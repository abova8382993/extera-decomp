...
@DebugMetadata(m895c = "androidx.datastore.core.DataStoreImpl$InitDataStore$doRun$initData$1$api$1", m896f = "DataStoreImpl.kt", m897i = {0, 0, 1, 2, 2}, m898l = {544, 447, 449}, m899m = "updateData", m900n = {"transform", "$this$withLock_u24default$iv", "$this$withLock_u24default$iv", "$this$withLock_u24default$iv", "newData"}, m902s = {"L$0", "L$1", "L$0", "L$0", "L$2"})
