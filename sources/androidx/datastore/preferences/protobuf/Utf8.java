...
import com.google.android.recaptcha.internal.zzma$$ExternalSyntheticBUOutline0;
        ...
        public String decodeUtf8(byte[] bArr, int i, int i2) throws InvalidProtocolBufferException {
            ...
            while (i < i3) {
                ...
                if (DecodeUtil.isOneByte(b3)) {
                    ...
                    int i9 = i + 2;
                    i += 3;
                    DecodeUtil.handleThreeBytes(b3, bArr[i6], bArr[i9], cArr, i5);
                    i5++;
                } else {
                    if (i6 >= i3 - 2) {
                        throw InvalidProtocolBufferException.invalidUtf8();
                    ...
                    byte b6 = bArr[i + 2];
                    i += 4;
                    DecodeUtil.handleFourBytes(b3, b5, b6, bArr[i10], cArr, i5);
                    i5 += 2;
                }
            }
            ...
            while (i6 < length) {
                ...
                if (cCharAt2 < 128 && i7 < i5) {
                    ...
                    if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || i7 > i5 - 3) {
                        ...
                        zzma$$ExternalSyntheticBUOutline0.m498m(cCharAt2, i7);
                        return 0;
                    }
