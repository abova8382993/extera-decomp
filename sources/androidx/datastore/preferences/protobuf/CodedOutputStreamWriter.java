...
final class CodedOutputStreamWriter implements Writer {
    ...
    /* JADX INFO: renamed from: androidx.datastore.preferences.protobuf.CodedOutputStreamWriter$1 */
    public static /* synthetic */ class C05681 {
    ...
    private <K, V> void writeDeterministicMap(int i, MapEntryLite.Metadata<K, V> metadata, Map<K, V> map) {
        switch (C05681.$SwitchMap$com$google$protobuf$WireFormat$FieldType[metadata.keyType.ordinal()]) {
            case 1:
            ...
            case 12:
                ...
                break;
            default:
                Buffer$$ExternalSyntheticBUOutline4.m978m("does not support key type: ", metadata.keyType);
                break;
        }
    }
