...
abstract class UnknownFieldSchema {
    ...
    final boolean mergeOneFieldFrom(Object obj, Reader reader, int i) throws InvalidProtocolBufferException {
        ...
        mergeFrom(objNewBuilder, reader, i2);
    ...
    private final void mergeFrom(Object obj, Reader reader, int i) {
        while (reader.getFieldNumber() != Integer.MAX_VALUE && mergeOneFieldFrom(obj, reader, i)) {
        }
    }
}
