...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    public /* synthetic */ CodedOutputStream(C05671 c05671) {
        this();
    }
    ...
    public static abstract class AbstractBufferedEncoder extends CodedOutputStream {
        ...
        public AbstractBufferedEncoder(int i) {
            super();
            if (i < 0) {
                g$$ExternalSyntheticBUOutline1.m207m("bufferSize must be >= 0");
                throw null;
            }
        ...
        public final void bufferUInt32NoTag(int i) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while (true) {
                    ...
                    this.position = i4 + 1;
                    UnsafeUtil.putByte(bArr, i4, (byte) ((i | 128) & 255));
                    i >>>= 7;
                }
            } else {
                while (true) {
        ...
        public final void bufferUInt64NoTag(long j) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while (true) {
                    ...
                    this.position = i2 + 1;
                    UnsafeUtil.putByte(bArr, i2, (byte) ((((int) j) | 128) & 255));
                    j >>>= 7;
                }
            } else {
                while (true) {
    ...
    public static final class OutputStreamEncoder extends AbstractBufferedEncoder {
        ...
        public OutputStreamEncoder(OutputStream outputStream, int i) {
            ...
            if (outputStream == null) {
                g$$ExternalSyntheticBUOutline2.m208m("out");
                throw null;
            }
