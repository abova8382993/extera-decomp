    ...
    private static void writeField(int i, Object obj, Writer writer) {
        ...
        if (tagWireType != 3) {
            if (tagWireType == 5) {
                ...
                HttpUrl$$ExternalSyntheticBUOutline0.m958m(InvalidProtocolBufferException.invalidWireType());
                return;
            }
        }
        if (writer.fieldOrder() == Writer.FieldOrder.ASCENDING) {
    ...
    public int getSerializedSize() {
        ...
        for (int i3 = 0; i3 < this.count; i3++) {
            ...
            if (tagWireType == 0) {
                ...
                Recorder$$ExternalSyntheticBUOutline0.m107m(InvalidProtocolBufferException.invalidWireType());
                return 0;
            }
