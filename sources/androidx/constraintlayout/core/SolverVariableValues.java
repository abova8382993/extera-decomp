...
public class SolverVariableValues implements ArrayRow.ArrayRowVariables {
    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (variable != null) {
                String str = strConcat + variable + " = " + getVariableValue(i2) + " ";
                int iIndexOf = indexOf(variable);
                String strConcat2 = str.concat("[p: ");
                String strConcat3 = (this.mPrevious[iIndexOf] != -1 ? strConcat2 + this.mCache.mIndexedVariables[this.mVariables[this.mPrevious[iIndexOf]]] : strConcat2.concat("none")).concat(", n: ");
                strConcat = (this.mNext[iIndexOf] != -1 ? strConcat3 + this.mCache.mIndexedVariables[this.mVariables[this.mNext[iIndexOf]]] : strConcat3.concat("none")).concat("]");
            }
        }
        return strConcat + " }";
    }
    ...
    private void addToHashMap(SolverVariable solverVariable, int i) {
        int[] iArr;
        int i2 = solverVariable.f32id % this.mHashSize;
    ...
    private void addVariable(int i, SolverVariable solverVariable, float f) {
        this.mVariables[i] = solverVariable.f32id;
        this.mValues[i] = f;
        this.mPrevious[i] = -1;
        this.mNext[i] = -1;
