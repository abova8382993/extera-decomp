...
public abstract class WidgetRun implements Dependency {
    ...
    public final DependencyNode getTarget(ConstraintAnchor constraintAnchor) {
        ...
        int i = C03561.f39x6930e354[constraintAnchor2.mType.ordinal()];
        if (i == 1) {
    ...
    public static /* synthetic */ class C03561 {
        ...
        static final /* synthetic */ int[] f39x6930e354;
        ...
        static {
            ...
            try {
                f39x6930e354[ConstraintAnchor.Type.RIGHT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f39x6930e354[ConstraintAnchor.Type.TOP.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f39x6930e354[ConstraintAnchor.Type.BASELINE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f39x6930e354[ConstraintAnchor.Type.BOTTOM.ordinal()] = 5;
    ...
    private void resolveDimension(int i, int i2) {
        ...
        WidgetRun widgetRun2 = constraintWidget2.mHorizontalRun;
        ...
        if (i == 0) {
            widgetRun2 = constraintWidget2.mVerticalRun;
        }
        if (widgetRun2.mDimension.resolved) {
            float dimensionRatio = constraintWidget2.getDimensionRatio();
            DimensionDependency dimensionDependency = widgetRun2.mDimension;
            if (i == 1) {
                i3 = (int) ((dimensionDependency.value / dimensionRatio) + 0.5f);
            } else {
                i3 = (int) ((dimensionRatio * dimensionDependency.value) + 0.5f);
            }
    ...
    public final DependencyNode getTarget(ConstraintAnchor constraintAnchor, int i) {
        ...
        int i2 = C03561.f39x6930e354[constraintAnchor2.mType.ordinal()];
        if (i2 != 1) {
            if (i2 != 2) {
                if (i2 != 3) {
                    if (i2 != 5) {
