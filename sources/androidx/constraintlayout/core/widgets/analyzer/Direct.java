...
public abstract class Direct {
    ...
    private static void horizontalSolvingPass(int i, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, boolean z) {
        ...
        if (anchor.getDependents() != null && anchor.hasFinalValue()) {
            for (ConstraintAnchor constraintAnchor5 : anchor.getDependents()) {
                ...
                boolean z4 = ((constraintAnchor5 == constraintWidget2.mLeft && (constraintAnchor4 = constraintWidget2.mRight.mTarget) != null && constraintAnchor4.hasFinalValue()) || (constraintAnchor5 == constraintWidget2.mRight && (constraintAnchor3 = constraintWidget2.mLeft.mTarget) != null && constraintAnchor3.hasFinalValue())) ? z2 : false;
        ...
        if (anchor2.getDependents() != null && anchor2.hasFinalValue()) {
            for (ConstraintAnchor constraintAnchor8 : anchor2.getDependents()) {
                ...
                boolean z6 = ((constraintAnchor8 == constraintWidget3.mLeft && (constraintAnchor2 = constraintWidget3.mRight.mTarget) != null && constraintAnchor2.hasFinalValue()) || (constraintAnchor8 == constraintWidget3.mRight && (constraintAnchor = constraintWidget3.mLeft.mTarget) != null && constraintAnchor.hasFinalValue())) ? z5 : false;
    ...
    private static void verticalSolvingPass(int i, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer) {
        ...
        if (anchor.getDependents() != null && anchor.hasFinalValue()) {
            for (ConstraintAnchor constraintAnchor5 : anchor.getDependents()) {
                ...
                boolean z2 = ((constraintAnchor5 == constraintWidget2.mTop && (constraintAnchor4 = constraintWidget2.mBottom.mTarget) != null && constraintAnchor4.hasFinalValue()) || (constraintAnchor5 == constraintWidget2.mBottom && (constraintAnchor3 = constraintWidget2.mTop.mTarget) != null && constraintAnchor3.hasFinalValue())) ? z : false;
        ...
        if (anchor2.getDependents() != null && anchor2.hasFinalValue()) {
            for (ConstraintAnchor constraintAnchor8 : anchor2.getDependents()) {
                ...
                boolean z5 = ((constraintAnchor8 == constraintWidget3.mTop && (constraintAnchor2 = constraintWidget3.mBottom.mTarget) != null && constraintAnchor2.hasFinalValue()) || (constraintAnchor8 == constraintWidget3.mBottom && (constraintAnchor = constraintWidget3.mTop.mTarget) != null && constraintAnchor.hasFinalValue())) ? z4 : false;
        ...
        if (anchor3.getDependents() != null && anchor3.hasFinalValue()) {
            ...
            for (ConstraintAnchor constraintAnchor11 : anchor3.getDependents()) {
