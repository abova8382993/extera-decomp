...
public class VerticalWidgetRun extends WidgetRun {
    ...
    /* JADX INFO: renamed from: androidx.constraintlayout.core.widgets.analyzer.VerticalWidgetRun$1 */
    public static /* synthetic */ class C03551 {

        /* JADX INFO: renamed from: $SwitchMap$androidx$constraintlayout$core$widgets$analyzer$WidgetRun$RunType */
        static final /* synthetic */ int[] f38x56910102;
        ...
        static {
            ...
            try {
                f38x56910102[WidgetRun.RunType.END.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f38x56910102[WidgetRun.RunType.CENTER.ordinal()] = 3;
    ...
    public void update(Dependency dependency) {
        ...
        int i;
        int i2 = C03551.f38x56910102[this.mRunType.ordinal()];
        if (i2 == 1) {
        ...
        if (dimensionDependency.readyToSolve && !dimensionDependency.resolved && this.mDimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            ...
            if (i3 != 2) {
                if (i3 == 3 && constraintWidget2.mHorizontalRun.mDimension.resolved) {
