...
public class ConstraintWidget {
    ...
    public String toString() {
        ...
        sb.append(str3);
        sb.append("(");
        sb.append(this.f31mX);
        sb.append(", ");
        sb.append(this.f32mY);
        sb.append(") - (");
    ...
    public int getX() {
        ...
        if (constraintWidget != null && (constraintWidget instanceof ConstraintWidgetContainer)) {
            return ((ConstraintWidgetContainer) constraintWidget).mPaddingLeft + this.f31mX;
        }
        return this.f31mX;
    }
    ...
    public int getY() {
        ConstraintWidget constraintWidget = this.mParent;
        if (constraintWidget != null && (constraintWidget instanceof ConstraintWidgetContainer)) {
            return ((ConstraintWidgetContainer) constraintWidget).mPaddingTop + this.f32mY;
        }
        return this.f32mY;
    }
    ...
    static /* synthetic */ class C03331 {
        ...
        static final /* synthetic */ int[] f33x6930e354;
        ...
        static {
            ...
            try {
                f33x6930e354[ConstraintAnchor.Type.TOP.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f33x6930e354[ConstraintAnchor.Type.RIGHT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f33x6930e354[ConstraintAnchor.Type.BOTTOM.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f33x6930e354[ConstraintAnchor.Type.BASELINE.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f33x6930e354[ConstraintAnchor.Type.CENTER.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f33x6930e354[ConstraintAnchor.Type.CENTER_X.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f33x6930e354[ConstraintAnchor.Type.CENTER_Y.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f33x6930e354[ConstraintAnchor.Type.NONE.ordinal()] = 9;
  ...
  0x0086: PHI (r0v2 int) = (r0v1 int), (r0v0 int), (r0v0 int), (r0v0 int), (r0v0 int), (r0v0 int) binds: [B:46:0x0086, B:36:0x007f, B:24:0x0051, B:26:0x0057, B:28:0x0063, B:30:0x0067] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public ConstraintAnchor getAnchor(ConstraintAnchor.Type type) {
        switch (C03331.f33x6930e354[type.ordinal()]) {
            case 1:
                return this.mLeft;
            case 2:
                return this.mTop;
    ...
    */
    ...
    public void getSceneString(StringBuilder sb) {
        ...
        sb.append("\n");
        sb.append("    actualLeft:" + this.f31mX);
        sb.append("\n");
        sb.append("    actualTop:" + this.f32mY);
        sb.append("\n");
