...
public class Barrier extends HelperWidget {
    ...
    public String toString() {
        String strConcat = "[Barrier] " + getDebugName() + " {";
        for (int i = 0; i < this.mWidgetsCount; i++) {
            ConstraintWidget constraintWidget = this.mWidgets[i];
            if (i > 0) {
                strConcat = strConcat.concat(", ");
            }
            strConcat = strConcat + constraintWidget.getDebugName();
        }
    ...
    public void addToSolver(LinearSystem linearSystem, boolean z) {
        ...
        if (this.mResolved) {
            ...
            if (i6 == 0 || i6 == 1) {
                linearSystem.addEquality(this.mLeft.mSolverVariable, this.f33mX);
                linearSystem.addEquality(this.mRight.mSolverVariable, this.f33mX);
                return;
            } else {
                if (i6 == 2 || i6 == 3) {
                    linearSystem.addEquality(this.mTop.mSolverVariable, this.f34mY);
                    linearSystem.addEquality(this.mBottom.mSolverVariable, this.f34mY);
                    return;
                }
                return;
            }
