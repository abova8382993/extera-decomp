...
public class PriorityGoalRow extends ArrayRow {
    ...
    */
    ...
    private void addToGoal(SolverVariable solverVariable) {
        ...
        int i4 = i3 + 1;
        this.mNumGoals = i4;
        if (i4 > 1 && solverVariableArr3[i3].f30id > solverVariable.f30id) {
            int i5 = 0;
            while (true) {
                i = this.mNumGoals;
                if (i5 >= i) {
            ...
            Arrays.sort(this.mSortArray, 0, i, new Comparator() { // from class: androidx.constraintlayout.core.PriorityGoalRow.1
    ...
    @Override // androidx.constraintlayout.core.ArrayRow
    public String toString() {
        String str = _UrlKt.FRAGMENT_ENCODE_SET + " goal -> (" + this.mConstantValue + ") : ";
