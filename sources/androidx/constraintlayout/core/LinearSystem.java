...
public class LinearSystem {
    ...
    public ArrayRow createRow() {
        ArrayRow arrayRow;
        if (OPTIMIZED_ENGINE) {
            arrayRow = (ArrayRow) this.mCache.mOptimizedArrayRowPool.acquire();
            if (arrayRow == null) {
            ...
            arrayRow = (ArrayRow) this.mCache.mArrayRowPool.acquire();
            if (arrayRow == null) {
    ...
    */
    public void addConstraint(androidx.constraintlayout.core.ArrayRow r6) {
        ...
        L63:
            ...
            androidx.constraintlayout.core.Pools$Pool r0 = r0.mOptimizedArrayRowPool
            r0.release(r6)
            goto L76
        L6f:
            androidx.constraintlayout.core.Cache r0 = r5.mCache
            androidx.constraintlayout.core.Pools$Pool r0 = r0.mArrayRowPool
            r0.release(r6)
        L76:
            int r0 = r5.mNumRows
            int r0 = r0 - r1
    ...
    public void addEquality(SolverVariable solverVariable, int i) {
        if (USE_BASIC_SYNONYMS && solverVariable.mDefinitionId == -1) {
            ...
            for (int i2 = 0; i2 < this.mVariablesID + 1; i2++) {
                ...
                if (solverVariable2 != null && solverVariable2.mIsSynonym && solverVariable2.mSynonym == solverVariable.f30id) {
