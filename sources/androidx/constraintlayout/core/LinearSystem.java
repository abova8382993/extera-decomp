...
public class LinearSystem {
    ...
    private int mPoolSize = MediaDataController.MAX_STYLE_RUNS_COUNT;
    ...
    private SolverVariable[] mPoolVariables = new SolverVariable[MediaDataController.MAX_STYLE_RUNS_COUNT];
    ...
    public SolverVariable createSlackVariable() {
        ...
        this.mVariablesID = i;
        this.mNumColumns++;
        solverVariableAcquireSolverVariable.f32id = i;
    ...
    public SolverVariable createErrorVariable(int i, String str) {
        ...
        this.mVariablesID = i2;
        this.mNumColumns++;
        solverVariableAcquireSolverVariable.f32id = i2;
    ...
    */
    public void addConstraint(androidx.constraintlayout.core.ArrayRow r6) {
        ...
        L25:
            ...
            androidx.constraintlayout.core.LinearSystem$Row r2 = r5.mTempGoal
            r5.optimize(r2, r1)
            int r2 = r0.mDefinitionId
            r3 = -1
            if (r2 != r3) goto L7b
            androidx.constraintlayout.core.SolverVariable r2 = r6.mVariable
            if (r2 != r0) goto L5a
        ...
        L63:
            ...
            androidx.constraintlayout.core.Cache r2 = r5.mCache
            if (r0 == 0) goto L6f
            androidx.constraintlayout.core.Pools$Pool<androidx.constraintlayout.core.ArrayRow> r0 = r2.mOptimizedArrayRowPool
            r0.release(r6)
            goto L74
        L6f:
            androidx.constraintlayout.core.Pools$Pool<androidx.constraintlayout.core.ArrayRow> r0 = r2.mArrayRowPool
            r0.release(r6)
        L74:
            int r0 = r5.mNumRows
            int r0 = r0 - r1
    ...
    public void addEquality(SolverVariable solverVariable, int i) {
        if (USE_BASIC_SYNONYMS && solverVariable.mDefinitionId == -1) {
            ...
            for (int i2 = 0; i2 < this.mVariablesID + 1; i2++) {
                ...
                if (solverVariable2 != null && solverVariable2.mIsSynonym && solverVariable2.mSynonym == solverVariable.f32id) {
