...
public class ConstraintLayout extends ViewGroup {
    ...
    static /* synthetic */ Metrics access$000(ConstraintLayout constraintLayout) {
    ...
    class Measurer implements BasicMeasure.Measurer {
        ...
        public final void measure(ConstraintWidget constraintWidget, BasicMeasure.Measure measure) {
            ...
            int[] iArr = C03381.f38x6d00e4a2;
            int i6 = iArr[dimensionBehaviour.ordinal()];
            if (i6 == 1) {
                iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i2, TLObject.FLAG_30);
            } else if (i6 == 2) {
                iMakeMeasureSpec = ViewGroup.getChildMeasureSpec(this.mLayoutWidthSpec, i5, -2);
            } else if (i6 == 3) {
                iMakeMeasureSpec = ViewGroup.getChildMeasureSpec(this.mLayoutWidthSpec, i5 + constraintWidget.getHorizontalMargin(), -1);
            } else if (i6 != 4) {
                iMakeMeasureSpec = 0;
            } else {
                iMakeMeasureSpec = ViewGroup.getChildMeasureSpec(this.mLayoutWidthSpec, i5, -2);
                ...
                if (i7 == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || i7 == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS) {
                    ...
                    if (measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || !z || ((z && z2) || constraintWidget.isResolvedHorizontally())) {
                        iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(constraintWidget.getWidth(), TLObject.FLAG_30);
                    }
                }
            }
            int i8 = iArr[dimensionBehaviour2.ordinal()];
            if (i8 == 1) {
                iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(i3, TLObject.FLAG_30);
            } else if (i8 == 2) {
                ...
                if (i9 == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || i9 == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS) {
                    ...
                    if (measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || !z3 || ((z3 && z4) || constraintWidget.isResolvedVertically())) {
                        iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(constraintWidget.getHeight(), TLObject.FLAG_30);
                    }
                }
            }
            ...
            if (i10 != BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS && i10 != BasicMeasure.Measure.USE_GIVEN_DIMENSIONS && z5 && constraintWidget.mMatchConstraintDefaultWidth == 0 && z6 && constraintWidget.mMatchConstraintDefaultHeight == 0) {
                ...
                if (measuredWidth != iMax || measuredHeight != iMax2) {
                    if (measuredWidth != iMax) {
                        iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(iMax, TLObject.FLAG_30);
                    }
                    if (measuredHeight != iMax2) {
                        iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(iMax2, TLObject.FLAG_30);
                    }
                    view.measure(iMakeMeasureSpec, iMakeMeasureSpec2);
                    constraintWidget.setLastMeasureSpec(iMakeMeasureSpec, iMakeMeasureSpec2);
            ...
            if (z13 && baseline != -1 && constraintWidget.getBaselineDistance() != baseline) {
    ...
    static /* synthetic */ class C03381 {
        ...
        static final /* synthetic */ int[] f38x6d00e4a2;
        ...
        static {
            ...
            try {
                f38x6d00e4a2[ConstraintWidget.DimensionBehaviour.WRAP_CONTENT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f38x6d00e4a2[ConstraintWidget.DimensionBehaviour.MATCH_PARENT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f38x6d00e4a2[ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT.ordinal()] = 4;
    ...
    private void setChildrenConstraints() {
        ...
        for (int i7 = 0; i7 < childCount; i7++) {
            ...
            if (viewWidget2 != null) {
                ...
                applyConstraintsFromLayoutParams(zIsInEditMode, childAt3, viewWidget2, layoutParams, this.mTempMapIdToWidget);
            }
        }
    }
 ...
 binds: [B:21:0x004a, B:17:0x003c] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public String getSceneString() {
        ...
        ArrayList children = this.mLayoutWidget.getChildren();
    ...
    protected boolean dynamicUpdateConstraints(int i, int i2) {
        ...
        while (i3 < size) {
            ...
            i3++;
            WindowDecorActionBar$$ExternalSyntheticThrowCCEIfNotNull0.m4m(valueModifier);
            Iterator it = this.mLayoutWidget.getChildren().iterator();
            if (it.hasNext()) {
                View view = (View) ((ConstraintWidget) it.next()).getCompanionWidget();
                view.getId();
                throw null;
            }
        }
