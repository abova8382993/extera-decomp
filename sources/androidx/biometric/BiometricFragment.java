...
public class BiometricFragment extends Fragment {
    ...
    /* JADX INFO: renamed from: androidx.biometric.BiometricFragment$1 */
    public class C00901 implements Observer<BiometricPrompt.AuthenticationResult> {
        public C00901() {
        }
    ...
    /* JADX INFO: renamed from: androidx.biometric.BiometricFragment$2 */
    public class C00932 implements Observer<BiometricErrorData> {
        public C00932() {
        }
    ...
    /* JADX INFO: renamed from: androidx.biometric.BiometricFragment$3 */
    public class C00943 implements Observer<CharSequence> {
        public C00943() {
        }
    ...
    /* JADX INFO: renamed from: androidx.biometric.BiometricFragment$4 */
    public class C00954 implements Observer<Boolean> {
        public C00954() {
        }
    ...
    /* JADX INFO: renamed from: androidx.biometric.BiometricFragment$5 */
    public class C00965 implements Observer<Boolean> {
        public C00965() {
        }
    ...
    /* JADX INFO: renamed from: androidx.biometric.BiometricFragment$6 */
    public class C00976 implements Observer<Boolean> {
        public C00976() {
        }
    ...
    /* JADX INFO: renamed from: androidx.biometric.BiometricFragment$7 */
    public class RunnableC00987 implements Runnable {
        public RunnableC00987() {
        }
    ...
    public void onAuthenticationError(int i, CharSequence charSequence) {
        ...
        if (isUsingFingerprintDialog()) {
            ...
            if (biometricViewModel.isFingerprintDialogDismissedInstantly()) {
                ...
                this.mHandler.postDelayed(new Runnable() { // from class: androidx.biometric.BiometricFragment.8
                    ...
                    final /* synthetic */ int val$knownErrorCode;

                    public RunnableC00998(int i2, CharSequence charSequence2) {
                        i = i2;
        ...
        if (charSequence2 == null) {
            charSequence2 = getString(R$string.default_error_msg) + " " + i2;
        }
        sendErrorAndDismiss(i2, charSequence2);
    }

    /* JADX INFO: renamed from: androidx.biometric.BiometricFragment$8 */
    public class RunnableC00998 implements Runnable {
        final /* synthetic */ CharSequence val$errorString;
        final /* synthetic */ int val$knownErrorCode;
    ...
    private void sendSuccessToClient(BiometricPrompt.AuthenticationResult authenticationResult) {
        if (!this.mViewModel.isAwaitingResult()) {
            ...
            this.mViewModel.getClientExecutor().execute(new Runnable() { // from class: androidx.biometric.BiometricFragment.9
                final /* synthetic */ BiometricPrompt.AuthenticationResult val$result;

                public RunnableC01009(BiometricPrompt.AuthenticationResult authenticationResult2) {
    ...
    /* JADX INFO: renamed from: androidx.biometric.BiometricFragment$9 */
    public class RunnableC01009 implements Runnable {
        final /* synthetic */ BiometricPrompt.AuthenticationResult val$result;
    ...
    private void sendErrorToClient(int i, CharSequence charSequence) {
        if (this.mViewModel.isConfirmingDeviceCredential()) {
            ...
            this.mViewModel.getClientExecutor().execute(new Runnable() { // from class: androidx.biometric.BiometricFragment.10
                ...
                public RunnableC009110(int i2, CharSequence charSequence2) {
                    i = i2;
                    charSequence = charSequence2;
                }
    ...
    /* JADX INFO: renamed from: androidx.biometric.BiometricFragment$10 */
    public class RunnableC009110 implements Runnable {
        final /* synthetic */ int val$errorCode;
        final /* synthetic */ CharSequence val$errorString;
    ...
    /* JADX INFO: renamed from: androidx.biometric.BiometricFragment$11 */
    public class RunnableC009211 implements Runnable {
        public RunnableC009211() {
        }
