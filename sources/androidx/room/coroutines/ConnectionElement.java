...
final class ConnectionElement implements CoroutineContext.Element {
    ...
    public ConnectionElement(CoroutineContext.Key<ConnectionElement> key, PooledConnectionImpl pooledConnectionImpl) {
        this.key = key;
