    ...
    */
    ...
    public void addView(View view, int i, ViewGroup.LayoutParams layoutParams) {
        ...
        if (!this.mInLayout) {
            ...
            Segment$$ExternalSyntheticBUOutline1.m992m("Cannot add pager decor view during layout");
        } else {
    ...
    */
    ...
    private boolean pageScrolled(int i) {
        if (this.mItems.size() == 0) {
            ...
            Segment$$ExternalSyntheticBUOutline1.m992m("onPageScrolled did not call superclass implementation");
            return false;
        }
    ...
    */
    ...
    public void endFakeDrag() {
        if (!this.mFakeDragging) {
            Segment$$ExternalSyntheticBUOutline1.m992m("No fake drag in progress. Call beginFakeDrag first.");
            return;
        }
