    ...
    public void onStateChanged(LifecycleOwner source, Lifecycle.Event event) {
        switch (WhenMappings.$EnumSwitchMapping$0[event.ordinal()]) {
            ...
            case 6:
                ...
                break;
            case 7:
                g$$ExternalSyntheticBUOutline1.m207m("ON_ANY must not been send by anybody");
                return;
            default:
