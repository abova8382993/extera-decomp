            ...
            if (onLifecycleEvent != null) {
                ...
                if (parameterTypes.length <= 0) {
                    ...
                    if (!LifecycleOwner.class.isAssignableFrom(parameterTypes[0])) {
                        g$$ExternalSyntheticBUOutline1.m207m("invalid parameter type. Must be one and instanceof LifecycleOwner");
                        return null;
                    }
                    i = 1;
                }
                ...
                if (parameterTypes.length > 1) {
                    if (!Lifecycle.Event.class.isAssignableFrom(parameterTypes[1])) {
                        g$$ExternalSyntheticBUOutline1.m207m("invalid parameter type. second arg must be an event");
                        return null;
                    }
                    if (eventValue != Lifecycle.Event.ON_ANY) {
                        g$$ExternalSyntheticBUOutline1.m207m("Second arg is supported only for ON_ANY value");
                        return null;
                    }
                    i = 2;
                }
                if (parameterTypes.length > 2) {
                    g$$ExternalSyntheticBUOutline1.m207m("cannot have more than 2 params");
                    return null;
                }
    ...
    public static final class MethodReference {
        ...
        public void invokeCallback(LifecycleOwner lifecycleOwner, Lifecycle.Event event, Object obj) {
            try {
                ...
                Make$Map$$ExternalSyntheticBUOutline0.m1024m("Failed to call observer method", e2.getCause());
            }
        }
