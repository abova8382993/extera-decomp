...
public abstract class NotificationCompat {
    ...
    public static class MessagingStyle extends Style {
        ...
        public MessagingStyle(Person person) {
            if (TextUtils.isEmpty(person.getName())) {
                g$$ExternalSyntheticBUOutline1.m207m("User's name must not be empty.");
                throw null;
            }
            this.mUser = person;
        }
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (i >= 28) {
                messagingStyleCreateMessagingStyle = Api28Impl.createMessagingStyle(person.toAndroidPerson());
            } else {
                messagingStyleCreateMessagingStyle = Api24Impl.createMessagingStyle(person.getName());
            }
        ...
        public static final class Message {
            ...
            private Bundle toBundle() {
                ...
                if (person != null) {
                    ...
                    if (i >= 28) {
                        bundle.putParcelable("sender_person", Api28Impl.castToParcelable(person2.toAndroidPerson()));
                    } else {
                        bundle.putBundle("person", person2.toBundle());
                    }
                }
    ...
    public static class Action {
        ...
        public Action(int i, CharSequence charSequence, PendingIntent pendingIntent) {
            this(i != 0 ? IconCompat.createWithResource(null, _UrlKt.FRAGMENT_ENCODE_SET, i) : null, charSequence, pendingIntent);
        }
        ...
        public IconCompat getIconCompat() {
            ...
            if (this.mIcon == null && (i = this.icon) != 0) {
                this.mIcon = IconCompat.createWithResource(null, _UrlKt.FRAGMENT_ENCODE_SET, i);
            }
            return this.mIcon;
        }
        ...
        public static final class Builder {
            ...
            public Builder(int i, CharSequence charSequence, PendingIntent pendingIntent) {
                this(i != 0 ? IconCompat.createWithResource(null, _UrlKt.FRAGMENT_ENCODE_SET, i) : null, charSequence, pendingIntent, new Bundle(), null, true, 0, true, false, false);
            }
            ...
            private void checkContextualActionNullFields() {
                if (this.mIsContextual && this.mIntent == null) {
                    g$$ExternalSyntheticBUOutline2.m208m("Contextual Actions must contain a valid PendingIntent");
                }
            }
    ...
    public static final class WearableExtender implements Extender {
        ...
        public WearableExtender m1960clone() {
    ...
    public static final class BubbleMetadata {
        ...
        public static final class Builder {
            ...
            public Builder(PendingIntent pendingIntent, IconCompat iconCompat) {
                if (pendingIntent == null) {
                    g$$ExternalSyntheticBUOutline2.m208m("Bubble requires non-null pending intent");
                    throw null;
                }
                if (iconCompat == null) {
                    g$$ExternalSyntheticBUOutline2.m208m("Bubbles require non-null icon");
                    throw null;
                }
                this.mPendingIntent = pendingIntent;
                this.mIcon = iconCompat;
            ...
            public BubbleMetadata build() {
                ...
                if (str == null && this.mPendingIntent == null) {
                    g$$ExternalSyntheticBUOutline2.m208m("Must supply pending intent or shortcut to bubble");
                    return null;
                }
                if (str == null && this.mIcon == null) {
                    g$$ExternalSyntheticBUOutline2.m208m("Must supply an icon or shortcut for the bubble");
                    return null;
                }
