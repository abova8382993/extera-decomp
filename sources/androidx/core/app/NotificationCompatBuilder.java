    ...
    NotificationCompatBuilder(NotificationCompat.Builder builder) {
        ...
        if (builder.mInvisibleActions.size() > 0) {
            ...
            for (int i5 = 0; i5 < builder.mInvisibleActions.size(); i5++) {
                bundle4.putBundle(Integer.toString(i5), NotificationCompatJellybean.getBundleForAction((NotificationCompat.Action) builder.mInvisibleActions.get(i5)));
            }
        ...
        if (i6 >= 28) {
            ArrayList arrayList2 = builder.mPersonList;
            int size2 = arrayList2.size();
            while (i2 < size2) {
                Object obj3 = arrayList2.get(i2);
                i2++;
                Api28Impl.addPerson(this.mBuilder, ((Person) obj3).toAndroidPerson());
            }
        }
