...
public class ShortcutInfoCompat {
    ...
    public ShortcutInfo toShortcutInfo() {
        ShortcutInfoCompat$$ExternalSyntheticApiModelOutline1.m116m();
        ShortcutInfo.Builder intents = ShortcutInfoCompat$$ExternalSyntheticApiModelOutline0.m115m(this.mContext, this.mId).setShortLabel(this.mLabel).setIntents(this.mIntents);
    ...
    public static List<ShortcutInfoCompat> fromShortcuts(Context context, List<ShortcutInfo> list) {
        ...
        while (it.hasNext()) {
            arrayList.add(new Builder(context, ShortcutInfoCompat$$ExternalSyntheticApiModelOutline2.m117m(it.next())).build());
        }
        return arrayList;
    }
    ...
    public static class Builder {
        ...
        public ShortcutInfoCompat build() {
            if (TextUtils.isEmpty(this.mInfo.mLabel)) {
                g$$ExternalSyntheticBUOutline1.m207m("Shortcut must have a non-empty label");
                return null;
            }
            ShortcutInfoCompat shortcutInfoCompat = this.mInfo;
            Intent[] intentArr = shortcutInfoCompat.mIntents;
            if (intentArr == null || intentArr.length == 0) {
                g$$ExternalSyntheticBUOutline1.m207m("Shortcut must have an intent");
                return null;
            }
