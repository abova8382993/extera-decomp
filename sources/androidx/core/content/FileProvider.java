...
public class FileProvider extends ContentProvider {
    ...
    public static XmlResourceParser getFileProviderPathsMetaData(Context context, String str, ProviderInfo providerInfo, int i) {
        if (providerInfo == null) {
            Native$$ExternalSyntheticBUOutline5.m554m("Couldn't find meta-data for provider with authority ", str);
            return null;
        }
        ...
        g$$ExternalSyntheticBUOutline1.m207m("Missing android.support.FILE_PROVIDER_PATHS meta-data");
        return null;
    }
    ...
    private static int modeToMode(String str) {
        ...
        Native$$ExternalSyntheticBUOutline5.m554m("Invalid mode: ", str);
        return 0;
    }
    ...
    public static class SimplePathStrategy implements PathStrategy {
        ...
        public void addRoot(String str, File file) {
            if (TextUtils.isEmpty(str)) {
                g$$ExternalSyntheticBUOutline1.m207m("Name must not be empty");
                return;
            }
            try {
        ...
        public Uri getUriForFile(File file) {
            ...
            try {
                ...
                if (entry == null) {
                    Native$$ExternalSyntheticBUOutline5.m554m("Failed to find configured root that contains ", canonicalPath);
                    return null;
                }
                ...
                Native$$ExternalSyntheticBUOutline5.m554m("Failed to resolve canonical path for ", file);
                return null;
            }
        }
        ...
        public File getFileForUri(Uri uri) {
            ...
            if (iIndexOf == -1) {
                Native$$ExternalSyntheticBUOutline5.m554m("Unable to find path from root: ", uri);
                return null;
            }
            ...
            if (file == null) {
                Native$$ExternalSyntheticBUOutline5.m554m("Unable to find configured root for ", uri);
                return null;
            }
            ...
            try {
                ...
                Native$$ExternalSyntheticBUOutline5.m554m("Failed to resolve canonical path for ", file2);
                return null;
            }
        }
