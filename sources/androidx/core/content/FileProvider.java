...
public class FileProvider extends ContentProvider {
    ...
    private static PathStrategy getPathStrategy(Context context, String str, int i) {
        ...
        synchronized (map) {
            try {
                pathStrategy = (PathStrategy) map.get(str);
    ...
    static class SimplePathStrategy implements PathStrategy {
        ...
        public Uri getUriForFile(File file) {
            ...
            try {
                ...
                return new Uri.Builder().scheme("content").authority(this.mAuthority).encodedPath(Uri.encode((String) entry.getKey()) + '/' + Uri.encode(strSubstring, "/")).build();
