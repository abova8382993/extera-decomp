...
public class CamColor {
    ...
    private final float f43mJ;
    private final float mJstar;

    /* JADX INFO: renamed from: mM */
    private final float f44mM;

    /* JADX INFO: renamed from: mQ */
    private final float f45mQ;

    /* JADX INFO: renamed from: mS */
    private final float f46mS;
    ...
    private static CamColor fromJchInFrame(float f, float f2, float f3, ViewingConditions viewingConditions) {
        ...
        return new CamColor(f3, f2, f, c2, flRoot, fSqrt, f4, ((float) Math.cos(d)) * fLog, fLog * ((float) Math.sin(d)));
    }
