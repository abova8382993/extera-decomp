...
public abstract class FontResourcesParserCompat {
    ...
    public static final class ProviderResourceEntry implements FamilyResourceEntry {
        ...
        public ProviderResourceEntry(List list, int i, int i2, String str) {
            this.mRequests = list;
            this.mStrategy = i;
            this.mTimeoutMs = i2;
    ...
    private static FontRequest readFallback(XmlPullParser xmlPullParser, Resources resources, String str, String str2, List list) throws Exception {
        ...
        try {
            ...
            UseCaseGraphContext$$ExternalSyntheticAutoCloseableDispatcher0.m22m(typedArrayObtainAttributes);
            return fontRequest;
        } catch (Throwable th) {
