...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild {
    ...
    public void addView(View view) {
        if (getChildCount() > 0) {
            Segment$$ExternalSyntheticBUOutline1.m992m("ScrollView can host only one direct child");
        } else {
            super.addView(view);
        }
    }
    ...
    */
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (actionMasked == 2) {
                ...
                if (iFindPointerIndex == -1) {
                    ...
                    if (!this.mIsBeingDragged && Math.abs(iReleaseVerticalGlow) > this.mTouchSlop) {
                        ...
                        iReleaseVerticalGlow = iReleaseVerticalGlow > 0 ? iReleaseVerticalGlow - i2 : iReleaseVerticalGlow + i2;
                    }
                    int i3 = iReleaseVerticalGlow;
                    if (this.mIsBeingDragged) {
                        nestedScrollView = this;
                        int iScrollBy = nestedScrollView.scrollBy(i3, 1, motionEvent, (int) motionEvent.getX(iFindPointerIndex), 0, false);
            ...
            velocityTracker.computeCurrentVelocity(MediaDataController.MAX_STYLE_RUNS_COUNT, nestedScrollView.mMaximumVelocity);
    ...
    private float getSplineFlingDistance(int i) {
        ...
        return (float) (((double) (this.mPhysicalCoeff * 0.015f)) * Math.exp((((double) f) / (((double) f) - 1.0d)) * dLog));
    }
    ...
    public float getVerticalScrollFactorCompat() {
        if (this.mVerticalScrollFactor == 0.0f) {
            ...
            if (!context.getTheme().resolveAttribute(R.attr.listPreferredItemHeight, typedValue, true)) {
                Segment$$ExternalSyntheticBUOutline1.m992m("Expected theme to define listPreferredItemHeight.");
                return 0.0f;
            }
    ...
    */
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public class C04141 implements Parcelable.Creator<SavedState> {
            @Override // android.os.Parcelable.Creator
            public SavedState createFromParcel(Parcel parcel) {
                return new SavedState(parcel);
            }
