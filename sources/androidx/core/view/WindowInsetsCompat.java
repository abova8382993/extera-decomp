...
public class WindowInsetsCompat {
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(int i, int i2, int i3, int i4) {
        return new Builder(this).setSystemWindowInsets(Insets.m120of(i, i2, i3, i4)).build();
    }
    ...
    public static class Impl {
        ...
        public Insets getInsetsIgnoringVisibility(int i) {
            if ((i & 8) != 0) {
                g$$ExternalSyntheticBUOutline1.m207m("Unable to query the maximum insets for IME");
                return null;
            }
            return Insets.NONE;
        }
    ...
    public static class Impl20 extends Impl {
        ...
        public Insets getInsetsForType(int i, boolean z) {
            ...
            if (i == 1) {
                if (z) {
                    return Insets.m120of(0, Math.max(getRootStableInsets().top, getSystemWindowInsets().top), 0, 0);
                }
                if ((this.mSystemUiVisibility & 4) != 0) {
                    return Insets.NONE;
                }
                return Insets.m120of(0, getSystemWindowInsets().top, 0, 0);
            }
            if (i == 2) {
                if (z) {
                    Insets rootStableInsets = getRootStableInsets();
                    Insets stableInsets2 = getStableInsets();
                    return Insets.m120of(Math.max(rootStableInsets.left, stableInsets2.left), 0, Math.max(rootStableInsets.right, stableInsets2.right), Math.max(rootStableInsets.bottom, stableInsets2.bottom));
                }
                ...
                return Insets.m120of(systemWindowInsets.left, 0, systemWindowInsets.right, iMin);
            }
            if (i != 8) {
                if (i == 16) {
                ...
                if (i == 128) {
                    ...
                    if (displayCutout != null) {
                        return Insets.m120of(displayCutout.getSafeInsetLeft(), displayCutout.getSafeInsetTop(), displayCutout.getSafeInsetRight(), displayCutout.getSafeInsetBottom());
                    }
                    return Insets.NONE;
                }
                return Insets.NONE;
        ...
        public final Insets getSystemWindowInsets() {
            if (this.mSystemWindowInsets == null) {
                this.mSystemWindowInsets = Insets.m120of(this.mPlatformInsets.getSystemWindowInsetLeft(), this.mPlatformInsets.getSystemWindowInsetTop(), this.mPlatformInsets.getSystemWindowInsetRight(), this.mPlatformInsets.getSystemWindowInsetBottom());
            }
        ...
        private Insets getVisibleInsets(View view) {
            if (Build.VERSION.SDK_INT >= 30) {
                ByteString$$ExternalSyntheticBUOutline0.m979m("getVisibleInsets() should not be called on API >= 30. Use WindowInsets.isVisible() instead.");
                return null;
            }
    ...
    public static class Impl21 extends Impl20 {
        ...
        public final Insets getStableInsets() {
            if (this.mStableInsets == null) {
                this.mStableInsets = Insets.m120of(this.mPlatformInsets.getStableInsetLeft(), this.mPlatformInsets.getStableInsetTop(), this.mPlatformInsets.getStableInsetRight(), this.mPlatformInsets.getStableInsetBottom());
            }
    ...
    public static Insets insetInsets(Insets insets, int i, int i2, int i3, int i4) {
        ...
        return (iMax == i && iMax2 == i2 && iMax3 == i3 && iMax4 == i4) ? insets : Insets.m120of(iMax, iMax2, iMax3, iMax4);
    }
    ...
    public static class BuilderImpl29 extends BuilderImpl {
        ...
        public BuilderImpl29() {
            this.mPlatBuilder = AbstractC0394xad760192.m143m();
        }
        ...
        public BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            ...
            if (windowInsets != null) {
                builderM143m = AbstractC0393xad760191.m142m(windowInsets);
            } else {
                builderM143m = AbstractC0394xad760192.m143m();
            }
    ...
    public static final class Type {
        ...
        public static int indexOf(int i) {
            ...
            CharCodeKt$$ExternalSyntheticBUOutline0.m873m("type needs to be >= FIRST and <= LAST, type=", i);
            return 0;
        }
    }
