...
public class WindowInsetsCompat {
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(int i, int i2, int i3, int i4) {
        return new Builder(this).setSystemWindowInsets(Insets.m118of(i, i2, i3, i4)).build();
    }
    ...
    private static class Impl20 extends Impl {
        ...
        protected Insets getInsetsForType(int i, boolean z) {
            ...
            if (i == 1) {
                if (z) {
                    return Insets.m118of(0, Math.max(getRootStableInsets().top, getSystemWindowInsets().top), 0, 0);
                }
                if ((this.mSystemUiVisibility & 4) != 0) {
                    return Insets.NONE;
                }
                return Insets.m118of(0, getSystemWindowInsets().top, 0, 0);
            }
            if (i == 2) {
                if (z) {
                    Insets rootStableInsets = getRootStableInsets();
                    Insets stableInsets2 = getStableInsets();
                    return Insets.m118of(Math.max(rootStableInsets.left, stableInsets2.left), 0, Math.max(rootStableInsets.right, stableInsets2.right), Math.max(rootStableInsets.bottom, stableInsets2.bottom));
                }
                ...
                return Insets.m118of(systemWindowInsets.left, 0, systemWindowInsets.right, iMin);
            }
            if (i != 8) {
                if (i == 16) {
                ...
                if (i == 128) {
                    ...
                    if (displayCutout != null) {
                        return Insets.m118of(displayCutout.getSafeInsetLeft(), displayCutout.getSafeInsetTop(), displayCutout.getSafeInsetRight(), displayCutout.getSafeInsetBottom());
                    }
                    return Insets.NONE;
                }
                return Insets.NONE;
        ...
        final Insets getSystemWindowInsets() {
            if (this.mSystemWindowInsets == null) {
                this.mSystemWindowInsets = Insets.m118of(this.mPlatformInsets.getSystemWindowInsetLeft(), this.mPlatformInsets.getSystemWindowInsetTop(), this.mPlatformInsets.getSystemWindowInsetRight(), this.mPlatformInsets.getSystemWindowInsetBottom());
            }
    ...
    private static class Impl21 extends Impl20 {
        ...
        final Insets getStableInsets() {
            if (this.mStableInsets == null) {
                this.mStableInsets = Insets.m118of(this.mPlatformInsets.getStableInsetLeft(), this.mPlatformInsets.getStableInsetTop(), this.mPlatformInsets.getStableInsetRight(), this.mPlatformInsets.getStableInsetBottom());
            }
    ...
    static Insets insetInsets(Insets insets, int i, int i2, int i3, int i4) {
        ...
        return (iMax == i && iMax2 == i2 && iMax3 == i3 && iMax4 == i4) ? insets : Insets.m118of(iMax, iMax2, iMax3, iMax4);
    }
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = AbstractC0374xad760192.m137m();
        }

        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            WindowInsets.Builder builderM137m;
            super(windowInsetsCompat);
            WindowInsets windowInsets = windowInsetsCompat.toWindowInsets();
            if (windowInsets != null) {
                builderM137m = AbstractC0373xad760191.m136m(windowInsets);
            } else {
                builderM137m = AbstractC0374xad760192.m137m();
            }
            this.mPlatBuilder = builderM137m;
        }
