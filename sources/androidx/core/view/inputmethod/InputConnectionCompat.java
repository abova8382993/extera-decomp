...
public abstract class InputConnectionCompat {
    ...
    public static InputConnection createWrapper(InputConnection inputConnection, EditorInfo editorInfo, OnCommitContentListener onCommitContentListener) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            return new InputConnectionWrapper(inputConnection, false) { // from class: androidx.core.view.inputmethod.InputConnectionCompat.1
                ...
                public C04081(InputConnection inputConnection2, boolean z, OnCommitContentListener onCommitContentListener2) {
        ...
        return EditorInfoCompat.getContentMimeTypes(editorInfo).length == 0 ? inputConnection2 : new InputConnectionWrapper(inputConnection2, false) { // from class: androidx.core.view.inputmethod.InputConnectionCompat.2
            final /* synthetic */ OnCommitContentListener val$listener;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C04092(InputConnection inputConnection2, boolean z, OnCommitContentListener onCommitContentListener2) {
                super(inputConnection2, z);
                onCommitContentListener = onCommitContentListener2;
            }
    ...
    public class C04081 extends InputConnectionWrapper {
        final /* synthetic */ OnCommitContentListener val$listener;
    ...
    public class C04092 extends InputConnectionWrapper {
        final /* synthetic */ OnCommitContentListener val$listener;
