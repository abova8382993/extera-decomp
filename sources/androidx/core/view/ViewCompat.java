...
public abstract class ViewCompat {
    ...
    public static void setPointerIcon(View view, PointerIconCompat pointerIconCompat) {
        if (Build.VERSION.SDK_INT >= 24) {
            Api24Impl.setPointerIcon(view, ViewCompat$$ExternalSyntheticApiModelOutline0.m130m(pointerIconCompat != null ? pointerIconCompat.getPointerIcon() : null));
        }
    }
    ...
    static boolean dispatchUnhandledKeyEventBeforeHierarchy(View view, KeyEvent keyEvent) {
        ...
        return UnhandledKeyEventManager.m131at(view).preDispatch(keyEvent);
    }
    ...
    static boolean dispatchUnhandledKeyEventBeforeCallback(View view, KeyEvent keyEvent) {
        ...
        return UnhandledKeyEventManager.m131at(view).dispatch(view, keyEvent);
    }
    ...
    static class UnhandledKeyEventManager {
        ...
        static UnhandledKeyEventManager m131at(View view) {
        ...
        private boolean onUnhandledKeyEvent(View view, KeyEvent keyEvent) {
            ...
            WindowDecorActionBar$$ExternalSyntheticThrowCCEIfNotNull0.m4m(arrayList.get(size));
            throw null;
        }
