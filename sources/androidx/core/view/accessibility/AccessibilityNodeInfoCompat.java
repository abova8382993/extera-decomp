...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        public static final AccessibilityActionCompat ACTION_SET_TEXT = new AccessibilityActionCompat(TLObject.FLAG_21, (CharSequence) null, AccessibilityViewCommand.SetTextArguments.class);
        ...
        public boolean perform(View view, Bundle bundle) {
            ...
            if (cls != null) {
                try {
                    WindowDecorActionBar$$ExternalSyntheticThrowCCEIfNotNull0.m4m(cls.getDeclaredConstructor(null).newInstance(null));
                    throw null;
                } catch (Exception e) {
    ...
    public int getExpandedState() {
        ...
        return this.mInfo.getExtras().getInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.EXPANDED_STATE_KEY", 0);
    }
    ...
    public int getChecked() {
        if (Build.VERSION.SDK_INT < 36) {
            return this.mInfo.getExtras().getInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.CHECKED_KEY", this.mInfo.isChecked() ? 1 : 0);
        }
    ...
    public CharSequence getSupplementalDescription() {
        ...
        return this.mInfo.getExtras().getCharSequence("androidx.view.accessibility.AccessibilityNodeInfoCompat.SUPPLEMENTAL_DESCRIPTION_KEY");
    }
