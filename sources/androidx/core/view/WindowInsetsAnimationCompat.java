...
public final class WindowInsetsAnimationCompat {
        ...
        public static class Impl21OnApplyWindowInsetsListener implements View.OnApplyWindowInsetsListener {
            ...
            public WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
                ...
                duration.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.core.view.WindowInsetsAnimationCompat.Impl21.Impl21OnApplyWindowInsetsListener.1
                    ...
                    public C03861(WindowInsetsAnimationCompat windowInsetsAnimationCompat2, WindowInsetsCompat windowInsetsCompat3, WindowInsetsCompat windowInsetsCompat22, int i32, View view2) {
                ...
                duration.addListener(new AnimatorListenerAdapter() { // from class: androidx.core.view.WindowInsetsAnimationCompat.Impl21.Impl21OnApplyWindowInsetsListener.2
                    ...
                    public C03872(WindowInsetsAnimationCompat windowInsetsAnimationCompat2, View view2) {
                        windowInsetsAnimationCompat = windowInsetsAnimationCompat2;
                        view = view2;
                    }
                ...
                OneShotPreDrawListener.add(view2, new Runnable() { // from class: androidx.core.view.WindowInsetsAnimationCompat.Impl21.Impl21OnApplyWindowInsetsListener.3
                    ...
                    public RunnableC03883(View view2, WindowInsetsAnimationCompat windowInsetsAnimationCompat2, BoundsCompat boundsCompatComputeAnimationBounds2, ValueAnimator duration2) {
                        view = view2;
                        windowInsetsAnimationCompat = windowInsetsAnimationCompat2;
            ...
            public class C03861 implements ValueAnimator.AnimatorUpdateListener {
                final /* synthetic */ WindowInsetsAnimationCompat val$anim;
                final /* synthetic */ int val$animationMask;
                final /* synthetic */ WindowInsetsCompat val$startingInsets;
                final /* synthetic */ WindowInsetsCompat val$targetInsets;
            ...
            public class C03872 extends AnimatorListenerAdapter {
                final /* synthetic */ WindowInsetsAnimationCompat val$anim;
                final /* synthetic */ View val$v;
            ...
            public class RunnableC03883 implements Runnable {
                final /* synthetic */ WindowInsetsAnimationCompat val$anim;
                final /* synthetic */ BoundsCompat val$animationBounds;
                final /* synthetic */ ValueAnimator val$animator;
                final /* synthetic */ View val$v;
    ...
    public static class Impl30 extends Impl {
        ...
        public Impl30(int i, Interpolator interpolator, long j) {
            this(AbstractC0389x6f32a476.m138m(i, interpolator, j));
        }
        ...
        public static class ProxyCallback extends WindowInsetsAnimation$Callback {
            ...
            public WindowInsets onProgress(WindowInsets windowInsets, List<WindowInsetsAnimation> list) {
                ...
                for (int size = list.size() - 1; size >= 0; size--) {
                    WindowInsetsAnimation windowInsetsAnimationM141m = C0392x30864cc7.m141m(list.get(size));
                    WindowInsetsAnimationCompat windowInsetsAnimationCompat = getWindowInsetsAnimationCompat(windowInsetsAnimationM141m);
                    windowInsetsAnimationCompat.setFraction(windowInsetsAnimationM141m.getFraction());
        ...
        public static WindowInsetsAnimation.Bounds createPlatformBounds(BoundsCompat boundsCompat) {
            AbstractC0391x6f32a478.m140m();
            return AbstractC0390x6f32a477.m139m(boundsCompat.getLowerBound().toPlatformInsets(), boundsCompat.getUpperBound().toPlatformInsets());
        }
