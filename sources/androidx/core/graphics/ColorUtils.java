...
public abstract class ColorUtils {
    ...
    public static double calculateContrast(int i, int i2) {
        if (Color.alpha(i2) != 255) {
            Buffer$$ExternalSyntheticBUOutline4.m978m("background can not be translucent: #", Integer.toHexString(i2));
            return 0.0d;
        }
    ...
    public static int setAlphaComponent(int i, int i2) {
        ...
        g$$ExternalSyntheticBUOutline1.m207m("alpha must be between 0 and 255.");
        return 0;
    }
    ...
    public static void RGBToXYZ(int i, int i2, int i3, double[] dArr) {
        if (dArr.length != 3) {
            g$$ExternalSyntheticBUOutline1.m207m("outXyz must have a length of 3.");
            return;
        }
