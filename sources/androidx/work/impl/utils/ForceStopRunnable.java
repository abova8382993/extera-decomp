            ...
            if (i >= 30) {
                ...
                if (historicalProcessExitReasons != null && !historicalProcessExitReasons.isEmpty()) {
                    ...
                    for (int i2 = 0; i2 < historicalProcessExitReasons.size(); i2++) {
                        ApplicationExitInfo applicationExitInfoM199m = ForceStopRunnable$$ExternalSyntheticApiModelOutline0.m199m(historicalProcessExitReasons.get(i2));
                        if (applicationExitInfoM199m.getReason() == 10 && applicationExitInfoM199m.getTimestamp() >= lastForceStopEventMillis) {
                            return true;
                        }
                    }
                }
