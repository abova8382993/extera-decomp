    ...
    public ListenableFuture<Void> setForegroundAsync(final Context context, final UUID uuid, final ForegroundInfo foregroundInfo) {
        return ListenableFutureKt.executeAsync(this.mTaskExecutor.getSerialTaskExecutor(), "setForegroundAsync", new Function0() { // from class: androidx.work.impl.utils.WorkForegroundUpdater$$ExternalSyntheticLambda0
            ...
            public final Object invoke() {
                return WorkForegroundUpdater.m2123$r8$lambda$Ik9WYk9fFXWE3Htab7GTHBbvxc(this.f$0, uuid, foregroundInfo, context);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$Ik9WY-k9fFXWE3Htab7GTHBbvxc, reason: not valid java name */
    public static /* synthetic */ Void m2123$r8$lambda$Ik9WYk9fFXWE3Htab7GTHBbvxc(WorkForegroundUpdater workForegroundUpdater, UUID uuid, ForegroundInfo foregroundInfo, Context context) {
        workForegroundUpdater.getClass();
        String string = uuid.toString();
        WorkSpec workSpec = workForegroundUpdater.mWorkSpecDao.getWorkSpec(string);
        if (workSpec == null || workSpec.state.isFinished()) {
            Segment$$ExternalSyntheticBUOutline1.m992m("Calls to setForegroundAsync() must complete before a ListenableWorker signals completion of work by returning an instance of Result.");
            return null;
        }
