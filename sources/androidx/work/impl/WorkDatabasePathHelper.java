...
public final class WorkDatabasePathHelper {
    ...
    public final Map migrationPaths(Context context) {
        ...
        for (String str : strArr) {
            Pair pairM1081to = TuplesKt.m1081to(new File(defaultDatabasePath.getPath() + str), new File(databasePath.getPath() + str));
            linkedHashMap.put(pairM1081to.getFirst(), pairM1081to.getSecond());
        }
        return MapsKt.plus(linkedHashMap, TuplesKt.m1081to(defaultDatabasePath, databasePath));
    }
