...
public class WorkManagerImpl extends WorkManager {
    ...
    public WorkManagerImpl(Context context, Configuration configuration, TaskExecutor taskExecutor, WorkDatabase workDatabase, List<Scheduler> list, Processor processor, Trackers trackers) {
        ...
        if (Api24Impl.isDeviceProtectedStorage(applicationContext)) {
            Segment$$ExternalSyntheticBUOutline1.m992m("Cannot initialize WorkManager in direct boot mode");
            throw null;
        }
    ...
    public Operation enqueue(List<? extends WorkRequest> list) {
        if (list.isEmpty()) {
            g$$ExternalSyntheticBUOutline1.m207m("enqueue needs at least one WorkRequest.");
            return null;
        }
    ...
    public void rescheduleEligibleWork() {
        TracerKt.traced(getConfiguration().getTracer(), "ReschedulingWork", new Function0() { // from class: androidx.work.impl.WorkManagerImpl$$ExternalSyntheticLambda0
            ...
            public final Object invoke() {
                return WorkManagerImpl.m2099$r8$lambda$Wf3V6NEpTzV_1f6Vedbhp5FiGA(this.f$0);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$Wf3V6NEp-TzV_1f6Vedbhp5FiGA */
    public static /* synthetic */ Unit m2099$r8$lambda$Wf3V6NEpTzV_1f6Vedbhp5FiGA(WorkManagerImpl workManagerImpl) {
