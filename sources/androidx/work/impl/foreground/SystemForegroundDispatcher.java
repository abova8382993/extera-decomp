...
public class SystemForegroundDispatcher implements OnConstraintsStateChangedListener, ExecutionListener {
    ...
    private void handleNotify(Intent intent) {
        if (this.mCallback == null) {
            Segment$$ExternalSyntheticBUOutline1.m992m("handleNotify was called on the destroyed dispatcher");
            return;
        }
        ...
        if (notification == null) {
            g$$ExternalSyntheticBUOutline1.m207m("Notification passed in the intent was null.");
            return;
        }
