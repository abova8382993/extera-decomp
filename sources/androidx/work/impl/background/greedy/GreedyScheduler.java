...
public class GreedyScheduler implements Scheduler, OnConstraintsStateChangedListener, ExecutionListener {
    ...
    /* JADX WARN: Type inference failed for: r2v4, types: [androidx.work.impl.model.WorkGenerationalId, java.lang.Object, kotlin.coroutines.Continuation] */
            ...
            try {
                if (!hashSet.isEmpty()) {
                    ...
                    for (WorkSpec workSpec2 : hashSet) {
                        ?? GenerationalId = WorkSpecKt.generationalId(workSpec2);
                        if (this.mConstrainedWorkSpecs.probeCoroutineSuspended((Continuation<?>) GenerationalId) == 0) {
                            this.mConstrainedWorkSpecs.put((WorkGenerationalId) GenerationalId, WorkConstraintsTrackerKt.listen(this.mConstraintsTracker, workSpec2, this.mTaskExecutor.getTaskCoroutineDispatcher(), this));
                        }
                    }
                }
            } catch (Throwable th) {
    ...
    public static class AttemptData {
        ...
        public /* synthetic */ AttemptData(int i, long j, C08701 c08701) {
            this(i, j);
        }
