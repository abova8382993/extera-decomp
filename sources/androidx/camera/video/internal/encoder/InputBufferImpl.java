...
abstract class InputBufferImpl implements InputBuffer {
    ...
    public InputBufferImpl(MediaCodec mediaCodec, int i) {
        ...
        this.mTerminationFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.video.internal.encoder.InputBufferImpl$$ExternalSyntheticLambda0
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return InputBufferImpl.m1925$r8$lambda$eInTYqtZ8fzSXhIp4uswMKYH0w(atomicReference, completer);
            }
        });
    ...
    public static /* synthetic */ Object m1925$r8$lambda$eInTYqtZ8fzSXhIp4uswMKYH0w(AtomicReference atomicReference, CallbackToFutureAdapter.Completer completer) {
    ...
    private void throwIfTerminated() {
        if (this.mTerminated.get()) {
            Segment$$ExternalSyntheticBUOutline1.m992m("The buffer is submitted or canceled.");
        }
    }
}
