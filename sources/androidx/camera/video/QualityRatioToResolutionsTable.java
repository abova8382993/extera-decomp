...
class QualityRatioToResolutionsTable {
    ...
    QualityRatioToResolutionsTable(List list, Map map) {
        for (Quality quality : sQualityRangeMap.keySet()) {
            this.mTable.put(QualityRatio.m107of(quality, -1), new ArrayList());
            Iterator it = sAspectRatioMap.keySet().iterator();
            while (it.hasNext()) {
                this.mTable.put(QualityRatio.m107of(quality, ((Integer) it.next()).intValue()), new ArrayList());
            }
        }
    ...
    private List getQualityRatioRow(Quality quality, int i) {
        return (List) this.mTable.get(QualityRatio.m107of(quality, i));
    }
    ...
    static abstract class QualityRatio {
        ...
        static QualityRatio m107of(Quality quality, int i) {
