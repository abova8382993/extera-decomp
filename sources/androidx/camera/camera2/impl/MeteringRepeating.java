...
@Metadata(m876d1 = {"\u0000f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\u0018\u00002\u00020\u0001:\u0002%&B\u001f\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007¢\u0006\u0004\b\b\u0010\tJ\u0018\u0010\u0012\u001a\u00020\u00052\u0006\u0010\u0013\u001a\u00020\u00142\u0006\u0010\u0015\u001a\u00020\u0016H\u0016J\u0010\u0010\u0017\u001a\u00020\u00182\u0006\u0010\u0004\u001a\u00020\u0019H\u0016J\u001a\u0010\u001a\u001a\u00020\u001b2\u0006\u0010\u001c\u001a\u00020\u001b2\b\u0010\u001d\u001a\u0004\u0018\u00010\u001bH\u0014J\b\u0010\u001e\u001a\u00020\u001fH\u0016J\u0006\u0010 \u001a\u00020\u001fJ\u0010\u0010!\u001a\u00020\"2\u0006\u0010#\u001a\u00020\u000bH\u0002J\u0010\u0010$\u001a\u00020\u00112\u0006\u0010#\u001a\u00020\u000bH\u0003R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0007X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\u000bX\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\f\u001a\u00020\rX\u0082\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u000e\u001a\u0004\u0018\u00010\u000fX\u0082\u000e¢\u0006\u0002\n\u0000R\u0014\u0010\u0010\u001a\u0004\u0018\u00010\u00118\u0002@\u0002X\u0083\u000e¢\u0006\u0002\n\u0000¨\u0006'"}, m877d2 = {"Landroidx/camera/camera2/impl/MeteringRepeating;", "Landroidx/camera/core/UseCase;", "cameraProperties", "Landroidx/camera/camera2/impl/CameraProperties;", "config", "Landroidx/camera/camera2/impl/MeteringRepeating$MeteringRepeatingConfig;", "displayInfoManager", "Landroidx/camera/camera2/impl/DisplayInfoManager;", "<init>", "(Landroidx/camera/camera2/impl/CameraProperties;Landroidx/camera/camera2/impl/MeteringRepeating$MeteringRepeatingConfig;Landroidx/camera/camera2/impl/DisplayInfoManager;)V", "meteringSurfaceSize", "Landroid/util/Size;", "deferrableSurfaceLock", _UrlKt.FRAGMENT_ENCODE_SET, "closeableErrorListener", "Landroidx/camera/core/impl/SessionConfig$CloseableErrorListener;", "deferrableSurface", "Landroidx/camera/core/impl/DeferrableSurface;", "getDefaultConfig", "applyDefaultConfig", _UrlKt.FRAGMENT_ENCODE_SET, "factory", "Landroidx/camera/core/impl/UseCaseConfigFactory;", "getUseCaseConfigBuilder", "Landroidx/camera/camera2/impl/MeteringRepeating$Builder;", "Landroidx/camera/core/impl/Config;", "onSuggestedStreamSpecUpdated", "Landroidx/camera/core/impl/StreamSpec;", "primaryStreamSpec", "secondaryStreamSpec", "onUnbind", _UrlKt.FRAGMENT_ENCODE_SET, "setupSession", "createPipeline", "Landroidx/camera/core/impl/SessionConfig$Builder;", "resolution", "createAndManageDeferrableSurface", "MeteringRepeatingConfig", "Builder", "camera-camera2"}, m878k = 1, m879mv = {2, 1, 0}, m881xi = 48)
...
public final class MeteringRepeating extends UseCase {
    ...
    public MeteringRepeating(CameraProperties cameraProperties, MeteringRepeatingConfig meteringRepeatingConfig, DisplayInfoManager displayInfoManager) {
    ...
    @Override // androidx.camera.core.UseCase
    public StreamSpec onSuggestedStreamSpecUpdated(StreamSpec primaryStreamSpec, StreamSpec secondaryStreamSpec) {
        updateSessionConfig(CollectionsKt.listOf(createPipeline(this.meteringSurfaceSize).build()));
        return primaryStreamSpec.toBuilder().setResolution(this.meteringSurfaceSize).build();
    }
    ...
    private final SessionConfig.Builder createPipeline(final Size resolution) {
        ...
        SessionConfig.CloseableErrorListener closeableErrorListener2 = new SessionConfig.CloseableErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.camera2.impl.MeteringRepeating$$ExternalSyntheticLambda0
            ...
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                MeteringRepeating.$r8$lambda$BPlB8isfuWKFvMqTcjDrqYh8Ecw(this.f$0, resolution, sessionConfig, sessionError);
            }
        });
    ...
    public static void $r8$lambda$BPlB8isfuWKFvMqTcjDrqYh8Ecw(MeteringRepeating meteringRepeating, Size size, SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
