...
public final class C0153x125bb28e extends SuspendLambda implements Function2 {
    ...
    public C0153x125bb28e(DeferredUseCaseCameraRequestControl deferredUseCaseCameraRequestControl, Continuation continuation, Config config, Map map) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new C0153x125bb28e(this.this$0, continuation, this.$config$inlined, this.$tags$inlined);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
        return ((C0153x125bb28e) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
