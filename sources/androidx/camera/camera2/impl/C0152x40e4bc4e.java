...
public final class C0152x40e4bc4e extends SuspendLambda implements Function2 {
    ...
    public C0152x40e4bc4e(DeferredUseCaseCameraRequestControl deferredUseCaseCameraRequestControl, Continuation continuation, List list, List list2, List list3) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new C0152x40e4bc4e(this.this$0, continuation, this.$aeRegions$inlined, this.$afRegions$inlined, this.$awbRegions$inlined);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
        return ((C0152x40e4bc4e) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
