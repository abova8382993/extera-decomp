...
public final class StandardCamera2CaptureSequenceProcessorFactory implements Camera2CaptureSequenceProcessorFactory {
    ...
    public StandardCamera2CaptureSequenceProcessorFactory(Threads threads, CameraGraph.Config config, StreamGraphImpl streamGraphImpl, Camera2Quirks camera2Quirks, StrictMode strictMode) {
        this.threads = threads;
        this.graphConfig = config;
        this.streamGraph = streamGraphImpl;
        this.quirks = camera2Quirks;
    ...
    public CaptureSequenceProcessor<?, CaptureSequence<Object>> create(CameraCaptureSessionWrapper session, Map<StreamId, ? extends Surface> streamToSurfaceMap, Map<OutputId, ? extends Surface> outputToSurfaceMap) {
        return new Camera2CaptureSequenceProcessor(session, this.threads, this.graphConfig.getDefaultTemplate(), streamToSurfaceMap, outputToSurfaceMap, this.streamGraph, this.strictMode, this.quirks.m68x94af7f6a(this.graphConfig), null);
    }
}
