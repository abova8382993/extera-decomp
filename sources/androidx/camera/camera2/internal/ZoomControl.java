...
final class ZoomControl {
    ...
    ListenableFuture setZoomRatio(float f) {
        ...
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.ZoomControl$$ExternalSyntheticLambda0
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return ZoomControl.$r8$lambda$uQgV00gAZsyQZYEjjiEtE90Na8E(this.f$0, zoomStateCreate, completer);
            }
        });
    }

    public static /* synthetic */ Object $r8$lambda$uQgV00gAZsyQZYEjjiEtE90Na8E(final ZoomControl zoomControl, final ZoomState zoomState, final CallbackToFutureAdapter.Completer completer) {
        zoomControl.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.ZoomControl$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.submitCameraZoomRatio(completer, zoomState);
            }
        });
        return "setZoomRatio";
    }
    ...
    public void submitCameraZoomRatio(CallbackToFutureAdapter.Completer completer, ZoomState zoomState) {
        ZoomState zoomStateCreate;
        if (!this.mIsActive) {
            synchronized (this.mCurrentZoomState) {
                this.mCurrentZoomState.setZoomRatio(1.0f);
