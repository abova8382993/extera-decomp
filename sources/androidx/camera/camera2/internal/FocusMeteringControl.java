...
class FocusMeteringControl {
    ...
    void addFocusMeteringOptions(Camera2ImplConfig.Builder builder) {
        ...
        Object objValueOf = Integer.valueOf(this.mCameraControl.getSupportedAfMode(defaultAfMode));
        Config.OptionPriority optionPriority = Config.OptionPriority.REQUIRED;
        builder.setCaptureRequestOptionWithPriority(key, objValueOf, optionPriority);
    ...
    public void startFocusAndMeteringInternal(CallbackToFutureAdapter.Completer completer, FocusMeteringAction focusMeteringAction, long j) {
        if (!this.mIsActive) {
    ...
    private void executeMeteringAction(MeteringRectangle[] meteringRectangleArr, MeteringRectangle[] meteringRectangleArr2, MeteringRectangle[] meteringRectangleArr3, FocusMeteringAction focusMeteringAction, long j) {
        ...
        Runnable runnable = new Runnable() { // from class: androidx.camera.camera2.internal.FocusMeteringControl$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                FocusMeteringControl focusMeteringControl = this.f$0;
                focusMeteringControl.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.FocusMeteringControl$$ExternalSyntheticLambda7
                    @Override // java.lang.Runnable
                    public final void run() {
                        FocusMeteringControl.$r8$lambda$hlEiXqoi1nhA7ujpjVwxm9MfUT8(focusMeteringControl, j);
                    }
                });
            }
        };
        ...
        if (focusMeteringAction.isAutoCancelEnabled()) {
            this.mAutoCancelHandle = this.mScheduler.schedule(new Runnable() { // from class: androidx.camera.camera2.internal.FocusMeteringControl$$ExternalSyntheticLambda5
                ...
                public final void run() {
                    FocusMeteringControl focusMeteringControl = this.f$0;
                    focusMeteringControl.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.FocusMeteringControl$$ExternalSyntheticLambda6
                        @Override // java.lang.Runnable
                        public final void run() {
                            FocusMeteringControl.$r8$lambda$u72i9yd9zUef2xWGxHMMqDzjnkA(focusMeteringControl, j);
                        }
                    });
                }
    ...
    void cancelFocusAndMeteringInternal(CallbackToFutureAdapter.Completer completer) {
        ...
        if (this.mRunningCancelCompleter != null) {
            ...
            Camera2CameraControlImpl.CaptureResultListener captureResultListener = new Camera2CameraControlImpl.CaptureResultListener() { // from class: androidx.camera.camera2.internal.FocusMeteringControl$$ExternalSyntheticLambda2
                @Override // androidx.camera.camera2.internal.Camera2CameraControlImpl.CaptureResultListener
                public final boolean onCaptureResult(TotalCaptureResult totalCaptureResult) {
