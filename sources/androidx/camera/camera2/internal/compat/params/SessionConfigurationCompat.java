...
public final class SessionConfigurationCompat {
    ...
    static List transformToCompat(List list) {
        ...
        while (it.hasNext()) {
            arrayList.add(OutputConfigurationCompat.wrap(CaptureSession$$ExternalSyntheticApiModelOutline2.m(it.next())));
        }
        return arrayList;
    }
    ...
    public static List transformFromCompat(List list) {
        ...
        Iterator it = list.iterator();
        while (it.hasNext()) {
            arrayList.add(CaptureSession$$ExternalSyntheticApiModelOutline2.m(((OutputConfigurationCompat) it.next()).unwrap()));
        }
        return arrayList;
    }
