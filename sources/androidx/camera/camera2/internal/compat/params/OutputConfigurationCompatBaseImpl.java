...
class OutputConfigurationCompatBaseImpl implements OutputConfigurationCompat.OutputConfigurationCompatImpl {
    ...
    private static final class OutputConfigurationParamsApi21 {
        ...
        public int hashCode() {
            ...
            return OutputConfigurationCompatApi24Impl$OutputConfigurationParamsApi24$$ExternalSyntheticBackport0.m(this.mDynamicRangeProfile) ^ ((iHashCode3 << 5) - iHashCode3);
        }
    }
}
