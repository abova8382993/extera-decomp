    ...
    public void close() {
        ...
        this.mRequestMonitor.getRequestsProcessedFuture().addListener(new Runnable() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionImpl$$ExternalSyntheticLambda1
            ...
            public final void run() {
                SynchronizedCaptureSessionImpl.m33$r8$lambda$mXxGqxRa3j8xCOuzEWSiyY83Sk(this.f$0);
            }
        }, getExecutor());
    }

    /* JADX INFO: renamed from: $r8$lambda$mXxGqxRa3j8xCOuz-EWSiyY83Sk, reason: not valid java name */
    public static /* synthetic */ void m33$r8$lambda$mXxGqxRa3j8xCOuzEWSiyY83Sk(SynchronizedCaptureSessionImpl synchronizedCaptureSessionImpl) {
