...
abstract class SynchronizedCaptureSessionBaseImpl extends SynchronizedCaptureSession.StateCallback implements SynchronizedCaptureSession, SynchronizedCaptureSession.Opener {
            ...
            try {
                ...
                FutureChain futureChainTransformAsync = FutureChain.from(DeferrableSurfaces.surfaceListWithTimeout(list, false, j, getExecutor(), this.mScheduledExecutorService)).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionBaseImpl$$ExternalSyntheticLambda1
                    ...
                    public final ListenableFuture apply(Object obj) {
                        return SynchronizedCaptureSessionBaseImpl.m31$r8$lambda$aopvf1kQ2K0e9IHBo0tv6mKpkk(this.f$0, list, (List) obj);
                    }
                }, getExecutor());
    ...
    /* JADX INFO: renamed from: $r8$lambda$aopvf1kQ2K0-e9IHBo0tv6mKpkk, reason: not valid java name */
    public static /* synthetic */ ListenableFuture m31$r8$lambda$aopvf1kQ2K0e9IHBo0tv6mKpkk(SynchronizedCaptureSessionBaseImpl synchronizedCaptureSessionBaseImpl, List list, List list2) {
        synchronizedCaptureSessionBaseImpl.getClass();
        Logger.d("SyncCaptureSessionBase", "[" + synchronizedCaptureSessionBaseImpl + "] getSurface done with results: " + list2);
        if (list2.isEmpty()) {
    ...
    public List createHighSpeedRequestList(CaptureRequest captureRequest) {
        ...
        if (cameraCaptureSession instanceof CameraConstrainedHighSpeedCaptureSession) {
            return Api23Impl.createHighSpeedRequestList((CameraConstrainedHighSpeedCaptureSession) cameraCaptureSession, captureRequest);
        }
    ...
    public void close() {
        ...
        getExecutor().execute(new Runnable() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionBaseImpl$$ExternalSyntheticLambda3
            ...
            public final void run() {
                ...
                synchronizedCaptureSessionBaseImpl.m32$r8$lambda$dP3DguhPXTXPVRCgeBvlk8lcbs(synchronizedCaptureSessionBaseImpl);
            }
        });
    }
    ...
    public static /* synthetic */ void $r8$lambda$AW8dnIDzjDAI10RRH0EHT52a0kI(SynchronizedCaptureSessionBaseImpl synchronizedCaptureSessionBaseImpl, SynchronizedCaptureSession synchronizedCaptureSession) {
        ...
        synchronizedCaptureSessionBaseImpl.m32$r8$lambda$dP3DguhPXTXPVRCgeBvlk8lcbs(synchronizedCaptureSession);
    ...
    @Override // androidx.camera.camera2.internal.SynchronizedCaptureSession.StateCallback
    /* JADX INFO: renamed from: onSessionFinished, reason: merged with bridge method [inline-methods] */
    public void m32$r8$lambda$dP3DguhPXTXPVRCgeBvlk8lcbs(final SynchronizedCaptureSession synchronizedCaptureSession) {
        ListenableFuture listenableFuture;
        synchronized (this.mLock) {
            try {
        ...
        if (listenableFuture != null) {
            listenableFuture.addListener(new Runnable() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionBaseImpl$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    SynchronizedCaptureSessionBaseImpl.m30$r8$lambda$ZNWc4mXlAbAd0_P_G2IriBPS9w(this.f$0, synchronizedCaptureSession);
                }
            }, CameraXExecutors.directExecutor());
        }
    }

    /* JADX INFO: renamed from: $r8$lambda$ZN-Wc4mXlAbAd0_P_G2IriBPS9w, reason: not valid java name */
    public static /* synthetic */ void m30$r8$lambda$ZNWc4mXlAbAd0_P_G2IriBPS9w(SynchronizedCaptureSessionBaseImpl synchronizedCaptureSessionBaseImpl, SynchronizedCaptureSession synchronizedCaptureSession) {
        Objects.requireNonNull(synchronizedCaptureSessionBaseImpl.mCaptureSessionStateCallback);
        synchronizedCaptureSessionBaseImpl.mCaptureSessionStateCallback.m32$r8$lambda$dP3DguhPXTXPVRCgeBvlk8lcbs(synchronizedCaptureSession);
    }
