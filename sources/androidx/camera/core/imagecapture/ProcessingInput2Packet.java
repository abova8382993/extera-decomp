...
final class ProcessingInput2Packet implements Operation {
    ProcessingInput2Packet() {
    }

    @Override // androidx.camera.core.processing.Operation
    public Packet apply(ProcessingNode.InputPacket inputPacket) throws ImageCaptureException {
    ...
    private static Packet createPacket(ProcessingRequest processingRequest, Exif exif, ImageProxy imageProxy) {
        return Packet.m95of(imageProxy, exif, processingRequest.getCropRect(), processingRequest.getRotationDegrees(), processingRequest.getSensorToBufferTransform(), getCameraCaptureResult(imageProxy));
    }

    private static Packet createPacketWithHalRotation(ProcessingRequest processingRequest, Exif exif, ImageProxy imageProxy) {
        ...
        return Packet.m96of(imageProxy, exif, rotatedSize, getUpdatedCropRect(processingRequest.getCropRect(), rectToRect), exif.getRotation(), getUpdatedTransform(processingRequest.getSensorToBufferTransform(), rectToRect), getCameraCaptureResult(imageProxy));
    }
