...
public class StreamSharing extends UseCase {
    ...
    public StreamSpec onSuggestedStreamSpecUpdated(StreamSpec streamSpec, StreamSpec streamSpec2) {
        Logger.m74d("StreamSharing", "onSuggestedStreamSpecUpdated: primaryStreamSpec = " + streamSpec + ", secondaryStreamSpec " + streamSpec2);
    ...
    private List<SessionConfig> createPipelineAndUpdateChildrenSpecs(String str, String str2, UseCaseConfig<?> useCaseConfig, StreamSpec streamSpec, StreamSpec streamSpec2) {
        ...
        if (streamSpec2 == null) {
            ...
            return ImageCapture$$ExternalSyntheticBackport1.m73m(new Object[]{this.mSessionConfigBuilder.build()});
        }
        ...
        return ImageCapture$$ExternalSyntheticBackport1.m73m(new Object[]{this.mSessionConfigBuilder.build(), this.mSecondarySessionConfigBuilder.build()});
    }
    ...
    private void transformAndOutputToChildUseCases(SurfaceEdge surfaceEdge, SurfaceProcessorNode surfaceProcessorNode, boolean z) {
        ...
        SurfaceProcessorNode.Out outTransform = surfaceProcessorNode.transform(SurfaceProcessorNode.AbstractC0296In.m97of(surfaceEdge, new ArrayList(childrenOutConfigs.values())));
    ...
    private void transformDualSurfacesAndOutputToChildUseCases(SurfaceEdge surfaceEdge, SurfaceEdge surfaceEdge2, DualSurfaceProcessorNode dualSurfaceProcessorNode, StreamSpec streamSpec) {
        ...
        DualSurfaceProcessorNode.Out outTransform = this.mDualSharingNode.transform(DualSurfaceProcessorNode.AbstractC0298In.m99of(surfaceEdge, surfaceEdge2, new ArrayList(childrenOutConfigs.values())));
        HashMap map = new HashMap();
