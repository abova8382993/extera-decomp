...
final class AutoValue_StreamSpec extends StreamSpec {
    ...
    public /* synthetic */ AutoValue_StreamSpec(Size size, Size size2, DynamicRange dynamicRange, int i, Range range, Config config, boolean z, C02671 c02671) {
    ...
    public static final class Builder extends StreamSpec.Builder {
        ...
        public /* synthetic */ Builder(StreamSpec streamSpec, C02671 c02671) {
            this(streamSpec);
        }
        ...
        public StreamSpec.Builder setOriginalConfiguredResolution(Size size) {
            if (size == null) {
                g$$ExternalSyntheticBUOutline2.m208m("Null originalConfiguredResolution");
                return null;
            }
        ...
        public StreamSpec.Builder setExpectedFrameRateRange(Range<Integer> range) {
            if (range == null) {
                g$$ExternalSyntheticBUOutline2.m208m("Null expectedFrameRateRange");
                return null;
            }
            this.expectedFrameRateRange = range;
            return this;
