...
public interface ImageOutputConfig extends ReadableConfig {
    ...
    static void validateConfig(ImageOutputConfig imageOutputConfig) {
        ...
        if (zHasTargetAspectRatio && z) {
            g$$ExternalSyntheticBUOutline1.m207m("Cannot use both setTargetResolution and setTargetAspectRatio on the same config.");
        } else if (imageOutputConfig.getResolutionSelector(null) != null) {
            if (zHasTargetAspectRatio || z) {
                g$$ExternalSyntheticBUOutline1.m207m("Cannot use setTargetResolution or setTargetAspectRatio with setResolutionSelector on the same config.");
            }
        }
    }
}
