...
final class AutoValue_SurfaceSizeDefinition extends SurfaceSizeDefinition {
    ...
    private final Map maximum16x9SizeMap;
    private final Map maximum4x3SizeMap;
    private final Map maximumSizeMap;
    private final Size previewSize;
    private final Size recordSize;
    private final Map s1440pSizeMap;
    private final Map s720pSizeMap;
    private final Map ultraMaximumSizeMap;

    AutoValue_SurfaceSizeDefinition(Size size, Map map, Size size2, Map map2, Size size3, Map map3, Map map4, Map map5, Map map6) {
        if (size == null) {
    ...
    @Override // androidx.camera.core.impl.SurfaceSizeDefinition
    public Map getMaximum4x3SizeMap() {
        return this.maximum4x3SizeMap;
    }

    @Override // androidx.camera.core.impl.SurfaceSizeDefinition
    public Map getMaximum16x9SizeMap() {
