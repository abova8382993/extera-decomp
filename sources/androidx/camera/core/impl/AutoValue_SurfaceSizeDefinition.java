...
final class AutoValue_SurfaceSizeDefinition extends SurfaceSizeDefinition {
    ...
    public AutoValue_SurfaceSizeDefinition(Size size, Map<Integer, Size> map, Size size2, Map<Integer, Size> map2, Size size3, Map<Integer, Size> map3, Map<Integer, Size> map4, Map<Integer, Size> map5, Map<Integer, Size> map6) {
        if (size == null) {
            g$$ExternalSyntheticBUOutline2.m208m("Null analysisSize");
            throw null;
        }
        this.analysisSize = size;
        if (map == null) {
            g$$ExternalSyntheticBUOutline2.m208m("Null s720pSizeMap");
            throw null;
        }
        this.s720pSizeMap = map;
        if (size2 == null) {
            g$$ExternalSyntheticBUOutline2.m208m("Null previewSize");
            throw null;
        }
        this.previewSize = size2;
        if (map2 == null) {
            g$$ExternalSyntheticBUOutline2.m208m("Null s1440pSizeMap");
            throw null;
        }
        this.s1440pSizeMap = map2;
        if (size3 == null) {
            g$$ExternalSyntheticBUOutline2.m208m("Null recordSize");
            throw null;
        }
        this.recordSize = size3;
        if (map3 == null) {
            g$$ExternalSyntheticBUOutline2.m208m("Null maximumSizeMap");
            throw null;
        }
        this.maximumSizeMap = map3;
        if (map4 == null) {
            g$$ExternalSyntheticBUOutline2.m208m("Null maximum4x3SizeMap");
            throw null;
        }
        this.maximum4x3SizeMap = map4;
        if (map5 == null) {
            g$$ExternalSyntheticBUOutline2.m208m("Null maximum16x9SizeMap");
            throw null;
        }
        this.maximum16x9SizeMap = map5;
        if (map6 == null) {
            g$$ExternalSyntheticBUOutline2.m208m("Null ultraMaximumSizeMap");
            throw null;
        }
