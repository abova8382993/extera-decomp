...
public final class ImageCapture extends UseCase {
    ...
    protected UseCaseConfig onMergeConfig(CameraInfoInternal cameraInfoInternal, UseCaseConfig.Builder builder) {
        ...
        if (cameraInfoInternal.getCameraQuirks().contains(SoftwareJpegEncodingPreferredQuirk.class)) {
            ...
            if (bool.equals(mutableConfig.retrieveOption(option, bool2))) {
                Logger.m81w("ImageCapture", "Device quirk suggests software JPEG encoder, but it has been explicitly disabled.");
            } else {
                Logger.m80i("ImageCapture", "Requesting software JPEG due to device quirk.");
    ...
    public void onCameraControlReady() {
        Logger.m76d("ImageCapture", "onCameraControlReady");
    ...
    boolean enforceSoftwareJpegConstraints(MutableConfig mutableConfig) {
        ...
        if (bool.equals(mutableConfig.retrieveOption(option, bool2))) {
            if (isSessionProcessorEnabledInCurrentCamera()) {
                Logger.m81w("ImageCapture", "Software JPEG cannot be used with Extensions.");
                z = false;
            } else {
                z = true;
            }
            ...
            if (num == null || num.intValue() == 256) {
                ...
                Logger.m81w("ImageCapture", "Software JPEG cannot be used with non-JPEG output buffer format.");
            }
            if (!z2) {
                Logger.m81w("ImageCapture", "Unable to support software JPEG. Disabling.");
    ...
    protected StreamSpec onSuggestedStreamSpecUpdated(StreamSpec streamSpec, StreamSpec streamSpec2) {
        Logger.m76d("ImageCapture", "onSuggestedStreamSpecUpdated: primaryStreamSpec = " + streamSpec + ", secondaryStreamSpec " + streamSpec2);
        ...
        updateSessionConfig(ImageCapture$$ExternalSyntheticBackport1.m75m(new Object[]{builderCreatePipeline.build()}));
        notifyActive();
        return streamSpec;
    }
    ...
    class C02481 implements ImageCaptureControl {
        C02481() {
        }
    }
    ...
    public static /* synthetic */ void $r8$lambda$3PPYv7aM85CQohSH7HAYGLoL3uo(ImageCapture imageCapture, androidx.camera.core.impl.SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
        ...
        imageCapture.updateSessionConfig(ImageCapture$$ExternalSyntheticBackport1.m75m(new Object[]{builderCreatePipeline.build()}));
