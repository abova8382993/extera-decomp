...
import com.sun.jna.Structure$$ExternalSyntheticBUOutline2;
...
public abstract class ImageUtil {
    ...
    public static Bitmap createBitmapFromImageProxy(ImageProxy imageProxy) {
        ...
        Structure$$ExternalSyntheticBUOutline2.m557m("Incorrect image format of the input image proxy: ", imageProxy.getFormat(), ", only ImageFormat.YUV_420_888 and PixelFormat.RGBA_8888 are supported");
        return null;
    }
    ...
    public static byte[] jpegImageToJpegByteArray(ImageProxy imageProxy) {
        if (!isJpegFormats(imageProxy.getFormat())) {
            IntegerType$$ExternalSyntheticBUOutline0.m547m("Incorrect image format of the input image proxy: ", imageProxy.getFormat());
            return null;
        }
    ...
    private static Bitmap createBitmapFromJpegImage(ImageProxy imageProxy) {
        ...
        ByteString$$ExternalSyntheticBUOutline0.m979m("Decode jpeg byte array failed");
        return null;
    }
