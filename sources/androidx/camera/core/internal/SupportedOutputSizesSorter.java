...
public class SupportedOutputSizesSorter {
    ...
    public List<Size> getSortedSupportedOutputSizes(UseCaseConfig<?> useCaseConfig) {
        ...
        Logger.m74d("SupportedOutputSizesCollector", "useCaseConfig = " + useCaseConfig + ", candidateSizes = " + list);
    ...
    private List<Size> getResolutionCandidateList(List<Pair<Integer, Size[]>> list, int i) {
        ...
        if (arrayList.isEmpty()) {
            Logger.m79w("SupportedOutputSizesCollector", "The retrieved supported resolutions from camera info internal is empty. Format is " + i + ".");
        }
        return arrayList;
    }
    ...
    private static List<Size> applyResolutionFilter(List<Size> list, ResolutionFilter resolutionFilter, int i, int i2, int i3) {
        ...
        g$$ExternalSyntheticBUOutline1.m207m("The returned sizes list of the resolution filter must be a subset of the provided sizes list.");
        return null;
    }
    ...
    public static Rational getTargetAspectRatioRationalValue(int i, boolean z) {
        ...
        Logger.m76e("SupportedOutputSizesCollector", "Undefined target aspect ratio: " + i);
        return null;
    }
