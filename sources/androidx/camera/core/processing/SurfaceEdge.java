...
public class SurfaceEdge {
    ...
    public void setProvider(DeferrableSurface deferrableSurface) {
        ...
        settableSurface.setProvider(deferrableSurface, new SurfaceEdge$$ExternalSyntheticLambda4(settableSurface));
    }
    ...
    public SurfaceRequest createSurfaceRequest(CameraInternal cameraInternal, boolean z) {
        Threads.checkMainThread();
        checkNotClosed();
        SurfaceRequest surfaceRequest = new SurfaceRequest(this.mStreamSpec.getResolution(), cameraInternal, z, this.mStreamSpec.getDynamicRange(), this.mStreamSpec.getSessionType(), this.mStreamSpec.getExpectedFrameRateRange(), new Runnable() { // from class: androidx.camera.core.processing.SurfaceEdge$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                SurfaceEdge.m1880$r8$lambda$OUGeMRYPeF_WOgV3sPeeq2_z7c(this.f$0);
            }
        });
        try {
            ...
            SettableSurface settableSurface = this.mSettableSurface;
            Objects.requireNonNull(settableSurface);
            if (settableSurface.setProvider(deferrableSurface, new SurfaceEdge$$ExternalSyntheticLambda4(settableSurface))) {
    ...
    /* JADX INFO: renamed from: $r8$lambda$OUGeMRYPeF_WOgV3sPe-eq2_z7c */
    public static /* synthetic */ void m1880$r8$lambda$OUGeMRYPeF_WOgV3sPeeq2_z7c(final SurfaceEdge surfaceEdge) {
        surfaceEdge.getClass();
        CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.core.processing.SurfaceEdge$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                SurfaceEdge.m1881$r8$lambda$QHdR7T3HmMsEDLpEkRmCFFpf4(this.f$0);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$QHdR7T3HmMsEDLpE-k-RmCFFpf4 */
    public static /* synthetic */ void m1881$r8$lambda$QHdR7T3HmMsEDLpEkRmCFFpf4(SurfaceEdge surfaceEdge) {
    ...
    public static /* synthetic */ ListenableFuture $r8$lambda$fmIccKEiiPDQZ5pv_vs05SRNksM(SurfaceEdge surfaceEdge, final SettableSurface settableSurface, int i, SurfaceOutput.CameraInputInfo cameraInputInfo, SurfaceOutput.CameraInputInfo cameraInputInfo2, Surface surface) {
        ...
        try {
            ...
            surfaceOutputImpl.getCloseFuture().addListener(new Runnable() { // from class: androidx.camera.core.processing.SurfaceEdge$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void updateTransformation(final int i, final int i2) {
        Threads.runOnMain(new Runnable() { // from class: androidx.camera.core.processing.SurfaceEdge$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private void notifyTransformationInfoUpdate() {
        Threads.checkMainThread();
        SurfaceRequest.TransformationInfo transformationInfoM84of = SurfaceRequest.TransformationInfo.m84of(this.mCropRect, this.mRotationDegrees, this.mTargetRotation, hasCameraTransform(), this.mSensorToBufferTransform, this.mMirroring);
        SurfaceRequest surfaceRequest = this.mProviderSurfaceRequest;
        if (surfaceRequest != null) {
            surfaceRequest.updateTransformationInfo(transformationInfoM84of);
        }
        Iterator<Consumer<SurfaceRequest.TransformationInfo>> it = this.mTransformationUpdatesListeners.iterator();
        while (it.hasNext()) {
            it.next().accept(transformationInfoM84of);
        }
    }
    ...
    public static class SettableSurface extends DeferrableSurface {
        ...
        /* JADX INFO: renamed from: $r8$lambda$VdiGildDqQ-QQLDZiSabHKVcb7o */
        public static /* synthetic */ Object m1883$r8$lambda$VdiGildDqQQQLDZiSabHKVcb7o(SettableSurface settableSurface, CallbackToFutureAdapter.Completer completer) {
        ...
        public SettableSurface(Size size, int i) {
            ...
            this.mSurfaceFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.processing.SurfaceEdge$SettableSurface$$ExternalSyntheticLambda2
                ...
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return SurfaceEdge.SettableSurface.m1883$r8$lambda$VdiGildDqQQQLDZiSabHKVcb7o(this.f$0, completer);
                }
            });
        }
        ...
        public boolean setProvider(final DeferrableSurface deferrableSurface, Runnable runnable) {
            ...
            getTerminationFuture().addListener(new Runnable() { // from class: androidx.camera.core.processing.SurfaceEdge$SettableSurface$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public void close() {
            super.close();
            Threads.runOnMain(new Runnable() { // from class: androidx.camera.core.processing.SurfaceEdge$SettableSurface$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    SurfaceEdge.SettableSurface.m1882$r8$lambda$MbwWKPmNYVcJmML8QCwwbJ_Io(this.f$0);
                }
            });
        }

        /* JADX INFO: renamed from: $r8$lambda$MbwWKPmNY-V-cJmML8QCwwbJ_Io */
        public static /* synthetic */ void m1882$r8$lambda$MbwWKPmNYVcJmML8QCwwbJ_Io(SettableSurface settableSurface) {
