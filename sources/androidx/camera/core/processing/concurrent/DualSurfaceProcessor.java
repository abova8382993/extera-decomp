...
public class DualSurfaceProcessor implements SurfaceProcessorInternal, SurfaceTexture.OnFrameAvailableListener {
    ...
    /* JADX INFO: renamed from: $r8$lambda$H-VJUM4Do99Q9JsClAV6N0JKx5I */
    public static /* synthetic */ void m1887$r8$lambda$HVJUM4Do99Q9JsClAV6N0JKx5I() {
    }
    ...
    public void onInputSurface(final SurfaceRequest surfaceRequest) {
        ...
        Runnable runnable = new Runnable() { // from class: androidx.camera.core.processing.concurrent.DualSurfaceProcessor$$ExternalSyntheticLambda1
            ...
            public final void run() {
                DualSurfaceProcessor.m1891$r8$lambda$eYxu5ZhmaW5Q_3yYxnq9Fy4kTk(this.f$0, surfaceRequest);
            }
        };
    ...
    /* JADX INFO: renamed from: $r8$lambda$eYxu-5ZhmaW5Q_3yYxnq9Fy4kTk */
    public static /* synthetic */ void m1891$r8$lambda$eYxu5ZhmaW5Q_3yYxnq9Fy4kTk(final DualSurfaceProcessor dualSurfaceProcessor, SurfaceRequest surfaceRequest) {
        ...
        surfaceRequest.provideSurface(surface, dualSurfaceProcessor.mGlExecutor, new Consumer() { // from class: androidx.camera.core.processing.concurrent.DualSurfaceProcessor$$ExternalSyntheticLambda8
            ...
            public final void accept(Object obj) {
                DualSurfaceProcessor.m1888$r8$lambda$NAKKUHmbm6lwk7NskA4M9WlNg(this.f$0, surfaceTexture, surface, (SurfaceRequest.Result) obj);
            }
        });
    ...
    /* JADX INFO: renamed from: $r8$lambda$NAKKU-Hmbm6lwk-7NskA4M9WlNg */
    public static /* synthetic */ void m1888$r8$lambda$NAKKUHmbm6lwk7NskA4M9WlNg(DualSurfaceProcessor dualSurfaceProcessor, SurfaceTexture surfaceTexture, Surface surface, SurfaceRequest.Result result) {
    ...
    public void onOutputSurface(final SurfaceOutput surfaceOutput) {
        ...
        Runnable runnable = new Runnable() { // from class: androidx.camera.core.processing.concurrent.DualSurfaceProcessor$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                DualSurfaceProcessor.m1890$r8$lambda$XjKCBi0iSlQAHKEbAfakln9aNU(this.f$0, surfaceOutput);
            }
        };
    ...
    /* JADX INFO: renamed from: $r8$lambda$XjKCBi0iSlQAHK-EbAfakln9aNU */
    public static /* synthetic */ void m1890$r8$lambda$XjKCBi0iSlQAHKEbAfakln9aNU(final DualSurfaceProcessor dualSurfaceProcessor, final SurfaceOutput surfaceOutput) {
        Surface surface = surfaceOutput.getSurface(dualSurfaceProcessor.mGlExecutor, new Consumer() { // from class: androidx.camera.core.processing.concurrent.DualSurfaceProcessor$$ExternalSyntheticLambda5
            @Override // androidx.core.util.Consumer
            public final void accept(Object obj) {
                DualSurfaceProcessor.m1889$r8$lambda$SSJVT35FEA6PJGDsDjTufRx9_M(this.f$0, surfaceOutput, (SurfaceOutput.Event) obj);
            }
        });
    ...
    /* JADX INFO: renamed from: $r8$lambda$SSJVT35FEA6PJGDsDjTufRx-9_M */
    public static /* synthetic */ void m1889$r8$lambda$SSJVT35FEA6PJGDsDjTufRx9_M(DualSurfaceProcessor dualSurfaceProcessor, SurfaceOutput surfaceOutput, SurfaceOutput.Event event) {
        dualSurfaceProcessor.getClass();
        surfaceOutput.close();
        ...
        for (Map.Entry<SurfaceOutput, Surface> entry : this.mOutputSurfaces.entrySet()) {
            ...
            if (key.getFormat() == 34) {
                try {
                    ...
                    Logger.m77e("DualSurfaceProcessor", "Failed to render with OpenGL.", e);
                }
            }
        }
    }
    ...
    public static /* synthetic */ Object $r8$lambda$xmFNEnzuXLtJLpm9XXaBYQZXSMI(final DualSurfaceProcessor dualSurfaceProcessor, final DynamicRange dynamicRange, final Map map, final CallbackToFutureAdapter.Completer completer) {
        ...
        dualSurfaceProcessor.executeSafely(new Runnable() { // from class: androidx.camera.core.processing.concurrent.DualSurfaceProcessor$$ExternalSyntheticLambda4
            ...
            public final void run() throws Throwable {
                DualSurfaceProcessor.m1892$r8$lambda$gvtYv8V6pqQmb0lqnGgcqf1W30(this.f$0, dynamicRange, map, completer);
            }
        });
        return "Init GlRenderer";
    }

    /* JADX INFO: renamed from: $r8$lambda$gvtYv8V6pqQmb0lqnGgcqf1W-30 */
    public static /* synthetic */ void m1892$r8$lambda$gvtYv8V6pqQmb0lqnGgcqf1W30(DualSurfaceProcessor dualSurfaceProcessor, DynamicRange dynamicRange, Map map, CallbackToFutureAdapter.Completer completer) throws Throwable {
        dualSurfaceProcessor.getClass();
        try {
    ...
    private void executeSafely(Runnable runnable) {
        executeSafely(runnable, new Runnable() { // from class: androidx.camera.core.processing.concurrent.DualSurfaceProcessor$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
                DualSurfaceProcessor.m1887$r8$lambda$HVJUM4Do99Q9JsClAV6N0JKx5I();
            }
        });
    }
    ...
    private void executeSafely(final Runnable runnable, final Runnable runnable2) {
        try {
            this.mGlExecutor.execute(new Runnable() { // from class: androidx.camera.core.processing.concurrent.DualSurfaceProcessor$$ExternalSyntheticLambda6
                @Override // java.lang.Runnable
                public final void run() {
                    DualSurfaceProcessor.m1886$r8$lambda$ZbwcPykT74fmw8U2V6XL8hhU5w(this.f$0, runnable2, runnable);
                }
            });
        } catch (RejectedExecutionException e) {
            Logger.m80w("DualSurfaceProcessor", "Unable to executor runnable", e);
            runnable2.run();
        }
    }

    /* JADX INFO: renamed from: $r8$lambda$-ZbwcPykT74fmw8U2V6XL8hhU5w */
    public static /* synthetic */ void m1886$r8$lambda$ZbwcPykT74fmw8U2V6XL8hhU5w(DualSurfaceProcessor dualSurfaceProcessor, Runnable runnable, Runnable runnable2) {
