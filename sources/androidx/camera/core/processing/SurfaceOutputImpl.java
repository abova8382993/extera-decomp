...
final class SurfaceOutputImpl implements SurfaceOutput {
    ...
    public SurfaceOutputImpl(Surface surface, int i, int i2, Size size, SurfaceOutput.CameraInputInfo cameraInputInfo, SurfaceOutput.CameraInputInfo cameraInputInfo2, Matrix matrix) {
        ...
        this.mCloseFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.processing.SurfaceOutputImpl$$ExternalSyntheticLambda0
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return SurfaceOutputImpl.m1884$r8$lambda$BPwK3dRtWFOkowL69hb8JIT2RI(this.f$0, completer);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$BPwK3dRtWFOkowL69-hb8JIT2RI, reason: not valid java name */
    public static /* synthetic */ Object m1884$r8$lambda$BPwK3dRtWFOkowL69hb8JIT2RI(SurfaceOutputImpl surfaceOutputImpl, CallbackToFutureAdapter.Completer completer) {
    ...
    public void requestClose() {
        ...
        if (executor != null) {
            try {
                ...
                Logger.m75d("SurfaceOutputImpl", "Processor executor closed. Close request not posted.", e);
            }
        }
    }
    ...
    public static /* synthetic */ void $r8$lambda$tN7PQI3jxt3m69zesHNhPckAd28(SurfaceOutputImpl surfaceOutputImpl, AtomicReference atomicReference) {
        ...
        ((Consumer) atomicReference.get()).accept(SurfaceOutput.Event.m82of(0, surfaceOutputImpl));
    }
