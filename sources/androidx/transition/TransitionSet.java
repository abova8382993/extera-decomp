...
public class TransitionSet extends Transition {
    ...
    protected void runAnimators() {
        ...
        if (!this.mPlayTogether) {
            for (int i2 = 1; i2 < this.mTransitions.size(); i2++) {
                ((Transition) this.mTransitions.get(i2 - 1)).addListener(new TransitionListenerAdapter() { // from class: androidx.transition.TransitionSet.1
                    final /* synthetic */ Transition val$nextTransition;

                    C08311(Transition transition) {
    ...
    class C08311 extends TransitionListenerAdapter {
        final /* synthetic */ Transition val$nextTransition;
    ...
    class C08322 extends TransitionListenerAdapter {
        C08322() {
        }
    ...
    void prepareAnimatorsForSeeking() {
        ...
        C08322 c08322 = new TransitionListenerAdapter() { // from class: androidx.transition.TransitionSet.2
            C08322() {
            }
    ...
    */
    ...
    public Transition mo2179clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo2179clone();
        transitionSet.mTransitions = new ArrayList();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(((Transition) this.mTransitions.get(i)).mo2179clone());
        }
