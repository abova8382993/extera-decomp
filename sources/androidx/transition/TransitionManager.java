...
public abstract class TransitionManager {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo2179clone = transition.mo2179clone();
        sceneChangeSetup(viewGroup, transitionMo2179clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo2179clone);
    }
}
