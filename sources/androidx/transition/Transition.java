...
public abstract class Transition implements Cloneable {
    ...
    public class C08441 extends PathMotion {
        @Override // androidx.transition.PathMotion
        public Path getPath(float f, float f2, float f3, float f4) {
            Path path = new Path();
            path.moveTo(f, f2);
    ...
    public void setMatchOrder(int... iArr) {
        ...
        for (int i = 0; i < iArr.length; i++) {
            if (!isValidMatch(iArr[i])) {
                g$$ExternalSyntheticBUOutline1.m207m("matches contains invalid value");
                return;
            } else {
                if (alreadyContains(iArr, i)) {
                    g$$ExternalSyntheticBUOutline1.m207m("matches contains a duplicate value");
                    return;
                }
            }
        }
    ...
    public void createAnimators(ViewGroup viewGroup, TransitionValuesMaps transitionValuesMaps, TransitionValuesMaps transitionValuesMaps2, ArrayList<TransitionValues> arrayList, ArrayList<TransitionValues> arrayList2) {
        ...
        boolean z = transition.getRootTransition().mSeekController != null;
        for (int i = 0; i < size; i++) {
            ...
            if ((transitionValues2 != null || transitionValues3 != null) && (transitionValues2 == null || transitionValues3 == null || transition.isTransitionRequired(transitionValues2, transitionValues3))) {
                Animator animatorCreateAnimator = transition.createAnimator(viewGroup, transitionValues2, transitionValues3);
                if (animatorCreateAnimator != null) {
                        ...
                        if (transitionProperties != null && transitionProperties.length > 0) {
                            ...
                            if (transitionValues4 != null) {
                                ...
                                while (i2 < transitionProperties.length) {
                                    ...
                                    animatorCreateAnimator = animatorCreateAnimator;
                                }
                            }
                    ...
                    if (animatorCreateAnimator != null) {
                        ...
                        transition = this;
                        AnimationInfo animationInfo2 = new AnimationInfo(view2, getName(), transition, viewGroup.getWindowId(), transitionValues, animator4);
                        if (z) {
        ...
        if (sparseIntArray.size() != 0) {
            for (int i4 = 0; i4 < sparseIntArray.size(); i4++) {
                AnimationInfo animationInfo3 = runningAnimators.get(transition.mAnimators.get(sparseIntArray.keyAt(i4)));
                animationInfo3.mAnimator.setStartDelay((((long) sparseIntArray.valueAt(i4)) - LongCompanionObject.MAX_VALUE) + animationInfo3.mAnimator.getStartDelay());
            }
        }
    }
    ...
    public class C08452 extends AnimatorListenerAdapter {
        final /* synthetic */ ArrayMap val$runningAnimators;

        public C08452(ArrayMap arrayMap) {
            arrayMap = arrayMap;
        }
    ...
    private void runAnimator(Animator animator, ArrayMap<Animator, AnimationInfo> arrayMap) {
        if (animator != null) {
            animator.addListener(new AnimatorListenerAdapter() { // from class: androidx.transition.Transition.2
                ...
                public C08452(ArrayMap arrayMap2) {
                    arrayMap = arrayMap2;
                }
    ...
    */
    public androidx.transition.TransitionValues getMatchedTransitionValues(android.view.View r6, boolean r7) {
        ...
        L2d:
            if (r3 < 0) goto L3d
            if (r7 == 0) goto L34
            java.util.ArrayList<androidx.transition.TransitionValues> r5 = r5.mEndValuesList
            goto L36
        L34:
            java.util.ArrayList<androidx.transition.TransitionValues> r5 = r5.mStartValuesList
        L36:
    ...
    public class C08463 extends AnimatorListenerAdapter {
        public C08463() {
        }
    ...
    public String toString() {
        return toString(_UrlKt.FRAGMENT_ENCODE_SET);
    }
