...
@Metadata(m876d1 = {"\u0000<\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\b\n\u0002\b\u0004\n\u0002\u0010\u0007\n\u0002\b\u0005\b\u0000\u0018\u0000 \u00182\f\u0012\b\u0012\u00060\u0002R\u00020\u00000\u0001:\u0002\u0018\u0019B3\b\u0012\u0012\u0006\u0010\u0003\u001a\u00020\u0004\u0012\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00070\u0006\u0012\f\u0010\b\u001a\b\u0012\u0004\u0012\u00020\t0\u0006\u0012\u0006\u0010\n\u001a\u00020\u000b¢\u0006\u0002\u0010\fJ\u000e\u0010\u0013\u001a\u00020\u00002\u0006\u0010\u0014\u001a\u00020\u0015J\u0015\u0010\u0016\u001a\u00060\u0002R\u00020\u00002\u0006\u0010\u0017\u001a\u00020\u0010H\u0096\u0002R\u0018\u0010\b\u001a\f\u0012\b\u0012\u00060\u0002R\u00020\u00000\u0006X\u0082\u0004¢\u0006\u0002\n\u0000R\u0017\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00070\u0006¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000eR\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u000f\u001a\u00020\u00108VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b\u0011\u0010\u0012¨\u0006\u001a"}, m877d2 = {"Landroidx/graphics/shapes/MeasuredPolygon;", "Lkotlin/collections/AbstractList;", "Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;", "measurer", "Landroidx/graphics/shapes/Measurer;", "features", _UrlKt.FRAGMENT_ENCODE_SET, "Landroidx/graphics/shapes/ProgressableFeature;", "cubics", "Landroidx/graphics/shapes/Cubic;", "outlineProgress", "Landroidx/collection/FloatList;", "(Landroidx/graphics/shapes/Measurer;Ljava/util/List;Ljava/util/List;Landroidx/collection/FloatList;)V", "getFeatures", "()Ljava/util/List;", "size", _UrlKt.FRAGMENT_ENCODE_SET, "getSize", "()I", "cutAndShift", "cuttingPoint", _UrlKt.FRAGMENT_ENCODE_SET, "get", "index", "Companion", "MeasuredCubic", "graphics-shapes_release"}, m878k = 1, m879mv = {1, 8, 0}, m881xi = 48)
...
public final class MeasuredPolygon extends AbstractList<MeasuredCubic> {
    ...
    private MeasuredPolygon(Measurer measurer, List<ProgressableFeature> list, List<? extends Cubic> list2, FloatList floatList) {
        if (floatList.get_size() != list2.size() + 1) {
            g$$ExternalSyntheticBUOutline1.m207m("Outline progress size is expected to be the cubics size + 1");
            throw null;
        }
        if (floatList.first() != 0.0f) {
            g$$ExternalSyntheticBUOutline1.m207m("First outline progress value is expected to be zero");
            throw null;
        }
        if (floatList.last() != 1.0f) {
            g$$ExternalSyntheticBUOutline1.m207m("Last outline progress value is expected to be one");
            throw null;
        }
        ...
        while (i < size) {
            ...
            if (floatList.get(i2) - floatList.get(i) > 1.0E-4f) {
                arrayList.add(new MeasuredCubic(list2.get(i), f, floatList.get(i2)));
                f = floatList.get(i2);
            }
            i = i2;
        }
    ...
    @Metadata(m876d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0007\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\r\b\u0080\u0004\u0018\u00002\u00020\u0001B#\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\b\b\u0001\u0010\u0005\u001a\u00020\u0004\u0012\b\b\u0001\u0010\u0006\u001a\u00020\u0004¢\u0006\u0004\b\u0007\u0010\bJ#\u0010\f\u001a\u00020\t2\b\b\u0002\u0010\u0005\u001a\u00020\u00042\b\b\u0002\u0010\u0006\u001a\u00020\u0004H\u0000¢\u0006\u0004\b\n\u0010\u000bJ)\u0010\u0010\u001a\u0016\u0012\b\u0012\u00060\u0000R\u00020\u000f\u0012\b\u0012\u00060\u0000R\u00020\u000f0\u000e2\u0006\u0010\r\u001a\u00020\u0004¢\u0006\u0004\b\u0010\u0010\u0011J\u000f\u0010\u0013\u001a\u00020\u0012H\u0016¢\u0006\u0004\b\u0013\u0010\u0014R\u0017\u0010\u0003\u001a\u00020\u00028\u0006¢\u0006\f\n\u0004\b\u0003\u0010\u0015\u001a\u0004\b\u0016\u0010\u0017R\u0017\u0010\u0018\u001a\u00020\u00048\u0006¢\u0006\f\n\u0004\b\u0018\u0010\u0019\u001a\u0004\b\u001a\u0010\u001bR$\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u001c\u001a\u00020\u00048\u0006@BX\u0086\u000e¢\u0006\f\n\u0004\b\u0005\u0010\u0019\u001a\u0004\b\u001d\u0010\u001bR$\u0010\u0006\u001a\u00020\u00042\u0006\u0010\u001c\u001a\u00020\u00048\u0006@BX\u0086\u000e¢\u0006\f\n\u0004\b\u0006\u0010\u0019\u001a\u0004\b\u001e\u0010\u001b¨\u0006\u001f"}, m877d2 = {"Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;", _UrlKt.FRAGMENT_ENCODE_SET, "Landroidx/graphics/shapes/Cubic;", "cubic", _UrlKt.FRAGMENT_ENCODE_SET, "startOutlineProgress", "endOutlineProgress", "<init>", "(Landroidx/graphics/shapes/MeasuredPolygon;Landroidx/graphics/shapes/Cubic;FF)V", _UrlKt.FRAGMENT_ENCODE_SET, "updateProgressRange$graphics_shapes_release", "(FF)V", "updateProgressRange", "cutOutlineProgress", "Lkotlin/Pair;", "Landroidx/graphics/shapes/MeasuredPolygon;", "cutAtProgress", "(F)Lkotlin/Pair;", _UrlKt.FRAGMENT_ENCODE_SET, "toString", "()Ljava/lang/String;", "Landroidx/graphics/shapes/Cubic;", "getCubic", "()Landroidx/graphics/shapes/Cubic;", "measuredSize", "F", "getMeasuredSize", "()F", "<set-?>", "getStartOutlineProgress", "getEndOutlineProgress", "graphics-shapes_release"}, m878k = 1, m879mv = {1, 8, 0}, m881xi = 48)
    ...
    public final class MeasuredCubic {
        ...
        public MeasuredCubic(Cubic cubic, float f, float f2) {
            this.cubic = cubic;
            if (f2 >= f) {
                this.measuredSize = MeasuredPolygon.this.measurer.measureCubic(cubic);
                this.startOutlineProgress = f;
                this.endOutlineProgress = f2;
                return;
            }
            g$$ExternalSyntheticBUOutline1.m207m("endOutlineProgress is expected to be equal or greater than startOutlineProgress");
            throw null;
        }
        ...
        public final Pair<MeasuredCubic, MeasuredCubic> cutAtProgress(float cutOutlineProgress) {
            ...
            float fFindCubicCutPoint = MeasuredPolygon.this.measurer.findCubicCutPoint(this.cubic, ((fCoerceIn - f2) / (f - f2)) * this.measuredSize);
            if (0.0f <= fFindCubicCutPoint && fFindCubicCutPoint <= 1.0f) {
                ...
                return TuplesKt.m884to(MeasuredPolygon.this.new MeasuredCubic(pairSplit.component1(), this.startOutlineProgress, fCoerceIn), MeasuredPolygon.this.new MeasuredCubic(pairSplit.component2(), fCoerceIn, this.endOutlineProgress));
            }
            g$$ExternalSyntheticBUOutline1.m207m("Cubic cut point is expected to be between 0 and 1");
            return null;
        }
    ...
    public final MeasuredPolygon cutAndShift(float cuttingPoint) {
        ...
        if (0.0f > cuttingPoint || cuttingPoint > 1.0f) {
            g$$ExternalSyntheticBUOutline1.m207m("Cutting point is expected to be between 0 and 1");
            return null;
        }
    ...
    @Metadata(m876d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u001d\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0000¢\u0006\u0002\b\t¨\u0006\n"}, m877d2 = {"Landroidx/graphics/shapes/MeasuredPolygon$Companion;", _UrlKt.FRAGMENT_ENCODE_SET, "()V", "measurePolygon", "Landroidx/graphics/shapes/MeasuredPolygon;", "measurer", "Landroidx/graphics/shapes/Measurer;", "polygon", "Landroidx/graphics/shapes/RoundedPolygon;", "measurePolygon$graphics_shapes_release", "graphics-shapes_release"}, m878k = 1, m879mv = {1, 8, 0}, m881xi = 48)
    ...
    public static final class Companion {
        ...
        public final MeasuredPolygon measurePolygon$graphics_shapes_release(Measurer measurer, RoundedPolygon polygon) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                for (int i2 = 0; i2 < size2; i2++) {
                    if ((feature instanceof Feature.Corner) && i2 == feature.getCubics().size() / 2) {
                        arrayList2.add(TuplesKt.m884to(feature, Integer.valueOf(arrayList.size())));
                    }
            ...
            if (iCollectionSizeOrDefault == 0) {
                ...
                while (i3 < size3) {
                    ...
                    if (fMeasureCubic < 0.0f) {
                        g$$ExternalSyntheticBUOutline1.m207m("Measured cubic is expected to be greater or equal to zero");
                        return null;
                    }
            ...
            for (int i5 = 0; i5 < size5; i5++) {
                ...
                listCreateListBuilder.add(new ProgressableFeature((mutableFloatList.get(iIntValue) + mutableFloatList.get(iIntValue + 1)) / 2.0f, (Feature) ((Pair) arrayList2.get(i5)).getFirst()));
            }
