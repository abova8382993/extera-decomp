...
public abstract class ShapesKt {
    ...
    public static final RoundedPolygon circle(RoundedPolygon.Companion companion, int i, float f, float f2, float f3) {
        if (i < 3) {
            g$$ExternalSyntheticBUOutline1.m207m("Circle must have at least three vertices");
            return null;
        }
    ...
    public static final RoundedPolygon star(RoundedPolygon.Companion companion, int i, float f, float f2, CornerRounding cornerRounding, CornerRounding cornerRounding2, List<CornerRounding> list, float f3, float f4) {
        if (f <= 0.0f || f2 <= 0.0f) {
            g$$ExternalSyntheticBUOutline1.m207m("Star radii must both be greater than 0");
            return null;
        }
        if (f2 >= f) {
            g$$ExternalSyntheticBUOutline1.m207m("innerRadius must be less than radius");
            return null;
        }
    ...
    private static final float[] starVerticesFromNumVerts(int i, float f, float f2, float f3, float f4) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            float f5 = i;
            long jM2039radialToCartesianL6JJ3z0$default = Utils.m2039radialToCartesianL6JJ3z0$default(f, (Utils.getFloatPi() / f5) * 2.0f * i3, 0L, 4, null);
            fArr[i2] = PointKt.m2027getXDnnuFBc(jM2039radialToCartesianL6JJ3z0$default) + f3;
            fArr[i2 + 1] = PointKt.m2028getYDnnuFBc(jM2039radialToCartesianL6JJ3z0$default) + f4;
            long jM2039radialToCartesianL6JJ3z0$default2 = Utils.m2039radialToCartesianL6JJ3z0$default(f2, (Utils.getFloatPi() / f5) * ((i3 * 2) + 1), 0L, 4, null);
            int i4 = i2 + 3;
            fArr[i2 + 2] = PointKt.m2027getXDnnuFBc(jM2039radialToCartesianL6JJ3z0$default2) + f3;
            i2 += 4;
            fArr[i4] = PointKt.m2028getYDnnuFBc(jM2039radialToCartesianL6JJ3z0$default2) + f4;
        }
        return fArr;
    }
}
