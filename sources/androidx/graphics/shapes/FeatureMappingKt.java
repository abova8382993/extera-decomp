...
@Metadata(m876d1 = {"\u0000(\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0007\n\u0002\b\u0006\u001a3\u0010\u0006\u001a\u00020\u00052\u0010\u0010\u0003\u001a\f\u0012\u0004\u0012\u00020\u00010\u0000j\u0002`\u00022\u0010\u0010\u0004\u001a\f\u0012\u0004\u0012\u00020\u00010\u0000j\u0002`\u0002H\u0000¢\u0006\u0004\b\u0006\u0010\u0007\u001a\u001f\u0010\f\u001a\u00020\u000b2\u0006\u0010\t\u001a\u00020\b2\u0006\u0010\n\u001a\u00020\bH\u0000¢\u0006\u0004\b\f\u0010\r\u001a=\u0010\u000e\u001a\f\u0012\u0004\u0012\u00020\u00010\u0000j\u0002`\u00022\u0010\u0010\t\u001a\f\u0012\u0004\u0012\u00020\u00010\u0000j\u0002`\u00022\u0010\u0010\n\u001a\f\u0012\u0004\u0012\u00020\u00010\u0000j\u0002`\u0002H\u0000¢\u0006\u0004\b\u000e\u0010\u000f*\u0018\b\u0000\u0010\u0010\"\b\u0012\u0004\u0012\u00020\u00010\u00002\b\u0012\u0004\u0012\u00020\u00010\u0000¨\u0006\u0011"}, m877d2 = {_UrlKt.FRAGMENT_ENCODE_SET, "Landroidx/graphics/shapes/ProgressableFeature;", "Landroidx/graphics/shapes/MeasuredFeatures;", "features1", "features2", "Landroidx/graphics/shapes/DoubleMapper;", "featureMapper", "(Ljava/util/List;Ljava/util/List;)Landroidx/graphics/shapes/DoubleMapper;", "Landroidx/graphics/shapes/Feature;", "f1", "f2", _UrlKt.FRAGMENT_ENCODE_SET, "featureDistSquared", "(Landroidx/graphics/shapes/Feature;Landroidx/graphics/shapes/Feature;)F", "doMapping", "(Ljava/util/List;Ljava/util/List;)Ljava/util/List;", "MeasuredFeatures", "graphics-shapes_release"}, m878k = 2, m879mv = {1, 8, 0}, m881xi = 48)
...
public abstract class FeatureMappingKt {
    public static final DoubleMapper featureMapper(List<ProgressableFeature> list, List<ProgressableFeature> list2) {
        ...
        if (listBuild.size() > listBuild2.size()) {
            pairM884to = TuplesKt.m884to(doMapping(listBuild2, listBuild), listBuild2);
        } else {
            pairM884to = TuplesKt.m884to(listBuild, doMapping(listBuild, listBuild2));
        }
        List list3 = (List) pairM884to.component1();
        List list4 = (List) pairM884to.component2();
        List listCreateListBuilder3 = CollectionsKt.createListBuilder();
        int size3 = list3.size();
        for (int i3 = 0; i3 < size3 && i3 != list4.size(); i3++) {
            listCreateListBuilder3.add(TuplesKt.m884to(Float.valueOf(((ProgressableFeature) list3.get(i3)).getProgress()), Float.valueOf(((ProgressableFeature) list4.get(i3)).getProgress())));
        }
    ...
    public static final float featureDistSquared(Feature feature, Feature feature2) {
        ...
        float anchor0X = (((Cubic) CollectionsKt.first((List) feature.getCubics())).getAnchor0X() + ((Cubic) CollectionsKt.last((List) feature.getCubics())).getAnchor1X()) / 2.0f;
        float anchor0Y = (((Cubic) CollectionsKt.first((List) feature.getCubics())).getAnchor0Y() + ((Cubic) CollectionsKt.last((List) feature.getCubics())).getAnchor1Y()) / 2.0f;
        float anchor0X2 = anchor0X - ((((Cubic) CollectionsKt.first((List) feature2.getCubics())).getAnchor0X() + ((Cubic) CollectionsKt.last((List) feature2.getCubics())).getAnchor1X()) / 2.0f);
        float anchor0Y2 = anchor0Y - ((((Cubic) CollectionsKt.first((List) feature2.getCubics())).getAnchor0Y() + ((Cubic) CollectionsKt.last((List) feature2.getCubics())).getAnchor1Y()) / 2.0f);
