    ...
    public static class DeclaredOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            try {
                ...
                Constants$$ExternalSyntheticBUOutline0.m1007m("Could not execute non-public method for android:onClick", e);
            } catch (InvocationTargetException e2) {
                Constants$$ExternalSyntheticBUOutline0.m1007m("Could not execute method for android:onClick", e2);
            }
        }
        ...
        private void resolveMethod(Context context) {
            ...
            WorkerFactory$$ExternalSyntheticBUOutline0.m198m("Could not find method ", this.mMethodName, "(View) in a parent or ancestor Context for android:onClick attribute defined on view ", this.mHostView.getClass(), str);
        }
    }
}
