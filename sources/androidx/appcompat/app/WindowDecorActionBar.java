...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    public class C00481 extends ViewPropertyAnimatorListenerAdapter {
        public C00481() {
        }
    ...
    public class C00492 extends ViewPropertyAnimatorListenerAdapter {
        public C00492() {
        }
    ...
    public class C00503 implements ViewPropertyAnimatorUpdateListener {
        public C00503() {
        }
    ...
    private void init(View view) {
        ...
        if (decorToolbar == null || this.mContextView == null || actionBarContainer == null) {
            Segment$$ExternalSyntheticBUOutline1.m992m(getClass().getSimpleName().concat(" can only be used with a compatible window decor layout"));
            return;
        }
    ...
    public void dispatchMenuVisibilityChanged(boolean z) {
        ...
        MediaSessionCompat$$ExternalSyntheticThrowCCEIfNotNull0.m2m(this.mMenuVisibilityListeners.get(0));
        throw null;
    }
    ...
    public void setHideOnContentScrollEnabled(boolean z) {
        if (z && !this.mOverlayLayout.isInOverlayMode()) {
            Segment$$ExternalSyntheticBUOutline1.m992m("Action bar must be in overlay mode (Window.FEATURE_OVERLAY_ACTION_BAR) to enable hide on content scroll");
        } else {
    ...
    public void animateToMode(boolean z) {
        ...
        if (shouldAnimateContextView()) {
            DecorToolbar decorToolbar = this.mDecorToolbar;
            if (z) {
                viewPropertyAnimatorCompat = decorToolbar.setupAnimatorToVisibility(4, 100L);
