...
class AppCompatTextHelper {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        if (i2 >= 26 && tintTypedArrayObtainStyledAttributes3.hasValue(R$styleable.TextAppearance_fontVariationSettings)) {
            string2 = tintTypedArrayObtainStyledAttributes3.getString(R$styleable.TextAppearance_fontVariationSettings);
        }
        if (i2 >= 28 && tintTypedArrayObtainStyledAttributes3.hasValue(R$styleable.TextAppearance_android_textSize) && tintTypedArrayObtainStyledAttributes3.getDimensionPixelSize(R$styleable.TextAppearance_android_textSize, -1) == 0) {
            ...
            if (!context.isRestricted()) {
                try {
                    Typeface font = tintTypedArray.getFont(i, this.mStyle, new ResourcesCompat.FontCallback() { // from class: androidx.appcompat.widget.AppCompatTextHelper.1
                        ...
                        public C00721(int i42, int i52, WeakReference weakReference) {
                            i = i42;
                            i = i52;
    ...
    public class C00721 extends ResourcesCompat.FontCallback {
        final /* synthetic */ int val$fontWeight;
        final /* synthetic */ int val$style;
        final /* synthetic */ WeakReference val$textViewWeak;
            ...
            if (textView != null) {
                ...
                if (zIsAttachedToWindow) {
                    textView.post(new Runnable() { // from class: androidx.appcompat.widget.AppCompatTextHelper.2
                        ...
                        public RunnableC00732(TextView textView2, Typeface typeface2, int i2) {
                            textView = textView2;
                            typeface = typeface2;
                            i = i2;
                        }
