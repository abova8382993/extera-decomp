...
class AppCompatTextHelper {
    ...
    void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        if (resourceId != -1) {
            ...
            string = (i2 < 26 || !tintTypedArrayObtainStyledAttributes2.hasValue(R$styleable.TextAppearance_fontVariationSettings)) ? null : tintTypedArrayObtainStyledAttributes2.getString(R$styleable.TextAppearance_fontVariationSettings);
        ...
        if (string2 != null) {
            if (i3 >= 24) {
                ...
                this.mView.setTextLocale(Api21Impl.forLanguageTag(string2.split(",")[0]));
            }
        }
            ...
            if (!context.isRestricted()) {
                try {
                    Typeface font = tintTypedArray.getFont(i, this.mStyle, new ResourcesCompat.FontCallback() { // from class: androidx.appcompat.widget.AppCompatTextHelper.1
                        ...
                        C00711(int i42, int i52, WeakReference weakReference) {
                            i = i42;
                            i = i52;
                        ...
                        public void onFontRetrieved(Typeface typeface) {
                            int i6;
                            if (Build.VERSION.SDK_INT >= 28 && (i6 = i) != -1) {
                                typeface = Api28Impl.create(typeface, i6, (i & 2) != 0);
                            }
    ...
    class C00711 extends ResourcesCompat.FontCallback {
        final /* synthetic */ int val$fontWeight;
        final /* synthetic */ int val$style;
        final /* synthetic */ WeakReference val$textViewWeak;
            ...
            if (textView != null) {
                if (textView.isAttachedToWindow()) {
                    textView.post(new Runnable() { // from class: androidx.appcompat.widget.AppCompatTextHelper.2
                        ...
                        RunnableC00722(TextView textView2, Typeface typeface2, int i) {
                            textView = textView2;
                            typeface = typeface2;
                            i = i;
                        }
    ...
    void onSetTextAppearance(Context context, int i) {
        ...
        if (i2 >= 26 && tintTypedArrayObtainStyledAttributes.hasValue(R$styleable.TextAppearance_fontVariationSettings) && (string = tintTypedArrayObtainStyledAttributes.getString(R$styleable.TextAppearance_fontVariationSettings)) != null) {
            Api26Impl.setFontVariationSettings(this.mView, string);
        }
        tintTypedArrayObtainStyledAttributes.recycle();
        Typeface typeface = this.mFontTypeface;
