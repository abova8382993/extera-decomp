...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    class C00791 implements ActionMenuView.OnMenuItemClickListener {
        C00791() {
        }
    ...
    class RunnableC00802 implements Runnable {
        RunnableC00802() {
        }
    ...
    class C00813 implements MenuBuilder.Callback {
        C00813() {
        }
    ...
    class ViewOnClickListenerC00824 implements View.OnClickListener {
        ViewOnClickListenerC00824() {
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:240:0x02ec A[LOOP:2: B:239:0x02ea->B:240:0x02ec, LOOP_END] */
    @Override // android.view.ViewGroup, android.view.View
    /*
    ...
    */
    ...
    public static class SavedState extends AbsSavedState {
        ...
        class C00831 implements Parcelable.ClassLoaderCreator {
            C00831() {
            }
