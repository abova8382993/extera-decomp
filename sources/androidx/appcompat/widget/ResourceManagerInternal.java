...
public final class ResourceManagerInternal {
    ...
    private Drawable loadDrawableFromDelegates(Context context, int i) {
        ...
        if (charSequence != null && charSequence.toString().endsWith(".xml")) {
            try {
                ...
                MediaSessionCompat$$ExternalSyntheticThrowCCEIfNotNull0.m2m(this.mDelegates.get(name));
                if (cachedDrawable != null) {
    ...
    private void checkVectorDrawableSetup(Context context) {
        ...
        if (drawable == null || !isVectorDrawable(drawable)) {
            ...
            Segment$$ExternalSyntheticBUOutline1.m992m("This app has been built with an incorrect configuration. Please configure your build for VectorDrawableCompat.");
        }
    }
