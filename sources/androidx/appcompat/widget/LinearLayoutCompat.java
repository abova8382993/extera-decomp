...
public abstract class LinearLayoutCompat extends ViewGroup {
    ...
    public int getBaseline() {
        ...
        if (childCount <= i2) {
            GlShader$$ExternalSyntheticBUOutline1.m1250m("mBaselineAlignedChildIndex of LinearLayout set to an index that is out of bounds.");
            return 0;
        }
        ...
        if (baseline == -1) {
            ...
            GlShader$$ExternalSyntheticBUOutline1.m1250m("mBaselineAlignedChildIndex of LinearLayout points to a View that doesn't know how to get its baseline.");
            return 0;
        }
    ...
    public void setBaselineAlignedChildIndex(int i) {
        if (i < 0 || i >= getChildCount()) {
            Structure$$ExternalSyntheticBUOutline2.m557m("base aligned child index out of range (0, ", getChildCount(), ")");
        } else {
