...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (mode != 1073741824) {
            Segment$$ExternalSyntheticBUOutline1.m992m(getClass().getSimpleName().concat(" can only be used with android:layout_width=\"match_parent\" (or fill_parent)"));
            return;
        }
        if (View.MeasureSpec.getMode(i2) == 0) {
            Segment$$ExternalSyntheticBUOutline1.m992m(getClass().getSimpleName().concat(" can only be used with android:layout_height=\"wrap_content\""));
            return;
        }
        ...
        if (view2 != null) {
            ...
            this.mCustomView.measure(View.MeasureSpec.makeMeasureSpec(paddingLeft, i5), View.MeasureSpec.makeMeasureSpec(iMin, i3));
        }
