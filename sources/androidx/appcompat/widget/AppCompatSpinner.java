    ...
    */
    ...
    public class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
        ...
        public void computeContentWidth() {
            ...
            int i2 = appCompatSpinner3.mDropDownWidth;
            if (i2 == -2) {
                int iCompatMeasureContentWidth = appCompatSpinner3.compatMeasureContentWidth((SpinnerAdapter) this.mAdapter, getBackground());
        ...
        public void show(int i, int i2) {
            ...
            final ViewTreeObserver.OnGlobalLayoutListener onGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() { // from class: androidx.appcompat.widget.AppCompatSpinner.DropdownPopup.2
                ...
                public void onGlobalLayout() {
                    DropdownPopup dropdownPopup = DropdownPopup.this;
                    boolean zIsVisibleToUser = dropdownPopup.isVisibleToUser(AppCompatSpinner.this);
