...
class AppCompatTextViewAutoSizeHelper {
    ...
    public void setAutoSizeTextTypeWithDefaults(int i) {
        if (supportsAutoSizeText()) {
            ...
            CharCodeKt$$ExternalSyntheticBUOutline0.m873m("Unknown auto-size text type: ", i);
        }
    }
        ...
        if (supportsAutoSizeText()) {
            ...
            if (length > 0) {
                ...
                if (!setupAutoSizeUniformPresetSizesConfiguration()) {
                    Buffer$$ExternalSyntheticBUOutline4.m978m("None of the preset sizes is valid: ", Arrays.toString(iArr));
                    return;
                }
            } else {
    ...
    private int findLargestTextSizeWhichFits(RectF rectF) {
        ...
        if (length == 0) {
            Segment$$ExternalSyntheticBUOutline1.m992m("No available text sizes to choose from.");
            return 0;
        }
        int i = 1;
        int i2 = length - 1;
        ...
        while (true) {
            ...
            if (i <= i2) {
                int i4 = (i + i2) / 2;
                if (suggestedSizeFitsInSpace(iArr[i4], rectF)) {
                    int i5 = i4 + 1;
                    i3 = i;
                    i = i5;
                } else {
