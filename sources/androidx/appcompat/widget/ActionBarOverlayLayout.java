...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    private static final WindowInsetsCompat NON_EMPTY_SYSTEM_WINDOW_INSETS = new WindowInsetsCompat.Builder().setSystemWindowInsets(Insets.m120of(0, 1, 0, 1)).build();
    ...
    */
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (!this.mOverlayMode && !z && decorFitsSystemWindows()) {
            ...
            this.mInnerInsets = new WindowInsetsCompat.Builder(this.mInnerInsets).setSystemWindowInsets(Insets.m120of(this.mInnerInsets.getSystemWindowInsetLeft(), this.mInnerInsets.getSystemWindowInsetTop() + measuredHeight, this.mInnerInsets.getSystemWindowInsetRight(), this.mInnerInsets.getSystemWindowInsetBottom())).build();
        }
    ...
    private DecorToolbar getDecorToolbar(View view) {
        ...
        Segment$$ExternalSyntheticBUOutline1.m992m("Can't make a decor toolbar out of ".concat(view.getClass().getSimpleName()));
        return null;
    }
