...
final class StandardMenuPopup extends MenuPopup implements PopupWindow.OnDismissListener, AdapterView.OnItemClickListener, MenuPresenter, View.OnKeyListener {
    ...
    final ViewTreeObserver.OnGlobalLayoutListener mGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() { // from class: androidx.appcompat.view.menu.StandardMenuPopup.1
        public ViewTreeObserverOnGlobalLayoutListenerC00571() {
        }
    ...
    private final View.OnAttachStateChangeListener mAttachStateChangeListener = new View.OnAttachStateChangeListener() { // from class: androidx.appcompat.view.menu.StandardMenuPopup.2
        ...
        public ViewOnAttachStateChangeListenerC00582() {
        }
    ...
    public class ViewTreeObserverOnGlobalLayoutListenerC00571 implements ViewTreeObserver.OnGlobalLayoutListener {
        public ViewTreeObserverOnGlobalLayoutListenerC00571() {
        }
    ...
    public class ViewOnAttachStateChangeListenerC00582 implements View.OnAttachStateChangeListener {
        @Override // android.view.View.OnAttachStateChangeListener
        public void onViewAttachedToWindow(View view) {
        }
    ...
    public void show() {
        ...
        Segment$$ExternalSyntheticBUOutline1.m992m("StandardMenuPopup cannot be used without an anchor");
    }
