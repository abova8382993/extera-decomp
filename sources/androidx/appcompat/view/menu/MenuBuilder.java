...
public class MenuBuilder implements SupportMenu {
    ...
    private static int getOrdering(int i) {
        ...
        g$$ExternalSyntheticBUOutline1.m207m("order does not contain a valid category.");
        return 0;
    }
    ...
    */
    ...
    public MenuItemImpl findItemWithShortcutForKey(int i, KeyEvent keyEvent) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            char[] cArr = keyData.meta;
            if ((numericShortcut == cArr[0] && (metaState & 2) == 0) || ((numericShortcut == cArr[2] && (metaState & 2) != 0) || (zIsQwertyMode && numericShortcut == '\b' && i == 67))) {
                return menuItemImpl;
            }
        }
        return null;
