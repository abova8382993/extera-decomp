...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    public void setShowAsAction(int i) {
        int i2 = i & 3;
        if (i2 != 0 && i2 != 1 && i2 != 2) {
            g$$ExternalSyntheticBUOutline1.m207m("SHOW_AS_ACTION_ALWAYS, SHOW_AS_ACTION_IF_ROOM, and SHOW_AS_ACTION_NEVER are mutually exclusive.");
        } else {
    ...
    public class C00551 implements ActionProvider.VisibilityListener {
        public C00551() {
        }
