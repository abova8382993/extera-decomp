...
public class SupportMenuInflater extends MenuInflater {
    ...
    private void parseMenu(XmlPullParser xmlPullParser, AttributeSet attributeSet, Menu menu) throws XmlPullParserException, IOException {
        ...
        while (true) {
            if (eventType == 2) {
                ...
                if (name.equals("menu")) {
                    ...
                    GlShader$$ExternalSyntheticBUOutline1.m1250m("Expecting menu, got ".concat(name));
                    return;
                }
            } else {
                eventType = xmlPullParser.next();
        ...
        while (!z) {
            if (eventType == 1) {
                GlShader$$ExternalSyntheticBUOutline1.m1250m("Unexpected end of document");
                return;
            }
            if (eventType != 2) {
                if (eventType == 3) {
    ...
    public class MenuState {
        ...
        public void readItem(AttributeSet attributeSet) {
            ...
            this.itemCategoryOrder = (tintTypedArrayObtainStyledAttributes.getInt(R$styleable.MenuItem_android_menuCategory, this.groupCategory) & Opcodes.V_PREVIEW) | (tintTypedArrayObtainStyledAttributes.getInt(R$styleable.MenuItem_android_orderInCategory, this.groupOrder) & 65535);
        ...
        private void setItem(MenuItem menuItem) {
            ...
            if (this.itemListenerMethodName != null) {
                if (SupportMenuInflater.this.mContext.isRestricted()) {
                    Segment$$ExternalSyntheticBUOutline1.m992m("The android:onClick attribute cannot be used within a restricted context");
                    return;
                }
