...
public class ExifInterface {
    ...
    public static class Rational {
        ...
        public static Rational createFromDouble(double d) {
            ...
            if (d >= 9.223372036854776E18d || d <= -9.223372036854776E18d) {
                return new Rational(d > 0.0d ? LongCompanionObject.MAX_VALUE : Long.MIN_VALUE, 1L);
            }
    ...
    public ExifInterface(File file) throws Throwable {
        ...
        if (file == null) {
            g$$ExternalSyntheticBUOutline2.m208m("file cannot be null");
            throw null;
        }
    ...
    public ExifInterface(String str) throws Throwable {
        ...
        this.mExifByteOrder = ByteOrder.BIG_ENDIAN;
        if (str == null) {
            g$$ExternalSyntheticBUOutline2.m208m("filename cannot be null");
            throw null;
        }
        initForFilename(str);
    }
    ...
    */
    public ExifInterface(java.io.InputStream r3, int r4) {
        ...
        L53:
            ...
            return
        L57:
            java.lang.String r2 = "inputStream cannot be null"
            p005c.g$$ExternalSyntheticBUOutline2.m208m(r2)
            throw r0
        */
    ...
    private ExifAttribute getExifAttribute(String str) {
        ...
        if (str == null) {
            g$$ExternalSyntheticBUOutline2.m208m("tag shouldn't be null");
            return null;
        }
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:70:0x00f1 A[Catch: all -> 0x00fa, Exception -> 0x00fe, TryCatch #17 {Exception -> 0x00fe, all -> 0x00fa, blocks: (B:68:0x00ed, B:70:0x00f1, B:77:0x0110, B:76:0x0101), top: B:129:0x00ed }] */
    /* JADX WARN: Removed duplicated region for block: B:76:0x0101 A[Catch: all -> 0x00fa, Exception -> 0x00fe, TryCatch #17 {Exception -> 0x00fe, all -> 0x00fa, blocks: (B:68:0x00ed, B:70:0x00f1, B:77:0x0110, B:76:0x0101), top: B:129:0x00ed }] */
    ...
    */
    public byte[] getThumbnailBytes() throws java.lang.Throwable {
        ...
        L8:
            ...
            return r1
        Ld:
            android.content.res.AssetManager$AssetInputStream r1 = r8.mAssetInputStream     // Catch: java.lang.Throwable -> L39 java.lang.Exception -> L3c
            if (r1 == 0) goto L2d
        ...
        L24:
            ...
            return r2
        L2d:
            java.lang.String r1 = r8.mFilename     // Catch: java.lang.Throwable -> L39 java.lang.Exception -> L3c
            if (r1 == 0) goto L40
            java.io.FileInputStream r1 = new java.io.FileInputStream     // Catch: java.lang.Throwable -> L39 java.lang.Exception -> L3c
            java.lang.String r3 = r8.mFilename     // Catch: java.lang.Throwable -> L39 java.lang.Exception -> L3c
        ...
        L3c:
            ...
            goto L7e
        L40:
            java.io.FileDescriptor r1 = r8.mSeekableFileDescriptor     // Catch: java.lang.Throwable -> L39 java.lang.Exception -> L3c
            ...
            r1 = r7
        L55:
            androidx.exifinterface.media.ExifInterface$ByteOrderedDataInputStream r4 = new androidx.exifinterface.media.ExifInterface$ByteOrderedDataInputStream     // Catch: java.lang.Throwable -> L74 java.lang.Exception -> L76
            r4.<init>(r1)     // Catch: java.lang.Throwable -> L74 java.lang.Exception -> L76
            int r5 = r8.mThumbnailOffset     // Catch: java.lang.Throwable -> L74 java.lang.Exception -> L76
            int r6 = r8.mOffsetToExifData     // Catch: java.lang.Throwable -> L74 java.lang.Exception -> L76
            int r5 = r5 + r6
            r4.skipFully(r5)     // Catch: java.lang.Throwable -> L74 java.lang.Exception -> L76
            int r5 = r8.mThumbnailLength     // Catch: java.lang.Throwable -> L74 java.lang.Exception -> L76
            ...
            r8.mThumbnailBytes = r5     // Catch: java.lang.Throwable -> L74 java.lang.Exception -> L76
            androidx.exifinterface.media.ExifInterfaceUtils.closeQuietly(r1)
            if (r3 == 0) goto L73
    ...
    public double[] getLatLong() {
        ...
        try {
            ...
            Log.w("ExifInterface", "Latitude/longitude values are not parsable. ".concat(String.format("latValue=%s, latRef=%s, lngValue=%s, lngRef=%s", attribute, attribute2, attribute3, attribute4)));
            return null;
        }
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:36:0x00b1 A[FALL_THROUGH] */
    /* JADX WARN: Removed duplicated region for block: B:57:0x0154 A[LOOP:0: B:10:0x0035->B:57:0x0154, LOOP_END] */
    ...
    */
    ...
    private void getHeifAttributes(final SeekableByteOrderedDataInputStream seekableByteOrderedDataInputStream, int i) {
        ...
        if (i2 < 28) {
            ByteString$$ExternalSyntheticBUOutline0.m979m("Reading EXIF from HEIC files is supported from SDK 28 and above");
            return;
        }
        if (i == 15 && i2 < 31) {
            ByteString$$ExternalSyntheticBUOutline0.m979m("Reading EXIF from AVIF files is supported from SDK 31 and above");
            return;
        }
    ...
    */
    ...
    private void saveJpegAttributes(InputStream inputStream, OutputStream outputStream) throws IOException {
        ...
        if (byteOrderedDataInputStream.readByte() != -1) {
            Model$$ExternalSyntheticBUOutline0.m1247m("Invalid marker");
            return;
        }
        ...
        while (byteOrderedDataInputStream.readByte() == -1) {
            do {
                b2 = byteOrderedDataInputStream.readByte();
            } while (b2 == -1);
            if (b2 == -39 || b2 == -38) {
                byteOrderedDataOutputStream.writeByte(-1);
            ...
            if (b2 == -31) {
                ...
                if (length < 0) {
                    Model$$ExternalSyntheticBUOutline0.m1247m("Invalid length");
                    return;
                }
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:25:0x0076 -> B:10:0x0042). Please report as a decompilation issue!!! */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:82:0x0211 A[Catch: all -> 0x007c, Exception -> 0x0080, TryCatch #5 {Exception -> 0x0080, all -> 0x007c, blocks: (B:7:0x004d, B:9:0x0059, B:11:0x006d, B:12:0x006f, B:80:0x01f5, B:82:0x0211, B:83:0x021a, B:19:0x0084, B:21:0x0093, B:23:0x009b, B:25:0x009f, B:28:0x00af, B:30:0x00ba, B:31:0x00bf, B:32:0x00c1, B:36:0x00cf, B:37:0x00d4, B:38:0x00d8, B:39:0x00e4, B:41:0x00ec, B:45:0x00fa, B:47:0x0102, B:50:0x0109, B:52:0x0118, B:54:0x0128, B:69:0x0184, B:71:0x0190, B:72:0x0197, B:74:0x01d1, B:79:0x01ee, B:76:0x01df, B:78:0x01e7, B:55:0x013c, B:56:0x0143, B:57:0x0144, B:59:0x014e, B:61:0x0154, B:65:0x016d, B:66:0x0175, B:67:0x017c), top: B:97:0x004d }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    private ByteOrder readByteOrder(ByteOrderedDataInputStream byteOrderedDataInputStream) throws IOException {
        ...
        ZipFilesKt$$ExternalSyntheticBUOutline1.m999m("Invalid byte order: ", Integer.toHexString(s));
        return null;
    }
    ...
    private void parseTiffHeaders(ByteOrderedDataInputStream byteOrderedDataInputStream) throws IOException {
        ...
        if (i != 7 && i != 10 && unsignedShort != 42) {
            ZipFilesKt$$ExternalSyntheticBUOutline1.m999m("Invalid start code: ", Integer.toHexString(unsignedShort));
            return;
        }
        int i2 = byteOrderedDataInputStream.readInt();
        if (i2 < 8) {
            ZipFilesKt$$ExternalSyntheticBUOutline0.m998m("Invalid first Ifd offset: ", i2);
            return;
        }
        int i3 = i2 - 8;
        if (i3 > 0) {
    ...
    */
    ...
    private int writeExifSegment(ByteOrderedDataOutputStream byteOrderedDataOutputStream) throws IOException {
        ...
        if (this.mHasThumbnail) {
            ...
            if (z) {
                mapArr2[4].put("StripOffsets", ExifAttribute.createUShort(0, this.mExifByteOrder));
                this.mAttributes[4].put("StripByteCounts", ExifAttribute.createUShort(this.mThumbnailLength, this.mExifByteOrder));
                c3 = 3;
            } else {
                mapArr2[4].put("JPEGInterchangeFormat", ExifAttribute.createULong(0L, this.mExifByteOrder));
                c3 = 3;
        ...
        if (this.mHasThumbnail) {
            ...
            if (z2) {
                mapArr3[4].put("StripOffsets", ExifAttribute.createUShort(size2, this.mExifByteOrder));
            } else {
                mapArr3[4].put("JPEGInterchangeFormat", ExifAttribute.createULong(size2, this.mExifByteOrder));
            }
        ...
        if (DEBUG) {
            for (int i7 = 0; i7 < EXIF_TAGS.length; i7++) {
                Log.d("ExifInterface", String.format("index: %d, offsets: %d, tag count: %d, data sizes: %d, total size: %d", Integer.valueOf(i7), Integer.valueOf(iArr[i7]), Integer.valueOf(this.mAttributes[i7].size()), Integer.valueOf(iArr2[i7]), Integer.valueOf(size2)));
            }
        }
        ...
        if (i8 == 4) {
            if (size2 > 65535) {
                ExifInterface$$ExternalSyntheticBUOutline0.m179m("Size of exif data (", size2, " bytes) exceeds the max size of a JPEG APP1 segment (65536 bytes)");
                return 0;
            }
    ...
    public static class SeekableByteOrderedDataInputStream extends ByteOrderedDataInputStream {
        ...
        public SeekableByteOrderedDataInputStream(InputStream inputStream) {
            ...
            if (!inputStream.markSupported()) {
                g$$ExternalSyntheticBUOutline1.m207m("Cannot create SeekableByteOrderedDataInputStream with stream that does not support mark/reset");
                throw null;
            }
            this.mDataInputStream.mark(Integer.MAX_VALUE);
        }
    ...
    public static class ByteOrderedDataInputStream extends InputStream implements DataInput {
        ...
        public short readShort() throws IOException {
            ...
            ZipFilesKt$$ExternalSyntheticBUOutline1.m999m("Invalid byte order: ", this.mByteOrder);
            return (short) 0;
        }
    ...
    public static class ByteOrderedDataOutputStream extends FilterOutputStream {
        ...
        public void writeUnsignedShort(int i) throws IOException {
            if (i > 65535) {
                g$$ExternalSyntheticBUOutline1.m207m("val is larger than the maximum value of a 16-bit unsigned integer");
            } else {
                writeShort((short) i);
            }
        }
        ...
        public void writeUnsignedInt(long j) throws IOException {
            if (j > 4294967295L) {
                g$$ExternalSyntheticBUOutline1.m207m("val is larger than the maximum value of a 32-bit unsigned integer");
            } else {
                writeInt((int) j);
            }
        }
