...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    public void onSeekTargetStep(int i, int i2, RecyclerView.State state, RecyclerView.SmoothScroller.Action action) {
        ...
        if (DEBUG && (pointF = this.mTargetVector) != null && (pointF.x * i < 0.0f || pointF.y * i2 < 0.0f)) {
            Segment$$ExternalSyntheticBUOutline1.m992m("Scroll happened in the opposite direction of the target. Some calculations are wrong");
            return;
        }
    ...
    public int calculateDtToFit(int i, int i2, int i3, int i4, int i5) {
        ...
        if (i5 != 0) {
            ...
            g$$ExternalSyntheticBUOutline1.m207m("snap preference should be one of the constants defined in SmoothScroller, starting with SNAP_");
            return 0;
        }
        int i6 = i3 - i;
        if (i6 > 0) {
