    ...
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        for (int i10 = 0; i10 < i5; i10++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i7) {
                ...
                if (this.mOrientation == 1) {
                    childMeasureSpec2 = RecyclerView.LayoutManager.getChildMeasureSpec(spaceForSpanRange, TLObject.FLAG_30, i12, ((ViewGroup.MarginLayoutParams) layoutParams).width, false);
                    childMeasureSpec = View.MeasureSpec.makeMeasureSpec(i7 - i11, TLObject.FLAG_30);
                } else {
                    int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i7 - i12, TLObject.FLAG_30);
                    childMeasureSpec = RecyclerView.LayoutManager.getChildMeasureSpec(spaceForSpanRange, TLObject.FLAG_30, i11, ((ViewGroup.MarginLayoutParams) layoutParams).height, false);
