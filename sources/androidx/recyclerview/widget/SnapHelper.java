...
public abstract class SnapHelper extends RecyclerView.OnFlingListener {
    ...
    public class C07681 extends RecyclerView.OnScrollListener {
        boolean mScrolled = false;
    ...
    private void setupCallbacks() {
        if (this.mRecyclerView.getOnFlingListener() != null) {
            Segment$$ExternalSyntheticBUOutline1.m992m("An instance of OnFlingListener already set.");
        } else {
    ...
    public class C07692 extends LinearSmoothScroller {
        public C07692(Context context) {
            super(context);
        }
