...
class AdapterHelper implements OpReorderer.Callback {
    private final ArrayList<String> lastNotifies;
    ...
    public void logNotify(String str) {
        ...
        for (i = 0; i < stackTrace.length && i2 < 5; i++) {
            ...
            if (!string.startsWith("androidx.recyclerview.widget.") || i2 != 0) {
                sb.append("\n");
                sb.append(string);
                sb.append("\n");
                i2++;
    ...
    public String getLastNotifies() {
        ...
        for (int size = this.lastNotifies.size() - 1; size >= 0; size--) {
            ...
            sb.append(this.lastNotifies.get(size));
        }
        return sb.toString();
    }
    ...
    private void dispatchAndUpdateViewHolders(UpdateOp updateOp) {
        ...
        int i2 = updateOp.cmd;
        if (i2 == 1 || i2 == 8) {
            g$$ExternalSyntheticBUOutline1.m207m("should not dispatch add or move for pre layout");
            return;
        }
        ...
        if (i4 == 2) {
            ...
            if (i4 != 4) {
                Native$$ExternalSyntheticBUOutline5.m554m("op should be remove or update.", updateOp);
                return;
            }
            i = 1;
        }
    ...
    public void dispatchFirstPassAndUpdateViewHolders(UpdateOp updateOp, int i) {
        ...
        if (i2 == 2) {
            ...
            g$$ExternalSyntheticBUOutline1.m207m("only remove and update ops can be dispatched in first pass");
        }
    }
    ...
    private void postponeAndUpdateViewHolders(UpdateOp updateOp) {
        ...
        if (i == 4) {
            ...
            Native$$ExternalSyntheticBUOutline5.m554m("Unknown update op type for ", updateOp);
        }
    }
    ...
    public boolean onItemRangeMoved(int i, int i2, int i3) {
        ...
        if (i3 != 1) {
            g$$ExternalSyntheticBUOutline1.m207m("Moving more than 1 item is not supported yet");
            return false;
        }
        if (BuildVars.DEBUG_VERSION) {
