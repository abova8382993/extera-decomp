    ...
    public static DiffResult calculateDiff(Callback callback, boolean z) {
        ...
        while (!arrayList2.isEmpty()) {
            ...
            if (snakeDiffPartial != null) {
                ...
                snakeDiffPartial.f65x += range.oldListStart;
                snakeDiffPartial.f66y += range.newListStart;
                Range range2 = arrayList3.isEmpty() ? new Range() : (Range) arrayList3.remove(arrayList3.size() - 1);
                range2.oldListStart = range.oldListStart;
                range2.newListStart = range.newListStart;
                if (snakeDiffPartial.reverse) {
                    range2.oldListEnd = snakeDiffPartial.f65x;
                    range2.newListEnd = snakeDiffPartial.f66y;
                } else {
                    boolean z2 = snakeDiffPartial.removal;
                    int i2 = snakeDiffPartial.f65x;
                    if (z2) {
                        range2.oldListEnd = i2 - 1;
                        range2.newListEnd = snakeDiffPartial.f66y;
                    } else {
                        range2.oldListEnd = i2;
                        range2.newListEnd = snakeDiffPartial.f66y - 1;
                    }
                }
                arrayList2.add(range2);
                if (snakeDiffPartial.reverse) {
                    boolean z3 = snakeDiffPartial.removal;
                    int i3 = snakeDiffPartial.f65x;
                    if (z3) {
                        int i4 = snakeDiffPartial.size;
                        range.oldListStart = i3 + i4 + 1;
                        range.newListStart = snakeDiffPartial.f66y + i4;
                    } else {
                        int i5 = snakeDiffPartial.size;
                        range.oldListStart = i3 + i5;
                        range.newListStart = snakeDiffPartial.f66y + i5 + 1;
                    }
                } else {
                    int i6 = snakeDiffPartial.f65x;
                    int i7 = snakeDiffPartial.size;
                    range.oldListStart = i6 + i7;
                    range.newListStart = snakeDiffPartial.f66y + i7;
                }
        ...
        public void dispatchUpdatesTo(ListUpdateCallback listUpdateCallback) {
            ...
            while (size >= 0) {
                ...
                for (int i6 = i3 - 1; i6 >= 0; i6--) {
                    ...
                    int i7 = snake.f65x;
                    if ((iArr[i7 + i6] & 31) == 2) {
                        batchingListUpdateCallback.onChanged(i7 + i6, 1, diffResult.mCallback.getChangePayload(i7 + i6, snake.f66y + i6));
                    }
                }
                i = snake.f65x;
                i2 = snake.f66y;
        ...
        private void dispatchAdditions(List<PostponedUpdate> list, ListUpdateCallback listUpdateCallback, int i, int i2, int i3) {
            ...
            for (int i4 = i2 - 1; i4 >= 0; i4--) {
                ...
                if (i7 == 0) {
                    ...
                    MultiCstInsn$$ExternalSyntheticBUOutline0.m222m("unknown flag for pos ", i5, " ", Long.toBinaryString(i7));
                    return;
                }
            }
        }
