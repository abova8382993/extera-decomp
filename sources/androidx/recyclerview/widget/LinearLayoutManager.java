...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public void setOrientation(int i) {
        if (i != 0 && i != 1) {
            CharCodeKt$$ExternalSyntheticBUOutline0.m873m("invalid orientation:", i);
            return;
        }
        assertNotInLayoutOrScroll(null);
    ...
    public int getExtraLayoutSpace(RecyclerView.State state) {
        boolean zHasTargetScrollPosition = state.hasTargetScrollPosition();
        int i = this.addExtraLayoutSpace;
        return zHasTargetScrollPosition ? i + this.mOrientationHelper.getTotalSpace() : i;
    }
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (state.isPreLayout() && (i5 = this.mPendingScrollPosition) != -1 && this.mPendingScrollPositionOffset != Integer.MIN_VALUE && (viewFindViewByPosition = findViewByPosition(i5)) != null) {
            boolean z = this.mPendingScrollPositionBottom;
        ...
        boolean z2 = anchorInfo3.mLayoutFromEnd;
    ...
    private void layoutForPredictiveAnimations(RecyclerView.Recycler recycler, RecyclerView.State state, int i, int i2) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            if (!viewHolder.isRemoved()) {
                boolean z = viewHolder.getLayoutPosition() < position;
            ...
            if (i < 0 || i >= state.getItemCount()) {
                ...
                if (this.mPendingScrollPositionOffset == Integer.MIN_VALUE) {
                    ...
                    if (viewFindViewByPosition != null) {
                        ...
                        if (orientationHelper2.getEndAfterPadding() - this.mOrientationHelper.getDecoratedEnd(viewFindViewByPosition) < 0) {
                        ...
                        if (z2) {
                            decoratedStart = orientationHelper3.getDecoratedEnd(viewFindViewByPosition) + this.mOrientationHelper.getTotalSpaceChange();
                        } else {
                            decoratedStart = orientationHelper3.getDecoratedStart(viewFindViewByPosition);
                        }
    ...
    */
    public void layoutChunk(androidx.recyclerview.widget.RecyclerView.Recycler r7, androidx.recyclerview.widget.RecyclerView.State r8, androidx.recyclerview.widget.LinearLayoutManager.LayoutState r9, androidx.recyclerview.widget.LinearLayoutManager.LayoutChunkResult r10) {
        ...
        La2:
            ...
            boolean r6 = r8.isItemRemoved()
            if (r6 != 0) goto Lb1
            boolean r6 = r8.isItemChanged()
            if (r6 == 0) goto Lb3
        Lb1:
            r10.mIgnoreConsumed = r7
        Lb3:
            boolean r6 = r1.hasFocusable()
            r10.mFocusable = r6
            return
        */
        ...
        if (this.mShouldReverseLayout) {
            for (int i = 1; i < getChildCount(); i++) {
                ...
                if (decoratedStart2 > decoratedStart) {
                    logChildren();
                    GlShader$$ExternalSyntheticBUOutline1.m1250m("detected invalid location");
                    return;
                }
            }
            return;
    ...
    public void prepareForDrop(View view, View view2, int i, int i2) {
        ...
        if (this.mShouldReverseLayout) {
            OrientationHelper orientationHelper = this.mOrientationHelper;
            if (b2 == 1) {
                scrollToPositionWithOffset(position2, orientationHelper.getEndAfterPadding() - (this.mOrientationHelper.getDecoratedStart(view2) + this.mOrientationHelper.getDecoratedMeasurement(view)));
                return;
            } else {
    ...
    public static class SavedState implements Parcelable {
        ...
        public class C07551 implements Parcelable.Creator<SavedState> {
            @Override // android.os.Parcelable.Creator
            public SavedState createFromParcel(Parcel parcel) {
                return new SavedState(parcel);
            }
    ...
    public static class AnchorInfo {
        ...
        public void assignFromViewAndKeepVisibleRect(View view, int i) {
            ...
            OrientationHelper orientationHelper = this.mOrientationHelper;
            if (z) {
                int endAfterPadding = (orientationHelper.getEndAfterPadding() - totalSpaceChange) - this.mOrientationHelper.getDecoratedEnd(view);
