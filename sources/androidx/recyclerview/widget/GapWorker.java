...
final class GapWorker implements Runnable {
    ...
    public static class LayoutPrefetchRegistryImpl implements RecyclerView.LayoutManager.LayoutPrefetchRegistry {
        ...
        public void addPosition(int i, int i2) {
            if (i < 0) {
                g$$ExternalSyntheticBUOutline1.m207m("Layout positions must be non-negative");
                return;
            }
            if (i2 < 0) {
                g$$ExternalSyntheticBUOutline1.m207m("Pixel distance must be non-negative");
                return;
            }
            int i3 = this.mCount;
            int i4 = i3 * 2;
            ...
            try {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: androidx.recyclerview.widget.GapWorker$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        GapWorker.$r8$lambda$AzUCWB2uRWYN3md5QS0GYsl7qPU(recyclerView);
                    }
                });
                recyclerView.onExitLayoutOrScroll(false);
                return null;
