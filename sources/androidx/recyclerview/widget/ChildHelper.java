...
public class ChildHelper {
    ...
    public void hide(View view) {
        int iIndexOfChild = this.mCallback.indexOfChild(view);
        if (iIndexOfChild < 0) {
            Native$$ExternalSyntheticBUOutline5.m554m("view is not a child, cannot hide ", view);
        } else {
    ...
    public void unhide(View view) {
        ...
        if (iIndexOfChild < 0) {
            ...
            MVEL$$ExternalSyntheticBUOutline0.m1006m("trying to unhide a view that was not hidden", view);
        } else {
