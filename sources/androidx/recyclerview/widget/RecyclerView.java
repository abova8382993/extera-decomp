...
public class RecyclerView extends ViewGroup implements NestedScrollingChild {
    ...
    public class InterpolatorC07613 implements Interpolator {
    ...
    public class RunnableC07591 implements Runnable {
        public RunnableC07591() {
        }
    ...
    public class RunnableC07602 implements Runnable {
        public RunnableC07602() {
        }
    ...
    public class C07624 implements ViewInfoStore.ProcessCallback {
        public C07624() {
        }
    ...
    public class C07635 implements ChildHelper.Callback {
        public C07635() {
        }
    ...
    public class C07646 implements AdapterHelper.Callback {
        public C07646() {
        }
    ...
    public void setLayoutManager(LayoutManager layoutManager) {
        ...
        if (layoutManager != null) {
            if (layoutManager.mRecyclerView != null) {
                ...
                Utils$$ExternalSyntheticBUOutline1.m1267m(sb, " is already attached to a RecyclerView:", layoutManager.mRecyclerView.exceptionLabel());
                return;
            } else {
    ...
    public void setLayoutTransition(LayoutTransition layoutTransition) {
        if (layoutTransition == null) {
            ...
            g$$ExternalSyntheticBUOutline1.m207m("Providing a LayoutTransition into RecyclerView is not supported. Please use setItemAnimator() instead for animating changes to the items in this RecyclerView");
        }
    }
    ...
    */
    ...
    private boolean isPreferredNextFocus(View view, View view2, int i) {
        ...
        Structure$$ExternalSyntheticBUOutline2.m557m("Invalid direction: ", i, exceptionLabel());
        return false;
    }
    ...
    */
    ...
    public void assertInLayoutOrScroll(String str) {
        ...
        if (str == null) {
            CstInsn$$ExternalSyntheticBUOutline0.m219m("Cannot call this method unless RecyclerView is computing a layout or scrolling", exceptionLabel());
        } else {
            Preconditions$$ExternalSyntheticBUOutline0.m560m(str, exceptionLabel());
        }
    }
    ...
    public void assertNotInLayoutOrScroll(String str) {
        if (isComputingLayout()) {
            if (str == null) {
                CstInsn$$ExternalSyntheticBUOutline0.m219m("Cannot call this method while RecyclerView is computing a layout or scrolling", exceptionLabel());
                return;
            } else {
    ...
    /* JADX WARN: Type inference failed for: r5v1, types: [androidx.recyclerview.widget.RecyclerView] */
    ...
    */
    ...
    private void dispatchLayoutStep3() {
                ...
                while (childCount >= 0) {
                    ...
                    if (childViewHolderInt == null || childViewHolderInt.shouldIgnore()) {
                        ...
                        if (fromOldChangeHolders != null && !fromOldChangeHolders.shouldIgnore()) {
                            ...
                            recyclerView = this;
                            recyclerView.mViewInfoStore.addToPostLayout(childViewHolderInt, itemHolderInfoRecordPostLayoutInformation);
                        }
                    }
                    childCount--;
                    this = recyclerView;
        ...
        ArrayList<ViewHolder> arrayList = recyclerView2.mRecycler.mChangedScrap;
        if (arrayList != null) {
            arrayList.clear();
        }
        ...
        recyclerView2.onExitLayoutOrScroll();
        recyclerView2.stopInterceptRequestLayout(false);
        recyclerView2.mViewInfoStore.clear();
        int[] iArr = recyclerView2.mMinMaxLayoutPositions;
        if (recyclerView2.didChildRangeChange(iArr[0], iArr[1])) {
            recyclerView2.dispatchOnScrolled(0, 0);
        }
        recyclerView2.recoverFocusFromState();
        recyclerView2.resetFocusInfo();
    }
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childViewHolderInt != viewHolder && getChangedHolderKey(childViewHolderInt) == j) {
                ...
                if (adapter != null && adapter.hasStableIds()) {
                    ...
                    RecyclerView$$ExternalSyntheticBUOutline0.m191m(sb, exceptionLabel());
                    return;
                }
                ...
                RecyclerView$$ExternalSyntheticBUOutline0.m191m(sb2, exceptionLabel());
                return;
            }
        }
    ...
    public ViewGroup.LayoutParams generateDefaultLayoutParams() {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            CstInsn$$ExternalSyntheticBUOutline0.m219m("RecyclerView has no LayoutManager", exceptionLabel());
            return null;
        }
    ...
    public ViewHolder getChildViewHolder(View view) {
        ...
        if (parent != null && parent != this) {
            Utils$$ExternalSyntheticBUOutline2.m1268m("View ", view, " is not a direct child of ", this);
            return null;
        }
    ...
    */
    ...
    public final class Recycler {
        ...
        /* JADX WARN: Removed duplicated region for block: B:181:0x01bc A[ADDED_TO_REGION] */
        ...
        */
        ...
        public void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (viewHolder.shouldIgnore()) {
                Buffer$$ExternalSyntheticBUOutline4.m978m("Trying to recycle an ignored view holder. You should first call stopIgnoringView(view) before calling recycle.", RecyclerView.this.exceptionLabel());
                return;
            }
        ...
        public void scrapView(View view) {
            ...
            if (childViewHolderInt.hasAnyOfTheFlags(12) || !childViewHolderInt.isUpdated() || RecyclerView.this.canReuseUpdatedViewHolder(childViewHolderInt)) {
                if (childViewHolderInt.isInvalid() && !childViewHolderInt.isRemoved() && !RecyclerView.this.mAdapter.hasStableIds()) {
                    Buffer$$ExternalSyntheticBUOutline4.m978m("Called scrap view with an invalid view. Invalid views cannot be reused from scrap, they should rebound from recycler pool.", RecyclerView.this.exceptionLabel());
                    return;
                } else {
        ...
        public ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i, boolean z) {
            ...
            if (!z && (viewFindHiddenNonRemovedView = RecyclerView.this.mChildHelper.findHiddenNonRemovedView(i)) != null) {
                ...
                if (iIndexOfChild == -1) {
                    ...
                    sb.append(childViewHolderInt);
                    RecyclerView$$ExternalSyntheticBUOutline0.m191m(sb, RecyclerView.this.exceptionLabel());
                    return null;
                }
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public void setHasStableIds(boolean z) {
            if (hasObservers()) {
                Segment$$ExternalSyntheticBUOutline1.m992m("Cannot change whether this adapter has stable IDs while the adapter has registered observers.");
            } else {
    ...
    public static abstract class LayoutManager {
        ...
        public LayoutManager() {
            C07651 c07651 = new ViewBoundsCheck.Callback() { // from class: androidx.recyclerview.widget.RecyclerView.LayoutManager.1
                public C07651() {
                }
            ...
            this.mHorizontalBoundCheckCallback = c07651;
            C07662 c07662 = new ViewBoundsCheck.Callback() { // from class: androidx.recyclerview.widget.RecyclerView.LayoutManager.2
                public C07662() {
                }
            ...
            this.mVerticalBoundCheckCallback = c07662;
            this.mHorizontalBoundCheck = new ViewBoundsCheck(c07651);
            this.mVerticalBoundCheck = new ViewBoundsCheck(c07662);
        ...
        public class C07651 implements ViewBoundsCheck.Callback {
            public C07651() {
            }
        ...
        public class C07662 implements ViewBoundsCheck.Callback {
            public C07662() {
            }
        ...
        public void ignoreView(View view) {
            ...
            if (parent != recyclerView || recyclerView.indexOfChild(view) == -1) {
                Buffer$$ExternalSyntheticBUOutline4.m978m("View should be fully attached to be ignored", this.mRecyclerView.exceptionLabel());
                return;
            }
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
  ...
  0x000c: PHI (r3v5 int) = (r3v0 int), (r3v2 int), (r3v0 int) binds: [B:24:0x0010, B:28:0x0016, B:21:0x000a] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        */
        ...
        /* JADX WARN: Removed duplicated region for block: B:47:0x0042 A[PHI: r2
  0x0042: PHI (r2v8 int) = (r2v4 int), (r2v12 int) binds: [B:53:0x0060, B:45:0x0030] A[DONT_GENERATE, DONT_INLINE]] */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
    ...
    public static abstract class ViewHolder {
        ...
        public ViewHolder(View view) {
            if (view == null) {
                g$$ExternalSyntheticBUOutline1.m207m("itemView may not be null");
                throw null;
            }
            this.itemView = view;
        }
        ...
        public final void setIsRecyclable(boolean z) {
            ...
            if (i2 < 0) {
                this.mIsRecyclableCount = 0;
                if (BuildVars.DEBUG_VERSION) {
                    MVEL$$ExternalSyntheticBUOutline0.m1006m("isRecyclable decremented below 0: unmatched pair of setIsRecyable() calls for ", this);
                    return;
                }
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        if (stateListDrawable == null || drawable == null || stateListDrawable2 == null || drawable2 == null) {
            Buffer$$ExternalSyntheticBUOutline4.m978m("Trying to set fast scroller without both required drawables.", exceptionLabel());
        } else {
            getContext().getResources();
            new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, AndroidUtilities.m1036dp(8.0f), AndroidUtilities.m1036dp(50.0f), 0);
        }
    }
    ...
    public static abstract class SmoothScroller {
        ...
        public void start(RecyclerView recyclerView, LayoutManager layoutManager) {
            ...
            if (i == -1) {
                g$$ExternalSyntheticBUOutline1.m207m("Invalid target position");
                return;
            }
        ...
        public static class Action {
            ...
            private void validate() {
                if (this.mInterpolator != null && this.mDuration < 1) {
                    Segment$$ExternalSyntheticBUOutline1.m992m("If you provide an interpolator, you must set a positive duration");
                } else {
                    if (this.mDuration >= 1) {
                        return;
                    }
                    Segment$$ExternalSyntheticBUOutline1.m992m("Scroll duration must be a positive number");
                }
            }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        /* JADX INFO: loaded from: classes4.dex */
        public class C07671 implements Parcelable.ClassLoaderCreator<SavedState> {
            @Override // android.os.Parcelable.ClassLoaderCreator
            public SavedState createFromParcel(Parcel parcel, ClassLoader classLoader) {
                return new SavedState(parcel, classLoader);
            }
    ...
    public static class State {
        ...
        public void assertLayoutStep(int i) {
            ...
            RegistryImpl$$ExternalSyntheticBUOutline0.m563m("Layout state should be one of ", Integer.toBinaryString(i), " but it is ", Integer.toBinaryString(this.mLayoutStep));
        }
