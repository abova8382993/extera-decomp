...
public abstract class Loader<D> {
    ...
    public void registerListener(int i, OnLoadCompleteListener<D> onLoadCompleteListener) {
        if (this.mListener != null) {
            Segment$$ExternalSyntheticBUOutline1.m992m("There is already a listener registered");
        } else {
    ...
    public void unregisterListener(OnLoadCompleteListener<D> onLoadCompleteListener) {
        ...
        if (onLoadCompleteListener2 == null) {
            Segment$$ExternalSyntheticBUOutline1.m992m("No listener register");
        } else if (onLoadCompleteListener2 != onLoadCompleteListener) {
            g$$ExternalSyntheticBUOutline1.m207m("Attempting to unregister the wrong listener");
        } else {
            this.mListener = null;
        }
    }
