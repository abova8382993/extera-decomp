...
public class MediaRouteButton extends View {
    ...
    public MediaRouteButton(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context2.obtainStyledAttributes(attributeSet, R$styleable.MediaRouteButton, i, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context2, R$styleable.MediaRouteButton, attributeSet, typedArrayObtainStyledAttributes, i, 0);
        if (isInEditMode()) {
            this.mRouter = null;
            this.mCallback = null;
    ...
    public void setDialogFactory(MediaRouteDialogFactory mediaRouteDialogFactory) {
        if (mediaRouteDialogFactory == null) {
            g$$ExternalSyntheticBUOutline1.m207m("factory must not be null");
        } else {
    ...
    private boolean showDialogForType(int i) {
        ...
        if (fragmentManager == null) {
            Segment$$ExternalSyntheticBUOutline1.m992m("The activity must be a subclass of FragmentActivity");
            return false;
        }
