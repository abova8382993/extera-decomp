...
public class MediaRouteControllerDialog extends AlertDialog {
    ...
    /* JADX INFO: renamed from: androidx.mediarouter.app.MediaRouteControllerDialog$1 */
    public class RunnableC06741 implements Runnable {
        public RunnableC06741() {
        }
    ...
    private boolean isGroup() {
        return this.mRoute.isGroup() && this.mRoute.getSelectedRoutesInGroup().size() > 1;
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        frameLayout.setOnClickListener(new View.OnClickListener() { // from class: androidx.mediarouter.app.MediaRouteControllerDialog.2
            public ViewOnClickListenerC06782() {
            }
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() { // from class: androidx.mediarouter.app.MediaRouteControllerDialog.3
            ...
            public ViewOnClickListenerC06793() {
            }
        });
        ...
        ViewOnClickListenerC06804 viewOnClickListenerC06804 = new View.OnClickListener() { // from class: androidx.mediarouter.app.MediaRouteControllerDialog.4
            public ViewOnClickListenerC06804() {
            }
        ...
        imageView.setOnClickListener(viewOnClickListenerC06804);
        findViewById(R$id.mr_control_title_container).setOnClickListener(viewOnClickListenerC06804);
        ...
        mediaRouteExpandCollapseButton.setOnClickListener(new View.OnClickListener() { // from class: androidx.mediarouter.app.MediaRouteControllerDialog.5
            public ViewOnClickListenerC06815() {
            }
    ...
    /* JADX INFO: renamed from: androidx.mediarouter.app.MediaRouteControllerDialog$2 */
    public class ViewOnClickListenerC06782 implements View.OnClickListener {
        public ViewOnClickListenerC06782() {
        }
    ...
    /* JADX INFO: renamed from: androidx.mediarouter.app.MediaRouteControllerDialog$3 */
    public class ViewOnClickListenerC06793 implements View.OnClickListener {
        @Override // android.view.View.OnClickListener
        public void onClick(View view) {
        }
    ...
    /* JADX INFO: renamed from: androidx.mediarouter.app.MediaRouteControllerDialog$4 */
    public class ViewOnClickListenerC06804 implements View.OnClickListener {
        public ViewOnClickListenerC06804() {
        }
    ...
    /* JADX INFO: renamed from: androidx.mediarouter.app.MediaRouteControllerDialog$5 */
    public class ViewOnClickListenerC06815 implements View.OnClickListener {
        public ViewOnClickListenerC06815() {
        }
    ...
    public void updateLayoutHeight(boolean z) {
        ...
        this.mDefaultControlLayout.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: androidx.mediarouter.app.MediaRouteControllerDialog.6
            ...
            public ViewTreeObserverOnGlobalLayoutListenerC06826(boolean z2) {
                z = z2;
            }
    ...
    /* JADX INFO: renamed from: androidx.mediarouter.app.MediaRouteControllerDialog$6 */
    public class ViewTreeObserverOnGlobalLayoutListenerC06826 implements ViewTreeObserver.OnGlobalLayoutListener {
        final /* synthetic */ boolean val$animate;
    ...
    public void updateLayoutHeightInternal(boolean z) {
        ...
        int size2 = isGroup() ? this.mVolumeGroupListItemHeight * this.mRoute.getSelectedRoutesInGroup().size() : 0;
        if (size > 0) {
    ...
    private void animateLayoutHeight(View view, int i) {
        C06837 c06837 = new Animation() { // from class: androidx.mediarouter.app.MediaRouteControllerDialog.7
            final /* synthetic */ int val$endValue;
            final /* synthetic */ int val$startValue;
            final /* synthetic */ View val$view;

            public C06837(int i2, int i3, View view2) {
                i = i2;
                i = i3;
                view = view2;
            }
            ...
            public void applyTransformation(float f, Transformation transformation) {
                MediaRouteControllerDialog.setLayoutHeight(view, i - ((int) ((r3 - i) * f)));
            }
        };
        c06837.setDuration(this.mGroupListAnimationDurationMs);
        c06837.setInterpolator(this.mInterpolator);
        view2.startAnimation(c06837);
    }

    /* JADX INFO: renamed from: androidx.mediarouter.app.MediaRouteControllerDialog$7 */
    public class C06837 extends Animation {
        final /* synthetic */ int val$endValue;
        final /* synthetic */ int val$startValue;
        final /* synthetic */ View val$view;
    ...
    private void rebuildVolumeGroupList(boolean z) {
        List<MediaRouter.RouteInfo> selectedRoutesInGroup = this.mRoute.getSelectedRoutesInGroup();
        boolean zIsEmpty = selectedRoutesInGroup.isEmpty();
        ...
        if (MediaRouteDialogHelper.listUnorderedEquals(list, selectedRoutesInGroup)) {
            this.mVolumeGroupAdapter.notifyDataSetChanged();
            return;
        }
        ...
        this.mGroupMemberRoutesAdded = MediaRouteDialogHelper.getItemsAdded(this.mGroupMemberRoutes, selectedRoutesInGroup);
        this.mGroupMemberRoutesRemoved = MediaRouteDialogHelper.getItemsRemoved(this.mGroupMemberRoutes, selectedRoutesInGroup);
    ...
    private void animateGroupListItems(Map<MediaRouter.RouteInfo, Rect> map, Map<MediaRouter.RouteInfo, BitmapDrawable> map2) {
        ...
        this.mVolumeGroupList.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: androidx.mediarouter.app.MediaRouteControllerDialog.8
            ...
            public ViewTreeObserverOnGlobalLayoutListenerC06848(Map map3, Map map22) {
                map = map3;
                map = map22;
            }
            ...
            public void onGlobalLayout() {
                ...
                MediaRouteControllerDialog.this.animateGroupListItemsInternal(map, map);
            }
        });
    }

    /* JADX INFO: renamed from: androidx.mediarouter.app.MediaRouteControllerDialog$8 */
    public class ViewTreeObserverOnGlobalLayoutListenerC06848 implements ViewTreeObserver.OnGlobalLayoutListener {
        final /* synthetic */ Map val$previousRouteBitmapMap;
        final /* synthetic */ Map val$previousRouteBoundMap;
    ...
    public void animateGroupListItemsInternal(Map<MediaRouter.RouteInfo, Rect> map, Map<MediaRouter.RouteInfo, BitmapDrawable> map2) {
        ...
        AnimationAnimationListenerC06859 animationAnimationListenerC06859 = new Animation.AnimationListener() { // from class: androidx.mediarouter.app.MediaRouteControllerDialog.9
            ...
            public AnimationAnimationListenerC06859() {
            }
        ...
        for (int i2 = 0; i2 < this.mVolumeGroupList.getChildCount(); i2++) {
            ...
            if (!z) {
                animationSet.setAnimationListener(animationAnimationListenerC06859);
                z = true;
            }
        ...
        for (Map.Entry<MediaRouter.RouteInfo, BitmapDrawable> entry : map2.entrySet()) {
            ...
            if (this.mGroupMemberRoutesRemoved.contains(key)) {
                ...
                animationEndListener = new OverlayListView.OverlayObject(value, rect2).setTranslateYAnimation(this.mVolumeGroupListItemHeight * size).setDuration(this.mGroupListAnimationDurationMs).setInterpolator(this.mInterpolator).setAnimationEndListener(new OverlayListView.OverlayObject.OnAnimationEndListener() { // from class: androidx.mediarouter.app.MediaRouteControllerDialog.10
                    ...
                    public C067510(MediaRouter.RouteInfo key2) {
                        routeInfo = key2;
                    }
                ...
                this.mGroupMemberRoutesAnimatingWithBitmap.add(key2);
            }
            this.mVolumeGroupList.addOverlayObject(animationEndListener);
        }
    }

    /* JADX INFO: renamed from: androidx.mediarouter.app.MediaRouteControllerDialog$9 */
    public class AnimationAnimationListenerC06859 implements Animation.AnimationListener {
        @Override // android.view.animation.Animation.AnimationListener
        public void onAnimationEnd(Animation animation) {
        }
    ...
    /* JADX INFO: renamed from: androidx.mediarouter.app.MediaRouteControllerDialog$10 */
    public class C067510 implements OverlayListView.OverlayObject.OnAnimationEndListener {
        final /* synthetic */ MediaRouter.RouteInfo val$route;
    ...
    public void startGroupListFadeInAnimation() {
        ...
        this.mVolumeGroupList.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: androidx.mediarouter.app.MediaRouteControllerDialog.11
            public ViewTreeObserverOnGlobalLayoutListenerC067611() {
            }
    ...
    /* JADX INFO: renamed from: androidx.mediarouter.app.MediaRouteControllerDialog$11 */
    public class ViewTreeObserverOnGlobalLayoutListenerC067611 implements ViewTreeObserver.OnGlobalLayoutListener {
        public ViewTreeObserverOnGlobalLayoutListenerC067611() {
        }
    ...
    /* JADX INFO: renamed from: androidx.mediarouter.app.MediaRouteControllerDialog$12 */
    public class AnimationAnimationListenerC067712 implements Animation.AnimationListener {
        @Override // android.view.animation.Animation.AnimationListener
        public void onAnimationRepeat(Animation animation) {
        }
        ...
        public AnimationAnimationListenerC067712() {
        }
    ...
    private void fadeInAddedRoutes() {
        AnimationAnimationListenerC067712 animationAnimationListenerC067712 = new Animation.AnimationListener() { // from class: androidx.mediarouter.app.MediaRouteControllerDialog.12
            @Override // android.view.animation.Animation.AnimationListener
            public void onAnimationRepeat(Animation animation) {
            }
        ...
        for (int i = 0; i < this.mVolumeGroupList.getChildCount(); i++) {
            ...
            if (this.mGroupMemberRoutesAdded.contains((MediaRouter.RouteInfo) this.mVolumeGroupAdapter.getItem(firstVisiblePosition + i))) {
                ...
                if (!z) {
                    alphaAnimation.setAnimationListener(animationAnimationListenerC067712);
                    z = true;
                }
                childAt.clearAnimation();
    ...
    public void clearGroupListAnimation(boolean z) {
        ...
        int i = 0;
        while (true) {
            int childCount = this.mVolumeGroupList.getChildCount();
            overlayListView = this.mVolumeGroupList;
            if (i >= childCount) {
                break;
            }
        ...
        overlayListView.stopAnimationAll();
        if (z) {
            return;
        }
    ...
    */
    ...
    public int getDesiredArtHeight(int i, int i2) {
        float f;
        float f2;
        int i3 = this.mDialogContentWidth;
        if (i >= i2) {
            f = i3 * i2;
            f2 = i;
        } else {
    ...
    public class VolumeChangeListener implements SeekBar.OnSeekBarChangeListener {
        ...
        /* JADX INFO: renamed from: androidx.mediarouter.app.MediaRouteControllerDialog$VolumeChangeListener$1 */
        public class RunnableC06861 implements Runnable {
            public RunnableC06861() {
            }
