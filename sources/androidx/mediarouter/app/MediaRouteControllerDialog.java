...
public class MediaRouteControllerDialog extends AlertDialog {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        ViewOnClickListenerC06624 viewOnClickListenerC06624 = new View.OnClickListener() { // from class: androidx.mediarouter.app.MediaRouteControllerDialog.4
            ViewOnClickListenerC06624() {
            }
        ...
        imageView.setOnClickListener(viewOnClickListenerC06624);
        findViewById(R$id.mr_control_title_container).setOnClickListener(viewOnClickListenerC06624);
    ...
    class ViewOnClickListenerC06613 implements View.OnClickListener {
        @Override // android.view.View.OnClickListener
        public void onClick(View view) {
        }
    ...
    class ViewOnClickListenerC06624 implements View.OnClickListener {
        ViewOnClickListenerC06624() {
        }
    ...
    class ViewOnClickListenerC06635 implements View.OnClickListener {
        ViewOnClickListenerC06635() {
        }
    ...
    void updateLayoutHeight(boolean z) {
        ...
        this.mDefaultControlLayout.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: androidx.mediarouter.app.MediaRouteControllerDialog.6
            ...
            ViewTreeObserverOnGlobalLayoutListenerC06646(boolean z2) {
                z = z2;
            }
    ...
    class ViewTreeObserverOnGlobalLayoutListenerC06646 implements ViewTreeObserver.OnGlobalLayoutListener {
        final /* synthetic */ boolean val$animate;
    ...
    private void animateLayoutHeight(View view, int i) {
        C06657 c06657 = new Animation() { // from class: androidx.mediarouter.app.MediaRouteControllerDialog.7
            final /* synthetic */ int val$endValue;
            final /* synthetic */ int val$startValue;
            final /* synthetic */ View val$view;

            C06657(int i2, int i3, View view2) {
                i = i2;
                i = i3;
                view = view2;
            }
        ...
        c06657.setDuration(this.mGroupListAnimationDurationMs);
        c06657.setInterpolator(this.mInterpolator);
        view2.startAnimation(c06657);
    }

    /* JADX INFO: renamed from: androidx.mediarouter.app.MediaRouteControllerDialog$7 */
    class C06657 extends Animation {
        final /* synthetic */ int val$endValue;
        final /* synthetic */ int val$startValue;
        final /* synthetic */ View val$view;
    ...
    private void animateGroupListItems(Map map, Map map2) {
        ...
        this.mVolumeGroupList.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: androidx.mediarouter.app.MediaRouteControllerDialog.8
            ...
            ViewTreeObserverOnGlobalLayoutListenerC06668(Map map3, Map map22) {
                map = map3;
                map = map22;
            }
    ...
    class ViewTreeObserverOnGlobalLayoutListenerC06668 implements ViewTreeObserver.OnGlobalLayoutListener {
        final /* synthetic */ Map val$previousRouteBitmapMap;
        final /* synthetic */ Map val$previousRouteBoundMap;
    ...
    void animateGroupListItemsInternal(Map map, Map map2) {
        ...
        AnimationAnimationListenerC06679 animationAnimationListenerC06679 = new Animation.AnimationListener() { // from class: androidx.mediarouter.app.MediaRouteControllerDialog.9
            ...
            AnimationAnimationListenerC06679() {
            }
        ...
        for (int i2 = 0; i2 < this.mVolumeGroupList.getChildCount(); i2++) {
            ...
            Object obj = (MediaRouter.RouteInfo) this.mVolumeGroupAdapter.getItem(firstVisiblePosition + i2);
            ...
            if (!z) {
                animationSet.setAnimationListener(animationAnimationListenerC06679);
                z = true;
            }
        ...
        for (Map.Entry entry : map2.entrySet()) {
            ...
            if (this.mGroupMemberRoutesRemoved.contains(routeInfo)) {
                ...
                animationEndListener = new OverlayListView.OverlayObject(bitmapDrawable, rect2).setTranslateYAnimation(this.mVolumeGroupListItemHeight * size).setDuration(this.mGroupListAnimationDurationMs).setInterpolator(this.mInterpolator).setAnimationEndListener(new OverlayListView.OverlayObject.OnAnimationEndListener() { // from class: androidx.mediarouter.app.MediaRouteControllerDialog.10
                    ...
                    C065710(MediaRouter.RouteInfo routeInfo2) {
    ...
    class AnimationAnimationListenerC06679 implements Animation.AnimationListener {
        @Override // android.view.animation.Animation.AnimationListener
        public void onAnimationEnd(Animation animation) {
        }
    ...
    class C065710 implements OverlayListView.OverlayObject.OnAnimationEndListener {
        final /* synthetic */ MediaRouter.RouteInfo val$route;
    ...
    void startGroupListFadeInAnimation() {
        ...
        this.mVolumeGroupList.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: androidx.mediarouter.app.MediaRouteControllerDialog.11
            ViewTreeObserverOnGlobalLayoutListenerC065811() {
            }
    ...
    class ViewTreeObserverOnGlobalLayoutListenerC065811 implements ViewTreeObserver.OnGlobalLayoutListener {
        ViewTreeObserverOnGlobalLayoutListenerC065811() {
        }
    ...
    class AnimationAnimationListenerC065912 implements Animation.AnimationListener {
        @Override // android.view.animation.Animation.AnimationListener
        public void onAnimationRepeat(Animation animation) {
        }
        ...
        AnimationAnimationListenerC065912() {
        }
    ...
    private void fadeInAddedRoutes() {
        AnimationAnimationListenerC065912 animationAnimationListenerC065912 = new Animation.AnimationListener() { // from class: androidx.mediarouter.app.MediaRouteControllerDialog.12
            @Override // android.view.animation.Animation.AnimationListener
            public void onAnimationRepeat(Animation animation) {
            }
        ...
        for (int i = 0; i < this.mVolumeGroupList.getChildCount(); i++) {
            ...
            if (this.mGroupMemberRoutesAdded.contains((MediaRouter.RouteInfo) this.mVolumeGroupAdapter.getItem(firstVisiblePosition + i))) {
                ...
                if (!z) {
                    alphaAnimation.setAnimationListener(animationAnimationListenerC065912);
                    z = true;
                }
                childAt.clearAnimation();
    ...
    */
    ...
    private class VolumeChangeListener implements SeekBar.OnSeekBarChangeListener {
        ...
        class RunnableC06681 implements Runnable {
            RunnableC06681() {
            }
