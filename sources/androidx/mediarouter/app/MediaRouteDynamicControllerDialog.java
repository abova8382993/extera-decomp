...
public class MediaRouteDynamicControllerDialog extends AppCompatDialog {
    ...
    class HandlerC06721 extends Handler {
        HandlerC06721() {
        }
    ...
    class ViewOnClickListenerC06732 implements View.OnClickListener {
        ViewOnClickListenerC06732() {
        }
    ...
    class ViewOnClickListenerC06743 implements View.OnClickListener {
        ViewOnClickListenerC06743() {
        }
    ...
    private abstract class MediaRouteVolumeSliderHolder extends RecyclerView.ViewHolder {
        ...
        class ViewOnClickListenerC06751 implements View.OnClickListener {
            ViewOnClickListenerC06751() {
            }
    ...
    private final class RecyclerAdapter extends RecyclerView.Adapter {
        ...
        void animateLayoutHeight(View view, int i) {
            C06761 c06761 = new Animation() { // from class: androidx.mediarouter.app.MediaRouteDynamicControllerDialog.RecyclerAdapter.1
                final /* synthetic */ int val$endValue;
                final /* synthetic */ int val$startValue;
                final /* synthetic */ View val$view;

                C06761(int i2, int i3, View view2) {
                    i = i2;
                    i = i3;
                    view = view2;
                }
            ...
            c06761.setAnimationListener(new Animation.AnimationListener() { // from class: androidx.mediarouter.app.MediaRouteDynamicControllerDialog.RecyclerAdapter.2
                @Override // android.view.animation.Animation.AnimationListener
                public void onAnimationRepeat(Animation animation) {
                }

                AnimationAnimationListenerC06772() {
                }
            ...
            c06761.setDuration(this.mLayoutAnimationDurationMs);
            c06761.setInterpolator(this.mAccelerateDecelerateInterpolator);
            view2.startAnimation(c06761);
        }

        /* JADX INFO: renamed from: androidx.mediarouter.app.MediaRouteDynamicControllerDialog$RecyclerAdapter$1 */
        class C06761 extends Animation {
            final /* synthetic */ int val$endValue;
            final /* synthetic */ int val$startValue;
            final /* synthetic */ View val$view;
        ...
        class AnimationAnimationListenerC06772 implements Animation.AnimationListener {
            @Override // android.view.animation.Animation.AnimationListener
            public void onAnimationRepeat(Animation animation) {
            }
        ...
        private class RouteViewHolder extends MediaRouteVolumeSliderHolder {
            ...
            class ViewOnClickListenerC06791 implements View.OnClickListener {
                ViewOnClickListenerC06791() {
                }
        ...
        private class GroupViewHolder extends RecyclerView.ViewHolder {
            ...
            class ViewOnClickListenerC06781 implements View.OnClickListener {
                ViewOnClickListenerC06781() {
                }
