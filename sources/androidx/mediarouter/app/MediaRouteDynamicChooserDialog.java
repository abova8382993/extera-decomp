...
public class MediaRouteDynamicChooserDialog extends AppCompatDialog {
    ...
    class HandlerC06691 extends Handler {
        HandlerC06691() {
        }
    ...
    class ViewOnClickListenerC06702 implements View.OnClickListener {
        ViewOnClickListenerC06702() {
        }
        ...
        private class RouteViewHolder extends RecyclerView.ViewHolder {
            ...
            public void bindRouteView(Item item) {
                ...
                this.mItemView.setOnClickListener(new View.OnClickListener() { // from class: androidx.mediarouter.app.MediaRouteDynamicChooserDialog.RecyclerAdapter.RouteViewHolder.1
                    ...
                    ViewOnClickListenerC06711(MediaRouter.RouteInfo routeInfo2) {
            ...
            class ViewOnClickListenerC06711 implements View.OnClickListener {
                final /* synthetic */ MediaRouter.RouteInfo val$route;
