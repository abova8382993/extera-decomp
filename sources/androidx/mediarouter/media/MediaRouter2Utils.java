...
abstract class MediaRouter2Utils {
    ...
    public static MediaRouteDescriptor toMediaRouteDescriptor(MediaRoute2Info mediaRoute2Info) {
        ...
        if (features.contains("android.media.route.feature.REMOTE_DYNAMIC_GROUP_ROUTE")) {
            canDisconnect.setIsDynamicGroupRoute(true);
        }
        if (features.contains("android.media.route.feature.REMOTE_GROUP_PLAYBACK")) {
            ArrayList<String> stringArrayList = extras.getStringArrayList("androidx.mediarouter.media.KEY_GROUP_MEMBER_IDS");
            if (stringArrayList == null || stringArrayList.isEmpty()) {
                Log.w("MediaRouter2Utils", "Invalid feature of a group without members");
            } else {
                canDisconnect.addGroupMemberIds(stringArrayList);
            }
        }
    ...
    public static List<String> getRouteIds(List<MediaRoute2Info> list) {
        ...
        while (it.hasNext()) {
            ...
            if (mediaRoute2InfoM186m != null) {
                arrayList.add(mediaRoute2InfoM186m.getId());
            }
        }
        return arrayList;
    }
    ...
    public static RouteDiscoveryPreference toDiscoveryPreference(MediaRouteDiscoveryRequest mediaRouteDiscoveryRequest) {
        if (mediaRouteDiscoveryRequest == null || !mediaRouteDiscoveryRequest.isValid()) {
            MediaRouter2Utils$$ExternalSyntheticApiModelOutline1.m188m();
            return MediaRouter2Utils$$ExternalSyntheticApiModelOutline0.m187m(new ArrayList(), false).build();
        }
        ...
        return MediaRouter2Utils$$ExternalSyntheticApiModelOutline0.m187m(arrayList, zIsActiveScan).build();
    }
    ...
    public static String toRouteFeature(String str) {
        ...
        switch (str) {
            ...
            case "android.media.intent.category.REMOTE_AUDIO_PLAYBACK":
                return "android.media.route.feature.REMOTE_AUDIO_PLAYBACK";
            case "android.media.intent.category.REMOTE_VIDEO_PLAYBACK":
                return "android.media.route.feature.REMOTE_VIDEO_PLAYBACK";
            default:
                return str;
        }
    }
