...
class MediaRoute2Provider extends MediaRouteProvider {
    ...
    private String mPendingTransferRouteId;
    ...
    public void setMediaTransferRestrictedToSelfProviders(boolean z) {
        this.mMediaTransferRestrictedToSelfProviders = z;
        refreshRoutes();
    }
    ...
    public void transferTo(String str) {
        ...
        } else if (TextUtils.equals(this.mPendingTransferRouteId, str)) {
            Log.w("MR2Provider", "Ignoring attempt to transfer to pending transfer route: " + routeById);
        } else {
            this.mPendingTransferRouteId = str;
    ...
    public void refreshRoutes() {
        ...
        while (it.hasNext()) {
            MediaRoute2Info mediaRoute2InfoM186m = MediaRoute2Provider$$ExternalSyntheticApiModelOutline0.m186m(it.next());
            if (mediaRoute2InfoM186m != null && !arraySet.contains(mediaRoute2InfoM186m) && !mediaRoute2InfoM186m.isSystemRoute()) {
                if (this.mMediaTransferRestrictedToSelfProviders) {
                    if (!mediaRoute2InfoM186m.getId().startsWith(getContext().getPackageName() + "/")) {
                    }
                }
                arraySet.add(mediaRoute2InfoM186m);
                arrayList.add(mediaRoute2InfoM186m);
            }
        }
        ...
        while (it2.hasNext()) {
            MediaRoute2Info mediaRoute2InfoM186m2 = MediaRoute2Provider$$ExternalSyntheticApiModelOutline0.m186m(it2.next());
            Bundle extras = mediaRoute2InfoM186m2.getExtras();
            if (extras == null || extras.getString("androidx.mediarouter.media.KEY_ORIGINAL_ROUTE_ID") == null) {
                Log.w("MR2Provider", "Cannot find the original route Id. route=" + mediaRoute2InfoM186m2);
            } else {
                this.mRouteIdToOriginalRouteIdMap.put(mediaRoute2InfoM186m2.getId(), extras.getString("androidx.mediarouter.media.KEY_ORIGINAL_ROUTE_ID"));
            }
        }
        ArrayList arrayList2 = new ArrayList();
        Iterator<MediaRoute2Info> it3 = this.mRoutes.iterator();
        while (it3.hasNext()) {
            MediaRouteDescriptor mediaRouteDescriptor = MediaRouter2Utils.toMediaRouteDescriptor(MediaRoute2Provider$$ExternalSyntheticApiModelOutline0.m186m(it3.next()));
    ...
    public MediaRoute2Info getRouteById(String str) {
        ...
        while (it.hasNext()) {
            MediaRoute2Info mediaRoute2InfoM186m = MediaRoute2Provider$$ExternalSyntheticApiModelOutline0.m186m(it.next());
            if (TextUtils.equals(mediaRoute2InfoM186m.getId(), str)) {
                return mediaRoute2InfoM186m;
            }
        }
        return null;
    }

    public static Messenger getMessengerFromRoutingController(MediaRouter2.RoutingController routingController) {
        Bundle controlHints;
    ...
    public void setDynamicRouteDescriptors(MediaRouter2.RoutingController routingController) {
        ...
        MediaRouteDescriptor mediaRouteDescriptor = MediaRouter2Utils.toMediaRouteDescriptor(MediaRoute2Provider$$ExternalSyntheticApiModelOutline0.m186m(selectedRoutes.get(0)));
    ...
    public void setRouteListingPreference(RouteListingPreference routeListingPreference) {
        Api34Impl.setPlatformRouteListingPreference(this.mMediaRouter2, routeListingPreference != null ? routeListingPreference.toPlatformRouteListingPreference() : null);
    }
    ...
    public class TransferCallback extends MediaRouter2$TransferCallback {
        ...
        public void onTransfer(MediaRouter2.RoutingController routingController, MediaRouter2.RoutingController routingController2) {
            MediaRoute2Provider.this.mPendingTransferRouteId = null;
            ...
            String id = MediaRoute2Provider$$ExternalSyntheticApiModelOutline0.m186m(selectedRoutes.get(0)).getId();
    ...
    public static class Api34Impl {
        public static void setPlatformRouteListingPreference(MediaRouter2 mediaRouter2, android.media.RouteListingPreference routeListingPreference) {
