...
public abstract class DynamicAnimation<T extends DynamicAnimation<T>> implements AnimationHandler.AnimationFrameCallback {
    ...
    public static final ViewProperty f53X = new ViewProperty("x") { // from class: androidx.dynamicanimation.animation.DynamicAnimation.9
        @Override // androidx.dynamicanimation.animation.FloatPropertyCompat
        public void setValue(View view, float f) {
            view.setX(f);
        }
    ...
    public static final ViewProperty f54Y = new ViewProperty("y") { // from class: androidx.dynamicanimation.animation.DynamicAnimation.10
        @Override // androidx.dynamicanimation.animation.FloatPropertyCompat
        public void setValue(View view, float f) {
            view.setY(f);
        }
    ...
    public static final ViewProperty f55Z = new ViewProperty("z") { // from class: androidx.dynamicanimation.animation.DynamicAnimation.11
        @Override // androidx.dynamicanimation.animation.FloatPropertyCompat
        public void setValue(View view, float f) {
    ...
    public T addUpdateListener(OnAnimationUpdateListener onAnimationUpdateListener) {
        if (isRunning()) {
            ByteString$$ExternalSyntheticBUOutline0.m979m("Error: Update listeners must be added beforethe animation.");
            return null;
        }
    ...
    public T setMinimumVisibleChange(float f) {
        if (f <= 0.0f) {
            g$$ExternalSyntheticBUOutline1.m207m("Minimum visible change must be positive.");
            return null;
        }
    ...
    private void startAnimationInternal() {
        ...
        if (f > this.mMaxValue || f < this.mMinValue) {
            g$$ExternalSyntheticBUOutline1.m207m("Starting value need to be in between min value and max value");
        } else {
