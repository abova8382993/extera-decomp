...
public abstract class VersionedParcel {
    ...
    private void writeVersionedParcelableCreator(VersionedParcelable versionedParcelable) {
        try {
            ...
            Make$Map$$ExternalSyntheticBUOutline0.m1024m(versionedParcelable.getClass().getSimpleName().concat(" does not have a Parcelizer"), e);
        }
    }
    ...
    public <T extends VersionedParcelable> T readFromParcel(String str, VersionedParcel versionedParcel) {
        try {
            ...
            Make$Map$$ExternalSyntheticBUOutline0.m1024m("VersionedParcel encountered ClassNotFoundException", e);
            return null;
        } catch (IllegalAccessException e2) {
            Make$Map$$ExternalSyntheticBUOutline0.m1024m("VersionedParcel encountered IllegalAccessException", e2);
            return null;
        } catch (NoSuchMethodException e3) {
            Make$Map$$ExternalSyntheticBUOutline0.m1024m("VersionedParcel encountered NoSuchMethodException", e3);
            return null;
        } catch (InvocationTargetException e4) {
            if (e4.getCause() instanceof RuntimeException) {
                throw ((RuntimeException) e4.getCause());
            }
            Make$Map$$ExternalSyntheticBUOutline0.m1024m("VersionedParcel encountered InvocationTargetException", e4);
            return null;
        }
    }
