...
import io.noties.markwon.RegistryImpl$$ExternalSyntheticBUOutline0;
...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
  ...
  0x0015: PHI (r3v4 boolean) = (r3v2 boolean), (r3v5 boolean) binds: [B:36:0x0024, B:31:0x0012] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public static Behavior parseBehavior(Context context, AttributeSet attributeSet, String str) {
        ...
        try {
            ...
            Make$Map$$ExternalSyntheticBUOutline0.m1024m("Could not inflate Behavior subclass ".concat(str), e);
            return null;
        }
    }
    ...
    */
    ...
    public void onLayoutChild(View view, int i) {
        ...
        if (layoutParams.checkAnchorChanged()) {
            Segment$$ExternalSyntheticBUOutline1.m992m("An anchor may not be changed after CoordinatorLayout measurement begins before layout is complete.");
            return;
        }
        ...
        if (ViewCompat.isLaidOut(view) && view.getWidth() > 0 && view.getHeight() > 0) {
            ...
            if (behavior != null && behavior.getInsetDodgeRect(this, view, rectAcquireTempRect)) {
                if (!rectAcquireTempRect2.contains(rectAcquireTempRect)) {
                    Union$$ExternalSyntheticBUOutline0.m558m("Rect should be within the child's bounds. Rect:", rectAcquireTempRect.toShortString(), " | Bounds:", rectAcquireTempRect2.toShortString());
                    return;
                }
            } else {
    ...
    */
        ...
        private void resolveAnchorView(View view, CoordinatorLayout coordinatorLayout) {
            ...
            if (viewFindViewById == null) {
                if (coordinatorLayout.isInEditMode()) {
                    ...
                    RegistryImpl$$ExternalSyntheticBUOutline0.m563m("Could not find CoordinatorLayout descendant view with id ", coordinatorLayout.getResources().getResourceName(this.mAnchorId), " to anchor view ", view);
                    return;
                }
            }
            if (viewFindViewById == coordinatorLayout) {
                if (coordinatorLayout.isInEditMode()) {
                    ...
                    Segment$$ExternalSyntheticBUOutline1.m992m("View can not be anchored to the the parent CoordinatorLayout");
                    return;
                }
            }
            for (ViewParent parent = viewFindViewById.getParent(); parent != coordinatorLayout && parent != null; parent = parent.getParent()) {
                if (parent == view) {
                    if (coordinatorLayout.isInEditMode()) {
                        ...
                        Segment$$ExternalSyntheticBUOutline1.m992m("Anchor must not be a descendant of the anchored view");
                        return;
                    }
                }
    ...
    public class C03581 implements OnApplyWindowInsetsListener {
        public C03581() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public static class C03591 implements Parcelable.ClassLoaderCreator<SavedState> {
            @Override // android.os.Parcelable.ClassLoaderCreator
            public SavedState createFromParcel(Parcel parcel, ClassLoader classLoader) {
                return new SavedState(parcel, classLoader);
            }
