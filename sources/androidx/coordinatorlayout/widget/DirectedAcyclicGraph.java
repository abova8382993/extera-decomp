...
public final class DirectedAcyclicGraph<T> {
    ...
    public void addEdge(T t, T t2) {
        if (!this.mGraph.containsKey(t) || !this.mGraph.containsKey(t2)) {
            g$$ExternalSyntheticBUOutline1.m207m("All nodes must be present in the graph before being added as an edge");
            return;
        }
    ...
    private void dfs(T t, ArrayList<T> arrayList, HashSet<T> hashSet) {
        ...
        if (hashSet.contains(t)) {
            GlShader$$ExternalSyntheticBUOutline1.m1250m("This graph contains cyclic dependencies");
            return;
        }
        hashSet.add(t);
