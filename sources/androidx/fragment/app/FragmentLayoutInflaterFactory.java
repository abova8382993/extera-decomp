...
class FragmentLayoutInflaterFactory implements LayoutInflater.Factory2 {
    ...
    public View onCreateView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        if (id == -1 && resourceId == -1 && string == null) {
            Library$Handler$$ExternalSyntheticBUOutline0.m548m(attributeSet.getPositionDescription(), ": Must specify unique android:id, android:tag, or have a parent with an id for ", attributeValue);
            return null;
        }
        ...
        if (view2 == null) {
            LiveData$$ExternalSyntheticBUOutline0.m184m("Fragment ", attributeValue, " did not create a view.");
            return null;
        }
        if (resourceId != 0) {
