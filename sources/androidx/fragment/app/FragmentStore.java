...
class FragmentStore {
        ...
        if (list != null) {
            for (String str : list) {
                ...
                if (fragmentFindActiveFragment == null) {
                    LiveData$$ExternalSyntheticBUOutline0.m184m("No instantiated fragment for (", str, ")");
                    return;
                }
    ...
    public void addFragment(Fragment fragment) {
        if (this.mAdded.contains(fragment)) {
            DexMaker$$ExternalSyntheticBUOutline0.m217m("Fragment already added: ", fragment);
            return;
        }
    ...
    public FragmentState setSavedState(String str, FragmentState fragmentState) {
        ...
        if (fragmentState != null) {
            return map.put(str, fragmentState);
        }
