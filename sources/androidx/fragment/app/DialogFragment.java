...
public class DialogFragment extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    public class DialogInterfaceOnCancelListenerC06202 implements DialogInterface.OnCancelListener {
        public DialogInterfaceOnCancelListenerC06202() {
        }
    ...
    public class DialogInterfaceOnDismissListenerC06213 implements DialogInterface.OnDismissListener {
        public DialogInterfaceOnDismissListenerC06213() {
        }
    ...
    public class C06224 implements Observer<LifecycleOwner> {
        public C06224() {
        }
        ...
        public void onChanged(LifecycleOwner lifecycleOwner) {
            ...
            Segment$$ExternalSyntheticBUOutline1.m992m("DialogFragment can not be attached to a container view");
        }
    }
    ...
    public final Dialog requireDialog() {
        ...
        LiveData$$ExternalSyntheticBUOutline0.m184m("DialogFragment ", this, " does not have a Dialog.");
        return null;
    }
    ...
    public class C06235 extends FragmentContainer {
        final /* synthetic */ FragmentContainer val$fragmentContainer;

        public C06235(FragmentContainer fragmentContainer) {
    ...
    public void onStart() {
        ...
        if (dialog != null) {
            ...
            AbstractC7635ViewTreeLifecycleOwner.set(decorView, this);
            AbstractC7636ViewTreeViewModelStoreOwner.set(decorView, this);
            AbstractC7638ViewTreeSavedStateRegistryOwner.set(decorView, this);
        }
    }
