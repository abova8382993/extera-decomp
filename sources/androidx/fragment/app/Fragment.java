...
public abstract class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner {
    ...
    public class RunnableC06241 implements Runnable {
        public RunnableC06241() {
        }
    ...
    public static abstract class OnPreAttachedListener {
        ...
        public /* synthetic */ OnPreAttachedListener(RunnableC06241 runnableC06241) {
            this();
        }
    }
    ...
    /* JADX INFO: loaded from: classes4.dex */
    public class C06262 extends OnPreAttachedListener {
        public C06262() {
        }
    ...
    public LifecycleOwner getViewLifecycleOwner() {
        ...
        Segment$$ExternalSyntheticBUOutline1.m992m("Can't access the Fragment View's LifecycleOwner when getView() is null i.e., before onCreateView() or after onDestroyView()");
        return null;
    }
    ...
    public ViewModelStore getViewModelStore() {
        if (this.mFragmentManager == null) {
            Segment$$ExternalSyntheticBUOutline1.m992m("Can't access ViewModels from detached fragment");
            return null;
        }
        if (getMinimumMaxLifecycleState() == Lifecycle.State.INITIALIZED.ordinal()) {
            Segment$$ExternalSyntheticBUOutline1.m992m("Calling getViewModelStore() before a Fragment reaches onCreate() when using setMaxLifecycle(INITIALIZED) is not supported");
            return null;
        }
    ...
    public static class SavedState implements Parcelable {
        ...
        public class C06341 implements Parcelable.ClassLoaderCreator<SavedState> {
            @Override // android.os.Parcelable.Creator
            public SavedState createFromParcel(Parcel parcel) {
                return new SavedState(parcel, null);
            }
    ...
    public static Fragment instantiate(Context context, String str, Bundle bundle) {
        try {
            ...
            Fragment$$ExternalSyntheticBUOutline1.m181m(str, ": make sure class name exists, is public, and has an empty constructor that is public", e);
            return null;
        } catch (java.lang.InstantiationException e2) {
            Fragment$$ExternalSyntheticBUOutline1.m181m(str, ": make sure class name exists, is public, and has an empty constructor that is public", e2);
            return null;
        } catch (NoSuchMethodException e3) {
            Fragment$$ExternalSyntheticBUOutline1.m181m(str, ": could not find Fragment constructor", e3);
            return null;
        } catch (InvocationTargetException e4) {
            Fragment$$ExternalSyntheticBUOutline1.m181m(str, ": calling Fragment constructor caused an exception", e4);
            return null;
        }
    }
    ...
    public final void restoreViewState(Bundle bundle) {
        ...
        if (!this.mCalled) {
            Fragment$$ExternalSyntheticBUOutline0.m180m(this, " did not call through to super.onViewStateRestored()");
    ...
    public void setArguments(Bundle bundle) {
        if (this.mFragmentManager != null && isStateSaved()) {
            Segment$$ExternalSyntheticBUOutline1.m992m("Fragment already added and state has been saved");
        } else {
    ...
    public final Bundle requireArguments() {
        ...
        LiveData$$ExternalSyntheticBUOutline0.m184m("Fragment ", this, " does not have any arguments.");
        return null;
    }
    ...
    public void setInitialSavedState(SavedState savedState) {
        Bundle bundle;
        if (this.mFragmentManager != null) {
            Segment$$ExternalSyntheticBUOutline1.m992m("Fragment already added");
            return;
        }
    ...
    public void setTargetFragment(Fragment fragment, int i) {
        ...
        if (fragmentManager != null && fragmentManager2 != null && fragmentManager != fragmentManager2) {
            Native$$ExternalSyntheticBUOutline0.m549m("Fragment ", fragment, " must share the same FragmentManager to be set as a target fragment");
            return;
        }
        for (Fragment targetFragment = fragment; targetFragment != null; targetFragment = targetFragment.getTargetFragment(false)) {
            if (targetFragment.equals(this)) {
                Native$$ExternalSyntheticBUOutline3.m552m("Setting ", fragment, " as the target of ", this, " would create a target cycle");
                return;
            }
        }
        if (fragment == null) {
    ...
    public final Context requireContext() {
        ...
        LiveData$$ExternalSyntheticBUOutline0.m184m("Fragment ", this, " not attached to a context.");
        return null;
    }
    ...
    public final FragmentActivity requireActivity() {
        ...
        LiveData$$ExternalSyntheticBUOutline0.m184m("Fragment ", this, " not attached to an activity.");
        return null;
    }
    ...
    public final Object requireHost() {
        ...
        LiveData$$ExternalSyntheticBUOutline0.m184m("Fragment ", this, " not attached to a host.");
        return null;
    }
    ...
    public final FragmentManager getParentFragmentManager() {
        ...
        LiveData$$ExternalSyntheticBUOutline0.m184m("Fragment ", this, " not associated with a fragment manager.");
        return null;
    }
    ...
    public final FragmentManager getChildFragmentManager() {
        if (this.mHost == null) {
            LiveData$$ExternalSyntheticBUOutline0.m184m("Fragment ", this, " has not been attached yet.");
            return null;
        }
    ...
    public final Fragment requireParentFragment() {
        ...
        if (getContext() == null) {
            LiveData$$ExternalSyntheticBUOutline0.m184m("Fragment ", this, " is not attached to any Fragment or host");
            return null;
        }
        StringBuilder sb = new StringBuilder("Fragment ");
        sb.append(this);
        OkHttpClient$Builder$$ExternalSyntheticBUOutline0.m962m(sb, " is not a child Fragment, it is directly attached to ", getContext());
        return null;
    }
    ...
    public void startActivity(@SuppressLint({"UnknownNullness"}) Intent intent, Bundle bundle) {
        FragmentHostCallback<?> fragmentHostCallback = this.mHost;
        if (fragmentHostCallback == null) {
            LiveData$$ExternalSyntheticBUOutline0.m184m("Fragment ", this, " not attached to Activity");
        } else {
    ...
    public LayoutInflater getLayoutInflater(Bundle bundle) {
        FragmentHostCallback<?> fragmentHostCallback = this.mHost;
        if (fragmentHostCallback == null) {
            Segment$$ExternalSyntheticBUOutline1.m992m("onGetLayoutInflater() cannot be executed until the Fragment is attached to the FragmentManager.");
            return null;
        }
    ...
    public final View requireView() {
        ...
        LiveData$$ExternalSyntheticBUOutline0.m184m("Fragment ", this, " did not return a View from onCreateView() or this was called before onCreateView().");
        return null;
    }
    ...
    /* JADX INFO: loaded from: classes4.dex */
    public class RunnableC06273 implements Runnable {
        public RunnableC06273() {
        }
    ...
    public void callStartTransitionListener(boolean z) {
        ...
        if (z) {
            this.mHost.getHandler().post(new Runnable() { // from class: androidx.fragment.app.Fragment.4
                ...
                public RunnableC06284(SpecialEffectsController orCreateController2) {
    ...
    /* JADX INFO: loaded from: classes4.dex */
    public class RunnableC06284 implements Runnable {
        final /* synthetic */ SpecialEffectsController val$controller;
    ...
    /* JADX INFO: loaded from: classes4.dex */
    public class C06295 extends FragmentContainer {
        public C06295() {
        }
        ...
        public View onFindViewById(int i) {
            ...
            if (view == null) {
                NotNullVar$$ExternalSyntheticBUOutline0.m935m("Fragment ", Fragment.this, " does not have a view");
                return null;
            }
    ...
    public void performAttach() {
        ...
        if (!this.mCalled) {
            Fragment$$ExternalSyntheticBUOutline0.m180m(this, " did not call through to super.onAttach()");
        } else {
    ...
    public void performCreate(Bundle bundle) {
        ...
        if (!this.mCalled) {
            Fragment$$ExternalSyntheticBUOutline0.m180m(this, " did not call through to super.onCreate()");
        } else {
    ...
    /* JADX INFO: loaded from: classes4.dex */
    public class C06306 implements LifecycleEventObserver {
        public C06306() {
        }
    ...
    public void performCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (viewOnCreateView != null) {
            ...
            AbstractC7635ViewTreeLifecycleOwner.set(this.mView, this.mViewLifecycleOwner);
            AbstractC7636ViewTreeViewModelStoreOwner.set(this.mView, this.mViewLifecycleOwner);
            AbstractC7638ViewTreeSavedStateRegistryOwner.set(this.mView, this.mViewLifecycleOwner);
            this.mViewLifecycleOwnerLiveData.setValue(this.mViewLifecycleOwner);
            return;
        }
        if (fragmentViewLifecycleOwner.isInitialized()) {
            Segment$$ExternalSyntheticBUOutline1.m992m("Called getViewLifecycleOwner() but onCreateView() returned null");
        } else {
    ...
    public void performActivityCreated(Bundle bundle) {
        ...
        if (!this.mCalled) {
            Fragment$$ExternalSyntheticBUOutline0.m180m(this, " did not call through to super.onActivityCreated()");
        } else {
            restoreViewState();
    ...
    public void performStart() {
        ...
        onStart();
        if (!this.mCalled) {
            Fragment$$ExternalSyntheticBUOutline0.m180m(this, " did not call through to super.onStart()");
            return;
        }
    ...
    public void performResume() {
        ...
        onResume();
        if (!this.mCalled) {
            Fragment$$ExternalSyntheticBUOutline0.m180m(this, " did not call through to super.onResume()");
            return;
        }
        LifecycleRegistry lifecycleRegistry = this.mLifecycleRegistry;
    ...
    public void performSaveInstanceState(Bundle bundle) {
        ...
        Bundle bundleSaveAllStateInternal = this.mChildFragmentManager.saveAllStateInternal();
    ...
    public void performPause() {
        ...
        Fragment$$ExternalSyntheticBUOutline0.m180m(this, " did not call through to super.onPause()");
    }
    ...
    public void performStop() {
        ...
        Fragment$$ExternalSyntheticBUOutline0.m180m(this, " did not call through to super.onStop()");
    }
    ...
    public void performDestroyView() {
        ...
        onDestroyView();
        if (!this.mCalled) {
            Fragment$$ExternalSyntheticBUOutline0.m180m(this, " did not call through to super.onDestroyView()");
        } else {
    ...
    public void performDestroy() {
        ...
        Fragment$$ExternalSyntheticBUOutline0.m180m(this, " did not call through to super.onDestroy()");
    }
    ...
    public void performDetach() {
        ...
        if (!this.mCalled) {
            Fragment$$ExternalSyntheticBUOutline0.m180m(this, " did not call through to super.onDetach()");
        } else {
    ...
    /* JADX INFO: loaded from: classes4.dex */
    public class C06317 implements Function<Void, ActivityResultRegistry> {
        public C06317() {
        }
    ...
    /* JADX INFO: loaded from: classes4.dex */
    public class C06328 implements Function<Void, ActivityResultRegistry> {
        final /* synthetic */ ActivityResultRegistry val$registry;

        public C06328(ActivityResultRegistry activityResultRegistry) {
    ...
    public final <I, O> ActivityResultLauncher<I> registerForActivityResult(ActivityResultContract<I, O> activityResultContract, ActivityResultRegistry activityResultRegistry, ActivityResultCallback<O> activityResultCallback) {
        return prepareCallInternal(activityResultContract, new Function<Void, ActivityResultRegistry>() { // from class: androidx.fragment.app.Fragment.8
            ...
            public C06328(ActivityResultRegistry activityResultRegistry2) {
    ...
    private <I, O> ActivityResultLauncher<I> prepareCallInternal(ActivityResultContract<I, O> activityResultContract, Function<Void, ActivityResultRegistry> function, ActivityResultCallback<O> activityResultCallback) {
        if (this.mState > 1) {
            LiveData$$ExternalSyntheticBUOutline0.m184m("Fragment ", this, " is attempting to registerForActivityResult after being created. Fragments must call registerForActivityResult() before they are created (i.e. initialization, onAttach(), or onCreate()).");
            return null;
        }
        ...
        registerOnPreAttachListener(new OnPreAttachedListener() { // from class: androidx.fragment.app.Fragment.9
            ...
            public C06339(Function function2, AtomicReference atomicReference2, ActivityResultContract activityResultContract2, ActivityResultCallback activityResultCallback2) {
                super();
                function = function2;
        ...
        return new ActivityResultLauncher<I>() { // from class: androidx.fragment.app.Fragment.10
            ...
            public C062510(AtomicReference atomicReference2, ActivityResultContract activityResultContract2) {
                atomicReference = atomicReference2;
                activityResultContract = activityResultContract2;
            }
            ...
            public void launch(I i, ActivityOptionsCompat activityOptionsCompat) {
                ...
                if (activityResultLauncher == null) {
                    Segment$$ExternalSyntheticBUOutline1.m992m("Operation cannot be started before fragment is in created state");
                } else {
    ...
    /* JADX INFO: loaded from: classes4.dex */
    public class C06339 extends OnPreAttachedListener {
        final /* synthetic */ ActivityResultCallback val$callback;
        final /* synthetic */ ActivityResultContract val$contract;
        final /* synthetic */ AtomicReference val$ref;
        final /* synthetic */ Function val$registryProvider;
    ...
    /* JADX INFO: loaded from: classes4.dex */
    public class C062510<I> extends ActivityResultLauncher<I> {
        final /* synthetic */ ActivityResultContract val$contract;
        final /* synthetic */ AtomicReference val$ref;
