...
class FragmentStateManager {
    ...
    int computeExpectedState() {
        ...
        int i = C06322.$SwitchMap$androidx$lifecycle$Lifecycle$State[fragment.mMaxState.ordinal()];
        if (i != 1) {
            if (i == 2) {
        ...
        if (view != null) {
            ...
            if (ViewCompat.isAttachedToWindow(this.mFragment.mView)) {
                ...
                view2.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: androidx.fragment.app.FragmentStateManager.1
                    ...
                    ViewOnAttachStateChangeListenerC06311(View view22) {
                        view = view22;
                    }
    ...
    class ViewOnAttachStateChangeListenerC06311 implements View.OnAttachStateChangeListener {
        final /* synthetic */ View val$fragmentView;
