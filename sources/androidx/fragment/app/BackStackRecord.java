...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.OpGenerator {
    ...
    public void dump(String str, PrintWriter printWriter, boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            FragmentTransaction.C0651Op c0651Op = this.mOps.get(i);
            switch (c0651Op.mCmd) {
                case 0:
                    str2 = "NULL";
                    break;
            ...
            printWriter.print(" ");
            printWriter.println(c0651Op.mFragment);
            if (z) {
                if (c0651Op.mEnterAnim != 0 || c0651Op.mExitAnim != 0) {
                    printWriter.print(str);
                    printWriter.print("enterAnim=#");
                    printWriter.print(Integer.toHexString(c0651Op.mEnterAnim));
                    printWriter.print(" exitAnim=#");
                    printWriter.println(Integer.toHexString(c0651Op.mExitAnim));
                }
                if (c0651Op.mPopEnterAnim != 0 || c0651Op.mPopExitAnim != 0) {
                    printWriter.print(str);
                    printWriter.print("popEnterAnim=#");
                    printWriter.print(Integer.toHexString(c0651Op.mPopEnterAnim));
                    printWriter.print(" popExitAnim=#");
                    printWriter.println(Integer.toHexString(c0651Op.mPopExitAnim));
                }
            }
        }
    }
    ...
    public void bumpBackStackNesting(int i) {
        if (this.mAddToBackStack) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                FragmentTransaction.C0651Op c0651Op = this.mOps.get(i2);
                Fragment fragment = c0651Op.mFragment;
                if (fragment != null) {
                    fragment.mBackStackNesting += i;
                    if (FragmentManager.isLoggingEnabled(2)) {
                        Log.v("FragmentManager", "Bump nesting of " + c0651Op.mFragment + " to " + c0651Op.mFragment.mBackStackNesting);
                    }
                }
            }
        }
    ...
    public int commitInternal(boolean z) {
        if (this.mCommitted) {
            Segment$$ExternalSyntheticBUOutline1.m992m("commit already called");
            return 0;
        }
        if (FragmentManager.isLoggingEnabled(2)) {
    ...
    public void executeOps() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            switch (c0651Op.mCmd) {
                case 1:
                    fragment.setAnimations(c0651Op.mEnterAnim, c0651Op.mExitAnim, c0651Op.mPopEnterAnim, c0651Op.mPopExitAnim);
                    this.mManager.setExitAnimationOrder(fragment, false);
                    this.mManager.addFragment(fragment);
                    break;
                case 2:
                default:
                    IntegerType$$ExternalSyntheticBUOutline0.m547m("Unknown cmd: ", c0651Op.mCmd);
                    return;
                case 3:
                    fragment.setAnimations(c0651Op.mEnterAnim, c0651Op.mExitAnim, c0651Op.mPopEnterAnim, c0651Op.mPopExitAnim);
                ...
                case 9:
                    ...
                    break;
                case 10:
                    this.mManager.setMaxLifecycle(fragment, c0651Op.mCurrentMaxState);
                    break;
            }
        }
    }
    ...
    public void executePopOps() {
        for (int size = this.mOps.size() - 1; size >= 0; size--) {
            FragmentTransaction.C0651Op c0651Op = this.mOps.get(size);
            Fragment fragment = c0651Op.mFragment;
            if (fragment != null) {
                fragment.mBeingSaved = this.mBeingSaved;
            ...
            switch (c0651Op.mCmd) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    this.mManager.setMaxLifecycle(fragment, c0651Op.mOldMaxState);
                    break;
            }
        }
    }
    ...
    */
    public androidx.fragment.app.Fragment expandOps(java.util.ArrayList<androidx.fragment.app.Fragment> r17, androidx.fragment.app.Fragment r18) {
        ...
        L7:
            ...
            androidx.fragment.app.FragmentTransaction$Op r5 = (androidx.fragment.app.FragmentTransaction.C0651Op) r5
            int r6 = r5.mCmd
            r7 = 1
            if (r6 == r7) goto Lb6
            r8 = 2
    ...
    */
    public androidx.fragment.app.Fragment trackAddedFragmentsInPop(java.util.ArrayList<androidx.fragment.app.Fragment> r6, androidx.fragment.app.Fragment r7) {
        ...
        L8:
            ...
            androidx.fragment.app.FragmentTransaction$Op r2 = (androidx.fragment.app.FragmentTransaction.C0651Op) r2
            int r3 = r2.mCmd
            if (r3 == r1) goto L2d
            r4 = 3
            if (r3 == r4) goto L27
