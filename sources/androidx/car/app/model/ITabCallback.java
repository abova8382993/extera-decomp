...
public interface ITabCallback extends IInterface {
    public static final String DESCRIPTOR = "androidx$car$app$model$ITabCallback".replace(Typography.dollar, '.');
    ...
    public static abstract class Stub extends Binder implements ITabCallback {
        ...
        public static ITabCallback asInterface(IBinder iBinder) {
            ...
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof ITabCallback)) {
                return (ITabCallback) iInterfaceQueryLocalInterface;
            }
