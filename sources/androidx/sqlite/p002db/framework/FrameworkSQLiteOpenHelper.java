...
import androidx.sqlite.p002db.SupportSQLiteCompat$Api21Impl;
import androidx.sqlite.p002db.SupportSQLiteDatabase;
import androidx.sqlite.p002db.SupportSQLiteOpenHelper;
import androidx.sqlite.p002db.framework.FrameworkSQLiteOpenHelper;
...
public final class FrameworkSQLiteOpenHelper implements SupportSQLiteOpenHelper {
    ...
    static final class DBRefHolder {
        ...
        private FrameworkSQLiteDatabase f70db;

        public DBRefHolder(FrameworkSQLiteDatabase frameworkSQLiteDatabase) {
            this.f70db = frameworkSQLiteDatabase;
        }
