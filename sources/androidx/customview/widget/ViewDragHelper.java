...
public class ViewDragHelper {
    ...
    public void captureChildView(View view, int i) {
        if (view.getParent() != this.mParentView) {
            Native$$ExternalSyntheticBUOutline2.m551m("captureChildView: parameter must be a descendant of the ViewDragHelper's tracked parent view (", this.mParentView, ")");
            return;
        }
    ...
    public boolean smoothSlideViewTo(View view, int i, int i2, int i3, Interpolator interpolator) {
        this.mCapturedView = view;
        this.mActivePointerId = -1;
        boolean zForceSettleCapturedViewAt = forceSettleCapturedViewAt(i, i2, i3, interpolator);
        if (!zForceSettleCapturedViewAt && this.mDragState == 0 && this.mCapturedView != null) {
            this.mCapturedView = null;
        }
        return zForceSettleCapturedViewAt;
    ...
    public boolean settleCapturedViewAt(int i, int i2) {
        if (!this.mReleaseInProgress) {
            Segment$$ExternalSyntheticBUOutline1.m992m("Cannot settleCapturedViewAt outside of a call to Callback#onViewReleased");
            return false;
        }
    ...
    private boolean forceSettleCapturedViewAt(int i, int i2, int i3, int i4) {
        ...
        int iComputeSettleDuration = computeSettleDuration(this.mCapturedView, i5, i6, i3, i4);
        this.mInterpolator = sInterpolator;
        this.mScroller.startScroll(left, top, i5, i6, iComputeSettleDuration);
        setDragState(2);
        return true;
    }
    ...
    */
    ...
    private void releaseViewForPointerUp() {
        this.mVelocityTracker.computeCurrentVelocity(MediaDataController.MAX_STYLE_RUNS_COUNT, this.mMaxVelocity);
