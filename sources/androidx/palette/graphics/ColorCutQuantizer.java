...
final class ColorCutQuantizer {
    ...
    public class Vbox {
        ...
        public final Vbox splitBox() {
            if (!canSplit()) {
                Segment$$ExternalSyntheticBUOutline1.m992m("Can not split a box with only 1 color");
                return null;
            }
    ...
    /* JADX INFO: renamed from: androidx.palette.graphics.ColorCutQuantizer$1 */
    public static class C07101 implements Comparator<Vbox> {
        @Override // java.util.Comparator
        public int compare(Vbox vbox, Vbox vbox2) {
            return vbox2.getVolume() - vbox.getVolume();
        }
