...
public interface Map<K, V> {
    ...
    public final /* synthetic */ class EL {
        public static /* synthetic */ Object compute(java.util.Map map, Object obj, BiFunction biFunction) {
            return map instanceof Map ? ((Map) map).compute(obj, biFunction) : map instanceof ConcurrentMap ? j$.com.android.tools.r8.a.h((ConcurrentMap) map, obj, biFunction) : CC.$default$compute(map, obj, biFunction);
        }
        ...
        public static /* synthetic */ void forEach(java.util.Map map, BiConsumer biConsumer) {
            if (map instanceof Map) {
                ...
                j$.com.android.tools.r8.a.i((ConcurrentMap) map, biConsumer);
            } else {
