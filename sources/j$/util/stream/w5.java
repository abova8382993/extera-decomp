...
public final class w5 extends z {
    ...
    public w5(b0 b0Var, int i, long j, long j2) {
        super(b0Var, i);
        this.s = j;
        this.t = j2;
    }
    ...
    public final Spliterator B0(b bVar, Spliterator spliterator) {
        ...
        if (jE0 > 0 && spliterator.hasCharacteristics(16384)) {
            j$.util.t0 t0Var = (j$.util.t0) bVar.u0(spliterator);
            long j = this.s;
            return new s7(t0Var, j, z5.c(j, this.t));
        }
        if (c7.ORDERED.k(bVar.m)) {
            return ((h2) new y5(this, bVar, spliterator, new c1(13), this.s, this.t).invoke()).spliterator();
        }
        j$.util.t0 t0Var2 = (j$.util.t0) bVar.u0(spliterator);
        long j2 = this.s;
        long j3 = this.t;
        if (j2 <= jE0) {
            long jMin = jE0 - j2;
    ...
    public final h2 A0(x3 x3Var, Spliterator spliterator, IntFunction intFunction) {
        ...
        if (jE0 > 0 && spliterator.hasCharacteristics(16384)) {
            ...
            return x3.V(x3Var, z5.b(bVar.z0(), spliterator, this.s, this.t), true);
        }
        if (!c7.ORDERED.k(((b) x3Var).m)) {
            j$.util.t0 t0Var = (j$.util.t0) x3Var.u0(spliterator);
            long j2 = this.s;
            long j3 = this.t;
            if (j2 <= jE0) {
                long j4 = jE0 - j2;
            ...
            return x3.V(this, new y7(t0Var, j, jMin), true);
        }
