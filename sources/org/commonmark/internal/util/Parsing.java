...
public abstract class Parsing {
    ...
    public static int find(char c2, CharSequence charSequence, int i) {
    ...
    public static int skip(char c2, CharSequence charSequence, int i, int i2) {
        while (i < i2) {
            if (charSequence.charAt(i) != c2) {
                return i;
            }
    ...
    public static int skipBackwards(char c2, CharSequence charSequence, int i, int i2) {
        while (i >= i2) {
            if (charSequence.charAt(i) != c2) {
                return i;
            }
