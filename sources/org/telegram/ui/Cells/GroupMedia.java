...
public class GroupMedia {
    ...
    /* JADX WARN: Removed duplicated region for block: B:150:0x003a  */
    /*
    ...
    */
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.buttonText != null && f > 0.0f) {
            ...
            int i3 = this.y;
            int i4 = this.height;
            rectF.set(i + ((i2 - fDp) / 2.0f), i3 + ((i4 - fDp2) / 2.0f), i + ((i2 + fDp) / 2.0f), i3 + ((i4 + fDp2) / 2.0f));
        ...
        int i6 = this.width;
        int i7 = this.y;
        rectF2.set(((i5 + i6) - fDp3) - fDp5, i7 + fDp5, (i5 + i6) - fDp5, i7 + fDp5 + fDp4);
        this.clipPath.rewind();
        float f3 = fDp4 / 2.0f;
        ...
        this.priceText.draw(canvas, (((this.x + this.width) - fDp3) - fDp5) + AndroidUtilities.dp(5.66f), this.y + fDp5 + f3, -1, timeAlpha);
        canvas.restore();
    }
    ...
    public void drawImages(Canvas canvas, boolean z) {
        ...
        while (i < this.holders.size()) {
            ...
            if (f > 0.0f) {
                fMin = Math.min(this.x + mediaHolder.l, fMin);
                fMin2 = Math.min(this.y + mediaHolder.t, fMin2);
                fMax = Math.max(this.x + mediaHolder.r, fMax);
                fMax2 = Math.max(this.y + mediaHolder.b, fMax2);
        ...
        while (i9 < this.holders.size()) {
            ...
            if (mediaHolder2.durationText != null) {
                ...
                rectF2.set(i10 + i11 + fDp3, i12 + i13 + fDp3, i10 + i11 + fDp3 + fDp, i12 + i13 + fDp3 + fDp2);
                if (this.priceText == null || this.clipRect.right <= ((this.x + this.width) - (AndroidUtilities.dp(11.32f) + this.priceText.getCurrentWidth())) - fDp3 || this.clipRect.top > this.y + fDp3) {
                    ...
                    mediaHolder2.durationText.draw(canvas2, this.x + mediaHolder2.l + fDp3 + AndroidUtilities.dp(5.66f), f4 + this.y + mediaHolder2.t + fDp3, -1, 1.0f);
                    canvas.restore();
                }
            }
            i9++;
    ...
    public static class GroupedMessages {
        ...
        /* JADX WARN: Removed duplicated region for block: B:336:0x00a2  */
        /* JADX WARN: Removed duplicated region for block: B:378:0x020c  */
