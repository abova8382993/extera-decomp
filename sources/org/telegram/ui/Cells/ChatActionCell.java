...
public class ChatActionCell extends BaseCell implements DownloadController.FileDownloadProgressListener, NotificationCenter.NotificationCenterDelegate {
    ...
    */
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.starGiftLayout.has()) {
            ...
            if (suggestBirthdayActionLayout != null) {
                ...
                if (isNewStyleButtonLayout()) {
                    ...
                    f2 = 12.0f;
                    f3 = 10.0f;
                    fDp = this.textY + this.textHeight + (this.giftRectSize * 0.075f) + imageSize + AndroidUtilities.dp(4.0f) + (this.giftPremiumText == null ? 0 : r11.layout.getHeight() + AndroidUtilities.dp(4.0f));
                }
                this.giftPremiumAdditionalHeight = 0;
                if (this.giftPremiumTitleLayout != null) {
                    float height = fDp + r11.getHeight();
                    ...
                    if (this.giftPremiumSubtitleLayout != null) {
                        fDp2 += r7.getHeight() + AndroidUtilities.dp(9.0f);
                    }
                    if (this.giftPremiumReleasedText != null) {
                        fDp2 += AndroidUtilities.dp(f5);
                    }
                } else {
                    f4 = 16.0f;
                    f5 = 24.0f;
                    fDp2 = fDp - AndroidUtilities.dp(f2);
                ...
                if (this.giftPremiumText == null) {
                    ...
                    this.giftPremiumAdditionalHeight += height2 + AndroidUtilities.dp(f3);
                } else {
                    MessageObject messageObject2 = this.currentMessageObject;
                    if (messageObject2.type == 18 || messageObject2.isStarGiftAction()) {
                        this.giftPremiumAdditionalHeight += height2 - AndroidUtilities.dp(this.giftPremiumButtonLayout == null ? 0.0f : f3);
                ...
                if (this.giftPremiumReleasedText != null) {
                    this.giftPremiumAdditionalHeight += AndroidUtilities.dp(f5);
                }
                ...
                if (staticLayout != null) {
                    float height3 = fDp2 + ((((iDp6 - fDp2) - (staticLayout != null ? staticLayout.getHeight() : 0)) - AndroidUtilities.dp(8.0f)) / 2.0f);
                    ...
                    this.giftButtonRect.set(f6 - AndroidUtilities.dp(18.0f), height3 - AndroidUtilities.dp(8.0f), f6 + this.giftPremiumButtonWidth + AndroidUtilities.dp(18.0f), height3 + (this.giftPremiumButtonLayout != null ? r15.getHeight() : 0) + AndroidUtilities.dp(8.0f));
                } else {
                ...
                if (isNewStyleButtonLayout()) {
                    ...
                    int iDp8 = AndroidUtilities.dp(f4);
                    if (imageSize > 0) {
                        iDp8 = (iDp8 * 2) + imageSize;
                    }
                    this.backgroundRectHeight = iDp8;
                    StaticLayout staticLayout2 = this.giftPremiumSubtitleLayout;
                    if (staticLayout2 != null) {
                        this.backgroundRectHeight = iDp8 + staticLayout2.getHeight() + AndroidUtilities.dp(f3);
                    }
                    if (this.giftPremiumReleasedText != null) {
                        this.backgroundRectHeight += AndroidUtilities.dp(f5);
                    }
                    StaticLayout staticLayout3 = this.giftPremiumTitleLayout;
                    if (staticLayout3 != null) {
                        this.backgroundRectHeight += staticLayout3.getHeight() + AndroidUtilities.dp(4.0f);
                    }
                    ...
                    if (this.giftPremiumButtonLayout != null) {
                        this.backgroundButtonTop = height4 + iDp7 + AndroidUtilities.dp(32.0f);
                        this.giftButtonRect.set(f7 - AndroidUtilities.dp(18.0f), this.backgroundButtonTop, f7 + this.giftPremiumButtonWidth + AndroidUtilities.dp(18.0f), this.backgroundButtonTop + this.giftPremiumButtonLayout.getHeight() + (AndroidUtilities.dp(8.0f) * 2));
                        this.backgroundRectHeight = (int) (this.backgroundRectHeight + AndroidUtilities.dp(32.0f) + this.giftButtonRect.height());
                    } else if (!isMessageActionSuggestedPostApproval() && (messageObject == null || ((i3 = messageObject.type) != 34 && i3 != 33))) {
                        this.giftButtonRect.set(f7 - AndroidUtilities.dp(18.0f), this.backgroundButtonTop, f7 + this.giftPremiumButtonWidth + AndroidUtilities.dp(18.0f), this.backgroundButtonTop + AndroidUtilities.dp(17.0f) + (AndroidUtilities.dp(8.0f) * 2));
                        this.backgroundRectHeight += AndroidUtilities.dp(17.0f);
                    }
                    int iDp9 = this.backgroundRectHeight + AndroidUtilities.dp(f4);
        ...
        if (isMessageActionSuggestedPostApproval()) {
            iDp += this.titleHeight + AndroidUtilities.dp(f5);
        }
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:168:0x0583 A[LOOP:1: B:166:0x057d->B:168:0x0583, LOOP_END] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:234:0x0762  */
    /* JADX WARN: Removed duplicated region for block: B:237:0x0772  */
    /* JADX WARN: Removed duplicated region for block: B:279:0x0a70  */
    ...
    /* JADX WARN: Removed duplicated region for block: B:309:0x0c29  */
    /* JADX WARN: Removed duplicated region for block: B:310:0x0c3d  */
    /* JADX WARN: Removed duplicated region for block: B:313:0x0c6f  */
    /* JADX WARN: Removed duplicated region for block: B:349:0x0d6d  */
    /* JADX WARN: Removed duplicated region for block: B:353:0x0d7b  */
    /* JADX WARN: Removed duplicated region for block: B:359:0x0d98  */
    /* JADX WARN: Removed duplicated region for block: B:370:0x0e33  */
    /* JADX WARN: Removed duplicated region for block: B:374:0x0e90  */
    /* JADX WARN: Removed duplicated region for block: B:387:0x0ef4  */
    /* JADX WARN: Removed duplicated region for block: B:388:0x0f0a  */
    /* JADX WARN: Removed duplicated region for block: B:391:0x0f31  */
    /* JADX WARN: Removed duplicated region for block: B:392:0x0f36  */
    /* JADX WARN: Removed duplicated region for block: B:397:0x0f42  */
    /* JADX WARN: Removed duplicated region for block: B:403:0x0f60  */
    /* JADX WARN: Removed duplicated region for block: B:404:0x0f64  */
    /* JADX WARN: Removed duplicated region for block: B:407:0x0f6c  */
    /* JADX WARN: Removed duplicated region for block: B:408:0x0f70  */
    /* JADX WARN: Removed duplicated region for block: B:412:0x0f9a  */
    ...
    */
    ...
    private void drawBotButtons(Canvas canvas, ArrayList arrayList) {
        ...
        while (i < arrayList.size()) {
            ...
            float f4 = fDp3 + fDp2;
            this.rect.set(fDp3, fDp, f4, botButton.height + fDp);
            canvas.save();
            if (pressScale != 1.0f) {
                f = f2;
            ...
            if (drawable != null) {
                int i2 = (int) fDp;
                drawable.setBounds((int) fDp3, i2, (int) f4, botButton.height + i2);
            ...
            float width2 = fDp3 + (((fDp2 - (botButton.title.getWidth() + (botButton.iconDrawable != null ? AndroidUtilities.dp(f) : 0))) - fDp6) / f5);
            Drawable drawable2 = botButton.iconDrawable;
            if (drawable2 != null) {
                int i3 = (int) width2;
                drawable2.setBounds(i3, (int) (((botButton.height - AndroidUtilities.dp(24.0f)) / f5) + fDp), i3 + AndroidUtilities.dp(24.0f), ((int) (((botButton.height - AndroidUtilities.dp(24.0f)) / f5) + fDp)) + AndroidUtilities.dp(24.0f));
                botButton.iconDrawable.setAlpha(botButton.isLocked ? 128 : Function.USE_VARARGS);
                botButton.iconDrawable.draw(canvas);
                width2 += fDp6;
            }
            botButton.title.ellipsize(Math.max(1, (((int) fDp2) - AndroidUtilities.dp(15.0f)) - r4));
            botButton.title.draw(canvas, width2, (AndroidUtilities.dp(40.0f) / f5) + fDp, botButton.isLocked ? 0.5f : 1.0f);
            canvas.restore();
            canvas.restore();
            i++;
            f2 = f;
