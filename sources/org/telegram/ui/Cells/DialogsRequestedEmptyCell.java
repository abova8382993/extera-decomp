...
public abstract class DialogsRequestedEmptyCell extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public DialogsRequestedEmptyCell(Context context) {
        ...
        AnonymousClass1 anonymousClass1 = new LinearLayout(context) { // from class: org.telegram.ui.Cells.DialogsRequestedEmptyCell.1
            Paint paint;
            Path path = new Path();
        ...
        anonymousClass1.setPadding(AndroidUtilities.dp(32.0f), AndroidUtilities.dp(16.0f), AndroidUtilities.dp(32.0f), AndroidUtilities.dp(32.0f));
        ...
        updateSticker();
        anonymousClass1.addView(this.stickerView, LayoutHelper.createLinear(Opcodes.IXOR, Opcodes.IXOR, 49));
        ...
        anonymousClass1.addView(this.titleView, LayoutHelper.createLinear(-1, -2, 49, 0, 6, 0, 0));
        ...
        anonymousClass1.addView(this.subtitleView, LayoutHelper.createLinear(-1, -2, 49, 0, 7, 0, 0));
        ...
        anonymousClass1.addView(this.buttonView, LayoutHelper.createLinear(-1, -2, 49, 0, 18, 0, 0));
        addView(anonymousClass1, LayoutHelper.createLinear(-1, -2));
        set(null);
    }
