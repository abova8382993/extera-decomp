...
public class RequestPeerRequirementsCell extends LinearLayout {
    ...
    class AnonymousClass1 extends View {
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(i), TLObject.FLAG_30));
        }
    }

    private View emptyView(int i, Drawable drawable) {
        AnonymousClass1 anonymousClass1 = new View(getContext()) { // from class: org.telegram.ui.Cells.RequestPeerRequirementsCell.1
            final /* synthetic */ int val$heightDp;
        ...
        anonymousClass1.setBackground(drawable);
