...
public abstract class WallpaperCell extends FrameLayout {
    ...
    public class WallpaperView extends FrameLayout {
        ...
        public void setWallpaper(Object obj, Object obj2, Drawable drawable, boolean z) {
            ...
            if (obj instanceof TLRPC.TL_wallPaper) {
                ...
                TLRPC.PhotoSize closestPhotoSizeWithSize2 = FileLoader.getClosestPhotoSizeWithSize(tL_wallPaper.document.thumbs, AndroidUtilities.dp(Opcodes.GETFIELD));
                ...
                if (colorWallpaper.path != null || colorWallpaper.pattern != null || "d".equals(colorWallpaper.slug)) {
                    ...
                    if ("d".equals(colorWallpaper.slug)) {
                        if (colorWallpaper.defaultCache == null) {
                            colorWallpaper.defaultCache = SvgHelper.getBitmap(R.raw.default_pattern, 100, Opcodes.GETFIELD, -16777216);
                        }
            ...
            if (obj instanceof MediaController.SearchImage) {
                ...
                if (photo != null) {
                    ...
                    TLRPC.PhotoSize closestPhotoSizeWithSize5 = FileLoader.getClosestPhotoSizeWithSize(searchImage.photo.sizes, AndroidUtilities.dp(Opcodes.GETFIELD));
    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (true) {
            ...
            this.wallpaperViews[i3].measure(View.MeasureSpec.makeMeasureSpec(i3 == i6 + (-1) ? iDp : i4, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(iDp2, TLObject.FLAG_30));
            iDp -= i4;
            i3++;
        }
    }
