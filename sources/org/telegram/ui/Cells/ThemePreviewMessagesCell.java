...
public class ThemePreviewMessagesCell extends LinearLayout {
    ...
    /* JADX WARN: Removed duplicated region for block: B:195:0x046f A[SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public ThemePreviewMessagesCell(android.content.Context r24, org.telegram.ui.ActionBar.INavigationLayout r25, int r26, long r27, org.telegram.ui.ActionBar.Theme.ResourcesProvider r29) {
        /*
    ...
    class AnonymousClass1 extends ChatMessageCell {
        ...
        class C00361 extends GestureDetector.SimpleOnGestureListener {
            C00361() {
            }
            ...
            public boolean onDoubleTap(MotionEvent motionEvent) {
                ...
                boolean zSelectReaction = AnonymousClass1.this.getMessageObject().selectReaction(ReactionsLayoutInBubble.VisibleReaction.fromEmojicon(MediaDataController.getInstance(AnonymousClass1.this.currentAccount).getDoubleTapReaction()), false, false);
                ...
                AnonymousClass1.this.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserverOnPreDrawListenerC00371());
                return true;
            }

            /* JADX INFO: renamed from: org.telegram.ui.Cells.ThemePreviewMessagesCell$1$1$1 */
            class ViewTreeObserverOnPreDrawListenerC00371 implements ViewTreeObserver.OnPreDrawListener {
                ViewTreeObserverOnPreDrawListenerC00371() {
                }
        ...
        AnonymousClass1(Context context, int i, boolean z, ChatMessageSharedResources chatMessageSharedResources, Theme.ResourcesProvider resourcesProvider, Context context2, int i2) {
            super(context, i, z, chatMessageSharedResources, resourcesProvider);
            this.val$context = context2;
            this.val$type = i2;
            this.gestureDetector = new GestureDetector(context2, new C00361());
