    ...
    static class ActiveAuctionCell extends FrameLayout {
        ...
        public void updateStatus(boolean z) {
            if (this.auction.auctionStateActive != null) {
                this.titleView.setText(LocaleController.formatString(R.string.Gift2ActiveAuctionsActiveRound, LocaleController.formatNumber(r0.current_round, ','), LocaleController.formatNumber(this.auction.auctionStateActive.total_rounds, ',')), z);
            }
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, LayoutHelper.measureSpecExactlyDp(Opcodes.I2C));
        }
