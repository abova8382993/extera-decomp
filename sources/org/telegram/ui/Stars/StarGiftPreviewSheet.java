...
public class StarGiftPreviewSheet extends BottomSheetWithRecyclerListView {
    ...
    public static /* synthetic */ void m16122$r8$lambda$4FWGrWE3omtJROED_SUH0Jjw8(View view) {
    }
    ...
    public StarGiftPreviewSheet(Context context, Theme.ResourcesProvider resourcesProvider, int i, String str, final ArrayList arrayList, boolean z) {
        ...
        StarGiftSheet.TopView topView = new StarGiftSheet.TopView(context, resourcesProvider, new Runnable() { // from class: org.telegram.ui.Stars.StarGiftPreviewSheet$$ExternalSyntheticLambda11
            ...
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                StarGiftPreviewSheet.m16122$r8$lambda$4FWGrWE3omtJROED_SUH0Jjw8(view);
            }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Stars.StarGiftPreviewSheet$5, reason: invalid class name */
    ...
    protected RecyclerListView.SelectionAdapter createAdapter(RecyclerListView recyclerListView) {
        AnonymousClass5 anonymousClass5 = new AnonymousClass5(this.recyclerListView, getContext(), this.currentAccount, 0, true, new Utilities.Callback2() { // from class: org.telegram.ui.Stars.StarGiftPreviewSheet$$ExternalSyntheticLambda15
