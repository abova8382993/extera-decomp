...
public class GiftOfferSheet extends BottomSheetWithRecyclerListView {
    ...
    public GiftOfferSheet(final Context context, final int i, final long j, TL_stars.TL_starGiftUnique tL_starGiftUnique, final Theme.ResourcesProvider resourcesProvider, Runnable runnable) {
        ...
        AnonymousClass1 anonymousClass1 = new EditTextBoldCursor(context) { // from class: org.telegram.ui.Stars.GiftOfferSheet.1
    ...
    private void openConfirmAlert() {
        ...
        tableView.addRow(LocaleController.getString(R.string.GiftOfferRowOffer), StarsIntroActivity.replaceStarsWithPlain(z, LocaleController.formatString(R.string.GiftOfferAmount, strAsFormatString), 0.8f));
        if (sendPaidMessagesStars > 0) {
            tableView.addRow(LocaleController.getString(R.string.GiftOfferRowFee), StarsIntroActivity.replaceStarsWithPlain(LocaleController.formatString(R.string.GiftOfferAmount, amountUtils$AmountFromDecimal.asFormatString()), 0.8f));
        }
        ...
        if (sendPaidMessagesStars == 0) {
            ...
            spannableStringBuilder.append(LocaleController.formatSpannable(R.string.GiftOfferPayMulti, StarsIntroActivity.replaceStars(true, (CharSequence) LocaleController.formatString(R.string.GiftOfferPayMultiPart, strAsFormatString)), StarsIntroActivity.replaceStars(LocaleController.formatString(R.string.GiftOfferPayMultiPart, amountUtils$AmountFromDecimal.asFormatString()))));
        } else {
    ...
    public static void openOfferAcceptAlert(final BaseFragment baseFragment, Context context, Theme.ResourcesProvider resourcesProvider, final int i, long j, final int i2, TLRPC.TL_messageActionStarGiftPurchaseOffer tL_messageActionStarGiftPurchaseOffer) {
        ...
        new AlertDialog.Builder(context, resourcesProvider).setView(linearLayout).setPositiveButton(StarsIntroActivity.replaceStars(z2, LocaleController.formatString(R.string.GiftOfferSellFor, strAsFormatString2)), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Stars.GiftOfferSheet$$ExternalSyntheticLambda0
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
    ...
    public static /* synthetic */ void $r8$lambda$gwQEkKs_SOAXz1zUreKS8Dm31cc(int i, final int i2, final BaseFragment baseFragment, final AlertDialog alertDialog, int i3) {
        ...
        ConnectionsManager.getInstance(i2).sendRequestTyped(tL_resolveStarGiftOffer, new Utilities.Callback2() { // from class: org.telegram.ui.Stars.GiftOfferSheet$$ExternalSyntheticLambda1
            @Override // org.telegram.messenger.Utilities.Callback2
            public final void run(Object obj, Object obj2) {
                GiftOfferSheet.m16103$r8$lambda$IzHiAyep2_oXhadHlpCz1iaQM(i2, baseFragment, progressMakeButtonLoading, alertDialog, (TLRPC.Updates) obj, (TLRPC.TL_error) obj2);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$IzHiAye-p2_oXhadHlpCz1iaQ-M */
    public static /* synthetic */ void m16103$r8$lambda$IzHiAyep2_oXhadHlpCz1iaQM(int i, final BaseFragment baseFragment, final Browser.Progress progress, final AlertDialog alertDialog, TLRPC.Updates updates, final TLRPC.TL_error tL_error) {
        if (updates != null && tL_error == null) {
