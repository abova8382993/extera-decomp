...
public class CallLogActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, MainTabsActivity.TabFragmentDelegate {
    ...
    class EmptyTextProgressView extends FrameLayout {
        ...
        public EmptyTextProgressView(Context context, View view) {
            ...
            setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.CallLogActivity$EmptyTextProgressView$$ExternalSyntheticLambda1
                ...
                public final boolean onTouch(View view2, MotionEvent motionEvent) {
                    return CallLogActivity.EmptyTextProgressView.m4473$r8$lambda$r2yXPcVr5CyXIjl7raCNSCXp8(view2, motionEvent);
                }
            });
        }
        ...
        public static /* synthetic */ boolean m4473$r8$lambda$r2yXPcVr5CyXIjl7raCNSCXp8(View view, MotionEvent motionEvent) {
            return true;
        }
    ...
    */
    public void didReceivedNotification(int r17, int r18, java.lang.Object... r19) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.CallLogActivity.didReceivedNotification(int, int, java.lang.Object[]):void");
    }
    ...
    public View createView(Context context) {
        ...
        AnonymousClass4 anonymousClass4 = new FragmentContextView(context2, this, this.contentView, false, this.resourceProvider) { // from class: org.telegram.ui.CallLogActivity.4
            AnonymousClass4(Context context2, final BaseFragment this, View view, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.fragmentContextView = anonymousClass4;
        anonymousClass4.isInsideBubble = true;
        this.fragmentContextViewWrapper.addView(anonymousClass4);
    ...
    class AnonymousClass4 extends FragmentContextView {
        AnonymousClass4(Context context2, final CallLogActivity this, View view, boolean z, Theme.ResourcesProvider resourcesProvider) {
            super(context2, this, view, z, resourcesProvider);
        }
    ...
    public void showDeleteAlert(final boolean z) {
        ...
        checkBoxCell.setText(LocaleController.getString(R.string.DeleteCallsForEveryone), _UrlKt.FRAGMENT_ENCODE_SET, false, false);
        ...
        builder.setPositiveButton(LocaleController.getString(R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda32
    ...
    */
    ...
    public static void showCallLinkSheet(final Context context, int i, final TLRPC.InputGroupCall inputGroupCall, final String str, final Theme.ResourcesProvider resourcesProvider, boolean z, final boolean z2) {
        ...
        imageView3.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.ic_ab_other));
        ...
        if (z) {
            AnonymousClass6 anonymousClass6 = new TextView(context) { // from class: org.telegram.ui.CallLogActivity.6
                private final Paint paint = new Paint(1);
                final /* synthetic */ Theme.ResourcesProvider val$resourcesProvider;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                AnonymousClass6(final Context context2, final Theme.ResourcesProvider resourcesProvider2) {
                    super(context2);
            ...
            anonymousClass6.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteGrayText2, resourcesProvider2));
            anonymousClass6.setText(" " + LocaleController.getString(R.string.GroupCallCreatedLinkJoinOr) + " ");
            anonymousClass6.setTextSize(14.0f);
            linearLayout.addView(anonymousClass6, LayoutHelper.createLinear(Opcodes.ARRAYLENGTH, -2, 1, 28, 12, 28, 8));
            i2 = i;
        ...
        buttonWithCounterView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda43
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                CallLogActivity.m4429$r8$lambda$1EFOwZ77UqkTcqErUyM45xhGTk(strArr, bottomSheetShow, resourcesProvider2, view);
            }
        });
        final Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda44
            @Override // java.lang.Runnable
            public final void run() {
                CallLogActivity.m4431$r8$lambda$2prmdrrmAf0kUoNk0dOqcJaAs(inputGroupCall, i2, strArr, frameLayout3, linksTextViewMakeLinkTextView3, bottomSheetShow, resourcesProvider2);
            }
        };
        imageView3.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda45
            ...
            public final void onClick(View view) {
                ...
                ItemOptions.makeOptions(bottomSheet.container, resourcesProvider2, frameLayout4).add(R.drawable.msg_copy, LocaleController.getString(R.string.Copy), new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda49
                    @Override // java.lang.Runnable
                    public final void run() {
                        CallLogActivity.$r8$lambda$PLg6mSTanxGc9UtnR7bnEEzTVXc(strArr2, bottomSheet, resourcesProvider2);
                    }
                }).add(R.drawable.msg_qrcode, LocaleController.getString(R.string.GetQRCode), new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda50
                    @Override // java.lang.Runnable
                    public final void run() {
                        CallLogActivity.m4441$r8$lambda$ofizaQ8fz8pIkZ0CmoIzuZ1WxU(context, strArr2);
                    }
        ...
        buttonWithCounterView2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda46
            ...
            public final void onClick(View view) {
                new ShareAlert(context2, null, str, false, strArr[0], false, resourcesProvider2) { // from class: org.telegram.ui.CallLogActivity.8
                    ...
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    AnonymousClass8(Context context2, ArrayList arrayList, String str2, boolean z3, String str3, boolean z4, Theme.ResourcesProvider resourcesProvider2, BottomSheet bottomSheet) {
        ...
        if (z2) {
            imageView2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda47
                ...
                public final void onClick(View view) {
                    BottomSheet bottomSheet = bottomSheetShow;
                    ItemOptions.makeOptions(bottomSheet.getContainer(), resourcesProvider2, imageView2).add(R.drawable.menu_link_revoke, LocaleController.getString(R.string.GroupCallCreatedLinkRevoke), runnable2).setOnTopOfScrim().translate(0.0f, -AndroidUtilities.dp(6.0f)).setDimAlpha(0).show();
                }
            });
        }
    }
        ...
        ConnectionsManager.getInstance(i).sendRequest(exportgroupcallinvite, new RequestDelegate() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda51
            ...
            public final void run(TLObject tLObject2, TLRPC.TL_error tL_error2) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        CallLogActivity.m4435$r8$lambda$XP3zZ7XrhNj3c7Y0VBP453XMXs(tLObject2, strArr, frameLayout, linksTextView, bottomSheet, resourcesProvider);
                    }
                });
            }
        });
    ...
    public static /* synthetic */ void m4435$r8$lambda$XP3zZ7XrhNj3c7Y0VBP453XMXs(TLObject tLObject, String[] strArr, final FrameLayout frameLayout, final LinkSpanDrawable.LinksTextView linksTextView, BottomSheet bottomSheet, Theme.ResourcesProvider resourcesProvider) {
        if (tLObject instanceof TL_phone.exportedGroupCallInvite) {
            ...
            duration.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.CallLogActivity.7
                ...
                AnonymousClass7(final AtomicBoolean atomicBoolean2, final LinkSpanDrawable.LinksTextView linksTextView2, final String strSubstring2) {
    ...
    public static /* synthetic */ void m4441$r8$lambda$ofizaQ8fz8pIkZ0CmoIzuZ1WxU(Context context, String[] strArr) {
        ...
        ConnectionsManager.getInstance(i).sendRequest(createconferencecall, new RequestDelegate() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda30
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda33
                    @Override // java.lang.Runnable
                    public final void run() {
                        CallLogActivity.m4439$r8$lambda$gyhVDjUE7ARRTUf1l96t6off0(tLObject, i, alertDialog, context, resourcesProvider, runnable);
                    }
                });
            }
        });
    ...
    public static /* synthetic */ void m4439$r8$lambda$gyhVDjUE7ARRTUf1l96t6off0(TLObject tLObject, final int i, final AlertDialog alertDialog, final Context context, final Theme.ResourcesProvider resourcesProvider, final Runnable runnable) {
        int i2 = 0;
        if (tLObject instanceof TLRPC.Updates) {
            TLRPC.Updates updates = (TLRPC.Updates) tLObject;
            ...
            ConnectionsManager.getInstance(i).sendRequest(exportgroupcallinvite, new RequestDelegate() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda38
                ...
                public final void run(TLObject tLObject2, TLRPC.TL_error tL_error) {
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda39
                        @Override // java.lang.Runnable
                        public final void run() {
                            CallLogActivity.m4440$r8$lambda$k3EfdJ6Yoam0W237sh_2inFJEA(tLObject2, alertDialog, context, i, exportgroupcallinvite, resourcesProvider, runnable);
                        }
                    });
                }
            });
    ...
    public static /* synthetic */ void m4440$r8$lambda$k3EfdJ6Yoam0W237sh_2inFJEA(TLObject tLObject, AlertDialog alertDialog, Context context, int i, TL_phone.exportGroupCallInvite exportgroupcallinvite, Theme.ResourcesProvider resourcesProvider, Runnable runnable) {
        if (tLObject instanceof TL_phone.exportedGroupCallInvite) {
            alertDialog.dismiss();
    ...
    private void showItemOptions() {
        ...
        if (getUserConfig().showCallsTab) {
            itemOptionsMakeOptions.add(R.drawable.msg_archive_hide, LocaleController.getString(R.string.HideCallTab), new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda15
                @Override // java.lang.Runnable
                public final void run() {
        ...
        itemOptionsMakeOptions.add(R.drawable.msg_delete, (CharSequence) LocaleController.getString(R.string.DeleteAllCalls), true, new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda16
            @Override // java.lang.Runnable
            public final void run() {
