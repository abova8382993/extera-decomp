...
public class TONIntroActivity extends GradientHeaderActivity implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(final Context context) {
        ...
        AnonymousClass1 anonymousClass1 = new View(context) { // from class: org.telegram.ui.TON.TONIntroActivity.1
            ...
            protected void onMeasure(int i, int i2) {
                ...
                if (tONIntroActivity.isLandscapeMode) {
                    measuredHeight = (tONIntroActivity.statusBarHeight + ((BaseFragment) tONIntroActivity).actionBar.getMeasuredHeight()) - AndroidUtilities.dp(16.0f);
                } else {
                    int iDp = AndroidUtilities.dp(140.0f);
                    TONIntroActivity tONIntroActivity2 = TONIntroActivity.this;
                    int measuredHeight2 = iDp + tONIntroActivity2.statusBarHeight;
                    if (tONIntroActivity2.backgroundView.getMeasuredHeight() + AndroidUtilities.dp(24.0f) > measuredHeight2) {
                        measuredHeight2 = TONIntroActivity.this.backgroundView.getMeasuredHeight() + AndroidUtilities.dp(24.0f);
                    }
        ...
        anonymousClass1.setBackgroundColor(Theme.getColor(this.allowTopUp ? Theme.key_dialogBackgroundGray : Theme.key_dialogBackground));
        ...
        this.aboveTitleView.addView(this.iconTextureView, LayoutHelper.createFrame(Opcodes.TABLESWITCH, 170.0f, 17, 0.0f, 32.0f, 0.0f, 24.0f));
        ...
        AnonymousClass2 anonymousClass2 = new FrameLayout(getContext()) { // from class: org.telegram.ui.TON.TONIntroActivity.2
        ...
        AnonymousClass3 anonymousClass3 = new LinearLayout(getContext()) { // from class: org.telegram.ui.TON.TONIntroActivity.3
        ...
        this.twoButtonsLayout = anonymousClass3;
        frameLayout2.addView(anonymousClass3);
    ...
    protected RecyclerView.Adapter createAdapter() {
        AnonymousClass5 anonymousClass5 = new UniversalAdapter(this.listView, getContext(), this.currentAccount, this.classGuid, true, new Utilities.Callback2() { // from class: org.telegram.ui.TON.TONIntroActivity$$ExternalSyntheticLambda7
