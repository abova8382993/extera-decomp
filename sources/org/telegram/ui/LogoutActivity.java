...
public class LogoutActivity extends BaseFragment {
    ...
    public static AlertDialog makeLogOutDialog(Context context, final int i) {
        ...
        builder.setPositiveButton(LocaleController.getString(R.string.LogOut), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.LogoutActivity$$ExternalSyntheticLambda1
