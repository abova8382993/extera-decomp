...
public class ChatEditTypeActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ChatEditTypeActivity$6, reason: invalid class name */
    class AnonymousClass6 extends TextInfoPrivacyCell {
            ...
            if (this.prevHeight != -1 && ChatEditTypeActivity.this.linearLayout != null) {
                ...
                valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.ChatEditTypeActivity$6$$ExternalSyntheticLambda0
                    ...
                    public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                        ChatEditTypeActivity.AnonymousClass6.m6128$r8$lambda$5iypMHzfd2L8oljr3QXR7PEQpM(arrayList, height, valueAnimator2);
                    }
                });
        ...
        public static /* synthetic */ void m6128$r8$lambda$5iypMHzfd2L8oljr3QXR7PEQpM(ArrayList arrayList, float f, ValueAnimator valueAnimator) {
    ...
    class UsernamesListView extends RecyclerListView {
        ...
        public static /* synthetic */ void m6129$r8$lambda$oQEsyq3f16mseGL6oDuSzZA71Y(TLObject tLObject, TLRPC.TL_error tL_error) {
        }
        ...
        /* JADX INFO: renamed from: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$1, reason: invalid class name */
        class AnonymousClass1 implements RecyclerListView.OnItemClickListener {
            ...
            public void onItemClick(final View view, int i) {
                ...
                }).setNegativeButton(LocaleController.getString(R.string.Cancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$1$$ExternalSyntheticLambda2
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                    public final void onClick(AlertDialog alertDialog, int i2) {
                        alertDialog.dismiss();
                    }
        ...
        public void sendReorder() {
            ...
            ChatEditTypeActivity.this.getConnectionsManager().sendRequest(tL_channels_reorderUsernames, new RequestDelegate() { // from class: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$$ExternalSyntheticLambda0
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    ChatEditTypeActivity.UsernamesListView.m6129$r8$lambda$oQEsyq3f16mseGL6oDuSzZA71Y(tLObject, tL_error);
                }
            });
            updateChat();
        }
    ...
    public /* synthetic */ void lambda$loadAdminedChannels$20(View view) {
        ...
        builder.setPositiveButton(LocaleController.getString(R.string.RevokeButton), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ChatEditTypeActivity$$ExternalSyntheticLambda27
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
