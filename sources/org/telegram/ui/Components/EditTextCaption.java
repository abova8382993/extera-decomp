...
public class EditTextCaption extends EditTextBoldCursor {
        ...
        if (this.adaptiveCreateLinkDialog) {
            ...
            this.creationLinkDialog.setOnShowListener(new DialogInterface.OnShowListener() { // from class: org.telegram.ui.Components.EditTextCaption$$ExternalSyntheticLambda4
                ...
                public final void onShow(DialogInterface dialogInterface) {
                    EditTextCaption.m7824$r8$lambda$pCcTxlQ8dV6EAwUJKlmcmDpPcA(editTextBoldCursor, dialogInterface);
                }
            });
            ...
            r2.show().setOnShowListener(new DialogInterface.OnShowListener() { // from class: org.telegram.ui.Components.EditTextCaption$$ExternalSyntheticLambda5
                @Override // android.content.DialogInterface.OnShowListener
                public final void onShow(DialogInterface dialogInterface) {
                    EditTextCaption.m7825$r8$lambda$w99hVJg8PezZJc1Cp768FzOPvA(editTextBoldCursor, dialogInterface);
                }
            });
        }
    ...
    /* JADX INFO: renamed from: $r8$lambda$pCcTxlQ8dV6EAwUJ-KlmcmDpPcA, reason: not valid java name */
    public static /* synthetic */ void m7824$r8$lambda$pCcTxlQ8dV6EAwUJKlmcmDpPcA(EditTextBoldCursor editTextBoldCursor, DialogInterface dialogInterface) {
        editTextBoldCursor.requestFocus();
        AndroidUtilities.showKeyboard(editTextBoldCursor);
    }

    /* JADX INFO: renamed from: $r8$lambda$w99hVJ-g8PezZJc1Cp768FzOPvA, reason: not valid java name */
    public static /* synthetic */ void m7825$r8$lambda$w99hVJg8PezZJc1Cp768FzOPvA(EditTextBoldCursor editTextBoldCursor, DialogInterface dialogInterface) {
        editTextBoldCursor.requestFocus();
        AndroidUtilities.showKeyboard(editTextBoldCursor);
    }
