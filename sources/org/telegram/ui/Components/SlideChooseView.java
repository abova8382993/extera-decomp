    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (i2 < this.optionsStr.length) {
            ...
            if (this.leftDrawables != null) {
                ...
                canvas2.save();
                f4 = 0.0f;
                canvas2.translate((this.leftDrawables[i2].getIntrinsicWidth() / 2.0f) - AndroidUtilities.dp(i2 == 0 ? f2 : 2.0f), 0.0f);
            } else {
                f4 = 0.0f;
            }
            if (i2 == 0) {
        ...
        canvas2.drawCircle(f17, f18, AndroidUtilities.dp(f8 * 12.0f), this.paint);
