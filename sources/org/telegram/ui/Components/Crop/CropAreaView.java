    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.freeform) {
            ...
            if (this.dimVisibile) {
                ...
                float f12 = (i + i9) - iDp;
                canvas.drawRect(0.0f, f11, i4 + iDp, f12, this.dimPaint);
                canvas.drawRect((i4 + i8) - iDp, f11, getWidth(), f12, this.dimPaint);
            ...
            canvas.drawRect(f14, f15, f16, r6 + iDp, this.framePaint);
            float f17 = i16 + iDp;
            int i18 = i + i9;
            float f18 = i18 - i12;
            canvas.drawRect(f14, f15, f17, f18, this.framePaint);
            canvas.drawRect(f14, r8 - iDp, f16, f18, this.framePaint);
            canvas.drawRect(r4 - iDp, f15, f16, f18, this.framePaint);
            int i19 = 0;
            while (i19 < 3) {
    ...
    */
    public void calculateRect(android.graphics.RectF r13, float r14) {
        ...
        L7f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.Crop.CropAreaView.calculateRect(android.graphics.RectF, float):void");
    }
