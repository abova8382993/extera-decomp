...
public class MediaActivity extends BaseFragment implements SharedMediaLayout.SharedMediaPreloaderDelegate, FloatingDebugProvider, NotificationCenter.NotificationCenterDelegate {
    ...
    */
        ...
        protected void onMeasure(int i, int i2) {
            ...
            for (int i3 = 0; i3 < 2; i3++) {
                if (MediaActivity.this.nameTextView[i3] != null) {
                    ((FrameLayout.LayoutParams) MediaActivity.this.nameTextView[i3].getLayoutParams()).topMargin = (((ActionBar.getCurrentActionBarHeight() / 2) - AndroidUtilities.dp(22.0f)) / 2) + AndroidUtilities.dp((AndroidUtilities.isTablet() || getResources().getConfiguration().orientation != 2) ? 5.0f : 4.0f);
                }
                if (MediaActivity.this.subtitleTextView[i3] != null) {
                    ((FrameLayout.LayoutParams) MediaActivity.this.subtitleTextView[i3].getLayoutParams()).topMargin = ((ActionBar.getCurrentActionBarHeight() / 2) + (((ActionBar.getCurrentActionBarHeight() / 2) - AndroidUtilities.dp(19.0f)) / 2)) - AndroidUtilities.dp(7.0f);
                }
            }
    ...
    class AnonymousClass3 extends ProfileActivity.AvatarImageView {
    ...
    class AnonymousClass5 implements SharedMediaLayout.Delegate {
        ...
        if (zArr[i] != z || this.firstSubtitleCheck[i]) {
            ...
            if (z3) {
                ...
                this.subtitleAnimator[i].addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.MediaActivity.7
                    ...
                    AnonymousClass7(final int i3, boolean z4) {
                        i = i3;
                        z = z4;
                    }
            ...
            this.nameTextView[i3].setTranslationY(z4 ? 0.0f : AndroidUtilities.dp(8.0f));
