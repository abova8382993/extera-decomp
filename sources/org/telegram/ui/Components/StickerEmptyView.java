...
public class StickerEmptyView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public StickerEmptyView(Context context, View view, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.stickerType = i;
        AnonymousClass2 anonymousClass2 = new LinearLayout(context) { // from class: org.telegram.ui.Components.StickerEmptyView.2
    ...
    public void createButtonLayout(CharSequence charSequence, final Runnable runnable) {
        ...
        AnonymousClass3 anonymousClass3 = new FrameLayout(getContext()) { // from class: org.telegram.ui.Components.StickerEmptyView.3
        ...
        anonymousClass3.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.StickerEmptyView$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                AndroidUtilities.runOnUIThread(runnable, 100L);
            }
        });
        anonymousClass3.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.dp(8.0f), Theme.getColor(Theme.key_featuredStickers_addButton, this.resourcesProvider), ColorUtils.setAlphaComponent(Theme.getColor(i, this.resourcesProvider), 30)));
        ScaleStateListAnimator.apply(anonymousClass3, 0.05f, 1.5f);
        anonymousClass3.addView(textView);
        this.linearLayout.setClipChildren(false);
        this.linearLayout.addView(anonymousClass3, LayoutHelper.createLinear(-2, -2, 1, 0, 28, 0, 4));
    }
