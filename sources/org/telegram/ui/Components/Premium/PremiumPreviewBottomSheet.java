...
public class PremiumPreviewBottomSheet extends BottomSheetWithRecyclerListView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public PremiumPreviewBottomSheet(final BaseFragment baseFragment, final int i, TLRPC.User user, GiftPremiumBottomSheet$GiftTier giftPremiumBottomSheet$GiftTier, TL_stars.StarGift starGift, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.containerView.addView(frameLayout, LayoutHelper.createFrame(-1, Opcodes.F2L, 87));
    }
    ...
    */
    public void setTitle(boolean r13) {
        /*
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet$1 */
    class AnonymousClass1 extends ClickableSpan {
        ...
        public void updateDrawState(TextPaint textPaint) {
            ...
            Integer num = PremiumPreviewBottomSheet.this.accentColor;
            if (num != null) {
    ...
    public /* synthetic */ void lambda$setTitle$6(ClickableSpan clickableSpan) {
        ...
        AnonymousClass2 anonymousClass2 = new BaseFragment() { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet.2
            AnonymousClass2() {
            }
        ...
        if (baseFragment != null) {
            anonymousClass2.setParentFragment(baseFragment);
        }
        new EmojiPacksAlert(anonymousClass2, getContext(), this.resourcesProvider, arrayList) { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet.3
            AnonymousClass3(BaseFragment anonymousClass22, Context context, Theme.ResourcesProvider resourcesProvider, ArrayList arrayList2) {
                super(anonymousClass22, context, resourcesProvider, arrayList2);
            }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet$2 */
    class AnonymousClass2 extends BaseFragment {
        AnonymousClass2() {
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet$3 */
    class AnonymousClass3 extends EmojiPacksAlert {
        AnonymousClass3(BaseFragment anonymousClass22, Context context, Theme.ResourcesProvider resourcesProvider, ArrayList arrayList2) {
            super(anonymousClass22, context, resourcesProvider, arrayList2);
        }
    ...
    protected void attachIconContainer(LinearLayout linearLayout) {
        linearLayout.addView(this.overrideTitleIcon, LayoutHelper.createLinear(Opcodes.F2L, Opcodes.F2L, 1.0f, 17, 10, 10, 10, 10));
    }

    class Adapter extends RecyclerListView.SelectionAdapter {
        /* synthetic */ Adapter(PremiumPreviewBottomSheet premiumPreviewBottomSheet, PremiumPreviewBottomSheetIA premiumPreviewBottomSheetIA) {
            this();
        }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                AnonymousClass1 anonymousClass1 = new LinearLayout(context) { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet.Adapter.1
                ...
                if (view == null) {
                    premiumPreviewBottomSheet.iconTextureView = new GLIconTextureView(context2, 1) { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet.Adapter.2
                    ...
                    anonymousClass1.addView(PremiumPreviewBottomSheet.this.iconTextureView, LayoutHelper.createLinear(Opcodes.IF_ICMPNE, Opcodes.IF_ICMPNE, 1));
                } else {
                    ...
                    PremiumPreviewBottomSheet.this.attachIconContainer(anonymousClass1);
                }
                if (PremiumPreviewBottomSheet.this.titleViewContainer == null) {
                    PremiumPreviewBottomSheet.this.titleViewContainer = new FrameLayout(context2);
                    ...
                    int i3 = 0;
                    while (i3 < 2) {
                        PremiumPreviewBottomSheet.this.titleView[i3] = new LinkSpanDrawable.LinksTextView(context2, ((BottomSheet) PremiumPreviewBottomSheet.this).resourcesProvider) { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet.Adapter.3
                ...
                anonymousClass1.addView(PremiumPreviewBottomSheet.this.titleViewContainer, LayoutHelper.createLinear(-2, -2, 0.0f, 1, 40, 0, 40, 0));
                ...
                anonymousClass1.addView(PremiumPreviewBottomSheet.this.subtitleView, LayoutHelper.createLinear(-1, -2, 0.0f, 0, 24, 9, 24, 20));
                PremiumPreviewBottomSheet.this.setTitle(false);
                PremiumPreviewBottomSheet.this.starParticlesView = new StarParticlesView(context2) { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet.Adapter.4
                ...
                AnonymousClass5 anonymousClass5 = new FrameLayout(context2) { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet.Adapter.5
                ...
                anonymousClass5.addView(PremiumPreviewBottomSheet.this.starParticlesView);
                anonymousClass5.addView(anonymousClass1);
                PremiumPreviewBottomSheet premiumPreviewBottomSheet9 = PremiumPreviewBottomSheet.this;
                GLIconTextureView gLIconTextureView = premiumPreviewBottomSheet9.iconTextureView;
                shadowSectionCell = anonymousClass5;
                if (gLIconTextureView != null) {
                    gLIconTextureView.setStarParticlesView(premiumPreviewBottomSheet9.starParticlesView);
                    shadowSectionCell = anonymousClass5;
                }
            } else if (i == 2) {
                shadowSectionCell = new ShadowSectionCell(context2, 12, PremiumPreviewBottomSheet.this.getThemedColor(Theme.key_windowBackgroundGray));
            } else if (i == 3) {
                shadowSectionCell = new View(context2) { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet.Adapter.7
                    ...
                    protected void onMeasure(int i4, int i5) {
                        super.onMeasure(i4, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(68.0f), TLObject.FLAG_30));
                    }
                };
            } else if (i == 4) {
                shadowSectionCell = new AboutPremiumView(context2);
            } else if (i != 5) {
                shadowSectionCell = new PremiumFeatureCell(context2, ((BottomSheet) PremiumPreviewBottomSheet.this).resourcesProvider) { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet.Adapter.6
                ...
                TextInfoCell textInfoCell = new TextInfoCell(context2, ((BottomSheet) PremiumPreviewBottomSheet.this).resourcesProvider);
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet$Adapter$1 */
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet$Adapter$2 */
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet$Adapter$3 */
        class AnonymousClass3 extends LinkSpanDrawable.LinksTextView {
            @Override // org.telegram.ui.Components.LinkSpanDrawable.LinksTextView
            protected int emojiCacheType() {
                return 3;
            }
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet$Adapter$4 */
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet$Adapter$5 */
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet$Adapter$6 */
        class AnonymousClass6 extends PremiumFeatureCell {
            AnonymousClass6(Context context2, Theme.ResourcesProvider resourcesProvider) {
                super(context2, resourcesProvider);
            }
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet$Adapter$7 */
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet$4 */
    class AnonymousClass4 extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            if (this.val$startEnterFromDrawable != null) {
                ValueAnimator valueAnimatorOfInt = ValueAnimator.ofInt(0, Function.USE_VARARGS);
