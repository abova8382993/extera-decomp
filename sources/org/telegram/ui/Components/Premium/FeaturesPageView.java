...
public class FeaturesPageView extends BaseListPageView {
    ...
    */
    ...
    /* JADX INFO: renamed from: $r8$lambda$dXX_8n-C6-cQoBeyITZRw1xIN6w */
    public static /* synthetic */ int m9504$r8$lambda$dXX_8nC6cQoBeyITZRw1xIN6w(SparseIntArray sparseIntArray, Item item, Item item2) {
        return sparseIntArray.get(item.order, Integer.MAX_VALUE) - sparseIntArray.get(item2.order, Integer.MAX_VALUE);
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.FeaturesPageView$1 */
    ...
    public RecyclerView.Adapter createAdapter() {
        AnonymousClass1 anonymousClass1 = new RecyclerListView.SelectionAdapter() { // from class: org.telegram.ui.Components.Premium.FeaturesPageView.1
            @Override // org.telegram.ui.Components.RecyclerListView.SelectionAdapter
            public boolean isEnabled(RecyclerView.ViewHolder viewHolder) {
                return false;
            }
    ...
    class Item {
        ...
        /* synthetic */ Item(FeaturesPageView featuresPageView, int i, FeaturesPageViewIA featuresPageViewIA) {
            this(i);
        }
    ...
    private class HeaderView extends FrameLayout {
        ...
        public HeaderView(Context context) {
            ...
            if (i == 1) {
                AnonymousClass1 anonymousClass1 = new StarParticlesView(context) { // from class: org.telegram.ui.Components.Premium.FeaturesPageView.HeaderView.1
                    final /* synthetic */ FeaturesPageView val$this$0;

                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    AnonymousClass1(Context context2, FeaturesPageView featuresPageView) {
                        super(context2);
                ...
                this.starParticlesView = anonymousClass1;
                addView(anonymousClass1, LayoutHelper.createFrame(-1, Opcodes.ARRAYLENGTH, 55));
                AnonymousClass2 anonymousClass2 = new GLIconTextureView(context2, 1, 1) { // from class: org.telegram.ui.Components.Premium.FeaturesPageView.HeaderView.2
                    final /* synthetic */ FeaturesPageView val$this$0;

                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    AnonymousClass2(Context context2, int i2, int i3, FeaturesPageView featuresPageView) {
                ...
                this.iconTextureView = anonymousClass2;
                anonymousClass2.setStarParticlesView(this.starParticlesView);
                ...
                addView(this.iconTextureView, LayoutHelper.createFrame(Opcodes.IF_ICMPNE, Opcodes.IF_ICMPNE, 1));
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.FeaturesPageView$HeaderView$1 */
        class AnonymousClass1 extends StarParticlesView {
            final /* synthetic */ FeaturesPageView val$this$0;
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.FeaturesPageView$HeaderView$2 */
