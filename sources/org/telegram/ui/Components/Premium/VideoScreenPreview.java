...
public class VideoScreenPreview extends FrameLayout implements PagerHeaderView, NotificationCenter.NotificationCenterDelegate {
    ...
    public VideoScreenPreview(Context context, SvgHelper.SvgDrawable svgDrawable, int i, int i2, Theme.ResourcesProvider resourcesProvider) {
        ...
        AnonymousClass1 anonymousClass1 = new AspectRatioFrameLayout(context) { // from class: org.telegram.ui.Components.Premium.VideoScreenPreview.1
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.VideoScreenPreview$1 */
    class AnonymousClass1 extends AspectRatioFrameLayout {
        Path clipPath = new Path();
            ...
            if (i >= 0) {
                ...
                for (int i2 = 0; i2 < document.thumbs.size(); i2++) {
                    if (document.thumbs.get(i2) instanceof TLRPC.TL_photoStrippedSize) {
                        ...
                        AnonymousClass2 anonymousClass22 = new CombinedDrawable(this.roundedBitmapDrawable, this.cellFlickerDrawable) { // from class: org.telegram.ui.Components.Premium.VideoScreenPreview.2
                        ...
                        anonymousClass22.setFullsize(true);
                        anonymousClass2 = anonymousClass22;
                    }
                }
                this.attachFileName = FileLoader.getAttachFileName(document);
                this.imageReceiver.setImage(null, null, anonymousClass2, null, premiumPromo, 1);
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.VideoScreenPreview$2 */
    class AnonymousClass2 extends CombinedDrawable {
        AnonymousClass2(Drawable drawable, Drawable drawable2) {
            super(drawable, drawable2);
        }
    ...
    private void runVideoPlayer() {
        ...
        if ((this.file != null || SharedConfig.streamMedia) && this.videoPlayerBase == null) {
            ...
            AnonymousClass3 anonymousClass3 = new VideoPlayerHolderBase() { // from class: org.telegram.ui.Components.Premium.VideoScreenPreview.3
                AnonymousClass3() {
                }

                @Override // org.telegram.messenger.video.VideoPlayerHolderBase
                public void onStateChanged(boolean z, int i) {
                    VideoPlayerHolderBase videoPlayerHolderBase = VideoScreenPreview.this.videoPlayerBase;
                ...
                /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.VideoScreenPreview$3$1 */
            ...
            anonymousClass3.with(this.textureView);
            File file = this.file;
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.VideoScreenPreview$3 */
