...
public class LimitPreviewView extends LinearLayout {
    ...
    private void setArrowX(float f) {
        ...
        this.limitIcon.setTranslationX(Utilities.clamp((Math.max(this.width1, (getMeasuredWidth() - (r0 * 2)) * f) + fDp) - (this.limitIcon.getMeasuredWidth() / 2.0f), (getMeasuredWidth() - r0) - this.limitIcon.getMeasuredWidth(), fDp));
    ...
    public void setBoosts(TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus, boolean z) {
        ...
        if ((tL_premium_boostsStatus.current_level_boosts == tL_premium_boostsStatus.boosts && z) || (i = tL_premium_boostsStatus.next_level_boosts) == 0) {
            this.percent = 1.0f;
            this.defaultText.setText(LocaleController.formatString("BoostsLevel", R.string.BoostsLevel, Integer.valueOf(tL_premium_boostsStatus.level - 1)));
            this.premiumCount.setText(LocaleController.formatString("BoostsLevel", R.string.BoostsLevel, Integer.valueOf(tL_premium_boostsStatus.level)));
        } else {
            this.percent = MathUtils.clamp((r2 - r1) / (i - r1), 0.0f, 1.0f);
            this.defaultText.setText(LocaleController.formatString("BoostsLevel", R.string.BoostsLevel, Integer.valueOf(tL_premium_boostsStatus.level)));
            this.premiumCount.setText(LocaleController.formatString("BoostsLevel", R.string.BoostsLevel, Integer.valueOf(tL_premium_boostsStatus.level + 1)));
        }
    ...
    public void setStarRating(TL_stars.Tl_starsRating tl_starsRating) {
        ...
        if (tl_starsRating.stars <= 0) {
            ...
            if (tl_starsRating.next_level_stars == 0) {
                this.percent = 1.0f;
                this.defaultText.setText(LocaleController.formatString(R.string.StarRatingLevel, Integer.valueOf(tl_starsRating.level - 1)));
                this.premiumCount.setText(LocaleController.formatString(R.string.StarRatingLevel, Integer.valueOf(tl_starsRating.level)));
            } else {
                this.percent = MathUtils.clamp((r4 - j) / (r8 - j), 0.0f, 1.0f);
                this.defaultText.setText(LocaleController.formatString(R.string.StarRatingLevel, Integer.valueOf(tl_starsRating.level)));
                this.premiumCount.setText(LocaleController.formatString(R.string.StarRatingLevel, Integer.valueOf(tl_starsRating.level + 1)));
            }
        }
        ((FrameLayout.LayoutParams) this.premiumCount.getLayoutParams()).gravity = 5;
        setType(17);
        ...
        if (i2 == i3) {
            if (tl_starsRating2.stars <= 0) {
                ...
                if (tl_starsRating2.next_level_stars == 0) {
                    this.percent = 1.0f;
                    this.defaultText.setText(LocaleController.formatString(R.string.StarRatingLevel, Integer.valueOf(i3 - 1)));
                    this.premiumCount.setText(LocaleController.formatString(R.string.StarRatingLevel, Integer.valueOf(tl_starsRating2.level)));
                } else {
                    long j = tl_starsRating2.current_level_stars;
                    this.percent = MathUtils.clamp((r4 - j) / (r12 - j), 0.0f, 1.0f);
                    this.defaultText.setText(LocaleController.formatString(R.string.StarRatingLevel, Integer.valueOf(tl_starsRating2.level)));
                    this.premiumCount.setText(LocaleController.formatString(R.string.StarRatingLevel, Integer.valueOf(tl_starsRating2.level + 1)));
                }
            }
            this.animate = true;
