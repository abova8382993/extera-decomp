...
public class DoubledLimitsBottomSheet$Adapter extends RecyclerListView.SelectionAdapter {
    ...
    public DoubledLimitsBottomSheet$Adapter(int i, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        arrayList.add(new DoubledLimitsBottomSheet$Limit(LocaleController.getString(R.string.ConnectedAccountsLimitTitle), LocaleController.formatString(R.string.ConnectedAccountsLimitSubtitle, 4), 8, 16));
