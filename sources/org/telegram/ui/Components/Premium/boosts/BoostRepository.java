...
public abstract class BoostRepository {
    ...
    public static /* synthetic */ void $r8$lambda$VfNNzLz2r9dG197A_eLlLbrOSU8(TLRPC.TL_error tL_error, final Utilities.Callback callback, TLObject tLObject, MessagesController messagesController, TLRPC.TL_inputInvoicePremiumGiftCode tL_inputInvoicePremiumGiftCode, BaseFragment baseFragment, final Utilities.Callback callback2) {
        ...
        if (paymentFormActivity != null) {
            paymentFormActivity.setPaymentFormCallback(new PaymentFormActivity.PaymentFormCallback() { // from class: org.telegram.ui.Components.Premium.boosts.BoostRepository$$ExternalSyntheticLambda38
                @Override // org.telegram.ui.PaymentFormActivity.PaymentFormCallback
                public final void onInvoiceStatusChanged(PaymentFormActivity.InvoiceStatus invoiceStatus) {
                    BoostRepository.m9651$r8$lambda$J0yHjds9RgDYKvt_Tecd4MSrg(callback2, callback, invoiceStatus);
                }
            });
            LaunchActivity.getLastFragment().showAsSheet(paymentFormActivity, new BaseFragment.BottomSheetParams());
        } else {
    ...
    public static /* synthetic */ void m9651$r8$lambda$J0yHjds9RgDYKvt_Tecd4MSrg(Utilities.Callback callback, Utilities.Callback callback2, PaymentFormActivity.InvoiceStatus invoiceStatus) {
        if (invoiceStatus == PaymentFormActivity.InvoiceStatus.PAID) {
            callback.run(null);
        } else if (invoiceStatus != PaymentFormActivity.InvoiceStatus.PENDING) {
            callback2.run(null);
        ...
        connectionsManager.sendRequest(tL_payments_canPurchaseStore, new RequestDelegate() { // from class: org.telegram.ui.Components.Premium.boosts.BoostRepository$$ExternalSyntheticLambda28
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.Premium.boosts.BoostRepository$$ExternalSyntheticLambda39
                    @Override // java.lang.Runnable
                    public final void run() {
                        BoostRepository.m9650$r8$lambda$EsswBawrvnmZnHQ3bnrVP4EnZM(tL_error, callback, tLObject, list, billingResult, callback, baseFragment, tL_inputStorePaymentPremiumGiveaway);
                    }
                });
            }
        });
    ...
    public static /* synthetic */ void m9650$r8$lambda$EsswBawrvnmZnHQ3bnrVP4EnZM(TLRPC.TL_error tL_error, final Utilities.Callback callback, TLObject tLObject, List list, final BillingResult billingResult, final Utilities.Callback callback2, BaseFragment baseFragment, TLRPC.TL_inputStorePaymentPremiumGiveaway tL_inputStorePaymentPremiumGiveaway) {
        if (tL_error != null) {
            ...
            BillingController.getInstance().addResultListener(((ProductDetails) list.get(0)).getProductId(), new Consumer() { // from class: org.telegram.ui.Components.Premium.boosts.BoostRepository$$ExternalSyntheticLambda48
                @Override // androidx.core.util.Consumer
                public final void accept(Object obj) {
                    BoostRepository.m9657$r8$lambda$ig8rwkvloatAUQHYzF830bssQs(billingResult, callback2, (BillingResult) obj);
                }
            });
    ...
    public static /* synthetic */ void m9657$r8$lambda$ig8rwkvloatAUQHYzF830bssQs(BillingResult billingResult, final Utilities.Callback callback, BillingResult billingResult2) {
        if (billingResult.getResponseCode() == 0) {
        ...
        if (tLObject instanceof Vector) {
            ...
            if (arrayList2.isEmpty() || !isGoogleBillingAvailable()) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.Premium.boosts.BoostRepository$$ExternalSyntheticLambda15
                    @Override // java.lang.Runnable
                    public final void run() {
                        BoostRepository.m9658$r8$lambda$li8FkIw_gPYVwIEkZVlffnvmp0(chat, i, arrayList, callback);
                    }
                });
            } else {
    ...
    public static /* synthetic */ void m9658$r8$lambda$li8FkIw_gPYVwIEkZVlffnvmp0(TLRPC.Chat chat, int i, List list, Utilities.Callback callback) {
        if (chat == null) {
    ...
    */
    ...
    public static void searchChats(final long j, int i, String str, int i2, final Utilities.Callback callback) {
        ...
        connectionsManager.sendRequest(tL_contacts_search, new RequestDelegate() { // from class: org.telegram.ui.Components.Premium.boosts.BoostRepository$$ExternalSyntheticLambda19
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                BoostRepository.m9659$r8$lambda$ps5PoP1v0VQnUSMm24oobXVob8(messagesController, j, callback, tLObject, tL_error);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$ps5PoP1v0-VQnUSMm24oobXVob8, reason: not valid java name */
    public static /* synthetic */ void m9659$r8$lambda$ps5PoP1v0VQnUSMm24oobXVob8(MessagesController messagesController, long j, final Utilities.Callback callback, TLObject tLObject, TLRPC.TL_error tL_error) {
        if (tLObject instanceof TLRPC.TL_contacts_found) {
            TLRPC.TL_contacts_found tL_contacts_found = (TLRPC.TL_contacts_found) tLObject;
        ...
        connectionsManager.sendRequest(tL_payments_getGiveawayInfo, new RequestDelegate() { // from class: org.telegram.ui.Components.Premium.boosts.BoostRepository$$ExternalSyntheticLambda10
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.Premium.boosts.BoostRepository$$ExternalSyntheticLambda13
                    @Override // java.lang.Runnable
                    public final void run() {
                        BoostRepository.m9652$r8$lambda$J6qxWY_dgKgsiDrmGLQuQhZJJs(tL_error, callback, tLObject, callback);
                    }
                });
            }
        });
    ...
    public static /* synthetic */ void m9652$r8$lambda$J6qxWY_dgKgsiDrmGLQuQhZJJs(TLRPC.TL_error tL_error, Utilities.Callback callback, TLObject tLObject, Utilities.Callback callback2) {
        if (tL_error != null) {
            callback.run(tL_error);
