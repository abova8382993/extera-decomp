...
public class ReassignBoostBottomSheet extends BottomSheetWithRecyclerListView {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.boosts.ReassignBoostBottomSheet$1 */
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.boosts.ReassignBoostBottomSheet$2 */
    class AnonymousClass2 implements Bulletin.Delegate {
        @Override // org.telegram.ui.Components.Bulletin.Delegate
        public /* synthetic */ boolean allowLayoutChanges() {
            return Bulletin.Delegate.CC.$default$allowLayoutChanges(this);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.boosts.ReassignBoostBottomSheet$3 */
    ...
    static class TopCell extends LinearLayout {
        ...
        public void showChats(List list, TLRPC.Chat chat) {
            ...
            while (i4 < size3) {
                ...
                if (avatarHolderView != null) {
                    ...
                    interpolator.setDuration(j).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.Premium.boosts.ReassignBoostBottomSheet.TopCell.1
                        final /* synthetic */ AvatarHolderView val$finalRemovedAvatar;

                        AnonymousClass1(AvatarHolderView avatarHolderView4) {
                            avatarHolderView = avatarHolderView4;
                        }
                    ...
                    while (i6 < size5) {
                        ...
                        if (avatarHolderView4 != avatarHolderView4) {
                            i5++;
                            avatarHolderView4.animate().translationX((-(size6 - i5)) * AndroidUtilities.dp(23.0f)).setInterpolator(cubicBezierInterpolator).setDuration(j).start();
                        }
                    }
                    if (arrayList3.get(arrayList3.size() - 1) != avatarHolderView4 || arrayList3.size() <= 1) {
                        f3 = 0.1f;
                        c4 = 0;
                    } else {
                        f3 = 0.1f;
            ...
            if (this.addedChats.isEmpty() || this.addedChats.size() == 1) {
                ...
                this.avatarsContainer.animate().setInterpolator(cubicBezierInterpolator).translationX(AndroidUtilities.dp(11.5f) * (this.addedChats.size() - 1)).setDuration(DataTypes.EMPTY).start();
            }
            ...
            ViewPropertyAnimator viewPropertyAnimatorTranslationX2 = this.avatarsWrapper.animate().setInterpolator(cubicBezierInterpolator).translationX(-AndroidUtilities.dp(48.0f));
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.boosts.ReassignBoostBottomSheet$TopCell$1 */
