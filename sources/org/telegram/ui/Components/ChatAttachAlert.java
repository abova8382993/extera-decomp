...
public class ChatAttachAlert extends BottomSheet implements NotificationCenter.NotificationCenterDelegate, BottomSheet.BottomSheetDelegateInterface, FactorAnimator.Target {
    ...
    */
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.ChatAttachAlert$1, reason: invalid class name */
    ...
    public interface ChatAttachViewDelegate {
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Components.ChatAttachAlert$ChatAttachViewDelegate$-CC, reason: invalid class name */
    ...
    class AttachBotButton extends AttachButtonBase {
        ...
        public AttachBotButton(Context context) {
            ...
            glassTabViewCreateAttachBotTab.getBackupImageView().imageReceiver.setDelegate(new ImageReceiver.ImageReceiverDelegate() { // from class: org.telegram.ui.Components.ChatAttachAlert$AttachBotButton$$ExternalSyntheticLambda0
                ...
                public final void didSetImage(ImageReceiver imageReceiver, boolean z, boolean z2, boolean z3) {
                    ChatAttachAlert.AttachBotButton.m7274$r8$lambda$Q4NR2NsLg9EoXirNGvADBmdOEU(imageReceiver, z, z2, z3);
                }
        ...
        public static /* synthetic */ void m7274$r8$lambda$Q4NR2NsLg9EoXirNGvADBmdOEU(ImageReceiver imageReceiver, boolean z, boolean z2, boolean z3) {
    ...
    public ChatAttachAlert(final Context context, final BaseFragment baseFragment, boolean z, final boolean z2, boolean z3, final Theme.ResourcesProvider resourcesProvider) {
        ...
        AnonymousClass6 anonymousClass6 = new AnonymousClass6(context, z, resourcesProvider);
        this.sizeNotifierFrameLayout = anonymousClass6;
        anonymousClass6.setDelegate(new SizeNotifierFrameLayout.SizeNotifierFrameLayoutDelegate() { // from class: org.telegram.ui.Components.ChatAttachAlert.7
        ...
        actionBar3.setItemsBackgroundColor(getThemedColor(i4), false);
        ...
        if (baseFragment != null) {
            ActionBarMenuItem actionBarMenuItem3 = new ActionBarMenuItem(context, null, 0, getThemedColor(i3), false, resourcesProvider);
        ...
        ActionBarMenuItem actionBarMenuItem4 = new ActionBarMenuItem(context, null, 0, getThemedColor(i3), false, resourcesProvider);
        ...
        this.optionsItem.addSubItem(1, R.drawable.msg_addbot, LocaleController.getString(R.string.StickerCreateEmpty)).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatAttachAlert$$ExternalSyntheticLambda25
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        frameLayout.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatAttachAlert$$ExternalSyntheticLambda27
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        this.bottomFadeView = new View(context) { // from class: org.telegram.ui.Components.ChatAttachAlert.16
            ...
            protected void onSizeChanged(int i5, int i6, int i7, int i8) {
                ...
                ChatAttachAlert.this.bottomFadeDrawable.setBounds(0, (i6 - AndroidUtilities.navigationBarHeight) - AndroidUtilities.dp(48.0f), i5, i6);
            }
        ...
        this.buttonsRecyclerView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.telegram.ui.Components.ChatAttachAlert$$ExternalSyntheticLambda28
            ...
            public final void onItemClick(View view2, int i5) {
                this.f$0.lambda$new$13(resourcesProvider, view2, i5);
            }
        });
        ...
        this.frameLayout2 = new AnonymousClass17(context, z);
        ...
        this.frameLayout2.addView(frameLayout3, LayoutHelper.createFrame(-1, -1, Opcodes.DNEG));
        ...
        AnonymousClass19 anonymousClass19 = new AnonymousClass19(context, this.sizeNotifierFrameLayout, null, 1, z5, resourcesProvider);
        this.commentTextView = anonymousClass19;
        anonymousClass19.includeNavigationBar = true;
        anonymousClass19.allowEmojisForNonPremium(LocaleUtils.canUseLocalPremiumEmojis(i));
        ...
        EditTextEmoji editTextEmoji = new EditTextEmoji(context, this.sizeNotifierFrameLayout, null, 1, z5, resourcesProvider) { // from class: org.telegram.ui.Components.ChatAttachAlert.21
            @Override // android.view.ViewGroup
            public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        this.writeButton.setOnLongClickListener(new View.OnLongClickListener() { // from class: org.telegram.ui.Components.ChatAttachAlert$$ExternalSyntheticLambda20
            @Override // android.view.View.OnLongClickListener
            public final boolean onLongClick(View view2) {
                return this.f$0.lambda$new$33(context, resourcesProvider, baseFragment, view2);
            }
        });
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.ChatAttachAlert$6, reason: invalid class name */
    class AnonymousClass6 extends SizeNotifierFrameLayout {
        ...
        AnonymousClass6(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
            super(context);
            ...
            this.bulletinDelegate = new Bulletin.Delegate() { // from class: org.telegram.ui.Components.ChatAttachAlert.6.1
                ...
                public int getBottomOffset(int i) {
                    return (AnonymousClass6.this.getHeight() - ChatAttachAlert.this.frameLayout2.getTop()) + AndroidUtilities.dp(52.0f);
                }
            };
            this.rect = new RectF();
                ...
                */
                protected void onTransitionStart(boolean r5, int r6) {
                    /*
                        ...
                        org.telegram.ui.Components.ChatAttachAlert$6 r0 = org.telegram.ui.Components.ChatAttachAlert.AnonymousClass6.this
                        org.telegram.ui.Components.ChatAttachAlert r0 = org.telegram.ui.Components.ChatAttachAlert.this
                        int r0 = org.telegram.ui.Components.ChatAttachAlert.m7221$$Nest$fgetpreviousScrollOffsetY(r0)
                        r1 = 0
                        if (r0 <= 0) goto L37
                        org.telegram.ui.Components.ChatAttachAlert$6 r0 = org.telegram.ui.Components.ChatAttachAlert.AnonymousClass6.this
                        org.telegram.ui.Components.ChatAttachAlert r0 = org.telegram.ui.Components.ChatAttachAlert.this
                        int r0 = org.telegram.ui.Components.ChatAttachAlert.m7221$$Nest$fgetpreviousScrollOffsetY(r0)
                        org.telegram.ui.Components.ChatAttachAlert$6 r2 = org.telegram.ui.Components.ChatAttachAlert.AnonymousClass6.this
                        org.telegram.ui.Components.ChatAttachAlert r2 = org.telegram.ui.Components.ChatAttachAlert.this
                        int[] r3 = r2.scrollOffsetY
                        r3 = r3[r1]
                        if (r0 == r3) goto L37
                        if (r5 == 0) goto L37
                        int r0 = org.telegram.ui.Components.ChatAttachAlert.m7221$$Nest$fgetpreviousScrollOffsetY(r2)
                        float r0 = (float) r0
                        org.telegram.ui.Components.ChatAttachAlert.m7248$$Nest$fputfromScrollY(r2, r0)
                        org.telegram.ui.Components.ChatAttachAlert$6 r0 = org.telegram.ui.Components.ChatAttachAlert.AnonymousClass6.this
                        org.telegram.ui.Components.ChatAttachAlert r0 = org.telegram.ui.Components.ChatAttachAlert.this
                        int[] r2 = r0.scrollOffsetY
                        r2 = r2[r1]
                        float r2 = (float) r2
                        org.telegram.ui.Components.ChatAttachAlert.m7252$$Nest$fputtoScrollY(r0, r2)
                        goto L40
                    L37:
                        org.telegram.ui.Components.ChatAttachAlert$6 r0 = org.telegram.ui.Components.ChatAttachAlert.AnonymousClass6.this
                        org.telegram.ui.Components.ChatAttachAlert r0 = org.telegram.ui.Components.ChatAttachAlert.this
                        r2 = -1082130432(0xffffffffbf800000, float:-1.0)
                        org.telegram.ui.Components.ChatAttachAlert.m7248$$Nest$fputfromScrollY(r0, r2)
                    L40:
                        org.telegram.ui.Components.ChatAttachAlert$6 r0 = org.telegram.ui.Components.ChatAttachAlert.AnonymousClass6.this
                        r0.invalidate()
                        org.telegram.ui.Components.ChatAttachAlert$6 r0 = org.telegram.ui.Components.ChatAttachAlert.AnonymousClass6.this
                        org.telegram.ui.Components.ChatAttachAlert r0 = org.telegram.ui.Components.ChatAttachAlert.this
                        org.telegram.ui.Components.ChatAttachAlert$AttachAlertLayout r0 = org.telegram.ui.Components.ChatAttachAlert.m7194$$Nest$fgetcurrentAttachLayout(r0)
                        boolean r0 = r0 instanceof org.telegram.ui.bots.ChatAttachAlertBotWebViewLayout
                        if (r0 == 0) goto L72
                        org.telegram.ui.Components.ChatAttachAlert$6 r0 = org.telegram.ui.Components.ChatAttachAlert.AnonymousClass6.this
                        org.telegram.ui.Components.ChatAttachAlert r0 = org.telegram.ui.Components.ChatAttachAlert.this
                        boolean r0 = org.telegram.ui.Components.ChatAttachAlert.m7179$$Nest$fgetbotButtonWasVisible(r0)
                        if (r0 != 0) goto L72
                        if (r5 == 0) goto L69
                        org.telegram.ui.Components.ChatAttachAlert$6 r0 = org.telegram.ui.Components.ChatAttachAlert.AnonymousClass6.this
                        org.telegram.ui.Components.ChatAttachAlert r0 = org.telegram.ui.Components.ChatAttachAlert.this
                    ...
                    L72:
                        ...
                        return
                    */
                    throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.ChatAttachAlert.AnonymousClass6.AnonymousClass2.onTransitionStart(boolean, int):void");
                }
        ...
        */
        protected void onLayout(boolean r17, int r18, int r19, int r20, int r21) {
            /*
                ...
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.ChatAttachAlert.AnonymousClass6.onLayout(boolean, int, int, int, int):void");
        }
        ...
        private void drawChildBackground(Canvas canvas, View view) {
            ...
            if (view instanceof AttachAlertLayout) {
                ...
                if ((fMax != f4 && iNeedsActionBar != 2) || ChatAttachAlert.this.currentAttachLayout.hasCustomActionBarBackground()) {
                    ...
                    canvas.drawRoundRect(this.rect, AndroidUtilities.dp(f7) * fMax, AndroidUtilities.dp(f7) * fMax, Theme.dialogs_onlineCirclePaint);
                    canvas.restore();
                }
                if (ChatAttachAlert.this.currentAttachLayout.hasCustomActionBarBackground()) {
                    ...
                    this.rect.set(((BottomSheet) r4).backgroundPaddingLeft, (((BottomSheet) ChatAttachAlert.this).backgroundPaddingTop + scrollOffsetY + AndroidUtilities.dp(f7)) * fMax, getMeasuredWidth() - ((BottomSheet) ChatAttachAlert.this).backgroundPaddingLeft, scrollOffsetY2 + AndroidUtilities.dp(f7));
                    canvas.save();
                ...
                if ((frameLayout3 == null || frameLayout3.getAlpha() != f4) && fMax != f) {
                    ...
                    this.rect.set((getMeasuredWidth() - iDp5) / 2, iDp3, (getMeasuredWidth() + iDp5) / 2, iDp3 + AndroidUtilities.dp(f3));
                    if (iNeedsActionBar == 2) {
                    ...
                    canvas.drawRoundRect(this.rect, AndroidUtilities.dp(f6), AndroidUtilities.dp(f6), Theme.dialogs_onlineCirclePaint);
                }
                canvas.restore();
            }
        }
        ...
        */
        protected boolean drawChild(android.graphics.Canvas r24, android.view.View r25, long r26) {
            /*
                ...
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.ChatAttachAlert.AnonymousClass6.drawChild(android.graphics.Canvas, android.view.View, long):boolean");
        }
        ...
        protected void onSizeChanged(int i, int i2, int i3, int i4) {
            ...
            if (ChatAttachAlert.this.emojiViewChildBg != null) {
                ChatAttachAlert.this.emojiViewChildBg.setRadius(AndroidUtilities.dp(29.0f), AndroidUtilities.dp(29.0f), radius2, radius, true);
            }
        }
    }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.ChatAttachAlert$11, reason: invalid class name */
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.ChatAttachAlert$17, reason: invalid class name */
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.ChatAttachAlert$19, reason: invalid class name */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public /* synthetic */ boolean lambda$new$33(android.content.Context r37, final org.telegram.ui.ActionBar.Theme.ResourcesProvider r38, final org.telegram.ui.ActionBar.BaseFragment r39, android.view.View r40) throws java.lang.Throwable {
        /*
            Method dump skipped, instruction units count: 1899
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.ChatAttachAlert.lambda$new$33(android.content.Context, org.telegram.ui.ActionBar.Theme$ResourcesProvider, org.telegram.ui.ActionBar.BaseFragment, android.view.View):boolean");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public /* synthetic */ void lambda$new$24(org.telegram.ui.ActionBar.BaseFragment r10, org.telegram.ui.ActionBar.Theme.ResourcesProvider r11, android.view.View r12) {
        /*
            r9 = this;
        ...
        L56:
            ...
            boolean r12 = r10 instanceof org.telegram.ui.ChatActivity
            if (r12 == 0) goto L7e
            ...
            org.telegram.ui.ChatActivity r12 = (org.telegram.ui.ChatActivity) r12
            ...
            r12.<init>()
            org.telegram.ui.Components.AlertsCreator.createScheduleDatePickerDialog(r10, r2, r12, r11)
            r2 = r9
            goto Lb5
        L7e:
        ...
        Lb5:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.ChatAttachAlert.lambda$new$24(org.telegram.ui.ActionBar.BaseFragment, org.telegram.ui.ActionBar.Theme$ResourcesProvider, android.view.View):void");
    }
    ...
    public void onLongClickBotButton(final TLRPC.TL_attachMenuBot tL_attachMenuBot, final TLRPC.User user) {
        ...
        while (i < size) {
            ...
            i++;
            if (((TLRPC.TL_attachMenuBot) obj).bot_id == user.id) {
                break;
            }
        }
        ...
        title.setMessage(AndroidUtilities.replaceTags(string)).setPositiveButton(LocaleController.getString("OK", R.string.OK), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.ChatAttachAlert$$ExternalSyntheticLambda55
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.ChatAttachAlert$28, reason: invalid class name */
    class AnonymousClass28 extends AnimatorListenerAdapter {
        final /* synthetic */ Runnable val$onEnd;
        final /* synthetic */ int val$t;

        AnonymousClass28(int i, Runnable runnable) {
            this.val$t = i;
        ...
        */
        public /* synthetic */ void lambda$onAnimationEnd$0(androidx.dynamicanimation.animation.DynamicAnimation r1, float r2, float r3) {
            /*
                ...
                org.telegram.ui.Components.ChatAttachAlert$AttachAlertLayout r1 = org.telegram.ui.Components.ChatAttachAlert.m7211$$Nest$fgetnextAttachLayout(r1)
                org.telegram.ui.Components.ChatAttachAlert r2 = org.telegram.ui.Components.ChatAttachAlert.this
                org.telegram.ui.Components.ChatAttachAlertPollLayout r2 = org.telegram.ui.Components.ChatAttachAlert.m7219$$Nest$fgetpollLayout(r2)
                if (r1 == r2) goto L28
                org.telegram.ui.Components.ChatAttachAlert r1 = org.telegram.ui.Components.ChatAttachAlert.this
                org.telegram.ui.Components.ChatAttachAlert$AttachAlertLayout r1 = org.telegram.ui.Components.ChatAttachAlert.m7211$$Nest$fgetnextAttachLayout(r1)
                org.telegram.ui.Components.ChatAttachAlert r2 = org.telegram.ui.Components.ChatAttachAlert.this
                org.telegram.ui.Components.ChatAttachAlertPollLayout r2 = org.telegram.ui.Components.ChatAttachAlert.m7230$$Nest$fgettodoLayout(r2)
                if (r1 == r2) goto L28
                org.telegram.ui.Components.ChatAttachAlert r1 = org.telegram.ui.Components.ChatAttachAlert.this
                boolean r2 = r1.isPhotoPicker
                if (r2 == 0) goto L2e
                java.lang.Object r1 = org.telegram.ui.Components.ChatAttachAlert.m7234$$Nest$fgetviewChangeAnimator(r1)
                if (r1 == 0) goto L2e
            L28:
                org.telegram.ui.Components.ChatAttachAlert r1 = org.telegram.ui.Components.ChatAttachAlert.this
                r2 = 1
                org.telegram.ui.Components.ChatAttachAlert.m7265$$Nest$mupdateSelectedPosition(r1, r2)
            L2e:
                org.telegram.ui.Components.ChatAttachAlert r1 = org.telegram.ui.Components.ChatAttachAlert.this
                org.telegram.ui.Components.ChatAttachAlert$AttachAlertLayout r1 = org.telegram.ui.Components.ChatAttachAlert.m7211$$Nest$fgetnextAttachLayout(r1)
                org.telegram.ui.Components.ChatAttachAlert r2 = org.telegram.ui.Components.ChatAttachAlert.this
                ...
                org.telegram.ui.Components.ChatAttachAlert r1 = org.telegram.ui.Components.ChatAttachAlert.this
                android.view.ViewGroup r1 = org.telegram.ui.Components.ChatAttachAlert.access$9000(r1)
                r1.invalidate()
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.ChatAttachAlert.AnonymousClass28.lambda$onAnimationEnd$0(androidx.dynamicanimation.animation.DynamicAnimation, float, float):void");
        }
        ...
        if (this.viewChangeAnimator == null && this.commentsAnimator == null) {
            ...
            if (!(attachAlertLayout5 instanceof ChatAttachAlertPhotoLayoutPreview) && !(this.nextAttachLayout instanceof ChatAttachAlertPhotoLayoutPreview)) {
                if (z) {
                    ...
                    animatorSet.addListener(new AnonymousClass28(firstOffset, runnable));
    ...
    */
    ...
    public void updateCameraButtonVisibility() {
        ...
        float fMax = Math.max(this.buttonsRecyclerViewWrapper.getTranslationY(), (1.0f - alpha) * AndroidUtilities.dp(70.0f));
        if (z) {
    ...
    */
    ...
    public void createMentionsContainer() {
        ...
        MentionsContainerView.Delegate delegate = new MentionsContainerView.Delegate() { // from class: org.telegram.ui.Components.ChatAttachAlert.37
