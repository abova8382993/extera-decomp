...
public class PipVideoOverlay implements IPipSourceDelegate {
    ...
    private boolean showInternal(boolean z, Activity activity, View view, PhotoViewerWebView photoViewerWebView, int i, int i2, boolean z2) {
        ...
        AnonymousClass6 anonymousClass6 = new PipVideoViewGroup(context2) { // from class: org.telegram.ui.Components.PipVideoOverlay.6
        ...
        if (pipX != -1.0f) {
            float fDp = pipX + (i5 / 2.0f) >= ((float) AndroidUtilities.displaySize.x) / 2.0f ? (r4 - i5) - AndroidUtilities.dp(16.0f) : AndroidUtilities.dp(16.0f);
            this.pipX = fDp;
    ...
    class AnonymousClass6 extends PipVideoViewGroup {
        AnonymousClass6(Context context2) {
            super(context2);
        }
    ...
    class AnonymousClass8 implements VideoForwardDrawable.VideoForwardDrawableDelegate {
        @Override // org.telegram.ui.Components.VideoForwardDrawable.VideoForwardDrawableDelegate
        public void onAnimationEnd() {
        }
    ...
    class AnonymousClass10 implements TextureView.SurfaceTextureListener {
        @Override // android.view.TextureView.SurfaceTextureListener
        public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
        }
