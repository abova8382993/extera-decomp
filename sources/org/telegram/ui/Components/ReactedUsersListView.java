        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (recyclerListView != null) {
                for (int i5 = 0; i5 < recyclerListView.getChildCount(); i5++) {
                    recyclerListView.getChildAt(i5).measure(View.MeasureSpec.makeMeasureSpec(iDp, TLObject.FLAG_30), i2);
                }
            }
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(iDp, TLObject.FLAG_30), i2);
        }
    }
