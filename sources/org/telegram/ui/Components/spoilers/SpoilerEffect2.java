...
public class SpoilerEffect2 {
    ...
    private class SpoilerThread extends Thread {
        ...
        private void init() {
            ...
            GLES20.glShaderSource(iGlCreateShader, AndroidUtilities.readRes(org.telegram.messenger.R.raw.spoiler_vertex) + "\n// " + Math.random());
            ...
            GLES20.glShaderSource(iGlCreateShader2, AndroidUtilities.readRes(org.telegram.messenger.R.raw.spoiler_fragment) + "\n// " + Math.random());
