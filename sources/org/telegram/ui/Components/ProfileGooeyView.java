    ...
    private final class GPUImpl implements Impl {
        ...
        public void draw(Drawer drawer, Canvas canvas) {
            ...
            if (canvas.isHardwareAccelerated()) {
                ...
                float fLerp = AndroidUtilities.lerp(0.0f, AndroidUtilities.dp(7.0f) * f15, 0.0f, 0.5f, ProfileGooeyView.this.pullProgress);
                if (ProfileGooeyView.this.getChildCount() > 0) {
                ...
                if (ProfileGooeyView.this.notchInfo != null) {
                    ...
                    i = 255;
                    paint = null;
                    recordingCanvasBeginRecording4.drawRect(0.0f, 0.0f, f6, AndroidUtilities.dp(32.0f), ProfileGooeyView.this.blackPaint);
                    ProfileGooeyView.this.path.rewind();
                    ProfileGooeyView.this.path.moveTo((f6 - fLerp) / 2.0f, AndroidUtilities.dp(32.0f));
                    ProfileGooeyView.this.path.lineTo(f6 / 2.0f, AndroidUtilities.dp(32.0f) + fLerp);
                    ProfileGooeyView.this.path.lineTo((f6 + fLerp) / 2.0f, AndroidUtilities.dp(32.0f));
                    ProfileGooeyView.this.path.close();
                    recordingCanvasBeginRecording4.drawPath(ProfileGooeyView.this.path, ProfileGooeyView.this.blackPaint);
                }
