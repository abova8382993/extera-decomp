...
public abstract class TranscribeButton {
    ...
    public void draw(Canvas canvas, float f) {
        ...
        canvas.saveLayerAlpha(0.0f, 0.0f, AndroidUtilities.dp(26.0f), AndroidUtilities.dp(26.0f), Function.USE_VARARGS, 31);
        if (this.isOpen) {
    ...
    private static class LoadingPointsDrawable extends Drawable {
        ...
        public LoadingPointsDrawable(TextPaint textPaint) {
            ...
            float textSize = textPaint.getTextSize() * 0.89f;
            AnonymousClass1 anonymousClass1 = new RLottieDrawable(org.telegram.messenger.R.raw.dots_loading, "dots_loading", (int) textSize, (int) (textSize * 1.25f)) { // from class: org.telegram.ui.Components.TranscribeButton.LoadingPointsDrawable.1
            ...
            this.lottie = anonymousClass1;
            anonymousClass1.setAutoRepeat(1);
            this.lottie.setCurrentFrame((int) ((SystemClock.elapsedRealtime() / 16.0f) % 60.0f));
            this.lottie.setAllowDecodeSingleFrame(true);
            this.lottie.start();
        }

        /* JADX INFO: renamed from: org.telegram.ui.Components.TranscribeButton$LoadingPointsDrawable$1 */
        class AnonymousClass1 extends RLottieDrawable {
            @Override // org.telegram.ui.Components.RLottieDrawable
            protected boolean hasParentView() {
                return true;
            }
            ...
            if (VoiceRecognitionController.isCustomRecognitionEnabled() && !UserConfig.getInstance(UserConfig.selectedAccount).isPremium()) {
                MediaLoader.loadFiles(AccountInstance.getInstance(i), new ArrayList() { // from class: org.telegram.ui.Components.TranscribeButton.1
                    ...
                    public final void run(int i4) {
                        TranscribeButton.m10908$r8$lambda$kNGsRkppBULGalCwHXfcm26L9g(messageObject, requestDelegate, i4);
                    }
                });
                return;
            } else {
        ...
        if (tL_messages_transcribedAudio != null) {
            ...
            if ((tL_messages_transcribedAudio.flags & 2) != 0) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.TranscribeButton$$ExternalSyntheticLambda8
                    @Override // java.lang.Runnable
                    public final void run() {
                        TranscribeButton.m10907$r8$lambda$a2o22si0EBawgKyJsqzCtlJsVw(chatMessageCellDelegate, tL_messages_transcribedAudio);
                    }
                });
            }
            ...
            if (tL_error != null && (str = tL_error.text) != null) {
                if (str.startsWith("FLOOD_WAIT_")) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.TranscribeButton$$ExternalSyntheticLambda9
                        @Override // java.lang.Runnable
                        public final void run() {
                            TranscribeButton.m10909$r8$lambda$oaPhGEe95pO5I2f8R2G6iDBAyg(messageObject, chatMessageCellDelegate, i);
                        }
                    });
                    return;
                }
    ...
    /* JADX INFO: renamed from: $r8$lambda$a2o22si0EBawg-KyJsqzCtlJsVw */
    public static /* synthetic */ void m10907$r8$lambda$a2o22si0EBawgKyJsqzCtlJsVw(ChatMessageCell.ChatMessageCellDelegate chatMessageCellDelegate, TLRPC.TL_messages_transcribedAudio tL_messages_transcribedAudio) {
        if (chatMessageCellDelegate != null) {
            chatMessageCellDelegate.needShowPremiumBulletin(tL_messages_transcribedAudio.trial_remains_num > 0 ? 1 : 2);
        }
    }

    /* JADX INFO: renamed from: $r8$lambda$oaPhGEe95pO5I2f8R2G6iDB-Ayg */
    public static /* synthetic */ void m10909$r8$lambda$oaPhGEe95pO5I2f8R2G6iDBAyg(MessageObject messageObject, ChatMessageCell.ChatMessageCellDelegate chatMessageCellDelegate, int i) {
        HashMap map = transcribeOperationsByDialogPosition;
        if (map != null) {
            map.remove(Integer.valueOf(reqInfoHash(messageObject)));
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.TranscribeButton$1 */
    /* JADX INFO: loaded from: classes5.dex */
    ...
    /* JADX INFO: renamed from: $r8$lambda$kNGsRkppBULGalCwHXf-cm26L9g */
    public static /* synthetic */ void m10908$r8$lambda$kNGsRkppBULGalCwHXfcm26L9g(MessageObject messageObject, RequestDelegate requestDelegate, int i) {
        if (i > 0) {
    ...
    private static void transcribeLocally(MessageObject messageObject, RequestDelegate requestDelegate) {
        ...
        voiceRecognitionController.startRecognition(voiceRecognitionController.key(Long.valueOf(peerDialogId), i), ExteraConfig.recognitionLanguage, pathToMessage, "vosk", new VoiceRecognitionController.RecognitionCallback() { // from class: org.telegram.ui.Components.TranscribeButton.2
            final /* synthetic */ Long val$hashCode;
            ...
            AnonymousClass2(Long l, RequestDelegate requestDelegate2) {
                l = l;
            ...
            public void onChunk(String str) {
                ...
                tL_messages_transcribedAudio.transcription_id = l.longValue();
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.TranscribeButton$2 */
    /* JADX INFO: loaded from: classes5.dex */
    class AnonymousClass2 implements VoiceRecognitionController.RecognitionCallback {
        final /* synthetic */ Long val$hashCode;
        final /* synthetic */ RequestDelegate val$onComplete;
        ...
        try {
            ...
            if (messageObject != null && messageObject.messageOwner != null) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.TranscribeButton$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        TranscribeButton.m10906$r8$lambda$1VsD2GsCgYYhqv4wc1i0EhIq0(messageObject, j, str);
                    }
                });
                return true;
            }
    ...
    /* JADX INFO: renamed from: $r8$lambda$1VsD2GsCgYYhqv4wc1i0Eh-Iq-0 */
    public static /* synthetic */ void m10906$r8$lambda$1VsD2GsCgYYhqv4wc1i0EhIq0(MessageObject messageObject, long j, String str) {
