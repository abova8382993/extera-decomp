    ...
    public int texture() {
        ...
        try {
            ...
            for (int i4 = 0; i4 < i3; i4++) {
                int i5 = iArr2[i4];
                iArr2[i4] = ((i5 >> 16) & Function.USE_VARARGS) | (i5 & (-16711936)) | ((i5 & Function.USE_VARARGS) << 16);
            }
        ...
        if (!this.bitmap.isRecycled() && Build.VERSION.SDK_INT <= 28) {
            ...
            int i6 = ((pixel >> 16) & Function.USE_VARARGS) | ((-16711936) & pixel) | ((pixel & Function.USE_VARARGS) << 16);
            ByteBuffer byteBufferAllocateDirect = ByteBuffer.allocateDirect(4);
            byteBufferAllocateDirect.putInt(i6).position(0);
