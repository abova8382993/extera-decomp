...
public class PhotoFace {
    ...
    public PhotoFace(Face face, Bitmap bitmap, Size size, boolean z) {
        ...
        if (pointTransposePoint != null && pointTransposePoint2 != null) {
            ...
            this.eyesCenterPoint = new org.telegram.ui.Components.Point((pointTransposePoint.x * 0.5f) + (pointTransposePoint2.x * 0.5f), (pointTransposePoint.y * 0.5f) + (pointTransposePoint2.y * 0.5f));
