...
public class TopicSeparator {
    ...
    public void draw(Canvas canvas, int i, float f, float f2, float f3, float f4, boolean z) {
        ...
        if (this.pathWidth == i2 && this.pathParentWidth == i && this.pathWithCenter == z && this.pathWithDots == this.withDots) {
            ...
            rectF.set(f9, AndroidUtilities.dp(4.5f), f9 + fDp, AndroidUtilities.dp(28.5f));
            if (z) {
            ...
            if (this.withDots) {
                float f10 = f7 / 2.0f;
                float f11 = 1.833f;
                float fDp2 = f10 - AndroidUtilities.dp(1.833f);
                while (fDp2 > 0.0f) {
                ...
                f5 = fDp;
                f6 = f8;
                int iDp = AndroidUtilities.dp(f11);
                while (true) {
                    f10 += iDp;
                    if (f10 >= f7) {
                        break;
                    ...
                    rectF3.set(f10, AndroidUtilities.dp(15.5f), AndroidUtilities.dp(3.66f) + f10, AndroidUtilities.dp(17.5f));
        ...
        float f13 = f12 + f9;
        float f14 = f13 + f5;
        this.clickBounds.set(f13 - AndroidUtilities.dp(4.0f), f2 - AndroidUtilities.dp(4.0f), AndroidUtilities.dp(4.0f) + f14, AndroidUtilities.dp(32.0f) + f2);
        if (z) {
            AnimatedEmojiDrawable animatedEmojiDrawable = this.emojiImage;
            if (animatedEmojiDrawable != null) {
                animatedEmojiDrawable.setBounds((int) (AndroidUtilities.dp(2.66f) + f13), (int) (AndroidUtilities.dp(6.5f) + f2), (int) (AndroidUtilities.dp(22.66f) + f13), (int) (AndroidUtilities.dp(26.5f) + f2));
                this.emojiImage.setAlpha((int) (255.0f * f4));
                this.emojiImage.draw(canvas);
            } else {
                this.image.setImageCoords(AndroidUtilities.dp(2.66f) + f13, AndroidUtilities.dp(6.5f) + f2, AndroidUtilities.dp(20.0f), AndroidUtilities.dp(20.0f));
                this.image.setAlpha(f4);
                this.image.draw(canvas);
            }
            int color = Theme.getColor(Theme.key_chat_serviceText, this.resourcesProvider);
            this.text.draw(canvas, f13 + AndroidUtilities.dp(27.66f), AndroidUtilities.dp(16.5f) + f2, color, f4);
            canvas.save();
            canvas.translate(f14 - AndroidUtilities.dp(11.25f), AndroidUtilities.dp(16.5f) + f2);
