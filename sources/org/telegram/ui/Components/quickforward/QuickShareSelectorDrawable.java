...
public class QuickShareSelectorDrawable extends Drawable implements Animator.AnimatorListener {
    ...
    public void draw(Canvas canvas, int i, boolean z) {
        ...
        if (blurVisibilityDrawable != null && !z) {
            ...
            blurVisibilityDrawable.setBounds(i5, iDp, (int) rectF2.right, (int) rectF2.bottom);
            ...
            if (this.selectedIndex != -1) {
                ...
                if (lottieLayout != null && lottieLayout.top) {
                    fMin = Math.max(fCenterY, f5) + AndroidUtilities.dp(Sizes.CLOSE_AVATAR_JUMP_HEIGHT);
                } else {
                    fMin = Math.min(fCenterY, f5) - AndroidUtilities.dp(Sizes.CLOSE_AVATAR_JUMP_HEIGHT);
                }
                this.avatarCells[this.selectedIndex].drawBlurredAvatar(canvas2, fromTo(fCenterX, f4, interpolation2), findParabola(fCenterX, fCenterY, f4, f5, f6, fMin, interpolation2), fromTo((AndroidUtilities.dp(Sizes.AVATAR) / 2.0f) + AndroidUtilities.dp(2.0f), AndroidUtilities.dp(12.0f), interpolation2), interpolation);
                return;
            }
            return;
        }
            ...
            while (true) {
                if (i7 < this.avatarCells.length) {
                    if (!(i6 == 0 && i7 == this.selectedIndex) && (i6 != 1 || i7 == this.selectedIndex)) {
                        ...
                        float f8 = i7 == i4 ? fDp2 : (i7 == 1 || i7 == 3) ? fDp3 : fDp4;
    ...
    public static Interpolator interpolator(final Interpolator interpolator, int i, int i2, int i3, final boolean z) {
        ...
        return new Interpolator() { // from class: org.telegram.ui.Components.quickforward.QuickShareSelectorDrawable$$ExternalSyntheticLambda2
            ...
            public final float getInterpolation(float f4) {
                return QuickShareSelectorDrawable.m11196$r8$lambda$TFdbEg5B8rng8gyNxj41ZbRLAs(z, f2, f3, interpolator, f4);
            }
        };
    }

    /* JADX INFO: renamed from: $r8$lambda$TFdbEg5B8-rng8gyNxj41ZbRLAs, reason: not valid java name */
    public static /* synthetic */ float m11196$r8$lambda$TFdbEg5B8rng8gyNxj41ZbRLAs(boolean z, float f, float f2, Interpolator interpolator, float f3) {
        if (z) {
