...
public class VoIpGradientLayout extends FrameLayout {
    ...
    public void switchToCalling() {
        ...
        this.alphaBlueGreen = Function.USE_VARARGS;
        ValueAnimator valueAnimatorOfInt = ValueAnimator.ofInt(Function.USE_VARARGS, 0, Function.USE_VARARGS);
    ...
    public void switchToConnectedAnimator() {
        ...
        this.alphaGreen = Function.USE_VARARGS;
        this.connectedAnimatorSet = new AnimatorSet();
        ValueAnimator valueAnimatorOfInt = ValueAnimator.ofInt(0, Function.USE_VARARGS, Function.USE_VARARGS, Function.USE_VARARGS, 0);
        ...
        valueAnimatorOfInt.setRepeatCount(-1);
        valueAnimatorOfInt.setRepeatMode(1);
        ValueAnimator valueAnimatorOfInt2 = ValueAnimator.ofInt(0, 0, Function.USE_VARARGS, 0, 0);
    ...
    public void showToBadConnection() {
        ...
        this.state = gradientState2;
        ValueAnimator valueAnimatorOfInt = ValueAnimator.ofInt(this.alphaOrangeRed, Function.USE_VARARGS);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.showClip) {
            ...
            this.bgGreen.setAlpha(Function.USE_VARARGS);
            this.bgGreen.draw(canvas);
            this.clipPath.rewind();
            ...
            this.bgGreenLightReveal.setAlpha(Function.USE_VARARGS);
            ...
            this.bgGreenDarkReveal.setAlpha(Function.USE_VARARGS);
