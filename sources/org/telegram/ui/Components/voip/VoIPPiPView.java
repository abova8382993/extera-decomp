...
public class VoIPPiPView implements VoIPService.StateListener, IPipSourceDelegate, NotificationCenter.NotificationCenterDelegate {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.voip.VoIPPiPView$1 */
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.voip.VoIPPiPView$2 */
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.voip.VoIPPiPView$3 */
    ...
    public VoIPPiPView(final Context context, int i, int i2, boolean z) {
        ...
        AnonymousClass4 anonymousClass4 = new FrameLayout(context) { // from class: org.telegram.ui.Components.voip.VoIPPiPView.4
            final /* synthetic */ Drawable val$outerDrawable;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            AnonymousClass4(final Context context2, Drawable drawable) {
                super(context2);
                drawable = drawable;
            }
        ...
        this.floatingView = new FloatingView(context2);
        VoIPTextureView voIPTextureView = new VoIPTextureView(context2, false, true);
        this.callingUserTextureView = voIPTextureView;
        voIPTextureView.scaleType = VoIPTextureView.SCALE_TYPE_NONE;
        VoIPTextureView voIPTextureView2 = new VoIPTextureView(context2, false, true);
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.voip.VoIPPiPView$4 */
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.voip.VoIPPiPView$5 */
    class AnonymousClass5 implements RendererCommon.RendererEvents {
        @Override // org.webrtc.RendererCommon.RendererEvents
        public void onFrameResolutionChanged(int i, int i2, int i3) {
        }
    ...
    class FloatingView extends FrameLayout {
        ...
        public FloatingView(Context context) {
            ...
            setOutlineProvider(new ViewOutlineProvider() { // from class: org.telegram.ui.Components.voip.VoIPPiPView.FloatingView.1
                final /* synthetic */ VoIPPiPView val$this$0;

                AnonymousClass1(VoIPPiPView voIPPiPView) {
                    voIPPiPView = voIPPiPView;
                }
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Components.voip.VoIPPiPView$FloatingView$1 */
        ...
        */
        ...
        public void expand(boolean z) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.voip.VoIPPiPView$FloatingView$$ExternalSyntheticLambda1
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    VoIPPiPView.FloatingView.m11420$r8$lambda$IozzDMM2wo9rwKfitkKti6NbPU(scaleX2, valueAnimator);
                }
            });
        ...
        public /* synthetic */ void lambda$expand$1(final float f, final VoIPPiPView voIPPiPView) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.voip.VoIPPiPView$FloatingView$$ExternalSyntheticLambda2
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    VoIPPiPView.FloatingView.m11421$r8$lambda$nnUQfHzfHnDL_MoShkmrtDfByk(f, f2, voIPPiPView, valueAnimator);
                }
            });
        ...
        /* JADX INFO: renamed from: $r8$lambda$nn-UQfHzfHnDL_MoShkmrtDfByk */
        public static /* synthetic */ void m11421$r8$lambda$nnUQfHzfHnDL_MoShkmrtDfByk(float f, float f2, VoIPPiPView voIPPiPView, ValueAnimator valueAnimator) {
            float fFloatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Components.voip.VoIPPiPView$FloatingView$2 */
        ...
        /* JADX INFO: renamed from: $r8$lambda$IozzDMM2-wo9rwKfitkKti6NbPU */
        public static /* synthetic */ void m11420$r8$lambda$IozzDMM2wo9rwKfitkKti6NbPU(float f, ValueAnimator valueAnimator) {
            float fFloatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.voip.VoIPPiPView$6 */
