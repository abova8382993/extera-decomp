...
public class RateCallLayout extends FrameLayout {
    ...
    public /* synthetic */ void lambda$new$3(Context context, float f, float f2, int i) {
        if (i >= 4) {
            ...
            rLottieImageView.setAnimation(R.raw.rate, Opcodes.I2L, Opcodes.I2L);
            int[] iArr = new int[2];
    ...
    public void show(OnRateSelected onRateSelected) {
        ...
        animatorSet.playTogether(objectAnimatorOfFloat, objectAnimatorOfFloat2, ObjectAnimator.ofFloat(this.rateCallContainer, (Property<RateCallContainer, Float>) property3, 0.7f, 1.0f), ObjectAnimator.ofFloat(this.rateCallContainer, (Property<RateCallContainer, Float>) property4, AndroidUtilities.dp(24.0f), 0.0f));
