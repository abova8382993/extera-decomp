...
public class VoIpSwitchLayout extends FrameLayout {
    ...
    */
    ...
    public void lambda$setType$0(int i) {
        this.voIpButtonView.unSelectedIcon = new RLottieDrawable(R.raw.speaker_to_bt, _UrlKt.FRAGMENT_ENCODE_SET + R.raw.speaker_to_bt, i, i, true, null);
        this.voIpButtonView.selectedIcon = new RLottieDrawable(R.raw.speaker_to_bt, _UrlKt.FRAGMENT_ENCODE_SET + R.raw.speaker_to_bt, i, i, true, null);
    ...
    public void lambda$setType$2(int i) {
        this.voIpButtonView.unSelectedIcon = new RLottieDrawable(R.raw.bt_to_speaker, _UrlKt.FRAGMENT_ENCODE_SET + R.raw.bt_to_speaker, i, i, true, null);
        this.voIpButtonView.selectedIcon = new RLottieDrawable(R.raw.bt_to_speaker, _UrlKt.FRAGMENT_ENCODE_SET + R.raw.bt_to_speaker, i, i, true, null);
        this.voIpButtonView.selectedIcon.setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.MULTIPLY));
    }
