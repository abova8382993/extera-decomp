...
public class AcceptDeclineView extends View {
    ...
    public AcceptDeclineView(Context context) {
        ...
        RLottieDrawable rLottieDrawable = new RLottieDrawable(R.raw.call_accept, _UrlKt.FRAGMENT_ENCODE_SET + R.raw.call_accept, AndroidUtilities.dp(48.0f), AndroidUtilities.dp(48.0f), true, null);
