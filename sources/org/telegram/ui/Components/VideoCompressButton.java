...
public class VideoCompressButton extends View {
    ...
    public VideoCompressButton(Context context) {
        ...
        this.sizes = new int[]{Opcodes.D2F, 240, 360, 480, 720, 1080, 1440, 2160};
    ...
    public void setState(boolean z, boolean z2, int i) {
        ...
        if (z2) {
            ...
            if (length < 0) {
                ...
                this.sizeTextDrawable.setText(_UrlKt.FRAGMENT_ENCODE_SET + this.sizes[length], TextUtils.isEmpty(this.sizeTextDrawable.getText()));
            }
        }
