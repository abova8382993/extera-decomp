    ...
    public void draw(Canvas canvas) {
        ...
        if (f8 > 0.0f) {
            if (this.hintDrawable == null) {
                RLottieDrawable rLottieDrawable = new RLottieDrawable(R.raw.seek_speed_hint, _UrlKt.FRAGMENT_ENCODE_SET + R.raw.seek_speed_hint, AndroidUtilities.dp(24.0f), AndroidUtilities.dp(24.0f), true, null);
