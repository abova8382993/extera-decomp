...
public abstract class AvatarConstructorPreviewCell extends FrameLayout {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.AvatarConstructorPreviewCell$1 */
    class AnonymousClass1 implements Runnable {
        ...
        public void run() {
            ...
            if (avatarConstructorPreviewCell.isAllEmojiDrawablesLoaded || (AvatarConstructorPreviewCell.this.nextAnimatedEmojiDrawable.getImageReceiver() != null && AvatarConstructorPreviewCell.this.nextAnimatedEmojiDrawable.getImageReceiver().hasImageLoaded())) {
                ...
                int i = avatarConstructorPreviewCell2.emojiIndex + 1;
                avatarConstructorPreviewCell2.emojiIndex = i;
                avatarConstructorPreviewCell2.backgroundIndex++;
                if (i > avatarConstructorPreviewCell2.emojiList.document_id.size() - 1) {
                ...
                int i2 = avatarConstructorPreviewCell3.backgroundIndex;
                ...
                avatarConstructorPreviewCell3.animatedEmojiDrawable = new AnimatedEmojiDrawable(4, i3, ((Long) avatarConstructorPreviewCell4.emojiList.document_id.get(avatarConstructorPreviewCell4.emojiIndex)).longValue());
                ...
                AvatarConstructorPreviewCell.this.nextBackgroundDrawable.setColors(i4, i5, i6, i7);
        ...
        if (stickerSets.isEmpty()) {
            ...
            for (int i2 = 0; i2 < featuredEmojiSets.size(); i2++) {
                ...
                if (document != null) {
                    ...
                    if (!tL_stickerSetFullCovered.documents.isEmpty()) {
                        tL_emojiList2.document_id.add(Long.valueOf(((TLRPC.Document) tL_stickerSetFullCovered.documents.get(0)).id));
                    }
                }
            }
        } else {
            for (int i3 = 0; i3 < stickerSets.size(); i3++) {
                ...
                if (!tL_messages_stickerSet.documents.isEmpty()) {
                    tL_emojiList2.document_id.add(Long.valueOf(((TLRPC.Document) tL_messages_stickerSet.documents.get(Math.abs(Utilities.fastRandom.nextInt() % tL_messages_stickerSet.documents.size()))).id));
                }
            }
        }
    ...
    public AvatarConstructorPreviewCell(Context context, boolean z) {
        ...
        this.scheduleSwitchToNextRunnable = new Runnable() { // from class: org.telegram.ui.Components.AvatarConstructorPreviewCell.1
            ...
            public void run() {
                ...
                if (avatarConstructorPreviewCell.isAllEmojiDrawablesLoaded || (AvatarConstructorPreviewCell.this.nextAnimatedEmojiDrawable.getImageReceiver() != null && AvatarConstructorPreviewCell.this.nextAnimatedEmojiDrawable.getImageReceiver().hasImageLoaded())) {
                    ...
                    AvatarConstructorPreviewCell avatarConstructorPreviewCell3 = AvatarConstructorPreviewCell.this;
                    int i22 = avatarConstructorPreviewCell3.backgroundIndex;
                    int[][] iArr = AvatarConstructorFragment.defaultColors;
        ...
        if (tL_emojiList != null && !tL_emojiList.document_id.isEmpty()) {
            AnimatedEmojiDrawable animatedEmojiDrawable = new AnimatedEmojiDrawable(4, i, ((Long) this.emojiList.document_id.get(0)).longValue());
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (f == 1.0f) {
            this.currentBackgroundDrawable.paint.setAlpha(Function.USE_VARARGS);
