...
public class WallpaperCheckBoxView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas2.drawText(this.currentText, AndroidUtilities.dp(28.0f) + measuredWidth, AndroidUtilities.dp(21.0f), this.textPaint);
        canvas2.save();
        canvas2.translate(measuredWidth, AndroidUtilities.dp(7.0f));
        int i2 = 0;
