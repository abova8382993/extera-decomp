...
public class EditTextBoldCursor extends EditTextEffects {
    ...
    public Drawable getTextCursorDrawable() {
        ...
        ShapeDrawable shapeDrawable = new ShapeDrawable(new RoundRectShape(new float[]{AndroidUtilities.dp(10.0f), AndroidUtilities.dp(10.0f), AndroidUtilities.dp(10.0f), AndroidUtilities.dp(10.0f), AndroidUtilities.dp(10.0f), AndroidUtilities.dp(10.0f), AndroidUtilities.dp(10.0f), AndroidUtilities.dp(10.0f)}, null, null)) { // from class: org.telegram.ui.Components.EditTextBoldCursor.4
    ...
    private void init() {
        ...
        if (i >= 29) {
            ...
            c = 0;
            f = 10.0f;
            shapeDrawable.setShape(new RoundRectShape(new float[]{AndroidUtilities.dp(10.0f), AndroidUtilities.dp(10.0f), AndroidUtilities.dp(10.0f), AndroidUtilities.dp(10.0f), AndroidUtilities.dp(10.0f), AndroidUtilities.dp(10.0f), AndroidUtilities.dp(10.0f), AndroidUtilities.dp(10.0f)}, null, null));
        ...
        if (this.cursorDrawable == null) {
            try {
                ...
                gradientDrawable2.setCornerRadius(AndroidUtilities.dp(f));
