...
public class GalleryEmptyView extends LinearLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(44.0f), TLObject.FLAG_30);
        ...
        this.useAnEmojiButton.getLayoutParams().width = iMax + AndroidUtilities.dp(80.0f);
