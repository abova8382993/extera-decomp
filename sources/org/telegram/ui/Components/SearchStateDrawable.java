...
public class SearchStateDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        if (f10 > 0.0f) {
            f2 = 1.0f;
            drawCircle(canvas2, AndroidUtilities.lerp(x(0.25f), x(0.444f), f10), AndroidUtilities.lerp(y(0.5f), y(0.444f), f10), AndroidUtilities.lerp(0.0f, w(0.208f), f10));
        } else {
            f2 = 1.0f;
        }
        if (f10 > 0.0f || f11 > 0.0f) {
            ...
            f3 = 45.0f;
            c = 1;
            canvas2.rotate(f10 * 45.0f, this.cx, this.cy);
            f4 = 0.2409f;
            f5 = 0.75f;
            float fLerp3 = lerp3(x(0.914f), x(0.7638f), this.fromState == 2 ? x(0.75f) : x(0.2409f), f10, f11, f);
            float fY = y(0.5f);
            float fLerp32 = lerp3(x(0.658f), x(0.2409f), this.fromState == 2 ? x(0.75f) : x(0.2409f), f10, f11, f);
            float f12 = f;
            f6 = f10;
            f7 = f12;
            canvas3 = canvas2;
            f8 = f11;
            drawLine(canvas3, fLerp3, fY, fLerp32, y(0.5f));
            canvas3.restore();
        } else {
            f7 = f;
            canvas3 = canvas2;
        ...
        if (f8 > 0.0f) {
            float fLerp = this.fromState == 2 ? AndroidUtilities.lerp(x(f5), x(f4), f8) : x(f4);
            canvas3.save();
            canvas3.rotate(f6 * f3, this.cx, this.cy);
            drawLines(canvas3, (x(0.2452f) * f8) + fLerp, AndroidUtilities.lerp(y(0.5f), y(0.25f), f8), fLerp, y(0.5f), (x(0.2452f) * f8) + fLerp, AndroidUtilities.lerp(y(0.5f), y(f5), f8));
        ...
        if (f7 > 0.0f) {
            ...
            if (searchStateDrawable.progressStart > 0) {
                ...
                searchStateDrawable.progressRect.set(searchStateDrawable.x(0.25f), searchStateDrawable.y(0.25f), searchStateDrawable.x(f5), searchStateDrawable.y(f5));
