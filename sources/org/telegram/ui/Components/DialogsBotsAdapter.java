...
public class DialogsBotsAdapter extends UniversalAdapter {
    ...
    public /* synthetic */ void lambda$new$2(Theme.ResourcesProvider resourcesProvider, final Context context) {
        ...
        SpannableStringBuilder spannableStringBuilderReplaceTags = AndroidUtilities.replaceTags(AndroidUtilities.replaceLinks(LocaleController.getString(R.string.AppsTabInfoText), resourcesProvider, new Runnable() { // from class: org.telegram.ui.Components.DialogsBotsAdapter$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        if (!TextUtils.isEmpty(this.query)) {
            ...
            if (!arrayList2.isEmpty()) {
                if (arrayList2.size() <= 5 || this.searchMessages.isEmpty() || this.showOnlyPopular) {
                    ...
                    arrayList.add(UItem.asGraySection(LocaleController.getString(R.string.SearchApps), LocaleController.getString(this.expandedSearchBots ? R.string.ShowLess : R.string.ShowMore), new View.OnClickListener() { // from class: org.telegram.ui.Components.DialogsBotsAdapter$$ExternalSyntheticLambda5
        ...
        if (!arrayList5.isEmpty() && !this.showOnlyPopular) {
            if (arrayList5.size() > 5) {
                arrayList.add(UItem.asGraySection(LocaleController.getString(R.string.SearchAppsMine), LocaleController.getString(this.expandedMyBots ? R.string.ShowLess : R.string.ShowMore), new View.OnClickListener() { // from class: org.telegram.ui.Components.DialogsBotsAdapter$$ExternalSyntheticLambda6
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
        ...
        */
        public /* synthetic */ void lambda$loadCache$1(org.telegram.messenger.MessagesStorage r18, final java.lang.Runnable r19) throws java.lang.Throwable {
            ...
            L67:
                ...
                if (r15 == 0) goto L7f
                r16 = r6
                long r5 = r15.id     // Catch: java.lang.Throwable -> L3a java.lang.Exception -> L7c
