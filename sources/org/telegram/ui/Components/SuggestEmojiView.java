...
public class SuggestEmojiView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    class AnonymousClass1 implements ContentPreviewViewer.ContentPreviewViewerDelegate {
        ...
        public void setAsBadge(final TLRPC.Document document) {
                    ...
                    BadgesController.INSTANCE.updateBadge(badge, new Consumer() { // from class: org.telegram.ui.Components.SuggestEmojiView$1$$ExternalSyntheticLambda4
                        ...
                        public final void v(Object obj) {
                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.SuggestEmojiView$1$$ExternalSyntheticLambda5
                                @Override // java.lang.Runnable
                                public final void run() {
                                    SuggestEmojiView.AnonymousClass1.$r8$lambda$2whgXLzBqz4yP9CNbNBbP88YKH4(str, baseFragment);
                                }
                            });
                        }
            ...
            badgesController.updateBadge(new BadgeDTO(document.id, badge != null ? badge.getText() : null), new Consumer() { // from class: org.telegram.ui.Components.SuggestEmojiView$1$$ExternalSyntheticLambda1
                @Override // java.util.function.Consumer
                /* JADX INFO: renamed from: accept */
                public final void v(Object obj) {
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.SuggestEmojiView$1$$ExternalSyntheticLambda3
                        @Override // java.lang.Runnable
                        public final void run() {
                            SuggestEmojiView.AnonymousClass1.$r8$lambda$7poGLY6Q4YTEAgwqJr6NoecHU9k(str, baseFragment, document, runnable);
                        }
                    });
                }
        ...
        public static /* synthetic */ void $r8$lambda$7poGLY6Q4YTEAgwqJr6NoecHU9k(String str, BaseFragment baseFragment, TLRPC.Document document, Runnable runnable) {
            if (str == null || !str.equals("ok")) {
                ...
                BulletinFactory.of(baseFragment).createEmojiBulletin(document, LocaleController.getString(R.string.SetAsBadgeStatusInfo), LocaleController.getString(R.string.UndoNoCaps), runnable).show();
            }
        }
    ...
    private void createListView() {
        ...
        AnonymousClass2 anonymousClass2 = new FrameLayout(getContext()) { // from class: org.telegram.ui.Components.SuggestEmojiView.2
        ...
        AnonymousClass3 anonymousClass3 = new RecyclerListView(getContext()) { // from class: org.telegram.ui.Components.SuggestEmojiView.3
        ...
        anonymousClass3.setAdapter(adapter);
