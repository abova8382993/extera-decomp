...
public class ChatActivityEnterViewAnimatedIconView extends RLottieImageView {
    ...
    private static final class TransitState {
        ...
        static {
            ...
            VOICE_TO_VIDEO = new TransitState("VOICE_TO_VIDEO", 0, state, state2, R.raw.voice_and_video);
            ...
            VIDEO_TO_VOICE = new TransitState("VIDEO_TO_VOICE", 3, state2, state, R.raw.voice_and_video);
