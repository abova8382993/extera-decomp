...
public class CircularProgressDrawable extends Drawable implements Drawable.Callback {
    ...
    private void updateM3Bounds(android.graphics.Rect rect) {
    ...
    private void updateCircularBounds(android.graphics.Rect rect) {
    ...
    public void setWavyValues(float f, float f2, float f3) {
        this.circularIndicatorSpec.waveAmplitude = AndroidUtilities.dp(f);
