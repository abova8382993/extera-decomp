...
public class AnimatedEmojiEffect {
    ...
    public void setView(View view) {
        ...
        if (z) {
            ...
            this.effectImageReceiver.setImageBitmap(new RLottieDrawable(R.raw.custom_emoji_reaction, _UrlKt.FRAGMENT_ENCODE_SET + R.raw.custom_emoji_reaction, AndroidUtilities.dp(60.0f), AndroidUtilities.dp(60.0f), false, null));
        }
    }
