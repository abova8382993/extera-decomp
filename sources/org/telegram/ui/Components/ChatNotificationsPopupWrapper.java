...
public class ChatNotificationsPopupWrapper {
            ...
            public final void didSelectDate(boolean z, int i2, int i3) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.ChatNotificationsPopupWrapper$$ExternalSyntheticLambda11
                    ...
                    public final void run() {
                        ChatNotificationsPopupWrapper.m7640$r8$lambda$jhiS2GRG2Zdjm9uB5JrzKUjxx0(i2, i, callback);
                    }
                }, 16L);
            }
        });
    ...
    public static /* synthetic */ void m7640$r8$lambda$jhiS2GRG2Zdjm9uB5JrzKUjxx0(int i, int i2, Callback callback) {
        if (i != 0) {
    ...
    public ChatNotificationsPopupWrapper(final Context context, final int i, final PopupSwipeBackLayout popupSwipeBackLayout, boolean z, boolean z2, final Callback callback, final Theme.ResourcesProvider resourcesProvider) {
        ...
        this.isProfile = z2;
        AnonymousClass1 anonymousClass1 = new ActionBarPopupWindow.ActionBarPopupWindowLayout(context, z ? R.drawable.popup_fixed_alert : 0, resourcesProvider) { // from class: org.telegram.ui.Components.ChatNotificationsPopupWrapper.1
            Path path = new Path();
        ...
        if (popupSwipeBackLayout != null) {
            ActionBarMenuSubItem actionBarMenuSubItemAddItem = ActionBarMenuItem.addItem(this.windowLayout, R.drawable.msg_arrow_back, LocaleController.getString(R.string.Back), false, resourcesProvider2);
        ...
        ActionBarMenuSubItem actionBarMenuSubItemAddItem2 = ActionBarMenuItem.addItem(this.windowLayout, R.drawable.msg_tone_on, LocaleController.getString(R.string.SoundOn), false, resourcesProvider2);
        ...
        ActionBarMenuSubItem actionBarMenuSubItemAddItem3 = ActionBarMenuItem.addItem(this.windowLayout, R.drawable.msg_mute_1h, LocaleController.getString(R.string.MuteFor1h), false, resourcesProvider2);
        ...
        ActionBarMenuSubItem actionBarMenuSubItemAddItem4 = ActionBarMenuItem.addItem(this.windowLayout, R.drawable.msg_mute_1h, LocaleController.getString(R.string.MuteFor1h), false, resourcesProvider2);
    ...
    public static ItemOptions addAsItemOptions(final BaseFragment baseFragment, final ItemOptions itemOptions, final long j, final long j2) {
        ...
        itemOptionsMakeSwipeback.add(R.drawable.msg_arrow_back, LocaleController.getString(R.string.Back), new ChatActivity$$ExternalSyntheticLambda266(itemOptions));
                ...
                AlertsCreator.createMuteForPickerDialog(itemOptions.getContext(), resourceProvider, new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.telegram.ui.Components.ChatNotificationsPopupWrapper$$ExternalSyntheticLambda18
                    ...
                    public final void didSelectDate(boolean z, int i, int i2) {
                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.ChatNotificationsPopupWrapper$$ExternalSyntheticLambda19
                            @Override // java.lang.Runnable
                            public final void run() {
                                ChatNotificationsPopupWrapper.m7636$r8$lambda$2E5Qdzb2TlshZLi5DNrMyDRQJs(i, i, callback);
                            }
                        }, 16L);
                    }
                });
        ...
        new Runnable() { // from class: org.telegram.ui.Components.ChatNotificationsPopupWrapper$$ExternalSyntheticLambda17
            @Override // java.lang.Runnable
            public final void run() {
                ChatNotificationsPopupWrapper.m7641$r8$lambda$jslqYv3H4CQpj7lsolTF0FqDk4(currentAccount, j, j2, last2, last);
            }
        }.run();
    ...
    public static /* synthetic */ void m7636$r8$lambda$2E5Qdzb2TlshZLi5DNrMyDRQJs(int i, int i2, Utilities.Callback callback) {
        if (i != 0) {
            SharedPreferences notificationsSettings = MessagesController.getNotificationsSettings(i2);
            notificationsSettings.edit().putInt("last_selected_mute_until_time", i).putInt("last_selected_mute_until_time2", notificationsSettings.getInt("last_selected_mute_until_time", 0)).apply();
        }
    ...
    public static /* synthetic */ void m7641$r8$lambda$jslqYv3H4CQpj7lsolTF0FqDk4(int i, long j, long j2, ActionBarMenuSubItem actionBarMenuSubItem, ActionBarMenuSubItem actionBarMenuSubItem2) {
        int color;
        if (MessagesController.getInstance(i).isDialogMuted(j, j2)) {
