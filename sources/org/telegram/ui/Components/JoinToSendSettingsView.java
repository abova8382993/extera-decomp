...
public class JoinToSendSettingsView extends LinearLayout {
    ...
    /* JADX INFO: renamed from: setJoinRequest */
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.JoinToSendSettingsView$1 */
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.joinRequestCell.getVisibility() == 0) {
            iDp = iLayoutChild + layoutChild(this.joinRequestCell, iLayoutChild, i5);
        } else {
            ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) this.joinRequestCell.getLayoutParams();
            iDp = iLayoutChild + AndroidUtilities.dp(50.0f) + marginLayoutParams.topMargin + marginLayoutParams.bottomMargin;
        }
        layoutChild(this.joinToSendInfoCell, iDp, i5);
        layoutChild(this.joinRequestInfoCell, iDp, i5);
    }
