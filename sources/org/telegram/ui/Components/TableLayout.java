        ...
        */
        public void measure(int r2, int r3, boolean r4) {
            ...
            L18:
                ...
                int r2 = org.telegram.ui.Components.TableLayout.m10726$$Nest$fgetitemPaddingTop(r2)
                int r3 = r3 - r2
                r1.textY = r3
                goto L31
            L29:
            ...
            L4a:
                org.telegram.ui.Components.TableLayout r2 = org.telegram.ui.Components.TableLayout.this
                org.telegram.ui.Components.TableLayout$TableLayoutDelegate r2 = org.telegram.ui.Components.TableLayout.m10722$$Nest$fgetdelegate(r2)
                ...
                int r0 = org.telegram.ui.Components.TableLayout.m10725$$Nest$fgetitemPaddingLeft(r0)
                int r0 = r0 * 2
                int r4 = r4 - r0
                ...
                int r3 = org.telegram.ui.Components.TableLayout.m10726$$Nest$fgetitemPaddingTop(r3)
                int r3 = r3 * 2
                int r2 = r2 + r3
                r1.fixedHeight = r2
            L71:
                ...
                int r4 = org.telegram.ui.Components.TableLayout.m10725$$Nest$fgetitemPaddingLeft(r4)
                int r3 = r3 - r4
                int r2 = r2 + r3
                r1.textX = r2
                return
            ...
            La2:
                org.telegram.ui.Components.TableLayout r3 = org.telegram.ui.Components.TableLayout.this
                int r3 = org.telegram.ui.Components.TableLayout.m10725$$Nest$fgetitemPaddingLeft(r3)
                int r2 = r2 + r3
                r1.textX = r2
                return
            Lac:
                org.telegram.ui.Components.TableLayout r2 = org.telegram.ui.Components.TableLayout.this
                int r2 = org.telegram.ui.Components.TableLayout.m10725$$Nest$fgetitemPaddingLeft(r2)
                r1.textX = r2
            Lb4:
                return
            */
        ...
        public void draw(Canvas canvas, View view) {
            ...
            if (this.cell.header || (TableLayout.this.isStriped && this.layoutParams.rowSpec.span.min % 2 == 0)) {
                ...
                if (z2) {
                    TableLayout.this.rect.set(this.x, this.y, r3 + this.measuredWidth, r5 + this.measuredHeight);
                    ...
                    canvas2.drawRect(this.x, this.y, r2 + this.measuredWidth, r4 + this.measuredHeight, TableLayout.this.delegate.getHeaderPaint());
                    canvas2 = canvas;
                } else {
                    canvas2 = canvas;
                    canvas2.drawRect(this.x, this.y, r1 + this.measuredWidth, r3 + this.measuredHeight, TableLayout.this.delegate.getStripPaint());
                }
            }
            ...
            if (TableLayout.this.drawLines) {
                ...
                if (i2 == 0) {
                    ...
                    paint = linePaint;
                    paint2 = linePaint2;
                    canvas.drawLine(i2 - strokeWidth2, this.y, i2 - strokeWidth2, r3 + this.measuredHeight, paint2);
                }
                int i5 = this.y;
                if (i5 == 0) {
                    int i6 = this.x;
                    ...
                    canvas.drawLine(this.x, i5 - strokeWidth2, r2 + this.measuredWidth, i5 - strokeWidth2, paint2);
                }
                float f11 = (z3 && (i = this.y) == 0) ? i + iDp : this.y - strokeWidth;
                if (z3 && z4) {
                ...
                int i10 = this.x;
                float f13 = (i10 == 0 && z4) ? i10 + iDp : i10 - strokeWidth;
                if (z3 && z4) {
