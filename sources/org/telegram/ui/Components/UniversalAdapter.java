...
public class UniversalAdapter extends AdapterWithDiffUtils {
    ...
    /* JADX WARN: Removed duplicated region for block: B:29:0x0033 A[FALL_THROUGH, RETURN] */
    /*
    ...
    */
    public boolean shouldApplyBackground(int r4) {
        /*
            ...
            return r1
        L6:
            int r0 = org.telegram.ui.Components.UItem.factoryViewTypeStartsWith
            r2 = 1
            if (r4 < r0) goto Lc
            return r2
        Lc:
        ...
        L33:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.UniversalAdapter.shouldApplyBackground(int):boolean");
    }
