...
public class DownloadsInfoBottomSheet extends BottomSheet {
    ...
    public DownloadsInfoBottomSheet(Context context, final BaseFragment baseFragment, boolean z) {
        ...
        textView3.setBackground(Theme.createSimpleSelectorRoundRectDrawable(iDp2, Theme.getColor(i3), ColorUtils.setAlphaComponent(Theme.getColor(i), Opcodes.ISHL)));
        ...
        textView4.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.dp(8.0f), 0, ColorUtils.setAlphaComponent(Theme.getColor(i3), Opcodes.ISHL)));
