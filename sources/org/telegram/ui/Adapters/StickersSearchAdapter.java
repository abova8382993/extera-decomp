...
public class StickersSearchAdapter extends RecyclerListView.SelectionAdapter {
    ...
    class AnonymousClass2 extends StickerEmojiCell {
        ...
        public void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(82.0f), TLObject.FLAG_30));
        }
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        if (i == 0) {
            AnonymousClass2 anonymousClass2 = new StickerEmojiCell(this.context, false, this.resourcesProvider) { // from class: org.telegram.ui.Adapters.StickersSearchAdapter.2
                AnonymousClass2(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
                    super(context, z, resourcesProvider);
                }
