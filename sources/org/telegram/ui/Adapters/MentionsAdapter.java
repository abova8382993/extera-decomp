...
public class MentionsAdapter extends RecyclerListView.SelectionAdapter implements NotificationCenter.NotificationCenterDelegate {
    ...
    class AnonymousClass1 implements SendMessagesHelper.LocationProvider.LocationProviderDelegate {
        AnonymousClass1() {
        }
    ...
    class AnonymousClass2 extends SendMessagesHelper.LocationProvider {
        AnonymousClass2(SendMessagesHelper.LocationProvider.LocationProviderDelegate locationProviderDelegate) {
            super(locationProviderDelegate);
        }
    ...
    class AnonymousClass3 implements SearchAdapterHelper.SearchAdapterHelperDelegate {
        @Override // org.telegram.ui.Adapters.SearchAdapterHelper.SearchAdapterHelperDelegate
        public /* synthetic */ boolean canApplySearchResults(int i) {
            return SearchAdapterHelper.SearchAdapterHelperDelegate.CC.$default$canApplySearchResults(this, i);
        }
  ...
  0x06ed: PHI (r22v7 boolean) = (r22v6 boolean), (r22v6 boolean), (r22v6 boolean), (r22v8 boolean) binds: [B:1071:0x06eb, B:1068:0x06db, B:1064:0x06cb, B:1058:0x06b8] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    class AnonymousClass5 implements Comparator {
        ...
        private int getIndex(StickerResult stickerResult) {
            for (int i = 0; i < arrayList.size(); i++) {
                if (((TLRPC.Document) arrayList.get(i)).id == stickerResult.sticker.id) {
                    return i + 2000000;
                }
            }
            for (int i2 = 0; i2 < Math.min(20, arrayList.size()); i2++) {
                if (((TLRPC.Document) arrayList.get(i2)).id == stickerResult.sticker.id) {
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class AnonymousClass6 implements Comparator {
        final /* synthetic */ LongSparseArray val$newMap;
        final /* synthetic */ ArrayList val$users;

        AnonymousClass6(LongSparseArray longSparseArray, ArrayList arrayList) {
    ...
    class AnonymousClass8 extends View {
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(8.0f), TLObject.FLAG_30));
        }
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        if (i == 0) {
            ...
            if (i == 3) {
                ...
                View anonymousClass8 = new View(this.mContext) { // from class: org.telegram.ui.Adapters.MentionsAdapter.8
                    AnonymousClass8(Context context) {
                        super(context);
                    }
                ...
                anonymousClass8.setBackground(combinedDrawable);
    ...
    public void doSomeStickersAction() {
        ...
        if (isStickers()) {
            if (this.mentionsStickersActionTracker == null) {
                ...
                AnonymousClass9 anonymousClass9 = new EmojiView.ChooseStickerActionTracker(this.currentAccount, this.dialog_id, this.threadMessageId) { // from class: org.telegram.ui.Adapters.MentionsAdapter.9
                    AnonymousClass9(int i, long j, long j2) {
                        super(i, j, j2);
                    }
                ...
                mentionsAdapter.mentionsStickersActionTracker = anonymousClass9;
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class AnonymousClass9 extends EmojiView.ChooseStickerActionTracker {
        AnonymousClass9(int i, long j, long j2) {
            super(i, j, j2);
        }
