...
public class GroupCallActivity extends BottomSheet implements NotificationCenter.NotificationCenterDelegate, VoIPService.StateListener, FactorAnimator.Target {
    ...
    public static /* synthetic */ void m12437$r8$lambda$_YrqkqkohdH6mXwgsnpz0Pkz9U() {
    ...
    */
    ...
    protected void makeFocusable(final BottomSheet bottomSheet, final AlertDialog alertDialog, final EditTextBoldCursor editTextBoldCursor, final boolean z) {
        ...
        if (z) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.GroupCallActivity$$ExternalSyntheticLambda51
                @Override // java.lang.Runnable
                public final void run() {
                    GroupCallActivity.m12424$r8$lambda$93eSzpgS8XVzTm6hjP7Nm8Wk7U(editTextBoldCursor);
                }
            }, 100L);
        }
    }
    ...
    public static /* synthetic */ void m12424$r8$lambda$93eSzpgS8XVzTm6hjP7Nm8Wk7U(EditTextBoldCursor editTextBoldCursor) {
        editTextBoldCursor.requestFocus();
        AndroidUtilities.showKeyboard(editTextBoldCursor);
    }
    ...
    private GroupCallActivity(final Activity activity, final AccountInstance accountInstance, final ChatObject.Call call, final TLRPC.Chat chat, TLRPC.InputPeer inputPeer, boolean z, String str) {
        ...
        this.unmuteRunnable = new Runnable() { // from class: org.telegram.ui.GroupCallActivity$$ExternalSyntheticLambda28
            @Override // java.lang.Runnable
            public final void run() {
                GroupCallActivity.m12437$r8$lambda$_YrqkqkohdH6mXwgsnpz0Pkz9U();
            }
        };
            ...
            */
            protected void dispatchDraw(android.graphics.Canvas r21) {
                /*
                    ...
                    To view this dump change 'Code comments level' option to 'DEBUG'
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.GroupCallActivity.AnonymousClass7.dispatchDraw(android.graphics.Canvas):void");
            }
        ...
        int i8 = R.drawable.filled_sound_on;
        ...
        for (int i10 = 0; i10 < 2; i10++) {
            ...
            groupCallActivity.undoView[i10].setAdditionalTranslationY(AndroidUtilities.dp(10.0f));
            groupCallActivity.undoView[i10].setTranslationZ(AndroidUtilities.dp(5.0f));
        ...
        int i14 = R.drawable.msg_cancel;
        if (groupCallActivity.isConference()) {
            i2 = i13;
            string = LocaleController.getString(R.string.VoipGroupEndConference);
        } else {
            string = LocaleController.getString(ChatObject.isChannelOrGiga(groupCallActivity.currentChat) ? R.string.VoipChannelEndChat : R.string.VoipGroupEndChat);
            i2 = i13;
        }
            ...
            protected void dispatchDraw(Canvas canvas) {
                if (GroupCallActivity.this.progressToAvatarPreview != 1.0f) {
                    if (GroupCallActivity.this.scrimView != null && GroupCallActivity.this.hasScrimAnchorView) {
                        ...
                        GroupCallActivity.this.scrimView.getAvatarImageView().setRoundRadius(iDp, iDp, i16, i16);
                        ...
                        GroupCallActivity.this.scrimFullscreenView.getAvatarImageView().setRoundRadius(iDp2, iDp2, i17, i17);
    ...
    class AnonymousClass6 extends ActionBar.ActionBarMenuOnItemClick {
        ...
        public static /* synthetic */ void m12678$r8$lambda$t6jC1WSfURy5tDSUywPpDZ0crs(TLObject tLObject, TLRPC.TL_error tL_error) {
        }
            ...
            if (GroupCallActivity.this.call.isScheduled()) {
                ...
                GroupCallActivity.this.accountInstance.getConnectionsManager().sendRequest(savedefaultgroupcalljoinas, new RequestDelegate() { // from class: org.telegram.ui.GroupCallActivity$6$$ExternalSyntheticLambda11
                    ...
                    public final void run(TLObject tLObject2, TLRPC.TL_error tL_error) {
                        GroupCallActivity.AnonymousClass6.m12678$r8$lambda$t6jC1WSfURy5tDSUywPpDZ0crs(tLObject2, tL_error);
                    }
                });
        ...
        */
        public void onClick(android.view.View r14) {
            /*
                ...
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.GroupCallActivity.AnonymousClass19.onClick(android.view.View):void");
        }
    ...
    */
    private void openShareAlert(boolean r14, java.lang.String r15, java.lang.String r16, boolean r17) {
        ...
        L2b:
            ...
            boolean r6 = r3 instanceof org.telegram.ui.ChatActivity
            if (r6 == 0) goto L5e
