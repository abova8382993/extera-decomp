...
public class PrivacySettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ void m14962$r8$lambda$DPP8PtFalvDYsSlbRJJHb1FeA(TLObject tLObject, TLRPC.TL_error tL_error) {
    }
    ...
    */
        ...
        if (view.isEnabled()) {
            ...
            if (i == this.passkeysRow) {
                ...
                if (password4 == null || !password4.has_password) {
                    BulletinFactory.of(this).createSimpleBulletin(R.raw.chats_infotip, AndroidUtilities.replaceTags(LocaleController.getString(R.string.PaymentCardSavePaymentInformationInfoLine2).replace("*", "**")), LocaleController.getString(R.string.Enable), new Runnable() { // from class: org.telegram.ui.PrivacySettingsActivity$$ExternalSyntheticLambda11
            ...
            if (i == this.contactsDeleteRow) {
                ...
                builder2.setPositiveButton(LocaleController.getString("Delete", R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.PrivacySettingsActivity$$ExternalSyntheticLambda12
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                    public final void onClick(AlertDialog alertDialog, int i5) {
            ...
            if (i == this.contactsSuggestRow) {
                ...
                if (this.newSuggest) {
                    ...
                    builder3.setPositiveButton(LocaleController.getString("MuteDisable", R.string.MuteDisable), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.PrivacySettingsActivity$$ExternalSyntheticLambda13
                        @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                        public final void onClick(AlertDialog alertDialog, int i5) {
            ...
            if (i == this.paymentsClearRow) {
                ...
                builder4.setPositiveButton(LocaleController.getString("ClearButton", R.string.ClearButton), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.PrivacySettingsActivity$$ExternalSyntheticLambda16
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
    ...
    public /* synthetic */ void lambda$createView$18(AlertDialog alertDialog, int i) {
        ...
        getConnectionsManager().sendRequest(tL_payments_clearSavedInfo, new RequestDelegate() { // from class: org.telegram.ui.PrivacySettingsActivity$$ExternalSyntheticLambda24
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                PrivacySettingsActivity.m14962$r8$lambda$DPP8PtFalvDYsSlbRJJHb1FeA(tLObject, tL_error);
            }
        });
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (i == PrivacySettingsActivity.this.webSessionsRow) {
                    ...
                    if (i == PrivacySettingsActivity.this.groupsRow) {
                        ...
                        textSettingsCell.setTextAndValue(PrivacySettingsActivity.addPremiumStar(LocaleController.getString(R.string.PrivacyVoiceMessages)), pluralString, PrivacySettingsActivity.this.noncontactsRow != -1);
            ...
            if (i == PrivacySettingsActivity.this.autoDeleteMesages) {
                ...
                if (i == i6) {
                    ...
                    textCell.setTextAndValueAndIcon(LocaleController.getString(R.string.TwoStepVerification), str3, true, i3, true);
                    ...
                    textCell.setTextAndValueAndIcon(LocaleController.getString(R.string.Passcode), string3, true, i2, true);
    ...
    public static CharSequence addPremiumStar(String str) {
        if (premiumStar == null) {
            ...
            AnimatedEmojiDrawable.WrapSizeDrawable wrapSizeDrawable = new AnimatedEmojiDrawable.WrapSizeDrawable(PremiumGradient.getInstance().premiumStarMenuDrawable, AndroidUtilities.dp(16.0f), AndroidUtilities.dp(16.0f));
            wrapSizeDrawable.setBounds(0, 0, AndroidUtilities.dp(16.0f), AndroidUtilities.dp(16.0f));
