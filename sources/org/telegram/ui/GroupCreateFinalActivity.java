...
public class GroupCreateFinalActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, ImageUpdater.ImageUpdaterDelegate {
    ...
    */
    ...
    public View createView(Context context) {
        ...
        AnonymousClass2 anonymousClass2 = new SizeNotifierFrameLayout(context) { // from class: org.telegram.ui.GroupCreateFinalActivity.2
        ...
        this.shadowDrawable = context2.getResources().getDrawable(R.drawable.greydivider_top).mutate();
        AnonymousClass3 anonymousClass3 = new LinearLayout(context2) { // from class: org.telegram.ui.GroupCreateFinalActivity.3
        ...
        anonymousClass3.addView(this.editTextContainer, LayoutHelper.createLinear(-1, -2, 9.0f, 0.0f, 9.0f, 0.0f));
        AnonymousClass4 anonymousClass4 = new BackupImageView(context2) { // from class: org.telegram.ui.GroupCreateFinalActivity.4
        ...
        anonymousClass4.setRoundRadius(ExteraConfig.getAvatarCorners(56.0f, false, this.chatType == 5));
        ...
        AnonymousClass5 anonymousClass5 = new View(context2) { // from class: org.telegram.ui.GroupCreateFinalActivity.5
            final /* synthetic */ Paint val$paint;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            AnonymousClass5(Context context2, Paint paint2) {
                super(context2);
                paint = paint2;
            }
        ...
        frameLayout3.addView(anonymousClass5, LayoutHelper.createFrame(56, 56.0f, (z2 ? 5 : 3) | 48, z2 ? 0.0f : 24.0f, 20.0f, z2 ? 24.0f : 0.0f, 12.0f));
        ...
        this.cameraDrawable = new RLottieDrawable(R.raw.camera, _UrlKt.FRAGMENT_ENCODE_SET + R.raw.camera, AndroidUtilities.dp(52.0f), AndroidUtilities.dp(52.0f), false, null);
        AnonymousClass6 anonymousClass6 = new RLottieImageView(context2) { // from class: org.telegram.ui.GroupCreateFinalActivity.6
        ...
        AnonymousClass7 anonymousClass7 = new RadialProgressView(context2) { // from class: org.telegram.ui.GroupCreateFinalActivity.7
        ...
        EditTextEmoji editTextEmoji2 = new EditTextEmoji(context2, anonymousClass2, this, 0, false);
    ...
    class AnonymousClass9 implements AutoDeletePopupWrapper.Callback {
        @Override // org.telegram.ui.Components.AutoDeletePopupWrapper.Callback
        public /* synthetic */ void showGlobalAutoDeleteScreen() {
            AutoDeletePopupWrapper.Callback.CC.$default$showGlobalAutoDeleteScreen(this);
        }
