        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (((Item) SaveToGallerySettingsActivity.this.items.get(i)).viewType == 6) {
                ...
                if (i == SaveToGallerySettingsActivity.this.savePhotosRow) {
                    ...
                    textCheckCell.setColorfullIcon(saveToGallerySettingsActivity.getThemedColor(i2), R.drawable.msg_filled_data_photos);
                    textCheckCell.setColorfullIcon(SaveToGallerySettingsActivity.this.getThemedColor(i2), R.drawable.msg_filled_data_photos);
                    return;
                }
