...
public class PassportActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        if (this.currentActivityType == 7) {
            AnonymousClass4 anonymousClass4 = new ScrollView(context) { // from class: org.telegram.ui.PassportActivity.4
            ...
            AnonymousClass5 anonymousClass5 = new ScrollView(context2) { // from class: org.telegram.ui.PassportActivity.5
                @Override // android.widget.ScrollView, android.view.ViewGroup
                protected boolean onRequestFocusInDescendants(int i, Rect rect) {
                    return false;
                }
    ...
    public /* synthetic */ void lambda$createPasswordInterface$9(TLRPC.TL_error tL_error, TLObject tLObject) {
        ...
        if (tL_error == null) {
            ...
            builder.setPositiveButton(LocaleController.getString(R.string.OK), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.PassportActivity$$ExternalSyntheticLambda72
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i) {
    ...
    */
    public /* synthetic */ void lambda$onPasswordDone$13(boolean r10, java.lang.String r11) {
        ...
        L24:
            ...
            boolean r2 = r11 instanceof org.telegram.tgnet.TLRPC.TL_passwordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow
            if (r2 == 0) goto L67
            org.telegram.tgnet.TLRPC$TL_passwordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow r11 = (org.telegram.tgnet.TLRPC.TL_passwordKdfAlgoSHA256SHA256PBKDF2HMACSHA512iter100000SHA256ModPow) r11
            long r7 = r10.srp_id
            byte[] r10 = r10.srp_B
    ...
    */
    ...
    class AnonymousClass11 extends FrameLayout {
        ...
        AnonymousClass11(Context context, EditTextBoldCursor editTextBoldCursor) {
            super(context);
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (errorLayout != null) {
                ...
                int i3 = 0;
                if (lineCount > 1) {
                    i2 = View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(64.0f) + (this.errorLayout.getLineBottom(lineCount - 1) - this.errorLayout.getLineBottom(0)), TLObject.FLAG_30);
                }
    ...
    private void createDocumentDeleteAlert() {
        ...
        if (!this.documentOnly && this.currentDocumentsType != null) {
            ...
            if (secureValueType instanceof TLRPC.TL_secureValueTypeAddress) {
                checkBoxCell.setText(LocaleController.getString(R.string.PassportDeleteDocumentAddress), _UrlKt.FRAGMENT_ENCODE_SET, true, false);
            } else if (secureValueType instanceof TLRPC.TL_secureValueTypePersonalDetails) {
                checkBoxCell.setText(LocaleController.getString(R.string.PassportDeleteDocumentPersonal), _UrlKt.FRAGMENT_ENCODE_SET, true, false);
            }
    ...
    */
    ...
    class AnonymousClass14 implements CameraScanActivity.CameraScanActivityDelegate {
        @Override // org.telegram.ui.CameraScanActivity.CameraScanActivityDelegate
        public /* synthetic */ void didFindQr(String str) {
            CameraScanActivity.CameraScanActivityDelegate.CC.$default$didFindQr(this, str);
        }
    ...
    class AnonymousClass15 extends FrameLayout {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass15(Context context, EditTextBoldCursor editTextBoldCursor) {
            super(context);
            editTextBoldCursor = editTextBoldCursor;
        }
    ...
    class AnonymousClass17 implements TextWatcher {
        ...
        AnonymousClass17(EditTextBoldCursor editTextBoldCursor, String str, HashMap map) {
            editTextBoldCursor = editTextBoldCursor;
            str = str;
            map = map;
        }
    ...
    class AnonymousClass18 extends FrameLayout {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass18(Context context, EditTextBoldCursor editTextBoldCursor) {
            super(context);
            editTextBoldCursor = editTextBoldCursor;
        }
    ...
    */
    ...
    public /* synthetic */ boolean lambda$addDocumentView$57(final int i, final SecureDocument secureDocument, final SecureDocumentCell secureDocumentCell, final String str, View view) {
        ...
        builder.setNegativeButton(LocaleController.getString(R.string.Cancel), null);
        builder.setTitle(LocaleController.getString(R.string.AppName));
        builder.setPositiveButton(LocaleController.getString(R.string.OK), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.PassportActivity$$ExternalSyntheticLambda64
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i2) {
    ...
    */
    ...
    class AnonymousClass20 implements PassportActivityDelegate {
        ...
        AnonymousClass20(TLRPC.SecureValueType secureValueType, boolean z, int i) {
                            ...
                            while (i6 < size2) {
                                ...
                                if (secureFile instanceof TLRPC.TL_secureFile) {
                                    ...
                                    if (Utilities.arraysEquals(secureDocument4.fileSecret, 0, tL_secureFile.secret, 0)) {
                                        AnonymousClass20.this.renameFile(secureDocument4, tL_secureFile);
                                        break;
                                    }
                                } else {
                                    i3 = i5;
                ...
                if (secureDocument != null && secureDocument.inputFile != null) {
                    ...
                    if (secureFile2 instanceof TLRPC.TL_secureFile) {
                        ...
                        if (Utilities.arraysEquals(secureDocument.fileSecret, 0, tL_secureFile2.secret, 0)) {
                            AnonymousClass20.this.renameFile(secureDocument, tL_secureFile2);
                        }
                    }
                }
                if (secureDocument2 != null && secureDocument2.inputFile != null) {
                    ...
                    if (secureFile3 instanceof TLRPC.TL_secureFile) {
                        ...
                        if (Utilities.arraysEquals(secureDocument2.fileSecret, 0, tL_secureFile3.secret, 0)) {
                            AnonymousClass20.this.renameFile(secureDocument2, tL_secureFile3);
                        }
                    }
                }
                if (secureDocument3 != null && secureDocument3.inputFile != null) {
                    ...
                    if (secureFile4 instanceof TLRPC.TL_secureFile) {
                        ...
                        if (Utilities.arraysEquals(secureDocument3.fileSecret, 0, tL_secureFile4.secret, 0)) {
                            AnonymousClass20.this.renameFile(secureDocument3, tL_secureFile4);
                        }
                    }
                }
                if (arrayList2 != null && !arrayList2.isEmpty()) {
                            ...
                            for (int i8 = 0; i8 < size4; i8++) {
                                ...
                                if (secureFile5 instanceof TLRPC.TL_secureFile) {
                                    ...
                                    if (Utilities.arraysEquals(secureDocument5.fileSecret, 0, tL_secureFile5.secret, 0)) {
                                        AnonymousClass20.this.renameFile(secureDocument5, tL_secureFile5);
                                        break;
                                    }
                                }
                            }
    ...
    */
    ...
    public /* synthetic */ void lambda$addField$64(final ArrayList arrayList, final TLRPC.TL_secureRequiredType tL_secureRequiredType, final boolean z, View view) {
        ...
        if ((secureValueType instanceof TLRPC.TL_secureValueTypePersonalDetails) || (secureValueType instanceof TLRPC.TL_secureValueTypeAddress)) {
            ...
            if ((z2 || (secureValueType instanceof TLRPC.TL_secureValueTypeEmail)) && getValueByType(tL_secureRequiredType, false) != null) {
                ...
                builder2.setPositiveButton(LocaleController.getString(R.string.OK), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.PassportActivity$$ExternalSyntheticLambda67
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
    ...
    public void setPage(int i, boolean z, Bundle bundle) {
        ...
        if (z) {
            ...
            animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.PassportActivity.23
                ...
                AnonymousClass23(SlideView slideView22, SlideView slideView3) {
    ...
    public boolean checkDiscard(boolean z) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
        builder.setPositiveButton(LocaleController.getString(R.string.PassportDiscard), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.PassportActivity$$ExternalSyntheticLambda26
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
    ...
    public /* synthetic */ void lambda$processSelectedFiles$72(ArrayList arrayList, final int i, boolean z) throws FileNotFoundException {
    ...
    public class PhoneConfirmationView extends SlideView implements NotificationCenter.NotificationCenterDelegate {
        ...
        public PhoneConfirmationView(Context context, int i) {
            ...
            AnonymousClass1 anonymousClass1 = new TextView(context) { // from class: org.telegram.ui.PassportActivity.PhoneConfirmationView.1
                final /* synthetic */ PassportActivity val$this$0;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                AnonymousClass1(Context context2, PassportActivity passportActivity) {
                    super(context2);
            ...
            anonymousClass1.setTextColor(Theme.getColor(i2));
            ...
            AnonymousClass2 anonymousClass2 = new TextView(context2) { // from class: org.telegram.ui.PassportActivity.PhoneConfirmationView.2
                final /* synthetic */ PassportActivity val$this$0;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                AnonymousClass2(Context context2, PassportActivity passportActivity) {
                    super(context2);
                    passportActivity = passportActivity;
                }
            ...
            anonymousClass2.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteBlueText4));
