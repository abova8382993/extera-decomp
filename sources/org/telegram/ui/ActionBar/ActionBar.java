    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (i6 < 2) {
            ...
            if ((simpleTextView3 == null || simpleTextView3.getVisibility() == 8) && ((simpleTextView = actionBar.subtitleTextView) == null || simpleTextView.getVisibility() == 8)) {
                ...
                if (ExteraConfig.centerTitle) {
                    measuredWidth = actionBar.getAnimatedCenterTitleAvailableWidth(actionBar.getCenteredTitleAvailableWidth(size, iDp, zShouldUseAdaptiveCenterTitle));
                } else {
                    ActionBarMenu actionBarMenu3 = actionBar.menu;
                    measuredWidth = (((size - (actionBarMenu3 != null ? actionBarMenu3.getMeasuredWidth() : 0)) - AndroidUtilities.dp(16.0f)) - iDp) - actionBar.titleRightMargin;
                }
    ...
    */
    public static int getCurrentActionBarHeight() {
        ...
        L15:
            ...
            goto L10
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.ActionBar.ActionBar.getCurrentActionBarHeight():int");
    }
    ...
    public void setUseContainerForTitles() {
        ...
        if (this.titlesContainer == null) {
            FrameLayout frameLayout = new FrameLayout(getContext()) { // from class: org.telegram.ui.ActionBar.ActionBar.11
                @Override // android.widget.FrameLayout, android.view.ViewGroup, android.view.View
    ...
    public FrameLayout createAdditionalSubTitleOverlayContainer() {
        if (this.additionalSubTitleOverlayContainer == null) {
            ActionBarAnimatedSubtitleOverlayContainer actionBarAnimatedSubtitleOverlayContainer = new ActionBarAnimatedSubtitleOverlayContainer(getContext(), this.resourcesProvider, this.ellipsizeSpanAnimator) { // from class: org.telegram.ui.ActionBar.ActionBar.12
