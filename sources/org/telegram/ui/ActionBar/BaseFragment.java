...
public abstract class BaseFragment {
    ...
    public interface AttachedSheet {
        ...
        /* JADX INFO: renamed from: org.telegram.ui.ActionBar.BaseFragment$AttachedSheet$-CC, reason: invalid class name */
        /* JADX INFO: loaded from: classes6.dex */
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.BaseFragment$1, reason: invalid class name */
    /* JADX INFO: loaded from: classes6.dex */
    class AnonymousClass1 extends BottomSheet {
        ...
        AnonymousClass1(Context context, boolean z, Theme.ResourcesProvider resourcesProvider, final BottomSheetParams bottomSheetParams, INavigationLayout[] iNavigationLayoutArr, final BaseFragment baseFragment, BottomSheet[] bottomSheetArr) {
            ...
            setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.ActionBar.BaseFragment$1$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnDismissListener
                public final void onDismiss(DialogInterface dialogInterface) {
                    BaseFragment.AnonymousClass1.$r8$lambda$Rx21TGQLU2yUDDxrvshPgjTbRus(baseFragment, bottomSheetParams, dialogInterface);
                }
            });
        }
        ...
        if (this.sheetsStack != null) {
            for (int i = 0; i < this.sheetsStack.size(); i++) {
                ...
                if (attachedSheet != null && attachedSheet.attachedToParent()) {
                    AndroidUtilities.removeFromParent(attachedSheet.mo4059getWindowView());
                    layoutContainer.addView(attachedSheet.mo4059getWindowView());
                }
            }
        }
    }
    ...
    public boolean isStoryViewer(View view) {
        if (this.sheetsStack != null) {
            for (int i = 0; i < this.sheetsStack.size(); i++) {
                AttachedSheet attachedSheet = this.sheetsStack.get(i);
                if ((attachedSheet instanceof StoryViewer) && view == attachedSheet.mo4059getWindowView()) {
                    return true;
                }
            }
        }
    ...
    */
    public org.telegram.ui.Stories.StoryViewer getOrCreateStoryViewer() {
        ...
        Lb:
            ...
            boolean r0 = r0 instanceof org.telegram.ui.Stories.StoryViewer
            if (r0 == 0) goto L31
            java.util.ArrayList<org.telegram.ui.ActionBar.BaseFragment$AttachedSheet> r0 = r3.sheetsStack
            int r2 = r0.size()
            int r2 = r2 - r1
            java.lang.Object r0 = r0.get(r2)
            org.telegram.ui.Stories.StoryViewer r0 = (org.telegram.ui.Stories.StoryViewer) r0
            goto L32
        L31:
            r0 = 0
        L32:
