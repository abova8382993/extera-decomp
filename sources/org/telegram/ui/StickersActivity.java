...
public class StickersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        AnonymousClass2 anonymousClass2 = new LinearLayoutManager(context) { // from class: org.telegram.ui.StickersActivity.2
    ...
    /* JADX INFO: renamed from: org.telegram.ui.StickersActivity$1 */
    ...
    /* JADX INFO: renamed from: org.telegram.ui.StickersActivity$2 */
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        if (this.currentType == 0) {
            ...
            int i3 = R.drawable.msg2_trending;
            String string = LocaleController.getString(R.string.FeaturedStickers);
            ...
            int i5 = R.drawable.msg2_smile_status;
        ...
        if (this.currentType == 0) {
            ...
            arrayList.add(UItem.asSettingsCell(4, R.drawable.msg2_reactions2, LocaleController.getString(R.string.DoubleTapSetting)).onBind(new Utilities.Callback() { // from class: org.telegram.ui.StickersActivity$$ExternalSyntheticLambda12
        ...
        if (this.sets.size() > 0) {
            ...
            while (i7 < size3) {
                ...
                arrayList.add(StickerSetCell.Factory.of(tL_messages_stickerSet).setClickCallback(new View.OnClickListener() { // from class: org.telegram.ui.StickersActivity$$ExternalSyntheticLambda13
        ...
        if (this.currentType == 5 && !this.featured.isEmpty()) {
            ...
            while (i < size4) {
                ...
                arrayList.add(FeaturedStickerSetCell2.Factory.of(stickerSetCovered).setClickCallback(new View.OnClickListener() { // from class: org.telegram.ui.StickersActivity$$ExternalSyntheticLambda15
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
        ...
        if (i9 == 5) {
            arrayList.add(UItem.asShadow(addStickersBotSpan(LocaleController.getString(i9 == 5 ? R.string.EmojiBotInfo : R.string.StickersBotInfo))));
        }
    }
    ...
    public void onClick(UItem uItem, final View view, int i, float f, float f2) {
        ...
        switch (uItem.id) {
            ...
            case 4:
                ...
                break;
            case 5:
                ItemOptions.makeOptions(this, view).addChecked(SharedConfig.suggestStickers == 0, LocaleController.getString(R.string.SuggestStickersAll), new Runnable() { // from class: org.telegram.ui.StickersActivity$$ExternalSyntheticLambda7
                    @Override // java.lang.Runnable
                    public final void run() {
                        StickersActivity.$r8$lambda$IqXvhUBY50Bhj0yCxfWSEqn5CRI(view);
                    }
                }).addChecked(SharedConfig.suggestStickers == 1, LocaleController.getString(R.string.SuggestStickersInstalled), new Runnable() { // from class: org.telegram.ui.StickersActivity$$ExternalSyntheticLambda8
                    @Override // java.lang.Runnable
                    public final void run() {
                        StickersActivity.$r8$lambda$8K5rbn3DXzUBLU4mUe9Ff5sQT70(view);
                    }
                }).addChecked(SharedConfig.suggestStickers == 2, LocaleController.getString(R.string.SuggestStickersNone), new Runnable() { // from class: org.telegram.ui.StickersActivity$$ExternalSyntheticLambda9
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.StickersActivity$3 */
    class AnonymousClass3 extends TrendingStickersLayout.Delegate {
        AnonymousClass3() {
        }
    ...
    /* JADX INFO: renamed from: sendReorder */
    ...
    public void openStickerSetOptions(View view) {
        ...
        ItemOptions.makeOptions(this, stickerSetCell).add(R.drawable.msg_archive, LocaleController.getString(R.string.StickersHide), new Runnable() { // from class: org.telegram.ui.StickersActivity$$ExternalSyntheticLambda17
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$openStickerSetOptions$8(stickersSet);
            }
        }).addIf(!stickersSet.set.official, R.drawable.msg_link, LocaleController.getString(R.string.StickersCopy), new Runnable() { // from class: org.telegram.ui.StickersActivity$$ExternalSyntheticLambda18
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$openStickerSetOptions$9(stickersSet);
            }
        }).add(R.drawable.msg_reorder, LocaleController.getString(R.string.StickersReorder), new Runnable() { // from class: org.telegram.ui.StickersActivity$$ExternalSyntheticLambda19
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$openStickerSetOptions$10(stickerSetCell);
            }
        }).addIf(!stickersSet.set.official, R.drawable.msg_share, LocaleController.getString(R.string.StickersShare), new Runnable() { // from class: org.telegram.ui.StickersActivity$$ExternalSyntheticLambda20
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$openStickerSetOptions$11(stickersSet);
            }
        }).add(R.drawable.msg_retry, LocaleController.getString(R.string.Refresh), new Runnable() { // from class: org.telegram.ui.StickersActivity$$ExternalSyntheticLambda21
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$openStickerSetOptions$12(stickersSet);
            }
        }).addIf(!stickersSet.set.official, R.drawable.msg_delete, (CharSequence) LocaleController.getString(R.string.StickersRemove), true, new Runnable() { // from class: org.telegram.ui.StickersActivity$$ExternalSyntheticLambda22
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /* JADX INFO: renamed from: toggleSelected */
    ...
    private CharSequence addStickersBotSpan(String str) {
        ...
        if (iIndexOf != -1) {
            try {
                ...
                spannableStringBuilder.setSpan(new URLSpanNoUnderline("@stickers") { // from class: org.telegram.ui.StickersActivity.4
    ...
    /* JADX INFO: renamed from: org.telegram.ui.StickersActivity$4 */
    class AnonymousClass4 extends URLSpanNoUnderline {
        AnonymousClass4(String str2) {
            super(str2);
        }
    ...
    /* JADX INFO: renamed from: refreshStickerSet */
    ...
    /* JADX INFO: renamed from: org.telegram.ui.StickersActivity$5 */
    class AnonymousClass5 implements ShareAlert.ShareAlertDelegate {
        AnonymousClass5() {
        }
