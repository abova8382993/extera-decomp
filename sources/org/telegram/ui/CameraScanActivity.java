...
public class CameraScanActivity extends BaseFragment {
    ...
    class AnonymousClass1 extends BottomSheet {
        ...
        AnonymousClass1(Context context, boolean z, INavigationLayout[] iNavigationLayoutArr, int i, boolean z2, CameraScanActivityDelegate cameraScanActivityDelegate) {
            ...
            C00331 c00331 = new CameraScanActivity(i) { // from class: org.telegram.ui.CameraScanActivity.1.1
                C00331(int i2) {
                    super(i2);
                }
            ...
            this.fragment = c00331;
            c00331.shownAsBottomSheet = true;
            ((CameraScanActivity) c00331).needGalleryButton = z2;
        ...
        class C00331 extends CameraScanActivity {
            C00331(int i2) {
                super(i2);
            }
    ...
    public View createView(Context context) {
        ...
        AnonymousClass3 anonymousClass3 = new ViewGroup(context) { // from class: org.telegram.ui.CameraScanActivity.3
            ...
            protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
                ...
                if (CameraScanActivity.this.currentType != 0) {
                    ...
                    if (CameraScanActivity.this.currentType == 3) {
                        int measuredHeight2 = i7 + CameraScanActivity.this.titleTextView.getMeasuredHeight() + AndroidUtilities.dp(8.0f);
        ...
        anonymousClass3.setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.CameraScanActivity$$ExternalSyntheticLambda0
    ...
    class AnonymousClass5 implements PhotoAlbumPickerActivity.PhotoAlbumPickerActivityDelegate {
        AnonymousClass5() {
        }
