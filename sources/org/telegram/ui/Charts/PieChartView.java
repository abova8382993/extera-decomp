    ...
    */
    protected void drawPickerChart(android.graphics.Canvas r22) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Charts.PieChartView.drawPickerChart(android.graphics.Canvas):void");
    }
    ...
    protected void selectXOnChart(int i, int i2) {
        ...
        if (this.currentSelection != i3 && i3 >= 0) {
            ...
            int iMin2 = ((int) Math.min(this.rectF.centerY(), (int) Math.min(((double) this.rectF.centerY()) + (Math.sin(Math.toRadians(r14)) * dWidth), ((double) this.rectF.centerY()) + (dWidth * Math.sin(Math.toRadians(r9)))))) - AndroidUtilities.dp(50.0f);
