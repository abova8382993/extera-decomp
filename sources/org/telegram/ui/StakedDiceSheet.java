...
public class StakedDiceSheet extends BottomSheetWithRecyclerListView {
    ...
    public StakedDiceSheet(final Context context, final int i, final Theme.ResourcesProvider resourcesProvider, final Utilities.Callback callback) {
        ...
        spannableStringBuilder.setSpan(new ReplacementSpan() { // from class: org.telegram.ui.StakedDiceSheet.1
            ...
            public void draw(Canvas canvas, CharSequence charSequence, int i3, int i4, float f, int i5, int i6, int i7, Paint paint) {
                float fDp = ((i5 + i7) / 2.0f) + AndroidUtilities.dp(1.0f);
        ...
        int i3 = R.drawable.dice1;
        int i4 = R.drawable.dice2;
        int i5 = R.drawable.dice3;
        int i6 = R.drawable.dice4;
        int i7 = R.drawable.dice5;
        int i8 = R.drawable.dice6;
        ...
        Utilities.Callback2Return callback2Return = new Utilities.Callback2Return() { // from class: org.telegram.ui.StakedDiceSheet$$ExternalSyntheticLambda4
            ...
            public final Object run(Object obj, Object obj2) {
                return StakedDiceSheet.m16067$r8$lambda$Avzvs7HEBCdkCHlzfUQfHJlva8(context, iArr, resourcesProvider, tableView, (Integer) obj, (Float) obj2);
            }
        };
        float f = 1.0f;
        ...
        ColoredImageSpan coloredImageSpan = new ColoredImageSpan(R.drawable.dice6);
        ...
        Utilities.CallbackReturn callbackReturn = new Utilities.CallbackReturn() { // from class: org.telegram.ui.StakedDiceSheet$$ExternalSyntheticLambda6
            ...
            public final Object run(Object obj) {
                return StakedDiceSheet.m16068$r8$lambda$U3QzNjIEL4Nod70FOH84Lt4RXk(context, resourcesProvider, editTextBoldCursor, (Long) obj);
            }
        };
        ...
        while (true) {
            ...
            if (i9 < Utilities.divCeil(jArr.length, 3)) {
                ...
                coloredImageSpan2.setTranslateY(AndroidUtilities.dp(f3));
                ...
                recyclerListView.setPadding(i14, 0, i14, AndroidUtilities.dp(68.0f));
    ...
    public static /* synthetic */ TableView.TableRowContent m16067$r8$lambda$Avzvs7HEBCdkCHlzfUQfHJlva8(Context context, int[] iArr, Theme.ResourcesProvider resourcesProvider, TableView tableView, Integer num, Float f) {
        LinearLayout linearLayout = new LinearLayout(context);
        linearLayout.setOrientation(1);
        LinearLayout linearLayout2 = new LinearLayout(context);
    ...
    public static /* synthetic */ View m16068$r8$lambda$U3QzNjIEL4Nod70FOH84Lt4RXk(Context context, Theme.ResourcesProvider resourcesProvider, final EditTextBoldCursor editTextBoldCursor, final Long l) {
        TextView textView = new TextView(context);
        textView.setGravity(17);
        textView.setTextSize(1, 13.0f);
