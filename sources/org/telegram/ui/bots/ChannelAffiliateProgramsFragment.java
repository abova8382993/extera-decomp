...
public class ChannelAffiliateProgramsFragment extends GradientHeaderActivity implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(final Context context) {
        ...
        AnonymousClass1 anonymousClass1 = new View(context) { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment.1
        ...
        this.emptyLayout = anonymousClass1;
        anonymousClass1.setBackgroundColor(Theme.getColor(Theme.key_dialogBackgroundGray));
        ...
        this.listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda0
            ...
            public final void onItemClick(View view, int i) {
                this.f$0.lambda$createView$0(context2, view, i);
            }
        });
        this.listView.setOnItemLongClickListener(new RecyclerListView.OnItemLongClickListener() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda1
            ...
            public final boolean onItemClick(View view, int i) {
                return this.f$0.lambda$createView$8(context2, view, i);
            }
        });
    ...
    /* JADX INFO: renamed from: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$1 */
    ...
    public /* synthetic */ boolean lambda$createView$8(final Context context, View view, int i) {
        ...
        ItemOptions.makeOptions(this, view).addIf(user.bot_has_main_app, R.drawable.msg_bot, LocaleController.getString(R.string.ProfileBotOpenApp), new Runnable() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$createView$1(user);
            }
        }).addIf(!user.bot_has_main_app, R.drawable.msg_bot, LocaleController.getString(R.string.BotWebViewOpenBot), new Runnable() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$createView$2(connectedbotstarref);
            }
        }).add(R.drawable.msg_link2, LocaleController.getString(R.string.CopyLink), new Runnable() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$createView$3(connectedbotstarref, user);
            }
        }).addIf(!connectedbotstarref.revoked, R.drawable.msg_leave, (CharSequence) LocaleController.getString(R.string.LeaveAffiliateLinkButton), true, new Runnable() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda12
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$2 */
    ...
    /* JADX INFO: renamed from: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$3 */
    class AnonymousClass3 extends UniversalAdapter {
        AnonymousClass3(RecyclerListView recyclerListView, Context context, int i, int i2, boolean z, Utilities.Callback2 callback2, Theme.ResourcesProvider resourcesProvider) {
    ...
    protected RecyclerView.Adapter createAdapter() {
        AnonymousClass3 anonymousClass3 = new UniversalAdapter(this.listView, getContext(), this.currentAccount, this.classGuid, true, new Utilities.Callback2() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda2
    ...
    /* JADX INFO: renamed from: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$5 */
    class AnonymousClass5 extends StarParticlesView {
    ...
    /* JADX WARN: Removed duplicated region for block: B:61:0x0629  */
    ...
    */
    public static void showConnectAffiliateAlert(final android.content.Context r35, final int r36, final org.telegram.tgnet.tl.TL_payments.starRefProgram r37, final long r38, final org.telegram.ui.ActionBar.Theme.ResourcesProvider r40, final boolean r41) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.bots.ChannelAffiliateProgramsFragment.showConnectAffiliateAlert(android.content.Context, int, org.telegram.tgnet.tl.TL_payments$starRefProgram, long, org.telegram.ui.ActionBar.Theme$ResourcesProvider, boolean):void");
    }
    ...
    /* JADX INFO: renamed from: $r8$lambda$XgA49I2JQGHCeLKN--4jezb1a-Q */
    public static /* synthetic */ void m18594$r8$lambda$XgA49I2JQGHCeLKN4jezb1aQ(int i, BottomSheet bottomSheet, Theme.ResourcesProvider resourcesProvider, View view, final long[] jArr, final Runnable runnable, View view2) {
        final long j;
        ...
        while (i2 < size) {
            ...
            itemOptionsMakeOptions.addChat(tLObject, j == jArr[0], new Runnable() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda23
                @Override // java.lang.Runnable
                public final void run() {
                    ChannelAffiliateProgramsFragment.m18598$r8$lambda$myZWo4kuTQPqu_UZiRZ7NiFhCg(jArr, j, runnable);
                }
            });
        }
    ...
    /* JADX INFO: renamed from: $r8$lambda$myZWo4kuTQPqu_UZ-iRZ7NiFhCg */
    public static /* synthetic */ void m18598$r8$lambda$myZWo4kuTQPqu_UZiRZ7NiFhCg(long[] jArr, long j, Runnable runnable) {
        jArr[0] = j;
        runnable.run();
    }

    public static /* synthetic */ void $r8$lambda$RSMiA0pDgQwFzQxvPORVXXWPlFw(BottomSheet bottomSheet, TL_payments.starRefProgram starrefprogram, View view) {
        BaseFragment safeLastFragment = LaunchActivity.getSafeLastFragment();
        if (safeLastFragment != null) {
            bottomSheet.lambda$new$0();
            ...
            safeLastFragment.presentFragment(new ChatActivity(bundle) { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment.6
                ...
                AnonymousClass6(Bundle bundle2, BottomSheet bottomSheet2) {
                    super(bundle2);
    ...
    /* JADX INFO: renamed from: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$6 */
    ...
    public static BottomSheet showShareAffiliateAlert(final Context context, final int i, final TL_payments.connectedBotStarRef connectedbotstarref, final long j, Theme.ResourcesProvider resourcesProvider) {
        ...
        linearLayout3.setBackground(Theme.createRoundRectDrawable(iDp, Theme.getColor(i6, resourcesProvider)));
        BackupImageView backupImageView = new BackupImageView(context);
        ...
        if (connectedbotstarref.revoked) {
            ...
            linearLayout4.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.dp(28.0f), Theme.getColor(i6, resourcesProvider)));
        ...
        textView7.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.dp(8.0f), Theme.getColor(i6, resourcesProvider2), Theme.blendOver(Theme.getColor(i6, resourcesProvider2), Theme.getColor(Theme.key_listSelector, resourcesProvider2))));
        ...
        if (r17 != 0) {
            ...
            r4.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda7
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    ChannelAffiliateProgramsFragment.m18599$r8$lambda$rkFAKYigEpM2vOin2Pe0z1jB8Q(i, bottomSheetCreate, resourcesProvider3, r4, j, context, connectedbotstarref, view2);
                }
            });
        } else {
            connectedbotstarref2 = connectedbotstarref;
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda8
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                ChannelAffiliateProgramsFragment.m18590$r8$lambda$DA_jYfNNWEocIbgyGZeSJnRhK8(bottomSheetCreate, connectedbotstarref2, view2);
            }
        });
                ...
                MessagesController.getInstance(i).loadFullUser(user, 0, true, new Utilities.Callback() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda24
                    ...
                    public final void run(Object obj) {
                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.bots.ChannelAffiliateProgramsFragment$$ExternalSyntheticLambda26
                            @Override // java.lang.Runnable
                            public final void run() {
                                ChannelAffiliateProgramsFragment.m18591$r8$lambda$GfWtO3GPRLf2Utb4HcFxHVUeXo(userFull, bottomSheet, context, i, j, resourcesProvider);
                            }
                        });
                    }
                });
    ...
    /* JADX INFO: renamed from: $r8$lambda$GfWtO3GP-RLf2Utb4HcFxHVUeXo */
    public static /* synthetic */ void m18591$r8$lambda$GfWtO3GPRLf2Utb4HcFxHVUeXo(TLRPC.UserFull userFull, BottomSheet bottomSheet, Context context, int i, long j, Theme.ResourcesProvider resourcesProvider) {
    ...
    /* JADX INFO: renamed from: $r8$lambda$rkFAKY-igEpM2vOin2Pe0z1jB8Q */
    public static /* synthetic */ void m18599$r8$lambda$rkFAKYigEpM2vOin2Pe0z1jB8Q(final int i, final BottomSheet bottomSheet, Theme.ResourcesProvider resourcesProvider, View view, long j, final Context context, final TL_payments.connectedBotStarRef connectedbotstarref, View view2) {
        long j2;
        ArrayList admined = BotStarsController.getInstance(i).getAdmined();
        admined.add(0, UserConfig.getInstance(i).getCurrentUser());
    ...
    /* JADX INFO: renamed from: $r8$lambda$DA_jYfNNWEocIbgyGZeSJnRhK-8 */
    public static /* synthetic */ void m18590$r8$lambda$DA_jYfNNWEocIbgyGZeSJnRhK8(BottomSheet bottomSheet, TL_payments.connectedBotStarRef connectedbotstarref, View view) {
        bottomSheet.lambda$new$0();
        BaseFragment safeLastFragment = LaunchActivity.getSafeLastFragment();
        if (safeLastFragment != null) {
