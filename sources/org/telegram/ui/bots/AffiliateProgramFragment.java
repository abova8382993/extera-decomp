...
public class AffiliateProgramFragment extends GradientHeaderActivity implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(final Context context) {
        ...
        AnonymousClass1 anonymousClass1 = new View(context) { // from class: org.telegram.ui.bots.AffiliateProgramFragment.1
            ...
            protected void onMeasure(int i, int i2) {
                ...
                if (affiliateProgramFragment.isLandscapeMode) {
                    measuredHeight = (affiliateProgramFragment.statusBarHeight + ((BaseFragment) affiliateProgramFragment).actionBar.getMeasuredHeight()) - AndroidUtilities.dp(16.0f);
                } else {
                    int iDp = AndroidUtilities.dp(140.0f);
                    AffiliateProgramFragment affiliateProgramFragment2 = AffiliateProgramFragment.this;
                    int measuredHeight2 = iDp + affiliateProgramFragment2.statusBarHeight;
                    if (affiliateProgramFragment2.backgroundView.getMeasuredHeight() + AndroidUtilities.dp(24.0f) > measuredHeight2) {
                        measuredHeight2 = AffiliateProgramFragment.this.backgroundView.getMeasuredHeight() + AndroidUtilities.dp(24.0f);
                    }
        ...
        AnonymousClass2 anonymousClass2 = new ButtonWithCounterView(context2, this.resourceProvider) { // from class: org.telegram.ui.bots.AffiliateProgramFragment.2
            @Override // org.telegram.ui.Stories.recorder.ButtonWithCounterView
            protected boolean subTextSplitToWords() {
                return false;
            }

            AnonymousClass2(final Context context2, Theme.ResourcesProvider resourcesProvider) {
                super(context2, resourcesProvider);
            }
        };
        this.button = anonymousClass2;
        anonymousClass2.setText(LocaleController.getString(R.string.AffiliateProgramStart), false);
    ...
    class AnonymousClass2 extends ButtonWithCounterView {
        @Override // org.telegram.ui.Stories.recorder.ButtonWithCounterView
        protected boolean subTextSplitToWords() {
            return false;
        }
    ...
    private void update(boolean z) {
        ...
        this.buttonSubtext.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString((this.new_program || this.program.end_date != 0) ? R.string.AffiliateProgramStartInfo : R.string.AffiliateProgramUpdateInfo), new Runnable() { // from class: org.telegram.ui.bots.AffiliateProgramFragment$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
    ...
    class AnonymousClass3 extends StarParticlesView {
    ...
    class AnonymousClass4 extends UniversalAdapter {
        AnonymousClass4(RecyclerListView recyclerListView, Context context, int i, int i2, boolean z, Utilities.Callback2 callback2, Theme.ResourcesProvider resourcesProvider) {
    ...
    protected RecyclerView.Adapter createAdapter() {
        AnonymousClass4 anonymousClass4 = new UniversalAdapter(this.listView, getContext(), this.currentAccount, this.classGuid, true, new Utilities.Callback2() { // from class: org.telegram.ui.bots.AffiliateProgramFragment$$ExternalSyntheticLambda6
