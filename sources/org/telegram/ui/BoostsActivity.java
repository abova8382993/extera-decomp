...
public class BoostsActivity extends GradientHeaderActivity implements NotificationCenter.NotificationCenterDelegate {
    ...
    AdapterWithDiffUtils adapter = new AdapterWithDiffUtils() { // from class: org.telegram.ui.BoostsActivity.1
        ...
        /* JADX INFO: renamed from: org.telegram.ui.BoostsActivity$1$1 */
        class C00311 extends View {
            ...
            protected void onMeasure(int i, int i2) {
                ...
                super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(Math.max(0, linearLayoutManager instanceof FillLastLinearLayoutManager ? ((FillLastLinearLayoutManager) linearLayoutManager).getLastItemHeight() : 0), TLObject.FLAG_30));
            }
        }

        /* JADX INFO: renamed from: org.telegram.ui.BoostsActivity$1$2 */
        ...
        /* JADX INFO: renamed from: org.telegram.ui.BoostsActivity$1$3 */
        class AnonymousClass3 implements ScrollSlidingTextTabStrip.ScrollSlidingTabStripDelegate {
            ...
            public void onPageSelected(int i, boolean z) {
                BoostsActivity.this.selectedTab = i;
                BoostsActivity.this.updateRows(true);
            }
        }

        /* JADX INFO: renamed from: org.telegram.ui.BoostsActivity$1$4 */
        ...
        /* JADX INFO: renamed from: org.telegram.ui.BoostsActivity$1$5 */
        class AnonymousClass5 extends ManageChatTextCell {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            switch (i) {
                ...
                case 7:
                    ...
                    return new RecyclerListView.Holder(overviewCell);
                case 8:
                    AnonymousClass4 anonymousClass4 = new FrameLayout(BoostsActivity.this.getContext()) { // from class: org.telegram.ui.BoostsActivity.1.4
                        AnonymousClass4(Context context) {
                            super(context);
                        }
                    ...
                    anonymousClass4.addView(textView, LayoutHelper.createFrame(-1, -2.0f, 0, 0.0f, 16.0f, 0.0f, 0.0f));
                    overviewCell = anonymousClass4;
                    overviewCell.setLayoutParams(new RecyclerView.LayoutParams(-1, -2));
                    return new RecyclerListView.Holder(overviewCell);
                case 9:
                    AnonymousClass5 anonymousClass5 = new ManageChatTextCell(BoostsActivity.this.getContext()) { // from class: org.telegram.ui.BoostsActivity.1.5
                        AnonymousClass5(Context context) {
                            super(context);
                        }
                ...
                case 13:
                    ...
                    AnonymousClass2 anonymousClass2 = new FrameLayout(BoostsActivity.this.getContext()) { // from class: org.telegram.ui.BoostsActivity.1.2
                        private final Paint dividerPaint = new Paint(1);
                    ...
                    anonymousClass2.addView(BoostsActivity.this.boostsTabs, LayoutHelper.createFrame(-2, 48.0f));
                ...
                case 14:
                    ...
                    return new RecyclerListView.Holder(overviewCell);
                case 15:
                    C00311 c00311 = new View(BoostsActivity.this.getContext()) { // from class: org.telegram.ui.BoostsActivity.1.1
                        C00311(Context context) {
                            super(context);
                        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.BoostsActivity$1 */
    ...
    /* JADX INFO: renamed from: org.telegram.ui.BoostsActivity$2 */
    ...
    public void createEmptyView(Context context) {
        ...
        this.progressLayout.addView(new View(context) { // from class: org.telegram.ui.BoostsActivity.3
            ...
            AnonymousClass3(Context context2) {
                super(context2);
                this.drawable = new CircularProgressDrawable(AndroidUtilities.dp(30.0f), AndroidUtilities.dp(3.0f), Theme.getColor(Theme.key_dialogTextBlue));
            }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.BoostsActivity$3 */
    ...
    /* JADX INFO: renamed from: org.telegram.ui.BoostsActivity$4 */
    class AnonymousClass4 extends FrameLayout {
        AnonymousClass4(Context context) {
            super(context);
            addView(BoostsActivity.this.boostsStatus != null ? BoostsActivity.this.limitPreviewView : new View(getContext()), LayoutHelper.createFrame(-1, BoostsActivity.this.boostsStatus != null ? -2.0f : 110.0f, 0, 8.0f, 46.0f, 8.0f, 33.0f));
