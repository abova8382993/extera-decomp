            ...
            switch (viewHolder.getItemViewType()) {
                ...
                case 1:
                    ...
                    if (i == ProfileNotificationsActivity.this.customResetRow) {
                        ...
                        if (i == ProfileNotificationsActivity.this.soundRow) {
                            String string = notificationsSettings.getString("sound_" + sharedPrefKey, LocaleController.getString(R.string.SoundDefault));
                            ...
                            textSettingsCell.setTextAndValue(LocaleController.getString(R.string.Sound), string, true);
                            ...
                            textSettingsCell.setTextAndValue(LocaleController.getString(R.string.VoipSettingsRingtone), string2, false);
                ...
                case 4:
                    ...
                    if (i == ProfileNotificationsActivity.this.popupEnabledRow) {
                        radioCell.setText(LocaleController.getString(R.string.PopupEnabled), i9 == 1, true);
                        radioCell.setTag(1);
                    } else if (i == ProfileNotificationsActivity.this.popupDisabledRow) {
                        radioCell.setText(LocaleController.getString(R.string.PopupDisabled), i9 == 2, false);
                        radioCell.setTag(2);
                    }
                    break;
                case 5:
