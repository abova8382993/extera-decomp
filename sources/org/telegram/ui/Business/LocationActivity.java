...
public class LocationActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        AnonymousClass2 anonymousClass2 = new EditTextBoldCursor(getContext()) { // from class: org.telegram.ui.Business.LocationActivity.2
        ...
        if (editTextBoldCursor2 != null) {
            ...
            editTextBoldCursor2.setText(this.address);
        ...
        this.mapPreview = new BackupImageView(context) { // from class: org.telegram.ui.Business.LocationActivity.5
            ...
            /* JADX INFO: renamed from: org.telegram.ui.Business.LocationActivity$5$1 */
            ...
            protected ImageReceiver createImageReciever() {
                return new ImageReceiver(this) { // from class: org.telegram.ui.Business.LocationActivity.5.1
                    ...
                    @Override // org.telegram.messenger.ImageReceiver
                    protected boolean setImageBitmapByKey(Drawable drawable, String str, int i4, boolean z, int i22) {
                        if (drawable != null && i4 != 1) {
                            LocationActivity.this.mapMarker.animate().alpha(1.0f).translationY(0.0f).setInterpolator(CubicBezierInterpolator.EASE_OUT_BACK).setDuration(250L).start();
                        }
                        return super.setImageBitmapByKey(drawable, str, i4, z, i22);
                    }
                };
            }
        ...
        this.mapMarker = new View(context2) { // from class: org.telegram.ui.Business.LocationActivity.6
            ...
            AnonymousClass6(Context context2) {
                super(context2);
                this.pin = getContext().getResources().getDrawable(R.drawable.map_pin_photo).mutate();
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Business.LocationActivity$1 */
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Business.LocationActivity$2 */
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Business.LocationActivity$3 */
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Business.LocationActivity$4 */
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Business.LocationActivity$5 */
    class AnonymousClass5 extends BackupImageView {
        AnonymousClass5(Context context2) {
            super(context2);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Business.LocationActivity$6 */
