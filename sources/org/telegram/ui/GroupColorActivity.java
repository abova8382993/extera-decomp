...
public class GroupColorActivity extends ChannelColorActivity {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.GroupColorActivity$2 */
    ...
    protected void createListView() {
        AnonymousClass2 anonymousClass2 = new RecyclerListView(getContext(), this.resourceProvider) { // from class: org.telegram.ui.GroupColorActivity.2
            AnonymousClass2(Context context, Theme.ResourcesProvider resourcesProvider) {
                super(context, resourcesProvider);
            }
        ...
        anonymousClass2.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.GroupColorActivity.3
            AnonymousClass3() {
            }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.GroupColorActivity$3 */
    ...
    public /* synthetic */ void lambda$openBoostDialog$0(int i, ChannelBoostsController.CanApplyBoost canApplyBoost) {
        ...
        AnonymousClass4 anonymousClass4 = new LimitReachedBottomSheet(this, getContext(), i, this.currentAccount, this.resourceProvider) { // from class: org.telegram.ui.GroupColorActivity.4
            AnonymousClass4(BaseFragment this, Context context, int i2, int i3, Theme.ResourcesProvider resourcesProvider) {
                super(this, context, i2, i3, resourcesProvider);
            }
        ...
        anonymousClass4.setCanApplyBoost(canApplyBoost);
        anonymousClass4.setBoostsStats(this.boostsStatus, true);
        anonymousClass4.setDialogId(this.dialogId);
        anonymousClass4.show();
    }

    /* JADX INFO: renamed from: org.telegram.ui.GroupColorActivity$4 */
