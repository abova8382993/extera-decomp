...
public class DataUsage2Activity extends BaseFragment {
    ...
    class ListView extends RecyclerListView {
        ...
        class Adapter extends AdapterWithDiffUtils {
            ...
            /* JADX INFO: renamed from: org.telegram.ui.DataUsage2Activity$ListView$Adapter$1, reason: invalid class name */
    ...
    public static class RoundingCell extends View {
        ...
        @Override // android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(13.0f), TLObject.FLAG_30));
            setTop(this.top);
        }
