    ...
    public static class CollageLayoutDrawable extends Drawable {
        ...
        public CollageLayoutDrawable(CollageLayout collageLayout, boolean z) {
            ...
            while (i2 < size) {
                ...
                int i6 = i;
                float fMax2 = (fDpf25 - (Math.max(i, collageLayout.h - 1) * fDpf27)) / collageLayout.h;
                ...
                int i10 = part.x;
                float f8 = 0.0f;
                float f9 = (i10 == 0 && part.y == 0) ? fDpf26 : 0.0f;
                fArr[1] = f9;
                fArr[i6] = f9;
                float f10 = (i10 == i5 && part.y == 0) ? fDpf26 : 0.0f;
                fArr[3] = f10;
                fArr[2] = f10;
                float f11 = (i10 == i5 && part.y == collageLayout.h + (-1)) ? fDpf26 : 0.0f;
                fArr[5] = f11;
                fArr[4] = f11;
