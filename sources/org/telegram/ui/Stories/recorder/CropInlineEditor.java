...
public abstract class CropInlineEditor extends FrameLayout {
    ...
    public CropInlineEditor(Context context, PreviewView previewView, Theme.ResourcesProvider resourcesProvider) {
        ...
        AnonymousClass1 anonymousClass1 = new CropView(context) { // from class: org.telegram.ui.Stories.recorder.CropInlineEditor.1
        ...
        this.cropView = anonymousClass1;
        anonymousClass1.setListener(new CropView.CropViewListener() { // from class: org.telegram.ui.Stories.recorder.CropInlineEditor.2
        ...
        CropRotationWheel cropRotationWheel = new CropRotationWheel(context2);
        ...
        this.shapesLayout = new LinearLayout(context2);
    }

    /* JADX INFO: renamed from: org.telegram.ui.Stories.recorder.CropInlineEditor$1 */
    class AnonymousClass1 extends CropView {
        AnonymousClass1(Context context2) {
            super(context2);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Stories.recorder.CropInlineEditor$2 */
    class AnonymousClass2 implements CropView.CropViewListener {
        @Override // org.telegram.ui.Components.Crop.CropView.CropViewListener
        public void onAspectLock(boolean z) {
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Stories.recorder.CropInlineEditor$3 */
    class AnonymousClass3 implements CropRotationWheel.RotationWheelListener {
        AnonymousClass3() {
        }
