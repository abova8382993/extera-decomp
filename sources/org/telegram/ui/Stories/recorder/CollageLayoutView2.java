...
public abstract class CollageLayoutView2 extends FrameLayout implements ItemOptions.ScrimView {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        float f6 = this.animatedRows.set(this.currentLayout.h);
        int i2 = 0;
        while (true) {
            d = f6;
            f = 0.0f;
        ...
        while (i4 < this.parts.size()) {
            ...
            int i5 = i;
            float f7 = f2;
            float f8 = this.animatedColumns[part3.y].set(part3.layout.columns[r2]);
            if (this.reordering || this.reorderingTouch) {
                ...
                z = true;
                f4 = f;
                this.rect.set((getMeasuredWidth() / f8) * part3.x, (getMeasuredHeight() / f6) * part3.y, (getMeasuredWidth() / f8) * (part3.x + 1), (part3.y + 1) * (getMeasuredHeight() / f6));
            }
        ...
        while (i < this.removingParts.size()) {
            ...
            int i10 = i;
            this.rect.set((getMeasuredWidth() / f11) * part5.x, (getMeasuredHeight() / f6) * part5.y, (getMeasuredWidth() / f11) * (part5.x + 1), (getMeasuredHeight() / f6) * (part5.y + 1));
        ...
        if (f5 > f3 && (part = this.reorderingPart) != null) {
            ...
            float f12 = this.animatedColumns[part6.y].set(this.currentLayout.columns[r7]);
            if (this.reorderingTouch) {
                AndroidUtilities.lerp(part.fromBounds, part.bounds, part.boundsTransition, this.rect);
            } else {
                this.rect.set((getMeasuredWidth() / f12) * part6.x, (getMeasuredHeight() / f6) * part6.y, (getMeasuredWidth() / f12) * (part6.x + 1), (getMeasuredHeight() / f6) * (part6.y + 1));
            }
            canvasBeginRecording.save();
            canvasBeginRecording.translate(AndroidUtilities.lerp(this.ldx, this.dx, part.boundsTransition) * f5, AndroidUtilities.lerp(this.ldy, this.dy, part.boundsTransition) * f5);
        ...
        for (int i14 = i8; i14 < this.parts.size(); i14++) {
            ...
            if (f13 > 0.0f) {
                float f14 = this.animatedColumns[part8.y].set(part8.layout.columns[r8]);
                if (this.reordering || this.reorderingTouch) {
                    AndroidUtilities.lerp(part7.fromBounds, part7.bounds, part7.boundsTransition, this.rect);
                } else {
                    this.rect.set((getMeasuredWidth() / f14) * part8.x, (getMeasuredHeight() / f6) * part8.y, (getMeasuredWidth() / f14) * (part8.x + 1), (getMeasuredHeight() / f6) * (part8.y + 1));
                }
                ...
                float fDp3 = (i16 == collageLayout.w + (-1) && part11.y == collageLayout.h + (-1)) ? AndroidUtilities.dp(8.0f) : 0.0f;
                fArr7[4] = fDp3;
                fArr7[3] = fDp3;
    ...
    public void onLongPress() {
        ...
        itemOptionsMakeOptions.setFixedWidth(220).add(R.drawable.menu_camera_retake, LocaleController.getString(R.string.StoreCollageRetake), new Runnable() { // from class: org.telegram.ui.Stories.recorder.CollageLayoutView2$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public class Part {
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Stories.recorder.CollageLayoutView2$Part$1 */
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Stories.recorder.CollageLayoutView2$Part$2 */
