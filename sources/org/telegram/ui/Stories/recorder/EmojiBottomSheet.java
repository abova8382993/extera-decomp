...
public class EmojiBottomSheet extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
                ...
                if (this.imageViewEmojis != null) {
                    ...
                    for (int i = 0; i < this.imageViewEmojis.size(); i++) {
                        ...
                        if (!emojiImageView.notDraw) {
                            ...
                            if (EmojiListView.this.whiteFilter != null && OnBackPressedDispatcher$$ExternalSyntheticNonNull0.m(emojiImageView.drawable)) {
    ...
    static class SearchField extends FrameLayout {
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Stories.recorder.EmojiBottomSheet$SearchField$3, reason: invalid class name */
        ...
        public void checkCategoriesView(int i, final boolean z) {
            if (this.categoriesListViewType != i || this.categoriesListView == null) {
                ...
                stickerCategoriesListView2.setDontOccupyWidth(((int) this.editText.getPaint().measureText(((Object) this.editText.getHint()) + _UrlKt.FRAGMENT_ENCODE_SET)) + AndroidUtilities.dp(16.0f));
    ...
    class StoryWidgetsCell extends View {
        ...
        class ReactionWidget extends BaseWidget {
            ...
            ReactionWidget() {
                ...
                Collections.sort(this.visibleReactions, new Comparator() { // from class: org.telegram.ui.Stories.recorder.EmojiBottomSheet$StoryWidgetsCell$ReactionWidget$$ExternalSyntheticLambda0
                    ...
                    public final int compare(Object obj, Object obj2) {
                        return EmojiBottomSheet.StoryWidgetsCell.ReactionWidget.m17199$r8$lambda$M0r5PWt2OPKJuCVT6lv8Fy7TH8((ReactionsLayoutInBubble.VisibleReaction) obj, (ReactionsLayoutInBubble.VisibleReaction) obj2);
                    }
                });
            ...
            public static /* synthetic */ int m17199$r8$lambda$M0r5PWt2OPKJuCVT6lv8Fy7TH8(ReactionsLayoutInBubble.VisibleReaction visibleReaction, ReactionsLayoutInBubble.VisibleReaction visibleReaction2) {
            ...
            /* JADX INFO: renamed from: org.telegram.ui.Stories.recorder.EmojiBottomSheet$StoryWidgetsCell$ReactionWidget$1, reason: invalid class name */
        ...
        */
        protected void dispatchDraw(android.graphics.Canvas r8) {
            ...
            L14:
                ...
                int r6 = org.telegram.messenger.AndroidUtilities.dp(r6)     // Catch: java.lang.Exception -> Lc
