...
public abstract class CaptionContainerView extends FrameLayout {
        ...
        EditTextEmoji editTextEmoji = new EditTextEmoji(context, sizeNotifierFrameLayout, null, getEditTextStyle(), true, new DarkThemeResourceProvider()) { // from class: org.telegram.ui.Stories.recorder.CaptionContainerView.3
            ...
            protected void drawEmojiBackground(Canvas canvas, View view) {
                ...
                if (CaptionContainerView.this.customBlur()) {
                    ...
                    CaptionContainerView captionContainerView = CaptionContainerView.this;
                    captionContainerView.drawBlur(this.blurDrawer, canvas, captionContainerView.rectF, AndroidUtilities.dp(29.0f), false, 0.0f, -view2.getY(), false, 1.0f);
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Stories.recorder.CaptionContainerView$4, reason: invalid class name */
    ...
    private void drawReply(Canvas canvas) {
        ...
        rectF.set(this.bounds.left + AndroidUtilities.dp(10.0f), AndroidUtilities.dp(10.0f) + f4, this.bounds.right - AndroidUtilities.dp(10.0f), AndroidUtilities.dp(52.0f) + f4);
        if (paint != null) {
        ...
        if (text != null) {
            text.ellipsize((int) (this.bounds.width() - AndroidUtilities.dp(40.0f))).draw(canvas2, this.bounds.left + AndroidUtilities.dp(20.0f), AndroidUtilities.dp(22.0f) + f4, -1, 1.0f);
        }
        ...
        if (text2 != null) {
            text2.ellipsize((int) (this.bounds.width() - AndroidUtilities.dp(40.0f))).draw(canvas2, this.bounds.left + AndroidUtilities.dp(20.0f), AndroidUtilities.dp(40.0f) + f4, -1, 1.0f);
        }
    }
