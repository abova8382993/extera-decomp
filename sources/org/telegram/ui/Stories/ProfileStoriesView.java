...
public class ProfileStoriesView extends View implements NotificationCenter.NotificationCenterDelegate {
  ...
  0x0192: PHI (r9v18 org.telegram.tgnet.tl.TL_stories$StoryItem) = (r9v17 org.telegram.tgnet.tl.TL_stories$StoryItem), (r9v20 org.telegram.tgnet.tl.TL_stories$StoryItem) binds: [B:84:0x013f, B:105:0x018f] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    protected void dispatchDraw(Canvas canvas) {
                ...
                if (i3 > 0 && ((StoryCircle) profileStoriesView3.circles.get(i3 - 1)).cachedIndex > storyCircle.cachedIndex) {
                    Collections.sort(profileStoriesView3.circles, new Comparator() { // from class: org.telegram.ui.Stories.ProfileStoriesView$$ExternalSyntheticLambda0
                        ...
                        public final int compare(Object obj, Object obj2) {
                            return ProfileStoriesView.m16846$r8$lambda$JQNPIPP51ie698WIdXQXlPmQs((ProfileStoriesView.StoryCircle) obj, (ProfileStoriesView.StoryCircle) obj2);
                        }
                    });
                    break;
                }
        ...
        if (fLerp2 < 1.0f) {
            ...
            if (zIsLastUploadingFailed) {
                ...
                errorPaint.setStrokeWidth(AndroidUtilities.dp(f));
        ...
        if (profileStoriesView3.expandProgress <= f3 || fClamp >= 1.0f) {
            ...
            profileStoriesView3.w = f3;
            for (int i9 = 0; i9 < profileStoriesView3.circles.size(); i9++) {
                profileStoriesView3.w += AndroidUtilities.dp(14.0f) * ((StoryCircle) profileStoriesView3.circles.get(i9)).cachedScale;
            }
            float fDp = 0.0f;
            for (int i10 = 0; i10 < profileStoriesView3.circles.size(); i10++) {
                ...
                float fDp2 = (AndroidUtilities.dp(28.0f) / f) * f20;
                float f22 = profileStoriesView3.left + fDp2 + fDp;
                fDp += AndroidUtilities.dp(18.0f) * f20;
                float f23 = f22 + fDp2;
                fMax = Math.max(fMax, f23);
                profileStoriesView3.rect2.set(f22 - fDp2, f2 - fDp2, f23, f2 + fDp2);
    ...
    public static /* synthetic */ int m16846$r8$lambda$JQNPIPP51ie698WIdXQXlPmQs(StoryCircle storyCircle, StoryCircle storyCircle2) {
    ...
    private void drawArc(Canvas canvas, RectF rectF, float f, float f2, boolean z, Paint paint) {
        ...
        if (zIsForum || (ExteraConfig.avatarCorners != 28.0f && this.expandProgress < 0.2f)) {
            float avatarCorners = ExteraConfig.getAvatarCorners(rectF.height() + AndroidUtilities.dp(4.0f), true, zIsForum);
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Stories.ProfileStoriesView$3, reason: invalid class name */
