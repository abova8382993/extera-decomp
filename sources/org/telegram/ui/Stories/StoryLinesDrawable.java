...
public class StoryLinesDrawable {
    ...
    public void draw(Canvas canvas, int i, int i2, float f, int i3, float f2, float f3, boolean z, boolean z2, float f4) {
        ...
        float fDp = ((i6 - AndroidUtilities.dp(10.0f)) - ((i7 - 1) * iDp)) / i7;
        ...
        int i8 = 0;
        while (i8 < i7) {
            float fDp2 = AndroidUtilities.dp(5.0f) + (-0.0f) + (i4 * i8) + (i8 * fDp);
            if (fDp2 <= i6) {
                float f10 = fDp2 + fDp;
                if (f10 >= 0.0f && f3 > 0.0f) {
                    ...
                    if (i8 > i2 || i8 != i2) {
                        ...
                        f5 = f9;
                        f6 = fMin;
                        rectF.set(fDp2, 0.0f, f10, AndroidUtilities.lerp(AndroidUtilities.dpf2(2.0f), AndroidUtilities.dpf2(5.0f), (i2 == i8 ? 1 : 0) * f8));
                        if (z3) {
                    ...
                    rectF2.set(fDp2, 0.0f, f10, AndroidUtilities.lerp(AndroidUtilities.dpf2(2.0f), AndroidUtilities.dpf2(5.0f), (i2 == i8 ? 1 : 0) * f8));
                    if (f8 > 0.0f) {
                        int i10 = i8 - i2;
