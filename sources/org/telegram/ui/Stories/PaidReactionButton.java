...
public class PaidReactionButton extends View {
    ...
    public static class PaidReactionButtonEffectsView extends View {
        ...
        public void playEffect() {
            ...
            RLottieDrawable rLottieDrawable = new RLottieDrawable(i, _UrlKt.FRAGMENT_ENCODE_SET + i, AndroidUtilities.dp(70.0f), AndroidUtilities.dp(70.0f));
        ...
        public class Chip {
            ...
            public Chip(View view, int i, long j, int i2, int i3, boolean z) {
                ...
                if (z) {
                    ...
                    RLottieDrawable rLottieDrawable = new RLottieDrawable(i4, _UrlKt.FRAGMENT_ENCODE_SET + i4, AndroidUtilities.dp(70.0f), AndroidUtilities.dp(70.0f));
    ...
    public PaidReactionButton(Context context, PaidReactionButtonEffectsView paidReactionButtonEffectsView, BlurredBackgroundColorProvider blurredBackgroundColorProvider) {
        ...
        this.iconDrawable = context.getResources().getDrawable(R.drawable.star).mutate();
