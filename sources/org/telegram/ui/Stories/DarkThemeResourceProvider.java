...
public class DarkThemeResourceProvider implements Theme.ResourcesProvider {
    ...
    public DarkThemeResourceProvider() {
        ...
        this.sparseIntArray.put(Theme.key_chat_emojiSearchIcon, ColorUtils.setAlphaComponent(-1, Opcodes.LUSHR));
        this.sparseIntArray.put(Theme.key_chat_emojiPanelIcon, -2130706433);
        this.sparseIntArray.put(Theme.key_chat_emojiBottomPanelIcon, ColorUtils.setAlphaComponent(-1, Opcodes.LUSHR));
        ...
        this.sparseIntArray.put(Theme.key_chat_emojiPanelBackspace, ColorUtils.setAlphaComponent(-1, Opcodes.LUSHR));
