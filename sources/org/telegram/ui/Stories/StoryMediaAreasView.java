...
public abstract class StoryMediaAreasView extends FrameLayout implements View.OnClickListener {
    ...
    public void set(TL_stories.StoryItem storyItem, ArrayList arrayList, EmojiAnimationsOverlay emojiAnimationsOverlay) {
        ...
        for (int i2 = 0; i2 < arrayList.size(); i2++) {
            ...
            if (mediaArea != null && mediaArea.coordinates != null) {
                ...
                double d = mediaAreaCoordinates.w;
                double d2 = mediaAreaCoordinates.h;
            }
        }
        this.malicious = false;
    ...
    protected void onMeasure(int i, int i2) {
        ...
        for (int i3 = 0; i3 < getChildCount(); i3++) {
            ...
            if (childAt == frameLayout) {
                ...
                areaView.measure(View.MeasureSpec.makeMeasureSpec((int) Math.ceil((areaView.mediaArea.coordinates.w / 100.0d) * ((double) size)), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec((int) Math.ceil((areaView.mediaArea.coordinates.h / 100.0d) * ((double) size2)), TLObject.FLAG_30));
            } else if (childAt instanceof FitViewWidget) {
                FitViewWidget fitViewWidget = (FitViewWidget) getChildAt(i3);
                fitViewWidget.measure(View.MeasureSpec.makeMeasureSpec((int) Math.ceil((fitViewWidget.mediaArea.coordinates.w / 100.0d) * ((double) size)), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec((int) Math.ceil((fitViewWidget.mediaArea.coordinates.h / 100.0d) * ((double) size2)), TLObject.FLAG_30));
            }
        }
    ...
    */
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Stories.StoryMediaAreasView$1 */
    class AnonymousClass1 extends LocationActivity {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Stories.StoryMediaAreasView$2 */
    class AnonymousClass2 implements LineHeightSpan {
        AnonymousClass2() {
        }
    ...
    */
    private void drawHighlight(android.graphics.Canvas r18) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Stories.StoryMediaAreasView.drawHighlight(android.graphics.Canvas):void");
    }
