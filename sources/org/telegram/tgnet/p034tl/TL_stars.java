...
public class TL_stars {
        ...
        public AmountUtils$Amount getResellAmount(AmountUtils$Currency amountUtils$Currency) {
            ...
            while (i < size) {
                ...
                if (starsAmount2.getCurrency() == amountUtils$Currency) {
                    return AmountUtils$Amount.m1099of(starsAmount2);
                }
            }
            return AmountUtils$Amount.fromNano(0L, amountUtils$Currency);
        }
    ...
    public static class TL_starGiftUnique extends StarGift {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            ...
            this.f1443id = inputSerializedData.readInt64(z);
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            outputSerializedData.writeInt64(this.f1443id);
    ...
    public static class TL_starGift extends StarGift {
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            this.flags = flag8;
            int flag9 = TLObject.setFlag(flag8, 8192, this.background != null);
            this.flags = flag9;
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            int int32 = inputSerializedData.readInt32(z);
            this.flags = int32;
            this.limited = TLObject.hasFlag(int32, 1);
    ...
    public static class TL_starsTopupOption extends TLObject {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            int int32 = inputSerializedData.readInt32(z);
            this.flags = int32;
            this.extended = TLObject.hasFlag(int32, 2);
            this.stars = inputSerializedData.readInt64(z);
            if (TLObject.hasFlag(this.flags, 1)) {
    ...
    public static class TL_starsGiveawayWinnersOption extends TLObject {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            int int32 = inputSerializedData.readInt32(z);
            this.flags = int32;
            this.isDefault = TLObject.hasFlag(int32, 1);
    ...
    public static class TL_starsGiveawayOption extends TLObject {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            int int32 = inputSerializedData.readInt32(z);
            this.flags = int32;
            this.extended = TLObject.hasFlag(int32, 1);
    ...
    public static class TL_starsTransaction_layer181 extends StarsTransaction {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            int int32 = inputSerializedData.readInt32(z);
            this.flags = int32;
            this.refund = TLObject.hasFlag(int32, 8);
            this.f1445id = inputSerializedData.readString(z);
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            this.flags = flag;
            outputSerializedData.writeInt32(flag);
            outputSerializedData.writeString(this.f1445id);
    ...
    public static class TL_starsTransaction extends StarsTransaction {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            ...
            this.business_transfer = TLObject.hasFlag(this.flags, TLObject.FLAG_21);
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            this.flags = flag10;
            int flag11 = TLObject.setFlag(flag10, TLObject.FLAG_21, this.business_transfer);
            this.flags = flag11;
    ...
    public static class TL_starsSubscription extends StarsSubscription {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            int int32 = inputSerializedData.readInt32(z);
            this.flags = int32;
            this.canceled = TLObject.hasFlag(int32, 1);
            ...
            this.f1444id = inputSerializedData.readString(z);
            this.peer = TLRPC.Peer.TLdeserialize(inputSerializedData, inputSerializedData.readInt32(z), z);
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            this.flags = flag4;
            outputSerializedData.writeInt32(flag4);
            outputSerializedData.writeString(this.f1444id);
            this.peer.serializeToStream(outputSerializedData);
    ...
    public static class TL_changeStarsSubscription extends TLObject {
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            outputSerializedData.writeInt32(constructor);
            int flag = TLObject.setFlag(this.flags, 1, this.canceled != null);
            this.flags = flag;
            outputSerializedData.writeInt32(flag);
            this.peer.serializeToStream(outputSerializedData);
            outputSerializedData.writeString(this.subscription_id);
