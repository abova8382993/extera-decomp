...
public class TL_account {
    ...
    public static class contentSettings extends TLObject {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            ...
            this.flags = int32;
            this.sensitive_enabled = TLObject.hasFlag(int32, 1);
    ...
    public static class TL_password extends Password {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            int int32 = inputSerializedData.readInt32(z);
            this.flags = int32;
            this.has_recovery = TLObject.hasFlag(int32, 1);
    ...
    public static class TL_savedRingtones extends SavedRingtones {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            this.hash = inputSerializedData.readInt64(z);
            this.ringtones = Vector.deserialize(inputSerializedData, new C1108x420a2707(), z);
        }
    ...
    public static class saveRingtone extends TLObject {
        ...
        public TLRPC.InputDocument f1424id;
        public boolean unsave;
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            outputSerializedData.writeInt32(constructor);
            this.f1424id.serializeToStream(outputSerializedData);
            outputSerializedData.writeBool(this.unsave);
        }
    }
    ...
    public static class TL_businessWorkHours extends TLObject {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            int int32 = inputSerializedData.readInt32(z);
            this.flags = int32;
            this.open_now = TLObject.hasFlag(int32, 1);
    ...
    public static class TL_inputBusinessAwayMessage extends TLObject {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            int int32 = inputSerializedData.readInt32(z);
            this.flags = int32;
            this.offline_only = TLObject.hasFlag(int32, 1);
            this.shortcut_id = inputSerializedData.readInt32(z);
    ...
    public static class TL_inputBusinessBotRecipients extends TLObject {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            int int32 = inputSerializedData.readInt32(z);
            this.flags = int32;
            this.existing_chats = TLObject.hasFlag(int32, 1);
    ...
    public static class TL_businessBotRights extends TLObject {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            int int32 = inputSerializedData.readInt32(z);
            this.flags = int32;
            this.reply = TLObject.hasFlag(int32, 1);
    ...
    public static class getRequirementsToContact extends TLObject {
        ...
        /* JADX INFO: renamed from: id */
        public ArrayList<TLRPC.InputUser> f1421id = new ArrayList<>();
        ...
        @Override // org.telegram.tgnet.TLObject
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            this.f1421id = Vector.deserialize(inputSerializedData, new TLRPC$TL_inputPrivacyValueAllowUsers$$ExternalSyntheticLambda0(), z);
        }

        @Override // org.telegram.tgnet.TLObject
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            outputSerializedData.writeInt32(constructor);
            Vector.serialize(outputSerializedData, this.f1421id);
        }
    }
    ...
    public static class getSavedMusicByID extends TLObject {
        ...
        /* JADX INFO: renamed from: id */
        public TLRPC.InputUser f1422id;
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            outputSerializedData.writeInt32(constructor);
            this.f1422id.serializeToStream(outputSerializedData);
    ...
    public static class Passkey extends TLObject {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            this.flags = inputSerializedData.readInt32(z);
            this.f1419id = inputSerializedData.readString(z);
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            outputSerializedData.writeInt32(constructor);
            outputSerializedData.writeInt32(this.flags);
            outputSerializedData.writeString(this.f1419id);
    ...
    public static class inputPasskeyCredentialPublicKey extends TLObject {
        ...
        @Override // org.telegram.tgnet.TLObject
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            this.f1423id = inputSerializedData.readString(z);
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            outputSerializedData.writeInt32(constructor);
            outputSerializedData.writeString(this.f1423id);
    ...
    public static class deletePasskey extends TLMethod<TLRPC.Bool> {
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            outputSerializedData.writeInt32(constructor);
            outputSerializedData.writeString(this.f1420id);
        }
    }
