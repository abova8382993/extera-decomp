...
public class TL_phone {
    ...
    public static class phoneCallRequested extends PhoneCall {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            ...
            this.f1844id = inputSerializedData.readInt64(z);
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            outputSerializedData.writeInt64(this.f1844id);
    ...
    public static class groupCallDonor extends TLObject {
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            this.flags = flag;
            int flag2 = TLObject.setFlag(flag, 2, this.f1845my);
            this.flags = flag2;
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            ...
            this.f1845my = TLObject.hasFlag(this.flags, 2);
