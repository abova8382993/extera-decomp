...
import com.exteragram.messenger.export.api.C0937x420a2707;
...
public class TL_account {
    ...
    public static class TL_savedRingtones extends SavedRingtones {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            this.hash = inputSerializedData.readInt64(z);
            this.ringtones = Vector.deserialize(inputSerializedData, new C0937x420a2707(), z);
        }
    ...
    public static class saveRingtone extends TLObject {
        ...
        public TLRPC.InputDocument f1792id;
        public boolean unsave;
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            outputSerializedData.writeInt32(constructor);
            this.f1792id.serializeToStream(outputSerializedData);
            outputSerializedData.writeBool(this.unsave);
        }
    }
    ...
    public static class getRequirementsToContact extends TLObject {
        ...
        /* JADX INFO: renamed from: id */
        public ArrayList<TLRPC.InputUser> f1789id = new ArrayList<>();
        ...
        @Override // org.telegram.tgnet.TLObject
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            this.f1789id = Vector.deserialize(inputSerializedData, new TLRPC$TL_inputPrivacyValueAllowUsers$$ExternalSyntheticLambda0(), z);
        }

        @Override // org.telegram.tgnet.TLObject
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            outputSerializedData.writeInt32(constructor);
            Vector.serialize(outputSerializedData, this.f1789id);
        }
    }
    ...
    public static class getSavedMusicByID extends TLObject {
        ...
        /* JADX INFO: renamed from: id */
        public TLRPC.InputUser f1790id;
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            outputSerializedData.writeInt32(constructor);
            this.f1790id.serializeToStream(outputSerializedData);
    ...
    public static class Passkey extends TLObject {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            this.flags = inputSerializedData.readInt32(z);
            this.f1787id = inputSerializedData.readString(z);
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            outputSerializedData.writeInt32(constructor);
            outputSerializedData.writeInt32(this.flags);
            outputSerializedData.writeString(this.f1787id);
    ...
    public static class inputPasskeyCredentialPublicKey extends TLObject {
        ...
        @Override // org.telegram.tgnet.TLObject
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            this.f1791id = inputSerializedData.readString(z);
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            outputSerializedData.writeInt32(constructor);
            outputSerializedData.writeString(this.f1791id);
    ...
    public static class deletePasskey extends TLMethod {
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            outputSerializedData.writeInt32(constructor);
            outputSerializedData.writeString(this.f1788id);
        }
    }
