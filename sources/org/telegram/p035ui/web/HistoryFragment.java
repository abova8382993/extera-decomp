...
import org.telegram.p035ui.web.HistoryFragment;
...
public class HistoryFragment extends UniversalFragment {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C75481());
        ...
        ActionBarMenuItem actionBarMenuItemSearchListener = this.actionBar.createMenu().addItem(0, C2797R.drawable.outline_header_search, getResourceProvider()).setIsSearchField(true).setActionBarMenuItemSearchListener(new C75492());
        ...
        stickerEmptyView.title.setText(LocaleController.getString(TextUtils.isEmpty(this.query) ? C2797R.string.WebNoHistory : C2797R.string.WebNoSearchedHistory));
    ...
    public class C75481 extends ActionBar.ActionBarMenuOnItemClick {
        public C75481() {
        }
        ...
        public void onItemClick(int i) {
            if (i == -1) {
                boolean zIsActionModeShowed = ((BaseFragment) HistoryFragment.this).actionBar.isActionModeShowed();
                HistoryFragment historyFragment = HistoryFragment.this;
                if (zIsActionModeShowed) {
                    ((BaseFragment) historyFragment).actionBar.hideActionMode();
                    HistoryFragment.this.selected.clear();
                    AndroidUtilities.forEachViews((RecyclerView) HistoryFragment.this.listView, (Consumer<View>) new Consumer() { // from class: org.telegram.ui.web.HistoryFragment$1$$ExternalSyntheticLambda0
                        @Override // com.google.android.exoplayer2.util.Consumer
                        public final void accept(Object obj) {
                            HistoryFragment.C75481.m22770$r8$lambda$KfK5PG5YTgdWSPyA_5pT_hC880((View) obj);
                        }
                    });
                    return;
                }
        ...
        public static /* synthetic */ void m22770$r8$lambda$KfK5PG5YTgdWSPyA_5pT_hC880(View view) {
    ...
    public class C75492 extends ActionBarMenuItem.ActionBarMenuItemSearchListener {
        ...
        public void onSearchCollapse() {
            ...
            HistoryFragment.this.emptyView.title.setText(LocaleController.getString(TextUtils.isEmpty(HistoryFragment.this.query) ? C2797R.string.WebNoHistory : C2797R.string.WebNoSearchedHistory));
        }
        ...
        public void onTextChanged(EditText editText) {
            ...
            if (!TextUtils.equals(HistoryFragment.this.query, string)) {
                ...
                scheduleSearch();
                HistoryFragment.this.emptyView.title.setText(LocaleController.getString(TextUtils.isEmpty(string) ? C2797R.string.WebNoHistory : C2797R.string.WebNoSearchedHistory));
            }
            UniversalRecyclerView universalRecyclerView = HistoryFragment.this.listView;
            if (universalRecyclerView != null) {
                universalRecyclerView.adapter.update(true);
    ...
    public CharSequence getTitle() {
        return LocaleController.getString(C2797R.string.WebHistory);
    }
        ...
        if (TextUtils.isEmpty(this.query)) {
            ...
            if (arrayList2 != null) {
                for (int size = arrayList2.size() - 1; size >= 0; size--) {
                    ...
                    arrayList.add(AddressBarList.BookmarkView.Factory.m1243as(entry, this.query));
                }
            }
        } else {
            for (int size2 = this.searchResults.size() - 1; size2 >= 0; size2--) {
                ...
                arrayList.add(AddressBarList.BookmarkView.Factory.m1243as(entry2, this.query));
            }
