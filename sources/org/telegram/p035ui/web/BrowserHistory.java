...
public abstract class BrowserHistory {
    ...
    public static class Entry extends TLObject {
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            outputSerializedData.writeInt64(this.f1864id);
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            this.f1864id = inputSerializedData.readInt64(z);
    ...
    public static void preloadHistory() {
        ...
        Utilities.globalQueue.postRunnable(new Runnable() { // from class: org.telegram.ui.web.BrowserHistory$$ExternalSyntheticLambda1
            ...
            public final void run() {
                BrowserHistory.m22762$r8$lambda$XLggRB9xRVBOZxQbci8KT9Gp2I();
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$XLggRB-9xRVBOZxQbci8KT9Gp2I, reason: not valid java name */
    public static /* synthetic */ void m22762$r8$lambda$XLggRB9xRVBOZxQbci8KT9Gp2I() {
        ...
        try {
            ...
            if (historyFile.exists()) {
                ...
                for (long j = 0; j < int64; j++) {
                    ...
                    arrayList.add(entry);
                    longSparseArray.put(entry.f1864id, entry);
                }
            }
        } catch (Exception e) {
            FileLog.m1048e(e);
    ...
    public static /* synthetic */ void $r8$lambda$t5XNsDGR4uk9GQQTvfDDerHU1uc(ArrayList arrayList, LongSparseArray longSparseArray) {
        ...
        if (arrayList2 != null) {
            ...
            while (i < size) {
                Utilities.Callback<ArrayList<Entry>> callback = arrayList2.get(i);
                i++;
    ...
    public static void pushHistory(Entry entry) {
        ...
        preloadHistory();
        Entry entry2 = historyById.get(entry.f1864id);
        if (entry2 != null) {
            entry2.meta = entry.meta;
        } else {
            history.add(entry);
            historyById.put(entry.f1864id, entry);
        }
        scheduleHistorySave();
    }
    ...
    public static /* synthetic */ void $r8$lambda$dRU362fkhJ4Ahr_Zn4AAc3sHuCE() {
        try {
            ...
            while (i2 < size2) {
                ...
                i2++;
                entry.serializeToStream(serializedData);
            }
            SerializedData serializedData2 = new SerializedData(serializedData.length());
            serializedData2.writeInt64(size);
            ArrayList<Entry> arrayList2 = history;
            int size3 = arrayList2.size();
            while (i < size3) {
                Entry entry2 = arrayList2.get(i);
                i++;
                entry2.serializeToStream(serializedData2);
            }
            try {
