...
public class AddressBarList extends FrameLayout {
    ...
    public AddressBarList(Context context) {
        ...
        imageView2.setImageResource(C2797R.drawable.msg_copy);
        ...
        this.space = new View(context) { // from class: org.telegram.ui.web.AddressBarList.2
            ...
            public void onMeasure(int i3, int i4) {
                super.onMeasure(i3, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(6.0f), TLObject.FLAG_30));
            }
        };
    ...
    public void clearRecentSearches(View view) {
        new AlertDialog.Builder(getContext()).setTitle(LocaleController.getString(C2797R.string.WebRecentClearTitle)).setMessage(LocaleController.getString(C2797R.string.WebRecentClearText)).setPositiveButton(LocaleController.getString(C2797R.string.f1162OK), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.web.AddressBarList$$ExternalSyntheticLambda11
    ...
    public void fillItems(ArrayList<UItem> arrayList, UniversalAdapter universalAdapter) {
        ...
        int i = 0;
        int i2 = 0;
        while (i2 < this.suggestions.size()) {
            final String str = this.suggestions.get(i2);
            AddressBarList addressBarList = this;
            arrayList.add(Address2View.Factory.m1240as(1, str, new View.OnClickListener() { // from class: org.telegram.ui.web.AddressBarList$$ExternalSyntheticLambda5
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.lambda$fillItems$2(str, view);
                }
            }, i2 == 0, i2 == this.suggestions.size() - 1, addressBarList));
            i2++;
            this = addressBarList;
        }
        final AddressBarList addressBarList2 = this;
        if (!recentSearches.isEmpty()) {
            arrayList.add(UItem.asGraySection(LocaleController.getString(C2797R.string.WebSectionRecent), LocaleController.getString(C2797R.string.WebRecentClear), new View.OnClickListener() { // from class: org.telegram.ui.web.AddressBarList$$ExternalSyntheticLambda6
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            int i3 = 0;
            while (i3 < recentSearches.size()) {
                final String str2 = recentSearches.get(i3);
                arrayList.add(Address2View.Factory.m1240as(0, str2, new View.OnClickListener() { // from class: org.telegram.ui.web.AddressBarList$$ExternalSyntheticLambda7
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        this.f$0.lambda$fillItems$3(str2, view);
                    }
                }, i3 == 0, i3 == recentSearches.size() - 1, addressBarList2));
                i3++;
            }
        }
        BookmarksList bookmarksList2 = addressBarList2.bookmarksList;
        if (bookmarksList2 == null || bookmarksList2.links.isEmpty()) {
            return;
        }
        arrayList.add(UItem.asGraySection(LocaleController.getString(C2797R.string.WebSectionBookmarks)));
        while (true) {
            int size = addressBarList2.bookmarksList.links.size();
            bookmarksList = addressBarList2.bookmarksList;
            if (i >= size) {
                break;
            }
            MessageObject messageObject = bookmarksList.links.get(i);
            if (!TextUtils.isEmpty(getLink(messageObject))) {
                arrayList.add(BookmarkView.Factory.m1241as(messageObject, true));
            }
            i++;
        }
    ...
    public void setCurrent(Bitmap bitmap, String str, String str2, final Runnable runnable, Utilities.Callback<String> callback, Utilities.Callback<String> callback2, Utilities.Callback<String> callback3, View.OnClickListener onClickListener) {
        ...
        if (bitmap == null) {
            imageView.setImageResource(C2797R.drawable.msg_language);
    ...
    public static class Address2View extends FrameLayout {
        ...
        public Address2View(Context context) {
            ...
            imageView.setImageResource(C2797R.drawable.menu_clear_recent);
            ...
            imageView2.setImageResource(C2797R.drawable.menu_browser_arrowup);
        ...
        public void setColors(int i, int i2) {
            ...
            this.insertView.setBackground(Theme.createRadSelectorDrawable(0, Theme.multAlpha(i2, 0.15f), AndroidUtilities.m1036dp(4.0f), AndroidUtilities.m1036dp(4.0f)));
        }
        ...
        public void set(int i, String str, View.OnClickListener onClickListener, boolean z, boolean z2, AddressBarList addressBarList, boolean z3) {
            ...
            this.iconView.setImageResource(i == 0 ? C2797R.drawable.msg_clear_recent : C2797R.drawable.msg_search);
        ...
        public void setAsShowMore(AddressBarList addressBarList) {
            this.iconView.setImageResource(C2797R.drawable.arrow_more);
        ...
        public void onDraw(Canvas canvas) {
            super.onDraw(canvas);
            if (this.needDivider) {
                canvas.drawRect(AndroidUtilities.m1036dp(64.0f), getHeight() - Math.max(AndroidUtilities.m1036dp(0.66f), 1), getWidth(), getHeight(), this.dividerPaint);
            }
        }
        ...
        public static class Factory extends UItem.UItemFactory<Address2View> {
            ...
            public static UItem m1240as(int i, String str, View.OnClickListener onClickListener, boolean z, boolean z2, AddressBarList addressBarList) {
    ...
    public static class BookmarkView extends FrameLayout implements Theme.Colorable {
        ...
        public BookmarkView(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            imageView.setImageResource(C2797R.drawable.attach_arrow_right);
        ...
        public void set(MessageObject messageObject, boolean z, String str, boolean z2, boolean z3) {
            ...
            if (webMetadata != null && (bitmap = webMetadata.favicon) != null) {
                ...
                this.iconView.setImage(ImageLocation.getForPhoto(FileLoader.getClosestPhotoSizeWithSize(photo.sizes, AndroidUtilities.m1036dp(32.0f), true, null, true), webPage.photo), AndroidUtilities.m1036dp(32.0f) + "_" + AndroidUtilities.m1036dp(32.0f), ImageLocation.getForPhoto(FileLoader.getClosestPhotoSizeWithSize(webPage.photo.sizes, AndroidUtilities.m1036dp(32.0f), true, null, false), webPage.photo), AndroidUtilities.m1036dp(32.0f) + "_" + AndroidUtilities.m1036dp(32.0f), 0, messageObject);
            } else {
                ...
                CombinedDrawable combinedDrawable = new CombinedDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m1036dp(6.0f), Theme.multAlpha(this.textColor, 0.1f)), new Drawable(strSubstring) { // from class: org.telegram.ui.web.AddressBarList.BookmarkView.2
                    ...
                    {
                        this.val$firstLetter = strSubstring;
                        this.text = new Text(strSubstring, 14.0f, AndroidUtilities.bold());
                    }
            ...
            this.textLayoutParams.rightMargin = AndroidUtilities.m1036dp(52.0f);
        ...
        public void set(BrowserHistory.Entry entry, String str, boolean z) {
            ...
            if (webMetadata != null && (bitmap = webMetadata.favicon) != null) {
                ...
                CombinedDrawable combinedDrawable = new CombinedDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m1036dp(6.0f), Theme.multAlpha(this.textColor, 0.1f)), new Drawable(strSubstring) { // from class: org.telegram.ui.web.AddressBarList.BookmarkView.3
                    private final Text text;
                    final /* synthetic */ String val$firstLetter;
            ...
            this.textLayoutParams.rightMargin = AndroidUtilities.m1036dp(70.0f);
            this.textLayout.setLayoutParams(this.textLayoutParams);
            this.needDivider = z;
            setWillNotDraw(!z);
        }
        ...
        public void onDraw(Canvas canvas) {
            super.onDraw(canvas);
            if (this.needDivider) {
                canvas.drawRect(AndroidUtilities.m1036dp(59.0f), getHeight() - Math.max(AndroidUtilities.m1036dp(0.66f), 1), getWidth(), getHeight(), this.dividerPaint);
            }
        }
        ...
        public static class Factory extends UItem.UItemFactory<BookmarkView> {
            ...
            /* JADX INFO: renamed from: as */
            public static UItem m1241as(MessageObject messageObject, boolean z) {
                UItem uItemOfFactory = UItem.ofFactory(Factory.class);
            ...
            /* JADX INFO: renamed from: as */
            public static UItem m1242as(MessageObject messageObject, boolean z, String str) {
                UItem uItemOfFactory = UItem.ofFactory(Factory.class);
                uItemOfFactory.intValue = 3;
                uItemOfFactory.accent = z;
                uItemOfFactory.object2 = messageObject;
            ...
            /* JADX INFO: renamed from: as */
            public static UItem m1243as(BrowserHistory.Entry entry, String str) {
                UItem uItemOfFactory = UItem.ofFactory(Factory.class);
                uItemOfFactory.intValue = 3;
        ...
        if (string != null) {
            try {
                ...
                Collections.sort(arrayList, new Comparator() { // from class: org.telegram.ui.web.AddressBarList$$ExternalSyntheticLambda4
                    @Override // java.util.Comparator
                    public final int compare(Object obj, Object obj2) {
                        return AddressBarList.m22671$r8$lambda$M1RWMsq_khurYUX4HFPRF86Yew((AddressBarList.QueryEntry) obj, (AddressBarList.QueryEntry) obj2);
                    }
                });
            } catch (Exception e) {
                FileLog.m1048e(e);
    ...
    /* JADX INFO: renamed from: $r8$lambda$M1RWMsq_-khurYUX4HFPRF86Yew, reason: not valid java name */
    public static /* synthetic */ int m22671$r8$lambda$M1RWMsq_khurYUX4HFPRF86Yew(QueryEntry queryEntry, QueryEntry queryEntry2) {
        return (int) (queryEntry2.rank - queryEntry.rank);
    }
    ...
    public static class BookmarksList implements NotificationCenter.NotificationCenterDelegate {
        ...
        public void load() {
            ...
            for (int i = 0; i < this.links.size(); i++) {
                iMin = Math.min(iMin, this.links.get(i).getId());
            }
