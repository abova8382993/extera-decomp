...
public class MHTML {
    ...
    public final HashMap<String, Entry> entriesByLocation;
    public final File file;
    private final long[] filePos;
    public final HashMap<String, HeaderValue> headers;

    public MHTML(File file) throws IOException {
        HashMap<String, HeaderValue> map = new HashMap<>();
        this.headers = map;
        ...
        String prop = HeaderValue.getProp(map.get("content-type"), "boundary");
        this.boundary = prop;
        if (prop != null) {
    ...
    private HashMap<String, HeaderValue> parseHeaders(BufferedReader bufferedReader) throws IOException {
        String str;
        StringBuilder sb;
        HashMap<String, HeaderValue> map = new HashMap<>();
        loop0: while (true) {
    ...
    private static void appendHeader(String str, String str2, HashMap<String, HeaderValue> map) {
    ...
    public static class Entry {
        ...
        public String getType() {
            return HeaderValue.getValue(this.headers.get("content-type"));
        }

        public String getLocation() {
            return HeaderValue.getValue(this.headers.get("content-location"));
        }

        public String getTransferEncoding() {
            return HeaderValue.getValue(this.headers.get("content-transfer-encoding"));
        }
    ...
    public static class HeaderValue {
        ...
        public static String getProp(HeaderValue headerValue, String str) {
            ...
            return headerValue.props.get(str);
        }
    }
    ...
    public static class QuotedPrintableInputStream extends FilterInputStream {
        ...
        private int hexToByte(int i, int i2) {
            return hexDigitToInt(i2) | (hexDigitToInt(i) << 4);
        }
    }
    ...
    public static class BoundedInputStream extends FileInputStream {
        ...
        public BoundedInputStream(File file, long j, long j2) {
            ...
            GlShader$$ExternalSyntheticBUOutline1.m1250m("BoundedInputStream failed to skip");
            throw null;
        }
