...
import androidx.appcompat.app.C0045xf5eeb9b9;
...
import org.telegram.p035ui.Components.AttachBotIntroTopView;
import org.telegram.p035ui.Components.BatteryDrawable;
import org.telegram.p035ui.Components.BlockingUpdateView;
...
import org.telegram.p035ui.Components.PasscodeViewDialog;
import org.telegram.p035ui.Components.PipRoundVideoView;
import org.telegram.p035ui.Components.PipVideoOverlay;
...
import org.telegram.p035ui.Components.SearchTagsList;
...
import org.telegram.p035ui.Components.TermsOfServiceView;
...
import org.telegram.p035ui.Gifts.AuctionJoinSheet;
...
import org.telegram.p035ui.Stars.ISuperRipple;
...
import org.telegram.p035ui.Stars.SuperRipple;
import org.telegram.p035ui.Stories.LiveStoryPipOverlay;
...
public class LaunchActivity extends BasePermissionsActivity implements INavigationLayout.INavigationLayoutDelegate, NotificationCenter.NotificationCenterDelegate, DialogsActivity.DialogsActivityDelegate, IPipActivity {
    ...
    public LaunchActivity() {
        ...
        this.blurListener = new Consumer<Boolean>() { // from class: org.telegram.ui.LaunchActivity.1
            public C58901() {
            }
    ...
    private boolean addSharedPhotoUri(Uri uri, boolean z) {
        if (uri == null) {
            return false;
        }
        if (this.photoPathsArray == null) {
            ...
            for (int i = 0; i < this.photoPathsArray.size(); i++) {
                Uri uri2 = this.photoPathsArray.get(i).uri;
                if (uri2 != null && string.equals(uri2.normalizeScheme().toString())) {
                    return false;
                }
            }
        }
    ...
    public class C58901 implements Consumer<Boolean> {
        public C58901() {
        }
    ...
    public void onCreate(Bundle bundle) throws Throwable {
        ...
        FlagSecureReason flagSecureReason = new FlagSecureReason(getWindow(), new FlagSecureReason.FlagSecureCondition() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda18
        ...
        C59012 c59012 = new FrameLayout(this) { // from class: org.telegram.ui.LaunchActivity.2
            public C59012(final Context this) {
                super(this);
            }
        ...
        this.frameLayout = c59012;
        c59012.setClipToPadding(false);
        ...
        C59044 c59044 = new C59044(this);
        this.drawerLayoutContainer = c59044;
        c59044.setClipChildren(false);
        ...
        C59055 c59055 = new ImageView(this) { // from class: org.telegram.ui.LaunchActivity.5
            public C59055(final Context this) {
                super(this);
            }
        ...
        this.themeSwitchSunView = c59055;
        c59055.setScaleType(ImageView.ScaleType.CENTER);
        ...
        C59066 c59066 = new FireworksOverlay(this) { // from class: org.telegram.ui.LaunchActivity.6
            public C59066(final Context this) {
                super(this);
                setVisibility(8);
            }

            @Override // org.telegram.p035ui.Components.FireworksOverlay
        ...
        this.fireworksOverlay = c59066;
        frameLayout2.addView(c59066);
        setupActionBarLayout();
        this.drawerLayoutContainer.setParentActionBarLayout(this.actionBarLayout);
        this.actionBarLayout.setDrawerLayoutContainer(this.drawerLayoutContainer);
        syncDrawerContainerEnabled();
        this.actionBarLayout.setFragmentStack(this.mainFragmentsStack);
        this.actionBarLayout.setFragmentStackChangedListener(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda19
        ...
        NotificationCenter.getInstance(this.currentAccount).addObserver(this, NotificationCenter.guardBotDecisionResult);
        Utilities.Callback<Boolean> callback = new Utilities.Callback() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda20
        ...
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1045d("OS name " + lowerCase2 + " " + lowerCase);
            }
        ...
        if (i3 >= 28 && ((ActivityManager) getSystemService("activity")).isBackgroundRestricted() && System.currentTimeMillis() - SharedConfig.BackgroundActivityPrefs.getLastCheckedBackgroundActivity() >= DurationKt.MILLIS_IN_DAY && SharedConfig.BackgroundActivityPrefs.getDismissedCount() < 3) {
        ...
        if (i3 >= 31) {
            ...
            getWindow().getDecorView().addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: org.telegram.ui.LaunchActivity.7
                public ViewOnAttachStateChangeListenerC59077() {
                }
        ...
        Bulletin.addDelegate(this.frameLayout, new Bulletin.Delegate() { // from class: org.telegram.ui.LaunchActivity.8
            ...
            public int getBottomOffset(int i4) {
                return AndroidUtilities.navigationBarHeight + AndroidUtilities.m1036dp(16.0f);
            }
        });
        ...
        if (i3 >= 34 && ExteraConfig.getPredictiveBackIntensity() > 0.0f) {
            if (this.onBackAnimationCallback == null) {
                this.onBackAnimationCallback = new OnBackAnimationCallback() { // from class: org.telegram.ui.LaunchActivity.9
                    ...
                    public void onBackInvoked() {
                        ...
                        if (launchActivity.onBackPressed(true)) {
                            ...
                            ActionBarLayout actionBarLayout2 = launchActivity2.actionBarLayout;
                            if (actionBarLayout2 != null) {
                                actionBarLayout2.onBackInvoked();
                            } else {
                                launchActivity2.onBackPressed();
                            }
                        }
                    }
                    ...
                    private void onBackStartedInternal(BackEvent backEvent) {
                        if (!AndroidUtilities.isTablet() && LaunchActivity.this.onBackPressed(false)) {
                            ...
                            if (actionBarLayout2 == null || !actionBarLayout2.onBackStarted(backEvent.getTouchX(), backEvent.getTouchY()) || this.locked) {
                                return;
                            }
                            this.locker.lock();
                            this.locked = true;
            ...
            getOnBackInvokedDispatcher().registerOnBackInvokedCallback(0, LaunchActivity$$ExternalSyntheticApiModelOutline0.m1179m(this.onBackAnimationCallback));
        } else if (i3 >= 33) {
            ...
            getOnBackInvokedDispatcher().registerOnBackInvokedCallback(0, C0045xf5eeb9b9.m4m(this.onBackInvokedCallback));
        }
        checkFrameMetrics();
    }
    ...
    public class C59012 extends FrameLayout {
        public C59012(final LaunchActivity this) {
            super(this);
        }
    ...
    public class C59033 implements IPipActivityListener {
        final ActivityVisibilityController activityVisibilityController;
    ...
    public class C59044 extends DrawerLayoutContainer {
        private boolean wasPortrait;

        public C59044(Context context) {
            super(context);
        }

        @Override // org.telegram.p035ui.ActionBar.DrawerLayoutContainer, android.widget.FrameLayout, android.view.ViewGroup, android.view.View
        ...
        @Override // org.telegram.p035ui.ActionBar.DrawerLayoutContainer, android.view.ViewGroup, android.view.View
        public void dispatchDraw(Canvas canvas) {
    ...
    public class C59055 extends ImageView {
        public C59055(final LaunchActivity this) {
            super(this);
        }
    ...
    public class C59066 extends FireworksOverlay {
        public C59066(final LaunchActivity this) {
            super(this);
            setVisibility(8);
        }
    ...
    public static /* synthetic */ void $r8$lambda$DDOCmwt7UXAtUfyR4lE720_wK_U(View view) {
        ...
        FileLog.m1045d("height = " + measuredHeight + " displayHeight = " + AndroidUtilities.displaySize.y);
        int i = (measuredHeight - AndroidUtilities.navigationBarHeight) - AndroidUtilities.statusBarHeight;
        if (i <= AndroidUtilities.m1036dp(100.0f) || i >= AndroidUtilities.displaySize.y) {
            return;
        }
        int iM1036dp = AndroidUtilities.m1036dp(100.0f) + i;
        Point point = AndroidUtilities.displaySize;
        if (iM1036dp > point.y) {
            point.y = i;
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1045d("fix display size y to " + AndroidUtilities.displaySize.y);
            }
        }
    }

    /* JADX INFO: renamed from: org.telegram.ui.LaunchActivity$7 */
    public class ViewOnAttachStateChangeListenerC59077 implements View.OnAttachStateChangeListener {
        public ViewOnAttachStateChangeListenerC59077() {
        }
    ...
    public class C59088 implements Bulletin.Delegate {
        public C59088() {
        }
    ...
    public class C59099 implements OnBackAnimationCallback {
        private boolean locked;
        private boolean predictiveBackStarted;
        private AnimationNotificationsLocker locker = new AnimationNotificationsLocker();
        private boolean started = false;
    ...
    public class C589110 implements OnBackInvokedCallback {
        public C589110() {
        }
    ...
    public void checkFrameMetrics() {
        if (this.frameMetricsOverlayView == null && SharedConfig.frameMetricsEnabled) {
            this.frameMetricsOverlayView = FrameMetricsOverlayView.attachToActivityCorner(this, NavigationBarView.ITEM_GRAVITY_START_CENTER, 12, this.frameLayout);
        }
    ...
    public static void showAttachMenuBot(LaunchActivity launchActivity, int i, TLRPC.TL_attachMenuBot tL_attachMenuBot, String str, boolean z) {
        ...
        WebViewRequestProps webViewRequestPropsM1233of = WebViewRequestProps.m1233of(i, j, j, tL_attachMenuBot.short_name, null, 1, 0, 0L, false, null, false, str, null, 2, false, false);
        if (launchActivity.getBottomSheetTabs() == null || launchActivity.getBottomSheetTabs().tryReopenTab(webViewRequestPropsM1233of) == null) {
            ...
            botWebViewSheet.requestWebView(lastFragment, webViewRequestPropsM1233of);
    ...
    private void setupActionBarLayout() {
        int iIndexOfChild = this.drawerLayoutContainer.indexOfChild(this.drawerLayoutContainer.indexOfChild(this.launchLayout) != -1 ? this.launchLayout : this.actionBarLayout.getView());
        if (iIndexOfChild != -1) {
            this.drawerLayoutContainer.removeViewAt(iIndexOfChild);
        }
        if (AndroidUtilities.isTablet()) {
            getWindow().setSoftInputMode(16);
            C589211 c589211 = new RelativeLayout(this) { // from class: org.telegram.ui.LaunchActivity.11
                private boolean inLayout;

                public C589211(final Context this) {
                    super(this);
                }
                ...
                public void onMeasure(int i, int i2) {
                    ...
                    if (!AndroidUtilities.isInMultiwindow && (!AndroidUtilities.isSmallTablet() || getResources().getConfiguration().orientation == 2)) {
                        ...
                        int iM1036dp = (size / 100) * 35;
                        if (iM1036dp < AndroidUtilities.m1036dp(320.0f)) {
                            iM1036dp = AndroidUtilities.m1036dp(320.0f);
                        }
                        LaunchActivity.this.actionBarLayout.getView().measure(View.MeasureSpec.makeMeasureSpec(iM1036dp, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, TLObject.FLAG_30));
                        LaunchActivity.this.shadowTabletSide.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(1.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, TLObject.FLAG_30));
                        LaunchActivity.this.rightActionBarLayout.getView().measure(View.MeasureSpec.makeMeasureSpec(size - iM1036dp, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, TLObject.FLAG_30));
                    } else {
                    ...
                    LaunchActivity.this.layersActionBarLayout.getView().measure(View.MeasureSpec.makeMeasureSpec(Math.min(AndroidUtilities.m1036dp(500.0f), size - AndroidUtilities.m1036dp(16.0f)), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(((size2 - AndroidUtilities.statusBarHeight) - AndroidUtilities.navigationBarHeight) - AndroidUtilities.m1036dp(16.0f), TLObject.FLAG_30));
                    this.inLayout = false;
                }
                ...
                public void onLayout(boolean z, int i, int i2, int i3, int i4) {
                    int i5 = i3 - i;
                    if (!AndroidUtilities.isInMultiwindow && (!AndroidUtilities.isSmallTablet() || getResources().getConfiguration().orientation == 2)) {
                        int iM1036dp = (i5 / 100) * 35;
                        if (iM1036dp < AndroidUtilities.m1036dp(320.0f)) {
                            iM1036dp = AndroidUtilities.m1036dp(320.0f);
                        }
                        LaunchActivity.this.shadowTabletSide.layout(iM1036dp, 0, LaunchActivity.this.shadowTabletSide.getMeasuredWidth() + iM1036dp, LaunchActivity.this.shadowTabletSide.getMeasuredHeight());
                        ...
                        LaunchActivity.this.rightActionBarLayout.getView().layout(iM1036dp, 0, LaunchActivity.this.rightActionBarLayout.getView().getMeasuredWidth() + iM1036dp, LaunchActivity.this.rightActionBarLayout.getView().getMeasuredHeight());
                    } else {
                        LaunchActivity.this.actionBarLayout.getView().layout(0, 0, LaunchActivity.this.actionBarLayout.getView().getMeasuredWidth(), LaunchActivity.this.actionBarLayout.getView().getMeasuredHeight());
                    }
                    int measuredWidth = (i5 - LaunchActivity.this.layersActionBarLayout.getView().getMeasuredWidth()) / 2;
                    int iM1036dp2 = AndroidUtilities.statusBarHeight + AndroidUtilities.m1036dp(8.0f);
                    LaunchActivity.this.layersActionBarLayout.getView().layout(measuredWidth, iM1036dp2, LaunchActivity.this.layersActionBarLayout.getView().getMeasuredWidth() + measuredWidth, LaunchActivity.this.layersActionBarLayout.getView().getMeasuredHeight() + iM1036dp2);
            ...
            this.launchLayout = c589211;
            DrawerLayoutContainer drawerLayoutContainer = this.drawerLayoutContainer;
            if (iIndexOfChild != -1) {
                drawerLayoutContainer.addView(c589211, iIndexOfChild, LayoutHelper.createFrame(-1, -1.0f));
            } else {
                drawerLayoutContainer.addView(c589211, LayoutHelper.createFrame(-1, -1.0f));
            }
            C589312 c589312 = new SizeNotifierFrameLayout(this) { // from class: org.telegram.ui.LaunchActivity.12
                @Override // org.telegram.p035ui.Components.SizeNotifierFrameLayout
                public boolean isActionBarVisible() {
                    return false;
                }

                public C589312(final Context this) {
                    super(this);
                }
            };
            this.backgroundTablet = c589312;
            c589312.setOccupyStatusBar(false);
            ...
            this.shadowTablet.setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda16
                @Override // android.view.View.OnTouchListener
                public final boolean onTouch(View view, MotionEvent motionEvent) {
                    return this.f$0.lambda$setupActionBarLayout$3(view, motionEvent);
                }
            });
            this.shadowTablet.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda17
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    LaunchActivity.$r8$lambda$65VHYkg1vsJ3EsSWZZHCDAFY2UU(view);
                }
            });
            ...
            view.setVisibility(this.layerFragmentsStack.isEmpty() ? 8 : 0);
            this.launchLayout.addView(view);
        } else {
            ...
            if (iIndexOfChild != -1) {
                drawerLayoutContainer2.addView(this.actionBarLayout.getView(), iIndexOfChild, new ViewGroup.LayoutParams(-1, -1));
            } else {
                drawerLayoutContainer2.addView(this.actionBarLayout.getView(), new ViewGroup.LayoutParams(-1, -1));
            }
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C589211 extends RelativeLayout {
        private boolean inLayout;

        public C589211(final LaunchActivity this) {
            super(this);
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C589312 extends SizeNotifierFrameLayout {
        @Override // org.telegram.p035ui.Components.SizeNotifierFrameLayout
        public boolean isActionBarVisible() {
            return false;
        }

        public C589312(final LaunchActivity this) {
            super(this);
        }
    }
    ...
    public void checkSystemBarColors(boolean z, boolean z2, boolean z3) {
        ...
        if (Build.VERSION.SDK_INT >= 26 && z3 && (!z || baseFragment == null || !baseFragment.isInPreviewMode())) {
            ...
            if (this.actionBarLayout.getSheetFragment(false) != null) {
                ...
                if (sheetFragment.sheetsStack != null) {
                    for (int i = 0; i < sheetFragment.sheetsStack.size(); i++) {
                        BaseFragment.AttachedSheet attachedSheet2 = sheetFragment.sheetsStack.get(i);
            ...
            while (it.hasNext()) {
                color = it.next().getNavigationBarColor(color);
                c2 = 0;
            }
            setNavigationBarColor(color);
            if ((c2 != 0 || AndroidUtilities.computePerceivedBrightness(color) < 0.721f) && c2 != 1) {
                z4 = false;
            }
    ...
    public void switchToAccount(int i, boolean z, GenericProvider<Void, MainTabsActivity> genericProvider) {
        ...
        if (z) {
            ...
            actionBarLayout3.removeFragmentFromStack(0);
        }
        this.actionBarLayout.addFragmentToStack(genericProvider.provide(null), -3);
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda122
            @Override // java.lang.Runnable
            public final void run() {
                PillStackConfig.notifySettingsChanged(PillType.GRAM.getId(), PillType.BTC.getId(), PillType.USD.getId());
            }
        }, 150L);
    }
    ...
    public void clearFragments() {
        ...
        if (AndroidUtilities.isTablet()) {
            ArrayList<BaseFragment> arrayList2 = this.layerFragmentsStack;
            ...
            ArrayList<BaseFragment> arrayList3 = this.rightFragmentsStack;
            int size3 = arrayList3.size();
            while (i < size3) {
                BaseFragment baseFragment3 = arrayList3.get(i);
                i++;
                baseFragment3.onFragmentDestroy();
            }
    ...
    private void checkCurrentAccount() {
        ...
        if (i != UserConfig.selectedAccount) {
            ...
            NotificationCenter.getInstance(this.currentAccount).removeObserver(this, NotificationCenter.guardBotDecisionResult);
        }
    ...
    private void syncDrawerContainerEnabled() {
        ...
        boolean navigationDrawer = ExteraConfig.getNavigationDrawer();
        DrawerLayoutContainer drawerLayoutContainer = this.drawerLayoutContainer;
        if (navigationDrawer) {
    ...
    private void showTosActivity(int i, TLRPC.TL_help_termsOfService tL_help_termsOfService) {
        if (this.termsOfServiceView == null) {
            ...
            this.termsOfServiceView.setDelegate(new C589413());
        }
        TLRPC.TL_help_termsOfService tL_help_termsOfService2 = UserConfig.getInstance(i).unacceptedTermsOfService;
        if (tL_help_termsOfService2 != tL_help_termsOfService && (tL_help_termsOfService2 == null || !tL_help_termsOfService2.f1312id.data.equals(tL_help_termsOfService.f1312id.data))) {
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C589413 implements TermsOfServiceView.TermsOfServiceViewDelegate {
        public C589413() {
        }
    ...
    /* JADX WARN: Failed to restore switch over string. Please report as a decompilation issue */
    /* JADX WARN: Multi-variable search skipped. Vars limit reached: 8309 (expected less than 5000) */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:2034:0x01a0  */
    /* JADX WARN: Removed duplicated region for block: B:2054:0x01ef  */
    /* JADX WARN: Removed duplicated region for block: B:2061:0x0210  */
    /* JADX WARN: Removed duplicated region for block: B:2069:0x023b  */
    /* JADX WARN: Removed duplicated region for block: B:2074:0x0249  */
    /* JADX WARN: Removed duplicated region for block: B:2151:0x037b  */
    /* JADX WARN: Removed duplicated region for block: B:2186:0x0459  */
    /* JADX WARN: Removed duplicated region for block: B:2255:0x0583  */
    /* JADX WARN: Removed duplicated region for block: B:2381:0x0909  */
    /* JADX WARN: Removed duplicated region for block: B:2504:0x0d7c  */
    /* JADX WARN: Removed duplicated region for block: B:2506:0x0d7f  */
    /* JADX WARN: Removed duplicated region for block: B:2514:0x0db5  */
    /* JADX WARN: Removed duplicated region for block: B:2592:0x1070  */
    /* JADX WARN: Removed duplicated region for block: B:2593:0x1079  */
    /* JADX WARN: Removed duplicated region for block: B:2649:0x1245  */
    /* JADX WARN: Removed duplicated region for block: B:2651:0x1284  */
    /* JADX WARN: Removed duplicated region for block: B:3028:0x250c  */
    /* JADX WARN: Removed duplicated region for block: B:3111:0x2944  */
    /* JADX WARN: Removed duplicated region for block: B:3148:0x2a1c  */
    /* JADX WARN: Removed duplicated region for block: B:3152:0x2a2a A[Catch: Exception -> 0x2a3e, TRY_LEAVE, TryCatch #28 {Exception -> 0x2a3e, blocks: (B:3150:0x2a20, B:3152:0x2a2a), top: B:3814:0x2a20 }] */
    /* JADX WARN: Removed duplicated region for block: B:3154:0x2a38  */
    /* JADX WARN: Removed duplicated region for block: B:3169:0x2b27  */
    /* JADX WARN: Removed duplicated region for block: B:3171:0x2b2a  */
    /* JADX WARN: Removed duplicated region for block: B:3176:0x2b66  */
    /* JADX WARN: Removed duplicated region for block: B:3177:0x2b8d  */
    /* JADX WARN: Removed duplicated region for block: B:3198:0x2d91  */
    /* JADX WARN: Removed duplicated region for block: B:3207:0x2dff  */
    /* JADX WARN: Removed duplicated region for block: B:3229:0x2f04  */
    /* JADX WARN: Removed duplicated region for block: B:3252:0x2f88  */
    /* JADX WARN: Removed duplicated region for block: B:3264:0x3101  */
    /* JADX WARN: Removed duplicated region for block: B:3274:0x3134  */
    /* JADX WARN: Removed duplicated region for block: B:3275:0x3138  */
    /* JADX WARN: Removed duplicated region for block: B:3277:0x314e  */
    /* JADX WARN: Removed duplicated region for block: B:3279:0x3152  */
    /* JADX WARN: Removed duplicated region for block: B:3284:0x316d  */
    /* JADX WARN: Removed duplicated region for block: B:3355:0x3270  */
    /* JADX WARN: Removed duplicated region for block: B:3378:0x3324  */
    /* JADX WARN: Removed duplicated region for block: B:3379:0x3338  */
    /* JADX WARN: Removed duplicated region for block: B:3441:0x3760  */
    /* JADX WARN: Removed duplicated region for block: B:3455:0x3797  */
    /* JADX WARN: Removed duplicated region for block: B:3468:0x37de  */
    /* JADX WARN: Removed duplicated region for block: B:3482:0x3830  */
    /* JADX WARN: Removed duplicated region for block: B:3502:0x38b8  */
    /* JADX WARN: Removed duplicated region for block: B:3614:0x3ae1  */
    /* JADX WARN: Removed duplicated region for block: B:3615:0x3af3  */
    /* JADX WARN: Removed duplicated region for block: B:3618:0x3b01  */
    /* JADX WARN: Removed duplicated region for block: B:3699:0x3d7a  */
    /* JADX WARN: Removed duplicated region for block: B:3701:0x3d83 A[ADDED_TO_REGION] */
    /* JADX WARN: Removed duplicated region for block: B:3704:0x3d8b  */
    /* JADX WARN: Removed duplicated region for block: B:3715:0x3dd1  */
    /* JADX WARN: Removed duplicated region for block: B:3725:0x3e0b  */
    /* JADX WARN: Removed duplicated region for block: B:3729:0x3e22  */
    /* JADX WARN: Removed duplicated region for block: B:3733:0x3e3f  */
    /* JADX WARN: Removed duplicated region for block: B:3737:0x3e4b  */
    /* JADX WARN: Removed duplicated region for block: B:3797:0x2507 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:3811:0x250f A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /* JADX WARN: Type inference failed for: r0v20, types: [org.telegram.ui.ActionBar.BaseFragment, org.telegram.ui.MainTabsActivity] */
    /* JADX WARN: Type inference failed for: r0v22, types: [org.telegram.ui.ActionBar.ActionBarLayout, org.telegram.ui.ActionBar.INavigationLayout] */
    /* JADX WARN: Type inference failed for: r0v24, types: [org.telegram.ui.ActionBar.ActionBarLayout, org.telegram.ui.ActionBar.INavigationLayout] */
    /* JADX WARN: Type inference failed for: r0v25, types: [org.telegram.ui.ActionBar.ActionBarLayout, org.telegram.ui.ActionBar.INavigationLayout] */
    /* JADX WARN: Type inference failed for: r0v32, types: [org.telegram.ui.ActionBar.BaseFragment, org.telegram.ui.MainTabsActivity] */
    /* JADX WARN: Type inference failed for: r0v77, types: [android.os.BaseBundle, android.os.Bundle] */
    ...
    /* JADX WARN: Type inference failed for: r121v0, types: [android.app.Activity, android.content.Context, org.telegram.ui.BasePermissionsActivity, org.telegram.ui.LaunchActivity] */
    ...
    /* JADX WARN: Type inference failed for: r16v138 */
    /* JADX WARN: Type inference failed for: r16v139 */
    /* JADX WARN: Type inference failed for: r16v140 */
    /* JADX WARN: Type inference failed for: r16v27, types: [java.lang.Integer] */
    /* JADX WARN: Type inference failed for: r16v35 */
    /* JADX WARN: Type inference failed for: r16v99 */
    /* JADX WARN: Type inference failed for: r17v18, types: [java.lang.Long] */
    ...
    /* JADX WARN: Type inference failed for: r19v21, types: [java.lang.Integer] */
    ...
    /* JADX WARN: Type inference failed for: r2v19, types: [org.telegram.ui.ActionBar.ActionBarLayout] */
    /* JADX WARN: Type inference failed for: r2v22, types: [org.telegram.ui.ActionBar.ActionBarLayout] */
    /* JADX WARN: Type inference failed for: r2v48, types: [org.telegram.ui.ActionBar.INavigationLayout$NavigationParams] */
    /* JADX WARN: Type inference failed for: r2v65, types: [android.os.BaseBundle, android.os.Bundle] */
    /* JADX WARN: Type inference failed for: r2v73, types: [org.telegram.ui.ActionBar.INavigationLayout$NavigationParams] */
    /* JADX WARN: Type inference failed for: r4v22, types: [org.telegram.ui.ActionBar.INavigationLayout$NavigationParams] */
    /* JADX WARN: Type inference failed for: r4v31, types: [org.telegram.ui.ActionBar.INavigationLayout$NavigationParams] */
    /* JADX WARN: Type inference failed for: r4v37, types: [org.telegram.ui.ActionBar.INavigationLayout$NavigationParams] */
    /* JADX WARN: Type inference failed for: r4v38, types: [org.telegram.ui.ActionBar.INavigationLayout$NavigationParams] */
    /* JADX WARN: Type inference failed for: r4v46, types: [org.telegram.ui.ActionBar.INavigationLayout$NavigationParams] */
    /* JADX WARN: Type inference failed for: r56v0, types: [java.lang.Integer] */
    /* JADX WARN: Type inference failed for: r56v2 */
    /* JADX WARN: Type inference failed for: r56v42 */
    /* JADX WARN: Type inference failed for: r56v72 */
    /* JADX WARN: Type inference failed for: r56v73 */
    /* JADX WARN: Type inference failed for: r56v74 */
    /* JADX WARN: Type inference failed for: r56v75 */
    /* JADX WARN: Type inference failed for: r56v76 */
    /* JADX WARN: Type inference failed for: r58v0, types: [byte[]] */
    /* JADX WARN: Type inference failed for: r58v2 */
    /* JADX WARN: Type inference failed for: r58v41 */
    /* JADX WARN: Type inference failed for: r58v59 */
    /* JADX WARN: Type inference failed for: r58v60 */
    ...
    */
    private boolean handleIntent(android.content.Intent r122, boolean r123, boolean r124, boolean r125, final org.telegram.messenger.browser.Browser.Progress r126, boolean r127, boolean r128) throws java.lang.Throwable {
        /*
            Method dump skipped, instruction units count: 16000
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.LaunchActivity.handleIntent(android.content.Intent, boolean, boolean, boolean, org.telegram.messenger.browser.Browser$Progress, boolean, boolean):boolean");
    }
        ...
        if (tLObject == null) {
            if (tL_error != null) {
                if ("URL_EXPIRED".equalsIgnoreCase(tL_error.text)) {
                    OAuthSheet.getBulletinFactory().createSimpleBulletin(C2797R.raw.error, getString(C2797R.string.BotAuthLoggedInFailTitle), getString(C2797R.string.BotAuthLoggedInFailNoDomain)).show();
                    return;
                } else {
    ...
    public /* synthetic */ void lambda$handleIntent$16(long j, long j2, ChatActivity chatActivity) {
        FileLog.m1045d("LaunchActivity openForum after load " + j + " " + j2 + " TL_forumTopic " + MessagesController.getInstance(this.currentAccount).getTopicsController().findTopic(j, j2));
        if (this.actionBarLayout != null) {
            ForumUtilities.applyTopic(chatActivity, MessagesStorage.TopicKey.m1066of(-j, j2));
            getActionBarLayout().presentFragment(chatActivity);
        }
    }

    public /* synthetic */ void lambda$handleIntent$18(final int[] iArr, LocationController.SharingLocationInfo sharingLocationInfo) {
        ...
        locationActivity.setDelegate(new LocationActivity.LocationActivityDelegate() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda111
            ...
            public final void didSelectLocation(TLRPC.MessageMedia messageMedia, int i2, boolean z, int i3, long j) {
                SendMessagesHelper.getInstance(iArr[0]).sendMessage(SendMessagesHelper.SendMessageParams.m1079of(messageMedia, dialogId, (MessageObject) null, (MessageObject) null, (TLRPC.ReplyMarkup) null, (HashMap<String, String>) null, z, i3, 0));
            }
        });
        lambda$runLinkRequest$101(locationActivity);
    }

    public /* synthetic */ void lambda$handleIntent$19() {
        if (this.actionBarLayout.getFragmentStack().isEmpty()) {
            return;
        }
    ...
    public /* synthetic */ void lambda$handleIntent$21(TLObject tLObject, TLRPC.TL_error tL_error) {
        if (tLObject != null) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda45
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$handleIntent$20(password);
                }
            });
        }
    }

    public /* synthetic */ void lambda$handleIntent$22(BaseFragment baseFragment, boolean z) {
        presentFragment(baseFragment, z, false);
    }

    public /* synthetic */ void lambda$handleIntent$23(boolean z, int[] iArr, TLRPC.User user, String str, ContactsActivity contactsActivity) {
        TLRPC.UserFull userFull = MessagesController.getInstance(this.currentAccount).getUserFull(user.f1407id);
    ...
    public /* synthetic */ void lambda$handleIntent$27(final ActionIntroActivity actionIntroActivity, String str) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_auth_acceptLoginToken, new RequestDelegate() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda152
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda169
                    @Override // java.lang.Runnable
                    public final void run() {
                        LaunchActivity.m16833$r8$lambda$swXf3dSvh8HHFZzxTC8rZQJfnc(alertDialog, tLObject, actionIntroActivity, tL_error);
                    }
                });
            }
        });
    ...
    /* JADX INFO: renamed from: $r8$lambda$swXf3d-Svh8HHFZzxTC8rZQJfnc */
    public static /* synthetic */ void m16833$r8$lambda$swXf3dSvh8HHFZzxTC8rZQJfnc(AlertDialog alertDialog, TLObject tLObject, final ActionIntroActivity actionIntroActivity, final TLRPC.TL_error tL_error) {
        try {
            alertDialog.dismiss();
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda179
            @Override // java.lang.Runnable
            public final void run() {
                AlertsCreator.showSimpleAlert(actionIntroActivity, LocaleController.getString(C2797R.string.AuthAnotherClient), LocaleController.getString(C2797R.string.ErrorOccurred) + "\n" + tL_error.text);
            }
        });
    }

    public /* synthetic */ void lambda$handleIntent$28(BaseFragment baseFragment, String str, String str2, AlertDialog alertDialog, int i) {
    ...
    public void lambda$handleIntent$20(TL_account.Password password) {
        String str;
        final LoginActivity loginActivityChangeEmail = new LoginActivity().changeEmail(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda123
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$openEmailSettings$29();
            }
        });
        if (password != null && (str = password.login_email_pattern) != null) {
            ...
            new AlertDialog.Builder(this).setTitle(spannableStringBuilderValueOf).setMessage(getString(C2797R.string.EmailLoginChangeMessage)).setPositiveButton(getString(C2797R.string.ChangeEmail), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda124
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i2) {
                    this.f$0.lambda$openEmailSettings$30(loginActivityChangeEmail, alertDialog, i2);
                }
            }).setNegativeButton(getString(C2797R.string.Cancel), null).show();
            return;
        }
        lambda$runLinkRequest$101(loginActivityChangeEmail);
    }

    public /* synthetic */ void lambda$openEmailSettings$29() {
        ...
        lottieLayout.textView.setText(getString(C2797R.string.YourLoginEmailChangedSuccess));
        BaseFragment lastFragment = getLastFragment();
        if (lastFragment != null) {
    ...
    public /* synthetic */ void lambda$openEmailSettings$30(LoginActivity loginActivity, AlertDialog alertDialog, int i) {
    ...
    private void openDialogsToSend(boolean z) {
        ...
        if (arrayList2 != null) {
            if (arrayList2.size() != 1) {
                bundle.putString("selectAlertString", LocaleController.getString(C2797R.string.SendMessagesToText));
                bundle.putString("selectAlertStringGroup", LocaleController.getString(C2797R.string.SendContactToGroupText));
            }
        } else {
            bundle.putString("selectAlertString", LocaleController.getString(C2797R.string.SendMessagesToText));
            bundle.putString("selectAlertStringGroup", LocaleController.getString(C2797R.string.SendMessagesToGroupText));
        }
        DialogsActivity dialogsActivity = new DialogsActivity(bundle);
        dialogsActivity.setDelegate(this);
        if (this.videoPath != null || ((arrayList = this.photoPathsArray) != null && !arrayList.isEmpty())) {
            ArrayList<MediaController.PhotoEntry> arrayList3 = new ArrayList<>();
            ...
            if (!arrayList3.isEmpty()) {
                if (!TextUtils.isEmpty(this.sendingText)) {
                    arrayList3.get(0).caption = this.sendingText;
                }
            ...
            if (strExtractFirstUrl != null) {
                dialogsActivity.setSharedLink(strExtractFirstUrl, charSequence);
            } else {
    ...
    private int runCommentRequest(final int i, final Runnable runnable, final Integer num, final Integer num2, final Long l, final Integer num3, final byte[] bArr, final TLRPC.Chat chat, final Runnable runnable2, final String str, final int i2, final int i3) {
        ...
        return ConnectionsManager.getInstance(i).sendRequest(tL_messages_getDiscussionMessage, new RequestDelegate() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda118
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                this.f$0.lambda$runCommentRequest$32(i, chat, l, num2, num, runnable2, str, num3, bArr, i2, i3, tL_messages_getDiscussionMessage, runnable, tLObject, tL_error);
            }
        });
    }

    public /* synthetic */ void lambda$runCommentRequest$32(final int i, final TLRPC.Chat chat, final Long l, final Integer num, final Integer num2, final Runnable runnable, final String str, final Integer num3, final byte[] bArr, final int i2, final int i3, final TLRPC.TL_messages_getDiscussionMessage tL_messages_getDiscussionMessage, final Runnable runnable2, final TLObject tLObject, TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda146
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$runCommentRequest$31(tLObject, i, chat, l, num, num2, runnable, str, num3, bArr, i2, i3, tL_messages_getDiscussionMessage, runnable2);
            }
        });
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public /* synthetic */ void lambda$runCommentRequest$31(org.telegram.tgnet.TLObject r14, int r15, org.telegram.tgnet.TLRPC.Chat r16, java.lang.Long r17, java.lang.Integer r18, java.lang.Integer r19, java.lang.Runnable r20, java.lang.String r21, java.lang.Integer r22, byte[] r23, int r24, int r25, org.telegram.tgnet.TLRPC.TL_messages_getDiscussionMessage r26, java.lang.Runnable r27) {
        /*
            Method dump skipped, instruction units count: 322
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.LaunchActivity.lambda$runCommentRequest$31(org.telegram.tgnet.TLObject, int, org.telegram.tgnet.TLRPC$Chat, java.lang.Long, java.lang.Integer, java.lang.Integer, java.lang.Runnable, java.lang.String, java.lang.Integer, byte[], int, int, org.telegram.tgnet.TLRPC$TL_messages_getDiscussionMessage, java.lang.Runnable):void");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void openTopicRequest(final int r16, int r17, final org.telegram.tgnet.TLRPC.Chat r18, final int r19, org.telegram.tgnet.TLRPC.TL_forumTopic r20, final java.lang.Runnable r21, final java.lang.String r22, final java.lang.Integer r23, final byte[] r24, final int r25, final java.util.ArrayList<org.telegram.messenger.MessageObject> r26, final int r27) {
        /*
            Method dump skipped, instruction units count: 300
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.LaunchActivity.openTopicRequest(int, int, org.telegram.tgnet.TLRPC$Chat, int, org.telegram.tgnet.TLRPC$TL_forumTopic, java.lang.Runnable, java.lang.String, java.lang.Integer, byte[], int, java.util.ArrayList, int):void");
    }

    public /* synthetic */ void lambda$openTopicRequest$34(final int i, final TLRPC.Chat chat, final int i2, final int i3, final Runnable runnable, final String str, final Integer num, final byte[] bArr, final int i4, final ArrayList arrayList, final int i5, final TLObject tLObject, final TLRPC.TL_error tL_error) {
    ...
    public /* synthetic */ void lambda$openTopicRequest$33(TLRPC.TL_error tL_error, TLObject tLObject, int i, TLRPC.Chat chat, int i2, int i3, Runnable runnable, String str, Integer num, byte[] bArr, int i4, ArrayList arrayList, int i5) {
        if (tL_error == null) {
            ...
            for (int i6 = 0; i6 < tL_messages_forumTopics.messages.size(); i6++) {
                longSparseArray.put(tL_messages_forumTopics.messages.get(i6).f1271id, tL_messages_forumTopics.messages.get(i6));
            }
            ...
            MessagesController.getInstance(i).getTopicsController().processTopics(chat.f1245id, tL_messages_forumTopics.topics, longSparseArray, false, 2, -1);
            openTopicRequest(i, i2, chat, i3, MessagesController.getInstance(i).getTopicsController().findTopic(chat.f1245id, i2), runnable, str, num, bArr, i4, arrayList, i5);
        }
    }

    /* JADX WARN: Code restructure failed: missing block: B:128:0x004e, code lost:
    
        r6 = new java.io.BufferedReader(new java.io.InputStreamReader(r0));
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private java.lang.String readImport(android.net.Uri r7) throws java.lang.Throwable {
        /*
            Method dump skipped, instruction units count: 245
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.LaunchActivity.readImport(android.net.Uri):java.lang.String");
    }
    ...
    private void runImportRequest(final Uri uri, ArrayList<Uri> arrayList) throws Throwable {
        ...
        iArr[0] = ConnectionsManager.getInstance(i).sendRequest(tL_messages_checkHistoryImport, new RequestDelegate() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda55
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                this.f$0.lambda$runImportRequest$36(uri, i, alertDialog, tLObject, tL_error);
            }
        });
        final Runnable runnable = null;
        alertDialog.setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda56
            @Override // android.content.DialogInterface.OnCancelListener
            public final void onCancel(DialogInterface dialogInterface) {
                LaunchActivity.$r8$lambda$t8gETfOolZF34s8bP4sz4nIfK1U(i, iArr, runnable, dialogInterface);
            }
        });
        try {
    ...
    public /* synthetic */ void lambda$runImportRequest$36(final Uri uri, final int i, final AlertDialog alertDialog, final TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    public /* synthetic */ void lambda$runImportRequest$35(TLObject tLObject, Uri uri, int i, AlertDialog alertDialog) {
        boolean z;
        if (isFinishing()) {
            return;
        }
        ...
        if (tLObject != null && this.actionBarLayout != null) {
            ...
            bundle.putBoolean("allowSwitchAccount", true);
            if (tL_messages_historyImportParsed.f1360pm) {
    ...
    public static /* synthetic */ void $r8$lambda$t8gETfOolZF34s8bP4sz4nIfK1U(int i, int[] iArr, Runnable runnable, DialogInterface dialogInterface) {
    ...
    public void openMessage(final long j, final int i, final String str, final Browser.Progress progress, int i2, final int i3, final Integer num, final byte[] bArr) {
        ...
        if (j < 0 && (chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(-j))) != null && ChatObject.isForum(chat)) {
            ...
            openForumFromLink(j, Integer.valueOf(i), str, num, bArr, new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda155
                @Override // java.lang.Runnable
                public final void run() {
                    LaunchActivity.$r8$lambda$XRXtU1WgKRmPfPHe76sbDecUuNw(progress);
                }
            }, i2, i3);
            return;
        }
        ...
        if (j >= 0) {
            ...
            if (chat2 != null && chat2.forum) {
                openForumFromLink(j, Integer.valueOf(i), str, num, bArr, new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda156
                    @Override // java.lang.Runnable
                    public final void run() {
                        LaunchActivity.$r8$lambda$5yJmt7eer039p7GDxu1DnBa5ut0(progress);
                    }
                }, i2, i3);
                return;
            }
        ...
        if (this.mainFragmentsStack.isEmpty()) {
            ...
            baseFragment = this.mainFragmentsStack.get(r1.size() - 1);
        }
        ...
        if (baseFragment2 == null || MessagesController.getInstance(this.currentAccount).checkCanOpenChat(bundle, baseFragment2)) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda157
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$openMessage$43(bundle, bArr, i, num, str, i3, j, progress, baseFragment2);
                }
            });
        }
    }
    ...
    public static /* synthetic */ void $r8$lambda$5yJmt7eer039p7GDxu1DnBa5ut0(Browser.Progress progress) {
        if (progress != null) {
            progress.end();
        }
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public /* synthetic */ void lambda$openMessage$43(final android.os.Bundle r17, final byte[] r18, final int r19, final java.lang.Integer r20, java.lang.String r21, int r22, final long r23, final org.telegram.messenger.browser.Browser.Progress r25, final org.telegram.p035ui.ActionBar.BaseFragment r26) {
        /*
            r16 = this;
            r1 = r16
            r7 = r18
            ...
            r10.<init>(r9)
            if (r7 == 0) goto L1d
            r10.highlightPollOptionId = r7
            r10.setHighlightMessageId(r5)
        L18:
            r11 = r21
            r12 = r22
            goto L2c
        L1d:
            if (r6 == 0) goto L25
            r10.highlightTaskId = r6
            r10.setHighlightMessageId(r5)
            goto L18
        L25:
            r11 = r21
            r12 = r22
            r10.setHighlightQuote(r5, r11, r12)
        L2c:
            ...
            goto L39
        L35:
            org.telegram.ui.ActionBar.INavigationLayout r0 = r1.getActionBarLayout()
        L39:
            boolean r0 = r0.presentFragment(r10)
            if (r0 != 0) goto L75
            r13 = 0
            ...
            long r14 = -r3
            r0.channel_id = r14
            java.util.ArrayList<org.telegram.tgnet.TLRPC$InputChannel> r2 = r13.f1290id
            r2.add(r0)
            int r0 = r1.currentAccount
            org.telegram.tgnet.ConnectionsManager r14 = org.telegram.tgnet.ConnectionsManager.getInstance(r0)
            org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda173 r0 = new org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda173
            r2 = r25
            r8 = r26
            r0.<init>()
            int r0 = r14.sendRequest(r13, r0)
            if (r2 == 0) goto L7c
            org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda174 r3 = new org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda174
            r3.<init>()
            r2.onCancel(r3)
            return
        L75:
        ...
        L7c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.LaunchActivity.lambda$openMessage$43(android.os.Bundle, byte[], int, java.lang.Integer, java.lang.String, int, long, org.telegram.messenger.browser.Browser$Progress, org.telegram.ui.ActionBar.BaseFragment):void");
    }

    public /* synthetic */ void lambda$openMessage$41(final Browser.Progress progress, final long j, final int i, final Integer num, final byte[] bArr, final BaseFragment baseFragment, final Bundle bundle, final ChatActivity chatActivity, final String str, final int i2, final TLObject tLObject, TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda175
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$openMessage$40(progress, tLObject, j, i, num, bArr, baseFragment, bundle, chatActivity, str, i2);
            }
        });
    }

    public /* synthetic */ void lambda$openMessage$40(Browser.Progress progress, TLObject tLObject, long j, int i, Integer num, byte[] bArr, BaseFragment baseFragment, Bundle bundle, ChatActivity chatActivity, String str, int i2) {
        if (progress != null) {
            progress.end();
        }
        ...
        showAlertDialog(AlertsCreator.createNoAccessAlert(this, LocaleController.getString(C2797R.string.DialogNotAvailable), LocaleController.getString(C2797R.string.LinkNotFound), null));
    }

    public /* synthetic */ void lambda$openMessage$42(int i) {
    ...
    */
    ...
    public static /* synthetic */ void $r8$lambda$NOAK2apSMX9Dy8plyP7Rmq_rlco(Browser.Progress progress, AlertDialog alertDialog) {
        if (progress != null) {
            progress.end();
        }
        if (alertDialog != null) {
    ...
    public /* synthetic */ void lambda$runLinkRequest$49(final int i, final String str, final Runnable runnable, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda110
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$runLinkRequest$48(tLObject, i, str, tL_error, runnable);
            }
        });
    }

    public /* synthetic */ void lambda$runLinkRequest$48(TLObject tLObject, int i, String str, TLRPC.TL_error tL_error, Runnable runnable) {
        if (tLObject instanceof TLRPC.User) {
            ...
            FileLog.m1046e(sb.toString());
            BulletinFactory.m1143of(this.mainFragmentsStack.get(r2.size() - 1)).createErrorBulletin(LocaleController.getString(C2797R.string.NoUsernameFound)).show();
        }
        try {
            runnable.run();
        } catch (Exception e) {
    ...
    public /* synthetic */ void lambda$runLinkRequest$51(final int i, final String str, final Runnable runnable, final TLObject tLObject, TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda131
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$runLinkRequest$50(tLObject, i, str, runnable);
            }
        });
    }

    public /* synthetic */ void lambda$runLinkRequest$50(TLObject tLObject, int i, String str, Runnable runnable) {
        ArrayList<TLRPC.Chat> arrayList;
        ArrayList<TLRPC.User> arrayList2;
        BaseFragment baseFragment = this.mainFragmentsStack.get(r5.size() - 1);
        if (tLObject instanceof TL_chatlists.chatlist_ChatlistInvite) {
            ...
            if (!z || !((TL_chatlists.TL_chatlists_chatlistInvite) chatlist_chatlistinvite).peers.isEmpty()) {
                ...
                BulletinFactory.m1143of(baseFragment).createErrorBulletin(LocaleController.getString(C2797R.string.NoFolderFound)).show();
            }
        } else {
            BulletinFactory.m1143of(baseFragment).createErrorBulletin(LocaleController.getString(C2797R.string.NoFolderFound)).show();
        }
    ...
    public /* synthetic */ void lambda$runLinkRequest$52(Runnable runnable, TL_payments.TL_StarGiftAuctionState tL_StarGiftAuctionState, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null) {
            BulletinFactory.m1143of(this.mainFragmentsStack.get(r9.size() - 1)).createSimpleBulletin(C2797R.raw.error, getString(C2797R.string.GiftAuctionNotFound)).show();
        } else if (tL_StarGiftAuctionState != null && (auction = GiftAuctionController.getInstance(this.currentAccount).getAuction(tL_StarGiftAuctionState.gift.f1443id)) != null) {
    ...
    public /* synthetic */ void lambda$runLinkRequest$53(Runnable runnable, TL_payments.TL_StarGiftAuctionState tL_StarGiftAuctionState, TLRPC.TL_error tL_error) {
        if (tL_error != null) {
            BulletinFactory.m1143of(this.mainFragmentsStack.get(r10.size() - 1)).createSimpleBulletin(C2797R.raw.error, getString(C2797R.string.GiftAuctionNotFound)).show();
        } else if (tL_StarGiftAuctionState != null) {
            AuctionJoinSheet.show(this, (Theme.ResourcesProvider) null, this.currentAccount, 0L, tL_StarGiftAuctionState.gift.f1443id, (Runnable) null);
        }
        try {
            runnable.run();
        } catch (Exception e) {
    ...
    public /* synthetic */ void lambda$runLinkRequest$55(final int i, final String str, final Runnable runnable, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda128
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$runLinkRequest$54(tL_error, tLObject, i, str, runnable);
            }
        });
    }

    public /* synthetic */ void lambda$runLinkRequest$54(TLRPC.TL_error tL_error, TLObject tLObject, int i, String str, Runnable runnable) {
        if (tL_error != null) {
            BaseFragment safeLastFragment = getSafeLastFragment();
            ...
            if ("STARGIFT_ALREADY_BURNED".equalsIgnoreCase(tL_error.text)) {
                BulletinFactory.m1143of(safeLastFragment).createSimpleBulletin(C2797R.raw.fire_on, getString(C2797R.string.UniqueGiftNotFoundBurned)).show();
            } else {
                BulletinFactory.m1143of(safeLastFragment).createSimpleBulletin(C2797R.raw.error, getString(C2797R.string.UniqueGiftNotFound)).show();
            }
    ...
    public /* synthetic */ void lambda$runLinkRequest$60(final TLRPC.TL_inputInvoiceSlug tL_inputInvoiceSlug, final Runnable runnable, final int i, final String str, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda102
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$runLinkRequest$59(tL_error, tLObject, tL_inputInvoiceSlug, runnable, i, str);
            }
        });
    }

    public /* synthetic */ void lambda$runLinkRequest$59(TLRPC.TL_error tL_error, TLObject tLObject, TLRPC.TL_inputInvoiceSlug tL_inputInvoiceSlug, final Runnable runnable, int i, String str) {
        PaymentFormActivity paymentFormActivity;
        if (tL_error != null) {
            boolean zEqualsIgnoreCase = "SUBSCRIPTION_ALREADY_ACTIVE".equalsIgnoreCase(tL_error.text);
            ArrayList<BaseFragment> arrayList = this.mainFragmentsStack;
            if (zEqualsIgnoreCase) {
                BulletinFactory.m1143of(arrayList.get(arrayList.size() - 1)).createErrorBulletin(LocaleController.getString(C2797R.string.PaymentInvoiceSubscriptionLinkAlreadyPaid)).show();
            } else {
                BulletinFactory.m1143of(arrayList.get(arrayList.size() - 1)).createErrorBulletin(LocaleController.getString(C2797R.string.PaymentInvoiceLinkInvalid)).show();
            }
        } else if (!isFinishing()) {
            if (tLObject instanceof TLRPC.TL_payments_paymentFormStars) {
                final Runnable runnable2 = this.navigateToPremiumGiftCallback;
                this.navigateToPremiumGiftCallback = null;
                StarsController.getInstance(this.currentAccount).openPaymentForm(null, tL_inputInvoiceSlug, (TLRPC.TL_payments_paymentFormStars) tLObject, new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda135
                    @Override // java.lang.Runnable
                    public final void run() {
                        LaunchActivity.$r8$lambda$3dI_5PWyLopdlltbTKWvfStY8j4(runnable);
                    }
                }, new Utilities.Callback() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda136
                    @Override // org.telegram.messenger.Utilities.Callback
                    public final void run(Object obj) {
                        LaunchActivity.$r8$lambda$En4S8NMrw1kfZCIJKIQIoZ4HJEU(runnable2, (String) obj);
                    }
                });
                return;
            }
                ...
                if (runnable3 != null) {
                    ...
                    paymentFormActivity.setPaymentFormCallback(new PaymentFormActivity.PaymentFormCallback() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda137
                        ...
                        public final void onInvoiceStatusChanged(PaymentFormActivity.InvoiceStatus invoiceStatus) {
                            LaunchActivity.$r8$lambda$A68gTBNSs1xsP7JTaWsH4aLO_oo(runnable3, invoiceStatus);
                        }
                    });
                }
    ...
    public static /* synthetic */ void $r8$lambda$3dI_5PWyLopdlltbTKWvfStY8j4(Runnable runnable) {
        try {
            runnable.run();
        } catch (Exception e) {
            FileLog.m1048e(e);
    ...
    public static /* synthetic */ void $r8$lambda$En4S8NMrw1kfZCIJKIQIoZ4HJEU(Runnable runnable, String str) {
    ...
    public /* synthetic */ void lambda$runLinkRequest$82(final Runnable runnable, final boolean z, final int i, final int i2, final String str, final String str2, final boolean z2, final String str3, final String str4, final int i3, final String str5, final String str6, final String str7, final String str8, final String str9, final String str10, final String str11, final String str12, final String str13, final String str14, final String str15, final String str16, final boolean z3, final Integer num, final Long l, final Long l2, final Integer num2, final HashMap map, final String str17, final String str18, final String str19, final String str20, final TLRPC.TL_wallPaper tL_wallPaper, final String str21, final String str22, final String str23, final int i4, final int i5, final String str24, final String str25, final String str26, final Browser.Progress progress, final boolean z4, final int i6, final String str27, final String str28, final boolean z5, final String str29, final boolean z6, final boolean z7, final boolean z8, final boolean z9, final boolean z10, final String str30, final Integer num3, final boolean z11, final byte[] bArr, final String str31, int[] iArr, final Long l3) {
        ...
        if (l3 != null && l3.longValue() == LongCompanionObject.MAX_VALUE) {
            ...
            new AlertDialog.Builder(this, null).setTitle(LocaleController.getString(C2797R.string.AffiliateLinkExpiredTitle)).setMessage(LocaleController.getString(C2797R.string.AffiliateLinkExpiredText)).setNegativeButton(LocaleController.getString(C2797R.string.f1162OK), null).show();
            return;
        }
        if (isFinishing()) {
            return;
        ...
        if (z && l3 != null) {
            MessagesController.getInstance(this.currentAccount).getStoriesController().resolveLiveStoryLink(l3.longValue(), new com.google.android.exoplayer2.util.Consumer() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda93
                @Override // com.google.android.exoplayer2.util.Consumer
                public final void accept(Object obj) {
                    this.f$0.lambda$runLinkRequest$61(runnable, l3, (TL_stories.StoryItem) obj);
                }
            });
            return;
        }
        if (i != 0 && l3 != null) {
            MessagesController.getInstance(this.currentAccount).getStoriesController().resolveStoryLink(l3.longValue(), i, new com.google.android.exoplayer2.util.Consumer() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda94
                @Override // com.google.android.exoplayer2.util.Consumer
                public final void accept(Object obj) {
                    this.f$0.lambda$runLinkRequest$62(runnable, l3, (TL_stories.StoryItem) obj);
                }
            });
            return;
        }
        if (i2 != 0 && l3 != null) {
            MessagesController.getInstance(this.currentAccount).getStoriesController().resolveStoryAlbumLink(l3.longValue(), i2, new com.google.android.exoplayer2.util.Consumer() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda95
                @Override // com.google.android.exoplayer2.util.Consumer
                public final void accept(Object obj) {
                    this.f$0.lambda$runLinkRequest$63(runnable, l3, i2, (TL_stories.TL_storyAlbum) obj);
                }
            });
            return;
        }
        if (l3 != null && this.actionBarLayout != null && ((str == null && str2 == null) || ((str != null && l3.longValue() > 0) || ((str2 != null && l3.longValue() > 0) || ((z2 && l3.longValue() < 0) || (str3 != null && l3.longValue() < 0)))))) {
            if (!TextUtils.isEmpty(str4) && (user2 = MessagesController.getInstance(i3).getUser(l3)) != null && user2.bot) {
                if (user2.bot_attach_menu && !MediaDataController.getInstance(i3).botInAttachMenu(user2.f1407id)) {
                    ...
                    ConnectionsManager.getInstance(i3).sendRequest(tL_messages_getAttachMenuBot, new RequestDelegate() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda96
                        @Override // org.telegram.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                            this.f$0.lambda$runLinkRequest$72(i3, str5, str6, str7, str8, str9, str10, str11, str12, str13, str14, str15, str16, z3, num, l, l2, num2, str, map, str17, str18, str19, str20, tL_wallPaper, str21, str22, str23, str2, z2, str3, i4, i5, str24, str25, str26, progress, z4, i, z, i2, i6, str27, str28, z5, str29, z6, z7, z8, z9, z10, str30, num3, z11, bArr, l3, str4, str31, user2, runnable, tLObject, tL_error);
                        }
                    });
                    return;
                }
                processWebAppBot(i3, str5, str6, str7, str8, str9, str10, str11, str12, str13, str14, str15, str16, z3, num, l, l2, num2, str, map, str17, str18, str19, str20, tL_wallPaper, str21, str22, str23, str2, z2, str3, i4, i5, str24, str25, str26, str4, str31, progress, z4, i, false, i2, i6, z5, str29, user2, runnable, false, false, z6, z7, z8, z9, z10, str30, z11);
                return;
            }
            ...
            if (str31 != null) {
                ...
                if (user4 != null && user4.bot) {
                    if (user4.bot_attach_menu) {
                        processAttachMenuBot(i3, l3.longValue(), str26, user4, str24, str31);
                    } else {
                        ArrayList<BaseFragment> arrayList = this.mainFragmentsStack;
                        BulletinFactory.m1143of(arrayList.get(arrayList.size() - 1)).createErrorBulletin(LocaleController.getString(C2797R.string.BotCantAddToAttachMenu)).show();
                    }
                } else {
                    ArrayList<BaseFragment> arrayList2 = this.mainFragmentsStack;
                    BulletinFactory.m1143of(arrayList2.get(arrayList2.size() - 1)).createErrorBulletin(LocaleController.getString(C2797R.string.BotSetAttachLinkNotBot)).show();
                }
                ...
                bundle.putString("selectAlertString", LocaleController.getString(C2797R.string.SendGameToText));
                bundle.putString("selectAlertStringGroup", LocaleController.getString(C2797R.string.SendGameToGroupText));
                DialogsActivity dialogsActivity = new DialogsActivity(bundle);
                ...
                dialogsActivity.setDelegate(new DialogsActivity.DialogsActivityDelegate() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda97
                    ...
                    public final boolean didSelectDialogs(DialogsActivity dialogsActivity2, ArrayList arrayList3, CharSequence charSequence, boolean z13, boolean z14, int i8, int i9, TopicsFragment topicsFragment) {
                        return this.f$0.lambda$runLinkRequest$73(str, i3, user5, dialogsActivity2, arrayList3, charSequence, z13, z14, i8, i9, topicsFragment);
                    }
                });
                ...
                if (user6 == null || (user6.bot && user6.bot_nochats)) {
                    try {
                        ...
                        BulletinFactory.m1143of(this.mainFragmentsStack.get(r0.size() - 1)).createErrorBulletin(LocaleController.getString(C2797R.string.BotCantJoinGroups)).show();
                        return;
                    } catch (Exception e2) {
                        FileLog.m1048e(e2);
                        return;
                ...
                dialogsActivity2.setDelegate(new DialogsActivity.DialogsActivityDelegate() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda98
                    @Override // org.telegram.ui.DialogsActivity.DialogsActivityDelegate
                    public final boolean didSelectDialogs(DialogsActivity dialogsActivity3, ArrayList arrayList3, CharSequence charSequence, boolean z13, boolean z14, int i8, int i9, TopicsFragment topicsFragment) {
                        return this.f$0.lambda$runLinkRequest$78(i3, user6, str12, str38, dialogsActivity2, dialogsActivity3, arrayList3, charSequence, z13, z14, i8, i9, topicsFragment);
                    }
                });
                ...
                if (l3.longValue() < 0) {
                    ...
                    if (z11 && chat.linked_monoforum_id != 0) {
                        ...
                        if (MessagesController.getInstance(i3).getChat(Long.valueOf(chat.linked_monoforum_id)) == null) {
                            ...
                            ConnectionsManager.getInstance(i3).sendRequest(tL_channels_getFullChannel, new RequestDelegate() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda99
                                @Override // org.telegram.tgnet.RequestDelegate
                                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                                    this.f$0.lambda$runLinkRequest$80(i3, chat, runnable, str5, str6, str7, str8, str9, str10, str11, str12, str13, str14, str15, str16, z3, num, l, l2, num2, str, map, str17, str18, str19, str20, tL_wallPaper, str21, str22, str23, str2, z2, str3, i4, i5, str24, str25, str26, str4, str31, progress, z4, i, z, i2, i6, str27, str28, z5, str29, z6, z7, z8, z9, z10, str30, num3, z11, bArr, tLObject, tL_error);
                                }
                            });
                            return;
                        }
                    ...
                    if (strConcat != null) {
                        ...
                        bundle3.putString("start_text", strConcat);
                    }
                    jLongValue = jLongValue2;
                }
                if (str36 == null || user == null || !user.bot) {
                    z12 = false;
                } else {
                    bundle3.putString("botUser", str36);
                    z12 = true;
                }
                ...
                if (num != null) {
                    ...
                    if (bArr != null) {
                        bundle3.putByteArray("poll_option_id", bArr);
                    }
                }
                if (str32 != null) {
                ...
                if (str35 != null) {
                    bundle3.putString("livestream", str35);
                }
                if (i7 >= 0) {
                    bundle3.putInt("video_timestamp", i7);
                }
                if (str34 != null) {
                    bundle3.putString("attach_bot", str34);
                }
                if (str33 != null) {
                    bundle3.putString("attach_bot_start_command", str33);
                }
                if (this.mainFragmentsStack.isEmpty() || str32 != null) {
                    baseFragment = null;
                } else {
                    baseFragment = this.mainFragmentsStack.get(r10.size() - 1);
                }
                if (baseFragment == null || MessagesController.getInstance(i3).checkCanOpenChat(bundle3, baseFragment)) {
                    boolean z13 = (baseFragment instanceof ChatActivity) && ((ChatActivity) baseFragment).getDialogId() == jLongValue;
                    if (z12 && z13) {
                        ((ChatActivity) baseFragment).setBotUser(str36);
                    } else if (str34 != null && z13) {
                        ((ChatActivity) baseFragment).openAttachBotLayout(str34);
                    } else {
                        long j2 = -jLongValue;
                        TLRPC.Chat chat2 = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(j2));
                        if (z9 || i6 > 0) {
                        ...
                        if (chat2 != null && chat2.forum) {
                            ...
                            if (lValueOf != null && lValueOf.longValue() != j) {
                                openForumFromLink(jLongValue, num, null, num3, bArr, new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda100
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        LaunchActivity.$r8$lambda$jPjXF1CAeLN4KcHYv4mqaPTKoS8(runnable2);
                                    }
                                }, 0, -1);
                                return;
                            }
                        ...
                        MessagesController.getInstance(i3).ensureMessagesLoaded(jLongValue, num == null ? 0 : num.intValue(), new C589615(runnable2, str35, baseFragment, jLongValue, num, bundle3));
                        return;
                    }
                }
            }
            ...
            try {
                ...
                if (lastFragment != null) {
                    ...
                    if (AndroidUtilities.isNumeric(str5)) {
                        BulletinFactory.m1143of(lastFragment).createErrorBulletin(LocaleController.getString(C2797R.string.NoPhoneFound)).show();
                    } else {
                        BulletinFactory.m1143of(lastFragment).createErrorBulletin(LocaleController.getString(C2797R.string.NoUsernameFound)).show();
                    }
                }
            } catch (Exception e5) {
                FileLog.m1048e(e5);
    ...
    public /* synthetic */ void lambda$runLinkRequest$61(Runnable runnable, Long l, TL_stories.StoryItem storyItem) {
        ...
        if (storyItem == null) {
            ...
            if (bulletinFactoryGlobal != null) {
                bulletinFactoryGlobal.createSimpleBulletin(C2797R.raw.story_bomb2, LocaleController.getString(C2797R.string.StoryNotFound)).show();
                return;
            }
            return;
        }
        if (storyItem instanceof TL_stories.TL_storyItemDeleted) {
            ...
            if (bulletinFactoryGlobal2 != null) {
                bulletinFactoryGlobal2.createSimpleBulletin(C2797R.raw.story_bomb1, LocaleController.getString(C2797R.string.StoryNotFound)).show();
                return;
            }
            return;
        }
    ...
    public /* synthetic */ void lambda$runLinkRequest$62(Runnable runnable, Long l, TL_stories.StoryItem storyItem) {
        try {
            runnable.run();
        } catch (Exception e) {
            FileLog.m1048e(e);
    ...
    public /* synthetic */ void lambda$runLinkRequest$63(Runnable runnable, Long l, int i, TL_stories.TL_storyAlbum tL_storyAlbum) {
        try {
            runnable.run();
        } catch (Exception e) {
            FileLog.m1048e(e);
        ...
        if (tL_storyAlbum == null) {
            BulletinFactory bulletinFactoryGlobal = BulletinFactory.global();
            if (bulletinFactoryGlobal != null) {
                bulletinFactoryGlobal.createSimpleBulletin(C2797R.raw.story_bomb2, LocaleController.getString(C2797R.string.StoryAlbumNotFound)).show();
                return;
            }
            return;
        }
    ...
    public /* synthetic */ void lambda$runLinkRequest$71(TLRPC.TL_error tL_error, final int i, final String str, final String str2, final String str3, final String str4, final String str5, final String str6, final String str7, final String str8, final String str9, final String str10, final String str11, final String str12, final boolean z, final Integer num, final Long l, final Long l2, final Integer num2, final String str13, final HashMap map, final String str14, final String str15, final String str16, final String str17, final TLRPC.TL_wallPaper tL_wallPaper, final String str18, final String str19, final String str20, final String str21, final boolean z2, final String str22, final int i2, final int i3, final String str23, final String str24, final String str25, final Browser.Progress progress, final boolean z3, final int i4, final boolean z4, final int i5, final int i6, final String str26, final String str27, final boolean z5, final String str28, final boolean z6, final boolean z7, final boolean z8, final boolean z9, final boolean z10, final String str29, final Integer num3, final boolean z11, final byte[] bArr, TLObject tLObject, final Long l3, final String str30, final String str31, final TLRPC.User user, final Runnable runnable) {
        if (tL_error != null) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda160
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$runLinkRequest$64(i, str, str2, str3, str4, str5, str6, str7, str8, str9, str10, str11, str12, z, num, l, l2, num2, str13, map, str14, str15, str16, str17, tL_wallPaper, str18, str19, str20, str21, z2, str22, i2, i3, str23, str24, str25, progress, z3, i4, z4, i5, i6, str26, str27, z5, str28, z6, z7, z8, z9, z10, str29, num3, z11, bArr);
                }
            });
            return;
        }
        if (tLObject instanceof TLRPC.TL_attachMenuBotsBot) {
            ...
            if ((tL_attachMenuBot.inactive || tL_attachMenuBot.side_menu_disclaimer_needed) && z12) {
                WebAppDisclaimerAlert.show(this, new com.google.android.exoplayer2.util.Consumer() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda161
                    @Override // com.google.android.exoplayer2.util.Consumer
                    public final void accept(Object obj) {
                        this.f$0.lambda$runLinkRequest$67(tL_attachMenuBot, i, l3, str, str2, str3, str4, str5, str6, str7, str8, str9, str10, str11, str12, z, num, l, l2, num2, str13, map, str14, str15, str16, str17, tL_wallPaper, str18, str19, str20, str21, z2, str22, i2, i3, str23, str24, str25, str30, str31, progress, z3, i4, i5, i6, z5, str28, user, runnable, z12, z6, z7, z8, z9, z10, str29, z11, (Boolean) obj);
                    }
                }, null, progress != null ? new ChatActivity$ChatMessageCellDelegate$$ExternalSyntheticLambda16(progress) : null);
            } else if (tL_attachMenuBot.request_write_access || z3) {
                final AtomicBoolean atomicBoolean = new AtomicBoolean(true);
                AlertsCreator.createBotLaunchAlert(getLastFragment(), atomicBoolean, user, new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda162
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$runLinkRequest$70(l3, tL_attachMenuBot, atomicBoolean, i, str, str2, str3, str4, str5, str6, str7, str8, str9, str10, str11, str12, z, num, l, l2, num2, str13, map, str14, str15, str16, str17, tL_wallPaper, str18, str19, str20, str21, z2, str22, i2, i3, str23, str24, str25, str30, str31, progress, z3, i4, i5, i6, z5, str28, user, runnable, z6, z7, z8, z9, z10, str29, z11);
                    }
                });
            } else {
    ...
    public /* synthetic */ void lambda$runLinkRequest$67(TLRPC.TL_attachMenuBot tL_attachMenuBot, final int i, Long l, String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, boolean z, Integer num, Long l2, Long l3, Integer num2, String str13, HashMap map, String str14, String str15, String str16, String str17, TLRPC.TL_wallPaper tL_wallPaper, String str18, String str19, String str20, String str21, boolean z2, String str22, int i2, int i3, String str23, String str24, String str25, String str26, String str27, Browser.Progress progress, boolean z3, int i4, int i5, int i6, boolean z4, String str28, TLRPC.User user, Runnable runnable, boolean z5, boolean z6, boolean z7, boolean z8, boolean z9, boolean z10, String str29, boolean z11, Boolean bool) {
        ...
        ConnectionsManager.getInstance(i).sendRequest(tL_messages_toggleBotInAttachMenu, new RequestDelegate() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda172
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda178
                    @Override // java.lang.Runnable
                    public final void run() {
                        LaunchActivity.$r8$lambda$kOiTOg77lcRQvSmC9EMH6xhLtvo(tLObject, i);
                    }
                });
            }
        }, 66);
        ...
        ConnectionsManager.getInstance(i).sendRequest(tL_messages_toggleBotInAttachMenu, new RequestDelegate() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda168
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda177
                    @Override // java.lang.Runnable
                    public final void run() {
                        LaunchActivity.$r8$lambda$Pe2Sn56rTgqN2tyvBmzY7J4whX8(tLObject, i);
                    }
                });
            }
        }, 66);
    ...
    public static /* synthetic */ void $r8$lambda$Pe2Sn56rTgqN2tyvBmzY7J4whX8(TLObject tLObject, int i) {
        if (tLObject instanceof TLRPC.TL_boolTrue) {
            MediaDataController.getInstance(i).loadAttachMenuBots(false, true, null);
        }
    }

    public /* synthetic */ boolean lambda$runLinkRequest$73(String str, int i, TLRPC.User user, DialogsActivity dialogsActivity, ArrayList arrayList, CharSequence charSequence, boolean z, boolean z2, int i2, int i3, TopicsFragment topicsFragment) {
        ...
        tL_inputMediaGame.f1319id = tL_inputGameShortName;
    ...
    public /* synthetic */ boolean lambda$runLinkRequest$78(final int i, final TLRPC.User user, final String str, final String str2, final DialogsActivity dialogsActivity, DialogsActivity dialogsActivity2, ArrayList arrayList, CharSequence charSequence, boolean z, boolean z2, int i2, int i3, TopicsFragment topicsFragment) {
        ...
        if (chat != null && (chat.creator || ((tL_chatAdminRights = chat.admin_rights) != null && tL_chatAdminRights.add_admins))) {
            MessagesController.getInstance(i).checkIsInChat(false, chat, user, new MessagesController.IsInChatCheckedCallback() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda132
                @Override // org.telegram.messenger.MessagesController.IsInChatCheckedCallback
                public final void run(boolean z3, TLRPC.TL_chatAdminRights tL_chatAdminRights2, String str3) {
                    this.f$0.lambda$runLinkRequest$76(str, str2, i, chat, dialogsActivity, user, j, z3, tL_chatAdminRights2, str3);
                }
            });
            return true;
        }
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle(LocaleController.getString(C2797R.string.AddBot));
        builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("AddMembersAlertNamesText", C2797R.string.AddMembersAlertNamesText, UserObject.getUserName(user), chat == null ? _UrlKt.FRAGMENT_ENCODE_SET : chat.title)));
        builder.setNegativeButton(LocaleController.getString(C2797R.string.Cancel), null);
        builder.setPositiveButton(LocaleController.getString(C2797R.string.AddBot), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda133
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i4) {
                this.f$0.lambda$runLinkRequest$77(j, i, user, str2, alertDialog, i4);
            }
        });
        builder.show();
        return true;
    ...
    public /* synthetic */ void lambda$runLinkRequest$76(final String str, final String str2, final int i, final TLRPC.Chat chat, final DialogsActivity dialogsActivity, final TLRPC.User user, final long j, final boolean z, final TLRPC.TL_chatAdminRights tL_chatAdminRights, final String str3) {
    ...
    public /* synthetic */ void lambda$runLinkRequest$75(String str, TLRPC.TL_chatAdminRights tL_chatAdminRights, boolean z, String str2, final int i, final TLRPC.Chat chat, final DialogsActivity dialogsActivity, TLRPC.User user, long j, String str3) {
        ...
        if (z && tL_chatAdminRights2 == null && !TextUtils.isEmpty(str2)) {
            MessagesController.getInstance(this.currentAccount).addUserToChat(chat.f1245id, user, 0, str2, dialogsActivity, true, new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda164
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$runLinkRequest$74(i, chat, dialogsActivity);
                }
            }, null);
            return;
        }
        ChatRightsEditActivity chatRightsEditActivity = new ChatRightsEditActivity(user.f1407id, -j, tL_chatAdminRights3, null, null, str3, 2, true, !z, str2);
        chatRightsEditActivity.setDelegate(new ChatRightsEditActivity.ChatRightsEditActivityDelegate() { // from class: org.telegram.ui.LaunchActivity.14
            ...
            public C589514(final DialogsActivity dialogsActivity2, final int i2) {
    ...
    public /* synthetic */ void lambda$runLinkRequest$74(int i, TLRPC.Chat chat, DialogsActivity dialogsActivity) {
        NotificationCenter.getInstance(i).lambda$postNotificationNameOnUIThread$1(NotificationCenter.closeChats, new Object[0]);
        Bundle bundle = new Bundle();
        bundle.putBoolean("scrollToTopOnResume", true);
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C589514 implements ChatRightsEditActivity.ChatRightsEditActivityDelegate {
        final /* synthetic */ DialogsActivity val$fragment;
        final /* synthetic */ int val$intentAccount;
    ...
    public /* synthetic */ void lambda$runLinkRequest$77(long j, int i, TLRPC.User user, String str, AlertDialog alertDialog, int i2) {
        Bundle bundle = new Bundle();
        bundle.putBoolean("scrollToTopOnResume", true);
        long j2 = -j;
        bundle.putLong("chat_id", j2);
    ...
    public static /* synthetic */ void $r8$lambda$jPjXF1CAeLN4KcHYv4mqaPTKoS8(Runnable runnable) {
        try {
            runnable.run();
        } catch (Exception e) {
            FileLog.m1048e(e);
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C589615 implements MessagesController.MessagesLoadedCallback {
        ...
        public C589615(Runnable runnable, String str, BaseFragment baseFragment, long j, Integer num, Bundle bundle) {
        ...
        */
        public void onMessagesLoaded(boolean r8) {
            ...
            Lb:
                org.telegram.ui.LaunchActivity r8 = org.telegram.p035ui.LaunchActivity.this
                boolean r8 = r8.isFinishing()
                if (r8 != 0) goto La3
                java.lang.String r8 = r7.val$livestream
                if (r8 == 0) goto L2e
                org.telegram.ui.ActionBar.BaseFragment r8 = r7.val$lastFragment
                boolean r0 = r8 instanceof org.telegram.p035ui.ChatActivity
                if (r0 == 0) goto L2e
                org.telegram.ui.ChatActivity r8 = (org.telegram.p035ui.ChatActivity) r8
            ...
            L83:
                ...
                r8.<init>(r0)
                org.telegram.ui.LaunchActivity r0 = org.telegram.p035ui.LaunchActivity.this
            ...
            L94:
                ...
                org.telegram.ui.LaunchActivity$15$$ExternalSyntheticLambda0 r1 = new org.telegram.ui.LaunchActivity$15$$ExternalSyntheticLambda0
                r2 = r7
                r1.<init>()
            ...
            La3:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.LaunchActivity.C589615.onMessagesLoaded(boolean):void");
        }
                ...
                if (chatFull != null) {
                    if (chatFull.call == null) {
                        if (baseFragment.getParentActivity() != null) {
                            BulletinFactory.m1143of(baseFragment).createSimpleBulletin(C2797R.raw.linkbroken, LocaleController.getString(C2797R.string.InviteExpired)).show();
                            return;
                        }
                        return;
                    }
        ...
        public void onError() {
            if (!LaunchActivity.this.isFinishing()) {
                AlertsCreator.showSimpleAlert((BaseFragment) LaunchActivity.this.mainFragmentsStack.get(LaunchActivity.this.mainFragmentsStack.size() - 1), LocaleController.getString(C2797R.string.JoinToGroupErrorNotExist));
            }
            try {
    ...
    public /* synthetic */ void lambda$runLinkRequest$88(final int i, final AlertDialog alertDialog, final Runnable runnable, final String str, final TLObject tLObject, final TLRPC.TL_error tL_error) {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public /* synthetic */ void lambda$runLinkRequest$87(org.telegram.tgnet.TLRPC.TL_error r7, org.telegram.tgnet.TLObject r8, int r9, org.telegram.p035ui.ActionBar.AlertDialog r10, java.lang.Runnable r11, java.lang.String r12) {
        /*
            Method dump skipped, instruction units count: 352
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.LaunchActivity.lambda$runLinkRequest$87(org.telegram.tgnet.TLRPC$TL_error, org.telegram.tgnet.TLObject, int, org.telegram.ui.ActionBar.AlertDialog, java.lang.Runnable, java.lang.String):void");
    }

    public static /* synthetic */ void $r8$lambda$nkxDupGtYG5kIp7hdSwwGK8Bi6I(boolean[] zArr, DialogInterface dialogInterface) {
        zArr[0] = true;
    }

    /* JADX INFO: renamed from: org.telegram.ui.LaunchActivity$16 */
    /* JADX INFO: loaded from: classes6.dex */
    public class C589716 implements MessagesController.MessagesLoadedCallback {
        final /* synthetic */ Bundle val$args;
        final /* synthetic */ boolean[] val$canceled;
        final /* synthetic */ Runnable val$dismissLoading;
        final /* synthetic */ TLRPC.ChatInvite val$invite;

        public C589716(Runnable runnable, boolean[] zArr, Bundle bundle, TLRPC.ChatInvite chatInvite) {
            runnable = runnable;
            zArr = zArr;
            bundle = bundle;
    ...
    public /* synthetic */ void lambda$runLinkRequest$86(final long j, String str, final Long l) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda159
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$runLinkRequest$85(l, j);
            }
        });
    }

    public /* synthetic */ void lambda$runLinkRequest$85(Long l, final long j) {
        BaseFragment safeLastFragment = getSafeLastFragment();
        if (safeLastFragment == null) {
            return;
        }
        final ChatActivity chatActivityM1139of = ChatActivity.m1139of(l.longValue());
        ...
        if (chat != null) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda163
                @Override // java.lang.Runnable
                public final void run() {
                    BulletinFactory.m1143of(chatActivityM1139of).createSimpleBulletin(C2797R.raw.stars_send, LocaleController.getString(C2797R.string.StarsSubscriptionCompleted), AndroidUtilities.replaceTags(LocaleController.formatPluralString("StarsSubscriptionCompletedText", (int) j, chat.title))).show(true);
                }
            }, 250L);
        }
    }

    public /* synthetic */ void lambda$runLinkRequest$91(final Runnable runnable, final int i, TLRPC.ChatInviteJoinResult chatInviteJoinResult, final TLRPC.TL_error tL_error) {
        ...
        if (chatInviteJoinResult instanceof TLRPC.TL_chatInviteJoinResultOk) {
            ...
            if (chatInviteJoinResult instanceof TLRPC.TL_chatInviteJoinResultWebView) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda115
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$runLinkRequest$89(tL_chatInviteJoinResultWebView);
                    }
                });
            }
            updates = null;
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda116
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$runLinkRequest$90(runnable, tL_error, updates, i);
            }
        });
    }

    public /* synthetic */ void lambda$runLinkRequest$89(TLRPC.TL_chatInviteJoinResultWebView tL_chatInviteJoinResultWebView) {
    ...
    public /* synthetic */ void lambda$runLinkRequest$90(Runnable runnable, TLRPC.TL_error tL_error, TLRPC.Updates updates, int i) {
        if (isFinishing()) {
            return;
        }
        try {
        ...
        if (tL_error == null) {
            ...
            bundle.putLong("chat_id", chat.f1245id);
            if (!this.mainFragmentsStack.isEmpty()) {
                if (!MessagesController.getInstance(i).checkCanOpenChat(bundle, this.mainFragmentsStack.get(r0.size() - 1))) {
                    return;
                }
            }
            ChatActivity chatActivity = new ChatActivity(bundle);
        ...
        if (tL_error.text.startsWith("FLOOD_WAIT")) {
            builder.setMessage(LocaleController.getString(C2797R.string.FloodWait));
        } else if (tL_error.text.equals("USERS_TOO_MUCH")) {
            builder.setMessage(LocaleController.getString(C2797R.string.JoinToGroupErrorFull));
        } else {
            builder.setMessage(LocaleController.getString(C2797R.string.JoinToGroupErrorNotExist));
        }
        builder.setPositiveButton(LocaleController.getString(C2797R.string.f1162OK), null);
        showAlertDialog(builder);
    }

    public /* synthetic */ boolean lambda$runLinkRequest$92(boolean z, int i, String str, DialogsActivity dialogsActivity, ArrayList arrayList, CharSequence charSequence, boolean z2, boolean z3, int i2, int i3, TopicsFragment topicsFragment) {
        long j = ((MessagesStorage.TopicKey) arrayList.get(0)).dialogId;
        Bundle bundle = new Bundle();
        bundle.putBoolean("scrollToTopOnResume", true);
    ...
    public /* synthetic */ void lambda$runLinkRequest$96(int[] iArr, final int i, final Runnable runnable, final TL_account.getAuthorizationForm getauthorizationform, final String str, final String str2, final String str3, TLObject tLObject, final TLRPC.TL_error tL_error) {
        final TL_account.authorizationForm authorizationform = (TL_account.authorizationForm) tLObject;
        if (authorizationform != null) {
            iArr[0] = ConnectionsManager.getInstance(i).sendRequest(new TL_account.getPassword(), new RequestDelegate() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda107
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject2, TLRPC.TL_error tL_error2) {
                    this.f$0.lambda$runLinkRequest$94(runnable, i, authorizationform, getauthorizationform, str, str2, str3, tLObject2, tL_error2);
                }
            });
        } else {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda108
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$runLinkRequest$95(runnable, tL_error);
                }
            });
        }
    }

    public /* synthetic */ void lambda$runLinkRequest$94(final Runnable runnable, final int i, final TL_account.authorizationForm authorizationform, final TL_account.getAuthorizationForm getauthorizationform, final String str, final String str2, final String str3, final TLObject tLObject, TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda138
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$runLinkRequest$93(runnable, tLObject, i, authorizationform, getauthorizationform, str, str2, str3);
            }
        });
    }

    public /* synthetic */ void lambda$runLinkRequest$93(Runnable runnable, TLObject tLObject, int i, TL_account.authorizationForm authorizationform, TL_account.getAuthorizationForm getauthorizationform, String str, String str2, String str3) {
        try {
            runnable.run();
        } catch (Exception e) {
            FileLog.m1048e(e);
    ...
    public /* synthetic */ void lambda$runLinkRequest$95(Runnable runnable, TLRPC.TL_error tL_error) {
        try {
            runnable.run();
            if ("APP_VERSION_OUTDATED".equals(tL_error.text)) {
                AlertsCreator.showUpdateAppAlert(this, LocaleController.getString(C2797R.string.UpdateAppAlert), true);
                return;
            }
            showAlertDialog(AlertsCreator.createSimpleAlert(this, LocaleController.getString(C2797R.string.ErrorOccurred) + "\n" + tL_error.text));
        } catch (Exception e) {
            FileLog.m1048e(e);
        }
    }

    public /* synthetic */ void lambda$runLinkRequest$98(final Runnable runnable, final TLObject tLObject, TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda113
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$runLinkRequest$97(runnable, tLObject);
            }
        });
    }

    public /* synthetic */ void lambda$runLinkRequest$97(Runnable runnable, TLObject tLObject) {
        try {
            runnable.run();
        } catch (Exception e) {
            FileLog.m1048e(e);
    ...
    public /* synthetic */ void lambda$runLinkRequest$100(final Runnable runnable, final TLObject tLObject, final TLRPC.TL_error tL_error) {
    ...
    public /* synthetic */ void lambda$runLinkRequest$99(Runnable runnable, TLObject tLObject, TLRPC.TL_error tL_error) {
        try {
            runnable.run();
        } catch (Exception e) {
            FileLog.m1048e(e);
        ...
        if (tL_error != null) {
            if ("LANG_CODE_NOT_SUPPORTED".equals(tL_error.text)) {
                showAlertDialog(AlertsCreator.createSimpleAlert(this, LocaleController.getString(C2797R.string.LanguageUnsupportedError)));
                return;
            }
            showAlertDialog(AlertsCreator.createSimpleAlert(this, LocaleController.getString(C2797R.string.ErrorOccurred) + "\n" + tL_error.text));
        }
    ...
    public /* synthetic */ void lambda$runLinkRequest$103(final Runnable runnable, final TLRPC.TL_wallPaper tL_wallPaper, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda103
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$runLinkRequest$102(runnable, tLObject, tL_wallPaper, tL_error);
            }
        });
    }

    public /* synthetic */ void lambda$runLinkRequest$102(Runnable runnable, TLObject tLObject, TLRPC.TL_wallPaper tL_wallPaper, TLRPC.TL_error tL_error) {
        try {
            runnable.run();
        } catch (Exception e) {
            FileLog.m1048e(e);
    ...
    public /* synthetic */ void lambda$runLinkRequest$104(Browser.Progress progress) {
    ...
    public /* synthetic */ void lambda$runLinkRequest$106(final AlertDialog alertDialog, final Runnable runnable, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda129
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$runLinkRequest$105(tLObject, alertDialog, runnable, tL_error);
            }
        });
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public /* synthetic */ void lambda$runLinkRequest$105(org.telegram.tgnet.TLObject r6, org.telegram.p035ui.ActionBar.AlertDialog r7, java.lang.Runnable r8, org.telegram.tgnet.TLRPC.TL_error r9) {
        /*
            Method dump skipped, instruction units count: 205
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.LaunchActivity.lambda$runLinkRequest$105(org.telegram.tgnet.TLObject, org.telegram.ui.ActionBar.AlertDialog, java.lang.Runnable, org.telegram.tgnet.TLRPC$TL_error):void");
    }

    public /* synthetic */ void lambda$runLinkRequest$108(final int[] iArr, final int i, final Runnable runnable, final Integer num, final Integer num2, final Long l, final Integer num3, final TLObject tLObject, TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda117
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$runLinkRequest$107(tLObject, iArr, i, runnable, num, num2, l, num3);
            }
        });
    }

    public /* synthetic */ void lambda$runLinkRequest$107(TLObject tLObject, int[] iArr, int i, Runnable runnable, Integer num, Integer num2, Long l, Integer num3) {
        if (tLObject instanceof TLRPC.TL_messages_chats) {
            TLRPC.TL_messages_chats tL_messages_chats = (TLRPC.TL_messages_chats) tLObject;
            if (!tL_messages_chats.chats.isEmpty()) {
                MessagesController.getInstance(this.currentAccount).putChats(tL_messages_chats.chats, false);
    ...
    /* JADX INFO: renamed from: $r8$lambda$UdW8rdCGcP2Nd9TISa-nhcENypw */
    public static /* synthetic */ void m16805$r8$lambda$UdW8rdCGcP2Nd9TISanhcENypw(Runnable runnable) {
        try {
            runnable.run();
        } catch (Exception e) {
            FileLog.m1048e(e);
    ...
    public /* synthetic */ void lambda$runLinkRequest$112(final Bundle bundle, final Long l, int[] iArr, final Runnable runnable, final boolean z, final Browser.Progress progress, final Long l2, final Integer num, final Integer num2, final byte[] bArr, final BaseFragment baseFragment, final int i) {
        ...
        tL_channels_getChannels.f1290id.add(tL_inputChannel);
        iArr[0] = ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_getChannels, new RequestDelegate() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda101
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                this.f$0.lambda$runLinkRequest$111(runnable, z, l, progress, l2, num, num2, bArr, baseFragment, i, bundle, tLObject, tL_error);
            }
        });
    }

    public /* synthetic */ void lambda$runLinkRequest$111(final Runnable runnable, final boolean z, final Long l, final Browser.Progress progress, final Long l2, final Integer num, final Integer num2, final byte[] bArr, final BaseFragment baseFragment, final int i, final Bundle bundle, final TLObject tLObject, TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda143
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$runLinkRequest$110(runnable, tLObject, z, l, progress, l2, num, num2, bArr, baseFragment, i, bundle);
            }
        });
    }

    public /* synthetic */ void lambda$runLinkRequest$110(Runnable runnable, TLObject tLObject, boolean z, Long l, Browser.Progress progress, Long l2, Integer num, Integer num2, byte[] bArr, BaseFragment baseFragment, int i, Bundle bundle) {
        try {
            runnable.run();
        } catch (Exception e) {
            FileLog.m1048e(e);
    ...
    public /* synthetic */ void lambda$runLinkRequest$114(final TLObject tLObject, TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda121
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$runLinkRequest$113(tLObject);
            }
        });
    }

    public /* synthetic */ void lambda$runLinkRequest$113(TLObject tLObject) {
        ...
        showAlertDialog(AlertsCreator.createSimpleAlert(this, LocaleController.getString(C2797R.string.BusinessLink), LocaleController.getString(C2797R.string.BusinessLinkInvalid)));
    }

    public static /* synthetic */ void $r8$lambda$ZLReXrXgg_or0hlgXAx1yHTdGWU(int i, int[] iArr, Runnable runnable, DialogInterface dialogInterface) {
        ConnectionsManager.getInstance(i).cancelRequest(iArr[0], true);
        if (runnable != null) {
            runnable.run();
        }
    ...
    public static /* synthetic */ void $r8$lambda$3u37IWTKffqIJ7gbch0aQoQHgn8(int i, int[] iArr, Runnable runnable) {
        ConnectionsManager.getInstance(i).cancelRequest(iArr[0], true);
        if (runnable != null) {
            runnable.run();
        }
    ...
    public /* synthetic */ void lambda$processWebAppBot$121(final Browser.Progress progress, final int i, final String str, final String str2, final String str3, final String str4, final String str5, final String str6, final String str7, final String str8, final String str9, final String str10, final String str11, final String str12, final boolean z, final Integer num, final Long l, final Long l2, final Integer num2, final String str13, final HashMap map, final String str14, final String str15, final String str16, final String str17, final TLRPC.TL_wallPaper tL_wallPaper, final String str18, final String str19, final String str20, final String str21, final boolean z2, final String str22, final int i2, final int i3, final String str23, final String str24, final String str25, final boolean z3, final int i4, final boolean z4, final int i5, final int i6, final boolean z5, final String str26, final boolean z6, final boolean z7, final boolean z8, final boolean z9, final boolean z10, final String str27, final boolean z11, final Runnable runnable, final TLRPC.User user, final String str28, final boolean z12, final boolean z13, TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda150
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$processWebAppBot$117(i, str, str2, str3, str4, str5, str6, str7, str8, str9, str10, str11, str12, z, num, l, l2, num2, str13, map, str14, str15, str16, str17, tL_wallPaper, str18, str19, str20, str21, z2, str22, i2, i3, str23, str24, str25, progress, z3, i4, z4, i5, i6, z5, str26, z6, z7, z8, z9, z10, str27, z11);
                }
            });
        } else {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda151
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$processWebAppBot$120(runnable, i, user, tL_messages_botApp, str28, z6, z7, z8, z3, z12, z13, progress);
                }
            });
        }
    }

    public /* synthetic */ void lambda$processWebAppBot$117(int i, String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, boolean z, Integer num, Long l, Long l2, Integer num2, String str13, HashMap map, String str14, String str15, String str16, String str17, TLRPC.TL_wallPaper tL_wallPaper, String str18, String str19, String str20, String str21, boolean z2, String str22, int i2, int i3, String str23, String str24, String str25, Browser.Progress progress, boolean z3, int i4, boolean z4, int i5, int i6, boolean z5, String str26, boolean z6, boolean z7, boolean z8, boolean z9, boolean z10, String str27, boolean z11) {
    ...
    public /* synthetic */ void lambda$processWebAppBot$120(Runnable runnable, final int i, final TLRPC.User user, final TLRPC.TL_messages_botApp tL_messages_botApp, final String str, final boolean z, final boolean z2, final boolean z3, final boolean z4, boolean z5, boolean z6, Browser.Progress progress) {
        ...
        if (arrayList == null || arrayList.isEmpty()) {
            ...
            baseFragment = this.mainFragmentsStack.get(r15.size() - 1);
        }
        final Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda165
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$processWebAppBot$118(baseFragment, i, user, tL_messages_botApp, atomicBoolean, str, z, z2, z3, z4);
            }
        };
        if (z5) {
            runnable2.run();
        ...
        if (tL_messages_botApp.inactive && z6) {
            WebAppDisclaimerAlert.show(this, new com.google.android.exoplayer2.util.Consumer() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda166
                @Override // com.google.android.exoplayer2.util.Consumer
                public final void accept(Object obj) {
                    runnable2.run();
                }
    ...
    public /* synthetic */ void lambda$processWebAppBot$118(BaseFragment baseFragment, int i, TLRPC.User user, TLRPC.TL_messages_botApp tL_messages_botApp, AtomicBoolean atomicBoolean, String str, boolean z, boolean z2, boolean z3, boolean z4) {
        if (baseFragment == null || !isActive || isFinishing() || isDestroyed()) {
            return;
        }
        long j = user.f1407id;
        WebViewRequestProps webViewRequestPropsM1233of = WebViewRequestProps.m1233of(i, j, j, null, null, 3, 0, 0L, false, tL_messages_botApp.app, atomicBoolean.get(), str, user, 0, z, z2);
        if (getBottomSheetTabs() == null || getBottomSheetTabs().tryReopenTab(webViewRequestPropsM1233of) == null) {
            SharedPrefsHelper.setWebViewConfirmShown(this.currentAccount, user.f1407id, true);
            ...
            botWebViewSheet.requestWebView(baseFragment, webViewRequestPropsM1233of);
            botWebViewSheet.show();
    ...
    private void processAttachedMenuBotFromShortcut(final long j) {
        ...
        final Utilities.Callback callback = new Utilities.Callback() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda57
            @Override // org.telegram.messenger.Utilities.Callback
            public final void run(Object obj) {
                this.f$0.lambda$processAttachedMenuBotFromShortcut$122((TLRPC.User) obj);
            }
        };
        ...
        if (user != null) {
            ...
            MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda58
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$processAttachedMenuBotFromShortcut$124(j, callback);
                }
            });
        }
    }

    public /* synthetic */ void lambda$processAttachedMenuBotFromShortcut$122(TLRPC.User user) {
        MessagesController.getInstance(this.currentAccount).openApp(user, 0);
    }

    public /* synthetic */ void lambda$processAttachedMenuBotFromShortcut$124(long j, final Utilities.Callback callback) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda114
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$processAttachedMenuBotFromShortcut$123(user, callback);
            }
        });
    }

    public /* synthetic */ void lambda$processAttachedMenuBotFromShortcut$123(TLRPC.User user, Utilities.Callback callback) {
    ...
    private void processBoostDialog(final Long l, final Runnable runnable, final Browser.Progress progress, final ChatMessageCell chatMessageCell) {
        ...
        boostsController.getBoostsStats(l.longValue(), new com.google.android.exoplayer2.util.Consumer() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda63
            @Override // com.google.android.exoplayer2.util.Consumer
            public final void accept(Object obj) {
                this.f$0.lambda$processBoostDialog$126(progress, runnable, boostsController, l, chatMessageCell, (TL_stories.TL_premium_boostsStatus) obj);
            }
        });
    }

    public /* synthetic */ void lambda$processBoostDialog$126(final Browser.Progress progress, final Runnable runnable, ChannelBoostsController channelBoostsController, final Long l, final ChatMessageCell chatMessageCell, final TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus) {
        if (tL_premium_boostsStatus != null) {
            channelBoostsController.userCanBoostChannel(l.longValue(), tL_premium_boostsStatus, new com.google.android.exoplayer2.util.Consumer() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda104
                @Override // com.google.android.exoplayer2.util.Consumer
                public final void accept(Object obj) {
                    this.f$0.lambda$processBoostDialog$125(progress, l, tL_premium_boostsStatus, chatMessageCell, runnable, (ChannelBoostsController.CanApplyBoost) obj);
                }
            });
            return;
        }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public /* synthetic */ void lambda$processBoostDialog$125(org.telegram.messenger.browser.Browser.Progress r7, java.lang.Long r8, org.telegram.tgnet.tl.TL_stories.TL_premium_boostsStatus r9, org.telegram.p035ui.Cells.ChatMessageCell r10, java.lang.Runnable r11, org.telegram.messenger.ChannelBoostsController.CanApplyBoost r12) {
        /*
            r6 = this;
            if (r7 == 0) goto L5
            r7.end()
        L5:
            ...
            goto L83
        Ld:
            org.telegram.ui.ActionBar.Theme$ResourcesProvider r7 = r1.getResourceProvider()
            org.telegram.ui.Stories.StoryViewer r0 = r1.getLastStoryViewer()
            if (r0 == 0) goto L29
            org.telegram.ui.Stories.StoryViewer r0 = r1.getLastStoryViewer()
            boolean r0 = r0.isFullyVisible()
            if (r0 == 0) goto L29
            org.telegram.ui.Stories.StoryViewer r7 = r1.getLastStoryViewer()
            org.telegram.ui.ActionBar.Theme$ResourcesProvider r7 = r7.getResourceProvider()
        L29:
            r5 = r7
            ...
            r0.setCanApplyBoost(r12)
            boolean r6 = r1 instanceof org.telegram.p035ui.ChatActivity
            r7 = 1
            r12 = 0
            if (r6 == 0) goto L50
            r6 = r1
            org.telegram.ui.ChatActivity r6 = (org.telegram.p035ui.ChatActivity) r6
        ...
        L4e:
            ...
            goto L68
        L50:
            boolean r6 = r1 instanceof org.telegram.p035ui.DialogsActivity
            if (r6 == 0) goto L68
            r6 = r1
            org.telegram.ui.DialogsActivity r6 = (org.telegram.p035ui.DialogsActivity) r6
            org.telegram.ui.RightSlidingDialogContainer r6 = r6.rightSlidingDialogContainer
            if (r6 == 0) goto L4d
            long r2 = r6.getCurrentFragmetDialogId()
            long r4 = r8.longValue()
            int r6 = (r2 > r4 ? 1 : (r2 == r4 ? 0 : -1))
            if (r6 != 0) goto L4d
            goto L4e
        L68:
            r0.setBoostsStats(r9, r12)
            long r6 = r8.longValue()
            r0.setDialogId(r6)
            r0.setChatMessageCell(r10)
            r1.showDialog(r0)
            if (r11 == 0) goto L83
            r11.run()     // Catch: java.lang.Exception -> L7e
            return
        L7e:
            r0 = move-exception
            r6 = r0
    ...
    private void processAttachMenuBot(final int i, final long j, final String str, final TLRPC.User user, final String str2, final String str3) {
        ...
        ConnectionsManager.getInstance(i).sendRequest(tL_messages_getAttachMenuBot, new RequestDelegate() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda144
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                this.f$0.lambda$processAttachMenuBot$133(i, str3, str, user, str2, j, tLObject, tL_error);
            }
        });
    }

    public /* synthetic */ void lambda$processAttachMenuBot$133(final int i, final String str, final String str2, final TLRPC.User user, final String str3, final long j, final TLObject tLObject, TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda154
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$processAttachMenuBot$132(tLObject, i, str, str2, user, str3, j);
            }
        });
    }

    public /* synthetic */ void lambda$processAttachMenuBot$132(TLObject tLObject, final int i, String str, String str2, final TLRPC.User user, final String str3, final long j) {
        ...
        if (tLObject instanceof TLRPC.TL_attachMenuBotsBot) {
            ...
            if (arrayList3.isEmpty()) {
                ...
                dialogsActivity2.setDelegate(new DialogsActivity.DialogsActivityDelegate() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda170
                    @Override // org.telegram.ui.DialogsActivity.DialogsActivityDelegate
                    public final boolean didSelectDialogs(DialogsActivity dialogsActivity3, ArrayList arrayList4, CharSequence charSequence, boolean z, boolean z2, int i3, int i4, TopicsFragment topicsFragment) {
                        return this.f$0.lambda$processAttachMenuBot$127(user, str3, i, dialogsActivity3, arrayList4, charSequence, z, z2, i3, i4, topicsFragment);
                    }
                });
                dialogsActivity = dialogsActivity2;
            }
            if (tL_attachMenuBot.inactive) {
                ...
                WebAppDisclaimerAlert.show(this, new com.google.android.exoplayer2.util.Consumer() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda171
                    @Override // com.google.android.exoplayer2.util.Consumer
                    public final void accept(Object obj) {
                        this.f$0.lambda$processAttachMenuBot$131(i, j, dialogsActivity, baseFragment2, user, str3, (Boolean) obj);
                    }
            ...
            if (dialogsActivity == null) {
                if (baseFragment2 instanceof ChatActivity) {
                    ...
                    if (!MediaDataController.canShowAttachMenuBot(tL_attachMenuBot, chatActivity.getCurrentUser() != null ? chatActivity.getCurrentUser() : chatActivity.getCurrentChat())) {
                        BulletinFactory.m1143of(baseFragment2).createErrorBulletin(LocaleController.getString(C2797R.string.BotAlreadyAddedToAttachMenu)).show();
                        return;
                    } else {
                        chatActivity.openAttachBotLayout(user.f1407id, str3, false);
                        return;
                    }
                }
                BulletinFactory.m1143of(baseFragment2).createErrorBulletin(LocaleController.getString(C2797R.string.BotAlreadyAddedToAttachMenu)).show();
            ...
            while (true) {
                ...
                ArrayList<Dialog> arrayList4 = this.visibleDialogs;
                if (i2 < size) {
                    if (arrayList4.get(i2).isShowing()) {
            ...
            ArrayList<BaseFragment> arrayList5 = this.mainFragmentsStack;
            BulletinFactory.m1143of(arrayList5.get(arrayList5.size() - 1)).createErrorBulletin(LocaleController.getString(C2797R.string.BotCantAddToAttachMenu)).show();
        }
    }

    public /* synthetic */ boolean lambda$processAttachMenuBot$127(TLRPC.User user, String str, int i, DialogsActivity dialogsActivity, ArrayList arrayList, CharSequence charSequence, boolean z, boolean z2, int i2, int i3, TopicsFragment topicsFragment) {
        long j = ((MessagesStorage.TopicKey) arrayList.get(0)).dialogId;
        Bundle bundle = new Bundle();
        bundle.putBoolean("scrollToTopOnResume", true);
        if (DialogObject.isEncryptedDialog(j)) {
    ...
    public /* synthetic */ void lambda$processAttachMenuBot$131(final int i, long j, final DialogsActivity dialogsActivity, final BaseFragment baseFragment, final TLRPC.User user, final String str, Boolean bool) {
        TLRPC.TL_messages_toggleBotInAttachMenu tL_messages_toggleBotInAttachMenu = new TLRPC.TL_messages_toggleBotInAttachMenu();
        tL_messages_toggleBotInAttachMenu.bot = MessagesController.getInstance(i).getInputUser(j);
        tL_messages_toggleBotInAttachMenu.enabled = true;
        tL_messages_toggleBotInAttachMenu.write_allowed = true;
        ConnectionsManager.getInstance(i).sendRequest(tL_messages_toggleBotInAttachMenu, new RequestDelegate() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda176
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                this.f$0.lambda$processAttachMenuBot$130(i, dialogsActivity, baseFragment, user, str, tLObject, tL_error);
            }
        }, 66);
    }

    public /* synthetic */ void lambda$processAttachMenuBot$130(final int i, final DialogsActivity dialogsActivity, final BaseFragment baseFragment, final TLRPC.User user, final String str, final TLObject tLObject, TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda180
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$processAttachMenuBot$129(tLObject, i, dialogsActivity, baseFragment, user, str);
            }
        });
    }

    public /* synthetic */ void lambda$processAttachMenuBot$129(TLObject tLObject, int i, final DialogsActivity dialogsActivity, final BaseFragment baseFragment, final TLRPC.User user, final String str) {
        if (tLObject instanceof TLRPC.TL_boolTrue) {
            MediaDataController.getInstance(i).loadAttachMenuBots(false, true, new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda181
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$processAttachMenuBot$128(dialogsActivity, baseFragment, user, str);
                }
            });
        }
    }

    public /* synthetic */ void lambda$processAttachMenuBot$128(DialogsActivity dialogsActivity, BaseFragment baseFragment, TLRPC.User user, String str) {
        if (dialogsActivity == null) {
            if (baseFragment instanceof ChatActivity) {
                ((ChatActivity) baseFragment).openAttachBotLayout(user.f1407id, str, true);
                return;
            }
            return;
        }
    ...
    private void openForumFromLink(final long j, final Integer num, final String str, final Integer num2, final byte[] bArr, final Runnable runnable, final int i, final int i2) {
        ...
        tL_channels_getMessages.f1292id.add(num);
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_getMessages, new RequestDelegate() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda106
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                this.f$0.lambda$openForumFromLink$135(num, num2, bArr, j, runnable, str, i, i2, tLObject, tL_error);
            }
        });
    }

    public /* synthetic */ void lambda$openForumFromLink$135(final Integer num, final Integer num2, final byte[] bArr, final long j, final Runnable runnable, final String str, final int i, final int i2, final TLObject tLObject, TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda134
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$openForumFromLink$134(tLObject, num, num2, bArr, j, runnable, str, i, i2);
            }
        });
    }

    public /* synthetic */ void lambda$openForumFromLink$134(TLObject tLObject, Integer num, Integer num2, byte[] bArr, long j, Runnable runnable, String str, int i, int i2) {
        TLRPC.Message message;
        if (tLObject instanceof TLRPC.messages_Messages) {
            ArrayList<TLRPC.Message> arrayList = ((TLRPC.messages_Messages) tLObject).messages;
            for (int i3 = 0; i3 < arrayList.size(); i3++) {
                if (arrayList.get(i3) != null && arrayList.get(i3).f1271id == num.intValue()) {
        ...
        if (message != null) {
            ...
            Integer numValueOf = Integer.valueOf(message.f1271id);
    ...
    */
    private java.util.List<org.telegram.tgnet.TLRPC.TL_contact> findContacts(java.lang.String r18, java.lang.String r19, boolean r20) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.LaunchActivity.findContacts(java.lang.String, java.lang.String, boolean):java.util.List");
    }
    ...
    public void checkAppUpdate(final boolean z, final Browser.Progress progress) {
        if (z || Math.abs(System.currentTimeMillis() - ExteraConfig.getUpdateScheduleTimestamp()) >= DurationKt.MILLIS_IN_HOUR) {
    ...
    public /* synthetic */ void lambda$checkAppUpdate$138(final boolean z, final int i, final Browser.Progress progress, final TLRPC.TL_help_appUpdate tL_help_appUpdate, final TLRPC.TL_error tL_error) {
        ...
        if (tL_help_appUpdate != null) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda125
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$checkAppUpdate$136(tL_help_appUpdate, z, i, progress);
                }
            });
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda126
                @Override // java.lang.Runnable
                public final void run() {
                    LaunchActivity.$r8$lambda$96xORVNnVYJY1IQaAFFiw7XjjKQ(progress, tL_error);
                }
            });
        }
    }

    public /* synthetic */ void lambda$checkAppUpdate$136(TLRPC.TL_help_appUpdate tL_help_appUpdate, boolean z, int i, Browser.Progress progress) {
        ...
        if (tL_help_appUpdate2 == null || !tL_help_appUpdate2.version.equals(tL_help_appUpdate.version) || z || tL_help_appUpdate.can_not_skip) {
            ...
            BulletinFactory.m1143of(lastFragment).createSimpleBulletin(C2797R.raw.chats_infotip, LocaleController.getString(C2797R.string.YourVersionIsLatest)).show();
        }
    }

    public static /* synthetic */ void $r8$lambda$96xORVNnVYJY1IQaAFFiw7XjjKQ(Browser.Progress progress, TLRPC.TL_error tL_error) {
        if (progress != null) {
            progress.end();
        }
        BaseFragment lastFragment = getLastFragment();
        if (lastFragment != null) {
            BulletinFactory.m1143of(lastFragment).showForError(tL_error);
        }
    }
        ...
        try {
            ...
            alertDialogShow.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda91
                ...
                public final void onDismiss(DialogInterface dialogInterface) {
                    this.f$0.lambda$showAlertDialog$144(alertDialogShow, dialogInterface);
                }
            });
    ...
    public /* synthetic */ void lambda$showAlertDialog$144(AlertDialog alertDialog, DialogInterface dialogInterface) {
        if (alertDialog != null) {
            if (alertDialog == this.localeDialog) {
                ...
                try {
                    ...
                    if (lastFragment != null) {
                        BulletinFactory.m1143of(lastFragment).createSimpleBulletin(C2797R.raw.msg_translate, getStringForLanguageAlert(str.equals("en") ? this.englishLocaleStrings : this.systemLocaleStrings, "ChangeLanguageLater", C2797R.string.ChangeLanguageLater)).setDuration(5000).show();
                    } else {
                        BulletinFactory.m1142of(Bulletin.BulletinWindow.make(this), null).createSimpleBulletin(C2797R.raw.msg_translate, getStringForLanguageAlert(str.equals("en") ? this.englishLocaleStrings : this.systemLocaleStrings, "ChangeLanguageLater", C2797R.string.ChangeLanguageLater)).setDuration(5000).show();
                    }
                } catch (Exception e) {
                    FileLog.m1048e(e);
                }
    ...
    public void showBulletin(Function<BulletinFactory, Bulletin> function) {
        ...
        if (!this.layerFragmentsStack.isEmpty()) {
            baseFragment = this.layerFragmentsStack.get(r1.size() - 1);
        } else if (!this.rightFragmentsStack.isEmpty()) {
            baseFragment = this.rightFragmentsStack.get(r1.size() - 1);
        ...
        if (BulletinFactory.canShowBulletin(baseFragment)) {
            function.apply(BulletinFactory.m1143of(baseFragment)).show();
        }
    }
    ...
    public boolean canSelectStories() {
        ArrayList<SendMessagesHelper.SendingMediaInfo> arrayList = this.photoPathsArray;
        return (arrayList != null && arrayList.size() == 1) || this.videoPath != null;
    }

    /* JADX WARN: Removed duplicated region for block: B:86:0x0080 A[RETURN] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public boolean didSelectStories(org.telegram.p035ui.DialogsActivity r18) {
        /*
            Method dump skipped, instruction units count: 217
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.LaunchActivity.didSelectStories(org.telegram.ui.DialogsActivity):boolean");
    }

    /* JADX WARN: Removed duplicated region for block: B:449:0x0276  */
    /* JADX WARN: Removed duplicated region for block: B:516:0x03c5  */
    /* JADX WARN: Removed duplicated region for block: B:546:0x049f  */
    /* JADX WARN: Removed duplicated region for block: B:552:0x04ad  */
    /* JADX WARN: Removed duplicated region for block: B:553:0x04b2  */
    /* JADX WARN: Removed duplicated region for block: B:556:0x04b7  */
    /* JADX WARN: Removed duplicated region for block: B:557:0x04bc  */
    /* JADX WARN: Removed duplicated region for block: B:560:0x04c1  */
    /* JADX WARN: Removed duplicated region for block: B:564:0x04fa  */
    /* JADX WARN: Removed duplicated region for block: B:578:0x05b1  */
    /* JADX WARN: Removed duplicated region for block: B:579:0x05c2  */
    /* JADX WARN: Removed duplicated region for block: B:587:0x05d9 A[LOOP:3: B:585:0x05d1->B:587:0x05d9, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:593:0x0620  */
    /* JADX WARN: Type inference failed for: r10v20 */
    /* JADX WARN: Type inference failed for: r10v26, types: [android.net.Uri, java.lang.CharSequence, java.lang.String, java.util.ArrayList<java.lang.String>, java.util.ArrayList<org.telegram.messenger.SendMessagesHelper$SendingMediaInfo>, java.util.ArrayList<org.telegram.tgnet.TLRPC$User>] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public boolean didSelectDialogs(final org.telegram.p035ui.DialogsActivity r46, final java.util.ArrayList<org.telegram.messenger.MessagesStorage.TopicKey> r47, final java.lang.CharSequence r48, final boolean r49, boolean r50, int r51, final int r52, org.telegram.p035ui.TopicsFragment r53) {
        /*
            Method dump skipped, instruction units count: 1620
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.LaunchActivity.didSelectDialogs(org.telegram.ui.DialogsActivity, java.util.ArrayList, java.lang.CharSequence, boolean, boolean, int, int, org.telegram.ui.TopicsFragment):boolean");
    }

    public /* synthetic */ void lambda$didSelectDialogs$145(int i, DialogsActivity dialogsActivity, boolean z, ArrayList arrayList, Uri uri, AlertDialog alertDialog, long j) {
        if (j != 0) {
            Bundle bundle = new Bundle();
            bundle.putBoolean("scrollToTopOnResume", true);
            if (!AndroidUtilities.isTablet()) {
    ...
    public /* synthetic */ void lambda$didSelectDialogs$146(ChatActivity chatActivity, ArrayList arrayList, int i, int i2, CharSequence charSequence, int i3, boolean z, TLRPC.User user, boolean z2, int i4, long j, boolean z3, long j2) {
        ...
        for (int i5 = 0; i5 < arrayList.size(); i5++) {
            ...
            SendMessagesHelper.SendMessageParams sendMessageParamsM1087of = SendMessagesHelper.SendMessageParams.m1087of(user, j3, messageObject2, messageObject2, (TLRPC.ReplyMarkup) null, (HashMap<String, String>) null, z2, i4 != 0 ? i4 : i, i2);
            if (TextUtils.isEmpty(charSequence)) {
                sendMessageParamsM1087of.effect_id = j;
            }
            sendMessageParamsM1087of.invert_media = z3;
            SendMessagesHelper.getInstance(i3).sendMessage(sendMessageParamsM1087of);
            if (!TextUtils.isEmpty(charSequence)) {
    ...
    private static void sendShareText(AccountInstance accountInstance, DialogsActivity dialogsActivity, CharSequence charSequence, long j, MessageObject messageObject, long j2, boolean z, int i, int i2) {
        ...
        accountInstance.getSendMessagesHelper().sendMessage(SendMessagesHelper.SendMessageParams.m1075of(charSequenceArr[0].toString(), j, messageObject, messageObject, sharedWebPage, z2, accountInstance.getMediaDataController().getEntities(charSequenceArr, true), null, null, z, i, i2, null, false));
    }

    private static ArrayList<SendMessagesHelper.SendingMediaInfo> buildSendingInfosFromEntries(ArrayList<MediaController.PhotoEntry> arrayList) {
        String str;
    ...
    private void onFinish() {
        ...
        Utilities.Callback<Boolean> callback = this.onPowerSaverCallback;
        if (callback != null) {
    ...
    public void onPowerSaver(boolean z) {
        ...
        BulletinFactory.m1143of(lastFragment).createSimpleBulletin(new BatteryDrawable(batteryLevel / 100.0f, -1, lastFragment.getThemedColor(Theme.key_dialogSwipeRemove), 1.3f), LocaleController.getString(C2797R.string.LowPowerEnabledTitle), LocaleController.formatString("LowPowerEnabledSubtitle", C2797R.string.LowPowerEnabledSubtitle, String.format("%d%%", Integer.valueOf(batteryLevel))), LocaleController.getString(C2797R.string.Disable), new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda64
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$onPowerSaver$147();
            }
        }).setDuration(5000).show();
    }

    public /* synthetic */ void lambda$onPowerSaver$147() {
    ...
    public INavigationLayout getActionBarLayout() {
        ...
        return this.sheetFragmentsStack.get(r2.size() - 1);
    }
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (SharedConfig.passcodeHash.length() != 0 && SharedConfig.lastPauseTime != 0) {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1045d("reset lastPauseTime onActivityResult");
            }
        ...
        if (i == 105) {
            ...
            if (zCanDrawOverlays) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda36
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onActivityResult$148();
                    }
                }, 200L);
                return;
            }
    ...
    public /* synthetic */ void lambda$onActivityResult$148() {
    ...
    public void onPause() {
        ...
        Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda35
            @Override // java.lang.Runnable
            public final void run() {
                LaunchActivity.$r8$lambda$NjUfMjuLOWqsZokHDHqYY4MWFsQ(i);
            }
        });
        onPasscodePause();
        ...
        ConnectionsManager.getInstance(this.currentAccount).setAppPaused(!(ApplicationLoader.applicationLoaderInstance != null ? r2.onPause() : false), false);
    ...
    public static /* synthetic */ void $r8$lambda$NjUfMjuLOWqsZokHDHqYY4MWFsQ(int i) {
    ...
    /* JADX WARN: Can't wrap try/catch for region: R(21:58|60|(1:62)|63|(1:65)|66|(17:110|67|68|(3:70|(2:72|114)(1:113)|75)(1:112)|108|79|(1:81)|85|(1:87)|88|(2:90|(1:92))(2:93|(1:97))|98|(1:100)|101|(1:103)|104|(2:106|107)(1:115))|76|108|79|(0)|85|(0)|88|(0)(0)|98|(0)|101|(0)|104|(0)(0)) */
    ...
    /* JADX WARN: Removed duplicated region for block: B:81:0x0069 A[Catch: Exception -> 0x007f, TRY_LEAVE, TryCatch #0 {Exception -> 0x007f, blocks: (B:79:0x0065, B:81:0x0069), top: B:108:0x0065 }] */
    ...
    */
    public void onDestroy() {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.LaunchActivity.onDestroy():void");
    }
    ...
    public void onResume() {
        ...
        Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda37
            @Override // java.lang.Runnable
            public final void run() {
                LaunchActivity.m16791$r8$lambda$Eyn8G9afShxY2iEQiXNZNHeqXw();
            }
        });
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda38
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$onResume$151();
            }
        }, 300L);
    }

    /* JADX INFO: renamed from: $r8$lambda$E-yn8G9afShxY2iEQiXNZNHeqXw */
    public static /* synthetic */ void m16791$r8$lambda$Eyn8G9afShxY2iEQiXNZNHeqXw() {
        ApplicationLoader.mainInterfacePausedStageQueue = false;
        ApplicationLoader.mainInterfacePausedStageQueueTime = System.currentTimeMillis();
    }

    public /* synthetic */ void lambda$onResume$151() {
    ...
    /* JADX WARN: Removed duplicated region for block: B:651:0x02b4  */
    /* JADX WARN: Removed duplicated region for block: B:656:0x02cb  */
    /* JADX WARN: Removed duplicated region for block: B:725:0x0451  */
    /* JADX WARN: Removed duplicated region for block: B:795:0x061f  */
    /* JADX WARN: Removed duplicated region for block: B:796:0x0625  */
    /* JADX WARN: Removed duplicated region for block: B:800:0x062c  */
    ...
    */
    public void didReceivedNotification(int r21, final int r22, java.lang.Object... r23) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.LaunchActivity.didReceivedNotification(int, int, java.lang.Object[]):void");
    }

    public /* synthetic */ void lambda$didReceivedNotification$152(int i, AlertDialog alertDialog, int i2) {
        if (this.mainFragmentsStack.isEmpty()) {
            return;
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C589817 extends ClickableSpan {
        public C589817() {
        }
    ...
    public /* synthetic */ void lambda$didReceivedNotification$153(AlertDialog alertDialog, int i) {
        MessagesController.getInstance(this.currentAccount).performLogout(2);
    }

    public /* synthetic */ void lambda$didReceivedNotification$155(final HashMap map, final int i, AlertDialog alertDialog, int i2) {
        if (this.mainFragmentsStack.isEmpty()) {
            return;
        }
        if (AndroidUtilities.isMapsInstalled(this.mainFragmentsStack.get(r3.size() - 1))) {
            LocationActivity locationActivity = new LocationActivity(0);
            locationActivity.setDelegate(new LocationActivity.LocationActivityDelegate() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda61
                @Override // org.telegram.ui.LocationActivity.LocationActivityDelegate
                public final void didSelectLocation(TLRPC.MessageMedia messageMedia, int i3, boolean z, int i4, long j) {
                    LaunchActivity.$r8$lambda$ETQeb5hoj5u8KkVyddSPclU9kFU(map, i, messageMedia, i3, z, i4, j);
                }
            });
            lambda$runLinkRequest$101(locationActivity);
        }
    ...
    public static /* synthetic */ void $r8$lambda$ETQeb5hoj5u8KkVyddSPclU9kFU(HashMap map, int i, TLRPC.MessageMedia messageMedia, int i2, boolean z, int i3, long j) {
        Iterator it = map.entrySet().iterator();
        while (it.hasNext()) {
            MessageObject messageObject = (MessageObject) ((Map.Entry) it.next()).getValue();
            SendMessagesHelper.getInstance(i).sendMessage(SendMessagesHelper.SendMessageParams.m1079of(messageMedia, messageObject.getDialogId(), messageObject, (MessageObject) null, (TLRPC.ReplyMarkup) null, (HashMap<String, String>) null, z, i3, 0));
        }
    }

    /* JADX INFO: renamed from: org.telegram.ui.LaunchActivity$18 */
    /* JADX INFO: loaded from: classes6.dex */
    public class C589918 extends AnimatorListenerAdapter {
        ...
        public C589918(RLottieDrawable rLottieDrawable, RLottieImageView rLottieImageView, RLottieDrawable rLottieDrawable2, boolean z) {
    ...
    public /* synthetic */ void lambda$didReceivedNotification$163() {
        ...
        File file = new File(ApplicationLoader.getFilesDirFixed(), "remote" + this.loadingTheme.f1395id + ".attheme");
    ...
    private void showVoiceChatTooltip(int i) {
        ...
        if (currentVisibleFragment instanceof ChatActivity) {
            ...
            if (chat != null && chatActivity.getDialogId() == (-chat.f1245id)) {
                chat = null;
            }
    ...
    private void openThemeAccentPreview(TLRPC.TL_theme tL_theme, TLRPC.TL_wallPaper tL_wallPaper, Theme.ThemeInfo themeInfo) {
        ...
        themeInfo.setCurrentAccentId(themeAccentCreateNewAccent.f1479id);
    ...
    private void showLanguageAlertInternal(LocaleController.LocaleInfo localeInfo, LocaleController.LocaleInfo localeInfo2, String str) {
        try {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            builder.setTitle(getStringForLanguageAlert(this.systemLocaleStrings, "ChooseYourLanguage", C2797R.string.ChooseYourLanguage));
            builder.setSubtitle(getStringForLanguageAlert(this.englishLocaleStrings, "ChooseYourLanguage", C2797R.string.ChooseYourLanguage));
            LinearLayout linearLayout = new LinearLayout(this);
            linearLayout.setOrientation(1);
            final LanguageCell[] languageCellArr = new LanguageCell[2];
            String stringForLanguageAlert = getStringForLanguageAlert(this.systemLocaleStrings, "English", C2797R.string.English);
            ...
            languageCell2.setValue(getStringForLanguageAlert(this.systemLocaleStrings, "ChooseYourLanguageOther", C2797R.string.ChooseYourLanguageOther), getStringForLanguageAlert(this.englishLocaleStrings, "ChooseYourLanguageOther", C2797R.string.ChooseYourLanguageOther));
            ...
            builder.setNegativeButton(LocaleController.getString(C2797R.string.f1162OK), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda149
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i2) {
            ...
            try {
                if (!this.loadingLocaleDialog && !ApplicationLoader.mainInterfacePaused) {
                    ...
                    if (!z && string.equals(str2)) {
                        if (BuildVars.LOGS_ENABLED) {
                            FileLog.m1045d("alert already showed for ".concat(string));
                            return;
                        }
                        return;
                    }
                    ...
                    if (localeInfo3 != null && (localeInfo = localeInfoArr[1]) != null && localeInfo3 != localeInfo) {
                        if (BuildVars.LOGS_ENABLED) {
                            FileLog.m1045d("show lang alert for " + localeInfoArr[c2].getKey() + " and " + localeInfoArr[1].getKey());
                        }
    ...
    private void onPasscodePause() {
        ...
        if (this.lockRunnable != null) {
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1045d("cancel lockRunnable onPasscodePause");
            }
        ...
        if (SharedConfig.passcodeHash.length() != 0) {
            SharedConfig.lastPauseTime = (int) (SystemClock.elapsedRealtime() / 1000);
            RunnableC590019 runnableC590019 = new Runnable() { // from class: org.telegram.ui.LaunchActivity.19
                public RunnableC590019() {
                }
            ...
            this.lockRunnable = runnableC590019;
            if (SharedConfig.appLocked || (i = SharedConfig.autoLockIn) == Integer.MAX_VALUE) {
                AndroidUtilities.runOnUIThread(runnableC590019, 1000L);
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m1045d("schedule app lock in 1000");
                }
            } else if (i != 0) {
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m1045d("schedule app lock in " + ((((long) SharedConfig.autoLockIn) * 1000) + 1000));
                }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class RunnableC590019 implements Runnable {
        public RunnableC590019() {
        }
    ...
    private void onPasscodeResume() {
        if (this.lockRunnable != null) {
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1045d("cancel lockRunnable onPasscodeResume");
            }
            AndroidUtilities.cancelRunOnUIThread(this.lockRunnable);
            this.lockRunnable = null;
        }
        ...
        if (SharedConfig.lastPauseTime != 0) {
            ...
            SharedConfig.saveConfig();
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1045d("reset lastPauseTime onPasscodeResume");
            }
        }
    }
    ...
    private void updateCurrentConnectionState() {
        ...
        if (connectionState == 2) {
            i = C2797R.string.WaitingForNetwork;
            str = "WaitingForNetwork";
        } else if (connectionState == 5) {
            i = C2797R.string.Updating;
            str = "Updating";
        } else if (connectionState == 4) {
            i = C2797R.string.ConnectingToProxyWithDots;
            str = "ConnectingToProxyWithDots";
        } else if (connectionState == 1) {
            i = C2797R.string.Connecting;
            str = "Connecting";
        } else {
            i = 0;
            str = null;
    ...
    */
    public /* synthetic */ void lambda$updateCurrentConnectionState$181() {
        /*
            ...
            boolean r0 = org.telegram.messenger.AndroidUtilities.isTablet()
            if (r0 == 0) goto L1d
            java.util.ArrayList<org.telegram.ui.ActionBar.BaseFragment> r0 = r2.layerFragmentsStack
            ...
            goto L35
        L1d:
            java.util.ArrayList<org.telegram.ui.ActionBar.BaseFragment> r0 = r2.mainFragmentsStack
            boolean r0 = r0.isEmpty()
            if (r0 != 0) goto L34
            java.util.ArrayList<org.telegram.ui.ActionBar.BaseFragment> r0 = r2.mainFragmentsStack
            int r1 = r0.size()
        ...
        L34:
            r0 = 0
        L35:
            boolean r1 = r0 instanceof org.telegram.p035ui.ProxyListActivity
            if (r1 != 0) goto L46
            boolean r0 = r0 instanceof org.telegram.p035ui.ProxySettingsActivity
            if (r0 == 0) goto L3e
            goto L46
        L3e:
            org.telegram.ui.ProxyListActivity r0 = new org.telegram.ui.ProxyListActivity
            r0.<init>()
            r2.lambda$runLinkRequest$101(r0)
        L46:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.LaunchActivity.lambda$updateCurrentConnectionState$181():void");
    }
    ...
    */
    public void onSaveInstanceState(android.os.Bundle r6) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.LaunchActivity.onSaveInstanceState(android.os.Bundle):void");
    }
    ...
    public static <T extends BaseFragment> T findFragment(Class<T> cls) {
        ...
        LaunchActivity launchActivity = instance;
        if (launchActivity != null && !launchActivity.sheetFragmentsStack.isEmpty()) {
            return (T) instance.sheetFragmentsStack.get(r0.size() - 1).findFragment(cls);
        }
        LaunchActivity launchActivity2 = instance;
        if (launchActivity2 == null || launchActivity2.getActionBarLayout() == null) {
            return null;
    ...
    public static List<BaseFragment> getVisibleFragments() {
        ...
        if (launchActivity != null) {
            ...
            if (!instance.layerFragmentsStack.isEmpty()) {
                arrayList.add(instance.layerFragmentsStack.get(r1.size() - 1));
            }
            if (!instance.rightFragmentsStack.isEmpty()) {
                arrayList.add(instance.rightFragmentsStack.get(r1.size() - 1));
            }
            if (!instance.mainFragmentsStack.isEmpty()) {
                arrayList.add(instance.mainFragmentsStack.get(r1.size() - 1));
            }
        }
        return arrayList;
    }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C590220 extends AnimatorListenerAdapter {
        final /* synthetic */ int val$toColor;
    ...
    private void openStory(final long j, final int i, final boolean z) {
        ...
        StoriesListPlaceProvider storiesListPlaceProviderM1210of = null;
        if (stories != null) {
            int i2 = 0;
            while (true) {
                if (i2 >= stories.stories.size()) {
                    ...
                    if (stories.stories.get(i2).f1454id == i) {
            ...
            if (storyItem != null) {
                ...
                if (lastFragment instanceof DialogsActivity) {
                    try {
                        storiesListPlaceProviderM1210of = StoriesListPlaceProvider.m1210of(((DialogsActivity) lastFragment).dialogStoriesCell.recyclerListView);
                    } catch (Exception unused) {
                    }
                }
                ...
                lastFragment.getOrCreateStoryViewer().open(this, storyItem, arrayList, 0, null, stories, storiesListPlaceProviderM1210of, false);
                return;
            }
        } else {
            storyItem = null;
        ...
        if (storyItem == null) {
            ...
            if (storyItem != null && storiesList != null) {
                ...
                if (lastFragment2 instanceof DialogsActivity) {
                    try {
                        storiesListPlaceProviderM1210of = StoriesListPlaceProvider.m1210of(((DialogsActivity) lastFragment2).dialogStoriesCell.recyclerListView);
                ...
                lastFragment2.getOrCreateStoryViewer().open(this, storyItem, arrayList2, 0, storiesList, null, storiesListPlaceProviderM1210of, false);
                return;
            }
        }
    ...
    public /* synthetic */ void lambda$openStory$183(TLObject tLObject, int i, long j, boolean z) {
        StoriesListPlaceProvider storiesListPlaceProviderM1210of;
        TL_stories.StoryItem storyItem;
        if (tLObject instanceof TL_stories.TL_stories_stories) {
            TL_stories.TL_stories_stories tL_stories_stories = (TL_stories.TL_stories_stories) tLObject;
            int i2 = 0;
            while (true) {
                storiesListPlaceProviderM1210of = null;
            ...
            if (storyItem != null) {
                ...
                StoriesListPlaceProvider storiesListPlaceProvider = storiesListPlaceProviderM1210of;
                lastFragment.getOrCreateStoryViewer().instantClose();
                ArrayList<Long> arrayList = new ArrayList<>();
        ...
        BulletinFactory.global().createSimpleBulletin(C2797R.raw.error, LocaleController.getString(C2797R.string.StoryNotFound)).show(false);
    }
                    ...
                    ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_stories_getPeerStories, new RequestDelegate() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda49
                        ...
                        public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.LaunchActivity$$ExternalSyntheticLambda119
                                @Override // java.lang.Runnable
                                public final void run() {
                                    LaunchActivity.m16817$r8$lambda$g396DMT6FUNOZ_uEPabL1YbpE0(tLObject, messagesController, j, runnable);
                                }
                            });
                        }
                    });
    ...
    /* JADX INFO: renamed from: $r8$lambda$g396DMT6FUNO-Z_uEPabL1YbpE0 */
    public static /* synthetic */ void m16817$r8$lambda$g396DMT6FUNOZ_uEPabL1YbpE0(TLObject tLObject, MessagesController messagesController, long j, Runnable runnable) {
    ...
    public static class ActivityVisibilityController implements WindowVisibilityManager.Controller {
        ...
        public /* synthetic */ ActivityVisibilityController(LaunchActivity launchActivity, boolean z, LaunchActivityIA launchActivityIA) {
