...
public class ProfileNotificationsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public interface ProfileNotificationsActivityDelegate {
        ...
        default void didRemoveException(long j) {
        }
    }
    ...
    */
    public boolean onFragmentCreate() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.ProfileNotificationsActivity.onFragmentCreate():boolean");
    }
    ...
    public View createView(final Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.ProfileNotificationsActivity.1
            ...
            public void onItemClick(int i) {
                if (i == -1) {
                    ...
                    TLRPC.Dialog dialog = MessagesController.getInstance(((BaseFragment) ProfileNotificationsActivity.this).currentAccount).dialogs_dict.get(ProfileNotificationsActivity.this.dialogId);
                    boolean z = ProfileNotificationsActivity.this.notificationsEnabled;
                    String str = sharedPrefKey;
                    if (z) {
                        editorEdit.putInt(NotificationsSettingsFacade.PROPERTY_NOTIFY + str, 0);
                        ...
                        editorEdit.putInt(NotificationsSettingsFacade.PROPERTY_NOTIFY + str, 2);
                        if (ProfileNotificationsActivity.this.topicId == 0) {
        ...
        if (z) {
            chatAvatarContainer2.setSubtitle(LocaleController.getString(C2797R.string.NotificationsNewException));
            this.actionBar.createMenu().addItem(1, LocaleController.getString(C2797R.string.Done).toUpperCase());
        } else {
            chatAvatarContainer2.setSubtitle(LocaleController.getString(C2797R.string.CustomNotifications));
        }
    ...
    public /* synthetic */ void lambda$createView$6(Context context, final String str, View view, int i) {
        if (view.isEnabled()) {
            ...
            if (i == this.customResetRow) {
                AlertDialog alertDialogCreate = new AlertDialog.Builder(context, this.resourcesProvider).setTitle(LocaleController.getString(C2797R.string.ResetCustomNotificationsAlertTitle)).setMessage(LocaleController.getString(C2797R.string.ResetCustomNotificationsAlert)).setPositiveButton(LocaleController.getString(C2797R.string.Reset), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ProfileNotificationsActivity$$ExternalSyntheticLambda2
        ...
        if (uri == null || (ringtone = RingtoneManager.getRingtone(ApplicationLoader.applicationContext, uri)) == null) {
            ...
            if (i == 13) {
                if (uri.equals(Settings.System.DEFAULT_RINGTONE_URI)) {
                    title = LocaleController.getString(C2797R.string.DefaultRingtone);
                } else {
                    title = ringtone.getTitle(getParentActivity());
                }
            } else if (uri.equals(Settings.System.DEFAULT_NOTIFICATION_URI)) {
                title = LocaleController.getString(C2797R.string.SoundDefault);
            } else {
                title = ringtone.getTitle(getParentActivity());
            }
            ringtone.stop();
            ...
            switch (viewHolder.getItemViewType()) {
                case 0:
                    ...
                    if (i == ProfileNotificationsActivity.this.generalRow) {
                        headerCell.setText(LocaleController.getString(C2797R.string.General));
                    } else if (i == ProfileNotificationsActivity.this.popupRow) {
                        headerCell.setText(LocaleController.getString(C2797R.string.ProfilePopupNotification));
                    } else if (i == ProfileNotificationsActivity.this.ledRow) {
                        headerCell.setText(LocaleController.getString(C2797R.string.NotificationsLed));
                    } else if (i == ProfileNotificationsActivity.this.callsRow) {
                        headerCell.setText(LocaleController.getString(C2797R.string.VoipNotificationSettings));
                    }
                    break;
                case 1:
                    ...
                    if (i == ProfileNotificationsActivity.this.customResetRow) {
                        textSettingsCell.setText(LocaleController.getString(C2797R.string.ResetCustomNotifications), false);
                        ...
                        if (i == ProfileNotificationsActivity.this.soundRow) {
                            String string = notificationsSettings.getString("sound_" + sharedPrefKey, LocaleController.getString(C2797R.string.SoundDefault));
                            ...
                            if (j != 0) {
                                ...
                                if (document == null) {
                                    strTrimTitle = LocaleController.getString(C2797R.string.CustomSound);
                                } else {
                                    strTrimTitle = NotificationsSoundActivity.trimTitle(document, document.file_name_fixed);
                                }
                                string = strTrimTitle;
                            } else if (string.equals("NoSound")) {
                                string = LocaleController.getString(C2797R.string.NoSound);
                            } else if (string.equals("Default")) {
                                string = LocaleController.getString(C2797R.string.SoundDefault);
                            }
                            textSettingsCell.setTextAndValue(LocaleController.getString(C2797R.string.Sound), string, true);
                        } else if (i == ProfileNotificationsActivity.this.ringtoneRow) {
                            String string2 = notificationsSettings.getString("ringtone_" + sharedPrefKey, LocaleController.getString(C2797R.string.DefaultRingtone));
                            if (string2.equals("NoSound")) {
                                string2 = LocaleController.getString(C2797R.string.NoSound);
                            }
                            textSettingsCell.setTextAndValue(LocaleController.getString(C2797R.string.VoipSettingsRingtone), string2, false);
                        } else if (i == ProfileNotificationsActivity.this.vibrateRow) {
                            int i3 = notificationsSettings.getInt("vibrate_" + sharedPrefKey, 0);
                            if (i3 == 0 || i3 == 4) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2797R.string.Vibrate), LocaleController.getString(C2797R.string.VibrationDefault), (ProfileNotificationsActivity.this.smartRow == -1 && ProfileNotificationsActivity.this.priorityRow == -1) ? false : true);
                            } else if (i3 == 1) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2797R.string.Vibrate), LocaleController.getString(C2797R.string.Short), (ProfileNotificationsActivity.this.smartRow == -1 && ProfileNotificationsActivity.this.priorityRow == -1) ? false : true);
                            } else if (i3 == 2) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2797R.string.Vibrate), LocaleController.getString(C2797R.string.VibrationDisabled), (ProfileNotificationsActivity.this.smartRow == -1 && ProfileNotificationsActivity.this.priorityRow == -1) ? false : true);
                            } else if (i3 == 3) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2797R.string.Vibrate), LocaleController.getString(C2797R.string.Long), (ProfileNotificationsActivity.this.smartRow == -1 && ProfileNotificationsActivity.this.priorityRow == -1) ? false : true);
                            }
                        } else if (i == ProfileNotificationsActivity.this.priorityRow) {
                            int i4 = notificationsSettings.getInt("priority_" + sharedPrefKey, 3);
                            if (i4 == 0) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2797R.string.NotificationsImportance), LocaleController.getString(C2797R.string.NotificationsPriorityHigh), false);
                            } else if (i4 == 1 || i4 == 2) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2797R.string.NotificationsImportance), LocaleController.getString(C2797R.string.NotificationsPriorityUrgent), false);
                            } else if (i4 == 3) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2797R.string.NotificationsImportance), LocaleController.getString(C2797R.string.NotificationsPrioritySettings), false);
                            } else if (i4 == 4) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2797R.string.NotificationsImportance), LocaleController.getString(C2797R.string.NotificationsPriorityLow), false);
                            } else if (i4 == 5) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2797R.string.NotificationsImportance), LocaleController.getString(C2797R.string.NotificationsPriorityMedium), false);
                            }
                            ...
                            if (i5 == 0) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2797R.string.SmartNotifications), LocaleController.getString(C2797R.string.SmartNotificationsDisabled), ProfileNotificationsActivity.this.priorityRow != -1);
                            } else {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2797R.string.SmartNotifications), LocaleController.formatString("SmartNotificationsInfo", C2797R.string.SmartNotificationsInfo, Integer.valueOf(i5), LocaleController.formatPluralString("Minutes", i6 / 60, new Object[0])), ProfileNotificationsActivity.this.priorityRow != -1);
                            }
                            ...
                            if (i7 == 0 || i7 == 4) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2797R.string.Vibrate), LocaleController.getString(C2797R.string.VibrationDefault), true);
                            } else if (i7 == 1) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2797R.string.Vibrate), LocaleController.getString(C2797R.string.Short), true);
                            } else if (i7 == 2) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2797R.string.Vibrate), LocaleController.getString(C2797R.string.VibrationDisabled), true);
                            } else if (i7 == 3) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2797R.string.Vibrate), LocaleController.getString(C2797R.string.Long), true);
                            }
                        }
                    }
                    break;
                case 2:
                    ...
                    if (i == ProfileNotificationsActivity.this.popupInfoRow) {
                        textInfoPrivacyCell.setText(LocaleController.getString(C2797R.string.ProfilePopupNotificationInfo));
                    } else if (i == ProfileNotificationsActivity.this.ledInfoRow) {
                        textInfoPrivacyCell.setText(LocaleController.getString(C2797R.string.NotificationsLedInfo));
                    } else {
                        int i8 = ProfileNotificationsActivity.this.priorityInfoRow;
                        ...
                        if (i == i8) {
                            if (profileNotificationsActivity.priorityRow == -1) {
                                ...
                                textInfoPrivacyCell.setText(LocaleController.getString(C2797R.string.PriorityInfo));
                            }
                        } else if (i == profileNotificationsActivity.ringtoneInfoRow) {
                            textInfoPrivacyCell.setText(LocaleController.getString(C2797R.string.VoipRingtoneInfo));
                        }
                    }
                    break;
                case 3:
                    ...
                    textColorCell.setTextAndColor(LocaleController.getString(C2797R.string.NotificationsLedColor), i2, false);
                    break;
                case 4:
                    ...
                    if (i == ProfileNotificationsActivity.this.popupEnabledRow) {
                        radioCell.setText(LocaleController.getString(C2797R.string.PopupEnabled), i10 == 1, true);
                        radioCell.setTag(1);
                    } else if (i == ProfileNotificationsActivity.this.popupDisabledRow) {
                        radioCell.setText(LocaleController.getString(C2797R.string.PopupDisabled), i10 == 2, false);
                        radioCell.setTag(2);
                    }
                    break;
                case 5:
                    UserCell2 userCell2 = (UserCell2) viewHolder.itemView;
                    boolean zIsUserDialog = DialogObject.isUserDialog(ProfileNotificationsActivity.this.dialogId);
                    ProfileNotificationsActivity profileNotificationsActivity2 = ProfileNotificationsActivity.this;
                    userCell2.setData(zIsUserDialog ? MessagesController.getInstance(((BaseFragment) profileNotificationsActivity2).currentAccount).getUser(Long.valueOf(ProfileNotificationsActivity.this.dialogId)) : MessagesController.getInstance(((BaseFragment) profileNotificationsActivity2).currentAccount).getChat(Long.valueOf(-ProfileNotificationsActivity.this.dialogId)), null, null, 0);
                    break;
                case 6:
                ...
                case 7:
                    ...
                    if (i == ProfileNotificationsActivity.this.enableRow) {
                        textCheckCell.setTextAndCheck(LocaleController.getString(C2797R.string.Notifications), ProfileNotificationsActivity.this.notificationsEnabled, true);
                    } else {
                        int i11 = ProfileNotificationsActivity.this.previewRow;
                        ProfileNotificationsActivity profileNotificationsActivity3 = ProfileNotificationsActivity.this;
                        if (i == i11) {
                            String sharedPrefKey3 = NotificationsController.getSharedPrefKey(profileNotificationsActivity3.dialogId, ProfileNotificationsActivity.this.topicId);
                            textCheckCell.setTextAndCheck(LocaleController.getString(C2797R.string.MessagePreview), notificationsSettings4.getBoolean(NotificationsSettingsFacade.PROPERTY_CONTENT_PREVIEW + sharedPrefKey3, true), true);
                        } else if (i == profileNotificationsActivity3.storiesRow) {
                            ...
                            textCheckCell.setTextAndCheck(LocaleController.getString(C2797R.string.StoriesSoundEnabled), notificationsSettings4.getBoolean(str, z), true);
                        }
                    }
                    break;
            }
