...
import org.telegram.p035ui.Cells.CreationTextCell;
...
public class ManageLinksActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private final LinkEditActivity.Callback linkEditActivityCallback = new C60996();
    ...
    public static class EmptyView extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
        ...
        public EmptyView(Context context) {
            ...
            setPadding(0, AndroidUtilities.m1036dp(12.0f), 0, AndroidUtilities.m1036dp(12.0f));
            setOrientation(1);
    ...
    */
    public /* synthetic */ void lambda$loadLinks$5(org.telegram.tgnet.TLRPC.TL_chatInviteExported r7, final boolean r8, final org.telegram.tgnet.TLObject r9, final org.telegram.tgnet.TLRPC.TL_error r10) {
        /*
            ...
            java.util.ArrayList<org.telegram.tgnet.TLRPC$ExportedChatInvite> r1 = r0.invites
            int r1 = r1.size()
            if (r1 <= 0) goto L37
            if (r7 == 0) goto L37
            r1 = 0
        L10:
            java.util.ArrayList<org.telegram.tgnet.TLRPC$ExportedChatInvite> r2 = r0.invites
            int r2 = r2.size()
            if (r1 >= r2) goto L37
            java.util.ArrayList<org.telegram.tgnet.TLRPC$ExportedChatInvite> r2 = r0.invites
            ...
            if (r2 == 0) goto L34
            java.util.ArrayList<org.telegram.tgnet.TLRPC$ExportedChatInvite> r7 = r0.invites
        ...
        L39:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.ManageLinksActivity.lambda$loadLinks$5(org.telegram.tgnet.TLRPC$TL_chatInviteExported, boolean, org.telegram.tgnet.TLObject, org.telegram.tgnet.TLRPC$TL_error):void");
    }
    ...
    */
    public /* synthetic */ void lambda$loadLinks$3(org.telegram.tgnet.TLRPC.TL_chatInviteExported r7, org.telegram.tgnet.TLRPC.TL_error r8, org.telegram.tgnet.TLObject r9, boolean r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.ManageLinksActivity.lambda$loadLinks$3(org.telegram.tgnet.TLRPC$TL_chatInviteExported, org.telegram.tgnet.TLRPC$TL_error, org.telegram.tgnet.TLObject, boolean):void");
    }
    ...
    */
    public void updateRows(boolean r7) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.ManageLinksActivity.updateRows(boolean):void");
    }
    ...
    public View createView(final Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2797R.string.InviteLinks));
        ...
        this.linkIcon = ContextCompat.getDrawable(context, C2797R.drawable.msg_link_1);
        this.linkIconRevoked = ContextCompat.getDrawable(context, C2797R.drawable.msg_link_2);
        this.linkIconRevenue = ContextCompat.getDrawable(context, C2797R.drawable.large_income);
    ...
    public /* synthetic */ void lambda$createView$9(Context context, View view, int i) {
        ...
        if (i == this.revokeAllRow) {
            ...
            builder.setTitle(LocaleController.getString(C2797R.string.DeleteAllRevokedLinks));
            builder.setMessage(LocaleController.getString(C2797R.string.DeleteAllRevokedLinkHelp));
            builder.setPositiveButton(LocaleController.getString(C2797R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda6
    ...
    public class HintInnerCell extends FrameLayout {
        ...
        public HintInnerCell(Context context) {
            ...
            this.messageTextView.setText(LocaleController.getString(ManageLinksActivity.this.isChannel ? C2797R.string.PrimaryLinkHelpChannel : C2797R.string.PrimaryLinkHelp));
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            switch (i) {
                ...
                case 8:
                    ...
                    textSettingsCell.setText(LocaleController.getString(C2797R.string.DeleteAllRevokedLinks), false);
        ...
        /* JADX WARN: Removed duplicated region for block: B:51:0x014d A[PHI: r0
  0x014d: PHI (r0v22 org.telegram.tgnet.TLRPC$TL_chatInviteExported) = (r0v20 org.telegram.tgnet.TLRPC$TL_chatInviteExported), (r0v28 org.telegram.tgnet.TLRPC$TL_chatInviteExported) binds: [B:53:0x016a, B:50:0x014b] A[DONT_GENERATE, DONT_INLINE]] */
        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct code enable 'Show inconsistent code' option in preferences
    ...
    public /* synthetic */ void lambda$revokePermanent$11(TLRPC.TL_error tL_error, TLObject tLObject, TLRPC.TL_chatInviteExported tL_chatInviteExported) {
        if (tL_error == null) {
            ...
            updateRecyclerViewAnimated(diffCallbackSaveListState);
            BulletinFactory.m1143of(this).createSimpleBulletin(C2797R.raw.linkbroken, LocaleController.getString(C2797R.string.InviteRevokedHint)).show();
        }
    }
    ...
    public class LinkCell extends FrameLayout {
        ...
        public LinkCell(Context context) {
            ...
            imageView.setImageDrawable(ContextCompat.getDrawable(context, C2797R.drawable.ic_ab_other));
        ...
        public /* synthetic */ void lambda$new$7(View view) {
            ...
            if (view2 instanceof ViewGroup) {
                ...
                if (this.invite.revoked) {
                    itemOptionsMakeOptions.add(C2797R.drawable.msg_delete, (CharSequence) LocaleController.getString(C2797R.string.Delete), true, new Runnable() { // from class: org.telegram.ui.ManageLinksActivity$LinkCell$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
                    ...
                    itemOptionsMakeOptions.add(C2797R.drawable.msg_copy, LocaleController.getString(C2797R.string.CopyLink), new Runnable() { // from class: org.telegram.ui.ManageLinksActivity$LinkCell$$ExternalSyntheticLambda2
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$new$2();
                        }
                    });
                    itemOptionsMakeOptions.add(C2797R.drawable.msg_share, LocaleController.getString(C2797R.string.ShareLink), new Runnable() { // from class: org.telegram.ui.ManageLinksActivity$LinkCell$$ExternalSyntheticLambda3
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$new$3();
                        }
                    });
                    itemOptionsMakeOptions.addIf(!this.invite.permanent && ManageLinksActivity.this.canEdit, C2797R.drawable.msg_edit, LocaleController.getString(C2797R.string.EditLink), new Runnable() { // from class: org.telegram.ui.ManageLinksActivity$LinkCell$$ExternalSyntheticLambda4
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$new$4();
                        }
                    });
                    itemOptionsMakeOptions.addIf(ManageLinksActivity.this.canEdit, C2797R.drawable.msg_delete, (CharSequence) LocaleController.getString(C2797R.string.RevokeLink), true, new Runnable() { // from class: org.telegram.ui.ManageLinksActivity$LinkCell$$ExternalSyntheticLambda5
                        @Override // java.lang.Runnable
                        public final void run() {
        ...
        public /* synthetic */ void lambda$new$1() {
            final TLRPC.TL_chatInviteExported tL_chatInviteExported = this.invite;
            new AlertDialog.Builder(ManageLinksActivity.this.getParentActivity()).setTitle(LocaleController.getString(C2797R.string.DeleteLink)).setMessage(LocaleController.getString(C2797R.string.DeleteLinkHelp)).setPositiveButton(LocaleController.getString(C2797R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ManageLinksActivity$LinkCell$$ExternalSyntheticLambda7
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                        ...
                        if (z) {
                            if (longSparseArray != null && longSparseArray.size() == 1) {
                                ...
                                if (j == 0 || j == ManageLinksActivity.this.getUserConfig().getClientUserId()) {
                                    ...
                                    string = LocaleController.formatString(C2797R.string.InvLinkToUser, ManageLinksActivity.this.getMessagesController().getPeerName(j, true));
                                }
                            } else {
                                string = LocaleController.formatString(C2797R.string.InvLinkToChats, LocaleController.formatPluralString("Chats", i, new Object[0]));
                            }
                            Bulletin bulletinCreateSimpleBulletin = BulletinFactory.m1143of(ManageLinksActivity.this).createSimpleBulletin(C2797R.raw.forward, AndroidUtilities.replaceTags(string));
        ...
        public /* synthetic */ void lambda$new$6() {
            final TLRPC.TL_chatInviteExported tL_chatInviteExported = this.invite;
            new AlertDialog.Builder(ManageLinksActivity.this.getParentActivity()).setMessage(LocaleController.getString(C2797R.string.RevokeAlert)).setTitle(LocaleController.getString(C2797R.string.RevokeLink)).setPositiveButton(LocaleController.getString(C2797R.string.RevokeButton), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ManageLinksActivity$LinkCell$$ExternalSyntheticLambda6
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i) {
        ...
        */
        ...
        public void setLink(TLRPC.TL_chatInviteExported tL_chatInviteExported, int i) {
            ...
            int iM1036dp = AndroidUtilities.m1036dp(30.0f);
            ...
            if (tL_starsSubscriptionPricing != null) {
                ...
                if (i3 == 2592000) {
                    this.priceSubitleView.setText(LocaleController.getString(C2797R.string.StarsParticipantSubscriptionPerMonth));
                } else if (i3 == 300) {
                    this.priceSubitleView.setText("per 5 minutes");
                } else if (i3 == 60) {
                    this.priceSubitleView.setText("each minute");
                }
                iM1036dp = AndroidUtilities.m1036dp(28.0f) + ((int) Math.max(HintView2.measureCorrectly(this.priceTitleView.getText(), this.priceTitleView.getPaint()), HintView2.measureCorrectly(this.priceSubitleView.getText(), this.priceSubitleView.getPaint())));
            } else {
                linearLayout.setVisibility(8);
                this.optionsView.setVisibility(8);
            }
            ((ViewGroup.MarginLayoutParams) this.textLayout.getLayoutParams()).rightMargin = iM1036dp;
            if (!TextUtils.isEmpty(tL_chatInviteExported.title)) {
                ...
                boolean zStartsWith = tL_chatInviteExported.link.startsWith("https://");
                TextView textView = this.titleView;
                if (zStartsWith) {
                    textView.setText(tL_chatInviteExported.link.substring(8));
                } else {
                    textView.setText(tL_chatInviteExported.link);
                }
            }
            int i4 = tL_chatInviteExported.usage;
            if (i4 == 0 && tL_chatInviteExported.usage_limit == 0 && tL_chatInviteExported.requested == 0) {
                pluralString = LocaleController.getString(tL_chatInviteExported.subscription_pricing != null ? C2797R.string.NoOneSubscribed : C2797R.string.NoOneJoined);
            } else {
            ...
            if (tL_chatInviteExported.permanent && !tL_chatInviteExported.revoked) {
                ...
                spannableStringBuilder2.append((CharSequence) LocaleController.getString(C2797R.string.Permanent));
                ...
                if (tL_chatInviteExported.revoked && tL_chatInviteExported.usage == 0) {
                    String string = LocaleController.getString(tL_chatInviteExported.subscription_pricing != null ? C2797R.string.NoOneSubscribed : C2797R.string.NoOneJoined);
                    spannableStringBuilder2.clear();
                    spannableStringBuilder2.append((CharSequence) string);
                }
                DotDividerSpan dotDividerSpan2 = new DotDividerSpan();
                dotDividerSpan2.setTopPadding(AndroidUtilities.m1036dp(1.5f));
                ...
                if (z || (i2 = tL_chatInviteExported.usage_limit) <= 0 || tL_chatInviteExported.usage < i2) {
                    spannableStringBuilder2.append((CharSequence) LocaleController.getString(z ? C2797R.string.Revoked : C2797R.string.Expired));
                } else {
                    spannableStringBuilder2.append((CharSequence) LocaleController.getString(C2797R.string.LinkLimitReached));
                }
            } else if (tL_chatInviteExported.expire_date > 0) {
                DotDividerSpan dotDividerSpan3 = new DotDividerSpan();
                dotDividerSpan3.setTopPadding(AndroidUtilities.m1036dp(1.5f));
                ...
                if (jCurrentTimeMillis > DurationKt.MILLIS_IN_DAY) {
                    spannableStringBuilder2.append((CharSequence) LocaleController.formatPluralString("DaysLeft", (int) (jCurrentTimeMillis / DurationKt.MILLIS_IN_DAY), new Object[0]));
                } else {
                    long j = jCurrentTimeMillis / 1000;
                    int i6 = (int) (j % 60);
                    long j2 = j / 60;
                    Locale locale = Locale.ENGLISH;
                    spannableStringBuilder2.append((CharSequence) String.format(locale, TimeModel.ZERO_LEADING_NUMBER_FORMAT, Integer.valueOf((int) (j2 / 60)))).append((CharSequence) String.format(locale, ":%02d", Integer.valueOf((int) (j2 % 60)))).append((CharSequence) String.format(locale, ":%02d", Integer.valueOf(i6)));
                    this.timerRunning = true;
                }
            }
            if (tL_chatInviteExported.request_needed) {
                DotDividerSpan dotDividerSpan4 = new DotDividerSpan();
                dotDividerSpan4.setTopPadding(AndroidUtilities.m1036dp(1.5f));
                ...
                spannableStringBuilder2.append((CharSequence) LocaleController.getString(C2797R.string.ApprovalRequired));
            }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ManageLinksActivity$6 */
    public class C60996 implements LinkEditActivity.Callback {
        public C60996() {
        }
            ...
            if (tLObject instanceof TLRPC.TL_messages_exportedChatInvite) {
                ...
                for (int i = 0; i < ManageLinksActivity.this.invites.size(); i++) {
                    if (((TLRPC.TL_chatInviteExported) ManageLinksActivity.this.invites.get(i)).link.equals(tL_chatInviteExported.link)) {
                        boolean z = tL_chatInviteExported2.revoked;
                        ManageLinksActivity manageLinksActivity = ManageLinksActivity.this;
                        if (z) {
        ...
        public boolean areItemsTheSame(int i, int i2) {
            ...
            if (((i >= this.oldLinksStartRow && i < this.oldLinksEndRow) || (i >= this.oldRevokedLinksStartRow && i < this.oldRevokedLinksEndRow)) && ((i2 >= ManageLinksActivity.this.linksStartRow && i2 < ManageLinksActivity.this.linksEndRow) || (i2 >= ManageLinksActivity.this.revokedLinksStartRow && i2 < ManageLinksActivity.this.revokedLinksEndRow))) {
                ...
                if (i >= i3 && i < this.oldLinksEndRow) {
                    tL_chatInviteExported2 = this.oldLinks.get(i - i3);
                } else {
                    tL_chatInviteExported2 = this.oldRevokedLinks.get(i - this.oldRevokedLinksStartRow);
                }
