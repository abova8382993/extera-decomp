...
public abstract class RightSlidingDialogContainer extends FrameLayout {
    ...
    public void updateOpenAnimationProgress() {
        ...
        if (view != null) {
            view.setTranslationX((getMeasuredWidth() - AndroidUtilities.m1036dp(getRightPaddingSize())) * (1.0f - this.openedProgress));
        }
        ActionBar actionBar = this.currentActionBarView;
        if (actionBar != null) {
            actionBar.setTranslationX(AndroidUtilities.m1036dp(48.0f) * (1.0f - this.openedProgress));
        }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (view != null) {
            ...
            layoutParams.leftMargin = AndroidUtilities.m1036dp(getRightPaddingSize());
    ...
    /* JADX INFO: renamed from: finishPreview, reason: merged with bridge method [inline-methods] */
    ...
    public void finishPreviewInernal() {
        ...
        this.openAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.RightSlidingDialogContainer.2
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                RightSlidingDialogContainer.this.destroyCurrentFragment();
                RightSlidingDialogContainer.this.openAnimationFinished(false);
            }
        });
        this.openAnimator.setDuration(250L);
    ...
    public void destroyCurrentFragment() {
        ...
        this.currentFragment.setPreviewDelegate(null);
        ActionBar actionBar = this.currentActionBarView;
        if (actionBar != null) {
            actionBar.listenToBackgroundUpdate(null);
        }
        removeAllViews();
        this.currentFragment = null;
        this.currentFragmentView = null;
        this.currentFragmentFullscreenView = null;
        this.currentActionBarView = null;
        fragmentDialogId = 0L;
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent != null && motionEvent.getAction() == 0) {
            ...
            if (this.maybeStartTracking && !this.startedTracking && iMax >= AndroidUtilities.getPixelsInCM(0.15f, true) && Math.abs(iMax) / 3 > iAbs) {
            ...
            if (this.startedTracking) {
                ...
                if (f2 >= getMeasuredWidth() / 3.0f || (xVelocity >= AppUtils.getSwipeVelocity() && xVelocity >= yVelocity)) {
                    finishPreviewInernal();
                } else {
                    ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(this.openedProgress, 1.0f);
                    this.openAnimator = valueAnimatorOfFloat;
                    valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.RightSlidingDialogContainer$$ExternalSyntheticLambda1
                        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.currentActionBarView.getActionMode() != null) {
            float alpha2 = this.openedProgress * this.currentActionBarView.getActionMode().getAlpha();
            ActionBar actionBar3 = this.currentActionBarView;
            if (fMax != alpha2) {
                actionBar3.draw(canvas);
                ...
                actionBar3.getActionMode().draw(canvas);
            }
        } else {
