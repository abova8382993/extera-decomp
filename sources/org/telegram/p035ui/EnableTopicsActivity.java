...
public class EnableTopicsActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2797R.string.TopicsTitle));
    ...
    public void fillItems(ArrayList<UItem> arrayList, UniversalAdapter universalAdapter) {
        arrayList.add(UItem.asTopView(LocaleController.getString(C2797R.string.TopicsInfo), C2797R.raw.topics_top));
        arrayList.add(UItem.asCheck(1, LocaleController.getString(C2797R.string.TopicsEnable)).setChecked(this.forum));
        if (this.forum) {
            arrayList.add(UItem.asShadow(null));
            arrayList.add(UItem.asHeader(LocaleController.getString(C2797R.string.TopicsLayout)));
            ...
            arrayList.add(UItem.asShadow(LocaleController.getString(C2797R.string.TopicsLayoutInfo)));
        }
    }
    ...
    public void onItemClick(UItem uItem, View view, int i, float f, float f2) {
        if (uItem.f1708id != 1 || this.currentChat == null) {
            return;
        }
    ...
    public static class TopicsLayoutSwitcher extends LinearLayout {
        ...
        public TopicsLayoutSwitcher(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            setOrientation(0);
            setPadding(AndroidUtilities.m1036dp(8.0f), 0, AndroidUtilities.m1036dp(8.0f), 0);
            FrameLayout frameLayout = new FrameLayout(context);
            this.leftLayout = frameLayout;
            ScaleStateListAnimator.apply(frameLayout, 0.05f, 1.25f);
            addView(frameLayout, LayoutHelper.createLinear(-1, Opcodes.USHR_INT_LIT8, 1.0f, 119));
            BackupImageView backupImageView = new BackupImageView(context);
            this.leftImageView = backupImageView;
            backupImageView.setImageDrawable(new RLottieDrawable(C2797R.raw.topics_tabs, "topics_tabs", AndroidUtilities.m1036dp(160.0f), AndroidUtilities.m1036dp(160.0f)));
            ...
            textViewMakeTextView.setText(LocaleController.getString(C2797R.string.TopicsLayoutTabs));
            textViewMakeTextView.setPadding(AndroidUtilities.m1036dp(12.0f), 0, AndroidUtilities.m1036dp(12.0f), 0);
            frameLayout2.addView(textViewMakeTextView, LayoutHelper.createFrame(-2, -2, 17));
            FrameLayout frameLayout3 = new FrameLayout(context);
            this.leftTitleBackground = frameLayout3;
            frameLayout3.setPadding(AndroidUtilities.m1036dp(12.0f), 0, AndroidUtilities.m1036dp(12.0f), 0);
            int iM1036dp = AndroidUtilities.m1036dp(13.0f);
            int i2 = Theme.key_featuredStickers_addButton;
            frameLayout3.setBackground(Theme.createRoundRectDrawable(iM1036dp, Theme.getColor(i2, resourcesProvider)));
            ...
            textViewMakeTextView2.setText(LocaleController.getString(C2797R.string.TopicsLayoutTabs));
            ...
            addView(frameLayout4, LayoutHelper.createLinear(-1, Opcodes.USHR_INT_LIT8, 1.0f, 119));
            BackupImageView backupImageView2 = new BackupImageView(context);
            this.rightImageView = backupImageView2;
            backupImageView2.setImageDrawable(new RLottieDrawable(C2797R.raw.topics_list, "topics_list", AndroidUtilities.m1036dp(160.0f), AndroidUtilities.m1036dp(160.0f)));
            ...
            textViewMakeTextView3.setText(LocaleController.getString(C2797R.string.TopicsLayoutList));
            textViewMakeTextView3.setPadding(AndroidUtilities.m1036dp(12.0f), 0, AndroidUtilities.m1036dp(12.0f), 0);
            ...
            frameLayout6.setPadding(AndroidUtilities.m1036dp(12.0f), 0, AndroidUtilities.m1036dp(12.0f), 0);
            frameLayout6.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1036dp(13.0f), Theme.getColor(i2, resourcesProvider)));
            ...
            textViewMakeTextView4.setText(LocaleController.getString(C2797R.string.TopicsLayoutList));
        ...
        public void setChecked(final boolean z, boolean z2) {
            ...
            FrameLayout frameLayout = this.leftTitleBackground;
            if (z2) {
                ViewPropertyAnimator viewPropertyAnimatorAlpha = frameLayout.animate().scaleX(!z ? 0.0f : 1.0f).scaleY(!z ? 0.0f : 1.0f).alpha(!z ? 0.0f : 1.0f);
