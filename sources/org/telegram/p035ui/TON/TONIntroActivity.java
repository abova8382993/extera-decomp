package org.telegram.p035ui.TON;
...
public class TONIntroActivity extends GradientHeaderActivity implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(final Context context) {
        ...
        this.emptyLayout = new View(context) { // from class: org.telegram.ui.TON.TONIntroActivity.1
            public C72231(final Context context2) {
                super(context2);
            }
            ...
            public void onMeasure(int i, int i2) {
                ...
                if (tONIntroActivity.isLandscapeMode) {
                    measuredHeight = (tONIntroActivity.statusBarHeight + ((BaseFragment) tONIntroActivity).actionBar.getMeasuredHeight()) - AndroidUtilities.m1036dp(16.0f);
                } else {
                    int iM1036dp = AndroidUtilities.m1036dp(140.0f);
                    TONIntroActivity tONIntroActivity2 = TONIntroActivity.this;
                    int measuredHeight2 = iM1036dp + tONIntroActivity2.statusBarHeight;
                    if (tONIntroActivity2.backgroundView.getMeasuredHeight() + AndroidUtilities.m1036dp(24.0f) > measuredHeight2) {
                        measuredHeight2 = TONIntroActivity.this.backgroundView.getMeasuredHeight() + AndroidUtilities.m1036dp(24.0f);
                    }
        ...
        GLIconTextureView gLIconTextureView = new GLIconTextureView(context2, 1, 4);
        ...
        configureHeader(LocaleController.getString(C2797R.string.TONBalanceTitle), AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(C2797R.string.TONBalanceText), new Runnable() { // from class: org.telegram.ui.TON.TONIntroActivity$$ExternalSyntheticLambda0
        ...
        this.balanceLayout.setPadding(0, AndroidUtilities.m1036dp(20.0f), 0, AndroidUtilities.m1036dp(10.0f));
        ...
        this.starBalanceTitleView.setText(LocaleController.getString(C2797R.string.YourTonBalance));
        ...
        C72242 c72242 = new FrameLayout(getContext()) { // from class: org.telegram.ui.TON.TONIntroActivity.2
            public C72242(Context context2) {
                super(context2);
            }
        ...
        this.oneButtonsLayout = c72242;
        frameLayout2.addView(c72242);
        if (this.allowTopUp) {
            ButtonWithCounterView round = new ButtonWithCounterView(getContext(), this.resourceProvider).setRound();
            this.buyButton = round;
            round.setRound();
            this.buyButton.setText(LocaleController.getString(C2797R.string.TopUpViaFragment), false);
        ...
        C72253 c72253 = new LinearLayout(getContext()) { // from class: org.telegram.ui.TON.TONIntroActivity.3
            public C72253(Context context2) {
                super(context2);
            }
        ...
        this.twoButtonsLayout = c72253;
        frameLayout2.addView(c72253);
        ...
        spannableStringBuilder.append((CharSequence) LocaleController.getString(C2797R.string.TonTopUp));
        ...
        spannableStringBuilder2.append((CharSequence) LocaleController.getString(C2797R.string.TonStats));
    ...
    /* JADX INFO: renamed from: org.telegram.ui.TON.TONIntroActivity$1 */
    public class C72231 extends View {
        public C72231(final Context context2) {
            super(context2);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.TON.TONIntroActivity$2 */
    public class C72242 extends FrameLayout {
        public C72242(Context context2) {
            super(context2);
        }
    ...
    public /* synthetic */ void lambda$createView$2(View view) {
        Browser.openUrlInSystemBrowser(getContext(), LocaleController.getString(C2797R.string.TopUpViaFragmentLink));
    }

    /* JADX INFO: renamed from: org.telegram.ui.TON.TONIntroActivity$3 */
    public class C72253 extends LinearLayout {
        public C72253(Context context2) {
            super(context2);
        }
    ...
    private void updateBalance() {
        ...
        AnimatedTextView animatedTextView = this.starBalanceTitleView;
        if (i > 0) {
            animatedTextView.setText("≈" + BillingController.getInstance().formatCurrency(i, "USD"));
        } else {
            animatedTextView.setText(LocaleController.getString(C2797R.string.YourTonBalance));
        }
    ...
    public class C72264 extends StarParticlesView {
        Paint[] paints;
        final /* synthetic */ int val$particlesCount;
        final /* synthetic */ int val$type;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C72264(Context context, int i, int i2) {
            super(context);
    ...
    public static StarParticlesView makeParticlesView(Context context, int i, int i2) {
        return new C72264(context, i, i2);
    }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.TON.TONIntroActivity$5 */
    public class C72275 extends UniversalAdapter {
        public C72275(RecyclerListView recyclerListView, Context context, int i, int i2, boolean z, Utilities.Callback2 callback2, Theme.ResourcesProvider resourcesProvider) {
    ...
    public RecyclerView.Adapter<?> createAdapter() {
        C72275 c72275 = new UniversalAdapter(this.listView, getContext(), this.currentAccount, this.classGuid, true, new Utilities.Callback2() { // from class: org.telegram.ui.TON.TONIntroActivity$$ExternalSyntheticLambda7
        ...
        this.adapter = c72275;
        c72275.setApplyBackground(false);
        return this.adapter;
    }
    ...
    public void fillItems(ArrayList<UItem> arrayList, UniversalAdapter universalAdapter) {
        ...
        if (this.allowTopUp) {
            arrayList.add(UItem.asShadow(LocaleController.getString(C2797R.string.TopUpViaFragmentInfo)));
        }
    ...
    public static class StarsNeededSheet extends BottomSheetWithRecyclerListView implements NotificationCenter.NotificationCenterDelegate {
        ...
        public void didReceivedNotification(int i, int i2, Object... objArr) {
            ...
            if (i == NotificationCenter.starOptionsLoaded || i == NotificationCenter.starBalanceUpdated) {
                ...
                this.headerView.titleView.setText(LocaleController.formatString(C2797R.string.TonNeededTitle, AmountUtils$Amount.fromNano(this.requiredAmount.asNano() - balanceAmount.asNano(), AmountUtils$Currency.TON).asFormatString()));
        ...
        public StarsNeededSheet(Context context, Theme.ResourcesProvider resourcesProvider, AmountUtils$Amount amountUtils$Amount, boolean z, Runnable runnable) {
            ...
            headerView.titleView.setText(LocaleController.formatString(C2797R.string.TonNeededTitle, AmountUtils$Amount.fromNano(amountUtils$Amount.asNano() - StarsController.getTonInstance(this.currentAccount).getBalanceAmount().asNano(), AmountUtils$Currency.TON).asFormatString()));
            headerView.subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2797R.string.FragmentAddFunds)));
            ...
            if (z || TONIntroActivity.allowTopUp()) {
                buttonWithCounterView.setText(LocaleController.getString(C2797R.string.TopUpViaFragment), false);
