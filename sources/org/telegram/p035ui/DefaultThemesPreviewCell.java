...
public class DefaultThemesPreviewCell extends LinearLayout implements Theme.Colorable {
    ...
    public DefaultThemesPreviewCell(Context context, final BaseFragment baseFragment, int i) {
        ...
        if (this.currentType == 0) {
            ...
            this.dayNightCell.setOnClickListener(new ViewOnClickListenerC54992(context, baseFragment));
            this.darkThemeDrawable.setPlayInDirectionOfCustomEndFrame(true);
            if (!Theme.isCurrentThemeDay()) {
                RLottieDrawable rLottieDrawable2 = this.darkThemeDrawable;
                rLottieDrawable2.setCurrentFrame(rLottieDrawable2.getFramesCount() - 1);
                this.dayNightCell.setTextAndIcon((CharSequence) LocaleController.getString(C2797R.string.SettingsSwitchToDayMode), (Drawable) this.darkThemeDrawable, true);
            } else {
                this.dayNightCell.setTextAndIcon((CharSequence) LocaleController.getString(C2797R.string.SettingsSwitchToNightMode), (Drawable) this.darkThemeDrawable, true);
            }
        }
        ...
        linearLayoutManager.scrollToPositionWithOffset(i4, AndroidUtilities.m1036dp(16.0f));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$new$0(BaseFragment baseFragment, View view, int i) {
        ChatThemeBottomSheet.Adapter adapter;
        ...
        if (themeInfo == null) {
            ...
            if (theme != null) {
                Theme.ThemeAccent themeAccentCreateNewAccent = theme.accentsByThemeId.get(tlTheme.f1395id);
                ...
                accentId = themeAccentCreateNewAccent.f1479id;
        ...
        while (true) {
            ...
            ChatThemeBottomSheet.ChatThemeItem chatThemeItem2 = adapter.items.get(i2);
    ...
    public class ViewOnClickListenerC54992 implements View.OnClickListener {
        final /* synthetic */ Context val$context;
        final /* synthetic */ BaseFragment val$parentFragment;

        public ViewOnClickListenerC54992(Context context, BaseFragment baseFragment) {
        ...
        */
        public void onClick(android.view.View r14) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.DefaultThemesPreviewCell.ViewOnClickListenerC54992.onClick(android.view.View):void");
        }
        ...
        public /* synthetic */ void lambda$onClick$0(Context context, int i, boolean z, BaseFragment baseFragment) {
            ...
            if (zIsCurrentThemeDay) {
                defaultThemesPreviewCell.dayNightCell.textView.setText(LocaleController.getString(C2797R.string.SettingsSwitchToNightMode));
            } else {
                defaultThemesPreviewCell.dayNightCell.textView.setText(LocaleController.getString(C2797R.string.SettingsSwitchToDayMode));
            }
    ...
    public void updateDayNightMode() {
        ...
        if (this.adapter.items != null) {
            ...
            while (true) {
                ...
                adapter.items.get(i4).themeIndex = this.themeIndex;
                i4++;
            }
    ...
    public void updateSelectedPosition() {
        ...
        while (true) {
            ...
            if (tlTheme != null) {
                if (!Theme.getActiveTheme().name.equals(Theme.getBaseThemeKey(tlTheme.settings.get(this.adapter.items.get(i).chatTheme.getSettingsIndex(this.themeIndex))))) {
                    ...
                    Theme.ThemeAccent themeAccent = Theme.getActiveTheme().accentsByThemeId.get(tlTheme.f1395id);
                    if (themeAccent != null && themeAccent.f1479id == Theme.getActiveTheme().currentAccentId) {
                        this.selectedPosition = i;
                        break;
                    }
                }
        ...
        while (true) {
            ...
            if (i2 < size) {
                adapter.items.get(i2).isSelected = i2 == this.selectedPosition;
                i2++;
            } else {
                adapter.setSelectedItem(this.selectedPosition);
                return;
