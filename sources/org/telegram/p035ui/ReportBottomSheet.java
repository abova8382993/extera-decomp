...
public class ReportBottomSheet extends BottomSheet {
    ...
    public ReportBottomSheet(boolean z, final Context context, Theme.ResourcesProvider resourcesProvider, long j, boolean z2, ArrayList<Integer> arrayList, byte[] bArr) {
    ...
    public void lambda$openCrafting$8() {
        ...
        if (this.viewPager.getCurrentPosition() > 0) {
            this.viewPager.scrollToPosition(r2.getCurrentPosition() - 1);
        } else {
    ...
    public void submitOption(final CharSequence charSequence, final byte[] bArr, final String str) {
        ...
        if (this.sponsored) {
            ...
            if (z) {
                ...
                if (arrayList != null) {
                    tL_stories_report.f1466id.addAll(arrayList);
                }
                if (str != null) {
                    str2 = str;
                }
                ...
                if (arrayList2 != null) {
                    tL_messages_report.f1363id.addAll(arrayList2);
                }
                if (str != null) {
                    str2 = str;
                }
    ...
    public class ContainerView extends FrameLayout {
        ...
        public void dispatchDraw(Canvas canvas) {
            ...
            rectF.set(((BottomSheet) ReportBottomSheet.this).backgroundPaddingLeft, this.top, getWidth() - ((BottomSheet) ReportBottomSheet.this).backgroundPaddingLeft, getHeight() + AndroidUtilities.m1036dp(8.0f));
    ...
    public class Page extends FrameLayout {
        ...
        public Page(Context context) {
            ...
            if (ReportBottomSheet.this.sponsored) {
                bigHeaderCell.setText(LocaleController.getString(C2797R.string.ReportAd));
            } else if (ReportBottomSheet.this.stories) {
                bigHeaderCell.setText(LocaleController.getString(C2797R.string.ReportStory));
            } else {
                bigHeaderCell.setText(LocaleController.getString(C2797R.string.Report2));
            }
        ...
        public /* synthetic */ void lambda$new$0() {
            ...
            if (i == 0) {
                reportBottomSheet.lambda$new$0();
            } else {
        ...
        public void setHeaderText(CharSequence charSequence) {
            ...
            this.headerView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.displaySize.x, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(120.0f), Integer.MIN_VALUE));
            UniversalRecyclerView universalRecyclerView = this.listView;
            if (universalRecyclerView != null) {
                universalRecyclerView.adapter.update(true);
            }
        ...
        public void fillItems(ArrayList<UItem> arrayList, UniversalAdapter universalAdapter) {
            ...
            uItemAsSpace.f1708id = -1;
            uItemAsSpace.transparent = true;
            arrayList.add(uItemAsSpace);
            int measuredHeight = (int) (0.0f + (this.headerView.getMeasuredHeight() / AndroidUtilities.density));
            ...
            if (tL_channels_sponsoredMessageReportResultChooseOption == null && this.option == null && this.commentOption == null) {
                ...
                if (this.sponsoredOption != null) {
                    for (int i = 0; i < this.sponsoredOption.options.size(); i++) {
                        ...
                        uItem.iconResId = C2797R.drawable.msg_arrowright;
                        uItem.f1708id = i;
                        arrayList.add(uItem);
                        measuredHeight += 50;
                    }
                    ...
                    for (int i2 = 0; i2 < this.option.options.size(); i2++) {
                        ...
                        uItem2.iconResId = C2797R.drawable.msg_arrowright;
                        uItem2.f1708id = i2;
                    ...
                    if (this.commentOption != null) {
                        if (this.editTextCell == null) {
                            page = this;
                            EditTextCell editTextCell = new EditTextCell(getContext(), _UrlKt.FRAGMENT_ENCODE_SET, true, false, 1024, ((BottomSheet) ReportBottomSheet.this).resourcesProvider) { // from class: org.telegram.ui.ReportBottomSheet.Page.2
                            ...
                            page.editTextCell = editTextCell;
                            editTextCell.setShowLimitWhenNear(100);
                        } else {
                            page = this;
                        }
                        page.editTextCell.editText.setHint(LocaleController.getString(page.commentOption.optional ? C2797R.string.Report2CommentOptional : C2797R.string.Report2Comment));
                        UItem uItemAsCustom2 = UItem.asCustom(page.editTextCell);
                        uItemAsCustom2.f1708id = -3;
                        arrayList.add(uItemAsCustom2);
                        if (ReportBottomSheet.this.messageIds != null && !ReportBottomSheet.this.messageIds.isEmpty()) {
                            arrayList.add(UItem.asShadow(LocaleController.getString(ReportBottomSheet.this.messageIds.size() > 1 ? C2797R.string.Report2CommentInfoMany : C2797R.string.Report2CommentInfo)));
                            ...
                            if (ChatObject.isChannelAndNotMegaGroup(MessagesController.getInstance(((BottomSheet) ReportBottomSheet.this).currentAccount).getChat(Long.valueOf(-ReportBottomSheet.this.dialogId)))) {
                                arrayList.add(UItem.asShadow(LocaleController.getString(C2797R.string.Report2CommentInfoChannel)));
                            } else {
                                arrayList.add(UItem.asShadow(LocaleController.getString(C2797R.string.Report2CommentInfoGroup)));
                            }
                        } else {
                            arrayList.add(UItem.asShadow(LocaleController.getString(C2797R.string.Report2CommentInfoUser)));
                        }
                        if (page.buttonContainer == null) {
                            ButtonWithCounterView buttonWithCounterView = new ButtonWithCounterView(page.getContext(), ((BottomSheet) ReportBottomSheet.this).resourcesProvider);
                            page.button = buttonWithCounterView;
                            buttonWithCounterView.setText(LocaleController.getString(C2797R.string.Report2Send), false);
                            ...
                            page.buttonContainer.addView(view, LayoutHelper.createFrame(-1.0f, 1.0f / AndroidUtilities.density, 48));
                        }
                        page.button.setEnabled(page.commentOption.optional || !TextUtils.isEmpty(page.editTextCell.getText()));
                        page.button.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.ReportBottomSheet$Page$$ExternalSyntheticLambda3
                        ...
                        uItemAsCustom3.f1708id = -4;
                        arrayList.add(uItemAsCustom3);
                        measuredHeight += 112;
                    }
                    arrayList.get(arrayList.size() - 1).hideDivider = true;
                    if (ReportBottomSheet.this.sponsored && page.pageType == 0) {
                        FrameLayout frameLayout2 = new FrameLayout(page.getContext());
                        CombinedDrawable combinedDrawable = new CombinedDrawable(new ColorDrawable(ReportBottomSheet.this.getThemedColor(Theme.key_windowBackgroundGray)), Theme.getThemedDrawable(page.getContext(), C2797R.drawable.greydivider, Theme.getColor(Theme.key_windowBackgroundGrayShadow, ((BottomSheet) ReportBottomSheet.this).resourcesProvider)), 0, 0);
                        combinedDrawable.setFullsize(true);
                        frameLayout2.setBackground(combinedDrawable);
                        LinkSpanDrawable.LinksTextView linksTextView = new LinkSpanDrawable.LinksTextView(page.getContext());
                        linksTextView.setTextSize(1, 14.0f);
                        linksTextView.setText(AndroidUtilities.replaceLinks(LocaleController.getString(C2797R.string.ReportAdLearnMore), ((BottomSheet) ReportBottomSheet.this).resourcesProvider));
                ...
                arrayList.get(arrayList.size() - 1).hideDivider = true;
                if (ReportBottomSheet.this.sponsored) {
                    FrameLayout frameLayout22 = new FrameLayout(page.getContext());
                    CombinedDrawable combinedDrawable2 = new CombinedDrawable(new ColorDrawable(ReportBottomSheet.this.getThemedColor(Theme.key_windowBackgroundGray)), Theme.getThemedDrawable(page.getContext(), C2797R.drawable.greydivider, Theme.getColor(Theme.key_windowBackgroundGrayShadow, ((BottomSheet) ReportBottomSheet.this).resourcesProvider)), 0, 0);
                    combinedDrawable2.setFullsize(true);
                    frameLayout22.setBackground(combinedDrawable2);
                    LinkSpanDrawable.LinksTextView linksTextView2 = new LinkSpanDrawable.LinksTextView(page.getContext());
                    linksTextView2.setTextSize(1, 14.0f);
                    linksTextView2.setText(AndroidUtilities.replaceLinks(LocaleController.getString(C2797R.string.ReportAdLearnMore), ((BottomSheet) ReportBottomSheet.this).resourcesProvider));
                    linksTextView2.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteGrayText3, ((BottomSheet) ReportBottomSheet.this).resourcesProvider));
                    linksTextView2.setGravity(17);
                    frameLayout22.addView(linksTextView2, LayoutHelper.createFrame(-1, -2.0f, 17, 16.0f, 16.0f, 16.0f, 16.0f));
                    UItem uItemAsCustom42 = UItem.asCustom(frameLayout22);
                    uItemAsCustom42.f1708id = -3;
                    arrayList.add(uItemAsCustom42);
                    measuredHeight += 46;
                }
            }
            if (page.listView != null) {
                if (((BottomSheet) ReportBottomSheet.this).containerView.getMeasuredHeight() - AndroidUtilities.statusBarHeight < AndroidUtilities.m1036dp(measuredHeight)) {
                    page.listView.layoutManager.setReverseLayout(false);
                } else {
                    Collections.reverse(arrayList);
                    page.listView.layoutManager.setReverseLayout(true);
                }
            }
        }
        ...
        public void onClick(UItem uItem, View view, int i, float f, float f2) {
            if (uItem.viewType == 30) {
                ...
                if (tL_channels_sponsoredMessageReportResultChooseOption != null) {
                    TLRPC.TL_sponsoredMessageReportOption tL_sponsoredMessageReportOption = tL_channels_sponsoredMessageReportResultChooseOption.options.get(uItem.f1708id);
                ...
                TLRPC.TL_reportResultChooseOption tL_reportResultChooseOption = this.option;
                if (tL_reportResultChooseOption != null) {
                    TLRPC.TL_messageReportOption tL_messageReportOption = tL_reportResultChooseOption.options.get(uItem.f1708id);
        ...
        public class BigHeaderCell extends FrameLayout {
            ...
            public BigHeaderCell(Context context, Theme.ResourcesProvider resourcesProvider) {
                ...
                setMinimumHeight(AndroidUtilities.m1036dp(56.0f));
            }
    ...
    public static void openMessage(BaseFragment baseFragment, MessageObject messageObject) {
        ...
        open(currentAccount, context, messageObject.getDialogId(), false, new ArrayList(Collections.singleton(Integer.valueOf(messageObject.getId()))), BulletinFactory.m1143of(baseFragment), baseFragment.getResourceProvider(), new byte[0], null, null);
    }
    ...
    public static void continueReport(ChatActivity chatActivity, byte[] bArr, String str, ArrayList<Integer> arrayList, Utilities.Callback<Boolean> callback) {
        ...
        open(currentAccount, context, dialogId, false, arrayList, BulletinFactory.m1143of(chatActivity), chatActivity.getResourceProvider(), bArr, str, callback);
    }
    ...
    public static void openStory(int i, Context context, TL_stories.StoryItem storyItem, BulletinFactory bulletinFactory, Theme.ResourcesProvider resourcesProvider, Utilities.Callback<Boolean> callback) {
        open(i, context, storyItem.dialogId, true, new ArrayList(Collections.singleton(Integer.valueOf(storyItem.f1454id))), bulletinFactory, resourcesProvider, new byte[0], null, callback);
    }

    public static void open(int i, final Context context, final long j, final boolean z, final ArrayList<Integer> arrayList, final BulletinFactory bulletinFactory, final Theme.ResourcesProvider resourcesProvider, byte[] bArr, String str, final Utilities.Callback<Boolean> callback) {
        TLObject tLObject;
        ...
        if (z) {
            ...
            tL_messages_report.f1363id.addAll(arrayList);
            tL_messages_report.option = bArr;
            if (!TextUtils.isEmpty(str)) {
                str2 = str;
            }
    ...
    public static /* synthetic */ void $r8$lambda$M_WfqrZ8xZuG8vbY74nKtmM0Sz0(Context context, Theme.ResourcesProvider resourcesProvider, boolean z, long j, ArrayList arrayList, TLObject tLObject, final boolean[] zArr, final Utilities.Callback callback, BulletinFactory bulletinFactory) {
        ...
        reportBottomSheet.setListener(new C65743(zArr, callback, bulletinFactory));
    ...
    public class C65743 implements Listener {
        ...
        public C65743(boolean[] zArr, Utilities.Callback callback, BulletinFactory bulletinFactory) {
            this.val$done = zArr;
        ...
        public void onReported() {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ReportBottomSheet$3$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    ReportBottomSheet.C65743.$r8$lambda$BigYiaLE7uVWxqGsnUXTnyV2DyI(bulletinFactory);
                }
            }, 200L);
        }
        ...
        public static /* synthetic */ void $r8$lambda$BigYiaLE7uVWxqGsnUXTnyV2DyI(BulletinFactory bulletinFactory) {
            ...
            if (bulletinFactory == null) {
                bulletinFactory = BulletinFactory.m1143of(LaunchActivity.getSafeLastFragment());
            }
            if (bulletinFactory == null) {
                return;
            }
            bulletinFactory.createSimpleBulletin(C2797R.raw.msg_antispam, LocaleController.getString(C2797R.string.ReportChatSent), LocaleController.getString(C2797R.string.Reported2)).setDuration(5000).show();
        }
    }
    ...
    public static /* synthetic */ void $r8$lambda$li9vdl1VFAfDQyvILFv4gJ6Pl2Q(boolean[] zArr, Utilities.Callback callback) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ReportBottomSheet$$ExternalSyntheticLambda15
            @Override // java.lang.Runnable
            public final void run() {
                ReportBottomSheet.m19607$r8$lambda$qccbcIsr_o1YahgTVc8jwK_xBc();
            }
        }, 220L);
    }

    /* JADX INFO: renamed from: $r8$lambda$qccbcIsr_o1YahgTVc8jwK_xB-c, reason: not valid java name */
    public static /* synthetic */ void m19607$r8$lambda$qccbcIsr_o1YahgTVc8jwK_xBc() {
        BulletinFactory bulletinFactoryM1143of;
        BaseFragment safeLastFragment = LaunchActivity.getSafeLastFragment();
        if (safeLastFragment == null || (bulletinFactoryM1143of = BulletinFactory.m1143of(safeLastFragment)) == null) {
            return;
        }
        bulletinFactoryM1143of.createSimpleBulletin(C2797R.raw.msg_antispam, LocaleController.getString(C2797R.string.ReportChatSent), LocaleController.getString(C2797R.string.Reported2)).setDuration(5000).show();
    }
    ...
    public static /* synthetic */ void $r8$lambda$Lm9P7ATXMCvW70ucnC9iVcs3ppo(final Context context, final Theme.ResourcesProvider resourcesProvider, final long j, final byte[] bArr, final ChatActivity chatActivity, final MessageObject messageObject, final int i, final TLObject tLObject, TLRPC.TL_error tL_error) {
            ...
            if (tLObject instanceof TLRPC.TL_channels_sponsoredMessageReportResultChooseOption) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ReportBottomSheet$$ExternalSyntheticLambda16
                    ...
                    public final void run() {
                        ...
                        new ReportBottomSheet(context2, resourcesProvider2, j, bArr).setReportChooseOption((TLRPC.TL_channels_sponsoredMessageReportResultChooseOption) tLObject2).setListener(new ReportBottomSheet.C65754(chatActivity, context2, resourcesProvider2, messageObject)).show();
                    }
                });
                return;
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ReportBottomSheet$$ExternalSyntheticLambda19
            @Override // java.lang.Runnable
            public final void run() {
                ReportBottomSheet.m19608$r8$lambda$zQCeOkSflZrgrux4xzW1PPnGCY(chatActivity, context, resourcesProvider, messageObject);
            }
        }, 200L);
    }

    /* JADX INFO: renamed from: org.telegram.ui.ReportBottomSheet$4 */
    public class C65754 implements Listener {
        ...
        public C65754(ChatActivity chatActivity, Context context, Theme.ResourcesProvider resourcesProvider, MessageObject messageObject) {
        ...
        public void onReported() {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ReportBottomSheet$4$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    ReportBottomSheet.C65754.$r8$lambda$o7YJQajG1ZXWrikg12x_57K64do(chatActivity, context, resourcesProvider, messageObject);
                }
            }, 200L);
        }
        ...
        public static /* synthetic */ void $r8$lambda$o7YJQajG1ZXWrikg12x_57K64do(ChatActivity chatActivity, final Context context, Theme.ResourcesProvider resourcesProvider, MessageObject messageObject) {
            BulletinFactory.m1143of(chatActivity).createAdReportedBulletin(AndroidUtilities.replaceSingleTag(LocaleController.getString(C2797R.string.AdReported), -1, 2, new Runnable() { // from class: org.telegram.ui.ReportBottomSheet$4$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public void onHidden() {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ReportBottomSheet$4$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    ReportBottomSheet.C65754.$r8$lambda$NA6yB0znHotrf1ac4VaDyBpaUE4(chatActivity, messageObject);
                }
            }, 200L);
        }

        public static /* synthetic */ void $r8$lambda$NA6yB0znHotrf1ac4VaDyBpaUE4(ChatActivity chatActivity, MessageObject messageObject) {
            BulletinFactory.m1143of(chatActivity).createAdReportedBulletin(LocaleController.getString(C2797R.string.AdHidden)).show();
            chatActivity.removeFromSponsored(messageObject);
            chatActivity.removeMessageWithThanos(messageObject);
        }
    ...
    public static /* synthetic */ void $r8$lambda$Mxuk_1Vu4dgtBBTOV4Kd1uQCSSA(ChatActivity chatActivity, final Context context, Theme.ResourcesProvider resourcesProvider, MessageObject messageObject) {
        BulletinFactory.m1143of(chatActivity).createAdReportedBulletin(AndroidUtilities.replaceSingleTag(LocaleController.getString(C2797R.string.AdReported), -1, 2, new Runnable() { // from class: org.telegram.ui.ReportBottomSheet$$ExternalSyntheticLambda23
            @Override // java.lang.Runnable
            public final void run() {
                Browser.openUrl(context, "https://promote.telegram.org/guidelines");
            }
    ...
    /* JADX INFO: renamed from: $r8$lambda$zQCeOkSflZrgrux4xzW-1PPnGCY, reason: not valid java name */
    public static /* synthetic */ void m19608$r8$lambda$zQCeOkSflZrgrux4xzW1PPnGCY(ChatActivity chatActivity, final Context context, Theme.ResourcesProvider resourcesProvider, MessageObject messageObject) {
        BulletinFactory.m1143of(chatActivity).createAdReportedBulletin(AndroidUtilities.replaceSingleTag(LocaleController.getString(C2797R.string.AdReported), -1, 2, new Runnable() { // from class: org.telegram.ui.ReportBottomSheet$$ExternalSyntheticLambda21
            @Override // java.lang.Runnable
            public final void run() {
                Browser.openUrl(context, "https://promote.telegram.org/guidelines");
            }
            ...
            if (tLObject instanceof TLRPC.TL_channels_sponsoredMessageReportResultChooseOption) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ReportBottomSheet$$ExternalSyntheticLambda4
                    ...
                    public final void run() {
                        ...
                        Context context2 = context;
                        Theme.ResourcesProvider resourcesProvider2 = resourcesProvider;
                        new ReportBottomSheet(context2, resourcesProvider2, j, bArr).setReportChooseOption((TLRPC.TL_channels_sponsoredMessageReportResultChooseOption) tLObject2).setListener(new ReportBottomSheet.C65765(runnable, bulletinFactory, context2, resourcesProvider2, runnable2)).show();
                    }
                });
                return;
            } else if (tLObject instanceof TLRPC.TL_channels_sponsoredMessageReportResultReported) {
    ...
    public class C65765 implements Listener {
        final /* synthetic */ BulletinFactory val$bulletinFactory;
        final /* synthetic */ Context val$context;
        ...
        public C65765(Runnable runnable, BulletinFactory bulletinFactory, Context context, Theme.ResourcesProvider resourcesProvider, Runnable runnable2) {
        ...
        public void onReported() {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ReportBottomSheet$5$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    ReportBottomSheet.C65765.m19617$r8$lambda$H1FLXYhbApWbLaXPsE7oTlVdbY(runnable, bulletinFactory, context, resourcesProvider);
                }
            }, 200L);
        }

        /* JADX INFO: renamed from: $r8$lambda$H1FLXYhbApWbLaXPsE-7oTlVdbY, reason: not valid java name */
        public static /* synthetic */ void m19617$r8$lambda$H1FLXYhbApWbLaXPsE7oTlVdbY(Runnable runnable, BulletinFactory bulletinFactory, final Context context, Theme.ResourcesProvider resourcesProvider) {
            if (runnable != null) {
                runnable.run();
            }
            bulletinFactory.createAdReportedBulletin(AndroidUtilities.replaceSingleTag(LocaleController.getString(C2797R.string.AdReported), -1, 2, new Runnable() { // from class: org.telegram.ui.ReportBottomSheet$5$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    Browser.openUrl(context, "https://promote.telegram.org/guidelines");
                }
        ...
        public void onHidden() {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ReportBottomSheet$5$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    ReportBottomSheet.C65765.$r8$lambda$SMieQ2J2V2XrVdL9OXrJEEZDtV0(runnable, bulletinFactory);
                }
            }, 200L);
        }
        ...
        public static /* synthetic */ void $r8$lambda$SMieQ2J2V2XrVdL9OXrJEEZDtV0(Runnable runnable, BulletinFactory bulletinFactory) {
            ...
            bulletinFactory.createAdReportedBulletin(LocaleController.getString(C2797R.string.AdHidden)).show();
        }
    ...
    public static /* synthetic */ void $r8$lambda$KeAm4zgD_DLzLN_dbqZA5DNe0pU(Runnable runnable, BulletinFactory bulletinFactory, final Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        bulletinFactory.createAdReportedBulletin(AndroidUtilities.replaceSingleTag(LocaleController.getString(C2797R.string.AdReported), -1, 2, new Runnable() { // from class: org.telegram.ui.ReportBottomSheet$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                Browser.openUrl(context, "https://promote.telegram.org/guidelines");
            }
    ...
    public static /* synthetic */ void $r8$lambda$bTHvJhLzcmJEZrs2qBhlG5EJbD4(Runnable runnable, BulletinFactory bulletinFactory, final Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        bulletinFactory.createAdReportedBulletin(AndroidUtilities.replaceSingleTag(LocaleController.getString(C2797R.string.AdReported), -1, 2, new Runnable() { // from class: org.telegram.ui.ReportBottomSheet$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
                Browser.openUrl(context, "https://promote.telegram.org/guidelines");
            }
            ...
            if (tLObject instanceof TLRPC.TL_channels_sponsoredMessageReportResultChooseOption) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ReportBottomSheet$$ExternalSyntheticLambda27
                    ...
                    public final void run() {
                        ...
                        Context context2 = context;
                        Theme.ResourcesProvider resourcesProvider2 = resourcesProvider;
                        new ReportBottomSheet(context2, resourcesProvider2, 0L, bArr).setReportChooseOption((TLRPC.TL_channels_sponsoredMessageReportResultChooseOption) tLObject2).setListener(new ReportBottomSheet.C65776(baseFragment, context2, resourcesProvider2, runnable)).show();
                    }
                });
                return;
            } else if (tLObject instanceof TLRPC.TL_channels_sponsoredMessageReportResultReported) {
                ...
                if (tLObject instanceof TLRPC.TL_channels_sponsoredMessageReportResultAdsHidden) {
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ReportBottomSheet$$ExternalSyntheticLambda29
                        @Override // java.lang.Runnable
                        public final void run() {
                            ReportBottomSheet.m19604$r8$lambda$eEsRKBS9r6RgYSvLbscW_A598(baseFragment, i, runnable);
                        }
                    }, 200L);
                    return;
                }
    ...
    public class C65776 implements Listener {
        final /* synthetic */ Context val$context;
        final /* synthetic */ BaseFragment val$fragment;
        final /* synthetic */ Runnable val$remove;
        final /* synthetic */ Theme.ResourcesProvider val$resourceProvider;

        public C65776(BaseFragment baseFragment, Context context, Theme.ResourcesProvider resourcesProvider, Runnable runnable) {
        ...
        public void onReported() {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ReportBottomSheet$6$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    ReportBottomSheet.C65776.$r8$lambda$WnkSMxLgeAYEbetp7tOy7z9Ac5w(baseFragment, context, resourcesProvider, runnable);
                }
            }, 200L);
        }
        ...
        public static /* synthetic */ void $r8$lambda$WnkSMxLgeAYEbetp7tOy7z9Ac5w(BaseFragment baseFragment, final Context context, Theme.ResourcesProvider resourcesProvider, Runnable runnable) {
            BulletinFactory.m1143of(baseFragment).createAdReportedBulletin(AndroidUtilities.replaceSingleTag(LocaleController.getString(C2797R.string.AdReported), -1, 2, new Runnable() { // from class: org.telegram.ui.ReportBottomSheet$6$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    Browser.openUrl(context, "https://promote.telegram.org/guidelines");
                }
        ...
        public void onHidden() {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ReportBottomSheet$6$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    ReportBottomSheet.C65776.$r8$lambda$h1OS3GR2m2PbJb2TEDujYJI5gr8(baseFragment, runnable);
                }
            }, 200L);
        }

        public static /* synthetic */ void $r8$lambda$h1OS3GR2m2PbJb2TEDujYJI5gr8(BaseFragment baseFragment, Runnable runnable) {
            BulletinFactory.m1143of(baseFragment).createAdReportedBulletin(LocaleController.getString(C2797R.string.AdHidden)).show();
            AndroidUtilities.runOnUIThread(runnable);
        }
    ...
    public static /* synthetic */ void $r8$lambda$tSiSeU2ldF9U7FjyHNznWxZullw(BaseFragment baseFragment, final Context context, Theme.ResourcesProvider resourcesProvider, Runnable runnable) {
        BulletinFactory.m1143of(baseFragment).createAdReportedBulletin(AndroidUtilities.replaceSingleTag(LocaleController.getString(C2797R.string.AdReported), -1, 2, new Runnable() { // from class: org.telegram.ui.ReportBottomSheet$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                Browser.openUrl(context, "https://promote.telegram.org/guidelines");
            }
    ...
    /* JADX INFO: renamed from: $r8$lambda$eEsRKBS9r6RgYSvL-bsc-W_A598, reason: not valid java name */
    public static /* synthetic */ void m19604$r8$lambda$eEsRKBS9r6RgYSvLbscW_A598(BaseFragment baseFragment, int i, Runnable runnable) {
        BulletinFactory.m1143of(baseFragment).createAdReportedBulletin(LocaleController.getString(C2797R.string.AdHidden)).show();
        MessagesController.getInstance(i).disableAds(false);
        AndroidUtilities.runOnUIThread(runnable);
    }
    ...
    public static /* synthetic */ void $r8$lambda$x0fgiqYJUAeZ5FQTI3RNnSPRWlU(BaseFragment baseFragment, final Context context, Theme.ResourcesProvider resourcesProvider, Runnable runnable) {
        BulletinFactory.m1143of(baseFragment).createAdReportedBulletin(AndroidUtilities.replaceSingleTag(LocaleController.getString(C2797R.string.AdReported), -1, 2, new Runnable() { // from class: org.telegram.ui.ReportBottomSheet$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                Browser.openUrl(context, "https://promote.telegram.org/guidelines");
            }
