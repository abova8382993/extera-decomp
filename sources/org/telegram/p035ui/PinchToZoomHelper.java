...
public class PinchToZoomHelper {
    ...
    public void startZoom(View view, ImageReceiver imageReceiver, View view2, View view3, MessageObject messageObject, int i) {
        ...
        if (!this.isSimple) {
            ...
            if (messageObject != null && messageObject.isVideo() && MediaController.getInstance().isPlayingMessage(messageObject)) {
                ...
                this.overlayView.videoPlayerContainer.setTag(C2797R.id.parent_tag, imageReceiver);
    ...
    /* JADX INFO: renamed from: org.telegram.ui.PinchToZoomHelper$1 */
    /* JADX INFO: loaded from: classes6.dex */
    public class C63901 extends AnimatorListenerAdapter {
        public C63901() {
        }
    ...
    public class ZoomOverlayView extends FrameLayout {
        ...
        public ZoomOverlayView(Context context) {
            ...
            frameLayout.setOutlineProvider(new ViewOutlineProvider() { // from class: org.telegram.ui.PinchToZoomHelper.ZoomOverlayView.1
                ...
                public C63911(PinchToZoomHelper pinchToZoomHelper) {
                    pinchToZoomHelper = pinchToZoomHelper;
                }

                @Override // android.view.ViewOutlineProvider
                public void getOutline(View view, Outline outline) {
                    ImageReceiver imageReceiver = (ImageReceiver) view.getTag(C2797R.id.parent_tag);
                    if (imageReceiver != null) {
        ...
        /* JADX INFO: renamed from: org.telegram.ui.PinchToZoomHelper$ZoomOverlayView$1 */
        /* JADX INFO: loaded from: classes6.dex */
        public class C63911 extends ViewOutlineProvider {
            final /* synthetic */ PinchToZoomHelper val$this$0;
        ...
        public void dispatchDraw(Canvas canvas) {
            ...
            if (pinchToZoomHelper2.finishTransition == null && pinchToZoomHelper2.enterProgress != 1.0f) {
                ...
                float f3 = PinchToZoomHelper.this.enterProgress;
                PinchToZoomHelper pinchToZoomHelper3 = PinchToZoomHelper.this;
                if (f3 > 1.0f) {
                    pinchToZoomHelper3.enterProgress = 1.0f;
                } else {
                    pinchToZoomHelper3.invalidateViews();
                }
            }
            ...
            if (interpolation != 1.0f && (clipBoundsListener = (pinchToZoomHelper = PinchToZoomHelper.this).clipBoundsListener) != null) {
                ...
                float f5 = PinchToZoomHelper.this.clipTopBottom[0] * f4;
                float measuredHeight2 = (getMeasuredHeight() * interpolation) + (PinchToZoomHelper.this.clipTopBottom[1] * f4);
        ...
        private void drawImage(Canvas canvas) {
            ...
            if (PinchToZoomHelper.this.fullImage != null && PinchToZoomHelper.this.fullImage.hasNotThumb()) {
                if (PinchToZoomHelper.this.progressToFullView != 1.0f) {
                    ...
                    float f3 = PinchToZoomHelper.this.progressToFullView;
                    PinchToZoomHelper pinchToZoomHelper5 = PinchToZoomHelper.this;
                    if (f3 > 1.0f) {
                        pinchToZoomHelper5.progressToFullView = 1.0f;
                    } else {
                        pinchToZoomHelper5.invalidateViews();
                    }
                }
                PinchToZoomHelper.this.fullImage.setAlpha(PinchToZoomHelper.this.progressToFullView);
            }
            float f4 = PinchToZoomHelper.this.imageX;
            float f5 = PinchToZoomHelper.this.imageY;
            if (PinchToZoomHelper.this.imageHeight != PinchToZoomHelper.this.fullImageHeight || PinchToZoomHelper.this.imageWidth != PinchToZoomHelper.this.fullImageWidth) {
                float f6 = f < 1.0f ? 0.0f : f < 1.4f ? (f - 1.0f) / 0.4f : 1.0f;
                float f7 = (PinchToZoomHelper.this.fullImageHeight - PinchToZoomHelper.this.imageHeight) / 2.0f;
                float f8 = ((PinchToZoomHelper.this.fullImageWidth - PinchToZoomHelper.this.imageWidth) / 2.0f) * f6;
                float f9 = PinchToZoomHelper.this.imageX - f8;
                float f10 = f7 * f6;
                float f11 = PinchToZoomHelper.this.imageY - f10;
                if (PinchToZoomHelper.this.childImage != null) {
                    PinchToZoomHelper.this.childImage.setImageCoords(f9, f11, PinchToZoomHelper.this.imageWidth + (f8 * 2.0f), PinchToZoomHelper.this.imageHeight + (f10 * 2.0f));
                }
                f5 = f11;
                f4 = f9;
            }
            if (!PinchToZoomHelper.this.isHardwareVideo) {
                if (PinchToZoomHelper.this.childImage != null) {
                    float f12 = PinchToZoomHelper.this.progressToFullView;
                    PinchToZoomHelper pinchToZoomHelper6 = PinchToZoomHelper.this;
                    if (f12 != 1.0f) {
                        if (pinchToZoomHelper6.childImage.getLottieAnimation() != null || PinchToZoomHelper.this.childImage.getAnimation() != null || PinchToZoomHelper.this.fullImage.getLottieAnimation() != null || PinchToZoomHelper.this.fullImage.getAnimation() != null) {
                            invalidate();
                        }
                        ...
                        pinchToZoomHelper6.fullImage.setImageCoords(PinchToZoomHelper.this.childImage.getImageX(), PinchToZoomHelper.this.childImage.getImageY(), PinchToZoomHelper.this.childImage.getImageWidth(), PinchToZoomHelper.this.childImage.getImageHeight());
                        PinchToZoomHelper.this.fullImage.draw(canvas);
                ...
                frameLayout.setPivotX(pinchToZoomHelper7.pinchCenterX - pinchToZoomHelper7.imageX);
                FrameLayout frameLayout2 = this.videoPlayerContainer;
                PinchToZoomHelper pinchToZoomHelper8 = PinchToZoomHelper.this;
                frameLayout2.setPivotY(pinchToZoomHelper8.pinchCenterY - pinchToZoomHelper8.imageY);
                ...
                frameLayout3.setTranslationX(f13 + (pinchToZoomHelper9.pinchTranslationX * f * pinchToZoomHelper9.finishProgress));
                FrameLayout frameLayout4 = this.videoPlayerContainer;
                float f14 = f5 + top;
                PinchToZoomHelper pinchToZoomHelper10 = PinchToZoomHelper.this;
                frameLayout4.setTranslationY(f14 + (pinchToZoomHelper10.pinchTranslationY * f * pinchToZoomHelper10.finishProgress));
            }
            if (PinchToZoomHelper.this.hasMediaSpoiler) {
                ...
                SpoilerEffect2 spoilerEffect2 = PinchToZoomHelper.this.mediaSpoilerEffect2;
                PinchToZoomHelper pinchToZoomHelper11 = PinchToZoomHelper.this;
                if (spoilerEffect2 != null) {
                    canvas.translate(pinchToZoomHelper11.childImage.getImageX(), PinchToZoomHelper.this.childImage.getImageY());
                    ...
                    pinchToZoomHelper11.mediaSpoilerEffect.setColor(ColorUtils.setAlphaComponent(-1, (int) (Color.alpha(-1) * 0.325f * PinchToZoomHelper.this.childImage.getAlpha())));
