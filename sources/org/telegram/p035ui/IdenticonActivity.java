...
import org.telegram.p035ui.Components.IdenticonDrawable;
...
public class IdenticonActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2797R.string.EncryptionKey));
        ...
        this.fragmentView.setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.IdenticonActivity$$ExternalSyntheticLambda0
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return IdenticonActivity.m16669$r8$lambda$_9TeDfLKkBhGucrGhUvCKvDx8M(view, motionEvent);
            }
        });
        ...
        frameLayout2.setPadding(AndroidUtilities.m1036dp(20.0f), AndroidUtilities.m1036dp(20.0f), AndroidUtilities.m1036dp(20.0f), AndroidUtilities.m1036dp(20.0f));
        ...
        FrameLayout frameLayout3 = new FrameLayout(context) { // from class: org.telegram.ui.IdenticonActivity.2
            ...
            public void onLayout(boolean z, int i, int i2, int i3, int i4) {
                ...
                if (IdenticonActivity.this.codeTextView != null) {
                    ...
                    int measuredHeight = (((IdenticonActivity.this.codeTextView.getMeasuredHeight() - IdenticonActivity.this.emojiTextView.getMeasuredHeight()) / 2) + IdenticonActivity.this.linearLayout1.getTop()) - AndroidUtilities.m1036dp(16.0f);
        ...
        this.linearLayout1.setPadding(AndroidUtilities.m1036dp(10.0f), 0, AndroidUtilities.m1036dp(10.0f), 0);
        ...
        if (encryptedChat != null) {
            ...
            if (bArr.length > 16) {
                ...
                for (int i4 = 0; i4 < 5; i4++) {
                    ...
                    int i5 = i4 * 4;
                    int i6 = (bArr2[i5 + 19] & UByte.MAX_VALUE) | ((bArr2[i5 + 16] & ByteCompanionObject.MAX_VALUE) << 24) | ((bArr2[i5 + 17] & UByte.MAX_VALUE) << 16) | ((bArr2[i5 + 18] & UByte.MAX_VALUE) << 8);
                    if (i4 != 0) {
                        sb.append(" ");
                    }
            ...
            int i7 = C2797R.string.EncryptionKeyDescription;
            ...
            if (iIndexOf != -1) {
                spannableStringBuilder.setSpan(new URLSpanReplacement(LocaleController.getString(C2797R.string.EncryptionKeyLink)), iIndexOf, iIndexOf + 12, 33);
            }
    ...
    /* JADX INFO: renamed from: $r8$lambda$_9TeDfLKkBhGucrGhUv-CKvDx8M, reason: not valid java name */
    public static /* synthetic */ boolean m16669$r8$lambda$_9TeDfLKkBhGucrGhUvCKvDx8M(View view, MotionEvent motionEvent) {
        return true;
    }
