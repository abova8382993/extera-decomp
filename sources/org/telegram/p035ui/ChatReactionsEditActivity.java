    ...
    */
    public boolean onFragmentCreate() {
        ...
        L4f:
            ...
            r0.addObserver(r11, r1)
            boolean r11 = super.onFragmentCreate()
            return r11
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.ChatReactionsEditActivity.onFragmentCreate():boolean");
    }
    ...
    public View createView(final Context context) {
        ...
        if (this.isChannel) {
            ...
            this.enableReactionsCell.setTextAndCheck(LocaleController.getString(C2797R.string.EnableReactions), !this.chatReactions.isEmpty(), false);
        ...
        radioCell.setText(LocaleController.getString(C2797R.string.AllReactions), false, true);
        RadioCell radioCell2 = new RadioCell(context);
        this.someReactions = radioCell2;
        radioCell2.setText(LocaleController.getString(C2797R.string.SomeReactions), false, true);
        RadioCell radioCell3 = new RadioCell(context);
        this.disableReactions = radioCell3;
        radioCell3.setText(LocaleController.getString(C2797R.string.NoReactions), false, false);
        ...
        RecyclerListView.SelectionAdapter selectionAdapter = new RecyclerListView.SelectionAdapter() { // from class: org.telegram.ui.ChatReactionsEditActivity.2
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i3) {
                ...
                if (itemViewType != 0) {
                    ...
                    if (i3 == 0) {
                        headerCell.setText(LocaleController.getString(C2797R.string.AvailableReactions));
                    } else {
                        headerCell.setText(LocaleController.getString(C2797R.string.OnlyAllowThisReactions));
                    }
                ...
                if (chatReactionsEditActivity.isChannel) {
                    textInfoPrivacyCell.setText(ChatObject.isChannelAndNotMegaGroup(chatReactionsEditActivity.currentChat) ? LocaleController.getString(C2797R.string.EnableReactionsChannelInfo) : LocaleController.getString(C2797R.string.EnableReactionsGroupInfo));
                    return;
                }
                int i4 = chatReactionsEditActivity.selectedType;
                if (i4 == 1) {
                    textInfoPrivacyCell.setText(LocaleController.getString(C2797R.string.EnableSomeReactionsInfo));
                } else if (i4 == 0) {
                    textInfoPrivacyCell.setText(LocaleController.getString(C2797R.string.EnableAllReactionsInfo));
                } else if (i4 == 2) {
                    textInfoPrivacyCell.setText(LocaleController.getString(C2797R.string.DisableReactionsInfo));
                }
            }
    ...
    public /* synthetic */ void lambda$createView$7(View view, int i) {
        ...
        TLRPC.TL_availableReaction tL_availableReaction = this.availableReactions.get(i - (z ? 2 : 4));
        ...
        if (!zContains) {
            list.add(tL_availableReaction.reaction);
        } else {
            list.remove(tL_availableReaction.reaction);
    ...
    private void setCheckedEnableReactionCell(int i, boolean z) {
        ...
        if (textCheckCell != null) {
            ...
            TextCheckCell textCheckCell2 = this.enableReactionsCell;
            if (z2) {
                textCheckCell2.setBackgroundColorAnimated(z2, color);
            } else {
