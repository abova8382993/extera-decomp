...
public class ActionBarLayout extends FrameLayout implements INavigationLayout, FloatingDebugProvider {
    ...
    @Override // org.telegram.p035ui.ActionBar.INavigationLayout
    public /* bridge */ /* synthetic */ BaseFragment getBackgroundFragment() {
        return super.getBackgroundFragment();
    }
    ...
    public /* bridge */ /* synthetic */ BaseFragment getSafeLastFragment() {
        return super.getSafeLastFragment();
    }
    ...
    public class LayoutContainer extends FrameLayout {
        ...
        public boolean drawChild(Canvas canvas, View view, long j) {
            ...
            if (lastSheet != null && lastSheet.isFullyVisible() && lastSheet.mo7483getWindowView() != view) {
                return true;
            }
            ...
            if (measuredHeight != 0 && !(view instanceof BaseFragment.AttachedSheetWindow)) {
        ...
        /* JADX WARN: Removed duplicated region for block: B:54:0x0041 A[RETURN] */
        ...
        */
        public boolean dispatchTouchEvent(android.view.MotionEvent r6) {
            /*
                r5 = this;
                r6.getAction()
                org.telegram.ui.ActionBar.ActionBarLayout r0 = org.telegram.p035ui.ActionBar.ActionBarLayout.this
                boolean r0 = org.telegram.p035ui.ActionBar.ActionBarLayout.m6752$$Nest$fgetinPreviewMode(r0)
                r1 = 1
                r2 = 0
                if (r0 == 0) goto L17
                org.telegram.ui.ActionBar.ActionBarLayout r0 = org.telegram.p035ui.ActionBar.ActionBarLayout.this
                org.telegram.ui.ActionBar.ActionBarPopupWindow$ActionBarPopupWindowLayout r0 = org.telegram.p035ui.ActionBar.ActionBarLayout.m6759$$Nest$fgetpreviewMenu(r0)
                if (r0 != 0) goto L17
                r0 = r1
                goto L18
            L17:
            ...
            L18:
                if (r0 != 0) goto L22
                org.telegram.ui.ActionBar.ActionBarLayout r3 = org.telegram.p035ui.ActionBar.ActionBarLayout.this
                boolean r3 = org.telegram.p035ui.ActionBar.ActionBarLayout.m6764$$Nest$fgettransitionAnimationPreviewMode(r3)
                if (r3 == 0) goto L30
            L22:
            ...
            L30:
                if (r0 == 0) goto L3b
                org.telegram.ui.ActionBar.ActionBarLayout r0 = org.telegram.p035ui.ActionBar.ActionBarLayout.this     // Catch: java.lang.Throwable -> L39
            ...
            L39:
                ...
                goto L43
            L3b:
                boolean r5 = super.dispatchTouchEvent(r6)     // Catch: java.lang.Throwable -> L39
                if (r5 == 0) goto L42
                return r1
            L42:
                return r2
    ...
    public EmptyBaseFragment getSheetFragment(boolean z) {
        ...
        if (this.sheetFragment == null) {
            C29161 c29161 = new EmptyBaseFragment() { // from class: org.telegram.ui.ActionBar.ActionBarLayout.1
                public C29161() {
                }
            ...
            this.sheetFragment = c29161;
            c29161.setParentLayout(this);
            EmptyBaseFragment emptyBaseFragment = this.sheetFragment;
            View viewCreateView = emptyBaseFragment.fragmentView;
            if (viewCreateView == null) {
                viewCreateView = emptyBaseFragment.createView(this.parentActivity);
            }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.ActionBarLayout$1 */
    public class C29161 extends EmptyBaseFragment {
        public C29161() {
        }
    ...
    public ActionBarLayout(Context context, boolean z) {
        ...
        this.invalidateRunnable = new Runnable() { // from class: org.telegram.ui.ActionBar.ActionBarLayout$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.invalidate();
            }
        };
        this.relayoutRunnable = new Runnable() { // from class: org.telegram.ui.ActionBar.ActionBarLayout$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.relayout();
            }
        ...
        this.debugBlackScreenRunnable = new Runnable() { // from class: org.telegram.ui.ActionBar.ActionBarLayout$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new OnApplyWindowInsetsListener() { // from class: org.telegram.ui.ActionBar.ActionBarLayout$$ExternalSyntheticLambda9
    ...
    public void setFragmentStack(List<BaseFragment> list) {
        ...
        if (this.main) {
            ...
            FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(-1, AndroidUtilities.m1036dp(76.0f));
    ...
    public void onMeasure(int i, int i2) {
        ...
        this.isKeyboardVisible = measureKeyboardHeight() > AndroidUtilities.m1036dp(20.0f);
    ...
    */
    public void onLayout(boolean r9, int r10, int r11, int r12, int r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.ActionBar.ActionBarLayout.onLayout(boolean, int, int, int, int):void");
    }
    ...
    public void setInnerTranslationX(float f) {
        ...
        if (newBackTransitions()) {
            measuredWidth = Utilities.clamp01(f / (AndroidUtilities.m1036dp(56.0f) * 6));
        } else {
        ...
        BaseFragment baseFragment2 = this.fragmentsStack.get(r3.size() - 1);
    ...
    /* JADX WARN: Removed duplicated region for block: B:324:0x0304  */
    /* JADX WARN: Removed duplicated region for block: B:335:0x0323  */
    /* JADX WARN: Removed duplicated region for block: B:337:0x0350  */
    ...
    /* JADX WARN: Removed duplicated region for block: B:348:0x0367  */
    @Override // android.view.ViewGroup
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public boolean drawChild(android.graphics.Canvas r20, android.view.View r21, long r22) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.ActionBar.ActionBarLayout.drawChild(android.graphics.Canvas, android.view.View, long):boolean");
    }
    ...
    private void drawPreviewDrawables(Canvas canvas, ViewGroup viewGroup) {
        if (viewGroup.getChildAt(0) != null) {
            ...
            if (this.previewMenu == null) {
                ...
                int top = (int) ((r1.getTop() + viewGroup.getTranslationY()) - AndroidUtilities.m1036dp(20.0f));
                Theme.moveUpDrawable.setBounds(measuredWidth, top, iM1036dp + measuredWidth, (iM1036dp / 2) + top);
    ...
    public void onSlideAnimationEnd(boolean z) {
        ...
        if (!z) {
            ...
            BaseFragment baseFragment = list2.get(list2.size() - 1);
            ...
            if (list.size() >= 2) {
                ...
                list5.get(list5.size() - 1).prepareFragmentToSlide(true, false);
                List<BaseFragment> list6 = this.fragmentsStack;
                BaseFragment baseFragment3 = list6.get(list6.size() - 2);
                ...
                if (view2 != null && (viewGroup2 = (ViewGroup) view2.getParent()) != null) {
                    ...
                    BaseFragment.removeViewFromParent(viewGroup2, baseFragment3.fragmentView);
                }
                ...
                if (actionBar != null && actionBar.shouldAddToContainer() && (viewGroup = (ViewGroup) baseFragment3.actionBar.getParent()) != null) {
                    BaseFragment.removeViewFromParent(viewGroup, baseFragment3.actionBar);
                }
    ...
    private void prepareForMoving() {
        ...
        if (viewCreateView == null && (viewCreateView = baseFragment.createView(this.parentActivity)) != null && baseFragment.isSupportEdgeToEdge() && baseFragment.drawEdgeNavigationBar()) {
            ViewCompat.setOnApplyWindowInsetsListener(viewCreateView, new ActionBarLayout$$ExternalSyntheticLambda0(baseFragment));
    ...
    /* JADX WARN: Removed duplicated region for block: B:293:0x0302  */
    @Override // android.view.View
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public boolean onTouchEvent(android.view.MotionEvent r11) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.ActionBar.ActionBarLayout.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:57:0x0011, code lost:
        ...
        if (r5.animationInProgress != false) goto L58;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public boolean onBackStarted(float r6, float r7) {
        /*
            r5 = this;
            boolean r0 = r5.animationInProgress
            r1 = 0
            if (r0 == 0) goto L14
            android.animation.AnimatorSet r0 = r5.backAnimator
            if (r0 == 0) goto L13
            r0.end()
            r0 = 0
            r5.backAnimator = r0
        ...
        L13:
            return r1
        L14:
            boolean r0 = r5.predictiveBackInProgress
            if (r0 != 0) goto L9a
            boolean r0 = r5.predictiveInput
            if (r0 == 0) goto L1e
            goto L9a
        L1e:
            boolean r0 = r5.transitionAnimationPreviewMode
            if (r0 != 0) goto L9a
            boolean r0 = r5.startedTracking
            if (r0 != 0) goto L9a
            boolean r0 = r5.checkTransitionAnimation()
            if (r0 != 0) goto L9a
            java.util.List<org.telegram.ui.ActionBar.BaseFragment> r0 = r5.fragmentsStack
            int r0 = r0.size()
            r2 = 1
            if (r0 > r2) goto L36
            goto L9a
        L36:
            boolean r0 = r5.isInPreviewMode()
            if (r0 == 0) goto L3d
            return r1
        L3d:
            org.telegram.ui.EmptyBaseFragment r0 = r5.sheetFragment
            if (r0 == 0) goto L48
            boolean r0 = r0.hasShownSheet()
            if (r0 == 0) goto L48
            return r1
        L48:
            java.util.List<org.telegram.ui.ActionBar.BaseFragment> r0 = r5.fragmentsStack
            ...
            boolean r3 = r0.onBackPressed(r1)
            if (r3 != 0) goto L5c
            return r1
        L5c:
            boolean r3 = r0.hasShownSheet()
            if (r3 != 0) goto L9a
            boolean r3 = r0.canBeginSlide()
            if (r3 != 0) goto L69
            goto L9a
        L69:
            r5.predictiveBackHasProgress = r1
            r5.predictiveBackInProgress = r2
            r5.predictiveInput = r2
            ...
            r1 = r2
        L7c:
            r5.predictiveBackLeft = r1
            r5.predictiveBackY = r7
            r5.prepareForMoving()
            android.app.Activity r6 = r5.parentActivity
            if (r6 == 0) goto L96
        ...
        L9a:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.ActionBar.ActionBarLayout.onBackStarted(float, float):boolean");
    }

    public void onBackProgress(float f) {
        if (this.predictiveInput) {
            float predictiveBackIntensity = ExteraConfig.getPredictiveBackIntensity();
            if (predictiveBackIntensity <= 0.0f) {
                predictiveBackIntensity = 1.0f;
            }
            float fMin = Math.min(AndroidUtilities.m1036dp(72.0f) * predictiveBackIntensity * f, this.containerView.getMeasuredWidth());
            this.predictiveBackHasProgress = f > 0.0f;
            this.containerView.setTranslationX(fMin);
            if (ExteraConfig.getSpringAnimations()) {
                this.containerViewBack.setTranslationX((-(this.containerView.getMeasuredWidth() - fMin)) * 0.35f);
            }
            setInnerTranslationX(fMin);
        }
    }
    ...
    private boolean newBackTransitions() {
        return !ExteraConfig.getSpringAnimations() && this.predictiveBackInProgress && this.predictiveBackHasProgress;
    }

    private void animateBackEndAnimation(boolean z) {
        BaseFragment baseFragment;
        ...
        if (!z) {
            ...
            if (!zShouldOverrideSlideTransition) {
                long j = iMax;
                animatorSet.playTogether(ObjectAnimator.ofFloat(this.containerView, (Property<LayoutContainer, Float>) property, r6.getMeasuredWidth() + (this.predictiveBackInProgress ? AndroidUtilities.m1036dp(56.0f) : 0)).setDuration(j), ObjectAnimator.ofFloat(this, "innerTranslationX", this.containerView.getMeasuredWidth()).setDuration(j));
                if (newBackTransitions()) {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.ActionBarLayout$2 */
    /* JADX INFO: loaded from: classes6.dex */
    public class C29192 extends AnimatorListenerAdapter {
        private boolean cancelled;
        final /* synthetic */ boolean val$backAnimation;
    ...
    public void onBackPressed() {
        ...
        if (emptyBaseFragment == null || emptyBaseFragment.onBackPressed(true)) {
            List<BaseFragment> list = this.fragmentsStack;
            if (!list.get(list.size() - 1).onBackPressed(true) || this.fragmentsStack.isEmpty()) {
                return;
            }
    ...
    public BaseFragment getLastFragment() {
        ...
        return this.fragmentsStack.get(r1.size() - 1);
    }
    ...
    private void presentFragmentInternalRemoveOld(boolean z, BaseFragment baseFragment) {
        ...
        if (z) {
            ...
            if (view != null && (viewGroup2 = (ViewGroup) view.getParent()) != null) {
                baseFragment.onRemoveFromParent();
                try {
                    BaseFragment.removeViewFromParent(viewGroup2, baseFragment.fragmentView);
                } catch (Exception e) {
                    FileLog.m1048e(e);
                    try {
            ...
            if (actionBar != null && actionBar.shouldAddToContainer() && (viewGroup = (ViewGroup) baseFragment.actionBar.getParent()) != null) {
                BaseFragment.removeViewFromParent(viewGroup, baseFragment.actionBar);
            }
    ...
    private void applySpringProgress(float f) {
        ...
        if (this.springIsPreview) {
            ...
            if (z) {
                ...
                if (this.previewMenu != null) {
                    ...
                    this.containerView.setTranslationY(AndroidUtilities.m1036dp(40.0f) * f3);
                    this.previewMenu.setTranslationY((-AndroidUtilities.m1036dp(70.0f)) * f3);
        ...
        this.containerView.setTranslationX(r0.getMeasuredWidth() * fClamp01);
        ...
        if (this.fragmentsStack.size() > 1) {
            baseFragment = this.fragmentsStack.get(r0.size() - 2);
        }
    ...
    public void startLayoutAnimation(final boolean z, boolean z2, boolean z3) {
        if (z2) {
            this.animationProgress = 0.0f;
            this.lastFrameTime = System.nanoTime() / 1000000;
        }
        if (!ExteraConfig.getSpringAnimations()) {
            RunnableC29203 runnableC29203 = new Runnable() { // from class: org.telegram.ui.ActionBar.ActionBarLayout.3
                final /* synthetic */ boolean val$first;
                final /* synthetic */ boolean val$open;
                final /* synthetic */ boolean val$preview;

                public RunnableC29203(boolean z22, boolean z32, final boolean z4) {
                    z = z22;
                    z = z32;
                    z = z4;
                }
                    ...
                    if (z) {
                        ...
                        if (z4) {
                            ...
                            if (ActionBarLayout.this.previewMenu != null) {
                                ...
                                ActionBarLayout.this.containerView.setTranslationY(AndroidUtilities.m1036dp(40.0f) * f3);
                                ActionBarLayout.this.previewMenu.setTranslationY((-AndroidUtilities.m1036dp(70.0f)) * f3);
                            ...
                            actionBarLayout.containerView.setTranslationX(AndroidUtilities.m1036dp(48.0f) * (1.0f - interpolation));
                        }
                    } else {
                        ...
                        if (z5) {
                            ...
                            actionBarLayout2.containerViewBack.setScaleX(f6);
                            ...
                            actionBarLayout2.containerViewBack.setTranslationX(AndroidUtilities.m1036dp(48.0f) * interpolation);
                        }
                    }
                    float f7 = ActionBarLayout.this.animationProgress;
                    ActionBarLayout actionBarLayout3 = ActionBarLayout.this;
                    if (f7 < 1.0f) {
                        actionBarLayout3.startLayoutAnimation(z, false, z);
                    } else {
                        actionBarLayout3.onAnimationEndCheck(false);
                    }
                }
            };
            this.animationRunnable = runnableC29203;
            AndroidUtilities.runOnUIThread(runnableC29203);
            return;
        }
        if (z32) {
            SpringAnimation spring = new SpringAnimation(new FloatValueHolder(0.0f)).setSpring(new SpringForce(1000.0f).setStiffness(z4 ? 650.0f : 800.0f).setDampingRatio(0.6f));
            spring.addUpdateListener(new DynamicAnimation.OnAnimationUpdateListener() { // from class: org.telegram.ui.ActionBar.ActionBarLayout$$ExternalSyntheticLambda18
                @Override // androidx.dynamicanimation.animation.DynamicAnimation.OnAnimationUpdateListener
                public final void onAnimationUpdate(DynamicAnimation dynamicAnimation, float f, float f2) {
                    this.f$0.lambda$startLayoutAnimation$4(z4, dynamicAnimation, f, f2);
                }
            });
            spring.addEndListener(new DynamicAnimation.OnAnimationEndListener() { // from class: org.telegram.ui.ActionBar.ActionBarLayout$$ExternalSyntheticLambda19
                @Override // androidx.dynamicanimation.animation.DynamicAnimation.OnAnimationEndListener
        ...
        this.openingAnimation = z4;
        this.springIsLayout = true;
        this.springIsPreview = z32;
        ...
        if (this.currentSpringAnimation == null) {
            ...
            this.currentSpringAnimation.addUpdateListener(new DynamicAnimation.OnAnimationUpdateListener() { // from class: org.telegram.ui.ActionBar.ActionBarLayout$$ExternalSyntheticLambda20
                @Override // androidx.dynamicanimation.animation.DynamicAnimation.OnAnimationUpdateListener
                public final void onAnimationUpdate(DynamicAnimation dynamicAnimation, float f, float f2) {
                    this.f$0.lambda$startLayoutAnimation$6(dynamicAnimation, f, f2);
                }
            });
            this.currentSpringAnimation.addEndListener(new DynamicAnimation.OnAnimationEndListener() { // from class: org.telegram.ui.ActionBar.ActionBarLayout$$ExternalSyntheticLambda21
                @Override // androidx.dynamicanimation.animation.DynamicAnimation.OnAnimationEndListener
                public final void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z4, float f, float f2) {
                    this.f$0.lambda$startLayoutAnimation$7(dynamicAnimation, z4, f, f2);
                }
            });
        }
        ...
        this.springForce.setDampingRatio(z32 ? 0.6f : 1.0f);
        this.currentSpringAnimation.setStartVelocity(0.0f);
        this.currentSpringAnimation.start();
    }

    public /* synthetic */ void lambda$startLayoutAnimation$4(boolean z, DynamicAnimation dynamicAnimation, float f, float f2) {
        float f3 = f / 1000.0f;
        ...
        if (z) {
            ...
            this.containerView.setAlpha(fClamp);
            if (this.previewMenu != null) {
                this.containerView.setTranslationY(AndroidUtilities.m1036dp(40.0f) * (1.0f - this.animationProgress));
                this.previewMenu.setTranslationY((-AndroidUtilities.m1036dp(70.0f)) * (1.0f - this.animationProgress));
        ...
        float fClamp2 = MathUtils.clamp(1.0f - f4, 0.0f, 1.0f);
        this.containerViewBack.setTranslationX(0.0f);
        this.containerViewBack.setTranslationY(0.0f);
    ...
    public /* synthetic */ void lambda$startLayoutAnimation$6(DynamicAnimation dynamicAnimation, float f, float f2) {
        applySpringProgress(f);
    }

    public /* synthetic */ void lambda$startLayoutAnimation$7(DynamicAnimation dynamicAnimation, boolean z, float f, float f2) {
        if (this.springIsLayout) {
            onAnimationEndCheck(false);
            setInnerTranslationX(0.0f);
        } else {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.ActionBarLayout$3 */
    /* JADX INFO: loaded from: classes6.dex */
    public class RunnableC29203 implements Runnable {
        final /* synthetic */ boolean val$first;
        final /* synthetic */ boolean val$open;
        final /* synthetic */ boolean val$preview;
    ...
    public boolean presentFragment(INavigationLayout.NavigationParams navigationParams) {
        ...
        boolean zIsSupportEdgeToEdge = baseFragment2.isSupportEdgeToEdge();
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m1045d("present fragment " + baseFragment2.getClass().getSimpleName() + " args=" + baseFragment2.getArguments());
        }
        ...
        boolean springAnimations = ExteraConfig.getSpringAnimations();
        if (this.fragmentsStack.isEmpty()) {
            baseFragment = null;
        } else {
            List<BaseFragment> list = this.fragmentsStack;
        ...
        if (viewCreateView == null) {
            ...
            if (viewCreateView != null && baseFragment2.isSupportEdgeToEdge() && baseFragment2.drawEdgeNavigationBar()) {
                ViewCompat.setOnApplyWindowInsetsListener(viewCreateView, new ActionBarLayout$$ExternalSyntheticLambda0(baseFragment2));
                this.containerViewBack.invalidate();
            }
        } else {
            ViewGroup viewGroup = (ViewGroup) viewCreateView.getParent();
        ...
        if (actionBarPopupWindowLayout != null) {
            ...
            measuredHeight = actionBarPopupWindowLayout.getMeasuredHeight() + AndroidUtilities.m1036dp(24.0f);
            FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) actionBarPopupWindowLayout.getLayoutParams();
            layoutParams.width = -2;
            layoutParams.height = -2;
            layoutParams.topMargin = ((getMeasuredHeight() - AndroidUtilities.navigationBarHeight) - measuredHeight) - AndroidUtilities.m1036dp(6.0f);
        ...
        if (z5) {
            ...
            if (previewHeight > 0 && previewHeight < getMeasuredHeight() - i2) {
                ...
                int iM1036dp = AndroidUtilities.m1036dp(actionBarPopupWindowLayout != null ? 0.0f : f);
                layoutParams2.bottomMargin = iM1036dp;
                layoutParams2.topMargin = iM1036dp;
            ...
            if (actionBarPopupWindowLayout != null) {
                layoutParams2.bottomMargin += measuredHeight + AndroidUtilities.m1036dp(8.0f);
            }
        ...
        this.containerView.setTranslationY(0.0f);
        if (z5) {
            viewCreateView.setOutlineProvider(ViewOutlineProviderImpl.boundsWithPaddingRoundRect(0, AndroidUtilities.m1036dp(actionBarPopupWindowLayout == null ? f : 12.0f)));
            viewCreateView.setClipToOutline(true);
            viewCreateView.setElevation(AndroidUtilities.m1036dp(4.0f));
        ...
        if (z6 || z5) {
            if (this.useAlphaAnimations && this.fragmentsStack.size() == 1) {
                ...
                this.onOpenAnimationEndRunnable = new Runnable() { // from class: org.telegram.ui.ActionBar.ActionBarLayout$$ExternalSyntheticLambda10
                    @Override // java.lang.Runnable
                    public final void run() {
                        ActionBarLayout.$r8$lambda$6b3oNGlqO3pCqQdggcJfac2igu0(baseFragment, baseFragment2);
                    }
                };
                ...
                fArr2[0] = 0.9f;
                fArr2[1] = 1.0f;
                arrayList.add(ObjectAnimator.ofFloat(this, (Property<ActionBarLayout, Float>) View.SCALE_X, fArr2));
                float[] fArr3 = new float[i5];
                // fill-array-data instruction
                fArr3[0] = 0.9f;
                fArr3[1] = 1.0f;
                arrayList.add(ObjectAnimator.ofFloat(this, (Property<ActionBarLayout, Float>) View.SCALE_Y, fArr3));
                ...
                if (view2 != null) {
                    ...
                    fArr4[0] = 0.0f;
                    fArr4[1] = 1.0f;
                    arrayList.add(ObjectAnimator.ofFloat(this.backgroundView, (Property<View, Float>) property, fArr4));
                }
                if (baseFragment != null) {
                ...
                this.onOpenAnimationEndRunnable = new Runnable() { // from class: org.telegram.ui.ActionBar.ActionBarLayout$$ExternalSyntheticLambda11
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$presentFragment$9(z5, actionBarPopupWindowLayout, z2, baseFragment3, baseFragment2);
                    }
                };
                boolean zNeedDelayOpenAnimation = baseFragment2.needDelayOpenAnimation();
                boolean z7 = !zNeedDelayOpenAnimation;
                ...
                AnimatorSet animatorSetOnCustomTransitionAnimation = !z5 ? baseFragment2.onCustomTransitionAnimation(z, new Runnable() { // from class: org.telegram.ui.ActionBar.ActionBarLayout$$ExternalSyntheticLambda12
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$presentFragment$10();
                    }
                }) : null;
                if (animatorSetOnCustomTransitionAnimation == null) {
                    if (springAnimations) {
                        ...
                        if (z5) {
                            layoutContainer4.setAlpha(0.0f);
                            this.containerView.setTranslationX(0.0f);
                            this.containerView.setScaleX(0.5f);
                            this.containerView.setScaleY(0.5f);
                        } else {
                            layoutContainer4.setTranslationX((getWidth() - getPaddingLeft()) - getPaddingRight());
                        }
                    } else {
                        this.containerView.setAlpha(0.0f);
                        LayoutContainer layoutContainer5 = this.containerView;
                        if (z5) {
                            layoutContainer5.setTranslationX(0.0f);
                            this.containerView.setScaleX(0.9f);
                            this.containerView.setScaleY(0.9f);
                        } else {
                            layoutContainer5.setTranslationX(48.0f);
                    ...
                    if (this.containerView.isKeyboardVisible || this.containerViewBack.isKeyboardVisible) {
                        ...
                        this.waitingForKeyboardCloseRunnable = new Runnable() { // from class: org.telegram.ui.ActionBar.ActionBarLayout.5
                            ...
                            public RunnableC29225(boolean z72, final BaseFragment baseFragment32, final BaseFragment baseFragment22, final boolean z52) {
                                z = z72;
                                baseFragment = baseFragment32;
                                baseFragment = baseFragment22;
                                z = z52;
                            }
                            ...
                            public void run() {
                                ...
                                if (ActionBarLayout.this.delayedOpenAnimationRunnable != null) {
                                    ...
                                    boolean z8 = ActionBarLayout.this.delayedAnimationResumed;
                                    ActionBarLayout actionBarLayout = ActionBarLayout.this;
                                    if (z8) {
                        ...
                        if (baseFragment22.needDelayOpenAnimation()) {
                            this.delayedOpenAnimationRunnable = new Runnable() { // from class: org.telegram.ui.ActionBar.ActionBarLayout.6
                                final /* synthetic */ BaseFragment val$currentFragment;
                                final /* synthetic */ BaseFragment val$fragment;
                                final /* synthetic */ boolean val$preview;

                                public RunnableC29236(final BaseFragment baseFragment32, final BaseFragment baseFragment22, final boolean z52) {
                                    baseFragment = baseFragment32;
                                    baseFragment = baseFragment22;
                                    z = z52;
                                }
                    ...
                    } else if (baseFragment22.needDelayOpenAnimation()) {
                        RunnableC29247 runnableC29247 = new Runnable() { // from class: org.telegram.ui.ActionBar.ActionBarLayout.7
                            final /* synthetic */ BaseFragment val$fragment;
                            final /* synthetic */ boolean val$preview;

                            public RunnableC29247(final BaseFragment baseFragment22, final boolean z52) {
                                baseFragment = baseFragment22;
                                z = z52;
                            }
                        ...
                        this.delayedOpenAnimationRunnable = runnableC29247;
                        AndroidUtilities.runOnUIThread(runnableC29247, 200L);
                    } else {
                        startLayoutAnimation(true, true, z52);
                    }
                } else {
                    if (!z52 && ((this.containerView.isKeyboardVisible || this.containerViewBack.isKeyboardVisible) && baseFragment32 != null)) {
                        baseFragment32.saveKeyboardPositionBeforeTransition();
                    }
        ...
        baseFragment22.onTransitionAnimationStart(true, false);
        baseFragment22.onTransitionAnimationEnd(true, false);
        baseFragment22.onBecomeFullyVisible();
        return true;
    }

    public static /* synthetic */ void $r8$lambda$6b3oNGlqO3pCqQdggcJfac2igu0(BaseFragment baseFragment, BaseFragment baseFragment2) {
        if (baseFragment != null) {
            baseFragment.onTransitionAnimationEnd(false, false);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.ActionBarLayout$4 */
    /* JADX INFO: loaded from: classes6.dex */
    public class C29214 extends AnimatorListenerAdapter {
        public C29214() {
        }
    ...
    public /* synthetic */ void lambda$presentFragment$9(boolean z, ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout, boolean z2, BaseFragment baseFragment, BaseFragment baseFragment2) {
        if (z) {
    ...
    public /* synthetic */ void lambda$presentFragment$10() {
        onAnimationEndCheck(false);
    }

    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.ActionBarLayout$5 */
    /* JADX INFO: loaded from: classes6.dex */
    public class RunnableC29225 implements Runnable {
        final /* synthetic */ BaseFragment val$currentFragment;
        final /* synthetic */ BaseFragment val$fragment;
        final /* synthetic */ boolean val$noDelay;
        final /* synthetic */ boolean val$preview;
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.ActionBarLayout$6 */
    public class RunnableC29236 implements Runnable {
        final /* synthetic */ BaseFragment val$currentFragment;
        final /* synthetic */ BaseFragment val$fragment;
        final /* synthetic */ boolean val$preview;
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.ActionBarLayout$7 */
    public class RunnableC29247 implements Runnable {
        final /* synthetic */ BaseFragment val$fragment;
        final /* synthetic */ boolean val$preview;
    ...
    public void movePreviewFragment(float f) {
        if (this.inPreviewMode && this.previewMenu == null && !this.transitionAnimationPreviewMode) {
            ...
            if (f2 > 0.0f) {
                f2 = 0.0f;
            } else if (f2 < (-AndroidUtilities.m1036dp(60.0f))) {
    ...
    public void expandPreviewFragment() {
        ...
        List<BaseFragment> list = this.fragmentsStack;
        final BaseFragment baseFragment = list.get(list.size() - 2);
        List<BaseFragment> list2 = this.fragmentsStack;
        ...
        try {
            if (ExteraConfig.getSpringAnimations()) {
                ...
                spring.addUpdateListener(new DynamicAnimation.OnAnimationUpdateListener() { // from class: org.telegram.ui.ActionBar.ActionBarLayout$$ExternalSyntheticLambda15
                    @Override // androidx.dynamicanimation.animation.DynamicAnimation.OnAnimationUpdateListener
                    public final void onAnimationUpdate(DynamicAnimation dynamicAnimation, float f, float f2) {
                        this.f$0.lambda$expandPreviewFragment$11(view, translationY2, translationY, dynamicAnimation, f, f2);
                    }
                });
                spring.addEndListener(new DynamicAnimation.OnAnimationEndListener() { // from class: org.telegram.ui.ActionBar.ActionBarLayout$$ExternalSyntheticLambda16
                    @Override // androidx.dynamicanimation.animation.DynamicAnimation.OnAnimationEndListener
                    public final void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z, float f, float f2) {
                        this.f$0.lambda$expandPreviewFragment$12(baseFragment, baseFragment2, dynamicAnimation, z, f, f2);
                    }
                });
                spring.start();
            ...
            animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.ActionBar.ActionBarLayout.8
                ...
                public C29258(final BaseFragment baseFragment22) {
                    baseFragment = baseFragment22;
                }
            ...
            this.containerView.setShouldHandleBottomInsets(baseFragment22.isSupportEdgeToEdge());
            this.containerView.setDrawNavigationBar(baseFragment22.drawEdgeNavigationBar());
            baseFragment22.setInPreviewMode(false);
            baseFragment22.setInMenuMode(false);
            AndroidUtilities.setLightStatusBar(this.parentActivity.getWindow(), baseFragment22.isLightStatusBar(), baseFragment22.hasForceLightStatusBar());
        } catch (Exception unused2) {
        }
    }

    public /* synthetic */ void lambda$expandPreviewFragment$11(View view, float f, float f2, DynamicAnimation dynamicAnimation, float f3, float f4) {
        float f5 = f3 / 1000.0f;
        ...
        view.setTranslationY(AndroidUtilities.lerp(rect2.top - (rect2.centerY() * (1.0f - fHeight)), 0.0f, f5));
    ...
    public /* synthetic */ void lambda$expandPreviewFragment$12(BaseFragment baseFragment, BaseFragment baseFragment2, DynamicAnimation dynamicAnimation, boolean z, float f, float f2) {
        presentFragmentInternalRemoveOld(false, baseFragment);
        this.previewOpenAnimationInProgress = false;
        baseFragment2.onPreviewOpenAnimationEnd();
    }

    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.ActionBarLayout$8 */
    /* JADX INFO: loaded from: classes6.dex */
    public class C29258 extends AnimatorListenerAdapter {
        final /* synthetic */ BaseFragment val$fragment;
            ...
            if (baseFragment != null) {
                ...
                if (z3) {
                    ...
                    this.onCloseAnimationEndRunnable = new Runnable() { // from class: org.telegram.ui.ActionBar.ActionBarLayout$$ExternalSyntheticLambda3
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$closeLastFragment$13(baseFragment2, baseFragment);
                        }
                    };
                    if (!this.inPreviewMode && !this.transitionAnimationPreviewMode) {
                        animatorSetOnCustomTransitionAnimation = baseFragment2.onCustomTransitionAnimation(false, new Runnable() { // from class: org.telegram.ui.ActionBar.ActionBarLayout$$ExternalSyntheticLambda4
                            @Override // java.lang.Runnable
                            public final void run() {
                                this.f$0.lambda$closeLastFragment$14();
                            }
                        });
                    }
                    if (animatorSetOnCustomTransitionAnimation == null) {
                        if (!this.inPreviewMode && (this.containerView.isKeyboardVisible || this.containerViewBack.isKeyboardVisible)) {
                            RunnableC29269 runnableC29269 = new Runnable() { // from class: org.telegram.ui.ActionBar.ActionBarLayout.9
                                public RunnableC29269() {
                                }
                            ...
                            this.waitingForKeyboardCloseRunnable = runnableC29269;
                            AndroidUtilities.runOnUIThread(runnableC29269, 200L);
                        } else {
                ...
                this.onCloseAnimationEndRunnable = new Runnable() { // from class: org.telegram.ui.ActionBar.ActionBarLayout$$ExternalSyntheticLambda5
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$closeLastFragment$15(baseFragment2);
                    }
                };
                ArrayList arrayList = new ArrayList();
                Property property = View.ALPHA;
    ...
    public /* synthetic */ void lambda$closeLastFragment$13(BaseFragment baseFragment, BaseFragment baseFragment2) {
        ViewGroup viewGroup;
        ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout = this.previewMenu;
    ...
    public /* synthetic */ void lambda$closeLastFragment$14() {
        onAnimationEndCheck(false);
    }

    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.ActionBarLayout$9 */
    /* JADX INFO: loaded from: classes6.dex */
    public class RunnableC29269 implements Runnable {
        public RunnableC29269() {
        }
    ...
    public /* synthetic */ void lambda$closeLastFragment$15(BaseFragment baseFragment) {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.ActionBarLayout$10 */
    /* JADX INFO: loaded from: classes6.dex */
    public class C291710 extends AnimatorListenerAdapter {
        public C291710() {
        }
    ...
    public void bringToFront(int i) {
        ...
        if (this.fragmentsStack.size() - 1 != i || this.fragmentsStack.get(i).fragmentView == null) {
            int i2 = 0;
            while (true) {
            ...
            BaseFragment baseFragment2 = list.get(i);
            baseFragment2.setParentLayout(this);
            View viewCreateView = baseFragment2.fragmentView;
            if (viewCreateView == null) {
                viewCreateView = baseFragment2.createView(this.parentActivity);
    ...
    /* JADX WARN: Removed duplicated region for block: B:39:0x0016  */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void removeFragmentFromStack(org.telegram.p035ui.ActionBar.BaseFragment r4, boolean r5) {
        /*
            r3 = this;
        ...
        L7b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.ActionBar.ActionBarLayout.removeFragmentFromStack(org.telegram.ui.ActionBar.BaseFragment, boolean):void");
    }
    ...
    public void removeAllFragments() {
        ...
        View view = this.backgroundView;
        if (view != null) {
            view.animate().alpha(0.0f).setDuration(180L).withEndAction(new Runnable() { // from class: org.telegram.ui.ActionBar.ActionBarLayout$$ExternalSyntheticLambda17
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$removeAllFragments$16();
                }
            }).start();
        }
    }

    public /* synthetic */ void lambda$removeAllFragments$16() {
    ...
    public void animateThemedValues(final INavigationLayout.ThemeAnimationSettings themeAnimationSettings, final Runnable runnable) {
        ...
        final Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.ActionBar.ActionBarLayout$$ExternalSyntheticLambda13
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$animateThemedValues$17(size, themeAnimationSettings, runnable);
            }
        };
        if (size >= 1 && themeAnimationSettings.applyTheme && themeAnimationSettings.applyTrulyTheme) {
            ...
            Theme.ThemeInfo themeInfo2 = themeAnimationSettings.theme;
            if (runnable == null) {
                Theme.applyTheme(themeInfo2, themeAnimationSettings.nightTheme);
                runnable2.run();
                return;
            } else {
                Theme.applyThemeInBackground(themeInfo2, themeAnimationSettings.nightTheme, new Runnable() { // from class: org.telegram.ui.ActionBar.ActionBarLayout$$ExternalSyntheticLambda14
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public /* synthetic */ void lambda$animateThemedValues$17(int i, INavigationLayout.ThemeAnimationSettings themeAnimationSettings, Runnable runnable) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            if (i2 == 0) {
                ...
                List<BaseFragment> list = this.fragmentsStack;
                lastFragment = list.get(list.size() - 2);
            }
            if (lastFragment != null) {
        ...
        if (z) {
            ...
            animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.ActionBar.ActionBarLayout.11
                final /* synthetic */ INavigationLayout.ThemeAnimationSettings val$settings;

                public C291811(INavigationLayout.ThemeAnimationSettings themeAnimationSettings2) {
                    themeAnimationSettings = themeAnimationSettings2;
                }
            ...
            this.themeAnimatorSet.setDuration(themeAnimationSettings2.duration);
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.ActionBarLayout$11 */
    /* JADX INFO: loaded from: classes6.dex */
    public class C291811 extends AnimatorListenerAdapter {
        final /* synthetic */ INavigationLayout.ThemeAnimationSettings val$settings;
    ...
    public void setTitleOverlayText(String str, int i, Runnable runnable) {
        ...
        for (int i2 = 0; i2 < this.fragmentsStack.size(); i2++) {
            this.fragmentsStack.get(i2).setTitleOverlayText(this.titleOverlayText, this.titleOverlayTextId, runnable);
        }
    }
    ...
    public boolean extendActionMode(Menu menu) {
        ...
        List<BaseFragment> list = this.fragmentsStack;
        return list.get(list.size() - 1).extendActionMode(menu);
    }
    ...
    public /* synthetic */ void lambda$new$19() {
        if (this.attached && getLastFragment() != null && this.containerView.getChildCount() == 0) {
            if (BuildVars.DEBUG_VERSION) {
                FileLog.m1048e(new RuntimeException(TextUtils.join(", ", this.lastActions)));
            }
    ...
    /* JADX WARN: Removed duplicated region for block: B:72:0x005f A[PHI: r3
 ...
 binds: [B:62:0x0038, B:64:0x003e, B:66:0x0048, B:70:0x005c] A[DONT_GENERATE, DONT_INLINE]] */
    @Override // android.view.ViewGroup, android.view.View
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public boolean dispatchTouchEvent(android.view.MotionEvent r7) {
        /*
            ...
            int r1 = r6.getHeight()
            r2 = 1
            int r3 = r6.getBottomTabsHeight(r2)
            int r1 = r1 - r3
            int r3 = r6.navigationBarInsetHeight
            int r1 = r1 - r3
            float r1 = (float) r1
        ...
        L19:
            r0 = r1
        L1a:
            org.telegram.ui.EmptyBaseFragment r3 = r6.sheetFragment
            r4 = 0
            if (r3 == 0) goto L37
            org.telegram.ui.ActionBar.BaseFragment$AttachedSheet r3 = r3.getLastSheet()
            if (r3 == 0) goto L37
            org.telegram.ui.EmptyBaseFragment r3 = r6.sheetFragment
            org.telegram.ui.ActionBar.BaseFragment$AttachedSheet r3 = r3.getLastSheet()
            boolean r5 = r3.attachedToParent()
            if (r5 == 0) goto L37
            android.view.View r5 = r3.mo7483getWindowView()
            if (r5 != 0) goto L38
        L37:
            r3 = r4
        L38:
            if (r3 != 0) goto L5f
            org.telegram.ui.ActionBar.BaseFragment r5 = r6.getLastFragment()
            if (r5 == 0) goto L5f
            org.telegram.ui.ActionBar.BaseFragment r5 = r6.getLastFragment()
            org.telegram.ui.ActionBar.BaseFragment$AttachedSheet r5 = r5.getLastSheet()
            if (r5 == 0) goto L5f
            org.telegram.ui.ActionBar.BaseFragment r3 = r6.getLastFragment()
            org.telegram.ui.ActionBar.BaseFragment$AttachedSheet r3 = r3.getLastSheet()
            boolean r5 = r3.attachedToParent()
            if (r5 == 0) goto L60
            android.view.View r5 = r3.mo7483getWindowView()
        ...
        L7b:
            r6.tabsEvents = r1
        L7d:
            android.view.View r6 = r4.mo7483getWindowView()
            boolean r6 = r6.dispatchTouchEvent(r7)
            return r6
        L86:
            int r0 = r7.getAction()
            if (r0 == r2) goto L92
        ...
        L94:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.ActionBar.ActionBarLayout.dispatchTouchEvent(android.view.MotionEvent):boolean");
    }
