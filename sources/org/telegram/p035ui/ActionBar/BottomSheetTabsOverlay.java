...
public class BottomSheetTabsOverlay extends View {
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (tabPreview != null) {
                ...
                boolean zContains = this.pressTab.tabDrawable.closeRipple.getBounds().contains((int) (motionEvent.getX() - this.pressTab.clickBounds.left), (int) ((motionEvent.getY() - this.pressTab.clickBounds.top) - AndroidUtilities.m1036dp(24.0f)));
            ...
            if (tabPreview2 != null) {
                if (tabPreview2.isPressed()) {
                    ...
                    if (this.pressTabClose) {
                        boolean zContains2 = this.pressTab.tabDrawable.closeRipple.getBounds().contains((int) (motionEvent.getX() - this.pressTab.clickBounds.left), (int) ((motionEvent.getY() - this.pressTab.clickBounds.top) - AndroidUtilities.m1036dp(24.0f)));
                ...
                if (!this.pressTab.isPressed()) {
                    if (this.horizontallySwiping) {
                        this.pressTab.dismissProgress = (motionEvent.getX() - this.startX) / AndroidUtilities.m1036dp(300.0f);
            ...
            if (tabPreview3 != null) {
                ...
                this.pressTab.setPressed(false);
                if (this.pressTabClose) {
                    this.pressTabClose = this.pressTab.tabDrawable.closeRipple.getBounds().contains((int) (motionEvent.getX() - this.pressTab.clickBounds.left), (int) ((motionEvent.getY() - this.pressTab.clickBounds.top) - AndroidUtilities.m1036dp(24.0f)));
                }
                if (this.pressTabClose) {
    ...
    private float getScrollStep() {
        return AndroidUtilities.m1036dp(200.0f);
    }
    ...
    public boolean dismissSheet(final Sheet sheet) {
        ...
        this.animator.addListener(new C29912(webTabDataSaveState, sheet));
    ...
    public static /* synthetic */ void $r8$lambda$hXGnNPWO7I1wkl5xjJT0SgMoWSw(Sheet sheet) {
        if (sheet == null || sheet.mo7483getWindowView() == null) {
            return;
        }
        sheet.mo7483getWindowView().setDrawingFromOverlay(true);
    }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.BottomSheetTabsOverlay$2 */
    /* JADX INFO: loaded from: classes6.dex */
    public class C29912 extends AnimatorListenerAdapter {
        final /* synthetic */ Sheet val$sheet;
        final /* synthetic */ BottomSheetTabs.WebTabData val$tab;

        public C29912(BottomSheetTabs.WebTabData webTabData, Sheet sheet) {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            if (view != null && webTabData.previewBitmap == null && (i = webTabData.viewWidth) > 0 && (i2 = webTabData.viewHeight) > 0) {
                if (Build.VERSION.SDK_INT >= 26) {
                    ...
                    BottomSheetTabsOverlay.renderHardwareViewToBitmap(view, f, new Utilities.Callback() { // from class: org.telegram.ui.ActionBar.BottomSheetTabsOverlay$2$$ExternalSyntheticLambda0
                        @Override // org.telegram.messenger.Utilities.Callback
                        public final void run(Object obj) {
                            BottomSheetTabsOverlay.C29912.$r8$lambda$GCfik7AYPJcOu1GrqTlmVf7Z84w(webTabData, sheet, (Bitmap) obj);
                        }
                    });
            ...
            this.val$sheet.mo7483getWindowView().setDrawingFromOverlay(false);
        ...
        public static /* synthetic */ void $r8$lambda$GCfik7AYPJcOu1GrqTlmVf7Z84w(BottomSheetTabs.WebTabData webTabData, Sheet sheet, Bitmap bitmap) {
            ...
            sheet.mo7483getWindowView().setDrawingFromOverlay(false);
            sheet.release();
        }
    }
    ...
    public void openTabsView() {
        ...
        if (!BotWebViewSheet.activeSheets.isEmpty()) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ActionBar.BottomSheetTabsOverlay$$ExternalSyntheticLambda6
                @Override // java.lang.Runnable
                public final void run() {
        ...
        int i = this.pos[0];
        int i2 = this.pos2[0];
        rectF.set(i - i2, r2[1] - r5[1], (i - i2) + this.actionBarLayout.getWidth(), (this.pos[1] - this.pos2[1]) + this.actionBarLayout.getHeight());
    ...
    private void scrollTo(float f) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.ActionBar.BottomSheetTabsOverlay$$ExternalSyntheticLambda8
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class OverlayAccessibilityHelper extends ExploreByTouchHelper {
            ...
            for (int size = BottomSheetTabsOverlay.this.tabs.size() - 1; size >= 0; size--) {
                ...
                if (Math.abs(tabPreview.dismissProgress) < 0.4f && tabPreview.clickBounds.contains(f, f2)) {
                    ...
                    if (!bounds.isEmpty()) {
                        ...
                        if (bounds.contains((int) (f - rectF.left), (int) ((f2 - rectF.top) - AndroidUtilities.m1036dp(24.0f)))) {
                            return size + 2000;
                        }
                    }
        ...
        public void onPopulateNodeForVirtualView(int i, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            ...
            if (i == 1) {
                Drawable drawable = BottomSheetTabsOverlay.this.closeAllButtonBackground;
                Rect rect = this.tmpRect;
                if (drawable != null) {
                    rect.set(BottomSheetTabsOverlay.this.closeAllButtonBackground.getBounds());
                } else {
                    rect.set(0, 0, 1, 1);
                    accessibilityNodeInfoCompat.setVisibleToUser(false);
                }
                accessibilityNodeInfoCompat.setBoundsInParent(this.tmpRect);
                accessibilityNodeInfoCompat.setContentDescription(LocaleController.getString(C2797R.string.BotCloseAllTabs));
                return;
            }
            if (i >= 2000) {
                i2 = i - 2000;
            ...
            String title = (webTabData == null || webTabData.getTitle() == null) ? _UrlKt.FRAGMENT_ENCODE_SET : tabPreview.tabData.getTitle();
            if (z) {
                Rect bounds = tabPreview.tabDrawable.closeRipple.getBounds();
                RectF rectF = tabPreview.clickBounds;
                int i3 = (int) (rectF.left + bounds.left);
                int iM1036dp = (int) (rectF.top + AndroidUtilities.m1036dp(24.0f) + bounds.top);
                RectF rectF2 = tabPreview.clickBounds;
                this.tmpRect.set(i3, iM1036dp, (int) (rectF2.left + bounds.right), (int) (rectF2.top + AndroidUtilities.m1036dp(24.0f) + bounds.bottom));
                accessibilityNodeInfoCompat.setBoundsInParent(this.tmpRect);
        ...
        public boolean onPerformActionForVirtualView(int i, int i2, Bundle bundle) {
            ...
            if (i3 >= 0 && i3 < BottomSheetTabsOverlay.this.tabs.size()) {
                ...
                BottomSheetTabsOverlay bottomSheetTabsOverlay = BottomSheetTabsOverlay.this;
                if (z) {
                    if (bottomSheetTabsOverlay.tabsView != null) {
    ...
    private void drawDismissingTab(Canvas canvas) {
        if (this.dismissingSheet != null) {
            ...
            SheetView sheetViewMo7483getWindowView = this.dismissingSheet.mo7483getWindowView();
            RectF rectF2 = this.rect;
            float f = this.dismissProgress;
            float fDrawInto = sheetViewMo7483getWindowView.drawInto(canvas, rectF2, f, this.clipRect, f, false);
            if (this.dismissingTab != null) {
                this.clipPath.rewind();
                this.clipPath.addRoundRect(this.clipRect, fDrawInto, fDrawInto, Path.Direction.CW);
                canvas.save();
                canvas.clipPath(this.clipPath);
                float fM1036dp = this.clipRect.top - (AndroidUtilities.m1036dp(50.0f) * (1.0f - this.dismissProgress));
                RectF rectF3 = this.rect;
                RectF rectF4 = this.clipRect;
                rectF3.set(rectF4.left, fM1036dp, rectF4.right, AndroidUtilities.m1036dp(50.0f) + fM1036dp);
    ...
    */
    private void drawTabsPreview(android.graphics.Canvas r43) {
        /*
            Method dump skipped, instruction units count: 1443
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.ActionBar.BottomSheetTabsOverlay.drawTabsPreview(android.graphics.Canvas):void");
    }
    ...
    public static class TabPreview {
        ...
        public void animateDismiss(final float f) {
            ...
            ValueAnimator valueAnimator = this.dismissAnimator;
            if (fAbs < 0.1f) {
                AndroidUtilities.applySpring(valueAnimator, 285.0d, 20.0d);
            } else {
        ...
        public void draw(Canvas canvas, RectF rectF, boolean z, float f, float f2, float f3, float f4) {
            ...
            float currentActionBarHeight = ((AndroidUtilities.statusBarHeight + ActionBar.getCurrentActionBarHeight()) - AndroidUtilities.m1036dp(50.0f)) * f3;
            canvas.save();
            canvas.rotate(this.dismissProgress * 20.0f, rectF.centerX() + (AndroidUtilities.m1036dp(50.0f) * this.dismissProgress), rectF.bottom + AndroidUtilities.m1036dp(350.0f));
            float scale = this.bounce.getScale(0.01f);
            canvas.scale(scale, scale, rectF.centerX(), rectF.centerY());
            float fLerp2 = AndroidUtilities.lerp(AndroidUtilities.m1036dp(18.0f), AndroidUtilities.m1036dp(18.0f), f2);
            if (z) {
                this.shadowPaint.setColor(0);
                this.shadowPaint.setShadowLayer(AndroidUtilities.m1036dp(30.0f), 0.0f, AndroidUtilities.m1036dp(10.0f), Theme.multAlpha(536870912, fClamp * f2 * f7));
            ...
            this.shadowPaint.setColor(0);
            float f9 = fClamp * f2;
            this.shadowPaint.setShadowLayer(AndroidUtilities.m1036dp(30.0f), 0.0f, AndroidUtilities.m1036dp(10.0f), Theme.multAlpha(536870912, f9 * f7));
            ...
            canvas.drawRoundRect(rectF, fLerp2, fLerp2, this.backgroundPaint);
            canvas.save();
            canvas.translate(rectF.left, rectF.top + (AndroidUtilities.m1036dp(50.0f) * fLerp) + currentActionBarHeight);
            canvas.scale(1.0f, AndroidUtilities.lerp(1.0f, 1.25f, f8));
            BottomSheetTabs.WebTabData webTabData = this.tabData;
            if (webTabData != null && (obj = webTabData.previewNode) != null && Build.VERSION.SDK_INT >= 29 && BotFullscreenButtons$$ExternalSyntheticApiModelOutline1.m1042m(obj).hasDisplayList()) {
                RenderNode renderNodeM1042m = BotFullscreenButtons$$ExternalSyntheticApiModelOutline1.m1042m(this.tabData.previewNode);
                float fWidth = rectF.width() / renderNodeM1042m.getWidth();
                canvas.scale(fWidth, fWidth);
                renderNodeM1042m.setAlpha(f9);
                ...
                if (webTabData2 != null && webTabData2.previewBitmap != null) {
                    ...
                    rectF2.bottom = rectF2.top + Math.min(rectF.height(), AndroidUtilities.m1036dp(50.0f));
            ...
            rectF22.bottom = rectF22.top + Math.min(rectF.height(), AndroidUtilities.m1036dp(50.0f));
            this.tabBounds.offset(0.0f, f6);
            this.tabDrawable.setExpandProgress(f2);
            canvas.scale(1.0f, fLerp, this.tabBounds.centerX(), this.tabBounds.top);
            this.tabDrawable.draw(canvas, this.tabBounds, f5, fClamp * fClamp, f4);
    ...
    public static void renderHardwareViewToBitmap(View view, float f, final Utilities.Callback<Bitmap> callback) {
        ...
        final SurfaceTexture surfaceTextureM1112m = BottomSheetTabsOverlay$$ExternalSyntheticApiModelOutline0.m1112m(false);
        surfaceTextureM1112m.setDefaultBufferSize(view.getWidth(), view.getHeight());
        final Surface surface = new Surface(surfaceTextureM1112m);
        ...
        PixelCopy.request(surface, bitmapCreateBitmap, new PixelCopy.OnPixelCopyFinishedListener() { // from class: org.telegram.ui.ActionBar.BottomSheetTabsOverlay$$ExternalSyntheticLambda9
            @Override // android.view.PixelCopy.OnPixelCopyFinishedListener
            public final void onPixelCopyFinished(int i) {
                BottomSheetTabsOverlay.$r8$lambda$XU58vQduemRbiaLID3mmX5TDEEs(callback, bitmapCreateBitmap, surface, surfaceTextureM1112m, i);
            }
        }, new Handler());
    }
