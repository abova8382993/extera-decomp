...
import org.telegram.p035ui.Components.FireworksEffect;
...
import org.telegram.p035ui.Components.SnowflakesEffect;
...
public class ActionBar extends FrameLayout implements FactorAnimator.Target, Theme.Colorable {
    ...
    public void setupGlass(BlurredBackgroundDrawableViewFactory blurredBackgroundDrawableViewFactory, BlurredBackgroundColorProvider blurredBackgroundColorProvider) {
        ...
        this.glassMode = true;
        this.glassDrawable = blurredBackgroundDrawableViewFactory.create(this).setColorProvider(blurredBackgroundColorProvider).setRadius(AndroidUtilities.m1036dp(23.0f)).setPadding(AndroidUtilities.m1036dp(6.0f));
        this.glassDrawableBack = blurredBackgroundDrawableViewFactory.create(this).setColorProvider(blurredBackgroundColorProvider).setRadius(AndroidUtilities.m1036dp(23.0f)).setPadding(AndroidUtilities.m1036dp(6.0f));
        this.glassDrawableMenu = blurredBackgroundDrawableViewFactory.create(this).setColorProvider(blurredBackgroundColorProvider).setRadius(AndroidUtilities.m1036dp(23.0f)).setPadding(AndroidUtilities.m1036dp(6.0f));
        ActionBarMenu actionBarMenu = this.menu;
        if (actionBarMenu != null) {
            actionBarMenu.setTranslationX(-AndroidUtilities.m1036dp(10.0f));
            this.menu.setGlassMode(true);
        }
        ActionBarMenu actionBarMenu2 = this.actionMode;
        if (actionBarMenu2 != null) {
            actionBarMenu2.setTranslationX(-AndroidUtilities.m1036dp(10.0f));
            this.actionMode.setGlassMode(true);
        }
        ImageView imageView = this.backButtonImageView;
        if (imageView != null) {
            imageView.setTranslationX(AndroidUtilities.m1036dp(2.0f));
        }
    }
    ...
    private void createBackButtonImage() {
        ...
        this.backButtonImageView.setPadding(AndroidUtilities.m1036dp(1.0f), 0, 0, 0);
        ...
        this.backButtonImageView.setContentDescription(LocaleController.getString(C2797R.string.AccDescrGoBack));
    }
            ...
            if (view == simpleTextViewArr[0] || view == simpleTextViewArr[1] || (view == this.titlesContainer && this.useContainerForTitles)) {
                ...
                if (currentHolidayDrawable != null) {
                    ...
                    if (simpleTextView != null && simpleTextView.getVisibility() == 0 && (simpleTextView.getText() instanceof String)) {
                        ...
                        int textStartY = simpleTextView.getTextStartY() + Theme.getCurrentHolidayDrawableYOffset() + ((int) Math.ceil((simpleTextView.getTextHeight() - this.rect.height()) / 2.0f)) + ((int) (AndroidUtilities.m1036dp(8.0f) * (1.0f - this.titlesContainer.getScaleY())));
    ...
    private void createTitleTextView(int i) {
        ...
        this.titleTextView[i].setDrawablePadding(AndroidUtilities.m1036dp(4.0f));
        this.titleTextView[i].setPadding(0, AndroidUtilities.m1036dp(8.0f), 0, AndroidUtilities.m1036dp(8.0f));
        this.titleTextView[i].setRightDrawableTopPadding(-AndroidUtilities.m1036dp(1.0f));
    ...
    private int getTitleLeft(boolean z) {
        ...
        if (!z) {
            ...
            return AndroidUtilities.m1036dp(AndroidUtilities.isTablet() ? 26.0f : 18.0f);
        }
        if (z2) {
            return AndroidUtilities.m1036dp(76.0f);
        }
        if (shouldUseDialogsDrawerTitleOffset()) {
            return AndroidUtilities.m1036dp(AndroidUtilities.isTablet() ? 68.0f : 56.0f);
        }
        return AndroidUtilities.m1036dp(AndroidUtilities.isTablet() ? 80.0f : 72.0f);
    }
    ...
    public Paint.FontMetricsInt getTitleFontMetricsInt() {
        ...
        if (simpleTextView == null) {
            ...
            textPaint.setTextSize(AndroidUtilities.m1036dp((AndroidUtilities.isTablet() || getResources().getConfiguration().orientation != 2) ? 20.0f : 18.0f));
    ...
    public ActionBarMenu createActionMode(boolean z, String str) {
        ...
        C29001 c29001 = new ActionBarMenu(getContext(), this) { // from class: org.telegram.ui.ActionBar.ActionBar.1
            public C29001(Context context, ActionBar this) {
                super(context, this);
            }
        ...
        this.actionMode = c29001;
        c29001.setTranslationX(this.glassMode ? -AndroidUtilities.m1036dp(10.0f) : 0.0f);
    ...
    public class C29001 extends ActionBarMenu {
        public C29001(Context context, ActionBar this) {
            super(context, this);
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C29082 extends AnimatorListenerAdapter {
        final /* synthetic */ boolean[] val$hideView;
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C29093 extends AnimatorListenerAdapter {
        public C29093() {
        }
    ...
    public void onSearchFieldVisibilityChanged(boolean z) {
        ...
        this.searchVisibleAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.ActionBar.ActionBar.4
            ...
            public C29104(ArrayList arrayList2, boolean z2, boolean zOnSearchChangedIgnoreTitles2) {
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C29104 extends AnimatorListenerAdapter {
        final /* synthetic */ boolean val$ignoreTitles;
        final /* synthetic */ ArrayList val$viewsToHide;
        final /* synthetic */ boolean val$visible;
    ...
    private int getCenterTitleRightBound(int i) {
        ...
        return i - AndroidUtilities.m1036dp(16.0f);
    }
    ...
    private int getCenteredTitleAvailableWidth(int i, int i2, boolean z) {
        ...
        int iMax = Math.max(0, i - AndroidUtilities.m1036dp(120.0f));
    ...
    private void updateCenterTitleLayoutAnimation(final int i, final int i2, boolean z) {
        ...
        this.centerTitleLayoutAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.ActionBar.ActionBar.5
            ...
            public C29115(final int i3, final int i22) {
                i = i3;
                i = i22;
            }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C29115 extends AnimatorListenerAdapter {
        private boolean cancelled;
        final /* synthetic */ int val$targetAvailableWidth;
        final /* synthetic */ int val$targetCenterTitleX;
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (imageView != null && imageView.getVisibility() != 8) {
            actionBar.backButtonImageView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(54.0f), TLObject.FLAG_30), iMakeMeasureSpec2);
        ...
        if (actionBarMenu2 != null && actionBarMenu2.getVisibility() != 8) {
            ...
            if (actionBar.menu.searchFieldVisible() && !actionBar.isSearchFieldVisible) {
                ...
                iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec((size - AndroidUtilities.m1036dp(f)) + actionBar.menu.getItemsMeasuredWidth(true), TLObject.FLAG_30);
                ...
                iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(size - AndroidUtilities.m1036dp(f), TLObject.FLAG_30);
                if (!actionBar.isMenuOffsetSuppressed) {
        ...
        while (i6 < 2) {
            ...
            if ((simpleTextView3 == null || simpleTextView3.getVisibility() == 8) && ((simpleTextView = actionBar.subtitleTextView) == null || simpleTextView.getVisibility() == 8)) {
                ...
                if (actionBar.shouldCenterTitle()) {
                    ...
                    measuredWidth = (((size - (actionBarMenu3 != null ? actionBarMenu3.getMeasuredWidth() : 0)) - AndroidUtilities.m1036dp(16.0f)) - titleLeft) - actionBar.titleRightMargin;
                }
                ...
                if (simpleTextView12 != null && simpleTextView12.getVisibility() != 8) {
                    actionBar.titleTextView[i6].measure(View.MeasureSpec.makeMeasureSpec(measuredWidth, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(24.0f) + actionBar.titleTextView[i6].getPaddingTop() + actionBar.titleTextView[i6].getPaddingBottom(), Integer.MIN_VALUE));
                    ...
                    if (z2) {
                        ...
                        actionBar.titleTextView[i6].setPivotY(AndroidUtilities.m1036dp(24.0f) >> 1);
                    } else {
                ...
                if (simpleTextView14 != null && simpleTextView14.getVisibility() != 8) {
                    actionBar.subtitleTextView.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(20.0f), Integer.MIN_VALUE));
                }
                ...
                if (simpleTextView15 != null && simpleTextView15.getVisibility() != 8) {
                    actionBar.additionalSubtitleTextView.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(20.0f), Integer.MIN_VALUE));
                }
            }
            i6++;
            i5 = i3;
        ...
        if (backupImageView != null) {
            backupImageView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(42.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(42.0f), TLObject.FLAG_30));
        }
    ...
    */
    public void onLayout(boolean r14, int r15, int r16, int r17, int r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.ActionBar.ActionBar.onLayout(boolean, int, int, int, int):void");
    }
    ...
    public void setTitleOverlayText(String str, int i, Runnable runnable) {
        ...
        if (charSequence2 == null || !charSequence2.equals(str)) {
            ...
            if (this.additionalSubTitleOverlayContainer != null) {
                this.additionalSubTitleOverlayContainer.setText(i == C2797R.string.ConnectingToProxyWithDots ? AndroidUtilities.replaceArrows(LocaleController.getString(C2797R.string.TitleSetupProxy), true, AndroidUtilities.m1036dp(2.6666667f), AndroidUtilities.m1036dp(2.0f)) : null, true);
            }
            CharSequence string = str != null ? LocaleController.getString(str, i) : this.lastTitle;
            Drawable visibleTitleRightDrawable = str == null ? getVisibleTitleRightDrawable(this.lastRightDrawable) : null;
            ...
            if ((charSequence != null && this.titleTextView[0] == null) || getMeasuredWidth() == 0 || ((simpleTextView = this.titleTextView[0]) != null && simpleTextView.getVisibility() != 0)) {
                ...
                this.titleTextView[0].setDrawablePadding(AndroidUtilities.m1036dp(4.0f));
                this.titleTextView[0].setRightDrawable(visibleTitleRightDrawable);
                ...
                if (simpleTextView2 != null) {
                    ...
                    this.titleTextView[1].setDrawablePadding(AndroidUtilities.m1036dp(4.0f));
                    ...
                    this.titleTextView[0].setTranslationY(-AndroidUtilities.m1036dp(20.0f));
                    ...
                    if (this.subtitleTextView == null) {
                        viewPropertyAnimatorAlpha.translationY(AndroidUtilities.m1036dp(20.0f));
                    } else {
    ...
    public class C29126 extends AnimatorListenerAdapter {
        public C29126() {
        }
    ...
    public void setTitleAnimated(CharSequence charSequence, boolean z, long j, Interpolator interpolator) {
        ...
        if (!z2) {
            ...
            simpleTextView2.setTranslationY(iM1036dp);
        }
        ...
        if (!z2) {
            ...
            viewPropertyAnimatorAlpha.translationY(iM1036dp2);
        }
        if (interpolator != null) {
        ...
        viewPropertyAnimatorAlpha.setDuration(j).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.ActionBar.ActionBar.7
            ...
            public C29137(boolean z22, boolean z3) {
                z = z22;
                z = z3;
            }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C29137 extends AnimatorListenerAdapter {
        final /* synthetic */ boolean val$crossfade;
        final /* synthetic */ boolean val$fromBottom;
    ...
    public void setTitleAnimatedX(CharSequence charSequence, Drawable drawable, boolean z, int i) {
        ...
        setTitle(charSequence, drawable);
        this.titleAnimationRunning = true;
        float fM1036dp = AndroidUtilities.m1036dp(10.0f) * (z ? -1 : 1);
        this.titleTextView[1].setTranslationX(0.0f);
        this.titleTextView[1].setTranslationY(0.0f);
        this.titleTextView[0].setTranslationX(-fM1036dp);
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C29148 extends AnimatorListenerAdapter {
        public C29148() {
        }
            ...
            public Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
                if (transitionValues != null && (transitionValues.view instanceof SimpleTextView)) {
                    ...
                    animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.ActionBar.ActionBar.9.1
                        ...
                        public AnonymousClass1(TransitionValues transitionValues3) {
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C29159 extends ChangeBounds {
        public C29159() {
        }
        ...
        public Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues3, TransitionValues transitionValues2) {
            if (transitionValues3 != null && (transitionValues3.view instanceof SimpleTextView)) {
                ...
                animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.ActionBar.ActionBar.9.1
                    ...
                    public AnonymousClass1(TransitionValues transitionValues32) {
    ...
    public void refreshTitlePosition(boolean z) {
        ...
        while (i < 2) {
            SimpleTextView simpleTextView7 = this.titleTextView[i];
            if (simpleTextView7 != null) {
                simpleTextView7.setGravity(titleGravity);
            }
            i++;
        }
        SimpleTextView simpleTextView8 = this.subtitleTextView;
        if (simpleTextView8 != null) {
            simpleTextView8.setGravity(subtitleGravity);
        }
        ...
        requestLayout();
        ViewTreeObserverOnPreDrawListenerC290110 viewTreeObserverOnPreDrawListenerC290110 = new ViewTreeObserver.OnPreDrawListener() { // from class: org.telegram.ui.ActionBar.ActionBar.10
            final /* synthetic */ ArrayList val$startX;
            final /* synthetic */ ArrayList val$startY;
            final /* synthetic */ ArrayList val$viewsToAnimate;

            public ViewTreeObserverOnPreDrawListenerC290110(ArrayList arrayList4, ArrayList arrayList22, ArrayList arrayList32) {
            ...
            public boolean onPreDraw() {
                ...
                for (int i4 = 0; i4 < arrayList.size(); i4++) {
                    ...
                    float f2 = top2;
                    float fFloatValue = ((Float) arrayList.get(i4)).floatValue() - left;
                    float fFloatValue2 = ((Float) arrayList.get(i4)).floatValue() - f2;
        ...
        getViewTreeObserver().addOnPreDrawListener(viewTreeObserverOnPreDrawListenerC290110);
        addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: org.telegram.ui.ActionBar.ActionBar.11
            final /* synthetic */ ViewTreeObserverOnPreDrawListenerC290110 val$listener;

            @Override // android.view.View.OnAttachStateChangeListener
            public void onViewAttachedToWindow(View view2) {
            }

            public ViewOnAttachStateChangeListenerC290211(ViewTreeObserverOnPreDrawListenerC290110 viewTreeObserverOnPreDrawListenerC2901102) {
                viewTreeObserverOnPreDrawListenerC290110 = viewTreeObserverOnPreDrawListenerC2901102;
            }

            @Override // android.view.View.OnAttachStateChangeListener
            public void onViewDetachedFromWindow(View view2) {
                ActionBar.this.getViewTreeObserver().removeOnPreDrawListener(viewTreeObserverOnPreDrawListenerC290110);
    ...
    public class ViewTreeObserverOnPreDrawListenerC290110 implements ViewTreeObserver.OnPreDrawListener {
        final /* synthetic */ ArrayList val$startX;
        final /* synthetic */ ArrayList val$startY;
        final /* synthetic */ ArrayList val$viewsToAnimate;
    ...
    public class ViewOnAttachStateChangeListenerC290211 implements View.OnAttachStateChangeListener {
        final /* synthetic */ ViewTreeObserverOnPreDrawListenerC290110 val$listener;
    ...
    public void checkAvatarContainerWidth(boolean z) {
        ...
        if (zHasVisibleAvatar) {
            visualWidth = Math.max(visualWidth, AndroidUtilities.m1036dp(192.0f));
        }
        int iMin = Math.min(getMeasuredWidth() - AndroidUtilities.m1036dp(116.0f), visualWidth);
    ...
    public void dispatchDraw(Canvas canvas) {
        float f;
        int iM1036dp = AndroidUtilities.m1036dp(6.0f);
        int iM1036dp2 = AndroidUtilities.m1036dp(46.0f);
        float actionModeFactor = getActionModeFactor();
        ActionBarMenu actionBarMenu = this.menu;
        int iMax = Math.max(0, actionBarMenu != null ? (actionBarMenu.getItemsWidth() - AndroidUtilities.m1036dp(1.0f)) - AndroidUtilities.m1036dp(1.0f) : 0);
        ActionBarMenu actionBarMenu2 = this.actionMode;
        int iLerp = this.hasForcedMenuWidth ? this.forcedMenuWidth : AndroidUtilities.lerp(iMax, Math.max(0, actionBarMenu2 != null ? (actionBarMenu2.getItemsWidth() - AndroidUtilities.m1036dp(1.0f)) - AndroidUtilities.m1036dp(1.0f) : 0), getActionModeFactor());
        ImageView imageView = this.backButtonImageView;
        boolean z = imageView != null && imageView.getVisibility() == 0;
        int height = (getHeight() - ((getCurrentActionBarHeight() + iM1036dp2) / 2)) - iM1036dp;
        int i = iM1036dp * 2;
        int i2 = height + iM1036dp2 + i;
        float f2 = this.drawGlassMiddlePill ? 1.0f : this.searchFactor;
        if (this.glassDrawable != null && f2 > 0.0f) {
            int i3 = iLerp > 0 ? iLerp + iM1036dp : 0;
            int i4 = iM1036dp + iM1036dp2;
            f = 1.0f;
            ...
            int iLerp3 = AndroidUtilities.lerp(z ? i4 : 0, i4, this.chatAvatarContainer != null ? 1.0f - this.animatorAvatarContainerHasAvatar.getFloatValue() : 0.0f);
            ...
            if (this.chatAvatarContainer != null) {
                ...
                width = iLerp3 + iLerp4;
                this.chatAvatarContainer.setTranslationX(((iLerp3 - ((ViewGroup.MarginLayoutParams) r4.getLayoutParams()).leftMargin) - this.chatAvatarContainer.getLeftPadding()) + iM1036dp + AndroidUtilities.m1036dp(3.0f));
            }
            this.glassDrawable.setBounds(iLerp3, height, width, i2);
            this.glassDrawable.setAlpha((int) (f2 * 255.0f));
            this.glassDrawable.draw(canvas);
        } else {
            f = 1.0f;
            ChatAvatarContainer chatAvatarContainer = this.chatAvatarContainer;
            if (chatAvatarContainer != null) {
                chatAvatarContainer.setTranslationX(0.0f);
            }
        }
        BlurredBackgroundDrawable blurredBackgroundDrawable = this.glassDrawableBack;
        if (blurredBackgroundDrawable != null && z) {
            blurredBackgroundDrawable.setBounds(0, height, iM1036dp2 + i, i2);
            this.glassDrawableBack.draw(canvas);
        }
        BlurredBackgroundDrawable blurredBackgroundDrawable2 = this.glassDrawableMenu;
        if (blurredBackgroundDrawable2 != null && iLerp > 0) {
            blurredBackgroundDrawable2.setBounds((getWidth() - iLerp) - i, height, getWidth(), i2);
        ...
        if (this.blurredBackground && this.actionBarColor != 0) {
            ...
            if (z2) {
                sizeNotifierFrameLayout.drawBlurRect(canvas, getY(), this.rectTmp, this.blurScrimPaint, true, f - this.onTopAnimated);
            } else {
    ...
    public void setUseContainerForTitles() {
        ...
        if (this.titlesContainer == null) {
            C290312 c290312 = new FrameLayout(getContext()) { // from class: org.telegram.ui.ActionBar.ActionBar.12
                @Override // android.widget.FrameLayout, android.view.ViewGroup, android.view.View
                public void onLayout(boolean z, int i, int i2, int i3, int i4) {
                }

                public C290312(Context context) {
                    super(context);
                }
            ...
            this.titlesContainer = c290312;
            addView(c290312);
        }
    }

    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.ActionBar$12 */
    public class C290312 extends FrameLayout {
        @Override // android.widget.FrameLayout, android.view.ViewGroup, android.view.View
        public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        }
    ...
    public class C290413 extends ActionBarAnimatedSubtitleOverlayContainer {
        public C290413(Context context, Theme.ResourcesProvider resourcesProvider, EllipsizeSpanAnimator ellipsizeSpanAnimator) {
        ...
        public void onItemChanged(ReplaceAnimator<?> replaceAnimator) {
            ...
            if (ActionBar.this.titlesContainer != null) {
                ActionBar.this.titlesContainer.setTranslationY(totalVisibility * AndroidUtilities.m1036dp(-11.0f));
            }
        }
    }
    ...
    public FrameLayout createAdditionalSubTitleOverlayContainer() {
        if (this.additionalSubTitleOverlayContainer == null) {
            C290413 c290413 = new ActionBarAnimatedSubtitleOverlayContainer(getContext(), this.resourcesProvider, this.ellipsizeSpanAnimator) { // from class: org.telegram.ui.ActionBar.ActionBar.13
                public C290413(Context context, Theme.ResourcesProvider resourcesProvider, EllipsizeSpanAnimator ellipsizeSpanAnimator) {
                    super(context, resourcesProvider, ellipsizeSpanAnimator);
                }
            ...
            this.additionalSubTitleOverlayContainer = c290413;
            c290413.setClipChildren(false);
    ...
    public void setAdaptiveBackground(final RecyclerView recyclerView, boolean z, int i, int i2) {
        ...
        Runnable runnable = new Runnable() { // from class: org.telegram.ui.ActionBar.ActionBar$$ExternalSyntheticLambda5
        ...
        recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.ActionBar.ActionBar.15
            ...
            public C290615(Runnable runnable2) {
                runnable = runnable2;
            }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C290514 extends AnimatorListenerAdapter {
        final /* synthetic */ boolean val$onTop;
    ...
    public class C290615 extends RecyclerView.OnScrollListener {
        final /* synthetic */ Runnable val$checkScroll;
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.ActionBar$16 */
    /* JADX INFO: loaded from: classes6.dex */
    public class C290716 extends AnimatorListenerAdapter {
        final /* synthetic */ boolean val$onTop;
