...
public class BottomSheet extends Dialog implements BaseFragment.AttachedSheet {
    ...
    public class ContainerView extends FrameLayout {
        ...
        public class C29841 extends AnimatorListenerAdapter {
            public C29841() {
            }
        ...
        public boolean processTouchEvent(MotionEvent motionEvent, boolean z) {
            ...
            if (BottomSheet.this.canSwipeToBack(motionEvent) || this.allowedSwipeToBack) {
                ...
                bottomSheet.onScrollUpBegin(this.f1477y);
                this.startedTrackingPointerId = motionEvent.getPointerId(0);
                this.maybeStartTracking = true;
                cancelCurrentAnimation();
                ...
                boolean zOnScrollUp = BottomSheet.this.onScrollUp(this.f1477y + y3);
                this.velocityTracker.addMovement(motionEvent);
                if (!BottomSheet.this.disableScroll && this.maybeStartTracking && !this.startedTracking && y3 > 0.0f && y3 / 3.0f > Math.abs(fAbs) && Math.abs(y3) >= BottomSheet.this.touchSlop) {
                    ...
                    float f2 = this.f1477y + y3;
                    this.f1477y = f2;
                    if (!zOnScrollUp) {
                        this.f1477y = Math.max(f2, 0.0f);
                    }
                    BottomSheet.this.containerView.setTranslationY(Math.max(this.f1477y, 0.0f));
                    BottomSheet.this.onContainerViewTranslation();
                    this.startedTrackingY = (int) motionEvent.getY();
                    BottomSheet.this.container.invalidate();
                }
                ...
                BottomSheet.this.onScrollUpEnd(this.f1477y);
                if (this.startedTracking || this.f1477y > 0.0f) {
        ...
        public class C29852 extends AnimatorListenerAdapter {
            public C29852() {
            }
        ...
        public class C29863 extends AnimatorListenerAdapter {
            public C29863() {
            }
        ...
        */
        ...
        public class C29874 extends AnimatorListenerAdapter {
            public C29874() {
            }
    ...
    public int getBottomSheetWidth(boolean z, int i, int i2) {
        return z ? i : (int) Math.max(i * 0.8f, Math.min(AndroidUtilities.m1036dp(480.0f), i));
    }
    ...
    public static class BottomSheetCell extends FrameLayout {
        ...
        public void onMeasure(int i, int i2) {
            ...
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(i4), TLObject.FLAG_30));
        }
        ...
        public void setTextAndIcon(CharSequence charSequence, int i, Drawable drawable, boolean z) {
            ...
            if (i != 0 || drawable != null) {
                ...
                if (z) {
                    textViewEmojis.setPadding(AndroidUtilities.m1036dp(LocaleController.isRTL ? 21.0f : 72.0f), 0, AndroidUtilities.m1036dp(LocaleController.isRTL ? 72.0f : 21.0f), 0);
                    this.imageView.setPadding(LocaleController.isRTL ? 0 : AndroidUtilities.m1036dp(5.0f), 0, LocaleController.isRTL ? AndroidUtilities.m1036dp(5.0f) : 5, 0);
                    return;
                } else {
                    textViewEmojis.setPadding(AndroidUtilities.m1036dp(LocaleController.isRTL ? 16.0f : 72.0f), 0, AndroidUtilities.m1036dp(LocaleController.isRTL ? 72.0f : 16.0f), 0);
                    this.imageView.setPadding(0, 0, 0, 0);
                    return;
                }
            }
            this.imageView.setVisibility(4);
            this.textView.setPadding(AndroidUtilities.m1036dp(z ? 21.0f : 16.0f), 0, AndroidUtilities.m1036dp(z ? 21.0f : 16.0f), 0);
        }

        public void setChecked(boolean z) {
            ImageView imageView = this.imageView2;
            this.checked = z;
            imageView.setImageResource(z ? C2797R.drawable.checkbig : 0);
        }
    ...
    public BottomSheet(Context context, boolean z, boolean z2, Theme.ResourcesProvider resourcesProvider) {
        ...
        C29761 c29761 = new ContainerView(getContext()) { // from class: org.telegram.ui.ActionBar.BottomSheet.1
            public C29761(Context context2) {
                super(context2);
            }
            ...
            /* JADX INFO: renamed from: org.telegram.ui.ActionBar.BottomSheet$1$1 */
        ...
        this.container = c29761;
        c29761.setClipChildren(false);
        ...
        if (i2 >= 30) {
            containerView.setSystemUiVisibility(1792);
        } else {
            containerView.setSystemUiVisibility(1280);
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C29761 extends ContainerView {
        public C29761(Context context2) {
            super(context2);
        }
    ...
    private void onCreateInternal() {
        ...
        if (this.containerView == null) {
            C29772 c29772 = new FrameLayout(getContext()) { // from class: org.telegram.ui.ActionBar.BottomSheet.2
                @Override // android.view.View
                public boolean hasOverlappingRendering() {
                    return false;
                }

                public C29772(Context context) {
                    super(context);
                }
            ...
            this.containerView = c29772;
            c29772.setBackgroundDrawable(this.shadowDrawable);
            this.containerView.setPadding(this.backgroundPaddingLeft, ((this.applyTopPadding ? AndroidUtilities.m1036dp(8.0f) : 0) + this.backgroundPaddingTop) - 1, this.backgroundPaddingLeft, this.applyBottomPadding ? AndroidUtilities.m1036dp(8.0f) : 0);
        }
        ...
        if (this.title != null) {
            C29783 c29783 = new TextView(getContext()) { // from class: org.telegram.ui.ActionBar.BottomSheet.3
                public C29783(Context context) {
                    super(context);
                }
                        ...
                        if (bottomSheet.containerView != null) {
                            for (int i4 = 1; i4 < BottomSheet.this.containerView.getChildCount(); i4++) {
                                ...
                                if (childAt instanceof BottomSheetCell) {
                                    ...
                                    measuredHeight += AndroidUtilities.m1036dp(48.0f);
                                }
                            }
                        }
                    }
            ...
            this.titleView = c29783;
            c29783.setText(this.title);
            ...
            if (z) {
                ...
                this.titleView.setPadding(AndroidUtilities.m1036dp(21.0f), AndroidUtilities.m1036dp(this.multipleLinesTitle ? 14.0f : 6.0f), AndroidUtilities.m1036dp(21.0f), AndroidUtilities.m1036dp(8.0f));
            } else {
                textView.setTextColor(getThemedColor(Theme.key_dialogTextGray2));
                this.titleView.setTextSize(1, 16.0f);
                this.titleView.setPadding(AndroidUtilities.m1036dp(16.0f), AndroidUtilities.m1036dp(this.multipleLinesTitle ? 8.0f : 0.0f), AndroidUtilities.m1036dp(16.0f), AndroidUtilities.m1036dp(8.0f));
            }
        ...
        if (view != null) {
            ...
            if (!z3) {
                ...
                ((ViewGroup.MarginLayoutParams) this.customView.getLayoutParams()).topMargin = (-this.backgroundPaddingTop) + AndroidUtilities.m1036dp(f);
            } else {
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C29772 extends FrameLayout {
        @Override // android.view.View
        public boolean hasOverlappingRendering() {
            return false;
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C29783 extends TextView {
        public C29783(Context context) {
            super(context);
        }
    ...
    public void show() {
        if (AndroidUtilities.isSafeToShow(getContext())) {
            ...
            RunnableC29794 runnableC29794 = new Runnable() { // from class: org.telegram.ui.ActionBar.BottomSheet.4
                public RunnableC29794() {
                }
            ...
            this.startAnimationRunnable = runnableC29794;
            AndroidUtilities.runOnUIThread(runnableC29794, j);
        }
    }

    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.BottomSheet$4 */
    /* JADX INFO: loaded from: classes6.dex */
    public class RunnableC29794 implements Runnable {
        public RunnableC29794() {
        }
    ...
    public void startOpenAnimation() {
        ...
        ViewGroup viewGroup = this.containerView;
        if (z) {
            viewGroup.setTranslationX(AndroidUtilities.m1036dp(48.0f));
            this.containerView.setAlpha(0.0f);
            this.containerView.setTranslationY(0.0f);
        } else {
            viewGroup.setTranslationY(getContainerViewHeight() + this.keyboardHeight + AndroidUtilities.m1036dp(10.0f) + Math.max(0, Math.min(AndroidUtilities.navigationBarHeight, getBottomInset())));
        }
        onContainerViewTranslation();
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C29805 extends AnimatorListenerAdapter {
        public C29805() {
        }
    ...
    public void dismissWithButtonClick(final int i) {
        ...
        this.currentSheetAnimation = new AnimatorSet();
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(this.containerView, (Property<ViewGroup, Float>) View.TRANSLATION_Y, getContainerViewHeight() + this.keyboardHeight + AndroidUtilities.m1036dp(10.0f) + Math.max(0, Math.min(AndroidUtilities.navigationBarHeight, getBottomInset())));
        ...
        this.currentSheetAnimation.addListener(new C29816(i));
        NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.stopAllHeavyOperations, 512);
        this.currentSheetAnimation.start();
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C29816 extends AnimatorListenerAdapter {
    ...
    */
    public void lambda$new$0() {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.ActionBar.BottomSheet.lambda$new$0():void");
    }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C29827 extends AnimatorListenerAdapter {
        public C29827() {
        }
    ...
    public int getNavigationBarColor(int i) {
        ...
        if (!attachedToParent() || (viewGroup = this.containerView) == null) {
            ...
            fClamp01 = Utilities.clamp01(1.0f - (this.containerView.getTranslationY() / (((getContainerViewHeight() + this.keyboardHeight) + AndroidUtilities.m1036dp(10.0f)) + (this.scrollNavBar ? Math.max(0, Math.min(AndroidUtilities.navigationBarHeight, getBottomInset())) : 0))));
        }
    ...
    public void setOverlayNavBarColor(int i) {
        ...
        if (this.attachedFragment != null) {
            LaunchActivity.instance.checkSystemBarColors(true, true, true);
            AndroidUtilities.setLightNavigationBar(mo7483getWindowView(), AndroidUtilities.computePerceivedBrightness(getNavigationBarColor(getThemedColor(Theme.key_windowBackgroundGray))) >= 0.721f);
        } else {
    ...
    public void registerBackCallback() {
        ...
        C29838 c29838 = new OnBackAnimationCallback() { // from class: org.telegram.ui.ActionBar.BottomSheet.8
            public C29838() {
            }
            ...
            public void onBackProgressed(BackEvent backEvent) {
                ...
                SheetBackDrawable sheetBackDrawable = BottomSheet.this.backDrawable;
                if (sheetBackDrawable != null) {
                    sheetBackDrawable.setAlpha((int) (r2.dimBehindAlpha * (1.0f - progress)));
                }
            }
            ...
            /* JADX INFO: renamed from: org.telegram.ui.ActionBar.BottomSheet$8$1 */
        ...
        this.backAnimationCallback = c29838;
        if (this.keyboardVisible) {
            return;
        }
        this.onBackInvokedDispatcher.registerOnBackInvokedCallback(DurationKt.NANOS_IN_MILLIS, c29838);
        this.isBackCallbackRegistered = true;
    }

    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.BottomSheet$8 */
    /* JADX INFO: loaded from: classes6.dex */
    public class C29838 implements OnBackAnimationCallback {
        public C29838() {
        }
    ...
    public BulletinFactory getBulletinFactory() {
        return BulletinFactory.m1142of(this.topBulletinContainer, this.resourcesProvider);
    }
}
