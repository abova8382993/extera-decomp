...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo7483getWindowView().getContext(), C2797R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView sheetViewMo7483getWindowView = sheet.mo7483getWindowView();
        this.sheetView = sheetViewMo7483getWindowView;
        C29881 c29881 = new View(getContext()) { // from class: org.telegram.ui.ActionBar.BottomSheetTabDialog.1
            public C29881(Context context) {
                super(context);
            }
