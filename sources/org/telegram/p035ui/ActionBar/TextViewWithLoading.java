...
public abstract class TextViewWithLoading extends TextView {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (f < 1.0f) {
            ...
            canvas2.translate(0.0f, AndroidUtilities.m1036dp(6.0f) * f);
        ...
        if (f > 0.0f) {
            ...
            int iM1036dp = width - ((int) (AndroidUtilities.m1036dp(6.0f) * (1.0f - f)));
            this.spinner.setAlpha((int) (f * 255.0f));
            CircularProgressDrawable circularProgressDrawable = this.spinner;
            circularProgressDrawable.setBounds(iM1036dp - (circularProgressDrawable.getIntrinsicWidth() / 2), height - (this.spinner.getIntrinsicWidth() / 2), iM1036dp + (this.spinner.getIntrinsicWidth() / 2), height + (this.spinner.getIntrinsicHeight() / 2));
