...
import com.exteragram.messenger.speech.p019ui.RecognitionModelDialogs$1$$ExternalSyntheticLambda0;
...
import org.telegram.p035ui.Components.AttachableDrawable;
...
public class AlertDialog extends Dialog implements Drawable.Callback, NotificationCenter.NotificationCenterDelegate {
    ...
    public static class AlertDialogCell extends FrameLayout {
        ...
        public AlertDialogCell(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            setPadding(AndroidUtilities.m1036dp(23.0f), 0, AndroidUtilities.m1036dp(23.0f), 0);
        ...
        public void setTextAndIcon(CharSequence charSequence, int i) {
            ...
            if (i != 0) {
                ...
                this.textView.setPadding(LocaleController.isRTL ? 0 : AndroidUtilities.m1036dp(46.0f), 0, LocaleController.isRTL ? AndroidUtilities.m1036dp(46.0f) : 0, 0);
            } else {
    ...
    public AlertDialog(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.dismissRunnable = new RecognitionModelDialogs$1$$ExternalSyntheticLambda0(this);
        ...
        if (i != 3 || this.blurredBackground) {
            Drawable drawableMutate = context.getResources().getDrawable(C2797R.drawable.popup_fixed_alert4).mutate();
    ...
    public class AlertDialogView extends LinearLayout {
        ...
        */
        ...
        public /* synthetic */ void lambda$onMeasure$0() {
            ...
            int iM1036dp2 = AndroidUtilities.displaySize.x - AndroidUtilities.m1036dp(56.0f);
            if (AndroidUtilities.isTablet()) {
                if (AndroidUtilities.isSmallTablet()) {
                    iM1036dp = AndroidUtilities.m1036dp(446.0f);
                } else {
                    iM1036dp = AndroidUtilities.m1036dp(496.0f);
                }
            } else {
                iM1036dp = AndroidUtilities.m1036dp(356.0f);
            }
            Window window = AlertDialog.this.getWindow();
            WindowManager.LayoutParams layoutParams = new WindowManager.LayoutParams();
            layoutParams.copyFrom(window.getAttributes());
            layoutParams.width = Math.min(iM1036dp, iM1036dp2) + AlertDialog.this.backgroundPaddings.left + AlertDialog.this.backgroundPaddings.right;
            try {
        ...
        public void onLayout(boolean z, int i, int i2, int i3, int i4) {
            ...
            int i5 = AlertDialog.this.progressViewStyle;
            ...
            } else if (alertDialog.contentScrollView != null) {
        ...
        public void draw(Canvas canvas) {
            ...
            if (AlertDialog.this.blurredBackground && !AlertDialog.this.blurredNativeBackground) {
                if (AlertDialog.this.progressViewStyle == 3 && AlertDialog.this.progressViewContainer != null) {
                    fM1036dp = AndroidUtilities.m1036dp(18.0f);
                    ...
                    fM1036dp = AndroidUtilities.m1036dp(20.0f);
                ...
                if (AlertDialog.this.blurPaint != null) {
                    ...
                    canvas.drawRoundRect(AndroidUtilities.rectTmp, fM1036dp, fM1036dp, AlertDialog.this.blurPaint);
                }
                ...
                canvas.drawRoundRect(rectF, fM1036dp, fM1036dp, AlertDialog.this.dimBlurPaint);
    ...
    public View inflateContent(boolean z) {
        ...
        if ((this.blurredBackground || this.progressViewStyle == 3) && this.progressViewStyle != 2) {
            ...
            this.containerView.setOutlineProvider(ViewOutlineProviderImpl.boundsWithPaddingRoundRect(AndroidUtilities.m1036dp(8.0f), AndroidUtilities.m1036dp(20.0f)));
        ...
        if (this.topResId != 0 || this.topAnimationId != 0 || this.topDrawable != null) {
            ...
            if (drawable != null) {
                ...
                if (obj instanceof AttachableDrawable) {
                    AttachableDrawable attachableDrawable = (AttachableDrawable) obj;
                    this.topImageView.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: org.telegram.ui.ActionBar.AlertDialog.1
                        final /* synthetic */ AttachableDrawable val$d;

                        public ViewOnAttachStateChangeListenerC29631(AttachableDrawable attachableDrawable2) {
                            attachableDrawable = attachableDrawable2;
                        }
                    ...
                    attachableDrawable2.setParent(this.topImageView);
                }
            } else {
                int i = this.topResId;
                if (i != 0) {
            ...
            if (this.topAnimationIsNew) {
                ...
                gradientDrawable.setCornerRadius(AndroidUtilities.m1036dp(128.0f));
                this.topImageView.setBackground(new Drawable() { // from class: org.telegram.ui.ActionBar.AlertDialog.2
                    int size;
                    final /* synthetic */ GradientDrawable val$d;

                    public C29642(GradientDrawable gradientDrawable2) {
                        gradientDrawable = gradientDrawable2;
                        this.size = AlertDialog.this.topAnimationSize + AndroidUtilities.m1036dp(52.0f);
                    }
                ...
                this.topImageView.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1036dp(10.0f), 0, this.topBackgroundColor));
            }
            boolean z3 = this.topAnimationIsNew;
            RLottieImageView rLottieImageView3 = this.topImageView;
            if (z3) {
                rLottieImageView3.setTranslationY(AndroidUtilities.m1036dp(16.0f));
            } else {
                rLottieImageView3.setTranslationY(0.0f);
            }
        ...
        if (this.title != null) {
            ...
            boolean z4 = this.topAnimationIsNew;
            frameLayout3.addView(spoilersTextView3, LayoutHelper.createFrame(-2, -2.0f, (z4 ? 1 : LocaleController.isRTL ? 5 : 3) | 48, 0.0f, 19.0f, 0.0f, z4 ? 4.0f : this.subtitle != null ? 2 : this.items != null ? 14 : 10));
        }
        ...
        if (this.progressViewStyle == 0) {
            this.shadow[0] = (BitmapDrawable) getContext().getResources().getDrawable(C2797R.drawable.header_shadow).mutate();
            this.shadow[1] = (BitmapDrawable) getContext().getResources().getDrawable(C2797R.drawable.header_shadow_reverse).mutate();
            this.shadow[0].setAlpha(0);
            this.shadow[1].setAlpha(0);
            this.shadow[0].setCallback(this);
            this.shadow[1].setCallback(this);
            C29653 c29653 = new ScrollView(getContext()) { // from class: org.telegram.ui.ActionBar.AlertDialog.3
                public C29653(Context context) {
                    super(context);
                }
            ...
            this.contentScrollView = c29653;
            c29653.setVerticalScrollBarEnabled(false);
        ...
        if (i4 == 2) {
            ...
            if (!this.blurredBackground || this.blurredNativeBackground) {
                this.progressViewContainer.setBackgroundDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m1036dp(f3), this.backgroundColor));
            }
            c2 = 2;
            ...
            radialProgressView.setSize(AndroidUtilities.m1036dp(32.0f));
        ...
        if (z2) {
            if (this.verticalButtons) {
                ...
                f4 = 24.0f;
                int iMeasureText = charSequence2 != null ? (int) (textPaint.measureText(charSequence2, 0, charSequence2.length()) + AndroidUtilities.m1036dp(24.0f) + 0.0f) : 0;
                if (this.negativeButtonText != null) {
                    if (iMeasureText > 0) {
                        iMeasureText += AndroidUtilities.m1036dp(f);
                    }
                    CharSequence charSequence3 = this.negativeButtonText;
                    f5 = 64.0f;
                    iMeasureText = (int) (iMeasureText + textPaint.measureText(charSequence3, 0, charSequence3.length()) + AndroidUtilities.m1036dp(24.0f));
                } else {
                    f5 = 64.0f;
                }
                if (this.negative2ButtonText != null) {
                    ...
                    iMeasureText = (int) (iMeasureText + textPaint.measureText(charSequence4, 0, charSequence4.length()) + AndroidUtilities.m1036dp(24.0f));
                }
                if (this.neutralButtonText != null) {
                    ...
                    iMeasureText = (int) (iMeasureText + textPaint.measureText(charSequence5, 0, charSequence5.length()) + AndroidUtilities.m1036dp(24.0f));
                }
                if (iMeasureText > AndroidUtilities.displaySize.x - AndroidUtilities.m1036dp(f5)) {
                            ...
                            if (num != null) {
                                if (num.intValue() == -1) {
                                    ...
                                    if (LocaleController.isRTL) {
                                        ...
                                        if (view6 != null) {
                                            paddingLeft += view6.getMeasuredWidth() + AndroidUtilities.m1036dp(8.0f);
                                        }
                                        childAt.layout(paddingLeft, getPaddingTop(), childAt.getMeasuredWidth() + paddingLeft, getPaddingTop() + childAt.getMeasuredHeight());
                                    } else {
                                        int paddingRight = (i10 - getPaddingRight()) - childAt.getMeasuredWidth();
                                        if (view6 != null) {
                                            paddingRight -= view6.getMeasuredWidth() + AndroidUtilities.m1036dp(8.0f);
                                        }
            ...
            if (view6 != null) {
                f6 = 6.0f;
                viewGroup.setPadding(AndroidUtilities.m1036dp(16.0f), 0, AndroidUtilities.m1036dp(16.0f), AndroidUtilities.m1036dp(4.0f));
                this.buttonsLayout.setTranslationY(-AndroidUtilities.m1036dp(6.0f));
            } else {
                f6 = 6.0f;
                viewGroup.setPadding(AndroidUtilities.m1036dp(f), AndroidUtilities.m1036dp(f), AndroidUtilities.m1036dp(f), AndroidUtilities.m1036dp(f));
            }
            this.containerView.addView(this.buttonsLayout, LayoutHelper.createLinear(-1, 52));
            if (this.topAnimationIsNew) {
                this.buttonsLayout.setTranslationY(-AndroidUtilities.m1036dp(f));
            }
            if (this.positiveButtonText != null) {
                final C29675 c29675 = new TextViewWithLoading(getContext()) { // from class: org.telegram.ui.ActionBar.AlertDialog.5
                    public C29675(Context context) {
                        super(context);
                    }
                    ...
                    @Override // org.telegram.p035ui.ActionBar.TextViewWithLoading, android.widget.TextView
                    public void setTextColor(int i6) {
                        super.setTextColor(i6);
                        setBackground(Theme.getRoundRectSelectorDrawable(AndroidUtilities.m1036dp(20.0f), i6));
                    }
                };
                c29675.setMinWidth(AndroidUtilities.m1036dp(f5));
                c29675.setTag(-1);
                c29675.setTextSize(1, 16.0f);
                c29675.setTextColor(getThemedColor(this.dialogButtonColorKey));
                c29675.setGravity(17);
                c29675.setTypeface(AndroidUtilities.bold());
                c29675.setText(this.positiveButtonText);
                f7 = 12.0f;
                c29675.setBackground(Theme.getRoundRectSelectorDrawable(AndroidUtilities.m1036dp(f2), getThemedColor(this.dialogButtonColorKey)));
                c29675.setPadding(AndroidUtilities.m1036dp(12.0f), 0, AndroidUtilities.m1036dp(12.0f), 0);
                boolean z5 = this.verticalButtons;
                ViewGroup viewGroup2 = this.buttonsLayout;
                if (z5) {
                    viewGroup2.addView(c29675, LayoutHelper.createLinear(-1, 40, 7));
                } else {
                    viewGroup2.addView(c29675, LayoutHelper.createFrame(-2, 40, 53));
                }
                c29675.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda4
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view7) {
                        this.f$0.lambda$inflateContent$4(c29675, view7);
                    }
                });
            } else {
                f7 = 12.0f;
            ...
            if (this.negativeButtonText != null) {
                final C29686 c29686 = new TextViewWithLoading(getContext()) { // from class: org.telegram.ui.ActionBar.AlertDialog.6
                    public C29686(Context context) {
                        super(context);
                    }
                ...
                c29686.setMinWidth(AndroidUtilities.m1036dp(f5));
                c29686.setTag(-2);
                c29686.setTextSize(1, 16.0f);
                c29686.setTextColor(getThemedColor(this.dialogButtonColorKey));
                c29686.setGravity(17);
                c29686.setTypeface(AndroidUtilities.bold());
                c29686.setEllipsize(TextUtils.TruncateAt.END);
                c29686.setSingleLine(true);
                c29686.setText(this.negativeButtonText.toString());
                c29686.setBackground(Theme.getRoundRectSelectorDrawable(AndroidUtilities.m1036dp(f2), getThemedColor(this.dialogButtonColorKey)));
                c29686.setPadding(AndroidUtilities.m1036dp(f7), 0, AndroidUtilities.m1036dp(f7), 0);
                boolean z6 = this.verticalButtons;
                ViewGroup viewGroup3 = this.buttonsLayout;
                if (z6) {
                    viewGroup3.addView(c29686, 0, LayoutHelper.createLinear(-1, 40, 7));
                } else {
                    viewGroup3.addView(c29686, LayoutHelper.createFrame(-2, 40, 53));
                }
                c29686.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda5
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view7) {
                        this.f$0.lambda$inflateContent$5(c29686, view7);
                    }
                });
            }
            if (this.neutralButtonText != null) {
                final C29697 c29697 = new TextViewWithLoading(getContext()) { // from class: org.telegram.ui.ActionBar.AlertDialog.7
                    public C29697(Context context) {
                        super(context);
                    }
                ...
                c29697.setMinWidth(AndroidUtilities.m1036dp(f5));
                c29697.setTag(-3);
                c29697.setTextSize(1, 16.0f);
                c29697.setTextColor(getThemedColor(this.dialogButtonColorKey));
                c29697.setGravity(17);
                c29697.setTypeface(AndroidUtilities.bold());
                c29697.setEllipsize(TextUtils.TruncateAt.END);
                c29697.setSingleLine(true);
                c29697.setText(this.neutralButtonText.toString());
                c29697.setBackground(Theme.getRoundRectSelectorDrawable(AndroidUtilities.m1036dp(f2), getThemedColor(this.dialogButtonColorKey)));
                c29697.setPadding(AndroidUtilities.m1036dp(f7), 0, AndroidUtilities.m1036dp(f7), 0);
                boolean z7 = this.verticalButtons;
                ViewGroup viewGroup4 = this.buttonsLayout;
                if (z7) {
                    viewGroup4.addView(c29697, 1, LayoutHelper.createLinear(-1, 40, 7));
                } else {
                    viewGroup4.addView(c29697, LayoutHelper.createFrame(-2, 40, 51));
                }
                c29697.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda6
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view7) {
                        this.f$0.lambda$inflateContent$6(c29697, view7);
                    }
                });
            }
            if (this.negative2ButtonText != null) {
                final C29708 c29708 = new TextViewWithLoading(getContext()) { // from class: org.telegram.ui.ActionBar.AlertDialog.8
                    public C29708(Context context) {
                        super(context);
                    }
                    ...
                    public void setTextColor(int i6) {
                        super.setTextColor(i6);
                        setBackgroundDrawable(Theme.getRoundRectSelectorDrawable(AndroidUtilities.m1036dp(6.0f), i6));
                    }
                };
                c29708.setMinWidth(AndroidUtilities.m1036dp(f5));
                c29708.setTag(-4);
                c29708.setTextSize(1, 16.0f);
                c29708.setTextColor(getThemedColor(this.dialogButtonColorKey));
                c29708.setGravity(17);
                c29708.setTypeface(AndroidUtilities.bold());
                c29708.setEllipsize(TextUtils.TruncateAt.END);
                c29708.setSingleLine(true);
                c29708.setText(this.negative2ButtonText.toString());
                c29708.setBackground(Theme.getRoundRectSelectorDrawable(AndroidUtilities.m1036dp(f6), getThemedColor(this.dialogButtonColorKey)));
                c29708.setPadding(AndroidUtilities.m1036dp(f7), 0, AndroidUtilities.m1036dp(f7), 0);
                boolean z8 = this.verticalButtons;
                ViewGroup viewGroup5 = this.buttonsLayout;
                if (z8) {
                    viewGroup5.addView(c29708, 0, LayoutHelper.createLinear(-1, 36, 7));
                } else {
                    viewGroup5.addView(c29708, LayoutHelper.createFrame(-2, 36, 53));
                }
                c29708.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda7
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view7) {
                        this.f$0.lambda$inflateContent$7(c29708, view7);
                    }
                });
            }
            if (this.verticalButtons) {
                for (int i6 = 1; i6 < this.buttonsLayout.getChildCount(); i6++) {
                    ((ViewGroup.MarginLayoutParams) this.buttonsLayout.getChildAt(i6).getLayoutParams()).topMargin = AndroidUtilities.m1036dp(f6);
                }
            }
        } else {
            f4 = 24.0f;
        ...
        if (this.needStarsBalance) {
            ...
            int iM1036dp2 = (i7 - AndroidUtilities.m1036dp(48.0f)) - (this.additioanalHorizontalPadding * 2);
            if (AndroidUtilities.isTablet()) {
                if (AndroidUtilities.isSmallTablet()) {
                    iM1036dp = AndroidUtilities.m1036dp(446.0f);
                } else {
        ...
        if (this.blurredBackground) {
            if (supportsNativeBlur()) {
                if (this.progressViewStyle == 0) {
                    ...
                    float fM1036dp = AndroidUtilities.m1036dp(f4);
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.AlertDialog$1 */
    /* JADX INFO: loaded from: classes6.dex */
    public class ViewOnAttachStateChangeListenerC29631 implements View.OnAttachStateChangeListener {
        final /* synthetic */ AttachableDrawable val$d;
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.AlertDialog$2 */
    /* JADX INFO: loaded from: classes6.dex */
    public class C29642 extends Drawable {
        int size;
        final /* synthetic */ GradientDrawable val$d;
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.AlertDialog$3 */
    /* JADX INFO: loaded from: classes6.dex */
    public class C29653 extends ScrollView {
        public C29653(Context context) {
            super(context);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.AlertDialog$4 */
    /* JADX INFO: loaded from: classes6.dex */
    public class C29664 extends FrameLayout {
        public C29664(Context context) {
            super(context);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.AlertDialog$5 */
    /* JADX INFO: loaded from: classes6.dex */
    public class C29675 extends TextViewWithLoading {
        public C29675(Context context) {
            super(context);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.AlertDialog$6 */
    /* JADX INFO: loaded from: classes6.dex */
    public class C29686 extends TextViewWithLoading {
        public C29686(Context context) {
            super(context);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.AlertDialog$7 */
    /* JADX INFO: loaded from: classes6.dex */
    public class C29697 extends TextViewWithLoading {
        public C29697(Context context) {
            super(context);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.AlertDialog$8 */
    /* JADX INFO: loaded from: classes6.dex */
    public class C29708 extends TextViewWithLoading {
        public C29708(Context context) {
            super(context);
        }
    ...
    public Browser.Progress makeButtonLoading(int i, final boolean z, boolean z2) {
        ...
        return new Browser.Progress(new Runnable() { // from class: org.telegram.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda12
            @Override // java.lang.Runnable
            public final void run() {
                AlertDialog.m6857$r8$lambda$B4fp4rFk_mbEvWTBZXG5SwPoB0(button);
            }
    ...
    /* JADX INFO: renamed from: $r8$lambda$B4fp4rFk_mbEv-WTBZXG5SwPoB0 */
    public static /* synthetic */ void m6857$r8$lambda$B4fp4rFk_mbEvWTBZXG5SwPoB0(View view) {
    ...
    public void setMessageLineSpacing(float f) {
        TextView textView = this.messageTextView;
        if (textView != null) {
            textView.setLineSpacing(AndroidUtilities.m1036dp(f), 1.0f);
        }
    }
    ...
    public void showCancelAlert() {
        if (this.canCacnel && this.cancelDialog == null) {
            ...
            builder.setNegativeButton(LocaleController.getString(C2797R.string.Stop), new OnButtonClickListener() { // from class: org.telegram.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda10
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.AlertDialog$9 */
    /* JADX INFO: loaded from: classes6.dex */
    public class C29719 extends AnimatorListenerAdapter {
        final /* synthetic */ int val$num;
    ...
    public void dismissUnless(long j) {
        ...
        if (jCurrentTimeMillis < j) {
            AndroidUtilities.runOnUIThread(new RecognitionModelDialogs$1$$ExternalSyntheticLambda0(this), jCurrentTimeMillis - j);
        } else {
            dismiss();
        }
    }
    ...
    public void dismiss() {
        ...
        if (callback != null) {
            ...
            callback.run(new RecognitionModelDialogs$1$$ExternalSyntheticLambda0(this));
            return;
        }
        if (this.dismissed) {
            return;
