...
import androidx.core.view.C0392x30864cc7;
    ...
    */
    public void startTransition(int r7, int r8, boolean r9) {
        ...
        L27:
            r1 = r2
        L28:
            org.telegram.ui.LaunchActivity r3 = org.telegram.p035ui.LaunchActivity.instance
            if (r3 == 0) goto L3d
        ...
        La7:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.ActionBar.AdjustPanLayoutHelper.startTransition(int, int, boolean):void");
    }
    ...
    public void updateTransition(float f) {
        ...
        float f2 = (int) ((this.from * f) + (this.f1476to * (1.0f - f)));
        if (applyTranslation()) {
    ...
    public AdjustPanLayoutHelper(View view, boolean z) {
        ...
        this.onPreDrawListener = new ViewTreeObserver.OnPreDrawListener() { // from class: org.telegram.ui.ActionBar.AdjustPanLayoutHelper.2
            ...
            public boolean onPreDraw() {
                ...
                if (!adjustPanLayoutHelper.heightAnimationEnabled() || Math.abs(AdjustPanLayoutHelper.this.previousHeight - height) < AndroidUtilities.m1036dp(20.0f)) {
    ...
    private void setupNewCallback() {
        ...
        view.setWindowInsetsAnimationCallback(new WindowInsetsAnimation$Callback(1) { // from class: org.telegram.ui.ActionBar.AdjustPanLayoutHelper.4
            public WindowInsets onProgress(WindowInsets windowInsets, List<WindowInsetsAnimation> list) {
                WindowInsetsAnimation windowInsetsAnimationM141m;
                if (AdjustPanLayoutHelper.this.animationInProgress && AndroidUtilities.screenRefreshRate >= 90.0f) {
                    Iterator<WindowInsetsAnimation> it = list.iterator();
                    while (true) {
                        if (!it.hasNext()) {
                            windowInsetsAnimationM141m = null;
                            break;
                        }
                        windowInsetsAnimationM141m = C0392x30864cc7.m141m(it.next());
                        if ((windowInsetsAnimationM141m.getTypeMask() & WindowInsetsCompat.Type.ime()) != 0) {
                            break;
                        }
                    }
                    if (windowInsetsAnimationM141m != null) {
                        long jElapsedRealtime = SystemClock.elapsedRealtime();
                        AdjustPanLayoutHelper adjustPanLayoutHelper = AdjustPanLayoutHelper.this;
                        if (jElapsedRealtime >= adjustPanLayoutHelper.startAfter) {
                            adjustPanLayoutHelper.usingInsetAnimator = true;
                            AdjustPanLayoutHelper.this.updateTransition(windowInsetsAnimationM141m.getInterpolatedFraction());
                        }
                    }
                }
                return windowInsets;
