...
public class ActionBarMenu extends LinearLayout {
    ...
    public void updateItemsBackgroundColor() {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childAt instanceof ActionBarMenuItem) {
                ...
                childAt.setBackgroundDrawable(Theme.createSelectorDrawable(z ? actionBar.itemsActionModeBackgroundColor : actionBar.itemsBackgroundColor));
            }
        }
    }
    ...
    public ActionBarMenuItem addItem(int i, Drawable drawable) {
        boolean z = this.isActionMode;
        ActionBar actionBar = this.parentActionBar;
        return addItem(i, 0, null, z ? actionBar.itemsActionModeBackgroundColor : actionBar.itemsBackgroundColor, drawable, AndroidUtilities.m1036dp(48.0f), null);
    }

    public ActionBarMenuItem addItem(int i, int i2) {
        boolean z = this.isActionMode;
        ActionBar actionBar = this.parentActionBar;
        return addItem(i, i2, z ? actionBar.itemsActionModeBackgroundColor : actionBar.itemsBackgroundColor, null);
    }

    public ActionBarMenuItem addItem(int i, int i2, Theme.ResourcesProvider resourcesProvider) {
        boolean z = this.isActionMode;
        ActionBar actionBar = this.parentActionBar;
        return addItem(i, i2, z ? actionBar.itemsActionModeBackgroundColor : actionBar.itemsBackgroundColor, resourcesProvider);
    }

    public ActionBarMenuItem addItem(int i, CharSequence charSequence) {
        boolean z = this.isActionMode;
        ActionBar actionBar = this.parentActionBar;
        return addItem(i, 0, charSequence, z ? actionBar.itemsActionModeBackgroundColor : actionBar.itemsBackgroundColor, null, 0, charSequence);
    }

    public ActionBarMenuItem addItem(int i, int i2, int i3, Theme.ResourcesProvider resourcesProvider) {
        return addItem(i, i2, null, i3, null, AndroidUtilities.m1036dp(48.0f), null, resourcesProvider);
    }

    public ActionBarMenuItem addItemWithWidth(int i, int i2, int i3) {
        boolean z = this.isActionMode;
        ActionBar actionBar = this.parentActionBar;
        return addItem(i, i2, null, z ? actionBar.itemsActionModeBackgroundColor : actionBar.itemsBackgroundColor, null, i3, null);
    }

    public ActionBarMenuItem addItemWithWidth(int i, Drawable drawable, int i2, CharSequence charSequence) {
        boolean z = this.isActionMode;
        ActionBar actionBar = this.parentActionBar;
        return addItem(i, 0, null, z ? actionBar.itemsActionModeBackgroundColor : actionBar.itemsBackgroundColor, drawable, i2, charSequence);
    }

    public ActionBarMenuItem addItemWithWidth(int i, int i2, int i3, CharSequence charSequence) {
        boolean z = this.isActionMode;
        ActionBar actionBar = this.parentActionBar;
        return addItem(i, i2, null, z ? actionBar.itemsActionModeBackgroundColor : actionBar.itemsBackgroundColor, null, i3, charSequence);
    }
    ...
    public LazyItem lazilyAddItem(int i, int i2, Theme.ResourcesProvider resourcesProvider) {
        boolean z = this.isActionMode;
        ActionBar actionBar = this.parentActionBar;
        return lazilyAddItem(i, i2, null, z ? actionBar.itemsActionModeBackgroundColor : actionBar.itemsBackgroundColor, null, AndroidUtilities.m1036dp(48.0f), null, resourcesProvider);
    }

    public LazyItem lazilyAddItem(int i, Drawable drawable, Theme.ResourcesProvider resourcesProvider) {
        boolean z = this.isActionMode;
        ActionBar actionBar = this.parentActionBar;
        return lazilyAddItem(i, 0, null, z ? actionBar.itemsActionModeBackgroundColor : actionBar.itemsBackgroundColor, drawable, AndroidUtilities.m1036dp(48.0f), null, resourcesProvider);
    }
    ...
    public static class LazyItem {
        ...
        public void setAllowCloseAnimation(boolean z) {
            ...
            this.allowCloseAnimation = boolValueOf;
            ActionBarMenuItem actionBarMenuItem = this.cell;
            if (actionBarMenuItem != null) {
                actionBarMenuItem.setAllowCloseAnimation(boolValueOf.booleanValue());
            }
        }
        ...
        public void add() {
            ...
            if (this.parent.ids != null) {
                int iIndexOf = this.parent.ids.indexOf(Integer.valueOf(this.f1474id));
                for (int i3 = 0; i3 < this.parent.getChildCount(); i3++) {
                    Object tag = this.parent.getChildAt(i3).getTag();
                    if (tag instanceof Integer) {
                        if (this.parent.ids.indexOf((Integer) tag) > iIndexOf) {
                            i = i3;
                            break;
                        }
                    }
            ...
            ActionBarMenuItem actionBarMenuItemAddItemAt = this.parent.addItemAt(i, this.f1474id, this.icon, this.text, this.backgroundColor, this.drawable, this.width, this.title, this.resourcesProvider);
            ...
            ArrayList<Utilities.Callback<ActionBarMenuItem>> arrayList = this.onViews;
            if (arrayList != null) {
                int size = arrayList.size();
                while (i2 < size) {
                    Utilities.Callback<ActionBarMenuItem> callback = arrayList.get(i2);
                    i2++;
                    callback.run(this.cell);
                }
                this.onViews = null;
            }
        }

        public void onView(Utilities.Callback<ActionBarMenuItem> callback) {
            ActionBarMenuItem actionBarMenuItem = this.cell;
            if (actionBarMenuItem != null) {
    ...
    public int getVisibleItemsCount() {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            View childAt = getChildAt(i2);
            if ((childAt instanceof ActionBarMenuItem) && ((ActionBarMenuItem) childAt).isVisibleForCenterTitle()) {
                i++;
            }
        }
        return i;
    ...
    public int getVisibleItemsMeasuredWidthForCenterTitle() {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            View childAt = getChildAt(i2);
            if (childAt.getVisibility() == 0 && (!(childAt instanceof ActionBarMenuItem) || ((ActionBarMenuItem) childAt).isVisibleForCenterTitle())) {
        ...
        if (this.glassMode) {
            ...
            for (int i3 = 0; i3 < childCount; i3++) {
                ...
                if (childAt instanceof ActionBarMenuItem) {
                    ...
                    if (layoutParams instanceof ViewGroup.MarginLayoutParams) {
                        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) layoutParams;
                        marginLayoutParams.leftMargin = -AndroidUtilities.m1036dp(5.0f);
                        marginLayoutParams.rightMargin = -AndroidUtilities.m1036dp(5.0f);
                    }
                }
            }
        }
    ...
    public int getItemsWidth() {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if ((childAt instanceof ActionBarMenuItem) && childAt.getVisibility() == 0) {
                ...
                x = Math.min(x, x2);
                width = Math.max(width, childAt.getWidth() + x2);
                z = true;
            }
        }
        ...
        if (view != null) {
            x = view.getX();
            width = getWidth() + AndroidUtilities.m1036dp(5.0f);
        }
        if (z) {
            return (int) (width - x);
        }
