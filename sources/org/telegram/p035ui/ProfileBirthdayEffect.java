...
import org.telegram.p035ui.ProfileBirthdayEffect;
...
public class ProfileBirthdayEffect extends View {
    ...
    public void onDraw(Canvas canvas) {
        if (this.fetcher.loaded) {
            ...
            if (this.isPlaying) {
                ...
                this.f1744t = Utilities.clamp(this.f1744t + (Utilities.clamp(jCurrentTimeMillis - this.lastTime, 20L, 0L) / 4200.0f), 1.0f, 0.0f);
                this.lastTime = jCurrentTimeMillis;
                updateSourcePoint();
                float filterWidth = EmojiAnimationsOverlay.getFilterWidth();
                float f = 2.0f;
                this.fetcher.interactionAsset.setImageCoords((getWidth() - AndroidUtilities.m1036dp(filterWidth)) / 2.0f, Math.max(0.0f, this.sourcePoint.y - (AndroidUtilities.m1036dp(filterWidth) * 0.5f)), AndroidUtilities.m1036dp(filterWidth), AndroidUtilities.m1036dp(filterWidth));
                canvas.save();
                canvas.scale(-1.0f, 1.0f, getWidth() / 2.0f, 0.0f);
                this.fetcher.interactionAsset.draw(canvas);
                this.fetcher.interactionAsset.setAlpha(1.0f - ((this.f1744t - 0.9f) / 0.1f));
                canvas.restore();
                ...
                while (size >= 0) {
                    ...
                    float f2 = size;
                    float fCascade = AndroidUtilities.cascade(this.f1744t, f2, this.fetcher.digitAssets.size(), 1.8f);
                    float f3 = iM1036dp;
                    float f4 = 0.88f * f3;
                    ...
                    float f8 = f;
                    float fPow = f6 - ((f6 + f3) * ((float) Math.pow(this.f1744t, 2.0d)));
                    float interpolation = CubicBezierInterpolator.EASE_OUT_QUINT.getInterpolation(Utilities.clamp(fCascade / 0.4f, 1.0f, 0.0f));
                    float f9 = (f3 / f8) * interpolation;
                    float f10 = f3 * interpolation;
                    imageReceiverAsset.setImageCoords(f7 - f9, fPow - f9, f10, f10);
    ...
    /* JADX INFO: renamed from: start */
    public boolean lambda$onDraw$0() {
        if (!this.fetcher.loaded || this.f1744t < 1.0f) {
            return false;
        }
    ...
    private void updateSourcePoint() {
        ...
        for (int i2 = 0; i2 < listView.getChildCount(); i2++) {
            ...
            if (i == listView.getChildAdapterPosition(childAt) && (childAt instanceof TextDetailCell)) {
                ...
                this.sourcePoint.set(listView.getX() + childAt.getX() + spoilersTextView.getX() + AndroidUtilities.m1036dp(12.0f), listView.getY() + childAt.getY() + spoilersTextView.getY() + (spoilersTextView.getMeasuredHeight() / 2.0f));
                return;
            }
        }
    }
    ...
    public static class BirthdayEffectFetcher {
        ...
        public static BirthdayEffectFetcher m1188of(int i, TLRPC.UserFull userFull, BirthdayEffectFetcher birthdayEffectFetcher) {
            ...
            int years = (userFull == null || (tL_birthday = userFull.birthday) == null || (tL_birthday.flags & 1) == 0) ? 0 : Period.between(LocalDate.m593of(tL_birthday.year, tL_birthday.month, tL_birthday.day), LocalDate.now()).getYears();
            if (birthdayEffectFetcher != null) {
        ...
        private BirthdayEffectFetcher(int i, int i2) {
            ...
            if (i2 <= 0) {
                ...
                String str = _UrlKt.FRAGMENT_ENCODE_SET + i2;
        ...
        public /* synthetic */ void lambda$new$1(HashSet hashSet, ArrayList arrayList, TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
            ...
            while (it.hasNext()) {
                ...
                if (documentFindSticker == null) {
                    FileLog.m1046e("couldn't find " + num + "️⃣ emoji in " + ProfileBirthdayEffect.numbersEmojipack);
                    return;
                }
        ...
        public /* synthetic */ void lambda$new$3(String str, TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
            ...
            if (documentFindSticker == null) {
                FileLog.m1046e("couldn't find " + str + " sticker in " + ProfileBirthdayEffect.interactionsPack);
                return;
            }
        ...
        public void detach(boolean z) {
            ...
            while (true) {
                ...
                ArrayList<ImageReceiverAsset> arrayList = this.allAssets;
                if (i < size) {
    ...
    public static class ImageReceiverAsset extends ImageReceiver {
        public /* synthetic */ ImageReceiverAsset(ProfileBirthdayEffectIA profileBirthdayEffectIA) {
            this();
        }
        ...
        /* JADX INFO: renamed from: org.telegram.ui.ProfileBirthdayEffect$ImageReceiverAsset$1 */
        public class C65371 implements ImageReceiver.ImageReceiverDelegate {
            final /* synthetic */ Runnable[] val$callback;

            public C65371(Runnable[] runnableArr) {
            ...
            public void didSetImage(ImageReceiver imageReceiver, boolean z, boolean z2, boolean z3) {
                ...
                boolean zIsGeneratingCache = lottieAnimation.isGeneratingCache();
                final Runnable[] runnableArr = this.val$callback;
                if (zIsGeneratingCache) {
                    lottieAnimation.whenCacheDone = new Runnable() { // from class: org.telegram.ui.ProfileBirthdayEffect$ImageReceiverAsset$1$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            ProfileBirthdayEffect.ImageReceiverAsset.C65371.m19433$r8$lambda$KpChqogLAmWFbTAkMrzQEJILDc(runnableArr);
                        }
                    };
                } else {
                    runnableArr[0].run();
            ...
            /* JADX INFO: renamed from: $r8$lambda$KpChqo-gLAmWFbTAkMrzQEJILDc */
            public static /* synthetic */ void m19433$r8$lambda$KpChqogLAmWFbTAkMrzQEJILDc(Runnable[] runnableArr) {
                runnableArr[0].run();
                runnableArr[0] = null;
            }
        }
        ...
        public void setEmoji(TLRPC.Document document, String str, TLRPC.TL_messages_stickerSet tL_messages_stickerSet, Runnable runnable) {
            setDelegate(new C65371(new Runnable[]{runnable}));
