...
import org.telegram.p035ui.Stories.StoryMediaAreasView;
...
public class StoryReactionWidgetView extends StoryMediaAreasView.AreaView {
    ...
    public StoryReactionWidgetView(Context context, View view, TL_stories.TL_mediaAreaSuggestedReaction tL_mediaAreaSuggestedReaction, EmojiAnimationsOverlay emojiAnimationsOverlay) {
        ...
        this.animatedTextDrawable.setTextSize(AndroidUtilities.m1036dp(18.0f));
    ...
    public void onMeasure(int i, int i2) {
        ...
        this.animatedTextDrawable.setTextSize(Math.min(AndroidUtilities.m1036dp(18.0f), getMeasuredHeight() * 0.156f));
    }
    ...
    public void customDraw(Canvas canvas) {
        ...
        this.animatedTextDrawable.setBounds(this.storyReactionWidgetBackground.getBounds().left, (int) (fHeight2 - AndroidUtilities.m1036dp(10.0f)), this.storyReactionWidgetBackground.getBounds().right, (int) (AndroidUtilities.m1036dp(10.0f) + fHeight2));
        canvas.save();
