...
public abstract class StoriesUtilities {
    ...
    public class RunnableC69621 implements Runnable {
        @Override // java.lang.Runnable
        public void run() {
            int iAbs = Math.abs(Utilities.random.nextInt() % 3);
            StoriesUtilities.debugState = iAbs;
    ...
    /* JADX WARN: Removed duplicated region for block: B:441:0x041f  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static void drawAvatarWithStory(long r25, android.graphics.Canvas r27, org.telegram.messenger.ImageReceiver r28, boolean r29, org.telegram.ui.Stories.StoriesUtilities.AvatarStoryParams r30) {
        /*
            Method dump skipped, instruction units count: 1164
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Stories.StoriesUtilities.drawAvatarWithStory(long, android.graphics.Canvas, org.telegram.messenger.ImageReceiver, boolean, org.telegram.ui.Stories.StoriesUtilities$AvatarStoryParams):void");
    }

    public static void drawLive(Canvas canvas, RectF rectF, float f, boolean z, float f2) {
        Canvas canvas2;
        if (liveText == null) {
            liveText = new Text(LocaleController.getString(C2797R.string.LiveStoryBadge), 9.66f, AndroidUtilities.bold());
        }
        ...
        float fLerp = AndroidUtilities.lerp(AndroidUtilities.m1036dp(4.66f), AndroidUtilities.m1036dp(7.0f), f2);
        float width = liveText.getWidth() + fLerp + fLerp;
        float fLerp2 = AndroidUtilities.lerp(AndroidUtilities.m1036dp(15.0f), AndroidUtilities.m1036dp(18.0f), f2);
        float fM1036dp = AndroidUtilities.m1036dp(2.0f);
        canvas.save();
        float f3 = width / 2.0f;
        float f4 = 0.8f * fLerp2;
        float f5 = fLerp2 * 0.2f;
        liveRect.set((rectF.centerX() - f3) - fM1036dp, (rectF.bottom - f4) - fM1036dp, rectF.centerX() + f3 + fM1036dp, rectF.bottom + f5 + fM1036dp);
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private static void drawSegmentsInternal(android.graphics.Canvas r20, org.telegram.p035ui.Stories.StoriesController r21, org.telegram.messenger.ImageReceiver r22, org.telegram.ui.Stories.StoriesUtilities.AvatarStoryParams r23, android.graphics.Paint r24, android.graphics.Paint r25, android.graphics.Paint r26, android.graphics.Paint r27, boolean r28) {
        /*
            Method dump skipped, instruction units count: 494
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Stories.StoriesUtilities.drawSegmentsInternal(android.graphics.Canvas, org.telegram.ui.Stories.StoriesController, org.telegram.messenger.ImageReceiver, org.telegram.ui.Stories.StoriesUtilities$AvatarStoryParams, android.graphics.Paint, android.graphics.Paint, android.graphics.Paint, android.graphics.Paint, boolean):void");
    }
    ...
    private static void drawProgress(Canvas canvas, AvatarStoryParams avatarStoryParams, View view, Paint paint) {
        ...
        view.invalidate();
        boolean z = avatarStoryParams.inc;
        float f = avatarStoryParams.globalAngle;
        if (z) {
            canvas.drawArc(rectTmp, f, avatarStoryParams.sweepAngle * 360.0f, false, paint);
            paint2 = paint;
            canvas2 = canvas;
        } else {
            canvas2 = canvas;
            paint2 = paint;
            canvas2.drawArc(rectTmp, f + 360.0f, avatarStoryParams.sweepAngle * (-360.0f), false, paint2);
        }
        for (int i = 0; i < 16; i++) {
            float f2 = (i * 22.5f) + 10.0f;
            canvas2.drawArc(rectTmp, avatarStoryParams.globalAngle + f2, ((22.5f + f2) - 10.0f) - f2, false, paint2);
        }
    }
    ...
    private static void drawCircleInternal(Canvas canvas, View view, AvatarStoryParams avatarStoryParams, Paint paint, boolean z) {
        if (z || ExteraConfig.getAvatarCorners() != 28.0f) {
            RectF rectF = forumRect;
            rectF.set(rectTmp);
            rectF.inset(AndroidUtilities.m1036dp(0.5f), AndroidUtilities.m1036dp(0.5f));
    ...
    public static void setThumbImage(AvatarDrawable avatarDrawable, ImageReceiver imageReceiver, TL_stories.StoryItem storyItem, int i, int i2) {
        ...
        if (messageMedia != null && (document = messageMedia.document) != null) {
            imageReceiver.setImage(ImageLocation.getForDocument(FileLoader.getClosestPhotoSizeWithSize(document.thumbs, AndroidUtilities.m1036dp(Math.max(i, i2)), false, null, true), storyItem.media.document), i + "_" + i2, null, null, ImageLoader.createStripedBitmap(storyItem.media.document.thumbs), 0L, null, storyItem, 0);
            return;
        }
        TLRPC.Photo photo = messageMedia != null ? messageMedia.photo : null;
        if (photo != null && (arrayList = photo.sizes) != null) {
            imageReceiver.setImage(null, null, ImageLocation.getForPhoto(FileLoader.getClosestPhotoSizeWithSize(arrayList, AndroidUtilities.m1036dp(Math.max(i, i2)), false, null, true), photo), i + "_" + i2, null, null, ImageLoader.createStripedBitmap(photo.sizes), 0L, null, storyItem, 0);
            return;
        }
        imageReceiver.clearImage();
    }
    ...
    public static CharSequence getUploadingStr(TextView textView, boolean z, boolean z2) {
        String string;
        if (z2) {
            string = LocaleController.getString(C2797R.string.StoryEditing);
        } else {
            string = LocaleController.getString(C2797R.string.UploadingStory);
        }
        if (string.indexOf("…") <= 0) {
            return string;
        }
    ...
    public static CharSequence createExpiredStoryString() {
        return createExpiredStoryString(false, C2797R.string.ExpiredStory, new Object[0]);
    }
    ...
    public static CharSequence createExpiredStoryString(boolean z, int i, Object... objArr) {
        ...
        ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C2797R.drawable.msg_mini_bomb);
        if (z) {
    ...
    public static CharSequence createReplyStoryString() {
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        spannableStringBuilder.append((CharSequence) "d ").append((CharSequence) LocaleController.getString(C2797R.string.Story));
        spannableStringBuilder.setSpan(new ColoredImageSpan(C2797R.drawable.msg_mini_replystory2), 0, 1, 0);
        return spannableStringBuilder;
    }
    ...
    public static void applyViewedUser(TL_stories.StoryItem storyItem, TLRPC.User user) {
        ...
        if (storyViews.views_count == 0) {
            ...
            storyViews.recent_viewers.add(Long.valueOf(user.f1407id));
        }
    }
    ...
    public static class EnsureStoryFileLoadedObject {
        ...
        public /* synthetic */ EnsureStoryFileLoadedObject(StoriesController storiesController, long j, StoriesUtilitiesIA storiesUtilitiesIA) {
    ...
    public static EnsureStoryFileLoadedObject ensureStoryFileLoaded(TL_stories.PeerStories peerStories, final Runnable runnable) {
        ...
        ensureStoryFileLoadedObject.runnable = new Runnable() { // from class: org.telegram.ui.Stories.StoriesUtilities$$ExternalSyntheticLambda0
            ...
            public final void run() {
                StoriesUtilities.m20850$r8$lambda$vj5KJCnxfshabut8bbOCF844fQ(ensureStoryFileLoadedObject, runnable);
            }
        };
        ...
        Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.Stories.StoriesUtilities$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                StoriesUtilities.m20849$r8$lambda$kfHW3kZyQMzq2sFs9GFKip6YvU(runnableArr, ensureStoryFileLoadedObject);
            }
        };
        AndroidUtilities.runOnUIThread(runnable2, 3000L);
        C69632 c69632 = new ImageReceiver() { // from class: org.telegram.ui.Stories.StoriesUtilities.2
            final /* synthetic */ EnsureStoryFileLoadedObject val$ensureStoryFileLoadedObject;
            final /* synthetic */ Runnable[] val$runnableRef;

            public C69632(final Runnable[] runnableArr2, final EnsureStoryFileLoadedObject ensureStoryFileLoadedObject2) {
        ...
        ensureStoryFileLoadedObject2.imageReceiver = c69632;
        c69632.setAllowLoadingOnAttachedOnly(true);
    ...
    public static /* synthetic */ void m20850$r8$lambda$vj5KJCnxfshabut8bbOCF844fQ(EnsureStoryFileLoadedObject ensureStoryFileLoadedObject, Runnable runnable) {
    ...
    public static /* synthetic */ void m20849$r8$lambda$kfHW3kZyQMzq2sFs9GFKip6YvU(Runnable[] runnableArr, EnsureStoryFileLoadedObject ensureStoryFileLoadedObject) {
        runnableArr[0] = null;
        ensureStoryFileLoadedObject.runnable.run();
    ...
    /* JADX INFO: loaded from: classes7.dex */
    public class C69632 extends ImageReceiver {
        final /* synthetic */ EnsureStoryFileLoadedObject val$ensureStoryFileLoadedObject;
        final /* synthetic */ Runnable[] val$runnableRef;
    ...
    public static class AvatarStoryParams {
        ...
        public void openStory(long j, Runnable runnable) {
            ...
            lastFragment.getOrCreateStoryViewer().open(lastFragment.getContext(), j, parent instanceof RecyclerView ? StoriesListPlaceProvider.m1210of((RecyclerListView) parent) : null);
        }
        ...
        */
        public /* synthetic */ void lambda$load$2(org.telegram.tgnet.TLObject r10, long r11, android.view.View r13, final org.telegram.ui.Stories.StoriesUtilities.AvatarStoryParams r14, org.telegram.messenger.MessagesController r15) {
            /*
                ...
                r8 = r14
                r3.<init>()
                org.telegram.p035ui.Stories.StoriesUtilities.ensureStoryFileLoaded(r10, r3)
                r9 = r0
                goto L45
            L41:
                r4 = r9
            ...
            L45:
                ...
                org.telegram.tgnet.TLRPC$User r12 = r15.getUser(r12)
                if (r12 == 0) goto L68
                r12.stories_unavailable = r1
                ...
                java.util.List r14 = java.util.Collections.singletonList(r12)
                r13.putUsersAndChats(r14, r11, r0, r1)
                r15.putUser(r12, r0)
            L68:
                if (r10 >= 0) goto L87
                long r12 = -r6
                ...
                r12.putUsersAndChats(r11, r13, r0, r1)
                r15.putChat(r10, r0)
            L87:
                if (r9 == 0) goto L99
                r5.invalidate()
                int r9 = r4.currentAccount
                org.telegram.messenger.MessagesController r9 = org.telegram.messenger.MessagesController.getInstance(r9)
                org.telegram.ui.Stories.StoriesController r9 = r9.getStoriesController()
                r9.setLoading(r6, r0)
            L99:
                return
            */
