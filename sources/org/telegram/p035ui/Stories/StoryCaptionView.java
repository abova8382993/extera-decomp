...
import org.telegram.p035ui.Components.spoilers.SpoilersClickDetector;
...
public class StoryCaptionView extends NestedScrollView implements ItemOptions.ScrimView {
    ...
    public StoryCaptionView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        setFadingEdgeLength(AndroidUtilities.m1036dp(12.0f));
    ...
    public int calculateNewContainerMarginTop(int i, int i2) {
        ...
        this.isLandscape = z;
        this.prevHeight = i2;
        storyCaptionTextView.measure(View.MeasureSpec.makeMeasureSpec(i, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(i2, Integer.MIN_VALUE));
    ...
    private void startSpringAnimationIfNotRunning(float f) {
        ...
        if (getScrollY() < AndroidUtilities.m1036dp(2.0f)) {
            collapse();
        }
    }
    ...
    public float getProgressToBlackout() {
        return Utilities.clamp((getScrollY() - this.captionTextview.getTranslationY()) / Math.min(this.prevHeight, AndroidUtilities.m1036dp(40.0f)), 1.0f, 0.0f);
    }
    ...
    public /* synthetic */ void lambda$expand$1(float f, float f2, float f3, ValueAnimator valueAnimator) {
        ...
        setScrollY((int) AndroidUtilities.lerp(f, Math.min((getMeasuredHeight() - this.blackoutBottomOffset) - AndroidUtilities.m1036dp(64.0f), this.captionContainer.getBottom() - getMeasuredHeight()), fFloatValue));
    ...
    public void drawScrim(Canvas canvas, float f) {
        ...
        float f2 = x + r1.horizontalPadding;
        float y = (this.captionTextview.getY() - getScrollY()) + this.captionContainer.getY();
        StoryCaptionTextView.TextState textState2 = this.captionTextview.state[0];
        canvas.translate(f2, ((y + r2.verticalPadding) + AndroidUtilities.lerp(textState2.collapsedTextHeight, textState2.textHeight, r2.progressToExpand)) - this.captionTextview.state[0].bottomPanel.height());
    ...
    public static class Panel {
        ...
        public static Panel from(int i, TL_stories.StoryItem storyItem) {
            ...
            if (storyItem.fwd_from != null) {
                ...
                if (peer != null) {
                    ...
                    if (peerDialogId >= 0) {
                        ...
                        panel2.title = new SpannableStringBuilder(ChatObject.isChannelAndNotMegaGroup(chat2) ? MessageObject.channelSpan() : MessageObject.groupSpan()).append((CharSequence) " ").append((CharSequence) (chat2 != null ? chat2.title : _UrlKt.FRAGMENT_ENCODE_SET));
                    }
            ...
            if (storyItem.media_areas != null) {
                ...
                if (tL_mediaAreaChannelPost != null && (chat = MessagesController.getInstance(i).getChat(Long.valueOf(tL_mediaAreaChannelPost.channel_id))) != null) {
                    panel = new Panel();
                    panel.peerId = Long.valueOf(-chat.f1245id);
        ...
        public static CharSequence musicSpan(int i) {
            ...
            if (charSequenceArr[i] == null) {
                ...
                ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C2797R.drawable.filled_widget_music);
        ...
        public int height() {
            return AndroidUtilities.m1036dp(this.small ? 22.0f : 42.0f);
        }
        ...
        public void draw(Canvas canvas, float f) {
            ...
            if (text == null) {
                ...
                this.titleLayout = new Text(charSequence2, document != null ? 12.0f : 14.0f, document != null ? null : AndroidUtilities.bold());
            }
            if (this.textLayout == null || this.updateText) {
                ...
                this.textLayout = new Text(charSequence, 14.0f);
            }
            float f2 = this.animatedSmall.set(this.small);
            this.backgroundPaint.setColor(TLObject.FLAG_30);
            int iMin = (int) Math.min(f, AndroidUtilities.lerp(AndroidUtilities.m1036dp(20.0f), AndroidUtilities.m1036dp(18.0f), f2) + Math.max(this.titleLayout.getCurrentWidth(), this.textLayout.getCurrentWidth()));
            this.width = iMin;
            int iLerp = AndroidUtilities.lerp(AndroidUtilities.m1036dp(42.0f), AndroidUtilities.m1036dp(22.0f), f2);
            float f3 = iMin;
            ...
            float fLerp = AndroidUtilities.lerp(AndroidUtilities.m1036dp(5.0f), AndroidUtilities.m1036dp(11.0f), f2);
            ...
            canvas.restore();
            canvas.save();
            canvas.clipRect(0, 0, AndroidUtilities.m1036dp(3.0f), AndroidUtilities.m1036dp(42.0f));
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(0.0f, 0.0f, AndroidUtilities.m1036dp(10.0f), AndroidUtilities.m1036dp(42.0f));
            this.linePaint.setColor(-1);
            float f4 = 1.0f - f2;
            this.linePaint.setAlpha((int) (255.0f * f4));
            canvas.drawRoundRect(rectF, AndroidUtilities.m1036dp(5.0f), AndroidUtilities.m1036dp(5.0f), this.linePaint);
            canvas.restore();
            int iM1036dp = iMin - AndroidUtilities.m1036dp(20.0f);
            if (f3 < f) {
                iM1036dp = (int) Math.min(iM1036dp + AndroidUtilities.m1036dp(12.0f), f - AndroidUtilities.m1036dp(20.0f));
            }
            float f5 = iM1036dp;
            this.titleLayout.ellipsize(f5).draw(canvas, AndroidUtilities.lerp(AndroidUtilities.m1036dp(10.0f), AndroidUtilities.m1036dp(7.0f), f2), AndroidUtilities.lerp(AndroidUtilities.m1036dp(12.0f), AndroidUtilities.m1036dp(11.0f), f2), -1, 1.0f);
            this.textLayout.ellipsize(f5).draw(canvas, AndroidUtilities.m1036dp(10.0f), AndroidUtilities.m1036dp(30.0f), -1, f4);
            canvas.restore();
        }
    }
    ...
    public class StoryCaptionTextView extends View implements TextSelectionHelper.SimpleSelectabeleView {
        ...
        public class TextState {
            ...
            public int collapsedTextHeight(int i) {
                ...
                int iHeight = panel != null ? panel.height() + AndroidUtilities.m1036dp(8.0f) : 0;
                Panel panel2 = this.bottomPanel;
                int iHeight2 = iHeight + (panel2 != null ? panel2.height() + AndroidUtilities.m1036dp(8.0f) : 0);
            ...
            public void measure(int i) {
                if (TextUtils.isEmpty(this.text)) {
                    ...
                    Panel panel = this.topPanel;
                    if (panel != null) {
                        this.textHeight = panel.height() + AndroidUtilities.m1036dp(4.0f);
                    }
                    Panel panel2 = this.bottomPanel;
                    if (panel2 != null) {
                        this.textHeight += panel2.height() + AndroidUtilities.m1036dp(4.0f);
                    }
                ...
                int iHeight = panel3 != null ? panel3.height() + AndroidUtilities.m1036dp(8.0f) : 0;
                Panel panel4 = this.bottomPanel;
                if (panel4 != null) {
                    this.textHeight += panel4.height() + AndroidUtilities.m1036dp(8.0f);
                }
                ...
                if (storyCaptionTextView3.shouldCollapse) {
                    ...
                    if (this == StoryCaptionTextView.this.state[0]) {
                        String string = LocaleController.getString(C2797R.string.ShowMore);
                        ...
                        StoryCaptionTextView.this.showMoreY = ((r9.verticalPadding + iHeight) + lineTop) - AndroidUtilities.dpf2(0.3f);
                    ...
                    int iHeight2 = lineBottom + (panel5 != null ? panel5.height() + AndroidUtilities.m1036dp(8.0f) : 0);
                    Panel panel6 = this.bottomPanel;
                    this.collapsedTextHeight = iHeight2 + (panel6 != null ? panel6.height() + AndroidUtilities.m1036dp(8.0f) : 0);
                    ...
                    if (this.spoilers.isEmpty()) {
                        for (int i3 = 3; i3 < this.fullLayout.getLineCount(); i3++) {
                            ...
                            if (TextUtils.isEmpty(charSequenceSubSequence)) {
                                ...
                                if (lineRight < StoryCaptionTextView.this.showMoreX - AndroidUtilities.m1036dp(16.0f)) {
            ...
            private void drawInternal(Canvas canvas, float f) {
                ...
                if (this.topPanel != null) {
                    ...
                    int iHeight = this.topPanel.height() + AndroidUtilities.m1036dp(8.0f);
                    canvas.restore();
                    i = iHeight;
                } else {
                    i = 0;
                        ...
                        while (true) {
                            ...
                            if (lineInfo == null) {
                                ...
                                if (f2 == f3) {
                                    ...
                                    i2 = i4;
                                    float fLerp = AndroidUtilities.lerp(f2, f3, storyCaptionTextView8.progressToExpand);
        ...
        public StoryCaptionTextView(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            this.showMorePaint.setTextSize(AndroidUtilities.m1036dp(16.0f));
            paint.setColor(-16777216);
            PorterDuff.Mode mode = PorterDuff.Mode.DST_OUT;
            paint.setXfermode(new PorterDuffXfermode(mode));
            paint2.setShader(new LinearGradient(0.0f, 0.0f, AndroidUtilities.m1036dp(16.0f), 0.0f, new int[]{0, -1}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP));
        ...
        public void onMeasure(int i, int i2) {
            int i3 = (i2 + i) << 16;
            this.horizontalPadding = AndroidUtilities.m1036dp(16.0f);
            this.verticalPadding = AndroidUtilities.m1036dp(8.0f);
        ...
        public void onDraw(Canvas canvas) {
            ...
            if (this.showMore != null) {
                ...
                canvas2.save();
                canvas2.translate(this.showMoreX - AndroidUtilities.m1036dp(32.0f), scrollY);
                canvas2.drawRect(0.0f, 0.0f, AndroidUtilities.m1036dp(32.0f), this.showMore.getHeight() + this.verticalPadding, this.xRefGradinetPaint);
                canvas2.restore();
                canvas2.drawRect(this.showMoreX - AndroidUtilities.m1036dp(16.0f), scrollY, getMeasuredWidth(), this.showMore.getHeight() + scrollY + this.verticalPadding, this.xRefPaint);
                canvas2.save();
        ...
        */
        ...
        public float getAnimatedHeight() {
            ...
            return i + AndroidUtilities.lerp(i2, textStateArr[1] != null ? r1.textHeight : 0, this.updateT);
        }
    }
}
