...
public class StoryPrivacyButton extends View {
    ...
    private void setupGradient(int i, int i2) {
        ...
        this.gradientMatrix.postTranslate(0.0f, AndroidUtilities.m1036dp(8.0f));
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.draw) {
            ...
            if (f2 > 0.0f) {
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.m1036dp(12.0f), AndroidUtilities.m1036dp(12.0f), this.backgroundPaint[1]);
            }
            if (f2 < 1.0f) {
                this.backgroundPaint[0].setAlpha((int) ((1.0f - f2) * 255.0f));
                canvas.drawRoundRect(rectF, AndroidUtilities.m1036dp(12.0f), AndroidUtilities.m1036dp(12.0f), this.backgroundPaint[0]);
            }
    ...
    public void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(60.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(40.0f), TLObject.FLAG_30));
    }

    public float getCenterX() {
        return getX() + (getWidth() / 2.0f) + (this.drawArrow ? 0 : AndroidUtilities.m1036dp(14.0f));
    }
}
