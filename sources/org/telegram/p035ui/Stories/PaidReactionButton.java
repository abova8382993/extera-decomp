...
public class PaidReactionButton extends View {
    ...
    public static class PaidReactionButtonEffectsView extends View {
        ...
        public PaidReactionButtonEffectsView(Context context, int i) {
            ...
            this.effectAssets = new int[]{C2797R.raw.star_reaction_effect1, C2797R.raw.star_reaction_effect2, C2797R.raw.star_reaction_effect3, C2797R.raw.star_reaction_effect4, C2797R.raw.star_reaction_effect5};
            this.chips = new ArrayList<>();
            this.hidden = true;
            this.currentAccount = i;
            animatedTextDrawable.setCallback(this);
            animatedTextDrawable.setHacks(false, true, true);
            animatedTextDrawable.setTextSize(AndroidUtilities.m1036dp(40.0f));
            animatedTextDrawable.setTypeface(AndroidUtilities.getTypeface("fonts/num.otf"));
            animatedTextDrawable.setShadowLayer(AndroidUtilities.m1036dp(12.0f), 0.0f, AndroidUtilities.m1036dp(3.5f), 0);
        ...
        public void dispatchDraw(Canvas canvas) {
            ...
            int iM1036dp = (int) (AndroidUtilities.m1036dp(90.0f) * fLerp);
            int i = 0;
            int i2 = 0;
            while (i2 < this.effects.size()) {
                RLottieDrawable rLottieDrawable = this.effects.get(i2);
                if (rLottieDrawable.getCurrentFrame() >= rLottieDrawable.getFramesCount()) {
                    this.effects.remove(i2);
                    i2--;
                } else {
                    float f = iM1036dp / 2.0f;
                    rLottieDrawable.setBounds((int) ((this.reactionBounds.left + (AndroidUtilities.m1036dp(15.0f) * fLerp)) - f), (int) (this.reactionBounds.centerY() - f), (int) (this.reactionBounds.left + (AndroidUtilities.m1036dp(15.0f) * fLerp) + f), (int) (this.reactionBounds.centerY() + f));
            ...
            float fM1036dp = this.reactionBounds.top - AndroidUtilities.m1036dp(1.0f);
            canvas.save();
            canvas.translate(fCenterX, fM1036dp);
            while (i < this.chips.size()) {
                if (this.chips.get(i).draw(canvas)) {
                    this.chips.get(i).detach();
                    this.chips.remove(i);
                    i--;
                }
                i++;
        ...
        public void playEffect() {
            ...
            RLottieDrawable rLottieDrawable = new RLottieDrawable(i, _UrlKt.FRAGMENT_ENCODE_SET + i, AndroidUtilities.m1036dp(70.0f), AndroidUtilities.m1036dp(70.0f));
        ...
        public void lambda$hide$2() {
            ArrayList<RLottieDrawable> arrayList = this.effects;
        ...
        public class Chip {
            ...
            public Chip(View view, int i, long j, int i2, int i3, boolean z) {
                ...
                if (z) {
                    ...
                    RLottieDrawable rLottieDrawable = new RLottieDrawable(i4, _UrlKt.FRAGMENT_ENCODE_SET + i4, AndroidUtilities.m1036dp(70.0f), AndroidUtilities.m1036dp(70.0f));
                ...
                imageReceiver.setImageCoords(AndroidUtilities.m1036dp(2.0f), AndroidUtilities.m1036dp(2.0f), AndroidUtilities.m1036dp(14.0f), AndroidUtilities.m1036dp(14.0f));
                imageReceiver.setRoundRadius(AndroidUtilities.m1036dp(7.0f));
                ...
                ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C2797R.drawable.star);
            ...
            public boolean draw(Canvas canvas) {
                ...
                float fM1036dp = AndroidUtilities.m1036dp(23.0f) + this.text.getCurrentWidth();
                float fM1036dp2 = AndroidUtilities.m1036dp(18.0f);
                ...
                canvas.translate(AndroidUtilities.m1036dp(4.0f) * ((this.randomTranslation * 2.0f) - 1.0f), 0.0f);
                canvas.rotate(((this.randomRotation * 2.0f) - 1.0f) * 1.5f);
                canvas.translate(0.0f, (-AndroidUtilities.m1036dp(200.0f)) * ((float) Math.pow(d, 0.800000011920929d)));
                canvas.translate(AndroidUtilities.m1036dp(5.0f) * fSin * ((float) Math.pow(d, 0.5d)), 0.0f);
                ...
                canvas.translate((-fM1036dp) / 2.0f, (-fM1036dp2) / 2.0f);
                float f3 = fM1036dp2 / 2.0f;
                canvas.drawRoundRect(0.0f, 0.0f, fM1036dp, fM1036dp2, f3, f3, this.backgroundPaint);
                this.imageReceiver.draw(canvas);
                this.text.draw(canvas, AndroidUtilities.m1036dp(18.0f), f3, -1, fLerp);
                canvas.restore();
                if (this.effect != null) {
                    canvas.save();
                    canvas.translate(AndroidUtilities.m1036dp(4.0f) * ((this.randomTranslation * 2.0f) - 1.0f), 0.0f);
                    canvas.rotate(((this.randomRotation * 2.0f) - 1.0f) * 1.5f);
                    canvas.translate(0.0f, (-AndroidUtilities.m1036dp(200.0f)) * ((float) Math.pow(d, 0.800000011920929d)));
                    canvas.translate(fSin * AndroidUtilities.m1036dp(5.0f) * ((float) Math.pow(d, 0.5d)), 0.0f);
                    int iM1036dp = AndroidUtilities.m1036dp(90.0f);
                    int i2 = (-iM1036dp) / 2;
                    int i3 = iM1036dp / 2;
                    this.effect.setBounds(i2, AndroidUtilities.m1036dp(8.0f) + i2, i3, AndroidUtilities.m1036dp(8.0f) + i3);
        ...
        public void removeChipsFrom(long j) {
            for (int i = 0; i < this.chips.size(); i++) {
                if (this.chips.get(i).dialogId == j) {
                    this.chips.get(i).kill();
                }
            }
        }
    }
    ...
    public PaidReactionButton(Context context, PaidReactionButtonEffectsView paidReactionButtonEffectsView, BlurredBackgroundColorProvider blurredBackgroundColorProvider) {
        ...
        this.iconDrawable = context.getResources().getDrawable(C2797R.drawable.star).mutate();
    ...
    @Override // android.view.View
    public void dispatchDraw(Canvas canvas) {
        float fM1036dp = AndroidUtilities.m1036dp(38.0f);
        float f = this.animatedFilled.set(this.filled);
        float f2 = this.animatedShowCounter.set(this.stars > 0);
        this.rect.set((getWidth() - fM1036dp) / 2.0f, (getHeight() - fM1036dp) / 2.0f, (getWidth() + fM1036dp) / 2.0f, (getHeight() + fM1036dp) / 2.0f);
        ...
        this.iconDrawable.setBounds((getWidth() - iM1036dp) / 2, (getHeight() - iM1036dp) / 2, (getWidth() + iM1036dp) / 2, (getHeight() + iM1036dp) / 2);
        ...
        if (f2 > 0.0f) {
            ...
            rectF3.set(getWidth() - fMax, 0.0f, getWidth(), AndroidUtilities.m1036dp(13.0f));
            canvas.scale(fIsNotEmpty, fIsNotEmpty, rectF3.centerX(), rectF3.centerY());
            rectF3.inset(-AndroidUtilities.m1036dp(2.0f), -AndroidUtilities.m1036dp(2.0f));
            ...
            canvas.translate(rectF3.left + ((fMax - this.countText.getCurrentWidth()) / 2.0f), AndroidUtilities.m1036dp(6.33f));
    ...
    private void ripple() {
        ...
        float f = this.accumulatedRippleIntensity;
        if (j < 100) {
            this.accumulatedRippleIntensity = f + 0.5f;
            return;
        }
        this.accumulatedRippleIntensity = f * Utilities.clamp(1.0f - (((jCurrentTimeMillis - r2) - 100) / 200.0f), 1.0f, 0.0f);
