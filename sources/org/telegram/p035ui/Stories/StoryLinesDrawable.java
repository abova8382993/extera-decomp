...
public class StoryLinesDrawable {
    ...
    public StoryLinesDrawable(View view, PeerStoriesView.SharedResources sharedResources) {
        ...
        textPaint.setShadowLayer(AndroidUtilities.m1036dp(3.0f), 0.0f, AndroidUtilities.m1036dp(1.0f), 805306368);
        StaticLayout staticLayout = new StaticLayout(LocaleController.getString(C2797R.string.StorySeekHelp), textPaint, AndroidUtilities.displaySize.x, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
    ...
    public void draw(Canvas canvas, int i, int i2, float f, int i3, float f2, float f3, boolean z, boolean z2, float f4) {
        ...
        if (i7 > 100) {
            ...
            iM1036dp = AndroidUtilities.m1036dp(2.0f);
        }
        float fM1036dp = ((i6 - AndroidUtilities.m1036dp(10.0f)) - ((i7 - 1) * iM1036dp)) / i7;
        AndroidUtilities.m1036dp(5.0f);
        float fMin = Math.min(fM1036dp / 2.0f, AndroidUtilities.m1036dp(1.0f));
        ...
        if (f8 > 0.0f) {
            ...
            z3 = z4;
            i4 = iM1036dp;
            storyLinesDrawable.zoomHintPaint.setShadowLayer(AndroidUtilities.m1036dp(3.0f), 0.0f, AndroidUtilities.m1036dp(1.0f), Theme.multAlpha(805306368, f8));
            canvas.translate(((i6 - storyLinesDrawable.zoomHintLayoutWidth) / 2.0f) - storyLinesDrawable.zoomHintLayoutLeft, AndroidUtilities.lerp(AndroidUtilities.m1036dp(4.0f), AndroidUtilities.m1036dp(16.0f), f8));
        ...
        int i8 = 0;
        while (i8 < i7) {
            float fM1036dp2 = AndroidUtilities.m1036dp(5.0f) + (-0.0f) + (i4 * i8) + (i8 * fM1036dp);
            if (fM1036dp2 <= i6) {
                float f10 = fM1036dp2 + fM1036dp;
                if (f10 >= 0.0f && f3 > 0.0f) {
                    ...
                    if (i8 > i2 || i8 != i2) {
                        ...
                        f5 = f9;
                        f6 = fMin;
                        rectF.set(fM1036dp2, 0.0f, f10, AndroidUtilities.lerp(AndroidUtilities.dpf2(2.0f), AndroidUtilities.dpf2(5.0f), (i2 == i8 ? 1 : 0) * f8));
                        if (z3) {
                            boolean z5 = storyLinesDrawable.incrementBuffering;
                            float f11 = storyLinesDrawable.bufferingProgress;
                            if (z5) {
                                float f12 = f11 + 0.026666667f;
                                storyLinesDrawable.bufferingProgress = f12;
                                if (f12 > 0.5f) {
                                    storyLinesDrawable.incrementBuffering = false;
                                }
                            } else {
                                float f13 = f11 - 0.026666667f;
                                storyLinesDrawable.bufferingProgress = f13;
                                if (f13 < -0.5f) {
                                    storyLinesDrawable.incrementBuffering = true;
                                }
                            }
                        ...
                        paint2.setAlpha(((int) (f3 * 85.0f * f2)) + i5);
                        if (f8 > 0.0f) {
                            int i9 = i8 - i2;
                            rectF.left = Utilities.clamp(AndroidUtilities.lerp(rectF.left, (i9 * i) + AndroidUtilities.m1036dp(5.0f), f8), i - AndroidUtilities.m1036dp(5.0f), AndroidUtilities.m1036dp(5.0f));
                            rectF.right = Utilities.clamp(AndroidUtilities.lerp(rectF.right, ((i9 + 1) * i) - AndroidUtilities.m1036dp(5.0f), f8), i - AndroidUtilities.m1036dp(5.0f), AndroidUtilities.m1036dp(5.0f));
                        }
                        canvas.drawRoundRect(rectF, fLerp2, fLerp2, paint2);
                        f7 = f5;
                    }
                    RectF rectF2 = AndroidUtilities.rectTmp;
                    rectF2.set(fM1036dp2, 0.0f, f10, AndroidUtilities.lerp(AndroidUtilities.dpf2(2.0f), AndroidUtilities.dpf2(5.0f), (i2 == i8 ? 1 : 0) * f8));
                    if (f8 > 0.0f) {
                        int i10 = i8 - i2;
                        rectF2.left = Utilities.clamp(AndroidUtilities.lerp(rectF2.left, (i10 * i) + AndroidUtilities.m1036dp(5.0f), f8), i - AndroidUtilities.m1036dp(5.0f), AndroidUtilities.m1036dp(5.0f));
                        rectF2.right = Utilities.clamp(AndroidUtilities.lerp(rectF2.right, ((i10 + 1) * i) - AndroidUtilities.m1036dp(5.0f), f8), i - AndroidUtilities.m1036dp(5.0f), AndroidUtilities.m1036dp(5.0f));
                    }
                    ...
                    if (i8 <= i2) {
                        ...
                        paint2.setAlpha((int) (85.0f * f3 * f2));
                        paint = paint2;
                    }
