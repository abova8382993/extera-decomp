...
public class StoriesIntro extends FrameLayout {
    ...
    public StoriesIntro(Context context, final View view) {
        ...
        linearLayout.setPadding(0, AndroidUtilities.m1036dp(48.0f), 0, AndroidUtilities.m1036dp(48.0f));
        linearLayout.setGravity(1);
        TextView textView = new TextView(context);
        textView.setTextColor(-1);
        textView.setTypeface(AndroidUtilities.bold());
        textView.setText(LocaleController.getString(C2797R.string.StoriesIntroHeader));
        textView.setTextSize(1, 20.0f);
        linearLayout.addView(textView, LayoutHelper.createLinear(-2, -2));
        final TextView textView2 = new TextView(context);
        textView2.setTextColor(-1761607681);
        textView2.setText(LocaleController.getString(C2797R.string.StoriesIntroSubHeader));
        ...
        arrayList.add(new StoriesIntroItemView(context, C2797R.raw.stories_intro_go_forward, LocaleController.getString(C2797R.string.StoriesIntroGoForwardHeader), LocaleController.getString(C2797R.string.StoriesIntroGoForwardSubHeader)));
        arrayList.add(new StoriesIntroItemView(context, C2797R.raw.stories_intro_pause, LocaleController.getString(C2797R.string.StoriesIntroPauseAndSeekHeader), LocaleController.getString(C2797R.string.StoriesIntroPauseAndSeekSubHeader)));
        arrayList.add(new StoriesIntroItemView(context, C2797R.raw.stories_intro_go_back, LocaleController.getString(C2797R.string.StoriesIntroGoBackHeader), LocaleController.getString(C2797R.string.StoriesIntroGoBackSubHeader)));
        arrayList.add(new StoriesIntroItemView(context, C2797R.raw.stories_intro_go_to_next, LocaleController.getString(C2797R.string.StoriesIntroGoToNextAuthorHeader), LocaleController.getString(C2797R.string.StoriesIntroGoToNextAuthorSubHeader)));
        int measuredWidth = view.getMeasuredWidth() - AndroidUtilities.m1036dp(100.0f);
        int size = arrayList.size();
        int i2 = 0;
        while (i2 < size) {
            StoriesIntroItemView storiesIntroItemView = arrayList.get(i2);
            i2++;
            int requiredWidth = storiesIntroItemView.getRequiredWidth();
            if (requiredWidth > measuredWidth) {
                measuredWidth = requiredWidth;
            }
        }
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(AndroidUtilities.m1036dp(8.0f) + measuredWidth > view.getMeasuredWidth() ? view.getMeasuredWidth() - AndroidUtilities.m1036dp(8.0f) : measuredWidth, AndroidUtilities.m1036dp(64.0f));
        layoutParams.setMargins(0, AndroidUtilities.m1036dp(5.0f), 0, AndroidUtilities.m1036dp(5.0f));
        ArrayList<StoriesIntroItemView> arrayList2 = this.items;
        int size2 = arrayList2.size();
        while (i < size2) {
            StoriesIntroItemView storiesIntroItemView2 = arrayList2.get(i);
            i++;
            linearLayout.addView(storiesIntroItemView2, layoutParams);
        }
        final TextView textView3 = new TextView(context);
        textView3.setTextColor(-1);
        textView3.setTypeface(AndroidUtilities.bold());
        textView3.setText(LocaleController.getString(C2797R.string.StoriesIntroDismiss));
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: org.telegram.ui.Stories.StoriesIntro.1
            ...
            public void onGlobalLayout() {
                ...
                if (iArr[1] + AndroidUtilities.m1036dp(24.0f) > view.getMeasuredHeight()) {
    ...
    public /* synthetic */ void lambda$startAnimation$1(ValueAnimator valueAnimator) {
        ...
        this.items.get(this.current).setProgress(fFloatValue);
        int i = this.prev;
        if (i != -1) {
            this.items.get(i).setProgress(1.0f - fFloatValue);
        }
    }
    ...
    public static class StoriesIntroItemView extends View {
        ...
        public StoriesIntroItemView(Context context, int i, String str, String str2) {
            ...
            this.header = str;
            this.subHeader = str2;
            RLottieDrawable rLottieDrawable = new RLottieDrawable(i, _UrlKt.FRAGMENT_ENCODE_SET + i, AndroidUtilities.m1036dp(36.0f), AndroidUtilities.m1036dp(36.0f), true, null);
        ...
        public int getRequiredWidth() {
            ...
            return AndroidUtilities.m1036dp(88.0f) + AndroidUtilities.m1036dp(8.0f) + Math.max(iWidth, this.textBounds.width());
        }
        ...
        public void onMeasure(int i, int i2) {
            ...
            this.lottieDrawable.setBounds(i4, i5, i4 + iM1036dp2, iM1036dp2 + i5);
        }
        ...
        public void onDraw(Canvas canvas) {
            ...
            int iM1036dp = AndroidUtilities.m1036dp(40.0f);
            int measuredHeight = getMeasuredHeight() / 2;
            int iM1036dp2 = (int) (AndroidUtilities.m1036dp(36.0f) + (AndroidUtilities.m1036dp(8.0f) * this.progress));
            int i = iM1036dp2 / 2;
            int i2 = iM1036dp - i;
            int i3 = measuredHeight - i;
            this.lottieDrawable.setBounds(i2, i3, i2 + iM1036dp2, iM1036dp2 + i3);
