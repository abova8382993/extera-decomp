...
public class StoryWidgetsImageDecorator extends ImageReceiver.Decorator {
    ...
    public void onDraw(Canvas canvas, ImageReceiver imageReceiver) {
        if (this.drawingObjects == null) {
            return;
        }
    ...
    public class ReactionWidget extends DrawingObject {
        ...
        public void draw(Canvas canvas, ImageReceiver imageReceiver, float f) {
            if (this.imageHolder.isLoaded()) {
                ...
                float f3 = (float) (d + ((((double) f2) * mediaAreaCoordinates.f1451x) / 100.0d));
                double d2 = storyWidgetsImageDecorator.imageY;
                float f4 = storyWidgetsImageDecorator.imageH;
                float f5 = (float) (d2 + ((((double) f4) * mediaAreaCoordinates.f1452y) / 100.0d));
                float f6 = ((float) ((((double) f2) * mediaAreaCoordinates.f1450w) / 100.0d)) / 2.0f;
                float f7 = ((float) ((((double) f4) * mediaAreaCoordinates.f1449h) / 100.0d)) / 2.0f;
    ...
    public class WeatherWidget extends DrawingObject {
        ...
        public void draw(Canvas canvas, ImageReceiver imageReceiver, float f) {
            ...
            float f4 = storyWidgetsImageDecorator.imageH;
            float f5 = (float) (d2 + ((((double) f4) * mediaAreaCoordinates.f1452y) / 100.0d));
            float f6 = (float) ((((double) f2) * mediaAreaCoordinates.f1450w) / 100.0d);
            float f7 = (float) ((((double) f4) * mediaAreaCoordinates.f1449h) / 100.0d);
            canvas.save();
        ...
        public void onAttachedToWindow(boolean z) {
            ...
            if (z) {
                locationMarker.attachInternal();
            } else {
                locationMarker.detachInternal();
            }
        }
