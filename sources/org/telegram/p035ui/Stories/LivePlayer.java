...
public class LivePlayer implements NotificationCenter.NotificationCenterDelegate, AudioManager.OnAudioFocusChangeListener {
    ...
    private final HashMap<String, Integer> currentStreamRequestTimestamp;
    ...
    private final HashSet<Integer> srcs;
    ...
    public static /* synthetic */ void m20485$r8$lambda$Zf53pjibKnjUHxoDqBPPYdZKM(int[] iArr, float[] fArr, boolean[] zArr) {
    }
    ...
    public void continueStreaming() {
        ...
        PermissionRequest.ensureAllPermissions(C2797R.raw.permission_request_camera, C2797R.string.PermissionNoCameraMicVideo, new String[]{"android.permission.CAMERA", "android.permission.RECORD_AUDIO"}, new Utilities.Callback() { // from class: org.telegram.ui.Stories.LivePlayer$$ExternalSyntheticLambda9
    ...
    public /* synthetic */ void lambda$continueStreaming$0(Boolean bool) {
        if (bool.booleanValue() && !this.destroyed) {
            ...
            configureAudio();
            init();
            NotificationCenter.getInstance(this.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.liveStoryUpdated, Long.valueOf(this.inputCall.f1267id));
        }
    }
    ...
    public LivePlayer(Context context, int i, TL_stories.StoryItem storyItem, long j, int i2, boolean z, TLRPC.InputGroupCall inputGroupCall, boolean z2, boolean z3) {
        ...
        this.outgoing = z2;
        this.isFront = z3;
        this.instanceSink = new C68761();
        FileLog.m1045d("[LivePlayer] setup to call " + inputGroupCall.f1267id);
    ...
    public class C68761 extends VoIPService.ProxyVideoSink {
        public C68761() {
        }
    ...
    private void init() {
        ...
        NativeInstance nativeInstanceMakeGroup = NativeInstance.makeGroup(VoIPHelper.getLogFilePath("live_" + this.inputCall.f1267id), 0L, false, SharedConfig.noiseSupression, new NativeInstance.PayloadCallback() { // from class: org.telegram.ui.Stories.LivePlayer$$ExternalSyntheticLambda2
            ...
            public final void run(int[] iArr, float[] fArr, boolean[] zArr) {
                LivePlayer.m20485$r8$lambda$Zf53pjibKnjUHxoDqBPPYdZKM(iArr, fArr, zArr);
            }
        ...
        nativeInstanceMakeGroup.setOnStateUpdatedListener(new C68772());
    ...
    public /* synthetic */ void lambda$init$9(final TLObject tLObject, TLRPC.TL_error tL_error) {
        if (tLObject instanceof TLRPC.Updates) {
            ...
            while (i2 < size) {
                ...
                i2++;
                this.call = ((TL_update.TL_updateGroupCall) obj).call;
            }
            ...
            while (i3 < size2) {
                ...
                if (tL_updateGroupCallParticipants.call.f1267id == getCallId() && !z) {
                    int i4 = 0;
                    while (true) {
                        if (i4 >= tL_updateGroupCallParticipants.participants.size()) {
                            break;
                        }
                        if (DialogObject.getPeerDialogId(tL_updateGroupCallParticipants.participants.get(i4).peer) == this.dialogId) {
                            this.participant = tL_updateGroupCallParticipants.participants.get(i4);
                            break;
                        }
                        i4++;
                    }
            ...
            FileLog.m1045d("[LivePlayer] joined call " + this.inputCall.f1267id);
            this.joined = true;
    ...
    public /* synthetic */ void lambda$init$1(ArrayList arrayList) {
        ...
        while (i < size) {
            ...
            NotificationCenter.getInstance(this.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.liveStoryMessageUpdate, Long.valueOf(tL_updateGroupCallMessage.call.f1267id), tL_updateGroupCallMessage, Boolean.TRUE);
        }
    }
    ...
    public /* synthetic */ void lambda$init$8() {
        NotificationCenter.getInstance(this.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.liveStoryUpdated, Long.valueOf(this.call.f1260id));
        setPolling(true);
    }
    ...
    public /* synthetic */ void lambda$init$16(final String str, long j, long j2, long j3, int i, int i2, TLObject tLObject, TLRPC.TL_error tL_error, long j4) {
        ...
        if (tLObject != null) {
            ...
            StringBuilder sb = new StringBuilder("[LivePlayer] received in ");
    ...
    public /* synthetic */ void lambda$init$20(final long j, long j2, final int i, final int i2) {
        StringBuilder sb = new StringBuilder("[LivePlayer] cancelling getFile time_ms=");
        sb.append(j);
    ...
    /* JADX INFO: loaded from: classes7.dex */
    public class C68772 implements Instance.OnStateUpdatedListener {
        public C68772() {
        }
        ...
        public void onStateUpdated(int i, boolean z) {
            ...
            FileLog.m1045d("[LivePlayer] connectionState = " + i);
    ...
    public void setVolume(float f) {
        ...
        FileLog.m1045d("setVolume(" + fClamp01 + ")");
    ...
    private void updateVolumes() {
        ...
        Iterator<Integer> it = this.srcs.iterator();
        while (it.hasNext()) {
            this.instance.setVolume(it.next().intValue(), this.volume);
        }
    }
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        if (i == NotificationCenter.storyGroupCallUpdated) {
            ...
            if (this.dialogId == jLongValue) {
                ...
                NotificationCenter.getInstance(this.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.liveStoryUpdated, Long.valueOf(groupCall.f1260id));
            }
        }
    }
    ...
    public void storyDeleted() {
        ...
        tL_storyItemDeleted.f1454id = this.storyId;
    ...
    public boolean equals(TLRPC.InputGroupCall inputGroupCall) {
        ...
        return inputGroupCall2 == inputGroupCall || inputGroupCall2.f1267id == inputGroupCall.f1267id;
    }
    ...
    public void destroy() {
        ...
        FileLog.m1045d("[LivePlayer] destroyed");
        if (this.joined) {
            TL_phone.leaveGroupCall leavegroupcall = new TL_phone.leaveGroupCall();
            leavegroupcall.call = this.inputCall;
    ...
    public /* synthetic */ void lambda$poll$32(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (tLObject instanceof Vector) {
            ...
            if ("GROUPCALL_JOIN_MISSING".equals(tL_error.text)) {
                FileLog.m1045d("[LivePlayer] received GROUPCALL_JOIN_MISSING on checkGroupCall => rejoining");
    ...
    public boolean isAdmin(int i) {
        ...
        if (j >= 0) {
            return UserConfig.getInstance(i2).getClientUserId() == this.dialogId;
        }
        return ChatObject.canUserDoAction(MessagesController.getInstance(i2).getChat(Long.valueOf(-this.dialogId)), i);
    }
