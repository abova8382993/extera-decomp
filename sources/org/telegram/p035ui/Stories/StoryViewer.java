...
public class StoryViewer implements NotificationCenter.NotificationCenterDelegate, BaseFragment.AttachedSheet, IPipSourceDelegate {
    ...
    public void open(Context context, TL_stories.StoryItem storyItem, ArrayList<Long> arrayList, int i, StoriesController.StoriesList storiesList, TL_stories.PeerStories peerStories, PlaceProvider placeProvider, boolean z) {
        open(UserConfig.selectedAccount, context, storyItem, arrayList, i, storiesList, peerStories, placeProvider, z);
    }

    public void open(int i, Context context, TL_stories.StoryItem storyItem, ArrayList<Long> arrayList, int i2, StoriesController.StoriesList storiesList, TL_stories.PeerStories peerStories, PlaceProvider placeProvider, boolean z) {
        ...
        if (this.windowView == null) {
            this.gestureDetector = new GestureDetector(new GestureDetector.OnGestureListener() { // from class: org.telegram.ui.Stories.StoryViewer.1
                ...
                public GestureDetectorOnGestureListenerC69831() {
                }
                ...
                */
                public boolean onScroll(android.view.MotionEvent r4, android.view.MotionEvent r5, float r6, float r7) {
                    ...
                    */
                    throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Stories.StoryViewer.GestureDetectorOnGestureListenerC69831.onScroll(android.view.MotionEvent, android.view.MotionEvent, float, float):boolean");
                }
        ...
        if (this.containerView == null) {
            this.containerView = new HwFrameLayout(context) { // from class: org.telegram.ui.Stories.StoryViewer.3
                ...
                public void onMeasure(int i4, int i5) {
                    ...
                    StoryViewer storyViewer2 = StoryViewer.this;
                    if (size > i6) {
                        storyViewer2.storiesViewPager.getLayoutParams().width = -1;
                        size = i6;
                    } else {
                        int i7 = (int) ((size / 16.0f) * 9.0f);
                        storyViewer2.storiesViewPager.getLayoutParams().width = i7;
                        size2 = i7;
                    }
                ...
                public void dispatchDraw(Canvas canvas) {
                    ...
                    if (currentPeerView != null) {
                        StoryViewer.this.volumeControl.setTranslationY(((currentPeerView.getY() + currentPeerView.storyContainer.getY()) - StoryViewer.this.volumeControl.getTop()) - AndroidUtilities.m1036dp(4.0f));
                    }
                    super.dispatchDraw(canvas);
                }
            };
            C69874 c69874 = new HwStoriesViewPager(this.currentAccount, context2, this, this.resourcesProvider) { // from class: org.telegram.ui.Stories.StoryViewer.4
                public C69874(int i4, Context context2, final StoryViewer this, Theme.ResourcesProvider resourcesProvider) {
                    super(i4, context2, this, resourcesProvider);
                }

                @Override // org.telegram.p035ui.Stories.StoriesViewPager
            ...
            this.storiesViewPager = c69874;
            c69874.setDelegate(new C69885(storiesList, arrayList, context2));
            this.containerView.addView(this.storiesViewPager, LayoutHelper.createFrame(-1, -1, 1));
            this.aspectRatioFrameLayout = new AspectRatioFrameLayout(context2);
            if (this.USE_SURFACE_VIEW) {
                ...
                C69896 c69896 = new HwTextureView(context2) { // from class: org.telegram.ui.Stories.StoryViewer.6
                    public C69896(Context context2) {
                        super(context2);
                    }

                    @Override // org.telegram.p035ui.Stories.HwTextureView, android.view.View
                ...
                this.textureView = c69896;
                this.aspectRatioFrameLayout.addView(c69896);
            }
            ...
            StoriesVolumeControl storiesVolumeControl = new StoriesVolumeControl(context2);
        ...
        StoriesViewPager storiesViewPager2 = this.storiesViewPager;
        if (storiesList != null) {
            storiesViewPager2.setDays(storiesList.dialogId, storiesList.getDays(), this.currentAccount);
        } else {
            storiesViewPager2.setPeerIds(arrayList, this.currentAccount, i2);
        }
        ...
        boolean z3 = this.ATTACH_TO_FRAGMENT;
        ...
        if (z3) {
            ...
            sizeNotifierFrameLayout.setFocusable(false);
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Stories.StoryViewer$1 */
    /* JADX INFO: loaded from: classes7.dex */
    public class GestureDetectorOnGestureListenerC69831 implements GestureDetector.OnGestureListener {
        @Override // android.view.GestureDetector.OnGestureListener
        public void onLongPress(MotionEvent motionEvent) {
        }
    ...
    /* JADX INFO: loaded from: classes7.dex */
    public class C69852 extends SizeNotifierFrameLayout {
        float lastTouchX;
        ...
        public C69852(Context context, BaseFragment baseFragment) {
            super(context);
        ...
        /* JADX WARN: Removed duplicated region for block: B:375:0x0638 A[LOOP:1: B:363:0x0604->B:375:0x0638, LOOP_END] */
        /* JADX WARN: Removed duplicated region for block: B:467:0x0640 A[EDGE_INSN: B:467:0x0640->B:376:0x0640 BREAK  A[LOOP:1: B:363:0x0604->B:375:0x0638], SYNTHETIC] */
        ...
        */
        public void dispatchDraw(android.graphics.Canvas r21) {
            /*
                ...
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Stories.StoryViewer.C69852.dispatchDraw(android.graphics.Canvas):void");
        }
        ...
        */
        public boolean dispatchTouchEvent(android.view.MotionEvent r19) {
            /*
                ...
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Stories.StoryViewer.C69852.dispatchTouchEvent(android.view.MotionEvent):boolean");
        }
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Stories.StoryViewer$2$1 */
        public class AnonymousClass1 extends AnimatorListenerAdapter {
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                storyViewer.updateProgressToDismiss();
            }
        }

        /* JADX WARN: Removed duplicated region for block: B:196:0x003e  */
        ...
        */
        public boolean onInterceptTouchEvent(android.view.MotionEvent r15) {
            /*
                ...
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Stories.StoryViewer.C69852.onInterceptTouchEvent(android.view.MotionEvent):boolean");
        }
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Stories.StoryViewer$2$2 */
        ...
        public void onAttachedToWindow() {
            ...
            Bulletin.addDelegate(this, new Bulletin.Delegate() { // from class: org.telegram.ui.Stories.StoryViewer.2.3
                ...
                public int getBottomOffset(int i) {
                    ...
                    return (int) (C69852.this.getMeasuredHeight() - (this.position[1] + currentPeerView.storyContainer.getMeasuredHeight()));
                }
            });
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Stories.StoryViewer$2$3 */
        public class AnonymousClass3 implements Bulletin.Delegate {
            float[] position = new float[2];
        ...
        public void onMeasure(int i, int i2) {
            ((FrameLayout.LayoutParams) StoryViewer.this.volumeControl.getLayoutParams()).topMargin = AndroidUtilities.statusBarHeight - AndroidUtilities.m1036dp(2.0f);
            StoryViewer.this.volumeControl.getLayoutParams().height = AndroidUtilities.m1036dp(2.0f);
            super.onMeasure(i, i2);
        }
    }

    /* JADX INFO: renamed from: org.telegram.ui.Stories.StoryViewer$3 */
    /* JADX INFO: loaded from: classes7.dex */
    public class C69863 extends HwFrameLayout {
        public C69863(Context context2) {
            super(context2);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Stories.StoryViewer$4 */
    /* JADX INFO: loaded from: classes7.dex */
    public class C69874 extends HwStoriesViewPager {
        public C69874(int i4, Context context2, final StoryViewer this, Theme.ResourcesProvider resourcesProvider) {
            super(i4, context2, this, resourcesProvider);
        }
    ...
    /* JADX INFO: loaded from: classes7.dex */
    public class C69885 implements PeerStoriesView.Delegate {
        final /* synthetic */ Context val$context;
        final /* synthetic */ ArrayList val$peerIds;
        final /* synthetic */ StoriesController.StoriesList val$storiesList;

        public C69885(StoriesController.StoriesList storiesList, ArrayList arrayList, Context context) {
        ...
        public void switchToNextAndRemoveCurrentPeer() {
            if (this.val$storiesList != null) {
                ...
                if (iIndexOf >= 0) {
                    ...
                    boolean zSwitchToNext = StoryViewer.this.storiesViewPager.switchToNext(true);
                    StoryViewer storyViewer = StoryViewer.this;
                    if (!zSwitchToNext) {
            ...
            if (iIndexOf2 >= 0) {
                ...
                boolean zSwitchToNext2 = StoryViewer.this.storiesViewPager.switchToNext(true);
                StoryViewer storyViewer2 = StoryViewer.this;
                if (!zSwitchToNext2) {
                    storyViewer2.close(false);
                    return;
                } else {
                    storyViewer2.storiesViewPager.onNextIdle(new Runnable() { // from class: org.telegram.ui.Stories.StoryViewer$5$$ExternalSyntheticLambda2
                        @Override // java.lang.Runnable
                        public final void run() {
        ...
        public void requestPlayer(TLRPC.Document document, Uri uri, long j, PeerStoriesView.VideoPlayerSharedScope videoPlayerSharedScope) {
                ...
                if (storyViewer2.progressToOpen >= 0.9f) {
                    ...
                    if (!zEquals || (videoPlayerHolder = (storyViewer = StoryViewer.this).playerHolder) == null) {
                        ...
                        if (uri != null) {
                            ...
                            FileLog.m1045d("StoryViewer requestPlayer: currentPlayerScope.player start " + uri);
                            ...
                            FileLog.m1045d("StoryViewer requestPlayer: url is null (1)");
                        }
                    } else if (zEquals) {
                        ...
                        FileLog.m1045d("StoryViewer requestPlayer: same url");
                    }
            ...
            FileLog.m1045d("StoryViewer requestPlayer ignored, because closed: " + StoryViewer.this.isClosed + ", " + StoryViewer.this.progressToOpen);
            videoPlayerSharedScope.firstFrameRendered = false;
        ...
        public void preparePlayer(ArrayList<TLRPC.Document> arrayList, ArrayList<Uri> arrayList2) {
            if (SharedConfig.deviceIsHigh() && SharedConfig.allowPreparingHevcPlayers() && !StoryViewer.this.isClosed) {
                ...
                for (int i3 = 0; i3 < arrayList2.size(); i3++) {
                    ...
                    TLRPC.Document document = arrayList.get(i3);
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Stories.StoryViewer$6 */
    /* JADX INFO: loaded from: classes7.dex */
    public class C69896 extends HwTextureView {
        public C69896(Context context2) {
            super(context2);
        }
    ...
    public void cancelSwipeToViews(boolean z) {
        ...
        if (this.allowSelfStoriesView || this.selfStoriesViewsOffset != 0.0f) {
            ...
            ValueAnimator valueAnimator = this.swipeToViewsAnimator;
            if (z2) {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Stories.StoryViewer$7 */
    /* JADX INFO: loaded from: classes7.dex */
    public class C69907 extends AnimatorListenerAdapter {
        final /* synthetic */ boolean val$open;
    ...
    public /* synthetic */ void lambda$cancelSwipeToReply$6(ValueAnimator valueAnimator) {
        ...
        this.swipeToReplyProgress = Utilities.clamp(this.swipeToReplyOffset / AndroidUtilities.m1036dp(200.0f), 1.0f, 0.0f);
        StoriesViewPager storiesViewPager = this.storiesViewPager;
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Stories.StoryViewer$8 */
    /* JADX INFO: loaded from: classes7.dex */
    public class C69918 extends AnimatorListenerAdapter {
        public C69918() {
        }
    ...
    public void layoutAndFindView() {
        ...
        if (this.placeProvider != null) {
            ...
            if (this.storiesList instanceof StoriesController.StoryRepostsList) {
                ...
                TL_stories.StoryItem storyItem = (currentPeerView2 == null || selectedPosition2 < 0 || selectedPosition2 >= currentPeerView2.storyItems.size()) ? null : currentPeerView2.storyItems.get(selectedPosition2);
                if (storyItem != null) {
    ...
    private void updateTransitionParams() {
        if (this.placeProvider != null) {
            ...
            int i = (currentPeerView == null || selectedPosition < 0 || selectedPosition >= currentPeerView.storyItems.size()) ? 0 : currentPeerView.storyItems.get(selectedPosition).f1454id;
            TL_stories.StoryItem storyItem = (currentPeerView == null || selectedPosition < 0 || selectedPosition >= currentPeerView.storyItems.size()) ? null : currentPeerView.storyItems.get(selectedPosition);
    ...
    public void requestAdjust(boolean z) {
        if (this.ATTACH_TO_FRAGMENT) {
            ...
            if (z) {
                AndroidUtilities.requestAdjustNothing(baseFragment.getParentActivity(), this.fragment.getClassGuid());
                return;
            } else {
                AndroidUtilities.requestAdjustResize(baseFragment.getParentActivity(), this.fragment.getClassGuid());
                return;
            }
        }
    ...
    public void updateProgressToDismiss() {
        float fClamp01 = Utilities.clamp01(Math.abs(Math.max(this.swipeToDismissHorizontalOffset, this.swipeToDismissOffset) / AndroidUtilities.m1036dp(80.0f)));
    ...
    public void startOpenAnimation() {
        ...
        this.openCloseAnimator.addListener(new C69929());
        ...
        while (true) {
            int size = this.doOnAnimationReadyRunnables.size();
            ArrayList<Runnable> arrayList = this.doOnAnimationReadyRunnables;
            if (i < size) {
                arrayList.get(i).run();
                i++;
            } else {
    ...
    /* JADX INFO: loaded from: classes7.dex */
    public class C69929 extends AnimatorListenerAdapter {
        public C69929() {
        }
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Stories.StoryViewer$9$1 */
        public class AnonymousClass1 extends AnimatorListenerAdapter {
            public AnonymousClass1() {
            }
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Stories.StoryViewer$9$2 */
        public class AnonymousClass2 extends AnimatorListenerAdapter {
            public AnonymousClass2() {
            }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Stories.StoryViewer$10 */
    /* JADX INFO: loaded from: classes7.dex */
    public class C698410 extends AnimatorListenerAdapter {
        public C698410() {
        }
    ...
    public void release() {
        ArrayList<VideoPlayerHolder> arrayList;
        this.lastUri = null;
        ...
        int i = 0;
        while (true) {
            int size = this.preparedPlayers.size();
            arrayList = this.preparedPlayers;
            if (i >= size) {
                break;
            }
            arrayList.get(i).release(null);
            i++;
        }
        arrayList.clear();
    ...
    public View mo7483getWindowView() {
    ...
    public void openFor(BaseFragment baseFragment, RecyclerListView recyclerListView, ChatActionCell chatActionCell) {
        ...
        open(baseFragment.getContext(), messageObject.messageOwner.media.storyItem, StoriesListPlaceProvider.m1210of(recyclerListView));
    }
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
            ...
            if (this.storiesList == ((StoriesController.StoriesList) objArr[0])) {
                ...
                if (selfStoryViewsView != null) {
                    ...
                    while (i3 < this.storiesList.messageObjects.size()) {
                        if (selectedStory != null && selectedStory.f1454id == this.storiesList.messageObjects.get(i3).storyItem.f1454id) {
                            i4 = i3;
                        }
        ...
        if (i == NotificationCenter.storyDeleted) {
            ...
            if (storyItem != null && storyItem.dialogId == jLongValue && storyItem.f1454id == iIntValue) {
    ...
    public CharSequence getDraft(long j, TL_stories.StoryItem storyItem) {
        return (j == 0 || storyItem == null) ? _UrlKt.FRAGMENT_ENCODE_SET : replyDrafts.get(draftHash(j, storyItem), _UrlKt.FRAGMENT_ENCODE_SET);
    }
    ...
    private long draftHash(long j, TL_stories.StoryItem storyItem) {
        return j + (j >> 16) + (((long) storyItem.f1454id) << 16);
    }
    ...
    public interface PlaceProvider {
        ...
        default void loadNext(boolean z) {
        }

        default void preLayout(long j, int i, Runnable runnable) {
            runnable.run();
        }
    }
    ...
    public class VideoPlayerHolder extends VideoPlayerHolderBase {
        ...
        public /* synthetic */ void lambda$onStateChanged$0() {
            ...
            FileLog.m1045d("StoryViewer displayed story buffering dialogId=" + currentPeerView.getCurrentPeer() + " storyId=" + currentPeerView.currentStory.storyItem.f1454id);
        }
        ...
        public /* synthetic */ void lambda$onStateChanged$1() {
            ...
            FileLog.m1045d("StoryViewer displayed story playing dialogId=" + currentPeerView.getCurrentPeer() + " storyId=" + currentPeerView.currentStory.storyItem.f1454id);
        }
    }
