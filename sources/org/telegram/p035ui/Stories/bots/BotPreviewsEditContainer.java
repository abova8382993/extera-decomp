package org.telegram.p035ui.Stories.bots;
...
public abstract class BotPreviewsEditContainer extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public BotPreviewsEditContainer(final Context context, BaseFragment baseFragment, long j) {
        ...
        viewPagerFixed.setAdapter(new ViewPagerFixed.Adapter() { // from class: org.telegram.ui.Stories.bots.BotPreviewsEditContainer.2
            ...
            public String getItemTitle(int i) {
                if (i == 0) {
                    return LocaleController.getString(C2797R.string.ProfileBotLanguageGeneral);
                }
    ...
    public void addTranslation() {
        new ChooseLanguageSheet(this.fragment, LocaleController.getString(C2797R.string.ProfileBotPreviewLanguageChoose), new Utilities.Callback() { // from class: org.telegram.ui.Stories.bots.BotPreviewsEditContainer$$ExternalSyntheticLambda1
    ...
    public boolean canScroll(boolean z) {
        ...
        return z ? viewPagerFixed.getCurrentPosition() == this.langLists.size() : viewPagerFixed.getCurrentPosition() == 0;
    }
    ...
    private void updateLangs(boolean z) {
        ...
        if (uploadingStories != null) {
            ...
            while (i2 < size2) {
                ...
                i2++;
                StoriesController.UploadingStory uploadingStory2 = uploadingStory;
                if (uploadingStory2 != null && (storyEntry = uploadingStory2.entry) != null && storyEntry.botId == this.bot_id && !TextUtils.isEmpty(storyEntry.botLang) && !arrayList.contains(uploadingStory2.entry.botLang)) {
                    arrayList.add(uploadingStory2.entry.botLang);
                }
            }
        }
        ...
        SpannableString spannableString = new SpannableString("+ " + LocaleController.getString(C2797R.string.ProfileBotLanguageAdd));
        ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C2797R.drawable.msg_filled_plus);
    ...
    public void deleteLang(String str) {
        ...
        if (botPreviewsList != null) {
            ...
            for (int i2 = 0; i2 < botPreviewsList.messageObjects.size(); i2++) {
                TL_stories.StoryItem storyItem = botPreviewsList.messageObjects.get(i2).storyItem;
                if (storyItem != null && (messageMedia = storyItem.media) != null) {
    ...
    private void updateTabs(final boolean z, boolean z2) {
        ...
        if (bool == null || bool.booleanValue() != z) {
            ...
            if (!z2) {
                ...
                this.tabsView.setTranslationY(AndroidUtilities.m1036dp(z ? 0.0f : -42.0f));
                this.viewPager.setTranslationY(AndroidUtilities.m1036dp(z ? 42.0f : 0.0f));
                return;
            }
            ...
            this.tabsAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Stories.bots.BotPreviewsEditContainer.3
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    BotPreviewsEditContainer.this.tabsView.setTranslationY(AndroidUtilities.m1036dp(z ? 0.0f : -42.0f));
                    BotPreviewsEditContainer.this.viewPager.setTranslationY(AndroidUtilities.m1036dp(z ? 42.0f : 0.0f));
                }
            });
    ...
    public /* synthetic */ void lambda$updateTabs$3(ValueAnimator valueAnimator) {
        ...
        this.tabsView.setTranslationY(AndroidUtilities.lerp(-AndroidUtilities.m1036dp(42.0f), 0, this.tabsAlpha));
        this.viewPager.setTranslationY(AndroidUtilities.lerp(0, AndroidUtilities.m1036dp(42.0f), this.tabsAlpha));
    }
    ...
    public class BotPreviewsEditLangContainer extends FrameLayout {
        ...
        public void updateFooter() {
            ...
            if (z) {
                string = LocaleController.getString(C2797R.string.ProfileBotPreviewFooterGeneral);
            } else {
                string = LocaleController.formatString(C2797R.string.ProfileBotPreviewFooterLanguage, TranslateAlert2.languageName(this.list.lang_code));
            }
            String str = string;
            String string3 = LocaleController.getString(C2797R.string.ProfileBotAddPreview);
            ...
            if (z || count <= 0) {
                if (z) {
                    i = C2797R.string.ProfileBotPreviewFooterCreateTranslation;
                } else {
                    i = C2797R.string.ProfileBotPreviewFooterDeleteTranslation;
                }
            ...
            if (z) {
                ...
                this.emptyView.title.setText(LocaleController.getString(C2797R.string.ProfileBotPreviewEmptyTitle));
                ...
                this.emptyView.button.setText(LocaleController.getString(C2797R.string.ProfileBotPreviewEmptyButton), false);
                this.emptyViewOr.setVisibility(8);
                this.emptyViewButton2.setVisibility(8);
            } else {
                stickerEmptyView.title.setVisibility(8);
                this.emptyView.subtitle.setText(LocaleController.formatString(C2797R.string.ProfileBotPreviewFooterLanguage, TranslateAlert2.languageName(this.list.lang_code)));
                this.emptyView.button.setText(LocaleController.getString(C2797R.string.ProfileBotPreviewEmptyButton), false);
                this.emptyViewOr.setVisibility(0);
                this.emptyViewButton2.setVisibility(0);
                this.emptyViewButton2.setText(LocaleController.getString(C2797R.string.ProfileBotPreviewFooterDeleteTranslation), false);
        ...
        public /* synthetic */ void lambda$updateFooter$1(boolean z) {
            ...
            if (z) {
                ...
                botPreviewsEditContainer.deleteLang(this.list.lang_code);
            }
        }
        ...
        public void setVisibleHeight(int i) {
            float f = (-(getMeasuredHeight() - Math.max(i, AndroidUtilities.m1036dp(280.0f)))) / 2.0f;
        ...
        public BotPreviewsEditLangContainer(Context context) {
            ...
            sharedMediaListView.setPinnedSectionOffsetY(-AndroidUtilities.m1036dp(2.0f));
            ...
            stickerEmptyView.title.setText(LocaleController.getString(C2797R.string.ProfileBotPreviewEmptyTitle));
            ...
            stickerEmptyView.button.setText(LocaleController.getString(C2797R.string.ProfileBotPreviewEmptyButton), false);
            ...
            TextView textView = new TextView(context) { // from class: org.telegram.ui.Stories.bots.BotPreviewsEditContainer.BotPreviewsEditLangContainer.9
                ...
                public void dispatchDraw(Canvas canvas) {
                    Canvas canvas2;
                    int height = (getHeight() / 2) + AndroidUtilities.m1036dp(1.0f);
                    int iMax = Math.max(1, AndroidUtilities.m1036dp(0.66f));
                    ...
                    if (layout != null) {
                        ...
                        float f4 = f + f2;
                        canvas2 = canvas;
                        canvas2.drawRect(0.0f, f3, (getWidth() - (layout.getLineWidth(0) + AndroidUtilities.m1036dp(16.0f))) / 2.0f, f4, this.paint);
                        canvas2.drawRect(((getWidth() + layout.getLineWidth(0)) + AndroidUtilities.m1036dp(16.0f)) / 2.0f, f3, getWidth(), f4, this.paint);
                    } else {
                        canvas2 = canvas;
                    }
            ...
            textView.setText(LocaleController.getString(C2797R.string.ProfileBotOr));
            ...
            buttonWithCounterView.setMinWidth(AndroidUtilities.m1036dp(200.0f));
            ...
            ItemTouchHelper itemTouchHelper = new ItemTouchHelper(new ItemTouchHelper.Callback() { // from class: org.telegram.ui.Stories.bots.BotPreviewsEditContainer.BotPreviewsEditLangContainer.10
                ...
                public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int i) {
                    ...
                    if (i == 0) {
                        botPreviewsEditLangContainer.adapter.reorderDone();
        ...
        public /* synthetic */ void lambda$new$3(View view, int i) {
            if (view instanceof SharedPhotoVideoCell2) {
                ...
                boolean zIsActionModeShowed = BotPreviewsEditContainer.this.isActionModeShowed();
                BotPreviewsEditContainer botPreviewsEditContainer = BotPreviewsEditContainer.this;
                if (zIsActionModeShowed) {
                    boolean zIsSelected = botPreviewsEditContainer.isSelected(messageObject);
                    BotPreviewsEditContainer botPreviewsEditContainer2 = BotPreviewsEditContainer.this;
                    if (zIsSelected) {
                        botPreviewsEditContainer2.unselect(messageObject);
                        return;
                    } else {
                        botPreviewsEditContainer2.select(messageObject);
                        return;
                    }
                }
                botPreviewsEditContainer.fragment.getOrCreateStoryViewer().open(getContext(), messageObject.getId(), this.list, StoriesListPlaceProvider.m1210of(this.listView).addBottomClip(((BotPreviewsEditContainer.this.fragment instanceof ProfileActivity) && ((ProfileActivity) BotPreviewsEditContainer.this.fragment).myProfile) ? AndroidUtilities.m1036dp(68.0f) : 0));
            }
        }
        ...
        public /* synthetic */ boolean lambda$new$4(View view, int i) {
            ...
            MessageObject messageObject = ((SharedPhotoVideoCell2) view).getMessageObject();
            boolean zIsSelected = BotPreviewsEditContainer.this.isSelected(messageObject);
            BotPreviewsEditContainer botPreviewsEditContainer = BotPreviewsEditContainer.this;
            if (zIsSelected) {
        ...
        public void onMeasure(int i, int i2) {
            ...
            sharedMediaListView.setPadding(paddingLeft, sharedMediaListView2.topPadding, sharedMediaListView2.getPaddingRight(), AndroidUtilities.m1036dp(42.0f) + this.footer.getMeasuredHeight());
        }
        ...
        public class StoriesAdapter extends RecyclerListView.FastScrollAdapter {
            ...
            private void checkColumns() {
                ...
                if ((!BotPreviewsEditLangContainer.this.storiesColumnsCountSet || (BotPreviewsEditLangContainer.this.allowStoriesSingleColumn && getItemCount() > 1)) && getItemCount() > 0) {
                    ...
                    BotPreviewsEditLangContainer botPreviewsEditLangContainer = BotPreviewsEditLangContainer.this;
                    if (itemCount < 5) {
                        botPreviewsEditLangContainer.columnsCount = Math.max(1, getItemCount());
                        BotPreviewsEditLangContainer botPreviewsEditLangContainer2 = BotPreviewsEditLangContainer.this;
                        botPreviewsEditLangContainer2.allowStoriesSingleColumn = botPreviewsEditLangContainer2.columnsCount == 1;
                    } else if (botPreviewsEditLangContainer.allowStoriesSingleColumn || BotPreviewsEditLangContainer.this.columnsCount == 1) {
            ...
            private int columnsCount() {
                StoriesAdapter storiesAdapter = this.supportingAdapter;
                BotPreviewsEditLangContainer botPreviewsEditLangContainer = BotPreviewsEditLangContainer.this;
                if (this == storiesAdapter) {
                    return botPreviewsEditLangContainer.animateToColumnsCount;
                }
                return botPreviewsEditLangContainer.columnsCount;
            }
            ...
            public String getLetter(int i) {
                ...
                StoriesController.StoriesList storiesList = this.storiesList;
                if (storiesList == null || i < 0 || i >= storiesList.messageObjects.size() || (messageObject = this.storiesList.messageObjects.get(i)) == null || (storyItem = messageObject.storyItem) == null) {
                    return null;
                }
            ...
            if (motionEvent.getActionMasked() == 0 || motionEvent.getActionMasked() == 5) {
                ...
                if (this.isInPinchToZoomTouchMode) {
                    ...
                    if ((z2 && this.pinchScale < 1.0f) || (!z2 && this.pinchScale > 1.0f)) {
                        ...
                        this.columnsAnimationProgress = Math.max(0.0f, Math.min(1.0f, z2 ? 1.0f - ((2.0f - f) / 1.0f) : (1.0f - f) / 0.5f));
                    }
                    float f2 = this.columnsAnimationProgress;
                    if (f2 == 1.0f || f2 == 0.0f) {
                        if (f2 == 1.0f) {
        ...
        private void startPinchToMediaColumnsCount(boolean z) {
            ...
            internalListView.setPadding(internalListView.getPaddingLeft(), 0, this.supportingListView.getPaddingRight(), AndroidUtilities.m1036dp(42.0f) + this.footer.getMeasuredHeight());
                    ...
                    valueAnimatorOfFloat.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Stories.bots.BotPreviewsEditContainer.BotPreviewsEditLangContainer.13
                        ...
                        public void onAnimationEnd(Animator animator) {
                            ...
                            if (z) {
                                ...
                                int itemCount2 = BotPreviewsEditLangContainer.this.adapter.getItemCount();
                                BotPreviewsEditLangContainer botPreviewsEditLangContainer3 = BotPreviewsEditLangContainer.this;
                                if (itemCount2 == itemCount) {
                                    AndroidUtilities.updateVisibleRows(botPreviewsEditLangContainer3.listView);
                                } else {
                                    botPreviewsEditLangContainer3.adapter.notifyDataSetChanged();
                                }
                            }
                            ...
                            if (botPreviewsEditLangContainer4.pinchCenterPosition >= 0) {
                                if (z && (viewFindViewByPosition = botPreviewsEditLangContainer4.supportingLayoutManager.findViewByPosition(BotPreviewsEditLangContainer.this.pinchCenterPosition)) != null) {
                                ...
                                BotPreviewsEditLangContainer botPreviewsEditLangContainer5 = BotPreviewsEditLangContainer.this;
                                extendedGridLayoutManager.scrollToPositionWithOffset(botPreviewsEditLangContainer5.pinchCenterPosition, (-botPreviewsEditLangContainer5.listView.getPaddingTop()) + BotPreviewsEditLangContainer.this.pinchCenterOffset);
                            } else {
                                botPreviewsEditLangContainer4.saveScrollPosition();
                            }
        ...
        public class FooterView extends LinearLayout {
            ...
            public FooterView(Context context, final Theme.ResourcesProvider resourcesProvider) {
                super(context);
                setPadding(AndroidUtilities.m1036dp(24.0f), AndroidUtilities.m1036dp(21.0f), AndroidUtilities.m1036dp(24.0f), AndroidUtilities.m1036dp(21.0f));
                setOrientation(1);
                ...
                ButtonWithCounterView buttonWithCounterView = new ButtonWithCounterView(context, resourcesProvider) { // from class: org.telegram.ui.Stories.bots.BotPreviewsEditContainer.BotPreviewsEditLangContainer.FooterView.1
                    @Override // org.telegram.p035ui.Stories.recorder.ButtonWithCounterView, android.widget.FrameLayout, android.view.View
                ...
                buttonWithCounterView.setMinWidth(AndroidUtilities.m1036dp(200.0f));
                buttonWithCounterView.setText(LocaleController.getString(C2797R.string.ProfileBotAddPreview), false);
                ...
                textView2.setText(LocaleController.getString(C2797R.string.ProfileBotOr));
                ...
                buttonWithCounterView2.setMinWidth(AndroidUtilities.m1036dp(200.0f));
    ...
    public static class ChooseLanguageSheet extends BottomSheetWithRecyclerListView {
        ...
        public void fillItems(ArrayList<UItem> arrayList, UniversalAdapter universalAdapter) {
            ...
            while (i < size) {
                ...
                i++;
                arrayList.add(LanguageView.Factory.m1213of(language));
            }
        }
        ...
        public static class LanguageView extends LinearLayout {
            ...
            public LanguageView(Context context) {
                super(context);
                setPadding(AndroidUtilities.m1036dp(22.0f), 0, AndroidUtilities.m1036dp(22.0f), 0);
                setOrientation(1);
                TextView textView = new TextView(context);
                this.title = textView;
            ...
            public static class Factory extends UItem.UItemFactory<LanguageView> {
                ...
                public static UItem m1213of(TranslateController.Language language) {
