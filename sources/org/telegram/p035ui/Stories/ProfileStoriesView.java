...
import org.telegram.p035ui.Stories.ProfileStoriesView;
...
public class ProfileStoriesView extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public class StoryCircle {
        ...
        public StoryCircle(TL_stories.StoryItem storyItem) {
            ...
            this.imageReceiver.setRoundRadius(AndroidUtilities.m1036dp(200.0f));
  ...
  0x0192: PHI (r9v18 org.telegram.tgnet.tl.TL_stories$StoryItem) = (r9v17 org.telegram.tgnet.tl.TL_stories$StoryItem), (r9v20 org.telegram.tgnet.tl.TL_stories$StoryItem) binds: [B:84:0x013f, B:105:0x018f] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public void updateStories(boolean r21, boolean r22) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Stories.ProfileStoriesView.updateStories(boolean, boolean):void");
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        float f7 = profileStoriesView3.rightAnimated.set(profileStoriesView3.right);
        ...
        float f8 = fLerp * 2.0f;
        profileStoriesView3.rect1.set(x, y, ((profileStoriesView3.avatarContainer.getWidth() - f8) * profileStoriesView3.avatarContainer.getScaleX()) + x, ((profileStoriesView3.avatarContainer.getHeight() - f8) * profileStoriesView3.avatarContainer.getScaleY()) + y);
        ...
        while (true) {
            ...
            StoryCircle storyCircle = profileStoriesView3.circles.get(i2);
            float f9 = storyCircle.scaleAnimated.set(storyCircle.scale);
            storyCircle.cachedScale = f9;
            if (f9 <= 0.0f && storyCircle.scale <= 0.0f) {
                storyCircle.destroy();
                ...
                if (i2 > 0 && profileStoriesView3.circles.get(i2 - 1).cachedIndex > storyCircle.cachedIndex) {
                    Collections.sort(profileStoriesView3.circles, new Comparator() { // from class: org.telegram.ui.Stories.ProfileStoriesView$$ExternalSyntheticLambda0
                        ...
                        public final int compare(Object obj, Object obj2) {
                            return ProfileStoriesView.m20759$r8$lambda$JQNPIPP51ie698WIdXQXlPmQs((ProfileStoriesView.StoryCircle) obj, (ProfileStoriesView.StoryCircle) obj2);
                        }
                    });
                    break;
                }
        ...
        canvas2.save();
        float f10 = profileStoriesView3.bounceScale;
        canvas2.scale(f10, f10, profileStoriesView3.rect1.centerX(), profileStoriesView3.rect1.centerY());
        ...
        if (fLerp2 > 0.0f) {
            ...
            if (!profileStoriesView3.storiesController.hasUploadingStories(profileStoriesView3.dialogId) || profileStoriesView3.storiesController.isLastUploadingFailed(profileStoriesView3.dialogId)) {
                ...
                ArrayList<StoriesController.UploadingStory> uploadingStories = profileStoriesView3.storiesController.getUploadingStories(profileStoriesView3.dialogId);
                if (uploadingStories != null) {
                    if (uploadingStories.size() > 0) {
                        profileStoriesView3.lastUploadingStory = uploadingStories.get(0);
                    }
                    float f11 = 0.0f;
                    for (int i3 = 0; i3 < uploadingStories.size(); i3++) {
                        f11 += uploadingStories.get(i3).progress;
                    }
        ...
        if (fLerp2 < 1.0f) {
            ...
            float f13 = profileStoriesView3.segmentsCountAnimated.set(profileStoriesView3.count);
            float f14 = profileStoriesView3.segmentsUnreadCountAnimated.set(profileStoriesView3.unreadCount);
            if (zIsLastUploadingFailed) {
                profileStoriesView3.rect2.set(profileStoriesView3.rect1);
                profileStoriesView3.rect2.inset(-AndroidUtilities.dpf2(3.775f), -AndroidUtilities.dpf2(3.775f));
                Paint errorPaint = StoriesUtilities.getErrorPaint(profileStoriesView3.rect2);
                errorPaint.setStrokeWidth(AndroidUtilities.m1036dp(f));
                errorPaint.setAlpha((int) (fClamp * 255.0f));
                boolean zIsForum = ChatObject.isForum(UserConfig.selectedAccount, profileStoriesView3.dialogId);
                RectF rectF2 = profileStoriesView3.rect2;
                if (zIsForum) {
                    float fHeight = rectF2.height() * 0.32f;
                    canvas2.drawRoundRect(profileStoriesView3.rect2, fHeight, fHeight, errorPaint);
                } else {
                    canvas2.drawCircle(rectF2.centerX(), profileStoriesView3.rect2.centerY(), profileStoriesView3.rect2.width() / f, errorPaint);
                }
                ...
                RectF rectF3 = profileStoriesView3.rect2;
                RectF rectF4 = profileStoriesView3.rect3;
                AndroidUtilities.lerp(rectF3, rectF4, fClamp2, rectF4);
                f4 = 12.0f;
                float fLerp4 = AndroidUtilities.lerp(0.0f, (float) ((((double) AndroidUtilities.dpf2(4.23f)) / (((double) profileStoriesView3.rect1.width()) * 3.141592653589793d)) * 360.0d), Utilities.clamp(f13 - 1.0f, 1.0f, 0.0f) * fClamp);
                ...
                float f15 = (-90.0f) - (fLerp5 / f);
                boolean z3 = false;
                for (int i5 = 0; i5 < iMin; i5++) {
                    if (i5 < profileStoriesView3.circles.size() && profileStoriesView3.circles.get(i5).live) {
                        z3 = true;
                    }
                }
                if (z3) {
                    RectF rectF5 = AndroidUtilities.rectTmp;
                    rectF5.set(profileStoriesView3.rect3);
                    rectF5.inset(-AndroidUtilities.m1036dp(12.0f), -AndroidUtilities.m1036dp(12.0f));
                    canvas2.saveLayerAlpha(rectF5, 255, 31);
                    float f16 = ((profileStoriesView3.newStoryBounceT - 1.0f) / 2.5f) + 1.0f;
                    if (f16 != 1.0f) {
                        canvas2.save();
                        canvas2.scale(f16, f16, profileStoriesView3.rect2.centerX(), profileStoriesView3.rect2.centerY());
                    }
                    int alpha2 = profileStoriesView3.livePaint.getAlpha();
                    profileStoriesView3.livePaint.setAlpha((int) (alpha2 * fClamp));
                    rectF5.set(profileStoriesView3.rect3);
                    rectF5.inset(-AndroidUtilities.m1036dp(3.0f), -AndroidUtilities.m1036dp(3.0f));
                    ...
                    while (i6 < iMin) {
                        float f17 = i6;
                        float f18 = f12;
                        float fClamp4 = 1.0f - Utilities.clamp(f14 - f17, 1.0f, 0.0f);
                        float fClamp5 = 1.0f - Utilities.clamp((iMin - fMin) - f17, 1.0f, 0.0f);
                        if (fClamp5 < 0.0f) {
                            f6 = fMax2;
                            i = i6;
                        } else {
                            float f19 = i6 == 0 ? ((profileStoriesView3.newStoryBounceT - 1.0f) / 2.5f) + 1.0f : 1.0f;
                            if (f19 != 1.0f) {
                                canvas2.save();
                                canvas2.scale(f19, f19, profileStoriesView3.rect2.centerX(), profileStoriesView3.rect2.centerY());
                            }
                            boolean z4 = i6 < profileStoriesView3.circles.size() && profileStoriesView3.circles.get(i6).live;
                            if (fClamp4 < 1.0f) {
                                if (z4) {
                                ...
                                profileStoriesView3.drawArc(canvas2, profileStoriesView3.rect2, f15, (-fMax2) * fClamp5, false, paint3);
                            ...
                            if (fClamp4 > 0.0f) {
                                ...
                                canvas2 = canvas;
                                profileStoriesView3.drawArc(canvas2, profileStoriesView3.rect3, f15, (-f6) * fClamp5, false, paint5);
        ...
        if (profileStoriesView3.expandProgress <= 0.0f || fClamp >= 1.0f) {
            profileStoriesView = profileStoriesView3;
        } else {
            profileStoriesView3.f1792w = 0.0f;
            for (int i7 = 0; i7 < profileStoriesView3.circles.size(); i7++) {
                profileStoriesView3.f1792w += AndroidUtilities.m1036dp(14.0f) * profileStoriesView3.circles.get(i7).cachedScale;
            }
            float fM1036dp = 0.0f;
            for (int i8 = 0; i8 < profileStoriesView3.circles.size(); i8++) {
                StoryCircle storyCircle2 = profileStoriesView3.circles.get(i8);
                float f20 = storyCircle2.cachedScale;
                float f21 = storyCircle2.cachedRead;
                float fM1036dp2 = (AndroidUtilities.m1036dp(28.0f) / f) * f20;
                float f22 = profileStoriesView3.left + fM1036dp2 + fM1036dp;
                fM1036dp += AndroidUtilities.m1036dp(18.0f) * f20;
                float f23 = f22 + fM1036dp2;
                fMax = Math.max(fMax, f23);
                profileStoriesView3.rect2.set(f22 - fM1036dp2, f2 - fM1036dp2, f23, f2 + fM1036dp2);
            ...
            paint6.setStrokeWidth(AndroidUtilities.lerp(AndroidUtilities.dpf2(2.33f), AndroidUtilities.dpf2(f5), profileStoriesView3.expandProgress));
            ...
            while (i9 < profileStoriesView3.circles.size()) {
                StoryCircle storyCircle3 = profileStoriesView3.circles.get(i9);
                int i10 = i9 - 2;
                int i11 = i9 - 1;
                StoryCircle storyCircleNearest = profileStoriesView3.nearest(i10 >= 0 ? profileStoriesView3.circles.get(i10) : null, i11 >= 0 ? profileStoriesView3.circles.get(i11) : null, storyCircle3);
                int i12 = i9 + 1;
                int i13 = i9 + 2;
                StoryCircle storyCircleNearest2 = profileStoriesView3.nearest(i12 < profileStoriesView3.circles.size() ? profileStoriesView3.circles.get(i12) : null, i13 < profileStoriesView3.circles.size() ? profileStoriesView3.circles.get(i13) : null, storyCircle3);
                ...
                if (storyCircle3.cachedRead < 1.0f) {
                    ...
                    profileStoriesView3.drawArcs(canvas2, storyCircleNearest, storyCircle3, storyCircleNearest2, paint6);
                    paint2 = paint6;
            ...
            profileStoriesView = profileStoriesView3;
            Paint paint8 = paint6;
            canvas.saveLayerAlpha(0.0f, 0.0f, profileStoriesView.getWidth(), profileStoriesView.getHeight(), (int) (profileStoriesView.expandProgress * f3 * (1.0f - fClamp)), 31);
            canvas2 = canvas;
            for (int size2 = profileStoriesView.circles.size() - 1; size2 >= 0; size2--) {
                StoryCircle storyCircle4 = profileStoriesView.circles.get(size2);
                if (storyCircle4.imageReceiver.getVisible()) {
                    int saveCount = canvas2.getSaveCount();
                    int i14 = size2 - 1;
                    int i15 = size2 - 2;
                    profileStoriesView.clipCircle(canvas2, storyCircle4, profileStoriesView.nearest(i14 >= 0 ? profileStoriesView.circles.get(i14) : null, i15 >= 0 ? profileStoriesView.circles.get(i15) : null, storyCircle4));
        ...
        if (fMax3 > 0.0f) {
            float fLerp6 = AndroidUtilities.lerp(profileStoriesView.rect1.right + AndroidUtilities.m1036dp(16.0f), fMax + AndroidUtilities.m1036dp(f4), profileStoriesView.expandProgress);
            float fLerp7 = AndroidUtilities.lerp(profileStoriesView.getWidth(), f7, profileStoriesView.expandProgress);
            float fLerp8 = AndroidUtilities.lerp(profileStoriesView.rect1.centerY(), profileStoriesView.f1791cy, profileStoriesView.expandProgress);
            profileStoriesView.titleDrawable.setBounds((int) fLerp6, (int) (fLerp8 - AndroidUtilities.m1036dp(18.0f)), (int) fLerp7, (int) (fLerp8 + AndroidUtilities.m1036dp(18.0f)));
            profileStoriesView.titleDrawable.setAlpha((int) (fMax3 * f3));
    ...
    public static /* synthetic */ int m20759$r8$lambda$JQNPIPP51ie698WIdXQXlPmQs(StoryCircle storyCircle, StoryCircle storyCircle2) {
    ...
    private void drawArc(Canvas canvas, RectF rectF, float f, float f2, boolean z, Paint paint) {
        ...
        if (zIsForum || (ExteraConfig.getAvatarCorners() != 28.0f && this.expandProgress < 0.2f)) {
            float avatarCorners = ExteraConfig.getAvatarCorners(rectF.height() + AndroidUtilities.m1036dp(4.0f), true, zIsForum);
    ...
    public void setBounds(float f, float f2, float f3, boolean z) {
        boolean z2 = Math.abs(f - this.left) > 0.1f || Math.abs(f2 - this.right) > 0.1f || Math.abs(f3 - this.f1791cy) > 0.1f;
        this.left = f;
        this.right = f2;
        if (!z) {
    ...
    public class C69373 implements StoryViewer.PlaceProvider {
        public C69373() {
        }
    ...
    private float getExpandRight() {
        return this.expandRight - (this.expandRightPadAnimated.set(this.expandRightPad) * AndroidUtilities.m1036dp(71.0f));
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.expandProgress < 0.9f) {
            ...
            zContains = motionEvent.getX() >= this.left && motionEvent.getX() <= this.right && Math.abs(motionEvent.getY() - this.f1791cy) < ((float) AndroidUtilities.m1036dp(32.0f));
        }
