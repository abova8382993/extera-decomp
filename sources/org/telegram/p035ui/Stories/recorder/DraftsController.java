    ...
    */
    public static /* synthetic */ void $r8$lambda$RiC0JImjTCT65pJVD7o8arqUXPQ(org.telegram.messenger.MessagesStorage r5, org.telegram.ui.Stories.recorder.DraftsController.StoryDraft r6) {
        ...
        L8:
            ...
            long r1 = r6.f1804id     // Catch: java.lang.Throwable -> L4a java.lang.Exception -> L4c
            r3 = 1
        ...
        L4c:
            r5 = move-exception
            org.telegram.messenger.FileLog.m1048e(r5)     // Catch: java.lang.Throwable -> L4a
            if (r0 == 0) goto L55
            r0.dispose()
        L55:
            return
        ...
        L5b:
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Stories.recorder.DraftsController.$r8$lambda$RiC0JImjTCT65pJVD7o8arqUXPQ(org.telegram.messenger.MessagesStorage, org.telegram.ui.Stories.recorder.DraftsController$StoryDraft):void");
    }
    ...
    private void prepare(StoryEntry storyEntry) {
        ...
        boolean z = storyEntry.fileDeletable;
        File file = storyEntry.file;
        if (z) {
            storyEntry.file = prepareFile(file);
        } else if (file != null) {
    ...
    */
    public static /* synthetic */ void $r8$lambda$6IXZXV8p4lXLYDofSjSWK6WcFX8(org.telegram.messenger.MessagesStorage r5, org.telegram.ui.Stories.recorder.DraftsController.StoryDraft r6) {
        ...
        L5b:
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Stories.recorder.DraftsController.$r8$lambda$6IXZXV8p4lXLYDofSjSWK6WcFX8(org.telegram.messenger.MessagesStorage, org.telegram.ui.Stories.recorder.DraftsController$StoryDraft):void");
    }
    ...
    public void saveForEdit(StoryEntry storyEntry, long j, TL_stories.StoryItem storyItem) {
        ...
        ArrayList<StoryEntry> arrayList2 = this.drafts;
        int size = arrayList2.size();
        int i = 0;
        while (i < size) {
            StoryEntry storyEntry2 = arrayList2.get(i);
            i++;
            StoryEntry storyEntry3 = storyEntry2;
            if (storyEntry3.isEdit && storyEntry3.editStoryId == storyItem.f1454id) {
                arrayList.add(storyEntry3);
            }
        }
        delete(arrayList);
        prepare(storyEntry);
    ...
    public StoryEntry getForEdit(long j, TL_stories.StoryItem storyItem) {
        ...
        ArrayList<StoryEntry> arrayList = this.drafts;
        ...
        while (i < size) {
            ...
            if (storyEntry2.isEdit && storyItem.f1454id == storyEntry2.editStoryId && j == storyEntry2.editStoryPeerId && ((document = (messageMedia = storyItem.media).document) == null || document.f1253id == storyEntry2.editDocumentId)) {
                TLRPC.Photo photo = messageMedia.photo;
                if (photo == null || photo.f1276id == storyEntry2.editPhotoId) {
                    storyEntry2.isEditSaved = true;
                    return storyEntry2;
                }
            }
        }
    ...
    public static class StoryDraft {
        ...
        public StoryDraft(StoryEntry storyEntry) {
            ...
            this.f1804id = storyEntry.draftId;
        ...
        public StoryEntry toEntry() {
            ...
            storyEntry.draftId = this.f1804id;
            storyEntry.isDraft = true;
        ...
        public void toStream(AbstractSerializedData abstractSerializedData) {
            ...
            ArrayList<TLRPC.MessageEntity> arrayList2 = this.captionEntities;
            abstractSerializedData.writeInt32(arrayList2 == null ? 0 : arrayList2.size());
            if (this.captionEntities != null) {
                for (int i3 = 0; i3 < this.captionEntities.size(); i3++) {
                    this.captionEntities.get(i3).serializeToStream(abstractSerializedData);
                }
            }
            abstractSerializedData.writeInt32(481674261);
            ArrayList<TLRPC.InputPrivacyRule> arrayList3 = this.privacyRules;
            ...
            if (this.privacyRules != null) {
                for (int i4 = 0; i4 < this.privacyRules.size(); i4++) {
                    this.privacyRules.get(i4).serializeToStream(abstractSerializedData);
                }
            }
            ...
            abstractSerializedData.writeInt32(481674261);
            ArrayList<VideoEditedInfo.MediaEntity> arrayList4 = this.mediaEntities;
            abstractSerializedData.writeInt32(arrayList4 == null ? 0 : arrayList4.size());
            if (this.mediaEntities != null) {
                for (int i5 = 0; i5 < this.mediaEntities.size(); i5++) {
                    this.mediaEntities.get(i5).serializeTo(abstractSerializedData, true);
                }
            }
            abstractSerializedData.writeInt32(481674261);
            ...
            if (this.stickers != null) {
                for (int i6 = 0; i6 < this.stickers.size(); i6++) {
                    this.stickers.get(i6).serializeToStream(abstractSerializedData);
                }
            }
            ...
            if (collageLayout == null || collageLayout.parts.size() <= 1 || (arrayList = this.collageParts) == null || arrayList.size() <= 1) {
                ...
                ArrayList<VideoEditedInfo.Part> arrayList5 = this.collageParts;
                int size = arrayList5.size();
                while (i < size) {
                    VideoEditedInfo.Part part = arrayList5.get(i);
                    i++;
                    part.serializeToStream(abstractSerializedData);
                }
            }
        ...
        public StoryDraft(AbstractSerializedData abstractSerializedData, boolean z) {
            ...
            if (abstractSerializedData.readInt32(z) != -1318387531) {
                if (z) {
                    GlShader$$ExternalSyntheticBUOutline1.m1250m("StoryDraft parse error");
                    throw null;
                }
                return;
            }
            ...
            if (abstractSerializedData.readInt32(z) != 481674261) {
                if (z) {
                    GlShader$$ExternalSyntheticBUOutline1.m1250m("Vector magic in StoryDraft parse error (1)");
                    throw null;
                }
                return;
            }
            ...
            if (abstractSerializedData.readInt32(z) != 481674261) {
                if (z) {
                    GlShader$$ExternalSyntheticBUOutline1.m1250m("Vector magic in StoryDraft parse error (2)");
                    throw null;
                }
                return;
            }
            ...
            if (abstractSerializedData.readInt32(z) != 481674261) {
                if (z) {
                    GlShader$$ExternalSyntheticBUOutline1.m1250m("Vector magic in StoryDraft parse error (3)");
                    throw null;
                }
                return;
            }
            ...
            if (abstractSerializedData.readInt32(z) != 481674261) {
                if (z) {
                    GlShader$$ExternalSyntheticBUOutline1.m1250m("Vector magic in StoryDraft parse error (4)");
                    throw null;
                }
                return;
            }
            ...
            if (abstractSerializedData.remaining() > 0) {
                if (abstractSerializedData.readInt32(z) != 481674261) {
                    if (z) {
                        GlShader$$ExternalSyntheticBUOutline1.m1250m("Vector magic in StoryDraft parse error (5)");
                        throw null;
                    }
                    return;
                }
            ...
            if (abstractSerializedData.remaining() > 0 && abstractSerializedData.readInt32(z) == -559038737) {
                ...
                for (int i6 = 0; i6 < this.collage.parts.size(); i6++) {
                    ...
                    part.part = this.collage.parts.get(i6);
