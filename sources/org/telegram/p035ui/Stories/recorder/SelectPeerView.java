...
public class SelectPeerView extends FrameLayout {
    ...
    public SelectPeerView(Context context, int i) {
        ...
        backupImageView.setRoundRadius(AndroidUtilities.m1036dp(15.0f));
        ...
        textView2.setText(AndroidUtilities.replaceArrows(LocaleController.getString(C2797R.string.LiveStoryPeerChange), false, AndroidUtilities.m1036dp(2.6666667f), AndroidUtilities.m1036dp(0.33f), 1.0f));
        set(null);
    }
