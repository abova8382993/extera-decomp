...
import org.telegram.p035ui.Stories.StoryReactionWidgetBackground;
...
public class EmojiBottomSheet extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public class GifPage extends IPage implements NotificationCenter.NotificationCenterDelegate {
        ...
        private final ArrayList<TLRPC.BotInlineResult> gifs;
        public ExtendedGridLayoutManager layoutManager;
        public RecyclerListView listView;
        private final ArrayList<TLRPC.Document> mygifs;
        ...
        public GifPage(Context context) {
            ...
            this.listView.addItemDecoration(new RecyclerView.ItemDecoration() { // from class: org.telegram.ui.Stories.recorder.EmojiBottomSheet.GifPage.2
                ...
                public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
                    rect.right = GifPage.this.layoutManager.isLastInRow(recyclerView.getChildAdapterPosition(view)) ? 0 : AndroidUtilities.m1036dp(4.0f);
        ...
        public void updateTops() {
            this.searchField.setTranslationY(AndroidUtilities.m1036dp(10.0f) + Math.max(0.0f, top()));
        }
            ...
            public GifLayoutManager(Context context) {
                ...
                setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() { // from class: org.telegram.ui.Stories.recorder.EmojiBottomSheet.GifPage.GifLayoutManager.1
                    ...
                    public int getSpanSize(int i) {
                        ...
                        return gifLayoutManager.getSpanSizeForItem(i);
                    }
                });
            }
    ...
    public class Page extends IPage {
        ...
        public Page(Context context) {
            ...
            EmojiTabsStrip emojiTabsStrip = new EmojiTabsStrip(context, ((BottomSheet) EmojiBottomSheet.this).resourcesProvider, false, false, false, true, 0, null) { // from class: org.telegram.ui.Stories.recorder.EmojiBottomSheet.Page.3
                ...
                public boolean onTabClick(int i) {
                    ...
                    Page page = Page.this;
                    page.listView.scrollToPosition(iKeyAt, ((int) page.lockTop()) - AndroidUtilities.m1036dp(102.0f));
                    return true;
                }
            };
        ...
        public /* synthetic */ void lambda$new$0(View view, int i) {
            ...
            if (i >= 0 && this.layoutManager.getItemViewType(view) != 4) {
                ...
                if (EmojiBottomSheet.this.onDocumentSelected != null) {
                    EmojiBottomSheet.this.onDocumentSelected.run(this.adapter.setByDocumentId.get(Long.valueOf(documentFindDocument.f1253id)), documentFindDocument, Boolean.FALSE);
                }
                EmojiBottomSheet.this.lambda$new$0();
            }
        }
        ...
        public float top() {
            ...
            for (int i = 0; i < this.listView.getChildCount(); i++) {
                Object tag = this.listView.getChildAt(i).getTag();
                if ((tag instanceof Integer) && ((Integer) tag).intValue() == 34) {
                    return Math.max(0, r3.getBottom() - AndroidUtilities.m1036dp(102.0f));
                }
            }
            return 0.0f;
        }
        ...
        public void updateTops() {
            ...
            this.tabsStrip.setTranslationY(AndroidUtilities.m1036dp(16.0f) + fMax);
            this.searchField.setTranslationY(AndroidUtilities.m1036dp(52.0f) + fMax);
        ...
        public void onMeasure(int i, int i2) {
            ...
            this.tabsStrip.setTranslationY(AndroidUtilities.m1036dp(16.0f));
            this.searchField.setTranslationY(AndroidUtilities.m1036dp(52.0f));
            this.listView.setPadding(AndroidUtilities.m1036dp(5.0f), AndroidUtilities.m1036dp(102.0f), AndroidUtilities.m1036dp(5.0f), AndroidUtilities.navigationBarHeight + AndroidUtilities.m1036dp(EmojiBottomSheet.this.onlyStickers ? 0.0f : 40.0f));
            super.onMeasure(i, i2);
        }
        ...
        public void bind(int i) {
            ...
            if (EmojiBottomSheet.this.categoryIndex >= 0) {
                ...
                boolean zIsEmpty = TextUtils.isEmpty(EmojiBottomSheet.this.query);
                SearchField searchField3 = this.searchField;
                if (!zIsEmpty) {
                    searchField3.editText.setText(EmojiBottomSheet.this.query);
        ...
        public class Adapter extends RecyclerView.Adapter {
            ...
            /* JADX WARN: Removed duplicated region for block: B:155:0x034a A[SYNTHETIC] */
            ...
            */
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
                ...
                TLRPC.Document document = i >= this.documents.size() ? null : this.documents.get(i);
                ...
                if (document == EmojiBottomSheet.this.plus) {
                    ...
                    ShapeDrawable shapeDrawableCreateRoundRectDrawable = Theme.createRoundRectDrawable(iM1036dp, Theme.multAlpha(emojiBottomSheet.getThemedColor(i3), 0.12f));
                    Drawable drawableMutate = Page.this.getResources().getDrawable(C2797R.drawable.filled_add_sticker).mutate();
                ...
                long jLongValue = i >= this.documentIds.size() ? 0L : this.documentIds.get(i).longValue();
    ...
    public void showPremiumBulletin(String str) {
        ...
        BulletinFactory.m1142of(this.container, this.resourcesProvider).createSimpleBulletin(C2797R.raw.star_premium_2, LocaleController.getString(C2797R.string.IncreaseLimit), premiumText(str)).show(true);
    }
    ...
    public void lambda$onWidgetClick$1(final int i) {
        if (canClickWidget(Integer.valueOf(i))) {
            ...
            })) && this.onWidgetSelected.run(Integer.valueOf(i)).booleanValue()) {
                lambda$new$0();
            }
        }
    }
    ...
    public class ContainerView extends FrameLayout {
        ...
        public void onMeasure(int i, int i2) {
            ...
            EmojiBottomSheet.this.maxPadding = Math.min(size2 * 0.45f, (AndroidUtilities.m1036dp(350.0f) / 0.55f) * 0.45f);
        ...
        public void dispatchDraw(Canvas canvas) {
            ...
            float paddingTop = (EmojiBottomSheet.this.top + EmojiBottomSheet.this.viewPager.getPaddingTop()) - AndroidUtilities.lerp(AndroidUtilities.m1036dp(8.0f), EmojiBottomSheet.this.viewPager.getPaddingTop(), f);
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(((BottomSheet) EmojiBottomSheet.this).backgroundPaddingLeft, paddingTop, getWidth() - ((BottomSheet) EmojiBottomSheet.this).backgroundPaddingLeft, getHeight() + AndroidUtilities.m1036dp(8.0f));
            if (this.blurBitmap != null) {
                this.blurBitmapMatrix.reset();
                this.blurBitmapMatrix.postScale(16.0f, 16.0f);
                this.blurBitmapMatrix.postTranslate(0.0f, -getY());
                this.blurBitmapShader.setLocalMatrix(this.blurBitmapMatrix);
                canvas.drawRoundRect(rectF, AndroidUtilities.m1036dp(14.0f), AndroidUtilities.m1036dp(14.0f), this.backgroundBlurPaint);
            }
            ...
            float f2 = 1.0f - f;
            canvas.drawRoundRect(rectF, AndroidUtilities.m1036dp(14.0f) * f2, AndroidUtilities.m1036dp(14.0f) * f2, this.backgroundPaint);
            this.handleRect.set((getWidth() - AndroidUtilities.m1036dp(36.0f)) / 2.0f, AndroidUtilities.m1036dp(9.66f) + paddingTop, (getWidth() + AndroidUtilities.m1036dp(36.0f)) / 2.0f, paddingTop + AndroidUtilities.m1036dp(13.66f));
            this.handlePaint.setColor(1367573379);
            this.handlePaint.setAlpha((int) (f2 * 81.0f));
            canvas.drawRoundRect(this.handleRect, AndroidUtilities.m1036dp(4.0f), AndroidUtilities.m1036dp(4.0f), this.handlePaint);
            canvas.save();
    ...
    public EmojiBottomSheet whenWidgetSelected(Utilities.CallbackReturn<Integer, Boolean> callbackReturn) {
    ...
    public static class EmojiListView extends RecyclerListView {
        ...
        public static class EmojiImageView extends View {
            ...
            public void setEmoji(TLRPC.Document document, boolean z) {
                if (this.documentId == (document == null ? 0L : document.f1253id)) {
                    return;
                }
                AnimatedEmojiDrawable animatedEmojiDrawable = this.drawable;
                if (animatedEmojiDrawable != null) {
                ...
                if (document != null) {
                    this.emoji = true;
                    this.documentId = document.f1253id;
        ...
        public void dispatchDraw(Canvas canvas) {
            ...
            while (true) {
                ...
                ArrayList<EmojiImageView> arrayListValueAt = sparseArray.valueAt(i);
                    ...
                    if (emojiImageView.getY() < this.bottomBound && emojiImageView.getY() + emojiImageView.getHeight() > this.topBound) {
                        ...
                        if (arrayList == null) {
                            if (!this.unusedArrays.isEmpty()) {
                                arrayList = this.unusedArrays.remove(r5.size() - 1);
                            } else {
            ...
            while (true) {
                ...
                if (drawingInBackgroundLine == null) {
                    if (!this.unusedLineDrawables.isEmpty()) {
                        drawingInBackgroundLine = this.unusedLineDrawables.remove(r4.size() - 1);
                    } else {
        ...
        public class DrawingInBackgroundLine extends DrawingInBackgroundThreadDrawable {
            ...
            private float getAspectRatio(ImageReceiver imageReceiver) {
                ...
                if (lottieAnimation != null && lottieAnimation.getIntrinsicHeight() != 0) {
                    intrinsicWidth = lottieAnimation.getIntrinsicWidth();
                    intrinsicHeight = lottieAnimation.getIntrinsicHeight();
                } else {
                    AnimatedFileDrawable animation = imageReceiver.getAnimation();
                    if (animation != null && animation.getIntrinsicHeight() != 0) {
                        intrinsicWidth = animation.getIntrinsicWidth();
                        intrinsicHeight = animation.getIntrinsicHeight();
                    } else {
                        ...
                        if (bitmap != null) {
                            ...
                            intrinsicWidth = staticThumb.getIntrinsicWidth();
                            intrinsicHeight = staticThumb.getIntrinsicHeight();
                        }
                    }
                }
                ...
                if (this.imageViewEmojis != null) {
                    ...
                    for (int i = 0; i < this.imageViewEmojis.size(); i++) {
                        ...
                        if (!emojiImageView.notDraw) {
                            ...
                            if (EmojiListView.this.whiteFilter != null && emojiImageView.drawable != null) {
    ...
    public static class SearchField extends FrameLayout {
        ...
        public SearchField(Context context, final Theme.ResourcesProvider resourcesProvider) {
            ...
            frameLayout.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1036dp(18.0f), Theme.getColor(Theme.key_chat_emojiSearchBackground, resourcesProvider)));
            ...
            editTextBoldCursor.setHint(LocaleController.getString(C2797R.string.Search));
            ...
            editTextBoldCursor.setTranslationY(AndroidUtilities.m1036dp(-2.0f));
            frameLayout2.addView(editTextBoldCursor, LayoutHelper.createFrame(-1, 40.0f, 51, 0.0f, 0.0f, 28.0f, 0.0f));
            editTextBoldCursor.addTextChangedListener(new C70703());
            ...
            imageView2.setBackground(Theme.createSelectorDrawable(Theme.getColor(Theme.key_listSelector, resourcesProvider), 1, AndroidUtilities.m1036dp(15.0f)));
        ...
        public class C70703 implements TextWatcher {
        ...
        public void checkCategoriesView(int i, final boolean z) {
            if (this.categoriesListViewType != i || this.categoriesListView == null) {
                ...
                StickerCategoriesListView stickerCategoriesListView2 = new StickerCategoriesListView(getContext(), null, i == 1 ? 3 : 0, this.resourcesProvider) { // from class: org.telegram.ui.Stories.recorder.EmojiBottomSheet.SearchField.5
                    ...
                    @Override // org.telegram.p035ui.Components.StickerCategoriesListView
                    public StickerCategoriesListView.EmojiCategory[] preprocessCategories(StickerCategoriesListView.EmojiCategory[] emojiCategoryArr) {
                    ...
                    @Override // org.telegram.p035ui.Components.StickerCategoriesListView
                    public boolean isTabIconsAnimationEnabled(boolean z2) {
                        return LiteMode.isEnabled(LiteMode.FLAG_ANIMATED_EMOJI_REACTIONS);
                    }
                };
                this.categoriesListView = stickerCategoriesListView2;
                stickerCategoriesListView2.setDontOccupyWidth(((int) this.editText.getPaint().measureText(((Object) this.editText.getHint()) + _UrlKt.FRAGMENT_ENCODE_SET)) + AndroidUtilities.m1036dp(16.0f));
        ...
        public /* synthetic */ void lambda$checkCategoriesView$3(StickerCategoriesListView.EmojiCategory emojiCategory) {
            ...
            StickerCategoriesListView.EmojiCategory selectedCategory = stickerCategoriesListView.getSelectedCategory();
            StickerCategoriesListView stickerCategoriesListView2 = this.categoriesListView;
            if (selectedCategory == emojiCategory) {
                stickerCategoriesListView2.selectCategory((StickerCategoriesListView.EmojiCategory) null);
                search(null, -1);
            } else {
                stickerCategoriesListView2.selectCategory(emojiCategory);
    ...
    public static class TabsView extends View {
        ...
        @Override // android.view.View
        public void onMeasure(int i, int i2) {
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m1036dp(40.0f) + AndroidUtilities.navigationBarHeight);
        ...
        private void updateLayouts() {
            ...
            StaticLayout staticLayout3 = new StaticLayout(LocaleController.getString(C2797R.string.AccDescrGIFs), this.textPaint, getMeasuredWidth(), alignment, 1.0f, 0.0f, false);
            ...
            float fM1036dp = AndroidUtilities.m1036dp(14.0f) / 2.0f;
            float fM1036dp2 = AndroidUtilities.m1036dp(66.0f) / 2.0f;
            float measuredWidth2 = (getMeasuredWidth() - ((((((AndroidUtilities.m1036dp(12.0f) + this.emojiLayoutWidth) + AndroidUtilities.m1036dp(36.0f)) + this.stickersLayoutWidth) + AndroidUtilities.m1036dp(36.0f)) + this.gifsLayoutWidth) + AndroidUtilities.m1036dp(12.0f))) / 2.0f;
            this.emojiRect.set(measuredWidth2, fM1036dp, this.emojiLayoutWidth + measuredWidth2 + AndroidUtilities.m1036dp(24.0f), fM1036dp2);
            float fM1036dp3 = measuredWidth2 + this.emojiLayoutWidth + AndroidUtilities.m1036dp(36.0f);
            this.stickersRect.set(fM1036dp3, fM1036dp, this.stickersLayoutWidth + fM1036dp3 + AndroidUtilities.m1036dp(24.0f), fM1036dp2);
            float fM1036dp4 = fM1036dp3 + this.stickersLayoutWidth + AndroidUtilities.m1036dp(36.0f);
            this.gifsRect.set(fM1036dp4, fM1036dp, this.gifsLayoutWidth + fM1036dp4 + AndroidUtilities.m1036dp(24.0f), fM1036dp2);
            AndroidUtilities.m1036dp(36.0f);
        }
        ...
        public void dispatchDraw(Canvas canvas) {
            ...
            canvas.drawRoundRect(this.selectRect, AndroidUtilities.m1036dp(20.0f), AndroidUtilities.m1036dp(20.0f), this.selectPaint);
            if (this.emojiLayout != null) {
                canvas.save();
                float fM1036dp = (this.emojiRect.left + AndroidUtilities.m1036dp(12.0f)) - this.emojiLayoutLeft;
                RectF rectF = this.emojiRect;
                canvas.translate(fM1036dp, rectF.top + ((rectF.height() - this.emojiLayout.getHeight()) / 2.0f));
            ...
            if (this.stickersLayout != null) {
                canvas.save();
                float fM1036dp2 = (this.stickersRect.left + AndroidUtilities.m1036dp(12.0f)) - this.stickersLayoutLeft;
                RectF rectF2 = this.stickersRect;
                canvas.translate(fM1036dp2, rectF2.top + ((rectF2.height() - this.stickersLayout.getHeight()) / 2.0f));
            ...
            if (this.gifsLayout != null) {
                canvas.save();
                float fM1036dp3 = (this.gifsRect.left + AndroidUtilities.m1036dp(12.0f)) - this.gifsLayoutLeft;
                RectF rectF3 = this.gifsRect;
                canvas.translate(fM1036dp3, rectF3.top + ((rectF3.height() - this.gifsLayout.getHeight()) / 2.0f));
    ...
    public static class NoEmojiView extends FrameLayout {
        ...
        public NoEmojiView(Context context, boolean z) {
            ...
            this.textView.setText(LocaleController.getString(z ? C2797R.string.NoEmojiFound : C2797R.string.NoStickersFound));
        ...
        @Override // android.widget.FrameLayout, android.view.View
        public void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec((int) Math.max(AndroidUtilities.m1036dp(170.0f), (AndroidUtilities.displaySize.y * 0.34999996f) - AndroidUtilities.m1036dp(142.0f)), TLObject.FLAG_30));
        }
    }
    ...
    public class StoryWidgetsCell extends View {
        ...
        public StoryWidgetsCell(Context context) {
            ...
            if (EmojiBottomSheet.this.canShowWidget(4)) {
                arrayList.add(new Button(4, C2797R.drawable.msg_limit_links, LocaleController.getString(C2797R.string.StoryWidgetLink)).needsPremium());
            }
            if (EmojiBottomSheet.this.canShowWidget(0)) {
                arrayList.add(new Button(0, C2797R.drawable.map_pin3, LocaleController.getString(C2797R.string.StoryWidgetLocation)));
            }
            if (EmojiBottomSheet.this.canShowWidget(5)) {
                ...
                if (MessagesController.getInstance(((BottomSheet) EmojiBottomSheet.this).currentAccount).storyWeatherPreload) {
                    ...
                    if (PermissionRequest.hasPermission("android.permission.ACCESS_COARSE_LOCATION") && cached == null) {
                        ...
                        spannableStringBuilder.setSpan(new LoadingSpan(this, AndroidUtilities.m1036dp(68.0f)), 0, spannableStringBuilder.length(), 33);
            ...
            if (EmojiBottomSheet.this.canShowWidget(1)) {
                arrayList.add(new Button(1, C2797R.drawable.filled_widget_music, LocaleController.getString(C2797R.string.StoryWidgetAudio)));
            }
            if (EmojiBottomSheet.this.canShowWidget(2)) {
                arrayList.add(new Button(2, C2797R.drawable.filled_premium_camera, LocaleController.getString(C2797R.string.StoryWidgetPhoto)));
            }
        ...
        public class Button extends BaseWidget {
            ...
            public Button needsPremium() {
                if (!UserConfig.getInstance(((BottomSheet) EmojiBottomSheet.this).currentAccount).isPremium()) {
                    Drawable drawableMutate = StoryWidgetsCell.this.getContext().getResources().getDrawable(C2797R.drawable.msg_mini_lock3).mutate();
            ...
            public void draw(Canvas canvas, float f, float f2) {
                ...
                canvas.drawRoundRect(this.bounds, AndroidUtilities.m1036dp(8.0f), AndroidUtilities.m1036dp(8.0f), StoryWidgetsCell.this.bgPaint);
                ...
                if (this.drawable != null) {
                    int iM1036dp = AndroidUtilities.m1036dp(this.emojiDrawable == null ? 24.0f : 22.0f);
                    Drawable drawable = this.drawable;
                    float f3 = iM1036dp / 2;
                    int iM1036dp2 = (int) ((this.bounds.left + AndroidUtilities.m1036dp(18.0f)) - f3);
                    RectF rectF = this.bounds;
                    drawable.setBounds(iM1036dp2, (int) ((rectF.top + (this.height / 2.0f)) - f3), (int) (rectF.left + AndroidUtilities.m1036dp(18.0f) + f3), (int) (this.bounds.top + (this.height / 2.0f) + f3));
                    this.drawable.draw(canvas);
                }
                if (this.lockDrawable != null) {
                    RectF rectF2 = AndroidUtilities.rectTmp;
                    rectF2.set(this.bounds.left + AndroidUtilities.m1036dp(18.55f), ((this.bounds.top + this.height) - AndroidUtilities.m1036dp(5.0f)) - AndroidUtilities.m1036dp(12.55f), this.bounds.left + AndroidUtilities.m1036dp(29.45f), this.bounds.left + AndroidUtilities.m1036dp(31.0f));
                    canvas.drawRoundRect(rectF2, AndroidUtilities.m1036dp(6.0f), AndroidUtilities.m1036dp(6.0f), this.lockPaint);
                    this.lockDrawable.setBounds((int) (this.bounds.left + AndroidUtilities.m1036dp(18.0f)), (int) (((this.bounds.top + this.height) - AndroidUtilities.m1036dp(5.0f)) - AndroidUtilities.m1036dp(12.0f)), (int) (this.bounds.left + AndroidUtilities.m1036dp(30.0f)), (int) ((this.bounds.top + this.height) - AndroidUtilities.m1036dp(5.0f)));
                    this.lockDrawable.draw(canvas);
                    canvas.restore();
                }
                canvas.translate((this.bounds.left + AndroidUtilities.m1036dp(6 + ((this.drawable == null && this.emojiDrawable == null) ? 0 : 28))) - this.textLeft, (this.bounds.top + (this.height / 2.0f)) - (this.layout.getHeight() / 2.0f));
        ...
        public class ReactionWidget extends BaseWidget {
            ...
            public ReactionWidget() {
                ArrayList<ReactionsLayoutInBubble.VisibleReaction> arrayList;
                super();
                ...
                this.f1809id = 3;
                this.width = AndroidUtilities.m1036dp(44.0f);
                this.height = AndroidUtilities.m1036dp(36.0f);
                ...
                int i = 0;
                while (true) {
                    int iMin = Math.min(reactionsList.size(), 8);
                    arrayList = this.visibleReactions;
                    if (i >= iMin) {
                        break;
                    }
                    arrayList.add(ReactionsLayoutInBubble.VisibleReaction.fromEmojicon(reactionsList.get(i)));
                    i++;
                }
                Collections.sort(arrayList, new Comparator() { // from class: org.telegram.ui.Stories.recorder.EmojiBottomSheet$StoryWidgetsCell$ReactionWidget$$ExternalSyntheticLambda0
                    @Override // java.util.Comparator
                    public final int compare(Object obj, Object obj2) {
                        return EmojiBottomSheet.StoryWidgetsCell.ReactionWidget.m21112$r8$lambda$M0r5PWt2OPKJuCVT6lv8Fy7TH8((ReactionsLayoutInBubble.VisibleReaction) obj, (ReactionsLayoutInBubble.VisibleReaction) obj2);
                    }
                });
            ...
            public static /* synthetic */ int m21112$r8$lambda$M0r5PWt2OPKJuCVT6lv8Fy7TH8(ReactionsLayoutInBubble.VisibleReaction visibleReaction, ReactionsLayoutInBubble.VisibleReaction visibleReaction2) {
            ...
            @Override // org.telegram.ui.Stories.recorder.EmojiBottomSheet.StoryWidgetsCell.BaseWidget
            public void draw(Canvas canvas, float f, float f2) {
                float fM1036dp = f2 - AndroidUtilities.m1036dp(4.0f);
                float f3 = this.width;
                this.bounds.set((int) f, (int) fM1036dp, (int) (f + f3), (int) (fM1036dp + f3));
                float scale = this.bounce.getScale(0.05f);
                canvas.save();
                canvas.scale(scale, scale, this.bounds.centerX(), this.bounds.centerY());
        ...
        public void onMeasure(int i, int i2) {
            ...
            for (BaseWidget baseWidget : this.widgets) {
                baseWidget.layoutX = fM1036dp;
                fM1036dp += baseWidget.width + AndroidUtilities.m1036dp(10.0f);
                if (fM1036dp > paddingLeft) {
                    i3++;
                    baseWidget.layoutX = 0.0f;
                    fM1036dp = baseWidget.width + AndroidUtilities.m1036dp(10.0f) + 0.0f;
                }
            ...
            for (BaseWidget baseWidget2 : this.widgets) {
                ...
                float f = fArr2[i4];
                if (f > 0.0f) {
                    fArr2[i4] = f + AndroidUtilities.m1036dp(10.0f);
                }
                float[] fArr3 = this.lineWidths;
                fArr3[i4] = fArr3[i4] + baseWidget2.width;
            }
            setMeasuredDimension(size, AndroidUtilities.m1036dp(24.0f) + (AndroidUtilities.m1036dp(36.0f) * i3) + ((i3 - 1) * AndroidUtilities.m1036dp(12.0f)));
        }
        ...
        */
        public void dispatchDraw(android.graphics.Canvas r8) {
            ...
            Lc:
                ...
                goto L46
            Le:
                java.util.List<org.telegram.ui.Stories.recorder.EmojiBottomSheet$StoryWidgetsCell$BaseWidget> r0 = r7.widgets     // Catch: java.lang.Exception -> Lc
            ...
            L14:
                ...
                int r6 = org.telegram.messenger.AndroidUtilities.m1036dp(r6)     // Catch: java.lang.Exception -> Lc
            ...
            L49:
                java.util.List<org.telegram.ui.Stories.recorder.EmojiBottomSheet$StoryWidgetsCell$BaseWidget> r0 = r7.widgets
            ...
            L4f:
                ...
                int r5 = org.telegram.messenger.AndroidUtilities.m1036dp(r5)
                int r4 = r4 * r5
                int r3 = r3 + r4
                float r3 = (float) r3
                r1.draw(r8, r2, r3)
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            for (BaseWidget baseWidget : this.widgets) {
                if (baseWidget != next) {
                    baseWidget.bounce.setPressed(false);
                }
            }
            if (next != null) {
                next.bounce.setPressed((motionEvent.getAction() == 1 || motionEvent.getAction() == 3) ? false : true);
            }
            if (motionEvent.getAction() == 1 && next != null && (callback = this.onClickListener) != null) {
                callback.run(Integer.valueOf(next.f1809id));
            }
            return next != null;
        }
        ...
        public void onDetachedFromWindow() {
            ...
            Iterator<BaseWidget> it = this.widgets.iterator();
            while (it.hasNext()) {
                it.next().onAttachToWindow(false);
            }
        }
    }
