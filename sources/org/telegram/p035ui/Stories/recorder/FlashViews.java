...
public class FlashViews {
    ...
    public /* synthetic */ void lambda$flash$2(Utilities.Callback callback) {
        callback.run(new Utilities.Callback() { // from class: org.telegram.ui.Stories.recorder.FlashViews$$ExternalSyntheticLambda5
    ...
    private void flashTo(final float f, long j, final Runnable runnable) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Stories.recorder.FlashViews$$ExternalSyntheticLambda2
    ...
    public void drawGradient(Canvas canvas, boolean z) {
        if (this.gradient != null) {
            ...
            canvas.drawRoundRect(rectF, AndroidUtilities.m1036dp(12.0f) - 2, AndroidUtilities.m1036dp(12.0f) - 2, this.paint);
        }
    }
