...
public abstract class RoundVideoRecorder extends FrameLayout {
    ...
    public abstract void receivedAmplitude(double d);
    ...
    public void onMeasure(int i, int i2) {
        ...
        this.cameraView.measure(View.MeasureSpec.makeMeasureSpec(iMin, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(iMin, TLObject.FLAG_30));
        setMeasuredDimension(size, size2);
    }

    @Override // android.widget.FrameLayout, android.view.ViewGroup, android.view.View
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        int measuredWidth = ((i3 - i) - this.cameraView.getMeasuredWidth()) - AndroidUtilities.m1036dp(16.0f);
        int iM1036dp = AndroidUtilities.m1036dp(72.0f);
        CameraView cameraView = this.cameraView;
        cameraView.layout(measuredWidth, iM1036dp, cameraView.getMeasuredWidth() + measuredWidth, this.cameraView.getMeasuredHeight() + iM1036dp);
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        this.shadowPaint.setShadowLayer(AndroidUtilities.m1036dp(2.0f), 0.0f, AndroidUtilities.m1036dp(0.66f), Theme.multAlpha(536870912, this.alpha));
        ...
        if (this.recordingStarted > 0) {
            ...
            this.progressPaint.setShadowLayer(AndroidUtilities.m1036dp(1.0f), 0.0f, AndroidUtilities.m1036dp(0.33f), Theme.multAlpha(536870912, this.alpha));
            rectF.inset(-AndroidUtilities.m1036dp(7.665f), -AndroidUtilities.m1036dp(7.665f));
    ...
    public String sinceRecordingText() {
        ...
        int i2 = (int) ((jSinceRecording - ((long) (i * MediaDataController.MAX_STYLE_RUNS_COUNT))) / 100);
        int i3 = i / 60;
        int i4 = i % 60;
        StringBuilder sb = new StringBuilder();
        sb.append(i3);
        sb.append(":");
        sb.append(i4 < 10 ? MVEL.VERSION_SUB : _UrlKt.FRAGMENT_ENCODE_SET);
        sb.append(i4);
        sb.append(".");
        sb.append(i2);
        return sb.toString();
