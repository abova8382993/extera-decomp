...
public class ButtonWithCounterView extends FrameLayout implements Loadable {
    ...
    public void setRoundRadius(int i) {
        this.radiusDp = i;
        if (this.filled) {
            setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1036dp(i), this.backgroundColor));
        } else {
            setBackground(null);
        }
        updateColors();
    ...
    public void setFilled(boolean z) {
        ...
        this.filled = z;
        if (z) {
            setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1036dp(this.radiusDp), this.backgroundColor));
    ...
    public ButtonWithCounterView(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (z) {
            int iM1036dp = AndroidUtilities.m1036dp(this.radiusDp);
            int color = Theme.getColor(Theme.key_featuredStickers_addButton, resourcesProvider);
            this.backgroundColor = color;
            setBackground(Theme.createRoundRectDrawable(iM1036dp, color));
        }
        ...
        if (z) {
            ...
            animatedTextDrawable.setTypeface(AndroidUtilities.regular());
        }
        ...
        animatedTextDrawable3.setTextSize(AndroidUtilities.m1036dp(12.0f));
    ...
    public void setColor(int i) {
        if (this.filled) {
            ...
            setBackground(Theme.createRoundRectDrawable(iM1036dp, i));
            return;
        }
    ...
    public void setColor(int i, int i2) {
        if (this.filled) {
            setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1036dp(this.radiusDp), i));
            View view = this.rippleView;
    ...
    public void updateColors() {
        ...
        if (z2) {
            paint.setColor(this.countFilled ? color : this.backgroundColor);
        ...
        paint.setColor(Theme.getColor(Theme.key_featuredStickers_buttonText, this.resourcesProvider));
    ...
    public void setCountFilled(boolean z) {
        this.countFilled = z;
        this.countText.setTextSize(AndroidUtilities.m1036dp(z ? 12.0f : 14.0f));
        updateColors();
    }
    ...
    public void withCounterIcon() {
        ...
        Drawable drawableMutate = ContextCompat.getDrawable(getContext(), C2797R.drawable.mini_boost_button).mutate();
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.flickeringLoading) {
            ...
            LoadingDrawable loadingDrawable = this.flickeringLoadingDrawable;
            if (z2) {
                if (loadingDrawable == null) {
                    LoadingDrawable loadingDrawable2 = new LoadingDrawable(this.resourcesProvider);
                    this.flickeringLoadingDrawable = loadingDrawable2;
        ...
        if (f < 1.0f) {
            ...
            float fM1036dp = this.withCounterIcon ? AndroidUtilities.m1036dp(12.0f) : 0.0f;
            float fCalculateCounterWidth = currentWidth + fM1036dp + calculateCounterWidth(AndroidUtilities.m1036dp(17.66f) + this.countText.getCurrentWidth(), f2);
            ...
            rect.offset(0, (int) ((-AndroidUtilities.m1036dp(7.0f)) * this.subTextT));
            ...
            if (this.subTextVisible) {
                ...
                rect.set((int) (((getMeasuredWidth() - fCalculateCounterWidth) - getWidth()) / 2.0f), (int) (((getMeasuredHeight() - this.subText.getHeight()) / 2.0f) - AndroidUtilities.m1036dp(1.0f)), (int) ((((getMeasuredWidth() - fCalculateCounterWidth) + getWidth()) / 2.0f) + fCalculateCounterWidth), (int) (((getMeasuredHeight() + this.subText.getHeight()) / 2.0f) - AndroidUtilities.m1036dp(1.0f)));
                rect.offset(0, AndroidUtilities.m1036dp(11.0f));
                canvas.save();
            ...
            rect.set((int) (((getMeasuredWidth() - fCalculateCounterWidth) / 2.0f) + currentWidth + AndroidUtilities.m1036dp(this.countFilled ? 5.0f : 2.0f)), (int) ((getMeasuredHeight() - AndroidUtilities.m1036dp(18.0f)) / 2.0f), (int) (((getMeasuredWidth() - fCalculateCounterWidth) / 2.0f) + currentWidth + AndroidUtilities.m1036dp((this.countFilled ? 5 : 2) + 10) + Math.max(AndroidUtilities.m1036dp(9.0f), this.countText.getCurrentWidth() + fM1036dp)), (int) ((getMeasuredHeight() + AndroidUtilities.m1036dp(18.0f)) / 2.0f));
            ...
            if (this.countFilled) {
                ...
                float fM1036dp2 = AndroidUtilities.m1036dp(this.withCounterIcon ? 4.0f : 10.0f);
                canvas.drawRoundRect(rectF, fM1036dp2, fM1036dp2, this.paint);
            }
            rect.offset(-AndroidUtilities.m1036dp((this.countText.getText() != null ? this.countText.getText().length() : 0) > 1 ? 0.3f : 0.0f), -AndroidUtilities.m1036dp(0.2f));
            ...
            if (this.countFilled && this.withCounterIcon) {
                ...
                this.counterDrawable.setBounds(AndroidUtilities.m1036dp(1.0f) + rect.left, AndroidUtilities.m1036dp(2.0f) + rect.top, AndroidUtilities.m1036dp(1.0f) + rect.left + this.counterDrawable.getIntrinsicWidth(), AndroidUtilities.m1036dp(2.0f) + rect.top + this.counterDrawable.getIntrinsicHeight());
                this.counterDrawable.draw(canvas);
                canvas.translate(fM1036dp / 2.0f, 0.0f);
            }
    ...
    private int getWrapWidth() {
        return getPaddingLeft() + ((int) (this.text.getCurrentWidth() + (this.withCounterIcon ? AndroidUtilities.m1036dp(12.0f) : 0.0f) + calculateCounterWidth(AndroidUtilities.m1036dp(15.66f) + this.countText.getCurrentWidth(), this.countAlphaAnimated.set(this.countAlpha)))) + getPaddingRight();
    }
