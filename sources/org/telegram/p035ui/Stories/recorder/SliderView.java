...
public class SliderView extends View {
    ...
    public SliderView(Context context, int i) {
        ...
        if (i == 0) {
            animatedTextDrawable2.setTextSize(AndroidUtilities.m1036dp(15.0f));
            this.text2 = null;
            paint2.setColor(-1);
            paint3.setColor(-1);
            paint4.setColor(-1);
            ...
            animatedTextDrawable3.setTextSize(AndroidUtilities.m1036dp(14.0f));
            ...
            if (i == 1) {
                animatedTextDrawable3.setText(LocaleController.getString(C2797R.string.FlashWarmth));
            } else if (i == 2) {
                animatedTextDrawable3.setText(LocaleController.getString(C2797R.string.FlashIntensity));
            } else if (i == 3) {
                animatedTextDrawable3.setText(LocaleController.getString(C2797R.string.WallpaperDimming));
            }
        }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        rectF.set(0.0f, 0.0f, this.f1838w, this.f1836h);
        ...
        canvas.saveLayerAlpha(0.0f, 0.0f, this.f1838w, this.f1836h, 255, 31);
        if (this.currentType == 0) {
            this.text.setBounds(AndroidUtilities.m1036dp(42.0f), -AndroidUtilities.m1036dp(1.0f), this.f1838w, this.f1836h - AndroidUtilities.m1036dp(1.0f));
            this.text.draw(canvas);
        } else {
            this.text2.setBounds(AndroidUtilities.m1036dp(12.33f), -AndroidUtilities.m1036dp(1.0f), (this.f1838w - ((int) this.text.getCurrentWidth())) - AndroidUtilities.m1036dp(6.0f), this.f1836h - AndroidUtilities.m1036dp(1.0f));
            this.text2.draw(canvas);
            this.text.setBounds(this.f1838w - AndroidUtilities.m1036dp(111.0f), -AndroidUtilities.m1036dp(1.0f), this.f1838w - AndroidUtilities.m1036dp(11.0f), this.f1836h - AndroidUtilities.m1036dp(1.0f));
            this.text.draw(canvas);
        }
        if (this.currentType == 0) {
        ...
        canvas.save();
        canvas.drawRect(0.0f, 0.0f, this.f1838w * f2, this.f1836h, this.whitePaint);
        canvas.restore();
        canvas.restore();
        canvas.restore();
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (motionEvent.getAction() == 1 && System.currentTimeMillis() - this.pressTime < ViewConfiguration.getTapTimeout()) {
                ...
                this.value = x / this.f1838w;
                this.valueIsAnimated = true;
            } else {
                this.value = Utilities.clamp(this.value + ((x - this.lastTouchX) / this.f1838w), 1.0f, 0.0f);
                this.valueIsAnimated = false;
                z = true;
            }
    ...
    public void onMeasure(int i, int i2) {
        this.f1837r = AndroidUtilities.m1036dp(12.0f);
        ...
        if (i3 > 0) {
            this.f1838w = i3;
            this.f1836h = AndroidUtilities.m1036dp(48.0f);
        } else if (this.currentType == 0) {
            this.f1838w = (int) Math.min(this.textPaint.measureText(LocaleController.getString(C2797R.string.StoryAudioRemove)) + AndroidUtilities.m1036dp(88.0f), View.MeasureSpec.getSize(i));
            this.f1836h = AndroidUtilities.m1036dp(48.0f);
        } else {
            this.f1838w = AndroidUtilities.m1036dp(190.0f);
            this.f1836h = AndroidUtilities.m1036dp(44.0f);
        }
        setMeasuredDimension(this.f1838w, this.f1836h);
        if (this.currentType == 0) {
            float fM1036dp = AndroidUtilities.m1036dp(25.0f);
            float f = this.f1836h / 2.0f;
            this.speaker1Paint.setPathEffect(new CornerPathEffect(AndroidUtilities.dpf2(1.33f)));
            this.speaker1Path.rewind();
            this.speaker1Path.moveTo(fM1036dp - AndroidUtilities.dpf2(8.66f), f - AndroidUtilities.dpf2(2.9f));
            this.speaker1Path.lineTo(fM1036dp - AndroidUtilities.dpf2(3.0f), f - AndroidUtilities.dpf2(2.9f));
            this.speaker1Path.lineTo(fM1036dp - AndroidUtilities.dpf2(3.0f), AndroidUtilities.dpf2(2.9f) + f);
            this.speaker1Path.lineTo(fM1036dp - AndroidUtilities.dpf2(8.66f), AndroidUtilities.dpf2(2.9f) + f);
            ...
            this.speaker2Path.moveTo(fM1036dp - AndroidUtilities.dpf2(7.5f), f);
            this.speaker2Path.lineTo(fM1036dp, f - AndroidUtilities.dpf2(7.33f));
            this.speaker2Path.lineTo(fM1036dp, AndroidUtilities.dpf2(7.33f) + f);
            this.speaker2Path.close();
            this.speakerWave1Path.rewind();
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set((fM1036dp - AndroidUtilities.dpf2(0.33f)) - AndroidUtilities.m1036dp(4.33f), f - AndroidUtilities.m1036dp(4.33f), (fM1036dp - AndroidUtilities.dpf2(0.33f)) + AndroidUtilities.m1036dp(4.33f), AndroidUtilities.m1036dp(4.33f) + f);
            ...
            this.speakerWave2Paint.setStrokeWidth(AndroidUtilities.m1036dp(2.0f));
            this.speakerWave2Path.rewind();
            rectF.set((fM1036dp - AndroidUtilities.dpf2(0.33f)) - AndroidUtilities.m1036dp(8.0f), f - AndroidUtilities.m1036dp(8.0f), (fM1036dp - AndroidUtilities.dpf2(0.33f)) + AndroidUtilities.m1036dp(8.0f), f + AndroidUtilities.m1036dp(8.0f));
