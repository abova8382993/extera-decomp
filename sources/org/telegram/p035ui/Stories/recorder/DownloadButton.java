...
public class DownloadButton extends ImageView {
    ...
    public DownloadButton(Context context, Utilities.Callback<Runnable> callback, int i, FrameLayout frameLayout, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.progressDrawable = new CircularProgressDrawable(AndroidUtilities.m1036dp(18.0f), AndroidUtilities.m1036dp(2.0f), -1);
        updateImage();
    }
    ...
    public void onClickInternal() {
        ...
        if (storyEntry.wouldBeVideo()) {
            ...
            if (fileGeneratePicturePath == null) {
                this.toast.setDone(C2797R.raw.error, LocaleController.getString("UnknownError"), 3500);
                this.downloading = false;
                updateImage();
                return;
            }
    ...
    public /* synthetic */ void lambda$onClickInternal$2(Uri uri) {
        ...
        this.toast.setDone(C2797R.raw.ic_save_to_gallery, LocaleController.getString("VideoSavedHint"), 3500);
        this.downloading = false;
        updateImage();
    ...
    public /* synthetic */ void lambda$onClickInternal$5() {
        ...
        this.toast.setDone(C2797R.raw.error, LocaleController.getString("VideoConvertFail"), 3500);
        this.downloading = false;
        updateImage();
    }
    ...
    public /* synthetic */ void lambda$onClickInternal$6(Uri uri) {
        ...
        preparingVideoToast2.setDone(C2797R.raw.ic_save_to_gallery, LocaleController.getString("PhotoSavedHint"), 2500);
        this.container.addView(this.toast);
        this.savedToGalleryUri = uri;
    }
    ...
    private void updateImage() {
        ...
        if (z != (z2 && !this.downloadingVideo)) {
            ...
            if (z4) {
                ...
                AndroidUtilities.updateImageViewImageAnimated(this, C2797R.drawable.media_download);
            }
        }
    ...
    public void showFailedVideo() {
        showToast(C2797R.raw.error, LocaleController.getString("VideoConvertFail"));
    }
    ...
    public static class PreparingVideoToast extends View {
        ...
        private final AnimatedFloat f1803t;
        ...
        public PreparingVideoToast(Context context) {
            this(context, LocaleController.getString(C2797R.string.PreparingVideo));
        }
        ...
        public PreparingVideoToast(Context context, String str) {
            ...
            this.preparing = true;
            this.progress = 0.0f;
            this.f1803t = new AnimatedFloat(this);
            ...
            paint3.setStrokeWidth(AndroidUtilities.m1036dp(4.0f));
            paint4.setStyle(style);
            paint4.setStrokeCap(cap);
            paint4.setStrokeWidth(AndroidUtilities.m1036dp(4.0f));
        ...
        public void onDraw(Canvas canvas) {
            ...
            float f2 = this.f1803t.set(this.preparing ? 0.0f : 1.0f);
            float f3 = 1.0f - f2;
            this.dimPaint.setAlpha((int) (90.0f * f3 * f));
            canvas.drawRect(0.0f, 0.0f, getWidth(), getHeight(), this.dimPaint);
            float fMax = Math.max(this.preparingLayoutWidth, AndroidUtilities.m1036dp(54.0f)) + AndroidUtilities.m1036dp(42.0f);
            float fM1036dp = AndroidUtilities.m1036dp(111.0f) + this.preparingLayout.getHeight();
            this.prepareRect.set((getWidth() - fMax) / 2.0f, (getHeight() - fM1036dp) / 2.0f, (getWidth() + fMax) / 2.0f, (getHeight() + fM1036dp) / 2.0f);
            float fM1036dp2 = AndroidUtilities.m1036dp(74.0f) + this.doneLayoutWidth;
            float fM1036dp3 = AndroidUtilities.m1036dp(48.0f);
            this.toastRect.set((getWidth() - fM1036dp2) / 2.0f, (getHeight() - fM1036dp3) / 2.0f, (getWidth() + fM1036dp2) / 2.0f, (getHeight() + fM1036dp3) / 2.0f);
            ...
            canvas.drawRoundRect(this.currentRect, AndroidUtilities.m1036dp(10.0f), AndroidUtilities.m1036dp(10.0f), this.backgroundPaint);
            canvas.save();
        ...
        private void drawPreparing(Canvas canvas, float f) {
            ...
            float fM1036dp = this.prepareRect.top + AndroidUtilities.m1036dp(48.0f);
            float fM1036dp2 = AndroidUtilities.m1036dp(25.0f);
            this.greyPaint.setAlpha((int) (51.0f * f));
            canvas.drawCircle(fCenterX, fM1036dp, fM1036dp2, this.greyPaint);
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(fCenterX - fM1036dp2, fM1036dp - fM1036dp2, fCenterX + fM1036dp2, fM1036dp2 + fM1036dp);
            int i = (int) (255.0f * f);
            this.whitePaint.setAlpha(i);
            this.whitePaint.setStrokeWidth(AndroidUtilities.m1036dp(4.0f));
            canvas.drawArc(rectF, -90.0f, f2 * 360.0f, false, this.whitePaint);
            float scale = this.cancelButton.getScale(0.15f);
            canvas.save();
            canvas.scale(scale, scale, fCenterX, fM1036dp);
            this.whitePaint.setStrokeWidth(AndroidUtilities.m1036dp(3.4f));
            canvas.drawLine(fCenterX - AndroidUtilities.m1036dp(7.0f), fM1036dp - AndroidUtilities.m1036dp(7.0f), AndroidUtilities.m1036dp(7.0f) + fCenterX, AndroidUtilities.m1036dp(7.0f) + fM1036dp, this.whitePaint);
            canvas.drawLine(fCenterX - AndroidUtilities.m1036dp(7.0f), fM1036dp + AndroidUtilities.m1036dp(7.0f), fCenterX + AndroidUtilities.m1036dp(7.0f), fM1036dp - AndroidUtilities.m1036dp(7.0f), this.whitePaint);
            canvas.restore();
            canvas.save();
            canvas.translate((this.prepareRect.left + AndroidUtilities.m1036dp(21.0f)) - this.preparingLayoutLeft, (this.prepareRect.bottom - AndroidUtilities.m1036dp(18.0f)) - this.preparingLayout.getHeight());
        ...
        private void drawToast(Canvas canvas, float f) {
            ...
            if (rLottieDrawable != null) {
                ...
                this.lottieDrawable.setBounds((int) (this.toastRect.left + AndroidUtilities.m1036dp(9.0f)), (int) (this.toastRect.top + AndroidUtilities.m1036dp(6.0f)), (int) (this.toastRect.left + AndroidUtilities.m1036dp(45.0f)), (int) (this.toastRect.top + AndroidUtilities.m1036dp(42.0f)));
                this.lottieDrawable.draw(canvas);
            }
            if (this.doneLayout != null) {
                canvas.save();
                canvas.translate((this.toastRect.left + AndroidUtilities.m1036dp(52.0f)) - this.doneLayoutLeft, this.toastRect.centerY() - (this.doneLayout.getHeight() / 2.0f));
        ...
        public void setDone(int i, CharSequence charSequence, int i2) {
            ...
            RLottieDrawable rLottieDrawable2 = new RLottieDrawable(i, _UrlKt.FRAGMENT_ENCODE_SET + i, AndroidUtilities.m1036dp(36.0f), AndroidUtilities.m1036dp(36.0f));
