...
public abstract class StoryModeTabs extends FrameLayout implements FlashViews.Invertable {
    ...
    public abstract boolean allowTouch();
    ...
    public StoryModeTabs(Context context) {
        ...
        LinearLayout linearLayout = new LinearLayout(context) { // from class: org.telegram.ui.Stories.recorder.StoryModeTabs.1
            ...
            private final RectF f1839a = new RectF();

            /* JADX INFO: renamed from: b */
            private final RectF f1840b = new RectF();

            /* JADX INFO: renamed from: c */
            private final RectF f1841c = new RectF();
            private final Paint backgroundPaint = new Paint(1);

            private void setRect(int i, RectF rectF) {
                StoryModeTabs storyModeTabs = StoryModeTabs.this;
                FrameLayout frameLayout = i <= -1 ? storyModeTabs.liveLayout : i >= 1 ? storyModeTabs.videoLayout : storyModeTabs.photoLayout;
                rectF.set(frameLayout.getLeft(), frameLayout.getBottom() - AndroidUtilities.m1036dp(30.0f), frameLayout.getRight(), frameLayout.getBottom());
            }

            @Override // android.view.ViewGroup, android.view.View
            public void dispatchDraw(Canvas canvas) {
                setRect((int) Math.floor(StoryModeTabs.this.mode), this.f1839a);
                setRect((int) Math.ceil(StoryModeTabs.this.mode), this.f1840b);
                AndroidUtilities.lerp(this.f1839a, this.f1840b, StoryModeTabs.this.mode - ((float) Math.floor(StoryModeTabs.this.mode)), this.f1841c);
                this.backgroundPaint.setColor(Theme.multAlpha(ColorUtils.blendARGB(-1, -16777216, StoryModeTabs.this.invert), 0.15f));
                RectF rectF = this.f1841c;
                canvas.drawRoundRect(rectF, rectF.height() / 2.0f, this.f1841c.height() / 2.0f, this.backgroundPaint);
        ...
        textView.setText(LocaleController.getString(C2797R.string.StoryLive));
        ...
        textView2.setText(LocaleController.getString(C2797R.string.StoryPhoto));
        ...
        textView3.setText(LocaleController.getString(C2797R.string.StoryVideo));
    ...
    private void switchModeInternal(int i) {
        ...
        switchMode(i);
        Utilities.Callback<Integer> callback = this.onSwitchModeListener;
        if (callback != null) {
