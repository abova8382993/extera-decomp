...
import org.telegram.p035ui.Stories.recorder.ScannedLinkPreview;
...
public class ScannedLinkPreview extends View {
    ...
    public void whenClicked(Utilities.Callback<Utilities.Callback<BaseFragment>> callback) {
    ...
    private void setup() {
        ...
        if (spannableStringBuilder.toString().contains(">")) {
            ...
            spannableStringBuilder.append((CharSequence) ">");
            ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C2797R.drawable.settings_arrow);
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        float fM1036dp5 = AndroidUtilities.m1036dp(11.0f);
        float fMax = Math.max(Math.min(AndroidUtilities.m1036dp(200.0f), getWidth() * 0.8f), (this.hasImage ? fM1036dp5 + fM1036dp3 + fM1036dp5 : 0.0f) + fM1036dp + Math.max(this.title.getCurrentWidth(), this.subtitle.getCurrentWidth()) + AndroidUtilities.m1036dp(15.0f) + fM1036dp);
        float fMax2 = Math.max(this.hasImage ? fM1036dp3 : 0.0f, this.title.getHeight() + fM1036dp4 + this.subtitle.getHeight()) + fM1036dp2 + fM1036dp2;
        float scale = this.bounce.getScale(0.05f) * AndroidUtilities.lerp(0.6f, 1.0f, f);
        float fM1036dp6 = AndroidUtilities.m1036dp(15.0f) * (1.0f - f);
        ...
        this.clipBounds.offset(0.0f, fM1036dp6);
        if (Build.VERSION.SDK_INT >= 29 && (obj = this.blurRenderNode) != null && this.blurView != null) {
            ...
            this.clipPath.addRoundRect(this.clipBounds, AndroidUtilities.m1036dp(12.0f), AndroidUtilities.m1036dp(12.0f), Path.Direction.CW);
            ...
            float fMax3 = Math.max(this.blurView.getWidth() / renderNodeM1042m.getWidth(), this.blurView.getHeight() / renderNodeM1042m.getHeight());
            canvas.scale(fMax3, fMax3);
            canvas.drawRenderNode(renderNodeM1042m);
            canvas.restore();
            this.backgroundPaint.setColor(Theme.multAlpha(1879048192, f));
            canvas.drawRoundRect(this.clipBounds, AndroidUtilities.m1036dp(12.0f), AndroidUtilities.m1036dp(12.0f), this.backgroundPaint);
        } else {
            this.backgroundPaint.setColor(Theme.multAlpha(-587202560, f));
            canvas.drawRoundRect(this.clipBounds, AndroidUtilities.m1036dp(12.0f), AndroidUtilities.m1036dp(12.0f), this.backgroundPaint);
        }
        canvas.save();
        canvas.translate(0.0f, fM1036dp6);
        canvas.scale(scale, scale, this.bounds.centerX(), this.bounds.centerY());
        if (this.hasImage) {
            float f2 = fM1036dp3 / 2.0f;
            this.imageReceiver.setRoundRadius((int) f2);
            ImageReceiver imageReceiver = this.imageReceiver;
            RectF rectF = this.bounds;
            imageReceiver.setImageCoords(rectF.left + fM1036dp + fM1036dp5, rectF.centerY() - f2, fM1036dp3, fM1036dp3);
            this.imageReceiver.setAlpha(f);
            this.imageReceiver.draw(canvas);
        }
        float fCenterY = this.bounds.centerY() - (((this.title.getHeight() + fM1036dp4) + this.subtitle.getHeight()) / 2.0f);
        Text text2 = this.title;
        text2.draw(canvas, this.bounds.left + (this.hasImage ? fM1036dp5 + fM1036dp3 + fM1036dp5 : 0.0f) + fM1036dp, fCenterY + (text2.getHeight() / 2.0f), -1, f);
        this.subtitle.draw(canvas, this.bounds.left + (this.hasImage ? fM1036dp3 + fM1036dp5 + fM1036dp5 : 0.0f) + fM1036dp, fCenterY + this.title.getHeight() + fM1036dp4 + (this.subtitle.getHeight() / 2.0f), Theme.blendOver(-16777216, -1610612737), f);
        canvas.restore();
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        Utilities.Callback<Utilities.Callback<BaseFragment>> callback;
    ...
    public static class ResolvedLink {
        ...
        public static Runnable resolve(int i, final String str, final Utilities.Callback<ResolvedLink> callback) {
            if (callback == null) {
                return null;
            }
            try {
                ...
                return messagesController.getUserNameResolver().resolve(str3, queryParameter, new Consumer() { // from class: org.telegram.ui.Stories.recorder.ScannedLinkPreview$ResolvedLink$$ExternalSyntheticLambda0
                    ...
                    public final void accept(Object obj) {
                        ScannedLinkPreview.ResolvedLink.m21318$r8$lambda$ZU95PTWNIUggcw96yv0AFkIIfE(callback, messagesController, str, (Long) obj);
                    }
                });
            } catch (Exception e) {
                FileLog.m1048e(e);
        ...
        public static /* synthetic */ void m21318$r8$lambda$ZU95PTWNIUggcw96yv0AFkIIfE(Utilities.Callback callback, MessagesController messagesController, String str, Long l) {
            if (l == null) {
                callback.run(null);
                return;
            }
        ...
        public static ResolvedLink fromUser(String str, final TLRPC.User user) {
            ...
            return new ResolvedLink(str) { // from class: org.telegram.ui.Stories.recorder.ScannedLinkPreview.ResolvedLink.1
                ...
                public String getSubtitle() {
                    return LocaleController.getString(C2797R.string.ViewProfile);
                }
                ...
                public void open(BaseFragment baseFragment) {
                    ...
                    baseFragment.presentFragment(ProfileActivity.m1186of(user.f1407id));
                }
            };
        }
        ...
        public static ResolvedLink fromChat(String str, final TLRPC.Chat chat) {
            ...
            return new ResolvedLink(str) { // from class: org.telegram.ui.Stories.recorder.ScannedLinkPreview.ResolvedLink.2
                ...
                @Override // org.telegram.ui.Stories.recorder.ScannedLinkPreview.ResolvedLink
                public String getSubtitle() {
                    return LocaleController.getString(C2797R.string.AccDescrOpenChat);
                }
                ...
                @Override // org.telegram.ui.Stories.recorder.ScannedLinkPreview.ResolvedLink
                public void open(BaseFragment baseFragment) {
                    baseFragment.presentFragment(ChatActivity.m1139of(-chat.f1245id));
                }
            };
        }
    }
