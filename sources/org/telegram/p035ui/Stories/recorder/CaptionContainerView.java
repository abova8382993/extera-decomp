...
import org.telegram.p035ui.Components.CaptionPhotoViewer;
...
public abstract class CaptionContainerView extends FrameLayout {
    ...
    /* JADX INFO: renamed from: onTextChange, reason: merged with bridge method [inline-methods] */
    ...
    public CaptionContainerView(Context context, FrameLayout frameLayout, SizeNotifierFrameLayout sizeNotifierFrameLayout, FrameLayout frameLayout2, final Theme.ResourcesProvider resourcesProvider, final BlurringShader.BlurManager blurManager) {
        ...
        LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.m1036dp(10.0f), new int[]{Opcodes.V_PREVIEW, 0}, new float[]{0.05f, 1.0f}, Shader.TileMode.CLAMP);
        ...
        strokeDrawable.setColorProvider(new BlurredBackgroundColorProviderThemed(resourcesProvider, i, f) { // from class: org.telegram.ui.Stories.recorder.CaptionContainerView.1
            @Override // org.telegram.p035ui.Components.blur3.drawable.color.BlurredBackgroundColorProviderThemed
        ...
        EditTextEmoji editTextEmoji = new EditTextEmoji(context, sizeNotifierFrameLayout, null, getEditTextStyle(), true, new DarkThemeResourceProvider()) { // from class: org.telegram.ui.Stories.recorder.CaptionContainerView.3
                ...
                if (emojiView != null) {
                    ...
                    emojiView.setOutlineProvider(new ViewOutlineProvider() { // from class: org.telegram.ui.Stories.recorder.CaptionContainerView.3.1
                        ...
                        public void getOutline(View view, Outline outline) {
                            outline.setRoundRect(0, 0, view.getWidth(), view.getHeight() + AndroidUtilities.m1036dp(29.0f), AndroidUtilities.m1036dp(29.0f));
                        }
                    });
                }
            }
            ...
            public void drawEmojiBackground(Canvas canvas, View view) {
                ...
                CaptionContainerView.this.rectF.set(0.0f, 0.0f, view.getWidth(), view.getHeight() + AndroidUtilities.m1036dp(29.0f));
                CaptionContainerView captionContainerView = CaptionContainerView.this;
                if (captionContainerView.factoryForMentions != null) {
                    if (this.blurredBackgroundDrawable == null) {
                        ...
                        colorProvider.setRadius(AndroidUtilities.m1036dp(29.0f), AndroidUtilities.m1036dp(29.0f), radius2, radius, true);
                        this.blurredBackgroundDrawable.enableInAppKeyboardOptimization();
                        this.blurredBackgroundDrawable.setThickness(AndroidUtilities.m1036dp(32.0f));
                ...
                if (captionContainerView.customBlur()) {
                    ...
                    captionContainerView2.drawBlur(this.blurDrawer, canvas, captionContainerView2.rectF, AndroidUtilities.m1036dp(29.0f), false, 0.0f, -view.getY(), false, 1.0f);
                    CaptionContainerView.this.strokeDrawableEmoji.radius = AndroidUtilities.m1036dp(29.0f);
                    CaptionContainerView captionContainerView3 = CaptionContainerView.this;
                    captionContainerView3.strokeDrawableEmoji.setBounds((int) captionContainerView3.rectF.left, (int) CaptionContainerView.this.rectF.top, (int) CaptionContainerView.this.rectF.right, ((int) CaptionContainerView.this.rectF.bottom) + AndroidUtilities.m1036dp(29.0f));
            ...
            @Override // org.telegram.p035ui.Components.EditTextEmoji
            public boolean onScrollYChange(int i2) {
        ...
        editTextEmoji.getEditText().setHintText(LocaleController.getString(C2797R.string.AddCaption), false);
        paint3.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_IN));
        editTextEmoji.getEditText().setTranslationX(AndroidUtilities.m1036dp(-26.0f));
        if (isAtTop()) {
            editTextEmoji.getEditText().setGravity(48);
        }
        editTextEmoji.getEmojiButton().setAlpha(0.0f);
        editTextEmoji.getEmojiButton().setTranslationY(AndroidUtilities.m1036dp(isAtTop() ? 1.0f : -1.0f));
        editTextEmoji.setTranslationY(AndroidUtilities.m1036dp(isAtTop() ? 1.0f : -1.0f));
        editTextEmoji.getEditText().addTextChangedListener(new C70324());
        ...
        Drawable drawableMutate = context.getResources().getDrawable(C2797R.drawable.input_done).mutate();
        ...
        CombinedDrawable combinedDrawable = new CombinedDrawable(Theme.createCircleDrawable(AndroidUtilities.m1036dp(18.0f), Theme.getColor(Theme.key_chat_editMediaButton, resourcesProvider)), this.applyButtonCheck, 0, AndroidUtilities.m1036dp(1.0f));
        this.applyButtonDrawable = combinedDrawable;
        combinedDrawable.setCustomSize(AndroidUtilities.m1036dp(36.0f), AndroidUtilities.m1036dp(36.0f));
        ...
        this.limitTextView.setTextSize(AndroidUtilities.m1036dp(15.0f));
        ...
        frameLayout3.setTranslationX(AndroidUtilities.m1036dp(2.0f));
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Stories.recorder.CaptionContainerView$4 */
    public class C70324 implements TextWatcher {
        ...
        public void afterTextChanged(Editable editable) {
            ...
            if (CaptionContainerView.this.codePointCount + 25 > captionLimit) {
                str = _UrlKt.FRAGMENT_ENCODE_SET + (captionLimit - CaptionContainerView.this.codePointCount);
            } else {
                str = null;
            }
    ...
    public void createMentionsContainer() {
        MentionsContainerView mentionsContainerView = new MentionsContainerView(getContext(), this.dialogId, 0L, LaunchActivity.getLastFragment(), new DarkThemeResourceProvider()) { // from class: org.telegram.ui.Stories.recorder.CaptionContainerView.5
            ...
            public void drawRoundRect(Canvas canvas, Rect rect, float f) {
                ...
                boolean zCustomBlur = CaptionContainerView.this.customBlur();
                CaptionContainerView captionContainerView = CaptionContainerView.this;
                if (zCustomBlur) {
                ...
                Paint paint = captionContainerView.mentionBackgroundBlur.getPaint(1.0f);
                CaptionContainerView captionContainerView2 = CaptionContainerView.this;
                if (paint == null) {
        ...
        MentionsContainerView.Delegate delegate = new MentionsContainerView.Delegate() { // from class: org.telegram.ui.Stories.recorder.CaptionContainerView.6
    ...
    public int getEditTextHeightClosedKeyboard() {
        return Math.min(AndroidUtilities.m1036dp(82.0f), this.editText.getHeight());
    }
    ...
    public void updateKeyboard(int i) {
        ...
        if (!isAtTop()) {
            ...
            if (iMax > iM1036dp) {
                objectAnimator2.setInterpolator(AdjustPanLayoutHelper.keyboardInterpolator);
                this.parentKeyboardAnimator.setDuration(250L);
            } else {
                objectAnimator2.setInterpolator(CubicBezierInterpolator.EASE_OUT_QUINT);
                this.parentKeyboardAnimator.setDuration(640L);
            }
            this.parentKeyboardAnimator.start();
        }
        this.toKeyboardShow = iMax > AndroidUtilities.m1036dp(20.0f);
        AndroidUtilities.cancelRunOnUIThread(this.updateShowKeyboard);
        AndroidUtilities.runOnUIThread(this.updateShowKeyboard);
        if (iMax < AndroidUtilities.m1036dp(20.0f)) {
    ...
    public void updateEditTextLeft() {
        this.editText.getEditText().setTranslationX(AndroidUtilities.lerp(AndroidUtilities.m1036dp(-26.0f) + getEditTextLeft(), AndroidUtilities.m1036dp(2.0f), this.keyboardT));
    }
    ...
    private void updateShowKeyboard(final boolean z, boolean z2) {
        ...
        if (z2) {
            ...
            if (z) {
                valueAnimator2.setInterpolator(AdjustPanLayoutHelper.keyboardInterpolator);
            ...
            this.editText.getEditText().setTranslationX(AndroidUtilities.lerp(AndroidUtilities.m1036dp(-26.0f) + getEditTextLeft(), AndroidUtilities.m1036dp(2.0f), this.keyboardT));
            this.limitTextContainer.setTranslationX(AndroidUtilities.lerp(-AndroidUtilities.m1036dp(8.0f), AndroidUtilities.m1036dp(2.0f), this.keyboardT));
            this.limitTextContainer.setTranslationY(AndroidUtilities.lerp(-AndroidUtilities.m1036dp(8.0f), 0, this.keyboardT));
    ...
    public boolean onBackPressed() {
        ...
        if (editTextEmoji.emojiExpanded && editTextEmoji.getEmojiView() != null) {
            boolean zKeyboardVisible = this.keyboardNotifier.keyboardVisible();
            EditTextEmoji editTextEmoji2 = this.editText;
            if (zKeyboardVisible) {
                editTextEmoji2.getEmojiView().hideSearchKeyboard();
            } else {
                editTextEmoji2.collapseEmojiView();
            }
            return true;
        }
        boolean zIsPopupShowing = this.editText.isPopupShowing();
        EditTextEmoji editTextEmoji3 = this.editText;
        if (zIsPopupShowing) {
            editTextEmoji3.hidePopup(true);
            return true;
        }
        if ((!editTextEmoji3.isKeyboardVisible() && !this.keyboardNotifier.keyboardVisible()) || this.keyboardNotifier.ignoring) {
            return false;
        }
        closeKeyboard();
        return true;
    ...
    private void drawReply(Canvas canvas) {
        ...
        float f2 = 1.0f;
        if (this.collapsed) {
            boolean z = this.keyboardShown;
            RectF rectF = this.bounds;
            if (z) {
                f = rectF.bottom;
                iMin = Math.max(AndroidUtilities.m1036dp(46.0f), this.editText.getHeight());
            } else {
                f = rectF.bottom;
                iMin = Math.min(AndroidUtilities.m1036dp(82.0f), this.editText.getHeight());
            }
            float f3 = f - iMin;
            f2 = 1.0f - this.collapsedT.get();
            fM1036dp = f3 - AndroidUtilities.m1036dp(50.0f);
        } else {
            fM1036dp = this.bounds.top;
        }
        float f4 = fM1036dp;
        float f5 = f2;
        ...
        rectF2.set(this.bounds.left + AndroidUtilities.m1036dp(10.0f), AndroidUtilities.m1036dp(10.0f) + f4, this.bounds.right - AndroidUtilities.m1036dp(10.0f), AndroidUtilities.m1036dp(52.0f) + f4);
        if (paint != null) {
            canvas2.drawRoundRect(rectF2, AndroidUtilities.m1036dp(5.0f), AndroidUtilities.m1036dp(5.0f), paint);
        }
        if (paint2 != null) {
            RectF rectF3 = this.bounds;
            canvas2.saveLayerAlpha(rectF3.left, rectF3.top, rectF3.right, rectF3.bottom, 255, 31);
        }
        ...
        float fLerp = AndroidUtilities.lerp(AndroidUtilities.m1036dp(21.0f), 0, this.keyboardT);
        Path path2 = this.replyClipPath;
        RectF rectF4 = this.bounds;
        Path.Direction direction = Path.Direction.CW;
        path2.addRoundRect(rectF4, fLerp, fLerp, direction);
        canvas2.clipPath(this.replyClipPath);
        Text text = this.replyTitle;
        if (text != null) {
            text.ellipsize((int) (this.bounds.width() - AndroidUtilities.m1036dp(40.0f))).draw(canvas2, this.bounds.left + AndroidUtilities.m1036dp(20.0f), AndroidUtilities.m1036dp(22.0f) + f4, -1, 1.0f);
            canvas2 = canvas2;
        }
        ...
        if (path3 == null) {
            ...
            fArr2[5] = 0.0f;
            fArr2[4] = 0.0f;
            float fM1036dp3 = AndroidUtilities.m1036dp(5.0f);
            fArr2[7] = fM1036dp3;
            fArr2[6] = fM1036dp3;
        } else {
            path3.rewind();
        ...
        rectF2.set(f6, rectF2.top, AndroidUtilities.m1036dp(3.0f) + f6, rectF2.bottom);
        this.replyLinePath.addRoundRect(rectF2, this.replyLinePathRadii, direction);
        ...
        if (text2 != null) {
            text2.ellipsize((int) (this.bounds.width() - AndroidUtilities.m1036dp(40.0f))).draw(canvas2, this.bounds.left + AndroidUtilities.m1036dp(20.0f), AndroidUtilities.m1036dp(40.0f) + f4, -1, 1.0f);
        }
    }
    ...
    */
    public void dispatchDraw(android.graphics.Canvas r30) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Stories.recorder.CaptionContainerView.dispatchDraw(android.graphics.Canvas):void");
    }
    ...
    public boolean drawChild(Canvas canvas, View view, long j) {
        if (view == this.editText) {
            float fMax = isAtTop() ? 0.0f : Math.max(0, (this.editText.getHeight() - AndroidUtilities.m1036dp(82.0f)) - this.editText.getScrollY()) * (1.0f - this.keyboardT);
            ...
            float f = rectF.left;
            float f2 = rectF.top;
            canvas.drawRect(f, f2, rectF.right, AndroidUtilities.m1036dp(10.0f) + f2, this.fadePaint);
            this.matrix.reset();
            ...
            float fM1036dp = rectF2.bottom - AndroidUtilities.m1036dp(10.0f);
            RectF rectF3 = this.bounds;
            canvas.drawRect(f3, fM1036dp, rectF3.right, rectF3.bottom, this.fadePaint);
            canvas.restore();
            canvas.restore();
            return zDrawChild;
        }
    ...
    public void updateColors(Theme.ResourcesProvider resourcesProvider) {
        ...
        this.applyButtonDrawable.setBackgroundDrawable(Theme.createCircleDrawable(AndroidUtilities.m1036dp(16.0f), Theme.getColor(Theme.key_chat_editMediaButton, resourcesProvider)));
    }
    ...
    public void onAttachedToWindow() {
        ...
        if (customBlur()) {
            ...
            this.hintTextPaint.setTextSize(AndroidUtilities.m1036dp(16.0f));
            String string = LocaleController.getString(C2797R.string.AddCaption);
    ...
    public static class PeriodDrawable extends Drawable {
        ...
        public void setBounds(Rect rect) {
            ...
            this.f1793cx = getBounds().centerX();
            this.f1794cy = getBounds().centerY();
        }
        ...
        public void draw(Canvas canvas, float f) {
            ...
            if (f2 > 0.0f) {
                ...
                canvas.drawCircle(this.f1793cx, this.f1794cy, AndroidUtilities.dpf2(11.33f) * f2, this.fillPaint);
            }
            this.strokePaint.setAlpha((int) (Color.alpha(this.strokeColor) * f * (1.0f - f2)));
            RectF rectF = AndroidUtilities.rectTmp;
            float f3 = this.f1793cx;
            float f4 = this.f1794cy;
            ...
            while (i2 < this.dashes) {
                float f9 = f6;
                canvas.drawArc(AndroidUtilities.rectTmp, 270.0f + f8, f9, false, this.strokePaint);
                f8 += f9 + f7;
                i2++;
                f6 = f9;
            }
            ...
            Rect rect = AndroidUtilities.rectTmp2;
            rect.set((int) (this.f1793cx - AndroidUtilities.m1036dp(20.0f)), (int) (this.f1794cy - AndroidUtilities.m1036dp(20.0f)), (int) (this.f1793cx + AndroidUtilities.m1036dp(20.0f)), (int) (this.f1794cy + AndroidUtilities.m1036dp(20.0f)));
            this.textDrawable.setBounds(rect);
            this.textDrawable.setAlpha((int) (Color.alpha(this.strokeColor) * f));
            this.textDrawable.draw(canvas);
            if (f2 > 0.0f) {
                this.activePath.rewind();
                this.activePath.addCircle(this.f1793cx, this.f1794cy + AndroidUtilities.m1036dp(1.0f), AndroidUtilities.dpf2(11.33f) * f2, Path.Direction.CW);
        ...
        public void setValue(int i, boolean z, boolean z2) {
            this.textDrawable.setText(_UrlKt.FRAGMENT_ENCODE_SET + i, z2);
            this.activeTextDrawable.setText(_UrlKt.FRAGMENT_ENCODE_SET + i, z2);
            this.filled = z;
            if (!z2) {
