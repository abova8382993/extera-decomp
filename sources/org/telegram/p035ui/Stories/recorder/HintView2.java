...
import org.telegram.p035ui.ProfileActivity$$ExternalSyntheticLambda71;
...
public class HintView2 extends View {
    ...
    public HintView2(Context context, int i) {
        ...
        this.rounding = AndroidUtilities.m1036dp(8.0f);
        this.innerPadding = new RectF(AndroidUtilities.m1036dp(11.0f), AndroidUtilities.m1036dp(6.0f), AndroidUtilities.m1036dp(11.0f), AndroidUtilities.m1036dp(7.0f));
        this.closeButtonMargin = AndroidUtilities.m1036dp(2.0f);
        this.arrowHalfWidth = AndroidUtilities.m1036dp(7.0f);
        this.arrowHeight = AndroidUtilities.m1036dp(6.0f);
        ...
        this.iconMargin = AndroidUtilities.m1036dp(2.0f);
    ...
    public HintView2 setRounding(float f) {
        this.rounding = AndroidUtilities.m1036dp(f);
    ...
    public HintView2 setFlicker(float f, int i) {
        ...
        LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, AndroidUtilities.m1036dp(64.0f), 0.0f, new int[]{Theme.multAlpha(i, 0.0f), Theme.multAlpha(i, 1.0f), Theme.multAlpha(i, 0.0f)}, new float[]{0.0f, 0.5f, 1.0f}, tileMode);
        this.flickerStrokeGradient = linearGradient;
        this.flickerStrokePaint.setShader(linearGradient);
        this.flickerGradient = new LinearGradient(0.0f, 0.0f, AndroidUtilities.m1036dp(64.0f), 0.0f, new int[]{Theme.multAlpha(i, 0.0f), Theme.multAlpha(i, 0.5f), Theme.multAlpha(i, 0.0f)}, new float[]{0.0f, 0.5f, 1.0f}, tileMode);
    ...
    public HintView2 setMultilineText(boolean z) {
        ...
        if (z) {
            rectF.set(AndroidUtilities.m1036dp(15.0f), AndroidUtilities.m1036dp(8.0f), AndroidUtilities.m1036dp(15.0f), AndroidUtilities.m1036dp(8.0f));
            this.closeButtonMargin = AndroidUtilities.m1036dp(6.0f);
            return this;
        }
        rectF.set(AndroidUtilities.m1036dp(11.0f), AndroidUtilities.m1036dp(6.0f), AndroidUtilities.m1036dp(this.closeButton ? 15.0f : 11.0f), AndroidUtilities.m1036dp(7.0f));
        this.closeButtonMargin = AndroidUtilities.m1036dp(2.0f);
        return this;
    }
    ...
    public HintView2 setCloseButton(boolean z) {
        this.closeButton = z;
        if (!this.multiline) {
            this.innerPadding.set(AndroidUtilities.m1036dp(11.0f), AndroidUtilities.m1036dp(6.0f), AndroidUtilities.m1036dp(this.closeButton ? 15.0f : 11.0f), AndroidUtilities.m1036dp(7.0f));
        }
        return this;
    }

    public HintView2 setMaxWidth(float f) {
        this.textMaxWidth = AndroidUtilities.m1036dp(f);
        return this;
    }
    ...
    public HintView2 setIcon(int i) {
        RLottieDrawable rLottieDrawable = new RLottieDrawable(i, _UrlKt.FRAGMENT_ENCODE_SET + i, AndroidUtilities.m1036dp(34.0f), AndroidUtilities.m1036dp(34.0f));
    ...
    public static float measureCorrectly(CharSequence charSequence, Paint paint) {
        ...
        while (i < replacementSpanArr.length) {
            ...
            Paint paint3 = paint2;
            iMax = (int) (iMax + Math.max(0.0f, replacementSpan.getSize(paint3, r10, r11, r12, paint2.getFontMetricsInt()) - paint3.measureText(spanned, spanned.getSpanStart(replacementSpan), spanned.getSpanEnd(replacementSpan))));
            i++;
            paint2 = paint3;
        ...
        if (typefaceSpanArr == null || typefaceSpanArr.length == 0) {
            return paint4.measureText(charSequence2.toString()) + iMax;
        }
        int iMax2 = 0;
    ...
    */
    public static java.lang.CharSequence cutInFancyHalfText(java.lang.CharSequence r12, android.text.TextPaint r13) {
        ...
        L6d:
            ...
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Stories.recorder.HintView2.cutInFancyHalfText(java.lang.CharSequence, android.text.TextPaint):java.lang.CharSequence");
    }
    ...
    public HintView2 setIconMargin(int i) {
        this.iconMargin = AndroidUtilities.m1036dp(i);
        return this;
    }
    ...
    public HintView2 setJoint(float f, float f2) {
        if (Math.abs(this.joint - f) >= 1.0f || Math.abs(this.jointTranslate - AndroidUtilities.m1036dp(f2)) >= 1.0f) {
            this.pathSet = false;
            invalidate();
        }
        this.joint = f;
        this.jointTranslate = AndroidUtilities.m1036dp(f2);
        return this;
    }
    ...
    public void drawBgPath(Canvas canvas, float f) {
        ...
        if (this.flicker) {
            ...
            float fCurrentTimeMillis = (-iM1036dp) + ((((System.currentTimeMillis() - this.flickerStart) % 4000) / 4000.0f) * ((this.pathLastWidth * 4.0f) + (iM1036dp * 2)));
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.closeButton) {
            if (this.closeButtonDrawable == null) {
                Drawable drawableMutate = getContext().getResources().getDrawable(C2797R.drawable.msg_mini_close_tooltip).mutate();
        ...
        if (hintView2.bounceT != 1.0f) {
            ...
            if (i == 3 || i == 1) {
                canvas.translate(0.0f, (hintView2.bounceT - 1.0f) * Math.max(i == 3 ? hintView2.getPaddingBottom() : hintView2.getPaddingTop(), AndroidUtilities.m1036dp(24.0f)) * (hintView2.direction == 1 ? -1 : 1));
            } else {
                canvas.translate((hintView2.bounceT - 1.0f) * Math.max(i == 0 ? hintView2.getPaddingLeft() : hintView2.getPaddingRight(), AndroidUtilities.m1036dp(24.0f)) * (hintView2.direction == 0 ? -1 : 1), 0.0f);
            }
        }
        ...
        hintView2.drawBgPath(canvas, f2);
        ...
        if (drawable2 != null) {
            ...
            if (z) {
                ...
                float f20 = hintView2.iconTy;
                int i3 = hintView2.iconHeight;
                f4 = 2.0f;
                drawable2.setBounds((int) (((f14 + f18) - (f19 / 2.0f)) - hintView2.iconWidth), (int) ((f20 + f13) - (i3 / 2.0f)), (int) ((f14 + f18) - (f19 / 2.0f)), (int) (f20 + f13 + (i3 / 2.0f)));
                f6 = 0.0f;
            }
        ...
        if (hintView2.multiline) {
            ...
            float f21 = ((f6 + hintView2.bounds.left) + hintView2.innerPadding.left) - hintView2.textLayoutLeft;
            hintView2.textX = f21;
            float f22 = f13 - (hintView2.textLayoutHeight / f4);
            hintView2.textY = f22;
            ...
            float f23 = hintView2.bounds.left;
            float f24 = hintView2.innerPadding.left;
            float f25 = hintView2.textLayoutHeight;
            animatedTextDrawable.setBounds((int) (f6 + f23 + f24), (int) (f13 - (f25 / f4)), (int) (f23 + f24 + f7), (int) (f13 + (f25 / f4)));
        ...
        if (hintView2.closeButton) {
            if (hintView2.closeButtonDrawable == null) {
                Drawable drawableMutate2 = hintView2.getContext().getResources().getDrawable(C2797R.drawable.msg_mini_close_tooltip).mutate();
    ...
    private void fillPath(Path path, float f, float f2, float f3, RectF rectF, Rect rect) {
        ...
        if (this.direction == 0) {
            path.lineTo(rectF.left, this.arrowHalfWidth + fClamp + AndroidUtilities.m1036dp(2.0f));
            path.lineTo(rectF.left, this.arrowHalfWidth + fClamp);
            path.lineTo(rectF.left - this.arrowHeight, AndroidUtilities.m1036dp(1.0f) + fClamp);
            float f14 = rectF.left;
            float f15 = this.arrowHeight;
            this.arrowX = f14 - f15;
            this.arrowY = fClamp;
            path.lineTo(f14 - f15, fClamp - AndroidUtilities.m1036dp(1.0f));
            path.lineTo(rectF.left, fClamp - this.arrowHalfWidth);
            path.lineTo(rectF.left, (fClamp - this.arrowHalfWidth) - AndroidUtilities.m1036dp(2.0f));
            if (rect != null) {
        ...
        if (this.direction == 1) {
            path.lineTo((fClamp - this.arrowHalfWidth) - AndroidUtilities.m1036dp(2.0f), rectF.top);
            path.lineTo(fClamp - this.arrowHalfWidth, rectF.top);
            path.lineTo(fClamp - AndroidUtilities.m1036dp(1.0f), rectF.top - this.arrowHeight);
            this.arrowX = fClamp;
            this.arrowY = rectF.top - this.arrowHeight;
            path.lineTo(AndroidUtilities.m1036dp(1.0f) + fClamp, rectF.top - this.arrowHeight);
            path.lineTo(this.arrowHalfWidth + fClamp, rectF.top);
            path.lineTo(this.arrowHalfWidth + fClamp + AndroidUtilities.m1036dp(2.0f), rectF.top);
            if (rect != null) {
        ...
        if (this.direction == 2) {
            path.lineTo(rectF.right, (fClamp - this.arrowHalfWidth) - AndroidUtilities.m1036dp(2.0f));
            path.lineTo(rectF.right, fClamp - this.arrowHalfWidth);
            path.lineTo(rectF.right + this.arrowHeight, fClamp - AndroidUtilities.m1036dp(1.0f));
            float f22 = rectF.right;
            float f23 = this.arrowHeight;
            this.arrowX = f22 + f23;
            this.arrowY = fClamp;
            path.lineTo(f22 + f23, AndroidUtilities.m1036dp(1.0f) + fClamp);
            path.lineTo(rectF.right, this.arrowHalfWidth + fClamp);
            path.lineTo(rectF.right, this.arrowHalfWidth + fClamp + AndroidUtilities.m1036dp(2.0f));
            if (rect != null) {
        ...
        if (this.direction == 3) {
            path.lineTo(this.arrowHalfWidth + fClamp + AndroidUtilities.m1036dp(2.0f), rectF.bottom);
            path.lineTo(this.arrowHalfWidth + fClamp, rectF.bottom);
            path.lineTo(AndroidUtilities.m1036dp(1.0f) + fClamp, rectF.bottom + this.arrowHeight);
            this.arrowX = fClamp;
            this.arrowY = rectF.bottom + this.arrowHeight;
            path.lineTo(fClamp - AndroidUtilities.m1036dp(1.0f), rectF.bottom + this.arrowHeight);
            path.lineTo(fClamp - this.arrowHalfWidth, rectF.bottom);
            path.lineTo((fClamp - this.arrowHalfWidth) - AndroidUtilities.m1036dp(2.0f), rectF.bottom);
            if (rect != null) {
    ...
    private boolean checkTouchLinks(MotionEvent motionEvent) {
        if (this.textLayout != null) {
            ...
            if (clickableSpanHitLink != null && motionEvent.getAction() == 0) {
                final LinkSpanDrawable<ClickableSpan> linkSpanDrawable = new LinkSpanDrawable<>(clickableSpanHitLink, null, motionEvent.getX(), motionEvent.getY());
            ...
            if (motionEvent.getAction() == 1) {
                ...
                if (linkSpanDrawable2 != null && linkSpanDrawable2.getSpan() == clickableSpanHitLink) {
                    ...
                    if (onLinkPress != null) {
                        onLinkPress.run((ClickableSpan) linkSpanDrawable3.getSpan());
                    } else if (linkSpanDrawable3.getSpan() != null) {
