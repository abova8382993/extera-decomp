...
public class PlayPauseButton extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(getWidth() / 2.0f, getHeight() / 2.0f, AndroidUtilities.m1036dp(10.0f), this.circlePaint);
        this.drawable.setBounds(0, 0, AndroidUtilities.m1036dp(10.0f), AndroidUtilities.m1036dp(10.0f));
        canvas.save();
        canvas.translate((getWidth() - AndroidUtilities.m1036dp(10.0f)) / 2.0f, (getHeight() - AndroidUtilities.m1036dp(10.0f)) / 2.0f);
    ...
    public void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(56.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(56.0f), TLObject.FLAG_30));
    }
}
