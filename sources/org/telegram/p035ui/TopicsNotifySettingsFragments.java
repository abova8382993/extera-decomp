...
import org.telegram.p035ui.Cells.TopicExceptionCell;
...
public class TopicsNotifySettingsFragments extends BaseFragment {
    ...
    public static /* synthetic */ void m22123$r8$lambda$c3dNfmvd9QA3F1Dmf28JyLaDVg(TLObject tLObject, TLRPC.TL_error tL_error) {
    }
    ...
    public View createView(Context context) {
        ...
        this.recyclerListView.setOnItemClickListener(new C73552());
    ...
    public class C73552 implements RecyclerListView.OnItemClickListener {
        public C73552() {
        }
        ...
        public void onItemClick(View view, int i) {
            ...
            if (TopicsNotifySettingsFragments.this.items.get(i).viewType == 2) {
                ...
                bundle2.putLong("topic_id", tL_forumTopic.f1306id);
            ...
            if (TopicsNotifySettingsFragments.this.items.get(i).viewType == 4) {
                ...
                builder.setTitle(LocaleController.getString(C2797R.string.NotificationsDeleteAllExceptionTitle));
                builder.setMessage(LocaleController.getString(C2797R.string.NotificationsDeleteAllExceptionAlert));
                builder.setPositiveButton(LocaleController.getString(C2797R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.TopicsNotifySettingsFragments$2$$ExternalSyntheticLambda1
        ...
        public /* synthetic */ void lambda$onItemClick$0(TLRPC.TL_forumTopic tL_forumTopic, NotificationsSettingsActivity.NotificationException notificationException) {
            TopicsNotifySettingsFragments.this.exceptionsTopics.add(Integer.valueOf(tL_forumTopic.f1306id));
        ...
        public class AnonymousClass1 implements ProfileNotificationsActivity.ProfileNotificationsActivityDelegate {
            ...
            public void didRemoveException(long j) {
                TopicsNotifySettingsFragments.this.removeException(this.val$topic.f1306id);
            ...
            public /* synthetic */ void lambda$didRemoveException$0(TLRPC.TL_forumTopic tL_forumTopic) {
                TopicsNotifySettingsFragments.this.exceptionsTopics.remove(Integer.valueOf(tL_forumTopic.f1306id));
                TopicsNotifySettingsFragments.this.updateRows();
            }
        }
    ...
    public void removeException(int i) {
        ...
        getConnectionsManager().sendRequest(updatenotifysettings, new RequestDelegate() { // from class: org.telegram.ui.TopicsNotifySettingsFragments$$ExternalSyntheticLambda0
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                TopicsNotifySettingsFragments.m22123$r8$lambda$c3dNfmvd9QA3F1Dmf28JyLaDVg(tLObject, tL_error);
            }
        });
    }
    ...
    public void updateRows() {
        ...
        if (topics != null) {
            int i3 = 0;
            while (i < topics.size()) {
                if (this.exceptionsTopics.contains(Integer.valueOf(topics.get(i).f1306id))) {
        ...
        int i4 = 3;
        if (i != 0) {
            this.items.add(new Item(i4, b7 == true ? 1 : 0));
            this.items.add(new Item(4, b5 == true ? 1 : 0));
        }
        this.items.add(new Item(i4, b3 == true ? 1 : 0));
    ...
    public class Item extends AdapterWithDiffUtils.Item {
        ...
        public boolean equals(Object obj) {
            ...
            return tL_forumTopic2 == null || (tL_forumTopic = item.topic) == null || tL_forumTopic2.f1306id == tL_forumTopic.f1306id;
        }
    }
}
