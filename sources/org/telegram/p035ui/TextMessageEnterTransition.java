...
import org.telegram.p035ui.MessageEnterTransitionContainer;
...
public class TextMessageEnterTransition implements MessageEnterTransitionContainer.Transition {
    ...
    public TextMessageEnterTransition(final ChatMessageCell chatMessageCell, final ChatActivity chatActivity, RecyclerListView recyclerListView, final MessageEnterTransitionContainer messageEnterTransitionContainer, Theme.ResourcesProvider resourcesProvider) {
        ...
        StaticLayout staticLayoutBuild = StaticLayout.Builder.obtain(charSequenceReplaceEmoji, 0, charSequenceReplaceEmoji.length(), textPaint2, width).setBreakStrategy(1).setHyphenationFrequency(0).setAlignment(Layout.Alignment.ALIGN_NORMAL).build();
        this.layout = staticLayoutBuild;
        this.animatedEmojiStack = AnimatedEmojiSpan.update(2, (View) null, this.animatedEmojiStack, staticLayoutBuild);
        ...
        this.fromStartY = ((AndroidUtilities.m1036dp(10.0f) + f3) - chatActivityEnterView.getEditField().getScrollY()) + lineTop;
        this.toXOffset = 0.0f;
        ...
        this.drawableFromTop = AndroidUtilities.m1036dp(4.0f) + f3;
        float f5 = 12.0f;
        if (this.enterView.isTopViewVisible()) {
            this.drawableFromTop -= AndroidUtilities.m1036dp(12.0f);
        }
        ...
        if (z3) {
            ...
            this.drawableFromTop -= AndroidUtilities.m1036dp(46.0f);
        }
        this.listViewTargetBottomPadding = recyclerListView.getPaddingBottom() - (chatActivity.getInputIslandHeightTarget() - AndroidUtilities.m1036dp(48.0f));
        this.gradientMatrix = new Matrix();
        Paint paint = new Paint(1);
        this.gradientPaint = paint;
        paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_IN));
        LinearGradient linearGradient = new LinearGradient(0.0f, AndroidUtilities.m1036dp(f), 0.0f, 0.0f, 0, -16777216, Shader.TileMode.CLAMP);
    ...
    */
    public void onDraw(android.graphics.Canvas r46) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.TextMessageEnterTransition.onDraw(android.graphics.Canvas):void");
    }
