...
import org.telegram.p035ui.Components.BlurredFrameLayout;
...
public abstract class ProfileStoriesCollectionTabs extends BlurredFrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ProfileStoriesCollectionTabs(Context context, SizeNotifierFrameLayout sizeNotifierFrameLayout, final StoriesController.StoriesCollections storiesCollections, final Delegate delegate) {
        ...
        viewPagerFixed.setTranslationY(AndroidUtilities.m1036dp(42.0f));
    ...
    @Override // org.telegram.p035ui.Components.BlurredFrameLayout, android.view.ViewGroup, android.view.View
    ...
    public class Adapter extends ViewPagerFixed.Adapter {
        ...
        public int getItemId(int i) {
            ...
            return ProfileStoriesCollectionTabs.this.collections.collections.get(i - 1).album_id;
        }
        ...
        public CharSequence getItemTitle(int i) {
            if (i == 0) {
                return LocaleController.getString(C2797R.string.StoriesAlbumNameAllStories);
            }
            if (this.canCreateNewAlbum && i == getItemCount() - 1) {
                SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder("+ ");
                spannableStringBuilder.append((CharSequence) LocaleController.getString(C2797R.string.StoriesAlbumAddAlbum));
            ...
            return ProfileStoriesCollectionTabs.this.collections.collections.get(i - 1).title;
        }
    }
}
