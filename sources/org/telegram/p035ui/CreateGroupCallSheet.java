...
public class CreateGroupCallSheet extends BottomSheetWithRecyclerListView {
    ...
    public CreateGroupCallSheet(Context context, Collection<Long> collection) {
        ...
        frameLayout2.setBackground(Theme.createCircleDrawable(AndroidUtilities.m1036dp(80.0f), Theme.getColor(Theme.key_featuredStickers_addButton, this.resourcesProvider)));
        ImageView imageView2 = new ImageView(context);
        imageView2.setImageResource(C2797R.drawable.filled_calls_users);
        ...
        linksTextViewMakeLinkTextView.setText(LocaleController.getString(C2797R.string.GroupCallCreateTitle));
        ...
        linksTextViewMakeLinkTextView2.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2797R.string.GroupCallCreateText)));
        ...
        linearLayout2.setPadding(this.backgroundPaddingLeft + AndroidUtilities.m1036dp(14.0f), AndroidUtilities.m1036dp(14.0f), this.backgroundPaddingLeft + AndroidUtilities.m1036dp(14.0f), AndroidUtilities.m1036dp(14.0f));
        ...
        recyclerListView.setPadding(i2, 0, i2, AndroidUtilities.m1036dp(76.0f));
    }
    ...
    public /* synthetic */ void lambda$new$1(View view, int i, float f, float f2) {
        ...
        if (obj instanceof TLRPC.User) {
            j = ((TLRPC.User) obj).f1407id;
        } else if (!(obj instanceof TLRPC.Chat)) {
            return;
        } else {
            j = ((TLRPC.Chat) obj).f1245id;
        }
        boolean zContains = this.selectedParticipants.contains(Long.valueOf(j));
        HashSet<Long> hashSet = this.selectedParticipants;
        if (zContains) {
    ...
    public CharSequence getTitle() {
        return LocaleController.getString(C2797R.string.GroupCallCreateTitle);
    }
    ...
    public void fillItems(ArrayList<UItem> arrayList, UniversalAdapter universalAdapter) {
        ...
        arrayList.add(UItem.asHeader(LocaleController.getString(C2797R.string.GroupCallCreateAddMembers)));
