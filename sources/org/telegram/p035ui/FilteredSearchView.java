...
public class FilteredSearchView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, FactorAnimator.Target {
    ...
    public FilteredSearchView(BaseFragment baseFragment) {
        ...
        this.provider = new PhotoViewer.EmptyPhotoViewerProvider() { // from class: org.telegram.ui.FilteredSearchView.2
            ...
            */
            public org.telegram.ui.PhotoViewer.PlaceProviderObject getPlaceForPhoto(org.telegram.messenger.MessageObject r8, org.telegram.tgnet.TLRPC.FileLocation r9, int r10, boolean r11, boolean r12) {
                /*
                    Method dump skipped, instruction units count: 261
                    To view this dump change 'Code comments level' option to 'DEBUG'
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.FilteredSearchView.C56212.getPlaceForPhoto(org.telegram.messenger.MessageObject, org.telegram.tgnet.TLRPC$FileLocation, int, boolean, boolean):org.telegram.ui.PhotoViewer$PlaceProviderObject");
            }
                ...
                if (getAdapter() == FilteredSearchView.this.sharedPhotoVideoAdapter) {
                    for (int i = 0; i < getChildCount(); i++) {
                        if (getChildViewHolder(getChildAt(i)).getItemViewType() == 1) {
                            canvas.save();
                            canvas.translate(getChildAt(i).getX(), (getChildAt(i).getY() - getChildAt(i).getMeasuredHeight()) + AndroidUtilities.m1036dp(2.0f));
        ...
        recyclerListView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.telegram.ui.FilteredSearchView$$ExternalSyntheticLambda2
        ...
        recyclerListView.setOnScrollListener(new C56256());
    ...
    public class C56256 extends RecyclerView.OnScrollListener {
        public C56256() {
        }
    ...
    public static CharSequence createFromInfoString(MessageObject messageObject, boolean z, int i, TextPaint textPaint) {
        ...
        if (messageObject.isSponsored()) {
            if (messageObject.sponsoredCanReport) {
                return LocaleController.getString(C2797R.string.SponsoredMessageAd);
            }
            if (messageObject.sponsoredRecommended) {
                return LocaleController.getString(C2797R.string.SponsoredMessage2Recommended);
            }
            return LocaleController.getString(C2797R.string.SponsoredMessage2);
        }
        ...
        if (spannableStringBuilderArr[i] == null) {
            ...
            if (i == 0) {
                i2 = C2797R.drawable.attach_arrow_right;
            } else if (i == 1) {
                i2 = C2797R.drawable.msg_mini_arrow_mediathin;
            } else {
                if (i != 2) {
                    return _UrlKt.FRAGMENT_ENCODE_SET;
                }
                i2 = C2797R.drawable.msg_mini_arrow_mediabold;
            }
        ...
        if (user != null && chat2 != null) {
            ...
            if (ChatObject.isForum(chat2) && (tL_forumTopicFindTopic2 = MessagesController.getInstance(UserConfig.selectedAccount).getTopicsController().findTopic(chat2.f1245id, MessageObject.getTopicId(messageObject.currentAccount, messageObject.messageOwner, true))) != null) {
            ...
            if (ChatObject.isForum(chat) && (tL_forumTopicFindTopic = MessagesController.getInstance(UserConfig.selectedAccount).getTopicsController().findTopic(chat.f1245id, MessageObject.getTopicId(messageObject.currentAccount, messageObject.messageOwner, true))) != null) {
    ...
    public void search(final long j, final long j2, final long j3, final FiltersView.MediaFilterData mediaFilterData, final boolean z, String str, boolean z2) {
        ...
        Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.FilteredSearchView$$ExternalSyntheticLambda3
            ...
            public final void run() throws Throwable {
                this.f$0.lambda$search$4(j, str5, mediaFilterData, i2, j2, j3, z3, z, str3, i);
            }
        };
        ...
        if (i3 == 0) {
            boolean zIsEmpty = TextUtils.isEmpty(this.currentSearchString);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$search$4(final long j, final String str, final FiltersView.MediaFilterData mediaFilterData, final int i, final long j2, long j3, final boolean z, boolean z2, String str2, final int i2) throws Throwable {
        int i3;
        TLObject tLObject;
        ...
        if (j != 0) {
            ...
            if (z && str.equals(this.lastMessagesSearchString) && !this.messages.isEmpty()) {
                tL_messages_search.offset_id = this.messages.get(r2.size() - 1).getId();
            } else {
    ...
    public /* synthetic */ void lambda$search$2(int i, TLRPC.TL_error tL_error, TLObject tLObject, int i2, boolean z, String str, ArrayList arrayList, FiltersView.MediaFilterData mediaFilterData, long j, long j2, ArrayList arrayList2, ArrayList arrayList3) {
        ...
        if (tL_error != null) {
            stickerEmptyView.title.setText(LocaleController.getString(C2797R.string.SearchEmptyViewTitle2));
        ...
        if (this.messages.isEmpty()) {
            if (mediaFilterData != null) {
                if (TextUtils.isEmpty(this.currentDataQuery) && j == 0 && j2 == 0) {
                    this.emptyView.title.setText(LocaleController.getString(C2797R.string.SearchEmptyViewTitle));
                    int i4 = mediaFilterData.filterType;
                    if (i4 == 1) {
                        string = LocaleController.getString(C2797R.string.SearchEmptyViewFilteredSubtitleFiles);
                    } else if (i4 == 0) {
                        string = LocaleController.getString(C2797R.string.SearchEmptyViewFilteredSubtitleMedia);
                    } else if (i4 == 2) {
                        string = LocaleController.getString(C2797R.string.SearchEmptyViewFilteredSubtitleLinks);
                    } else if (i4 == 3) {
                        string = LocaleController.getString(C2797R.string.SearchEmptyViewFilteredSubtitleMusic);
                    } else {
                        string = LocaleController.getString(C2797R.string.SearchEmptyViewFilteredSubtitleVoice);
                    }
                    this.emptyView.subtitle.setVisibility(0);
                    this.emptyView.subtitle.setText(string);
                } else {
                    this.emptyView.title.setText(LocaleController.getString(C2797R.string.SearchEmptyViewTitle2));
                    this.emptyView.subtitle.setVisibility(0);
                    this.emptyView.subtitle.setText(LocaleController.getString(C2797R.string.SearchEmptyViewFilteredSubtitle2));
                }
            } else {
        ...
        if (!z) {
            ...
            if (str != null && str.length() >= 3 && (LocaleController.getString(C2797R.string.SavedMessages).toLowerCase().startsWith(str) || "saved messages".startsWith(str))) {
                int i6 = 0;
                while (true) {
                    int size2 = this.localTipChats.size();
                    ArrayList<Object> arrayList5 = this.localTipChats;
                    if (i6 < size2) {
                        if ((arrayList5.get(i6) instanceof TLRPC.User) && UserConfig.getInstance(UserConfig.selectedAccount).getCurrentUser().f1407id == ((TLRPC.User) this.localTipChats.get(i6)).f1407id) {
                            break;
                        } else {
                            i6++;
                        }
            ...
            if (str != null && str.length() >= 3 && (LocaleController.getString(C2797R.string.ArchiveSearchFilter).toLowerCase().startsWith(str) || "archive".startsWith(str))) {
    ...
    */
    public void messagesDeleted(long r9, java.util.ArrayList<java.lang.Integer> r11) {
        ...
        L83:
            if (r2 == 0) goto L8c
            androidx.recyclerview.widget.RecyclerView$Adapter r8 = r8.adapter
            if (r8 == 0) goto L8c
            r8.notifyDataSetChanged()
        L8c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.FilteredSearchView.messagesDeleted(long, java.util.ArrayList):void");
    }
    ...
    public class SharedLinksAdapter extends RecyclerListView.SectionsAdapter {
        ...
        public class C56321 implements SharedLinkCell.SharedLinkCellDelegate {
            public C56321() {
            }
            ...
            public void onLinkPress(final String str, boolean z) {
                if (z) {
                    ...
                    builder.setItems(new CharSequence[]{LocaleController.getString(C2797R.string.Open), LocaleController.getString(C2797R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.FilteredSearchView$SharedLinksAdapter$1$$ExternalSyntheticLambda0
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: hideFloatingDateView, reason: merged with bridge method [inline-methods] */
    ...
    private void checkUi_floatingDateView() {
        ...
        this.floatingDateView.setTranslationY((-AndroidUtilities.m1036dp(24.0f)) * (1.0f - floatValue));
    ...
    public static class FloatingDateView extends View {
        ...
        public void setBlurredBackgroundDrawable(BlurredBackgroundDrawable blurredBackgroundDrawable) {
            ...
            blurredBackgroundDrawable.setRadius(AndroidUtilities.m1036dp(11.5f));
            this.bgDrawable.setPadding(AndroidUtilities.m1036dp(5.0f));
        }
