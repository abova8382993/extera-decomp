...
import org.telegram.p035ui.Stories.StoryReactionWidgetView;
...
public class EmojiAnimationsOverlay implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void onDetachedFromWindow() {
        ...
        while (true) {
            int size = this.drawingObjects.size();
            ArrayList<DrawingObject> arrayList = this.drawingObjects;
            if (i < size) {
                arrayList.get(i).imageReceiver.onDetachedFromWindow();
                if (this.drawingObjects.get(i).genericEffect != null) {
    ...
    public void checkStickerPack() {
        ...
        if (this.set != null) {
            ...
            for (int i = 0; i < this.set.documents.size(); i++) {
                map.put(Long.valueOf(this.set.documents.get(i).f1253id), this.set.documents.get(i));
            }
                    ...
                    try {
                        ...
                        for (int i4 = 0; i4 < jSONArray.length(); i4++) {
                            ...
                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.EmojiAnimationsOverlay.1
                                ...
                                public RunnableC55781(int i32, int i5) {
                                    i = i32;
                                    i = i5;
                                }
    ...
    public class RunnableC55781 implements Runnable {
        final /* synthetic */ int val$animation;
        final /* synthetic */ int val$messageId;
    ...
    public void draw(Canvas canvas) {
        ArrayList<DrawingObject> arrayList;
        float f;
        boolean zIsDone;
        float y;
        ...
        while (true) {
                        ...
                        if (drawingObject.isMessageEffect && (childAt instanceof ChatMessageCell)) {
                            ...
                            if (drawingObject.isPremiumSticker) {
                                ...
                                if (drawingObject.isOut) {
                                    fM1036dp = ((-photoImage.getImageWidth()) * 2.0f) + AndroidUtilities.m1036dp(24.0f);
                                } else {
                                    fM1036dp = -AndroidUtilities.m1036dp(24.0f);
                                }
                                float f5 = imageX + fM1036dp;
            ...
            if (!z3) {
                if (drawingObject.isPremiumSticker && !drawingObject.isMessageEffect) {
                    ...
                    boolean z4 = drawingObject.isOut;
                    ImageReceiver imageReceiver = drawingObject.imageReceiver;
                    if (!z4) {
                        imageReceiver.setImageCoords(drawingObject.lastX - f10, f11, f9, f9);
                    } else {
                        imageReceiver.setImageCoords(((drawingObject.lastX + drawingObject.lastW) - f9) + f10, f11, f9, f9);
                    }
                    if (!drawingObject.isOut) {
                        canvas.save();
                    ...
                    if (animatedEmojiEffect != null) {
                        ...
                        imageReceiver2.setImageCoords(f15, f16, f17 * f, f17 * f);
                        if (!drawingObject.isOut) {
                            canvas.save();
                            canvas.scale(-1.0f, 1.0f, drawingObject.imageReceiver.getCenterX(), drawingObject.imageReceiver.getCenterY());
                            drawingObject.imageReceiver.draw(canvas);
    ...
    public boolean onTapItem(ChatMessageCell chatMessageCell, ChatActivity chatActivity, boolean z) {
        ...
        if ((printingStringType == null || printingStringType.intValue() != 5) && this.hintRunnable == null && zShowAnimationForCell && ((Bulletin.getVisibleBulletin() == null || !Bulletin.getVisibleBulletin().isShowing()) && SharedConfig.emojiInteractionsHintCount > 0 && UserConfig.getInstance(this.currentAccount).getClientUserId() != chatActivity.currentUser.f1407id)) {
            ...
            stickerSetBulletinLayout.titleTextView.setText(Emoji.replaceEmoji(AndroidUtilities.replaceTags(LocaleController.formatString("EmojiInteractionTapHint", C2797R.string.EmojiInteractionTapHint, chatActivity.currentUser.first_name)), stickerSetBulletinLayout.titleTextView.getPaint().getFontMetricsInt(), false));
            ...
            RunnableC55792 runnableC55792 = new Runnable() { // from class: org.telegram.ui.EmojiAnimationsOverlay.2
                final /* synthetic */ Bulletin val$bulletin;

                public RunnableC55792(Bulletin bulletin) {
                    bulletin = bulletin;
                }
            ...
            this.hintRunnable = runnableC55792;
            AndroidUtilities.runOnUIThread(runnableC55792, 1500L);
        }
        return zShowAnimationForCell;
    }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class RunnableC55792 implements Runnable {
        final /* synthetic */ Bulletin val$bulletin;
    ...
    public boolean showAnimationForActionCell(ChatActionCell chatActionCell, TLRPC.Document document, TLRPC.VideoSize videoSize) {
        ...
        for (int i3 = 0; i3 < this.drawingObjects.size(); i3++) {
            ...
            if (this.drawingObjects.get(i3).document != null && document != null && this.drawingObjects.get(i3).document.f1253id == document.f1253id) {
                i2++;
            }
        }
        if (i >= 4) {
        ...
        if (i2 > 0) {
            Integer num = this.lastAnimationIndex.get(Long.valueOf(document.f1253id));
            int iIntValue = num == null ? 0 : num.intValue();
            this.lastAnimationIndex.put(Long.valueOf(document.f1253id), Integer.valueOf((iIntValue + 1) % 4));
    ...
    private void preloadAnimation(TLRPC.Document document) {
        ...
        if (map == null || !map.containsKey(Long.valueOf(document.f1253id))) {
            if (this.preloaded == null) {
                this.preloaded = new HashMap<>();
            }
            this.preloaded.put(Long.valueOf(document.f1253id), Boolean.TRUE);
            ...
            if (z9 || ((arrayList != null && !arrayList.isEmpty()) || z8)) {
                ...
                while (i4 < this.drawingObjects.size()) {
                    if (this.drawingObjects.get(i4).messageId == i) {
                        i5++;
                        if (!z9 && (this.drawingObjects.get(i4).imageReceiver.getLottieAnimation() == null || this.drawingObjects.get(i4).imageReceiver.getLottieAnimation().isGeneratingCache())) {
                            return z7;
                        }
                    }
                    if (this.drawingObjects.get(i4).document == null || document == null) {
                        z5 = z7;
                        z6 = z8;
                    } else {
                        z5 = z7;
                        z6 = z8;
                        if (this.drawingObjects.get(i4).document.f1253id == document.f1253id) {
                            i6++;
                        }
                    }
                    i4++;
                ...
                if (z && z11 && i5 > 0) {
                    ...
                    if (stickerSetByName == null) {
                        stickerSetByName = MediaDataController.getInstance(this.currentAccount).getStickerSetById(inputStickerSet.f1270id);
                    }
                    if (stickerSetByName == null) {
                ...
                if (z9) {
                    ...
                    while (true) {
                        ...
                        document2 = availableEffects.documents.get(i7);
                        if (document2 != null && document2.f1253id == j2) {
                            break;
                        }
                        i7++;
                    }
                        ...
                        if (messageObject != null && messageObject.isAnimatedAnimatedEmoji()) {
                            if (iAbs < 0 || iAbs > arrayList.size() - 1) {
                                ...
                                for (int i8 = z10 ? 1 : 0; i8 < arrayList.size(); i8++) {
                                    ...
                                    if (document3 != null) {
                                        HashMap<Long, Boolean> map = this.preloaded;
                                        Boolean bool = map != null ? map.get(Long.valueOf(document3.f1253id)) : null;
                                ...
                                if (zIsEmpty) {
                                    iIntValue = Math.abs(random.nextInt()) % arrayList.size();
                                } else {
                                    iIntValue = ((Integer) arrayList2.get(Math.abs(random.nextInt()) % arrayList2.size())).intValue();
                                }
                            } else {
                                iIntValue = iAbs;
                            }
                            document2 = arrayList.get(iIntValue);
                            iAbs = iIntValue;
                        } else {
                            if (iAbs < 0 || iAbs > arrayList.size() - 1) {
                ...
                if (premiumStickerAnimation == null) {
                    int filterWidth = getFilterWidth();
                    Integer num = this.lastAnimationIndex.get(Long.valueOf(document2.f1253id));
                    if (num == null) {
                        iIntValue2 = z10 ? 1 : 0;
                    } else {
                    ...
                    int i9 = iIntValue2 + 1;
                    this.lastAnimationIndex.put(Long.valueOf(document2.f1253id), Integer.valueOf(i9));
                    ...
                    drawingObject.imageReceiver.setDelegate(new ImageReceiver.ImageReceiverDelegate() { // from class: org.telegram.ui.EmojiAnimationsOverlay.3
                        ...
                        public C55803(DrawingObject drawingObject2, boolean z12, final MessageObject messageObject2) {
                    ...
                    if (i6 > 0) {
                        i3 = iAbs;
                        Integer num2 = this.lastAnimationIndex.get(Long.valueOf(document2.f1253id));
                        int iIntValue3 = num2 == null ? 0 : num2.intValue();
                        this.lastAnimationIndex.put(Long.valueOf(document2.f1253id), Integer.valueOf((iIntValue3 + 1) % 4));
                        drawingObject2.imageReceiver.setUniqKeyPrefix(iIntValue3 + "_" + drawingObject2.messageId + "_");
                    } else {
                        i3 = iAbs;
                    }
                    drawingObject2.document = document2;
                    drawingObject2.imageReceiver.setImage(ImageLocation.getForDocument(premiumStickerAnimation, document2), filterWidth2 + "_" + filterWidth2 + "_pcache", null, "tgs", this.set, 1);
                }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C55803 implements ImageReceiver.ImageReceiverDelegate {
        final /* synthetic */ DrawingObject val$drawingObject;
        final /* synthetic */ MessageObject val$messageObject;
        final /* synthetic */ boolean val$sendTap;
    ...
    public void lambda$createDrawingObject$0(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, final MessageObject messageObject) {
        ...
        stickerSetBulletinLayout.subtitleTextView.setText(LocaleController.getString(C2797R.string.PremiumStickerTooltip));
        ...
        undoButton.setText(LocaleController.getString(C2797R.string.ViewAction));
    ...
    */
    public static java.lang.String unwrapEmoji(java.lang.String r8) {
        ...
        L8d:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.EmojiAnimationsOverlay.unwrapEmoji(java.lang.String):java.lang.String");
    }
    ...
    private void sendCurrentTaps() {
        ...
        try {
            jSONObject.put(RegisterSpec.PREFIX, 1);
    ...
    public boolean showAnimationForWidget(StoryReactionWidgetView storyReactionWidgetView) {
        ...
        if (visibleReactionFromTL.emojicon != null && createDrawingObject(strUnwrapEmoji, iHashCode, null, null, -1, false, false, width, f, z)) {
            if (!this.drawingObjects.isEmpty()) {
                ...
                boolean z2 = drawingObject.isOut;
                float f3 = drawingObject.lastX;
                if (z2) {
                    drawingObject.lastX = f3 + ((-f2) * 1.8f);
                } else {
                    drawingObject.lastX = f3 + ((-f2) * 0.2f);
                }
            }
            return true;
        }
    ...
    public float getProgress() {
        ...
        return this.drawingObjects.get(r1.size() - 1).getProgress();
    }
}
