...
import org.telegram.p035ui.Cells.InviteUserCell;
...
public abstract class ContactsAdapter extends RecyclerListView.SectionsAdapter {
    ...
    public ContactsAdapter(Context context, BaseFragment baseFragment, int i, boolean z, LongSparseArray<TLRPC.User> longSparseArray, LongSparseArray<TLRPC.User> longSparseArray2, int i2) {
    ...
    */
    public static /* synthetic */ int $r8$lambda$ELiMIR3niEAcM_m7UV_uqfYJfuE(org.telegram.messenger.MessagesController r2, int r3, org.telegram.tgnet.TLRPC.TL_contact r4, org.telegram.tgnet.TLRPC.TL_contact r5) {
        ...
        L61:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Adapters.ContactsAdapter.$r8$lambda$ELiMIR3niEAcM_m7UV_uqfYJfuE(org.telegram.messenger.MessagesController, int, org.telegram.tgnet.TLRPC$TL_contact, org.telegram.tgnet.TLRPC$TL_contact):int");
    }
    ...
    public Object getItem(int i, int i2) {
        ...
        int i4 = this.onlyUsers;
        int i5 = this.currentAccount;
        HashMap<String, ArrayList<TLRPC.TL_contact>> map = i4 == 2 ? ContactsController.getInstance(i5).usersMutualSectionsDict : ContactsController.getInstance(i5).usersSectionsDict;
        int i6 = this.onlyUsers;
        int i7 = this.currentAccount;
        ArrayList<String> arrayList = i6 == 2 ? ContactsController.getInstance(i7).sortedUsersMutualSectionsArray : ContactsController.getInstance(i7).sortedUsersSectionsArray;
        ...
        if (this.sortType != 2) {
            ...
            if (i8 < arrayList.size()) {
                ArrayList<TLRPC.TL_contact> arrayList3 = map.get(arrayList.get(i8));
    ...
    public boolean isEnabled(RecyclerView.ViewHolder viewHolder, int i, int i2) {
        ...
        HashMap<String, ArrayList<TLRPC.TL_contact>> map = i3 == 2 ? ContactsController.getInstance(i4).usersMutualSectionsDict : ContactsController.getInstance(i4).usersSectionsDict;
        int i5 = this.onlyUsers;
        int i6 = this.currentAccount;
        ArrayList<String> arrayList = i5 == 2 ? ContactsController.getInstance(i6).sortedUsersMutualSectionsArray : ContactsController.getInstance(i6).sortedUsersSectionsArray;
        if (this.onlyUsers != 0 && !this.isAdmin) {
        ...
        int i7 = i - 1;
        return i7 >= arrayList.size() || i2 < map.get(arrayList.get(i7)).size();
        return true;
    }
    ...
    */
    public int getSectionCount() {
        /*
            ...
            r3 = 2
            if (r1 != r3) goto L13
            java.util.ArrayList<org.telegram.tgnet.TLRPC$TL_contact> r1 = r6.onlineContacts
        ...
        L13:
            ...
            if (r1 != r3) goto L20
            org.telegram.messenger.ContactsController r1 = org.telegram.messenger.ContactsController.getInstance(r4)
        ...
        L64:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Adapters.ContactsAdapter.getSectionCount():int");
    }
    ...
    private int getCountForSectionInternal(int i) {
        ...
        HashMap<String, ArrayList<TLRPC.TL_contact>> map = i2 == 2 ? ContactsController.getInstance(i3).usersMutualSectionsDict : ContactsController.getInstance(i3).usersSectionsDict;
        int i4 = this.onlyUsers;
        int i5 = this.currentAccount;
        ArrayList<String> arrayList = i4 == 2 ? ContactsController.getInstance(i5).sortedUsersMutualSectionsArray : ContactsController.getInstance(i5).sortedUsersSectionsArray;
        if (this.onlyUsers != 0 && !this.isAdmin) {
            if (this.isEmpty) {
                return 1;
            }
            ...
            if (i == 0) {
                ...
                boolean z3 = this.includeSearch;
                return z2 ? (z3 ? 1 : 0) + 4 : (z3 ? 1 : 0) + 4;
            }
            if (z) {
                return 1;
            }
            if (this.sortType != 2) {
                ...
                if (i6 < arrayList.size()) {
                    int size2 = map.get(arrayList.get(i6)).size();
                    arrayList.size();
                    return size2;
                }
            } else if (i == 1) {
    ...
    public View getSectionHeaderView(int i, View view) {
        ...
        int i3 = this.currentAccount;
        if (i2 == 2) {
            HashMap<String, ArrayList<TLRPC.TL_contact>> map = ContactsController.getInstance(i3).usersMutualSectionsDict;
        } else {
            HashMap<String, ArrayList<TLRPC.TL_contact>> map2 = ContactsController.getInstance(i3).usersSectionsDict;
        }
        int i4 = this.onlyUsers;
        int i5 = this.currentAccount;
        ArrayList<String> arrayList = i4 == 2 ? ContactsController.getInstance(i5).sortedUsersMutualSectionsArray : ContactsController.getInstance(i5).sortedUsersSectionsArray;
        ...
        int i6 = i - 1;
        if (i6 < arrayList.size()) {
            letterSectionCell.setLetter(arrayList.get(i6));
            return view;
        }
        letterSectionCell.setLetter(_UrlKt.FRAGMENT_ENCODE_SET);
        return view;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(final ViewGroup viewGroup, int i) {
        ...
        if (i == 0) {
            ...
            if (i == 4) {
                FrameLayout frameLayout = new FrameLayout(this.mContext) { // from class: org.telegram.ui.Adapters.ContactsAdapter.2
                    ...
                    public void onMeasure(int i2, int i3) {
                        ...
                        int iM1036dp2 = ContactsAdapter.this.onlyUsers != 0 ? 0 : AndroidUtilities.m1036dp(30.0f) + iM1036dp;
                        ...
                        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i2), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(iM1036dp2 < paddingTop ? paddingTop - iM1036dp2 : 0, TLObject.FLAG_30));
                    }
                };
            ...
            dividerCell.setPadding(AndroidUtilities.m1036dp(LocaleController.isRTL ? 28.0f : 72.0f), AndroidUtilities.m1036dp(8.0f), AndroidUtilities.m1036dp(LocaleController.isRTL ? 72.0f : 28.0f), AndroidUtilities.m1036dp(8.0f));
    ...
    public void onBindViewHolder(int i, int i2, RecyclerView.ViewHolder viewHolder) {
        ...
        if (itemViewType == 0) {
            ...
            if (this.sortType == 2) {
                ...
                int i5 = this.onlyUsers;
                int i6 = this.currentAccount;
                HashMap<String, ArrayList<TLRPC.TL_contact>> map = i5 == 2 ? ContactsController.getInstance(i6).usersMutualSectionsDict : ContactsController.getInstance(i6).usersSectionsDict;
                int i7 = this.onlyUsers;
                int i8 = this.currentAccount;
                arrayList = map.get((i7 == 2 ? ContactsController.getInstance(i8).sortedUsersMutualSectionsArray : ContactsController.getInstance(i8).sortedUsersSectionsArray).get(i - ((this.onlyUsers == 0 || this.isAdmin) ? 1 : 0)));
            }
            ...
            userCell.setChecked(this.selectedContacts.indexOfKey(user.f1407id) >= 0, false);
            LongSparseArray<TLRPC.User> longSparseArray = this.ignoreUsers;
            if (longSparseArray != null) {
                if (longSparseArray.indexOfKey(user.f1407id) >= 0) {
        ...
        if (itemViewType != 1) {
            if (itemViewType == 2) {
                ...
                if (i9 == 0) {
                    ...
                    graySectionCell.setText(LocaleController.getString(C2797R.string.SortedByName));
                    return;
                } else {
                    graySectionCell.setText(LocaleController.getString(C2797R.string.SortedByLastSeen));
                    return;
                }
            }
            if (itemViewType == 4) {
                viewHolder.itemView.setPadding(0, AndroidUtilities.m1036dp(!this.hasPhonebook ? 96.0f : 25.0f), 0, AndroidUtilities.m1036dp(18.0f));
                return;
            }
            if (itemViewType != 7) {
                if (itemViewType != 8) {
                ...
                int i10 = i3 - 2;
                if (i10 < 0 || i10 >= ContactsController.getInstance(this.currentAccount).phoneBookContacts.size()) {
                    return;
                }
                inviteUserCell.setUser(ContactsController.getInstance(this.currentAccount).phoneBookContacts.get(i10), null);
                return;
            }
            HeaderCell headerCell = (HeaderCell) viewHolder.itemView;
            if (this.isEmptyWithMainTabs && i3 == 1 && i == 1) {
                headerCell.setText(LocaleController.getString(C2797R.string.InviteFriends));
                return;
            } else if (this.sortType == 1) {
                headerCell.setText(LocaleController.getString(C2797R.string.SortedByName));
                return;
            } else {
                headerCell.setText(LocaleController.getString(C2797R.string.SortedByLastSeen));
                return;
            }
        }
        ...
        if (this.needPhonebook || !this.isAdmin) {
            ...
            int i12 = Theme.key_telegram_color_text;
            textCell.setColors(i12, i12);
        }
        if (i == 0) {
            if (this.needPhonebook) {
                if (i3 == 0) {
                    textCell.setTextAndValueAndColorfulIcon(LocaleController.getString(C2797R.string.InviteFriends), _UrlKt.FRAGMENT_ENCODE_SET, false, C2797R.drawable.settings_invite, -14899731, -15431455, false);
                    return;
                } else {
                    if (i3 == 1) {
                        textCell.setTextAndValueAndColorfulIcon(LocaleController.getString(C2797R.string.RecentCalls), _UrlKt.FRAGMENT_ENCODE_SET, false, C2797R.drawable.settings_calls, -11154873, -14175180, false);
                        return;
                    }
                    return;
                }
            ...
            if (this.isAdmin) {
                if (this.isChannel) {
                    textCell.setTextAndIcon((CharSequence) LocaleController.getString(C2797R.string.ChannelInviteViaLink), C2797R.drawable.msg_link2, false);
                    return;
                } else {
                    textCell.setTextAndIcon((CharSequence) LocaleController.getString(C2797R.string.InviteToGroupByLink), C2797R.drawable.msg_link2, false);
                    return;
                }
            }
            if (i3 == 0) {
                textCell.setTextAndValueAndColorfulIcon(LocaleController.getString(C2797R.string.NewGroup), _UrlKt.FRAGMENT_ENCODE_SET, false, C2797R.drawable.settings_group, -14899731, -15431455, false);
                return;
            } else {
                if (i3 == 1) {
                    textCell.setTextAndValueAndColorfulIcon(LocaleController.getString(C2797R.string.NewChannel), _UrlKt.FRAGMENT_ENCODE_SET, false, C2797R.drawable.settings_channel, -11154873, -14175180, false);
                    return;
                }
                return;
            }
        ...
        if (i == 0) {
            ...
            if (this.sortType != 2) {
                ...
                if (i10 < arrayList.size()) {
                    return i2 < map.get(arrayList.get(i10)).size() ? 0 : 3;
                }
            } else if (i == 1) {
    ...
    public String getLetter(int i) {
        ...
        if (this.sortType != 2 && !this.isEmpty) {
            int i2 = this.onlyUsers;
            int i3 = this.currentAccount;
            ArrayList<String> arrayList = i2 == 2 ? ContactsController.getInstance(i3).sortedUsersMutualSectionsArray : ContactsController.getInstance(i3).sortedUsersSectionsArray;
