...
public abstract class DialogsSearchAdapter extends RecyclerListView.SelectionAdapter {
    ...
    public enum Filter {
        All(0, C2797R.string.SearchMessagesFilterAll, C2797R.string.SearchMessagesFilterAllFrom),
        Private(8, C2797R.string.SearchMessagesFilterPrivate, C2797R.string.SearchMessagesFilterPrivateFrom),
        Groups(4, C2797R.string.SearchMessagesFilterGroup, C2797R.string.SearchMessagesFilterGroupFrom),
        Channels(2, C2797R.string.SearchMessagesFilterChannels, C2797R.string.SearchMessagesFilterChannelsFrom);
    ...
    public static class CategoryAdapterRecycler extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            hintDialogCell.setLayoutParams(new RecyclerView.LayoutParams(AndroidUtilities.m1036dp(80.0f), AndroidUtilities.m1036dp(86.0f)));
    ...
    public boolean filter(Object obj) {
        ...
        boolean zIsMegagroup = ChatObject.isMegagroup(chat);
        DialogsActivity dialogsActivity2 = this.dialogsActivity;
        return zIsMegagroup ? dialogsActivity2.allowGroups || dialogsActivity2.allowMegagroups : dialogsActivity2.allowGroups || dialogsActivity2.allowLegacyGroups;
    }
    ...
    public DialogsSearchAdapter(Context context, DialogsActivity dialogsActivity, int i, int i2, DefaultItemAnimator defaultItemAnimator, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.resourcesProvider = resourcesProvider;
        C30411 c30411 = new SearchAdapterHelper(false) { // from class: org.telegram.ui.Adapters.DialogsSearchAdapter.1
            public C30411(boolean z2) {
                super(z2);
            }
        ...
        this.searchAdapterHelper = c30411;
        c30411.setDelegate(new SearchAdapterHelper.SearchAdapterHelperDelegate() { // from class: org.telegram.ui.Adapters.DialogsSearchAdapter.2
            public C30422() {
            }
            ...
            public void onSetHashtags(ArrayList<SearchAdapterHelper.HashtagObject> arrayList, HashMap<String, SearchAdapterHelper.HashtagObject> map) {
                ...
                while (true) {
                    ...
                    dialogsSearchAdapter.searchResultHashtags.add(arrayList.get(i3).hashtag);
                    i3++;
                }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Adapters.DialogsSearchAdapter$1 */
    public class C30411 extends SearchAdapterHelper {
        public C30411(boolean z2) {
            super(z2);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Adapters.DialogsSearchAdapter$2 */
    public class C30422 implements SearchAdapterHelper.SearchAdapterHelperDelegate {
        public C30422() {
        }
    ...
    public /* synthetic */ void lambda$searchForumMessagesInternal$1(final String str, final int i, final int i2, final TLRPC.TL_messages_search tL_messages_search, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        ...
        if (tL_error == null) {
            ...
            for (int i3 = 0; i3 < messages_messages.chats.size(); i3++) {
                ...
                longSparseArray.put(chat.f1245id, chat);
            }
            ...
            for (int i5 = 0; i5 < messages_messages.messages.size(); i5++) {
                MessageObject messageObject = new MessageObject(this.currentAccount, messages_messages.messages.get(i5), (LongSparseArray<TLRPC.User>) longSparseArray2, (LongSparseArray<TLRPC.Chat>) longSparseArray, false, true);
    ...
    private void searchMessagesInternal(final String str, final int i) {
        if (this.needMessagesSearch != 0) {
            ...
            tL_messages_searchGlobal.f1370q = str;
            ...
            this.reqId = ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_messages_searchGlobal, new RequestDelegate() { // from class: org.telegram.ui.Adapters.DialogsSearchAdapter$$ExternalSyntheticLambda30
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    this.f$0.lambda$searchMessagesInternal$4(str, i5, i, tL_messages_searchGlobal, tLObject, tL_error);
                }
            }, 2);
        }
    }
    ...
    public /* synthetic */ void lambda$searchMessagesInternal$4(final String str, final int i, final int i2, final TLRPC.TL_messages_searchGlobal tL_messages_searchGlobal, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        ...
        if (tL_error == null) {
            ...
            for (int i6 = 0; i6 < messages_messages2.messages.size(); i6++) {
                ...
                if ((z ? MessagesController.getInstance(i7).dialogs_read_outbox_max : MessagesController.getInstance(i7).dialogs_read_inbox_max).get(Long.valueOf(dialogId)) == null) {
    ...
    */
        ...
        try {
            ...
            if (!arrayList3.isEmpty()) {
                ...
                for (int i3 = 0; i3 < arrayList6.size(); i3++) {
                    RecentSearchObject recentSearchObject3 = (RecentSearchObject) longSparseArray.get(DialogObject.makeEncryptedDialogId(arrayList6.get(i3).f1257id));
            ...
            if (!arrayList.isEmpty()) {
                ...
                for (int i5 = 0; i5 < arrayList5.size(); i5++) {
                    ...
                    RecentSearchObject recentSearchObject6 = (RecentSearchObject) longSparseArray.get(user.f1407id);
    ...
    /* JADX INFO: renamed from: setRecentSearch */
    public void lambda$loadRecentSearch$5(ArrayList<RecentSearchObject> arrayList, LongSparseArray<RecentSearchObject> longSparseArray) {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public /* synthetic */ void lambda$searchDialogsInternal$13(java.lang.String r17, int r18, java.lang.String r19) throws java.lang.Throwable {
        /*
            Method dump skipped, instruction units count: 237
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Adapters.DialogsSearchAdapter.lambda$searchDialogsInternal$13(java.lang.String, int, java.lang.String):void");
    }
    ...
    public void searchDialogs(final String str, int i, boolean z) {
        ...
        if (!TextUtils.equals(this.sponsoredQuery, strTrim)) {
            ...
            if (strTrim == null || strTrim.length() < 4 || (UserConfig.getInstance(this.currentAccount).isPremium() && MessagesController.getInstance(this.currentAccount).isSponsoredDisabled())) {
                ...
                this.sponsoredQuery = strTrim;
                tL_contacts_getSponsoredPeers.f1299q = strTrim;
    ...
    public /* synthetic */ void lambda$searchDialogs$16(TLObject tLObject) {
        ...
        if (tLObject instanceof TLRPC.TL_contacts_sponsoredPeers) {
            ...
            if (RemoteUtils.getBooleanConfigValue("hide_ads", false).booleanValue()) {
                ArrayList<TLRPC.TL_sponsoredPeer> arrayList = tL_contacts_sponsoredPeers.peers;
                int size = arrayList.size();
                while (i < size) {
                    TLRPC.TL_sponsoredPeer tL_sponsoredPeer = arrayList.get(i);
                    i++;
                    seenSponsoredPeer(tL_sponsoredPeer);
                }
                tL_contacts_sponsoredPeers.peers.clear();
            }
    ...
    public int getItemCount() {
        ...
        if (size7 != 0) {
            i += size7 + 1 + (!this.localMessagesSearchEndReached ? 1 : 0);
        }
        ...
        if ((this.currentMessagesFilter != Filter.All || this.forceLoadingMessages) && this.searchResultMessages.isEmpty()) {
            size8 = this.forceLoadingMessages ? 3 : 1;
        }
        int i2 = (this.searchForumResultMessages.isEmpty() || this.localMessagesSearchEndReached) ? size8 : 0;
        if (i2 != 0) {
    ...
    public Object getItem(int i) {
        ...
        if (isRecentSearchDisplayed()) {
            ...
            if (i > HasHints && (i2 = (i - 1) - (HasHints == true ? 1 : 0)) < arrayList.size()) {
                ...
                if (!(tLObject instanceof TLRPC.User)) {
                    return (!(tLObject instanceof TLRPC.Chat) || (chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(((TLRPC.Chat) tLObject).f1245id))) == null) ? tLObject : chat;
                }
                TLRPC.User user = MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(((TLRPC.User) tLObject).f1407id));
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Adapters.DialogsSearchAdapter$3 */
    public class C30433 extends DialogCell {
        @Override // org.telegram.p035ui.Cells.DialogCell
        public boolean isForumCell() {
            return false;
        }

        public C30433(DialogsActivity dialogsActivity, Context context, boolean z, boolean z2) {
            super(dialogsActivity, context, z, z2);
        }
    }

    /* JADX INFO: renamed from: org.telegram.ui.Adapters.DialogsSearchAdapter$4 */
    public class C30444 extends RecyclerListView {
        public C30444(Context context) {
            super(context);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Adapters.DialogsSearchAdapter$5 */
    public class C30455 extends LinearLayoutManager {
        @Override // androidx.recyclerview.widget.LinearLayoutManager, androidx.recyclerview.widget.RecyclerView.LayoutManager
        public boolean supportsPredictiveItemAnimations() {
            return false;
        }

        public C30455(Context context) {
            super(context);
        }
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        switch (i) {
            case 0:
                c30433 = new ProfileSearchCell(this.mContext).showPremiumBlock(this.dialogsType == 3);
                break;
            case 1:
                c30433 = new GraySectionCell(this.mContext);
                break;
            case 2:
            case 9:
                c30433 = new DialogCell(null, this.mContext, false, true) { // from class: org.telegram.ui.Adapters.DialogsSearchAdapter.3
                    @Override // org.telegram.p035ui.Cells.DialogCell
                    public boolean isForumCell() {
                        return false;
                    }
                ...
                break;
            case 3:
                c30433 = new TopicSearchCell(this.mContext);
                break;
            case 4:
                FlickerLoadingView flickerLoadingView = new FlickerLoadingView(this.mContext);
                flickerLoadingView.setViewType(1);
                flickerLoadingView.setIsSingleCell(true);
                c30433 = flickerLoadingView;
                break;
            case 5:
                c30433 = new HashtagSearchCell(this.mContext);
                break;
            case 6:
                C30444 c30444 = new RecyclerListView(this.mContext) { // from class: org.telegram.ui.Adapters.DialogsSearchAdapter.4
                    public C30444(Context context) {
                        super(context);
                    }
                ...
                c30444.setSelectorDrawableColor(Theme.getColor(Theme.key_listSelector));
                c30444.setTag(9);
                c30444.setItemAnimator(null);
                c30444.setLayoutAnimation(null);
                C30455 c30455 = new LinearLayoutManager(this.mContext) { // from class: org.telegram.ui.Adapters.DialogsSearchAdapter.5
                    @Override // androidx.recyclerview.widget.LinearLayoutManager, androidx.recyclerview.widget.RecyclerView.LayoutManager
                    public boolean supportsPredictiveItemAnimations() {
                        return false;
                    }
                ...
                c30455.setOrientation(0);
                c30444.setLayoutManager(c30455);
                c30444.setAdapter(new CategoryAdapterRecycler(this.mContext, this.currentAccount, false, this.dialogsType == 3, this.resourcesProvider));
                c30444.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.telegram.ui.Adapters.DialogsSearchAdapter$$ExternalSyntheticLambda5
                    @Override // org.telegram.ui.Components.RecyclerListView.OnItemClickListener
                    public final void onItemClick(View view, int i2) {
                        this.f$0.lambda$onCreateViewHolder$23(view, i2);
                    }
                });
                c30444.setOnItemLongClickListener(new RecyclerListView.OnItemLongClickListener() { // from class: org.telegram.ui.Adapters.DialogsSearchAdapter$$ExternalSyntheticLambda6
                    @Override // org.telegram.ui.Components.RecyclerListView.OnItemLongClickListener
                    public final boolean onItemClick(View view, int i2) {
                        return this.f$0.lambda$onCreateViewHolder$24(view, i2);
                    }
                });
                this.innerListView = c30444;
                c30433 = c30444;
                break;
            case 7:
            default:
                c30433 = new TextCell(this.mContext, 16, false);
                break;
            case 8:
                c30433 = new ProfileSearchCell(this.mContext);
                break;
            case 10:
        ...
        if (i == 5) {
            c30433.setLayoutParams(new RecyclerView.LayoutParams(-1, AndroidUtilities.m1036dp(86.0f)));
        } else {
            c30433.setLayoutParams(new RecyclerView.LayoutParams(-1, -2));
        }
        return new RecyclerListView.Holder(c30433);
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:514:0x02df A[PHI: r9
  0x02df: PHI (r9v12 java.lang.String) = (r9v11 java.lang.String), (r9v17 java.lang.String), (r9v18 java.lang.String), (r9v20 java.lang.String) binds: [B:507:0x02b8, B:533:0x0339, B:519:0x02f9, B:512:0x02d0] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:579:0x0487  */
    /* JADX WARN: Removed duplicated region for block: B:582:0x0495  */
    /* JADX WARN: Removed duplicated region for block: B:591:0x04b0  */
    /* JADX WARN: Removed duplicated region for block: B:594:0x04b9  */
    /* JADX WARN: Removed duplicated region for block: B:597:0x04e3  */
    /* JADX WARN: Removed duplicated region for block: B:606:0x0504  */
    /* JADX WARN: Removed duplicated region for block: B:610:0x050b  */
    /* JADX WARN: Removed duplicated region for block: B:613:0x0518  */
    /* JADX WARN: Removed duplicated region for block: B:616:0x0522  */
    /* JADX WARN: Removed duplicated region for block: B:621:0x052d  */
    /* JADX WARN: Removed duplicated region for block: B:624:0x0537  */
    /* JADX WARN: Removed duplicated region for block: B:626:0x0542  */
    /* JADX WARN: Removed duplicated region for block: B:637:0x0569  */
    ...
    /* JADX WARN: Removed duplicated region for block: B:700:0x0667 A[ADDED_TO_REGION] */
    /* JADX WARN: Removed duplicated region for block: B:719:0x06ac  */
    /* JADX WARN: Removed duplicated region for block: B:720:0x06af  */
    /* JADX WARN: Removed duplicated region for block: B:723:0x06b9  */
    /* JADX WARN: Removed duplicated region for block: B:728:0x06d5  */
    /* JADX WARN: Removed duplicated region for block: B:732:0x06df  */
    /* JADX WARN: Removed duplicated region for block: B:748:0x072a  */
    /* JADX WARN: Removed duplicated region for block: B:762:0x0776  */
    /* JADX WARN: Removed duplicated region for block: B:763:0x077b  */
    /* JADX WARN: Removed duplicated region for block: B:766:0x0781  */
    /* JADX WARN: Removed duplicated region for block: B:767:0x0784  */
    /* JADX WARN: Removed duplicated region for block: B:770:0x07a5  */
    /* JADX WARN: Removed duplicated region for block: B:771:0x07a7  */
    ...
    */
    public void onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder r31, int r32) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Adapters.DialogsSearchAdapter.onBindViewHolder(androidx.recyclerview.widget.RecyclerView$ViewHolder, int):void");
    }
    ...
    public /* synthetic */ void lambda$onBindViewHolder$30(GraySectionCell graySectionCell) {
        ...
        graySectionCell.setRightText(LocaleController.getString(!z ? C2797R.string.ShowMore : C2797R.string.ShowLess));
        notifyDataSetChanged();
    }

    public /* synthetic */ void lambda$onBindViewHolder$33(ArrayList arrayList, int i, GraySectionCell graySectionCell) {
        ...
        graySectionCell.setRightText(LocaleController.getString(this.globalSearchCollapsed ? C2797R.string.ShowMore : C2797R.string.ShowLess), this.globalSearchCollapsed);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:281:0x0178, code lost:
    
        if (r12 != 0) goto L283;
     */
    /* JADX WARN: Code restructure failed: missing block: B:282:0x017a, code lost:
    ...
    */
    public int getItemViewType(int r12) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Adapters.DialogsSearchAdapter.getItemViewType(int):int");
    }
    ...
    public static class EmptyLayout extends LinearLayout {
        ...
        public EmptyLayout(Context context, Theme.ResourcesProvider resourcesProvider, final Runnable runnable) {
            ...
            textView.setText(LocaleController.getString(C2797R.string.SearchMessagesFilterEmptyTitle));
            ...
            this.textView.setText(LocaleController.formatString(C2797R.string.SearchMessagesFilterEmptyText, _UrlKt.FRAGMENT_ENCODE_SET));
            this.textView.setGravity(17);
            addView(this.textView, LayoutHelper.createLinear(-1, -2, 1, 0, 0, 0, 14));
            TextView textView3 = new TextView(context);
            textView3.setPadding(AndroidUtilities.m1036dp(12.0f), AndroidUtilities.m1036dp(4.0f), AndroidUtilities.m1036dp(12.0f), AndroidUtilities.m1036dp(4.0f));
            textView3.setTextSize(1, 14.0f);
            textView3.setText(LocaleController.getString(C2797R.string.SearchMessagesFilterEmptySearchAll));
        ...
        public void setQuery(String str) {
            this.textView.setText(LocaleController.formatString(C2797R.string.SearchMessagesFilterEmptyText, str));
        }
    }
