...
public class FiltersView extends RecyclerListView {
    ...
    public static final MediaFilterData[] filters = {new MediaFilterData(C2797R.drawable.search_media_filled, C2797R.string.SharedMediaTab2, new TLRPC.TL_inputMessagesFilterPhotoVideo(), 0), new MediaFilterData(C2797R.drawable.search_links_filled, C2797R.string.SharedLinksTab2, new TLRPC.TL_inputMessagesFilterUrl(), 2), new MediaFilterData(C2797R.drawable.search_files_filled, C2797R.string.SharedFilesTab2, new TLRPC.TL_inputMessagesFilterDocument(), 1), new MediaFilterData(C2797R.drawable.search_music_filled, C2797R.string.SharedMusicTab2, new TLRPC.TL_inputMessagesFilterMusic(), 3), new MediaFilterData(C2797R.drawable.search_voice_filled, C2797R.string.SharedVoiceTab2, new TLRPC.TL_inputMessagesFilterRoundVoice(), 5)};
    ...
    public class C30461 extends LinearLayoutManager {
        @Override // androidx.recyclerview.widget.LinearLayoutManager, androidx.recyclerview.widget.RecyclerView.LayoutManager
        public boolean supportsPredictiveItemAnimations() {
            return false;
        }

        public C30461(Context context) {
            super(context);
        }
    ...
    public FiltersView(Context context, Theme.ResourcesProvider resourcesProvider) {
                    ...
                    if (i3 == 4) {
                        ...
                        if (tLObject instanceof TLRPC.User) {
                            ...
                            if (tLObject2 instanceof TLRPC.User) {
                                return ((TLRPC.User) tLObject).f1407id == ((TLRPC.User) tLObject2).f1407id;
                            }
                        }
                        if (tLObject instanceof TLRPC.Chat) {
                            TLObject tLObject3 = mediaFilterData2.chat;
                            return (tLObject3 instanceof TLRPC.Chat) && ((TLRPC.Chat) tLObject).f1245id == ((TLRPC.Chat) tLObject3).f1245id;
                        }
                    } else {
                        if (i3 == 6) {
        ...
        C30461 c30461 = new LinearLayoutManager(context) { // from class: org.telegram.ui.Adapters.FiltersView.1
            @Override // androidx.recyclerview.widget.LinearLayoutManager, androidx.recyclerview.widget.RecyclerView.LayoutManager
            public boolean supportsPredictiveItemAnimations() {
                return false;
            }

            public C30461(Context context2) {
                super(context2);
            }
        ...
        this.layoutManager = c30461;
        c30461.setOrientation(0);
        ...
        addItemDecoration(new RecyclerView.ItemDecoration() { // from class: org.telegram.ui.Adapters.FiltersView.2
            ...
            public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
                ...
                rect.left = AndroidUtilities.m1036dp(8.0f);
                if (childAdapterPosition == state.getItemCount() - 1) {
                    rect.right = AndroidUtilities.m1036dp(10.0f);
                }
                if (childAdapterPosition == 0) {
                    rect.left = AndroidUtilities.m1036dp(10.0f);
                }
            }
        });
        setItemAnimator(new DefaultItemAnimator() { // from class: org.telegram.ui.Adapters.FiltersView.3
            ...
            public void animateRemoveImpl(RecyclerView.ViewHolder viewHolder) {
                ...
                viewPropertyAnimatorAnimate.setDuration(getRemoveDuration()).alpha(0.0f).scaleX(0.0f).scaleY(0.0f).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Adapters.FiltersView.3.2
                    ...
                    public AnonymousClass2(RecyclerView.ViewHolder viewHolder2, ViewPropertyAnimator viewPropertyAnimatorAnimate2, View view2) {
                    ...
                    public void onAnimationStart(Animator animator) {
                        C30483.this.dispatchRemoveStarting(viewHolder);
                    }
                    ...
                    public void onAnimationEnd(Animator animator) {
                        ...
                        view.setScaleX(1.0f);
                        view.setScaleY(1.0f);
                        C30483.this.dispatchRemoveFinished(viewHolder);
                        ((DefaultItemAnimator) C30483.this).mRemoveAnimations.remove(viewHolder);
                        C30483.this.dispatchFinishedWhenDone();
                    }
                }).start();
            }
        ...
        setSelectorRadius(AndroidUtilities.m1036dp(28.0f));
    ...
    public class C30472 extends RecyclerView.ItemDecoration {
        public C30472() {
        }
    ...
    public class C30483 extends DefaultItemAnimator {
        private final float scaleFrom = 0.0f;
        ...
        @Override // androidx.recyclerview.widget.DefaultItemAnimator
        public void animateRemoveImpl(RecyclerView.ViewHolder viewHolder2) {
            ...
            viewPropertyAnimatorAnimate2.setDuration(getRemoveDuration()).alpha(0.0f).scaleX(0.0f).scaleY(0.0f).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Adapters.FiltersView.3.2
                ...
                public AnonymousClass2(RecyclerView.ViewHolder viewHolder22, ViewPropertyAnimator viewPropertyAnimatorAnimate22, View view22) {
    ...
    public void setUsersAndDates(ArrayList<Object> arrayList, ArrayList<DateData> arrayList2, boolean z) {
        ...
        if (arrayList != null) {
            for (int i = 0; i < arrayList.size(); i++) {
                ...
                if (obj instanceof TLRPC.User) {
                    ...
                    MediaFilterData mediaFilterData = new MediaFilterData(C2797R.drawable.search_users_filled, name, (TLRPC.MessagesFilter) null, 4);
                    ...
                    MediaFilterData mediaFilterData2 = new MediaFilterData(C2797R.drawable.search_users_filled, str, (TLRPC.MessagesFilter) null, 4);
        ...
        if (arrayList2 != null) {
            for (int i2 = 0; i2 < arrayList2.size(); i2++) {
                ...
                MediaFilterData mediaFilterData3 = new MediaFilterData(C2797R.drawable.search_date_filled, dateData.title, (TLRPC.MessagesFilter) null, 6);
                mediaFilterData3.setDate(dateData);
                this.usersFilters.add(mediaFilterData3);
            }
        }
        if (z) {
            this.usersFilters.add(new MediaFilterData(C2797R.drawable.chats_archive, C2797R.string.ArchiveSearchFilter, (TLRPC.MessagesFilter) null, 7));
        }
        if (getAdapter() != null) {
    ...
    public static void fillTipDates(String str, ArrayList<DateData> arrayList) {
        ...
        if (LocaleController.getString(C2797R.string.SearchTipToday).toLowerCase().startsWith(strTrim) || "today".startsWith(strTrim)) {
            ...
            arrayList.add(new DateData(LocaleController.getString(C2797R.string.SearchTipToday), timeInMillis, calendar.getTimeInMillis() - 1));
            return;
        }
        if (LocaleController.getString(C2797R.string.SearchTipYesterday).toLowerCase().startsWith(strTrim) || "yesterday".startsWith(strTrim)) {
            ...
            arrayList.add(new DateData(LocaleController.getString(C2797R.string.SearchTipYesterday), timeInMillis2, calendar2.getTimeInMillis() - 86400001));
            return;
        }
    ...
    public static int getMonth(String str) {
        String[] strArr = {LocaleController.getString(C2797R.string.January).toLowerCase(), LocaleController.getString(C2797R.string.February).toLowerCase(), LocaleController.getString(C2797R.string.March).toLowerCase(), LocaleController.getString(C2797R.string.April).toLowerCase(), LocaleController.getString(C2797R.string.May).toLowerCase(), LocaleController.getString(C2797R.string.June).toLowerCase(), LocaleController.getString(C2797R.string.July).toLowerCase(), LocaleController.getString(C2797R.string.August).toLowerCase(), LocaleController.getString(C2797R.string.September).toLowerCase(), LocaleController.getString(C2797R.string.October).toLowerCase(), LocaleController.getString(C2797R.string.November).toLowerCase(), LocaleController.getString(C2797R.string.December).toLowerCase()};
    ...
    public class Adapter extends RecyclerListView.SelectionAdapter {
        public /* synthetic */ Adapter(FiltersView filtersView, FiltersViewIA filtersViewIA) {
            this();
        }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            viewHolder.itemView.setLayoutParams(new RecyclerView.LayoutParams(-2, AndroidUtilities.m1036dp(30.0f)));
            return viewHolder;
        }
    ...
    public class C30494 extends DiffUtil.Callback {
        @Override // androidx.recyclerview.widget.DiffUtil.Callback
        public boolean areContentsTheSame(int i, int i2) {
            return true;
        }
    ...
    public static class FilterView extends FrameLayout {
        ...
        public void setData(MediaFilterData mediaFilterData) {
            ...
            if (mediaFilterData.filterType == 7) {
                CombinedDrawable combinedDrawableCreateCircleDrawableWithIcon = Theme.createCircleDrawableWithIcon(AndroidUtilities.m1036dp(32.0f), C2797R.drawable.chats_archive);
                this.thumbDrawable = combinedDrawableCreateCircleDrawableWithIcon;
                combinedDrawableCreateCircleDrawableWithIcon.setIconSize(AndroidUtilities.m1036dp(16.0f), AndroidUtilities.m1036dp(16.0f));
            ...
            CombinedDrawable combinedDrawableCreateCircleDrawableWithIcon2 = Theme.createCircleDrawableWithIcon(AndroidUtilities.m1036dp(32.0f), mediaFilterData.iconResFilled);
    ...
    public static class DateData {
        ...
        public /* synthetic */ DateData(String str, long j, long j2, FiltersViewIA filtersViewIA) {
            this(str, j, j2);
        }
    ...
    public static class UpdateCallback implements ListUpdateCallback {
        ...
        public /* synthetic */ UpdateCallback(RecyclerView.Adapter adapter, FiltersViewIA filtersViewIA) {
            this(adapter);
        }
