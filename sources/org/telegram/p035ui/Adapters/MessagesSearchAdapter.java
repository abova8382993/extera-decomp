...
public class MessagesSearchAdapter extends RecyclerListView.SelectionAdapter implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void notifyDataSetChanged() {
        ...
        ArrayList<MessageObject> foundMessageObjects = i == 0 ? MediaDataController.getInstance(i2).getFoundMessageObjects() : HashtagSearchController.getInstance(i2).getMessages(this.searchType);
        ...
        if (i5 != 0) {
            if (!HashtagSearchController.getInstance(i6).isEndReached(this.searchType) && this.loadedCount != 0) {
            ...
            if (!MediaDataController.getInstance(i6).searchEndReached() && this.loadedCount != 0) {
            ...
            dialogCell.setDialogCellDelegate(new DialogCell.DialogCellDelegate() { // from class: org.telegram.ui.Adapters.MessagesSearchAdapter.1
                ...
                public void openStory(DialogCell dialogCell2, Runnable runnable) {
                    if (MessagesController.getInstance(MessagesSearchAdapter.this.currentAccount).getStoriesController().hasStories(dialogCell2.getDialogId())) {
                        ...
                        MessagesSearchAdapter.this.fragment.getOrCreateStoryViewer().open(MessagesSearchAdapter.this.mContext, dialogCell2.getDialogId(), StoriesListPlaceProvider.m1210of((RecyclerListView) dialogCell2.getParent()));
                    }
                }
            });
            return;
    ...
    public static class StoriesView extends FrameLayout {
        ...
        public StoriesView(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            avatarsDrawable.width = AndroidUtilities.m1036dp(75.0f);
            avatarsDrawable.height = AndroidUtilities.m1036dp(48.0f);
            avatarsDrawable.drawStoriesCircle = true;
            avatarsDrawable.setSize(AndroidUtilities.m1036dp(22.0f));
            int i = 0;
            while (i < 2) {
        ...
        public boolean set(StoriesController.SearchStoriesList searchStoriesList) {
            ...
            for (int i2 = 0; i2 < searchStoriesList.messageObjects.size() && i < 3; i2++) {
                MessageObject messageObject = searchStoriesList.messageObjects.get(i2);
            ...
            boolean zIsEmpty = TextUtils.isEmpty(searchStoriesList.username);
            TextView[] textViewArr = this.titleTextView;
            if (!zIsEmpty) {
                textViewArr[0].setText(AndroidUtilities.replaceSingleLink(LocaleController.formatPluralStringSpaced("HashtagStoriesFoundChannel", searchStoriesList.getCount(), "@" + searchStoriesList.username), Theme.getColor(Theme.key_featuredStickers_addButton, this.resourcesProvider), null));
            } else {
                textViewArr[0].setText(LocaleController.formatPluralStringSpaced("HashtagStoriesFound", searchStoriesList.getCount()));
            }
            this.subtitleTextView[0].setText(LocaleController.formatString(C2797R.string.HashtagStoriesFoundSubtitle, searchStoriesList.query));
            return i > 0;
        }
        ...
        public void setMessages(int i, String str, String str2) {
            ...
            TextView[] textViewArr = this.titleTextView;
            if (!zIsEmpty) {
                textViewArr[1].setText(AndroidUtilities.replaceSingleLink(LocaleController.formatPluralStringSpaced("HashtagMessagesFoundChannel", i, "@" + str2), Theme.getColor(Theme.key_featuredStickers_addButton, this.resourcesProvider), null));
            } else {
                textViewArr[1].setText(LocaleController.formatPluralStringSpaced("HashtagMessagesFound", i));
            }
            this.subtitleTextView[1].setText(LocaleController.formatString(C2797R.string.HashtagMessagesFoundSubtitle, str));
        }
        ...
        public void transition(final boolean z) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Adapters.MessagesSearchAdapter.StoriesView.1
                ...
                public void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    ...
                    int i = 0;
                    while (i < 2) {
                        StoriesView.this.titleTextView[i].setTranslationX(AndroidUtilities.lerp(0, -AndroidUtilities.m1036dp(62.0f), StoriesView.this.transitValue));
                        ...
                        StoriesView.this.subtitleTextView[i].setTranslationX(AndroidUtilities.lerp(0, -AndroidUtilities.m1036dp(62.0f), StoriesView.this.transitValue));
        ...
        public void onDraw(Canvas canvas) {
            ...
            canvas.translate(AndroidUtilities.lerp(0, -AndroidUtilities.m1036dp(62.0f), this.transitValue), 0.0f);
