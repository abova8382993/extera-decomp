...
public class CheckBoxCell extends FrameLayout {
    ...
    public CheckBoxCell(Context context, int i, int i2, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        boolean z2 = true;
        if (z) {
            C32841 c32841 = new AnimatedTextView(context) { // from class: org.telegram.ui.Cells.CheckBoxCell.1
                public C32841(Context context2) {
                    super(context2);
                }
            ...
            this.animatedTextView = c32841;
            NotificationCenter.listenEmojiLoading(c32841);
            this.animatedTextView.setEllipsizeByGradient(true);
            this.animatedTextView.setRightPadding(AndroidUtilities.m1036dp(8.0f));
            ...
            this.animatedTextView.setTextSize(AndroidUtilities.m1036dp(16.0f));
            if (i == 7) {
            ...
            if (i == 3) {
                ...
                this.animatedTextView.setPadding(0, 0, 0, AndroidUtilities.m1036dp(3.0f));
            } else {
                animatedTextView.setRightPadding(AndroidUtilities.m1036dp(i2));
            ...
            C32852 c32852 = new LinkSpanDrawable.LinksTextView(context2) { // from class: org.telegram.ui.Cells.CheckBoxCell.2
                public C32852(Context context2) {
                    super(context2);
                }
            ...
            this.linksTextView = c32852;
            NotificationCenter.listenEmojiLoading(c32852);
            ...
            if (i == 3) {
                ...
                this.linksTextView.setPadding(0, 0, 0, AndroidUtilities.m1036dp(3.0f));
            } else {
        ...
        if (i == 6) {
            CollapseButton collapseButton = new CollapseButton(context2, C2797R.drawable.msg_folders_groups);
    ...
    public class C32841 extends AnimatedTextView {
        public C32841(Context context2) {
            super(context2);
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C32852 extends LinkSpanDrawable.LinksTextView {
        public C32852(Context context2) {
            super(context2);
        }
    ...
    public void setCollapsed(Boolean bool) {
        ...
        if (view == null) {
            ...
            Drawable drawableMutate = getContext().getResources().getDrawable(C2797R.drawable.arrow_more).mutate();
    ...
    public void updateCollapseArrowTranslation() {
        ...
        if (z) {
            left = (view.getRight() - measuredWidth) - AndroidUtilities.m1036dp(20.0f);
        } else {
            left = view.getLeft() + measuredWidth + AndroidUtilities.m1036dp(4.0f);
        }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.currentType == 3) {
            this.valueTextView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(10.0f), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(50.0f), TLObject.FLAG_30));
            this.textView.measure(View.MeasureSpec.makeMeasureSpec(size - AndroidUtilities.m1036dp(34.0f), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(50.0f), Integer.MIN_VALUE));
            this.checkBox.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(this.checkBoxSize), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(this.checkBoxSize), TLObject.FLAG_30));
            setMeasuredDimension(this.textView.getMeasuredWidth() + AndroidUtilities.m1036dp(29.0f), AndroidUtilities.m1036dp(50.0f));
            ...
            int measuredWidth = ((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight()) - AndroidUtilities.m1036dp(isCheckboxRound() ? 60.0f : 34.0f);
            if (this.textAnimated) {
                measuredWidth += (int) this.animatedTextView.getRightPadding();
            }
            if (this.currentType == 7) {
                measuredWidth -= AndroidUtilities.m1036dp(34.0f);
            }
            ...
            if (collapseButton != null) {
                ...
                measuredWidth2 += this.collapseButton.getMeasuredWidth() - AndroidUtilities.m1036dp(11.0f);
            }
            int i4 = this.textView.getLayoutParams().width;
            View view = this.textView;
            if (i4 == -1) {
                view.measure(View.MeasureSpec.makeMeasureSpec(((measuredWidth - ((int) Math.abs(view.getTranslationX()))) - measuredWidth2) - AndroidUtilities.m1036dp(8.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), Integer.MIN_VALUE));
            } else {
                view.measure(View.MeasureSpec.makeMeasureSpec(((measuredWidth - ((int) Math.abs(view.getTranslationX()))) - measuredWidth2) - AndroidUtilities.m1036dp(8.0f), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), Integer.MIN_VALUE));
            }
            BackupImageView backupImageView = this.avatarImageView;
            if (backupImageView != null) {
                backupImageView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(34.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(34.0f), TLObject.FLAG_30));
            }
            this.checkBox.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(this.checkBoxSize), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(this.checkBoxSize), TLObject.FLAG_30));
        }
        ...
        if (view2 != null) {
            ...
            this.click1Container.measure(View.MeasureSpec.makeMeasureSpec((size - marginLayoutParams.leftMargin) - marginLayoutParams.rightMargin, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(50.0f), TLObject.FLAG_30));
        }
        View view3 = this.click2Container;
        if (view3 != null) {
            view3.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(56.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(50.0f), TLObject.FLAG_30));
        }
        View view4 = this.collapsedArrow;
        if (view4 != null) {
            view4.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(16.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(16.0f), TLObject.FLAG_30));
        }
    }
    ...
    public void setUserOrChat(TLObject tLObject) {
        ...
        if (z && ((TLRPC.User) tLObject).f1407id == MessagesController.getInstance(UserConfig.selectedAccount).telegramAntispamUserId) {
            name = LocaleController.getString(C2797R.string.ChannelAntiSpamUser);
        }
        if (this.textAnimated) {
    ...
    public void setPad(int i) {
        int iM1036dp = AndroidUtilities.m1036dp(i * 40 * (LocaleController.isRTL ? -1 : 1));
        View view = this.checkBox;
        if (view != null) {
            view.setTranslationX(iM1036dp);
        }
        float f = iM1036dp;
    ...
    public void setMultiline(boolean z) {
        ...
        if (z2) {
            ...
            layoutParams2.topMargin = AndroidUtilities.m1036dp(15.0f);
        }
    ...
    public void onDraw(Canvas canvas) {
        if (this.needDivider) {
            int iM1036dp = AndroidUtilities.m1036dp(isCheckboxRound() ? 60.0f : 20.0f) + ((int) Math.abs(this.textView.getTranslationX()));
            if (this.currentType == 7) {
                iM1036dp += AndroidUtilities.m1036dp(39.0f);
            }
            ...
            Paint paint2 = paint;
            float f = LocaleController.isRTL ? 0.0f : iM1036dp;
            float measuredHeight = getMeasuredHeight() - 1;
            int measuredWidth = getMeasuredWidth();
            if (!LocaleController.isRTL) {
                iM1036dp = 0;
            }
            canvas.drawLine(f, measuredHeight, measuredWidth - iM1036dp, getMeasuredHeight() - 1, paint2);
        }
    }
    ...
    public class CollapseButton extends LinearLayout {
        ...
        public void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(32.0f), TLObject.FLAG_30));
        }
