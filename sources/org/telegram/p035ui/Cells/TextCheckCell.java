...
public class TextCheckCell extends FrameLayout {
    ...
    public class C33691 extends AnimationProperties.FloatProperty<TextCheckCell> {
        public C33691(String str) {
            super(str);
        }
    ...
    public void onMeasure(int i, int i2) {
        if (this.isMultiline) {
            ...
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(this.valueTextView.getVisibility() == 0 ? 64.0f : this.height) + (this.needDivider ? 1 : 0), TLObject.FLAG_30));
        }
    }
    ...
    public void setIcon(int i) {
        if (this.imageView == null) {
            ...
            addView(this.imageView, LayoutHelper.createFrame(24, 24.0f, (LocaleController.isRTL ? 5 : 3) | 16, 21.0f, 0.0f, 21.0f, 0.0f));
        }
        int iM1036dp = AndroidUtilities.m1036dp(71.0f);
        this.padding = iM1036dp;
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) this.textView.getLayoutParams();
        boolean z = LocaleController.isRTL;
        marginLayoutParams.leftMargin = z ? marginLayoutParams.leftMargin : iM1036dp;
        marginLayoutParams.rightMargin = z ? iM1036dp : marginLayoutParams.rightMargin;
        ViewGroup.MarginLayoutParams marginLayoutParams2 = (ViewGroup.MarginLayoutParams) this.valueTextView.getLayoutParams();
        boolean z2 = LocaleController.isRTL;
        marginLayoutParams2.leftMargin = z2 ? marginLayoutParams2.leftMargin : iM1036dp;
        if (!z2) {
            iM1036dp = marginLayoutParams2.rightMargin;
        }
        marginLayoutParams2.rightMargin = iM1036dp;
        ...
        this.imageView.setAlpha(isEnabled() ? 1.0f : 0.5f);
    }
    ...
    public void setDrawCheckRipple(boolean z) {
        ...
        setTag(RecyclerListView.TAG_ROUND_SECTION, z ? Boolean.TRUE : null);
    }
    ...
    public void setTextAndValueAndCheck(CharSequence charSequence, String str, boolean z, boolean z2, boolean z3) {
        if (str != null && str.contains("->")) {
            this.valueTextView.setText(VerticalImageSpan.createSpan(getContext(), C2797R.drawable.search_arrow, str, "->", Theme.key_windowBackgroundWhiteGrayText2, this.resourcesProvider));
        } else {
        ...
        if (z2) {
            ...
            this.valueTextView.setPadding(0, 0, 0, AndroidUtilities.m1036dp(11.0f));
        } else {
            textView.setLines(1);
            this.valueTextView.setMaxLines(1);
            this.valueTextView.setSingleLine(true);
    ...
    public class C33702 extends AnimatorListenerAdapter {
        final /* synthetic */ int val$color;
    ...
    public void setAnimationProgress(float f) {
        ...
        float fMax = Math.max(lastTouchX, getMeasuredWidth() - lastTouchX) + AndroidUtilities.m1036dp(40.0f);
    ...
    public class C33713 extends AnimatorListenerAdapter {
        final /* synthetic */ int val$color;
    ...
    private float getLastTouchX() {
        if (this.isAnimatingToThumbInsteadOfTouch) {
            return LocaleController.isRTL ? AndroidUtilities.m1036dp(22.0f) : getMeasuredWidth() - AndroidUtilities.m1036dp(42.0f);
        }
    ...
    */
    public void onDraw(android.graphics.Canvas r8) {
        ...
        L37:
            ...
            goto L3c
        L39:
            android.graphics.Paint r0 = org.telegram.p035ui.ActionBar.Theme.dividerPaint
            goto L37
        L3c:
            if (r6 == 0) goto L83
        ...
        L83:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Cells.TextCheckCell.onDraw(android.graphics.Canvas):void");
    }
    ...
    public void setColorfullIcon(int i, int i2) {
        if (this.imageView == null) {
            ...
            this.padding = AndroidUtilities.m1036dp(65.0f);
        ...
        rLottieImageView2.setBackground(Theme.createRoundRectDrawable(iM1036dp, i));
        this.imageView.setAlpha(isEnabled() ? 1.0f : 0.5f);
    }
