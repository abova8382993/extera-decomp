...
public class PhotoPickerPhotoCell extends FrameLayout {
    ...
    public PhotoPickerPhotoCell(Context context) {
        ...
        this.videoInfoContainer.setPadding(AndroidUtilities.m1036dp(3.0f), 0, AndroidUtilities.m1036dp(3.0f), 0);
        addView(this.videoInfoContainer, LayoutHelper.createFrame(-1, 16, 83));
        ImageView imageView = new ImageView(context);
        imageView.setImageResource(C2797R.drawable.ic_video);
    ...
    public void setImage(MediaController.PhotoEntry photoEntry) {
        Drawable drawable = getResources().getDrawable(C2797R.drawable.nophotos);
        ...
        if (str2 != null) {
            ...
            if (photoEntry.isLivePhoto()) {
                ...
                setContentDescription(LocaleController.getString(C2797R.string.AttachLivePhoto));
            ...
            if (z) {
                ...
                setContentDescription(LocaleController.getString(C2797R.string.AttachVideo) + ", " + LocaleController.formatDuration(photoEntry.duration));
                this.imageView.setImage("vthumb://" + photoEntry.imageId + ":" + photoEntry.path, null, drawable);
                return;
            }
            frameLayout.setVisibility(4);
            setContentDescription(LocaleController.getString(C2797R.string.AttachPhoto));
            this.imageView.setImage("thumb://" + photoEntry.imageId + ":" + photoEntry.path, null, drawable);
            return;
        }
