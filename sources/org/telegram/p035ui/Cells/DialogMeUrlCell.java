...
public class DialogMeUrlCell extends BaseCell {
    ...
    public DialogMeUrlCell(Context context) {
        ...
        this.messageTop = AndroidUtilities.m1036dp(40.0f);
        this.avatarTop = AndroidUtilities.m1036dp(10.0f);
    ...
    public void onMeasure(int i, int i2) {
        setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m1036dp(72.0f) + (this.useSeparator ? 1 : 0));
    }
    ...
    public void buildLayout() {
        ...
        if (recentMeUrl instanceof TLRPC.TL_recentMeUrlChat) {
            ...
            if (!LocaleController.isRTL) {
                this.nameLockLeft = AndroidUtilities.m1036dp(AndroidUtilities.leftBaseline);
                this.nameLeft = AndroidUtilities.m1036dp(AndroidUtilities.leftBaseline + 4);
            } else {
                this.nameLockLeft = getMeasuredWidth() - AndroidUtilities.m1036dp(AndroidUtilities.leftBaseline);
                this.nameLeft = AndroidUtilities.m1036dp(14.0f);
            }
            userName = chat.title;
            ...
            if (!LocaleController.isRTL) {
                this.nameLeft = AndroidUtilities.m1036dp(AndroidUtilities.leftBaseline);
            } else {
                this.nameLeft = AndroidUtilities.m1036dp(14.0f);
            }
            if (user != null) {
                if (user.bot) {
                    this.nameLockTop = AndroidUtilities.m1036dp(16.5f);
                    if (!LocaleController.isRTL) {
                        this.nameLockLeft = AndroidUtilities.m1036dp(AndroidUtilities.leftBaseline);
                        this.nameLeft = AndroidUtilities.m1036dp(AndroidUtilities.leftBaseline + 4);
                    } else {
        ...
        if (TextUtils.isEmpty(userName)) {
            userName = LocaleController.getString(C2797R.string.HiddenName);
        }
        if (!LocaleController.isRTL) {
            measuredWidth = getMeasuredWidth() - this.nameLeft;
            iM1036dp = AndroidUtilities.m1036dp(14.0f);
        } else {
            measuredWidth = getMeasuredWidth() - this.nameLeft;
            iM1036dp = AndroidUtilities.m1036dp(AndroidUtilities.leftBaseline);
        }
        int iM1036dp2 = measuredWidth - iM1036dp;
        if (this.drawNameLock) {
            iM1036dp2 -= AndroidUtilities.m1036dp(4.0f) + Theme.dialogs_lockDrawable.getIntrinsicWidth();
        }
        if (this.drawVerified) {
            int iM1036dp3 = AndroidUtilities.m1036dp(6.0f) + Theme.dialogs_verifiedDrawable.getIntrinsicWidth();
            iM1036dp2 -= iM1036dp3;
            if (LocaleController.isRTL) {
                this.nameLeft += iM1036dp3;
            }
        }
        int iMax = Math.max(AndroidUtilities.m1036dp(12.0f), iM1036dp2);
        try {
            StaticLayout staticLayout = new StaticLayout(TextUtils.ellipsize(userName.replace('\n', ' '), textPaint, iMax - AndroidUtilities.m1036dp(12.0f), TextUtils.TruncateAt.END), textPaint, iMax, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            i = iMax;
            try {
        ...
        int measuredWidth3 = getMeasuredWidth() - AndroidUtilities.m1036dp(AndroidUtilities.leftBaseline + 16);
        if (!LocaleController.isRTL) {
            this.messageLeft = AndroidUtilities.m1036dp(AndroidUtilities.leftBaseline);
            measuredWidth2 = AndroidUtilities.m1036dp(AndroidUtilities.isTablet() ? 13.0f : 9.0f);
        } else {
            this.messageLeft = AndroidUtilities.m1036dp(16.0f);
            measuredWidth2 = getMeasuredWidth() - AndroidUtilities.m1036dp(AndroidUtilities.isTablet() ? 65.0f : 61.0f);
        }
        this.avatarImage.setImageCoords(measuredWidth2, this.avatarTop, AndroidUtilities.m1036dp(52.0f), AndroidUtilities.m1036dp(52.0f));
        int iMax2 = Math.max(AndroidUtilities.m1036dp(12.0f), measuredWidth3);
        try {
            this.messageLayout = new StaticLayout(TextUtils.ellipsize(str3, textPaint2, iMax2 - AndroidUtilities.m1036dp(12.0f), TextUtils.TruncateAt.END), textPaint2, iMax2, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        } catch (Exception e3) {
            FileLog.m1048e(e3);
        }
        ...
        if (z) {
            if (staticLayout2 != null && staticLayout2.getLineCount() > 0) {
                ...
                if (this.drawVerified) {
                    this.nameMuteLeft = (int) (((((double) this.nameLeft) + (((double) i) - dCeil)) - ((double) AndroidUtilities.m1036dp(6.0f))) - ((double) Theme.dialogs_verifiedDrawable.getIntrinsicWidth()));
                }
                if (lineLeft == 0.0f) {
                    double d = i;
                    if (dCeil < d) {
        ...
        if (staticLayout2 != null && staticLayout2.getLineCount() > 0) {
            ...
            if (this.drawVerified) {
                this.nameMuteLeft = (int) (this.nameLeft + lineRight + AndroidUtilities.m1036dp(6.0f));
            }
        }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.nameLayout != null) {
            canvas2.save();
            canvas2.translate(this.nameLeft, AndroidUtilities.m1036dp(13.0f));
        ...
        if (this.drawVerified) {
            BaseCell.setDrawableBounds(Theme.dialogs_verifiedDrawable, this.nameMuteLeft, AndroidUtilities.m1036dp(16.5f));
            BaseCell.setDrawableBounds(Theme.dialogs_verifiedCheckDrawable, this.nameMuteLeft, AndroidUtilities.m1036dp(16.5f));
