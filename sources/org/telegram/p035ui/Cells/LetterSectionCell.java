...
public class LetterSectionCell extends FrameLayout {
    ...
    public LetterSectionCell(Context context) {
        super(context);
        setLayoutParams(new ViewGroup.LayoutParams(AndroidUtilities.m1036dp(76.0f), AndroidUtilities.m1036dp(64.0f)));
    ...
    public void setCellHeight(int i) {
        setLayoutParams(new ViewGroup.LayoutParams(AndroidUtilities.m1036dp(54.0f), i));
    }
}
