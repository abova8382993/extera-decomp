...
public class SharedAudioCell extends FrameLayout implements DownloadController.FileDownloadProgressListener, NotificationCenter.NotificationCenterDelegate {
    ...
    public SharedAudioCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        super(context);
        this.titleY = AndroidUtilities.m1036dp(9.0f);
        this.descriptionY = AndroidUtilities.m1036dp(29.0f);
        this.captionY = AndroidUtilities.m1036dp(29.0f);
        ...
        if (resourcesProvider != null) {
            ...
            this.titlePaint.setTextSize(AndroidUtilities.m1036dp(15.0f));
    ...
    public void onMeasure(int i, int i2) {
        ...
        int size = (View.MeasureSpec.getSize(i) - AndroidUtilities.m1036dp(AndroidUtilities.leftBaseline)) - AndroidUtilities.m1036dp(28.0f);
        if (this.viewType == 1) {
            ...
            this.dateLayoutX = ((size - iCeil) - AndroidUtilities.m1036dp(8.0f)) + AndroidUtilities.m1036dp(20.0f);
            iM1036dp = iCeil + AndroidUtilities.m1036dp(12.0f);
        } else {
            iM1036dp = 0;
        }
        try {
            ...
            StaticLayout staticLayout = new StaticLayout(TextUtils.ellipsize(charSequenceReplace, textPaint2, size - iM1036dp, TextUtils.TruncateAt.END), textPaint2, (AndroidUtilities.m1036dp(4.0f) + size) - iM1036dp, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        ...
        try {
            if (this.currentMessageObject.isVoice() || this.currentMessageObject.isRoundVideo()) {
                ...
                this.descriptionLayout = new StaticLayout(TextUtils.ellipsize(str2, textPaint3, size, TextUtils.TruncateAt.END), textPaint3, size + AndroidUtilities.m1036dp(4.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            } else {
                ...
                this.descriptionLayout = new StaticLayout(SpannableStringBuilder.valueOf(TextUtils.ellipsize(charSequenceReplace2, textPaint4, size - textPaint4.measureText(str), TextUtils.TruncateAt.END)).append((CharSequence) str), textPaint4, size + AndroidUtilities.m1036dp(4.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            }
        ...
        setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m1036dp(56.0f) + (this.captionLayout != null ? AndroidUtilities.m1036dp(18.0f) : 0) + (this.needDivider ? 1 : 0));
        int size2 = LocaleController.isRTL ? (View.MeasureSpec.getSize(i) - AndroidUtilities.m1036dp(8.0f)) - AndroidUtilities.m1036dp(52.0f) : AndroidUtilities.m1036dp(8.0f);
        RadialProgress2 radialProgress2 = this.radialProgress;
        int iM1036dp2 = AndroidUtilities.m1036dp(4.0f) + size2;
        this.buttonX = iM1036dp2;
        int iM1036dp3 = AndroidUtilities.m1036dp(6.0f);
        this.buttonY = iM1036dp3;
        radialProgress2.setProgressRect(iM1036dp2, iM1036dp3, size2 + AndroidUtilities.m1036dp(48.0f), AndroidUtilities.m1036dp(50.0f));
        measureChildWithMargins(this.checkBox, i, 0, i2, 0);
        if (this.captionLayout != null) {
            this.captionY = AndroidUtilities.m1036dp(29.0f);
            this.descriptionY = AndroidUtilities.m1036dp(29.0f) + AndroidUtilities.m1036dp(18.0f);
        } else {
            this.descriptionY = AndroidUtilities.m1036dp(29.0f);
        }
    }
    ...
    */
    private boolean checkAudioMotionEvent(android.view.MotionEvent r9) {
        ...
        Lc5:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Cells.SharedAudioCell.checkAudioMotionEvent(android.view.MotionEvent):boolean");
    }
    ...
    public void updateButtonState(boolean z, boolean z2) {
        ...
        if (z3) {
            DownloadController.getInstance(i3).removeLoadingFileObserver(this);
        ...
        DownloadController.getInstance(i3).addLoadingFileObserver(fileName, this.currentMessageObject, this);
        if (!FileLoader.getInstance(this.currentAccount).isLoadingFile(fileName)) {
            this.buttonState = 2;
            ...
            if (fileProgress2 != null) {
                radialProgress22.setProgress(fileProgress2.floatValue(), z2);
            } else {
                radialProgress22.setProgress(0.0f, z2);
            }
        }
        this.radialProgress.setIcon(getIconForCurrentState(), z, z2);
        invalidate();
    ...
    public boolean needPlayMessage(MessageObject messageObject) {
        Utilities.CallbackReturn<MessageObject, Boolean> callbackReturn = this.needPlayMessageListener;
        return callbackReturn != null && callbackReturn.run(messageObject).booleanValue();
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.currentMessageObject.isMusic()) {
            accessibilityNodeInfo.setText(LocaleController.formatString("AccDescrMusicInfo", C2797R.string.AccDescrMusicInfo, this.currentMessageObject.getMusicAuthor(), this.currentMessageObject.getMusicTitle()));
    ...
    */
    public void dispatchDraw(android.graphics.Canvas r20) {
        ...
        L92:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Cells.SharedAudioCell.dispatchDraw(android.graphics.Canvas):void");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void drawReorder(android.graphics.Canvas r7) {
        /*
            r6 = this;
            boolean r0 = r6.showReorderIcon
            r1 = 0
            if (r0 != 0) goto Ld
            float r2 = r6.showReorderIconProgress
        ...
        Ld:
            ...
            if (r0 == 0) goto L21
            float r4 = r6.showReorderIconProgress
            int r5 = (r4 > r3 ? 1 : (r4 == r3 ? 0 : -1))
            if (r5 == 0) goto L21
            float r4 = r4 + r2
            r6.showReorderIconProgress = r4
            r6.invalidate()
            goto L2f
        L21:
            if (r0 != 0) goto L2f
            float r0 = r6.showReorderIconProgress
            int r4 = (r0 > r1 ? 1 : (r0 == r1 ? 0 : -1))
            if (r4 == 0) goto L2f
            float r0 = r0 - r2
            r6.showReorderIconProgress = r0
            r6.invalidate()
        L2f:
            float r0 = r6.showReorderIconProgress
            ...
            int r0 = r0 - r1
            android.graphics.drawable.Drawable r1 = org.telegram.p035ui.ActionBar.Theme.dialogs_reorderDrawable
            int r1 = r1.getIntrinsicWidth()
            int r0 = r0 - r1
            int r1 = r6.getMeasuredHeight()
            android.graphics.drawable.Drawable r2 = org.telegram.p035ui.ActionBar.Theme.dialogs_reorderDrawable
            int r2 = r2.getIntrinsicHeight()
            int r1 = r1 - r2
            int r1 = r1 >> 1
            r7.save()
            float r6 = r6.showReorderIconProgress
            float r2 = (float) r0
            android.graphics.drawable.Drawable r3 = org.telegram.p035ui.ActionBar.Theme.dialogs_reorderDrawable
            ...
            float r2 = r2 + r3
            float r3 = (float) r1
            android.graphics.drawable.Drawable r5 = org.telegram.p035ui.ActionBar.Theme.dialogs_reorderDrawable
            int r5 = r5.getIntrinsicHeight()
            float r5 = (float) r5
            float r5 = r5 / r4
            float r3 = r3 + r5
            r7.scale(r6, r6, r2, r3)
            android.graphics.drawable.Drawable r6 = org.telegram.p035ui.ActionBar.Theme.dialogs_reorderDrawable
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Cells.SharedAudioCell.drawReorder(android.graphics.Canvas):void");
    }
    ...
    private void drawInternal(Canvas canvas) {
        ...
        if (this.dateLayout != null) {
            canvas.save();
            canvas.translate(AndroidUtilities.m1036dp(LocaleController.isRTL ? 24.0f : AndroidUtilities.leftBaseline) + (LocaleController.isRTL ? 0 : this.dateLayoutX), this.titleY);
        ...
        if (this.titleLayout != null) {
            ...
            canvas.save();
            int iM1036dp = AndroidUtilities.m1036dp(LocaleController.isRTL ? 24.0f : AndroidUtilities.leftBaseline);
            if (LocaleController.isRTL && (staticLayout = this.dateLayout) != null) {
                width = staticLayout.getWidth() + AndroidUtilities.m1036dp(LocaleController.isRTL ? 12.0f : 4.0f);
            }
            canvas.translate(((iM1036dp + width) + (LocaleController.isRTL ? this.titleLayout.getWidth() - this.titleLayoutWidth : 0.0f)) - this.titleLayoutLeft, this.titleY);
        ...
        if (this.captionLayout != null) {
            ...
            canvas.save();
            canvas.translate((AndroidUtilities.m1036dp(LocaleController.isRTL ? 24.0f : AndroidUtilities.leftBaseline) + (LocaleController.isRTL ? this.captionLayout.getWidth() - this.captionLayoutWidth : 0.0f)) - this.captionLayoutLeft, this.captionY);
        ...
        if (this.descriptionLayout != null) {
            ...
            canvas.save();
            canvas.translate((AndroidUtilities.m1036dp(LocaleController.isRTL ? 24.0f : AndroidUtilities.leftBaseline) + (LocaleController.isRTL ? this.descriptionLayout.getWidth() - this.descriptionLayoutWidth : 0.0f)) - this.descriptionLayoutLeft, this.descriptionY);
        ...
        if (this.needDivider) {
            if (LocaleController.isRTL) {
                canvas.drawLine(0.0f, getHeight() - 1, (getWidth() - AndroidUtilities.m1036dp(72.0f)) - getPaddingRight(), getHeight() - 1, Theme.getThemePaint("paintDivider", this.resourcesProvider));
            } else {
                canvas.drawLine(AndroidUtilities.m1036dp(72.0f), getHeight() - 1, getWidth() - getPaddingRight(), getHeight() - 1, Theme.getThemePaint("paintDivider", this.resourcesProvider));
            }
        }
    }
    ...
    public static final class Factory extends UItem.UItemFactory<SharedAudioCell> {
        ...
        public static UItem m1133as(MessageObject messageObject, Utilities.CallbackReturn<MessageObject, Boolean> callbackReturn) {
        ...
        /* JADX INFO: renamed from: as */
        public static UItem m1132as(MediaController.AudioEntry audioEntry, Utilities.CallbackReturn<MessageObject, Boolean> callbackReturn) {
            UItem uItemOfFactory = UItem.ofFactory(Factory.class);
        ...
        public boolean equals(UItem uItem, UItem uItem2) {
            return uItem.f1708id == uItem2.f1708id && uItem.object == uItem2.object;
        }
