...
public class AnimatedStatusView extends View {
    ...
    private float f1491y1;

    /* JADX INFO: renamed from: y2 */
    private float f1492y2;
    ...
    public void dispatchDraw(Canvas canvas) {
        int iM1036dp = AndroidUtilities.m1036dp(this.renderedEffectsSize);
        int iM1036dp2 = AndroidUtilities.m1036dp(this.effectsSize);
        for (int i = 0; i < this.animations.size(); i++) {
            Object obj = this.animations.get(i);
            if (obj instanceof ImageReceiver) {
                ImageReceiver imageReceiver = (ImageReceiver) obj;
                float f = iM1036dp2;
                imageReceiver.setImageCoords((getMeasuredWidth() - iM1036dp2) / 2.0f, (getMeasuredHeight() - iM1036dp2) / 2.0f, f, f);
                imageReceiver.draw(canvas);
            } else if (obj instanceof AnimatedEmojiEffect) {
                AnimatedEmojiEffect animatedEmojiEffect = (AnimatedEmojiEffect) obj;
                animatedEmojiEffect.setBounds((int) ((getMeasuredWidth() - iM1036dp) / 2.0f), (int) ((getMeasuredHeight() - iM1036dp) / 2.0f), (int) ((getMeasuredWidth() + iM1036dp) / 2.0f), (int) ((getMeasuredHeight() + iM1036dp) / 2.0f));
    ...
    private void detach() {
        if (!this.animations.isEmpty()) {
            ArrayList<Object> arrayList = this.animations;
