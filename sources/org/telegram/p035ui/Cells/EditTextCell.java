...
public class EditTextCell extends FrameLayout {
    ...
    public EditTextCell(Context context, String str, final boolean z, final boolean z2, final int i, final Theme.ResourcesProvider resourcesProvider) {
        ...
        EditTextCaption editTextCaption = new EditTextCaption(context, resourcesProvider) { // from class: org.telegram.ui.Cells.EditTextCell.2
            ...
            public void dispatchDraw(Canvas canvas) {
                ...
                EditTextCell.this.limit.setBounds(getScrollX(), getHeight() - Math.min(AndroidUtilities.m1036dp(52.0f), getHeight()), ((getScrollX() + getWidth()) - getPaddingRight()) + AndroidUtilities.m1036dp(42.0f), getHeight());
            ...
            public void extendActionMode(ActionMode actionMode, Menu menu) {
                if (z2 && menu.findItem(C2797R.id.menu_bold) == null) {
                    ...
                    SpannableStringBuilder spannableStringBuilder3 = new SpannableStringBuilder(LocaleController.getString(C2797R.string.Strike));
                    TextStyleSpan.TextStyleRun textStyleRun = new TextStyleSpan.TextStyleRun();
                    textStyleRun.flags |= 8;
                    spannableStringBuilder3.setSpan(new TextStyleSpan(textStyleRun), 0, spannableStringBuilder3.length(), 33);
                    menu.add(C2797R.id.menu_groupbolditalic, C2797R.id.menu_strike, 8, spannableStringBuilder3);
        ...
        editTextCaption.setPadding(AndroidUtilities.m1036dp(21.0f), AndroidUtilities.m1036dp(15.0f), AndroidUtilities.m1036dp((i > 0 ? 42 : 0) + 21), AndroidUtilities.m1036dp(15.0f));
        editTextCaption.setGravity((LocaleController.isRTL ? 5 : 3) | 48);
        editTextCaption.setInputType((z ? 131072 : 0) | 573441);
        editTextCaption.setRawInputType((z ? 131072 : i2) | 573441);
    ...
    public ImageView setLeftDrawable(Drawable drawable) {
        ...
        layoutParams.leftMargin = AndroidUtilities.m1036dp(24.0f);
    ...
    public void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if (this.needDivider) {
            canvas.drawLine(LocaleController.isRTL ? 0.0f : AndroidUtilities.m1036dp(22.0f), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m1036dp(22.0f) : 0), getMeasuredHeight() - 1, Theme.dividerPaint);
        }
    }
