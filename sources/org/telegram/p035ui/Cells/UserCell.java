...
public class UserCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public class C33931 extends StoriesUtilities.AvatarStoryParams {
        public C33931(boolean z) {
            super(z);
        }
    ...
    public void openStory(long j, Runnable runnable) {
        ...
        if (lastFragment != null) {
            ...
            lastFragment.getOrCreateStoryViewer().open(getContext(), j, StoriesListPlaceProvider.m1210of((RecyclerListView) getParent()));
        }
    }
    ...
    public UserCell(Context context, int i, int i2, boolean z, boolean z2, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (z2) {
            ...
            this.addButton.setText(LocaleController.getString(C2797R.string.Add));
            this.addButton.setPadding(AndroidUtilities.m1036dp(17.0f), 0, AndroidUtilities.m1036dp(17.0f), 0);
            ...
            iCeil = (int) Math.ceil((this.addButton.getPaint().measureText(this.addButton.getText().toString()) + AndroidUtilities.m1036dp(48.0f)) / AndroidUtilities.density);
        } else {
            iCeil = 0;
        }
        this.padding = i;
        ...
        C33942 c33942 = new BackupImageView(context) { // from class: org.telegram.ui.Cells.UserCell.2
            public C33942(Context context2) {
                super(context2);
            }
        ...
        this.avatarImageView = c33942;
        c33942.setRoundRadius(ExteraConfig.getAvatarCorners(46.0f));
        ...
        this.botVerification = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(this.nameTextView, AndroidUtilities.m1036dp(20.0f));
        this.emojiStatus = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(this.nameTextView, AndroidUtilities.m1036dp(20.0f));
        this.emojiStatus2 = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(this.nameTextView, AndroidUtilities.m1036dp(20.0f));
        ...
        if (i2 == 2) {
            ...
            this.checkBox3.setImageResource(C2797R.drawable.account_check);
        ...
        imageView4.setImageResource(C2797R.drawable.msg_switch);
        ...
        imageView4.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Cells.UserCell$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view9) {
                NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.showBulletin, 1, LocaleController.getString(C2797R.string.MutualContactInfo));
            }
        });
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C33942 extends BackupImageView {
        public C33942(Context context2) {
            super(context2);
        }
    ...
    public void setAvatarPadding(int i, int i2) {
        ...
        layoutParams.leftMargin = AndroidUtilities.m1036dp(LocaleController.isRTL ? 0.0f : i + 7);
        layoutParams.rightMargin = AndroidUtilities.m1036dp(LocaleController.isRTL ? i + 7 : 0.0f);
        ...
        layoutParams2.leftMargin = AndroidUtilities.m1036dp(i3);
        if (LocaleController.isRTL) {
            f = i + 64 + i2;
        } else {
            f = (this.checkBoxBig != null ? 18 : 0) + 28;
        }
        layoutParams2.rightMargin = AndroidUtilities.m1036dp(f);
        FrameLayout.LayoutParams layoutParams3 = (FrameLayout.LayoutParams) this.statusTextView.getLayoutParams();
        layoutParams3.leftMargin = AndroidUtilities.m1036dp(LocaleController.isRTL ? 28.0f : i + 64 + i2);
        layoutParams3.rightMargin = AndroidUtilities.m1036dp(LocaleController.isRTL ? i + 64 + i2 : 28.0f);
        CheckBox2 checkBox2 = this.checkBox;
        if (checkBox2 != null) {
            FrameLayout.LayoutParams layoutParams4 = (FrameLayout.LayoutParams) checkBox2.getLayoutParams();
            layoutParams4.leftMargin = AndroidUtilities.m1036dp(LocaleController.isRTL ? 0.0f : i + 32 + i2);
            layoutParams4.rightMargin = AndroidUtilities.m1036dp(LocaleController.isRTL ? i + 32 + i2 : 0.0f);
        }
    }
    ...
    public void setAdminRole(String str, boolean z, boolean z2, boolean z3, View.OnClickListener onClickListener) {
        ...
        if (z || z2) {
            ...
            this.adminTextView.setPadding(AndroidUtilities.m1036dp(6.0f), AndroidUtilities.m1036dp(0.66f), AndroidUtilities.m1036dp(6.0f), AndroidUtilities.m1036dp(1.0f));
            this.adminTextView.setTranslationX(AndroidUtilities.m1036dp(6.0f));
            this.adminTextView.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1036dp(32.0f), Theme.multAlpha(color, 0.12f)));
            this.adminTextView.setOnClickListener(onClickListener);
        } else if (z3 && TextUtils.isEmpty(str)) {
            this.adminTextView.setText(LocaleController.getString(C2797R.string.AddTag));
            this.adminTextView.setPadding(AndroidUtilities.m1036dp(6.0f), AndroidUtilities.m1036dp(0.66f), AndroidUtilities.m1036dp(6.0f), AndroidUtilities.m1036dp(1.0f));
            this.adminTextView.setTranslationX(AndroidUtilities.m1036dp(6.0f));
            this.adminTextView.setBackground(Theme.createRadSelectorDrawable(Theme.multAlpha(color, 0.12f), AndroidUtilities.m1036dp(32.0f), AndroidUtilities.m1036dp(32.0f)));
            this.adminTextView.setOnClickListener(onClickListener);
        } else {
            this.adminTextView.setText(str);
    ...
    public void setRightPadding(int i, boolean z, boolean z2) {
        if (i > 0) {
            i += AndroidUtilities.m1036dp(6.0f);
        }
        if (z) {
    ...
    public void setException(NotificationsSettingsActivity.NotificationException notificationException, CharSequence charSequence, boolean z) {
        ...
        if (notificationException.story) {
            ...
            if (i <= 0 && notificationException.auto) {
                string = LocaleController.getString(C2797R.string.NotificationEnabledAutomatically);
            } else if (i <= 0) {
                string = LocaleController.getString(C2797R.string.NotificationEnabled);
            } else {
                string = LocaleController.getString(C2797R.string.NotificationDisabled);
            }
        } else {
            ...
            if (i2 != 3 || i3 == Integer.MAX_VALUE) {
                ...
                if (z3 && z2) {
                    string = LocaleController.getString(C2797R.string.NotificationsCustom);
                } else {
                    string = LocaleController.getString(z3 ? C2797R.string.NotificationsUnmuted : C2797R.string.NotificationsMuted);
                }
            } else {
                int currentTime = i3 - ConnectionsManager.getInstance(this.currentAccount).getCurrentTime();
                if (currentTime <= 0) {
                    string = z2 ? LocaleController.getString(C2797R.string.NotificationsCustom) : LocaleController.getString(C2797R.string.NotificationsUnmuted);
                } else {
                    string = currentTime < 3600 ? LocaleController.formatString("WillUnmuteIn", C2797R.string.WillUnmuteIn, LocaleController.formatPluralString("Minutes", currentTime / 60, new Object[0])) : currentTime < 86400 ? LocaleController.formatString("WillUnmuteIn", C2797R.string.WillUnmuteIn, LocaleController.formatPluralString("Hours", (int) Math.ceil((currentTime / 60.0f) / 60.0f), new Object[0])) : currentTime < 31536000 ? LocaleController.formatString("WillUnmuteIn", C2797R.string.WillUnmuteIn, LocaleController.formatPluralString("Days", (int) Math.ceil(((currentTime / 60.0f) / 60.0f) / 24.0f), new Object[0])) : null;
                }
            }
            if (string == null) {
                string = LocaleController.getString(C2797R.string.NotificationsOff);
            }
    ...
    public void setCallCellStyle(int i) {
        ...
        this.avatarImageView.setRoundRadius(AndroidUtilities.m1036dp(22.0f));
    ...
    public void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(this.callCellStyle ? 56.0f : 58.0f) + (this.needDivider ? 1 : 0), TLObject.FLAG_30));
    }
    ...
    public void update(int i) {
        ...
        SimpleTextView simpleTextView = this.nameTextView;
        if (z3) {
            ((FrameLayout.LayoutParams) simpleTextView.getLayoutParams()).topMargin = AndroidUtilities.m1036dp(19.0f);
            ...
            j = 0;
            ((FrameLayout.LayoutParams) simpleTextView.getLayoutParams()).topMargin = AndroidUtilities.m1036dp(10.0f);
            if (user != null) {
                if (this.selfAsSavedMessages && UserObject.isUserSelf(user)) {
                    this.nameTextView.setText(LocaleController.getString(C2797R.string.SavedMessages), true);
                    this.statusTextView.setText(null);
                    this.avatarDrawable.setAvatarType(1);
                    this.avatarImageView.setImage((ImageLocation) null, "50_50", this.avatarDrawable, user);
                    ((FrameLayout.LayoutParams) this.nameTextView.getLayoutParams()).topMargin = AndroidUtilities.m1036dp(19.0f);
                    return;
                }
        ...
        if (user != null && DialogObject.getEmojiStatusDocumentId(user.emoji_status) != j) {
            ...
            if (user != null && MessagesController.getInstance(this.currentAccount).isPremiumUser(user) && !MessagesController.getInstance(this.currentAccount).premiumFeaturesBlocked()) {
                if (this.premiumDrawable == null) {
                    this.premiumDrawable = getContext().getResources().getDrawable(C2797R.drawable.msg_premium_liststar).mutate();
                    C33953 c33953 = new AnimatedEmojiDrawable.WrapSizeDrawable(this.premiumDrawable, AndroidUtilities.m1036dp(14.0f), AndroidUtilities.m1036dp(14.0f)) { // from class: org.telegram.ui.Cells.UserCell.3
                        public C33953(Drawable drawable2, int i2, int i3) {
                    ...
                    this.premiumDrawable = c33953;
                    c33953.setColorFilter(new PorterDuffColorFilter(Theme.getColor(Theme.key_chats_verifiedBackground, this.resourcesProvider), PorterDuff.Mode.MULTIPLY));
                }
                if (badge == null) {
        ...
        this.nameTextView.setRightDrawableTopPadding(-AndroidUtilities.m1036dp(0.5f));
        if (this.currentStatus != null) {
            ...
            if (user.bot) {
                ...
                if (user.bot_chat_history || ((textView = this.adminTextView) != null && textView.getVisibility() == 0)) {
                    this.statusTextView.setText(LocaleController.getString(C2797R.string.BotStatusRead));
                } else {
                    this.statusTextView.setText(LocaleController.getString(C2797R.string.BotStatusCantRead));
                }
            } else if (user.f1407id == UserConfig.getInstance(this.currentAccount).getClientUserId() || (((userStatus = user.status) != null && userStatus.expires > ConnectionsManager.getInstance(this.currentAccount).getCurrentTime()) || MessagesController.getInstance(this.currentAccount).onlinePrivacy.containsKey(Long.valueOf(user.f1407id)))) {
                this.statusTextView.setTextColor(this.statusOnlineColor);
                this.statusTextView.setText(LocaleController.getString(C2797R.string.Online));
            } else {
                this.statusTextView.setTextColor(this.statusColor);
        ...
        backupImageView2.setRoundRadius(ExteraConfig.getAvatarCorners(46.0f, false, z, zHasStories));
        ...
        if (this.mutual) {
            this.nameTextView.setPadding(LocaleController.isRTL ? AndroidUtilities.m1036dp(33.0f) : 0, 0, !LocaleController.isRTL ? AndroidUtilities.m1036dp(33.0f) : 0, 0);
        }
    }

    /* JADX INFO: renamed from: org.telegram.ui.Cells.UserCell$3 */
    /* JADX INFO: loaded from: classes6.dex */
    public class C33953 extends AnimatedEmojiDrawable.WrapSizeDrawable {
        public C33953(Drawable drawable2, int i2, int i3) {
            super(drawable2, i2, i3);
        }
    ...
    public void onDraw(Canvas canvas) {
        if (this.needDivider) {
            canvas.drawLine(LocaleController.isRTL ? 0.0f : AndroidUtilities.m1036dp(68.0f), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m1036dp(68.0f) : 0), getMeasuredHeight() - 1, Theme.dividerPaint);
        }
    }
