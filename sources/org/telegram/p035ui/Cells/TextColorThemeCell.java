...
public class TextColorThemeCell extends FrameLayout {
    ...
    public TextColorThemeCell(Context context) {
        ...
        this.textView.setPadding(0, 0, 0, AndroidUtilities.m1036dp(3.0f));
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (i != 0) {
            ...
            canvas.drawCircle(!LocaleController.isRTL ? AndroidUtilities.m1036dp(28.0f) : getMeasuredWidth() - AndroidUtilities.m1036dp(28.0f), getMeasuredHeight() / 2, AndroidUtilities.m1036dp(10.0f), colorPaint);
        }
    }
}
