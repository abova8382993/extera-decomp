...
public abstract class EditEmojiTextCell extends FrameLayout {
    ...
    public EditEmojiTextCell(Context context, SizeNotifierFrameLayout sizeNotifierFrameLayout, String str, final boolean z, final int i, int i2, final Theme.ResourcesProvider resourcesProvider) {
        ...
        animatedTextDrawable.setTextSize(AndroidUtilities.m1036dp(15.33f));
        ...
        EditTextEmoji editTextEmoji = new EditTextEmoji(context, sizeNotifierFrameLayout, null, i2, true) { // from class: org.telegram.ui.Cells.EditEmojiTextCell.2
            ...
            public void onDraw(Canvas canvas) {
                ...
                int iMin = Math.min(AndroidUtilities.m1036dp(48.0f), getHeight());
                float f2 = z ? 0.0f : -AndroidUtilities.m1036dp(1.0f);
                EditEmojiTextCell.this.limit.setBounds(getScrollX(), (getHeight() + f2) - iMin, (getScrollX() + getWidth()) - AndroidUtilities.m1036dp((z ? 0 : 44) + 12), f2 + getHeight());
            ...
            public void extendActionMode(ActionMode actionMode, Menu menu) {
                ...
                menu.add(C2797R.id.menu_groupbolditalic, C2797R.id.menu_strike, 9, spannableStringBuilder3);
                menu.add(C2797R.id.menu_groupbolditalic, C2797R.id.menu_regular, 10, LocaleController.getString(C2797R.string.Regular));
            }
        ...
        editText.setPadding(paddingLeft, paddingTop, AndroidUtilities.m1036dp(f), editText.getPaddingBottom());
        ...
        editText.setCursorSize(AndroidUtilities.m1036dp(19.0f));
    ...
    public void setOnChangeIconListener(View.OnClickListener onClickListener) {
        ...
        while (true) {
            ...
            this.iconImageView[i].setPadding(iM1036dp, iM1036dp, iM1036dp, iM1036dp);
