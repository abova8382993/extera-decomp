...
public class TextInfoPrivacyCell extends FrameLayout {
    ...
    public TextInfoPrivacyCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.textView.setPadding(0, AndroidUtilities.m1036dp(10.0f), 0, AndroidUtilities.m1036dp(17.0f));
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (i3 == -1) {
            ...
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(this.fixedSize), TLObject.FLAG_30));
        } else {
    ...
    public void setText(CharSequence charSequence) {
        ...
        if (charSequence == null) {
            linksTextView.setPadding(0, AndroidUtilities.m1036dp(2.0f), 0, 0);
        } else {
            linksTextView.setPadding(0, AndroidUtilities.m1036dp(this.topPadding), 0, AndroidUtilities.m1036dp(this.bottomPadding));
        }
    ...
    public void setEnabled(boolean z, ArrayList<Animator> arrayList) {
        LinkSpanDrawable.LinksTextView linksTextView = this.textView;
        if (arrayList != null) {
            arrayList.add(ObjectAnimator.ofFloat(linksTextView, (Property<LinkSpanDrawable.LinksTextView, Float>) View.ALPHA, z ? 1.0f : 0.5f));
        } else {
            linksTextView.setAlpha(z ? 1.0f : 0.5f);
        }
    }
