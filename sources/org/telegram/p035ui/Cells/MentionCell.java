...
public class MentionCell extends LinearLayout {
    ...
    public void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(36.0f), TLObject.FLAG_30));
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.needsDivider) {
            canvas.drawLine(AndroidUtilities.m1036dp(52.0f), getHeight() - 1, getWidth() - AndroidUtilities.m1036dp(8.0f), getHeight() - 1, Theme.dividerPaint);
        }
    }
    ...
    public void setEmojiSuggestion(MediaDataController.KeywordResult keywordResult) {
        ...
        textView.setPadding(AndroidUtilities.m1036dp(22.0f), 0, 0, 0);
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        Drawable drawable = this.emojiDrawable;
        if (drawable != null) {
            int iM1036dp = AndroidUtilities.m1036dp(drawable instanceof AnimatedEmojiDrawable ? 24.0f : 20.0f);
            int iM1036dp2 = AndroidUtilities.m1036dp(this.emojiDrawable instanceof AnimatedEmojiDrawable ? -2.0f : 0.0f);
            this.emojiDrawable.setBounds(this.nameTextView.getLeft() + iM1036dp2, ((this.nameTextView.getTop() + this.nameTextView.getBottom()) - iM1036dp) / 2, this.nameTextView.getLeft() + iM1036dp2 + iM1036dp, ((this.nameTextView.getTop() + this.nameTextView.getBottom()) + iM1036dp) / 2);
            Drawable drawable2 = this.emojiDrawable;
