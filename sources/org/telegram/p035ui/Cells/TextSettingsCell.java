...
public class TextSettingsCell extends FrameLayout {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.valueImageView.getVisibility() == 0) {
            this.valueImageView.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth2, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), TLObject.FLAG_30));
        }
        if (this.imageView.getVisibility() == 0) {
            boolean z = this.imageViewIsColorful;
            ImageView imageView = this.imageView;
            if (z) {
                imageView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(28.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(28.0f), TLObject.FLAG_30));
            } else {
                imageView.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth2, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), Integer.MIN_VALUE));
            }
            if (this.betterLayout) {
                measuredWidth2 -= this.imageView.getMeasuredWidth() + AndroidUtilities.m1036dp(8.0f);
            }
        }
        ...
        if (backupImageView != null) {
            ...
            if (this.betterLayout) {
                measuredWidth2 -= this.valueBackupImageView.getMeasuredWidth() + AndroidUtilities.m1036dp(8.0f);
            }
        }
        if (this.valueTextView.getVisibility() == 0) {
            this.valueTextView.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth2, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), TLObject.FLAG_30));
            boolean z2 = this.betterLayout;
            AnimatedTextView animatedTextView = this.valueTextView;
            if (z2) {
                measuredWidth = measuredWidth2 - (animatedTextView.getMeasuredWidth() + AndroidUtilities.m1036dp(8.0f));
            } else {
                measuredWidth = (measuredWidth - animatedTextView.getMeasuredWidth()) - AndroidUtilities.m1036dp(8.0f);
            }
            if (this.valueImageView.getVisibility() == 0) {
                ...
                int i3 = this.padding;
                if (z3) {
                    marginLayoutParams.leftMargin = AndroidUtilities.m1036dp(i3 + 4) + this.valueTextView.getMeasuredWidth();
                } else {
                    marginLayoutParams.rightMargin = AndroidUtilities.m1036dp(i3 + 4) + this.valueTextView.getMeasuredWidth();
                }
            }
        }
    ...
    public void setIcon(int i) {
        ...
        if (i == 0) {
            ...
            int i2 = this.padding;
            if (z) {
                marginLayoutParams.rightMargin = AndroidUtilities.m1036dp(i2);
                return;
            } else {
                marginLayoutParams.leftMargin = AndroidUtilities.m1036dp(i2);
                return;
            }
        }
        ...
        if (LocaleController.isRTL) {
            marginLayoutParams.rightMargin = AndroidUtilities.m1036dp(71.0f);
        } else {
            marginLayoutParams.leftMargin = AndroidUtilities.m1036dp(71.0f);
        }
    }
    ...
    */
    public void dispatchDraw(android.graphics.Canvas r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Cells.TextSettingsCell.dispatchDraw(android.graphics.Canvas):void");
    }
