...
public abstract class AboutLinkCell extends FrameLayout {
    ...
    public AboutLinkCell(Context context, BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.SPACE = AndroidUtilities.m1036dp(3.0f);
        this.longPressedRunnable = new RunnableC32522();
        this.expandT = 0.0f;
        ...
        TextView textView2 = new TextView(context) { // from class: org.telegram.ui.Cells.AboutLinkCell.1
            ...
            public void onDraw(Canvas canvas) {
                if (this.pressed) {
                    ...
                    canvas.drawRoundRect(rectF, AndroidUtilities.m1036dp(4.0f), AndroidUtilities.m1036dp(4.0f), Theme.chat_urlPaint);
                }
                super.onDraw(canvas);
            }
        };
        ...
        this.showMoreTextView.setTypeface(AndroidUtilities.regular());
        this.showMoreTextView.setLines(1);
        this.showMoreTextView.setMaxLines(1);
        this.showMoreTextView.setSingleLine(true);
        this.showMoreTextView.setText(LocaleController.getString(C2797R.string.DescriptionMore));
        this.showMoreTextView.setPadding(AndroidUtilities.m1036dp(2.0f), 0, AndroidUtilities.m1036dp(2.0f), 0);
        this.showMoreTextBackgroundView = new FrameLayout(context);
        Drawable drawableMutate = context.getResources().getDrawable(C2797R.drawable.gradient_left).mutate();
        ...
        frameLayout2.setPadding(frameLayout2.getPaddingLeft() + AndroidUtilities.m1036dp(4.0f), AndroidUtilities.m1036dp(1.0f), 0, AndroidUtilities.m1036dp(3.0f));
    ...
    public void updateColors() {
        ...
        ((TextPaint) Theme.profile_aboutTextPaint).linkColor = processColor(Theme.getColor(Theme.key_chat_messageLinkIn, this.resourcesProvider));
    }
    ...
    public void draw(Canvas canvas) {
        super.draw(canvas);
        float fPow = ((View) getParent()) == null ? 1.0f : (float) Math.pow(r1.getAlpha(), 2.0d);
        drawText(canvas);
    ...
    private void drawText(Canvas canvas) {
        ...
        int i;
        canvas.save();
        canvas.clipRect(AndroidUtilities.m1036dp(10.0f), AndroidUtilities.m1036dp(8.0f), getWidth() - AndroidUtilities.m1036dp(18.0f), getHeight());
        ...
        canvas.translate(0.0f, iM1036dp2);
        try {
            Theme.profile_aboutTextPaint.setColor(processColor(Theme.getColor(Theme.key_windowBackgroundWhiteBlackText, this.resourcesProvider)));
            ((TextPaint) Theme.profile_aboutTextPaint).linkColor = processColor(Theme.getColor(Theme.key_chat_messageLinkIn, this.resourcesProvider));
                ...
                if (this.nextLinesLayouts != null) {
                    ...
                    while (true) {
                        ...
                        if (staticLayout4 != null) {
                            ...
                            if (point != null) {
                                point.set((int) (this.textX + (lineRight2 * fEaseInOutCubic)), (int) (this.textY + lineTop + ((f3 - fEaseInOutCubic) * lineBottom2)));
                            }
                            int i3 = this.lastInlineLine;
                            if (i3 != -1 && i3 <= i2) {
                                canvas.translate(f2, lineTop + lineBottom2);
                                ...
                                f = f3;
                                i = iSave;
                                canvas.translate(lineRight2 * fEaseInOutCubic, ((f - fEaseInOutCubic) * lineBottom2) + lineTop);
                            }
                            staticLayout.draw(canvas);
                            canvas.restoreToCount(i);
                            lineRight2 += staticLayout.getLineRight(0) + this.SPACE;
                            lineBottom2 += (staticLayout.getLineBottom(0) + staticLayout.getTopPadding()) - 1;
                        } else {
                            f = f3;
                        }
                        i2++;
    ...
    public void setTextAndValue(String str, String str2, boolean z, boolean z2) {
        ...
        if (this.lastMaxWidth <= 0) {
            this.lastMaxWidth = AndroidUtilities.displaySize.x - AndroidUtilities.m1036dp(36.0f);
        }
    ...
    public class RunnableC32522 implements Runnable {
        public RunnableC32522() {
        }

        @Override // java.lang.Runnable
        public void run() {
            String string;
            final RunnableC32522 runnableC32522;
            if (AboutLinkCell.this.pressedLink != null) {
                boolean z = AboutLinkCell.this.pressedLink.getSpan() instanceof URLSpanNoUnderline;
                AboutLinkCell aboutLinkCell = AboutLinkCell.this;
                if (z) {
                    string = ((URLSpanNoUnderline) aboutLinkCell.pressedLink.getSpan()).getURL();
                } else {
                    boolean z2 = aboutLinkCell.pressedLink.getSpan() instanceof URLSpan;
                    AboutLinkCell aboutLinkCell2 = AboutLinkCell.this;
                    if (z2) {
                        string = ((URLSpan) aboutLinkCell2.pressedLink.getSpan()).getURL();
                    } else {
                        string = aboutLinkCell2.pressedLink.getSpan().toString();
                    }
                }
                ...
                if (AboutLinkCell.this.getContext() != null) {
                    ...
                    runnableC32522 = this;
                    builder.setItems(new CharSequence[]{LocaleController.getString(C2797R.string.Open), LocaleController.getString(C2797R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Cells.AboutLinkCell$2$$ExternalSyntheticLambda0
        ...
        public /* synthetic */ void lambda$run$0(ClickableSpan clickableSpan, Layout layout, float f, String str, DialogInterface dialogInterface, int i) {
            ...
            if (i == 1) {
                ...
                if (AndroidUtilities.shouldShowClipboardToast()) {
                    if (str.startsWith("@")) {
                        BulletinFactory.m1143of(AboutLinkCell.this.parentFragment).createSimpleBulletin(C2797R.raw.copy, LocaleController.getString(C2797R.string.UsernameCopied)).show();
                    } else if (str.startsWith("#") || str.startsWith("$")) {
                        BulletinFactory.m1143of(AboutLinkCell.this.parentFragment).createSimpleBulletin(C2797R.raw.copy, LocaleController.getString(C2797R.string.HashtagCopied)).show();
                    } else {
                        BulletinFactory.m1143of(AboutLinkCell.this.parentFragment).createSimpleBulletin(C2797R.raw.copy, LocaleController.getString(C2797R.string.LinkCopied)).show();
                    }
                }
            }
        }
    ...
    private LinkSpanDrawable hitLink(int i, int i2) {
        ...
        int i3;
        int i4;
        if (getMeasuredWidth() > 0 && i > getMeasuredWidth() - AndroidUtilities.m1036dp(18.0f)) {
            return null;
        }
    ...
    public void onLinkClick(ClickableSpan clickableSpan, Layout layout, float f) {
        ...
        if (layout != null && clickableSpan != null) {
            c32533 = new C32533(layout, clickableSpan, f);
        }
        this.currentProgress = c32533;
    ...
    public class C32533 extends Browser.Progress {
        ...
        public C32533(Layout layout, ClickableSpan clickableSpan, float f) {
    ...
    static {
        int iM1036dp = AndroidUtilities.m1036dp(76.0f);
        COLLAPSED_HEIGHT = iM1036dp;
        MAX_OPEN_HEIGHT = iM1036dp;
    ...
    private int fromHeight() {
        ...
        if (this.shouldExpand && (staticLayout = this.firstThreeLinesLayout) != null) {
            iM1036dp = staticLayout.getHeight() + AndroidUtilities.m1036dp(16.0f);
        } else {
            iM1036dp = COLLAPSED_HEIGHT;
        }
        if (this.valueTextView.getVisibility() == 0) {
            iM1036dp += AndroidUtilities.m1036dp(23.0f);
        }
        return Math.min(iM1036dp, textHeight());
    }
    ...
    public void onMeasure(int i, int i2) {
        checkTextLayout(View.MeasureSpec.getSize(i) - AndroidUtilities.m1036dp(36.0f), false);
    ...
    private void checkTextLayout(int i, boolean z) {
        ...
        if (spannableStringBuilder != null && (i != this.lastMaxWidth || z)) {
            ...
            if (this.shouldExpand && this.firstThreeLinesLayout != null) {
                int iFromHeight = fromHeight() - AndroidUtilities.m1036dp(8.0f);
                StaticLayout staticLayout = this.firstThreeLinesLayout;
    ...
    private int textHeight() {
        ...
        int height = (staticLayout != null ? staticLayout.getHeight() : AndroidUtilities.m1036dp(20.0f)) + AndroidUtilities.m1036dp(16.0f);
        return this.valueTextView.getVisibility() == 0 ? height + AndroidUtilities.m1036dp(23.0f) : height;
    }
    ...
    private CharSequence buildAccessibilityText() {
        ...
        for (final ClickableSpan clickableSpan : clickableSpanArr) {
            ...
            if (spanStart >= 0 && spanEnd > spanStart) {
                ...
                spannableStringBuilder3.setSpan(new ClickableSpan() { // from class: org.telegram.ui.Cells.AboutLinkCell.5
