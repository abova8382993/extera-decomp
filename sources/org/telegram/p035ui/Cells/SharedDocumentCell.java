...
public class SharedDocumentCell extends FrameLayout implements DownloadController.FileDownloadProgressListener {
    ...
    public SharedDocumentCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (i == 1) {
            ...
            addView(view, LayoutHelper.createFrame(32, -2.0f, (z4 ? 5 : 3) | 48, z4 ? 0.0f : 16.0f, 22.0f, z4 ? 16.0f : 0.0f, 0.0f));
        }
        C33501 c33501 = new BackupImageView(context) { // from class: org.telegram.ui.Cells.SharedDocumentCell.1
            public C33501(Context context2) {
                super(context2);
            }
        ...
        this.thumbImageView = c33501;
        c33501.setRoundRadius(AndroidUtilities.m1036dp(8.0f));
        View view2 = this.thumbImageView;
        if (i == 1) {
            boolean z5 = LocaleController.isRTL;
            addView(view2, LayoutHelper.createFrame(42, 42.0f, (z5 ? 5 : 3) | 48, z5 ? 0.0f : 16.0f, 12.0f, z5 ? 16.0f : 0.0f, 0.0f));
        } else {
            boolean z6 = LocaleController.isRTL;
            addView(view2, LayoutHelper.createFrame(40, 40.0f, (z6 ? 5 : 3) | 48, z6 ? 0.0f : 12.0f, 8.0f, z6 ? 12.0f : 0.0f, 0.0f));
        }
        ...
        if (i == 1) {
            ...
            addView(view3, LayoutHelper.createFrame(-1, -2.0f, (z7 ? 5 : 3) | 48, z7 ? 8.0f : 72.0f, 9.0f, z7 ? 72.0f : 8.0f, 0.0f));
        } else if (i == 2) {
            ...
            addView(view4, LayoutHelper.createFrame(-1, -2.0f, (z9 ? 5 : 3) | 48, z9 ? 8.0f : 72.0f, 30.0f, z9 ? 72.0f : 8.0f, 0.0f));
            this.captionTextView.setVisibility(8);
        } else {
            this.nameTextView.setMaxLines(1);
            View view5 = this.nameTextView;
            boolean z10 = LocaleController.isRTL;
            addView(view5, LayoutHelper.createFrame(-1, -2.0f, (z10 ? 5 : 3) | 48, z10 ? 8.0f : 72.0f, 5.0f, z10 ? 72.0f : 8.0f, 0.0f));
        }
        this.statusDrawable = new RLottieDrawable(C2797R.raw.download_arrow, "download_arrow", AndroidUtilities.m1036dp(14.0f), AndroidUtilities.m1036dp(14.0f), true, null);
        ...
        View view6 = this.statusImageView;
        if (i == 1) {
            boolean z11 = LocaleController.isRTL;
            addView(view6, LayoutHelper.createFrame(14, 14.0f, (z11 ? 5 : 3) | 48, z11 ? 8.0f : 70.0f, 37.0f, z11 ? 72.0f : 8.0f, 0.0f));
        } else {
            boolean z12 = LocaleController.isRTL;
            addView(view6, LayoutHelper.createFrame(14, 14.0f, (z12 ? 5 : 3) | 48, z12 ? 8.0f : 70.0f, 33.0f, z12 ? 72.0f : 8.0f, 0.0f));
        }
        ...
        AnimatedEmojiSpan.TextViewEmojis textViewEmojis2 = this.dateTextView;
        if (i == 1) {
            textViewEmojis2.setTextSize(1, 13.0f);
            View view7 = this.dateTextView;
            boolean z13 = LocaleController.isRTL;
            addView(view7, LayoutHelper.createFrame(-1, -2.0f, (z13 ? 5 : 3) | 48, z13 ? 8.0f : 72.0f, 34.0f, z13 ? 72.0f : 8.0f, 0.0f));
        } else {
            textViewEmojis2.setTextSize(1, 13.0f);
            View view8 = this.dateTextView;
            boolean z14 = LocaleController.isRTL;
            addView(view8, LayoutHelper.createFrame(-1, -2.0f, (z14 ? 5 : 3) | 48, z14 ? 8.0f : 72.0f, 30.0f, z14 ? 72.0f : 8.0f, 0.0f));
        }
        ...
        this.progressView.setHideAnimationBehavior(2);
        this.progressView.setProgressColor(getThemedColor(i4));
        View view9 = this.progressView;
        boolean z15 = LocaleController.isRTL;
        addView(view9, LayoutHelper.createFrame(-1, 2.0f, (z15 ? 5 : 3) | 80, z15 ? 0.0f : 72.0f, 0.0f, z15 ? 72.0f : 0.0f, 0.0f));
        ...
        View view10 = this.checkBox;
        if (i == 1) {
            boolean z16 = LocaleController.isRTL;
            addView(view10, LayoutHelper.createFrame(24, 24.0f, (z16 ? 5 : 3) | 48, z16 ? 0.0f : 38.0f, 36.0f, z16 ? 38.0f : 0.0f, 0.0f));
        } else {
            boolean z17 = LocaleController.isRTL;
            addView(view10, LayoutHelper.createFrame(24, 24.0f, (z17 ? 5 : 3) | 48, z17 ? 0.0f : 33.0f, 28.0f, z17 ? 33.0f : 0.0f, 0.0f));
        }
        if (i == 2) {
    ...
    public class C33501 extends BackupImageView {
        public C33501(Context context2) {
            super(context2);
        }
    ...
    public void setTextAndValueAndTypeAndThumb(String str, String str2, String str3, String str4, int i, boolean z) {
        ...
        if (str4 != null || i != 0) {
            if (str4 != null) {
                ...
                CombinedDrawable combinedDrawableCreateCircleDrawableWithIcon = UIUtil.createCircleDrawableWithIcon(getContext(), i, AndroidUtilities.m1036dp(42.0f));
                if (i == C2797R.drawable.files_storage) {
                    i2 = Theme.key_chat_attachLocationBackground;
                    i3 = Theme.key_chat_attachIcon;
                } else if (i == C2797R.drawable.files_gallery) {
                    i2 = Theme.key_chat_attachContactBackground;
                    i3 = Theme.key_chat_attachIcon;
                } else if (i == C2797R.drawable.files_music) {
                    i2 = Theme.key_chat_attachAudioBackground;
                    i3 = Theme.key_chat_attachIcon;
                } else if (i == C2797R.drawable.files_internal) {
    ...
    public void setDocument(MessageObject messageObject, boolean z) {
        ...
        if (document == null) {
            ...
            if (TextUtils.isEmpty(documentFileName) && (str = document.mime_type) != null) {
                documentFileName = str.startsWith(MediaStreamTrack.VIDEO_TRACK_KIND) ? MessageObject.isGifDocument(document) ? LocaleController.getString(C2797R.string.AttachGif) : LocaleController.getString(C2797R.string.AttachVideo) : document.mime_type.startsWith("image") ? MessageObject.isGifDocument(document) ? LocaleController.getString(C2797R.string.AttachGif) : LocaleController.getString(C2797R.string.AttachPhoto) : document.mime_type.startsWith(MediaStreamTrack.AUDIO_TRACK_KIND) ? LocaleController.getString(C2797R.string.AttachAudio) : LocaleController.getString(C2797R.string.AttachDocument);
            }
            if (str4 == null) {
            ...
            if ((closestPhotoSizeWithSize2 instanceof TLRPC.TL_photoSizeEmpty) || closestPhotoSizeWithSize2 == null) {
                ...
                if (bitmapDrawable != null) {
                    backupImageView.setImage(ImageLocation.getForDocument(closestPhotoSizeWithSize, document), "40_40", (ImageLocation) null, (String) null, messageObject.strippedThumb, (Bitmap) null, (String) null, 1, messageObject);
                } else {
                    backupImageView.setImage(ImageLocation.getForDocument(closestPhotoSizeWithSize, document), "40_40", ImageLocation.getForDocument(closestPhotoSizeWithSize2, document), "40_40_b", (String) null, 0L, 1, messageObject);
                }
            }
            updateDateView();
            if (messageObject.hasHighlightedWords() && !TextUtils.isEmpty(this.message.messageOwner.message)) {
                ...
                if (textView4 != null) {
                    textView4.setVisibility(charSequenceHighlightText2 != null ? 0 : 8);
                }
            } else {
    ...
    private void updateDateView() {
        ...
        this.dateTextView.setText(String.format("%s, %s", fileSize, LocaleController.formatString("formatDateAtTime", C2797R.string.formatDateAtTime, LocaleController.getInstance().getFormatterYear().format(new Date(j)), LocaleController.getInstance().getFormatterDay().format(new Date(j)))));
    }
        ...
        if (messageObject != null && messageObject.messageOwner.media != null) {
            ...
            if (messageObject.attachPathExists || messageObject.mediaExists || !this.drawDownloadIcon) {
                ...
                if (layoutParams != null) {
                    layoutParams.leftMargin = AndroidUtilities.m1036dp(LocaleController.isRTL ? 8.0f : 72.0f);
                    layoutParams.rightMargin = AndroidUtilities.m1036dp(LocaleController.isRTL ? 72.0f : 8.0f);
            ...
            if (layoutParams2 != null) {
                layoutParams2.leftMargin = AndroidUtilities.m1036dp(LocaleController.isRTL ? 8.0f : 86.0f);
                layoutParams2.rightMargin = AndroidUtilities.m1036dp(LocaleController.isRTL ? 86.0f : 8.0f);
                this.dateTextView.requestLayout();
            }
            if (this.loading) {
                LineProgressView lineProgressView2 = this.progressView;
                if (z) {
                    lineProgressView2.show();
                } else {
            ...
            LineProgressView lineProgressView3 = this.progressView;
            if (z) {
                lineProgressView3.hide();
                return;
            } else {
                lineProgressView3.setVisibility(4);
                return;
            }
        }
        this.loading = false;
        this.loaded = true;
        LineProgressView lineProgressView4 = this.progressView;
        if (z) {
            lineProgressView4.hide();
        } else {
            lineProgressView4.setVisibility(4);
        }
        this.progressView.setProgress(0.0f, false);
        this.statusImageView.setVisibility(4);
        FrameLayout.LayoutParams layoutParams3 = (FrameLayout.LayoutParams) this.dateTextView.getLayoutParams();
        if (layoutParams3 != null) {
            layoutParams3.leftMargin = AndroidUtilities.m1036dp(LocaleController.isRTL ? 8.0f : 72.0f);
            layoutParams3.rightMargin = AndroidUtilities.m1036dp(LocaleController.isRTL ? 72.0f : 8.0f);
            this.dateTextView.requestLayout();
        }
        DownloadController.getInstance(this.currentAccount).removeLoadingFileObserver(this);
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(56.0f), TLObject.FLAG_30));
        int iM1036dp = AndroidUtilities.m1036dp(34.0f) + this.nameTextView.getMeasuredHeight() + (this.needDivider ? 1 : 0);
        if (this.caption != null && this.captionTextView != null && this.message.hasHighlightedWords()) {
            ...
            iM1036dp += this.captionTextView.getMeasuredHeight() + AndroidUtilities.m1036dp(3.0f);
        }
        setMeasuredDimension(getMeasuredWidth(), iM1036dp);
    }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.viewType != 1) {
            if (this.nameTextView.getLineCount() > 1 || ((textView = this.captionTextView) != null && textView.getVisibility() == 0)) {
                int measuredHeight = this.nameTextView.getMeasuredHeight() - AndroidUtilities.m1036dp(22.0f);
                ...
                if (textView2 != null && textView2.getVisibility() == 0) {
                    ...
                    measuredHeight += this.captionTextView.getMeasuredHeight() + AndroidUtilities.m1036dp(3.0f);
                }
                ...
                LineProgressView lineProgressView = this.progressView;
                lineProgressView.layout(lineProgressView.getLeft(), getMeasuredHeight() - this.progressView.getMeasuredHeight(), this.progressView.getRight(), getMeasuredHeight());
            }
        }
    }
    ...
    */
    public void dispatchDraw(android.graphics.Canvas r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Cells.SharedDocumentCell.dispatchDraw(android.graphics.Canvas):void");
    }
    ...
    public void setPhoto(String str) {
        if (str.endsWith("mp4")) {
            this.thumbImageView.setImage("vthumb://0:".concat(str), null, null);
            this.thumbImageView.setVisibility(0);
        } else if (str.endsWith(".jpg") || str.endsWith(".jpeg") || str.endsWith(".png") || str.endsWith(".gif")) {
            this.thumbImageView.setImage("thumb://0:".concat(str), null, null);
            this.thumbImageView.setVisibility(0);
        } else {
