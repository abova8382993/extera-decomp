...
public class NotificationsCheckCell extends FrameLayout {
    ...
    public NotificationsCheckCell(Context context, int i, int i2, int i3, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.valueTextView.setTextSize(AndroidUtilities.m1036dp(13.0f));
        ...
        Switch r3 = new Switch(context, resourcesProvider) { // from class: org.telegram.ui.Cells.NotificationsCheckCell.1
            @Override // org.telegram.p035ui.Components.Switch
            public int processColor(int i9) {
    ...
    public void onMeasure(int i, int i2) {
        if (this.isMultiline) {
            ...
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(this.currentHeight), TLObject.FLAG_30));
        }
    }
    ...
    public void setMultiline(boolean z) {
        ...
        if (z) {
            ...
            this.multilineValueTextView.setPadding(0, 0, 0, AndroidUtilities.m1036dp(8.0f));
        } else {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.needDivider) {
            if (LocaleController.isRTL) {
                ...
                fM1036dp = AndroidUtilities.m1036dp(this.imageView != null ? this.textOffset - AndroidUtilities.m1036dp(2.0f) : 20.0f);
            }
            float f = fM1036dp;
            float measuredHeight = getMeasuredHeight() - 1;
            int measuredWidth = getMeasuredWidth();
            if (LocaleController.isRTL) {
                iM1036dp = AndroidUtilities.m1036dp(this.imageView != null ? this.textOffset - AndroidUtilities.m1036dp(2.0f) : 20.0f);
            } else {
                iM1036dp = 0;
            }
        ...
        if (this.drawLine) {
            int iM1036dp2 = LocaleController.isRTL ? AndroidUtilities.m1036dp(76.0f) : (getMeasuredWidth() - AndroidUtilities.m1036dp(76.0f)) - 1;
            canvas.drawRect(iM1036dp2, (getMeasuredHeight() - AndroidUtilities.m1036dp(22.0f)) / 2, iM1036dp2 + 2, r0 + AndroidUtilities.m1036dp(22.0f), Theme.dividerPaint);
        }
    }
