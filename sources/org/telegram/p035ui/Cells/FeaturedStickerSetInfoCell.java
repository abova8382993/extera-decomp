...
import org.telegram.p035ui.Components.ColorSpanUnderline;
...
public class FeaturedStickerSetInfoCell extends FrameLayout {
    ...
    public FeaturedStickerSetInfoCell(Context context, int i, boolean z, boolean z2, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (z2) {
            ...
            this.delButton.setText(LocaleController.getString(C2797R.string.StickersRemove));
            if (z) {
    ...
    public void setStickerSet(TLRPC.StickerSetCovered stickerSetCovered, boolean z, boolean z2, int i, int i2, boolean z3) {
        ...
        if (this.canAddRemove) {
            ...
            if (z5) {
                ...
                boolean z6 = z3 || MediaDataController.getInstance(this.currentAccount).isStickerPackInstalled(stickerSetCovered.set.f1280id);
                this.isInstalled = z6;
                if (!z2) {
                    if (z6) {
                ...
                this.animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Cells.FeaturedStickerSetInfoCell.1
                    ...
                    public void onAnimationEnd(Animator animator) {
                        boolean z7 = FeaturedStickerSetInfoCell.this.isInstalled;
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Cells.FeaturedStickerSetInfoCell$1 */
    public class C33091 extends AnimatorListenerAdapter {
        public C33091() {
        }
    ...
    */
    public void onDraw(android.graphics.Canvas r8) {
        ...
        L3b:
            ...
            int r1 = org.telegram.p035ui.ActionBar.Theme.key_featuredStickers_unread
        ...
        L6a:
            ...
            org.telegram.ui.ActionBar.Theme$ResourcesProvider r7 = r7.resourcesProvider
            android.graphics.Paint r6 = org.telegram.p035ui.ActionBar.Theme.getThemePaint(r0, r7)
            r2 = 0
            r3 = 0
            r5 = 0
            r1 = r8
        ...
        L82:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Cells.FeaturedStickerSetInfoCell.onDraw(android.graphics.Canvas):void");
    }
