...
public class GraySectionCell extends FrameLayout implements Theme.Colorable {
    ...
    public GraySectionCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        C33101 c33101 = new AnimatedTextView(getContext(), true, true, true) { // from class: org.telegram.ui.Cells.GraySectionCell.1
            public C33101(Context context2, boolean z, boolean z2, boolean z3) {
        ...
        this.rightTextView = c33101;
        c33101.setPadding(AndroidUtilities.m1036dp(2.0f), 0, AndroidUtilities.m1036dp(2.0f), 0);
        this.rightTextView.setAnimationProperties(0.9f, 0L, 420L, CubicBezierInterpolator.EASE_OUT_QUINT);
        this.rightTextView.setTextSize(AndroidUtilities.m1036dp(14.0f));
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Cells.GraySectionCell$1 */
    public class C33101 extends AnimatedTextView {
        public C33101(Context context2, boolean z, boolean z2, boolean z3) {
            super(context2, z, z2, z3);
        }
    ...
    public void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(this.layerHeight), TLObject.FLAG_30));
    }
    ...
    public void setRightTextMargin(int i) {
        float f = i;
        this.rightTextViewLayoutParams.leftMargin = AndroidUtilities.m1036dp(f);
        this.rightTextViewLayoutParams.rightMargin = AndroidUtilities.m1036dp(f);
