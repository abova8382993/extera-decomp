...
public class AudioPlayerCell extends FrameLayout implements DownloadController.FileDownloadProgressListener {
    ...
    public static /* synthetic */ void m7915$r8$lambda$rQ9o2aGm7Anfro19pIupw3wso(View view) {
    }
    ...
    public AudioPlayerCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Cells.AudioPlayerCell$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                AudioPlayerCell.m7915$r8$lambda$rQ9o2aGm7Anfro19pIupw3wso(view);
            }
        });
    ...
    public void onMeasure(int i, int i2) {
        ...
        int size = (View.MeasureSpec.getSize(i) - AndroidUtilities.m1036dp(AndroidUtilities.leftBaseline)) - AndroidUtilities.m1036dp(48.0f);
        try {
            ...
            StaticLayout staticLayout = new StaticLayout(charSequenceHighlightText == null ? charSequenceEllipsize : charSequenceHighlightText, Theme.chat_contextResult_titleTextPaint, size + AndroidUtilities.m1036dp(4.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        ...
        try {
            ...
            StaticLayout staticLayout2 = new StaticLayout(charSequenceHighlightText2 == null ? charSequenceEllipsize2 : charSequenceHighlightText2, Theme.chat_contextResult_descriptionTextPaint, size + AndroidUtilities.m1036dp(4.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        ...
        int iM1036dp = AndroidUtilities.m1036dp(4.0f) + size2;
        this.buttonX = iM1036dp;
        int iM1036dp2 = AndroidUtilities.m1036dp(6.0f);
        this.buttonY = iM1036dp2;
        radialProgress2.setProgressRect(iM1036dp, iM1036dp2, size2 + AndroidUtilities.m1036dp(48.0f), AndroidUtilities.m1036dp(50.0f));
    }
    ...
    public void setMessageObject(MessageObject messageObject, boolean z, View.OnClickListener onClickListener, boolean z2, View.OnTouchListener onTouchListener) {
        ...
        this.needDivider = z2;
        this.optionsButton.setImageResource(z ? C2797R.drawable.list_reorder : C2797R.drawable.ic_ab_other);
    ...
    */
    private boolean checkAudioMotionEvent(android.view.MotionEvent r9) {
        ...
        L77:
            org.telegram.ui.Components.RadialProgress2 r9 = r8.radialProgress
            boolean r8 = r8.miniButtonPressed
            r9.setPressed(r8, r4)
        L7e:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Cells.AudioPlayerCell.checkAudioMotionEvent(android.view.MotionEvent):boolean");
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.titleLayout != null) {
            canvas.save();
            canvas.translate(AndroidUtilities.m1036dp(LocaleController.isRTL ? 16.0f : AndroidUtilities.leftBaseline) + ((LocaleController.isRTL && this.optionsButton.getVisibility() == 0) ? AndroidUtilities.m1036dp(32.0f) : 0), this.titleY);
        ...
        if (this.descriptionLayout != null) {
            ...
            canvas.save();
            int iM1036dp2 = AndroidUtilities.m1036dp(LocaleController.isRTL ? 16.0f : AndroidUtilities.leftBaseline);
            if (LocaleController.isRTL && this.optionsButton.getVisibility() == 0) {
                iM1036dp = AndroidUtilities.m1036dp(32.0f);
            }
            canvas.translate(iM1036dp2 + iM1036dp, this.descriptionY);
        ...
        if (LocaleController.isRTL) {
            canvas.drawRect(0.0f, getHeight() - 1, getWidth() - AndroidUtilities.m1036dp(AndroidUtilities.leftBaseline), getHeight(), themePaint);
        } else {
            canvas.drawRect(AndroidUtilities.m1036dp(AndroidUtilities.leftBaseline), getHeight() - 1, getWidth(), getHeight(), themePaint);
        }
    }
    ...
    public void updateButtonState(boolean z, boolean z2) {
        ...
        DownloadController.getInstance(i3).addLoadingFileObserver(fileName, this);
        if (!FileLoader.getInstance(this.currentAccount).isLoadingFile(fileName)) {
            this.buttonState = 2;
            this.radialProgress.setIcon(getIconForCurrentState(), z, z2);
        } else {
