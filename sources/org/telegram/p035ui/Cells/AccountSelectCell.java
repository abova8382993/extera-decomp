...
public class AccountSelectCell extends FrameLayout {
    ...
    public AccountSelectCell(Context context, boolean z) {
        ...
        if (z) {
            ...
            this.infoTextView.setMaxWidth(AndroidUtilities.m1036dp(320.0f));
        ...
        imageView.setImageResource(C2797R.drawable.account_check);
    ...
    private int width() {
        float fM1036dp = AndroidUtilities.m1036dp(196.0f);
        float fM1036dp2 = AndroidUtilities.m1036dp((this.checkImageView != null ? 50 : 0) + 69);
        float fMeasureText = this.textView.getTextPaint().measureText(this.textView.getText().toString());
        TextView textView = this.infoTextView;
        return (int) Math.max(fM1036dp, fM1036dp2 + Math.max(fMeasureText, textView != null ? textView.getPaint().measureText(this.infoTextView.getText().toString()) : 0.0f));
    }
    ...
    public void onMeasure(int i, int i2) {
        if (this.checkImageView != null || (this.infoTextView != null && getLayoutParams().width != -2)) {
            ...
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(width(), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(56.0f), TLObject.FLAG_30));
        } else {
