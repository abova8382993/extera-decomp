...
import org.telegram.p035ui.Components.CornerPath;
...
public abstract class TextSelectionHelper<Cell extends SelectableView> {
        ...
        public void run() {
            ...
            if (TextSelectionHelper.this.scrolling) {
                ...
                if (textSelectionHelper.multiselect && textSelectionHelper.selectedView == null) {
                    lineHeight = AndroidUtilities.m1036dp(8.0f);
                ...
                if (!textSelectionHelper2.multiselect && !textSelectionHelper2.allowScrollPrentRelative) {
                    boolean z = textSelectionHelper2.scrollDown;
                    TextSelectionHelper textSelectionHelper3 = TextSelectionHelper.this;
                    if (z) {
                        if (textSelectionHelper3.selectedView.getBottom() - lineHeight < TextSelectionHelper.this.parentView.getMeasuredHeight() - TextSelectionHelper.this.getParentBottomPadding()) {
                    ...
                    } else if (textSelectionHelper3.selectedView.getTop() + lineHeight > TextSelectionHelper.this.getParentTopPadding()) {
                ...
                if (recyclerListView != null) {
                    recyclerListView.scrollBy(0, textSelectionHelper4.scrollDown ? lineHeight : -lineHeight);
                }
    ...
    final Runnable startSelectionRunnable = new Runnable() { // from class: org.telegram.ui.Cells.TextSelectionHelper.2
        ...
        public void run() {
            ...
            TextSelectionHelper textSelectionHelper3 = TextSelectionHelper.this;
            int charOffsetFromCord = textSelectionHelper3.getCharOffsetFromCord(i, i2, textSelectionHelper3.maybeTextX, textSelectionHelper3.maybeTextY, cell, true);
            if (charOffsetFromCord >= text.length()) {
                ...
                if (f < textSelectionHelper6.layoutBlock.layout.getLineRight(lineCount) + AndroidUtilities.m1036dp(4.0f) && f > TextSelectionHelper.this.layoutBlock.layout.getLineLeft(lineCount)) {
    ...
    protected final Runnable showActionsRunnable = new Runnable() { // from class: org.telegram.ui.Cells.TextSelectionHelper$$ExternalSyntheticLambda2
        @Override // java.lang.Runnable
    ...
    private final Runnable hideActionsRunnable = new Runnable() { // from class: org.telegram.ui.Cells.TextSelectionHelper.3
        ...
        public void run() {
            if (TextSelectionHelper.this.actionMode != null) {
                ...
                textSelectionHelper.actionMode.hide(LongCompanionObject.MAX_VALUE);
    ...
    public TextSelectionHelper() {
        ...
        this.cornerRadius = fM1036dp;
        paint.setPathEffect(new CornerPathEffect(fM1036dp));
    ...
    public void setOnAiGenerate(OnAiGenerateListener onAiGenerateListener) {
        this.onAiGenerateListener = onAiGenerateListener;
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        TextSelectionHelper<Cell> textSelectionHelper;
        int action = motionEvent.getAction();
        if (action == 0) {
            this.capturedX = (int) motionEvent.getX();
            this.capturedY = (int) motionEvent.getY();
            this.tryCapture = false;
            this.textArea.inset(-AndroidUtilities.m1036dp(8.0f), -AndroidUtilities.m1036dp(8.0f));
            if (!this.textArea.contains(this.capturedX, this.capturedY) || this.maybeSelectedView == null) {
                ...
                if (charOffsetFromCord >= text.length()) {
                    ...
                    if (f < textSelectionHelper.layoutBlock.layout.getLineRight(lineCount) + AndroidUtilities.m1036dp(4.0f) && f > textSelectionHelper.layoutBlock.layout.getLineLeft(lineCount)) {
                        charOffsetFromCord = text.length() - 1;
                    }
                }
                if (charOffsetFromCord >= 0 && charOffsetFromCord < text.length() && text.charAt(charOffsetFromCord) != '\n') {
        ...
        AndroidUtilities.cancelRunOnUIThread(this.startSelectionRunnable);
        if (this.tryCapture && isInSelectionMode()) {
    ...
    public void showMagnifier(int i) {
        ...
        int lineTop = (int) (((((layout.getLineTop(lineForOffset) + this.textY) + coordsInParent[1]) - lineBottom) - AndroidUtilities.m1036dp(8.0f)) + this.layoutBlock.yOffset);
        ...
        if (this.magnifier == null) {
            TextSelectionHelper$$ExternalSyntheticApiModelOutline1.m1136m();
            this.magnifier = TextSelectionHelper$$ExternalSyntheticApiModelOutline0.m1135m(this.textSelectionOverlay);
        ...
        this.magnifier.show(this.magnifierXanimated, this.magnifierYanimated + (lineBottom * 1.5f) + AndroidUtilities.m1036dp(8.0f));
    ...
    public class ActionModeCallbackC33814 implements ActionMode.Callback {
        ...
        public ActionModeCallbackC33814() {
        }

        @Override // android.view.ActionMode.Callback
        public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            menu.add(0, R.id.copy, 0, R.string.copy);
            menu.add(0, C2797R.id.menu_quote, 1, LocaleController.getString(C2797R.string.Quote));
            menu.add(0, R.id.selectAll, 2, R.string.selectAll);
            menu.add(0, 3, 3, LocaleController.getString(C2797R.string.TranslateMessage));
            menu.add(0, 4, 4, LocaleController.getString(C2797R.string.Generate));
            return true;
        }
        ...
        public /* synthetic */ void lambda$onPrepareActionMode$1(Menu menu, Exception exc) {
            FileLog.m1046e("mlkit: failed to detect language in selection");
            FileLog.m1048e(exc);
            this.translateFromLanguage = null;
            updateTranslateButton(menu);
        }
        ...
        private void updateTranslateButton(Menu menu) {
            String str;
            menu.getItem(3).setVisible((TextSelectionHelper.this.onTranslateListener == null || (((str = this.translateFromLanguage) == null || TranslatorUtils.isRestrictedLanguage(str)) && LanguageDetector.hasSupport())) ? false : true);
            menu.getItem(4).setVisible(TextSelectionHelper.this.onAiGenerateListener != null);
        }
        ...
        public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
            ...
            if (itemId == 3) {
                if (TextSelectionHelper.this.onTranslateListener != null) {
                    TextSelectionHelper.this.onTranslateListener.run(TextSelectionHelper.this.getSelectedText(), this.translateFromLanguage, TranslateAlert2.getToLanguage(), new Runnable() { // from class: org.telegram.ui.Cells.TextSelectionHelper$4$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
            ...
            if (itemId == C2797R.id.menu_quote) {
            ...
            TextSelectionHelper textSelectionHelper3 = TextSelectionHelper.this;
            if (itemId == 4) {
                if (textSelectionHelper3.onAiGenerateListener != null) {
                    TextSelectionHelper.this.onAiGenerateListener.run(TextSelectionHelper.this.getSelectedText());
                }
                TextSelectionHelper.this.hideActions();
                return true;
            }
            textSelectionHelper3.clear();
            return true;
        }
    ...
    private ActionMode.Callback createActionCallback() {
        final ActionModeCallbackC33814 actionModeCallbackC33814 = new ActionModeCallbackC33814();
        return new ActionMode.Callback2() { // from class: org.telegram.ui.Cells.TextSelectionHelper.5
            @Override // android.view.ActionMode.Callback
            public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
                return actionModeCallbackC33814.onCreateActionMode(actionMode, menu);
            }

            @Override // android.view.ActionMode.Callback
            public boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
                return actionModeCallbackC33814.onPrepareActionMode(actionMode, menu);
            }

            @Override // android.view.ActionMode.Callback
            public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
                return actionModeCallbackC33814.onActionItemClicked(actionMode, menuItem);
            }

            @Override // android.view.ActionMode.Callback
            public void onDestroyActionMode(ActionMode actionMode) {
                actionModeCallbackC33814.onDestroyActionMode(actionMode);
            }
            ...
            public void onGetContentRect(ActionMode actionMode, View view, Rect rect) {
                ...
                if (TextSelectionHelper.this.isInSelectionMode()) {
                    ...
                    if (textSelectionHelper.selectedView != null) {
                        ...
                        int iM1036dp = (((iArrOffsetToCord[1] + textSelectionHelper3.textY) + coordsInParent[1]) + (i3 / 2)) - AndroidUtilities.m1036dp(4.0f);
                        if (iM1036dp >= 1) {
                            i2 = iM1036dp;
                        }
                    } else {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void drawSelection(android.graphics.Canvas r24, android.text.Layout r25, int r26, int r27, boolean r28, boolean r29, float r30) {
        /*
            Method dump skipped, instruction units count: 556
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Cells.TextSelectionHelper.drawSelection(android.graphics.Canvas, android.text.Layout, int, int, boolean, boolean, float):void");
    }
    ...
    private void drawLine(Layout layout, int i, int i2, int i3, boolean z, boolean z2, float f) {
        ...
        int i4 = 0;
        while (true) {
            int i5 = this.tempPath2.rectsCount;
            scalablePath = this.tempPath2;
            if (i4 >= i5) {
                break;
            }
            RectF rectF = (RectF) scalablePath.rects.get(i4);
        ...
        if (scalablePath.rectsCount != 0 || z2) {
            return;
        }
        try {
    ...
    public static class ChatListTextSelectionHelper extends TextSelectionHelper<ChatMessageCell> {
        ...
        */
        public int getLineHeight() {
            /*
                r4 = this;
                Cell extends org.telegram.ui.Cells.TextSelectionHelper$SelectableView r0 = r4.selectedView
                r1 = 0
                if (r0 == 0) goto L89
                org.telegram.ui.Cells.ChatMessageCell r0 = (org.telegram.p035ui.Cells.ChatMessageCell) r0
                org.telegram.messenger.MessageObject r0 = r0.getMessageObject()
                if (r0 == 0) goto L89
                Cell extends org.telegram.ui.Cells.TextSelectionHelper$SelectableView r0 = r4.selectedView
                org.telegram.ui.Cells.ChatMessageCell r0 = (org.telegram.p035ui.Cells.ChatMessageCell) r0
                org.telegram.messenger.MessageObject r0 = r0.getMessageObject()
                boolean r2 = r4.isDescription
                if (r2 == 0) goto L22
                Cell extends org.telegram.ui.Cells.TextSelectionHelper$SelectableView r4 = r4.selectedView
                org.telegram.ui.Cells.ChatMessageCell r4 = (org.telegram.p035ui.Cells.ChatMessageCell) r4
                android.text.StaticLayout r4 = r4.getDescriptionlayout()
                goto L7c
            L22:
                boolean r2 = r4.isFactCheck
                if (r2 == 0) goto L2f
                Cell extends org.telegram.ui.Cells.TextSelectionHelper$SelectableView r4 = r4.selectedView
                org.telegram.ui.Cells.ChatMessageCell r4 = (org.telegram.p035ui.Cells.ChatMessageCell) r4
                android.text.StaticLayout r4 = r4.getFactCheckLayout()
                goto L7c
            L2f:
                boolean r2 = r4.isRich
                r3 = 0
                if (r2 == 0) goto L51
                if (r0 == 0) goto L39
                org.telegram.messenger.RichMessageLayout r4 = r0.richLayout
                goto L3a
            L39:
                r4 = r3
            L3a:
                if (r4 == 0) goto L7b
                java.util.ArrayList<org.telegram.ui.Cells.TextSelectionHelper$TextLayoutBlock> r0 = r4.textBlocks
                boolean r0 = r0.isEmpty()
                if (r0 != 0) goto L7b
                java.util.ArrayList<org.telegram.ui.Cells.TextSelectionHelper$TextLayoutBlock> r4 = r4.textBlocks
                java.lang.Object r4 = r4.get(r1)
                org.telegram.ui.Cells.TextSelectionHelper$TextLayoutBlock r4 = (org.telegram.ui.Cells.TextSelectionHelper.TextLayoutBlock) r4
                android.text.Layout r4 = r4.getLayout()
                goto L7c
            L51:
                Cell extends org.telegram.ui.Cells.TextSelectionHelper$SelectableView r2 = r4.selectedView
                org.telegram.ui.Cells.ChatMessageCell r2 = (org.telegram.p035ui.Cells.ChatMessageCell) r2
                boolean r2 = r2.hasCaptionLayout()
                if (r2 == 0) goto L6e
                Cell extends org.telegram.ui.Cells.TextSelectionHelper$SelectableView r4 = r4.selectedView
                org.telegram.ui.Cells.ChatMessageCell r4 = (org.telegram.p035ui.Cells.ChatMessageCell) r4
                org.telegram.messenger.MessageObject$TextLayoutBlocks r4 = r4.getCaptionLayout()
                java.util.ArrayList<org.telegram.messenger.MessageObject$TextLayoutBlock> r4 = r4.textLayoutBlocks
                java.lang.Object r4 = r4.get(r1)
                org.telegram.messenger.MessageObject$TextLayoutBlock r4 = (org.telegram.messenger.MessageObject.TextLayoutBlock) r4
                android.text.StaticLayout r4 = r4.textLayout
                goto L7c
            L6e:
                java.util.ArrayList<org.telegram.messenger.MessageObject$TextLayoutBlock> r4 = r0.textLayoutBlocks
                if (r4 == 0) goto L7b
                java.lang.Object r4 = r4.get(r1)
                org.telegram.messenger.MessageObject$TextLayoutBlock r4 = (org.telegram.messenger.MessageObject.TextLayoutBlock) r4
                android.text.StaticLayout r4 = r4.textLayout
            ...
            L7c:
                ...
                return r1
            L7f:
                int r0 = r4.getLineBottom(r1)
                int r4 = r4.getLineTop(r1)
                int r0 = r0 - r4
                return r0
            L89:
                return r1
        ...
        public CharSequence getText(ChatMessageCell chatMessageCell, boolean z) {
            ...
            if (!z ? this.isRich : this.maybeIsRich) {
                ...
                return richMessageLayout != null ? richMessageLayout.joinedText : _UrlKt.FRAGMENT_ENCODE_SET;
            }
        ...
        public void draw(MessageObject messageObject, MessageObject.TextLayoutBlock textLayoutBlock, Canvas canvas) {
            ...
            Cell cell = this.selectedView;
            if (cell == null || ((ChatMessageCell) cell).getMessageObject() == null || this.isDescription || this.isFactCheck || this.isRich || (messageObject2 = ((ChatMessageCell) this.selectedView).getMessageObject()) == null || messageObject2.textLayoutBlocks == null || messageObject.getId() != this.selectedCellId) {
                return;
            }
            ...
            if (iClamp != iClamp2) {
                boolean zIsOutOwner = messageObject2.isOutOwner();
                Paint paint = this.selectionPaint;
                if (zIsOutOwner) {
                ...
                if (textLayoutBlock.quote) {
                    iM1036dp = AndroidUtilities.m1036dp(10.0f);
                } else if (textLayoutBlock.code) {
                    iM1036dp = AndroidUtilities.m1036dp(0.0f);
                }
                drawSelection(canvas, textLayoutBlock.textLayout, iClamp, iClamp2, true, true, iM1036dp);
            }
        }

        public void drawCaption(MessageObject messageObject, MessageObject.TextLayoutBlock textLayoutBlock, Canvas canvas) {
            Cell cell;
            if (messageObject == null || this.isDescription || this.isFactCheck || this.isRich || (cell = this.selectedView) == null || ((ChatMessageCell) cell).getMessageObject() == null || ((ChatMessageCell) this.selectedView).getMessageObject().getId() != messageObject.getId()) {
                return;
            }
            int i = this.selectionStart;
            int i2 = textLayoutBlock.charactersOffset;
        ...
        public int getCharOffsetFromCord(int i, int i2, int i3, int i4, ChatMessageCell chatMessageCell, boolean z) {
            ...
            if (lineBottom > factCheckLayout.getLineBottom(factCheckLayout.getLineCount() - 1) + y) {
                lineBottom = (int) ((y + factCheckLayout.getLineBottom(factCheckLayout.getLineCount() - 1)) - 1.0f);
            }
            fillLayoutForCoords(i7, lineBottom, chatMessageCell, this.layoutBlock, z);
            LayoutBlock layoutBlock = this.layoutBlock;
            Layout layout2 = layoutBlock.layout;
            if (layout2 == null) {
                return -1;
            }
            int i8 = (int) (i7 - layoutBlock.xOffset);
            while (true) {
            ...
            if (i6 >= 0) {
                return this.layoutBlock.charOffset + layout2.getOffsetForHorizontal(i6, i8);
            }
            return -1;
        }
        ...
        private void fillLayoutForCoords(int i, int i2, ChatMessageCell chatMessageCell, LayoutBlock layoutBlock, boolean z) {
            ...
            if (!z ? this.isRich : this.maybeIsRich) {
                ...
                int i6 = 0;
                while (true) {
                    if (i6 >= richMessageLayout.textBlocks.size()) {
                        break;
                    }
                    TextLayoutBlock textLayoutBlock = richMessageLayout.textBlocks.get(i6);
                    ...
                    if (i2 >= y && i2 < height) {
                        ...
                        int iMin = Math.min(Math.abs(i - x), Math.abs(i - width));
                        if (iMin < i5) {
                            i4 = i6;
                            i5 = iMin;
                        }
                ...
                layoutBlock.yOffset = r7.getY();
                layoutBlock.xOffset = r7.getX();
            ...
            if (chatMessageCell.hasCaptionLayout()) {
                ...
                for (int i8 = 0; i8 < captionLayout.textLayoutBlocks.size(); i8++) {
                    ...
                    if (f >= textLayoutBlock3.textYOffset(captionLayout.textLayoutBlocks) && f <= textLayoutBlock3.textYOffset(captionLayout.textLayoutBlocks) + textLayoutBlock3.padTop + textLayoutBlock3.height(chatMessageCell.transitionParams)) {
                        ...
                        float f2 = -(textLayoutBlock3.isRtl() ? ((int) Math.ceil(captionLayout.textXOffset)) - (textLayoutBlock3.quote ? AndroidUtilities.m1036dp(10.0f) : 0) : 0);
                        layoutBlock.xOffset = f2;
                        if (textLayoutBlock3.code && !textLayoutBlock3.quote) {
                            layoutBlock.xOffset = f2 + AndroidUtilities.m1036dp(8.0f);
                        }
            ...
            for (int i9 = 0; i9 < messageObject.textLayoutBlocks.size(); i9++) {
                ...
                if (f3 >= textLayoutBlock4.textYOffset(messageObject.textLayoutBlocks) && f3 <= textLayoutBlock4.textYOffset(messageObject.textLayoutBlocks) + textLayoutBlock4.padTop + textLayoutBlock4.height(chatMessageCell.transitionParams)) {
                    ...
                    if (textLayoutBlock4.quote) {
                        ...
                        iM1036dp = textLayoutBlock4.code ? AndroidUtilities.m1036dp(0.0f) : 0;
                    }
                    float f4 = -(textLayoutBlock4.isRtl() ? ((int) Math.ceil(messageObject.textXOffset)) - iM1036dp : 0);
                    layoutBlock.xOffset = f4;
                    if (textLayoutBlock4.code && !textLayoutBlock4.quote) {
                        layoutBlock.xOffset = f4 + AndroidUtilities.m1036dp(8.0f);
                    }
        ...
        public void fillLayoutForOffset(int i, LayoutBlock layoutBlock, boolean z) {
            ...
            if (this.isRich) {
                ...
                layoutBlock.yOffset = r8.getY();
                layoutBlock.xOffset = r8.getX();
            ...
            if (chatMessageCell.hasCaptionLayout()) {
                ...
                if (captionLayout.textLayoutBlocks.size() == 1) {
                    ...
                    layoutBlock.yOffset = r8.padTop;
                    MessageObject.TextLayoutBlock textLayoutBlock = captionLayout.textLayoutBlocks.get(0);
                    float f = -(textLayoutBlock.isRtl() ? ((int) Math.ceil(captionLayout.textXOffset)) - (textLayoutBlock.quote ? AndroidUtilities.m1036dp(10.0f) : 0) : 0);
                    layoutBlock.xOffset = f;
                    if (textLayoutBlock.code && !textLayoutBlock.quote) {
                        layoutBlock.xOffset = f + AndroidUtilities.m1036dp(8.0f);
                    }
                    layoutBlock.charOffset = 0;
                    return;
                }
                for (int i2 = 0; i2 < captionLayout.textLayoutBlocks.size(); i2++) {
                    ...
                    if (i3 >= 0 && i3 <= textLayoutBlock2.textLayout.getText().length()) {
                        ...
                        float f2 = -(textLayoutBlock2.isRtl() ? ((int) Math.ceil(captionLayout.textXOffset)) - (textLayoutBlock2.quote ? AndroidUtilities.m1036dp(10.0f) : 0) : 0);
                        layoutBlock.xOffset = f2;
            ...
            if (arrayList.size() == 1) {
                ...
                layoutBlock.yOffset = r7.padTop;
                MessageObject.TextLayoutBlock textLayoutBlock3 = messageObject.textLayoutBlocks.get(0);
                float f3 = -(textLayoutBlock3.isRtl() ? ((int) Math.ceil(messageObject.textXOffset)) - (textLayoutBlock3.quote ? AndroidUtilities.m1036dp(10.0f) : 0) : 0);
                layoutBlock.xOffset = f3;
                if (textLayoutBlock3.code && !textLayoutBlock3.quote) {
                    layoutBlock.xOffset = f3 + AndroidUtilities.m1036dp(8.0f);
                }
                layoutBlock.charOffset = 0;
                return;
            }
            for (int i4 = 0; i4 < messageObject.textLayoutBlocks.size(); i4++) {
                ...
                if (i5 >= 0 && i5 <= textLayoutBlock4.textLayout.getText().length()) {
                    layoutBlock.layout = textLayoutBlock4.textLayout;
                    layoutBlock.yOffset = textLayoutBlock4.textYOffset(messageObject.textLayoutBlocks) + textLayoutBlock4.padTop;
                    float f4 = -(textLayoutBlock4.isRtl() ? ((int) Math.ceil(messageObject.textXOffset)) - (textLayoutBlock4.quote ? AndroidUtilities.m1036dp(10.0f) : 0) : 0);
                    layoutBlock.xOffset = f4;
                    if (textLayoutBlock4.code && !textLayoutBlock4.quote) {
                        layoutBlock.xOffset = f4 + AndroidUtilities.m1036dp(8.0f);
                    }
        ...
        public void onExitSelectionMode(boolean z) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Cells.TextSelectionHelper$ChatListTextSelectionHelper$$ExternalSyntheticLambda0
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    TextSelectionHelper.ChatListTextSelectionHelper.m8377$r8$lambda$Gcwvj2Ry5WM_FcJtCCC93mDpYk(chatMessageCell, id, valueAnimator);
                }
            });
        ...
        /* JADX INFO: renamed from: $r8$lambda$Gcwvj2Ry5WM_FcJtCCC-93mDpYk, reason: not valid java name */
        public static /* synthetic */ void m8377$r8$lambda$Gcwvj2Ry5WM_FcJtCCC93mDpYk(ChatMessageCell chatMessageCell, int i, ValueAnimator valueAnimator) {
        ...
        public void cancelAllAnimators() {
            int i = 0;
            while (true) {
                int size = this.animatorSparseArray.size();
        ...
        /*
            ...
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        public void drawRich(org.telegram.messenger.MessageObject r11, org.telegram.messenger.RichMessageLayout r12, android.graphics.Canvas r13) {
            /*
                Method dump skipped, instruction units count: 201
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Cells.TextSelectionHelper.ChatListTextSelectionHelper.drawRich(org.telegram.messenger.MessageObject, org.telegram.messenger.RichMessageLayout, android.graphics.Canvas):void");
        }
    ...
    public static class ArticleTextSelectionHelper extends TextSelectionHelper<ArticleSelectableView> {
        ...
        public int getCharOffsetFromCord(int i, int i2, int i3, int i4, ArticleSelectableView articleSelectableView, boolean z) {
            ...
            Layout layout = this.arrayList.get(i5).getLayout();
            if (width < 0) {
                width = 1;
            }
            if (lineBottom < 0) {
        ...
        public int getLineHeight() {
            ...
            Layout layout = this.arrayList.get(i).getLayout();
        ...
        public void trySelect(View view) {
            if (this.maybeSelectedView == null || this.capturedX < 0 || this.capturedY < 0) {
                return;
            }
        ...
        private int findClosestLayoutIndex(int i, int i2, ArticleSelectableView articleSelectableView) {
            ...
            if (row > 0 && i3 < AndroidUtilities.m1036dp(24.0f)) {
        ...
        public void draw(Canvas canvas, ArticleSelectableView articleSelectableView, int i) {
            ...
            this.arrayList.clear();
            articleSelectableView.fillTextLayoutBlocks(this.arrayList);
            if (i < 0 || i >= this.arrayList.size() || (textLayoutBlock = this.arrayList.get(i)) == null || textLayoutBlock.getLayout() == null || textLayoutBlock.getLayout().getText() == null) {
                return;
            }
        ...
        public boolean selectRangeOf(ArticleSelectableView articleSelectableView, int i, int i2, int i3) {
            ...
            if (!this.arrayList.isEmpty() && i >= 0 && i < this.arrayList.size()) {
                this.textX = this.arrayList.get(i).getX();
                this.textY = this.arrayList.get(i).getY();
            } else if (!this.arrayList.isEmpty()) {
                this.textX = this.arrayList.get(0).getX();
                this.textY = this.arrayList.get(0).getY();
            }
            TextSelectionHelper<Cell>.TextSelectionOverlay textSelectionOverlay = this.textSelectionOverlay;
            if (textSelectionOverlay != null) {
                textSelectionOverlay.setVisibility(0);
        ...
        public boolean extendSelectionTo(ArticleSelectableView articleSelectableView, int i, int i2) {
            ...
            populateTextCacheForView(articleSelectableView, adapterPosition);
            int i7 = i2;
            int iLexCompare = lexCompare(adapterPosition, i, i7, this.anchorViewPosition, this.anchorChildPosition, this.anchorOffset);
            int i8 = this.anchorViewPosition;
            if (iLexCompare < 0) {
                i5 = this.anchorChildPosition;
                i6 = i8;
                i4 = i;
                i7 = this.anchorOffset;
                i3 = i7;
            } else {
                int i9 = this.anchorChildPosition;
                i3 = this.anchorOffset;
                i4 = i9;
                i5 = i;
                i6 = adapterPosition;
                adapterPosition = i8;
            }
            if (adapterPosition == i6 && i4 == i5 && i3 == i7) {
                clear();
                return true;
            }
            this.startViewPosition = adapterPosition;
        ...
        public boolean selectAllBlocksRange(int i, int i2) {
            ...
            CharSequence charSequence = this.textByPosition.get(i2);
        ...
        public void cacheText(int i, CharSequence charSequence, CharSequence charSequence2) {
            SparseArray<CharSequence> sparseArray = this.textByPosition;
        ...
        public CharSequence getSelectedText() {
            ...
            while (true) {
                ...
                if (i == i3) {
                    ...
                    for (int i11 = 0; i11 <= this.endViewChildPosition; i11++) {
                        ...
                        if (charSequence4 != null) {
                            if (this.startViewPosition == this.endViewPosition && i11 == this.endViewChildPosition && i11 == this.startViewChildPosition) {
                                ...
                                SparseArray<CharSequence> sparseArray = this.prefixTextByPosition;
                                if (i11 == i14) {
                                    CharSequence charSequence5 = sparseArray.get(i12);
                                    ...
                                    CharSequence charSequence6 = sparseArray.get(i12);
                    ...
                    int i15 = this.childCountByPosition.get(i);
                    for (int i16 = this.startViewChildPosition; i16 < i15; i16++) {
                        int i17 = (i16 << 16) + i;
                        CharSequence charSequence7 = this.prefixTextByPosition.get(i17);
                        if (charSequence7 != null) {
                            spannableStringBuilder.append(charSequence7).append(' ');
                        }
                        spannableStringBuilder.append(this.textByPosition.get(i17));
                        spannableStringBuilder.append('\n');
                    }
                }
                i++;
                ...
                for (ReplaceCopyTextSpannable replaceCopyTextSpannable : replaceCopyTextSpannableArr) {
                    ...
                    if (spanStart >= 0 && spanEnd > spanStart) {
                        ...
                        if (charSequence8 == null) {
                            charSequence8 = _UrlKt.FRAGMENT_ENCODE_SET;
                        }
