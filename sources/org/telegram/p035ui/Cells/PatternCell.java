...
public class PatternCell extends BackupImageView implements DownloadController.FileDownloadProgressListener {
    ...
    public PatternCell(Context context, int i, PatternCellDelegate patternCellDelegate) {
        ...
        setRoundRadius(AndroidUtilities.m1036dp(6.0f));
        this.maxWallpaperSize = i;
        this.delegate = patternCellDelegate;
        RadialProgress2 radialProgress2 = new RadialProgress2(this);
        this.radialProgress = radialProgress2;
        radialProgress2.setProgressRect(AndroidUtilities.m1036dp(30.0f), AndroidUtilities.m1036dp(30.0f), AndroidUtilities.m1036dp(70.0f), AndroidUtilities.m1036dp(70.0f));
        ...
        setOutlineProvider(new ViewOutlineProvider() { // from class: org.telegram.ui.Cells.PatternCell.1
            ...
            public void getOutline(View view, Outline outline) {
                outline.setRoundRect(AndroidUtilities.m1036dp(1.0f), AndroidUtilities.m1036dp(1.0f), view.getMeasuredWidth() - AndroidUtilities.m1036dp(1.0f), view.getMeasuredHeight() - AndroidUtilities.m1036dp(1.0f), AndroidUtilities.m1036dp(6.0f));
            }
        });
    ...
    public void setPattern(TLRPC.TL_wallPaper tL_wallPaper) {
        ...
        if (tL_wallPaper != null) {
            patternCell = this;
            patternCell.setImage(ImageLocation.getForDocument(FileLoader.getClosestPhotoSizeWithSize(tL_wallPaper.document.thumbs, AndroidUtilities.m1036dp(100.0f)), tL_wallPaper.document), "100_100", (ImageLocation) null, (String) null, "png", 0L, 1, tL_wallPaper);
        } else {
            patternCell = this;
            patternCell.setImageDrawable(null);
        }
        patternCell.updateSelected(false);
    }
    ...
    public void updateSelected(boolean z) {
        ...
        if ((tL_wallPaper == null && selectedPattern == null) || (selectedPattern != null && tL_wallPaper != null && tL_wallPaper.f1415id == selectedPattern.f1415id)) {
    ...
    private void updateButtonState(Object obj, boolean z, boolean z2) {
        ...
        if (z3 || (obj instanceof MediaController.SearchImage)) {
            ...
            boolean zExists = httpFilePath.exists();
    ...
    public void onDraw(Canvas canvas) {
            ...
            if (this.gradientShader == null || backgroundColor != this.currentBackgroundColor || backgroundGradientColor1 != this.currentGradientColor1 || backgroundGradientColor2 != this.currentGradientColor2 || backgroundGradientColor3 != this.currentGradientColor3 || backgroundGradientAngle != this.currentGradientAngle) {
                ...
                if (backgroundGradientColor2 != 0) {
                    ...
                    if (motionBackgroundDrawable != null) {
                        ...
                        motionBackgroundDrawable2.setRoundRadius(AndroidUtilities.m1036dp(6.0f));
                        this.backgroundDrawable.setParentView(this);
                    }
                    ImageReceiver imageReceiver = this.imageReceiver;
                    if (intensity < 0.0f) {
                        imageReceiver.setGradientBitmap(this.backgroundDrawable.getBitmap());
                    } else {
                        imageReceiver.setGradientBitmap(null);
                        int i = Build.VERSION.SDK_INT;
                        ImageReceiver imageReceiver2 = this.imageReceiver;
                        if (i >= 29) {
                            imageReceiver2.setBlendMode(BlendMode.SOFT_LIGHT);
                        } else {
                            imageReceiver2.setColorFilter(new PorterDuffColorFilter(this.delegate.getPatternColor(), PorterDuff.Mode.SRC_IN));
                        }
                    }
                } else {
        ...
        if (motionBackgroundDrawable3 != null) {
            ...
            canvas.drawRoundRect(this.rect, AndroidUtilities.m1036dp(6.0f), AndroidUtilities.m1036dp(6.0f), this.backgroundPaint);
        }
        super.onDraw(canvas);
    ...
    public void onMeasure(int i, int i2) {
        setMeasuredDimension(AndroidUtilities.m1036dp(100.0f), AndroidUtilities.m1036dp(100.0f));
    }
    ...
    public void onProgressDownload(String str, long j, long j2) {
        ...
        TLRPC.TL_wallPaper selectedPattern = this.delegate.getSelectedPattern();
        TLRPC.TL_wallPaper tL_wallPaper = this.currentPattern;
        if ((!(tL_wallPaper == null && selectedPattern == null) && (selectedPattern == null || tL_wallPaper == null || tL_wallPaper.f1415id != selectedPattern.f1415id)) || this.radialProgress.getIcon() == 10) {
            return;
        }
