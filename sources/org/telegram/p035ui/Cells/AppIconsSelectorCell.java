...
public class AppIconsSelectorCell extends RecyclerListView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public AppIconsSelectorCell(final Context context, final BaseFragment baseFragment, int i) {
        ...
        addItemDecoration(new RecyclerView.ItemDecoration() { // from class: org.telegram.ui.Cells.AppIconsSelectorCell.2
            private final int spacing = AndroidUtilities.m1036dp(16.0f);
    ...
    public /* synthetic */ void lambda$new$0(BaseFragment baseFragment, Context context, View view, int i) {
        ...
        LinearSmoothScroller linearSmoothScroller = new LinearSmoothScroller(context) { // from class: org.telegram.ui.Cells.AppIconsSelectorCell.3
            ...
            public int calculateDtToFit(int i2, int i3, int i4, int i5, int i6) {
                return (i4 - i2) + AndroidUtilities.m1036dp(16.0f);
            }
        ...
        if (this.selectedIcon != null) {
            for (int i2 = 0; i2 < this.availableIcons.size(); i2++) {
                if (this.availableIcons.get(i2) == this.selectedIcon) {
                    this.linearLayoutManager.scrollToPositionWithOffset(i2, AndroidUtilities.m1036dp(16.0f));
                    return;
                }
            }
        }
    ...
    public static final class IconHolderView extends LinearLayout {
        ...
        private IconHolderView(Context context) {
            ...
            adaptiveIconImageView.setPadding(AndroidUtilities.m1036dp(8.0f), AndroidUtilities.m1036dp(8.0f), AndroidUtilities.m1036dp(8.0f), AndroidUtilities.m1036dp(8.0f));
            this.iconView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1036dp(16.0f), 0, Theme.getColor(Theme.key_listSelector), -16777216));
            ...
            this.titleView.setTypeface(AndroidUtilities.regular());
            this.titleView.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteBlackText));
            addView(this.titleView, LayoutHelper.createLinear(-1, -2, 1, 0, 4, 0, 0));
            this.outlinePaint.setStyle(Paint.Style.STROKE);
            this.outlinePaint.setStrokeWidth(Math.max(2, AndroidUtilities.m1036dp(0.5f)));
        ...
        private void setProgress(float f) {
            ...
            this.outlinePaint.setStrokeWidth(Math.max(2, AndroidUtilities.m1036dp(AndroidUtilities.lerp(0.5f, 2.0f, f))));
            invalidate();
        }
        ...
        public void bind(LauncherIconController.LauncherIcon launcherIcon, boolean z) {
            ...
            if (launcherIcon.premium && !UserConfig.hasPremiumOnAccounts()) {
                ...
                coloredImageSpan.setSize(AndroidUtilities.m1036dp(13.0f));
                spannableString.setSpan(coloredImageSpan, 0, 1, 33);
                marginLayoutParams.rightMargin = AndroidUtilities.m1036dp(4.0f);
    ...
    public static class AdaptiveIconImageView extends ImageView {
        ...
        public AdaptiveIconImageView(Context context) {
            ...
            this.outerPadding = AndroidUtilities.m1036dp(5.0f);
            this.backgroundOuterPadding = AndroidUtilities.m1036dp(42.0f);
        ...
        private Drawable loadDrawable(int i) {
            ...
            Map<Integer, Drawable.ConstantState> map = drawableStateCache;
            synchronized (map) {
                constantState = map.get(Integer.valueOf(i));
            }
        ...
        private void updatePath() {
            ...
            Path finalIconShapePath = map.get(str);
            ...
            Path finalIconShapePath2 = map.get(str2);
            ...
            matrix.setTranslate(AndroidUtilities.m1036dp(2.0f), AndroidUtilities.m1036dp(2.0f));
