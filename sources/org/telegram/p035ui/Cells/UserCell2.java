...
public class UserCell2 extends FrameLayout {
    ...
    public UserCell2(Context context, int i, int i2, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (i2 == 1) {
            CheckBox checkBox = new CheckBox(context, C2797R.drawable.round_check2);
    ...
    public void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(70.0f), TLObject.FLAG_30));
    }
    ...
    public void update(int i) {
        ...
        if (this.currentStatus != null) {
            ...
            if (user.bot) {
                ...
                if (z2) {
                    simpleTextView.setText(LocaleController.getString(C2797R.string.BotStatusRead));
                } else {
                    simpleTextView.setText(LocaleController.getString(C2797R.string.BotStatusCantRead));
                }
            ...
            if (ChatObject.isChannel(chat) && !chat.megagroup) {
                ...
                if (i2 != 0) {
                    ...
                    if (!zIsPublic) {
                        simpleTextView2.setText(LocaleController.getString(C2797R.string.ChannelPrivate));
                    } else {
                        simpleTextView2.setText(LocaleController.getString(C2797R.string.ChannelPublic));
                    }
                }
            } else {
                ...
                if (i3 != 0) {
                    ...
                    if (!zIsPublic2) {
                        simpleTextView3.setText(LocaleController.getString(C2797R.string.MegaPrivate));
                    } else {
                        simpleTextView3.setText(LocaleController.getString(C2797R.string.MegaPublic));
                    }
                }
            }
