...
public class ChatUnreadCell extends FrameLayout {
    ...
    public ChatUnreadCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        simpleTextView.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1036dp(50.0f), getColor(Theme.key_chat_unreadMessagesStartBackground)));
        if (LocaleController.isRTL) {
            simpleTextView.setAlignment(Layout.Alignment.ALIGN_OPPOSITE);
        }
        simpleTextView.setPadding(AndroidUtilities.m1036dp(12.0f), AndroidUtilities.m1036dp(6.0f), AndroidUtilities.m1036dp(12.0f), AndroidUtilities.m1036dp(6.0f));
    ...
    public void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(46.0f), TLObject.FLAG_30));
    }
