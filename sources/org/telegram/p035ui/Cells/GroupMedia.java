...
public class GroupMedia {
    ...
    public void setMessageObject(MessageObject messageObject, boolean z, boolean z2) {
        ...
        ArrayList<TLRPC.MessageExtendedMedia> arrayList;
        ...
        if (messageMedia instanceof TLRPC.TL_messageMediaPaidMedia) {
            ...
            if (i > 0) {
                ...
                if (AndroidUtilities.isTablet()) {
                    this.maxWidth = AndroidUtilities.getMinTabletSide() - AndroidUtilities.m1036dp(122.0f);
                } else {
                    this.maxWidth = Math.min(this.cell.getParentWidth(), AndroidUtilities.displaySize.y) - AndroidUtilities.m1036dp((this.cell.checkNeedDrawShareButton(messageObject) ? 10 : 0) + 64);
                }
                if (this.cell.needDrawAvatar()) {
                    this.maxWidth -= AndroidUtilities.m1036dp(52.0f);
                }
            }
            int i2 = 0;
            while (true) {
                int size = tL_messageMediaPaidMedia.extended_media.size();
                arrayList = tL_messageMediaPaidMedia.extended_media;
                if (i2 >= size) {
                    break;
                }
                TLRPC.MessageExtendedMedia messageExtendedMedia = arrayList.get(i2);
                MediaHolder mediaHolder = i2 >= this.holders.size() ? null : this.holders.get(i2);
                if (mediaHolder == null) {
                    MediaHolder mediaHolder2 = new MediaHolder(this.cell, messageObject, messageExtendedMedia, tL_messageMediaPaidMedia.extended_media.size() != 1, (int) ((r1.f1153pw / 1000.0f) * this.maxWidth), (int) (this.layout.getPosition(messageExtendedMedia).f1152ph * this.layout.maxSizeHeight));
            ...
            while (size2 < this.holders.size()) {
                MediaHolder mediaHolder3 = size2 >= this.holders.size() ? null : this.holders.get(size2);
                if (mediaHolder3 != null) {
                    mediaHolder3.detach();
                    this.holders.remove(size2);
                    size2--;
                }
                size2++;
            }
            ...
            if (this.hidden) {
                ...
                if (text.getCurrentWidth() > this.width - AndroidUtilities.m1036dp(30.0f)) {
    ...
    */
    public void updateHolders(org.telegram.messenger.MessageObject r23) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Cells.GroupMedia.updateHolders(org.telegram.messenger.MessageObject):void");
    }
    ...
    public ImageReceiver getPhotoImage(int i) {
        ...
        if (groupedMessages != null && i >= 0 && i < groupedMessages.medias.size()) {
            TLRPC.MessageExtendedMedia messageExtendedMedia = this.layout.medias.get(i);
            for (int i2 = 0; i2 < this.holders.size(); i2++) {
                if (this.holders.get(i2).media == messageExtendedMedia) {
    ...
    public boolean allVisible() {
        ArrayList<MediaHolder> arrayList = this.holders;
        int size = arrayList.size();
        int i = 0;
        while (i < size) {
            MediaHolder mediaHolder = arrayList.get(i);
            i++;
            if (!mediaHolder.imageReceiver.getVisible()) {
                return false;
            }
        }
        return true;
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.buttonText != null && f > 0.0f) {
            ...
            int i3 = this.f1504y;
            int i4 = this.height;
            rectF.set(i + ((i2 - fM1036dp) / 2.0f), i3 + ((i4 - fM1036dp2) / 2.0f), i + ((i2 + fM1036dp) / 2.0f), i3 + ((i4 + fM1036dp2) / 2.0f));
            this.clipPath.rewind();
            float f2 = fM1036dp2 / 2.0f;
            this.clipPath.addRoundRect(this.clipRect, f2, f2, Path.Direction.CW);
            canvas2.save();
            canvas2.scale(scale, scale, this.f1503x + (this.width / 2.0f), this.f1504y + (this.height / 2.0f));
            canvas2.save();
            canvas2.clipPath(this.clipPath);
            drawBlurred(canvas2, f);
            canvas2.drawColor(Theme.multAlpha(1342177280, f));
            this.buttonText.draw(canvas, AndroidUtilities.m1036dp(14.0f) + ((this.f1503x + (this.width / 2.0f)) - (fM1036dp / 2.0f)), (this.height / 2.0f) + this.f1504y, -1, f);
            canvas2 = canvas;
            canvas2.restore();
            ...
            if (loadingDrawable3 != null) {
                loadingDrawable3.setBounds(this.clipRect);
        ...
        float fM1036dp3 = AndroidUtilities.m1036dp(11.32f) + this.priceText.getCurrentWidth();
        float fM1036dp4 = AndroidUtilities.m1036dp(17.0f);
        float fM1036dp5 = AndroidUtilities.m1036dp(5.0f);
        RectF rectF2 = this.clipRect;
        int i5 = this.f1503x;
        int i6 = this.width;
        int i7 = this.f1504y;
        rectF2.set(((i5 + i6) - fM1036dp3) - fM1036dp5, i7 + fM1036dp5, (i5 + i6) - fM1036dp5, i7 + fM1036dp5 + fM1036dp4);
        this.clipPath.rewind();
        float f3 = fM1036dp4 / 2.0f;
        this.clipPath.addRoundRect(this.clipRect, f3, f3, Path.Direction.CW);
        canvas2.save();
        canvas2.clipPath(this.clipPath);
        canvas2.drawColor(Theme.multAlpha(TLObject.FLAG_30, timeAlpha));
        this.priceText.draw(canvas2, AndroidUtilities.m1036dp(5.66f) + (((this.f1503x + this.width) - fM1036dp3) - fM1036dp5), f3 + this.f1504y + fM1036dp5, -1, timeAlpha);
        canvas.restore();
    }
    ...
    public void checkBlurBitmap() {
        ...
        for (int i8 = 0; i8 < this.holders.size(); i8++) {
            ...
            mediaHolder2.imageReceiver.setImageCoords(mediaHolder2.f1507l, mediaHolder2.f1509t, mediaHolder2.f1508r - r4, mediaHolder2.f1505b - r6);
    ...
    public void drawBlurred(Canvas canvas, float f) {
        ...
        if (this.blurBitmap != null) {
            canvas.save();
            canvas.translate(this.f1503x, this.f1504y);
    ...
    public void drawImages(Canvas canvas, boolean z) {
        ...
        while (i < this.holders.size()) {
            ...
            int i2 = this.f1503x;
            int i3 = mediaHolder.f1507l;
            int i4 = this.f1504y;
            int i5 = mediaHolder.f1509t;
            imageReceiver.setImageCoords(i2 + i3, i4 + i5, mediaHolder.f1508r - i3, mediaHolder.f1505b - i5);
            ...
            if (f > 0.0f) {
                fMin = Math.min(this.f1503x + mediaHolder.f1507l, fMin);
                fMin2 = Math.min(this.f1504y + mediaHolder.f1509t, fMin2);
                fMax = Math.max(this.f1503x + mediaHolder.f1508r, fMax);
                fMax2 = Math.max(this.f1504y + mediaHolder.f1505b, fMax2);
                RectF rectF = AndroidUtilities.rectTmp;
                float f2 = mediaHolder.f1507l + this.f1503x;
                int i6 = this.f1504y;
                rectF.set(f2, mediaHolder.f1509t + i6, r11 + mediaHolder.f1508r, i6 + mediaHolder.f1505b);
            ...
            boolean zIsSending = messageObject.isSending();
            ...
            } else if (FileLoader.getInstance(i7).isLoadingFile(mediaHolder.filename)) {
        ...
        while (i10 < this.holders.size()) {
            ...
            if (mediaHolder2.durationText != null) {
                float fM1036dp = AndroidUtilities.m1036dp(11.4f) + mediaHolder2.durationText.getCurrentWidth();
                float fM1036dp2 = AndroidUtilities.m1036dp(17.0f);
                float fM1036dp3 = AndroidUtilities.m1036dp(5.0f);
                RectF rectF2 = this.clipRect;
                int i11 = this.f1503x;
                int i12 = mediaHolder2.f1507l;
                int i13 = this.f1504y;
                int i14 = mediaHolder2.f1509t;
                rectF2.set(i11 + i12 + fM1036dp3, i13 + i14 + fM1036dp3, i11 + i12 + fM1036dp3 + fM1036dp, i13 + i14 + fM1036dp3 + fM1036dp2);
                if (this.priceText == null || this.clipRect.right <= ((this.f1503x + this.width) - (AndroidUtilities.m1036dp(11.32f) + this.priceText.getCurrentWidth())) - fM1036dp3 || this.clipRect.top > this.f1504y + fM1036dp3) {
                    this.clipPath.rewind();
                    ...
                    mediaHolder2.durationText.draw(canvas2, this.f1503x + mediaHolder2.f1507l + fM1036dp3 + AndroidUtilities.m1036dp(5.66f), f4 + this.f1504y + mediaHolder2.f1509t + fM1036dp3, -1, 1.0f);
                    canvas.restore();
                }
            }
            i10++;
    ...
    public static class MediaHolder implements DownloadController.FileDownloadProgressListener {
        ...
        public void updateMedia(TLRPC.MessageExtendedMedia messageExtendedMedia, MessageObject messageObject) {
            ...
            this.autoplay = false;
            String strConcat = this.f1510w + "_" + this.f1506h;
            if (messageExtendedMedia instanceof TLRPC.TL_messageExtendedMediaPreview) {
                this.hidden = true;
                this.filename = null;
                this.imageReceiver.setImage(ImageLocation.getForObject(((TLRPC.TL_messageExtendedMediaPreview) messageExtendedMedia).thumb, messageObject.messageOwner), strConcat.concat("_b2"), null, null, messageObject, 0);
                ColorMatrix colorMatrix = new ColorMatrix();
            ...
            if (messageExtendedMedia instanceof TLRPC.TL_messageExtendedMedia) {
                ...
                this.hidden = z;
                if (z) {
                    strConcat = strConcat.concat("_b3");
                }
                ...
                if (messageMedia instanceof TLRPC.TL_messageMediaPhoto) {
                    ...
                    this.imageReceiver.setImage(ImageLocation.getForPhoto(closestPhotoSizeWithSize, tL_messageMediaPhoto.photo), str, ImageLocation.getForPhoto(FileLoader.getClosestPhotoSizeWithSize(tL_messageMediaPhoto.photo.sizes, Math.min(this.f1510w, this.f1506h) / 100, false, closestPhotoSizeWithSize, false), tL_messageMediaPhoto.photo), str, 0L, null, messageObject, 0);
                    return;
                }
                if (messageMedia instanceof TLRPC.TL_messageMediaDocument) {
                    ...
                    if (!this.album && this.video && (document = tL_messageMediaDocument.document) != null) {
                        ...
                        TLRPC.PhotoSize closestPhotoSizeWithSize3 = FileLoader.getClosestPhotoSizeWithSize(tL_messageMediaDocument.document.thumbs, Math.min(this.f1510w, this.f1506h), false, closestPhotoSizeWithSize2, false);
                        ...
                        imageReceiver.setImage(forDocument, str.concat(z2 ? "_g" : _UrlKt.FRAGMENT_ENCODE_SET), forDocument2, str, forDocument3, str, null, 0L, null, messageObject, 0);
                        return;
                    }
                    ...
                    if (document2 != null) {
                        ...
                        this.imageReceiver.setImage(ImageLocation.getForDocument(closestPhotoSizeWithSize4, tL_messageMediaDocument.document), str, ImageLocation.getForDocument(FileLoader.getClosestPhotoSizeWithSize(tL_messageMediaDocument.document.thumbs, Math.min(this.f1510w, this.f1506h), false, closestPhotoSizeWithSize4, false), tL_messageMediaDocument.document), str, 0L, null, messageObject, 0);
                    }
                }
            }
        }
    ...
    public static class GroupedMessages {
        ...
        public MessageObject.GroupedMessagePosition getPosition(TLRPC.MessageExtendedMedia messageExtendedMedia) {
            ...
            return this.positions.get(messageExtendedMedia);
        }
