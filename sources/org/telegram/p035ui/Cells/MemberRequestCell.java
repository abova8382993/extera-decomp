...
public class MemberRequestCell extends FrameLayout {
    ...
    public MemberRequestCell(Context context, final OnClickListener onClickListener, boolean z) {
        ...
        textView.setPadding(iM1036dp, 0, iM1036dp, 0);
        textView.setText(LocaleController.getString(z ? C2797R.string.AddToChannel : C2797R.string.AddToGroup));
        ...
        float fMeasureText = textView.getPaint().measureText(textView.getText().toString()) + (iM1036dp * 2);
        TextView textView2 = new TextView(getContext());
        textView2.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1036dp(16.0f), 0, Theme.getColor(Theme.key_listSelector), -16777216));
        textView2.setGravity((LocaleController.isRTL ? 5 : 3) | 16);
        textView2.setMaxLines(1);
        textView2.setPadding(iM1036dp, 0, iM1036dp, 0);
        textView2.setText(LocaleController.getString(C2797R.string.Dismiss));
        ...
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(-2, AndroidUtilities.m1036dp(32.0f), LocaleController.isRTL ? 5 : 3);
        layoutParams.topMargin = AndroidUtilities.m1036dp(62.0f);
        layoutParams.leftMargin = LocaleController.isRTL ? 0 : (int) (AndroidUtilities.m1036dp(79.0f) + fMeasureText);
        layoutParams.rightMargin = LocaleController.isRTL ? (int) (fMeasureText + AndroidUtilities.m1036dp(79.0f)) : 0;
    ...
    public void setData(LongSparseArray<TLRPC.User> longSparseArray, TLRPC.TL_chatInviteImporter tL_chatInviteImporter, boolean z) {
        ...
        if (tL_chatInviteImporter.via_chatlist) {
            this.statusTextView.setText(LocaleController.getString(C2797R.string.JoinedViaFolder));
            return;
        }
        long j = tL_chatInviteImporter.approved_by;
        if (j == 0) {
            this.statusTextView.setText(LocaleController.formatString("RequestedToJoinAt", C2797R.string.RequestedToJoinAt, dateAudio));
            return;
        }
        TLRPC.User user2 = longSparseArray.get(j);
        SimpleTextView simpleTextView = this.statusTextView;
        if (user2 != null) {
            simpleTextView.setText(LocaleController.formatString("AddedBy", C2797R.string.AddedBy, UserObject.getFirstName(user2), dateAudio));
        } else {
    ...
    public void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(107.0f), TLObject.FLAG_30));
    }
