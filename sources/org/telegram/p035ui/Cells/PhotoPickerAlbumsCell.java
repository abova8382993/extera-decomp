...
public class PhotoPickerAlbumsCell extends FrameLayout {
    ...
    public class AlbumView extends FrameLayout {
        ...
        public AlbumView(Context context) {
            ...
            linearLayout.setBackgroundResource(C2797R.drawable.album_shadow);
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (AndroidUtilities.isTablet()) {
            iM1036dp = ((AndroidUtilities.m1036dp(490.0f) - AndroidUtilities.m1036dp(12.0f)) - ((this.albumsCount - 1) * AndroidUtilities.m1036dp(4.0f))) / this.albumsCount;
        } else {
            iM1036dp = ((AndroidUtilities.displaySize.x - AndroidUtilities.m1036dp(12.0f)) - ((this.albumsCount - 1) * AndroidUtilities.m1036dp(4.0f))) / this.albumsCount;
        }
        for (int i3 = 0; i3 < this.albumsCount; i3++) {
            ...
            layoutParams.topMargin = AndroidUtilities.m1036dp(4.0f);
            layoutParams.leftMargin = (AndroidUtilities.m1036dp(4.0f) + iM1036dp) * i3;
            layoutParams.width = iM1036dp;
            layoutParams.height = iM1036dp;
            layoutParams.gravity = 51;
            this.albumViews[i3].setLayoutParams(layoutParams);
        }
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(4.0f) + iM1036dp, TLObject.FLAG_30));
    }
}
