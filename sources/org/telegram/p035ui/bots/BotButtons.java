...
public abstract class BotButtons extends FrameLayout {
    ...
    public static class ButtonState {
        ...
        public static ButtonState m1228of(boolean z, boolean z2, boolean z3, boolean z4, String str, long j, int i, int i2) {
            return m1229of(z, z2, z3, z4, str, j, i, i2, null);
        }

        /* JADX INFO: renamed from: of */
        public static ButtonState m1229of(boolean z, boolean z2, boolean z3, boolean z4, String str, long j, int i, int i2, String str2) {
    ...
    public class Button {
        ...
        public final AnimatedFloat f1856w;

        /* JADX INFO: renamed from: x */
        public final AnimatedFloat f1857x;

        /* JADX INFO: renamed from: y */
        public final AnimatedFloat f1858y;

        private Button() {
            this.bounds = new RectF();
            CubicBezierInterpolator cubicBezierInterpolator = CubicBezierInterpolator.EASE_OUT_QUINT;
            this.alpha = new AnimatedFloat(BotButtons.this, 0L, 320L, cubicBezierInterpolator);
            this.f1857x = new AnimatedFloat(BotButtons.this, 0L, 320L, cubicBezierInterpolator);
            this.f1858y = new AnimatedFloat(BotButtons.this, 0L, 320L, cubicBezierInterpolator);
            this.f1856w = new AnimatedFloat(BotButtons.this, 0L, 320L, cubicBezierInterpolator);
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            AnimatedFloat animatedFloat = button.f1857x;
            if (z) {
            ...
            AnimatedFloat animatedFloat2 = button.f1858y;
            if (z2) {
            ...
            AnimatedFloat animatedFloat3 = button.f1856w;
            if (z3) {
            ...
            float fLerp = AndroidUtilities.lerp((getWidth() - AndroidUtilities.m1036dp(26.0f)) / 2.0f, getWidth() - AndroidUtilities.m1036dp(16.0f), f5);
            float fM1036dp = AndroidUtilities.m1036dp(44.0f);
            float f8 = fLerp / 2.0f;
            float fLerp2 = AndroidUtilities.lerp(AndroidUtilities.m1036dp(8.0f), AndroidUtilities.m1036dp(18.0f) + ((getWidth() - AndroidUtilities.m1036dp(26.0f)) / 2.0f), f2) + f8;
            float f9 = fM1036dp / 2.0f;
            float fLerp3 = AndroidUtilities.lerp(AndroidUtilities.m1036dp(7.0f), AndroidUtilities.m1036dp(58.0f), f4) + f9 + height;
            ...
            String str2 = str;
            canvas.drawRoundRect(button.bounds, AndroidUtilities.m1036dp(9.0f), AndroidUtilities.m1036dp(9.0f), button.backgroundPaint);
            if (f10 < 1.0f) {
                canvas.save();
                float f12 = 1.0f - f10;
                float fLerp4 = AndroidUtilities.lerp(0.75f, 1.0f, f12);
                canvas.scale(fLerp4, fLerp4, fLerp2, fLerp3);
                canvas.translate(0.0f, AndroidUtilities.m1036dp(-10.0f) * f10);
                float f13 = f12 * f7;
            ...
            if (f10 > 0.0f) {
                ...
                canvas.translate(0.0f, AndroidUtilities.m1036dp(10.0f) * (1.0f - f10));
            ...
            if (f11 > f6) {
                ...
                button.flicker.draw(canvas, button.bounds, AndroidUtilities.m1036dp(8.0f), this);
            }
    ...
    public void setMainState(ButtonState buttonState, boolean z) {
        ...
        Runnable runnable = this.whenResized;
        if (totalHeight < totalHeight2) {
    ...
    public int getTotalHeight() {
        ...
        return AndroidUtilities.m1036dp(109.0f);
    }
    ...
    public void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(109.0f) + 1, TLObject.FLAG_30));
    }
