...
public class BotSensors {
    ...
    private final SensorEventListener accelerometerListener = new C74491();
    private final SensorEventListener gyroscopeListener = new C74502();
    private final SensorEventListener absoluteOrientationListener = new C74513();
    private final SensorEventListener relativeOrientationListener = new C74524();
    ...
    /* JADX INFO: renamed from: org.telegram.ui.bots.BotSensors$1 */
    public class C74491 implements SensorEventListener {
        ...
        public void onSensorChanged(SensorEvent sensorEvent) {
            ...
            if (jCurrentTimeMillis < BotSensors.this.accelerometerDesiredRefreshRate) {
                ...
                Runnable runnable = new Runnable() { // from class: org.telegram.ui.bots.BotSensors$1$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.post();
                    }
                };
                botSensors.accelerometerListenerPostponed = runnable;
                AndroidUtilities.runOnUIThread(runnable, BotSensors.this.accelerometerDesiredRefreshRate - jCurrentTimeMillis);
                return;
            }
            post();
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.bots.BotSensors$2 */
    public class C74502 implements SensorEventListener {
        ...
        public void onSensorChanged(SensorEvent sensorEvent) {
            ...
            if (jCurrentTimeMillis < BotSensors.this.gyroscopeDesiredRefreshRate) {
                BotSensors botSensors = BotSensors.this;
                Runnable runnable = new Runnable() { // from class: org.telegram.ui.bots.BotSensors$2$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.post();
                    }
                };
                botSensors.gyroscopeListenerPostponed = runnable;
                AndroidUtilities.runOnUIThread(runnable, BotSensors.this.gyroscopeDesiredRefreshRate - jCurrentTimeMillis);
                return;
            }
            post();
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.bots.BotSensors$3 */
    public class C74513 implements SensorEventListener {
        ...
        public void onSensorChanged(SensorEvent sensorEvent) {
            ...
            if (jCurrentTimeMillis < BotSensors.this.absoluteOrientationDesiredRefreshRate) {
                BotSensors botSensors = BotSensors.this;
                Runnable runnable = new Runnable() { // from class: org.telegram.ui.bots.BotSensors$3$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.post();
                    }
                };
                botSensors.absoluteOrientationListenerPostponed = runnable;
                AndroidUtilities.runOnUIThread(runnable, BotSensors.this.absoluteOrientationDesiredRefreshRate - jCurrentTimeMillis);
                return;
            }
            post();
        }
        ...
        public void post() {
            ...
            if (SensorManager.getRotationMatrix(fArr, new float[9], this.gravity, this.geomagnetic)) {
                ...
                try {
                    ...
                    jSONObject.put("alpha", -r1[0]);
                    jSONObject.put(BuildConfig.FLAVOR_minApi, -r1[1]);
                    jSONObject.put("gamma", r1[2]);
    ...
    /* JADX INFO: renamed from: org.telegram.ui.bots.BotSensors$4 */
    public class C74524 implements SensorEventListener {
        private long lastTime;
        ...
        public void onSensorChanged(SensorEvent sensorEvent) {
            ...
            if (jCurrentTimeMillis < BotSensors.this.relativeOrientationDesiredRefreshRate) {
                BotSensors botSensors = BotSensors.this;
                Runnable runnable = new Runnable() { // from class: org.telegram.ui.bots.BotSensors$4$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.post();
                    }
                };
                botSensors.relativeOrientationListenerPostponed = runnable;
                AndroidUtilities.runOnUIThread(runnable, BotSensors.this.relativeOrientationDesiredRefreshRate - jCurrentTimeMillis);
                return;
            }
