...
public abstract class SetupEmojiStatusSheet {
    public static void show(final int i, final TLRPC.User user, long j, final int i2, final Utilities.Callback2<String, TLRPC.Document> callback2) {
        if (callback2 == null) {
            return;
        }
        final TLRPC.Document documentFindDocument = AnimatedEmojiDrawable.findDocument(i, j);
        if (documentFindDocument != null) {
            show(i, user, documentFindDocument, i2, (Utilities.Callback<String>) new Utilities.Callback() { // from class: org.telegram.ui.bots.SetupEmojiStatusSheet$$ExternalSyntheticLambda1
                ...
                public final void run(TLRPC.Document document) {
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.bots.SetupEmojiStatusSheet$$ExternalSyntheticLambda8
                        ...
                        public final void run() {
                            ...
                            SetupEmojiStatusSheet.show(i3, user2, document2, i, (Utilities.Callback<String>) new Utilities.Callback() { // from class: org.telegram.ui.bots.SetupEmojiStatusSheet$$ExternalSyntheticLambda10
                                @Override // org.telegram.messenger.Utilities.Callback
                                public final void run(Object obj) {
    ...
    public static void show(final int i, TLRPC.User user, final TLRPC.Document document, final int i2, final Utilities.Callback<String> callback) {
        ...
        if (i2 > 0) {
            ...
            int iRound = Math.round((r3 - (i4 * 3600)) / 60.0f);
            ...
            spannableStringBuilderReplaceTags = AndroidUtilities.replaceTags(LocaleController.formatString(C2797R.string.BotEmojiStatusSetRequestFor, UserObject.getUserName(user), sb));
        } else {
            spannableStringBuilderReplaceTags = AndroidUtilities.replaceTags(LocaleController.formatString(C2797R.string.BotEmojiStatusSetRequest, UserObject.getUserName(user)));
        }
        AlertDialog alertDialogCreate = new AlertDialog.Builder(contextFindActivity, null).setTopImage(new UserEmojiStatusDrawable(currentUser, document), Theme.getColor(Theme.key_dialogTopBackground)).setMessage(spannableStringBuilderReplaceTags).setPositiveButton(LocaleController.getString(C2797R.string.BotEmojiStatusConfirm), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.bots.SetupEmojiStatusSheet$$ExternalSyntheticLambda3
    ...
    public class C74991 extends BaseFragment {
        @Override // org.telegram.p035ui.ActionBar.BaseFragment
        public int getCurrentAccount() {
            return this.currentAccount;
        }
    ...
    public static /* synthetic */ void $r8$lambda$qjBVdEmBi2OOINVrp3sTDsRgkV4(TLObject tLObject, boolean[] zArr, Utilities.Callback callback, int i, TL_account.updateEmojiStatus updateemojistatus) {
        ...
        if (currentUser != null) {
            ...
            MessagesController.getInstance(i).updateEmojiStatusUntilUpdate(currentUser.f1407id, currentUser.emoji_status);
        }
        if (zArr[0]) {
            return;
        }
    ...
    public static void askPermission(final int i, long j, final Utilities.Callback2<Boolean, String> callback2) {
    ...
    public static void askPermission(final int i, final TLRPC.User user, final TLRPC.UserFull userFull, final Utilities.Callback2<Boolean, String> callback2) {
        if (callback2 == null) {
            return;
        }
        ...
        }).setNegativeButton(LocaleController.getString(C2797R.string.BotEmojiStatusPermissionDecline), null).create();
        alertDialogCreate.show();
        alertDialogCreate.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.bots.SetupEmojiStatusSheet$$ExternalSyntheticLambda7
            @Override // android.content.DialogInterface.OnDismissListener
            public final void onDismiss(DialogInterface dialogInterface) {
                SetupEmojiStatusSheet.m22603$r8$lambda$xBcQe_QLK_Xp3dKHzBejZphvM(zArr2, zArr, context, i, user, callback2, dialogInterface);
            }
        });
    }
    ...
    public static /* synthetic */ void $r8$lambda$e9F1zgMeFykHyXu2bGe3uCAdOus(int i, boolean[] zArr, final boolean[] zArr2, final Utilities.Callback2 callback2, Context context, TLRPC.User user, final TLRPC.UserFull userFull, AlertDialog alertDialog, int i2) {
        ...
        zArr[0] = true;
        saveAccessRequested(context, i, user.f1407id);
        ...
        ConnectionsManager.getInstance(i).sendRequest(toggleuseremojistatuspermission, new RequestDelegate() { // from class: org.telegram.ui.bots.SetupEmojiStatusSheet$$ExternalSyntheticLambda11
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.bots.SetupEmojiStatusSheet$$ExternalSyntheticLambda12
                    @Override // java.lang.Runnable
                    public final void run() {
                        SetupEmojiStatusSheet.m22601$r8$lambda$HIic6tNxbal5Rj9WJRo00n2yQ(tLObject, zArr, callback2, userFull);
                    }
                });
            }
        });
    ...
    public class C75002 extends BaseFragment {
        @Override // org.telegram.p035ui.ActionBar.BaseFragment
        public int getCurrentAccount() {
            return this.currentAccount;
        }
    ...
    public static /* synthetic */ void m22601$r8$lambda$HIic6tNxbal5Rj9WJRo00n2yQ(TLObject tLObject, boolean[] zArr, Utilities.Callback2 callback2, TLRPC.UserFull userFull) {
        if (!(tLObject instanceof TLRPC.TL_boolTrue)) {
            if (zArr[0]) {
                return;
            }
    ...
    public static /* synthetic */ void m22603$r8$lambda$xBcQe_QLK_Xp3dKHzBejZphvM(boolean[] zArr, boolean[] zArr2, Context context, int i, TLRPC.User user, Utilities.Callback2 callback2, DialogInterface dialogInterface) {
        if (zArr[0] || zArr2[0]) {
            return;
        }
        zArr2[0] = true;
    ...
    public static class UserEmojiStatusDrawable extends Drawable implements AttachableDrawable, NotificationCenter.NotificationCenterDelegate {
        ...
        public UserEmojiStatusDrawable(TLRPC.User user) {
            ...
            paint2.setShadowLayer(AndroidUtilities.m1036dp(2.33f), 0.0f, AndroidUtilities.m1036dp(2.0f), Theme.multAlpha(-16777216, 0.18f));
            AvatarDrawable avatarDrawable = new AvatarDrawable();
            avatarDrawable.setInfo(user);
            imageReceiver.setForUserOrChat(user, avatarDrawable);
            imageReceiver.setRoundRadius(AndroidUtilities.m1036dp(16.0f));
            setRandomStatus();
        ...
        @Override // org.telegram.p035ui.Components.AttachableDrawable
        ...
        public void draw(Canvas canvas) {
            ...
            float fM1036dp = (AndroidUtilities.m1036dp(((this.highlight ? 48 : 28) + 38) + 6.66f) + this.text.getCurrentWidth()) / 2.0f;
            float fM1036dp2 = AndroidUtilities.m1036dp(32.0f) / 2.0f;
            this.rect.set(bounds.centerX() - fM1036dp, bounds.centerY() - fM1036dp2, bounds.centerX() + fM1036dp, bounds.centerY() + fM1036dp2);
            canvas.drawRoundRect(this.rect, fM1036dp2, fM1036dp2, this.backgroundPaint);
            ImageReceiver imageReceiver = this.userImageReceiver;
            RectF rectF = this.rect;
            imageReceiver.setImageCoords(rectF.left, rectF.top, AndroidUtilities.m1036dp(32.0f), AndroidUtilities.m1036dp(32.0f));
            this.userImageReceiver.draw(canvas);
            this.text.draw(canvas, this.rect.left + AndroidUtilities.m1036dp(36.0f), this.rect.centerY(), Theme.getColor(Theme.key_windowBackgroundWhiteBlackText), 1.0f);
            if (this.highlight) {
                float fM1036dp3 = this.rect.right - AndroidUtilities.m1036dp(22.66f);
                canvas.drawCircle(fM1036dp3, this.rect.centerY(), AndroidUtilities.m1036dp(24.0f), this.backgroundPaint2);
                this.statusImageReceiver.setImageCoords(fM1036dp3 - AndroidUtilities.m1036dp(16.0f), this.rect.centerY() - AndroidUtilities.m1036dp(16.0f), AndroidUtilities.m1036dp(32.0f), AndroidUtilities.m1036dp(32.0f));
                this.statusImageReceiver.draw(canvas);
                return;
            }
            float f4 = this.animatedSwap.set(this.currentStatus);
            canvas.save();
            canvas.translate((int) (this.rect.right - AndroidUtilities.m1036dp(30.66f)), (int) (this.rect.centerY() - AndroidUtilities.m1036dp(12.0f)));
            if (f4 >= 1.0f || (animatedEmojiDrawable2 = this.emojis[0]) == null) {
                ...
                canvas.save();
                canvas.translate(0.0f, (this.currentStatus == 0 ? -1 : 1) * AndroidUtilities.m1036dp(9.0f) * f4);
                float f5 = 1.0f - f4;
                f = 24.0f;
                float f6 = (f5 * 0.4f) + 0.6f;
                f2 = 1.0f;
                f3 = 12.0f;
                canvas.scale(f6, f6, AndroidUtilities.m1036dp(12.0f), AndroidUtilities.m1036dp(12.0f));
                animatedEmojiDrawable2.setBounds(0, 0, AndroidUtilities.m1036dp(24.0f), AndroidUtilities.m1036dp(24.0f));
            ...
            if (f4 > 0.0f && (animatedEmojiDrawable = this.emojis[1]) != null) {
                canvas.save();
                canvas.translate(0.0f, (this.currentStatus != 1 ? 1 : -1) * AndroidUtilities.m1036dp(9.0f) * (f2 - f4));
                float f7 = (0.4f * f4) + 0.6f;
                canvas.scale(f7, f7, AndroidUtilities.m1036dp(f3), AndroidUtilities.m1036dp(f3));
                animatedEmojiDrawable.setBounds(0, 0, AndroidUtilities.m1036dp(f), AndroidUtilities.m1036dp(f));
