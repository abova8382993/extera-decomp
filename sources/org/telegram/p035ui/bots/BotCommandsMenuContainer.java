...
public abstract class BotCommandsMenuContainer extends FrameLayout {
    ...
    public BotCommandsMenuContainer(Context context) {
        ...
        RecyclerListView recyclerListView = new RecyclerListView(context) { // from class: org.telegram.ui.bots.BotCommandsMenuContainer.1
            ...
            public void dispatchDraw(Canvas canvas) {
                ...
                float fM1036dp = BotCommandsMenuContainer.this.scrollYOffset - AndroidUtilities.m1036dp(8.0f);
                BotCommandsMenuContainer.this.containerY = fM1036dp - AndroidUtilities.m1036dp(16.0f);
                ...
                rectF.set((getMeasuredWidth() / 2.0f) - AndroidUtilities.m1036dp(12.0f), fM1036dp - AndroidUtilities.m1036dp(4.0f), (getMeasuredWidth() / 2.0f) + AndroidUtilities.m1036dp(12.0f), fM1036dp);
                canvas.drawRoundRect(rectF, AndroidUtilities.m1036dp(4.0f), AndroidUtilities.m1036dp(4.0f), BotCommandsMenuContainer.this.topBackground);
                super.dispatchDraw(canvas);
            }
        };
    ...
    private void checkDismiss() {
        ...
        if (this.listView.getTranslationY() > AndroidUtilities.m1036dp(16.0f)) {
            dismiss();
        } else {
            playEnterAnim(false);
        }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.entering && !this.dismissed) {
            this.listView.setTranslationY((r2.getMeasuredHeight() - this.listView.getPaddingTop()) + AndroidUtilities.m1036dp(16.0f));
            playEnterAnim(true);
            this.entering = false;
        }
    ...
    public void dismiss() {
        ...
        cancelCurrentAnimation();
        RecyclerListView recyclerListView = this.listView;
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(recyclerListView, (Property<RecyclerListView, Float>) FrameLayout.TRANSLATION_Y, recyclerListView.getTranslationY(), (getMeasuredHeight() - this.scrollYOffset) + AndroidUtilities.m1036dp(40.0f));
        this.currentAnimation = objectAnimatorOfFloat;
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() != 0 || motionEvent.getY() >= this.scrollYOffset - AndroidUtilities.m1036dp(24.0f)) {
    ...
    public void checkBackgroundBounds() {
        BlurredBackgroundDrawable blurredBackgroundDrawable = this.backgroundDrawable;
        if (blurredBackgroundDrawable != null) {
            blurredBackgroundDrawable.setBounds(0, ((int) this.scrollYOffset) - AndroidUtilities.m1036dp(25.0f), getMeasuredWidth(), getMeasuredHeight() + AndroidUtilities.m1036dp(5.0f));
