...
import org.telegram.p035ui.Components.VideoPlayerSeekBar;
...
public class SecretMediaViewer implements NotificationCenter.NotificationCenterDelegate, GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    ...
    public final Property<SecretMediaViewer, Float> VIDEO_CROSSFADE_ALPHA = new AnimationProperties.FloatProperty<SecretMediaViewer>("videoCrossfadeAlpha") { // from class: org.telegram.ui.SecretMediaViewer.16
        public C659516(String str) {
            super(str);
        }
    ...
    public final Property<SecretMediaViewer, Float> ANIMATION_VALUE = new AnimationProperties.FloatProperty<SecretMediaViewer>("animationValue") { // from class: org.telegram.ui.SecretMediaViewer.20
        public C660020(String str) {
            super(str);
        }
    ...
    public class SecretDeleteTimer extends FrameLayout {
        ...
        public SecretDeleteTimer(Context context) {
            ...
            paint.setStrokeWidth(AndroidUtilities.m1036dp(1.5f));
            ...
            this.afterDeleteProgressPaint.setStrokeWidth(AndroidUtilities.m1036dp(2.0f));
            Paint paint5 = new Paint(1);
            this.circlePaint = paint5;
            paint5.setColor(2130706432);
            RLottieDrawable rLottieDrawable = new RLottieDrawable(C2797R.raw.fire_on, _UrlKt.FRAGMENT_ENCODE_SET + C2797R.raw.fire_on, AndroidUtilities.m1036dp(16.0f), AndroidUtilities.m1036dp(16.0f));
        ...
        public void setOnce() {
            this.once = true;
            this.oncePaint.setTextSize(AndroidUtilities.m1036dp(13.0f));
        ...
        public void onMeasure(int i, int i2) {
            ...
            float measuredWidth = getMeasuredWidth() - AndroidUtilities.m1036dp(35.0f);
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (i == NotificationCenter.updateMessageMedia) {
            if (this.currentMessageObject.getId() == ((TLRPC.Message) objArr[0]).f1271id) {
                if (this.isVideo && !this.videoWatchedOneTime) {
                    this.closeVideoAfterWatch = true;
                } else {
                    if (closePhoto(true, true)) {
    ...
    public void preparePlayer(File file) {
        ...
        if (this.videoPlayer == null) {
            C65881 c65881 = new VideoPlayer() { // from class: org.telegram.ui.SecretMediaViewer.1
                public C65881() {
                }

                @Override // org.telegram.p035ui.Components.VideoPlayer
            ...
            this.videoPlayer = c65881;
            c65881.setTextureView(this.videoTextureView);
            this.videoPlayer.setDelegate(new C65992(file));
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C65881 extends VideoPlayer {
        public C65881() {
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C65992 implements VideoPlayer.VideoPlayerDelegate {
        ...
        public void onStateChanged(boolean z, int i) {
            ...
            if (SecretMediaViewer.this.videoPlayer.isPlaying() && i != 4) {
                ...
                if (i == 4) {
                    ...
                    boolean z2 = SecretMediaViewer.this.closeVideoAfterWatch;
                    SecretMediaViewer secretMediaViewer = SecretMediaViewer.this;
                    if (z2) {
                        secretMediaViewer.closePhoto(true, !secretMediaViewer.ignoreDelete);
                    } else {
                        secretMediaViewer.videoPlayer.seekTo(0L);
    ...
    public void setParentActivity(final Activity activity) {
        ...
        C66013 c66013 = new FrameLayout(activity) { // from class: org.telegram.ui.SecretMediaViewer.3
            public C66013(final Context activity2) {
                super(activity2);
            }
        ...
        this.windowView = c66013;
        c66013.setBackgroundDrawable(this.photoBackgroundDrawable);
        ...
        this.containerView = new FrameLayoutDrawer(activity2) { // from class: org.telegram.ui.SecretMediaViewer.4
            public C66024(final Context activity2) {
                super(activity2);
            }
            ...
            public void onLayout(boolean z, int i2, int i3, int i4, int i5) {
                ...
                if (SecretMediaViewer.this.secretHint != null && SecretMediaViewer.this.secretDeleteTimer != null) {
                    int currentActionBarHeight2 = ((((ActionBar.getCurrentActionBarHeight() - SecretMediaViewer.this.secretDeleteTimer.getMeasuredHeight()) / 2) + AndroidUtilities.statusBarHeight) + SecretMediaViewer.this.secretDeleteTimer.getMeasuredHeight()) - AndroidUtilities.m1036dp(10.0f);
        ...
        C66035 c66035 = new ActionBar(activity2) { // from class: org.telegram.ui.SecretMediaViewer.5
            public C66035(final Context activity2) {
                super(activity2);
            }
        ...
        this.actionBar = c66035;
        c66035.setTitleColor(-1);
        ...
        this.actionBar.setTitleRightMargin(AndroidUtilities.m1036dp(70.0f));
        ...
        this.secretHint.setPadding(AndroidUtilities.m1036dp(8.0f), AndroidUtilities.m1036dp(8.0f), AndroidUtilities.m1036dp(8.0f), AndroidUtilities.m1036dp(8.0f));
        ...
        C66057 c66057 = new VideoPlayerSeekBar.SeekBarDelegate() { // from class: org.telegram.ui.SecretMediaViewer.7
            public C66057() {
            }
        ...
        C66068 c66068 = new View(activity2) { // from class: org.telegram.ui.SecretMediaViewer.8
            public C66068(final Context activity2) {
                super(activity2);
            }
        ...
        this.seekbarView = c66068;
        VideoPlayerSeekBar videoPlayerSeekBar = new VideoPlayerSeekBar(c66068);
        this.seekbar = videoPlayerSeekBar;
        videoPlayerSeekBar.setHorizontalPadding(AndroidUtilities.m1036dp(2.0f));
        this.seekbar.setColors(872415231, 872415231, -1, -1, -1, 1509949439);
        this.seekbar.setDelegate(c66057);
        ...
        C66079 c66079 = new TextSelectionHelper.SimpleTextSelectionHelper(null, new DarkThemeResourceProvider()) { // from class: org.telegram.ui.SecretMediaViewer.9
            @Override // org.telegram.p035ui.Cells.TextSelectionHelper
            public int getParentBottomPadding() {
                return 0;
            }

            public C66079(TextSelectionHelper.SimpleSelectabeleView simpleSelectabeleView, Theme.ResourcesProvider resourcesProvider) {
                super(simpleSelectabeleView, resourcesProvider);
            }
        };
        this.textSelectionHelper = c66079;
        c66079.allowScrollPrentRelative = true;
        c66079.useMovingOffset = false;
        ...
        imageView.setBackground(Theme.createCircleDrawable(AndroidUtilities.m1036dp(64.0f), 1711276032));
        ...
        this.playButton.setPivotX(AndroidUtilities.m1036dp(32.0f));
        this.playButton.setPivotY(AndroidUtilities.m1036dp(32.0f));
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C66013 extends FrameLayout {
        public C66013(final Activity activity2) {
            super(activity2);
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C66024 extends FrameLayoutDrawer {
        public C66024(final Activity activity2) {
            super(activity2);
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C66035 extends ActionBar {
        public C66035(final Activity activity2) {
            super(activity2);
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C66046 extends ActionBar.ActionBarMenuOnItemClick {
        public C66046() {
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C66057 implements VideoPlayerSeekBar.SeekBarDelegate {
        public C66057() {
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C66068 extends View {
        public C66068(final Activity activity2) {
            super(activity2);
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C66079 extends TextSelectionHelper.SimpleTextSelectionHelper {
        @Override // org.telegram.p035ui.Cells.TextSelectionHelper
        public int getParentBottomPadding() {
            return 0;
        }
    ...
    private void setCurrentCaption(MessageObject messageObject, CharSequence charSequence, boolean z, boolean z2) {
        ...
        if (this.captionScrollView == null) {
            ...
            C658910 c658910 = new PhotoViewer.CaptionScrollView(this.containerView.getContext(), this.captionTextViewSwitcher, this.captionContainer) { // from class: org.telegram.ui.SecretMediaViewer.10
                public C658910(Context context, PhotoViewer.CaptionTextViewSwitcher captionTextViewSwitcher, FrameLayout frameLayout2) {
            ...
            this.captionScrollView = c658910;
            this.captionTextViewSwitcher.setScrollView(c658910);
        ...
        if (z2) {
            ...
            TransitionSet duration = new TransitionSet().addTransition(new C659112(2, zIsEmpty2, zIsEmpty)).addTransition(new C659011(1, zIsEmpty2, zIsEmpty)).setDuration(200L);
            if (!zIsEmpty2) {
                this.captionScrollView.dontChangeTopMargin = true;
                duration.addTransition(new C659213());
            }
        ...
        if (!zIsEmpty) {
            ...
            this.captionTextViewSwitcher.setVisibility(4, !b2 == true || zIsEmpty2);
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C658910 extends PhotoViewer.CaptionScrollView {
        public C658910(Context context, PhotoViewer.CaptionTextViewSwitcher captionTextViewSwitcher, FrameLayout frameLayout2) {
            super(context, captionTextViewSwitcher, frameLayout2);
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C659011 extends Fade {
        final /* synthetic */ boolean val$isCaptionEmpty;
        final /* synthetic */ boolean val$isCurrentCaptionEmpty;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C659011(int i, boolean z, boolean z2) {
            super(i);
            this.val$isCurrentCaptionEmpty = z;
            this.val$isCaptionEmpty = z2;
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C659213 extends Transition {
        public C659213() {
        }
    ...
    public void showPlayButton(boolean z, boolean z2) {
        ...
        if (z2) {
            imageView.animate().scaleX(z3 ? 1.0f : 0.6f).scaleY(z3 ? 1.0f : 0.6f).alpha(z3 ? 1.0f : 0.0f).setDuration(340L).setInterpolator(CubicBezierInterpolator.EASE_OUT_QUINT).start();
            return;
        }
        imageView.setScaleX(z3 ? 1.0f : 0.6f);
    ...
    private void showSecretHint() {
        ...
        String string = LocaleController.getString(this.isVideo ? C2797R.string.VideoShownOnce : C2797R.string.PhotoShownOnce);
        ...
        this.secretHint.setIcon(C2797R.raw.fire_on);
    ...
    public void openMedia(final MessageObject messageObject, PhotoViewer.PhotoViewerProvider photoViewerProvider, final Runnable runnable, Runnable runnable2) {
        ...
        if (document != null) {
            ...
            while (true) {
                ...
                if (documentAttribute instanceof TLRPC.TL_documentAttributeVideo) {
                    ...
                    this.videoWidth = tL_documentAttributeVideo.f1256w;
                    this.videoHeight = tL_documentAttributeVideo.f1255h;
                    break;
                }
                i2++;
            }
            if (MessageObject.isGifDocument(document)) {
                this.actionBar.setTitle(LocaleController.getString(C2797R.string.DisappearingGif));
                ...
                this.actionBar.setTitle(LocaleController.getString(C2797R.string.DisappearingVideo));
            ...
            f2 = 1.0f;
            Object obj = null;
            this.actionBar.setTitle(LocaleController.getString(C2797R.string.DisappearingPhoto));
            ...
            if (closestPhotoSizeWithSize != null) {
                this.videoWidth = closestPhotoSizeWithSize.f1278w;
                this.videoHeight = closestPhotoSizeWithSize.f1277h;
                r14 = obj;
            }
        }
        ...
        if (z) {
            ...
            secretDeleteTimer.setOnClickListener(r14);
        }
        try {
        ...
        ObjectAnimator objectAnimatorOfFloat4 = ObjectAnimator.ofFloat(this, this.ANIMATION_VALUE, 0.0f, 1.0f);
        VideoPlayerControlFrameLayout videoPlayerControlFrameLayout = this.seekbarContainer;
        ObjectAnimator objectAnimatorOfFloat5 = ObjectAnimator.ofFloat(videoPlayerControlFrameLayout, videoPlayerControlFrameLayout.SEEKBAR_ALPHA, f2);
        ...
        animatorArr[c2] = objectAnimatorOfFloat4;
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C659314 extends AnimatorListenerAdapter {
        public C659314() {
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C659415 extends AnimatorListenerAdapter {
        public C659415() {
        }
    ...
    */
    public void onDraw(android.graphics.Canvas r23) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.SecretMediaViewer.onDraw(android.graphics.Canvas):void");
    }

    /* JADX INFO: renamed from: org.telegram.ui.SecretMediaViewer$16 */
    public class C659516 extends AnimationProperties.FloatProperty<SecretMediaViewer> {
        public C659516(String str) {
            super(str);
        }
    ...
    */
    public boolean closePhoto(boolean r26, boolean r27) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.SecretMediaViewer.closePhoto(boolean, boolean):boolean");
    }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C659617 extends AnimatorListenerAdapter {
        final /* synthetic */ PhotoViewer.PlaceProviderObject val$object;

        public C659617(PhotoViewer.PlaceProviderObject placeProviderObject) {
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C659718 extends AnimatorListenerAdapter {
        public C659718() {
        }
    ...
    */
    public boolean processTouchEvent(android.view.MotionEvent r13) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.SecretMediaViewer.processTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    */
    private void checkMinMax(boolean r6) {
        ...
        L2b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.SecretMediaViewer.checkMinMax(boolean):void");
    }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    public class C659819 extends AnimatorListenerAdapter {
        public C659819() {
        }
    ...
    public class C660020 extends AnimationProperties.FloatProperty<SecretMediaViewer> {
        public C660020(String str) {
            super(str);
        }
    ...
    */
    public boolean onDoubleTap(android.view.MotionEvent r10) {
        ...
        L99:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.SecretMediaViewer.onDoubleTap(android.view.MotionEvent):boolean");
    }
    ...
    public class VideoPlayerControlFrameLayout extends FrameLayout {
        ...
        public /* synthetic */ void lambda$new$0(DynamicAnimation dynamicAnimation, float f, float f2) {
            SecretMediaViewer.this.seekbar.setSize((int) (((getMeasuredWidth() - AndroidUtilities.m1036dp(16.0f)) - f) - (this.parentWidth > this.parentHeight ? AndroidUtilities.m1036dp(48.0f) : 0)), getMeasuredHeight());
        }
        ...
        public VideoPlayerControlFrameLayout(Context context) {
            ...
            this.SEEKBAR_ALPHA = new AnimationProperties.FloatProperty<VideoPlayerControlFrameLayout>("progress") { // from class: org.telegram.ui.SecretMediaViewer.VideoPlayerControlFrameLayout.1
                public C66091(String str) {
                    super(str);
                }
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (SecretMediaViewer.this.seekbar.onTouch(motionEvent.getAction(), motionEvent.getX() - AndroidUtilities.m1036dp(2.0f), motionEvent.getY())) {
        ...
        */
        ...
        public class C66091 extends AnimationProperties.FloatProperty<VideoPlayerControlFrameLayout> {
            public C66091(String str) {
                super(str);
            }
