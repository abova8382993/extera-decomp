...
public class FiltersSetupActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static class TextCell extends FrameLayout {
        ...
        public void onLayout(boolean z, int i, int i2, int i3, int i4) {
            ...
            if (LocaleController.isRTL) {
                iM1036dp = (getMeasuredWidth() - this.textView.getMeasuredWidth()) - AndroidUtilities.m1036dp(this.imageView.getVisibility() == 0 ? 64.0f : 23.0f);
            } else {
                iM1036dp = AndroidUtilities.m1036dp(this.imageView.getVisibility() == 0 ? 64.0f : 23.0f);
            }
            ...
            int iM1036dp2 = !LocaleController.isRTL ? AndroidUtilities.m1036dp(20.0f) : (i5 - this.imageView.getMeasuredWidth()) - AndroidUtilities.m1036dp(20.0f);
    ...
    public static class SuggestedFilterCell extends FrameLayout {
        ...
        @Override // android.widget.FrameLayout, android.view.View
        public void onMeasure(int i, int i2) {
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m1036dp(64.0f));
    ...
    public static class HintInnerCell extends FrameLayout {
        ...
        public HintInnerCell(Context context, int i, CharSequence charSequence) {
            ...
            this.messageTextView.setTypeface(AndroidUtilities.regular());
    ...
    public class FilterCell extends FrameLayout {
        ...
        public FilterCell(Context context) {
            ...
            imageView.setContentDescription(LocaleController.getString(C2797R.string.FilterReorder));
            ...
            SimpleTextView simpleTextView = new SimpleTextView(context);
            this.textView = simpleTextView;
            simpleTextView.setPadding(0, AndroidUtilities.m1036dp(4.0f), 0, AndroidUtilities.m1036dp(4.0f));
            ...
            final int iM1036dp = AndroidUtilities.m1036dp(1.0f);
            loadingDrawable.strokePaint.setStrokeWidth(iM1036dp);
            ...
            ImageView imageView2 = new ImageView(context) { // from class: org.telegram.ui.FiltersSetupActivity.FilterCell.1
                ...
                public void onDraw(Canvas canvas) {
                    ...
                    if (FilterCell.this.shareLoading) {
                        ...
                        int i3 = iM1036dp;
                        loadingDrawable2.setBounds(i3 / 2, i3 / 2, getWidth() - (iM1036dp / 2), getHeight() - (iM1036dp / 2));
            ...
            imageView2.setContentDescription(LocaleController.getString(C2797R.string.FilterShare));
            imageView2.setVisibility(8);
            imageView2.setImageResource(C2797R.drawable.msg_link_folder);
            imageView2.setColorFilter(new PorterDuffColorFilter(Theme.getColor(i), mode));
            ...
            imageView3.setImageResource(C2797R.drawable.msg_actions);
        ...
        */
        public void onDraw(android.graphics.Canvas r10) {
            /*
                ...
                goto L13
            Ld:
                int r0 = org.telegram.messenger.AndroidUtilities.m1036dp(r2)
                float r0 = (float) r0
                r4 = r0
            L13:
            ...
            L28:
                ...
                int r0 = r0 + (-1)
                float r7 = (float) r0
                android.graphics.Paint r8 = org.telegram.p035ui.ActionBar.Theme.dividerPaint
                r3 = r10
            ...
            L5f:
                ...
                org.telegram.ui.ActionBar.SimpleTextView r9 = r9.textView
                r9.invalidate()
                return
            */
    ...
    public void updateRows(boolean z) {
        ...
        if (recyclerListView != null) {
            ArrayList<Long> arrayList2 = recyclerListView.forcedSections;
            if (arrayList2 == null) {
        ...
        this.items.clear();
        ArrayList<TLRPC.TL_dialogFilterSuggested> arrayList3 = getMessagesController().suggestedFilters;
        ArrayList<MessagesController.DialogFilter> dialogFilters = getMessagesController().getDialogFilters();
        this.items.add(ItemInner.asHint());
        if (!arrayList3.isEmpty() && dialogFilters.size() < 10) {
            int size = this.items.size();
            this.items.add(ItemInner.asHeader(LocaleController.getString(C2797R.string.FilterRecommended)));
            if (ExteraConfig.getSectionsSeparatedHeaders()) {
                size = this.items.size();
            }
            for (int i = 0; i < arrayList3.size(); i++) {
                this.items.add(ItemInner.asSuggested(arrayList3.get(i)));
            }
        ...
        if (!dialogFilters.isEmpty()) {
            ...
            this.items.add(ItemInner.asHeader(LocaleController.getString(C2797R.string.Filters)));
            ...
            while (true) {
                ...
                arrayList.add(ItemInner.asFilter(dialogFilters.get(i2)));
                if (MessagesController.getInstance(this.currentAccount).folderTags && dialogFilters.get(i2).color >= 0) {
                    this.loadedColors = true;
                }
                i2++;
            }
            this.filtersSectionEnd = arrayList.size();
            int i3 = ExteraConfig.getSectionsSeparatedHeaders() ? this.filtersStartPosition : this.filtersSectionStart;
            RecyclerListView recyclerListView3 = this.listView;
            if (recyclerListView3 != null) {
                recyclerListView3.forcedSections.add(Long.valueOf(AndroidUtilities.pack(i3, (this.filtersSectionEnd - 1) + (dialogFilters.size() < getMessagesController().dialogFiltersLimitPremium ? 1 : 0))));
            }
        } else {
        ...
        if (dialogFilters.size() < getMessagesController().dialogFiltersLimitPremium) {
            this.items.add(ItemInner.asButton(LocaleController.getString(C2797R.string.CreateNewFilter)));
        }
        this.items.add(ItemInner.asShadow(null));
        this.folderTagsPosition = this.items.size();
        this.showTagsRow = this.items.size();
        this.items.add(ItemInner.asCheck(LocaleController.getString(C2797R.string.FolderShowTags)));
        this.items.add(ItemInner.asShadow(!getUserConfig().isPremium() ? AndroidUtilities.replaceSingleTag(LocaleController.getString(C2797R.string.FolderShowTagsInfoPremium), Theme.key_windowBackgroundWhiteBlueHeader, 2, new Runnable() { // from class: org.telegram.ui.FiltersSetupActivity$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$updateRows$0();
            }
        }) : LocaleController.getString(C2797R.string.FolderShowTagsInfo)));
    ...
    public void onFragmentDestroy() {
        ...
        if (this.orderChanged) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                tL_messages_updateDialogFiltersOrder.order.add(Integer.valueOf(dialogFilters.get(i2).f1156id));
            }
    ...
    public View createView(final Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2797R.string.Filters));
    ...
    public class C56382 extends RecyclerListView {
        public C56382(Context context) {
            super(context);
        }
    ...
    public static class ItemInner extends AdapterWithDiffUtils.Item {
        ...
        public boolean equals(Object obj) {
            ...
            if (i3 == 2) {
                ...
                if (dialogFilter != null && dialogFilter.f1156id != dialogFilter2.f1156id) {
                    return false;
                }
            }
            if (i3 == 5) {
                ...
                if (tL_dialogFilterSuggested != null && tL_dialogFilterSuggested.filter.f1252id != tL_dialogFilterSuggested2.filter.f1252id) {
                    return false;
                }
            }
            return true;
    ...
    public class ListAdapter extends AdapterWithDiffUtils {
        ...
        public /* synthetic */ void lambda$onCreateViewHolder$7(View view) {
            ...
            itemOptionsMakeOptions.add(C2797R.drawable.msg_edit, LocaleController.getString(C2797R.string.FilterEditItem), new Runnable() { // from class: org.telegram.ui.FiltersSetupActivity$ListAdapter$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onCreateViewHolder$1(currentFilter);
                }
            });
            itemOptionsMakeOptions.add(C2797R.drawable.msg_delete, (CharSequence) LocaleController.getString(C2797R.string.FilterDeleteItem), true, new Runnable() { // from class: org.telegram.ui.FiltersSetupActivity$ListAdapter$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public /* synthetic */ void lambda$onCreateViewHolder$1(MessagesController.DialogFilter dialogFilter) {
            ...
            if (z) {
                ...
                filtersSetupActivity.presentFragment(new FilterCreateActivity(dialogFilter));
            }
        }
        ...
        public /* synthetic */ void lambda$onCreateViewHolder$6(final MessagesController.DialogFilter dialogFilter) {
            ...
            FiltersSetupActivity filtersSetupActivity = FiltersSetupActivity.this;
            if (zIsChatlist) {
                FolderBottomSheet.showForDeletion(filtersSetupActivity, dialogFilter.f1156id, new Utilities.Callback() { // from class: org.telegram.ui.FiltersSetupActivity$ListAdapter$$ExternalSyntheticLambda6
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(filtersSetupActivity.getParentActivity());
            ...
            builder.setPositiveButton(LocaleController.getString(C2797R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.FiltersSetupActivity$ListAdapter$$ExternalSyntheticLambda7
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                headerCell = new HintInnerCell(this.mContext, C2797R.raw.filters, AndroidUtilities.replaceTags(LocaleController.formatString(C2797R.string.CreateNewFilterInfo, new Object[0])));
            } else if (i == 2) {
        ...
        public /* synthetic */ void lambda$onCreateViewHolder$9(SuggestedFilterCell suggestedFilterCell, View view) {
            ...
            dialogFilter.f1156id = 2;
            while (FiltersSetupActivity.this.getMessagesController().dialogFiltersById.get(dialogFilter.f1156id) != null) {
                dialogFilter.f1156id++;
            }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType != 4) {
                if (itemViewType == 5) {
                    ...
                    textCheckCell.setCheckBoxIcon(FiltersSetupActivity.this.getUserConfig().isPremium() ? 0 : C2797R.drawable.permission_locked);
                    return;
                }
            }
