...
import org.telegram.p035ui.Components.Premium.boosts.GiftInfoBottomSheet;
...
public class BoostsActivity extends GradientHeaderActivity implements NotificationCenter.NotificationCenterDelegate {
    ...
    AdapterWithDiffUtils adapter = new AdapterWithDiffUtils() { // from class: org.telegram.ui.BoostsActivity.1
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            switch (i) {
                case 0:
                    shadowSectionCell = new StatisticActivity.OverviewCell(BoostsActivity.this.getContext());
                    break;
                case 1:
                case 16:
                ...
                default:
                    ...
                    return null;
                case 5:
                    shadowSectionCell = new GiftedUserCell(BoostsActivity.this.getContext(), 0, 0, false);
                    break;
                case 6:
                    shadowSectionCell = new TextInfoPrivacyCell(viewGroup.getContext(), 20, ((BaseFragment) BoostsActivity.this).resourceProvider);
                    break;
                case 7:
                    shadowSectionCell = new FixedHeightEmptyCell(BoostsActivity.this.getContext(), 8);
                    break;
                case 8:
                    ...
                    textView.setText(LocaleController.getString(BoostsActivity.this.isChannel() ? C2797R.string.NoBoostersHint : C2797R.string.NoBoostersGroupHint));
                ...
                case 10:
                    ...
                    textCell.setTextAndIcon((CharSequence) LocaleController.formatString(C2797R.string.BoostingGetBoostsViaGifts, new Object[0]), C2797R.drawable.msg_gift_premium, false);
                    ...
                    break;
                case 11:
                    shadowSectionCell = new GiveawayCell(BoostsActivity.this.getContext(), 0, 0, false);
                    break;
                case 12:
                ...
                case 14:
                    ...
                    shadowSectionCell = boostsActivity.getHeader(boostsActivity.getContext());
                    break;
                case 15:
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (viewHolder.getItemViewType() == 1 || viewHolder.getItemViewType() == 12 || viewHolder.getItemViewType() == 16) {
                ...
                if (viewHolder.getItemViewType() == 12) {
                    chartHeaderView.setPadding(AndroidUtilities.m1036dp(3.0f), chartHeaderView.getPaddingTop(), chartHeaderView.getPaddingRight(), chartHeaderView.getPaddingBottom());
                    return;
                }
                return;
            }
            if (viewHolder.getItemViewType() == 0) {
                ...
                overviewCell.setData(0, Integer.toString(BoostsActivity.this.boostsStatus.level), null, LocaleController.getString(C2797R.string.BoostsLevel2));
                if (BoostsActivity.this.boostsStatus.premium_audience == null || BoostsActivity.this.boostsStatus.premium_audience.total == 0.0d) {
                    overviewCell.setData(1, "~0", "0%", LocaleController.getString(BoostsActivity.this.isChannel() ? C2797R.string.PremiumSubscribers : C2797R.string.PremiumMembers));
                } else {
                    overviewCell.setData(1, "≈" + ((int) BoostsActivity.this.boostsStatus.premium_audience.part), String.format(Locale.US, "%.1f", Float.valueOf((((float) BoostsActivity.this.boostsStatus.premium_audience.part) / ((float) BoostsActivity.this.boostsStatus.premium_audience.total)) * 100.0f)).concat("%"), LocaleController.getString(BoostsActivity.this.isChannel() ? C2797R.string.PremiumSubscribers : C2797R.string.PremiumMembers));
                }
                overviewCell.setData(2, String.valueOf(BoostsActivity.this.boostsStatus.boosts), null, LocaleController.getString(C2797R.string.BoostsExisting));
                overviewCell.setData(3, String.valueOf(Math.max(0, BoostsActivity.this.boostsStatus.next_level_boosts - BoostsActivity.this.boostsStatus.boosts)), null, LocaleController.getString(C2797R.string.BoostsToLevel));
                overviewCell.setPadding(AndroidUtilities.m1036dp(23.0f), overviewCell.getPaddingTop(), AndroidUtilities.m1036dp(23.0f), overviewCell.getPaddingBottom());
                return;
            }
            if (viewHolder.getItemViewType() == 5) {
                ...
                if (i2 > 1) {
                    string = LocaleController.formatString("BoostsExpireOn", C2797R.string.BoostsExpireOn, LocaleController.formatDate(i3));
                } else {
                    string = LocaleController.formatString("BoostExpireOn", C2797R.string.BoostExpireOn, LocaleController.formatDate(i3));
                }
            ...
            if (viewHolder.getItemViewType() == 9) {
                ...
                int i4 = BoostsActivity.this.selectedTab;
                BoostsActivity boostsActivity = BoostsActivity.this;
                if (i4 == 0) {
                    manageChatTextCell.setText(LocaleController.formatPluralString("BoostingShowMoreBoosts", boostsActivity.nextBoostRemaining, new Object[0]), null, C2797R.drawable.arrow_more, false);
                    return;
                } else {
                    manageChatTextCell.setText(LocaleController.formatPluralString("BoostingShowMoreGifts", boostsActivity.nextGiftsRemaining, new Object[0]), null, C2797R.drawable.arrow_more, false);
                    return;
                }
            }
    ...
    public void updateRows(boolean z) {
        ...
        if (this.boostsStatus != null) {
            this.items.add(new ItemInternal(16, LocaleController.getString(C2797R.string.StatisticOverview)));
    ...
    public void createEmptyView(Context context) {
        ...
        this.progressLayout.addView(new View(context) { // from class: org.telegram.ui.BoostsActivity.3
            private final CircularProgressDrawable drawable = new CircularProgressDrawable(AndroidUtilities.m1036dp(30.0f), AndroidUtilities.m1036dp(3.0f), Theme.getColor(Theme.key_dialogTextBlue));
    ...
    private void resetHeader(boolean z) {
        ...
        if (this.limitPreviewView == null) {
            LimitPreviewView limitPreviewView = new LimitPreviewView(getContext(), C2797R.drawable.filled_limit_boost, 0, 0, this.resourceProvider);
        ...
        configureHeader(LocaleController.getString(isChannel() ? C2797R.string.BoostingBoostForChannels : C2797R.string.BoostingBoostForGroups), AndroidUtilities.replaceTags(LocaleController.getString(isChannel() ? C2797R.string.BoostingBoostForChannelsInfo : C2797R.string.BoostingBoostForGroupsInfo)), new FrameLayout(getContext()) { // from class: org.telegram.ui.BoostsActivity.4
            {
        ...
        }, new C31535(getContext()));
    }

    /* JADX INFO: renamed from: org.telegram.ui.BoostsActivity$5 */
    public class C31535 extends FrameLayout {
        ...
        public C31535(Context context) {
            ...
            headerButtonView.setTextAndIcon(LocaleController.getString(C2797R.string.BoostBtn), C2797R.drawable.filled_boost_plus);
            headerButtonView2.setTextAndIcon(LocaleController.getString(C2797R.string.GiveawayBtn), C2797R.drawable.filled_gift_premium);
            headerButtonView3.setTextAndIcon(LocaleController.getString(C2797R.string.FeaturesBtn), C2797R.drawable.filled_info);
    ...
    public class HeaderButtonView extends FrameLayout {
        ...
        public HeaderButtonView(Context context) {
            ...
            setMinimumWidth(AndroidUtilities.m1036dp(100.0f));
            setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1036dp(10.0f), 0, ColorUtils.setAlphaComponent(-16777216, 80)));
        }
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.drawRoundRect(this.rect, AndroidUtilities.m1036dp(10.0f), AndroidUtilities.m1036dp(10.0f), BoostsActivity.this.setDarkGradientLocation(((ViewGroup) getParent()).getX() + getX(), ((ViewGroup) getParent().getParent().getParent()).getY()));
            invalidate();
            super.draw(canvas);
        }
    }
    ...
    public /* synthetic */ void lambda$createView$12(Context context, View view, int i) {
        ...
        if (view instanceof GiftedUserCell) {
            ...
            if (z && boost.stars > 0) {
                ...
                if (((z2 || z) && boost.user_id >= 0) || boost.unclaimed) {
                    ...
                    tL_payments_checkedGiftCode.from_id = MessagesController.getInstance(UserConfig.selectedAccount).getPeer(-this.currentChat.f1245id);
                    int i2 = boost.date;
                    ...
                    lottieLayout.setAnimation(C2797R.raw.chats_infotip, 36, 36, new String[0]);
                    lottieLayout.textView.setText(LocaleController.getString(C2797R.string.BoostingRecipientWillBeSelected));
                    lottieLayout.textView.setSingleLine(false);
                    lottieLayout.textView.setMaxLines(2);
                    Bulletin.make(this, lottieLayout, 2750).show();
                } else if (!z2 && !z) {
                    presentFragment(ProfileActivity.m1186of(giftedUserCell.getDialogId()));
                }
            }
            boostsActivity = this;
        } else {
        ...
        if (view instanceof TextCell) {
            BoostPagerBottomSheet.show(boostsActivity, boostsActivity.dialogId, boostsActivity.resourceProvider);
        }
        if (view instanceof GiveawayCell) {
            BoostPagerBottomSheet.show(boostsActivity, boostsActivity.resourceProvider, boostsActivity.dialogId, ((GiveawayCell) view).getPrepaidGiveaway());
        }
        if (boostsActivity.items.get(i).viewType == 9) {
            boostsActivity.loadUsers(Boolean.valueOf(boostsActivity.selectedTab == 1));
        }
    }
}
