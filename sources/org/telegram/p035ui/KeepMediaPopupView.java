...
public class KeepMediaPopupView extends ActionBarPopupWindow.ActionBarPopupWindowLayout {
    ...
    public KeepMediaPopupView(final BaseFragment baseFragment, Context context) {
        ...
        setFitItems(true);
        this.oneDay = ActionBarMenuItem.addItem(this, C2797R.drawable.msg_autodelete_1d, LocaleController.formatPluralString("Days", 1, new Object[0]), false, null);
        this.twoDay = ActionBarMenuItem.addItem(this, C2797R.drawable.msg_autodelete_2d, LocaleController.formatPluralString("Days", 2, new Object[0]), false, null);
        this.oneWeek = ActionBarMenuItem.addItem(this, C2797R.drawable.msg_autodelete_1w, LocaleController.formatPluralString("Weeks", 1, new Object[0]), false, null);
        this.oneMonth = ActionBarMenuItem.addItem(this, C2797R.drawable.msg_autodelete_1m, LocaleController.formatPluralString("Months", 1, new Object[0]), false, null);
        this.forever = ActionBarMenuItem.addItem(this, C2797R.drawable.msg_cancel, LocaleController.getString(C2797R.string.AutoDeleteMediaNever), false, null);
        ActionBarMenuSubItem actionBarMenuSubItemAddItem = ActionBarMenuItem.addItem(this, C2797R.drawable.msg_delete, LocaleController.getString(C2797R.string.DeleteException), false, null);
        ...
        view.setBackground(Theme.getThemedDrawableByKey(context, C2797R.drawable.greydivider, Theme.key_windowBackgroundGrayShadow, null));
        this.gap.addView(view, LayoutHelper.createFrame(-1, -1.0f));
        this.gap.setTag(C2797R.id.fit_width_tag, 1);
        ...
        linksTextView.setText(LocaleController.getString(C2797R.string.KeepMediaPopupDescription));
    ...
    public /* synthetic */ boolean lambda$new$1(DialogsActivity dialogsActivity, DialogsActivity dialogsActivity2, ArrayList arrayList, CharSequence charSequence, boolean z, boolean z2, int i, int i2, TopicsFragment topicsFragment) {
        ...
        final C58851 c58851 = new CacheChatsExceptionsFragment(bundle) { // from class: org.telegram.ui.KeepMediaPopupView.1
            final /* synthetic */ DialogsActivity val$activity;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C58851(Bundle bundle2, DialogsActivity dialogsActivity3) {
                super(bundle2);
        ...
        c58851.setExceptions(this.exceptions);
        this.parentFragment.presentFragment(c58851);
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.KeepMediaPopupView$$ExternalSyntheticLambda3
            ...
            public final void run() {
                c58851.showPopupFor(keepMediaException);
            }
        }, 150L);
        return true;
    }
    ...
    public class C58851 extends CacheChatsExceptionsFragment {
        final /* synthetic */ DialogsActivity val$activity;
    ...
    public void update(int i) {
        ...
        if (keepMediaExceptions.isEmpty()) {
            this.exceptionsView.titleView.setText(LocaleController.getString(C2797R.string.AddAnException));
            this.exceptionsView.titleView.setRightPadding(AndroidUtilities.m1036dp(8.0f));
            ...
            this.exceptionsView.titleView.setRightPadding(AndroidUtilities.m1036dp((Math.max(0, iMin - 1) * 12) + 64));
            ...
            int i2 = 0;
            while (true) {
                exceptionsView = this.exceptionsView;
                if (i2 >= iMin) {
                    break;
                }
                exceptionsView.avatarsImageView.setObject(i2, this.parentFragment.getCurrentAccount(), this.parentFragment.getMessagesController().getUserOrChat(this.exceptions.get(i2).dialogId));
                i2++;
            }
    ...
    public class ExceptionsView extends FrameLayout {
        ...
        public ExceptionsView(Context context) {
            ...
            this.titleView.setRightPadding(AndroidUtilities.m1036dp(68.0f));
            ...
            this.avatarsImageView.setAvatarsTextSize(AndroidUtilities.m1036dp(22.0f));
    ...
    public void updateAvatarsPosition() {
        if (this.exceptions != null) {
            this.exceptionsView.avatarsImageView.setTranslationX(AndroidUtilities.m1036dp(12.0f) * (3 - Math.min(3, this.exceptions.size())));
        }
    }
    ...
    public static class CheckItem {
        ...
        public /* synthetic */ CheckItem(ActionBarMenuSubItem actionBarMenuSubItem, int i, KeepMediaPopupViewIA keepMediaPopupViewIA) {
