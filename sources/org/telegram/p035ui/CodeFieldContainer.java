...
public abstract class CodeFieldContainer extends LinearLayout {
    ...
    public void onMeasure(int i, int i2) {
        ...
        float fM1036dp = AndroidUtilities.m1036dp(1.5f);
        this.strokeWidth = fM1036dp;
        paint.setStrokeWidth(fM1036dp);
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (childAt instanceof CodeNumberField) {
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.m1036dp(4.0f), AndroidUtilities.m1036dp(4.0f), this.paint);
            }
        }
    ...
    */
    public void setNumbersCount(int r13, int r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.CodeFieldContainer.setNumbersCount(int, int):void");
    }

    /* JADX INFO: renamed from: org.telegram.ui.CodeFieldContainer$1 */
    public class C36991 extends CodeNumberField {
        final /* synthetic */ int val$length;
        final /* synthetic */ int val$num;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C36991(Context context, int i, int i2) {
            super(context);
            i = i;
            i = i2;
        }
        ...
        public boolean dispatchKeyEvent(KeyEvent keyEvent) {
                ...
                if (keyCode >= 7 && keyCode <= 16) {
                    ...
                    if (CodeFieldContainer.this.codeField[i].getText() != null && string.equals(CodeFieldContainer.this.codeField[i].getText().toString())) {
                        ...
                        if (i3 >= i4) {
                            ...
                            codeFieldContainer.codeField[i3 + 1].requestFocus();
                        }
                        return true;
                    }
            ...
            while (true) {
                ...
                if (i2 < i5) {
                    int i6 = i5 - 1;
                    CodeFieldContainer codeFieldContainer2 = CodeFieldContainer.this;
                    if (i2 == i6) {
                        codeFieldContainer2.codeField[i5 - 1].requestFocus();
                    } else {
                        codeFieldContainer2.codeField[i2].clearFocus();
                    }
                    i2++;
                } else {
                    CodeFieldContainer.this.codeField[i5 - 1].startExitAnimation();
    ...
    public class C37002 implements TextWatcher {
        final /* synthetic */ int val$length;
        final /* synthetic */ int val$num;
