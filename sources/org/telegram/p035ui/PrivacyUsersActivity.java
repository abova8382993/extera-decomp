...
public class PrivacyUsersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        if (i == 1) {
            this.actionBar.setTitle(LocaleController.getString(C2797R.string.BlockedUsers));
        } else if (i == 2) {
            boolean z = this.isAlwaysShare;
            ActionBar actionBar = this.actionBar;
            if (z) {
                actionBar.setTitle(LocaleController.getString(C2797R.string.FilterAlwaysShow));
            } else {
                actionBar.setTitle(LocaleController.getString(C2797R.string.FilterNeverShow));
            }
        } else {
            boolean z2 = this.isGroup;
            boolean z3 = this.isAlwaysShare;
            if (z2) {
                ActionBar actionBar2 = this.actionBar;
                if (z3) {
                    actionBar2.setTitle(LocaleController.getString(C2797R.string.AlwaysAllow));
                } else {
                    actionBar2.setTitle(LocaleController.getString(C2797R.string.NeverAllow));
                }
            } else {
                ActionBar actionBar3 = this.actionBar;
                if (z3) {
                    actionBar3.setTitle(LocaleController.getString(C2797R.string.AlwaysShareWithTitle));
                } else {
        ...
        if (this.currentType == 1) {
            emptyTextProgressView.setText(LocaleController.getString(C2797R.string.NoBlocked));
        } else {
        ...
        if (this.currentType == 1) {
            ...
            int i2 = getMessagesController().totalBlockedCount;
    ...
    /* JADX INFO: renamed from: org.telegram.ui.PrivacyUsersActivity$1 */
    public class C64531 extends ActionBar.ActionBarMenuOnItemClick {
        public C64531() {
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.PrivacyUsersActivity$2 */
    public class C64542 extends RecyclerView.OnScrollListener {
        public C64542() {
        }
    ...
    public void showUnblockAlert(final Long l, View view) {
        ...
        int i = this.currentType;
        itemOptionsAddIf.addIf(i != 1, i == 0 ? C2797R.drawable.msg_user_remove : 0, (CharSequence) LocaleController.getString(C2797R.string.Remove), true, new Runnable() { // from class: org.telegram.ui.PrivacyUsersActivity$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                textCell.setText(LocaleController.getString(C2797R.string.NotificationsDeleteAllException), false);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType != 0) {
                if (itemViewType == 1) {
                    ...
                    int i2 = PrivacyUsersActivity.this.blockUserDetailRow;
                    PrivacyUsersActivity privacyUsersActivity = PrivacyUsersActivity.this;
                    if (i == i2) {
                        if (privacyUsersActivity.currentType == 1) {
                            textInfoPrivacyCell.setFixedSize(0);
                            textInfoPrivacyCell.setText(LocaleController.getString(C2797R.string.BlockedUsersInfo));
                            return;
                        } else {
                ...
                if (itemViewType == 2) {
                    ...
                    if (PrivacyUsersActivity.this.currentType == 1) {
                        manageChatTextCell.setText(LocaleController.getString(C2797R.string.BlockUser), null, C2797R.drawable.msg_contact_add, false);
                        return;
                    } else {
                        manageChatTextCell.setText(LocaleController.getString(C2797R.string.PrivacyAddAnException), null, C2797R.drawable.msg_contact_add, PrivacyUsersActivity.this.uidArray.size() > 0);
                        return;
                    }
                }
                if (itemViewType != 3) {
                ...
                if (i == PrivacyUsersActivity.this.usersHeaderRow) {
                    if (PrivacyUsersActivity.this.currentType == 1) {
                        ...
                        headerCell.setText(LocaleController.getString(C2797R.string.PrivacyExceptions));
                        return;
                    }
                }
                return;
            ...
            int i3 = PrivacyUsersActivity.this.currentType;
            PrivacyUsersActivity privacyUsersActivity2 = PrivacyUsersActivity.this;
            if (i3 == 1) {
                jLongValue = privacyUsersActivity2.getMessagesController().blockePeers.keyAt(i - PrivacyUsersActivity.this.usersStartRow);
            } else {
                jLongValue = ((Long) privacyUsersActivity2.uidArray.get(i - PrivacyUsersActivity.this.usersStartRow)).longValue();
            }
            manageChatUserCell.setTag(Long.valueOf(jLongValue));
            PrivacyUsersActivity privacyUsersActivity3 = PrivacyUsersActivity.this;
            if (jLongValue > 0) {
                TLRPC.User user = privacyUsersActivity3.getMessagesController().getUser(Long.valueOf(jLongValue));
                if (user != null) {
                    if (user.bot) {
                        string2 = LocaleController.getString(C2797R.string.Bot).substring(0, 1).toUpperCase() + LocaleController.getString(C2797R.string.Bot).substring(1);
                    } else {
                        String str = user.phone;
                        if (str != null && str.length() != 0) {
                            string2 = PhoneFormat.getInstance().format("+" + user.phone);
                        } else {
                            string2 = LocaleController.getString(C2797R.string.NumberUnknown);
                        }
                    }
            ...
            TLRPC.Chat chat = privacyUsersActivity3.getMessagesController().getChat(Long.valueOf(-jLongValue));
            if (chat != null) {
                int i4 = chat.participants_count;
                if (i4 != 0) {
                    string = LocaleController.formatPluralString("Members", i4, new Object[0]);
                } else if (chat.has_geo) {
                    string = LocaleController.getString(C2797R.string.MegaLocation);
