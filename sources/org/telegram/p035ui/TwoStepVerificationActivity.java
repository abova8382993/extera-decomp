...
public class TwoStepVerificationActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public android.view.View createView(android.content.Context r31) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.TwoStepVerificationActivity.createView(android.content.Context):android.view.View");
    }

    /* JADX INFO: renamed from: org.telegram.ui.TwoStepVerificationActivity$1 */
    public class C73561 extends ActionBar.ActionBarMenuOnItemClick {
        public C73561() {
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.TwoStepVerificationActivity$2 */
    public class C73572 implements TextWatcher {
    ...
    public /* synthetic */ void lambda$createView$7(View view, int i) {
        ...
        if (i == this.turnPasswordOffRow) {
            ...
            String string2 = LocaleController.getString(C2797R.string.TurnPasswordOffQuestionTitle);
            String string3 = LocaleController.getString(C2797R.string.Disable);
    ...
    /* JADX INFO: renamed from: org.telegram.ui.TwoStepVerificationActivity$3 */
    public class C73583 extends RadialProgressView {
        public C73583(Context context) {
            super(context);
        }
    ...
    */
    public void onConfigurationChanged(android.content.res.Configuration r2) {
        /*
            ...
            org.telegram.ui.Components.RLottieImageView r1 = r1.lockImageView
            boolean r2 = org.telegram.messenger.AndroidUtilities.isSmallScreen()
            if (r2 != 0) goto L1c
        ...
        L1e:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.TwoStepVerificationActivity.onConfigurationChanged(android.content.res.Configuration):void");
    }
    ...
    private void cancelPasswordReset() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
        builder.setPositiveButton(LocaleController.getString(C2797R.string.CancelPasswordResetYes), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.TwoStepVerificationActivity$$ExternalSyntheticLambda15
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
                this.f$0.lambda$cancelPasswordReset$10(alertDialog, i);
            }
        });
        builder.setNegativeButton(LocaleController.getString(C2797R.string.CancelPasswordResetNo), null);
        builder.setTitle(LocaleController.getString(C2797R.string.CancelReset));
        builder.setMessage(LocaleController.getString(C2797R.string.CancelPasswordReset));
    ...
    public /* synthetic */ void lambda$resetPassword$12(TLObject tLObject) {
        ...
        if (tLObject instanceof TL_account.resetPasswordOk) {
            ...
            builder.setMessage(LocaleController.getString(C2797R.string.RestorePasswordResetPasswordOk));
        ...
        if (tLObject instanceof TL_account.resetPasswordRequestedWait) {
            ...
            showAlertWithText(LocaleController.getString(C2797R.string.ResetPassword), LocaleController.formatString("ResetPasswordWait", C2797R.string.ResetPasswordWait, pluralString));
        }
    }
    ...
    */
    public void updateBottomButton() {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.TwoStepVerificationActivity.updateBottomButton():void");
    }
    ...
    private void onPasswordForgot() {
        ...
        if (this.currentPassword.pending_reset_date != 0) {
            if (getConnectionsManager().getCurrentTime() > this.currentPassword.pending_reset_date) {
                AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                builder.setPositiveButton(LocaleController.getString(C2797R.string.Reset), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.TwoStepVerificationActivity$$ExternalSyntheticLambda2
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                    public final void onClick(AlertDialog alertDialog, int i) {
                ...
                builder.setNegativeButton(LocaleController.getString(C2797R.string.Cancel), null);
                builder.setTitle(LocaleController.getString(C2797R.string.ResetPassword));
                builder.setMessage(LocaleController.getString(C2797R.string.RestorePasswordResetPasswordText));
                AlertDialog alertDialogCreate = builder.create();
                showDialog(alertDialogCreate);
                TextView textView = (TextView) alertDialogCreate.getButton(-1);
                if (textView != null) {
        ...
        builder2.setPositiveButton(LocaleController.getString(C2797R.string.Reset), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.TwoStepVerificationActivity$$ExternalSyntheticLambda3
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
        ...
        builder2.setTitle(LocaleController.getString(C2797R.string.ResetPassword));
        builder2.setMessage(LocaleController.getString(C2797R.string.RestorePasswordNoEmailText2));
    ...
    public /* synthetic */ void lambda$onPasswordForgot$14(TLRPC.TL_error tL_error, TLObject tLObject) {
        ...
        if (tL_error == null) {
            ...
            C73594 c73594 = new TwoStepVerificationSetupActivity(this.currentAccount, 4, password) { // from class: org.telegram.ui.TwoStepVerificationActivity.4
                public C73594(int i, int i2, TL_account.Password password2) {
                    super(i, i2, password2);
                }

                @Override // org.telegram.p035ui.TwoStepVerificationSetupActivity
                public void onReset() {
                    TwoStepVerificationActivity.this.resetPasswordOnShow = true;
                }
            };
            c73594.addFragmentToClose(this);
            c73594.setCurrentPasswordParams(this.currentPasswordHash, this.currentSecretId, this.currentSecret, false);
            presentFragment(c73594);
            return;
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.TwoStepVerificationActivity$4 */
    public class C73594 extends TwoStepVerificationSetupActivity {
        public C73594(int i, int i2, TL_account.Password password2) {
            super(i, i2, password2);
        }
    ...
    public static void initPasswordNewAlgo(TL_account.Password password) {
        ...
        if (passwordKdfAlgo instanceof TLRPC.C2891xb6caa888) {
            TLRPC.C2891xb6caa888 c2891xb6caa888 = (TLRPC.C2891xb6caa888) passwordKdfAlgo;
            byte[] bArr = new byte[c2891xb6caa888.salt1.length + 32];
            Utilities.random.nextBytes(bArr);
            byte[] bArr2 = c2891xb6caa888.salt1;
            System.arraycopy(bArr2, 0, bArr, 0, bArr2.length);
            c2891xb6caa888.salt1 = bArr;
        }
    ...
    private void updateRows() {
        ...
        if (this.fragmentView != null) {
            ...
            if (this.passwordEditText != null) {
                ...
                updateBottomButton();
                this.bottomTextView.setVisibility(8);
                boolean zIsEmpty = TextUtils.isEmpty(this.currentPassword.hint);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType != 0) {
                ...
                if (i == TwoStepVerificationActivity.this.setPasswordDetailRow) {
                    textInfoPrivacyCell.setText(LocaleController.getString(C2797R.string.SetAdditionalPasswordInfo));
                    return;
                } else {
                    if (i == TwoStepVerificationActivity.this.passwordEnabledDetailRow) {
                        textInfoPrivacyCell.setText(LocaleController.getString(C2797R.string.EnabledPasswordText));
                        return;
                    }
                    return;
                }
            ...
            if (i == TwoStepVerificationActivity.this.changePasswordRow) {
                textSettingsCell.setText(LocaleController.getString(C2797R.string.ChangePassword), true);
                return;
            }
            if (i == TwoStepVerificationActivity.this.setPasswordRow) {
                textSettingsCell.setText(LocaleController.getString(C2797R.string.SetAdditionalPassword), true);
                return;
            }
            if (i == TwoStepVerificationActivity.this.turnPasswordOffRow) {
                textSettingsCell.setText(LocaleController.getString(C2797R.string.TurnPasswordOff), true);
            } else if (i == TwoStepVerificationActivity.this.changeRecoveryEmailRow) {
                textSettingsCell.setText(LocaleController.getString(C2797R.string.ChangeRecoveryEmail), false);
            } else if (i == TwoStepVerificationActivity.this.setRecoveryEmailRow) {
                textSettingsCell.setText(LocaleController.getString(C2797R.string.SetRecoveryEmail), false);
            }
        }
    ...
    public void showSetForcePasswordAlert() {
        ...
        builder.setNegativeButton(LocaleController.getString(C2797R.string.ForceSetPasswordCancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.TwoStepVerificationActivity$$ExternalSyntheticLambda0
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
