            ...
            while (i3 < this.lines.size()) {
                ...
                if (lineViewData.enabled || lineViewData.alpha != 0.0f) {
                    ...
                    if (i8 == 2) {
                        ...
                        canvas.scale((f10 * 2.0f) + 1.0f, 1.0f, transitionParams.f1519pX, transitionParams.f1520pY);
                        f = f11;
                    } else if (i8 == 1) {
                        ...
                        canvas.scale(f14, transitionParams2.needScaleY ? f14 : 1.0f, transitionParams2.f1519pX, transitionParams2.f1520pY);
                        f = f13;
                    } else if (i8 == 3) {
                        f = this.transitionParams.progress;
                    }
                    lineViewData.paint.setAlpha((int) (lineViewData.alpha * 255.0f * f));
                    int i9 = this.endXIndex - this.startXIndex;
        ...
        if (this.chartData != 0) {
            ...
            while (i3 < size) {
                ...
                if (lineViewData.enabled || lineViewData.alpha != 0.0f) {
                    ...
                    long[] jArr2 = lineViewData.line.f1518y;
                    lineViewData.chartPath.reset();
                    int i4 = 0;
                    int i5 = 0;
                    while (i4 < length) {
                        ...
                        if (j < 0) {
                            ...
                            T t = this.chartData;
                            float f5 = t.xPercentage[i4] * this.pickerWidth;
