...
import org.telegram.p035ui.Charts.view_data.PieLegendView;
...
public class PieChartView extends StackLinearChartView<PieChartViewData> {
    ...
    public PieChartView(Context context) {
        ...
        this.MIN_TEXT_SIZE = AndroidUtilities.m1036dp(9.0f);
        this.MAX_TEXT_SIZE = AndroidUtilities.m1036dp(13.0f);
    ...
    @Override // org.telegram.p035ui.Charts.StackLinearChartView, org.telegram.p035ui.Charts.BaseChartView
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void drawChart(android.graphics.Canvas r26) {
        /*
            Method dump skipped, instruction units count: 860
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Charts.PieChartView.drawChart(android.graphics.Canvas):void");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void drawPickerChart(android.graphics.Canvas r22) {
        /*
            Method dump skipped, instruction units count: 300
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Charts.PieChartView.drawPickerChart(android.graphics.Canvas):void");
    }
    ...
    public void selectXOnChart(int i, int i2) {
        ...
        float degrees = (float) (Math.toDegrees(Math.atan2((this.chartArea.centerY() + AndroidUtilities.m1036dp(16.0f)) - i2, this.chartArea.centerX() - i)) - 90.0d);
        float f = 0.0f;
        if (degrees < 0.0f) {
        ...
        if (this.currentSelection != i3 && i3 >= 0) {
            ...
            if (this.pieLegendView.getMeasuredWidth() + measuredWidth > getMeasuredWidth() - AndroidUtilities.m1036dp(16.0f)) {
                measuredWidth -= (this.pieLegendView.getMeasuredWidth() + measuredWidth) - (getMeasuredWidth() - AndroidUtilities.m1036dp(16.0f));
            }
            int iMin2 = ((int) Math.min(this.rectF.centerY(), (int) Math.min(((double) this.rectF.centerY()) + (Math.sin(Math.toRadians(r14)) * dWidth), ((double) this.rectF.centerY()) + (dWidth * Math.sin(Math.toRadians(r9)))))) - AndroidUtilities.m1036dp(50.0f);
    ...
    @Override // org.telegram.p035ui.Charts.StackLinearChartView, org.telegram.p035ui.Charts.BaseChartView, android.view.View
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (getMeasuredWidth() != this.oldW) {
            ...
            float fWidth = this.chartArea.width();
            float fHeight = this.chartArea.height();
            RectF rectF = this.chartArea;
            int iHeight = (int) ((fWidth > fHeight ? rectF.height() : rectF.width()) * 0.45f);
    ...
    public void updatePicker(ChartData chartData, long j) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            if (j2 >= chartData.f1516x[i2]) {
                i = i2;
            }
        }
        float length2 = chartData.xPercentage.length < 2 ? 0.5f : 1.0f / chartData.f1516x.length;
        if (i == 0) {
        ...
        int length3 = chartData.f1516x.length - 1;
        ...
        float f = i * length2;
        chartPickerDelegate2.pickerStart = f;
        float f2 = f + length2;
        chartPickerDelegate2.pickerEnd = f2;
        if (f2 > 1.0f) {
            chartPickerDelegate2.pickerEnd = 1.0f;
        }
    ...
    private void updateCharValues(float f, float f2, boolean z) {
        ...
        while (i3 <= i2) {
            for (int i6 = 0; i6 < size; i6++) {
                ...
                fArr[i6] = fArr[i6] + ((StackLinearChartData) this.chartData).lines.get(i6).f1518y[i3];
                this.sum += ((StackLinearChartData) this.chartData).lines.get(i6).f1518y[i3];
                if (this.isEmpty && ((PieChartViewData) this.lines.get(i6)).enabled && ((StackLinearChartData) this.chartData).lines.get(i6).f1518y[i3] > 0) {
                    this.isEmpty = false;
                }
            }
            i3++;
        ...
        while (i < size) {
            ...
            float f4 = this.sum;
            ValueAnimator valueAnimatorCreateAnimator = createAnimator(pieChartViewData.drawingPart, f4 == 0.0f ? 0.0f : this.values[i] / f4, new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Charts.PieChartView$$ExternalSyntheticLambda0
    ...
    @Override // org.telegram.p035ui.Charts.BaseChartView, org.telegram.ui.Charts.ChartPickerDelegate.Listener
