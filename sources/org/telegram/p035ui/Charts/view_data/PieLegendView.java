...
public class PieLegendView extends LegendSignatureView {
    ...
    @Override // org.telegram.p035ui.Charts.view_data.LegendSignatureView
    ...
    public PieLegendView(Context context) {
        ...
        this.signature.getLayoutParams().width = AndroidUtilities.m1036dp(96.0f);
        TextView textView2 = new TextView(getContext());
        this.value = textView2;
        linearLayout.addView(textView2);
        addView(linearLayout);
        this.value.setTypeface(Typeface.create("sans-serif-medium", 0));
        setPadding(AndroidUtilities.m1036dp(12.0f), AndroidUtilities.m1036dp(12.0f), AndroidUtilities.m1036dp(12.0f), AndroidUtilities.m1036dp(12.0f));
