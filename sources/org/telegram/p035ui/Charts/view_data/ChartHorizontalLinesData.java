...
public class ChartHorizontalLinesData {
    ...
    */
    public ChartHorizontalLinesData(long r24, long r26, boolean r28, float r29, int r30, android.text.TextPaint r31, android.text.TextPaint r32) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Charts.view_data.ChartHorizontalLinesData.<init>(long, long, boolean, float, int, android.text.TextPaint, android.text.TextPaint):void");
    }
    ...
    public CharSequence format(int i, TextPaint textPaint, long j, int i2) {
        ...
        return ChannelMonetizationLayout.replaceTON("TON " + this.formatterTON.format(j / 1.0E9d), textPaint, 0.8f, -AndroidUtilities.m1036dp(0.66f), false);
    }
