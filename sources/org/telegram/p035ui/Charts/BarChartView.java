...
import org.telegram.p035ui.Charts.view_data.BarViewData;
...
public class BarChartView extends BaseChartView<ChartData, BarViewData> {
    ...
    */
    public void drawChart(android.graphics.Canvas r25) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Charts.BarChartView.drawChart(android.graphics.Canvas):void");
    }
        ...
        if (this.chartData != 0) {
            ...
            while (i7 < size) {
                ...
                if (barViewData.enabled || barViewData.alpha != 0.0f) {
                    ...
                    long[] jArr = barViewData.line.f1518y;
                    ...
                    while (i8 < length) {
                        ...
                        if (j < 0) {
                            ...
                            T t = this.chartData;
                            i3 = i6;
                            float f4 = t.xPercentage[i8] * this.pickerWidth;
