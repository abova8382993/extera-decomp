...
public class ChartPickerDelegate {
    ...
    public class CapturesData {
        ...
        public void captured() {
            ...
            this.f1515a = valueAnimatorOfFloat;
            valueAnimatorOfFloat.setDuration(600L);
            this.f1515a.setInterpolator(BaseChartView.INTERPOLATOR);
            this.f1515a.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Charts.ChartPickerDelegate$CapturesData$$ExternalSyntheticLambda0
        ...
        public void uncapture() {
            ValueAnimator valueAnimator = this.f1515a;
    ...
    public boolean uncapture(MotionEvent motionEvent, int i) {
        ...
        if (i == 0) {
            if (this.tryMoveTo) {
                ...
                if (motionEvent.getAction() == 1 && System.currentTimeMillis() - this.startTapTime < 300 && Math.sqrt((x * x) + (y * y)) < AndroidUtilities.m1036dp(10.0f)) {
