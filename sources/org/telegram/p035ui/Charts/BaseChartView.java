...
import org.telegram.p035ui.Charts.view_data.ChartBottomSignatureData;
import org.telegram.p035ui.Charts.view_data.ChartHeaderView;
import org.telegram.p035ui.Charts.view_data.ChartHorizontalLinesData;
...
public abstract class BaseChartView<T extends ChartData, L extends LineViewData> extends View implements ChartPickerDelegate.Listener {
    ...
    public static final int SIGNATURE_TEXT_HEIGHT = AndroidUtilities.m1036dp(18.0f);
    private static final int BOTTOM_SIGNATURE_TEXT_HEIGHT = AndroidUtilities.m1036dp(14.0f);
    public static final int BOTTOM_SIGNATURE_START_ALPHA = AndroidUtilities.m1036dp(10.0f);
    protected static final int PICKER_PADDING = AndroidUtilities.m1036dp(16.0f);
    private static final int PICKER_CAPTURE_WIDTH = AndroidUtilities.m1036dp(24.0f);
    private static final int LANDSCAPE_END_PADDING = AndroidUtilities.m1036dp(16.0f);
    private static final int BOTTOM_SIGNATURE_OFFSET = AndroidUtilities.m1036dp(10.0f);
    private static final int DP_12 = AndroidUtilities.m1036dp(12.0f);
    private static final int DP_8 = AndroidUtilities.m1036dp(8.0f);
    private static final int DP_6 = AndroidUtilities.m1036dp(6.0f);
    private static final int DP_5 = AndroidUtilities.m1036dp(5.0f);
    private static final int DP_2 = AndroidUtilities.m1036dp(2.0f);
    private static final int DP_1 = AndroidUtilities.m1036dp(1.0f);
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Charts.BaseChartView$1 */
    public class C34821 implements ValueAnimator.AnimatorUpdateListener {
        public C34821() {
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Charts.BaseChartView$2 */
    public class C34832 implements ValueAnimator.AnimatorUpdateListener {
        public C34832() {
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Charts.BaseChartView$3 */
    public class C34843 implements ValueAnimator.AnimatorUpdateListener {
        public C34843() {
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Charts.BaseChartView$4 */
    public class C34854 extends AnimatorListenerAdapter {
        public C34854() {
        }
    ...
    public BaseChartView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.pikerHeight = AndroidUtilities.m1036dp(46.0f);
    ...
    public void updateColors() {
        ...
        if (this.legendShowing) {
            ...
            long[] jArr = t.f1516x;
            if (i2 < jArr.length) {
                this.legendSignatureView.setData(i2, jArr[i2], this.lines, false, t.yTooltipFormatter, t.yRate);
            }
        }
        this.invalidatePickerChart = true;
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (!this.landscape) {
            ...
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.displaySize.y - AndroidUtilities.m1036dp(56.0f));
        }
    ...
    private void measureSizes() {
        ...
        updateLineSignature();
        this.chartBottom = AndroidUtilities.m1036dp(100.0f);
        this.chartArea.set(this.chartStart - f, 0.0f, this.chartEnd + f, getMeasuredHeight() - this.chartBottom);
        if (this.chartData != null) {
            this.bottomSignatureOffset = (int) (AndroidUtilities.m1036dp(20.0f) / (this.pickerWidth / this.chartData.f1516x.length));
        }
    ...
    */
    public void drawBottomSignature(android.graphics.Canvas r18) {
        /*
            Method dump skipped, instruction units count: 286
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Charts.BaseChartView.drawBottomSignature(android.graphics.Canvas):void");
    }
    ...
    public void drawSelection(Canvas canvas) {
        ...
        while (true) {
            ...
            if (l.enabled || l.alpha != 0.0f) {
                float f7 = l.line.f1518y[this.selectedIndex];
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void drawHorizontalLines(android.graphics.Canvas r12, org.telegram.p035ui.Charts.view_data.ChartHorizontalLinesData r13) {
        /*
            r11 = this;
            long[] r0 = r13.values
            int r1 = r0.length
        ...
        L3e:
            ...
            int r0 = r0 - r3
            int r3 = org.telegram.p035ui.Charts.BaseChartView.SIGNATURE_TEXT_HEIGHT
            int r0 = r0 - r3
        ...
        La3:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Charts.BaseChartView.drawHorizontalLines(android.graphics.Canvas, org.telegram.ui.Charts.view_data.ChartHorizontalLinesData):void");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void drawSignaturesToHorizontalLines(android.graphics.Canvas r12, org.telegram.p035ui.Charts.view_data.ChartHorizontalLinesData r13) {
        /*
            r11 = this;
            long[] r0 = r13.values
            int r1 = r0.length
        ...
        L83:
            ...
            float r2 = r2 - r4
            int r2 = (int) r2
            float r8 = org.telegram.p035ui.Charts.BaseChartView.HORIZONTAL_PADDING
            int r2 = r2 - r3
            float r9 = (float) r2
        ...
        Lbf:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Charts.BaseChartView.drawSignaturesToHorizontalLines(android.graphics.Canvas, org.telegram.ui.Charts.view_data.ChartHorizontalLinesData):void");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void drawPicker(android.graphics.Canvas r30) {
        /*
            Method dump skipped, instruction units count: 860
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Charts.BaseChartView.drawPicker(android.graphics.Canvas):void");
    }
    ...
    public void setMaxMinValue(long j, long j2, boolean z, boolean z2, boolean z3) {
        ...
        if (jCurrentTimeMillis - this.lastTime >= 320 || z2) {
            ...
            valueAnimatorCreateAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Charts.BaseChartView.5
                ...
                public C34865(final ChartHorizontalLinesData chartHorizontalLinesDataCreateHorizontalLinesData2) {
                    chartHorizontalLinesData = chartHorizontalLinesDataCreateHorizontalLinesData2;
                }

                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator3) {
                    BaseChartView.this.horizontalLines.clear();
                    BaseChartView.this.horizontalLines.add(chartHorizontalLinesData);
                }
            });
    ...
    public /* synthetic */ void lambda$setMaxMinValue$2(ChartHorizontalLinesData chartHorizontalLinesData, ValueAnimator valueAnimator) {
        ...
        ArrayList<ChartHorizontalLinesData> arrayList = this.horizontalLines;
        int size = arrayList.size();
        int i = 0;
        while (i < size) {
            ChartHorizontalLinesData chartHorizontalLinesData2 = arrayList.get(i);
            i++;
            ChartHorizontalLinesData chartHorizontalLinesData3 = chartHorizontalLinesData2;
            if (chartHorizontalLinesData3 != chartHorizontalLinesData) {
                chartHorizontalLinesData3.alpha = (int) ((chartHorizontalLinesData3.fixedAlpha / 255.0f) * (255 - chartHorizontalLinesData.alpha));
            }
        }
        invalidate();
    }

    /* JADX INFO: renamed from: org.telegram.ui.Charts.BaseChartView$5 */
    public class C34865 extends AnimatorListenerAdapter {
        final /* synthetic */ ChartHorizontalLinesData val$newData;
    ...
    public ChartHorizontalLinesData createHorizontalLinesData(long j, long j2, int i) {
    ...
    public void selectXOnChart(int i, int i2) {
        ...
        if (f3 < 0.0f) {
            ...
            this.selectedIndex = t.f1516x.length - 1;
            this.selectedCoordinate = 1.0f;
        } else {
            int iFindIndex = t.findIndex(this.startXIndex, this.endXIndex, f3);
    ...
    public long findMaxValue(int i, int i2) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            if (this.lines.get(i3).enabled) {
                long jRMaxQ = this.lines.get(i3).line.segmentTree.rMaxQ(i, i2);
                if (jRMaxQ > j) {
                    j = jRMaxQ;
                }
            }
    ...
    public long findMinValue(int i, int i2) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            if (this.lines.get(i3).enabled) {
                long jRMinQ = this.lines.get(i3).line.segmentTree.rMinQ(i, i2);
                if (jRMinQ < j) {
                    j = jRMinQ;
                }
            }
        ...
        if (this.chartData != t) {
            ...
            if (t != null && t.lines != null) {
                for (int i = 0; i < t.lines.size(); i++) {
                    this.lines.add((L) createLineViewData(t.lines.get(i)));
                }
            }
            clearSelection();
            this.chartData = t;
            if (t != null) {
                ...
                if (j == 0) {
                    ...
                    chartPickerDelegate.minDistance = getMinDistance();
    ...
    public void initPickerMaxHeight() {
        ...
        while (i < size) {
            ...
            i++;
            L l2 = l;
            boolean z = l2.enabled;
            if (z) {
                long j = l2.line.maxValue;
                if (j > this.pickerMaxHeight) {
                    this.pickerMaxHeight = j;
                }
            }
            if (z) {
                long j2 = l2.line.minValue;
    ...
    public void onPickerJumpTo(float f, float f2, boolean z) {
        ...
        if (z) {
            int iFindStartIndex = t.findStartIndex(Math.max(f, 0.0f));
    ...
    public void updateIndexes() {
        ...
        int iFindStartIndex = t.findStartIndex(Math.max(this.pickerDelegate.pickerStart, 0.0f));
        ...
        if (chartHeaderView != null) {
            long[] jArr = this.chartData.f1516x;
    ...
    private void updateDates(int i) {
        ArrayList<ChartBottomSignatureData> arrayList;
        ...
        if (chartBottomSignatureData == null || i >= chartBottomSignatureData.stepMax || i <= chartBottomSignatureData.stepMin) {
            ...
            if (chartBottomSignatureData2 == null || chartBottomSignatureData2.step != iHighestOneBit) {
                ...
                while (true) {
                    int i3 = this.tmpN;
                    arrayList = this.bottomSignatureDate;
                    if (i2 >= i3) {
                        break;
                    }
                    ChartBottomSignatureData chartBottomSignatureData4 = arrayList.get(i2);
                ...
                duration.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Charts.BaseChartView.6
                    ...
                    public C34876(final ChartBottomSignatureData chartBottomSignatureData32) {
                        chartBottomSignatureData = chartBottomSignatureData32;
                    }
                    ...
                    public void onAnimationEnd(Animator animator) {
                        ...
                        BaseChartView.this.bottomSignatureDate.add(chartBottomSignatureData);
                    }
                });
    ...
    public /* synthetic */ void lambda$updateDates$3(ChartBottomSignatureData chartBottomSignatureData, ValueAnimator valueAnimator) {
        ...
        ArrayList<ChartBottomSignatureData> arrayList = this.bottomSignatureDate;
        int size = arrayList.size();
        int i = 0;
        while (i < size) {
            ChartBottomSignatureData chartBottomSignatureData2 = arrayList.get(i);
            i++;
            ChartBottomSignatureData chartBottomSignatureData3 = chartBottomSignatureData2;
            if (chartBottomSignatureData3 == chartBottomSignatureData) {
                chartBottomSignatureData.alpha = (int) (255.0f * fFloatValue);
            } else {
                chartBottomSignatureData3.alpha = (int) ((1.0f - fFloatValue) * chartBottomSignatureData3.fixedAlpha);
            }
        }
        invalidate();
    }

    /* JADX INFO: renamed from: org.telegram.ui.Charts.BaseChartView$6 */
    public class C34876 extends AnimatorListenerAdapter {
        final /* synthetic */ ChartBottomSignatureData val$data;
    ...
    public void onCheckChanged() {
        ...
        while (true) {
            ...
            if (l.enabled && l.alpha != 1.0f) {
                ...
                if (valueAnimator4 == null || !valueAnimator4.isRunning()) {
                    ValueAnimator valueAnimatorCreateAnimator = createAnimator(l.alpha, 1.0f, new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Charts.BaseChartView$$ExternalSyntheticLambda4
                        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                        public final void onAnimationUpdate(ValueAnimator valueAnimator5) {
                            this.f$0.lambda$onCheckChanged$4(l, valueAnimator5);
                        }
                    });
                    l.animatorIn = valueAnimatorCreateAnimator;
                    valueAnimatorCreateAnimator.start();
                    if (l.enabled) {
                    }
                }
            } else if (l.enabled && l.alpha != 0.0f && ((valueAnimator = l.animatorOut) == null || !valueAnimator.isRunning())) {
                ValueAnimator valueAnimatorCreateAnimator2 = createAnimator(l.alpha, 0.0f, new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Charts.BaseChartView$$ExternalSyntheticLambda5
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public final void onAnimationUpdate(ValueAnimator valueAnimator5) {
                        this.f$0.lambda$onCheckChanged$5(l, valueAnimator5);
                    }
                });
                l.animatorOut = valueAnimatorCreateAnimator2;
        ...
        if (this.legendShowing) {
            ...
            int i3 = this.selectedIndex;
            T t = this.chartData;
            legendSignatureView.setData(i3, t.f1516x[i3], this.lines, true, t.yTooltipFormatter, t.yRate);
        }
    }
    ...
    public void updatePickerMinMaxHeight() {
        if (ANIMATE_PICKER_SIZES) {
            ...
            while (i < size) {
                ...
                boolean z = l2.enabled;
                if (z) {
                    long j3 = l2.line.maxValue;
                    if (j3 > j2) {
                        j2 = j3;
                    }
                }
                if (z) {
                    long j4 = l2.line.minValue;
                    if (j4 < j) {
                        j = j4;
                    }
                }
    ...
    public long getSelectedDate() {
        ...
        return this.chartData.f1516x[i];
    }
    ...
    public void selectDate(long j) {
        this.selectedIndex = Arrays.binarySearch(this.chartData.f1516x, j);
        this.legendShowing = true;
        this.legendSignatureView.setVisibility(0);
    ...
    public long getStartDate() {
        return this.chartData.f1516x[this.startXIndex];
    }

    public long getEndDate() {
        return this.chartData.f1516x[this.endXIndex];
    }

    public void updatePicker(ChartData chartData, long j) {
        int length = chartData.f1516x.length;
        long j2 = j - (j % DurationKt.MILLIS_IN_DAY);
        long j3 = 86399999 + j2;
        int i = 0;
        int i2 = 0;
        for (int i3 = 0; i3 < length; i3++) {
            long j4 = chartData.f1516x[i3];
            if (j2 > j4) {
                i = i3;
            }
            if (j3 > j4) {
    ...
    public static class SharedUiComponents {
        ...
        public Bitmap getPickerMaskBitmap(int i, int i2) {
            int i3 = (i + i2) << 10;
            if (i3 != this.f1514k || this.invalidate) {
                ...
                this.canvas.drawRoundRect(this.rectF, AndroidUtilities.m1036dp(6.0f), AndroidUtilities.m1036dp(6.0f), this.xRefP);
            }
