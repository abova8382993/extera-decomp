...
public abstract class AvatarPreviewPagerIndicator extends View implements ProfileGalleryView.Callback {
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        this.bottomOverlayRect.set(0, (int) (i2 - (AndroidUtilities.m1036dp(72.0f) * 0.5f)), i, i2);
        this.topOverlayGradient.setBounds(0, this.topOverlayRect.bottom, i, currentActionBarHeight + AndroidUtilities.m1036dp(16.0f));
        this.bottomOverlayGradient.setBounds(0, (i2 - AndroidUtilities.m1036dp(72.0f)) - AndroidUtilities.m1036dp(24.0f), i, this.bottomOverlayRect.top);
        int i5 = i / 5;
    ...
    */
    public void onDraw(android.graphics.Canvas r26) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.AvatarPreviewPagerIndicator.onDraw(android.graphics.Canvas):void");
    }
