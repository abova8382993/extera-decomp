...
import org.telegram.p035ui.IntroActivity;
...
public class IntroActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean onFragmentCreate() {
        ...
        this.titles = new CharSequence[]{LocaleController.getString(C2797R.string.AppName), LocaleController.getString(C2797R.string.Page2Title), LocaleController.getString(C2797R.string.Page3Title), LocaleController.getString(C2797R.string.Page5Title), LocaleController.getString(C2797R.string.Page4Title), LocaleController.getString(C2797R.string.Page6Title)};
        this.messages = new String[]{LocaleController.getString(C2797R.string.Page1Message), LocaleController.getString(C2797R.string.Page2Message), LocaleController.getString(C2797R.string.Page3Message), LocaleController.getString(C2797R.string.Page5Message), LocaleController.getString(C2797R.string.Page4Message), LocaleController.getString(C2797R.string.Page6Message)};
        return true;
    }
    ...
    public View createView(Context context) {
        ...
        FrameLayout frameLayout2 = new FrameLayout(context) { // from class: org.telegram.ui.IntroActivity.1
            ...
            public void onLayout(boolean z, int i2, int i3, int i4, int i5) {
                ...
                int i6 = (i5 - i3) / 4;
                int i7 = i6 * 3;
                int iM1036dp = (i7 - AndroidUtilities.m1036dp(275.0f)) / 2;
                IntroActivity.this.frameLayout2.layout(0, iM1036dp, IntroActivity.this.frameLayout2.getMeasuredWidth(), IntroActivity.this.frameLayout2.getMeasuredHeight() + iM1036dp);
                int iM1036dp2 = iM1036dp + AndroidUtilities.m1036dp(150.0f) + AndroidUtilities.m1036dp(139.0f);
                int measuredWidth = (getMeasuredWidth() - IntroActivity.this.bottomPages.getMeasuredWidth()) / 2;
                IntroActivity.this.bottomPages.layout(measuredWidth, iM1036dp2, IntroActivity.this.bottomPages.getMeasuredWidth() + measuredWidth, IntroActivity.this.bottomPages.getMeasuredHeight() + iM1036dp2);
                ...
                int iM1036dp3 = measuredHeight - AndroidUtilities.m1036dp(30.0f);
                int measuredWidth3 = (getMeasuredWidth() - IntroActivity.this.switchLanguageTextView.getMeasuredWidth()) / 2;
                IntroActivity.this.switchLanguageTextView.layout(measuredWidth3, iM1036dp3 - IntroActivity.this.switchLanguageTextView.getMeasuredHeight(), IntroActivity.this.switchLanguageTextView.getMeasuredWidth() + measuredWidth3, iM1036dp3);
                ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) frameLayout.getLayoutParams();
                int iM1036dp4 = AndroidUtilities.m1036dp(i) + (AndroidUtilities.isTablet() ? 0 : AndroidUtilities.statusBarHeight);
                if (marginLayoutParams.topMargin != iM1036dp4) {
                    marginLayoutParams.topMargin = iM1036dp4;
        ...
        int i2 = C2797R.raw.sun;
        RLottieDrawable rLottieDrawable = new RLottieDrawable(i2, String.valueOf(i2), AndroidUtilities.m1036dp(28.0f), AndroidUtilities.m1036dp(28.0f), true, null);
        ...
        rLottieImageView.setContentDescription(LocaleController.getString(Theme.getCurrentTheme().isDark() ? C2797R.string.AccDescrSwitchToDayTheme : C2797R.string.AccDescrSwitchToNightTheme));
        ...
        textureView.setSurfaceTextureListener(new TextureViewSurfaceTextureListenerC58702());
        ...
        TextView textView = new TextView(context) { // from class: org.telegram.ui.IntroActivity.4
            ...
            public void onMeasure(int i3, int i4) {
                if (View.MeasureSpec.getSize(i3) > AndroidUtilities.m1036dp(260.0f)) {
                    super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(320.0f), TLObject.FLAG_30), i4);
                } else {
        ...
        this.startMessagingButton.setText(LocaleController.getString(C2797R.string.StartMessaging));
        ...
        this.startMessagingButton.setPadding(AndroidUtilities.m1036dp(34.0f), 0, AndroidUtilities.m1036dp(34.0f), 0);
        ...
        this.frameContainerView.addView(frameLayout, LayoutHelper.createFrame(64, 64.0f, 53, 0.0f, 4.0f, 4.0f, 0.0f));
    ...
    public /* synthetic */ void lambda$createView$0(RLottieImageView rLottieImageView, View view) {
        ...
        rLottieImageView.setContentDescription(LocaleController.getString(!zIsCurrentThemeDark ? C2797R.string.AccDescrSwitchToDayTheme : C2797R.string.AccDescrSwitchToNightTheme));
    }

    /* JADX INFO: renamed from: org.telegram.ui.IntroActivity$2 */
    public class TextureViewSurfaceTextureListenerC58702 implements TextureView.SurfaceTextureListener {
        @Override // android.view.TextureView.SurfaceTextureListener
        public void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
        }

        public TextureViewSurfaceTextureListenerC58702() {
        }
    ...
    public /* synthetic */ void lambda$createView$2(View view) {
        ...
        NotificationCenter.getGlobalInstance().addObserver(new C58735(alertDialog), NotificationCenter.reloadInterface);
        LocaleController.getInstance().applyLanguage(this.localeInfo, true, false, this.currentAccount);
    }

    /* JADX INFO: renamed from: org.telegram.ui.IntroActivity$5 */
    public class C58735 implements NotificationCenter.NotificationCenterDelegate {
        final /* synthetic */ AlertDialog val$loaderDialog;

        public C58735(AlertDialog alertDialog) {
    ...
    public class IntroAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup viewGroup, int i) {
            ...
            FrameLayout frameLayout = new FrameLayout(viewGroup.getContext()) { // from class: org.telegram.ui.IntroActivity.IntroAdapter.1
                @Override // android.widget.FrameLayout, android.view.ViewGroup, android.view.View
                public void onLayout(boolean z, int i2, int i3, int i4, int i5) {
                    int iM1036dp = (((((i5 - i3) / 4) * 3) - AndroidUtilities.m1036dp(275.0f)) / 2) + AndroidUtilities.m1036dp(150.0f) + AndroidUtilities.m1036dp(25.0f);
                    int iM1036dp2 = AndroidUtilities.m1036dp(18.0f);
                    TextView textView3 = textView;
                    textView3.layout(iM1036dp2, iM1036dp, textView3.getMeasuredWidth() + iM1036dp2, textView.getMeasuredHeight() + iM1036dp);
                    int textSize = iM1036dp + ((int) textView.getTextSize()) + AndroidUtilities.m1036dp(18.0f);
                    int iM1036dp3 = AndroidUtilities.m1036dp(16.0f);
                    TextView textView4 = textView2;
                    textView4.layout(iM1036dp3, textSize, textView4.getMeasuredWidth() + iM1036dp3, textView2.getMeasuredHeight() + textSize);
                }
            };
    ...
    public class EGLThread extends DispatchQueue {
        ...
        /* JADX INFO: renamed from: $r8$lambda$7LXCaMmSl-_zxBSp3pQPev_oFIc, reason: not valid java name */
        public static /* synthetic */ Bitmap m16702$r8$lambda$7LXCaMmSl_zxBSp3pQPev_oFIc(Void r6) {
            int iM1036dp = AndroidUtilities.m1036dp(150.0f);
            Bitmap bitmapCreateBitmap = Bitmap.createBitmap(AndroidUtilities.m1036dp(200.0f), iM1036dp, Bitmap.Config.ARGB_8888);
            Canvas canvas = new Canvas(bitmapCreateBitmap);
            canvas.drawColor(Theme.getColor(Theme.key_windowBackgroundWhite));
            Paint paint = new Paint(1);
            paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.CLEAR));
            canvas.drawCircle(bitmapCreateBitmap.getWidth() / 2.0f, bitmapCreateBitmap.getHeight() / 2.0f, iM1036dp / 2.0f, paint);
        ...
        public EGLThread(SurfaceTexture surfaceTexture) {
            ...
            this.telegramMaskProvider = new GenericProvider() { // from class: org.telegram.ui.IntroActivity$EGLThread$$ExternalSyntheticLambda1
                ...
                public final Object provide(Object obj) {
                    return IntroActivity.EGLThread.m16702$r8$lambda$7LXCaMmSl_zxBSp3pQPev_oFIc((Void) obj);
                }
            };
                    ...
                    if (EGLThread.this.initied) {
                        ...
                        if ((!EGLThread.this.eglContext.equals(EGLThread.this.egl10.eglGetCurrentContext()) || !EGLThread.this.eglSurface.equals(EGLThread.this.egl10.eglGetCurrentSurface(12377))) && !EGLThread.this.egl10.eglMakeCurrent(EGLThread.this.eglDisplay, EGLThread.this.eglSurface, EGLThread.this.eglSurface, EGLThread.this.eglContext)) {
                            if (BuildVars.LOGS_ENABLED) {
                                FileLog.m1046e("eglMakeCurrent failed " + GLUtils.getEGLErrorString(EGLThread.this.egl10.eglGetError()));
                                return;
                            }
                            return;
                        }
        ...
        private boolean initGL() {
            ...
            if (iArr2[0] > 0) {
                ...
                if (this.surfaceTexture != null) {
                    ...
                    loadTexture(C2797R.drawable.intro_fast_arrow_shadow, 0);
                    loadTexture(C2797R.drawable.intro_fast_arrow, 1);
                    loadTexture(C2797R.drawable.intro_fast_body, 2);
                    loadTexture(C2797R.drawable.intro_fast_spiral, 3);
                    loadTexture(C2797R.drawable.intro_ic_bubble_dot, 4);
                    loadTexture(C2797R.drawable.intro_ic_bubble, 5);
                    loadTexture(C2797R.drawable.intro_ic_cam_lens, 6);
                    loadTexture(C2797R.drawable.intro_ic_cam, 7);
                    loadTexture(C2797R.drawable.intro_ic_pencil, 8);
                    loadTexture(C2797R.drawable.intro_ic_pin, 9);
                    loadTexture(C2797R.drawable.intro_ic_smile_eye, 10);
                    loadTexture(C2797R.drawable.intro_ic_smile, 11);
                    loadTexture(C2797R.drawable.intro_ic_videocam, 12);
                    loadTexture(C2797R.drawable.intro_knot_down, 13);
                    loadTexture(C2797R.drawable.intro_knot_up, 14);
                    loadTexture(C2797R.drawable.intro_powerful_infinity_white, 15);
                    loadTexture(C2797R.drawable.intro_powerful_infinity, 16);
                    loadTexture(C2797R.drawable.intro_powerful_mask, 17, Theme.getColor(Theme.key_windowBackgroundWhite), false);
                    loadTexture(C2797R.drawable.intro_powerful_star, 18);
                    loadTexture(C2797R.drawable.intro_private_door, 19);
                    loadTexture(C2797R.drawable.intro_private_screw, 20);
                    loadTexture(C2797R.drawable.intro_etg_arrow, 21);
        ...
        public static /* synthetic */ Bitmap $r8$lambda$foVV6ESqdPYksTpmJ2qe1lzbeC4(Void r4) {
            Paint paint = new Paint(1);
            paint.setColor(ContextCompat.getColor(ApplicationLoader.applicationContext, C2797R.color.ic_background));
            int iM1036dp = AndroidUtilities.m1036dp(150.0f);
    ...
    private void updateColors(boolean z) {
        ...
        this.startMessagingButton.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1036dp(24.0f), 0, Theme.getColor(Theme.key_featuredStickers_addButtonPressed)));
    ...
    public /* synthetic */ void lambda$updateColors$6() {
        EGLThread eGLThread = this.eglThread;
        int i = C2797R.drawable.intro_powerful_mask;
        int i2 = Theme.key_windowBackgroundWhite;
