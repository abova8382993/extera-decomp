...
public class DownloadProgressIcon extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public DownloadProgressIcon(int i, Context context) {
        ...
        this.downloadDrawable = new RLottieDrawable(C2797R.raw.download_progress, "download_progress", AndroidUtilities.m1036dp(28.0f), AndroidUtilities.m1036dp(28.0f), true, null);
        this.downloadCompleteDrawable = new RLottieDrawable(C2797R.raw.download_finish, "download_finish", AndroidUtilities.m1036dp(28.0f), AndroidUtilities.m1036dp(28.0f), true, null);
    ...
    public void onDraw(Canvas canvas) {
        ...
        int measuredHeight = (getMeasuredHeight() / 2) + AndroidUtilities.m1036dp(8.0f);
        float fM1036dp = AndroidUtilities.m1036dp(1.0f);
        float fM1036dp2 = AndroidUtilities.m1036dp(16.0f);
        RectF rectF = AndroidUtilities.rectTmp;
        float f5 = measuredHeight;
        float f6 = f5 - fM1036dp;
        float f7 = f5 + fM1036dp;
        rectF.set(fM1036dp2, f6, getMeasuredWidth() - fM1036dp2, f7);
        canvas.drawRoundRect(rectF, fM1036dp, fM1036dp, this.paint2);
        rectF.set(fM1036dp2, f6, ((getMeasuredWidth() - (2.0f * fM1036dp2)) * this.currentProgress) + fM1036dp2, f7);
    ...
    private void updateDownloadingListeners() {
        ArrayList<ProgressObserver> arrayList;
        ...
        while (true) {
            ...
            map.put(arrayList.get(i).fileName, this.currentListeners.get(i));
