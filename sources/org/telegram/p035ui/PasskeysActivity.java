...
public class PasskeysActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2797R.string.Passkey));
    ...
    /* JADX INFO: renamed from: org.telegram.ui.PasskeysActivity$1 */
    public class C61731 extends ActionBar.ActionBarMenuOnItemClick {
        public C61731() {
        }
    ...
    public void fillItems(ArrayList<UItem> arrayList, UniversalAdapter universalAdapter) {
        ArrayList<TL_account.Passkey> arrayList2;
        this.addPasskeyRow = -1;
        arrayList.add(UItem.asTopView(LocaleController.getString(C2797R.string.PasskeyTopInfo), C2797R.raw.passkey));
        int i = 0;
        while (true) {
            int size = this.passkeys.size();
            arrayList2 = this.passkeys;
            if (i >= size) {
                break;
            }
            arrayList.add(PasskeyCell.Factory.m1183of(arrayList2.get(i), new View.OnClickListener() { // from class: org.telegram.ui.PasskeysActivity$$ExternalSyntheticLambda3
        ...
        if (arrayList2.size() + 1 <= getMessagesController().config.passkeysAccountPasskeysMax.get()) {
            this.addPasskeyRow = arrayList.size();
            arrayList.add(UItem.asButton(-1, C2797R.drawable.menu_passkey_add, LocaleController.getString(C2797R.string.PasskeyAdd)).accent());
        }
        arrayList.add(UItem.asShadow(AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(C2797R.string.PasskeyInfo), new Runnable() { // from class: org.telegram.ui.PasskeysActivity$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$fillItems$0();
            }
        }), true)));
        arrayList.add(UItem.asButton(-2, C2797R.drawable.msg_settings, LocaleController.getString(C2797R.string.Settings)));
        arrayList.add(UItem.asShadow(AndroidUtilities.replaceMultipleTags(LocaleController.getString(C2797R.string.PasskeyInfo2), new Runnable() { // from class: org.telegram.ui.PasskeysActivity$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void openMenu(View view) {
        ...
        final String str = passkeyCell.f1738id;
        final int i = 0;
        while (true) {
            if (i >= this.passkeys.size()) {
                i = -1;
                break;
            } else if (str.equals(this.passkeys.get(i).f1419id)) {
                break;
            } else {
                i++;
            }
        ...
        final TL_account.Passkey passkey = this.passkeys.get(i);
        ItemOptions.makeOptions(this, passkeyCell).add(C2797R.drawable.msg_delete, (CharSequence) LocaleController.getString(C2797R.string.Delete), true, new Runnable() { // from class: org.telegram.ui.PasskeysActivity$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$openMenu$5(final TL_account.Passkey passkey, final String str, final int i) {
        new AlertDialog.Builder(getContext()).setTitle(LocaleController.getString(C2797R.string.PasskeyDeleteTitle)).setMessage(LocaleController.getString(C2797R.string.PasskeyDeleteText)).setPositiveButton(LocaleController.getString(C2797R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.PasskeysActivity$$ExternalSyntheticLambda9
    ...
    public /* synthetic */ void lambda$openMenu$4(final TL_account.Passkey passkey, String str, final int i, AlertDialog alertDialog, int i2) {
        ...
        deletepasskey.f1420id = str;
        ConnectionsManager.getInstance(this.currentAccount).sendRequestTyped(deletepasskey, new AiTonesController$$ExternalSyntheticLambda0(), new Utilities.Callback2() { // from class: org.telegram.ui.PasskeysActivity$$ExternalSyntheticLambda13
            @Override // org.telegram.messenger.Utilities.Callback2
            public final void run(Object obj, Object obj2) {
    ...
    public /* synthetic */ void lambda$openMenu$3(int i, TL_account.Passkey passkey, TLRPC.Bool bool, TLRPC.TL_error tL_error) {
        if (bool instanceof TLRPC.TL_boolFalse) {
            BulletinFactory.m1143of(this).showForError("FALSE");
    ...
    public /* synthetic */ void lambda$onItemClick$6(TL_account.Passkey passkey, String str) {
        ...
        if ("EMPTY".equalsIgnoreCase(str)) {
            new AlertDialog.Builder(getContext()).setTitle(LocaleController.getString(C2797R.string.PasskeyNoOptionsTitle)).setMessage(LocaleController.getString(C2797R.string.PasskeyNoOptionsText)).setPositiveButton(LocaleController.getString(C2797R.string.f1162OK), null).show();
            return;
        }
        BulletinFactory bulletinFactoryM1143of = BulletinFactory.m1143of(this);
        if (str.startsWith("No create options")) {
            PasskeysUtil.showUnsupportedBulletin(bulletinFactoryM1143of);
        } else {
            bulletinFactoryM1143of.showForError(str, true);
        }
    }
    ...
    public void added(TL_account.Passkey passkey) {
        ...
        BulletinFactory.m1143of(this).createSimpleBulletin(C2797R.raw.passcode_lock_close, LocaleController.getString(C2797R.string.PasskeyAddedTitle), LocaleController.formatString(C2797R.string.PasskeyAddedText, passkey.name)).setDuration(5000).show(true);
    }
    ...
    public static class PasskeyCell extends FrameLayout {
        ...
        public PasskeyCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
            ...
            backupImageView.setImageResource(C2797R.drawable.msg2_permissions);
        ...
        public void set(TL_account.Passkey passkey, View.OnClickListener onClickListener, boolean z) {
            ...
            if (j != 0) {
                ...
                frameLayout.setBackground(Theme.createRoundRectDrawable(iM1036dp, Theme.multAlpha(Theme.getColor(i, this.resourcesProvider), 0.04f)));
                ...
                this.imageView.setImageResource(C2797R.drawable.msg2_permissions);
            ...
            if (zIsEmpty) {
                textView.setText(LocaleController.getString(C2797R.string.PasskeyUnknown));
            } else {
            ...
            if (i2 != 0) {
                textView2.setText(LocaleController.formatString(C2797R.string.PasskeyLastUsedOn, LocaleController.formatDateTime(i2, false)));
            } else {
                textView2.setText(LocaleController.formatString(C2797R.string.PasskeyCreatedOn, LocaleController.formatDateTime(passkey.date, false)));
            }
        ...
        public void onDraw(Canvas canvas) {
            ...
            if (this.needDivider) {
                ...
                canvas.drawRect(AndroidUtilities.m1036dp(LocaleController.isRTL ? 0.0f : 72.0f), getMeasuredHeight() - 1, getWidth() - AndroidUtilities.m1036dp(LocaleController.isRTL ? 72.0f : 0.0f), getMeasuredHeight(), themePaint);
            }
        }
        ...
        public static class Factory extends UItem.UItemFactory<PasskeyCell> {
            ...
            public static UItem m1183of(TL_account.Passkey passkey, View.OnClickListener onClickListener) {
    ...
    public static void showLearnSheet(final Context context, final int i, Theme.ResourcesProvider resourcesProvider, boolean z) {
        ...
        rLottieImageView.setAnimation(C2797R.raw.passkey, AndroidUtilities.m1036dp(115.0f), AndroidUtilities.m1036dp(115.0f));
        ...
        textViewMakeTextView.setText(LocaleController.getString(C2797R.string.PasskeyFeatureTitle));
        ...
        textViewMakeTextView2.setText(LocaleController.getString(C2797R.string.PasskeyFeatureSubtitle));
        ...
        featureCell.set(C2797R.drawable.msg2_permissions, LocaleController.getString(C2797R.string.PasskeyFeature1Title), LocaleController.getString(C2797R.string.PasskeyFeature1Subtitle));
        ...
        featureCell2.set(C2797R.drawable.menu_face, LocaleController.getString(C2797R.string.PasskeyFeature2Title), LocaleController.getString(C2797R.string.PasskeyFeature2Subtitle));
        ...
        featureCell3.set(C2797R.drawable.menu_privacy, LocaleController.getString(C2797R.string.PasskeyFeature3Title), LocaleController.getString(C2797R.string.PasskeyFeature3Subtitle));
        ...
        round.setText(LocaleController.getString(C2797R.string.PasskeyFeatureButton), false);
    ...
    public static /* synthetic */ void $r8$lambda$YbuzlWVIPDdYORbpgGojRqxLWg4(ButtonWithCounterView buttonWithCounterView, Context context, final BottomSheet bottomSheet, int i, final TL_account.Passkey passkey, String str) {
        ...
        if ("EMPTY".equalsIgnoreCase(str)) {
            new AlertDialog.Builder(context).setTitle(LocaleController.getString(C2797R.string.PasskeyNoOptionsTitle)).setMessage(LocaleController.getString(C2797R.string.PasskeyNoOptionsText)).setPositiveButton(LocaleController.getString(C2797R.string.f1162OK), null).setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.PasskeysActivity$$ExternalSyntheticLambda11
        ...
        final BulletinFactory bulletinFactoryM1142of = BulletinFactory.m1142of(bottomSheet.topBulletinContainer, bottomSheet.getResourcesProvider());
        if (str != null) {
            if (str.startsWith("No create options")) {
                PasskeysUtil.showUnsupportedBulletin(bulletinFactoryM1142of);
                return;
            } else {
                bulletinFactoryM1142of.showForError(str);
                return;
            }
        }
        if (passkey != null) {
            ...
            ConnectionsManager.getInstance(i).sendRequestTyped(new TL_account.getPasskeys(), new AiTonesController$$ExternalSyntheticLambda0(), new Utilities.Callback2() { // from class: org.telegram.ui.PasskeysActivity$$ExternalSyntheticLambda12
                @Override // org.telegram.messenger.Utilities.Callback2
                public final void run(Object obj, Object obj2) {
                    PasskeysActivity.m17576$r8$lambda$IjsLdKNQgpIsFobjMO60p983YE(bottomSheet, passkey, bulletinFactoryM1142of, (TL_account.Passkeys) obj, (TLRPC.TL_error) obj2);
                }
            });
        }
    }

    /* JADX INFO: renamed from: $r8$lambda$IjsLdKNQgpI-sFobjMO60p983YE */
    public static /* synthetic */ void m17576$r8$lambda$IjsLdKNQgpIsFobjMO60p983YE(BottomSheet bottomSheet, final TL_account.Passkey passkey, BulletinFactory bulletinFactory, TL_account.Passkeys passkeys, TLRPC.TL_error tL_error) {
        if (passkeys == null) {
            if (tL_error != null) {
        ...
        while (i < passkeys.passkeys.size()) {
            if (TextUtils.equals(passkeys.passkeys.get(i).f1419id, passkey.f1419id)) {
