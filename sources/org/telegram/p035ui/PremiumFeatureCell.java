...
public class PremiumFeatureCell extends FrameLayout {
    ...
    public void setData(PremiumPreviewFragment.PremiumFeatureData premiumFeatureData, boolean z) {
        if (UserConfig.getInstance(UserConfig.selectedAccount).isPremium() && premiumFeatureData.type == 12 && premiumFeatureData.icon == C2797R.drawable.filled_premium_status2) {
    ...
    public void setEmoji(long j, boolean z) {
        ...
        if (j == 0) {
            if (this.premiumStar == null) {
                Drawable drawableMutate = getContext().getResources().getDrawable(C2797R.drawable.msg_premium_prolfilestar).mutate();
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.drawDivider) {
            canvas.drawRect(AndroidUtilities.m1036dp(62.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight(), Theme.dividerPaint);
        }
    }
    ...
    public static class Factory extends UItem.UItemFactory<PremiumFeatureCell> {
        ...
        public PremiumFeatureCell createView(Context context, RecyclerListView recyclerListView, int i, int i2, Theme.ResourcesProvider resourcesProvider) {
