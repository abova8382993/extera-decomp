...
public class DataSettingsActivity extends BaseFragment {
    ...
    public View createView(final Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2797R.string.DataSettings));
        ...
        C54892 c54892 = new RecyclerListView(context) { // from class: org.telegram.ui.DataSettingsActivity.2
            public C54892(final Context context2) {
                super(context2);
            }
    ...
    public class C54881 extends ActionBar.ActionBarMenuOnItemClick {
        public C54881() {
        }
    ...
    public class C54892 extends RecyclerListView {
        public C54892(final Context context2) {
            super(context2);
        }
    ...
    */
    public /* synthetic */ void lambda$createView$9(android.content.Context r20, android.view.View r21, final int r22, float r23, float r24) {
        /*
            Method dump skipped, instruction units count: 1074
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.DataSettingsActivity.lambda$createView$9(android.content.Context, android.view.View, int, float, float):void");
    }
    ...
    public /* synthetic */ void lambda$createView$2(AlertDialog alertDialog, int i) {
        ...
        for (int i2 = 0; i2 < 3; i2++) {
            if (i2 == 0) {
                ...
                if (i2 == 1) {
                    preset = DownloadController.getInstance(i3).wifiPreset;
                    preset2 = DownloadController.getInstance(this.currentAccount).highPreset;
                    str = "wifiPreset";
                } else {
                    preset = DownloadController.getInstance(i3).roamingPreset;
    ...
    public /* synthetic */ void lambda$createView$5(final String str, boolean z, final AlertDialog.Builder builder, View view) {
        ...
        if (!z) {
            ...
            builder2.setTitle(LocaleController.getString(C2797R.string.DecreaseSpeed));
            builder2.setMessage(LocaleController.getString(C2797R.string.SdCardAlert));
            builder2.setPositiveButton(LocaleController.getString(C2797R.string.Proceed), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.DataSettingsActivity$$ExternalSyntheticLambda7
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i) {
                    this.f$0.lambda$createView$4(str, builder, alertDialog, i);
                }
            });
            builder2.setNegativeButton(LocaleController.getString(C2797R.string.Back), null);
            builder2.show();
            return;
        }
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        /* JADX WARN: Removed duplicated region for block: B:324:0x0309  */
        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct code enable 'Show inconsistent code' option in preferences
