...
import org.telegram.p035ui.Cells.WallpaperCell;
...
public class WallpapersListActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private static final int[] searchColorsNamesR = {C2797R.string.Blue, C2797R.string.Red, C2797R.string.Orange, C2797R.string.Yellow, C2797R.string.Green, C2797R.string.Teal, C2797R.string.Purple, C2797R.string.Pink, C2797R.string.Brown, C2797R.string.Black, C2797R.string.Gray, C2797R.string.White};
    ...
    public static class ColorWallpaper {
        ...
        public String getUrl() {
            ...
            String lowerCase = i != 0 ? String.format("%02x%02x%02x", Integer.valueOf(((byte) (i >> 16)) & UByte.MAX_VALUE), Integer.valueOf(((byte) (this.gradientColor1 >> 8)) & UByte.MAX_VALUE), Byte.valueOf((byte) (this.gradientColor1 & 255))).toLowerCase() : null;
            String lowerCase2 = String.format("%02x%02x%02x", Integer.valueOf(((byte) (this.color >> 16)) & UByte.MAX_VALUE), Integer.valueOf(((byte) (this.color >> 8)) & UByte.MAX_VALUE), Byte.valueOf((byte) (this.color & 255))).toLowerCase();
            int i2 = this.gradientColor2;
            String lowerCase3 = i2 != 0 ? String.format("%02x%02x%02x", Integer.valueOf(((byte) (i2 >> 16)) & UByte.MAX_VALUE), Integer.valueOf(((byte) (this.gradientColor2 >> 8)) & UByte.MAX_VALUE), Byte.valueOf((byte) (this.gradientColor2 & 255))).toLowerCase() : null;
            int i3 = this.gradientColor3;
            String lowerCase4 = i3 != 0 ? String.format("%02x%02x%02x", Integer.valueOf(((byte) (i3 >> 16)) & UByte.MAX_VALUE), Integer.valueOf(((byte) (this.gradientColor3 >> 8)) & UByte.MAX_VALUE), Byte.valueOf((byte) (this.gradientColor3 & 255))).toLowerCase() : null;
            ...
            if (this.pattern != null) {
                ...
                return this.motion ? str2.concat("&mode=motion") : str2;
            }
    ...
    public View createView(Context context) {
        ...
        this.updater = new WallpaperUpdater(getParentActivity(), this, new C74191());
        this.hasOwnBackground = true;
        this.actionBar.setBackButtonImage(C2797R.drawable.ic_ab_back);
        this.actionBar.setAllowOverlayTitle(true);
        int i2 = this.currentType;
        if (i2 == 0) {
            this.actionBar.setTitle(LocaleController.getString(C2797R.string.ChatBackground));
        } else if (i2 == 2) {
            this.actionBar.setTitle("Channel Wallpaper");
        } else if (i2 == 1) {
            this.actionBar.setTitle(LocaleController.getString(C2797R.string.SelectColorTitle));
        }
        this.actionBar.setActionBarMenuOnItemClick(new C74202());
        boolean z = false;
        if (this.currentType == 0) {
            ActionBarMenuItem actionBarMenuItemSearchListener = this.actionBar.createMenu().addItem(0, C2797R.drawable.outline_header_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() { // from class: org.telegram.ui.WallpapersListActivity.3
                ...
                public void onCaptionCleared() {
                    ...
                    WallpapersListActivity.this.searchItem.setSearchFieldHint(LocaleController.getString(C2797R.string.SearchBackgrounds));
                }
            });
            this.searchItem = actionBarMenuItemSearchListener;
            actionBarMenuItemSearchListener.setSearchFieldHint(LocaleController.getString(C2797R.string.SearchBackgrounds));
            ...
            this.actionModeViews.add(actionBarMenuCreateActionMode.addItemWithWidth(3, C2797R.drawable.msg_forward, AndroidUtilities.m1036dp(54.0f), LocaleController.getString(C2797R.string.Forward)));
            this.actionModeViews.add(actionBarMenuCreateActionMode.addItemWithWidth(4, C2797R.drawable.msg_delete, AndroidUtilities.m1036dp(54.0f), LocaleController.getString(C2797R.string.Delete)));
    ...
    public class C74191 implements WallpaperUpdater.WallpaperUpdaterDelegate {
    ...
    public class C74202 extends ActionBar.ActionBarMenuOnItemClick {
        public C74202() {
        }
        ...
        public void onItemClick(int i) {
            if (i == -1) {
                boolean zIsActionModeShowed = ((BaseFragment) WallpapersListActivity.this).actionBar.isActionModeShowed();
            ...
            builder.setMessage(LocaleController.formatString("DeleteChatBackgroundsAlert", C2797R.string.DeleteChatBackgroundsAlert, new Object[0]));
            builder.setPositiveButton(LocaleController.getString(C2797R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.WallpapersListActivity$2$$ExternalSyntheticLambda0
        ...
        public /* synthetic */ void lambda$onItemClick$2(AlertDialog alertDialog, int i) {
            ...
            for (int i2 = 0; i2 < WallpapersListActivity.this.selectedWallPapers.size(); i2++) {
                ...
                if (objValueAt instanceof ColorWallpaper) {
                    ...
                    if (wallPaper == null || wallPaper.f1415id >= 0) {
                        objValueAt = wallPaper;
                    } else {
                        WallpapersListActivity.this.getMessagesStorage().deleteWallpaper(colorWallpaper.parentWallpaper.f1415id);
                ...
                if (objValueAt instanceof TLRPC.WallPaper) {
                    ...
                    if (objValueAt instanceof TLRPC.TL_wallPaperNoFile) {
                        ...
                        tL_inputWallPaperNoFile.f1329id = wallPaper2.f1415id;
                        savewallpaper.wallpaper = tL_inputWallPaperNoFile;
                    } else {
                        TLRPC.TL_inputWallPaper tL_inputWallPaper = new TLRPC.TL_inputWallPaper();
                        tL_inputWallPaper.f1328id = wallPaper2.f1415id;
        ...
        public /* synthetic */ boolean lambda$onItemClick$3(DialogsActivity dialogsActivity, ArrayList arrayList, CharSequence charSequence, boolean z, boolean z2, int i, int i2, TopicsFragment topicsFragment) {
            ...
            int i3 = 0;
            while (true) {
                int size = WallpapersListActivity.this.selectedWallPapers.size();
                wallpapersListActivity = WallpapersListActivity.this;
                if (i3 >= size) {
                    break;
                }
                Object objValueAt = wallpapersListActivity.selectedWallPapers.valueAt(i3);
            ...
            if (arrayList.size() > 1 || ((MessagesStorage.TopicKey) arrayList.get(0)).dialogId == UserConfig.getInstance(((BaseFragment) WallpapersListActivity.this).currentAccount).getClientUserId() || charSequence != null) {
                ...
                for (int i4 = 0; i4 < arrayList.size(); i4++) {
                    ...
                    if (charSequence != null) {
                        SendMessagesHelper.getInstance(((BaseFragment) WallpapersListActivity.this).currentAccount).sendMessage(SendMessagesHelper.SendMessageParams.m1075of(charSequence.toString(), j, null, null, null, true, null, null, null, true, 0, 0, null, false));
                    }
                    if (!TextUtils.isEmpty(sb)) {
                        SendMessagesHelper.getInstance(((BaseFragment) WallpapersListActivity.this).currentAccount).sendMessage(SendMessagesHelper.SendMessageParams.m1075of(sb.toString(), j, null, null, null, true, null, null, null, true, 0, 0, null, false));
                    }
                }
                ...
                SendMessagesHelper.getInstance(((BaseFragment) WallpapersListActivity.this).currentAccount).sendMessage(SendMessagesHelper.SendMessageParams.m1075of(sb.toString(), j2, null, null, null, true, null, null, null, true, 0, 0, null, false));
            }
            return true;
        }
    }
    ...
    public /* synthetic */ void lambda$createView$4(View view, int i) {
        ...
        if (i == this.setColorRow) {
            ...
            builder.setTitle(LocaleController.getString(C2797R.string.ResetChatBackgroundsAlertTitle));
            builder.setMessage(LocaleController.getString(C2797R.string.ResetChatBackgroundsAlert));
            builder.setPositiveButton(LocaleController.getString(C2797R.string.Reset), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.WallpapersListActivity$$ExternalSyntheticLambda4
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i2) {
    ...
    @Override // org.telegram.p035ui.ActionBar.BaseFragment
    public void onActivityResultFragment(int i, int i2, Intent intent) throws Throwable {
    ...
    public boolean onItemLongClick(WallpaperCell wallpaperCell, Object obj, int i) {
        ...
        if (i2 != 2 && i2 != 3) {
            ...
            if (!this.actionBar.isActionModeShowed() && getParentActivity() != null && (obj2 instanceof TLRPC.WallPaper)) {
                ...
                this.selectedWallPapers.put(((TLRPC.WallPaper) obj2).f1415id, obj);
    ...
    */
    public void onItemClick(org.telegram.p035ui.Cells.WallpaperCell r19, java.lang.Object r20, int r21) {
        /*
            Method dump skipped, instruction units count: 220
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.WallpapersListActivity.onItemClick(org.telegram.ui.Cells.WallpaperCell, java.lang.Object, int):void");
    }
    ...
    */
    public void didReceivedNotification(int r20, int r21, java.lang.Object... r22) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.WallpapersListActivity.didReceivedNotification(int, int, java.lang.Object[]):void");
    }
        ...
        if (!z) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (obj instanceof TLRPC.WallPaper) {
                    long j2 = ((TLRPC.WallPaper) obj).f1415id;
                    if (j2 >= 0) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (!"fqv01SQemVIBAAAApND8LDRUhRU".equals(wallPaper.slug)) {
                    if ((wallPaper instanceof TLRPC.TL_wallPaper) && !(wallPaper.document instanceof TLRPC.TL_documentEmpty)) {
                        ...
                        if (wallPaper.pattern && (document = wallPaper.document) != null && !this.patternsDict.containsKey(Long.valueOf(document.f1253id))) {
    ...
    private void fillWallpapersWithCustom() {
        ...
        if (i6 == 0 || i6 == 2) {
            ...
            if (r5 instanceof TLRPC.WallPaper) {
                ...
                r10 = r52;
                j = tL_wallPaper3.f1415id;
            } else {
                str = this.selectedBackgroundSlug;
                j = (!(r5 instanceof ColorWallpaper) || (wallPaper = ((ColorWallpaper) r5).parentWallpaper) == null) ? 0L : wallPaper.f1415id;
                r10 = r5;
                tL_wallPaper = null;
            }
    ...
    public /* synthetic */ int lambda$fillWallpapersWithCustom$9(long j, String str, boolean z, Object obj, Object obj2) {
        ...
        if (j != 0) {
            if (wallPaper.f1415id == j) {
                return -1;
            }
            if (wallPaper2.f1415id == j) {
                return 1;
            }
        } else {
    ...
    public class ColorCell extends View {
        ...
        public void onMeasure(int i, int i2) {
            setMeasuredDimension(AndroidUtilities.m1036dp(50.0f), AndroidUtilities.m1036dp(62.0f));
        }
        ...
        public void onDraw(Canvas canvas) {
            ...
            canvas.drawCircle(AndroidUtilities.m1036dp(25.0f), AndroidUtilities.m1036dp(31.0f), AndroidUtilities.m1036dp(18.0f), WallpapersListActivity.this.colorPaint);
            if (this.color == Theme.getColor(Theme.key_windowBackgroundWhite)) {
                canvas.drawCircle(AndroidUtilities.m1036dp(25.0f), AndroidUtilities.m1036dp(31.0f), AndroidUtilities.m1036dp(18.0f), WallpapersListActivity.this.colorFramePaint);
            }
        }
    }
    ...
    public class SearchAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public /* synthetic */ void lambda$searchImages$3(int i, TLObject tLObject) {
            ...
            if (tLObject != null) {
                ...
                for (int i2 = 0; i2 < size2; i2++) {
                    ...
                    if ("photo".equals(botInlineResult.type) && !this.searchResultKeys.containsKey(botInlineResult.f1243id)) {
                        ...
                        if (photo != null) {
                            ...
                            if (closestPhotoSizeWithSize != null) {
                                searchImage.width = closestPhotoSizeWithSize.f1278w;
                                searchImage.height = closestPhotoSizeWithSize.f1277h;
        ...
        public /* synthetic */ void lambda$onCreateViewHolder$5(View view, int i) {
            String string = LocaleController.getString(C2797R.string.BackgroundSearchColor);
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i != 0) {
                ...
                if (i == 1) {
                    ...
                    recyclerListView.setPadding(AndroidUtilities.m1036dp(7.0f), 0, AndroidUtilities.m1036dp(7.0f), 0);
                ...
                graySectionCell = new WallpaperCell(this.mContext) { // from class: org.telegram.ui.WallpapersListActivity.SearchAdapter.1
                    @Override // org.telegram.p035ui.Cells.WallpaperCell
            ...
            if (i == 1) {
                graySectionCell.setLayoutParams(new RecyclerView.LayoutParams(-1, AndroidUtilities.m1036dp(60.0f)));
            } else {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType != 0) {
                ...
                ((GraySectionCell) viewHolder.itemView).setText(LocaleController.getString(C2797R.string.SearchByColor));
                return;
            }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (i == WallpapersListActivity.this.uploadImageRow) {
                    textCell.setTextAndIcon((CharSequence) LocaleController.getString(C2797R.string.SelectFromGallery), C2797R.drawable.msg_photos, true);
                    return;
                }
                if (i == WallpapersListActivity.this.setColorRow) {
                    textCell.setTextAndIcon((CharSequence) LocaleController.getString(C2797R.string.SetColor), C2797R.drawable.msg_palette, true);
                    return;
                }
                if (i == WallpapersListActivity.this.resetRow) {
                    textCell.setText(LocaleController.getString(C2797R.string.ResetChatBackgrounds), false);
                    return;
                } else {
                    if (i == WallpapersListActivity.this.galleryRow) {
                        textCell.setTextAndIcon((CharSequence) "Choose from gallery", C2797R.drawable.msg_background, false);
            ...
            if (itemViewType != 2) {
                ...
                if (i == WallpapersListActivity.this.resetInfoRow) {
                    textInfoPrivacyCell.setText(LocaleController.getString(C2797R.string.ResetChatBackgroundsInfo));
                    return;
                } else {
            ...
            for (int i3 = 0; i3 < WallpapersListActivity.this.columnsCount; i3++) {
                ...
                WallpapersListActivity wallpapersListActivity = WallpapersListActivity.this;
                if (zIsActionModeShowed) {
                    wallpaperCell.setChecked(i3, wallpapersListActivity.selectedWallPapers.indexOfKey(j2) >= 0, !WallpapersListActivity.this.scrolling);
                } else {
                    wallpaperCell.setChecked(i3, false, !wallpapersListActivity.scrolling);
                }
            }
        }
