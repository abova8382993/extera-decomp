...
public class ActionIntroActivity extends BaseFragment implements LocationController.LocationFetchCallback {
    ...
    public View createView(Context context) {
        ...
        C30302 c30302 = new ViewGroup(context) { // from class: org.telegram.ui.ActionIntroActivity.2
            public C30302(Context context2) {
                super(context2);
            }
            ...
            public void onMeasure(int i, int i2) {
                ...
                if (i3 == 0) {
                    ...
                    if (size > size2) {
                        float f4 = size;
                        actionIntroActivity.imageView.measure(View.MeasureSpec.makeMeasureSpec((int) (0.45f * f4), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec((int) (size2 * 0.68f), TLObject.FLAG_30));
                        int i4 = (int) (f4 * 0.6f);
                        ...
                        ActionIntroActivity.this.buttonTextView.measure(View.MeasureSpec.makeMeasureSpec(i4, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(48.0f), TLObject.FLAG_30));
                    } else {
                        actionIntroActivity.imageView.measure(View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec((int) (size2 * 0.399f), TLObject.FLAG_30));
                        ...
                        ActionIntroActivity.this.buttonTextView.measure(View.MeasureSpec.makeMeasureSpec(size - AndroidUtilities.m1036dp(72.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(48.0f), TLObject.FLAG_30));
                    }
                } else if (i3 == 3) {
                    ActionIntroActivity.this.imageView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(150.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(150.0f), TLObject.FLAG_30));
                    ActionIntroActivity actionIntroActivity2 = ActionIntroActivity.this;
                    if (size > size2) {
                        float f5 = size;
                        actionIntroActivity2.subtitleTextView.measure(View.MeasureSpec.makeMeasureSpec((int) (0.45f * f5), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, 0));
                        int i5 = (int) (f5 * 0.6f);
                        ...
                        ActionIntroActivity.this.buttonTextView.measure(View.MeasureSpec.makeMeasureSpec(i5, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(48.0f), TLObject.FLAG_30));
                    } else {
                        actionIntroActivity2.titleTextView.measure(View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, 0));
                        ActionIntroActivity.this.descriptionText.measure(View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, 0));
                        ...
                        ActionIntroActivity.this.buttonTextView.measure(View.MeasureSpec.makeMeasureSpec(size - AndroidUtilities.m1036dp(48.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(48.0f), TLObject.FLAG_30));
                    }
                } else if (i3 != 5) {
                    if (i3 == 6) {
                        int i6 = ActionIntroActivity.this.currentType;
                        ActionIntroActivity actionIntroActivity3 = ActionIntroActivity.this;
                        if (i6 == 6) {
                            actionIntroActivity3.imageView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(140.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(140.0f), TLObject.FLAG_30));
                        } else {
                            actionIntroActivity3.imageView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(100.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(100.0f), TLObject.FLAG_30));
                        }
                        ActionIntroActivity actionIntroActivity4 = ActionIntroActivity.this;
                        if (size > size2) {
                            int i7 = (int) (size * 0.6f);
                            actionIntroActivity4.titleTextView.measure(View.MeasureSpec.makeMeasureSpec(i7, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, 0));
                            ...
                            ActionIntroActivity.this.buttonTextView.measure(View.MeasureSpec.makeMeasureSpec(i7, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(48.0f), TLObject.FLAG_30));
                        } else {
                            actionIntroActivity4.titleTextView.measure(View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, 0));
                            ActionIntroActivity.this.descriptionText.measure(View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, 0));
                            int i8 = ActionIntroActivity.this.currentType;
                            ActionIntroActivity actionIntroActivity5 = ActionIntroActivity.this;
                            if (i8 == 6) {
                                actionIntroActivity5.buttonTextView.measure(View.MeasureSpec.makeMeasureSpec(size - AndroidUtilities.m1036dp(48.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(48.0f), TLObject.FLAG_30));
                            } else {
                                actionIntroActivity5.buttonTextView.measure(View.MeasureSpec.makeMeasureSpec(size - AndroidUtilities.m1036dp(72.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(48.0f), TLObject.FLAG_30));
                            }
                        }
                    }
                    ...
                    ActionIntroActivity.this.buttonTextView.measure(View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(48.0f), TLObject.FLAG_30));
                    size2 = ActionIntroActivity.this.buttonTextView.getMeasuredHeight() + ActionIntroActivity.this.imageView.getMeasuredHeight() + ActionIntroActivity.this.titleTextView.getMeasuredHeight() + AndroidUtilities.m1036dp(20.0f) + ActionIntroActivity.this.titleTextView.getMeasuredHeight() + ActionIntroActivity.this.descriptionLayout.getMeasuredHeight();
                } else {
                    ActionIntroActivity actionIntroActivity6 = ActionIntroActivity.this;
                    if (size > size2) {
                        float f6 = size;
                        actionIntroActivity6.imageView.measure(View.MeasureSpec.makeMeasureSpec((int) (0.45f * f6), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec((int) (size2 * 0.68f), TLObject.FLAG_30));
                        int i9 = (int) (f6 * 0.6f);
                        ActionIntroActivity.this.titleTextView.measure(View.MeasureSpec.makeMeasureSpec(i9, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, 0));
                        ...
                        ActionIntroActivity.this.buttonTextView.measure(View.MeasureSpec.makeMeasureSpec(i9, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(48.0f), TLObject.FLAG_30));
                    } else {
                        actionIntroActivity6.imageView.measure(View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec((int) (size2 * 0.399f), TLObject.FLAG_30));
                        ActionIntroActivity.this.titleTextView.measure(View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, 0));
                        ActionIntroActivity.this.descriptionLayout.measure(View.MeasureSpec.makeMeasureSpec(size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(size2, 0));
                        ActionIntroActivity.this.buttonTextView.measure(View.MeasureSpec.makeMeasureSpec(size, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(48.0f), TLObject.FLAG_30));
                    }
                }
            ...
            public void onLayout(boolean z, int i, int i2, int i3, int i4) {
                ...
                if (i7 == 0) {
                    ...
                    actionIntroActivity.imageView.layout(0, i12, ActionIntroActivity.this.imageView.getMeasuredWidth(), ActionIntroActivity.this.imageView.getMeasuredHeight() + i12);
                ...
                if (i7 == 3) {
                    ...
                    if (i3 > i4) {
                        float f9 = i6;
                        int measuredHeight2 = ((int) ((0.95f * f9) - actionIntroActivity2.imageView.getMeasuredHeight())) / 2;
                        ...
                        int measuredHeight3 = i19 - (ActionIntroActivity.this.subtitleTextView.getMeasuredHeight() + AndroidUtilities.m1036dp(16.0f));
                    ...
                    int i20 = (int) (i6 * 0.3f);
                    int measuredWidth5 = (i5 - actionIntroActivity2.imageView.getMeasuredWidth()) / 2;
                    ...
                    int measuredHeight4 = i20 + ActionIntroActivity.this.imageView.getMeasuredHeight() + AndroidUtilities.m1036dp(24.0f);
                    ...
                    int textSize = (int) (measuredHeight4 + ActionIntroActivity.this.titleTextView.getTextSize() + AndroidUtilities.m1036dp(16.0f));
                    ...
                    int measuredHeight5 = (i6 - ActionIntroActivity.this.buttonTextView.getMeasuredHeight()) - AndroidUtilities.m1036dp(48.0f);
                    ...
                    int measuredHeight6 = measuredHeight5 - (ActionIntroActivity.this.subtitleTextView.getMeasuredHeight() + AndroidUtilities.m1036dp(32.0f));
                ...
                if (i7 != 5) {
                    ...
                    ActionIntroActivity actionIntroActivity3 = ActionIntroActivity.this;
                    if (i3 > i4) {
                        int measuredHeight7 = (i6 - actionIntroActivity3.imageView.getMeasuredHeight()) / 2;
                        float f13 = i5;
                    ...
                    int i25 = (int) (i6 * 0.3f);
                    int measuredWidth10 = (i5 - actionIntroActivity3.imageView.getMeasuredWidth()) / 2;
                    ...
                    int measuredHeight8 = i25 + ActionIntroActivity.this.imageView.getMeasuredHeight() + AndroidUtilities.m1036dp(24.0f);
                    ...
                    int textSize2 = (int) (measuredHeight8 + ActionIntroActivity.this.titleTextView.getTextSize() + AndroidUtilities.m1036dp(16.0f));
                    ...
                    int measuredHeight9 = (i6 - ActionIntroActivity.this.buttonTextView.getMeasuredHeight()) - AndroidUtilities.m1036dp(48.0f);
                ...
                int i33 = AndroidUtilities.displaySize.y;
                ActionIntroActivity actionIntroActivity4 = ActionIntroActivity.this;
                if (i33 < 1800) {
                    float f21 = i6;
                    int i34 = (int) (0.06f * f21);
                    actionIntroActivity4.imageView.layout(0, i34, ActionIntroActivity.this.imageView.getMeasuredWidth(), ActionIntroActivity.this.imageView.getMeasuredHeight() + i34);
                    ...
                    actionIntroActivity4.imageView.layout(0, i36, ActionIntroActivity.this.imageView.getMeasuredWidth(), ActionIntroActivity.this.imageView.getMeasuredHeight() + i36);
        ...
        this.fragmentView = c30302;
        c30302.setBackgroundColor(Theme.getColor(Theme.key_windowBackgroundWhite));
        ...
        this.titleTextView.setPadding(AndroidUtilities.m1036dp(32.0f), 0, AndroidUtilities.m1036dp(32.0f), 0);
        float f4 = 24.0f;
        ...
        this.subtitleTextView.setPadding(AndroidUtilities.m1036dp(32.0f), 0, AndroidUtilities.m1036dp(32.0f), 0);
        ...
        float f6 = 2.0f;
        this.descriptionText.setLineSpacing(AndroidUtilities.m1036dp(2.0f), 1.0f);
        this.descriptionText.setTextSize(1, 15.0f);
        int i2 = this.currentType;
        if (i2 == 6 || i2 == 3) {
            this.descriptionText.setPadding(AndroidUtilities.m1036dp(48.0f), 0, AndroidUtilities.m1036dp(48.0f), 0);
        } else {
            this.descriptionText.setPadding(AndroidUtilities.m1036dp(32.0f), 0, AndroidUtilities.m1036dp(32.0f), 0);
        }
        ...
        if (this.currentType == 5) {
            ...
            f = 32.0f;
            this.descriptionLayout.setPadding(AndroidUtilities.m1036dp(24.0f), 0, AndroidUtilities.m1036dp(24.0f), 0);
            ...
            for (int i4 = 3; i3 < i4; i4 = 3) {
                ...
                if (i3 == 0) {
                    ...
                    String string = LocaleController.getString(C2797R.string.AuthAnotherClientInfo1);
                    ...
                    if (iIndexOf != -1 && iLastIndexOf != -1 && iIndexOf != iLastIndexOf) {
                        ...
                        spannableStringBuilder.setSpan(new URLSpanNoUnderline(LocaleController.getString(C2797R.string.AuthAnotherClientDownloadClientUrl)), iIndexOf, iLastIndexOf - 1, 33);
                    }
                    this.descriptionLines[i8].setText(spannableStringBuilder);
                } else {
                    TextView[] textViewArr = this.descriptionLines;
                    if (i3 == 1) {
                        textViewArr[i8].setText(LocaleController.getString(C2797R.string.AuthAnotherClientInfo2));
                    } else {
                        textViewArr[i8].setText(LocaleController.getString(C2797R.string.AuthAnotherClientInfo3));
                    }
                }
        ...
        this.descriptionText2.setLineSpacing(AndroidUtilities.m1036dp(f3), 1.0f);
        this.descriptionText2.setTextSize(1, 13.0f);
        this.descriptionText2.setVisibility(8);
        this.descriptionText2.setPadding(AndroidUtilities.m1036dp(f), 0, AndroidUtilities.m1036dp(f), 0);
        ...
        C30313 c30313 = new TextView(context2) { // from class: org.telegram.ui.ActionIntroActivity.3
            private final CellFlickerDrawable cellFlickerDrawable;

            public C30313(Context context2) {
                super(context2);
        ...
        this.buttonTextView = c30313;
        ScaleStateListAnimator.apply(c30313, 0.02f, 1.2f);
        ...
        this.buttonTextView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1036dp(f2), 0, Theme.getColor(Theme.key_featuredStickers_addButtonPressed)));
        ...
        if (i9 == 0) {
            ...
            this.imageView.setAnimation(C2797R.raw.channel_create, 200, 200);
            this.titleTextView.setText(LocaleController.getString(C2797R.string.ChannelAlertTitle));
            this.descriptionText.setText(LocaleController.getString(C2797R.string.ChannelAlertText));
            this.buttonTextView.setText(LocaleController.getString(C2797R.string.ChannelAlertCreate2));
            this.imageView.playAnimation();
            this.flickerButton = true;
        } else if (i9 == 3) {
            this.subtitleTextView.setVisibility(0);
            this.imageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
            this.imageView.setAnimation(C2797R.raw.utyan_change_number, 200, 200);
            ...
            if (user != null) {
                this.subtitleTextView.setText(LocaleController.formatString("PhoneNumberKeepButton", C2797R.string.PhoneNumberKeepButton, PhoneFormat.getInstance().format("+" + user.phone)));
            }
            ...
            this.titleTextView.setText(LocaleController.getString(C2797R.string.PhoneNumberChange2));
            this.descriptionText.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2797R.string.PhoneNumberHelp)));
            this.buttonTextView.setText(LocaleController.getString(C2797R.string.PhoneNumberChange2));
            this.imageView.playAnimation();
            this.flickerButton = true;
        } else if (i9 == 5) {
            int[] iArr = new int[8];
            this.colors = iArr;
            this.imageView.setAnimation(C2797R.raw.qr_login, 334, 334, iArr);
            this.imageView.setScaleType(ImageView.ScaleType.CENTER);
            this.titleTextView.setText(LocaleController.getString(C2797R.string.AuthAnotherClient));
            this.buttonTextView.setText(LocaleController.getString(C2797R.string.AuthAnotherClientScan));
            this.imageView.playAnimation();
        } else if (i9 == 6) {
            this.imageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
            this.imageView.setAnimation(C2797R.raw.utyan_passcode, 200, 200);
            ...
            this.titleTextView.setText(LocaleController.getString(C2797R.string.Passcode));
            this.descriptionText.setText(LocaleController.getString(C2797R.string.ChangePasscodeInfoShort));
            this.buttonTextView.setText(LocaleController.getString(C2797R.string.EnablePasscode));
            this.imageView.playAnimation();
            this.flickerButton = true;
        }
        if (this.flickerButton) {
            this.buttonTextView.setPadding(AndroidUtilities.m1036dp(34.0f), AndroidUtilities.m1036dp(8.0f), AndroidUtilities.m1036dp(34.0f), AndroidUtilities.m1036dp(8.0f));
    ...
    public class C30291 extends ActionBar.ActionBarMenuOnItemClick {
        public C30291() {
        }
    ...
    public class C30302 extends ViewGroup {
        public C30302(Context context2) {
            super(context2);
        }
    ...
    public class C30313 extends TextView {
        private final CellFlickerDrawable cellFlickerDrawable;
    ...
    public /* synthetic */ void lambda$createView$2(View view) {
        ...
        if (i == 3) {
            ...
            builder.setTitle(LocaleController.getString(C2797R.string.PhoneNumberChangeTitle));
            builder.setMessage(LocaleController.getString(C2797R.string.PhoneNumberAlert));
            builder.setPositiveButton(LocaleController.getString(C2797R.string.Change), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ActionIntroActivity$$ExternalSyntheticLambda7
    ...
    public void updateColors() {
        ...
        this.buttonTextView.setTextColor(Theme.getColor(Theme.key_featuredStickers_buttonText));
        this.buttonTextView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1036dp(24.0f), 0, Theme.getColor(Theme.key_featuredStickers_addButtonPressed)));
    ...
    public class C30324 implements CameraScanActivity.CameraScanActivityDelegate {
        public C30324() {
        }
