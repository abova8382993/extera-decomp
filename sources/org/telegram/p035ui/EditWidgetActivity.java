...
public class EditWidgetActivity extends BaseFragment {
    ...
    public class WidgetPreviewCell extends FrameLayout {
        ...
        public WidgetPreviewCell(Context context) {
            ...
            setPadding(0, AndroidUtilities.m1036dp(24.0f), 0, AndroidUtilities.m1036dp(24.0f));
            LinearLayout linearLayout = new LinearLayout(context);
            linearLayout.setOrientation(1);
            addView(linearLayout, LayoutHelper.createFrame(-2, -2, 17));
            ChatActionCell chatActionCell = new ChatActionCell(context);
            chatActionCell.setCustomText(LocaleController.getString(C2797R.string.WidgetPreview));
            linearLayout.addView(chatActionCell, LayoutHelper.createLinear(-2, -2, 17, 0, 0, 0, 4));
            LinearLayout linearLayout2 = new LinearLayout(context);
            linearLayout2.setOrientation(1);
            linearLayout2.setBackgroundResource(C2797R.drawable.widget_bg);
            ...
            if (EditWidgetActivity.this.widgetType == 0) {
                while (i < 2) {
                    this.cells[i] = (ViewGroup) EditWidgetActivity.this.getParentActivity().getLayoutInflater().inflate(C2797R.layout.shortcut_widget_item, (ViewGroup) null);
                ...
                EditWidgetActivity.this.previewImageView.setImageResource(C2797R.drawable.chats_widget_preview);
            } else if (EditWidgetActivity.this.widgetType == 1) {
                while (i < 2) {
                    this.cells[i] = (ViewGroup) EditWidgetActivity.this.getParentActivity().getLayoutInflater().inflate(C2797R.layout.contacts_widget_item, (ViewGroup) null);
                ...
                EditWidgetActivity.this.previewImageView.setImageResource(C2797R.drawable.contacts_widget_preview);
            }
            updateDialogs();
        ...
        /* JADX WARN: Removed duplicated region for block: B:480:0x0089  */
        /* JADX WARN: Removed duplicated region for block: B:481:0x0096  */
        /* JADX WARN: Removed duplicated region for block: B:573:0x025c  */
        /* JADX WARN: Removed duplicated region for block: B:575:0x025f  */
        /* JADX WARN: Removed duplicated region for block: B:588:0x02ad  */
        /* JADX WARN: Removed duplicated region for block: B:706:0x055a  */
        /* JADX WARN: Removed duplicated region for block: B:713:0x0599  */
        /* JADX WARN: Removed duplicated region for block: B:717:0x05ef  */
        /* JADX WARN: Removed duplicated region for block: B:734:0x0690  */
        /* JADX WARN: Removed duplicated region for block: B:862:0x08be  */
        /* JADX WARN: Removed duplicated region for block: B:875:0x0904  */
        ...
        /* JADX WARN: Type inference failed for: r4v25, types: [android.graphics.drawable.Drawable, org.telegram.ui.Components.AvatarDrawable] */
        /* JADX WARN: Type inference failed for: r4v26, types: [org.telegram.ui.Components.AvatarDrawable] */
        /* JADX WARN: Type inference failed for: r4v34 */
        /* JADX WARN: Type inference failed for: r4v35 */
        /* JADX WARN: Type inference failed for: r4v36 */
        /* JADX WARN: Type inference failed for: r4v37 */
        /* JADX WARN: Type inference failed for: r5v48, types: [org.telegram.messenger.FileLoader] */
        /*
        ...
        */
        ...
        public void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(264.0f), TLObject.FLAG_30));
        }
    ...
    public View createView(final Context context) {
        ...
        if (i == 0) {
            actionBar.setTitle(LocaleController.getString(C2797R.string.WidgetChats));
        } else {
            actionBar.setTitle(LocaleController.getString(C2797R.string.WidgetShortcuts));
        }
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.EditWidgetActivity.1
            ...
            public void onItemClick(int i2) {
                ...
                while (true) {
                    ...
                    arrayList.add(MessagesStorage.TopicKey.m1066of(((Long) editWidgetActivity.selectedDialogs.get(i3)).longValue(), 0L));
                    i3++;
                }
        ...
        this.listView.setOnItemLongClickListener(new C55772());
        return this.fragmentView;
    }

    /* JADX INFO: renamed from: org.telegram.ui.EditWidgetActivity$1 */
    public class C55761 extends ActionBar.ActionBarMenuOnItemClick {
        public C55761() {
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.EditWidgetActivity$2 */
    public class C55772 implements RecyclerListView.OnItemLongClickListenerExtended {
        ...
        public boolean onItemClick(View view, final int i, float f, float f2) {
            if (EditWidgetActivity.this.getParentActivity() != null && (view instanceof GroupCreateUserCell)) {
                ((ImageView) view.getTag(C2797R.id.object_tag)).getHitRect(this.rect);
                if (!this.rect.contains((int) f, (int) f2)) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(EditWidgetActivity.this.getParentActivity());
                    builder.setItems(new CharSequence[]{LocaleController.getString(C2797R.string.Delete)}, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.EditWidgetActivity$2$$ExternalSyntheticLambda0
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                groupCreateUserCell.setTag(C2797R.id.object_tag, imageView);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (i == EditWidgetActivity.this.infoRow) {
                    ...
                    if (EditWidgetActivity.this.widgetType == 0) {
                        spannableStringBuilder.append((CharSequence) LocaleController.getString(C2797R.string.EditWidgetChatsInfo));
                    } else if (EditWidgetActivity.this.widgetType == 1) {
                        spannableStringBuilder.append((CharSequence) LocaleController.getString(C2797R.string.EditWidgetContactsInfo));
                    }
                    if (SharedConfig.passcodeHash.length() > 0) {
                        spannableStringBuilder.append((CharSequence) "\n\n").append((CharSequence) AndroidUtilities.replaceTags(LocaleController.getString(C2797R.string.WidgetPasscode2)));
                    }
            ...
            textCell.setTextAndIcon(LocaleController.getString(C2797R.string.SelectChats), new CombinedDrawable(drawable, drawable2), EditWidgetActivity.this.chatsStartRow != -1);
            textCell.getImageView().setPadding(0, AndroidUtilities.m1036dp(7.0f), 0, 0);
        }
