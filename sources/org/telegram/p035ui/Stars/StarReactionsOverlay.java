...
public class StarReactionsOverlay extends View {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (reactionButton != null) {
            ...
            int i2 = iArr2[0];
            int[] iArr3 = this.pos2;
            int i3 = (i2 - iArr3[0]) + reactionsLayoutInBubble.f1656x + reactionButton.f1658x;
            int i4 = (iArr2[1] - iArr3[1]) + reactionsLayoutInBubble.f1657y + reactionButton.f1659y;
            float f2 = i3;
            float f3 = i4;
            f = 12.0f;
            ...
            i = 0;
            this.shadowPaint.setShadowLayer(AndroidUtilities.m1036dp(12.0f), 0.0f, AndroidUtilities.m1036dp(3.0f), Theme.multAlpha(1426063360, this.focus));
        ...
        if (reactionButton != null) {
            ...
            this.clickBounds.inset(-AndroidUtilities.m1036dp(42.0f), -AndroidUtilities.m1036dp(42.0f));
            int iM1036dp = (int) (AndroidUtilities.m1036dp(90.0f) * fLerp);
            int i6 = i;
            while (i6 < this.effects.size()) {
                RLottieDrawable rLottieDrawable = this.effects.get(i6);
                if (rLottieDrawable.getCurrentFrame() >= rLottieDrawable.getFramesCount()) {
                    this.effects.remove(i6);
                    i6--;
                } else {
                    float f4 = iM1036dp / 2.0f;
                    rLottieDrawable.setBounds((int) ((this.reactionBounds.left + (AndroidUtilities.m1036dp(15.0f) * fLerp)) - f4), (int) (this.reactionBounds.centerY() - f4), (int) (this.reactionBounds.left + (AndroidUtilities.m1036dp(15.0f) * fLerp) + f4), (int) (this.reactionBounds.centerY() + f4));
            ...
            float fM1036dp = this.reactionBounds.top - AndroidUtilities.m1036dp(36.0f);
            canvas.save();
            float f5 = this.counterAlpha.set(this.counterShown);
            canvas.translate(0.0f, (this.counterShown ? AndroidUtilities.m1036dp(60.0f) : -AndroidUtilities.m1036dp(30.0f)) * (1.0f - f5));
            float fLerp2 = AndroidUtilities.lerp(this.counterShown ? 1.8f : 1.3f, 1.0f, f5);
            canvas.scale(fLerp2, fLerp2, fCenterX, fM1036dp);
            this.counter.setAlpha((int) (255.0f * f5));
            this.counter.setShadowLayer(AndroidUtilities.m1036dp(f), 0.0f, AndroidUtilities.m1036dp(3.5f), Theme.multAlpha(-1442840576, f5));
            this.counter.setBounds(fCenterX - AndroidUtilities.m1036dp(100.0f), this.reactionBounds.top - AndroidUtilities.m1036dp(48.0f), fCenterX + AndroidUtilities.m1036dp(100.0f), this.reactionBounds.top - AndroidUtilities.m1036dp(24.0f));
    ...
    public void tap(float f, float f2, boolean z, boolean z2) {
        ...
        if (z2) {
            ...
            float f3 = this.accumulatedRippleIntensity;
            if (j < 100) {
                this.accumulatedRippleIntensity = f3 + 0.5f;
                return;
            }
            this.accumulatedRippleIntensity = f3 * Utilities.clamp(1.0f - (((jCurrentTimeMillis - r1) - 100) / 200.0f), 1.0f, 0.0f);
