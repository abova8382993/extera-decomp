...
public class StarGiftUniqueActionLayout {
    ...
    public StarGiftUniqueActionLayout(int i, ChatActionCell chatActionCell, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.emoji = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(chatActionCell, AndroidUtilities.m1036dp(28.0f));
    }

    /* JADX WARN: Removed duplicated region for block: B:128:0x0012  */
    /*
    ...
    */
    public void set(org.telegram.messenger.MessageObject r13, boolean r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Stars.StarGiftUniqueActionLayout.set(org.telegram.messenger.MessageObject, boolean):void");
    }
    ...
    public void draw(Canvas canvas) {
        ...
        this.backgroundPath.addRoundRect(this.backgroundRect, AndroidUtilities.m1036dp(14.0f), AndroidUtilities.m1036dp(14.0f), Path.Direction.CW);
        canvas.save();
        ...
        canvas.save();
        canvas.translate(width, AndroidUtilities.m1036dp(65.0f));
        ...
        canvas.restore();
        this.imageReceiver.setImageCoords(width - (AndroidUtilities.m1036dp(110.0f) / 2.0f), AndroidUtilities.m1036dp(10.0f), AndroidUtilities.m1036dp(110.0f), AndroidUtilities.m1036dp(110.0f));
        ...
        int i = iMultAlpha;
        this.title.ellipsize(getWidth() - AndroidUtilities.m1036dp(12.0f));
        Text text = this.title;
        text.draw(canvas, width - (text.getCurrentWidth() / 2.0f), this.titleY, -1, 1.0f);
        this.subtitle.ellipsize(getWidth() - AndroidUtilities.m1036dp(12.0f));
        Text text2 = this.subtitle;
        int i2 = i;
        text2.draw(canvas, width - (text2.getCurrentWidth() / 2.0f), this.subtitleY, i2, 1.0f);
        float fM1036dp = this.nameWidth + AndroidUtilities.m1036dp(9.0f) + this.valueWidth;
        ArrayList<Row> arrayList = this.table;
        ...
        while (i3 < size) {
            ...
            Text text3 = row.name;
            float f2 = width - (fM1036dp / 2.0f);
            text3.draw(canvas, (f2 + this.nameWidth) - text3.getCurrentWidth(), row.f1770y, i2, 1.0f);
            row.value.draw(canvas, f2 + this.nameWidth + AndroidUtilities.m1036dp(9.0f), row.f1770y, -1, 1.0f);
            i3 = i4;
            i2 = i2;
        }
        int i5 = i2;
        if (!this.repost) {
            this.buttonRect.set(width - ((this.buttonText.getCurrentWidth() + AndroidUtilities.m1036dp(30.0f)) / 2.0f), this.buttonY, width + ((this.buttonText.getCurrentWidth() + AndroidUtilities.m1036dp(30.0f)) / 2.0f), this.buttonY + this.buttonHeight);
            ...
            canvas.restore();
            this.ribbon.setBounds(((int) this.backgroundRect.right) - AndroidUtilities.m1036dp(46.67f), ((int) this.backgroundRect.top) - AndroidUtilities.m1036dp(1.33f), ((int) this.backgroundRect.right) + AndroidUtilities.m1036dp(1.33f), ((int) this.backgroundRect.top) + AndroidUtilities.m1036dp(46.67f));
    ...
    public void drawOutbounds(Canvas canvas) {
        ...
        this.buttonText.draw(canvas, this.buttonRect.left + AndroidUtilities.m1036dp(15.0f), this.buttonRect.centerY(), -1, 1.0f);
        canvas.restore();
