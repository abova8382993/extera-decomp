...
public class SuperRipple extends ISuperRipple {
    ...
    public static class Effect {
        ...
        public final float f1782cx;

        /* JADX INFO: renamed from: cy */
        public final float f1783cy;
        public final float intensity;
    ...
    public SuperRipple(View view) {
        ...
        this.MAX_COUNT = 7;
        this.f1781t = new float[7];
        this.centerX = new float[7];
        this.centerY = new float[7];
        this.intensity = new float[7];
        RuntimeShader runtimeShaderM1154m = AbstractC4547xcbc2f459.m1154m(AndroidUtilities.readRes(C2797R.raw.superripple_effect));
        this.shader = runtimeShaderM1154m;
        setupSizeUniforms(true);
        this.effect = RenderEffect.createRuntimeShaderEffect(runtimeShaderM1154m, "img");
    }
    ...
    */
    private void setupSizeUniforms(boolean r11) {
        ...
        L9a:
            ...
            if (r10 == r0) goto La9
            int r10 = org.telegram.messenger.AndroidUtilities.navigationBarHeight
            if (r10 <= 0) goto La9
            goto Lb0
        La9:
            int r10 = r3.getRadius()
            float r10 = (float) r10
            r8 = r10
            goto Lb1
        Lb0:
        ...
        Lbb:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Stars.SuperRipple.setupSizeUniforms(boolean):void");
    }

    @Override // org.telegram.p035ui.Stars.ISuperRipple
    ...
    public /* synthetic */ void lambda$animate$0(Effect effect, ValueAnimator valueAnimator) {
        effect.f1784t = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        updateProperties();
    }
    ...
    public void updateProperties() {
        ...
        if (!this.effects.isEmpty()) {
            ...
            for (int i = 0; i < this.count; i++) {
                ...
                boolean z4 = z3 || Math.abs(this.f1781t[i] - effect.f1784t) > 0.001f;
                this.f1781t[i] = effect.f1784t;
                boolean z5 = z4 || Math.abs(this.centerX[i] - effect.f1782cx) > 0.001f;
                this.centerX[i] = effect.f1782cx;
                boolean z6 = z5 || Math.abs(this.centerY[i] - effect.f1783cy) > 0.001f;
                this.centerY[i] = effect.f1783cy;
            ...
            if (z2) {
                ...
                this.shader.setFloatUniform("t", this.f1781t);
