...
public class MessageSuggestionOfferSheet extends BottomSheet {
    ...
    public MessageSuggestionOfferSheet(final Context context, final int i, final long j, MessageSuggestionParams messageSuggestionParams, final ChatActivity chatActivity, final Theme.ResourcesProvider resourcesProvider, int i2, final Utilities.Callback<MessageSuggestionParams> callback) {
        int i3;
        boolean z;
        ...
        if (i2 == 0) {
            i3 = C2797R.string.PostSuggestionsOfferTitle;
        } else {
            i3 = C2797R.string.PostSuggestionsOfferChangeTitle;
        }
        ...
        imageView2.setImageResource(C2797R.drawable.star_small_inner);
        ...
        imageView3.setImageResource(C2797R.drawable.mini_gram_72);
        ...
        C67371 c67371 = new EditTextBoldCursor(context) { // from class: org.telegram.ui.Stars.MessageSuggestionOfferSheet.1
            @Override // org.telegram.p035ui.Components.EditTextEffects, android.view.View
            public boolean dispatchTouchEvent(MotionEvent motionEvent) {
                return false;
            }

            public C67371(final Context context2) {
                super(context2);
            }
        };
        this.publishingTimeField = c67371;
        c67371.setCursorSize(AndroidUtilities.m1036dp(20.0f));
        c67371.setCursorWidth(1.5f);
        c67371.setTextSize(1, 17.0f);
        c67371.setMaxLines(1);
        c67371.setBackground(null);
        c67371.setPadding(AndroidUtilities.m1036dp(16.0f), AndroidUtilities.m1036dp(16.0f), AndroidUtilities.m1036dp(16.0f), AndroidUtilities.m1036dp(16.0f));
        c67371.setTextColor(Theme.getColor(i4));
        c67371.setFocusable(false);
        c67371.setClickable(false);
        c67371.setEnabled(false);
        OutlineTextContainerView outlineTextContainerView2 = new OutlineTextContainerView(context2);
        outlineTextContainerView2.setText(LocaleController.getString(C2797R.string.PostSuggestionsOfferTitleTime));
        outlineTextContainerView2.attachEditText(c67371);
        outlineTextContainerView2.addView(c67371, LayoutHelper.createFrame(-1, -2.0f, 48, 0.0f, 0.0f, 48.0f, 0.0f));
        ...
        outlineTextContainerView2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Stars.MessageSuggestionOfferSheet$$ExternalSyntheticLambda4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$new$5(context2, resourcesProvider, view);
            }
        });
        ...
        imageView4.setImageResource(C2797R.drawable.arrow_more);
        ...
        spannableStringBuilder.append((CharSequence) AndroidUtilities.replaceTags(LocaleController.getString(C2797R.string.PostSuggestionsAddTimeHint)));
        spannableStringBuilder.append(' ');
        spannableStringBuilder.append((CharSequence) AndroidUtilities.replaceTags(LocaleController.formatString(C2797R.string.PostSuggestionsAddTimeHint2, Long.valueOf(MessagesController.getInstance(i).config.starsSuggestedPostAgeMin.get(TimeUnit.HOURS)))));
        ...
        buttonWithCounterView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Stars.MessageSuggestionOfferSheet$$ExternalSyntheticLambda5
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$new$6(chatActivity, i, context2, resourcesProvider, j, callback, view);
            }
        });
        if (i2 == 1) {
            buttonWithCounterView.setText(LocaleController.getString(C2797R.string.PostSuggestionsOfferChangeUpdateTerms), false);
        }
        ...
        editTextBoldCursor.addTextChangedListener(new TextWatcher() { // from class: org.telegram.ui.Stars.MessageSuggestionOfferSheet.2
            ...
            public void afterTextChanged(Editable editable) {
                ...
                MessageSuggestionOfferSheet.this.starsCountEditOutline.animateSelection(MessageSuggestionOfferSheet.this.starsCountEditField.isFocused(), !TextUtils.isEmpty(MessageSuggestionOfferSheet.this.starsCountEditField.getText()));
            }
        });
    }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Stars.MessageSuggestionOfferSheet$1 */
    public class C67371 extends EditTextBoldCursor {
        @Override // org.telegram.p035ui.Components.EditTextEffects, android.view.View
        public boolean dispatchTouchEvent(MotionEvent motionEvent) {
            return false;
        }
    ...
    public /* synthetic */ void lambda$new$6(ChatActivity chatActivity, int i, Context context, Theme.ResourcesProvider resourcesProvider, long j, Utilities.Callback callback, View view) {
        ...
        if (!this.isMonoForumAdmin && (amountUtils$AmountM1099of == null || amountUtils$AmountM1099of.asNano() < this.inputAmount.asNano())) {
        ...
        callback.run(MessageSuggestionParams.m1056of(this.inputAmount, this.selectedTime));
        lambda$new$0();
    }

    /* JADX INFO: renamed from: org.telegram.ui.Stars.MessageSuggestionOfferSheet$2 */
    public class C67382 implements TextWatcher {
        @Override // android.text.TextWatcher
        public void beforeTextChanged(CharSequence charSequence, int i7, int i8, int i9) {
        }
    ...
    private void onCurrencyChanged(boolean z) {
        ...
        if (amountUtils$Currency == amountUtils$Currency2) {
            this.starsCountEditHint.setText(LocaleController.getString(C2797R.string.PostSuggestionsOfferSubtitleStars));
            ...
            this.starsCountEditHint.setText(LocaleController.getString(C2797R.string.PostSuggestionsOfferSubtitleTON));
    ...
    private void checkButtonOfferText(boolean z) {
        ...
        if (this.mode == 0) {
            if (!this.inputAmount.isZero()) {
                ...
                int i = C2797R.string.PostSuggestionsOfferStars;
                if (z2) {
            ...
            this.buttonView.setText(LocaleController.getString(C2797R.string.PostSuggestionsOfferForFree), z);
            return;
        }
        this.buttonView.setText(LocaleController.getString(C2797R.string.PostSuggestionsOfferChangeUpdateTerms), z);
    }
    ...
    private void checkAmountInputText(boolean z) {
        ...
        if ((i2 & 4) != 0) {
            this.starsCountEditOutline.setText(LocaleController.formatString(C2797R.string.SuggestAPostTooMuch, getInputAmountMax().formatAsDecimalSpaced()));
            return;
        }
        if ((i2 & 2) != 0) {
            this.starsCountEditOutline.setText(LocaleController.formatString(C2797R.string.SuggestAPostTooSmall, getInputAmountMin().formatAsDecimalSpaced()));
            return;
        }
        if (this.inputAmount.currency == AmountUtils$Currency.STARS) {
            i = C2797R.string.PostSuggestionsOfferTitlePriceStars;
        } else {
            i = C2797R.string.PostSuggestionsOfferTitlePriceTON;
        }
    ...
    public static String formatDateTime(long j) {
        if (j <= 0) {
            return LocaleController.getString(C2797R.string.PostSuggestionsAnytime);
        }
