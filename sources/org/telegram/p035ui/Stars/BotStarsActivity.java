...
public class BotStarsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private final ChannelMonetizationLayout.ProceedOverview availableValue = ChannelMonetizationLayout.ProceedOverview.m1137as("XTR", LocaleController.getString(C2797R.string.BotStarsOverviewAvailableBalance));
    private final ChannelMonetizationLayout.ProceedOverview totalValue = ChannelMonetizationLayout.ProceedOverview.m1137as("XTR", LocaleController.getString(C2797R.string.BotStarsOverviewTotalBalance));
    private final ChannelMonetizationLayout.ProceedOverview totalProceedsValue = ChannelMonetizationLayout.ProceedOverview.m1137as("XTR", LocaleController.getString(C2797R.string.BotStarsOverviewTotalProceeds));
    private final ChannelMonetizationLayout.ProceedOverview tonAvailableValue = ChannelMonetizationLayout.ProceedOverview.m1137as("TON", LocaleController.getString(C2797R.string.BotMonetizationOverviewAvailable));
    private final ChannelMonetizationLayout.ProceedOverview tonLastWithdrawalValue = ChannelMonetizationLayout.ProceedOverview.m1137as("TON", LocaleController.getString(C2797R.string.BotMonetizationOverviewLastWithdrawal));
    private final ChannelMonetizationLayout.ProceedOverview tonLifetimeValue = ChannelMonetizationLayout.ProceedOverview.m1137as("TON", LocaleController.getString(C2797R.string.BotMonetizationOverviewTotal));
    ...
    private String tonTransactionsLastOffset = _UrlKt.FRAGMENT_ENCODE_SET;
    private Runnable setBalanceButtonText = new Runnable() { // from class: org.telegram.ui.Stars.BotStarsActivity$$ExternalSyntheticLambda0
    ...
    public BotStarsActivity(int i, long j) {
        ...
        this.withdrawInfo = AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(z ? LocaleController.formatPluralStringComma("SelfStarsWithdrawInfo", (int) getMessagesController().starsRevenueWithdrawalMin) : LocaleController.getString(C2797R.string.BotStarsWithdrawInfo), new Runnable() { // from class: org.telegram.ui.Stars.BotStarsActivity$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$new$0() {
        Browser.openUrl(getContext(), LocaleController.getString(C2797R.string.BotStarsWithdrawInfoLink));
    }
    ...
    public View createView(final Context context) {
        ...
        if (i == 0) {
            chatAvatarContainer2.setSubtitle(LocaleController.getString(C2797R.string.BotStatsStars));
        } else {
            chatAvatarContainer2.setSubtitle(LocaleController.getString(C2797R.string.BotStatsTON));
        }
        ...
        C67232 c67232 = new LinearLayout(context) { // from class: org.telegram.ui.Stars.BotStarsActivity.2
            public C67232(final Context context2) {
                super(context2);
            }
        ...
        this.balanceLayout = c67232;
        c67232.setOrientation(1);
        this.balanceLayout.setBackgroundColor(Theme.getColor(i3, getResourceProvider()));
        this.balanceLayout.setPadding(0, 0, 0, AndroidUtilities.m1036dp(17.0f));
        ...
        this.balanceTitle.setTextSize(AndroidUtilities.m1036dp(32.0f));
        ...
        AnimatedTextView animatedTextView3 = new AnimatedTextView(context2, true, true, true);
        ...
        this.balanceSubtitle.setTextSize(AndroidUtilities.m1036dp(14.0f));
        this.balanceLayout.addView(this.balanceSubtitle, LayoutHelper.createFrame(-1, 17.0f, 49, 22.0f, 4.0f, 22.0f, 0.0f));
        C67243 c67243 = new OutlineTextContainerView(context2) { // from class: org.telegram.ui.Stars.BotStarsActivity.3
            public C67243(final Context context2) {
                super(context2);
            }
        ...
        this.balanceEditTextContainer = c67243;
        c67243.setText(LocaleController.getString(C2797R.string.BotStarsWithdrawPlaceholder));
        this.balanceEditTextContainer.setLeftPadding(AndroidUtilities.m1036dp(36.0f));
        C67254 c67254 = new EditTextBoldCursor(context2) { // from class: org.telegram.ui.Stars.BotStarsActivity.4
            public C67254(final Context context2) {
                super(context2);
            }
        ...
        this.balanceEditText = c67254;
        c67254.setFocusable(false);
        this.balanceEditText.setTextColor(getThemedColor(i4));
        this.balanceEditText.setCursorSize(AndroidUtilities.m1036dp(20.0f));
        ...
        this.balanceEditText.setPadding(AndroidUtilities.m1036dp(6.0f), iM1036dp, iM1036dp, iM1036dp);
        ...
        this.balanceEditText.setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: org.telegram.ui.Stars.BotStarsActivity$$ExternalSyntheticLambda2
        ...
        this.balanceEditText.setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: org.telegram.ui.Stars.BotStarsActivity$$ExternalSyntheticLambda3
        ...
        ButtonWithCounterView round = new ButtonWithCounterView(context2, getResourceProvider()) { // from class: org.telegram.ui.Stars.BotStarsActivity.6
            @Override // org.telegram.p035ui.Stories.recorder.ButtonWithCounterView
            public boolean subTextSplitToWords() {
                return false;
            }

            public C67276(final Context context2, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.balanceButton.setText(LocaleController.getString(C2797R.string.BotStarsButtonWithdrawShortAll), false);
        this.balanceButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Stars.BotStarsActivity$$ExternalSyntheticLambda4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$createView$3(view);
            }
        });
        ButtonWithCounterView round2 = new ButtonWithCounterView(context2, getResourceProvider()).setRound();
        this.adsButton = round2;
        round2.setEnabled(true);
        this.adsButton.setText(LocaleController.getString(C2797R.string.MonetizationStarsAds), false);
        this.adsButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Stars.BotStarsActivity$$ExternalSyntheticLambda5
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$createView$7(context2, view);
            }
        });
        this.balanceButtonsLayout.addView(this.balanceButton, LayoutHelper.createLinear(-1, 48, 1.0f, 119));
        if (!this.self) {
            this.balanceButtonsLayout.addView(new Space(context2), LayoutHelper.createLinear(8, 48, 0.0f, 119));
        ...
        C67287 c67287 = new LinearLayout(context2) { // from class: org.telegram.ui.Stars.BotStarsActivity.7
            public C67287(final Context context2) {
                super(context2);
            }
        ...
        this.tonBalanceLayout = c67287;
        c67287.setOrientation(1);
        this.tonBalanceLayout.setBackgroundColor(Theme.getColor(i3, this.resourceProvider));
        this.tonBalanceLayout.setPadding(0, 0, 0, AndroidUtilities.m1036dp(17.0f));
        AnimatedTextView animatedTextView5 = new AnimatedTextView(context2, false, true, true);
        ...
        this.tonBalanceTitle.setTextSize(AndroidUtilities.m1036dp(32.0f));
        ...
        AnimatedTextView animatedTextView6 = new AnimatedTextView(context2, true, true, true);
        ...
        this.tonBalanceSubtitle.setTextSize(AndroidUtilities.m1036dp(14.0f));
        ...
        this.tonBalanceButton.setText(LocaleController.getString(this.self ? C2797R.string.MonetizationSelfWithdraw : C2797R.string.MonetizationWithdraw), false);
        this.tonBalanceButton.setVisibility(8);
        this.tonBalanceButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Stars.BotStarsActivity$$ExternalSyntheticLambda6
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Stars.BotStarsActivity$1 */
    public class C67221 extends ActionBar.ActionBarMenuOnItemClick {
        public C67221() {
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Stars.BotStarsActivity$2 */
    public class C67232 extends LinearLayout {
        public C67232(final Context context2) {
            super(context2);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Stars.BotStarsActivity$3 */
    public class C67243 extends OutlineTextContainerView {
        public C67243(final Context context2) {
            super(context2);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Stars.BotStarsActivity$4 */
    public class C67254 extends EditTextBoldCursor {
        public C67254(final Context context2) {
            super(context2);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Stars.BotStarsActivity$5 */
    public class C67265 implements TextWatcher {
        @Override // android.text.TextWatcher
        public void beforeTextChanged(CharSequence charSequence, int i6, int i7, int i8) {
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Stars.BotStarsActivity$6 */
    public class C67276 extends ButtonWithCounterView {
        @Override // org.telegram.p035ui.Stories.recorder.ButtonWithCounterView
        public boolean subTextSplitToWords() {
            return false;
        }
    ...
    public /* synthetic */ void lambda$createView$7(final Context context, View view) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_payments_getStarsRevenueAdsAccountUrl, new RequestDelegate() { // from class: org.telegram.ui.Stars.BotStarsActivity$$ExternalSyntheticLambda15
    ...
    public /* synthetic */ void lambda$createView$6(final Context context, final TLObject tLObject, TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.BotStarsActivity$$ExternalSyntheticLambda19
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Stars.BotStarsActivity$7 */
    public class C67287 extends LinearLayout {
        public C67287(final Context context2) {
            super(context2);
        }
    ...
    public /* synthetic */ void lambda$createView$10(View view) {
        ...
        twoStepVerificationActivity.setDelegate(1, new TwoStepVerificationActivity.TwoStepVerificationActivityDelegate() { // from class: org.telegram.ui.Stars.BotStarsActivity$$ExternalSyntheticLambda10
        ...
        twoStepVerificationActivity.preload(new Runnable() { // from class: org.telegram.ui.Stars.BotStarsActivity$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Stars.BotStarsActivity$8 */
    public class C67298 extends RecyclerView.OnScrollListener {
        public C67298() {
        }
    ...
    private void withdraw() {
        ...
        if (this.balanceBlockedUntil > currentTime) {
            this.withdrawalBulletin = BulletinFactory.m1143of(this).createSimpleBulletin(C2797R.raw.timer_3, AndroidUtilities.replaceTags(LocaleController.formatString(C2797R.string.BotStarsWithdrawalToast, untilString(this.balanceBlockedUntil - currentTime)))).show();
            return;
        }
        if (this.balanceEditTextValue < getMessagesController().starsRevenueWithdrawalMin) {
            BulletinFactory.m1143of(this).createSimpleBulletin(getContext().getResources().getDrawable(C2797R.drawable.star_small_inner).mutate(), AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("BotStarsWithdrawMinLimit", (int) getMessagesController().starsRevenueWithdrawalMin, new Object[0]), new Runnable() { // from class: org.telegram.ui.Stars.BotStarsActivity$$ExternalSyntheticLambda12
                @Override // java.lang.Runnable
                public final void run() {
        ...
        final TwoStepVerificationActivity twoStepVerificationActivity = new TwoStepVerificationActivity();
        twoStepVerificationActivity.setDelegate(1, new TwoStepVerificationActivity.TwoStepVerificationActivityDelegate() { // from class: org.telegram.ui.Stars.BotStarsActivity$$ExternalSyntheticLambda13
            @Override // org.telegram.ui.TwoStepVerificationActivity.TwoStepVerificationActivityDelegate
            public final void didEnterPassword(TLRPC.InputCheckPasswordSRP inputCheckPasswordSRP) {
        ...
        twoStepVerificationActivity.preload(new Runnable() { // from class: org.telegram.ui.Stars.BotStarsActivity$$ExternalSyntheticLambda14
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void fillItems(ArrayList<UItem> arrayList, UniversalAdapter universalAdapter) {
        ...
        if (i == 0) {
            ...
            arrayList.add(UItem.asBlackHeader(LocaleController.getString(C2797R.string.BotStarsOverview)));
            ...
            arrayList.add(UItem.asShadow(-2, LocaleController.getString(this.self ? C2797R.string.SelfStarsOverviewInfo : C2797R.string.BotStarsOverviewInfo)));
            arrayList.add(UItem.asBlackHeader(LocaleController.getString(C2797R.string.BotStarsAvailableBalance)));
            ...
            if (getMessagesController().starrefConnectAllowed) {
                arrayList.add(AffiliateProgramFragment.ColorfulTextCell.Factory.m1226as(2, Theme.getColor(Theme.key_color_green, this.resourceProvider), C2797R.drawable.filled_earn_stars, ChatEditActivity.applyNewSpan(LocaleController.getString(C2797R.string.BotAffiliateProgramRowTitle)), LocaleController.getString(C2797R.string.BotAffiliateProgramRowText)));
        ...
        if (i == 1) {
            ...
            if (!this.self) {
                if (this.titleInfo == null) {
                    this.titleInfo = AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.formatString(C2797R.string.BotMonetizationInfo, 50), -1, 3, new Runnable() { // from class: org.telegram.ui.Stars.BotStarsActivity$$ExternalSyntheticLambda16
                        @Override // java.lang.Runnable
                        public final void run() {
            ...
            if (this.impressionsChart == null && tONRevenueStats != null) {
                StatisticActivity.ChartViewData chartViewDataCreateViewData = StatisticActivity.createViewData(tONRevenueStats.top_hours_graph, LocaleController.getString(C2797R.string.BotMonetizationGraphImpressions), 0);
            ...
            if (this.revenueChart == null && tONRevenueStats != null) {
                ...
                this.revenueChart = StatisticActivity.createViewData(statsGraph, LocaleController.getString(C2797R.string.BotMonetizationGraphRevenue), 2);
            }
            ...
            if (this.proceedsAvailable) {
                arrayList.add(UItem.asBlackHeader(LocaleController.getString(C2797R.string.BotMonetizationOverview)));
                ...
                if (this.proceedsInfo == null) {
                    int i3 = C2797R.string.BotMonetizationProceedsTONInfo;
                    final int i4 = C2797R.string.BotMonetizationProceedsTONInfoLink;
                    this.proceedsInfo = AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(i3), -1, 3, new Runnable() { // from class: org.telegram.ui.Stars.BotStarsActivity$$ExternalSyntheticLambda17
                        @Override // java.lang.Runnable
                        public final void run() {
            ...
            arrayList.add(UItem.asBlackHeader(LocaleController.getString(C2797R.string.BotMonetizationBalance)));
            arrayList.add(UItem.asCustom(this.tonBalanceLayout));
            if (this.balanceInfo == null) {
                this.balanceInfo = AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(MessagesController.getInstance(this.currentAccount).channelRevenueWithdrawalEnabled ? C2797R.string.BotMonetizationBalanceInfo : C2797R.string.BotMonetizationBalanceInfoNotAvailable), -1, 3, new Runnable() { // from class: org.telegram.ui.Stars.BotStarsActivity$$ExternalSyntheticLambda18
                    @Override // java.lang.Runnable
                    public final void run() {
            ...
            if (!this.tonTransactionsEndReached || !this.tonTransactions.isEmpty()) {
                arrayList.add(UItem.asBlackHeader(LocaleController.getString(C2797R.string.BotMonetizationTransactions)));
                ArrayList<TL_stars.StarsTransaction> arrayList2 = this.tonTransactions;
                int size = arrayList2.size();
                while (i2 < size) {
                    TL_stars.StarsTransaction starsTransaction = arrayList2.get(i2);
                    i2++;
                    arrayList.add(StarsIntroActivity.StarsTransactionView.Factory.asTransaction(starsTransaction, true));
                }
    ...
    public /* synthetic */ void lambda$fillItems$16() {
        Browser.openUrl(getContext(), LocaleController.getString(C2797R.string.BotMonetizationBalanceInfoLink));
    }
    ...
    public void loadTonTransactions() {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_payments_getStarsTransactions, new RequestDelegate() { // from class: org.telegram.ui.Stars.BotStarsActivity$$ExternalSyntheticLambda20
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    public void onItemClick(UItem uItem, View view, int i, float f, float f2) {
        boolean zInstanceOf = uItem.instanceOf(StarsIntroActivity.StarsTransactionView.Factory.class);
        Object obj = uItem.object;
        if (zInstanceOf) {
            StarsIntroActivity.showTransactionSheet(getContext(), true, this.bot_id, this.currentAccount, (TL_stars.StarsTransaction) obj, getResourceProvider());
            return;
        }
    ...
    public /* synthetic */ void lambda$new$19() {
        ...
        int i = this.balanceBlockedUntil;
        ButtonWithCounterView buttonWithCounterView = this.balanceButton;
        if (currentTime < i) {
            buttonWithCounterView.setText(LocaleController.getString(C2797R.string.BotStarsButtonWithdrawShortUntil), true);
            if (this.lock == null) {
            ...
            if (bulletin != null && (bulletin.getLayout() instanceof Bulletin.LottieLayout) && this.withdrawalBulletin.getLayout().isAttachedToWindow()) {
                ((Bulletin.LottieLayout) this.withdrawalBulletin.getLayout()).textView.setText(AndroidUtilities.replaceTags(LocaleController.formatString(C2797R.string.BotStarsWithdrawalToast, untilString(this.balanceBlockedUntil - currentTime))));
            }
            AndroidUtilities.cancelRunOnUIThread(this.setBalanceButtonText);
        ...
        this.balanceButton.setText(StarsIntroActivity.replaceStars(this.balanceEditTextAll ? LocaleController.getString(C2797R.string.BotStarsButtonWithdrawShortAll) : LocaleController.formatPluralStringSpaced("BotStarsButtonWithdrawShort", (int) this.balanceEditTextValue), this.starRef), true);
    }
    ...
    public static String untilString(int i) {
        ...
        if (i2 == 0) {
            ...
            return String.format(Locale.ENGLISH, "%02d:%02d:%02d", Integer.valueOf(i4), Integer.valueOf(i6), Integer.valueOf(i7));
        }
        int i8 = C2797R.string.PeriodDHM;
        Locale locale = Locale.ENGLISH;
        return LocaleController.formatString(i8, String.format(locale, TimeModel.ZERO_LEADING_NUMBER_FORMAT, Integer.valueOf(i2)), String.format(locale, TimeModel.ZERO_LEADING_NUMBER_FORMAT, Integer.valueOf(i4)), String.format(locale, TimeModel.ZERO_LEADING_NUMBER_FORMAT, Integer.valueOf(i6)));
    }
    ...
    private void checkStats() {
        ...
        if (starsRevenueStats != null) {
            ...
            StatisticActivity.ChartViewData chartViewDataCreateViewData = StatisticActivity.createViewData(starsRevenueStats.revenue_graph, LocaleController.getString(C2797R.string.BotStarsChartRevenue), 2);
    ...
    private void initWithdraw(final boolean z, final long j, TLRPC.InputCheckPasswordSRP inputCheckPasswordSRP, final TwoStepVerificationActivity twoStepVerificationActivity) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_payments_getStarsRevenueWithdrawalUrl, new RequestDelegate() { // from class: org.telegram.ui.Stars.BotStarsActivity$$ExternalSyntheticLambda22
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    public /* synthetic */ void lambda$initWithdraw$24(final TwoStepVerificationActivity twoStepVerificationActivity, final Activity activity, final boolean z, final long j, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.BotStarsActivity$$ExternalSyntheticLambda24
            @Override // java.lang.Runnable
            public final void run() {
        ...
        if (tL_error != null) {
            if ("PASSWORD_MISSING".equals(tL_error.text) || tL_error.text.startsWith("PASSWORD_TOO_FRESH_") || tL_error.text.startsWith("SESSION_TOO_FRESH_")) {
                ...
                if ("PASSWORD_MISSING".equals(tL_error.text)) {
                    builder.setPositiveButton(LocaleController.getString(C2797R.string.EditAdminTransferSetPassword), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Stars.BotStarsActivity$$ExternalSyntheticLambda25
    ...
    public /* synthetic */ void lambda$initWithdraw$22(final TwoStepVerificationActivity twoStepVerificationActivity, final boolean z, final long j, final TLObject tLObject, final TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stars.BotStarsActivity$$ExternalSyntheticLambda27
            @Override // java.lang.Runnable
            public final void run() {
