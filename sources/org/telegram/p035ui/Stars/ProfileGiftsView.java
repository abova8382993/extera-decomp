...
public class ProfileGiftsView extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void setBounds(float f, float f2, float f3, boolean z, int i) {
        boolean z2 = Math.abs(f - this.left) > 0.1f || Math.abs(f2 - this.right) > 0.1f || Math.abs(f3 - this.f1750cy) > 0.1f;
        this.left = f;
        this.right = f2;
        if (!z) {
    ...
    public final class Gift {
        ...
        public Gift(TL_stars.TL_starGiftUnique tL_starGiftUnique) {
            ...
            this.f1751id = tL_starGiftUnique.f1443id;
            TLRPC.Document document = tL_starGiftUnique.getDocument();
            this.document = document;
            this.documentId = document == null ? 0L : document.f1253id;
        ...
        private void initParticles() {
            ...
            float fM1036dp = AndroidUtilities.m1036dp(36.0f);
            float f = (-fM1036dp) / 2.0f;
            float f2 = fM1036dp / 2.0f;
            this.particles.bounds.set(f, f, f2, f2);
        }

        public boolean equals(Gift gift) {
            return gift != null && gift.f1751id == this.f1751id;
        }
        ...
        public void draw(Canvas canvas, float f, float f2, float f3, float f4, float f5, float f6) {
            ...
            float fM1036dp = AndroidUtilities.m1036dp(45.0f);
    ...
    */
    public void update() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Stars.ProfileGiftsView.update():void");
    }
    ...
    */
    public void dispatchDraw(android.graphics.Canvas r28) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Stars.ProfileGiftsView.dispatchDraw(android.graphics.Canvas):void");
    }
