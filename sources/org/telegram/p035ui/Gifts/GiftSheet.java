...
import org.telegram.p035ui.Components.Premium.PremiumPreviewBottomSheet;
...
import org.telegram.p035ui.Components.chat.buttons.AbstractC5334x2078045a;
import org.telegram.p035ui.Components.chat.buttons.AbstractC5335x2078045b;
...
import org.telegram.p035ui.Stars.StarGiftPatterns;
...
public class GiftSheet extends BottomSheetWithRecyclerListView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public GiftSheet(final Context context, final int i, final long j, List<TLRPC.TL_premiumGiftCodeOption> list, final Runnable runnable) {
        ...
        C56631 c56631 = new FrameLayout(context2) { // from class: org.telegram.ui.Gifts.GiftSheet.1
            public C56631(final Context context22) {
                super(context22);
            }

            @Override // android.widget.FrameLayout, android.view.View
            public void onMeasure(int i4, int i5) {
                super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i4), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(120.0f), TLObject.FLAG_30));
            }
        };
        this.topView = c56631;
        c56631.setClipChildren(false);
        c56631.setClipToPadding(false);
        c56631.addView(StarsIntroActivity.makeParticlesView(context22, 70, 0), LayoutHelper.createFrame(-1, -1.0f));
        backupImageView.setRoundRadius(ExteraConfig.getAvatarCorners(84.0f));
        c56631.addView(backupImageView, LayoutHelper.createFrame(84, 84.0f, 17, 0.0f, 15.0f, 0.0f, 17.0f));
        ...
        c56631.addView(starsBalanceView, LayoutHelper.createFrame(-2, -2.0f, 53, 0.0f, -3.0f, -10.0f, 0.0f));
        ...
        LinkSpanDrawable.LinksTextView linksTextView = new LinkSpanDrawable.LinksTextView(context22, this.resourcesProvider);
        ...
        linksTextView.setLineSpacing(AndroidUtilities.m1036dp(2.33f), 1.0f);
        linearLayout.addView(linksTextView, LayoutHelper.createLinear(-1, -2, 1, 4, 4, 4, 12));
        textView.setText(LocaleController.getString(C2797R.string.Gift2Premium));
        linksTextView.setText(TextUtils.concat(AndroidUtilities.replaceTags(LocaleController.formatString(C2797R.string.Gift2PremiumInfo, this.name)), " ", AndroidUtilities.replaceArrows(AndroidUtilities.makeClickable(LocaleController.getString(C2797R.string.Gift2PremiumInfoLink), new Runnable() { // from class: org.telegram.ui.Gifts.GiftSheet$$ExternalSyntheticLambda5
        ...
        C56662 c56662 = new LinkSpanDrawable.LinksTextView(context22, this.resourcesProvider) { // from class: org.telegram.ui.Gifts.GiftSheet.2
            public C56662(final Context context22, Theme.ResourcesProvider resourcesProvider) {
                super(context22, resourcesProvider);
            }
        ...
        this.subtitleStarsView = c56662;
        c56662.setLinkTextColor(Theme.getColor(i5, this.resourcesProvider));
        c56662.setTextSize(1, 14.0f);
        c56662.setTextColor(Theme.getColor(i4, this.resourcesProvider));
        c56662.setGravity(17);
        C56673 c56673 = new LinkSpanDrawable.LinksTextView(context22, this.resourcesProvider) { // from class: org.telegram.ui.Gifts.GiftSheet.3
            public C56673(final Context context22, Theme.ResourcesProvider resourcesProvider) {
                super(context22, resourcesProvider);
            }
        ...
        this.subtitleCollectiblesStarsView = c56673;
        c56673.setLinkTextColor(Theme.getColor(i5, this.resourcesProvider));
        c56673.setTextSize(1, 14.0f);
        c56673.setTextColor(Theme.getColor(i4, this.resourcesProvider));
        c56673.setGravity(17);
        c56673.setAlpha(0.0f);
        c56673.setScaleX(0.85f);
        c56673.setScaleY(0.85f);
        FrameLayout frameLayout2 = new FrameLayout(context22);
        frameLayout2.addView(c56662, LayoutHelper.createFrame(-1, -2.0f, 49, 26.0f, 0.0f, 26.0f, 0.0f));
        frameLayout2.addView(c56673, LayoutHelper.createFrame(-1, -2.0f, 49, 26.0f, 0.0f, 26.0f, 0.0f));
        if (j < 0) {
            i2 = C2797R.string.Gift2StarsChannel;
        } else {
            i2 = z ? C2797R.string.Gift2StarsSelf : C2797R.string.Gift2Stars;
        }
        ...
        if (z) {
            ...
            LinkSpanDrawable.LinksTextView linksTextView2 = new LinkSpanDrawable.LinksTextView(context22, this.resourcesProvider);
            ...
            c56662.setText(LocaleController.getString(C2797R.string.Gift2StarsSelfInfo1));
            linksTextView2.setText(LocaleController.getString(C2797R.string.Gift2StarsSelfInfo2));
        } else if (j < 0) {
            linearLayout2.addView(frameLayout2, LayoutHelper.createLinear(-2, -2, 1, 0, 9, 0, 4));
            NotificationCenter.listenEmojiLoading(c56662);
            c56662.setText(Emoji.replaceEmoji(AndroidUtilities.replaceTags(LocaleController.formatString(C2797R.string.Gift2StarsChannelInfo, this.name)), c56662.getPaint().getFontMetricsInt(), false));
        } else {
            ...
            context22 = context;
            runnable2.run();
            c56662.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: org.telegram.ui.Gifts.GiftSheet.4
                final /* synthetic */ Runnable val$setSubtitle;

                @Override // android.view.View.OnAttachStateChangeListener
                public void onViewDetachedFromWindow(View view) {
                }

                public ViewOnAttachStateChangeListenerC56684(final Runnable runnable22) {
                    runnable = runnable22;
                }
            ...
            NotificationCenter.getInstance(i).listen(c56662, NotificationCenter.starUserGiftsLoaded, new Utilities.Callback() { // from class: org.telegram.ui.Gifts.GiftSheet$$ExternalSyntheticLambda7
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    GiftSheet.$r8$lambda$3dkE23YxP0eT28ZcAWx7zHxtNUw(profileGiftsList, runnable22, (Object[]) obj);
                }
            });
        }
        ExtendedGridLayoutManager extendedGridLayoutManager = new ExtendedGridLayoutManager(context22, 3);
        ...
        this.recyclerListView.setPadding(AndroidUtilities.m1036dp(16.0f), 0, AndroidUtilities.m1036dp(16.0f), 0);
        ...
        C56706 c56706 = new DefaultItemAnimator() { // from class: org.telegram.ui.Gifts.GiftSheet.6
        ...
        this.itemAnimator = c56706;
        c56706.setDelayAnimations(false);
        c56706.setSupportsChangeAnimations(false);
        c56706.setDurations(350L);
        c56706.setInterpolator(CubicBezierInterpolator.EASE_OUT_QUINT);
        c56706.setDelayIncrement(40L);
        this.recyclerListView.setItemAnimator(c56706);
        this.recyclerListView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.telegram.ui.Gifts.GiftSheet$$ExternalSyntheticLambda8
            ...
            public final void onItemClick(View view, int i6) {
                this.f$0.lambda$new$19(context22, i, runnable, j, view, i6);
            }
        });
        updatePremiumTiers();
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Gifts.GiftSheet$1 */
    public class C56631 extends FrameLayout {
        public C56631(final Context context22) {
            super(context22);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Gifts.GiftSheet$2 */
    public class C56662 extends LinkSpanDrawable.LinksTextView {
        public C56662(final Context context22, Theme.ResourcesProvider resourcesProvider) {
            super(context22, resourcesProvider);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Gifts.GiftSheet$3 */
    public class C56673 extends LinkSpanDrawable.LinksTextView {
        public C56673(final Context context22, Theme.ResourcesProvider resourcesProvider) {
            super(context22, resourcesProvider);
        }
    ...
    public /* synthetic */ void lambda$new$5(StarsController.GiftsList giftsList, final long j, final Runnable runnable, final Context context) {
        ...
        while (i < 2) {
            ...
            spannableStringBuilder.append((CharSequence) AndroidUtilities.replaceTags(i == 1 ? LocaleController.getString(C2797R.string.Gift2StarsCollectibleInfo) : LocaleController.formatString(C2797R.string.Gift2StarsInfo, this.name)));
            ...
            for (int i2 = 0; i2 < giftsList.gifts.size() && hashSet.size() < 3; i2++) {
                ...
                if (savedStarGift != null && (starGift = savedStarGift.gift) != null && (document = starGift.getDocument()) != null && !hashSet.contains(Long.valueOf(document.f1253id))) {
            ...
            if (hashSet2.size() > 0) {
                ...
                spannableStringBuilder2.append((CharSequence) LocaleController.formatString(C2797R.string.Gift2StarsInfoProfileLink, DialogObject.getShortName(j)).replaceAll(" ", " "));
                ...
                spannableStringBuilder.append(AndroidUtilities.replaceArrows(AndroidUtilities.makeClickable(LocaleController.getString(C2797R.string.Gift2StarsInfoLink), new Runnable() { // from class: org.telegram.ui.Gifts.GiftSheet$$ExternalSyntheticLambda11
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Gifts.GiftSheet$4 */
    public class ViewOnAttachStateChangeListenerC56684 implements View.OnAttachStateChangeListener {
        final /* synthetic */ Runnable val$setSubtitle;
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Gifts.GiftSheet$5 */
    public class C56695 extends GridLayoutManager.SpanSizeLookup {
        public C56695() {
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Gifts.GiftSheet$6 */
    public class C56706 extends DefaultItemAnimator {
        @Override // androidx.recyclerview.widget.DefaultItemAnimator
        public float animateByScale(View view) {
            return 0.3f;
        }
        ...
        if (item != null && item.instanceOf(GiftCell.Factory.class)) {
            ...
            if (obj instanceof GiftPremiumBottomSheet$GiftTier) {
                new SendGiftSheet(context, i, (GiftPremiumBottomSheet$GiftTier) obj, this.dialogId, new Runnable() { // from class: org.telegram.ui.Gifts.GiftSheet$$ExternalSyntheticLambda12
                    ...
                    public DialogC56717(final Context context2, final int i3, GiftPremiumBottomSheet$GiftTier giftPremiumBottomSheet$GiftTier, long j2, Runnable runnable2) {
                        super(context2, i3, giftPremiumBottomSheet$GiftTier, j2, runnable2);
                    }
                    ...
                    public BulletinFactory getParentBulletinFactory() {
                        ...
                        return BulletinFactory.m1142of(giftSheet.container, giftSheet.resourcesProvider);
                    }
                }.show();
                return;
            }
            if (obj instanceof TL_stars.StarGift) {
                ...
                if (giftsList != null && this.selectedTab == this.TAB_MY_GIFTS) {
                    ArrayList<TL_stars.SavedStarGift> arrayList = giftsList.gifts;
                    ...
                    while (true) {
                        ...
                        TL_stars.SavedStarGift savedStarGift2 = arrayList.get(i3);
                        i3++;
                        TL_stars.SavedStarGift savedStarGift3 = savedStarGift2;
                        if (savedStarGift3.gift.f1443id == starGift.f1443id) {
                            savedStarGift = savedStarGift3;
                            break;
                        }
                    }
                    ...
                    final StarGiftSheet starGiftSheet = new StarGiftSheet(getContext(), i3, UserConfig.getInstance(i3).getClientUserId(), this.resourcesProvider) { // from class: org.telegram.ui.Gifts.GiftSheet.8
                        public DialogC56728(Context context2, final int i32, long j2, Theme.ResourcesProvider resourcesProvider) {
                            super(context2, i32, j2, resourcesProvider);
                        }
                ...
                if (item.accent && starGift.availability_resale > 0) {
                    ...
                    C56739 c56739 = new ResaleGiftsFragment(j, starGift.title, starGift.f1443id, this.resourcesProvider) { // from class: org.telegram.ui.Gifts.GiftSheet.9
                        ...
                        public C56739(final long j2, String str, long j3, Theme.ResourcesProvider resourcesProvider, ViewTreeObserver viewTreeObserver, ViewTreeObserver.OnPreDrawListener onPreDrawListener) {
                            super(j2, str, j3, resourcesProvider);
                    ...
                    c56739.setCloseParentSheet(new Runnable() { // from class: org.telegram.ui.Gifts.GiftSheet$$ExternalSyntheticLambda15
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$new$12(runnable);
                        }
                    });
                    safeLastFragment.showAsSheet(c56739, bottomSheetParams);
                    return;
                }
                if (starGift.auction) {
                    AuctionJoinSheet.show(context2, this.resourcesProvider, i32, j2, starGift.f1443id, new Runnable() { // from class: org.telegram.ui.Gifts.GiftSheet$$ExternalSyntheticLambda16
                        @Override // java.lang.Runnable
                        public final void run() {
                ...
                if (starGift.sold_out) {
                    StarsIntroActivity.showSoldOutGiftSheet(context2, i32, starGift, this.resourcesProvider);
                    return;
                }
                if (starGift.limited_per_user && starGift.per_user_remains <= 0) {
                    BulletinFactory.m1142of(this.container, this.resourcesProvider).createSimpleMultiBulletin(starGift.getDocument(), AndroidUtilities.replaceTags(LocaleController.formatPluralStringComma("Gift2PerUserLimit", starGift.per_user_total))).show();
                    return;
                }
                final Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.Gifts.GiftSheet$$ExternalSyntheticLambda17
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$new$15(context2, i32, starGift, runnable);
                    }
                };
                if (starGift.locked_until_date > ConnectionsManager.getInstance(i32).getCurrentTime()) {
                    final AlertDialog alertDialog = new AlertDialog(getContext(), 3);
                    alertDialog.showDelayed(500L);
                    TL_stars.checkCanSendGift checkcansendgift = new TL_stars.checkCanSendGift();
                    checkcansendgift.gift_id = starGift.f1443id;
                    ConnectionsManager.getInstance(i32).sendRequest(checkcansendgift, new RequestDelegate() { // from class: org.telegram.ui.Gifts.GiftSheet$$ExternalSyntheticLambda18
                ...
                if (starGift.require_premium && !UserConfig.getInstance(i32).isPremium()) {
                    BaseFragment safeLastFragment2 = LaunchActivity.getSafeLastFragment();
                    if (safeLastFragment2 == null) {
                        return;
                    }
                    PremiumPreviewBottomSheet premiumPreviewBottomSheet = new PremiumPreviewBottomSheet(safeLastFragment2, i32, null, null, starGift, this.resourcesProvider);
                    BackupImageView backupImageView = new BackupImageView(getContext());
                    AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable swapAnimatedEmojiDrawable = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(backupImageView, AndroidUtilities.m1036dp(160.0f), 4);
                    ...
                    backupImageView.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: org.telegram.ui.Gifts.GiftSheet.11
                        final /* synthetic */ AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable val$drawable;

                        public ViewOnAttachStateChangeListenerC566511(AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable swapAnimatedEmojiDrawable2) {
                    ...
                    swapAnimatedEmojiDrawable2.set(starGift.getDocument(), false);
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Gifts.GiftSheet$7 */
    public class DialogC56717 extends SendGiftSheet {
        public DialogC56717(final Context context2, final int i32, GiftPremiumBottomSheet$GiftTier giftPremiumBottomSheet$GiftTier, long j2, Runnable runnable2) {
            super(context2, i32, giftPremiumBottomSheet$GiftTier, j2, runnable2);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Gifts.GiftSheet$8 */
    public class DialogC56728 extends StarGiftSheet {
        public DialogC56728(Context context2, final int i32, long j2, Theme.ResourcesProvider resourcesProvider) {
            super(context2, i32, j2, resourcesProvider);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Gifts.GiftSheet$9 */
    public class C56739 extends ResaleGiftsFragment {
        final /* synthetic */ ViewTreeObserver val$observer;
        final /* synthetic */ ViewTreeObserver.OnPreDrawListener val$onPreDrawListener;
    ...
    public /* synthetic */ void lambda$new$15(Context context, int i, TL_stars.StarGift starGift, final Runnable runnable) {
        ...
        new SendGiftSheet(context2, i2, starGift2, j, runnable2, z3, z) { // from class: org.telegram.ui.Gifts.GiftSheet.10
            public DialogC566410(Context context22, int i22, TL_stars.StarGift starGift22, long j2, Runnable runnable22, boolean z32, boolean z4) {
                super(context22, i22, starGift22, j2, runnable22, z32, z4);
            }

            @Override // org.telegram.p035ui.Gifts.SendGiftSheet
            public BulletinFactory getParentBulletinFactory() {
                GiftSheet giftSheet2 = GiftSheet.this;
                return BulletinFactory.m1142of(giftSheet2.container, giftSheet2.resourcesProvider);
            }
        }.show();
    }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Gifts.GiftSheet$10 */
    public class DialogC566410 extends SendGiftSheet {
        public DialogC566410(Context context22, int i22, TL_stars.StarGift starGift22, long j2, Runnable runnable22, boolean z32, boolean z4) {
            super(context22, i22, starGift22, j2, runnable22, z32, z4);
        }
    ...
    public /* synthetic */ void lambda$new$17(AlertDialog alertDialog, TLObject tLObject, Runnable runnable, final Runnable runnable2, TLRPC.TL_error tL_error) {
        ...
        if (!(tLObject instanceof TL_stars.checkCanSendGiftResultFail)) {
            if (tL_error != null) {
                BulletinFactory.m1142of(this.container, this.resourcesProvider).showForError(tL_error);
            }
        } else {
            final AlertDialog alertDialogShow = new AlertDialog.Builder(getContext(), this.resourcesProvider).setTitle(LocaleController.getString(C2797R.string.GiftLocked)).setMessage(MessageObject.formatTextWithEntities(((TL_stars.checkCanSendGiftResultFail) tLObject).reason, false)).setPositiveButton(LocaleController.getString(C2797R.string.f1162OK), null).show();
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Gifts.GiftSheet$11 */
    public class ViewOnAttachStateChangeListenerC566511 implements View.OnAttachStateChangeListener {
        final /* synthetic */ AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable val$drawable;
    ...
    public void show() {
        ...
        if (disallowedGiftsSettings != null && disallowedGiftsSettings.disallow_premium_gifts && disallowedGiftsSettings.disallow_unique_stargifts && disallowedGiftsSettings.disallow_limited_stargifts && disallowedGiftsSettings.disallow_unlimited_stargifts) {
            BaseFragment safeLastFragment = LaunchActivity.getSafeLastFragment();
            if (safeLastFragment != null) {
                BulletinFactory.m1143of(safeLastFragment).createSimpleBulletin(C2797R.raw.error, AndroidUtilities.replaceTags(LocaleController.formatString(C2797R.string.UserDisallowedGifts, DialogObject.getShortName(this.dialogId)))).show();
                return;
            }
            return;
        }
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (i == NotificationCenter.starGiftSoldOut) {
            if (isShown()) {
                ...
                BulletinFactory.m1142of(this.container, this.resourcesProvider).createEmojiBulletin(starGift.sticker, LocaleController.getString(C2797R.string.Gift2SoldOutTitle), AndroidUtilities.replaceTags(LocaleController.formatPluralStringComma("Gift2SoldOutCount", starGift.availability_total))).show();
    ...
    private void updatePremiumTiers() {
        ...
        TLRPC.TL_premiumGiftCodeOption next;
        ...
        if (this.premiumTiers.isEmpty() && (list = this.options) != null && !list.isEmpty()) {
            ...
            for (int size = this.options.size() - 1; size >= 0; size--) {
                TLRPC.TL_premiumGiftCodeOption tL_premiumGiftCodeOption = this.options.get(size);
                if (!"XTR".equalsIgnoreCase(tL_premiumGiftCodeOption.currency)) {
                    Iterator<TLRPC.TL_premiumGiftCodeOption> it = this.options.iterator();
                    while (true) {
                        if (!it.hasNext()) {
                            next = null;
                            break;
                        ...
                        next = it.next();
                        if (next != tL_premiumGiftCodeOption && "XTR".equalsIgnoreCase(next.currency) && next.months == tL_premiumGiftCodeOption.months) {
                            break;
                        }
                    }
                    GiftPremiumBottomSheet$GiftTier giftPremiumBottomSheet$GiftTier = new GiftPremiumBottomSheet$GiftTier(tL_premiumGiftCodeOption, next);
            ...
            if (BuildVars.useInvoiceBilling()) {
                ...
                int i = 0;
                while (i < size2) {
                    GiftPremiumBottomSheet$GiftTier giftPremiumBottomSheet$GiftTier2 = arrayList2.get(i);
                    i++;
                    giftPremiumBottomSheet$GiftTier2.setPricePerMonthRegular(pricePerMonth);
                }
        ...
        if (this.premiumTiers.isEmpty()) {
            BoostRepository.loadGiftOptions(this.currentAccount, null, new Utilities.Callback() { // from class: org.telegram.ui.Gifts.GiftSheet$$ExternalSyntheticLambda1
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    this.f$0.lambda$updatePremiumTiers$23((List) obj);
                }
            });
        }
    }
    ...
    public /* synthetic */ void lambda$updatePremiumTiers$23(List list) {
        ...
        List<TLRPC.TL_premiumGiftCodeOption> listFilterGiftOptions = BoostRepository.filterGiftOptions(list, 1);
        this.options = listFilterGiftOptions;
        List<TLRPC.TL_premiumGiftCodeOption> listFilterGiftOptionsByBilling = BoostRepository.filterGiftOptionsByBilling(listFilterGiftOptions);
    ...
    public CharSequence getTitle() {
        if (this.self) {
            return LocaleController.getString(C2797R.string.Gift2TitleSelf1);
        }
        return Emoji.replaceEmoji(LocaleController.formatString(C2797R.string.Gift2User, this.name), null, false);
    }
    ...
    public void fillItems(ArrayList<UItem> arrayList, UniversalAdapter universalAdapter) {
        boolean z;
        ArrayList<TL_stars.StarGift> arrayList2;
        boolean z2;
        ...
        if (this.self || this.dialogId < 0 || ((disallowedGiftsSettings4 = this.userSettings) != null && disallowedGiftsSettings4.disallow_premium_gifts)) {
            ...
            ArrayList<GiftPremiumBottomSheet$GiftTier> arrayList3 = this.premiumTiers;
            if (arrayList3 != null && !arrayList3.isEmpty()) {
                ArrayList<GiftPremiumBottomSheet$GiftTier> arrayList4 = this.premiumTiers;
                int size = arrayList4.size();
                int i = 0;
                while (i < size) {
                    GiftPremiumBottomSheet$GiftTier giftPremiumBottomSheet$GiftTier = arrayList4.get(i);
                    i++;
                    arrayList.add(GiftCell.Factory.asPremiumGift(giftPremiumBottomSheet$GiftTier));
                }
            } else {
        ...
        if (this.userSettings != null) {
            arrayList2 = (ArrayList) arrayList2.stream().filter(new Predicate() { // from class: org.telegram.ui.Gifts.GiftSheet$$ExternalSyntheticLambda19
        ...
        if (this.dialogId < 0) {
            arrayList2 = (ArrayList) arrayList2.stream().filter(new Predicate() { // from class: org.telegram.ui.Gifts.GiftSheet$$ExternalSyntheticLambda20
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
                    return GiftSheet.$r8$lambda$BWHgLBI1xuuSDJlJhhRqd8BDE2o((TL_stars.StarGift) obj);
                }
            }).collect(Collectors.toCollection(new ExportMapper$$ExternalSyntheticLambda2()));
        }
        if (this.dialogId == UserConfig.getInstance(this.currentAccount).getClientUserId() || (giftsList3 = this.myGifts) == null) {
            ...
            ArrayList<TL_stars.SavedStarGift> arrayList5 = giftsList3.gifts;
            int size2 = arrayList5.size();
            int i2 = 0;
            while (i2 < size2) {
                TL_stars.SavedStarGift savedStarGift = arrayList5.get(i2);
                i2++;
        ...
        if (!MessagesController.getInstance(this.currentAccount).stargiftsBlocked && (!arrayList2.isEmpty() || ((disallowedGiftsSettings3 = this.userSettings) != null && !disallowedGiftsSettings3.disallow_unique_stargifts && (giftsList2 = this.myGifts) != null && !giftsList2.gifts.isEmpty()))) {
            ...
            if (disallowedGiftsSettings5 == null || !disallowedGiftsSettings5.disallow_unique_stargifts) {
                for (int i3 = 0; i3 < arrayList2.size(); i3++) {
                    treeSet.add(Long.valueOf(arrayList2.get(i3).stars));
                }
            }
            ...
            if (!arrayList2.isEmpty()) {
                ...
                arrayList6.add(LocaleController.getString(C2797R.string.Gift2TabAll));
            }
            ...
            if ((disallowedGiftsSettings6 == null || !disallowedGiftsSettings6.disallow_unique_stargifts) && z2) {
                ...
                arrayList6.add(LocaleController.getString(C2797R.string.Gift2TabMine));
            }
            this.TAB_COLLECTIBLES = arrayList6.size();
            arrayList6.add(LocaleController.getString(C2797R.string.Gift2TabCollectibles));
            ...
            if (this.myGifts != null && this.selectedTab == this.TAB_MY_GIFTS) {
                ...
                ArrayList<TL_stars.SavedStarGift> arrayList7 = this.myGifts.gifts;
                int size3 = arrayList7.size();
                int i4 = 0;
                while (i4 < size3) {
                    TL_stars.SavedStarGift savedStarGift2 = arrayList7.get(i4);
                    i4++;
            ...
            while (i5 < arrayList2.size()) {
                TL_stars.StarGift starGift2 = arrayList2.get(i5);
            ...
            arrayList.add(UItem.asSpace(AndroidUtilities.m1036dp(i6 >= 9 ? 40.0f : 300.0f)));
            return;
        }
        ...
        arrayList.add(UItem.asSpace(AndroidUtilities.m1036dp(300.0f)));
    }
    ...
    public static class GiftCell extends FrameLayout {
        ...
        public GiftCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
            ...
            C56761 c56761 = new FrameLayout(context) { // from class: org.telegram.ui.Gifts.GiftSheet.GiftCell.1
                public C56761(Context context2) {
                    super(context2);
                }
            ...
            this.priceLayout = c56761;
            TextView textView3 = new TextView(context2);
            this.priceView = textView3;
            textView3.setTextSize(1, 12.0f);
            textView3.setTypeface(AndroidUtilities.bold());
            textView3.setPadding(AndroidUtilities.m1036dp(10.0f), 0, AndroidUtilities.m1036dp(10.0f), 0);
            textView3.setGravity(17);
            textView3.setTextColor(-13397548);
            frameLayout.addView(c56761, LayoutHelper.createFrame(-2, -2.0f, 81, 0.0f, 0.0f, 0.0f, 11.0f));
            StarsBackgroundView starsBackgroundView = new StarsBackgroundView(context2);
            this.priceBackground = starsBackgroundView;
            starsBackgroundView.setBackgroundColor(-16776961);
            c56761.addView(starsBackgroundView, LayoutHelper.createFrame(0, 0.0f));
            c56761.addView(textView3, LayoutHelper.createFrame(-2, 26, 17));
            ...
            backupImageView2.setRoundRadius(AndroidUtilities.m1036dp(20.0f));
            ...
            imageView.setImageResource(C2797R.drawable.msg_limit_pin);
            ...
            imageView2.setImageResource(C2797R.drawable.mini_gram_14);
            imageView2.setPadding(0, AndroidUtilities.m1036dp(2.0f), 0, 0);
            ...
            textView5.setPadding(AndroidUtilities.m1036dp(5.0f), 0, AndroidUtilities.m1036dp(5.0f), 0);
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Gifts.GiftSheet$GiftCell$1 */
        public class C56761 extends FrameLayout {
            public C56761(Context context2) {
                super(context2);
            }
        ...
        */
        ...
        public void setSelected(boolean z, boolean z2) {
            ...
            if (z2) {
                imageView.animate().translationX(z ? AndroidUtilities.m1036dp(6.0f) : 0.0f).translationY(z ? AndroidUtilities.m1036dp(6.0f) : 0.0f).setDuration(320L).setInterpolator(CubicBezierInterpolator.EASE_OUT_QUINT).start();
                return;
            }
            imageView.animate().cancel();
            this.tonOnlySaleView.setTranslationX(z ? AndroidUtilities.m1036dp(6.0f) : 0.0f);
            this.tonOnlySaleView.setTranslationY(z ? AndroidUtilities.m1036dp(6.0f) : 0.0f);
        }
        ...
        public void customDraw(View view, Canvas canvas, float f, float f2, float f3) {
            ...
            float fM1036dp = uniqueStarGift != null ? AndroidUtilities.m1036dp(63.0f) * f3 : 0.0f;
            ...
            float fLerp = AndroidUtilities.lerp(AndroidUtilities.m1036dp(80.0f), AndroidUtilities.m1036dp(120.0f), f3);
            float f4 = f2 - fM1036dp;
            ...
            if (this.pinnedView.getVisibility() == 0 && this.pinnedView.getAlpha() > 0.0f) {
                canvas2.save();
                canvas2.translate(this.cardBackgroundPadding.left + AndroidUtilities.m1036dp(2.0f), this.cardBackgroundPadding.top + AndroidUtilities.m1036dp(2.0f));
            ...
            if (this.ribbon.getVisibility() == 0 && this.ribbon.getAlpha() > 0.0f) {
                canvas2.save();
                canvas2.translate(f - AndroidUtilities.m1036dp(1.0f), AndroidUtilities.m1036dp(2.0f));
            ...
            if (uniqueStarGift != null) {
                ...
                float f5 = 1.0f - f3;
                this.title.ellipsize(f - AndroidUtilities.m1036dp(8.0f)).draw(canvas2, (f - this.title.getWidth()) / 2.0f, ((f2 - AndroidUtilities.m1036dp(40.0f)) - (this.title.getHeight() / 2.0f)) + (AndroidUtilities.m1036dp(50.0f) * f5), -1, f3);
                this.subtitle.ellipsize(f - AndroidUtilities.m1036dp(8.0f)).draw(canvas, (f - this.subtitle.getWidth()) / 2.0f, (AndroidUtilities.m1036dp(50.0f) * f5) + ((f2 - AndroidUtilities.m1036dp(19.0f)) - (this.subtitle.getHeight() / 2.0f)), -1, f3 * 0.6f);
                canvas2 = canvas;
            }
        ...
        public boolean setPremiumGift(GiftPremiumBottomSheet$GiftTier giftPremiumBottomSheet$GiftTier) {
            ...
            this.subtitleView.setText(LocaleController.getString(C2797R.string.TelegramPremiumShort));
            this.titleView.setVisibility(0);
            this.subtitleView.setVisibility(0);
            this.imageView.setTranslationY(-AndroidUtilities.m1036dp(8.0f));
            this.avatarView.setVisibility(8);
            this.lockView.setVisibility(8);
            boolean zIsStarsPaymentAvailable = giftPremiumBottomSheet$GiftTier.isStarsPaymentAvailable();
            TextView textView = this.starsPriceView;
            if (zIsStarsPaymentAvailable) {
                textView.setTextColor(Theme.isCurrentThemeDark() ? -1333971 : -2722014);
                ...
                this.starsPriceView.setText(StarsIntroActivity.replaceStarsWithPlain(LocaleController.formatSpannable(C2797R.string.PremiumOrStarsPrice, spannableStringBuilder), 0.48f, coloredImageSpanArr));
            ...
            this.priceView.setPadding(AndroidUtilities.m1036dp(10.0f), 0, AndroidUtilities.m1036dp(10.0f), 0);
            this.priceView.setTextSize(1, 12.0f);
            this.priceView.setText(giftPremiumBottomSheet$GiftTier.getFormattedPrice());
            this.priceBackground.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1036dp(13.0f), 422810068));
            this.priceView.setTextColor(-13397548);
            ((ViewGroup.MarginLayoutParams) this.priceLayout.getLayoutParams()).topMargin = AndroidUtilities.m1036dp(130.0f);
        ...
        private void setSticker(TLRPC.Document document, Object obj) {
            if (document == null) {
                ...
                this.lastDocumentId = document.f1253id;
        ...
        /*
            ...
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        public boolean setStarsGift(org.telegram.tgnet.tl.TL_stars.StarGift r29, boolean r30, boolean r31, boolean r32, boolean r33, boolean r34) {
            /*
        ...
        public boolean setStarsGift(final TL_stars.SavedStarGift savedStarGift, boolean z, boolean z2) {
            ...
            if (stargiftattributebackdrop != null) {
                frameLayout.setBackground(Theme.createCircleDrawable(AndroidUtilities.m1036dp(20.0f), Theme.adaptHSV(stargiftattributebackdrop.center_color | (-16777216), 0.1f, -0.2f)));
            } else {
                frameLayout.setBackground(Theme.createCircleDrawable(AndroidUtilities.m1036dp(20.0f), Theme.getColor(Theme.key_featuredStickers_addButton, this.resourcesProvider)));
            }
            FrameLayout.LayoutParams layoutParams = this.imageViewLayoutParams;
            layoutParams.gravity = 17;
            this.imageView.setLayoutParams(layoutParams);
            TL_stars.SavedStarGift savedStarGift2 = this.lastUserGift;
            PremiumLockIconView premiumLockIconView = this.lockView;
            if (savedStarGift2 == savedStarGift) {
                premiumLockIconView.setVisibility(0);
                this.lockView.animate().alpha(savedStarGift.unsaved ? 1.0f : 0.0f).scaleX(savedStarGift.unsaved ? 1.0f : 0.4f).scaleY(savedStarGift.unsaved ? 1.0f : 0.4f).setDuration(350L).setInterpolator(CubicBezierInterpolator.EASE_OUT_QUINT).withEndAction(new Runnable() { // from class: org.telegram.ui.Gifts.GiftSheet$GiftCell$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$setStarsGift$2(savedStarGift);
                    }
                }).start();
            } else {
                premiumLockIconView.setAlpha(savedStarGift.unsaved ? 1.0f : 0.0f);
            ...
            if (z3) {
                ...
                platformDrawable.setIconSize(AndroidUtilities.m1036dp(16.0f), AndroidUtilities.m1036dp(16.0f));
            ...
            if (stargiftattributebackdrop != null && savedStarGift.gift.resell_amount != null) {
                ...
                this.priceView.setPadding(AndroidUtilities.m1036dp(8.0f), 0, AndroidUtilities.m1036dp(10.0f), 0);
                this.priceView.setTextSize(1, 12.0f);
                ColoredImageSpan[] coloredImageSpanArr = new ColoredImageSpan[1];
                TL_stars.StarGift starGift = savedStarGift.gift;
                ...
                ColoredImageSpan coloredImageSpan = coloredImageSpanArr[c2];
                if (coloredImageSpan != null) {
                    coloredImageSpan.translate(0.0f, AndroidUtilities.m1036dp(0.5f));
                }
                ...
                this.tonOnlySaleView.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1036dp(10.0f), iBlendOver));
                this.tonOnlySaleView.setColorFilter(-1);
                ((FrameLayout.LayoutParams) this.priceLayout.getLayoutParams()).gravity = 49;
                ((ViewGroup.MarginLayoutParams) this.priceLayout.getLayoutParams()).topMargin = AndroidUtilities.m1036dp(79.0f);
            } else {
                TextView textView2 = this.priceView;
                if (z) {
                    textView2.setVisibility(8);
                    this.imageViewLayoutParams.topMargin = AndroidUtilities.m1036dp(12.0f);
                    this.imageViewLayoutParams.bottomMargin = AndroidUtilities.m1036dp(12.0f);
                    i = 0;
                } else {
                    i = 0;
                ...
                if (z3) {
                    textView3.setPadding(AndroidUtilities.m1036dp(8.0f), i, AndroidUtilities.m1036dp(8.0f), i);
                    this.priceView.setTextSize(1, 12.0f);
                    this.priceView.setText(LocaleController.getString(C2797R.string.Gift2PriceUnique));
                } else {
                    textView3.setPadding(AndroidUtilities.m1036dp(8.0f), i, AndroidUtilities.m1036dp(10.0f), i);
                    this.priceView.setTextSize(1, 12.0f);
                    ...
                    textView4.setText(StarsIntroActivity.replaceStarsWithPlain(sb2.toString(), 0.66f));
                }
                ...
                imageView.setBackground(Theme.createRoundRectDrawable(iM1036dp, i3));
                this.tonOnlySaleView.setColorFilter(z3 ? -1 : Theme.isCurrentThemeDark() ? -1333971 : -4229632);
                ((FrameLayout.LayoutParams) this.priceLayout.getLayoutParams()).gravity = 49;
                ((ViewGroup.MarginLayoutParams) this.priceLayout.getLayoutParams()).topMargin = AndroidUtilities.m1036dp(103.0f);
            }
            ...
            this.title = null;
            this.subtitle = null;
            setPinned(savedStarGift.pinned_to_top, savedStarGift3 == savedStarGift);
            updateRibbonText();
            return savedStarGift3 == savedStarGift;
        }
        ...
        private void updateRibbonText() {
            ...
            if (savedStarGift != null) {
                ...
                if (starGift instanceof TL_stars.TL_starGiftUnique) {
                    ...
                    if (this.userGift.gift.resell_amount != null) {
                        ...
                        this.ribbon.setText(LocaleController.getString(C2797R.string.Gift2OnSale), false);
                        return;
                    }
                ...
                if (z) {
                    ...
                    this.ribbon.setStrokeColor(0);
                    this.ribbon.setBackdrop(null);
                    this.ribbon.setText(LocaleController.formatString(C2797R.string.Gift2Limited1OfRibbon, AndroidUtilities.formatWholeNumber(this.userGift.gift.availability_total, 0)), true);
                    return;
                }
            ...
            if (starGift2 != null) {
                ...
                if (this.allowResaleInGifts && starGift2.availability_resale > 0) {
                    ...
                    this.ribbon.setStrokeColor(0);
                    this.ribbon.setBackdrop(null);
                    this.ribbon.setText(LocaleController.getString(C2797R.string.Gift2Resale), false);
                    return;
                }
                if (this.giftMine) {
                    this.ribbon.setVisibility(0);
                    ...
                    this.ribbon.setStrokeColor(0);
                    this.ribbon.setBackdrop((TL_stars.starGiftAttributeBackdrop) StarsController.findAttribute(this.gift.attributes, TL_stars.starGiftAttributeBackdrop.class));
                    this.ribbon.setText(LocaleController.formatString(C2797R.string.Gift2Limited1OfRibbon, AndroidUtilities.formatWholeNumber(this.gift.availability_issued, 0)), true);
                    return;
                }
                ...
                if (z2 && starGift2.availability_remains <= 0) {
                    ...
                    this.ribbon.setStrokeColor(0);
                    this.ribbon.setBackdrop(null);
                    this.ribbon.setText(LocaleController.getString(C2797R.string.Gift2SoldOut), true);
                    return;
                }
                if (starGift2.auction) {
                    ...
                    this.ribbon.setStrokeColor(0);
                    int i = this.gift.auction_start_date;
                    int currentTime = ConnectionsManager.getInstance(this.currentAccount).getCurrentTime();
                    Ribbon ribbon2 = this.ribbon;
                    if (i > currentTime) {
                        ribbon2.setText(LocaleController.getString(C2797R.string.Gift2LimitedAuctionSoon), true);
                        return;
                    } else {
                        ribbon2.setText(LocaleController.getString(C2797R.string.Gift2LimitedAuction), true);
                        return;
                    }
                }
                if (starGift2.require_premium) {
                    ...
                    this.ribbon.setColors(-2650077, -4227818);
                    this.ribbon.setStrokeColor(0);
                    this.ribbon.setText(LocaleController.getString(C2797R.string.Gift2LimitedPremium), true);
                    return;
                }
                ...
                if (z2) {
                    ...
                    this.ribbon.setStrokeColor(0);
                    this.ribbon.setBackdrop(null);
                    this.ribbon.setText(LocaleController.getString(C2797R.string.Gift2LimitedRibbon), true);
                    return;
                }
            ...
            if (giftPremiumBottomSheet$GiftTier != null) {
                int discount = giftPremiumBottomSheet$GiftTier.getDiscount();
                Ribbon ribbon4 = this.ribbon;
                if (discount > 0) {
                    ribbon4.setVisibility(0);
                    this.ribbon.setBackdrop(null);
                    this.ribbon.setColors(-2535425, -8229377);
                    this.ribbon.setStrokeColor(0);
                    this.ribbon.setText(12, LocaleController.formatString(C2797R.string.GiftPremiumOptionDiscount, Integer.valueOf(this.premiumTier.getDiscount())), true);
                    return;
                }
                ribbon4.setVisibility(8);
                this.ribbon.setBackdrop(null);
                this.ribbon.setStrokeColor(0);
            }
        }
        ...
        public void setRibbonTextOneOf(int i) {
            ...
            this.ribbon.setStrokeColor(0);
            this.ribbon.setBackdrop((TL_stars.starGiftAttributeBackdrop) StarsController.findAttribute(this.gift.attributes, TL_stars.starGiftAttributeBackdrop.class));
            this.ribbon.setText(LocaleController.formatString(C2797R.string.Gift2Limited1OfRibbon, AndroidUtilities.formatWholeNumber(i, 0)), true);
        }
                ...
                if (obj != null || uItem2.object != null) {
                    ...
                    if (obj instanceof TL_stars.StarGift) {
                        ...
                        if (obj2 instanceof TL_stars.StarGift) {
                            return ((TL_stars.StarGift) obj).f1443id == ((TL_stars.StarGift) obj2).f1443id;
                        }
                    }
                    if (obj instanceof TL_stars.SavedStarGift) {
                        ...
                        if (obj3 instanceof TL_stars.SavedStarGift) {
                            ...
                            return savedStarGift.gift.f1443id == savedStarGift2.gift.f1443id && savedStarGift.date == savedStarGift2.date && savedStarGift.saved_id == savedStarGift2.saved_id;
                        }
                    }
                }
    ...
    public static class RibbonDrawable extends CompatDrawable {
        ...
        public static void fillRibbonPath(Path path, float f, final boolean z) {
            ...
            path.rewind();
            float f2 = f * 24.5f;
            path.moveTo(AndroidUtilities.m1036dp(((Float) callbackReturn.run(Float.valueOf(46.83f))).floatValue() * f), AndroidUtilities.m1036dp(f2));
            path.lineTo(AndroidUtilities.m1036dp(((Float) callbackReturn.run(Float.valueOf(23.5f))).floatValue() * f), AndroidUtilities.m1036dp(1.17f * f));
            path.cubicTo(AndroidUtilities.m1036dp(((Float) callbackReturn.run(Float.valueOf(22.75f))).floatValue() * f), AndroidUtilities.m1036dp(0.42f * f), AndroidUtilities.m1036dp(((Float) callbackReturn.run(Float.valueOf(21.73f))).floatValue() * f), 0.0f, AndroidUtilities.m1036dp(((Float) callbackReturn.run(Float.valueOf(20.68f))).floatValue() * f), 0.0f);
            float f3 = f * 0.05f;
            path.cubicTo(AndroidUtilities.m1036dp(((Float) callbackReturn.run(Float.valueOf(19.62f))).floatValue() * f), 0.0f, AndroidUtilities.m1036dp(((Float) callbackReturn.run(Float.valueOf(2.73f))).floatValue() * f), AndroidUtilities.m1036dp(f3), AndroidUtilities.m1036dp(((Float) callbackReturn.run(Float.valueOf(1.55f))).floatValue() * f), AndroidUtilities.m1036dp(f3));
            path.cubicTo(AndroidUtilities.m1036dp(((Float) callbackReturn.run(Float.valueOf(0.36f))).floatValue() * f), AndroidUtilities.m1036dp(f3), AndroidUtilities.m1036dp(((Float) callbackReturn.run(Float.valueOf(-0.23f))).floatValue() * f), AndroidUtilities.m1036dp(1.4885f * f), AndroidUtilities.m1036dp(((Float) callbackReturn.run(Float.valueOf(0.6f))).floatValue() * f), AndroidUtilities.m1036dp(2.32f * f));
            path.lineTo(AndroidUtilities.m1036dp(((Float) callbackReturn.run(Float.valueOf(45.72f))).floatValue() * f), AndroidUtilities.m1036dp(47.44f * f));
            float fM1036dp = AndroidUtilities.m1036dp(((Float) callbackReturn.run(Float.valueOf(46.56f))).floatValue() * f);
            float fM1036dp2 = AndroidUtilities.m1036dp(48.28f * f);
            Float fValueOf = Float.valueOf(48.0f);
            path.cubicTo(fM1036dp, fM1036dp2, AndroidUtilities.m1036dp(((Float) callbackReturn.run(fValueOf)).floatValue() * f), AndroidUtilities.m1036dp(47.68f * f), AndroidUtilities.m1036dp(((Float) callbackReturn.run(fValueOf)).floatValue() * f), AndroidUtilities.m1036dp(46.5f * f));
            path.cubicTo(AndroidUtilities.m1036dp(((Float) callbackReturn.run(fValueOf)).floatValue() * f), AndroidUtilities.m1036dp(45.31f * f), AndroidUtilities.m1036dp(((Float) callbackReturn.run(fValueOf)).floatValue() * f), AndroidUtilities.m1036dp(28.38f * f), AndroidUtilities.m1036dp(((Float) callbackReturn.run(fValueOf)).floatValue() * f), AndroidUtilities.m1036dp(27.32f * f));
            path.cubicTo(AndroidUtilities.m1036dp(((Float) callbackReturn.run(fValueOf)).floatValue() * f), AndroidUtilities.m1036dp(26.26f * f), AndroidUtilities.m1036dp(((Float) callbackReturn.run(Float.valueOf(47.5f))).floatValue() * f), AndroidUtilities.m1036dp(25.24f * f), AndroidUtilities.m1036dp(((Float) callbackReturn.run(Float.valueOf(46.82f))).floatValue() * f), AndroidUtilities.m1036dp(f2));
            path.close();
        }
        ...
        public RibbonDrawable(View view, float f) {
            ...
            this.paint.setPathEffect(new CornerPathEffect(AndroidUtilities.m1036dp(2.33f)));
        ...
        public void setColors(int i, int i2) {
            this.paint.setShader(new LinearGradient(0.0f, 0.0f, AndroidUtilities.m1036dp(48.0f), AndroidUtilities.m1036dp(48.0f), new int[]{i, i2}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP));
        }
        ...
        public void setBackdrop(TL_stars.starGiftAttributeBackdrop stargiftattributebackdrop, boolean z, boolean z2) {
            if (stargiftattributebackdrop == null) {
                ...
                this.paint.setShader(new LinearGradient(0.0f, 0.0f, AndroidUtilities.m1036dp(48.0f), AndroidUtilities.m1036dp(48.0f), new int[]{Theme.adaptHSV(stargiftattributebackdrop.center_color | (-16777216), z3 ? 0.07f : 0.05f, (z3 ? -0.15f : -0.1f) - (z2 ? 0.125f : 0.0f)), Theme.adaptHSV(stargiftattributebackdrop.edge_color | (-16777216), z3 ? 0.07f : 0.05f, (z3 ? -0.15f : -0.1f) - (z2 ? 0.125f : 0.0f))}, new float[]{z3 ? 1.0f : 0.0f, z3 ? 0.0f : 1.0f}, Shader.TileMode.CLAMP));
            }
        }
        ...
        public void draw(Canvas canvas) {
            Canvas canvas2;
            canvas.save();
            canvas.translate(getBounds().right - AndroidUtilities.m1036dp(48.0f), getBounds().top);
            if (this.strokePaint.getAlpha() > 0) {
                this.strokePaint.setStrokeWidth(AndroidUtilities.m1036dp(1.33f) * 2);
                canvas.drawPath(this.path, this.strokePaint);
            }
            canvas.drawPath(this.path, this.paint);
            if (this.particles != null) {
                canvas.clipPath(this.path);
                this.particles.setBounds(0, 0, AndroidUtilities.m1036dp(48.0f), AndroidUtilities.m1036dp(48.0f));
            ...
            if (this.text != null) {
                canvas.save();
                canvas.rotate(this.left ? -45.0f : 45.0f, (getBounds().width() / 2.0f) + AndroidUtilities.m1036dp(this.left ? -7.0f : 6.0f), (getBounds().height() / 2.0f) - AndroidUtilities.m1036dp(this.left ? 5.0f : 6.0f));
                float fMin = Math.min(1.0f, AndroidUtilities.m1036dp(40.0f) / this.text.getCurrentWidth());
                canvas.scale(fMin, fMin, (getBounds().width() / 2.0f) + AndroidUtilities.m1036dp(this.left ? -7.0f : 6.0f), (getBounds().height() / 2.0f) - AndroidUtilities.m1036dp(this.left ? 5.0f : 6.0f));
                canvas2 = canvas;
                this.text.draw(canvas2, ((getBounds().width() / 2.0f) + AndroidUtilities.m1036dp(this.left ? -7.0f : 6.0f)) - (this.text.getWidth() / 2.0f), (getBounds().height() / 2.0f) - AndroidUtilities.m1036dp(this.left ? 4.0f : 5.0f), this.textColor, 1.0f);
                canvas2.restore();
            } else {
                canvas2 = canvas;
            }
    ...
    public static class Ribbon extends View {
        ...
        public void onMeasure(int i, int i2) {
            setMeasuredDimension(AndroidUtilities.m1036dp(50.0f), AndroidUtilities.m1036dp(50.0f));
        }
    ...
    public static class StarsBackground extends Drawable {
        ...
        public void attach() {
            ...
            Utilities.Callback<Boolean> callback = new Utilities.Callback() { // from class: org.telegram.ui.Gifts.GiftSheet$StarsBackground$$ExternalSyntheticLambda0
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
    ...
    public static class SharedBackgroundDrawables {
        ...
        public SharedBackgroundDrawables() {
            ...
            this.radii = fArr;
            Arrays.fill(fArr, AndroidUtilities.m1036dp(11.0f));
        }
        ...
        public Drawable getOrCreateShadowNinePatch(int i) {
            if (this.shadowNinePatch == null || this.lastShadowColor != i) {
                ...
                this.shadowNinePatch = NinePatchBuilder.createNinePatch(this.shadowNinePatchBitmap, 0, this.radii, AndroidUtilities.m1036dp(1.66f), i, 0.0f, AndroidUtilities.m1036dp(0.33f), 0);
            }
        ...
        public Drawable getOrCreateFilledWithShadowNinePatch(int i, int i2) {
            if (this.filledWithShadowNinePatch == null || (this.lastFillingWithShadowFillingColor != i && this.lastFillingWithShadowShadowColor != i2)) {
                ...
                this.filledWithShadowNinePatch = NinePatchBuilder.createNinePatch(this.filledWithShadowNinePatchBitmap, i, this.radii, AndroidUtilities.m1036dp(1.66f), i2, 0.0f, AndroidUtilities.m1036dp(0.33f), i);
            }
    ...
    public static class CardBackground extends Drawable {
        ...
        public CardBackground(View view, Theme.ResourcesProvider resourcesProvider, boolean z) {
            ...
            this.f1728r = AndroidUtilities.m1036dp(11.0f);
            ...
            this.view = view;
            this.resourcesProvider = resourcesProvider;
            this.pattern = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(view, AndroidUtilities.m1036dp(28.0f)) { // from class: org.telegram.ui.Gifts.GiftSheet.CardBackground.1
                public C56741(View view2, int i2) {
                    super(view2, i2);
                }
            ...
            view2.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: org.telegram.ui.Gifts.GiftSheet.CardBackground.2
                public ViewOnAttachStateChangeListenerC56752() {
                }
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Gifts.GiftSheet$CardBackground$1 */
        public class C56741 extends AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable {
            public C56741(View view2, int i2) {
                super(view2, i2);
            }
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Gifts.GiftSheet$CardBackground$2 */
        public class ViewOnAttachStateChangeListenerC56752 implements View.OnAttachStateChangeListener {
            public ViewOnAttachStateChangeListenerC56752() {
            }
        ...
        private void checkShadow(boolean z) {
            if (this.lastNeedShadow != z) {
                ...
                if (z) {
                    paint.setShadowLayer(AndroidUtilities.m1036dp(1.66f), 0.0f, AndroidUtilities.m1036dp(0.33f), Theme.getColor(Theme.key_dialogCardShadow, this.resourcesProvider));
                } else {
        ...
        public void draw(Canvas canvas, float f) {
            ...
            if (this.withPadding) {
                this.rect.inset(AndroidUtilities.m1036dp(3.33f), AndroidUtilities.m1036dp(4.0f));
            }
            if (this.backdrop != null) {
                ...
                this.gradientMatrix.postTranslate(bounds.centerX(), Math.min(AndroidUtilities.m1036dp(50.0f), bounds.centerY()));
            ...
            boolean z = false;
            boolean z2 = this.f1728r == ((float) AndroidUtilities.m1036dp(11.0f)) && color == Theme.getColor(i2) && color2 == Theme.getColor(i3);
            ...
            if (this.strokeColors != null) {
                ...
                this.strokePaint.setStrokeWidth(AndroidUtilities.m1036dp(4.66f));
                RectF rectF5 = this.rect;
                float f7 = this.f1728r;
            ...
            if (this.backdrop != null && !this.pattern.isEmpty()) {
                ...
                if (BatchParticlesDrawHelper.isAvailable() && (stableBitmapFromPattern = getStableBitmapFromPattern(this.pattern)) != null) {
                    ...
                    if (this.lastDrawnColor != i4 || z) {
                        ...
                        if (i5 >= 29) {
                            AbstractC5335x2078045b.m1173m();
                            paint.setColorFilter(AbstractC5334x2078045a.m1172m(i4, BlendMode.SRC_IN));
                        } else {
                    ...
                    if (f > 0.0f) {
                        canvas2.translate(0.0f, AndroidUtilities.m1036dp(-31.0f));
            ...
            if (f2 > 0.0f) {
                ...
                if (i6 == 0) {
                    ...
                    float fLerp2 = AndroidUtilities.lerp(this.f1728r, AndroidUtilities.dpf2(7.33f), f2);
                ...
                if (i6 == 1) {
                    ...
                    float fLerp4 = AndroidUtilities.lerp(this.f1728r, AndroidUtilities.dpf2(10.0f), f2);
        ...
        public boolean getPadding(Rect rect) {
            rect.set(AndroidUtilities.m1036dp(3.33f), AndroidUtilities.m1036dp(4.0f), AndroidUtilities.m1036dp(3.33f), AndroidUtilities.m1036dp(4.0f));
            return true;
        }
        ...
        public void setPattern(TL_stars.starGiftAttributePattern stargiftattributepattern) {
            ...
            if (document != null) {
                this.patternDocumentId = document.f1253id;
            }
        }
    ...
    public static class Tabs extends FrameLayout {
        ...
        public Tabs(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
            ...
            this.resourcesProvider = resourcesProvider;
            C56771 c56771 = new LinearLayout(context) { // from class: org.telegram.ui.Gifts.GiftSheet.Tabs.1
                public C56771(Context context2) {
                    super(context2);
                }
            ...
            this.layout = c56771;
            c56771.setClipToPadding(false);
            c56771.setClipChildren(false);
            c56771.setOrientation(0);
            c56771.setPadding(0, AndroidUtilities.m1036dp(8.0f), 0, AndroidUtilities.m1036dp(10.0f));
            if (z) {
                this.scrollView = null;
                addView(c56771, LayoutHelper.createFrame(-2, -1, 1));
            } else {
                c56771.setPadding(AndroidUtilities.m1036dp(12.0f), AndroidUtilities.m1036dp(8.0f), AndroidUtilities.m1036dp(12.0f), AndroidUtilities.m1036dp(3.0f));
                HorizontalScrollView horizontalScrollView = new HorizontalScrollView(context2);
                this.scrollView = horizontalScrollView;
                horizontalScrollView.setHorizontalScrollBarEnabled(false);
                horizontalScrollView.setClipToPadding(false);
                horizontalScrollView.setClipChildren(false);
                horizontalScrollView.addView(c56771, LayoutHelper.createFrame(-2, -1, 119));
                addView(horizontalScrollView, LayoutHelper.createFrame(-1, -1, 119));
            }
            setHorizontalScrollBarEnabled(false);
            setClipToPadding(false);
            setClipChildren(false);
            this.animatedSelected = new AnimatedFloat(c56771, 0L, 320L, CubicBezierInterpolator.EASE_OUT_QUINT);
        }

        /* JADX INFO: renamed from: org.telegram.ui.Gifts.GiftSheet$Tabs$1 */
        public class C56771 extends LinearLayout {
            public C56771(Context context2) {
                super(context2);
            }
        ...
        public void set(int i, ArrayList<CharSequence> arrayList, int i2, final Utilities.Callback<Integer> callback) {
            ...
            if (this.tabs.size() != arrayList.size()) {
                ...
                while (i4 < arrayList.size()) {
                    ...
                    linksTextView.setTextSize(1, 14.0f);
                    linksTextView.setPadding(AndroidUtilities.m1036dp(12.0f), 0, AndroidUtilities.m1036dp(12.0f), 0);
        ...
        public static class Factory extends UItem.UItemFactory<Tabs> {
            ...
            @Override // org.telegram.ui.Components.UItem.UItemFactory
            public void bindView(View view, UItem uItem, boolean z, UniversalAdapter universalAdapter, UniversalRecyclerView universalRecyclerView) {
                ((Tabs) view).set(uItem.f1708id, (ArrayList) uItem.object, uItem.intValue, (Utilities.Callback) uItem.object2);
            }
            ...
            private static boolean m1178eq(ArrayList<CharSequence> arrayList, ArrayList<CharSequence> arrayList2) {
            ...
            @Override // org.telegram.ui.Components.UItem.UItemFactory
            public boolean equals(UItem uItem, UItem uItem2) {
                return uItem.f1708id == uItem2.f1708id && m1178eq((ArrayList) uItem.object, (ArrayList) uItem2.object);
            }
