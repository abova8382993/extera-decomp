...
public class AcquiredGiftsSheet extends BottomSheetWithRecyclerListView {
    ...
    public AcquiredGiftsSheet(Context context, Theme.ResourcesProvider resourcesProvider, GiftAuctionController.Auction auction, List<TL_stars.TL_StarGiftAuctionAcquiredGift> list) {
        ...
        fixNavigationBar();
        this.recyclerListView.setPadding(this.backgroundPaddingLeft, AndroidUtilities.m1036dp(9.0f), this.backgroundPaddingLeft, AndroidUtilities.m1036dp(64.0f));
    ...
    public void fillItems(ArrayList<UItem> arrayList, UniversalAdapter universalAdapter) {
        ...
        for (final TL_stars.TL_StarGiftAuctionAcquiredGift tL_StarGiftAuctionAcquiredGift : list) {
            arrayList.add(AcquiredGiftsCell.Factory.m1177as(tL_StarGiftAuctionAcquiredGift, this.auction, new View.OnClickListener() { // from class: org.telegram.ui.Gifts.AcquiredGiftsSheet$$ExternalSyntheticLambda3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    public static class AcquiredGiftsCell extends FrameLayout {
        ...
        public AcquiredGiftsCell(Context context, Theme.ResourcesProvider resourcesProvider, int i) {
            ...
            setPadding(AndroidUtilities.m1036dp(18.0f), AndroidUtilities.m1036dp(9.0f), AndroidUtilities.m1036dp(18.0f), AndroidUtilities.m1036dp(9.0f));
        }
        ...
        public void bind(GiftAuctionController.Auction auction, TL_stars.TL_StarGiftAuctionAcquiredGift tL_StarGiftAuctionAcquiredGift, final View.OnClickListener onClickListener) {
            ...
            spannableStringBuilder.append((CharSequence) LocaleController.formatString(C2797R.string.Gift2AuctionsAcquiredRound2, auction.gift.title, Integer.valueOf(tL_StarGiftAuctionAcquiredGift.gift_num), Integer.valueOf(tL_StarGiftAuctionAcquiredGift.round)));
            ...
            String string = LocaleController.formatString(C2797R.string.Gift2AuctionsAcquiredTop, Integer.valueOf(tL_StarGiftAuctionAcquiredGift.pos));
            ...
            tableView.addRowUser(LocaleController.getString(C2797R.string.Gift2AuctionsAcquiredRecipient), this.currentAccount, DialogObject.getPeerDialogId(tL_StarGiftAuctionAcquiredGift.peer), new Runnable() { // from class: org.telegram.ui.Gifts.AcquiredGiftsSheet$AcquiredGiftsCell$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$bind$0(onClickListener);
                }
            });
            tableView.addRowDateTime(LocaleController.getString(C2797R.string.Gift2AuctionsAcquiredDate), tL_StarGiftAuctionAcquiredGift.date);
            tableView.addRow(LocaleController.getString(C2797R.string.Gift2AuctionsAcquiredAcceptedBid), spannableStringBuilder2, string, (Runnable) null);
        ...
        public static class Factory extends UItem.UItemFactory<AcquiredGiftsCell> {
            ...
            public static UItem m1177as(TL_stars.TL_StarGiftAuctionAcquiredGift tL_StarGiftAuctionAcquiredGift, GiftAuctionController.Auction auction, View.OnClickListener onClickListener) {
