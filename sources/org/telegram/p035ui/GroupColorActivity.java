...
public class GroupColorActivity extends ChannelColorActivity {
    ...
    @Override // org.telegram.p035ui.ChannelColorActivity
    ...
    public int getEmojiPackStrRes() {
        return C2797R.string.GroupEmojiPack;
    }

    @Override // org.telegram.p035ui.ChannelColorActivity
    public int getEmojiPackInfoStrRes() {
        return C2797R.string.GroupEmojiPackInfo;
    }

    @Override // org.telegram.p035ui.ChannelColorActivity
    public int getStickerPackStrRes() {
        return C2797R.string.GroupStickerPack;
    }

    @Override // org.telegram.p035ui.ChannelColorActivity
    public int getStickerPackInfoStrRes() {
        return C2797R.string.GroupStickerPackInfo;
    }

    @Override // org.telegram.p035ui.ChannelColorActivity
    public int getProfileInfoStrRes() {
        return C2797R.string.GroupProfileInfo;
    }

    @Override // org.telegram.p035ui.ChannelColorActivity
    public int getEmojiStatusStrRes() {
        return C2797R.string.GroupEmojiStatus;
    }

    @Override // org.telegram.p035ui.ChannelColorActivity
    public int getEmojiStatusInfoStrRes() {
        return C2797R.string.GroupEmojiStatusInfo;
    }

    @Override // org.telegram.p035ui.ChannelColorActivity
    public int getWallpaperStrRes() {
        return C2797R.string.GroupWallpaper;
    }

    @Override // org.telegram.p035ui.ChannelColorActivity
    public int getWallpaper2InfoStrRes() {
        return C2797R.string.GroupWallpaper2Info;
    }

    @Override // org.telegram.p035ui.ChannelColorActivity, org.telegram.p035ui.ActionBar.BaseFragment
    ...
    public class ViewTreeObserverOnGlobalLayoutListenerC58341 implements ViewTreeObserver.OnGlobalLayoutListener {
        final /* synthetic */ View val$view;

        public ViewTreeObserverOnGlobalLayoutListenerC58341(View view) {
            this.val$view = view;
        }
    ...
    public void createListView() {
        ...
        recyclerListView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.GroupColorActivity.3
            ...
            public void onScrolled(RecyclerView recyclerView, int i, int i2) {
                ...
                float f2 = GroupColorActivity.this.profilePreviewPercent;
    ...
    public void updateColors(boolean z) {
        ...
        CombinedDrawable combinedDrawable = new CombinedDrawable(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundWhite, this.resourceProvider)), Theme.getThemedDrawableByKey(getContext(), C2797R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow), 0, 0);
    ...
    @Override // org.telegram.p035ui.ChannelColorActivity, org.telegram.messenger.NotificationCenter.NotificationCenterDelegate
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        super.didReceivedNotification(i, i2, objArr);
        if (i == NotificationCenter.chatInfoDidLoad && ((TLRPC.ChatFull) objArr[0]).f1246id == (-this.dialogId)) {
