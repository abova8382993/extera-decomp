...
import org.telegram.p035ui.FilterChatlistActivity;
...
public class FilterChatlistActivity extends BaseFragment {
    ...
    private Runnable enableDoneLoading = new Runnable() { // from class: org.telegram.ui.FilterChatlistActivity$$ExternalSyntheticLambda2
    ...
    public void updateActionBarTitle(boolean z) {
        ...
        String string = TextUtils.isEmpty(tL_exportedChatlistInvite == null ? null : tL_exportedChatlistInvite.title) ? LocaleController.getString(C2797R.string.FilterShare) : this.invite.title;
        ActionBar actionBar = this.actionBar;
        if (z) {
            actionBar.setTitleAnimated(string, false, 220L);
        } else {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.FilterChatlistActivity.1
            ...
            public void onItemClick(int i) {
                if (i == -1) {
                    ...
                    float fAbs = Math.abs(FilterChatlistActivity.this.doneButtonAlpha - 1.0f);
                    FilterChatlistActivity filterChatlistActivity = FilterChatlistActivity.this;
                    if (fAbs < 0.1f) {
                        filterChatlistActivity.save();
        ...
        this.listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.telegram.ui.FilterChatlistActivity$$ExternalSyntheticLambda3
        ...
        for (int i3 = 0; i3 < this.filter.dialogs.size(); i3++) {
            ...
            if (dialog != null && !DialogObject.isEncryptedDialog(dialog.f1251id) && !this.peers.contains(Long.valueOf(dialog.f1251id))) {
                long j = dialog.f1251id;
                boolean zCanAddToFolder = j < 0;
                if (j < 0) {
                    zCanAddToFolder = FilterCreateActivity.canAddToFolder(getMessagesController().getChat(Long.valueOf(-dialog.f1251id)));
                }
                if (zCanAddToFolder) {
                    this.peers.add(Long.valueOf(dialog.f1251id));
                    this.allowedPeers.add(Long.valueOf(dialog.f1251id));
                }
            }
        }
        for (int i4 = 0; i4 < this.filter.dialogs.size(); i4++) {
            TLRPC.Dialog dialog2 = this.filter.dialogs.get(i4);
            if (dialog2 != null && !DialogObject.isEncryptedDialog(dialog2.f1251id) && !this.peers.contains(Long.valueOf(dialog2.f1251id)) && !this.allowedPeers.contains(Long.valueOf(dialog2.f1251id))) {
                this.peers.add(Long.valueOf(dialog2.f1251id));
            }
        }
        updateRows();
    ...
    public /* synthetic */ void lambda$createView$0(View view, int i) {
        String string;
        String string2;
        FilterChatlistActivity filterChatlistActivity;
        if (getParentActivity() != null && (view instanceof GroupCreateUserCell)) {
            ...
            if (this.selectedPeers.contains(l)) {
                ...
                filterChatlistActivity = this;
                filterChatlistActivity.selectedPeers.add(l);
                ...
                if (jLongValue >= 0) {
                    ...
                    if (user != null && user.bot) {
                        string2 = LocaleController.getString(C2797R.string.FilterInviteBotToast);
                    } else {
                        string2 = LocaleController.getString(C2797R.string.FilterInviteUserToast);
                    }
                } else {
                    TLRPC.Chat chat = getMessagesController().getChat(Long.valueOf(-jLongValue));
                    if (ChatObject.isChannelAndNotMegaGroup(chat)) {
                        if (ChatObject.isPublic(chat)) {
                            string = LocaleController.getString(C2797R.string.FilterInviteChannelToast);
                        } else {
                            string = LocaleController.getString(C2797R.string.FilterInvitePrivateChannelToast);
                        }
                    } else if (ChatObject.isPublic(chat)) {
                        string = LocaleController.getString(C2797R.string.FilterInviteGroupToast);
                    } else {
                        string = LocaleController.getString(C2797R.string.FilterInvitePrivateGroupToast);
                    }
                    arrayList.add(chat);
                    string2 = string;
                }
                if (this.lastClickedDialogId != jLongValue || System.currentTimeMillis() - this.lastClicked > 1500) {
                    ...
                    BulletinFactory.m1143of(this).createChatsBulletin(arrayList, string2, null).show();
                    return;
                }
                return;
            }
            filterChatlistActivity.checkPeersChanged();
            filterChatlistActivity.updateHeaderCell(true);
            filterChatlistActivity.updateHintCell(true);
        }
    }
    ...
    public void save() {
        ...
        getConnectionsManager().sendRequest(tL_chatlists_editExportedInvite, new RequestDelegate() { // from class: org.telegram.ui.FilterChatlistActivity$$ExternalSyntheticLambda8
    ...
    public /* synthetic */ void lambda$save$2(TLObject tLObject, final TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.FilterChatlistActivity$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void saveTitle() {
        ...
        this.savingTitleReqId = getConnectionsManager().sendRequest(tL_chatlists_editExportedInvite, new RequestDelegate() { // from class: org.telegram.ui.FilterChatlistActivity$$ExternalSyntheticLambda0
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    public /* synthetic */ void lambda$saveTitle$4(TLObject tLObject, final TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.FilterChatlistActivity$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$saveTitle$3(TLRPC.TL_error tL_error) {
        this.savingTitleReqId = 0;
        if (tL_error == null) {
            BulletinFactory.m1143of(this).createSimpleBulletin(C2797R.raw.contact_check, LocaleController.getString(C2797R.string.FilterInviteNameEdited)).show();
        }
    }
    ...
    public void updateHintCell(boolean z) {
        ...
        if (this.invite == null) {
            hintInnerCell.setText(LocaleController.getString(C2797R.string.FilterInviteHeaderNo), false);
            return;
        }
    ...
    public void updateHeaderCell(boolean z) {
        ...
        if (this.allowedPeers.size() > 1) {
            ...
            this.headerCountCell.setAction(LocaleController.getString(!z2 ? C2797R.string.SelectAll : C2797R.string.DeselectAll), new Runnable() { // from class: org.telegram.ui.FilterChatlistActivity$$ExternalSyntheticLambda6
                @Override // java.lang.Runnable
                public final void run() {
            ...
            this.headerCountCell.setAction(_UrlKt.FRAGMENT_ENCODE_SET, null);
        }
        if (z) {
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            View headerCell;
            if (i == 0) {
                headerCell = new HintInnerCell(FilterChatlistActivity.this.getContext(), C2797R.raw.folder_share);
            } else if (i == 2) {
                headerCell = new TextInfoPrivacyCell(FilterChatlistActivity.this.getContext());
            } else if (i == 3) {
                headerCell = new C55971(FilterChatlistActivity.this.getContext(), FilterChatlistActivity.this);
        ...
        /* JADX INFO: renamed from: org.telegram.ui.FilterChatlistActivity$ListAdapter$1 */
        public class C55971 extends InviteLinkCell {
            public C55971(Context context, BaseFragment baseFragment) {
            ...
            public void deleteLink() {
                ...
                FilterChatlistActivity filterChatlistActivity = FilterChatlistActivity.this;
                tL_inputChatlistDialogFilter.filter_id = filterChatlistActivity.filter.f1156id;
                tL_chatlists_deleteExportedInvite.slug = filterChatlistActivity.getSlug();
                final AlertDialog alertDialog = new AlertDialog(getContext(), 3);
                alertDialog.showDelayed(180L);
                FilterChatlistActivity.this.getConnectionsManager().sendRequest(tL_chatlists_deleteExportedInvite, new RequestDelegate() { // from class: org.telegram.ui.FilterChatlistActivity$ListAdapter$1$$ExternalSyntheticLambda7
                    @Override // org.telegram.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
            ...
            public /* synthetic */ void lambda$deleteLink$3(final AlertDialog alertDialog, TLObject tLObject, TLRPC.TL_error tL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.FilterChatlistActivity$ListAdapter$1$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
            ...
            public void editname() {
                ...
                builder.setTitle(LocaleController.getString(C2797R.string.FilterInviteEditName));
                builder.setNegativeButton(LocaleController.getString(C2797R.string.Cancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.FilterChatlistActivity$ListAdapter$1$$ExternalSyntheticLambda2
                ...
                editTextBoldCursor.setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: org.telegram.ui.FilterChatlistActivity$ListAdapter$1$$ExternalSyntheticLambda3
                    @Override // android.widget.TextView.OnEditorActionListener
                    public final boolean onEditorAction(TextView textView, int i2, KeyEvent keyEvent) {
                        return FilterChatlistActivity.ListAdapter.C55971.m15963$r8$lambda$7YDJLZtC9zlvS_dgDCiC9wZWSw(builder, textView, i2, keyEvent);
                    }
                });
                ...
                builder.setPositiveButton(LocaleController.getString(C2797R.string.Save), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.FilterChatlistActivity$ListAdapter$1$$ExternalSyntheticLambda4
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                ...
                alertDialogCreate.setOnShowListener(new DialogInterface.OnShowListener() { // from class: org.telegram.ui.FilterChatlistActivity$ListAdapter$1$$ExternalSyntheticLambda5
                    @Override // android.content.DialogInterface.OnShowListener
                    public final void onShow(DialogInterface dialogInterface) {
                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.FilterChatlistActivity$ListAdapter$1$$ExternalSyntheticLambda0
                            @Override // java.lang.Runnable
                            public final void run() {
                                FilterChatlistActivity.ListAdapter.C55971.$r8$lambda$OMUeedhUn3MJzL3eK6XyRJnyWH8(editTextBoldCursor);
                            }
                        });
                    }
                });
                alertDialogCreate.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.FilterChatlistActivity$ListAdapter$1$$ExternalSyntheticLambda6
            ...
            /* JADX INFO: renamed from: $r8$lambda$7YDJLZtC9zlvS_dgDCiC9wZW-Sw, reason: not valid java name */
            public static /* synthetic */ boolean m15963$r8$lambda$7YDJLZtC9zlvS_dgDCiC9wZWSw(AlertDialog.Builder builder, TextView textView, int i, KeyEvent keyEvent) {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 2) {
                ...
                textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(FilterChatlistActivity.this.getContext(), i == FilterChatlistActivity.this.chatsSectionRow ? C2797R.drawable.greydivider_bottom : C2797R.drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                if (i == FilterChatlistActivity.this.chatsSectionRow) {
                    ...
                    if (filterChatlistActivity.invite == null || filterChatlistActivity.allowedPeers.isEmpty()) {
                        textInfoPrivacyCell.setText(LocaleController.getString(C2797R.string.FilterInviteHintNo));
                        return;
                    } else {
                        textInfoPrivacyCell.setText(LocaleController.getString(C2797R.string.FilterInviteHint));
                        return;
                    }
                }
            ...
            if (itemViewType != 4) {
                if (itemViewType == 5) {
                    ...
                    if (i == FilterChatlistActivity.this.linkHeaderRow) {
                        headerCell.setText(LocaleController.getString(C2797R.string.InviteLink), false);
                        headerCell.setAction(_UrlKt.FRAGMENT_ENCODE_SET, null);
                        return;
                    }
                    ...
                    if (filterChatlistActivity2.invite == null || filterChatlistActivity2.allowedPeers.isEmpty()) {
                        headerCell.setText(LocaleController.getString(C2797R.string.FilterInviteHeaderChatsNo), false);
                        headerCell.setAction(_UrlKt.FRAGMENT_ENCODE_SET, null);
                        return;
                    } else {
            ...
            long jLongValue = l.longValue();
            FilterChatlistActivity filterChatlistActivity3 = FilterChatlistActivity.this;
            if (jLongValue >= 0) {
                TLRPC.User user2 = filterChatlistActivity3.getMessagesController().getUser(l);
                if (user2 != null) {
                ...
                TLRPC.Chat chat = filterChatlistActivity3.getMessagesController().getChat(Long.valueOf(-jLongValue));
                if (chat != null) {
                    string = chat.title;
            ...
            if (FilterChatlistActivity.this.allowedPeers.contains(l)) {
                ...
                if (user instanceof TLRPC.User) {
                    if (user.bot) {
                        string = LocaleController.getString(C2797R.string.FilterInviteBot);
                    } else {
                        string = LocaleController.getString(C2797R.string.FilterInviteUser);
                    }
                } else if (user instanceof TLRPC.Chat) {
                    if (ChatObject.isChannelAndNotMegaGroup((TLRPC.Chat) user)) {
                        string = LocaleController.getString(C2797R.string.FilterInviteChannel);
                    } else {
                        string = LocaleController.getString(C2797R.string.FilterInviteGroup);
                    }
                }
            }
    ...
    private int getMaxChats() {
        ...
        return zIsPremium ? messagesController.dialogFiltersChatsLimitPremium : messagesController.dialogFiltersChatsLimitDefault;
    }
    ...
    private void deselectAll(final FolderBottomSheet.HeaderCell headerCell, final boolean z) {
        ...
        headerCell.setAction(LocaleController.getString(this.selectedPeers.size() >= Math.min(getMaxChats(), this.allowedPeers.size()) ? C2797R.string.DeselectAll : C2797R.string.SelectAll), new Runnable() { // from class: org.telegram.ui.FilterChatlistActivity$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private void updateDoneProgress(boolean z) {
        ...
        if (this.doneButtonDrawable != null) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.FilterChatlistActivity$$ExternalSyntheticLambda7
    ...
    public boolean checkDiscard(boolean z) {
        ...
        builder.setMessage(LocaleController.getString(C2797R.string.UnsavedChangesMessage));
        builder.setPositiveButton(LocaleController.getString(C2797R.string.ApplyTheme), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.FilterChatlistActivity$$ExternalSyntheticLambda4
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
                this.f$0.lambda$checkDiscard$9(alertDialog, i);
            }
        });
        builder.setNegativeButton(LocaleController.getString(C2797R.string.PassportDiscard), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.FilterChatlistActivity$$ExternalSyntheticLambda5
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
    ...
    public static class InviteLinkCell extends FrameLayout {
        ...
        public class ButtonsBox extends FrameLayout {
            ...
            public void onDraw(Canvas canvas) {
                ...
                rectF.set(0.0f, 0.0f, measuredWidth - AndroidUtilities.lerp(0, AndroidUtilities.m1036dp(4.0f), this.f1724t), getMeasuredHeight());
                setRadii(AndroidUtilities.m1036dp(8.0f), AndroidUtilities.lerp(0, AndroidUtilities.m1036dp(8.0f), this.f1724t));
                Path path = this.path;
                float[] fArr = this.radii;
                ...
                this.path.rewind();
                rectF.set(measuredWidth + AndroidUtilities.lerp(0, AndroidUtilities.m1036dp(4.0f), this.f1724t), 0.0f, getMeasuredWidth(), getMeasuredHeight());
                setRadii(AndroidUtilities.lerp(0, AndroidUtilities.m1036dp(8.0f), this.f1724t), AndroidUtilities.m1036dp(8.0f));
        ...
        public InviteLinkCell(Context context, BaseFragment baseFragment) {
            ...
            frameLayout.setBackground(Theme.createSimpleSelectorRoundRectDrawable(iM1036dp, Theme.getColor(i), Theme.blendOver(Theme.getColor(i), Theme.getColor(Theme.key_listSelector))));
            this.linkBox.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.FilterChatlistActivity$InviteLinkCell$$ExternalSyntheticLambda0
            ...
            this.optionsIcon.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.FilterChatlistActivity$InviteLinkCell$$ExternalSyntheticLambda1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            TextView textView = new TextView(context) { // from class: org.telegram.ui.FilterChatlistActivity.InviteLinkCell.1
                ...
                public void onMeasure(int i3, int i4) {
                    super.onMeasure(View.MeasureSpec.makeMeasureSpec((View.MeasureSpec.getSize(i3) - AndroidUtilities.m1036dp(8.0f)) / 2, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(42.0f), TLObject.FLAG_30));
                }
            };
            ...
            spannableStringBuilder.append((CharSequence) "..").setSpan(new ColoredImageSpan(ContextCompat.getDrawable(context, C2797R.drawable.msg_copy_filled)), 0, 1, 0);
            spannableStringBuilder.setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m1036dp(8.0f)), 1, 2, 0);
            spannableStringBuilder.append((CharSequence) LocaleController.getString(C2797R.string.LinkActionCopy));
            spannableStringBuilder.append((CharSequence) ".").setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m1036dp(5.0f)), spannableStringBuilder.length() - 1, spannableStringBuilder.length(), 0);
            this.copyButton.setText(spannableStringBuilder);
            this.copyButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.FilterChatlistActivity$InviteLinkCell$$ExternalSyntheticLambda2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            TextView textView3 = new TextView(context) { // from class: org.telegram.ui.FilterChatlistActivity.InviteLinkCell.2
                ...
                public void onMeasure(int i4, int i5) {
                    super.onMeasure(View.MeasureSpec.makeMeasureSpec((View.MeasureSpec.getSize(i4) - AndroidUtilities.m1036dp(8.0f)) / 2, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(42.0f), TLObject.FLAG_30));
                }
            };
            ...
            spannableStringBuilder2.append((CharSequence) "..").setSpan(new ColoredImageSpan(ContextCompat.getDrawable(context, C2797R.drawable.msg_share_filled)), 0, 1, 0);
            spannableStringBuilder2.setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m1036dp(8.0f)), 1, 2, 0);
            spannableStringBuilder2.append((CharSequence) LocaleController.getString(C2797R.string.LinkActionShare));
            spannableStringBuilder2.append((CharSequence) ".").setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m1036dp(5.0f)), spannableStringBuilder2.length() - 1, spannableStringBuilder2.length(), 0);
            this.shareButton.setText(spannableStringBuilder2);
            this.shareButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.FilterChatlistActivity$InviteLinkCell$$ExternalSyntheticLambda3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            this.generateButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.FilterChatlistActivity$InviteLinkCell$$ExternalSyntheticLambda4
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        public /* synthetic */ void lambda$new$2(View view) {
            if (this.linkBox.getBackground() instanceof RippleDrawable) {
                ...
                postDelayed(new Runnable() { // from class: org.telegram.ui.FilterChatlistActivity$InviteLinkCell$$ExternalSyntheticLambda5
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public void setLink(final String str, boolean z) {
            ...
            if (this.changeAlpha != (str != null ? 1 : 0)) {
                ...
                if (z) {
                    ...
                    valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.FilterChatlistActivity$InviteLinkCell$$ExternalSyntheticLambda6
                        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                        public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    ...
                    this.changeAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.FilterChatlistActivity.InviteLinkCell.3
                        ...
                        public void onAnimationEnd(Animator animator) {
                            ...
                            if (str2 == null) {
                                inviteLinkCell.generateButton.setVisibility(0);
                            ...
                            inviteLinkCell.generateButton.setVisibility(8);
                ...
                updateChangeAlpha();
                TextView textView = this.generateButton;
                if (str == null) {
        ...
        @Override // android.widget.FrameLayout, android.view.View
        public void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(127.0f), TLObject.FLAG_30));
        }
        ...
        public void options() {
            ...
            actionBarMenuSubItem.setTextAndIcon(LocaleController.getString(C2797R.string.EditName), C2797R.drawable.msg_edit);
            ...
            actionBarMenuSubItem2.setTextAndIcon(LocaleController.getString(C2797R.string.GetQRCode), C2797R.drawable.msg_qrcode);
            ...
            actionBarMenuSubItem3.setTextAndIcon(LocaleController.getString(C2797R.string.DeleteLink), C2797R.drawable.msg_delete);
            ...
            if (overlayContainerView != null) {
                ...
                this.actionBarPopupWindow.setAnimationStyle(C2797R.style.PopupContextAnimation);
                ...
                this.actionBarPopupWindow.showAtLocation(overlayContainerView, 0, (int) (((overlayContainerView.getMeasuredWidth() - actionBarPopupWindowLayout.getMeasuredWidth()) - AndroidUtilities.m1036dp(16.0f)) + overlayContainerView.getX() + paddingLeft), (int) (paddingTop + this.linkBox.getMeasuredHeight() + overlayContainerView.getY()));
            }
        }
        ...
        public void copy() {
            ...
            BulletinFactory.m1143of(this.parentFragment).createCopyBulletin(LocaleController.getString(C2797R.string.LinkCopied)).show();
        }
        ...
        public void share() {
            ...
            try {
                ...
                this.parentFragment.startActivityForResult(Intent.createChooser(intent, LocaleController.getString(C2797R.string.InviteToGroupByLink)), 500);
            } catch (Exception e) {
                FileLog.m1048e(e);
            }
        }
