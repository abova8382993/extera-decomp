...
import org.telegram.p035ui.ChangeUsernameActivity;
import org.telegram.p035ui.ChatEditTypeActivity;
...
import org.telegram.p035ui.Components.JoinToSendSettingsView;
...
public class ChatEditTypeActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public boolean onFragmentCreate() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.ChatEditTypeActivity.onFragmentCreate():boolean");
    }
    ...
    public void onResume() {
        ...
        if (textSettingsCell != null && (chatFull = this.info) != null) {
            if (chatFull.stickerset != null) {
                textSettingsCell.setTextAndValue(LocaleController.getString(C2797R.string.GroupStickers), this.info.stickerset.title, false);
            } else {
                textSettingsCell.setText(LocaleController.getString(C2797R.string.GroupStickers), false);
            }
        }
    ...
    public View createView(final Context context) {
        ...
        SectionsScrollView sectionsScrollView = new SectionsScrollView(context, this.linearLayout, this.resourceProvider, false) { // from class: org.telegram.ui.ChatEditTypeActivity.2
        ...
        if (this.isForcePublic) {
            this.actionBar.setTitle(LocaleController.getString(C2797R.string.TypeLocationGroup));
        } else {
            boolean z = this.isChannel;
            ActionBar actionBar = this.actionBar;
            if (z) {
                actionBar.setTitle(LocaleController.getString(C2797R.string.ChannelSettingsTitle));
            } else {
                actionBar.setTitle(LocaleController.getString(C2797R.string.GroupSettingsTitle));
            }
        }
        ...
        if (z2) {
            headerCell2.setText(LocaleController.getString(C2797R.string.ChannelTypeHeader));
        } else {
            headerCell2.setText(LocaleController.getString(C2797R.string.GroupTypeHeader));
        }
        ...
        if (this.isChannel) {
            radioButtonCell.setTextAndValue(LocaleController.getString(C2797R.string.ChannelPrivate), LocaleController.getString(C2797R.string.ChannelPrivateInfo), false, this.isPrivate);
        } else {
            radioButtonCell.setTextAndValue(LocaleController.getString(C2797R.string.MegaPrivate), LocaleController.getString(C2797R.string.MegaPrivateInfo), false, this.isPrivate);
        }
        ...
        if (this.isChannel) {
            radioButtonCell2.setTextAndValue(LocaleController.getString(C2797R.string.ChannelPublic), LocaleController.getString(C2797R.string.ChannelPublicInfo), false, !this.isPrivate);
        } else {
            radioButtonCell2.setTextAndValue(LocaleController.getString(C2797R.string.MegaPublic), LocaleController.getString(C2797R.string.MegaPublicInfo), false, !this.isPrivate);
        }
        ...
        this.usernameTextView.setHint(LocaleController.getString(C2797R.string.ChannelUsernamePlaceholder));
        this.usernameTextView.setCursorColor(Theme.getColor(i3));
        this.usernameTextView.setCursorSize(AndroidUtilities.m1036dp(20.0f));
        ...
        C36526 c36526 = new C36526(context, 12, this.resourceProvider);
        this.checkTextView = c36526;
        c36526.setBottomPadding(6);
        ...
        textCell.setTextAndIcon((CharSequence) LocaleController.getString(C2797R.string.ManageInviteLinks), C2797R.drawable.msg_link2, false);
        ...
        C36537 c36537 = new C36537(context, this.currentChat, context);
        this.joinContainer = c36537;
        TLRPC.ChatFull chatFull = this.info;
        c36537.showJoinToSend((chatFull == null || chatFull.linked_chat_id == 0 || this.isChannel) ? false : true);
        ...
        this.saveHeaderCell.setText(LocaleController.getString(C2797R.string.SavingContentTitle));
        ...
        textCheckCell.setTextAndCheck(LocaleController.getString(C2797R.string.RestrictSavingContent), this.isSaveRestricted, false);
        ...
        if (this.isChannel && !ChatObject.isMegagroup(this.currentChat)) {
            this.saveRestrictInfoCell.setText(LocaleController.getString(C2797R.string.RestrictSavingContentInfoChannel));
        } else {
            this.saveRestrictInfoCell.setText(LocaleController.getString(C2797R.string.RestrictSavingContentInfoGroup));
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ChatEditTypeActivity$6 */
    public class C36526 extends TextInfoPrivacyCell {
        int prevHeight;
        ValueAnimator translateAnimator;

        public C36526(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        @Override // org.telegram.p035ui.Cells.TextInfoPrivacyCell
        public void setText(CharSequence charSequence) {
            if (charSequence != 0) {
                ...
                final String string = (ChatEditTypeActivity.this.usernameTextView == null || ChatEditTypeActivity.this.usernameTextView.getText() == null) ? _UrlKt.FRAGMENT_ENCODE_SET : ChatEditTypeActivity.this.usernameTextView.getText().toString();
                for (int i = 0; i < typefaceSpanArr.length; i++) {
                    charSequence.setSpan(new ClickableSpan() { // from class: org.telegram.ui.ChatEditTypeActivity.6.1
                        ...
                        public void onClick(View view) {
                            Browser.openUrl(C36526.this.getContext(), "https://fragment.com/username/" + string);
                        }
            ...
            if (this.prevHeight != -1 && ChatEditTypeActivity.this.linearLayout != null) {
                ...
                valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.ChatEditTypeActivity$6$$ExternalSyntheticLambda0
                    ...
                    public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                        ChatEditTypeActivity.C36526.m9575$r8$lambda$5iypMHzfd2L8oljr3QXR7PEQpM(arrayList, height, valueAnimator2);
                    }
                });
        ...
        /* JADX INFO: renamed from: $r8$lambda$5iypMHzfd2L8oljr3QXR-7PEQpM, reason: not valid java name */
        public static /* synthetic */ void m9575$r8$lambda$5iypMHzfd2L8oljr3QXR7PEQpM(ArrayList arrayList, float f, ValueAnimator valueAnimator) {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ChatEditTypeActivity$7 */
    public class C36537 extends JoinToSendSettingsView {
        final /* synthetic */ Context val$context;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C36537(Context context, TLRPC.Chat chat, Context context2) {
            super(context, chat);
            this.val$context = context2;
        }

        @Override // org.telegram.p035ui.Components.JoinToSendSettingsView
        public boolean onJoinRequestToggle(final boolean z, Runnable runnable) {
            ...
            builder.setTitle(LocaleController.getString(C2797R.string.ApproveNewMembersApplyToLinksTitle));
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatPluralString(str, i, new Object[0])));
            builder.setPositiveButton(LocaleController.getString(C2797R.string.ApproveNewMembersApplyToLinksApply), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ChatEditTypeActivity$7$$ExternalSyntheticLambda0
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i2) {
                    this.f$0.lambda$onJoinRequestToggle$0(z, alertDialog, i2);
                }
            });
            builder.setNegativeButton(LocaleController.getString(C2797R.string.ApproveNewMembersApplyToLinksDontApply), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ChatEditTypeActivity$7$$ExternalSyntheticLambda1
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i2) {
    ...
    public class UsernamesListView extends RecyclerListView {
        ...
        /* JADX INFO: renamed from: $r8$lambda$oQEsyq3f16mseGL6oDuSzZA7-1Y, reason: not valid java name */
        public static /* synthetic */ void m9576$r8$lambda$oQEsyq3f16mseGL6oDuSzZA71Y(TLObject tLObject, TLRPC.TL_error tL_error) {
        }
        ...
        public UsernamesListView(Context context) {
            ...
            setOnItemClickListener(new C36541(ChatEditTypeActivity.this));
            ItemTouchHelper itemTouchHelper = new ItemTouchHelper(new TouchHelperCallback());
            this.itemTouchHelper = itemTouchHelper;
            itemTouchHelper.attachToRecyclerView(this);
        }

        /* JADX INFO: renamed from: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$1 */
        public class C36541 implements RecyclerListView.OnItemClickListener {
            final /* synthetic */ ChatEditTypeActivity val$this$0;

            public C36541(ChatEditTypeActivity chatEditTypeActivity) {
            ...
            public void onItemClick(final View view, int i) {
                ...
                if (z) {
                    ...
                    if (view2 instanceof ScrollView) {
                        ((ScrollView) view2).smoothScrollTo(0, chatEditTypeActivity.linkContainer.getTop() - AndroidUtilities.m1036dp(128.0f));
                    }
                ...
                new AlertDialog.Builder(usernamesListView.getContext(), ChatEditTypeActivity.this.getResourceProvider()).setTitle(LocaleController.getString(tL_username.active ? C2797R.string.UsernameDeactivateLink : C2797R.string.UsernameActivateLink)).setMessage(LocaleController.getString(tL_username.active ? C2797R.string.UsernameDeactivateLinkChannelMessage : C2797R.string.UsernameActivateLinkChannelMessage)).setPositiveButton(LocaleController.getString(tL_username.active ? C2797R.string.Hide : C2797R.string.Show), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$1$$ExternalSyntheticLambda1
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                    public final void onClick(AlertDialog alertDialog, int i2) {
                        this.f$0.lambda$onItemClick$4(tL_username, view, alertDialog, i2);
                    }
                }).setNegativeButton(LocaleController.getString(C2797R.string.Cancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$1$$ExternalSyntheticLambda2
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                    public final void onClick(AlertDialog alertDialog, int i2) {
                        alertDialog.dismiss();
                    }
            ...
            public /* synthetic */ void lambda$onItemClick$4(final TLRPC.TL_username tL_username, View view, AlertDialog alertDialog, int i) {
                if (tL_username.editable) {
                    ...
                    tL_inputChannel.channel_id = ChatEditTypeActivity.this.currentChat.f1245id;
            ...
            public /* synthetic */ void lambda$onItemClick$1(final TLRPC.TL_username tL_username, final boolean z) {
                new AlertDialog.Builder(UsernamesListView.this.getContext(), ((RecyclerListView) UsernamesListView.this).resourcesProvider).setTitle(LocaleController.getString(C2797R.string.UsernameActivateErrorTitle)).setMessage(LocaleController.getString(C2797R.string.UsernameActivateErrorMessage)).setPositiveButton(LocaleController.getString(C2797R.string.f1162OK), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$1$$ExternalSyntheticLambda0
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
        ...
        public void sendReorder() {
            ...
            ChatEditTypeActivity.this.getConnectionsManager().sendRequest(tL_channels_reorderUsernames, new RequestDelegate() { // from class: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$$ExternalSyntheticLambda0
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    ChatEditTypeActivity.UsernamesListView.m9576$r8$lambda$oQEsyq3f16mseGL6oDuSzZA71Y(tLObject, tL_error);
                }
            });
            updateChat();
        }
        ...
        public class Adapter extends RecyclerListView.SelectionAdapter {
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
                ...
                if (itemViewType == 0) {
                    ...
                    ((HeaderCell) viewHolder.itemView).setText(LocaleController.getString(C2797R.string.UsernamesChannelHeader));
                    return;
                }
                if (itemViewType != 1) {
                    if (itemViewType != 2) {
                    ...
                    ((TextInfoPrivacyCell) viewHolder.itemView).setText(LocaleController.getString(C2797R.string.UsernamesChannelHelp));
                    ((TextInfoPrivacyCell) viewHolder.itemView).setBackground(Theme.getThemedDrawableByKey(UsernamesListView.this.getContext(), C2797R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                    return;
                }
    ...
    private boolean trySetUsername() {
        ...
        getMessagesController().updateChannelUserName(this, this.chatId, str, new Runnable() { // from class: org.telegram.ui.ChatEditTypeActivity$$ExternalSyntheticLambda18
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$loadAdminedChannels$20(View view) {
        ...
        if (this.isChannel) {
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("RevokeLinkAlertChannel", C2797R.string.RevokeLinkAlertChannel, getMessagesController().linkPrefix + "/" + ChatObject.getPublicUsername(currentChannel), currentChannel.title)));
        } else {
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("RevokeLinkAlert", C2797R.string.RevokeLinkAlert, getMessagesController().linkPrefix + "/" + ChatObject.getPublicUsername(currentChannel), currentChannel.title)));
        }
        builder.setNegativeButton(LocaleController.getString(C2797R.string.Cancel), null);
        builder.setPositiveButton(LocaleController.getString(C2797R.string.RevokeButton), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ChatEditTypeActivity$$ExternalSyntheticLambda27
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
    ...
    private void updatePrivatePublic() {
        ...
        if (!this.isPrivate && !this.canCreatePublic && getUserConfig().isPremium()) {
            ...
            boolean z = this.loadingAdminedChannels;
            LoadingCell loadingCell = this.loadingAdminedCell;
            if (z) {
            ...
            boolean z2 = this.isForcePublic;
            ShadowSectionCell shadowSectionCell = this.sectionCell2;
            if (z2) {
            ...
            if (z3) {
                textInfoPrivacyCell3.setText(LocaleController.getString(this.isPrivate ? C2797R.string.ChannelPrivateLinkHelp : C2797R.string.ChannelUsernameHelp));
                ...
                textInfoPrivacyCell3.setText(LocaleController.getString(this.isPrivate ? C2797R.string.MegaPrivateLinkHelp : C2797R.string.MegaUsernameHelp));
                this.headerCell.setText(LocaleController.getString(this.isPrivate ? C2797R.string.ChannelInviteLinkTitle : C2797R.string.ChannelLinkTitle));
            }
            ...
            this.manageLinksInfoCell.setText(LocaleController.getString((chatFull != null && chatFull.paid_media_allowed && ChatObject.isChannelAndNotMegaGroup(getMessagesController().getChat(Long.valueOf(this.chatId)))) ? C2797R.string.ManageLinksInfoHelpPaid : C2797R.string.ManageLinksInfoHelp));
        }
    ...
    public boolean checkUserName(final String str) {
        ...
        if (str != null) {
            ...
            for (int i = 0; i < str.length(); i++) {
                ...
                if (i == 0 && cCharAt >= '0' && cCharAt <= '9') {
                    ...
                    if (z) {
                        textInfoPrivacyCell.setText(LocaleController.getString(C2797R.string.LinkInvalidStartNumber));
                    } else {
                        textInfoPrivacyCell.setText(LocaleController.getString(C2797R.string.LinkInvalidStartNumberMega));
                    }
                    this.checkTextView.setTextColorByKey(Theme.key_text_RedRegular);
                    return false;
                }
        ...
        if (str == null || str.length() < 4) {
            ...
            if (z2) {
                textInfoPrivacyCell2.setText(LocaleController.getString(C2797R.string.LinkInvalidShort));
            } else {
                textInfoPrivacyCell2.setText(LocaleController.getString(C2797R.string.LinkInvalidShortMega));
            }
            this.checkTextView.setTextColorByKey(Theme.key_text_RedRegular);
            return false;
        }
        ...
        if (length > 32) {
            textInfoPrivacyCell3.setText(LocaleController.getString(C2797R.string.LinkInvalidLong));
            this.checkTextView.setTextColorByKey(Theme.key_text_RedRegular);
            return false;
        }
        textInfoPrivacyCell3.setText(LocaleController.getString(C2797R.string.LinkChecking));
    ...
    public /* synthetic */ void lambda$checkUserName$23(String str, TLRPC.TL_error tL_error, TLObject tLObject, TLRPC.TL_channels_checkUsername tL_channels_checkUsername) {
        ...
        if (tL_error != null && "USERNAME_INVALID".equals(tL_error.text) && tL_channels_checkUsername.username.length() == 4) {
            ...
            TextInfoPrivacyCell textInfoPrivacyCell = this.checkTextView;
            if (length == 4) {
                textInfoPrivacyCell.setText(LocaleController.getString(C2797R.string.UsernameInvalidShortPurchase));
            } else {
                textInfoPrivacyCell.setText(LocaleController.getString(C2797R.string.UsernameInUsePurchase));
            }
