...
import org.telegram.p035ui.Components.RecyclerListView$$ExternalSyntheticLambda1;
...
public abstract class GradientHeaderActivity extends BaseFragment {
        ...
        View view = new View(context) { // from class: org.telegram.ui.GradientHeaderActivity.3
            ...
            public void onMeasure(int i, int i2) {
                ...
                if (gradientHeaderActivity.isLandscapeMode) {
                    gradientHeaderActivity.firstViewHeight = (gradientHeaderActivity.statusBarHeight + ((BaseFragment) gradientHeaderActivity).actionBar.getMeasuredHeight()) - AndroidUtilities.m1036dp(16.0f);
                } else {
                    int iM1036dp = AndroidUtilities.m1036dp(140.0f);
                    GradientHeaderActivity gradientHeaderActivity2 = GradientHeaderActivity.this;
                    int iMax = iM1036dp + gradientHeaderActivity2.statusBarHeight;
                    if (gradientHeaderActivity2.backgroundView.getMeasuredHeight() + AndroidUtilities.m1036dp(24.0f) > iMax) {
                        iMax = Math.max(iMax, (GradientHeaderActivity.this.backgroundView.getMeasuredHeight() + AndroidUtilities.m1036dp(24.0f)) - GradientHeaderActivity.this.minusHeaderHeight);
                    }
    ...
    public View createView(Context context) {
        ...
        Rect rect = new Rect();
        Drawable drawableMutate = ContextCompat.getDrawable(context, C2797R.drawable.sheet_shadow_round).mutate();
        ...
        if (this.useFillLastLayoutManager) {
            this.layoutManager = new FillLastLinearLayoutManager(context, (AndroidUtilities.m1036dp(68.0f) + this.statusBarHeight) - AndroidUtilities.m1036dp(16.0f), this.listView);
        } else {
        ...
        if (z) {
            ...
            float fM1036dp = AndroidUtilities.m1036dp(DebugConfig.getSectionRadiusDp());
            RecyclerListView recyclerListView2 = this.listView;
            Objects.requireNonNull(recyclerListView2);
            recyclerListView.setSections(callbackReturn, iM1036dp, fM1036dp, new RecyclerListView$$ExternalSyntheticLambda1(recyclerListView2), true);
        } else {
        ...
        this.listView.addOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.GradientHeaderActivity.4
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int i) {
                ...
                if (i == 0) {
                    int bottom = ((BaseFragment) GradientHeaderActivity.this).actionBar.getBottom() + AndroidUtilities.m1036dp(16.0f);
    ...
    public class ContentView extends NestedSizeNotifierLayout {
        ...
        @Override // org.telegram.p035ui.Components.NestedSizeNotifierLayout, android.widget.FrameLayout, android.view.View
        public void onMeasure(int i, int i2) {
            GradientHeaderActivity gradientHeaderActivity = GradientHeaderActivity.this;
        ...
        public void dispatchDraw(Canvas canvas) {
            ...
            int bottom2 = ((BaseFragment) GradientHeaderActivity.this).actionBar.getBottom() + AndroidUtilities.m1036dp(16.0f);
            ...
            if (GradientHeaderActivity.this.currentYOffset < AndroidUtilities.m1036dp(30.0f) + bottom2) {
                GradientHeaderActivity.this.progressToFull = ((bottom2 + AndroidUtilities.m1036dp(30.0f)) - GradientHeaderActivity.this.currentYOffset) / AndroidUtilities.m1036dp(30.0f);
            }
            ...
            GradientHeaderActivity.this.particlesView.setTranslationY((backgroundView.getY() + backgroundView.aboveTitleLayout.getY()) - AndroidUtilities.m1036dp(30.0f));
            backgroundView.titleView.setTranslationX((AndroidUtilities.m1036dp(72.0f) - backgroundView.titleView.getLeft()) * (1.0f - CubicBezierInterpolator.EASE_OUT_QUINT.getInterpolation(1.0f - (GradientHeaderActivity.this.totalProgress > 0.3f ? (GradientHeaderActivity.this.totalProgress - 0.3f) / 0.7f : 0.0f))));
            ...
            int iBlendARGB = ColorUtils.blendARGB(themedColor, gradientHeaderActivity7.getThemedColor(gradientHeaderActivity7.whiteBackground ? Theme.key_windowBackgroundWhiteBlackText : Theme.key_premiumGradientBackgroundOverlay), f3);
