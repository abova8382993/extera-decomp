...
public class AwayMessagesActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2797R.string.BusinessAway));
    ...
    */
    private void setValue() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Business.AwayMessagesActivity.setValue():void");
    }
    ...
    public void processDone() {
        ...
        if (!z || this.recipientsHelper.validate(this.listView)) {
            ...
            if (this.enabled) {
                ...
                tL_inputBusinessAwayMessage.shortcut_id = quickReplyFindReply.f1489id;
                ...
                if (userFull != null) {
                    ...
                    tL_businessAwayMessage.shortcut_id = quickReplyFindReply.f1489id;
    ...
    public boolean onBackPressed(boolean z) {
        ...
        if (z) {
            ...
            builder.setMessage(LocaleController.getString(C2797R.string.BusinessAwayUnsavedChanges));
            builder.setPositiveButton(LocaleController.getString(C2797R.string.ApplyTheme), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Business.AwayMessagesActivity$$ExternalSyntheticLambda3
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i) {
                    this.f$0.lambda$onBackPressed$3(alertDialog, i);
                }
            });
            builder.setNegativeButton(LocaleController.getString(C2797R.string.PassportDiscard), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Business.AwayMessagesActivity$$ExternalSyntheticLambda4
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i) {
    ...
    public void fillItems(ArrayList<UItem> arrayList, UniversalAdapter universalAdapter) {
        arrayList.add(UItem.asTopView(LocaleController.getString(C2797R.string.BusinessAway), LocaleController.getString(C2797R.string.BusinessAwayInfo), "RestrictedEmoji", "💤"));
        arrayList.add(UItem.asCheck(1, LocaleController.getString(C2797R.string.BusinessAwaySend)).setChecked(this.enabled));
        ...
        if (this.enabled) {
            ...
            if (quickReplyFindReply != null) {
                ...
                arrayList.add(UItem.asButton(2, C2797R.drawable.msg2_chats_add, LocaleController.getString(C2797R.string.BusinessAwayCreate)).accent());
            }
            arrayList.add(UItem.asShadow(null));
            arrayList.add(UItem.asHeader(LocaleController.getString(C2797R.string.BusinessAwaySchedule)));
            arrayList.add(UItem.asRadio(3, LocaleController.getString(C2797R.string.BusinessAwayScheduleAlways)).setChecked(this.schedule == 0));
            if (this.hasHours) {
                arrayList.add(UItem.asRadio(4, LocaleController.getString(C2797R.string.BusinessAwayScheduleOutsideHours)).setChecked(this.schedule == 1));
            }
            arrayList.add(UItem.asRadio(5, LocaleController.getString(C2797R.string.BusinessAwayScheduleCustom)).setChecked(this.schedule == 2));
            if (this.schedule == 2) {
                arrayList.add(UItem.asShadow(null));
                arrayList.add(UItem.asHeader(LocaleController.getString(C2797R.string.BusinessAwaySchedule)));
                arrayList.add(UItem.asButton(8, LocaleController.getString(C2797R.string.BusinessAwayScheduleCustomStart), LocaleController.formatShortDateTime(this.scheduleCustomStart)));
                arrayList.add(UItem.asButton(9, LocaleController.getString(C2797R.string.BusinessAwayScheduleCustomEnd), LocaleController.formatShortDateTime(this.scheduleCustomEnd)));
            }
            arrayList.add(UItem.asShadow(null));
            arrayList.add(UItem.asCheck(10, LocaleController.getString(C2797R.string.BusinessAwayOnlyOffline)).setChecked(this.offline_only));
            arrayList.add(UItem.asShadow(LocaleController.getString(C2797R.string.BusinessAwayOnlyOfflineInfo)));
            arrayList.add(UItem.asHeader(LocaleController.getString(C2797R.string.BusinessRecipients)));
            arrayList.add(UItem.asRadio(6, LocaleController.getString(C2797R.string.BusinessChatsAllPrivateExcept2)).setChecked(this.exclude));
            arrayList.add(UItem.asRadio(7, LocaleController.getString(C2797R.string.BusinessChatsOnlySelected2)).setChecked(true ^ this.exclude));
            arrayList.add(UItem.asShadow(null));
    ...
    public void onClick(UItem uItem, final View view, int i, float f, float f2) {
        ...
        if (i2 == 5) {
            ...
            if (i2 == 8) {
                AlertsCreator.createDatePickerDialog(getContext(), LocaleController.getString(C2797R.string.BusinessAwayScheduleCustomStartTitle), LocaleController.getString(C2797R.string.BusinessAwayScheduleCustomSetButton), this.scheduleCustomStart, new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.telegram.ui.Business.AwayMessagesActivity$$ExternalSyntheticLambda6
            ...
            if (i2 == 9) {
                AlertsCreator.createDatePickerDialog(getContext(), LocaleController.getString(C2797R.string.BusinessAwayScheduleCustomEndTitle), LocaleController.getString(C2797R.string.BusinessAwayScheduleCustomSetButton), this.scheduleCustomEnd, new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.telegram.ui.Business.AwayMessagesActivity$$ExternalSyntheticLambda7
                    @Override // org.telegram.ui.Components.AlertsCreator.ScheduleDatePickerDelegate
                    public final void didSelectDate(boolean z, int i3, int i4) {
