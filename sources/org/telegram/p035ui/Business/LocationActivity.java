...
public class LocationActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2797R.string.BusinessLocation));
        ...
        this.editText.setPadding(0, 0, AndroidUtilities.m1036dp(42.0f), 0);
        this.editText.setGravity((LocaleController.isRTL ? 5 : 3) | 48);
        this.editText.setInputType(180225);
        this.editText.setHint(LocaleController.getString(C2797R.string.BusinessLocationAddress));
        ...
        this.mapPreview = new BackupImageView(context) { // from class: org.telegram.ui.Business.LocationActivity.5
            ...
            public void onMeasure(int i4, int i5) {
                super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i4), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(240.0f), TLObject.FLAG_30));
            }
    ...
    public boolean onBackPressed(boolean z) {
        ...
        if (z) {
            ...
            builder.setMessage(LocaleController.getString(C2797R.string.BusinessLocationUnsavedChanges));
            builder.setPositiveButton(LocaleController.getString(C2797R.string.ApplyTheme), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Business.LocationActivity$$ExternalSyntheticLambda2
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i) {
                    this.f$0.lambda$onBackPressed$2(alertDialog, i);
                }
            });
            builder.setNegativeButton(LocaleController.getString(C2797R.string.PassportDiscard), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Business.LocationActivity$$ExternalSyntheticLambda3
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i) {
    ...
    public void fillItems(ArrayList<UItem> arrayList, UniversalAdapter universalAdapter) {
        arrayList.add(UItem.asTopView(LocaleController.getString(C2797R.string.BusinessLocation), LocaleController.getString(C2797R.string.BusinessLocationInfo), C2797R.raw.biz_map));
        arrayList.add(UItem.asCustom(this.editTextContainer));
        arrayList.add(UItem.asShadow(null));
        boolean z = false;
        arrayList.add(UItem.asCheck(1, LocaleController.getString(C2797R.string.BusinessLocationMap)).setChecked(this.geo != null));
        if (this.geo != null) {
        ...
        this.clearVisible = z;
        if (z) {
            arrayList.add(UItem.asButton(2, LocaleController.getString(C2797R.string.BusinessLocationClear)).red());
            arrayList.add(UItem.asShadow(null));
        }
        checkDone(true);
    }
    ...
    public void onClick(UItem uItem, View view, int i, float f, float f2) {
        ...
        if (i2 == 2) {
            AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
            builder.setTitle(LocaleController.getString(C2797R.string.BusinessLocationClearTitle));
            builder.setMessage(LocaleController.getString(C2797R.string.BusinessLocationClearMessage));
            builder.setPositiveButton(LocaleController.getString(C2797R.string.Remove), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Business.LocationActivity$$ExternalSyntheticLambda5
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
    ...
    private void showLocationAlert() {
        final org.telegram.p035ui.LocationActivity locationActivity = new org.telegram.p035ui.LocationActivity(8);
        if (this.geo != null) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showLocationAlert$7(org.telegram.p035ui.LocationActivity locationActivity, TLRPC.MessageMedia messageMedia, int i, boolean z, int i2, long j) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showLocationAlert$9(final org.telegram.p035ui.LocationActivity locationActivity, final AlertDialog alertDialog) {
        try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showLocationAlert$8(AlertDialog alertDialog, org.telegram.p035ui.LocationActivity locationActivity) {
        alertDialog.dismiss();
        presentFragment(locationActivity);
    }
