...
public class ProfileHoursCell extends LinearLayout {
            ...
            if (i == 0) {
                FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.Business.ProfileHoursCell.1
                    ...
                    public void onMeasure(int i3, int i4) {
                        super.onMeasure(i3, View.MeasureSpec.makeMeasureSpec(Math.max(View.MeasureSpec.getSize(i4), AndroidUtilities.m1036dp(60.0f)), View.MeasureSpec.getMode(i4)));
                    }
                };
                frameLayout.setMinimumHeight(AndroidUtilities.m1036dp(60.0f));
                ...
                this.switchText.setTextSize(AndroidUtilities.m1036dp(13.0f));
                this.switchText.setPadding(AndroidUtilities.m1036dp(6.0f), 0, AndroidUtilities.m1036dp(6.0f), 0);
                ...
                clickableAnimatedTextView2.setBackground(Theme.createSimpleSelectorRoundRectDrawable(iM1036dp, Theme.multAlpha(processColor(Theme.getColor(i5, resourcesProvider)), 0.1f), Theme.multAlpha(processColor(Theme.getColor(i5, resourcesProvider)), 0.22f)));
    ...
    public void updateColors() {
        ...
        clickableAnimatedTextView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(iM1036dp, Theme.multAlpha(processColor(Theme.getColor(i, this.resourcesProvider)), 0.1f), Theme.multAlpha(processColor(Theme.getColor(i, this.resourcesProvider)), 0.22f)));
    ...
    */
    public void set(org.telegram.tgnet.tl.TL_account.TL_businessWorkHours r24, boolean r25, boolean r26, boolean r27) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Business.ProfileHoursCell.set(org.telegram.tgnet.tl.TL_account$TL_businessWorkHours, boolean, boolean, boolean):void");
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.needDivider) {
            ...
            canvas.drawRect(AndroidUtilities.m1036dp(LocaleController.isRTL ? 0.0f : 21.33f), getMeasuredHeight() - 1, getWidth() - AndroidUtilities.m1036dp(LocaleController.isRTL ? 21.33f : 0.0f), getMeasuredHeight(), themePaint);
        }
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (!this.expanded) {
            int iM1036dp2 = AndroidUtilities.m1036dp(60.0f);
            if (this.todayLinesCount > 2 || this.switchText.getVisibility() == 0) {
                iM1036dp = this.todayLinesHeight + AndroidUtilities.m1036dp(15.0f) + AndroidUtilities.m1036dp(this.switchText.getVisibility() == 0 ? 21.0f : 0.0f);
            } else {
                iM1036dp = 0;
            }
            i2 = View.MeasureSpec.makeMeasureSpec(Math.max(iM1036dp2, iM1036dp) + (this.needDivider ? 1 : 0), TLObject.FLAG_30);
        }
    ...
    public static final class Factory extends UItem.UItemFactory<ProfileHoursCell> {
        ...
        public void bindView(View view, UItem uItem, boolean z, UniversalAdapter universalAdapter, UniversalRecyclerView universalRecyclerView) {
            ...
            profileHoursCell.setId(uItem.f1708id);
