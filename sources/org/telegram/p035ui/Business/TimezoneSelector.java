...
public class TimezoneSelector extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2797R.string.TimezoneTitle));
        ...
        ActionBarMenuItem actionBarMenuItemSearchListener = this.actionBar.createMenu().addItem(1, C2797R.drawable.outline_header_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() { // from class: org.telegram.ui.Business.TimezoneSelector.2
            public C31932() {
            }
        ...
        this.emptyView.setMinimumHeight(AndroidUtilities.m1036dp(500.0f));
        ...
        textView.setText(LocaleController.getString(C2797R.string.TimezoneNotFound));
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Business.TimezoneSelector$1 */
    public class C31921 extends ActionBar.ActionBarMenuOnItemClick {
        public C31921() {
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Business.TimezoneSelector$2 */
    public class C31932 extends ActionBarMenuItem.ActionBarMenuItemSearchListener {
        public C31932() {
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Business.TimezoneSelector$3 */
    public class C31943 extends RecyclerView.OnScrollListener {
        public C31943() {
        }
    ...
    */
    public void fillItems(java.util.ArrayList<org.telegram.p035ui.Components.UItem> r13, org.telegram.p035ui.Components.UniversalAdapter r14) {
        /*
            Method dump skipped, instruction units count: 250
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Business.TimezoneSelector.fillItems(java.util.ArrayList, org.telegram.ui.Components.UniversalAdapter):void");
    }
    ...
    public void onClick(UItem uItem, View view, int i, float f, float f2) {
        ...
        if (view.isEnabled()) {
            ...
            TLRPC.TL_timezone tL_timezone = timezonesController.getTimezones().get(uItem.f1708id);
            this.useSystem = false;
            String str2 = tL_timezone.f1396id;
