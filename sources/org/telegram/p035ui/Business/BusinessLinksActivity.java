...
import org.telegram.p035ui.Components.URLSpanCopyToClipboard;
...
public class BusinessLinksActivity extends UniversalFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void openRenameAlert(Context context, final int i, final TL_account.TL_businessChatLink tL_businessChatLink, Theme.ResourcesProvider resourcesProvider, boolean z) {
        ...
        builder.setTitle(LocaleController.getString(C2797R.string.BusinessLinksRenameTitle));
        final C31661 c31661 = new EditTextBoldCursor(context) { // from class: org.telegram.ui.Business.BusinessLinksActivity.1
            ...
            public C31661(Context context2, Theme.ResourcesProvider resourcesProvider2) {
                super(context2);
        ...
        c31661.setInputType(49153);
        c31661.setTextSize(1, 18.0f);
        c31661.setText(tL_businessChatLink.title);
        int i2 = Theme.key_dialogTextBlack;
        c31661.setTextColor(Theme.getColor(i2, resourcesProvider2));
        c31661.setHintColor(Theme.getColor(Theme.key_groupcreate_hintText, resourcesProvider2));
        c31661.setCursorColor(Theme.getColor(Theme.key_chat_messagePanelCursor));
        c31661.setHintText(LocaleController.getString(C2797R.string.BusinessLinksNamePlaceholder));
        c31661.setSingleLine(true);
        c31661.setFocusable(true);
        c31661.setLineColors(Theme.getColor(Theme.key_windowBackgroundWhiteInputField, resourcesProvider2), Theme.getColor(Theme.key_windowBackgroundWhiteInputFieldActivated, resourcesProvider2), Theme.getColor(Theme.key_text_RedRegular, resourcesProvider2));
        c31661.setImeOptions(6);
        c31661.setBackgroundDrawable(null);
        c31661.setPadding(0, 0, AndroidUtilities.m1036dp(42.0f), 0);
        LinearLayout linearLayout = new LinearLayout(context2);
        linearLayout.setOrientation(1);
        TextView textView = new TextView(context2);
        textView.setTextColor(Theme.getColor(i2, resourcesProvider2));
        textView.setTextSize(1, 16.0f);
        textView.setText(LocaleController.getString(C2797R.string.BusinessLinksRenameMessage));
        linearLayout.addView(textView, LayoutHelper.createLinear(-1, -2, 24.0f, 5.0f, 24.0f, 12.0f));
        linearLayout.addView(c31661, LayoutHelper.createLinear(-1, -2, 24.0f, 0.0f, 24.0f, 10.0f));
        builder.setView(linearLayout);
        builder.setWidth(AndroidUtilities.m1036dp(292.0f));
        c31661.setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: org.telegram.ui.Business.BusinessLinksActivity$$ExternalSyntheticLambda4
            @Override // android.widget.TextView.OnEditorActionListener
            public final boolean onEditorAction(TextView textView2, int i3, KeyEvent keyEvent) {
                return BusinessLinksActivity.$r8$lambda$DtBQAB1IVKEeN5sJZ6_I4zgsmCc(c31661, i, tL_businessChatLink, alertDialogArr, view, textView2, i3, keyEvent);
            }
        });
        builder.setPositiveButton(LocaleController.getString(C2797R.string.Done), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Business.BusinessLinksActivity$$ExternalSyntheticLambda5
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i3) {
                BusinessLinksActivity.$r8$lambda$cxMI8a8s6tOBqxsSlMOAHU39TGw(c31661, i, tL_businessChatLink, alertDialog, i3);
            }
        });
        builder.setNegativeButton(LocaleController.getString(C2797R.string.Cancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Business.BusinessLinksActivity$$ExternalSyntheticLambda6
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i3) {
                alertDialog.dismiss();
            }
        ...
        if (z2) {
            ...
            currentDialog.setOnShowListener(new DialogInterface.OnShowListener() { // from class: org.telegram.ui.Business.BusinessLinksActivity$$ExternalSyntheticLambda8
                ...
                public final void onShow(DialogInterface dialogInterface) {
                    BusinessLinksActivity.$r8$lambda$uViQvlykjsAe5Vxc8gEsQJWvtWI(c31661, dialogInterface);
                }
            });
            ...
            builder.overrideDismissListener(new Utilities.Callback() { // from class: org.telegram.ui.Business.BusinessLinksActivity$$ExternalSyntheticLambda9
                ...
                public final void run(Object obj) {
                    BusinessLinksActivity.$r8$lambda$JbvWftK4TSlZUFN3lwTgZOzHk8g(view, c31661, (Runnable) obj);
                }
            });
            ...
            alertDialogCreate2.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.Business.BusinessLinksActivity$$ExternalSyntheticLambda10
                @Override // android.content.DialogInterface.OnDismissListener
                public final void onDismiss(DialogInterface dialogInterface) {
                    AndroidUtilities.hideKeyboard(c31661);
                }
            });
            alertDialogArr[0].setOnShowListener(new DialogInterface.OnShowListener() { // from class: org.telegram.ui.Business.BusinessLinksActivity$$ExternalSyntheticLambda11
                @Override // android.content.DialogInterface.OnShowListener
                public final void onShow(DialogInterface dialogInterface) {
                    BusinessLinksActivity.$r8$lambda$UcDw_lm1x7o2YELRhLAwjiy5CUg(view, c31661, dialogInterface);
                }
            });
            alertDialogArr[0].show();
        }
        alertDialogArr[0].setDismissDialogByButtons(false);
        c31661.setSelection(c31661.getText().length());
    }

    /* JADX INFO: renamed from: org.telegram.ui.Business.BusinessLinksActivity$1 */
    public class C31661 extends EditTextBoldCursor {
        AnimatedTextView.AnimatedTextDrawable limit;
        AnimatedColor limitColor = new AnimatedColor(this);
        private int limitCount;
        final /* synthetic */ Theme.ResourcesProvider val$resourcesProvider;
    ...
    public CharSequence getTitle() {
        return LocaleController.getString(C2797R.string.BusinessLinks);
    }
    ...
    */
    private static int getPrivacyType(java.util.ArrayList<org.telegram.tgnet.TLRPC.PrivacyRule> r9) {
        /*
            r0 = -1
            r1 = 0
            r3 = r0
        ...
        L4a:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Business.BusinessLinksActivity.getPrivacyType(java.util.ArrayList):int");
    }

    @Override // org.telegram.p035ui.Components.UniversalFragment
    public void fillItems(ArrayList<UItem> arrayList, UniversalAdapter universalAdapter) {
        String string;
        arrayList.add(UItem.asTopView(LocaleController.getString(C2797R.string.BusinessLinks), LocaleController.getString(C2797R.string.BusinessLinksInfo), C2797R.raw.biz_links));
        universalAdapter.whiteSectionStart();
        if (BusinessLinksController.getInstance(this.currentAccount).canAddNew()) {
            arrayList.add(UItem.asButton(1, C2797R.drawable.menu_link_create, LocaleController.getString(C2797R.string.BusinessLinksAdd)).accent());
        }
        ArrayList<TL_account.TL_businessChatLink> arrayList2 = BusinessLinksController.getInstance(this.currentAccount).links;
        int size = arrayList2.size();
        int i = 0;
        int i2 = 0;
        while (i2 < size) {
            TL_account.TL_businessChatLink tL_businessChatLink = arrayList2.get(i2);
            i2++;
            arrayList.add(UItem.asBusinessChatLink(new BusinessLinkWrapper(tL_businessChatLink)));
        }
        ...
        if (publicUsername != null) {
            arrayList3.add(str.concat(publicUsername));
        }
        ...
        if (arrayList3.size() == 2) {
            string = LocaleController.formatString(C2797R.string.BusinessLinksFooterTwoLinks, arrayList3.get(0), arrayList3.get(1));
        } else {
            string = LocaleController.formatString(C2797R.string.BusinessLinksFooterOneLink, arrayList3.get(0));
        }
    ...
    public boolean onLongClick(UItem uItem, View view, int i, float f, float f2) {
        ...
        itemOptionsMakeOptions.add(C2797R.drawable.msg_copy, LocaleController.getString(C2797R.string.Copy), new Runnable() { // from class: org.telegram.ui.Business.BusinessLinksActivity$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                BusinessLinksActivity.$r8$lambda$22WngckNHnN_AZ8f8CZXwLcfKho(tL_businessChatLink);
            }
        });
        itemOptionsMakeOptions.add(C2797R.drawable.msg_share, LocaleController.getString(C2797R.string.LinkActionShare), new Runnable() { // from class: org.telegram.ui.Business.BusinessLinksActivity$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$onLongClick$9(tL_businessChatLink);
            }
        });
        itemOptionsMakeOptions.add(C2797R.drawable.msg_edit, LocaleController.getString(C2797R.string.Rename), new Runnable() { // from class: org.telegram.ui.Business.BusinessLinksActivity$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$onLongClick$10(tL_businessChatLink);
            }
        });
        itemOptionsMakeOptions.add(C2797R.drawable.msg_delete, (CharSequence) LocaleController.getString(C2797R.string.Delete), true, new Runnable() { // from class: org.telegram.ui.Business.BusinessLinksActivity$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public static /* synthetic */ void $r8$lambda$22WngckNHnN_AZ8f8CZXwLcfKho(TL_account.TL_businessChatLink tL_businessChatLink) {
        ...
        BulletinFactory.m1143of(LaunchActivity.getLastFragment()).createCopyLinkBulletin().show();
    }
    ...
    public /* synthetic */ void lambda$onLongClick$12(final TL_account.TL_businessChatLink tL_businessChatLink) {
        AlertDialog alertDialogCreate = new AlertDialog.Builder(getContext(), getResourceProvider()).setTitle(LocaleController.getString(C2797R.string.BusinessLinksDeleteTitle)).setMessage(LocaleController.getString(C2797R.string.BusinessLinksDeleteMessage)).setPositiveButton(LocaleController.getString(C2797R.string.Remove), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Business.BusinessLinksActivity$$ExternalSyntheticLambda12
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
    ...
    public static class BusinessLinkView extends FrameLayout {
        ...
        public BusinessLinkView(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            imageView.setPadding(AndroidUtilities.m1036dp(9.0f), AndroidUtilities.m1036dp(9.0f), AndroidUtilities.m1036dp(9.0f), AndroidUtilities.m1036dp(9.0f));
            imageView.setColorFilter(new PorterDuffColorFilter(-1, PorterDuff.Mode.SRC_IN));
            imageView.setBackground(Theme.createCircleDrawable(AndroidUtilities.m1036dp(36.0f), Theme.getColor(Theme.key_featuredStickers_addButton)));
        ...
        public void set(BusinessLinkWrapper businessLinkWrapper, boolean z) {
            ...
            boolean zIsEmpty = TextUtils.isEmpty(tL_businessChatLink.title);
            SimpleTextView simpleTextView = this.titleTextView;
            if (!zIsEmpty) {
                simpleTextView.setText(this.businessLink.title);
            } else {
                simpleTextView.setText(BusinessLinksController.stripHttps(this.businessLink.link));
            }
            ...
            SimpleTextView simpleTextView2 = this.clicksCountTextView;
            if (i == 0) {
                simpleTextView2.setText(LocaleController.formatString(C2797R.string.NoClicks, new Object[0]));
            } else {
                simpleTextView2.setText(LocaleController.formatPluralString("Clicks", i, new Object[0]));
            }
        ...
        public void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(56.0f) + (this.needDivider ? 1 : 0), TLObject.FLAG_30));
        }
        ...
        public void onLayout(boolean z, int i, int i2, int i3, int i4) {
            ...
            SimpleTextView simpleTextView = this.titleTextView;
            if (z2) {
                simpleTextView.setPadding(this.clicksCountTextView.getTextWidth(), 0, 0, 0);
            } else {
                simpleTextView.setPadding(0, 0, this.clicksCountTextView.getTextWidth(), 0);
            }
        }
    }
}
