...
public class GroupCallTabletGridAdapter extends RecyclerListView.SelectionAdapter {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.GroupCallTabletGridAdapter$1 */
    public class C58321 extends GroupCallGridCell {
        public C58321(Context context, boolean z) {
            super(context, z);
        }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        TLRPC.GroupCallParticipant groupCallParticipant = this.videoParticipants.get(i).participant;
    ...
    public void update(boolean z, RecyclerListView recyclerListView) {
        ...
        if (z) {
            ...
            DiffUtil.calculateDiff(new DiffUtil.Callback() { // from class: org.telegram.ui.GroupCallTabletGridAdapter.2
                ...
                public C58332(ArrayList arrayList2) {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.GroupCallTabletGridAdapter$2 */
    public class C58332 extends DiffUtil.Callback {
        final /* synthetic */ ArrayList val$oldVideoParticipants;
