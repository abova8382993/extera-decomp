...
public class LinkEditActivity extends BaseFragment {
    ...
    */
    public android.view.View createView(final android.content.Context r29) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.LinkEditActivity.createView(android.content.Context):android.view.View");
    }

    /* JADX INFO: renamed from: org.telegram.ui.LinkEditActivity$1 */
    public class C59101 extends ActionBar.ActionBarMenuOnItemClick {
        public C59101() {
        }
    ...
    public class C59122 extends Drawable {

        /* JADX INFO: renamed from: p */
        final Paint f1735p = new Paint(1);
        ...
        public void draw(Canvas canvas) {
            this.f1735p.setColor(Theme.getColor(Theme.key_telegram_color));
            canvas.drawRoundRect(getBounds().left, getBounds().exactCenterY() - AndroidUtilities.m1036dp(14.0f), getBounds().right, AndroidUtilities.m1036dp(14.0f) + getBounds().exactCenterY(), AndroidUtilities.m1036dp(14.0f), AndroidUtilities.m1036dp(14.0f), this.f1735p);
        }
    }

    /* JADX INFO: renamed from: org.telegram.ui.LinkEditActivity$3 */
    public class C59133 extends SectionsScrollView.SectionsLinearLayout {
        public C59133(Context context) {
            super(context);
        }
    ...
    public class C59144 extends SizeNotifierFrameLayout {
        public C59144(Context context) {
            super(context);
        }
        ...
        public void onMeasure(int i, int i2) {
            ...
            if (i3 != 0 && i3 < AndroidUtilities.m1036dp(20.0f)) {
                LinkEditActivity.this.usesEditText.clearFocus();
                LinkEditActivity.this.nameEditText.clearFocus();
            }
            LinkEditActivity.this.buttonLayout.setVisibility(this.keyboardHeight > AndroidUtilities.m1036dp(20.0f) ? 8 : 0);
        }
    ...
    public /* synthetic */ void lambda$createView$1(Context context, View view) {
        AlertsCreator.createDatePickerDialog(context, LocaleController.getString(C2797R.string.ExpireAfter), LocaleController.getString(C2797R.string.SetTimeLimit), -1L, new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.telegram.ui.LinkEditActivity$$ExternalSyntheticLambda12
    ...
    public /* synthetic */ void lambda$createView$3(int i) {
        ...
        if (i < size) {
            editText.setText(this.dispalyedUses.get(i).toString());
        } else {
    ...
    public class C59155 extends EditText {
        public C59155(Context context) {
            super(context);
        }
    ...
    public class C59166 implements TextWatcher {
    ...
    public class C59177 extends TextCheckCell {
        public C59177(Context context) {
            super(context);
        }

        @Override // org.telegram.p035ui.Cells.TextCheckCell, android.view.View
    ...
    public /* synthetic */ void lambda$createView$4(boolean z, View view) {
        ...
        if (this.subCell != null) {
            if (textCheckCell3.isChecked()) {
                ...
                this.subCell.setCheckBoxIcon(C2797R.drawable.permission_locked);
    ...
    public /* synthetic */ void lambda$createView$7(Runnable[] runnableArr, View view) {
        ...
        if (zIsChecked) {
            ...
            this.approveCell.setCheckBoxIcon(C2797R.drawable.permission_locked);
            this.approveHintCell.setText(LocaleController.getString(C2797R.string.ApproveNewMembersDescriptionFrozen));
        ...
        this.approveHintCell.setText(LocaleController.getString(C2797R.string.ApproveNewMembersDescription2));
    ...
    public class C59188 extends EditTextCell {
        private boolean ignoreTextChanged;

        public C59188(Context context, String str, boolean z, boolean z2, int i, Theme.ResourcesProvider resourcesProvider) {
    ...
    public /* synthetic */ void lambda$createView$8() {
        Browser.openUrl(getContext(), LocaleController.getString(C2797R.string.RequireMonthlyFeeInfoLink));
    }

    /* JADX INFO: renamed from: org.telegram.ui.LinkEditActivity$9 */
    public class C59199 extends EditText {
        public C59199(Context context) {
            super(context);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.LinkEditActivity$10 */
    public class C591110 implements TextWatcher {
        @Override // android.text.TextWatcher
        public void beforeTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        }
    ...
    public /* synthetic */ void lambda$createView$10(View view) {
        ...
        builder.setPositiveButton(LocaleController.getString(C2797R.string.RevokeButton), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.LinkEditActivity$$ExternalSyntheticLambda13
    ...
    public void onCreateClicked(View view) {
        ...
        if (i == 1) {
            ...
            int i2 = this.currentInviteDate;
            if (selectedIndex4 < size) {
                if (i2 != this.dispalyedDates.get(selectedIndex4).intValue()) {
    ...
    public void chooseUses(int i) {
        ...
        for (int i5 = 0; i5 < i4; i5++) {
            if (i5 == size) {
                strArr[i5] = LocaleController.getString(C2797R.string.NoLimit);
            } else {
    ...
    private void chooseDate(int i) {
        ...
        for (int i4 = 0; i4 < i3; i4++) {
            if (i4 == size) {
                strArr[i4] = LocaleController.getString(C2797R.string.NoLimit);
                ...
                long j2 = currentTime;
                if (j2 < 86400) {
                    strArr[i4] = LocaleController.getString(C2797R.string.MessageScheduleToday);
                } else if (j2 < 31449600) {
    ...
    private void resetDates() {
        ...
        while (true) {
            ...
            if (i < iArr.length) {
                ...
                this.timeChooseView.setOptions(3, LocaleController.formatPluralString("Hours", 1, new Object[0]), LocaleController.formatPluralString("Days", 1, new Object[0]), LocaleController.formatPluralString("Weeks", 1, new Object[0]), LocaleController.getString(C2797R.string.NoLimit));
                return;
            }
        }
    }
    ...
    public void resetUses() {
        ...
        while (true) {
            ...
            if (i < iArr.length) {
                ...
                this.usesChooseView.setOptions(3, "1", "10", "100", LocaleController.getString(C2797R.string.NoLimit));
                return;
            }
        }
    }
    ...
    public void setInviteToEdit(TLRPC.TL_chatInviteExported tL_chatInviteExported) {
        ...
        if (tL_chatInviteExported.subscription_pricing != null) {
            ...
            if (textInfoPrivacyCell != null) {
                textInfoPrivacyCell.setText(LocaleController.getString(C2797R.string.ApproveNewMembersDescriptionFrozen));
            }
        }
