...
import org.telegram.p035ui.Cells.MaxFileSizeCell;
...
public class DataAutoDownloadActivity extends BaseFragment {
    ...
    public DataAutoDownloadActivity(int i) {
        ...
        if (i2 == 1) {
            this.currentPresetNum = DownloadController.getInstance(i3).currentWifiPreset;
        ...
        this.currentPresetNum = DownloadController.getInstance(i3).currentRoamingPreset;
    ...
    public View createView(Context context) {
        ...
        if (i == 0) {
            this.actionBar.setTitle(LocaleController.getString(C2797R.string.AutoDownloadOnMobileData));
        } else if (i == 1) {
            this.actionBar.setTitle(LocaleController.getString(C2797R.string.AutoDownloadOnWiFiData));
        } else if (i == 2) {
            this.actionBar.setTitle(LocaleController.getString(C2797R.string.AutoDownloadOnRoamingData));
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.DataAutoDownloadActivity$1 */
    public class C54851 extends ActionBar.ActionBarMenuOnItemClick {
        public C54851() {
        }
    ...
    */
    public /* synthetic */ void lambda$createView$4(final android.view.View r26, int r27, float r28, float r29) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.DataAutoDownloadActivity.lambda$createView$4(android.view.View, int, float, float):void");
    }
    ...
    public /* synthetic */ void lambda$createView$0(TextCheckBoxCell textCheckBoxCell, TextCheckBoxCell[] textCheckBoxCellArr, int i, MaxFileSizeCell[] maxFileSizeCellArr, TextCheckCell[] textCheckCellArr, AnimatorSet[] animatorSetArr, View view) {
        if (view.isEnabled()) {
            ...
            animatorSetArr[0].addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DataAutoDownloadActivity.2
                ...
                public C54862(AnimatorSet[] animatorSetArr2) {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.DataAutoDownloadActivity$2 */
    public class C54862 extends AnimatorListenerAdapter {
        final /* synthetic */ AnimatorSet[] val$animatorSet;
    ...
    /* JADX INFO: renamed from: org.telegram.ui.DataAutoDownloadActivity$3 */
    public class C54873 extends MaxFileSizeCell {
        final /* synthetic */ AnimatorSet[] val$animatorSet;
        ...
        public C54873(Context context, int i, TextInfoPrivacyCell textInfoPrivacyCell, TextCheckCell[] textCheckCellArr, AnimatorSet[] animatorSetArr) {
            super(context);
            i = i;
        ...
        @Override // org.telegram.p035ui.Cells.MaxFileSizeCell
        public void didChangedSizeValue(int i) {
            if (i == DataAutoDownloadActivity.this.videosRow) {
                textInfoPrivacyCell.setText(LocaleController.formatString("AutoDownloadPreloadVideoInfo", C2797R.string.AutoDownloadPreloadVideoInfo, AndroidUtilities.formatFileSize(i)));
                boolean z = i > 2097152;
                if (z != textCheckCellArr[0].isEnabled()) {
                    ArrayList<Animator> arrayList = new ArrayList<>();
                    textCheckCellArr[0].setEnabled(z, arrayList);
                    AnimatorSet animatorSet = animatorSetArr[0];
                    if (animatorSet != null) {
        ...
        /* JADX INFO: renamed from: org.telegram.ui.DataAutoDownloadActivity$3$1 */
    ...
    public /* synthetic */ void lambda$createView$3(TextCheckBoxCell[] textCheckBoxCellArr, int i, MaxFileSizeCell[] maxFileSizeCellArr, int i2, TextCheckCell[] textCheckCellArr, int i3, String str, String str2, BottomSheet.Builder builder, View view, View view2) {
        ...
        for (int i5 = 0; i5 < 4; i5++) {
            boolean zIsChecked = textCheckBoxCellArr[i5].isChecked();
        ...
        if (textCheckCell != null) {
            ...
            if (i3 == i6) {
                preset2.preloadVideo = textCheckCell.isChecked();
            } else {
                preset2.preloadMusic = textCheckCell.isChecked();
            }
        }
        ...
        if (i7 == 0) {
            ...
            if (i7 == 1) {
                DownloadController.getInstance(i8).currentWifiPreset = this.currentPresetNum;
            } else {
                DownloadController.getInstance(i8).currentRoamingPreset = this.currentPresetNum;
            }
        }
        editorEdit.apply();
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (i == DataAutoDownloadActivity.this.autoDownloadRow) {
                    ...
                    textCheckCell.setTextAndCheck(LocaleController.getString(C2797R.string.AutoDownloadMedia), DataAutoDownloadActivity.this.typePreset.enabled, false);
            ...
            if (itemViewType == 2) {
                ...
                if (i == DataAutoDownloadActivity.this.usageHeaderRow) {
                    headerCell.setText(LocaleController.getString(C2797R.string.AutoDownloadDataUsage));
                    return;
                } else {
                    if (i == DataAutoDownloadActivity.this.typeHeaderRow) {
                        headerCell.setText(LocaleController.getString(C2797R.string.AutoDownloadTypes));
                        return;
                    }
                    return;
                }
            ...
            if (itemViewType != 4) {
                ...
                if (i == DataAutoDownloadActivity.this.typeSectionRow) {
                    textInfoPrivacyCell.setText(LocaleController.getString(C2797R.string.AutoDownloadAudioInfo));
                    ...
                    if (i == DataAutoDownloadActivity.this.autoDownloadSectionRow) {
                        if (DataAutoDownloadActivity.this.usageHeaderRow == -1) {
                            if (DataAutoDownloadActivity.this.currentType == 0) {
                                textInfoPrivacyCell.setText(LocaleController.getString(C2797R.string.AutoDownloadOnMobileDataInfo));
                            } else if (DataAutoDownloadActivity.this.currentType == 1) {
                                textInfoPrivacyCell.setText(LocaleController.getString(C2797R.string.AutoDownloadOnWiFiDataInfo));
                            } else if (DataAutoDownloadActivity.this.currentType == 2) {
                                textInfoPrivacyCell.setText(LocaleController.getString(C2797R.string.AutoDownloadOnRoamingDataInfo));
                            }
                            textInfoPrivacyCell.setImportantForAccessibility(1);
                            return;
                        }
            ...
            if (i == DataAutoDownloadActivity.this.photosRow) {
                string2 = LocaleController.getString(C2797R.string.AutoDownloadPhotos);
                i3 = 1;
            } else if (i == DataAutoDownloadActivity.this.videosRow) {
                string2 = LocaleController.getString(C2797R.string.AutoDownloadVideos);
                i3 = 4;
            } else {
                if (i == DataAutoDownloadActivity.this.storiesRow) {
                    string = LocaleController.getString(C2797R.string.AutoDownloadStories);
                    notificationsCheckCell.setDrawLine(false);
                } else {
                    string = LocaleController.getString(C2797R.string.AutoDownloadFiles);
                    i3 = 8;
                }
                string2 = string;
            }
            int i4 = DataAutoDownloadActivity.this.currentType;
            ...
            if (i4 == 0) {
                ...
                DataAutoDownloadActivity dataAutoDownloadActivity2 = DataAutoDownloadActivity.this;
                currentWiFiPreset = i5 == 1 ? DownloadController.getInstance(((BaseFragment) dataAutoDownloadActivity2).currentAccount).getCurrentWiFiPreset() : DownloadController.getInstance(((BaseFragment) dataAutoDownloadActivity2).currentAccount).getCurrentRoamingPreset();
            }
            ...
            if (i != DataAutoDownloadActivity.this.storiesRow) {
                ...
                while (true) {
                    ...
                    if ((iArr[i6] & i3) != 0) {
                        ...
                        if (i6 == 0) {
                            sb3.append(LocaleController.getString(C2797R.string.AutoDownloadContacts));
                        } else if (i6 == 1) {
                            sb3.append(LocaleController.getString(C2797R.string.AutoDownloadPm));
                        } else if (i6 == 2) {
                            sb3.append(LocaleController.getString(C2797R.string.AutoDownloadGroups));
                        } else if (i6 == 3) {
                            sb3.append(LocaleController.getString(C2797R.string.AutoDownloadChannels));
                        }
                        i2++;
                    }
                    i6++;
                ...
                if (i2 == 4) {
                    sb3.setLength(0);
                    if (i == DataAutoDownloadActivity.this.photosRow) {
                        sb3.append(LocaleController.getString(C2797R.string.AutoDownloadOnAllChats));
                    } else {
                        sb3.append(LocaleController.formatString("AutoDownloadUpToOnAllChats", C2797R.string.AutoDownloadUpToOnAllChats, AndroidUtilities.formatFileSize(j)));
                    }
                } else if (i2 == 0) {
                    sb3.append(LocaleController.getString(C2797R.string.AutoDownloadOff));
                } else {
                    if (i == DataAutoDownloadActivity.this.photosRow) {
                        sb = new StringBuilder(LocaleController.formatString("AutoDownloadOnFor", C2797R.string.AutoDownloadOnFor, sb3.toString()));
                    } else {
                        sb = new StringBuilder(LocaleController.formatString("AutoDownloadOnUpToFor", C2797R.string.AutoDownloadOnUpToFor, AndroidUtilities.formatFileSize(j), sb3.toString()));
                    }
                    sb2 = sb;
                }
                sb2 = sb3;
            } else if (currentWiFiPreset.preloadStories) {
                sb2 = new StringBuilder(LocaleController.formatString("AutoDownloadOn", C2797R.string.AutoDownloadOn, sb3.toString()));
                i2 = 1;
            } else {
                sb2 = new StringBuilder(LocaleController.formatString("AutoDownloadOff", C2797R.string.AutoDownloadOff, sb3.toString()));
                i2 = 0;
            }
        ...
        public /* synthetic */ void lambda$onCreateViewHolder$0(int i) {
            ...
            DownloadController.Preset preset2 = DataAutoDownloadActivity.this.lowPreset;
            DataAutoDownloadActivity dataAutoDownloadActivity = DataAutoDownloadActivity.this;
            int i2 = 0;
            if (preset == preset2) {
                dataAutoDownloadActivity.currentPresetNum = 0;
            } else {
                DownloadController.Preset preset3 = dataAutoDownloadActivity.mediumPreset;
                DataAutoDownloadActivity dataAutoDownloadActivity2 = DataAutoDownloadActivity.this;
                if (preset == preset3) {
                    dataAutoDownloadActivity2.currentPresetNum = 1;
                } else {
                    DownloadController.Preset preset4 = dataAutoDownloadActivity2.highPreset;
                    DataAutoDownloadActivity dataAutoDownloadActivity3 = DataAutoDownloadActivity.this;
                    if (preset == preset4) {
                        dataAutoDownloadActivity3.currentPresetNum = 2;
                    } else {
                        dataAutoDownloadActivity3.currentPresetNum = 3;
                    }
                }
            }
            int i3 = DataAutoDownloadActivity.this.currentType;
            DataAutoDownloadActivity dataAutoDownloadActivity4 = DataAutoDownloadActivity.this;
            if (i3 == 0) {
                DownloadController.getInstance(((BaseFragment) dataAutoDownloadActivity4).currentAccount).currentMobilePreset = DataAutoDownloadActivity.this.currentPresetNum;
            } else {
                int i4 = dataAutoDownloadActivity4.currentType;
                DataAutoDownloadActivity dataAutoDownloadActivity5 = DataAutoDownloadActivity.this;
                if (i4 == 1) {
                    DownloadController.getInstance(((BaseFragment) dataAutoDownloadActivity5).currentAccount).currentWifiPreset = DataAutoDownloadActivity.this.currentPresetNum;
                } else {
                    DownloadController.getInstance(((BaseFragment) dataAutoDownloadActivity5).currentAccount).currentRoamingPreset = DataAutoDownloadActivity.this.currentPresetNum;
                }
            }
            ...
            while (true) {
                DataAutoDownloadActivity dataAutoDownloadActivity6 = DataAutoDownloadActivity.this;
                if (i2 < 4) {
                    RecyclerView.ViewHolder viewHolderFindViewHolderForAdapterPosition = dataAutoDownloadActivity6.listView.findViewHolderForAdapterPosition(DataAutoDownloadActivity.this.photosRow + i2);
                    if (viewHolderFindViewHolderForAdapterPosition != null) {
                    ...
                    dataAutoDownloadActivity6.wereAnyChanges = true;
                    return;
                }
            }
        }
    ...
    public void updatePresetChoseView(SlideChooseView slideChooseView) {
        ...
        for (int i = 0; i < this.presets.size(); i++) {
            ...
            if (preset == this.lowPreset) {
                strArr[i] = LocaleController.getString(C2797R.string.AutoDownloadLow);
            } else if (preset == this.mediumPreset) {
                strArr[i] = LocaleController.getString(C2797R.string.AutoDownloadMedium);
            } else if (preset == this.highPreset) {
                strArr[i] = LocaleController.getString(C2797R.string.AutoDownloadHigh);
            } else {
                strArr[i] = LocaleController.getString(C2797R.string.AutoDownloadCustom);
            }
        }
