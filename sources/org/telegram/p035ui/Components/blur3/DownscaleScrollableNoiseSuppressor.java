...
public class DownscaleScrollableNoiseSuppressor {
    ...
    private final ArrayList<SourcePart> rectRenderNodes;
    ...
    public DownscaleScrollableNoiseSuppressor(boolean z, boolean z2) {
        ...
        while (true) {
            ...
            renderNodeArr[i] = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1041m(null);
            i++;
        }
    }
    ...
    */
    public void drawInline(android.graphics.Canvas r7, int r8) {
        ...
        L18:
            ...
            if (r1 >= r8) goto L54
            java.util.ArrayList<org.telegram.ui.Components.blur3.DownscaleScrollableNoiseSuppressor$SourcePart> r8 = r6.rectRenderNodes
        ...
        L54:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.blur3.DownscaleScrollableNoiseSuppressor.drawInline(android.graphics.Canvas, int):void");
    }
    ...
    public class DownscaledRenderNode {
        ...
        public DownscaledRenderNode(String str, int i, boolean z) {
            this.renderNodeOriginalWithOffset = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1041m(null);
            int i2 = i + 1;
            ...
            for (int i3 = 0; i3 < i2; i3++) {
                ...
                renderNodeArr[i3] = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1041m(str + "_down_" + i);
            }
            if (i > 0 || z) {
                this.renderNodeRestored = new RenderNode[i2];
                for (int i4 = 0; i4 < i2; i4++) {
                    this.renderNodeRestored[i4] = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1041m(null);
                }
            } else {
        ...
        public void invalidateRenderNodes(RenderNode renderNode) {
            ...
            float f = width;
            int iRound = Math.round((DownscaleScrollableNoiseSuppressor.this.f1713k * f) / this.scaleX);
            float f2 = height;
            int iRound2 = Math.round((DownscaleScrollableNoiseSuppressor.this.f1713k * f2) / this.scaleY);
            float f3 = iRound;
            float f4 = f3 / f;
            float f5 = iRound2;
            float f6 = f5 / f2;
            float f7 = (f * DownscaleScrollableNoiseSuppressor.this.f1713k) / f3;
            float f8 = (f2 * DownscaleScrollableNoiseSuppressor.this.f1713k) / f5;
    ...
    public void onScrolled(float f, float f2) {
        for (int i = 0; i < this.rectRenderNodesCount; i++) {
            SourcePart sourcePart = this.rectRenderNodes.get(i);
    ...
    private boolean invalidateResultRenderNodes(int i, int i2) {
        ...
        while (true) {
            ...
            for (int i4 = 0; i4 < this.rectRenderNodesCount; i4++) {
                SourcePart sourcePart = this.rectRenderNodes.get(i4);
        ...
        while (true) {
            ...
            for (int i6 = 0; i6 < this.rectRenderNodesCount; i6++) {
                SourcePart sourcePart2 = this.rectRenderNodes.get(i6);
    ...
    private RenderNode getRenderNode(int i, int i2) {
        ...
        SourcePart sourcePart = this.rectRenderNodes.get(i2);
    ...
    public class SourcePart {
        ...
        private SourcePart() {
            this.renderNode = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1041m(null);
            ...
            if (DownscaleScrollableNoiseSuppressor.this.isLiquidGlassEnabled) {
                ...
                downscaledRenderNode.setPrimaryEffectBlur(AndroidUtilities.dpf2(6.0f), RenderNodeEffects.getSaturationX3RenderEffect());
            ...
            if (DownscaleScrollableNoiseSuppressor.this.simpleMode) {
                ...
                downscaledRenderNode3.setScale(z ? 16 : 8, z ? 16 : 8);
                downscaledRenderNode3.setPrimaryEffectBlur(AndroidUtilities.dpf2(40.0f), RenderNodeEffects.getSaturationX3RenderEffect());
            ...
            downscaledRenderNode4.setSecondaryEffect(0, RenderNodeEffects.getSaturationX3RenderEffect());
            this.renderNodesForGlass = null;
        }
    ...
    public void setupRenderNodes(List<RectF> list, int i) {
        ...
        for (int i2 = 0; i2 < this.rectRenderNodesCount; i2++) {
            this.rectRenderNodes.get(i2).setPosition(list.get(i2));
        }
    }
    ...
    private RecordingCanvas beginRecordingRect(int i) {
        ...
        int iWidth = rect.width() / this.f1713k;
        int iHeight = rect.height() / this.f1713k;
    ...
    private void endRecordingRect() {
        ...
        SourcePart sourcePart = this.rectRenderNodes.get(this.recordingIndex);
