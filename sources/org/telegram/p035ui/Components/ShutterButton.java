...
public class ShutterButton extends View {
    ...
    public ShutterButton(Context context) {
        ...
        this.shadowDrawable = getResources().getDrawable(C2797R.drawable.camera_btn);
    ...
    public void onDraw(Canvas canvas) {
        ...
        this.shadowDrawable.setBounds(measuredWidth - AndroidUtilities.m1036dp(36.0f), measuredHeight - AndroidUtilities.m1036dp(36.0f), AndroidUtilities.m1036dp(36.0f) + measuredWidth, AndroidUtilities.m1036dp(36.0f) + measuredHeight);
        ...
        canvas.drawCircle(f, f2, AndroidUtilities.m1036dp(26.0f), this.whitePaint);
        State state = this.state;
        State state2 = State.RECORDING;
        float f3 = this.redProgress;
        if (state != state2) {
            if (f3 != 0.0f) {
                canvas.drawCircle(f, f2, AndroidUtilities.m1036dp(26.5f) * scaleX, this.redPaint);
                return;
            }
            return;
        }
        ...
        canvas.drawCircle(f, f2, AndroidUtilities.m1036dp(26.5f) * scaleX * this.redProgress, this.redPaint);
    }

    @Override // android.view.View
    public void onMeasure(int i, int i2) {
        setMeasuredDimension(AndroidUtilities.m1036dp(84.0f), AndroidUtilities.m1036dp(84.0f));
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(AccessibilityNodeInfo.AccessibilityAction.ACTION_CLICK.getId(), LocaleController.getString(C2797R.string.AccActionTakePicture)));
        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(AccessibilityNodeInfo.AccessibilityAction.ACTION_LONG_CLICK.getId(), LocaleController.getString(C2797R.string.AccActionRecordVideo)));
    }
}
