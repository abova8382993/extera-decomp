...
public class TableView extends TableLayout {
    ...
    private final float f1698hw;
    private final Path path;
    private final float[] radii;
    private final Theme.ResourcesProvider resourcesProvider;

    /* JADX INFO: renamed from: w */
    private final float f1699w;
    ...
    public TableView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        float fMax = Math.max(1, AndroidUtilities.m1036dp(0.66f));
        this.f1699w = fMax;
        this.f1698hw = fMax / 2.0f;
    ...
    public TableRow addRowMonospaced(CharSequence charSequence, final CharSequence charSequence2, int i, final Runnable runnable) {
        ...
        frameLayout.setPadding(AndroidUtilities.m1036dp(12.66f), AndroidUtilities.m1036dp(9.33f), AndroidUtilities.m1036dp(10.66f), AndroidUtilities.m1036dp(9.33f));
        ...
        if (runnable != null) {
            ...
            imageView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.TableView$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view) {
                    TableView.m14437$r8$lambda$94D2tet7nd1WDBXBAcVpSQDBqE(charSequence2, runnable, view);
                }
            });
    ...
    public static /* synthetic */ void m14437$r8$lambda$94D2tet7nd1WDBXBAcVpSQDBqE(CharSequence charSequence, Runnable runnable, View view) {
    ...
    public TableRow addWalletAddressRow(CharSequence charSequence, final CharSequence charSequence2, final Runnable runnable) {
        ...
        linksTextView.setPadding(AndroidUtilities.m1036dp(12.66f), AndroidUtilities.m1036dp(9.33f), AndroidUtilities.m1036dp(10.66f), AndroidUtilities.m1036dp(9.33f));
    ...
    public TableRow addRowUserWithEmojiStatus(CharSequence charSequence, final int i, final long j, final Runnable runnable) {
        ...
        linksSimpleTextView.setPadding(AndroidUtilities.m1036dp(12.66f), AndroidUtilities.m1036dp(9.33f), AndroidUtilities.m1036dp(12.66f), AndroidUtilities.m1036dp(9.33f));
        ...
        if (j == UserObject.ANONYMOUS) {
            string = LocaleController.getString(C2797R.string.StarsTransactionHidden);
            ...
            if (UserObject.isService(j)) {
                string = LocaleController.getString(C2797R.string.StarsTransactionUnknown);
                CombinedDrawable platformDrawable2 = StarsIntroActivity.StarsTransactionView.getPlatformDrawable("fragment");
                platformDrawable2.setIconSize(AndroidUtilities.m1036dp(16.0f), AndroidUtilities.m1036dp(16.0f));
        ...
        final AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable swapAnimatedEmojiDrawable = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(linksSimpleTextView, AndroidUtilities.m1036dp(20.0f));
        swapAnimatedEmojiDrawable.setColor(Integer.valueOf(color));
        swapAnimatedEmojiDrawable.offset(AndroidUtilities.m1036dp(12.0f), 0);
        ...
        final Drawable drawableMutate = getContext().getResources().getDrawable(C2797R.drawable.msg_premium_liststar).mutate();
    ...
    */
    ...
    public TableRow addRowUser(CharSequence charSequence, int i, long j, final Runnable runnable, CharSequence charSequence2, Runnable runnable2) {
        ...
        textViewButtons.setPadding(AndroidUtilities.m1036dp(12.66f), AndroidUtilities.m1036dp(9.33f), AndroidUtilities.m1036dp(12.66f), AndroidUtilities.m1036dp(9.33f));
    ...
    public TableRow addRowDateTime(CharSequence charSequence, int i) {
        long j = ((long) i) * 1000;
        return addRow(charSequence, LocaleController.formatString(C2797R.string.formatDateAtTime, LocaleController.getInstance().getFormatterGiveawayCard().format(new Date(j)), LocaleController.getInstance().getFormatterDay().format(new Date(j))));
    }
    ...
    public TableRowFullContent addFullRow(CharSequence charSequence) {
        ...
        spoilersTextView.setPadding(AndroidUtilities.m1036dp(12.66f), AndroidUtilities.m1036dp(9.33f), AndroidUtilities.m1036dp(12.66f), AndroidUtilities.m1036dp(9.33f));
        TableRow tableRow = new TableRow(getContext());
        TableRow.LayoutParams layoutParams = new TableRow.LayoutParams(-2, -1);
        layoutParams.span = 2;
    ...
    public void addFullRow(CharSequence charSequence, ArrayList<TLRPC.MessageEntity> arrayList) {
        SelectableTextEmojis selectableTextEmojis = new SelectableTextEmojis(getContext());
        selectableTextEmojis.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteBlackText, this.resourcesProvider));
        selectableTextEmojis.setTextSize(1, 14.0f);
        selectableTextEmojis.setTextIsSelectable(true);
        selectableTextEmojis.setTextWithEntities(charSequence, arrayList);
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(charSequence);
        MessageObject.addEntitiesToText(spannableStringBuilder, arrayList, false, false, false, false);
        selectableTextEmojis.setText(MessageObject.replaceAnimatedEmoji(Emoji.replaceEmoji(spannableStringBuilder, selectableTextEmojis.getPaint().getFontMetricsInt(), false), arrayList, selectableTextEmojis.getPaint().getFontMetricsInt()));
        NotificationCenter.listenEmojiLoading(selectableTextEmojis);
        TableRow tableRow = new TableRow(getContext());
        TableRow.LayoutParams layoutParams = new TableRow.LayoutParams(-2, -1);
        layoutParams.span = 2;
        tableRow.addView(new TableRowFullContent(this, selectableTextEmojis), layoutParams);
        addView(tableRow);
    }

    public static class SelectableTextEmojis extends AnimatedEmojiSpan.TextViewEmojis {
        private ArrayList<TLRPC.MessageEntity> entities;
        private CharSequence originalText;

        public SelectableTextEmojis(Context context) {
            super(context);
        }

        @Override // android.widget.TextView
        public boolean onTextContextMenuItem(int i) {
            if (i == 16908321 && this.originalText != null && this.entities != null) {
                TLRPC.TL_textWithEntities tL_textWithEntities = new TLRPC.TL_textWithEntities();
                tL_textWithEntities.text = this.originalText.toString();
                tL_textWithEntities.entities = this.entities;
                AndroidUtilities.addToClipboard(MessageObject.formatTextWithEntities(tL_textWithEntities, false));
                return true;
            }
            return super.onTextContextMenuItem(i);
        }

        public void setTextWithEntities(CharSequence charSequence, ArrayList<TLRPC.MessageEntity> arrayList) {
    ...
    public static class TableRowTitle extends TextView {
        ...
        public TableRowTitle(TableView tableView, CharSequence charSequence) {
            ...
            this.resourcesProvider = resourcesProvider;
            setPadding(AndroidUtilities.m1036dp(12.66f), AndroidUtilities.m1036dp(9.33f), AndroidUtilities.m1036dp(12.66f), AndroidUtilities.m1036dp(9.33f));
        ...
        public void onDraw(Canvas canvas) {
            ...
            if (this.first || this.last) {
                ...
                float f = this.first ? fM1036dp : 0.0f;
                fArr2[1] = f;
                fArr[0] = f;
                ...
                rectF.set(this.table.f1698hw, this.table.f1698hw, getWidth() + this.table.f1698hw, getHeight() + (this.table.f1698hw * AndroidUtilities.m1036dp(this.last ? -1.0f : 1.0f)));
                ...
                canvas2 = canvas;
                canvas2.drawRect(this.table.f1698hw, this.table.f1698hw, getWidth() + this.table.f1698hw, getHeight() + this.table.f1698hw, this.table.backgroundPaint);
                canvas2.drawRect(this.table.f1698hw, this.table.f1698hw, getWidth() + this.table.f1698hw, getHeight() + this.table.f1698hw, this.table.borderPaint);
            }
    ...
    public static class TableRowFullContent extends FrameLayout {
        ...
        public void onDraw(Canvas canvas) {
            ...
            if (this.first || this.last) {
                ...
                float[] fArr3 = this.table.radii;
                float[] fArr4 = this.table.radii;
                float f2 = this.first ? fM1036dp : 0.0f;
                fArr4[3] = f2;
                fArr3[2] = f2;
                float[] fArr5 = this.table.radii;
                float[] fArr6 = this.table.radii;
                float f3 = this.last ? fM1036dp : 0.0f;
                fArr6[5] = f3;
                fArr5[4] = f3;
    ...
    public static class TableRowContent extends FrameLayout {
        ...
        public void onDraw(Canvas canvas) {
            ...
            if (this.first || this.last) {
                ...
                float[] fArr = this.table.radii;
                float[] fArr2 = this.table.radii;
                float f = (this.first && this.left) ? fM1036dp : 0.0f;
                fArr2[1] = f;
                fArr[0] = f;
                float[] fArr3 = this.table.radii;
                float[] fArr4 = this.table.radii;
                float f2 = (this.first && this.right) ? fM1036dp : 0.0f;
                fArr4[3] = f2;
                fArr3[2] = f2;
                float[] fArr5 = this.table.radii;
                float[] fArr6 = this.table.radii;
                float f3 = (this.last && this.right) ? fM1036dp : 0.0f;
                fArr6[5] = f3;
                fArr5[4] = f3;
                float[] fArr7 = this.table.radii;
                float[] fArr8 = this.table.radii;
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        this.borderPaint.setStrokeWidth(this.f1699w);
