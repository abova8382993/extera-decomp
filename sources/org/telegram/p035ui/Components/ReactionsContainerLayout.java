...
public class ReactionsContainerLayout extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public interface ReactionsContainerDelegate {
        ...
        default void drawRoundRect(Canvas canvas, RectF rectF, float f, float f2, float f3, int i, boolean z) {
        }
    ...
    public ReactionsContainerLayout(final int i, BaseFragment baseFragment, Context context, int i2, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.rect = new RectF();
        this.mPath = new Path();
        this.radius = AndroidUtilities.m1036dp(72.0f);
        float fM1036dp = AndroidUtilities.m1036dp(8.0f);
        this.bigCircleRadius = fM1036dp;
        this.smallCircleRadius = fM1036dp / 2.0f;
        this.bigCircleOffset = AndroidUtilities.m1036dp(36.0f);
        ...
        this.linearLayoutManager = new LinearLayoutManager(context, i3, b2 == true ? 1 : 0) { // from class: org.telegram.ui.Components.ReactionsContainerLayout.3
            ...
            public void getItemOffsets(Rect rect2, View view, RecyclerView recyclerView, RecyclerView.State state) {
                ...
                if (!ReactionsContainerLayout.this.showCustomEmojiReaction()) {
                    ...
                    if (childAdapterPosition == 0) {
                        rect2.left = AndroidUtilities.m1036dp(6.0f);
                    }
                    rect2.right = AndroidUtilities.m1036dp(4.0f);
                    if (childAdapterPosition == ReactionsContainerLayout.this.listAdapter.getItemCount() - 1) {
                        if (ReactionsContainerLayout.this.showUnlockPremiumButton() || ReactionsContainerLayout.this.showCustomEmojiReaction()) {
                            rect2.right = AndroidUtilities.m1036dp(2.0f);
                            return;
                        } else {
                            rect2.right = AndroidUtilities.m1036dp(6.0f);
                            return;
                        }
                    }
                    return;
        ...
        recyclerListView.addOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.Components.ReactionsContainerLayout.5
            ...
            public void onScrolled(RecyclerView recyclerView, int i4, int i5) {
                ...
                int i7 = 1;
                while (true) {
                    int childCount = ReactionsContainerLayout.this.recyclerListView.getChildCount() - 1;
                    ReactionsContainerLayout reactionsContainerLayout = ReactionsContainerLayout.this;
                    if (i7 < childCount) {
                        ReactionsContainerLayout.this.setChildScale(reactionsContainerLayout.recyclerListView.getChildAt(i7), 1.0f);
                        i7++;
                    } else {
        ...
        recyclerListView.addItemDecoration(new RecyclerView.ItemDecoration() { // from class: org.telegram.ui.Components.ReactionsContainerLayout.6
            ...
            public void getItemOffsets(Rect rect2, View view, RecyclerView recyclerView, RecyclerView.State state) {
                int childAdapterPosition = recyclerView.getChildAdapterPosition(view);
                if (childAdapterPosition == 0) {
                    rect2.left = AndroidUtilities.m1036dp(8.0f);
                }
                if (childAdapterPosition == ReactionsContainerLayout.this.listAdapter.getItemCount() - 1) {
                    rect2.right = AndroidUtilities.m1036dp(8.0f);
                }
            }
        });
        ...
        this.nextRecentReaction.getLayoutParams().width = paddingTop - AndroidUtilities.m1036dp(12.0f);
    ...
    private void setVisibleReactionsList(List<ReactionsLayoutInBubble.VisibleReaction> list, boolean z) {
        ...
        if (showCustomEmojiReaction()) {
            int iM1036dp = (AndroidUtilities.displaySize.x - AndroidUtilities.m1036dp(36.0f)) / AndroidUtilities.m1036dp(34.0f);
            if (iM1036dp > 7) {
                iM1036dp = 7;
            }
            int i = 0;
            ...
            while (i < Math.min(list.size(), iM1036dp)) {
        ...
        if ((((getLayoutParams().height - ((int) getTopOffset())) - getPaddingTop()) - getPaddingBottom()) * list.size() < AndroidUtilities.m1036dp(200.0f)) {
    ...
    */
    public void dispatchDraw(android.graphics.Canvas r24) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.ReactionsContainerLayout.dispatchDraw(android.graphics.Canvas):void");
    }
    ...
    private void drawBubbles(Canvas canvas, float f, float f2, float f3, int i) {
        ...
        if (this.isTop) {
            ...
            canvas.clipRect(0.0f, (AndroidUtilities.lerp(f5, 0.0f, cubicBezierInterpolator.getInterpolation(this.flipVerticalProgress)) - ((int) Math.ceil((this.rect.height() / 2.0f) * (1.0f - this.transitionProgress)))) - 1.0f, getMeasuredWidth(), AndroidUtilities.lerp(getMeasuredHeight() + AndroidUtilities.m1036dp(8.0f), getPaddingTop() - expandSize(), cubicBezierInterpolator.getInterpolation(this.flipVerticalProgress)));
        }
        ...
        float fLerp = AndroidUtilities.lerp(this.isTop ? (getPaddingTop() - expandSize()) - AndroidUtilities.m1036dp(16.0f) : ((getHeight() - this.smallCircleRadius) - f7) + expandSize(), (this.smallCircleRadius + f7) - expandSize(), CubicBezierInterpolator.DEFAULT.getInterpolation(this.flipVerticalProgress));
        float f12 = (-AndroidUtilities.m1036dp(1.0f)) * f2;
    ...
    private void checkPressedProgress(Canvas canvas, ReactionHolderView reactionHolderView) {
        ...
        float fClamp = this.pullingLeftOffset != 0.0f ? Utilities.clamp(reactionHolderView.getLeft() / (getMeasuredWidth() - AndroidUtilities.m1036dp(34.0f)), 1.0f, 0.0f) * getPullingLeftProgress() * AndroidUtilities.m1036dp(46.0f) : 0.0f;
        if (reactionHolderView.currentReaction.equals(this.pressedReaction)) {
            ...
            if (!this.clicked) {
                ValueAnimator valueAnimator = this.cancelPressedAnimation;
                BackupImageView backupImageView2 = reactionHolderView.pressedBackupImageView;
                if (valueAnimator == null) {
                    ...
                    backupImageView2.setAlpha(1.0f - this.cancelPressedProgress);
    ...
    public float getPullingLeftProgress() {
        return Utilities.clamp(this.pullingLeftOffset / AndroidUtilities.m1036dp(42.0f), 2.0f, 0.0f);
    }
    ...
    private void invalidateShaders() {
        ...
        paint.setShader(new LinearGradient(0.0f, height, iM1036dp, height, color, 0, tileMode));
        this.rightShadowPaint.setShader(new LinearGradient(getWidth(), height, getWidth() - iM1036dp, height, color, 0, tileMode));
        invalidate();
    }
    ...
    public void setMessage(MessageObject messageObject, TLRPC.ChatFull chatFull, boolean z) {
        ...
        if (i3 == 3) {
            ...
            if (chatReactions instanceof TLRPC.TL_chatReactionsAll) {
                TLRPC.Chat chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(chatFull.f1246id));
    ...
    private void fillRecentReactionsList(List<ReactionsLayoutInBubble.VisibleReaction> list) {
        ...
        if (!this.allReactionsAvailable || i == 4) {
            ...
            if (i == 3) {
                ArrayList<TLRPC.Reaction> savedReactions = MediaDataController.getInstance(i4).getSavedReactions();
                int i5 = 0;
            ...
            List<TLRPC.TL_availableReaction> enabledReactionsList2 = MediaDataController.getInstance(i4).getEnabledReactionsList();
        ...
        if (i == 3) {
            topReactions = MediaDataController.getInstance(i6).getSavedReactions();
        } else {
            topReactions = MediaDataController.getInstance(i6).getTopReactions();
        }
        if (this.type == 3) {
            ...
            if (savedReactionTags != null) {
                for (int i7 = 0; i7 < savedReactionTags.tags.size(); i7++) {
                    ReactionsLayoutInBubble.VisibleReaction visibleReactionFromTL3 = ReactionsLayoutInBubble.VisibleReaction.fromTL(savedReactionTags.tags.get(i7).reaction);
            ...
            for (int i8 = 0; i8 < topReactions.size(); i8++) {
                ReactionsLayoutInBubble.VisibleReaction visibleReactionFromTL4 = ReactionsLayoutInBubble.VisibleReaction.fromTL(topReactions.get(i8));
            ...
            for (int i9 = 0; i9 < topReactions.size(); i9++) {
                ReactionsLayoutInBubble.VisibleReaction visibleReactionFromTL5 = ReactionsLayoutInBubble.VisibleReaction.fromTL(topReactions.get(i9));
        ...
        if (this.type != 3 || UserConfig.getInstance(this.currentAccount).isPremium()) {
            ...
            for (int i10 = 0; i10 < recentReactions.size(); i10++) {
                ReactionsLayoutInBubble.VisibleReaction visibleReactionFromTL6 = ReactionsLayoutInBubble.VisibleReaction.fromTL(recentReactions.get(i10));
    ...
    public int getTotalWidth() {
        ...
        if (!showCustomEmojiReaction()) {
            return (AndroidUtilities.m1036dp(36.0f) * itemsCount) + (AndroidUtilities.m1036dp(2.0f) * (itemsCount - 1)) + AndroidUtilities.m1036dp(16.0f);
        }
        return (AndroidUtilities.m1036dp(36.0f) * itemsCount) - AndroidUtilities.m1036dp(4.0f);
    }
    ...
    public void setCustomEmojiReactionsBackground(boolean z) {
        ...
        if (z) {
            internalImageView.setBackground(Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m1036dp(28.0f), 0, ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_listSelector), 40)));
        } else {
            internalImageView.setBackground(null);
        }
    }
    ...
    public void setHint(CharSequence charSequence) {
        ...
        ((FrameLayout.LayoutParams) this.nextRecentReaction.getLayoutParams()).topMargin = AndroidUtilities.m1036dp(20.0f);
        ((FrameLayout.LayoutParams) this.recyclerListView.getLayoutParams()).topMargin = AndroidUtilities.m1036dp(20.0f);
    }
    ...
    public void measureHint() {
        ...
        int iMin = Math.min(AndroidUtilities.m1036dp(320.0f), getMeasuredWidth() - AndroidUtilities.m1036dp(16.0f));
        ...
        if (staticLayout.getLineCount() > 1 && !this.hintView.getText().toString().contains("\n")) {
            ...
            this.hintView.setPadding(AndroidUtilities.m1036dp(24.0f), 0, AndroidUtilities.m1036dp(24.0f), 0);
            this.hintView.setWidth(AndroidUtilities.m1036dp(48.0f) + iCutInFancyHalf);
        } else {
            this.hintView.setWidth(AndroidUtilities.m1036dp(16.0f) + iMin);
        }
        int iMax = Math.max(AndroidUtilities.m1036dp(20.0f), AndroidUtilities.m1036dp(7.0f) + this.hintViewHeight);
        int i3 = this.type;
        if (i3 == 1 || i3 == 2) {
            iMax = AndroidUtilities.m1036dp(20.0f);
        } else {
            getLayoutParams().height = AndroidUtilities.m1036dp(52.0f) + iMax + AndroidUtilities.m1036dp(22.0f);
        }
    ...
    public final class ReactionHolderView extends FrameLayout {
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            if (visibleReaction != null) {
                ...
                if (str != null) {
                    ...
                    accessibilityNodeInfo.setText(LocaleController.getString(C2797R.string.AccDescrCustomEmoji));
                    accessibilityNodeInfo.setEnabled(true);
                }
            }
        }
        ...
        public ReactionHolderView(Context context, boolean z) {
            ...
            this.enterImageView = new C48942(context, ReactionsContainerLayout.this);
        ...
        public class C48942 extends BackupImageView {
            final /* synthetic */ ReactionsContainerLayout val$this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C48942(Context context, ReactionsContainerLayout reactionsContainerLayout) {
                super(context);
        ...
        public void updateSelected(ReactionsLayoutInBubble.VisibleReaction visibleReaction, boolean z) {
            ...
            if (zContains != z2) {
                ...
                if (z) {
                    ViewPropertyAnimator duration = backupImageView.animate().scaleX(this.enterScale * (this.selected ? 0.76f : 1.0f)).scaleY(this.enterScale * (this.selected ? 0.76f : 1.0f)).setDuration(240L);
                    ...
                    backupImageView.setScaleX(this.enterScale * (zContains ? 0.76f : 1.0f));
        ...
        public void setReaction(ReactionsLayoutInBubble.VisibleReaction visibleReaction, int i) {
            ...
            int iM1036dp2 = AndroidUtilities.m1036dp(34.0f);
            layoutParams4.height = iM1036dp2;
            layoutParams3.width = iM1036dp2;
        }
        ...
        private void updateImage(ReactionsLayoutInBubble.VisibleReaction visibleReaction) {
            if (visibleReaction != null && visibleReaction.isStar) {
                this.enterImageView.getImageReceiver().setImageBitmap(new RLottieDrawable(C2797R.raw.star_reaction, "star_reaction", AndroidUtilities.m1036dp(30.0f), AndroidUtilities.m1036dp(30.0f)));
                this.loopImageView.getImageReceiver().setImageBitmap(getContext().getResources().getDrawable(C2797R.drawable.star_reaction));
        ...
        public void resetAnimation() {
            if (this.hasEnterAnimation) {
                ...
                if (this.enterImageView.getImageReceiver().getLottieAnimation() != null && !this.enterImageView.getImageReceiver().getLottieAnimation().isGeneratingCache()) {
                    this.enterImageView.getImageReceiver().getLottieAnimation().stop();
                    boolean z = ReactionsContainerLayout.this.animationEnabled;
                    BackupImageView backupImageView = this.enterImageView;
                    if (z) {
                        backupImageView.getImageReceiver().getLottieAnimation().setCurrentFrame(0, false, true);
                    } else {
                        backupImageView.getImageReceiver().getLottieAnimation().setCurrentFrame(this.enterImageView.getImageReceiver().getLottieAnimation().getFramesCount() - 1, false, true);
                    }
                }
                ...
                boolean z2 = ReactionsContainerLayout.this.skipEnterAnimation;
                BackupImageView backupImageView2 = this.loopImageView;
                if (z2) {
                    backupImageView2.setScaleY(this.enterScale * (this.selected ? 0.76f : 1.0f));
                    this.loopImageView.setScaleX(this.enterScale * (this.selected ? 0.76f : 1.0f));
                } else {
                    backupImageView2.setScaleY(0.0f);
                    this.loopImageView.setScaleX(0.0f);
                }
            }
            this.isEnter = false;
        ...
        public void dispatchDraw(Canvas canvas) {
            if (this.selected && this.drawSelected) {
                ...
                float measuredWidth2 = (getMeasuredWidth() >> 1) - AndroidUtilities.m1036dp(1.0f);
                ReactionsLayoutInBubble.VisibleReaction visibleReaction = this.currentReaction;
            ...
            if (animatedEmojiDrawable != null && animatedEmojiDrawable.getImageReceiver() != null) {
                ...
                BackupImageView backupImageView = this.loopImageView;
                if (i == 0) {
                    backupImageView.animatedEmojiDrawable.getImageReceiver().setRoundRadius(AndroidUtilities.m1036dp(6.0f), 0, 0, AndroidUtilities.m1036dp(6.0f));
                } else {
                    backupImageView.animatedEmojiDrawable.getImageReceiver().setRoundRadius(this.selected ? AndroidUtilities.m1036dp(6.0f) : 0);
                }
            }
            ReactionsLayoutInBubble.VisibleReaction visibleReaction2 = this.currentReaction;
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        if (i == NotificationCenter.chatInfoDidLoad) {
            ...
            if (chatFull.f1246id != this.waitingLoadingChatId || getVisibility() == 0 || (chatFull.available_reactions instanceof TLRPC.TL_chatReactionsNone)) {
                return;
            }
    ...
    public float expandSize() {
        return (int) (getPullingLeftProgress() * AndroidUtilities.m1036dp(6.0f));
    }
    ...
    public class Adapter extends AdapterWithDiffUtils {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 1) {
                ...
                ReactionsContainerLayout.this.premiumLockIconView.setPadding(AndroidUtilities.m1036dp(1.0f), AndroidUtilities.m1036dp(1.0f), AndroidUtilities.m1036dp(1.0f), AndroidUtilities.m1036dp(1.0f));
                ReactionsContainerLayout reactionsContainerLayout = ReactionsContainerLayout.this;
                ...
                ReactionsContainerLayout.this.customEmojiReactionsIconView.setImageResource(C2797R.drawable.msg_reactions_expand);
                ...
                ReactionsContainerLayout.this.customEmojiReactionsIconView.setBackground(Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m1036dp(28.0f), 0, ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_listSelector), 40)));
                ReactionsContainerLayout.this.customEmojiReactionsIconView.setPadding(AndroidUtilities.m1036dp(2.0f), AndroidUtilities.m1036dp(2.0f), AndroidUtilities.m1036dp(2.0f), AndroidUtilities.m1036dp(2.0f));
                ReactionsContainerLayout.this.customEmojiReactionsIconView.setContentDescription(LocaleController.getString(C2797R.string.AccDescrExpandPanel));
            ...
            reactionHolderView.setLayoutParams(new RecyclerView.LayoutParams(topOffset - AndroidUtilities.m1036dp(12.0f), topOffset));
        ...
        public void updateItems(boolean z) {
            ...
            ReactionsContainerLayout reactionsContainerLayout2 = ReactionsContainerLayout.this;
            reactionsContainerLayout2.oldItems.addAll(reactionsContainerLayout2.items);
            ReactionsContainerLayout.this.items.clear();
            int i = 0;
            while (true) {
                int size = ReactionsContainerLayout.this.visibleReactionsList.size();
                reactionsContainerLayout = ReactionsContainerLayout.this;
                if (i >= size) {
                    break;
                }
                ReactionsLayoutInBubble.VisibleReaction visibleReaction = (ReactionsLayoutInBubble.VisibleReaction) reactionsContainerLayout.visibleReactionsList.get(i);
                ReactionsContainerLayout reactionsContainerLayout3 = ReactionsContainerLayout.this;
                reactionsContainerLayout3.items.add(reactionsContainerLayout3.new InnerItem(visibleReaction.emojicon == null ? 3 : 0, visibleReaction));
                i++;
            }
            if (reactionsContainerLayout.showUnlockPremiumButton()) {
                ReactionsContainerLayout reactionsContainerLayout4 = ReactionsContainerLayout.this;
                reactionsContainerLayout4.items.add(reactionsContainerLayout4.new InnerItem(1, null));
            }
            if (ReactionsContainerLayout.this.showCustomEmojiReaction()) {
                ReactionsContainerLayout reactionsContainerLayout5 = ReactionsContainerLayout.this;
                reactionsContainerLayout5.items.add(reactionsContainerLayout5.new InnerItem(2, null));
            }
            if (z) {
                ReactionsContainerLayout reactionsContainerLayout6 = ReactionsContainerLayout.this;
                setItems(reactionsContainerLayout6.oldItems, reactionsContainerLayout6.items);
            } else {
    ...
    private Paint getStarGradientPaint(RectF rectF, float f) {
        ...
        if (this.starSelectedGradient == null) {
            ...
            LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, AndroidUtilities.m1036dp(64.0f), 0.0f, new int[]{color, Theme.multAlpha(color, 0.0f)}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP);
