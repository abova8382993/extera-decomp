...
import org.telegram.p035ui.TopicCreateFragment;
...
public class TopicsTabsView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, FactorAnimator.Target {
    ...
    public TopicsTabsView(Context context, BaseFragment baseFragment, int i, long j, Theme.ResourcesProvider resourcesProvider) {
        ...
        UniversalRecyclerView universalRecyclerView = new UniversalRecyclerView(context, i, 0, new Utilities.Callback2() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda3
            @Override // org.telegram.messenger.Utilities.Callback2
            public final void run(Object obj, Object obj2) {
                this.f$0.fillHorizontalTabs((ArrayList) obj, (UniversalAdapter) obj2);
            }
        }, new Utilities.Callback5() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda4
        ...
        }, new Utilities.Callback5Return() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda5
            ...
            @Override // org.telegram.p035ui.Components.UniversalRecyclerView, org.telegram.p035ui.Components.RecyclerListView, android.view.ViewGroup, android.view.View
            public void dispatchDraw(Canvas canvas) {
                ...
                if (horizontalTabView != null) {
                    this.lineRect.set(horizontalTabView.getX() + AndroidUtilities.m1036dp(1.0f), horizontalTabView.getY() + AndroidUtilities.m1036dp(4.0f), (horizontalTabView.getX() + horizontalTabView.getWidth()) - AndroidUtilities.m1036dp(1.0f), (horizontalTabView.getY() + getHeight()) - AndroidUtilities.m1036dp(4.0f));
                    if (horizontalTabView2 != null) {
                        RectF rectF = AndroidUtilities.rectTmp;
                        rectF.set(horizontalTabView2.getX() + AndroidUtilities.m1036dp(1.0f), horizontalTabView2.getY() + AndroidUtilities.m1036dp(4.0f), (horizontalTabView2.getX() + horizontalTabView2.getWidth()) - AndroidUtilities.m1036dp(1.0f), (horizontalTabView2.getY() + getHeight()) - AndroidUtilities.m1036dp(4.0f));
                    ...
                    canvas2.drawRoundRect(this.lineRect, AndroidUtilities.m1036dp(14.0f), AndroidUtilities.m1036dp(14.0f), this.linePaint);
                }
                if (z) {
                    canvas2.save();
                    if (f > 0.0f) {
                        RectF rectF2 = AndroidUtilities.rectTmp;
                        rectF2.set(0.0f, 0.0f, AndroidUtilities.m1036dp(12.0f), getHeight());
                        this.clip.draw(canvas2, rectF2, 0, f);
                    }
                    if (f2 > 0.0f) {
                        RectF rectF3 = AndroidUtilities.rectTmp;
                        rectF3.set(getWidth() - AndroidUtilities.m1036dp(12.0f), 0.0f, getWidth(), getHeight());
            ...
            private void drawPinnedBackground(Canvas canvas) {
                ...
                if (x > width) {
                    ...
                    RectF rectF = AndroidUtilities.rectTmp;
                    rectF.set(width + AndroidUtilities.m1036dp(1.0f), (getHeight() - AndroidUtilities.m1036dp(28.0f)) / 2.0f, x - AndroidUtilities.m1036dp(1.0f), (getHeight() + AndroidUtilities.m1036dp(28.0f)) / 2.0f);
                    canvas.drawRoundRect(rectF, AndroidUtilities.m1036dp(14.0f), AndroidUtilities.m1036dp(14.0f), this.pinnedBackgroundPaint);
                    if (this.pinIcon == null) {
                        this.pinIcon = getContext().getResources().getDrawable(C2797R.drawable.msg_limit_pin).mutate();
                    }
                    ...
                    this.pinIcon.setBounds((int) (AndroidUtilities.m1036dp(-17.0f) + x), (int) (rectF.top + AndroidUtilities.m1036dp(10.0f)), (int) (x + AndroidUtilities.m1036dp(-7.0f)), (int) (rectF.top + AndroidUtilities.m1036dp(20.0f)));
        ...
        universalRecyclerView.listenReorder(new Utilities.Callback2() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda6
            @Override // org.telegram.messenger.Utilities.Callback2
            public final void run(Object obj, Object obj2) {
        ...
        if (zIsBotForumWithEditableTopics) {
            ...
            verticalTabView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda7
        ...
        UniversalRecyclerView universalRecyclerView2 = new UniversalRecyclerView(context, i, 0, new Utilities.Callback2() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda8
            @Override // org.telegram.messenger.Utilities.Callback2
            public final void run(Object obj, Object obj2) {
            ...
            public void dispatchDraw(Canvas canvas) {
                ...
                if (f > 0.0f) {
                    canvas2.save();
                    RectF rectF = AndroidUtilities.rectTmp;
                    rectF.set(0.0f, 0.0f, getWidth(), AndroidUtilities.m1036dp(12.0f));
            ...
            private void drawPinnedBackground(Canvas canvas) {
                ...
                if (y > height) {
                    ...
                    RectF rectF = AndroidUtilities.rectTmp;
                    rectF.set((getWidth() - AndroidUtilities.m1036dp(56.0f)) / 2.0f, height, (getWidth() + AndroidUtilities.m1036dp(56.0f)) / 2.0f, y);
                    canvas.drawRoundRect(rectF, AndroidUtilities.m1036dp(6.0f), AndroidUtilities.m1036dp(6.0f), this.pinnedBackgroundPaint);
                    if (this.pinIcon == null) {
                        this.pinIcon = getContext().getResources().getDrawable(C2797R.drawable.msg_limit_pin).mutate();
                    }
                    int color = Theme.getColor(Theme.key_chats_pinnedIcon, this.resourcesProvider);
                    ...
                    this.pinIcon.setBounds((int) (rectF.left + AndroidUtilities.m1036dp(4.0f)), (int) (rectF.top + AndroidUtilities.m1036dp(2.66f)), (int) (rectF.left + AndroidUtilities.m1036dp(13.66f)), (int) (rectF.top + AndroidUtilities.m1036dp(12.32f)));
                    this.pinIcon.draw(canvas);
                }
            }
        };
        this.sideTabs = universalRecyclerView2;
        universalRecyclerView2.listenReorder(new Utilities.Callback2() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda6
            @Override // org.telegram.messenger.Utilities.Callback2
            public final void run(Object obj, Object obj2) {
                this.f$0.whenReordered(((Integer) obj).intValue(), (ArrayList) obj2);
            }
        ...
        ImageView imageViewCreateButton = createButton(context, C2797R.drawable.menu_sidebar_left, new View.OnClickListener() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        ImageView imageViewCreateButton2 = createButton(context, C2797R.drawable.menu_sidebar_left, new View.OnClickListener() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.onSideMenuButtonClick(view);
            }
        ...
        ImageView imageViewCreateButton3 = createButton(context, C2797R.drawable.msg_select, new View.OnClickListener() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        ImageView imageViewCreateButton4 = createButton(context, C2797R.drawable.msg_select, new View.OnClickListener() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.onCloseButtonClick(view);
            }
        ...
        this.topicBottom = z;
        imageViewCreateButton2.setImageResource(z ? C2797R.drawable.menu_sidebar_top : C2797R.drawable.menu_sidebar_bottom);
    ...
    public void dispatchDraw(Canvas canvas) {
        if (this.sideTabsContainer.getVisibility() == 0) {
            this.sideMenuBackgroundDrawable.setBounds((int) this.sideTabsContainer.getTranslationX(), (int) this.sideMenuBackgroundMarginTop, (int) (this.sideTabsContainer.getTranslationX() + AndroidUtilities.m1036dp(78.0f)), (int) (getMeasuredHeight() - this.sideMenuBackgroundMarginBottom));
        ...
        if (this.topTabsContainer.getVisibility() == 0) {
            ...
            this.topMenuBackgroundDrawable.setBounds(0, (int) this.topTabsContainer.getTranslationY(), getMeasuredWidth(), (int) (this.topTabsContainer.getTranslationY() + AndroidUtilities.m1036dp(50.0f)));
    ...
    public void setSideMenuBackgroundDrawable(BlurredBackgroundDrawable blurredBackgroundDrawable) {
        ...
        blurredBackgroundDrawable.setRadius(AndroidUtilities.m1036dp(16.0f));
        this.sideMenuBackgroundDrawable.setPadding(AndroidUtilities.m1036dp(7.0f));
    }
    ...
    public void setTopMenuBackgroundDrawable(BlurredBackgroundDrawable blurredBackgroundDrawable) {
        ...
        blurredBackgroundDrawable.setRadius(AndroidUtilities.m1036dp(18.0f));
        this.topMenuBackgroundDrawable.setPadding(AndroidUtilities.m1036dp(7.0f));
    }
    ...
    public void updateSidemenuPosition() {
        ...
        this.sideTabsContainer.setTranslationX(AndroidUtilities.lerp(-AndroidUtilities.m1036dp(78.0f), 0, tabsVisibility));
    ...
    private void checkUi_topicsVerticalPosition() {
        ...
        boolean z = this.topicBottom;
        FrameLayout frameLayout = this.topTabsContainer;
        if (z) {
            frameLayout.setTranslationY(((getMeasuredHeight() - AndroidUtilities.m1036dp(50.0f)) - this.sideMenuBackgroundMarginBottom) + AndroidUtilities.lerp(AndroidUtilities.m1036dp(43.0f), 0, getTabsVisibility(Position.BOTTOM)));
        } else {
            frameLayout.setTranslationY(this.sideMenuBackgroundMarginTop + AndroidUtilities.lerp(-AndroidUtilities.m1036dp(43.0f), 0, getTabsVisibility(Position.TOP)));
        }
    }
    ...
    public void animateSidemenuTo(boolean z) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda18
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                this.f$0.lambda$animateSidemenuTo$2(valueAnimator2);
            }
        });
        this.animator.addListener(new C52265(z));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$animateSidemenuTo$2(ValueAnimator valueAnimator) {
    ...
    public class C52265 extends AnimatorListenerAdapter {
        final /* synthetic */ boolean val$side;

        public C52265(boolean z) {
            this.val$side = z;
        }
        ...
        public void onAnimationEnd(Animator animator) {
            if (TopicsTabsView.this.animator == animator) {
                ...
                TopicsTabsView.this.toggleButtonSide.setImageResource(TopicsTabsView.this.topicBottom ? C2797R.drawable.menu_sidebar_top : C2797R.drawable.menu_sidebar_bottom);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$updateTabs$3() {
        if (isLoadingVisible()) {
            loadMore();
        }
    }
    ...
    public void whenReordered(int i, ArrayList<UItem> arrayList) {
        ...
        for (int i2 = 0; i2 < arrayList.size(); i2++) {
            arrayList2.add(Integer.valueOf(arrayList.get(i2).f1708id));
        }
    ...
    private void setAttached(boolean z) {
        ...
        if (z) {
            ...
            MessagesController.getInstance(i).getTopicsController().onTopicFragmentPause(-this.dialogId);
    ...
    public void fillVerticalTabs(ArrayList<UItem> arrayList, UniversalAdapter universalAdapter) {
        ...
        if (topics != null) {
            ...
            while (i < size) {
                ...
                if (!this.bot || tL_forumTopic2.f1306id != 1) {
                    if (!this.excludeTopics.contains(Integer.valueOf(tL_forumTopic2.f1306id))) {
                    ...
                    if (!this.excludeTopics.contains(Integer.valueOf(tL_forumTopic2.f1306id))) {
                        ...
                        if (!z3 && z2) {
                            if (!arrayList.isEmpty()) {
                                arrayList.get(arrayList.size() - 1).flags |= 8;
                            }
                            universalAdapter.reorderSectionEnd();
                            z2 = false;
                        } else if (z3 && !z2) {
    ...
    public void onTabClick(UItem uItem, View view, int i, float f, float f2) {
        ...
        Utilities.Callback2<Integer, Boolean> callback22 = this.onTopicSelected;
        if (callback22 != null) {
            callback22.run(Integer.valueOf(uItem.f1708id), Boolean.FALSE);
        }
    }
        ...
        if (!this.sideTabs.isReorderAllowed() && !this.topTabs.isReorderAllowed()) {
            ...
            if (obj instanceof TLRPC.TL_forumTopic) {
                ...
                if (ChatObject.isMonoForum(chat)) {
                    ...
                    itemOptionsMakeOptions.add(C2797R.drawable.msg_clear, LocaleController.getString(C2797R.string.ClearHistory), new Runnable() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda10
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$onTabLongClick$5(itemOptionsMakeOptions, peerDialogId, chat);
                        }
                    });
                    ...
                    if (user2 != null && ChatObject.canBlockUsers(chat3)) {
                        itemOptionsMakeOptions.add(C2797R.drawable.msg_remove, LocaleController.getString(C2797R.string.BanUserMonoforum), (Runnable) null);
                        final long j5 = j3;
                        final ActionBarMenuSubItem last = itemOptionsMakeOptions.getLast();
                        last.setVisibility(8);
                        MessagesController.getInstance(this.currentAccount).checkIsInChat(true, chat3, user2, new MessagesController.IsInChatCheckedCallback() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda11
                            @Override // org.telegram.messenger.MessagesController.IsInChatCheckedCallback
                            public final void run(boolean z, TLRPC.TL_chatAdminRights tL_chatAdminRights, String str) {
                                this.f$0.lambda$onTabLongClick$10(last, itemOptionsMakeOptions, j5, user2, chat3, z, tL_chatAdminRights, str);
                            }
                        });
                    }
                } else {
                    ...
                    if (ChatObject.canManageTopics(chat4) || UserObject.isBotForumWithEditableTopics(user)) {
                        ...
                        itemOptionsMakeOptions.add(z ? C2797R.drawable.msg_unpin : C2797R.drawable.msg_pin, LocaleController.getString(z ? C2797R.string.DialogUnpin : C2797R.string.DialogPin), new Runnable() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda12
                            @Override // java.lang.Runnable
                            public final void run() {
                                this.f$0.lambda$onTabLongClick$11(itemOptionsMakeOptions, messagesController, tL_forumTopic);
                            }
                        });
                        if (tL_forumTopic.pinned) {
                            itemOptionsMakeOptions.add(C2797R.drawable.tabs_reorder, LocaleController.getString(C2797R.string.FilterReorder), new Runnable() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda13
                                @Override // java.lang.Runnable
                                public final void run() {
                    ...
                    if (ChatObject.canManageTopics(chat4) || UserObject.isBotForumWithEditableTopics(user)) {
                        itemOptionsMakeOptions.add(C2797R.drawable.outline_profile_edit_24, LocaleController.getString(C2797R.string.EditTopic), new Runnable() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda14
                            @Override // java.lang.Runnable
                            public final void run() {
                                this.f$0.lambda$onTabLongClick$13(itemOptionsMakeOptions, tL_forumTopic);
                            }
                        });
                    }
                    final ItemOptions itemOptionsAddAsItemOptions = ChatNotificationsPopupWrapper.addAsItemOptions(this.fragment, itemOptionsMakeOptions, this.dialogId, tL_forumTopic.f1306id);
                    boolean zIsDialogMuted = messagesController.isDialogMuted(this.dialogId, tL_forumTopic.f1306id);
                    itemOptionsMakeOptions.add(zIsDialogMuted ? C2797R.drawable.msg_unmute : C2797R.drawable.msg_mute, LocaleController.getString(zIsDialogMuted ? C2797R.string.Unmute : C2797R.string.Mute), new Runnable() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda15
                        @Override // java.lang.Runnable
                        public final void run() {
                    ...
                    if (ChatObject.canManageTopic(this.currentAccount, chat4, tL_forumTopic) && !UserObject.isBotForum(user)) {
                        ...
                        itemOptionsMakeOptions.add(z2 ? C2797R.drawable.msg_topic_restart : C2797R.drawable.msg_topic_close, LocaleController.getString(z2 ? C2797R.string.RestartTopic : C2797R.string.CloseTopic), new Runnable() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda16
                            @Override // java.lang.Runnable
                            public final void run() {
                    ...
                    if (ChatObject.canDeleteTopic(this.currentAccount, chat4, tL_forumTopic)) {
                        itemOptionsMakeOptions.add(C2797R.drawable.msg_delete, LocaleController.getPluralString("DeleteTopics", 1), new Runnable() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda17
                            @Override // java.lang.Runnable
                            public final void run() {
                ...
                if (view instanceof HorizontalTabView) {
                    itemOptionsMakeOptions.setScrimViewBackground(new Drawable() { // from class: org.telegram.ui.Components.TopicsTabsView.6
                        ...
                        public void draw(Canvas canvas) {
                            ...
                            this.bound.inset(AndroidUtilities.m1036dp(1.0f), (this.bound.height() - AndroidUtilities.m1036dp(28.0f)) / 2.0f);
                    ...
                    itemOptionsMakeOptions.translate(AndroidUtilities.m1036dp(16.0f), 0.0f);
                } else {
                    itemOptionsMakeOptions.setScrimViewBackground(Theme.createRoundRectDrawable(0, AndroidUtilities.m1036dp(5.0f), AndroidUtilities.m1036dp(5.0f), 0, Theme.getColor(Theme.key_windowBackgroundWhite, this.resourcesProvider)));
                }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onTabLongClick$5(ItemOptions itemOptions, final long j, TLRPC.Chat chat) {
        itemOptions.dismiss();
    ...
    public /* synthetic */ void lambda$onTabLongClick$9(boolean z, ActionBarMenuSubItem actionBarMenuSubItem, final ItemOptions itemOptions, final long j, final TLRPC.User user, final TLRPC.Chat chat) {
        ...
        actionBarMenuSubItem.setText(LocaleController.getString(!z ? C2797R.string.UnbanUserMonoforum : C2797R.string.BanUserMonoforum));
    ...
    public /* synthetic */ void lambda$onTabLongClick$6(TLRPC.Updates updates) {
        MessagesController.getInstance(this.currentAccount).loadFullChat(updates.chats.get(0).f1245id, 0, true);
    }
    ...
    public /* synthetic */ void lambda$onTabLongClick$11(ItemOptions itemOptions, MessagesController messagesController, TLRPC.TL_forumTopic tL_forumTopic) {
        itemOptions.dismiss();
        messagesController.getTopicsController().pinTopic(-this.dialogId, tL_forumTopic.f1306id, !tL_forumTopic.pinned, this.fragment);
    }
    ...
    public /* synthetic */ void lambda$onTabLongClick$13(ItemOptions itemOptions, TLRPC.TL_forumTopic tL_forumTopic) {
        itemOptions.dismiss();
        this.fragment.presentFragment(TopicCreateFragment.create(-this.dialogId, tL_forumTopic.f1306id));
    }
    ...
    public /* synthetic */ void lambda$onTabLongClick$14(MessagesController messagesController, TLRPC.TL_forumTopic tL_forumTopic, ItemOptions itemOptions, ItemOptions itemOptions2) {
        if (messagesController.isDialogMuted(this.dialogId, tL_forumTopic.f1306id)) {
            itemOptions.dismiss();
            NotificationsController.getInstance(this.currentAccount).muteDialog(this.dialogId, tL_forumTopic.f1306id, false);
    ...
    public /* synthetic */ void lambda$onTabLongClick$15(ItemOptions itemOptions, TLRPC.TL_forumTopic tL_forumTopic) {
        itemOptions.dismiss();
        MessagesController.getInstance(this.currentAccount).getTopicsController().toggleCloseTopic(-this.dialogId, tL_forumTopic.f1306id, !tL_forumTopic.closed);
    }
    ...
    public static class VerticalTabView extends FrameLayout {
        ...
        public VerticalTabView(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
            ...
            FrameLayout frameLayout = new FrameLayout(context, resourcesProvider) { // from class: org.telegram.ui.Components.TopicsTabsView.VerticalTabView.2
                ...
                public void dispatchDraw(Canvas canvas) {
                    ...
                    float fM1036dp2 = AndroidUtilities.m1036dp(8.33f);
                    float width = (getWidth() / 2.0f) + AndroidUtilities.m1036dp(12.0f);
                    float fM1036dp3 = AndroidUtilities.m1036dp(12.0f);
                    float fMax = Math.max(fM1036dp2 + fM1036dp2, VerticalTabView.this.counterText.getCurrentWidth() + AndroidUtilities.m1036dp(10.0f));
                    if (z) {
                        f = 2.0f;
                        f2 = fM1036dp3;
                        canvas2 = canvas;
                    ...
                    if (z) {
                        RectF rectF = AndroidUtilities.rectTmp;
                        float f3 = fMax / f;
                        rectF.set((width - f3) - AndroidUtilities.m1036dp(1.33f), f2 - fM1036dp, f3 + width + AndroidUtilities.m1036dp(1.33f), f2 + fM1036dp);
                        AndroidUtilities.scaleRect(rectF, fIsNotEmpty);
                        float f4 = fM1036dp * fIsNotEmpty;
                    ...
                    if (fIsNotEmpty > 0.0f) {
                        ...
                        RectF rectF2 = AndroidUtilities.rectTmp;
                        float f5 = fMax / f;
                        rectF2.set(width - f5, f2 - fM1036dp2, width + f5, f2 + fM1036dp2);
                        canvas2.drawRoundRect(rectF2, fM1036dp2, fM1036dp2, this.backgroundPaint.setByKey(VerticalTabView.this.counterBackgroundColorKey, fIsNotEmpty));
            ...
            frameLayout.setPadding(0, AndroidUtilities.m1036dp(4.0f), 0, 0);
            ...
            imageView.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1036dp(2.33f), Theme.getColor(i2, resourcesProvider)));
            addView(imageView, LayoutHelper.createFrame(6, -1.0f, 115, -3.0f, 3.0f, 0.0f, 3.0f));
            imageView.setTranslationX(-AndroidUtilities.m1036dp(3.0f));
        ...
        private void setLayout(boolean z) {
            ...
            this.imageLayoutView.setPadding(0, AndroidUtilities.m1036dp(z ? 7.0f : 4.0f), 0, 0);
            this.imageViewParams.width = z ? AndroidUtilities.m1036dp(28.0f) : AndroidUtilities.m1036dp(30.0f);
            this.imageViewParams.height = z ? AndroidUtilities.m1036dp(28.0f) : AndroidUtilities.m1036dp(30.0f);
        }
        ...
        private void setCounter(boolean z, int i, boolean z2, boolean z3, boolean z4) {
            if (z3) {
                ...
                if (this.reactionString == null) {
                    ...
                    ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C2797R.drawable.mini_like_filled);
                    coloredImageSpan.setScale(0.8f, 0.8f);
                    coloredImageSpan.spaceScaleX = 0.5f;
                    coloredImageSpan.translate(-AndroidUtilities.m1036dp(3.0f), 0.0f);
                ...
                if (this.mentionString == null) {
                    ...
                    ColoredImageSpan coloredImageSpan2 = new ColoredImageSpan(C2797R.drawable.mini_mention_filled_16);
                    coloredImageSpan2.setScale(0.8f, 0.8f);
                    coloredImageSpan2.spaceScaleX = 0.5f;
                    coloredImageSpan2.translate(-AndroidUtilities.m1036dp(3.0f), 0.0f);
        ...
        public void setAll(boolean z, boolean z2, boolean z3) {
            ...
            this.isAdd = false;
            this.textView.setText(LocaleController.getString(z ? C2797R.string.BotForumNewTopic : C2797R.string.AllTopicsSide));
            ...
            if (z) {
                ...
                this.imageView.setImageResource(C2797R.drawable.other_chats);
            }
        ...
        public void setAdd(boolean z, boolean z2) {
            ...
            this.staticImage = true;
            this.isAdd = true;
            this.textView.setText(LocaleController.getString(C2797R.string.NewTopic));
            this.textView.setVisibility(0);
            this.imageView.clearImage();
            this.imageView.setAnimatedEmojiDrawable(null);
            this.imageView.setImageResource(C2797R.drawable.emoji_tabs_new3);
            this.imageView.setScaleX(1.0f);
            this.imageView.setScaleY(1.0f);
            setSelected(z2);
            updateImageColor();
        ...
        public void setLoading() {
            ...
            LoadingSpan loadingSpan = new LoadingSpan(this.textView, AndroidUtilities.m1036dp(38.0f));
        ...
        public void set(long j, TLRPC.TL_forumTopic tL_forumTopic, boolean z) {
            ...
            if (tL_forumTopic.f1306id == 1) {
                ...
                this.imageView.clearImage();
                this.imageView.setAnimatedEmojiDrawable(null);
                this.imageView.setImageResource(C2797R.drawable.msg_filled_general);
            ...
            setSelected(z);
            updateImageColor();
            setCounter(MessagesController.getInstance(this.currentAccount).isDialogMuted(j, tL_forumTopic.f1306id), tL_forumTopic.unread_count, tL_forumTopic.unread_mentions_count > 0, tL_forumTopic.unread_reactions_count > 0, z2);
        ...
        public void updateState() {
            this.lineView.setTranslationX((-AndroidUtilities.m1036dp(3.0f)) * (1.0f - this.selectT));
        ...
        public void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(64.0f), TLObject.FLAG_30), i2);
        }
        ...
        public static class Factory extends UItem.UItemFactory<VerticalTabView> {
            ...
            public static UItem asTab(long j, TLRPC.TL_forumTopic tL_forumTopic, boolean z) {
                ...
                uItemOfFactory.f1708id = tL_forumTopic.f1306id;
    ...
    public static class HorizontalTabView extends FrameLayout {
            ...
            View view = new View(context, resourcesProvider) { // from class: org.telegram.ui.Components.TopicsTabsView.HorizontalTabView.1
                ...
                public void dispatchDraw(Canvas canvas) {
                    ...
                    if (fIsNotEmpty > 0.0f) {
                        ...
                        float fMax = Math.max(AndroidUtilities.m1036dp(16.66f), HorizontalTabView.this.counterText.getCurrentWidth() + AndroidUtilities.m1036dp(10.0f));
                        RectF rectF = AndroidUtilities.rectTmp;
                        rectF.set(0.0f, 0.0f, fMax, getHeight());
                        canvas.save();
                        canvas.scale(fLerp, fLerp, rectF.centerX(), rectF.centerY());
                        canvas.drawRoundRect(rectF, AndroidUtilities.m1036dp(8.33f), AndroidUtilities.m1036dp(8.33f), this.backgroundPaint.setByKey(HorizontalTabView.this.counterBackgroundColorKey).blendTo(HorizontalTabView.this.getTextColor(), HorizontalTabView.this.selectT).multAlpha(fIsNotEmpty));
                ...
                public void onMeasure(int i2, int i3) {
                    super.onMeasure(View.MeasureSpec.makeMeasureSpec((int) Math.max(AndroidUtilities.m1036dp(16.66f), HorizontalTabView.this.counterText.getAnimateToWidth() + AndroidUtilities.m1036dp(10.0f)), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(16.66f), TLObject.FLAG_30));
                }
            };
        ...
        public void onLayout(boolean z, int i, int i2, int i3, int i4) {
            ...
            int i7 = i6 / 2;
            this.textView.layout(AndroidUtilities.m1036dp(11.0f), i7 - (this.textView.getMeasuredHeight() / 2), AndroidUtilities.m1036dp(11.0f) + this.textView.getMeasuredWidth(), (this.textView.getMeasuredHeight() / 2) + i7);
            float animateToWidth = this.counterText.getAnimateToWidth();
            View view = this.counterView;
            if (animateToWidth > 0.0f) {
                view.layout((i5 - AndroidUtilities.m1036dp(11.0f)) - this.counterView.getMeasuredWidth(), i7 - (this.counterView.getMeasuredHeight() / 2), i5 - AndroidUtilities.m1036dp(11.0f), i7 + (this.counterView.getMeasuredHeight() / 2));
            } else {
                view.layout(AndroidUtilities.m1036dp(11.0f) + this.textView.getMeasuredWidth() + AndroidUtilities.m1036dp(4.66f), i7 - (this.counterView.getMeasuredHeight() / 2), AndroidUtilities.m1036dp(11.0f) + this.textView.getMeasuredWidth() + AndroidUtilities.m1036dp(4.66f) + this.counterView.getMeasuredWidth(), i7 + (this.counterView.getMeasuredHeight() / 2));
            }
        ...
        public void setAll(boolean z, boolean z2, boolean z3) {
            ...
            this.textView.setText(LocaleController.getString(z ? C2797R.string.BotForumNewTopic : C2797R.string.AllTopicsShort));
            this.textView.setVisibility(z ? 8 : 0);
            setSelected(z3);
            updateTextColor();
            setCounter(true, 0, false, false, false);
        ...
        public void setAdd() {
            ...
            spannableStringBuilder.setSpan(new ColoredImageSpan(C2797R.drawable.menu_topic_add), 0, 1, 33);
            this.textView.setText(spannableStringBuilder);
            setSelected(false);
            updateTextColor();
            setCounter(true, 0, false, false, false);
        ...
        public void setLoading() {
            ...
            this.textView.setVisibility(0);
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder("x");
            LoadingSpan loadingSpan = new LoadingSpan(this.textView, AndroidUtilities.m1036dp(42.0f));
        ...
        public void set(long j, TLRPC.TL_forumTopic tL_forumTopic, boolean z) {
            ...
            if (tL_forumTopic.f1306id == 1) {
                ...
                ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C2797R.drawable.msg_filled_general);
        ...
        public void setMf(long j, TLRPC.TL_forumTopic tL_forumTopic, boolean z) {
            ...
            linksTextView.setText(TextUtils.ellipsize(spannableStringBuilder, linksTextView.getPaint(), AndroidUtilities.m1036dp(150.0f), TextUtils.TruncateAt.END));
            setSelected(z);
        ...
        private int getMeasuringWidth() {
            return AndroidUtilities.m1036dp(11.0f) + this.textView.getMeasuredWidth() + (this.counterText.getAnimateToWidth() > 0.0f ? AndroidUtilities.m1036dp(4.66f) + ((int) Math.max(AndroidUtilities.m1036dp(16.66f), this.counterText.getAnimateToWidth() + AndroidUtilities.m1036dp(10.0f))) : 0) + AndroidUtilities.m1036dp(11.0f) + this.addW;
        }

        @Override // android.widget.FrameLayout, android.view.View
        public void onMeasure(int i, int i2) {
            this.textView.measure(i, i2);
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(getMeasuringWidth(), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(36.0f), TLObject.FLAG_30));
        }
        ...
        public static class Factory extends UItem.UItemFactory<HorizontalTabView> {
            ...
            public void bindView(View view, UItem uItem, boolean z, UniversalAdapter universalAdapter, UniversalRecyclerView universalRecyclerView) {
                ...
                horizontalTabView.addW = BitwiseUtils.hasFlag(uItem.flags, 8) ? AndroidUtilities.m1036dp(10.0f) : 0;
    ...
    private void deleteTopics(final HashSet<Integer> hashSet, final Runnable runnable) {
        ...
        if (hashSet.size() == 1) {
            builder.setMessage(LocaleController.formatString(C2797R.string.DeleteSelectedTopic, MessagesController.getInstance(this.currentAccount).getTopicsController().findTopic(-this.dialogId, ((Integer) arrayList.get(0)).intValue()).title));
        } else {
            builder.setMessage(LocaleController.getString(C2797R.string.DeleteSelectedTopics));
        }
        builder.setPositiveButton(LocaleController.getString(C2797R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda22
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
                this.f$0.lambda$deleteTopics$20(arrayList, j, hashSet, runnable, alertDialog, i);
            }
        });
        builder.setNegativeButton(LocaleController.getString(C2797R.string.Cancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda23
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
                alertDialog.dismiss();
            }
    ...
    public /* synthetic */ void lambda$deleteTopics$20(final ArrayList arrayList, final long j, final HashSet hashSet, final Runnable runnable, AlertDialog alertDialog, int i) {
        ...
        updateTabs();
        BulletinFactory.m1143of(this.fragment).createUndoBulletin(LocaleController.getPluralString("TopicsDeleted", hashSet.size()), new Runnable() { // from class: org.telegram.ui.Components.TopicsTabsView$$ExternalSyntheticLambda26
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private long getTopicId(TLRPC.TL_forumTopic tL_forumTopic) {
        return this.mono ? DialogObject.getPeerDialogId(tL_forumTopic.from_id) : tL_forumTopic.f1306id;
    }
    ...
    public static class BotNewTopicDrawable extends Drawable {
        ...
        public BotNewTopicDrawable(Context context) {
            this.drawable = context.getResources().getDrawable(C2797R.drawable.menu_topic_add).mutate();
        }
        ...
        @Override // android.graphics.drawable.Drawable
        public void draw(Canvas canvas) {
            canvas.drawRoundRect(this.rectF, AndroidUtilities.m1036dp(10.0f), AndroidUtilities.m1036dp(10.0f), this.paint);
        ...
        public void onBoundsChange(Rect rect) {
            ...
            this.rectF.set(rect);
            int iCenterX = rect.centerX() - AndroidUtilities.m1036dp(12.0f);
            int iCenterY = rect.centerY() - AndroidUtilities.m1036dp(12.0f);
            this.drawable.setBounds(iCenterX, iCenterY, AndroidUtilities.m1036dp(24.0f) + iCenterX, AndroidUtilities.m1036dp(24.0f) + iCenterY);
        }
    ...
    private static int getTabsSize(Position position) {
        return AndroidUtilities.m1036dp(position == Position.LEFT ? 64.0f : 36.0f);
    }
    ...
    public Position getCurrentTabsPosition() {
        return this.sidemenuEnabled ? Position.LEFT : this.topicBottom ? Position.BOTTOM : Position.TOP;
    }
