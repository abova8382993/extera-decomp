...
public class CrossfadeDrawable extends Drawable {
    ...
    private void updateChildVisibility(boolean z) {
        boolean z2 = false;
        this.topDrawable.setVisible(isVisible() && this.progress < 1.0f, z);
        Drawable drawable = this.bottomDrawable;
        if (isVisible() && this.progress > 0.0f) {
            z2 = true;
        }
        drawable.setVisible(z2, z);
    }
}
