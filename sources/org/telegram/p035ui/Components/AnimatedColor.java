        ...
        if (this.transition) {
            ...
            if (jElapsedRealtime - this.transitionStart >= this.transitionDelay) {
                ...
                if (timeInterpolator == null) {
                    this.value = ColorUtils.blendARGB(i2, this.targetValue, fClamp);
                } else {
                    this.value = ColorUtils.blendARGB(i2, this.targetValue, timeInterpolator.getInterpolation(fClamp));
                }
            }
            if (fClamp >= 1.0f) {
                this.transition = false;
