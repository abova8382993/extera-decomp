...
public class GroupVoipInviteAlert extends UsersAlertBase {
    ...
    public GroupVoipInviteAlert(Context context, int i, TLRPC.Chat chat, TLRPC.ChatFull chatFull, LongSparseArray<TLRPC.GroupCallParticipant> longSparseArray, HashSet<Long> hashSet) {
    ...
    */
    public static /* synthetic */ int $r8$lambda$Jxjb1g4dHVPktfHUABWJR3wxpuE(org.telegram.messenger.MessagesController r4, int r5, org.telegram.tgnet.TLObject r6, org.telegram.tgnet.TLObject r7) {
        ...
        L6c:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.GroupVoipInviteAlert.$r8$lambda$Jxjb1g4dHVPktfHUABWJR3wxpuE(org.telegram.messenger.MessagesController, int, org.telegram.tgnet.TLObject, org.telegram.tgnet.TLObject):int");
    }
    ...
    public /* synthetic */ void lambda$loadChatParticipants$3(TLRPC.TL_error tL_error, TLObject tLObject, TLRPC.TL_channels_getParticipants tL_channels_getParticipants) {
        ...
        LongSparseArray<TLRPC.GroupCallParticipant> longSparseArray2;
        if (tL_error == null) {
    ...
    public class SearchAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void searchUsers(final String str) {
            ...
            this.searchAdapterHelper.queryServerSearch(null, true, false, true, false, false, GroupVoipInviteAlert.this.currentChat.f1245id, false, 2, -1);
        ...
        public /* synthetic */ void lambda$processSearch$2(final String str, final int i) {
            ...
            this.searchAdapterHelper.queryServerSearch(str, ChatObject.canAddUsers(GroupVoipInviteAlert.this.currentChat), false, true, false, false, ChatObject.isChannel(GroupVoipInviteAlert.this.currentChat) ? GroupVoipInviteAlert.this.currentChat.f1245id : 0L, false, 2, i);
        }

        /* JADX INFO: Access modifiers changed from: private */
        /* JADX WARN: Removed duplicated region for block: B:49:0x00e7  */
        /* JADX WARN: Removed duplicated region for block: B:52:0x00ef A[LOOP:1: B:33:0x009f->B:52:0x00ef, LOOP_END] */
        ...
        */
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                manageChatUserCell.setCustomRightImage(C2797R.drawable.msg_invited);
                ...
                view2.setLayoutParams(new RecyclerView.LayoutParams(-1, AndroidUtilities.m1036dp(56.0f)));
                view = view2;
            } else {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            manageChatUserCell.setCustomImageVisible(GroupVoipInviteAlert.this.invitedUsers.contains(Long.valueOf(user.f1407id)));
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                if (i == 1) {
                    ...
                    view3.setLayoutParams(new RecyclerView.LayoutParams(-1, AndroidUtilities.m1036dp(56.0f)));
                    view2 = view3;
                } else if (i == 5) {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType != 0) {
                if (itemViewType == 1) {
                    ...
                    if (i == GroupVoipInviteAlert.this.addNewRow) {
                        manageChatTextCell.setText(LocaleController.getString(C2797R.string.VoipGroupCopyInviteLink), null, C2797R.drawable.msg_link, 7, (!GroupVoipInviteAlert.this.loadingUsers || GroupVoipInviteAlert.this.firstLoaded) && GroupVoipInviteAlert.this.membersHeaderRow == -1 && !GroupVoipInviteAlert.this.participants.isEmpty());
                        return;
                    }
                    return;
                }
                ...
                if (i == GroupVoipInviteAlert.this.membersHeaderRow) {
                    graySectionCell.setText(LocaleController.getString(C2797R.string.ChannelOtherMembers));
                    return;
                } else {
                    if (i == GroupVoipInviteAlert.this.contactsHeaderRow) {
                        if (GroupVoipInviteAlert.this.showContacts) {
                            graySectionCell.setText(LocaleController.getString(C2797R.string.YourContactsToInvite));
                            return;
                        } else {
                            graySectionCell.setText(LocaleController.getString(C2797R.string.GroupContacts));
                            return;
                        }
                    }
                    return;
            ...
            if (item instanceof TLRPC.TL_contact) {
                ...
                peerId = ((TLRPC.User) item).f1407id;
            } else if (item instanceof TLRPC.ChannelParticipant) {
