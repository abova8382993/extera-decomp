...
public abstract class StorageDiagramView extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public StorageDiagramView(Context context, long j) {
        ...
        if (j == LongCompanionObject.MAX_VALUE) {
            this.dialogText = LocaleController.getString(C2797R.string.CacheOtherChats);
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.dialogId != null) {
            ...
            size = (View.MeasureSpec.getSize(i) - AndroidUtilities.m1036dp(110.0f)) / 2;
            this.rectF.set(AndroidUtilities.m1036dp(3.0f) + size, AndroidUtilities.m1036dp(3.0f), AndroidUtilities.m1036dp(107.0f) + size, AndroidUtilities.m1036dp(107.0f));
        } else {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(110.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(110.0f), TLObject.FLAG_30));
            this.rectF.set(AndroidUtilities.m1036dp(3.0f), AndroidUtilities.m1036dp(3.0f), AndroidUtilities.m1036dp(107.0f), AndroidUtilities.m1036dp(107.0f));
            size = 0;
        }
        ...
        this.text1.setTextSize(AndroidUtilities.m1036dp(24.0f));
        ...
        if (l != null) {
            animatedTextDrawable2.setTextSize(AndroidUtilities.m1036dp(16.0f));
            this.text1.setGravity(5);
            this.text2.setGravity(3);
        } else {
            animatedTextDrawable2.setTextSize(AndroidUtilities.m1036dp(13.0f));
            int textSize = (int) this.text1.getTextSize();
            int textSize2 = (int) this.text2.getTextSize();
            int iM1036dp = ((AndroidUtilities.m1036dp(110.0f) - textSize) - textSize2) / 2;
            int i3 = textSize + iM1036dp;
            this.text1.setBounds(0, iM1036dp, getMeasuredWidth(), i3);
            this.text2.setBounds(0, AndroidUtilities.m1036dp(2.0f) + i3, getMeasuredWidth(), i3 + textSize2 + AndroidUtilities.m1036dp(2.0f));
        ...
        if (this.dialogText != null) {
            ...
            this.dialogTextPaint.setTextSize(AndroidUtilities.m1036dp(13.0f));
            int size2 = View.MeasureSpec.getSize(i) - AndroidUtilities.m1036dp(60.0f);
        ...
        if (imageReceiver != null) {
            imageReceiver.setImageCoords(size + AndroidUtilities.m1036dp(10.0f), AndroidUtilities.m1036dp(10.0f), AndroidUtilities.m1036dp(90.0f), AndroidUtilities.m1036dp(90.0f));
            this.avatarImageReceiver.setRoundRadius(AndroidUtilities.m1036dp(45.0f));
        }
        updateDescription();
    }
    ...
    */
    public void onDraw(android.graphics.Canvas r29) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.StorageDiagramView.onDraw(android.graphics.Canvas):void");
    }
    ...
    public static class ClearViewData {
        ...
        public ClearViewData(StorageDiagramView storageDiagramView) {
            ...
            this.paint.setStrokeWidth(AndroidUtilities.m1036dp(5.0f));
    ...
    public void update(boolean z) {
        ...
        this.valueAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.StorageDiagramView.1
            ...
            public C51601(final ClearViewData[] clearViewDataArr2) {
                clearViewDataArr = clearViewDataArr2;
            }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.StorageDiagramView$1 */
    public class C51601 extends AnimatorListenerAdapter {
        final /* synthetic */ ClearViewData[] val$data;
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        Long l;
        boolean z = this.avatarImageReceiver != null && (l = this.dialogId) != null && l.longValue() != LongCompanionObject.MAX_VALUE && motionEvent.getX() > this.avatarImageReceiver.getImageX() && motionEvent.getX() <= this.avatarImageReceiver.getImageX2() && motionEvent.getY() > this.avatarImageReceiver.getImageY() && motionEvent.getY() <= this.avatarImageReceiver.getImageY2();
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.StorageDiagramView$2 */
    public class C51612 extends AnimatorListenerAdapter {
        public C51612() {
        }
