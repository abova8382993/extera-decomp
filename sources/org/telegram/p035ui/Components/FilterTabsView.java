...
public class FilterTabsView extends FrameLayout {
    ...
    public class Tab {
        ...
        public Tab(int i, CharSequence charSequence, String str, boolean z) {
            this.f1563id = i;
            this.title = ExteraConfig.getTabIcons() != TabIconsMode.ICONS_ONLY ? charSequence : _UrlKt.FRAGMENT_ENCODE_SET;
        ...
        public int getWidth(boolean z) {
            ...
            int iM1036dp = 0;
            if (z) {
                tabCounter = FilterTabsView.this.delegate.getTabCounter(this.f1563id);
                if (tabCounter < 0) {
                    tabCounter = 0;
                }
                if (z) {
            ...
            if (tabCounter > 0) {
                iMax = Math.max(AndroidUtilities.m1036dp(7.333f), (int) Math.ceil(FilterTabsView.this.textCounterPaint.measureText(String.format(TimeModel.NUMBER_FORMAT, Integer.valueOf(tabCounter))))) + AndroidUtilities.m1036dp(10.0f) + AndroidUtilities.m1036dp(-2.0f);
            } else {
                if (!this.isDefault && FilterTabsView.this.isEditing) {
                    iM1036dp = AndroidUtilities.m1036dp(12.333f);
                }
                iMax = iM1036dp;
            }
            return Math.max(AndroidUtilities.m1036dp(16.0f), i + iMax);
        }
        ...
        public boolean setTitle(String str, ArrayList<TLRPC.MessageEntity> arrayList, boolean z) {
            ...
            this.title = ExteraConfig.getTabIcons() != TabIconsMode.ICONS_ONLY ? this.title : _UrlKt.FRAGMENT_ENCODE_SET;
            this.noanimate = z;
            return true;
        }
    }
    ...
    public class TabView extends View {
        ...
        public int getId() {
            return this.currentTab.f1563id;
        }
        ...
        /* JADX WARN: Removed duplicated region for block: B:589:0x0814  */
        /* JADX WARN: Removed duplicated region for block: B:590:0x081d  */
        /* JADX WARN: Removed duplicated region for block: B:593:0x0825  */
        /* JADX WARN: Removed duplicated region for block: B:596:0x085e  */
        /* JADX WARN: Removed duplicated region for block: B:599:0x0898  */
        /* JADX WARN: Removed duplicated region for block: B:632:0x0a0e  */
        @Override // android.view.View
        ...
        */
        ...
        private float getCurrentIconAlpha() {
            boolean z = this.animateIconWidth;
            Tab tab = this.currentTab;
            if (!z) {
                return tab.iconWidth > 0 ? 1.0f : 0.0f;
            }
            int i = tab.iconWidth;
        ...
        public boolean animateChange() {
            ...
            int iMax = this.currentTab.counter > 0 ? Math.max(AndroidUtilities.m1036dp(7.333f), (int) Math.ceil(FilterTabsView.this.textCounterPaint.measureText(String.format(TimeModel.NUMBER_FORMAT, Integer.valueOf(r2))))) + AndroidUtilities.m1036dp(10.0f) : 0;
            int i5 = this.currentTab.iconWidth;
            ...
            if (ExteraConfig.getTabIcons() != TabIconsMode.ICONS_ONLY) {
                iM1036dp = this.currentTab.titleWidth + i5 + (iMax != 0 ? iMax + AndroidUtilities.m1036dp(6.0f) : 0);
            } else {
                iM1036dp = i5 + (iMax != 0 ? iMax + AndroidUtilities.m1036dp(6.0f) : 0);
            }
            float measuredWidth = ((getMeasuredWidth() - iM1036dp) / 2) + i5;
            ...
            if (charSequence3 != null && !this.currentTab.title.equals(charSequence3)) {
                ...
                if (iCharSequenceIndexOf >= 0) {
                    ...
                    int iM1036dp2 = AndroidUtilities.m1036dp(400.0f);
                    Layout.Alignment alignment3 = Layout.Alignment.ALIGN_NORMAL;
                    StaticLayout staticLayout = new StaticLayout(spannableStringBuilder4, textPaint3, iM1036dp2, alignment3, 1.0f, 0.0f, false);
                    ...
                    StaticLayout staticLayout2 = new StaticLayout(spannableStringBuilder5, FilterTabsView.this.textPaint, AndroidUtilities.m1036dp(400.0f), alignment3, 1.0f, 0.0f, false);
                    ...
                    int iM1036dp3 = AndroidUtilities.m1036dp(400.0f);
                    Layout.Alignment alignment4 = Layout.Alignment.ALIGN_NORMAL;
                    StaticLayout staticLayout3 = new StaticLayout(charSequence4, textPaint4, iM1036dp3, alignment4, 1.0f, 0.0f, false);
                    ...
                    StaticLayout staticLayout4 = new StaticLayout(this.lastTitle, FilterTabsView.this.textPaint, AndroidUtilities.m1036dp(400.0f), alignment4, 1.0f, 0.0f, false);
            ...
            if (ExteraConfig.getTabIcons() != TabIconsMode.TITLES_ONLY) {
                float measuredWidth2 = (int) ((getMeasuredWidth() - iM1036dp) / 2.0f);
            ...
            if (iM1036dp == this.lastTabWidth && getMeasuredWidth() == this.lastWidth) {
                return z;
            }
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            accessibilityNodeInfo.setSelected((this.currentTab == null || FilterTabsView.this.selectedTabId == -1 || this.currentTab.f1563id != FilterTabsView.this.selectedTabId) ? false : true);
            accessibilityNodeInfo.addAction(16);
            accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(32, LocaleController.getString(C2797R.string.AccDescrOpenMenu2)));
        ...
        public void shakeLockIcon(float f, int i) {
            ...
            ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(0.0f, AndroidUtilities.m1036dp(f));
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Components.FilterTabsView$TabView$1 */
        /* JADX INFO: loaded from: classes7.dex */
        public class C43561 extends AnimatorListenerAdapter {
            final /* synthetic */ int val$num;
            final /* synthetic */ float val$x;
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.FilterTabsView$1 */
    public class RunnableC43491 implements Runnable {
        public RunnableC43491() {
        }
        ...
        public void run() {
            if (FilterTabsView.this.animatingIndicator) {
                ...
                float f = FilterTabsView.this.animationTime;
                FilterTabsView filterTabsView2 = FilterTabsView.this;
                if (f < 1.0f) {
                    AndroidUtilities.runOnUIThread(filterTabsView2.animationRunnable);
                    return;
                }
                filterTabsView2.animatingIndicator = false;
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.FilterTabsView$2 */
    public class C43502 extends AnimationProperties.FloatProperty<FilterTabsView> {
        public C43502(String str) {
            super(str);
        }
    ...
    public FilterTabsView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        textPaint3.setStrokeWidth(AndroidUtilities.m1036dp(1.5f));
        ...
        C43513 c43513 = new RecyclerListView(context) { // from class: org.telegram.ui.Components.FilterTabsView.3
            public C43513(Context context2) {
                super(context2);
            }
            ...
            public boolean canHighlightChildAt(View view, float f, float f2) {
                if (FilterTabsView.this.isEditing) {
                    ...
                    if (tabView.rect.left - fM1036dp < f && tabView.rect.right + fM1036dp > f) {
                        return false;
                    }
                }
        ...
        this.listView = c43513;
        c43513.setOverScrollMode(2);
        c43513.setClipChildren(false);
        C43524 c43524 = new C43524();
        this.itemAnimator = c43524;
        c43524.setDelayAnimations(false);
        c43513.setItemAnimator(this.itemAnimator);
        c43513.setSelectorType(9);
        c43513.setSelectorRadius(6);
        c43513.setSelectorDrawableColor(Theme.getColor(this.selectorColorKey, resourcesProvider));
        C43535 c43535 = new LinearLayoutManager(context2, 0, false) { // from class: org.telegram.ui.Components.FilterTabsView.5
            @Override // androidx.recyclerview.widget.LinearLayoutManager, androidx.recyclerview.widget.RecyclerView.LayoutManager
            public boolean supportsPredictiveItemAnimations() {
                return true;
            }

            public C43535(Context context2, int i, boolean z) {
                super(context2, i, z);
            }

            /* JADX INFO: renamed from: org.telegram.ui.Components.FilterTabsView$5$1 */
            /* JADX INFO: loaded from: classes7.dex */
            public class AnonymousClass1 extends LinearSmoothScroller {
                ...
                public void onTargetFound(View view, RecyclerView.State state, RecyclerView.SmoothScroller.Action action) {
                    ...
                    if (iCalculateDxToMakeVisible > 0 || (iCalculateDxToMakeVisible == 0 && view.getLeft() - AndroidUtilities.m1036dp(21.0f) < 0)) {
                        iCalculateDxToMakeVisible += AndroidUtilities.m1036dp(60.0f);
                    } else if (iCalculateDxToMakeVisible < 0 || (iCalculateDxToMakeVisible == 0 && view.getRight() + AndroidUtilities.m1036dp(21.0f) > FilterTabsView.this.getMeasuredWidth())) {
                        iCalculateDxToMakeVisible -= AndroidUtilities.m1036dp(60.0f);
                    }
            ...
            public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int i) {
                AnonymousClass1 anonymousClass1 = new LinearSmoothScroller(recyclerView.getContext()) { // from class: org.telegram.ui.Components.FilterTabsView.5.1
        ...
        this.layoutManager = c43535;
        c43513.setLayoutManager(c43535);
        new ItemTouchHelper(new TouchHelperCallback()).attachToRecyclerView(c43513);
        int iMax = Math.max(0, AndroidUtilities.m1036dp(23.5f) - (FolderIcons.getPaddingTab() / 2));
        this.listViewPaddingH = iMax;
        c43513.setPadding(iMax, 0, iMax, 0);
        c43513.setClipToPadding(false);
        c43513.setDrawSelectorBehind(true);
        ListAdapter listAdapter = new ListAdapter(context2);
        this.adapter = listAdapter;
        listAdapter.setHasStableIds(true);
        c43513.setAdapter(listAdapter);
        c43513.setOnItemClickListener(new RecyclerListView.OnItemClickListenerExtended() { // from class: org.telegram.ui.Components.FilterTabsView$$ExternalSyntheticLambda0
            @Override // org.telegram.ui.Components.RecyclerListView.OnItemClickListenerExtended
            public final void onItemClick(View view, int i, float f, float f2) {
                this.f$0.lambda$new$0(view, i, f, f2);
            }
        });
        c43513.setOnItemLongClickListener(new RecyclerListView.OnItemLongClickListener() { // from class: org.telegram.ui.Components.FilterTabsView$$ExternalSyntheticLambda1
            @Override // org.telegram.ui.Components.RecyclerListView.OnItemLongClickListener
            public final boolean onItemClick(View view, int i) {
                return this.f$0.lambda$new$1(view, i);
            }
        });
        c43513.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.Components.FilterTabsView.6
            public C43546() {
            }
        ...
        c43513.setAdaptiveOverScroll();
        addView(c43513, LayoutHelper.createFrame(-1, -1.0f));
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.FilterTabsView$3 */
    public class C43513 extends RecyclerListView {
        public C43513(Context context2) {
            super(context2);
        }
    ...
    public class C43524 extends DefaultItemAnimator {
        public C43524() {
        }
                ...
                if (tabView.animateChange) {
                    ...
                    valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.FilterTabsView$4$$ExternalSyntheticLambda1
                        ...
                        public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                            FilterTabsView.C43524.m11916$r8$lambda$DghHiTLqtaEBdiK1Uy8XexT6xo(tabView, valueAnimator2);
                        }
                    });
                    valueAnimatorOfFloat.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.FilterTabsView.4.1
                        ...
                        public AnonymousClass1(final TabView tabView2) {
                            tabView = tabView2;
                        }
                    ...
                    tabView2.changeAnimator = valueAnimatorOfFloat;
                    valueAnimatorOfFloat.setDuration(getMoveDuration());
                    valueAnimatorOfFloat.start();
                }
            }
        ...
        /* JADX INFO: renamed from: $r8$lambda$DghHiTLqtaEB-diK1Uy8XexT6xo */
        public static /* synthetic */ void m11916$r8$lambda$DghHiTLqtaEBdiK1Uy8XexT6xo(TabView tabView, ValueAnimator valueAnimator) {
            tabView.changeProgress = ((Float) valueAnimator.getAnimatedValue()).floatValue();
            tabView.invalidate();
        }

        /* JADX INFO: renamed from: org.telegram.ui.Components.FilterTabsView$4$1 */
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.FilterTabsView$5 */
    public class C43535 extends LinearLayoutManager {
        @Override // androidx.recyclerview.widget.LinearLayoutManager, androidx.recyclerview.widget.RecyclerView.LayoutManager
        public boolean supportsPredictiveItemAnimations() {
            return true;
        }
    ...
    public /* synthetic */ void lambda$new$0(View view, int i, float f, float f2) {
        ...
        if (this.delegate.canPerformActions()) {
            TabView tabView = (TabView) view;
            if (this.isEditing) {
                if (i != 0 || ExteraConfig.getHideAllChats()) {
                    float fM1036dp = AndroidUtilities.m1036dp(6.0f);
                    if (tabView.rect.left - fM1036dp >= f || tabView.rect.right + fM1036dp <= f) {
                        return;
                    }
                    this.delegate.onDeletePressed(tabView.currentTab.f1563id);
                    return;
                }
                return;
            }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.FilterTabsView$6 */
    public class C43546 extends RecyclerView.OnScrollListener {
        public C43546() {
        }
    ...
    public void scrollToTab(Tab tab, int i) {
        ...
        if (i2 == i && this.selectedTabId == tab.f1563id) {
            return;
        }
        if (tab.isLocked) {
        ...
        this.currentPosition = i;
        this.selectedTabId = tab.f1563id;
    ...
    public void addTab(int i, int i2, String str, String str2, ArrayList<TLRPC.MessageEntity> arrayList, boolean z, boolean z2, boolean z3) {
    ...
    public void finishAddingTabs(boolean z) {
        ...
        this.delegate.onTabSelected(this.tabs.get(this.currentPosition), false, false);
        this.oldAnimatedTab = this.currentPosition;
    }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.FilterTabsView$7 */
    /* JADX INFO: loaded from: classes7.dex */
    public class C43557 extends AnimatorListenerAdapter {
        public C43557() {
        }
    ...
    */
    public boolean drawChild(android.graphics.Canvas r9, android.view.View r10, long r11) {
        ...
        L2a:
            ...
            float r5 = r8.editingAnimationProgress
        ...
        L39:
            ...
            float r7 = r7 / r6
            float r5 = r5 + r7
            r8.editingAnimationProgress = r5
            if (r9 != 0) goto L48
            if (r4 == 0) goto L48
            int r4 = (r5 > r3 ? 1 : (r5 == r3 ? 0 : -1))
            if (r4 < 0) goto L48
        ...
        Lae:
            return r11
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.FilterTabsView.drawChild(android.graphics.Canvas, android.view.View, long):boolean");
    }
    ...
    */
    private void drawSelector(android.graphics.Canvas r14) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.FilterTabsView.drawSelector(android.graphics.Canvas):void");
    }
        ...
        if (!this.tabs.isEmpty()) {
            ...
            if (tabFindDefaultTab != null || ExteraConfig.getHideAllChats()) {
                if (!ExteraConfig.getHideAllChats()) {
                    ...
                    String string = LocaleController.getString(C2797R.string.FilterAllChats);
                    String string2 = LocaleController.getString(C2797R.string.FilterAllChatsShort);
    ...
    public void setIsEditing(boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (zIsDefault) {
                ...
                arrayList.add(Integer.valueOf(dialogFilter.f1156id));
            }
        }
    ...
    */
    public void checkTabsCounter() {
        /*
            r8 = this;
            java.util.ArrayList<org.telegram.ui.Components.FilterTabsView$Tab> r0 = r8.tabs
            int r0 = r0.size()
            r1 = 0
            r2 = r1
            r3 = r2
        L9:
            if (r2 >= r0) goto L65
            java.util.ArrayList<org.telegram.ui.Components.FilterTabsView$Tab> r4 = r8.tabs
        ...
        L45:
            ...
            java.util.ArrayList<org.telegram.ui.Components.FilterTabsView$Tab> r3 = r8.tabs
            ...
            int r4 = com.exteragram.messenger.utils.p020ui.FolderIcons.getPaddingTab()
            int r3 = r3 + r4
            int r2 = r2 + r3
            r8.allTabsWidth = r2
            int r1 = r1 + 1
        ...
        L65:
            ...
            org.telegram.ui.Components.FilterTabsView$ListAdapter r8 = r8.adapter
            r8.notifyDataSetChanged()
        L73:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.FilterTabsView.checkTabsCounter():void");
    }
    ...
    public void notifyTabCounterChanged(int i) {
        ...
        if (tab.counter == this.delegate.getTabCounter(tab.f1563id) || this.delegate.getTabCounter(tab.f1563id) < 0) {
            return;
        }
        this.listView.invalidateViews();
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        */
        ...
        public void moveElementToStart(int i) {
            ...
            int i3 = ((Tab) FilterTabsView.this.tabs.get(i)).f1563id;
            ...
            ((Tab) FilterTabsView.this.tabs.get(0)).f1563id = i3;
            for (int i5 = 0; i5 <= i; i5++) {
                ((Tab) FilterTabsView.this.tabs.get(i5)).f1563id = i5;
            ...
            notifyItemMoved(i, 0);
            FilterTabsView.this.delegate.onPageReorder(((Tab) FilterTabsView.this.tabs.get(i)).f1563id, i3);
    ...
    public class TouchHelperCallback extends ItemTouchHelper.Callback {
        ...
        public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (viewHolder != null) {
                viewHolder.itemView.setTag(C2797R.id.dragging, i == 2 ? Boolean.TRUE : null);
            }
        }
    ...
    public boolean currentTabIsDefault() {
        Tab tabFindDefaultTab = findDefaultTab();
        return tabFindDefaultTab != null && tabFindDefaultTab.f1563id == this.selectedTabId;
    }
    ...
    public int getDefaultTabId() {
        ...
        return tabFindDefaultTab.f1563id;
    }
    ...
    public boolean isFirstTabSelected() {
        return this.tabs.isEmpty() || this.selectedTabId == this.tabs.get(0).f1563id;
    }

    public boolean isLocked(int i) {
        for (int i2 = 0; i2 < this.tabs.size(); i2++) {
            if (this.tabs.get(i2).f1563id == i) {
    ...
    public void shakeLock(int i) {
        for (int i2 = 0; i2 < this.listView.getChildCount(); i2++) {
            if (this.listView.getChildAt(i2) instanceof TabView) {
                ...
                if (tabView.currentTab.f1563id == i) {
