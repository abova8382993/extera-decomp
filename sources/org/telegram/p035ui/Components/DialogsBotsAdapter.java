...
public class DialogsBotsAdapter extends UniversalAdapter {
    ...
    public DialogsBotsAdapter(RecyclerListView recyclerListView, final Context context, int i, int i2, boolean z, final Theme.ResourcesProvider resourcesProvider) {
        ...
        this.infoText = AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(C2797R.string.AppsTabInfo), new Runnable() { // from class: org.telegram.ui.Components.DialogsBotsAdapter$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$new$2(Theme.ResourcesProvider resourcesProvider, Context context) {
        final AlertDialog[] alertDialogArr = new AlertDialog[1];
        SpannableStringBuilder spannableStringBuilderReplaceTags = AndroidUtilities.replaceTags(AndroidUtilities.replaceLinks(LocaleController.getString(C2797R.string.AppsTabInfoText), resourcesProvider, new Runnable() { // from class: org.telegram.ui.Components.DialogsBotsAdapter$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
        ...
        while (matcher.find()) {
            spannableStringBuilderReplaceTags.setSpan(new ClickableSpan() { // from class: org.telegram.ui.Components.DialogsBotsAdapter.1
                ...
                public C42271(final AlertDialog[] alertDialogArr2, Context context2, String str) {
                ...
                public void onClick(View view) {
                    ...
                    Browser.openUrl(context, "https://t.me/" + str);
                }
        ...
        alertDialogArr2[0] = new AlertDialog.Builder(context2, resourcesProvider).setTitle(LocaleController.getString(C2797R.string.AppsTabInfoTitle)).setMessage(spannableStringBuilderReplaceTags).setPositiveButton(LocaleController.getString(C2797R.string.AppsTabInfoButton), null).show();
    }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.DialogsBotsAdapter$1 */
    /* JADX INFO: loaded from: classes7.dex */
    public class C42271 extends ClickableSpan {
        final /* synthetic */ AlertDialog[] val$alert;
        final /* synthetic */ Context val$context;
        final /* synthetic */ String val$username;
    ...
    public void fillItems(ArrayList<UItem> arrayList, UniversalAdapter universalAdapter) {
        ...
        if (!TextUtils.isEmpty(this.query)) {
            ...
            if (!arrayList2.isEmpty()) {
                if (arrayList2.size() <= 5 || this.searchMessages.isEmpty() || this.showOnlyPopular) {
                    arrayList.add(UItem.asGraySection(LocaleController.getString(C2797R.string.SearchApps)));
                } else {
                    arrayList.add(UItem.asGraySection(LocaleController.getString(C2797R.string.SearchApps), LocaleController.getString(this.expandedSearchBots ? C2797R.string.ShowLess : C2797R.string.ShowMore), new View.OnClickListener() { // from class: org.telegram.ui.Components.DialogsBotsAdapter$$ExternalSyntheticLambda5
            ...
            arrayList.add(UItem.asGraySection(LocaleController.getString(C2797R.string.SearchMessages)));
        ...
        if (!arrayList5.isEmpty() && !this.showOnlyPopular) {
            if (arrayList5.size() > 5) {
                arrayList.add(UItem.asGraySection(LocaleController.getString(C2797R.string.SearchAppsMine), LocaleController.getString(this.expandedMyBots ? C2797R.string.ShowLess : C2797R.string.ShowMore), new View.OnClickListener() { // from class: org.telegram.ui.Components.DialogsBotsAdapter$$ExternalSyntheticLambda6
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                ...
                arrayList.add(UItem.asGraySection(LocaleController.getString(C2797R.string.SearchAppsMine)));
            }
            for (int i4 = 0; i4 < arrayList5.size() && (i4 < 5 || this.expandedMyBots); i4++) {
                TLRPC.User user2 = (TLRPC.User) arrayList5.get(i4);
                if (!hashSet.contains(Long.valueOf(user2.f1407id))) {
        ...
        if (!this.popular.bots.isEmpty()) {
            if (!this.showOnlyPopular) {
                arrayList.add(UItem.asGraySection(LocaleController.getString(C2797R.string.SearchAppsPopular)));
            }
            int i5 = 0;
            while (true) {
                int size3 = this.popular.bots.size();
                popularBots = this.popular;
                if (i >= size3) {
                    break;
                }
                TLRPC.User user3 = popularBots.bots.get(i);
                if (!hashSet.contains(Long.valueOf(user3.f1407id))) {
                    hashSet.add(Long.valueOf(user3.f1407id));
    ...
    private void searchMessages(final boolean z) {
        ...
        tL_messages_searchGlobal.f1370q = this.query;
        ...
        tL_contacts_search.f1300q = this.query;
    ...
    public /* synthetic */ void lambda$searchMessages$5(final int i, final TLRPC.TL_messages_searchGlobal tL_messages_searchGlobal, final boolean z) {
        if (i == this.searchBotsId && TextUtils.equals(tL_messages_searchGlobal.f1370q, this.query)) {
    ...
    public /* synthetic */ void lambda$searchMessages$6(TLRPC.TL_contacts_search tL_contacts_search, TLObject tLObject) {
        ...
        TLRPC.User user;
        TLRPC.User user2;
        if (!TextUtils.equals(tL_contacts_search.f1300q, this.query) || TextUtils.isEmpty(this.query)) {
            return;
        }
        ...
        if (tL_contacts_found != null) {
            ...
            while (i < size) {
                ...
                if ((peer2 instanceof TLRPC.TL_peerUser) && (user2 = MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(peer2.user_id))) != null && user2.bot && !hashSet.contains(Long.valueOf(user2.f1407id))) {
                    hashSet.add(Long.valueOf(user2.f1407id));
        ...
        if (tL_contacts_found != null) {
            ...
            while (i2 < size2) {
                ...
                if ((peer4 instanceof TLRPC.TL_peerUser) && (user = MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(peer4.user_id))) != null && user.bot && !hashSet.contains(Long.valueOf(user.f1407id))) {
    ...
    public static class PopularBots {
        ...
        /* JADX WARN: Can't wrap try/catch for region: R(3:(3:119|76|130)|74|125) */
        ...
        */
        public /* synthetic */ void lambda$loadCache$1(org.telegram.messenger.MessagesStorage r18, final java.lang.Runnable r19) throws java.lang.Throwable {
            ...
            L67:
                ...
                if (r15 == 0) goto L7f
                r16 = r6
                long r5 = r15.f1407id     // Catch: java.lang.Throwable -> L3a java.lang.Exception -> L7c
            ...
            L9e:
                ...
                r16 = 0
            La2:
                org.telegram.messenger.FileLog.m1048e(r0)     // Catch: java.lang.Throwable -> Lb8
                if (r5 == 0) goto L98
                r5.dispose()
                goto L98
            Lab:
        ...
        private void saveCache() {
            ...
            for (int i = 0; i < this.bots.size(); i++) {
                arrayList.add(Long.valueOf(this.bots.get(i).f1407id));
            }
            final MessagesStorage messagesStorage = MessagesStorage.getInstance(this.currentAccount);
        ...
        public /* synthetic */ void lambda$load$4() {
            ...
            if (this.bots.isEmpty() || System.currentTimeMillis() - this.cacheTime > DurationKt.MILLIS_IN_HOUR) {
                this.bots.clear();
