...
public class MotionBackgroundDrawable extends Drawable {
    ...
    public void setPatternGiftPositions(List<WallpaperGiftPatternPosition> list) {
    ...
    public void setGiftPatternBitmap(Bitmap bitmap) {
        ...
        if (this.intensity < 0) {
            if (!useLegacyBitmap) {
                ...
                createLegacyBitmap();
                boolean z = errorWhileGenerateLegacyBitmap;
                Paint paint = this.paint2Gift;
                if (!z) {
    ...
    public void setGiftDrawable(TLRPC.Document document) {
        if (this.giftImageReceiver == null) {
            ...
            if (weakReference != null) {
                this.giftImageReceiver.setParentView(weakReference.get());
            }
            if (this.isAttached) {
    ...
    public void setPatternBitmap(int i, Bitmap bitmap, boolean z) {
        ...
        if (i < 0) {
            ...
            createLegacyBitmap();
            boolean z2 = errorWhileGenerateLegacyBitmap;
    ...
    */
    public void drawPattern(android.graphics.Canvas r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.MotionBackgroundDrawable.drawPattern(android.graphics.Canvas):void");
    }
    ...
    */
    public void draw(android.graphics.Canvas r22) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.MotionBackgroundDrawable.draw(android.graphics.Canvas):void");
    }
    ...
    /* JADX INFO: renamed from: updateAnimation */
        ...
        if (f2 < 1.0f) {
            ...
            if (z) {
                ...
                if (this.rotatingPreview) {
                    ...
                    char c2 = interpolation3 <= 0.25f ? (char) 0 : interpolation3 <= 0.5f ? (char) 1 : interpolation3 <= 0.75f ? (char) 2 : (char) 3;
                    ...
                    if ((c2 == 0 && interpolation2 > 0.25f) || ((c2 == 1 && interpolation2 > 0.5f) || (c2 == 2 && interpolation2 > 0.75f))) {
                        boolean z3 = this.rotationBack;
                        int i2 = this.phase;
                        if (z3) {
                            int i3 = i2 + 1;
                            this.phase = i3;
            ...
            if (z2) {
                ...
                if (f != 1.0f) {
                    int i7 = (int) (f / 0.33333334f);
                    Canvas canvas = this.gradientCanvas;
                    if (i7 == 0) {
                        canvas.drawBitmap(this.gradientFromBitmap, 0.0f, 0.0f, (Paint) null);
                    } else {
                        canvas.drawBitmap(this.gradientToBitmap[i7 - 1], 0.0f, 0.0f, (Paint) null);
                    }
                    this.paint3.setAlpha((int) (((f - (i7 * 0.33333334f)) / 0.33333334f) * 255.0f));
                    this.gradientCanvas.drawBitmap(this.gradientToBitmap[i7], 0.0f, 0.0f, this.paint3);
                } else {
    ...
    private void drawGiftPatternsForNegativeIntensity(Canvas canvas, float f, float f2, float f3) {
        ...
        for (int i = 0; i < this.giftPatternPositions.size(); i++) {
            WallpaperGiftPatternPosition wallpaperGiftPatternPosition = this.giftPatternPositions.get(i);
            canvas.save();
    ...
    private void drawGiftPatternsForPositiveIntensity(Canvas canvas, RectF rectF, Paint paint, int i) {
        ...
        for (int i2 = 0; i2 < this.giftPatternPositions.size(); i2++) {
            WallpaperGiftPatternPosition wallpaperGiftPatternPosition = this.giftPatternPositions.get(i2);
            canvas.save();
            canvas.concat(wallpaperGiftPatternPosition.matrix);
