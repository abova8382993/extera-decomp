...
public class GroupCallFullscreenAdapter extends RecyclerListView.SelectionAdapter {
    ...
    public void scrollTo(ChatObject.VideoParticipant videoParticipant, RecyclerListView recyclerListView) {
        ...
        for (int i = 0; i < this.videoParticipants.size(); i++) {
            if (this.videoParticipants.get(i).equals(videoParticipant)) {
                linearLayoutManager.scrollToPositionWithOffset(i, AndroidUtilities.m1036dp(13.0f));
                return;
            }
        }
    }
    ...
    public class GroupCallUserCell extends FrameLayout implements GroupCallStatusIcon.Callback {
        ...
        public GroupCallUserCell(Context context) {
            ...
            this.avatarWavesDrawable = new GroupCallUserCell.AvatarWavesDrawable(AndroidUtilities.m1036dp(26.0f), AndroidUtilities.m1036dp(29.0f));
            this.avatarDrawable.setTextSize((int) (AndroidUtilities.m1036dp(18.0f) / 1.15f));
            ...
            this.selectionPaint.setStrokeWidth(AndroidUtilities.m1036dp(2.0f));
            this.textPaint.setColor(-1);
            C44031 c44031 = new RLottieImageView(context) { // from class: org.telegram.ui.Components.GroupCallFullscreenAdapter.GroupCallUserCell.1
                final /* synthetic */ GroupCallFullscreenAdapter val$this$0;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public C44031(Context context2, GroupCallFullscreenAdapter groupCallFullscreenAdapter) {
                    super(context2);
            ...
            this.muteButton = c44031;
            c44031.setScaleType(ImageView.ScaleType.CENTER);
        ...
        public class C44031 extends RLottieImageView {
            final /* synthetic */ GroupCallFullscreenAdapter val$this$0;
        ...
        public void onMeasure(int i, int i2) {
            ...
            if (this.name != null) {
                int iMin = (int) Math.min(AndroidUtilities.m1036dp(46.0f), this.textPaint.measureText(this.name));
                this.nameWidth = iMin;
                this.drawingName = TextUtils.ellipsize(this.name, this.textPaint, iMin, TextUtils.TruncateAt.END).toString();
            }
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(80.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(80.0f), TLObject.FLAG_30));
        }
        ...
        public void setProgressToFullscreen(float f) {
            ...
            float f2 = 1.0f - f;
            float fM1036dp = ((AndroidUtilities.m1036dp(46.0f) / AndroidUtilities.m1036dp(40.0f)) * f2) + (1.0f * f);
            this.avatarImageView.setTranslationY((-top) * f2);
            this.avatarImageView.setScaleX(fM1036dp);
            this.avatarImageView.setScaleY(fM1036dp);
        ...
        public void dispatchDraw(Canvas canvas) {
            ...
            float fM1036dp = ((AndroidUtilities.m1036dp(46.0f) / AndroidUtilities.m1036dp(40.0f)) * (1.0f - f)) + (f * 1.0f);
            this.avatarImageView.setScaleX(this.avatarWavesDrawable.getAvatarScale() * fM1036dp);
            this.avatarImageView.setScaleY(this.avatarWavesDrawable.getAvatarScale() * fM1036dp);
        ...
        */
        private void drawSelection(android.graphics.Canvas r7) {
            ...
            L33:
                ...
                int r1 = org.telegram.messenger.AndroidUtilities.m1036dp(r0)
                float r1 = (float) r1
                int r0 = org.telegram.messenger.AndroidUtilities.m1036dp(r0)
                float r0 = (float) r0
                android.graphics.Paint r6 = r6.selectionPaint
                r7.drawRoundRect(r2, r1, r0, r6)
            L78:
                return
            */
        ...
        public void drawOverlays(Canvas canvas) {
            if (this.drawingName != null) {
                canvas.save();
                int measuredWidth = ((getMeasuredWidth() - this.nameWidth) - AndroidUtilities.m1036dp(24.0f)) / 2;
                this.textPaint.setAlpha((int) (this.progress * 255.0f * getAlpha()));
                canvas.drawText(this.drawingName, AndroidUtilities.m1036dp(22.0f) + measuredWidth, AndroidUtilities.m1036dp(69.0f), this.textPaint);
                canvas.restore();
                canvas.save();
                canvas.translate(measuredWidth, AndroidUtilities.m1036dp(53.0f));
        ...
        */
        public void updateState(boolean r9) {
            ...
            L19:
                ...
                goto L16
            L28:
                int r0 = org.telegram.p035ui.ActionBar.Theme.key_voipgroup_nameText
                int r0 = org.telegram.p035ui.ActionBar.Theme.getColor(r0)
                int r1 = org.telegram.p035ui.ActionBar.Theme.key_voipgroup_listeningText
            ...
            L6f:
                ...
                org.telegram.ui.Components.GroupCallFullscreenAdapter$GroupCallUserCell$2 r9 = new org.telegram.ui.Components.GroupCallFullscreenAdapter$GroupCallUserCell$2
                r9.<init>()
                r8.addListener(r9)
                android.animation.ValueAnimator r8 = r3.colorAnimator
                r8.start()
        ...
        public class C44042 extends AnimatorListenerAdapter {
            final /* synthetic */ int val$newColor;
            final /* synthetic */ int val$newWavesColor;

            public C44042(int i, int i2) {
                i = i;
                i = i2;
            }
    ...
    public void update(boolean z, RecyclerListView recyclerListView) {
        ...
        if (z) {
            ...
            DiffUtil.calculateDiff(new DiffUtil.Callback() { // from class: org.telegram.ui.Components.GroupCallFullscreenAdapter.1
                ...
                public C44011(ArrayList arrayList22, ArrayList arrayList3) {
    ...
    public class C44011 extends DiffUtil.Callback {
        final /* synthetic */ ArrayList val$oldParticipants;
        final /* synthetic */ ArrayList val$oldVideoParticipants;
