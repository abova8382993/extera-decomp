...
public class CheckBox extends View {
    ...
    public CheckBox(Context context, int i) {
        ...
        eraser2.setStrokeWidth(AndroidUtilities.m1036dp(28.0f));
        backgroundPaint.setStrokeWidth(AndroidUtilities.m1036dp(2.0f));
        TextPaint textPaint = new TextPaint(1);
        this.textPaint = textPaint;
        textPaint.setTextSize(AndroidUtilities.m1036dp(18.0f));
    ...
    public void setVisibility(int i) {
        ...
        if (i == 0 && this.drawBitmap == null) {
            try {
                ...
                int iM1036dp2 = AndroidUtilities.m1036dp(this.size);
                Bitmap.Config config = Bitmap.Config.ARGB_4444;
                this.drawBitmap = Bitmap.createBitmap(iM1036dp, iM1036dp2, config);
                this.bitmapCanvas = new Canvas(this.drawBitmap);
                this.checkBitmap = Bitmap.createBitmap(AndroidUtilities.m1036dp(this.size), AndroidUtilities.m1036dp(this.size), config);
    ...
    public void setSize(int i) {
        this.size = i;
        if (i == 40) {
            this.textPaint.setTextSize(AndroidUtilities.m1036dp(24.0f));
        }
    }
    ...
    public class C41881 extends AnimatorListenerAdapter {
        public C41881() {
        }
    ...
    */
    public void onDraw(android.graphics.Canvas r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.CheckBox.onDraw(android.graphics.Canvas):void");
    }
