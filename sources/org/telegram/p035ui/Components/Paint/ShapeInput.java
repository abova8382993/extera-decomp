...
public class ShapeInput {
    ...
    public ShapeInput(RenderView renderView, Runnable runnable) {
        ...
        this.centerPointStrokePaint.setStrokeWidth(AndroidUtilities.m1036dp(1.0f));
        ...
        this.controlPointStrokePaint.setStrokeWidth(AndroidUtilities.m1036dp(1.0f));
        this.linePaint.setStyle(style);
        this.linePaint.setColor(-1);
        this.linePaint.setStrokeWidth(AndroidUtilities.m1036dp(0.8f));
        this.linePaint.setPathEffect(new DashPathEffect(new float[]{AndroidUtilities.m1036dp(8.0f), AndroidUtilities.m1036dp(8.0f)}, 0.0f));
    ...
    */
    private boolean isInsideShape(float r21, float r22) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.Paint.ShapeInput.isInsideShape(float, float):boolean");
    }
    ...
    public void process(MotionEvent motionEvent, float f) {
        ...
        if (actionMasked != 0) {
            ...
            if (point2 == null) {
                ...
                if (point3 != null) {
                    ...
                    float f5 = f4 - point4.f1593x;
                    float f6 = (fArr3[1] + this.touchOffsetY) - point4.f1594y;
                    for (int i = 0; i < this.movingPoints.size(); i++) {
                        Point point5 = this.movingPoints.get(i);
                        point5.update(point5.f1593x + f5, point5.f1594y + f6);
                    }
                }
            } else {
                if (point2.rotate) {
        ...
        for (int i2 = 0; i2 < this.allPoints.size(); i2++) {
            ...
            if (point7.draw) {
                ...
                float f7 = point7.f1593x;
                float f8 = point7.f1594y;
                float[] fArr6 = this.tempPoint;
                double dDistance = MathUtils.distance(f7, f8, fArr6[0], fArr6[1]);
                if (dDistance < AndroidUtilities.m1036dp(40.0f) && (point == null || dDistance < d)) {
                    point = point7;
                    d = dDistance;
                }
            }
        ...
        if (point != null) {
            ...
            float f9 = point8.f1593x;
            float[] fArr9 = this.tempPoint;
            this.touchOffsetX = f9 - fArr9[0];
            this.touchOffsetY = point8.f1594y - fArr9[1];
            return;
        }
        ...
        if (point9 != null) {
            ...
            float f10 = point10.f1593x;
            float[] fArr10 = this.tempPoint;
            this.touchOffsetX = f10 - fArr10[0];
            this.touchOffsetY = point10.f1594y - fArr10[1];
        }
    }
    ...
    public void start(int i) {
        ...
        shape.radiusX = fMin;
        this.shape.thickness = this.renderView.getCurrentWeight();
        this.shape.rounding = AndroidUtilities.m1036dp(32.0f);
        ...
        if (this.shape.getType() == 4) {
            ...
            C45701 c45701 = new Point() { // from class: org.telegram.ui.Components.Paint.ShapeInput.1
                public C45701() {
                }
            ...
            arrayList.add(c45701);
            ArrayList<Point> arrayList2 = this.allPoints;
            C45712 c45712 = new Point() { // from class: org.telegram.ui.Components.Paint.ShapeInput.2
                final /* synthetic */ Point val$triangleLengthControl;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public C45712(Point c457012) {
                    super();
                    point = c457012;
                }
            ...
            arrayList2.add(c45712);
            this.movingPoints.add(c45712);
            ArrayList<Point> arrayList3 = this.allPoints;
            C45723 c45723 = new Point() { // from class: org.telegram.ui.Components.Paint.ShapeInput.3
                final /* synthetic */ Point val$triangleLengthControl;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public C45723(Point c457012) {
                    super();
                    point = c457012;
                }
            ...
            arrayList3.add(c45723);
            this.movingPoints.add(c45723);
        }
        ...
        if (this.shape.getType() == 3) {
            ...
            C45767 c45767 = new Point() { // from class: org.telegram.ui.Components.Paint.ShapeInput.7
                public C45767() {
                }

                private void limit() {
                    if (this.f1594y > ShapeInput.this.shape.centerY - ShapeInput.this.shape.radiusY && this.f1594y < ShapeInput.this.shape.centerY + ShapeInput.this.shape.radiusY) {
                        if (this.f1593x <= ShapeInput.this.shape.centerX && this.f1593x > ShapeInput.this.shape.centerX - ShapeInput.this.shape.radiusX) {
                            this.f1593x = ShapeInput.this.shape.centerX - ShapeInput.this.shape.radiusX;
                        } else if (this.f1593x > ShapeInput.this.shape.centerY && this.f1593x < ShapeInput.this.shape.centerX + ShapeInput.this.shape.radiusX) {
                            this.f1593x = ShapeInput.this.shape.centerX + ShapeInput.this.shape.radiusX;
                        }
                    }
                    if (this.f1593x <= ShapeInput.this.shape.centerX - ShapeInput.this.shape.radiusX || this.f1593x >= ShapeInput.this.shape.centerX + ShapeInput.this.shape.radiusX) {
                        return;
                    }
                    if (this.f1594y <= ShapeInput.this.shape.centerY && this.f1594y > ShapeInput.this.shape.centerY - ShapeInput.this.shape.radiusY) {
                        this.f1594y = ShapeInput.this.shape.centerY - ShapeInput.this.shape.radiusY;
                    } else {
                        if (this.f1594y <= ShapeInput.this.shape.centerY || this.f1594y >= ShapeInput.this.shape.centerY + ShapeInput.this.shape.radiusY) {
                            return;
                        }
                ...
                public void update(float f7, float f8) {
                    set(f7, f8);
                    limit();
                    ShapeInput.this.shape.middleX = this.f1593x;
                    ShapeInput.this.shape.middleY = this.f1594y;
                }
            ...
            arrayList4.add(c45767);
            c45767.rotate = false;
            this.movingPoints.add(c45767);
        }
        this.center = new Point(true) { // from class: org.telegram.ui.Components.Paint.ShapeInput.8
            public C45778(boolean z) {
                super(z);
            }

            @Override // org.telegram.ui.Components.Paint.ShapeInput.Point
            public void set() {
                this.f1593x = ShapeInput.this.shape.centerX;
                this.f1594y = ShapeInput.this.shape.centerY;
            }
            ...
            public void update(float f7, float f8) {
                int i2 = 0;
                while (true) {
                    int size2 = ShapeInput.this.allPoints.size();
                    ShapeInput shapeInput = ShapeInput.this;
                    if (i2 < size2) {
                        Point point = (Point) shapeInput.allPoints.get(i2);
                        if (point != this) {
                            point.set();
                        }
                        i2++;
                    } else {
                        shapeInput.shape.centerX = f7;
    ...
    public class C45701 extends Point {
        public C45701() {
        }
    ...
    public class C45712 extends Point {
        final /* synthetic */ Point val$triangleLengthControl;
    ...
    public class C45723 extends Point {
        final /* synthetic */ Point val$triangleLengthControl;
    ...
    public class C45734 extends Point {
        public C45734() {
        }
    ...
    public class C45745 extends Point {
    ...
    public class C45756 extends Point {
        public C45756(boolean z) {
            super(z);
        }
    ...
    public class C45767 extends Point {
        public C45767() {
        }
    ...
    public class C45778 extends Point {
        public C45778(boolean z) {
            super(z);
        }
    ...
    private void drawPoint(Canvas canvas, Size size, Point point) {
        canvas.drawCircle((point.f1593x / size.width) * canvas.getWidth(), (point.f1594y / size.height) * canvas.getHeight(), AndroidUtilities.m1036dp(5.0f), point.green ? this.centerPointPaint : this.controlPointPaint);
        canvas.drawCircle((point.f1593x / size.width) * canvas.getWidth(), (point.f1594y / size.height) * canvas.getHeight(), AndroidUtilities.m1036dp(5.0f), point.green ? this.centerPointStrokePaint : this.controlPointStrokePaint);
    }

    public class CornerPoint extends Point {

        /* JADX INFO: renamed from: rx */
        public float f1591rx;

        /* JADX INFO: renamed from: ry */
        public float f1592ry;
        public Shape shape;
        ...
        public CornerPoint(Shape shape, boolean z, boolean z2) {
            ...
            this.rotate = false;
            this.shape = shape;
            this.f1591rx = z ? -1.0f : 1.0f;
            this.f1592ry = z2 ? -1.0f : 1.0f;
            set();
        }
        ...
        public void set() {
            Shape shape = this.shape;
            if (shape != null) {
                ShapeInput.this.rotate(shape.centerX + (this.f1591rx * shape.radiusX), shape.centerY + (this.f1592ry * shape.radiusY), true);
        ...
        public void update(float f, float f2) {
            super.update(f, f2);
            Shape shape = this.shape;
            float f3 = shape.centerX + ((-this.f1591rx) * shape.radiusX);
            float f4 = shape.centerY + ((-this.f1592ry) * shape.radiusY);
