...
public class RenderView extends TextureView {
    ...
    public RenderView(Context context, Painting painting, Bitmap bitmap, Bitmap bitmap2, BlurringShader.BlurManager blurManager) {
        ...
        setSurfaceTextureListener(new TextureViewSurfaceTextureListenerC45671(blurManager));
    ...
    public class TextureViewSurfaceTextureListenerC45671 implements TextureView.SurfaceTextureListener {
        ...
        public TextureViewSurfaceTextureListenerC45671(BlurringShader.BlurManager blurManager) {
    ...
    public class CanvasInternal extends DispatchQueue {
        ...
        public CanvasInternal(SurfaceTexture surfaceTexture, BlurringShader.BlurManager blurManager) {
            ...
            this.drawRunnable = new RunnableC45691();
        ...
        public class RunnableC45691 implements Runnable {
            public RunnableC45691() {
            }
