...
public abstract class ShaderSet {
    ...
    private static Map<String, Map<String, Object>> createMap() {
        ...
        map18.put("uniforms", new String[]{"mvpMatrix", "texture", "mask", "clear", "color", TeXSymbolParser.TYPE_ATTR, "color", "resolution", "center", "radius", "thickness", "rounding", "fill", "rotation", "middle", "arrowTriangleLength", "composite"});
