...
public abstract class EntityView extends FrameLayout {
    ...
    public interface EntityViewDelegate {
        ...
        default void onEntityDragEnd(boolean z) {
        }
        ...
        default void onEntityDragTrash(boolean z) {
        }

        default void onEntityDraggedBottom(boolean z) {
        }

        default void onEntityDraggedTop(boolean z) {
        }
    ...
    public EntityView(Context context, PointF pointF) {
        ...
        this.longPressRunnable = new Runnable() { // from class: org.telegram.ui.Components.Paint.Views.EntityView$$ExternalSyntheticLambda0
        ...
        this.stickyX = 0;
        this.stickyY = 0;
        this.setStickyXRunnable = new Runnable() { // from class: org.telegram.ui.Components.Paint.Views.EntityView$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.updateStickyX();
            }
        };
        this.setStickyYRunnable = new Runnable() { // from class: org.telegram.ui.Components.Paint.Views.EntityView$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.updateStickyY();
            }
        };
        this.f1597xy = new float[2];
    ...
    public boolean onTouchMove(float f, float f2, boolean z, float f3, float f4) {
        ...
        if (entityViewDelegate5 != null) {
            entityViewDelegate5.onEntityDraggedTop(this.position.y - ((((float) getHeight()) / 2.0f) * scaleX) < ((float) AndroidUtilities.m1036dp(66.0f)));
            this.delegate.onEntityDraggedBottom(this.position.y + ((((float) getHeight()) / 2.0f) * scaleX) > ((float) (((View) getParent()).getHeight() - AndroidUtilities.m1036dp(114.0f))));
        }
        EntityViewDelegate entityViewDelegate6 = this.delegate;
        updateTrash((entityViewDelegate6 == null || entityViewDelegate6.isEntityDeletable()) && !z && MathUtils.distance(f5, f6, ((float) ((View) getParent()).getWidth()) / 2.0f, (float) (((View) getParent()).getHeight() - AndroidUtilities.m1036dp(76.0f))) < ((float) AndroidUtilities.m1036dp(32.0f)));
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        this.delegate.getTransformedTouch(motionEvent.getRawX(), motionEvent.getRawY(), this.f1597xy);
        ...
        float[] fArr = this.cxy;
        if (z) {
            float[] fArr2 = this.f1597xy;
            float f = fArr2[0];
            float[] fArr3 = this.xy2;
            fArr[0] = (f + fArr3[0]) / 2.0f;
            fArr[1] = (fArr2[1] + fArr3[1]) / 2.0f;
        } else {
            float[] fArr4 = this.f1597xy;
            fArr[0] = fArr4[0];
            fArr[1] = fArr4[1];
        }
        if (this.lastIsMultitouch != z) {
            float[] fArr5 = this.f1597xy;
            this.previousLocationX = fArr5[0];
            this.previousLocationY = fArr5[1];
            float[] fArr6 = this.xy2;
            this.previousLocationX2 = fArr6[0];
            this.previousLocationY2 = fArr6[1];
            float[] fArr7 = this.cxy;
            this.previousLocationCX = fArr7[0];
            this.previousLocationCY = fArr7[1];
        ...
        if (actionMasked == 0) {
            ...
            float[] fArr9 = entityView.f1597xy;
            entityView.previousLocationX = fArr9[0];
            entityView.previousLocationY = fArr9[1];
            entityView.previousLocationCX = f2;
            entityView.previousLocationCY = f3;
            entityView.hasReleased = false;
            if ((entityView.getParent() instanceof EntitiesContainerView) && (entityView.stickyX != 0 || entityView.stickyY != 0)) {
                ((EntitiesContainerView) entityView.getParent()).invalidate();
            }
            ...
            if (actionMasked != 1) {
                if (actionMasked == 2) {
                    float[] fArr10 = this.f1597xy;
                    float f4 = fArr10[0];
                    float f5 = fArr10[1];
                    float[] fArr11 = this.xy2;
                    entityView = this;
                    zOnTouchMove = entityView.onTouchMove(f4, f5, z, fArr11[0], fArr11[1]);
            ...
            entityView = this;
            entityView.onTouchUp(actionMasked == 3);
    ...
    private void runStickyXAnimator(float... fArr) {
        ...
        this.stickyXAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.Paint.Views.EntityView$$ExternalSyntheticLambda7
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.Paint.Views.EntityView$1 */
    public class C45781 extends AnimatorListenerAdapter {
        public C45781() {
        }
    ...
    private void runStickyYAnimator(float... fArr) {
        ...
        duration.setInterpolator(CubicBezierInterpolator.DEFAULT);
        this.stickyYAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.Paint.Views.EntityView$$ExternalSyntheticLambda8
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.Paint.Views.EntityView$2 */
    public class C45792 extends AnimatorListenerAdapter {
        public C45792() {
        }
    ...
    */
    public void pan(float r10, float r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.Paint.Views.EntityView.pan(float, float):void");
    }
    ...
    public float getPositionX() {
        ...
        if (getParent() != null) {
            ...
            int i = this.stickyX;
            if (i == 1) {
                measuredWidth = AndroidUtilities.m1036dp(8.0f) + (((width() / 2.0f) - getStickyPaddingLeft()) * getScaleX());
            } else if (i == 2) {
                measuredWidth = view.getMeasuredWidth() / 2.0f;
            } else {
                measuredWidth = i == 3 ? (view.getMeasuredWidth() - AndroidUtilities.m1036dp(8.0f)) - (((width() / 2.0f) + getStickyPaddingRight()) * getScaleX()) : f;
            }
            ValueAnimator valueAnimator = this.stickyXAnimator;
            if (valueAnimator != null) {
    ...
    public float getPositionY() {
        ...
        if (getParent() != null) {
            ...
            int i = this.stickyY;
            if (i == 1) {
                measuredHeight = AndroidUtilities.m1036dp(64.0f) + (((height() / 2.0f) - getStickyPaddingTop()) * getScaleY());
            } else if (i == 2) {
                measuredHeight = view.getMeasuredHeight() / 2.0f;
            } else {
                measuredHeight = i == 3 ? (view.getMeasuredHeight() - AndroidUtilities.m1036dp(64.0f)) - (((height() / 2.0f) + getStickyPaddingBottom()) * getScaleY()) : f;
            }
            ValueAnimator valueAnimator = this.stickyYAnimator;
            if (valueAnimator != null) {
    ...
    public void rotate(float f) {
        ...
        if (!z && !this.lastIsMultitouch) {
            ...
            while (true) {
                ...
                if (Math.abs(iIntValue - f) < 4.0f) {
                    if (this.stickyAngleRunnableValue != iIntValue) {
                        ...
                        Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.Components.Paint.Views.EntityView$$ExternalSyntheticLambda3
                            @Override // java.lang.Runnable
                            public final void run() {
            ...
            if (Math.abs(this.currentStickyAngle - f) >= 12.0f || this.lastIsMultitouch) {
                ...
                duration.setInterpolator(CubicBezierInterpolator.DEFAULT);
                this.fromStickyAngleAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.Paint.Views.EntityView$$ExternalSyntheticLambda4
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
    ...
    public /* synthetic */ void lambda$rotate$4(int i) {
        ...
        duration.setInterpolator(CubicBezierInterpolator.DEFAULT);
        this.angleAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.Paint.Views.EntityView$$ExternalSyntheticLambda9
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.Paint.Views.EntityView$3 */
    public class C45803 extends AnimatorListenerAdapter {
        public C45803() {
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.Paint.Views.EntityView$4 */
    public class C45814 extends AnimatorListenerAdapter {
        public C45814() {
        }
    ...
    private void updateSelect(ViewGroup viewGroup, boolean z) {
        if (this.selecting != z) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.Paint.Views.EntityView$$ExternalSyntheticLambda6
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.Paint.Views.EntityView$5 */
    public class C45825 extends AnimatorListenerAdapter {
        public C45825() {
        }
    ...
    public class SelectionView extends FrameLayout {
        ...
        public SelectionView(Context context) {
            ...
            this.paint.setPathEffect(new DashPathEffect(new float[]{AndroidUtilities.m1036dp(10.0f), AndroidUtilities.m1036dp(10.0f)}, 0.5f));
        ...
        public void updatePosition() {
            ...
            layoutParams.leftMargin = (int) selectionBounds.f1660x;
            layoutParams.topMargin = (int) selectionBounds.f1661y;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (getParent() instanceof View) {
            ...
            if (trashCenter()) {
                ...
                float height = (view.getHeight() - AndroidUtilities.m1036dp(76.0f)) - getY();
