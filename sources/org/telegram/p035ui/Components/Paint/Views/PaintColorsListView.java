...
public abstract class PaintColorsListView extends RecyclerListView {
    ...
    public PaintColorsListView(final Context context) {
        ...
        this.outlinePaint.setStrokeWidth(AndroidUtilities.m1036dp(2.0f));
    ...
    public static void drawColorCircle(Canvas canvas, float f, float f2, float f3, int i) {
        ...
        if (colorCirclePaint.getAlpha() != 255) {
            ...
            drawCheckerboard(canvas, rectF, AndroidUtilities.m1036dp(4.0f));
            canvas.restore();
            colorCirclePaint.setColor(i);
            canvas.drawArc(rectF, -45.0f, 180.0f, true, colorCirclePaint);
            return;
    ...
    public final class ColorView extends View {
        ...
        public ColorView(Context context) {
            super(context);
            setPadding(AndroidUtilities.m1036dp(4.0f), AndroidUtilities.m1036dp(4.0f), AndroidUtilities.m1036dp(4.0f), AndroidUtilities.m1036dp(4.0f));
        ...
        public void onDraw(Canvas canvas) {
            ...
            if (this.selectProgress != 0.0f) {
                fMin -= (AndroidUtilities.m1036dp(3.0f) + PaintColorsListView.this.outlinePaint.getStrokeWidth()) * this.selectProgress;
            }
            ...
            if (this.selectProgress != 0.0f) {
                ...
                canvas.drawCircle(width, height, (Math.min((getWidth() - getPaddingLeft()) - getPaddingRight(), (getHeight() - getPaddingTop()) - getPaddingBottom()) / 2.0f) - AndroidUtilities.m1036dp(2.0f), PaintColorsListView.this.outlinePaint);
            }
        }
