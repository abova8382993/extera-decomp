...
public abstract class MessageEntityView extends EntityView {
    ...
    public MessageEntityView(final Context context, PointF pointF, float f, float f2, ArrayList<MessageObject> arrayList, final BlurringShader.BlurManager blurManager, final boolean z, final PreviewView.TextureViewHolder textureViewHolder) {
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.Components.Paint.Views.MessageEntityView.1
            ...
            public void onMeasure(int i4, int i5) {
                ...
                int iMax = 0;
                while (true) {
                    int childCount = MessageEntityView.this.listView.getChildCount();
                    MessageEntityView messageEntityView = MessageEntityView.this;
                    if (i6 < childCount) {
                        View childAt = messageEntityView.listView.getChildAt(i6);
                        ...
                        setMeasuredDimension(iMax - measuredWidth, messageEntityView.listView.getMeasuredHeight());
                        return;
                    }
                }
            }
            ...
            public void onLayout(boolean z2, int i4, int i5, int i6, int i7) {
                ...
                while (true) {
                    int childCount = MessageEntityView.this.listView.getChildCount();
                    messageEntityView = MessageEntityView.this;
                    if (i8 >= childCount) {
                        break;
                    }
                    View childAt = messageEntityView.listView.getChildAt(i8);
                    int left2 = childAt.getLeft();
                    int right = childAt.getRight();
                    if (childAt instanceof ChatMessageCell) {
                        ChatMessageCell chatMessageCell = (ChatMessageCell) childAt;
                ...
                RecyclerListView recyclerListView = messageEntityView.listView;
        ...
        RecyclerListView recyclerListView = new RecyclerListView(context, this.resourcesProvider) { // from class: org.telegram.ui.Components.Paint.Views.MessageEntityView.2
            ...
            */
            private void drawChatForegroundElements(android.graphics.Canvas r18) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.Paint.Views.MessageEntityView.C46122.drawChatForegroundElements(android.graphics.Canvas):void");
            }
            ...
            */
            private void drawChatBackgroundElements(android.graphics.Canvas r26) {
                /*
                    ...
                    To view this dump change 'Code comments level' option to 'DEBUG'
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.Paint.Views.MessageEntityView.C46122.drawChatBackgroundElements(android.graphics.Canvas):void");
            }
            ...
            */
            public boolean drawChild(android.graphics.Canvas r20, android.view.View r21, long r22) {
                /*
                    ...
                    To view this dump change 'Code comments level' option to 'DEBUG'
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.Paint.Views.MessageEntityView.C46122.drawChild(android.graphics.Canvas, android.view.View, long):boolean");
            }
        };
        ...
        recyclerListView.setAdapter(new RecyclerListView.SelectionAdapter() { // from class: org.telegram.ui.Components.Paint.Views.MessageEntityView.3
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i4) {
                if (i4 == 1) {
                    return new RecyclerListView.Holder(new ChatActionCell(context, false, MessageEntityView.this.resourcesProvider) { // from class: org.telegram.ui.Components.Paint.Views.MessageEntityView.3.1
                        ...
                        @Override // org.telegram.p035ui.Cells.ChatActionCell
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i4) {
                ...
                MessageObject messageObject3 = MessageEntityView.this.messageObjects.get((MessageEntityView.this.messageObjects.size() - 1) - i4);
            ...
            public int getItemViewType(int i4) {
                return MessageEntityView.this.messageObjects.get((MessageEntityView.this.messageObjects.size() - 1) - i4).contentType;
            }
    ...
    public float getBubbleBounds(RectF rectF) {
        ...
        for (int i = 0; i < this.listView.getChildCount(); i++) {
            ...
            if (childAt instanceof ChatMessageCell) {
                ...
                if (chatMessageCell.getMessageObject() != null && chatMessageCell.getMessageObject().isRoundVideo() && chatMessageCell.getPhotoImage() != null) {
                    ...
                    float x3 = this.container.getX() + childAt.getX() + chatMessageCell.getBackgroundDrawableLeft() + AndroidUtilities.m1036dp(1.0f);
                    if (this.groupedMessages == null) {
                        x3 += AndroidUtilities.m1036dp(8.0f);
                    }
                    float x4 = ((this.container.getX() + childAt.getX()) + chatMessageCell.getBackgroundDrawableRight()) - AndroidUtilities.m1036dp(1.66f);
                    float y3 = this.container.getY() + childAt.getY() + chatMessageCell.getBackgroundDrawableTop() + AndroidUtilities.m1036dp(2.0f);
                    y = ((this.container.getY() + childAt.getY()) + chatMessageCell.getBackgroundDrawableBottom()) - AndroidUtilities.m1036dp(1.0f);
                    x = x3;
                    x2 = x4;
                    y2 = y3;
                }
        ...
        return AndroidUtilities.m1036dp(SharedConfig.bubbleRadius);
    }
    ...
    */
    public void onMeasure(int r5, int r6) {
        /*
            ...
            if (r0 == 0) goto L8a
            java.util.ArrayList<org.telegram.messenger.MessageObject> r0 = r4.messageObjects
            r1 = 0
            if (r0 == 0) goto L34
            int r0 = r0.size()
            r2 = 1
        ...
        L4e:
            ...
            r4.setScale(r5)
        L6e:
            android.graphics.PointF r0 = r4.getPosition()
            if (r2 != 0) goto L85
            float r2 = r0.x
        ...
        L8a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.Paint.Views.MessageEntityView.onMeasure(int, int):void");
    }
    ...
    public RectOld getSelectionBounds() {
        ...
        return new RectOld(((getPositionX() * scaleX) - (((getMeasuredWidth() * getScale()) / 2.0f) * scaleX)) - AndroidUtilities.m1036dp(35.5f), ((getPositionY() * scaleX) - (((getMeasuredHeight() * getScale()) / 2.0f) * scaleX)) - AndroidUtilities.m1036dp(35.5f), (getMeasuredWidth() * getScale() * scaleX) + AndroidUtilities.m1036dp(71.0f), (getMeasuredHeight() * getScale() * scaleX) + AndroidUtilities.m1036dp(71.0f));
    }
    ...
    public class MessageEntityViewSelectionView extends EntityView.SelectionView {
        ...
        public int pointInsideHandle(float f, float f2) {
            ...
            if (f > f3 - fM1036dp2 && f2 > f5 - fM1036dp2 && f < f3 + fM1036dp2 && f2 < f5 + fM1036dp2) {
                return 1;
            }
            float f6 = f3 + measuredWidth;
            if (f <= f6 - fM1036dp2 || f2 <= f5 - fM1036dp2 || f >= f6 + fM1036dp2 || f2 >= f5 + fM1036dp2) {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void setupTheme(org.telegram.p035ui.Stories.recorder.StoryEntry r8) {
        /*
            Method dump skipped, instruction units count: 208
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.Paint.Views.MessageEntityView.setupTheme(org.telegram.ui.Stories.recorder.StoryEntry):void");
    }
    ...
    public TLRPC.Message copyMessage(TLRPC.Message message) {
        ...
        tL_messageService.f1271id = message.f1271id;
