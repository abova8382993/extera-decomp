...
public abstract class PipettePickerView extends View {
    ...
    public abstract void onStartPipette();

    public abstract void onStopPipette();
    ...
    public PipettePickerView(Context context, Bitmap bitmap) {
        ...
        this.outlinePaint.setStrokeWidth(AndroidUtilities.m1036dp(4.0f));
        ...
        this.colorPaint.setStrokeWidth(AndroidUtilities.m1036dp(12.0f));
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        for (float f5 = -3.5f; f5 < 4.5f; f5 += 1.0f) {
            ...
            this.path.moveTo(f6, height - strokeWidth3);
            this.path.lineTo(f6, height + strokeWidth3);
        }
        while (true) {
            Path path2 = this.path;
            if (f4 < 4.5f) {
                float f7 = (f4 * f3) + height;
                path2.moveTo(width - strokeWidth3, f7);
                ...
                canvas.drawRoundRect(this.dstRect, AndroidUtilities.m1036dp(1.0f), AndroidUtilities.m1036dp(1.0f), this.outlinePaint);
                canvas.restore();
                return;
            }
        }
