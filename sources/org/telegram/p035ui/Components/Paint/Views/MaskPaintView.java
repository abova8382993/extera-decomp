...
public abstract class MaskPaintView extends FrameLayout {
    ...
    public MaskPaintView(Context context, int i, Bitmap bitmap, Bitmap bitmap2, int i2, MediaController.CropState cropState) {
        ...
        this.weightDefaultValueOverride = new PaintWeightChooserView.ValueOverride() { // from class: org.telegram.ui.Components.Paint.Views.MaskPaintView.1
            ...
            public float get() {
                ...
                if (currentBrush == null) {
                    return PersistColorPalette.getInstance(maskPaintView.currentAccount).getCurrentWeight();
                }
                return PersistColorPalette.getInstance(maskPaintView.currentAccount).getWeight("-1", currentBrush.getDefaultWeight());
            }
        ...
        textView.setPadding(AndroidUtilities.m1036dp(28.0f), 0, AndroidUtilities.m1036dp(28.0f), 0);
        textView.setText(LocaleController.getString(C2797R.string.Cancel).toUpperCase());
        ...
        textView2.setPadding(AndroidUtilities.m1036dp(28.0f), 0, AndroidUtilities.m1036dp(28.0f), 0);
        textView2.setText(LocaleController.getString(C2797R.string.Save).toUpperCase());
    ...
    public void init() {
        ...
        this.buttonsLayout.setTranslationY(AndroidUtilities.m1036dp(18.0f));
