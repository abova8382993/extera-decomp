    ...
    public StoryLinkPreviewDialog(Context context, final int i) {
        ...
        LinearLayout linearLayout = new LinearLayout(context) { // from class: org.telegram.ui.Components.Paint.Views.StoryLinkPreviewDialog.2
            ...
            public void onMeasure(int i2, int i3) {
                super.onMeasure(View.MeasureSpec.makeMeasureSpec(Math.min(View.MeasureSpec.getSize(i2), AndroidUtilities.m1036dp(600.0f)), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(Math.min(View.MeasureSpec.getSize(i3), AndroidUtilities.m1036dp(800.0f)), TLObject.FLAG_30));
            }
        };
        ...
        FrameLayout frameLayout2 = new FrameLayout(context) { // from class: org.telegram.ui.Components.Paint.Views.StoryLinkPreviewDialog.3
            ...
            public void onMeasure(int i2, int i3) {
                ...
                this.path.addRoundRect(this.rect, AndroidUtilities.m1036dp(10.0f), AndroidUtilities.m1036dp(10.0f), Path.Direction.CW);
                if (StoryLinkPreviewDialog.this.linkView != null) {
                    StoryLinkPreviewDialog.this.linkView.setMaxWidth(getMeasuredWidth() - AndroidUtilities.m1036dp(32.0f));
                }
            }
        ...
        textView.setText(LocaleController.getString(C2797R.string.StoryLinkPreviewTitle));
        ...
        textView2.setText(LocaleController.getString(C2797R.string.StoryLinkPreviewSubtitle));
        ...
        FrameLayout frameLayout4 = new FrameLayout(context) { // from class: org.telegram.ui.Components.Paint.Views.StoryLinkPreviewDialog.4
            ...
            private final AnimatedFloat f1606x;

            /* JADX INFO: renamed from: y */
            private final AnimatedFloat f1607y;

            {
                CubicBezierInterpolator cubicBezierInterpolator = CubicBezierInterpolator.EASE_OUT_QUINT;
                this.f1606x = new AnimatedFloat(this, 0L, 350L, cubicBezierInterpolator);
                this.f1607y = new AnimatedFloat(this, 0L, 350L, cubicBezierInterpolator);
            }
            ...
            public boolean drawChild(Canvas canvas, View view, long j) {
                if (view == StoryLinkPreviewDialog.this.linkView) {
                    canvas.save();
                    canvas.translate(this.f1606x.set(view.getX()), this.f1607y.set(view.getY()));
        ...
        MessagePreviewView.ToggleButton toggleButton = new MessagePreviewView.ToggleButton(getContext(), C2797R.raw.position_below, LocaleController.getString(C2797R.string.StoryLinkCaptionAbove), C2797R.raw.position_above, LocaleController.getString(C2797R.string.StoryLinkCaptionBelow), darkThemeResourceProvider);
        ...
        MessagePreviewView.ToggleButton toggleButton2 = new MessagePreviewView.ToggleButton(context, C2797R.raw.media_shrink, LocaleController.getString(C2797R.string.LinkMediaLarger), C2797R.raw.media_enlarge, LocaleController.getString(C2797R.string.LinkMediaSmaller), darkThemeResourceProvider);
        ...
        itemOptionsMakeOptions.add(C2797R.drawable.msg_select, LocaleController.getString(C2797R.string.ApplyChanges), new Runnable() { // from class: org.telegram.ui.Components.Paint.Views.StoryLinkPreviewDialog$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.dismiss();
            }
        });
        itemOptionsMakeOptions.add(C2797R.drawable.msg_delete, (CharSequence) LocaleController.getString(C2797R.string.DoNotLinkPreview), true, new Runnable() { // from class: org.telegram.ui.Components.Paint.Views.StoryLinkPreviewDialog$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
