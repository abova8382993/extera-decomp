...
public class LinkPreview extends View {
    ...
    public LinkPreview(Context context, float f) {
        ...
        this.icon = context.getResources().getDrawable(C2797R.drawable.story_link).mutate();
    ...
    public void setupLayout() {
        ...
        if (zWithPreview) {
            boolean zIsEmpty = TextUtils.isEmpty(webPagePreview.name);
            WebPagePreview webPagePreview2 = this.webpage;
            String strFromUrl = zIsEmpty ? fromUrl(webPagePreview2.url) : webPagePreview2.name;
            ...
            this.f1598h += this.density * 7.33f;
            ...
            this.f1599w = Math.max(this.f1599w, Math.min(maxWidth.getCurrentWidth() + (this.density * 20.0f), f5));
            this.f1598h = this.f1598h + this.messageText.getHeight() + (this.density * 7.0f);
            this.hasPhoto = webPage.photo != null || MessageObject.isVideoDocument(webPage.document);
            WebPagePreview webPagePreview3 = this.webpage;
            boolean z = webPagePreview3.largePhoto;
            this.smallPhoto = !z;
            int i5 = (!this.video || (webPagePreview3.flags & 4) == 0) ? ((int) (!z ? 48.0f : (f5 / this.density) - 40.0f)) * 2 : webPagePreview3.photoSize;
            ...
            if (photo != null) {
                ...
                if (closestPhotoSizeWithSize2 != null) {
                    i = closestPhotoSizeWithSize2.f1278w;
                    i2 = closestPhotoSizeWithSize2.f1277h;
                } else {
                    i = 0;
                    i2 = 0;
                }
                ...
                if (document != null) {
                    ...
                    if (closestPhotoSizeWithSize4 != null) {
                        int i6 = closestPhotoSizeWithSize4.f1278w;
                        i2 = closestPhotoSizeWithSize4.f1277h;
                        i = i6;
                    } else {
                        i = 0;
                        i2 = 0;
            ...
            boolean zIsEmpty2 = TextUtils.isEmpty(webPage.site_name);
            this.hasSiteName = !zIsEmpty2;
            if (zIsEmpty2) {
                lineCount = 0;
            } else {
                ...
                float f7 = this.f1599w;
                float currentWidth = maxWidth2.getCurrentWidth();
                float f8 = this.density;
                this.f1599w = Math.max(f7, Math.min(currentWidth + (f8 * f2) + ((this.hasPhoto && this.smallPhoto) ? f8 * 60.0f : 0.0f), f5));
            ...
            boolean zIsEmpty3 = TextUtils.isEmpty(webPage.title);
            this.hasTitle = !zIsEmpty3;
            if (zIsEmpty3) {
                f4 = 2.66f;
            } else {
                ...
                float f10 = this.f1599w;
                float currentWidth2 = maxWidth3.getCurrentWidth();
                float f11 = this.density;
                this.f1599w = Math.max(f10, Math.min(currentWidth2 + (f11 * f2) + ((this.hasPhoto && this.smallPhoto) ? f11 * 60.0f : 0.0f), f5));
                this.previewHeight = this.previewHeight + this.titleText.getHeight() + (this.density * 2.66f);
                lineCount += this.titleText.getLineCount();
            }
            boolean zIsEmpty4 = TextUtils.isEmpty(webPage.description);
            this.hasDescription = !zIsEmpty4;
            if (!zIsEmpty4) {
                ...
                this.f1599w = Math.max(this.f1599w, Math.min(this.descriptionLayoutWidth + (this.density * f2), f5));
            ...
            if (this.hasPhoto && !this.smallPhoto) {
                if (i <= 0 || i2 <= 0) {
                    ...
                    this.photoHeight = Math.min((Math.max(0.0f, this.f1599w - (this.density * f2)) / i) * i2, this.density * 200.0f);
                }
            ...
            this.f1598h = this.f1598h + f14 + (f13 * 11.0f);
        } else {
            boolean zIsEmpty5 = TextUtils.isEmpty(webPagePreview.name);
            WebPagePreview webPagePreview4 = this.webpage;
            String upperCase = zIsEmpty5 ? fromUrlWithoutSchema(webPagePreview4.url).toUpperCase() : webPagePreview4.name;
            ...
            this.f1599w = (f17 * f18) + (this.layoutWidth * this.textScale);
            this.f1598h = ((rectF2.top + rectF2.bottom) * f18) + Math.max(f18 * 30.0f, this.layout.getHeight() * this.textScale);
        }
        if (!this.animated) {
    ...
    public void drawInternal(Canvas canvas) {
        ...
        setupLayout();
        float f5 = this.width.set(this.f1599w);
        float f6 = this.height.set(this.f1598h);
    ...
    public void onMeasure(int i, int i2) {
        setupLayout();
        setMeasuredDimension(this.padx + ((int) Math.ceil(this.f1599w)) + this.padx, this.pady + ((int) Math.ceil(this.f1598h)) + this.pady);
    }
    ...
    public static class WebPagePreview extends TLObject {
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            int i = this.flags;
            this.flags = webPage != null ? i | 1 : i & (-2);
            boolean zIsEmpty = TextUtils.isEmpty(this.name);
            int i2 = this.flags;
            int i3 = !zIsEmpty ? i2 | 2 : i2 & (-3);
            this.flags = i3;
            int i4 = this.largePhoto ? i3 | 8 : i3 & (-9);
            this.flags = i4;
            int i5 = this.captionAbove ? i4 | 16 : i4 & (-17);
            this.flags = i5;
