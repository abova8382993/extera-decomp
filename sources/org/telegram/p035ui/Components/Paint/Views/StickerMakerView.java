...
import org.telegram.p035ui.Components.Paint.ObjectDetectionEmojis;
...
public class StickerMakerView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public StickerMakerView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        paint.setPathEffect(new DashPathEffect(new float[]{AndroidUtilities.m1036dp(5.0f), AndroidUtilities.m1036dp(10.0f)}, 0.5f));
        ...
        paint3.setColor(-1);
        paint3.setStrokeWidth(AndroidUtilities.m1036dp(3.0f));
        paint3.setStyle(style);
        paint3.setStrokeCap(cap);
        paint3.setPathEffect(new CornerPathEffect(AndroidUtilities.m1036dp(20.0f)));
        float fM1036dp = AndroidUtilities.m1036dp(4.0f);
        BlurMaskFilter.Blur blur = BlurMaskFilter.Blur.NORMAL;
        paint3.setMaskFilter(new BlurMaskFilter(fM1036dp, blur));
        paint4.setColor(-1);
        paint4.setStrokeWidth(AndroidUtilities.m1036dp(3.0f));
        paint4.setStyle(style);
        paint4.setStrokeCap(cap);
        paint4.setPathEffect(new CornerPathEffect(AndroidUtilities.m1036dp(20.0f)));
        paint4.setMaskFilter(new BlurMaskFilter(AndroidUtilities.m1036dp(4.0f), blur));
        ...
        this.weightChooserView.setTranslationX(-AndroidUtilities.m1036dp(18.0f));
    ...
    public class SegmentedObject {
        ...
        public void initPoints() {
            ...
            int iCeil = (int) Math.ceil(length / AndroidUtilities.m1036dp(2.0f));
            ...
            while (true) {
                ...
                if (i < i2) {
                    ...
                    this.bordersFillPaint.setPathEffect(new CornerPathEffect(AndroidUtilities.m1036dp(10.0f)));
                    ...
                    this.bordersStrokePaint.setPathEffect(new CornerPathEffect(AndroidUtilities.m1036dp(10.0f)));
                    this.pointsPaint.setStyle(style);
                    this.pointsPaint.setStrokeWidth(AndroidUtilities.m1036dp(4.0f));
                    this.pointsPaint.setColor(-1);
                    this.pointsPaint.setStrokeCap(cap);
                    Paint paint4 = this.pointsPaint;
                    float fM1036dp = AndroidUtilities.m1036dp(0.33f);
                    BlurMaskFilter.Blur blur = BlurMaskFilter.Blur.NORMAL;
                    paint4.setMaskFilter(new BlurMaskFilter(fM1036dp, blur));
                    ...
                    this.pointsHighlightPaint.setStrokeWidth(AndroidUtilities.m1036dp(20.0f));
                    this.pointsHighlightPaint.setColor(Theme.multAlpha(-1, 0.04f));
                    this.pointsHighlightPaint.setMaskFilter(new BlurMaskFilter(AndroidUtilities.m1036dp(60.0f), blur));
                    return;
                }
            }
        }
        ...
        public void drawOutline(Canvas canvas, boolean z, float f, float f2) {
            ...
            if (StickerMakerView.this.sourceBitmap != null) {
                ...
                paint.setStrokeWidth(AndroidUtilities.m1036dp(f));
                ...
                if (StickerMakerView.this.outlineBoundsPath != null && z) {
                    ...
                    paint.setStrokeWidth(AndroidUtilities.m1036dp(f * 2.0f));
        ...
        public void drawAnimationBorders(Canvas canvas, float f, float f2, View view) {
            ...
            int i = (this.orientation / 90) % 2;
            StickerMakerView stickerMakerView = StickerMakerView.this;
            if (i != 0) {
                width = stickerMakerView.sourceBitmap.getHeight();
                height = StickerMakerView.this.sourceBitmap.getWidth();
            } else {
                width = stickerMakerView.sourceBitmap.getWidth();
            ...
            if (this.points != null) {
                int i2 = this.pointsCount;
                int i3 = (int) (i2 * f);
                int iMin = Math.min(500, (int) (i2 * 0.6f)) + i3;
                if (this.pointsCount > 0) {
                    while (i3 <= iMin) {
                        float f8 = 1.0f - ((iMin - i3) / this.pointsCount);
                        if (f8 > 0.0f) {
                            this.pointsHighlightPaint.setAlpha((int) (f8 * 10.2f * f2));
                            canvas.drawPoints(this.points, (i3 % this.pointsCount) * 2, 2, this.pointsHighlightPaint);
                        }
                        i3++;
                    }
                }
            ...
            if (this.points != null) {
                ...
                int i5 = (int) (i4 * f);
                int iMin2 = Math.min(500, (int) (i4 * 0.6f)) + i5;
                if (this.pointsCount > 0) {
                    for (int i6 = i5; i6 <= iMin2; i6++) {
                        float f9 = (i6 - i5) / (iMin2 - i5);
                        this.pointsPaint.setAlpha((int) (Math.min(1.0f, Math.min(f9, 1.0f - f9) * 4.0f) * 255.0f * f2));
                        canvas.drawPoints(this.points, (i6 % this.pointsCount) * 2, 2, this.pointsPaint);
                    }
                }
            } else {
    ...
    public void setOutlineVisible(boolean z) {
        ...
        this.weightChooserView.animate().alpha(z ? 1.0f : 0.0f).translationX(z ? 0.0f : AndroidUtilities.m1036dp(-18.0f)).setInterpolator(CubicBezierInterpolator.EASE_OUT_QUINT).setDuration(320L).start();
        if (getParent() instanceof View) {
            ((View) getParent()).invalidate();
        }
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            if (this.outlineVisible) {
                ...
                this.exclusionRect.set(0, (getMeasuredHeight() - measuredHeight) / 2, AndroidUtilities.m1036dp(20.0f), (getMeasuredHeight() + measuredHeight) / 2);
            }
    ...
    public void updateOutlineBounds(boolean z) {
        ...
        if (z) {
            ...
            Path path2 = this.outlineBoundsInnerPath;
            if (path2 == null) {
            ...
            float stickerCornerRadius = getStickerCornerRadius(1.0f);
            this.outlineBoundsInnerPath.addRoundRect(rectF, stickerCornerRadius, stickerCornerRadius, Path.Direction.CW);
    ...
    public void enableClippingMode(final Utilities.Callback<SegmentedObject> callback) {
        ...
        this.actionTextView.setText(LocaleController.getString(C2797R.string.SegmentationTabToCrop));
    ...
    public /* synthetic */ void lambda$enableClippingMode$1(Utilities.Callback callback, View view) {
        ...
        SegmentedObject[] segmentedObjectArr = this.objects;
        if (segmentedObjectArr == null || segmentedObjectArr.length == 0 || this.sourceBitmap == null || (segmentedObjectObjectBehind = objectBehind(this.f1604tx, this.f1605ty)) == null) {
            return;
        }
    ...
    */
    public boolean dispatchTouchEvent(android.view.MotionEvent r6) {
        ...
        L5c:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.Paint.Views.StickerMakerView.dispatchTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public SegmentedObject objectBehind(float f, float f2) {
        ...
        while (true) {
            ...
            if (segmentedObject != null) {
                int i2 = (segmentedObject.orientation / 90) % 2;
    ...
    public void onMeasure(int i, int i2) {
        ...
        this.actionTextView.setTranslationY(-((getMeasuredWidth() / 2.0f) + AndroidUtilities.m1036dp(10.0f)));
        if (Build.VERSION.SDK_INT >= 29) {
            this.exclusionRects.clear();
            if (this.outlineVisible) {
                this.exclusionRects.add(this.exclusionRect);
    ...
    private void updateStickerAreaPath() {
        ...
        float stickerCornerRadius = getStickerCornerRadius(measuredWidth);
        RectF rectF = AndroidUtilities.rectTmp;
        float f2 = measuredWidth + fM1036dp;
        rectF.set(fM1036dp, fM1036dp, f2, f2);
        rectF.offset(0.0f, (measuredHeight - rectF.height()) / 2.0f);
        this.areaPath.rewind();
        Path path = this.areaPath;
        Path.Direction direction = Path.Direction.CW;
        path.addRoundRect(rectF, stickerCornerRadius, stickerCornerRadius, direction);
        this.bgPath.rewind();
        ...
        this.dashPath.addRoundRect(rectF, stickerCornerRadius, stickerCornerRadius, direction);
    }
    ...
    public /* synthetic */ void lambda$segmentImage$5(int i, List list, final ArrayList arrayList, final Utilities.Callback callback) {
        ...
        Bitmap bitmap = this.sourceBitmap;
        if (i2 != 0) {
            matrix.postScale(bitmap.getHeight(), this.sourceBitmap.getWidth());
        } else {
            matrix.postScale(bitmap.getWidth(), this.sourceBitmap.getHeight());
        }
        if (list.isEmpty()) {
            ...
            if (bitmapCreateSmoothEdgesSegmentedImage == null) {
                FileLog.m1048e(new RuntimeException("createSmoothEdgesSegmentedImage failed on empty image"));
                return;
            }
        ...
        for (int i3 = 0; i3 < list.size(); i3++) {
            SubjectMock subjectMock = (SubjectMock) list.get(i3);
    ...
    public static class SubjectMock {
        ...
        public static SubjectMock m1156of(Subject subject) {
    ...
    public static /* synthetic */ void $r8$lambda$N34q7RjOP0nAX0Rvuf8jtIHGY0g(Utilities.Callback callback, SubjectSegmentationResult subjectSegmentationResult) {
        ...
        for (int i = 0; i < subjectSegmentationResult.getSubjects().size(); i++) {
            arrayList.add(SubjectMock.m1156of(subjectSegmentationResult.getSubjects().get(i)));
        }
        callback.run(arrayList);
    }
    ...
    public /* synthetic */ void lambda$segment$10(List list) {
        if (list.size() <= 0) {
            FileLog.m1045d("objimg: no objects");
            return;
        }
        this.detectedEmoji = ObjectDetectionEmojis.labelToEmoji(((ImageLabel) list.get(0)).getIndex());
        FileLog.m1045d("objimg: detected #" + ((ImageLabel) list.get(0)).getIndex() + " " + this.detectedEmoji + " " + ((ImageLabel) list.get(0)).getText());
    ...
    private void createSegmentImagePath(SegmentedObject segmentedObject, int i, int i2) {
        ...
        List<Point> listRemoveUnnecessaryPoints = removeUnnecessaryPoints(new ArrayList(linkedHashSet));
        List<Point> listRemoveUnnecessaryPoints2 = removeUnnecessaryPoints(new ArrayList(linkedHashSet2));
        Path path = new Path();
        for (int i8 = 0; i8 < listRemoveUnnecessaryPoints2.size(); i8 += 2) {
            Point point5 = listRemoveUnnecessaryPoints2.get(i8);
            if (path.isEmpty()) {
        ...
        for (int i9 = 0; i9 < listRemoveUnnecessaryPoints.size(); i9 += 2) {
            Point point6 = listRemoveUnnecessaryPoints.get(i9);
            if (path2.isEmpty()) {
    ...
    private void showLoadingDialog() {
        if (this.loadingToast == null) {
            this.loadingToast = new DownloadButton.PreparingVideoToast(getContext(), LocaleController.getString(C2797R.string.PreparingSticker));
        }
    ...
    private void showError(TLRPC.TL_error tL_error) {
        ...
        BulletinFactory.m1142of((FrameLayout) getParent(), this.resourcesProvider).createErrorBulletin(tL_error.text).show();
    }
