...
public class ReactionWidgetEntityView extends EntityView {
    ...
    @Override // org.telegram.p035ui.Components.Paint.Views.EntityView, android.view.ViewGroup, android.view.View
    ...
    public int getPadding() {
        return (int) ((this.baseSize.height - AndroidUtilities.m1036dp(84.0f)) / 2.0f);
    }
    ...
    public void mirror(boolean z) {
        ...
        valueAnimatorOfFloat.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.Paint.Views.ReactionWidgetEntityView.1
            ...
            public C46231(final boolean[] zArr2) {
                zArr = zArr2;
            }
    ...
    public class C46231 extends AnimatorListenerAdapter {
        final /* synthetic */ boolean[] val$mirrored;
    ...
    public void changeStyle(boolean z) {
        ...
        if (!z) {
            ...
            this.outBackground = storyReactionWidgetBackground;
            this.storyReactionWidgetBackground = new StoryReactionWidgetBackground(this);
