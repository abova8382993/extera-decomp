...
public class EditTextOutline extends EditTextBoldCursor {
    ...
    public EditTextOutline(Context context) {
        ...
        setFrameRoundRadius(AndroidUtilities.m1036dp(16.0f));
    ...
    public void setFrameColor(int i) {
        ...
        if (i2 == 0 && i != 0) {
            setPadding(AndroidUtilities.m1036dp(19.0f), AndroidUtilities.m1036dp(7.0f), AndroidUtilities.m1036dp(19.0f), AndroidUtilities.m1036dp(7.0f));
            setCursorColor(-1);
        } else if (i2 != 0 && i == 0) {
            setPadding(AndroidUtilities.m1036dp(7.0f), AndroidUtilities.m1036dp(7.0f), AndroidUtilities.m1036dp(7.0f), AndroidUtilities.m1036dp(7.0f));
            setCursorColor(-1);
        }
        this.mFrameColor = i;
        if (i != 0) {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.mFrameColor != 0) {
            ...
            while (true) {
                ...
                if (rectF8.width() >= AndroidUtilities.m1036dp(1.0f) && rectF9.width() >= AndroidUtilities.m1036dp(1.0f)) {
                    ...
                    if (z) {
                        for (int i6 = i5; i6 >= 1; i6--) {
                            ...
                            if (rectF10.width() >= AndroidUtilities.m1036dp(1.0f) && rectF11.width() >= AndroidUtilities.m1036dp(1.0f)) {
