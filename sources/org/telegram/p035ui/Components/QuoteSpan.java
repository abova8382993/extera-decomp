...
public class QuoteSpan implements LeadingMarginSpan {
    ...
    public QuoteSpan(boolean z, boolean z2, QuoteStyleSpan quoteStyleSpan) {
        ...
        this.quoteDrawable = ApplicationLoader.applicationContext.getResources().getDrawable(C2797R.drawable.mini_quote).mutate();
    ...
    public int getLeadingMargin(boolean z) {
        return AndroidUtilities.m1036dp(this.adaptLineHeight ? 8.0f : 10.0f);
    }
    ...
    public static class QuoteStyleSpan extends MetricAffectingSpan implements LineHeightSpan {
        ...
        public void updateDrawState(TextPaint textPaint) {
            ...
            textPaint.setTextSize(AndroidUtilities.m1036dp(this.span.edit ? 16.0f : SharedConfig.fontSize - 2));
        }
        ...
        public void chooseHeight(CharSequence charSequence, int i, int i2, int i3, int i4, Paint.FontMetricsInt fontMetricsInt) {
            ...
            if (quoteSpan.adaptLineHeight) {
                ...
                if (i <= quoteSpan.start) {
                    fontMetricsInt.ascent -= AndroidUtilities.m1036dp((quoteSpan.last ? 2 : 0) + i5);
                    fontMetricsInt.top -= AndroidUtilities.m1036dp((this.span.last ? 2 : 0) + i5);
                }
                if (i2 >= this.span.end) {
                    float f = i5;
                    fontMetricsInt.descent += AndroidUtilities.m1036dp(f);
                    fontMetricsInt.bottom += AndroidUtilities.m1036dp(f);
                }
            }
        }
    }
    ...
    */
    public static java.util.ArrayList<org.telegram.ui.Components.QuoteSpan.Block> updateQuoteBlocks(android.view.View r17, android.text.Layout r18, java.util.ArrayList<org.telegram.ui.Components.QuoteSpan.Block> r19, boolean[] r20) {
        /*
            Method dump skipped, instruction units count: 499
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.QuoteSpan.updateQuoteBlocks(android.view.View, android.text.Layout, java.util.ArrayList, boolean[]):java.util.ArrayList");
    }
    ...
    public static class Block {
        ...
        public Block(View view, Layout layout, Spanned spanned, QuoteSpan quoteSpan) {
            ...
            if (quoteSpan.edit) {
                ...
                this.top = lineTop + AndroidUtilities.m1036dp(3 - i);
                ...
                this.bottom = lineBottom - AndroidUtilities.m1036dp(2 - i2);
            } else {
                this.top = layout.getLineTop(lineForOffset) + AndroidUtilities.m1036dp(3 - (quoteSpan.singleLine ? 1 : 2));
                this.bottom = layout.getLineBottom(lineForOffset2) - AndroidUtilities.m1036dp(2 - (quoteSpan.singleLine ? 1 : 2));
            }
            quoteSpan.rtl = false;
            float fMax = 0.0f;
            ...
            if (quoteSpan.expandText == null) {
                ...
                quoteSpan.expandText.setTextSize(AndroidUtilities.m1036dp(11.0f));
                ...
                animatedTextDrawable.setText(LocaleController.getString(C2797R.string.QuoteCollapse), false);
                quoteSpan.expandTextWidth = (int) Math.ceil(Math.max(quoteSpan.expandText.getPaint().measureText(LocaleController.getString(C2797R.string.QuoteExpand)), quoteSpan.expandText.getPaint().measureText(LocaleController.getString(C2797R.string.QuoteCollapse))));
            }
        ...
        */
        ...
        public int buttonWidth() {
            return AndroidUtilities.m1036dp(23.66f) + this.span.expandTextWidth + (AndroidUtilities.m1036dp(3.333f) * 2);
        }
    ...
    public static boolean onTouch(MotionEvent motionEvent, int i, ArrayList<Block> arrayList, Runnable runnable) {
        ...
        while (i2 < size) {
            ...
            if (motionEvent.getAction() == 0) {
                ...
                QuoteSpan quoteSpan2 = block2.span;
                ...
                QuoteSpan quoteSpan3 = block2.span;
                ...
                QuoteSpan quoteSpan4 = block2.span;
