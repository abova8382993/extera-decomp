...
public class FabBackgroundDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        float f = iMin / 2;
        canvas.drawCircle(f, f, r0 - AndroidUtilities.m1036dp(4.0f), this.bgPaint);
    }
    ...
    public void onBoundsChange(Rect rect) {
        ...
        float f = iMin / 2;
        new Canvas(this.shadowBitmap).drawCircle(f, f, r4 - AndroidUtilities.m1036dp(4.0f), new Paint(1));
    }
    ...
    public boolean getPadding(Rect rect) {
        ...
        rect.set(iM1036dp, iM1036dp, iM1036dp, iM1036dp);
        return true;
    }
}
