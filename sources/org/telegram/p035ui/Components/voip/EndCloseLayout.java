...
public class EndCloseLayout extends FrameLayout {
    ...
    public void switchToClose(final View.OnClickListener onClickListener, boolean z) {
        ...
        endCloseView.round = AndroidUtilities.m1036dp(8.0f);
    ...
    public static class EndCloseView extends View {
        ...
        public EndCloseView(Context context) {
            ...
            this.round = AndroidUtilities.m1036dp(26.0f);
            this.callDeclineAlpha = 255;
            this.closeTextAlpha = 0;
            Drawable drawableMutate = ContextCompat.getDrawable(getContext(), C2797R.drawable.calls_decline).mutate();
            ...
            paint2.setTextSize(AndroidUtilities.m1036dp(18.0f));
            paint2.setTypeface(AndroidUtilities.bold());
            paint2.setTextAlign(align);
            paint2.setColor(-16777216);
            setLayerType(2, null);
            setClickable(true);
            this.closeText = LocaleController.getString(C2797R.string.Close);
        }
        ...
        public void onDraw(Canvas canvas) {
            ...
            canvas.drawText(this.closeText, width, AndroidUtilities.m1036dp(6.0f) + height, this.textPaintMask);
            canvas.drawText(this.closeText, width, height + AndroidUtilities.m1036dp(6.0f), this.textPaint);
