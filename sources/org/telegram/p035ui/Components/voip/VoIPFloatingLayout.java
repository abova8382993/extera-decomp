...
public class VoIPFloatingLayout extends FrameLayout {
    ...
    public VoIPFloatingLayout(Context context) {
        ...
        setOutlineProvider(new ViewOutlineProvider() { // from class: org.telegram.ui.Components.voip.VoIPFloatingLayout.2
            ...
            public void getOutline(View view, Outline outline) {
                ...
                VoIPFloatingLayout voIPFloatingLayout = VoIPFloatingLayout.this;
                if (f >= 0.0f) {
                    if (voIPFloatingLayout.overrideCornerRadius < 1.0f) {
                ...
                if (!voIPFloatingLayout.floatingMode) {
                    ...
                    outline.setRoundRect(0, 0, view.getMeasuredWidth(), view.getMeasuredHeight(), VoIPFloatingLayout.this.floatingMode ? AndroidUtilities.m1036dp(4.0f) : 0.0f);
                }
            }
        });
        setClipToOutline(true);
        this.mutedPaint.setColor(ColorUtils.setAlphaComponent(-16777216, 102));
        this.mutedDrawable = ContextCompat.getDrawable(context, C2797R.drawable.calls_mute_mini);
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (getMeasuredHeight() != this.lastH && getMeasuredWidth() != this.lastW) {
            ...
            this.path.addRoundRect(this.rectF, AndroidUtilities.m1036dp(4.0f), AndroidUtilities.m1036dp(4.0f), Path.Direction.CW);
    ...
    private void updatePadding() {
        ...
        this.topPadding = this.uiVisible ? AndroidUtilities.m1036dp(60.0f) : AndroidUtilities.m1036dp(16.0f);
        this.bottomPadding = AndroidUtilities.m1036dp(this.uiVisible ? 100.0f : 16.0f) + this.bottomOffset;
    }
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.voip.VoIPFloatingLayout.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (!voIPFloatingLayout.switchingToFloatingMode) {
            ...
            if (z != z2) {
                voIPFloatingLayout.setFloatingMode(z2, true);
            }
        }
        int measuredWidth = voIPFloatingLayout.getMeasuredWidth() >> 1;
        int measuredHeight = voIPFloatingLayout.getMeasuredHeight() - ((int) ((AndroidUtilities.m1036dp(18.0f) * 1.0f) / voIPFloatingLayout.getScaleY()));
        canvas.save();
        float f = measuredWidth;
        float f2 = measuredHeight;
        canvas.scale((1.0f / voIPFloatingLayout.getScaleX()) * voIPFloatingLayout.toFloatingModeProgress * voIPFloatingLayout.mutedProgress, (1.0f / voIPFloatingLayout.getScaleY()) * voIPFloatingLayout.toFloatingModeProgress * voIPFloatingLayout.mutedProgress, f, f2);
        canvas.drawCircle(f, f2, AndroidUtilities.m1036dp(14.0f), voIPFloatingLayout.mutedPaint);
    ...
    public void setFloatingMode(boolean z, boolean z2) {
        ...
        if (z && !this.floatingMode) {
            ...
            final float translationX = voIPFloatingLayout.getTranslationX();
            final float translationY = voIPFloatingLayout.getTranslationY();
            voIPFloatingLayout.setTranslationX(0.0f);
            voIPFloatingLayout.setTranslationY(0.0f);
            voIPFloatingLayout.invalidate();
            ...
            ViewPropertyAnimator duration = voIPFloatingLayout.animate().scaleX(0.23f).scaleY(0.23f).translationX(translationX - ((voIPFloatingLayout.getMeasuredWidth() - (voIPFloatingLayout.getMeasuredWidth() * 0.23f)) / 2.0f)).translationY(translationY - ((voIPFloatingLayout.getMeasuredHeight() - (voIPFloatingLayout.getMeasuredHeight() * 0.23f)) / 2.0f)).alpha(1.0f).setStartDelay(0L).setDuration(300L);
