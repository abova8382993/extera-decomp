...
public class VoIpSwitchLayout extends FrameLayout {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.voip.VoIpSwitchLayout$4 */
    public static /* synthetic */ class C54514 {
    ...
    private void setText(Type type, boolean z) {
        final String string;
        int i = C54514.$SwitchMap$org$telegram$ui$Components$voip$VoIpSwitchLayout$Type[type.ordinal()];
        if (i != 1) {
            if (i == 2) {
                string = LocaleController.getString(C2797R.string.VoipFlip);
            } else if (i != 3) {
                if (i == 4) {
                    string = LocaleController.getString(C2797R.string.VoipAudioRoutingBluetooth);
                } else if (i == 5) {
                    string = LocaleController.getString(C2797R.string.VoipSpeaker);
                } else {
                    string = _UrlKt.FRAGMENT_ENCODE_SET;
                }
            } else if (z) {
                string = LocaleController.getString(C2797R.string.VoipStartVideo);
            } else {
                string = LocaleController.getString(C2797R.string.VoipStopVideo);
            }
        } else if (z) {
            string = LocaleController.getString(C2797R.string.VoipUnmute);
        } else {
            string = LocaleController.getString(C2797R.string.VoipMute);
        }
        ...
        if (this.currentTextView.getVisibility() == 8 && this.newTextView.getVisibility() == 8) {
            ...
            this.currentTextView.animate().alpha(0.0f).translationY(-AndroidUtilities.m1036dp(4.0f)).setDuration(140L).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.voip.VoIpSwitchLayout.1
            ...
            this.newTextView.setTranslationY(AndroidUtilities.m1036dp(5.0f));
    ...
    private void attachNewButton(int i, int i2, boolean z, Type type) {
        ...
        if (i == C2797R.raw.camera_flip2) {
            voIpButtonView.singleIcon = new RLottieDrawable(i, _UrlKt.FRAGMENT_ENCODE_SET + i, i2, i2, true, null);
            voIpButtonView.singleIcon.setMasterParent(voIpButtonView);
        } else {
            voIpButtonView.unSelectedIcon = new RLottieDrawable(i, _UrlKt.FRAGMENT_ENCODE_SET + i, i2, i2, true, null);
            voIpButtonView.selectedIcon = new RLottieDrawable(i, _UrlKt.FRAGMENT_ENCODE_SET + i, i2, i2, true, null);
    ...
    */
    public void setType(org.telegram.ui.Components.voip.VoIpSwitchLayout.Type r13, boolean r14, boolean r15) {
        /*
            Method dump skipped, instruction units count: 467
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.voip.VoIpSwitchLayout.setType(org.telegram.ui.Components.voip.VoIpSwitchLayout$Type, boolean, boolean):void");
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: attachSpeakerToBt, reason: merged with bridge method [inline-methods] */
    public void lambda$setType$0(int i) {
        this.voIpButtonView.unSelectedIcon = new RLottieDrawable(C2797R.raw.speaker_to_bt, _UrlKt.FRAGMENT_ENCODE_SET + C2797R.raw.speaker_to_bt, i, i, true, null);
        this.voIpButtonView.selectedIcon = new RLottieDrawable(C2797R.raw.speaker_to_bt, _UrlKt.FRAGMENT_ENCODE_SET + C2797R.raw.speaker_to_bt, i, i, true, null);
        this.voIpButtonView.selectedIcon.setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.MULTIPLY));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: attachBtToSpeaker, reason: merged with bridge method [inline-methods] */
    public void lambda$setType$2(int i) {
        this.voIpButtonView.unSelectedIcon = new RLottieDrawable(C2797R.raw.bt_to_speaker, _UrlKt.FRAGMENT_ENCODE_SET + C2797R.raw.bt_to_speaker, i, i, true, null);
        this.voIpButtonView.selectedIcon = new RLottieDrawable(C2797R.raw.bt_to_speaker, _UrlKt.FRAGMENT_ENCODE_SET + C2797R.raw.bt_to_speaker, i, i, true, null);
        this.voIpButtonView.selectedIcon.setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.MULTIPLY));
    }
    ...
    public static class VoIpButtonView extends View {
        ...
        public void setSelectedState(boolean z, boolean z2, Type type) {
            ...
            if (z2) {
                ...
                if (rLottieDrawable != null) {
                    ...
                    if (z) {
                        ...
                        valueAnimatorOfInt2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.voip.VoIpSwitchLayout$VoIpButtonView$$ExternalSyntheticLambda2
                            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                            public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                                this.f$0.lambda$setSelectedState$1(valueAnimator3);
                            }
                        });
                        ...
                        valueAnimatorOfInt2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.voip.VoIpSwitchLayout$VoIpButtonView$$ExternalSyntheticLambda3
                            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                            public final void onAnimationUpdate(ValueAnimator valueAnimator3) {
                                this.f$0.lambda$setSelectedState$2(valueAnimator3);
                            }
                        });
                        this.animator.setDuration(200L);
                ...
                if (type == Type.VIDEO || type == Type.MICRO) {
                    this.selectedIcon.setCurrentFrame(r8.getFramesCount() - 1, false);
                }
            } else {
        ...
        public VoIpButtonView(Context context, VoIPBackgroundProvider voIPBackgroundProvider) {
            ...
            int iM1036dp = AndroidUtilities.m1036dp(26.0f);
            this.maxRadius = iM1036dp;
            this.unselectedRadius = iM1036dp;
            this.selectedRadius = 0;
        ...
        private boolean isClick(float f, float f2, float f3, float f4) {
            return Math.abs(f - f2) <= ((float) AndroidUtilities.m1036dp(48.0f)) && Math.abs(f3 - f4) <= ((float) AndroidUtilities.m1036dp(48.0f));
        }
    }
}
