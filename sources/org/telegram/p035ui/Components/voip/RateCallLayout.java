...
public class RateCallLayout extends FrameLayout {
    ...
    public /* synthetic */ void lambda$new$3(Context context, float f, float f2, int i) {
        if (i >= 4) {
            ...
            int iM1036dp = AndroidUtilities.m1036dp(133.0f);
            rLottieImageView.setAnimation(C2797R.raw.rate, 133, 133);
            int[] iArr = new int[2];
    ...
    public void show(OnRateSelected onRateSelected) {
        ...
        animatorSet.playTogether(objectAnimatorOfFloat, objectAnimatorOfFloat2, ObjectAnimator.ofFloat(this.rateCallContainer, (Property<RateCallContainer, Float>) property3, 0.7f, 1.0f), ObjectAnimator.ofFloat(this.rateCallContainer, (Property<RateCallContainer, Float>) property4, AndroidUtilities.m1036dp(24.0f), 0.0f));
        ...
        while (i < this.startsViews.length) {
            ...
            char c4 = c3;
            ObjectAnimator objectAnimatorOfFloat3 = ObjectAnimator.ofFloat(this.startsViews[i], (Property<StarContainer, Float>) property, 0.0f, 1.0f);
            char c5 = c2;
            ObjectAnimator objectAnimatorOfFloat4 = ObjectAnimator.ofFloat(this.startsViews[i], (Property<StarContainer, Float>) property2, 0.3f, 1.0f);
            float f2 = f;
            ObjectAnimator objectAnimatorOfFloat5 = ObjectAnimator.ofFloat(this.startsViews[i], (Property<StarContainer, Float>) property3, 0.3f, 1.0f);
            StarContainer starContainer = this.startsViews[i];
            float[] fArr = new float[2];
            fArr[0] = AndroidUtilities.m1036dp(30.0f);
            fArr[c5] = f2;
            ObjectAnimator objectAnimatorOfFloat6 = ObjectAnimator.ofFloat(starContainer, (Property<StarContainer, Float>) property4, fArr);
            Animator[] animatorArr = new Animator[4];
            animatorArr[0] = objectAnimatorOfFloat3;
            animatorArr[c5] = objectAnimatorOfFloat4;
            animatorArr[2] = objectAnimatorOfFloat5;
            animatorArr[c4] = objectAnimatorOfFloat6;
    ...
    public static class StarContainer extends FrameLayout {
        ...
        public StarContainer(Context context) {
            ...
            this.defaultStar.setAnimation(C2797R.raw.star_stroke, 37, 37);
            this.selectedStar.setAnimation(C2797R.raw.star_fill, 37, 37);
            ...
            Drawable drawableCreateSimpleSelectorCircleDrawable = Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m1036dp(37.0f), 0, ColorUtils.setAlphaComponent(-1, 76));
    ...
    public static class RateCallContainer extends FrameLayout {
        ...
        public RateCallContainer(Context context, VoIPBackgroundProvider voIPBackgroundProvider) {
            ...
            textView.setText(LocaleController.getString(C2797R.string.VoipRateCallTitle));
            ...
            textView2.setText(LocaleController.getString(C2797R.string.VoipRateCallDescription));
        ...
        public void dispatchDraw(Canvas canvas) {
            ...
            canvas.drawRoundRect(this.bgRect, AndroidUtilities.m1036dp(28.0f), AndroidUtilities.m1036dp(28.0f), this.backgroundProvider.getDarkPaint());
