...
public class AcceptDeclineView extends View {
    ...
    public AcceptDeclineView(Context context) {
        ...
        ImageWithWavesView.AvatarWavesDrawable avatarWavesDrawable = new ImageWithWavesView.AvatarWavesDrawable(AndroidUtilities.m1036dp(45.0f), AndroidUtilities.m1036dp(50.0f), AndroidUtilities.m1036dp(8.0f), 4);
        ...
        this.buttonWidth = AndroidUtilities.m1036dp(60.0f);
        ...
        String string = LocaleController.getString(C2797R.string.AcceptCall);
        String string2 = LocaleController.getString(C2797R.string.DeclineCall);
        String string3 = LocaleController.getString(C2797R.string.RetryCall);
        ...
        this.callDrawable = ContextCompat.getDrawable(context, C2797R.drawable.calls_decline).mutate();
        Drawable drawableMutate = ContextCompat.getDrawable(context, C2797R.drawable.ic_close_white).mutate();
        ...
        RLottieDrawable rLottieDrawable = new RLottieDrawable(C2797R.raw.call_accept, _UrlKt.FRAGMENT_ENCODE_SET + C2797R.raw.call_accept, AndroidUtilities.m1036dp(48.0f), AndroidUtilities.m1036dp(48.0f), true, null);
        ...
        this.acceptVideoDrawable = ContextCompat.getDrawable(context, C2797R.drawable.calls_video).mutate();
        paint.setColor(-1);
        paint.setAlpha(20);
        Drawable drawableCreateSimpleSelectorCircleDrawable = Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m1036dp(52.0f), 0, ColorUtils.setAlphaComponent(-1, 76));
    ...
    public void onMeasure(int i, int i2) {
        ...
        this.maxOffset = (getMeasuredWidth() / 2.0f) - ((this.buttonWidth / 2.0f) + AndroidUtilities.m1036dp(46.0f));
        int iM1036dp = (this.buttonWidth - AndroidUtilities.m1036dp(28.0f)) / 2;
        this.callDrawable.setBounds(iM1036dp, iM1036dp, AndroidUtilities.m1036dp(28.0f) + iM1036dp, AndroidUtilities.m1036dp(28.0f) + iM1036dp);
        this.cancelDrawable.setBounds(iM1036dp, iM1036dp, AndroidUtilities.m1036dp(28.0f) + iM1036dp, AndroidUtilities.m1036dp(28.0f) + iM1036dp);
        this.linePaint.setStrokeWidth(AndroidUtilities.m1036dp(3.0f));
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r7) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.voip.AcceptDeclineView.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public void onDraw(Canvas canvas) {
        if (!this.retryMod) {
            boolean z = this.expandSmallRadius;
            float f = this.smallRadius;
            if (z) {
                float fM1036dp = f + (AndroidUtilities.m1036dp(2.0f) * 0.04f);
                this.smallRadius = fM1036dp;
                if (fM1036dp > AndroidUtilities.m1036dp(4.0f)) {
                    this.smallRadius = AndroidUtilities.m1036dp(4.0f);
                    this.expandSmallRadius = false;
                }
            } else {
                float fM1036dp2 = f - (AndroidUtilities.m1036dp(2.0f) * 0.04f);
                this.smallRadius = fM1036dp2;
                if (fM1036dp2 < 0.0f) {
                    this.smallRadius = 0.0f;
                    this.expandSmallRadius = true;
                }
            }
            boolean z2 = this.expandBigRadius;
            float f2 = this.bigRadius;
            if (z2) {
                float fM1036dp3 = f2 + (AndroidUtilities.m1036dp(4.0f) * 0.03f);
                this.bigRadius = fM1036dp3;
                if (fM1036dp3 > AndroidUtilities.m1036dp(10.0f)) {
                    this.bigRadius = AndroidUtilities.m1036dp(10.0f);
                    this.expandBigRadius = false;
                }
            } else {
                float fM1036dp4 = f2 - (AndroidUtilities.m1036dp(5.0f) * 0.03f);
                this.bigRadius = fM1036dp4;
                if (fM1036dp4 < AndroidUtilities.m1036dp(5.0f)) {
                    this.bigRadius = AndroidUtilities.m1036dp(5.0f);
                    this.expandBigRadius = true;
                }
            }
            invalidate();
        }
        this.bigRadius += AndroidUtilities.m1036dp(8.0f) * 0.005f;
        this.declineRect.set((getMeasuredWidth() - AndroidUtilities.m1036dp(46.0f)) - this.buttonWidth, AndroidUtilities.m1036dp(40.0f), getMeasuredWidth() - AndroidUtilities.m1036dp(46.0f), AndroidUtilities.m1036dp(40.0f) + this.buttonWidth);
        canvas.save();
        canvas.translate(0.0f, AndroidUtilities.m1036dp(40.0f));
        canvas.save();
        ...
        canvas.translate(((this.rigthOffsetX + getMeasuredWidth()) - AndroidUtilities.m1036dp(46.0f)) - this.buttonWidth, 0.0f);
        if (this.retryMod) {
        ...
        canvas.save();
        canvas.translate((this.buttonWidth / 2.0f) - (this.declineLayout.getWidth() / 2.0f), this.buttonWidth + AndroidUtilities.m1036dp(4.0f));
        this.declineLayout.draw(canvas);
        canvas.restore();
        if (this.leftDrag) {
            this.rippleDrawable.setBounds(AndroidUtilities.m1036dp(4.0f), AndroidUtilities.m1036dp(4.0f), this.buttonWidth - AndroidUtilities.m1036dp(4.0f), this.buttonWidth - AndroidUtilities.m1036dp(4.0f));
            this.rippleDrawable.draw(canvas);
        }
        canvas.restore();
        this.acceptRect.set(AndroidUtilities.m1036dp(46.0f), AndroidUtilities.m1036dp(40.0f), AndroidUtilities.m1036dp(46.0f) + this.buttonWidth, AndroidUtilities.m1036dp(40.0f) + this.buttonWidth);
        canvas.save();
        ...
        canvas.translate(this.leftOffsetX + AndroidUtilities.m1036dp(46.0f), 0.0f);
        if (!this.retryMod) {
            this.avatarWavesDrawable.update();
            float f3 = (int) (this.buttonWidth / 2.0f);
            this.avatarWavesDrawable.draw(canvas, f3, f3, this);
        }
        this.acceptDrawable.draw(canvas);
        if (this.retryMod) {
            canvas.save();
            canvas.translate((this.buttonWidth / 2.0f) - (this.retryLayout.getWidth() / 2.0f), this.buttonWidth + AndroidUtilities.m1036dp(4.0f));
            this.retryLayout.draw(canvas);
            canvas.restore();
        } else {
            canvas.save();
            canvas.translate((this.buttonWidth / 2.0f) - (this.acceptLayout.getWidth() / 2.0f), this.buttonWidth + AndroidUtilities.m1036dp(4.0f));
        ...
        if (this.isVideo) {
            ...
            canvas.translate((AndroidUtilities.m1036dp(48.0f) - iM1036dp) / 2.0f, (AndroidUtilities.m1036dp(48.0f) - iM1036dp) / 2.0f);
            this.acceptVideoDrawable.setBounds(0, 0, iM1036dp, iM1036dp);
    ...
    public static abstract class AcceptDeclineAccessibilityNodeProvider extends AccessibilityNodeProvider {
        ...
        public abstract void getVirtualViewBoundsInParent(int i, Rect rect);

        public abstract void getVirtualViewBoundsInScreen(int i, Rect rect);

        public abstract CharSequence getVirtualViewText(int i);

        public abstract void onVirtualViewClick(int i);

        public AcceptDeclineAccessibilityNodeProvider(View view, int i) {
            this.hostView = view;
