...
public class GroupCallStatusIcon {
    ...
    RLottieDrawable micDrawable = new RLottieDrawable(C2797R.raw.voice_mini, _UrlKt.FRAGMENT_ENCODE_SET + C2797R.raw.voice_mini, AndroidUtilities.m1036dp(24.0f), AndroidUtilities.m1036dp(24.0f), true, null);
    RLottieDrawable shakeHandDrawable = new RLottieDrawable(C2797R.raw.hand_2, _UrlKt.FRAGMENT_ENCODE_SET + C2797R.raw.hand_2, AndroidUtilities.m1036dp(15.0f), AndroidUtilities.m1036dp(15.0f), true, null);
    ...
    */
    public /* synthetic */ void lambda$new$1() {
        ...
        L2b:
            ...
            r0.setAnimation(r1)
            org.telegram.ui.Components.RLottieImageView r5 = r5.iconView
            r5.playAnimation()
        L4c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.voip.GroupCallStatusIcon.lambda$new$1():void");
    }
        ...
        if (!z) {
            ...
            if (z6) {
                ...
                if (z5) {
                    ...
                    rLottieDrawable2.setCurrentFrame(36);
