...
public class VoIPPiPView implements VoIPService.StateListener, IPipSourceDelegate, NotificationCenter.NotificationCenterDelegate {
    ...
    private void setRelativePosition(float f, float f2) {
        ...
        float fM1036dp3 = AndroidUtilities.m1036dp(60.0f);
        float fM1036dp4 = AndroidUtilities.m1036dp(16.0f);
        ...
        layoutParams.x = (int) ((f * (((f3 - fM1036dp) - fM1036dp2) - measuredWidth)) - (this.xOffset - fM1036dp));
        layoutParams.y = (int) ((f2 * (((f4 - fM1036dp3) - fM1036dp4) - measuredHeight)) - (this.yOffset - fM1036dp3));
    ...
    public VoIPPiPView(final Context context, int i, int i2, boolean z) {
        ...
        final Drawable drawable = ContextCompat.getDrawable(context, C2797R.drawable.calls_pip_outershadow);
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.Components.voip.VoIPPiPView.4
            ...
            public void onDraw(Canvas canvas) {
                ...
                drawable.setBounds(VoIPPiPView.this.floatingView.getLeft() - AndroidUtilities.m1036dp(2.0f), VoIPPiPView.this.floatingView.getTop() - AndroidUtilities.m1036dp(2.0f), VoIPPiPView.this.floatingView.getRight() + AndroidUtilities.m1036dp(2.0f), VoIPPiPView.this.floatingView.getBottom() + AndroidUtilities.m1036dp(2.0f));
        ...
        if (z) {
            ...
            this.floatingView.addView(this.topShadow, -1, AndroidUtilities.m1036dp(60.0f));
            ImageView imageView = new ImageView(context);
            this.closeIcon = imageView;
            imageView.setImageResource(C2797R.drawable.pip_close);
            this.closeIcon.setPadding(AndroidUtilities.m1036dp(8.0f), AndroidUtilities.m1036dp(8.0f), AndroidUtilities.m1036dp(8.0f), AndroidUtilities.m1036dp(8.0f));
            this.closeIcon.setContentDescription(LocaleController.getString(C2797R.string.Close));
            ...
            imageView2.setImageResource(C2797R.drawable.pip_enlarge);
            this.enlargeIcon.setPadding(AndroidUtilities.m1036dp(8.0f), AndroidUtilities.m1036dp(8.0f), AndroidUtilities.m1036dp(8.0f), AndroidUtilities.m1036dp(8.0f));
            this.enlargeIcon.setContentDescription(LocaleController.getString(C2797R.string.Open));
    ...
    private void updateViewState() {
        ...
        boolean z3 = this.callingUserIsVideo;
        if (!z) {
            this.progressToCameraMini = z3 ? 1.0f : 0.0f;
            return;
        }
        if (z2 != z3) {
    ...
    public class FloatingView extends FrameLayout {
        ...
        public FloatingView(Context context) {
            ...
            setOutlineProvider(new ViewOutlineProvider() { // from class: org.telegram.ui.Components.voip.VoIPPiPView.FloatingView.1
                ...
                public void getOutline(View view, Outline outline) {
                    outline.setRoundRect(0, 0, view.getMeasuredWidth(), view.getMeasuredHeight(), (1.0f / view.getScaleX()) * AndroidUtilities.m1036dp(4.0f));
                }
            });
        ...
        public void onMeasure(int i, int i2) {
            ...
            this.leftPadding = AndroidUtilities.m1036dp(16.0f);
            this.rightPadding = AndroidUtilities.m1036dp(16.0f);
            this.topPadding = AndroidUtilities.m1036dp(60.0f);
            this.bottomPadding = AndroidUtilities.m1036dp(16.0f);
        }
        ...
        public void dispatchDraw(Canvas canvas) {
            ...
            VoIPPiPView.this.currentUserTextureView.setTranslationX((-AndroidUtilities.m1036dp(4.0f)) * (1.0f / getScaleX()) * VoIPPiPView.this.progressToCameraMini);
            VoIPPiPView.this.currentUserTextureView.setTranslationY((-AndroidUtilities.m1036dp(4.0f)) * (1.0f / getScaleY()) * VoIPPiPView.this.progressToCameraMini);
            VoIPPiPView.this.currentUserTextureView.setRoundCorners(AndroidUtilities.m1036dp(8.0f) * (1.0f / getScaleY()) * VoIPPiPView.this.progressToCameraMini);
            VoIPPiPView voIPPiPView = VoIPPiPView.this;
        ...
        */
        ...
        public void expand(boolean z) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.voip.VoIPPiPView$FloatingView$$ExternalSyntheticLambda1
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    VoIPPiPView.FloatingView.m15196$r8$lambda$IozzDMM2wo9rwKfitkKti6NbPU(scaleX2, valueAnimator);
                }
            });
            valueAnimatorOfFloat.setDuration(300L).setInterpolator(CubicBezierInterpolator.DEFAULT);
            valueAnimatorOfFloat.addListener(new C54363(z));
        ...
        public /* synthetic */ void lambda$expand$1(final float f, final VoIPPiPView voIPPiPView) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.voip.VoIPPiPView$FloatingView$$ExternalSyntheticLambda2
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    VoIPPiPView.FloatingView.m15197$r8$lambda$nnUQfHzfHnDL_MoShkmrtDfByk(f, f2, voIPPiPView, valueAnimator);
                }
            });
        ...
        public static /* synthetic */ void m15197$r8$lambda$nnUQfHzfHnDL_MoShkmrtDfByk(float f, float f2, VoIPPiPView voIPPiPView, ValueAnimator valueAnimator) {
            float fFloatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        ...
        public static /* synthetic */ void m15196$r8$lambda$IozzDMM2wo9rwKfitkKti6NbPU(float f, ValueAnimator valueAnimator) {
            float fFloatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        ...
        public class C54363 extends AnimatorListenerAdapter {
            final /* synthetic */ boolean val$expanded;

            public C54363(boolean z) {
                this.val$expanded = z;
            }
