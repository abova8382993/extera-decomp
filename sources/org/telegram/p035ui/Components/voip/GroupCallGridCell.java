...
import org.telegram.p035ui.GroupCallTabletGridAdapter;
...
public abstract class GroupCallGridCell extends FrameLayout {
    ...
    public void onMeasure(int i, int i2) {
        if (this.isTabletGrid) {
            ...
            float fM1036dp = (AndroidUtilities.displaySize.x - (AndroidUtilities.m1036dp(14.0f) * 2)) + (GroupCallActivity.isLandscapeMode ? -AndroidUtilities.m1036dp(90.0f) : 0);
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec((int) ((GroupCallActivity.isTabletMode ? fM1036dp / 2.0f : fM1036dp / f) + AndroidUtilities.m1036dp(4.0f)), TLObject.FLAG_30));
        }
    }
