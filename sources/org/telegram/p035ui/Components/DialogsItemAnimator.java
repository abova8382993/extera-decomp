...
public abstract class DialogsItemAnimator extends SimpleItemAnimator {
    ...
    public void runPendingAnimations() {
        ...
        if (!zIsEmpty2) {
            final ArrayList<MoveInfo> arrayList2 = new ArrayList<>(this.mPendingMoves);
            ...
            new Runnable() { // from class: org.telegram.ui.Components.DialogsItemAnimator$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.lambda$runPendingAnimations$0(arrayList2);
                }
            }.run();
        }
        if (!zIsEmpty3) {
            final ArrayList<ChangeInfo> arrayList3 = new ArrayList<>(this.mPendingChanges);
            ...
            new Runnable() { // from class: org.telegram.ui.Components.DialogsItemAnimator$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$runPendingAnimations$1(arrayList3);
                }
            }.run();
        }
        if (zIsEmpty4) {
        ...
        final ArrayList<RecyclerView.ViewHolder> arrayList4 = new ArrayList<>(this.mPendingAdditions);
        ...
        new Runnable() { // from class: org.telegram.ui.Components.DialogsItemAnimator$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$runPendingAnimations$2(arrayList4);
            }
        }.run();
    }
    ...
    private void animateRemoveImpl(final RecyclerView.ViewHolder viewHolder) {
        ...
        viewPropertyAnimatorAnimate.setDuration(180L).alpha(0.0f).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.DialogsItemAnimator.3
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationStart(Animator animator) {
                DialogsItemAnimator.this.dispatchRemoveStarting(viewHolder);
            }
    ...
    public void animateAddImpl(final RecyclerView.ViewHolder viewHolder) {
        ...
        final ViewPropertyAnimator viewPropertyAnimatorAnimate = view.animate();
        viewPropertyAnimatorAnimate.alpha(1.0f).setDuration(180L).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.DialogsItemAnimator.4
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationStart(Animator animator) {
    ...
    public void animateMoveImpl(final RecyclerView.ViewHolder viewHolder, RecyclerView.ItemAnimator.ItemHolderInfo itemHolderInfo, int i, int i2, int i3, int i4) {
        final View view = viewHolder.itemView;
        final int i5 = i3 - i;
        final int i6 = i4 - i2;
        if (i5 != 0) {
        ...
        viewPropertyAnimatorAnimate.setDuration(180L).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.DialogsItemAnimator.5
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationStart(Animator animator) {
        ...
        if (isRunning()) {
            ...
            for (int size7 = this.mAdditionsList.size() - 1; size7 >= 0; size7--) {
                ...
                for (int size8 = arrayList3.size() - 1; size8 >= 0; size8--) {
                    RecyclerView.ViewHolder viewHolder3 = arrayList3.get(size8);
