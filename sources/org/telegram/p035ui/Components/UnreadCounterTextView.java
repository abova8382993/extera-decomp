...
public class UnreadCounterTextView extends View {
    ...
    public UnreadCounterTextView(Context context) {
        ...
        this.layoutPaint.setTextSize(AndroidUtilities.m1036dp(15.0f));
    ...
    public void setCounter(int i) {
        if (this.currentCounter != i) {
            ...
            if (i == 0) {
                ...
                int iMax = Math.max(AndroidUtilities.m1036dp(20.0f), AndroidUtilities.m1036dp(12.0f) + this.textWidth);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (getParent() != null) {
            ...
            if (this.rippleColor != Theme.getColor(this.textColorKey, getResourceProvider()) || this.selectableBackground == null) {
                ...
                Drawable drawableCreateSimpleSelectorCircleDrawable = Theme.createSimpleSelectorCircleDrawable(iM1036dp, 0, ColorUtils.setAlphaComponent(color4, 26));
            ...
            int iM1036dp2 = getLeft() + measuredWidth2 <= 0 ? measuredWidth2 - AndroidUtilities.m1036dp(20.0f) : measuredWidth2;
            int iM1036dp3 = measuredWidth2 + measuredWidth;
            if (iM1036dp3 > ((View) getParent()).getMeasuredWidth()) {
                iM1036dp3 += AndroidUtilities.m1036dp(20.0f);
            }
            int i = measuredWidth / 2;
            this.selectableBackground.setBounds(iM1036dp2, (getMeasuredHeight() / 2) - i, iM1036dp3, (getMeasuredHeight() / 2) + i);
        ...
        if (this.textLayout != null) {
            ...
            if (this.replaceProgress != 1.0f && this.textLayoutOut != null) {
                ...
                canvas.translate(this.iconOut != null ? (r6.getIntrinsicWidth() / 2) + AndroidUtilities.m1036dp(3.0f) : 0, (this.animatedFromBottom ? -1.0f : 1.0f) * AndroidUtilities.m1036dp(18.0f) * this.replaceProgress);
                Drawable drawable = this.iconOut;
                if (drawable != null) {
                    drawable.setBounds((-drawable.getIntrinsicWidth()) - AndroidUtilities.m1036dp(6.0f), ((this.textLayout.getHeight() - this.iconOut.getIntrinsicHeight()) / 2) + AndroidUtilities.m1036dp(1.0f), -AndroidUtilities.m1036dp(6.0f), ((this.textLayout.getHeight() + this.iconOut.getIntrinsicHeight()) / 2) + AndroidUtilities.m1036dp(1.0f));
                ...
                canvas.translate(this.icon != null ? (r6.getIntrinsicWidth() / 2) + AndroidUtilities.m1036dp(3.0f) : 0, (this.animatedFromBottom ? 1.0f : -1.0f) * AndroidUtilities.m1036dp(18.0f) * (1.0f - this.replaceProgress));
                Drawable drawable2 = this.icon;
                if (drawable2 != null) {
                    drawable2.setBounds((-drawable2.getIntrinsicWidth()) - AndroidUtilities.m1036dp(6.0f), ((this.textLayout.getHeight() - this.icon.getIntrinsicHeight()) / 2) + AndroidUtilities.m1036dp(1.0f), -AndroidUtilities.m1036dp(6.0f), ((this.textLayout.getHeight() + this.icon.getIntrinsicHeight()) / 2) + AndroidUtilities.m1036dp(1.0f));
                ...
                canvas.translate(measuredWidth3 + (this.icon != null ? (r6.getIntrinsicWidth() / 2) + AndroidUtilities.m1036dp(3.0f) : 0), ((getMeasuredHeight() - this.textLayout.getHeight()) / 2) + getTopOffset());
                Drawable drawable3 = this.icon;
                if (drawable3 != null) {
                    drawable3.setBounds((-drawable3.getIntrinsicWidth()) - AndroidUtilities.m1036dp(6.0f), ((this.textLayout.getHeight() - this.icon.getIntrinsicHeight()) / 2) + AndroidUtilities.m1036dp(1.0f), -AndroidUtilities.m1036dp(6.0f), ((this.textLayout.getHeight() + this.icon.getIntrinsicHeight()) / 2) + AndroidUtilities.m1036dp(1.0f));
        ...
        this.rect.set(((((getMeasuredWidth() - iCeil) / 2) + iCeil) - (this.circleWidth / 2)) + AndroidUtilities.m1036dp(6.0f), (getMeasuredHeight() / 2) - AndroidUtilities.m1036dp(10.0f), r1 + this.circleWidth, (getMeasuredHeight() / 2) + AndroidUtilities.m1036dp(10.0f));
        canvas.drawRoundRect(this.rect, AndroidUtilities.m1036dp(10.0f), AndroidUtilities.m1036dp(10.0f), this.paint);
        canvas.drawText(this.currentCounterString, this.rect.centerX() - (this.textWidth / 2.0f), this.rect.top + AndroidUtilities.m1036dp(14.5f), this.textPaint);
    }
