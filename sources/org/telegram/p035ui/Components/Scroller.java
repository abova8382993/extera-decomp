...
public class Scroller {
    ...
    */
    public void fling(int r12, int r13, int r14, int r15, int r16, int r17, int r18, int r19) {
        /*
            Method dump skipped, instruction units count: 231
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.Scroller.fling(int, int, int, int, int, int, int, int):void");
    }
