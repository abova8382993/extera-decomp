...
public class StarRatingView extends View {
    ...
    public void set(TL_stars.Tl_starsRating tl_starsRating) {
        ...
        setContentDescription(LocaleController.getString(C2797R.string.AccDescrProfileRatingLevel) + " " + tl_starsRating.level);
        invalidate();
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        int measuredWidth = (getMeasuredWidth() - AndroidUtilities.m1036dp(24.0f)) / 2;
        int measuredHeight = (getMeasuredHeight() - AndroidUtilities.m1036dp(24.0f)) / 2;
        canvas.save();
        canvas.translate(measuredWidth, measuredHeight);
        canvas.scale(f, f, 0.0f, AndroidUtilities.m1036dp(12.0f));
        this.drawable.setBounds(0, 0, AndroidUtilities.m1036dp(24.0f), AndroidUtilities.m1036dp(24.0f));
