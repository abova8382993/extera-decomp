...
public class LetterDrawable extends Drawable {
    ...
    public LetterDrawable(Theme.ResourcesProvider resourcesProvider, int i) {
        ...
        if (i == 0) {
            ...
            namePaint.setTextSize(AndroidUtilities.m1036dp(28.0f));
        ...
        if (i == 1) {
            ...
            namePaintTopic.setTextSize(AndroidUtilities.m1036dp(13.0f));
    ...
    public void setTitle(String str) {
        ...
        if (str != null && str.length() > 0) {
            this.stringBuilder.append((CharSequence) str, 0, Character.charCount(str.codePointAt(0)));
        }
        if (this.stringBuilder.length() > 0) {
            try {
                StaticLayout staticLayout = new StaticLayout(this.stringBuilder.toString().toUpperCase(), this.textPaint, AndroidUtilities.m1036dp(100.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.style == 0) {
            ...
            canvas.drawRoundRect(this.rect, AndroidUtilities.m1036dp(8.0f), AndroidUtilities.m1036dp(8.0f), paint);
        }
        canvas.save();
        float f = this.scale;
        if (f != 1.0f) {
