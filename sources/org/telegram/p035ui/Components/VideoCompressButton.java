...
public class VideoCompressButton extends View {
    ...
    public void setState(boolean z, boolean z2, int i) {
        ...
        if (z2) {
            animatedTextDrawable.setText("GIF");
            this.sizeTextDrawable.setText(_UrlKt.FRAGMENT_ENCODE_SET, true);
        } else {
            animatedTextDrawable.setText(i >= 720 ? "HD" : "SD");
            ...
            if (length < 0) {
                ...
                animatedTextDrawable2.setText("2K", TextUtils.isEmpty(animatedTextDrawable2.getText()));
            } else {
                AnimatedTextView.AnimatedTextDrawable animatedTextDrawable3 = this.sizeTextDrawable;
                if (length == 7) {
                    animatedTextDrawable3.setText("4K", TextUtils.isEmpty(animatedTextDrawable3.getText()));
                } else {
                    animatedTextDrawable3.setText(_UrlKt.FRAGMENT_ENCODE_SET + this.sizes[length], TextUtils.isEmpty(this.sizeTextDrawable.getText()));
                }
            }
        }
    ...
    public void setPhotoState(boolean z) {
        ...
        this.sizeTextDrawable.setText(_UrlKt.FRAGMENT_ENCODE_SET, false);
    }
