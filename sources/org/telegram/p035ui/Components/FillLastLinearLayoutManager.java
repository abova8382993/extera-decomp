    ...
    private void calcLastItemHeight() {
        ...
        if (this.listHeight > 0 && (adapter = this.listView.getAdapter()) != 0) {
            ...
            for (?? r2 = this.skipFirstItem; r2 < itemCount; r2++) {
                ...
                boolean z = this.fixedLastItemHeight;
            ...
            boolean z2 = this.fixedLastItemHeight;
            int i2 = this.minimumHeight;
            if (z2) {
                this.lastItemHeight = Math.max(i2, measuredHeight2 + (((this.listHeight - measuredHeight) - this.additionalHeight) - this.listView.getPaddingBottom()));
            } else {
                this.lastItemHeight = Math.max(i2, ((this.listHeight - measuredHeight) - this.additionalHeight) - this.listView.getPaddingBottom());
            }
        }
    }
