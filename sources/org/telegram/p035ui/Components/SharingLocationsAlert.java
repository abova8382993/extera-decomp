    ...
    public SharingLocationsAlert(Context context, SharingLocationsAlertDelegate sharingLocationsAlertDelegate, Theme.ResourcesProvider resourcesProvider) {
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.Components.SharingLocationsAlert.1
            ...
            public void onMeasure(int i2, int i3) {
                ...
                getMeasuredWidth();
                int iM1036dp2 = AndroidUtilities.m1036dp(56.0f) + AndroidUtilities.m1036dp(56.0f) + 1 + (LocationController.getLocationsCount() * AndroidUtilities.m1036dp(54.0f));
                int i4 = size / 5;
                if (iM1036dp2 < i4 * 3) {
                    ...
                    iM1036dp = i4 * 2;
                    if (iM1036dp2 < size) {
                        iM1036dp -= size - iM1036dp2;
                    }
                }
                if (SharingLocationsAlert.this.listView.getPaddingTop() != iM1036dp) {
                    SharingLocationsAlert.this.ignoreLayout = true;
                    SharingLocationsAlert.this.listView.setPadding(0, iM1036dp, 0, AndroidUtilities.m1036dp(8.0f));
                    SharingLocationsAlert.this.ignoreLayout = false;
                }
                super.onMeasure(i2, View.MeasureSpec.makeMeasureSpec(Math.min(iM1036dp2, size), TLObject.FLAG_30));
            }
        ...
        pickerBottomLayout.cancelButton.setPadding(AndroidUtilities.m1036dp(18.0f), 0, AndroidUtilities.m1036dp(18.0f), 0);
        pickerBottomLayout.cancelButton.setTextColor(getThemedColor(Theme.key_text_RedBold));
        pickerBottomLayout.cancelButton.setText(LocaleController.getString(C2797R.string.StopAllLocationSharings));
        ...
        pickerBottomLayout.doneButtonTextView.setText(LocaleController.getString(C2797R.string.Close).toUpperCase());
        pickerBottomLayout.doneButton.setPadding(AndroidUtilities.m1036dp(18.0f), 0, AndroidUtilities.m1036dp(18.0f), 0);
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                sharingLiveLocationCell = new FrameLayout(this.context) { // from class: org.telegram.ui.Components.SharingLocationsAlert.ListAdapter.1
                    @Override // android.widget.FrameLayout, android.view.View
                    public void onMeasure(int i2, int i3) {
                        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i2), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(48.0f) + 1, TLObject.FLAG_30));
                    }

                    @Override // android.view.View
                    public void onDraw(Canvas canvas) {
                        canvas.drawLine(0.0f, AndroidUtilities.m1036dp(40.0f), getMeasuredWidth(), AndroidUtilities.m1036dp(40.0f), Theme.dividerPaint);
                    }
                };
                ...
                SharingLocationsAlert.this.textView.setPadding(0, 0, 0, AndroidUtilities.m1036dp(8.0f));
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                SharingLocationsAlert.this.textView.setText(LocaleController.formatString("SharingLiveLocationTitle", C2797R.string.SharingLiveLocationTitle, LocaleController.formatPluralString("Chats", LocationController.getLocationsCount(), new Object[0])));
            }
        }
    }
}
