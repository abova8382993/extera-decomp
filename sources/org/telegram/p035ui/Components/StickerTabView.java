...
public class StickerTabView extends FrameLayout {
    ...
    public StickerTabView(Context context, int i) {
        ...
        if (i == 2) {
            ...
            this.imageView.setRoundRadius(AndroidUtilities.m1036dp(6.0f));
        ...
        C51351 c51351 = new TextView(context) { // from class: org.telegram.ui.Components.StickerTabView.1
            public C51351(Context context2) {
                super(context2);
            }
        ...
        this.textView = c51351;
        c51351.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: org.telegram.ui.Components.StickerTabView$$ExternalSyntheticLambda0
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.StickerTabView$1 */
    public class C51351 extends TextView {
        public C51351(Context context2) {
            super(context2);
        }
    ...
    public void setExpanded(boolean z) {
        ...
        this.visibleView.getLayoutParams().width = AndroidUtilities.m1036dp(z ? f2 : f);
        ViewGroup.LayoutParams layoutParams = this.visibleView.getLayoutParams();
        if (z) {
            f = f2;
        }
        layoutParams.height = AndroidUtilities.m1036dp(f);
        this.textView.setVisibility(z ? 0 : 8);
        if (this.type == 1 || !this.roundImage) {
            return;
        }
        this.imageView.setRoundRadius(AndroidUtilities.m1036dp(this.visibleView.getLayoutParams().width / 2.0f));
    }
    ...
    public void updateExpandProgress(float f) {
        ...
        if (this.expanded) {
            ...
            float f4 = 1.0f - f;
            this.visibleView.setTranslationY((((AndroidUtilities.m1036dp(36.0f - f2) / 2.0f) - (AndroidUtilities.m1036dp(86.0f - f3) / 2.0f)) * f4) - (AndroidUtilities.m1036dp(8.0f) * f));
            this.visibleView.setTranslationX(((AndroidUtilities.m1036dp(33.0f - f2) / 2.0f) - (AndroidUtilities.m1036dp(ScrollSlidingTabStrip.EXPANDED_WIDTH - f3) / 2.0f)) * f4);
            this.textView.setAlpha(Math.max(0.0f, (f - 0.5f) / 0.5f));
            this.textView.setTranslationY((-AndroidUtilities.m1036dp(40.0f)) * f4);
            this.textView.setTranslationX((-AndroidUtilities.m1036dp(12.0f)) * f4);
    ...
    public void animateIfPositionChanged(ViewGroup viewGroup) {
        ...
        if (left != f && this.hasSavedLeft) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.StickerTabView.2
                ...
                public C51362(ViewGroup viewGroup2) {
            ...
            this.dragOffsetAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.StickerTabView.3
                ...
                public C51373(ViewGroup viewGroup2) {
                    viewGroup = viewGroup2;
                }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.StickerTabView$2 */
    public class C51362 implements ValueAnimator.AnimatorUpdateListener {
        final /* synthetic */ ViewGroup val$parent;
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.StickerTabView$3 */
    public class C51373 extends AnimatorListenerAdapter {
        final /* synthetic */ ViewGroup val$parent;
