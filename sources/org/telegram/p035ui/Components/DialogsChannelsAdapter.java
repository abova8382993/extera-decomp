...
public abstract class DialogsChannelsAdapter extends UniversalAdapter {
    ...
    public void fillItems(ArrayList<UItem> arrayList, UniversalAdapter universalAdapter) {
        ...
        if (TextUtils.isEmpty(this.query)) {
            ...
            if (arrayList2 != null && !arrayList2.isEmpty()) {
                if (this.myChannels.size() > 5) {
                    arrayList.add(UItem.asGraySection(LocaleController.getString(C2797R.string.SearchMyChannels), LocaleController.getString(this.expandedMyChannels ? C2797R.string.ShowLess : C2797R.string.ShowMore), new View.OnClickListener() { // from class: org.telegram.ui.Components.DialogsChannelsAdapter$$ExternalSyntheticLambda5
                    ...
                    arrayList.add(UItem.asGraySection(LocaleController.getString(C2797R.string.SearchMyChannels)));
                }
                ...
                for (int i2 = 0; i2 < size; i2++) {
                    arrayList.add(UItem.asProfileCell(this.myChannels.get(i2)).withUsername(true));
                }
            }
            ...
            if (cachedChannelRecommendations != null) {
                ...
                while (i3 < size2) {
                    ...
                    if (tLObject2 instanceof TLRPC.Chat) {
                        ...
                        TLRPC.Chat chat2 = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(chat.f1245id));
                ...
                if (!arrayList3.isEmpty()) {
                    arrayList.add(UItem.asGraySection(LocaleController.getString(C2797R.string.SearchRecommendedChannels)));
                }
        ...
        int i4 = 0;
        while (i4 < size4) {
            TLRPC.Chat chat3 = arrayList6.get(i4);
            i4++;
            TLRPC.Chat chat4 = chat3;
            TLRPC.Chat chat5 = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(chat4.f1245id));
        ...
        int i5 = 0;
        while (i5 < size5) {
            TLRPC.Chat chat6 = arrayList7.get(i5);
            i5++;
            TLRPC.Chat chat7 = chat6;
            TLRPC.Chat chat8 = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(chat7.f1245id));
        ...
        int i6 = 0;
        while (i6 < size6) {
            TLRPC.Chat chat9 = arrayList8.get(i6);
            i6++;
            TLRPC.Chat chat10 = chat9;
            TLRPC.Chat chat11 = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(chat10.f1245id));
        ...
        if (!arrayList5.isEmpty()) {
            if (arrayList5.size() <= 5 || this.messages.isEmpty()) {
                arrayList.add(UItem.asGraySection(LocaleController.getString(C2797R.string.SearchChannels)));
            } else {
                arrayList.add(UItem.asGraySection(LocaleController.getString(C2797R.string.SearchChannels), LocaleController.getString(this.expandedSearchChannels ? C2797R.string.ShowLess : C2797R.string.ShowMore), new View.OnClickListener() { // from class: org.telegram.ui.Components.DialogsChannelsAdapter$$ExternalSyntheticLambda6
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
    ...
    public /* synthetic */ void lambda$searchMessages$2(final int i, final TLRPC.TL_messages_searchGlobal tL_messages_searchGlobal, final boolean z) {
        if (i == this.searchChannelsId && TextUtils.equals(tL_messages_searchGlobal.f1370q, this.query)) {
    ...
    public /* synthetic */ void lambda$searchMessages$3(TLRPC.TL_contacts_search tL_contacts_search, TLObject tLObject) {
        ...
        if (tL_contacts_found != null) {
            ...
            while (i2 < size) {
                ...
                if ((peer2 instanceof TLRPC.TL_peerChannel) && (chat2 = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(peer2.channel_id))) != null && ChatObject.isChannelAndNotMegaGroup(chat2) && !hashSet.contains(Long.valueOf(chat2.f1245id))) {
                    hashSet.add(Long.valueOf(chat2.f1245id));
            ...
            while (i3 < size2) {
                ...
                if (tLObject3 instanceof TLRPC.Chat) {
                    ...
                    if (ChatObject.isChannelAndNotMegaGroup(chat3)) {
                        TLRPC.Chat chat4 = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(chat3.f1245id));
                        if (ChatObject.isNotInChat(chat3) && (chat4 == null || ChatObject.isNotInChat(chat4))) {
                            ...
                            if (!hashSet.contains(Long.valueOf(chat3.f1245id))) {
                                hashSet.add(Long.valueOf(chat3.f1245id));
        ...
        if (tL_contacts_found != null) {
            ...
            while (i < size3) {
                ...
                if ((peer4 instanceof TLRPC.TL_peerChannel) && (chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(peer4.channel_id))) != null && ChatObject.isChannelAndNotMegaGroup(chat) && !hashSet.contains(Long.valueOf(chat.f1245id))) {
                    hashSet.add(Long.valueOf(chat.f1245id));
