...
import org.telegram.p035ui.Components.ProfileMetaballView;
...
public class ProfileGalleryBlurView extends View {
    ...
    public class C48191 implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(int i, float f, int i2) {
            if (!ProfileGalleryBlurView.this.usingRenderNode && Math.abs(i - ProfileGalleryBlurView.this.currentPosition) == 1) {
                ...
                ProfileGalleryBlurView profileGalleryBlurView = ProfileGalleryBlurView.this;
                if (i > i3) {
                    profileGalleryBlurView.swap(0, 1, 1);
                } else if (i < profileGalleryBlurView.currentPosition) {
                    ProfileGalleryBlurView.this.swap(1, 0, 0);
                    ProfileGalleryBlurView.this.swap(2, 0, -1);
                }
            }
            int i4 = ProfileGalleryBlurView.this.currentPosition;
            int i5 = ProfileGalleryBlurView.this.offset;
            ProfileGalleryBlurView.this.currentPosition = i;
            ProfileGalleryBlurView.this.offset = i2;
            if (i4 == ProfileGalleryBlurView.this.currentPosition && i5 == ProfileGalleryBlurView.this.offset) {
                return;
            }
    ...
    public void setSize(int i) {
        ...
        this.actionSize = i;
        this.size = (int) (AndroidUtilities.m1036dp(64.0f) * 1.5f);
    }
    ...
    public void draw(Canvas canvas, ProfileActivity.AvatarImageView avatarImageView, float f, float f2, boolean z, float f3, float f4) {
        ...
        synchronized (profileGalleryBlurView.lock) {
            try {
                ...
                if (profileGalleryBlurView.offset != 0 && profileGalleryBlurView.paints[c2].getShader() != null) {
                    canvas2.save();
                    ...
                    canvas2.drawRect(0.0f, i3, profileGalleryBlurView.frameWidth, i3 + f7, profileGalleryBlurView.paints[c2]);
                    canvas.restore();
                    profileGalleryBlurView.paints[c2].setAlpha((int) (f4 * 255.0f));
                    int i4 = profileGalleryBlurView.frameHeight;
                    canvas.drawRect(0.0f, i4 * f3, profileGalleryBlurView.frameWidth, i4, profileGalleryBlurView.paints[c2]);
                    profileGalleryBlurView.paints[c2].setAlpha(255);
                    canvas.restore();
                }
            } catch (Throwable th) {
                throw th;
    ...
    private void initRenderNode() {
        if (this.blurNode == null) {
            ...
            this.blurNode = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1041m("profileBlurNode");
    ...
    private void initActionsRenderNode() {
        ...
        if (this.actionsBlurNode == null) {
            this.actionsBlurNode = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1041m("profileActionsBlurNode");
    ...
    private void captureActionsBlurRenderNode(float f, ProfileActivity.AvatarImageView avatarImageView, float f2, float f3) {
        ...
        if (profileActionsView2 != null) {
            ...
            if (avatarImageView != null) {
                profileActionsView2.drawingBlur(renderNode, avatarImageView, renderNodeScale / f2, -f3);
            } else {
                profileActionsView2.drawingBlur(renderNode, null, renderNodeScale, -f3);
            }
        }
        ...
        if (profileMusicView2 != null) {
            RenderNode renderNode2 = this.actionsBlurNode;
            if (avatarImageView != null) {
                profileMusicView2.drawingBlur(renderNode2, avatarImageView, renderNodeScale / f2, (-f3) + AndroidUtilities.m1036dp(22.0f));
            } else {
                profileMusicView2.drawingBlur(renderNode2, null, renderNodeScale, (-f3) + AndroidUtilities.m1036dp(22.0f));
            }
        }
    }
    ...
    private float getRenderNodeScale() {
        return AndroidUtilities.m1036dp(1.0f);
    }
