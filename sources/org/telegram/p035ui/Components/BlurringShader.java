...
import org.telegram.p035ui.Components.Paint.Shader;
...
public class BlurringShader {
    ...
    public boolean setup(float f, boolean z, int i) {
        ...
        String res = AndroidUtilities.readRes(C2797R.raw.blur_vrt);
        String res2 = AndroidUtilities.readRes(C2797R.raw.blur_frg);
    ...
    public void draw(float[] fArr, int i, int i2, int i3) {
        ...
        GLES20.glUseProgram(program.f1535gl);
    ...
    public static class BlurManager {
        ...
        public void setRenderNode(View view, Object obj, int i) {
            ...
            if (obj != null && Build.VERSION.SDK_INT >= 31) {
                ...
                RenderNode renderNodeM1041m = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1041m("blurRenderNode");
                renderNodeM1041m.setRenderEffect(RenderEffect.createBlurEffect(AndroidUtilities.m1036dp(35.0f), AndroidUtilities.m1036dp(35.0f), Shader.TileMode.CLAMP));
                renderNodeM1041m.setPosition(0, 0, renderNodeM1042m.getWidth(), renderNodeM1042m.getHeight());
                RecordingCanvas recordingCanvasBeginRecording = renderNodeM1041m.beginRecording();
        ...
        public BlurManager(View view) {
            ...
            view.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: org.telegram.ui.Components.BlurringShader.BlurManager.1
                public ViewOnAttachStateChangeListenerC38701() {
                }
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Components.BlurringShader$BlurManager$1 */
        public class ViewOnAttachStateChangeListenerC38701 implements View.OnAttachStateChangeListener {
            public ViewOnAttachStateChangeListenerC38701() {
            }
        ...
        public void invalidate() {
            ArrayList<StoryBlurDrawer> arrayList = this.holders;
            int size = arrayList.size();
            int i = 0;
            int i2 = 0;
            while (i2 < size) {
                StoryBlurDrawer storyBlurDrawer = arrayList.get(i2);
                i2++;
                storyBlurDrawer.view.invalidate();
            }
            ArrayList<Runnable> arrayList2 = this.invalidateHolders;
    ...
    public static class StoryBlurDrawer {
        ...
        public StoryBlurDrawer(BlurManager blurManager, View view, int i, boolean z) {
            ...
            view.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: org.telegram.ui.Components.BlurringShader.StoryBlurDrawer.1
                final /* synthetic */ BlurManager val$manager;

                public ViewOnAttachStateChangeListenerC38711(BlurManager blurManager2) {
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Components.BlurringShader$StoryBlurDrawer$1 */
        public class ViewOnAttachStateChangeListenerC38711 implements View.OnAttachStateChangeListener {
            final /* synthetic */ BlurManager val$manager;
        ...
        public void drawRect(Canvas canvas, float f, float f2, float f3, boolean z) {
            if (this.manager.hasRenderNode() && Build.VERSION.SDK_INT >= 31) {
                ...
                RenderNode renderNodeM1042m = BotFullscreenButtons$$ExternalSyntheticApiModelOutline1.m1042m(this.manager.blurRenderNode);
                if (!renderNodeM1042m.hasDisplayList()) {
                    RenderNode renderNodeM1042m2 = BotFullscreenButtons$$ExternalSyntheticApiModelOutline1.m1042m(this.manager.renderNode);
                    renderNodeM1042m.setPosition(0, 0, renderNodeM1042m2.getWidth(), renderNodeM1042m2.getHeight());
                    RecordingCanvas recordingCanvasBeginRecording = renderNodeM1042m.beginRecording();
                    recordingCanvasBeginRecording.drawColor(getBackgroundColor());
                    recordingCanvasBeginRecording.drawRenderNode(renderNodeM1042m2);
                ...
                canvas.drawColor(getBackgroundColor());
                if (setupMatrix(renderNodeM1042m.getWidth(), renderNodeM1042m.getHeight(), true) && renderNodeM1042m.hasDisplayList()) {
                    this.matrix.postTranslate(-f, -f2);
                    this.paint.setAlpha((int) (f3 * 255.0f));
                    canvas.saveLayer(null, this.paint);
                    canvas.concat(this.matrix);
                    if (z) {
                        if (this.clipPathWidth != renderNodeM1042m.getWidth() || this.clipPathHeight != renderNodeM1042m.getHeight()) {
                            this.clipPath.rewind();
                            RectF rectF = AndroidUtilities.rectTmp;
                            int width = renderNodeM1042m.getWidth();
                            this.clipPathWidth = width;
                            int height = renderNodeM1042m.getHeight();
                            this.clipPathHeight = height;
                            rectF.set(0.0f, 0.0f, width, height);
                            this.clipPath.addRoundRect(rectF, AndroidUtilities.m1036dp(12.0f), AndroidUtilities.m1036dp(12.0f), Path.Direction.CW);
                        }
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Components.BlurringShader$StoryBlurDrawer$2 */
        /* JADX INFO: loaded from: classes7.dex */
        public class C38722 extends Drawable {
            final /* synthetic */ Drawable val$base;
            ...
            public C38722(float f, float f2, Drawable drawable, float f3) {
                f = f;
                f = f2;
                drawable = drawable;
                f = f3;
            ...
            private Paint getPaint() {
                ...
                StoryBlurDrawer.this.matrix.postTranslate((-StoryBlurDrawer.this.customOffsetX) - f, (-StoryBlurDrawer.this.customOffsetY) - f);
            ...
            public void draw(Canvas canvas) {
                ...
                if (paint != null || (StoryBlurDrawer.this.manager != null && StoryBlurDrawer.this.manager.hasRenderNode())) {
                    if (drawable != null) {
                        ...
                        float f2 = f;
                        canvas.drawRoundRect(rectF2, f2, f2, this.dimPaint);
                        return;
                    }
                    if (f > 0.0f) {
                    ...
                    if (f > 0.0f) {
                        ...
                        rectF4.set(bounds);
                        float f5 = f;
                        canvas.drawRoundRect(rectF4, f5, f5, this.dimPaint);
                        return;
                    }
        ...
        public Drawable makeDrawable(float f, float f2, Drawable drawable, float f3) {
            return new Drawable() { // from class: org.telegram.ui.Components.BlurringShader.StoryBlurDrawer.2
                ...
                public C38722(float f4, float f22, Drawable drawable2, float f32) {
                    f = f4;
                    f = f22;
                    drawable = drawable2;
                    f = f32;
                ...
                public void draw(Canvas canvas) {
                    ...
                    if (paint != null || (StoryBlurDrawer.this.manager != null && StoryBlurDrawer.this.manager.hasRenderNode())) {
                        if (drawable != null) {
                            ...
                            this.dimPaint.setColor(1711276032);
                            float f22 = f;
                            canvas.drawRoundRect(rectF2, f22, f22, this.dimPaint);
                            return;
                        }
                        if (f > 0.0f) {
                            RectF rectF3 = AndroidUtilities.rectTmp;
                            ...
                            if (StoryBlurDrawer.this.manager != null && StoryBlurDrawer.this.manager.hasRenderNode()) {
                                ...
                                Path path2 = this.clipPath;
                                float f32 = f;
                                path2.addRoundRect(rectF3, f32, f32, Path.Direction.CW);
                                canvas.clipPath(this.clipPath);
                                StoryBlurDrawer.this.drawRect(canvas, 0.0f, 0.0f, 1.0f, false);
                                canvas.restore();
                            } else {
                                float f42 = f;
                                canvas.drawRoundRect(rectF3, f42, f42, paint);
                            }
                        } else if (StoryBlurDrawer.this.manager != null && StoryBlurDrawer.this.manager.hasRenderNode()) {
                            canvas.save();
                            canvas.clipRect(bounds);
