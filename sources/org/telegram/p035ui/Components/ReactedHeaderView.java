...
public class ReactedHeaderView extends FrameLayout {
    ...
    public ReactedHeaderView(Context context, int i, MessageObject messageObject, long j) {
        ...
        Drawable drawableMutate = ContextCompat.getDrawable(context, C2797R.drawable.msg_reactions).mutate();
    ...
    public static class UserSeen {
        ...
        public UserSeen(TLObject tLObject, int i) {
            ...
            if (tLObject instanceof TLRPC.User) {
                this.dialogId = ((TLRPC.User) tLObject).f1407id;
            } else if (tLObject instanceof TLRPC.Chat) {
                this.dialogId = -((TLRPC.Chat) tLObject).f1245id;
            }
        }
    }
    ...
    public /* synthetic */ void lambda$onAttachedToWindow$5(long j, TLRPC.Chat chat, TLObject tLObject, TLRPC.TL_error tL_error) {
        if (tLObject instanceof Vector) {
            ...
            if (ChatObject.isChannel(chat)) {
                ...
                tL_channels_getParticipants.channel = MessagesController.getInstance(this.currentAccount).getInputChannel(chat.f1245id);
    ...
    public /* synthetic */ void lambda$onAttachedToWindow$0(List list) {
        ...
        while (it.hasNext()) {
            ...
            while (true) {
                ...
                List<UserSeen> list2 = this.users;
                if (i >= size) {
                    list2.add(userSeen);
                    break;
                } else if (MessageObject.getObjectPeerId(list2.get(i).user) != MessageObject.getObjectPeerId(userSeen.user)) {
                    i++;
    ...
    public /* synthetic */ void lambda$onAttachedToWindow$1(TLObject tLObject, List list, List list2, List list3, Runnable runnable) {
        if (tLObject != null) {
            ...
            for (int i = 0; i < tL_channels_channelParticipants.users.size(); i++) {
                ...
                int iIndexOf = list.indexOf(Long.valueOf(user.f1407id));
    ...
    public /* synthetic */ void lambda$loadReactions$6(int i, TLRPC.TL_messages_messageReactionsList tL_messages_messageReactionsList) {
        ...
        while (i2 < size) {
            ...
            TLRPC.Peer peer = this.message.messageOwner.from_id;
            if (peer != null && user2.f1407id != peer.user_id) {
                int i3 = 0;
                while (true) {
                    int size2 = this.users.size();
                    List<UserSeen> list = this.users;
                    if (i3 >= size2) {
                        list.add(new UserSeen(user2, 0));
                        break;
                    } else if (list.get(i3).dialogId == user2.f1407id) {
                        break;
                    } else {
                        i3++;
                    }
        ...
        while (i4 < size3) {
            ...
            if (peer2 != null && chat2.f1245id != peer2.user_id) {
                int i5 = 0;
                while (true) {
                    int size4 = this.users.size();
                    List<UserSeen> list2 = this.users;
                    if (i5 >= size4) {
                        list2.add(new UserSeen(chat2, 0));
                        break;
                    } else if (list2.get(i5).dialogId == (-chat2.f1245id)) {
                        break;
                    } else {
                        i5++;
                    }
    ...
    */
    private void updateView() {
        ...
        L11:
            ...
            if (r0 >= r4) goto L37
            int r3 = r3.size()
            org.telegram.ui.Components.AvatarsImageView r4 = r6.avatarsImageView
            if (r0 >= r3) goto L2e
        ...
        L37:
            ...
            goto L52
        L45:
            int r0 = org.telegram.messenger.AndroidUtilities.m1036dp(r3)
        L49:
            float r0 = (float) r0
            goto L52
        L4b:
        ...
        L5d:
            ...
            org.telegram.ui.Components.FlickerLoadingView r6 = r6.flickerLoadingView
            r1.<init>(r6)
            android.view.ViewPropertyAnimator r6 = r0.setListener(r1)
            r6.start()
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.ReactedHeaderView.updateView():void");
    }
