...
public class PermanentLinkBottomSheet extends BottomSheet {
    ...
    public PermanentLinkBottomSheet(Context context, boolean z, final BaseFragment baseFragment, final TLRPC.ChatFull chatFull, long j, boolean z2) {
        ...
        imageView.setImageResource(C2797R.drawable.ic_layer_close);
        ...
        RLottieDrawable rLottieDrawable = new RLottieDrawable(C2797R.raw.shared_link_enter, _UrlKt.FRAGMENT_ENCODE_SET + C2797R.raw.shared_link_enter, AndroidUtilities.m1036dp(90.0f), AndroidUtilities.m1036dp(90.0f), false, null);
        ...
        textView.setText(LocaleController.getString(C2797R.string.InviteLink));
        ...
        textView2.setText(LocaleController.getString(z2 ? C2797R.string.LinkInfoChannel : C2797R.string.LinkInfo));
        ...
        textView3.setText(LocaleController.getString(C2797R.string.ManageInviteLinks));
        ...
        textView3.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1036dp(8.0f), 0, ColorUtils.setAlphaComponent(Theme.getColor(i), 120)));
    ...
    public /* synthetic */ void lambda$new$2(TLRPC.ChatFull chatFull, BaseFragment baseFragment, View view) {
        ManageLinksActivity manageLinksActivity = new ManageLinksActivity(chatFull.f1246id, 0L, 0);
    ...
    public void updateColors() {
        ...
        int i = Theme.key_featuredStickers_addButton;
        rLottieImageView.setBackground(Theme.createCircleDrawable(iM1036dp, Theme.getColor(i)));
        this.manage.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1036dp(8.0f), 0, ColorUtils.setAlphaComponent(Theme.getColor(i), 120)));
