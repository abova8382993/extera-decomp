...
public class MuteDrawable extends Drawable {
    ...
    public MuteDrawable(Context context) {
        ...
        this.baseDrawable = context.getResources().getDrawable(C2797R.drawable.filled_sound_on).mutate();
    ...
    public void draw(Canvas canvas) {
        ...
        if (f > 0.0f) {
            ...
            float fCenterX = (bounds.centerX() - AndroidUtilities.m1036dp(9.0f)) + fDpf2;
            float fCenterY = (bounds.centerY() - AndroidUtilities.m1036dp(9.0f)) + fDpf2;
            float fCenterX2 = (bounds.centerX() + AndroidUtilities.m1036dp(9.0f)) - fDpf2;
            float fCenterY2 = (bounds.centerY() + AndroidUtilities.m1036dp(9.0f)) - fDpf2;
            if (this.muted) {
