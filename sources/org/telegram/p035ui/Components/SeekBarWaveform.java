...
public class SeekBarWaveform {
    ...
    */
    public void draw(android.graphics.Canvas r21, android.view.View r22) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.SeekBarWaveform.draw(android.graphics.Canvas, android.view.View):void");
    }
    ...
    private void drawFill(Canvas canvas, float f) {
        ...
        if (f2 > 0.0f) {
            if (this.loadingPaint == null || Math.abs(this.loadingPaintWidth - this.width) > AndroidUtilities.m1036dp(8.0f) || this.loadingPaintColor1 != this.innerColor || this.loadingPaintColor2 != this.outerColor) {
    ...
    private void addBar(Path path, float f, float f2) {
        float fDpf2 = AndroidUtilities.dpf2(2.0f);
        int iM1036dp = (this.height - AndroidUtilities.m1036dp(14.0f)) / 2;
        float f3 = f2 * this.waveScaling;
        RectF rectF = AndroidUtilities.rectTmp;
        float f4 = fDpf2 / 2.0f;
        rectF.set((AndroidUtilities.dpf2(1.0f) + f) - f4, AndroidUtilities.m1036dp(7.0f) + iM1036dp + ((-f3) - f4), f + AndroidUtilities.dpf2(1.0f) + f4, iM1036dp + AndroidUtilities.m1036dp(7.0f) + f3 + f4);
    ...
    public static class Particles {
        ...
        public Particles(int i, Runnable runnable) {
            ...
            paint.setStrokeWidth(AndroidUtilities.m1036dp(1.33f));
        }
        ...
        public void draw(Canvas canvas, float f) {
            ...
            while (i < this.particles.size()) {
                ...
                float f2 = jMin;
                float f3 = particle.f1678t - (f2 / particle.f1677d);
                particle.f1678t = f3;
                if (f3 < 0.0f) {
                    ...
                    float f4 = particle.f1682x;
                    float f5 = particle.f1680vx;
                    float f6 = particle.f1679v;
                    particle.f1682x = f4 + (((f5 * f6) * f2) / 500.0f);
                    float f7 = particle.f1683y;
                    float f8 = particle.f1681vy;
                    particle.f1683y = f7 + (((f6 * f8) * f2) / 500.0f);
                    particle.f1681vy = f8 - ((((long) AndroidUtilities.m1036dp(0.33f)) * jMin) / 500.0f);
                }
                i++;
            }
            if (this.emitArea != null) {
                ...
                for (int i2 = 0; i2 < iMin; i2++) {
                    ...
                    particle2.f1682x = rectF.left + (rectF.width() * Utilities.random.nextFloat());
                    RectF rectF2 = this.emitArea;
                    particle2.f1683y = rectF2.top + (rectF2.height() * Utilities.random.nextFloat());
                    double dNextInt = ((double) (Utilities.random.nextInt(200) - 125)) * 0.017453292519943295d;
                    particle2.f1680vx = ((float) (Math.cos(dNextInt) - Math.sin(dNextInt))) * 0.8f;
                    particle2.f1681vy = ((float) (Math.sin(dNextInt) + Math.cos(dNextInt))) - 0.2f;
                    particle2.f1678t = 1.0f;
                    particle2.f1679v = AndroidUtilities.m1036dp((Utilities.random.nextFloat() * 7.0f) + 10.0f);
                    particle2.f1677d = AndroidUtilities.lerp(420, 550, Utilities.random.nextFloat());
                    this.particles.add(particle2);
                }
            }
            for (int i3 = 0; i3 < this.particles.size(); i3++) {
                Particle particle3 = this.particles.get(i3);
                this.paint.setAlpha((int) (255.0f * f * particle3.f1678t));
                canvas.drawPoint(particle3.f1682x, particle3.f1683y, this.paint);
            }
