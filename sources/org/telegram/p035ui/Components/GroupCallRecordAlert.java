...
public abstract class GroupCallRecordAlert extends BottomSheet {
    ...
    public GroupCallRecordAlert(Context context, TLRPC.Chat chat, boolean z) {
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.Components.GroupCallRecordAlert.1
            ...
            public void onMeasure(int i, int i2) {
                ...
                int size = (View.MeasureSpec.getSize(i) - AndroidUtilities.m1036dp(200.0f)) / 2;
                GroupCallRecordAlert.this.viewPager.setPadding(size, 0, size, 0);
                super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(370.0f), TLObject.FLAG_30));
                measureChildWithMargins(GroupCallRecordAlert.this.titlesLayout, View.MeasureSpec.makeMeasureSpec(0, 0), 0, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(64.0f), TLObject.FLAG_30), 0);
            }
        ...
        if (ChatObject.isChannelOrGiga(chat)) {
            textView.setText(LocaleController.getString(C2797R.string.VoipChannelRecordVoiceChat));
        } else {
            textView.setText(LocaleController.getString(C2797R.string.VoipRecordVoiceChat));
        }
        ...
        textView2.setText(LocaleController.getString(C2797R.string.VoipRecordVoiceChatInfo));
            ...
            */
            public void onSizeChanged(int r11, int r12, int r13, int r14) {
                ...
                L5d:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.GroupCallRecordAlert.C44213.onSizeChanged(int, int, int, int):void");
            }
            ...
            public void onDraw(Canvas canvas) {
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.m1036dp(6.0f), AndroidUtilities.m1036dp(6.0f), this.gradientPaint[GroupCallRecordAlert.this.currentPage]);
                if (GroupCallRecordAlert.this.pageOffset > 0.0f) {
                    ...
                    if (i2 < paintArr.length) {
                        ...
                        canvas.drawRoundRect(rectF, AndroidUtilities.m1036dp(6.0f), AndroidUtilities.m1036dp(6.0f), this.gradientPaint[GroupCallRecordAlert.this.currentPage + 1]);
                    }
                }
                super.onDraw(canvas);
            }
        ...
        textView3.setMinWidth(AndroidUtilities.m1036dp(64.0f));
        ...
        this.positiveButton.setText(LocaleController.getString(C2797R.string.VoipRecordStart));
        this.positiveButton.setForeground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1036dp(6.0f), 0, ColorUtils.setAlphaComponent(Theme.getColor(i2), 76)));
        ...
        while (true) {
            ...
            this.titles[i3].setPadding(AndroidUtilities.m1036dp(10.0f), 0, AndroidUtilities.m1036dp(10.0f), 0);
            ...
            if (i3 == 0) {
                this.titles[i3].setText(LocaleController.getString(C2797R.string.VoipRecordAudio));
            } else {
                TextView[] textViewArr2 = this.titles;
                if (i3 == 1) {
                    textViewArr2[i3].setText(LocaleController.getString(C2797R.string.VoipRecordPortrait));
                } else {
                    textViewArr2[i3].setText(LocaleController.getString(C2797R.string.VoipRecordLandscape));
                }
            }
    ...
    public class Adapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup viewGroup, final int i) {
            ...
            imageView.setPadding(AndroidUtilities.m1036dp(18.0f), 0, AndroidUtilities.m1036dp(18.0f), 0);
            imageView.setScaleType(ImageView.ScaleType.FIT_XY);
            imageView.setLayoutParams(new ViewGroup.LayoutParams(AndroidUtilities.m1036dp(200.0f), -1));
            if (i == 0) {
                imageView.setContentDescription(LocaleController.getString(C2797R.string.VoipRecordAudio));
            } else if (i == 1) {
                imageView.setContentDescription(LocaleController.getString(C2797R.string.VoipRecordPortrait));
            } else {
                imageView.setContentDescription(LocaleController.getString(C2797R.string.VoipRecordLandscape));
            }
            if (i == 0) {
                i2 = C2797R.raw.record_audio;
            } else if (i == 1) {
                i2 = C2797R.raw.record_video_p;
            } else {
                i2 = C2797R.raw.record_video_l;
            }
