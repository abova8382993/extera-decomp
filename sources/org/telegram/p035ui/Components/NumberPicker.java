...
public class NumberPicker extends LinearLayout {
    ...
    private void init() {
        ...
        if (i != -1 && iApplyDimension != -1 && i > iApplyDimension) {
            g$$ExternalSyntheticBUOutline1.m207m("minHeight > maxHeight");
            return;
        }
        ...
        SeekBarAccessibilityDelegate seekBarAccessibilityDelegate = new SeekBarAccessibilityDelegate() { // from class: org.telegram.ui.Components.NumberPicker.1
            ...
            public CharSequence getContentDescription(View view) {
                Utilities.CallbackReturn callbackReturn = NumberPicker.this.contentDescriptionCallback;
                NumberPicker numberPicker = NumberPicker.this;
                if (callbackReturn != null) {
                    return (CharSequence) numberPicker.contentDescriptionCallback.run(Integer.valueOf(NumberPicker.this.mValue));
                }
    ...
    public NumberPicker(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.mTextSize = AndroidUtilities.m1036dp(i);
        init();
    }
    ...
    */
    public boolean dispatchKeyEvent(android.view.KeyEvent r6) {
        ...
        L60:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.NumberPicker.dispatchKeyEvent(android.view.KeyEvent):boolean");
    }
    ...
    */
    public void setWrapSelectorWheel(boolean r5) {
        ...
        L1f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.NumberPicker.setWrapSelectorWheel(boolean):void");
    }
    ...
    public void setMinValue(int i) {
        ...
        if (i < 0) {
            g$$ExternalSyntheticBUOutline1.m207m("minValue must be >= 0");
            return;
        }
        this.mMinValue = i;
        if (i > this.mValue) {
    ...
    public void setMaxValue(int i) {
        ...
        if (i < 0) {
            g$$ExternalSyntheticBUOutline1.m207m("maxValue must be >= 0");
            return;
        }
        this.mMaxValue = i;
        if (i < this.mValue) {
    ...
    private int makeMeasureSpec(int i, int i2) {
        if (i2 != -1) {
            ...
            if (mode != 1073741824) {
                CharCodeKt$$ExternalSyntheticBUOutline0.m873m("Unknown measure mode: ", mode);
                return 0;
            }
        }
        return i;
    ...
    public void changeValueByOne(boolean z) {
        ...
        Scroller scroller = this.mFlingScroller;
        if (z) {
            scroller.startScroll(0, 0, 0, -this.mSelectorElementHeight, 300);
        } else {
            scroller.startScroll(0, 0, 0, this.mSelectorElementHeight, 300);
        }
        invalidate();
    ...
    private void onScrollStateChange(int i) {
        ...
        if (i == 0) {
            ...
            if (accessibilityManager.isTouchExplorationEnabled()) {
                String[] strArr = this.mDisplayedValues;
                int i2 = this.mValue;
                String number = strArr == null ? formatNumber(i2) : strArr[i2 - this.mMinValue];
    ...
    private void ensureCachedScrollSelectorValue(int i) {
        ...
        if (i < i2 || i > this.mMaxValue) {
            number = _UrlKt.FRAGMENT_ENCODE_SET;
        } else {
            String[] strArr = this.mDisplayedValues;
            if (strArr != null) {
                number = strArr[i - i2];
    ...
    private boolean updateInputTextView() {
        String[] strArr = this.mDisplayedValues;
        int i = this.mValue;
        String number = strArr == null ? formatNumber(i) : strArr[i - this.mMinValue];
