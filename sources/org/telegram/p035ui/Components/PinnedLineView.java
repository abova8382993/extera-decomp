...
public class PinnedLineView extends View {
    ...
    public PinnedLineView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.fadePaint.setShader(new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.m1036dp(6.0f), new int[]{-1, 0}, new float[]{0.0f, 1.0f}, tileMode));
        Paint paint3 = this.fadePaint;
        PorterDuff.Mode mode = PorterDuff.Mode.DST_OUT;
        paint3.setXfermode(new PorterDuffXfermode(mode));
        this.fadePaint2 = new Paint();
        this.fadePaint2.setShader(new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.m1036dp(6.0f), new int[]{0, -1}, new float[]{0.0f, 1.0f}, tileMode));
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.replaceInProgress) {
            ...
            measuredHeight = (getMeasuredHeight() - (iM1036dp * 2)) / Math.min(this.totalCount, 3);
        }
        ...
        if (this.replaceInProgress) {
            ...
            if (measuredHeight2 < 0.0f) {
                ...
                float f8 = iM1036dp;
                if ((((this.totalCount - 1) * measuredHeight) + f8) - measuredHeight2 < (getMeasuredHeight() - iM1036dp) - measuredHeight) {
                    measuredHeight2 = (f8 + ((this.totalCount - 1) * measuredHeight)) - ((getMeasuredHeight() - iM1036dp) - measuredHeight);
                }
            }
        }
        ...
        while (iMax < iMin) {
            ...
            if (f11 < 0.0f || f10 > getMeasuredHeight()) {
                ...
                if (z && iMax >= this.animateToTotal) {
                    f = f2;
                    this.paint.setColor(ColorUtils.setAlphaComponent(this.color, (int) ((Color.alpha(r14) / 255.0f) * 76.0f * (f - this.animationProgress))));
                    ...
                    f = f2;
                    if (z && iMax >= this.animateFromTotal) {
        ...
        if (this.needDrawFade) {
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), AndroidUtilities.m1036dp(6.0f), this.fadePaint);
            canvas.drawRect(0.0f, getMeasuredHeight() - AndroidUtilities.m1036dp(6.0f), getMeasuredWidth(), getMeasuredHeight(), this.fadePaint);
            canvas.translate(0.0f, getMeasuredHeight() - AndroidUtilities.m1036dp(6.0f));
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), AndroidUtilities.m1036dp(6.0f), this.fadePaint2);
        }
    }
    ...
    public void set(int i, int i2, boolean z) {
        ...
        if (!z) {
            ...
            if (f < 0.0f) {
                ...
                float f2 = (((this.totalCount - 1) * r3) + iM1036dp) - f;
                int measuredHeight = getMeasuredHeight() - iM1036dp;
                int i5 = this.lineHFrom;
                if (f2 < measuredHeight - i5) {
                    this.startOffsetFrom = (((this.totalCount - 1) * i5) + iM1036dp) - ((getMeasuredHeight() - iM1036dp) - this.lineHFrom);
                }
            }
            ...
            if (f3 < 0.0f) {
                ...
                int i6 = i2 - 1;
                float f4 = ((r3 * i6) + iM1036dp) - f3;
                int measuredHeight2 = getMeasuredHeight() - iM1036dp;
                int i7 = this.lineHTo;
                if (f4 < measuredHeight2 - i7) {
                    this.startOffsetTo = ((i6 * i7) + iM1036dp) - ((getMeasuredHeight() - iM1036dp) - this.lineHTo);
                }
            }
            this.animateFromPosition = this.selectedPosition;
            this.animateToPosition = i;
