...
import org.telegram.p035ui.Components.Premium.HelloParticles;
...
public class VideoScreenPreview extends FrameLayout implements PagerHeaderView, NotificationCenter.NotificationCenterDelegate {
    ...
    public VideoScreenPreview(Context context, SvgHelper.SvgDrawable svgDrawable, int i, int i2, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (i2 == 1) {
            ...
            drawable3.size1 = 4;
            drawable3.f1646k3 = 0.98f;
            drawable3.f1645k2 = 0.98f;
            drawable3.f1644k1 = 0.98f;
        ...
        AspectRatioFrameLayout aspectRatioFrameLayout = new AspectRatioFrameLayout(context) { // from class: org.telegram.ui.Components.Premium.VideoScreenPreview.1
            ...
            public void onMeasure(int i4, int i5) {
                ...
                float fM1036dp = VideoScreenPreview.this.roundRadius - AndroidUtilities.m1036dp(3.0f);
                this.clipPath.addRoundRect(AndroidUtilities.rectTmp, fM1036dp, fM1036dp, Path.Direction.CW);
            }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.size != measuredWidth) {
            ...
            if (matrixParticlesDrawable != null) {
                ...
                this.matrixParticlesDrawable.excludeRect.inset(AndroidUtilities.m1036dp(16.0f), AndroidUtilities.m1036dp(16.0f));
            }
            ...
            if (drawable != null) {
                ...
                if (i5 == 6 || i5 == 9 || i5 == 3 || i5 == 7 || i5 == 24 || i5 == 11 || i5 == 4) {
                    ...
                    this.starDrawable.rect.inset(AndroidUtilities.m1036dp(30.0f), AndroidUtilities.m1036dp(30.0f));
                } else {
                    RectF rectF = AndroidUtilities.rectTmp;
                ...
                this.starDrawable.excludeRect.inset(AndroidUtilities.m1036dp(10.0f), AndroidUtilities.m1036dp(10.0f));
            }
            ...
            if (speedLineParticles$Drawable != null) {
                ...
                this.speedLinesDrawable.rect.inset(AndroidUtilities.m1036dp(100.0f), AndroidUtilities.m1036dp(100.0f));
            ...
            if (drawable2 != null) {
                ...
                this.helloParticlesDrawable.rect.inset(AndroidUtilities.m1036dp(0.0f), getMeasuredHeight() * 0.1f);
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.inset(-AndroidUtilities.m1036dp(3.0f), -AndroidUtilities.m1036dp(3.0f));
        rectF.inset(-AndroidUtilities.m1036dp(3.0f), -AndroidUtilities.m1036dp(3.0f));
        canvas.drawRoundRect(rectF, this.roundRadius + AndroidUtilities.m1036dp(3.0f), this.roundRadius + AndroidUtilities.m1036dp(3.0f), this.phoneFrame2);
        rectF.inset(AndroidUtilities.m1036dp(3.0f), AndroidUtilities.m1036dp(3.0f));
        ...
        float fM1036dp = this.roundRadius - AndroidUtilities.m1036dp(3.0f);
        this.roundRadius = fM1036dp;
        RoundedBitmapDrawable roundedBitmapDrawable = this.roundedBitmapDrawable;
        if (roundedBitmapDrawable != null) {
            roundedBitmapDrawable.setCornerRadius(fM1036dp);
        }
        ...
        if (z) {
            ...
            imageReceiver.setRoundRadius((int) f6, (int) f6, 0, 0);
        }
        ...
        canvas.drawCircle(this.imageReceiver.getCenterX(), this.imageReceiver.getImageY() + AndroidUtilities.m1036dp(12.0f), AndroidUtilities.m1036dp(6.0f), this.phoneFrame1);
    }
