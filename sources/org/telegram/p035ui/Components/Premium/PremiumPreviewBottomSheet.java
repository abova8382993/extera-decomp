...
import org.telegram.p035ui.Components.Premium.boosts.cells.TextInfoCell;
...
public class PremiumPreviewBottomSheet extends BottomSheetWithRecyclerListView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public int getAdditionItemViewType(int i) {
        return 0;
    }

    public boolean isAdditionViewClickable(int i) {
        return false;
    }
    ...
    public void onAdditionItemClicked(View view) {
    }

    public void onBindAdditionCell(View view, int i) {
    }
    ...
    public PremiumPreviewBottomSheet(final BaseFragment baseFragment, final int i, TLRPC.User user, GiftPremiumBottomSheet$GiftTier giftPremiumBottomSheet$GiftTier, TL_stars.StarGift starGift, Theme.ResourcesProvider resourcesProvider) {
        ...
        premiumGradientTools.f1635y1 = 1.0f;
        premiumGradientTools.f1634x2 = 0.0f;
        premiumGradientTools.f1636y2 = 0.0f;
        premiumGradientTools.f1631cx = 0.0f;
        premiumGradientTools.f1632cy = 0.0f;
        updateRows();
        this.recyclerListView.setPadding(AndroidUtilities.m1036dp(6.0f), 0, AndroidUtilities.m1036dp(6.0f), 0);
    ...
    private void titleLoaded(CharSequence charSequence, boolean z) {
        ...
        if (this.titleView[1].getVisibility() != 0) {
            ...
            if (z) {
                linksTextViewArr2[1].setAlpha(0.0f);
            ...
            linksTextViewArr2[1].setAlpha(1.0f);
            this.titleView[1].setVisibility(0);
    ...
    */
    public void setTitle(boolean r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.Premium.PremiumPreviewBottomSheet.setTitle(boolean):void");
    }
    ...
    public CharSequence getTitle() {
        return LocaleController.getString(C2797R.string.TelegramPremium);
    }
    ...
    public class Adapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                    ...
                    public void onMeasure(int i5, int i6) {
                        ...
                        if (gLIconTextureView != null) {
                            ...
                            if (view2 != null) {
                                ...
                                f = 0.0f;
                                PremiumPreviewBottomSheet.this.starParticlesView.setTranslationY(f - (r1.getMeasuredHeight() / 2.0f));
                            }
                        }
                ...
                shadowSectionCell = new View(context) { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet.Adapter.7
                    ...
                    public void onMeasure(int i5, int i6) {
                        super.onMeasure(i5, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(68.0f), TLObject.FLAG_30));
                    }
                };
            } else if (i == 4) {
                ...
                shadowSectionCell = new PremiumFeatureCell(context, ((BottomSheet) PremiumPreviewBottomSheet.this).resourcesProvider) { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet.Adapter.6
                    ...
                    public void dispatchDraw(Canvas canvas2) {
                        ...
                        canvas2.drawRoundRect(rectF, AndroidUtilities.m1036dp(8.0f), AndroidUtilities.m1036dp(8.0f), PremiumPreviewBottomSheet.this.gradientTools.paint);
                ...
                String string = LocaleController.getString("GiftPremiumPrivacyPolicyAndTerms", C2797R.string.GiftPremiumPrivacyPolicyAndTerms);
                ...
                }), AndroidUtilities.replaceSingleTag(LocaleController.getString("GiftPremiumPrivacyPolicy", C2797R.string.GiftPremiumPrivacyPolicy), i5, 0, new Runnable() { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet$Adapter$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public /* synthetic */ void lambda$onCreateViewHolder$0() {
            Browser.openUrl(PremiumPreviewBottomSheet.this.fragment.getParentActivity(), LocaleController.getString(C2797R.string.TermsOfServiceUrl));
        }

        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onCreateViewHolder$1() {
            Browser.openUrl(PremiumPreviewBottomSheet.this.fragment.getParentActivity(), LocaleController.getString(C2797R.string.PrivacyPolicyUrl));
        }
    ...
    public boolean onCustomOpenAnimation() {
        ...
        this.enterAnimator.addListener(new C47554(rightDrawable));
    ...
    public class C47554 extends AnimatorListenerAdapter {
        final /* synthetic */ Drawable val$startEnterFromDrawable;

        public C47554(Drawable drawable) {
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (i == NotificationCenter.groupStickersDidLoad && (inputStickerSet = this.statusStickerSet) != null && inputStickerSet.f1270id == ((Long) objArr[0]).longValue()) {
            setTitle(true);
        }
    }
}
