...
public class StarParticlesView extends View {
    ...
    public void onAttachedToWindow() {
        ...
        Utilities.Callback<Boolean> callback = new Utilities.Callback() { // from class: org.telegram.ui.Components.Premium.StarParticlesView$$ExternalSyntheticLambda0
    ...
    public void onMeasure(int i, int i2) {
        ...
        this.drawable.rect.set(0.0f, 0.0f, getStarsRectWidth(), AndroidUtilities.m1036dp(140.0f));
        ...
        this.drawable.rect2.set(-AndroidUtilities.m1036dp(15.0f), -AndroidUtilities.m1036dp(15.0f), getMeasuredWidth() + AndroidUtilities.m1036dp(15.0f), getMeasuredHeight() + AndroidUtilities.m1036dp(15.0f));
    ...
    public void setClipWithGradient() {
        ...
        LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.m1036dp(12.0f), new int[]{16777215, -1}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.isLiteModeParticlesAllowed) {
            ...
            if (this.clipGradientPaint != null) {
                ...
                this.clipGradientMatrix.postTranslate(0.0f, (getHeight() + 1) - AndroidUtilities.m1036dp(12.0f));
                this.clipGradient.setLocalMatrix(this.clipGradientMatrix);
                canvas2.drawRect(0.0f, getHeight() - AndroidUtilities.m1036dp(12.0f), getWidth(), getHeight(), this.clipGradientPaint);
                this.clipGradientMatrix.reset();
                this.clipGradientMatrix.postRotate(180.0f);
                this.clipGradientMatrix.postTranslate(0.0f, AndroidUtilities.m1036dp(12.0f));
                this.clipGradient.setLocalMatrix(this.clipGradientMatrix);
                canvas2.drawRect(0.0f, 0.0f, getWidth(), AndroidUtilities.m1036dp(12.0f), this.clipGradientPaint);
                canvas2.restore();
                canvas2.restore();
            }
    ...
    public static class Drawable {
        ...
        public float f1644k1 = 0.85f;

        /* JADX INFO: renamed from: k2 */
        public float f1645k2 = 0.85f;

        /* JADX INFO: renamed from: k3 */
        public float f1646k3 = 0.9f;
        public long minLifeTime = 2000;
        public int randLifeTime = MediaDataController.MAX_STYLE_RUNS_COUNT;

        /* JADX INFO: renamed from: dt */
        private final float f1643dt = 1000.0f / AndroidUtilities.screenRefreshRate;
        ...
        */
        ...
        public int getPathColor(int i) {
            ...
            if (i2 == 100) {
                return ColorUtils.setAlphaComponent(Theme.getColor(i3, this.resourcesProvider), 200);
            }
            return Theme.getColor(i3, this.resourcesProvider);
        }
        ...
        public void onDraw(Canvas canvas, float f) {
            ...
            if (this.useRotate) {
                this.matrix.reset();
                float f2 = jClamp;
                float f3 = this.f1640a + ((f2 / 40000.0f) * 360.0f);
                this.f1640a = f3;
                this.f1641a1 += (f2 / 50000.0f) * 360.0f;
                this.f1642a2 += (f2 / 60000.0f) * 360.0f;
                this.matrix.setRotate(f3, this.rect.centerX() + this.centerOffsetX, this.rect.centerY() + this.centerOffsetY);
                this.matrix2.setRotate(this.f1641a1, this.rect.centerX() + this.centerOffsetX, this.rect.centerY() + this.centerOffsetY);
                this.matrix3.setRotate(this.f1642a2, this.rect.centerX() + this.centerOffsetX, this.rect.centerY() + this.centerOffsetY);
                this.pointsCount1 = 0;
                this.pointsCount2 = 0;
                this.pointsCount3 = 0;
                for (int i = 0; i < this.particles.size(); i++) {
        ...
        public class Particle {
            ...
            private float f1648x;

            /* JADX INFO: renamed from: x2 */
            private float f1649x2;

            /* JADX INFO: renamed from: y */
            private float f1650y;

            /* JADX INFO: renamed from: y2 */
            private float f1651y2;
            ...
            public void updatePoint() {
                ...
                if (i == 0) {
                    ...
                    fArr[i2 * 2] = this.f1648x;
                    fArr[(i2 * 2) + 1] = this.f1650y;
                ...
                if (i == 1) {
                    ...
                    fArr2[i3 * 2] = this.f1648x;
                    fArr2[(i3 * 2) + 1] = this.f1650y;
                ...
                if (i == 2) {
                    ...
                    fArr3[i4 * 2] = this.f1648x;
                    fArr3[(i4 * 2) + 1] = this.f1650y;
            ...
            */
            ...
            public void genPosition(long j) {
                ...
                if (drawable2.distributionAlgorithm) {
                    ...
                    while (i2 < 10) {
                        ...
                        while (i3 < Drawable.this.particles.size()) {
                            ...
                            if (drawable3.startFromCenter) {
                                f2 = drawable3.particles.get(i3).f1649x2 - fAbs3;
                                f3 = Drawable.this.particles.get(i3).f1651y2;
                            } else {
                                f2 = drawable3.particles.get(i3).f1648x - fAbs3;
                                f3 = Drawable.this.particles.get(i3).f1650y;
                            }
                            float f8 = f3 - fAbs4;
                    ...
                    if (drawable2.isCircle) {
                        ...
                        if (!Drawable.this.flip[this.starIndex] || this.first) {
                            ...
                            fAbs5 = Math.min(fAbs5, AndroidUtilities.m1036dp(10.0f));
                            fM1036dp = AndroidUtilities.m1036dp(30.0f) + 0.0f;
                        }
                        double d = fAbs5;
                        double d2 = fAbs6;
                        this.f1648x = Drawable.this.rect.centerX() + Drawable.this.centerOffsetX + ((float) (Math.sin(Math.toRadians(d2)) * d));
                        this.f1650y = Drawable.this.rect.centerY() + fM1036dp + Drawable.this.centerOffsetY + ((float) (d * Math.cos(Math.toRadians(d2))));
                    } else {
                        this.f1648x = drawable2.rect.left + Math.abs(Utilities.fastRandom.nextInt() % Drawable.this.rect.width());
                        this.f1650y = Drawable.this.rect.top + Math.abs(Utilities.fastRandom.nextInt() % Drawable.this.rect.height());
                    }
                }
                ...
                if (drawable4.flip[this.starIndex]) {
                    ...
                    float f12 = this.f1650y;
                    float fCenterY = drawable4.rect.centerY();
                    Drawable drawable5 = Drawable.this;
                    dAtan2 = Math.atan2(f12 - (fCenterY + drawable5.centerOffsetY), this.f1648x - (drawable5.rect.centerX() + Drawable.this.centerOffsetX));
                }
