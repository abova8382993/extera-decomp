...
public abstract class BaseCell extends FrameLayout {
    ...
    public BaseCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        avatarDrawable.setRoundRadius(AndroidUtilities.m1036dp(40.0f));
    ...
    public void setSubtitle(CharSequence charSequence) {
        ...
        if (this.imageView.getVisibility() == 8) {
            ...
            if (z) {
                simpleTextView2.setTranslationX(AndroidUtilities.m1036dp(40.0f));
                this.subtitleTextView.setTranslationX(AndroidUtilities.m1036dp(40.0f));
            } else {
                simpleTextView2.setTranslationX(AndroidUtilities.m1036dp(-40.0f));
                this.subtitleTextView.setTranslationX(AndroidUtilities.m1036dp(-40.0f));
            }
    ...
    public void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(getFullHeight()), TLObject.FLAG_30));
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.needDivider) {
            ...
            if (LocaleController.isRTL) {
                canvas.drawRect(0.0f, getHeight() - 1, getWidth() - AndroidUtilities.m1036dp(iDividerPadding), getHeight(), this.dividerPaint);
            } else {
                canvas.drawRect(AndroidUtilities.m1036dp(iDividerPadding), getHeight() - 1, getWidth(), getHeight(), this.dividerPaint);
            }
        }
    }
}
