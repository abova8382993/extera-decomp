...
public class DurationCell extends BaseCell {
    ...
    public void setDuration(Object obj, int i, int i2, long j, CharSequence charSequence, boolean z, boolean z2) {
        ...
        if (i >= 12) {
            simpleTextView.setText(LocaleController.formatPluralString("Years", 1, new Object[0]));
        } else {
            simpleTextView.setText(LocaleController.formatPluralString("Months", i, new Object[0]));
        }
