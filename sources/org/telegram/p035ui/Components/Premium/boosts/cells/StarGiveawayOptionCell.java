...
public class StarGiveawayOptionCell extends FrameLayout {
    ...
    public StarGiveawayOptionCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.titleView.setTextSize(AndroidUtilities.m1036dp(16.0f));
        addView(this.titleView, LayoutHelper.createFrame(-1, 20.0f, 51, 64.0f, 8.0f, 80.0f, 0.0f));
        SpannableString spannableString = new SpannableString("x");
        this.loading1 = spannableString;
        spannableString.setSpan(new LoadingSpan(this.titleView, AndroidUtilities.m1036dp(90.0f)), 0, 1, 33);
        ...
        this.subtitleView.setTextSize(AndroidUtilities.m1036dp(13.0f));
        ...
        spannableString2.setSpan(new LoadingSpan(this.subtitleView, AndroidUtilities.m1036dp(70.0f)), 0, 1, 33);
    ...
    public void setOption(TL_stars.TL_starsGiveawayOption tL_starsGiveawayOption, int i, long j, boolean z, boolean z2) {
        ...
        if (tL_starsGiveawayOption == null) {
            animatedTextView.setText(this.loading1, false);
            this.subtitleView.setText(this.loading2, z3);
            this.priceView.setText(_UrlKt.FRAGMENT_ENCODE_SET);
        } else {
            animatedTextView.setText(LocaleController.formatPluralStringComma("GiveawayStars", (int) tL_starsGiveawayOption.stars, ' '), false);
    ...
    public void onDraw(Canvas canvas) {
        ...
        float fM1036dp4 = AndroidUtilities.m1036dp(64.0f);
        float fM1036dp5 = AndroidUtilities.m1036dp(8.0f);
        for (int iCeil = ((int) Math.ceil(f)) - 1; iCeil >= 0; iCeil--) {
            float fClamp = Utilities.clamp(f - iCeil, 1.0f, 0.0f);
            float f2 = (((iCeil - 1) - (1.0f - fClamp)) * fM1036dp3 * 1.0f) + fM1036dp4;
            int i = (int) f2;
            int i2 = (int) fM1036dp5;
            int i3 = (int) (f2 + fM1036dp);
            int i4 = (int) (fM1036dp5 + fM1036dp2);
        ...
        this.titleView.setTranslationX(AndroidUtilities.m1036dp(22.0f) + (fM1036dp3 * f));
    }
}
