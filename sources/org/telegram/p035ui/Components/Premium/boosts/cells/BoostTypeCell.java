...
public class BoostTypeCell extends BaseCell {
    ...
    public void setType(int i, int i2, TLRPC.User user, boolean z) {
        ...
        this.selectedType = i;
        if (i == TYPE_GIVEAWAY) {
            this.titleTextView.setText(LocaleController.getString(C2797R.string.BoostingCreateGiveaway));
            setSubtitle(LocaleController.getString(C2797R.string.BoostingWinnersRandomly));
            ...
            setDivider(true);
            setBackground(Theme.getThemedDrawableByKey(getContext(), C2797R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
        } else if (i == TYPE_SPECIFIC_USERS) {
            this.titleTextView.setText(LocaleController.getString(C2797R.string.BoostingAwardSpecificUsers));
            if (i2 == 1 && user != null) {
                ...
                setSubtitle(withArrow(LocaleController.getString(C2797R.string.BoostingSelectRecipients)));
            }
            ...
            setDivider(false);
            setBackground(Theme.getThemedDrawableByKey(getContext(), C2797R.drawable.greydivider_top, Theme.key_windowBackgroundGrayShadow));
        } else if (i == TYPE_PREMIUM) {
            this.titleTextView.setText(LocaleController.getString(C2797R.string.BoostingPremium));
            if (i2 == 1 && user != null) {
                setSubtitle(withArrow(Emoji.replaceEmoji(UserObject.getUserName(user), this.subtitleTextView.getPaint().getFontMetricsInt(), false)));
            } else if (i2 > 0) {
                setSubtitle(withArrow(LocaleController.formatPluralString("Recipient", i2, new Object[0])));
            } else {
                setSubtitle(withArrow(LocaleController.getString(C2797R.string.BoostingWinnersRandomly)));
            }
            this.subtitleTextView.setTextColor(Theme.getColor(Theme.key_dialogTextBlue2, this.resourcesProvider));
            ...
            this.titleTextView.setText(TextCell.applyNewSpan(LocaleController.getString(C2797R.string.BoostingStars)));
            setSubtitle(LocaleController.getString(C2797R.string.BoostingWinnersRandomly));
            this.subtitleTextView.setTextColor(Theme.getColor(Theme.key_dialogTextGray3, this.resourcesProvider));
