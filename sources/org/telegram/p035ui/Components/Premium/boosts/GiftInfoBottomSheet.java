...
import org.telegram.p035ui.Components.Premium.boosts.adapters.GiftInfoAdapter;
...
public class GiftInfoBottomSheet extends BottomSheetWithRecyclerListView {
    ...
    public CharSequence getTitle() {
        return this.isUnused ? LocaleController.getString(C2797R.string.BoostingGiftLink) : LocaleController.getString(C2797R.string.BoostingUsedGiftLink);
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.boosts.GiftInfoBottomSheet$2 */
    /* JADX INFO: loaded from: classes7.dex */
    public class C47812 extends GiftInfoAdapter {
        public C47812(Theme.ResourcesProvider resourcesProvider) {
            super(resourcesProvider);
        }

        @Override // org.telegram.p035ui.Components.Premium.boosts.adapters.GiftInfoAdapter
        public void dismiss() {
            GiftInfoBottomSheet.this.lambda$new$0();
        }

        @Override // org.telegram.p035ui.Components.Premium.boosts.adapters.GiftInfoAdapter
        public void afterCodeApplied() {
        ...
        public void onObjectClicked(TLObject tLObject) {
            ...
            if (tLObject instanceof TLRPC.Chat) {
                GiftInfoBottomSheet.this.getBaseFragment().presentFragment(ChatActivity.m1139of(-((TLRPC.Chat) tLObject).f1245id));
                return;
            }
            if (tLObject instanceof TLRPC.User) {
                GiftInfoBottomSheet.this.getBaseFragment().presentFragment(ChatActivity.m1139of(((TLRPC.User) tLObject).f1407id));
                return;
            }
        ...
        public void onHiddenLinkClicked() {
            ...
            if ((GiftInfoBottomSheet.this.slug == null || GiftInfoBottomSheet.this.slug.isEmpty()) && GiftInfoBottomSheet.this.giftCode.to_id == -1) {
                string = LocaleController.getString(C2797R.string.BoostingOnlyGiveawayCreatorSeeLink);
            } else {
                string = LocaleController.getString(C2797R.string.BoostingOnlyRecipientCode);
            }
            GiftInfoBottomSheet giftInfoBottomSheet = GiftInfoBottomSheet.this;
            BulletinFactory.m1142of(giftInfoBottomSheet.container, ((BottomSheet) giftInfoBottomSheet).resourcesProvider).createSimpleBulletin(C2797R.raw.chats_infotip, string).show(true);
        }
    }

    @Override // org.telegram.p035ui.Components.BottomSheetWithRecyclerListView
    public RecyclerListView.SelectionAdapter createAdapter(RecyclerListView recyclerListView) {
        C47812 c47812 = new C47812(this.resourcesProvider);
        this.adapter = c47812;
        return c47812;
    }
}
