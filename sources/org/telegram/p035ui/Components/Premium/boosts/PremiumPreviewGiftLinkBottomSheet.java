...
import org.telegram.p035ui.Components.Premium.boosts.cells.LinkCell;
...
public class PremiumPreviewGiftLinkBottomSheet extends PremiumPreviewBottomSheet {
    ...
    public void setTitle(boolean z) {
        ...
        ((ViewGroup.MarginLayoutParams) this.subtitleView.getLayoutParams()).bottomMargin = AndroidUtilities.m1036dp(14.0f);
        ((ViewGroup.MarginLayoutParams) this.subtitleView.getLayoutParams()).topMargin = AndroidUtilities.m1036dp(12.0f);
        this.subtitleView.setText(AndroidUtilities.replaceCharSequence("%1$s", AndroidUtilities.replaceSingleTag(LocaleController.getString("GiftPremiumAboutThisLink", C2797R.string.GiftPremiumAboutThisLink), Theme.key_chat_messageLinkIn, 0, new PremiumPreviewGiftLinkBottomSheet$$ExternalSyntheticLambda1(this)), AndroidUtilities.replaceTags(LocaleController.getString("GiftPremiumAboutThisLinkEnd", C2797R.string.GiftPremiumAboutThisLinkEnd))));
    }
    ...
    public /* synthetic */ boolean lambda$share$0(String str, DialogsActivity dialogsActivity, ArrayList arrayList, CharSequence charSequence, boolean z, boolean z2, int i, int i2, TopicsFragment topicsFragment) {
        ...
        while (i3 < arrayList.size()) {
            ...
            getBaseFragment().getSendMessagesHelper().sendMessage(SendMessagesHelper.SendMessageParams.m1075of(str, j2, null, null, null, true, null, null, null, true, 0, 0, null, false));
            i3++;
            j = j2;
        }
    ...
    public View onCreateAdditionCell(int i, Context context) {
        ...
        linkCell.setPadding(0, 0, 0, AndroidUtilities.m1036dp(8.0f));
        return linkCell;
    }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.boosts.PremiumPreviewGiftLinkBottomSheet$1 */
    public class C47821 implements Bulletin.Delegate {
        public C47821() {
        }
