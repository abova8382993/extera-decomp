...
import org.telegram.p035ui.Components.Premium.boosts.adapters.BoostAdapter;
import org.telegram.p035ui.Components.Premium.boosts.cells.ActionBtnCell;
import org.telegram.p035ui.Components.Premium.boosts.cells.AddChannelCell;
import org.telegram.p035ui.Components.Premium.boosts.cells.BaseCell;
import org.telegram.p035ui.Components.Premium.boosts.cells.BoostTypeCell;
import org.telegram.p035ui.Components.Premium.boosts.cells.ChatCell;
import org.telegram.p035ui.Components.Premium.boosts.cells.DateEndCell;
import org.telegram.p035ui.Components.Premium.boosts.cells.DurationCell;
import org.telegram.p035ui.Components.Premium.boosts.cells.EnterPrizeCell;
import org.telegram.p035ui.Components.Premium.boosts.cells.ParticipantsTypeCell;
import org.telegram.p035ui.Components.Premium.boosts.cells.StarGiveawayOptionCell;
import org.telegram.p035ui.Components.Premium.boosts.cells.SwitcherCell;
...
public class BoostViaGiftsBottomSheet extends BottomSheetWithRecyclerListView implements SelectorBottomSheet.SelectedObjectsListener, NotificationCenter.NotificationCenterDelegate {
    ...
    private final List<Integer> starsNotExtended;
    private int top;
    ...
    public BoostViaGiftsBottomSheet(final BaseFragment baseFragment, boolean z, boolean z2, final long j, final TL_stories.PrepaidGiveaway prepaidGiveaway) {
        List<Integer> listAsList;
        List<Integer> listAsList2;
        ...
        recyclerListView.setPadding(i, 0, i, AndroidUtilities.m1036dp(68.0f));
        ...
        if (view instanceof DateEndCell) {
            BoostDialogs.showDatePicker(baseFragment.getContext(), this.selectedEndDate, new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.telegram.ui.Components.Premium.boosts.BoostViaGiftsBottomSheet$$ExternalSyntheticLambda10
                ...
                public final void didSelectDate(boolean z3, int i2, int i3) {
                    this.f$0.lambda$new$1(z3, i2, i3);
                }
    ...
    public /* synthetic */ void lambda$new$20(final TL_stories.PrepaidGiveaway prepaidGiveaway, final long j, BaseFragment baseFragment, View view) {
        ...
        int i2 = BoostTypeCell.TYPE_SPECIFIC_USERS;
        List<TLRPC.TL_premiumGiftCodeOption> list = this.giftCodeOptions;
        if (i == i2) {
            List<TLRPC.TL_premiumGiftCodeOption> listFilterGiftOptions = BoostRepository.filterGiftOptions(list, this.selectedUsers.size());
            for (int i3 = 0; i3 < listFilterGiftOptions.size(); i3++) {
                TLRPC.TL_premiumGiftCodeOption tL_premiumGiftCodeOption = listFilterGiftOptions.get(i3);
        ...
        List<TLRPC.TL_premiumGiftCodeOption> listFilterGiftOptions2 = BoostRepository.filterGiftOptions(list, getSelectedSliderValue());
        for (int i4 = 0; i4 < listFilterGiftOptions2.size(); i4++) {
            TLRPC.TL_premiumGiftCodeOption tL_premiumGiftCodeOption2 = listFilterGiftOptions2.get(i4);
    ...
    public /* synthetic */ void lambda$new$8(TL_stories.TL_prepaidStarsGiveaway tL_prepaidStarsGiveaway, long j, final long j2, final TL_stories.PrepaidGiveaway prepaidGiveaway, Void r7) {
        ...
        if (tL_prepaidStarsGiveaway != null) {
            ...
            if (safeLastFragment != null) {
                ...
                chatActivityM1139of.whenFullyVisible(new Runnable() { // from class: org.telegram.ui.Components.Premium.boosts.BoostViaGiftsBottomSheet$$ExternalSyntheticLambda26
                    @Override // java.lang.Runnable
                    public final void run() {
                        BulletinFactory.m1143of(chatActivityM1139of).createSimpleBulletin(C2797R.raw.stars_topup, LocaleController.getString(C2797R.string.StarsGiveawaySentPopup), AndroidUtilities.replaceTags(LocaleController.formatPluralStringComma("StarsGiveawaySentPopupInfo", (int) j2))).show(true);
                    }
                });
    ...
    public /* synthetic */ void lambda$new$12(final TL_stars.TL_starsGiveawayOption tL_starsGiveawayOption, Boolean bool, String str) {
        ...
        lambda$new$0();
        final ChatActivity chatActivityM1139of = ChatActivity.m1139of(-this.currentChat.f1245id);
        safeLastFragment.presentFragment(chatActivityM1139of);
        safeLastFragment.whenFullyVisible(new Runnable() { // from class: org.telegram.ui.Components.Premium.boosts.BoostViaGiftsBottomSheet$$ExternalSyntheticLambda25
            @Override // java.lang.Runnable
            public final void run() {
                BulletinFactory.m1143of(chatActivityM1139of).createSimpleBulletin(C2797R.raw.stars_send, LocaleController.getString(C2797R.string.StarsGiveawaySentPopup), AndroidUtilities.replaceTags(LocaleController.formatPluralStringComma("StarsGiveawaySentPopupInfo", (int) tL_starsGiveawayOption.stars))).setDuration(5000).show(true);
            }
        });
    ...
    private void updateActionButton(boolean z) {
        if (isPreparedGiveaway()) {
            ...
            boolean z2 = prepaidGiveaway instanceof TL_stories.TL_prepaidStarsGiveaway;
            ActionBtnCell actionBtnCell = this.actionBtn;
            if (z2) {
                actionBtnCell.setStartGiveAwayStyle(prepaidGiveaway.quantity, z);
                return;
            } else {
                actionBtnCell.setStartGiveAwayStyle(prepaidGiveaway.quantity * BoostRepository.giveawayBoostsPerPremium(), z);
                return;
            }
        }
        int i = this.selectedBoostSubType;
        int i2 = BoostTypeCell.TYPE_GIVEAWAY;
        ActionBtnCell actionBtnCell2 = this.actionBtn;
        if (i == i2) {
            actionBtnCell2.setStartGiveAwayStyle(getSelectedSliderValueWithBoosts(), z);
        } else {
            actionBtnCell2.setGiftPremiumStyle(this.selectedUsers.size() * BoostRepository.giveawayBoostsPerPremium(), z, this.selectedUsers.size() > 0);
        }
    }
    ...
    public int getTop() {
        return Math.max(-AndroidUtilities.m1036dp(16.0f), this.top - (this.actionBar.getVisibility() == 0 ? AndroidUtilities.statusBarHeight + AndroidUtilities.m1036dp(16.0f) : 0));
    }
    ...
    private int getSelectedSliderValue() {
        ...
        List<Integer> sliderValues = getSliderValues();
        ...
        return sliderValues.get(this.selectedStarsSliderIndex).intValue();
    }
    ...
    private int getSelectedSliderValueWithBoosts() {
        ...
        if (this.selectedBoostType == BoostTypeCell.TYPE_PREMIUM) {
            selectedSliderValue = this.sliderValues.get(this.selectedSliderIndex).intValue();
    ...
    private long getSelectedPerUserStars() {
        List<Long> perUserStarsValues = getPerUserStarsValues();
        int i = this.selectedStarsSliderIndex;
        ...
        return perUserStarsValues.get(this.selectedStarsSliderIndex).longValue();
    }

    private long getSelectedPerUserStars(long j) {
        List<Long> perUserStarsValues = getPerUserStarsValues(j);
        if (perUserStarsValues.isEmpty()) {
            return Math.round(j / getSelectedPerUserStars());
        }
        return perUserStarsValues.get(Utilities.clamp(this.selectedStarsSliderIndex, perUserStarsValues.size() - 1, 0)).longValue();
    }
    ...
    public TL_stars.TL_starsGiveawayOption getSelectedStarsOption(long j) {
        ArrayList<TL_stars.TL_starsGiveawayOption> giveawayOptions = StarsController.getInstance(this.currentAccount).getGiveawayOptions();
        if (giveawayOptions == null) {
            return null;
        }
        for (int i = 0; i < giveawayOptions.size(); i++) {
            TL_stars.TL_starsGiveawayOption tL_starsGiveawayOption = giveawayOptions.get(i);
    ...
    private List<Long> getPerUserStarsValues(long j) {
        ArrayList arrayList = new ArrayList();
    ...
    */
    private void updateRows(boolean r26, boolean r27) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.Premium.boosts.BoostViaGiftsBottomSheet.updateRows(boolean, boolean):void");
    }
    ...
    public CharSequence getTitle() {
        if (this.selectedBoostSubType == BoostTypeCell.TYPE_SPECIFIC_USERS) {
            return LocaleController.getString(C2797R.string.GiftPremium);
        }
        return LocaleController.formatString("BoostingStartGiveaway", C2797R.string.BoostingStartGiveaway, new Object[0]);
    }
