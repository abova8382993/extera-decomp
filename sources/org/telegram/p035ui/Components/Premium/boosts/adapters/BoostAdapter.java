...
import org.telegram.p035ui.Components.Premium.boosts.cells.BoostTypeSingleCell;
...
import org.telegram.p035ui.Components.Premium.boosts.cells.HeaderCell;
import org.telegram.p035ui.Components.Premium.boosts.cells.ParticipantsTypeCell;
import org.telegram.p035ui.Components.Premium.boosts.cells.SliderCell;
import org.telegram.p035ui.Components.Premium.boosts.cells.StarGiveawayOptionCell;
import org.telegram.p035ui.Components.Premium.boosts.cells.SubtitleWithCounterCell;
...
public class BoostAdapter extends AdapterWithDiffUtils {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        switch (i) {
            ...
            case 5:
                ...
                break;
            case 6:
                org.telegram.p035ui.Cells.HeaderCell headerCell = new org.telegram.p035ui.Cells.HeaderCell(context, Theme.key_windowBackgroundWhiteBlueHeader, 21, 15, 3, false, this.resourcesProvider);
            ...
            case 18:
                ...
                expandView.set(LocaleController.getString(C2797R.string.NotifyMoreOptions), true, true, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if (itemViewType == 6) {
            ((org.telegram.p035ui.Cells.HeaderCell) viewHolder.itemView).setText(item.text);
            return;
        }
        if (itemViewType == 7) {
    ...
    public static class Item extends AdapterWithDiffUtils.Item {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj != null && getClass() == obj.getClass()) {
                ...
                if (i == 5) {
                    return m1160eq(this.values, item.values);
                }
                if (i == 13) {
        ...
        public static boolean m1160eq(List<Integer> list, List<Integer> list2) {
        ...
        public boolean contentsEquals(AdapterWithDiffUtils.Item item) {
            ...
            if (item != null && getClass() == item.getClass() && (i = (item2 = (Item) item).viewType) == (i2 = this.viewType)) {
                return i2 == 0 ? this.boolValue == item2.boolValue : i == 17 ? this.intValue == item2.intValue && this.longValue == item2.longValue && this.object == item2.object && this.boolValue == item2.boolValue && this.selectable == item2.selectable : i2 == 5 ? this.intValue == item2.intValue && m1160eq(this.values, item2.values) : i2 == 13 && this.intValue == item2.intValue && TextUtils.equals(this.text, item2.text);
            }
            return false;
        }
    }
