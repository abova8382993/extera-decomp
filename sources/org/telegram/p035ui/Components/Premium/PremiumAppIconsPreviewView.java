...
public class PremiumAppIconsPreviewView extends FrameLayout implements PagerHeaderView {
    ...
    public PremiumAppIconsPreviewView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (this.icons.size() < 3) {
            FileLog.m1048e(new IllegalArgumentException("There should be at least 3 premium icons!"));
            this.isEmpty = true;
        } else {
    ...
    private AdaptiveIconImageView newIconView(Context context, int i) {
        ...
        adaptiveIconImageView.setPadding(AndroidUtilities.m1036dp(8.0f));
        adaptiveIconImageView.setBackgroundOuterPadding(AndroidUtilities.m1036dp(32.0f));
    ...
    public void onMeasure(int i, int i2) {
        ...
        layoutParams3.height = iM1036dp;
        layoutParams3.width = iM1036dp;
        layoutParams3.leftMargin = i3;
    }

    @Override // org.telegram.p035ui.Components.Premium.PagerHeaderView
    public void setOffset(float f) {
        ...
        this.bottomRightIcon.setTranslationX(((getRight() - this.bottomRightIcon.getRight()) + (this.bottomRightIcon.getWidth() * 1.5f) + AndroidUtilities.m1036dp(32.0f)) * interpolation);
        this.bottomRightIcon.setTranslationY(AndroidUtilities.m1036dp(16.0f) * interpolation);
        ...
        this.topIcon.setTranslationY((((getTop() - this.topIcon.getTop()) - (this.topIcon.getHeight() * 1.8f)) - AndroidUtilities.m1036dp(32.0f)) * fAbs);
        this.topIcon.setTranslationX(AndroidUtilities.m1036dp(16.0f) * fAbs);
        ...
        this.bottomLeftIcon.setTranslationX((((getLeft() - this.bottomLeftIcon.getLeft()) - (this.bottomLeftIcon.getWidth() * 2.5f)) + AndroidUtilities.m1036dp(32.0f)) * interpolation2);
        this.bottomLeftIcon.setTranslationY(interpolation2 * ((getBottom() - this.bottomLeftIcon.getBottom()) + (this.bottomLeftIcon.getHeight() * 2.5f) + AndroidUtilities.m1036dp(32.0f)));
    ...
    public class AdaptiveIconImageView extends AppIconsSelectorCell.AdaptiveIconImageView {
        ...
        public void draw(Canvas canvas) {
            ...
            this.drawable.excludeRect.set(AndroidUtilities.m1036dp(5.0f), AndroidUtilities.m1036dp(5.0f), getMeasuredWidth() - AndroidUtilities.m1036dp(5.0f), getMeasuredHeight() - AndroidUtilities.m1036dp(5.0f));
            float f = -iM1036dp;
            this.drawable.rect.set(f, f, getWidth() + iM1036dp, getHeight() + iM1036dp);
            canvas.save();
            ...
            canvas.drawRoundRect(rectF, AndroidUtilities.m1036dp(16.0f), AndroidUtilities.m1036dp(16.0f), this.paint);
            super.draw(canvas);
        }
    }
}
