package org.telegram.p035ui.Components.Premium.GLIcon;
...
public class GLIconTextureView extends TextureView implements TextureView.SurfaceTextureListener {
    ...
    public GLIconTextureView(Context context, int i, int i2) {
        ...
        initialize(context);
        GestureDetector gestureDetector = new GestureDetector(context, new GestureDetectorOnGestureListenerC47141());
        this.gestureDetector = gestureDetector;
        gestureDetector.setIsLongpressEnabled(true);
        while (true) {
            int i4 = this.animationsCount;
            ArrayList<Integer> arrayList = this.animationIndexes;
            if (i3 < i4) {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.GLIcon.GLIconTextureView$1 */
    public class GestureDetectorOnGestureListenerC47141 implements GestureDetector.OnGestureListener {
        ...
        public GestureDetectorOnGestureListenerC47141() {
        }
        ...
        public /* synthetic */ void lambda$onSingleTapUp$0(float f, float f2) {
            ...
            float fAbs = Math.abs(GLIconTextureView.this.mRenderer.angleX);
            GLIconTextureView gLIconTextureView = GLIconTextureView.this;
            if (fAbs > 10.0f) {
            ...
            valueAnimatorOfFloat2.setStartDelay(220L);
            ...
            valueAnimatorOfFloat4.setStartDelay(220L);
            ...
            try {
                try {
                    try {
                        ...
                        GLIconRenderer gLIconRenderer = GLIconTextureView.this.mRenderer;
                        if (gLIconRenderer != null) {
                            gLIconRenderer.destroy();
                        }
                        if (GLIconTextureView.this.mEgl != null && GLIconTextureView.this.mEglDisplay != null) {
                            GLIconTextureView.this.mEgl.eglMakeCurrent(GLIconTextureView.this.mEglDisplay, eGLSurface, eGLSurface, eGLContext);
                            if (GLIconTextureView.this.mEglSurface != null) {
                                GLIconTextureView.this.mEgl.eglDestroySurface(GLIconTextureView.this.mEglDisplay, GLIconTextureView.this.mEglSurface);
                                GLIconTextureView.this.mEglSurface = null;
                            }
                            if (GLIconTextureView.this.mEglContext != null) {
                                GLIconTextureView.this.mEgl.eglDestroyContext(GLIconTextureView.this.mEglDisplay, GLIconTextureView.this.mEglContext);
                                GLIconTextureView.this.mEglContext = null;
                            }
                            GLIconTextureView.this.mEgl.eglTerminate(GLIconTextureView.this.mEglDisplay);
                            GLIconTextureView.this.mEglDisplay = null;
                        }
                    }
                } catch (Exception e2) {
                    FileLog.m1048e(e2);
                    GLIconTextureView gLIconTextureView4 = GLIconTextureView.this;
                    gLIconTextureView4.isRunning = false;
                    GLIconRenderer gLIconRenderer2 = gLIconTextureView4.mRenderer;
                    if (gLIconRenderer2 != null) {
                        gLIconRenderer2.destroy();
                    }
                    if (GLIconTextureView.this.mEgl == null || GLIconTextureView.this.mEglDisplay == null) {
                        return;
                    }
                ...
                FileLog.m1048e(e3);
                GLIconRenderer gLIconRenderer3 = GLIconTextureView.this.mRenderer;
                if (gLIconRenderer3 != null) {
                    gLIconRenderer3.destroy();
                }
                if (GLIconTextureView.this.mEgl == null || GLIconTextureView.this.mEglDisplay == null) {
                    return;
                }
    ...
    private void checkCurrent() {
        ...
        if (!egl10.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, this.mEglContext)) {
            Instance$$ExternalSyntheticBUOutline0.m1010m("eglMakeCurrent failed ", GLUtils.getEGLErrorString(this.mEgl.eglGetError()));
        } else {
            checkEglError();
        }
    }
    ...
    private void checkEglError() {
        if (this.mEgl.eglGetError() != 12288) {
            FileLog.m1046e("cannot swap buffers!");
        }
    }
    ...
    public void checkGlError() {
        ...
        if (iGlGetError != 0) {
            FileLog.m1046e("GL error = 0x" + Integer.toHexString(iGlGetError));
        }
    }
    ...
    public void initGL() {
        ...
        if (eGLDisplayEglGetDisplay == EGL10.EGL_NO_DISPLAY) {
            Instance$$ExternalSyntheticBUOutline0.m1010m("eglGetDisplay failed ", GLUtils.getEGLErrorString(egl102.eglGetError()));
            return;
        }
        if (!egl102.eglInitialize(eGLDisplayEglGetDisplay, new int[2])) {
            Instance$$ExternalSyntheticBUOutline0.m1010m("eglInitialize failed ", GLUtils.getEGLErrorString(this.mEgl.eglGetError()));
            return;
        }
        int[] iArr2 = new int[1];
        ...
        if (!this.mEgl.eglChooseConfig(this.mEglDisplay, iArr, eGLConfigArr, 1, iArr2)) {
            Buffer$$ExternalSyntheticBUOutline4.m978m("eglChooseConfig failed ", GLUtils.getEGLErrorString(this.mEgl.eglGetError()));
            return;
        }
        if (iArr2[0] > 0) {
        ...
        if (eGLConfig == null) {
            GlShader$$ExternalSyntheticBUOutline1.m1250m("eglConfig not initialized");
            return;
        }
        ...
        if (eGLSurface == null || eGLSurface == EGL10.EGL_NO_SURFACE) {
            ...
            if (iEglGetError == 12299) {
                FileLog.m1046e("eglCreateWindowSurface returned EGL10.EGL_BAD_NATIVE_WINDOW");
                return;
            } else {
                Instance$$ExternalSyntheticBUOutline0.m1010m("eglCreateWindowSurface failed ", GLUtils.getEGLErrorString(iEglGetError));
                return;
            }
        }
    ...
    private void pullAnimation() {
        ...
        if (i == 4) {
            ...
            ValueAnimator valueAnimatorOfFloat2 = ValueAnimator.ofFloat(this.mRenderer.angleY, 48.0f);
            ...
            ValueAnimator valueAnimatorOfFloat3 = ValueAnimator.ofFloat(48.0f, 0.0f);
            ...
            float f2 = i2;
            ValueAnimator valueAnimatorOfFloat4 = ValueAnimator.ofFloat(this.mRenderer.angleY, f2);
            ...
            ValueAnimator valueAnimatorOfFloat5 = ValueAnimator.ofFloat(f2, 0.0f);
