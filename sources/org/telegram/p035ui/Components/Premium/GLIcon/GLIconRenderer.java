...
public class GLIconRenderer implements GLSurfaceView.Renderer {
    ...
    public static int loadShader(int i, String str) {
        ...
        StaticFieldStub$$ExternalSyntheticBUOutline0.m1029m("Could not compile program: ", GLES20.glGetShaderInfoLog(iGlCreateShader), " ", str);
        return 0;
    }
    ...
    public void onDrawFrame(GL10 gl10) {
        ...
        if (icon3D != null) {
            ...
            icon3D.draw(this.mMVPMatrix, this.mRotationMatrix, this.mWidth, this.mHeight, this.gradientStartX, this.gradientScaleX, this.gradientStartY, this.gradientScaleY, this.white, this.golden, this.f1621dt);
        }
    }
