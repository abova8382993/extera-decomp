...
public class ReactionTabHolderView extends FrameLayout {
    ...
    public ReactionTabHolderView(Context context) {
        ...
        this.path = new Path();
        this.rect = new RectF();
        this.radius = AndroidUtilities.m1036dp(32.0f);
        View view = new View(context);
        this.overlaySelectorView = view;
        addView(view, LayoutHelper.createFrame(-1, -1.0f));
        this.iconView = new ImageView(context);
        Drawable drawableMutate = ContextCompat.getDrawable(context, C2797R.drawable.msg_reactions_filled).mutate();
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (visibleReaction != null) {
            accessibilityNodeInfo.setText(LocaleController.formatPluralString("AccDescrNumberOfPeopleReactions", i, visibleReaction));
        } else {
            accessibilityNodeInfo.setText(LocaleController.formatPluralString("ReactionsCount", i, new Object[0]));
        }
    }
}
