...
public class OverlayActionBarLayoutDialog extends Dialog implements INavigationLayout.INavigationLayoutDelegate {
    ...
    public OverlayActionBarLayoutDialog(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        INavigationLayout iNavigationLayoutNewLayout = INavigationLayout.newLayout(context, false);
    ...
    public void onMeasureOverride(int[] iArr) {
        ...
        iArr[0] = View.MeasureSpec.makeMeasureSpec(Math.min(AndroidUtilities.m1036dp(530.0f), View.MeasureSpec.getSize(iArr[0])), TLObject.FLAG_30);
        iArr[1] = View.MeasureSpec.makeMeasureSpec(Math.min(AndroidUtilities.m1036dp(528.0f), View.MeasureSpec.getSize(iArr[1])), TLObject.FLAG_30);
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.frameLayout.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() { // from class: org.telegram.ui.Components.OverlayActionBarLayoutDialog$$ExternalSyntheticLambda1
            ...
            public final WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
                return OverlayActionBarLayoutDialog.m12557$r8$lambda$AKWEMZGytT31G2x4IT_NdAkiqA(view, windowInsets);
            }
        });
        if (i >= 26) {
    ...
    /* JADX INFO: renamed from: $r8$lambda$AKW-EMZGytT31G2x4IT_NdAkiqA, reason: not valid java name */
    public static /* synthetic */ WindowInsets m12557$r8$lambda$AKWEMZGytT31G2x4IT_NdAkiqA(View view, WindowInsets windowInsets) {
