...
public abstract class CloseProgressDrawable2 extends Drawable {
    ...
    public CloseProgressDrawable2(float f) {
        ...
        this.paint.setStrokeWidth(AndroidUtilities.m1036dp(f));
        this.paint.setStrokeCap(Paint.Cap.ROUND);
        this.paint.setStyle(Paint.Style.STROKE);
        this.side = AndroidUtilities.m1036dp(8.0f);
    }
    ...
    */
    public void draw(android.graphics.Canvas r17) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.CloseProgressDrawable2.draw(android.graphics.Canvas):void");
    }
