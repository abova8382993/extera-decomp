...
public class ProfileGooeyView extends FrameLayout {
    ...
    public interface Impl {
        ...
        default void setBlurIntensity(float f) {
        }

        default void setIntensity(float f) {
        }
    }
    ...
    public /* synthetic */ void lambda$draw$0(Canvas canvas) {
        canvas.save();
        canvas.translate(0.0f, AndroidUtilities.m1036dp(32.0f));
        super.draw(canvas);
        canvas.restore();
    }
    ...
    public final class CPUImpl implements Impl {
        ...
        public void onSizeChanged(int i, int i2) {
            ...
            this.optimizedW = Math.min(AndroidUtilities.m1036dp(120.0f), i);
            int iMin = Math.min(AndroidUtilities.m1036dp(220.0f), i2);
            this.optimizedH = iMin;
            this.bitmapOrigW = this.optimizedW;
            int iM1036dp = iMin + AndroidUtilities.m1036dp(32.0f);
            this.bitmapOrigH = iM1036dp;
            this.bitmap = Bitmap.createBitmap((int) (this.bitmapOrigW / 6.0f), (int) (iM1036dp / 6.0f), Bitmap.Config.ARGB_8888);
        ...
        public void draw(Drawer drawer, Canvas canvas) {
            ...
            if (iClamp != 255) {
                ...
                if (notchInfo != null) {
                    canvas2.save();
                    this.bitmapCanvas.translate(f, AndroidUtilities.m1036dp(32.0f));
                    ...
                    if (notchInfo2.isLikelyCircle) {
                        ...
                        canvas3.drawCircle(fCenterX, rectF.bottom - (rectF.width() / 2.0f), fMin, ProfileGooeyView.this.blackPaint);
                    } else if (notchInfo2.isAccurate) {
                        this.bitmapCanvas.drawPath(notchInfo2.path, profileGooeyView.blackPaint);
                    } else {
                        ...
                        canvas4.drawRoundRect(profileGooeyView2.notchInfo.bounds, fMax, fMax, profileGooeyView2.blackPaint);
                    }
                    this.bitmapCanvas.restore();
                } else {
                    canvas2.drawRect(0.0f, 0.0f, this.optimizedW, AndroidUtilities.m1036dp(32.0f), ProfileGooeyView.this.blackPaint);
                }
                this.bitmapCanvas.restore();
    ...
    public final class GPUImpl implements Impl {
        ...
        private GPUImpl(float f) {
            ...
            this.node = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1041m("render");
            this.effectNotchNode = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1041m("effectNotch");
            this.effectNode = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1041m("effect");
            this.blurNode = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1041m("blur");
        ...
        public void setBlurIntensity(float f) {
            ...
            if (f == 0.0f) {
                ...
                renderNode.setRenderEffect(RenderEffect.createBlurEffect((ProfileGooeyView.this.intensity * f) / this.factorMult, (f * ProfileGooeyView.this.intensity) / this.factorMult, Shader.TileMode.DECAL));
            }
        }
        ...
        public void draw(Drawer drawer, Canvas canvas) {
            ...
            if (canvas.isHardwareAccelerated()) {
                ...
                if (ProfileGooeyView.this.getChildCount() > 0) {
                    ...
                    this.wholeOptimized.inset(-AndroidUtilities.m1036dp(20.0f), -AndroidUtilities.m1036dp(20.0f));
                    this.wholeOptimized.intersect(this.whole);
                    this.wholeOptimized.top = 0.0f;
                } else {
                    this.wholeOptimized.set(this.whole);
                }
                this.wholeOptimized.bottom += AndroidUtilities.m1036dp(32.0f);
                ...
                float fLerp = AndroidUtilities.lerp(0.0f, AndroidUtilities.m1036dp(7.0f) * f15, 0.0f, 0.5f, ProfileGooeyView.this.pullProgress);
                if (ProfileGooeyView.this.getChildCount() > 0) {
                    View childAt2 = ProfileGooeyView.this.getChildAt(0);
                    float x2 = (childAt2.getX() + ((childAt2.getWidth() * childAt2.getScaleX()) / 2.0f)) - f4;
                    float y2 = ((childAt2.getY() + ((childAt2.getHeight() * childAt2.getScaleY()) / 2.0f)) + AndroidUtilities.m1036dp(32.0f)) - f5;
                ...
                if (ProfileGooeyView.this.notchInfo != null) {
                    ...
                    recordingCanvasBeginRecording4.translate(0.0f, AndroidUtilities.m1036dp(32.0f));
                    ProfileGooeyView profileGooeyView = ProfileGooeyView.this;
                    NotchInfoUtils.NotchInfo notchInfo2 = profileGooeyView.notchInfo;
                    if (notchInfo2.isLikelyCircle) {
                        float fMin = Math.min(notchInfo2.bounds.width(), ProfileGooeyView.this.notchInfo.bounds.height()) / 2.0f;
                    ...
                    i = 255;
                    paint = null;
                    recordingCanvasBeginRecording4.drawRect(0.0f, 0.0f, f6, AndroidUtilities.m1036dp(32.0f), ProfileGooeyView.this.blackPaint);
                    ProfileGooeyView.this.path.rewind();
                    ProfileGooeyView.this.path.moveTo((f6 - fLerp) / 2.0f, AndroidUtilities.m1036dp(32.0f));
                    ProfileGooeyView.this.path.lineTo(f6 / 2.0f, AndroidUtilities.m1036dp(32.0f) + fLerp);
                    ProfileGooeyView.this.path.lineTo((f6 + fLerp) / 2.0f, AndroidUtilities.m1036dp(32.0f));
                    ProfileGooeyView.this.path.close();
                    recordingCanvasBeginRecording4.drawPath(ProfileGooeyView.this.path, ProfileGooeyView.this.blackPaint);
                }
                this.effectNotchNode.endRecording();
                canvas.save();
                canvas.translate(f4, f5 - AndroidUtilities.m1036dp(32.0f));
