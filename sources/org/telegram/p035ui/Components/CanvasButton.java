...
public class CanvasButton {
    ...
    float roundRadius = AndroidUtilities.m1036dp(12.0f);
    ...
    public CanvasButton(View view) {
        ...
        this.maskPaint.setPathEffect(new CornerPathEffect(AndroidUtilities.m1036dp(12.0f)));
        ...
        if (i <= 1) {
            if (i == 1) {
                ...
                if (this.rounded) {
                    ...
                    float fMin = Math.min(this.drawingRects.get(0).width(), this.drawingRects.get(0).height()) / 2.0f;
                    canvas.drawRoundRect(this.drawingRects.get(0), fMin, fMin, paint);
                    return;
                } else {
        ...
        if (!this.pathCreated) {
            ...
            while (true) {
                ...
                if (i8 < i7) {
                    ...
                    if (Math.abs(f - f2) < AndroidUtilities.m1036dp(4.0f)) {
