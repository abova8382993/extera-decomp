...
public class BlurBehindDrawable {
    ...
    */
    public void draw(android.graphics.Canvas r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.BlurBehindDrawable.draw(android.graphics.Canvas):void");
    }
    ...
    private void generateBlurredBitmaps() {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            int iM1036dp = AndroidUtilities.statusBarHeight + AndroidUtilities.m1036dp(200.0f);
            this.toolbarH = iM1036dp;
            if (i != 0) {
                iM1036dp = measuredHeight;
            }
            Bitmap bitmap = bitmapArr[i];
            if (bitmap == null || bitmap.getHeight() != iM1036dp || bitmapArr[i].getWidth() != this.parentView.getMeasuredWidth()) {
                ...
                bitmapArr2[i] = Bitmap.createBitmap(i2, (int) (iM1036dp / 15.0f), config);
                if (i == 1) {
    ...
    public class BlurBackgroundTask implements Runnable {
        ...
        public void run() {
            ...
            while (i2 < 2) {
                ...
                if (i2 == 1) {
                    blurBehindDrawable.backgroundBitmap[i2].eraseColor(BlurBehindDrawable.this.getThemedColor(Theme.key_windowBackgroundWhite));
                } else {
