    ...
    public void draw(float f, float f2, float f3, float f4, Canvas canvas, FragmentContextView fragmentContextView, float f5) {
        ...
        for (int i = 0; i < 2; i++) {
            if (i != 0 || this.previousState != null) {
                ...
                lineBlobDrawable.maxRadius = AndroidUtilities.m1036dp(2.0f) + (AndroidUtilities.m1036dp(2.0f) * this.amplitude);
                this.lineBlobDrawable1.minRadius = AndroidUtilities.m1036dp(0.0f);
                this.lineBlobDrawable1.maxRadius = AndroidUtilities.m1036dp(3.0f) + (AndroidUtilities.m1036dp(9.0f) * this.amplitude);
                this.lineBlobDrawable2.minRadius = AndroidUtilities.m1036dp(0.0f);
                LineBlobDrawable lineBlobDrawable2 = this.lineBlobDrawable2;
                float fM1036dp = AndroidUtilities.m1036dp(3.0f);
                float fM1036dp2 = AndroidUtilities.m1036dp(9.0f);
                float f17 = this.amplitude;
                lineBlobDrawable2.maxRadius = fM1036dp + (fM1036dp2 * f17);
                if (i == 1 && z) {
                ...
                if (LiteMode.isEnabled(512)) {
                    ...
                    float fM1036dp3 = AndroidUtilities.m1036dp(6.0f) * this.amplitude2;
                    float fM1036dp4 = AndroidUtilities.m1036dp(6.0f) * this.amplitude2;
                    this.lineBlobDrawable1.draw(f, f2 - fM1036dp3, f3, f4, canvas, this.paint, f2, f5);
                    this.lineBlobDrawable2.draw(f, f2 - fM1036dp4, f3, f4, canvas, this.paint, f2, f5);
                }
                if (i == 1 && z2) {
                ...
                if (i == 1 && z2) {
                    this.path.reset();
                    this.path.addCircle(f3 - AndroidUtilities.m1036dp(18.0f), f2 + ((f4 - f2) / 2.0f), (f3 - f) * 1.1f * f6, Path.Direction.CW);
                    canvas.save();
        ...
        public void setToPaint(Paint paint) {
            ...
            if (i == 0 || i == 1 || i == 3) {
                if (!LiteMode.isEnabled(512)) {
                    ...
                    int i3 = this.color1;
                    if (i2 == 3) {
                        paint.setColor(ColorUtils.blendARGB(ColorUtils.blendARGB(i3, this.color2, 0.5f), this.color3, 0.5f));
                        return;
                    } else {
                        paint.setColor(ColorUtils.blendARGB(i3, this.color2, 0.5f));
                        return;
                    }
                }
