...
public class ChecksHintView extends FrameLayout {
    ...
    public ChecksHintView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        frameLayout.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1036dp(6.0f), getThemedColor(Theme.key_chat_gifSaveHintBackground)));
        int i = 0;
        frameLayout.setPadding(AndroidUtilities.m1036dp(8.0f), AndroidUtilities.m1036dp(8.0f), 0, AndroidUtilities.m1036dp(8.0f));
        ...
        while (i < 2) {
            ...
            this.textView[i].setMaxWidth(AndroidUtilities.m1036dp(250.0f));
            ...
            if (i == 0) {
                rLottieImageViewArr[i].setAnimation(C2797R.raw.ticks_single, 24, 24);
                this.textView[i].setText(LocaleController.getString(C2797R.string.HintSent));
            } else {
                rLottieImageViewArr[i].setAnimation(C2797R.raw.ticks_double, 24, 24);
                this.textView[i].setText(LocaleController.getString(C2797R.string.HintRead));
            }
        ...
        imageView.setImageResource(C2797R.drawable.tooltip_arrow);
    ...
    public boolean showForMessageCell(ChatMessageCell chatMessageCell, boolean z) {
        ...
        final int i3 = 0;
        if (i2 <= getMeasuredHeight() + AndroidUtilities.m1036dp(10.0f)) {
            return false;
        }
        int checksY = i2 + chatMessageCell.getChecksY() + AndroidUtilities.m1036dp(6.0f);
        int checksX = chatMessageCell.getChecksX() + AndroidUtilities.m1036dp(5.0f);
        ...
        if (left > view.getMeasuredWidth() / 2) {
            int measuredWidth2 = (measuredWidth - getMeasuredWidth()) - AndroidUtilities.m1036dp(20.0f);
            setTranslationX(measuredWidth2);
            iM1036dp += measuredWidth2;
        } else {
            setTranslationX(0.0f);
        }
        float left2 = ((chatMessageCell.getLeft() + checksX) - iM1036dp) - (this.arrowImageView.getMeasuredWidth() / 2);
        this.arrowImageView.setTranslationX(left2);
        if (left > view.getMeasuredWidth() / 2) {
            if (left2 < AndroidUtilities.m1036dp(10.0f)) {
                float fM1036dp = left2 - AndroidUtilities.m1036dp(10.0f);
                setTranslationX(getTranslationX() + fM1036dp);
                this.arrowImageView.setTranslationX(left2 - fM1036dp);
            }
        } else if (left2 > getMeasuredWidth() - AndroidUtilities.m1036dp(24.0f)) {
            float measuredWidth3 = (left2 - getMeasuredWidth()) + AndroidUtilities.m1036dp(24.0f);
            setTranslationX(measuredWidth3);
            this.arrowImageView.setTranslationX(left2 - measuredWidth3);
        } else if (left2 < AndroidUtilities.m1036dp(10.0f)) {
            float fM1036dp2 = left2 - AndroidUtilities.m1036dp(10.0f);
            setTranslationX(getTranslationX() + fM1036dp2);
            this.arrowImageView.setTranslationX(left2 - fM1036dp2);
        }
        setPivotX(left2);
        ...
        if (z) {
            ...
            this.animatorSet.addListener(new C41901());
    ...
    public class C41901 extends AnimatorListenerAdapter {
        public C41901() {
        }
