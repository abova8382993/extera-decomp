...
public class BlobDrawable {
    ...
    public BlobDrawable(int i, int i2) {
        ...
        this.f1533m = new Matrix();
        float f = i;
        this.f1532N = f;
        this.f1531L = (float) (Math.tan(3.141592653589793d / ((double) (f * 2.0f))) * 1.3333333333333333d);
        ...
        for (int i3 = 0; i3 < this.f1532N; i3++) {
    ...
    public void draw(float f, float f2, Canvas canvas, Paint paint) {
        ...
        while (true) {
            ...
            if (f3 < f4) {
                ...
                float fMin = this.f1531L * (Math.min(f9, f11) + ((Math.max(f9, f11) - Math.min(f9, f11)) / 2.0f)) * this.cubicBezierK;
                this.f1533m.reset();
                this.f1533m.setRotate(f13, f, f2);
                ...
                fArr7[3] = f16;
                this.f1533m.reset();
                this.f1533m.setRotate(f14, f, f2);
                this.f1533m.mapPoints(this.pointEnd);
                if (i == 0) {
                    Path path = this.path;
    ...
    public void setValue(float f, boolean z) {
        ...
        if (LiteMode.isEnabled(this.liteFlag)) {
            ...
            if (f2 > f4) {
                this.animateAmplitudeDiff = (f2 - f4) / 320.0f;
            } else {
                this.animateAmplitudeDiff = (f2 - f4) / 375.0f;
            }
        }
    }
