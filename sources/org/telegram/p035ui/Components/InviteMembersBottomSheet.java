...
import org.telegram.p035ui.Components.UsersAlertBase;
...
public class InviteMembersBottomSheet extends UsersAlertBase implements NotificationCenter.NotificationCenterDelegate {
    ...
    public InviteMembersBottomSheet(final Context context, int i, final LongSparseArray<TLObject> longSparseArray, final long j, final BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.spanClickListener = new View.OnClickListener() { // from class: org.telegram.ui.Components.InviteMembersBottomSheet.1
            ...
            public void onClick(View view) {
                ...
                if (zIsDeleting) {
                    inviteMembersBottomSheet.currentDeletingSpan = null;
                ...
                if (inviteMembersBottomSheet.currentDeletingSpan != null) {
        ...
        this.chatId = j;
        fixNavigationBar();
        this.searchView.searchEditText.setHint(LocaleController.getString(C2797R.string.SearchForChats));
        ...
        ScrollView scrollView = new ScrollView(context) { // from class: org.telegram.ui.Components.InviteMembersBottomSheet.2
            ...
            public void onMeasure(int i3, int i4) {
                ...
                if (AndroidUtilities.isTablet() || size2 > size) {
                    InviteMembersBottomSheet.this.maxSize = AndroidUtilities.m1036dp(144.0f);
                } else {
                    InviteMembersBottomSheet.this.maxSize = AndroidUtilities.m1036dp(56.0f);
                }
        ...
        fragmentFloatingButton.setContentDescription(LocaleController.getString(C2797R.string.Next));
        this.containerView.addView(fragmentFloatingButton, FragmentFloatingButton.createDefaultLayoutParams());
        ((ViewGroup.MarginLayoutParams) this.emptyView.getLayoutParams()).topMargin = AndroidUtilities.m1036dp(20.0f);
        ((ViewGroup.MarginLayoutParams) this.emptyView.getLayoutParams()).leftMargin = AndroidUtilities.m1036dp(4.0f);
        ((ViewGroup.MarginLayoutParams) this.emptyView.getLayoutParams()).rightMargin = AndroidUtilities.m1036dp(4.0f);
    }
    ...
    */
    public /* synthetic */ void lambda$new$0(long r4, org.telegram.p035ui.ActionBar.BaseFragment r6, androidx.collection.LongSparseArray r7, android.content.Context r8, android.view.View r9, int r10) {
        /*
            Method dump skipped, instruction units count: 361
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.InviteMembersBottomSheet.lambda$new$0(long, org.telegram.ui.ActionBar.BaseFragment, androidx.collection.LongSparseArray, android.content.Context, android.view.View, int):void");
    }
    ...
    public /* synthetic */ void lambda$new$2(Context context, long j, View view) {
        ...
        while (i < this.selectedContacts.size()) {
            TLRPC.User user = MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(this.selectedContacts.keyAt(i)));
            if (user != null) {
                if (sb.length() > 0) {
                    sb.append(", ");
                }
        ...
        if (this.selectedContacts.size() > 5) {
            ...
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("AddMembersAlertNamesText", C2797R.string.AddMembersAlertNamesText, sb, chat.title)));
        }
        builder.setPositiveButton(LocaleController.getString(C2797R.string.Add), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.InviteMembersBottomSheet$$ExternalSyntheticLambda5
    ...
    @Override // org.telegram.p035ui.Components.UsersAlertBase, org.telegram.p035ui.ActionBar.BottomSheet, android.app.Dialog, android.content.DialogInterface, org.telegram.ui.ActionBar.BaseFragment.AttachedSheet
    ...
    */
    public void setSelectedContacts(java.util.ArrayList<java.lang.Long> r12) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.InviteMembersBottomSheet.setSelectedContacts(java.util.ArrayList):void");
    }
    ...
    private void updateRows() {
        ...
        if (this.dialogsDelegate == null) {
            ...
            if (size != 0) {
                ...
                int size2 = i2 + this.contacts.size();
                this.rowCount = size2;
                this.contactsEndRow = size2;
            } else {
                this.rowCount = i2 + 1;
                this.noContactsStubRow = i2;
            }
        } else {
            int size3 = this.dialogsServerOnly.size();
            int i3 = this.rowCount;
            if (size3 != 0) {
                this.contactsStartRow = i3;
                int size4 = i3 + this.dialogsServerOnly.size();
                this.rowCount = size4;
    ...
    public class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i != 2) {
                ...
                if (i == 3) {
                    ...
                    manageChatTextCell.setText(LocaleController.getString(C2797R.string.VoipGroupCopyInviteLink), null, C2797R.drawable.msg_link, 7, true);
                    ...
                    InviteMembersBottomSheetDelegate inviteMembersBottomSheetDelegate = InviteMembersBottomSheet.this.dialogsDelegate;
                    SpoilersTextView spoilersTextView = stickerEmptyView.title;
                    if (inviteMembersBottomSheetDelegate != null) {
                        spoilersTextView.setText(LocaleController.getString(C2797R.string.FilterNoChats));
                    } else {
                        spoilersTextView.setText(LocaleController.getString(C2797R.string.NoContacts));
                    }
                ...
                groupCreateUserCell = new View(context) { // from class: org.telegram.ui.Components.InviteMembersBottomSheet.ListAdapter.1
                    ...
                    public void onMeasure(int i4, int i5) {
                        super.onMeasure(i4, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(48.0f) + InviteMembersBottomSheet.this.additionalHeight, TLObject.FLAG_30));
                    }
                };
            }
        ...
        public TLObject getObject(int i) {
            ...
            InviteMembersBottomSheet inviteMembersBottomSheet = InviteMembersBottomSheet.this;
            if (inviteMembersBottomSheetDelegate != null) {
                TLRPC.Dialog dialog = (TLRPC.Dialog) inviteMembersBottomSheet.dialogsServerOnly.get(i - InviteMembersBottomSheet.this.contactsStartRow);
                ...
                return zIsUserDialog ? MessagesController.getInstance(((BottomSheet) inviteMembersBottomSheet2).currentAccount).getUser(Long.valueOf(dialog.f1251id)) : MessagesController.getInstance(((BottomSheet) inviteMembersBottomSheet2).currentAccount).getChat(Long.valueOf(-dialog.f1251id));
            }
            return (TLObject) inviteMembersBottomSheet.contacts.get(i - InviteMembersBottomSheet.this.contactsStartRow);
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (object2 instanceof TLRPC.User) {
                j = ((TLRPC.User) object2).f1407id;
            } else {
                j = object2 instanceof TLRPC.Chat ? -((TLRPC.Chat) object2).f1245id : 0L;
            }
            groupCreateUserCell.setObject(object, null, null, i != InviteMembersBottomSheet.this.contactsEndRow);
            if (object instanceof TLRPC.User) {
                j2 = ((TLRPC.User) object).f1407id;
            } else {
                j2 = object instanceof TLRPC.Chat ? -((TLRPC.Chat) object).f1245id : 0L;
            }
            if (j2 != 0) {
            ...
            if (i == 1) {
                ...
                groupCreateUserCell = new View(context) { // from class: org.telegram.ui.Components.InviteMembersBottomSheet.SearchAdapter.1
                    ...
                    public void onMeasure(int i2, int i3) {
                        super.onMeasure(i2, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(48.0f) + InviteMembersBottomSheet.this.additionalHeight + InviteMembersBottomSheet.this.searchAdditionalHeight, TLObject.FLAG_30));
                    }
                };
            } else if (i != 4) {
        ...
        */
        ...
        public void searchDialogs(final String str) {
            ...
            if (!zIsEmpty) {
                ...
                InviteMembersBottomSheet inviteMembersBottomSheet2 = InviteMembersBottomSheet.this;
                RecyclerView.Adapter adapter2 = inviteMembersBottomSheet2.searchListViewAdapter;
                if (adapter != adapter2) {
                    inviteMembersBottomSheet2.listView.setAdapter(adapter2);
                }
            ...
            RecyclerView.Adapter adapter3 = inviteMembersBottomSheet.listView.getAdapter();
            InviteMembersBottomSheet inviteMembersBottomSheet3 = InviteMembersBottomSheet.this;
            RecyclerView.Adapter adapter4 = inviteMembersBottomSheet3.listViewAdapter;
            if (adapter3 != adapter4) {
                inviteMembersBottomSheet3.listView.setAdapter(adapter4);
            }
        }
        ...
        /* JADX WARN: Removed duplicated region for block: B:54:0x0129 A[LOOP:1: B:29:0x0098->B:54:0x0129, LOOP_END] */
    ...
    public void onSearchViewTouched(MotionEvent motionEvent, final EditTextBoldCursor editTextBoldCursor) {
        ...
        if (motionEvent.getAction() == 0) {
            this.f1578y = this.scrollOffsetY;
            return;
        }
        if (motionEvent.getAction() != 1 || Math.abs(this.scrollOffsetY - this.f1578y) >= this.touchSlop || this.enterEventSent) {
            return;
        }
        ...
        public void onMeasure(int i, int i2) {
            ...
            for (int i3 = 0; i3 < childCount; i3++) {
                ...
                if (childAt instanceof GroupCreateSpan) {
                    ...
                    if (childAt != this.removingSpan && childAt.getMeasuredWidth() + measuredWidth > iM1036dp) {
            ...
            final int iM1036dp6 = iM1036dp2 + AndroidUtilities.m1036dp(42.0f);
            InviteMembersBottomSheetDelegate inviteMembersBottomSheetDelegate = InviteMembersBottomSheet.this.dialogsDelegate;
            InviteMembersBottomSheet inviteMembersBottomSheet = InviteMembersBottomSheet.this;
            if (inviteMembersBottomSheetDelegate != null) {
                iMax = inviteMembersBottomSheet.spanEnter ? Math.min(InviteMembersBottomSheet.this.maxSize, iM1036dp6) : 0;
            } else {
                iMax = Math.max(0, Math.min(inviteMembersBottomSheet.maxSize, iM1036dp6) - AndroidUtilities.m1036dp(52.0f));
            }
            int i4 = InviteMembersBottomSheet.this.searchAdditionalHeight;
            InviteMembersBottomSheet inviteMembersBottomSheet2 = InviteMembersBottomSheet.this;
            inviteMembersBottomSheet2.searchAdditionalHeight = (inviteMembersBottomSheet2.dialogsDelegate != null || InviteMembersBottomSheet.this.selectedContacts.size() <= 0) ? 0 : AndroidUtilities.m1036dp(56.0f);
            ...
            int iMin = Math.min(InviteMembersBottomSheet.this.maxSize, iM1036dp6);
            ...
            if (this.addAnimation && iM1036dp6 > InviteMembersBottomSheet.this.maxSize) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.InviteMembersBottomSheet$SpansContainer$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onMeasure$1(iM1036dp6);
                    }
                });
            } else if (!this.addAnimation && InviteMembersBottomSheet.this.spansScrollView.getScrollY() + InviteMembersBottomSheet.this.spansScrollView.getMeasuredHeight() > iM1036dp6) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.InviteMembersBottomSheet$SpansContainer$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onMeasure$2(iM1036dp6);
                    }
                });
            }
            ...
            setMeasuredDimension(size, Math.max(iM1036dp6, iM1036dp5));
    ...
    public UsersAlertBase.ContainerView createContainerView(Context context) {
        return new UsersAlertBase.ContainerView(context) { // from class: org.telegram.ui.Components.InviteMembersBottomSheet.4
            ...
            public void dispatchDraw(Canvas canvas) {
                InviteMembersBottomSheet inviteMembersBottomSheet = InviteMembersBottomSheet.this;
                InviteMembersBottomSheet.this.spansScrollView.setTranslationY((inviteMembersBottomSheet.scrollOffsetY - ((BottomSheet) inviteMembersBottomSheet).backgroundPaddingTop) + AndroidUtilities.m1036dp(6.0f) + AndroidUtilities.m1036dp(64.0f));
            ...
            public boolean drawChild(Canvas canvas, View view, long j) {
                if (view == InviteMembersBottomSheet.this.spansScrollView) {
                    canvas.save();
                    canvas.clipRect(0.0f, view.getY() - AndroidUtilities.m1036dp(4.0f), getMeasuredWidth(), view.getY() + InviteMembersBottomSheet.this.scrollViewH + 1.0f);
