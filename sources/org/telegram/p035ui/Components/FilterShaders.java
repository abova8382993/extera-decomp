...
public class FilterShaders {
    ...
    public static class BlurProgram {
        ...
        public BlurProgram(float f, float f2, boolean z) {
            ...
            if (z) {
                ...
                if (f2 >= 1.0f) {
                    double d = f2;
                    int iFloor = (int) Math.floor(Math.sqrt(Math.pow(d, 2.0d) * (-2.0d) * Math.log(0.00390625d * Math.sqrt(Math.pow(d, 2.0d) * 6.283185307179586d))));
                    i = iFloor + (iFloor % 2);
                } else {
                    i = 0;
                }
        ...
        public boolean create() {
            ...
            int i = iArr[0];
            int i2 = this.blurShaderProgram;
            if (i == 0) {
                GLES20.glDeleteProgram(i2);
                this.blurShaderProgram = 0;
            } else {
                this.blurPositionHandle = GLES20.glGetAttribLocation(i2, "position");
    ...
    public static class ToneCurve {
        ...
        private float[] getPreparedSplineCurve(ArrayList<PointF> arrayList) {
            ...
            float f2 = arrayListSplineCurve.get(arrayListSplineCurve.size() - 1).x;
            if (f2 < 255.0f) {
                int i3 = (int) f2;
                while (true) {
                    i3++;
        ...
        /* JADX WARN: Removed duplicated region for block: B:40:0x0075 A[PHI: r2
  0x0075: PHI (r2v9 float) = (r2v5 float), (r2v6 float) binds: [B:39:0x0073, B:42:0x007a] A[DONT_GENERATE, DONT_INLINE]] */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        private java.util.ArrayList<android.graphics.PointF> splineCurve(java.util.ArrayList<android.graphics.PointF> r22) {
            /*
                r21 = this;
                r0 = r22
                double[] r1 = r21.secondDerivative(r22)
                int r2 = r1.length
                r3 = 1
                if (r2 >= r3) goto Lc
                r0 = 0
            ...
            L29:
                ...
                double r1 = r19 + r1
                double r17 = r17 * r17
                r19 = 4618441417868443648(0x4018000000000000, double:6.0)
                double r17 = r17 / r19
                double r19 = r3 * r3
                double r19 = r19 * r3
                double r19 = r19 - r3
            ...
            L91:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.FilterShaders.ToneCurve.splineCurve(java.util.ArrayList):java.util.ArrayList");
        }
        ...
        private double[] secondDerivative(ArrayList<PointF> arrayList) {
            ...
            while (true) {
                ...
                int i7 = i3;
                double d3 = d;
                dArr4[i7] = ((double) (f - f2)) / 6.0d;
                float f3 = pointF3.x;
                dArr4[i6] = ((double) (f3 - f2)) / 3.0d;
                dArr4[c3] = ((double) (f3 - f)) / 6.0d;
                float f4 = pointF3.y;
                float f5 = pointF2.y;
                dArr2[i4] = (((double) (f4 - f5)) / ((double) (f3 - f))) - (((double) (f5 - pointF.y)) / ((double) (f - f2)));
                i2 = i6;
                i4 = i5;
                d2 = d2;
                c2 = c3;
            ...
            for (int i10 = i8; i10 < size; i10++) {
                ...
                double d6 = d5 / dArr7[i8];
                dArr6[i8] = dArr6[i8] - (dArr7[c4] * d6);
                dArr6[i9] = d4;
                dArr2[i10] = dArr2[i10] - (d6 * dArr2[i11]);
            }
            for (int i12 = size - 2; i12 >= 0; i12--) {
                ...
                double d8 = d7 / dArr9[i8];
                dArr8[i8] = dArr8[i8] - (dArr9[i9] * d8);
                dArr8[c4] = d4;
                dArr2[i12] = dArr2[i12] - (d8 * dArr2[i13]);
            }
            double[] dArr10 = new double[size];
            for (int i14 = i9; i14 < size; i14++) {
                dArr10[i14] = dArr2[i14] / dArr[i14][i8];
            }
            return dArr10;
        }
    ...
    public boolean create() {
        ...
        if (iLoadShader != 0 && iLoadShader2 != 0) {
            ...
            int i = iArr[0];
            int i2 = this.toolsShaderProgram;
            if (i == 0) {
                GLES20.glDeleteProgram(i2);
                this.toolsShaderProgram = 0;
            } else {
                this.positionHandle = GLES20.glGetAttribLocation(i2, "position");
            ...
            if (iLoadShader3 != 0 && iLoadShader4 != 0) {
                ...
                int i3 = iArr[0];
                int i4 = this.sharpenShaderProgram;
                if (i3 == 0) {
                    GLES20.glDeleteProgram(i4);
                    this.sharpenShaderProgram = 0;
                } else {
                    this.sharpenPositionHandle = GLES20.glGetAttribLocation(i4, "position");
                ...
                if (iLoadShader5 != 0 && iLoadShader6 != 0) {
                    ...
                    int i5 = iArr[0];
                    int i6 = this.linearBlurShaderProgram;
                    if (i5 == 0) {
                        GLES20.glDeleteProgram(i6);
                        this.linearBlurShaderProgram = 0;
                    } else {
                        this.linearBlurPositionHandle = GLES20.glGetAttribLocation(i6, "position");
                    ...
                    if (iLoadShader7 != 0 && iLoadShader8 != 0) {
                        ...
                        int i7 = iArr[0];
                        int i8 = this.radialBlurShaderProgram;
                        if (i7 == 0) {
                            GLES20.glDeleteProgram(i8);
                            this.radialBlurShaderProgram = 0;
                        } else {
                            this.radialBlurPositionHandle = GLES20.glGetAttribLocation(i8, "position");
                        ...
                        if (iLoadShader9 != 0 && iLoadShader10 != 0) {
                            ...
                            int i9 = iArr[0];
                            int i10 = this.enhanceShaderProgram;
                            if (i9 == 0) {
                                GLES20.glDeleteProgram(i10);
                                this.enhanceShaderProgram = 0;
                            } else {
                                this.enhancePositionHandle = GLES20.glGetAttribLocation(i10, "position");
                            ...
                            if (iLoadShader12 != 0 && iLoadShader11 != 0) {
                                ...
                                int i11 = iArr[0];
                                int i12 = this.highPassProgram;
                                if (i11 == 0) {
                                    GLES20.glDeleteProgram(i12);
                                    this.highPassProgram = 0;
                                } else {
                                    this.highPassPositionHandle = GLES20.glGetAttribLocation(i12, "position");
                                ...
                                if (iLoadShader14 != 0 && iLoadShader13 != 0) {
                                    ...
                                    int i13 = iArr[0];
                                    int i14 = this.boostProgram;
                                    if (i13 == 0) {
                                        GLES20.glDeleteProgram(i14);
                                        this.boostProgram = 0;
                                    } else {
                                        this.boostPositionHandle = GLES20.glGetAttribLocation(i14, "position");
    ...
    private boolean setupExternalShaders() {
        ...
        if (hDRType == 1) {
            ...
            res = _UrlKt.FRAGMENT_ENCODE_SET;
        } else {
            res = AndroidUtilities.readRes(C2797R.raw.hdr2sdr_pq);
        }
        boolean z = this.isVideo;
        String str2 = z ? "#extension GL_OES_EGL_image_external : require" : _UrlKt.FRAGMENT_ENCODE_SET;
            ...
            if (i3 < (z2 ? i : i2)) {
                if (i3 == 1 && z2) {
                    if (i4 != 0) {
                        ...
                        str = "texSize";
                        iLoadShader6 = loadShader(35632, String.format(Locale.US, "%1$s\nprecision highp float;varying vec2 vTextureCoord;vec3 rgb_to_hsv(vec3 c) {vec4 K = vec4(0.0, -1.0 / 3.0, 2.0 / 3.0, -1.0);vec4 p = c.g < c.b ? vec4(c.bg, K.wz) : vec4(c.gb, K.xy);vec4 q = c.r < p.x ? vec4(p.xyw, c.r) : vec4(c.r, p.yzx);float d = q.x - min(q.w, q.y);float e = 1.0e-10;return vec3(abs(q.z + (q.w - q.y) / (6.0 * d + e)), d / (q.x + e), q.x);}void main() {vec4 texel = TEX(vTextureCoord);gl_FragColor = vec4(rgb_to_hsv(texel.rgb), texel.a);}", str4));
                    } else {
                        str = "texSize";
                        iLoadShader6 = 0;
                        iLoadShader5 = 0;
                    ...
                    iLoadShader6 = loadShader(35632, String.format(Locale.US, "%1$s\nprecision highp float;varying vec2 vTextureCoord;uniform %2$s sTexture;vec3 rgb_to_hsv(vec3 c) {vec4 K = vec4(0.0, -1.0 / 3.0, 2.0 / 3.0, -1.0);vec4 p = c.g < c.b ? vec4(c.bg, K.wz) : vec4(c.gb, K.xy);vec4 q = c.r < p.x ? vec4(p.xyw, c.r) : vec4(c.r, p.yzx);float d = q.x - min(q.w, q.y);float e = 1.0e-10;return vec3(abs(q.z + (q.w - q.y) / (6.0 * d + e)), d / (q.x + e), q.x);}void main() {vec4 texel = texture2D(sTexture, vTextureCoord);gl_FragColor = vec4(rgb_to_hsv(texel.rgb), texel.a);}", _UrlKt.FRAGMENT_ENCODE_SET, "sampler2D"));
                }
                int i5 = iLoadShader5;
                GLES20.glDeleteProgram(this.rgbToHsvShaderProgram[i3]);
                if (i5 == 0 || iLoadShader6 == 0) {
                    return false;
                }
                this.rgbToHsvShaderProgram[i3] = GLES20.glCreateProgram();
                GLES20.glAttachShader(this.rgbToHsvShaderProgram[i3], i5);
                GLES20.glAttachShader(this.rgbToHsvShaderProgram[i3], iLoadShader6);
                ...
                GLES20.glGetProgramiv(this.rgbToHsvShaderProgram[i3], 35714, iArr, 0);
                if (iArr[0] == 0) {
                    GLES20.glDeleteProgram(this.rgbToHsvShaderProgram[i3]);
                    ...
                    if (i3 == 1) {
                        ...
                        this.rgbToHsvTexSizeHandle = GLES20.glGetUniformLocation(this.rgbToHsvShaderProgram[i3], str);
                    }
                }
                i3++;
                hDRType = i4;
                ...
                int i6 = iArr[0];
                int i7 = this.greenAndBlueChannelOverlayProgram;
                if (i6 == 0) {
                    GLES20.glDeleteProgram(i7);
                    this.greenAndBlueChannelOverlayProgram = 0;
                } else {
                    this.greenAndBlueChannelOverlayPositionHandle = GLES20.glGetAttribLocation(i7, "position");
                ...
                int i8 = iArr[0];
                int i9 = this.compositeProgram;
                if (i8 == 0) {
                    GLES20.glDeleteProgram(i9);
                    this.compositeProgram = 0;
                    return true;
                }
                this.compositePositionHandle = GLES20.glGetAttribLocation(i9, "position");
    ...
    public void drawEnhancePass() {
        ...
        if (z ? true : !this.hsvGenerated) {
            ...
            GLES20.glUniform1i(this.rgbToHsvSourceImageHandle[c2], 0);
            GLES20.glEnableVertexAttribArray(this.rgbToHsvInputTexCoordHandle[c2]);
            GLES20.glVertexAttribPointer(this.rgbToHsvInputTexCoordHandle[c2], 2, 5126, false, 8, (Buffer) this.textureBuffer);
            GLES20.glEnableVertexAttribArray(this.rgbToHsvPositionHandle[c2]);
            GLES20.glVertexAttribPointer(this.rgbToHsvPositionHandle[c2], 2, 5126, false, 8, (Buffer) (this.isVideo ? this.vertexInvertBuffer : this.vertexBuffer));
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.FilterShaders$1 */
    public class C43481 implements FilterShadersDelegate {
