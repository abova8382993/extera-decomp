...
public class AvatarConstructorFragment extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2797R.string.PhotoEditor));
        ...
        if (avatarFor != null && avatarFor.type == 2) {
            string = LocaleController.getString(C2797R.string.SuggestPhoto);
        } else {
            string = LocaleController.getString(C2797R.string.SetPhoto);
        }
        ...
        this.linearLayout = new LinearLayout(getContext()) { // from class: org.telegram.ui.Components.AvatarConstructorFragment.3
            public C38503(Context context2) {
                super(context2);
            }
        ...
        C38514 c38514 = new ContainerLayout(context) { // from class: org.telegram.ui.Components.AvatarConstructorFragment.4
            boolean isScrolling;
            boolean maybeScroll;
            float scrollFromX;
            float scrollFromY;
            ...
            public C38514(Context context2) {
                super(context2);
            }
            ...
            public void onMeasure(int i2, int i3) {
                ...
                if (avatarConstructorFragment3.isLandscapeMode) {
                    ...
                    ((ViewGroup.MarginLayoutParams) AvatarConstructorFragment.this.button.getLayoutParams()).rightMargin = size + AndroidUtilities.m1036dp(16.0f);
                    ((ViewGroup.MarginLayoutParams) AvatarConstructorFragment.this.chooseBackgroundHint.getLayoutParams()).topMargin = 0;
                    ((ViewGroup.MarginLayoutParams) AvatarConstructorFragment.this.chooseEmojiHint.getLayoutParams()).topMargin = AndroidUtilities.m1036dp(10.0f);
                } else {
                    ((ViewGroup.MarginLayoutParams) avatarConstructorFragment3.linearLayout.getLayoutParams()).bottomMargin = AndroidUtilities.m1036dp(64.0f);
                    ...
                    ((ViewGroup.MarginLayoutParams) AvatarConstructorFragment.this.button.getLayoutParams()).rightMargin = AndroidUtilities.m1036dp(16.0f);
                    ((ViewGroup.MarginLayoutParams) AvatarConstructorFragment.this.chooseBackgroundHint.getLayoutParams()).topMargin = AndroidUtilities.m1036dp(10.0f);
                    ((ViewGroup.MarginLayoutParams) AvatarConstructorFragment.this.chooseEmojiHint.getLayoutParams()).topMargin = AndroidUtilities.m1036dp(18.0f);
                }
                ...
                avatarConstructorFragment4.keyboardVisible = this.keyboardHeight >= AndroidUtilities.m1036dp(20.0f);
                if (z2 != AvatarConstructorFragment.this.keyboardVisible) {
                    ...
                    int measuredHeight = avatarConstructorFragment5.keyboardVisible ? (-avatarConstructorFragment5.selectAnimatedEmojiDialog.getTop()) + ((BaseFragment) AvatarConstructorFragment.this).actionBar.getMeasuredHeight() + AndroidUtilities.m1036dp(8.0f) : 0;
            ...
            */
            public boolean drawChild(android.graphics.Canvas r10, android.view.View r11, long r12) {
                /*
                    r9 = this;
                    org.telegram.ui.Components.AvatarConstructorFragment r0 = org.telegram.p035ui.Components.AvatarConstructorFragment.this
                    org.telegram.ui.ActionBar.ActionBar r1 = r0.overlayActionBar
                    if (r11 != r1) goto L8
                    r9 = 1
                    return r9
                L8:
                    org.telegram.ui.ActionBar.ActionBar r0 = org.telegram.p035ui.Components.AvatarConstructorFragment.access$100(r0)
                    if (r11 != r0) goto L57
                    org.telegram.ui.Components.AvatarConstructorFragment r0 = org.telegram.p035ui.Components.AvatarConstructorFragment.this
                    ...
                    int r1 = org.telegram.p035ui.ActionBar.Theme.key_windowBackgroundWhite
                    ...
                    org.telegram.ui.Components.AvatarConstructorFragment r10 = org.telegram.p035ui.Components.AvatarConstructorFragment.this
                ...
                L57:
                    r3 = r10
                L58:
                    boolean r9 = super.drawChild(r3, r11, r12)
                    return r9
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.AvatarConstructorFragment.C38514.drawChild(android.graphics.Canvas, android.view.View, long):boolean");
            }
            ...
            public void dispatchDraw(Canvas canvas) {
                ...
                if (!avatarConstructorFragment.isLandscapeMode) {
                    if (!avatarConstructorFragment.drawForBlur) {
                        ...
                        float f2 = x + AvatarConstructorFragment.this.previewView.f1527cx;
                        float f3 = fLerp + AvatarConstructorFragment.this.previewView.f1528cy;
                        AvatarConstructorFragment avatarConstructorFragment3 = AvatarConstructorFragment.this;
                    ...
                    AvatarConstructorFragment avatarConstructorFragment4 = AvatarConstructorFragment.this;
                    if (alpha != 0.0f) {
                        avatarConstructorFragment4.overlayActionBar.setVisibility(0);
                        ...
                        avatarConstructorFragment4.overlayActionBar.setVisibility(8);
                    }
                }
        ...
        c38514.setFitsSystemWindows(true);
        c38514.setBackgroundColor(Theme.getColor(Theme.key_windowBackgroundGray));
        ...
        C38525 c38525 = new PreviewView(getContext()) { // from class: org.telegram.ui.Components.AvatarConstructorFragment.5
            final /* synthetic */ ContainerLayout val$nestedSizeNotifierLayout;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C38525(Context context2, ContainerLayout c385142) {
                super(context2);
                containerLayout = c385142;
            }
        ...
        this.previewView = c38525;
        linearLayout.addView(c38525);
        TextView textView = new TextView(getContext());
        this.chooseBackgroundHint = textView;
        textView.setText(LocaleController.getString(C2797R.string.ChooseBackground));
        ...
        C38536 c38536 = new FrameLayout(getContext()) { // from class: org.telegram.ui.Components.AvatarConstructorFragment.6
            private Path path = new Path();
            private Paint paint = new Paint(1);

            public C38536(Context context2) {
                super(context2);
                this.path = new Path();
        ...
        c38536.addView(backgroundSelectView);
        this.linearLayout.addView(c38536, LayoutHelper.createLinear(-1, 48, 0, 12, 0, 12, 0));
        TextView textView3 = new TextView(getContext());
        this.chooseEmojiHint = textView3;
        textView3.setText(LocaleController.getString(C2797R.string.ChooseEmojiOrSticker));
        ...
        C38547 c38547 = new SelectAnimatedEmojiDialog(this, getContext(), false, null, 4, true, null, 16, getThemedColor(i)) { // from class: org.telegram.ui.Components.AvatarConstructorFragment.7
            private boolean firstLayout = true;

            public C38547(final BaseFragment this, Context context2, boolean z, Integer num, int i3, boolean z2, Theme.ResourcesProvider resourcesProvider, int i4, int i5) {
        ...
        this.selectAnimatedEmojiDialog = c38547;
        c38547.forUser = !this.forGroup;
        c38547.setAnimationsEnabled(this.fragmentBeginToShow);
        ...
        this.linearLayout.setClipChildren(false);
        c385142.addView(this.linearLayout, LayoutHelper.createFrame(-1, -1.0f, 0, 0.0f, 0.0f, 0.0f, 64.0f));
        ...
        if (i3 == 1) {
            this.buttonText = LocaleController.getString(C2797R.string.SetChannelPhoto);
        } else if (i3 == 2) {
            this.buttonText = LocaleController.getString(C2797R.string.SetGroupPhoto);
        } else {
            ImageUpdater.AvatarFor avatarFor2 = this.avatarFor;
            if (avatarFor2 != null && avatarFor2.type == 2) {
                this.buttonText = LocaleController.getString(C2797R.string.SuggestPhoto);
            } else {
                this.buttonText = LocaleController.getString(C2797R.string.SetMyProfilePhotoAvatarConstructor);
            }
        }
        ...
        spannableStringBuilder.setSpan(new ColoredImageSpan(C2797R.drawable.msg_mini_lock2), spannableStringBuilder.length() - 1, spannableStringBuilder.length(), 33);
        ...
        c385142.addView(this.button, LayoutHelper.createFrame(-1, 48.0f, 80, 16.0f, 16.0f, 16.0f, 16.0f));
        c385142.addView(this.bottomBulletinContainer, LayoutHelper.createFrame(-1, 80.0f, 80, 8.0f, 16.0f, 8.0f, 64.0f));
        c385142.addView(this.actionBar);
        c385142.addView(this.overlayActionBar);
        c385142.addView(this.colorPickerPreviewView, LayoutHelper.createFrame(-1, -1.0f));
        CanvasButton canvasButton = new CanvasButton(c385142);
        ...
        this.fragmentView = c385142;
        return c385142;
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.AvatarConstructorFragment$1 */
    public class C38441 extends ActionBar.ActionBarMenuOnItemClick {
        public C38441() {
        }
    ...
    public class C38492 extends ActionBar.ActionBarMenuOnItemClick {
        public C38492() {
        }
    ...
    public class C38503 extends LinearLayout {
        public C38503(Context context2) {
            super(context2);
        }
    ...
    public class C38514 extends ContainerLayout {
        boolean isScrolling;
        boolean maybeScroll;
        float scrollFromX;
        float scrollFromY;
        ...
        @Override // android.view.ViewGroup
        public boolean drawChild(Canvas v, View v2, long v3) {
            /*
                this = this;
                org.telegram.ui.Components.AvatarConstructorFragment r0 = org.telegram.p035ui.Components.AvatarConstructorFragment.this
                org.telegram.ui.ActionBar.ActionBar r1 = r0.overlayActionBar
    ...
    public class C38525 extends PreviewView {
        final /* synthetic */ ContainerLayout val$nestedSizeNotifierLayout;
    ...
    public class C38536 extends FrameLayout {
        private Path path = new Path();
        private Paint paint = new Paint(1);
    ...
    public class C38547 extends SelectAnimatedEmojiDialog {
        private boolean firstLayout = true;

        public C38547(final AvatarConstructorFragment this, Context context2, boolean z, Integer num, int i3, boolean z2, Theme.ResourcesProvider resourcesProvider, int i4, int i5) {
            super(this, context2, z, num, i3, z2, resourcesProvider, i4, i5);
            this.firstLayout = true;
        }
    ...
    public void discardEditor() {
        ...
        if (this.wasChanged) {
            ...
            builder.setPositiveButton(LocaleController.getString(C2797R.string.PassportDiscard), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.AvatarConstructorFragment$$ExternalSyntheticLambda6
    ...
    public void createKeyboardVisibleAnimator(boolean z) {
        ...
        this.keyboardVisibilityAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.AvatarConstructorFragment.8
            ...
            public C38558(float translationY22, float translationY3, boolean z2) {
                f = translationY22;
                f = translationY3;
                z = z2;
            }
    ...
    public class C38558 implements ValueAnimator.AnimatorUpdateListener {
        final /* synthetic */ boolean val$keyboardVisible;
        final /* synthetic */ float val$translationYFrom;
        final /* synthetic */ float val$translationYTo;
    ...
    public class C38569 extends AnimatorListenerAdapter {
        public C38569() {
        }
    ...
    public void onDonePressed() {
        ...
        if (isLocked()) {
            BulletinFactory.m1142of(this.bottomBulletinContainer, this.resourceProvider).createSimpleBulletin(C2797R.raw.star_premium_2, AndroidUtilities.premiumText(LocaleController.getString(C2797R.string.PremiumAvatarToast), new Runnable() { // from class: org.telegram.ui.Components.AvatarConstructorFragment$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void setExpanded(boolean z, final boolean z2, boolean z3) {
        ...
        this.expandAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.AvatarConstructorFragment.10
            ...
            public C384510(boolean z4, final boolean z22) {
                z = z4;
                z = z22;
            }
    ...
    public class C384510 extends AnimatorListenerAdapter {
        final /* synthetic */ boolean val$expanded;
        final /* synthetic */ boolean val$fromClick;
        ...
        if (videoSize instanceof TLRPC.TL_videoSizeEmojiMarkup) {
            ...
            if (stickerSet != null) {
                for (int i = 0; i < stickerSet.documents.size(); i++) {
                    if (stickerSet.documents.get(i).f1253id == tL_videoSizeStickerMarkup.sticker_id) {
    ...
    public class PreviewView extends FrameLayout {
        ...
        private float f1527cx;

        /* JADX INFO: renamed from: cy */
        private float f1528cy;
        ...
        public PreviewView(Context context) {
            ...
            C38591 c38591 = new BackupImageView(context) { // from class: org.telegram.ui.Components.AvatarConstructorFragment.PreviewView.1
                final /* synthetic */ AvatarConstructorFragment val$this$0;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public C38591(Context context2, AvatarConstructorFragment avatarConstructorFragment) {
                    super(context2);
            ...
            this.backupImageView = c38591;
            c38591.getImageReceiver().setAutoRepeatCount(1);
        ...
        public class C38591 extends BackupImageView {
            final /* synthetic */ AvatarConstructorFragment val$this$0;
        ...
        public void onMeasure(int i, int i2) {
            if (AvatarConstructorFragment.this.isLandscapeMode) {
                ...
                super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(140.0f), TLObject.FLAG_30));
            }
        }
        ...
        public void dispatchDraw(Canvas canvas) {
            PreviewView previewView;
            Canvas canvas2;
            this.f1527cx = getMeasuredWidth() / 2.0f;
            this.f1528cy = getMeasuredHeight() / 2.0f;
            float measuredWidth = AvatarConstructorFragment.this.isLandscapeMode ? getMeasuredWidth() * 0.3f : AndroidUtilities.m1036dp(50.0f);
            ...
            this.size = fLerp;
            this.size = AndroidUtilities.lerp(fLerp, AndroidUtilities.m1036dp(21.0f), AvatarConstructorFragment.this.keyboardVisibleProgress);
            this.f1527cx = AndroidUtilities.lerp(this.f1527cx, (getMeasuredWidth() - AndroidUtilities.m1036dp(12.0f)) - AndroidUtilities.m1036dp(21.0f), AvatarConstructorFragment.this.keyboardVisibleProgress);
            canvas.save();
            AvatarConstructorFragment avatarConstructorFragment = AvatarConstructorFragment.this;
            ...
            if (backgroundGradient != null) {
                ...
                float f2 = this.f1527cx;
                float f3 = this.size;
                float f4 = this.f1528cy;
                ...
                if (this.changeBackgroundProgress != 1.0f) {
                    ...
                    float f5 = this.f1527cx;
                    float f6 = this.size;
                    float f7 = this.f1528cy;
                    gradientTools2.setBounds(f5 - f6, f7 - f6, f5 + f6, f7 + f6);
                    this.outGradientTools.paint.setAlpha(255);
                    canvas2 = canvas;
                    drawBackround(canvas2, this.f1527cx, this.f1528cy, measuredWidth, this.size, this.outGradientTools.paint);
                    this.gradientTools.paint.setAlpha((int) (this.changeBackgroundProgress * 255.0f));
                    drawBackround(canvas2, this.f1527cx, this.f1528cy, measuredWidth, this.size, this.gradientTools.paint);
                    ...
                    previewView = this;
                    previewView.drawBackround(canvas2, this.f1527cx, this.f1528cy, measuredWidth, this.size, this.gradientTools.paint);
                }
            } else {
                previewView = this;
                canvas2 = canvas;
            }
            float fLerp2 = AndroidUtilities.lerp(AndroidUtilities.lerp(AvatarConstructorFragment.this.isLandscapeMode ? (int) ((measuredWidth * 2.0f) * 0.7f) : AndroidUtilities.m1036dp(70.0f), (int) (previewView.getMeasuredWidth() * 0.7f), previewView.expandProgress.get()), (int) (AndroidUtilities.m1036dp(42.0f) * 0.7f), AvatarConstructorFragment.this.keyboardVisibleProgress) / 2.0f;
            ...
            if (animatedEmojiDrawable != null) {
                ...
                float f9 = previewView.f1527cx;
                float f10 = previewView.f1528cy;
            ...
            float f11 = previewView.f1527cx - fLerp2;
            float f12 = previewView.f1528cy - fLerp2;
    ...
    public class BackgroundSelectView extends RecyclerListView {
        ...
        public BackgroundSelectView(Context context) {
            ...
            while (true) {
                ...
                if (i3 < iArr3.length) {
                    ...
                    setPadding(AndroidUtilities.m1036dp(4.0f), 0, AndroidUtilities.m1036dp(4.0f), 0);
                    ...
                    RecyclerView.Adapter c38581 = new RecyclerView.Adapter() { // from class: org.telegram.ui.Components.AvatarConstructorFragment.BackgroundSelectView.1
                        final /* synthetic */ AvatarConstructorFragment val$this$0;

                        public C38581(AvatarConstructorFragment avatarConstructorFragment) {
                            avatarConstructorFragment = avatarConstructorFragment;
                        }
        ...
        public class C38581 extends RecyclerView.Adapter {
            final /* synthetic */ AvatarConstructorFragment val$this$0;
        ...
        public void onMeasure(int i, int i2) {
            ...
            int iM1036dp = AndroidUtilities.m1036dp(39.0f);
            AvatarConstructorFragment avatarConstructorFragment = AvatarConstructorFragment.this;
            if (i3 < iM1036dp) {
                avatarConstructorFragment.gradientBackgroundItemWidth = AndroidUtilities.m1036dp(39.0f);
            } else if (avatarConstructorFragment.gradientBackgroundItemWidth > AndroidUtilities.m1036dp(150.0f)) {
                AvatarConstructorFragment.this.gradientBackgroundItemWidth = AndroidUtilities.m1036dp(48.0f);
            }
            super.onMeasure(i, i2);
        }
    ...
    public void showColorPicker() {
        ...
        DialogC384611 dialogC384611 = new BottomSheet(getContext(), true) { // from class: org.telegram.ui.Components.AvatarConstructorFragment.11
            public DialogC384611(Context context, boolean z) {
                super(context, z);
            }
        ...
        this.bottomSheet = dialogC384611;
        dialogC384611.fixNavigationBar();
        ...
        C384813 c384813 = new ColorPicker(getContext(), false, new ColorPicker.ColorPickerDelegate() { // from class: org.telegram.ui.Components.AvatarConstructorFragment$$ExternalSyntheticLambda7
            ...
            public C384813(Context context, boolean z, ColorPicker.ColorPickerDelegate colorPickerDelegate) {
                super(context, z, colorPickerDelegate);
            }

            @Override // android.widget.FrameLayout, android.view.View
            public void onMeasure(int i, int i2) {
                super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(300.0f), TLObject.FLAG_30));
            }
        };
        ...
        if (backgroundGradient2 != null) {
            ...
            c384813.setColor(i4, 0);
        }
        c384813.setType(-1, true, 4, this.colorPickerGradient.colorsCount(), false, 0, false);
        this.previewView.setGradient(this.colorPickerGradient, true);
        updateButton();
        LinearLayout linearLayout = new LinearLayout(getContext());
        linearLayout.setOrientation(1);
        linearLayout.setPadding(0, AndroidUtilities.m1036dp(8.0f), 0, 0);
        linearLayout.addView(c384813);
        FrameLayout frameLayout = new FrameLayout(getContext());
        frameLayout.setBackground(Theme.AdaptiveRipple.filledRectByKey(Theme.key_featuredStickers_addButton, 8.0f));
        TextView textView = new TextView(getContext());
        textView.setTextSize(1, 14.0f);
        textView.setText(LocaleController.getString(C2797R.string.SetColor));
    ...
    public class DialogC384611 extends BottomSheet {
        public DialogC384611(Context context, boolean z) {
            super(context, z);
        }
    ...
    public class C384712 extends AnimatorListenerAdapter {
        public C384712() {
        }
    ...
    public class C384813 extends ColorPicker {
        public C384813(Context context, boolean z, ColorPicker.ColorPickerDelegate colorPickerDelegate) {
            super(context, z, colorPickerDelegate);
        }
    ...
    public class GradientSelectorView extends View {
        ...
        @Override // android.view.View
        public void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(AvatarConstructorFragment.this.gradientBackgroundItemWidth, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(48.0f), TLObject.FLAG_30));
        }
    ...
    public boolean onBackPressed(boolean z) {
        ...
        builder.setMessage(LocaleController.getString(C2797R.string.PhotoEditorDiscardAlert));
        builder.setTitle(LocaleController.getString(C2797R.string.DiscardChanges));
        builder.setPositiveButton(LocaleController.getString(C2797R.string.PassportDiscard), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.AvatarConstructorFragment$$ExternalSyntheticLambda3
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
