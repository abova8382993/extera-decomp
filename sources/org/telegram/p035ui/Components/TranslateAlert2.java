...
public abstract class TranslateAlert2 extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ TranslateAlert2(Context context, String str, String str2, CharSequence charSequence, ArrayList arrayList, TLRPC.InputPeer inputPeer, int i, boolean z, Theme.ResourcesProvider resourcesProvider, TranslateAlert2IA translateAlert2IA) {
    ...
    private TranslateAlert2(Context context, String str, String str2, CharSequence charSequence, ArrayList<TLRPC.MessageEntity> arrayList, TLRPC.InputPeer inputPeer, int i, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        loadingTextView.setPadding(AndroidUtilities.m1036dp(22.0f), AndroidUtilities.m1036dp(12.0f), AndroidUtilities.m1036dp(22.0f), AndroidUtilities.m1036dp(6.0f));
        ...
        this.textViewContainer = new FrameLayout(context) { // from class: org.telegram.ui.Components.TranslateAlert2.1
            public C52381(Context context2) {
                super(context2);
            }
        ...
        this.textView.setPadding(AndroidUtilities.m1036dp(22.0f), AndroidUtilities.m1036dp(12.0f), AndroidUtilities.m1036dp(22.0f), AndroidUtilities.m1036dp(6.0f));
        ...
        C52402 c52402 = new RecyclerListView(context2) { // from class: org.telegram.ui.Components.TranslateAlert2.2
            ...
            public C52402(Context context2) {
                super(context2);
            }
        ...
        this.listView = c52402;
        c52402.setOverScrollMode(1);
        this.listView.setPadding(0, AndroidUtilities.statusBarHeight + AndroidUtilities.m1036dp(56.0f), 0, AndroidUtilities.m1036dp(80.0f));
        ...
        this.listView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.Components.TranslateAlert2.3
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int i3) {
                ...
                if ((i3 == 0 || i3 == 2) && TranslateAlert2.this.getSheetTop(false) > 0.0f && TranslateAlert2.this.getSheetTop(false) < AndroidUtilities.m1036dp(96.0f) && TranslateAlert2.this.listView.canScrollVertically(1) && TranslateAlert2.this.hasEnoughHeight()) {
        ...
        C52424 c52424 = new DefaultItemAnimator() { // from class: org.telegram.ui.Components.TranslateAlert2.4
            public C52424() {
            }
        ...
        c52424.setDurations(180L);
        c52424.setInterpolator(new LinearInterpolator());
        this.listView.setItemAnimator(c52424);
        ...
        this.mainButton.setText(LocaleController.getString(C2797R.string.CloseTranslation), false);
    ...
    public class C52381 extends FrameLayout {
        public C52381(Context context2) {
            super(context2);
        }
    ...
    /* JADX INFO: loaded from: classes7.dex */
    public class C52402 extends RecyclerListView {
        @Override // androidx.recyclerview.widget.RecyclerView, android.view.ViewGroup
        public boolean onRequestFocusInDescendants(int i3, Rect rect) {
            return true;
        }
    ...
    /* JADX INFO: loaded from: classes7.dex */
    public class C52413 extends RecyclerView.OnScrollListener {
        public C52413() {
        }
    ...
    /* JADX INFO: loaded from: classes7.dex */
    public class C52424 extends DefaultItemAnimator {
        public C52424() {
        }
    ...
    public boolean hasEnoughHeight() {
        ...
        while (true) {
            ...
            if (this.listView.getChildAdapterPosition(recyclerListView.getChildAt(i)) == 1) {
                height += r3.getHeight();
            }
            i++;
        }
    ...
    public void translate() {
        ...
        if (this.reqSum && this.reqPeer != null) {
            ...
            tL_messages_summarizeText.f1379id = this.reqMessageId;
            tL_messages_summarizeText.to_lang = TranslateController.normalizeLanguage(str2);
            this.reqId = Integer.valueOf(ConnectionsManager.getInstance(this.currentAccount).sendRequestTyped(tL_messages_summarizeText, new AiTonesController$$ExternalSyntheticLambda0(), new Utilities.Callback2() { // from class: org.telegram.ui.Components.TranslateAlert2$$ExternalSyntheticLambda4
        ...
        int i = tL_messages_translateText.flags;
        if (inputPeer != null) {
            tL_messages_translateText.flags = 1 | i;
            tL_messages_translateText.peer = inputPeer;
            tL_messages_translateText.f1380id.add(Integer.valueOf(this.reqMessageId));
        } else {
            tL_messages_translateText.flags = i | 2;
            tL_messages_translateText.text.add(tL_textWithEntities);
        }
        tL_messages_translateText.to_lang = TranslateController.normalizeLanguage(str2);
        ...
        if (translationProvider == 0) {
            ...
            TranslatorUtils.translateWithDefault(string, this.reqPeer, this.reqMessageId, str2, this.reqMessageEntities, new TranslatorUtils.TranslateCallback() { // from class: org.telegram.ui.Components.TranslateAlert2.5
                ...
                public C52435(final TLRPC.TL_textWithEntities tL_textWithEntities2, String str22) {
                ...
                public void onSuccess(TLObject tLObject, TLRPC.TL_error tL_error) {
                    ...
                    if (tLObject instanceof TLRPC.TL_messages_translateResult) {
                        ...
                        if (!tL_messages_translateResult.result.isEmpty() && tL_messages_translateResult.result.get(0) != null && tL_messages_translateResult.result.get(0).text != null) {
                            ...
                            TLRPC.TL_textWithEntities tL_textWithEntitiesPreprocess = TranslateAlert2.preprocess(tL_textWithEntities, tL_messages_translateResult.result.get(0));
                ...
                public void onFailed() {
                    BulletinFactory.m1142of((FrameLayout) ((BottomSheet) TranslateAlert2.this).containerView, ((BottomSheet) TranslateAlert2.this).resourcesProvider).createErrorBulletin(LocaleController.getString(C2797R.string.TranslationFailedAlert2)).show();
                ...
                @Override // com.exteragram.messenger.utils.text.TranslatorUtils.TranslateCallback
                public void onReqId(int i2) {
                    TranslateAlert2.this.reqId = Integer.valueOf(i2);
                }
            });
        } else {
            if (charSequence2 != null) {
    ...
    public /* synthetic */ void lambda$translate$1(TLRPC.TL_textWithEntities tL_textWithEntities, TLRPC.TL_textWithEntities tL_textWithEntities2, TLRPC.TL_error tL_error) {
        ...
        BulletinFactory.m1142of((FrameLayout) this.containerView, this.resourcesProvider).createErrorBulletin(LocaleController.getString(C2797R.string.TranslationFailedAlert2)).show();
    ...
    /* JADX INFO: loaded from: classes7.dex */
    public class C52435 implements TranslatorUtils.TranslateCallback {
        final /* synthetic */ String val$finalLang;
        final /* synthetic */ TLRPC.TL_textWithEntities val$textWithEntities;
    ...
    /* JADX INFO: loaded from: classes7.dex */
    public class C52446 implements TranslatorUtils.TranslateCallback {
        final /* synthetic */ String val$finalLang;
    ...
    public /* synthetic */ void lambda$translateAlt$2(String str, Boolean bool) {
        if (str != null) {
            ...
            BulletinFactory.m1142of((FrameLayout) this.containerView, this.resourcesProvider).createErrorBulletin(LocaleController.getString(bool.booleanValue() ? C2797R.string.TranslationFailedAlert1 : C2797R.string.TranslationFailedAlert2)).show();
            AnimatedTextView animatedTextView = this.headerView.toLanguageTextView;
    ...
    public class C52457 extends Thread {
        ...
        */
        public void run() {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.TranslateAlert2.C52457.run():void");
        }
    ...
    private static void alternativeTranslateInternal(String str, String str2, String str3, Utilities.Callback2<String, Boolean> callback2) {
        ...
        new C52457(str2, str3, str, callback2).start();
    }
            ...
            for (URLSpan uRLSpan : (URLSpan[]) spannableStringBuilder.getSpans(0, spannableStringBuilder.length(), URLSpan.class)) {
                ...
                if (spanStart != -1 && spanEnd != -1) {
                    ...
                    spannableStringBuilder.setSpan(new ClickableSpan() { // from class: org.telegram.ui.Components.TranslateAlert2.8
                        ...
                        public C52468(URLSpan uRLSpan2) {
                            uRLSpan = uRLSpan2;
                        }

                        @Override // android.text.style.ClickableSpan
                        public void onClick(View view) {
                            Utilities.CallbackReturn callbackReturn = TranslateAlert2.this.onLinkPress;
                            TranslateAlert2 translateAlert2 = TranslateAlert2.this;
                            if (callbackReturn != null) {
                                if (((Boolean) translateAlert2.onLinkPress.run(uRLSpan)).booleanValue()) {
                                    TranslateAlert2.this.lambda$new$0();
                                }
                            } else if (translateAlert2.fragment != null) {
    ...
    /* JADX INFO: loaded from: classes7.dex */
    public class C52468 extends ClickableSpan {
        final /* synthetic */ URLSpan val$urlSpan;
    ...
    public static class PaddedAdapter extends RecyclerView.Adapter {
        ...
        public class C52531 extends View {
            public C52531(Context context) {
                super(context);
            }
    ...
    public float getSheetTop(boolean z) {
        ...
        float fMax = Math.max(0.0f, top - AndroidUtilities.m1036dp(78.0f));
    ...
    public class HeaderView extends FrameLayout {
        ...
        public HeaderView(Context context) {
            ...
            this.copyButton.setImageResource(C2797R.drawable.msg_copy);
            ...
            C52491 c52491 = new TextView(context) { // from class: org.telegram.ui.Components.TranslateAlert2.HeaderView.1
                final /* synthetic */ TranslateAlert2 val$this$0;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public C52491(Context context2, TranslateAlert2 translateAlert2) {
                    super(context2);
            ...
            this.titleTextView = c52491;
            c52491.setTextColor(TranslateAlert2.this.getThemedColor(i));
            this.titleTextView.setTextSize(1, 20.0f);
            this.titleTextView.setTypeface(AndroidUtilities.bold());
            this.titleTextView.setSingleLine(true);
            this.titleTextView.setEllipsize(TextUtils.TruncateAt.END);
            this.titleTextView.setText(TranslatorUtils.getCurrentTranslatorName());
            Drawable drawable = ContextCompat.getDrawable(getContext(), C2797R.drawable.ic_arrow_drop_down);
            if (drawable != null) {
                Drawable drawableMutate = drawable.mutate();
                drawableMutate.setColorFilter(new PorterDuffColorFilter(TranslateAlert2.this.getThemedColor(i), mode));
                drawableMutate.setBounds(0, -AndroidUtilities.m1036dp(1.0f), AndroidUtilities.m1036dp(22.0f), AndroidUtilities.m1036dp(21.0f));
                boolean z = LocaleController.isRTL;
                TextView textView = this.titleTextView;
                if (z) {
                    textView.setCompoundDrawables(drawableMutate, null, null, null);
                } else {
                    textView.setCompoundDrawables(null, null, drawableMutate, null);
                }
            }
            this.titleTextView.setCompoundDrawablePadding(AndroidUtilities.m1036dp(2.0f));
            this.titleTextView.setPadding(0, 0, 0, 0);
            this.titleTextView.setGravity(LocaleController.isRTL ? 5 : 3);
            this.titleTextView.setIncludeFontPadding(false);
            this.titleTextView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.TranslateAlert2$HeaderView$$ExternalSyntheticLambda2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
            ...
            addView(this.titleTextView, LayoutHelper.createFrame(-2, -2.0f, (LocaleController.isRTL ? 5 : 3) | 48, 22.0f, 20.0f, 22.0f, 0.0f));
            C52502 c52502 = new LinearLayout(context2) { // from class: org.telegram.ui.Components.TranslateAlert2.HeaderView.2
                final /* synthetic */ TranslateAlert2 val$this$0;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public C52502(Context context2, TranslateAlert2 translateAlert2) {
                    super(context2);
                    translateAlert2 = translateAlert2;
                }
            ...
            if (!TextUtils.isEmpty(TranslateAlert2.this.fromLanguage) && !TranslateController.UNKNOWN_LANGUAGE.equals(TranslateAlert2.this.fromLanguage)) {
                ...
                this.fromLanguageTextView.setPadding(0, AndroidUtilities.m1036dp(2.0f), 0, AndroidUtilities.m1036dp(2.0f));
            }
            ImageView imageView6 = new ImageView(context2);
            this.arrowView = imageView6;
            imageView6.setImageResource(C2797R.drawable.search_arrow);
            ...
            C52513 c52513 = new AnimatedTextView(context2) { // from class: org.telegram.ui.Components.TranslateAlert2.HeaderView.3
                private Paint bgPaint = new Paint(1);
                private LinkSpanDrawable.LinkCollector links = new LinkSpanDrawable.LinkCollector();
                final /* synthetic */ TranslateAlert2 val$this$0;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                public C52513(Context context2, TranslateAlert2 translateAlert2) {
                    super(context2);
                    translateAlert2 = translateAlert2;
                ...
                public void onDraw(Canvas canvas) {
                    if (LocaleController.isRTL) {
                        AndroidUtilities.rectTmp.set(getWidth() - width(), (getHeight() - AndroidUtilities.m1036dp(18.0f)) / 2.0f, getWidth(), (getHeight() + AndroidUtilities.m1036dp(18.0f)) / 2.0f);
                    } else {
                        AndroidUtilities.rectTmp.set(0.0f, (getHeight() - AndroidUtilities.m1036dp(18.0f)) / 2.0f, width(), (getHeight() + AndroidUtilities.m1036dp(18.0f)) / 2.0f);
                    }
                    this.bgPaint.setColor(Theme.multAlpha(TranslateAlert2.this.getThemedColor(Theme.key_player_actionBarSubtitle), 0.1175f));
                    canvas.drawRoundRect(AndroidUtilities.rectTmp, AndroidUtilities.m1036dp(4.0f), AndroidUtilities.m1036dp(4.0f), this.bgPaint);
            ...
            this.toLanguageTextView = c52513;
            if (LocaleController.isRTL) {
                c52513.setGravity(5);
            }
            ...
            this.toLanguageTextView.setTextSize(AndroidUtilities.m1036dp(14.0f));
            ...
            this.toLanguageTextView.setPadding(AndroidUtilities.m1036dp(4.0f), AndroidUtilities.m1036dp(2.0f), AndroidUtilities.m1036dp(4.0f), AndroidUtilities.m1036dp(2.0f));
            this.toLanguageTextView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.TranslateAlert2$HeaderView$$ExternalSyntheticLambda3
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
        ...
        public /* synthetic */ void lambda$new$1(View view) {
            if (AndroidUtilities.addToClipboard(TranslateAlert2.this.textView.getText())) {
                BulletinFactory.m1142of((FrameLayout) ((BottomSheet) TranslateAlert2.this).containerView, ((BottomSheet) TranslateAlert2.this).resourcesProvider).createCopyBulletin(LocaleController.getString(C2797R.string.TextCopied)).show();
            }
        }

        /* JADX INFO: renamed from: org.telegram.ui.Components.TranslateAlert2$HeaderView$1 */
        public class C52491 extends TextView {
            final /* synthetic */ TranslateAlert2 val$this$0;
        ...
        public class C52502 extends LinearLayout {
            final /* synthetic */ TranslateAlert2 val$this$0;
        ...
        public class C52513 extends AnimatedTextView {
            private Paint bgPaint = new Paint(1);
            private LinkSpanDrawable.LinkCollector links = new LinkSpanDrawable.LinkCollector();
            final /* synthetic */ TranslateAlert2 val$this$0;
        ...
        public void openProviderSelect() {
            ItemOptions itemOptionsTranslate = ItemOptions.makeOptions(((BottomSheet) TranslateAlert2.this).containerView, ((BottomSheet) TranslateAlert2.this).resourcesProvider, this.titleTextView).setDrawScrim(false).setDimAlpha(0).setGravity(LocaleController.isRTL ? 5 : 3).translate(LocaleController.isRTL ? AndroidUtilities.m1036dp(8.0f) : -AndroidUtilities.m1036dp(8.0f), 0.0f);
            int translationProvider = ExteraConfig.getTranslationProvider();
        ...
        public class C52524 extends ActionBarPopupWindow.ActionBarPopupWindowLayout {
            public C52524(Context context) {
                super(context);
            }
        ...
        public void openLanguagesSelect() {
            C52524 c52524 = new ActionBarPopupWindow.ActionBarPopupWindowLayout(getContext()) { // from class: org.telegram.ui.Components.TranslateAlert2.HeaderView.4
                public C52524(Context context) {
                    super(context);
                }
            ...
            c52524.setBackground(drawableMutate);
            ...
            while (i < arrayList.size()) {
                ...
                c52524.addView(actionBarMenuSubItem);
                i++;
                z = false;
            }
            final ActionBarPopupWindow actionBarPopupWindow = new ActionBarPopupWindow(c52524, -2, -2);
            ...
            c52524.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.displaySize.x, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.displaySize.y, Integer.MIN_VALUE));
            int measuredHeight = c52524.getMeasuredHeight();
            int i2 = iArr[1];
            actionBarPopupWindow.showAtLocation(((BottomSheet) TranslateAlert2.this).containerView, 51, iArr[0] - AndroidUtilities.m1036dp(8.0f), ((float) i2) > (((float) AndroidUtilities.displaySize.y) * 0.9f) - ((float) measuredHeight) ? (i2 - measuredHeight) + AndroidUtilities.m1036dp(8.0f) : (i2 + this.toLanguageTextView.getMeasuredHeight()) - AndroidUtilities.m1036dp(8.0f));
        }
        ...
        public void setTranslationY(float f) {
            ...
            float fClamp = MathUtils.clamp((f - AndroidUtilities.statusBarHeight) / AndroidUtilities.m1036dp(64.0f), 0.0f, 1.0f);
        ...
        @Override // android.widget.FrameLayout, android.view.View
        public void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(78.0f), TLObject.FLAG_30));
        }
    }
    ...
    public class ContainerView extends FrameLayout {
        ...
        public void dispatchDraw(Canvas canvas) {
            ...
            float fLerp = AndroidUtilities.lerp(0, AndroidUtilities.m1036dp(12.0f), MathUtils.clamp(sheetTop / AndroidUtilities.dpf2(24.0f), 0.0f, 1.0f));
            ...
            TranslateAlert2.this.topBulletinContainer.setTranslationY(((-r2.getTop()) - TranslateAlert2.this.topBulletinContainer.getHeight()) + getTranslationY() + Math.max(AndroidUtilities.statusBarHeight + AndroidUtilities.m1036dp(56.0f) + TranslateAlert2.this.topBulletinContainer.getHeight(), sheetTop));
            this.bgPath.rewind();
        ...
        public void setTranslationY(float f) {
            super.setTranslationY(f);
            TranslateAlert2.this.topBulletinContainer.setTranslationY(((-r0.getTop()) - TranslateAlert2.this.topBulletinContainer.getHeight()) + f + Math.max(AndroidUtilities.statusBarHeight + AndroidUtilities.m1036dp(56.0f) + TranslateAlert2.this.topBulletinContainer.getHeight(), TranslateAlert2.this.getSheetTop()));
        }
        ...
        private void updateLightStatusBar(boolean z) {
            ...
            if (bool == null || bool.booleanValue() != z) {
                ...
                if (z) {
                    ...
                    iBlendOver = Theme.blendOver(translateAlert2.getThemedColor(Theme.key_actionBarDefault), AndroidUtilities.DARK_STATUS_BAR_OVERLAY);
                }
        ...
        public class C52481 implements Bulletin.Delegate {
            public C52481() {
            }
    ...
    /* JADX INFO: loaded from: classes7.dex */
    public class DialogC52479 extends TranslateAlert2 {
        final /* synthetic */ Runnable val$onDismiss;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public DialogC52479(Context context, String str, String str2, CharSequence charSequence, ArrayList arrayList, TLRPC.InputPeer inputPeer, int i, boolean z, Theme.ResourcesProvider resourcesProvider, Runnable runnable) {
            super(context, str, str2, charSequence, arrayList, inputPeer, i, z, resourcesProvider);
            runnable = runnable;
        }

        @Override // org.telegram.p035ui.Components.TranslateAlert2, org.telegram.p035ui.ActionBar.BottomSheet, android.app.Dialog, android.content.DialogInterface, org.telegram.ui.ActionBar.BaseFragment.AttachedSheet
        /* JADX INFO: renamed from: dismiss */
        public void lambda$new$0() {
            super.lambda$new$0();
    ...
    public static TranslateAlert2 showAlert(Context context, BaseFragment baseFragment, int i, TLRPC.InputPeer inputPeer, int i2, boolean z, String str, String str2, CharSequence charSequence, ArrayList<TLRPC.MessageEntity> arrayList, boolean z2, Utilities.CallbackReturn<URLSpan, Boolean> callbackReturn, Runnable runnable) {
        DialogC52479 dialogC52479 = new TranslateAlert2(context, str, str2, charSequence, arrayList, inputPeer, i2, z, null) { // from class: org.telegram.ui.Components.TranslateAlert2.9
            final /* synthetic */ Runnable val$onDismiss;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public DialogC52479(Context context2, String str3, String str22, CharSequence charSequence2, ArrayList arrayList2, TLRPC.InputPeer inputPeer2, int i22, boolean z3, Theme.ResourcesProvider resourcesProvider, Runnable runnable2) {
        ...
        dialogC52479.setNoforwards(z2);
        dialogC52479.setFragment(baseFragment);
        dialogC52479.setOnLinkPress(callbackReturn);
        if (baseFragment != null) {
            if (baseFragment.getParentActivity() != null) {
                baseFragment.showDialog(dialogC52479);
            }
            return dialogC52479;
        }
        dialogC52479.show();
    ...
    /* JADX INFO: loaded from: classes7.dex */
    public class DialogC523910 extends TranslateAlert2 {
        final /* synthetic */ Runnable val$onDismiss;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public DialogC523910(Context context, String str, String str2, CharSequence charSequence, ArrayList arrayList, Theme.ResourcesProvider resourcesProvider, Runnable runnable) {
    ...
    public static TranslateAlert2 showAlert(Context context, BaseFragment baseFragment, int i, String str, String str2, CharSequence charSequence, ArrayList<TLRPC.MessageEntity> arrayList, boolean z, Utilities.CallbackReturn<URLSpan, Boolean> callbackReturn, Runnable runnable) {
        if (context == null) {
            return null;
        }
        DialogC523910 dialogC523910 = new TranslateAlert2(context, str, str2, charSequence, arrayList, null) { // from class: org.telegram.ui.Components.TranslateAlert2.10
            final /* synthetic */ Runnable val$onDismiss;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public DialogC523910(Context context2, String str3, String str22, CharSequence charSequence2, ArrayList arrayList2, Theme.ResourcesProvider resourcesProvider, Runnable runnable2) {
        ...
        dialogC523910.setNoforwards(z);
        dialogC523910.setFragment(baseFragment);
        dialogC523910.setOnLinkPress(callbackReturn);
        if (baseFragment != null) {
            if (baseFragment.getParentActivity() != null) {
                baseFragment.showDialog(dialogC523910);
            }
            return dialogC523910;
        }
        dialogC523910.show();
        return dialogC523910;
    }
