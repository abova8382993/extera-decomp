...
public class ChatThemeBottomSheet extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ChatThemeBottomSheet(final ChatActivity chatActivity, ChatActivity.ThemeDelegate themeDelegate) {
        ...
        textView.setText(LocaleController.getString(C2797R.string.SelectTheme));
        textView.setTextColor(getThemedColor(Theme.key_dialogTextBlack));
        textView.setTextSize(1, 20.0f);
        textView.setTypeface(AndroidUtilities.bold());
        textView.setPadding(AndroidUtilities.m1036dp(12.0f), AndroidUtilities.m1036dp(6.0f), AndroidUtilities.m1036dp(12.0f), AndroidUtilities.m1036dp(8.0f));
        ...
        int iM1036dp2 = AndroidUtilities.m1036dp(28.0f);
        int i3 = C2797R.raw.sun_outline;
        String firstName = _UrlKt.FRAGMENT_ENCODE_SET;
        RLottieDrawable rLottieDrawable = new RLottieDrawable(i3, _UrlKt.FRAGMENT_ENCODE_SET + C2797R.raw.sun_outline, iM1036dp2, iM1036dp2, false, null);
        ...
        recyclerListView.setPadding(AndroidUtilities.m1036dp(12.0f), 0, AndroidUtilities.m1036dp(12.0f), 0);
        ...
        view.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1036dp(6.0f), getThemedColor(i2), getThemedColor(Theme.key_featuredStickers_addButtonPressed)));
        ...
        TLRPC.WallPaper wallPaper = this.currentWallpaper;
        TextView textView3 = this.chooseBackgroundTextView;
        if (wallPaper == null) {
            textView3.setText(LocaleController.getString(C2797R.string.ChooseBackgroundFromGallery));
        } else {
            textView3.setText(LocaleController.getString(C2797R.string.ChooseANewWallpaper));
        }
        ...
        this.applyTextView.setTextSize(AndroidUtilities.m1036dp(15.0f));
        ...
        this.applySubTextView.setTextSize(AndroidUtilities.m1036dp(12.0f));
        this.applySubTextView.setAlpha(0.0f);
        this.applySubTextView.setTranslationY(AndroidUtilities.m1036dp(11.0f));
        ...
        if (this.currentWallpaper != null) {
            ...
            this.cancelOrResetTextView.setText(LocaleController.getString(C2797R.string.RestToDefaultBackground));
            ...
            this.themeHintTextView.setText(LocaleController.formatString("ChatThemeApplyHint", C2797R.string.ChatThemeApplyHint, firstName));
        ...
        this.containerView.postDelayed(new Runnable() { // from class: org.telegram.ui.Components.ChatThemeBottomSheet.3
            ...
            public void run() {
                ...
                if (layoutManager != null) {
                    int i2 = i;
                    int i3 = ChatThemeBottomSheet.this.prevSelectedPosition;
                    int i4 = i;
                    if (i2 > i3) {
                        iMax = Math.min(i4 + 1, ChatThemeBottomSheet.this.adapter.items.size() - 1);
                    } else {
                        iMax = Math.max(i4 - 1, 0);
                    }
    ...
    public void updateButtonColors() {
        ...
        if (textView != null) {
            ...
            this.themeHintTextView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1036dp(6.0f), 0, ColorUtils.setAlphaComponent(getThemedColor(Theme.key_featuredStickers_addButton), 76)));
        }
        TextView textView2 = this.cancelOrResetTextView;
        if (textView2 != null) {
            int i = Theme.key_text_RedRegular;
            textView2.setTextColor(getThemedColor(i));
            this.cancelOrResetTextView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1036dp(6.0f), 0, ColorUtils.setAlphaComponent(getThemedColor(i), 76)));
        }
        ...
        this.chooseBackgroundTextView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1036dp(6.0f), 0, ColorUtils.setAlphaComponent(getThemedColor(i3), 76)));
    }
    ...
    private void previewSelectedTheme() {
        ...
        boolean z = emojiThemes.showAsDefaultStub;
        ChatActivity.ThemeDelegate themeDelegate = this.themeDelegate;
        if (z) {
            themeDelegate.setCurrentTheme(null, wallPaper, true, Boolean.valueOf(this.forceDark));
        } else {
            themeDelegate.setCurrentTheme(emojiThemes, wallPaper, true, Boolean.valueOf(this.forceDark));
        }
    }
    ...
    */
    private void updateState(boolean r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.ChatThemeBottomSheet.updateState(boolean):void");
    }
    ...
    private void updateApplySubTextTranslation(final boolean z, boolean z2) {
        ...
        if (z2) {
            ...
            this.subTextTranslationAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ChatThemeBottomSheet.5
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    ChatThemeBottomSheet.this.applyTextView.setTranslationY((-AndroidUtilities.m1036dp(7.0f)) * ChatThemeBottomSheet.this.subTextTranslation);
                }
            });
        ...
        this.applyTextView.setTranslationY((-AndroidUtilities.m1036dp(7.0f)) * this.subTextTranslation);
    }
    ...
    public void loadNext() {
        ...
        if (chatThemeController.isGiftThemesFullyLoaded()) {
            chatThemeController.requestAllChatThemes(new C41846(chatThemeController), false);
        } else {
            chatThemeController.loadNextChatThemes(new C41857(chatThemeController));
        }
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.ChatThemeBottomSheet$6 */
    public class C41846 implements ResultCallback<List<EmojiThemes>> {
        final /* synthetic */ ChatThemeController val$chatThemeController;

        public C41846(ChatThemeController chatThemeController) {
    ...
    public class C41857 implements ResultCallback<Void> {
        final /* synthetic */ ChatThemeController val$chatThemeController;

        public C41857(ChatThemeController chatThemeController) {
            this.val$chatThemeController = chatThemeController;
        }
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.hintView.setBottomOffset(-AndroidUtilities.m1036dp(8.0f));
        boolean z = this.forceDark;
        HintView hintView2 = this.hintView;
        if (z) {
            hintView2.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ChatThemeDaySwitchTooltip", C2797R.string.ChatThemeDaySwitchTooltip, new Object[0])));
        } else {
            hintView2.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ChatThemeNightSwitchTooltip", C2797R.string.ChatThemeNightSwitchTooltip, new Object[0])));
        }
    ...
    public void close() {
        if (hasChanges()) {
            ...
            builder.setTitle(LocaleController.getString(C2797R.string.ChatThemeSaveDialogTitle));
            builder.setMessage(LocaleController.getString(C2797R.string.ChatThemeSaveDialogText));
            builder.setPositiveButton(LocaleController.getString(C2797R.string.ChatThemeSaveDialogApply), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.ChatThemeBottomSheet$$ExternalSyntheticLambda1
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i) {
                    this.f$0.lambda$close$9(alertDialog, i);
                }
            });
            builder.setNegativeButton(LocaleController.getString(C2797R.string.ChatThemeSaveDialogDiscard), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.ChatThemeBottomSheet$$ExternalSyntheticLambda2
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i) {
        ...
        ThemeDescription.ThemeDescriptionDelegate themeDescriptionDelegate = new ThemeDescription.ThemeDescriptionDelegate() { // from class: org.telegram.ui.Components.ChatThemeBottomSheet.8
            ...
            public void onAnimationProgress(float f) {
                ...
                if (ChatThemeBottomSheet.this.chatAttachButton != null) {
                    ChatThemeBottomSheet.this.chatAttachButton.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1036dp(0.0f), ChatThemeBottomSheet.this.getThemedColor(Theme.key_windowBackgroundWhite), ColorUtils.setAlphaComponent(ChatThemeBottomSheet.this.getThemedColor(i), 76)));
                }
    ...
    public /* synthetic */ void lambda$setupLightDarkTheme$13(boolean z) {
        ...
        if (this.selectedItem != null) {
            ...
            ChatActivity.ThemeDelegate themeDelegate = this.themeDelegate;
            if (z2) {
                themeDelegate.setCurrentTheme(null, currentWallpaper, false, Boolean.valueOf(z));
            } else {
                themeDelegate.setCurrentTheme(emojiThemes, currentWallpaper, false, Boolean.valueOf(z));
            }
        }
        ...
        while (true) {
            ...
            if (i < size) {
                adapter3.items.get(i).themeIndex = z ? 1 : 0;
                i++;
            } else {
        ...
        if (this.currentTheme != null) {
            ...
            while (true) {
                if (i == list.size()) {
                    ...
                    if (ThemeKey.equals(list.get(i).chatTheme.getThemeKey(), this.currentTheme.getThemeKey())) {
    ...
    private void applySelectedTheme(boolean z) {
        ...
        if (chatThemeItem != null && emojiThemes != this.currentTheme) {
            ...
            ChatActivity.ThemeDelegate themeDelegate = this.themeDelegate;
            if (!z2) {
                themeDelegate.setCurrentTheme(emojiThemes, currentWallpaper, true, Boolean.valueOf(this.originalIsDark));
            } else {
                themeDelegate.setCurrentTheme(null, currentWallpaper, true, Boolean.valueOf(this.originalIsDark));
            }
            ...
            if (currentUser != null && !currentUser.self) {
                ...
                if (z3) {
                    textView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ThemeAlsoDisabledForHint", C2797R.string.ThemeAlsoDisabledForHint, currentUser.first_name)));
                } else {
                    textView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ThemeAlsoAppliedForHint", C2797R.string.ThemeAlsoAppliedForHint, currentUser.first_name)));
                }
    ...
    public static void openGalleryForBackground(Activity activity, BaseFragment baseFragment, long j, Theme.ResourcesProvider resourcesProvider, Utilities.Callback<TLRPC.WallPaper> callback, ThemePreviewActivity.DayNightSwitchDelegate dayNightSwitchDelegate, TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus) {
        ...
        chatAttachAlert.setupPhotoPicker(LocaleController.getString(C2797R.string.ChooseBackground));
        chatAttachAlert.setDelegate(new C417612(chatAttachAlert, tL_premium_boostsStatus, resourcesProvider, dayNightSwitchDelegate, j, callback, baseFragment));
    ...
    public class C417612 implements ChatAttachAlert.ChatAttachViewDelegate {
        long start;
        ...
        public C417612(ChatAttachAlert chatAttachAlert, TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus, Theme.ResourcesProvider resourcesProvider, ThemePreviewActivity.DayNightSwitchDelegate dayNightSwitchDelegate, long j, Utilities.Callback callback, BaseFragment baseFragment) {
            ...
            try {
                ...
                if (str != null) {
                    ...
                    ThemePreviewActivity themePreviewActivity = new ThemePreviewActivity(new WallpapersListActivity.FileWallpaper(_UrlKt.FRAGMENT_ENCODE_SET, file, file), bitmapLoadBitmap) { // from class: org.telegram.ui.Components.ChatThemeBottomSheet.12.1
                        @Override // org.telegram.p035ui.ThemePreviewActivity
                    ...
                    themePreviewActivity.setDelegate(new ThemePreviewActivity.WallpaperActivityDelegate() { // from class: org.telegram.ui.Components.ChatThemeBottomSheet$12$$ExternalSyntheticLambda0
                        ...
                        public final void didSetNewBackground(TLRPC.WallPaper wallPaper) {
                            ChatThemeBottomSheet.C417612.$r8$lambda$yCNJNz_wi4txAgZrLSpOt3PRB_4(chatAttachAlert, callback, wallPaper);
                        }
                    });
        ...
        public void onWallpaperSelected(Object obj) {
            ...
            themePreviewActivity.setDelegate(new ThemePreviewActivity.WallpaperActivityDelegate() { // from class: org.telegram.ui.Components.ChatThemeBottomSheet$12$$ExternalSyntheticLambda1
                @Override // org.telegram.ui.ThemePreviewActivity.WallpaperActivityDelegate
                public final void didSetNewBackground(TLRPC.WallPaper wallPaper) {
                    ChatThemeBottomSheet.C417612.m11271$r8$lambda$6dRX3czrryVZ6jB_jue3GVp8Y(chatAttachAlert, callback, wallPaper);
                }
            });
            BaseFragment.BottomSheetParams bottomSheetParams = new BaseFragment.BottomSheetParams();
            bottomSheetParams.transitionFromLeft = true;
        ...
        public static /* synthetic */ void m11271$r8$lambda$6dRX3czrryVZ6jB_jue3GVp8Y(ChatAttachAlert chatAttachAlert, Utilities.Callback callback, TLRPC.WallPaper wallPaper) {
            chatAttachAlert.dismissInternal();
            if (callback != null) {
                callback.run(wallPaper);
            }
    ...
    private void openGalleryForBackground() {
        ...
        chatAttachAlert.drawNavigationBar = true;
        chatAttachAlert.setupPhotoPicker(LocaleController.getString(C2797R.string.ChooseBackground));
        this.chatAttachAlert.setDelegate(new C417713());
        ...
        this.chatAttachButtonText.setText(LocaleController.getString(C2797R.string.SetColorAsBackground));
        ...
        this.chatAttachButton.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1036dp(0.0f), getThemedColor(Theme.key_windowBackgroundWhite), ColorUtils.setAlphaComponent(getThemedColor(i), 76)));
    ...
    public class C417713 implements ChatAttachAlert.ChatAttachViewDelegate {
        long start;
    ...
    public /* synthetic */ void lambda$openGalleryForBackground$17(View view) {
        ChatAttachAlert.AttachAlertLayout currentAttachLayout = this.chatAttachAlert.getCurrentAttachLayout();
        ChatAttachAlertPhotoLayout photoLayout = this.chatAttachAlert.getPhotoLayout();
        AnimatedTextView animatedTextView = this.chatAttachButtonText;
        if (currentAttachLayout == photoLayout) {
            animatedTextView.setText(LocaleController.getString(C2797R.string.ChooseBackgroundFromGallery));
            this.chatAttachAlert.openColorsLayout();
            this.chatAttachAlert.colorsLayout.updateColors(this.forceDark);
        } else {
            animatedTextView.setText(LocaleController.getString(C2797R.string.SetColorAsBackground));
            ChatAttachAlert chatAttachAlert = this.chatAttachAlert;
    ...
    public void lambda$showAsSheet$22() {
        ...
        ChatActivity.ThemeDelegate themeDelegate = this.themeDelegate;
        if (z) {
            themeDelegate.setCurrentTheme(null, currentWallpaper, false, Boolean.valueOf(this.forceDark), true);
        } else {
            themeDelegate.setCurrentTheme(emojiThemes, currentWallpaper, false, Boolean.valueOf(this.forceDark), true);
        }
        ChatAttachAlert chatAttachAlert = this.chatAttachAlert;
        if (chatAttachAlert != null) {
        ...
        while (true) {
            ...
            Adapter adapter2 = this.adapter;
            if (i < size) {
                adapter2.items.get(i).themeIndex = this.forceDark ? 1 : 0;
                i++;
            } else {
        ...
        themePreviewActivity.setOnSwitchDayNightDelegate(new ThemePreviewActivity.DayNightSwitchDelegate() { // from class: org.telegram.ui.Components.ChatThemeBottomSheet.15
            ...
            public void switchDayNight(boolean z) {
                ...
                if (ChatThemeBottomSheet.this.selectedItem != null) {
                    ...
                    boolean z2 = ChatThemeBottomSheet.this.selectedItem.chatTheme.showAsDefaultStub;
                    ChatThemeBottomSheet chatThemeBottomSheet = ChatThemeBottomSheet.this;
                    if (z2) {
                        chatThemeBottomSheet.themeDelegate.setCurrentTheme(null, currentWallpaper, z, Boolean.valueOf(ChatThemeBottomSheet.this.forceDark));
                    } else {
                        chatThemeBottomSheet.themeDelegate.setCurrentTheme(ChatThemeBottomSheet.this.selectedItem.chatTheme, currentWallpaper, z, Boolean.valueOf(ChatThemeBottomSheet.this.forceDark));
                    }
