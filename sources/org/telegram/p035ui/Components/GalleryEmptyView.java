...
public class GalleryEmptyView extends LinearLayout {
    ...
    public GalleryEmptyView(Context context, int i, boolean z) {
        ...
        backupImageView.setImageDrawable(new RLottieDrawable(C2797R.raw.utyan_gallery, "utyan_gallery", AndroidUtilities.m1036dp(110.0f), AndroidUtilities.m1036dp(110.0f)));
        ...
        textView.setText(LocaleController.getString(C2797R.string.GalleryAccessAllowAccess));
        ...
        textView2.setText(LocaleController.getString(UserConfig.getInstance(i).isPremium() ? C2797R.string.GalleryAccessAllowAccessTextPremium : C2797R.string.GalleryAccessAllowAccessTextNonPremium));
        textView2.setMaxWidth(AndroidUtilities.m1036dp(260.0f));
        ...
        buttonWithCounterView.setText(LocaleController.getString(C2797R.string.GalleryAccessAllowAccessButton), false);
        ...
        spannableStringBuilder.setSpan(new ColoredImageSpan(C2797R.drawable.outline_attach_camera_24), 0, 1, 33);
        spannableStringBuilder.append((CharSequence) "  ").append((CharSequence) LocaleController.getString(C2797R.string.GalleryAccessAllowAccessOpenCamera));
        ...
        spannableStringBuilder2.append((CharSequence) LocaleController.getString(C2797R.string.UseEmoji));
    ...
    public void onMeasure(int i, int i2) {
        ...
        int iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(44.0f), TLObject.FLAG_30);
        ...
        this.galleryAccessButton.getLayoutParams().width = AndroidUtilities.m1036dp(80.0f) + iMax;
        this.cameraAccessButton.getLayoutParams().width = AndroidUtilities.m1036dp(80.0f) + iMax;
        this.useAnEmojiButton.getLayoutParams().width = iMax + AndroidUtilities.m1036dp(80.0f);
    ...
    public void doOnEmojiButton(final Utilities.Callback<Long> callback) {
