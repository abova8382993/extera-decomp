...
public class VideoPlayerSeekBar {
    ...
    private int lineHeight = AndroidUtilities.m1036dp(4.0f);
    private int smallLineHeight = AndroidUtilities.m1036dp(2.0f);
    ...
    public void setProgress(float f, boolean z) {
        ...
        if (z) {
            if (Math.abs(iCeil - this.thumbX) > AndroidUtilities.m1036dp(10.0f)) {
        ...
        if (Math.abs(this.animatedThumbX - this.thumbX) > AndroidUtilities.m1036dp(8.0f)) {
            this.animatedThumbX = this.thumbX;
        }
    }
        ...
        try {
            ...
            Collections.sort(this.timestamps, new Comparator() { // from class: org.telegram.ui.Components.VideoPlayerSeekBar$$ExternalSyntheticLambda0
                ...
                public final int compare(Object obj, Object obj2) {
                    return VideoPlayerSeekBar.m14737$r8$lambda$o3EHnMr9BcAI6WfiUzSrQzpwFA((Pair) obj, (Pair) obj2);
                }
            });
        } catch (Exception e) {
            FileLog.m1048e(e);
    ...
    public static /* synthetic */ int m14737$r8$lambda$o3EHnMr9BcAI6WfiUzSrQzpwFA(Pair pair, Pair pair2) {
    ...
    public void draw(Canvas canvas, View view) {
        ...
        int i = this.height;
        rectF.top = AndroidUtilities.lerp((i - this.lineHeight) / 2.0f, (i - AndroidUtilities.m1036dp(3.0f)) - this.smallLineHeight, this.transitionProgress);
        RectF rectF2 = this.rect;
        int i2 = this.height;
        rectF2.bottom = AndroidUtilities.lerp((this.lineHeight + i2) / 2.0f, i2 - AndroidUtilities.m1036dp(3.0f), this.transitionProgress);
        ...
        boolean z = this.animateResetBuffering;
        ...
        if (z) {
            ...
            float f12 = (f9 * (1.0f - f11)) + (this.bufferedProgress * f11);
            if (f12 > 0.0f) {
        ...
        if (this.currentRadius != fM1036dp) {
            ...
            if (f13 < fM1036dp) {
                float fM1036dp2 = f13 + (AndroidUtilities.m1036dp(1.0f) * (j / 60.0f));
                this.currentRadius = fM1036dp2;
                if (fM1036dp2 > fM1036dp) {
                    this.currentRadius = fM1036dp;
                }
            } else {
                float fM1036dp3 = f13 - (AndroidUtilities.m1036dp(1.0f) * (j / 60.0f));
        ...
        if (f6 > 0.0f) {
            ...
            rectF4.left = AndroidUtilities.lerp(f14, rectF4.right, 1.0f - f6);
        ...
        float f16 = thumbWidth / f;
        if (this.pressed) {
            f3 = this.draggingThumbX;
        }
        rectF5.right = f15 + AndroidUtilities.lerp(f16 + f3, (this.parentView.getWidth() - (this.horizontalPadding * f)) * getProgress(), this.transitionProgress);
        if (this.transitionProgress > 0.0f && this.rect.width() > 0.0f) {
            strokePaint.setAlpha((int) (this.transitionProgress * 255.0f * 0.2f));
            drawProgressBar(canvas, this.rect, strokePaint);
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:94:0x0207 A[EDGE_INSN: B:94:0x0207->B:85:0x0207 BREAK  A[LOOP:2: B:30:0x00d9->B:84:0x01fc], SYNTHETIC] */
    ...
    */
    private void drawProgressBar(android.graphics.Canvas r26, android.graphics.RectF r27, android.graphics.Paint r28) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.VideoPlayerSeekBar.drawProgressBar(android.graphics.Canvas, android.graphics.RectF, android.graphics.Paint):void");
    }
    ...
    private void drawTimestampLabel(Canvas canvas) {
        ...
        float fAbs = Math.abs(fLerp - f4) - AndroidUtilities.m1036dp(16.0f);
        ...
        canvas.save();
        int i2 = this.height;
        canvas.translate(fLerp + ((fLerp2 - f2) * this.transitionProgress), AndroidUtilities.lerp((this.lineHeight + i2) / f, i2 - AndroidUtilities.m1036dp(3.0f), this.transitionProgress) + AndroidUtilities.m1036dp(12.0f));
