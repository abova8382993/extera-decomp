...
public class AppIconBulletinLayout extends Bulletin.ButtonLayout {
    ...
    public AppIconBulletinLayout(Context context, LauncherIconController.LauncherIcon launcherIcon, Theme.ResourcesProvider resourcesProvider) {
        ...
        adaptiveIconImageView.setOuterPadding(AndroidUtilities.m1036dp(8.0f));
        adaptiveIconImageView.setBackgroundOuterPadding(AndroidUtilities.m1036dp(24.0f));
        adaptiveIconImageView.setForeground(launcherIcon.foreground);
        textView.setText(AndroidUtilities.replaceTags(LocaleController.formatString(C2797R.string.AppIconChangedTo, LocaleController.getString(launcherIcon.title))));
    }
}
