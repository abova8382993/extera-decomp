...
public class VectorAvatarThumbDrawable extends Drawable implements AnimatedEmojiSpan.InvalidateHolder, AttachableDrawable, NotificationCenter.NotificationCenterDelegate {
    ...
    public VectorAvatarThumbDrawable(TLRPC.VideoSize videoSize, boolean z, int i) {
        ...
        if (videoSize instanceof TLRPC.TL_videoSizeStickerMarkup) {
            ...
            C52981 c52981 = new ImageReceiver() { // from class: org.telegram.ui.Components.VectorAvatarThumbDrawable.1
                public C52981() {
                }
            ...
            this.imageReceiver = c52981;
            c52981.setInvalidateAll(true);
            if (i == 1) {
    ...
    public class C52981 extends ImageReceiver {
        public C52981() {
        }
    ...
    */
    private void setImage() {
        ...
        L4f:
            ...
            r4 = r2
        L52:
            int r1 = org.telegram.p035ui.ActionBar.Theme.key_windowBackgroundWhiteGrayIcon
        ...
        L8f:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.VectorAvatarThumbDrawable.setImage():void");
    }
        ...
        if (obj != null && getClass() == obj.getClass()) {
            ...
            if (this.type == vectorAvatarThumbDrawable.type) {
                ...
                if (i == gradientTools2.color1 && gradientTools.color2 == gradientTools2.color2 && gradientTools.color3 == gradientTools2.color3 && gradientTools.color4 == gradientTools2.color4) {
                    ...
                    if (tL_videoSizeStickerMarkup2 != null && (tL_videoSizeStickerMarkup = vectorAvatarThumbDrawable.sizeStickerMarkup) != null && tL_videoSizeStickerMarkup2.stickerset.f1270id == tL_videoSizeStickerMarkup.stickerset.f1270id && tL_videoSizeStickerMarkup2.sticker_id == tL_videoSizeStickerMarkup.sticker_id) {
                        return true;
                    }
                }
            }
