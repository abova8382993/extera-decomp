...
public class StorageUsageView extends FrameLayout {
    ...
    public StorageUsageView(Context context) {
        ...
        this.paintFill.setStrokeWidth(AndroidUtilities.m1036dp(6.0f));
        this.paintCalculcating.setStrokeWidth(AndroidUtilities.m1036dp(6.0f));
        this.paintProgress.setStrokeWidth(AndroidUtilities.m1036dp(6.0f));
        this.paintProgress2.setStrokeWidth(AndroidUtilities.m1036dp(6.0f));
        ...
        C51621 c51621 = new FrameLayout(context) { // from class: org.telegram.ui.Components.StorageUsageView.1
            public C51621(Context context2) {
                super(context2);
            }
                ...
                for (int i3 = 0; i3 < childCount; i3++) {
                    if (getChildAt(i3).getVisibility() != 8) {
                        if (getChildAt(i3).getMeasuredWidth() + measuredWidth > View.MeasureSpec.getSize(i)) {
                            measuredHeight2 += getChildAt(i3).getMeasuredHeight() + AndroidUtilities.m1036dp(8.0f);
                            measuredWidth = 0;
                        }
                        measuredWidth += getChildAt(i3).getMeasuredWidth() + AndroidUtilities.m1036dp(16.0f);
                ...
                for (int i5 = 0; i5 < childCount; i5++) {
                    if (getChildAt(i5).getVisibility() != 8) {
                        if (getChildAt(i5).getMeasuredWidth() + measuredWidth > getMeasuredWidth()) {
                            measuredHeight += getChildAt(i5).getMeasuredHeight() + AndroidUtilities.m1036dp(8.0f);
                            measuredWidth = 0;
                        }
                        ...
                        measuredWidth += getChildAt(i5).getMeasuredWidth() + AndroidUtilities.m1036dp(16.0f);
                    }
                }
            }
        };
        this.legendLayout = c51621;
        linearLayout.addView(c51621, LayoutHelper.createLinear(-1, -2, 21.0f, 40.0f, 21.0f, 16.0f));
        TextView textView = new TextView(context2);
        this.calculatingTextView = textView;
        int i = Theme.key_windowBackgroundWhiteGrayText;
        textView.setTextColor(Theme.getColor(i));
        String string = LocaleController.getString("CalculatingSize", C2797R.string.CalculatingSize);
        ...
        textView2.setCompoundDrawablePadding(AndroidUtilities.m1036dp(6.0f));
        this.telegramCacheTextView.setTextColor(Theme.getColor(i));
        TextView textView3 = new TextView(context2);
        this.telegramDatabaseTextView = textView3;
        textView3.setCompoundDrawablePadding(AndroidUtilities.m1036dp(6.0f));
        this.telegramDatabaseTextView.setTextColor(Theme.getColor(i));
        TextView textView4 = new TextView(context2);
        this.freeSizeTextView = textView4;
        textView4.setCompoundDrawablePadding(AndroidUtilities.m1036dp(6.0f));
        this.freeSizeTextView.setTextColor(Theme.getColor(i));
        TextView textView5 = new TextView(context2);
        this.totlaSizeTextView = textView5;
        textView5.setCompoundDrawablePadding(AndroidUtilities.m1036dp(6.0f));
        this.totlaSizeTextView.setTextColor(Theme.getColor(i));
        this.lastProgressColor = Theme.getColor(Theme.key_player_progress);
        this.telegramCacheTextView.setCompoundDrawablesWithIntrinsicBounds(Theme.createCircleDrawable(AndroidUtilities.m1036dp(10.0f), this.lastProgressColor), (Drawable) null, (Drawable) null, (Drawable) null);
        this.telegramCacheTextView.setCompoundDrawablePadding(AndroidUtilities.m1036dp(6.0f));
        this.freeSizeTextView.setCompoundDrawablesWithIntrinsicBounds(Theme.createCircleDrawable(AndroidUtilities.m1036dp(10.0f), ColorUtils.setAlphaComponent(this.lastProgressColor, 64)), (Drawable) null, (Drawable) null, (Drawable) null);
        this.freeSizeTextView.setCompoundDrawablePadding(AndroidUtilities.m1036dp(6.0f));
        this.totlaSizeTextView.setCompoundDrawablesWithIntrinsicBounds(Theme.createCircleDrawable(AndroidUtilities.m1036dp(10.0f), ColorUtils.setAlphaComponent(this.lastProgressColor, 127)), (Drawable) null, (Drawable) null, (Drawable) null);
        this.totlaSizeTextView.setCompoundDrawablePadding(AndroidUtilities.m1036dp(6.0f));
        this.telegramDatabaseTextView.setCompoundDrawablesWithIntrinsicBounds(Theme.createCircleDrawable(AndroidUtilities.m1036dp(10.0f), this.lastProgressColor), (Drawable) null, (Drawable) null, (Drawable) null);
        this.telegramDatabaseTextView.setCompoundDrawablePadding(AndroidUtilities.m1036dp(6.0f));
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.StorageUsageView$1 */
    public class C51621 extends FrameLayout {
        public C51621(Context context2) {
            super(context2);
        }
    ...
    public void setStorageUsage(boolean z, long j, long j2, long j3, long j4) {
        ...
        this.freeSizeTextView.setText(LocaleController.formatString("TotalDeviceFreeSize", C2797R.string.TotalDeviceFreeSize, AndroidUtilities.formatFileSize(j3)));
        long j5 = j4 - j3;
        this.totlaSizeTextView.setText(LocaleController.formatString("TotalDeviceSize", C2797R.string.TotalDeviceSize, AndroidUtilities.formatFileSize(j5)));
        if (z) {
            ...
            if (j2 > 0) {
                ...
                this.telegramDatabaseTextView.setVisibility(8);
                this.textSettingsCell.setTextAndValue(LocaleController.getString(C2797R.string.ClearTelegramCache), AndroidUtilities.formatFileSize(j2), true);
                this.telegramCacheTextView.setText(LocaleController.formatString("TelegramCacheSize", C2797R.string.TelegramCacheSize, AndroidUtilities.formatFileSize(j2 + j)));
            } else {
                this.telegramCacheTextView.setVisibility(8);
                this.telegramDatabaseTextView.setVisibility(0);
                this.telegramDatabaseTextView.setText(LocaleController.formatString("LocalDatabaseSize", C2797R.string.LocalDatabaseSize, AndroidUtilities.formatFileSize(j)));
                this.divider.setVisibility(8);
                this.textSettingsCell.setVisibility(8);
            }
    ...
    public class ProgressView extends View {
        ...
        @Override // android.view.View
        public void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(40.0f), TLObject.FLAG_30));
        }
        ...
        public void onDraw(Canvas canvas) {
            ...
            canvas.drawLine(AndroidUtilities.m1036dp(24.0f), AndroidUtilities.m1036dp(20.0f), getMeasuredWidth() - AndroidUtilities.m1036dp(24.0f), AndroidUtilities.m1036dp(20.0f), StorageUsageView.this.paintFill);
            if (StorageUsageView.this.calculating || StorageUsageView.this.calculatingProgress != 0.0f) {
                boolean z = StorageUsageView.this.calculating;
                ...
                if (z) {
                    ...
                    float f3 = storageUsageView.calculatingProgress - 0.10666667f;
                    storageUsageView.calculatingProgress = f3;
                    if (f3 < 0.0f) {
                        storageUsageView.calculatingProgress = 0.0f;
                    }
                }
                ...
                rectF.set(AndroidUtilities.m1036dp(24.0f), AndroidUtilities.m1036dp(17.0f), getMeasuredWidth() - AndroidUtilities.m1036dp(24.0f), AndroidUtilities.m1036dp(23.0f));
                StorageUsageView.this.cellFlickerDrawable.setParentWidth(getMeasuredWidth());
                StorageUsageView.this.cellFlickerDrawable.draw(canvas, rectF, AndroidUtilities.m1036dp(3.0f), null);
            }
            int iM1036dp = AndroidUtilities.m1036dp(24.0f);
            if (!StorageUsageView.this.calculating) {
                int iM1036dp2 = AndroidUtilities.m1036dp(24.0f) + ((int) ((getMeasuredWidth() - (AndroidUtilities.m1036dp(24.0f) * 2)) * StorageUsageView.this.progress2));
                canvas.drawLine(iM1036dp, AndroidUtilities.m1036dp(20.0f), AndroidUtilities.m1036dp(24.0f) + r3, AndroidUtilities.m1036dp(20.0f), StorageUsageView.this.paintProgress2);
                canvas.drawRect(iM1036dp2, AndroidUtilities.m1036dp(20.0f) - AndroidUtilities.m1036dp(3.0f), iM1036dp2 + AndroidUtilities.m1036dp(3.0f), AndroidUtilities.m1036dp(20.0f) + AndroidUtilities.m1036dp(3.0f), StorageUsageView.this.bgPaint);
            }
            if (StorageUsageView.this.calculating) {
                return;
            }
            int measuredWidth = (int) ((getMeasuredWidth() - (AndroidUtilities.m1036dp(24.0f) * 2)) * StorageUsageView.this.progress);
            if (measuredWidth < AndroidUtilities.m1036dp(1.0f)) {
                measuredWidth = AndroidUtilities.m1036dp(1.0f);
            }
            int iM1036dp3 = AndroidUtilities.m1036dp(24.0f) + measuredWidth;
            canvas.drawLine(iM1036dp, AndroidUtilities.m1036dp(20.0f), AndroidUtilities.m1036dp(24.0f) + measuredWidth, AndroidUtilities.m1036dp(20.0f), StorageUsageView.this.paintProgress);
            canvas.drawRect(iM1036dp3, AndroidUtilities.m1036dp(20.0f) - AndroidUtilities.m1036dp(3.0f), iM1036dp3 + AndroidUtilities.m1036dp(3.0f), AndroidUtilities.m1036dp(20.0f) + AndroidUtilities.m1036dp(3.0f), StorageUsageView.this.bgPaint);
        }
    }
