...
public class SenderSelectView extends View {
    private static final FloatPropertyCompat<SenderSelectView> MENU_PROGRESS = new SimpleFloatPropertyCompat("menuProgress", new SimpleFloatPropertyCompat.Getter() { // from class: org.telegram.ui.Components.SenderSelectView$$ExternalSyntheticLambda0
        ...
        public final void set(Object obj, float f) {
            SenderSelectView.m13888$r8$lambda$K0kIe8gi8ce3Pl7QoAyAgwuavA((SenderSelectView) obj, f);
        }
    ...
    /* JADX INFO: renamed from: $r8$lambda$K-0kIe8gi8ce3Pl7QoAyAgwuavA, reason: not valid java name */
    public static /* synthetic */ void m13888$r8$lambda$K0kIe8gi8ce3Pl7QoAyAgwuavA(SenderSelectView senderSelectView, float f) {
    ...
    public SenderSelectView(Context context) {
        ...
        this.menuPaint.setStrokeWidth(AndroidUtilities.m1036dp(2.0f));
        this.menuPaint.setStrokeCap(Paint.Cap.ROUND);
        this.menuPaint.setStyle(Paint.Style.STROKE);
        updateColors();
        setContentDescription(LocaleController.formatString("AccDescrSendAsPeer", C2797R.string.AccDescrSendAsPeer, _UrlKt.FRAGMENT_ENCODE_SET));
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        float strokeWidth = this.menuPaint.getStrokeWidth() + AndroidUtilities.m1036dp(10.0f);
    ...
    public void setAvatar(TLObject tLObject) {
        ...
        setContentDescription(LocaleController.formatString("AccDescrSendAsPeer", C2797R.string.AccDescrSendAsPeer, firstName));
