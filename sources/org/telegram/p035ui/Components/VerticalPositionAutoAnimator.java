...
public final class VerticalPositionAutoAnimator {
    ...
    public class AnimatorLayoutChangeListener implements View.OnLayoutChangeListener {
        ...
        public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
            ...
            VerticalPositionAutoAnimator verticalPositionAutoAnimator = VerticalPositionAutoAnimator.this;
            if (visibility != 0) {
                view.setTranslationY(verticalPositionAutoAnimator.offsetY);
                return;
            }
            verticalPositionAutoAnimator.floatingButtonAnimator.getSpring().setFinalPosition(VerticalPositionAutoAnimator.this.offsetY);
