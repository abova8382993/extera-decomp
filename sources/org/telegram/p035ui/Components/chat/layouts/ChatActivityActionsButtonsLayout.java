...
public class ChatActivityActionsButtonsLayout extends LinearLayout {
    ...
    public static /* synthetic */ void m14914$r8$lambda$93jBtX9Pu1HgVxuSin9Qptiq48(View view) {
    }
    ...
    public static /* synthetic */ void m14915$r8$lambda$hGVeBG6LPQS6sq_sAAeOPhOqg(View view) {
    }
    ...
    public ChatActivityActionsButtonsLayout(Context context, Theme.ResourcesProvider resourcesProvider, BlurredBackgroundColorProvider blurredBackgroundColorProvider, BlurredBackgroundDrawableViewFactory blurredBackgroundDrawableViewFactory) {
        ...
        chatActivityBlurredRoundButtonCreate.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.chat.layouts.ChatActivityActionsButtonsLayout$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                ChatActivityActionsButtonsLayout.m14914$r8$lambda$93jBtX9Pu1HgVxuSin9Qptiq48(view);
            }
        });
        ...
        chatActivityBlurredRoundButtonCreate2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.chat.layouts.ChatActivityActionsButtonsLayout$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ChatActivityActionsButtonsLayout.m14915$r8$lambda$hGVeBG6LPQS6sq_sAAeOPhOqg(view);
            }
        });
        ...
        addTextView(buttonHolder, LocaleController.getString(C2797R.string.Reply), C2797R.drawable.input_reply, false);
        addTextView(buttonHolder2, LocaleController.getString(C2797R.string.Forward), C2797R.drawable.input_forward, true);
        addTextView(buttonHolder3, LocaleController.getString(C2797R.string.Select), C2797R.drawable.select_between, false);
        setOrientation(0);
    ...
    private void addTextView(ButtonHolder buttonHolder, String str, int i, boolean z) {
        ...
        textView.setPadding(AndroidUtilities.m1036dp(21.0f), 0, AndroidUtilities.m1036dp(21.0f), 0);
        textView.setCompoundDrawablePadding(AndroidUtilities.m1036dp(6.0f));
    ...
    public void checkHolderPositionsAndVisibility(ButtonHolder buttonHolder) {
        ...
        float f = (-AndroidUtilities.m1036dp(54.0f)) * (1.0f - floatValue);
        ...
        if (floatValue <= 0.05f) {
            chatActivityBlurredRoundButton.setVisibility(4);
        } else {
            chatActivityBlurredRoundButton.setVisibility(0);
        }
    }
