...
import org.telegram.p035ui.Components.inset.WindowInsetsProvider;
...
public class ChatInputViewsContainer extends FrameLayout {
    ...
    public void setInputIslandBubbleDrawable(BlurredBackgroundDrawable blurredBackgroundDrawable) {
        ...
        blurredBackgroundDrawable.setPadding(AndroidUtilities.m1036dp(7.0f));
        this.blurredBackgroundDrawable.setRadius(AndroidUtilities.m1036dp(24.0f));
    }
    ...
    public void setUnderKeyboardBackgroundDrawable(BlurredBackgroundDrawable blurredBackgroundDrawable) {
        ...
        this.underKeyboardBackgroundDrawable.setRadius(AndroidUtilities.m1036dp(20.0f), AndroidUtilities.m1036dp(20.0f), 0.0f, 0.0f);
        this.underKeyboardBackgroundDrawable.setThickness(AndroidUtilities.m1036dp(32.0f));
    ...
    private void checkBlurredHeight(boolean z) {
        checkViewsPositions();
        int iM1036dp = this.inputBubbleHeightRound + AndroidUtilities.m1036dp(9.0f) + Math.round(this.maxBottomInset);
        if (this.currentBlurredHeight != iM1036dp || z) {
            this.currentBlurredHeight = iM1036dp;
    ...
    public void checkInsets() {
        ...
        if (this.underKeyboardBackgroundDrawable != null) {
            ...
            this.underKeyboardBackgroundDrawable.setRadius(AndroidUtilities.m1036dp(20.0f), AndroidUtilities.m1036dp(20.0f), radius2, radius, true);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void checkViewsPositions() {
        this.inputIslandBubbleContainer.setTranslationY((-this.maxBottomInset) - AndroidUtilities.m1036dp(9.0f));
    ...
    public float getInputBubbleBottom() {
        return (getMeasuredHeight() - this.maxBottomInset) - AndroidUtilities.m1036dp(9.0f);
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        this.underKeyboardBackgroundDrawable.setBounds(0, getMeasuredHeight() - ((int) this.imeBottomInset), getMeasuredWidth(), Math.max(getMeasuredHeight(), (getMeasuredHeight() - ((int) this.imeBottomInset)) + AndroidUtilities.m1036dp(40.0f)));
        ...
        this.tmpRect.inset(0, -AndroidUtilities.m1036dp(7.0f));
