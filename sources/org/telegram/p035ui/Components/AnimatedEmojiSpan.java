...
public class AnimatedEmojiSpan extends ReplacementSpan {
    ...
    public class C37931 extends AnimatorListenerAdapter {
        public C37931() {
        }
    ...
    /* JADX INFO: loaded from: classes7.dex */
    public class C37942 extends AnimatorListenerAdapter {
        public C37942() {
        }
    ...
    public int getSize(Paint paint, CharSequence charSequence, int i, int i2, Paint.FontMetricsInt fontMetricsInt) {
        ...
        if (fontMetricsInt2 == null) {
            ...
            if (fontMetricsInt != null) {
                float f2 = (-iM1036dp2) - iM1036dp;
                float f3 = this.scale;
                fontMetricsInt.top = (int) (f2 * f3);
                float f4 = iM1036dp2 - iM1036dp;
            ...
            this.measuredSize = (int) (f * this.scale);
            if (fontMetricsInt != null) {
                if (!this.full) {
    ...
    /* JADX INFO: loaded from: classes7.dex */
    public class C37953 extends AnimatorListenerAdapter {
        public C37953() {
        }
    ...
    */
    public void draw(android.graphics.Canvas r1, java.lang.CharSequence r2, int r3, int r4, float r5, int r6, int r7, int r8, android.graphics.Paint r9) {
        ...
        L28:
            ...
            goto L46
        L2f:
            boolean r3 = org.telegram.p035ui.Components.AnimatedEmojiSpan.lockPositionChanging
            if (r3 == 0) goto L34
            goto L46
        L34:
            float r3 = r0.lastDrawnCx
        ...
        L46:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.AnimatedEmojiSpan.draw(android.graphics.Canvas, java.lang.CharSequence, int, int, float, int, int, int, android.graphics.Paint):void");
    }
    ...
    public static void drawAnimatedEmojis(Canvas canvas, Layout layout, EmojiGroupedSpans emojiGroupedSpans, float f, List<SpoilerEffect> list, float f2, float f3, float f4, float f5, ColorFilter colorFilter) {
        ...
        if (Emoji.emojiDrawingYOffset == 0.0f && f == 0.0f) {
            ...
            canvas.save();
            canvas.translate(0.0f, Emoji.emojiDrawingYOffset + AndroidUtilities.m1036dp(20.0f * f));
            z = true;
        }
                    ...
                    if (animatedEmojiSpanCloneSpan == null) {
                        ...
                        if (animatedEmojiHolder == null) {
                            ...
                            if ((i9 == 20 || i9 == 21) && !TextUtils.isEmpty(animatedEmojiSpanCloneSpan.emoji)) {
                                ...
                                String str = animatedEmojiSpanCloneSpan.emoji;
                                if (animatedEmojiDrawable != null) {
                                    animatedEmojiDrawable.setupEmojiThumb(str);
                                } else {
                                    animatedEmojiHolder2.thumbDrawable = Emoji.getEmojiDrawable(str);
                                }
                            }
    ...
    public static class SpansChunk {
        ...
        /* JADX INFO: loaded from: classes7.dex */
        public class C37961 extends DrawingInBackgroundThreadDrawable {
            ...
            public void onFrameReady() {
                ArrayList<AnimatedEmojiHolder> arrayList;
                int i = 0;
                while (true) {
                    int size = this.backgroundHolders.size();
                    arrayList = this.backgroundHolders;
                    if (i >= size) {
                        break;
                    }
        ...
        private void checkBackgroundRendering() {
            ...
            if (this.allowBackgroundRendering && this.holders.size() >= 10 && this.backgroundThreadDrawable == null && LiteMode.isEnabled(LiteMode.FLAG_ANIMATED_EMOJI_KEYBOARD)) {
                C37961 c37961 = new DrawingInBackgroundThreadDrawable() { // from class: org.telegram.ui.Components.AnimatedEmojiSpan.SpansChunk.1
                    private final ArrayList<AnimatedEmojiHolder> backgroundHolders = new ArrayList<>();
                ...
                this.backgroundThreadDrawable = c37961;
                c37961.padding = AndroidUtilities.m1036dp(3.0f);
        ...
        /*
            ...
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        public void draw(android.graphics.Canvas r15, java.util.List<org.telegram.p035ui.Components.spoilers.SpoilerEffect> r16, long r17, float r19, float r20, float r21, float r22, android.graphics.ColorFilter r23) {
            /*
                r14 = this;
                r0 = r16
                r1 = 0
                r2 = r1
            L4:
                java.util.ArrayList<org.telegram.ui.Components.AnimatedEmojiSpan$AnimatedEmojiHolder> r3 = r14.holders
                int r3 = r3.size()
            ...
            L2c:
                ...
                org.telegram.ui.Components.spoilers.SpoilerEffect r3 = (org.telegram.p035ui.Components.spoilers.SpoilerEffect) r3
            ...
            L7b:
                ...
                int r10 = r0.getWidth()
                android.text.Layout r14 = r14.layout
