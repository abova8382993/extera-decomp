...
import org.telegram.p035ui.Components.VideoSeekPreviewImage;
...
public abstract class VideoSeekPreviewImage extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public VideoSeekPreviewImage(Context context, VideoSeekPreviewImageDelegate videoSeekPreviewImageDelegate) {
        ...
        setVisibility(4);
        this.frameDrawable = context.getResources().getDrawable(C2797R.drawable.videopreview);
        ...
        if (z) {
            ...
            if (photoViewerWebView != null) {
                ...
                while (true) {
                    ...
                    storyBoardFrame = this.storyBoardMap.get(i2);
            ...
            if (f > 1.0f) {
                ...
                int i3 = (int) (iM1036dp * f);
                i = iM1036dp;
                iM1036dp = i3;
            }
            ViewGroup.LayoutParams layoutParams = getLayoutParams();
            if (getVisibility() == 0 && layoutParams.width == iM1036dp && layoutParams.height == i) {
                return;
            }
    ...
    */
    public void setProgress(org.telegram.messenger.MessageObject r13, final float r14, int r15) {
        /*
            ...
            r1 = 0
            r12.isYoutube = r1
            java.util.ArrayList<org.telegram.ui.Components.VideoSeekPreviewImage$StoryBoardFrame> r2 = r12.storyBoardMap
            if (r2 == 0) goto L35
        ...
        L83:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.VideoSeekPreviewImage.setProgress(org.telegram.messenger.MessageObject, float, int):void");
    }
    ...
    public /* synthetic */ void lambda$setProgress$2(float f, long j) {
        ...
        int iMax = Math.max(200, AndroidUtilities.m1036dp(100.0f));
    ...
    public /* synthetic */ void lambda$setProgress$1(Bitmap bitmap) {
        ...
        if (bitmap != null) {
            ...
            if (width > 1.0f) {
                i = (int) (iM1036dp / width);
            } else {
                iM1036dp = (int) (iM1036dp * width);
                i = iM1036dp;
            }
            ViewGroup.LayoutParams layoutParams = getLayoutParams();
            if (getVisibility() != 0 || layoutParams.width != iM1036dp || layoutParams.height != i) {
    ...
    public void open(MessageObject messageObject, VideoPlayer videoPlayer) {
        ...
        if (videoPlayer.getQualitiesCount() > 0) {
            ...
            for (int i = 0; i < videoPlayer.getQualitiesCount(); i++) {
                ArrayList<VideoPlayer.VideoUri> arrayList = videoPlayer.getQuality(i).uris;
                int size = arrayList.size();
                int i2 = 0;
                while (i2 < size) {
                    VideoPlayer.VideoUri videoUri = arrayList.get(i2);
                    i2++;
                    VideoPlayer.VideoUri videoUri2 = videoUri;
                    if (downloadUri == null || ((!downloadUri.isCached() && videoUri2.isCached()) || (downloadUri.isCached() == videoUri2.isCached() && videoUri2.width * videoUri2.height < downloadUri.width * downloadUri.height))) {
                        downloadUri = videoUri2;
                    }
                }
            }
        ...
        long j = documentFindDocumentByMimeType == null ? 0L : documentFindDocumentByMimeType.f1253id;
    ...
    public void parseStoryBoardMap(File file) {
        ...
        try {
            ...
            ArrayList<StoryBoardFrame> arrayList = new ArrayList<>();
            long j = 0;
            int i = 0;
            int i2 = 0;
            while (true) {
                ...
                if (line != null) {
                    ...
                    Collections.sort(arrayList, Comparator.comparingDouble(new ToDoubleFunction() { // from class: org.telegram.ui.Components.VideoSeekPreviewImage$$ExternalSyntheticLambda1
    ...
    public /* synthetic */ void lambda$open$5(VideoPlayer.VideoUri videoUri, MessageObject messageObject) {
        ...
        if (videoUri.isCached()) {
            ...
            if (FileLoader.getInstance(i).isLoadingFile(FileLoader.getAttachFileName(document))) {
                absolutePath = new File(FileLoader.getDirectory(4), document.dc_id + "_" + document.f1253id + ".temp").getAbsolutePath();
            } else {
    ...
    public /* synthetic */ void lambda$open$7(Uri uri, MessageObject messageObject) {
        ...
        if ("tg".equals(uri.getScheme())) {
            ...
            tL_document.f1253id = Utilities.parseLong(uri.getQueryParameter("id")).longValue();
            ...
            if (FileLoader.getInstance(iIntValue).isLoadingFile(FileLoader.getAttachFileName(tL_document))) {
                absolutePath = new File(FileLoader.getDirectory(4), tL_document.dc_id + "_" + tL_document.f1253id + ".temp").getAbsolutePath();
            } else {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.drawStoryBoard) {
            ...
            this.ytPath.addRoundRect(rectF, AndroidUtilities.m1036dp(6.0f), AndroidUtilities.m1036dp(6.0f), Path.Direction.CW);
            ...
            canvas.drawText(this.frameTime, (getMeasuredWidth() - this.timeWidth) / 2.0f, getMeasuredHeight() - AndroidUtilities.m1036dp(9.0f), this.textPaint);
            return;
        }
        ...
        canvas.drawRoundRect(this.bitmapRect, AndroidUtilities.m1036dp(6.0f), AndroidUtilities.m1036dp(6.0f), this.bitmapPaint);
        this.frameDrawable.setBounds(0, 0, getMeasuredWidth(), getMeasuredHeight());
        this.frameDrawable.draw(canvas);
        canvas.drawText(this.frameTime, (getMeasuredWidth() - this.timeWidth) / 2.0f, getMeasuredHeight() - AndroidUtilities.m1036dp(9.0f), this.textPaint);
    }
