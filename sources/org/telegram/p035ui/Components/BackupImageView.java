...
public class BackupImageView extends View {
    ...
    public void setBlurAllowed(boolean z) {
        if (this.attached) {
            Segment$$ExternalSyntheticBUOutline1.m992m("You should call setBlurAllowed(...) only when detached!");
            return;
        }
        this.blurAllowed = z;
        if (z) {
    ...
    public void setHasBlur(boolean z) {
        if (z && !this.blurAllowed) {
            Segment$$ExternalSyntheticBUOutline1.m992m("You should call setBlurAllowed(...) before calling setHasBlur(true)!");
            return;
        }
        this.hasBlur = z;
        if (!z) {
    ...
    public void setImageMedia(VectorAvatarThumbDrawable vectorAvatarThumbDrawable, ImageLocation imageLocation, String str, ImageLocation imageLocation2, String str2, ImageLocation imageLocation3, String str3, String str4, int i, int i2, Object obj) {
        ...
        if (vectorAvatarThumbDrawable != null) {
            imageReceiver.setImageBitmap(vectorAvatarThumbDrawable);
        } else {
            imageReceiver.setImage(imageLocation, str, imageLocation2, str2, imageLocation3, str3, null, i, str4, obj, i2);
        }
        onNewImageSet();
    }
    ...
    public class C38651 implements ValueAnimator.AnimatorUpdateListener {
        public C38651() {
        }
    ...
    public void drawBlurredText(Canvas canvas, float f) {
        ...
        float currentWidth = this.blurText.getCurrentWidth() + AndroidUtilities.m1036dp(18.0f);
        float fM1036dp = AndroidUtilities.m1036dp(28.0f);
        float f2 = (measuredWidth - currentWidth) / 2.0f;
        float f3 = measuredHeight / 2.0f;
        RectF rectF = AndroidUtilities.rectTmp;
        float f4 = fM1036dp / 2.0f;
        ...
        this.blurText.draw(canvas, f2 + AndroidUtilities.m1036dp(9.0f), f3, -1, f);
        canvas.restore();
    }
