...
import org.telegram.p035ui.Components.SharingLocationsAlert;
...
public class FragmentContextView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, VoIPService.StateListener, GroupCallMessagesController.CallMessageListener {
    ...
    private final ReplaceAnimator<CallMessageItem> callMessagesAnimator;
        ...
        this.updateScheduleTimeRunnable = new Runnable() { // from class: org.telegram.ui.Components.FragmentContextView.1
            ...
            public void run() {
                ...
                if (!FragmentContextView.this.willBeNotified) {
                    fullDuration = LocaleController.getString(C2797R.string.VoipChatNotify);
                }
    ...
    private void checkCreateView() {
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.Components.FragmentContextView.3
            ...
            public void dispatchDraw(Canvas canvas) {
                ...
                if (FragmentContextView.this.currentStyle == 4 && FragmentContextView.this.notifyButtonEnabled) {
                    int iCeil = ((int) Math.ceil(FragmentContextView.this.notifyText.getCurrentWidth())) + AndroidUtilities.m1036dp(24.0f);
                    ...
                    int measuredWidth = (getMeasuredWidth() - iCeil) - AndroidUtilities.m1036dp(10.0f);
                    float f2 = measuredWidth;
                    float fM1036dp = AndroidUtilities.m1036dp(10.0f);
                    this.notifyButtonRect.set(f2, fM1036dp, measuredWidth + iCeil, r2 + AndroidUtilities.m1036dp(28.0f));
                    canvas.save();
                    ...
                    canvas.translate(f2, fM1036dp);
                    RectF rectF = AndroidUtilities.rectTmp;
                    rectF.set(0.0f, 0.0f, iCeil, AndroidUtilities.m1036dp(28.0f));
                    canvas.drawRoundRect(rectF, AndroidUtilities.m1036dp(16.0f), AndroidUtilities.m1036dp(16.0f), FragmentContextView.this.gradientPaint);
                    canvas.translate(AndroidUtilities.m1036dp(12.0f), AndroidUtilities.m1036dp(6.0f));
                    FragmentContextView.this.notifyText.setBounds(0, 0, AndroidUtilities.displaySize.x, AndroidUtilities.m1036dp(16.0f));
        ...
        this.notifyText.setTextSize(AndroidUtilities.m1036dp(14.0f));
        ...
        if (!this.isInsideBubble) {
            ...
            this.shadow = view2;
            view2.setBackgroundResource(C2797R.drawable.blockpanel_shadow);
        ...
        this.playButton.setBackground(Theme.createSelectorDrawable(getThemedColor(i) & 436207615, 1, AndroidUtilities.m1036dp(14.0f)));
        ...
        this.importingImageView.setAnimation(C2797R.raw.import_progress, 30, 30);
        this.importingImageView.setBackground(Theme.createCircleDrawable(AndroidUtilities.m1036dp(22.0f), getThemedColor(i)));
        ...
        TextView textView = new TextView(context) { // from class: org.telegram.ui.Components.FragmentContextView.6
            ...
            public void draw(Canvas canvas) {
                ...
                RectF rectF = AndroidUtilities.rectTmp;
                float f = iM1036dp;
                rectF.set(f, f, getWidth() - iM1036dp, getHeight() - iM1036dp);
                FragmentContextView.this.joinButtonFlicker.draw(canvas, rectF, AndroidUtilities.m1036dp(16.0f), this);
            }
        ...
        textView.setText(LocaleController.getString(C2797R.string.VoipChatJoin));
        this.joinButton.setTextColor(getThemedColor(Theme.key_featuredStickers_buttonText));
        this.joinButton.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1036dp(16.0f), getThemedColor(Theme.key_featuredStickers_addButton), getThemedColor(Theme.key_featuredStickers_addButtonPressed)));
        this.joinButton.setTextSize(1, 14.0f);
        this.joinButton.setTypeface(AndroidUtilities.bold());
        this.joinButton.setGravity(17);
        this.joinButton.setPadding(AndroidUtilities.m1036dp(14.0f), 0, AndroidUtilities.m1036dp(14.0f), 0);
        ...
        imageView4.setImageResource(C2797R.drawable.msg_mute);
        ...
        this.silentButton.setBackground(Theme.createSelectorDrawable(getThemedColor(i2) & 436207615, 1, AndroidUtilities.m1036dp(14.0f)));
        this.silentButton.setContentDescription(LocaleController.getString(C2797R.string.Unmute));
        ...
        avatarsImageView.setAvatarsTextSize(AndroidUtilities.m1036dp(21.0f));
        ...
        this.muteDrawable = new RLottieDrawable(C2797R.raw.voice_muted, _UrlKt.FRAGMENT_ENCODE_SET + C2797R.raw.voice_muted, AndroidUtilities.m1036dp(16.0f), AndroidUtilities.m1036dp(20.0f), true, null);
        C43887 c43887 = new C43887(context);
        this.muteButton = c43887;
        c43887.setColorFilter(new PorterDuffColorFilter(getThemedColor(Theme.key_returnToCallText), mode));
        this.muteButton.setBackground(Theme.createSelectorDrawable(getThemedColor(i2) & 436207615, 1, AndroidUtilities.m1036dp(14.0f)));
        ...
        imageView6.setImageResource(C2797R.drawable.miniplayer_close);
        this.closeButton.setColorFilter(new PorterDuffColorFilter(getThemedColor(i2), mode));
        this.closeButton.setBackground(Theme.createSelectorDrawable(getThemedColor(i2) & 436207615, 1, AndroidUtilities.m1036dp(14.0f)));
    ...
    public class C43887 extends RLottieImageView {
        ...
        public /* synthetic */ void lambda$$0() {
            ...
            if (FragmentContextView.this.muteDrawable.setCustomEndFrame(FragmentContextView.this.isMuted ? 15 : 29)) {
                boolean z = FragmentContextView.this.isMuted;
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            accessibilityNodeInfo.setText(LocaleController.getString(FragmentContextView.this.isMuted ? C2797R.string.VoipUnmute : C2797R.string.VoipMute));
        }
    }
    ...
    public /* synthetic */ void lambda$checkCreateView$4(View view) {
        ...
        if (sharedInstance.groupCall != null) {
            ...
            TLRPC.GroupCallParticipant groupCallParticipant = call.participants.get(sharedInstance.getSelfId());
    ...
    public /* synthetic */ void lambda$checkCreateView$6(View view) {
        if (this.currentStyle == 2) {
            ...
            builder.setTitle(LocaleController.getString(C2797R.string.StopLiveLocationAlertToTitle));
            if (this.fragment instanceof DialogsActivity) {
                builder.setMessage(LocaleController.getString(C2797R.string.StopLiveLocationAlertAllText));
            } else {
                TLRPC.Chat currentChat = this.chatActivity.getCurrentChat();
                TLRPC.User currentUser = this.chatActivity.getCurrentUser();
                if (currentChat != null) {
                    builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("StopLiveLocationAlertToGroupText", C2797R.string.StopLiveLocationAlertToGroupText, currentChat.title)));
                } else if (currentUser != null) {
                    builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("StopLiveLocationAlertToUserText", C2797R.string.StopLiveLocationAlertToUserText, UserObject.getFirstName(currentUser))));
                } else {
                    builder.setMessage(LocaleController.getString(C2797R.string.AreYouSure));
                }
            }
            builder.setPositiveButton(LocaleController.getString(C2797R.string.Stop), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.FragmentContextView$$ExternalSyntheticLambda14
    ...
    private void createPlaybackSpeedButton() {
        ...
        actionBarMenuItem.setAdditionalYOffset(AndroidUtilities.m1036dp(30.0f));
        ...
        this.speedItems[0] = this.playbackSpeedButton.lazilyAddSubItem(0, C2797R.drawable.msg_speed_slow, LocaleController.getString(C2797R.string.SpeedSlow));
        this.speedItems[1] = this.playbackSpeedButton.lazilyAddSubItem(1, C2797R.drawable.msg_speed_normal, LocaleController.getString(C2797R.string.SpeedNormal));
        this.speedItems[2] = this.playbackSpeedButton.lazilyAddSubItem(2, C2797R.drawable.msg_speed_medium, LocaleController.getString(C2797R.string.SpeedMedium));
        this.speedItems[3] = this.playbackSpeedButton.lazilyAddSubItem(3, C2797R.drawable.msg_speed_fast, LocaleController.getString(C2797R.string.SpeedFast));
        this.speedItems[4] = this.playbackSpeedButton.lazilyAddSubItem(4, C2797R.drawable.msg_speed_veryfast, LocaleController.getString(C2797R.string.SpeedVeryFast));
        this.speedItems[5] = this.playbackSpeedButton.lazilyAddSubItem(5, C2797R.drawable.msg_speed_superfast, LocaleController.getString(C2797R.string.SpeedSuperFast));
    ...
    private void showSpeedHint() {
        ...
        hintView.setExtraTranslationY(AndroidUtilities.m1036dp(-12.0f));
    ...
    public void onPanTranslationUpdate(float f) {
        ...
        if (hintView != null) {
            hintView.setExtraTranslationY(AndroidUtilities.m1036dp(72.0f) + f);
        }
    }
    ...
    public void updateColors() {
        ...
        if (actionBarMenuItem != null) {
            actionBarMenuItem.setBackground(Theme.createSelectorDrawable(themedColor & 436207615, 1, AndroidUtilities.m1036dp(14.0f)));
        }
    ...
    public void openSharingLocation(final LocationController.SharingLocationInfo sharingLocationInfo) {
        ...
        locationActivity.setDelegate(new LocationActivity.LocationActivityDelegate() { // from class: org.telegram.ui.Components.FragmentContextView$$ExternalSyntheticLambda18
            ...
            public final void didSelectLocation(TLRPC.MessageMedia messageMedia, int i, boolean z, int i2, long j) {
                SendMessagesHelper.getInstance(sharingLocationInfo.messageObject.currentAccount).sendMessage(SendMessagesHelper.SendMessageParams.m1079of(messageMedia, dialogId, (MessageObject) null, (MessageObject) null, (TLRPC.ReplyMarkup) null, (HashMap<String, String>) null, z, i2, 0));
            }
        });
    ...
    private void playbackSpeedChanged(boolean z, float f, float f2) {
        ...
        if (Math.abs(f2 - 1.0f) < 0.05f) {
            ...
            string = LocaleController.getString(C2797R.string.AudioSpeedNormal);
            if (Math.abs(f - 2.0f) < 0.05f) {
                i = C2797R.raw.speed_2to1;
            } else if (f2 < f) {
                i = C2797R.raw.speed_slow;
            } else {
                i = C2797R.raw.speed_fast;
            }
        } else if (z && equals(f2, 1.5f) && equals(f, 1.0f)) {
            string = LocaleController.formatString("AudioSpeedCustom", C2797R.string.AudioSpeedCustom, SpeedIconDrawable.formatNumber(f2));
            i = C2797R.raw.speed_1to15;
        } else if (!z || !equals(f2, 2.0f) || !equals(f, 1.5f)) {
            string = LocaleController.formatString("AudioSpeedCustom", C2797R.string.AudioSpeedCustom, SpeedIconDrawable.formatNumber(f2));
            i = f2 < 1.0f ? C2797R.raw.speed_slow : C2797R.raw.speed_fast;
        } else {
            string = LocaleController.getString(C2797R.string.AudioSpeedFast);
            i = C2797R.raw.speed_15to2;
        }
        BulletinFactory.m1143of(this.fragment).createSimpleBulletin(i, string).show();
    }
    ...
    private void updateStyle(int i, boolean z) {
        if (this.currentStyle != i || z) {
            ...
            if (i2 == 3 || i2 == 1) {
                ...
                ReplaceAnimator<CallMessageItem> replaceAnimator = this.callMessagesAnimator;
            ...
            if (i == 5) {
                ...
                this.closeButton.setContentDescription(LocaleController.getString(C2797R.string.AccDescrClosePlayer));
                ActionBarMenuItem actionBarMenuItem = this.playbackSpeedButton;
                if (actionBarMenuItem != null) {
            ...
            if (i == 0 || i == 2) {
                ...
                ImageView imageView = this.playButton;
                if (i == 0) {
                    imageView.setLayoutParams(LayoutHelper.createFrame(36, 36.0f, 51, 3.0f, 0.0f, 0.0f, 0.0f));
                ...
                imageView.setLayoutParams(LayoutHelper.createFrame(36, 36.0f, 51, 8.0f, 0.0f, 0.0f, 0.0f));
                this.titleTextView.setLayoutParams(LayoutHelper.createFrame(-1, 36.0f, 51, 51.0f, 0.0f, (this.isSideMenued ? 64 : 0) + 36, 0.0f));
                this.closeButton.setContentDescription(LocaleController.getString(C2797R.string.AccDescrStopLiveLocation));
                return;
            }
            if (i == 4) {
                this.selector.setBackground(Theme.getSelectorDrawable(false));
                ...
                if (this.avatars.getVisibility() != 8) {
                    ...
                    this.titleTextView.setTranslationX(-AndroidUtilities.m1036dp(36.0f));
                    this.subtitleTextView.setTranslationX(-AndroidUtilities.m1036dp(36.0f));
                }
                this.closeButton.setVisibility(8);
                this.playButton.setVisibility(8);
            ...
            if (i == 1 || i == 3) {
                ...
                this.titleTextView.setPadding(AndroidUtilities.m1036dp(88.0f), 0, AndroidUtilities.m1036dp(88.0f) + this.joinButtonWidth, 0);
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (i == i4 || i == NotificationCenter.groupCallUpdated || i == NotificationCenter.groupCallVisibilityChanged) {
            ...
            if (callState == 1 || callState == 2 || callState == 6 || callState == 5 || this.muteButton == null || (groupCallParticipant = sharedInstance.groupCall.participants.get(sharedInstance.getSelfId())) == null || groupCallParticipant.can_self_unmute || !groupCallParticipant.muted || ChatObject.canManageCalls(sharedInstance.getChat())) {
                return;
            }
            ...
            if (this.visible && this.currentStyle == 4) {
                ...
                if (groupCall != null && this.subtitleTextView != null) {
                    if (groupCall.isScheduled()) {
                        ...
                        AudioPlayerAlert.ClippingTextViewSwitcher clippingTextViewSwitcher = this.subtitleTextView;
                        if (i5 == 0) {
                            clippingTextViewSwitcher.setText(LocaleController.getString(groupCall2.rtmp_stream ? C2797R.string.ViewersWatchingNobody : C2797R.string.MembersTalkingNobody), false);
                        } else {
                            clippingTextViewSwitcher.setText(LocaleController.formatPluralString(groupCall2.rtmp_stream ? "ViewersWatching" : "Participants", i5, new Object[0]), false);
                        }
                    }
                }
                updateAvatars(true);
    ...
    private void checkLiveLocation(boolean z) {
        ...
        if (this.fragment instanceof DialogsActivity) {
            String string2 = LocaleController.getString(C2797R.string.LiveLocationContext);
            ...
            if (arrayList.size() == 1) {
                ...
                if (zIsUserDialog) {
                    pluralString = UserObject.getFirstName(MessagesController.getInstance(messageObject.currentAccount).getUser(Long.valueOf(dialogId)));
                    string = LocaleController.getString(C2797R.string.AttachLiveLocationIsSharing);
                } else {
                    ...
                    string = LocaleController.getString(C2797R.string.AttachLiveLocationIsSharingChat);
                }
            } else {
                pluralString = LocaleController.formatPluralString("Chats", arrayList.size(), new Object[0]);
                string = LocaleController.getString(C2797R.string.AttachLiveLocationIsSharingChats);
            }
    ...
    public void checkLocationString() {
        ...
        String string = LocaleController.getString(C2797R.string.LiveLocationContext);
        if (i == 0) {
            str = string;
        } else {
            int i3 = i - 1;
            if (LocationController.getInstance(currentAccount).isSharingLocation(dialogId)) {
                if (i3 == 0) {
                    str = String.format("%1$s - %2$s", string, LocaleController.getString(C2797R.string.ChatYourSelfName));
                } else if (i3 == 1 && user != null) {
                    str = String.format("%1$s - %2$s", string, LocaleController.formatString("SharingYouAndOtherName", C2797R.string.SharingYouAndOtherName, UserObject.getFirstName(user)));
                } else {
                    str = String.format("%1$s - %2$s %3$s", string, LocaleController.getString(C2797R.string.ChatYourSelfName), LocaleController.formatPluralString("AndOther", i3, new Object[0]));
                }
            } else if (i3 != 0) {
    ...
    public void checkPlayer(boolean z) {
            ...
            if (this.visible) {
                ...
                this.animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.FragmentContextView.12
                    ...
                    public void onAnimationEnd(Animator animator) {
                        ...
                        FragmentContextView.this.animatorSet = null;
                        boolean z4 = FragmentContextView.this.checkLiveStoryAfterAnimation;
                        FragmentContextView fragmentContextView = FragmentContextView.this;
                        if (z4) {
                            fragmentContextView.checkLiveStory(false);
                        } else {
                            boolean z5 = fragmentContextView.checkCallAfterAnimation;
                            FragmentContextView fragmentContextView2 = FragmentContextView.this;
                            if (z5) {
                                fragmentContextView2.checkCall(false);
                            } else {
                                boolean z6 = fragmentContextView2.checkPlayerAfterAnimation;
        ...
        if (!this.visible) {
            if (!z) {
                ...
                if (!this.isInsideBubble) {
                    ((FrameLayout.LayoutParams) getLayoutParams()).topMargin = -AndroidUtilities.m1036dp(getStyleHeight());
                }
        ...
        if (playingMessageObject.isVoice() || this.lastMessageObject.isRoundVideo()) {
            ...
            this.titleTextView.setPadding(0, 0, AndroidUtilities.m1036dp(44.0f) + this.joinButtonWidth, 0);
    ...
    public void checkImport(boolean z) {
        ...
        if (this.chatActivity != null) {
                ...
                if (this.visible && ((z && this.currentStyle == -1) || this.currentStyle == 5)) {
                    ...
                    this.animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.FragmentContextView.14
                        ...
                        public void onAnimationEnd(Animator animator) {
                            ...
                            FragmentContextView.this.setVisibility(8);
                            FragmentContextView.this.animatorSet = null;
                            boolean z2 = FragmentContextView.this.checkLiveStoryAfterAnimation;
                            FragmentContextView fragmentContextView = FragmentContextView.this;
                            if (z2) {
                                fragmentContextView.checkLiveStory(false);
                            } else {
                                boolean z3 = fragmentContextView.checkCallAfterAnimation;
                                FragmentContextView fragmentContextView2 = FragmentContextView.this;
                                if (z3) {
                                    fragmentContextView2.checkCall(false);
                                } else {
                                    boolean z4 = fragmentContextView2.checkPlayerAfterAnimation;
                                    FragmentContextView fragmentContextView3 = FragmentContextView.this;
                                    if (z4) {
                                        fragmentContextView3.checkPlayer(false);
                                    } else if (fragmentContextView3.checkImportAfterAnimation) {
            ...
            if (i3 != i4) {
                ...
                this.titleTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ImportUploading", C2797R.string.ImportUploading, Integer.valueOf(i4))), false);
            }
        }
    }
                ...
                if (z) {
                    ...
                    this.animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.FragmentContextView.16
                        ...
                        public void onAnimationEnd(Animator animator) {
                            ...
                            FragmentContextView.this.setVisibility(8);
                            FragmentContextView.this.animatorSet = null;
                            boolean z3 = FragmentContextView.this.checkLiveStoryAfterAnimation;
                            FragmentContextView fragmentContextView = FragmentContextView.this;
                            if (z3) {
                                fragmentContextView.checkLiveStory(false);
                            } else {
                                boolean z4 = fragmentContextView.checkCallAfterAnimation;
                                FragmentContextView fragmentContextView2 = FragmentContextView.this;
                                if (z4) {
                                    fragmentContextView2.checkCall(false);
                                } else {
                                    boolean z5 = fragmentContextView2.checkPlayerAfterAnimation;
                                    FragmentContextView fragmentContextView3 = FragmentContextView.this;
                                    if (z5) {
                                        fragmentContextView3.checkPlayer(false);
                                    } else if (fragmentContextView3.checkImportAfterAnimation) {
    ...
    */
    public void checkCall(boolean r17) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.FragmentContextView.checkCall(boolean):void");
    }
    ...
    private void updateAvatars(boolean z) {
        ...
        if (avatarsImageView.avatarsDrawable.transitionProgressAnimator == null) {
            ...
            AudioPlayerAlert.ClippingTextViewSwitcher clippingTextViewSwitcher = this.titleTextView;
            if (z) {
                int i5 = ((FrameLayout.LayoutParams) clippingTextViewSwitcher.getLayoutParams()).leftMargin;
                if (AndroidUtilities.m1036dp(i4) != i5) {
                    float translationX = (this.titleTextView.getTranslationX() + i5) - AndroidUtilities.m1036dp(r4);
                ...
                clippingTextViewSwitcher.animate().cancel();
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (!this.drawOverlay || getVisibility() == 0) {
            ...
            if (i == 3 || i == 1) {
                ...
                float fM1036dp = this.topPadding / AndroidUtilities.m1036dp(getStyleHeight());
                if (this.collapseTransition) {
                    Theme.getFragmentContextViewWavesDrawable().draw(0.0f, (AndroidUtilities.m1036dp(getStyleHeight()) - this.topPadding) + this.extraHeight, getMeasuredWidth(), getMeasuredHeight() - AndroidUtilities.m1036dp(this.isInsideBubble ? 0.0f : 2.0f), canvas, null, Math.min(fM1036dp, 1.0f - this.collapseProgress));
                } else {
                    Theme.getFragmentContextViewWavesDrawable().draw(0.0f, AndroidUtilities.m1036dp(getStyleHeight()) - this.topPadding, getMeasuredWidth(), getMeasuredHeight() - AndroidUtilities.m1036dp(this.isInsideBubble ? 0.0f : 2.0f), canvas, this, fM1036dp);
                }
                if (this.isInsideBubble) {
                    canvas2 = canvas;
                    z = false;
                } else {
                    float fM1036dp2 = AndroidUtilities.m1036dp(getStyleHeight()) - this.topPadding;
                    if (this.collapseTransition) {
                        fM1036dp2 += this.extraHeight;
                    }
                    if (fM1036dp2 > getMeasuredHeight()) {
                        return;
                    }
                    canvas.save();
                    canvas2 = canvas;
                    canvas2.clipRect(0.0f, fM1036dp2, getMeasuredWidth(), getMeasuredHeight());
                    z = true;
                }
                invalidate();
            } else {
            ...
            if (this.currentStyle == 0 && (playingMessageObject = MediaController.getInstance().getPlayingMessageObject()) != null) {
                ...
                float measuredHeight = getMeasuredHeight() - (this.isInsideBubble ? 0 : AndroidUtilities.m1036dp(2.0f));
    ...
    private void updatePaddings() {
        ...
        ((FrameLayout.LayoutParams) getLayoutParams()).topMargin = getVisibility() == 0 ? 0 - AndroidUtilities.m1036dp(getStyleHeight()) : 0;
    }
        ...
        if (sharedInstance != null) {
            ...
            if (i == 1 || i == 3) {
                ...
                if (!sharedInstance.isSwitchingStream() && (callState == 1 || callState == 2 || callState == 6 || callState == 5)) {
                    this.titleTextView.setText(LocaleController.getString(C2797R.string.VoipGroupConnecting), false);
                    return;
                }
                if (sharedInstance.isConference() && (call = sharedInstance.groupCall) != null) {
                    if (call.sortedParticipants.size() <= 1) {
                        this.titleTextView.setText(LocaleController.getString(C2797R.string.ConferenceChat), false);
                        return;
                    }
                ...
                if (sharedInstance.getChat() != null) {
                    ...
                    ChatActivityInterface chatActivityInterface = this.chatActivity;
                    if (chatActivityInterface != null && chatActivityInterface.getCurrentChat() != null && this.chatActivity.getCurrentChat().f1245id == sharedInstance.getChat().f1245id) {
                        TLRPC.Chat currentChat = this.chatActivity.getCurrentChat();
                        if (VoIPService.hasRtmpStream()) {
                            this.titleTextView.setText(LocaleController.getString(C2797R.string.VoipChannelViewVoiceChat), false);
                            return;
                        }
                        boolean zIsChannelOrGiga = ChatObject.isChannelOrGiga(currentChat);
                        AudioPlayerAlert.ClippingTextViewSwitcher clippingTextViewSwitcher = this.titleTextView;
                        if (zIsChannelOrGiga) {
                            clippingTextViewSwitcher.setText(LocaleController.getString(C2797R.string.VoipChannelViewVoiceChat), false);
                            return;
                        } else {
                            clippingTextViewSwitcher.setText(LocaleController.getString(C2797R.string.VoipGroupViewVoiceChat), false);
                            return;
                        }
                    }
                ...
                if (sharedInstance.getUser() != null) {
                    ...
                    if (chatActivityInterface2 != null && chatActivityInterface2.getCurrentUser() != null && this.chatActivity.getCurrentUser().f1407id == user.f1407id) {
                        this.titleTextView.setText(LocaleController.getString(C2797R.string.ReturnToCall));
                    } else {
    ...
    public void toggleScheduledNotify() {
        ...
        this.updateScheduleTimeRunnable.run();
        BulletinFactory bulletinFactoryM1143of = BulletinFactory.m1143of(this.fragment);
        boolean z2 = this.willBeNotified;
        bulletinFactoryM1143of.createSimpleBulletin(z2 ? C2797R.raw.silent_unmute : C2797R.raw.silent_mute, LocaleController.getString(z2 ? C2797R.string.LiveStreamWillNotify : C2797R.string.LiveStreamWillNotNotify)).show();
    }
    ...
    public void onItemChanged(ReplaceAnimator<?> replaceAnimator) {
        ...
        for (ListAnimator.Entry<CallMessageItem> entry : this.callMessagesAnimator) {
            float fLerp = AndroidUtilities.lerp(0.7f, 1.0f, entry.getVisibility());
            entry.item.cell.setAlpha(entry.getVisibility());
            entry.item.cell.setScaleX(fLerp);
            entry.item.cell.setScaleY(fLerp);
        }
    }
