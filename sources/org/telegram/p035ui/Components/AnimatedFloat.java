        ...
        if (this.transition) {
            ...
            if (jElapsedRealtime - this.transitionStart >= this.transitionDelay) {
                ...
                if (timeInterpolator == null) {
                    this.value = AndroidUtilities.lerp(f, this.targetValue, fClamp);
                } else {
                    this.value = AndroidUtilities.lerp(f, this.targetValue, timeInterpolator.getInterpolation(fClamp));
                }
            }
            if (fClamp >= 1.0f) {
                this.transition = false;
