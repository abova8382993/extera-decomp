...
public class WallpaperUpdater {
    ...
    public void showAlert(final boolean z) {
        ...
        if (z) {
            charSequenceArr = new CharSequence[]{LocaleController.getString(C2797R.string.ChooseTakePhoto), LocaleController.getString(C2797R.string.SelectFromGallery), LocaleController.getString(C2797R.string.SelectColor), LocaleController.getString(C2797R.string.Default)};
            iArr = null;
        } else {
            charSequenceArr = new CharSequence[]{LocaleController.getString(C2797R.string.ChooseTakePhoto), LocaleController.getString(C2797R.string.SelectFromGallery)};
            iArr = new int[]{C2797R.drawable.msg_camera, C2797R.drawable.msg_photos};
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.WallpaperUpdater$1 */
    public class C53191 implements PhotoAlbumPickerActivity.PhotoAlbumPickerActivityDelegate {
        public C53191() {
        }
    ...
    */
    public void onActivityResult(int r8, int r9, android.content.Intent r10) throws java.lang.Throwable {
        /*
            Method dump skipped, instruction units count: 213
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.WallpaperUpdater.onActivityResult(int, int, android.content.Intent):void");
    }
}
