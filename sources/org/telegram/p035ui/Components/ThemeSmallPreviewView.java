...
import org.telegram.p035ui.ActionBar.theme.ITheme;
...
public class ThemeSmallPreviewView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ThemeSmallPreviewView(Context context, int i, Theme.ResourcesProvider resourcesProvider, int i2) {
        super(context);
        this.STROKE_RADIUS = AndroidUtilities.m1036dp(8.0f);
        this.INNER_RADIUS = AndroidUtilities.m1036dp(6.0f);
        this.INNER_RECT_SPACE = AndroidUtilities.m1036dp(4.0f);
        this.BUBBLE_HEIGHT = AndroidUtilities.m1036dp(21.0f);
        this.BUBBLE_WIDTH = AndroidUtilities.m1036dp(41.0f);
        ...
        this.outlineBackgroundPaint.setStrokeWidth(AndroidUtilities.m1036dp(2.0f));
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (i3 == 1 || i3 == 4) {
            ...
            int iM1036dp = AndroidUtilities.m1036dp(i3 == 0 ? 77.0f : 83.0f);
            int size2 = View.MeasureSpec.getSize(i2);
            if (size2 == 0) {
                size2 = (int) (iM1036dp * 1.35f);
            }
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(iM1036dp, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, TLObject.FLAG_30));
        }
        this.backupImageView.setPivotY(r4.getMeasuredHeight());
        this.backupImageView.setPivotX(r3.getMeasuredWidth() / 2.0f);
    }
    ...
    public void setItem(final ChatThemeBottomSheet.ChatThemeItem chatThemeItem, long j, boolean z) {
        ...
        if (z2) {
            ...
            if (wallPaper != null) {
                if (z4 && (chatBackgroundDrawable2 = this.chatBackgroundDrawable) != null) {
                ...
                if (z4 && (chatBackgroundDrawable = this.chatBackgroundDrawable) != null) {
        ...
        if (z2 || z3) {
            ...
            EmojiThemes emojiThemes = chatThemeItem.chatTheme;
            if (themeId != 0) {
                TLRPC.WallPaper wallpaper = emojiThemes.getWallpaper(this.lastThemeIndex);
                if (wallpaper != null) {
                ...
                SparseArray<Theme.ThemeAccent> sparseArray = emojiThemes.getThemeInfo(this.lastThemeIndex).themeAccentsMap;
                    ...
                    if (wallPaper2 != null && (document = wallPaper2.document) != null) {
                        ...
                        imageReceiver.setDelegate(new ImageReceiver.ImageReceiverDelegate() { // from class: org.telegram.ui.Components.ThemeSmallPreviewView$$ExternalSyntheticLambda3
                            ...
                            public final void didSetImage(ImageReceiver imageReceiver2, boolean z5, boolean z6, boolean z7) {
                                this.f$0.lambda$setItem$1(chatThemeItem, wallPaper2, imageReceiver2, z5, z6, z7);
                            }
                        });
        ...
        if (emojiThemes2 == null || emojiThemes2.isAnyStub()) {
            setContentDescription(LocaleController.getString(C2797R.string.ChatNoTheme));
        } else {
    ...
    public /* synthetic */ void lambda$setItem$3(final ChatThemeBottomSheet.ChatThemeItem chatThemeItem, final int i) {
        final Bitmap bitmap = SvgHelper.getBitmap(C2797R.raw.default_pattern, AndroidUtilities.m1036dp(120.0f), AndroidUtilities.m1036dp(140.0f), -16777216, AndroidUtilities.density);
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.ThemeSmallPreviewView$1 */
    ...
    private Bitmap prescaleBitmap(Bitmap bitmap) {
        ...
        float fMax = Math.max(AndroidUtilities.m1036dp(120.0f) / bitmap.getWidth(), AndroidUtilities.m1036dp(140.0f) / bitmap.getHeight());
    ...
    private void fillOutBubblePaint(Paint paint, List<Integer> list) {
        if (list.size() > 1) {
            ...
            float fM1036dp = this.INNER_RECT_SPACE + AndroidUtilities.m1036dp(8.0f);
            paint.setShader(new LinearGradient(0.0f, fM1036dp, 0.0f, fM1036dp + this.BUBBLE_HEIGHT, iArr, (float[]) null, Shader.TileMode.CLAMP));
            return;
        }
        ...
        if (themeItem.themeInfo.getAccent(false) != null) {
            ...
            if (i != 0) {
                ...
                if (themeInfo != null && (themeInfo.previewWallpaperOffset > 0 || themeInfo.pathToWallpaper != null)) {
                    float fM1036dp = AndroidUtilities.m1036dp(112.0f);
                    float fM1036dp2 = AndroidUtilities.m1036dp(134.0f);
                    Theme.ThemeInfo themeInfo2 = themeItem.themeInfo;
                    Bitmap scaledBitmap = AndroidUtilities.getScaledBitmap(fM1036dp, fM1036dp2, themeInfo2.pathToWallpaper, themeInfo2.pathToFile, themeInfo2.previewWallpaperOffset);
    ...
    public StaticLayout getNoThemeStaticLayout() {
        ...
        textPaint.setColor(getThemedColor(Theme.key_chat_emojiPanelTrendingDescription));
        this.noThemeTextPaint.setTextSize(AndroidUtilities.m1036dp(noThemeStringTextSize()));
        this.noThemeTextPaint.setTypeface(AndroidUtilities.bold());
        int iM1036dp = AndroidUtilities.m1036dp(52.0f);
        int i = this.currentType;
        if (i == 3 || i == 4) {
            iM1036dp = AndroidUtilities.m1036dp(77.0f);
        }
        int i2 = iM1036dp;
    ...
    public String noThemeString() {
        return LocaleController.getString(C2797R.string.ChatNoTheme);
    }
    ...
    public class ThemeDrawable {
        ...
        public void drawBackground(Canvas canvas, float f) {
            ...
            if (this.previewDrawable != null) {
                ...
                if (drawable instanceof BitmapDrawable) {
                    ...
                    float width = ThemeSmallPreviewView.this.getWidth() / ThemeSmallPreviewView.this.getHeight();
                    ThemeSmallPreviewView themeSmallPreviewView = ThemeSmallPreviewView.this;
                    if (f2 > width) {
                        int width2 = (int) ((themeSmallPreviewView.getWidth() * intrinsicHeight) / intrinsicWidth);
                        int width3 = (width2 - ThemeSmallPreviewView.this.getWidth()) / 2;
                        this.previewDrawable.setBounds(width3, 0, width2 + width3, ThemeSmallPreviewView.this.getHeight());
                    } else {
                ...
                if ((drawable2 instanceof ColorDrawable) || ((drawable2 instanceof MotionBackgroundDrawable) && ((MotionBackgroundDrawable) drawable2).isOneColor())) {
                    ...
                    float f3 = ThemeSmallPreviewView.this.INNER_RECT_SPACE;
        ...
        public void draw(Canvas canvas, float f) {
            ...
            if (themeSmallPreviewView.isSelected || themeSmallPreviewView.strokeAlphaAnimator != null) {
                ...
                float strokeWidth = (this.strokePaint.getStrokeWidth() * 0.5f) + (AndroidUtilities.m1036dp(4.0f) * (1.0f - ThemeSmallPreviewView.this.selectionProgress));
            ...
            if (emojiThemes == null || (emojiThemes.isAnyStub() && ThemeSmallPreviewView.this.chatThemeItem.chatTheme.wallpaper == null)) {
                ...
                if (themeSmallPreviewView2.fallbackWallpaper == null) {
                    ...
                    canvas.translate((ThemeSmallPreviewView.this.getWidth() - noThemeStaticLayout.getWidth()) * 0.5f, AndroidUtilities.m1036dp(18.0f));
            ...
            if (ThemeSmallPreviewView.this.currentType != 4) {
                int i2 = ThemeSmallPreviewView.this.currentType;
                ThemeSmallPreviewView themeSmallPreviewView3 = ThemeSmallPreviewView.this;
                if (i2 == 2) {
                    if (themeSmallPreviewView3.chatThemeItem.icon != null) {
                        canvas.drawBitmap(ThemeSmallPreviewView.this.chatThemeItem.icon, (themeSmallPreviewView3.getWidth() - ThemeSmallPreviewView.this.chatThemeItem.icon.getWidth()) * 0.5f, AndroidUtilities.m1036dp(21.0f), (Paint) null);
                        return;
                    }
                    return;
                }
                float fM1036dp = themeSmallPreviewView3.INNER_RECT_SPACE + AndroidUtilities.m1036dp(8.0f);
                float fM1036dp2 = ThemeSmallPreviewView.this.INNER_RECT_SPACE + AndroidUtilities.m1036dp(ThemeSmallPreviewView.this.currentType == 3 ? 5.0f : 22.0f);
                if (ThemeSmallPreviewView.this.currentType == 0 || ThemeSmallPreviewView.this.currentType == 3) {
                    ThemeSmallPreviewView.this.rectF.set(fM1036dp2, fM1036dp, (ThemeSmallPreviewView.this.BUBBLE_WIDTH * (ThemeSmallPreviewView.this.currentType == 3 ? 1.2f : 1.0f)) + fM1036dp2, ThemeSmallPreviewView.this.BUBBLE_HEIGHT + fM1036dp);
                } else {
                    fM1036dp = ThemeSmallPreviewView.this.getMeasuredHeight() * 0.12f;
                    ThemeSmallPreviewView.this.rectF.set(ThemeSmallPreviewView.this.getMeasuredWidth() - (ThemeSmallPreviewView.this.getMeasuredWidth() * 0.65f), fM1036dp, ThemeSmallPreviewView.this.getMeasuredWidth() - (ThemeSmallPreviewView.this.getMeasuredWidth() * 0.1f), ThemeSmallPreviewView.this.getMeasuredHeight() * 0.32f);
                }
                ...
                if (ThemeSmallPreviewView.this.currentType == 0 || ThemeSmallPreviewView.this.currentType == 3) {
                    ...
                    f2 = 8.0f;
                    themeSmallPreviewView4.messageDrawableOut.setBounds((int) themeSmallPreviewView4.rectF.left, ((int) ThemeSmallPreviewView.this.rectF.top) - AndroidUtilities.m1036dp(2.0f), ((int) ThemeSmallPreviewView.this.rectF.right) + AndroidUtilities.m1036dp(4.0f), ((int) ThemeSmallPreviewView.this.rectF.bottom) + AndroidUtilities.m1036dp(2.0f));
                ...
                if (ThemeSmallPreviewView.this.currentType == 0 || ThemeSmallPreviewView.this.currentType == 3) {
                    float fM1036dp3 = ThemeSmallPreviewView.this.INNER_RECT_SPACE + AndroidUtilities.m1036dp(5.0f);
                    float fM1036dp4 = fM1036dp + ThemeSmallPreviewView.this.BUBBLE_HEIGHT + AndroidUtilities.m1036dp(4.0f);
                    ThemeSmallPreviewView.this.rectF.set(fM1036dp3, fM1036dp4, (ThemeSmallPreviewView.this.BUBBLE_WIDTH * (ThemeSmallPreviewView.this.currentType == 3 ? 0.8f : 1.0f)) + fM1036dp3, ThemeSmallPreviewView.this.BUBBLE_HEIGHT + fM1036dp4);
                } else {
                ...
                if (ThemeSmallPreviewView.this.currentType == 0 || ThemeSmallPreviewView.this.currentType == 3) {
                    ...
                    if (ThemeSmallPreviewView.this.themeUserByUserId != 0) {
                        ...
                        ThemeSmallPreviewView.this.rectF.set(fHeight - AndroidUtilities.m1036dp(f2), fCenterY - AndroidUtilities.m1036dp(f2), fHeight + AndroidUtilities.m1036dp(f2), AndroidUtilities.m1036dp(f2) + fCenterY);
                        ...
                        if (this.rotateDrawable == null) {
                            this.rotateDrawable = ThemeSmallPreviewView.this.getContext().getDrawable(C2797R.drawable.mini_replace_16).mutate();
                        }
                        int i3 = (int) fHeight2;
                        int i4 = (int) fCenterY;
                        this.rotateDrawable.setBounds(i3 - AndroidUtilities.m1036dp(f2), i4 - AndroidUtilities.m1036dp(f2), i3 + AndroidUtilities.m1036dp(f2), i4 + AndroidUtilities.m1036dp(f2));
                ...
                themeSmallPreviewView6.messageDrawableIn.setBounds(((int) themeSmallPreviewView6.rectF.left) - AndroidUtilities.m1036dp(4.0f), ((int) ThemeSmallPreviewView.this.rectF.top) - AndroidUtilities.m1036dp(2.0f), (int) ThemeSmallPreviewView.this.rectF.right, ((int) ThemeSmallPreviewView.this.rectF.bottom) + AndroidUtilities.m1036dp(2.0f));
