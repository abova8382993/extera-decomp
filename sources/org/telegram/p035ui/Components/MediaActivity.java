...
import org.telegram.p035ui.Components.BottomPagerTabs;
...
import org.telegram.p035ui.Components.Paint.ShapeDetector;
...
public class MediaActivity extends BaseFragment implements SharedMediaLayout.SharedMediaPreloaderDelegate, FloatingDebugProvider, NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public android.view.View createView(android.content.Context r34) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.MediaActivity.createView(android.content.Context):android.view.View");
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.MediaActivity$1 */
    public class C45061 extends ActionBar.ActionBarMenuOnItemClick {
        public C45061() {
        }
        ...
        public void onItemClick(int i) {
            ...
            if (MediaActivity.this.actionModeMessageObjects != null) {
                ...
                builder.setTitle(LocaleController.getString(arrayList.size() > 1 ? C2797R.string.DeleteStoriesTitle : C2797R.string.DeleteStoryTitle));
                builder.setMessage(LocaleController.formatPluralString("DeleteStoriesSubtitle", arrayList.size(), new Object[0]));
                builder.setPositiveButton(LocaleController.getString(C2797R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.MediaActivity$1$$ExternalSyntheticLambda0
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                    public final void onClick(AlertDialog alertDialog, int i3) {
                        this.f$0.lambda$onItemClick$0(arrayList, alertDialog, i3);
                    }
                });
                builder.setNegativeButton(LocaleController.getString(C2797R.string.Cancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.MediaActivity$1$$ExternalSyntheticLambda1
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                    public final void onClick(AlertDialog alertDialog, int i3) {
                        alertDialog.dismiss();
                    }
    ...
    public class C45072 extends SizeNotifierFrameLayout {
        final /* synthetic */ FrameLayout val$avatarContainer;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C45072(Context context, FrameLayout frameLayout) {
            super(context);
        ...
        public void onMeasure(int i, int i2) {
            ...
            while (true) {
                ...
                if (i3 < 2) {
                    if (mediaActivity.nameTextView[i3] != null) {
                        ((FrameLayout.LayoutParams) MediaActivity.this.nameTextView[i3].getLayoutParams()).topMargin = (((ActionBar.getCurrentActionBarHeight() / 2) - AndroidUtilities.m1036dp(22.0f)) / 2) + AndroidUtilities.m1036dp((AndroidUtilities.isTablet() || getResources().getConfiguration().orientation != 2) ? 5.0f : 4.0f);
                    }
                    if (MediaActivity.this.subtitleTextView[i3] != null) {
                        ((FrameLayout.LayoutParams) MediaActivity.this.subtitleTextView[i3].getLayoutParams()).topMargin = ((ActionBar.getCurrentActionBarHeight() / 2) + (((ActionBar.getCurrentActionBarHeight() / 2) - AndroidUtilities.m1036dp(19.0f)) / 2)) - AndroidUtilities.m1036dp(7.0f);
                    }
                    i3++;
                } else {
                    ((FrameLayout.LayoutParams) mediaActivity.avatarImageView.getLayoutParams()).topMargin = (ActionBar.getCurrentActionBarHeight() - AndroidUtilities.m1036dp(42.0f)) / 2;
    ...
    public class C45083 extends ProfileActivity.AvatarImageView {
        public C45083(Context context) {
            super(context);
        }
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            if (getImageReceiver().hasNotThumb()) {
                ...
                accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(32, LocaleController.getString(C2797R.string.AccDescrOpenInPhotoViewer)));
                return;
            }
    ...
    public /* synthetic */ void lambda$createView$10(View view) {
        ...
        (z ? BulletinFactory.m1143of(this).createSimpleBulletin(C2797R.raw.contact_check, LocaleController.formatPluralString("StorySavedTitle", i, new Object[0]), LocaleController.getString("StorySavedSubtitle"), LocaleController.getString("Undo"), runnable2).show() : BulletinFactory.m1143of(this).createSimpleBulletin(C2797R.raw.chats_archived, LocaleController.formatPluralString("StoryArchived", i, new Object[0]), LocaleController.getString("Undo"), 5000, runnable2).show()).setOnHideListener(new Runnable() { // from class: org.telegram.ui.Components.MediaActivity$$ExternalSyntheticLambda12
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public class C45094 implements Bulletin.Delegate {
        public C45094() {
        }
    ...
    public class C45105 implements SharedMediaLayout.Delegate {
    ...
    public class C45116 extends SharedMediaLayout {
        ...
        public void showActionMode(boolean z) {
            ...
            this.actionModeAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.MediaActivity.6.1
                ...
                public void onAnimationCancel(Animator animator) {
                    C45116.this.actionModeAnimation = null;
                }

                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
                    if (C45116.this.actionModeAnimation == null) {
                        return;
                    }
                    C45116.this.actionModeAnimation = null;
                    boolean z3 = z;
                    C45116 c45116 = C45116.this;
                    if (!z3) {
        ...
        public void onTabProgress(float f) {
            ...
            MediaActivity.this.titles[0].setTranslationX(AndroidUtilities.m1036dp(-12.0f) * f2);
            MediaActivity.this.titles[1].setAlpha(f2);
            MediaActivity.this.titles[1].setTranslationX(AndroidUtilities.m1036dp(12.0f) * f3);
        }
                ...
                if (closestTab == 8 || closestTab == 9) {
                    ...
                    if (buttonWithCounterView != null) {
                        ...
                        if (closestTab == 8) {
                            ...
                            buttonWithCounterView.setText(LocaleController.getString(C2797R.string.SaveToProfile), z4);
                        }
        ...
        if (zArr[i] != z || this.firstSubtitleCheck[i]) {
            ...
            if (z3) {
                ...
                this.subtitleAnimator[i].addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.MediaActivity.7
                    ...
                    public C45127(final int i3, boolean z4) {
                        i = i3;
                        z = z4;
                    }
                    ...
                    public void onAnimationEnd(Animator animator) {
                        ...
                        MediaActivity.this.nameTextView[i].setTranslationY(z ? 0.0f : AndroidUtilities.m1036dp(8.0f));
            ...
            this.nameTextView[i3].setTranslationY(z4 ? 0.0f : AndroidUtilities.m1036dp(8.0f));
    ...
    public /* synthetic */ void lambda$showSubtitle$12(int i, ValueAnimator valueAnimator) {
        ...
        this.nameTextView[i].setTranslationY(AndroidUtilities.lerp(AndroidUtilities.m1036dp(8.0f), 0, this.subtitleT[i]));
        this.subtitleTextView[i].setAlpha(this.subtitleT[i]);
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.MediaActivity$7 */
    public class C45127 extends AnimatorListenerAdapter {
        final /* synthetic */ int val$i;
        final /* synthetic */ boolean val$show;
    ...
    public class StoriesTabsView extends BottomPagerTabs {
        ...
        @Override // org.telegram.p035ui.Components.BottomPagerTabs
        public BottomPagerTabs.Tab[] createTabs() {
            return new BottomPagerTabs.Tab[]{new BottomPagerTabs.Tab(0, C2797R.raw.msg_stories_saved, 20, 40, LocaleController.getString(C2797R.string.ProfileMyStoriesTab)), new BottomPagerTabs.Tab(1, C2797R.raw.msg_stories_archive, 0, 0, LocaleController.getString(C2797R.string.ProfileStoriesArchiveTab))};
        }
    }
