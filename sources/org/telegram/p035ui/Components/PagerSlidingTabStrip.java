...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public PagerSlidingTabStrip(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.scrollOffset = AndroidUtilities.m1036dp(52.0f);
        this.indicatorHeight = AndroidUtilities.m1036dp(8.0f);
    ...
    public void setViewPager(ViewPager viewPager) {
        ...
        if (viewPager.getAdapter() == null) {
            Segment$$ExternalSyntheticBUOutline1.m992m("ViewPager does not have adapter instance.");
        } else {
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < this.tabCount; i++) {
            boolean z = this.pager.getAdapter() instanceof IconTabProvider;
            ViewPager viewPager = this.pager;
            if (z) {
                Drawable pageIconDrawable = ((IconTabProvider) viewPager.getAdapter()).getPageIconDrawable(i);
                ViewPager viewPager2 = this.pager;
                if (pageIconDrawable != null) {
                    addIconTab(i, pageIconDrawable, viewPager2.getAdapter().getPageTitle(i));
                } else {
                    addTab(i, viewPager2.getAdapter().getPageTitle(i));
                }
            } else {
                addTab(i, viewPager.getAdapter().getPageTitle(i));
            }
        }
        updateTabStyles();
    ...
    private void addIconTab(final int i, Drawable drawable, CharSequence charSequence) {
        ...
        RippleDrawable rippleDrawable = (RippleDrawable) Theme.createSelectorDrawable(getGlassIconColor(0.05f), 1, AndroidUtilities.m1036dp(18.0f));
    ...
    private void addTab(final int i, CharSequence charSequence) {
        ...
        textTab.setPadding(AndroidUtilities.m1036dp(16.0f), 0, AndroidUtilities.m1036dp(16.0f), 0);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (childAt != null) {
            ...
            if (this.indicatorHeight != 0) {
                this.rectPaint.setColor(getGlassIconColor(0.065f));
                RectF rectF2 = AndroidUtilities.rectTmp;
                rectF2.set(f - AndroidUtilities.m1036dp(11.0f), getPaddingTop(), f2 + AndroidUtilities.m1036dp(11.0f), height - getPaddingBottom());
