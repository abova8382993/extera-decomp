...
public class PhotoFilterCurvesControl extends View {
    ...
    public PhotoFilterCurvesControl(Context context, PhotoFilterView.CurvesToolValue curvesToolValue) {
        ...
        this.paint.setStrokeWidth(AndroidUtilities.m1036dp(1.0f));
        Paint paint = this.paint;
        Paint.Style style = Paint.Style.STROKE;
        paint.setStyle(style);
        this.paintDash.setColor(-1711276033);
        this.paintDash.setStrokeWidth(AndroidUtilities.m1036dp(2.0f));
        this.paintDash.setStyle(style);
        this.paintCurve.setColor(-1);
        this.paintCurve.setStrokeWidth(AndroidUtilities.m1036dp(2.0f));
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r8) {
        ...
        L2b:
            ...
            r7.lastX = r0
            r7.lastY = r2
            org.telegram.ui.Components.RectOld r4 = r7.actualArea
            float r5 = r4.f1660x
        ...
        L78:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.PhotoFilterCurvesControl.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    private void selectSegmentWithPoint(float f) {
        ...
        RectOld rectOld = this.actualArea;
        this.activeSegment = (int) Math.floor(((f - rectOld.f1660x) / (rectOld.width / 5.0f)) + 1.0f);
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            float f2 = rectOld.f1660x;
            float f3 = i * f;
            float f4 = rectOld.f1661y;
            canvas.drawLine(f2 + f + f3, f4, f3 + f2 + f, f4 + rectOld.height, this.paint);
            i++;
        }
        float f5 = rectOld.f1660x;
        float f6 = rectOld.f1661y;
        canvas.drawLine(f5, rectOld.height + f6, f5 + rectOld.width, f6, this.paintDash);
        ...
        while (i3 < 5) {
            ...
            canvas.drawText(str, rectOld2.f1660x + ((f - fMeasureText) / 2.0f) + (i3 * f), (rectOld2.f1661y + rectOld2.height) - AndroidUtilities.m1036dp(4.0f), this.textPaint);
            i3++;
        }
        ...
        for (int i4 = 0; i4 < fArrInterpolateCurve.length / 2; i4++) {
            ...
            if (i4 == 0) {
                ...
                int i5 = i4 * 2;
                path.moveTo(rectOld3.f1660x + (fArrInterpolateCurve[i5] * rectOld3.width), rectOld3.f1661y + ((1.0f - fArrInterpolateCurve[i5 + 1]) * rectOld3.height));
            } else {
                RectOld rectOld4 = this.actualArea;
                int i6 = i4 * 2;
                path.lineTo(rectOld4.f1660x + (fArrInterpolateCurve[i6] * rectOld4.width), rectOld4.f1661y + ((1.0f - fArrInterpolateCurve[i6 + 1]) * rectOld4.height));
            }
        }
