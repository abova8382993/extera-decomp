...
public class PopupAudioView extends BaseCell implements SeekBar.SeekBarDelegate, DownloadController.FileDownloadProgressListener {
    ...
    public void onMeasure(int i, int i2) {
        setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m1036dp(56.0f));
    }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        this.seekBarX = AndroidUtilities.m1036dp(54.0f);
        this.buttonX = AndroidUtilities.m1036dp(10.0f);
        this.timeX = (getMeasuredWidth() - this.timeWidth) - AndroidUtilities.m1036dp(16.0f);
        this.seekBar.setSize((getMeasuredWidth() - AndroidUtilities.m1036dp(70.0f)) - this.timeWidth, AndroidUtilities.m1036dp(30.0f));
        this.progressView.width = (getMeasuredWidth() - AndroidUtilities.m1036dp(94.0f)) - this.timeWidth;
        this.progressView.height = AndroidUtilities.m1036dp(30.0f);
        this.seekBarY = AndroidUtilities.m1036dp(13.0f);
        this.buttonY = AndroidUtilities.m1036dp(10.0f);
        updateProgress();
        if (z || !this.wasLayout) {
            this.wasLayout = true;
        }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (i4 == 0 || i4 == 1) {
            ...
            canvas.translate(this.seekBarX + AndroidUtilities.m1036dp(12.0f), this.seekBarY);
        ...
        BaseCell.setDrawableBounds(drawable, ((iM1036dp - drawable.getIntrinsicWidth()) / 2) + this.buttonX, ((iM1036dp - drawable.getIntrinsicHeight()) / 2) + this.buttonY);
        drawable.draw(canvas);
        canvas.save();
        canvas.translate(this.timeX, AndroidUtilities.m1036dp(18.0f));
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r8) {
        ...
        Lb4:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.PopupAudioView.onTouchEvent(android.view.MotionEvent):boolean");
    }
