...
public abstract class ChatGreetingsView extends LinearLayout {
    ...
    public ChatGreetingsView(Context context, TLRPC.User user, int i, TLRPC.Document document, Theme.ResourcesProvider resourcesProvider) {
        ...
        setPadding(0, AndroidUtilities.m1036dp(8.0f), 0, 0);
        ...
        updateLayout();
        updateColors();
        setText(LocaleController.getString(C2797R.string.NoMessages), LocaleController.getString(C2797R.string.NoMessagesGreetingsDescription));
    ...
    public void setPremiumLock(boolean z, boolean z2, CharSequence charSequence, CharSequence charSequence2, View.OnClickListener onClickListener) {
        ...
        if (z) {
            if (this.premiumIconView == null) {
                ...
                this.premiumIconView.setBackground(Theme.createCircleDrawable(AndroidUtilities.m1036dp(78.0f), 469762048));
                RLottieImageView rLottieImageView2 = this.premiumIconView;
                if (z2) {
                    rLottieImageView2.setImageResource(C2797R.drawable.filled_chatlist2);
                } else {
                    rLottieImageView2.setAnimation(C2797R.raw.large_message_lock, 80, 80);
            ...
            this.premiumTextView.setLineSpacing(AndroidUtilities.m1036dp(2.0f), 1.0f);
            if (this.premiumButtonView == null) {
                ...
                this.premiumButtonView.setPadding(AndroidUtilities.m1036dp(13.0f), AndroidUtilities.m1036dp(5.0f), AndroidUtilities.m1036dp(13.0f), AndroidUtilities.m1036dp(8.0f));
                this.premiumButtonView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1036dp(15.0f), 503316480, AndroidUtilities.DARK_STATUS_BAR_OVERLAY));
    ...
    private void updateLayout() {
        removeAllViews();
        setPadding(0, (this.showGreetings || this.preview) ? AndroidUtilities.m1036dp(8.0f) : 0, 0, 0);
        if (this.premiumLock) {
    ...
    public void setNextSticker(TLRPC.Document document, Runnable runnable) {
        ...
        this.nextStickerToSendView.getImageReceiver().setDelegate(new C41682(runnable));
        SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(document, Theme.key_chat_serviceBackground, 1.0f);
        if (svgThumb != null) {
            document2 = document;
    ...
    public class C41682 implements ImageReceiver.ImageReceiverDelegate {
        ...
        public C41682(Runnable runnable) {
    ...
    public void toggleToNextSticker() {
        ...
        animatorSet3.playTogether(objectAnimatorOfFloat, objectAnimatorOfFloat2, ObjectAnimator.ofFloat(this.nextStickerToSendView, (Property<BackupImageView, Float>) property3, 0.7f, 1.0f), ObjectAnimator.ofFloat(this.nextStickerToSendView, (Property<BackupImageView, Float>) property4, -AndroidUtilities.m1036dp(24.0f), 0.0f), ObjectAnimator.ofFloat(this.stickerToSendView, (Property<BackupImageView, Float>) property, 1.0f, 0.0f), ObjectAnimator.ofFloat(this.stickerToSendView, (Property<BackupImageView, Float>) property2, 1.0f, 0.7f), ObjectAnimator.ofFloat(this.stickerToSendView, (Property<BackupImageView, Float>) property3, 1.0f, 0.7f), ObjectAnimator.ofFloat(this.stickerToSendView, (Property<BackupImageView, Float>) property4, 0.0f, AndroidUtilities.m1036dp(24.0f)));
    ...
    public static String createFilter(TLRPC.Document document) {
        ...
        if (MessageObject.isAnimatedStickerDocument(document, true) && iM1036dp == 0 && i == 0) {
            iM1036dp = 512;
            i = 512;
        }
        if (iM1036dp == 0) {
            i = (int) f2;
            iM1036dp = i + AndroidUtilities.m1036dp(100.0f);
        }
        int i3 = (int) (i * (f2 / iM1036dp));
        int i4 = (int) f2;
        float f3 = i3;
        if (f3 > f2) {
            i4 = (int) (i4 * (f2 / f3));
    ...
    public void setPreview(CharSequence charSequence, CharSequence charSequence2) {
        ...
        if (TextUtils.isEmpty(charSequence == null ? null : charSequence.toString().trim())) {
            charSequence = LocaleController.getString(C2797R.string.NoMessages);
        }
        textView.setText(charSequence);
        TextView textView2 = this.descriptionView;
        if (TextUtils.isEmpty(charSequence2 != null ? charSequence2.toString().trim() : null)) {
            charSequence2 = LocaleController.getString(C2797R.string.NoMessagesGreetingsDescription);
        }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.disableBackground) {
            ...
            canvas2 = canvas;
            canvas2.drawRoundRect(0.0f, 0.0f, getWidth(), getHeight(), AndroidUtilities.m1036dp(16.0f), AndroidUtilities.m1036dp(16.0f), Theme.getThemePaint("paintChatActionBackground", this.resourcesProvider));
        }
        if (!this.wasDraw) {
            this.wasDraw = true;
            if (!this.stickerExplicitlyHidden) {
    ...
    public static void showPremiumSheet(Context context, int i, long j, Theme.ResourcesProvider resourcesProvider) {
        ...
        rLottieImageView.setScaleType(ImageView.ScaleType.CENTER);
        rLottieImageView.setAnimation(C2797R.raw.large_message_lock, 80, 80);
        ...
        textView.setText(LocaleController.getString(zPremiumFeaturesBlocked ? C2797R.string.PremiumMessageHeaderLocked : C2797R.string.PremiumMessageHeader));
        ...
        textView2.setText(AndroidUtilities.replaceTags(LocaleController.formatString(zPremiumFeaturesBlocked ? C2797R.string.PremiumMessageTextLocked : C2797R.string.PremiumMessageText, firstName, firstName)));
        ...
        if (!zPremiumFeaturesBlocked) {
            ...
            premiumButtonView.setOverlayText(LocaleController.getString(C2797R.string.PremiumMessageButton), false, false);
