...
public class ReorderingHintDrawable extends Drawable {
    ...
    private final int intrinsicWidth = AndroidUtilities.m1036dp(24.0f);
    private final int intrinsicHeight = AndroidUtilities.m1036dp(24.0f);
    ...
    private void drawStage1(Canvas canvas, float f) {
        ...
        this.tempRect.left = (int) (AndroidUtilities.m1036dp(2.0f) * this.scaleX);
        this.tempRect.bottom = bounds.bottom - ((int) (AndroidUtilities.m1036dp(6.0f) * this.scaleY));
        Rect rect = this.tempRect;
        rect.right = bounds.right - rect.left;
        rect.top = rect.bottom - ((int) (AndroidUtilities.m1036dp(4.0f) * this.scaleY));
        ...
        rect2.right = iM1036dp;
        rect2.left = iM1036dp;
        Rect rect3 = this.tempRect;
        int iM1036dp2 = AndroidUtilities.m1036dp(8.0f);
        rect3.bottom = iM1036dp2;
        rect3.top = iM1036dp2;
        this.tempRect.inset(-AndroidUtilities.m1036dp(AndroidUtilities.lerp(10, 11, interpolation)), -AndroidUtilities.m1036dp(AndroidUtilities.lerp(2, 3, interpolation)));
    ...
    private void drawStage2(Canvas canvas, float f) {
        ...
        rect.right = bounds.right - rect.left;
        rect.top = rect.bottom - ((int) (AndroidUtilities.m1036dp(4.0f) * this.scaleY));
        this.tempRect.offset(0, AndroidUtilities.m1036dp(AndroidUtilities.lerp(0, -8, interpolation)));
        this.secondaryRectDrawable.setBounds(this.tempRect);
        this.secondaryRectDrawable.draw(canvas);
    ...
    private void drawStage3(Canvas canvas, float f) {
        ...
        rect.right = bounds.right - rect.left;
        rect.top = rect.bottom - ((int) (AndroidUtilities.m1036dp(4.0f) * this.scaleY));
        this.tempRect.offset(0, AndroidUtilities.m1036dp(-8.0f));
        this.secondaryRectDrawable.setBounds(this.tempRect);
        this.secondaryRectDrawable.draw(canvas);
