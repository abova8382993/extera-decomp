...
public class GroupCallPipAlertView extends LinearLayout implements VoIPService.StateListener, NotificationCenter.NotificationCenterDelegate {
    ...
    public GroupCallPipAlertView(final Context context, int i) {
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.Components.GroupCallPipAlertView.1
            ...
            public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
                ...
                if (sharedInstance != null && ChatObject.isChannelOrGiga(sharedInstance.getChat())) {
                    accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, LocaleController.getString(C2797R.string.VoipChannelOpenVoiceChat)));
                } else {
                    accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, LocaleController.getString(C2797R.string.VoipGroupOpenVoiceChat)));
                }
            }
        };
        ...
        this.groupInfoContainer.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1036dp(6.0f), 0, ColorUtils.setAlphaComponent(-1, 76)));
        ...
        this.leaveButton.setData(C2797R.drawable.calls_decline, -1, -3257782, 0.3f, false, LocaleController.getString(C2797R.string.VoipGroupLeave), false, false);
    ...
    */
    public void onDraw(android.graphics.Canvas r22) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.GroupCallPipAlertView.onDraw(android.graphics.Canvas):void");
    }

    @Override // android.widget.LinearLayout, android.view.View
    public void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(230.0f), TLObject.FLAG_30), i2);
    }
    ...
    public void onAttachedToWindow() {
        ...
        if (sharedInstance != null && sharedInstance.groupCall != null) {
            ...
            avatarDrawable.setColor(Theme.getColor(Theme.keys_avatar_background[AvatarDrawable.getColorIndex(chat != null ? chat.f1245id : 0L)]), Theme.getColor(Theme.keys_avatar_background2[AvatarDrawable.getColorIndex(chat != null ? chat.f1245id : 0L)]));
            ...
            if (sharedInstance.isConference() && (call = sharedInstance.groupCall) != null) {
                if (call.sortedParticipants.size() == 1) {
                    strTrim = LocaleController.getString(C2797R.string.ConferenceChat);
                } else {
    ...
    private void updateMembersCount() {
        ...
        if (!sharedInstance.isSwitchingStream() && (callState == 1 || callState == 2 || callState == 6 || callState == 5)) {
            this.subtitleView.setText(LocaleController.getString(C2797R.string.VoipGroupConnecting));
            return;
        }
    ...
    private void updateButtons(boolean z) {
        ...
        if (zIsBluetoothOn) {
            ...
            if (zIsHeadsetPlugged) {
                voIPToggleButton.setData(C2797R.drawable.calls_headphones, -1, 0, 0.1f, true, LocaleController.getString(C2797R.string.VoipAudioRoutingHeadset), false, z);
            } else {
                voIPToggleButton.setData(C2797R.drawable.calls_speaker, -1, 0, 0.1f, true, LocaleController.getString(C2797R.string.VoipSpeaker), false, z);
            }
        }
        boolean zMutedByAdmin = sharedInstance.mutedByAdmin();
        VoIPToggleButton voIPToggleButton2 = this.muteButton;
        if (zMutedByAdmin) {
            voIPToggleButton2.setData(C2797R.drawable.calls_unmute, -1, ColorUtils.setAlphaComponent(-1, 76), 0.1f, true, LocaleController.getString(C2797R.string.VoipMutedByAdminShort), true, z);
        } else {
            voIPToggleButton2.setData(C2797R.drawable.calls_unmute, -1, ColorUtils.setAlphaComponent(-1, (int) ((sharedInstance.isMicMute() ? 0.3f : 0.15f) * 255.0f)), 0.1f, true, LocaleController.getString(sharedInstance.isMicMute() ? C2797R.string.VoipUnmute : C2797R.string.VoipMute), sharedInstance.isMicMute(), z);
        }
        invalidate();
    }
