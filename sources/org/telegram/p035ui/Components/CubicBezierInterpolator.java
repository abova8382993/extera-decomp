...
public class CubicBezierInterpolator implements Interpolator {
    ...
    protected PointF f1554a;

    /* JADX INFO: renamed from: b */
    protected PointF f1555b;

    /* JADX INFO: renamed from: c */
    protected PointF f1556c;
    ...
    public CubicBezierInterpolator(PointF pointF, PointF pointF2) {
        this.f1554a = new PointF();
        this.f1555b = new PointF();
        this.f1556c = new PointF();
        float f = pointF.x;
        if (f < 0.0f || f > 1.0f) {
            g$$ExternalSyntheticBUOutline1.m207m("startX value must be in the range [0, 1]");
            throw null;
        }
        float f2 = pointF2.x;
        if (f2 < 0.0f || f2 > 1.0f) {
            g$$ExternalSyntheticBUOutline1.m207m("endX value must be in the range [0, 1]");
            throw null;
        }
        this.start = pointF;
        this.end = pointF2;
    ...
    public float getBezierCoordinateY(float f) {
        PointF pointF = this.f1556c;
        PointF pointF2 = this.start;
        float f2 = pointF2.y * 3.0f;
        pointF.y = f2;
        PointF pointF3 = this.f1555b;
        float f3 = ((this.end.y - pointF2.y) * 3.0f) - f2;
        pointF3.y = f3;
        PointF pointF4 = this.f1554a;
    ...
    private float getXDerivate(float f) {
        return this.f1556c.x + (f * ((this.f1555b.x * 2.0f) + (this.f1554a.x * 3.0f * f)));
    }
