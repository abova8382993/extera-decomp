...
public class SummaryIcon extends Drawable {
    ...
    public SummaryIcon(View view) {
        ...
        this.arrow = view.getContext().getResources().getDrawable(C2797R.drawable.summary_arrow);
        this.stars = view.getContext().getResources().getDrawable(C2797R.drawable.summary_stars);
    }
    ...
    public void draw(Canvas canvas) {
        ...
        float f = this.progress.set(this.f1695on);
