...
public class FilterGLThread extends DispatchQueue {
    ...
    private boolean setupVideoShader(StoryEntry.HDRInfo hDRInfo) {
        ...
        int i2 = iArr[0];
        int i3 = this.simpleOESShaderProgram;
        if (i2 == 0) {
            GLES20.glDeleteProgram(i3);
            this.simpleOESShaderProgram = 0;
        } else {
            this.simpleOESPositionHandle = GLES20.glGetAttribLocation(i3, "position");
    ...
    private boolean initGL() {
        ...
        if (iArr[0] > 0) {
            ...
            if (this.surfaceTexture != null) {
                ...
                int i = iArr3[0];
                int i2 = this.simpleShaderProgram;
                if (i == 0) {
                    GLES20.glDeleteProgram(i2);
                    this.simpleShaderProgram = 0;
                } else {
                    this.simplePositionHandle = GLES20.glGetAttribLocation(i2, "position");
                ...
                if (this.videoDelegate != null) {
                    ...
                    SurfaceTexture surfaceTexture = new SurfaceTexture(this.videoTexture[0]);
                    this.videoSurfaceTexture = surfaceTexture;
                    surfaceTexture.setOnFrameAvailableListener(new SurfaceTexture.OnFrameAvailableListener() { // from class: org.telegram.ui.Components.FilterGLThread$$ExternalSyntheticLambda8
                        @Override // android.graphics.SurfaceTexture.OnFrameAvailableListener
                        public final void onFrameAvailable(SurfaceTexture surfaceTexture2) {
                            this.f$0.lambda$initGL$2(surfaceTexture2);
                        }
                    });
                ...
                if (this.uiBlurEnabled && (blurringShader = this.uiBlur) != null && !blurringShader.setup(this.surfaceWidth / this.surfaceHeight, true, this.blurManager.padding)) {
                    FileLog.m1046e("Failed to create uiBlurFramebuffer");
