...
public class BlockingUpdateView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public BlockingUpdateView(Context context, TLRPC.TL_help_appUpdate tL_help_appUpdate) {
        ...
        addView(frameLayout, new FrameLayout.LayoutParams(-1, AndroidUtilities.m1036dp(236.0f) + AndroidUtilities.statusBarHeight));
        RLottieImageView rLottieImageView = new RLottieImageView(context);
        rLottieImageView.setAutoRepeat(true);
        rLottieImageView.setAnimation(C2797R.raw.extera_arrow, 120, 120);
        ...
        textView.setText(LocaleController.getString(C2797R.string.UpdateAvailable));
        ...
        textView2.setText(LocaleController.formatString("AppUpdateVersionAndSize", C2797R.string.AppUpdateVersionAndSize, tL_help_appUpdate.version, AndroidUtilities.formatFileSize(tL_help_appUpdate.document.size)));
        ...
        scrollView.setPadding(0, AndroidUtilities.m1036dp(16.0f), 0, AndroidUtilities.m1036dp(16.0f));
        ...
        spoilersTextView.setLineSpacing(AndroidUtilities.m1036dp(2.0f), 1.0f);
        ...
        FrameLayout frameLayout3 = new FrameLayout(context) { // from class: org.telegram.ui.Components.BlockingUpdateView.1
            ...
            public void onDraw(Canvas canvas) {
                ...
                this.cellFlickerDrawable.draw(canvas, rectF, AndroidUtilities.m1036dp(8.0f), null);
                invalidate();
            }
        };
        ...
        frameLayout3.setPadding(AndroidUtilities.m1036dp(16.0f), 0, AndroidUtilities.m1036dp(16.0f), 0);
        ...
        textView3.setText(LocaleController.getString(C2797R.string.Update));
        ...
        FrameLayout frameLayout4 = new FrameLayout(context) { // from class: org.telegram.ui.Components.BlockingUpdateView.2
            ...
            public void onLayout(boolean z, int i4, int i5, int i6, int i7) {
                ...
                int i8 = ((i6 - i4) - iM1036dp) / 2;
                int i9 = ((i7 - i5) - iM1036dp) / 2;
                BlockingUpdateView.this.radialProgress.setProgressRect(i8, i9, i8 + iM1036dp, iM1036dp + i9);
            }
    ...
    private void showProgress(final boolean z) {
        ...
        this.progressAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.BlockingUpdateView.3
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                boolean z2 = z;
                BlockingUpdateView blockingUpdateView = BlockingUpdateView.this;
                if (!z2) {
                    blockingUpdateView.radialProgressView.setVisibility(4);
                } else {
                    blockingUpdateView.acceptTextView.setVisibility(4);
                }
            }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        this.gradientDrawableTop.setBounds(this.scrollView.getLeft(), this.scrollView.getTop(), this.scrollView.getRight(), this.scrollView.getTop() + AndroidUtilities.m1036dp(16.0f));
        this.gradientDrawableTop.draw(canvas);
        this.gradientDrawableBottom.setBounds(this.scrollView.getLeft(), this.scrollView.getBottom() - AndroidUtilities.m1036dp(18.0f), this.scrollView.getRight(), this.scrollView.getBottom());
