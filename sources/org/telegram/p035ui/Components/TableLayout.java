...
public class TableLayout extends View {
    ...
    public interface TableLayoutDelegate {
        ...
        default void onLayoutChild(CellText cellText, int i, int i2) {
        }
    }
        ...
        */
        public void measure(int r2, int r3, boolean r4) {
            /*
                ...
                r1.fixedHeight = r3
            L8:
                org.telegram.tgnet.tl.TL_iv$pageTableCell r2 = r1.cell
                if (r2 == 0) goto Lbc
            ...
            L18:
                ...
                int r2 = r1.textHeight
                int r3 = r3 - r2
                org.telegram.ui.Components.TableLayout r2 = org.telegram.p035ui.Components.TableLayout.this
                int r2 = org.telegram.p035ui.Components.TableLayout.m14422$$Nest$fgetitemPaddingTop(r2)
                int r3 = r3 - r2
                r1.textY = r3
                goto L31
            L29:
                ...
                r1.textY = r2
            L31:
                org.telegram.ui.Components.TableLayout$CellText r2 = r1.textLayout
                if (r2 == 0) goto Lbc
            ...
            L52:
                org.telegram.ui.Components.TableLayout r2 = org.telegram.p035ui.Components.TableLayout.this
                org.telegram.ui.Components.TableLayout$TableLayoutDelegate r2 = org.telegram.p035ui.Components.TableLayout.m14418$$Nest$fgetdelegate(r2)
                org.telegram.tgnet.tl.TL_iv$pageTableCell r3 = r1.cell
                int r4 = r1.measuredWidth
                org.telegram.ui.Components.TableLayout r0 = org.telegram.p035ui.Components.TableLayout.this
                int r0 = org.telegram.p035ui.Components.TableLayout.m14421$$Nest$fgetitemPaddingLeft(r0)
                int r0 = r0 * 2
                int r4 = r4 - r0
                org.telegram.ui.Components.TableLayout$CellText r2 = r2.createTextLayout(r3, r4)
                r1.setTextLayout(r2)
                int r2 = r1.textHeight
                org.telegram.ui.Components.TableLayout r3 = org.telegram.p035ui.Components.TableLayout.this
                int r3 = org.telegram.p035ui.Components.TableLayout.m14422$$Nest$fgetitemPaddingTop(r3)
                int r3 = r3 * 2
                int r2 = r2 + r3
                r1.fixedHeight = r2
            L79:
                ...
                int r4 = r1.textWidth
                int r3 = r3 - r4
                org.telegram.ui.Components.TableLayout r4 = org.telegram.p035ui.Components.TableLayout.this
                int r4 = org.telegram.p035ui.Components.TableLayout.m14421$$Nest$fgetitemPaddingLeft(r4)
                int r3 = r3 - r4
                int r2 = r2 + r3
                r1.textX = r2
                return
            ...
            Laa:
                org.telegram.ui.Components.TableLayout r3 = org.telegram.p035ui.Components.TableLayout.this
                int r3 = org.telegram.p035ui.Components.TableLayout.m14421$$Nest$fgetitemPaddingLeft(r3)
                int r2 = r2 + r3
                r1.textX = r2
                return
            Lb4:
                org.telegram.ui.Components.TableLayout r2 = org.telegram.p035ui.Components.TableLayout.this
                int r2 = org.telegram.p035ui.Components.TableLayout.m14421$$Nest$fgetitemPaddingLeft(r2)
                r1.textX = r2
            Lbc:
                return
            */
        ...
        public int getTextX() {
            return this.f1696x + this.textX;
        }

        public int getTextY() {
            return this.f1697y + this.textY;
        }
        ...
        public void draw(Canvas canvas, View view, boolean z) {
            ...
            boolean z2 = false;
            boolean z3 = true;
            boolean z4 = this.f1696x + this.measuredWidth == TableLayout.this.getMeasuredWidth();
            boolean z5 = this.f1697y + this.measuredHeight == TableLayout.this.getMeasuredHeight();
            ...
            if (this.cell.header || (TableLayout.this.isStriped && this.layoutParams.rowSpec.span.min % 2 == 0)) {
                if (this.f1696x == 0 && this.f1697y == 0) {
                ...
                if (z3) {
                    TableLayout.this.rect.set(this.f1696x, this.f1697y, r3 + this.measuredWidth, r5 + this.measuredHeight);
                    ...
                    if (z6) {
                        canvas2.drawPath(tableLayout.backgroundPath, TableLayout.this.delegate.getHeaderPaint());
                    } else {
                        canvas2.drawPath(tableLayout.backgroundPath, TableLayout.this.delegate.getStripPaint());
                    }
                } else {
                    boolean z7 = this.cell.header;
                    int i2 = this.f1696x;
                    if (z7) {
                        canvas2.drawRect(i2, this.f1697y, i2 + this.measuredWidth, r4 + this.measuredHeight, TableLayout.this.delegate.getHeaderPaint());
                        canvas2 = canvas;
                    } else {
                        canvas2 = canvas;
                        canvas2.drawRect(i2, this.f1697y, this.measuredWidth + i2, r1 + this.measuredHeight, TableLayout.this.delegate.getStripPaint());
                    }
                }
            }
            ...
            if (TableLayout.this.drawLines) {
                ...
                if (i3 == 0) {
                    float f7 = i4;
                    float f8 = this.measuredHeight + i4;
                    if (i4 == 0) {
                        f7 += iM1036dp;
                    }
                    float f9 = f7;
                    ...
                    int i5 = this.f1696x;
                    canvas2.drawLine(i5 + strokeWidth, f9, i5 + strokeWidth, f8, linePaint);
                    paint = linePaint;
                    paint2 = linePaint2;
                } else {
                    paint = linePaint;
                    paint2 = linePaint2;
                    canvas.drawLine(i3 - strokeWidth2, i4, i3 - strokeWidth2, i4 + this.measuredHeight, paint2);
                }
                int i6 = this.f1697y;
                int i7 = this.f1696x;
                if (i6 == 0) {
                    float f10 = i7;
                    float f11 = this.measuredWidth + i7;
                    if (i7 == 0) {
                        f10 += iM1036dp;
                    }
                    float f12 = f10;
                    ...
                    int i8 = this.f1697y;
                    canvas.drawLine(f12, i8 + strokeWidth, f11, i8 + strokeWidth, paint);
                } else {
                    canvas.drawLine(i7, i6 - strokeWidth2, i7 + this.measuredWidth, i6 - strokeWidth2, paint2);
                }
                float f13 = (z4 && (i = this.f1697y) == 0) ? i + iM1036dp : this.f1697y - strokeWidth;
                if (z4 && z5) {
                    f = (this.f1697y + this.measuredHeight) - iM1036dp;
                } else {
                    f = (this.f1697y + this.measuredHeight) - strokeWidth;
                }
                float f14 = f;
                int i9 = this.f1696x;
                int i10 = this.measuredWidth;
                Paint paint3 = paint;
                canvas.drawLine((i9 + i10) - strokeWidth, f13, (i9 + i10) - strokeWidth, f14, paint3);
                int i11 = this.f1696x;
                float f15 = (i11 == 0 && z5) ? i11 + iM1036dp : i11 - strokeWidth;
                if (z4 && z5) {
                    f2 = (i11 + this.measuredWidth) - iM1036dp;
                } else {
                    f2 = (i11 + this.measuredWidth) - strokeWidth;
                }
                float f16 = f2;
                int i12 = this.f1697y;
                int i13 = this.measuredHeight;
                canvas.drawLine(f15, (i12 + i13) - strokeWidth, f16, (i12 + i13) - strokeWidth, paint3);
                if (this.f1696x == 0 && this.f1697y == 0) {
                    RectF rectF = TableLayout.this.rect;
                    int i14 = this.f1696x;
                    int i15 = this.f1697y;
                    float f17 = iM1036dp * 2;
                    rectF.set(i14 + strokeWidth, i15 + strokeWidth, i14 + strokeWidth + f17, i15 + strokeWidth + f17);
                    canvas.drawArc(TableLayout.this.rect, -180.0f, 90.0f, false, paint3);
                }
                if (z4 && this.f1697y == 0) {
                    RectF rectF2 = TableLayout.this.rect;
                    int i16 = this.f1696x;
                    int i17 = this.measuredWidth;
                    float f18 = iM1036dp * 2;
                    int i18 = this.f1697y;
                    rectF2.set(((i16 + i17) - strokeWidth) - f18, i18 + strokeWidth, (i16 + i17) - strokeWidth, i18 + strokeWidth + f18);
                    canvas.drawArc(TableLayout.this.rect, 0.0f, -90.0f, false, paint3);
                }
                if (this.f1696x == 0 && z5) {
                    RectF rectF3 = TableLayout.this.rect;
                    int i19 = this.f1696x;
                    int i20 = this.f1697y;
                    int i21 = this.measuredHeight;
                    float f19 = iM1036dp * 2;
                    rectF3.set(i19 + strokeWidth, ((i20 + i21) - strokeWidth) - f19, i19 + strokeWidth + f19, (i20 + i21) - strokeWidth);
                    canvas.drawArc(TableLayout.this.rect, 180.0f, -90.0f, false, paint3);
                }
                if (z4 && z5) {
                    RectF rectF4 = TableLayout.this.rect;
                    int i22 = this.f1696x;
                    int i23 = this.measuredWidth;
                    float f20 = iM1036dp * 2;
                    int i24 = this.f1697y;
                    int i25 = this.measuredHeight;
                    rectF4.set(((i22 + i23) - strokeWidth) - f20, ((i24 + i25) - strokeWidth) - f20, (i22 + i23) - strokeWidth, (i24 + i25) - strokeWidth);
                    canvas.drawArc(TableLayout.this.rect, 0.0f, 90.0f, false, paint3);
                }
            }
        }
    ...
    public TableLayout(Context context, TableLayoutDelegate tableLayoutDelegate, TextSelectionHelper.ArticleTextSelectionHelper articleTextSelectionHelper) {
        ...
        this.itemPaddingTop = AndroidUtilities.m1036dp(7.0f);
        this.itemPaddingLeft = AndroidUtilities.m1036dp(8.0f);
    ...
    public class TableA11yHelper extends ExploreByTouchHelper {
        ...
        public int getVirtualViewAt(float f, float f2) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (childAt.measuredWidth > 0 && childAt.measuredHeight > 0) {
                    if (f >= childAt.f1696x && f < r3 + childAt.measuredWidth) {
                        if (f2 >= childAt.f1697y && f2 < r3 + childAt.measuredHeight) {
                            return i;
                        }
                    }
                }
        ...
        public void onPopulateNodeForVirtualView(int i, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            ...
            int i2 = childAt.f1696x;
            rect.set(i2, childAt.f1697y, childAt.measuredWidth + i2, childAt.f1697y + childAt.measuredHeight);
            accessibilityNodeInfoCompat.setBoundsInParent(this.tmpRect);
    ...
    private void measureChildrenWithMargins(int i, int i2, boolean z) {
        ...
        int i5 = 0;
        while (i5 < childCount) {
            Child childAt = this.getChildAt(i5);
            ...
            if (z) {
                ...
                i3 = i;
                i4 = i2;
                tableLayout.measureChildWithMargins2(childAt, i3, i4, i6, i7, true);
            } else {
                i3 = i;
                i4 = i2;
                ...
                if (spec.getAbsoluteAlignment(z2) == FILL) {
                    ...
                    int totalMargin = (locations[interval.max] - locations[interval.min]) - this.getTotalMargin(childAt, z2);
                    if (z2) {
                        int i8 = ((ViewGroup.MarginLayoutParams) layoutParams).height;
                        tableLayout = this;
                        tableLayout.measureChildWithMargins2(childAt, i3, i4, totalMargin, i8, false);
                    } else {
                        int i9 = ((ViewGroup.MarginLayoutParams) layoutParams).width;
                        tableLayout = this;
                        tableLayout.measureChildWithMargins2(childAt, i3, i4, i9, totalMargin, false);
                    }
                } else {
                    tableLayout = this;
                }
    ...
    public void onMeasure(int i, int i2) {
        ...
        for (int i4 = 0; i4 < childCount; i4++) {
            tableLayout.colCount = Math.max(tableLayout.colCount, tableLayout.getChildAt(i4).layoutParams.columnSpec.span.max);
        }
        boolean z3 = true;
        ...
        int iMax2 = Math.max(measure2, tableLayout.getSuggestedMinimumHeight());
        tableLayout.setMeasuredDimension(iMax, iMax2);
        tableLayout.mHorizontalAxis.layout(iMax);
        tableLayout.mVerticalAxis.layout(iMax2);
        ...
        while (i6 < childCount2) {
            Child childAt = tableLayout.getChildAt(i6);
            LayoutParams layoutParams = childAt.getLayoutParams();
            ...
            int measurement = tableLayout.getMeasurement(childAt, z3);
            int measurement2 = tableLayout.getMeasurement(childAt, z2);
            Alignment absoluteAlignment = spec.getAbsoluteAlignment(z3);
            Alignment absoluteAlignment2 = spec2.getAbsoluteAlignment(z2);
            Bounds value = tableLayout.mHorizontalAxis.getGroupBounds().getValue(i6);
            Bounds value2 = tableLayout.mVerticalAxis.getGroupBounds().getValue(i6);
            ...
            int offset = value.getOffset(tableLayout, childAt, absoluteAlignment, measurement + i11, true);
            tableLayout = this;
            int i12 = iMax2;
            ...
            int i14 = !tableLayout.isRtl ? margin + i13 : ((i5 - sizeInCell) - margin3) - i13;
            ...
            if (childAt.cell != null) {
                ...
                if (childAt.fixedHeight != 0 && childAt.fixedHeight != sizeInCell2 && childAt.layoutParams.rowSpec.span.max - childAt.layoutParams.rowSpec.span.min <= 1) {
                    ...
                    while (true) {
                        if (i16 < size) {
                            PointF pointF = tableLayout.rowSpans.get(i16);
        ...
        int i17 = 0;
        while (i17 < size2) {
            Child child = tableLayout.cellsToFixHeight.get(i17);
            ...
            for (int i18 = child.index + 1; i18 < size3; i18++) {
                Child child2 = tableLayout.childrens.get(i18);
            ...
            if (!z) {
                ...
                while (true) {
                    ...
                    Child child3 = tableLayout.childrens.get(i20);
                    ...
                    int i21 = child3.measuredHeight - child3.fixedHeight;
                    if (i21 > 0) {
        ...
        tableLayout.setMeasuredDimension(i5, iMax2);
    }
    ...
    public final class Axis {
        ...
        private PackedMap<Spec, Bounds> createGroupBounds() {
            Assoc assocM1166of = Assoc.m1166of(Spec.class, Bounds.class);
            int childCount = TableLayout.this.getChildCount();
            for (int i = 0; i < childCount; i++) {
                LayoutParams layoutParams = TableLayout.this.getChildAt(i).getLayoutParams();
                boolean z = this.horizontal;
                Spec spec = z ? layoutParams.columnSpec : layoutParams.rowSpec;
                assocM1166of.put(spec, spec.getAbsoluteAlignment(z).getBounds());
            }
            return assocM1166of.pack();
        }
        ...
        private PackedMap<Interval, MutableInt> createLinks(boolean z) {
            Assoc assocM1166of = Assoc.m1166of(Interval.class, MutableInt.class);
            Spec[] specArr = getGroupBounds().keys;
            int length = specArr.length;
            for (int i = 0; i < length; i++) {
                assocM1166of.put(z ? specArr[i].span : specArr[i].span.inverse(), new MutableInt());
            }
            return assocM1166of.pack();
        }
        ...
        public int getMeasure(int i) {
            ...
            if (mode == 0) {
                return getMeasure(0, AppDataDirGuesser.PER_USER_RANGE);
            }
            if (mode != 1073741824) {
                return 0;
            }
    ...
    public static final class Assoc<K, V> extends ArrayList<Pair<K, V>> {
        ...
        public static <K, V> Assoc<K, V> m1166of(Class<K> cls, Class<V> cls2) {
    ...
    public static class Bounds {
        ...
        public int size(boolean z) {
            return (z || !TableLayout.canStretch(this.flexibility)) ? this.before + this.after : AppDataDirGuesser.PER_USER_RANGE;
        }
