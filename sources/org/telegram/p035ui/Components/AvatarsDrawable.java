...
import org.telegram.p035ui.Stories.StoriesGradientTools;
...
public class AvatarsDrawable {
    ...
    public int strokeWidth = AndroidUtilities.m1036dp(1.67f);
    ...
    public void commitTransition(boolean z, boolean z2) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if (drawingStateArr2[i].f1529id != this.animatingStates[i].f1529id) {
                z3 = true;
            } else {
        ...
        for (int i2 = 0; i2 < 3; i2++) {
            ...
            while (true) {
                ...
                if (this.currentStates[i3].f1529id == this.animatingStates[i2].f1529id) {
    ...
    public class C38611 extends AnimatorListenerAdapter {
        public C38611() {
        }
    ...
    public AvatarsDrawable(View view, boolean z) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            this.currentStates[i].avatarDrawable.setTextSize(AndroidUtilities.m1036dp(16.0f));
            ...
            this.animatingStates[i].avatarDrawable.setTextSize(AndroidUtilities.m1036dp(16.0f));
        }
        this.isInCall = z;
    ...
    public void setObject(int i, int i2, TLObject tLObject) {
        TLRPC.User user;
        TLRPC.Chat chat;
        this.animatingStates[i].f1529id = 0L;
        ...
        if (tLObject instanceof TLRPC.GroupCallParticipant) {
            ...
            this.animatingStates[i].f1529id = peerId;
            ...
            this.animatingStates[i].f1529id = user.f1407id;
            chat = null;
            ...
            this.animatingStates[i].f1529id = -chat.f1245id;
            user = null;
        } else {
            user = null;
            chat = null;
        ...
        if (tLObject instanceof TL_stories.StoryItem) {
            ...
            this.animatingStates[i].f1529id = storyItem.f1454id;
    ...
    public float getUsedWidth() {
        ...
        if (i == 11) {
            ...
            if (i2 != 0) {
                iM1036dp = (int) (i2 * this.overrideSizeStepFactor);
            } else {
                iM1036dp = AndroidUtilities.m1036dp(z ? 24.0f : 20.0f);
            }
        }
        int i3 = 0;
        for (int i4 = 0; i4 < 3; i4++) {
            if (this.currentStates[i4].f1529id != 0) {
                i3++;
            }
        }
        return (Math.max(0, i3 - 1) * iM1036dp) + (i3 > 0 ? getSize() : 0);
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:631:0x06b1  */
    /* JADX WARN: Removed duplicated region for block: B:637:0x06e2  */
    /* JADX WARN: Removed duplicated region for block: B:643:0x0720  */
    /* JADX WARN: Removed duplicated region for block: B:651:0x0754  */
    /* JADX WARN: Removed duplicated region for block: B:655:0x077b  */
    /* JADX WARN: Removed duplicated region for block: B:656:0x0790  */
    /* JADX WARN: Removed duplicated region for block: B:659:0x07a9  */
    /* JADX WARN: Removed duplicated region for block: B:672:0x02aa A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:680:0x07ac A[SYNTHETIC] */
    /*
    ...
    */
    public void onDraw(android.graphics.Canvas r40) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.AvatarsDrawable.onDraw(android.graphics.Canvas):void");
    }
    ...
    public int getSize() {
        ...
        return AndroidUtilities.m1036dp((i2 == 4 || i2 == 10) ? 32.0f : 24.0f);
    }
