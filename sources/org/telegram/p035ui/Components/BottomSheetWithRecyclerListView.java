...
public abstract class BottomSheetWithRecyclerListView extends BottomSheet {
    ...
    public BottomSheetWithRecyclerListView(Context context, BaseFragment baseFragment, boolean z, boolean z2, final boolean z3, boolean z4, final boolean z5, ActionBarType actionBarType, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.headerShadowDrawable = ContextCompat.getDrawable(context, C2797R.drawable.header_shadow).mutate();
        if (z4) {
            ...
            sizeNotifierFrameLayout = new SizeNotifierFrameLayout(context) { // from class: org.telegram.ui.Components.BottomSheetWithRecyclerListView.2
                ...
                private void onMeasureInternal(int i, int i2) {
                    ...
                    int i4 = 0;
                    if (editTextEmoji2 != null && !editTextEmoji2.isWaitingForKeyboardOpen() && AndroidUtilities.m1036dp(20.0f) >= 0 && !BottomSheetWithRecyclerListView.this.editTextEmoji.isPopupShowing() && !BottomSheetWithRecyclerListView.this.editTextEmoji.isAnimatePopupClosing()) {
                    ...
                    while (i4 < childCount) {
                        ...
                        if (childAt == null || childAt.getVisibility() == 8) {
                            ...
                            if (editTextEmoji3 != null && editTextEmoji3.isPopupView(childAt)) {
                                ...
                                c38742 = this;
                                i3 = i;
                                c38742.measureChildWithMargins(childAt, i3, 0, i5, 0);
                            }
                        }
                        i4++;
                        this = c38742;
                ...
                */
                public void onLayout(boolean r11, int r12, int r13, int r14, int r15) {
                    ...
                    */
                    throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.BottomSheetWithRecyclerListView.C38742.onLayout(boolean, int, int, int, int):void");
                }
            };
        }
        ...
        if (z3) {
            ...
            this.actionBar.setForceDisableCenterTitle(true);
    ...
    public void setSlidingActionBar() {
        ...
        this.headerPaddingTop = AndroidUtilities.m1036dp(16.0f);
    ...
    public class PaddingView extends View {
        ...
        public void onMeasure(int i, int i2) {
            ...
            if (i3 == 0) {
                iM1036dp = AndroidUtilities.m1036dp(300.0f);
            } else {
                iM1036dp = (int) (i3 * bottomSheetWithRecyclerListView.topPadding);
            }
            BottomSheetWithRecyclerListView bottomSheetWithRecyclerListView2 = BottomSheetWithRecyclerListView.this;
            int i4 = iM1036dp - (((bottomSheetWithRecyclerListView2.headerTotalHeight - bottomSheetWithRecyclerListView2.headerHeight) - bottomSheetWithRecyclerListView2.headerPaddingTop) - bottomSheetWithRecyclerListView2.headerPaddingBottom);
            if (i4 < 1) {
                i4 = 1;
            }
    ...
    public void resetAdapter(final Context context) {
    ...
    */
    public void postDrawInternal(android.graphics.Canvas r8, android.view.View r9) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.BottomSheetWithRecyclerListView.postDrawInternal(android.graphics.Canvas, android.view.View):void");
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:25:0x0079 A[PHI: r2
  0x0079: PHI (r2v3 int) = (r2v2 int), (r2v6 int) binds: [B:21:0x005f, B:23:0x006e] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void preDrawInternal(android.graphics.Canvas r13, android.view.View r14) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.BottomSheetWithRecyclerListView.preDrawInternal(android.graphics.Canvas, android.view.View):void");
    }
    ...
    private void checkBackDrawableInsets() {
        ...
        if (measuredWidth >= measuredWidth2) {
            sheetBackDrawable.setBackgroundInsets(0, 0, 0, ((this.containerView.getMeasuredHeight() - bounds.top) - AndroidUtilities.m1036dp(30.0f)) - ((int) this.containerView.getTranslationY()));
        } else {
            sheetBackDrawable.setBackgroundInsets(0, 0, 0, 0);
        }
    }
