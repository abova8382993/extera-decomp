...
public class ProgressButton extends Button {
    ...
    public ProgressButton(Context context) {
        ...
        setMinWidth(iM1036dp);
        setMinimumWidth(iM1036dp);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.drawProgress || this.progressAlpha != 0.0f) {
            this.progressRect.set(getMeasuredWidth() - AndroidUtilities.m1036dp(11.0f), AndroidUtilities.m1036dp(3.0f), r0 + AndroidUtilities.m1036dp(8.0f), AndroidUtilities.m1036dp(11.0f));
