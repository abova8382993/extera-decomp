        ...
        while (i4 < i3) {
            if (i4 == 0 && this.firstRowFullWidth) {
                ...
                if (sizeSizeForItem == null) {
                    ...
                    iMin = Math.min(spanCount, (int) Math.floor(spanCount * (((sizeSizeForItem.width / sizeSizeForItem.height) * iM1036dp) / f2)));
                    ...
                    if (i6 != 0 && i5 != 0) {
                        ...
                        while (true) {
                            ...
                            if (i10 == i12) {
                                ...
                                sparseIntArray2.put(i10, sparseIntArray2.get(i10) + i8);
                            }
                            i6 -= i8;
                            i10++;
                        }
