...
public class ThanosEffect extends TextureView {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.ThanosEffect$1 */
    /* JADX INFO: loaded from: classes7.dex */
    public class ChoreographerFrameCallbackC51971 implements Choreographer.FrameCallback {
        public ChoreographerFrameCallbackC51971() {
        }
    ...
    public ThanosEffect(Context context, Runnable runnable) {
        ...
        setOpaque(false);
        setSurfaceTextureListener(new TextureViewSurfaceTextureListenerC51982());
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.ThanosEffect$2 */
    /* JADX INFO: loaded from: classes7.dex */
    public class TextureViewSurfaceTextureListenerC51982 implements TextureView.SurfaceTextureListener {
        @Override // android.view.TextureView.SurfaceTextureListener
        public void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
        }

        public TextureViewSurfaceTextureListenerC51982() {
        }
        ...
        public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
            ...
            int i3 = 0;
            while (true) {
                int size = ThanosEffect.this.toSet.size();
                ThanosEffect thanosEffect4 = ThanosEffect.this;
                if (i3 < size) {
                    ToSet toSet = (ToSet) thanosEffect4.toSet.get(i3);
                    if (toSet.bitmap != null) {
                        ...
                        ArrayList<View> arrayList = toSet.views;
                        ThanosEffect thanosEffect5 = ThanosEffect.this;
                        if (arrayList != null) {
                            thanosEffect5.drawThread.animateGroup(toSet.views, toSet.doneCallback);
                        } else {
                            thanosEffect5.drawThread.animate(toSet.view, toSet.durationMultiplier, toSet.doneCallback);
                        }
                    }
                    i3++;
                } else {
                    thanosEffect4.toSet.clear();
    ...
    public void kill() {
        ...
        this.destroyed = true;
        ArrayList<ToSet> arrayList = this.toSet;
        int size = arrayList.size();
        int i = 0;
        while (i < size) {
            ToSet toSet = arrayList.get(i);
            i++;
            ToSet toSet2 = toSet;
            Runnable runnable = toSet2.doneCallback;
            if (runnable != null) {
                ensureRunOnUIThread(runnable);
                toSet2.doneCallback = null;
            }
        }
        this.toSet.clear();
    ...
    public static class DrawingThread extends DispatchQueue {
        ...
        public void run() {
            ...
            try {
                ...
                if (!this.toAddAnimations.isEmpty()) {
                    while (true) {
                        int size = this.toAddAnimations.size();
                        arrayList = this.toAddAnimations;
                        if (i >= size) {
                            break;
                        }
                        lambda$animateGroup$2(arrayList.get(i));
                        i++;
                    }
                    arrayList.clear();
                }
                ...
                FileLog.m1048e(e);
                while (true) {
                    int size2 = this.toAddAnimations.size();
                    ArrayList<Animation> arrayList2 = this.toAddAnimations;
                    if (i < size2) {
        ...
        public void kill() {
            if (!this.alive.get()) {
                FileLog.m1045d("ThanosEffect: kill failed, already dead");
                return;
            }
            FileLog.m1045d("ThanosEffect: kill");
            try {
                Handler handler = getHandler();
                if (handler != null) {
        ...
        private void killInternal() {
            ArrayList<Animation> arrayList;
            if (!this.alive.get()) {
                FileLog.m1045d("ThanosEffect: killInternal failed, already dead");
                return;
            }
            FileLog.m1045d("ThanosEffect: killInternal");
            this.alive.set(false);
            int i = 0;
            while (true) {
                int size = this.pendingAnimations.size();
                arrayList = this.pendingAnimations;
                if (i >= size) {
                    break;
                }
                arrayList.get(i).done(true);
                i++;
            }
            arrayList.clear();
        ...
        private void init() {
            ...
            if (eGLDisplayEglGetDisplay == EGL10.EGL_NO_DISPLAY) {
                FileLog.m1046e("ThanosEffect: eglDisplay == egl.EGL_NO_DISPLAY");
                killInternal();
                return;
            }
            if (!egl102.eglInitialize(eGLDisplayEglGetDisplay, new int[2])) {
                FileLog.m1046e("ThanosEffect: failed eglInitialize");
                killInternal();
                return;
            }
            ...
            if (!this.egl.eglChooseConfig(this.eglDisplay, new int[]{12324, 8, 12323, 8, 12322, 8, 12321, 8, 12352, 64, 12344}, eGLConfigArr, 1, new int[1])) {
                FileLog.m1046e("ThanosEffect: failed eglChooseConfig");
                kill();
                return;
            }
            ...
            if (eGLContextEglCreateContext == null) {
                FileLog.m1046e("ThanosEffect: eglContext == null");
                killInternal();
                return;
            }
            ...
            if (eGLSurfaceEglCreateWindowSurface == null) {
                FileLog.m1046e("ThanosEffect: eglSurface == null");
                killInternal();
                return;
            }
            if (!this.egl.eglMakeCurrent(this.eglDisplay, eGLSurfaceEglCreateWindowSurface, eGLSurfaceEglCreateWindowSurface, this.eglContext)) {
                FileLog.m1046e("ThanosEffect: failed eglMakeCurrent");
                killInternal();
                return;
            }
            ...
            if (iGlCreateShader == 0 || iGlCreateShader2 == 0) {
                FileLog.m1046e("ThanosEffect: vertexShader == 0 || fragmentShader == 0");
                killInternal();
                return;
            }
            GLES20.glShaderSource(iGlCreateShader, AndroidUtilities.readRes(C2797R.raw.thanos_vertex));
            GLES20.glCompileShader(iGlCreateShader);
            int[] iArr = new int[1];
            GLES20.glGetShaderiv(iGlCreateShader, 35713, iArr, 0);
            if (iArr[0] != 1) {
                FileLog.m1046e("ThanosEffect, compile vertex shader error: " + GLES20.glGetShaderInfoLog(iGlCreateShader));
                GLES20.glDeleteShader(iGlCreateShader);
                killInternal();
                return;
            }
            GLES20.glShaderSource(iGlCreateShader2, AndroidUtilities.readRes(C2797R.raw.thanos_fragment));
            GLES20.glCompileShader(iGlCreateShader2);
            GLES20.glGetShaderiv(iGlCreateShader2, 35713, iArr, 0);
            if (iArr[0] != 1) {
                FileLog.m1046e("ThanosEffect, compile fragment shader error: " + GLES20.glGetShaderInfoLog(iGlCreateShader2));
            ...
            if (iGlCreateProgram == 0) {
                FileLog.m1046e("ThanosEffect: drawProgram == 0");
                killInternal();
                return;
            }
            ...
            int i2 = this.drawProgram;
            if (i != 1) {
                FileLog.m1046e("ThanosEffect, link program error: " + GLES20.glGetProgramInfoLog(i2));
                killInternal();
                return;
            }
        ...
        private void draw() {
            ArrayList<Animation> arrayList;
            ArrayList<Animation> arrayList2;
            if (!this.alive.get()) {
                return;
            }
            ...
            try {
                ...
                while (true) {
                    int size = this.toRunStartCallback.size();
                    arrayList2 = this.toRunStartCallback;
                    if (i >= size) {
                        break;
                    }
                    AndroidUtilities.runOnUIThread(arrayList2.get(i).startCallback);
                    i++;
                }
                arrayList2.clear();
                ...
                int i3 = 0;
                while (true) {
                    int size2 = this.toRunStartCallback.size();
                    arrayList = this.toRunStartCallback;
                    if (i3 >= size2) {
                        break;
                    }
                    AndroidUtilities.runOnUIThread(arrayList.get(i3).startCallback);
                    i3++;
                }
                arrayList.clear();
                while (true) {
                    int size3 = this.pendingAnimations.size();
                    ArrayList<Animation> arrayList3 = this.pendingAnimations;
                    if (i < size3) {
                        arrayList3.get(i).done(true);
                        i++;
                    } else {
                        arrayList3.clear();
                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.ThanosEffect$DrawingThread$$ExternalSyntheticLambda2
                            @Override // java.lang.Runnable
                            public final void run() {
                                ThanosEffect.DrawingThread.m14468$r8$lambda$33gwjZyvrViSWSsm3D1G3vECaY();
                            }
                        });
                        killInternal();
                        return;
        ...
        /* JADX INFO: renamed from: $r8$lambda$33gw-jZyvrViSWSsm3D1G3vECaY */
        public static /* synthetic */ void m14468$r8$lambda$33gwjZyvrViSWSsm3D1G3vECaY() {
            SharedPreferences.Editor editorEdit = MessagesController.getGlobalMainSettings().edit();
            ThanosEffect.nothanos = Boolean.TRUE;
            editorEdit.putBoolean("nothanos", true).apply();
        }
        ...
        public void animate(Matrix matrix, Bitmap bitmap, final Runnable runnable, final Runnable runnable2) {
            if (!this.alive.get()) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.ThanosEffect$DrawingThread$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
                        ThanosEffect.DrawingThread.m14469$r8$lambda$LZe6jOiLycQhtpeORUpDh17wQ(runnable, runnable2);
                    }
                });
                ThanosEffect.ensureRunOnUIThread(this.destroy);
                this.destroy = null;
        ...
        /* JADX INFO: renamed from: $r8$lambda$LZe6jOiLycQht-peORUpDh-17wQ */
        public static /* synthetic */ void m14469$r8$lambda$LZe6jOiLycQhtpeORUpDh17wQ(Runnable runnable, Runnable runnable2) {
            ThanosEffect.ensureRunOnUIThread(runnable);
            if (runnable2 != null) {
                AndroidUtilities.runOnUIThread(runnable2);
            }
        ...
        public void lambda$animateGroup$2(Animation animation) {
            ...
            if (animation.isPhotoEditor) {
                ArrayList<Animation> arrayList = this.pendingAnimations;
                int size = arrayList.size();
                while (i < size) {
                    Animation animation2 = arrayList.get(i);
                    i++;
                    animation2.done(true);
                }
        ...
        public class Animation {
            ...
            /* JADX WARN: Removed duplicated region for block: B:431:0x0332  */
            /* JADX WARN: Type inference failed for: r0v0, types: [java.lang.Object, org.telegram.ui.Components.ThanosEffect$DrawingThread$Animation] */
            /* JADX WARN: Type inference failed for: r0v1 */
            /* JADX WARN: Type inference failed for: r0v38, types: [org.telegram.ui.Components.ThanosEffect$DrawingThread$Animation] */
            /* JADX WARN: Type inference failed for: r0v43 */
            /* JADX WARN: Type inference failed for: r0v50 */
            /* JADX WARN: Type inference failed for: r0v51 */
            /* JADX WARN: Type inference failed for: r0v52 */
            /* JADX WARN: Type inference failed for: r34v0, types: [org.telegram.ui.Components.ThanosEffect$DrawingThread$Animation] */
            /*
                Code decompiled incorrectly, please refer to instructions dump.
                To view partially-correct code enable 'Show inconsistent code' option in preferences
            */
            public Animation(final java.util.ArrayList<android.view.View> r36, java.lang.Runnable r37) {
                /*
            ...
            /* JADX INFO: renamed from: $r8$lambda$ffAyKhZF-HxyOgaQ4fNT2BZuSYc */
            public static /* synthetic */ void m14490$r8$lambda$ffAyKhZFHxyOgaQ4fNT2BZuSYc(ArrayList arrayList) {
                for (int i = 0; i < arrayList.size(); i++) {
        ...
        private void checkGlErrors() {
            while (true) {
                ...
                FileLog.m1046e("thanos gles error " + iGlGetError);
            }
        }
    }
}
