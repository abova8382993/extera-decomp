...
public class PhotoCropView extends FrameLayout {
    ...
    public PhotoCropView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.cropView.setBottomPadding(AndroidUtilities.m1036dp(64.0f));
    ...
    public boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (this.thumbImageVisible && view == (cropView = this.cropView)) {
            ...
            int videoThumbX = (this.delegate.getVideoThumbX() - (iM1036dp / 2)) + AndroidUtilities.m1036dp(2.0f);
            int measuredHeight = getMeasuredHeight() - AndroidUtilities.m1036dp(156.0f);
            ...
            float fWidth = actualRect.width() + ((iM1036dp - actualRect.width()) * this.thumbAnimationProgress);
            ...
            canvas.drawCircle(videoThumbX + r1, measuredHeight + iM1036dp + AndroidUtilities.m1036dp(8.0f), AndroidUtilities.m1036dp(3.0f), this.circlePaint);
        }
        return zDrawChild;
    }
    ...
    public float getRectX() {
        return this.cropView.getCropLeft() - AndroidUtilities.m1036dp(14.0f);
    }

    public float getRectY() {
        return (this.cropView.getCropTop() - AndroidUtilities.m1036dp(14.0f)) - (!this.inBubbleMode ? AndroidUtilities.statusBarHeight : 0);
    }
