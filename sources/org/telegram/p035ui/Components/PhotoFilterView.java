...
import org.telegram.p035ui.Cells.PhotoEditRadioCell;
import org.telegram.p035ui.Cells.PhotoEditToolCell;
...
public class PhotoFilterView extends FrameLayout implements FilterShaders.FilterShadersDelegate, StoryRecorder.Touchable {
    ...
    public static class CurvesValue {
        ...
        public float[] interpolateCurve() {
            ...
            arrayList2.add(Float.valueOf(fArr[c3]));
    ...
    public static class CurvesToolValue {
        ...
        public void fillBuffer() {
            ...
            while (true) {
                ...
                if (i < 200) {
                    byteBuffer.put((byte) (dataPoints2[i] * 255.0f));
    ...
    */
    public PhotoFilterView(android.content.Context r25, org.telegram.p035ui.Components.VideoEditTextureView r26, android.graphics.Bitmap r27, android.graphics.Bitmap r28, int r29, org.telegram.messenger.MediaController.SavedFilterState r30, org.telegram.p035ui.Components.PaintingOverlay r31, int r32, boolean r33, boolean r34, org.telegram.ui.Components.BlurringShader.BlurManager r35, org.telegram.ui.ActionBar.Theme.ResourcesProvider r36) {
        /*
            Method dump skipped, instruction units count: 1585
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.PhotoFilterView.<init>(android.content.Context, org.telegram.ui.Components.VideoEditTextureView, android.graphics.Bitmap, android.graphics.Bitmap, int, org.telegram.messenger.MediaController$SavedFilterState, org.telegram.ui.Components.PaintingOverlay, int, boolean, boolean, org.telegram.ui.Components.BlurringShader$BlurManager, org.telegram.ui.ActionBar.Theme$ResourcesProvider):void");
    }
    ...
    public class TextureViewSurfaceTextureListenerC46682 implements TextureView.SurfaceTextureListener {
        ...
        public TextureViewSurfaceTextureListenerC46682(boolean z, BlurringShader.BlurManager blurManager) {
    ...
    private void updateSelectedBlurType() {
        int i = this.blurType;
        if (i == 0) {
            Drawable drawableMutate = this.blurOffButton.getContext().getResources().getDrawable(C2797R.drawable.msg_blur_off).mutate();
            ...
            this.blurRadialButton.setCompoundDrawablesWithIntrinsicBounds(0, C2797R.drawable.msg_blur_radial, 0, 0);
            this.blurRadialButton.setTextColor(-1);
            this.blurLinearButton.setCompoundDrawablesWithIntrinsicBounds(0, C2797R.drawable.msg_blur_linear, 0, 0);
            this.blurLinearButton.setTextColor(-1);
        } else if (i == 1) {
            this.blurOffButton.setCompoundDrawablesWithIntrinsicBounds(0, C2797R.drawable.msg_blur_off, 0, 0);
            this.blurOffButton.setTextColor(-1);
            Drawable drawableMutate2 = this.blurOffButton.getContext().getResources().getDrawable(C2797R.drawable.msg_blur_radial).mutate();
            ...
            this.blurRadialButton.setCompoundDrawablesWithIntrinsicBounds(0, C2797R.drawable.msg_blur_radial, 0, 0);
            this.blurRadialButton.setTextColor(-1);
            Drawable drawableMutate3 = this.blurOffButton.getContext().getResources().getDrawable(C2797R.drawable.msg_blur_linear).mutate();
    ...
    public static class RecyclerListViewWithShadows extends RecyclerListView {
        ...
        public RecyclerListViewWithShadows(Context context) {
            ...
            paint.setShader(new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.m1036dp(8.0f), new int[]{-16777216, 0}, new float[]{0.0f, 1.0f}, tileMode));
            paint2.setShader(new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.m1036dp(8.0f), new int[]{0, -16777216}, new float[]{0.0f, 1.0f}, tileMode));
        }
        ...
        public void dispatchDraw(Canvas canvas) {
            ...
            canvas.drawRect(0.0f, 0.0f, getWidth(), AndroidUtilities.m1036dp(8.0f), this.topPaint);
            this.bottomPaint.setAlpha((int) (this.bottomAlpha.set(this.bottom ? 1.0f : 0.0f) * 255.0f));
            canvas.save();
            canvas.translate(0.0f, getHeight() - AndroidUtilities.m1036dp(8.0f));
            canvas.drawRect(0.0f, 0.0f, getWidth(), AndroidUtilities.m1036dp(8.0f), this.bottomPaint);
            canvas.restore();
        }
    ...
    private void fixLayout(int i, int i2) {
        ...
        float fCeil2;
        if (this.ownLayout) {
            int iM1036dp = i - AndroidUtilities.m1036dp(28.0f);
            int iM1036dp2 = i2 - (AndroidUtilities.m1036dp(214.0f) + (!this.inBubbleMode ? AndroidUtilities.statusBarHeight : 0));
            ...
            int iCeil = (int) Math.ceil(((f - fCeil2) / 2.0f) + AndroidUtilities.m1036dp(14.0f));
            int iCeil2 = (int) Math.ceil(((f2 - fCeil) / 2.0f) + AndroidUtilities.m1036dp(14.0f) + (!this.inBubbleMode ? AndroidUtilities.statusBarHeight : 0));
            int i4 = (int) fCeil2;
            int i5 = (int) fCeil;
            if (this.ownsTextureView) {
            ...
            ((FrameLayout.LayoutParams) this.blurControl.getLayoutParams()).height = AndroidUtilities.m1036dp(38.0f) + iM1036dp2;
            ((FrameLayout.LayoutParams) this.curvesControl.getLayoutParams()).height = iM1036dp2 + AndroidUtilities.m1036dp(28.0f);
            if (AndroidUtilities.isTablet()) {
                int iM1036dp3 = AndroidUtilities.m1036dp(86.0f) * 10;
                FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) this.recyclerListView.getLayoutParams();
                if (iM1036dp3 < iM1036dp) {
                    layoutParams2.width = iM1036dp3;
                    layoutParams2.leftMargin = (iM1036dp - iM1036dp3) / 2;
                } else {
    ...
    public void setEnhanceValue(float f) {
        ...
        while (true) {
            ...
            if ((childAt instanceof PhotoEditToolCell) && this.recyclerListView.getChildAdapterPosition(childAt) == this.enhanceTool) {
                ((PhotoEditToolCell) childAt).setIconAndTextAndValue(LocaleController.getString(C2797R.string.Enhance), this.enhanceValue, 0, 100);
                break;
            }
            i++;
        }
    ...
    public class ToolsAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public /* synthetic */ void lambda$onCreateViewHolder$0(int i, int i2) {
            int i3 = PhotoFilterView.this.enhanceTool;
            PhotoFilterView photoFilterView = PhotoFilterView.this;
            if (i == i3) {
                photoFilterView.enhanceValue = i2;
            } else {
                int i4 = photoFilterView.highlightsTool;
                PhotoFilterView photoFilterView2 = PhotoFilterView.this;
                if (i == i4) {
                    photoFilterView2.highlightsValue = i2;
                } else {
                    int i5 = photoFilterView2.contrastTool;
                    PhotoFilterView photoFilterView3 = PhotoFilterView.this;
                    if (i == i5) {
                        photoFilterView3.contrastValue = i2;
                    } else {
                        int i6 = photoFilterView3.exposureTool;
                        PhotoFilterView photoFilterView4 = PhotoFilterView.this;
                        if (i == i6) {
                            photoFilterView4.exposureValue = i2;
                        } else {
                            int i7 = photoFilterView4.warmthTool;
                            PhotoFilterView photoFilterView5 = PhotoFilterView.this;
                            if (i == i7) {
                                photoFilterView5.warmthValue = i2;
                            } else {
                                int i8 = photoFilterView5.saturationTool;
                                PhotoFilterView photoFilterView6 = PhotoFilterView.this;
                                if (i == i8) {
                                    photoFilterView6.saturationValue = i2;
                                } else {
                                    int i9 = photoFilterView6.vignetteTool;
                                    PhotoFilterView photoFilterView7 = PhotoFilterView.this;
                                    if (i == i9) {
                                        photoFilterView7.vignetteValue = i2;
                                    } else {
                                        int i10 = photoFilterView7.shadowsTool;
                                        PhotoFilterView photoFilterView8 = PhotoFilterView.this;
                                        if (i == i10) {
                                            photoFilterView8.shadowsValue = i2;
                                        } else {
                                            int i11 = photoFilterView8.grainTool;
                                            PhotoFilterView photoFilterView9 = PhotoFilterView.this;
                                            if (i == i11) {
                                                photoFilterView9.grainValue = i2;
                                            } else {
                                                int i12 = photoFilterView9.sharpenTool;
                                                PhotoFilterView photoFilterView10 = PhotoFilterView.this;
                                                if (i == i12) {
                                                    photoFilterView10.sharpenValue = i2;
                                                } else {
                                                    int i13 = photoFilterView10.fadeTool;
                                                    PhotoFilterView photoFilterView11 = PhotoFilterView.this;
                                                    if (i == i13) {
                                                        photoFilterView11.fadeValue = i2;
                                                    } else if (i == photoFilterView11.softenSkinTool) {
        ...
        public /* synthetic */ void lambda$onCreateViewHolder$1(View view) {
            ...
            int i = PhotoFilterView.this.tintShadowsTool;
            PhotoFilterView photoFilterView = PhotoFilterView.this;
            if (iIntValue == i) {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType != 0) {
                ...
                if (i == PhotoFilterView.this.tintShadowsTool) {
                    photoEditRadioCell.setIconAndTextAndValue(LocaleController.getString(C2797R.string.TintShadows), 0, PhotoFilterView.this.tintShadowsColor);
                    return;
                } else {
                    if (i == PhotoFilterView.this.tintHighlightsTool) {
                        photoEditRadioCell.setIconAndTextAndValue(LocaleController.getString(C2797R.string.TintHighlights), 0, PhotoFilterView.this.tintHighlightsColor);
                        return;
                    }
                    return;
                }
            ...
            if (i == PhotoFilterView.this.enhanceTool) {
                photoEditToolCell.setIconAndTextAndValue(LocaleController.getString(C2797R.string.Enhance), PhotoFilterView.this.enhanceValue, 0, 100);
                return;
            }
            if (i == PhotoFilterView.this.highlightsTool) {
                photoEditToolCell.setIconAndTextAndValue(LocaleController.getString(C2797R.string.Highlights), PhotoFilterView.this.highlightsValue, -100, 100);
                return;
            }
            if (i == PhotoFilterView.this.contrastTool) {
                photoEditToolCell.setIconAndTextAndValue(LocaleController.getString(C2797R.string.Contrast), PhotoFilterView.this.contrastValue, -100, 100);
                return;
            }
            if (i == PhotoFilterView.this.exposureTool) {
                photoEditToolCell.setIconAndTextAndValue(LocaleController.getString(C2797R.string.Exposure), PhotoFilterView.this.exposureValue, -100, 100);
                return;
            }
            if (i == PhotoFilterView.this.warmthTool) {
                photoEditToolCell.setIconAndTextAndValue(LocaleController.getString(C2797R.string.Warmth), PhotoFilterView.this.warmthValue, -100, 100);
                return;
            }
            if (i == PhotoFilterView.this.saturationTool) {
                photoEditToolCell.setIconAndTextAndValue(LocaleController.getString(C2797R.string.Saturation), PhotoFilterView.this.saturationValue, -100, 100);
                return;
            }
            if (i == PhotoFilterView.this.vignetteTool) {
                photoEditToolCell.setIconAndTextAndValue(LocaleController.getString(C2797R.string.Vignette), PhotoFilterView.this.vignetteValue, 0, 100);
                return;
            }
            if (i == PhotoFilterView.this.shadowsTool) {
                photoEditToolCell.setIconAndTextAndValue(LocaleController.getString(C2797R.string.Shadows), PhotoFilterView.this.shadowsValue, -100, 100);
                return;
            }
            if (i == PhotoFilterView.this.grainTool) {
                photoEditToolCell.setIconAndTextAndValue(LocaleController.getString(C2797R.string.Grain), PhotoFilterView.this.grainValue, 0, 100);
                return;
            }
            if (i == PhotoFilterView.this.sharpenTool) {
                photoEditToolCell.setIconAndTextAndValue(LocaleController.getString(C2797R.string.Sharpen), PhotoFilterView.this.sharpenValue, 0, 100);
            } else if (i == PhotoFilterView.this.fadeTool) {
                photoEditToolCell.setIconAndTextAndValue(LocaleController.getString(C2797R.string.Fade), PhotoFilterView.this.fadeValue, 0, 100);
            } else if (i == PhotoFilterView.this.softenSkinTool) {
                photoEditToolCell.setIconAndTextAndValue(LocaleController.getString(C2797R.string.SoftenSkin), PhotoFilterView.this.softenSkinValue, 0, 100);
            }
        }
    ...
    public static class EnhanceView extends View {
        ...
        public void onMeasure(int i, int i2) {
            ...
            this.topTextPaint.setShadowLayer(AndroidUtilities.m1036dp(8.0f), 0.0f, 0.0f, 805306368);
            this.topTextPaint.setTextSize(AndroidUtilities.m1036dp(34.0f));
            this.bottomTextPaint.setColor(-1);
            this.bottomTextPaint.setShadowLayer(AndroidUtilities.m1036dp(12.0f), 0.0f, 0.0f, 805306368);
            this.bottomTextPaint.setTextSize(AndroidUtilities.m1036dp(58.0f));
            if (this.topText == null) {
                StaticLayout staticLayout = new StaticLayout(LocaleController.getString(C2797R.string.Enhance), this.topTextPaint, getMeasuredWidth(), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        ...
        public void onDraw(Canvas canvas) {
            ...
            canvas.restore();
            canvas.save();
            canvas.translate(((getWidth() - this.bottomTextWidth) / 2.0f) - this.bottomTextLeft, (getHeight() * 0.22f) + AndroidUtilities.m1036dp(60.0f));
