...
public class PipRoundVideoView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void show(Activity activity, Runnable runnable) {
        ...
        C46791 c46791 = new PipFrameLayout(activity) { // from class: org.telegram.ui.Components.PipRoundVideoView.1
            private boolean dragging;
            private boolean startDragging;
            private float startX;
            private float startY;

            public C46791(Context activity2) {
                super(activity2);
            }
            ...
            public boolean onTouchEvent(MotionEvent motionEvent) {
                ...
                if (motionEvent.getAction() == 2) {
                    ...
                    if (this.startDragging) {
                        ...
                        int i2 = PipRoundVideoView.this.windowLayoutParams.x;
                        int i3 = -i;
                        PipRoundVideoView pipRoundVideoView = PipRoundVideoView.this;
                        if (i2 < i3) {
                            pipRoundVideoView.windowLayoutParams.x = i3;
                        } else if (pipRoundVideoView.windowLayoutParams.x > (AndroidUtilities.displaySize.x - PipRoundVideoView.this.windowLayoutParams.width) + i) {
                        ...
                        int i4 = PipRoundVideoView.this.windowLayoutParams.x;
                        PipRoundVideoView pipRoundVideoView2 = PipRoundVideoView.this;
                        float f3 = 1.0f;
                        if (i4 < 0) {
                            f3 = 1.0f + ((pipRoundVideoView2.windowLayoutParams.x / i) * 0.5f);
                        } else if (pipRoundVideoView2.windowLayoutParams.x > AndroidUtilities.displaySize.x - PipRoundVideoView.this.windowLayoutParams.width) {
                        ...
                        int i5 = PipRoundVideoView.this.windowLayoutParams.y;
                        PipRoundVideoView pipRoundVideoView3 = PipRoundVideoView.this;
                        if (i5 < 0) {
                            pipRoundVideoView3.windowLayoutParams.y = 0;
                        } else if (pipRoundVideoView3.windowLayoutParams.y > AndroidUtilities.displaySize.y - PipRoundVideoView.this.windowLayoutParams.height) {
            ...
            public void onDraw(Canvas canvas) {
                ...
                if (drawable != null) {
                    ...
                    Theme.chat_roundVideoShadow.setBounds(AndroidUtilities.m1036dp(1.0f), AndroidUtilities.m1036dp(2.0f), AndroidUtilities.m1036dp(125.0f), AndroidUtilities.m1036dp(125.0f));
                    ...
                    canvas.drawCircle(AndroidUtilities.m1036dp(63.0f), AndroidUtilities.m1036dp(63.0f), AndroidUtilities.m1036dp(59.5f), Theme.chat_docBackPaint);
                }
            }
        };
        this.windowView = c46791;
        c46791.setWillNotDraw(false);
        this.videoWidth = AndroidUtilities.m1036dp(126.0f);
        this.videoHeight = AndroidUtilities.m1036dp(126.0f);
        C46802 c46802 = new AspectRatioFrameLayout(activity2) { // from class: org.telegram.ui.Components.PipRoundVideoView.2
            public C46802(Context activity2) {
                super(activity2);
            }
        ...
        this.aspectRatioFrameLayout = c46802;
        c46802.setOutlineProvider(new ViewOutlineProvider() { // from class: org.telegram.ui.Components.PipRoundVideoView.3
            public C46813() {
            }

            @Override // android.view.ViewOutlineProvider
            public void getOutline(View view, Outline outline) {
                outline.setOval(0, 0, AndroidUtilities.m1036dp(120.0f), AndroidUtilities.m1036dp(120.0f));
            }
        });
        ...
        this.textureView = new TextureView(activity2);
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.PipRoundVideoView$1 */
    /* JADX INFO: loaded from: classes7.dex */
    public class C46791 extends PipFrameLayout {
        private boolean dragging;
        private boolean startDragging;
        private float startX;
        private float startY;
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.PipRoundVideoView$2 */
    /* JADX INFO: loaded from: classes7.dex */
    public class C46802 extends AspectRatioFrameLayout {
        public C46802(Context activity2) {
            super(activity2);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.PipRoundVideoView$3 */
    /* JADX INFO: loaded from: classes7.dex */
    public class C46813 extends ViewOutlineProvider {
        public C46813() {
        }
    ...
    public void showTemporary(boolean z) {
        ...
        this.hideShowAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.PipRoundVideoView.4
            public C46824() {
            }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.PipRoundVideoView$4 */
    /* JADX INFO: loaded from: classes7.dex */
    public class C46824 extends AnimatorListenerAdapter {
        public C46824() {
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.PipRoundVideoView$5 */
    /* JADX INFO: loaded from: classes7.dex */
    public class C46835 extends AnimatorListenerAdapter {
        final /* synthetic */ boolean val$show;
    ...
    */
    public void animateToBoundsMaybe() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.PipRoundVideoView.animateToBoundsMaybe():void");
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.PipRoundVideoView$6 */
    /* JADX INFO: loaded from: classes7.dex */
    public class C46846 extends AnimatorListenerAdapter {
        public C46846() {
        }
