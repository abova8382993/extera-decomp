...
public class ChatAttachAlertColorsLayout extends ChatAttachAlert.AttachAlertLayout {
    ...
    public ChatAttachAlertColorsLayout(ChatAttachAlert chatAttachAlert, Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        C40441 c40441 = new RecyclerListView(context, resourcesProvider) { // from class: org.telegram.ui.Components.ChatAttachAlertColorsLayout.1
            public C40441(Context context2, Theme.ResourcesProvider resourcesProvider2) {
            ...
            public boolean onTouchEvent(MotionEvent motionEvent) {
                if (motionEvent.getAction() != 0 || motionEvent.getY() >= ChatAttachAlertColorsLayout.this.parentAlert.scrollOffsetY[0] - AndroidUtilities.m1036dp(80.0f)) {
        ...
        this.gridView = c40441;
        Adapter adapter = new Adapter(context2);
        this.adapter = adapter;
        c40441.setAdapter(adapter);
        ...
        this.gridView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.Components.ChatAttachAlertColorsLayout.2
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int i) {
                ...
                if (i == 0) {
                    ...
                    if (((ChatAttachAlertColorsLayout.this.parentAlert.scrollOffsetY[0] - backgroundPaddingTop) - iM1036dp2) + backgroundPaddingTop >= ActionBar.getCurrentActionBarHeight() || (holder = (RecyclerListView.Holder) ChatAttachAlertColorsLayout.this.gridView.findViewHolderForAdapterPosition(0)) == null || holder.itemView.getTop() <= AndroidUtilities.m1036dp(7.0f)) {
                        return;
                    }
                    ChatAttachAlertColorsLayout.this.gridView.smoothScrollBy(0, holder.itemView.getTop() - AndroidUtilities.m1036dp(7.0f));
                }
            }
        });
        C40463 c40463 = new GridLayoutManager(context2, this.itemSize) { // from class: org.telegram.ui.Components.ChatAttachAlertColorsLayout.3
            @Override // androidx.recyclerview.widget.GridLayoutManager, androidx.recyclerview.widget.LinearLayoutManager, androidx.recyclerview.widget.RecyclerView.LayoutManager
            public boolean supportsPredictiveItemAnimations() {
                return false;
            }

            public C40463(Context context2, int i) {
                super(context2, i);
            }

            /* JADX INFO: renamed from: org.telegram.ui.Components.ChatAttachAlertColorsLayout$3$1 */
            public class AnonymousClass1 extends LinearSmoothScroller {
                ...
                public int calculateDyToMakeVisible(View view, int i) {
                    return super.calculateDyToMakeVisible(view, i) - (ChatAttachAlertColorsLayout.this.gridView.getPaddingTop() - AndroidUtilities.m1036dp(7.0f));
                }
            ...
            public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int i) {
                AnonymousClass1 anonymousClass1 = new LinearSmoothScroller(recyclerView.getContext()) { // from class: org.telegram.ui.Components.ChatAttachAlertColorsLayout.3.1
                    ...
                    public int calculateDyToMakeVisible(View view, int i2) {
                        return super.calculateDyToMakeVisible(view, i2) - (ChatAttachAlertColorsLayout.this.gridView.getPaddingTop() - AndroidUtilities.m1036dp(7.0f));
                    }
        ...
        this.layoutManager = c40463;
        c40463.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() { // from class: org.telegram.ui.Components.ChatAttachAlertColorsLayout.4
            public C40474() {
            }

            @Override // androidx.recyclerview.widget.GridLayoutManager.SpanSizeLookup
            public int getSpanSize(int i) {
                return ChatAttachAlertColorsLayout.this.itemSize + (i % ChatAttachAlertColorsLayout.this.itemsPerRow != ChatAttachAlertColorsLayout.this.itemsPerRow + (-1) ? AndroidUtilities.m1036dp(5.0f) : 0);
            }
        });
        this.gridView.setLayoutManager(this.layoutManager);
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.ChatAttachAlertColorsLayout$1 */
    public class C40441 extends RecyclerListView {
        public C40441(Context context2, Theme.ResourcesProvider resourcesProvider2) {
            super(context2, resourcesProvider2);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.ChatAttachAlertColorsLayout$2 */
    public class C40452 extends RecyclerView.OnScrollListener {
        public C40452() {
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.ChatAttachAlertColorsLayout$3 */
    public class C40463 extends GridLayoutManager {
        @Override // androidx.recyclerview.widget.GridLayoutManager, androidx.recyclerview.widget.LinearLayoutManager, androidx.recyclerview.widget.RecyclerView.LayoutManager
        public boolean supportsPredictiveItemAnimations() {
            return false;
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.ChatAttachAlertColorsLayout$4 */
    public class C40474 extends GridLayoutManager.SpanSizeLookup {
        public C40474() {
        }
    ...
    */
    public void onPreMeasure(int r7, int r8) {
        ...
        L18:
            ...
            int r1 = org.telegram.p035ui.ActionBar.ActionBar.getCurrentActionBarHeight()
            r0.topMargin = r1
        ...
        L9c:
            ...
            int r8 = org.telegram.messenger.AndroidUtilities.m1036dp(r8)
            int r7 = r7 - r8
            if (r7 >= 0) goto La6
            goto La7
        La6:
        ...
        La7:
            ...
            if (r7 == r0) goto Lc4
            org.telegram.ui.Components.RecyclerListView r6 = r6.gridView
            r7 = 1086324736(0x40c00000, float:6.0)
            int r8 = org.telegram.messenger.AndroidUtilities.m1036dp(r7)
            int r7 = org.telegram.messenger.AndroidUtilities.m1036dp(r7)
            r1 = 1111490560(0x42400000, float:48.0)
            int r1 = org.telegram.messenger.AndroidUtilities.m1036dp(r1)
            r6.setPadding(r8, r0, r7, r1)
        Lc4:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.ChatAttachAlertColorsLayout.onPreMeasure(int, int):void");
    }
    ...
    public class Adapter extends RecyclerListView.SelectionAdapter {
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Components.ChatAttachAlertColorsLayout$Adapter$1 */
        public class C40481 extends WallpaperCell {
            public C40481(Context context, int i) {
                super(context, i);
            }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            C40481 c40481 = new WallpaperCell(this.mContext, 1) { // from class: org.telegram.ui.Components.ChatAttachAlertColorsLayout.Adapter.1
                public C40481(Context context, int i2) {
                    super(context, i2);
                }
            ...
            c40481.drawStubBackground = false;
            return new RecyclerListView.Holder(c40481);
        }
    ...
    public void onShow(ChatAttachAlert.AttachAlertLayout attachAlertLayout) {
        ...
        this.parentAlert.actionBar.setTitle(LocaleController.getString(C2797R.string.SelectColor));
