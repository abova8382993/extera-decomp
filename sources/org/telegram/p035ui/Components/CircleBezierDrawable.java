...
public class CircleBezierDrawable {
    ...
    private final float f1545L;

    /* JADX INFO: renamed from: N */
    private final int f1546N;
    public float radius;
    ...
    private Matrix f1547m = new Matrix();
    ...
    public void draw(float f, float f2, Canvas canvas, Paint paint) {
        ...
        float fMax = this.f1545L * Math.max(f6, f7) * this.cubicBezierK;
        this.path.reset();
        int i = 0;
        int i2 = 0;
        while (i2 < this.f1546N) {
            this.f1547m.reset();
            this.f1547m.setRotate((360.0f / this.f1546N) * i2, f, f2);
            float f8 = i2 % 2 == 0 ? f6 : f7;
            float f9 = this.randomK;
            float[] fArr = this.randomAdditionals;
            float f10 = f8 + (fArr[i2] * f9);
            float[] fArr2 = this.pointStart;
            fArr2[i] = f;
            float f11 = f2 - f10;
            fArr2[1] = f11;
            fArr2[2] = f + fMax + (f9 * fArr[i2] * this.f1545L);
            fArr2[3] = f11;
            this.f1547m.mapPoints(fArr2);
            int i3 = i2 + 1;
            int i4 = i3 >= this.f1546N ? i : i3;
            float f12 = i4 % 2 == 0 ? f6 : f7;
            int i5 = i;
            float f13 = this.randomK;
            float[] fArr3 = this.randomAdditionals;
            float f14 = f12 + (fArr3[i4] * f13);
            float[] fArr4 = this.pointEnd;
            fArr4[i5] = f;
            float f15 = f2 - f14;
            fArr4[1] = f15;
            fArr4[2] = (f - fMax) + (f13 * fArr3[i4] * this.f1545L);
            fArr4[3] = f15;
            this.f1547m.reset();
            this.f1547m.setRotate((360.0f / this.f1546N) * i4, f, f2);
            this.f1547m.mapPoints(this.pointEnd);
            if (i2 == 0) {
                Path path = this.path;
                float[] fArr5 = this.pointStart;
                path.moveTo(fArr5[i5], fArr5[1]);
            }
            ...
            path2.cubicTo(f16, f17, fArr7[2], fArr7[3], fArr7[i5], fArr7[1]);
            i2 = i3;
            i = i5;
        }
        canvas.save();
