...
public abstract class PermissionRequest {
    ...
    public static void ensureAllPermissions(int i, int i2, String[] strArr, final String[] strArr2, final Utilities.Callback<Boolean> callback) {
        final Activity activityFindActivity = LaunchActivity.instance;
        if (activityFindActivity == null) {
            activityFindActivity = AndroidUtilities.findActivity(ApplicationLoader.applicationContext);
        }
                ...
                for (String str2 : strArr) {
                    if (activityFindActivity.shouldShowRequestPermissionRationale(str2)) {
                        new AlertDialog.Builder(activityFindActivity, null).setTopAnimation(i, 72, false, Theme.getColor(Theme.key_dialogTopBackground)).setMessage(AndroidUtilities.replaceTags(LocaleController.getString(i2))).setPositiveButton(LocaleController.getString(C2797R.string.PermissionOpenSettings), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.PermissionRequest$$ExternalSyntheticLambda3
                            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                            public final void onClick(AlertDialog alertDialog, int i3) {
                                PermissionRequest.m12900$r8$lambda$rqSIchz3KrqjwF9F5tplg1vFfk(activityFindActivity, alertDialog, i3);
                            }
                        }).setNegativeButton(LocaleController.getString(C2797R.string.ContactsPermissionAlertNotNow), null).create().show();
                        if (callback != null) {
                            callback.run(Boolean.FALSE);
    ...
    public static /* synthetic */ void m12900$r8$lambda$rqSIchz3KrqjwF9F5tplg1vFfk(Activity activity, AlertDialog alertDialog, int i) {
        try {
            Intent intent = new Intent("android.settings.APPLICATION_DETAILS_SETTINGS");
            intent.setData(Uri.parse("package:" + ApplicationLoader.applicationContext.getPackageName()));
            activity.startActivity(intent);
    ...
    public static void requestPermission(String str, final Utilities.Callback<Boolean> callback) {
        requestPermissions(new String[]{str}, callback != null ? new Utilities.Callback() { // from class: org.telegram.ui.Components.PermissionRequest$$ExternalSyntheticLambda0
            @Override // org.telegram.messenger.Utilities.Callback
            public final void run(Object obj) {
                PermissionRequest.m12899$r8$lambda$iRU0goqpimQBvdfDKQXDlUe4eE(callback, (int[]) obj);
            }
        } : null);
    }

    /* JADX INFO: renamed from: $r8$lambda$iRU0goqpim-QBvdfDKQXDlUe4eE */
    public static /* synthetic */ void m12899$r8$lambda$iRU0goqpimQBvdfDKQXDlUe4eE(Utilities.Callback callback, int[] iArr) {
        boolean z = false;
    ...
    public static void requestPermissions(String[] strArr, Utilities.Callback<int[]> callback) {
        ...
        notificationCenterDelegateArr[0] = new NotificationCenter.NotificationCenterDelegate() { // from class: org.telegram.ui.Components.PermissionRequest.1
            ...
            public C46511(int i2, Utilities.Callback callback2, NotificationCenter.NotificationCenterDelegate[] notificationCenterDelegateArr2) {
                i = i2;
                callback = callback2;
    ...
    public class C46511 implements NotificationCenter.NotificationCenterDelegate {
        final /* synthetic */ int val$code;
        final /* synthetic */ NotificationCenter.NotificationCenterDelegate[] val$observer;
        final /* synthetic */ Utilities.Callback val$whenDone;
