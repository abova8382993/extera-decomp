...
public abstract class EditTextEffects extends ReceiveContentEditText {
    ...
    */
    public void onTextChanged(java.lang.CharSequence r4, int r5, int r6, int r7) {
        ...
        L31:
            ...
            org.telegram.ui.Components.spoilers.SpoilerEffect r1 = (org.telegram.p035ui.Components.spoilers.SpoilerEffect) r1     // Catch: java.lang.Exception -> L58
        ...
        L5c:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.EditTextEffects.onTextChanged(java.lang.CharSequence, int, int, int):void");
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.clipToPadding && getScrollY() != 0) {
            canvas.clipRect(-AndroidUtilities.m1036dp(3.0f), (getScrollY() - super.getExtendedPaddingTop()) - this.offsetY, getMeasuredWidth(), ((getMeasuredHeight() + getScrollY()) + super.getExtendedPaddingBottom()) - this.offsetY);
        }
        if (!this.spoilers.isEmpty()) {
            this.path.rewind();
            Iterator<SpoilerEffect> it = this.spoilers.iterator();
        ...
        if (this.drawAnimatedEmojiDrawables && this.animatedEmojiDrawables != null) {
            ...
            int animatedEmojiDrawScrollY = getAnimatedEmojiDrawScrollY();
            AnimatedEmojiSpan.drawAnimatedEmojis(canvas, getLayout(), this.animatedEmojiDrawables, 0.0f, this.spoilers, animatedEmojiDrawScrollY - AndroidUtilities.m1036dp(6.0f), animatedEmojiDrawScrollY + computeVerticalScrollExtent(), 0.0f, 1.0f, this.animatedEmojiColorFilter);
            canvas.restore();
        }
        canvas.restore();
        if (this.spoilers.isEmpty()) {
