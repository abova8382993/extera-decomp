...
public abstract class JoinCallByUrlAlert extends BottomSheet {
    ...
    public JoinCallByUrlAlert(Context context, TLRPC.Chat chat) {
        ...
        ChatObject.Call groupCall = AccountInstance.getInstance(this.currentAccount).getMessagesController().getGroupCall(chat.f1245id, false);
        if (groupCall != null) {
            ...
            if (i == 0) {
                textView2.setText(LocaleController.getString(C2797R.string.NoOneJoinedYet));
            } else {
        ...
        if (ChatObject.isChannelOrGiga(chat)) {
            bottomSheetCell.setText(LocaleController.getString(C2797R.string.VoipChannelJoinVoiceChatUrl));
        } else {
            bottomSheetCell.setText(LocaleController.getString(C2797R.string.VoipGroupJoinVoiceChatUrl));
        }
