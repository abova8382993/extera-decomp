...
public class GroupCallMessageCell extends ViewGroup implements ClickHelper.Delegate, NotificationCenter.NotificationCenterDelegate, FactorAnimator.Target {
    ...
    public /* bridge */ /* synthetic */ long getLongPressDuration() {
        return super.getLongPressDuration();
    }
    ...
    public GroupCallMessageCell(Context context) {
        ...
        imageReceiver.setRoundRadius(AndroidUtilities.m1036dp(11.0f));
        cellFlickerDrawable.setStrokeWidth(AndroidUtilities.m1036dp(1.0f));
    ...
    public void onMeasure(int i, int i2) {
        ...
        this.flickerDrawable.setParentWidth(Math.round(this.layout.bubble.width() + AndroidUtilities.m1036dp(48.0f)));
    }
    ...
    private int getClickTarget(float f, float f2) {
        ...
        this.tmpRectF.inset(-AndroidUtilities.m1036dp(5.0f), -AndroidUtilities.m1036dp(5.0f));
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.isSendDelayedAnimator.getFloatValue() > 0.0f) {
            ...
            this.tmpRectF.inset(AndroidUtilities.m1036dp(1.0f), AndroidUtilities.m1036dp(1.0f));
            this.flickerDrawable.draw(canvas, this.tmpRectF, AndroidUtilities.m1036dp(14.0f), null);
            invalidate();
        }
    ...
    public static class Layout {
        ...
        public static Layout build(int i, int i2, int i3, SpoilersTextView spoilersTextView, ReactionsLayoutInBubble.VisibleReaction visibleReaction) {
            int iM1036dp;
            spoilersTextView.measure(View.MeasureSpec.makeMeasureSpec(((i - i2) - i3) - AndroidUtilities.m1036dp(44.0f), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(0, 0));
            float measuredWidth = spoilersTextView.getMeasuredWidth();
            if (visibleReaction == null) {
                iM1036dp = ((int) Math.ceil(measuredWidth)) + AndroidUtilities.m1036dp(44.0f);
            } else {
                iM1036dp = AndroidUtilities.m1036dp(70.0f) + ((int) Math.ceil(measuredWidth));
            }
            int iMax = Math.max(AndroidUtilities.m1036dp(28.0f), spoilersTextView.getMeasuredHeight() + AndroidUtilities.m1036dp(8.0f));
            Layout layout = new Layout();
            layout.viewWidth = i;
            layout.viewHeight = iMax;
            layout.bubble.set(0.0f, 0.0f, iM1036dp, iMax);
            layout.bubble.offset((i - iM1036dp) / 2.0f, 0.0f);
            layout.bubblePath.addRoundRect(layout.bubble, AndroidUtilities.m1036dp(14.0f), AndroidUtilities.m1036dp(14.0f), Path.Direction.CW);
            boolean z = spoilersTextView.getLayout().getParagraphDirection(0) == -1;
            layout.avatar.set(0.0f, 0.0f, AndroidUtilities.m1036dp(22.0f), AndroidUtilities.m1036dp(22.0f));
            RectF rectF = layout.avatar;
            if (z) {
                RectF rectF2 = layout.bubble;
                rectF.offset(rectF2.right, rectF2.top);
                layout.avatar.offset((-AndroidUtilities.m1036dp(4.0f)) - layout.avatar.width(), AndroidUtilities.m1036dp(3.0f));
            } else {
                RectF rectF3 = layout.bubble;
                rectF.offset(rectF3.left, rectF3.top);
                layout.avatar.offset(AndroidUtilities.m1036dp(4.0f), AndroidUtilities.m1036dp(3.0f));
            }
            layout.reaction.set(0.0f, 0.0f, AndroidUtilities.m1036dp(28.0f), AndroidUtilities.m1036dp(28.0f));
            RectF rectF4 = layout.reaction;
            if (z) {
                rectF4.offset(layout.bubble.left + AndroidUtilities.m1036dp(5.0f), 0.0f);
            } else {
                rectF4.offset(layout.bubble.right - AndroidUtilities.m1036dp(33.0f), 0.0f);
            }
            layout.reaction.inset(AndroidUtilities.m1036dp(1.0f), AndroidUtilities.m1036dp(1.0f));
            layout.text.set(0.0f, (layout.bubble.top + AndroidUtilities.m1036dp(19.0f)) - spoilersTextView.getLayout().getLineBaseline(0));
            PointF pointF = layout.text;
            if (z) {
                pointF.offset((layout.bubble.right - AndroidUtilities.m1036dp(32.0f)) - measuredWidth, 0.0f);
                return layout;
            }
            pointF.offset(layout.bubble.left + AndroidUtilities.m1036dp(32.0f), 0.0f);
            return layout;
        }
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.conference.message.GroupCallMessageCell$VH */
    public static class C5337VH extends RecyclerView.ViewHolder {
        public final GroupCallMessageCell cell;

        public C5337VH(GroupCallMessageCell groupCallMessageCell) {
