...
public class GroupCallMessagesListView extends RecyclerView {
    ...
    public GroupCallMessagesListView(Context context) {
        ...
        paint.setShader(new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.m1036dp(16.0f), 0, -16777216, Shader.TileMode.CLAMP));
        ...
        addItemDecoration(new RecyclerView.ItemDecoration() { // from class: org.telegram.ui.Components.conference.message.GroupCallMessagesListView.2
            ...
            public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
                rect.top = AndroidUtilities.m1036dp(6.0f);
            }
        });
        GroupCallMessagesAdapter groupCallMessagesAdapter = new GroupCallMessagesAdapter() { // from class: org.telegram.ui.Components.conference.message.GroupCallMessagesListView.3
            ...
            public GroupCallMessageCell.C5337VH onCreateViewHolder(ViewGroup viewGroup, int i) {
                GroupCallMessageCell.C5337VH c5337vhOnCreateViewHolder = super.onCreateViewHolder(viewGroup, i);
                c5337vhOnCreateViewHolder.cell.setRenderNode(GroupCallMessagesListView.this.blurRoot, GroupCallMessagesListView.this.renderNode, GroupCallMessagesListView.this.renderNodeScale);
                c5337vhOnCreateViewHolder.cell.setDelegate(GroupCallMessagesListView.this.cellDelegate);
                return c5337vhOnCreateViewHolder;
            }
        };
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        canvas.drawRect(0.0f, 0.0f, f3, iM1036dp, this.maskPaint);
