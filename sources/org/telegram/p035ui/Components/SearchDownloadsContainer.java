...
public class SearchDownloadsContainer extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void update(boolean z) {
        ...
        if (TextUtils.isEmpty(this.searchQuery) || isEmptyDownloads()) {
            ...
            if (this.rowCount == 0) {
                ...
                this.emptyView.title.setText(LocaleController.getString(C2797R.string.SearchEmptyViewDownloads));
        ...
        if (z) {
            ...
            DiffUtil.calculateDiff(new DiffUtil.Callback() { // from class: org.telegram.ui.Components.SearchDownloadsContainer.4
                ...
                public boolean areItemsTheSame(int i8, int i9) {
                    ...
                    return (messageObject2 == null || messageObject == null || messageObject2.getDocument() == null || messageObject.getDocument() == null || messageObject2.getDocument().f1253id != messageObject.getDocument().f1253id) ? false : true;
                }
    ...
    private void updateRows(ArrayList<MessageObject> arrayList, ArrayList<MessageObject> arrayList2) {
        ...
        int i3 = 0;
        while (i3 < size2) {
            MessageObject messageObject3 = arrayList2.get(i3);
            i3++;
    ...
    public void showPremiumFloodWaitBulletin(final boolean z) {
        ...
        if (z) {
            f = MessagesController.getInstance(i).uploadPremiumSpeedupUpload;
        } else {
            f = MessagesController.getInstance(i).uploadPremiumSpeedupDownload;
        }
        ...
        BulletinFactory.m1143of(this.parentFragment).createSimpleBulletin(C2797R.raw.speed_limit, LocaleController.getString(z ? C2797R.string.UploadSpeedLimited : C2797R.string.DownloadSpeedLimited), AndroidUtilities.replaceCharSequence(TimeModel.NUMBER_FORMAT, AndroidUtilities.premiumText(LocaleController.getString(z ? C2797R.string.UploadSpeedLimitedMessage : C2797R.string.DownloadSpeedLimitedMessage), new Runnable() { // from class: org.telegram.ui.Components.SearchDownloadsContainer$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
