...
public class ChatAttachAlertPhotoLayoutPreview extends ChatAttachAlert.AttachAlertLayout {
    ...
    public ChatAttachAlertPhotoLayoutPreview(ChatAttachAlert chatAttachAlert, Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        C41221 c41221 = new ActionBarMenuItem(context, actionBarMenuCreateMenu, 0, 0, this.resourcesProvider) { // from class: org.telegram.ui.Components.ChatAttachAlertPhotoLayoutPreview.1
            public C41221(Context context2, ActionBarMenu actionBarMenuCreateMenu2, int i, int i2, Theme.ResourcesProvider resourcesProvider2) {
        ...
        this.parentAlert.actionBar.addView(c41221, 0, LayoutHelper.createFrame(-2, -1.0f, 51, AndroidUtilities.isTablet() ? 64.0f : 56.0f, 0.0f, 40.0f, 0.0f));
        ...
        this.header.setText(LocaleController.getString(C2797R.string.AttachMediaPreview));
        this.header.setTypeface(AndroidUtilities.bold());
        this.header.setCompoundDrawablePadding(AndroidUtilities.m1036dp(4.0f));
        this.header.setPadding(0, 0, AndroidUtilities.m1036dp(10.0f), 0);
        this.header.setAlpha(0.0f);
        c41221.addView(this.header, LayoutHelper.createFrame(-2, -2.0f, 16, 16.0f, 0.0f, 0.0f, 0.0f));
        C41232 c41232 = new RecyclerListView(context2, this.resourcesProvider) { // from class: org.telegram.ui.Components.ChatAttachAlertPhotoLayoutPreview.2
            public C41232(Context context2, Theme.ResourcesProvider resourcesProvider2) {
        ...
        this.listView = c41232;
        c41232.setAdapter(new RecyclerView.Adapter() { // from class: org.telegram.ui.Components.ChatAttachAlertPhotoLayoutPreview.3
        ...
        undoView.setEnterOffsetMargin(AndroidUtilities.m1036dp(32.0f));
        addView(this.undoView, LayoutHelper.createFrame(-1, -2.0f, 83, 8.0f, 0.0f, 8.0f, 52.0f));
        this.videoPlayImage = context2.getResources().getDrawable(C2797R.drawable.play_mini_video);
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.ChatAttachAlertPhotoLayoutPreview$1 */
    public class C41221 extends ActionBarMenuItem {
        public C41221(Context context2, ActionBarMenu actionBarMenuCreateMenu2, int i, int i2, Theme.ResourcesProvider resourcesProvider2) {
            super(context2, actionBarMenuCreateMenu2, i, i2, resourcesProvider2);
        }
    ...
    public class C41232 extends RecyclerListView {
        public C41232(Context context2, Theme.ResourcesProvider resourcesProvider2) {
            super(context2, resourcesProvider2);
        }
    ...
    public class C41243 extends RecyclerView.Adapter {
        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        public int getItemCount() {
            return 1;
        }
    ...
    public /* synthetic */ void lambda$onShow$0(ChatAttachAlert.AttachAlertLayout attachAlertLayout) {
        ...
        RecyclerListView recyclerListView = this.listView;
        if (currentItemTop > AndroidUtilities.m1036dp(7.0f)) {
    ...
    public /* synthetic */ void lambda$onShow$1() {
        ...
        this.parentAlert.getPhotoLayout().previewItem.setIcon(C2797R.drawable.ic_ab_back);
        this.parentAlert.getPhotoLayout().previewItem.setText(LocaleController.getString(C2797R.string.Back));
    ...
    public void onHide() {
        ...
        if (getSelectedItemsCount() > 1 && this.parentAlert.getPhotoLayout() != null) {
            this.parentAlert.getPhotoLayout().previewItem.setIcon(C2797R.drawable.msg_view_file);
            this.parentAlert.getPhotoLayout().previewItem.setText(LocaleController.getString(C2797R.string.AttachMediaPreviewButton));
            this.parentAlert.getPhotoLayout().previewItem.setRightIcon(C2797R.drawable.msg_arrowright);
        }
    ...
    public class GroupCalculator {
        ...
        /* JADX WARN: Removed duplicated region for block: B:320:0x00b7  */
        /* JADX WARN: Removed duplicated region for block: B:321:0x00b9  */
        /* JADX WARN: Removed duplicated region for block: B:357:0x0213  */
        /* JADX WARN: Removed duplicated region for block: B:420:0x05c3  */
        /*
        ...
        */
        ...
        public int getWidth() {
            ...
            for (int i = 0; i < size; i++) {
                ...
                int i2 = groupedMessagePosition.f1153pw;
        ...
        public float getHeight() {
            ...
            for (int i = 0; i < size; i++) {
                MessageObject.GroupedMessagePosition groupedMessagePosition = this.posArray.get(i);
                float f = groupedMessagePosition.f1152ph;
            ...
            for (int i5 = 0; i5 < size; i5++) {
                ...
                if (groupedMessagePosition2 != groupedMessagePosition && groupedMessagePosition2.maxX < i3) {
                    ...
                    for (int iMax = Math.max(groupedMessagePosition2.minY - i, 0); iMax <= iMin; iMax++) {
                        fArr[iMax] = fArr[iMax] + groupedMessagePosition2.f1153pw;
                    }
                }
            }
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (groupedMessagePosition2 != groupedMessagePosition && groupedMessagePosition2.maxY < i) {
                    for (int i4 = groupedMessagePosition2.minX; i4 <= groupedMessagePosition2.maxX; i4++) {
                        fArr[i4] = fArr[i4] + groupedMessagePosition2.f1152ph;
                    }
                }
            }
    ...
    public int getCurrentItemTop() {
        ...
        if (top < AndroidUtilities.m1036dp(8.0f) || holder == null || holder.getAdapterPosition() != 0) {
            top = iM1036dp;
        }
    ...
    */
    public void onPreMeasure(int r5, int r6) {
        ...
        L7a:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.ChatAttachAlertPhotoLayoutPreview.onPreMeasure(int, int):void");
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (themeDelegate != null && (wallpaperDrawable = themeDelegate.getWallpaperDrawable()) != null) {
            ...
            if (currentItemTop < ActionBar.getCurrentActionBarHeight()) {
                currentItemTop -= AndroidUtilities.m1036dp((1.0f - (currentItemTop / ActionBar.getCurrentActionBarHeight())) * i);
            }
    ...
    public class PreviewGroupsView extends ViewGroup {
        ...
        public PreviewGroupsView(Context context) {
            ...
            this.paddingTop = AndroidUtilities.m1036dp(16.0f);
            this.paddingBottom = AndroidUtilities.m1036dp(64.0f);
            ...
            this.scroller = new Runnable() { // from class: org.telegram.ui.Components.ChatAttachAlertPhotoLayoutPreview.PreviewGroupsView.2
                ...
                public void run() {
                    ...
                    float fMax = Math.max(0.0f, (ChatAttachAlertPhotoLayoutPreview.this.draggingCellTouchY - Math.max(0, iComputeVerticalScrollOffset - ChatAttachAlertPhotoLayoutPreview.this.getListTopPadding())) - AndroidUtilities.m1036dp(52.0f));
                    float fMax2 = Math.max(0.0f, ((ChatAttachAlertPhotoLayoutPreview.this.listView.getMeasuredHeight() - (ChatAttachAlertPhotoLayoutPreview.this.draggingCellTouchY - iComputeVerticalScrollOffset)) - ChatAttachAlertPhotoLayoutPreview.this.getListTopPadding()) - AndroidUtilities.m1036dp(84.0f));
                    float fM1036dp2 = AndroidUtilities.m1036dp(32.0f);
                    if (fMax < fM1036dp2 && iComputeVerticalScrollOffset > ChatAttachAlertPhotoLayoutPreview.this.getListTopPadding()) {
                        fM1036dp = (-(1.0f - (fMax / fM1036dp2))) * AndroidUtilities.m1036dp(6.0f);
                    } else {
                        fM1036dp = fMax2 < fM1036dp2 ? AndroidUtilities.m1036dp(6.0f) * (1.0f - (fMax2 / fM1036dp2)) : 0.0f;
                    }
                    int i = (int) fM1036dp;
                    if (Math.abs(i) > 0 && ChatAttachAlertPhotoLayoutPreview.this.listView.canScrollVertically(i) && (fM1036dp <= 0.0f || !z)) {
                        ChatAttachAlertPhotoLayoutPreview.this.draggingCellTouchY += fM1036dp;
            ...
            chatActionCell.setCustomText(LocaleController.getString(C2797R.string.AttachMediaDragHint));
        ...
        public void fromPhotoArrays() {
            ArrayList<PreviewGroupCell> arrayList;
            int i = 0;
            while (true) {
            ...
            int size2 = this.photosOrder.size();
            int i2 = size2 - 1;
            for (int i3 = 0; i3 < size2; i3++) {
                ...
                if (i3 % 10 == 9 || i3 == i2) {
                    ...
                    previewGroupCell.setGroup(ChatAttachAlertPhotoLayoutPreview.this.new GroupCalculator(arrayList2), false);
        ...
        private int measureHeight() {
            return Math.max(measurePureHeight(), (AndroidUtilities.displaySize.y - ActionBar.getCurrentActionBarHeight()) - AndroidUtilities.m1036dp(45.0f));
        }
        ...
        */
        ...
        public PointF dragTranslate() {
            ...
            boolean z = ChatAttachAlertPhotoLayoutPreview.this.draggingCellHiding;
            ChatAttachAlertPhotoLayoutPreview chatAttachAlertPhotoLayoutPreview = ChatAttachAlertPhotoLayoutPreview.this;
            if (!z) {
                RectF rectFRect = chatAttachAlertPhotoLayoutPreview.draggingCell.rect();
                ...
                this.tmpPoint.y = AndroidUtilities.lerp(ChatAttachAlertPhotoLayoutPreview.this.draggingCell.groupCell.f1543y + rectFRect2.top + (rectFRect.height() / 2.0f), (ChatAttachAlertPhotoLayoutPreview.this.draggingCellTouchY - ((ChatAttachAlertPhotoLayoutPreview.this.draggingCellTop - 0.5f) * ChatAttachAlertPhotoLayoutPreview.this.draggingCellFromHeight)) + ChatAttachAlertPhotoLayoutPreview.this.draggingCellGroupY, this.draggingT);
            } else {
                RectF rectFRect3 = chatAttachAlertPhotoLayoutPreview.draggingCell.rect();
                ...
                this.tmpPoint.y = AndroidUtilities.lerp(ChatAttachAlertPhotoLayoutPreview.this.draggingCell.groupCell.f1543y + rectFRect4.top + (rectFRect3.height() / 2.0f), this.savedDragFromY, this.draggingT / this.savedDraggingT);
            }
        ...
        public class C41301 extends AnimatorListenerAdapter {
            public C41301() {
            }
        ...
        public void startDragging(PreviewGroupCell.MediaCell mediaCell) {
            ...
            ChatAttachAlertPhotoLayoutPreview chatAttachAlertPhotoLayoutPreview = ChatAttachAlertPhotoLayoutPreview.this;
            chatAttachAlertPhotoLayoutPreview.draggingCellGroupY = chatAttachAlertPhotoLayoutPreview.draggingCell.groupCell.f1543y;
            ChatAttachAlertPhotoLayoutPreview.this.draggingCellHiding = false;
            this.draggingT = 0.0f;
            invalidate();
            if (ChatAttachAlertPhotoLayoutPreview.this.draggingAnimator != null) {
        ...
        public class RunnableC41312 implements Runnable {
            public RunnableC41312() {
            }
            ...
            public PhotoViewer.PlaceProviderObject getPlaceForPhoto(MessageObject messageObject, TLRPC.FileLocation fileLocation, int i, boolean z, boolean z2) {
                ...
                if (i >= 0 && i < this.photos.size() && isPhotoChecked(i) && (photoEntry = this.photos.get(i)) != null) {
                    ...
                    if (previewGroupCell != null && mediaCell != null) {
                        ...
                        placeProviderObject.viewY = iArr[1] + ((int) previewGroupCell.f1543y);
  ...
  0x0364: PHI (r8v2 int) = (r8v1 int), (r8v12 int) binds: [B:311:0x0241, B:353:0x0363] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        */
        ...
        public class PreviewGroupCell {
            ...
            public /* synthetic */ PreviewGroupCell(PreviewGroupsView previewGroupsView, ChatAttachAlertPhotoLayoutPreviewIA chatAttachAlertPhotoLayoutPreviewIA) {
                this();
            }
            ...
            private PreviewGroupCell() {
                ...
                this.padding = AndroidUtilities.m1036dp(4.0f);
                int iM1036dp = AndroidUtilities.m1036dp(2.0f);
                this.gap = iM1036dp;
                this.halfGap = iM1036dp / 2;
            ...
            public class MediaCell {
                ...
                public /* synthetic */ MediaCell(PreviewGroupCell previewGroupCell, ChatAttachAlertPhotoLayoutPreviewIA chatAttachAlertPhotoLayoutPreviewIA) {
                    this();
                }
                ...
                public void layoutFrom(MediaCell mediaCell) {
                    ...
                    if (rectF2 == null) {
                        ...
                        AndroidUtilities.lerp(rectF2, rectF3, getT(), rectF);
                    }
                    RectF rectF4 = mediaCell.fromRect;
                    if (rectF4 != null) {
                        AndroidUtilities.lerp(rectF4, mediaCell.rect, mediaCell.getT(), this.fromRect);
                ...
                public void layout(GroupCalculator groupCalculator, MessageObject.GroupedMessagePosition groupedMessagePosition, boolean z) {
                    ...
                    float f5 = f3 / f4;
                    float f6 = groupedMessagePosition.f1153pw / i;
                    float f7 = groupedMessagePosition.f1152ph / f4;
                    this.scale = 1.0f;
                    this.rect.set(f2, f5, f6 + f2, f7 + f5);
                    float fM1036dp = AndroidUtilities.m1036dp(2.0f);
                    float fM1036dp2 = AndroidUtilities.m1036dp(SharedConfig.bubbleRadius - 1);
                    RectF rectF4 = this.roundRadiuses;
                    int i2 = this.positionFlags;
                    float f8 = (i2 & 5) == 5 ? fM1036dp2 : fM1036dp;
                    float f9 = (i2 & 6) == 6 ? fM1036dp2 : fM1036dp;
                    float f10 = (i2 & 10) == 10 ? fM1036dp2 : fM1036dp;
                    if ((i2 & 9) == 9) {
                        fM1036dp = fM1036dp2;
                    }
                    rectF4.set(f8, f9, f10, fM1036dp);
                    if (this.fromRect == null) {
                ...
                private void drawPhotoIndex(Canvas canvas, float f, float f2, String str, float f3, float f4) {
                    ...
                    int iM1036dp2 = AndroidUtilities.m1036dp(1.2f);
                    int i = (iM1036dp + iM1036dp2) * 2;
                    int i2 = iM1036dp2 * 4;
                    if (str != null && (this.indexBitmap == null || (str2 = this.indexBitmapText) == null || !str2.equals(str))) {
                        ...
                        this.textPaint.setTextSize(AndroidUtilities.m1036dp(f5));
                        float f6 = i / 2.0f;
                        ...
                        this.strokePaint.setStrokeWidth(iM1036dp2);
                        canvas2.drawCircle(f7, f7, f8, this.strokePaint);
                        canvas2.drawText(str, f6 - (this.textPaint.measureText(str) / 2.0f), f6 + AndroidUtilities.m1036dp(1.0f) + AndroidUtilities.m1036dp(f5 / 4.0f), this.textPaint);
                ...
                private void drawDuration(Canvas canvas, float f, float f2, String str, float f3, float f4) {
                    ...
                    if (str != null) {
                        if (this.videoDurationBitmap == null || (str2 = this.videoDurationBitmapText) == null || !str2.equals(str)) {
                            ...
                            this.videoDurationTextPaint.setTextSize(fM1036dp);
                            float intrinsicWidth = ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.getIntrinsicWidth() + this.videoDurationTextPaint.measureText(str) + AndroidUtilities.m1036dp(15.0f);
                            float fMax = Math.max(fM1036dp, ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.getIntrinsicHeight() + AndroidUtilities.m1036dp(4.0f));
                            ...
                            canvas2.drawRoundRect(rectF, AndroidUtilities.m1036dp(4.0f), AndroidUtilities.m1036dp(4.0f), Theme.chat_timeBackgroundPaint);
                            ...
                            ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.setBounds(iM1036dp, intrinsicHeight, ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.getIntrinsicWidth() + iM1036dp, ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.getIntrinsicHeight() + intrinsicHeight);
                            ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.draw(canvas2);
                            canvas2.drawText(str, AndroidUtilities.m1036dp(18.0f), fM1036dp + AndroidUtilities.m1036dp(-0.7f), this.videoDurationTextPaint);
                ...
                public class C41341 extends AnimatorListenerAdapter {
                    public C41341() {
                    }
            ...
            public void setGroup(GroupCalculator groupCalculator, boolean z) {
                ...
                int i4 = 0;
                while (i4 < size3) {
                    MediaCell mediaCell3 = this.media.get(i4);
            ...
            public void drawStarsButton(Canvas canvas) {
                ...
                rectF.set(((f2 - fM1036dp) / 2.0f) + f, ((f4 - fM1036dp2) / 2.0f) + f3, f + ((f2 + fM1036dp) / 2.0f), f3 + ((f4 + fM1036dp2) / 2.0f));
                this.buttonTextBgPaint.setColor(1610612736);
                float f5 = fM1036dp2 / 2.0f;
                canvas.drawRoundRect(this.buttonTextRect, f5, f5, this.buttonTextBgPaint);
                this.buttonText.draw(canvas, ((this.left + (this.width / 2.0f)) - (fM1036dp / 2.0f)) + AndroidUtilities.m1036dp(14.0f), this.top + (this.height / 2.0f), -1, 1.0f);
            }
        }
    }
