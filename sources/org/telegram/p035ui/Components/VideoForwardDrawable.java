...
public class VideoForwardDrawable extends Drawable {
    ...
    public VideoForwardDrawable(boolean z) {
        ...
        while (true) {
            if (i < playPath.length / 2) {
                ...
                if (i == 0) {
                    int i2 = i * 2;
                    path.moveTo(AndroidUtilities.m1036dp(r0[i2]), AndroidUtilities.m1036dp(r0[i2 + 1]));
                } else {
                    int i3 = i * 2;
                    path.lineTo(AndroidUtilities.m1036dp(r0[i3]), AndroidUtilities.m1036dp(r0[i3 + 1]));
                }
                i++;
            } else {
                this.path1.close();
    ...
    */
    public void draw(android.graphics.Canvas r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.VideoForwardDrawable.draw(android.graphics.Canvas):void");
    }
