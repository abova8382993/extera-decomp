...
public class GestureDetector2 {
        ...
        public void handleMessage(Message message) {
            ...
            if (i == 3) {
                if (GestureDetector2.this.mDoubleTapListener != null) {
                    boolean z = GestureDetector2.this.mStillDown;
                    GestureDetector2 gestureDetector2 = GestureDetector2.this;
                    if (!z) {
                        gestureDetector2.mDoubleTapListener.onSingleTapConfirmed(GestureDetector2.this.mCurrentDownEvent);
                        return;
                    } else {
                        gestureDetector2.mDeferConfirmSingleTap = true;
                        return;
                    }
                }
                return;
    ...
    private void init(Context context) {
        ...
        if (this.mListener == null) {
            g$$ExternalSyntheticBUOutline2.m208m("OnGestureListener must not be null");
            return;
        }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (i3 != 2) {
            ...
            if (this.mIsDoubleTapping) {
                ...
                zOnScroll = onDoubleTapListener4 != null && onDoubleTapListener4.onDoubleTapEvent(motionEvent);
                i2 = 29;
                i = classification;
                z = zHasMessages2;
            } else {
