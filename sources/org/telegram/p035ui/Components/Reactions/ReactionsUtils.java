    ...
    */
    public static void applyForStoryViews(org.telegram.tgnet.TLRPC.Reaction r5, org.telegram.tgnet.TLRPC.Reaction r6, org.telegram.tgnet.tl.TL_stories.StoryViews r7) {
        ...
        L51:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.Reactions.ReactionsUtils.applyForStoryViews(org.telegram.tgnet.TLRPC$Reaction, org.telegram.tgnet.TLRPC$Reaction, org.telegram.tgnet.tl.TL_stories$StoryViews):void");
    }
    ...
    public static void addReactionToEditText(TLRPC.TL_availableReaction tL_availableReaction, HashMap<Long, AnimatedEmojiSpan> map, List<Long> list, Editable editable, SelectAnimatedEmojiDialog selectAnimatedEmojiDialog, Paint.FontMetricsInt fontMetricsInt) {
        ...
        editable.append((CharSequence) createSpannableText(animatedEmojiSpanCreateAnimatedEmojiSpan, tL_availableReaction.reaction));
        if (selectAnimatedEmojiDialog != null) {
            selectAnimatedEmojiDialog.setMultiSelected(Long.valueOf(j), false);
        }
    }

    public static void addReactionToEditText(TLRPC.TL_reactionCustomEmoji tL_reactionCustomEmoji, HashMap<Long, AnimatedEmojiSpan> map, List<Long> list, Editable editable, SelectAnimatedEmojiDialog selectAnimatedEmojiDialog, Paint.FontMetricsInt fontMetricsInt) {
