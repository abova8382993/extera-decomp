...
public class ChatSelectionReactionMenuOverlay extends FrameLayout {
    ...
    private void checkCreateReactionsLayout() {
        if (this.reactionsContainerLayout == null) {
            ...
            reactionsContainerLayout.setPadding(AndroidUtilities.m1036dp(4.0f) + (LocaleController.isRTL ? 0 : this.mSidePadding), AndroidUtilities.m1036dp(4.0f), AndroidUtilities.m1036dp(4.0f) + (LocaleController.isRTL ? this.mSidePadding : 0), AndroidUtilities.m1036dp(this.mPadding));
            this.reactionsContainerLayout.setDelegate(new C48623());
    ...
    public class C48623 implements ReactionsContainerLayout.ReactionsContainerDelegate {
        public C48623() {
        }
            ...
            if (childAt instanceof ChatMessageCell) {
                ...
                if (messageObject.getId() == this.currentPrimaryObject.getId()) {
                    ...
                    if (reactionsContainerLayout != null) {
                        ...
                        this.reactionsContainerLayout.setPadding(AndroidUtilities.m1036dp(4.0f) + ((LocaleController.isRTL || zIsOutOwner) ? 0 : this.mSidePadding), AndroidUtilities.m1036dp(this.mPadding), AndroidUtilities.m1036dp(4.0f) + ((LocaleController.isRTL || zIsOutOwner) ? this.mSidePadding : 0), AndroidUtilities.m1036dp(this.mPadding));
                    }
                    ...
                    float y = (chatMessageCell.getY() + pullingDownOffset) - AndroidUtilities.m1036dp(74.0f);
                    float fM1036dp = AndroidUtilities.m1036dp(14.0f);
                    float fM1036dp2 = height2 - AndroidUtilities.m1036dp(218.0f);
                    FragmentContextView fragmentContextView = this.parentFragment.getFragmentContextView();
                    if (fragmentContextView != null && fragmentContextView.getVisibility() == 0) {
                        fM1036dp += fragmentContextView.getHeight();
                    }
                    float f5 = height;
                    if (y <= fM1036dp - (f5 / 2.0f) || y >= fM1036dp2) {
                        if (y < (fM1036dp - f5) - AndroidUtilities.m1036dp(92.0f) || y > fM1036dp2) {
                            z2 = false;
                        } else {
                            this.translationOffsetY = height + AndroidUtilities.m1036dp(56.0f);
                            this.toOffsetY = 1.0f;
                            z2 = true;
                        }
                        z3 = z2;
                    ...
                    this.reactionsContainerLayout.setTranslationY(MathUtils.clamp(interpolation, fM1036dp, fM1036dp2));
                    ...
                    int iMax = Math.max(0, chatMessageCell.getBackgroundDrawableLeft() - AndroidUtilities.m1036dp(32.0f));
                    int iMax2 = Math.max((int) chatMessageCell.getNonAnimationTranslationX(true), (chatMessageCell.getWidth() - chatMessageCell.getBackgroundDrawableRight()) - AndroidUtilities.m1036dp(32.0f));
                    int iM1036dp = AndroidUtilities.m1036dp(40.0f) * 8;
                    if ((getWidth() - iMax2) - iMax < iM1036dp) {
                        if (zIsOutOwner) {
                            iMax = Math.min(iMax, getWidth() - iM1036dp);
                            iMax2 = 0;
                        } else {
                            iMax2 = Math.min(iMax2, getWidth() - iM1036dp);
                            iMax = 0;
                        }
                    }
