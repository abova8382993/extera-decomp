...
public class ChatCustomReactionsEditActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    /* JADX WARN: Removed duplicated region for block: B:76:0x03a6 A[EDGE_INSN: B:76:0x03a6->B:43:0x03a6 BREAK  A[LOOP:1: B:30:0x0355->B:35:0x0377], SYNTHETIC] */
    ...
    */
    public android.view.View createView(android.content.Context r24) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.Reactions.ChatCustomReactionsEditActivity.createView(android.content.Context):android.view.View");
    }
    ...
    public /* synthetic */ void lambda$createView$6() {
        Browser.openUrl(getContext(), LocaleController.getString(C2797R.string.ChannelEnablePaidReactionsInfoLink));
    }
    ...
    public /* synthetic */ void lambda$createView$7(TLRPC.TL_error tL_error) {
        ...
        BulletinFactory.m1143of(this).createErrorBulletin(pluralString).show();
    }
    ...
    private void initSelectAnimatedEmojiDialog() {
        ...
        C48555 c48555 = new C48555(this, getContext(), false, null, 6, false, getResourceProvider(), 16, Theme.getColor(Theme.key_windowBackgroundWhiteBlackText, getResourceProvider()));
        this.selectAnimatedEmojiDialog = c48555;
        c48555.setAnimationsEnabled(false);
    ...
    public class C48555 extends SelectAnimatedEmojiDialog {
        private boolean firstLayout;

        public C48555(BaseFragment baseFragment, Context context, boolean z, Integer num, int i, boolean z2, Theme.ResourcesProvider resourcesProvider, int i2, int i3) {
        ...
        public void onEmojiSelected(View view, Long l, TLRPC.Document document, TL_stars.TL_starGiftUnique tL_starGiftUnique, Integer num) {
            boolean zContainsKey = ChatCustomReactionsEditActivity.this.selectedEmojisMap.containsKey(l);
            ChatCustomReactionsEditActivity chatCustomReactionsEditActivity = ChatCustomReactionsEditActivity.this;
            if (zContainsKey) {
                chatCustomReactionsEditActivity.selectedEmojisIds.remove(l);
            ...
            int size = chatCustomReactionsEditActivity.selectedEmojisMap.size() - (ChatCustomReactionsEditActivity.this.selectedEmojisMap.containsKey(-1L) ? 1 : 0);
            int i = ChatCustomReactionsEditActivity.this.maxReactionsCount;
            ChatCustomReactionsEditActivity chatCustomReactionsEditActivity2 = ChatCustomReactionsEditActivity.this;
            if (size >= i) {
                BulletinFactory.m1143of(chatCustomReactionsEditActivity2).createErrorBulletin(LocaleController.formatPluralString("ReactionMaxCountError", ChatCustomReactionsEditActivity.this.maxReactionsCount, new Object[0])).show();
                return;
            }
            try {
    ...
    private void setCheckedEnableReactionCell(int i, boolean z, boolean z2) {
        ...
        if (z2) {
            ...
            if (z3) {
                textCheckCell.setBackgroundColorAnimated(true, color);
            } else {
    ...
    public boolean checkChangesBeforeExit(boolean z) {
        ...
        if (z && z3) {
            ...
            builder.setMessage(LocaleController.getString("ReactionApplyChangesDialog", C2797R.string.ReactionApplyChangesDialog));
            builder.setPositiveButton(LocaleController.getString("ApplyTheme", C2797R.string.ApplyTheme), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.Reactions.ChatCustomReactionsEditActivity$$ExternalSyntheticLambda10
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i) {
                    this.f$0.lambda$checkChangesBeforeExit$14(alertDialog, i);
                }
            });
            builder.setNegativeButton(LocaleController.getString(C2797R.string.Discard), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.Reactions.ChatCustomReactionsEditActivity$$ExternalSyntheticLambda11
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i) {
    ...
    public void checkMaxCustomReactions(boolean z) {
        ...
        if (this.boostsStatus.level < size) {
            if (z) {
                BulletinFactory.m1143of(this).createSimpleBulletin(C2797R.raw.chats_infotip, AndroidUtilities.replaceTags(LocaleController.formatPluralString("ReactionReachLvlForReactionShort", size, Integer.valueOf(size)))).show();
            }
        ...
        for (Long l : this.selectedEmojisIds) {
            if (l.longValue() != -1) {
                ...
                while (true) {
                    ...
                    if (l.longValue() == next.activate_animation.f1253id) {
    ...
    public void toggleStarsEnabled() {
        ...
        if (zIsChecked) {
            ...
            final AnimatedEmojiSpan animatedEmojiSpanRemove = this.selectedEmojisMap.remove(-1L);
            if (animatedEmojiSpanRemove != null) {
                animatedEmojiSpanRemove.setRemoved(new Runnable() { // from class: org.telegram.ui.Components.Reactions.ChatCustomReactionsEditActivity$$ExternalSyntheticLambda16
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$toggleStarsEnabled$18(animatedEmojiSpanRemove);
                    }
                });
            }
            animateChangesInNextRows(animatedEmojiSpanRemove);
            ...
            try {
                ...
                SpannableString spannableString = new SpannableString("b");
                AnimatedEmojiSpan animatedEmojiSpan = new AnimatedEmojiSpan(j, null) { // from class: org.telegram.ui.Components.Reactions.ChatCustomReactionsEditActivity.11
                    private final Bitmap bitmap;

                    {
                        Bitmap bitmapCreateBitmap = Bitmap.createBitmap(AndroidUtilities.m1036dp(24.0f), AndroidUtilities.m1036dp(24.0f), Bitmap.Config.ARGB_8888);
                        this.bitmap = bitmapCreateBitmap;
                        Drawable drawableMutate = ChatCustomReactionsEditActivity.this.getContext().getResources().getDrawable(C2797R.drawable.star_small_inner).mutate();
                        drawableMutate.setBounds(0, 0, AndroidUtilities.m1036dp(24.0f), AndroidUtilities.m1036dp(24.0f));
                    ...
                    public void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
                        ...
                        canvas.save();
                        canvas.translate(f, ((i3 + i5) / 2.0f) - AndroidUtilities.m1036dp(12.0f));
                        float f2 = this.extraScale;
                        canvas.scale(f2, f2, f + AndroidUtilities.m1036dp(12.0f), AndroidUtilities.m1036dp(12.0f));
                    ...
                    public int getSize(Paint paint, CharSequence charSequence, int i, int i2, Paint.FontMetricsInt fontMetricsInt) {
                        return super.getSize(paint, charSequence, i, i2, fontMetricsInt) + AndroidUtilities.m1036dp(5.0f);
                    }
                };
