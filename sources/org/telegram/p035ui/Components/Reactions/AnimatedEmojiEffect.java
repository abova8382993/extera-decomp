    ...
    public void setView(View view) {
        ...
        if (strFindAnimatedEmojiEmoticon == null || (tL_availableReaction = MediaDataController.getInstance(this.currentAccount).getReactionsMap().get(strFindAnimatedEmojiEmoticon)) == null || (document = tL_availableReaction.around_animation) == null) {
            ...
            if (z2) {
                ...
                imageReceiver2.setImage(ImageLocation.getForDocument(document), ReactionsEffectOverlay.getFilterForAroundAnimation(), null, null, tL_availableReaction.around_animation, 0);
            }
            z = true;
        }
        if (!z) {
            ...
            if (stickerSetByName != null) {
                ...
                if (z3) {
                    ...
                    imageReceiver3.setImage(ImageLocation.getForDocument(stickerSetByName.documents.get(this.animationIndex)), "60_60", null, null, stickerSetByName.documents.get(this.animationIndex), 0);
                }
                z = true;
            }
        }
        if (z) {
            ...
            this.effectImageReceiver.setImageBitmap(new RLottieDrawable(C2797R.raw.custom_emoji_reaction, _UrlKt.FRAGMENT_ENCODE_SET + C2797R.raw.custom_emoji_reaction, AndroidUtilities.m1036dp(60.0f), AndroidUtilities.m1036dp(60.0f), false, null));
        }
    }
    ...
    public class Particle {
        ...
        public void generate() {
            ...
            if (AnimatedEmojiEffect.this.longAnimation) {
                ...
                float fWidth4 = (r0.bounds.width() * 0.05f) + (AnimatedEmojiEffect.this.bounds.width() * 0.1f * (Math.abs(Utilities.fastRandom.nextInt() % 100) / 100.0f));
