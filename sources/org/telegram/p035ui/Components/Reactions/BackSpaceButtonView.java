...
import org.telegram.p035ui.Stories.RoundRectOutlineProvider;
...
public class BackSpaceButtonView extends FrameLayout {
    ...
    public BackSpaceButtonView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        imageView.setImageResource(C2797R.drawable.smiles_tab_clear);
        ...
        imageView.setContentDescription(LocaleController.getString(C2797R.string.AccDescrBackspace));
        ...
        imageView.setBackground(Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m1036dp(36.0f), getThemedColor(Theme.key_windowBackgroundWhite), Theme.getColor(Theme.key_listSelector)));
        imageView.setOutlineProvider(new RoundRectOutlineProvider(18));
        imageView.setElevation(AndroidUtilities.m1036dp(1.0f));
    ...
    public void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(42.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(42.0f), TLObject.FLAG_30));
    }
