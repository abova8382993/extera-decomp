...
public abstract class CustomReactionEditText extends EditTextCaption {
    ...
    public CustomReactionEditText(Context context, Theme.ResourcesProvider resourcesProvider, int i) {
        ...
        setTextSize(1, 22.0f);
        setGravity(80);
        setPadding(AndroidUtilities.m1036dp(18.0f), AndroidUtilities.m1036dp(4.0f), AndroidUtilities.m1036dp(18.0f), AndroidUtilities.m1036dp(12.0f));
        ...
        setHintColor(getThemedColor(i2));
        setHintTextColor(getThemedColor(i2));
    ...
    public void extendActionMode(ActionMode actionMode, Menu menu) {
        menu.clear();
        int i = C2797R.id.menu_delete;
        menu.add(i, i, 0, LocaleController.getString(C2797R.string.Delete));
    }
