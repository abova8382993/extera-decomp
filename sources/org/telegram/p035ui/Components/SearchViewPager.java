...
import org.telegram.p035ui.Cells.HashtagSearchCell;
...
import org.telegram.p035ui.SearchAdsInfoBottomSheet;
...
public abstract class SearchViewPager extends ViewPagerFixed implements FilteredSearchView.UiCallback, NotificationCenter.NotificationCenterDelegate, IBlur3Capture {
    ...
    public abstract boolean includeDownloads();
    ...
    public SearchViewPager(Context context, DialogsActivity dialogsActivity, int i, int i2, int i3, ChatPreviewDelegate chatPreviewDelegate) {
        ...
        this.dialogsSearchAdapter = new C49491(context, dialogsActivity, i, i2, this.itemAnimator, dialogsActivity.getAllowGlobalSearch(), null, dialogsActivity, context);
        if (i2 == 15) {
            ...
            for (int i4 = 0; i4 < dialogsArray.size(); i4++) {
                arrayList.add(Long.valueOf(dialogsArray.get(i4).f1251id));
            }
        ...
        C49592 c49592 = new RecyclerListView(context) { // from class: org.telegram.ui.Components.SearchViewPager.2
            public C49592(Context context2) {
                super(context2);
            }
        ...
        this.searchListView = c49592;
        c49592.setItemAnimator(this.itemAnimator);
        c49592.setPivotY(0.0f);
        c49592.setClipToPadding(false);
        c49592.setAdapter(this.dialogsSearchAdapter);
        c49592.setVerticalScrollBarEnabled(true);
        c49592.setInstantClick(true);
        c49592.setVerticalScrollbarPosition(LocaleController.isRTL ? 1 : 2);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(context2, 1, false);
        this.searchLayoutManager = linearLayoutManager;
        c49592.setLayoutManager(linearLayoutManager);
        c49592.setAnimateEmptyView(true, 0);
        c49592.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.Components.SearchViewPager.3
            final /* synthetic */ DialogsActivity val$fragment;

            public C49603(DialogsActivity dialogsActivity2) {
        ...
        c49592.addEdgeEffectListener(new SearchViewPager$$ExternalSyntheticLambda3(this));
        ...
        C49614 c49614 = new StickerEmptyView(context2, flickerLoadingView, 1) { // from class: org.telegram.ui.Components.SearchViewPager.4
            public C49614(Context context2, View flickerLoadingView2, int i5) {
                super(context2, flickerLoadingView2, i5);
            }

            @Override // org.telegram.p035ui.Components.StickerEmptyView, android.view.View
        ...
        this.emptyView = c49614;
        c49614.title.setText(LocaleController.getString(C2797R.string.NoResult));
        ...
        this.searchContainer.addView(c49592);
        this.searchContainer.addView(this.noMediaFiltersSearchView);
        c49592.setEmptyView(this.emptyView);
        this.channelsSearchContainer = new FrameLayout(context2);
        C49625 c49625 = new DefaultItemAnimator() { // from class: org.telegram.ui.Components.SearchViewPager.5
            public C49625() {
            }
        ...
        this.channelsItemAnimator = c49625;
        c49625.setSupportsChangeAnimations(false);
        ...
        C49636 c49636 = new StickerEmptyView(context2, flickerLoadingView2, 1) { // from class: org.telegram.ui.Components.SearchViewPager.6
            public C49636(Context context2, View flickerLoadingView22, int i5) {
        ...
        this.channelsEmptyView = c49636;
        c49636.title.setText(LocaleController.getString(C2797R.string.NoResult));
        ...
        C49647 c49647 = new DialogsChannelsAdapter(recyclerListView, context2, this.currentAccount, i3, null) { // from class: org.telegram.ui.Components.SearchViewPager.7
            final /* synthetic */ DialogsActivity val$fragment;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C49647(RecyclerListView recyclerListView2, Context context2, int i5, int i32, Theme.ResourcesProvider resourcesProvider, DialogsActivity dialogsActivity2) {
            ...
            public void update(boolean z) {
                ...
                SearchViewPager searchViewPager = SearchViewPager.this;
                if (zIsEmpty) {
                    searchViewPager.channelsEmptyView.title.setText(LocaleController.getString(C2797R.string.NoChannelsTitle));
                    SearchViewPager.this.channelsEmptyView.subtitle.setVisibility(0);
                    SearchViewPager.this.channelsEmptyView.subtitle.setText(LocaleController.getString(C2797R.string.NoChannelsMessage));
                } else {
                    searchViewPager.channelsEmptyView.title.setText(LocaleController.getString(C2797R.string.NoResult));
                    SearchViewPager.this.channelsEmptyView.subtitle.setVisibility(8);
                }
            }

            @Override // org.telegram.p035ui.Components.DialogsChannelsAdapter
            public void hideKeyboard() {
                AndroidUtilities.hideKeyboard(dialogsActivity.getParentActivity().getCurrentFocus());
            }
        };
        this.channelsSearchAdapter = c49647;
        recyclerListView2.setAdapter(c49647);
        recyclerListView2.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.Components.SearchViewPager.8
            ...
            public C49658(DialogsActivity dialogsActivity2) {
                dialogsActivity = dialogsActivity2;
            }
        ...
        C49669 c49669 = new DefaultItemAnimator() { // from class: org.telegram.ui.Components.SearchViewPager.9
            public C49669() {
            }
        ...
        this.botsItemAnimator = c49669;
        c49669.setSupportsChangeAnimations(false);
        ...
        C495010 c495010 = new StickerEmptyView(context2, flickerLoadingView3, 1) { // from class: org.telegram.ui.Components.SearchViewPager.10
            public C495010(Context context2, View flickerLoadingView32, int i5) {
        ...
        this.botsEmptyView = c495010;
        c495010.title.setText(LocaleController.getString(C2797R.string.NoResult));
        ...
        C495111 c495111 = new DialogsBotsAdapter(recyclerListView2, context2, this.currentAccount, i32, false, null) { // from class: org.telegram.ui.Components.SearchViewPager.11
            final /* synthetic */ DialogsActivity val$fragment;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C495111(RecyclerListView recyclerListView22, Context context2, int i5, int i32, boolean z, Theme.ResourcesProvider resourcesProvider, DialogsActivity dialogsActivity2) {
            ...
            public void update(boolean z) {
                ...
                SearchViewPager.this.botsEmptyView.title.setText(LocaleController.getString(C2797R.string.NoResult));
                SearchViewPager.this.botsEmptyView.subtitle.setVisibility(8);
            }
        };
        this.botsSearchAdapter = c495111;
        recyclerListView22.setAdapter(c495111);
        recyclerListView22.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.Components.SearchViewPager.12
            ...
            public C495212(DialogsActivity dialogsActivity2) {
                dialogsActivity = dialogsActivity2;
            }
        ...
        C495313 c495313 = new DefaultItemAnimator() { // from class: org.telegram.ui.Components.SearchViewPager.13
            public C495313() {
            }
        ...
        this.hashtagItemAnimator = c495313;
        c495313.setSupportsChangeAnimations(false);
        ...
        C495414 c495414 = new StickerEmptyView(context2, flickerLoadingView4, 1) { // from class: org.telegram.ui.Components.SearchViewPager.14
            public C495414(Context context2, View flickerLoadingView42, int i5) {
        ...
        this.hashtagEmptyView = c495414;
        c495414.title.setText(LocaleController.getString(C2797R.string.NoResult));
        ...
        C495515 c495515 = new HashtagsSearchAdapter(recyclerListView3, context2, this.currentAccount, i32, null) { // from class: org.telegram.ui.Components.SearchViewPager.15
            public C495515(RecyclerListView recyclerListView32, Context context2, int i5, int i32, Theme.ResourcesProvider resourcesProvider) {
            ...
            public void update(boolean z) {
                ...
                SearchViewPager.this.hashtagEmptyView.title.setText(LocaleController.getString(C2797R.string.NoResult));
                SearchViewPager.this.hashtagEmptyView.subtitle.setVisibility(8);
            }

            @Override // org.telegram.p035ui.Components.HashtagsSearchAdapter
        ...
        this.hashtagSearchAdapter = c495515;
        recyclerListView32.setAdapter(c495515);
        recyclerListView32.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.Components.SearchViewPager.16
            ...
            public C495616(DialogsActivity dialogsActivity2) {
                dialogsActivity = dialogsActivity2;
            }
        ...
        this.itemsEnterAnimator = new RecyclerItemsEnterAnimator(c49592, true);
    ...
    public class C49491 extends DialogsSearchAdapter {
        final /* synthetic */ Context val$context;
        final /* synthetic */ DialogsActivity val$fragment;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C49491(Context context, DialogsActivity dialogsActivity, int i, int i2, DefaultItemAnimator defaultItemAnimator, boolean z, Theme.ResourcesProvider resourcesProvider, DialogsActivity dialogsActivity2, Context context2) {
        ...
        @Override // org.telegram.p035ui.Adapters.DialogsSearchAdapter
        ...
        public void openBotApp(TLRPC.User user) {
            ...
            if (SearchViewPager.this.parent != null) {
            ...
            putRecentSearch(user.f1407id, user);
        }

        @Override // org.telegram.p035ui.Adapters.DialogsSearchAdapter
        public void openSponsoredOptions(ProfileSearchCell profileSearchCell, final TLRPC.TL_sponsoredPeer tL_sponsoredPeer) {
            ...
            if (!TextUtils.isEmpty(tL_sponsoredPeer.sponsor_info) || !TextUtils.isEmpty(tL_sponsoredPeer.additional_info)) {
                final ItemOptions itemOptionsAddGap = itemOptionsMakeOptions.makeSwipeback().add(C2797R.drawable.ic_ab_back, LocaleController.getString(C2797R.string.Back), new Runnable() { // from class: org.telegram.ui.Components.SearchViewPager$1$$ExternalSyntheticLambda0
                ...
                itemOptionsMakeOptions.add(C2797R.drawable.msg_channel, LocaleController.getString(C2797R.string.SponsoredMessageSponsorReportable), new Runnable() { // from class: org.telegram.ui.Components.SearchViewPager$1$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
            ...
            int i = C2797R.drawable.msg_info;
            String string = LocaleController.getString(C2797R.string.AboutRevenueSharingAds);
            ...
            int i2 = C2797R.drawable.msg_block2;
            String string2 = LocaleController.getString(C2797R.string.ReportAd);
            ...
            int i3 = C2797R.drawable.msg_cancel;
            String string3 = LocaleController.getString(C2797R.string.RemoveAds);
        ...
        public /* synthetic */ void lambda$openSponsoredOptions$2(DialogsActivity dialogsActivity) {
            removeAllAds();
            BulletinFactory.m1143of(dialogsActivity).createAdReportedBulletin(LocaleController.getString(C2797R.string.AdHidden)).show();
        }
    ...
    public class C49592 extends RecyclerListView {
        public C49592(Context context2) {
            super(context2);
        }
    ...
    public class C49603 extends RecyclerView.OnScrollListener {
        final /* synthetic */ DialogsActivity val$fragment;
    ...
    public class C49614 extends StickerEmptyView {
        public C49614(Context context2, View flickerLoadingView2, int i5) {
            super(context2, flickerLoadingView2, i5);
        }
    ...
    public class C49625 extends DefaultItemAnimator {
        public C49625() {
        }
    ...
    public class C49636 extends StickerEmptyView {
        public C49636(Context context2, View flickerLoadingView22, int i5) {
            super(context2, flickerLoadingView22, i5);
        }
    ...
    public class C49647 extends DialogsChannelsAdapter {
        final /* synthetic */ DialogsActivity val$fragment;
    ...
    public class C49658 extends RecyclerView.OnScrollListener {
        final /* synthetic */ DialogsActivity val$fragment;
    ...
    public class C49669 extends DefaultItemAnimator {
        public C49669() {
        }
    ...
    public class C495010 extends StickerEmptyView {
        public C495010(Context context2, View flickerLoadingView32, int i5) {
            super(context2, flickerLoadingView32, i5);
        }
    ...
    public class C495111 extends DialogsBotsAdapter {
        final /* synthetic */ DialogsActivity val$fragment;
    ...
    public class C495212 extends RecyclerView.OnScrollListener {
        final /* synthetic */ DialogsActivity val$fragment;
    ...
    public class C495313 extends DefaultItemAnimator {
        public C495313() {
        }
    ...
    public class C495414 extends StickerEmptyView {
        public C495414(Context context2, View flickerLoadingView42, int i5) {
            super(context2, flickerLoadingView42, i5);
        }
    ...
    public class C495515 extends HashtagsSearchAdapter {
        public C495515(RecyclerListView recyclerListView32, Context context2, int i5, int i32, Theme.ResourcesProvider resourcesProvider) {
            super(recyclerListView32, context2, i5, i32, resourcesProvider);
        }
    ...
    public class C495616 extends RecyclerView.OnScrollListener {
        final /* synthetic */ DialogsActivity val$fragment;
    ...
    public class C495717 extends RecyclerView.OnScrollListener {
        public C495717() {
        }
    ...
    public void search(View view, int i, String str, boolean z) {
        ...
        if (zIsEmpty) {
            ...
            stickerEmptyView.subtitle.setVisibility(0);
            this.emptyView.subtitle.setText(LocaleController.formatString(C2797R.string.NoResultFoundFor2, str));
        }
        ...
        for (int i3 = 0; i3 < this.currentSearchFilters.size(); i3++) {
            ...
            if (i4 == 4) {
                ...
                if (tLObject instanceof TLRPC.User) {
                    j = ((TLRPC.User) tLObject).f1407id;
                } else if (tLObject instanceof TLRPC.Chat) {
                    j = -((TLRPC.Chat) tLObject).f1245id;
                }
                j2 = j;
            } else if (i4 == 6) {
        ...
        if (view == this.hashtagSearchContainer) {
            ...
            this.hashtagEmptyView.setKeyboardHeight(this.keyboardSize, z2);
            return;
        }
        if (view == this.searchContainer) {
            if ((j2 == 0 && j5 == 0 && j4 == 0) || j3 != 0) {
                this.lastSearchScrolledToTop = false;
                this.dialogsSearchAdapter.searchDialogs(str, i2, true);
                ...
                } else if (filteredSearchView.getVisibility() != 8) {
                ...
                this.noMediaFiltersSearchView.search(j2, j5, j4, null, i2, str, z3);
                this.emptyView.setVisibility(8);
            }
        ...
        if (view instanceof FilteredSearchView) {
            FilteredSearchView filteredSearchView3 = (FilteredSearchView) view;
            filteredSearchView3.setUseFromUserAsAvatar(j3 != 0);
            filteredSearchView3.setKeyboardHeight(this.keyboardSize, false);
            filteredSearchView3.search(j2, j6, j4, FiltersView.filters[this.viewPagerAdapter.items.get(i).filterIndex], z4, str, z);
            return;
        }
    ...
    public class C495818 extends AnimatorListenerAdapter {
        public C495818() {
        }
    ...
    private void showActionMode(boolean z) {
        ...
        if (z && !this.parent.getActionBar().actionModeIsExist("search_view_pager")) {
            ...
            ActionBarMenuItem actionBarMenuItemAddItemWithWidth = this.actionMode.addItemWithWidth(203, C2797R.drawable.avd_speed, AndroidUtilities.m1036dp(54.0f), LocaleController.getString(C2797R.string.AccDescrPremiumSpeed));
            ...
            this.gotoItem = this.actionMode.addItemWithWidth(200, C2797R.drawable.msg_message, AndroidUtilities.m1036dp(54.0f), LocaleController.getString(C2797R.string.AccDescrGoToMessage));
            ActionBarMenuItem actionBarMenuItemAddItemWithWidth2 = this.actionMode.addItemWithWidth(201, C2797R.drawable.msg_forward, AndroidUtilities.m1036dp(54.0f), LocaleController.getString(C2797R.string.Forward));
            ...
            this.deleteItem = this.actionMode.addItemWithWidth(Opcodes.REM_FLOAT_2ADDR, C2797R.drawable.msg_delete, AndroidUtilities.m1036dp(54.0f), LocaleController.getString(C2797R.string.Delete));
        }
        if (this.selectedMessagesCountTextView != null) {
            DialogsSearchAdapter dialogsSearchAdapter = this.dialogsSearchAdapter;
            ((ViewGroup.MarginLayoutParams) this.selectedMessagesCountTextView.getLayoutParams()).leftMargin = AndroidUtilities.m1036dp((this.parent.hasMainTabs ? 18 : 72) + (dialogsSearchAdapter != null && (dialogsSearchAdapterDelegate = dialogsSearchAdapter.delegate) != null && (dialogsSearchAdapterDelegate.getSearchForumDialogId() > 0L ? 1 : (dialogsSearchAdapterDelegate.getSearchForumDialogId() == 0L ? 0 : -1)) != 0 ? 56 : 0));
        ...
        dialogsActivity.getActionBar().hideActionMode();
    ...
    public void onActionBarItemClick(int i) {
        if (i == 202) {
            ...
            spannableStringBuilder.append((CharSequence) AndroidUtilities.replaceTags(LocaleController.formatPluralString("RemoveDocumentsMessage", this.selectedFiles.size(), new Object[0]))).append((CharSequence) "\n\n").append((CharSequence) LocaleController.getString(C2797R.string.RemoveDocumentsAlertMessage));
            builder.setMessage(spannableStringBuilder);
            builder.setNegativeButton(LocaleController.getString(C2797R.string.Cancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.SearchViewPager$$ExternalSyntheticLambda0
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i2) {
                    alertDialog.dismiss();
                }
            });
            builder.setPositiveButton(LocaleController.getString(C2797R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.SearchViewPager$$ExternalSyntheticLambda1
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i2) {
        ...
        if (arrayList.size() > 1 || ((MessagesStorage.TopicKey) arrayList.get(0)).dialogId == AccountInstance.getInstance(this.currentAccount).getUserConfig().getClientUserId() || charSequence != null) {
            ...
            while (i3 < arrayList.size()) {
                ...
                if (charSequence != null) {
                    j = j2;
                    AccountInstance.getInstance(this.currentAccount).getSendMessagesHelper().sendMessage(SendMessagesHelper.SendMessageParams.m1075of(charSequence.toString(), j, null, null, null, true, null, null, null, true, 0, 0, null, false));
                } else {
                    j = j2;
                }
    ...
    public void toggleItemSelection(MessageObject messageObject, View view, int i) {
        ...
        boolean zContainsKey = this.selectedFiles.containsKey(messageHashId);
        HashMap<FilteredSearchView.MessageHashId, MessageObject> map = this.selectedFiles;
        if (zContainsKey) {
    ...
    public void onItemSelected(View view, View view2, int i, int i2) {
        if (i == 0) {
            int visibility = this.noMediaFiltersSearchView.getVisibility();
            FilteredSearchView filteredSearchView = this.noMediaFiltersSearchView;
            if (visibility == 0) {
                filteredSearchView.setDelegate(this.filteredSearchViewDelegate, false);
                this.dialogsSearchAdapter.setFiltersDelegate(null, false);
            } else {
                filteredSearchView.setDelegate(null, false);
    ...
    */
    public void messagesDeleted(long r11, java.util.ArrayList<java.lang.Integer> r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p035ui.Components.SearchViewPager.messagesDeleted(long, java.util.ArrayList):void");
    }
    ...
    public class ViewPagerAdapter extends ViewPagerFixed.Adapter {
        ...
        public CharSequence getItemTitle(int i) {
            ...
            if (this.items.get(i).type == 1) {
                return LocaleController.getString(C2797R.string.ChannelsTab);
            }
            if (this.items.get(i).type == 4) {
                return LocaleController.getString(C2797R.string.AppsTab);
            }
            if (this.items.get(i).type == 6) {
                if (SearchViewPager.this.postsAreNew) {
                    return PremiumPreviewFragment.applyNewSpan(LocaleController.getString(C2797R.string.SearchPosts));
                }
                return LocaleController.getString(C2797R.string.SearchPosts);
            }
            if (this.items.get(i).type == 2) {
                return LocaleController.getString(C2797R.string.DownloadsTabs);
            }
            if (this.items.get(i).type == 5) {
                return LocaleController.getString(C2797R.string.PublicPostsTabs);
            }
        ...
        /* JADX INFO: loaded from: classes7.dex */
        public class C49671 extends RecyclerView.OnScrollListener {
            public C49671() {
            }
        ...
        /* JADX INFO: loaded from: classes7.dex */
        public class C49682 extends RecyclerView.OnScrollListener {
            public C49682() {
            }
        ...
        public class Item {
            ...
            public /* synthetic */ Item(ViewPagerAdapter viewPagerAdapter, int i, SearchViewPagerIA searchViewPagerIA) {
                this(i);
            }
