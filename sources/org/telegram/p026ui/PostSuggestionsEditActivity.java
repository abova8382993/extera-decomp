...
public class PostSuggestionsEditActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2702R.string.PostSuggestions));
        ...
        linkActionView.setPadding(AndroidUtilities.m1081dp(16.0f), AndroidUtilities.m1081dp(12.0f), AndroidUtilities.m1081dp(16.0f), 0);
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        arrayList.add(UItem.asTopView(LocaleController.getString(C2702R.string.AllowPostSuggestionsHint2), C2702R.raw.bubble));
        arrayList.add(UItem.asCheck(1, LocaleController.getString(C2702R.string.AllowPostSuggestions)).setChecked(this.isSuggestionsEnabled));
        arrayList.add(UItem.asShadow(2, null));
        if (this.isSuggestionsEnabled) {
            arrayList.add(UItem.asHeader(LocaleController.getString(C2702R.string.PriceForEachSuggestion)));
            ...
            arrayList.add(UItem.asHeader(LocaleController.getString(C2702R.string.ChannelLinkDirectMessages)));
    ...
    */
    public /* synthetic */ void lambda$fillItems$1(java.lang.Integer r7) {
        /*
            ...
            boolean r0 = r7 instanceof org.telegram.p026ui.Cells.TextInfoPrivacyCell
            r1 = 1
            if (r0 == 0) goto L2b
            org.telegram.ui.Cells.TextInfoPrivacyCell r7 = (org.telegram.p026ui.Cells.TextInfoPrivacyCell) r7
        ...
        L32:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.PostSuggestionsEditActivity.lambda$fillItems$1(java.lang.Integer):void");
    }

    private CharSequence getIncomeInfo() {
        int i = getMessagesController().starsPaidMessageCommissionPermille;
        return LocaleController.formatString(C2702R.string.PostSuggestionsPriceInfo2, AffiliateProgramFragment.percents(i), String.valueOf(((double) ((int) ((((double) (this.suggestionsStarsCount * (i / 1000.0f))) / 1000.0d) * ((double) getMessagesController().starsUsdWithdrawRate1000)))) / 100.0d));
    }
    ...
    public boolean onBackPressed(boolean z) {
        ...
        builder.setMessage(LocaleController.getString(C2702R.string.MessageSuggestionsUnsavedChanges));
        builder.setPositiveButton(LocaleController.getString(C2702R.string.ApplyTheme), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.PostSuggestionsEditActivity$$ExternalSyntheticLambda0
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
                this.f$0.lambda$onBackPressed$4(alertDialog, i);
            }
        });
        builder.setNegativeButton(LocaleController.getString(C2702R.string.Discard), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.PostSuggestionsEditActivity$$ExternalSyntheticLambda1
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
