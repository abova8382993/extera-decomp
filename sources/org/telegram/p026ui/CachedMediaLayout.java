...
public abstract class CachedMediaLayout extends FrameLayout implements NestedSizeNotifierLayout.ChildLayout {
    ...
    public CachedMediaLayout(Context context, BaseFragment baseFragment) {
        ...
        pageArr[0] = new Page(LocaleController.getString(C2702R.string.FilterChats), 0, new DialogsAdapter());
        this.allPages[1] = new Page(LocaleController.getString(C2702R.string.MediaTab), 1, new MediaAdapter(false));
        this.allPages[2] = new Page(LocaleController.getString(C2702R.string.SharedFilesTab2), 2, new DocumentsAdapter());
        this.allPages[3] = new Page(LocaleController.getString(C2702R.string.Music), 3, new MusicAdapter());
        int i = 0;
        while (true) {
            ...
            if (i < pageArr2.length) {
                ...
                View c31001 = new View(getContext()) { // from class: org.telegram.ui.CachedMediaLayout.1
                    C31001(Context context2) {
                        super(context2);
                    }
                ...
                this.divider = c31001;
                addView(c31001, LayoutHelper.createFrame(-1, 1.0f, 0, 0.0f, 48.0f, 0.0f, 0.0f));
                c31001.getLayoutParams().height = 1;
                this.viewPagerFixed.setAdapter(new C31012(context, baseFragment));
                ...
                imageView.setContentDescription(LocaleController.getString(C2702R.string.Close));
                linearLayout.addView(imageView, new LinearLayout.LayoutParams(AndroidUtilities.m1081dp(54.0f), -1));
                ...
                animatedTextView.setTextSize(AndroidUtilities.m1081dp(18.0f));
                ...
                actionBarMenuItem.setIcon(C2702R.drawable.msg_clear);
                actionBarMenuItem.setContentDescription(LocaleController.getString(C2702R.string.Delete));
                actionBarMenuItem.setDuplicateParentStateEnabled(false);
                linearLayout.addView(actionBarMenuItem, new LinearLayout.LayoutParams(AndroidUtilities.m1081dp(54.0f), -1));
    ...
    class C31012 extends ViewPagerFixed.Adapter {
        ...
        C31012(Context context, BaseFragment baseFragment) {
        ...
        public View createView(int i) {
            ...
            recyclerListView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.telegram.ui.CachedMediaLayout.2.1
                ...
                AnonymousClass1(final RecyclerListView recyclerListView2) {
                ...
                public void onItemClick(View view, int i2) {
                    ...
                    if (view instanceof SharedPhotoVideoCell2) {
                        ...
                        if (mediaAdapter.isStories) {
                            ...
                            tL_storyItem.f1807id = Objects.hash(fileInfo.file.getAbsolutePath());
                            tL_storyItem.attachPath = itemInner.file.file.getAbsolutePath();
                            tL_storyItem.date = -1;
                            C31012.this.val$parentFragment.getOrCreateStoryViewer().open(C31012.this.val$context, tL_storyItem, StoriesListPlaceProvider.m1269of(recyclerListView));
                            return;
                        }
        ...
        public /* synthetic */ boolean lambda$createView$5(final RecyclerListView recyclerListView, final BaseFragment baseFragment, final View view, int i, float f, float f2) {
            ...
            if ((view instanceof CacheCell) || (view instanceof SharedPhotoVideoCell2)) {
                ...
                if (view instanceof SharedPhotoVideoCell2) {
                    ActionBarMenuItem.addItem(actionBarPopupWindowLayout, C2702R.drawable.msg_view_file, LocaleController.getString(C2702R.string.CacheOpenFile), false, null).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CachedMediaLayout$2$$ExternalSyntheticLambda1
                        @Override // android.view.View.OnClickListener
                    ...
                    ActionBarMenuItem.addItem(actionBarPopupWindowLayout, C2702R.drawable.msg_played, LocaleController.getString(C2702R.string.PlayFile), false, null).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CachedMediaLayout$2$$ExternalSyntheticLambda2
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view2) {
                    ...
                    ActionBarMenuItem.addItem(actionBarPopupWindowLayout, C2702R.drawable.msg_view_file, LocaleController.getString(C2702R.string.CacheOpenFile), false, null).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CachedMediaLayout$2$$ExternalSyntheticLambda3
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view2) {
                ...
                if (fileInfo.dialogId != 0 && fileInfo.messageId != 0) {
                    ActionBarMenuItem.addItem(actionBarPopupWindowLayout, C2702R.drawable.msg_viewintopic, LocaleController.getString(C2702R.string.ViewInChat), false, null).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CachedMediaLayout$2$$ExternalSyntheticLambda4
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view2) {
                ...
                ActionBarMenuItem.addItem(actionBarPopupWindowLayout, C2702R.drawable.msg_select, LocaleController.getString(!CachedMediaLayout.this.cacheModel.selectedFiles.contains(itemInner.file) ? C2702R.string.Select : C2702R.string.Deselect), false, null).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CachedMediaLayout$2$$ExternalSyntheticLambda5
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view2) {
    ...
    private class Page {
        ...
        /* synthetic */ Page(CachedMediaLayout cachedMediaLayout, String str, int i, BaseAdapter baseAdapter, CachedMediaLayoutIA cachedMediaLayoutIA) {
    ...
    private class DialogsAdapter extends BaseAdapter {
        ...
        /* synthetic */ DialogsAdapter(CachedMediaLayout cachedMediaLayout, CachedMediaLayoutIA cachedMediaLayoutIA) {
            this();
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (dialogFileEntities.dialogId == Long.MAX_VALUE) {
                dialogPhotoTitle = LocaleController.getString(C2702R.string.CacheOtherChats);
    ...
    private class MediaAdapter extends BaseFilesAdapter {
        ...
        /* synthetic */ MediaAdapter(CachedMediaLayout cachedMediaLayout, boolean z, CachedMediaLayoutIA cachedMediaLayoutIA) {
            this(z);
        }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            C31031 c31031 = new SharedPhotoVideoCell2(viewGroup.getContext(), this.sharedResources, CachedMediaLayout.this.parentFragment.getCurrentAccount()) { // from class: org.telegram.ui.CachedMediaLayout.MediaAdapter.1
                C31031(Context context, SharedPhotoVideoCell2.SharedResources sharedResources, int i2) {
                    super(context, sharedResources, i2);
                }

                @Override // org.telegram.p026ui.Cells.SharedPhotoVideoCell2
            ...
            c31031.setStyle(1);
            return new RecyclerListView.Holder(c31031);
        }

        /* JADX INFO: renamed from: org.telegram.ui.CachedMediaLayout$MediaAdapter$1 */
        class C31031 extends SharedPhotoVideoCell2 {
            C31031(Context context, SharedPhotoVideoCell2.SharedResources sharedResources, int i2) {
                super(context, sharedResources, i2);
            }
    ...
    private class DocumentsAdapter extends BaseFilesAdapter {
        ...
        /* synthetic */ DocumentsAdapter(CachedMediaLayout cachedMediaLayout, CachedMediaLayoutIA cachedMediaLayoutIA) {
            this();
        }
        ...
        class C31021 extends CacheCell {
            C31021(Context context) {
                super(context);
            }
        ...
        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            C31021 c31021 = new CacheCell(viewGroup.getContext()) { // from class: org.telegram.ui.CachedMediaLayout.DocumentsAdapter.1
                C31021(Context context) {
                    super(context);
                }
            ...
            c31021.type = 2;
            c31021.container.addView(new SharedDocumentCell(viewGroup.getContext(), 3, null));
            return new RecyclerListView.Holder(c31021);
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            sharedDocumentCell.setTextAndValueAndTypeAndThumb(fileInfo.messageType == 5 ? LocaleController.getString(C2702R.string.AttachRound) : fileInfo.file.getName(), LocaleController.formatDateAudio(fileInfo.file.lastModified() / 1000, true), Utilities.getExtension(fileInfo.file.getName()), null, 0, z2);
            if (!z) {
                sharedDocumentCell.setPhoto(fileInfo.file.getPath());
            }
            sharedDocumentCell.getImageView().setRoundRadius(AndroidUtilities.m1081dp(fileInfo.messageType == 5 ? 20.0f : 4.0f));
    ...
    private class MusicAdapter extends BaseFilesAdapter {
        /* synthetic */ MusicAdapter(CachedMediaLayout cachedMediaLayout, CachedMediaLayoutIA cachedMediaLayoutIA) {
            this();
        }
        ...
        class C31041 extends CacheCell {
            C31041(Context context) {
                super(context);
            }
        ...
        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            C31041 c31041 = new CacheCell(viewGroup.getContext()) { // from class: org.telegram.ui.CachedMediaLayout.MusicAdapter.1
                C31041(Context context) {
                    super(context);
                }
            ...
            c31041.type = 3;
            C31052 c31052 = new SharedAudioCell(viewGroup.getContext(), 0, null) { // from class: org.telegram.ui.CachedMediaLayout.MusicAdapter.2
                final /* synthetic */ CacheCell val$cacheCell;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C31052(Context context, int i2, Theme.ResourcesProvider resourcesProvider, CacheCell c310412) {
            ...
            c31052.setCheckForButtonPress(true);
            c310412.container.addView(c31052);
            return new RecyclerListView.Holder(c310412);
        }

        /* JADX INFO: renamed from: org.telegram.ui.CachedMediaLayout$MusicAdapter$2 */
        class C31052 extends SharedAudioCell {
            final /* synthetic */ CacheCell val$cacheCell;
    ...
    */
    public /* synthetic */ void lambda$checkMessageObjectForAudio$3(final org.telegram.ui.Storage.CacheModel.FileInfo r12, final org.telegram.tgnet.TLRPC.TL_documentAttributeAudio r13) throws java.lang.Throwable {
        ...
        L35:
            ...
            goto L30
        L37:
            org.telegram.messenger.FileLog.m1093e(r0)     // Catch: java.lang.Throwable -> L32
            if (r2 == 0) goto L3f
        ...
        L52:
            throw r12
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.CachedMediaLayout.lambda$checkMessageObjectForAudio$3(org.telegram.ui.Storage.CacheModel$FileInfo, org.telegram.tgnet.TLRPC$TL_documentAttributeAudio):void");
    }
    ...
    public interface Delegate {
        ...
        /* JADX INFO: renamed from: org.telegram.ui.CachedMediaLayout$Delegate$-CC */
    ...
    private class BasePlaceProvider extends PhotoViewer.EmptyPhotoViewerProvider {
        ...
        /* synthetic */ BasePlaceProvider(CachedMediaLayout cachedMediaLayout, CachedMediaLayoutIA cachedMediaLayoutIA) {
            this();
        }
    ...
    class CacheCell extends FrameLayout {
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            if (this.drawDivider) {
                if (LocaleController.isRTL) {
                    canvas.drawLine(0.0f, getMeasuredHeight() - 1, getMeasuredWidth() - AndroidUtilities.m1081dp(48.0f), getMeasuredHeight() - 1, Theme.dividerPaint);
                } else {
                    canvas.drawLine(getMeasuredWidth() - AndroidUtilities.m1081dp(90.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, Theme.dividerPaint);
                }
            }
        }
    }
