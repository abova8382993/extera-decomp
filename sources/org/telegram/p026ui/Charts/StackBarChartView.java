...
import org.telegram.p026ui.Charts.view_data.StackBarViewData;
...
public class StackBarChartView extends BaseChartView {
    ...
    protected void drawChart(Canvas canvas) {
        ...
        if (i5 == 2) {
            ...
            f4 = 1.0f - f14;
            f3 = 2.0f;
            canvas2.scale((f14 * 2.0f) + 1.0f, 1.0f, transitionParams.f1867pX, transitionParams.f1868pY);
        } else {
            f3 = 2.0f;
            if (i5 == 1) {
                TransitionParams transitionParams2 = this.transitionParams;
                f4 = transitionParams2.progress;
                canvas2.scale(f4, 1.0f, transitionParams2.f1867pX, transitionParams2.f1868pY);
            } else {
        ...
        if (z) {
            ...
            while (i12 < this.lines.size()) {
                ...
                if (lineViewData2.enabled || lineViewData2.alpha != f19) {
                    long[] jArr2 = lineViewData2.line.f1866y;
    ...
    protected void selectXOnChart(int i, int i2) {
        ...
        if (f3 < 0.0f) {
            ...
            this.selectedIndex = ((StackBarChartData) chartData).f1864x.length - 1;
    ...
    protected void drawPickerChart(Canvas canvas) {
        ...
        if (chartData != null) {
            ...
            while (i4 < length) {
                ...
                while (true) {
                    ...
                    if (lineViewData.enabled || lineViewData.alpha != 0.0f) {
                        long j = lineViewData.line.f1866y[i4];
            ...
            for (int i12 = 0; i12 < size; i12++) {
                ...
                lineViewData3.paint.setAlpha(Function.USE_VARARGS);
    ...
    public void onCheckChanged() {
        int length = ((ChartData.Line) ((StackBarChartData) this.chartData).lines.get(0)).f1866y.length;
        ...
        for (int i = 0; i < length; i++) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                if (((StackBarViewData) this.lines.get(i2)).enabled) {
                    ...
                    jArr[i] = jArr[i] + ((ChartData.Line) ((StackBarChartData) chartData).lines.get(i2)).f1866y[i];
                }
            }
        }
        ChartData chartData2 = this.chartData;
    ...
    protected void updatePickerMinMaxHeight() {
        if (BaseChartView.ANIMATE_PICKER_SIZES) {
            int length = ((StackBarChartData) this.chartData).f1864x.length;
            int size = this.lines.size();
            long j = 0;
            for (int i = 0; i < length; i++) {
                long j2 = 0;
                for (int i2 = 0; i2 < size; i2++) {
                    ...
                    if (stackBarViewData.enabled) {
                        j2 += stackBarViewData.line.f1866y[i];
                    }
                }
                if (j2 > j) {
                    j = j2;
    ...
    protected void initPickerMaxHeight() {
        ...
        for (int i = 0; i < length; i++) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                StackBarViewData stackBarViewData = (StackBarViewData) this.lines.get(i2);
                if (stackBarViewData.enabled) {
                    j += stackBarViewData.line.f1866y[i];
                }
            }
            float f = j;
