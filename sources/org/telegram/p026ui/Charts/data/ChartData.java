    ...
    public ChartData(JSONObject jSONObject) throws JSONException {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            ...
            if (jSONArray2.getString(0).equals("x")) {
                ...
                this.f1864x = new long[length];
                int i2 = 0;
                while (i2 < length) {
                    int i3 = i2 + 1;
                    this.f1864x[i2] = jSONArray2.getLong(i3);
                    i2 = i3;
                }
            } else {
                Line line = new Line();
                ...
                line.f1865id = jSONArray2.getString(0);
                line.f1866y = new long[length2];
                int i4 = 0;
                while (i4 < length2) {
                    int i5 = i4 + 1;
                    line.f1866y[i4] = jSONArray2.getLong(i5);
                    long j = line.f1866y[i4];
                    if (j > line.maxValue) {
                        line.maxValue = j;
                    }
                    if (j < line.minValue) {
        ...
        for (int i6 = 0; i6 < this.lines.size(); i6++) {
            ...
            if (jSONObjectOptJSONObject != null) {
                Matcher matcher = patternCompile.matcher(jSONObjectOptJSONObject.getString(line2.f1865id));
                if (matcher.matches()) {
            ...
            if (jSONObjectOptJSONObject2 != null) {
                line2.name = jSONObjectOptJSONObject2.getString(line2.f1865id);
            }
        }
    }
    ...
    protected void measure() {
        ...
        if (length == 1) {
            ...
            for (int i = 0; i < length; i++) {
                this.xPercentage[i] = (this.f1864x[i] - j) / (j2 - j);
            }
        }
        for (int i2 = 0; i2 < this.lines.size(); i2++) {
            ...
            ((Line) this.lines.get(i2)).segmentTree = new SegmentTree(((Line) this.lines.get(i2)).f1866y);
        }
