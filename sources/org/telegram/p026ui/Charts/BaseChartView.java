...
import org.telegram.p026ui.Charts.view_data.ChartBottomSignatureData;
...
public abstract class BaseChartView extends View implements ChartPickerDelegate.Listener {
    ...
    public static final int SIGNATURE_TEXT_HEIGHT = AndroidUtilities.m1081dp(18.0f);
    private static final int BOTTOM_SIGNATURE_TEXT_HEIGHT = AndroidUtilities.m1081dp(14.0f);
    public static final int BOTTOM_SIGNATURE_START_ALPHA = AndroidUtilities.m1081dp(10.0f);
    protected static final int PICKER_PADDING = AndroidUtilities.m1081dp(16.0f);
    private static final int PICKER_CAPTURE_WIDTH = AndroidUtilities.m1081dp(24.0f);
    private static final int LANDSCAPE_END_PADDING = AndroidUtilities.m1081dp(16.0f);
    private static final int BOTTOM_SIGNATURE_OFFSET = AndroidUtilities.m1081dp(10.0f);
    private static final int DP_12 = AndroidUtilities.m1081dp(12.0f);
    private static final int DP_8 = AndroidUtilities.m1081dp(8.0f);
    private static final int DP_6 = AndroidUtilities.m1081dp(6.0f);
    private static final int DP_5 = AndroidUtilities.m1081dp(5.0f);
    private static final int DP_2 = AndroidUtilities.m1081dp(2.0f);
    private static final int DP_1 = AndroidUtilities.m1081dp(1.0f);
    ...
    class C33681 implements ValueAnimator.AnimatorUpdateListener {
        C33681() {
        }
    ...
    class C33692 implements ValueAnimator.AnimatorUpdateListener {
        C33692() {
        }
    ...
    class C33703 implements ValueAnimator.AnimatorUpdateListener {
        C33703() {
        }
    ...
    class C33714 extends AnimatorListenerAdapter {
        C33714() {
        }
    ...
    public BaseChartView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.pikerHeight = AndroidUtilities.m1081dp(46.0f);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (!this.landscape) {
            ...
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.displaySize.y - AndroidUtilities.m1081dp(56.0f));
        }
    ...
    private void measureSizes() {
        ...
        updateLineSignature();
        this.chartBottom = AndroidUtilities.m1081dp(100.0f);
        this.chartArea.set(this.chartStart - f, 0.0f, this.chartEnd + f, getMeasuredHeight() - this.chartBottom);
        if (this.chartData != null) {
            this.bottomSignatureOffset = (int) (AndroidUtilities.m1081dp(20.0f) / (this.pickerWidth / this.chartData.f1864x.length));
        }
    ...
    */
    void drawBottomSignature(android.graphics.Canvas r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Charts.BaseChartView.drawBottomSignature(android.graphics.Canvas):void");
    }
    ...
    protected void drawSelection(Canvas canvas) {
        ...
        while (true) {
            ...
            if (lineViewData.enabled || lineViewData.alpha != 0.0f) {
                float f7 = lineViewData.line.f1866y[this.selectedIndex];
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    protected void drawHorizontalLines(android.graphics.Canvas r12, org.telegram.p026ui.Charts.view_data.ChartHorizontalLinesData r13) {
        /*
            r11 = this;
            long[] r0 = r13.values
            int r1 = r0.length
        ...
        L3e:
            ...
            int r0 = r0 - r3
            int r3 = org.telegram.p026ui.Charts.BaseChartView.SIGNATURE_TEXT_HEIGHT
            int r0 = r0 - r3
        ...
        La3:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Charts.BaseChartView.drawHorizontalLines(android.graphics.Canvas, org.telegram.ui.Charts.view_data.ChartHorizontalLinesData):void");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    protected void drawSignaturesToHorizontalLines(android.graphics.Canvas r12, org.telegram.p026ui.Charts.view_data.ChartHorizontalLinesData r13) {
        /*
            r11 = this;
            long[] r0 = r13.values
            int r1 = r0.length
        ...
        L83:
            ...
            float r2 = r2 - r4
            int r2 = (int) r2
            float r8 = org.telegram.p026ui.Charts.BaseChartView.HORIZONTAL_PADDING
            int r2 = r2 - r3
            float r9 = (float) r2
        ...
        Lbf:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Charts.BaseChartView.drawSignaturesToHorizontalLines(android.graphics.Canvas, org.telegram.ui.Charts.view_data.ChartHorizontalLinesData):void");
    }
    ...
    */
    void drawPicker(android.graphics.Canvas r30) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Charts.BaseChartView.drawPicker(android.graphics.Canvas):void");
    }
    ...
    protected void setMaxMinValue(long j, long j2, boolean z, boolean z2, boolean z3) {
        ...
        if (jCurrentTimeMillis - this.lastTime >= 320 || z2) {
            ...
            valueAnimatorCreateAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Charts.BaseChartView.5
                ...
                C33725(final ChartHorizontalLinesData chartHorizontalLinesDataCreateHorizontalLinesData2) {
    ...
    class C33725 extends AnimatorListenerAdapter {
        final /* synthetic */ ChartHorizontalLinesData val$newData;
    ...
    protected void selectXOnChart(int i, int i2) {
        ...
        if (f3 < 0.0f) {
            ...
            this.selectedIndex = chartData.f1864x.length - 1;
            this.selectedCoordinate = 1.0f;
        } else {
    ...
    protected float getMinDistance() {
        ...
        int length = chartData.f1864x.length;
        if (length < 5) {
            return 1.0f;
        }
        float f = 5.0f / length;
    ...
    protected void updateIndexes() {
        ...
        if (chartHeaderView != null) {
            long[] jArr = this.chartData.f1864x;
        ...
        if (chartBottomSignatureData == null || i >= chartBottomSignatureData.stepMax || i <= chartBottomSignatureData.stepMin) {
            ...
            if (chartBottomSignatureData2 == null || chartBottomSignatureData2.step != iHighestOneBit) {
                ...
                duration.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Charts.BaseChartView.6
                    ...
                    C33736(final ChartBottomSignatureData chartBottomSignatureData32) {
    ...
    class C33736 extends AnimatorListenerAdapter {
        final /* synthetic */ ChartBottomSignatureData val$data;
    ...
    public void onCheckChanged() {
        ...
        if (this.legendShowing) {
            ...
            int i3 = this.selectedIndex;
            ChartData chartData = this.chartData;
            legendSignatureView.setData(i3, chartData.f1864x[i3], this.lines, true, chartData.yTooltipFormatter, chartData.yRate);
        }
    }
    ...
    public long getSelectedDate() {
        ...
        return this.chartData.f1864x[i];
    }
    ...
    public void selectDate(long j) {
        this.selectedIndex = Arrays.binarySearch(this.chartData.f1864x, j);
        this.legendShowing = true;
        this.legendSignatureView.setVisibility(0);
    ...
    public long getStartDate() {
        return this.chartData.f1864x[this.startXIndex];
    }

    public long getEndDate() {
        return this.chartData.f1864x[this.endXIndex];
    }
    ...
    public static class SharedUiComponents {
        ...
        Bitmap getPickerMaskBitmap(int i, int i2) {
            int i3 = (i + i2) << 10;
            if (i3 != this.f1862k || this.invalidate) {
                ...
                this.canvas.drawRoundRect(this.rectF, AndroidUtilities.m1081dp(6.0f), AndroidUtilities.m1081dp(6.0f), this.xRefP);
            }
