...
import org.telegram.p026ui.Charts.view_data.PieLegendView;
...
public class PieChartView extends StackLinearChartView {
    ...
    public PieChartView(Context context) {
        ...
        this.MIN_TEXT_SIZE = AndroidUtilities.m1081dp(9.0f);
        this.MAX_TEXT_SIZE = AndroidUtilities.m1081dp(13.0f);
    ...
    @Override // org.telegram.p026ui.Charts.StackLinearChartView, org.telegram.p026ui.Charts.BaseChartView
    /*
    ...
    */
    protected void drawChart(android.graphics.Canvas r26) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Charts.PieChartView.drawChart(android.graphics.Canvas):void");
    }
    ...
    */
    protected void drawPickerChart(android.graphics.Canvas r22) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Charts.PieChartView.drawPickerChart(android.graphics.Canvas):void");
    }
    ...
    protected void selectXOnChart(int i, int i2) {
        ...
        float degrees = (float) (Math.toDegrees(Math.atan2((this.chartArea.centerY() + AndroidUtilities.m1081dp(16.0f)) - i2, this.chartArea.centerX() - i)) - 90.0d);
        float f = 0.0f;
        if (degrees < 0.0f) {
        ...
        if (this.currentSelection != i3 && i3 >= 0) {
            ...
            if (this.pieLegendView.getMeasuredWidth() + measuredWidth > getMeasuredWidth() - AndroidUtilities.m1081dp(16.0f)) {
                measuredWidth -= (this.pieLegendView.getMeasuredWidth() + measuredWidth) - (getMeasuredWidth() - AndroidUtilities.m1081dp(16.0f));
            }
            int iMin2 = ((int) Math.min(this.rectF.centerY(), (int) Math.min(((double) this.rectF.centerY()) + (Math.sin(Math.toRadians(r14)) * dWidth), ((double) this.rectF.centerY()) + (dWidth * Math.sin(Math.toRadians(r9)))))) - AndroidUtilities.m1081dp(50.0f);
    ...
    @Override // org.telegram.p026ui.Charts.StackLinearChartView, org.telegram.p026ui.Charts.BaseChartView, android.view.View
    ...
    public void updatePicker(ChartData chartData, long j) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            if (j2 >= chartData.f1864x[i2]) {
                i = i2;
            }
        }
        float length2 = chartData.xPercentage.length < 2 ? 0.5f : 1.0f / chartData.f1864x.length;
        if (i == 0) {
            ChartPickerDelegate chartPickerDelegate = this.pickerDelegate;
            chartPickerDelegate.pickerStart = 0.0f;
            chartPickerDelegate.pickerEnd = length2;
        } else {
            if (i >= chartData.f1864x.length - 1) {
    ...
    private void updateCharValues(float f, float f2, boolean z) {
        ...
        while (i3 <= i2) {
            for (int i6 = 0; i6 < size; i6++) {
                ...
                fArr[i6] = fArr[i6] + ((ChartData.Line) ((StackLinearChartData) this.chartData).lines.get(i6)).f1866y[i3];
                this.sum += ((ChartData.Line) ((StackLinearChartData) this.chartData).lines.get(i6)).f1866y[i3];
                if (this.isEmpty && ((PieChartViewData) this.lines.get(i6)).enabled && ((ChartData.Line) ((StackLinearChartData) this.chartData).lines.get(i6)).f1866y[i3] > 0) {
                    this.isEmpty = false;
                }
            }
            i3++;
    ...
    @Override // org.telegram.p026ui.Charts.BaseChartView, org.telegram.ui.Charts.ChartPickerDelegate.Listener
