...
public class LegendSignatureView extends FrameLayout {
    ...
    class RunnableC33761 implements Runnable {
        RunnableC33761() {
        }
    ...
    public LegendSignatureView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        imageView.setImageResource(C2702R.drawable.ic_chevron_right_black_18dp);
        RadialProgressView radialProgressView = new RadialProgressView(context);
        this.progressView = radialProgressView;
        radialProgressView.setSize(AndroidUtilities.m1081dp(12.0f));
        this.progressView.setStrokeWidth(AndroidUtilities.m1081dp(0.5f));
    ...
    public void recolor() {
        ...
        this.shadowDrawable = getContext().getResources().getDrawable(C2702R.drawable.stats_tooltip).mutate();
        this.backgroundDrawable = Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1081dp(4.0f), Theme.getColor(Theme.key_dialogBackground, this.resourcesProvider), Theme.getColor(Theme.key_listSelector, this.resourcesProvider), -16777216);
        CombinedDrawable combinedDrawable = new CombinedDrawable(this.shadowDrawable, this.backgroundDrawable, AndroidUtilities.m1081dp(3.0f), AndroidUtilities.m1081dp(3.0f));
    ...
    public void setData(int i, long j, ArrayList arrayList, boolean z, int i2, float f) {
        ...
        for (int i5 = 0; i5 < arrayList.size(); i5++) {
            if (((LineViewData) arrayList.get(i5)).enabled) {
                j2 += ((LineViewData) arrayList.get(i5)).line.f1866y[i];
            }
        }
        int i6 = 0;
        while (i6 < length) {
            ...
            if (!lineViewData.enabled) {
                ...
                i3 = i6;
                int i8 = i4;
                textViewEmojis.setText(formatWholeNumber(lineViewData.line.f1866y[i], i2, i7, textViewEmojis, f));
                if (i2 == 1) {
                    TextView textView2 = holder.signature;
                    int i9 = i7 == 0 ? C2702R.string.ChartInTON : C2702R.string.ChartInUSD;
                    ...
                    int i10 = i7 == 0 ? C2702R.string.ChartInXTR : C2702R.string.ChartInUSD;
                ...
                if (this.showPercentage && (textView = holder.percentage) != null) {
                    ...
                    float f2 = ((LineViewData) arrayList.get(i3)).line.f1866y[i] / j2;
                    if (f2 < 0.1f && f2 != 0.0f) {
    ...
    class C33772 extends AnimatorListenerAdapter {
        C33772() {
        }
    ...
    class Holder {
        ...
        Holder() {
            ...
            linearLayout.setPadding(AndroidUtilities.m1081dp(4.0f), AndroidUtilities.m1081dp(2.0f), AndroidUtilities.m1081dp(4.0f), AndroidUtilities.m1081dp(2.0f));
            if (LegendSignatureView.this.showPercentage) {
                ...
                this.percentage.getLayoutParams().width = AndroidUtilities.m1081dp(36.0f);
