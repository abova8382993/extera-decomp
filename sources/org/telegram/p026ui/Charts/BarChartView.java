...
import org.telegram.p026ui.Charts.view_data.BarViewData;
...
public class BarChartView extends BaseChartView {
    ...
    */
    protected void drawChart(android.graphics.Canvas r25) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Charts.BarChartView.drawChart(android.graphics.Canvas):void");
    }
        ...
        if (this.chartData != null) {
            ...
            while (i7 < size) {
                ...
                if (barViewData.enabled || barViewData.alpha != 0.0f) {
                    ...
                    long[] jArr = barViewData.line.f1866y;
