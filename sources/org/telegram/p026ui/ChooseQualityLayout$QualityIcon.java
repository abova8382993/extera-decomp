...
public class ChooseQualityLayout$QualityIcon extends Drawable {
    ...
    public ChooseQualityLayout$QualityIcon(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.castFill = context.getResources().getDrawable(C2702R.drawable.mini_casting_fill).mutate();
        paint.setColor(-1);
        paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_OUT));
        animatedTextDrawable.setTypeface(AndroidUtilities.getTypeface("fonts/num.otf"));
        animatedTextDrawable.setTextColor(-16777216);
        animatedTextDrawable.setTextSize(AndroidUtilities.m1081dp(7.0f));
        ...
        animatedTextDrawable2.setTextSize(AndroidUtilities.m1081dp(7.0f));
        ...
        rectF.set(AndroidUtilities.m1081dp(0.66f), AndroidUtilities.m1081dp(4.0f), AndroidUtilities.m1081dp(13.0f), AndroidUtilities.m1081dp(13.33f));
        path.addRoundRect(rectF, AndroidUtilities.m1081dp(2.66f), AndroidUtilities.m1081dp(2.66f), Path.Direction.CW);
    ...
    public void draw(Canvas canvas) {
        ...
        float fM1081dp = (AndroidUtilities.m1081dp(5.0f) * this.topText.isNotEmpty()) + this.topText.getCurrentWidth();
        float fM1081dp2 = (AndroidUtilities.m1081dp(5.0f) * this.bottomText.isNotEmpty()) + this.bottomText.getCurrentWidth();
        int saveCount = canvas.getSaveCount();
        Rect bounds = getBounds();
        if (fM1081dp > 0.0f || fM1081dp2 > 0.0f || f5 > 0.0f) {
            canvas2 = canvas;
            canvas2.saveLayerAlpha(bounds.left, bounds.top, bounds.right, bounds.bottom, Function.USE_VARARGS, 31);
        } else {
            canvas2 = canvas;
        }
        Rect rect = AndroidUtilities.rectTmp2;
        rect.set(AndroidUtilities.m1081dp(6.0f), AndroidUtilities.m1081dp(6.0f), (AndroidUtilities.m1081dp(6.0f) + bounds.width()) - AndroidUtilities.m1081dp(12.0f), (AndroidUtilities.m1081dp(6.0f) + bounds.height()) - AndroidUtilities.m1081dp(12.0f));
        ...
        float fM1081dp3 = AndroidUtilities.m1081dp(10.0f);
        if (fM1081dp > 0.0f) {
            float f6 = fM1081dp3 / 2.0f;
            f = 2.0f;
            f2 = 3.0f;
            this.rect.set(fWidth - fM1081dp, fHeight - f6, fWidth, fHeight + f6);
            canvas2.drawRoundRect(this.rect, AndroidUtilities.m1081dp(3.0f), AndroidUtilities.m1081dp(3.0f), this.bgLinePaint);
        } else {
            f = 2.0f;
            f2 = 3.0f;
        }
        if (fM1081dp2 > 0.0f) {
            float f7 = fM1081dp3 / f;
            f3 = 0.0f;
            this.rect.set(fWidth - fM1081dp2, fHeight2 - f7, fWidth, f7 + fHeight2);
            canvas2.drawRoundRect(this.rect, AndroidUtilities.m1081dp(f2), AndroidUtilities.m1081dp(f2), this.bgLinePaint);
        } else {
            f3 = 0.0f;
        }
        float f8 = 1.0f - f5;
        if (fM1081dp * f8 > f3) {
            ...
            float f9 = fM1081dp3 / f;
            this.rect.set(fWidth - fM1081dp, fHeight - f9, fWidth, fHeight + f9);
            this.rect.inset(AndroidUtilities.m1081dp(1.0f), AndroidUtilities.m1081dp(1.0f));
            canvas2.drawRoundRect(this.rect, AndroidUtilities.m1081dp(f2), AndroidUtilities.m1081dp(f2), this.bgPaint);
            this.rect.inset(-AndroidUtilities.m1081dp(1.0f), -AndroidUtilities.m1081dp(1.0f));
        ...
        if (f5 > f3) {
            ...
            drawable2.setBounds((bounds.right - drawable2.getIntrinsicWidth()) - AndroidUtilities.m1081dp(f2), bounds.top + AndroidUtilities.m1081dp(0.66f), bounds.right - AndroidUtilities.m1081dp(f2), bounds.top + AndroidUtilities.m1081dp(0.66f) + this.castFill.getIntrinsicHeight());
        ...
        if (fM1081dp2 > 0.0f) {
            ...
            float f10 = fM1081dp3 / f;
            this.rect.set(fWidth - fM1081dp2, fHeight2 - f10, fWidth, fHeight2 + f10);
            this.rect.inset(AndroidUtilities.m1081dp(1.0f), AndroidUtilities.m1081dp(1.0f));
            canvas2.drawRoundRect(this.rect, AndroidUtilities.m1081dp(f2), AndroidUtilities.m1081dp(f2), this.bgPaint);
            this.rect.inset(-AndroidUtilities.m1081dp(1.0f), -AndroidUtilities.m1081dp(1.0f));
    ...
    public int getIntrinsicWidth() {
        return this.base.getIntrinsicWidth() + AndroidUtilities.m1081dp(12.0f);
    }

    @Override // android.graphics.drawable.Drawable
    public int getIntrinsicHeight() {
        return this.base.getIntrinsicHeight() + AndroidUtilities.m1081dp(12.0f);
    }
}
