...
import org.telegram.p026ui.Cells.TextBlockCell;
...
public class ChannelCreateActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, ImageUpdater.ImageUpdaterDelegate {
    ...
    public void showDoneCancelDialog() {
        ...
        builder.setNegativeButton(LocaleController.getString(C2702R.string.Stop), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ChannelCreateActivity$$ExternalSyntheticLambda19
    ...
    public View createView(Context context) {
        ...
        channelCreateActivity.actionBar.setBackButtonImage(C2702R.drawable.ic_ab_back);
        channelCreateActivity.actionBar.setAllowOverlayTitle(true);
        channelCreateActivity.actionBar.setActionBarMenuOnItemClick(channelCreateActivity.new C33441());
        ...
        channelCreateActivity.doneButton = actionBarMenuCreateMenu.addItemWithWidth(1, crossfadeDrawable, AndroidUtilities.m1081dp(56.0f), LocaleController.getString(C2702R.string.Done));
        int i2 = channelCreateActivity.currentStep;
        if (i2 == 0) {
            channelCreateActivity.actionBar.setTitle(LocaleController.getString(C2702R.string.NewChannel));
            SizeNotifierFrameLayout sizeNotifierFrameLayout = new SizeNotifierFrameLayout(context) { // from class: org.telegram.ui.ChannelCreateActivity.2
                ...
                */
                protected void onLayout(boolean r11, int r12, int r13, int r14, int r15) {
                    ...
                    */
                    throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.ChannelCreateActivity.C33462.onLayout(boolean, int, int, int, int):void");
                }
            ...
            view.setContentDescription(LocaleController.getString(C2702R.string.ChatSetPhotoOrVideo));
            ...
            channelCreateActivity.cameraDrawable = new RLottieDrawable(C2702R.raw.camera, _UrlKt.FRAGMENT_ENCODE_SET + C2702R.raw.camera, AndroidUtilities.m1081dp(52.0f), AndroidUtilities.m1081dp(52.0f), false, null);
            ...
            channelCreateActivity.avatarEditor.setPadding(AndroidUtilities.m1081dp(0.0f), 0, 0, AndroidUtilities.m1081dp(1.0f));
            ...
            radialProgressView.setSize(AndroidUtilities.m1081dp(30.0f));
            ...
            editTextEmoji2.setHint(LocaleController.getString(C2702R.string.EnterChannelName));
            ...
            outlineTextContainerView.setText(LocaleController.getString(C2702R.string.DescriptionPlaceholder));
            ...
            channelCreateActivity.descriptionTextView.setPadding(iM1081dp, iM1081dp, iM1081dp, iM1081dp);
            ...
            channelCreateActivity.descriptionTextView.setCursorSize(AndroidUtilities.m1081dp(20.0f));
            ...
            channelCreateActivity.helpTextView.setText(LocaleController.getString(C2702R.string.DescriptionInfo));
            ...
            channelCreateActivity.actionBar.setTitle(LocaleController.getString(z6 ? C2702R.string.GroupSettingsTitle : C2702R.string.ChannelSettingsTitle));
            ...
            channelCreateActivity.headerCell2.setText(LocaleController.getString(channelCreateActivity.isGroup ? C2702R.string.GroupTypeHeader : C2702R.string.ChannelTypeHeader));
            ...
            if (channelCreateActivity.isGroup) {
                channelCreateActivity.radioButtonCell1.setTextAndValue(LocaleController.getString(C2702R.string.MegaPublic), LocaleController.getString(C2702R.string.MegaPublicInfo), false, !channelCreateActivity.isPrivate);
            } else {
                channelCreateActivity.radioButtonCell1.setTextAndValue(LocaleController.getString(C2702R.string.ChannelPublic), LocaleController.getString(C2702R.string.ChannelPublicInfo), false, !channelCreateActivity.isPrivate);
            }
            ...
            if (channelCreateActivity.isGroup) {
                channelCreateActivity.radioButtonCell2.setTextAndValue(LocaleController.getString(C2702R.string.MegaPrivate), LocaleController.getString(C2702R.string.MegaPrivateInfo), false, channelCreateActivity.isPrivate);
            } else {
                channelCreateActivity.radioButtonCell2.setTextAndValue(LocaleController.getString(C2702R.string.ChannelPrivate), LocaleController.getString(C2702R.string.ChannelPrivateInfo), false, channelCreateActivity.isPrivate);
            }
            ...
            channelCreateActivity.descriptionTextView.setImeOptions(6);
            channelCreateActivity.descriptionTextView.setHint(LocaleController.getString(C2702R.string.ChannelUsernamePlaceholder));
            ...
            channelCreateActivity.checkTextView.setPadding(AndroidUtilities.m1081dp(3.0f), 0, AndroidUtilities.m1081dp(3.0f), 0);
            ...
            int i9 = C2702R.drawable.greydivider_bottom;
            ...
            textInfoPrivacyCell2.setBackgroundDrawable(Theme.getThemedDrawableByKey(context, C2702R.drawable.greydivider_bottom, i10));
    ...
    class C33441 extends ActionBar.ActionBarMenuOnItemClick {
        C33441() {
        }
                ...
                if (ChannelCreateActivity.this.currentStep == 1) {
                    if (!ChannelCreateActivity.this.isPrivate) {
                        if (ChannelCreateActivity.this.descriptionTextView.length() == 0) {
                            ...
                            builder.setTitle(LocaleController.getString(C2702R.string.ChannelPublicEmptyUsernameTitle));
                            builder.setMessage(LocaleController.getString(C2702R.string.ChannelPublicEmptyUsername));
    ...
    private void updatePrivatePublic() {
        ...
        if (!this.isPrivate && !this.canCreatePublic) {
            ...
            if (this.loadingAdminedChannels) {
                ...
                textInfoPrivacyCell2.setBackgroundDrawable(Theme.getThemedDrawableByKey(textInfoPrivacyCell2.getContext(), C2702R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                this.adminedInfoCell.setVisibility(8);
            } else {
                TextInfoPrivacyCell textInfoPrivacyCell3 = this.typeInfoCell;
                textInfoPrivacyCell3.setBackgroundDrawable(Theme.getThemedDrawableByKey(textInfoPrivacyCell3.getContext(), C2702R.drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
            ...
            textInfoPrivacyCell5.setBackgroundDrawable(Theme.getThemedDrawableByKey(textInfoPrivacyCell5.getContext(), C2702R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
    ...
    public /* synthetic */ void lambda$loadAdminedChannels$20(View view) {
        ...
        if (currentChannel.megagroup) {
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("RevokeLinkAlert", C2702R.string.RevokeLinkAlert, MessagesController.getInstance(this.currentAccount).linkPrefix + "/" + ChatObject.getPublicUsername(currentChannel), currentChannel.title)));
        } else {
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("RevokeLinkAlertChannel", C2702R.string.RevokeLinkAlertChannel, MessagesController.getInstance(this.currentAccount).linkPrefix + "/" + ChatObject.getPublicUsername(currentChannel), currentChannel.title)));
        }
        builder.setNegativeButton(LocaleController.getString(C2702R.string.Cancel), null);
        builder.setPositiveButton(LocaleController.getString(C2702R.string.RevokeButton), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ChannelCreateActivity$$ExternalSyntheticLambda25
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
