...
public class SpeedButtonsLayout extends LinearLayout {
    ...
    public SpeedButtonsLayout(Context context, final Callback callback) {
        ...
        setOrientation(1);
        ActionBarMenuSubItem actionBarMenuSubItemAddItem = ActionBarMenuItem.addItem(this, C2702R.drawable.msg_speed_0_2, LocaleController.getString(C2702R.string.SpeedVerySlow), false, null);
        ...
        ActionBarMenuSubItem actionBarMenuSubItemAddItem2 = ActionBarMenuItem.addItem(this, C2702R.drawable.msg_speed_slow, LocaleController.getString(C2702R.string.SpeedSlow), false, null);
        ...
        ActionBarMenuSubItem actionBarMenuSubItemAddItem3 = ActionBarMenuItem.addItem(this, C2702R.drawable.msg_speed_normal, LocaleController.getString(C2702R.string.SpeedNormal), false, null);
        ...
        ActionBarMenuSubItem actionBarMenuSubItemAddItem4 = ActionBarMenuItem.addItem(this, C2702R.drawable.msg_speed_fast, LocaleController.getString(C2702R.string.SpeedFast), false, null);
        ...
        ActionBarMenuSubItem actionBarMenuSubItemAddItem5 = ActionBarMenuItem.addItem(this, C2702R.drawable.msg_speed_superfast, LocaleController.getString(C2702R.string.SpeedVeryFast), false, null);
