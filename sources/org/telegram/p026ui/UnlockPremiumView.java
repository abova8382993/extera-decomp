...
public class UnlockPremiumView extends FrameLayout {
    ...
    public UnlockPremiumView(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (i == 0) {
            textView.setText(LocaleController.getString(C2702R.string.UnlockPremiumStickersDescription));
        } else if (i == 1) {
            textView.setText(LocaleController.getString(C2702R.string.UnlockPremiumReactionsDescription));
        }
        ...
        if (i == 0) {
            string = LocaleController.getString(C2702R.string.UnlockPremiumStickers);
        } else {
            string = LocaleController.getString(C2702R.string.UnlockPremiumReactions);
        }
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        spannableStringBuilder.append((CharSequence) "d ").setSpan(new ColoredImageSpan(ContextCompat.getDrawable(context, C2702R.drawable.msg_premium_normal)), 0, 1, 0);
