...
public class ExternalActionActivity extends Activity implements INavigationLayout.INavigationLayoutDelegate {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        if (AndroidUtilities.isTablet()) {
            ...
            this.layersActionBarLayout.getView().setBackgroundResource(C2702R.drawable.boxshadow);
        ...
        if ("org.telegram.passport.AUTHORIZE".equals(intent.getAction())) {
            if (i2 == 0) {
                ...
                if (activatedAccountsCount == 0) {
                    ...
                    builder.setMessage(LocaleController.getString(C2702R.string.PleaseLoginPassport));
    ...
    public /* synthetic */ void lambda$handleIntent$9(AlertDialog alertDialog, final TLRPC.TL_error tL_error) {
        try {
            ...
            if ("APP_VERSION_OUTDATED".equals(tL_error.text)) {
                AlertDialog alertDialogShowUpdateAppAlert = AlertsCreator.showUpdateAppAlert(this, LocaleController.getString(C2702R.string.UpdateAppAlert), true);
    ...
    public void needLayout() {
        if (AndroidUtilities.isTablet()) {
            ...
            if (!AndroidUtilities.isSmallTablet() || getResources().getConfiguration().orientation == 2) {
                int iM1081dp = (AndroidUtilities.displaySize.x / 100) * 35;
