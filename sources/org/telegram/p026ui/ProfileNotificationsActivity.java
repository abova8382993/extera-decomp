...
public class ProfileNotificationsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public boolean onFragmentCreate() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.ProfileNotificationsActivity.onFragmentCreate():boolean");
    }
    ...
    public View createView(final Context context) {
        ...
        if (this.addingException) {
            this.avatarContainer.setSubtitle(LocaleController.getString(C2702R.string.NotificationsNewException));
            this.actionBar.createMenu().addItem(1, LocaleController.getString(C2702R.string.Done).toUpperCase());
        } else {
            this.avatarContainer.setSubtitle(LocaleController.getString(C2702R.string.CustomNotifications));
        }
    ...
    public /* synthetic */ void lambda$createView$6(Context context, final String str, View view, int i) {
        if (view.isEnabled()) {
            ...
            if (i == this.customResetRow) {
                AlertDialog alertDialogCreate = new AlertDialog.Builder(context, this.resourcesProvider).setTitle(LocaleController.getString(C2702R.string.ResetCustomNotificationsAlertTitle)).setMessage(LocaleController.getString(C2702R.string.ResetCustomNotificationsAlert)).setPositiveButton(LocaleController.getString(C2702R.string.Reset), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ProfileNotificationsActivity$$ExternalSyntheticLambda2
            ...
            if (i == this.smartRow) {
                ...
                AlertsCreator.createSoundFrequencyPickerDialog(getParentActivity(), i2 != 0 ? i2 : 2, notificationsSettings2.getInt("smart_delay_" + str, Opcodes.GETFIELD), new AlertsCreator.SoundFrequencyDelegate() { // from class: org.telegram.ui.ProfileNotificationsActivity$$ExternalSyntheticLambda6
        ...
        if (uri == null || (ringtone = RingtoneManager.getRingtone(ApplicationLoader.applicationContext, uri)) == null) {
            ...
            if (i == 13) {
                if (uri.equals(Settings.System.DEFAULT_RINGTONE_URI)) {
                    title = LocaleController.getString(C2702R.string.DefaultRingtone);
                } else {
                    title = ringtone.getTitle(getParentActivity());
                }
            } else if (uri.equals(Settings.System.DEFAULT_NOTIFICATION_URI)) {
                title = LocaleController.getString(C2702R.string.SoundDefault);
            } else {
                title = ringtone.getTitle(getParentActivity());
            }
            ringtone.stop();
            ...
            switch (viewHolder.getItemViewType()) {
                case 0:
                    ...
                    if (i == ProfileNotificationsActivity.this.generalRow) {
                        headerCell.setText(LocaleController.getString(C2702R.string.General));
                    } else if (i == ProfileNotificationsActivity.this.popupRow) {
                        headerCell.setText(LocaleController.getString(C2702R.string.ProfilePopupNotification));
                    } else if (i == ProfileNotificationsActivity.this.ledRow) {
                        headerCell.setText(LocaleController.getString(C2702R.string.NotificationsLed));
                    } else if (i == ProfileNotificationsActivity.this.callsRow) {
                        headerCell.setText(LocaleController.getString(C2702R.string.VoipNotificationSettings));
                    }
                    break;
                case 1:
                    ...
                    if (i == ProfileNotificationsActivity.this.customResetRow) {
                        textSettingsCell.setText(LocaleController.getString(C2702R.string.ResetCustomNotifications), false);
                        ...
                        if (i == ProfileNotificationsActivity.this.soundRow) {
                            String string = notificationsSettings.getString("sound_" + sharedPrefKey, LocaleController.getString(C2702R.string.SoundDefault));
                            ...
                            if (j != 0) {
                                ...
                                if (document == null) {
                                    string = LocaleController.getString(C2702R.string.CustomSound);
                                } else {
                                    string = NotificationsSoundActivity.trimTitle(document, document.file_name_fixed);
                                }
                            } else if (string.equals("NoSound")) {
                                string = LocaleController.getString(C2702R.string.NoSound);
                            } else if (string.equals("Default")) {
                                string = LocaleController.getString(C2702R.string.SoundDefault);
                            }
                            textSettingsCell.setTextAndValue(LocaleController.getString(C2702R.string.Sound), string, true);
                        } else if (i == ProfileNotificationsActivity.this.ringtoneRow) {
                            String string2 = notificationsSettings.getString("ringtone_" + sharedPrefKey, LocaleController.getString(C2702R.string.DefaultRingtone));
                            if (string2.equals("NoSound")) {
                                string2 = LocaleController.getString(C2702R.string.NoSound);
                            }
                            textSettingsCell.setTextAndValue(LocaleController.getString(C2702R.string.VoipSettingsRingtone), string2, false);
                        } else if (i == ProfileNotificationsActivity.this.vibrateRow) {
                            int i3 = notificationsSettings.getInt("vibrate_" + sharedPrefKey, 0);
                            if (i3 == 0 || i3 == 4) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2702R.string.Vibrate), LocaleController.getString(C2702R.string.VibrationDefault), (ProfileNotificationsActivity.this.smartRow == -1 && ProfileNotificationsActivity.this.priorityRow == -1) ? false : true);
                            } else if (i3 == 1) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2702R.string.Vibrate), LocaleController.getString(C2702R.string.Short), (ProfileNotificationsActivity.this.smartRow == -1 && ProfileNotificationsActivity.this.priorityRow == -1) ? false : true);
                            } else if (i3 == 2) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2702R.string.Vibrate), LocaleController.getString(C2702R.string.VibrationDisabled), (ProfileNotificationsActivity.this.smartRow == -1 && ProfileNotificationsActivity.this.priorityRow == -1) ? false : true);
                            } else if (i3 == 3) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2702R.string.Vibrate), LocaleController.getString(C2702R.string.Long), (ProfileNotificationsActivity.this.smartRow == -1 && ProfileNotificationsActivity.this.priorityRow == -1) ? false : true);
                            }
                        } else if (i == ProfileNotificationsActivity.this.priorityRow) {
                            int i4 = notificationsSettings.getInt("priority_" + sharedPrefKey, 3);
                            if (i4 == 0) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2702R.string.NotificationsImportance), LocaleController.getString(C2702R.string.NotificationsPriorityHigh), false);
                            } else if (i4 == 1 || i4 == 2) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2702R.string.NotificationsImportance), LocaleController.getString(C2702R.string.NotificationsPriorityUrgent), false);
                            } else if (i4 == 3) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2702R.string.NotificationsImportance), LocaleController.getString(C2702R.string.NotificationsPrioritySettings), false);
                            } else if (i4 == 4) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2702R.string.NotificationsImportance), LocaleController.getString(C2702R.string.NotificationsPriorityLow), false);
                            } else if (i4 == 5) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2702R.string.NotificationsImportance), LocaleController.getString(C2702R.string.NotificationsPriorityMedium), false);
                            }
                        } else if (i == ProfileNotificationsActivity.this.smartRow) {
                            int i5 = notificationsSettings.getInt("smart_max_count_" + sharedPrefKey, 2);
                            int i6 = notificationsSettings.getInt("smart_delay_" + sharedPrefKey, Opcodes.GETFIELD);
                            if (i5 == 0) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2702R.string.SmartNotifications), LocaleController.getString(C2702R.string.SmartNotificationsDisabled), ProfileNotificationsActivity.this.priorityRow != -1);
                            } else {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2702R.string.SmartNotifications), LocaleController.formatString("SmartNotificationsInfo", C2702R.string.SmartNotificationsInfo, Integer.valueOf(i5), LocaleController.formatPluralString("Minutes", i6 / 60, new Object[0])), ProfileNotificationsActivity.this.priorityRow != -1);
                            }
                            ...
                            if (i7 == 0 || i7 == 4) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2702R.string.Vibrate), LocaleController.getString(C2702R.string.VibrationDefault), true);
                            } else if (i7 == 1) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2702R.string.Vibrate), LocaleController.getString(C2702R.string.Short), true);
                            } else if (i7 == 2) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2702R.string.Vibrate), LocaleController.getString(C2702R.string.VibrationDisabled), true);
                            } else if (i7 == 3) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2702R.string.Vibrate), LocaleController.getString(C2702R.string.Long), true);
                            }
                        }
                    }
                    break;
                case 2:
                    ...
                    if (i == ProfileNotificationsActivity.this.popupInfoRow) {
                        textInfoPrivacyCell.setText(LocaleController.getString(C2702R.string.ProfilePopupNotificationInfo));
                    } else if (i == ProfileNotificationsActivity.this.ledInfoRow) {
                        textInfoPrivacyCell.setText(LocaleController.getString(C2702R.string.NotificationsLedInfo));
                        ...
                        if (ProfileNotificationsActivity.this.priorityRow == -1) {
                            ...
                            textInfoPrivacyCell.setText(LocaleController.getString(C2702R.string.PriorityInfo));
                        }
                    } else if (i == ProfileNotificationsActivity.this.ringtoneInfoRow) {
                        textInfoPrivacyCell.setText(LocaleController.getString(C2702R.string.VoipRingtoneInfo));
                    }
                    break;
                case 3:
                    ...
                    textColorCell.setTextAndColor(LocaleController.getString(C2702R.string.NotificationsLedColor), i2, false);
                    break;
                case 4:
                    ...
                    if (i == ProfileNotificationsActivity.this.popupEnabledRow) {
                        radioCell.setText(LocaleController.getString(C2702R.string.PopupEnabled), i9 == 1, true);
                        radioCell.setTag(1);
                    } else if (i == ProfileNotificationsActivity.this.popupDisabledRow) {
                        radioCell.setText(LocaleController.getString(C2702R.string.PopupDisabled), i9 == 2, false);
                        radioCell.setTag(2);
                    }
                    break;
                case 5:
                ...
                case 7:
                    ...
                    if (i == ProfileNotificationsActivity.this.enableRow) {
                        textCheckCell.setTextAndCheck(LocaleController.getString(C2702R.string.Notifications), ProfileNotificationsActivity.this.notificationsEnabled, true);
                        ...
                        textCheckCell.setTextAndCheck(LocaleController.getString(C2702R.string.MessagePreview), notificationsSettings4.getBoolean(NotificationsSettingsFacade.PROPERTY_CONTENT_PREVIEW + sharedPrefKey3, true), true);
                        ...
                        textCheckCell.setTextAndCheck(LocaleController.getString(C2702R.string.StoriesSoundEnabled), notificationsSettings4.getBoolean(str, z), true);
                    }
                    break;
            }
        }
