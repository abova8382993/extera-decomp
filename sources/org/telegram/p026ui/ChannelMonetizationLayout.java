...
public class ChannelMonetizationLayout extends SizeNotifierFrameLayout implements NestedScrollingParent3 {
    ...
    public ChannelMonetizationLayout(final Context context, final BaseFragment baseFragment, final int i, final long j, final Theme.ResourcesProvider resourcesProvider, boolean z, boolean z2) {
        ...
        this.availableValue = ProceedOverview.m1187as("TON", "XTR", LocaleController.getString(C2702R.string.MonetizationOverviewAvailable));
        this.lastWithdrawalValue = ProceedOverview.m1187as("TON", "XTR", LocaleController.getString(C2702R.string.MonetizationOverviewLastWithdrawal));
        this.lifetimeValue = ProceedOverview.m1187as("TON", "XTR", LocaleController.getString(C2702R.string.MonetizationOverviewTotal));
        ...
        this.titleInfo = AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.formatString(C2702R.string.MonetizationInfo, 50), -1, 3, new Runnable() { // from class: org.telegram.ui.ChannelMonetizationLayout$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
                baseFragment.showDialog(ChannelMonetizationLayout.makeLearnSheet(context, false, resourcesProvider));
            }
        }, resourcesProvider), true);
        this.balanceInfo = AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(MessagesController.getInstance(i).channelRevenueWithdrawalEnabled ? C2702R.string.MonetizationBalanceInfo : C2702R.string.MonetizationBalanceInfoNotAvailable), -1, 3, new Runnable() { // from class: org.telegram.ui.ChannelMonetizationLayout$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
        ...
        if (z2 && z) {
            i2 = C2702R.string.MonetizationProceedsStarsTONInfo;
        } else {
            i2 = z2 ? C2702R.string.MonetizationProceedsStarsInfo : C2702R.string.MonetizationProceedsTONInfo;
        }
        if (z2 && z) {
            i3 = C2702R.string.MonetizationProceedsStarsTONInfoLink;
        } else {
            i3 = z2 ? C2702R.string.MonetizationProceedsStarsInfoLink : C2702R.string.MonetizationProceedsTONInfoLink;
        }
        ...
        this.starsBalanceInfo = AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(ChatObject.isChannelAndNotMegaGroup(chat) ? C2702R.string.MonetizationStarsInfo : C2702R.string.MonetizationStarsInfoGroup), new Runnable() { // from class: org.telegram.ui.ChannelMonetizationLayout$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
        ...
        C33541 c33541 = new LinearLayout(context) { // from class: org.telegram.ui.ChannelMonetizationLayout.1
            C33541(final Context context2) {
                super(context2);
            }
        ...
        this.balanceLayout = c33541;
        c33541.setOrientation(1);
        int i5 = Theme.key_windowBackgroundWhite;
        c33541.setBackgroundColor(Theme.getColor(i5, resourcesProvider));
        c33541.setPadding(0, 0, 0, AndroidUtilities.m1081dp(17.0f));
        ...
        animatedTextView.setTextSize(AndroidUtilities.m1081dp(32.0f));
        animatedTextView.setGravity(17);
        this.balanceTitleSizeSpan = new RelativeSizeSpan(0.6770833f);
        c33541.addView(animatedTextView, LayoutHelper.createLinear(-1, 38, 49, 22, 15, 22, 0));
        ...
        c33541.addView(animatedTextView2, LayoutHelper.createFrame(-1, 17.0f, 49, 22.0f, 4.0f, 22.0f, 0.0f));
        ...
        round.setText(LocaleController.getString(C2702R.string.MonetizationWithdraw), false);
        ...
        c33541.addView(round, LayoutHelper.createFrame(-1, 48.0f, 55, 18.0f, 13.0f, 18.0f, 0.0f));
        C33552 c33552 = new LinearLayout(context2) { // from class: org.telegram.ui.ChannelMonetizationLayout.2
            C33552(final Context context2) {
                super(context2);
            }
        ...
        this.starsBalanceLayout = c33552;
        c33552.setOrientation(1);
        c33552.setBackgroundColor(Theme.getColor(i5, resourcesProvider));
        c33552.setPadding(0, 0, 0, AndroidUtilities.m1081dp(17.0f));
        ...
        animatedTextView3.setTextSize(AndroidUtilities.m1081dp(32.0f));
        animatedTextView3.setGravity(17);
        this.starsBalanceTitleSizeSpan = new RelativeSizeSpan(0.6770833f);
        c33552.addView(animatedTextView3, LayoutHelper.createLinear(-1, 38, 49, 22, 15, 22, 0));
        ...
        animatedTextView4.setTextSize(AndroidUtilities.m1081dp(14.0f));
        c33552.addView(animatedTextView4, LayoutHelper.createFrame(-1, 17.0f, 49, 22.0f, 4.0f, 22.0f, 0.0f));
        C33563 c33563 = new OutlineTextContainerView(context2) { // from class: org.telegram.ui.ChannelMonetizationLayout.3
            C33563(final Context context2) {
                super(context2);
            }
        ...
        this.starsBalanceEditTextContainer = c33563;
        c33563.setVisibility(8);
        this.starsBalanceEditTextContainer.setText(LocaleController.getString(C2702R.string.BotStarsWithdrawPlaceholder));
        this.starsBalanceEditTextContainer.setLeftPadding(AndroidUtilities.m1081dp(36.0f));
        C33574 c33574 = new EditTextBoldCursor(context2) { // from class: org.telegram.ui.ChannelMonetizationLayout.4
            C33574(final Context context2) {
                super(context2);
            }

            @Override // org.telegram.p026ui.Components.EditTextBoldCursor, org.telegram.p026ui.Components.EditTextEffects, android.view.View
            protected void onDetachedFromWindow() {
                super.onDetachedFromWindow();
                AndroidUtilities.hideKeyboard(this);
            }
        };
        this.starsBalanceEditText = c33574;
        c33574.setFocusable(false);
        this.starsBalanceEditText.setTextColor(Theme.getColor(i6, resourcesProvider));
        this.starsBalanceEditText.setCursorSize(AndroidUtilities.m1081dp(20.0f));
        ...
        this.starsBalanceEditText.setPadding(AndroidUtilities.m1081dp(6.0f), iM1081dp, iM1081dp, iM1081dp);
        ...
        linearLayout.addView(this.starsBalanceEditText, LayoutHelper.createLinear(-1, -2, 1.0f, Opcodes.DNEG));
        ...
        c33552.addView(this.starsBalanceEditTextContainer, LayoutHelper.createLinear(-1, -2, 1, 18, 14, 18, 2));
        ...
        ButtonWithCounterView round2 = new ButtonWithCounterView(context2, resourcesProvider) { // from class: org.telegram.ui.ChannelMonetizationLayout.6
            ...
            C33596(final Context context2, final Theme.ResourcesProvider resourcesProvider2) {
        ...
        round3.setText(LocaleController.getString(C2702R.string.MonetizationStarsAds), false);
        ...
        linearLayout2.addView(round2, LayoutHelper.createLinear(-1, 48, 1.0f, Opcodes.DNEG));
        if (ChatObject.isChannelAndNotMegaGroup(chat)) {
            linearLayout2.addView(new Space(context2), LayoutHelper.createLinear(8, 48, 0.0f, Opcodes.DNEG));
            linearLayout2.addView(round3, LayoutHelper.createLinear(-1, 48, 1.0f, Opcodes.DNEG));
        }
        c33552.addView(linearLayout2, LayoutHelper.createFrame(-1, 48.0f, 55, 18.0f, 13.0f, 18.0f, 0.0f));
        ...
        rLottieImageView.setAnimation(C2702R.raw.statistic_preload, Opcodes.ISHL, Opcodes.ISHL);
        ...
        textView.setText(LocaleController.getString("LoadingStats", C2702R.string.LoadingStats));
        ...
        linearLayout3.addView(rLottieImageView, LayoutHelper.createLinear(Opcodes.ISHL, Opcodes.ISHL, 1, 0, 0, 0, 20));
    ...
    public /* synthetic */ void lambda$new$1() {
        Browser.openUrl(getContext(), LocaleController.getString(C2702R.string.MonetizationBalanceInfoLink));
    }
    ...
    public /* synthetic */ void lambda$new$3() {
        Browser.openUrl(getContext(), LocaleController.getString(C2702R.string.MonetizationStarsInfoLink));
    }

    /* JADX INFO: renamed from: org.telegram.ui.ChannelMonetizationLayout$1 */
    class C33541 extends LinearLayout {
        C33541(final Context context2) {
            super(context2);
        }
    ...
    class C33552 extends LinearLayout {
        C33552(final Context context2) {
            super(context2);
        }
    ...
    class C33563 extends OutlineTextContainerView {
        C33563(final Context context2) {
            super(context2);
        }
    ...
    class C33574 extends EditTextBoldCursor {
        C33574(final Context context2) {
            super(context2);
        }
    ...
    class C33585 implements TextWatcher {
        @Override // android.text.TextWatcher
        public void beforeTextChanged(CharSequence charSequence, int i8, int i9, int i10) {
        }
    ...
    class C33596 extends ButtonWithCounterView {
        @Override // org.telegram.p026ui.Stories.recorder.ButtonWithCounterView
        protected boolean subTextSplitToWords() {
            return false;
        }
    ...
    public /* synthetic */ void lambda$new$11(final int i, final BaseFragment baseFragment, View view) {
        ...
        if (this.starsBalanceBlockedUntil > currentTime) {
            this.withdrawalBulletin = BulletinFactory.m1195of(baseFragment).createSimpleBulletin(C2702R.raw.timer_3, AndroidUtilities.replaceTags(LocaleController.formatString(C2702R.string.BotStarsWithdrawalToast, BotStarsActivity.untilString(this.starsBalanceBlockedUntil - currentTime)))).show();
            return;
        }
        if (this.starsBalanceEditTextValue < MessagesController.getInstance(i).starsRevenueWithdrawalMin) {
            BulletinFactory.m1195of(baseFragment).createSimpleBulletin(getContext().getResources().getDrawable(C2702R.drawable.star_small_inner).mutate(), AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("BotStarsWithdrawMinLimit", (int) MessagesController.getInstance(i).starsRevenueWithdrawalMin, new Object[0]), new Runnable() { // from class: org.telegram.ui.ChannelMonetizationLayout$$ExternalSyntheticLambda24
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public /* synthetic */ void lambda$new$19(int i) {
        ...
        if (currentTime < this.starsBalanceBlockedUntil) {
            this.starsBalanceButton.setText(LocaleController.getString(C2702R.string.MonetizationStarsWithdrawUntil), true);
            if (this.lock == null) {
            ...
            if (bulletin != null && (bulletin.getLayout() instanceof Bulletin.LottieLayout) && this.withdrawalBulletin.getLayout().isAttachedToWindow()) {
                ((Bulletin.LottieLayout) this.withdrawalBulletin.getLayout()).textView.setText(AndroidUtilities.replaceTags(LocaleController.formatString(C2702R.string.BotStarsWithdrawalToast, BotStarsActivity.untilString(this.starsBalanceBlockedUntil - currentTime))));
            }
            AndroidUtilities.cancelRunOnUIThread(this.setStarsBalanceButtonText);
        ...
        this.starsBalanceButton.setText(StarsIntroActivity.replaceStars(this.starsBalanceEditTextAll ? LocaleController.getString(C2702R.string.MonetizationStarsWithdrawAll) : LocaleController.formatPluralStringSpaced("MonetizationStarsWithdraw", (int) this.starsBalanceEditTextValue), this.starRef), true);
    }
    ...
    public /* synthetic */ void lambda$initWithdraw$23(TLRPC.TL_error tL_error, final TwoStepVerificationActivity twoStepVerificationActivity, Activity activity, final boolean z, TLObject tLObject) {
        ...
        if (tL_error != null) {
            if ("PASSWORD_MISSING".equals(tL_error.text) || tL_error.text.startsWith("PASSWORD_TOO_FRESH_") || tL_error.text.startsWith("SESSION_TOO_FRESH_")) {
                ...
                builder.setTitle(LocaleController.getString(C2702R.string.EditAdminTransferAlertTitle));
                ...
                textView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2702R.string.WithdrawChannelAlertText)));
                ...
                if ("PASSWORD_MISSING".equals(tL_error.text)) {
                    builder.setPositiveButton(LocaleController.getString(C2702R.string.EditAdminTransferSetPassword), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ChannelMonetizationLayout$$ExternalSyntheticLambda45
    ...
    public void lambda$loadStarsStats$25(TLRPC.TL_payments_starsRevenueStats tL_payments_starsRevenueStats) {
        ...
        StatisticActivity.ChartViewData chartViewDataCreateViewData = StatisticActivity.createViewData(tL_payments_starsRevenueStats.revenue_graph, LocaleController.getString(C2702R.string.MonetizationGraphStarsRevenue), 2);
    ...
    public /* synthetic */ void lambda$initLevel$32(TLObject tLObject) {
        if (tLObject instanceof TLRPC.TL_payments_starsRevenueStats) {
            ...
            this.impressionsChart = StatisticActivity.createViewData(tL_payments_starsRevenueStats.top_hours_graph, LocaleController.getString(C2702R.string.MonetizationGraphImpressions), 0);
            ...
            this.revenueChart = StatisticActivity.createViewData(statsGraph, LocaleController.getString(C2702R.string.MonetizationGraphRevenue), 2);
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        if (this.proceedsAvailable) {
            arrayList.add(UItem.asBlackHeader(LocaleController.getString(C2702R.string.MonetizationOverview)));
        ...
        if (chat != null && chat.creator) {
            if (this.tonRevenueAvailable) {
                arrayList.add(UItem.asBlackHeader(LocaleController.getString(C2702R.string.MonetizationBalance)));
                ...
                boolean z = false;
                UItem uItemAsCheck = UItem.asCheck(1, PeerColorActivity.withLevelLock(LocaleController.getString(C2702R.string.MonetizationSwitchOff), this.currentBoostLevel < i2 ? i2 : 0));
                if (this.currentBoostLevel >= i2 && this.switchOffValue) {
                    z = true;
                }
                arrayList.add(uItemAsCheck.setChecked(z));
                arrayList.add(UItem.asShadow(-8, LocaleController.getString(C2702R.string.MonetizationSwitchOffInfo)));
            }
            if (this.starsRevenueAvailable) {
                arrayList.add(UItem.asBlackHeader(LocaleController.getString(C2702R.string.MonetizationStarsBalance)));
        ...
        if (ChatObject.isChannelAndNotMegaGroup(MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(-this.dialogId))) && MessagesController.getInstance(this.currentAccount).starrefConnectAllowed) {
            arrayList.add(AffiliateProgramFragment.ColorfulTextCell.Factory.m1285as(4, Theme.getColor(Theme.key_color_green, this.resourcesProvider), C2702R.drawable.filled_earn_stars, ChatEditActivity.applyNewSpan(LocaleController.getString(C2702R.string.ChannelAffiliateProgramRowTitle)), LocaleController.getString(C2702R.string.ChannelAffiliateProgramRowText)));
            arrayList.add(UItem.asShadow(-7, null));
        }
        if (this.transactionsLayout.hasTransactions()) {
            arrayList.add(UItem.asFullscreenCustom(this.transactionsLayout, AndroidUtilities.m1081dp(24.0f), true));
        } else {
    ...
    public static CharSequence replaceTON(CharSequence charSequence, TextPaint textPaint, float f, float f2, boolean z) {
        ...
        if (spannableString == null) {
            ...
            if (z) {
                ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C2702R.drawable.ton);
                ...
                ColoredImageSpan coloredImageSpan2 = new ColoredImageSpan(C2702R.drawable.mini_ton);
    ...
    public static class ProceedOverview {
        ...
        public static ProceedOverview m1186as(String str, CharSequence charSequence) {
        ...
        /* JADX INFO: renamed from: as */
        public static ProceedOverview m1187as(String str, String str2, CharSequence charSequence) {
            ProceedOverview proceedOverview = new ProceedOverview();
    ...
    public static class TransactionCell extends FrameLayout {
        ...
        public void set(TL_stats.BroadcastRevenueTransaction broadcastRevenueTransaction, boolean z) {
            ...
            if (broadcastRevenueTransaction instanceof TL_stats.TL_broadcastRevenueTransactionWithdrawal) {
                ...
                this.titleView.setText(LocaleController.getString(C2702R.string.MonetizationTransactionWithdraw));
                if (tL_broadcastRevenueTransactionWithdrawal.pending) {
                    this.dateView.setText(LocaleController.getString(C2702R.string.MonetizationTransactionPending));
                    z2 = false;
                } else {
                    ...
                    if (z2) {
                        str = " — " + LocaleController.getString(C2702R.string.MonetizationTransactionNotCompleted);
                    } else {
                ...
                if (broadcastRevenueTransaction instanceof TL_stats.TL_broadcastRevenueTransactionProceeds) {
                    this.titleView.setText(LocaleController.getString(C2702R.string.MonetizationTransactionProceed));
                    ...
                    this.titleView.setText(LocaleController.getString(C2702R.string.MonetizationTransactionRefund));
            ...
            textViewEmojis.setText(ChannelMonetizationLayout.replaceTON(spannableStringBuilder, textViewEmojis.getPaint(), 1.1f, AndroidUtilities.m1081dp(0.33f), false));
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (this.needDivider) {
                ...
                if (paint != null) {
                    canvas.drawLine(LocaleController.isRTL ? 0.0f : AndroidUtilities.m1081dp(17.0f), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m1081dp(17.0f) : 0), getMeasuredHeight() - 1, paint);
                }
            }
        }
    ...
    */
    public static void showTransactionSheet(final android.content.Context r35, int r36, org.telegram.tgnet.tl.TL_stats.BroadcastRevenueTransaction r37, long r38, org.telegram.ui.ActionBar.Theme.ResourcesProvider r40) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.ChannelMonetizationLayout.showTransactionSheet(android.content.Context, int, org.telegram.tgnet.tl.TL_stats$BroadcastRevenueTransaction, long, org.telegram.ui.ActionBar.Theme$ResourcesProvider):void");
    }
    ...
    public static BottomSheet makeLearnSheet(final Context context, final boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        LinearLayout linearLayout = new LinearLayout(context);
        linearLayout.setOrientation(1);
        linearLayout.setPadding(AndroidUtilities.m1081dp(8.0f), 0, AndroidUtilities.m1081dp(8.0f), 0);
        RLottieImageView rLottieImageView = new RLottieImageView(context);
        rLottieImageView.setScaleType(ImageView.ScaleType.CENTER);
        rLottieImageView.setImageResource(C2702R.drawable.large_monetize);
        ...
        textView.setText(LocaleController.getString(z ? C2702R.string.BotMonetizationInfoTitle : C2702R.string.MonetizationInfoTitle));
        linearLayout.addView(textView, LayoutHelper.createLinear(-1, -2, 8.0f, 0.0f, 8.0f, 25.0f));
        linearLayout.addView(new FeatureCell(context, C2702R.drawable.msg_channel, LocaleController.getString(z ? C2702R.string.BotMonetizationInfoFeature1Name : C2702R.string.MonetizationInfoFeature1Name), LocaleController.getString(z ? C2702R.string.BotMonetizationInfoFeature1Text : C2702R.string.MonetizationInfoFeature1Text), resourcesProvider), LayoutHelper.createLinear(-1, -2, 49, 8, 0, 8, 16));
        linearLayout.addView(new FeatureCell(context, C2702R.drawable.menu_feature_split, LocaleController.getString(z ? C2702R.string.BotMonetizationInfoFeature2Name : C2702R.string.MonetizationInfoFeature2Name), LocaleController.getString(z ? C2702R.string.BotMonetizationInfoFeature2Text : C2702R.string.MonetizationInfoFeature2Text), resourcesProvider), LayoutHelper.createLinear(-1, -2, 49, 8, 0, 8, 16));
        linearLayout.addView(new FeatureCell(context, C2702R.drawable.menu_feature_withdrawals, LocaleController.getString(z ? C2702R.string.BotMonetizationInfoFeature3Name : C2702R.string.MonetizationInfoFeature3Name), LocaleController.getString(z ? C2702R.string.BotMonetizationInfoFeature3Text : C2702R.string.MonetizationInfoFeature3Text), resourcesProvider), LayoutHelper.createLinear(-1, -2, 49, 8, 0, 8, 16));
        ...
        coloredImageSpan.spaceScaleX = 0.9f;
        spannableString.setSpan(coloredImageSpan, 0, spannableString.length(), 33);
        textViewEmojis.setText(AndroidUtilities.replaceCharSequence("💎", LocaleController.getString(z ? C2702R.string.BotMonetizationInfoTONTitle : C2702R.string.MonetizationInfoTONTitle), spannableString));
        ...
        linksTextView.setText(AndroidUtilities.withLearnMore(AndroidUtilities.replaceTags(LocaleController.getString(z ? C2702R.string.BotMonetizationInfoTONText : C2702R.string.MonetizationInfoTONText)), new Runnable() { // from class: org.telegram.ui.ChannelMonetizationLayout$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                Browser.openUrl(context, LocaleController.getString(z ? C2702R.string.BotMonetizationInfoTONLink : C2702R.string.MonetizationInfoTONLink));
            }
        }));
        ...
        round.setText(LocaleController.getString(C2702R.string.GotIt), false);
    ...
    public static class FeatureCell extends FrameLayout {
        ...
        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(Math.min(View.MeasureSpec.getSize(i), AndroidUtilities.m1081dp(325.0f)), View.MeasureSpec.getMode(i)), i2);
        }
    }
    ...
    public class ChannelTransactionsView extends LinearLayout {
        ...
        class PageAdapter extends ViewPagerFixed.Adapter {
            ...
            public String getItemTitle(int i) {
                ...
                if (itemViewType == 0) {
                    return LocaleController.getString(C2702R.string.MonetizationTransactionsStars);
                }
                if (itemViewType == 1) {
                    return LocaleController.getString(C2702R.string.MonetizationTransactionsTON);
                }
        ...
        public class Page extends FrameLayout {
            ...
            public Page(Context context, long j, int i, int i2, int i3, Runnable runnable, Theme.ResourcesProvider resourcesProvider) {
                ...
                universalRecyclerView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.ChannelMonetizationLayout.ChannelTransactionsView.Page.1
                    ...
                    C33661(ChannelTransactionsView channelTransactionsView, Runnable runnable2) {
            ...
            class C33661 extends RecyclerView.OnScrollListener {
                final /* synthetic */ Runnable val$loadMore;
                final /* synthetic */ ChannelTransactionsView val$this$1;
    ...
    public void onNestedScroll(View view, int i, int i2, int i3, int i4, int i5, int[] iArr) {
        try {
            if (view == this.listView && this.transactionsLayout.isAttachedToWindow()) {
                ...
                if (this.listView.getHeight() - bottom >= this.listView.getPaddingBottom() + AndroidUtilities.m1081dp(8.0f)) {
                    iArr[1] = i4;
    ...
    public void onNestedPreScroll(View view, int i, int i2, int[] iArr, int i3) {
        if (view == this.listView && this.transactionsLayout.isAttachedToWindow()) {
            ...
            if (i2 >= 0) {
                if (i2 > 0) {
                    RecyclerListView currentListView = this.transactionsLayout.getCurrentListView();
                    if (this.listView.getHeight() - bottom < this.listView.getPaddingBottom() + AndroidUtilities.m1081dp(8.0f) || currentListView == null || currentListView.canScrollVertically(1)) {
                        return;
                    }
                    iArr[1] = i2;
