...
import org.telegram.p026ui.Components.EarListener;
import org.telegram.p026ui.Components.LayoutHelper;
import org.telegram.p026ui.Components.ScaleStateListAnimator;
import org.telegram.p026ui.Components.SeekBarWaveform;
...
public class SecretVoicePlayer extends Dialog {
    ...
    private float f2085tx;

    /* JADX INFO: renamed from: ty */
    private float f2086ty;
    ...
    public void setupTranslation() {
        ...
        if (chatMessageCell != null) {
            ...
            this.f2085tx = f - ((((width - rect.left) - rect.right) - this.cell.getWidth()) / 2.0f);
            float f2 = iArr[1] - this.insets.top;
            int height = this.windowView.getHeight();
            Rect rect2 = this.insets;
            this.f2086ty = f2 - (((((height - rect2.top) - rect2.bottom) - this.cell.getHeight()) - this.heightdiff) / 2.0f);
    ...
    public void updateTranslation() {
        ...
        this.myCell.setTranslationX(AndroidUtilities.lerp(this.f2085tx, this.dtx, this.openProgress));
        this.myCell.setTranslationY(AndroidUtilities.lerp(this.f2086ty, this.dty, this.openProgress));
        HintView2 hintView2 = this.hintView;
        if (hintView2 != null) {
            hintView2.setTranslationX(AndroidUtilities.lerp(this.f2085tx, this.dtx, this.openProgress));
            this.hintView.setTranslationY(AndroidUtilities.lerp(this.f2086ty, this.dty, this.openProgress));
        }
    }
    ...
    public void setCell(ChatMessageCell chatMessageCell, Runnable runnable, Runnable runnable2) {
        ...
        if (this.cell != null) {
            ...
            if (this.isRound) {
                height = Math.min(AndroidUtilities.m1081dp(360.0f), Math.min(width, AndroidUtilities.displaySize.y));
            }
            final int i = height;
            ...
            ChatMessageCell chatMessageCell5 = new ChatMessageCell(getContext(), UserConfig.selectedAccount, false, null, this.cell.getResourcesProvider()) { // from class: org.telegram.ui.SecretVoicePlayer.4
                ...
                @Override // org.telegram.p026ui.Cells.ChatMessageCell, org.telegram.p026ui.Cells.BaseCell
                ...
                public void drawReactionsLayout(Canvas canvas, float f, Integer num) {
                    canvas.save();
                    canvas.translate(AndroidUtilities.lerp(0, -this.reactionsLayoutInBubble.f2004x, SecretVoicePlayer.this.openProgress), AndroidUtilities.lerp(SecretVoicePlayer.this.cell.getBackgroundDrawableBottom() - getBackgroundDrawableBottom(), this.reactionsLayoutInBubble.totalHeight, SecretVoicePlayer.this.openProgress));
                ...
                public void drawTime(Canvas canvas, float f, boolean z) {
                    ...
                    if (SecretVoicePlayer.this.isRound) {
                        ...
                        canvas.translate(((this.toRect.right - (i2 + AndroidUtilities.m1081dp(8 + i3))) - this.timeX) * SecretVoicePlayer.this.openProgress, 0.0f);
                    }
                ...
                public void drawBlurredPhoto(Canvas canvas) {
                    if (this.radialPaint != null) {
                        ...
                        canvas.saveLayerAlpha(SecretVoicePlayer.this.rect, Function.USE_VARARGS, 31);
                    ...
                    this.progressPaint.setStrokeWidth(AndroidUtilities.m1081dp(3.33f));
                    this.progressPaint.setColor(-1);
                    this.progressPaint.setStrokeCap(Paint.Cap.ROUND);
                    RectF rectF = AndroidUtilities.rectTmp;
                    rectF.set(SecretVoicePlayer.this.rect);
                    rectF.inset(AndroidUtilities.m1081dp(7.0f), AndroidUtilities.m1081dp(7.0f));
                    ...
                    this.progressPaint.setStrokeWidth(AndroidUtilities.m1081dp(2.8f));
        ...
        if (chatMessageCell8 != null && chatMessageCell8.getMessageObject() != null) {
            ...
            videoPlayer2.setDelegate(new C63916());
        ...
        if (messageObject4 != null && messageObject4.getDialogId() != UserConfig.getInstance(this.messageObject.currentAccount).getClientUserId()) {
            ...
            if (z) {
                ...
                this.hintView.setText(AndroidUtilities.replaceTags(LocaleController.formatString(this.isRound ? C2702R.string.VideoOnceOutHint : C2702R.string.VoiceOnceOutHint, firstName)));
            } else {
                this.hintView.setText(AndroidUtilities.replaceTags(LocaleController.getString(this.isRound ? C2702R.string.VideoOnceHint : C2702R.string.VoiceOnceHint)));
            }
            this.hintView.setRounding(12.0f);
            this.hintView.setPadding(AndroidUtilities.m1081dp((z || this.cell.pinnedBottom) ? 0.0f : 6.0f), 0, 0, 0);
            if (this.isRound) {
                this.hintView.setJointPx(0.5f, 0.0f);
                this.hintView.setTextAlign(Layout.Alignment.ALIGN_CENTER);
            } else {
                this.hintView.setJointPx(0.0f, AndroidUtilities.m1081dp(34.0f));
        ...
        this.closeButton.setPadding(AndroidUtilities.m1081dp(12.0f), AndroidUtilities.m1081dp(6.0f), AndroidUtilities.m1081dp(12.0f), AndroidUtilities.m1081dp(6.0f));
        ScaleStateListAnimator.apply(this.closeButton);
        this.closeButton.setText(LocaleController.getString(z ? C2702R.string.VoiceOnceClose : C2702R.string.VoiceOnceDeleteClose));
    ...
    class C63916 implements VideoPlayer.VideoPlayerDelegate {
    ...
    public void onBackPressed() {
        ...
        if (!this.dismissing && (messageObject = this.messageObject) != null && !messageObject.isOutOwner()) {
            AlertDialog alertDialogCreate = new AlertDialog.Builder(getContext(), this.resourcesProvider).setTitle(LocaleController.getString(this.isRound ? C2702R.string.VideoOnceCloseTitle : C2702R.string.VoiceOnceCloseTitle)).setMessage(LocaleController.getString(this.isRound ? C2702R.string.VideoOnceCloseMessage : C2702R.string.VoiceOnceCloseMessage)).setPositiveButton(LocaleController.getString(C2702R.string.Continue), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.SecretVoicePlayer$$ExternalSyntheticLambda5
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog2, int i) {
                    this.f$0.lambda$onBackPressed$3(alertDialog2, i);
                }
            }).setNegativeButton(LocaleController.getString(C2702R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.SecretVoicePlayer$$ExternalSyntheticLambda6
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog2, int i) {
