...
public class ChooseDownloadQualityLayout {
    ...
    public ChooseDownloadQualityLayout(Context context, final PopupSwipeBackLayout popupSwipeBackLayout, Callback callback) {
        ...
        ActionBarMenuSubItem actionBarMenuSubItemAddItem = ActionBarMenuItem.addItem(actionBarPopupWindowLayout, C2702R.drawable.msg_arrow_back, LocaleController.getString(C2702R.string.Back), false, null);
    ...
    public boolean update(final MessageObject messageObject) {
        ...
        for (int i2 = 0; i2 < qualities.size(); i2++) {
            ...
            sb.append(LocaleController.formatString(C2702R.string.QualitySaveIn, Integer.valueOf(quality.m1224p())));
            sb.append(quality.original ? " (" + LocaleController.getString(C2702R.string.QualitySource) + ")" : _UrlKt.FRAGMENT_ENCODE_SET);
            ...
            if (downloadUri.isCached()) {
                ...
                spannableStringBuilder.append(LocaleController.getString(C2702R.string.QualityCached));
            } else {
                SpannableString spannableString = new SpannableString("s ");
                ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C2702R.drawable.msg_mini_arrow_mediabold);
                coloredImageSpan.rotate(90.0f);
                coloredImageSpan.translate(0.0f, AndroidUtilities.m1081dp(1.0f));
