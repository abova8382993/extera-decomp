...
public class TwoStepVerificationActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public android.view.View createView(android.content.Context r31) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.TwoStepVerificationActivity.createView(android.content.Context):android.view.View");
    }
    ...
    public /* synthetic */ void lambda$createView$7(View view, int i) {
        ...
        if (i == this.turnPasswordOffRow) {
            ...
            String string2 = LocaleController.getString(C2702R.string.TurnPasswordOffQuestionTitle);
            String string3 = LocaleController.getString(C2702R.string.Disable);
    ...
    */
    public void onConfigurationChanged(android.content.res.Configuration r3) {
        ...
        L1e:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.TwoStepVerificationActivity.onConfigurationChanged(android.content.res.Configuration):void");
    }
    ...
    private void cancelPasswordReset() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
        builder.setPositiveButton(LocaleController.getString(C2702R.string.CancelPasswordResetYes), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.TwoStepVerificationActivity$$ExternalSyntheticLambda15
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
                this.f$0.lambda$cancelPasswordReset$10(alertDialog, i);
            }
        });
        builder.setNegativeButton(LocaleController.getString(C2702R.string.CancelPasswordResetNo), null);
        builder.setTitle(LocaleController.getString(C2702R.string.CancelReset));
        builder.setMessage(LocaleController.getString(C2702R.string.CancelPasswordReset));
    ...
    public /* synthetic */ void lambda$resetPassword$12(TLObject tLObject) {
        ...
        if (tLObject instanceof TL_account.resetPasswordOk) {
            ...
            builder.setMessage(LocaleController.getString(C2702R.string.RestorePasswordResetPasswordOk));
        ...
        if (tLObject instanceof TL_account.resetPasswordFailedWait) {
            ...
            showAlertWithText(LocaleController.getString(C2702R.string.ResetPassword), LocaleController.formatString("ResetPasswordWait", C2702R.string.ResetPasswordWait, pluralString));
        }
    }
    ...
    */
    public void updateBottomButton() {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.TwoStepVerificationActivity.updateBottomButton():void");
    }
    ...
    private void onPasswordForgot() {
        ...
        if (this.currentPassword.pending_reset_date != 0) {
            if (getConnectionsManager().getCurrentTime() > this.currentPassword.pending_reset_date) {
                AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                builder.setPositiveButton(LocaleController.getString(C2702R.string.Reset), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.TwoStepVerificationActivity$$ExternalSyntheticLambda2
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                    public final void onClick(AlertDialog alertDialog, int i) {
                ...
                builder.setNegativeButton(LocaleController.getString(C2702R.string.Cancel), null);
                builder.setTitle(LocaleController.getString(C2702R.string.ResetPassword));
                builder.setMessage(LocaleController.getString(C2702R.string.RestorePasswordResetPasswordText));
                AlertDialog alertDialogCreate = builder.create();
                showDialog(alertDialogCreate);
                TextView textView = (TextView) alertDialogCreate.getButton(-1);
                if (textView != null) {
        ...
        builder2.setPositiveButton(LocaleController.getString(C2702R.string.Reset), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.TwoStepVerificationActivity$$ExternalSyntheticLambda3
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
        ...
        builder2.setTitle(LocaleController.getString(C2702R.string.ResetPassword));
        builder2.setMessage(LocaleController.getString(C2702R.string.RestorePasswordNoEmailText2));
    ...
    public /* synthetic */ void lambda$onPasswordForgot$14(TLRPC.TL_error tL_error, TLObject tLObject) {
        ...
        if (tL_error == null) {
            ...
            TwoStepVerificationSetupActivity twoStepVerificationSetupActivity = new TwoStepVerificationSetupActivity(this.currentAccount, 4, password) { // from class: org.telegram.ui.TwoStepVerificationActivity.4
                @Override // org.telegram.p026ui.TwoStepVerificationSetupActivity
    ...
    public static void initPasswordNewAlgo(TL_account.Password password) {
        ...
        if (passwordKdfAlgo instanceof TLRPC.C2781xb6caa888) {
            TLRPC.C2781xb6caa888 c2781xb6caa888 = (TLRPC.C2781xb6caa888) passwordKdfAlgo;
            byte[] bArr = new byte[c2781xb6caa888.salt1.length + 32];
            Utilities.random.nextBytes(bArr);
            byte[] bArr2 = c2781xb6caa888.salt1;
            System.arraycopy(bArr2, 0, bArr, 0, bArr2.length);
            c2781xb6caa888.salt1 = bArr;
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType != 0) {
                ...
                if (i == TwoStepVerificationActivity.this.setPasswordDetailRow) {
                    textInfoPrivacyCell.setText(LocaleController.getString(C2702R.string.SetAdditionalPasswordInfo));
                    return;
                } else {
                    if (i == TwoStepVerificationActivity.this.passwordEnabledDetailRow) {
                        textInfoPrivacyCell.setText(LocaleController.getString(C2702R.string.EnabledPasswordText));
                        return;
                    }
                    return;
                }
            ...
            if (i == TwoStepVerificationActivity.this.changePasswordRow) {
                textSettingsCell.setText(LocaleController.getString(C2702R.string.ChangePassword), true);
                return;
            }
            if (i == TwoStepVerificationActivity.this.setPasswordRow) {
                textSettingsCell.setText(LocaleController.getString(C2702R.string.SetAdditionalPassword), true);
                return;
            }
            if (i == TwoStepVerificationActivity.this.turnPasswordOffRow) {
                textSettingsCell.setText(LocaleController.getString(C2702R.string.TurnPasswordOff), true);
            } else if (i == TwoStepVerificationActivity.this.changeRecoveryEmailRow) {
                textSettingsCell.setText(LocaleController.getString(C2702R.string.ChangeRecoveryEmail), false);
            } else if (i == TwoStepVerificationActivity.this.setRecoveryEmailRow) {
                textSettingsCell.setText(LocaleController.getString(C2702R.string.SetRecoveryEmail), false);
            }
        }
    ...
    public void showSetForcePasswordAlert() {
        ...
        builder.setNegativeButton(LocaleController.getString(C2702R.string.ForceSetPasswordCancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.TwoStepVerificationActivity$$ExternalSyntheticLambda0
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
