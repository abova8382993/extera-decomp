...
import org.telegram.p026ui.Components.Premium.boosts.GiftInfoBottomSheet;
import org.telegram.p026ui.Components.Premium.boosts.cells.statistics.GiftedUserCell;
import org.telegram.p026ui.Components.Premium.boosts.cells.statistics.GiveawayCell;
...
public class BoostsActivity extends GradientHeaderActivity implements NotificationCenter.NotificationCenterDelegate {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            switch (i) {
                ...
                case 16:
                    ...
                    chartHeaderView.setPadding(chartHeaderView.getPaddingLeft(), AndroidUtilities.m1081dp(16.0f), chartHeaderView.getRight(), AndroidUtilities.m1081dp(16.0f));
                ...
                case 3:
                    ...
                    linkActionView.setPadding(AndroidUtilities.m1081dp(11.0f), 0, AndroidUtilities.m1081dp(11.0f), AndroidUtilities.m1081dp(24.0f));
                ...
                case 8:
                    FrameLayout frameLayout = new FrameLayout(BoostsActivity.this.getContext()) { // from class: org.telegram.ui.BoostsActivity.1.4
                        ...
                        protected void onMeasure(int i2, int i3) {
                            super.onMeasure(i2, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(50.0f), TLObject.FLAG_30));
                        }
                    };
                    TextView textView = new TextView(BoostsActivity.this.getContext());
                    textView.setText(LocaleController.getString(BoostsActivity.this.isChannel() ? C2702R.string.NoBoostersHint : C2702R.string.NoBoostersGroupHint));
                ...
                case 9:
                    ManageChatTextCell manageChatTextCell = new ManageChatTextCell(BoostsActivity.this.getContext()) { // from class: org.telegram.ui.BoostsActivity.1.5
                        @Override // org.telegram.p026ui.Cells.ManageChatTextCell
                ...
                case 10:
                    ...
                    textCell.setTextAndIcon((CharSequence) LocaleController.formatString(C2702R.string.BoostingGetBoostsViaGifts, new Object[0]), C2702R.drawable.msg_gift_premium, false);
                ...
                case 12:
                    ...
                    chartHeaderView2.setPadding(chartHeaderView2.getPaddingLeft(), AndroidUtilities.m1081dp(16.0f), chartHeaderView2.getRight(), AndroidUtilities.m1081dp(8.0f));
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (viewHolder.getItemViewType() == 1 || viewHolder.getItemViewType() == 12 || viewHolder.getItemViewType() == 16) {
                ...
                if (viewHolder.getItemViewType() == 12) {
                    chartHeaderView.setPadding(AndroidUtilities.m1081dp(3.0f), chartHeaderView.getPaddingTop(), chartHeaderView.getPaddingRight(), chartHeaderView.getPaddingBottom());
                    return;
                }
                return;
            }
            if (viewHolder.getItemViewType() == 0) {
                ...
                overviewCell.setData(0, Integer.toString(BoostsActivity.this.boostsStatus.level), null, LocaleController.getString(C2702R.string.BoostsLevel2));
                if (BoostsActivity.this.boostsStatus.premium_audience == null || BoostsActivity.this.boostsStatus.premium_audience.total == 0.0d) {
                    overviewCell.setData(1, "~0", "0%", LocaleController.getString(BoostsActivity.this.isChannel() ? C2702R.string.PremiumSubscribers : C2702R.string.PremiumMembers));
                } else {
                    ...
                    overviewCell.setData(1, "≈" + ((int) BoostsActivity.this.boostsStatus.premium_audience.part), String.format(Locale.US, "%.1f", Float.valueOf(f)) + "%", LocaleController.getString(BoostsActivity.this.isChannel() ? C2702R.string.PremiumSubscribers : C2702R.string.PremiumMembers));
                }
                overviewCell.setData(2, String.valueOf(BoostsActivity.this.boostsStatus.boosts), null, LocaleController.getString(C2702R.string.BoostsExisting));
                overviewCell.setData(3, String.valueOf(Math.max(0, BoostsActivity.this.boostsStatus.next_level_boosts - BoostsActivity.this.boostsStatus.boosts)), null, LocaleController.getString(C2702R.string.BoostsToLevel));
                overviewCell.setPadding(AndroidUtilities.m1081dp(23.0f), overviewCell.getPaddingTop(), AndroidUtilities.m1081dp(23.0f), overviewCell.getPaddingBottom());
                return;
            }
            if (viewHolder.getItemViewType() == 5) {
                ...
                if (boost.multiplier > 1) {
                    string = LocaleController.formatString("BoostsExpireOn", C2702R.string.BoostsExpireOn, LocaleController.formatDate(boost.expires));
                } else {
                    string = LocaleController.formatString("BoostExpireOn", C2702R.string.BoostExpireOn, LocaleController.formatDate(boost.expires));
                }
            ...
            if (viewHolder.getItemViewType() == 9) {
                ...
                if (BoostsActivity.this.selectedTab == 0) {
                    manageChatTextCell.setText(LocaleController.formatPluralString("BoostingShowMoreBoosts", BoostsActivity.this.nextBoostRemaining, new Object[0]), null, C2702R.drawable.arrow_more, false);
                    return;
                } else {
                    manageChatTextCell.setText(LocaleController.formatPluralString("BoostingShowMoreGifts", BoostsActivity.this.nextGiftsRemaining, new Object[0]), null, C2702R.drawable.arrow_more, false);
                    return;
                }
            }
    ...
    public void updateRows(boolean z) {
        ...
        if (this.boostsStatus != null) {
            this.items.add(new ItemInternal(16, LocaleController.getString(C2702R.string.StatisticOverview)));
            ...
            if (this.boostsStatus.prepaid_giveaways.size() > 0) {
                this.items.add(new ItemInternal(12, LocaleController.getString(C2702R.string.BoostingPreparedGiveaways)));
                int i = 0;
                ...
                this.items.add(new ItemInternal(6, LocaleController.getString(C2702R.string.BoostingSelectPaidGiveaway)));
            }
            this.items.add(new ItemInternal(13, LocaleController.getString(C2702R.string.Boosters)));
            if (this.selectedTab == 0) {
                if (this.boosters.isEmpty()) {
                    ...
                    this.items.add(new ItemInternal(6, LocaleController.getString(isChannel() ? C2702R.string.BoostersInfoDescription : C2702R.string.BoostersInfoGroupDescription)));
                }
            ...
            this.items.add(new ItemInternal(1, LocaleController.getString(C2702R.string.LinkForBoosting)));
            ...
            if (MessagesController.getInstance(this.currentAccount).giveawayGiftsPurchaseAvailable && ChatObject.hasAdminRights(this.currentChat)) {
                this.items.add(new ItemInternal(6, LocaleController.getString(isChannel() ? C2702R.string.BoostingShareThisLink : C2702R.string.BoostingShareThisLinkGroup)));
                this.items.add(new ItemInternal(10, true));
                this.items.add(new ItemInternal(6, LocaleController.getString(isChannel() ? C2702R.string.BoostingGetMoreBoosts2 : C2702R.string.BoostingGetMoreBoostsGroup)));
            } else {
    ...
    private class ItemInternal extends AdapterWithDiffUtils.Item {
        ...
        public boolean equals(Object obj) {
            ...
            if (prepaidGiveaway2 != null && (prepaidGiveaway = itemInternal.prepaidGiveaway) != null) {
                return prepaidGiveaway2.f1806id == prepaidGiveaway.f1806id && this.isLast == itemInternal.isLast;
            }
            TL_stories.Boost boost = this.booster;
            if (boost == null || itemInternal.booster == null) {
                return true;
            }
            return boost.f1801id.hashCode() == itemInternal.booster.f1801id.hashCode() && this.isLast == itemInternal.isLast && this.tab == itemInternal.tab;
        }
    ...
    public void createEmptyView(Context context) {
        ...
        this.progressLayout.addView(new View(context) { // from class: org.telegram.ui.BoostsActivity.3
            private final CircularProgressDrawable drawable = new CircularProgressDrawable(AndroidUtilities.m1081dp(30.0f), AndroidUtilities.m1081dp(3.0f), Theme.getColor(Theme.key_dialogTextBlue));

            @Override // android.view.View
            protected void onDraw(Canvas canvas) {
                this.drawable.setBounds(0, 0, getWidth(), getHeight());
                this.drawable.setAlpha(Function.USE_VARARGS);
    ...
    private void resetHeader(boolean z) {
        ...
        if (this.limitPreviewView == null) {
            LimitPreviewView limitPreviewView = new LimitPreviewView(getContext(), C2702R.drawable.filled_limit_boost, 0, 0, this.resourceProvider);
        ...
        configureHeader(LocaleController.getString(isChannel() ? C2702R.string.BoostingBoostForChannels : C2702R.string.BoostingBoostForGroups), AndroidUtilities.replaceTags(LocaleController.getString(isChannel() ? C2702R.string.BoostingBoostForChannelsInfo : C2702R.string.BoostingBoostForGroupsInfo)), new FrameLayout(getContext()) { // from class: org.telegram.ui.BoostsActivity.4
            {
    ...
    class C30385 extends FrameLayout {
        ...
        C30385(Context context) {
            ...
            headerButtonView.setTextAndIcon(LocaleController.getString(C2702R.string.BoostBtn), C2702R.drawable.filled_boost_plus);
            headerButtonView2.setTextAndIcon(LocaleController.getString(C2702R.string.GiveawayBtn), C2702R.drawable.filled_gift_premium);
            headerButtonView3.setTextAndIcon(LocaleController.getString(C2702R.string.FeaturesBtn), C2702R.drawable.filled_info);
    ...
    private class HeaderButtonView extends FrameLayout {
        ...
        public HeaderButtonView(Context context) {
            ...
            setMinimumWidth(AndroidUtilities.m1081dp(100.0f));
            setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1081dp(10.0f), 0, ColorUtils.setAlphaComponent(-16777216, 80)));
        }
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.drawRoundRect(this.rect, AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(10.0f), BoostsActivity.this.setDarkGradientLocation(((ViewGroup) getParent()).getX() + getX(), ((ViewGroup) getParent().getParent().getParent()).getY()));
            invalidate();
            super.draw(canvas);
        }
    }
        ...
        if (view instanceof GiftedUserCell) {
            ...
            if (z && boost.stars > 0) {
                ...
                if (((z2 || z) && boost.user_id >= 0) || boost.unclaimed) {
                    ...
                    tL_payments_checkedGiftCode.from_id = MessagesController.getInstance(UserConfig.selectedAccount).getPeer(-this.currentChat.f1610id);
                    int i2 = boost.date;
                    ...
                    lottieLayout.setAnimation(C2702R.raw.chats_infotip, 36, 36, new String[0]);
                    lottieLayout.textView.setText(LocaleController.getString(C2702R.string.BoostingRecipientWillBeSelected));
                    lottieLayout.textView.setSingleLine(false);
                    lottieLayout.textView.setMaxLines(2);
                    Bulletin.make(this, lottieLayout, 2750).show();
                } else if (!z2 && !z) {
                    presentFragment(ProfileActivity.m1243of(giftedUserCell.getDialogId()));
                }
            }
            boostsActivity = this;
        } else {
