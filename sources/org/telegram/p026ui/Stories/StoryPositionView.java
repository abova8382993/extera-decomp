...
public class StoryPositionView {
    ...
    public StoryPositionView() {
        ...
        spannableStringBuilder.append((CharSequence) " ").setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m1081dp(1.0f)), 0, 1, 0);
        SpannableStringBuilder spannableStringBuilder2 = new SpannableStringBuilder();
        this.rightSpace = spannableStringBuilder2;
        spannableStringBuilder2.append((CharSequence) " ").setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m1081dp(1.0f)), 0, 1, 0);
    }
    ...
    public void draw(Canvas canvas, float f, int i, int i2, FrameLayout frameLayout, PeerStoriesView.PeerHeaderView peerHeaderView) {
        ...
        canvas.translate(((((AndroidUtilities.m1081dp(4.0f) + peerHeaderView.getLeft()) + peerHeaderView.titleView.getLeft()) + peerHeaderView.titleView.getTextWidth()) + peerHeaderView.titleView.getRightDrawableWidth()) - Utilities.clamp(((peerHeaderView.titleView.getTextWidth() + peerHeaderView.titleView.getRightDrawableWidth()) + r8) - peerHeaderView.titleView.getWidth(), r8, 0), y);
        float fM1081dp = AndroidUtilities.m1081dp(8.0f);
        float fM1081dp2 = AndroidUtilities.m1081dp(2.0f);
        AndroidUtilities.rectTmp.set(-fM1081dp, -fM1081dp2, this.textDrawable.getCurrentWidth() + fM1081dp, this.textDrawable.getHeight() + fM1081dp2);
