...
import org.telegram.p026ui.Stories.recorder.LivePlayerView;
...
public class StoryViewer implements NotificationCenter.NotificationCenterDelegate, BaseFragment.AttachedSheet, IPipSourceDelegate {
    ...
    public void open(int i, Context context, TL_stories.StoryItem storyItem, ArrayList arrayList, int i2, StoriesController.StoriesList storiesList, TL_stories.PeerStories peerStories, PlaceProvider placeProvider, boolean z) {
        ...
        if (this.windowView == null) {
            this.gestureDetector = new GestureDetector(new GestureDetector.OnGestureListener() { // from class: org.telegram.ui.Stories.StoryViewer.1
                ...
                GestureDetectorOnGestureListenerC67541() {
                }
                ...
                */
                public boolean onScroll(android.view.MotionEvent r4, android.view.MotionEvent r5, float r6, float r7) {
                    ...
                    */
                    throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Stories.StoryViewer.GestureDetectorOnGestureListenerC67541.onScroll(android.view.MotionEvent, android.view.MotionEvent, float, float):boolean");
                }
        ...
        if (this.containerView == null) {
            this.containerView = new HwFrameLayout(context) { // from class: org.telegram.ui.Stories.StoryViewer.3
                ...
                protected void dispatchDraw(Canvas canvas) {
                    ...
                    if (currentPeerView != null) {
                        StoryViewer.this.volumeControl.setTranslationY(((currentPeerView.getY() + currentPeerView.storyContainer.getY()) - StoryViewer.this.volumeControl.getTop()) - AndroidUtilities.m1081dp(4.0f));
                    }
                    super.dispatchDraw(canvas);
                }
            };
            C67584 c67584 = new HwStoriesViewPager(this.currentAccount, context2, this, this.resourcesProvider) { // from class: org.telegram.ui.Stories.StoryViewer.4
                C67584(int i4, Context context2, final StoryViewer this, Theme.ResourcesProvider resourcesProvider) {
                    super(i4, context2, this, resourcesProvider);
                }

                @Override // org.telegram.p026ui.Stories.StoriesViewPager
            ...
            this.storiesViewPager = c67584;
            c67584.setDelegate(new C67595(storiesList, arrayList, context2));
            ...
            if (this.USE_SURFACE_VIEW) {
                ...
                C67606 c67606 = new HwTextureView(context2) { // from class: org.telegram.ui.Stories.StoryViewer.6
                    C67606(Context context2) {
                        super(context2);
                    }

                    @Override // org.telegram.p026ui.Stories.HwTextureView, android.view.View
                ...
                this.textureView = c67606;
                this.aspectRatioFrameLayout.addView(c67606);
            }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class GestureDetectorOnGestureListenerC67541 implements GestureDetector.OnGestureListener {
        @Override // android.view.GestureDetector.OnGestureListener
        public void onLongPress(MotionEvent motionEvent) {
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C67562 extends SizeNotifierFrameLayout {
        float lastTouchX;
        SparseArray lastX;
        ...
        C67562(Context context, BaseFragment baseFragment) {
            super(context);
        ...
        /* JADX WARN: Removed duplicated region for block: B:744:0x016c  */
        /* JADX WARN: Removed duplicated region for block: B:831:0x05c3 A[LOOP:1: B:819:0x058f->B:831:0x05c3, LOOP_END] */
        /* JADX WARN: Removed duplicated region for block: B:925:0x05cb A[EDGE_INSN: B:925:0x05cb->B:832:0x05cb BREAK  A[LOOP:1: B:819:0x058f->B:831:0x05c3], SYNTHETIC] */
        ...
        */
        protected void dispatchDraw(android.graphics.Canvas r21) {
            /*
                Method dump skipped, instruction units count: 2233
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Stories.StoryViewer.C67562.dispatchDraw(android.graphics.Canvas):void");
        }
        ...
        /* JADX WARN: Removed duplicated region for block: B:472:0x0168  */
        @Override // android.view.ViewGroup, android.view.View
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        public boolean dispatchTouchEvent(android.view.MotionEvent r19) {
            /*
                ...
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Stories.StoryViewer.C67562.dispatchTouchEvent(android.view.MotionEvent):boolean");
        }
        ...
        /* JADX WARN: Removed duplicated region for block: B:566:0x003e  */
        /* JADX WARN: Removed duplicated region for block: B:572:0x005d  */
        @Override // android.view.ViewGroup
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        public boolean onInterceptTouchEvent(android.view.MotionEvent r15) {
            /*
                ...
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Stories.StoryViewer.C67562.onInterceptTouchEvent(android.view.MotionEvent):boolean");
        }
        ...
        protected void onAttachedToWindow() {
            ...
            Bulletin.addDelegate(this, new Bulletin.Delegate() { // from class: org.telegram.ui.Stories.StoryViewer.2.3
                ...
                public int getBottomOffset(int i) {
                    ...
                    return (int) (C67562.this.getMeasuredHeight() - (this.position[1] + currentPeerView.storyContainer.getMeasuredHeight()));
                }
            });
        ...
        protected void onMeasure(int i, int i2) {
            ((FrameLayout.LayoutParams) StoryViewer.this.volumeControl.getLayoutParams()).topMargin = AndroidUtilities.statusBarHeight - AndroidUtilities.m1081dp(2.0f);
            StoryViewer.this.volumeControl.getLayoutParams().height = AndroidUtilities.m1081dp(2.0f);
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C67573 extends HwFrameLayout {
        C67573(Context context2) {
            super(context2);
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C67584 extends HwStoriesViewPager {
        C67584(int i4, Context context2, final StoryViewer this, Theme.ResourcesProvider resourcesProvider) {
            super(i4, context2, this, resourcesProvider);
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C67595 implements PeerStoriesView.Delegate {
        final /* synthetic */ Context val$context;
        final /* synthetic */ ArrayList val$peerIds;
        final /* synthetic */ StoriesController.StoriesList val$storiesList;

        C67595(StoriesController.StoriesList storiesList, ArrayList arrayList, Context context) {
        ...
        public void requestPlayer(TLRPC.Document document, Uri uri, long j, PeerStoriesView.VideoPlayerSharedScope videoPlayerSharedScope) {
                ...
                if (storyViewer2.progressToOpen >= 0.9f) {
                    ...
                    if (!zEquals || (videoPlayerHolder = (storyViewer = StoryViewer.this).playerHolder) == null) {
                        ...
                        if (uri != null) {
                            ...
                            FileLog.m1090d("StoryViewer requestPlayer: currentPlayerScope.player start " + uri);
                            ...
                            FileLog.m1090d("StoryViewer requestPlayer: url is null (1)");
                        }
                    } else if (zEquals) {
                        ...
                        FileLog.m1090d("StoryViewer requestPlayer: same url");
                    }
            ...
            FileLog.m1090d("StoryViewer requestPlayer ignored, because closed: " + StoryViewer.this.isClosed + ", " + StoryViewer.this.progressToOpen);
            videoPlayerSharedScope.firstFrameRendered = false;
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C67606 extends HwTextureView {
        C67606(Context context2) {
            super(context2);
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C67617 extends AnimatorListenerAdapter {
        final /* synthetic */ boolean val$open;
    ...
    public /* synthetic */ void lambda$cancelSwipeToReply$6(ValueAnimator valueAnimator) {
        ...
        this.swipeToReplyProgress = Utilities.clamp(this.swipeToReplyOffset / AndroidUtilities.m1081dp(200.0f), 1.0f, 0.0f);
        StoriesViewPager storiesViewPager = this.storiesViewPager;
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C67628 extends AnimatorListenerAdapter {
        C67628() {
        }
    ...
    private void updateTransitionParams() {
        if (this.placeProvider != null) {
            ...
            int i = (currentPeerView == null || selectedPosition < 0 || selectedPosition >= currentPeerView.storyItems.size()) ? 0 : ((TL_stories.StoryItem) currentPeerView.storyItems.get(selectedPosition)).f1807id;
    ...
    public void updateProgressToDismiss() {
        float fClamp01 = Utilities.clamp01(Math.abs(Math.max(this.swipeToDismissHorizontalOffset, this.swipeToDismissOffset) / AndroidUtilities.m1081dp(80.0f)));
    ...
    public void startOpenAnimation() {
        ...
        this.openCloseAnimator.addListener(new C67639());
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C67639 extends AnimatorListenerAdapter {
        C67639() {
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C675510 extends AnimatorListenerAdapter {
        C675510() {
        }
    ...
    public View mo5374getWindowView() {
    ...
    public void openFor(BaseFragment baseFragment, RecyclerListView recyclerListView, ChatActionCell chatActionCell) {
        ...
        open(baseFragment.getContext(), messageObject.messageOwner.media.storyItem, StoriesListPlaceProvider.m1269of(recyclerListView));
    }
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
            ...
            if (this.storiesList == ((StoriesController.StoriesList) objArr[0])) {
                ...
                if (selfStoryViewsView != null) {
                    ...
                    while (i3 < this.storiesList.messageObjects.size()) {
                        if (selectedStory != null && selectedStory.f1807id == ((MessageObject) this.storiesList.messageObjects.get(i3)).storyItem.f1807id) {
                            i4 = i3;
                        }
        ...
        if (i == NotificationCenter.storyDeleted) {
            ...
            if (storyItem != null && storyItem.dialogId == jLongValue && storyItem.f1807id == iIntValue) {
    ...
    private long draftHash(long j, TL_stories.StoryItem storyItem) {
        return j + (j >> 16) + (((long) storyItem.f1807id) << 16);
    }
    ...
    public interface PlaceProvider {
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Stories.StoryViewer$PlaceProvider$-CC */
    ...
    public class VideoPlayerHolder extends VideoPlayerHolderBase {
        ...
        public /* synthetic */ void lambda$onStateChanged$0() {
            ...
            FileLog.m1090d("StoryViewer displayed story buffering dialogId=" + currentPeerView.getCurrentPeer() + " storyId=" + currentPeerView.currentStory.storyItem.f1807id);
        }
        ...
        public /* synthetic */ void lambda$onStateChanged$1() {
            ...
            FileLog.m1090d("StoryViewer displayed story playing dialogId=" + currentPeerView.getCurrentPeer() + " storyId=" + currentPeerView.currentStory.storyItem.f1807id);
        }
    }
