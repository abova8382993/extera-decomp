...
import org.telegram.p026ui.ChooseSpeedLayout;
...
import org.telegram.p026ui.Components.BitmapShaderTools;
...
import org.telegram.p026ui.Components.CustomPopupMenu;
import org.telegram.p026ui.Components.EditTextCaption;
import org.telegram.p026ui.Components.EmojiPacksAlert;
import org.telegram.p026ui.Components.HashtagActivity;
import org.telegram.p026ui.Components.HintView;
import org.telegram.p026ui.Components.InstantCameraView;
...
import org.telegram.p026ui.Components.MentionsContainerView;
...
import org.telegram.p026ui.Components.Reactions.ReactionsUtils;
...
import org.telegram.p026ui.Components.SpeedIconDrawable;
import org.telegram.p026ui.Components.Text;
import org.telegram.p026ui.Components.TranslateAlert2;
import org.telegram.p026ui.Components.URLSpanMono;
import org.telegram.p026ui.Components.URLSpanNoUnderline;
import org.telegram.p026ui.Components.URLSpanReplacement;
import org.telegram.p026ui.Components.URLSpanUserMention;
...
import org.telegram.p026ui.ReportBottomSheet;
...
import org.telegram.p026ui.Stories.PaidReactionButton;
import org.telegram.p026ui.Stories.PeerStoriesView;
import org.telegram.p026ui.Stories.SelfStoriesPreviewView;
...
import org.telegram.p026ui.Stories.recorder.DraftsController;
...
public abstract class PeerStoriesView extends SizeNotifierFrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    class C66661 implements PinchToZoomHelper.Callback {
    ...
    public PeerStoriesView(final Context context, final StoryViewer storyViewer, final SharedResources sharedResources, final Theme.ResourcesProvider resourcesProvider) {
        ...
        C66752 c66752 = new ImageReceiver() { // from class: org.telegram.ui.Stories.PeerStoriesView.2
            C66752() {
            }
        ...
        this.imageReceiver = c66752;
        c66752.setCrossfadeWithOldImage(false);
        c66752.setAllowLoadingOnAttachedOnly(true);
        c66752.ignoreNotifications = true;
        c66752.setFileLoadingPriority(0);
        ...
        c66752.setPreloadingReceivers(Arrays.asList(imageReceiver5, imageReceiver6));
        ...
        this.storyAreasView = new StoryMediaAreasView(context, this.storyContainer, resourcesProvider) { // from class: org.telegram.ui.Stories.PeerStoriesView.3
            ...
            C66863(final Context context2, View view, final Theme.ResourcesProvider resourcesProvider2, final StoryViewer storyViewer2) {
                super(context2, view, resourcesProvider2);
                storyViewer = storyViewer2;
            }

            @Override // org.telegram.p026ui.Stories.StoryMediaAreasView
            ...
            @Override // org.telegram.p026ui.Stories.StoryMediaAreasView, android.view.View
        ...
        if (Build.VERSION.SDK_INT >= 31 && SharedConfig.canBlurChat()) {
            ...
            blurredBackgroundSourceRenderNode.setBlur(AndroidUtilities.m1081dp(8.0f));
        ...
        blurredBackgroundDrawableCreate.setThickness(AndroidUtilities.m1081dp(32.0f));
        C66974 c66974 = new C66974(context2, sharedResources, storyViewer2);
        this.storyContainer = c66974;
        c66974.setClipChildren(false);
        ...
        C67005 c67005 = new C67005(getContext(), storyViewer2.resourcesProvider, storyViewer2, resourcesProvider2);
        this.storyCaptionView = c67005;
        c67005.captionTextview.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda7
        ...
        if (!DISABLE_STORY_REPOSTING) {
            ...
            this.repostButton.setPadding(iM1081dp, iM1081dp, iM1081dp, iM1081dp);
            C67016 c67016 = new FrameLayout(getContext()) { // from class: org.telegram.ui.Stories.PeerStoriesView.6
                C67016(Context context2) {
                    super(context2);
                }
                ...
                protected void dispatchDraw(Canvas canvas) {
                    ...
                    canvas.save();
                    canvas.translate((getMeasuredWidth() - PeerStoriesView.this.repostCounter.getCurrentWidth()) - AndroidUtilities.m1081dp(6.0f), 0.0f);
                    float f = PeerStoriesView.this.repostCounterProgress.set(PeerStoriesView.this.repostCounterVisible ? 1.0f : 0.0f);
                    canvas.scale(f, f, PeerStoriesView.this.repostCounter.getCurrentWidth() / 2.0f, AndroidUtilities.m1081dp(20.0f));
                    PeerStoriesView.this.repostCounter.setAlpha(Function.USE_VARARGS);
        ...
        C67027 c67027 = new FrameLayout(getContext()) { // from class: org.telegram.ui.Stories.PeerStoriesView.7
            C67027(Context context2) {
                super(context2);
            }
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                canvas.save();
                canvas.translate((getMeasuredWidth() - PeerStoriesView.this.reactionsCounter.getCurrentWidth()) - AndroidUtilities.m1081dp(6.0f), 0.0f);
                float f = PeerStoriesView.this.reactionsCounterProgress.set(PeerStoriesView.this.reactionsCounterVisible ? 1.0f : 0.0f);
                canvas.scale(f, f, PeerStoriesView.this.reactionsCounter.getCurrentWidth() / 2.0f, AndroidUtilities.m1081dp(20.0f));
                PeerStoriesView.this.reactionsCounter.setAlpha(Function.USE_VARARGS);
        ...
        this.likeButtonContainer = c67027;
        AnimatedTextView.AnimatedTextDrawable animatedTextDrawable2 = this.reactionsCounter;
        if (animatedTextDrawable2 != null) {
            animatedTextDrawable2.setCallback(c67027);
        }
        c67027.setWillNotDraw(false);
        c67027.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda10
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$new$4(view);
            }
        });
        c67027.setOnLongClickListener(new View.OnLongClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda11
        ...
        linearLayout.addView(c67027, LayoutHelper.createLinear(40, 40, 5));
        ...
        imageView3.setPadding(AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(8.0f));
        ...
        imageView4.setPadding(AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(8.0f));
        ...
        C67049 c67049 = new FrameLayout(context2) { // from class: org.telegram.ui.Stories.PeerStoriesView.9
            C67049(final Context context2) {
                super(context2);
            }
        ...
        this.muteIconContainer = c67049;
        this.storyContainer.addView(c67049, LayoutHelper.createFrame(40, 40.0f, 53, 2.0f, 15.0f, 42.0f, 0.0f));
        RLottieImageView rLottieImageView = new RLottieImageView(context2);
        this.muteIconView = rLottieImageView;
        rLottieImageView.setPadding(AndroidUtilities.m1081dp(6.0f), AndroidUtilities.m1081dp(6.0f), AndroidUtilities.m1081dp(6.0f), AndroidUtilities.m1081dp(6.0f));
        c67049.addView(rLottieImageView);
        ImageView imageView5 = new ImageView(context2);
        this.noSoundIconView = imageView5;
        imageView5.setPadding(AndroidUtilities.m1081dp(6.0f), AndroidUtilities.m1081dp(6.0f), AndroidUtilities.m1081dp(6.0f), AndroidUtilities.m1081dp(6.0f));
        imageView5.setImageDrawable(sharedResources.noSoundDrawable);
        c67049.addView(imageView5);
        ...
        c67049.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda5
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        this.storyContainer.addView(c67005, LayoutHelper.createFrame(-1, -1.0f, 0, 0.0f, 64.0f, 0.0f, 0.0f));
        ...
        C666710 c666710 = new LiveCommentsView(context2, storyViewer2, storyViewer2.containerView, view, this.topBulletinContainer) { // from class: org.telegram.ui.Stories.PeerStoriesView.10
            final /* synthetic */ StoryViewer val$storyViewer;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C666710(final Context context2, final StoryViewer storyViewer2, ViewGroup viewGroup, View view2, FrameLayout frameLayout4, final StoryViewer storyViewer22) {
            ...
            @Override // org.telegram.p026ui.Stories.LiveCommentsView
        ...
        this.liveCommentsView = c666710;
        this.storyContainer.addView(view2, LayoutHelper.createFrame(-1, DataTypes.EMPTY, 87));
        this.storyContainer.addView(c666710, LayoutHelper.createFrame(-1, -1.0f, 0, 0.0f, 64.0f, 0.0f, 0.0f));
        this.storyContainer.addView(this.topBulletinContainer, LayoutHelper.createFrame(-1, 100.0f, 0, 0.0f, 55.0f, 0.0f, 0.0f));
        c67049.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1081dp(20.0f), 0, ColorUtils.setAlphaComponent(-1, 100)));
        imageView3.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1081dp(20.0f), 0, ColorUtils.setAlphaComponent(-1, 100)));
        imageView4.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1081dp(20.0f), 0, ColorUtils.setAlphaComponent(-1, 100)));
        imageView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1081dp(20.0f), 0, ColorUtils.setAlphaComponent(-1, 100)));
        c67027.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1081dp(20.0f), 0, ColorUtils.setAlphaComponent(-1, 100)));
        FrameLayout frameLayout4 = this.repostButtonContainer;
        if (frameLayout4 != null) {
            frameLayout4.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1081dp(20.0f), 0, ColorUtils.setAlphaComponent(-1, 100)));
        }
        View overlayView = c67005.textSelectionHelper.getOverlayView(context2);
        if (overlayView != null) {
            AndroidUtilities.removeFromParent(overlayView);
            addView(overlayView);
        }
        c67005.textSelectionHelper.setCallback(new TextSelectionHelper.Callback() { // from class: org.telegram.ui.Stories.PeerStoriesView.11
            C666811() {
            }
        ...
        c67005.textSelectionHelper.setParentView(this);
    }

    /* JADX INFO: renamed from: org.telegram.ui.Stories.PeerStoriesView$2 */
    class C66752 extends ImageReceiver {
        C66752() {
        }
    ...
    class C66863 extends StoryMediaAreasView {
        final /* synthetic */ StoryViewer val$storyViewer;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C66863(final Context context2, View view, final Theme.ResourcesProvider resourcesProvider2, final StoryViewer storyViewer22) {
            super(context2, view, resourcesProvider2);
            storyViewer = storyViewer22;
        }
    ...
    class C66974 extends HwFrameLayout {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C66974(Context context, SharedResources sharedResources, StoryViewer storyViewer) {
            super(context);
        ...
        /* JADX WARN: Removed duplicated region for block: B:752:0x01c6  */
        /* JADX WARN: Removed duplicated region for block: B:753:0x01c8  */
        /* JADX WARN: Removed duplicated region for block: B:888:0x0606  */
        @Override // android.view.ViewGroup, android.view.View
        /*
        ...
        */
        protected void dispatchDraw(android.graphics.Canvas r19) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Stories.PeerStoriesView.C66974.dispatchDraw(android.graphics.Canvas):void");
        }
        ...
        /* JADX WARN: Removed duplicated region for block: B:359:0x0117  */
        /* JADX WARN: Removed duplicated region for block: B:367:0x0138  */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        private void drawLines(android.graphics.Canvas r21) {
            /*
                ...
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Stories.PeerStoriesView.C66974.drawLines(android.graphics.Canvas):void");
        }
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (PeerStoriesView.this.drawLinesAsCounter()) {
                layoutParams.rightMargin = AndroidUtilities.m1081dp(2.0f);
                layoutParams.topMargin = AndroidUtilities.m1081dp(55.0f);
            } else {
                layoutParams.rightMargin = AndroidUtilities.m1081dp(42.0f);
                layoutParams.topMargin = AndroidUtilities.m1081dp(15.0f);
            }
    ...
    class C67005 extends StoryCaptionView {
        final /* synthetic */ Theme.ResourcesProvider val$resourcesProvider;
        final /* synthetic */ StoryViewer val$storyViewer;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C67005(Context context, Theme.ResourcesProvider resourcesProvider, StoryViewer storyViewer, Theme.ResourcesProvider resourcesProvider2) {
            super(context, resourcesProvider);
            this.val$storyViewer = storyViewer;
            this.val$resourcesProvider = resourcesProvider2;
        }

        @Override // org.telegram.p026ui.Stories.StoryCaptionView, androidx.core.widget.NestedScrollView, android.view.View
        public boolean onTouchEvent(MotionEvent motionEvent) {
            return super.onTouchEvent(motionEvent);
        }
        ...
        @Override // org.telegram.p026ui.Stories.StoryCaptionView
        public void onLinkClick(CharacterStyle characterStyle, View view) {
            ...
            if (characterStyle instanceof URLSpanMono) {
                ...
                BulletinFactory.m1194of(PeerStoriesView.this.storyContainer, this.val$resourcesProvider).createCopyBulletin(LocaleController.getString(C2702R.string.TextCopied)).show();
        ...
        */
        private void processExternalUrl(int r18, java.lang.String r19, android.text.style.CharacterStyle r20, boolean r21) {
            ...
            L42:
                ...
                r6 = 0
                r3 = r19
                org.telegram.p026ui.Components.AlertsCreator.showOpenUrlAlert(r2, r3, r4, r5, r6, r7, r8)
            L53:
                return
            L54:
                boolean r1 = r2 instanceof org.telegram.p026ui.Components.URLSpanReplacement
                if (r1 == 0) goto L6d
                r1 = r2
                org.telegram.ui.Components.URLSpanReplacement r1 = (org.telegram.p026ui.Components.URLSpanReplacement) r1
            ...
            L6e:
                ...
                r10 = r19
                r16 = r1
                org.telegram.p026ui.Components.AlertsCreator.showOpenUrlAlert(r9, r10, r11, r12, r13, r14, r15, r16)
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Stories.PeerStoriesView.C67005.processExternalUrl(int, java.lang.String, android.text.style.CharacterStyle, boolean):void");
        }
        ...
        public void onLinkLongPress(final URLSpan uRLSpan, final View view, final Runnable runnable) {
            ...
            CharSequence[] charSequenceArr = (storyItemHolder == null || storyItemHolder.allowScreenshots()) ? new CharSequence[]{LocaleController.getString(C2702R.string.Open), LocaleController.getString(C2702R.string.Copy)} : new CharSequence[]{LocaleController.getString(C2702R.string.Open)};
        ...
        public /* synthetic */ void lambda$onLinkLongPress$0(URLSpan uRLSpan, View view, String str, Theme.ResourcesProvider resourcesProvider, DialogInterface dialogInterface, int i) {
            if (i == 0) {
                ...
                BulletinFactory.m1194of(PeerStoriesView.this.storyContainer, resourcesProvider).createCopyLinkBulletin().show();
            }
        }
        ...
        public void onReplyClick(final StoryCaptionView.Reply reply) {
            ...
            if (reply.peerId == null || reply.storyId == null) {
                BulletinFactory.m1194of(PeerStoriesView.this.storyContainer, this.val$resourcesProvider).createSimpleBulletin(C2702R.raw.error, LocaleController.getString(C2702R.string.StoryHidAccount)).setTag(3).show(true);
                return;
            }
        ...
        public /* synthetic */ void lambda$onReplyClick$3(StoryCaptionView.Reply reply, final StoryViewer storyViewer, Theme.ResourcesProvider resourcesProvider, TL_stories.StoryItem storyItem) {
            ...
            BulletinFactory.m1194of(PeerStoriesView.this.storyContainer, resourcesProvider).createSimpleBulletin(C2702R.raw.story_bomb2, LocaleController.getString(C2702R.string.StoryNotFound)).setTag(3).show(true);
        }
        ...
        public void onEmojiClick(AnimatedEmojiSpan animatedEmojiSpan) {
            if (animatedEmojiSpan != null) {
                ...
                BulletinFactory bulletinFactoryM1194of = BulletinFactory.m1194of(PeerStoriesView.this.storyContainer, this.val$resourcesProvider);
                final StoryViewer storyViewer = this.val$storyViewer;
                final Theme.ResourcesProvider resourcesProvider = this.val$resourcesProvider;
                Bulletin bulletinCreateContainsEmojiBulletin = bulletinFactoryM1194of.createContainsEmojiBulletin(documentFindDocument, 2, new Utilities.Callback() { // from class: org.telegram.ui.Stories.PeerStoriesView$5$$ExternalSyntheticLambda0
    ...
    class C67016 extends FrameLayout {
        C67016(Context context2) {
            super(context2);
        }
    ...
    class C67027 extends FrameLayout {
        C67027(Context context2) {
            super(context2);
        }
    ...
    public /* synthetic */ void lambda$new$6(StoryViewer storyViewer, View view) {
        ...
        if (j2 > 0) {
            storyViewer.presentFragment(ProfileActivity.m1243of(j2));
        } else {
            storyViewer.presentFragment(ChatActivity.m1188of(j2));
        }
    }
    ...
    public /* synthetic */ void lambda$new$8(Theme.ResourcesProvider resourcesProvider, StoryViewer storyViewer, Context context, SharedResources sharedResources, View view) {
        ...
        C67038 c67038 = new C67038(getContext(), resourcesProvider, true, resourcesProvider, storyViewer, this.currentStory.isVideo, this.isSelf || ((this.isChannel || isBotsPreview()) && z), z, context, sharedResources, zArr);
        this.popupMenu = c67038;
        c67038.show(this.optionsIconView, 0, (-ActionBar.getCurrentActionBarHeight()) + AndroidUtilities.m1081dp(6.0f));
    }

    /* JADX INFO: renamed from: org.telegram.ui.Stories.PeerStoriesView$8 */
    class C67038 extends CustomPopupMenu {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C67038(Context context, Theme.ResourcesProvider resourcesProvider, boolean z, Theme.ResourcesProvider resourcesProvider2, StoryViewer storyViewer, boolean z2, boolean z3, boolean z4, Context context2, SharedResources sharedResources, boolean[] zArr) {
        ...
        private void addViewStatistics(ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout, final TL_stories.StoryItem storyItem) {
            ...
            TLRPC.ChatFull chatFull = MessagesController.getInstance(PeerStoriesView.this.currentAccount).getChatFull(chat.f1610id);
            if (chatFull == null) {
                chatFull = MessagesStorage.getInstance(PeerStoriesView.this.currentAccount).loadChatInfo(chat.f1610id, true, new CountDownLatch(1), false, false);
            }
            if (chatFull == null || !chatFull.can_view_stats) {
                return;
            }
            ActionBarMenuSubItem actionBarMenuSubItemAddItem = ActionBarMenuItem.addItem(actionBarPopupWindowLayout, C2702R.drawable.msg_stats, LocaleController.getString(C2702R.string.ViewStatistics), false, this.val$resourcesProvider);
            final StoryViewer storyViewer = this.val$storyViewer;
        ...
        public /* synthetic */ void lambda$addViewStatistics$0(TL_stories.StoryItem storyItem, StoryViewer storyViewer, TLRPC.Chat chat, View view) {
            ...
            storyItem.messageId = storyItem.f1807id;
            MessageObject messageObject = new MessageObject(PeerStoriesView.this.currentAccount, storyItem);
            messageObject.generateThumbs(false);
            storyViewer.presentFragment(new MessageStatisticActivity(messageObject, chat.f1610id, false) { // from class: org.telegram.ui.Stories.PeerStoriesView.8.1
                @Override // org.telegram.p026ui.MessageStatisticActivity, org.telegram.p026ui.ActionBar.BaseFragment
                public boolean isLightStatusBar() {
                    return false;
                }

                AnonymousClass1(MessageObject messageObject2, long j, boolean z) {
        ...
        class AnonymousClass1 extends MessageStatisticActivity {
            @Override // org.telegram.p026ui.MessageStatisticActivity, org.telegram.p026ui.ActionBar.BaseFragment
            public boolean isLightStatusBar() {
                return false;
            }
        ...
        private void addSpeedLayout(final ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout, boolean z) {
            ...
            peerStoriesView.speedLayout = new ChooseSpeedLayout(peerStoriesView.getContext(), actionBarPopupWindowLayout.getSwipeBack(), new ChooseSpeedLayout.Callback() { // from class: org.telegram.ui.Stories.PeerStoriesView.8.2
                ...
                AnonymousClass2(final ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout2) {
                    actionBarPopupWindowLayout = actionBarPopupWindowLayout2;
                }

                @Override // org.telegram.ui.ChooseSpeedLayout.Callback
                public void onSpeedSelected(float f, boolean z2, boolean z3) {
                    StoryViewer storyViewer = C67038.this.val$storyViewer;
                    if (storyViewer != null) {
            ...
            PeerStoriesView.this.speedItem.setTextAndIcon(LocaleController.getString(C2702R.string.Speed), C2702R.drawable.msg_speed, null);
            PeerStoriesView.this.updateSpeedItem(true);
            PeerStoriesView.this.speedItem.setMinimumWidth(AndroidUtilities.m1081dp(196.0f));
            PeerStoriesView.this.speedItem.setRightIcon(C2702R.drawable.msg_arrowright);
            ...
            layoutParams.height = AndroidUtilities.m1081dp(48.0f);
            ...
            PeerStoriesView.this.speedItem.openSwipeBackLayout = new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$8$$ExternalSyntheticLambda39
                @Override // java.lang.Runnable
                public final void run() {
                    PeerStoriesView.C67038.$r8$lambda$f2mS9OHREAaY0zfxPk0fkyfF6ck(actionBarPopupWindowLayout2, iAddViewToSwipeBack);
                }
            };
        ...
        class AnonymousClass2 implements ChooseSpeedLayout.Callback {
            final /* synthetic */ ActionBarPopupWindow.ActionBarPopupWindowLayout val$popupLayout;
        ...
        private void addAlbumsLayout(final ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout, boolean z) {
            ...
            itemOptionsSwipeback.add(C2702R.drawable.ic_ab_back, LocaleController.getString(C2702R.string.Back), new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$8$$ExternalSyntheticLambda41
                @Override // java.lang.Runnable
                public final void run() {
                    PeerStoriesView.C67038.$r8$lambda$rVsuPxLsudFzomSQr9kQ1d0unxs(actionBarPopupWindowLayout);
                }
            });
            ...
            PeerStoriesView.this.albumItem.setTextAndIcon(LocaleController.getString(C2702R.string.StoriesAlbumAddToAlbum), C2702R.drawable.menu_album_add, null);
            PeerStoriesView.this.albumItem.openSwipeBackLayout = new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$8$$ExternalSyntheticLambda44
                @Override // java.lang.Runnable
                public final void run() {
                    PeerStoriesView.C67038.$r8$lambda$kkQekJEdPFrNqPha5yZIXlapoB4(actionBarPopupWindowLayout, iAddViewToSwipeBack);
                }
            };
        ...
        public /* synthetic */ void lambda$addAlbumsLayout$4(TL_stories.StoryItem storyItem, Theme.ResourcesProvider resourcesProvider, StoriesController.StoryAlbum storyAlbum) {
            ...
            BulletinFactory.m1194of(PeerStoriesView.this.storyContainer, resourcesProvider).createSimpleBulletin(C2702R.raw.contact_check, AndroidUtilities.replaceTags(LocaleController.formatString(C2702R.string.StoryAddedToAlbumX, storyAlbum.title))).show();
        }
        ...
        public /* synthetic */ void lambda$addAlbumsLayout$7(HashSet hashSet, TL_stories.StoryItem storyItem, Theme.ResourcesProvider resourcesProvider, StoriesController.StoryAlbum storyAlbum) {
            ...
            BulletinFactory.m1194of(PeerStoriesView.this.storyContainer, resourcesProvider).createSimpleBulletin(C2702R.raw.contact_check, AndroidUtilities.replaceTags(string)).show();
            CustomPopupMenu customPopupMenu = PeerStoriesView.this.popupMenu;
            if (customPopupMenu != null) {
                customPopupMenu.dismiss();
            }
        ...
        /* JADX WARN: Removed duplicated region for block: B:1024:0x0460  */
        /* JADX WARN: Removed duplicated region for block: B:1036:0x04b1  */
        /* JADX WARN: Removed duplicated region for block: B:1040:0x04bd  */
        /* JADX WARN: Removed duplicated region for block: B:1045:0x04cb  */
        /* JADX WARN: Removed duplicated region for block: B:1046:0x04ce  */
        /* JADX WARN: Removed duplicated region for block: B:1050:0x04e9  */
        /* JADX WARN: Removed duplicated region for block: B:1054:0x04fb  */
        /* JADX WARN: Removed duplicated region for block: B:1056:0x0502  */
        /* JADX WARN: Removed duplicated region for block: B:1060:0x0525  */
        /* JADX WARN: Removed duplicated region for block: B:1064:0x0535  */
        /* JADX WARN: Removed duplicated region for block: B:1067:0x053e  */
        /* JADX WARN: Removed duplicated region for block: B:1072:0x0562  */
        /* JADX WARN: Removed duplicated region for block: B:1075:0x0580  */
        /* JADX WARN: Removed duplicated region for block: B:1097:0x05e2  */
        /* JADX WARN: Removed duplicated region for block: B:1100:0x0604  */
        /* JADX WARN: Removed duplicated region for block: B:1113:0x0680  */
        /* JADX WARN: Removed duplicated region for block: B:1116:0x06c2  */
        /* JADX WARN: Removed duplicated region for block: B:908:0x0132 A[PHI: r2
  0x0132: PHI (r2v127 boolean) = (r2v113 boolean), (r2v129 boolean) binds: [B:917:0x0145, B:907:0x0130] A[DONT_GENERATE, DONT_INLINE]] */
        /* JADX WARN: Removed duplicated region for block: B:909:0x0134 A[PHI: r2
  0x0134: PHI (r2v116 boolean) = (r2v113 boolean), (r2v113 boolean), (r2v129 boolean), (r2v129 boolean) binds: [B:915:0x0141, B:917:0x0145, B:905:0x012c, B:907:0x0130] A[DONT_GENERATE, DONT_INLINE]] */
        @Override // org.telegram.p026ui.Components.CustomPopupMenu
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        protected void onCreate(org.telegram.ui.ActionBar.ActionBarPopupWindow.ActionBarPopupWindowLayout r21) {
            /*
                ...
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Stories.PeerStoriesView.C67038.onCreate(org.telegram.ui.ActionBar.ActionBarPopupWindow$ActionBarPopupWindowLayout):void");
        }
        ...
        public /* synthetic */ void lambda$onCreate$17(Theme.ResourcesProvider resourcesProvider, Context context, final StoryViewer storyViewer, final SharedResources sharedResources, View view) {
            if (view.getAlpha() < 1.0f) {
                ...
                BulletinFactory.m1194of(PeerStoriesView.this.storyContainer, resourcesProvider).createErrorBulletin("Wait until current upload is complete").show();
                return;
            }
        ...
        public /* synthetic */ void lambda$onCreate$15(SharedResources sharedResources, Long l, final Runnable runnable, Boolean bool, Long l2) {
            ...
            if (videoPlayerHolder == null) {
                ...
                peerStoriesView2.onImageReceiverThumbLoaded = new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$8$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
                        PeerStoriesView.C67038.$r8$lambda$44cxg47EmO7wGipUuO4ZEp56bsM(runnable);
                    }
                };
            ...
            videoPlayerHolder.setOnReadyListener(new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$8$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    PeerStoriesView.C67038.$r8$lambda$93s1RGoVHBMKE1kd2Jx9tC2wRPw(runnable, jCurrentTimeMillis);
                }
            });
        ...
        public /* synthetic */ void lambda$onCreate$21(final TL_stories.StoryItem storyItem, final TL_stories.StoryItem storyItem2, final Utilities.Callback callback) {
            ...
            if ((storyItem instanceof StoriesController.BotPreview) && (botPreviewsList = ((StoriesController.BotPreview) storyItem).list) != null) {
                botPreviewsList.reload(new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$8$$ExternalSyntheticLambda5
                    @Override // java.lang.Runnable
                    public final void run() {
                        PeerStoriesView.C67038.m18136$r8$lambda$_yNBXYv7gOPVoHtzsMoD1J64fI(botPreviewsList, storyItem2, callback);
                    }
                });
                return;
            }
            ...
            tL_stories_getStoriesByID.f1814id.add(Integer.valueOf(storyItem.f1807id));
        ...
        public static /* synthetic */ void m18136$r8$lambda$_yNBXYv7gOPVoHtzsMoD1J64fI(StoriesController.BotPreviewsList botPreviewsList, TL_stories.StoryItem storyItem, Utilities.Callback callback) {
            ...
            for (int i = 0; i < botPreviewsList.messageObjects.size(); i++) {
                ...
                if (messageObject != null && (storyItem2 = messageObject.storyItem) != null && (messageMedia = storyItem2.media) != null && (document = storyItem.media.document) != null && (document2 = messageMedia.document) != null && document2.f1618id == document.f1618id) {
        ...
        public /* synthetic */ void lambda$onCreate$19(TLObject tLObject, TL_stories.StoryItem storyItem, Utilities.Callback callback) {
            if (tLObject instanceof TL_stories.TL_stories_stories) {
                ...
                for (int i = 0; i < tL_stories_stories.stories.size(); i++) {
                    if (tL_stories_stories.stories.get(i).f1807id == storyItem.f1807id) {
        ...
        public /* synthetic */ void lambda$onCreate$25(SharedResources sharedResources, Long l, final Runnable runnable, Boolean bool, Long l2) {
            ...
            if (videoPlayerHolder == null) {
                ...
                peerStoriesView2.onImageReceiverThumbLoaded = new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$8$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        PeerStoriesView.C67038.$r8$lambda$NV2WjvVVPH_8msYrDZ0Kte2fosg(runnable);
                    }
                };
                if (bool.booleanValue()) {
                    PeerStoriesView.this.updatePosition();
            ...
            videoPlayerHolder.setOnReadyListener(new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$8$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    PeerStoriesView.C67038.$r8$lambda$VU5a7tw08M0tpjO9YNLN2d5ydoQ(runnable, jCurrentTimeMillis);
                }
            });
            PeerStoriesView.this.delegate.setPopupIsVisible(false);
            if (PeerStoriesView.this.muteIconView != null) {
        ...
        public /* synthetic */ void lambda$onCreate$28(TL_stories.StoryItem storyItem, boolean z, Theme.ResourcesProvider resourcesProvider, Boolean bool) {
            if (bool.booleanValue()) {
                ...
                if (peerStoriesView.isSelf) {
                    BulletinFactory.m1194of(peerStoriesView.storyContainer, resourcesProvider).createSimpleBulletin(z ? C2702R.raw.contact_check : C2702R.raw.chats_archived, LocaleController.getString(z ? C2702R.string.StoryPinnedToProfile : C2702R.string.StoryArchivedFromProfile)).show();
                    return;
                } else if (z) {
                    BulletinFactory.m1194of(peerStoriesView.storyContainer, resourcesProvider).createSimpleBulletin(C2702R.raw.contact_check, LocaleController.getString(C2702R.string.StoryPinnedToPosts), LocaleController.getString(C2702R.string.StoryPinnedToPostsDescription)).show();
                    return;
                } else {
                    BulletinFactory.m1194of(peerStoriesView.storyContainer, resourcesProvider).createSimpleBulletin(C2702R.raw.chats_archived, LocaleController.getString(C2702R.string.StoryUnpinnedFromPosts)).show();
                    return;
                }
            }
            BulletinFactory.m1194of(PeerStoriesView.this.storyContainer, resourcesProvider).createSimpleBulletin(C2702R.raw.error, LocaleController.getString(C2702R.string.UnknownError)).show();
        }
        ...
        public /* synthetic */ void lambda$onCreate$41(Theme.ResourcesProvider resourcesProvider, final StoryViewer storyViewer, View view) {
            ...
            new AlertDialog.Builder(PeerStoriesView.this.getContext(), resourcesProvider).setTitle(LocaleController.getString(C2702R.string.LiveStoryEndAlertTitle)).setMessage(LocaleController.getString(C2702R.string.LiveStoryEndAlertText)).setPositiveButton(LocaleController.getString(C2702R.string.LiveStoryEndAlertButton), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$8$$ExternalSyntheticLambda49
        ...
        public /* synthetic */ void lambda$onCreate$43(String str, Theme.ResourcesProvider resourcesProvider, TLObject tLObject, String str2, View view) {
            ...
            BulletinFactory.m1194of(PeerStoriesView.this.storyContainer, resourcesProvider).createUsersBulletin(Arrays.asList(tLObject), AndroidUtilities.replaceTags(LocaleController.formatString("NotificationsStoryMutedHint", C2702R.string.NotificationsStoryMutedHint, str2))).setTag(2).show();
            CustomPopupMenu customPopupMenu = PeerStoriesView.this.popupMenu;
            if (customPopupMenu != null) {
                customPopupMenu.dismiss();
            }
        ...
        public /* synthetic */ void lambda$onCreate$44(String str, Theme.ResourcesProvider resourcesProvider, TLObject tLObject, String str2, View view) {
            ...
            NotificationsController.getInstance(PeerStoriesView.this.currentAccount).updateServerNotificationsSettings(PeerStoriesView.this.dialogId, 0L);
            BulletinFactory.m1194of(PeerStoriesView.this.storyContainer, resourcesProvider).createUsersBulletin(Arrays.asList(tLObject), AndroidUtilities.replaceTags(LocaleController.formatString("NotificationsStoryUnmutedHint", C2702R.string.NotificationsStoryUnmutedHint, str2))).setTag(2).show();
            CustomPopupMenu customPopupMenu = PeerStoriesView.this.popupMenu;
            if (customPopupMenu != null) {
                customPopupMenu.dismiss();
            }
        ...
        public /* synthetic */ void lambda$onCreate$59(final StoryViewer storyViewer, Theme.ResourcesProvider resourcesProvider, View view) {
            ...
            PeerStoriesView peerStoriesView = PeerStoriesView.this;
            ReportBottomSheet.openStory(i, context, peerStoriesView.currentStory.storyItem, BulletinFactory.m1194of(peerStoriesView.storyContainer, resourcesProvider), resourcesProvider, new Utilities.Callback() { // from class: org.telegram.ui.Stories.PeerStoriesView$8$$ExternalSyntheticLambda52
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    PeerStoriesView.C67038.m18143$r8$lambda$rv4ddzDfrcC3oInSjhp75oHYjo(storyViewer, (Boolean) obj);
                }
            });
            CustomPopupMenu customPopupMenu = PeerStoriesView.this.popupMenu;
            if (customPopupMenu != null) {
        ...
        public static /* synthetic */ void m18143$r8$lambda$rv4ddzDfrcC3oInSjhp75oHYjo(StoryViewer storyViewer, Boolean bool) {
            if (storyViewer != null) {
    ...
    class C67049 extends FrameLayout {
        C67049(final Context context2) {
            super(context2);
        }
    ...
    */
    public /* synthetic */ void lambda$new$10(android.view.View r13) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Stories.PeerStoriesView.lambda$new$10(android.view.View):void");
    }
    ...
    class C666710 extends LiveCommentsView {
        final /* synthetic */ StoryViewer val$storyViewer;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C666710(final Context context2, final StoryViewer storyViewer22, ViewGroup viewGroup, View view2, FrameLayout frameLayout4, final StoryViewer storyViewer222) {
    ...
    class C666811 extends TextSelectionHelper.Callback {
        C666811() {
        }
    ...
    public void createStealthModeItem(ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout) {
        ...
        ActionBarMenuItem.addItem(actionBarPopupWindowLayout, C2702R.drawable.msg_stories_stealth2, LocaleController.getString(C2702R.string.StealthModeButton), false, this.resourcesProvider).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda53
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    public void createQualityItem(ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout) {
        ...
        if (UserConfig.getInstance(this.currentAccount).isPremium()) {
            ActionBarMenuItem.addItem(actionBarPopupWindowLayout, z ? C2702R.drawable.menu_quality_sd : C2702R.drawable.menu_quality_hd, LocaleController.getString(z ? C2702R.string.StoryQualityDecrease : C2702R.string.StoryQualityIncrease), false, this.resourcesProvider).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda51
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    public /* synthetic */ void lambda$createQualityItem$14(boolean z, View view) {
        ...
        BulletinFactory.m1194of(this.storyContainer, this.resourcesProvider).createSimpleBulletin(C2702R.raw.chats_infotip, LocaleController.getString(!z ? C2702R.string.StoryQualityIncreasedTitle : C2702R.string.StoryQualityDecreasedTitle), LocaleController.getString(!z ? C2702R.string.StoryQualityIncreasedMessage : C2702R.string.StoryQualityDecreasedMessage)).show();
        CustomPopupMenu customPopupMenu = this.popupMenu;
        if (customPopupMenu != null) {
            customPopupMenu.dismiss();
        }
    ...
    class C666914 extends AnimatorListenerAdapter {
        final /* synthetic */ boolean val$show;
    ...
    class C667015 extends AnimatorListenerAdapter {
        C667015() {
        }
    ...
    class C667116 extends AnimatorListenerAdapter {
    ...
    private void animateLikeButton() {
        ...
        storiesLikeButton.animate().alpha(0.0f).scaleX(0.8f).scaleY(0.8f).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Stories.PeerStoriesView.16
            ...
            C667116(View storiesLikeButton2) {
        ...
        storiesLikeButton2.setPadding(iM1081dp, iM1081dp, iM1081dp, iM1081dp);
            ...
            for (int i2 = 0; i2 < storyItemHolder.storyItem.media_areas.size(); i2++) {
                ...
                if (mediaArea2 instanceof TL_stories.TL_mediaAreaSuggestedReaction) {
                    ...
                    if (reaction instanceof TLRPC.TL_reactionCustomEmoji) {
                        ...
                        if (documentFindDocument != null && (inputStickerSet2 = MessageObject.getInputStickerSet(documentFindDocument)) != null && !hashSet.contains(Long.valueOf(inputStickerSet2.f1635id))) {
                            hashSet.add(Long.valueOf(inputStickerSet2.f1635id));
            ...
            while (i < storyItemHolder.storyItem.entities.size()) {
                ...
                if (messageEntity instanceof TLRPC.TL_messageEntityCustomEmoji) {
                    ...
                    if (documentFindDocument2 != null) {
                        ...
                        if (!hashSet.contains(Long.valueOf(inputStickerSet3.f1635id))) {
                            hashSet.add(Long.valueOf(inputStickerSet3.f1635id));
                    ...
                    for (int i3 = 0; i3 < storyItemHolder.uploadingStory.entry.mediaEntities.size(); i3++) {
                        ...
                        if (mediaEntity.type == 4 && (mediaArea = mediaEntity.mediaArea) != null) {
                            ...
                            if (reaction2 instanceof TLRPC.TL_reactionCustomEmoji) {
                                ...
                                if (documentFindDocument3 != null && (inputStickerSet = MessageObject.getInputStickerSet(documentFindDocument3)) != null && !hashSet.contains(Long.valueOf(inputStickerSet.f1635id))) {
                                    hashSet.add(Long.valueOf(inputStickerSet.f1635id));
                ...
                if ((charSequence instanceof Spanned) && (animatedEmojiSpanArr = (AnimatedEmojiSpan[]) ((Spanned) charSequence).getSpans(0, charSequence.length(), AnimatedEmojiSpan.class)) != null) {
                    while (i < animatedEmojiSpanArr.length) {
                        ...
                        if (documentFindDocument4 != null) {
                            ...
                            if (!hashSet.contains(Long.valueOf(inputStickerSet4.f1635id))) {
                                hashSet.add(Long.valueOf(inputStickerSet4.f1635id));
    ...
    public /* synthetic */ void lambda$toggleArchiveForStory$20(final MessagesController messagesController, final long j, final boolean z, String str, TLObject tLObject) {
        ...
        BulletinFactory.m1194of(this.topBulletinContainer, this.resourcesProvider).createUsersBulletin(Arrays.asList(tLObject), !z ? AndroidUtilities.replaceTags(LocaleController.formatString(C2702R.string.StoriesMovedToDialogs, ContactsController.formatName(str, null, 10))) : AndroidUtilities.replaceTags(LocaleController.formatString(C2702R.string.StoriesMovedToContacts, ContactsController.formatName(str, null, 10))), null, undoObject).setTag(2).show(true);
    }
    ...
    private void createPremiumBlockedText() {
        ...
        imageView.setImageResource(C2702R.drawable.mini_switch_lock);
        ...
        this.premiumBlockedText1.setText(LocaleController.getString(this.isGroup ? C2702R.string.StoryGroupRepliesLocked : C2702R.string.StoryRepliesLocked));
        TextView textView2 = new TextView(getContext());
        this.premiumBlockedText2 = textView2;
        textView2.setTextColor(-1);
        this.premiumBlockedText2.setTextSize(1, 12.0f);
        this.premiumBlockedText2.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1081dp(40.0f), 452984831, 855638015));
        this.premiumBlockedText2.setGravity(17);
        ScaleStateListAnimator.apply(this.premiumBlockedText2);
        this.premiumBlockedText2.setText(LocaleController.getString(C2702R.string.StoryRepliesLockedButton));
        this.premiumBlockedText2.setPadding(AndroidUtilities.m1081dp(7.0f), 0, AndroidUtilities.m1081dp(7.0f), 0);
    ...
    private void updatePremiumBlockedText() {
        if (this.areLiveCommentsDisabled) {
            ...
            if (textView != null) {
                textView.setText(LocaleController.getString(C2702R.string.LiveStoryCommentsDisabled));
            }
        ...
        if (textView3 != null) {
            textView3.setText(LocaleController.getString(this.isGroup ? C2702R.string.StoryGroupRepliesLocked : C2702R.string.StoryRepliesLocked));
        }
    ...
    class C667217 extends BaseFragment {
        @Override // org.telegram.p026ui.ActionBar.BaseFragment
        public boolean isLightStatusBar() {
            return false;
        }
    ...
    public void showPremiumBlockedToast() {
        ...
        if (MessagesController.getInstance(this.currentAccount).premiumFeaturesBlocked()) {
            bulletinCreateSimpleBulletin = BulletinFactory.m1194of(this.storyContainer, this.resourcesProvider).createSimpleBulletin(C2702R.raw.star_premium_2, AndroidUtilities.replaceTags(LocaleController.formatString(C2702R.string.UserBlockedRepliesNonPremium, userName)));
        } else {
            bulletinCreateSimpleBulletin = BulletinFactory.m1194of(this.storyContainer, this.resourcesProvider).createSimpleBulletin(C2702R.raw.star_premium_2, AndroidUtilities.replaceTags(LocaleController.formatString(C2702R.string.UserBlockedRepliesNonPremium, userName)), LocaleController.getString(C2702R.string.UserBlockedNonPremiumButton), new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda43
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void updateSpeedItem(boolean z) {
        ...
        if (z) {
            if (Math.abs(StoryViewer.currentSpeed - 0.2f) < 0.05f) {
                this.speedItem.setSubtext(LocaleController.getString(C2702R.string.VideoSpeedVerySlow));
            } else if (Math.abs(StoryViewer.currentSpeed - 0.5f) < 0.05f) {
                this.speedItem.setSubtext(LocaleController.getString(C2702R.string.VideoSpeedSlow));
            } else if (Math.abs(StoryViewer.currentSpeed - 1.0f) < 0.05f) {
                this.speedItem.setSubtext(LocaleController.getString(C2702R.string.VideoSpeedNormal));
            } else if (Math.abs(StoryViewer.currentSpeed - 1.5f) < 0.05f) {
                this.speedItem.setSubtext(LocaleController.getString(C2702R.string.VideoSpeedFast));
            } else if (Math.abs(StoryViewer.currentSpeed - 2.0f) < 0.05f) {
                this.speedItem.setSubtext(LocaleController.getString(C2702R.string.VideoSpeedVeryFast));
            } else {
                this.speedItem.setSubtext(LocaleController.formatString(C2702R.string.VideoSpeedCustom, SpeedIconDrawable.formatNumber(StoryViewer.currentSpeed) + "x"));
            }
        }
    ...
    private void showPaidMessageHint() {
        ...
        if (!disabledPaidFeatures(true) && MessagesController.getGlobalMainSettings().getInt("taptostoryhighlighthint", 0) < 3) {
            ...
            hintView22.setText(LocaleController.getString(C2702R.string.LiveStoryHighlightHint));
            this.highlightMessageHintView.setPadding(AndroidUtilities.m1081dp(8.0f), 0, AndroidUtilities.m1081dp(8.0f), 0);
    ...
    class C667318 extends WrappedResourceProvider {
        C667318(Theme.ResourcesProvider resourcesProvider) {
            super(resourcesProvider);
        }
    ...
    private void createEnterView() {
        C667419 c667419 = new C667419(AndroidUtilities.findActivity(getContext()), this, null, true, new WrappedResourceProvider(this.resourcesProvider) { // from class: org.telegram.ui.Stories.PeerStoriesView.18
            C667318(Theme.ResourcesProvider resourcesProvider) {
                super(resourcesProvider);
            }
        ...
        this.chatActivityEnterView = c667419;
        c667419.getEditField().useAnimatedTextDrawable();
        ...
        this.chatActivityEnterView.setDelegate(new C667620());
    ...
    class C667419 extends ChatActivityEnterView {
        ...
        C667419(Activity activity, SizeNotifierFrameLayout sizeNotifierFrameLayout, ChatActivity chatActivity, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        public void checkAnimation() {
            ...
            if (i != 0 && backgroundTop != i) {
                ...
                PeerStoriesView.this.changeBoundAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Stories.PeerStoriesView.19.1
                    ...
                    public void onAnimationEnd(Animator animator) {
                        PeerStoriesView.this.invalidate();
                        C667419.this.setAnimatedTop(0);
                        C667419 c667419 = C667419.this;
                        PeerStoriesView.this.forceUpdateOffsets = true;
                        if (((ChatActivityEnterView) c667419).topView != null && ((ChatActivityEnterView) C667419.this).topView.getVisibility() == 0) {
                            ((ChatActivityEnterView) C667419.this).topView.setTranslationY(((ChatActivityEnterView) C667419.this).animatedTop + ((1.0f - C667419.this.getTopViewEnterProgress()) * ((ChatActivityEnterView) C667419.this).topView.getLayoutParams().height));
                        }
    ...
    class C667620 implements ChatActivityEnterView.ChatActivityEnterViewDelegate {
        ...
        public void needShowMediaBanHint() {
            ...
            PeerStoriesView.this.mediaBanTooltip.setText(AndroidUtilities.replaceTags(LocaleController.formatString(PeerStoriesView.this.chatActivityEnterView.isInVideoMode() ? C2702R.string.VideoMessagesRestrictedByPrivacy : C2702R.string.VoiceMessagesRestrictedByPrivacy, firstName)));
    ...
    class C667721 extends MentionsContainerView {
        @Override // org.telegram.p026ui.Components.MentionsContainerView
        protected boolean isStories() {
            return true;
        }

        C667721(Context context, long j, long j2, BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider) {
    ...
    public void createMentionsContainer() {
        ...
        C667822 c667822 = new C667822();
        this.mentionsDelegate = c667822;
        this.mentionContainer.withDelegate(c667822);
    ...
    class C667822 implements MentionsContainerView.Delegate {
        C667822() {
        }
    ...
    public boolean applyMessageToChat(final Runnable runnable) {
        ...
        if (i > 0 && this.stealthModeIsActive) {
            ...
            alertDialog.setTitle(LocaleController.getString(C2702R.string.StealthModeConfirmTitle));
            alertDialog.setMessage(LocaleController.getString(C2702R.string.StealthModeConfirmMessage));
            alertDialog.setPositiveButton(LocaleController.getString(C2702R.string.Proceed), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda37
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog2, int i3) {
                    runnable.run();
                }
            });
            alertDialog.setNegativeButton(LocaleController.getString(C2702R.string.Cancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda38
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog2, int i3) {
    ...
    public void showDownloadAlert() {
        ...
        builder.setMessage(LocaleController.getString(C2702R.string.PleaseDownload));
    ...
    class DialogC667923 extends ChatAttachAlert {
        DialogC667923(Context context, BaseFragment baseFragment, boolean z, boolean z2, boolean z3, Theme.ResourcesProvider resourcesProvider) {
    ...
    private void createChatAttachView() {
        if (this.chatAttachAlert == null) {
            DialogC667923 dialogC667923 = new ChatAttachAlert(getContext(), null, false, false, true, this.resourcesProvider) { // from class: org.telegram.ui.Stories.PeerStoriesView.23
                DialogC667923(Context context, BaseFragment baseFragment, boolean z, boolean z2, boolean z3, Theme.ResourcesProvider resourcesProvider) {
                    super(context, baseFragment, z, z2, z3, resourcesProvider);
                }
            ...
            this.chatAttachAlert = dialogC667923;
            dialogC667923.setDelegate(new ChatAttachAlert.ChatAttachViewDelegate() { // from class: org.telegram.ui.Stories.PeerStoriesView.24
    ...
    class C668024 implements ChatAttachAlert.ChatAttachViewDelegate {
        @Override // org.telegram.ui.Components.ChatAttachAlert.ChatAttachViewDelegate
        public /* synthetic */ void didSelectBot(TLRPC.User user) {
            ChatAttachAlert.ChatAttachViewDelegate.CC.$default$didSelectBot(this, user);
        }
    ...
    class C668125 implements ChatAttachAlertDocumentLayout.DocumentSelectActivityDelegate {
        @Override // org.telegram.ui.Components.ChatAttachAlertDocumentLayout.DocumentSelectActivityDelegate
        public /* synthetic */ void didSelectPhotos(ArrayList arrayList, boolean z, int i, int i2, long j) {
            ChatAttachAlertDocumentLayout.DocumentSelectActivityDelegate.CC.$default$didSelectPhotos(this, arrayList, z, i, i2, j);
        }
    ...
    public void shareStory(boolean z) {
        ...
        if (z) {
            DialogC668327 dialogC668327 = new ShareAlert(this.storyViewer.fragment.getContext(), null, null, null, strCreateLink, null, false, strCreateLink, null, false, false, !DISABLE_STORY_REPOSTING && MessagesController.getInstance(this.currentAccount).storiesEnabled() && (!(this.isChannel || UserObject.isService(this.dialogId)) || ChatObject.isPublic(this.isChannel ? MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(-this.dialogId)) : null)), null, new WrappedResourceProvider(this.resourcesProvider) { // from class: org.telegram.ui.Stories.PeerStoriesView.26
                C668226(Theme.ResourcesProvider resourcesProvider) {
                    super(resourcesProvider);
                }
                ...
                DialogC668327(Context context, ChatActivity chatActivity, ArrayList arrayList, String str, String strCreateLink2, String str2, boolean z2, String strCreateLink22, String str3, boolean z3, boolean z4, boolean z5, Integer num, Theme.ResourcesProvider resourcesProvider) {
                    super(context, chatActivity, arrayList, str, strCreateLink22, str2, z2, strCreateLink22, str3, z3, z4, z5, num, resourcesProvider);
                }

                @Override // org.telegram.p026ui.Components.ShareAlert, org.telegram.p026ui.ActionBar.BottomSheet
                ...
                protected void onSend(LongSparseArray longSparseArray, int i, TLRPC.TL_forumTopic tL_forumTopic, boolean z2) {
                    if (z2) {
                        ...
                        BulletinFactory bulletinFactoryM1194of = BulletinFactory.m1194of(PeerStoriesView.this.storyContainer, this.resourcesProvider);
                        if (bulletinFactoryM1194of != null) {
                            if (longSparseArray.size() == 1) {
                                ...
                                if (jKeyAt == UserConfig.getInstance(this.currentAccount).clientUserId) {
                                    bulletinFactoryM1194of.createSimpleBulletin(C2702R.raw.saved_messages, AndroidUtilities.replaceTags(LocaleController.formatString(C2702R.string.StorySharedToSavedMessages, new Object[0])), 5000).hideAfterBottomSheet(false).show();
                                } else if (jKeyAt < 0) {
                                    bulletinFactoryM1194of.createSimpleBulletin(C2702R.raw.forward, AndroidUtilities.replaceTags(LocaleController.formatString(C2702R.string.StorySharedTo, tL_forumTopic != null ? tL_forumTopic.title : MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(-jKeyAt)).title)), 5000).hideAfterBottomSheet(false).show();
                                } else {
                                    bulletinFactoryM1194of.createSimpleBulletin(C2702R.raw.forward, AndroidUtilities.replaceTags(LocaleController.formatString(C2702R.string.StorySharedTo, MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(jKeyAt)).first_name)), 5000).hideAfterBottomSheet(false).show();
                                }
                            } else {
                                bulletinFactoryM1194of.createSimpleBulletin(C2702R.raw.forward, AndroidUtilities.replaceTags(LocaleController.formatPluralString("StorySharedToManyChats", longSparseArray.size(), Integer.valueOf(longSparseArray.size())))).hideAfterBottomSheet(false).show();
                            }
                            try {
            ...
            this.shareAlert = dialogC668327;
            dialogC668327.forceDarkThemeForHint = true;
            TL_stories.StoryItem storyItem = this.currentStory.storyItem;
            storyItem.dialogId = this.dialogId;
            dialogC668327.setStoryToShare(storyItem);
        ...
        LaunchActivity.instance.startActivityForResult(Intent.createChooser(intent, LocaleController.getString(C2702R.string.StickersShare)), 500);
    }

    /* JADX INFO: renamed from: org.telegram.ui.Stories.PeerStoriesView$26 */
    class C668226 extends WrappedResourceProvider {
        C668226(Theme.ResourcesProvider resourcesProvider) {
            super(resourcesProvider);
        }
    ...
    class DialogC668327 extends ShareAlert {
        DialogC668327(Context context, ChatActivity chatActivity, ArrayList arrayList, String str, String strCreateLink22, String str2, boolean z2, String strCreateLink222, String str3, boolean z3, boolean z4, boolean z5, Integer num, Theme.ResourcesProvider resourcesProvider) {
    ...
    class C668428 implements ShareAlert.ShareAlertDelegate {
        @Override // org.telegram.ui.Components.ShareAlert.ShareAlertDelegate
        public /* synthetic */ void didShare() {
            ShareAlert.ShareAlertDelegate.CC.$default$didShare(this);
        }
    ...
    public /* synthetic */ void lambda$openRepostStory$37(final StoryRecorder storyRecorder, Long l, final Runnable runnable, Boolean bool, final Long l2) {
        ...
        if (videoPlayerSharedScope != null && videoPlayerSharedScope.player == null) {
            ...
            this.onImageReceiverThumbLoaded = new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda48
                @Override // java.lang.Runnable
                public final void run() {
                    PeerStoriesView.m17965$r8$lambda$dGoH3A6sklctbRIH2lSj7RSHyg(runnable);
                }
            };
            if (bool.booleanValue()) {
                updatePosition();
        ...
        videoPlayerHolder.setOnReadyListener(new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda49
            @Override // java.lang.Runnable
            public final void run() {
                PeerStoriesView.m17956$r8$lambda$5LKFz3khgZaUzGgbmsjLCOKKIU(runnable, jCurrentTimeMillis);
            }
        });
        this.delegate.setPopupIsVisible(false);
    ...
    public static /* synthetic */ void m17965$r8$lambda$dGoH3A6sklctbRIH2lSj7RSHyg(Runnable runnable) {
        AndroidUtilities.cancelRunOnUIThread(runnable);
        AndroidUtilities.runOnUIThread(runnable);
    }

    /* JADX INFO: renamed from: $r8$lambda$5LKF-z3khgZaUzGgbmsjLCOKKIU */
    public static /* synthetic */ void m17956$r8$lambda$5LKFz3khgZaUzGgbmsjLCOKKIU(Runnable runnable, long j) {
        AndroidUtilities.cancelRunOnUIThread(runnable);
        AndroidUtilities.runOnUIThread(runnable, Math.max(0L, 32 - (System.currentTimeMillis() - j)));
    }
    ...
    public void onLinkCopied() {
        ...
        tL_stories_exportStoryLink.f1812id = this.currentStory.storyItem.f1807id;
    ...
    class C668529 implements RequestDelegate {
        @Override // org.telegram.tgnet.RequestDelegate
        public void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        }
    ...
    private void setTitle(boolean z, long j, boolean z2) {
        ...
        if (j >= 0) {
            if (this.isSelf && !z2) {
                this.headerView.titleView.setText(LocaleController.getString(C2702R.string.SelfStoryTitle));
                this.headerView.titleView.setRightDrawable((Drawable) null);
                return;
            }
            TLRPC.User user = MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(j));
            if (user != null && user.verified) {
                Drawable drawableMutate = ContextCompat.getDrawable(getContext(), C2702R.drawable.verified_profile).mutate();
                drawableMutate.setAlpha(Function.USE_VARARGS);
                CombinedDrawable combinedDrawable = new CombinedDrawable(drawableMutate, null);
                combinedDrawable.setFullsize(true);
                combinedDrawable.setCustomSize(AndroidUtilities.m1081dp(16.0f), AndroidUtilities.m1081dp(16.0f));
        ...
        if (chat != null && chat.verified) {
            Drawable drawableMutate2 = ContextCompat.getDrawable(getContext(), C2702R.drawable.verified_profile).mutate();
            drawableMutate2.setAlpha(Function.USE_VARARGS);
            CombinedDrawable combinedDrawable2 = new CombinedDrawable(drawableMutate2, null);
            combinedDrawable2.setFullsize(true);
            combinedDrawable2.setCustomSize(AndroidUtilities.m1081dp(16.0f), AndroidUtilities.m1081dp(16.0f));
    ...
    private void bindInternal(int i) {
        ...
        if (this.isChannel) {
            ...
            if (this.reactionsCounter == null) {
                ...
                this.reactionsCounter.setTextSize(AndroidUtilities.m1081dp(14.0f));
            ...
            if (this.repostButtonContainer != null && this.repostCounter == null) {
                ...
                this.repostCounter.setTextSize(AndroidUtilities.m1081dp(14.0f));
            ...
            if (i == -1) {
                ...
                if (arrayList != null) {
                    ...
                    for (int i4 = 0; i4 < this.storyItems.size(); i4++) {
                        if (((TL_stories.StoryItem) this.storyItems.get(i4)).justUploaded || ((TL_stories.StoryItem) this.storyItems.get(i4)).f1807id > this.storiesController.dialogIdToMaxReadId.get(this.dialogId)) {
    ...
    private void createUnsupportedContainer() {
        ...
        textView.setText(LocaleController.getString(C2702R.string.StoryUnsupported));
        textView.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteBlackText, this.resourcesProvider));
        TextView textView2 = new TextView(getContext());
        ScaleStateListAnimator.apply(textView2);
        textView2.setText(LocaleController.getString(C2702R.string.AppUpdate));
        int i = Theme.key_featuredStickers_buttonText;
        textView2.setTextColor(Theme.getColor(i, this.resourcesProvider));
        textView2.setPadding(AndroidUtilities.m1081dp(16.0f), AndroidUtilities.m1081dp(12.0f), AndroidUtilities.m1081dp(16.0f), AndroidUtilities.m1081dp(12.0f));
        textView2.setGravity(17);
        textView2.setTypeface(AndroidUtilities.bold());
        textView2.setTextSize(1, 15.0f);
        textView2.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1081dp(8.0f), Theme.getColor(Theme.key_featuredStickers_addButton, this.resourcesProvider), ColorUtils.setAlphaComponent(Theme.getColor(i, this.resourcesProvider), 30)));
        ...
        if (this.day != null) {
            ...
            if (arrayList == null || arrayList.isEmpty()) {
                ...
                for (int i = 0; i < this.uploadingStories.size(); i++) {
                    if (AbstractC0155x440b9a8e.m36m(((StoriesController.UploadingStory) this.uploadingStories.get(i)).random_id) == this.storyViewer.dayStoryId) {
                        this.selectedPosition = i;
                        return;
                    }
                }
            ...
            if (i2 == -1 && !this.storyViewer.isSingleStory && (peerStories = this.userStories) != null && peerStories.max_read_id > 0) {
                ...
                while (true) {
                    ...
                    if (((TL_stories.StoryItem) this.storyItems.get(i3)).f1807id > this.userStories.max_read_id) {
    ...
    private void createSelfPeerView() {
        ...
        C668730 c668730 = new FrameLayout(getContext()) { // from class: org.telegram.ui.Stories.PeerStoriesView.30
            C668730(Context context) {
                super(context);
            }
            ...
            protected void dispatchDraw(Canvas canvas) {
                int x;
                if (PeerStoriesView.this.selfAvatarsContainer.getVisibility() == 0 && PeerStoriesView.this.selfAvatarsContainer.getLayoutParams().width != (x = (int) (((PeerStoriesView.this.selfStatusView.getX() + PeerStoriesView.this.selfStatusView.getMeasuredWidth()) - PeerStoriesView.this.selfAvatarsContainer.getX()) + AndroidUtilities.m1081dp(10.0f)))) {
        ...
        this.selfAvatarsContainer = c668831;
        c668831.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda31
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        hwAvatarsImageView.setAvatarsTextSize(AndroidUtilities.m1081dp(18.0f));
        ...
        this.selfAvatarsContainer.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1081dp(15.0f), 0, ColorUtils.setAlphaComponent(-1, Opcodes.ISHL)));
        imageView.setBackground(Theme.createCircleSelectorDrawable(ColorUtils.setAlphaComponent(-1, Opcodes.ISHL), -AndroidUtilities.m1081dp(2.0f), -AndroidUtilities.m1081dp(2.0f)));
    }

    /* JADX INFO: renamed from: org.telegram.ui.Stories.PeerStoriesView$30 */
    class C668730 extends FrameLayout {
        C668730(Context context) {
            super(context);
        }
    ...
    public void deleteStory() {
        AlertDialog.Builder builder = new AlertDialog.Builder(getContext(), this.resourcesProvider);
        builder.setTitle(LocaleController.getString(isBotsPreview() ? C2702R.string.DeleteBotPreviewTitle : C2702R.string.DeleteStoryTitle));
        builder.setMessage(LocaleController.getString(isBotsPreview() ? C2702R.string.DeleteBotPreviewSubtitle : C2702R.string.DeleteStorySubtitle));
        builder.setPositiveButton(LocaleController.getString(C2702R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda54
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
                this.f$0.lambda$deleteStory$41(alertDialog, i);
            }
        });
        builder.setNegativeButton(LocaleController.getString(C2702R.string.Cancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda55
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
                alertDialog.dismiss();
            }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        this.sharedResources.topOverlayGradient.setBounds(0, 0, getMeasuredWidth(), AndroidUtilities.m1081dp(72.0f));
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (this.isChannel && (animatedTextDrawable2 = this.reactionsCounter) != null) {
            animatedTextDrawable2.setBounds(0, 0, getMeasuredWidth(), AndroidUtilities.m1081dp(40.0f));
        }
        if (this.isChannel && (animatedTextDrawable = this.repostCounter) != null) {
            animatedTextDrawable.setBounds(0, 0, getMeasuredWidth(), AndroidUtilities.m1081dp(40.0f));
        }
        super.dispatchDraw(canvas);
        if (this.movingReaction) {
            ...
            int iLerp = AndroidUtilities.lerp(this.movingReactionFromSize, iM1081dp, this.movingReactionProgress);
        ...
        if (this.drawReactionEffect) {
            ...
            int iM1081dp2 = AndroidUtilities.m1081dp(120.0f);
            if (!this.drawAnimatedEmojiAsMovingReaction) {
                float f4 = iM1081dp2;
                float f5 = f4 / 2.0f;
        ...
        if (i != NotificationCenter.storiesUpdated) {
            ...
            if (i != NotificationCenter.storiesListUpdated || this.storyViewer.storiesList != objArr[0]) {
                ...
                if (i == NotificationCenter.chatInfoDidLoad) {
                    Object obj = objArr[0];
                    if ((obj instanceof TLRPC.ChatFull) && this.dialogId == (-((TLRPC.ChatFull) obj).f1611id)) {
                        updatePosition();
                        return;
                    }
                    return;
    ...
    public void checkStealthMode(boolean z) {
        if (this.chatActivityEnterView != null && this.isVisible && this.attachedToWindow) {
            ...
            if (this.starsPriceBlocked > 0) {
                ...
                this.chatActivityEnterView.setOverrideHint(StarsIntroActivity.replaceStars(LocaleController.formatString(C2702R.string.TypeMessageForStars, LocaleController.formatNumber(this.starsPriceBlocked, ','))), z);
                return;
            }
            if (!this.currentStory.isLive && stealthMode != null) {
                ...
                if (currentTime < i) {
                    ...
                    int i4 = C2702R.string.StealthModeActiveHintShort;
                    ...
                    if (iMeasureText * 1.2f >= this.chatActivityEnterView.getEditField().getMeasuredWidth()) {
                        this.chatActivityEnterView.setOverrideHint(LocaleController.formatString(C2702R.string.StealthModeActiveHintShort, _UrlKt.FRAGMENT_ENCODE_SET), String.format(locale, "%02d:%02d", Integer.valueOf(i2), Integer.valueOf(i3)), z);
                    } else {
                        this.chatActivityEnterView.setOverrideHint(LocaleController.formatString(C2702R.string.StealthModeActiveHint, String.format(locale, "%02d:%02d", Integer.valueOf(i2), Integer.valueOf(i3))), z);
                    }
            ...
            if (this.currentStory.isLive) {
                if (this.chatActivityEnterView.getStarsPrice() > 0) {
                    this.chatActivityEnterView.setOverrideHint(StarsIntroActivity.replaceStars(LocaleController.formatString(C2702R.string.CommentFor, LocaleController.formatNumber((int) r0, ',')), this.chatActivityEnterView.spans), z);
                ...
                this.chatActivityEnterView.setOverrideHint(LocaleController.getString(C2702R.string.Comment), z);
                return;
            }
            this.chatActivityEnterView.setOverrideHint(LocaleController.getString(this.isGroup ? C2702R.string.ReplyToGroupStory : C2702R.string.ReplyPrivately), z);
        }
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:2657:0x0292  */
    /* JADX WARN: Removed duplicated region for block: B:2764:0x04a4 A[ADDED_TO_REGION] */
    /* JADX WARN: Removed duplicated region for block: B:2768:0x04ba  */
    /* JADX WARN: Removed duplicated region for block: B:2770:0x04be  */
    /* JADX WARN: Removed duplicated region for block: B:2773:0x04d2 A[ADDED_TO_REGION] */
    /* JADX WARN: Removed duplicated region for block: B:2780:0x04e7  */
    /* JADX WARN: Removed duplicated region for block: B:2782:0x04ea  */
    /* JADX WARN: Removed duplicated region for block: B:2789:0x04fe  */
    /* JADX WARN: Removed duplicated region for block: B:2792:0x0503  */
    /* JADX WARN: Removed duplicated region for block: B:2797:0x0511  */
    /* JADX WARN: Removed duplicated region for block: B:2800:0x0517  */
    /* JADX WARN: Removed duplicated region for block: B:2804:0x0527 A[ADDED_TO_REGION] */
    /* JADX WARN: Removed duplicated region for block: B:2811:0x0539  */
    /* JADX WARN: Removed duplicated region for block: B:2819:0x0586  */
    /* JADX WARN: Removed duplicated region for block: B:2822:0x058f  */
    /* JADX WARN: Removed duplicated region for block: B:2825:0x05a2  */
    /* JADX WARN: Removed duplicated region for block: B:2829:0x05b5  */
    /* JADX WARN: Removed duplicated region for block: B:2834:0x05ce A[ADDED_TO_REGION] */
    /* JADX WARN: Removed duplicated region for block: B:2839:0x05dd  */
    /* JADX WARN: Removed duplicated region for block: B:2841:0x05f9  */
    /* JADX WARN: Removed duplicated region for block: B:2847:0x0619  */
    /* JADX WARN: Removed duplicated region for block: B:2908:0x089a  */
    /* JADX WARN: Removed duplicated region for block: B:2923:0x08dd  */
    /* JADX WARN: Removed duplicated region for block: B:2926:0x08e4  */
    /* JADX WARN: Removed duplicated region for block: B:2929:0x08ed  */
    /* JADX WARN: Removed duplicated region for block: B:2942:0x090e  */
    /* JADX WARN: Removed duplicated region for block: B:2945:0x0919  */
    /* JADX WARN: Removed duplicated region for block: B:2947:0x091d  */
    /* JADX WARN: Removed duplicated region for block: B:2952:0x092d  */
    /* JADX WARN: Removed duplicated region for block: B:2961:0x094d  */
    /* JADX WARN: Removed duplicated region for block: B:2964:0x0952  */
    /* JADX WARN: Removed duplicated region for block: B:2988:0x0991  */
    /* JADX WARN: Removed duplicated region for block: B:2999:0x09ab  */
    /* JADX WARN: Removed duplicated region for block: B:3008:0x09da  */
    /* JADX WARN: Removed duplicated region for block: B:3117:0x0b2d  */
    /* JADX WARN: Removed duplicated region for block: B:3126:0x0b5a  */
    /* JADX WARN: Removed duplicated region for block: B:3153:0x0ba7  */
    /* JADX WARN: Removed duplicated region for block: B:3177:0x0bfe  */
    /* JADX WARN: Removed duplicated region for block: B:3182:0x0c0b  */
    /* JADX WARN: Removed duplicated region for block: B:3194:0x0c33  */
    /* JADX WARN: Removed duplicated region for block: B:3206:0x0c62  */
    /* JADX WARN: Removed duplicated region for block: B:3214:0x0c97  */
    /* JADX WARN: Removed duplicated region for block: B:3217:0x0cad  */
    /* JADX WARN: Removed duplicated region for block: B:3222:0x0cc0  */
    /* JADX WARN: Removed duplicated region for block: B:3244:0x0d00  */
    /* JADX WARN: Removed duplicated region for block: B:3262:0x0d52  */
    /* JADX WARN: Removed duplicated region for block: B:3265:0x0d71  */
    /* JADX WARN: Removed duplicated region for block: B:3270:0x0d86  */
    /* JADX WARN: Removed duplicated region for block: B:3278:0x0dae  */
    /* JADX WARN: Removed duplicated region for block: B:3281:0x0dbf  */
    /* JADX WARN: Removed duplicated region for block: B:3290:0x0dff  */
    /* JADX WARN: Removed duplicated region for block: B:3293:0x0e0a  */
    /* JADX WARN: Removed duplicated region for block: B:3301:0x0e1c  */
    /* JADX WARN: Removed duplicated region for block: B:3320:0x0e50  */
    /* JADX WARN: Removed duplicated region for block: B:3321:0x0e59  */
    /* JADX WARN: Removed duplicated region for block: B:3324:0x0e5f  */
    /* JADX WARN: Removed duplicated region for block: B:3333:0x0e85  */
    /* JADX WARN: Removed duplicated region for block: B:3341:0x0ecb  */
    /* JADX WARN: Removed duplicated region for block: B:3343:0x0ecf  */
    /* JADX WARN: Removed duplicated region for block: B:3353:0x0f26  */
    /* JADX WARN: Removed duplicated region for block: B:3358:0x0f60  */
    /* JADX WARN: Removed duplicated region for block: B:3361:0x0f75  */
    /* JADX WARN: Removed duplicated region for block: B:3365:0x0f85  */
    /* JADX WARN: Removed duplicated region for block: B:3368:0x0f9d  */
    /* JADX WARN: Removed duplicated region for block: B:3379:0x0fbd  */
    /* JADX WARN: Removed duplicated region for block: B:3383:0x0fc6  */
    /* JADX WARN: Removed duplicated region for block: B:3389:0x0fe5  */
    /* JADX WARN: Removed duplicated region for block: B:3392:0x0ff5  */
    /* JADX WARN: Removed duplicated region for block: B:3405:0x1015  */
    /* JADX WARN: Removed duplicated region for block: B:3413:0x0da0 A[EDGE_INSN: B:3413:0x0da0->B:3276:0x0da0 BREAK  A[LOOP:0: B:3268:0x0d7a->B:3275:0x0d9d], SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:3418:? A[RETURN, SYNTHETIC] */
    ...
    */
    private void updatePosition(boolean r44) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Stories.PeerStoriesView.updatePosition(boolean):void");
    }

    /* JADX INFO: renamed from: org.telegram.ui.Stories.PeerStoriesView$32 */
    class C668932 extends ReplacementSpan {
        private final RectF rect = new RectF();

        /* JADX INFO: renamed from: bg */
        private final Paint f2129bg = new Paint(1);
        private final Text text = new Text(LocaleController.getString(C2702R.string.LiveStoryBadge), 9.0f, AndroidUtilities.bold());
        ...
        public int getSize(Paint paint, CharSequence charSequence, int i, int i2, Paint.FontMetricsInt fontMetricsInt) {
            return (int) (this.text.getWidth() + AndroidUtilities.m1081dp(12.0f));
        }

        @Override // android.text.style.ReplacementSpan
        public void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
            float fM1081dp = ((i3 + i5) / 2.0f) + AndroidUtilities.m1081dp(1.33f);
            this.rect.set(f, fM1081dp - AndroidUtilities.m1081dp(7.0f), this.text.getWidth() + f + AndroidUtilities.m1081dp(12.0f), AndroidUtilities.m1081dp(7.0f) + fM1081dp);
            this.f2129bg.setColor(-572850);
            RectF rectF = this.rect;
            canvas.drawRoundRect(rectF, rectF.height() / 2.0f, this.rect.height() / 2.0f, this.f2129bg);
            this.text.draw(canvas, AndroidUtilities.m1081dp(6.0f) + f, fM1081dp, -1, 1.0f);
        }
    }
    ...
    public /* synthetic */ void lambda$updatePosition$44(StoryCaptionView.Reply reply, View view) {
        ...
        BulletinFactory.m1194of(this.storyContainer, this.resourcesProvider).createSimpleBulletin(C2702R.raw.error, LocaleController.getString(C2702R.string.StoryHidAccount)).setTag(3).show(true);
    }
    ...
    public /* synthetic */ boolean lambda$updatePosition$48(View view) {
        ...
        ItemOptions.makeOptions(this.storyViewer.containerView, this.resourcesProvider, view).add(C2702R.drawable.msg_edit, LocaleController.getString(C2702R.string.LiveStoryMessageEditStars), new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda26
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$updatePosition$46();
            }
        }).addIf(this.messageStars > 0, C2702R.drawable.menu_delete_paid, LocaleController.getString(C2702R.string.LiveStoryMessageRemoveStars), new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda27
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$updatePosition$50() {
        if (this.storyViewer.isShown()) {
            ...
            if (this.reactionsLongpressTooltip == null) {
                ...
                this.reactionsLongpressTooltip.setText(LocaleController.getString(C2702R.string.ReactionLongTapHint));
                this.reactionsLongpressTooltip.setPadding(AndroidUtilities.m1081dp(8.0f), 0, AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(1.0f));
    ...
    private void createReplyDisabledView() {
        ...
        C669033 c669033 = new TextView(getContext()) { // from class: org.telegram.ui.Stories.PeerStoriesView.33
            C669033(Context context) {
                super(context);
            }
        ...
        this.replyDisabledTextView = c669033;
        c669033.setTextSize(1, 14.0f);
        this.replyDisabledTextView.setTextColor(ColorUtils.blendARGB(-16777216, -1, 0.5f));
        this.replyDisabledTextView.setGravity(19);
        this.replyDisabledTextView.setText(LocaleController.getString(C2702R.string.StoryReplyDisabled));
    ...
    class C669033 extends TextView {
        C669033(Context context) {
            super(context);
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:224:0x0074 A[PHI: r4 r5
  0x0074: PHI (r4v5 int) = (r4v4 int), (r4v17 int) binds: [B:222:0x006d, B:219:0x005e] A[DONT_GENERATE, DONT_INLINE]
  0x0074: PHI (r5v1 org.telegram.messenger.ImageReceiver) = (r5v0 org.telegram.messenger.ImageReceiver), (r5v12 org.telegram.messenger.ImageReceiver) binds: [B:222:0x006d, B:219:0x005e] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void updatePreloadImages() {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Stories.PeerStoriesView.updatePreloadImages():void");
    }
        ...
        if (z2 || this.isSelf) {
            ...
            if (z2) {
                ...
                if ((this.isGroup && (ChatObject.canSendPlain(chat) || ChatObject.isPossibleRemoveChatRestrictionsByBoosts(chat))) || storyItem.views.views_count <= 0) {
                    ...
                    this.selfStatusView.setText(LocaleController.getString(this.storyViewer.storiesList == null ? C2702R.string.NobodyViews : C2702R.string.NobodyViewsArchived));
                    this.selfStatusView.setTranslationX(AndroidUtilities.m1081dp(16.0f));
                    SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
                    spannableStringBuilder.append((CharSequence) "d  ");
                    spannableStringBuilder.setSpan(new ColoredImageSpan(C2702R.drawable.filled_views), spannableStringBuilder.length() - 3, spannableStringBuilder.length() - 2, 0);
                    ...
                    FrameLayout frameLayout = this.selfView;
                    if (frameLayout != null) {
                        ((FrameLayout.LayoutParams) frameLayout.getLayoutParams()).rightMargin = (int) (AndroidUtilities.m1081dp(80.0f) + this.selfStatusView.getPaint().measureText(spannableStringBuilder.toString()));
                    }
                }
                this.likeButtonContainer.getLayoutParams().width = (int) (AndroidUtilities.m1081dp(40.0f) + (this.reactionsCounterVisible ? this.reactionsCounter.getAnimateToWidth() + AndroidUtilities.m1081dp(4.0f) : 0.0f));
                ((ViewGroup.MarginLayoutParams) this.selfView.getLayoutParams()).rightMargin = AndroidUtilities.m1081dp(40.0f) + this.likeButtonContainer.getLayoutParams().width;
                FrameLayout frameLayout2 = this.repostButtonContainer;
                if (frameLayout2 != null) {
                    frameLayout2.getLayoutParams().width = (int) (AndroidUtilities.m1081dp(40.0f) + (this.repostCounterVisible ? this.repostCounter.getAnimateToWidth() + AndroidUtilities.m1081dp(4.0f) : 0.0f));
            ...
            if (storyViews2 != null && storyViews2.views_count > 0) {
                ...
                if (storyItem.views.reactions_count > 0) {
                    ...
                    ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C2702R.drawable.mini_views_likes);
                    coloredImageSpan.setOverrideColor(-53704);
                    coloredImageSpan.setTopOffset(AndroidUtilities.m1081dp(0.2f));
                ...
                if (storyItem.views.forwards_count > 0) {
                    spannableStringBuilder2.append((CharSequence) "  d ");
                    ColoredImageSpan coloredImageSpan2 = new ColoredImageSpan(C2702R.drawable.mini_repost_story);
                    coloredImageSpan2.setOverrideColor(-14161823);
                    coloredImageSpan2.setTopOffset(AndroidUtilities.m1081dp(0.2f));
                ...
                if (i3 == 0) {
                    ...
                    this.selfStatusView.setTranslationX(AndroidUtilities.m1081dp(13.0f) + AndroidUtilities.m1081dp(24.0f) + (AndroidUtilities.m1081dp(20.0f) * (i3 - 1)) + AndroidUtilities.m1081dp(10.0f));
                }
            ...
            this.likeButtonContainer.getLayoutParams().width = AndroidUtilities.m1081dp(40.0f);
        ...
        if (this.isActive) {
            ...
            if (this.currentStory.isVideo()) {
                if (this.currentStory.getLocalPath() != null && new File(this.currentStory.getLocalPath()).exists()) {
                    ...
                    FileLog.m1090d("StoryViewer requestVideoPlayer(" + j + "): playing from attachPath " + uriFromFile);
                ...
                if (uri == null) {
                    FileLog.m1090d("PeerStoriesView.requestVideoPlayer(" + j + "): playing from null?");
                }
                this.delegate.requestPlayer(document, uri, j, this.playerSharedScope);
                this.storyContainer.invalidate();
                return;
            }
            FileLog.m1090d("PeerStoriesView.requestVideoPlayer(" + j + "): null, not a video");
    ...
    public boolean closeKeyboardOrEmoji() {
        ...
        if (getKeyboardHeight() >= AndroidUtilities.m1081dp(20.0f)) {
            ChatActivityEnterView chatActivityEnterView2 = this.chatActivityEnterView;
            if (chatActivityEnterView2 != null) {
    ...
    public boolean findClickableView(ViewGroup viewGroup, float f, float f2, boolean z) {
        ...
        for (int i = 0; i < viewGroup.getChildCount(); i++) {
            ...
            if (childAt.getVisibility() == 0) {
                ...
                StoryMediaAreasView storyMediaAreasView = this.storyAreasView;
                if (childAt == storyMediaAreasView && !storyMediaAreasView.hasSelected() && (f < AndroidUtilities.m1081dp(60.0f) || f > viewGroup.getMeasuredWidth() - AndroidUtilities.m1081dp(60.0f))) {
    ...
    public void setActive(long j, boolean z) {
        if (this.isActive != z) {
            ...
            if (z) {
                ...
                if (this.currentStory.storyItem != null) {
                    FileLog.m1090d("StoryViewer displayed story dialogId=" + this.dialogId + " storyId=" + this.currentStory.storyItem.f1807id + " " + this.currentStory.getMediaDebugString());
                }
            } else {
                cancelTextSelection();
    ...
    private void showAttachmentError() {
        BulletinFactory.m1194of(this.storyContainer, this.resourcesProvider).createErrorBulletin(LocaleController.getString(C2702R.string.UnsupportedAttachment), this.resourcesProvider).show();
    }
    ...
    class RunnableC669134 implements Runnable {
        RunnableC669134() {
        }
    ...
    public void showNoSoundHint(boolean z) {
        if (this.soundTooltip == null) {
            ...
            joint.setPadding(AndroidUtilities.m1081dp(8.0f), 0, AndroidUtilities.m1081dp(8.0f), 0);
            this.storyContainer.addView(this.soundTooltip, LayoutHelper.createFrame(-1, -2.0f, 55, 0.0f, 52.0f, 0.0f, 0.0f));
        }
        this.soundTooltip.setText(LocaleController.getString(z ? C2702R.string.StoryNoSound : C2702R.string.StoryTapToSound));
    ...
    public static class PeerHeaderView extends FrameLayout {
        ...
        public PeerHeaderView(Context context, StoryItemHolder storyItemHolder) {
            ...
            C67051 c67051 = new BackupImageView(context) { // from class: org.telegram.ui.Stories.PeerStoriesView.PeerHeaderView.1
                C67051(Context context2) {
                    super(context2);
                }
            ...
            this.backupImageView = c67051;
            c67051.setRoundRadius(ExteraConfig.getAvatarCorners(32.0f));
            addView(this.backupImageView, LayoutHelper.createFrame(32, 32.0f, 0, 12.0f, 2.0f, 0.0f, 0.0f));
            setClipChildren(false);
            C67062 c67062 = new SimpleTextView(context2) { // from class: org.telegram.ui.Stories.PeerStoriesView.PeerHeaderView.2
                C67062(Context context2) {
                    super(context2);
                }
            ...
            this.titleView = c67062;
            c67062.setTextSize(14);
            this.titleView.setTypeface(AndroidUtilities.bold());
            this.titleView.setMaxLines(1);
            this.titleView.setEllipsizeByGradient(AndroidUtilities.m1081dp(4.0f));
            ...
            for (int i = 0; i < 2; i++) {
                ...
                this.subtitleView[i].setPadding(AndroidUtilities.m1081dp(3.0f), 0, AndroidUtilities.m1081dp(3.0f), AndroidUtilities.m1081dp(1.0f));
        ...
        class C67051 extends BackupImageView {
            C67051(Context context2) {
                super(context2);
            }
        ...
        class C67062 extends SimpleTextView {
            C67062(Context context2) {
                super(context2);
            }
        ...
        public void setSubtitle(CharSequence charSequence, boolean z) {
            ...
            if (z) {
                ...
                this.subtitleView[0].setTranslationY(-AndroidUtilities.m1081dp(4.0f));
        ...
        public /* synthetic */ void lambda$setSubtitle$0(ValueAnimator valueAnimator) {
            ...
            this.subtitleView[0].setTranslationY((-AndroidUtilities.m1081dp(4.0f)) * f);
            this.subtitleView[1].setAlpha(f);
            this.subtitleView[1].setTranslationY(fFloatValue * AndroidUtilities.m1081dp(4.0f));
        }

        /* JADX INFO: renamed from: org.telegram.ui.Stories.PeerStoriesView$PeerHeaderView$3 */
        class C67073 extends AnimatorListenerAdapter {
            C67073() {
            }
        ...
        public void drawUploadingProgress(Canvas canvas, RectF rectF, boolean z, float f) {
            ...
            float fM1081dp = AndroidUtilities.m1081dp(3.0f) - (AndroidUtilities.m1081dp(6.0f) * (1.0f - this.progressToUploading));
            this.radialProgress.setProgressRect((int) (rectF.left - fM1081dp), (int) (rectF.top - fM1081dp), (int) (rectF.right + fM1081dp), (int) (rectF.bottom + fM1081dp));
            ...
            if (z) {
                ...
                if (this.radialProgressPaint == null) {
                    ...
                    paint.setColor(-1);
                    this.radialProgressPaint.setStrokeWidth(AndroidUtilities.m1081dp(2.0f));
    ...
    public class StoryItemHolder {
        ...
        boolean isThisCall(long j) {
            ...
            TLRPC.MessageMedia messageMedia = storyItem.media;
            return (messageMedia instanceof TLRPC.TL_messageMediaVideoStream) && j == ((TLRPC.TL_messageMediaVideoStream) messageMedia).call.f1632id;
        }
        ...
        public String getMediaDebugString() {
            ...
            if (storyItem != null && (messageMedia = storyItem.media) != null) {
                if (messageMedia.photo != null) {
                    return "photo#" + this.storyItem.media.photo.f1642id + "at" + this.storyItem.media.photo.dc_id + "dc";
                }
                if (messageMedia.document != null) {
                    return "doc#" + this.storyItem.media.document.f1618id + "at" + this.storyItem.media.document.dc_id + "dc";
                }
                return "unknown";
            }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:165:0x005a, code lost:
            ...
            if (org.telegram.p026ui.Stories.PeerStoriesView.this.isSelf != false) goto L166;
         */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        public void checkSendView() {
            /*
                r6 = this;
                org.telegram.ui.Stories.PeerStoriesView r0 = org.telegram.p026ui.Stories.PeerStoriesView.this
                ...
                long r2 = org.telegram.p026ui.Stories.PeerStoriesView.m17988$$Nest$fgetdialogId(r0)
                org.telegram.tgnet.tl.TL_stories$PeerStories r1 = r1.getStories(r2)
                if (r1 != 0) goto L2a
                org.telegram.ui.Stories.PeerStoriesView r0 = org.telegram.p026ui.Stories.PeerStoriesView.this
                int r0 = org.telegram.p026ui.Stories.PeerStoriesView.m17986$$Nest$fgetcurrentAccount(r0)
                org.telegram.messenger.MessagesController r0 = org.telegram.messenger.MessagesController.getInstance(r0)
                org.telegram.ui.Stories.PeerStoriesView r2 = org.telegram.p026ui.Stories.PeerStoriesView.this
                long r2 = org.telegram.p026ui.Stories.PeerStoriesView.m17988$$Nest$fgetdialogId(r2)
            ...
            L2a:
                ...
                if (r0 == 0) goto L9a
                if (r1 == 0) goto L9a
                boolean r0 = org.telegram.p026ui.Stories.StoriesUtilities.hasExpiredViews(r0)
                if (r0 != 0) goto L56
                org.telegram.tgnet.tl.TL_stories$StoryItem r0 = r6.storyItem
                int r0 = r0.f1807id
                int r1 = r1.max_read_id
                if (r0 > r1) goto L5c
                org.telegram.ui.Stories.PeerStoriesView r1 = org.telegram.p026ui.Stories.PeerStoriesView.this
                ...
                long r4 = org.telegram.p026ui.Stories.PeerStoriesView.m17988$$Nest$fgetdialogId(r1)
                r1 = 0
                int r1 = r3.get(r4, r1)
                if (r0 > r1) goto L5c
            L56:
            ...
            L5c:
                org.telegram.ui.Stories.PeerStoriesView r0 = org.telegram.p026ui.Stories.PeerStoriesView.this
                org.telegram.ui.Stories.StoryViewer r0 = org.telegram.p026ui.Stories.PeerStoriesView.m18049$$Nest$fgetstoryViewer(r0)
            ...
            L81:
                org.telegram.ui.Stories.PeerStoriesView r0 = org.telegram.p026ui.Stories.PeerStoriesView.this
                org.telegram.ui.Stories.StoriesController r1 = r0.storiesController
                long r3 = org.telegram.p026ui.Stories.PeerStoriesView.m17988$$Nest$fgetdialogId(r0)
                org.telegram.tgnet.tl.TL_stories$StoryItem r0 = r6.storyItem
        ...
        public String createLink() {
            ...
            if (peerStoriesView.dialogId > 0) {
                ...
                return PeerStoriesView.this.currentStory.isLive ? String.format(Locale.US, "https://t.me/%1$s/s/live", UserObject.getPublicUsername(user)) : String.format(Locale.US, "https://t.me/%1$s/s/%2$s", UserObject.getPublicUsername(user), Integer.valueOf(PeerStoriesView.this.currentStory.storyItem.f1807id));
            }
            TLRPC.Chat chat = MessagesController.getInstance(PeerStoriesView.this.currentAccount).getChat(Long.valueOf(-PeerStoriesView.this.dialogId));
            if (ChatObject.getPublicUsername(chat) == null) {
                return null;
            }
            return PeerStoriesView.this.currentStory.isLive ? String.format(Locale.US, "https://t.me/%1$s/s/live", ChatObject.getPublicUsername(chat)) : String.format(Locale.US, "https://t.me/%1$s/s/%2$s", ChatObject.getPublicUsername(chat), Integer.valueOf(PeerStoriesView.this.currentStory.storyItem.f1807id));
        }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.realKeyboardHeight < AndroidUtilities.m1081dp(20.0f)) {
            this.realKeyboardHeight = 0;
        }
        ...
        boolean z3 = size - size2 > AndroidUtilities.m1081dp(64.0f);
        this.BIG_SCREEN = z3;
        int iM1081dp = (size - ((z3 ? AndroidUtilities.m1081dp(64.0f) : 0) + size2)) >> 1;
        layoutParams.topMargin = iM1081dp;
        if (this.BIG_SCREEN) {
            this.enterViewBottomOffset = (((-iM1081dp) + size) - size2) - AndroidUtilities.m1081dp(64.0f);
        } else {
            this.enterViewBottomOffset = ((-iM1081dp) + size) - size2;
        }
        ...
        if (frameLayout != null) {
            ...
            if (this.BIG_SCREEN) {
                layoutParams2.topMargin = iM1081dp + size2 + AndroidUtilities.m1081dp(8.0f);
            } else {
                layoutParams2.topMargin = (iM1081dp + size2) - AndroidUtilities.m1081dp(48.0f);
            }
        }
        ...
        if (textView != null) {
            ...
            if (!this.BIG_SCREEN) {
                ...
                layoutParams3.topMargin = ((iM1081dp + size2) - AndroidUtilities.m1081dp(12.0f)) - AndroidUtilities.m1081dp(40.0f);
                c = 0;
            } else {
                c = 0;
                this.replyDisabledTextView.setTextColor(ColorUtils.blendARGB(-16777216, -1, 0.5f));
                layoutParams3.topMargin = iM1081dp + size2 + AndroidUtilities.m1081dp(12.0f);
            }
        } else {
            c = 0;
        }
        ...
        if (instantCameraView != null) {
            ...
            if (visibleEmojiPadding == 0) {
                layoutParams4.bottomMargin = size - ((iM1081dp + size2) - AndroidUtilities.m1081dp(64.0f));
            } else {
                layoutParams4.bottomMargin = visibleEmojiPadding + AndroidUtilities.m1081dp(64.0f);
            }
        }
        if (!this.BIG_SCREEN) {
            ((FrameLayout.LayoutParams) this.bottomActionsLinearLayout.getLayoutParams()).topMargin = ((iM1081dp + size2) - AndroidUtilities.m1081dp(12.0f)) - AndroidUtilities.m1081dp(40.0f);
            int iM1081dp2 = this.isSelf ? AndroidUtilities.m1081dp(40.0f) : AndroidUtilities.m1081dp(56.0f);
            ((FrameLayout.LayoutParams) this.storyCaptionView.getLayoutParams()).bottomMargin = iM1081dp2;
            ...
            this.storyCaptionView.blackoutBottomOffset = iM1081dp2;
        } else {
            ((FrameLayout.LayoutParams) this.bottomActionsLinearLayout.getLayoutParams()).topMargin = iM1081dp + size2 + AndroidUtilities.m1081dp(12.0f);
            ((FrameLayout.LayoutParams) this.storyCaptionView.getLayoutParams()).bottomMargin = AndroidUtilities.m1081dp(8.0f);
            if (this.wasBigScreen != this.BIG_SCREEN) {
            ...
            this.storyCaptionView.blackoutBottomOffset = AndroidUtilities.m1081dp(8.0f);
        }
        this.forceUpdateOffsets = true;
        float fM1081dp = AndroidUtilities.m1081dp(48.0f);
        if (this.privacyButton.getVisibility() == 0) {
            fM1081dp += AndroidUtilities.m1081dp(60.0f);
        }
        if (this.muteIconContainer.getVisibility() == 0) {
            fM1081dp += AndroidUtilities.m1081dp(40.0f);
        }
        FrameLayout.LayoutParams layoutParams5 = (FrameLayout.LayoutParams) this.headerView.titleView.getLayoutParams();
        if (layoutParams5.rightMargin != fM1081dp) {
            int i3 = (int) fM1081dp;
    ...
    class C669235 extends AnimatorListenerAdapter {
        C669235() {
        }
    ...
    public void updateViewOffsets() {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Stories.PeerStoriesView.updateViewOffsets():void");
    }
        ...
        if (view == chatActivityEnterView) {
            ...
            if (!this.currentStory.isLive) {
                ...
                if (frameLayout != null && frameLayout.getVisibility() == 0) {
                    fM1081dp2 = (fM1081dp2 - AndroidUtilities.m1081dp(40.0f)) + this.likeButtonContainer.getLayoutParams().width;
                }
                fM1081dp = 0.0f;
            } else {
                fM1081dp = AndroidUtilities.m1081dp(46.0f);
                fM1081dp2 = AndroidUtilities.m1081dp(46.0f);
            ...
            this.sharedResources.rect2.set(AndroidUtilities.m1081dp(10.0f) + fM1081dp, ((this.chatActivityEnterView.getY() + this.chatActivityEnterView.getMeasuredHeight()) - AndroidUtilities.m1081dp(5.0f)) - AndroidUtilities.m1081dp(38.0f), (getMeasuredWidth() - AndroidUtilities.m1081dp(10.0f)) - fM1081dp2, (this.chatActivityEnterView.getY() + this.chatActivityEnterView.getMeasuredHeight()) - AndroidUtilities.m1081dp(5.0f));
            this.chatActivityEnterView.setTranslationX(fM1081dp * (1.0f - this.progressToKeyboard));
            this.chatActivityEnterView.getEditField().setTranslationY((this.chatActivityEnterView.getMeasuredHeight() > AndroidUtilities.m1081dp(50.0f) ? 0.0f + ((1.0f - this.progressToKeyboard) * (this.chatActivityEnterView.getMeasuredHeight() - AndroidUtilities.m1081dp(50.0f))) : 0.0f) + ((-AndroidUtilities.m1081dp(2.0f)) * (1.0f - this.progressToKeyboard)));
            float fM1081dp3 = AndroidUtilities.m1081dp(50.0f) / 2.0f;
            ...
            if (blurredBackgroundDrawable != null) {
                ...
                this.inputFieldBackground.setRadius(fM1081dp3);
                ...
                canvas2.drawRoundRect(this.sharedResources.finalRect, fM1081dp3, fM1081dp3, this.inputBackgroundPaint);
            }
            ...
            if (chatActivityEnterView != null && chatActivityEnterView.isPopupView(view)) {
                float fM1081dp4 = AndroidUtilities.m1081dp(30.0f);
                this.sharedResources.popupRect.set(0.0f, view.getY() + AndroidUtilities.m1081dp(1.0f), getWidth(), getHeight() + AndroidUtilities.m1081dp(20.0f));
                this.clipPath.rewind();
                this.clipPath.addRoundRect(this.sharedResources.popupRect, fM1081dp4, fM1081dp4, Path.Direction.CW);
                canvas2.save();
                ...
                if (blurredBackgroundDrawable2 != null) {
                    ...
                    this.emojiKeyboardBackground.setRadius(fM1081dp4, fM1081dp4, fM1081dp4, fM1081dp4);
                    this.emojiKeyboardBackground.setAlpha(Function.USE_VARARGS);
                    this.emojiKeyboardBackground.draw(canvas2);
                } else {
                    canvas2.drawRoundRect(this.sharedResources.popupRect, fM1081dp4, fM1081dp4, this.inputBackgroundPaint);
                }
            ...
            if (view == this.reactionsContainerLayout && this.chatActivityEnterView != null) {
                view.setTranslationY(((-r11.getMeasuredHeight()) + (this.chatActivityEnterView.getY() + this.chatActivityEnterView.getAnimatedTop())) - AndroidUtilities.m1081dp(18.0f));
            } else {
                if (view == this.likesReactionLayout) {
                    view.setTranslationY((((-(r11.getMeasuredHeight() - this.likesReactionLayout.getPaddingBottom())) + this.likeButtonContainer.getY()) + this.bottomActionsLinearLayout.getY()) - AndroidUtilities.m1081dp(18.0f));
    ...
    class C669336 implements InstantCameraView.Delegate {
        @Override // org.telegram.ui.Components.InstantCameraView.Delegate
        public /* synthetic */ boolean isInScheduleMode() {
            return InstantCameraView.Delegate.CC.$default$isInScheduleMode(this);
        }
    ...
    public void afterMessageSend(boolean z) {
        BulletinFactory bulletinFactoryM1194of;
        InstantCameraView instantCameraView = this.instantCameraView;
        if (instantCameraView != null) {
        ...
        if (z && (bulletinFactoryM1194of = BulletinFactory.m1194of(this.storyContainer, this.resourcesProvider)) != null) {
            bulletinFactoryM1194of.createSimpleBulletin(C2702R.raw.forward, LocaleController.getString(C2702R.string.MessageSent), LocaleController.getString(C2702R.string.ViewInChat), 5000, new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda20
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.openChat();
                }
    ...
    class C669437 extends WrappedResourceProvider {
        C669437(Theme.ResourcesProvider resourcesProvider) {
            super(resourcesProvider);
        }
    ...
    void checkReactionsLayout() {
        if (this.reactionsContainerLayout == null) {
            ...
            reactionsContainerLayout.setHint(LocaleController.getString(this.isGroup ? C2702R.string.StoryGroupReactionsHint : C2702R.string.StoryReactionsHint));
            ...
            this.reactionsContainerLayout.setDelegate(new C669538());
            this.reactionsContainerLayout.setMessage(null, null, true);
        }
        this.reactionsContainerLayout.setFragment(LaunchActivity.getLastFragment());
        this.reactionsContainerLayout.setHint(LocaleController.getString(this.isGroup ? C2702R.string.StoryGroupReactionsHint : C2702R.string.StoryReactionsHint));
    }

    /* JADX INFO: renamed from: org.telegram.ui.Stories.PeerStoriesView$38 */
    class C669538 implements ReactionsContainerLayout.ReactionsContainerDelegate {
        ...
        public /* synthetic */ void lambda$onReactionClickedInternal$2(boolean z, ReactionsLayoutInBubble.VisibleReaction visibleReaction, View view, Long l) {
            ...
            if (visibleReaction2.emojicon != null) {
                ...
                SendMessagesHelper.SendMessageParams sendMessageParamsM1123of = SendMessagesHelper.SendMessageParams.m1123of(visibleReaction2.emojicon, PeerStoriesView.this.dialogId);
                sendMessageParamsM1123of.replyToStoryItem = PeerStoriesView.this.currentStory.storyItem;
                sendMessageParamsM1123of.payStars = l.longValue();
                SendMessagesHelper.getInstance(PeerStoriesView.this.currentAccount).sendMessage(sendMessageParamsM1123of);
            } else {
                ...
                SendMessagesHelper.SendMessageParams sendMessageParamsM1123of2 = SendMessagesHelper.SendMessageParams.m1123of(strFindAnimatedEmojiEmoticon, PeerStoriesView.this.dialogId);
                sendMessageParamsM1123of2.entities = new ArrayList<>();
                ...
                sendMessageParamsM1123of2.entities.add(tL_messageEntityCustomEmoji);
                sendMessageParamsM1123of2.replyToStoryItem = PeerStoriesView.this.currentStory.storyItem;
                sendMessageParamsM1123of2.payStars = l.longValue();
                SendMessagesHelper.getInstance(PeerStoriesView.this.currentAccount).sendMessage(sendMessageParamsM1123of2);
            }
            if (l.longValue() <= 0) {
                PeerStoriesView peerStoriesView = PeerStoriesView.this;
                BulletinFactory.m1194of(peerStoriesView.storyContainer, peerStoriesView.resourcesProvider).createEmojiBulletin(documentFindDocument, LocaleController.getString(C2702R.string.ReactionSent), LocaleController.getString(C2702R.string.ViewInChat), new Runnable() { // from class: org.telegram.ui.Stories.PeerStoriesView$38$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    class C669639 extends WrappedResourceProvider {
        C669639(Theme.ResourcesProvider resourcesProvider) {
            super(resourcesProvider);
        }
    ...
    void checkReactionsLayoutForLike() {
        ...
        if (reactionsContainerLayout == null) {
            ...
            reactionsContainerLayout2.setPadding(0, 0, 0, AndroidUtilities.m1081dp(22.0f));
            ...
            this.likesReactionLayout.setDelegate(new C669840());
    ...
    class C669840 implements ReactionsContainerLayout.ReactionsContainerDelegate {
        @Override // org.telegram.ui.Components.ReactionsContainerLayout.ReactionsContainerDelegate
        public /* synthetic */ boolean allowLongPress() {
            return ReactionsContainerLayout.ReactionsContainerDelegate.CC.$default$allowLongPress(this);
        }
        ...
        public /* synthetic */ void lambda$onReactionClicked$1(ReactionsLayoutInBubble.VisibleReaction visibleReaction, View view) {
            ...
            storiesLikeButton.animate().alpha(0.0f).scaleX(0.8f).scaleY(0.8f).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Stories.PeerStoriesView.40.1
                ...
                AnonymousClass1(View storiesLikeButton2) {
                    view = storiesLikeButton2;
                }
            ...
            PeerStoriesView.this.storiesLikeButton.setPadding(iM1081dp, iM1081dp, iM1081dp, iM1081dp);
            ...
            valueAnimatorOfFloat.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Stories.PeerStoriesView.40.2
                ...
                AnonymousClass2(final boolean[] zArr2, StoriesLikeButton storiesLikeButton22) {
                    zArr = zArr2;
    ...
    public static class SharedResources {
        ...
        SharedResources(Context context) {
            this.shareDrawable = ContextCompat.getDrawable(context, C2702R.drawable.media_share);
            this.likeDrawable = ContextCompat.getDrawable(context, C2702R.drawable.media_like);
            this.repostDrawable = ContextCompat.getDrawable(context, C2702R.drawable.media_repost);
            Drawable drawable = ContextCompat.getDrawable(context, C2702R.drawable.media_like_active);
            this.likeDrawableFilled = drawable;
            drawable.setColorFilter(new PorterDuffColorFilter(-53704, PorterDuff.Mode.MULTIPLY));
            this.optionsDrawable = ContextCompat.getDrawable(context, C2702R.drawable.media_more);
            this.pipDrawable = ContextCompat.getDrawable(context, C2702R.drawable.menu_stream_pip);
            this.deleteDrawable = ContextCompat.getDrawable(context, C2702R.drawable.msg_delete);
            this.muteDrawable = new RLottieDrawable(C2702R.raw.media_mute_unmute, "media_mute_unmute", AndroidUtilities.m1081dp(28.0f), AndroidUtilities.m1081dp(28.0f), true, null);
            RLottieDrawable rLottieDrawable = new RLottieDrawable(C2702R.raw.media_mute_unmute, "media_mute_unmute", AndroidUtilities.m1081dp(28.0f), AndroidUtilities.m1081dp(28.0f), true, null);
            ...
            this.topOverlayGradient = ContextCompat.getDrawable(context, C2702R.drawable.shadow_story_top);
            this.bottomOverlayGradient = ContextCompat.getDrawable(context, C2702R.drawable.shadow_story_bottom);
    ...
    public /* synthetic */ void lambda$editPrivacy$57(final TL_stories.StoryItem storyItem, final StoryPrivacyBottomSheet.StoryPrivacy storyPrivacy, boolean z, boolean z2, boolean z3, boolean z4, TLRPC.InputPeer inputPeer, int i, final Runnable runnable, Runnable runnable2) {
        ...
        tL_stories_editStory.f1811id = storyItem.f1807id;
    ...
    public /* synthetic */ void lambda$editPrivacy$55(Runnable runnable, TLRPC.TL_error tL_error, TL_stories.StoryItem storyItem, StoryPrivacyBottomSheet.StoryPrivacy storyPrivacy) {
        ...
        if (tL_error == null || "STORY_NOT_MODIFIED".equals(tL_error.text)) {
            ...
            if (i2 == 4) {
                BulletinFactory.m1194of(this.storyContainer, this.resourcesProvider).createSimpleBulletin(C2702R.raw.contact_check, LocaleController.getString("StorySharedToEveryone")).show();
            } else if (i2 == 1) {
                BulletinFactory.m1194of(this.storyContainer, this.resourcesProvider).createSimpleBulletin(C2702R.raw.contact_check, LocaleController.getString("StorySharedToCloseFriends")).show();
            } else if (i2 == 2) {
                if (storyPrivacy.selectedUserIds.isEmpty()) {
                    BulletinFactory.m1194of(this.storyContainer, this.resourcesProvider).createSimpleBulletin(C2702R.raw.contact_check, LocaleController.getString("StorySharedToAllContacts")).show();
                } else {
                    BulletinFactory.m1194of(this.storyContainer, this.resourcesProvider).createSimpleBulletin(C2702R.raw.contact_check, LocaleController.formatPluralString("StorySharedToAllContactsExcluded", storyPrivacy.selectedUserIds.size(), new Object[0])).show();
                }
            } else if (i2 == 3) {
                HashSet hashSet = new HashSet();
                ...
                BulletinFactory.m1194of(this.storyContainer, this.resourcesProvider).createSimpleBulletin(C2702R.raw.contact_check, LocaleController.formatPluralString("StorySharedToContacts", hashSet.size(), new Object[0])).show();
            }
        } else {
            BulletinFactory.m1194of(this.storyContainer, this.resourcesProvider).createSimpleBulletin(C2702R.raw.error, LocaleController.getString(C2702R.string.UnknownError)).show();
        }
        updatePosition();
    }
    ...
    public boolean checkRecordLocked(final boolean z) {
        ...
        if (this.chatActivityEnterView.isInVideoMode()) {
            builder.setTitle(LocaleController.getString(C2702R.string.DiscardVideoMessageTitle));
            builder.setMessage(LocaleController.getString(C2702R.string.DiscardVideoMessageDescription));
        } else {
            builder.setTitle(LocaleController.getString(C2702R.string.DiscardVoiceMessageTitle));
            builder.setMessage(LocaleController.getString(C2702R.string.DiscardVoiceMessageDescription));
        }
        builder.setPositiveButton(LocaleController.getString(C2702R.string.DiscardVoiceMessageAction), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Stories.PeerStoriesView$$ExternalSyntheticLambda2
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
                this.f$0.lambda$checkRecordLocked$58(z, alertDialog, i);
            }
        });
        builder.setNegativeButton(LocaleController.getString(C2702R.string.Continue), null);
        this.delegate.showDialog(builder.create());
        return true;
    }
    ...
    public void animateOut(boolean z) {
        ...
        this.outAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Stories.PeerStoriesView.41
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                PeerStoriesView.this.headerView.setTranslationY((-AndroidUtilities.m1081dp(8.0f)) * PeerStoriesView.this.outT);
                PeerStoriesView peerStoriesView = PeerStoriesView.this;
                peerStoriesView.headerView.setAlpha(1.0f - peerStoriesView.outT);
                PeerStoriesView.this.optionsIconView.setTranslationY((-AndroidUtilities.m1081dp(8.0f)) * PeerStoriesView.this.outT);
                PeerStoriesView.this.optionsIconView.setAlpha(1.0f - PeerStoriesView.this.outT);
                PeerStoriesView.this.pipIconView.setTranslationY((-AndroidUtilities.m1081dp(8.0f)) * PeerStoriesView.this.outT);
                PeerStoriesView.this.pipIconView.setAlpha(1.0f - PeerStoriesView.this.outT);
                PeerStoriesView.this.muteIconContainer.setTranslationY((-AndroidUtilities.m1081dp(8.0f)) * PeerStoriesView.this.outT);
                ...
                if (PeerStoriesView.this.selfView != null) {
                    PeerStoriesView.this.selfView.setTranslationY(AndroidUtilities.m1081dp(8.0f) * PeerStoriesView.this.outT);
                    PeerStoriesView.this.selfView.setAlpha(1.0f - PeerStoriesView.this.outT);
                }
                if (PeerStoriesView.this.privacyButton != null) {
                    PeerStoriesView.this.privacyButton.setTranslationY((-AndroidUtilities.m1081dp(8.0f)) * PeerStoriesView.this.outT);
    ...
    public /* synthetic */ void lambda$animateOut$59(ValueAnimator valueAnimator) {
        ...
        this.headerView.setTranslationY((-AndroidUtilities.m1081dp(8.0f)) * this.outT);
        this.headerView.setAlpha(1.0f - this.outT);
        this.optionsIconView.setTranslationY((-AndroidUtilities.m1081dp(8.0f)) * this.outT);
        this.optionsIconView.setAlpha(1.0f - this.outT);
        this.pipIconView.setTranslationY((-AndroidUtilities.m1081dp(8.0f)) * this.outT);
        this.pipIconView.setAlpha(1.0f - this.outT);
        this.muteIconContainer.setTranslationY((-AndroidUtilities.m1081dp(8.0f)) * this.outT);
        this.muteIconContainer.setAlpha(this.muteIconViewAlpha * (1.0f - this.outT));
        FrameLayout frameLayout = this.selfView;
        if (frameLayout != null) {
            frameLayout.setTranslationY(AndroidUtilities.m1081dp(8.0f) * this.outT);
            this.selfView.setAlpha(1.0f - this.outT);
        }
        StoryPrivacyButton storyPrivacyButton = this.privacyButton;
        if (storyPrivacyButton != null) {
            storyPrivacyButton.setTranslationY((-AndroidUtilities.m1081dp(8.0f)) * this.outT);
    ...
    class C669941 extends AnimatorListenerAdapter {
        final /* synthetic */ boolean val$out;
