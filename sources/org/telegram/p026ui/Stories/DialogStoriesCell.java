...
import org.telegram.p026ui.ActionBar.ActionBarAnimatedSubtitleOverlayContainer;
...
import org.telegram.p026ui.Components.CanvasButton;
...
public abstract class DialogStoriesCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, FactorAnimator.Target {
    ...
    public DialogStoriesCell(Context context, BaseFragment baseFragment, int i, int i2) {
        ...
        this.menuItemsOffset = AndroidUtilities.m1081dp(68.0f);
        ...
        recyclerListView.setPadding(AndroidUtilities.m1081dp(3.0f), 0, AndroidUtilities.m1081dp(3.0f), 0);
        ...
        this.titleView.setPadding(0, AndroidUtilities.m1081dp(8.0f), 0, AndroidUtilities.m1081dp(8.0f));
        this.titleView.setTextSize(AndroidUtilities.m1081dp((AndroidUtilities.isTablet() || getResources().getConfiguration().orientation != 2) ? 20.0f : 18.0f));
        addView(this.titleView, LayoutHelper.createFrame(-1, -2.0f));
        AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable swapAnimatedEmojiDrawable = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(null, AndroidUtilities.m1081dp(26.0f));
        ...
        this.grayPaint.setStrokeWidth(AndroidUtilities.m1081dp(1.0f));
        this.addNewStoryDrawable = ContextCompat.getDrawable(getContext(), C2702R.drawable.msg_mini_addstory);
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                while (i3 < DialogStoriesCell.this.viewsDrawInParent.size()) {
                    ...
                    if (storyCell2.getAlpha() != 1.0f) {
                        canvas2 = canvas;
                        canvas2.saveLayerAlpha(-AndroidUtilities.m1081dp(4.0f), -AndroidUtilities.m1081dp(4.0f), AndroidUtilities.m1081dp(50.0f), AndroidUtilities.m1081dp(50.0f), (int) (storyCell2.getAlpha() * 255.0f), 31);
                    } else {
                        canvas2 = canvas;
                    }
                    canvas2.scale(storyCell2.getScaleX(), storyCell2.getScaleY(), AndroidUtilities.m1081dp(14.0f), storyCell2.getCy());
        ...
        this.listViewMini.addItemDecoration(new RecyclerView.ItemDecoration() { // from class: org.telegram.ui.Stories.DialogStoriesCell.8
            ...
            public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
                ...
                if (childLayoutPosition == 1) {
                    rect.left = (-AndroidUtilities.m1081dp(85.0f)) + AndroidUtilities.m1081dp(31.0f);
    ...
    public /* synthetic */ void lambda$openStoryForCell$5(StoryCell storyCell, final long j) {
        ...
        orCreateStoryViewer.open(getContext(), null, arrayList, size, null, null, StoriesListPlaceProvider.m1269of(this.recyclerListView).with(new StoriesListPlaceProvider.LoadNextInterface() { // from class: org.telegram.ui.Stories.DialogStoriesCell$$ExternalSyntheticLambda18
    ...
    public void updateItems(boolean z, boolean z2) {
        ...
        if (this.storiesController.hasOnlySelfStories()) {
            if (this.storiesController.hasUploadingStories(UserConfig.getInstance(this.currentAccount).getClientUserId())) {
                String string = LocaleController.getString(C2702R.string.UploadingStory);
                if (string.indexOf("…") > 0) {
                ...
                this.currentTitle = LocaleController.getString(C2702R.string.MyStory);
            }
        } else {
            if (this.type == 0) {
                pluralString = LocaleUtils.getActionBarTitle();
            } else {
    ...
    */
    protected void dispatchDraw(android.graphics.Canvas r30) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Stories.DialogStoriesCell.dispatchDraw(android.graphics.Canvas):void");
    }
    ...
    protected void onMeasure(int i, int i2) {
        this.titleView.setTextSize(AndroidUtilities.m1081dp((AndroidUtilities.isTablet() || getResources().getConfiguration().orientation != 2) ? 20.0f : 18.0f));
        this.currentCellWidth = AndroidUtilities.m1081dp(70.0f);
        AndroidUtilities.rectTmp.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(89.0f), TLObject.FLAG_30));
    }
    ...
    public void setProgressToCollapse(float f, boolean z) {
        ...
        final boolean z2 = f > this.f2124K;
    ...
    */
    public void openStoryRecorder(final long r13) {
        ...
        L68:
            ...
            org.telegram.ui.Stories.DialogStoriesCell$$ExternalSyntheticLambda19 r0 = new org.telegram.ui.Stories.DialogStoriesCell$$ExternalSyntheticLambda19
            r1 = r12
            r3 = r13
            r0.<init>()
            r10 = 1
        ...
        L90:
            ...
            int r2 = r12.currentAccount
            org.telegram.ui.Stories.recorder.StoryRecorder r0 = org.telegram.p026ui.Stories.recorder.StoryRecorder.getInstance(r0, r2)
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Stories.DialogStoriesCell.openStoryRecorder(long):void");
    }
    ...
    public void setTitleOverlayText(String str, int i) {
        this.subtitleOverlayContainer.setText(i == C2702R.string.ConnectingToProxyWithDots ? AndroidUtilities.replaceArrows(LocaleController.getString(C2702R.string.TitleSetupProxy), true, AndroidUtilities.m1081dp(2.6666667f), AndroidUtilities.m1081dp(2.0f)) : null, true);
        boolean z = false;
        if (str != null) {
    ...
    public void openSelfStories() {
        if (this.storiesController.hasSelfStories()) {
            ...
            this.fragment.getOrCreateStoryViewer().open(getContext(), null, arrayList, 0, null, null, StoriesListPlaceProvider.m1269of(this.listViewMini), false);
        }
    }
    ...
    public void setOverscroll(float f) {
        this.overscrollProgress = f / AndroidUtilities.m1081dp(90.0f);
        invalidate();
    ...
    public class StoryCell extends FrameLayout {
        ...
        private float f2125cx;

        /* JADX INFO: renamed from: cy */
        private float f2126cy;
        long dialogId;
        ...
        public void setDialogId(long j) {
            ...
            if (DialogStoriesCell.this.storiesController.isLastUploadingFailed(j)) {
                ...
                this.textView.setText(LocaleController.getString(C2702R.string.FailedStory));
            ...
            if (this.isSelf) {
                if (z && this.isUploadingState && !this.mini) {
                    ...
                    this.textView.setTranslationY(AndroidUtilities.m1081dp(5.0f));
                ...
                this.isUploadingState = false;
                this.textView.setTextSize(10);
                this.textView.setText(LocaleController.getString(C2702R.string.MyStory));
                return;
            }
            if (this.user != null) {
                this.textView.setTextSize(11);
        ...
        public /* synthetic */ void lambda$setDialogId$0(View view, ValueAnimator valueAnimator) {
            ...
            view.setAlpha(f);
            view.setTranslationY((-AndroidUtilities.m1081dp(5.0f)) * fFloatValue);
            this.textView.setAlpha(fFloatValue);
            this.textView.setTranslationY(AndroidUtilities.m1081dp(5.0f) * f);
        }
        ...
        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.mini ? AndroidUtilities.m1081dp(70.0f) : DialogStoriesCell.this.currentCellWidth, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(81.0f), TLObject.FLAG_30));
        }

        float getCy() {
            float fM1081dp = AndroidUtilities.m1081dp(48.0f);
            float fM1081dp2 = AndroidUtilities.m1081dp(26.33f);
            return AndroidUtilities.lerp(AndroidUtilities.m1081dp(5.0f), (ActionBar.getCurrentActionBarHeight() - fM1081dp2) / 2.0f, DialogStoriesCell.this.collapsedProgress1) + (AndroidUtilities.lerp(fM1081dp, fM1081dp2, this.progressToCollapsed) / 2.0f);
        }
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            float fM1081dp = AndroidUtilities.m1081dp(48.0f);
            float fM1081dp2 = AndroidUtilities.m1081dp(26.33f);
            float fM1081dp3 = AndroidUtilities.m1081dp(8.0f) * Utilities.clamp(DialogStoriesCell.this.overscrollProgress / 0.5f, 1.0f, 0.0f);
            if (this.selectedForOverscroll) {
                fM1081dp3 += AndroidUtilities.m1081dp(16.0f) * Utilities.clamp((DialogStoriesCell.this.overscrollProgress - 0.5f) / 0.5f, 1.0f, 0.0f);
            }
            float fLerp = AndroidUtilities.lerp(fM1081dp + fM1081dp3, fM1081dp2, this.progressToCollapsed);
            ...
            float fLerp3 = AndroidUtilities.lerp(AndroidUtilities.m1081dp(5.0f), (ActionBar.getCurrentActionBarHeight() - fM1081dp2) / 2.0f, this.progressToCollapsed);
            ...
            if (this.progressToCollapsed != 0.0f) {
                float fM1081dp4 = AndroidUtilities.m1081dp(3.0f) + f11;
                float f15 = this.f2125cx;
                f7 = 3.0f;
                float f16 = this.f2126cy;
                float f17 = f11 * 2.0f;
                f8 = 2.0f;
                f6 = 1.0f;
                f3 = f13;
                ...
                r9 = 1;
                f9 = fLerp2;
                canvas.drawRoundRect(f15 - fM1081dp4, f16 - fM1081dp4, f15 + fM1081dp4, f16 + fM1081dp4, ExteraConfig.getAvatarCorners(f17 + AndroidUtilities.m1081dp(f), true), ExteraConfig.getAvatarCorners(f17 + AndroidUtilities.m1081dp(f), true), DialogStoriesCell.this.backgroundPaint);
                canvas2 = canvas;
            } else {
                canvas2 = canvas;
                f3 = f13;
            ...
            canvas2.scale(f18, f18, this.f2125cx, this.f2126cy);
            ...
            if (r5 != 0 || (this.progressWasDrawn && (radialProgress = this.radialProgress) != null && radialProgress.getAnimatedProgress() < 0.98f)) {
                ...
                unreadCirclePaint.setAlpha(Function.USE_VARARGS);
                this.radialProgress.setPaint(unreadCirclePaint);
                this.radialProgress.setProgressRect((int) (this.avatarImage.getImageX() - AndroidUtilities.m1081dp(f7)), (int) (this.avatarImage.getImageY() - AndroidUtilities.m1081dp(f7)), (int) (this.avatarImage.getImageX2() + AndroidUtilities.m1081dp(f7)), (int) (this.avatarImage.getImageY2() + AndroidUtilities.m1081dp(f7)));
                ...
                if (this.drawAvatar) {
                    ...
                    avatarStoryParams3.progressToArc = getArcProgress(this.f2125cx, f11);
                    ...
                    if (f21 > 0.0f) {
                        ...
                        errorPaint.setStrokeWidth(AndroidUtilities.m1081dp(f8));
                        errorPaint.setAlpha((int) (255.0f * f21));
                        canvas2.drawCircle(f3, f4, (f11 + AndroidUtilities.m1081dp(4.0f)) * this.params.getScale(), errorPaint);
                    }
                    f20 = f21;
                }
                ...
                if (this.drawAvatar) {
                    canvas2.save();
                    float f22 = f6 - fClamp;
                    canvas2.scale(f22, f22, this.f2125cx + AndroidUtilities.m1081dp(f2), this.f2126cy + AndroidUtilities.m1081dp(f2));
                    drawPlus(canvas2, this.f2125cx, this.f2126cy, f6);
                    drawFail(canvas2, this.f2125cx, this.f2126cy, f20);
                    canvas2.restore();
                }
            }
            canvas2.restore();
            ...
            this.textViewContainer.setTranslationY(f5 + (AndroidUtilities.m1081dp(7.0f) * (1.0f - this.progressToCollapsed)));
        ...
        private float getArcProgress(float f, float f2) {
            if (!this.isLast && DialogStoriesCell.this.overscrollProgress <= 0.0f) {
                if (AndroidUtilities.lerp(getMeasuredWidth(), AndroidUtilities.m1081dp(16.0f), CubicBezierInterpolator.EASE_OUT.getInterpolation(this.progressToCollapsed)) < (f2 + AndroidUtilities.dpf2(3.5f)) * 2.0f) {
        ...
        public void drawPlus(Canvas canvas, float f, float f2, float f3) {
            ...
            if (this.isSelf && !DialogStoriesCell.this.storiesController.hasStories(this.dialogId) && Utilities.isNullOrEmpty(DialogStoriesCell.this.storiesController.getUploadingStories(this.dialogId))) {
                float fM1081dp = f + AndroidUtilities.m1081dp(16.0f);
                float fM1081dp2 = f2 + AndroidUtilities.m1081dp(16.0f);
                DialogStoriesCell dialogStoriesCell2 = DialogStoriesCell.this;
                ...
                canvas.drawCircle(fM1081dp, fM1081dp2, AndroidUtilities.m1081dp(11.0f), DialogStoriesCell.this.backgroundPaint);
                canvas.drawCircle(fM1081dp, fM1081dp2, AndroidUtilities.m1081dp(9.0f), DialogStoriesCell.this.addCirclePaint);
                if (DialogStoriesCell.this.type == 0) {
                ...
                DialogStoriesCell.this.addNewStoryDrawable.setBounds((int) (fM1081dp - (DialogStoriesCell.this.addNewStoryDrawable.getIntrinsicWidth() / 2.0f)), (int) (fM1081dp2 - (DialogStoriesCell.this.addNewStoryDrawable.getIntrinsicHeight() / 2.0f)), (int) (fM1081dp + (DialogStoriesCell.this.addNewStoryDrawable.getIntrinsicWidth() / 2.0f)), (int) (fM1081dp2 + (DialogStoriesCell.this.addNewStoryDrawable.getIntrinsicHeight() / 2.0f)));
        ...
        public void drawFail(Canvas canvas, float f, float f2, float f3) {
            ...
            float fM1081dp = f + AndroidUtilities.m1081dp(17.0f);
            float fM1081dp2 = f2 + AndroidUtilities.m1081dp(17.0f);
            DialogStoriesCell dialogStoriesCell = DialogStoriesCell.this;
            ...
            float fM1081dp3 = AndroidUtilities.m1081dp(9.0f) * CubicBezierInterpolator.EASE_OUT_BACK.getInterpolation(f3);
            canvas.drawCircle(fM1081dp, fM1081dp2, AndroidUtilities.m1081dp(2.0f) + fM1081dp3, DialogStoriesCell.this.backgroundPaint);
            canvas.drawCircle(fM1081dp, fM1081dp2, fM1081dp3, DialogStoriesCell.this.addCirclePaint);
            DialogStoriesCell dialogStoriesCell4 = DialogStoriesCell.this;
            dialogStoriesCell4.addCirclePaint.setColor(Theme.multAlpha(dialogStoriesCell4.getTextColor(), f3));
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(fM1081dp - AndroidUtilities.m1081dp(1.0f), fM1081dp2 - AndroidUtilities.dpf2(4.6f), AndroidUtilities.m1081dp(1.0f) + fM1081dp, AndroidUtilities.dpf2(1.6f) + fM1081dp2);
            canvas.drawRoundRect(rectF, AndroidUtilities.m1081dp(3.0f), AndroidUtilities.m1081dp(3.0f), DialogStoriesCell.this.addCirclePaint);
            rectF.set(fM1081dp - AndroidUtilities.m1081dp(1.0f), AndroidUtilities.dpf2(2.6f) + fM1081dp2, fM1081dp + AndroidUtilities.m1081dp(1.0f), fM1081dp2 + AndroidUtilities.dpf2(4.6f));
            canvas.drawRoundRect(rectF, AndroidUtilities.m1081dp(3.0f), AndroidUtilities.m1081dp(3.0f), DialogStoriesCell.this.addCirclePaint);
        }
        ...
        public void setProgressToCollapsed(float f, float f2, float f3, boolean z) {
            ...
            if (!this.mini) {
                DialogStoriesCell dialogStoriesCell = DialogStoriesCell.this;
                fClamp = 1.0f - Utilities.clamp(dialogStoriesCell.collapsedProgress / dialogStoriesCell.f2124K, 1.0f, 0.0f);
            }
    ...
    public Drawable createVerifiedDrawable() {
        final Drawable drawableMutate = ContextCompat.getDrawable(getContext(), C2702R.drawable.verified_area).mutate();
        final Drawable drawableMutate2 = ContextCompat.getDrawable(getContext(), C2702R.drawable.verified_check).mutate();
        CombinedDrawable combinedDrawable = new CombinedDrawable(drawableMutate, drawableMutate2) { // from class: org.telegram.ui.Stories.DialogStoriesCell.11
            int lastColor;

            @Override // org.telegram.p026ui.Components.CombinedDrawable, android.graphics.drawable.Drawable
    ...
    static float getAvatarRight(int i, float f) {
        float fLerp = AndroidUtilities.lerp(AndroidUtilities.m1081dp(48.0f), AndroidUtilities.m1081dp(26.33f), f) / 2.0f;
    ...
    private HintView2 makePremiumHint() {
        ...
        this.premiumHint.setPadding(AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(24.0f), AndroidUtilities.m1081dp(8.0f), 0);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        if (this.currentState == 2) {
            ...
            this.miniItemsClickArea.setRect((int) this.listViewMini.getX(), (int) this.listViewMini.getY(), (int) (this.listViewMini.getX() + AndroidUtilities.m1081dp((size * 26.33f) - (Math.max(0, size - 1) * 16.0f))), (int) (this.listViewMini.getY() + this.listViewMini.getHeight()));
    ...
    public void updateStatus(TLRPC.User user, boolean z) {
        ...
        if (emojiStatusDocumentId != null) {
            ...
            if (this.premiumStar == null) {
                ...
                this.premiumStar = new AnimatedEmojiDrawable.WrapSizeDrawable(this.premiumStar, AndroidUtilities.m1081dp(18.0f), AndroidUtilities.m1081dp(18.0f)) { // from class: org.telegram.ui.Stories.DialogStoriesCell.12
