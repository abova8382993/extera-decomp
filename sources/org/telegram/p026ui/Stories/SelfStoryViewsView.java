...
public class SelfStoryViewsView extends FrameLayout {
    ...
    public SelfStoryViewsView(Context context, final StoryViewer storyViewer) {
        ...
        this.selfStoriesPreviewView = new SelfStoriesPreviewView(getContext()) { // from class: org.telegram.ui.Stories.SelfStoryViewsView.1
            @Override // org.telegram.p026ui.Stories.SelfStoriesPreviewView
            void onDragging() {
        ...
        ViewPagerInner viewPagerInner = new ViewPagerInner(context) { // from class: org.telegram.ui.Stories.SelfStoryViewsView.2
            ...
            public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
                if (!checkTopOffset(motionEvent) && Math.abs(SelfStoryViewsView.this.getCurrentTopOffset() - SelfStoryViewsView.this.bottomPadding) <= AndroidUtilities.m1081dp(1.0f)) {
        ...
        C67294 c67294 = new C67294(storyViewer, context);
        this.pagerAdapter = c67294;
        viewPagerInner2.setAdapter(c67294);
    ...
    class C67294 extends PagerAdapter {
        ...
        C67294(StoryViewer storyViewer, Context context) {
        ...
        public Object instantiateItem(ViewGroup viewGroup, int i) {
            SelfStoryViewsPage selfStoryViewsPage = new SelfStoryViewsPage(this.val$storyViewer, this.val$context, SelfStoryViewsView.this.sharedFilterState, new Consumer() { // from class: org.telegram.ui.Stories.SelfStoryViewsView$4$$ExternalSyntheticLambda0
                ...
                @Override // org.telegram.p026ui.Stories.SelfStoryViewsPage
            ...
            selfStoryViewsPage.setPadding(0, AndroidUtilities.m1081dp(16.0f), 0, 0);
    ...
    public void setKeyboardHeight(int i) {
        ...
        boolean z = this.keyboardHeight >= AndroidUtilities.m1081dp(20.0f);
        boolean z2 = i >= AndroidUtilities.m1081dp(20.0f);
        if (z2 != z) {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.toY = AndroidUtilities.m1081dp(20.0f) + i3;
        ((FrameLayout.LayoutParams) this.viewPagerContainer.getLayoutParams()).topMargin = AndroidUtilities.statusBarHeight;
        float fM1081dp = (((i3 + AndroidUtilities.m1081dp(20.0f)) + this.toHeight) + AndroidUtilities.m1081dp(24.0f)) - AndroidUtilities.statusBarHeight;
        this.bottomPadding = fM1081dp;
        this.maxSelfStoriesViewsOffset = size - fM1081dp;
    ...
    public void setOffset(float f) {
        ...
        if (f2 == 1.0f && this.progressToOpen != 1.0f) {
            if (this.storyViewer.storiesList != null) {
                ...
                this.storyViewer.storiesViewPager.setCurrentDate(jDay, messageObject.storyItem.f1807id);
