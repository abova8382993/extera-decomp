...
public abstract class StoriesViewPager extends ViewPager {
            ...
            public Object instantiateItem(ViewGroup viewGroup, int i2) {
                ...
                if (!this.cachedViews.isEmpty()) {
                    ...
                    peerStoriesView = new HwPeerStoriesView(context, storyViewer, StoriesViewPager.this.resources, resourcesProvider) { // from class: org.telegram.ui.Stories.StoriesViewPager.2.1
                        @Override // org.telegram.p026ui.Stories.PeerStoriesView
        ...
        addOnPageChangeListener(new ViewPager.OnPageChangeListener() { // from class: org.telegram.ui.Stories.StoriesViewPager.3
            ...
            */
            public void onPageScrolled(int r3, float r4, int r5) {
                /*
                    r2 = this;
                    org.telegram.ui.Stories.StoriesViewPager r0 = org.telegram.p026ui.Stories.StoriesViewPager.this
                ...
                Lb:
                    ...
                    org.telegram.ui.Stories.StoriesViewPager r5 = org.telegram.p026ui.Stories.StoriesViewPager.this
                ...
                L3e:
                    ...
                    if (r5 != 0) goto L51
                L44:
                    org.telegram.ui.Stories.StoriesViewPager r3 = org.telegram.p026ui.Stories.StoriesViewPager.this
                ...
                L88:
                    ...
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Stories.StoriesViewPager.C67433.onPageScrolled(int, float, int):void");
            }
    ...
    private static boolean eqA(ArrayList arrayList, ArrayList arrayList2) {
        ...
        for (int i = 0; i < arrayList.size(); i++) {
            if (!m1271eq((ArrayList) arrayList.get(i), (ArrayList) arrayList2.get(i))) {
                return false;
            }
        }
        return true;
    ...
    public static boolean m1271eq(ArrayList arrayList, ArrayList arrayList2) {
        if (arrayList == null && arrayList2 == null) {
            return true;
        }
        if (arrayList == null || arrayList2 == null || arrayList.size() != arrayList2.size()) {
