...
import org.telegram.p026ui.Components.ReplyMessageLine;
...
import org.telegram.p026ui.Components.spoilers.SpoilersClickDetector;
...
public class StoryCaptionView extends NestedScrollView {
    ...
    public StoryCaptionView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        setFadingEdgeLength(AndroidUtilities.m1081dp(12.0f));
    ...
    private void startSpringAnimationIfNotRunning(float f) {
        ...
        if (getScrollY() < AndroidUtilities.m1081dp(2.0f)) {
            collapse();
        }
    }
    ...
    public float getProgressToBlackout() {
        return Utilities.clamp((getScrollY() - this.captionTextview.getTranslationY()) / Math.min(this.prevHeight, AndroidUtilities.m1081dp(40.0f)), 1.0f, 0.0f);
    }
    ...
    public /* synthetic */ void lambda$expand$1(float f, float f2, float f3, ValueAnimator valueAnimator) {
        ...
        setScrollY((int) AndroidUtilities.lerp(f, Math.min((getMeasuredHeight() - this.blackoutBottomOffset) - AndroidUtilities.m1081dp(64.0f), this.captionContainer.getBottom() - getMeasuredHeight()), fFloatValue));
    ...
    public static class Reply {
        ...
        public static Reply from(int i, TL_stories.StoryItem storyItem) {
            ...
            if (storyItem.media_areas != null) {
                ...
                if (tL_mediaAreaChannelPost != null && (chat = MessagesController.getInstance(i).getChat(Long.valueOf(tL_mediaAreaChannelPost.channel_id))) != null) {
                    reply = new Reply();
                    reply.peerId = Long.valueOf(-chat.f1610id);
        ...
        public int height() {
            return AndroidUtilities.m1081dp(this.small ? 22.0f : 42.0f);
        }
        ...
        public void draw(Canvas canvas, float f) {
            ...
            int iMin = (int) Math.min(f, AndroidUtilities.lerp(AndroidUtilities.m1081dp(20.0f), AndroidUtilities.m1081dp(18.0f), f2) + Math.max(this.titleLayout.getCurrentWidth(), this.textLayout.getCurrentWidth()));
            this.width = iMin;
            int iLerp = AndroidUtilities.lerp(AndroidUtilities.m1081dp(42.0f), AndroidUtilities.m1081dp(22.0f), f2);
            float f3 = iMin;
            ...
            float fLerp = AndroidUtilities.lerp(AndroidUtilities.m1081dp(5.0f), AndroidUtilities.m1081dp(11.0f), f2);
            ...
            canvas.restore();
            canvas.save();
            canvas.clipRect(0, 0, AndroidUtilities.m1081dp(3.0f), AndroidUtilities.m1081dp(42.0f));
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(0.0f, 0.0f, AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(42.0f));
            this.linePaint.setColor(-1);
            float f4 = 1.0f - f2;
            this.linePaint.setAlpha((int) (255.0f * f4));
            canvas.drawRoundRect(rectF, AndroidUtilities.m1081dp(5.0f), AndroidUtilities.m1081dp(5.0f), this.linePaint);
            canvas.restore();
            int iM1081dp = iMin - AndroidUtilities.m1081dp(20.0f);
            if (f3 < f) {
                iM1081dp = (int) Math.min(iM1081dp + AndroidUtilities.m1081dp(12.0f), f - AndroidUtilities.m1081dp(20.0f));
            }
            float f5 = iM1081dp;
            this.titleLayout.ellipsize(f5).draw(canvas, AndroidUtilities.lerp(AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(7.0f), f2), AndroidUtilities.lerp(AndroidUtilities.m1081dp(12.0f), AndroidUtilities.m1081dp(11.0f), f2), -1, 1.0f);
            this.textLayout.ellipsize(f5).draw(canvas, AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(30.0f), -1, f4);
            canvas.restore();
        }
    }
    ...
    public class StoryCaptionTextView extends View implements TextSelectionHelper.SimpleSelectabeleView {
        ...
        public class TextState {
            ...
            public int collapsedTextHeight(int i) {
                ...
                int iHeight = reply != null ? reply.height() + AndroidUtilities.m1081dp(8.0f) : 0;
            ...
            public void measure(int i) {
                ...
                if (TextUtils.isEmpty(this.text)) {
                    ...
                    Reply reply = this.reply;
                    if (reply != null) {
                        this.textHeight = reply.height() + AndroidUtilities.m1081dp(4.0f);
                    }
                    StoryCaptionTextView storyCaptionTextView = StoryCaptionTextView.this;
                ...
                if (reply2 != null) {
                    iHeight = reply2.height() + AndroidUtilities.m1081dp(8.0f);
                ...
                if (storyCaptionTextView3.shouldCollapse) {
                    ...
                    if (this == StoryCaptionTextView.this.state[0]) {
                        String string = LocaleController.getString(C2702R.string.ShowMore);
                    ...
                    if (this.spoilers.isEmpty()) {
                        for (int i3 = 3; i3 < this.fullLayout.getLineCount(); i3++) {
                            ...
                            if (TextUtils.isEmpty(charSequenceSubSequence)) {
                                ...
                                if (lineRight < StoryCaptionTextView.this.showMoreX - AndroidUtilities.m1081dp(16.0f)) {
            ...
            private void drawInternal(Canvas canvas, float f) {
                ...
                if (this.reply != null) {
                    ...
                    int iHeight = this.reply.height() + AndroidUtilities.m1081dp(8.0f);
                    canvas.restore();
                    i = iHeight;
                } else {
                    i = 0;
        ...
        public StoryCaptionTextView(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            this.showMorePaint.setTextSize(AndroidUtilities.m1081dp(16.0f));
            paint.setColor(-16777216);
            PorterDuff.Mode mode = PorterDuff.Mode.DST_OUT;
            paint.setXfermode(new PorterDuffXfermode(mode));
            paint2.setShader(new LinearGradient(0.0f, 0.0f, AndroidUtilities.m1081dp(16.0f), 0.0f, new int[]{0, -1}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP));
        ...
        protected void onMeasure(int i, int i2) {
            int i3 = (i2 + i) << 16;
            this.horizontalPadding = AndroidUtilities.m1081dp(16.0f);
            this.verticalPadding = AndroidUtilities.m1081dp(8.0f);
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (this.showMore != null) {
                ...
                canvas2.save();
                canvas2.translate(this.showMoreX - AndroidUtilities.m1081dp(32.0f), scrollY);
                canvas2.drawRect(0.0f, 0.0f, AndroidUtilities.m1081dp(32.0f), this.showMore.getHeight() + this.verticalPadding, this.xRefGradinetPaint);
                canvas2.restore();
                canvas2.drawRect(this.showMoreX - AndroidUtilities.m1081dp(16.0f), scrollY, getMeasuredWidth(), this.showMore.getHeight() + scrollY + this.verticalPadding, this.xRefPaint);
                canvas2.save();
