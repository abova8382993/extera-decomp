...
public class AlbumButton extends View {
    ...
    public AlbumButton(Context context, MediaController.PhotoEntry photoEntry, CharSequence charSequence, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        setMinimumWidth(AndroidUtilities.m1081dp(196.0f));
        ...
        this.title = _UrlKt.FRAGMENT_ENCODE_SET + ((Object) charSequence);
    ...
    protected void onMeasure(int i, int i2) {
        updateLayouts((((View.MeasureSpec.getSize(i) - AndroidUtilities.m1081dp(30.0f)) - AndroidUtilities.m1081dp(12.0f)) - getPaddingLeft()) - getPaddingRight());
        if (View.MeasureSpec.getMode(i) == Integer.MIN_VALUE) {
            setMeasuredDimension((int) Math.min(getPaddingLeft() + AndroidUtilities.m1081dp(30.0f) + AndroidUtilities.m1081dp(12.0f) + this.nameLayoutWidth + AndroidUtilities.m1081dp(8.0f) + this.countLayoutWidth + getPaddingRight(), View.MeasureSpec.getSize(i)), AndroidUtilities.m1081dp(48.0f));
        } else if (View.MeasureSpec.getMode(i) == 1073741824) {
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m1081dp(48.0f));
        }
    }
    ...
    private void updateLayouts(int i) {
        ...
        if (staticLayout == null || staticLayout.getWidth() != i) {
            ...
            int iM1081dp = i - ((int) (lineWidth + AndroidUtilities.m1081dp(8.0f)));
            StaticLayout staticLayout3 = new StaticLayout(TextUtils.ellipsize(this.subtitle, this.countPaintLayout, iM1081dp, truncateAt), this.countPaintLayout, Math.max(0, iM1081dp), alignment, 1.0f, 0.0f, false);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        this.imageReceiver.setImageCoords(paddingLeft, (getMeasuredHeight() - AndroidUtilities.m1081dp(30.0f)) / 2.0f, AndroidUtilities.m1081dp(30.0f), AndroidUtilities.m1081dp(30.0f));
        this.imageReceiver.draw(canvas);
        float fM1081dp = paddingLeft + AndroidUtilities.m1081dp(30.0f) + AndroidUtilities.m1081dp(12.0f);
        if (this.nameLayout != null) {
            canvas.save();
            canvas.translate(fM1081dp - this.nameLayoutLeft, (getMeasuredHeight() - this.nameLayout.getHeight()) / 2.0f);
            this.nameLayout.draw(canvas);
            fM1081dp = fM1081dp + this.nameLayoutWidth + AndroidUtilities.m1081dp(6.0f);
            canvas.restore();
        }
        if (this.countLayout != null) {
            canvas.save();
            canvas.translate(fM1081dp - this.countLayoutLeft, ((getMeasuredHeight() - this.countLayout.getHeight()) / 2.0f) + AndroidUtilities.dpf2(1.6f));
