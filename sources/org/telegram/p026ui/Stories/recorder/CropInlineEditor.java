...
import org.telegram.p026ui.Components.Crop.CropRotationWheel;
import org.telegram.p026ui.Components.Crop.CropTransform;
import org.telegram.p026ui.Components.Crop.CropView;
...
public abstract class CropInlineEditor extends FrameLayout {
    ...
    public CropInlineEditor(Context context, PreviewView previewView, Theme.ResourcesProvider resourcesProvider) {
        ...
        CropView cropView = new CropView(context) { // from class: org.telegram.ui.Stories.recorder.CropInlineEditor.1
            @Override // org.telegram.p026ui.Components.Crop.CropView
            public int getCurrentWidth() {
        ...
        textView.setText(LocaleController.getString(C2702R.string.Cancel));
        textView.setPadding(AndroidUtilities.m1081dp(12.0f), 0, AndroidUtilities.m1081dp(12.0f), 0);
        ...
        textView2.setText(LocaleController.getString(C2702R.string.CropReset));
        ...
        textView3.setText(LocaleController.getString(C2702R.string.StoryCrop));
        textView3.setPadding(AndroidUtilities.m1081dp(12.0f), 0, AndroidUtilities.m1081dp(12.0f), 0);
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        this.cropView.setTopPadding(AndroidUtilities.m1081dp(52.0f));
        this.cropView.setBottomPadding(this.controlsLayout.getPaddingBottom() + AndroidUtilities.m1081dp(116.0f));
    ...
    public class ContentView extends View {
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            if (CropInlineEditor.this.appearProgress < 1.0f) {
                ...
                float fLerp = AndroidUtilities.lerp(AndroidUtilities.m1081dp(12.0f), 0, CropInlineEditor.this.appearProgress);
            ...
            canvas.translate((AndroidUtilities.m1081dp(16.0f) + (getContainerWidth() / 2.0f)) * f4, (CropInlineEditor.this.cropView.topPadding + (!(getContext() instanceof BubbleActivity) ? AndroidUtilities.statusBarHeight : 0) + ((getContainerHeight() + AndroidUtilities.m1081dp(32.0f)) / 2.0f)) * f4);
            if (f3 > 0.0f) {
        ...
        private float getContainerWidth() {
            return getWidth() - AndroidUtilities.m1081dp(32.0f);
        }

        private float getContainerHeight() {
            boolean z = getContext() instanceof BubbleActivity;
            CropView cropView = CropInlineEditor.this.cropView;
            return ((getHeight() - (cropView.topPadding + (!z ? AndroidUtilities.statusBarHeight : 0))) - cropView.bottomPadding) - AndroidUtilities.m1081dp(32.0f);
        }
