...
public abstract class RoundVideoRecorder extends FrameLayout {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        int measuredWidth = ((i3 - i) - this.cameraView.getMeasuredWidth()) - AndroidUtilities.m1081dp(16.0f);
        int iM1081dp = AndroidUtilities.m1081dp(72.0f);
        CameraView cameraView = this.cameraView;
        cameraView.layout(measuredWidth, iM1081dp, cameraView.getMeasuredWidth() + measuredWidth, this.cameraView.getMeasuredHeight() + iM1081dp);
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        this.shadowPaint.setShadowLayer(AndroidUtilities.m1081dp(2.0f), 0.0f, AndroidUtilities.m1081dp(0.66f), Theme.multAlpha(536870912, this.alpha));
        ...
        if (this.recordingStarted > 0) {
            ...
            this.progressPaint.setShadowLayer(AndroidUtilities.m1081dp(1.0f), 0.0f, AndroidUtilities.m1081dp(0.33f), Theme.multAlpha(536870912, this.alpha));
            rectF.inset(-AndroidUtilities.m1081dp(7.665f), -AndroidUtilities.m1081dp(7.665f));
