...
import org.telegram.p026ui.Components.Paint.Views.StoryLinkPreviewDialog;
...
public class StoryLinkSheet extends BottomSheetWithRecyclerListView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public StoryLinkSheet(final Context context, Theme.ResourcesProvider resourcesProvider, final PreviewView previewView, Utilities.Callback callback) {
        ...
        fixNavigationBar();
        setSlidingActionBar();
        this.headerPaddingTop = AndroidUtilities.m1081dp(4.0f);
        this.headerPaddingBottom = AndroidUtilities.m1081dp(-15.0f);
        EditTextCell editTextCell = new EditTextCell(context, LocaleController.getString(C2702R.string.StoryLinkURLPlaceholder), true, false, -1, resourcesProvider);
        ...
        EditTextCell editTextCell2 = new EditTextCell(context, LocaleController.getString(C2702R.string.StoryLinkNamePlaceholder), true, false, -1, resourcesProvider);
        ...
        buttonWithCounterView.setText(LocaleController.getString(C2702R.string.StoryLinkAdd), false);
    ...
    public /* synthetic */ void lambda$new$4(Context context, PreviewView previewView, View view, int i) {
        ...
        if (item.f2056id == 2 && (view instanceof TextCheckCell)) {
    ...
    public void set(LinkPreview.WebPagePreview webPagePreview) {
        ...
        this.button.setText(LocaleController.getString(C2702R.string.StoryLinkEdit), false);
        UniversalAdapter universalAdapter = this.adapter;
        if (universalAdapter != null) {
            universalAdapter.update(false);
        }
    ...
    protected CharSequence getTitle() {
        return LocaleController.getString(C2702R.string.StoryLinkCreate);
    }
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        for (int i3 = 0; i3 < longSparseArray.size(); i3++) {
            ...
            if (webPage != null && this.webpageId == webPage.f1784id) {
    ...
    */
    public /* synthetic */ void lambda$new$5(org.telegram.tgnet.TLObject r8) {
        ...
        L5b:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Stories.recorder.StoryLinkSheet.lambda$new$5(org.telegram.tgnet.TLObject):void");
    }
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        arrayList.add(UItem.asCheck(2, LocaleController.getString(C2702R.string.StoryLinkNameHeader)).setChecked(this.nameOpen));
        if (this.nameOpen) {
    ...
    public static class WebpagePreviewView extends FrameLayout {
        ...
        public WebpagePreviewView(Context context) {
            ...
            imageView.setImageResource(C2702R.drawable.filled_link);
            ...
            imageView2.setBackground(new CircularProgressDrawable(AndroidUtilities.m1081dp(20.0f), AndroidUtilities.m1081dp(2.4f), -15033089) { // from class: org.telegram.ui.Stories.recorder.StoryLinkSheet.WebpagePreviewView.1
                @Override // org.telegram.p026ui.Components.CircularProgressDrawable, android.graphics.drawable.Drawable
                public int getIntrinsicHeight() {
                    return AndroidUtilities.m1081dp(26.0f);
                }
            ...
            animatedTextView.setTextSize(AndroidUtilities.m1081dp(14.21f));
            ...
            animatedTextView2.setTextSize(AndroidUtilities.m1081dp(14.21f));
            ...
            LoadingSpan loadingSpan = new LoadingSpan(animatedTextView, AndroidUtilities.m1081dp(200.0f));
            ...
            LoadingSpan loadingSpan2 = new LoadingSpan(animatedTextView2, AndroidUtilities.m1081dp(140.0f));
            ...
            imageView3.setImageResource(C2702R.drawable.input_clear);
            imageView3.setScaleType(scaleType);
            imageView3.setBackground(Theme.createSelectorDrawable(436207615, 1, AndroidUtilities.m1081dp(18.0f)));
