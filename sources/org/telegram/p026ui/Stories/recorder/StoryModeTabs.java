...
public abstract class StoryModeTabs extends FrameLayout implements FlashViews.Invertable {
    ...
    public StoryModeTabs(Context context) {
        ...
        LinearLayout linearLayout = new LinearLayout(context) { // from class: org.telegram.ui.Stories.recorder.StoryModeTabs.1
            ...
            private final RectF f2180a = new RectF();

            /* JADX INFO: renamed from: b */
            private final RectF f2181b = new RectF();

            /* JADX INFO: renamed from: c */
            private final RectF f2182c = new RectF();
            ...
            private void setRect(int i, RectF rectF) {
                ...
                rectF.set(frameLayout.getLeft(), frameLayout.getBottom() - AndroidUtilities.m1081dp(30.0f), frameLayout.getRight(), frameLayout.getBottom());
            }

            @Override // android.view.ViewGroup, android.view.View
            protected void dispatchDraw(Canvas canvas) {
                setRect((int) Math.floor(StoryModeTabs.this.mode), this.f2180a);
                setRect((int) Math.ceil(StoryModeTabs.this.mode), this.f2181b);
                AndroidUtilities.lerp(this.f2180a, this.f2181b, StoryModeTabs.this.mode - ((float) Math.floor(StoryModeTabs.this.mode)), this.f2182c);
                this.backgroundPaint.setColor(Theme.multAlpha(ColorUtils.blendARGB(-1, -16777216, StoryModeTabs.this.invert), 0.15f));
                RectF rectF = this.f2182c;
                canvas.drawRoundRect(rectF, rectF.height() / 2.0f, this.f2182c.height() / 2.0f, this.backgroundPaint);
        ...
        textView.setText(LocaleController.getString(C2702R.string.StoryLive));
        ...
        textView2.setText(LocaleController.getString(C2702R.string.StoryPhoto));
        ...
        textView3.setText(LocaleController.getString(C2702R.string.StoryVideo));
