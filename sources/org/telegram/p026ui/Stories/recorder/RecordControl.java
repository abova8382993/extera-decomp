...
public class RecordControl extends View implements FlashViews.Invertable {
    ...
    private float f2167cx;

    /* JADX INFO: renamed from: cy */
    private float f2168cy;
    ...
    private final Point f2169h1;

    /* JADX INFO: renamed from: h2 */
    private final Point f2170h2;

    /* JADX INFO: renamed from: h3 */
    private final Point f2171h3;

    /* JADX INFO: renamed from: h4 */
    private final Point f2172h4;
    ...
    private final Point f2173p1;

    /* JADX INFO: renamed from: p2 */
    private final Point f2174p2;

    /* JADX INFO: renamed from: p3 */
    private final Point f2175p3;

    /* JADX INFO: renamed from: p4 */
    private final Point f2176p4;
    ...
    public RecordControl(Context context) {
        ...
        this.f2173p1 = new Point();
        this.f2174p2 = new Point();
        this.f2175p3 = new Point();
        this.f2176p4 = new Point();
        this.f2169h1 = new Point();
        this.f2170h2 = new Point();
        this.f2171h3 = new Point();
        this.f2172h4 = new Point();
        setWillNotDraw(false);
        RadialGradient radialGradient = new RadialGradient(0.0f, 0.0f, AndroidUtilities.m1081dp(48.0f), new int[]{-577231, -577231, -1}, new float[]{0.0f, 0.64f, 1.0f}, Shader.TileMode.CLAMP);
        ...
        Drawable drawableMutate = context.getResources().getDrawable(C2702R.drawable.msg_media_gallery).mutate();
        PorterDuff.Mode mode = PorterDuff.Mode.MULTIPLY;
        drawableMutate.setColorFilter(new PorterDuffColorFilter(1308622847, mode));
        CombinedDrawable combinedDrawable = new CombinedDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m1081dp(6.0f), -13750737), drawableMutate);
        ...
        Drawable drawableMutate2 = context.getResources().getDrawable(C2702R.drawable.msg_photo_switch2).mutate();
        this.flipDrawableWhite = drawableMutate2;
        drawableMutate2.setColorFilter(new PorterDuffColorFilter(-1, mode));
        Drawable drawableMutate3 = context.getResources().getDrawable(C2702R.drawable.msg_photo_switch2).mutate();
        this.flipDrawableBlack = drawableMutate3;
        drawableMutate3.setColorFilter(new PorterDuffColorFilter(-16777216, mode));
        Drawable drawableMutate4 = context.getResources().getDrawable(C2702R.drawable.msg_filled_unlockedrecord).mutate();
        this.unlockDrawable = drawableMutate4;
        drawableMutate4.setColorFilter(new PorterDuffColorFilter(-1, mode));
        Drawable drawableMutate5 = context.getResources().getDrawable(C2702R.drawable.msg_filled_lockedrecord).mutate();
        this.lockDrawable = drawableMutate5;
        drawableMutate5.setColorFilter(new PorterDuffColorFilter(-16777216, mode));
        Drawable drawableMutate6 = context.getResources().getDrawable(C2702R.drawable.msg_round_pause_m).mutate();
    ...
    protected void onMeasure(int i, int i2) {
        ...
        float f = size;
        this.f2167cx = f / 2.0f;
        this.f2168cy = iM1081dp / 2.0f;
        float fMin = Math.min(AndroidUtilities.m1081dp(135.0f), f * 0.35f);
        float f2 = this.f2167cx;
        this.leftCx = f2 - fMin;
        float f3 = f2 + fMin;
        this.rightCx = f3;
        setDrawableBounds(this.flipDrawableWhite, f3, this.f2168cy, AndroidUtilities.m1081dp(14.0f));
        setDrawableBounds(this.flipDrawableBlack, this.rightCx, this.f2168cy, AndroidUtilities.m1081dp(14.0f));
        setDrawableBounds(this.unlockDrawable, this.leftCx, this.f2168cy);
        setDrawableBounds(this.lockDrawable, this.leftCx, this.f2168cy);
        setDrawableBounds(this.pauseDrawable, this.leftCx, this.f2168cy);
        this.galleryImage.setImageCoords(this.leftCx - AndroidUtilities.m1081dp(20.0f), this.f2168cy - AndroidUtilities.m1081dp(20.0f), AndroidUtilities.m1081dp(40.0f), AndroidUtilities.m1081dp(40.0f));
        this.redMatrix.reset();
        this.redMatrix.postTranslate(this.f2167cx, this.f2168cy);
    ...
    */
    protected void onDraw(android.graphics.Canvas r50) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Stories.recorder.RecordControl.onDraw(android.graphics.Canvas):void");
    }
    ...
    private void getVector(float f, float f2, double d, float f3, Point point) {
        double d2 = f3;
        point.f1967x = (float) (((double) f) + (Math.cos(d) * d2));
        point.f1968y = (float) (((double) f2) + (Math.sin(d) * d2));
    }

    private float dist(Point point, Point point2) {
        return MathUtils.distance(point.f1967x, point.f1968y, point2.f1967x, point2.f1968y);
    }
    ...
    private boolean isPressed(float f, float f2, float f3, float f4, float f5, boolean z) {
        return this.recording ? (!z || f4 - f2 <= ((float) AndroidUtilities.m1081dp(100.0f))) && Math.abs(f3 - f) <= f5 : MathUtils.distance(f, f2, f3, f4) <= f5;
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        boolean zIsPressed = isPressed(fClamp, y, this.rightCx, this.f2168cy, AndroidUtilities.m1081dp(7.0f), true);
        boolean z = true;
        if (this.recordingLoading) {
            ...
            this.recordButton.setPressed(isPressed(fClamp, y, this.f2167cx, this.f2168cy, AndroidUtilities.m1081dp(60.0f), false));
            this.flipButton.setPressed(isPressed(fClamp, y, this.rightCx, this.f2168cy, (float) AndroidUtilities.m1081dp(30.0f), true) && !hasCheck());
            this.lockButton.setPressed(isPressed(fClamp, y, this.leftCx, this.f2168cy, (float) AndroidUtilities.m1081dp(30.0f), false) && !hasCheck());
        }
        if (action == 0) {
            this.touch = true;
            ...
            this.touchX = fClamp;
            this.touchY = y;
            if (Math.abs(fClamp - this.f2167cx) < AndroidUtilities.m1081dp(50.0f)) {
            ...
            if (this.recording && this.longpressRecording) {
                this.delegate.onZoom(Utilities.clamp(((this.f2168cy - AndroidUtilities.m1081dp(48.0f)) - y) / (AndroidUtilities.displaySize.y / 2.0f), 1.0f, 0.0f));
            }
