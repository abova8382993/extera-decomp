    ...
    public class ContentView extends View {
        ...
        public void drawImage(Canvas canvas, boolean z) {
            ...
            if (CropEditor.this.appearProgress < 1.0f && !z) {
                ...
                float fLerp = AndroidUtilities.lerp(AndroidUtilities.m1081dp(12.0f), 0, CropEditor.this.appearProgress);
            ...
            this.cropMatrix.preTranslate(AndroidUtilities.m1081dp(16.0f) + (getContainerWidth() / 2.0f), (!(getContext() instanceof BubbleActivity) ? AndroidUtilities.statusBarHeight : 0) + ((getContainerHeight() + AndroidUtilities.m1081dp(32.0f)) / 2.0f));
            if (z) {
        ...
        private float getContainerHeight() {
            return ((getHeight() - (!(getContext() instanceof BubbleActivity) ? AndroidUtilities.statusBarHeight : 0)) - CropEditor.this.cropView.bottomPadding) - AndroidUtilities.m1081dp(32.0f);
        }
