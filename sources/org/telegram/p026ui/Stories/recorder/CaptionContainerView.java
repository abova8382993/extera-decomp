...
import org.telegram.p026ui.Components.CaptionPhotoViewer;
...
public abstract class CaptionContainerView extends FrameLayout {
    ...
    public CaptionContainerView(Context context, FrameLayout frameLayout, SizeNotifierFrameLayout sizeNotifierFrameLayout, FrameLayout frameLayout2, Theme.ResourcesProvider resourcesProvider, final BlurringShader.BlurManager blurManager) {
        ...
        LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.m1081dp(10.0f), new int[]{Opcodes.V_PREVIEW, 0}, new float[]{0.05f, 1.0f}, Shader.TileMode.CLAMP);
        ...
        strokeDrawable.setColorProvider(new BlurredBackgroundColorProviderThemed(resourcesProvider, i, f) { // from class: org.telegram.ui.Stories.recorder.CaptionContainerView.1
            @Override // org.telegram.p026ui.Components.blur3.drawable.color.BlurredBackgroundColorProviderThemed
        ...
        EditTextEmoji editTextEmoji = new EditTextEmoji(context, sizeNotifierFrameLayout, null, getEditTextStyle(), true, new DarkThemeResourceProvider()) { // from class: org.telegram.ui.Stories.recorder.CaptionContainerView.3
                ...
                if (emojiView != null) {
                    ...
                    emojiView.setOutlineProvider(new ViewOutlineProvider() { // from class: org.telegram.ui.Stories.recorder.CaptionContainerView.3.1
                        ...
                        public void getOutline(View view, Outline outline) {
                            outline.setRoundRect(0, 0, view.getWidth(), view.getHeight() + AndroidUtilities.m1081dp(29.0f), AndroidUtilities.m1081dp(29.0f));
                        }
                    });
                }
            }
            ...
            protected void drawEmojiBackground(Canvas canvas, View view) {
                View view2;
                CaptionContainerView.this.rectF.set(0.0f, 0.0f, view.getWidth(), view.getHeight() + AndroidUtilities.m1081dp(29.0f));
                if (CaptionContainerView.this.customBlur()) {
                    if (this.blurDrawer == null) {
                        view2 = view;
                        this.blurDrawer = new BlurringShader.StoryBlurDrawer(blurManager, view2, 7);
                    } else {
                        view2 = view;
                    }
                    CaptionContainerView captionContainerView = CaptionContainerView.this;
                    captionContainerView.drawBlur(this.blurDrawer, canvas, captionContainerView.rectF, AndroidUtilities.m1081dp(29.0f), false, 0.0f, -view2.getY(), false, 1.0f);
                    CaptionContainerView.this.strokeDrawableEmoji.radius = AndroidUtilities.m1081dp(29.0f);
                    CaptionContainerView captionContainerView2 = CaptionContainerView.this;
                    captionContainerView2.strokeDrawableEmoji.setBounds((int) captionContainerView2.rectF.left, (int) CaptionContainerView.this.rectF.top, (int) CaptionContainerView.this.rectF.right, ((int) CaptionContainerView.this.rectF.bottom) + AndroidUtilities.m1081dp(29.0f));
        ...
        editTextEmoji.getEditText().setHintText(LocaleController.getString(C2702R.string.AddCaption), false);
        paint3.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_IN));
        editTextEmoji.getEditText().setTranslationX(AndroidUtilities.m1081dp(-22.0f));
        if (isAtTop()) {
            editTextEmoji.getEditText().setGravity(48);
        }
        editTextEmoji.getEmojiButton().setAlpha(0.0f);
        editTextEmoji.getEmojiButton().setTranslationY(AndroidUtilities.m1081dp(isAtTop() ? 1.0f : -1.0f));
        editTextEmoji.setTranslationY(AndroidUtilities.m1081dp(isAtTop() ? 1.0f : -1.0f));
        editTextEmoji.getEditText().addTextChangedListener(new C68034());
        ...
        Drawable drawableMutate = context.getResources().getDrawable(C2702R.drawable.input_done).mutate();
        ...
        CombinedDrawable combinedDrawable = new CombinedDrawable(Theme.createCircleDrawable(AndroidUtilities.m1081dp(18.0f), Theme.getColor(Theme.key_chat_editMediaButton, resourcesProvider)), this.applyButtonCheck, 0, AndroidUtilities.m1081dp(1.0f));
        this.applyButtonDrawable = combinedDrawable;
        combinedDrawable.setCustomSize(AndroidUtilities.m1081dp(36.0f), AndroidUtilities.m1081dp(36.0f));
        ...
        this.limitTextView.setTextSize(AndroidUtilities.m1081dp(15.0f));
        ...
        frameLayout3.setTranslationX(AndroidUtilities.m1081dp(2.0f));
    ...
    class C68034 implements TextWatcher {
    ...
    public int getEditTextHeightClosedKeyboard() {
        return Math.min(AndroidUtilities.m1081dp(82.0f), this.editText.getHeight());
    }
    ...
    public void updateKeyboard(int i) {
        ...
        if (!isAtTop()) {
            ...
            if (iMax > AndroidUtilities.m1081dp(20.0f)) {
        ...
        this.toKeyboardShow = iMax > AndroidUtilities.m1081dp(20.0f);
    ...
    protected void updateEditTextLeft() {
        this.editText.getEditText().setTranslationX(AndroidUtilities.lerp(AndroidUtilities.m1081dp(-22.0f) + getEditTextLeft(), AndroidUtilities.m1081dp(2.0f), this.keyboardT));
    }
    ...
    private void updateShowKeyboard(final boolean z, boolean z2) {
        ...
        if (z2) {
            ...
            this.editText.getEditText().setTranslationX(AndroidUtilities.lerp(AndroidUtilities.m1081dp(-22.0f) + getEditTextLeft(), AndroidUtilities.m1081dp(2.0f), this.keyboardT));
            this.limitTextContainer.setTranslationX(AndroidUtilities.lerp(-AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(2.0f), this.keyboardT));
            this.limitTextContainer.setTranslationY(AndroidUtilities.lerp(-AndroidUtilities.m1081dp(8.0f), 0, this.keyboardT));
    ...
    private void drawReply(Canvas canvas) {
        ...
        if (this.collapsed) {
            if (this.keyboardShown) {
                ...
                iMin = Math.max(AndroidUtilities.m1081dp(46.0f), this.editText.getHeight());
            } else {
                f = this.bounds.bottom;
                iMin = Math.min(AndroidUtilities.m1081dp(82.0f), this.editText.getHeight());
            }
            float f3 = f - iMin;
            f2 = 1.0f - this.collapsedT.get();
            fM1081dp = f3 - AndroidUtilities.m1081dp(50.0f);
        } else {
            fM1081dp = this.bounds.top;
        }
        float f4 = fM1081dp;
        float f5 = f2;
        ...
        rectF.set(this.bounds.left + AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(10.0f) + f4, this.bounds.right - AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(52.0f) + f4);
        if (paint != null) {
            canvas2.drawRoundRect(rectF, AndroidUtilities.m1081dp(5.0f), AndroidUtilities.m1081dp(5.0f), paint);
        }
        if (paint2 != null) {
            RectF rectF2 = this.bounds;
            canvas.saveLayerAlpha(rectF2.left, rectF2.top, rectF2.right, rectF2.bottom, Function.USE_VARARGS, 31);
            canvas2 = canvas;
        }
        ...
        float fLerp = AndroidUtilities.lerp(AndroidUtilities.m1081dp(21.0f), 0, this.keyboardT);
        ...
        if (text != null) {
            text.ellipsize((int) (this.bounds.width() - AndroidUtilities.m1081dp(40.0f))).draw(canvas2, this.bounds.left + AndroidUtilities.m1081dp(20.0f), AndroidUtilities.m1081dp(22.0f) + f4, -1, 1.0f);
        }
        ...
        if (path3 == null) {
            ...
            float fM1081dp2 = AndroidUtilities.m1081dp(5.0f);
            fArr[1] = fM1081dp2;
            fArr[0] = fM1081dp2;
        ...
        float f6 = rectF.left;
        rectF.set(f6, rectF.top, AndroidUtilities.m1081dp(3.0f) + f6, rectF.bottom);
        ...
        if (text2 != null) {
            text2.ellipsize((int) (this.bounds.width() - AndroidUtilities.m1081dp(40.0f))).draw(canvas2, this.bounds.left + AndroidUtilities.m1081dp(20.0f), AndroidUtilities.m1081dp(40.0f) + f4, -1, 1.0f);
        }
    }
    ...
    */
    protected void dispatchDraw(android.graphics.Canvas r30) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Stories.recorder.CaptionContainerView.dispatchDraw(android.graphics.Canvas):void");
    }
    ...
    public void drawHint(Canvas canvas, Runnable runnable) {
        if (customBlur()) {
            ...
            canvas.saveLayerAlpha(0.0f, 0.0f, this.hintTextBitmap.getWidth(), this.hintTextBitmap.getHeight(), Function.USE_VARARGS, 31);
        ...
        EditTextCaption editText = this.editText.getEditText();
        canvas.saveLayerAlpha(0.0f, 0.0f, editText.getWidth(), editText.getHeight(), Function.USE_VARARGS, 31);
        runnable.run();
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        if (view == this.editText) {
            float fMax = isAtTop() ? 0.0f : Math.max(0, (this.editText.getHeight() - AndroidUtilities.m1081dp(82.0f)) - this.editText.getScrollY()) * (1.0f - this.keyboardT);
            ...
            float f = rectF.left;
            float f2 = rectF.top;
            canvas.drawRect(f, f2, rectF.right, AndroidUtilities.m1081dp(10.0f) + f2, this.fadePaint);
            this.matrix.reset();
            ...
            float fM1081dp = rectF2.bottom - AndroidUtilities.m1081dp(10.0f);
            RectF rectF3 = this.bounds;
            canvas.drawRect(f3, fM1081dp, rectF3.right, rectF3.bottom, this.fadePaint);
            canvas.restore();
            canvas.restore();
            return zDrawChild;
        }
    ...
    public void updateColors(Theme.ResourcesProvider resourcesProvider) {
        ...
        this.applyButtonDrawable.setBackgroundDrawable(Theme.createCircleDrawable(AndroidUtilities.m1081dp(16.0f), Theme.getColor(Theme.key_chat_editMediaButton, resourcesProvider)));
    }
    ...
    protected void onAttachedToWindow() {
        ...
        if (customBlur()) {
            ...
            this.hintTextPaint.setTextSize(AndroidUtilities.m1081dp(16.0f));
            String string = LocaleController.getString(C2702R.string.AddCaption);
    ...
    public static class PeriodDrawable extends Drawable {
        ...
        private float f2134cx;

        /* JADX INFO: renamed from: cy */
        private float f2135cy;
        ...
        public void setBounds(Rect rect) {
            ...
            this.f2134cx = getBounds().centerX();
            this.f2135cy = getBounds().centerY();
        }
        ...
        public void draw(Canvas canvas, float f) {
            ...
            if (f2 > 0.0f) {
                ...
                canvas.drawCircle(this.f2134cx, this.f2135cy, AndroidUtilities.dpf2(11.33f) * f2, this.fillPaint);
            }
            this.strokePaint.setAlpha((int) (Color.alpha(this.strokeColor) * f * (1.0f - f2)));
            RectF rectF = AndroidUtilities.rectTmp;
            float f3 = this.f2134cx;
            float f4 = this.f2135cy;
            ...
            rect.set((int) (this.f2134cx - AndroidUtilities.m1081dp(20.0f)), (int) (this.f2135cy - AndroidUtilities.m1081dp(20.0f)), (int) (this.f2134cx + AndroidUtilities.m1081dp(20.0f)), (int) (this.f2135cy + AndroidUtilities.m1081dp(20.0f)));
            this.textDrawable.setBounds(rect);
            this.textDrawable.setAlpha((int) (Color.alpha(this.strokeColor) * f));
            this.textDrawable.draw(canvas);
            if (f2 > 0.0f) {
                this.activePath.rewind();
                this.activePath.addCircle(this.f2134cx, this.f2135cy + AndroidUtilities.m1081dp(1.0f), AndroidUtilities.dpf2(11.33f) * f2, Path.Direction.CW);
