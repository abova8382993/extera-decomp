...
public class SelectPeerView extends FrameLayout {
    ...
    public SelectPeerView(Context context, int i) {
        ...
        backupImageView.setRoundRadius(AndroidUtilities.m1081dp(15.0f));
        ...
        textView2.setText(AndroidUtilities.replaceArrows(LocaleController.getString(C2702R.string.LiveStoryPeerChange), false, AndroidUtilities.m1081dp(2.6666667f), AndroidUtilities.m1081dp(0.33f), 1.0f));
        set(null);
    }
