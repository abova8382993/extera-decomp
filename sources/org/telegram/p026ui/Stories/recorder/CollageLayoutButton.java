        ...
        public CollageLayoutListView(final Context context, final FlashViews flashViews) {
            ...
            RecyclerListView recyclerListView = new RecyclerListView(context) { // from class: org.telegram.ui.Stories.recorder.CollageLayoutButton.CollageLayoutListView.1
                ...
                protected void dispatchDraw(Canvas canvas) {
                    ...
                    rectF.set(paddingLeft, 0.0f, AndroidUtilities.m1081dp(12.0f) + paddingLeft, getHeight());
                    this.clip.draw(canvas, rectF, 0, CollageLayoutListView.this.visibleProgress);
                    rectF.set(width - AndroidUtilities.m1081dp(12.0f), 0.0f, width, getHeight());
            ...
            recyclerListView.setAdapter(new RecyclerView.Adapter() { // from class: org.telegram.ui.Stories.recorder.CollageLayoutButton.CollageLayoutListView.2
                ...
                public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
                    ...
                    button.setLayoutParams(new RecyclerView.LayoutParams(AndroidUtilities.m1081dp(46.0f), AndroidUtilities.m1081dp(56.0f)));
    ...
    public static class CollageLayoutDrawable extends Drawable {
        ...
        public CollageLayoutDrawable(CollageLayout collageLayout, boolean z) {
            ...
            while (i2 < size) {
                ...
                int i4 = collageLayout.columns[part.f2139y];
                int i5 = i4 - 1;
                float f3 = f;
                float fMax = (fDpf24 - (Math.max(i, i5) * fDpf27)) / i4;
                int i6 = i;
                float fMax2 = (fDpf25 - (Math.max(i, collageLayout.f2136h - 1) * fDpf27)) / collageLayout.f2136h;
                ...
                int i10 = part.f2138x;
                float f8 = 0.0f;
                float f9 = (i10 == 0 && part.f2139y == 0) ? fDpf26 : 0.0f;
                fArr[1] = f9;
                fArr[i6] = f9;
                float f10 = (i10 == i5 && part.f2139y == 0) ? fDpf26 : 0.0f;
                fArr[3] = f10;
                fArr[2] = f10;
                float f11 = (i10 == i5 && part.f2139y == collageLayout.f2136h + (-1)) ? fDpf26 : 0.0f;
                fArr[5] = f11;
                fArr[4] = f11;
                if (i10 == 0 && part.f2139y == collageLayout.f2136h - 1) {
                    f8 = fDpf26;
                }
                fArr[7] = f8;
                fArr[6] = f8;
            ...
            this.crossXferPaint.setStrokeWidth(AndroidUtilities.m1081dp(3.33f));
            this.crossXferPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.CLEAR));
            this.crossPaint.setStyle(style);
            this.crossPaint.setStrokeWidth(AndroidUtilities.m1081dp(f));
        ...
        public void draw(Canvas canvas) {
            Canvas canvas2;
            if (this.cross) {
                canvas.saveLayerAlpha(getBounds().left, getBounds().top, getBounds().right, getBounds().bottom, Function.USE_VARARGS, 31);
                canvas2 = canvas;
            } else {
                canvas2 = canvas;
                canvas2.save();
            ...
            if (this.cross) {
                canvas2.drawLine(-AndroidUtilities.m1081dp(8.66f), -AndroidUtilities.m1081dp(8.66f), AndroidUtilities.m1081dp(8.66f), AndroidUtilities.m1081dp(8.66f), this.crossXferPaint);
                canvas2.drawLine(-AndroidUtilities.m1081dp(8.66f), -AndroidUtilities.m1081dp(8.66f), AndroidUtilities.m1081dp(8.66f), AndroidUtilities.m1081dp(8.66f), this.crossPaint);
            }
            canvas2.restore();
        }
