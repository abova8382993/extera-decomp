...
public class CommentButton extends FrameLayout {
    ...
    public CommentButton(Context context, BlurredBackgroundColorProvider blurredBackgroundColorProvider) {
        ...
        imageView.setImageResource(C2702R.drawable.menu_comments);
        ...
        imageView2.setImageResource(C2702R.drawable.menu_comments_arrow);
        ...
        imageView2.setPivotX(AndroidUtilities.m1081dp(10.27f));
        imageView2.setPivotY(AndroidUtilities.m1081dp(9.58f));
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        rectF.set(getWidth() - fMax, 0.0f, getWidth(), AndroidUtilities.m1081dp(13.0f));
        canvas.scale(fIsNotEmpty, fIsNotEmpty, rectF.centerX(), rectF.centerY());
        rectF.inset(-AndroidUtilities.m1081dp(2.0f), -AndroidUtilities.m1081dp(2.0f));
        ...
        canvas.translate(rectF.left + ((fMax - this.countText.getCurrentWidth()) / 2.0f), AndroidUtilities.m1081dp(7.0f));
