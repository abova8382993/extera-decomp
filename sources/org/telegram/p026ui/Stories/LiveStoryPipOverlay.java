...
public class LiveStoryPipOverlay implements NotificationCenter.NotificationCenterDelegate, IPipSourceDelegate {
    ...
    private static final FloatPropertyCompat PIP_Y_PROPERTY = new SimpleFloatPropertyCompat("pipY", new SimpleFloatPropertyCompat.Getter() { // from class: org.telegram.ui.Stories.LiveStoryPipOverlay$$ExternalSyntheticLambda2
        ...
        @Override // org.telegram.ui.Components.SimpleFloatPropertyCompat.Setter
        public final void set(Object obj, float f) {
            LiveStoryPipOverlay.m17899$r8$lambda$RtxvIMOP4pyBZhC7EFpjUQ_GaU((LiveStoryPipOverlay) obj, f);
        }
    });
    ...
    public static /* synthetic */ void m17899$r8$lambda$RtxvIMOP4pyBZhC7EFpjUQ_GaU(LiveStoryPipOverlay liveStoryPipOverlay, float f) {
        WindowManager.LayoutParams layoutParams = liveStoryPipOverlay.windowLayoutParams;
    ...
    class C66511 extends AnimatorListenerAdapter {
        C66511() {
        }
    ...
    class C66522 extends AnimatorListenerAdapter {
        final /* synthetic */ boolean val$destroyPlayer;
    ...
    private void showInternal(Activity activity, final LivePlayer livePlayer) {
        ...
        ScaleGestureDetector scaleGestureDetector = new ScaleGestureDetector(context, new ScaleGestureDetectorOnScaleGestureListenerC66533());
        ...
        this.gestureDetector = new GestureDetectorCompat(context, new GestureDetector.SimpleOnGestureListener() { // from class: org.telegram.ui.Stories.LiveStoryPipOverlay.4
            ...
            public boolean onFling(MotionEvent motionEvent, MotionEvent motionEvent2, float f, float f2) {
                ...
                ((SpringAnimation) ((SpringAnimation) LiveStoryPipOverlay.this.pipYSpring.setStartVelocity(f)).setStartValue(LiveStoryPipOverlay.this.pipY)).getSpring().setFinalPosition(MathUtils.clamp(LiveStoryPipOverlay.this.pipY + (f2 / 10.0f), AndroidUtilities.m1081dp(16.0f), (AndroidUtilities.displaySize.y - LiveStoryPipOverlay.this.pipHeight) - AndroidUtilities.m1081dp(16.0f)));
            ...
            public boolean dispatchTouchEvent(MotionEvent motionEvent) {
                ...
                if (action == 1 || action == 3) {
                    ...
                    if (!LiveStoryPipOverlay.this.pipYSpring.isRunning()) {
                        ((SpringAnimation) LiveStoryPipOverlay.this.pipYSpring.setStartValue(LiveStoryPipOverlay.this.pipY)).getSpring().setFinalPosition(MathUtils.clamp(LiveStoryPipOverlay.this.pipY, AndroidUtilities.m1081dp(16.0f), (AndroidUtilities.displaySize.y - LiveStoryPipOverlay.this.pipHeight) - AndroidUtilities.m1081dp(16.0f)));
                        LiveStoryPipOverlay.this.pipYSpring.start();
                    }
                }
        ...
        C66566 c66566 = new ViewGroup(context2) { // from class: org.telegram.ui.Stories.LiveStoryPipOverlay.6
            C66566(final Context context2) {
                super(context2);
            }
        ...
        this.contentView = c66566;
        c66566.addView(this.contentFrameLayout, LayoutHelper.createFrame(-1, -1.0f));
        ...
        C66588 c66588 = new View(context2) { // from class: org.telegram.ui.Stories.LiveStoryPipOverlay.8
            C66588(final Context context2) {
                super(context2);
            }
        ...
        this.flickerView = c66588;
        this.contentFrameLayout.addView(c66588, LayoutHelper.createFrame(-1, -1.0f));
        ...
        float fM1081dp = (AndroidUtilities.displaySize.x - i4) - AndroidUtilities.m1081dp(16.0f);
        this.pipX = fM1081dp;
        ...
        this.pipSource = new PipSource.Builder(activity, this).setTagPrefix("pip-live-story").setPriority(1).setCornerRadius(AndroidUtilities.m1081dp(10.0f)).setContentView(this.contentView).setPlaceholderView(this.textureView.getPlaceholderView()).build();
    }

    /* JADX INFO: renamed from: org.telegram.ui.Stories.LiveStoryPipOverlay$3 */
    class ScaleGestureDetectorOnScaleGestureListenerC66533 implements ScaleGestureDetector.OnScaleGestureListener {
        ScaleGestureDetectorOnScaleGestureListenerC66533() {
        }
        ...
        public boolean onScale(ScaleGestureDetector scaleGestureDetector) {
            ...
            ((SpringAnimation) LiveStoryPipOverlay.this.pipXSpring.setStartValue(LiveStoryPipOverlay.this.pipX)).getSpring().setFinalPosition(scaleGestureDetector.getFocusX() >= ((float) AndroidUtilities.displaySize.x) / 2.0f ? (r2 - LiveStoryPipOverlay.this.pipWidth) - AndroidUtilities.m1081dp(16.0f) : AndroidUtilities.m1081dp(16.0f));
            if (!LiveStoryPipOverlay.this.pipXSpring.isRunning()) {
                LiveStoryPipOverlay.this.pipXSpring.start();
            }
            ((SpringAnimation) LiveStoryPipOverlay.this.pipYSpring.setStartValue(LiveStoryPipOverlay.this.pipY)).getSpring().setFinalPosition(MathUtils.clamp(scaleGestureDetector.getFocusY() - (LiveStoryPipOverlay.this.pipHeight / 2.0f), AndroidUtilities.m1081dp(16.0f), (AndroidUtilities.displaySize.y - LiveStoryPipOverlay.this.pipHeight) - AndroidUtilities.m1081dp(16.0f)));
            if (LiveStoryPipOverlay.this.pipYSpring.isRunning()) {
                return true;
            }
            LiveStoryPipOverlay.this.pipYSpring.start();
            ...
            if (LiveStoryPipOverlay.this.pipXSpring.isRunning() || LiveStoryPipOverlay.this.pipYSpring.isRunning()) {
                ...
                AnonymousClass1 anonymousClass1 = new DynamicAnimation.OnAnimationEndListener() { // from class: org.telegram.ui.Stories.LiveStoryPipOverlay.3.1
                    ...
                    public void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z, float f, float f2) {
                        ...
                        if (list.size() == 2) {
                            ScaleGestureDetectorOnScaleGestureListenerC66533.this.updateLayout();
                        }
                    }
                };
                if (!LiveStoryPipOverlay.this.pipXSpring.isRunning()) {
    ...
    class C66544 extends GestureDetector.SimpleOnGestureListener {
        private float startPipX;
        private float startPipY;
        final /* synthetic */ int val$touchSlop;
    ...
    class C66555 extends FrameLayout {
        private Path path = new Path();
    ...
    class C66566 extends ViewGroup {
        C66566(final Context context2) {
            super(context2);
        }
    ...
    class C66577 extends ViewOutlineProvider {
        C66577() {
        }
    ...
    class C66599 extends AnimatorListenerAdapter {
        C66599() {
        }
