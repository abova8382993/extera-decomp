...
import org.telegram.p026ui.Cells.ProfileChannelCell;
...
public class StoriesListPlaceProvider implements StoryViewer.PlaceProvider {
    ...
    public static StoriesListPlaceProvider m1269of(RecyclerListView recyclerListView) {
        return m1270of(recyclerListView, false);
    }

    /* JADX INFO: renamed from: of */
    public static StoriesListPlaceProvider m1270of(RecyclerListView recyclerListView, boolean z) {
        return new StoriesListPlaceProvider(recyclerListView, z);
    }

    /* JADX INFO: renamed from: of */
    public static StoriesListPlaceProvider m1268of(ProfileChannelCell profileChannelCell) {
            ...
            if (childAt instanceof DialogStoriesCell.StoryCell) {
                ...
                if ((dialogCell.getDialogId() == j && !this.isHiddenArchive) || (this.isHiddenArchive && dialogCell.isDialogFolder())) {
                    ...
                    if (this.isHiddenArchive) {
                        ...
                        transitionViewHolder.isLive = dialogCell.storyParams.drawnLive;
                    }
                    transitionViewHolder.alpha = 1.0f;
    ...
    public static /* synthetic */ void $r8$lambda$dVvQM61LLLmGehYO5ae62iOJhMA(Path path, Canvas canvas, RectF rectF, float f, boolean z) {
        ...
        path.addCircle((rectF.right + AndroidUtilities.m1081dp(7.0f)) - (AndroidUtilities.m1081dp(14.0f) * fPow), (rectF.bottom + AndroidUtilities.m1081dp(7.0f)) - (AndroidUtilities.m1081dp(14.0f) * fPow), AndroidUtilities.m1081dp(11.0f), Path.Direction.CW);
