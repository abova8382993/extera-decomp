...
import org.telegram.p026ui.Cells.ReactedUserHolderView;
...
import org.telegram.p026ui.Components.MessageContainsEmojiButton;
...
import org.telegram.p026ui.Components.ReplaceableIconDrawable;
import org.telegram.p026ui.Components.SearchField;
...
import org.telegram.p026ui.RecyclerListViewScroller;
import org.telegram.p026ui.Stories.SelfStoryViewsPage;
import org.telegram.p026ui.Stories.SelfStoryViewsView;
...
public abstract class SelfStoryViewsPage extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public SelfStoryViewsPage(final StoryViewer storyViewer, Context context, FiltersState filtersState, Consumer consumer) {
        ...
        C67141 c67141 = new RecyclerListViewInner(context, this.resourcesProvider) { // from class: org.telegram.ui.Stories.SelfStoryViewsPage.1
            C67141(Context context2, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.recyclerListView = c67141;
        c67141.setClipToPadding(false);
        ...
        this.recyclerListView.setOnItemLongClickListener(new C67174(storyViewer));
        ...
        C67185 c67185 = new C67185(getContext(), true, 13.0f, this.resourcesProvider);
        this.searchField = c67185;
        c67185.setHint(LocaleController.getString(C2702R.string.Search));
    ...
    class C67141 extends RecyclerListViewInner {
        C67141(Context context2, Theme.ResourcesProvider resourcesProvider) {
            super(context2, resourcesProvider);
        }
    ...
    class C67152 implements RecyclerAnimationScrollHelper.ScrollListener {
        C67152() {
        }
    ...
    class C67163 extends RecyclerView.OnScrollListener {
        C67163() {
        }
    ...
    public /* synthetic */ void lambda$new$0(StoryViewer storyViewer, View view, int i) {
        ...
        if (storyView instanceof TL_stories.TL_storyView) {
            storyViewer.presentFragment(ProfileActivity.m1243of(storyView.user_id));
            return;
        }
        if (storyView instanceof TL_stories.TL_storyViewPublicRepost) {
            storyViewer.fragment.createOverlayStoryViewer().open(getContext(), ((TL_stories.TL_storyViewPublicRepost) item.view).story, StoriesListPlaceProvider.m1269of(this.recyclerListView));
            return;
        }
        TL_stories.StoryReaction storyReaction = item.reaction;
        if (storyReaction instanceof TL_stories.TL_storyReaction) {
            storyViewer.presentFragment(ProfileActivity.m1243of(DialogObject.getPeerDialogId(storyReaction.peer_id)));
            return;
        }
        if (storyReaction instanceof TL_stories.TL_storyReactionPublicRepost) {
            storyViewer.fragment.createOverlayStoryViewer().open(getContext(), ((TL_stories.TL_storyReactionPublicRepost) item.reaction).story, StoriesListPlaceProvider.m1269of(this.recyclerListView));
            return;
        }
    ...
    class C67174 implements RecyclerListView.OnItemLongClickListener {
        ...
        public boolean onItemClick(View view, int i) {
            ...
            boolean z2 = messagesController.blockePeers.indexOfKey(user.f1775id) >= 0;
            boolean z3 = user.contact || ContactsController.getInstance(SelfStoryViewsPage.this.currentAccount).contactsDict.get(Long.valueOf(user.f1775id)) != null;
            ...
            final ItemOptions itemOptionsAddIf = ItemOptions.makeOptions(this.val$storyViewer.containerView, SelfStoryViewsPage.this.resourcesProvider, view).setGravity(3).ignoreX().setScrimViewBackground(new ColorDrawable(Theme.getColor(Theme.key_dialogBackground, SelfStoryViewsPage.this.resourcesProvider))).setDimAlpha(Opcodes.I2L).addIf((!zIsStoryShownToUser || zIsBlocked || z2 || zIsUserSelf) ? false : true, C2702R.drawable.msg_stories_myhide, LocaleController.formatString(C2702R.string.StoryHideFrom, strSubstring), new Runnable() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$4$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onItemClick$0(messagesController, user, str, reactedUserHolderView, storyView);
                }
            }).makeMultiline(false).cutTextInFancyHalf().addIf((!zIsBlocked || z2 || zIsUserSelf) ? false : true, C2702R.drawable.msg_menu_stories, LocaleController.formatString(C2702R.string.StoryShowBackTo, str), new Runnable() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$4$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onItemClick$1(messagesController, user, str, reactedUserHolderView, storyView);
                }
            }).makeMultiline(false).cutTextInFancyHalf().addIf((z3 || z2 || zIsUserSelf) ? false : true, C2702R.drawable.msg_user_remove, (CharSequence) LocaleController.getString(C2702R.string.BlockUser), true, new Runnable() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$4$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onItemClick$2(messagesController, user, reactedUserHolderView, storyView);
                }
            }).addIf((z3 || !z2 || zIsUserSelf) ? false : true, C2702R.drawable.msg_block, LocaleController.getString(C2702R.string.Unblock), new Runnable() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$4$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onItemClick$3(messagesController, user, reactedUserHolderView, storyView);
                }
            }).addIf(z3 && !zIsUserSelf, C2702R.drawable.msg_user_remove, (CharSequence) LocaleController.getString(C2702R.string.StoryDeleteContact), true, new Runnable() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$4$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public /* synthetic */ void lambda$onItemClick$0(MessagesController messagesController, TLRPC.User user, String str, ReactedUserHolderView reactedUserHolderView, TL_stories.StoryView storyView) {
            messagesController.getStoriesController().updateBlockUser(user.f1775id, true);
            SelfStoryViewsPage selfStoryViewsPage = SelfStoryViewsPage.this;
            BulletinFactory.m1194of(selfStoryViewsPage, selfStoryViewsPage.resourcesProvider).createSimpleBulletin(C2702R.raw.ic_ban, LocaleController.formatString(C2702R.string.StoryHidFromToast, str)).show();
        ...
        public /* synthetic */ void lambda$onItemClick$1(MessagesController messagesController, TLRPC.User user, String str, ReactedUserHolderView reactedUserHolderView, TL_stories.StoryView storyView) {
            messagesController.getStoriesController().updateBlockUser(user.f1775id, false);
            SelfStoryViewsPage selfStoryViewsPage = SelfStoryViewsPage.this;
            BulletinFactory.m1194of(selfStoryViewsPage, selfStoryViewsPage.resourcesProvider).createSimpleBulletin(C2702R.raw.contact_check, LocaleController.formatString(C2702R.string.StoryShownBackToToast, str)).show();
            reactedUserHolderView.animateAlpha(SelfStoryViewsPage.this.isStoryShownToUser(storyView) ? 1.0f : 0.5f, true);
        }
        ...
        public /* synthetic */ void lambda$onItemClick$2(MessagesController messagesController, TLRPC.User user, ReactedUserHolderView reactedUserHolderView, TL_stories.StoryView storyView) {
            messagesController.blockPeer(user.f1775id);
            SelfStoryViewsPage selfStoryViewsPage = SelfStoryViewsPage.this;
            BulletinFactory.m1194of(selfStoryViewsPage, selfStoryViewsPage.resourcesProvider).createBanBulletin(true).show();
            reactedUserHolderView.animateAlpha(SelfStoryViewsPage.this.isStoryShownToUser(storyView) ? 1.0f : 0.5f, true);
        }
        ...
        public /* synthetic */ void lambda$onItemClick$3(MessagesController messagesController, TLRPC.User user, ReactedUserHolderView reactedUserHolderView, TL_stories.StoryView storyView) {
            messagesController.getStoriesController().updateBlockUser(user.f1775id, false);
            messagesController.unblockPeer(user.f1775id);
            SelfStoryViewsPage selfStoryViewsPage = SelfStoryViewsPage.this;
            BulletinFactory.m1194of(selfStoryViewsPage, selfStoryViewsPage.resourcesProvider).createBanBulletin(false).show();
            reactedUserHolderView.animateAlpha(SelfStoryViewsPage.this.isStoryShownToUser(storyView) ? 1.0f : 0.5f, true);
        }
        ...
        public /* synthetic */ void lambda$onItemClick$4(TLRPC.User user, String str, ReactedUserHolderView reactedUserHolderView, TL_stories.StoryView storyView) {
            ...
            SelfStoryViewsPage selfStoryViewsPage = SelfStoryViewsPage.this;
            BulletinFactory.m1194of(selfStoryViewsPage, selfStoryViewsPage.resourcesProvider).createSimpleBulletin(C2702R.raw.ic_ban, LocaleController.formatString(C2702R.string.DeletedFromYourContacts, str)).show();
            reactedUserHolderView.animateAlpha(SelfStoryViewsPage.this.isStoryShownToUser(storyView) ? 1.0f : 0.5f, true);
        }
    ...
    class C67185 extends SearchField {
        Runnable runnable;

        C67185(Context context, boolean z, float f, Theme.ResourcesProvider resourcesProvider) {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        this.shadowDrawable.setBounds(-AndroidUtilities.m1081dp(6.0f), paddingTop, getMeasuredWidth() + AndroidUtilities.m1081dp(6.0f), getMeasuredHeight());
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        if (view == this.recyclerListView) {
            canvas.save();
            canvas.clipRect(0, AndroidUtilities.m1081dp(this.TOP_PADDING), getMeasuredWidth(), getMeasuredHeight());
    ...
    public void setStoryItem(long j, SelfStoryViewsView.StoryItemInternal storyItemInternal) {
        ...
        NotificationsController.getInstance(this.currentAccount).processSeenStoryReactions(j, storyItemInternal.storyItem.f1807id);
    }
    ...
    */
    private void updateViewsVisibility() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Stories.SelfStoryViewsPage.updateViewsVisibility():void");
    }
    ...
    public static void preload(int i, long j, TL_stories.StoryItem storyItem) {
        ...
        ViewsModel viewsModel = sparseArray == null ? null : (ViewsModel) sparseArray.get(storyItem.f1807id);
        ...
        if (viewsModel == null || viewsModel.totalCount != i2) {
            ...
            sparseArray.put(storyItem.f1807id, viewsModel2);
        }
    }
    ...
    class C67196 implements Bulletin.Delegate {
        @Override // org.telegram.ui.Components.Bulletin.Delegate
        public /* synthetic */ boolean allowLayoutChanges() {
            return Bulletin.Delegate.CC.$default$allowLayoutChanges(this);
        }
    ...
    public boolean onBackPressed() {
        ...
        if (Math.abs(this.topViewsContainer.getTranslationY() - this.recyclerListView.getPaddingTop()) <= AndroidUtilities.m1081dp(2.0f)) {
            return false;
        }
        this.recyclerListView.dispatchTouchEvent(AndroidUtilities.emptyMotionEvent());
    ...
    class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        /* synthetic */ ListAdapter(SelfStoryViewsPage selfStoryViewsPage, SelfStoryViewsPageIA selfStoryViewsPageIA) {
            this();
        }
        ...
        class C67221 extends View {
            C67221(Context context) {
                super(context);
            }

            @Override // android.view.View
            protected void onMeasure(int i, int i2) {
                super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(SelfStoryViewsPage.this.TOP_PADDING), TLObject.FLAG_30));
            }
        }

        /* JADX INFO: renamed from: org.telegram.ui.Stories.SelfStoryViewsPage$ListAdapter$2 */
        class C67232 extends ReactedUserHolderView {
            C67232(int i, int i2, Context context, Theme.ResourcesProvider resourcesProvider, boolean z, boolean z2) {
                super(i, i2, context, resourcesProvider, z, z2);
            }

            @Override // org.telegram.p026ui.Cells.ReactedUserHolderView
            public void openStory(long j, Runnable runnable) {
                ...
                storyViewerCreateOverlayStoryViewer.open(getContext(), j, StoriesListPlaceProvider.m1269of(SelfStoryViewsPage.this.recyclerListView));
            }
        }
        ...
        class C67243 extends View {
            C67243(Context context) {
                super(context);
            }
        ...
        */
        ...
        class C67254 extends StickerEmptyView {
            C67254(Context context, View view, int i, Theme.ResourcesProvider resourcesProvider) {
                super(context, view, i, resourcesProvider);
            }

            @Override // android.widget.FrameLayout, android.view.View
            protected void onMeasure(int i, int i2) {
                super.onMeasure(i, View.MeasureSpec.makeMeasureSpec((SelfStoryViewsPage.this.measuerdHeight - SelfStoryViewsPage.this.recyclerListView.getPaddingTop()) - AndroidUtilities.m1081dp(SelfStoryViewsPage.this.TOP_PADDING), TLObject.FLAG_30));
            }
        }
                    ...
                    if (viewsModel != null) {
                        if (viewsModel.isChannel) {
                            while (i < viewsModel.reactions.size()) {
                                this.items.add(new Item(1, (TL_stories.StoryReaction) viewsModel.reactions.get(i)));
                                i++;
                            }
                        } else {
                            while (i < viewsModel.views.size()) {
                                this.items.add(new Item(1, (TL_stories.StoryView) viewsModel.views.get(i)));
                                i++;
                            }
                        }
                    }
    ...
    private static class Item {
        ...
        /* synthetic */ Item(int i, TL_stories.StoryReaction storyReaction, SelfStoryViewsPageIA selfStoryViewsPageIA) {
            this(i, storyReaction);
        }

        /* synthetic */ Item(int i, TL_stories.StoryView storyView, SelfStoryViewsPageIA selfStoryViewsPageIA) {
            this(i, storyView);
        }

        /* synthetic */ Item(int i, SelfStoryViewsPageIA selfStoryViewsPageIA) {
            this(i);
        }
    ...
    public static class ViewsModel {
        ...
        public void loadNext() {
            ...
            if (this.isChannel) {
                ...
                tL_getStoryReactionsList.f1808id = this.storyItem.f1807id;
                ...
                this.loading = true;
                FileLog.m1090d("SelfStoryViewsPage reactions load next " + this.storyItem.f1807id + " " + this.initial + " offset=" + tL_getStoryReactionsList.offset);
            ...
            tL_stories_getStoryViewsList.f1816id = this.storyItem.f1807id;
            ...
            if (this.useLocalFilters) {
                tL_stories_getStoryViewsList.f1817q = _UrlKt.FRAGMENT_ENCODE_SET;
                ...
                tL_stories_getStoryViewsList.f1817q = str2;
            ...
            this.loading = true;
            FileLog.m1090d("SelfStoryViewsPage load next " + this.storyItem.f1807id + " " + this.initial + " offset=" + tL_stories_getStoryViewsList.offset + " q" + tL_stories_getStoryViewsList.f1817q + " " + tL_stories_getStoryViewsList.just_contacts + " " + tL_stories_getStoryViewsList.reactions_first);
        ...
        public /* synthetic */ void lambda$loadNext$0(int[] iArr, TLObject tLObject, TLRPC.TL_error tL_error) {
            if (iArr[0] != this.reqId) {
                FileLog.m1090d("SelfStoryViewsPage reactions " + this.storyItem.f1807id + " localId != reqId");
                return;
            }
            this.loading = false;
            this.reqId = -1;
            ...
            FileLog.m1090d("SelfStoryViewsPage reactions " + this.storyItem.f1807id + " response  totalItems " + this.reactions.size() + " has next " + this.hasNext);
        ...
        public /* synthetic */ void lambda$loadNext$2(int[] iArr, TLObject tLObject, TLRPC.TL_error tL_error) {
            boolean z;
            if (iArr[0] != this.reqId) {
                FileLog.m1090d("SelfStoryViewsPage " + this.storyItem.f1807id + " localId != reqId");
                return;
            }
            this.loading = false;
            this.reqId = -1;
            if (tLObject != null) {
                ...
                if (i2 > storyViews.views_count) {
                    ...
                    for (int i3 = 0; i3 < Math.min(3, storyViewsList.users.size()); i3++) {
                        this.storyItem.views.recent_viewers.add(Long.valueOf(storyViewsList.users.get(i3).f1775id));
                    }
            ...
            FileLog.m1090d("SelfStoryViewsPage " + this.storyItem.f1807id + " response  totalItems " + this.views.size() + " has next " + this.hasNext);
        ...
        private void applyLocalFilter() {
            ...
            Collections.sort(this.views, Comparator.CC.comparingInt(new ToIntFunction() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$ViewsModel$$ExternalSyntheticLambda2
                ...
                public final int applyAsInt(Object obj) {
                    return SelfStoryViewsPage.ViewsModel.m18197$r8$lambda$keJViVULdsq7Tmm19unD9O4elA((TL_stories.StoryView) obj);
                }
            }));
        }

        /* JADX INFO: renamed from: $r8$lambda$keJViVULdsq7T-mm19unD9O4elA */
        public static /* synthetic */ int m18197$r8$lambda$keJViVULdsq7Tmm19unD9O4elA(TL_stories.StoryView storyView) {
    ...
    class HeaderView extends FrameLayout {
        ...
        public HeaderView(Context context) {
            ...
            textView.setText(LocaleController.getString(C2702R.string.AllViewers));
            ...
            this.allViewersView.setPadding(AndroidUtilities.m1081dp(12.0f), AndroidUtilities.m1081dp(4.0f), AndroidUtilities.m1081dp(12.0f), AndroidUtilities.m1081dp(4.0f));
            TextView textView3 = new TextView(context);
            this.contactsViewersView = textView3;
            textView3.setText(LocaleController.getString(C2702R.string.Contacts));
            ...
            this.contactsViewersView.setPadding(AndroidUtilities.m1081dp(12.0f), AndroidUtilities.m1081dp(4.0f), AndroidUtilities.m1081dp(12.0f), AndroidUtilities.m1081dp(4.0f));
            linearLayout.setPadding(0, AndroidUtilities.m1081dp(6.0f), 0, AndroidUtilities.m1081dp(6.0f));
            ...
            linearLayout2.setPadding(AndroidUtilities.m1081dp(6.0f), 0, AndroidUtilities.m1081dp(6.0f), 0);
            linearLayout2.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1081dp(26.0f), Theme.getColor(i, SelfStoryViewsPage.this.resourcesProvider)));
            ...
            replaceableIconDrawable.setIcon(C2702R.drawable.menu_views_reactions3, false);
            ImageView imageView = new ImageView(getContext());
            imageView.setScaleType(ImageView.ScaleType.FIT_XY);
            imageView.setImageDrawable(this.replacableDrawable);
            imageView.setPadding(AndroidUtilities.m1081dp(1.0f), AndroidUtilities.m1081dp(1.0f), AndroidUtilities.m1081dp(1.0f), AndroidUtilities.m1081dp(1.0f));
            linearLayout2.addView(imageView, LayoutHelper.createLinear(26, 26));
            ImageView imageView2 = new ImageView(getContext());
            imageView2.setImageResource(C2702R.drawable.arrow_more);
        ...
        class C67201 extends CustomPopupMenu {
            @Override // org.telegram.p026ui.Components.CustomPopupMenu
            protected void onDismissed() {
            }

            C67201(Context context, Theme.ResourcesProvider resourcesProvider, boolean z) {
            ...
            protected void onCreate(ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout) {
                ...
                if (z) {
                    i = C2702R.drawable.menu_views_reposts;
                } else {
                    i = selfStoryViewsPage.state.sortByReactions ? C2702R.drawable.menu_views_reactions2 : C2702R.drawable.menu_views_reactions;
                }
                ActionBarMenuSubItem actionBarMenuSubItemAddItem = ActionBarMenuItem.addItem(actionBarPopupWindowLayout, i, LocaleController.getString(z ? C2702R.string.SortByReposts : C2702R.string.SortByReactions), false, SelfStoryViewsPage.this.resourcesProvider);
                ...
                ActionBarMenuSubItem actionBarMenuSubItemAddItem2 = ActionBarMenuItem.addItem(actionBarPopupWindowLayout, !SelfStoryViewsPage.this.state.sortByReactions ? C2702R.drawable.menu_views_recent2 : C2702R.drawable.menu_views_recent, LocaleController.getString(C2702R.string.SortByTime), false, SelfStoryViewsPage.this.resourcesProvider);
                if (SelfStoryViewsPage.this.state.sortByReactions) {
                ...
                ActionBarMenuItem.addText(actionBarPopupWindowLayout, LocaleController.getString(z ? C2702R.string.StoryReactionsSortDescription : C2702R.string.StoryViewsSortDescription), SelfStoryViewsPage.this.resourcesProvider);
            }
        ...
        public /* synthetic */ void lambda$new$2(View view) {
            SelfStoryViewsPage.this.popupMenu = new C67201(getContext(), SelfStoryViewsPage.this.resourcesProvider, false);
            CustomPopupMenu customPopupMenu = SelfStoryViewsPage.this.popupMenu;
            LinearLayout linearLayout = this.buttonContainer;
            customPopupMenu.show(linearLayout, 0, (-linearLayout.getMeasuredHeight()) - AndroidUtilities.m1081dp(8.0f));
        }
        ...
        class C67212 extends AnimatorListenerAdapter {
            C67212() {
            }
    ...
    public void updateViewState(boolean z) {
        ...
        if (z2) {
            ViewsModel viewsModel = this.currentModel;
            i = (viewsModel == null || !viewsModel.isChannel) ? C2702R.drawable.menu_views_reactions3 : C2702R.drawable.menu_views_reposts3;
        } else {
            i = C2702R.drawable.menu_views_recent3;
        }
    ...
    private class RecyclerListViewInner extends RecyclerListView implements StoriesListPlaceProvider.ClippedView {
        ...
        public void updateClip(int[] iArr) {
            iArr[0] = AndroidUtilities.m1081dp(SelfStoryViewsPage.this.TOP_PADDING);
