...
import org.telegram.p026ui.CallLogActivity;
...
public class CallLogActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, MainTabsActivity.TabFragmentDelegate {
    ...
    class EmptyTextProgressView extends FrameLayout {
        ...
        public EmptyTextProgressView(Context context, View view) {
            ...
            rLottieImageView.setAnimation(C2702R.raw.utyan_call, 110, 110);
            ...
            textView.setText(LocaleController.getString(C2702R.string.MakeYourFirstCall));
            ...
            String string = LocaleController.formatString(C2702R.string.MakeYourFirstCallHint, Integer.valueOf(CallLogActivity.this.getMessagesController().conferenceCallSizeLimit));
            ...
            setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.CallLogActivity$EmptyTextProgressView$$ExternalSyntheticLambda1
                ...
                public final boolean onTouch(View view2, MotionEvent motionEvent) {
                    return CallLogActivity.EmptyTextProgressView.m5788$r8$lambda$r2yXPcVr5CyXIjl7raCNSCXp8(view2, motionEvent);
                }
            });
        }
        ...
        public static /* synthetic */ boolean m5788$r8$lambda$r2yXPcVr5CyXIjl7raCNSCXp8(View view, MotionEvent motionEvent) {
            return true;
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:448:0x0071  */
    ...
    */
    public void didReceivedNotification(int r17, int r18, java.lang.Object... r19) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.CallLogActivity.didReceivedNotification(int, int, java.lang.Object[]):void");
    }

    /* JADX INFO: renamed from: eq */
    private static boolean m1169eq(long j, ArrayList arrayList) {
        return arrayList.size() == 1 && ((TLRPC.User) arrayList.get(0)).f1775id == j;
    }

    /* JADX INFO: renamed from: eq */
    private static boolean m1170eq(Set set, ArrayList arrayList) {
        ...
        while (i < size) {
            ...
            i++;
            if (!set.contains(Long.valueOf(((TLRPC.User) obj).f1775id))) {
                return false;
            }
        }
        return true;
    ...
    private static class CallCell extends FrameLayout {
        ...
        public CallCell(Context context, int i) {
            ...
            profileSearchCell.setPadding(LocaleController.isRTL ? AndroidUtilities.m1081dp(32.0f) : 0, 0, LocaleController.isRTL ? 0 : AndroidUtilities.m1081dp(32.0f), 0);
            profileSearchCell.setSublabelOffset(AndroidUtilities.m1081dp(LocaleController.isRTL ? 2.0f : -2.0f), -AndroidUtilities.m1081dp(7.0f));
            addView(profileSearchCell, LayoutHelper.createFrame(-1, -1.0f));
            AvatarsImageView avatarsImageView = new AvatarsImageView(context, false);
            this.avatarsImageView = avatarsImageView;
            avatarsImageView.setAvatarsTextSize(AndroidUtilities.m1081dp(18.0f));
            avatarsImageView.setStepFactor(0.4f);
            avatarsImageView.setSize(AndroidUtilities.m1081dp(29.0f));
            ...
            imageView.setContentDescription(LocaleController.getString(C2702R.string.Call));
        ...
        public void set(CallLogRow callLogRow, View.OnClickListener onClickListener) {
            ...
            this.imageView.setImageResource(callLogRow.video ? C2702R.drawable.menu_videocall : C2702R.drawable.menu_call_create_2_24);
        ...
        private static ImageSpan iconOut(Context context) {
            Drawable drawableMutate = context.getResources().getDrawable(C2702R.drawable.mini_call_out_16).mutate();
        ...
        private static ImageSpan iconIn(Context context) {
            Drawable drawableMutate = context.getResources().getDrawable(C2702R.drawable.mini_call_in_16).mutate();
            drawableMutate.setBounds(0, 0, drawableMutate.getIntrinsicWidth(), drawableMutate.getIntrinsicHeight());
            drawableMutate.setColorFilter(new PorterDuffColorFilter(Theme.getColor(Theme.key_windowBackgroundWhiteGrayText3), PorterDuff.Mode.MULTIPLY));
            return new ImageSpan(drawableMutate, 0);
        }
        ...
        public static final class Factory extends UItem.UItemFactory {
            ...
            public static UItem m1173of(CallLogRow callLogRow, View.OnClickListener onClickListener) {
    ...
    private static class GroupCallCell extends FrameLayout {
        ...
        public GroupCallCell(Context context) {
            super(context);
            String string = LocaleController.getString(C2702R.string.VoipChatJoin);
            ...
            this.profileSearchCell = profileSearchCell;
            profileSearchCell.setCallCellStyle();
            profileSearchCell.setPadding(LocaleController.isRTL ? AndroidUtilities.m1081dp(44.0f) + iCeil : 0, 0, LocaleController.isRTL ? 0 : AndroidUtilities.m1081dp(44.0f) + iCeil, 0);
            profileSearchCell.setSublabelOffset(0, -AndroidUtilities.m1081dp(4.0f));
            addView(profileSearchCell, LayoutHelper.createFrame(-1, -1.0f));
            ...
            progressButton.setPadding(AndroidUtilities.m1081dp(14.0f), 0, AndroidUtilities.m1081dp(14.0f), 0);
        ...
        public void setChat(TLRPC.Chat chat, View.OnClickListener onClickListener) {
            ...
            this.button.setTag(Long.valueOf(chat.f1610id));
        ...
        public static final class Factory extends UItem.UItemFactory {
            ...
            /* JADX INFO: renamed from: of */
            public static UItem m1174of(TLRPC.Chat chat, View.OnClickListener onClickListener) {
                UItem uItemOfFactory = UItem.ofFactory(Factory.class);
    ...
    public boolean onFragmentCreate() {
        ...
        this.additionNavigationBarHeight = this.hasMainTabs ? AndroidUtilities.m1081dp(72.0f) : 0;
        this.additionFloatingButtonOffset = this.hasMainTabs ? AndroidUtilities.m1081dp(64.0f) : 0;
        return true;
    }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2702R.string.Calls));
        ...
        ActionBarMenuItem actionBarMenuItemAddItem = this.actionBar.createMenu().addItem(10, C2702R.drawable.ic_ab_other);
        ...
        this.otherItem.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$createView$0(view);
            }
        });
        UniversalRecyclerView universalRecyclerView = new UniversalRecyclerView(this, new Utilities.Callback2() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda4
            @Override // org.telegram.messenger.Utilities.Callback2
            public final void run(Object obj, Object obj2) {
                this.f$0.fillItems((ArrayList) obj, (UniversalAdapter) obj2);
            }
        }, new Utilities.Callback5() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda5
            @Override // org.telegram.messenger.Utilities.Callback5
            public final void run(Object obj, Object obj2, Object obj3, Object obj4, Object obj5) {
                this.f$0.onClick((UItem) obj, (View) obj2, ((Integer) obj3).intValue(), ((Float) obj4).floatValue(), ((Float) obj5).floatValue());
            }
        }, new Utilities.Callback5Return() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda6
        ...
        this.contentView = new SizeNotifierFrameLayout(context) { // from class: org.telegram.ui.CallLogActivity.2
            ...
            protected void onMeasure(int i2, int i3) {
                ...
                ((ViewGroup.MarginLayoutParams) CallLogActivity.this.topPanelLayout.getLayoutParams()).topMargin = ((BaseFragment) CallLogActivity.this).actionBar.getMeasuredHeight() - AndroidUtilities.m1081dp(14.0f);
        ...
        this.listView.addEdgeEffectListener(new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda8
        ...
        recyclerAnimationScrollHelper.setScrollListener(new RecyclerAnimationScrollHelper.ScrollListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda9
        ...
        this.listView.setOnScrollListener(new C31213());
        if (this.loading) {
        ...
        fragmentFloatingButton.imageView.setImageResource(C2702R.drawable.filled_calls_plus);
        this.floatingButton.setContentDescription(LocaleController.getString(C2702R.string.Call));
        this.floatingButton.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda10
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        this.topPanelLayout.setOnAnimatedHeightChangedListener(new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
        ...
        C31224 c31224 = new FragmentContextView(context2, this, this.contentView, false, this.resourceProvider) { // from class: org.telegram.ui.CallLogActivity.4
            C31224(Context context2, final BaseFragment this, View view, boolean z, Theme.ResourcesProvider resourcesProvider) {
                super(context2, this, view, z, resourcesProvider);
            }
        ...
        this.fragmentContextView = c31224;
        c31224.isInsideBubble = true;
        this.fragmentContextViewWrapper.addView(c31224);
        ...
        if (this.hasMainTabs) {
            ViewCompat.setOnApplyWindowInsetsListener(this.fragmentView, new OnApplyWindowInsetsListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda12
    ...
    class C31191 extends ActionBar.ActionBarMenuOnItemClick {
        C31191() {
        }
    ...
    class C31202 extends SizeNotifierFrameLayout {
        C31202(Context context2) {
            super(context2);
        }
    ...
    public /* synthetic */ void lambda$createView$2() {
        this.listView.postOnAnimation(new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda17
            @Override // java.lang.Runnable
            public final void run() {
    ...
    class C31213 extends RecyclerView.OnScrollListener {
        ...
        public /* synthetic */ void lambda$onScrolled$0(CallLogRow callLogRow) {
            CallLogActivity.this.getCalls(((TLRPC.Message) callLogRow.calls.get(r3.size() - 1)).f1636id, 100);
        }
    }
    ...
    class C31224 extends FragmentContextView {
        C31224(Context context2, final CallLogActivity this, View view, boolean z, Theme.ResourcesProvider resourcesProvider) {
            super(context2, this, view, z, resourcesProvider);
        }
    ...
    class C31235 implements Bulletin.Delegate {
        @Override // org.telegram.ui.Components.Bulletin.Delegate
        public /* synthetic */ boolean allowLayoutChanges() {
            return Bulletin.Delegate.CC.$default$allowLayoutChanges(this);
        }
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        if (!zIsEmpty || !zIsEmpty2) {
            arrayList.add(UItem.asButton(1, C2702R.drawable.menu_call_create, LocaleController.getString(C2702R.string.GroupCallCreate2)).accent());
            if (!getUserConfig().showCallsTab) {
                arrayList.add(UItem.asButton(2, C2702R.drawable.menu_add_tab_24, LocaleController.getString(C2702R.string.GroupCallShowInMainTabs)).accent());
            }
        ...
        if (!zIsEmpty) {
            ...
            while (i2 < size) {
                ...
                if (l != null && (chat = getMessagesController().getChat(l)) != null) {
                    arrayList.add(GroupCallCell.Factory.m1174of(chat, new View.OnClickListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda19
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
        ...
        while (i < size2) {
            ...
            arrayList.add(CallCell.Factory.m1173of(callLogRow, onCallClick(callLogRow)).setChecked(isSelected(callLogRow.calls)));
        }
        if (this.endReached) {
            return;
        }
    ...
    public /* synthetic */ void lambda$onCallClick$8(CallLogRow callLogRow, View view) {
        ...
        while (i < size) {
            Object obj = arrayList.get(i);
            i++;
            hashSet.add(Long.valueOf(((TLRPC.User) obj).f1775id));
        }
        final TLRPC.TL_inputGroupCallInviteMessage tL_inputGroupCallInviteMessage = new TLRPC.TL_inputGroupCallInviteMessage();
        tL_inputGroupCallInviteMessage.msg_id = ((TLRPC.Message) callLogRow.calls.get(0)).f1636id;
        final AlertDialog alertDialog = new AlertDialog(getContext(), 3);
        TL_phone.getGroupCall getgroupcall = new TL_phone.getGroupCall();
        getgroupcall.call = tL_inputGroupCallInviteMessage;
        getgroupcall.limit = getMessagesController().conferenceCallSizeLimit;
        final int iSendRequest = getConnectionsManager().sendRequest(getgroupcall, new RequestDelegate() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda34
    ...
    public /* synthetic */ void lambda$onCallClick$5(AlertDialog alertDialog, TLObject tLObject, HashSet hashSet, TLRPC.TL_inputGroupCallInviteMessage tL_inputGroupCallInviteMessage, boolean z, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null && "GROUPCALL_INVALID".equalsIgnoreCase(tL_error.text)) {
            ...
            BulletinFactory.m1195of(this).showForError(tL_error);
        }
    }
    ...
    public void onClick(UItem uItem, View view, int i, float f, float f2) {
        ...
        if (i2 == 2) {
            ...
            BulletinFactory.m1195of(this).createSimpleBulletin(C2702R.raw.contact_check, AndroidUtilities.replaceTags(LocaleController.getString(C2702R.string.GroupCallTabWasShownTitle)), LocaleController.getString(C2702R.string.UndoNoCaps), 5000, true, new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda22
                @Override // java.lang.Runnable
                public final void run() {
        ...
        if (obj instanceof CallLogRow) {
            ...
            if (callLogRow.call_id != 0 && !callLogRow.calls.isEmpty()) {
                ...
                while (i3 < size) {
                    ...
                    i3++;
                    hashSet.add(Long.valueOf(((TLRPC.User) obj2).f1775id));
                }
                final TLRPC.TL_inputGroupCallInviteMessage tL_inputGroupCallInviteMessage = new TLRPC.TL_inputGroupCallInviteMessage();
                tL_inputGroupCallInviteMessage.msg_id = ((TLRPC.Message) callLogRow.calls.get(0)).f1636id;
                final AlertDialog alertDialog = new AlertDialog(getContext(), 3);
                ...
                getgroupcall.call = tL_inputGroupCallInviteMessage;
                getgroupcall.limit = getMessagesController().conferenceCallSizeLimit;
                final int iSendRequest = getConnectionsManager().sendRequest(getgroupcall, new RequestDelegate() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda23
                    @Override // org.telegram.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
            ...
            bundle.putInt("message_id", ((TLRPC.Message) callLogRow.calls.get(0)).f1636id);
        ...
        if (view instanceof GroupCallCell) {
            ...
            bundle2.putLong("chat_id", ((GroupCallCell) view).currentChat.f1610id);
            getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.closeChats, new Object[0]);
    ...
    public void onBecomeFullyVisible() {
        ...
        this.hideCallTabsHintView.setPadding(0, AndroidUtilities.m1081dp(4.0f), 0, 0);
        this.hideCallTabsHintView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2702R.string.TapToHideCallsTab)));
        this.contentView.addView(this.hideCallTabsHintView, LayoutHelper.createFrame(-1, 80, 48));
        this.hideCallTabsHintView.setTranslationY((AndroidUtilities.statusBarHeight + ActionBar.getCurrentActionBarHeight()) - AndroidUtilities.m1081dp(16.0f));
    ...
    public ActionBar createActionBar(Context context) {
        ...
        actionBarCreateActionBar.getAdditionalSubTitleOverlayContainer().setTranslationX(AndroidUtilities.m1081dp(4.0f));
        actionBarCreateActionBar.getAdditionalSubTitleOverlayContainer().setTranslationY(-AndroidUtilities.m1081dp(2.0f));
        actionBarCreateActionBar.getTitlesContainer().setTranslationX(AndroidUtilities.m1081dp(4.0f));
    ...
    public void showDeleteAlert(final boolean z) {
        ...
        if (z) {
            builder.setTitle(LocaleController.getString(C2702R.string.DeleteAllCalls));
            builder.setMessage(LocaleController.getString(C2702R.string.DeleteAllCallsText));
        } else {
            builder.setTitle(LocaleController.getString(C2702R.string.DeleteCalls));
            builder.setMessage(LocaleController.getString(C2702R.string.DeleteSelectedCallsText));
        }
        final boolean[] zArr = {false};
        FrameLayout frameLayout = new FrameLayout(getParentActivity());
        CheckBoxCell checkBoxCell = new CheckBoxCell(getParentActivity(), 1);
        checkBoxCell.setBackground(Theme.getSelectorDrawable(false));
        checkBoxCell.setText(LocaleController.getString(C2702R.string.DeleteCallsForEveryone), _UrlKt.FRAGMENT_ENCODE_SET, false, false);
        checkBoxCell.setPadding(LocaleController.isRTL ? AndroidUtilities.m1081dp(8.0f) : 0, 0, LocaleController.isRTL ? 0 : AndroidUtilities.m1081dp(8.0f), 0);
        frameLayout.addView(checkBoxCell, LayoutHelper.createFrame(-1, 48.0f, 51, 8.0f, 0.0f, 8.0f, 0.0f));
        checkBoxCell.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda31
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        builder.setPositiveButton(LocaleController.getString(C2702R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda32
    ...
    private void deleteAllMessages(final boolean z) {
        ...
        getConnectionsManager().sendRequest(tL_messages_deletePhoneCallHistory, new RequestDelegate() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda36
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    private boolean isSelected(ArrayList arrayList) {
        ...
        for (int i = 0; i < size; i++) {
            if (this.selectedIds.contains(Integer.valueOf(((TLRPC.Message) arrayList.get(i)).f1636id))) {
                return true;
            }
        }
        return false;
    ...
    private void createActionMode() {
        ...
        this.actionModeViews.add(actionBarMenuCreateActionMode.addItemWithWidth(2, C2702R.drawable.msg_delete, AndroidUtilities.m1081dp(54.0f), LocaleController.getString(C2702R.string.Delete)));
    }
    ...
    private boolean addOrRemoveSelectedDialog(ArrayList arrayList, CallCell callCell) {
        ...
        if (isSelected(arrayList)) {
            int size = arrayList.size();
            for (int i = 0; i < size; i++) {
                this.selectedIds.remove(Integer.valueOf(((TLRPC.Message) arrayList.get(i)).f1636id));
            }
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            Integer numValueOf = Integer.valueOf(((TLRPC.Message) arrayList.get(i2)).f1636id);
    ...
    public void getCalls(int i, int i2) {
        ...
        tL_messages_search.f1726q = _UrlKt.FRAGMENT_ENCODE_SET;
        tL_messages_search.offset_id = i;
        getConnectionsManager().bindRequestToGuid(getConnectionsManager().sendRequest(tL_messages_search, new RequestDelegate() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda2
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    public /* synthetic */ void lambda$getCalls$21(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda18
            @Override // java.lang.Runnable
            public final void run() {
    ...
    */
    public /* synthetic */ void lambda$getCalls$20(org.telegram.tgnet.TLRPC.TL_error r18, org.telegram.tgnet.TLObject r19) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.CallLogActivity.lambda$getCalls$20(org.telegram.tgnet.TLRPC$TL_error, org.telegram.tgnet.TLObject):void");
    }

    public static /* synthetic */ boolean $r8$lambda$_0SBMTDZzqEhCFeXNeob46nKQg4(long j, TLRPC.User user) {
        return user.f1775id == j;
    }
    ...
    public void onRequestPermissionsResultFragment(int i, String[] strArr, int[] iArr) {
        ...
        if (i == 101 || i == 102 || i == 103) {
            ...
            if (iArr.length <= 0 || !z) {
                ...
                TLRPC.UserFull userFull = this.lastCallUser != null ? getMessagesController().getUserFull(this.lastCallUser.f1775id) : null;
    ...
    static class CallLogRow {
        ...
        /* synthetic */ CallLogRow(CallLogActivityIA callLogActivityIA) {
            this();
        }
    ...
    public void checkUi_listViewPadding() {
        this.listView.setPadding(0, AndroidUtilities.m1081dp(this.ADDITIONAL_LIST_HEIGHT_DP) + this.actionBar.getMeasuredHeight() + ((int) this.topPanelLayout.getAnimatedHeightWithPadding(AndroidUtilities.m1081dp(14.0f))), 0, AndroidUtilities.m1081dp(this.ADDITIONAL_LIST_HEIGHT_DP) + this.navigationBarHeight + this.additionNavigationBarHeight);
    ...
    public void checkUi_listClip() {
        if (this.listView.hasActiveEdgeEffects()) {
            ...
            this.tmpClipRect.set(0, AndroidUtilities.m1081dp(this.ADDITIONAL_LIST_HEIGHT_DP) + this.actionBar.getMeasuredHeight(), this.listView.getMeasuredWidth(), this.listView.getMeasuredHeight() - AndroidUtilities.m1081dp(this.ADDITIONAL_LIST_HEIGHT_DP));
    ...
    public ArrayList getThemeDescriptions() {
        ArrayList arrayList = new ArrayList();
        ThemeDescription.ThemeDescriptionDelegate themeDescriptionDelegate = new ThemeDescription.ThemeDescriptionDelegate() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda14
    ...
    public static void showCallLinkSheet(final Context context, int i, final TLRPC.InputGroupCall inputGroupCall, final String str, final Theme.ResourcesProvider resourcesProvider, boolean z, final boolean z2) {
        ...
        linearLayout.setPadding(0, 0, 0, AndroidUtilities.m1081dp(8.0f));
        ...
        imageView2.setImageResource(C2702R.drawable.ic_ab_other);
        ...
        linksTextViewMakeLinkTextView.setText(LocaleController.getString(C2702R.string.GroupCallCreatedLinkTitle));
        ...
        linksTextViewMakeLinkTextView2.setText(LocaleController.getString(C2702R.string.GroupCallCreatedLinkText));
        ...
        linksTextViewMakeLinkTextView3.setPadding(AndroidUtilities.m1081dp(16.0f), AndroidUtilities.m1081dp(14.0f), 0, AndroidUtilities.m1081dp(14.0f));
        ...
        imageView3.setImageDrawable(ContextCompat.getDrawable(context, C2702R.drawable.ic_ab_other));
        ...
        spannableStringBuilder.append((CharSequence) LocaleController.getString(C2702R.string.GroupCallCreatedLinkCopy));
        spannableStringBuilder.setSpan(new ColoredImageSpan(C2702R.drawable.msg_copy_filled), 0, 1, 33);
        ...
        spannableStringBuilder2.append((CharSequence) LocaleController.getString(C2702R.string.GroupCallCreatedLinkShare));
        spannableStringBuilder2.setSpan(new ColoredImageSpan(C2702R.drawable.msg_share_filled), 0, 1, 33);
        ...
        if (z) {
            C31246 c31246 = new TextView(context) { // from class: org.telegram.ui.CallLogActivity.6
                private final Paint paint = new Paint(1);
                final /* synthetic */ Theme.ResourcesProvider val$resourcesProvider;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C31246(final Context context2, final Theme.ResourcesProvider resourcesProvider2) {
                    super(context2);
            ...
            c31246.setGravity(17);
            c31246.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteGrayText2, resourcesProvider2));
            c31246.setText(" " + LocaleController.getString(C2702R.string.GroupCallCreatedLinkJoinOr) + " ");
            c31246.setTextSize(14.0f);
            linearLayout.addView(c31246, LayoutHelper.createLinear(Opcodes.ARRAYLENGTH, -2, 1, 28, 12, 28, 8));
            i2 = i;
            final Runnable runnable = new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda40
                @Override // java.lang.Runnable
                public final void run() {
            ...
            linksTextViewMakeLinkTextView4.setText(AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(C2702R.string.GroupCallCreatedLinkJoinText), runnable), true));
            ...
            linksTextViewMakeLinkTextView4.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda41
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    runnable.run();
                }
        ...
        frameLayout3.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda42
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                CallLogActivity.$r8$lambda$BsdDJzHH2jXeuHHHw9yzq0gKRJM(strArr, bottomSheetShow, resourcesProvider2, view);
            }
        });
        buttonWithCounterView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda43
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                CallLogActivity.m5744$r8$lambda$1EFOwZ77UqkTcqErUyM45xhGTk(strArr, bottomSheetShow, resourcesProvider2, view);
            }
        });
        final Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda44
            @Override // java.lang.Runnable
            public final void run() {
                CallLogActivity.m5746$r8$lambda$2prmdrrmAf0kUoNk0dOqcJaAs(inputGroupCall, i2, strArr, frameLayout3, linksTextViewMakeLinkTextView3, bottomSheetShow, resourcesProvider2);
            }
        };
        imageView3.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda45
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ...
                ItemOptions.makeOptions(bottomSheet.container, resourcesProvider2, frameLayout4).add(C2702R.drawable.msg_copy, LocaleController.getString(C2702R.string.Copy), new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda49
                    @Override // java.lang.Runnable
                    public final void run() {
                        CallLogActivity.$r8$lambda$PLg6mSTanxGc9UtnR7bnEEzTVXc(strArr2, bottomSheet, resourcesProvider2);
                    }
                }).add(C2702R.drawable.msg_qrcode, LocaleController.getString(C2702R.string.GetQRCode), new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda50
                    @Override // java.lang.Runnable
                    public final void run() {
                        CallLogActivity.m5756$r8$lambda$ofizaQ8fz8pIkZ0CmoIzuZ1WxU(context, strArr2);
                    }
                }).addIf(z2, C2702R.drawable.msg_delete, (CharSequence) LocaleController.getString(C2702R.string.RevokeLink), true, runnable2).show();
            }
        });
        buttonWithCounterView2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda46
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                new ShareAlert(context2, null, str, false, strArr[0], false, resourcesProvider2) { // from class: org.telegram.ui.CallLogActivity.8
                    ...
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    DialogC31268(Context context2, ArrayList arrayList, String str2, boolean z3, String str3, boolean z4, Theme.ResourcesProvider resourcesProvider2, BottomSheet bottomSheet) {
                    ...
                    protected void onSend(LongSparseArray longSparseArray, int i6, TLRPC.TL_forumTopic tL_forumTopic, boolean z3) {
                        ...
                        if (z3) {
                            if (longSparseArray != null && longSparseArray.size() == 1) {
                                long j = ((TLRPC.Dialog) longSparseArray.valueAt(0)).f1616id;
                                if (j == 0 || j == UserConfig.getInstance(this.currentAccount).getClientUserId()) {
                                    string = LocaleController.getString(C2702R.string.InvLinkToSavedMessages);
                                } else {
                                    string = LocaleController.formatString(C2702R.string.InvLinkToUser, MessagesController.getInstance(this.currentAccount).getPeerName(j, true));
                                }
                            } else {
                                string = LocaleController.formatString(C2702R.string.InvLinkToChats, LocaleController.formatPluralString("Chats", longSparseArray == null ? 1 : longSparseArray.size(), new Object[0]));
                            }
                            Bulletin bulletinCreateSimpleBulletin = BulletinFactory.m1194of(bottomSheet.topBulletinContainer, this.resourcesProvider).createSimpleBulletin(C2702R.raw.forward, AndroidUtilities.replaceTags(string));
        ...
        if (z2) {
            imageView2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda47
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    BottomSheet bottomSheet = bottomSheetShow;
                    ItemOptions.makeOptions(bottomSheet.getContainer(), resourcesProvider2, imageView2).add(C2702R.drawable.menu_link_revoke, LocaleController.getString(C2702R.string.GroupCallCreatedLinkRevoke), runnable2).setOnTopOfScrim().translate(0.0f, -AndroidUtilities.m1081dp(6.0f)).setDimAlpha(0).show();
                }
            });
        }
    }
    ...
    public static /* synthetic */ void $r8$lambda$BsdDJzHH2jXeuHHHw9yzq0gKRJM(String[] strArr, BottomSheet bottomSheet, Theme.ResourcesProvider resourcesProvider, View view) {
        ...
        BulletinFactory.m1194of(bottomSheet.topBulletinContainer, resourcesProvider).createCopyBulletin(LocaleController.getString(C2702R.string.LinkCopied)).show();
    }

    /* JADX INFO: renamed from: $r8$lambda$1EFOwZ77UqkTcqErUyM45x-hGTk */
    public static /* synthetic */ void m5744$r8$lambda$1EFOwZ77UqkTcqErUyM45xhGTk(String[] strArr, BottomSheet bottomSheet, Theme.ResourcesProvider resourcesProvider, View view) {
        AndroidUtilities.addToClipboard(strArr[0]);
        BulletinFactory.m1194of(bottomSheet.topBulletinContainer, resourcesProvider).createCopyBulletin(LocaleController.getString(C2702R.string.LinkCopied)).show();
    }

    /* JADX INFO: renamed from: $r8$lambda$2prmd-rrmA-f0kUoNk0dOqcJaAs */
    public static /* synthetic */ void m5746$r8$lambda$2prmdrrmAf0kUoNk0dOqcJaAs(final TLRPC.InputGroupCall inputGroupCall, final int i, final String[] strArr, final FrameLayout frameLayout, final LinkSpanDrawable.LinksTextView linksTextView, final BottomSheet bottomSheet, final Theme.ResourcesProvider resourcesProvider) {
        TL_phone.toggleGroupCallSettings togglegroupcallsettings = new TL_phone.toggleGroupCallSettings();
        togglegroupcallsettings.call = inputGroupCall;
        togglegroupcallsettings.reset_invite_hash = true;
        ConnectionsManager.getInstance(i).sendRequest(togglegroupcallsettings, new RequestDelegate() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda48
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    public static /* synthetic */ void $r8$lambda$GHC6S6IidW7fVoaBk9qPej04rH0(int i, TLRPC.InputGroupCall inputGroupCall, final String[] strArr, final FrameLayout frameLayout, final LinkSpanDrawable.LinksTextView linksTextView, final BottomSheet bottomSheet, final Theme.ResourcesProvider resourcesProvider, TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        ConnectionsManager.getInstance(i).sendRequest(exportgroupcallinvite, new RequestDelegate() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda51
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject2, TLRPC.TL_error tL_error2) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        CallLogActivity.m5750$r8$lambda$XP3zZ7XrhNj3c7Y0VBP453XMXs(tLObject2, strArr, frameLayout, linksTextView, bottomSheet, resourcesProvider);
                    }
                });
            }
        });
    ...
    public static /* synthetic */ void m5750$r8$lambda$XP3zZ7XrhNj3c7Y0VBP453XMXs(TLObject tLObject, String[] strArr, final FrameLayout frameLayout, final LinkSpanDrawable.LinksTextView linksTextView, BottomSheet bottomSheet, Theme.ResourcesProvider resourcesProvider) {
        if (tLObject instanceof TL_phone.exportedGroupCallInvite) {
            ...
            duration.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda1
            ...
            duration.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.CallLogActivity.7
                ...
                C31257(final AtomicBoolean atomicBoolean2, final LinkSpanDrawable.LinksTextView linksTextView2, final String strSubstring2) {
            ...
            duration.start();
            BulletinFactory.m1194of(bottomSheet.topBulletinContainer, resourcesProvider).createSimpleBulletin(C2702R.raw.linkbroken, LocaleController.getString(C2702R.string.GroupCallCreatedLinkRevokedTitle), LocaleController.getString(C2702R.string.GroupCallCreatedLinkRevokedText)).show();
        }
    }
    ...
    class C31257 extends AnimatorListenerAdapter {
        final /* synthetic */ AtomicBoolean val$changed;
        final /* synthetic */ String val$formatted;
        final /* synthetic */ LinkSpanDrawable.LinksTextView val$linkText;
    ...
    public static /* synthetic */ void m5756$r8$lambda$ofizaQ8fz8pIkZ0CmoIzuZ1WxU(Context context, String[] strArr) {
        QRCodeBottomSheet qRCodeBottomSheet = new QRCodeBottomSheet(context, LocaleController.getString(C2702R.string.InviteByQRCode), strArr[0], LocaleController.getString(C2702R.string.QRCodeLinkGroupCall), false);
        qRCodeBottomSheet.setCenterAnimation(C2702R.raw.qr_code_logo);
        qRCodeBottomSheet.show();
    }

    /* JADX INFO: renamed from: org.telegram.ui.CallLogActivity$8 */
    class DialogC31268 extends ShareAlert {
        final /* synthetic */ BottomSheet val$sheet;
    ...
    private void openCreateCall() {
        ...
        presentFragment(new C31279(bundle));
    }

    /* JADX INFO: renamed from: org.telegram.ui.CallLogActivity$9 */
    class C31279 extends GroupCreateActivity {
        C31279(Bundle bundle) {
            super(bundle);
        }
        ...
        protected void onCallUsersSelected(final HashSet hashSet, final boolean z) {
            if (hashSet.size() == 1) {
                ...
                if (userFull == null) {
                    ...
                    getConnectionsManager().sendRequest(tL_users_getFullUser, new RequestDelegate() { // from class: org.telegram.ui.CallLogActivity$9$$ExternalSyntheticLambda0
                        @Override // org.telegram.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(createconferencecall, new RequestDelegate() { // from class: org.telegram.ui.CallLogActivity$9$$ExternalSyntheticLambda1
                    @Override // org.telegram.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        public /* synthetic */ void lambda$onCallUsersSelected$2(TLObject tLObject, boolean z, HashSet hashSet, TLRPC.TL_error tL_error) {
            ...
            if (!(tLObject instanceof TL_phone.groupCall)) {
                if (tL_error != null) {
                    BulletinFactory.m1195of(CallLogActivity.this).showForError(tL_error);
                    return;
                }
                return;
            }
        ...
        ConnectionsManager.getInstance(i).sendRequest(createconferencecall, new RequestDelegate() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda30
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda33
                    @Override // java.lang.Runnable
                    public final void run() {
                        CallLogActivity.m5754$r8$lambda$gyhVDjUE7ARRTUf1l96t6off0(tLObject, i, alertDialog, context, resourcesProvider, runnable);
                    }
                });
            }
        });
    ...
    public static /* synthetic */ void m5754$r8$lambda$gyhVDjUE7ARRTUf1l96t6off0(TLObject tLObject, final int i, final AlertDialog alertDialog, final Context context, final Theme.ResourcesProvider resourcesProvider, final Runnable runnable) {
        int i2 = 0;
        if (tLObject instanceof TLRPC.Updates) {
            TLRPC.Updates updates = (TLRPC.Updates) tLObject;
        ...
        if (tLObject instanceof TL_phone.groupCall) {
            ...
            tL_inputGroupCall2.f1632id = groupCall2.f1625id;
            tL_inputGroupCall2.access_hash = groupCall2.access_hash;
            ConnectionsManager.getInstance(i).sendRequest(exportgroupcallinvite, new RequestDelegate() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda38
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject2, TLRPC.TL_error tL_error) {
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda39
                        @Override // java.lang.Runnable
                        public final void run() {
                            CallLogActivity.m5755$r8$lambda$k3EfdJ6Yoam0W237sh_2inFJEA(tLObject2, alertDialog, context, i, exportgroupcallinvite, resourcesProvider, runnable);
                        }
                    });
                }
            });
    ...
    public static /* synthetic */ void m5755$r8$lambda$k3EfdJ6Yoam0W237sh_2inFJEA(TLObject tLObject, AlertDialog alertDialog, Context context, int i, TL_phone.exportGroupCallInvite exportgroupcallinvite, Theme.ResourcesProvider resourcesProvider, Runnable runnable) {
        if (tLObject instanceof TL_phone.exportedGroupCallInvite) {
            alertDialog.dismiss();
    ...
    private void showItemOptions() {
        ...
        if (getUserConfig().showCallsTab) {
            itemOptionsMakeOptions.add(C2702R.drawable.msg_archive_hide, LocaleController.getString(C2702R.string.HideCallTab), new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda15
                @Override // java.lang.Runnable
                public final void run() {
        ...
        itemOptionsMakeOptions.add(C2702R.drawable.msg_delete, (CharSequence) LocaleController.getString(C2702R.string.DeleteAllCalls), true, new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda16
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$showItemOptions$42() {
        setCallsTabVisible(false);
        (this.hasMainTabs ? BulletinFactory.global() : BulletinFactory.m1195of(this)).createSimpleBulletin(C2702R.raw.contact_check, AndroidUtilities.replaceTags(LocaleController.getString(C2702R.string.GroupCallTabWasHiddenTitle)), LocaleController.getString(C2702R.string.UndoNoCaps), 5000, true, new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda26
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void blur3_InvalidateBlur() {
        ...
        int iM1081dp = AndroidUtilities.m1081dp(48.0f) + ((int) this.topPanelLayout.getAnimatedHeightWithPadding(AndroidUtilities.m1081dp(7.0f)));
        int measuredHeight = (this.fragmentView.getMeasuredHeight() - this.navigationBarHeight) - AndroidUtilities.m1081dp(8.0f);
