...
public class FilterTabsView extends FrameLayout {
    ...
    public class Tab {
        ...
        public int getWidth(boolean z) {
            ...
            int iM1081dp = 0;
            if (z) {
                tabCounter = FilterTabsView.this.delegate.getTabCounter(this.f1911id);
                if (tabCounter < 0) {
                    tabCounter = 0;
                }
                if (z) {
            ...
            if (tabCounter > 0) {
                iMax = Math.max(AndroidUtilities.m1081dp(7.333f), (int) Math.ceil(FilterTabsView.this.textCounterPaint.measureText(String.format(TimeModel.NUMBER_FORMAT, Integer.valueOf(tabCounter))))) + AndroidUtilities.m1081dp(10.0f) + AndroidUtilities.m1081dp(-2.0f);
            } else {
                if (!this.isDefault && FilterTabsView.this.isEditing) {
                    iM1081dp = AndroidUtilities.m1081dp(12.333f);
                }
                iMax = iM1081dp;
            }
            return Math.max(AndroidUtilities.m1081dp(16.0f), i + iMax);
        }
    ...
    public class TabView extends View {
        ...
        public int getId() {
            return this.currentTab.f1911id;
        }
        ...
        */
        ...
        public boolean animateChange() {
            ...
            int iMax = this.currentTab.counter > 0 ? Math.max(AndroidUtilities.m1081dp(7.333f), (int) Math.ceil(FilterTabsView.this.textCounterPaint.measureText(String.format(TimeModel.NUMBER_FORMAT, Integer.valueOf(r2))))) + AndroidUtilities.m1081dp(10.0f) : 0;
            ...
            if (ExteraConfig.tabIcons != 2) {
                iM1081dp = tab.titleWidth + i5 + (iMax != 0 ? iMax + AndroidUtilities.m1081dp(6.0f) : 0);
            } else {
                iM1081dp = i5 + (iMax != 0 ? iMax + AndroidUtilities.m1081dp(6.0f) : 0);
            }
            float measuredWidth = ((getMeasuredWidth() - iM1081dp) / 2) + i5;
            ...
            if (charSequence3 != null && !this.currentTab.title.equals(charSequence3)) {
                ...
                if (iCharSequenceIndexOf >= 0) {
                    ...
                    int iM1081dp2 = AndroidUtilities.m1081dp(400.0f);
                    Layout.Alignment alignment3 = Layout.Alignment.ALIGN_NORMAL;
                    StaticLayout staticLayout = new StaticLayout(spannableStringBuilder4, textPaint3, iM1081dp2, alignment3, 1.0f, 0.0f, false);
                    ...
                    StaticLayout staticLayout2 = new StaticLayout(spannableStringBuilder5, FilterTabsView.this.textPaint, AndroidUtilities.m1081dp(400.0f), alignment3, 1.0f, 0.0f, false);
                    ...
                    int iM1081dp3 = AndroidUtilities.m1081dp(400.0f);
                    Layout.Alignment alignment4 = Layout.Alignment.ALIGN_NORMAL;
                    StaticLayout staticLayout3 = new StaticLayout(charSequence4, textPaint4, iM1081dp3, alignment4, 1.0f, 0.0f, false);
                    ...
                    StaticLayout staticLayout4 = new StaticLayout(this.lastTitle, FilterTabsView.this.textPaint, AndroidUtilities.m1081dp(400.0f), alignment4, 1.0f, 0.0f, false);
            ...
            if (ExteraConfig.tabIcons != 1) {
                float measuredWidth2 = (int) ((getMeasuredWidth() - iM1081dp) / 2.0f);
            ...
            if (iM1081dp == this.lastTabWidth && getMeasuredWidth() == this.lastWidth) {
                return z;
            }
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            accessibilityNodeInfo.setSelected((this.currentTab == null || FilterTabsView.this.selectedTabId == -1 || this.currentTab.f1911id != FilterTabsView.this.selectedTabId) ? false : true);
            accessibilityNodeInfo.addAction(16);
            accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(32, LocaleController.getString(C2702R.string.AccDescrOpenMenu2)));
        ...
        public void shakeLockIcon(final float f, final int i) {
            ...
            ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(0.0f, AndroidUtilities.m1081dp(f));
    ...
    public FilterTabsView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        C41994 c41994 = new C41994();
        this.itemAnimator = c41994;
        c41994.setDelayAnimations(false);
            ...
            public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int i) {
                LinearSmoothScroller linearSmoothScroller = new LinearSmoothScroller(recyclerView.getContext()) { // from class: org.telegram.ui.Components.FilterTabsView.5.1
                    ...
                    protected void onTargetFound(View view, RecyclerView.State state2, RecyclerView.SmoothScroller.Action action) {
                        ...
                        } else if (iCalculateDxToMakeVisible < 0 || (iCalculateDxToMakeVisible == 0 && view.getRight() + AndroidUtilities.m1081dp(21.0f) > FilterTabsView.this.getMeasuredWidth())) {
                            iCalculateDxToMakeVisible -= AndroidUtilities.m1081dp(60.0f);
                        }
        ...
        int iMax = Math.max(0, AndroidUtilities.m1081dp(23.5f) - (FolderIcons.getPaddingTab() / 2));
    ...
    class C41994 extends DefaultItemAnimator {
        C41994() {
        }
                ...
                if (tabView.animateChange) {
                    ...
                    valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.FilterTabsView$4$$ExternalSyntheticLambda1
                        ...
                        public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                            FilterTabsView.C41994.m9602$r8$lambda$DghHiTLqtaEBdiK1Uy8XexT6xo(tabView, valueAnimator2);
                        }
                    });
        ...
        public static /* synthetic */ void m9602$r8$lambda$DghHiTLqtaEBdiK1Uy8XexT6xo(TabView tabView, ValueAnimator valueAnimator) {
        ...
        if (this.delegate.canPerformActions()) {
            ...
            if (this.isEditing) {
                if (i != 0 || ExteraConfig.hideAllChats) {
                    ...
                    this.delegate.onDeletePressed(tabView.currentTab.f1911id);
                    return;
                }
                return;
            }
    ...
    public void scrollToTab(Tab tab, int i) {
        ...
        this.currentPosition = i;
        this.selectedTabId = tab.f1911id;
    ...
    */
    protected boolean drawChild(android.graphics.Canvas r9, android.view.View r10, long r11) {
        ...
        Lb0:
            return r11
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.FilterTabsView.drawChild(android.graphics.Canvas, android.view.View, long):boolean");
    }
    ...
    */
    private void drawSelector(android.graphics.Canvas r14) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.FilterTabsView.drawSelector(android.graphics.Canvas):void");
    }
    ...
    protected void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        this.clipPath.addRoundRect(AndroidUtilities.m1081dp(9.0f), AndroidUtilities.m1081dp(9.0f), i - AndroidUtilities.m1081dp(9.0f), i2 - AndroidUtilities.m1081dp(9.0f), AndroidUtilities.m1081dp(16.0f), AndroidUtilities.m1081dp(16.0f), Path.Direction.CW);
    }
        ...
        if (!this.tabs.isEmpty()) {
            ...
            if (tabFindDefaultTab != null || ExteraConfig.hideAllChats) {
                if (!ExteraConfig.hideAllChats) {
                    ...
                    String string = LocaleController.getString(C2702R.string.FilterAllChats);
                    String string2 = LocaleController.getString(C2702R.string.FilterAllChatsShort);
    ...
    public void setIsEditing(boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (dialogFilter.isDefault()) {
                ...
                tL_messages_updateDialogFiltersOrder.order.add(Integer.valueOf(dialogFilter.f1551id));
            }
        }
    ...
    */
    public void checkTabsCounter() {
        ...
        L45:
            ...
            int r4 = com.exteragram.messenger.utils.p014ui.FolderIcons.getPaddingTab()
            int r3 = r3 + r4
            int r2 = r2 + r3
            r8.allTabsWidth = r2
            int r1 = r1 + 1
        ...
        L73:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.FilterTabsView.checkTabsCounter():void");
    }
    ...
    public void notifyTabCounterChanged(int i) {
        ...
        if (tab.counter == this.delegate.getTabCounter(tab.f1911id) || this.delegate.getTabCounter(tab.f1911id) < 0) {
            return;
        }
        this.listView.invalidateViews();
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        */
        ...
        public void moveElementToStart(int i) {
            ...
            int i3 = ((Tab) FilterTabsView.this.tabs.get(i)).f1911id;
            ...
            ((Tab) FilterTabsView.this.tabs.get(0)).f1911id = i3;
            for (int i5 = 0; i5 <= i; i5++) {
                ((Tab) FilterTabsView.this.tabs.get(i5)).f1911id = i5;
            ...
            notifyItemMoved(i, 0);
            FilterTabsView.this.delegate.onPageReorder(((Tab) FilterTabsView.this.tabs.get(i)).f1911id, i3);
    ...
    public boolean currentTabIsDefault() {
        Tab tabFindDefaultTab = findDefaultTab();
        return tabFindDefaultTab != null && tabFindDefaultTab.f1911id == this.selectedTabId;
    }
    ...
    public int getDefaultTabId() {
        ...
        return tabFindDefaultTab.f1911id;
    }
    ...
    public boolean isFirstTabSelected() {
        return this.tabs.isEmpty() || this.selectedTabId == ((Tab) this.tabs.get(0)).f1911id;
    }

    public boolean isLocked(int i) {
        for (int i2 = 0; i2 < this.tabs.size(); i2++) {
            if (((Tab) this.tabs.get(i2)).f1911id == i) {
    ...
    public void shakeLock(int i) {
        for (int i2 = 0; i2 < this.listView.getChildCount(); i2++) {
            if (this.listView.getChildAt(i2) instanceof TabView) {
                ...
                if (tabView.currentTab.f1911id == i) {
