...
public class ReorderingHintDrawable extends Drawable {
    ...
    private final int intrinsicWidth = AndroidUtilities.m1081dp(24.0f);
    private final int intrinsicHeight = AndroidUtilities.m1081dp(24.0f);
    ...
    private void drawStage1(Canvas canvas, float f) {
        ...
        this.tempRect.left = (int) (AndroidUtilities.m1081dp(2.0f) * this.scaleX);
        this.tempRect.bottom = bounds.bottom - ((int) (AndroidUtilities.m1081dp(6.0f) * this.scaleY));
        Rect rect = this.tempRect;
        rect.right = bounds.right - rect.left;
        rect.top = rect.bottom - ((int) (AndroidUtilities.m1081dp(4.0f) * this.scaleY));
        ...
        rect2.right = iM1081dp;
        rect2.left = iM1081dp;
        Rect rect3 = this.tempRect;
        int iM1081dp2 = AndroidUtilities.m1081dp(8.0f);
        rect3.bottom = iM1081dp2;
        rect3.top = iM1081dp2;
        this.tempRect.inset(-AndroidUtilities.m1081dp(AndroidUtilities.lerp(10, 11, interpolation)), -AndroidUtilities.m1081dp(AndroidUtilities.lerp(2, 3, interpolation)));
        this.primaryRectDrawable.setBounds(this.tempRect);
        this.primaryRectDrawable.setAlpha(AndroidUtilities.lerp(128, Function.USE_VARARGS, interpolation));
    ...
    private void drawStage2(Canvas canvas, float f) {
        ...
        rect.right = bounds.right - rect.left;
        rect.top = rect.bottom - ((int) (AndroidUtilities.m1081dp(4.0f) * this.scaleY));
        this.tempRect.offset(0, AndroidUtilities.m1081dp(AndroidUtilities.lerp(0, -8, interpolation)));
        this.secondaryRectDrawable.setBounds(this.tempRect);
        this.secondaryRectDrawable.draw(canvas);
        ...
        this.tempRect.offset(0, AndroidUtilities.m1081dp(AndroidUtilities.lerp(0, 8, interpolation)));
        this.primaryRectDrawable.setBounds(this.tempRect);
        this.primaryRectDrawable.setAlpha(Function.USE_VARARGS);
        this.primaryRectDrawable.draw(canvas);
    }
    ...
    private void drawStage3(Canvas canvas, float f) {
        ...
        rect.right = bounds.right - rect.left;
        rect.top = rect.bottom - ((int) (AndroidUtilities.m1081dp(4.0f) * this.scaleY));
        this.tempRect.offset(0, AndroidUtilities.m1081dp(-8.0f));
        this.secondaryRectDrawable.setBounds(this.tempRect);
        this.secondaryRectDrawable.draw(canvas);
        ...
        this.tempRect.offset(0, AndroidUtilities.m1081dp(8.0f));
        this.primaryRectDrawable.setBounds(this.tempRect);
        this.primaryRectDrawable.setAlpha(AndroidUtilities.lerp(Function.USE_VARARGS, 128, interpolation));
        this.primaryRectDrawable.draw(canvas);
    }
