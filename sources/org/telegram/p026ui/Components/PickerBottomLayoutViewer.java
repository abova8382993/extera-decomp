...
public class PickerBottomLayoutViewer extends FrameLayout {
    ...
    public PickerBottomLayoutViewer(Context context, boolean z) {
        ...
        this.cancelButton.setPadding(AndroidUtilities.m1081dp(20.0f), 0, AndroidUtilities.m1081dp(20.0f), 0);
        ...
        this.doneButton.setPadding(AndroidUtilities.m1081dp(20.0f), 0, AndroidUtilities.m1081dp(20.0f), 0);
        this.doneButton.setText(LocaleController.getString(C2702R.string.Send).toUpperCase());
        ...
        this.doneButtonBadgeTextView.setBackgroundResource(this.isDarkTheme ? C2702R.drawable.photobadge : C2702R.drawable.bluecounter);
    ...
    public void updateSelectedCount(int i, boolean z) {
        ...
        this.doneButtonBadgeTextView.setText(String.format(TimeModel.NUMBER_FORMAT, Integer.valueOf(i)));
        this.doneButton.setTextColor(this.isDarkTheme ? -1 : -15095832);
        if (z) {
