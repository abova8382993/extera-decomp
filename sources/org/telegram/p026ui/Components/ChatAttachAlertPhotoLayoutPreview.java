...
public class ChatAttachAlertPhotoLayoutPreview extends ChatAttachAlert.AttachAlertLayout {
    ...
    public ChatAttachAlertPhotoLayoutPreview(ChatAttachAlert chatAttachAlert, Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.header.setText(LocaleController.getString(C2702R.string.AttachMediaPreview));
        this.header.setTypeface(AndroidUtilities.bold());
        this.header.setCompoundDrawablePadding(AndroidUtilities.m1081dp(4.0f));
        this.header.setPadding(0, 0, AndroidUtilities.m1081dp(10.0f), 0);
        ...
        undoView.setEnterOffsetMargin(AndroidUtilities.m1081dp(32.0f));
        addView(this.undoView, LayoutHelper.createFrame(-1, -2.0f, 83, 8.0f, 0.0f, 8.0f, 52.0f));
        this.videoPlayImage = context.getResources().getDrawable(C2702R.drawable.play_mini_video);
    }
    ...
    public /* synthetic */ void lambda$onShow$0(ChatAttachAlert.AttachAlertLayout attachAlertLayout) {
        ...
        if (currentItemTop > AndroidUtilities.m1081dp(7.0f)) {
    ...
    public /* synthetic */ void lambda$onShow$1() {
        ...
        this.parentAlert.getPhotoLayout().previewItem.setIcon(C2702R.drawable.ic_ab_back);
        this.parentAlert.getPhotoLayout().previewItem.setText(LocaleController.getString(C2702R.string.Back));
    ...
    public void onHide() {
        ...
        if (getSelectedItemsCount() > 1 && this.parentAlert.getPhotoLayout() != null) {
            this.parentAlert.getPhotoLayout().previewItem.setIcon(C2702R.drawable.msg_view_file);
            this.parentAlert.getPhotoLayout().previewItem.setText(LocaleController.getString(C2702R.string.AttachMediaPreviewButton));
            this.parentAlert.getPhotoLayout().previewItem.setRightIcon(C2702R.drawable.msg_arrowright);
        }
    ...
    public int getCurrentItemTop() {
        ...
        if (top < AndroidUtilities.m1081dp(8.0f) || holder == null || holder.getAdapterPosition() != 0) {
            top = iM1081dp;
        }
    ...
    */
    public void onPreMeasure(int r5, int r6) {
        ...
        L7a:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.ChatAttachAlertPhotoLayoutPreview.onPreMeasure(int, int):void");
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (themeDelegate != null && (wallpaperDrawable = themeDelegate.getWallpaperDrawable()) != null) {
            ...
            if (currentItemTop < ActionBar.getCurrentActionBarHeight()) {
                currentItemTop -= AndroidUtilities.m1081dp((1.0f - (currentItemTop / ActionBar.getCurrentActionBarHeight())) * i);
            }
    ...
    class PreviewGroupsView extends ViewGroup {
        ...
        public PreviewGroupsView(Context context) {
            ...
            this.paddingTop = AndroidUtilities.m1081dp(16.0f);
            this.paddingBottom = AndroidUtilities.m1081dp(64.0f);
            ...
            this.scroller = new Runnable() { // from class: org.telegram.ui.Components.ChatAttachAlertPhotoLayoutPreview.PreviewGroupsView.2
                ...
                public void run() {
                    ...
                    float fMax = Math.max(0.0f, (ChatAttachAlertPhotoLayoutPreview.this.draggingCellTouchY - Math.max(0, iComputeVerticalScrollOffset - ChatAttachAlertPhotoLayoutPreview.this.getListTopPadding())) - AndroidUtilities.m1081dp(52.0f));
                    float fMax2 = Math.max(0.0f, ((ChatAttachAlertPhotoLayoutPreview.this.listView.getMeasuredHeight() - (ChatAttachAlertPhotoLayoutPreview.this.draggingCellTouchY - iComputeVerticalScrollOffset)) - ChatAttachAlertPhotoLayoutPreview.this.getListTopPadding()) - AndroidUtilities.m1081dp(84.0f));
                    float fM1081dp2 = AndroidUtilities.m1081dp(32.0f);
                    if (fMax < fM1081dp2 && iComputeVerticalScrollOffset > ChatAttachAlertPhotoLayoutPreview.this.getListTopPadding()) {
                        fM1081dp = (-(1.0f - (fMax / fM1081dp2))) * AndroidUtilities.m1081dp(6.0f);
                    } else {
                        fM1081dp = fMax2 < fM1081dp2 ? AndroidUtilities.m1081dp(6.0f) * (1.0f - (fMax2 / fM1081dp2)) : 0.0f;
                    }
                    int i = (int) fM1081dp;
                    if (Math.abs(i) > 0 && ChatAttachAlertPhotoLayoutPreview.this.listView.canScrollVertically(i) && (fM1081dp <= 0.0f || !z)) {
                        ChatAttachAlertPhotoLayoutPreview.this.draggingCellTouchY += fM1081dp;
            ...
            chatActionCell.setCustomText(LocaleController.getString(C2702R.string.AttachMediaDragHint));
        ...
        private int measureHeight() {
            return Math.max(measurePureHeight(), (AndroidUtilities.displaySize.y - ActionBar.getCurrentActionBarHeight()) - AndroidUtilities.m1081dp(45.0f));
        }
        ...
        */
        ...
        Point dragTranslate() {
            ...
            if (!ChatAttachAlertPhotoLayoutPreview.this.draggingCellHiding) {
                ...
                this.tmpPoint.f1967x = AndroidUtilities.lerp(rectFRect2.left + (rectFRect.width() / 2.0f), ChatAttachAlertPhotoLayoutPreview.this.draggingCellTouchX - ((ChatAttachAlertPhotoLayoutPreview.this.draggingCellLeft - 0.5f) * ChatAttachAlertPhotoLayoutPreview.this.draggingCellFromWidth), this.draggingT);
                this.tmpPoint.f1968y = AndroidUtilities.lerp(ChatAttachAlertPhotoLayoutPreview.this.draggingCell.groupCell.f1890y + rectFRect2.top + (rectFRect.height() / 2.0f), (ChatAttachAlertPhotoLayoutPreview.this.draggingCellTouchY - ((ChatAttachAlertPhotoLayoutPreview.this.draggingCellTop - 0.5f) * ChatAttachAlertPhotoLayoutPreview.this.draggingCellFromHeight)) + ChatAttachAlertPhotoLayoutPreview.this.draggingCellGroupY, this.draggingT);
            } else {
                ...
                this.tmpPoint.f1967x = AndroidUtilities.lerp(rectFRect4.left + (rectFRect3.width() / 2.0f), this.savedDragFromX, this.draggingT / this.savedDraggingT);
                this.tmpPoint.f1968y = AndroidUtilities.lerp(ChatAttachAlertPhotoLayoutPreview.this.draggingCell.groupCell.f1890y + rectFRect4.top + (rectFRect3.height() / 2.0f), this.savedDragFromY, this.draggingT / this.savedDraggingT);
            }
        ...
        void stopDragging() {
            ...
            this.savedDragFromX = pointDragTranslate.f1967x;
            this.savedDragFromY = pointDragTranslate.f1968y;
        ...
        void startDragging(PreviewGroupCell.MediaCell mediaCell) {
            ...
            ChatAttachAlertPhotoLayoutPreview chatAttachAlertPhotoLayoutPreview = ChatAttachAlertPhotoLayoutPreview.this;
            chatAttachAlertPhotoLayoutPreview.draggingCellGroupY = chatAttachAlertPhotoLayoutPreview.draggingCell.groupCell.f1890y;
            ChatAttachAlertPhotoLayoutPreview.this.draggingCellHiding = false;
            this.draggingT = 0.0f;
            invalidate();
            if (ChatAttachAlertPhotoLayoutPreview.this.draggingAnimator != null) {
            ...
            public PhotoViewer.PlaceProviderObject getPlaceForPhoto(MessageObject messageObject, TLRPC.FileLocation fileLocation, int i, boolean z, boolean z2) {
                ...
                if (i >= 0 && i < this.photos.size() && isPhotoChecked(i) && (photoEntry = (MediaController.PhotoEntry) this.photos.get(i)) != null) {
                    ...
                    if (previewGroupCell != null && mediaCell != null) {
                        ...
                        placeProviderObject.viewY = iArr[1] + ((int) previewGroupCell.f1890y);
        ...
        */
        ...
        class PreviewGroupCell {
            ...
            private PreviewGroupCell() {
                ...
                this.padding = AndroidUtilities.m1081dp(4.0f);
                int iM1081dp = AndroidUtilities.m1081dp(2.0f);
                this.gap = iM1081dp;
                this.halfGap = iM1081dp / 2;
            ...
            class MediaCell {
                ...
                public void layout(GroupCalculator groupCalculator, MessageObject.GroupedMessagePosition groupedMessagePosition, boolean z) {
                    ...
                    float f5 = f3 / f4;
                    float f6 = groupedMessagePosition.f1548pw / i;
                    float f7 = groupedMessagePosition.f1547ph / f4;
                    this.scale = 1.0f;
                    this.rect.set(f2, f5, f6 + f2, f7 + f5);
                    float fM1081dp = AndroidUtilities.m1081dp(2.0f);
                    float fM1081dp2 = AndroidUtilities.m1081dp(SharedConfig.bubbleRadius - 1);
                    RectF rectF4 = this.roundRadiuses;
                    int i2 = this.positionFlags;
                    float f8 = (i2 & 5) == 5 ? fM1081dp2 : fM1081dp;
                    float f9 = (i2 & 6) == 6 ? fM1081dp2 : fM1081dp;
                    float f10 = (i2 & 10) == 10 ? fM1081dp2 : fM1081dp;
                    if ((i2 & 9) == 9) {
                        fM1081dp = fM1081dp2;
                    }
                    rectF4.set(f8, f9, f10, fM1081dp);
                    if (this.fromRect == null) {
                ...
                private void drawPhotoIndex(Canvas canvas, float f, float f2, String str, float f3, float f4) {
                    ...
                    int iM1081dp2 = AndroidUtilities.m1081dp(1.2f);
                    int i = (iM1081dp + iM1081dp2) * 2;
                    int i2 = iM1081dp2 * 4;
                    if (str != null && (this.indexBitmap == null || (str2 = this.indexBitmapText) == null || !str2.equals(str))) {
                        ...
                        this.textPaint.setTextSize(AndroidUtilities.m1081dp(f5));
                        float f6 = i / 2.0f;
                        ...
                        this.strokePaint.setStrokeWidth(iM1081dp2);
                        canvas2.drawCircle(f7, f7, f8, this.strokePaint);
                        canvas2.drawText(str, f6 - (this.textPaint.measureText(str) / 2.0f), f6 + AndroidUtilities.m1081dp(1.0f) + AndroidUtilities.m1081dp(f5 / 4.0f), this.textPaint);
                ...
                private void drawDuration(Canvas canvas, float f, float f2, String str, float f3, float f4) {
                    ...
                    if (str != null) {
                        if (this.videoDurationBitmap == null || (str2 = this.videoDurationBitmapText) == null || !str2.equals(str)) {
                            ...
                            this.videoDurationTextPaint.setTextSize(fM1081dp);
                            float intrinsicWidth = ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.getIntrinsicWidth() + this.videoDurationTextPaint.measureText(str) + AndroidUtilities.m1081dp(15.0f);
                            float fMax = Math.max(fM1081dp, ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.getIntrinsicHeight() + AndroidUtilities.m1081dp(4.0f));
                            ...
                            canvas2.drawRoundRect(rectF, AndroidUtilities.m1081dp(4.0f), AndroidUtilities.m1081dp(4.0f), Theme.chat_timeBackgroundPaint);
                            ...
                            ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.setBounds(iM1081dp, intrinsicHeight, ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.getIntrinsicWidth() + iM1081dp, ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.getIntrinsicHeight() + intrinsicHeight);
                            ChatAttachAlertPhotoLayoutPreview.this.videoPlayImage.draw(canvas2);
                            canvas2.drawText(str, AndroidUtilities.m1081dp(18.0f), fM1081dp + AndroidUtilities.m1081dp(-0.7f), this.videoDurationTextPaint);
            ...
            public void drawStarsButton(Canvas canvas) {
                ...
                rectF.set(((f2 - fM1081dp) / 2.0f) + f, ((f4 - fM1081dp2) / 2.0f) + f3, f + ((f2 + fM1081dp) / 2.0f), f3 + ((f4 + fM1081dp2) / 2.0f));
                this.buttonTextBgPaint.setColor(1610612736);
                float f5 = fM1081dp2 / 2.0f;
                canvas.drawRoundRect(this.buttonTextRect, f5, f5, this.buttonTextBgPaint);
                this.buttonText.draw(canvas, ((this.left + (this.width / 2.0f)) - (fM1081dp / 2.0f)) + AndroidUtilities.m1081dp(14.0f), this.top + (this.height / 2.0f), -1, 1.0f);
            }
        }
    }
