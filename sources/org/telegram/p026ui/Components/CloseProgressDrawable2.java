...
public abstract class CloseProgressDrawable2 extends Drawable {
    ...
    public CloseProgressDrawable2(float f) {
        ...
        this.rect = new RectF();
        this.globalColorAlpha = Function.USE_VARARGS;
        this.paint.setColor(-1);
        this.paint.setStrokeWidth(AndroidUtilities.m1081dp(f));
        this.paint.setStrokeCap(Paint.Cap.ROUND);
        this.paint.setStyle(Paint.Style.STROKE);
        this.side = AndroidUtilities.m1081dp(8.0f);
    }
    ...
    private void setColor(int i) {
        if (this.currentColor != i) {
            ...
            this.paint.setColor(ColorUtils.setAlphaComponent(i, Function.USE_VARARGS));
        }
    }
    ...
    */
    public void draw(android.graphics.Canvas r17) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.CloseProgressDrawable2.draw(android.graphics.Canvas):void");
    }
