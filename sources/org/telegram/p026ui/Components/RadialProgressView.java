...
public class RadialProgressView extends View {
    ...
    public RadialProgressView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.size = AndroidUtilities.m1081dp(40.0f);
    ...
    public void setStyle(int i) {
        if (this.currentStyle != i) {
            ...
            if (i == 1) {
                ...
                this.m3CircularProgressIndicator.setTrackCornerRadius(AndroidUtilities.m1081dp(2.0f));
                this.m3CircularProgressIndicator.setIndicatorTrackGapSize(AndroidUtilities.m1081dp(2.0f));
    ...
    /* JADX WARN: Removed duplicated region for block: B:205:0x002f  */
    /*
    ...
    */
    private void updateAnimation(long r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.RadialProgressView.updateAnimation(long):void");
    }
    ...
    public void setStrokeWidth(float f) {
        this.progressPaint.setStrokeWidth(AndroidUtilities.m1081dp(f));
        CircularProgressIndicator circularProgressIndicator = this.m3CircularProgressIndicator;
        if (circularProgressIndicator != null) {
            circularProgressIndicator.setTrackThickness(AndroidUtilities.m1081dp(f));
        }
    }
