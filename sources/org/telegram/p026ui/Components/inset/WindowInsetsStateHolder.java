...
import org.telegram.p026ui.Components.inset.KeyboardState;
...
public class WindowInsetsStateHolder implements WindowInsetsProvider, WindowInsetsInAppController, WindowAnimatedInsetsProvider.Listener {
    ...
    @Override // org.telegram.p026ui.Components.inset.WindowInsetsInAppController
    ...
    public void setInsets(WindowInsetsCompat windowInsetsCompat) {
        ...
        Insets insetsMax = Insets.max(insets2, Insets.m85of(0, 0, 0, this.inAppKeyboardHeight));
    ...
    @Override // org.telegram.p026ui.Components.inset.WindowInsetsProvider
