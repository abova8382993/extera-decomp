...
public class AnimatedEmojiDrawable extends Drawable {
    ...
    public static AnimatedEmojiDrawable make(int i, int i2, TLRPC.Document document) {
        ...
        AnimatedEmojiDrawable animatedEmojiDrawable = (AnimatedEmojiDrawable) longSparseArray.get(document.f1618id);
        if (animatedEmojiDrawable != null) {
            return animatedEmojiDrawable;
        }
        long j = document.f1618id;
    ...
    public static class EmojiDocumentFetcher {
        ...
        private boolean checkThread() {
            ...
            FileLog.m1092e("EmojiDocumentFetcher", new IllegalStateException("Wrong thread"));
            return false;
        }
            ...
            try {
                ...
                while (sQLiteCursorQueryFinalized.next()) {
                    ...
                    try {
                        ...
                        if (documentTLdeserialize != null && documentTLdeserialize.f1618id != 0) {
                            arrayList2.add(documentTLdeserialize);
                            hashSet.remove(Long.valueOf(documentTLdeserialize.f1618id));
                        }
                    } catch (Exception e) {
                        FileLog.m1093e(e);
                    }
            ...
            if (tLObject instanceof Vector) {
                ...
                for (int i = 0; i < arrayList2.size(); i++) {
                    if (arrayList2.get(i) instanceof TLRPC.Document) {
                        hashSet.remove(Long.valueOf(((TLRPC.Document) arrayList2.get(i)).f1618id));
                    }
                }
                if (hashSet.isEmpty()) {
                    return;
                    ...
                    if (arrayList.get(i) instanceof TLRPC.Document) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                sQLitePreparedStatementExecuteFast.bindLong(1, document.f1618id);
            ...
            if (checkThread()) {
                ...
                for (int i = 0; i < arrayList.size(); i++) {
                    if (arrayList.get(i) instanceof TLRPC.Document) {
                        ...
                        if (map != null && (arrayList2 = (ArrayList) map.remove(Long.valueOf(document.f1618id))) != null) {
        ...
        public void putDocument(TLRPC.Document document) {
            ...
            synchronized (this) {
                try {
                    ...
                    this.emojiDocumentsCache.put(Long.valueOf(document.f1618id), document);
                } catch (Throwable th) {
                    throw th;
                }
            }
    ...
    class C36441 extends ImageReceiver {
        C36441() {
        }
    ...
    private void createImageReceiver() {
        if (this.imageReceiver == null) {
            C36441 c36441 = new C36441();
            this.imageReceiver = c36441;
            c36441.setCurrentAccount(this.currentAccount);
    ...
    /* JADX WARN: Removed duplicated region for block: B:1124:0x0218  */
    /* JADX WARN: Removed duplicated region for block: B:1126:0x0225  */
    /* JADX WARN: Removed duplicated region for block: B:1130:0x022e  */
    /* JADX WARN: Removed duplicated region for block: B:1131:0x025f  */
    /* JADX WARN: Removed duplicated region for block: B:1157:0x03a5  */
    /* JADX WARN: Removed duplicated region for block: B:1167:0x03b6  */
    /* JADX WARN: Removed duplicated region for block: B:1170:0x03c2  */
    /* JADX WARN: Removed duplicated region for block: B:1172:0x03c6  */
    /* JADX WARN: Removed duplicated region for block: B:1175:0x03d8  */
    /* JADX WARN: Removed duplicated region for block: B:1190:0x0402  */
    /* JADX WARN: Removed duplicated region for block: B:1193:0x041c  */
    /* JADX WARN: Removed duplicated region for block: B:1200:0x042d  */
    ...
    */
    private void initDocument(boolean r36) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.AnimatedEmojiDrawable.initDocument(boolean):void");
    }
    ...
    class ViewOnAttachStateChangeListenerC36452 implements View.OnAttachStateChangeListener {
        ViewOnAttachStateChangeListenerC36452() {
        }
    ...
    */
    public boolean isDefaultStatusEmoji() {
        ...
        L35:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.AnimatedEmojiDrawable.isDefaultStatusEmoji():boolean");
    }
    ...
    public static class SwapAnimatedEmojiDrawable extends Drawable implements AnimatedEmojiSpan.InvalidateHolder {
            ...
            if (this.drawables[0] != null) {
                ...
                if (drawable3 instanceof AnimatedEmojiDrawable) {
                    if (((AnimatedEmojiDrawable) drawable3).imageReceiver != null) {
                        ((AnimatedEmojiDrawable) this.drawables[0]).imageReceiver.setRoundRadius(AndroidUtilities.m1081dp(4.0f));
                    }
                    if (f < 1.0f) {
        ...
        public void set(TLRPC.Document document, int i, boolean z) {
            Drawable drawable = this.drawables[0];
            if ((drawable instanceof AnimatedEmojiDrawable) && document != null && ((AnimatedEmojiDrawable) drawable).getDocumentId() == document.f1618id) {
                return;
            }
            if (z) {
                this.changeProgress.set(0.0f, true);
