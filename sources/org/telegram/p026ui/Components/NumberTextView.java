...
public class NumberTextView extends View {
    ...
    /* JADX WARN: Removed duplicated region for block: B:72:0x004e A[PHI: r2 r7
  ...
  0x004e: PHI (r7v4 java.lang.String) = (r7v1 java.lang.String), (r7v6 java.lang.String) binds: [B:75:0x0072, B:71:0x004c] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:73:0x0050 A[PHI: r2 r7
  ...
  0x0050: PHI (r7v2 java.lang.String) = (r7v1 java.lang.String), (r7v6 java.lang.String) binds: [B:75:0x0072, B:71:0x004c] A[DONT_GENERATE, DONT_INLINE]] */
    /*
    ...
    */
    public void setNumber(int r22, boolean r23) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.NumberTextView.setNumber(int, boolean):void");
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.NumberTextView$1 */
    /* JADX INFO: loaded from: classes5.dex */
    class C43911 extends AnimatorListenerAdapter {
        C43911() {
        }
    ...
    public void setTextSize(int i) {
        this.textPaint.setTextSize(AndroidUtilities.m1081dp(i));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float fM1081dp = this.addNumber ? AndroidUtilities.m1081dp(4.0f) : height;
        if (this.center) {
        ...
        while (i < iMax) {
            ...
            if (f > 0.0f) {
                if (staticLayout != null) {
                    ...
                    canvas.save();
                    canvas.translate(lineWidth, (this.progress - 1.0f) * fM1081dp);
                    staticLayout.draw(canvas);
                    canvas.restore();
                    if (staticLayout2 != null) {
                        this.textPaint.setAlpha((int) ((1.0f - this.progress) * 255.0f));
                        canvas.translate(0.0f, this.progress * fM1081dp);
                    }
                } else {
            ...
            canvas.restore();
            canvas.translate(staticLayout2 != null ? staticLayout2.getLineWidth(0) : staticLayout.getLineWidth(0) + AndroidUtilities.m1081dp(1.0f), 0.0f);
