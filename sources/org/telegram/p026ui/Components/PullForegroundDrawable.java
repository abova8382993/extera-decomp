...
public abstract class PullForegroundDrawable {
    ...
    public PullForegroundDrawable(CharSequence charSequence, CharSequence charSequence2) {
        ...
        try {
            this.generalTopicDrawable = ApplicationLoader.applicationContext.getResources().getDrawable(C2702R.drawable.msg_filled_general).mutate();
    ...
    public static int getMaxOverscroll() {
        return AndroidUtilities.m1081dp(72.0f);
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:364:0x03d1  */
    ...
    */
    public void draw(android.graphics.Canvas r35, boolean r36) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.PullForegroundDrawable.draw(android.graphics.Canvas, boolean):void");
    }
    ...
    class RunnableC46681 implements Runnable {
        RunnableC46681() {
        }
    ...
    public void startOutAnimation() {
        ...
        this.outOverScroll = this.listView.getTranslationY() / AndroidUtilities.m1081dp(100.0f);
        ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
    ...
    class C46692 extends AnimatorListenerAdapter {
        C46692() {
        }
    ...
    private class ArrowDrawable extends Drawable {
        ...
        private void updatePath() {
            ...
            this.path.lineTo(iM1081dp - AndroidUtilities.dpf2(4.95f), AndroidUtilities.dpf2(9.0f));
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.drawRect(AndroidUtilities.dpf2(7.56f), AndroidUtilities.dpf2(8.0f), AndroidUtilities.m1081dp(18.0f) - AndroidUtilities.dpf2(7.56f), AndroidUtilities.dpf2(11.1f), this.paint);
            canvas.restore();
        }
    }
}
