...
public abstract class HashtagHistoryView extends FrameLayout {
    ...
    public HashtagHistoryView(Context context, Theme.ResourcesProvider resourcesProvider, int i) {
        ...
        this.emptyImage.setImageResource(C2702R.drawable.large_hashtags);
        this.emptyView.addView(this.emptyImage, LayoutHelper.createFrame(56, 56, 49));
        TextView textView = new TextView(context);
        this.emptyText = textView;
        textView.setTextColor(Theme.getColor(i2, resourcesProvider));
        this.emptyText.setText(LocaleController.getString(C2702R.string.HashtagSearchPlaceholder));
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        for (int i = 0; i < this.history.size(); i++) {
            ...
            if (str.startsWith("#") || str.startsWith("$")) {
                arrayList.add(UItem.asButton(i + 1, str.startsWith("$") ? C2702R.drawable.menu_cashtag : C2702R.drawable.menu_hashtag, str.substring(1)));
            }
        }
        arrayList.add(UItem.asButton(0, C2702R.drawable.msg_clear_recent, LocaleController.getString(C2702R.string.ClearHistory)));
    }
    ...
    public boolean onLongClick(UItem uItem, View view, int i, float f, float f2) {
        ...
        builder.setMessage(LocaleController.formatString(C2702R.string.ClearSearchSingleHashtagAlertText, str));
        builder.setPositiveButton(LocaleController.getString(C2702R.string.ClearSearchRemove), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.HashtagHistoryView$$ExternalSyntheticLambda3
