...
public class GroupCreateSpan extends View {
    ...
    /* JADX WARN: Removed duplicated region for block: B:301:0x02de  */
    ...
    /* JADX WARN: Removed duplicated region for block: B:316:0x0318  */
    ...
    */
    public GroupCreateSpan(android.content.Context r32, java.lang.Object r33, org.telegram.messenger.ContactsController.Contact r34, boolean r35, org.telegram.ui.ActionBar.Theme.ResourcesProvider r36) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.GroupCreateSpan.<init>(android.content.Context, java.lang.Object, org.telegram.messenger.ContactsController$Contact, boolean, org.telegram.ui.ActionBar.Theme$ResourcesProvider):void");
    }
    ...
    protected void onMeasure(int i, int i2) {
        setMeasuredDimension(AndroidUtilities.m1081dp((this.small ? 20 : 32) + 25) + this.textWidth, AndroidUtilities.m1081dp(this.small ? 28.0f : 32.0f));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.save();
        this.rect.set(0.0f, 0.0f, getMeasuredWidth(), AndroidUtilities.m1081dp(this.small ? 28.0f : 32.0f));
        ...
        if (this.progress != 0.0f) {
            ...
            canvas.drawRoundRect(0.0f, 0.0f, AndroidUtilities.m1081dp(this.small ? 28.0f : 32.0f), AndroidUtilities.m1081dp(this.small ? 28.0f : 32.0f), ExteraConfig.getAvatarCorners(this.small ? 28.0f : 32.0f), ExteraConfig.getAvatarCorners(this.small ? 28.0f : 32.0f), backPaint);
            canvas.save();
            canvas.rotate((1.0f - this.progress) * 45.0f, AndroidUtilities.m1081dp(16.0f), AndroidUtilities.m1081dp(16.0f));
            this.deleteDrawable.setBounds(AndroidUtilities.m1081dp(this.small ? 9.0f : 11.0f), AndroidUtilities.m1081dp(this.small ? 9.0f : 11.0f), AndroidUtilities.m1081dp(this.small ? 19.0f : 21.0f), AndroidUtilities.m1081dp(this.small ? 19.0f : 21.0f));
            this.deleteDrawable.setAlpha((int) (this.progress * 255.0f));
            this.deleteDrawable.draw(canvas);
            canvas.restore();
        }
        canvas.translate(this.textX + AndroidUtilities.m1081dp((this.small ? 26 : 32) + 9), AndroidUtilities.m1081dp(this.small ? 6.0f : 8.0f));
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (isDeleting()) {
            accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(AccessibilityNodeInfo.AccessibilityAction.ACTION_CLICK.getId(), LocaleController.getString(C2702R.string.Delete)));
        }
    }
}
