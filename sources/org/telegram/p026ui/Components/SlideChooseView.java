...
public class SlideChooseView extends View {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(74.0f), TLObject.FLAG_30));
        this.circleSize = AndroidUtilities.m1081dp(6.0f);
        this.gapSize = AndroidUtilities.m1081dp(2.0f);
        this.sideSide = AndroidUtilities.m1081dp(22.0f);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int measuredHeight = (getMeasuredHeight() / 2) + AndroidUtilities.m1081dp(11.0f);
        int i2 = 0;
        while (i2 < this.optionsStr.length) {
            ...
            if (this.leftDrawables != null) {
                canvas2.save();
                if (i2 == 0) {
                    canvas2.translate(AndroidUtilities.m1081dp(12.0f), AndroidUtilities.m1081dp(15.5f));
                } else if (i2 == this.optionsStr.length - 1) {
                    canvas2.translate(((getMeasuredWidth() - i12) - AndroidUtilities.m1081dp(22.0f)) - AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(28.0f) - AndroidUtilities.m1081dp(12.5f));
                } else {
                    canvas2.translate((i - (i12 / 2)) - AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(28.0f) - AndroidUtilities.m1081dp(12.5f));
                }
                ...
                canvas2.save();
                f4 = 0.0f;
                canvas2.translate((this.leftDrawables[i2].getIntrinsicWidth() / 2.0f) - AndroidUtilities.m1081dp(i2 == 0 ? f2 : 2.0f), 0.0f);
            } else {
                f4 = 0.0f;
            }
            if (i2 == 0) {
                canvas2.drawText(str, AndroidUtilities.m1081dp(22.0f), AndroidUtilities.m1081dp(28.0f), this.textPaint);
            } else if (i2 == this.optionsStr.length - 1) {
                canvas2.drawText(str, (getMeasuredWidth() - i12) - AndroidUtilities.m1081dp(22.0f), AndroidUtilities.m1081dp(28.0f), this.textPaint);
            } else {
                canvas2.drawText(str, i - (i12 / 2), AndroidUtilities.m1081dp(28.0f), this.textPaint);
            }
            if (this.leftDrawables != null) {
                canvas2.restore();
            }
        ...
        canvas2.drawCircle(f17, f18, AndroidUtilities.m1081dp(f8 * 12.0f), this.paint);
        this.paint.setColor(AndroidUtilities.getTransparentColor(getThemedColor(i15), this.allowSlide ? f14 : 0.5f));
        canvas2.drawCircle(f17, f18, AndroidUtilities.m1081dp(6.0f), this.paint);
        if (this.needDivider) {
            canvas2.drawLine(LocaleController.isRTL ? f15 : AndroidUtilities.m1081dp(21.0f), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m1081dp(21.0f) : 0), getMeasuredHeight() - 1, Theme.dividerPaint);
        }
    }
