...
public class MessageContainsEmojiButton extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    private class BoldAndAccent extends CharacterStyle {
        /* synthetic */ BoldAndAccent(MessageContainsEmojiButton messageContainsEmojiButton, MessageContainsEmojiButtonIA messageContainsEmojiButtonIA) {
            this();
        }
    ...
    */
    public MessageContainsEmojiButton(int r10, android.content.Context r11, org.telegram.ui.ActionBar.Theme.ResourcesProvider r12, java.util.ArrayList r13, int r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.MessageContainsEmojiButton.<init>(int, android.content.Context, org.telegram.ui.ActionBar.Theme$ResourcesProvider, java.util.ArrayList, int):void");
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.MessageContainsEmojiButton$1 */
    /* JADX INFO: loaded from: classes5.dex */
    class C43631 extends AnimatedEmojiSpan {
        C43631(TLRPC.Document document, Paint.FontMetricsInt fontMetricsInt) {
        ...
        if (charSequence != this.lastMainTextText || this.lastMainTextWidth != i) {
            if (charSequence != null) {
                ...
                if (this.loadingDrawable != null && this.loadingBoundsTo == null) {
                    ...
                    this.lastLineMargin = ((int) this.mainTextLayout.getPrimaryHorizontal(this.mainText.length())) + AndroidUtilities.m1081dp(2.0f);
                    this.lastLineTop = this.mainTextLayout.getLineTop(lineCount);
                    this.lastLineHeight = lineBottom - this.lastLineTop;
                    float fMin = Math.min(AndroidUtilities.m1081dp(100.0f), this.mainTextLayout.getWidth() - this.lastLineMargin);
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (stickerSet2 != null) {
            ...
            while (true) {
                ...
                if (((TLRPC.Document) stickerSet.documents.get(i3)).f1618id == stickerSet.set.thumb_document_id) {
        ...
        spannableString2.setSpan(new AnimatedEmojiSpan(document, this.textPaint.getFontMetricsInt()) { // from class: org.telegram.ui.Components.MessageContainsEmojiButton.3
            C43653(TLRPC.Document document2, Paint.FontMetricsInt fontMetricsInt) {
        ...
        final boolean z = Math.abs(measuredHeight - iUpdateLayout) > AndroidUtilities.m1081dp(3.0f);
    ...
    class C43642 extends ReplacementSpan {
        @Override // android.text.style.ReplacementSpan
        public void draw(Canvas canvas, CharSequence charSequence, int i4, int i5, float f, int i6, int i7, int i8, Paint paint) {
        }
    ...
    class C43653 extends AnimatedEmojiSpan {
        C43653(TLRPC.Document document2, Paint.FontMetricsInt fontMetricsInt) {
            super(document2, fontMetricsInt);
        }
