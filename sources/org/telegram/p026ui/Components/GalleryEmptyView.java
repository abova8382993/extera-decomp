...
public class GalleryEmptyView extends LinearLayout {
    ...
    public GalleryEmptyView(Context context, int i, boolean z) {
        ...
        backupImageView.setImageDrawable(new RLottieDrawable(C2702R.raw.utyan_gallery, "utyan_gallery", AndroidUtilities.m1081dp(110.0f), AndroidUtilities.m1081dp(110.0f)));
        ...
        textView.setText(LocaleController.getString(C2702R.string.GalleryAccessAllowAccess));
        ...
        textView2.setText(LocaleController.getString(UserConfig.getInstance(i).isPremium() ? C2702R.string.GalleryAccessAllowAccessTextPremium : C2702R.string.GalleryAccessAllowAccessTextNonPremium));
        textView2.setMaxWidth(AndroidUtilities.m1081dp(260.0f));
        ...
        buttonWithCounterView.setText(LocaleController.getString(C2702R.string.GalleryAccessAllowAccessButton), false);
        ...
        spannableStringBuilder.setSpan(new ColoredImageSpan(C2702R.drawable.outline_attach_camera_24), 0, 1, 33);
        spannableStringBuilder.append((CharSequence) "  ").append((CharSequence) LocaleController.getString(C2702R.string.GalleryAccessAllowAccessOpenCamera));
        ...
        spannableStringBuilder2.append((CharSequence) LocaleController.getString(C2702R.string.UseEmoji));
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(44.0f), TLObject.FLAG_30);
        ...
        this.galleryAccessButton.getLayoutParams().width = AndroidUtilities.m1081dp(80.0f) + iMax;
        this.cameraAccessButton.getLayoutParams().width = AndroidUtilities.m1081dp(80.0f) + iMax;
        this.useAnEmojiButton.getLayoutParams().width = iMax + AndroidUtilities.m1081dp(80.0f);
