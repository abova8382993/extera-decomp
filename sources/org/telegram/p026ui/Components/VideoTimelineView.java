...
public class VideoTimelineView extends View {
    ...
    public void setRoundFrames(boolean z) {
        ...
        if (z) {
            this.rect1 = new Rect(AndroidUtilities.m1081dp(14.0f), AndroidUtilities.m1081dp(14.0f), AndroidUtilities.m1081dp(42.0f), AndroidUtilities.m1081dp(42.0f));
            this.rect2 = new Rect();
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        int measuredWidth = getMeasuredWidth() - AndroidUtilities.m1081dp(24.0f);
        float f = measuredWidth;
        int iM1081dp = ((int) (this.progressLeft * f)) + AndroidUtilities.m1081dp(12.0f);
        int iM1081dp2 = ((int) (this.progressRight * f)) + AndroidUtilities.m1081dp(12.0f);
        if (motionEvent.getAction() == 0) {
            getParent().requestDisallowInterceptTouchEvent(true);
            if (this.mediaMetadataRetriever == null) {
                return false;
            }
            int iM1081dp3 = AndroidUtilities.m1081dp(24.0f);
            if (iM1081dp - iM1081dp3 <= x && x <= iM1081dp + iM1081dp3 && y >= 0.0f && y <= getMeasuredHeight()) {
                ...
                this.pressDx = (int) (x - iM1081dp);
                this.timeHintView.setTime((int) ((this.videoLength / 1000.0f) * this.progressLeft));
                this.timeHintView.setCx(iM1081dp + getLeft() + AndroidUtilities.m1081dp(4.0f));
                this.timeHintView.show(true);
                invalidate();
                return true;
            }
            if (iM1081dp2 - iM1081dp3 <= x && x <= iM1081dp3 + iM1081dp2 && y >= 0.0f && y <= getMeasuredHeight()) {
                ...
                this.pressDx = (int) (x - iM1081dp2);
                this.timeHintView.setTime((int) ((this.videoLength / 1000.0f) * this.progressRight));
                this.timeHintView.setCx((iM1081dp2 + getLeft()) - AndroidUtilities.m1081dp(4.0f));
                this.timeHintView.show(true);
                invalidate();
                return true;
            }
            ...
            if (this.pressedLeft) {
                ...
                if (i < AndroidUtilities.m1081dp(16.0f)) {
                    iM1081dp2 = AndroidUtilities.m1081dp(16.0f);
                } else if (i <= iM1081dp2) {
                    iM1081dp2 = i;
                }
                float fM1081dp = (iM1081dp2 - AndroidUtilities.m1081dp(16.0f)) / f;
                this.progressLeft = fM1081dp;
                float f2 = this.progressRight;
                float f3 = f2 - fM1081dp;
                float f4 = this.maxProgressDiff;
                if (f3 > f4) {
                    this.progressRight = fM1081dp + f4;
                } else {
                    float f5 = this.minProgressDiff;
                    if (f5 != 0.0f && f2 - fM1081dp < f5) {
                        float f6 = f2 - f5;
                ...
                this.timeHintView.setCx((((f * this.progressLeft) + AndroidUtilities.dpf2(12.0f)) + getLeft()) - AndroidUtilities.m1081dp(4.0f));
                this.timeHintView.setTime((int) ((this.videoLength / 1000.0f) * this.progressLeft));
                this.timeHintView.show(true);
            ...
            if (this.pressedRight) {
                ...
                if (i2 >= iM1081dp) {
                    iM1081dp = i2 > AndroidUtilities.m1081dp(16.0f) + measuredWidth ? measuredWidth + AndroidUtilities.m1081dp(16.0f) : i2;
                }
                float fM1081dp2 = (iM1081dp - AndroidUtilities.m1081dp(16.0f)) / f;
                this.progressRight = fM1081dp2;
                float f7 = this.progressLeft;
                float f8 = fM1081dp2 - f7;
                float f9 = this.maxProgressDiff;
                if (f8 > f9) {
                    this.progressLeft = fM1081dp2 - f9;
                } else {
                    float f10 = this.minProgressDiff;
                    if (f10 != 0.0f && fM1081dp2 - f7 < f10) {
                        float f11 = f7 + f10;
                ...
                this.timeHintView.setCx((f * this.progressRight) + AndroidUtilities.dpf2(12.0f) + getLeft() + AndroidUtilities.m1081dp(4.0f));
                this.timeHintView.show(true);
                this.timeHintView.setTime((int) ((this.videoLength / 1000.0f) * this.progressRight));
    ...
    public void reloadFrames(int i) {
        ...
        if (i == 0) {
            if (this.isRoundFrames) {
                ...
                this.frameWidth = iM1081dp;
                this.frameHeight = iM1081dp;
                this.framesToLoad = Math.max(1, (int) Math.ceil((getMeasuredWidth() - AndroidUtilities.m1081dp(16.0f)) / (this.frameHeight / 2.0f)));
            } else {
                this.frameHeight = AndroidUtilities.m1081dp(40.0f);
                this.framesToLoad = Math.max(1, (getMeasuredWidth() - AndroidUtilities.m1081dp(16.0f)) / this.frameHeight);
                this.frameWidth = (int) Math.ceil((getMeasuredWidth() - AndroidUtilities.m1081dp(16.0f)) / this.framesToLoad);
            }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.useClip) {
            ...
            this.path.rewind();
            int measuredHeight = (getMeasuredHeight() - AndroidUtilities.m1081dp(32.0f)) >> 1;
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(0.0f, measuredHeight, getMeasuredWidth(), getMeasuredHeight() - measuredHeight);
            this.path.addRoundRect(rectF, AndroidUtilities.m1081dp(7.0f), AndroidUtilities.m1081dp(7.0f), Path.Direction.CCW);
        }
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float measuredWidth = getMeasuredWidth() - AndroidUtilities.m1081dp(24.0f);
        int iM1081dp = ((int) (this.progressLeft * measuredWidth)) + AndroidUtilities.m1081dp(12.0f);
        int iM1081dp2 = ((int) (measuredWidth * this.progressRight)) + AndroidUtilities.m1081dp(12.0f);
        int measuredHeight = (getMeasuredHeight() - AndroidUtilities.m1081dp(32.0f)) >> 1;
        ...
        if (!this.frames.isEmpty()) {
            ...
            for (int i2 = 0; i2 < this.frames.size(); i2++) {
                ...
                if (bitmap != null && !bitmap.isRecycled()) {
                    ...
                    int i4 = i3 * i;
                    if (z) {
                        this.rect2.set(i4, measuredHeight, AndroidUtilities.m1081dp(28.0f) + i4, AndroidUtilities.m1081dp(32.0f) + measuredHeight);
            ...
            canvas.drawRect(0.0f, f, iM1081dp, getMeasuredHeight() - measuredHeight, this.paint2);
            canvas.drawRect(iM1081dp2, f, getMeasuredWidth(), getMeasuredHeight() - measuredHeight, this.paint2);
            canvas.drawLine(iM1081dp - AndroidUtilities.m1081dp(4.0f), AndroidUtilities.m1081dp(10.0f) + measuredHeight, iM1081dp - AndroidUtilities.m1081dp(4.0f), (getMeasuredHeight() - AndroidUtilities.m1081dp(10.0f)) - measuredHeight, this.thumbPaint);
            canvas.drawLine(AndroidUtilities.m1081dp(4.0f) + iM1081dp2, AndroidUtilities.m1081dp(10.0f) + measuredHeight, iM1081dp2 + AndroidUtilities.m1081dp(4.0f), (getMeasuredHeight() - AndroidUtilities.m1081dp(10.0f)) - measuredHeight, this.thumbPaint);
            if (this.useClip) {
                canvas.restore();
                return;
            } else {
    ...
    private void drawCorners(Canvas canvas, int i, int i2, int i3, int i4) {
        if (AndroidUtilities.m1081dp(6.0f) != this.roundCornersSize) {
            this.roundCornersSize = AndroidUtilities.m1081dp(6.0f);
            this.roundCornerBitmap = Bitmap.createBitmap(AndroidUtilities.m1081dp(6.0f), AndroidUtilities.m1081dp(6.0f), Bitmap.Config.ARGB_8888);
    ...
    public static class TimeHintView extends View {
        ...
        public TimeHintView(Context context) {
            ...
            this.tooltipBackground = Theme.createRoundRectDrawable(AndroidUtilities.m1081dp(5.0f), Theme.getColor(Theme.key_chat_gifSaveHintBackground));
            updateColors();
            setTime(0);
        }
        ...
        @Override // android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(this.tooltipLayout.getHeight() + AndroidUtilities.m1081dp(4.0f) + this.tooltipBackgroundArrow.getIntrinsicHeight(), TLObject.FLAG_30));
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.save();
            float f6 = this.scale;
            canvas.scale(f6, f6, this.f2057cx, getMeasuredHeight());
            canvas.translate(this.f2057cx - (this.tooltipLayout.getWidth() / 2.0f), 0.0f);
            this.tooltipBackground.setBounds(-AndroidUtilities.m1081dp(8.0f), 0, this.tooltipLayout.getWidth() + AndroidUtilities.m1081dp(8.0f), (int) (this.tooltipLayout.getHeight() + AndroidUtilities.dpf2(4.0f)));
        ...
        public void updateColors() {
            ...
            this.tooltipBackground = Theme.createRoundRectDrawable(iM1081dp, Theme.getColor(i));
