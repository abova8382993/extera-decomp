...
public class SpoilerEffect2 {
    ...
    private class SpoilerThread extends Thread {
        ...
        private void init() {
            ...
            GLES20.glShaderSource(iGlCreateShader, AndroidUtilities.readRes(C2702R.raw.spoiler_vertex) + "\n// " + Math.random());
            GLES20.glCompileShader(iGlCreateShader);
            int[] iArr = new int[1];
            GLES20.glGetShaderiv(iGlCreateShader, 35713, iArr, 0);
            if (iArr[0] == 0) {
                FileLog.m1091e("SpoilerEffect2, compile vertex shader error: " + GLES20.glGetShaderInfoLog(iGlCreateShader));
                GLES20.glDeleteShader(iGlCreateShader);
                this.running = false;
                return;
            }
            GLES20.glShaderSource(iGlCreateShader2, AndroidUtilities.readRes(C2702R.raw.spoiler_fragment) + "\n// " + Math.random());
            GLES20.glCompileShader(iGlCreateShader2);
            GLES20.glGetShaderiv(iGlCreateShader2, 35713, iArr, 0);
            if (iArr[0] == 0) {
                FileLog.m1091e("SpoilerEffect2, compile fragment shader error: " + GLES20.glGetShaderInfoLog(iGlCreateShader2));
            ...
            if (iArr[0] == 0) {
                FileLog.m1091e("SpoilerEffect2, link draw program error: " + GLES20.glGetProgramInfoLog(this.drawProgram));
                this.running = false;
                return;
            }
        ...
        private void drawFrame(float f) {
            ...
            GLES20.glVertexAttribPointer(3, 1, 5126, false, 24, 20);
            GLES20.glEnableVertexAttribArray(3);
            GLES20.glUniform1f(this.timeHandle, this.f2063t);
        ...
        private void checkGlErrors() {
            while (true) {
                ...
                FileLog.m1091e("spoiler gles error " + iGlGetError);
            }
        }
    }
}
