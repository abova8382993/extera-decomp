package org.telegram.p026ui.Components.blur3.drawable;
...
import org.telegram.p026ui.Components.blur3.LiquidGlassEffect;
...
public class BlurredBackgroundDrawableRenderNode extends BlurredBackgroundDrawable {
    ...
    public BlurredBackgroundDrawableRenderNode(BlurredBackgroundSourceRenderNode blurredBackgroundSourceRenderNode) {
        ...
        RenderNode renderNodeM1086m = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1086m("BlurredNode");
        this.renderNode = renderNodeM1086m;
        this.renderNodeFill = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1086m("BlurredFill");
        renderNodeM1086m.setClipToOutline(true);
        renderNodeM1086m.setClipToBounds(true);
    ...
    @Override // org.telegram.p026ui.Components.blur3.drawable.BlurredBackgroundDrawable
    ...
    private void updateDisplayList() {
        ...
        if (liquidGlassEffect != null && Build.VERSION.SDK_INT >= 33) {
            ...
            float f9 = fArr[4];
            float f10 = fArr[6];
            int iM1081dp = props.liquidThickness;
            if (iM1081dp <= 0) {
    ...
    @Override // org.telegram.p026ui.Components.blur3.drawable.BlurredBackgroundDrawable, android.graphics.drawable.Drawable
