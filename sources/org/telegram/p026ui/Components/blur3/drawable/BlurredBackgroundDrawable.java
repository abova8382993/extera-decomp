...
import org.telegram.p026ui.Components.blur3.source.BlurredBackgroundSourceWrapped;
    ...
    */
    public static void drawStroke(android.graphics.Canvas r10, float r11, float r12, float r13, float r14, float[] r15, float r16, boolean r17, android.graphics.Paint r18) {
        ...
        L8b:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.blur3.drawable.BlurredBackgroundDrawable.drawStroke(android.graphics.Canvas, float, float, float, float, float[], float, boolean, android.graphics.Paint):void");
    }
