...
public class LiquidGlassEffect {
    ...
    public LiquidGlassEffect(RenderNode renderNode) {
        ...
        RuntimeShader runtimeShaderM1226m = LiquidGlassEffect$$ExternalSyntheticApiModelOutline0.m1226m(AndroidUtilities.readRes(C2702R.raw.liquid_glass_shader));
        this.shader = runtimeShaderM1226m;
        RenderEffect renderEffectCreateRuntimeShaderEffect = RenderEffect.createRuntimeShaderEffect(runtimeShaderM1226m, "img");
