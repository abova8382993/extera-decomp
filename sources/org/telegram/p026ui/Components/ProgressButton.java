...
public class ProgressButton extends Button {
    ...
    public ProgressButton(Context context) {
        ...
        setMinWidth(iM1081dp);
        setMinimumWidth(iM1081dp);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.drawProgress || this.progressAlpha != 0.0f) {
            this.progressRect.set(getMeasuredWidth() - AndroidUtilities.m1081dp(11.0f), AndroidUtilities.m1081dp(3.0f), r0 + AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(11.0f));
            this.progressPaint.setAlpha(Math.min(Function.USE_VARARGS, (int) (this.progressAlpha * 255.0f)));
