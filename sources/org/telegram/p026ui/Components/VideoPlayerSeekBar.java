...
public class VideoPlayerSeekBar {
    ...
    private int lineHeight = AndroidUtilities.m1081dp(4.0f);
    private int smallLineHeight = AndroidUtilities.m1081dp(2.0f);
    ...
    public VideoPlayerSeekBar(View view) {
        ...
        thumbWidth = AndroidUtilities.m1081dp(24.0f);
    ...
    public void setProgress(float f, boolean z) {
        ...
        if (z) {
            if (Math.abs(iCeil - this.thumbX) > AndroidUtilities.m1081dp(10.0f)) {
        ...
        if (Math.abs(this.animatedThumbX - this.thumbX) > AndroidUtilities.m1081dp(8.0f)) {
            this.animatedThumbX = this.thumbX;
        }
    }
        ...
        try {
            ...
            Collections.sort(this.timestamps, new Comparator() { // from class: org.telegram.ui.Components.VideoPlayerSeekBar$$ExternalSyntheticLambda0
                ...
                public final int compare(Object obj, Object obj2) {
                    return VideoPlayerSeekBar.m12333$r8$lambda$o3EHnMr9BcAI6WfiUzSrQzpwFA((Pair) obj, (Pair) obj2);
                }
            });
        } catch (Exception e) {
            FileLog.m1093e(e);
    ...
    public static /* synthetic */ int m12333$r8$lambda$o3EHnMr9BcAI6WfiUzSrQzpwFA(Pair pair, Pair pair2) {
    ...
    public void draw(Canvas canvas, View view) {
        ...
        int i = this.height;
        rectF.top = AndroidUtilities.lerp((i - this.lineHeight) / 2.0f, (i - AndroidUtilities.m1081dp(3.0f)) - this.smallLineHeight, this.transitionProgress);
        RectF rectF2 = this.rect;
        int i2 = this.height;
        rectF2.bottom = AndroidUtilities.lerp((this.lineHeight + i2) / 2.0f, i2 - AndroidUtilities.m1081dp(3.0f), this.transitionProgress);
        ...
        float fM1081dp = AndroidUtilities.m1081dp(this.pressed ? 8.0f : 6.0f);
        if (this.currentRadius != fM1081dp) {
            ...
            if (f14 < fM1081dp) {
                float fM1081dp2 = f14 + (AndroidUtilities.m1081dp(1.0f) * (j / 60.0f));
                this.currentRadius = fM1081dp2;
                if (fM1081dp2 > fM1081dp) {
                    this.currentRadius = fM1081dp;
                }
            } else {
                float fM1081dp3 = f14 - (AndroidUtilities.m1081dp(1.0f) * (j / 60.0f));
                this.currentRadius = fM1081dp3;
                if (fM1081dp3 < fM1081dp) {
                    this.currentRadius = fM1081dp;
                }
            }
    ...
    */
    private void drawProgressBar(android.graphics.Canvas r26, android.graphics.RectF r27, android.graphics.Paint r28) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.VideoPlayerSeekBar.drawProgressBar(android.graphics.Canvas, android.graphics.RectF, android.graphics.Paint):void");
    }
    ...
    private void drawTimestampLabel(Canvas canvas) {
        ...
        float fAbs = Math.abs(fLerp - f4) - AndroidUtilities.m1081dp(16.0f);
        ...
        canvas.save();
        int i2 = this.height;
        canvas.translate(fLerp + ((fLerp2 - f2) * this.transitionProgress), AndroidUtilities.lerp((this.lineHeight + i2) / f, i2 - AndroidUtilities.m1081dp(3.0f), this.transitionProgress) + AndroidUtilities.m1081dp(12.0f));
