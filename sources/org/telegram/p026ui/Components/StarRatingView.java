...
public class StarRatingView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int measuredWidth = (getMeasuredWidth() - AndroidUtilities.m1081dp(24.0f)) / 2;
        int measuredHeight = (getMeasuredHeight() - AndroidUtilities.m1081dp(24.0f)) / 2;
        canvas.save();
        canvas.translate(measuredWidth, measuredHeight);
        canvas.scale(f, f, 0.0f, AndroidUtilities.m1081dp(12.0f));
        this.drawable.setBounds(0, 0, AndroidUtilities.m1081dp(24.0f), AndroidUtilities.m1081dp(24.0f));
