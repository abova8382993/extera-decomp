...
public class StorageUsageView extends FrameLayout {
    ...
    public StorageUsageView(Context context) {
        ...
        this.cellFlickerDrawable = new CellFlickerDrawable(220, Function.USE_VARARGS);
        setWillNotDraw(false);
        this.cellFlickerDrawable.drawFrame = false;
        this.paintFill.setStrokeWidth(AndroidUtilities.m1081dp(6.0f));
        this.paintCalculcating.setStrokeWidth(AndroidUtilities.m1081dp(6.0f));
        this.paintProgress.setStrokeWidth(AndroidUtilities.m1081dp(6.0f));
        this.paintProgress2.setStrokeWidth(AndroidUtilities.m1081dp(6.0f));
        ...
        C49891 c49891 = new FrameLayout(context) { // from class: org.telegram.ui.Components.StorageUsageView.1
            C49891(Context context2) {
                super(context2);
            }
                ...
                for (int i3 = 0; i3 < childCount; i3++) {
                    if (getChildAt(i3).getVisibility() != 8) {
                        if (getChildAt(i3).getMeasuredWidth() + measuredWidth > View.MeasureSpec.getSize(i)) {
                            measuredHeight2 += getChildAt(i3).getMeasuredHeight() + AndroidUtilities.m1081dp(8.0f);
                            measuredWidth = 0;
                        }
                        measuredWidth += getChildAt(i3).getMeasuredWidth() + AndroidUtilities.m1081dp(16.0f);
                ...
                for (int i5 = 0; i5 < childCount; i5++) {
                    if (getChildAt(i5).getVisibility() != 8) {
                        if (getChildAt(i5).getMeasuredWidth() + measuredWidth > getMeasuredWidth()) {
                            measuredHeight += getChildAt(i5).getMeasuredHeight() + AndroidUtilities.m1081dp(8.0f);
                            measuredWidth = 0;
                        }
                        ...
                        measuredWidth += getChildAt(i5).getMeasuredWidth() + AndroidUtilities.m1081dp(16.0f);
                    }
                }
            }
        };
        this.legendLayout = c49891;
        linearLayout.addView(c49891, LayoutHelper.createLinear(-1, -2, 21.0f, 40.0f, 21.0f, 16.0f));
        TextView textView = new TextView(context2);
        this.calculatingTextView = textView;
        int i = Theme.key_windowBackgroundWhiteGrayText;
        textView.setTextColor(Theme.getColor(i));
        String string = LocaleController.getString("CalculatingSize", C2702R.string.CalculatingSize);
        ...
        textView2.setCompoundDrawablePadding(AndroidUtilities.m1081dp(6.0f));
        this.telegramCacheTextView.setTextColor(Theme.getColor(i));
        TextView textView3 = new TextView(context2);
        this.telegramDatabaseTextView = textView3;
        textView3.setCompoundDrawablePadding(AndroidUtilities.m1081dp(6.0f));
        this.telegramDatabaseTextView.setTextColor(Theme.getColor(i));
        TextView textView4 = new TextView(context2);
        this.freeSizeTextView = textView4;
        textView4.setCompoundDrawablePadding(AndroidUtilities.m1081dp(6.0f));
        this.freeSizeTextView.setTextColor(Theme.getColor(i));
        TextView textView5 = new TextView(context2);
        this.totlaSizeTextView = textView5;
        textView5.setCompoundDrawablePadding(AndroidUtilities.m1081dp(6.0f));
        this.totlaSizeTextView.setTextColor(Theme.getColor(i));
        this.lastProgressColor = Theme.getColor(Theme.key_player_progress);
        this.telegramCacheTextView.setCompoundDrawablesWithIntrinsicBounds(Theme.createCircleDrawable(AndroidUtilities.m1081dp(10.0f), this.lastProgressColor), (Drawable) null, (Drawable) null, (Drawable) null);
        this.telegramCacheTextView.setCompoundDrawablePadding(AndroidUtilities.m1081dp(6.0f));
        this.freeSizeTextView.setCompoundDrawablesWithIntrinsicBounds(Theme.createCircleDrawable(AndroidUtilities.m1081dp(10.0f), ColorUtils.setAlphaComponent(this.lastProgressColor, 64)), (Drawable) null, (Drawable) null, (Drawable) null);
        this.freeSizeTextView.setCompoundDrawablePadding(AndroidUtilities.m1081dp(6.0f));
        this.totlaSizeTextView.setCompoundDrawablesWithIntrinsicBounds(Theme.createCircleDrawable(AndroidUtilities.m1081dp(10.0f), ColorUtils.setAlphaComponent(this.lastProgressColor, 127)), (Drawable) null, (Drawable) null, (Drawable) null);
        this.totlaSizeTextView.setCompoundDrawablePadding(AndroidUtilities.m1081dp(6.0f));
        this.telegramDatabaseTextView.setCompoundDrawablesWithIntrinsicBounds(Theme.createCircleDrawable(AndroidUtilities.m1081dp(10.0f), this.lastProgressColor), (Drawable) null, (Drawable) null, (Drawable) null);
        this.telegramDatabaseTextView.setCompoundDrawablePadding(AndroidUtilities.m1081dp(6.0f));
    ...
    class C49891 extends FrameLayout {
        C49891(Context context2) {
            super(context2);
        }
    ...
    public void setStorageUsage(boolean z, long j, long j2, long j3, long j4) {
        ...
        this.freeSizeTextView.setText(LocaleController.formatString("TotalDeviceFreeSize", C2702R.string.TotalDeviceFreeSize, AndroidUtilities.formatFileSize(j3)));
        long j5 = j4 - j3;
        this.totlaSizeTextView.setText(LocaleController.formatString("TotalDeviceSize", C2702R.string.TotalDeviceSize, AndroidUtilities.formatFileSize(j5)));
        if (z) {
            ...
            if (j2 > 0) {
                ...
                this.telegramDatabaseTextView.setVisibility(8);
                this.textSettingsCell.setTextAndValue(LocaleController.getString(C2702R.string.ClearTelegramCache), AndroidUtilities.formatFileSize(j2), true);
                this.telegramCacheTextView.setText(LocaleController.formatString("TelegramCacheSize", C2702R.string.TelegramCacheSize, AndroidUtilities.formatFileSize(j2 + j)));
            } else {
                this.telegramCacheTextView.setVisibility(8);
                this.telegramDatabaseTextView.setVisibility(0);
                this.telegramDatabaseTextView.setText(LocaleController.formatString("LocalDatabaseSize", C2702R.string.LocalDatabaseSize, AndroidUtilities.formatFileSize(j)));
                this.divider.setVisibility(8);
                this.textSettingsCell.setVisibility(8);
            }
    ...
    private class ProgressView extends View {
        ...
        @Override // android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(40.0f), TLObject.FLAG_30));
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            StorageUsageView.this.paintProgress.setAlpha(Function.USE_VARARGS);
            ...
            canvas.drawLine(AndroidUtilities.m1081dp(24.0f), AndroidUtilities.m1081dp(20.0f), getMeasuredWidth() - AndroidUtilities.m1081dp(24.0f), AndroidUtilities.m1081dp(20.0f), StorageUsageView.this.paintFill);
            if (StorageUsageView.this.calculating || StorageUsageView.this.calculatingProgress != 0.0f) {
                ...
                rectF.set(AndroidUtilities.m1081dp(24.0f), AndroidUtilities.m1081dp(17.0f), getMeasuredWidth() - AndroidUtilities.m1081dp(24.0f), AndroidUtilities.m1081dp(23.0f));
                StorageUsageView.this.cellFlickerDrawable.setParentWidth(getMeasuredWidth());
                StorageUsageView.this.cellFlickerDrawable.draw(canvas, rectF, AndroidUtilities.m1081dp(3.0f), null);
            }
            int iM1081dp = AndroidUtilities.m1081dp(24.0f);
            if (!StorageUsageView.this.calculating) {
                int iM1081dp2 = AndroidUtilities.m1081dp(24.0f) + ((int) ((getMeasuredWidth() - (AndroidUtilities.m1081dp(24.0f) * 2)) * StorageUsageView.this.progress2));
                canvas.drawLine(iM1081dp, AndroidUtilities.m1081dp(20.0f), AndroidUtilities.m1081dp(24.0f) + r3, AndroidUtilities.m1081dp(20.0f), StorageUsageView.this.paintProgress2);
                canvas.drawRect(iM1081dp2, AndroidUtilities.m1081dp(20.0f) - AndroidUtilities.m1081dp(3.0f), iM1081dp2 + AndroidUtilities.m1081dp(3.0f), AndroidUtilities.m1081dp(20.0f) + AndroidUtilities.m1081dp(3.0f), StorageUsageView.this.bgPaint);
            }
            if (StorageUsageView.this.calculating) {
                return;
            }
            int measuredWidth = (int) ((getMeasuredWidth() - (AndroidUtilities.m1081dp(24.0f) * 2)) * StorageUsageView.this.progress);
            if (measuredWidth < AndroidUtilities.m1081dp(1.0f)) {
                measuredWidth = AndroidUtilities.m1081dp(1.0f);
            }
            int iM1081dp3 = AndroidUtilities.m1081dp(24.0f) + measuredWidth;
            canvas.drawLine(iM1081dp, AndroidUtilities.m1081dp(20.0f), AndroidUtilities.m1081dp(24.0f) + measuredWidth, AndroidUtilities.m1081dp(20.0f), StorageUsageView.this.paintProgress);
            canvas.drawRect(iM1081dp3, AndroidUtilities.m1081dp(20.0f) - AndroidUtilities.m1081dp(3.0f), iM1081dp3 + AndroidUtilities.m1081dp(3.0f), AndroidUtilities.m1081dp(20.0f) + AndroidUtilities.m1081dp(3.0f), StorageUsageView.this.bgPaint);
        }
    }
