...
import org.telegram.p026ui.Adapters.StickersSearchAdapter;
...
public class TrendingStickersLayout extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public TrendingStickersLayout(Context context, final Delegate delegate, TLRPC.StickerSetCovered[] stickerSetCoveredArr, LongSparseArray longSparseArray, LongSparseArray longSparseArray2, TLRPC.StickerSetCovered stickerSetCovered, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.searchAdapter = new StickersSearchAdapter(context, new StickersSearchAdapter.Delegate() { // from class: org.telegram.ui.Components.TrendingStickersLayout.1
            ...
            public void setAdapterVisible(boolean z) {
                ...
                if (TrendingStickersLayout.this.listView.getAdapter().getItemCount() > 0) {
                    TrendingStickersLayout.this.layoutManager.scrollToPositionWithOffset(0, (-TrendingStickersLayout.this.listView.getPaddingTop()) + AndroidUtilities.m1081dp(58.0f) + TrendingStickersLayout.this.topOffset, false);
                }
            }
        ...
        searchField.setHint(LocaleController.getString(C2702R.string.SearchTrendingStickersHint));
        ...
        RecyclerListView recyclerListView = new RecyclerListView(context) { // from class: org.telegram.ui.Components.TrendingStickersLayout.3
            ...
            protected boolean allowSelectChildAtPosition(float f, float f2) {
                return f2 >= ((float) (TrendingStickersLayout.this.topOffset + AndroidUtilities.m1081dp(58.0f)));
            }
        };
        ...
        FillLastGridLayoutManager fillLastGridLayoutManager = new FillLastGridLayoutManager(context, 5, AndroidUtilities.m1081dp(58.0f), recyclerListView) { // from class: org.telegram.ui.Components.TrendingStickersLayout.4
            ...
            @Override // org.telegram.p026ui.Components.FillLastGridLayoutManager
            ...
            public int scrollVerticallyBy(int i2, RecyclerView.Recycler recycler, RecyclerView.State state) {
                ...
                if (trendingStickersLayout.gluedToTop) {
                    ...
                    if (i3 == 0 && (viewFindViewByPosition = TrendingStickersLayout.this.layoutManager.findViewByPosition(i3)) != null && viewFindViewByPosition.getTop() - i2 > AndroidUtilities.m1081dp(58.0f)) {
                        i2 = viewFindViewByPosition.getTop() - AndroidUtilities.m1081dp(58.0f);
                    }
                }
                return super.scrollVerticallyBy(i2, recycler, state);
            }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        this.layoutManager.scrollToPositionWithOffset(num.intValue(), (-this.listView.getPaddingTop()) + AndroidUtilities.m1081dp(58.0f));
    }
    ...
    */
    protected void dispatchDraw(android.graphics.Canvas r11) {
        ...
        L1b:
            ...
            java.util.HashMap r0 = org.telegram.ui.Components.TrendingStickersLayout.TrendingStickersAdapter.m12298$$Nest$fgetsetsToPosition(r0)
        ...
        L6f:
            ...
            int r1 = org.telegram.p026ui.ActionBar.Theme.key_featuredStickers_addButton
        ...
        L9e:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.TrendingStickersLayout.dispatchDraw(android.graphics.Canvas):void");
    }
            ...
            public void onStickerSetInstalled() {
                if (TrendingStickersLayout.this.listView.getAdapter() == TrendingStickersLayout.this.adapter) {
                    for (int i = 0; i < TrendingStickersLayout.this.adapter.sets.size(); i++) {
                        ...
                        if (stickerSetCovered.set.f1646id == inputStickerSet.f1635id) {
    ...
    public void setContentViewPaddingTop(int i) {
        int iM1081dp = i + AndroidUtilities.m1081dp(58.0f);
        if (this.listView.getPaddingTop() != iM1081dp) {
            this.ignoreLayout = true;
            this.listView.setPadding(0, iM1081dp, 0, 0);
    ...
    public boolean update() {
        ...
        int top = childAt.getTop() - AndroidUtilities.m1081dp(58.0f);
        ...
        this.topOffset = i2;
        this.listView.setTopGlowOffset(i2 + AndroidUtilities.m1081dp(58.0f));
        this.searchLayout.setTranslationY(this.topOffset);
        this.shadowView.setTranslationY(this.topOffset);
        return true;
    }
        ...
        if (z) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.TrendingStickersLayout.9
                ...
                public void onAnimationUpdate(ValueAnimator valueAnimator) {
                    ...
                    TrendingStickersLayout.this.listView.scrollBy(0, iFloatValue - this.f2055dy);
                    TrendingStickersLayout.this.scrollFromAnimator = false;
                    this.f2055dy = iFloatValue;
                }
            });
    ...
    class TrendingStickersAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public /* synthetic */ void lambda$onCreateViewHolder$0(View view) {
            ...
            if (TrendingStickersLayout.this.installingStickerSets.indexOfKey(stickerSet.set.f1646id) >= 0 || TrendingStickersLayout.this.removingStickerSets.indexOfKey(stickerSet.set.f1646id) >= 0) {
                return;
            }
            if (featuredStickerSetInfoCell.isInstalled()) {
                TrendingStickersLayout.this.removingStickerSets.put(stickerSet.set.f1646id, stickerSet);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (itemViewType != 2) {
                    if (itemViewType == 4) {
                        ((GraySectionCell) viewHolder.itemView).setText(LocaleController.getString(C2702R.string.OtherStickers));
                        return;
        ...
        */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:27:0x0083, code lost:
            ...
            if ((r8 instanceof org.telegram.p026ui.Cells.FeaturedStickerSetCell2) == false) goto L29;
         */
        /* JADX WARN: Code restructure failed: missing block: B:28:0x0085, code lost:
        
            ((org.telegram.p026ui.Cells.FeaturedStickerSetCell2) r8).setDrawProgress(true, true);
         */
        /* JADX WARN: Code restructure failed: missing block: B:30:0x008e, code lost:
        
            if ((r8 instanceof org.telegram.p026ui.Cells.FeaturedStickerSetInfoCell) == false) goto L32;
         */
        /* JADX WARN: Code restructure failed: missing block: B:31:0x0090, code lost:
        
            ((org.telegram.p026ui.Cells.FeaturedStickerSetInfoCell) r8).setAddDrawProgress(true, true);
         */
        /* JADX WARN: Code restructure failed: missing block: B:32:0x0096, code lost:
        
            r6.this$0.installingStickerSets.put(r7.set.f1646id, r7);
         */
        ...
        /* JADX WARN: Code restructure failed: missing block: B:41:0x00cc, code lost:
            ...
            if (r2.set.f1646id != r7.set.f1646id) goto L56;
         */
        ...
        */
        ...
        public void refreshStickerSets() {
            ...
            if (measuredWidth != 0) {
                this.stickersPerRow = Math.max(5, measuredWidth / AndroidUtilities.m1081dp(72.0f));
