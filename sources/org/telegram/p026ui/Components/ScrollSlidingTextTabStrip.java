...
public class ScrollSlidingTextTabStrip extends HorizontalScrollView {
    ...
    public ScrollSlidingTextTabStrip(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        C47652 c47652 = new C47652(context);
        this.tabsContainer = c47652;
        c47652.setOrientation(0);
        c47652.setPadding(AndroidUtilities.m1081dp(7.0f), 0, AndroidUtilities.m1081dp(7.0f), 0);
        c47652.setLayoutParams(new FrameLayout.LayoutParams(-1, -1));
        addView(c47652);
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.ScrollSlidingTextTabStrip$2 */
    class C47652 extends LinearLayout {

        /* JADX INFO: renamed from: sx */
        private float f2018sx;

        /* JADX INFO: renamed from: sy */
        private float f2019sy;

        C47652(Context context) {
            super(context);
        }
        ...
        public boolean dispatchTouchEvent(MotionEvent motionEvent) {
            ...
            if (motionEvent.getAction() == 0) {
                ...
                if (ScrollSlidingTextTabStrip.this.dragging != null && getParent() != null) {
                    ...
                    this.f2018sx = motionEvent.getX();
                    this.f2019sy = motionEvent.getY();
                    getParent().requestDisallowInterceptTouchEvent(true);
                }
            } else {
                if (motionEvent.getAction() == 2) {
                    if (ScrollSlidingTextTabStrip.this.dragging != null) {
                        ScrollSlidingTextTabStrip.this.dragging.setTranslationX(motionEvent.getX() - this.f2018sx);
                        ...
                        if (motionEvent.getX() < AndroidUtilities.m1081dp(16.0f)) {
                            ScrollSlidingTextTabStrip.this.scrollBy(-AndroidUtilities.m1081dp(1.0f), 0);
                        } else if (motionEvent.getX() >= getWidth() - AndroidUtilities.m1081dp(16.0f)) {
                            ScrollSlidingTextTabStrip.this.scrollBy(AndroidUtilities.m1081dp(1.0f), 0);
                        }
                        ...
                        if (iFindPosition != iIndexOfChild && ScrollSlidingTextTabStrip.this.delegate.canReorder(ScrollSlidingTextTabStrip.this.positionToId.get(iFindPosition))) {
                            ...
                            if (childAt.getLeft() > ScrollSlidingTextTabStrip.this.dragging.getLeft()) {
                                this.f2018sx += ((childAt.getLeft() + childAt.getWidth()) - ScrollSlidingTextTabStrip.this.dragging.getWidth()) - ScrollSlidingTextTabStrip.this.dragging.getLeft();
                            } else {
                                this.f2018sx += childAt.getLeft() - ScrollSlidingTextTabStrip.this.dragging.getLeft();
                            }
                            ScrollSlidingTextTabStrip.this.dragging.setTranslationX(motionEvent.getX() - this.f2018sx);
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (view == this.tabsContainer) {
            ...
            this.selectorDrawable.setBounds((int) translationX, measuredHeight - AndroidUtilities.dpr(4.0f), (int) translationX2, measuredHeight);
    ...
    protected void onMeasure(int i, int i2) {
        int size = View.MeasureSpec.getSize(i) - AndroidUtilities.m1081dp(22.0f);
        int childCount = this.tabsContainer.getChildCount();
    ...
    public void scrollToChild(int i, boolean z) {
        ...
        if (left - AndroidUtilities.m1081dp(50.0f) < scrollX) {
            if (z) {
                smoothScrollTo(left - AndroidUtilities.m1081dp(50.0f), 0);
                return;
            } else {
                scrollTo(left - AndroidUtilities.m1081dp(50.0f), 0);
                return;
            }
        }
        int i2 = left + measuredWidth;
        if (AndroidUtilities.m1081dp(21.0f) + i2 > scrollX + getWidth()) {
            if (z) {
                smoothScrollTo(i2, 0);
            } else {
                scrollTo(i2, 0);
    ...
    private int getChildWidth(TextView textView) {
        if (textView.getLayout() != null) {
            return ((int) Math.ceil(r0.getLineWidth(0))) + AndroidUtilities.m1081dp(2.0f);
        }
