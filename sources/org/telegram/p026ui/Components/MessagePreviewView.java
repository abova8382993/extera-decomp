...
public abstract class MessagePreviewView extends FrameLayout implements ForwardContext {
    ...
    class Page extends FrameLayout {
        ...
        */
        ...
        class C43827 extends ChatListItemAnimator {
            Runnable finishRunnable;
            int scrollAnimationIndex;
            final /* synthetic */ MessagePreviewView val$this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C43827(ChatActivity chatActivity, RecyclerListView recyclerListView, Theme.ResourcesProvider resourcesProvider, MessagePreviewView messagePreviewView) {
        ...
        class C437110 extends GridLayoutManagerFixed {
            final /* synthetic */ MessagePreviewView val$this$0;
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C437110(Context context, int i, int i2, boolean z, MessagePreviewView messagePreviewView) {
        ...
        public void showQuoteLengthError() {
            MessagePreviewView messagePreviewView = MessagePreviewView.this;
            BulletinFactory.m1194of(messagePreviewView, messagePreviewView.resourcesProvider).createSimpleBulletin(C2702R.raw.error, LocaleController.getString(C2702R.string.QuoteMaxError), LocaleController.getString(C2702R.string.QuoteMaxErrorMessage)).show();
        }
        ...
        public void updateSubtitle(boolean z) {
            ...
            if (i != 1) {
                if (i != 0) {
                    if (i == 2) {
                        this.actionBar.setTitle(LocaleController.getString(C2702R.string.MessageOptionsLinkTitle), z);
                        this.actionBar.setSubtitle(LocaleController.getString(C2702R.string.MessageOptionsLinkSubtitle), z);
                        return;
                    }
                    return;
                }
                ...
                if (messagePreviewParams.quote != null && messagePreviewParams.replyMessage.hasText) {
                    this.actionBar.setTitle(LocaleController.getString(C2702R.string.PreviewQuoteUpdate), z);
                    this.actionBar.setSubtitle(LocaleController.getString(C2702R.string.PreviewQuoteUpdateSubtitle), z);
                    return;
                } else {
                    this.actionBar.setTitle(LocaleController.getString(C2702R.string.MessageOptionsReplyTitle), z);
                    this.actionBar.setSubtitle(MessagePreviewView.this.messagePreviewParams.replyMessage.hasText ? LocaleController.getString(C2702R.string.MessageOptionsReplySubtitle) : _UrlKt.FRAGMENT_ENCODE_SET, z);
                    return;
                }
            }
            ...
            if (!messagePreviewParams2.hasSenders) {
                if (messagePreviewParams2.willSeeSenders) {
                    ...
                    if (user != null) {
                        string = LocaleController.formatString("ForwardPreviewSendersNameVisible", C2702R.string.ForwardPreviewSendersNameVisible, ContactsController.formatName(user.first_name, user.last_name));
                    } else if (ChatObject.isChannel(messagePreviewView.currentChat) && !MessagePreviewView.this.currentChat.megagroup) {
                        string = LocaleController.getString(C2702R.string.ForwardPreviewSendersNameVisibleChannel);
                    } else {
                        string = LocaleController.getString(C2702R.string.ForwardPreviewSendersNameVisibleGroup);
                    }
                } else {
                    TLRPC.User user2 = messagePreviewView.currentUser;
                    if (user2 != null) {
                        string = LocaleController.formatString("ForwardPreviewSendersNameVisible", C2702R.string.ForwardPreviewSendersNameVisible, ContactsController.formatName(user2.first_name, user2.last_name));
                    } else if (ChatObject.isChannel(messagePreviewView.currentChat) && !MessagePreviewView.this.currentChat.megagroup) {
                        string = LocaleController.getString(C2702R.string.ForwardPreviewSendersNameHiddenChannel);
                    } else {
                        string = LocaleController.getString(C2702R.string.ForwardPreviewSendersNameHiddenGroup);
                    }
                }
            } else if (!messagePreviewParams2.hideForwardSendersName) {
                TLRPC.User user3 = messagePreviewView.currentUser;
                if (user3 != null) {
                    string = LocaleController.formatString("ForwardPreviewSendersNameVisible", C2702R.string.ForwardPreviewSendersNameVisible, ContactsController.formatName(user3.first_name, user3.last_name));
                } else if (ChatObject.isChannel(messagePreviewView.currentChat) && !MessagePreviewView.this.currentChat.megagroup) {
                    string = LocaleController.getString(C2702R.string.ForwardPreviewSendersNameVisibleChannel);
                } else {
                    string = LocaleController.getString(C2702R.string.ForwardPreviewSendersNameVisibleGroup);
                ...
                if (user4 != null) {
                    string = LocaleController.formatString("ForwardPreviewSendersNameHidden", C2702R.string.ForwardPreviewSendersNameHidden, ContactsController.formatName(user4.first_name, user4.last_name));
                } else if (ChatObject.isChannel(messagePreviewView.currentChat) && !MessagePreviewView.this.currentChat.megagroup) {
                    string = LocaleController.getString(C2702R.string.ForwardPreviewSendersNameHiddenChannel);
                } else {
                    string = LocaleController.getString(C2702R.string.ForwardPreviewSendersNameHiddenGroup);
        ...
        protected void onMeasure(int i, int i2) {
            ...
            ((ViewGroup.MarginLayoutParams) this.chatListView.getLayoutParams()).topMargin = org.telegram.p026ui.ActionBar.ActionBar.getCurrentActionBarHeight();
            if (MessagePreviewView.this.isLandscapeMode) {
                this.chatPreviewContainer.getLayoutParams().height = -1;
                ((ViewGroup.MarginLayoutParams) this.chatPreviewContainer.getLayoutParams()).topMargin = AndroidUtilities.m1081dp(8.0f);
                ((ViewGroup.MarginLayoutParams) this.chatPreviewContainer.getLayoutParams()).bottomMargin = AndroidUtilities.m1081dp(8.0f);
                this.chatPreviewContainer.getLayoutParams().width = (int) Math.min(View.MeasureSpec.getSize(i), Math.max(AndroidUtilities.m1081dp(340.0f), View.MeasureSpec.getSize(i) * 0.6f));
                ...
                this.chatPreviewContainer.getLayoutParams().height = (View.MeasureSpec.getSize(i2) - AndroidUtilities.m1081dp(6.0f)) - this.buttonsHeight;
            ...
            if (this.lastSize != size) {
                for (int i4 = 0; i4 < this.messages.previewMessages.size(); i4++) {
                    if (MessagePreviewView.this.isLandscapeMode) {
                        ...
                        this.messages.previewMessages.get(i4).parentWidth = View.MeasureSpec.getSize(i) - AndroidUtilities.m1081dp(16.0f);
                    }
        ...
        public void updatePositions() {
            ...
            if (!MessagePreviewView.this.isLandscapeMode) {
                ...
                if (messages == null || i2 == 0 || i2 > messages.previewMessages.size()) {
                    ...
                    int iMax = Math.max(0, measuredHeight - AndroidUtilities.m1081dp(4.0f));
                    this.chatTopOffset = iMax;
                    this.chatTopOffset = Math.min((iMax + (this.chatListView.getMeasuredHeight() - this.chatTopOffset)) - ((int) ((((AndroidUtilities.displaySize.y - (Build.VERSION.SDK_INT >= 35 ? AndroidUtilities.navigationBarHeight : 0)) * 0.8f) - this.buttonsHeight) - AndroidUtilities.m1081dp(8.0f))), this.chatTopOffset);
                }
                float fM1081dp = (AndroidUtilities.m1081dp(8.0f) + (((getMeasuredHeight() - AndroidUtilities.m1081dp(16.0f)) - ((this.buttonsHeight - AndroidUtilities.m1081dp(8.0f)) + (this.chatPreviewContainer.getMeasuredHeight() - this.chatTopOffset))) / 2.0f)) - this.chatTopOffset;
                this.yOffset = fM1081dp;
                if (fM1081dp > AndroidUtilities.m1081dp(8.0f)) {
                    this.yOffset = AndroidUtilities.m1081dp(8.0f);
                }
                this.menu.setTranslationX(getMeasuredWidth() - this.menu.getMeasuredWidth());
            } else {
                this.yOffset = 0.0f;
                this.chatTopOffset = 0;
                this.menu.setTranslationX(this.chatListView.getMeasuredWidth() + AndroidUtilities.m1081dp(8.0f));
            }
        ...
        public void setOffset(float f, int i) {
            if (MessagePreviewView.this.isLandscapeMode) {
                ...
                this.menu.setTranslationY((f + this.chatPreviewContainer.getMeasuredHeight()) - AndroidUtilities.m1081dp(2.0f));
            }
        ...
        private class Adapter extends RecyclerView.Adapter {
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
                ...
                ChatMessageCell chatMessageCell = new ChatMessageCell(context, i2, false, page.sharedResources, MessagePreviewView.this.resourcesProvider) { // from class: org.telegram.ui.Components.MessagePreviewView.Page.Adapter.1
                    @Override // org.telegram.p026ui.Cells.ChatMessageCell, org.telegram.p026ui.Cells.BaseCell, android.view.View
            ...
            private int offset(ChatMessageCell chatMessageCell, int i) {
                ...
                if (!TextUtils.isEmpty(messageObject.caption) && (textLayoutBlocks = chatMessageCell.captionLayout) != null) {
                    ...
                    iM1081dp = chatMessageCell.textY;
                    CharSequence charSequence2 = messageObject.messageText;
                    ArrayList<MessageObject.TextLayoutBlock> arrayList2 = messageObject.textLayoutBlocks;
                    if (chatMessageCell.linkPreviewAbove) {
                        iM1081dp += chatMessageCell.linkPreviewHeight + AndroidUtilities.m1081dp(10.0f);
                    }
                    ...
                    for (int i2 = 0; i2 < arrayList.size(); i2++) {
                        ...
                        if (i > i3) {
                            if (i - i3 > string.length() - 1) {
                                lineTop = iM1081dp + ((int) (textLayoutBlock.textYOffset(arrayList, chatMessageCell.transitionParams) + textLayoutBlock.padTop + textLayoutBlock.height));
                            } else {
                                lineTop = r6.getLineTop(r6.getLineForOffset(i - textLayoutBlock.charactersOffset)) + iM1081dp + textLayoutBlock.textYOffset(arrayList, chatMessageCell.transitionParams) + textLayoutBlock.padTop;
                            }
                            return (int) lineTop;
                        }
                    }
    ...
    public MessagePreviewView(final Context context, ChatActivity chatActivity, MessagePreviewParams messagePreviewParams, TLRPC.User user, TLRPC.Chat chat, int i, ResourcesDelegate resourcesDelegate, int i2, final boolean z) {
        ...
        this.viewPager = new ViewPagerFixed(context, resourcesDelegate) { // from class: org.telegram.ui.Components.MessagePreviewView.2
            ...
            @Override // org.telegram.p026ui.Components.ViewPagerFixed, android.view.View
        ...
        for (int i3 = 0; i3 < 3; i3++) {
            if (i3 == 0 && messagePreviewParams.replyMessage != null) {
                this.tabsView.addTab(0, LocaleController.getString(C2702R.string.MessageOptionsReply));
            } else if (i3 == 1 && messagePreviewParams.forwardMessages != null && !z) {
                this.tabsView.addTab(1, LocaleController.getString(C2702R.string.MessageOptionsForward));
            } else if (i3 == 2 && messagePreviewParams.linkMessage != null && !z) {
                this.tabsView.addTab(2, LocaleController.getString(C2702R.string.MessageOptionsLink));
            }
            if (i3 == i2) {
        ...
        this.viewPager.setAdapter(new ViewPagerFixed.Adapter() { // from class: org.telegram.ui.Components.MessagePreviewView.3
            ...
            public int getItemViewType(int i4) {
                return ((TabsView.Tab) MessagePreviewView.this.tabsView.tabs.get(i4)).f1928id;
            }
    ...
    public /* synthetic */ void lambda$new$0(Integer num) {
        if (((TabsView.Tab) this.tabsView.tabs.get(this.viewPager.getCurrentPosition())).f1928id == num.intValue()) {
            return;
        }
        int i = 0;
        int i2 = 0;
        while (true) {
            ...
            if (((TabsView.Tab) this.tabsView.tabs.get(i2)).f1928id == num.intValue()) {
                i = i2;
                break;
            }
            i2++;
    ...
    public static class TabsView extends View {
        ...
        public TabsView(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            this.bgPaint = paint;
            this.tabInnerPadding = AndroidUtilities.m1081dp(12.0f);
            this.marginBetween = AndroidUtilities.m1081dp(13.0f);
        ...
        protected void onMeasure(int i, int i2) {
            ...
            float fM1081dp = (measuredHeight - AndroidUtilities.m1081dp(26.0f)) / 2.0f;
            float fM1081dp2 = (measuredHeight + AndroidUtilities.m1081dp(26.0f)) / 2.0f;
            ...
            for (int i4 = 0; i4 < this.tabs.size(); i4++) {
                ...
                ((Tab) this.tabs.get(i4)).bounds.set(f, fM1081dp, f + width2, fM1081dp2);
                ((Tab) this.tabs.get(i4)).clickBounds.set(((Tab) this.tabs.get(i4)).bounds);
                ((Tab) this.tabs.get(i4)).clickBounds.inset((-this.marginBetween) / 2.0f, -fM1081dp);
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            if (z || z2) {
                canvas.drawRoundRect(this.selectRect, AndroidUtilities.m1081dp(13.0f), AndroidUtilities.m1081dp(13.0f), this.bgPaint);
            }
        ...
        private int getHitTab(float f, float f2) {
            for (int i = 0; i < this.tabs.size(); i++) {
                if (((Tab) this.tabs.get(i)).clickBounds.contains(f, f2)) {
                    return ((Tab) this.tabs.get(i)).f1928id;
                }
            }
            return -1;
        }
    ...
    private class ActionBar extends FrameLayout {
        ...
        public ActionBar(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            animatedTextDrawable2.setTextSize(AndroidUtilities.m1081dp(14.0f));
        ...
        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(56.0f), TLObject.FLAG_30));
            setPadding(AndroidUtilities.m1081dp(18.0f), 0, AndroidUtilities.m1081dp(18.0f), 0);
        }
        ...
        private void setBounds(Drawable drawable, float f) {
            int i = (int) f;
            drawable.setBounds(getPaddingLeft(), i - AndroidUtilities.m1081dp(32.0f), getMeasuredWidth() - getPaddingRight(), i + AndroidUtilities.m1081dp(32.0f));
        }

        @Override // android.view.ViewGroup, android.view.View
        protected void dispatchDraw(Canvas canvas) {
            setBounds(this.title, AndroidUtilities.lerp(AndroidUtilities.m1081dp(29.0f), AndroidUtilities.m1081dp(18.83f), this.subtitle.isNotEmpty()));
            this.title.draw(canvas);
            setBounds(this.subtitle, AndroidUtilities.m1081dp(39.5f));
    ...
    public static class ToggleButton extends View {
        ...
        public ToggleButton(Context context, int i, String str, int i2, String str2, Theme.ResourcesProvider resourcesProvider) {
            ...
            this.textDrawable.setTextSize(AndroidUtilities.m1081dp(16.0f));
            ...
            int iM1081dp = (int) (AndroidUtilities.m1081dp(77.0f) + Math.max(this.textDrawable.getPaint().measureText(str), this.textDrawable.getPaint().measureText(str2)));
            this.minWidth = iM1081dp;
            this.textDrawable.setOverrideFullWidth(iM1081dp);
        ...
        protected void dispatchDraw(Canvas canvas) {
            if (LocaleController.isRTL) {
                this.iconDrawable.setBounds(getMeasuredWidth() - AndroidUtilities.m1081dp(41.0f), (getMeasuredHeight() - AndroidUtilities.m1081dp(24.0f)) / 2, getMeasuredWidth() - AndroidUtilities.m1081dp(17.0f), (getMeasuredHeight() + AndroidUtilities.m1081dp(24.0f)) / 2);
                this.textDrawable.setBounds(0, 0, getMeasuredWidth() - AndroidUtilities.m1081dp(59.0f), getMeasuredHeight());
            } else {
                this.iconDrawable.setBounds(AndroidUtilities.m1081dp(17.0f), (getMeasuredHeight() - AndroidUtilities.m1081dp(24.0f)) / 2, AndroidUtilities.m1081dp(41.0f), (getMeasuredHeight() + AndroidUtilities.m1081dp(24.0f)) / 2);
                this.textDrawable.setBounds(AndroidUtilities.m1081dp(59.0f), 0, getMeasuredWidth(), getMeasuredHeight());
            }
        ...
        protected void onMeasure(int i, int i2) {
            ...
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(iMin, mode), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(48.0f), TLObject.FLAG_30));
        }
    ...
    private static class RLottieToggleDrawable extends Drawable {
        ...
        public RLottieToggleDrawable(View view, int i, int i2) {
            RLottieDrawable rLottieDrawable = new RLottieDrawable(i, _UrlKt.FRAGMENT_ENCODE_SET + i, AndroidUtilities.m1081dp(24.0f), AndroidUtilities.m1081dp(24.0f));
            ...
            RLottieDrawable rLottieDrawable2 = new RLottieDrawable(i2, _UrlKt.FRAGMENT_ENCODE_SET + i2, AndroidUtilities.m1081dp(24.0f), AndroidUtilities.m1081dp(24.0f));
        ...
        public void draw(Canvas canvas) {
            ...
            rect.set(getBounds().centerX() - AndroidUtilities.m1081dp(12.0f), getBounds().centerY() - AndroidUtilities.m1081dp(12.0f), getBounds().centerX() + AndroidUtilities.m1081dp(12.0f), getBounds().centerY() + AndroidUtilities.m1081dp(12.0f));
