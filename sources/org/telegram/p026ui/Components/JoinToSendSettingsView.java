...
public class JoinToSendSettingsView extends LinearLayout {
    ...
    public JoinToSendSettingsView(Context context, TLRPC.Chat chat) {
        ...
        headerCell.setText(LocaleController.getString(C2702R.string.ChannelSettingsJoinTitle));
        ...
        String string = LocaleController.getString(C2702R.string.ChannelSettingsJoinToSend);
        ...
        textCheckCell2.setTextAndCheck(LocaleController.getString(C2702R.string.ChannelSettingsJoinRequest), this.isJoinRequest, false);
        ...
        textInfoPrivacyCell.setText(LocaleController.getString(C2702R.string.ChannelSettingsJoinToSendInfo));
        ...
        textInfoPrivacyCell2.setText(LocaleController.getString(C2702R.string.ChannelSettingsJoinRequestInfo));
    ...
    private void updateToggleValue(float f) {
        ...
        float f2 = 1.0f - f;
        this.joinRequestCell.setTranslationY((-AndroidUtilities.m1081dp(16.0f)) * f2);
        this.joinRequestCell.setScaleY(1.0f - (0.1f * f2));
        int iM1081dp = this.joinRequestCell.getMeasuredHeight() <= 0 ? AndroidUtilities.m1081dp(50.0f) : this.joinRequestCell.getMeasuredHeight();
        this.joinToSendInfoCell.setAlpha(f2);
        float f3 = (-iM1081dp) * f2;
        this.joinToSendInfoCell.setTranslationY(((-AndroidUtilities.m1081dp(4.0f)) * f) + f3);
        this.joinRequestInfoCell.setAlpha(f);
        this.joinRequestInfoCell.setTranslationY(f3 + (AndroidUtilities.m1081dp(4.0f) * f2));
        requestLayout();
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.joinRequestCell.getVisibility() == 0) {
            iM1081dp = iLayoutChild + layoutChild(this.joinRequestCell, iLayoutChild, i5);
        } else {
            ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) this.joinRequestCell.getLayoutParams();
            iM1081dp = iLayoutChild + AndroidUtilities.m1081dp(50.0f) + marginLayoutParams.topMargin + marginLayoutParams.bottomMargin;
        }
        layoutChild(this.joinToSendInfoCell, iM1081dp, i5);
        layoutChild(this.joinRequestInfoCell, iM1081dp, i5);
    }
