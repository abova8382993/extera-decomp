...
public class FolderDrawable extends Drawable {
    ...
    public FolderDrawable(Context context, int i, int i2) {
        ...
        if (i2 >= 0) {
            ...
            paint.setPathEffect(new CornerPathEffect(AndroidUtilities.m1081dp(1.0f)));
            ...
            paint2.setPathEffect(new CornerPathEffect(AndroidUtilities.m1081dp(1.0f)));
            return;
        }
        this.path = null;
    ...
    public void draw(Canvas canvas) {
        ...
        if (path != null) {
            if (this.pathInvalidated) {
                path.rewind();
                this.path.moveTo(m1206x(0.4871f), m1207y(0.6025f));
                this.path.lineTo(m1206x(0.8974f), m1207y(0.6025f));
                this.path.lineTo(m1206x(1.0f), m1207y(0.7564f));
                this.path.lineTo(m1206x(0.8974f), m1207y(0.9102f));
                this.path.lineTo(m1206x(0.4871f), m1207y(0.9102f));
                this.path.close();
                this.pathInvalidated = false;
                this.strokePaint.setStrokeWidth(AndroidUtilities.m1081dp(3.0f));
            }
