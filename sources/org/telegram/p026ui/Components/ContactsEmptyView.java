...
public class ContactsEmptyView extends LinearLayout {
    ...
    public ContactsEmptyView(Context context) {
        ...
        textView.setText(LocaleController.getString(C2702R.string.NoContactsYet3));
        ...
        textView2.setText(LocaleController.getString(C2702R.string.NoContactsYet3Sub));
        ...
        spannableStringBuilder.setSpan(new ColoredImageSpan(C2702R.drawable.filled_new_contact_24), 0, 1, 33);
        spannableStringBuilder.append((CharSequence) "  ").append((CharSequence) LocaleController.getString(C2702R.string.NewContact));
        buttonWithCounterView.setText(spannableStringBuilder, false);
        addView(buttonWithCounterView, LayoutHelper.createLinear(-2, 44, 49));
    }

    private void setSticker() {
        this.stickerView.setImageDrawable(new RLottieDrawable(C2702R.raw.utyan_empty, "utyan_empty", AndroidUtilities.m1081dp(110.0f), AndroidUtilities.m1081dp(110.0f)));
    }
