...
import org.telegram.p026ui.Adapters.MessagesSearchAdapter;
...
public class HashtagActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void updateStoriesVisible(final boolean z, boolean z2) {
        ...
        if (!z2) {
            ...
            this.storiesView.setTranslationY(z ? 0.0f : -AndroidUtilities.m1081dp(48.0f));
            this.contentView.setTranslationY(z ? AndroidUtilities.m1081dp(48.0f) : 0.0f);
            this.contentView.setPadding(0, 0, 0, z ? AndroidUtilities.m1081dp(48.0f) : 0);
            return;
        }
        this.storiesView.setVisibility(0);
        ViewPropertyAnimator duration = this.storiesView.animate().translationY(z ? 0.0f : -AndroidUtilities.m1081dp(48.0f)).withEndAction(new Runnable() { // from class: org.telegram.ui.Components.HashtagActivity$$ExternalSyntheticLambda0
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.HashtagActivity.6
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator2) {
                ...
                HashtagActivity.this.contentView.setTranslationY(HashtagActivity.this.contentViewValue * AndroidUtilities.m1081dp(48.0f));
                HashtagActivity.this.contentView.setPadding(0, 0, 0, (int) (HashtagActivity.this.contentViewValue * AndroidUtilities.m1081dp(48.0f)));
            }
        });
