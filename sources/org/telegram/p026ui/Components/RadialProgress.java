...
public class RadialProgress {
    ...
    private int diff = AndroidUtilities.m1081dp(4.0f);
    ...
    public RadialProgress(View view) {
        ...
        this.miniProgressPaint.setStrokeWidth(AndroidUtilities.m1081dp(2.0f));
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.drawMiniProgress && this.currentDrawable != null) {
            ...
            if (canvas2 != null) {
                ...
                f3 = -90.0f;
                f4 = 1.0f;
                canvas2.drawCircle(AndroidUtilities.m1081dp(f6), AndroidUtilities.m1081dp(f6), AndroidUtilities.m1081dp(i3 + 1) * f2, Theme.checkboxSquare_eraserPaint);
            } else {
                f3 = -90.0f;
                f4 = 1.0f;
                ...
                if (this.previousMiniDrawable != null && this.currentMiniDrawable == null) {
                    ...
                    this.miniProgressBackgroundPaint.setAlpha(Function.USE_VARARGS);
                }
            ...
            if (drawable4 != null) {
                ...
                float f7 = i3;
                this.previousMiniDrawable.setBounds((int) (fCenterX - (AndroidUtilities.m1081dp(f7) * f2)), (int) (fCenterY - (AndroidUtilities.m1081dp(f7) * f2)), (int) ((AndroidUtilities.m1081dp(f7) * f2) + fCenterX), (int) ((AndroidUtilities.m1081dp(f7) * f2) + fCenterY));
            ...
            if (!this.hideCurrentDrawable && (drawable2 = this.currentMiniDrawable) != null) {
                ...
                float f8 = i3;
                this.currentMiniDrawable.setBounds((int) (fCenterX - AndroidUtilities.m1081dp(f8)), (int) (fCenterY - AndroidUtilities.m1081dp(f8)), (int) (AndroidUtilities.m1081dp(f8) + fCenterX), (int) (AndroidUtilities.m1081dp(f8) + fCenterY));
            ...
            if (this.currentMiniWithRound || this.previousMiniWithRound) {
                ...
                float f9 = i3 - 2;
                this.cicleRect.set(fCenterX - (AndroidUtilities.m1081dp(f9) * f2), fCenterY - (AndroidUtilities.m1081dp(f9) * f2), fCenterX + (AndroidUtilities.m1081dp(f9) * f2), fCenterY + (AndroidUtilities.m1081dp(f9) * f2));
        ...
        if (this.currentWithRound || this.previousWithRound) {
            ...
            int i4 = this.diff;
            rectF5.set(f10 + i4, rectF6.top + i4, rectF6.right - i4, rectF6.bottom - i4);
