...
public class FragmentFloatingButton extends FrameLayout implements FactorAnimator.Target {
    ...
    public FragmentFloatingButton(Context context, Theme.ResourcesProvider resourcesProvider, boolean z) {
        ...
        if (!z) {
            if (ExteraConfig.squareFab) {
                viewOutlineProviderBoundsWithPaddingRoundRect = ViewOutlineProviderImpl.boundsWithPaddingRoundRect(0, AndroidUtilities.m1081dp(14.0f));
            } else {
        ...
        if (z) {
            this.iBlur3ColorProviderTabs = new BlurredBackgroundColorProviderThemed(null, Theme.key_dialogBackground) { // from class: org.telegram.ui.Components.FragmentFloatingButton.1
                @Override // org.telegram.p026ui.Components.blur3.drawable.color.BlurredBackgroundColorProviderThemed, org.telegram.p026ui.Components.blur3.drawable.color.BlurredBackgroundColorProvider
            ...
            this.iBlur3Background.setRadius(AndroidUtilities.m1081dp(ExteraConfig.squareFab ? 10.0f : 18.0f));
            this.iBlur3Background.setPadding(AndroidUtilities.m1081dp(5.66f));
        }
        updateColors();
    }
    ...
    public void onFactorChanged(int i, float f, float f2, FactorAnimator factorAnimator) {
        ...
        if (i == 0) {
            ...
            setAdditionalTranslationY(AndroidUtilities.m1081dp(this.isSubButton ? 64.0f : 40.0f) * (1.0f - f));
        } else if (i == 1) {
    ...
    public void updateColors() {
        if (this.isSubButton) {
            ...
            invalidate();
            setBackground(Theme.createInsetRoundRectDrawable(Theme.getColor(Theme.key_listSelector, this.resourcesProvider), AndroidUtilities.m1081dp(ExteraConfig.squareFab ? 10.0f : 18.0f), AndroidUtilities.m1081dp(6.0f)));
            return;
        }
