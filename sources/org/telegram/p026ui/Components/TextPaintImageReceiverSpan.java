...
public class TextPaintImageReceiverSpan extends ReplacementSpan {
    ...
    public int getSize(Paint paint, CharSequence charSequence, int i, int i2, Paint.FontMetricsInt fontMetricsInt) {
        if (fontMetricsInt != null) {
            if (this.alignTop) {
                int iM1081dp = (fontMetricsInt.descent - fontMetricsInt.ascent) - AndroidUtilities.m1081dp(4.0f);
                int i3 = this.height - iM1081dp;
                ...
                int iM1081dp2 = ((-this.height) / 2) - AndroidUtilities.m1081dp(4.0f);
                fontMetricsInt.ascent = iM1081dp2;
                fontMetricsInt.top = iM1081dp2;
                int i5 = this.height;
                int iM1081dp3 = (i5 - (i5 / 2)) - AndroidUtilities.m1081dp(4.0f);
                fontMetricsInt.descent = iM1081dp3;
                fontMetricsInt.bottom = iM1081dp3;
            }
        }
        return this.width;
    }
    ...
    public void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
        ...
        if (this.alignTop) {
            ...
            int iM1081dp = (i5 - AndroidUtilities.m1081dp(4.0f)) - i3;
            this.imageReceiver.setImageCoords((int) f, i3 + ((iM1081dp - r4) / 2), this.width, this.height);
        }
