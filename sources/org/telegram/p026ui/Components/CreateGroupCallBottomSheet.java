...
public class CreateGroupCallBottomSheet extends BottomSheetWithRecyclerListView {
    ...
    public CreateGroupCallBottomSheet(BaseFragment baseFragment, ArrayList arrayList, long j, JoinCallAlert.JoinCallAlertDelegate joinCallAlertDelegate) {
        ...
        if (zIsChannelOrGiga) {
            string = LocaleController.formatString(C2702R.string.VoipChannelStartVoiceChat, new Object[0]);
        } else {
            string = LocaleController.formatString(C2702R.string.VoipGroupStartVoiceChat, new Object[0]);
        }
        textView.setText(string);
        textView.setTextColor(Theme.getColor(Theme.key_featuredStickers_buttonText));
        int iM1081dp = AndroidUtilities.m1081dp(8.0f);
        int i = Theme.key_featuredStickers_addButton;
        textView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(iM1081dp, Theme.getColor(i), ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_windowBackgroundWhite), Opcodes.ISHL)));
        ...
        if (zIsChannelOrGiga) {
            string2 = LocaleController.formatString(C2702R.string.VoipChannelScheduleVoiceChat, new Object[0]);
        } else {
            string2 = LocaleController.formatString(C2702R.string.VoipGroupScheduleVoiceChat, new Object[0]);
        }
        textView2.setText(string2);
        textView2.setLetterSpacing(0.025f);
        textView2.setTextColor(Theme.getColor(i));
        textView2.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1081dp(8.0f), 0, ColorUtils.setAlphaComponent(Theme.getColor(i), Opcodes.ISHL)));
        ...
        recyclerListView.setPadding(i2, 0, i2, AndroidUtilities.m1081dp(120.0f));
    ...
    protected CharSequence getTitle() {
        if (this.isChannelOrGiga) {
            return LocaleController.getString(C2702R.string.StartVoipChannelTitle);
        }
        return LocaleController.getString(C2702R.string.StartVoipChatTitle);
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.CreateGroupCallBottomSheet$2 */
    class C40652 extends RecyclerListView.SelectionAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (viewHolder.getItemViewType() == 2) {
                ...
                headerCell.setText(LocaleController.getString(C2702R.string.VoipChatDisplayedAs).replace(":", _UrlKt.FRAGMENT_ENCODE_SET));
                return;
            }
            if (viewHolder.getItemViewType() == 1) {
                ((TextInfoPrivacyCell) viewHolder.itemView).setText(AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(C2702R.string.VoipChatStreamWithAnotherApp), Theme.key_windowBackgroundWhiteBlueHeader, 0, new Runnable() { // from class: org.telegram.ui.Components.CreateGroupCallBottomSheet$2$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onBindViewHolder$0();
                    }
                }), true, AndroidUtilities.m1081dp(1.0f), AndroidUtilities.m1081dp(1.0f)));
            }
        }
    ...
    private static class TopCell extends LinearLayout {
        public TopCell(Context context, boolean z) {
            ...
            rLottieImageView.setAnimation(C2702R.raw.utyan_schedule, 112, 112);
            rLottieImageView.playAnimation();
            addView(rLottieImageView, LayoutHelper.createLinear(112, 112, 49, 0, 24, 0, 0));
            TextView textView = new TextView(context);
            textView.setTypeface(AndroidUtilities.bold());
            if (z) {
                string = LocaleController.formatString(C2702R.string.StartVoipChannelTitle, new Object[0]);
            } else {
                string = LocaleController.formatString(C2702R.string.StartVoipChatTitle, new Object[0]);
            }
            textView.setText(string);
            ...
            if (z) {
                string2 = LocaleController.formatString(C2702R.string.VoipChannelStart2, new Object[0]);
            } else {
                string2 = LocaleController.formatString(C2702R.string.VoipGroupStart2, new Object[0]);
            }
            textView2.setText(string2);
