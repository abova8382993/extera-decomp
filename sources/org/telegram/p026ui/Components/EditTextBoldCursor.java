...
public class EditTextBoldCursor extends EditTextEffects {
    ...
    class RunnableC40881 implements Runnable {
        RunnableC40881() {
        }
    ...
    /* JADX INFO: loaded from: classes5.dex */
    class C40892 extends AnimatedTextView.AnimatedTextDrawable {
        C40892() {
        }
    ...
    public void useAnimatedTextDrawable() {
        C40892 c40892 = new AnimatedTextView.AnimatedTextDrawable() { // from class: org.telegram.ui.Components.EditTextBoldCursor.2
            C40892() {
            }
        ...
        this.hintAnimatedDrawable = c40892;
        c40892.setEllipsizeByGradient(true);
        this.hintAnimatedDrawable.setTextColor(this.hintColor);
        this.hintAnimatedDrawable.setTextSize(getPaint().getTextSize());
        C40903 c40903 = new AnimatedTextView.AnimatedTextDrawable() { // from class: org.telegram.ui.Components.EditTextBoldCursor.3
            C40903() {
            }
        ...
        this.hintAnimatedDrawable2 = c40903;
        c40903.setGravity(5);
    ...
    /* JADX INFO: loaded from: classes5.dex */
    class C40903 extends AnimatedTextView.AnimatedTextDrawable {
        C40903() {
        }
    ...
    public Drawable getTextCursorDrawable() {
        ...
        C40914 c40914 = new ShapeDrawable(new RoundRectShape(new float[]{AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(10.0f)}, null, null)) { // from class: org.telegram.ui.Components.EditTextBoldCursor.4
            C40914(Shape shape) {
                super(shape);
            }
    ...
    private void init() {
        ...
        if (i >= 29) {
            C40925 c40925 = new ShapeDrawable() { // from class: org.telegram.ui.Components.EditTextBoldCursor.5
                C40925() {
                }
                ...
                public int getIntrinsicHeight() {
                    return AndroidUtilities.m1081dp(EditTextBoldCursor.this.cursorSize + 20);
                }

                @Override // android.graphics.drawable.ShapeDrawable, android.graphics.drawable.Drawable
                public int getIntrinsicWidth() {
                    return AndroidUtilities.m1081dp(EditTextBoldCursor.this.cursorWidth);
                }
            };
            this.cursorDrawable = c40925;
            c = 0;
            f = 10.0f;
            c40925.setShape(new RoundRectShape(new float[]{AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(10.0f)}, null, null));
            ...
            gradientDrawable.setCornerRadius(AndroidUtilities.m1081dp(10.0f));
        ...
        if (this.cursorDrawable == null) {
            try {
                ...
                gradientDrawable2.setCornerRadius(AndroidUtilities.m1081dp(f));
            ...
            try {
                ...
                if (field != null) {
                    field.set(this, Integer.valueOf(C2702R.drawable.field_carret_empty));
                }
            } catch (Throwable unused5) {
            }
        }
        this.cursorSize = AndroidUtilities.m1081dp(24.0f);
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.EditTextBoldCursor$5 */
    class C40925 extends ShapeDrawable {
        C40925() {
        }
    ...
    public void setLineColors(int i, int i2, int i3) {
        ...
        getContext().getResources().getDrawable(C2702R.drawable.search_dark).getPadding(this.padding);
    ...
    public void setTextSize(int i, float f) {
        AnimatedTextView.AnimatedTextDrawable animatedTextDrawable = this.hintAnimatedDrawable;
        if (animatedTextDrawable != null) {
            animatedTextDrawable.setTextSize(AndroidUtilities.m1081dp(f));
        }
        AnimatedTextView.AnimatedTextDrawable animatedTextDrawable2 = this.hintAnimatedDrawable2;
        if (animatedTextDrawable2 != null) {
            animatedTextDrawable2.setTextSize(AndroidUtilities.m1081dp(f));
        }
    ...
    @Override // org.telegram.p026ui.Components.EditTextEffects, android.widget.EditText, android.widget.TextView
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (staticLayout != null && this.hintAnimatedDrawable == null) {
            ...
            if (this.hintLayoutYFix) {
                this.lineY = (((getExtendedPaddingTop() + getPaddingTop()) + ((((getMeasuredHeight() - getPaddingTop()) - getPaddingBottom()) - this.hintLayout.getHeight()) / 2.0f)) + this.hintLayout.getHeight()) - AndroidUtilities.m1081dp(1.0f);
            } else {
                this.lineY = ((getMeasuredHeight() - this.hintLayout.getHeight()) / 2.0f) + this.hintLayout.getHeight() + AndroidUtilities.m1081dp(6.0f);
            }
        } else {
            this.lineY = getMeasuredHeight() - AndroidUtilities.m1081dp(2.0f);
        }
    ...
    public void setHintText(CharSequence charSequence, boolean z, TextPaint textPaint) {
        ...
        this.hintLayout = new StaticLayout(charSequence, textPaint, AndroidUtilities.m1081dp(1000.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        invalidate();
    }
        ...
        if (length() == 0 || this.transformHintToHeader) {
            ...
            if (animatedTextDrawable != null && !TextUtils.isEmpty(animatedTextDrawable.getText()) && (this.hintVisible || this.hintAlpha != 0.0f)) {
                if (this.hintAnimatedDrawable2 == null) {
                    ...
                    this.hintAnimatedDrawable2.draw(canvas);
                    canvas.restore();
                    this.hintAnimatedDrawable.setRightPadding((this.hintAnimatedDrawable2.getCurrentWidth() + AndroidUtilities.m1081dp(2.0f)) - this.rightHintOffset);
                }
            ...
            if (this.hintLayout != null) {
                if (this.hintVisible || this.hintAlpha != 0.0f) {
                    ...
                    if (this.supportRtlHint && LocaleController.isRTL) {
                        ...
                        float height = (this.lineY - this.hintLayout.getHeight()) - AndroidUtilities.m1081dp(7.0f);
                    ...
                    if (this.transformHintToHeader) {
                        ...
                        canvas.scale(f3, f3);
                        canvas.translate(0.0f, (-AndroidUtilities.m1081dp(22.0f)) * this.headerAnimationProgress);
    ...
    */
    protected void onDraw(android.graphics.Canvas r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.EditTextBoldCursor.onDraw(android.graphics.Canvas):void");
    }
    ...
    private void updateCursorPosition(int i, int i2, float f) {
        ...
        int iM1081dp = AndroidUtilities.m1081dp(this.cursorWidth);
        GradientDrawable gradientDrawable = this.gradientDrawable;
        Rect rect = this.mTempRect;
        gradientDrawable.setBounds(iClampHorizontalPosition, i - rect.top, iM1081dp + iClampHorizontalPosition, i2 + rect.bottom);
    }
    ...
    public void setEllipsizeByGradient(boolean z) {
        ...
        if (z) {
            this.ellipsizeWidth = AndroidUtilities.m1081dp(12.0f);
