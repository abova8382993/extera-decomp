...
public class BlurVisibilityDrawable extends Drawable {
    ...
    public void render(int i, int i2, int i3, float f) {
        ...
        this.drawRunnable.draw(this.canvas, Function.USE_VARARGS);
    ...
    public void draw(Canvas canvas) {
        int i = this.alpha;
        if (i == 255) {
            drawNormal(canvas, Function.USE_VARARGS);
            return;
        }
        if (i == 0) {
            return;
        ...
        int iClamp = MathUtils.clamp((int) (d2 * dSqrt * 255.0d), 0, Function.USE_VARARGS);
        drawBlur(canvas, MathUtils.clamp((int) (dSqrt * 255.0d), 0, Function.USE_VARARGS));
