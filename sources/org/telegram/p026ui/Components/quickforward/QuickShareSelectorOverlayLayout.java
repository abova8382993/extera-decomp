            ...
            if (dialog instanceof TLRPC.TL_dialog) {
                ...
                if (j3 != j && !DialogObject.isEncryptedDialog(j3)) {
                    if (DialogObject.isUserDialog(dialog.f1616id)) {
                        ...
                        if (user != null && !UserObject.isBot(user) && !UserObject.isDeleted(user) && !UserObject.isService(user.f1775id)) {
                            if (dialog.folder_id == 1) {
                                arrayList2.add(Long.valueOf(dialog.f1616id));
                            } else {
                                this.dialogs.add(Long.valueOf(dialog.f1616id));
                            }
                        }
                    } else {
