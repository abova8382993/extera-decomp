...
import org.telegram.p026ui.Components.MediaActionDrawable;
...
public class RadialProgress2 {
    ...
    public RadialProgress2(final View view, Theme.ResourcesProvider resourcesProvider) {
        ...
        int iM1081dp = AndroidUtilities.m1081dp(22.0f);
        this.circleRadius = iM1081dp;
        this.overlayImageView.setRoundRadius(iM1081dp);
    ...
    private void initMdcDrawables(Context context) {
        ...
        setSpecValues(this.circleRadius * 2, AndroidUtilities.m1081dp(3.0f), AndroidUtilities.m1081dp(2.0f), AndroidUtilities.m1081dp(4.0f));
        setMiniSpecValues(AndroidUtilities.m1081dp(24.0f), AndroidUtilities.m1081dp(3.0f), AndroidUtilities.m1081dp(2.0f), AndroidUtilities.m1081dp(2.0f));
    ...
    public void setWavy(boolean z) {
        ...
        if (z) {
            ...
            setWavyValues(AndroidUtilities.m1081dp(15.0f), AndroidUtilities.m1081dp(1.6f), AndroidUtilities.m1081dp(5.0f), 0.05f);
        } else {
            this.progressSpec.indicatorInset = 0;
            this.miniProgressSpec.indicatorInset = 0;
    ...
    private void invalidateParent() {
        ...
        int i = ((int) rectF.left) - iM1081dp;
        int i2 = ((int) rectF.top) - iM1081dp;
        int i3 = iM1081dp * 2;
    ...
    public void initMiniIcons() {
        if (this.miniDrawBitmap == null) {
            try {
                this.miniDrawBitmap = Bitmap.createBitmap(AndroidUtilities.m1081dp(48.0f), AndroidUtilities.m1081dp(48.0f), Bitmap.Config.ARGB_8888);
        ...
        if ((this.mediaActionDrawable.getCurrentIcon() != 4 || this.mediaActionDrawable.getTransitionProgress() < 1.0f) && !this.progressRect.isEmpty()) {
            ...
            if (z2 && z5) {
                ...
                if (currentIcon != i4 || transitionProgress != f2) {
                    if (this.backgroundStroke != 0) {
                        canvas.drawCircle(iCeil, iCeil2, this.circleRadius - AndroidUtilities.m1081dp(f), this.circlePaint);
                    } else {
            ...
            if (z && z4) {
                float fM1081dp = z5 ? (this.circleRadius - AndroidUtilities.m1081dp(f)) / this.circleRadius : 1.0f;
                if (fM1081dp != 1.0f) {
                    canvas2.save();
                    canvas2.scale(fM1081dp, fM1081dp, iCeil, iCeil2);
                }
            ...
            if (this.drawMiniIcon || this.circleCrossfadeColorKey >= 0) {
                if (Math.abs(this.progressRect.width() - AndroidUtilities.m1081dp(44.0f)) < AndroidUtilities.density) {
                    float f5 = 16;
                    fCenterX = this.progressRect.centerX() + AndroidUtilities.m1081dp(f5);
                    fCenterY = this.progressRect.centerY() + AndroidUtilities.m1081dp(f5);
                    i3 = 20;
                    i2 = 0;
                } else {
                    fCenterX = this.progressRect.centerX() + AndroidUtilities.m1081dp(18.0f);
                    fCenterY = this.progressRect.centerY() + AndroidUtilities.m1081dp(18.0f);
                    i3 = 22;
                }
                int i16 = i3 / 2;
                if (this.drawMiniIcon) {
                ...
                if (canvas8 != null) {
                    float f6 = i3 + 18 + i2;
                    canvas8.drawCircle(AndroidUtilities.m1081dp(f6), AndroidUtilities.m1081dp(f6), AndroidUtilities.m1081dp(i16 + 1) * transitionProgress3 * this.miniIconScale, Theme.checkboxSquare_eraserPaint);
                } else {
                    this.miniProgressBackgroundPaint.setColor(this.progressColor);
                    canvas.drawCircle(fCenterX, fCenterY, AndroidUtilities.m1081dp(12.0f), this.miniProgressBackgroundPaint);
                }
                ...
                float f8 = i16;
                canvas.drawCircle(fCenterX, fCenterY, (AndroidUtilities.m1081dp(f8) * transitionProgress3) + (AndroidUtilities.m1081dp(1.0f) * (1.0f - this.circleCheckProgress)), this.circleMiniPaint);
                if (this.drawMiniIcon) {
                    this.miniMediaActionDrawable.setBounds((int) (fCenterX - (AndroidUtilities.m1081dp(f8) * transitionProgress3)), (int) (fCenterY - (AndroidUtilities.m1081dp(f8) * transitionProgress3)), (int) ((AndroidUtilities.m1081dp(f8) * transitionProgress3) + fCenterX), (int) ((AndroidUtilities.m1081dp(f8) * transitionProgress3) + fCenterY));
                    this.miniMediaActionDrawable.draw(canvas);
                    if (z) {
                        this.miniProgressDrawable.setBounds((int) (fCenterX - (AndroidUtilities.m1081dp(f8) * transitionProgress3)), (int) (fCenterY - (AndroidUtilities.m1081dp(f8) * transitionProgress3)), (int) (fCenterX + (AndroidUtilities.m1081dp(f8) * transitionProgress3)), (int) (fCenterY + (AndroidUtilities.m1081dp(f8) * transitionProgress3)));
