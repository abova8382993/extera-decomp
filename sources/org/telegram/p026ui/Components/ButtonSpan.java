...
public class ButtonSpan extends ReplacementSpan {
    ...
    public int getSize() {
        return (int) (this.text.getCurrentWidth() + AndroidUtilities.m1081dp(14.0f));
    }
    ...
    public void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
        ...
        this.text.draw(canvas, f + AndroidUtilities.m1081dp(7.0f), f2, iIntValue, 1.0f);
        canvas.restore();
    }
    ...
    public static class TextViewButtons extends LinkSpanDrawable.LinksTextView {
        ...
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            ...
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(TextUtils.ellipsize(getText(), getPaint(), (((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight()) - this.buttonToBeAdded.getSize()) - AndroidUtilities.m1081dp(4.0f), TextUtils.TruncateAt.END));
