...
import org.telegram.p026ui.Components.ProfileActionsView;
...
public abstract class ProfileActionsView extends View {
    ...
    private void measureActions() {
        ...
        for (int i = 0; i < this.actions.size(); i++) {
            ...
            if (action.text != null) {
                action.text.setMaxWidth(itemWidth - AndroidUtilities.m1081dp(2.0f));
    ...
    private void drawAction(Canvas canvas, Action action, float f, float f2) {
        ...
        updateBounds(action);
        float height = ((action.bounds.bottom + action.bounds.top) - ((action.text.getHeight() * action.textScale) / 2.0f)) - AndroidUtilities.m1081dp(6.0f);
        canvas.save();
    ...
    private void drawLoading(Canvas canvas, Action action, float f) {
        ...
        if (loadingDrawable4 != null) {
            ...
            float roundRadius = getRoundRadius();
            action.loadingDrawable.setRadii(roundRadius, roundRadius, roundRadius, roundRadius);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        Action action;
        if (this.currentHeight < AndroidUtilities.m1081dp(8.0f)) {
            return false;
        }
    ...
    protected boolean verifyDrawable(final Drawable drawable) {
        return Collection.EL.stream(this.actions).anyMatch(new Predicate() { // from class: org.telegram.ui.Components.ProfileActionsView$$ExternalSyntheticLambda0
            ...
            public /* synthetic */ Predicate m1216or(Predicate predicate) {
    ...
    private void updateNotification(Action action, boolean z) {
        if (z && IconManager.INSTANCE.isBasePackOnly(0)) {
            if (this.isNotificationsEnabled) {
                ...
                action.updateDrawable(C2702R.raw.profile_unmuting, actionButton.filledIcon, actionButton.outlineIcon);
                return;
            } else {
                ActionButton actionButton2 = ActionButton.NOTIFICATION_UNMUTE;
                action.setText(LocaleController.getString(actionButton2.title));
                action.updateDrawable(C2702R.raw.profile_muting, actionButton2.filledIcon, actionButton2.outlineIcon);
                return;
            }
        }
    ...
    private Action getOrCreate(int i) {
        ...
        switch (i) {
            ...
            case 9:
                ...
                actionFind.supportsLoading = true;
                actionFind.supportsAnimate = C2702R.raw.profile_leave;
                actionFind.stopDelay = 300;
                break;
            case 10:
                actionFind = new Action(ActionButton.VOICE_CHAT);
                actionFind.supportsLoading = true;
                actionFind.supportsAnimate = C2702R.raw.profile_voicechat;
                actionFind.stopDelay = 500;
                break;
            case 11:
    ...
    class Action {
        ...
        private final RectF f2001to = new RectF();
        ...
        public void delete() {
            ...
            this.f2001to.set(this.prevRect);
            if (z) {
                RectF rectF2 = this.f2001to;
                rectF2.right = rectF2.left;
            } else if (z3) {
                RectF rectF3 = this.f2001to;
                rectF3.left = rectF3.right;
            } else {
                int i = this.key;
                if ((i == 3 || i == 2) && ProfileActionsView.this.mode == 1) {
                    RectF rectF4 = this.f2001to;
                    rectF4.left = rectF4.right;
                } else {
                    RectF rectF5 = this.f2001to;
        ...
        */
        ...
        private void animatePosition() {
            ...
            if (f != 1.0f) {
                this.rect.left = AndroidUtilities.lerp(this.from.left, this.f2001to.left, f);
                this.rect.right = AndroidUtilities.lerp(this.from.right, this.f2001to.right, f);
                return;
            }
        ...
        public void updateDrawable(int i, int i2, int i3) {
            if (i != 0) {
                RLottieDrawable rLottieDrawable = new RLottieDrawable(i, String.valueOf(i), AndroidUtilities.m1081dp(56.0f), AndroidUtilities.m1081dp(56.0f), false, null);
    ...
    public static final class ActionButton {
        ...
        final int title;
        public static final ActionButton MESSAGE = new ActionButton("MESSAGE", 0, C2702R.string.ProfileActionsMessage, C2702R.drawable.filled_profile_message_24, C2702R.drawable.outline_profile_message_24);
        public static final ActionButton NOTIFICATION_MUTE = new ActionButton("NOTIFICATION_MUTE", 1, C2702R.string.ProfileButtonMute, C2702R.drawable.filled_profile_mute_24, C2702R.drawable.outline_profile_mute_24);
        public static final ActionButton NOTIFICATION_UNMUTE = new ActionButton("NOTIFICATION_UNMUTE", 2, C2702R.string.ProfileButtonUnmute, C2702R.drawable.filled_profile_unmute_24, C2702R.drawable.outline_profile_unmute_24);
        public static final ActionButton DISCUSS = new ActionButton("DISCUSS", 3, C2702R.string.ProfileActionsDiscuss, C2702R.drawable.filled_profile_message_24, C2702R.drawable.outline_profile_message_24);
        public static final ActionButton GIFT = new ActionButton("GIFT", 4, C2702R.string.ProfileActionsGift, C2702R.drawable.gift, C2702R.drawable.input_gift_s);
        public static final ActionButton SHARE = new ActionButton("SHARE", 5, C2702R.string.ProfileActionsShare, C2702R.drawable.action_share, C2702R.drawable.msg_share);
        public static final ActionButton CALL = new ActionButton("CALL", 6, C2702R.string.ProfileActionsCall, C2702R.drawable.filled_profile_call_24, C2702R.drawable.outline_profile_call_24);
        public static final ActionButton VIDEO = new ActionButton("VIDEO", 7, C2702R.string.ProfileActionsVideo, C2702R.drawable.filled_profile_video_24, C2702R.drawable.outline_profile_video_24);
        public static final ActionButton JOIN = new ActionButton("JOIN", 8, C2702R.string.ProfileActionsJoin, C2702R.drawable.filled_profile_member_24, C2702R.drawable.outline_profile_member_24);
        public static final ActionButton REPORT = new ActionButton("REPORT", 9, C2702R.string.ProfileActionsReport, C2702R.drawable.report, C2702R.drawable.msg_report);
        ...
        static {
            int i = C2702R.string.ProfileActionsLeave;
            int i2 = C2702R.drawable.leave;
            LEAVE = new ActionButton("LEAVE", 10, i, i2, i2);
            int i3 = C2702R.string.ProfileActionsVoiceChat;
            int i4 = C2702R.drawable.live_stream;
            VOICE_CHAT = new ActionButton("VOICE_CHAT", 11, i3, i4, i4);
            int i5 = C2702R.string.ProfileActionsLiveStream;
            int i6 = C2702R.drawable.live_stream;
            STREAM = new ActionButton("STREAM", 12, i5, i6, i6);
            STORY = new ActionButton("STORY", 13, C2702R.string.ProfileActionsAddStory, C2702R.drawable.filled_profile_story, C2702R.drawable.outline_profile_story);
            STOP = new ActionButton("STOP", 14, C2702R.string.ProfileActionsStop, C2702R.drawable.filled_profile_stop_24, C2702R.drawable.outline_profile_stop_24);
            SET_PHOTO = new ActionButton("SET_PHOTO", 15, C2702R.string.ProfileActionsEditPhoto2, C2702R.drawable.filled_profile_photo, C2702R.drawable.outline_profile_photo);
            EDIT_USERNAME = new ActionButton("EDIT_USERNAME", 16, C2702R.string.ProfileActionsEditUsername, C2702R.drawable.filled_profile_edit_24, C2702R.drawable.outline_profile_edit_24);
            EDIT_INFO = new ActionButton("EDIT_INFO", 17, C2702R.string.ProfileActionsEditInfo, C2702R.drawable.filled_profile_edit_24, C2702R.drawable.outline_profile_edit_24);
            SETTINGS = new ActionButton("SETTINGS", 18, C2702R.string.Settings, C2702R.drawable.filled_profile_settings, C2702R.drawable.outline_profile_settings);
            $VALUES = $values();
        }
