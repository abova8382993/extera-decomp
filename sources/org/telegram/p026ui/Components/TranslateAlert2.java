...
public abstract class TranslateAlert2 extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    private TranslateAlert2(Context context, String str, String str2, CharSequence charSequence, ArrayList arrayList, TLRPC.InputPeer inputPeer, int i, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.textView.setPadding(AndroidUtilities.m1081dp(22.0f), AndroidUtilities.m1081dp(12.0f), AndroidUtilities.m1081dp(22.0f), AndroidUtilities.m1081dp(6.0f));
        ...
        C50562 c50562 = new RecyclerListView(context2) { // from class: org.telegram.ui.Components.TranslateAlert2.2
        ...
        this.listView = c50562;
        c50562.setOverScrollMode(1);
        this.listView.setPadding(0, AndroidUtilities.statusBarHeight + AndroidUtilities.m1081dp(56.0f), 0, AndroidUtilities.m1081dp(80.0f));
        ...
        this.listView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.Components.TranslateAlert2.3
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int i3) {
                ...
                if ((i3 == 0 || i3 == 2) && TranslateAlert2.this.getSheetTop(false) > 0.0f && TranslateAlert2.this.getSheetTop(false) < AndroidUtilities.m1081dp(96.0f) && TranslateAlert2.this.listView.canScrollVertically(1) && TranslateAlert2.this.hasEnoughHeight()) {
        ...
        C50584 c50584 = new DefaultItemAnimator() { // from class: org.telegram.ui.Components.TranslateAlert2.4
            C50584() {
            }
        ...
        c50584.setDurations(180L);
        c50584.setInterpolator(new LinearInterpolator());
        this.listView.setItemAnimator(c50584);
        ...
        this.mainButton.setText(LocaleController.getString(C2702R.string.CloseTranslation), false);
    ...
    class C50541 extends FrameLayout {
        C50541(Context context2) {
            super(context2);
        }
    ...
    /* JADX INFO: loaded from: classes5.dex */
    class C50562 extends RecyclerListView {
        @Override // androidx.recyclerview.widget.RecyclerView, android.view.ViewGroup
        protected boolean onRequestFocusInDescendants(int i3, Rect rect) {
            return true;
        }
    ...
    /* JADX INFO: loaded from: classes5.dex */
    class C50573 extends RecyclerView.OnScrollListener {
        C50573() {
        }
    ...
    /* JADX INFO: loaded from: classes5.dex */
    class C50584 extends DefaultItemAnimator {
        C50584() {
        }
    ...
    public void translate() {
        ...
        if (this.reqSum && this.reqPeer != null) {
            ...
            tL_messages_summarizeText.f1735id = this.reqMessageId;
        ...
        if (inputPeer != null) {
            ...
            tL_messages_translateText.f1736id.add(Integer.valueOf(this.reqMessageId));
        } else {
        ...
        if (ExteraConfig.translationProvider == 0) {
            ...
            TranslatorUtils.translateWithDefault(string, this.reqPeer, this.reqMessageId, str2, this.reqMessageEntities, new TranslatorUtils.TranslateCallback() { // from class: org.telegram.ui.Components.TranslateAlert2.5
                ...
                C50595(final TLRPC.TL_textWithEntities tL_textWithEntities2, String str22) {
                ...
                public void onSuccess(TLObject tLObject, TLRPC.TL_error tL_error) {
                    ...
                    if (TranslateAlert2.this.firstTranslation) {
                        TranslateAlert2.this.lambda$new$0();
                        NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.showBulletin, 1, LocaleController.getString(C2702R.string.TranslationFailedAlert2));
                    }
                }

                @Override // com.exteragram.messenger.utils.text.TranslatorUtils.TranslateCallback
                public void onFailed() {
                    BulletinFactory.m1194of((FrameLayout) ((BottomSheet) TranslateAlert2.this).containerView, ((BottomSheet) TranslateAlert2.this).resourcesProvider).createErrorBulletin(LocaleController.getString(C2702R.string.TranslationFailedAlert2)).show();
    ...
    public /* synthetic */ void lambda$translate$1(TLRPC.TL_textWithEntities tL_textWithEntities, TLRPC.TL_textWithEntities tL_textWithEntities2, TLRPC.TL_error tL_error) {
        ...
        BulletinFactory.m1194of((FrameLayout) this.containerView, this.resourcesProvider).createErrorBulletin(LocaleController.getString(C2702R.string.TranslationFailedAlert2)).show();
    ...
    /* JADX INFO: loaded from: classes5.dex */
    class C50595 implements TranslatorUtils.TranslateCallback {
        final /* synthetic */ String val$finalLang;
        final /* synthetic */ TLRPC.TL_textWithEntities val$textWithEntities;
    ...
    /* JADX INFO: loaded from: classes5.dex */
    class C50606 implements TranslatorUtils.TranslateCallback {
        final /* synthetic */ String val$finalLang;
    ...
    public /* synthetic */ void lambda$translateAlt$2(String str, Boolean bool) {
        if (str != null) {
            ...
            if (this.firstTranslation) {
                lambda$new$0();
                NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.showBulletin, 1, LocaleController.getString(bool.booleanValue() ? C2702R.string.TranslationFailedAlert1 : C2702R.string.TranslationFailedAlert2));
                return;
            }
            BulletinFactory.m1194of((FrameLayout) this.containerView, this.resourcesProvider).createErrorBulletin(LocaleController.getString(bool.booleanValue() ? C2702R.string.TranslationFailedAlert1 : C2702R.string.TranslationFailedAlert2)).show();
            AnimatedTextView animatedTextView = this.headerView.toLanguageTextView;
    ...
    class C50617 extends Thread {
        ...
        */
        public void run() {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.TranslateAlert2.C50617.run():void");
        }
    ...
    private static void alternativeTranslateInternal(String str, String str2, String str3, Utilities.Callback2 callback2) {
        ...
        new C50617(str2, str3, str, callback2).start();
    }
    ...
    /* JADX INFO: loaded from: classes5.dex */
    class C50628 extends ClickableSpan {
        final /* synthetic */ URLSpan val$urlSpan;
    ...
    private static class PaddedAdapter extends RecyclerView.Adapter {
        ...
        class C50691 extends View {
            C50691(Context context) {
                super(context);
            }
    ...
    class HeaderView extends FrameLayout {
        ...
        public HeaderView(Context context) {
            ...
            this.copyButton.setImageResource(C2702R.drawable.msg_copy);
            ...
            C50651 c50651 = new TextView(context) { // from class: org.telegram.ui.Components.TranslateAlert2.HeaderView.1
                final /* synthetic */ TranslateAlert2 val$this$0;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C50651(Context context2, TranslateAlert2 translateAlert2) {
                    super(context2);
            ...
            this.titleTextView = c50651;
            c50651.setTextColor(TranslateAlert2.this.getThemedColor(i));
            ...
            C50662 c50662 = new LinearLayout(context2) { // from class: org.telegram.ui.Components.TranslateAlert2.HeaderView.2
                final /* synthetic */ TranslateAlert2 val$this$0;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C50662(Context context2, TranslateAlert2 translateAlert2) {
                    super(context2);
                    translateAlert2 = translateAlert2;
                }
            ...
            if (!TextUtils.isEmpty(TranslateAlert2.this.fromLanguage) && !TranslateController.UNKNOWN_LANGUAGE.equals(TranslateAlert2.this.fromLanguage)) {
                ...
                this.fromLanguageTextView.setPadding(0, AndroidUtilities.m1081dp(2.0f), 0, AndroidUtilities.m1081dp(2.0f));
            }
            ImageView imageView6 = new ImageView(context2);
            this.arrowView = imageView6;
            imageView6.setImageResource(C2702R.drawable.search_arrow);
            ...
            C50673 c50673 = new AnimatedTextView(context2) { // from class: org.telegram.ui.Components.TranslateAlert2.HeaderView.3
                private Paint bgPaint = new Paint(1);
                private LinkSpanDrawable.LinkCollector links = new LinkSpanDrawable.LinkCollector();
                final /* synthetic */ TranslateAlert2 val$this$0;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C50673(Context context2, TranslateAlert2 translateAlert2) {
                    super(context2);
                    translateAlert2 = translateAlert2;
                ...
                protected void onDraw(Canvas canvas) {
                    if (LocaleController.isRTL) {
                        AndroidUtilities.rectTmp.set(getWidth() - width(), (getHeight() - AndroidUtilities.m1081dp(18.0f)) / 2.0f, getWidth(), (getHeight() + AndroidUtilities.m1081dp(18.0f)) / 2.0f);
                    } else {
                        AndroidUtilities.rectTmp.set(0.0f, (getHeight() - AndroidUtilities.m1081dp(18.0f)) / 2.0f, width(), (getHeight() + AndroidUtilities.m1081dp(18.0f)) / 2.0f);
                    }
                    this.bgPaint.setColor(Theme.multAlpha(TranslateAlert2.this.getThemedColor(Theme.key_player_actionBarSubtitle), 0.1175f));
                    canvas.drawRoundRect(AndroidUtilities.rectTmp, AndroidUtilities.m1081dp(4.0f), AndroidUtilities.m1081dp(4.0f), this.bgPaint);
            ...
            this.toLanguageTextView = c50673;
            if (LocaleController.isRTL) {
                c50673.setGravity(5);
            }
            ...
            this.toLanguageTextView.setTextSize(AndroidUtilities.m1081dp(14.0f));
            ...
            this.toLanguageTextView.setPadding(AndroidUtilities.m1081dp(4.0f), AndroidUtilities.m1081dp(2.0f), AndroidUtilities.m1081dp(4.0f), AndroidUtilities.m1081dp(2.0f));
        ...
        public /* synthetic */ void lambda$new$1(View view) {
            if (AndroidUtilities.addToClipboard(TranslateAlert2.this.textView.getText())) {
                BulletinFactory.m1194of((FrameLayout) ((BottomSheet) TranslateAlert2.this).containerView, ((BottomSheet) TranslateAlert2.this).resourcesProvider).createCopyBulletin(LocaleController.getString(C2702R.string.TextCopied)).show();
            }
        }

        /* JADX INFO: renamed from: org.telegram.ui.Components.TranslateAlert2$HeaderView$1 */
        class C50651 extends TextView {
            final /* synthetic */ TranslateAlert2 val$this$0;
        ...
        class C50662 extends LinearLayout {
            final /* synthetic */ TranslateAlert2 val$this$0;
        ...
        class C50673 extends AnimatedTextView {
            private Paint bgPaint = new Paint(1);
            private LinkSpanDrawable.LinkCollector links = new LinkSpanDrawable.LinkCollector();
            final /* synthetic */ TranslateAlert2 val$this$0;
        ...
        class C50684 extends ActionBarPopupWindow.ActionBarPopupWindowLayout {
            C50684(Context context) {
                super(context);
            }
        ...
        public void openLanguagesSelect() {
            C50684 c50684 = new ActionBarPopupWindow.ActionBarPopupWindowLayout(getContext()) { // from class: org.telegram.ui.Components.TranslateAlert2.HeaderView.4
                C50684(Context context) {
                    super(context);
                }
            ...
            c50684.setBackground(drawableMutate);
            ...
            while (i < locales.size()) {
                ...
                if (!localeInfo.pluralLangCode.equals(TranslateAlert2.this.fromLanguage) && "remote".equals(localeInfo.pathToFile)) {
                    ...
                    c50684.addView(actionBarMenuSubItem);
                    z = false;
                }
                i++;
            }
            final ActionBarPopupWindow actionBarPopupWindow = new ActionBarPopupWindow(c50684, -2, -2);
            ...
            c50684.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.displaySize.x, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.displaySize.y, Integer.MIN_VALUE));
            int measuredHeight = c50684.getMeasuredHeight();
            int i2 = iArr[1];
            actionBarPopupWindow.showAtLocation(((BottomSheet) TranslateAlert2.this).containerView, 51, iArr[0] - AndroidUtilities.m1081dp(8.0f), ((float) i2) > (((float) AndroidUtilities.displaySize.y) * 0.9f) - ((float) measuredHeight) ? (i2 - measuredHeight) + AndroidUtilities.m1081dp(8.0f) : (i2 + this.toLanguageTextView.getMeasuredHeight()) - AndroidUtilities.m1081dp(8.0f));
        }
    ...
    private class ContainerView extends FrameLayout {
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            TranslateAlert2.this.topBulletinContainer.setTranslationY(((-r2.getTop()) - TranslateAlert2.this.topBulletinContainer.getHeight()) + getTranslationY() + Math.max(AndroidUtilities.statusBarHeight + AndroidUtilities.m1081dp(56.0f) + TranslateAlert2.this.topBulletinContainer.getHeight(), sheetTop));
            this.bgPath.rewind();
        ...
        public void setTranslationY(float f) {
            super.setTranslationY(f);
            TranslateAlert2.this.topBulletinContainer.setTranslationY(((-r0.getTop()) - TranslateAlert2.this.topBulletinContainer.getHeight()) + f + Math.max(AndroidUtilities.statusBarHeight + AndroidUtilities.m1081dp(56.0f) + TranslateAlert2.this.topBulletinContainer.getHeight(), TranslateAlert2.this.getSheetTop()));
        }
        ...
        class C50641 implements Bulletin.Delegate {
    ...
    /* JADX INFO: loaded from: classes5.dex */
    class DialogC50639 extends TranslateAlert2 {
        final /* synthetic */ Runnable val$onDismiss;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        DialogC50639(Context context, String str, String str2, CharSequence charSequence, ArrayList arrayList, TLRPC.InputPeer inputPeer, int i, boolean z, Theme.ResourcesProvider resourcesProvider, Runnable runnable) {
            super(context, str, str2, charSequence, arrayList, inputPeer, i, z, resourcesProvider);
            runnable = runnable;
        }

        @Override // org.telegram.p026ui.Components.TranslateAlert2, org.telegram.p026ui.ActionBar.BottomSheet, android.app.Dialog, android.content.DialogInterface, org.telegram.ui.ActionBar.BaseFragment.AttachedSheet
        /* JADX INFO: renamed from: dismiss */
        public void lambda$new$0() {
            super.lambda$new$0();
    ...
    public static TranslateAlert2 showAlert(Context context, BaseFragment baseFragment, int i, TLRPC.InputPeer inputPeer, int i2, boolean z, String str, String str2, CharSequence charSequence, ArrayList arrayList, boolean z2, Utilities.CallbackReturn callbackReturn, Runnable runnable) {
        DialogC50639 dialogC50639 = new TranslateAlert2(context, str, str2, charSequence, arrayList, inputPeer, i2, z, null) { // from class: org.telegram.ui.Components.TranslateAlert2.9
            final /* synthetic */ Runnable val$onDismiss;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            DialogC50639(Context context2, String str3, String str22, CharSequence charSequence2, ArrayList arrayList2, TLRPC.InputPeer inputPeer2, int i22, boolean z3, Theme.ResourcesProvider resourcesProvider, Runnable runnable2) {
        ...
        dialogC50639.setNoforwards(z2);
        dialogC50639.setFragment(baseFragment);
        dialogC50639.setOnLinkPress(callbackReturn);
        if (baseFragment != null) {
            if (baseFragment.getParentActivity() != null) {
                baseFragment.showDialog(dialogC50639);
            }
            return dialogC50639;
        }
        dialogC50639.show();
    ...
    /* JADX INFO: loaded from: classes5.dex */
    class DialogC505510 extends TranslateAlert2 {
        final /* synthetic */ Runnable val$onDismiss;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        DialogC505510(Context context, String str, String str2, CharSequence charSequence, ArrayList arrayList, Theme.ResourcesProvider resourcesProvider, Runnable runnable) {
    ...
    public static TranslateAlert2 showAlert(Context context, BaseFragment baseFragment, int i, String str, String str2, CharSequence charSequence, ArrayList arrayList, boolean z, Utilities.CallbackReturn callbackReturn, Runnable runnable) {
        ...
        DialogC505510 dialogC505510 = new TranslateAlert2(context, str, str2, charSequence, arrayList, null) { // from class: org.telegram.ui.Components.TranslateAlert2.10
            final /* synthetic */ Runnable val$onDismiss;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            DialogC505510(Context context2, String str3, String str22, CharSequence charSequence2, ArrayList arrayList2, Theme.ResourcesProvider resourcesProvider, Runnable runnable2) {
        ...
        dialogC505510.setNoforwards(z);
        dialogC505510.setFragment(baseFragment);
        dialogC505510.setOnLinkPress(callbackReturn);
        if (baseFragment != null) {
            if (baseFragment.getParentActivity() != null) {
                baseFragment.showDialog(dialogC505510);
            }
            return dialogC505510;
        }
        dialogC505510.show();
        return dialogC505510;
    }
