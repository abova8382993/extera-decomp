...
public class UniversalAdapter extends AdapterWithDiffUtils {
    ...
    /* JADX WARN: Removed duplicated region for block: B:119:0x0033 A[FALL_THROUGH, RETURN] */
    /*
    ...
    */
    public boolean shouldApplyBackground(int r4) {
        /*
            ...
            return r1
        L6:
            int r0 = org.telegram.p026ui.Components.UItem.factoryViewTypeStartsWith
            r2 = 1
            if (r4 < r0) goto Lc
            return r2
        Lc:
        ...
        L33:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.UniversalAdapter.shouldApplyBackground(int):boolean");
    }
    ...
    */
    public androidx.recyclerview.widget.RecyclerView.ViewHolder onCreateViewHolder(android.view.ViewGroup r13, int r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.UniversalAdapter.onCreateViewHolder(android.view.ViewGroup, int):androidx.recyclerview.widget.RecyclerView$ViewHolder");
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.UniversalAdapter$1 */
    /* JADX INFO: loaded from: classes5.dex */
    class C50931 extends FrameLayout {
        C50931(Context context) {
            super(context);
        }
    ...
    /* JADX INFO: loaded from: classes5.dex */
    class C50942 extends FrameLayout {
        C50942(Context context) {
            super(context);
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:1255:0x020f  */
    /* JADX WARN: Removed duplicated region for block: B:1258:0x0214  */
    /* JADX WARN: Removed duplicated region for block: B:1272:0x0254  */
    /* JADX WARN: Removed duplicated region for block: B:1277:0x0268  */
    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder r24, int r25) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.UniversalAdapter.onBindViewHolder(androidx.recyclerview.widget.RecyclerView$ViewHolder, int):void");
    }
