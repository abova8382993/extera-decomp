...
public class EllipsizeSpanAnimator {
    ...
    public EllipsizeSpanAnimator(final View view) {
        ...
        animatorSet.playTogether(createEllipsizeAnimator(textAlphaSpanArr[0], 0, Function.USE_VARARGS, 0, 300), createEllipsizeAnimator(textAlphaSpanArr[1], 0, Function.USE_VARARGS, 150, 300), createEllipsizeAnimator(textAlphaSpanArr[2], 0, Function.USE_VARARGS, 300, 300), createEllipsizeAnimator(textAlphaSpanArr[0], Function.USE_VARARGS, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400), createEllipsizeAnimator(textAlphaSpanArr[1], Function.USE_VARARGS, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400), createEllipsizeAnimator(textAlphaSpanArr[2], Function.USE_VARARGS, 0, MediaDataController.MAX_STYLE_RUNS_COUNT, 400));
