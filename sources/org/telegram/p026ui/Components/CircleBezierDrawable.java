...
public class CircleBezierDrawable {
    ...
    private final float f1892L;

    /* JADX INFO: renamed from: N */
    private final int f1893N;
    public float radius;
    ...
    private Matrix f1894m = new Matrix();
    ...
    public void draw(float f, float f2, Canvas canvas, Paint paint) {
        ...
        float fMax = this.f1892L * Math.max(f6, f7) * this.cubicBezierK;
        this.path.reset();
        int i = 0;
        int i2 = 0;
        while (i2 < this.f1893N) {
            this.f1894m.reset();
            this.f1894m.setRotate((360.0f / this.f1893N) * i2, f, f2);
            ...
            float f11 = f2 - f10;
            fArr2[1] = f11;
            fArr2[2] = f + fMax + (f9 * fArr[i2] * this.f1892L);
            fArr2[3] = f11;
            this.f1894m.mapPoints(fArr2);
            int i3 = i2 + 1;
            int i4 = i3 >= this.f1893N ? i : i3;
            ...
            float f15 = f2 - f14;
            fArr4[1] = f15;
            fArr4[2] = (f - fMax) + (f13 * fArr3[i4] * this.f1892L);
            fArr4[3] = f15;
            this.f1894m.reset();
            this.f1894m.setRotate((360.0f / this.f1893N) * i4, f, f2);
            this.f1894m.mapPoints(this.pointEnd);
            if (i2 == 0) {
                Path path = this.path;
