...
public class AvatarDrawable extends Drawable {
    ...
    public AvatarDrawable(Theme.ResourcesProvider resourcesProvider) {
        ...
        this.namePaint.setTextSize(AndroidUtilities.m1081dp(18.0f));
    }
    ...
    public AvatarDrawable(TLRPC.User user, boolean z) {
        ...
        this.isProfile = z;
        if (user != null) {
            setInfo(user.f1775id, user.first_name, user.last_name, null);
    ...
    public static String colorName(int i) {
        return LocaleController.getString(new int[]{C2702R.string.ColorRed, C2702R.string.ColorOrange, C2702R.string.ColorViolet, C2702R.string.ColorGreen, C2702R.string.ColorCyan, C2702R.string.ColorBlue, C2702R.string.ColorPink}[i % 7]);
    }
    ...
    public void setInfo(int i, TLRPC.User user) {
        if (user != null) {
            setInfo(user.f1775id, user.first_name, user.last_name, null, user.color != null ? Integer.valueOf(UserObject.getColorId(user)) : null, UserObject.getPeerColorForAvatar(i, user));
            this.drawDeleted = UserObject.isDeleted(user);
        }
    }
    ...
    public void setInfo(int i, TLRPC.Chat chat) {
        if (chat != null) {
            setInfo(chat.f1610id, chat.title, null, null, chat.color != null ? Integer.valueOf(ChatObject.getColorId(chat)) : null, ChatObject.getPeerColorForAvatar(i, chat));
        }
    }
        ...
        if (i3 == 2) {
            ...
            if (drawable2 != null) {
                ...
                if (this.alpha != 255) {
                    ...
                    drawable2.setColorFilter(new PorterDuffColorFilter(ColorUtils.setAlphaComponent(getThemedColor(i), Function.USE_VARARGS), mode));
                    drawable2.setAlpha(Function.USE_VARARGS);
                } else {
                    drawable2.draw(canvas);
                }
            }
            ...
            } else if (intrinsicWidth3 > iWidth - AndroidUtilities.m1081dp(6.0f) || intrinsicHeight3 > iWidth - AndroidUtilities.m1081dp(6.0f)) {
                float fM1081dp = iWidth / AndroidUtilities.m1081dp(50.0f);
                intrinsicWidth3 = (int) (intrinsicWidth3 * fM1081dp);
                intrinsicHeight3 = (int) (intrinsicHeight3 * fM1081dp);
            }
            ...
            if (this.invalidateTextLayout) {
                ...
                if (this.stringBuilder.length() > 0) {
                    ...
                    if (staticLayout == null || !TextUtils.equals(charSequenceReplaceEmoji, staticLayout.getText())) {
                        try {
                            StaticLayout staticLayout2 = new StaticLayout(charSequenceReplaceEmoji, this.namePaint, AndroidUtilities.m1081dp(100.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            ...
            if (this.textLayout != null) {
                float f7 = iWidth;
                float fM1081dp2 = f7 / AndroidUtilities.m1081dp(50.0f);
                float f8 = f7 / 2.0f;
                canvas.scale(fM1081dp2, fM1081dp2, f8, f8);
