...
public abstract class HelloParticles {
    ...
    public static class Drawable {
        ...
        private final float f1971dt = 1000.0f / AndroidUtilities.screenRefreshRate;
        ...
        public Drawable(int i) {
            ...
            this.textPaint.setTextSize(AndroidUtilities.m1081dp(this.bitmapScale * 24.0f));
        ...
        private class Particle {
            ...
            private float f1975x;

            /* JADX INFO: renamed from: y */
            private float f1976y;
            ...
            public void draw(Canvas canvas, int i, long j) {
                ...
                if (!drawable.paused) {
                    ...
                    if (f != 1.0f) {
                        float f2 = f + (drawable.f1971dt / this.duration);
                        this.inProgress = f2;
                        if (f2 > 1.0f) {
                ...
                if (this.bitmap != null) {
                    ...
                    canvas.translate(this.f1975x - (this.f1974w / 2.0f), this.f1976y - (this.f1972h / 2.0f));
                    canvas.scale(f3, f3, this.f1974w / 2.0f, this.f1972h / 2.0f);
            ...
            public void genPosition(long j, int i, boolean z) {
                ...
                if (staticLayout.getLineCount() <= 0) {
                    ...
                    this.f1973l = (int) this.staticLayout.getLineLeft(0);
                    this.f1974w = (int) this.staticLayout.getLineWidth(0);
                    this.f1972h = this.staticLayout.getHeight();
                }
                Bitmap bitmap = (Bitmap) Drawable.this.bitmaps.get(str);
                this.bitmap = bitmap;
                if (bitmap == null) {
                    this.bitmap = Bitmap.createBitmap(Math.max(1, this.f1974w - Math.max(0, this.f1973l)), Math.max(1, this.f1972h), Bitmap.Config.ARGB_8888);
                    Canvas canvas = new Canvas(this.bitmap);
                    canvas.translate(-this.f1973l, 0.0f);
                ...
                if (i % 2 == 0) {
                    fCenterX2 = rectF.centerX() - (this.f1974w / 2.0f);
                } else {
                    fCenterX = (this.f1974w / 2.0f) + rectF.centerX();
                }
                ...
                while (i4 < 10) {
                    ...
                    for (int i5 = i2; i5 < Drawable.this.particles.size(); i5++) {
                        ...
                        if (particle.set) {
                            float fMin = Math.min(Math.abs((particle.f1975x + ((particle.f1974w * (this.scale / Drawable.this.bitmapScale)) * 1.1f)) - fAbs3), Math.abs(particle.f1975x - fAbs3));
                            float f5 = particle.f1976y - fAbs4;
                ...
                this.f1975x = fAbs;
                this.f1976y = fAbs2;
                double dAtan2 = Math.atan2(fAbs - Drawable.this.rect.centerX(), this.f1976y - Drawable.this.rect.centerY());
