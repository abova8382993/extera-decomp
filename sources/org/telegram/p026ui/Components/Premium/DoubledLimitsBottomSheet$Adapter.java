...
public class DoubledLimitsBottomSheet$Adapter extends RecyclerListView.SelectionAdapter {
    ...
    public DoubledLimitsBottomSheet$Adapter(int i, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        arrayList.add(new DoubledLimitsBottomSheet$Limit(LocaleController.getString(C2702R.string.GroupsAndChannelsLimitTitle), LocaleController.formatString(C2702R.string.GroupsAndChannelsLimitSubtitle, Integer.valueOf(messagesController.channelsLimitPremium)), messagesController.channelsLimitDefault, messagesController.channelsLimitPremium));
        arrayList.add(new DoubledLimitsBottomSheet$Limit(LocaleController.getString(C2702R.string.PinChatsLimitTitle), LocaleController.formatString(C2702R.string.PinChatsLimitSubtitle, Integer.valueOf(messagesController.dialogFiltersPinnedLimitPremium)), messagesController.dialogFiltersPinnedLimitDefault, messagesController.dialogFiltersPinnedLimitPremium));
        arrayList.add(new DoubledLimitsBottomSheet$Limit(LocaleController.getString(C2702R.string.PublicLinksLimitTitle), LocaleController.formatString(C2702R.string.PublicLinksLimitSubtitle, Integer.valueOf(messagesController.publicLinksLimitPremium)), messagesController.publicLinksLimitDefault, messagesController.publicLinksLimitPremium));
        arrayList.add(new DoubledLimitsBottomSheet$Limit(LocaleController.getString(C2702R.string.SavedGifsLimitTitle), LocaleController.formatString(C2702R.string.SavedGifsLimitSubtitle, Integer.valueOf(messagesController.savedGifsLimitPremium)), messagesController.savedGifsLimitDefault, messagesController.savedGifsLimitPremium));
        arrayList.add(new DoubledLimitsBottomSheet$Limit(LocaleController.getString(C2702R.string.FavoriteStickersLimitTitle), LocaleController.formatString(C2702R.string.FavoriteStickersLimitSubtitle, Integer.valueOf(messagesController.stickersFavedLimitPremium)), messagesController.stickersFavedLimitDefault, messagesController.stickersFavedLimitPremium));
        arrayList.add(new DoubledLimitsBottomSheet$Limit(LocaleController.getString(C2702R.string.BioLimitTitle), LocaleController.formatString(C2702R.string.BioLimitSubtitle, Integer.valueOf(messagesController.stickersFavedLimitPremium)), messagesController.aboutLengthLimitDefault, messagesController.aboutLengthLimitPremium));
        arrayList.add(new DoubledLimitsBottomSheet$Limit(LocaleController.getString(C2702R.string.CaptionsLimitTitle), LocaleController.formatString(C2702R.string.CaptionsLimitSubtitle, Integer.valueOf(messagesController.stickersFavedLimitPremium)), messagesController.captionLengthLimitDefault, messagesController.captionLengthLimitPremium));
        arrayList.add(new DoubledLimitsBottomSheet$Limit(LocaleController.getString(C2702R.string.FoldersLimitTitle), LocaleController.formatString(C2702R.string.FoldersLimitSubtitle, Integer.valueOf(messagesController.dialogFiltersLimitPremium)), messagesController.dialogFiltersLimitDefault, messagesController.dialogFiltersLimitPremium));
        arrayList.add(new DoubledLimitsBottomSheet$Limit(LocaleController.getString(C2702R.string.ChatPerFolderLimitTitle), LocaleController.formatString(C2702R.string.ChatPerFolderLimitSubtitle, Integer.valueOf(messagesController.dialogFiltersChatsLimitPremium)), messagesController.dialogFiltersChatsLimitDefault, messagesController.dialogFiltersChatsLimitPremium));
        arrayList.add(new DoubledLimitsBottomSheet$Limit(LocaleController.getString(C2702R.string.ConnectedAccountsLimitTitle), LocaleController.formatString(C2702R.string.ConnectedAccountsLimitSubtitle, 4), 8, 16));
        arrayList.add(new DoubledLimitsBottomSheet$Limit(LocaleController.getString(C2702R.string.SimilarChannelsLimitTitle), LocaleController.formatString(C2702R.string.SimilarChannelsLimitSubtitle, Integer.valueOf(messagesController.recommendedChannelsLimitPremium)), messagesController.recommendedChannelsLimitDefault, messagesController.recommendedChannelsLimitPremium));
        this.rowCount = 1;
        this.headerRow = 0;
        ...
        if (i != 1) {
            ...
            FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.Components.Premium.DoubledLimitsBottomSheet$Adapter.1
                ...
                protected void onMeasure(int i2, int i3) {
                    super.onMeasure(i2, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(86.0f), TLObject.FLAG_30));
                }
            };
            LinearLayout linearLayout = new LinearLayout(context);
            linearLayout.setOrientation(0);
            ImageView imageView = new ImageView(context);
            imageView.setImageDrawable(PremiumGradient.getInstance().createGradientDrawable(ContextCompat.getDrawable(context, C2702R.drawable.other_2x_large)));
            linearLayout.addView(imageView, LayoutHelper.createFrame(40, 28.0f, 16, 0.0f, 0.0f, 8.0f, 0.0f));
            TextView textView = new TextView(context);
            textView.setText(LocaleController.getString(C2702R.string.DoubledLimits));
