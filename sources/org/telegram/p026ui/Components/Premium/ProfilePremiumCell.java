...
public class ProfilePremiumCell extends TextCell {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        float paddingTop = ((this.imageView.getPaddingTop() + this.imageView.getY()) + (this.imageView.getHeight() / 2.0f)) - AndroidUtilities.m1081dp(3.0f);
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(x - AndroidUtilities.m1081dp(16.0f), paddingTop - AndroidUtilities.m1081dp(16.0f), x + AndroidUtilities.m1081dp(16.0f), paddingTop + AndroidUtilities.m1081dp(16.0f));
        this.particles.setBounds(rectF);
    }

    @Override // org.telegram.p026ui.Cells.TextCell, android.view.ViewGroup, android.view.View
