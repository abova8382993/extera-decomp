package org.telegram.p026ui.Components.Premium.GLIcon;
...
public class GLIconTextureView extends TextureView implements TextureView.SurfaceTextureListener {
    ...
    public GLIconTextureView(Context context, int i, int i2) {
        ...
        initialize(context);
        GestureDetector gestureDetector = new GestureDetector(context, new GestureDetectorOnGestureListenerC45541());
    ...
    class GestureDetectorOnGestureListenerC45541 implements GestureDetector.OnGestureListener {
        ...
        GestureDetectorOnGestureListenerC45541() {
        }
    ...
    private void checkEglError() {
        if (this.mEgl.eglGetError() != 12288) {
            FileLog.m1091e("cannot swap buffers!");
        }
    }
    ...
    public void checkGlError() {
        ...
        if (iGlGetError != 0) {
            FileLog.m1091e("GL error = 0x" + Integer.toHexString(iGlGetError));
        }
    }
    ...
    public void initGL() {
        ...
        if (eGLSurface == null || eGLSurface == EGL10.EGL_NO_SURFACE) {
            ...
            if (iEglGetError == 12299) {
                FileLog.m1091e("eglCreateWindowSurface returned EGL10.EGL_BAD_NATIVE_WINDOW");
                return;
            }
