...
import org.telegram.p026ui.LauncherIconController;
...
public class PremiumAppIconsPreviewView extends FrameLayout implements PagerHeaderView {
    ...
    public PremiumAppIconsPreviewView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (this.icons.size() < 3) {
            FileLog.m1093e(new IllegalArgumentException("There should be at least 3 premium icons!"));
            this.isEmpty = true;
        } else {
    ...
    private AdaptiveIconImageView newIconView(Context context, int i) {
        ...
        adaptiveIconImageView.setPadding(AndroidUtilities.m1081dp(8.0f));
        adaptiveIconImageView.setBackgroundOuterPadding(AndroidUtilities.m1081dp(32.0f));
    ...
    public void setOffset(float f) {
        ...
        this.bottomRightIcon.setTranslationX(((getRight() - this.bottomRightIcon.getRight()) + (this.bottomRightIcon.getWidth() * 1.5f) + AndroidUtilities.m1081dp(32.0f)) * interpolation);
        this.bottomRightIcon.setTranslationY(AndroidUtilities.m1081dp(16.0f) * interpolation);
        ...
        this.topIcon.setTranslationY((((getTop() - this.topIcon.getTop()) - (this.topIcon.getHeight() * 1.8f)) - AndroidUtilities.m1081dp(32.0f)) * fAbs);
        this.topIcon.setTranslationX(AndroidUtilities.m1081dp(16.0f) * fAbs);
        ...
        this.bottomLeftIcon.setTranslationX((((getLeft() - this.bottomLeftIcon.getLeft()) - (this.bottomLeftIcon.getWidth() * 2.5f)) + AndroidUtilities.m1081dp(32.0f)) * interpolation2);
        this.bottomLeftIcon.setTranslationY(interpolation2 * ((getBottom() - this.bottomLeftIcon.getBottom()) + (this.bottomLeftIcon.getHeight() * 2.5f) + AndroidUtilities.m1081dp(32.0f)));
    ...
    private class AdaptiveIconImageView extends AppIconsSelectorCell.AdaptiveIconImageView {
        ...
        public void draw(Canvas canvas) {
            ...
            this.drawable.excludeRect.set(AndroidUtilities.m1081dp(5.0f), AndroidUtilities.m1081dp(5.0f), getMeasuredWidth() - AndroidUtilities.m1081dp(5.0f), getMeasuredHeight() - AndroidUtilities.m1081dp(5.0f));
            float f = -iM1081dp;
            this.drawable.rect.set(f, f, getWidth() + iM1081dp, getHeight() + iM1081dp);
            canvas.save();
            ...
            canvas.drawRoundRect(rectF, AndroidUtilities.m1081dp(16.0f), AndroidUtilities.m1081dp(16.0f), this.paint);
            super.draw(canvas);
        }
    }
}
