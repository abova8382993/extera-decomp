...
import org.telegram.p026ui.Cells.AdminedChannelCell;
...
import org.telegram.p026ui.ChannelColorActivity;
...
import org.telegram.p026ui.Components.Premium.boosts.BoostCounterView;
...
import org.telegram.p026ui.Components.Premium.boosts.ReassignBoostBottomSheet;
import org.telegram.p026ui.Components.Reactions.ChatCustomReactionsEditActivity;
...
import org.telegram.p026ui.Stories.ChannelBoostUtilities;
...
public class LimitReachedBottomSheet extends BottomSheetWithRecyclerListView implements NotificationCenter.NotificationCenterDelegate {
    ...
    private static class BoostFeature {
        ...
        /* synthetic */ BoostFeature(int i, int i2, String str, String str2, int i3, LimitReachedBottomSheetIA limitReachedBottomSheetIA) {
        ...
        public static BoostFeature m1212of(int i, int i2) {
            return new BoostFeature(i, i2, null, null, -1);
        }

        /* JADX INFO: renamed from: of */
        public static BoostFeature m1213of(int i, int i2, String str) {
            return new BoostFeature(i, i2, str, null, -1);
        }

        /* JADX INFO: renamed from: of */
        public static BoostFeature m1214of(int i, String str, int i2) {
    ...
    public LimitReachedBottomSheet(BaseFragment baseFragment, Context context, int i, int i2, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (i == 18 || i == 20 || i == 24 || i == 25 || i == 26 || i == 29 || i == 22 || i == 23 || i == 21 || i == 27 || i == 28 || i == 30 || i == 35 || i == 31) {
            ...
            this.actionBtn.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1081dp(8.0f), Theme.getColor(Theme.key_featuredStickers_addButton, resourcesProvider), ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_windowBackgroundWhite, resourcesProvider), Opcodes.ISHL)));
        }
        if (i == 32) {
            ((ViewGroup) this.premiumButtonView.getParent()).removeView(this.premiumButtonView);
            ...
            this.boostToUnlockGroupBtn.setText(LocaleController.getString(C2702R.string.BoostGroup), false);
    ...
    public void onViewCreated(FrameLayout frameLayout) {
        ...
        this.boostMiniBtn.setText(LocaleController.getString(C2702R.string.BoostBtn), false);
        ...
        C45651 c45651 = new PremiumButtonView(context, true, this.resourcesProvider) { // from class: org.telegram.ui.Components.Premium.LimitReachedBottomSheet.1
            C45651(final Context context2, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.premiumButtonView = c45651;
        ScaleStateListAnimator.apply(c45651, 0.02f, 1.2f);
        if (!this.hasFixedSize && (i = this.type) != 18 && i != 20 && i != 24 && i != 25 && i != 26 && i != 29 && i != 22 && i != 23 && i != 21 && i != 27 && i != 28 && i != 30 && i != 35) {
            C45662 c45662 = new View(context2) { // from class: org.telegram.ui.Components.Premium.LimitReachedBottomSheet.2
                C45662(final Context context2) {
                    super(context2);
                }
            ...
            this.divider = c45662;
            c45662.setBackgroundColor(Theme.getColor(Theme.key_dialogBackground, this.resourcesProvider));
        ...
        this.recyclerListView.setPadding(0, 0, 0, AndroidUtilities.m1081dp(72.0f));
    ...
    class C45651 extends PremiumButtonView {
        C45651(final Context context2, boolean z, Theme.ResourcesProvider resourcesProvider) {
            super(context2, z, resourcesProvider);
        }
            ...
            if (this.canSendLink || !((i2 = this.type) == 11 || i2 == 34)) {
                ...
                if (groupCreateUserCell.isBlocked()) {
                    if (object instanceof TLRPC.User) {
                        showPremiumBlockedToast(groupCreateUserCell, ((TLRPC.User) object).f1775id);
                    }
                } else {
    ...
    public /* synthetic */ void lambda$onViewCreated$12(Context context, View view) {
        ...
        if (i == 19 || i == 32 || isMiniBoostBtnForAdminAvailable()) {
            ...
            if (canApplyBoost.empty) {
                ...
                builder.setTitle(LocaleController.getString(C2702R.string.PremiumNeeded));
                builder.setMessage(AndroidUtilities.replaceTags(LocaleController.getString(isGroup() ? C2702R.string.PremiumNeededForBoostingGroup : C2702R.string.PremiumNeededForBoosting)));
                builder.setPositiveButton(LocaleController.getString(C2702R.string.CheckPhoneNumberYes), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.Premium.LimitReachedBottomSheet$$ExternalSyntheticLambda14
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                    public final void onClick(AlertDialog alertDialog, int i2) {
                        this.f$0.lambda$onViewCreated$7(alertDialog, i2);
                    }
                });
                builder.setNegativeButton(LocaleController.getString(C2702R.string.Cancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.Premium.LimitReachedBottomSheet$$ExternalSyntheticLambda15
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                    public final void onClick(AlertDialog alertDialog, int i2) {
                        alertDialog.dismiss();
                    }
            ...
            if (z) {
                ...
                frameLayout.addView(new View(getContext()) { // from class: org.telegram.ui.Components.Premium.LimitReachedBottomSheet.3
                    ...
                    C45673(Context context2, Paint paint2, Drawable drawable) {
                        super(context2);
                        paint = paint2;
                        drawable = drawable;
                    }
                    ...
                    protected void onDraw(Canvas canvas) {
                        ...
                        PremiumGradient.getInstance().updateMainGradientMatrix(0, 0, getMeasuredWidth(), getMeasuredHeight(), -AndroidUtilities.m1081dp(10.0f), 0.0f);
                        canvas.drawCircle(measuredWidth, measuredHeight, (getMeasuredWidth() / 2.0f) - AndroidUtilities.m1081dp(2.0f), PremiumGradient.getInstance().getMainGradientPaint());
                        float fM1081dp = AndroidUtilities.m1081dp(18.0f) / 2.0f;
                        drawable.setBounds((int) (measuredWidth - fM1081dp), (int) (measuredHeight - fM1081dp), (int) (measuredWidth + fM1081dp), (int) (measuredHeight + fM1081dp));
                ...
                backupImageView2.setRoundRadius(AndroidUtilities.m1081dp(30.0f));
                ...
                textView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ReplaceBoostChannelDescription", C2702R.string.ReplaceBoostChannelDescription, chat.title, chat2.title)));
                builder2.setPositiveButton(LocaleController.getString(C2702R.string.Replace), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.Premium.LimitReachedBottomSheet$$ExternalSyntheticLambda17
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                    public final void onClick(AlertDialog alertDialog, int i2) {
                        this.f$0.lambda$onViewCreated$10(alertDialog, i2);
                    }
                });
                builder2.setNegativeButton(LocaleController.getString(C2702R.string.Cancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.Premium.LimitReachedBottomSheet$$ExternalSyntheticLambda18
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                    public final void onClick(AlertDialog alertDialog, int i2) {
                        alertDialog.dismiss();
                    }
    ...
    private void showPremiumBlockedToast(View view, long j) {
        ...
        if (MessagesController.getInstance(this.currentAccount).premiumFeaturesBlocked()) {
            bulletinCreateSimpleBulletin = BulletinFactory.m1194of((FrameLayout) this.containerView, this.resourcesProvider).createSimpleBulletin(C2702R.raw.star_premium_2, AndroidUtilities.replaceTags(LocaleController.formatString(C2702R.string.UserBlockedNonPremium, forcedFirstName)));
        } else {
            bulletinCreateSimpleBulletin = BulletinFactory.m1194of((FrameLayout) this.containerView, this.resourcesProvider).createSimpleBulletin(C2702R.raw.star_premium_2, AndroidUtilities.replaceTags(LocaleController.formatString(C2702R.string.UserBlockedNonPremium, forcedFirstName)), LocaleController.getString(C2702R.string.UserBlockedNonPremiumButton), new Runnable() { // from class: org.telegram.ui.Components.Premium.LimitReachedBottomSheet$$ExternalSyntheticLambda11
                @Override // java.lang.Runnable
                public final void run() {
    ...
    private boolean onBoostSuccess() {
        ...
        transitionSet.addTransition(new Visibility() { // from class: org.telegram.ui.Components.Premium.LimitReachedBottomSheet.4
            ...
            public Animator onAppear(ViewGroup viewGroup, View view, TransitionValues transitionValues, TransitionValues transitionValues2) {
                ...
                animatorSet.playTogether(ObjectAnimator.ofFloat(view, (Property<View, Float>) View.ALPHA, 0.0f, 1.0f), ObjectAnimator.ofFloat(view, (Property<View, Float>) View.TRANSLATION_Y, AndroidUtilities.m1081dp(20.0f), 0.0f));
            ...
            public Animator onDisappear(ViewGroup viewGroup, View view, TransitionValues transitionValues, TransitionValues transitionValues2) {
                AnimatorSet animatorSet = new AnimatorSet();
                animatorSet.playTogether(ObjectAnimator.ofFloat(view, (Property<View, Float>) View.ALPHA, view.getAlpha(), 0.0f), ObjectAnimator.ofFloat(view, (Property<View, Float>) View.TRANSLATION_Y, 0.0f, -AndroidUtilities.m1081dp(20.0f)));
                animatorSet.setInterpolator(CubicBezierInterpolator.DEFAULT);
                return animatorSet;
            }
        });
    ...
    class C45684 extends Visibility {
        C45684() {
        }
    ...
    public void sendInviteMessages(HashMap map) {
        ...
        if (!TextUtils.isEmpty(this.forceLink)) {
            ...
            TLRPC.ChatFull chatFull = MessagesController.getInstance(this.currentAccount).getChatFull(this.fromChat.f1610id);
            if (chatFull == null) {
                lambda$new$0();
                return;
            }
        ...
        for (TLRPC.User user : this.selectedChats) {
            long sendPaidMessagesStars = MessagesController.getInstance(this.currentAccount).getSendPaidMessagesStars(user.f1775id);
            if (sendPaidMessagesStars <= 0) {
                sendPaidMessagesStars = DialogObject.getMessagesStarsPrice(MessagesController.getInstance(this.currentAccount).isUserContactBlocked(user.f1775id));
            }
        ...
        if (map2 == null && !arrayList.isEmpty()) {
            ...
            while (i < size) {
                ...
                i++;
                arrayList3.add(Long.valueOf(((TLRPC.User) obj).f1775id));
            }
        ...
        while (it.hasNext()) {
            ...
            long jLongValue = map2 == null ? 0L : ((Long) map2.get(Long.valueOf(user2.f1775id))).longValue();
            boolean z3 = z;
            Iterator it2 = it;
            SendMessagesHelper.SendMessageParams sendMessageParamsM1124of = SendMessagesHelper.SendMessageParams.m1124of(str2, user2.f1775id, null, null, null, true, null, null, null, false, 0, 0, null, false);
            sendMessageParamsM1124of.payStars = jLongValue;
            SendMessagesHelper.getInstance(this.currentAccount).sendMessage(sendMessageParamsM1124of);
            if (sendMessageParamsM1124of.payStars > 0) {
                z2 = z3;
            }
            map2 = map;
            z = z3;
    ...
    public /* synthetic */ void lambda$sendInviteMessages$20() {
        ...
        if (bulletinFactoryGlobal != null) {
            if (this.selectedChats.size() == 1) {
                bulletinFactoryGlobal.createSimpleBulletin(C2702R.raw.voip_invite, AndroidUtilities.replaceTags(LocaleController.formatString(C2702R.string.InviteLinkSentSingle, ContactsController.formatName((TLRPC.User) this.selectedChats.iterator().next())))).show();
            } else {
                bulletinFactoryGlobal.createSimpleBulletin(C2702R.raw.voip_invite, AndroidUtilities.replaceTags(LocaleController.formatPluralString("InviteLinkSent", this.selectedChats.size(), Integer.valueOf(this.selectedChats.size())))).show();
            }
        }
    }
    ...
    public void updatePremiumButtonText() {
        String string;
        if (this.premiumButtonSetSubscribe) {
            this.premiumButtonView.setOverlayText(LocaleController.getString(C2702R.string.InvitePremiumBlockedSubscribe), false, false);
            return;
        }
        int i = this.type;
        if (i == 19 || i == 32 || isMiniBoostBtnForAdminAvailable()) {
            if (BoostRepository.isMultiBoostsAvailable()) {
                ...
                if (canApplyBoost != null && canApplyBoost.alreadyActive) {
                    string = LocaleController.getString(C2702R.string.BoostingBoostAgain);
                } else {
                    string = LocaleController.getString(isGroup() ? C2702R.string.BoostGroup : C2702R.string.BoostChannel);
                }
                ...
                this.premiumButtonView.buttonTextView.setText(LocaleController.getString(C2702R.string.f1556OK));
                return;
            }
            this.premiumButtonView.buttonTextView.setText(LocaleController.getString(isGroup() ? C2702R.string.BoostGroup : C2702R.string.BoostChannel));
            return;
        }
        int i2 = this.type;
        if (i2 == 18 || i2 == 20 || i2 == 24 || i2 == 25 || i2 == 26 || i2 == 29 || i2 == 22 || i2 == 23 || i2 == 21 || i2 == 27 || i2 == 28 || i2 == 30 || i2 == 35) {
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder("d ");
            spannableStringBuilder.setSpan(new ColoredImageSpan(C2702R.drawable.msg_copy_filled), 0, 1, 0);
            spannableStringBuilder.append((CharSequence) LocaleController.getString(C2702R.string.CopyLink));
        ...
        this.premiumButtonView.buttonTextView.setText(LocaleController.getString(C2702R.string.IncreaseLimit));
        ...
        if (limitParams != null) {
            ...
            if (i4 == i5) {
                this.premiumButtonView.setIcon(C2702R.raw.addone_icon);
                return;
            }
            if (i3 != 0 && i5 != 0 && i5 / i3 >= 1.6f && i5 / i3 <= 2.5f) {
                this.premiumButtonView.setIcon(C2702R.raw.double_icon);
                return;
            } else {
                this.premiumButtonView.hideIcon();
                return;
    ...
    private void leaveFromSelectedGroups() {
        ...
        if (arrayList.size() == 1) {
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("ChannelLeaveAlertWithName", C2702R.string.ChannelLeaveAlertWithName, ((TLRPC.Chat) arrayList.get(0)).title)));
        } else {
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("ChatsLeaveAlert", C2702R.string.ChatsLeaveAlert, new Object[0])));
        }
        builder.setNegativeButton(LocaleController.getString(C2702R.string.Cancel), null);
        builder.setPositiveButton(LocaleController.getString(C2702R.string.VoipGroupLeave), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.Premium.LimitReachedBottomSheet$$ExternalSyntheticLambda21
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
    ...
    public /* synthetic */ void lambda$leaveFromSelectedGroups$21(ArrayList arrayList, TLRPC.User user, AlertDialog alertDialog, int i) {
        ...
        for (int i2 = 0; i2 < arrayList.size(); i2++) {
            ...
            MessagesController.getInstance(this.currentAccount).deleteParticipantFromChat(chat.f1610id, user);
        }
    }
    ...
    private void updateButton() {
        ...
        if (i == 19 || i == 32 || isMiniBoostBtnForAdminAvailable()) {
            ...
            if ((z || canApplyBoost.empty) && !canApplyBoost.boostedNow && !canApplyBoost.alreadyActive) {
                if (canApplyBoost.isMaxLvl) {
                    this.premiumButtonView.setOverlayText(LocaleController.getString(C2702R.string.f1556OK), true, true);
                    return;
                } else {
            ...
            if (z) {
                if (BoostRepository.isMultiBoostsAvailable()) {
                    this.premiumButtonView.setOverlayText(LocaleController.getString(C2702R.string.BoostingBoostAgain), true, true);
                } else {
                    this.premiumButtonView.setOverlayText(LocaleController.getString(isGroup() ? C2702R.string.BoostGroup : C2702R.string.BoostChannel), true, true);
                }
                this.boostMiniBtn.setText(LocaleController.getString(C2702R.string.BoostBtn), true);
                ButtonWithCounterView buttonWithCounterView = this.boostToUnlockGroupBtn;
                if (buttonWithCounterView != null) {
                    buttonWithCounterView.setText(LocaleController.getString(C2702R.string.BoostGroup), true);
                    return;
                }
                return;
            }
            if (canApplyBoost.isMaxLvl) {
                this.boostMiniBtn.setText(LocaleController.getString(C2702R.string.f1556OK), true);
                ButtonWithCounterView buttonWithCounterView2 = this.boostToUnlockGroupBtn;
                if (buttonWithCounterView2 != null) {
                    buttonWithCounterView2.setText(LocaleController.getString(C2702R.string.f1556OK), true);
                }
                this.premiumButtonView.setOverlayText(LocaleController.getString(C2702R.string.f1556OK), true, true);
                return;
            }
            if (BoostRepository.isMultiBoostsAvailable()) {
                ...
                if (buttonWithCounterView3 != null) {
                    buttonWithCounterView3.setText(LocaleController.getString(C2702R.string.BoostGroup), true);
                }
                this.boostMiniBtn.setText(LocaleController.getString(C2702R.string.BoostBtn), true);
                this.premiumButtonView.setOverlayText(LocaleController.getString(C2702R.string.BoostingBoostAgain), true, true);
                return;
            ...
            if (buttonWithCounterView4 != null) {
                buttonWithCounterView4.setText(LocaleController.getString(C2702R.string.f1556OK), true);
            }
            this.boostMiniBtn.setText(LocaleController.getString(C2702R.string.f1556OK), true);
            this.premiumButtonView.setOverlayText(LocaleController.getString(C2702R.string.f1556OK), true, true);
            return;
        ...
        if (i2 == 11 || i2 == 34) {
            ...
            if (!this.canSendLink) {
                this.premiumButtonView.setOverlayText(LocaleController.getString(C2702R.string.Close), true, true);
            } else if (this.selectedChats.size() > 0) {
                this.premiumButtonView.setOverlayText(LocaleController.getString(C2702R.string.SendInviteLink), true, true);
            } else {
                this.premiumButtonView.setOverlayText(LocaleController.getString(C2702R.string.ActionSkip), true, true);
            }
    ...
    public CharSequence getTitle() {
        int i = this.type;
        if (i == 11) {
            return LocaleController.getString(C2702R.string.ChannelInviteViaLink2);
        }
        if (i == 34) {
            return LocaleController.getString(C2702R.string.CallInviteViaLink);
        }
        if (i != 35) {
            switch (i) {
                case 18:
                ...
                case 28:
                case 29:
                    return LocaleController.getString(C2702R.string.UnlockBoostChannelFeatures);
                case 19:
                case 30:
                    return LocaleController.getString(isGroup() ? C2702R.string.BoostGroup : C2702R.string.BoostChannel);
                case 31:
                    return LocaleController.getString(C2702R.string.BoostingAdditionalFeaturesTitle);
                case 32:
                    return LocaleController.getString(C2702R.string.BoostGroup);
                default:
                    return LocaleController.getString(C2702R.string.LimitReached);
            }
        }
        return LocaleController.getString(C2702R.string.UnlockBoostChannelFeatures);
    }
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (i == NotificationCenter.boostByChannelCreated) {
            ...
            if (zBooleanValue) {
                if (StoryRecorder.isVisible()) {
                    ChatActivity chatActivityM1188of = ChatActivity.m1188of(-chat.f1610id);
                    LaunchActivity.getLastFragment().presentFragment(chatActivityM1188of, false, false);
                    StoryRecorder.destroyInstance();
                    lambda$new$0();
                    BoostDialogs.showBulletin(chatActivityM1188of, chat, true);
                    return;
                }
            ...
            if (StoryRecorder.isVisible()) {
                ChatActivity chatActivityM1188of2 = ChatActivity.m1188of(-chat.f1610id);
                LaunchActivity.getLastFragment().presentFragment(chatActivityM1188of2, false, false);
                StoryRecorder.destroyInstance();
                lambda$new$0();
                BoostDialogs.showBulletin(chatActivityM1188of2, chat, false);
                return;
            }
            lambda$new$0();
        ...
        if (i == NotificationCenter.boostedChannelByUser) {
            ...
            canApplyBoost.setMyBoosts(tL_premium_myBoosts);
            if (onBoostSuccess()) {
                BulletinFactory.m1194of(this.container, this.resourcesProvider).createSimpleBulletinWithIconSize(C2702R.raw.ic_boosts_replace, LocaleController.formatPluralString("BoostingReassignedFromPlural", iIntValue, LocaleController.formatPluralString("BoostingFromOtherChannel", iIntValue2, new Object[0])), 30).setDuration(4000).show(true);
                return;
            }
            return;
        }
    ...
    class C45695 extends RecyclerListView.SelectionAdapter {
        C45695() {
        }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            switch (i) {
                ...
                case 3:
                    ...
                    headerCell.setPadding(0, 0, 0, AndroidUtilities.m1081dp(8.0f));
                ...
                case 6:
                    adminedChannelCell = new View(LimitReachedBottomSheet.this.getContext()) { // from class: org.telegram.ui.Components.Premium.LimitReachedBottomSheet.5.3
                        ...
                        protected void onMeasure(int i2, int i3) {
                            super.onMeasure(i2, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(16.0f), TLObject.FLAG_30));
                        }
                    };
                    break;
                case 7:
                    FrameLayout frameLayout = new FrameLayout(LimitReachedBottomSheet.this.getContext());
                    frameLayout.setPadding(((BottomSheet) LimitReachedBottomSheet.this).backgroundPaddingLeft + AndroidUtilities.m1081dp(6.0f), 0, ((BottomSheet) LimitReachedBottomSheet.this).backgroundPaddingLeft + AndroidUtilities.m1081dp(6.0f), 0);
                    TextView textView = new TextView(context);
                    LimitReachedBottomSheet limitReachedBottomSheet = LimitReachedBottomSheet.this;
                    ...
                    textView.setPadding(AndroidUtilities.m1081dp(18.0f), AndroidUtilities.m1081dp(13.0f), AndroidUtilities.m1081dp(LimitReachedBottomSheet.this.statisticClickRunnable == null ? 18.0f : 50.0f), AndroidUtilities.m1081dp(13.0f));
                    textView.setTextSize(1, 16.0f);
                    ...
                    textView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(iM1081dp, color, ColorUtils.setAlphaComponent(Theme.getColor(i2, ((BottomSheet) LimitReachedBottomSheet.this).resourcesProvider), 76)));
                    ...
                    if (LimitReachedBottomSheet.this.statisticClickRunnable != null) {
                        ...
                        imageView.setImageResource(C2702R.drawable.msg_stats);
                        ...
                        imageView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1081dp(20.0f), 0, ColorUtils.setAlphaComponent(Theme.getColor(i2, ((BottomSheet) LimitReachedBottomSheet.this).resourcesProvider), 76)));
                ...
                case 8:
                    ...
                    linearLayout.setPadding(((BottomSheet) LimitReachedBottomSheet.this).backgroundPaddingLeft + AndroidUtilities.m1081dp(6.0f), 0, ((BottomSheet) LimitReachedBottomSheet.this).backgroundPaddingLeft + AndroidUtilities.m1081dp(6.0f), 0);
                    ...
                    SpannableStringBuilder spannableStringBuilderReplaceTags = AndroidUtilities.replaceTags(LocaleController.getString(LimitReachedBottomSheet.this.isGroup() ? C2702R.string.BoostingStoriesByGiftingGroup2 : C2702R.string.BoostingStoriesByGiftingChannel2));
                    SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(LocaleController.getString(C2702R.string.BoostingStoriesByGiftingLink));
                    ...
                    Drawable drawableMutate = LimitReachedBottomSheet.this.getContext().getResources().getDrawable(C2702R.drawable.msg_arrowright).mutate();
                    ...
                    coloredImageSpan.setWidth(AndroidUtilities.m1081dp(11.0f));
                    coloredImageSpan.setTranslateX(-AndroidUtilities.m1081dp(5.0f));
                    ...
                    if (LimitReachedBottomSheet.this.isMiniBoostBtnForAdminAvailable()) {
                        ...
                        buttonWithCounterView.setText(LocaleController.getString(C2702R.string.Copy), false);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 3) {
                ...
                if (i3 != 11 && i3 != 34) {
                    if (i3 == 2) {
                        headerCell.setText(LocaleController.getString(C2702R.string.YourPublicCommunities));
                        return;
                    } else {
                        headerCell.setText(LocaleController.getString(C2702R.string.LastActiveCommunities));
                        return;
                    }
                }
                if (limitReachedBottomSheet3.canSendLink) {
                    headerCell.setText(LocaleController.getString(C2702R.string.ChannelInviteViaLink));
                    return;
                } else if (LimitReachedBottomSheet.this.restrictedUsers.size() == 1) {
                    headerCell.setText(LocaleController.getString(C2702R.string.ChannelInviteViaLinkRestricted2));
                    return;
                } else {
                    headerCell.setText(LocaleController.getString(C2702R.string.ChannelInviteViaLinkRestricted3));
                    return;
                }
            }
            if (itemViewType != 4) {
            ...
            if (i4 == 5) {
                ...
                boolean z = LimitReachedBottomSheet.this.premiumMessagingBlockedUsers != null && LimitReachedBottomSheet.this.premiumMessagingBlockedUsers.contains(Long.valueOf(user.f1775id));
                ...
                if (!z) {
                    ...
                    userStatus = LocaleController.getString(C2702R.string.InvitePremiumBlockedUser);
                }
    ...
    public void setRestrictedUsers(TLRPC.Chat chat, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, String str) {
        ...
        if (this.canSendLink) {
            ...
            while (i < size) {
                ...
                if (arrayList2 == null || !arrayList2.contains(Long.valueOf(user.f1775id))) {
    ...
    class HeaderView extends LinearLayout {
        ...
        /* JADX WARN: Removed duplicated region for block: B:1087:0x047b  */
        /* JADX WARN: Removed duplicated region for block: B:1088:0x048c  */
        /* JADX WARN: Removed duplicated region for block: B:1116:0x04f2  */
        /* JADX WARN: Removed duplicated region for block: B:1149:0x0537  */
        /* JADX WARN: Removed duplicated region for block: B:1151:0x053b  */
        /* JADX WARN: Removed duplicated region for block: B:1170:0x058d  */
        /* JADX WARN: Removed duplicated region for block: B:1171:0x0592  */
        /* JADX WARN: Removed duplicated region for block: B:1174:0x05c5 A[LOOP:0: B:1173:0x05c3->B:1174:0x05c5, LOOP_END] */
        /* JADX WARN: Removed duplicated region for block: B:1177:0x0667  */
        /* JADX WARN: Removed duplicated region for block: B:1178:0x0669  */
        /* JADX WARN: Removed duplicated region for block: B:1181:0x0670  */
        /* JADX WARN: Removed duplicated region for block: B:1184:0x0684  */
        /* JADX WARN: Removed duplicated region for block: B:1187:0x068c  */
        /* JADX WARN: Removed duplicated region for block: B:1193:0x06ba  */
        /* JADX WARN: Removed duplicated region for block: B:1217:0x07dd  */
        /* JADX WARN: Removed duplicated region for block: B:1218:0x07df  */
        /* JADX WARN: Removed duplicated region for block: B:1221:0x07ed  */
        /* JADX WARN: Removed duplicated region for block: B:1222:0x07ef  */
        /* JADX WARN: Removed duplicated region for block: B:1225:0x07fb  */
        /* JADX WARN: Removed duplicated region for block: B:1235:0x0911  */
        /* JADX WARN: Removed duplicated region for block: B:1244:0x0943  */
        /* JADX WARN: Removed duplicated region for block: B:1253:0x0964  */
        /* JADX WARN: Removed duplicated region for block: B:1269:0x09c1  */
        /* JADX WARN: Removed duplicated region for block: B:1273:0x09e6  */
        /* JADX WARN: Removed duplicated region for block: B:1276:0x0a42  */
        /* JADX WARN: Removed duplicated region for block: B:1278:0x0a53  */
        /* JADX WARN: Removed duplicated region for block: B:1349:0x0be5  */
        /* JADX WARN: Removed duplicated region for block: B:1359:0x0c0e  */
        /* JADX WARN: Removed duplicated region for block: B:1361:0x0c29  */
        /* JADX WARN: Removed duplicated region for block: B:1364:0x0c34  */
        /* JADX WARN: Removed duplicated region for block: B:1369:0x0c88  */
        /* JADX WARN: Removed duplicated region for block: B:1379:0x0dd9  */
        /* JADX WARN: Removed duplicated region for block: B:1383:0x0dff A[ADDED_TO_REGION, REMOVE] */
        /* JADX WARN: Removed duplicated region for block: B:1386:0x0e12  */
        /* JADX WARN: Removed duplicated region for block: B:1387:0x0e26  */
        /* JADX WARN: Removed duplicated region for block: B:1390:0x0e3f  */
        /*
        ...
        */
        ...
        class C45711 extends TextView {
            private final Paint paint = new Paint(1);
            final /* synthetic */ LimitReachedBottomSheet val$this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C45711(Context context, LimitReachedBottomSheet limitReachedBottomSheet) {
                super(context);
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                float f = iMax / 2.0f;
                canvas.drawLine(0.0f, height, ((getWidth() / 2.0f) - f) - AndroidUtilities.m1081dp(8.0f), height, this.paint);
                canvas.drawLine((getWidth() / 2.0f) + f + AndroidUtilities.m1081dp(8.0f), height, getWidth(), height, this.paint);
                super.dispatchDraw(canvas);
            }
        }

        /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.LimitReachedBottomSheet$HeaderView$2 */
        class C45722 extends LimitPreviewView {
            final /* synthetic */ LimitReachedBottomSheet val$this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C45722(Context context, int i, int i2, int i3, float f, Theme.ResourcesProvider resourcesProvider, LimitReachedBottomSheet limitReachedBottomSheet) {
        ...
        public /* synthetic */ void lambda$new$1(View view) {
            LimitReachedBottomSheet.this.getBaseFragment().presentFragment(ChatActivity.m1188of(LimitReachedBottomSheet.this.dialogId));
            LimitReachedBottomSheet.this.lambda$new$0();
        }
    ...
    public String getBoostsTitleString() {
        ...
        if (tL_premium_boostsStatus.next_level_boosts == 0) {
            return LocaleController.formatString("BoostsMaxLevelReached", C2702R.string.BoostsMaxLevelReached, new Object[0]);
        }
        ...
        if (this.isCurrentChat) {
            ...
            if (this.canApplyBoost.alreadyActive) {
                return LocaleController.formatString("YouBoostedChannel2", C2702R.string.YouBoostedChannel2, chat.title);
            }
            return LocaleController.getString(isGroup() ? C2702R.string.BoostGroup : C2702R.string.BoostChannel);
        }
        if (this.type == 32) {
        ...
        if (this.canApplyBoost.alreadyActive) {
            return LocaleController.getString(isGroup() ? C2702R.string.YouBoostedGroup : C2702R.string.YouBoostedChannel);
        }
        return LocaleController.getString(isGroup() ? C2702R.string.BoostingEnableStoriesForGroup : C2702R.string.BoostingEnableStoriesForChannel);
    }
    ...
    private String getBoostDescriptionStringAfterBoost() {
        ...
        int i = this.type;
        if (i == 20) {
            string = LocaleController.formatString(zIsGroup ? C2702R.string.GroupNeedBoostsForColorDescription : C2702R.string.ChannelNeedBoostsForColorDescription, Integer.valueOf(channelColorLevelMin()));
        } else if (i == 24) {
            string = LocaleController.formatString(zIsGroup ? C2702R.string.GroupNeedBoostsForProfileColorDescription : C2702R.string.ChannelNeedBoostsForProfileColorDescription, Integer.valueOf(channelColorLevelMin()));
        } else if (i == 29) {
            string = LocaleController.formatString(C2702R.string.GroupNeedBoostsForCustomEmojiPackDescription, Integer.valueOf(messagesController.groupEmojiStickersLevelMin));
        } else if (i == 30) {
            string = LocaleController.formatString(C2702R.string.ChannelNeedBoostsForSwitchOffAdsDescription, Integer.valueOf(messagesController.channelRestrictSponsoredLevelMin));
        } else if (i == 35) {
            string = LocaleController.formatString(C2702R.string.ChannelNeedBoostsForAutotranslationDescription, Integer.valueOf(messagesController.channelAutotranslationLevelMin));
        } else if (i == 25) {
            string = LocaleController.formatString(zIsGroup ? C2702R.string.GroupNeedBoostsForEmojiStatusDescription : C2702R.string.ChannelNeedBoostsForEmojiStatusDescription, Integer.valueOf(zIsGroup ? messagesController.groupEmojiStatusLevelMin : messagesController.channelEmojiStatusLevelMin));
        } else if (i == 26) {
            string = LocaleController.formatString(zIsGroup ? C2702R.string.GroupNeedBoostsForWearCollectiblesDescription : C2702R.string.ChannelNeedBoostsForWearCollectiblesDescription, Integer.valueOf(zIsGroup ? messagesController.groupEmojiStatusLevelMin : messagesController.channelEmojiStatusLevelMin));
        } else if (i == 27) {
            string = LocaleController.formatString(zIsGroup ? C2702R.string.GroupNeedBoostsForReplyIconDescription : C2702R.string.ChannelNeedBoostsForReplyIconDescription, Integer.valueOf(messagesController.channelBgIconLevelMin));
        } else if (i == 28) {
            string = LocaleController.formatString(zIsGroup ? C2702R.string.GroupNeedBoostsForProfileIconDescription : C2702R.string.ChannelNeedBoostsForProfileIconDescription, Integer.valueOf(zIsGroup ? messagesController.groupProfileBgIconLevelMin : messagesController.channelProfileIconLevelMin));
        } else if (i == 22) {
            string = LocaleController.formatString(zIsGroup ? C2702R.string.GroupNeedBoostsForWallpaperDescription : C2702R.string.ChannelNeedBoostsForWallpaperDescription, Integer.valueOf(zIsGroup ? messagesController.groupWallpaperLevelMin : messagesController.channelWallpaperLevelMin));
        } else if (i == 23) {
            string = LocaleController.formatString(zIsGroup ? C2702R.string.GroupNeedBoostsForCustomWallpaperDescription : C2702R.string.ChannelNeedBoostsForCustomWallpaperDescription, Integer.valueOf(zIsGroup ? messagesController.groupCustomWallpaperLevelMin : messagesController.channelCustomWallpaperLevelMin));
        } else {
            string = null;
        }
    ...
    public String getBoostsDescriptionString(boolean z) {
        ...
        TLRPC.Chat chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(-this.dialogId));
        if (chat == null) {
            string = LocaleController.getString(isGroup() ? C2702R.string.AccDescrGroup : C2702R.string.AccDescrChannel);
        } else {
            string = chat.title;
        }
        TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus = this.boostsStatus;
        ...
        if (isMiniBoostBtnForAdminAvailable() && this.boostsStatus.next_level_boosts != 0 && z) {
            int i = isGroup() ? C2702R.string.GroupNeedBoostsDescriptionForNewFeatures : C2702R.string.ChannelNeedBoostsDescriptionForNewFeatures;
        ...
        if (z2 && this.canApplyBoost.alreadyActive) {
            if (this.boostsStatus.level == 1) {
                return LocaleController.formatString(isGroup() ? C2702R.string.GroupBoostsJustReachedLevel1 : C2702R.string.ChannelBoostsJustReachedLevel1, new Object[0]);
            }
            return LocaleController.formatString(isGroup() ? C2702R.string.GroupBoostsJustReachedLevelNext : C2702R.string.ChannelBoostsJustReachedLevelNext, Integer.valueOf(this.boostsStatus.level), LocaleController.formatPluralString("BoostStories", this.boostsStatus.level, new Object[0]));
        }
        if (this.canApplyBoost.alreadyActive) {
            TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus3 = this.boostsStatus;
            if (tL_premium_boostsStatus3.level == 0) {
                int i4 = isGroup() ? C2702R.string.GroupNeedBoostsDescriptionForNewFeatures : C2702R.string.ChannelNeedBoostsDescriptionForNewFeatures;
            ...
            if (tL_premium_boostsStatus3.next_level_boosts == 0) {
                return LocaleController.formatString(isGroup() ? C2702R.string.GroupBoostsJustReachedLevelNext : C2702R.string.ChannelBoostsJustReachedLevelNext, Integer.valueOf(this.boostsStatus.level), LocaleController.formatPluralString("BoostStories", this.boostsStatus.level + 1, new Object[0]));
            }
            int i7 = isGroup() ? C2702R.string.GroupNeedBoostsDescriptionForNewFeatures : C2702R.string.ChannelNeedBoostsDescriptionForNewFeatures;
        ...
        if (tL_premium_boostsStatus6.level == 0) {
            int i10 = isGroup() ? C2702R.string.GroupNeedBoostsDescriptionForNewFeatures : C2702R.string.ChannelNeedBoostsDescriptionForNewFeatures;
        ...
        int i13 = isGroup() ? C2702R.string.GroupNeedBoostsDescriptionForNewFeatures : C2702R.string.ChannelNeedBoostsDescriptionForNewFeatures;
    ...
    public static LimitParams getLimitParams(int i, int i2) {
        ...
        if (i == 0) {
            ...
            limitParams.icon = C2702R.drawable.msg_limit_pin;
            limitParams.descriptionStr = LocaleController.formatString("LimitReachedPinDialogs", C2702R.string.LimitReachedPinDialogs, Integer.valueOf(limitParams.defaultLimit), Integer.valueOf(limitParams.premiumLimit));
            limitParams.descriptionStrPremium = LocaleController.formatString("LimitReachedPinDialogsPremium", C2702R.string.LimitReachedPinDialogsPremium, Integer.valueOf(limitParams.premiumLimit));
            limitParams.descriptionStrLocked = LocaleController.formatString("LimitReachedPinDialogsLocked", C2702R.string.LimitReachedPinDialogsLocked, Integer.valueOf(limitParams.defaultLimit));
            return limitParams;
        }
        if (i == 33) {
            ...
            limitParams.icon = C2702R.drawable.msg_limit_pin;
            limitParams.descriptionStr = LocaleController.formatString(C2702R.string.LimitReachedPinSavedDialogs, Integer.valueOf(limitParams.defaultLimit), Integer.valueOf(limitParams.premiumLimit));
            limitParams.descriptionStrPremium = LocaleController.formatString(C2702R.string.LimitReachedPinSavedDialogsPremium, Integer.valueOf(limitParams.premiumLimit));
            limitParams.descriptionStrLocked = LocaleController.formatString(C2702R.string.LimitReachedPinSavedDialogsLocked, Integer.valueOf(limitParams.defaultLimit));
            return limitParams;
        }
        if (i == 2) {
            ...
            limitParams.icon = C2702R.drawable.msg_limit_links;
            limitParams.descriptionStr = LocaleController.formatString("LimitReachedPublicLinks", C2702R.string.LimitReachedPublicLinks, Integer.valueOf(limitParams.defaultLimit), Integer.valueOf(limitParams.premiumLimit));
            limitParams.descriptionStrPremium = LocaleController.formatString("LimitReachedPublicLinksPremium", C2702R.string.LimitReachedPublicLinksPremium, Integer.valueOf(limitParams.premiumLimit));
            limitParams.descriptionStrLocked = LocaleController.formatString("LimitReachedPublicLinksLocked", C2702R.string.LimitReachedPublicLinksLocked, Integer.valueOf(limitParams.defaultLimit));
            return limitParams;
        }
        if (i == 12) {
            ...
            limitParams.icon = C2702R.drawable.msg_limit_links;
            limitParams.descriptionStr = LocaleController.formatString("LimitReachedFolderLinks", C2702R.string.LimitReachedFolderLinks, Integer.valueOf(limitParams.defaultLimit), Integer.valueOf(limitParams.premiumLimit));
            limitParams.descriptionStrPremium = LocaleController.formatString("LimitReachedFolderLinksPremium", C2702R.string.LimitReachedFolderLinksPremium, Integer.valueOf(limitParams.premiumLimit));
            limitParams.descriptionStrLocked = LocaleController.formatString("LimitReachedFolderLinksLocked", C2702R.string.LimitReachedFolderLinksLocked, Integer.valueOf(limitParams.defaultLimit));
            return limitParams;
        }
        if (i == 13) {
            ...
            limitParams.icon = C2702R.drawable.msg_limit_folder;
            limitParams.descriptionStr = LocaleController.formatString("LimitReachedSharedFolders", C2702R.string.LimitReachedSharedFolders, Integer.valueOf(limitParams.defaultLimit), Integer.valueOf(limitParams.premiumLimit));
            limitParams.descriptionStrPremium = LocaleController.formatString("LimitReachedSharedFoldersPremium", C2702R.string.LimitReachedSharedFoldersPremium, Integer.valueOf(limitParams.premiumLimit));
            limitParams.descriptionStrLocked = LocaleController.formatString("LimitReachedSharedFoldersLocked", C2702R.string.LimitReachedSharedFoldersLocked, Integer.valueOf(limitParams.defaultLimit));
            return limitParams;
        }
        if (i == 3) {
            ...
            limitParams.icon = C2702R.drawable.msg_limit_folder;
            limitParams.descriptionStr = LocaleController.formatString("LimitReachedFolders", C2702R.string.LimitReachedFolders, Integer.valueOf(limitParams.defaultLimit), Integer.valueOf(limitParams.premiumLimit));
            limitParams.descriptionStrPremium = LocaleController.formatString("LimitReachedFoldersPremium", C2702R.string.LimitReachedFoldersPremium, Integer.valueOf(limitParams.premiumLimit));
            limitParams.descriptionStrLocked = LocaleController.formatString("LimitReachedFoldersLocked", C2702R.string.LimitReachedFoldersLocked, Integer.valueOf(limitParams.defaultLimit));
            return limitParams;
        }
        if (i == 4) {
            ...
            limitParams.icon = C2702R.drawable.msg_limit_chats;
            limitParams.descriptionStr = LocaleController.formatString("LimitReachedChatInFolders", C2702R.string.LimitReachedChatInFolders, Integer.valueOf(limitParams.defaultLimit), Integer.valueOf(limitParams.premiumLimit));
            limitParams.descriptionStrPremium = LocaleController.formatString("LimitReachedChatInFoldersPremium", C2702R.string.LimitReachedChatInFoldersPremium, Integer.valueOf(limitParams.premiumLimit));
            limitParams.descriptionStrLocked = LocaleController.formatString("LimitReachedChatInFoldersLocked", C2702R.string.LimitReachedChatInFoldersLocked, Integer.valueOf(limitParams.defaultLimit));
            return limitParams;
        }
        if (i == 5) {
            ...
            limitParams.icon = C2702R.drawable.msg_limit_groups;
            limitParams.descriptionStr = LocaleController.formatString("LimitReachedCommunities", C2702R.string.LimitReachedCommunities, Integer.valueOf(limitParams.defaultLimit), Integer.valueOf(limitParams.premiumLimit));
            limitParams.descriptionStrPremium = LocaleController.formatString("LimitReachedCommunitiesPremium", C2702R.string.LimitReachedCommunitiesPremium, Integer.valueOf(limitParams.premiumLimit));
            limitParams.descriptionStrLocked = LocaleController.formatString("LimitReachedCommunitiesLocked", C2702R.string.LimitReachedCommunitiesLocked, Integer.valueOf(limitParams.defaultLimit));
            return limitParams;
        }
        if (i == 6) {
            ...
            limitParams.icon = C2702R.drawable.msg_limit_folder;
            limitParams.descriptionStr = LocaleController.formatString("LimitReachedFileSize", C2702R.string.LimitReachedFileSize, "2 GB", "4 GB");
            limitParams.descriptionStrPremium = LocaleController.formatString("LimitReachedFileSizePremium", C2702R.string.LimitReachedFileSizePremium, "4 GB");
            limitParams.descriptionStrLocked = LocaleController.formatString("LimitReachedFileSizeLocked", C2702R.string.LimitReachedFileSizeLocked, "2 GB");
            return limitParams;
        }
        if (i == 7) {
            limitParams.defaultLimit = 8;
            limitParams.premiumLimit = 16;
            limitParams.icon = C2702R.drawable.msg_limit_accounts;
            limitParams.descriptionStr = LocaleController.formatString("LimitReachedAccounts", C2702R.string.LimitReachedAccounts, 8, Integer.valueOf(limitParams.premiumLimit));
            limitParams.descriptionStrPremium = LocaleController.formatString("LimitReachedAccountsPremium", C2702R.string.LimitReachedAccountsPremium, Integer.valueOf(limitParams.premiumLimit));
            limitParams.descriptionStrLocked = LocaleController.formatString("LimitReachedAccountsPremium", C2702R.string.LimitReachedAccountsPremium, Integer.valueOf(limitParams.defaultLimit));
            return limitParams;
        }
        if (i == 11) {
            ...
            limitParams.icon = C2702R.drawable.msg_limit_links;
            limitParams.descriptionStr = LocaleController.formatString("LimitReachedAccounts", C2702R.string.LimitReachedAccounts, 0, Integer.valueOf(limitParams.premiumLimit));
        ...
        if (i == 14) {
            ...
            limitParams.icon = C2702R.drawable.msg_limit_stories;
        ...
        if (i == 15) {
            ...
            limitParams.icon = C2702R.drawable.msg_limit_stories;
            limitParams.descriptionStr = LocaleController.formatString("LimitReachedStoriesWeekly", C2702R.string.LimitReachedStoriesWeekly, Integer.valueOf(limitParams.defaultLimit), Integer.valueOf(limitParams.premiumLimit));
            limitParams.descriptionStrPremium = LocaleController.formatString("LimitReachedStoriesWeeklyPremium", C2702R.string.LimitReachedStoriesWeeklyPremium, Integer.valueOf(limitParams.premiumLimit));
            limitParams.descriptionStrLocked = LocaleController.formatString("LimitReachedStoriesWeeklyPremium", C2702R.string.LimitReachedStoriesWeeklyPremium, Integer.valueOf(limitParams.defaultLimit));
            return limitParams;
        }
        if (i == 16) {
            ...
            limitParams.icon = C2702R.drawable.msg_limit_stories;
            limitParams.descriptionStr = LocaleController.formatString("LimitReachedStoriesMonthly", C2702R.string.LimitReachedStoriesMonthly, Integer.valueOf(limitParams.defaultLimit), Integer.valueOf(limitParams.premiumLimit));
            limitParams.descriptionStrPremium = LocaleController.formatString("LimitReachedStoriesMonthlyPremium", C2702R.string.LimitReachedStoriesMonthlyPremium, Integer.valueOf(limitParams.premiumLimit));
            limitParams.descriptionStrLocked = LocaleController.formatString("LimitReachedStoriesMonthlyPremium", C2702R.string.LimitReachedStoriesMonthlyPremium, Integer.valueOf(limitParams.defaultLimit));
            return limitParams;
        }
        ...
        limitParams.defaultLimit = MessagesController.getInstance(i2).storiesSentMonthlyLimitDefault;
        limitParams.premiumLimit = MessagesController.getInstance(i2).storiesSentMonthlyLimitPremium;
        limitParams.icon = C2702R.drawable.filled_limit_boost;
        limitParams.descriptionStr = LocaleController.formatString("LimitReachedStoriesMonthly", C2702R.string.LimitReachedStoriesMonthly, Integer.valueOf(limitParams.defaultLimit), Integer.valueOf(limitParams.premiumLimit));
        limitParams.descriptionStrPremium = LocaleController.formatString("LimitReachedStoriesMonthlyPremium", C2702R.string.LimitReachedStoriesMonthlyPremium, Integer.valueOf(limitParams.premiumLimit));
        limitParams.descriptionStrLocked = LocaleController.formatString("LimitReachedStoriesMonthlyPremium", C2702R.string.LimitReachedStoriesMonthlyPremium, Integer.valueOf(limitParams.defaultLimit));
        return limitParams;
    ...
    public void revokeLinks(final ArrayList arrayList) {
        ...
        if (arrayList.size() == 1) {
            ...
            if (this.parentIsChannel) {
                builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("RevokeLinkAlertChannel", C2702R.string.RevokeLinkAlertChannel, MessagesController.getInstance(this.currentAccount).linkPrefix + "/" + ChatObject.getPublicUsername(chat), chat.title)));
            } else {
                builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("RevokeLinkAlert", C2702R.string.RevokeLinkAlert, MessagesController.getInstance(this.currentAccount).linkPrefix + "/" + ChatObject.getPublicUsername(chat), chat.title)));
            }
        } else if (this.parentIsChannel) {
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("RevokeLinksAlertChannel", C2702R.string.RevokeLinksAlertChannel, new Object[0])));
        } else {
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("RevokeLinksAlert", C2702R.string.RevokeLinksAlert, new Object[0])));
        }
        builder.setNegativeButton(LocaleController.getString(C2702R.string.Cancel), null);
        builder.setPositiveButton(LocaleController.getString(C2702R.string.RevokeButton), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.Premium.LimitReachedBottomSheet$$ExternalSyntheticLambda20
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
        ...
        if (tL_error == null) {
            ...
            for (int i = 0; i < iMin; i++) {
                ...
                if (ChatObject.isMegagroup(chat)) {
                    arrayList.add(LocaleController.formatString("InactiveChatSignature", C2702R.string.InactiveChatSignature, LocaleController.formatPluralString("Members", chat.participants_count, new Object[0]), pluralString));
                } else if (ChatObject.isChannel(chat)) {
                    arrayList.add(LocaleController.formatString("InactiveChannelSignature", C2702R.string.InactiveChannelSignature, pluralString));
                } else {
                    arrayList.add(LocaleController.formatString("InactiveChatSignature", C2702R.string.InactiveChatSignature, LocaleController.formatPluralString("Members", chat.participants_count, new Object[0]), pluralString));
                }
            }
    ...
    private ArrayList boostFeaturesForLevel(int i) {
        ...
        if (!zIsGroup && i >= messagesController.channelAutotranslationLevelMin) {
            arrayList.add(BoostFeature.m1212of(C2702R.drawable.menu_feature_translate, C2702R.string.BoostFeatureAutotranslation));
        }
        arrayList.add(BoostFeature.m1214of(C2702R.drawable.menu_feature_stories, "BoostFeatureStoriesPerDay", i).asIncremental());
        if (!zIsGroup) {
            arrayList.add(BoostFeature.m1214of(C2702R.drawable.menu_feature_reactions, "BoostFeatureCustomReaction", i).asIncremental());
        }
        MessagesController.PeerColors peerColors = messagesController.peerColors;
        ...
        if (!zIsGroup && iColorsAvailable > 0) {
            arrayList.add(BoostFeature.m1214of(C2702R.drawable.menu_feature_color_name, "BoostFeatureNameColor", 7));
        }
        if (!zIsGroup && iColorsAvailable > 0) {
            arrayList.add(BoostFeature.m1214of(C2702R.drawable.menu_feature_links, "BoostFeatureReplyColor", iColorsAvailable));
        }
        if (!zIsGroup && i >= messagesController.channelBgIconLevelMin) {
            arrayList.add(BoostFeature.m1212of(C2702R.drawable.menu_feature_links2, C2702R.string.BoostFeatureReplyIcon));
        }
        if (iColorsAvailable2 > 0) {
            arrayList.add(BoostFeature.m1214of(C2702R.drawable.menu_feature_color_profile, zIsGroup ? "BoostFeatureProfileColorGroup" : "BoostFeatureProfileColor", iColorsAvailable2));
        }
        if (zIsGroup && i >= messagesController.groupEmojiStickersLevelMin) {
            arrayList.add(BoostFeature.m1212of(C2702R.drawable.menu_feature_pack, C2702R.string.BoostFeatureCustomEmojiPack));
        }
        if ((!zIsGroup && i >= messagesController.channelProfileIconLevelMin) || (zIsGroup && i >= messagesController.groupProfileBgIconLevelMin)) {
            arrayList.add(BoostFeature.m1212of(C2702R.drawable.menu_feature_cover, zIsGroup ? C2702R.string.BoostFeatureProfileIconGroup : C2702R.string.BoostFeatureProfileIcon));
        }
        if (zIsGroup && i >= messagesController.groupTranscribeLevelMin) {
            arrayList.add(BoostFeature.m1212of(C2702R.drawable.menu_feature_voice, C2702R.string.BoostFeatureVoiceToTextConversion));
        }
        if ((!zIsGroup && i >= messagesController.channelEmojiStatusLevelMin) || (zIsGroup && i >= messagesController.groupEmojiStatusLevelMin)) {
            arrayList.add(BoostFeature.m1213of(C2702R.drawable.menu_feature_status, C2702R.string.BoostFeatureEmojiStatuses, "1000+"));
        }
        if ((!zIsGroup && i >= messagesController.channelWallpaperLevelMin) || (zIsGroup && i >= messagesController.groupWallpaperLevelMin)) {
            arrayList.add(BoostFeature.m1214of(C2702R.drawable.menu_feature_wallpaper, zIsGroup ? "BoostFeatureBackgroundGroup" : "BoostFeatureBackground", 8));
        }
        if ((!zIsGroup && i >= messagesController.channelCustomWallpaperLevelMin) || (zIsGroup && i >= messagesController.groupCustomWallpaperLevelMin)) {
            arrayList.add(BoostFeature.m1212of(C2702R.drawable.menu_feature_custombg, zIsGroup ? C2702R.string.BoostFeatureCustomBackgroundGroup : C2702R.string.BoostFeatureCustomBackground));
        }
        if (!zIsGroup && i >= messagesController.channelRestrictSponsoredLevelMin) {
            arrayList.add(BoostFeature.m1212of(C2702R.drawable.menu_feature_noads, C2702R.string.BoostFeatureSwitchOffAds));
        }
    ...
    private class BoostFeatureCell extends FrameLayout {
        ...
        public BoostFeatureCell(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            C45701 c45701 = new FrameLayout(context, LimitReachedBottomSheet.this, resourcesProvider) { // from class: org.telegram.ui.Components.Premium.LimitReachedBottomSheet.BoostFeatureCell.1
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C45701(Context context2, LimitReachedBottomSheet limitReachedBottomSheet, Theme.ResourcesProvider resourcesProvider2) {
                    super(context2);
                ...
                protected void dispatchDraw(Canvas canvas) {
                    ...
                    canvas.drawLine(AndroidUtilities.m1081dp(18.0f), getHeight() / 2.0f, BoostFeatureCell.this.levelTextView.getLeft() - AndroidUtilities.m1081dp(20.0f), getHeight() / 2.0f, this.dividerPaint);
                    canvas.drawLine(BoostFeatureCell.this.levelTextView.getRight() + AndroidUtilities.m1081dp(20.0f), getHeight() / 2.0f, getWidth() - AndroidUtilities.m1081dp(18.0f), getHeight() / 2.0f, this.dividerPaint);
                    RectF rectF = AndroidUtilities.rectTmp;
                    rectF.set(BoostFeatureCell.this.levelTextView.getLeft() - AndroidUtilities.m1081dp(15.0f), ((BoostFeatureCell.this.levelTextView.getTop() + BoostFeatureCell.this.levelTextView.getBottom()) - AndroidUtilities.m1081dp(30.0f)) / 2.0f, BoostFeatureCell.this.levelTextView.getRight() + AndroidUtilities.m1081dp(15.0f), ((BoostFeatureCell.this.levelTextView.getTop() + BoostFeatureCell.this.levelTextView.getBottom()) + AndroidUtilities.m1081dp(30.0f)) / 2.0f);
                    canvas.save();
                    canvas.translate(rectF.left, rectF.top);
                    rectF.set(0.0f, 0.0f, rectF.width(), rectF.height());
                    this.gradientTools.gradientMatrix(rectF);
                    canvas.drawRoundRect(rectF, AndroidUtilities.m1081dp(15.0f), AndroidUtilities.m1081dp(15.0f), this.gradientTools.paint);
                    canvas.restore();
                    super.dispatchDraw(canvas);
                }
            };
            this.levelLayout = c45701;
            c45701.setWillNotDraw(false);
            c45701.addView(simpleTextView2, LayoutHelper.createFrame(-2, -2, 17));
            addView(c45701, LayoutHelper.createFrame(-1, -1.0f));
        }

        /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.LimitReachedBottomSheet$BoostFeatureCell$1 */
        class C45701 extends FrameLayout {
            private final Paint dividerPaint;
            private final PremiumGradient.PremiumGradientTools gradientTools;
            final /* synthetic */ Theme.ResourcesProvider val$resourcesProvider;
            final /* synthetic */ LimitReachedBottomSheet val$this$0;
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(this.level != null ? 49.0f : 36.0f), TLObject.FLAG_30));
        }
    }
