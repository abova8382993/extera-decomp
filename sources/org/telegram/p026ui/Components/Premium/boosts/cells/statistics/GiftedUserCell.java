package org.telegram.p026ui.Components.Premium.boosts.cells.statistics;
...
public class GiftedUserCell extends UserCell {
    ...
    @Override // org.telegram.p026ui.Cells.UserCell, android.view.View
    ...
    private void init() {
        ...
        this.badgeLayout.setPadding(AndroidUtilities.m1081dp(8.0f), 0, AndroidUtilities.m1081dp(8.0f), 0);
    ...
    public void setStatus(TL_stories.Boost boost) {
        ...
        if (boost.gift || boost.giveaway) {
            ...
            if (j > 0) {
                ...
                this.nameTextView.setText(LocaleController.getString(C2702R.string.BoostingUnclaimed));
                this.avatarDrawable.setAvatarType(18);
                setAvatarColorByMonths(i);
                this.avatarImageView.setForUserOrChat(null, this.avatarDrawable);
                this.nameTextView.setRightDrawable((Drawable) null);
            } else if (boost.user_id == -1) {
                this.nameTextView.setText(LocaleController.getString(C2702R.string.BoostingToBeDistributed));
            ...
            if (boost.stars > 0) {
                this.statusTextView.setText(LocaleController.formatString(C2702R.string.BoostingStarsExpires, str));
            } else {
                this.statusTextView.setText(LocaleController.formatString(C2702R.string.BoostingExpires, str));
            }
            if (boost.gift) {
                if (this.giftDrawable == null) {
                    Drawable drawable = getResources().getDrawable(C2702R.drawable.mini_gift);
                ...
                this.badgeTextView.setCompoundDrawablePadding(AndroidUtilities.m1081dp(4.0f));
                this.badgeTextView.setText(LocaleController.getString(C2702R.string.BoostingGift));
                this.badgeLayout.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1081dp(12.0f), AndroidUtilities.m1081dp(12.0f), Theme.multAlpha(-3240417, 0.2f)));
            }
            if (boost.giveaway) {
                if (this.giveawayDrawable == null) {
                    Drawable drawable2 = getResources().getDrawable(C2702R.drawable.mini_giveaway);
                ...
                this.badgeTextView.setCompoundDrawablePadding(AndroidUtilities.m1081dp(4.0f));
                this.badgeTextView.setText(LocaleController.getString(C2702R.string.BoostingGiveaway));
                this.badgeLayout.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1081dp(12.0f), AndroidUtilities.m1081dp(12.0f), Theme.multAlpha(-13397548, 0.2f)));
            }
        } else {
        ...
        if (this.badgeLayout.getVisibility() == 0) {
            int iMeasureText = ((int) this.badgeTextView.getPaint().measureText(this.badgeTextView.getText().toString())) + AndroidUtilities.m1081dp(22.0f);
