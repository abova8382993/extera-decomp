...
public class TableCell extends FrameLayout {
    ...
    public TableCell(Context context, final Theme.ResourcesProvider resourcesProvider) {
        ...
        TextView textViewCreateTextView = createTextView(LocaleController.getString(C2702R.string.BoostingFrom), false);
        this.fromNameTextView = textViewCreateTextView;
        TextView textViewCreateTextView2 = createTextView(LocaleController.getString(C2702R.string.BoostingTo), false);
        this.toNameTextView = textViewCreateTextView2;
        TextView textViewCreateTextView3 = createTextView(LocaleController.getString(C2702R.string.BoostingGift), false);
        this.giftNameTextView = textViewCreateTextView3;
        TextView textViewCreateTextView4 = createTextView(LocaleController.getString(C2702R.string.BoostingReason), false);
        this.reasonNameTextView = textViewCreateTextView4;
        TextView textViewCreateTextView5 = createTextView(LocaleController.getString(C2702R.string.BoostingDate), false);
        ...
        this.fromFrameLayout.setPadding(0, AndroidUtilities.m1081dp(6.0f), 0, AndroidUtilities.m1081dp(6.0f));
        ...
        this.toFrameLayout.setPadding(0, AndroidUtilities.m1081dp(6.0f), 0, AndroidUtilities.m1081dp(6.0f));
        ...
        TableLayout tableLayout = new TableLayout(context) { // from class: org.telegram.ui.Components.Premium.boosts.cells.TableCell.1
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                TableCell.this.roundPath.addRoundRect(TableCell.this.roundRect, AndroidUtilities.m1081dp(6.0f), AndroidUtilities.m1081dp(6.0f), Path.Direction.CW);
                super.dispatchDraw(canvas);
                TableCell.this.linePaint.setColor(ColorUtils.blendARGB(Theme.getColor(Theme.key_divider, resourcesProvider), -1, 0.1f));
                TableCell.this.linePaint.setStrokeWidth(AndroidUtilities.m1081dp(1.0f));
                ...
                TableCell.this.linePaint.setStrokeWidth(AndroidUtilities.m1081dp(2.0f));
        ...
        tableLayout.setOutlineProvider(new ViewOutlineProvider() { // from class: org.telegram.ui.Components.Premium.boosts.cells.TableCell.2
            ...
            public void getOutline(View view, Outline outline) {
                outline.setRoundRect(0, 0, view.getMeasuredWidth(), view.getMeasuredHeight(), AndroidUtilities.m1081dp(6.0f));
            }
        });
        tableLayout.setClipToOutline(z);
        setPaddingRelative(AndroidUtilities.m1081dp(14.0f), AndroidUtilities.m1081dp(18.0f), AndroidUtilities.m1081dp(14.0f), 0);
    }
    ...
    public void setData(final TLRPC.TL_payments_checkedGiftCode tL_payments_checkedGiftCode, final Utilities.Callback callback) {
        ...
        this.dateTextView.setText(LocaleController.formatString("formatDateAtTime", C2702R.string.formatDateAtTime, LocaleController.getInstance().getFormatterYear().format(date), LocaleController.getInstance().getFormatterDay().format(date)));
        ...
        if (tL_payments_checkedGiftCode.via_giveaway) {
            ...
            spannableStringBuilder.append((CharSequence) LocaleController.getString(C2702R.string.BoostingGiveaway));
            spannableStringBuilder.append((CharSequence) "**");
            ...
            this.reasonTextView.setText(LocaleController.getString(zIsChannelAndNotMegaGroup ? C2702R.string.BoostingYouWereSelected : C2702R.string.BoostingYouWereSelectedGroup));
            this.reasonTextView.setOnClickListener(null);
        }
        int i = tL_payments_checkedGiftCode.months;
        this.giftTextView.setText(LocaleController.formatString("BoostingTelegramPremiumFor", C2702R.string.BoostingTelegramPremiumFor, i == 12 ? LocaleController.formatPluralString("Years", 1, new Object[0]) : LocaleController.formatPluralString("Months", i, new Object[0])));
        if (chat != null) {
        ...
        if (tL_payments_checkedGiftCode.to_id == -1 && tL_payments_checkedGiftCode.via_giveaway) {
            ...
            spannableStringBuilder3.append((CharSequence) LocaleController.getString(C2702R.string.BoostingIncompleteGiveaway));
            spannableStringBuilder3.append((CharSequence) "**");
            ...
            this.toTextView.setText(LocaleController.getString(C2702R.string.BoostingNoRecipient));
    ...
    private TextView createTextView(String str, boolean z) {
        ...
        if (str != null) {
            ...
            textView.setPadding(AndroidUtilities.m1081dp(LocaleController.isRTL ? 32.0f : 12.0f), AndroidUtilities.m1081dp(11.0f), AndroidUtilities.m1081dp(LocaleController.isRTL ? 12.0f : 32.0f), AndroidUtilities.m1081dp(11.0f));
            return textView;
        }
