...
public class AddChannelCell extends FrameLayout {
    ...
    public AddChannelCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        addView(imageView);
        simpleTextView.setText(LocaleController.getString(C2702R.string.BoostingAddChannelOrGroup));
        Drawable drawable = getResources().getDrawable(C2702R.drawable.poll_add_circle);
        Drawable drawable2 = getResources().getDrawable(C2702R.drawable.poll_add_plus);
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (LocaleController.isRTL) {
            iM1081dp = (getMeasuredWidth() - this.textView.getMeasuredWidth()) - AndroidUtilities.m1081dp(this.imageView.getVisibility() == 0 ? 68.0f : 23.0f);
        } else {
            iM1081dp = AndroidUtilities.m1081dp(this.imageView.getVisibility() == 0 ? 68.0f : 23.0f);
        }
        ...
        int iM1081dp2 = !LocaleController.isRTL ? AndroidUtilities.m1081dp(24.0f) : (i5 - this.imageView.getMeasuredWidth()) - AndroidUtilities.m1081dp(24.0f);
