...
public class SelectorUserCell extends BaseCell {
    ...
    public SelectorUserCell(Context context, boolean z, boolean z2, Theme.ResourcesProvider resourcesProvider, boolean z3) {
        ...
        imageView2.setImageResource(C2702R.drawable.menu_phone);
        ...
        imageView3.setImageResource(C2702R.drawable.menu_videocall);
    ...
    public void setUser(TLRPC.User user) {
        ...
        if (UserObject.isBot(user)) {
            ...
            if (i > 0) {
                ...
                setSubtitle(LocaleController.getString(C2702R.string.Bot));
            }
        } else {
    ...
    public void setChat(TLRPC.Chat chat, int i) {
        ...
        this.imageView.setRoundRadius(AndroidUtilities.m1081dp(ChatObject.isForum(chat) ? 12.0f : 20.0f));
    ...
    public void setBoost(TL_stories.TL_myBoost tL_myBoost) {
        ...
        this.subtitleTextView.setTextColor(Theme.getColor(Theme.key_dialogTextGray3, this.resourcesProvider));
        setSubtitle(LocaleController.formatString(C2702R.string.BoostExpireOn, LocaleController.getInstance().getFormatterBoostExpired().format(new Date(((long) tL_myBoost.expires) * 1000))));
        int i = tL_myBoost.cooldown_until_date;
        if (i > 0) {
            setSubtitle(LocaleController.formatString(C2702R.string.BoostingAvailableIn, buildCountDownTime((((long) i) * 1000) - System.currentTimeMillis())));
    ...
    public void updateTimer() {
        ...
        setSubtitle(LocaleController.formatString(C2702R.string.BoostExpireOn, LocaleController.getInstance().getFormatterBoostExpired().format(new Date(((long) this.boost.expires) * 1000))));
    ...
    public static String buildCountDownTime(long j) {
        ...
        long j5 = (j3 % RealWebSocket.CANCEL_AFTER_CLOSE_MILLIS) / 1000;
