...
import org.telegram.p026ui.Components.Premium.PremiumPreviewBottomSheet;
import org.telegram.p026ui.Components.Premium.boosts.cells.ActionBtnCell;
...
public class PremiumPreviewGiftSentBottomSheet extends PremiumPreviewBottomSheet {
    ...
    @Override // org.telegram.p026ui.Components.Premium.PremiumPreviewBottomSheet
    ...
    public void setTitle(boolean z) {
        ...
        this.subtitleView.setPadding(AndroidUtilities.m1081dp(30.0f), 0, AndroidUtilities.m1081dp(30.0f), 0);
        this.subtitleView.setLineSpacing(AndroidUtilities.m1081dp(2.0f), 1.0f);
        ...
        ((ViewGroup.MarginLayoutParams) this.subtitleView.getLayoutParams()).bottomMargin = AndroidUtilities.m1081dp(16.0f);
        ((ViewGroup.MarginLayoutParams) this.subtitleView.getLayoutParams()).topMargin = AndroidUtilities.m1081dp(4.0f);
        int size = this.selectedUsers.size();
        if (size == 1) {
            string = LocaleController.formatString(C2702R.string.GiftPremiumUsersPurchasedManyZero, LocaleController.formatString(C2702R.string.GiftPremiumUsersOne, UserObject.getFirstName((TLRPC.User) this.selectedUsers.get(0))));
        } else if (size == 2) {
            string = LocaleController.formatString("GiftPremiumUsersPurchasedManyZero", C2702R.string.GiftPremiumUsersPurchasedManyZero, LocaleController.formatString("GiftPremiumUsersTwo", C2702R.string.GiftPremiumUsersTwo, UserObject.getFirstName((TLRPC.User) this.selectedUsers.get(0)), UserObject.getFirstName((TLRPC.User) this.selectedUsers.get(1))));
        } else if (size == 3) {
            string = LocaleController.formatString("GiftPremiumUsersPurchasedManyZero", C2702R.string.GiftPremiumUsersPurchasedManyZero, LocaleController.formatString("GiftPremiumUsersThree", C2702R.string.GiftPremiumUsersThree, UserObject.getFirstName((TLRPC.User) this.selectedUsers.get(0)), UserObject.getFirstName((TLRPC.User) this.selectedUsers.get(1)), UserObject.getFirstName((TLRPC.User) this.selectedUsers.get(2))));
        } else {
            string = LocaleController.formatPluralString("GiftPremiumUsersPurchasedMany", this.selectedUsers.size() - 3, LocaleController.formatString("GiftPremiumUsersThree", C2702R.string.GiftPremiumUsersThree, UserObject.getFirstName((TLRPC.User) this.selectedUsers.get(0)), UserObject.getFirstName((TLRPC.User) this.selectedUsers.get(1)), UserObject.getFirstName((TLRPC.User) this.selectedUsers.get(2))));
        }
        this.subtitleView.setText(AndroidUtilities.replaceTags(string));
        this.subtitleView.append("\n");
        this.subtitleView.append("\n");
        if (this.selectedUsers.size() == 1) {
            this.subtitleView.append(AndroidUtilities.replaceTags(LocaleController.formatString("GiftPremiumGiftsSentStatusForUser", C2702R.string.GiftPremiumGiftsSentStatusForUser, UserObject.getFirstName((TLRPC.User) this.selectedUsers.get(0)))));
        } else {
            this.subtitleView.append(AndroidUtilities.replaceTags(LocaleController.getString("GiftPremiumGiftsSentStatus", C2702R.string.GiftPremiumGiftsSentStatus)));
        }
    }
    ...
    static class AvatarHolderView extends FrameLayout {
        ...
        public static View createAvatarsContainer(Context context, List list) {
            ...
            for (int i2 = 0; i2 < list.size(); i2++) {
                ...
                avatarHolderView2.setTranslationX((-i2) * AndroidUtilities.m1081dp(29.0f));
                if (i2 == 0 && list.size() > 3) {
            ...
            frameLayout.setTranslationX(AndroidUtilities.m1081dp(14.5f) * (i - 1));
            return frameLayout;
        }
        ...
        public AvatarHolderView(Context context, float f) {
            ...
            backupImageView.setRoundRadius(AndroidUtilities.m1081dp(f));
    ...
    static class AdditionalCounterView extends View {
        ...
        public AdditionalCounterView(Context context) {
            ...
            this.paint.setTextSize(AndroidUtilities.m1081dp(11.5f));
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawCircle(measuredWidth, measuredHeight, (getMeasuredWidth() / 2.0f) - AndroidUtilities.m1081dp(1.5f), PremiumGradient.getInstance().getMainGradientPaint());
    ...
    private void init() {
        ...
        recyclerListView.setPadding(i, 0, i, AndroidUtilities.m1081dp(64.0f));
        ...
        if (i == 0) {
            view.setOutlineProvider(new ViewOutlineProvider() { // from class: org.telegram.ui.Components.Premium.boosts.PremiumPreviewGiftSentBottomSheet.1
                ...
                public void getOutline(View view2, Outline outline) {
                    ...
                    outline.setRoundRect(0, 0, view2.getWidth(), (int) (view2.getHeight() + fM1081dp), fM1081dp);
                }
            });
            view.setClipToOutline(true);
            view.setBackgroundColor(Theme.getColor(Theme.key_windowBackgroundGray, this.resourcesProvider));
            ((ViewGroup.MarginLayoutParams) view.getLayoutParams()).topMargin = -AndroidUtilities.m1081dp(6.0f);
        }
    }
