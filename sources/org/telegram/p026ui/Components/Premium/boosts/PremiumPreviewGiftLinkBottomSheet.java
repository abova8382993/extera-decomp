...
import org.telegram.p026ui.Components.Premium.GiftPremiumBottomSheet$GiftTier;
...
import org.telegram.p026ui.Components.Premium.boosts.cells.LinkCell;
...
public class PremiumPreviewGiftLinkBottomSheet extends PremiumPreviewBottomSheet {
    ...
    public void setTitle(boolean z) {
        ...
        ((ViewGroup.MarginLayoutParams) this.subtitleView.getLayoutParams()).bottomMargin = AndroidUtilities.m1081dp(14.0f);
        ((ViewGroup.MarginLayoutParams) this.subtitleView.getLayoutParams()).topMargin = AndroidUtilities.m1081dp(12.0f);
        this.subtitleView.setText(AndroidUtilities.replaceCharSequence("%1$s", AndroidUtilities.replaceSingleTag(LocaleController.getString("GiftPremiumAboutThisLink", C2702R.string.GiftPremiumAboutThisLink), Theme.key_chat_messageLinkIn, 0, new PremiumPreviewGiftLinkBottomSheet$$ExternalSyntheticLambda1(this)), AndroidUtilities.replaceTags(LocaleController.getString("GiftPremiumAboutThisLinkEnd", C2702R.string.GiftPremiumAboutThisLinkEnd))));
    }
    ...
    public /* synthetic */ boolean lambda$share$0(String str, DialogsActivity dialogsActivity, ArrayList arrayList, CharSequence charSequence, boolean z, boolean z2, int i, int i2, TopicsFragment topicsFragment) {
        ...
        while (i3 < arrayList.size()) {
            ...
            getBaseFragment().getSendMessagesHelper().sendMessage(SendMessagesHelper.SendMessageParams.m1124of(str, j2, null, null, null, true, null, null, null, true, 0, 0, null, false));
            i3++;
            j = j2;
        }
    ...
    protected View onCreateAdditionCell(int i, Context context) {
        ...
        linkCell.setPadding(0, 0, 0, AndroidUtilities.m1081dp(8.0f));
        return linkCell;
    }
    ...
    class C46211 implements Bulletin.Delegate {
