...
import org.telegram.p026ui.Components.Premium.boosts.SelectorBottomSheet;
import org.telegram.p026ui.Components.Premium.boosts.adapters.BoostAdapter;
import org.telegram.p026ui.Components.Premium.boosts.cells.ActionBtnCell;
import org.telegram.p026ui.Components.Premium.boosts.cells.AddChannelCell;
import org.telegram.p026ui.Components.Premium.boosts.cells.BaseCell;
import org.telegram.p026ui.Components.Premium.boosts.cells.BoostTypeCell;
import org.telegram.p026ui.Components.Premium.boosts.cells.ChatCell;
import org.telegram.p026ui.Components.Premium.boosts.cells.DateEndCell;
import org.telegram.p026ui.Components.Premium.boosts.cells.DurationCell;
import org.telegram.p026ui.Components.Premium.boosts.cells.EnterPrizeCell;
import org.telegram.p026ui.Components.Premium.boosts.cells.ParticipantsTypeCell;
import org.telegram.p026ui.Components.Premium.boosts.cells.StarGiveawayOptionCell;
import org.telegram.p026ui.Components.Premium.boosts.cells.SwitcherCell;
...
public class BoostViaGiftsBottomSheet extends BottomSheetWithRecyclerListView implements SelectorBottomSheet.SelectedObjectsListener, NotificationCenter.NotificationCenterDelegate {
    ...
    public BoostViaGiftsBottomSheet(final BaseFragment baseFragment, boolean z, boolean z2, final long j, final TL_stories.PrepaidGiveaway prepaidGiveaway) {
        ...
        recyclerListView.setPadding(i, 0, i, AndroidUtilities.m1081dp(68.0f));
    ...
    public /* synthetic */ void lambda$new$8(TL_stories.TL_prepaidStarsGiveaway tL_prepaidStarsGiveaway, long j, final long j2, final TL_stories.PrepaidGiveaway prepaidGiveaway, Void r7) {
        ...
        if (tL_prepaidStarsGiveaway != null) {
            ...
            if (safeLastFragment != null) {
                ...
                chatActivityM1188of.whenFullyVisible(new Runnable() { // from class: org.telegram.ui.Components.Premium.boosts.BoostViaGiftsBottomSheet$$ExternalSyntheticLambda26
                    @Override // java.lang.Runnable
                    public final void run() {
                        BulletinFactory.m1195of(chatActivityM1188of).createSimpleBulletin(C2702R.raw.stars_topup, LocaleController.getString(C2702R.string.StarsGiveawaySentPopup), AndroidUtilities.replaceTags(LocaleController.formatPluralStringComma("StarsGiveawaySentPopupInfo", (int) j2))).show(true);
                    }
                });
    ...
    public /* synthetic */ void lambda$new$12(final TL_stars.TL_starsGiveawayOption tL_starsGiveawayOption, Boolean bool, String str) {
        ...
        lambda$new$0();
        final ChatActivity chatActivityM1188of = ChatActivity.m1188of(-this.currentChat.f1610id);
        safeLastFragment.presentFragment(chatActivityM1188of);
        safeLastFragment.whenFullyVisible(new Runnable() { // from class: org.telegram.ui.Components.Premium.boosts.BoostViaGiftsBottomSheet$$ExternalSyntheticLambda25
            @Override // java.lang.Runnable
            public final void run() {
                BulletinFactory.m1195of(chatActivityM1188of).createSimpleBulletin(C2702R.raw.stars_send, LocaleController.getString(C2702R.string.StarsGiveawaySentPopup), AndroidUtilities.replaceTags(LocaleController.formatPluralStringComma("StarsGiveawaySentPopupInfo", (int) tL_starsGiveawayOption.stars))).setDuration(5000).show(true);
            }
        });
    ...
    public int getTop() {
        return Math.max(-AndroidUtilities.m1081dp(16.0f), this.top - (this.actionBar.getVisibility() == 0 ? AndroidUtilities.statusBarHeight + AndroidUtilities.m1081dp(16.0f) : 0));
    }
    ...
    */
    private void updateRows(boolean r26, boolean r27) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.Premium.boosts.BoostViaGiftsBottomSheet.updateRows(boolean, boolean):void");
    }
    ...
    protected CharSequence getTitle() {
        ...
        return LocaleController.formatString("BoostingStartGiveaway", C2702R.string.BoostingStartGiveaway, new Object[0]);
    }
