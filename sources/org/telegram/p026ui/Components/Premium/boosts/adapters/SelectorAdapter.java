...
import org.telegram.p026ui.Components.Premium.boosts.cells.selector.SelectorLetterCell;
...
public class SelectorAdapter extends AdapterWithDiffUtils {
    ...
    public void setTopSectionClickListener(View.OnClickListener onClickListener) {
        ...
        if (graySectionCell != null) {
            if (onClickListener == null) {
                ...
                graySectionCell.setRightText(LocaleController.getString(C2702R.string.UsersDeselectAll), true, onClickListener);
            }
        }
    }
    ...
    public static class Item extends AdapterWithDiffUtils.Item {
        ...
        public boolean equals(Object obj) {
            ...
            if (this.viewType != 9 || (TextUtils.equals(this.text, item.text) && this.f2000id == item.f2000id && this.resId == item.resId)) {
