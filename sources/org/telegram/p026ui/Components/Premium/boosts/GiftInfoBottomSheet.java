...
import org.telegram.p026ui.Components.Premium.boosts.adapters.GiftInfoAdapter;
...
public class GiftInfoBottomSheet extends BottomSheetWithRecyclerListView {
    ...
    protected CharSequence getTitle() {
        return this.isUnused ? LocaleController.getString(C2702R.string.BoostingGiftLink) : LocaleController.getString(C2702R.string.BoostingUsedGiftLink);
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.Premium.boosts.GiftInfoBottomSheet$2 */
    /* JADX INFO: loaded from: classes5.dex */
    class C46202 extends GiftInfoAdapter {
        C46202(Theme.ResourcesProvider resourcesProvider) {
            super(resourcesProvider);
        }

        @Override // org.telegram.p026ui.Components.Premium.boosts.adapters.GiftInfoAdapter
        ...
        protected void onObjectClicked(TLObject tLObject) {
            ...
            if (tLObject instanceof TLRPC.Chat) {
                GiftInfoBottomSheet.this.getBaseFragment().presentFragment(ChatActivity.m1188of(-((TLRPC.Chat) tLObject).f1610id));
                return;
            }
            if (tLObject instanceof TLRPC.User) {
                GiftInfoBottomSheet.this.getBaseFragment().presentFragment(ChatActivity.m1188of(((TLRPC.User) tLObject).f1775id));
                return;
            }
        ...
        protected void onHiddenLinkClicked() {
            ...
            if ((GiftInfoBottomSheet.this.slug == null || GiftInfoBottomSheet.this.slug.isEmpty()) && GiftInfoBottomSheet.this.giftCode.to_id == -1) {
                string = LocaleController.getString(C2702R.string.BoostingOnlyGiveawayCreatorSeeLink);
            } else {
                string = LocaleController.getString(C2702R.string.BoostingOnlyRecipientCode);
            }
            GiftInfoBottomSheet giftInfoBottomSheet = GiftInfoBottomSheet.this;
            BulletinFactory.m1194of(giftInfoBottomSheet.container, ((BottomSheet) giftInfoBottomSheet).resourcesProvider).createSimpleBulletin(C2702R.raw.chats_infotip, string).show(true);
        }
    }

    @Override // org.telegram.p026ui.Components.BottomSheetWithRecyclerListView
    protected RecyclerListView.SelectionAdapter createAdapter(RecyclerListView recyclerListView) {
        C46202 c46202 = new C46202(this.resourcesProvider);
        this.adapter = c46202;
        return c46202;
    }
}
