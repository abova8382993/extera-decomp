...
import org.telegram.p026ui.Components.Premium.HelloParticles;
...
public class VideoScreenPreview extends FrameLayout implements PagerHeaderView, NotificationCenter.NotificationCenterDelegate {
    ...
    public VideoScreenPreview(Context context, SvgHelper.SvgDrawable svgDrawable, int i, int i2, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (i2 == 1) {
            ...
            SpeedLineParticles$Drawable speedLineParticles$Drawable = new SpeedLineParticles$Drawable(DataTypes.EMPTY);
            ...
            drawable3.size1 = 4;
            drawable3.f1994k3 = 0.98f;
            drawable3.f1993k2 = 0.98f;
            drawable3.f1992k1 = 0.98f;
        ...
        AspectRatioFrameLayout aspectRatioFrameLayout = new AspectRatioFrameLayout(context) { // from class: org.telegram.ui.Components.Premium.VideoScreenPreview.1
            ...
            protected void onMeasure(int i4, int i5) {
                ...
                float fM1081dp = VideoScreenPreview.this.roundRadius - AndroidUtilities.m1081dp(3.0f);
                this.clipPath.addRoundRect(AndroidUtilities.rectTmp, fM1081dp, fM1081dp, Path.Direction.CW);
            }
        ...
        if (premiumPromo != null) {
            ...
            while (true) {
                if (i >= premiumPromo.video_sections.size()) {
                    i = -1;
                    break;
                } else if (((String) premiumPromo.video_sections.get(i)).equals(strFeatureTypeToServerString)) {
                    break;
                } else {
                    i++;
                }
            ...
            if (i >= 0) {
                final TLRPC.Document document = (TLRPC.Document) premiumPromo.videos.get(i);
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.size != measuredWidth) {
            ...
            if (matrixParticlesDrawable != null) {
                ...
                this.matrixParticlesDrawable.excludeRect.inset(AndroidUtilities.m1081dp(16.0f), AndroidUtilities.m1081dp(16.0f));
            }
            ...
            if (drawable != null) {
                ...
                if (i5 == 6 || i5 == 9 || i5 == 3 || i5 == 7 || i5 == 24 || i5 == 11 || i5 == 4) {
                    ...
                    this.starDrawable.rect.inset(AndroidUtilities.m1081dp(30.0f), AndroidUtilities.m1081dp(30.0f));
                } else {
                    RectF rectF = AndroidUtilities.rectTmp;
                ...
                this.starDrawable.excludeRect.inset(AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(10.0f));
            }
            ...
            if (speedLineParticles$Drawable != null) {
                ...
                this.speedLinesDrawable.rect.inset(AndroidUtilities.m1081dp(100.0f), AndroidUtilities.m1081dp(100.0f));
            ...
            if (drawable2 != null) {
                ...
                this.helloParticlesDrawable.rect.inset(AndroidUtilities.m1081dp(0.0f), getMeasuredHeight() * 0.1f);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.inset(-AndroidUtilities.m1081dp(3.0f), -AndroidUtilities.m1081dp(3.0f));
        rectF.inset(-AndroidUtilities.m1081dp(3.0f), -AndroidUtilities.m1081dp(3.0f));
        canvas.drawRoundRect(rectF, this.roundRadius + AndroidUtilities.m1081dp(3.0f), this.roundRadius + AndroidUtilities.m1081dp(3.0f), this.phoneFrame2);
        rectF.inset(AndroidUtilities.m1081dp(3.0f), AndroidUtilities.m1081dp(3.0f));
        ...
        float fM1081dp = this.roundRadius - AndroidUtilities.m1081dp(3.0f);
        this.roundRadius = fM1081dp;
        RoundedBitmapDrawable roundedBitmapDrawable = this.roundedBitmapDrawable;
        if (roundedBitmapDrawable != null) {
            roundedBitmapDrawable.setCornerRadius(fM1081dp);
        }
        ...
        canvas.drawCircle(this.imageReceiver.getCenterX(), this.imageReceiver.getImageY() + AndroidUtilities.m1081dp(12.0f), AndroidUtilities.m1081dp(6.0f), this.phoneFrame1);
    }

    @Override // org.telegram.p026ui.Components.Premium.PagerHeaderView
        ...
        if ((this.file != null || SharedConfig.streamMedia) && this.videoPlayerBase == null) {
            ...
            if (file != null && file.exists()) {
                ...
                try {
                    ...
                    sb.append("&id=");
                    sb.append(this.document.f1618id);
                    sb.append("&hash=");
