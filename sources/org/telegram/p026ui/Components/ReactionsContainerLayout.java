...
public class ReactionsContainerLayout extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ReactionsContainerLayout(final int i, BaseFragment baseFragment, Context context, int i2, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.rect = new RectF();
        this.mPath = new Path();
        this.radius = AndroidUtilities.m1081dp(72.0f);
        float fM1081dp = AndroidUtilities.m1081dp(8.0f);
        this.bigCircleRadius = fM1081dp;
        this.smallCircleRadius = fM1081dp / 2.0f;
        this.bigCircleOffset = AndroidUtilities.m1081dp(36.0f);
        ...
        this.shadow = ContextCompat.getDrawable(context, C2702R.drawable.reactions_bubble_shadow).mutate();
        Rect rect = this.shadowPad;
        int iM1081dp = AndroidUtilities.m1081dp(7.0f);
        rect.bottom = iM1081dp;
        rect.right = iM1081dp;
        rect.top = iM1081dp;
        rect.left = iM1081dp;
        ...
        C47152 c47152 = new RecyclerListView(context) { // from class: org.telegram.ui.Components.ReactionsContainerLayout.2
            C47152(Context context2) {
                super(context2);
            }
        ...
        this.recyclerListView = c47152;
        c47152.setClipChildren(false);
        c47152.setClipToPadding(false);
        this.linearLayoutManager = new LinearLayoutManager(context2, 0, false) { // from class: org.telegram.ui.Components.ReactionsContainerLayout.3
            C47163(Context context2, int i3, boolean z) {
                super(context2, i3, z);
            }
        ...
        c47152.addItemDecoration(new RecyclerView.ItemDecoration() { // from class: org.telegram.ui.Components.ReactionsContainerLayout.4
            C47174() {
            }
            ...
            public void getItemOffsets(Rect rect2, View view, RecyclerView recyclerView, RecyclerView.State state) {
                ...
                if (!ReactionsContainerLayout.this.showCustomEmojiReaction()) {
                    ...
                    if (childAdapterPosition == 0) {
                        rect2.left = AndroidUtilities.m1081dp(6.0f);
                    }
                    rect2.right = AndroidUtilities.m1081dp(4.0f);
                    if (childAdapterPosition == ReactionsContainerLayout.this.listAdapter.getItemCount() - 1) {
                        if (ReactionsContainerLayout.this.showUnlockPremiumButton() || ReactionsContainerLayout.this.showCustomEmojiReaction()) {
                            rect2.right = AndroidUtilities.m1081dp(2.0f);
                            return;
                        } else {
                            rect2.right = AndroidUtilities.m1081dp(6.0f);
                            return;
                        }
                    }
                    return;
        ...
        c47152.setLayoutManager(this.linearLayoutManager);
        c47152.setOverScrollMode(2);
        Adapter adapter = new Adapter();
        this.listAdapter = adapter;
        c47152.setAdapter(adapter);
        c47152.addOnScrollListener(new LeftRightShadowsListener());
        c47152.addOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.Components.ReactionsContainerLayout.5
            C47185() {
            }
        ...
        c47152.addItemDecoration(new RecyclerView.ItemDecoration() { // from class: org.telegram.ui.Components.ReactionsContainerLayout.6
            C47196() {
            }
            ...
            public void getItemOffsets(Rect rect2, View view, RecyclerView recyclerView, RecyclerView.State state) {
                int childAdapterPosition = recyclerView.getChildAdapterPosition(view);
                if (childAdapterPosition == 0) {
                    rect2.left = AndroidUtilities.m1081dp(8.0f);
                }
                if (childAdapterPosition == ReactionsContainerLayout.this.listAdapter.getItemCount() - 1) {
                    rect2.right = AndroidUtilities.m1081dp(8.0f);
                }
            }
        });
        c47152.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.telegram.ui.Components.ReactionsContainerLayout$$ExternalSyntheticLambda0
            @Override // org.telegram.ui.Components.RecyclerListView.OnItemClickListener
            public final void onItemClick(View view, int i3) {
                this.f$0.lambda$new$0(view, i3);
            }
        });
        c47152.setOnItemLongClickListener(new RecyclerListView.OnItemLongClickListener() { // from class: org.telegram.ui.Components.ReactionsContainerLayout$$ExternalSyntheticLambda1
            @Override // org.telegram.ui.Components.RecyclerListView.OnItemLongClickListener
            public final boolean onItemClick(View view, int i3) {
                return this.f$0.lambda$new$1(i, view, i3);
            }
        });
        addView(c47152, LayoutHelper.createFrame(-1, -1.0f));
        setClipChildren(false);
        setClipToPadding(false);
        invalidateShaders();
        int paddingTop = (c47152.getLayoutParams().height - c47152.getPaddingTop()) - c47152.getPaddingBottom();
        this.nextRecentReaction.getLayoutParams().width = paddingTop - AndroidUtilities.m1081dp(12.0f);
    ...
    class C47152 extends RecyclerListView {
        C47152(Context context2) {
            super(context2);
        }
    ...
    class C47163 extends LinearLayoutManager {
        C47163(Context context2, int i3, boolean z) {
            super(context2, i3, z);
        }
    ...
    class C47174 extends RecyclerView.ItemDecoration {
        C47174() {
        }
    ...
    class C47185 extends RecyclerView.OnScrollListener {
        C47185() {
        }
    ...
    class C47196 extends RecyclerView.ItemDecoration {
        C47196() {
        }
    ...
    private void setVisibleReactionsList(List list, boolean z) {
        ...
        if (showCustomEmojiReaction()) {
            int iM1081dp = (AndroidUtilities.displaySize.x - AndroidUtilities.m1081dp(36.0f)) / AndroidUtilities.m1081dp(34.0f);
            if (iM1081dp > 7) {
                iM1081dp = 7;
            }
            int i = 0;
            ...
            while (i < Math.min(list.size(), iM1081dp)) {
        ...
        if ((((getLayoutParams().height - ((int) getTopOffset())) - getPaddingTop()) - getPaddingBottom()) * list.size() < AndroidUtilities.m1081dp(200.0f)) {
    ...
    */
    protected void dispatchDraw(android.graphics.Canvas r24) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.ReactionsContainerLayout.dispatchDraw(android.graphics.Canvas):void");
    }

    public void drawBubbles(Canvas canvas) {
        float fMax = (Math.max(0.25f, Math.min(this.transitionProgress, 1.0f)) - 0.25f) / 0.75f;
        drawBubbles(canvas, this.bigCircleRadius * fMax, fMax, this.smallCircleRadius * fMax, this.type == 5 ? Function.USE_VARARGS : (int) (Utilities.clamp(this.customEmojiReactionsEnterProgress / 0.2f, 1.0f, 0.0f) * (1.0f - this.customEmojiReactionsEnterProgress) * 255.0f));
    }
    ...
    private void drawBubbles(Canvas canvas, float f, float f2, float f3, int i) {
        ...
        if (this.isTop) {
            ...
            canvas.clipRect(0.0f, (AndroidUtilities.lerp(f5, 0.0f, cubicBezierInterpolator.getInterpolation(this.flipVerticalProgress)) - ((int) Math.ceil((this.rect.height() / 2.0f) * (1.0f - this.transitionProgress)))) - 1.0f, getMeasuredWidth(), AndroidUtilities.lerp(getMeasuredHeight() + AndroidUtilities.m1081dp(8.0f), getPaddingTop() - expandSize(), cubicBezierInterpolator.getInterpolation(this.flipVerticalProgress)));
        }
        ...
        int iM1081dp = AndroidUtilities.m1081dp(3.0f);
        ...
        float fLerp = AndroidUtilities.lerp(this.isTop ? (getPaddingTop() - expandSize()) - AndroidUtilities.m1081dp(16.0f) : ((getHeight() - this.smallCircleRadius) - f7) + expandSize(), (this.smallCircleRadius + f7) - expandSize(), CubicBezierInterpolator.DEFAULT.getInterpolation(this.flipVerticalProgress));
        float f12 = (-AndroidUtilities.m1081dp(1.0f)) * f2;
        ...
        canvas.restore();
        this.shadow.setAlpha(Function.USE_VARARGS);
        this.bgPaint.setAlpha(Function.USE_VARARGS);
    }
    ...
    private void checkPressedProgress(Canvas canvas, ReactionHolderView reactionHolderView) {
        ...
        float fClamp = this.pullingLeftOffset != 0.0f ? Utilities.clamp(reactionHolderView.getLeft() / (getMeasuredWidth() - AndroidUtilities.m1081dp(34.0f)), 1.0f, 0.0f) * getPullingLeftProgress() * AndroidUtilities.m1081dp(46.0f) : 0.0f;
    ...
    public float getPullingLeftProgress() {
        return Utilities.clamp(this.pullingLeftOffset / AndroidUtilities.m1081dp(42.0f), 2.0f, 0.0f);
    }
    ...
    private void invalidateShaders() {
        ...
        paint.setShader(new LinearGradient(0.0f, height, iM1081dp, height, color, 0, tileMode));
        this.rightShadowPaint.setShader(new LinearGradient(getWidth(), height, getWidth() - iM1081dp, height, color, 0, tileMode));
        invalidate();
    }
    ...
    public void setMessage(MessageObject messageObject, TLRPC.ChatFull chatFull, boolean z) {
        ...
        if (i3 == 3) {
            ...
            if (chatReactions instanceof TLRPC.TL_chatReactionsAll) {
                TLRPC.Chat chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(chatFull.f1611id));
    ...
    class C47207 extends AnimatorListenerAdapter {
        C47207() {
        }
    ...
    public int getTotalWidth() {
        ...
        if (!showCustomEmojiReaction()) {
            return (AndroidUtilities.m1081dp(36.0f) * itemsCount) + (AndroidUtilities.m1081dp(2.0f) * (itemsCount - 1)) + AndroidUtilities.m1081dp(16.0f);
        }
        return (AndroidUtilities.m1081dp(36.0f) * itemsCount) - AndroidUtilities.m1081dp(4.0f);
    }
    ...
    public void setCustomEmojiReactionsBackground(boolean z) {
        if (z) {
            this.customEmojiReactionsIconView.setBackground(Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m1081dp(28.0f), 0, ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_listSelector), 40)));
        } else {
    ...
    public void setHint(CharSequence charSequence) {
        ...
        ((FrameLayout.LayoutParams) this.nextRecentReaction.getLayoutParams()).topMargin = AndroidUtilities.m1081dp(20.0f);
        ((FrameLayout.LayoutParams) this.recyclerListView.getLayoutParams()).topMargin = AndroidUtilities.m1081dp(20.0f);
    }
    ...
    public void measureHint() {
        ...
        int iMin = Math.min(AndroidUtilities.m1081dp(320.0f), getMeasuredWidth() - AndroidUtilities.m1081dp(16.0f));
        ...
        if (staticLayout.getLineCount() > 1 && !this.hintView.getText().toString().contains("\n")) {
            ...
            this.hintView.setPadding(AndroidUtilities.m1081dp(24.0f), 0, AndroidUtilities.m1081dp(24.0f), 0);
            this.hintView.setWidth(AndroidUtilities.m1081dp(48.0f) + iCutInFancyHalf);
        } else {
            this.hintView.setWidth(AndroidUtilities.m1081dp(16.0f) + iMin);
        }
        int iMax = Math.max(AndroidUtilities.m1081dp(20.0f), AndroidUtilities.m1081dp(7.0f) + this.hintViewHeight);
        int i3 = this.type;
        if (i3 == 1 || i3 == 2) {
            iMax = AndroidUtilities.m1081dp(20.0f);
        } else {
            getLayoutParams().height = AndroidUtilities.m1081dp(52.0f) + iMax + AndroidUtilities.m1081dp(22.0f);
        }
    ...
    final class LeftRightShadowsListener extends RecyclerView.OnScrollListener {
        ...
        class C47291 extends AnimatorListenerAdapter {
            final /* synthetic */ Runnable val$onEnd;
    ...
    public final class ReactionHolderView extends FrameLayout {
        ...
        class RunnableC47311 implements Runnable {
            RunnableC47311() {
            }
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            if (visibleReaction != null) {
                ...
                if (str != null) {
                    ...
                    accessibilityNodeInfo.setText(LocaleController.getString(C2702R.string.AccDescrCustomEmoji));
                    accessibilityNodeInfo.setEnabled(true);
                }
            }
        }
        ...
        ReactionHolderView(Context context, boolean z) {
            ...
            this.enterImageView = new C47322(context, ReactionsContainerLayout.this);
            this.loopImageView = new BackupImageView(context) { // from class: org.telegram.ui.Components.ReactionsContainerLayout.ReactionHolderView.3
                ...
                C47343(Context context2, ReactionsContainerLayout reactionsContainerLayout) {
                    super(context2);
                ...
                @Override // org.telegram.p026ui.Components.BackupImageView
            ...
            this.pressedBackupImageView = new BackupImageView(context2) { // from class: org.telegram.ui.Components.ReactionsContainerLayout.ReactionHolderView.4
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C47354(Context context2, ReactionsContainerLayout reactionsContainerLayout) {
                    super(context2);
                    reactionsContainerLayout = reactionsContainerLayout;
                }
        ...
        class C47322 extends BackupImageView {
            final /* synthetic */ ReactionsContainerLayout val$this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C47322(Context context, ReactionsContainerLayout reactionsContainerLayout) {
                super(context);
        ...
        class C47343 extends BackupImageView {
            final /* synthetic */ ReactionsContainerLayout val$this$0;
        ...
        class C47354 extends BackupImageView {
            final /* synthetic */ ReactionsContainerLayout val$this$0;
        ...
        public void setReaction(ReactionsLayoutInBubble.VisibleReaction visibleReaction, int i) {
            ...
            int iM1081dp2 = AndroidUtilities.m1081dp(34.0f);
            layoutParams4.height = iM1081dp2;
            layoutParams3.width = iM1081dp2;
        }
        ...
        private void updateImage(ReactionsLayoutInBubble.VisibleReaction visibleReaction) {
            if (visibleReaction != null && visibleReaction.isStar) {
                this.enterImageView.getImageReceiver().setImageBitmap(new RLottieDrawable(C2702R.raw.star_reaction, "star_reaction", AndroidUtilities.m1081dp(30.0f), AndroidUtilities.m1081dp(30.0f)));
                this.loopImageView.getImageReceiver().setImageBitmap(getContext().getResources().getDrawable(C2702R.drawable.star_reaction));
        ...
        class RunnableC47365 implements Runnable {
            RunnableC47365() {
            }
        ...
        protected void dispatchDraw(Canvas canvas) {
            if (this.selected && this.drawSelected) {
                ...
                float measuredWidth2 = (getMeasuredWidth() >> 1) - AndroidUtilities.m1081dp(1.0f);
                ReactionsLayoutInBubble.VisibleReaction visibleReaction = this.currentReaction;
            ...
            if (animatedEmojiDrawable != null && animatedEmojiDrawable.getImageReceiver() != null) {
                if (this.position == 0) {
                    this.loopImageView.animatedEmojiDrawable.getImageReceiver().setRoundRadius(AndroidUtilities.m1081dp(6.0f), 0, 0, AndroidUtilities.m1081dp(6.0f));
                } else {
                    this.loopImageView.animatedEmojiDrawable.getImageReceiver().setRoundRadius(this.selected ? AndroidUtilities.m1081dp(6.0f) : 0);
                }
            }
            ReactionsLayoutInBubble.VisibleReaction visibleReaction2 = this.currentReaction;
    ...
    class C47218 implements ValueAnimator.AnimatorUpdateListener {
        final /* synthetic */ float val$fromProgress;
    ...
    /* JADX INFO: loaded from: classes5.dex */
    class C47229 extends AnimatorListenerAdapter {
        C47229() {
        }
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        if (i == NotificationCenter.chatInfoDidLoad) {
            ...
            if (chatFull.f1611id != this.waitingLoadingChatId || getVisibility() == 0 || (chatFull.available_reactions instanceof TLRPC.TL_chatReactionsNone)) {
                return;
            }
    ...
    public float expandSize() {
        return (int) (getPullingLeftProgress() * AndroidUtilities.m1081dp(6.0f));
    }
    ...
    public class Adapter extends AdapterWithDiffUtils {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 1) {
                ...
                ReactionsContainerLayout.this.premiumLockIconView.setPadding(AndroidUtilities.m1081dp(1.0f), AndroidUtilities.m1081dp(1.0f), AndroidUtilities.m1081dp(1.0f), AndroidUtilities.m1081dp(1.0f));
                ReactionsContainerLayout reactionsContainerLayout = ReactionsContainerLayout.this;
                ...
                ReactionsContainerLayout.this.customEmojiReactionsIconView.setImageResource(C2702R.drawable.msg_reactions_expand);
                ...
                ReactionsContainerLayout.this.customEmojiReactionsIconView.setBackground(Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m1081dp(28.0f), 0, ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_listSelector), 40)));
                ReactionsContainerLayout.this.customEmojiReactionsIconView.setPadding(AndroidUtilities.m1081dp(2.0f), AndroidUtilities.m1081dp(2.0f), AndroidUtilities.m1081dp(2.0f), AndroidUtilities.m1081dp(2.0f));
                ReactionsContainerLayout.this.customEmojiReactionsIconView.setContentDescription(LocaleController.getString(C2702R.string.AccDescrExpandPanel));
            ...
            reactionHolderView.setLayoutParams(new RecyclerView.LayoutParams(topOffset - AndroidUtilities.m1081dp(12.0f), topOffset));
    ...
    private Paint getStarGradientPaint(RectF rectF, float f) {
        ...
        if (this.starSelectedGradient == null) {
            ...
            LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, AndroidUtilities.m1081dp(64.0f), 0.0f, new int[]{color, Theme.multAlpha(color, 0.0f)}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP);
