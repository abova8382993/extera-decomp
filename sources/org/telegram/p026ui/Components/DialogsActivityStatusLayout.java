...
public class DialogsActivityStatusLayout extends View {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.telegramLogoRectF.set(AndroidUtilities.m1081dp(12.0f), (paddingTop + (currentActionBarHeight / 2)) - AndroidUtilities.m1081dp(15.0f), AndroidUtilities.m1081dp(12.0f) + AndroidUtilities.m1081dp(30.0f), r0 + AndroidUtilities.m1081dp(30.0f));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float fLerp = AndroidUtilities.lerp(AndroidUtilities.m1081dp(15.0f), 0, floatValue);
