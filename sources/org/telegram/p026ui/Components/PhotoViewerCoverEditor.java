...
import org.telegram.p026ui.Stories.recorder.GallerySheet;
...
public class PhotoViewerCoverEditor extends FrameLayout {
    ...
    public PhotoViewerCoverEditor(final Context context, final Theme.ResourcesProvider resourcesProvider, PhotoViewer photoViewer, BlurringShader.BlurManager blurManager) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2702R.string.EditorSetCoverTitle));
        ...
        buttonWithCounterView.setText(LocaleController.getString(C2702R.string.EditorSetCoverSave), false);
        addView(this.button, LayoutHelper.createFrame(-1, 48.0f, 87, 10.0f, 10.0f, 10.0f, 10.0f));
        EditCoverButton editCoverButton = new EditCoverButton(context, photoViewer, LocaleController.getString(C2702R.string.EditorSetCoverGallery), true);
        ...
        this.timelineView.setDelegate(new C45092());
    }
    ...
    public /* synthetic */ void lambda$new$1(Context context, Theme.ResourcesProvider resourcesProvider, View view) {
        if (this.gallerySheet == null) {
            GallerySheet gallerySheet = new GallerySheet(context, resourcesProvider, LocaleController.getString(C2702R.string.VideoChooseCover), true, this.aspectRatio);
    ...
    class C45092 implements TimelineView.TimelineDelegate {
