...
import org.telegram.p026ui.Components.UsersAlertBase;
...
public class InviteMembersBottomSheet extends UsersAlertBase implements NotificationCenter.NotificationCenterDelegate {
    ...
    public InviteMembersBottomSheet(final Context context, int i, final LongSparseArray longSparseArray, final long j, final BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.chatId = j;
        fixNavigationBar();
        this.searchView.searchEditText.setHint(LocaleController.getString(C2702R.string.SearchForChats));
        ...
        ScrollView scrollView = new ScrollView(context) { // from class: org.telegram.ui.Components.InviteMembersBottomSheet.2
            ...
            protected void onMeasure(int i3, int i4) {
                ...
                if (AndroidUtilities.isTablet() || size2 > size) {
                    InviteMembersBottomSheet.this.maxSize = AndroidUtilities.m1081dp(144.0f);
                } else {
                    InviteMembersBottomSheet.this.maxSize = AndroidUtilities.m1081dp(56.0f);
                }
        ...
        fragmentFloatingButton.setContentDescription(LocaleController.getString(C2702R.string.Next));
        this.containerView.addView(fragmentFloatingButton, FragmentFloatingButton.createDefaultLayoutParams());
        ((ViewGroup.MarginLayoutParams) this.emptyView.getLayoutParams()).topMargin = AndroidUtilities.m1081dp(20.0f);
        ((ViewGroup.MarginLayoutParams) this.emptyView.getLayoutParams()).leftMargin = AndroidUtilities.m1081dp(4.0f);
        ((ViewGroup.MarginLayoutParams) this.emptyView.getLayoutParams()).rightMargin = AndroidUtilities.m1081dp(4.0f);
    }
    ...
    */
    public /* synthetic */ void lambda$new$0(long r4, org.telegram.p026ui.ActionBar.BaseFragment r6, androidx.collection.LongSparseArray r7, android.content.Context r8, android.view.View r9, int r10) {
        /*
            Method dump skipped, instruction units count: 364
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.InviteMembersBottomSheet.lambda$new$0(long, org.telegram.ui.ActionBar.BaseFragment, androidx.collection.LongSparseArray, android.content.Context, android.view.View, int):void");
    }
    ...
    public /* synthetic */ void lambda$new$2(Context context, long j, View view) {
        ...
        if (this.selectedContacts.size() > 5) {
            ...
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("AddMembersAlertNamesText", C2702R.string.AddMembersAlertNamesText, sb, chat.title)));
        }
        builder.setPositiveButton(LocaleController.getString(C2702R.string.Add), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.InviteMembersBottomSheet$$ExternalSyntheticLambda5
    ...
    @Override // org.telegram.p026ui.Components.UsersAlertBase, org.telegram.p026ui.ActionBar.BottomSheet, android.app.Dialog, android.content.DialogInterface, org.telegram.ui.ActionBar.BaseFragment.AttachedSheet
    ...
    */
    public void setSelectedContacts(java.util.ArrayList r12) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.InviteMembersBottomSheet.setSelectedContacts(java.util.ArrayList):void");
    }
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i != 2) {
                ...
                if (i == 3) {
                    ...
                    manageChatTextCell.setText(LocaleController.getString(C2702R.string.VoipGroupCopyInviteLink), null, C2702R.drawable.msg_link, 7, true);
                    ...
                    if (InviteMembersBottomSheet.this.dialogsDelegate != null) {
                        stickerEmptyView.title.setText(LocaleController.getString(C2702R.string.FilterNoChats));
                    } else {
                ...
                groupCreateUserCell = new View(context) { // from class: org.telegram.ui.Components.InviteMembersBottomSheet.ListAdapter.1
                    ...
                    protected void onMeasure(int i4, int i5) {
                        super.onMeasure(i4, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(48.0f) + InviteMembersBottomSheet.this.additionalHeight, TLObject.FLAG_30));
                    }
                };
            }
        ...
        public TLObject getObject(int i) {
            if (InviteMembersBottomSheet.this.dialogsDelegate != null) {
                ...
                return DialogObject.isUserDialog(dialog.f1616id) ? MessagesController.getInstance(((BottomSheet) InviteMembersBottomSheet.this).currentAccount).getUser(Long.valueOf(dialog.f1616id)) : MessagesController.getInstance(((BottomSheet) InviteMembersBottomSheet.this).currentAccount).getChat(Long.valueOf(-dialog.f1616id));
            }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (object2 instanceof TLRPC.User) {
                j = ((TLRPC.User) object2).f1775id;
            } else {
                j = object2 instanceof TLRPC.Chat ? -((TLRPC.Chat) object2).f1610id : 0L;
            }
            groupCreateUserCell.setObject(object, null, null, i != InviteMembersBottomSheet.this.contactsEndRow);
            if (object instanceof TLRPC.User) {
                j2 = ((TLRPC.User) object).f1775id;
            } else {
                j2 = object instanceof TLRPC.Chat ? -((TLRPC.Chat) object).f1610id : 0L;
            }
            if (j2 != 0) {
    ...
    class SearchAdapter extends RecyclerListView.SelectionAdapter {
            ...
            if (i == 1) {
                ...
                groupCreateUserCell = new View(context) { // from class: org.telegram.ui.Components.InviteMembersBottomSheet.SearchAdapter.1
                    ...
                    protected void onMeasure(int i2, int i3) {
                        super.onMeasure(i2, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(48.0f) + InviteMembersBottomSheet.this.additionalHeight + InviteMembersBottomSheet.this.searchAdditionalHeight, TLObject.FLAG_30));
                    }
                };
            } else if (i != 4) {
        ...
        */
        ...
        public /* synthetic */ void lambda$searchDialogs$3(final String str) {
            ...
            searchAdapterHelper.queryServerSearch(str, true, z2, true, InviteMembersBottomSheet.this.dialogsDelegate != null ? z : false, false, 0L, false, 0, 0);
            DispatchQueue dispatchQueue = Utilities.searchQueue;
        ...
        /* JADX WARN: Removed duplicated region for block: B:54:0x0135 A[LOOP:1: B:29:0x0098->B:54:0x0135, LOOP_END] */
    ...
    @Override // org.telegram.p026ui.Components.UsersAlertBase
    protected void onSearchViewTouched(MotionEvent motionEvent, final EditTextBoldCursor editTextBoldCursor) {
        BaseFragment baseFragment;
        if (motionEvent.getAction() == 0) {
            this.f1926y = this.scrollOffsetY;
            return;
        }
        if (motionEvent.getAction() != 1 || Math.abs(this.scrollOffsetY - this.f1926y) >= this.touchSlop || this.enterEventSent) {
            return;
        }
        ...
        protected void onMeasure(int i, int i2) {
            ...
            for (int i3 = 0; i3 < childCount; i3++) {
                ...
                if (childAt instanceof GroupCreateSpan) {
                    ...
                    if (childAt != this.removingSpan && childAt.getMeasuredWidth() + measuredWidth > iM1081dp) {
            ...
            final int iM1081dp6 = iM1081dp2 + AndroidUtilities.m1081dp(42.0f);
            if (InviteMembersBottomSheet.this.dialogsDelegate != null) {
                iMax = InviteMembersBottomSheet.this.spanEnter ? Math.min(InviteMembersBottomSheet.this.maxSize, iM1081dp6) : 0;
            } else {
                iMax = Math.max(0, Math.min(InviteMembersBottomSheet.this.maxSize, iM1081dp6) - AndroidUtilities.m1081dp(52.0f));
            }
            int i4 = InviteMembersBottomSheet.this.searchAdditionalHeight;
            InviteMembersBottomSheet inviteMembersBottomSheet = InviteMembersBottomSheet.this;
            inviteMembersBottomSheet.searchAdditionalHeight = (inviteMembersBottomSheet.dialogsDelegate != null || InviteMembersBottomSheet.this.selectedContacts.size() <= 0) ? 0 : AndroidUtilities.m1081dp(56.0f);
            if (iMax != InviteMembersBottomSheet.this.additionalHeight || i4 != InviteMembersBottomSheet.this.searchAdditionalHeight) {
                InviteMembersBottomSheet.this.additionalHeight = iMax;
            ...
            int iMin = Math.min(InviteMembersBottomSheet.this.maxSize, iM1081dp6);
            if (InviteMembersBottomSheet.this.scrollViewH != iMin) {
                ValueAnimator valueAnimatorOfInt = ValueAnimator.ofInt(InviteMembersBottomSheet.this.scrollViewH, iMin);
            ...
            if (this.addAnimation && iM1081dp6 > InviteMembersBottomSheet.this.maxSize) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.InviteMembersBottomSheet$SpansContainer$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onMeasure$1(iM1081dp6);
                    }
                });
            } else if (!this.addAnimation && InviteMembersBottomSheet.this.spansScrollView.getScrollY() + InviteMembersBottomSheet.this.spansScrollView.getMeasuredHeight() > iM1081dp6) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.InviteMembersBottomSheet$SpansContainer$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onMeasure$2(iM1081dp6);
                    }
                });
            }
            ...
            if (InviteMembersBottomSheet.this.currentAnimation == null) {
                InviteMembersBottomSheet.this.scrollViewH = iMin;
                ((BottomSheet) InviteMembersBottomSheet.this).containerView.invalidate();
            }
            setMeasuredDimension(size, Math.max(iM1081dp6, iM1081dp5));
    ...
    protected UsersAlertBase.ContainerView createContainerView(Context context) {
        return new UsersAlertBase.ContainerView(context) { // from class: org.telegram.ui.Components.InviteMembersBottomSheet.4
            ...
            protected void dispatchDraw(Canvas canvas) {
                InviteMembersBottomSheet inviteMembersBottomSheet = InviteMembersBottomSheet.this;
                InviteMembersBottomSheet.this.spansScrollView.setTranslationY((inviteMembersBottomSheet.scrollOffsetY - ((BottomSheet) inviteMembersBottomSheet).backgroundPaddingTop) + AndroidUtilities.m1081dp(6.0f) + AndroidUtilities.m1081dp(64.0f));
            ...
            protected boolean drawChild(Canvas canvas, View view, long j) {
                if (view == InviteMembersBottomSheet.this.spansScrollView) {
                    canvas.save();
                    canvas.clipRect(0.0f, view.getY() - AndroidUtilities.m1081dp(4.0f), getMeasuredWidth(), view.getY() + InviteMembersBottomSheet.this.scrollViewH + 1.0f);
