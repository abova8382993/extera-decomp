...
import org.telegram.p026ui.Components.blur3.utils.BitmapMemoizedMetadata;
...
public class WallpaperBitmapProvider {
    ...
    public static int averageBottomColor(Bitmap bitmap) {
        ...
        for (int i5 = 0; i5 < i3; i5++) {
            int i6 = iArr[i5];
            j += (long) ((i6 >>> 24) & Function.USE_VARARGS);
            j2 += (long) ((i6 >> 16) & Function.USE_VARARGS);
            j3 += (long) ((i6 >> 8) & Function.USE_VARARGS);
            j4 += (long) (i6 & Function.USE_VARARGS);
            i4++;
        }
        if (i4 == 0) {
            return 0;
