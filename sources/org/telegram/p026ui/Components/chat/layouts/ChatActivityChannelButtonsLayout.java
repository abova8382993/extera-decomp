package org.telegram.p026ui.Components.chat.layouts;
...
import org.telegram.p026ui.Components.chat.buttons.ChatActivityBlurredRoundButton;

/* JADX INFO: loaded from: classes3.dex */
public abstract class ChatActivityChannelButtonsLayout extends FrameLayout implements FactorAnimator.Target {
    private static final int[] buttonIcons = {C2702R.drawable.msg_search, C2702R.drawable.input_gift_s, C2702R.drawable.input_message, C2702R.drawable.msg_help};
    ...
    public ChatActivityChannelButtonsLayout(Context context, Theme.ResourcesProvider resourcesProvider, BlurredBackgroundColorProvider blurredBackgroundColorProvider, BlurredBackgroundDrawableViewFactory blurredBackgroundDrawableViewFactory) {
        ...
        frameLayout.setOutlineProvider(new ViewOutlineProvider() { // from class: org.telegram.ui.Components.chat.layouts.ChatActivityChannelButtonsLayout.1
            ...
            public void getOutline(View view, Outline outline) {
                outline.setRoundRect(0, 0, view.getMeasuredWidth(), view.getMeasuredHeight(), AndroidUtilities.m1081dp(24.0f));
            }
        });
    ...
    private void checkContainerPaddings(boolean z) {
        ...
        for (int i : buttonsOrderLeft) {
            ...
            if (buttonHolder != null) {
                iM1081dp += buttonHolder.visibilityAnimator.getValue() ? AndroidUtilities.m1081dp(58.0f) : 0;
            }
        }
        for (int i2 : buttonsOrderRight) {
            ButtonHolder buttonHolder2 = this.buttonHolders[i2];
            if (buttonHolder2 != null) {
                iM1081dp2 += buttonHolder2.visibilityAnimator.getValue() ? AndroidUtilities.m1081dp(58.0f) : 0;
            }
        }
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) this.container.getLayoutParams();
        if (marginLayoutParams.leftMargin == iM1081dp && marginLayoutParams.rightMargin == iM1081dp2) {
            return;
        }
    ...
    private void checkButtonsPositionsAndVisibility() {
        ...
        for (int i : buttonsOrderLeft) {
            ...
            if (buttonHolder2 != null) {
                float floatValue2 = buttonHolder2.visibilityAnimator.getFloatValue() * AndroidUtilities.m1081dp(58.0f);
                buttonHolder2.button.setTranslationX(iM1081dp + this.totalWidthLeft);
        ...
        for (int i2 : buttonsOrderRight) {
            ...
            if (buttonHolder3 != null) {
                float floatValue3 = buttonHolder3.visibilityAnimator.getFloatValue() * AndroidUtilities.m1081dp(58.0f);
                buttonHolder3.button.setTranslationX(((getMeasuredWidth() - buttonHolder3.button.getMeasuredWidth()) - iM1081dp) - this.totalWidthRight);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (floatValue > 0) {
            RectF rectF = tmpRect;
            rectF.set(this.totalWidthLeft + AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(7.0f), (getMeasuredWidth() - AndroidUtilities.m1081dp(10.0f)) - this.totalWidthRight, getMeasuredHeight() - AndroidUtilities.m1081dp(7.0f));
            this.backgroundAccentPaint.setColor(this.accentColor);
            this.backgroundAccentPaint.setAlpha(floatValue);
            canvas.drawRoundRect(rectF, AndroidUtilities.m1081dp(21.0f), AndroidUtilities.m1081dp(21.0f), this.backgroundAccentPaint);
        }
