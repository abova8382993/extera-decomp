...
import org.telegram.p026ui.Components.chat.buttons.ChatActivityBlurredRoundPageDownButton;
...
public class ChatActivitySideControlsButtonsLayout extends FrameLayout implements FactorAnimator.Target {
    ...
    static {
        int i = C2702R.drawable.msg_input_attach2;
        int i2 = C2702R.drawable.pagedown;
        buttonIcons = new int[]{i, i2, C2702R.drawable.mentionbutton, C2702R.drawable.reactionbutton, i2, i2};
    }
    ...
    public ChatActivitySideControlsButtonsLayout(Context context, Theme.ResourcesProvider resourcesProvider, BlurredBackgroundColorProvider blurredBackgroundColorProvider, BlurredBackgroundDrawableViewFactory blurredBackgroundDrawableViewFactory) {
        super(context);
        this.buttonDescriptions = new String[]{LocaleController.getString(C2702R.string.AttachMenu), LocaleController.getString(C2702R.string.AccDescrPageDown), LocaleController.getString(C2702R.string.AccDescrMentionDown), LocaleController.getString(C2702R.string.AccDescrReactionMentionDown), LocaleController.getString(C2702R.string.AccDescrSearchPrev), LocaleController.getString(C2702R.string.AccDescrSearchNext)};
    ...
    private void checkButtonsPositionsAndVisibility() {
        ...
        while (true) {
            ...
            if (buttonHolder != null) {
                ...
                if (i != 0) {
                    buttonHolder.button.setTranslationY((AndroidUtilities.m1081dp(100.0f) * (1.0f - floatValue)) - fM1081dp);
                }
                fM1081dp += (AndroidUtilities.m1081dp(48.0f) + AndroidUtilities.m1081dp((i == 5 || i == 4) ? 10.0f : 16.0f)) * floatValue;
            }
            i++;
        }
    }
    ...
    private ButtonHolder getOrCreateButtonHolder(final int i) {
        ...
        if (this.buttonHolders[i] == null) {
            ...
            float f = i4 / 2.0f;
            chatActivityBlurredRoundPageDownButtonCreate.setPivotX(AndroidUtilities.m1081dp(f));
            chatActivityBlurredRoundPageDownButtonCreate.setPivotY(AndroidUtilities.m1081dp(f + 8.0f));
