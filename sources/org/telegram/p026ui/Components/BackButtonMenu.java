...
public abstract class BackButtonMenu {
    ...
    */
    public static org.telegram.p026ui.ActionBar.ActionBarPopupWindow show(final org.telegram.p026ui.ActionBar.BaseFragment r28, android.view.View r29, long r30, long r32, org.telegram.ui.ActionBar.Theme.ResourcesProvider r34) {
        /*
            Method dump skipped, instruction units count: 763
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.BackButtonMenu.show(org.telegram.ui.ActionBar.BaseFragment, android.view.View, long, long, org.telegram.ui.ActionBar.Theme$ResourcesProvider):org.telegram.ui.ActionBar.ActionBarPopupWindow");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static /* synthetic */ void $r8$lambda$LjwJnyIy4aTYeceLn6PSUidUlns(java.util.concurrent.atomic.AtomicReference r4, org.telegram.ui.Components.BackButtonMenu.PulledDialog r5, org.telegram.p026ui.ActionBar.INavigationLayout r6, org.telegram.tgnet.TLRPC.TL_forumTopic r7, org.telegram.p026ui.ActionBar.BaseFragment r8, android.view.View r9) {
        /*
            Method dump skipped, instruction units count: 205
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.BackButtonMenu.$r8$lambda$LjwJnyIy4aTYeceLn6PSUidUlns(java.util.concurrent.atomic.AtomicReference, org.telegram.ui.Components.BackButtonMenu$PulledDialog, org.telegram.ui.ActionBar.INavigationLayout, org.telegram.tgnet.TLRPC$TL_forumTopic, org.telegram.ui.ActionBar.BaseFragment, android.view.View):void");
    }
    ...
    private static ArrayList getStackedHistoryForTopic(BaseFragment baseFragment, long j, long j2) {
        ...
        if (pulledDialogs != null) {
            ...
            for (int i2 = 0; i2 < pulledDialogs.size(); i2++) {
                ...
                if (pulledDialog.topic != null && r7.f1670id != j2) {
    ...
    public static void goToPulledDialog(BaseFragment baseFragment, PulledDialog pulledDialog) {
        ...
        if (cls == ChatActivity.class) {
            ...
            if (tL_forumTopic != null) {
                ...
                baseFragment2.presentFragment(ForumUtilities.getChatActivityForTopic(baseFragment2, pulledDialog.chat.f1610id, tL_forumTopic, 0, bundle), true);
            } else {
                baseFragment2 = baseFragment;
        ...
        if (pulledDialog.activity == TopicsFragment.class) {
            ...
            bundle3.putLong("chat_id", pulledDialog.chat.f1610id);
    ...
    public static ArrayList getStackedHistoryDialogs(BaseFragment baseFragment, long j) {
        ...
        Collections.sort(arrayList, new Comparator() { // from class: org.telegram.ui.Components.BackButtonMenu$$ExternalSyntheticLambda1
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                return BackButtonMenu.m8067$r8$lambda$sPUzo9otFwawnC1lMMb0CzYuf8((BackButtonMenu.PulledDialog) obj, (BackButtonMenu.PulledDialog) obj2);
            }
        });
        return arrayList;
    }
    ...
    public static /* synthetic */ int m8067$r8$lambda$sPUzo9otFwawnC1lMMb0CzYuf8(PulledDialog pulledDialog, PulledDialog pulledDialog2) {
        return pulledDialog2.stackIndex - pulledDialog.stackIndex;
    }
    ...
    public static void addToPulledDialogs(BaseFragment baseFragment, int i, TLRPC.Chat chat, TLRPC.User user, TLRPC.TL_forumTopic tL_forumTopic, long j, int i2, int i3) {
        ...
        for (PulledDialog pulledDialog : parentLayout.getPulledDialogs()) {
            ...
            if (tL_forumTopic != null && (tL_forumTopic2 = pulledDialog.topic) != null && tL_forumTopic2.f1670id == tL_forumTopic.f1670id) {
                return;
            }
        }
        PulledDialog pulledDialog2 = new PulledDialog();
