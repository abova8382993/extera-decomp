...
public class StickerEmptyView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    class RunnableC49591 implements Runnable {
        RunnableC49591() {
        }
    ...
    public StickerEmptyView(Context context, View view, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.stickerType = i;
        C49602 c49602 = new LinearLayout(context) { // from class: org.telegram.ui.Components.StickerEmptyView.2
            C49602(Context context2) {
                super(context2);
            }
        ...
        this.linearLayout = c49602;
        c49602.setOrientation(1);
        ...
        this.linearLayout.addView(this.stickerView, LayoutHelper.createLinear(Opcodes.LNEG, Opcodes.LNEG, 1));
    ...
    class C49602 extends LinearLayout {
        C49602(Context context2) {
            super(context2);
        }
    ...
    public void createButtonLayout(CharSequence charSequence, final Runnable runnable) {
        ((LinearLayout.LayoutParams) this.subtitle.getLayoutParams()).topMargin = AndroidUtilities.m1081dp(12.0f);
        TextView textView = new TextView(getContext());
        textView.setText(charSequence);
        int i = Theme.key_featuredStickers_buttonText;
        textView.setTextColor(Theme.getColor(i, this.resourcesProvider));
        textView.setPadding(AndroidUtilities.m1081dp(45.0f), AndroidUtilities.m1081dp(12.0f), AndroidUtilities.m1081dp(45.0f), AndroidUtilities.m1081dp(12.0f));
        textView.setGravity(17);
        textView.setTypeface(AndroidUtilities.bold());
        textView.setTextSize(1, 15.0f);
        C49613 c49613 = new FrameLayout(getContext()) { // from class: org.telegram.ui.Components.StickerEmptyView.3
            C49613(Context context) {
                super(context);
            }
        ...
        c49613.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.StickerEmptyView$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                AndroidUtilities.runOnUIThread(runnable, 100L);
            }
        });
        c49613.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1081dp(8.0f), Theme.getColor(Theme.key_featuredStickers_addButton, this.resourcesProvider), ColorUtils.setAlphaComponent(Theme.getColor(i, this.resourcesProvider), 30)));
        ScaleStateListAnimator.apply(c49613, 0.05f, 1.5f);
        c49613.addView(textView);
        this.linearLayout.setClipChildren(false);
        this.linearLayout.addView(c49613, LayoutHelper.createLinear(-2, -2, 1, 0, 28, 0, 4));
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.StickerEmptyView$3 */
    /* JADX INFO: loaded from: classes5.dex */
    class C49613 extends FrameLayout {
        C49613(Context context) {
            super(context);
        }
    ...
    class C49624 extends AnimatorListenerAdapter {
        C49624() {
        }
    ...
    class C49635 extends AnimatorListenerAdapter {
        C49635() {
        }
    ...
    public void setSticker() {
        ...
        this.stickerView.setImageDrawable(new RLottieDrawable(C2702R.raw.utyan_empty, "utyan_empty", AndroidUtilities.m1081dp(130.0f), AndroidUtilities.m1081dp(130.0f)));
    }
    ...
    public void setKeyboardHeight(int i, boolean z) {
        if (this.keyboardSize != i) {
            ...
            this.keyboardSize = i;
            float fM1081dp = (-(i >> 1)) + (i > 0 ? AndroidUtilities.m1081dp(20.0f) : 0);
            if (z) {
                ViewPropertyAnimator viewPropertyAnimatorTranslationY = this.linearLayout.animate().translationY(fM1081dp);
                CubicBezierInterpolator cubicBezierInterpolator = CubicBezierInterpolator.DEFAULT;
                viewPropertyAnimatorTranslationY.setInterpolator(cubicBezierInterpolator).setDuration(250L);
                RadialProgressView radialProgressView = this.progressBar;
                if (radialProgressView != null) {
                    radialProgressView.animate().translationY(fM1081dp).setInterpolator(cubicBezierInterpolator).setDuration(250L);
                    return;
                }
                return;
            }
            this.linearLayout.setTranslationY(fM1081dp);
            RadialProgressView radialProgressView2 = this.progressBar;
            if (radialProgressView2 != null) {
                radialProgressView2.setTranslationY(fM1081dp);
            }
        }
    }
    ...
    /* JADX INFO: loaded from: classes5.dex */
    class C49646 extends AnimatorListenerAdapter {
        C49646() {
        }
