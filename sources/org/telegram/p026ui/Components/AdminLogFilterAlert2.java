...
public class AdminLogFilterAlert2 extends BottomSheetWithRecyclerListView {
    ...
    public AdminLogFilterAlert2(BaseFragment baseFragment, TLRPC.TL_channelAdminLogEventsFilter tL_channelAdminLogEventsFilter, LongSparseArray longSparseArray, boolean z) {
        ...
        if (longSparseArray != null) {
            this.selectedAdmins = longSparseArray.m1442clone();
        }
        this.isMegagroup = z;
        ...
        buttonWithCounterView.setText(LocaleController.getString(C2702R.string.EventLogFilterApply), false);
        ...
        recyclerListView.setPadding(i2, 0, i2, AndroidUtilities.m1081dp(68.0f));
    }
    ...
    protected CharSequence getTitle() {
        return LocaleController.getString(C2702R.string.EventLog);
    }
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        arrayList.add(UItem.asHeader(LocaleController.getString(C2702R.string.EventLogFilterByActions)));
        UItem uItemAsRoundGroupCheckbox = UItem.asRoundGroupCheckbox(2, LocaleController.getString(this.isMegagroup ? C2702R.string.EventLogFilterSectionMembers : C2702R.string.EventLogFilterSectionSubscribers), getGroupCount(0));
        TLRPC.TL_channelAdminLogEventsFilter tL_channelAdminLogEventsFilter = this.currentFilter;
        ...
        if (this.sectionMembersExpanded) {
            UItem uItemPad = UItem.asRoundCheckbox(3, LocaleController.getString(C2702R.string.EventLogFilterSectionAdmin)).pad();
            TLRPC.TL_channelAdminLogEventsFilter tL_channelAdminLogEventsFilter2 = this.currentFilter;
            arrayList.add(uItemPad.setChecked(tL_channelAdminLogEventsFilter2.promote || tL_channelAdminLogEventsFilter2.demote));
            if (this.isMegagroup) {
                UItem uItemPad2 = UItem.asRoundCheckbox(4, LocaleController.getString(C2702R.string.EventLogFilterNewRestrictions)).pad();
                TLRPC.TL_channelAdminLogEventsFilter tL_channelAdminLogEventsFilter3 = this.currentFilter;
            ...
            UItem uItemPad3 = UItem.asRoundCheckbox(5, LocaleController.getString(this.isMegagroup ? C2702R.string.EventLogFilterNewMembers : C2702R.string.EventLogFilterNewSubscribers)).pad();
            ...
            arrayList.add(UItem.asRoundCheckbox(6, LocaleController.getString(this.isMegagroup ? C2702R.string.EventLogFilterLeavingMembers2 : C2702R.string.EventLogFilterLeavingSubscribers2)).pad().setChecked(this.currentFilter.leave));
        }
        UItem uItemAsRoundGroupCheckbox2 = UItem.asRoundGroupCheckbox(7, LocaleController.getString(this.isMegagroup ? C2702R.string.EventLogFilterSectionGroupSettings : C2702R.string.EventLogFilterSectionChannelSettings), getGroupCount(1));
        ...
        if (this.sectionSettingsExpanded) {
            UItem uItemPad4 = UItem.asRoundCheckbox(8, LocaleController.getString(this.isMegagroup ? C2702R.string.EventLogFilterGroupInfo : C2702R.string.EventLogFilterChannelInfo)).pad();
            ...
            arrayList.add(UItem.asRoundCheckbox(9, LocaleController.getString(C2702R.string.EventLogFilterInvites)).pad().setChecked(this.currentFilter.invites));
            arrayList.add(UItem.asRoundCheckbox(10, LocaleController.getString(C2702R.string.EventLogFilterCalls)).pad().setChecked(this.currentFilter.group_call));
        }
        UItem uItemAsRoundGroupCheckbox3 = UItem.asRoundGroupCheckbox(11, LocaleController.getString(C2702R.string.EventLogFilterSectionMessages), getGroupCount(2));
        ...
        if (this.sectionMessagesExpanded) {
            arrayList.add(UItem.asRoundCheckbox(12, LocaleController.getString(C2702R.string.EventLogFilterDeletedMessages)).pad().setChecked(this.currentFilter.delete));
            arrayList.add(UItem.asRoundCheckbox(13, LocaleController.getString(C2702R.string.EventLogFilterEditedMessages)).pad().setChecked(this.currentFilter.edit));
            arrayList.add(UItem.asRoundCheckbox(14, LocaleController.getString(C2702R.string.EventLogFilterPinnedMessages)).pad().setChecked(this.currentFilter.pinned));
        }
        arrayList.add(UItem.asShadow(null));
        arrayList.add(UItem.asHeader(LocaleController.getString(C2702R.string.EventLogFilterByAdmins)));
        UItem uItemAsRoundCheckbox = UItem.asRoundCheckbox(15, LocaleController.getString(C2702R.string.EventLogFilterByAdminsAll));
        LongSparseArray longSparseArray = this.selectedAdmins;
    ...
    */
    public void onClick(org.telegram.p026ui.Components.UItem r9, android.view.View r10, float r11) {
        /*
            Method dump skipped, instruction units count: 460
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.AdminLogFilterAlert2.onClick(org.telegram.ui.Components.UItem, android.view.View, float):void");
    }
