...
public class WallpaperUpdater {
    ...
    public void showAlert(final boolean z) {
        ...
        if (z) {
            charSequenceArr = new CharSequence[]{LocaleController.getString(C2702R.string.ChooseTakePhoto), LocaleController.getString(C2702R.string.SelectFromGallery), LocaleController.getString(C2702R.string.SelectColor), LocaleController.getString(C2702R.string.Default)};
            iArr = null;
        } else {
            charSequenceArr = new CharSequence[]{LocaleController.getString(C2702R.string.ChooseTakePhoto), LocaleController.getString(C2702R.string.SelectFromGallery)};
            iArr = new int[]{C2702R.drawable.msg_camera, C2702R.drawable.msg_photos};
        }
    ...
    class C51351 implements PhotoAlbumPickerActivity.PhotoAlbumPickerActivityDelegate {
        C51351() {
        }
    ...
    */
    public void onActivityResult(int r8, int r9, android.content.Intent r10) throws java.lang.Throwable {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.WallpaperUpdater.onActivityResult(int, int, android.content.Intent):void");
    }
}
