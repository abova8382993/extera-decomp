...
public class RecyclerAnimationScrollHelper {
    ...
    */
    public void scrollToPosition(int r11, int r12, boolean r13, boolean r14, boolean r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.RecyclerAnimationScrollHelper.scrollToPosition(int, int, boolean, boolean, boolean):void");
    }
    ...
    class ViewOnLayoutChangeListenerC47381 implements View.OnLayoutChangeListener {
        ...
        ViewOnLayoutChangeListenerC47381(RecyclerView.Adapter adapter, ArrayList arrayList, boolean z, AnimatableAdapter animatableAdapter) {
        ...
        public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
            ...
            RecyclerAnimationScrollHelper.this.animator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.RecyclerAnimationScrollHelper.1.1
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    ArrayList arrayList4 = ViewOnLayoutChangeListenerC47381.this.val$oldViews;
                    ...
                    AnimatableAdapter animatableAdapter = ViewOnLayoutChangeListenerC47381.this.val$finalAnimatableAdapter;
