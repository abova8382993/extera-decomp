...
public abstract class BottomPagerTabs extends View {
    ...
    protected class Tab {
        ...
        public Tab(int i, int i2, int i3, int i4, CharSequence charSequence) {
            ...
            RLottieDrawable rLottieDrawable = new RLottieDrawable(i2, _UrlKt.FRAGMENT_ENCODE_SET + i2, AndroidUtilities.m1081dp(29.0f), AndroidUtilities.m1081dp(29.0f));
            ...
            this.ripple = Theme.createSelectorDrawable(Theme.multAlpha(Theme.getColor(i5, BottomPagerTabs.this.resourcesProvider), 0.1f), 7, AndroidUtilities.m1081dp(16.0f));
        }
        ...
        public void setActive(boolean z, boolean z2) {
            ...
            if (BottomPagerTabs.this.tabs[this.f1884i].customEndFrameMid != 0) {
                if (z) {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        int iMin = Math.min(AndroidUtilities.m1081dp(64.0f), width);
        ...
        if (f > 0.0f) {
            ...
            float f8 = iMin / 2.0f;
            rectF.set(paddingLeft - f8, AndroidUtilities.m1081dp(9.0f), paddingLeft + f8, AndroidUtilities.m1081dp(41.0f));
            canvas.drawRoundRect(rectF, AndroidUtilities.m1081dp(16.0f), AndroidUtilities.m1081dp(16.0f), this.selectPaint);
        }
        int i = 0;
        while (true) {
            Tab[] tabArr = this.tabs;
            ...
            float f11 = f4;
            float f12 = f5;
            rect.set((int) (tab.clickRect.centerX() - f10), AndroidUtilities.m1081dp(f11), (int) (tab.clickRect.centerX() + f10), AndroidUtilities.m1081dp(f9));
            ...
            if (f < 1.0f) {
                ...
                rectF2.set(rect);
                canvas.drawRoundRect(rectF2, AndroidUtilities.m1081dp(f12), AndroidUtilities.m1081dp(f12), this.selectPaint);
            }
            tab.ripple.setBounds(rect);
            tab.ripple.draw(canvas);
            float fM1081dp = AndroidUtilities.m1081dp(29.0f) / 2.0f;
            rect.set((int) (tab.clickRect.centerX() - fM1081dp), (int) (AndroidUtilities.dpf2(24.66f) - fM1081dp), (int) (tab.clickRect.centerX() + fM1081dp), (int) (AndroidUtilities.dpf2(24.66f) + fM1081dp));
            tab.drawable.setBounds(rect);
            tab.drawable.draw(canvas);
            canvas.save();
            canvas.translate((tab.clickRect.centerX() - (tab.layoutWidth / 2.0f)) - tab.layoutLeft, AndroidUtilities.m1081dp(50.0f) - (tab.layout.getHeight() / 2.0f));
    ...
    protected void onMeasure(int i, int i2) {
        setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m1081dp(64.0f) + AndroidUtilities.getShadowHeight());
    }
