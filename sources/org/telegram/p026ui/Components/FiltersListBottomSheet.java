    ...
    public FiltersListBottomSheet(BaseFragment baseFragment, ArrayList arrayList) {
        ...
        FrameLayout frameLayout = new FrameLayout(parentActivity) { // from class: org.telegram.ui.Components.FiltersListBottomSheet.1
            ...
            protected void onMeasure(int i2, int i3) {
                ...
                int iM1081dp = AndroidUtilities.m1081dp(48.0f) + (AndroidUtilities.m1081dp(48.0f) * FiltersListBottomSheet.this.adapter.getItemCount()) + ((BottomSheet) FiltersListBottomSheet.this).backgroundPaddingTop + AndroidUtilities.statusBarHeight;
                int i4 = size / 5;
                int i5 = ((double) iM1081dp) < ((double) i4) * 3.2d ? 0 : i4 * 2;
                if (i5 != 0 && iM1081dp < size) {
                    i5 -= size - iM1081dp;
                }
                if (i5 == 0) {
                ...
                if (FiltersListBottomSheet.this.listView.getPaddingTop() != i5) {
                    FiltersListBottomSheet.this.ignoreLayout = true;
                    FiltersListBottomSheet.this.listView.setPadding(AndroidUtilities.m1081dp(10.0f), i5, AndroidUtilities.m1081dp(10.0f), 0);
                    FiltersListBottomSheet.this.ignoreLayout = false;
                }
                this.fullHeight = iM1081dp >= size;
                super.onMeasure(i2, View.MeasureSpec.makeMeasureSpec(Math.min(iM1081dp, size), TLObject.FLAG_30));
            }
            ...
            protected void onDraw(Canvas canvas) {
                int iMin;
                float fMin;
                int iM1081dp = (FiltersListBottomSheet.this.scrollOffsetY - ((BottomSheet) FiltersListBottomSheet.this).backgroundPaddingTop) - AndroidUtilities.m1081dp(8.0f);
                int measuredHeight = getMeasuredHeight() + AndroidUtilities.m1081dp(36.0f) + ((BottomSheet) FiltersListBottomSheet.this).backgroundPaddingTop;
        ...
        this.titleTextView.setPadding(AndroidUtilities.m1081dp(24.0f), 0, AndroidUtilities.m1081dp(24.0f), 0);
        this.titleTextView.setGravity(16);
        this.titleTextView.setText(LocaleController.getString(C2702R.string.FilterChoose));
