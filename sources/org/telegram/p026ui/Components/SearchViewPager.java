...
import org.telegram.p026ui.Cells.HashtagSearchCell;
...
import org.telegram.p026ui.SearchAdsInfoBottomSheet;
...
public abstract class SearchViewPager extends ViewPagerFixed implements FilteredSearchView.UiCallback, NotificationCenter.NotificationCenterDelegate, IBlur3Capture {
    ...
    public SearchViewPager(Context context, DialogsActivity dialogsActivity, int i, int i2, int i3, ChatPreviewDelegate chatPreviewDelegate) {
        ...
        this.dialogsSearchAdapter = new C47861(context, dialogsActivity, i, i2, this.itemAnimator, dialogsActivity.getAllowGlobalSearch(), null, dialogsActivity, context);
        if (i2 == 15) {
            ...
            for (int i4 = 0; i4 < dialogsArray.size(); i4++) {
                arrayList.add(Long.valueOf(((TLRPC.Dialog) dialogsArray.get(i4)).f1616id));
            }
        ...
        C47962 c47962 = new RecyclerListView(context) { // from class: org.telegram.ui.Components.SearchViewPager.2
            C47962(Context context2) {
                super(context2);
            }
        ...
        this.searchListView = c47962;
        c47962.setItemAnimator(this.itemAnimator);
        c47962.setPivotY(0.0f);
        c47962.setClipToPadding(false);
        c47962.setAdapter(this.dialogsSearchAdapter);
        c47962.setVerticalScrollBarEnabled(true);
        c47962.setInstantClick(true);
        c47962.setVerticalScrollbarPosition(LocaleController.isRTL ? 1 : 2);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(context2, 1, false);
        this.searchLayoutManager = linearLayoutManager;
        c47962.setLayoutManager(linearLayoutManager);
        c47962.setAnimateEmptyView(true, 0);
        c47962.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.Components.SearchViewPager.3
            final /* synthetic */ DialogsActivity val$fragment;

            C47973(DialogsActivity dialogsActivity2) {
        ...
        c47962.addEdgeEffectListener(new SearchViewPager$$ExternalSyntheticLambda3(this));
        ...
        C47984 c47984 = new StickerEmptyView(context2, flickerLoadingView, 1) { // from class: org.telegram.ui.Components.SearchViewPager.4
            C47984(Context context2, View flickerLoadingView2, int i5) {
                super(context2, flickerLoadingView2, i5);
            }

            @Override // org.telegram.p026ui.Components.StickerEmptyView, android.view.View
        ...
        this.emptyView = c47984;
        c47984.title.setText(LocaleController.getString(C2702R.string.NoResult));
        ...
        this.searchContainer.addView(c47962);
        this.searchContainer.addView(this.noMediaFiltersSearchView);
        c47962.setEmptyView(this.emptyView);
        this.channelsSearchContainer = new FrameLayout(context2);
        C47995 c47995 = new DefaultItemAnimator() { // from class: org.telegram.ui.Components.SearchViewPager.5
            C47995() {
            }
        ...
        this.channelsItemAnimator = c47995;
        c47995.setSupportsChangeAnimations(false);
        ...
        C48006 c48006 = new StickerEmptyView(context2, flickerLoadingView2, 1) { // from class: org.telegram.ui.Components.SearchViewPager.6
            C48006(Context context2, View flickerLoadingView22, int i5) {
        ...
        this.channelsEmptyView = c48006;
        c48006.title.setText(LocaleController.getString(C2702R.string.NoResult));
        ...
        C48017 c48017 = new DialogsChannelsAdapter(recyclerListView, context2, this.currentAccount, i3, null) { // from class: org.telegram.ui.Components.SearchViewPager.7
            final /* synthetic */ DialogsActivity val$fragment;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C48017(RecyclerListView recyclerListView2, Context context2, int i5, int i32, Theme.ResourcesProvider resourcesProvider, DialogsActivity dialogsActivity2) {
                super(recyclerListView2, context2, i5, i32, resourcesProvider);
                dialogsActivity = dialogsActivity2;
            }

            @Override // org.telegram.p026ui.Components.UniversalAdapter
            public void update(boolean z) {
                ...
                if (TextUtils.isEmpty(this.query)) {
                    SearchViewPager.this.channelsEmptyView.title.setText(LocaleController.getString(C2702R.string.NoChannelsTitle));
                    SearchViewPager.this.channelsEmptyView.subtitle.setVisibility(0);
                    SearchViewPager.this.channelsEmptyView.subtitle.setText(LocaleController.getString(C2702R.string.NoChannelsMessage));
                } else {
                    SearchViewPager.this.channelsEmptyView.title.setText(LocaleController.getString(C2702R.string.NoResult));
                    SearchViewPager.this.channelsEmptyView.subtitle.setVisibility(8);
                }
            }

            @Override // org.telegram.p026ui.Components.DialogsChannelsAdapter
            protected void hideKeyboard() {
                AndroidUtilities.hideKeyboard(dialogsActivity.getParentActivity().getCurrentFocus());
            }
        };
        this.channelsSearchAdapter = c48017;
        recyclerListView2.setAdapter(c48017);
        recyclerListView2.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.Components.SearchViewPager.8
            ...
            C48028(DialogsActivity dialogsActivity2) {
                dialogsActivity = dialogsActivity2;
            }
        ...
        C48039 c48039 = new DefaultItemAnimator() { // from class: org.telegram.ui.Components.SearchViewPager.9
            C48039() {
            }
        ...
        this.botsItemAnimator = c48039;
        c48039.setSupportsChangeAnimations(false);
        ...
        C478710 c478710 = new StickerEmptyView(context2, flickerLoadingView3, 1) { // from class: org.telegram.ui.Components.SearchViewPager.10
            C478710(Context context2, View flickerLoadingView32, int i5) {
        ...
        this.botsEmptyView = c478710;
        c478710.title.setText(LocaleController.getString(C2702R.string.NoResult));
        ...
        C478811 c478811 = new DialogsBotsAdapter(recyclerListView2, context2, this.currentAccount, i32, false, null) { // from class: org.telegram.ui.Components.SearchViewPager.11
            final /* synthetic */ DialogsActivity val$fragment;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C478811(RecyclerListView recyclerListView22, Context context2, int i5, int i32, boolean z, Theme.ResourcesProvider resourcesProvider, DialogsActivity dialogsActivity2) {
            ...
            public void update(boolean z) {
                ...
                SearchViewPager.this.botsEmptyView.title.setText(LocaleController.getString(C2702R.string.NoResult));
                SearchViewPager.this.botsEmptyView.subtitle.setVisibility(8);
            }
        };
        this.botsSearchAdapter = c478811;
        recyclerListView22.setAdapter(c478811);
        recyclerListView22.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.Components.SearchViewPager.12
            ...
            C478912(DialogsActivity dialogsActivity2) {
                dialogsActivity = dialogsActivity2;
            }
        ...
        C479013 c479013 = new DefaultItemAnimator() { // from class: org.telegram.ui.Components.SearchViewPager.13
            C479013() {
            }
        ...
        this.hashtagItemAnimator = c479013;
        c479013.setSupportsChangeAnimations(false);
        ...
        C479114 c479114 = new StickerEmptyView(context2, flickerLoadingView4, 1) { // from class: org.telegram.ui.Components.SearchViewPager.14
            C479114(Context context2, View flickerLoadingView42, int i5) {
        ...
        this.hashtagEmptyView = c479114;
        c479114.title.setText(LocaleController.getString(C2702R.string.NoResult));
        ...
        C479215 c479215 = new HashtagsSearchAdapter(recyclerListView3, context2, this.currentAccount, i32, null) { // from class: org.telegram.ui.Components.SearchViewPager.15
            C479215(RecyclerListView recyclerListView32, Context context2, int i5, int i32, Theme.ResourcesProvider resourcesProvider) {
            ...
            public void update(boolean z) {
                ...
                SearchViewPager.this.hashtagEmptyView.title.setText(LocaleController.getString(C2702R.string.NoResult));
                SearchViewPager.this.hashtagEmptyView.subtitle.setVisibility(8);
            }

            @Override // org.telegram.p026ui.Components.HashtagsSearchAdapter
        ...
        this.hashtagSearchAdapter = c479215;
        recyclerListView32.setAdapter(c479215);
        recyclerListView32.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.Components.SearchViewPager.16
            ...
            C479316(DialogsActivity dialogsActivity2) {
                dialogsActivity = dialogsActivity2;
            }
        ...
        this.itemsEnterAnimator = new RecyclerItemsEnterAnimator(c47962, true);
    ...
    class C47861 extends DialogsSearchAdapter {
        final /* synthetic */ Context val$context;
        final /* synthetic */ DialogsActivity val$fragment;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C47861(Context context, DialogsActivity dialogsActivity, int i, int i2, DefaultItemAnimator defaultItemAnimator, boolean z, Theme.ResourcesProvider resourcesProvider, DialogsActivity dialogsActivity2, Context context2) {
        ...
        @Override // org.telegram.p026ui.Adapters.DialogsSearchAdapter
        ...
        protected void openBotApp(TLRPC.User user) {
            ...
            putRecentSearch(user.f1775id, user);
        }
        ...
        protected void openSponsoredOptions(ProfileSearchCell profileSearchCell, final TLRPC.TL_sponsoredPeer tL_sponsoredPeer) {
            ...
            if (!TextUtils.isEmpty(tL_sponsoredPeer.sponsor_info) || !TextUtils.isEmpty(tL_sponsoredPeer.additional_info)) {
                final ItemOptions itemOptionsAddGap = itemOptionsMakeOptions.makeSwipeback().add(C2702R.drawable.ic_ab_back, LocaleController.getString(C2702R.string.Back), new Runnable() { // from class: org.telegram.ui.Components.SearchViewPager$1$$ExternalSyntheticLambda0
                ...
                itemOptionsMakeOptions.add(C2702R.drawable.msg_channel, LocaleController.getString(C2702R.string.SponsoredMessageSponsorReportable), new Runnable() { // from class: org.telegram.ui.Components.SearchViewPager$1$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
            ...
            int i = C2702R.drawable.msg_info;
            String string = LocaleController.getString(C2702R.string.AboutRevenueSharingAds);
            ...
            int i2 = C2702R.drawable.msg_block2;
            String string2 = LocaleController.getString(C2702R.string.ReportAd);
            ...
            int i3 = C2702R.drawable.msg_cancel;
            String string3 = LocaleController.getString(C2702R.string.RemoveAds);
        ...
        public /* synthetic */ void lambda$openSponsoredOptions$2(DialogsActivity dialogsActivity) {
            removeAllAds();
            BulletinFactory.m1195of(dialogsActivity).createAdReportedBulletin(LocaleController.getString(C2702R.string.AdHidden)).show();
        }
    ...
    class C47962 extends RecyclerListView {
        C47962(Context context2) {
            super(context2);
        }
    ...
    class C47973 extends RecyclerView.OnScrollListener {
        final /* synthetic */ DialogsActivity val$fragment;
    ...
    class C47984 extends StickerEmptyView {
        C47984(Context context2, View flickerLoadingView2, int i5) {
            super(context2, flickerLoadingView2, i5);
        }
    ...
    class C47995 extends DefaultItemAnimator {
        C47995() {
        }
    ...
    class C48006 extends StickerEmptyView {
        C48006(Context context2, View flickerLoadingView22, int i5) {
            super(context2, flickerLoadingView22, i5);
        }
    ...
    class C48017 extends DialogsChannelsAdapter {
        final /* synthetic */ DialogsActivity val$fragment;
    ...
    class C48028 extends RecyclerView.OnScrollListener {
        final /* synthetic */ DialogsActivity val$fragment;
    ...
    class C48039 extends DefaultItemAnimator {
        C48039() {
        }
    ...
    class C478710 extends StickerEmptyView {
        C478710(Context context2, View flickerLoadingView32, int i5) {
            super(context2, flickerLoadingView32, i5);
        }
    ...
    class C478811 extends DialogsBotsAdapter {
        final /* synthetic */ DialogsActivity val$fragment;
    ...
    class C478912 extends RecyclerView.OnScrollListener {
        final /* synthetic */ DialogsActivity val$fragment;
    ...
    class C479013 extends DefaultItemAnimator {
        C479013() {
        }
    ...
    class C479114 extends StickerEmptyView {
        C479114(Context context2, View flickerLoadingView42, int i5) {
            super(context2, flickerLoadingView42, i5);
        }
    ...
    class C479215 extends HashtagsSearchAdapter {
        C479215(RecyclerListView recyclerListView32, Context context2, int i5, int i32, Theme.ResourcesProvider resourcesProvider) {
            super(recyclerListView32, context2, i5, i32, resourcesProvider);
        }
    ...
    class C479316 extends RecyclerView.OnScrollListener {
        final /* synthetic */ DialogsActivity val$fragment;
    ...
    class C479417 extends RecyclerView.OnScrollListener {
        C479417() {
        }
    ...
    public void search(View view, int i, String str, boolean z) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            this.emptyView.subtitle.setText(LocaleController.formatString(C2702R.string.NoResultFoundFor2, str));
        }
        ...
        for (int i2 = 0; i2 < this.currentSearchFilters.size(); i2++) {
            ...
            if (i3 == 4) {
                ...
                if (tLObject instanceof TLRPC.User) {
                    ...
                    j2 = -((TLRPC.Chat) tLObject).f1610id;
                } else {
                    j = j3;
                    j3 = j;
                }
    ...
    class C479518 extends AnimatorListenerAdapter {
        C479518() {
        }
    ...
    private void showActionMode(boolean z) {
        ...
        if (z && !this.parent.getActionBar().actionModeIsExist("search_view_pager")) {
            ...
            ActionBarMenuItem actionBarMenuItemAddItemWithWidth = this.actionMode.addItemWithWidth(VoIPService.ID_INCOMING_CALL_PRENOTIFICATION, C2702R.drawable.avd_speed, AndroidUtilities.m1081dp(54.0f), LocaleController.getString(C2702R.string.AccDescrPremiumSpeed));
            ...
            this.gotoItem = this.actionMode.addItemWithWidth(DataTypes.EMPTY, C2702R.drawable.msg_message, AndroidUtilities.m1081dp(54.0f), LocaleController.getString(C2702R.string.AccDescrGoToMessage));
            ActionBarMenuItem actionBarMenuItemAddItemWithWidth2 = this.actionMode.addItemWithWidth(201, C2702R.drawable.msg_forward, AndroidUtilities.m1081dp(54.0f), LocaleController.getString(C2702R.string.Forward));
            ...
            this.deleteItem = this.actionMode.addItemWithWidth(202, C2702R.drawable.msg_delete, AndroidUtilities.m1081dp(54.0f), LocaleController.getString(C2702R.string.Delete));
        }
        if (this.selectedMessagesCountTextView != null) {
            DialogsSearchAdapter dialogsSearchAdapter = this.dialogsSearchAdapter;
            ((ViewGroup.MarginLayoutParams) this.selectedMessagesCountTextView.getLayoutParams()).leftMargin = AndroidUtilities.m1081dp((this.parent.hasMainTabs ? 18 : 72) + (dialogsSearchAdapter != null && (dialogsSearchAdapterDelegate = dialogsSearchAdapter.delegate) != null && (dialogsSearchAdapterDelegate.getSearchForumDialogId() > 0L ? 1 : (dialogsSearchAdapterDelegate.getSearchForumDialogId() == 0L ? 0 : -1)) != 0 ? 56 : 0));
    ...
    public void onActionBarItemClick(int i) {
        if (i == 202) {
            ...
            spannableStringBuilder.append((CharSequence) AndroidUtilities.replaceTags(LocaleController.formatPluralString("RemoveDocumentsMessage", this.selectedFiles.size(), new Object[0]))).append((CharSequence) "\n\n").append((CharSequence) LocaleController.getString(C2702R.string.RemoveDocumentsAlertMessage));
            builder.setMessage(spannableStringBuilder);
            builder.setNegativeButton(LocaleController.getString(C2702R.string.Cancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.SearchViewPager$$ExternalSyntheticLambda0
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i2) {
                    alertDialog.dismiss();
                }
            });
            builder.setPositiveButton(LocaleController.getString(C2702R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.SearchViewPager$$ExternalSyntheticLambda1
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i2) {
        ...
        if (arrayList.size() > 1 || ((MessagesStorage.TopicKey) arrayList.get(0)).dialogId == AccountInstance.getInstance(this.currentAccount).getUserConfig().getClientUserId() || charSequence != null) {
            ...
            while (i3 < arrayList.size()) {
                ...
                if (charSequence != null) {
                    j = j2;
                    AccountInstance.getInstance(this.currentAccount).getSendMessagesHelper().sendMessage(SendMessagesHelper.SendMessageParams.m1124of(charSequence.toString(), j, null, null, null, true, null, null, null, true, 0, 0, null, false));
                } else {
                    j = j2;
                }
    ...
    */
    public void messagesDeleted(long r11, java.util.ArrayList r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.SearchViewPager.messagesDeleted(long, java.util.ArrayList):void");
    }
    ...
    private class ViewPagerAdapter extends ViewPagerFixed.Adapter {
        ...
        public CharSequence getItemTitle(int i) {
            if (((Item) this.items.get(i)).type == 0) {
                return LocaleController.getString(C2702R.string.SearchAllChatsShort);
            }
            if (((Item) this.items.get(i)).type == 1) {
                return LocaleController.getString(C2702R.string.ChannelsTab);
            }
            if (((Item) this.items.get(i)).type == 4) {
                return LocaleController.getString(C2702R.string.AppsTab);
            }
            if (((Item) this.items.get(i)).type == 6) {
                if (SearchViewPager.this.postsAreNew) {
                    return PremiumPreviewFragment.applyNewSpan(LocaleController.getString(C2702R.string.SearchPosts));
                }
                return LocaleController.getString(C2702R.string.SearchPosts);
            }
            ...
            if (((Item) this.items.get(i)).type == 5) {
                return LocaleController.getString(C2702R.string.PublicPostsTabs);
            }
        ...
        /* JADX INFO: loaded from: classes5.dex */
        class C48041 extends RecyclerView.OnScrollListener {
            C48041() {
            }
        ...
        /* JADX INFO: loaded from: classes5.dex */
        class C48052 extends RecyclerView.OnScrollListener {
            C48052() {
            }
