...
public class ColorPicker extends FrameLayout {
    ...
    private int interpolateColors(int i, int i2, float f) {
        ...
        return Color.argb(Function.USE_VARARGS, Math.min(Function.USE_VARARGS, (int) (iRed + ((iRed2 - iRed) * fMin))), Math.min(Function.USE_VARARGS, (int) (iGreen + ((iGreen2 - iGreen) * fMin))), Math.min(Function.USE_VARARGS, (int) (Color.blue(i) + ((Color.blue(i2) - r6) * fMin))));
    }
    ...
    */
    public void setLocation(float r6) {
        ...
        L4f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.Paint.Views.ColorPicker.setLocation(float):void");
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!this.interacting && y < (-AndroidUtilities.m1081dp(10.0f))) {
            return false;
        }
        ...
        if (actionMasked == 3 || actionMasked == 1 || actionMasked == 6) {
            ...
            if (y < (-AndroidUtilities.m1081dp(10.0f))) {
                this.changingWeight = true;
                setWeight(Math.max(0.0f, Math.min(1.0f, ((-y) - AndroidUtilities.m1081dp(10.0f)) / AndroidUtilities.m1081dp(190.0f))));
            }
            return true;
        }
        return false;
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        int i5 = i3 - i;
        int i6 = i4 - i2;
        this.gradientPaint.setShader(new LinearGradient(AndroidUtilities.m1081dp(56.0f), 0.0f, i5 - AndroidUtilities.m1081dp(56.0f), 0.0f, COLORS, LOCATIONS, Shader.TileMode.REPEAT));
        this.rectF.set(AndroidUtilities.m1081dp(56.0f), i6 - AndroidUtilities.m1081dp(32.0f), i5 - AndroidUtilities.m1081dp(56.0f), r9 + AndroidUtilities.m1081dp(12.0f));
        ImageView imageView = this.settingsButton;
        imageView.layout(i5 - imageView.getMeasuredWidth(), i6 - AndroidUtilities.m1081dp(52.0f), i5, i6);
        this.undoButton.layout(0, i6 - AndroidUtilities.m1081dp(52.0f), this.settingsButton.getMeasuredWidth(), i6);
    }

    @Override // android.view.View
    protected void onDraw(Canvas canvas) {
        canvas.drawRoundRect(this.rectF, AndroidUtilities.m1081dp(6.0f), AndroidUtilities.m1081dp(6.0f), this.gradientPaint);
        RectF rectF = this.rectF;
        int iWidth = (int) (rectF.left + (rectF.width() * this.location));
        int iCenterY = (int) ((this.rectF.centerY() + (this.draggingFactor * (-AndroidUtilities.m1081dp(70.0f)))) - (this.changingWeight ? this.weight * AndroidUtilities.m1081dp(190.0f) : 0.0f));
        AndroidUtilities.m1081dp(24.0f);
        float fFloor = (((int) Math.floor(AndroidUtilities.m1081dp(4.0f) + ((AndroidUtilities.m1081dp(19.0f) - AndroidUtilities.m1081dp(4.0f)) * this.weight))) * (this.draggingFactor + 1.0f)) / 2.0f;
        float f = iWidth;
        float f2 = iCenterY;
        canvas.drawCircle(f, f2, ((AndroidUtilities.m1081dp(22.0f) / 2) * (this.draggingFactor + 1.0f)) + 0.5f, this.swatchStrokePaint);
        canvas.drawCircle(f, f2, (AndroidUtilities.m1081dp(22.0f) / 2) * (this.draggingFactor + 1.0f), this.backgroundPaint);
        canvas.drawCircle(f, f2, fFloor, this.swatchPaint);
        canvas.drawCircle(f, f2, fFloor - AndroidUtilities.m1081dp(0.5f), this.swatchStrokePaint);
    }
