...
public abstract class StickerCutOutBtn extends ButtonWithCounterView {
    ...
    public StickerCutOutBtn(StickerMakerView stickerMakerView, Context context, Theme.ResourcesProvider resourcesProvider, BlurringShader.BlurManager blurManager) {
        ...
        setPadding(AndroidUtilities.m1081dp(24.0f), 0, AndroidUtilities.m1081dp(24.0f), 0);
    }
    ...
    @Override // org.telegram.p026ui.Stories.recorder.ButtonWithCounterView, android.view.View
    ...
    public void setCutOutState(boolean z) {
        ...
        ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C2702R.drawable.media_magic_cut);
        coloredImageSpan.setSize(AndroidUtilities.m1081dp(22.0f));
        coloredImageSpan.setTranslateX(AndroidUtilities.m1081dp(1.0f));
        coloredImageSpan.setTranslateY(AndroidUtilities.m1081dp(2.0f));
        coloredImageSpan.spaceScaleX = 1.2f;
        spannableStringBuilder.setSpan(coloredImageSpan, 0, 1, 0);
        spannableStringBuilder.append((CharSequence) " ").append((CharSequence) LocaleController.getString(C2702R.string.SegmentationCutObject));
    ...
    public void setUndoState(boolean z) {
        this.state = 5;
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder("d");
        ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C2702R.drawable.photo_undo2);
        coloredImageSpan.setSize(AndroidUtilities.m1081dp(20.0f));
        coloredImageSpan.setTranslateX(AndroidUtilities.m1081dp(-3.0f));
        spannableStringBuilder.setSpan(coloredImageSpan, 0, 1, 0);
        spannableStringBuilder.append((CharSequence) " ").append((CharSequence) LocaleController.getString(C2702R.string.SegmentationUndo));
        setText(spannableStringBuilder, z);
    }
    ...
    public void setOutlineState(boolean z) {
        this.state = 6;
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder("d");
        ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C2702R.drawable.media_sticker_stroke);
        coloredImageSpan.setSize(AndroidUtilities.m1081dp(20.0f));
        coloredImageSpan.setTranslateX(AndroidUtilities.m1081dp(-3.0f));
        spannableStringBuilder.setSpan(coloredImageSpan, 0, 1, 0);
        spannableStringBuilder.append((CharSequence) " ").append((CharSequence) LocaleController.getString(C2702R.string.SegmentationOutline));
        setText(spannableStringBuilder, z);
    }
    ...
    public void setRestoreState(boolean z) {
        this.state = 4;
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder("d");
        ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C2702R.drawable.media_button_restore);
        coloredImageSpan.setSize(AndroidUtilities.m1081dp(20.0f));
        coloredImageSpan.setTranslateX(AndroidUtilities.m1081dp(-3.0f));
        spannableStringBuilder.setSpan(coloredImageSpan, 0, 1, 0);
        spannableStringBuilder.append((CharSequence) " ").append((CharSequence) LocaleController.getString(C2702R.string.SegmentationRestore));
        setText(spannableStringBuilder, z);
    }
    ...
    public void setEraseState(boolean z) {
        this.state = 3;
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder("d");
        ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C2702R.drawable.media_button_erase);
        coloredImageSpan.setSize(AndroidUtilities.m1081dp(20.0f));
        coloredImageSpan.setTranslateX(AndroidUtilities.m1081dp(-3.0f));
        spannableStringBuilder.setSpan(coloredImageSpan, 0, 1, 0);
        spannableStringBuilder.append((CharSequence) " ").append((CharSequence) LocaleController.getString(C2702R.string.SegmentationErase));
        setText(spannableStringBuilder, z);
    }

    public void setCancelState(boolean z) {
        this.state = 2;
        setText(LocaleController.getString(C2702R.string.Cancel), z);
    }
