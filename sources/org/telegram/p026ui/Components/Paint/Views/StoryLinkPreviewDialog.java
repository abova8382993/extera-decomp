    ...
    public StoryLinkPreviewDialog(Context context, final int i) {
        ...
        LinearLayout linearLayout = new LinearLayout(context) { // from class: org.telegram.ui.Components.Paint.Views.StoryLinkPreviewDialog.2
            ...
            protected void onMeasure(int i2, int i3) {
                super.onMeasure(View.MeasureSpec.makeMeasureSpec(Math.min(View.MeasureSpec.getSize(i2), AndroidUtilities.m1081dp(600.0f)), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(Math.min(View.MeasureSpec.getSize(i3), AndroidUtilities.m1081dp(800.0f)), TLObject.FLAG_30));
            }
        };
        ...
        FrameLayout frameLayout2 = new FrameLayout(context) { // from class: org.telegram.ui.Components.Paint.Views.StoryLinkPreviewDialog.3
            ...
            protected void onMeasure(int i2, int i3) {
                ...
                this.path.addRoundRect(this.rect, AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(10.0f), Path.Direction.CW);
                if (StoryLinkPreviewDialog.this.linkView != null) {
                    StoryLinkPreviewDialog.this.linkView.setMaxWidth(getMeasuredWidth() - AndroidUtilities.m1081dp(32.0f));
                }
            }
        ...
        textView.setText(LocaleController.getString(C2702R.string.StoryLinkPreviewTitle));
        ...
        textView2.setText(LocaleController.getString(C2702R.string.StoryLinkPreviewSubtitle));
        ...
        FrameLayout frameLayout4 = new FrameLayout(context) { // from class: org.telegram.ui.Components.Paint.Views.StoryLinkPreviewDialog.4
            ...
            private final AnimatedFloat f1953x;

            /* JADX INFO: renamed from: y */
            private final AnimatedFloat f1954y;

            {
                CubicBezierInterpolator cubicBezierInterpolator = CubicBezierInterpolator.EASE_OUT_QUINT;
                this.f1953x = new AnimatedFloat(this, 0L, 350L, cubicBezierInterpolator);
                this.f1954y = new AnimatedFloat(this, 0L, 350L, cubicBezierInterpolator);
            }
            ...
            protected boolean drawChild(Canvas canvas, View view, long j) {
                if (view == StoryLinkPreviewDialog.this.linkView) {
                    canvas.save();
                    canvas.translate(this.f1953x.set(view.getX()), this.f1954y.set(view.getY()));
        ...
        MessagePreviewView.ToggleButton toggleButton = new MessagePreviewView.ToggleButton(getContext(), C2702R.raw.position_below, LocaleController.getString(C2702R.string.StoryLinkCaptionAbove), C2702R.raw.position_above, LocaleController.getString(C2702R.string.StoryLinkCaptionBelow), darkThemeResourceProvider);
        ...
        MessagePreviewView.ToggleButton toggleButton2 = new MessagePreviewView.ToggleButton(context, C2702R.raw.media_shrink, LocaleController.getString(C2702R.string.LinkMediaLarger), C2702R.raw.media_enlarge, LocaleController.getString(C2702R.string.LinkMediaSmaller), darkThemeResourceProvider);
        ...
        itemOptionsMakeOptions.add(C2702R.drawable.msg_select, LocaleController.getString(C2702R.string.ApplyChanges), new Runnable() { // from class: org.telegram.ui.Components.Paint.Views.StoryLinkPreviewDialog$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.dismiss();
            }
        });
        itemOptionsMakeOptions.add(C2702R.drawable.msg_delete, (CharSequence) LocaleController.getString(C2702R.string.DoNotLinkPreview), true, new Runnable() { // from class: org.telegram.ui.Components.Paint.Views.StoryLinkPreviewDialog$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
