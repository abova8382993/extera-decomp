...
public class TextPaintView extends EntityView {
    ...
    public TextPaintView(Context context, Point point, int i, CharSequence charSequence, Swatch swatch, int i2) {
        ...
        this.baseFontSize = i;
        C44731 c44731 = new EditTextOutline(context) { // from class: org.telegram.ui.Components.Paint.Views.TextPaintView.1
            C44731(Context context2) {
                super(context2);
            }
        ...
        this.editText = c44731;
        NotificationCenter.listenEmojiLoading(c44731);
        this.editText.setGravity(19);
        this.editText.setBackgroundColor(0);
        this.editText.setPadding(AndroidUtilities.m1081dp(7.0f), AndroidUtilities.m1081dp(7.0f), AndroidUtilities.m1081dp(7.0f), AndroidUtilities.m1081dp(7.0f));
        this.editText.setClickable(false);
        this.editText.setEnabled(false);
        this.editText.setCursorColor(-1);
        this.editText.setTextSize(0, this.baseFontSize);
        this.editText.setCursorSize(AndroidUtilities.m1081dp(this.baseFontSize * 0.4f));
    ...
    class C44731 extends EditTextOutline {
        C44731(Context context2) {
            super(context2);
        }
    ...
    class C44742 implements TextWatcher {
        boolean pasted;
    ...
    public void updateHint() {
        if (this.editText.getText().length() <= 0) {
            this.editText.setHint(LocaleController.getString(C2702R.string.TextPlaceholder));
    ...
    public void setBaseFontSize(int i) {
        ...
        this.editText.setCursorSize(AndroidUtilities.m1081dp(f * 0.4f));
    ...
    */
    public void updateColor() {
        ...
        L8c:
            ...
            int r0 = org.telegram.p026ui.ActionBar.Theme.multAlpha(r0, r2)
            r1.setHighlightColor(r0)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.Paint.Views.TextPaintView.updateColor():void");
    }
    ...
    public Rect getSelectionBounds() {
        ...
        float measuredHeight = (getMeasuredHeight() * getScale()) + (AndroidUtilities.m1081dp(52.0f) / scaleX);
