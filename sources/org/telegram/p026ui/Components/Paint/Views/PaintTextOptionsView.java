...
public class PaintTextOptionsView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public PaintTextOptionsView(Context context) {
        ...
        rLottieImageView.setAnimation(C2702R.raw.photo_text_allign, 24, 24);
        ...
        this.alignView.setPadding(AndroidUtilities.m1081dp(2.0f), AndroidUtilities.m1081dp(2.0f), AndroidUtilities.m1081dp(2.0f), AndroidUtilities.m1081dp(2.0f));
        addView(this.alignView, LayoutHelper.createFrame(28, 28.0f, 16, 0.0f, 0.0f, 16.0f, 0.0f));
        ImageView imageView = new ImageView(context);
        this.outlineView = imageView;
        imageView.setImageResource(C2702R.drawable.msg_text_outlined);
        this.outlineView.setPadding(AndroidUtilities.m1081dp(1.0f), AndroidUtilities.m1081dp(1.0f), AndroidUtilities.m1081dp(1.0f), AndroidUtilities.m1081dp(1.0f));
        ...
        imageView2.setImageResource(C2702R.drawable.msg_add);
        ...
        this.plusView.setPadding(AndroidUtilities.m1081dp(2.0f), AndroidUtilities.m1081dp(2.0f), AndroidUtilities.m1081dp(2.0f), AndroidUtilities.m1081dp(2.0f));
    ...
    private void layoutChild(View view) {
        if (view.getVisibility() != 8) {
            ...
            int i = this.f1949x + layoutParams.leftMargin;
            this.f1949x = i;
            view.layout(i, (getMeasuredHeight() - layoutParams.height) / 2, this.f1949x + layoutParams.width, (getMeasuredHeight() + layoutParams.height) / 2);
            this.f1949x += layoutParams.width + layoutParams.rightMargin;
        }
    }
    ...
    public void getTypefaceCellBounds(RectF rectF) {
        rectF.set(this.typefaceCell.getLeft() + AndroidUtilities.m1081dp(8.0f), this.typefaceCell.getTop(), this.typefaceCell.getRight() + AndroidUtilities.m1081dp(8.0f), this.typefaceCell.getBottom());
    }

    public void animatePlusToIcon(int i) {
        if (i == 0) {
            i = C2702R.drawable.msg_add;
        }
        if (this.plusIcon != i) {
    ...
    public void setOutlineType(int i, boolean z) {
        ...
        this.outlineType = i;
        if (i == 1) {
            i2 = C2702R.drawable.msg_photo_text_framed2;
        } else if (i == 2) {
            i2 = C2702R.drawable.msg_photo_text_framed3;
        } else if (i == 3) {
            i2 = C2702R.drawable.msg_photo_text_regular;
        } else if (i != 4) {
            i2 = C2702R.drawable.msg_photo_text_framed;
        } else {
            i2 = C2702R.drawable.msg_text_outlined;
        }
        if (z) {
    ...
    public static final class TypefaceCell extends TextView {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.restore();
            if (this.isCurrent) {
                int height = (getHeight() - AndroidUtilities.m1081dp(16.0f)) / 2;
                if (LocaleController.isRTL) {
                    this.expandDrawable.setBounds(AndroidUtilities.m1081dp(7.0f), height, AndroidUtilities.m1081dp(23.0f), AndroidUtilities.m1081dp(16.0f) + height);
                } else {
                    this.expandDrawable.setBounds(getWidth() - AndroidUtilities.m1081dp(23.0f), height, getWidth() - AndroidUtilities.m1081dp(7.0f), AndroidUtilities.m1081dp(16.0f) + height);
                }
        ...
        public void setCurrent(boolean z) {
            this.isCurrent = z;
            if (z) {
                setPadding(AndroidUtilities.m1081dp(LocaleController.isRTL ? 27.0f : 12.0f), AndroidUtilities.m1081dp(6.0f), AndroidUtilities.m1081dp(LocaleController.isRTL ? 12.0f : 27.0f), AndroidUtilities.m1081dp(6.0f));
                setBackground(Theme.AdaptiveRipple.rect(1090519039, AndroidUtilities.m1081dp(32.0f)));
            } else {
                setPadding(AndroidUtilities.m1081dp(24.0f), AndroidUtilities.m1081dp(14.0f), AndroidUtilities.m1081dp(24.0f), AndroidUtilities.m1081dp(14.0f));
                setBackground(Theme.AdaptiveRipple.rect(-14145495));
            }
            if (this.isCurrent && this.expandDrawable == null) {
                Drawable drawable = ContextCompat.getDrawable(getContext(), C2702R.drawable.photo_expand);
