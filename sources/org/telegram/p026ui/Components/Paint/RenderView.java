...
public class RenderView extends TextureView {
    ...
    public interface RenderViewDelegate {
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Components.Paint.RenderView$RenderViewDelegate$-CC, reason: invalid class name */
    ...
    public RenderView(Context context, Painting painting, Bitmap bitmap, Bitmap bitmap2, BlurringShader.BlurManager blurManager) {
        ...
        setSurfaceTextureListener(new TextureViewSurfaceTextureListenerC44071(blurManager));
    ...
    class TextureViewSurfaceTextureListenerC44071 implements TextureView.SurfaceTextureListener {
        ...
        TextureViewSurfaceTextureListenerC44071(BlurringShader.BlurManager blurManager) {
    ...
    class CanvasInternal extends DispatchQueue {
        ...
        public CanvasInternal(SurfaceTexture surfaceTexture, BlurringShader.BlurManager blurManager) {
            ...
            this.drawRunnable = new RunnableC44091();
        ...
        class RunnableC44091 implements Runnable {
            RunnableC44091() {
            }
