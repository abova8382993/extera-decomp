...
public abstract class SearchField extends FrameLayout {
    ...
    public SearchField(Context context, boolean z, float f, Theme.ResourcesProvider resourcesProvider) {
        ...
        view.setBackgroundDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m1081dp(18.0f), getThemedColor(Theme.key_dialogSearchBackground)));
        if (z) {
        ...
        this.searchIconImageView.setImageResource(C2702R.drawable.smiles_inputsearch);
        ...
        this.progressDrawable.setSide(AndroidUtilities.m1081dp(7.0f));
