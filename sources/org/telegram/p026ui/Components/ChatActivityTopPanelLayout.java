...
public class ChatActivityTopPanelLayout extends AnimatedLinearLayout {
    ...
    private void checkBoundsAndClipping() {
        ...
        float fMin = Math.min(AndroidUtilities.m1081dp(18.0f), Math.min(this.clipRectF.width(), this.clipRectF.height()) / 2.0f);
        ...
        if (blurredBackgroundDrawable != null) {
            ...
            this.backgroundDrawable.setBounds(getPaddingLeft() - AndroidUtilities.m1081dp(7.0f), 0, (getMeasuredWidth() - getPaddingRight()) + AndroidUtilities.m1081dp(7.0f), getPaddingTop() + getPaddingBottom() + ((int) totalHeight));
            this.backgroundDrawable.setRadius(Math.min(AndroidUtilities.m1081dp(18.0f), totalHeight / 2.0f));
        }
    }
