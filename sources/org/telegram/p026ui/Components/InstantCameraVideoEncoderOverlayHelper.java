...
public class InstantCameraVideoEncoderOverlayHelper {
    ...
    private final Program programRenderTexture = new Program(C2702R.raw.round_blur_stage_0_frag);
    private final Program programRenderWatermark = new Program(C2702R.raw.round_blur_stage_3_frag);
    ...
    public InstantCameraVideoEncoderOverlayHelper(int i, int i2) {
        ...
        for (int i9 = 5; i8 < i9; i9 = 5) {
            ...
            if (i8 == 4) {
                ...
                Object obj2 = null;
                long jCreateWithJson = RLottieDrawable.createWithJson(AndroidUtilities.readRes(C2702R.raw.plane_logo_plain), "logo_plane", new int[3], null);
                ...
                Bitmap bitmapFromRaw = AndroidUtilities.getBitmapFromRaw(C2702R.raw.round_blur_overlay_text);
    ...
    private static class MixProgram extends Program {
        ...
        public MixProgram() {
            super(C2702R.raw.round_blur_stage_2_frag);
    ...
    private static class BlurProgram extends Program {
        ...
        public BlurProgram() {
            super(C2702R.raw.round_blur_stage_1_frag);
    ...
    private static class Program {
        ...
        public Program(int i) {
            int iCreateShader = InstantCameraVideoEncoderOverlayHelper.createShader(35633, C2702R.raw.round_blur_vert);
    ...
    public static int createShader(int i, int i2) {
        ...
        FileLog.m1091e("GlUtils: compile shader error: " + GLES20.glGetShaderInfoLog(iGlCreateShader));
