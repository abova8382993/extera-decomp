...
public class AnimatedPhoneNumberEditText extends HintEditText {
    ...
    @Override // org.telegram.p026ui.Components.HintEditText, org.telegram.p026ui.Components.EditTextBoldCursor, android.widget.TextView
    ...
    @Override // org.telegram.p026ui.Components.HintEditText, org.telegram.p026ui.Components.EditTextBoldCursor, org.telegram.p026ui.Components.EditTextEffects, android.widget.TextView, android.view.View
        ...
        while (i < str.length()) {
            ...
            if (!z && strSubstring2 != null && strSubstring2.equals(strSubstring)) {
                ...
                if (z && strSubstring2 == null) {
                    this.oldLetters.add(new StaticLayout(_UrlKt.FRAGMENT_ENCODE_SET, this.textPaint, 0, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false));
                }
                this.letters.add(new StaticLayout(strSubstring, this.textPaint, (int) Math.ceil(r6.measureText(strSubstring)), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false));
            }
            i = i2;
        }
