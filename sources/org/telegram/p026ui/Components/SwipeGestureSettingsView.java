...
public class SwipeGestureSettingsView extends FrameLayout {
    ...
    public SwipeGestureSettingsView(Context context, int i) {
        ...
        strArr[0] = LocaleController.getString(C2702R.string.SwipeSettingsPin);
        this.strings[1] = LocaleController.getString(C2702R.string.SwipeSettingsRead);
        this.strings[2] = LocaleController.getString(C2702R.string.SwipeSettingsArchive);
        this.strings[3] = LocaleController.getString(C2702R.string.SwipeSettingsMute);
        this.strings[4] = LocaleController.getString(C2702R.string.SwipeSettingsDelete);
        this.strings[5] = LocaleController.getString(C2702R.string.SwipeSettingsFolders);
        ...
        this.outlinePaint.setStrokeWidth(AndroidUtilities.m1081dp(1.0f));
        this.linePaint.setStyle(style);
        Paint paint2 = this.linePaint;
        Paint.Cap cap = Paint.Cap.ROUND;
        paint2.setStrokeCap(cap);
        this.linePaint.setStrokeWidth(AndroidUtilities.m1081dp(5.0f));
        this.pickerDividersPaint.setStyle(style);
        this.pickerDividersPaint.setStrokeCap(cap);
        this.pickerDividersPaint.setStrokeWidth(AndroidUtilities.m1081dp(2.0f));
        NumberPicker numberPicker = new NumberPicker(context, 13) { // from class: org.telegram.ui.Components.SwipeGestureSettingsView.1
            @Override // org.telegram.p026ui.Components.NumberPicker, android.widget.LinearLayout, android.view.View
            protected void onDraw(Canvas canvas) {
                super.onDraw(canvas);
                float fM1081dp = AndroidUtilities.m1081dp(31.0f);
                SwipeGestureSettingsView.this.pickerDividersPaint.setColor(Theme.getColor(Theme.key_radioBackgroundChecked));
                canvas.drawLine(AndroidUtilities.m1081dp(2.0f), fM1081dp, getMeasuredWidth() - AndroidUtilities.m1081dp(2.0f), fM1081dp, SwipeGestureSettingsView.this.pickerDividersPaint);
                float measuredHeight = getMeasuredHeight() - AndroidUtilities.m1081dp(31.0f);
                canvas.drawLine(AndroidUtilities.m1081dp(2.0f), measuredHeight, getMeasuredWidth() - AndroidUtilities.m1081dp(2.0f), measuredHeight, SwipeGestureSettingsView.this.pickerDividersPaint);
            }
        };
    ...
    */
    protected void onDraw(android.graphics.Canvas r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.SwipeGestureSettingsView.onDraw(android.graphics.Canvas):void");
    }
    ...
    public RLottieDrawable getIcon(int i) {
        ...
        if (rLottieDrawableArr[i] == null) {
            if (i == 1) {
                i2 = C2702R.raw.swipe_read;
            } else if (i == 2) {
                i2 = C2702R.raw.chats_archive;
            } else if (i == 3) {
                i2 = C2702R.raw.swipe_mute;
            } else if (i == 4) {
                i2 = C2702R.raw.swipe_delete;
            } else if (i != 5) {
                i2 = C2702R.raw.swipe_pin;
            } else {
                i2 = C2702R.raw.swipe_disabled;
            }
            int i3 = i2;
            rLottieDrawableArr[i] = new RLottieDrawable(i3, _UrlKt.FRAGMENT_ENCODE_SET + i3, AndroidUtilities.m1081dp(28.0f), AndroidUtilities.m1081dp(28.0f), true, null);
            updateIconColor(i);
        }
        return this.icons[i];
    }
