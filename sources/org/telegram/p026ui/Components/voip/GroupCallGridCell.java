...
import org.telegram.p026ui.GroupCallTabletGridAdapter;
...
public abstract class GroupCallGridCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        if (this.isTabletGrid) {
            ...
            float fM1081dp = (AndroidUtilities.displaySize.x - (AndroidUtilities.m1081dp(14.0f) * 2)) + (GroupCallActivity.isLandscapeMode ? -AndroidUtilities.m1081dp(90.0f) : 0);
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec((int) ((GroupCallActivity.isTabletMode ? fM1081dp / 2.0f : fM1081dp / f) + AndroidUtilities.m1081dp(4.0f)), TLObject.FLAG_30));
        }
    }
