...
public class AcceptDeclineView extends View {
    ...
    public AcceptDeclineView(Context context) {
        ...
        ImageWithWavesView.AvatarWavesDrawable avatarWavesDrawable = new ImageWithWavesView.AvatarWavesDrawable(AndroidUtilities.m1081dp(45.0f), AndroidUtilities.m1081dp(50.0f), AndroidUtilities.m1081dp(8.0f), 4);
        ...
        this.buttonWidth = AndroidUtilities.m1081dp(60.0f);
        ...
        String string = LocaleController.getString(C2702R.string.AcceptCall);
        String string2 = LocaleController.getString(C2702R.string.DeclineCall);
        String string3 = LocaleController.getString(C2702R.string.RetryCall);
        ...
        this.callDrawable = ContextCompat.getDrawable(context, C2702R.drawable.calls_decline).mutate();
        Drawable drawableMutate = ContextCompat.getDrawable(context, C2702R.drawable.ic_close_white).mutate();
        ...
        RLottieDrawable rLottieDrawable = new RLottieDrawable(C2702R.raw.call_accept, _UrlKt.FRAGMENT_ENCODE_SET + C2702R.raw.call_accept, AndroidUtilities.m1081dp(48.0f), AndroidUtilities.m1081dp(48.0f), true, null);
        ...
        this.acceptVideoDrawable = ContextCompat.getDrawable(context, C2702R.drawable.calls_video).mutate();
        paint.setColor(-1);
        paint.setAlpha(20);
        Drawable drawableCreateSimpleSelectorCircleDrawable = Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m1081dp(52.0f), 0, ColorUtils.setAlphaComponent(-1, 76));
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.maxOffset = (getMeasuredWidth() / 2.0f) - ((this.buttonWidth / 2.0f) + AndroidUtilities.m1081dp(46.0f));
        int iM1081dp = (this.buttonWidth - AndroidUtilities.m1081dp(28.0f)) / 2;
        this.callDrawable.setBounds(iM1081dp, iM1081dp, AndroidUtilities.m1081dp(28.0f) + iM1081dp, AndroidUtilities.m1081dp(28.0f) + iM1081dp);
        this.cancelDrawable.setBounds(iM1081dp, iM1081dp, AndroidUtilities.m1081dp(28.0f) + iM1081dp, AndroidUtilities.m1081dp(28.0f) + iM1081dp);
        this.linePaint.setStrokeWidth(AndroidUtilities.m1081dp(3.0f));
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r7) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.voip.AcceptDeclineView.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    protected void onDraw(Canvas canvas) {
        if (!this.retryMod) {
            if (this.expandSmallRadius) {
                float fM1081dp = this.smallRadius + (AndroidUtilities.m1081dp(2.0f) * 0.04f);
                this.smallRadius = fM1081dp;
                if (fM1081dp > AndroidUtilities.m1081dp(4.0f)) {
                    this.smallRadius = AndroidUtilities.m1081dp(4.0f);
                    this.expandSmallRadius = false;
                }
            } else {
                float fM1081dp2 = this.smallRadius - (AndroidUtilities.m1081dp(2.0f) * 0.04f);
                this.smallRadius = fM1081dp2;
                if (fM1081dp2 < 0.0f) {
            ...
            if (this.expandBigRadius) {
                float fM1081dp3 = this.bigRadius + (AndroidUtilities.m1081dp(4.0f) * 0.03f);
                this.bigRadius = fM1081dp3;
                if (fM1081dp3 > AndroidUtilities.m1081dp(10.0f)) {
                    this.bigRadius = AndroidUtilities.m1081dp(10.0f);
                    this.expandBigRadius = false;
                }
            } else {
                float fM1081dp4 = this.bigRadius - (AndroidUtilities.m1081dp(5.0f) * 0.03f);
                this.bigRadius = fM1081dp4;
                if (fM1081dp4 < AndroidUtilities.m1081dp(5.0f)) {
                    this.bigRadius = AndroidUtilities.m1081dp(5.0f);
                    this.expandBigRadius = true;
                }
            }
            invalidate();
        }
        this.bigRadius += AndroidUtilities.m1081dp(8.0f) * 0.005f;
        this.declineRect.set((getMeasuredWidth() - AndroidUtilities.m1081dp(46.0f)) - this.buttonWidth, AndroidUtilities.m1081dp(40.0f), getMeasuredWidth() - AndroidUtilities.m1081dp(46.0f), AndroidUtilities.m1081dp(40.0f) + this.buttonWidth);
        canvas.save();
        canvas.translate(0.0f, AndroidUtilities.m1081dp(40.0f));
        canvas.save();
        ...
        canvas.translate(((this.rigthOffsetX + getMeasuredWidth()) - AndroidUtilities.m1081dp(46.0f)) - this.buttonWidth, 0.0f);
        if (this.retryMod) {
        ...
        canvas.save();
        canvas.translate((this.buttonWidth / 2.0f) - (this.declineLayout.getWidth() / 2.0f), this.buttonWidth + AndroidUtilities.m1081dp(4.0f));
        this.declineLayout.draw(canvas);
        canvas.restore();
        if (this.leftDrag) {
            this.rippleDrawable.setBounds(AndroidUtilities.m1081dp(4.0f), AndroidUtilities.m1081dp(4.0f), this.buttonWidth - AndroidUtilities.m1081dp(4.0f), this.buttonWidth - AndroidUtilities.m1081dp(4.0f));
            this.rippleDrawable.draw(canvas);
        }
        canvas.restore();
        this.acceptRect.set(AndroidUtilities.m1081dp(46.0f), AndroidUtilities.m1081dp(40.0f), AndroidUtilities.m1081dp(46.0f) + this.buttonWidth, AndroidUtilities.m1081dp(40.0f) + this.buttonWidth);
        canvas.save();
        ...
        canvas.translate(this.leftOffsetX + AndroidUtilities.m1081dp(46.0f), 0.0f);
        if (!this.retryMod) {
        ...
        if (this.retryMod) {
            canvas.save();
            canvas.translate((this.buttonWidth / 2.0f) - (this.retryLayout.getWidth() / 2.0f), this.buttonWidth + AndroidUtilities.m1081dp(4.0f));
            this.retryLayout.draw(canvas);
            canvas.restore();
        } else {
            canvas.save();
            canvas.translate((this.buttonWidth / 2.0f) - (this.acceptLayout.getWidth() / 2.0f), this.buttonWidth + AndroidUtilities.m1081dp(4.0f));
        ...
        if (this.isVideo) {
            ...
            canvas.translate((AndroidUtilities.m1081dp(48.0f) - iM1081dp) / 2.0f, (AndroidUtilities.m1081dp(48.0f) - iM1081dp) / 2.0f);
            this.acceptVideoDrawable.setBounds(0, 0, iM1081dp, iM1081dp);
