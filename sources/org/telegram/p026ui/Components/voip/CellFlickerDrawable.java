...
public class CellFlickerDrawable {
    ...
    public CellFlickerDrawable() {
        this(64, 204, Opcodes.IF_ICMPNE);
    }

    public CellFlickerDrawable(int i, int i2) {
        this(i, i2, Opcodes.IF_ICMPNE);
    }
    ...
    public CellFlickerDrawable(int i, int i2, int i3) {
        ...
        this.size = AndroidUtilities.m1081dp(i3);
        float f = this.size;
        ...
        this.paintOutline.setStrokeWidth(AndroidUtilities.m1081dp(2.0f));
    }
