...
public class VoIPFloatingLayout extends FrameLayout {
        ...
        setOutlineProvider(new ViewOutlineProvider() { // from class: org.telegram.ui.Components.voip.VoIPFloatingLayout.2
            ...
            public void getOutline(View view, Outline outline) {
                ...
                if (!VoIPFloatingLayout.this.floatingMode) {
                    ...
                    outline.setRoundRect(0, 0, view.getMeasuredWidth(), view.getMeasuredHeight(), VoIPFloatingLayout.this.floatingMode ? AndroidUtilities.m1081dp(4.0f) : 0.0f);
                }
            }
        });
        setClipToOutline(true);
        this.mutedPaint.setColor(ColorUtils.setAlphaComponent(-16777216, 102));
        this.mutedDrawable = ContextCompat.getDrawable(context, C2702R.drawable.calls_mute_mini);
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (getMeasuredHeight() != this.lastH && getMeasuredWidth() != this.lastW) {
            ...
            this.path.addRoundRect(this.rectF, AndroidUtilities.m1081dp(4.0f), AndroidUtilities.m1081dp(4.0f), Path.Direction.CW);
    ...
    private void updatePadding() {
        ...
        this.topPadding = this.uiVisible ? AndroidUtilities.m1081dp(60.0f) : AndroidUtilities.m1081dp(16.0f);
        this.bottomPadding = AndroidUtilities.m1081dp(this.uiVisible ? 100.0f : 16.0f) + this.bottomOffset;
    }
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.voip.VoIPFloatingLayout.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        int measuredHeight = getMeasuredHeight() - ((int) ((AndroidUtilities.m1081dp(18.0f) * 1.0f) / getScaleY()));
        canvas.save();
        ...
        canvas.drawCircle(f, f2, AndroidUtilities.m1081dp(14.0f), voIPFloatingLayout.mutedPaint);
