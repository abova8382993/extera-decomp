...
public class VoIPEllipsizeSpan extends ReplacementSpan {
    ...
    public void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
        float interpolation;
        canvas.save();
        canvas.translate(f + AndroidUtilities.m1081dp(4.0f), i4 / 2.0f);
        ...
        for (int i6 = 0; i6 < 3; i6++) {
            ...
            canvas.drawCircle(AndroidUtilities.dpf2((this.interpolator.getInterpolation(fMin) * 16.0f) + 1.667f), AndroidUtilities.m1081dp(3.0f), AndroidUtilities.dpf2(interpolation * 2.0f), paint);
        }
        canvas.restore();
