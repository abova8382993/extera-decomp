...
public abstract class StickersDialogs {
    ...
    public static /* synthetic */ void m12006$r8$lambda$_hnR8VeKoqzA2OPCRcOT4Rt9Us() {
    }
    ...
    public static void showNameEditorDialog(TLRPC.StickerSet stickerSet, Theme.ResourcesProvider resourcesProvider, final Context context, final Utilities.Callback2 callback2) {
        ...
        builder.setTitle(LocaleController.getString(z ? C2702R.string.EditStickerPack : C2702R.string.NewStickerPack));
        builder.setMessage(LocaleController.getString(C2702R.string.StickersChooseNameForStickerPack));
        FrameLayout frameLayout = new FrameLayout(context);
        frameLayout.setPadding(AndroidUtilities.m1081dp(24.0f), 0, AndroidUtilities.m1081dp(20.0f), 0);
        final EditTextBoldCursor editTextBoldCursor = new EditTextBoldCursor(context) { // from class: org.telegram.ui.Components.StickersDialogs.1
            ...
            protected void onMeasure(int i, int i2) {
                super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(50.0f), TLObject.FLAG_30));
            }
        };
        ...
        editTextBoldCursor.setPadding(AndroidUtilities.m1081dp(LocaleController.isRTL ? 28.0f : 0.0f), 0, AndroidUtilities.m1081dp(LocaleController.isRTL ? 0.0f : 28.0f), 0);
        ...
        builder.setPositiveButton(LocaleController.getString(z ? C2702R.string.Done : C2702R.string.Create), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.StickersDialogs$$ExternalSyntheticLambda1
        ...
        builder.setNegativeButton(LocaleController.getString(C2702R.string.Cancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.StickersDialogs$$ExternalSyntheticLambda2
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i2) {
    ...
    public static void showDeleteForEveryOneDialog(final TLRPC.StickerSet stickerSet, Theme.ResourcesProvider resourcesProvider, Context context, final Runnable runnable) {
        ...
        AlertDialog alertDialogCreate = new AlertDialog.Builder(context, resourcesProvider).setTitle(LocaleController.getString(C2702R.string.StickersDeleteStickerSetTitle)).setMessage(LocaleController.getString(C2702R.string.StickersDeleteStickerSetDescription)).setPositiveButton(LocaleController.getString(C2702R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.StickersDialogs$$ExternalSyntheticLambda6
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
                StickersDialogs.m12005$r8$lambda$YO0w2MC46Ze4CtRzzGkru9YLik(runnable, stickerSet, alertDialog, i);
            }
    ...
    public static /* synthetic */ void m12005$r8$lambda$YO0w2MC46Ze4CtRzzGkru9YLik(Runnable runnable, TLRPC.StickerSet stickerSet, AlertDialog alertDialog, int i) {
        runnable.run();
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.StickersDialogs$$ExternalSyntheticLambda10
                    ...
                    public final void run() {
                        StickersDialogs.m12006$r8$lambda$_hnR8VeKoqzA2OPCRcOT4Rt9Us();
                    }
                });
            }
        });
    ...
    private static void openStickerPickerDialog(final TLRPC.TL_messages_stickerSet tL_messages_stickerSet, BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider) {
        ...
        emojiBottomSheet.whenDocumentSelected(new Utilities.Callback3Return() { // from class: org.telegram.ui.Components.StickersDialogs$$ExternalSyntheticLambda8
            ...
            public final Object run(Object obj, Object obj2, Object obj3) {
                return StickersDialogs.m12008$r8$lambda$o7KvI6jticMZZAlTouYSxsHIg(i, context, tL_messages_stickerSet, obj, (TLRPC.Document) obj2, (Boolean) obj3);
            }
        });
    ...
    public static /* synthetic */ Boolean m12008$r8$lambda$o7KvI6jticMZZAlTouYSxsHIg(final int i, Context context, TLRPC.TL_messages_stickerSet tL_messages_stickerSet, final Object obj, final TLRPC.Document document, Boolean bool) {
    ...
    public static void showAddStickerDialog(final TLRPC.TL_messages_stickerSet tL_messages_stickerSet, View view, final BaseFragment baseFragment, final Theme.ResourcesProvider resourcesProvider) {
        ...
        ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout = new ActionBarPopupWindow.ActionBarPopupWindowLayout(context, C2702R.drawable.popup_fixed_alert3, resourcesProvider, 0);
        ArrayList arrayList = new ArrayList();
        final ArrayList arrayList2 = new ArrayList();
        ArrayList arrayList3 = new ArrayList();
        arrayList.add(LocaleController.getString(C2702R.string.StickersCreateNewSticker));
        arrayList3.add(Integer.valueOf(C2702R.drawable.menu_sticker_add));
        arrayList2.add(0);
        arrayList.add(LocaleController.getString(C2702R.string.StickersAddAnExistingSticker));
        arrayList3.add(Integer.valueOf(C2702R.drawable.menu_sticker_select));
        arrayList2.add(1);
        ...
        View.OnClickListener onClickListener = new View.OnClickListener() { // from class: org.telegram.ui.Components.StickersDialogs$$ExternalSyntheticLambda5
            ...
            public final void onClick(View view2) {
                StickersDialogs.m12004$r8$lambda$KwNe0gshzMmIwENIJT3PkIZ_Wc(actionBarPopupWindow, arrayList2, tL_messages_stickerSet, baseFragment, resourcesProvider, view2);
            }
        };
    ...
    public static /* synthetic */ void m12004$r8$lambda$KwNe0gshzMmIwENIJT3PkIZ_Wc(ActionBarPopupWindow actionBarPopupWindow, ArrayList arrayList, TLRPC.TL_messages_stickerSet tL_messages_stickerSet, BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider, View view) {
