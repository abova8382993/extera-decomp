...
public class LinkSpanDrawable {
    ...
    public boolean draw(Canvas canvas) {
        ...
        float f;
        float f2;
        int iM1081dp = this.isLite ? 0 : AndroidUtilities.m1081dp(4.0f);
        boolean z2 = this.cornerRadius != iM1081dp;
        ...
        float f4 = 1.0f - f2;
        this.mSelectionPaint.setStrokeWidth(Math.min(1.0f, f4) * AndroidUtilities.m1081dp(5.0f));
        ...
        this.mRipplePaint.setStrokeWidth(Math.min(1.0f, f4) * AndroidUtilities.m1081dp(5.0f));
    ...
    public static class ClickableSmallTextView extends SimpleTextView {
        ...
        protected void onDraw(Canvas canvas) {
            if (isClickable()) {
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.m1081dp(4.0f), AndroidUtilities.m1081dp(4.0f), this.linkBackgroundPaint);
            }
            super.onDraw(canvas);
