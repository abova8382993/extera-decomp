...
public abstract class ScrollableHorizontalScrollView extends HorizontalScrollView {
    ...
    public boolean scrollToVisible(int i, int i2) {
        ...
        if (i < getScrollX() + iM1081dp) {
            measuredWidth = i - iM1081dp;
        } else {
            if (i2 <= getScrollX() + (getMeasuredWidth() - iM1081dp)) {
                return false;
            }
            measuredWidth = (i2 - getMeasuredWidth()) + iM1081dp;
        }
    ...
    class C47671 extends AnimatorListenerAdapter {
        C47671() {
        }
