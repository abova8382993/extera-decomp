...
public abstract class ReportAlert extends BottomSheet {
    ...
    public ReportAlert(Context context, final int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        rLottieImageView.setAnimation(C2702R.raw.report_police, Opcodes.ISHL, Opcodes.ISHL);
        ...
        if (i == 0) {
            textView.setText(LocaleController.getString(C2702R.string.ReportTitleSpam));
        } else if (i == 6) {
            textView.setText(LocaleController.getString(C2702R.string.ReportTitleFake));
        } else if (i == 1) {
            textView.setText(LocaleController.getString(C2702R.string.ReportTitleViolence));
        } else if (i == 2) {
            textView.setText(LocaleController.getString(C2702R.string.ReportTitleChild));
        } else if (i == 5) {
            textView.setText(LocaleController.getString(C2702R.string.ReportTitlePornography));
        } else if (i == 100) {
            textView.setText(LocaleController.getString(C2702R.string.ReportChat));
        }
        ...
        textView2.setText(LocaleController.getString(C2702R.string.ReportInfo));
        ...
        this.editText.setHint(LocaleController.getString(C2702R.string.ReportHint));
        ...
        this.clearButton.setText(LocaleController.getString(C2702R.string.ReportSend));
