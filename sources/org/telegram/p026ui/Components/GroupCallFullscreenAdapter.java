...
public class GroupCallFullscreenAdapter extends RecyclerListView.SelectionAdapter {
    ...
    public void scrollTo(ChatObject.VideoParticipant videoParticipant, RecyclerListView recyclerListView) {
        ...
        for (int i = 0; i < this.videoParticipants.size(); i++) {
            if (((ChatObject.VideoParticipant) this.videoParticipants.get(i)).equals(videoParticipant)) {
                linearLayoutManager.scrollToPositionWithOffset(i, AndroidUtilities.m1081dp(13.0f));
                return;
            }
        }
    }
    ...
    public class GroupCallUserCell extends FrameLayout implements GroupCallStatusIcon.Callback {
        ...
        public GroupCallUserCell(Context context) {
            ...
            this.avatarWavesDrawable = new GroupCallUserCell.AvatarWavesDrawable(AndroidUtilities.m1081dp(26.0f), AndroidUtilities.m1081dp(29.0f));
            this.avatarDrawable.setTextSize((int) (AndroidUtilities.m1081dp(18.0f) / 1.15f));
            ...
            this.selectionPaint.setStrokeWidth(AndroidUtilities.m1081dp(2.0f));
            this.textPaint.setColor(-1);
            C42461 c42461 = new RLottieImageView(context) { // from class: org.telegram.ui.Components.GroupCallFullscreenAdapter.GroupCallUserCell.1
                final /* synthetic */ GroupCallFullscreenAdapter val$this$0;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C42461(Context context2, GroupCallFullscreenAdapter groupCallFullscreenAdapter) {
                    super(context2);
            ...
            this.muteButton = c42461;
            c42461.setScaleType(ImageView.ScaleType.CENTER);
        ...
        class C42461 extends RLottieImageView {
            final /* synthetic */ GroupCallFullscreenAdapter val$this$0;
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (this.name != null) {
                int iMin = (int) Math.min(AndroidUtilities.m1081dp(46.0f), this.textPaint.measureText(this.name));
                this.nameWidth = iMin;
                this.drawingName = TextUtils.ellipsize(this.name, this.textPaint, iMin, TextUtils.TruncateAt.END).toString();
            }
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(80.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(80.0f), TLObject.FLAG_30));
        }
        ...
        public void setProgressToFullscreen(float f) {
            ...
            float f2 = 1.0f - f;
            float fM1081dp = ((AndroidUtilities.m1081dp(46.0f) / AndroidUtilities.m1081dp(40.0f)) * f2) + (1.0f * f);
            ...
            this.avatarImageView.setScaleX(fM1081dp);
            this.avatarImageView.setScaleY(fM1081dp);
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            float fM1081dp = ((AndroidUtilities.m1081dp(46.0f) / AndroidUtilities.m1081dp(40.0f)) * (1.0f - f)) + (f * 1.0f);
            this.avatarImageView.setScaleX(this.avatarWavesDrawable.getAvatarScale() * fM1081dp);
            this.avatarImageView.setScaleY(this.avatarWavesDrawable.getAvatarScale() * fM1081dp);
        ...
        */
        private void drawSelection(android.graphics.Canvas r7) {
            ...
            L33:
                ...
                int r1 = org.telegram.messenger.AndroidUtilities.m1081dp(r0)
                float r1 = (float) r1
        ...
        public void drawOverlays(Canvas canvas) {
            if (this.drawingName != null) {
                canvas.save();
                int measuredWidth = ((getMeasuredWidth() - this.nameWidth) - AndroidUtilities.m1081dp(24.0f)) / 2;
                this.textPaint.setAlpha((int) (this.progress * 255.0f * getAlpha()));
                canvas.drawText(this.drawingName, AndroidUtilities.m1081dp(22.0f) + measuredWidth, AndroidUtilities.m1081dp(69.0f), this.textPaint);
                canvas.restore();
                canvas.save();
                canvas.translate(measuredWidth, AndroidUtilities.m1081dp(53.0f));
        ...
        */
        public void updateState(boolean r9) {
            ...
            L19:
                ...
                goto L16
            L28:
                int r0 = org.telegram.p026ui.ActionBar.Theme.key_voipgroup_nameText
                int r0 = org.telegram.p026ui.ActionBar.Theme.getColor(r0)
                int r1 = org.telegram.p026ui.ActionBar.Theme.key_voipgroup_listeningText
        ...
        class C42472 extends AnimatorListenerAdapter {
    ...
    public void update(boolean z, RecyclerListView recyclerListView) {
        ...
        if (z) {
            ...
            DiffUtil.calculateDiff(new DiffUtil.Callback() { // from class: org.telegram.ui.Components.GroupCallFullscreenAdapter.1
                ...
                C42441(ArrayList arrayList22, ArrayList arrayList3) {
    ...
    class C42441 extends DiffUtil.Callback {
        final /* synthetic */ ArrayList val$oldParticipants;
        final /* synthetic */ ArrayList val$oldVideoParticipants;
