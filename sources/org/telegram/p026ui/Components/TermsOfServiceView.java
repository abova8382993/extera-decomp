...
public class TermsOfServiceView extends FrameLayout {
    ...
    public TermsOfServiceView(Context context) {
        ...
        imageView.setImageResource(C2702R.drawable.logo_middle);
        ...
        this.titleTextView.setText(LocaleController.getString(C2702R.string.PrivacyPolicyAndTerms));
        ...
        this.textView.setLineSpacing(AndroidUtilities.m1081dp(2.0f), 1.0f);
        linearLayout.addView(this.textView, LayoutHelper.createLinear(-1, -2, 3, 0, 15, 0, 15));
        ScrollView scrollView = new ScrollView(context);
        this.scrollView = scrollView;
        scrollView.setVerticalScrollBarEnabled(false);
        this.scrollView.setOverScrollMode(2);
        this.scrollView.setPadding(AndroidUtilities.m1081dp(24.0f), i, AndroidUtilities.m1081dp(24.0f), AndroidUtilities.m1081dp(75.0f));
        ...
        textView3.setText(LocaleController.getString(C2702R.string.Decline).toUpperCase());
        ...
        textView3.setPadding(AndroidUtilities.m1081dp(20.0f), AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(20.0f), AndroidUtilities.m1081dp(10.0f));
        ...
        textView4.setText(LocaleController.getString(C2702R.string.Accept));
        textView4.setGravity(17);
        textView4.setTypeface(AndroidUtilities.bold());
        textView4.setTextColor(-1);
        textView4.setTextSize(1, 14.0f);
        textView4.setBackgroundDrawable(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1081dp(4.0f), -11491093, -12346402));
        textView4.setPadding(AndroidUtilities.m1081dp(34.0f), 0, AndroidUtilities.m1081dp(34.0f), 0);
        ...
        layoutParams.bottomMargin = AndroidUtilities.m1081dp(75.0f);
    ...
    public /* synthetic */ void lambda$new$4(View view) {
        ...
        builder.setTitle(LocaleController.getString(C2702R.string.TermsOfService));
        builder.setPositiveButton(LocaleController.getString(C2702R.string.DeclineDeactivate), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.TermsOfServiceView$$ExternalSyntheticLambda3
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
                this.f$0.lambda$new$3(alertDialog, i);
            }
        });
        builder.setNegativeButton(LocaleController.getString(C2702R.string.Back), null);
        builder.setMessage(LocaleController.getString(C2702R.string.TosUpdateDecline));
        builder.show();
    }
    ...
    public /* synthetic */ void lambda$new$3(AlertDialog alertDialog, int i) {
        ...
        builder.setMessage(LocaleController.getString(C2702R.string.TosDeclineDeleteAccount));
        builder.setTitle(LocaleController.getString(C2702R.string.AppName));
        builder.setPositiveButton(LocaleController.getString(C2702R.string.Deactivate), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.TermsOfServiceView$$ExternalSyntheticLambda5
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
    ...
    public /* synthetic */ void lambda$new$0(AlertDialog alertDialog, TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (tL_error == null || tL_error.code != -1000) {
            String string = LocaleController.getString(C2702R.string.ErrorOccurred);
            if (tL_error != null) {
                string = string + "\n" + tL_error.text;
            }
            AlertDialog.Builder builder = new AlertDialog.Builder(getContext());
    ...
    public /* synthetic */ void lambda$new$6(View view) {
        if (this.currentTos.min_age_confirm != 0) {
            AlertDialog.Builder builder = new AlertDialog.Builder(view.getContext());
            builder.setTitle(LocaleController.getString(C2702R.string.TosAgeTitle));
            builder.setPositiveButton(LocaleController.getString(C2702R.string.Agree), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.TermsOfServiceView$$ExternalSyntheticLambda2
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i) {
            ...
            builder.setNegativeButton(LocaleController.getString(C2702R.string.Cancel), null);
            builder.setMessage(LocaleController.formatString("TosAgeText", C2702R.string.TosAgeText, LocaleController.formatPluralString("Years", this.currentTos.min_age_confirm, new Object[0])));
            builder.show();
            return;
        }
        accept();
    ...
    private void accept() {
        ...
        tL_help_acceptTermsOfService.f1674id = this.currentTos.f1676id;
    ...
    public void show(int i, TLRPC.TL_help_termsOfService tL_help_termsOfService) {
        ...
        addBulletsToText(spannableStringBuilder, SignatureVisitor.SUPER, AndroidUtilities.m1081dp(10.0f), -11491093, AndroidUtilities.m1081dp(4.0f));
