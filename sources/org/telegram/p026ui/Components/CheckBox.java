...
public class CheckBox extends View {
    ...
    public CheckBox(Context context, int i) {
        ...
        eraser2.setStrokeWidth(AndroidUtilities.m1081dp(28.0f));
        backgroundPaint.setStrokeWidth(AndroidUtilities.m1081dp(2.0f));
        TextPaint textPaint = new TextPaint(1);
        this.textPaint = textPaint;
        textPaint.setTextSize(AndroidUtilities.m1081dp(18.0f));
    ...
    public void setVisibility(int i) {
        ...
        if (i == 0 && this.drawBitmap == null) {
            try {
                int iM1081dp = AndroidUtilities.m1081dp(this.size);
                int iM1081dp2 = AndroidUtilities.m1081dp(this.size);
                Bitmap.Config config = Bitmap.Config.ARGB_4444;
                this.drawBitmap = Bitmap.createBitmap(iM1081dp, iM1081dp2, config);
                this.bitmapCanvas = new Canvas(this.drawBitmap);
                this.checkBitmap = Bitmap.createBitmap(AndroidUtilities.m1081dp(this.size), AndroidUtilities.m1081dp(this.size), config);
    ...
    public void setSize(int i) {
        this.size = i;
        if (i == 40) {
            this.textPaint.setTextSize(AndroidUtilities.m1081dp(24.0f));
        }
    }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.CheckBox$1 */
    /* JADX INFO: loaded from: classes5.dex */
    class C40431 extends AnimatorListenerAdapter {
        C40431() {
        }
    ...
    */
    protected void onDraw(android.graphics.Canvas r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.CheckBox.onDraw(android.graphics.Canvas):void");
    }
