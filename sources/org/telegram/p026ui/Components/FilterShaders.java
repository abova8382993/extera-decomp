...
public class FilterShaders {
    ...
    private static class ToneCurve {
        ...
        private float[] getPreparedSplineCurve(ArrayList arrayList) {
            ...
            ArrayList arrayListSplineCurve = splineCurve(arrayList);
            float f = ((PointF) arrayListSplineCurve.get(0)).x;
            if (f > 0.0f) {
                for (int i2 = (int) f; i2 >= 0; i2--) {
                    arrayListSplineCurve.add(0, new PointF(i2, 0.0f));
                }
            }
            float f2 = ((PointF) arrayListSplineCurve.get(arrayListSplineCurve.size() - 1)).x;
            if (f2 < 255.0f) {
                int i3 = (int) f2;
                while (true) {
                    i3++;
            ...
            for (int i4 = 0; i4 < size2; i4++) {
                PointF pointF2 = (PointF) arrayListSplineCurve.get(i4);
  ...
  0x0075: PHI (r2v9 float) = (r2v5 float), (r2v6 float) binds: [B:39:0x0073, B:42:0x007a] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        */
        private java.util.ArrayList splineCurve(java.util.ArrayList r23) {
            /*
                r22 = this;
                r0 = r23
                double[] r1 = r22.secondDerivative(r23)
                int r2 = r1.length
                r3 = 1
                if (r2 >= r3) goto Lc
                r0 = 0
            ...
            L29:
                ...
                double r1 = r20 + r1
                double r18 = r18 * r18
                r20 = 4618441417868443648(0x4018000000000000, double:6.0)
                double r18 = r18 / r20
                double r20 = r3 * r3
                double r20 = r20 * r3
                double r20 = r20 - r3
        ...
        private double[] secondDerivative(ArrayList arrayList) {
            ...
            while (true) {
                ...
                PointF pointF = (PointF) arrayList.get(i4 - 1);
    ...
    private boolean setupExternalShaders() {
        ...
        if (hDRType == 1) {
            res = AndroidUtilities.readRes(C2702R.raw.hdr2sdr_hlg);
        } else if (hDRType != 2) {
            res = _UrlKt.FRAGMENT_ENCODE_SET;
        } else {
            res = AndroidUtilities.readRes(C2702R.raw.hdr2sdr_pq);
        }
        boolean z = this.isVideo;
        String str3 = z ? "#extension GL_OES_EGL_image_external : require" : _UrlKt.FRAGMENT_ENCODE_SET;
        ...
        while (true) {
            ...
            if (i3 < (z2 ? i : i2)) {
                ...
                GLES20.glAttachShader(this.rgbToHsvShaderProgram[i3], iLoadShader5);
    ...
    public void drawCustomParamsPass() {
        ...
        if (filterShadersDelegate == null || filterShadersDelegate.shouldShowOriginal()) {
            ...
            GLES20.glUniform3f(this.highlightsTintColorHandle, ((tintHighlightsColor >> 16) & Function.USE_VARARGS) / 255.0f, ((tintHighlightsColor >> 8) & Function.USE_VARARGS) / 255.0f, (tintHighlightsColor & Function.USE_VARARGS) / 255.0f);
            GLES20.glUniform1f(this.highlightsTintIntensityHandle, this.delegate.getTintHighlightsIntensityValue());
            GLES20.glUniform3f(this.shadowsTintColorHandle, ((tintShadowsColor >> 16) & Function.USE_VARARGS) / 255.0f, ((tintShadowsColor >> 8) & Function.USE_VARARGS) / 255.0f, (tintShadowsColor & Function.USE_VARARGS) / 255.0f);
            ...
            if (zShouldDrawCurvesPass) {
                ...
                GLES20.glActiveTexture(33985);
                GLES20.glBindTexture(3553, this.curveTextures[0]);
                GLES20.glTexImage2D(3553, 0, 6408, DataTypes.EMPTY, 1, 0, 6408, 5121, byteBufferFillAndGetCurveBuffer);
    ...
    public boolean drawBlurPass() {
        ...
        if (blurType == 1) {
            ...
            GLES20.glUniform2f(this.radialBlurExcludePointHandle, blurExcludePoint.f1967x, blurExcludePoint.f1968y);
            ...
            GLES20.glUniform2f(this.linearBlurExcludePointHandle, blurExcludePoint2.f1967x, blurExcludePoint2.f1968y);
    ...
    class C41951 implements FilterShadersDelegate {
