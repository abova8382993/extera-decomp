...
public class SeekBarView extends FrameLayout {
    ...
    public interface SeekBarViewDelegate {
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Components.SeekBarView$SeekBarViewDelegate$-CC */
    ...
    public SeekBarView(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.selectorWidth = AndroidUtilities.m1081dp(32.0f);
        this.thumbSize = AndroidUtilities.m1081dp(24.0f);
        this.currentRadius = AndroidUtilities.m1081dp(6.0f);
        Drawable drawableCreateSelectorDrawable = Theme.createSelectorDrawable(ColorUtils.setAlphaComponent(getThemedColor(i), 40), 1, AndroidUtilities.m1081dp(16.0f));
        ...
        C48071 c48071 = new AudioPlayerAlert.ClippingTextViewSwitcher(context) { // from class: org.telegram.ui.Components.SeekBarView.1
            final /* synthetic */ Context val$context;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C48071(Context context2, Context context22) {
                super(context22);
                context = context22;
            }
            ...
            protected TextView createTextView() {
                ...
                marqueeTextView.setPadding(AndroidUtilities.m1081dp(0.0f), 0, AndroidUtilities.m1081dp(0.0f), AndroidUtilities.m1081dp(0.0f));
                return marqueeTextView;
            }
        };
        this.textViewSwitcher = c48071;
        c48071.setIsCenter();
        addView(c48071, LayoutHelper.createFrame(-1, -2.0f));
        setImportantForAccessibility(1);
        C48082 c48082 = new FloatSeekBarAccessibilityDelegate(z) { // from class: org.telegram.ui.Components.SeekBarView.2
            C48082(boolean z2) {
                super(z2);
            }

            @Override // org.telegram.p026ui.Components.FloatSeekBarAccessibilityDelegate
        ...
        this.seekBarAccessibilityDelegate = c48082;
        setAccessibilityDelegate(c48082);
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.SeekBarView$1 */
    class C48071 extends AudioPlayerAlert.ClippingTextViewSwitcher {
        final /* synthetic */ Context val$context;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C48071(Context context22, Context context222) {
            super(context222);
            context = context222;
        }
    ...
    class C48082 extends FloatSeekBarAccessibilityDelegate {
        C48082(boolean z2) {
            super(z2);
        }
    ...
    boolean onTouch(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            this.f2023sx = motionEvent.getX();
            this.f2024sy = motionEvent.getY();
            return true;
        }
        if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
            this.captured = false;
            if (motionEvent.getAction() == 1) {
                if (Math.abs(motionEvent.getY() - this.f2024sy) < ViewConfiguration.get(getContext()).getScaledTouchSlop()) {
            ...
            if (!this.captured) {
                ...
                if (Math.abs(motionEvent.getY() - this.f2024sy) <= viewConfiguration.getScaledTouchSlop() && Math.abs(motionEvent.getX() - this.f2023sx) > viewConfiguration.getScaledTouchSlop()) {
                    this.captured = true;
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int measuredHeight = (getMeasuredHeight() / 2) + AndroidUtilities.m1081dp(14.0f) + (this.textViewSwitcher.getMeasuredHeight() / 2);
        int iM1081dp = (this.selectorWidth / 2) + (this.lastDuration > 600000 ? AndroidUtilities.m1081dp(42.0f) : 0) + AndroidUtilities.m1081dp(25.0f) + AndroidUtilities.m1081dp(8.0f);
        AudioPlayerAlert.ClippingTextViewSwitcher clippingTextViewSwitcher = this.textViewSwitcher;
        clippingTextViewSwitcher.layout(iM1081dp, measuredHeight - clippingTextViewSwitcher.getMeasuredHeight(), this.textViewSwitcher.getMeasuredWidth() + iM1081dp, measuredHeight);
    }
    ...
    */
    protected void onDraw(android.graphics.Canvas r17) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.SeekBarView.onDraw(android.graphics.Canvas):void");
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:192:0x01e0 A[EDGE_INSN: B:192:0x01e0->B:183:0x01e0 BREAK  A[LOOP:2: B:129:0x00aa->B:182:0x01d6], SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:193:0x01d6 A[SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void drawProgressBar(android.graphics.Canvas r26, android.graphics.RectF r27, android.graphics.Paint r28) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.SeekBarView.drawProgressBar(android.graphics.Canvas, android.graphics.RectF, android.graphics.Paint):void");
    }
    ...
    private int getTimestampLabelWidth() {
        return (int) (Math.abs(((this.selectorWidth / 2.0f) + (this.lastDuration > 600000 ? AndroidUtilities.m1081dp(42.0f) : 0)) - ((getMeasuredWidth() - (this.selectorWidth / 2.0f)) - (this.lastDuration > 600000 ? AndroidUtilities.m1081dp(42.0f) : 0))) - AndroidUtilities.m1081dp(66.0f));
    }
    ...
    private void drawTimestampLabel(Canvas canvas) {
        ...
        float fM1081dp = (this.selectorWidth / 2.0f) + (this.lastDuration > 600000 ? AndroidUtilities.m1081dp(42.0f) : 0);
        float fAbs = Math.abs(fM1081dp - ((getMeasuredWidth() - (this.selectorWidth / 2.0f)) - (this.lastDuration > 600000 ? AndroidUtilities.m1081dp(42.0f) : 0))) - AndroidUtilities.m1081dp(66.0f);
        ...
        canvas.save();
        canvas.translate(fM1081dp + AndroidUtilities.m1081dp(25.0f), (getMeasuredHeight() / 2.0f) + AndroidUtilities.m1081dp(14.0f));
        ...
        if (this.timestampLabel[1] != null) {
            ...
            if (this.timestampChangeDirection != 0) {
                canvas.translate(AndroidUtilities.m1081dp(8.0f) + (AndroidUtilities.m1081dp(16.0f) * (-this.timestampChangeDirection) * interpolation), 0.0f);
            }
        ...
        if (this.timestampLabel[0] != null) {
            canvas.save();
            if (this.timestampChangeDirection != 0) {
                canvas.translate(AndroidUtilities.m1081dp(8.0f) + (AndroidUtilities.m1081dp(16.0f) * this.timestampChangeDirection * (1.0f - interpolation)), 0.0f);
            }
    ...
    private StaticLayout makeStaticLayout(CharSequence charSequence, int i) {
        ...
        return StaticLayout.Builder.obtain(charSequence, 0, charSequence.length(), this.timestampLabelPaint, i).setMaxLines(1).setAlignment(Layout.Alignment.ALIGN_CENTER).setEllipsize(TextUtils.TruncateAt.END).setEllipsizedWidth(Math.min(AndroidUtilities.m1081dp(400.0f), i)).build();
    }
