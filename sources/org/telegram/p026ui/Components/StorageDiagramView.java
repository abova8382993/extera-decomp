...
public abstract class StorageDiagramView extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public StorageDiagramView(Context context, long j) {
        ...
        if (j == Long.MAX_VALUE) {
            this.dialogText = LocaleController.getString(C2702R.string.CacheOtherChats);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.dialogId != null) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(166.0f), TLObject.FLAG_30));
            size = (View.MeasureSpec.getSize(i) - AndroidUtilities.m1081dp(110.0f)) / 2;
            this.rectF.set(AndroidUtilities.m1081dp(3.0f) + size, AndroidUtilities.m1081dp(3.0f), AndroidUtilities.m1081dp(107.0f) + size, AndroidUtilities.m1081dp(107.0f));
        } else {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(110.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(110.0f), TLObject.FLAG_30));
            this.rectF.set(AndroidUtilities.m1081dp(3.0f), AndroidUtilities.m1081dp(3.0f), AndroidUtilities.m1081dp(107.0f), AndroidUtilities.m1081dp(107.0f));
            size = 0;
        }
        ...
        this.text1.setTextSize(AndroidUtilities.m1081dp(24.0f));
        this.text1.setTypeface(AndroidUtilities.bold());
        this.text2.setAnimationProperties(0.18f, 0L, 300L, cubicBezierInterpolator);
        if (this.dialogId != null) {
            this.text2.setTextSize(AndroidUtilities.m1081dp(16.0f));
            this.text1.setGravity(5);
            this.text2.setGravity(3);
        } else {
            this.text2.setTextSize(AndroidUtilities.m1081dp(13.0f));
            int textSize = (int) this.text1.getTextSize();
            int textSize2 = (int) this.text2.getTextSize();
            int iM1081dp = ((AndroidUtilities.m1081dp(110.0f) - textSize) - textSize2) / 2;
            int i3 = textSize + iM1081dp;
            this.text1.setBounds(0, iM1081dp, getMeasuredWidth(), i3);
            this.text2.setBounds(0, AndroidUtilities.m1081dp(2.0f) + i3, getMeasuredWidth(), i3 + textSize2 + AndroidUtilities.m1081dp(2.0f));
        ...
        if (this.dialogText != null) {
            ...
            this.dialogTextPaint.setTextSize(AndroidUtilities.m1081dp(13.0f));
            int size2 = View.MeasureSpec.getSize(i) - AndroidUtilities.m1081dp(60.0f);
        ...
        if (imageReceiver != null) {
            imageReceiver.setImageCoords(size + AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(90.0f), AndroidUtilities.m1081dp(90.0f));
            this.avatarImageReceiver.setRoundRadius(AndroidUtilities.m1081dp(45.0f));
        }
        updateDescription();
    }
    ...
    */
    protected void onDraw(android.graphics.Canvas r29) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.StorageDiagramView.onDraw(android.graphics.Canvas):void");
    }
    ...
    public static class ClearViewData {
        ...
        public ClearViewData(StorageDiagramView storageDiagramView) {
            ...
            this.paint.setStrokeWidth(AndroidUtilities.m1081dp(5.0f));
    ...
    public void update(boolean z) {
        ...
        this.valueAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.StorageDiagramView.1
            ...
            C49871(final ClearViewData[] clearViewDataArr2) {
    ...
    class C49871 extends AnimatorListenerAdapter {
        final /* synthetic */ ClearViewData[] val$data;
    ...
    class C49882 extends AnimatorListenerAdapter {
        C49882() {
        }
