...
public class BlockingUpdateView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public BlockingUpdateView(Context context, TLRPC.TL_help_appUpdate tL_help_appUpdate) {
        ...
        addView(frameLayout, new FrameLayout.LayoutParams(-1, AndroidUtilities.m1081dp(236.0f) + AndroidUtilities.statusBarHeight));
        RLottieImageView rLottieImageView = new RLottieImageView(context);
        rLottieImageView.setAutoRepeat(true);
        rLottieImageView.setAnimation(C2702R.raw.extera_arrow, Opcodes.ISHL, Opcodes.ISHL);
        ...
        textView.setText(LocaleController.getString(C2702R.string.UpdateAvailable));
        ...
        textView2.setText(LocaleController.formatString("AppUpdateVersionAndSize", C2702R.string.AppUpdateVersionAndSize, tL_help_appUpdate.version, AndroidUtilities.formatFileSize(tL_help_appUpdate.document.size)));
        ...
        scrollView.setPadding(0, AndroidUtilities.m1081dp(16.0f), 0, AndroidUtilities.m1081dp(16.0f));
        ...
        spoilersTextView.setLineSpacing(AndroidUtilities.m1081dp(2.0f), 1.0f);
        ...
        FrameLayout frameLayout3 = new FrameLayout(context) { // from class: org.telegram.ui.Components.BlockingUpdateView.1
            ...
            protected void onDraw(Canvas canvas) {
                ...
                this.cellFlickerDrawable.draw(canvas, rectF, AndroidUtilities.m1081dp(8.0f), null);
                invalidate();
            }
        };
        ...
        frameLayout3.setPadding(AndroidUtilities.m1081dp(16.0f), 0, AndroidUtilities.m1081dp(16.0f), 0);
        ...
        textView3.setText(LocaleController.getString(C2702R.string.Update));
        ...
        FrameLayout frameLayout4 = new FrameLayout(context) { // from class: org.telegram.ui.Components.BlockingUpdateView.2
            ...
            protected void onLayout(boolean z, int i4, int i5, int i6, int i7) {
                ...
                int i9 = (i8 - iM1081dp) / 2;
                int i10 = ((i7 - i5) - iM1081dp) / 2;
                BlockingUpdateView.this.radialProgress.setProgressRect(i9, i10, i9 + iM1081dp, iM1081dp + i10);
            }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        this.gradientDrawableTop.setBounds(this.scrollView.getLeft(), this.scrollView.getTop(), this.scrollView.getRight(), this.scrollView.getTop() + AndroidUtilities.m1081dp(16.0f));
        this.gradientDrawableTop.draw(canvas);
        this.gradientDrawableBottom.setBounds(this.scrollView.getLeft(), this.scrollView.getBottom() - AndroidUtilities.m1081dp(18.0f), this.scrollView.getRight(), this.scrollView.getBottom());
