...
public class AutoDeletePopupWrapper {
    ...
    public AutoDeletePopupWrapper(final Context context, final PopupSwipeBackLayout popupSwipeBackLayout, final Callback callback, boolean z, final int i, final Theme.ResourcesProvider resourcesProvider) {
        ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout = new ActionBarPopupWindow.ActionBarPopupWindowLayout(context, z ? C2702R.drawable.popup_fixed_alert : 0, resourcesProvider);
        this.windowLayout = actionBarPopupWindowLayout;
        actionBarPopupWindowLayout.setFitItems(true);
        this.callback = callback;
        if (popupSwipeBackLayout != null) {
            ActionBarMenuSubItem actionBarMenuSubItemAddItem = ActionBarMenuItem.addItem(this.windowLayout, C2702R.drawable.msg_arrow_back, LocaleController.getString(C2702R.string.Back), false, resourcesProvider);
        ...
        ActionBarMenuItem.addItem(this.windowLayout, C2702R.drawable.msg_autodelete_1d, LocaleController.getString(C2702R.string.AutoDelete1Day), false, resourcesProvider).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.AutoDeletePopupWrapper$$ExternalSyntheticLambda3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$new$1(callback, view);
            }
        });
        ActionBarMenuItem.addItem(this.windowLayout, C2702R.drawable.msg_autodelete_1w, LocaleController.getString(C2702R.string.AutoDelete7Days), false, resourcesProvider).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.AutoDeletePopupWrapper$$ExternalSyntheticLambda4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$new$2(callback, view);
            }
        });
        ActionBarMenuItem.addItem(this.windowLayout, C2702R.drawable.msg_autodelete_1m, LocaleController.getString(C2702R.string.AutoDelete1Month), false, resourcesProvider).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.AutoDeletePopupWrapper$$ExternalSyntheticLambda5
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$new$3(callback, view);
            }
        });
        ActionBarMenuItem.addItem(this.windowLayout, C2702R.drawable.msg_customize, i == 1 ? LocaleController.getString(C2702R.string.AutoDeleteCustom2) : LocaleController.getString(C2702R.string.AutoDeleteCustom), false, resourcesProvider).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.AutoDeletePopupWrapper$$ExternalSyntheticLambda6
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$new$5(context, i, resourcesProvider, callback, view);
            }
        });
        ActionBarMenuSubItem actionBarMenuSubItemAddItem2 = ActionBarMenuItem.addItem(this.windowLayout, C2702R.drawable.msg_disable, LocaleController.getString(C2702R.string.AutoDeleteDisable), false, resourcesProvider);
        ...
        if (i != 1) {
            ...
            view.setBackground(Theme.getThemedDrawableByKey(context, C2702R.drawable.greydivider, Theme.key_windowBackgroundGrayShadow, resourcesProvider));
            ...
            this.textView.setPadding(AndroidUtilities.m1081dp(13.0f), 0, AndroidUtilities.m1081dp(13.0f), AndroidUtilities.m1081dp(8.0f));
            ...
            this.textView.setText(LocaleController.getString(C2702R.string.AutoDeletePopupDescription));
    ...
    public void allowExtendedHint(int i) {
        ...
        spannableStringBuilder.append((CharSequence) LocaleController.getString(C2702R.string.AutoDeletePopupDescription));
        spannableStringBuilder.append((CharSequence) "\n\n");
        spannableStringBuilder.append((CharSequence) AndroidUtilities.replaceSingleLink(LocaleController.getString(C2702R.string.AutoDeletePopupDescription2), i, new Runnable() { // from class: org.telegram.ui.Components.AutoDeletePopupWrapper$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public interface Callback {
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Components.AutoDeletePopupWrapper$Callback$-CC */
