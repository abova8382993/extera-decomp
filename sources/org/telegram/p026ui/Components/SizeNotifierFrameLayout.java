...
public class SizeNotifierFrameLayout extends FrameLayout implements Theme.Colorable {
    ...
    public void startBlur() {
        ...
        if (this.blurIsRunning && !this.blurGeneratingTuskIsRunning && this.invalidateBlur && SharedConfig.chatBlurEnabled() && !DRAW_USING_RENDERNODE()) {
            if (Color.alpha(Theme.getColor(Theme.key_chat_BlurAlphaSlow)) != 255 || ExteraConfig.forceBlur) {
                ...
                int iM1081dp = AndroidUtilities.m1081dp(100.0f) + ActionBar.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight;
                if (measuredWidth == 0 || iM1081dp == 0) {
                    return;
                }
                ...
                this.blurBackgroundTask.radius = (int) (((int) (Math.max(6, Math.max(iM1081dp, measuredWidth) / Opcodes.GETFIELD) * 2.5f)) * BlurSettingsBottomSheet.blurRadius);
    ...
    class BlurBackgroundTask implements Runnable {
        ...
        /* synthetic */ BlurBackgroundTask(SizeNotifierFrameLayout sizeNotifierFrameLayout, SizeNotifierFrameLayoutIA sizeNotifierFrameLayoutIA) {
            this();
        }
        ...
        public /* synthetic */ void lambda$run$2() {
            ...
            SizeNotifierFrameLayout.this.blurCrossfade.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.SizeNotifierFrameLayout.BlurBackgroundTask.1
                ...
                C49421(BlurBitmap blurBitmap22) {
        ...
        class C49421 extends AnimatorListenerAdapter {
            final /* synthetic */ BlurBitmap val$oldBitmap;
    ...
    public static float getRenderNodeScale() {
        ...
        if (devicePerformanceClass == 1) {
            ...
            iM1081dp = AndroidUtilities.m1081dp(15.0f);
        }
        return iM1081dp;
    }
    ...
    public void drawBlurRect(Canvas canvas, float f, Rect rect, Paint paint, boolean z, float f2) {
        drawBlurRect(canvas, f, rect, paint, z, AndroidUtilities.lerp(Function.USE_VARARGS, Color.alpha(Theme.getColor((DRAW_USING_RENDERNODE() && SharedConfig.getDevicePerformanceClass() == 2) ? Theme.key_chat_BlurAlpha : Theme.key_chat_BlurAlphaSlow, getResourceProvider())), f2));
    }
    ...
    public void drawBlurRect(Canvas canvas, float f, Rect rect, Paint paint, boolean z, int i) {
        ...
        float f3;
        int i2 = i;
        if (i2 == 255 && ExteraConfig.forceBlur) {
            i2 = DataTypes.EMPTY;
        }
        int i3 = i2;
        if (!SharedConfig.chatBlurEnabled()) {
        ...
        if (DRAW_USING_RENDERNODE()) {
            ...
            if (i3 >= 255 || !this.blurNodeInvalidated[i4] || this.blurNodeInvalidatedThisFrame[i4]) {
                ...
                if (renderNodeArr[i4] == null) {
                    PipSourceSnapshot$$ExternalSyntheticApiModelOutline0.m1144m();
                    f2 = 255.0f;
                    StringBuilder sb = new StringBuilder();
                    f3 = 1.0f;
                    sb.append("blurNode");
                    sb.append(i4);
                    renderNodeArr[i4] = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1086m(sb.toString());
                ...
                int measuredWidth = getMeasuredWidth();
                int currentActionBarHeight = ActionBar.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight + AndroidUtilities.m1081dp(100.0f);
                this.blurNodes[i4].setPosition(0, 0, (int) (measuredWidth / renderNodeScale), (int) (((iM1081dp * 2) + currentActionBarHeight) / renderNodeScale));
                ...
                recordingCanvasBeginRecording.translate(0.0f, iM1081dp);
                if (!z) {
            ...
            if (renderNode != null && i3 < 255) {
                ...
                canvas.translate(0.0f, -iM1081dp);
    ...
    private static class BlurBitmap {
        ...
        /* synthetic */ BlurBitmap(SizeNotifierFrameLayoutIA sizeNotifierFrameLayoutIA) {
            this();
        }
