...
public class AnimatedAvatarContainer extends FrameLayout {
    ...
    public AnimatedAvatarContainer(Context context) {
        ...
        this.leftPadding = AndroidUtilities.m1081dp(8.0f);
        ...
        this.titleTextView.setTextSize(AndroidUtilities.m1081dp(18.0f));
        this.titleTextView.setGravity(3);
        this.titleTextView.setTypeface(AndroidUtilities.bold());
        this.titleTextView.setPadding(0, AndroidUtilities.m1081dp(6.0f), 0, AndroidUtilities.m1081dp(12.0f));
        ...
        this.subtitleTextView.setTextSize(AndroidUtilities.m1081dp(14.0f));
        this.subtitleTextView.setGravity(3);
        this.subtitleTextView.setPadding(0, 0, AndroidUtilities.m1081dp(10.0f), 0);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int iM1081dp = size - AndroidUtilities.m1081dp(16.0f);
        ...
        this.subtitleTextView.measure(View.MeasureSpec.makeMeasureSpec(iM1081dp, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(20.0f), Integer.MIN_VALUE));
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.subtitleTextView.getVisibility() != 8) {
            this.titleTextView.layout(i5, (AndroidUtilities.m1081dp(1.0f) + currentActionBarHeight) - this.titleTextView.getPaddingTop(), this.titleTextView.getMeasuredWidth() + i5, (((this.titleTextView.getTextHeight() + currentActionBarHeight) + AndroidUtilities.m1081dp(1.3f)) - this.titleTextView.getPaddingTop()) + this.titleTextView.getPaddingBottom());
        } else {
            this.titleTextView.layout(i5, (AndroidUtilities.m1081dp(11.0f) + currentActionBarHeight) - this.titleTextView.getPaddingTop(), this.titleTextView.getMeasuredWidth() + i5, (((this.titleTextView.getTextHeight() + currentActionBarHeight) + AndroidUtilities.m1081dp(11.0f)) - this.titleTextView.getPaddingTop()) + this.titleTextView.getPaddingBottom());
        }
        this.subtitleTextView.layout(i5, AndroidUtilities.m1081dp(20.0f) + currentActionBarHeight, this.subtitleTextView.getMeasuredWidth() + i5, currentActionBarHeight + this.subtitleTextView.getTextHeight() + AndroidUtilities.m1081dp(24.0f));
    }
