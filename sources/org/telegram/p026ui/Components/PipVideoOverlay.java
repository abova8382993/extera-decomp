...
import org.telegram.p026ui.Components.VideoForwardDrawable;
...
public class PipVideoOverlay implements IPipSourceDelegate {
    ...
    private float getRatio() {
        if (this.aspectRatio == null) {
            ...
            Point point = AndroidUtilities.displaySize;
            this.maxScaleFactor = (Math.min(point.x, point.y) - AndroidUtilities.m1081dp(32.0f)) / getSuggestedWidth();
    ...
    class C45241 extends AnimatorListenerAdapter {
        C45241() {
        }
    ...
    class C45262 extends AnimatorListenerAdapter {
        C45262() {
        }
    ...
    private void updatePlayButtonInternal() {
        ...
        if (!zIsPlaying) {
            if (this.isVideoCompleted) {
                this.playPauseButton.setImageResource(C2702R.drawable.pip_replay_large);
                return;
            } else {
                this.playPauseButton.setImageResource(C2702R.drawable.pip_play_large);
                return;
            }
        }
        this.playPauseButton.setImageResource(C2702R.drawable.pip_pause_large);
        AndroidUtilities.runOnUIThread(this.progressRunnable, 500L);
    }
    ...
    public static void setPhotoViewer(PhotoViewer photoViewer) {
        ...
        if (videoPlayer != null && PipUtils.checkPermissions(photoViewer.getParentActivity()) == 1) {
            PipVideoOverlay pipVideoOverlay = instance;
            PipSource.Builder placeholderView = new PipSource.Builder(photoViewer.getParentActivity(), instance).setTagPrefix("photo-viewer-pip-" + videoPlayer.playerId).setPriority(1).setCornerRadius(AndroidUtilities.m1081dp(10.0f)).setContentView(instance.contentView).setPlaceholderView(instance.placeholderView);
    ...
    public static Rect getPipRect(boolean z, float f) {
        ...
        if (!pipVideoOverlay.isVisible || z) {
            ...
            if (pipX != -1.0f) {
                ...
                rect.f2008x = f4 >= ((float) i) / 2.0f ? (i - f3) - AndroidUtilities.m1081dp(16.0f) : AndroidUtilities.m1081dp(16.0f);
            } else {
                rect.f2008x = (AndroidUtilities.displaySize.x - rect.width) - AndroidUtilities.m1081dp(16.0f);
            }
            if (pipY != -1.0f) {
                rect.f2009y = MathUtils.clamp(pipY, AndroidUtilities.m1081dp(16.0f), (AndroidUtilities.displaySize.y - AndroidUtilities.m1081dp(16.0f)) - rect.height) + AndroidUtilities.statusBarHeight;
                return rect;
            }
            rect.f2009y = AndroidUtilities.m1081dp(16.0f) + AndroidUtilities.statusBarHeight;
            return rect;
        }
        rect.f2008x = pipVideoOverlay.pipX;
        rect.f2009y = pipVideoOverlay.pipY + AndroidUtilities.statusBarHeight;
        PipVideoOverlay pipVideoOverlay2 = instance;
    ...
    private boolean showInternal(boolean z, Activity activity, View view, PhotoViewerWebView photoViewerWebView, int i, int i2, boolean z2) {
        ...
        ScaleGestureDetector scaleGestureDetector = new ScaleGestureDetector(context, new ScaleGestureDetectorOnScaleGestureListenerC45273());
        this.scaleGestureDetector = scaleGestureDetector;
        scaleGestureDetector.setQuickScaleEnabled(false);
        this.scaleGestureDetector.setStylusScaleEnabled(false);
        this.gestureDetector = new GestureDetectorFixDoubleTap(context, new C45284(scaledTouchSlop));
        this.contentFrameLayout = new FrameLayout(context) { // from class: org.telegram.ui.Components.PipVideoOverlay.5
            private Path path = new Path();

            C45295(Context context2) {
                super(context2);
                this.path = new Path();
            }
            ...
            protected void onConfigurationChanged(Configuration configuration) {
                ...
                spring.setFinalPosition(suggestedWidth2 >= ((float) i3) / 2.0f ? (i3 - (PipVideoOverlay.this.getSuggestedWidth() * PipVideoOverlay.this.scaleFactor)) - AndroidUtilities.m1081dp(16.0f) : AndroidUtilities.m1081dp(16.0f));
                PipVideoOverlay.this.pipXSpring.start();
                ((SpringAnimation) PipVideoOverlay.this.pipYSpring.setStartValue(PipVideoOverlay.this.pipY)).getSpring().setFinalPosition(MathUtils.clamp(PipVideoOverlay.this.pipY, AndroidUtilities.m1081dp(16.0f), (AndroidUtilities.displaySize.y - (PipVideoOverlay.this.getSuggestedHeight() * PipVideoOverlay.this.scaleFactor)) - AndroidUtilities.m1081dp(16.0f)));
                PipVideoOverlay.this.pipYSpring.start();
            }
        ...
        C45306 c45306 = new PipVideoViewGroup(context2) { // from class: org.telegram.ui.Components.PipVideoOverlay.6
            C45306(Context context2) {
                super(context2);
            }
        ...
        this.contentView = c45306;
        c45306.addView(this.contentFrameLayout, LayoutHelper.createFrame(-1, -1.0f));
        this.contentFrameLayout.setOutlineProvider(new ViewOutlineProvider() { // from class: org.telegram.ui.Components.PipVideoOverlay.7
            ...
            public void getOutline(View view2, Outline outline) {
                outline.setRoundRect(0, 0, view2.getMeasuredWidth(), view2.getMeasuredHeight(), AndroidUtilities.m1081dp(10.0f));
            }
        });
        ...
        this.controlsView = new FrameLayout(context2) { // from class: org.telegram.ui.Components.PipVideoOverlay.9
            C45339(Context context2) {
                super(context2);
            }
        ...
        imageView.setImageResource(C2702R.drawable.pip_video_close);
        ...
        if (pipX != -1.0f) {
            float fM1081dp = pipX + (i5 / 2.0f) >= ((float) AndroidUtilities.displaySize.x) / 2.0f ? (r4 - i5) - AndroidUtilities.m1081dp(16.0f) : AndroidUtilities.m1081dp(16.0f);
            this.pipX = fM1081dp;
            layoutParamsCreateWindowLayoutParams.x = (int) fM1081dp;
        } else {
            float fM1081dp2 = (AndroidUtilities.displaySize.x - i5) - AndroidUtilities.m1081dp(16.0f);
            this.pipX = fM1081dp2;
            layoutParamsCreateWindowLayoutParams.x = (int) fM1081dp2;
        }
        if (pipY != -1.0f) {
            WindowManager.LayoutParams layoutParams = this.windowLayoutParams;
            float fClamp = MathUtils.clamp(pipY, AndroidUtilities.m1081dp(16.0f), (AndroidUtilities.displaySize.y - AndroidUtilities.m1081dp(16.0f)) - this.pipHeight);
            this.pipY = fClamp;
            layoutParams.y = (int) fClamp;
        } else {
            WindowManager.LayoutParams layoutParams2 = this.windowLayoutParams;
            float fM1081dp3 = AndroidUtilities.m1081dp(16.0f);
            this.pipY = fM1081dp3;
            layoutParams2.y = (int) fM1081dp3;
        }
    ...
    class ScaleGestureDetectorOnScaleGestureListenerC45273 implements ScaleGestureDetector.OnScaleGestureListener {
        ScaleGestureDetectorOnScaleGestureListenerC45273() {
        }
        ...
        public boolean onScale(ScaleGestureDetector scaleGestureDetector) {
            ...
            float fM1081dp = scaleGestureDetector.getFocusX() >= ((float) AndroidUtilities.displaySize.x) / 2.0f ? (r1 - PipVideoOverlay.this.pipWidth) - AndroidUtilities.m1081dp(16.0f) : AndroidUtilities.m1081dp(16.0f);
            if (!PipVideoOverlay.this.pipXSpring.isRunning()) {
                ((SpringAnimation) PipVideoOverlay.this.pipXSpring.setStartValue(PipVideoOverlay.this.pipX)).getSpring().setFinalPosition(fM1081dp);
            } else {
                PipVideoOverlay.this.pipXSpring.getSpring().setFinalPosition(fM1081dp);
            }
            PipVideoOverlay.this.pipXSpring.start();
            float fClamp = MathUtils.clamp(scaleGestureDetector.getFocusY() - (PipVideoOverlay.this.pipHeight / 2.0f), AndroidUtilities.m1081dp(16.0f), (AndroidUtilities.displaySize.y - PipVideoOverlay.this.pipHeight) - AndroidUtilities.m1081dp(16.0f));
            if (!PipVideoOverlay.this.pipYSpring.isRunning()) {
            ...
            if (PipVideoOverlay.this.pipXSpring.isRunning() || PipVideoOverlay.this.pipYSpring.isRunning()) {
                ...
                AnonymousClass1 anonymousClass1 = new DynamicAnimation.OnAnimationEndListener() { // from class: org.telegram.ui.Components.PipVideoOverlay.3.1
                    ...
                    public void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z, float f, float f2) {
                        ...
                        if (list.size() == 2) {
                            ScaleGestureDetectorOnScaleGestureListenerC45273.this.updateLayout();
                        }
                    }
                };
                if (!PipVideoOverlay.this.pipXSpring.isRunning()) {
                    arrayList2.add(PipVideoOverlay.this.pipXSpring);
                } else {
                    PipVideoOverlay.this.pipXSpring.addEndListener(anonymousClass1);
                }
                if (!PipVideoOverlay.this.pipYSpring.isRunning()) {
                    arrayList2.add(PipVideoOverlay.this.pipYSpring);
                    return;
                } else {
    ...
    class C45284 extends GestureDetectorFixDoubleTap.OnGestureListener {
        ...
        public boolean onFling(MotionEvent motionEvent, MotionEvent motionEvent2, float f, float f2) {
            ...
            PipVideoOverlay.this.pipXSpring.start();
            ((SpringAnimation) ((SpringAnimation) PipVideoOverlay.this.pipYSpring.setStartVelocity(f)).setStartValue(PipVideoOverlay.this.pipY)).getSpring().setFinalPosition(MathUtils.clamp(PipVideoOverlay.this.pipY + (f2 / 10.0f), AndroidUtilities.m1081dp(16.0f), (AndroidUtilities.displaySize.y - PipVideoOverlay.this.pipHeight) - AndroidUtilities.m1081dp(16.0f)));
            PipVideoOverlay.this.pipYSpring.start();
            return true;
        }
            ...
            if (PipVideoOverlay.this.isScrolling) {
                ...
                if (rawX <= (-PipVideoOverlay.this.pipWidth) * 0.25f || rawX >= AndroidUtilities.displaySize.x - (PipVideoOverlay.this.pipWidth * 0.75f)) {
                    if (!PipVideoOverlay.this.onSideToDismiss) {
                        ...
                        int iM1081dp2 = AndroidUtilities.displaySize.x;
                        if (f4 >= iM1081dp2 / 2.0f) {
                            iM1081dp = AndroidUtilities.m1081dp(16.0f);
                        } else {
                            iM1081dp2 = AndroidUtilities.m1081dp(16.0f);
                            iM1081dp = PipVideoOverlay.this.pipWidth;
                        }
                        spring.setFinalPosition(iM1081dp2 - iM1081dp);
                        PipVideoOverlay.this.pipXSpring.start();
                    }
        ...
        public /* synthetic */ void lambda$onScroll$0(float f, DynamicAnimation dynamicAnimation, boolean z, float f2, float f3) {
            ...
            PipVideoOverlay.this.pipXSpring.getSpring().setFinalPosition(f + (PipVideoOverlay.this.pipWidth / 2.0f) >= ((float) AndroidUtilities.displaySize.x) / 2.0f ? (r3 - PipVideoOverlay.this.pipWidth) - AndroidUtilities.m1081dp(16.0f) : AndroidUtilities.m1081dp(16.0f));
        }
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.PipVideoOverlay$5 */
    class C45295 extends FrameLayout {
        private Path path = new Path();
    ...
    class C45306 extends PipVideoViewGroup {
        C45306(Context context2) {
            super(context2);
        }
    ...
    class C45317 extends ViewOutlineProvider {
        C45317() {
        }
    ...
    class C45328 implements VideoForwardDrawable.VideoForwardDrawableDelegate {
        @Override // org.telegram.ui.Components.VideoForwardDrawable.VideoForwardDrawableDelegate
        public void onAnimationEnd() {
        }
    ...
    class C45339 extends FrameLayout {
        C45339(Context context2) {
            super(context2);
        }
    ...
    private final class VideoProgressView extends View {
        ...
        public VideoProgressView(Context context) {
            ...
            this.progressPaint.setStrokeWidth(AndroidUtilities.m1081dp(2.0f));
            ...
            this.bufferPaint.setStrokeWidth(AndroidUtilities.m1081dp(2.0f));
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (!PipVideoOverlay.this.isWebView || (PipVideoOverlay.this.photoViewerWebView != null && PipVideoOverlay.this.photoViewerWebView.isControllable())) {
                ...
                float f = (width - iM1081dp) - iM1081dp;
                int i = ((int) (PipVideoOverlay.this.videoProgress * f)) + iM1081dp;
                float height = getHeight() - AndroidUtilities.m1081dp(8.0f);
                ...
                canvas2.drawLine(iM1081dp, height, i, height, this.progressPaint);
            }
        }
    }
    ...
    private static final class PipConfig {
        ...
        /* synthetic */ PipConfig(int i, int i2, PipVideoOverlayIA pipVideoOverlayIA) {
            this(i, i2);
        }
    ...
    public View pipCreatePictureInPictureView() {
        ...
        this.pipTextureView.setSurfaceTextureListener(new TextureView.SurfaceTextureListener() { // from class: org.telegram.ui.Components.PipVideoOverlay.10
            ...
            TextureViewSurfaceTextureListenerC452510() {
            }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.PipVideoOverlay$10 */
    class TextureViewSurfaceTextureListenerC452510 implements TextureView.SurfaceTextureListener {
        @Override // android.view.TextureView.SurfaceTextureListener
        public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
        }
