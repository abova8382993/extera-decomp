...
public class SenderSelectView extends View {
    private static final FloatPropertyCompat MENU_PROGRESS = new SimpleFloatPropertyCompat("menuProgress", new SimpleFloatPropertyCompat.Getter() { // from class: org.telegram.ui.Components.SenderSelectView$$ExternalSyntheticLambda0
        ...
        public final void set(Object obj, float f) {
            SenderSelectView.m11521$r8$lambda$K0kIe8gi8ce3Pl7QoAyAgwuavA((SenderSelectView) obj, f);
        }
    ...
    public static /* synthetic */ void m11521$r8$lambda$K0kIe8gi8ce3Pl7QoAyAgwuavA(SenderSelectView senderSelectView, float f) {
    ...
    public SenderSelectView(Context context) {
        ...
        this.menuPaint.setStrokeWidth(AndroidUtilities.m1081dp(2.0f));
        this.menuPaint.setStrokeCap(Paint.Cap.ROUND);
        this.menuPaint.setStyle(Paint.Style.STROKE);
        updateColors();
        setContentDescription(LocaleController.formatString("AccDescrSendAsPeer", C2702R.string.AccDescrSendAsPeer, _UrlKt.FRAGMENT_ENCODE_SET));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float strokeWidth = this.menuPaint.getStrokeWidth() + AndroidUtilities.m1081dp(9.0f);
    ...
    public void setAvatar(TLObject tLObject) {
        ...
        setContentDescription(LocaleController.formatString("AccDescrSendAsPeer", C2702R.string.AccDescrSendAsPeer, firstName));
