...
public class RLottieImageView extends ImageView {
    ...
    public void setAnimation(int i, int i2, int i3, int[] iArr) {
        setAnimation(new RLottieDrawable(i, _UrlKt.FRAGMENT_ENCODE_SET + i, AndroidUtilities.m1081dp(i2), AndroidUtilities.m1081dp(i3), false, iArr));
    }
    ...
    public void setAnimation(TLRPC.Document document, int i, int i2) {
        ...
        C46781 c46781 = new ImageReceiver() { // from class: org.telegram.ui.Components.RLottieImageView.1
            C46781() {
            }
        ...
        this.imageReceiver = c46781;
        c46781.setAllowLoadingOnAttachedOnly(true);
        ...
        setImageDrawable(new Drawable() { // from class: org.telegram.ui.Components.RLottieImageView.2
            ...
            public void draw(Canvas canvas) {
                ...
                rect.set(getBounds().centerX() - (AndroidUtilities.m1081dp(i) / 2), getBounds().centerY() - (AndroidUtilities.m1081dp(i) / 2), getBounds().centerX() + (AndroidUtilities.m1081dp(i) / 2), getBounds().centerY() + (AndroidUtilities.m1081dp(i) / 2));
    ...
    class C46781 extends ImageReceiver {
        C46781() {
        }
