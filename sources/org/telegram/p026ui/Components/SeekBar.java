...
public class SeekBar {
    ...
    private int lineHeight = AndroidUtilities.m1081dp(2.0f);
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.currentRadius != fM1081dp) {
            ...
            if (f3 < fM1081dp) {
                float fM1081dp2 = f3 + (AndroidUtilities.m1081dp(1.0f) * (jElapsedRealtime / 60.0f));
                this.currentRadius = fM1081dp2;
                if (fM1081dp2 > fM1081dp) {
                    this.currentRadius = fM1081dp;
                }
            } else {
                float fM1081dp3 = f3 - (AndroidUtilities.m1081dp(1.0f) * (jElapsedRealtime / 60.0f));
    ...
    */
    private void drawProgressBar(android.graphics.Canvas r26, android.graphics.RectF r27, android.graphics.Paint r28) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.SeekBar.drawProgressBar(android.graphics.Canvas, android.graphics.RectF, android.graphics.Paint):void");
    }
    ...
    private void updateTimestampAnimation() {
        ...
        int i = thumbWidth;
        this.lastWidth = Math.abs((i / 2.0f) - (this.width - (i / 2.0f))) - AndroidUtilities.m1081dp(66.0f);
