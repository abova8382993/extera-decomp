...
import org.telegram.p026ui.Stories.StoriesGradientTools;
...
public class AvatarsDrawable {
    ...
    public int strokeWidth = AndroidUtilities.m1081dp(1.67f);
    ...
    public void commitTransition(boolean z, boolean z2) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if (drawingStateArr2[i].f1877id != this.animatingStates[i].f1877id) {
                z3 = true;
            } else {
        ...
        for (int i2 = 0; i2 < 3; i2++) {
            ...
            while (true) {
                ...
                if (this.currentStates[i3].f1877id == this.animatingStates[i2].f1877id) {
    ...
    class C37221 extends AnimatorListenerAdapter {
        C37221() {
        }
    ...
    public AvatarsDrawable(View view, boolean z) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            this.currentStates[i].avatarDrawable.setTextSize(AndroidUtilities.m1081dp(16.0f));
            ...
            this.animatingStates[i].avatarDrawable.setTextSize(AndroidUtilities.m1081dp(16.0f));
        }
        this.isInCall = z;
    ...
    public void setObject(int i, int i2, TLObject tLObject) {
        TLRPC.User user;
        TLRPC.Chat chat;
        this.animatingStates[i].f1877id = 0L;
        ...
        if (tLObject instanceof TLRPC.GroupCallParticipant) {
            ...
            this.animatingStates[i].f1877id = peerId;
            ...
            this.animatingStates[i].f1877id = user.f1775id;
            chat = null;
            ...
            this.animatingStates[i].f1877id = -chat.f1610id;
            user = null;
        } else {
            user = null;
            chat = null;
        ...
        if (tLObject instanceof TL_stories.StoryItem) {
            ...
            this.animatingStates[i].f1877id = storyItem.f1807id;
    ...
    public float getUsedWidth() {
        ...
        if (i == 11) {
            ...
            if (i2 != 0) {
                iM1081dp = (int) (i2 * this.overrideSizeStepFactor);
            } else {
                iM1081dp = AndroidUtilities.m1081dp(z ? 24.0f : 20.0f);
            }
        }
        int i3 = 0;
        for (int i4 = 0; i4 < 3; i4++) {
            if (this.currentStates[i4].f1877id != 0) {
                i3++;
            }
        }
        return (Math.max(0, i3 - 1) * iM1081dp) + (i3 > 0 ? getSize() : 0);
    }

    /* JADX WARN: Removed duplicated region for block: B:2197:0x0271  */
    /* JADX WARN: Removed duplicated region for block: B:2200:0x02a7  */
    /* JADX WARN: Removed duplicated region for block: B:2210:0x02cc  */
    /* JADX WARN: Removed duplicated region for block: B:2251:0x035c  */
    /* JADX WARN: Removed duplicated region for block: B:2269:0x03d8  */
    /* JADX WARN: Removed duplicated region for block: B:2282:0x0417  */
    /* JADX WARN: Removed duplicated region for block: B:2286:0x0428  */
    /* JADX WARN: Removed duplicated region for block: B:2336:0x06b5  */
    /* JADX WARN: Removed duplicated region for block: B:2342:0x06e6  */
    /* JADX WARN: Removed duplicated region for block: B:2348:0x0725  */
    /* JADX WARN: Removed duplicated region for block: B:2356:0x0759  */
    /* JADX WARN: Removed duplicated region for block: B:2360:0x0780  */
    /* JADX WARN: Removed duplicated region for block: B:2361:0x0795  */
    /* JADX WARN: Removed duplicated region for block: B:2364:0x07ae  */
    /* JADX WARN: Removed duplicated region for block: B:2377:0x02aa A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:2385:0x07b1 A[SYNTHETIC] */
    /*
    ...
    */
    public void onDraw(android.graphics.Canvas r40) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.AvatarsDrawable.onDraw(android.graphics.Canvas):void");
    }
    ...
    public int getSize() {
        ...
        return AndroidUtilities.m1081dp((i2 == 4 || i2 == 10) ? 32.0f : 24.0f);
    }
