...
public class AnimatedEmojiEffect {
    ...
    public void setView(View view) {
        ...
        if (z) {
            ...
            this.effectImageReceiver.setImageBitmap(new RLottieDrawable(C2702R.raw.custom_emoji_reaction, _UrlKt.FRAGMENT_ENCODE_SET + C2702R.raw.custom_emoji_reaction, AndroidUtilities.m1081dp(60.0f), AndroidUtilities.m1081dp(60.0f), false, null));
        }
    }
