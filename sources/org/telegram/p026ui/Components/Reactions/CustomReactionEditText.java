...
public abstract class CustomReactionEditText extends EditTextCaption {
    ...
    public CustomReactionEditText(Context context, Theme.ResourcesProvider resourcesProvider, int i) {
        ...
        setTextSize(1, 22.0f);
        setGravity(80);
        setPadding(AndroidUtilities.m1081dp(18.0f), AndroidUtilities.m1081dp(4.0f), AndroidUtilities.m1081dp(18.0f), AndroidUtilities.m1081dp(12.0f));
    ...
    protected void extendActionMode(ActionMode actionMode, Menu menu) {
        menu.clear();
        int i = C2702R.id.menu_delete;
        menu.add(i, i, 0, LocaleController.getString(C2702R.string.Delete));
    }
