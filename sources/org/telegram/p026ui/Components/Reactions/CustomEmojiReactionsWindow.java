...
import org.telegram.p026ui.Components.StableAnimator;
...
public class CustomEmojiReactionsWindow {
    ...
    public CustomEmojiReactionsWindow(int i, BaseFragment baseFragment, List list, HashSet hashSet, final ReactionsContainerLayout reactionsContainerLayout, Theme.ResourcesProvider resourcesProvider, boolean z) {
        ...
        C47032 c47032 = new C47032(baseFragment, context, false, null, reactionsContainerLayout.getWindowType(), i != 1, resourcesProvider, 16, reactionsContainerLayout, baseFragment);
        this.selectAnimatedEmojiDialog = c47032;
        c47032.setOutlineProvider(new ViewOutlineProvider() { // from class: org.telegram.ui.Components.Reactions.CustomEmojiReactionsWindow.3
            ...
            public void getOutline(View view, Outline outline) {
                float fLerp = AndroidUtilities.lerp(CustomEmojiReactionsWindow.this.fromRadius, AndroidUtilities.m1081dp(8.0f), CustomEmojiReactionsWindow.this.enterTransitionProgress);
    ...
    class C47032 extends SelectAnimatedEmojiDialog {
        ...
        C47032(BaseFragment baseFragment, Context context, boolean z, Integer num, int i, boolean z2, Theme.ResourcesProvider resourcesProvider, int i2, ReactionsContainerLayout reactionsContainerLayout, BaseFragment baseFragment2) {
        ...
        protected void onEmojiSelected(View view, Long l, TLRPC.Document document, TL_stars.TL_starGiftUnique tL_starGiftUnique, Integer num) {
            if (this.val$baseFragment != null) {
                ...
                if (!reactionsContainerLayout.channelReactions && reactionsContainerLayout.getWindowType() != 13 && !UserConfig.getInstance(this.val$baseFragment.getCurrentAccount()).isPremium()) {
                    ...
                    BulletinFactory.m1194of(CustomEmojiReactionsWindow.this.windowView, null).createEmojiBulletin(document, AndroidUtilities.replaceTags(LocaleController.getString(C2702R.string.UnlockPremiumEmojiReaction)), LocaleController.getString(C2702R.string.PremiumMore), new Runnable() { // from class: org.telegram.ui.Components.Reactions.CustomEmojiReactionsWindow$2$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
            ...
            this.val$reactionsContainerLayout.onReactionClicked(view, ReactionsLayoutInBubble.VisibleReaction.fromCustomEmoji(Long.valueOf(l == null ? document.f1618id : l.longValue())), false);
            AndroidUtilities.hideKeyboard(CustomEmojiReactionsWindow.this.windowView);
        }
    ...
    public void updateWindowPosition() {
        ...
        int i = this.type;
        if (i == 1 || i == 2) {
            iM1081dp = AndroidUtilities.m1081dp(24.0f);
        }
        float f = iM1081dp;
    ...
    private void createTransition(final boolean z) {
        ...
        float fM1081dp = ((((this.location[1] - iArr[1]) - AndroidUtilities.m1081dp(44.0f)) - AndroidUtilities.m1081dp(52.0f)) - (this.selectAnimatedEmojiDialog.includeHint ? AndroidUtilities.m1081dp(26.0f) : 0)) + this.reactionsContainerLayout.getTopOffset();
        if (this.reactionsContainerLayout.showExpandableReactions()) {
            fM1081dp = (this.location[1] - iArr[1]) - AndroidUtilities.m1081dp(12.0f);
        }
        if (this.containerView.getMeasuredHeight() + fM1081dp > this.windowView.getMeasuredHeight() - AndroidUtilities.m1081dp(32.0f)) {
            fM1081dp = (this.windowView.getMeasuredHeight() - AndroidUtilities.m1081dp(32.0f)) - this.containerView.getMeasuredHeight();
        }
        if (fM1081dp < AndroidUtilities.m1081dp(16.0f)) {
            fM1081dp = AndroidUtilities.m1081dp(16.0f);
        }
        if (this.type == 5) {
            fM1081dp = Math.min(fM1081dp, 0.0f);
        }
        int i = this.type;
        if (i == 1) {
            this.containerView.setTranslationX(((this.windowView.getMeasuredWidth() - this.containerView.getMeasuredWidth()) / 2.0f) - AndroidUtilities.m1081dp(16.0f));
        } else if (i == 2 || i == 4) {
            this.containerView.setTranslationX((this.location[0] - iArr[0]) - AndroidUtilities.m1081dp(18.0f));
        } else {
            this.containerView.setTranslationX((this.location[0] - iArr[0]) - AndroidUtilities.m1081dp(2.0f));
        }
        if (!z) {
            this.yTranslation = this.containerView.getTranslationY();
        } else {
            this.yTranslation = fM1081dp;
            this.containerView.setTranslationY(fM1081dp);
        }
    ...
    public class ContainerView extends FrameLayout {
        ...
        */
        protected void onMeasure(int r9, int r10) {
            /*
                r8 = this;
                org.telegram.ui.Components.Reactions.CustomEmojiReactionsWindow r0 = org.telegram.p026ui.Components.Reactions.CustomEmojiReactionsWindow.this
                int r0 = org.telegram.p026ui.Components.Reactions.CustomEmojiReactionsWindow.m11243$$Nest$fgettype(r0)
                r1 = 1
                r2 = 5
                r3 = 4
                r4 = 8
            ...
            L21:
                ...
                if (r0 != r2) goto L36
                int r9 = org.telegram.messenger.AndroidUtilities.m1081dp(r5)
                int r9 = r9 * r4
                int r10 = org.telegram.messenger.AndroidUtilities.m1081dp(r1)
                int r9 = r9 + r10
                goto L58
            L36:
                ...
                int r10 = org.telegram.messenger.AndroidUtilities.m1081dp(r5)
                int r10 = r10 * r4
                int r0 = org.telegram.messenger.AndroidUtilities.m1081dp(r1)
                int r10 = r10 + r0
                if (r10 >= r9) goto L58
                r9 = r10
                goto L58
            L50:
                org.telegram.ui.Components.Reactions.CustomEmojiReactionsWindow r9 = org.telegram.p026ui.Components.Reactions.CustomEmojiReactionsWindow.this
                org.telegram.ui.Components.ReactionsContainerLayout r9 = r9.reactionsContainerLayout
                int r9 = r9.getMeasuredWidth()
            L58:
                org.telegram.ui.Components.Reactions.CustomEmojiReactionsWindow r10 = org.telegram.p026ui.Components.Reactions.CustomEmojiReactionsWindow.this
                int r10 = org.telegram.p026ui.Components.Reactions.CustomEmojiReactionsWindow.m11243$$Nest$fgettype(r10)
            ...
            L6d:
                ...
                int r10 = (int) r6
                if (r10 > r4) goto L94
                int r1 = org.telegram.messenger.AndroidUtilities.m1081dp(r5)
                int r10 = r10 * r1
                int r0 = org.telegram.messenger.AndroidUtilities.m1081dp(r0)
                int r10 = r10 + r0
                goto L9f
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            if (customEmojiReactionsWindow.isShowing) {
                ...
                float fLerp2 = AndroidUtilities.lerp(customEmojiReactionsWindow5.fromRadius, AndroidUtilities.m1081dp(customEmojiReactionsWindow5.type == 5 ? 20.0f : 8.0f), CustomEmojiReactionsWindow.this.enterTransitionProgress);
                ...
                if (customEmojiReactionsWindow10.reactionsContainerLayout != null) {
                    ...
                    if (CustomEmojiReactionsWindow.this.type != 5) {
                        canvas2.clipRect(y, i7 != 0 ? x + (AndroidUtilities.m1081dp(36.0f) * CustomEmojiReactionsWindow.this.enterTransitionProgress) : 0.0f, y + CustomEmojiReactionsWindow.this.selectAnimatedEmojiDialog.emojiGridView.getMeasuredWidth(), x + CustomEmojiReactionsWindow.this.selectAnimatedEmojiDialog.emojiGridView.getMeasuredHeight());
                    }
                    int i8 = -1;
                    int i9 = -1;
                        ...
                        if (childAt.getLeft() < 0 || childAt.getVisibility() == 8) {
                            ...
                            if (childAt instanceof ReactionsContainerLayout.ReactionHolderView) {
                                ...
                                if (imageViewEmoji2 != null) {
                                    ...
                                    float f15 = x2;
                                    float x3 = (((imageViewEmoji2.getX() + CustomEmojiReactionsWindow.this.selectAnimatedEmojiDialog.getX()) + CustomEmojiReactionsWindow.this.selectAnimatedEmojiDialog.emojiGridView.getX()) - reactionHolderView.loopImageView.getX()) - AndroidUtilities.m1081dp(f13);
                                    ...
                                    if (imageViewEmoji2.selected || CustomEmojiReactionsWindow.this.type == i5) {
                                        if (CustomEmojiReactionsWindow.this.type == i5) {
                                            ...
                                            x3 -= AndroidUtilities.m1081dp(0.33f);
                                            y3 -= AndroidUtilities.m1081dp(1.33f);
                                        } else {
                                            f9 = measuredWidth;
                                        }
                                    ...
                                    if (reactionHolderView.position == 0) {
                                        fM1081dp = AndroidUtilities.m1081dp(6.0f);
                                        f11 = fM1081dp;
                                        f10 = f18;
                                        f12 = f10;
                                    } else {
                                        fM1081dp = reactionHolderView.selected ? AndroidUtilities.m1081dp(6.0f) : f18;
                                        f10 = fM1081dp;
                                        f11 = f10;
                                        f12 = f11;
                                    }
                                ...
                                if (imageViewEmoji2 != null) {
                                    if (imageViewEmoji2.selected) {
                                        ...
                                        float measuredWidth4 = reactionHolderView.getMeasuredWidth() - AndroidUtilities.m1081dp(f5);
                                        float fLerp5 = AndroidUtilities.lerp(measuredWidth4, (imageViewEmoji2.getMeasuredWidth() - AndroidUtilities.m1081dp(f5)) / fLerp, CustomEmojiReactionsWindow.this.enterTransitionProgress);
                                        RectF rectF7 = AndroidUtilities.rectTmp;
                                        float f20 = fLerp5 / f5;
                                        i3 = i9;
                                        rectF7.set(measuredWidth3 - f20, measuredHeight - f20, measuredWidth3 + f20, measuredHeight + f20);
                                        float fLerp6 = AndroidUtilities.lerp(measuredWidth4 / f5, AndroidUtilities.m1081dp(4.0f), CustomEmojiReactionsWindow.this.enterTransitionProgress);
                                    ...
                                    if (f7 != 0.0f) {
                                        ...
                                        f4 = 0.0f;
                                        imageReceiver.setRoundRadius((int) AndroidUtilities.lerp(fM1081dp, 0.0f, CustomEmojiReactionsWindow.this.enterTransitionProgress), (int) AndroidUtilities.lerp(f6, 0.0f, CustomEmojiReactionsWindow.this.enterTransitionProgress), (int) AndroidUtilities.lerp(f8, 0.0f, CustomEmojiReactionsWindow.this.enterTransitionProgress), (int) AndroidUtilities.lerp(f7, 0.0f, CustomEmojiReactionsWindow.this.enterTransitionProgress));
