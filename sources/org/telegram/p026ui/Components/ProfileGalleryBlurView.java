...
import org.telegram.p026ui.Components.ProfileMetaballView;
...
public class ProfileGalleryBlurView extends View {
    ...
    class C46571 implements ViewPager.OnPageChangeListener {
    ...
    public void setSize(int i) {
        ...
        this.actionSize = i;
        this.size = (int) (AndroidUtilities.m1081dp(64.0f) * 1.5f);
    }
    ...
    private void initRenderNode() {
        if (this.blurNode == null) {
            ...
            this.blurNode = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1086m("profileBlurNode");
    ...
    private void initActionsRenderNode() {
        ...
        if (this.actionsBlurNode == null) {
            this.actionsBlurNode = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1086m("profileActionsBlurNode");
    ...
    private void captureActionsBlurRenderNode(float f, ProfileActivity.AvatarImageView avatarImageView, float f2, float f3) {
        ...
        if (profileMusicView2 != null) {
            if (avatarImageView != null) {
                profileMusicView2.drawingBlur(this.actionsBlurNode, avatarImageView, renderNodeScale / f2, (-f3) + AndroidUtilities.m1081dp(22.0f));
            } else {
                profileMusicView2.drawingBlur(this.actionsBlurNode, null, renderNodeScale, (-f3) + AndroidUtilities.m1081dp(22.0f));
            }
        }
    }
    ...
    private float getRenderNodeScale() {
        return AndroidUtilities.m1081dp(1.0f);
    }
