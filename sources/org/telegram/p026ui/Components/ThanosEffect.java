...
public class ThanosEffect extends TextureView {
    ...
    class ChoreographerFrameCallbackC50131 implements Choreographer.FrameCallback {
        ChoreographerFrameCallbackC50131() {
        }
    ...
    public ThanosEffect(Context context, Runnable runnable) {
        ...
        setOpaque(false);
        setSurfaceTextureListener(new TextureViewSurfaceTextureListenerC50142());
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.ThanosEffect$2 */
    /* JADX INFO: loaded from: classes5.dex */
    class TextureViewSurfaceTextureListenerC50142 implements TextureView.SurfaceTextureListener {
        @Override // android.view.TextureView.SurfaceTextureListener
        public void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
        }

        TextureViewSurfaceTextureListenerC50142() {
        }
    ...
    static class DrawingThread extends DispatchQueue {
        ...
        public void kill() {
            if (!this.alive.get()) {
                FileLog.m1090d("ThanosEffect: kill failed, already dead");
                return;
            }
            FileLog.m1090d("ThanosEffect: kill");
            try {
                Handler handler = getHandler();
                if (handler != null) {
        ...
        private void killInternal() {
            if (!this.alive.get()) {
                FileLog.m1090d("ThanosEffect: killInternal failed, already dead");
                return;
            }
            FileLog.m1090d("ThanosEffect: killInternal");
        ...
        private void init() {
            ...
            if (eGLDisplayEglGetDisplay == EGL10.EGL_NO_DISPLAY) {
                FileLog.m1091e("ThanosEffect: eglDisplay == egl.EGL_NO_DISPLAY");
                killInternal();
                return;
            }
            if (!egl102.eglInitialize(eGLDisplayEglGetDisplay, new int[2])) {
                FileLog.m1091e("ThanosEffect: failed eglInitialize");
                killInternal();
                return;
            }
            ...
            if (!this.egl.eglChooseConfig(this.eglDisplay, new int[]{12324, 8, 12323, 8, 12322, 8, 12321, 8, 12352, 64, 12344}, eGLConfigArr, 1, new int[1])) {
                FileLog.m1091e("ThanosEffect: failed eglChooseConfig");
                kill();
                return;
            }
            ...
            if (eGLContextEglCreateContext == null) {
                FileLog.m1091e("ThanosEffect: eglContext == null");
                killInternal();
                return;
            }
            ...
            if (eGLSurfaceEglCreateWindowSurface == null) {
                FileLog.m1091e("ThanosEffect: eglSurface == null");
                killInternal();
                return;
            }
            if (!this.egl.eglMakeCurrent(this.eglDisplay, eGLSurfaceEglCreateWindowSurface, eGLSurfaceEglCreateWindowSurface, this.eglContext)) {
                FileLog.m1091e("ThanosEffect: failed eglMakeCurrent");
                killInternal();
                return;
            }
            ...
            if (iGlCreateShader == 0 || iGlCreateShader2 == 0) {
                FileLog.m1091e("ThanosEffect: vertexShader == 0 || fragmentShader == 0");
                killInternal();
                return;
            }
            GLES20.glShaderSource(iGlCreateShader, AndroidUtilities.readRes(C2702R.raw.thanos_vertex) + "\n// " + Math.random());
            GLES20.glCompileShader(iGlCreateShader);
            int[] iArr = new int[1];
            GLES20.glGetShaderiv(iGlCreateShader, 35713, iArr, 0);
            if (iArr[0] != 1) {
                FileLog.m1091e("ThanosEffect, compile vertex shader error: " + GLES20.glGetShaderInfoLog(iGlCreateShader));
                GLES20.glDeleteShader(iGlCreateShader);
                killInternal();
                return;
            }
            GLES20.glShaderSource(iGlCreateShader2, AndroidUtilities.readRes(C2702R.raw.thanos_fragment) + "\n// " + Math.random());
            GLES20.glCompileShader(iGlCreateShader2);
            GLES20.glGetShaderiv(iGlCreateShader2, 35713, iArr, 0);
            if (iArr[0] != 1) {
                FileLog.m1091e("ThanosEffect, compile fragment shader error: " + GLES20.glGetShaderInfoLog(iGlCreateShader2));
            ...
            if (iGlCreateProgram == 0) {
                FileLog.m1091e("ThanosEffect: drawProgram == 0");
                killInternal();
                return;
            }
            ...
            if (iArr[0] != 1) {
                FileLog.m1091e("ThanosEffect, link program error: " + GLES20.glGetProgramInfoLog(this.drawProgram));
                killInternal();
                return;
            }
            ...
            if (this.alive.get()) {
                ...
                try {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.ThanosEffect$DrawingThread$$ExternalSyntheticLambda2
                        @Override // java.lang.Runnable
                        public final void run() {
                            ThanosEffect.DrawingThread.m12077$r8$lambda$33gwjZyvrViSWSsm3D1G3vECaY();
                        }
                    });
                    killInternal();
                }
        ...
        public static /* synthetic */ void m12077$r8$lambda$33gwjZyvrViSWSsm3D1G3vECaY() {
            SharedPreferences.Editor editorEdit = MessagesController.getGlobalMainSettings().edit();
            ThanosEffect.nothanos = Boolean.TRUE;
            editorEdit.putBoolean("nothanos", true).apply();
        }
        ...
        public void animate(Matrix matrix, Bitmap bitmap, final Runnable runnable, final Runnable runnable2) {
            if (!this.alive.get()) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.ThanosEffect$DrawingThread$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
                        ThanosEffect.DrawingThread.m12078$r8$lambda$LZe6jOiLycQhtpeORUpDh17wQ(runnable, runnable2);
                    }
                });
                ThanosEffect.ensureRunOnUIThread(this.destroy);
                this.destroy = null;
        ...
        public static /* synthetic */ void m12078$r8$lambda$LZe6jOiLycQhtpeORUpDh17wQ(Runnable runnable, Runnable runnable2) {
            ThanosEffect.ensureRunOnUIThread(runnable);
            if (runnable2 != null) {
                AndroidUtilities.runOnUIThread(runnable2);
            }
        ...
        class Animation {
            ...
            /* JADX WARN: Removed duplicated region for block: B:377:0x022f  */
            ...
            */
            ...
            public static /* synthetic */ void m12099$r8$lambda$ffAyKhZFHxyOgaQ4fNT2BZuSYc(ArrayList arrayList) {
                for (int i = 0; i < arrayList.size(); i++) {
                    ((View) arrayList.get(i)).setVisibility(8);
        ...
        private void checkGlErrors() {
            while (true) {
                ...
                FileLog.m1091e("thanos gles error " + iGlGetError);
            }
        }
    }
}
