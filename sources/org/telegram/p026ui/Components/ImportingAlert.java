...
public class ImportingAlert extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static class BottomSheetCell extends FrameLayout {
        ...
        public BottomSheetCell(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            view.setBackground(Theme.createSimpleSelectorRoundRectDrawable(iM1081dp, getThemedColor(i), getThemedColor(Theme.key_featuredStickers_addButtonPressed)));
            ...
            rLottieImageView.setBackground(Theme.createCircleDrawable(iM1081dp2, getThemedColor(i2)));
            this.imageView.setScaleType(ImageView.ScaleType.CENTER);
            this.imageView.setColorFilter(new PorterDuffColorFilter(getThemedColor(i), PorterDuff.Mode.MULTIPLY));
            this.imageView.setAnimation(C2702R.raw.import_check, 26, 26);
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(80.0f), TLObject.FLAG_30));
        }
    ...
    public ImportingAlert(Context context, String str, ChatActivity chatActivity, Theme.ResourcesProvider resourcesProvider) {
        ...
        RLottieDrawable rLottieDrawable = new RLottieDrawable(C2702R.raw.import_finish, _UrlKt.FRAGMENT_ENCODE_SET + C2702R.raw.import_finish, AndroidUtilities.m1081dp(120.0f), AndroidUtilities.m1081dp(120.0f), false, null);
        this.completedDrawable = rLottieDrawable;
        rLottieDrawable.setAllowDecodeSingleFrame(true);
        RLottieImageView rLottieImageView = new RLottieImageView(context);
        this.imageView = rLottieImageView;
        rLottieImageView.setAutoRepeat(true);
        this.imageView.setAnimation(C2702R.raw.import_loop, Opcodes.ISHL, Opcodes.ISHL);
        this.imageView.playAnimation();
        ...
        this.cell.setText(LocaleController.getString(C2702R.string.ImportDone));
        ...
        this.cell.background.setPivotY(AndroidUtilities.m1081dp(48.0f));
        ...
        for (int i2 = 0; i2 < 2; i2++) {
            ...
            if (i2 == 0) {
                this.infoTextView[i2].setText(LocaleController.getString(C2702R.string.ImportImportingInfo));
            } else {
                this.infoTextView[i2].setAlpha(0.0f);
                this.infoTextView[i2].setTranslationY(AndroidUtilities.m1081dp(10.0f));
                this.importCountTextView[i2].setAlpha(0.0f);
                this.importCountTextView[i2].setTranslationY(AndroidUtilities.m1081dp(10.0f));
            }
        }
        if (this.parentFragment != null) {
            textView.setText(LocaleController.getString(C2702R.string.ImportImportingTitle));
            ...
            this.importCountTextView[0].setText(LocaleController.formatString("ImportCount", C2702R.string.ImportCount, AndroidUtilities.formatFileSize(importingHistory.getUploadedCount()), AndroidUtilities.formatFileSize(importingHistory.getTotalCount())));
            this.infoTextView[1].setText(LocaleController.getString(C2702R.string.ImportDoneInfo));
            this.importCountTextView[1].setText(LocaleController.getString(C2702R.string.ImportDoneTitle));
            this.parentFragment.getNotificationCenter().addObserver(this, NotificationCenter.historyImportProgressChanged);
            return;
        }
        textView.setText(LocaleController.getString(C2702R.string.ImportStickersImportingTitle));
        ...
        this.importCountTextView[0].setText(LocaleController.formatString("ImportCount", C2702R.string.ImportCount, AndroidUtilities.formatFileSize(importingStickers.getUploadedCount()), AndroidUtilities.formatFileSize(importingStickers.getTotalCount())));
        this.infoTextView[1].setText(LocaleController.getString(C2702R.string.ImportStickersDoneInfo));
        this.importCountTextView[1].setText(LocaleController.getString(C2702R.string.ImportStickersDoneTitle));
    ...
    public void setCompleted() {
        ...
        animatorSet.playTogether(objectAnimatorOfFloat, ObjectAnimator.ofFloat(textView2, (Property<TextView, Float>) property2, -AndroidUtilities.m1081dp(10.0f)), ObjectAnimator.ofFloat(this.infoTextView[0], (Property<TextView, Float>) property, 0.0f), ObjectAnimator.ofFloat(this.infoTextView[0], (Property<TextView, Float>) property2, -AndroidUtilities.m1081dp(10.0f)), ObjectAnimator.ofFloat(this.importCountTextView[0], (Property<TextView, Float>) property, 0.0f), ObjectAnimator.ofFloat(this.importCountTextView[0], (Property<TextView, Float>) property2, -AndroidUtilities.m1081dp(10.0f)), ObjectAnimator.ofFloat(this.infoTextView[1], (Property<TextView, Float>) property, 1.0f), ObjectAnimator.ofFloat(this.infoTextView[1], (Property<TextView, Float>) property2, 0.0f), ObjectAnimator.ofFloat(this.importCountTextView[1], (Property<TextView, Float>) property, 1.0f), ObjectAnimator.ofFloat(this.importCountTextView[1], (Property<TextView, Float>) property2, 0.0f), ObjectAnimator.ofFloat(this.lineProgressView, (Property<LineProgressView, Float>) property, 0.0f), ObjectAnimator.ofFloat(this.cell.linearLayout, (Property<LinearLayout, Float>) property2, AndroidUtilities.m1081dp(8.0f), 0.0f));
