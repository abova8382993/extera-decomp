...
public class PipRoundVideoView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void show(Activity activity, Runnable runnable) {
        ...
        C45181 c45181 = new PipFrameLayout(activity) { // from class: org.telegram.ui.Components.PipRoundVideoView.1
            private boolean dragging;
            private boolean startDragging;
            private float startX;
            private float startY;

            C45181(Context activity2) {
                super(activity2);
            }
            ...
            protected void onDraw(Canvas canvas) {
                ...
                if (drawable != null) {
                    ...
                    Theme.chat_roundVideoShadow.setBounds(AndroidUtilities.m1081dp(1.0f), AndroidUtilities.m1081dp(2.0f), AndroidUtilities.m1081dp(125.0f), AndroidUtilities.m1081dp(125.0f));
                    ...
                    canvas.drawCircle(AndroidUtilities.m1081dp(63.0f), AndroidUtilities.m1081dp(63.0f), AndroidUtilities.m1081dp(59.5f), Theme.chat_docBackPaint);
                }
            }
        };
        this.windowView = c45181;
        c45181.setWillNotDraw(false);
        this.videoWidth = AndroidUtilities.m1081dp(126.0f);
        this.videoHeight = AndroidUtilities.m1081dp(126.0f);
        C45192 c45192 = new AspectRatioFrameLayout(activity2) { // from class: org.telegram.ui.Components.PipRoundVideoView.2
            C45192(Context activity2) {
                super(activity2);
            }
        ...
        this.aspectRatioFrameLayout = c45192;
        c45192.setOutlineProvider(new ViewOutlineProvider() { // from class: org.telegram.ui.Components.PipRoundVideoView.3
            C45203() {
            }

            @Override // android.view.ViewOutlineProvider
            public void getOutline(View view, Outline outline) {
                outline.setOval(0, 0, AndroidUtilities.m1081dp(120.0f), AndroidUtilities.m1081dp(120.0f));
            }
        });
        this.aspectRatioFrameLayout.setClipToOutline(true);
        this.aspectRatioFrameLayout.setAspectRatio(1.0f, 0);
        this.windowView.addView(this.aspectRatioFrameLayout, LayoutHelper.createFrame(Opcodes.ISHL, 120.0f, 51, 3.0f, 3.0f, 0.0f, 0.0f));
    ...
    /* JADX INFO: loaded from: classes5.dex */
    class C45181 extends PipFrameLayout {
        private boolean dragging;
        private boolean startDragging;
        private float startX;
        private float startY;
    ...
    /* JADX INFO: loaded from: classes5.dex */
    class C45192 extends AspectRatioFrameLayout {
        C45192(Context activity2) {
            super(activity2);
        }
    ...
    /* JADX INFO: loaded from: classes5.dex */
    class C45203 extends ViewOutlineProvider {
        C45203() {
        }
    ...
    /* JADX INFO: loaded from: classes5.dex */
    class C45214 extends AnimatorListenerAdapter {
        C45214() {
        }
    ...
    /* JADX INFO: loaded from: classes5.dex */
    class C45225 extends AnimatorListenerAdapter {
        final /* synthetic */ boolean val$show;
    ...
    */
    public void animateToBoundsMaybe() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.PipRoundVideoView.animateToBoundsMaybe():void");
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.PipRoundVideoView$6 */
    /* JADX INFO: loaded from: classes5.dex */
    class C45236 extends AnimatorListenerAdapter {
        C45236() {
        }
