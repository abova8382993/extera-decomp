...
public class RecyclerItemsEnterAnimator {
    ...
    public void showItemsAnimated(int i) {
        ...
        ViewTreeObserverOnPreDrawListenerC47402 viewTreeObserverOnPreDrawListenerC47402 = new ViewTreeObserverOnPreDrawListenerC47402(progressView, i);
        this.preDrawListeners.add(viewTreeObserverOnPreDrawListenerC47402);
        this.listView.getViewTreeObserver().addOnPreDrawListener(viewTreeObserverOnPreDrawListenerC47402);
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.RecyclerItemsEnterAnimator$2 */
    class ViewTreeObserverOnPreDrawListenerC47402 implements ViewTreeObserver.OnPreDrawListener {
        final /* synthetic */ int val$finalFrom;
        final /* synthetic */ View val$finalProgressView;

        ViewTreeObserverOnPreDrawListenerC47402(View view, int i) {
