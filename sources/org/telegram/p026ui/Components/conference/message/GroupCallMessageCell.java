...
public class GroupCallMessageCell extends ViewGroup implements ClickHelper.Delegate, NotificationCenter.NotificationCenterDelegate, FactorAnimator.Target {
    ...
    public /* bridge */ /* synthetic */ long getLongPressDuration() {
        /*
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.conference.message.GroupCallMessageCell.getLongPressDuration():long");
    }
    ...
    public GroupCallMessageCell(Context context) {
        ...
        imageReceiver.setRoundRadius(AndroidUtilities.m1081dp(11.0f));
        cellFlickerDrawable.setStrokeWidth(AndroidUtilities.m1081dp(1.0f));
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.flickerDrawable.setParentWidth(Math.round(this.layout.bubble.width() + AndroidUtilities.m1081dp(48.0f)));
    }
    ...
    private int getClickTarget(float f, float f2) {
        ...
        this.tmpRectF.inset(-AndroidUtilities.m1081dp(5.0f), -AndroidUtilities.m1081dp(5.0f));
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (this.isSendDelayedAnimator.getFloatValue() > 0.0f) {
            ...
            this.tmpRectF.inset(AndroidUtilities.m1081dp(1.0f), AndroidUtilities.m1081dp(1.0f));
            this.flickerDrawable.draw(canvas, this.tmpRectF, AndroidUtilities.m1081dp(14.0f), null);
            invalidate();
        }
    ...
    private static class Layout {
        ...
        public static Layout build(int i, int i2, int i3, SpoilersTextView spoilersTextView, ReactionsLayoutInBubble.VisibleReaction visibleReaction) {
            int iM1081dp;
            spoilersTextView.measure(View.MeasureSpec.makeMeasureSpec(((i - i2) - i3) - AndroidUtilities.m1081dp(44.0f), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(0, 0));
            float measuredWidth = spoilersTextView.getMeasuredWidth();
            if (visibleReaction == null) {
                iM1081dp = ((int) Math.ceil(measuredWidth)) + AndroidUtilities.m1081dp(44.0f);
            } else {
                iM1081dp = AndroidUtilities.m1081dp(70.0f) + ((int) Math.ceil(measuredWidth));
            }
            int iMax = Math.max(AndroidUtilities.m1081dp(28.0f), spoilersTextView.getMeasuredHeight() + AndroidUtilities.m1081dp(8.0f));
            Layout layout = new Layout();
            layout.viewWidth = i;
            layout.viewHeight = iMax;
            layout.bubble.set(0.0f, 0.0f, iM1081dp, iMax);
            layout.bubble.offset((i - iM1081dp) / 2.0f, 0.0f);
            layout.bubblePath.addRoundRect(layout.bubble, AndroidUtilities.m1081dp(14.0f), AndroidUtilities.m1081dp(14.0f), Path.Direction.CW);
            boolean z = spoilersTextView.getLayout().getParagraphDirection(0) == -1;
            layout.avatar.set(0.0f, 0.0f, AndroidUtilities.m1081dp(22.0f), AndroidUtilities.m1081dp(22.0f));
            if (z) {
                RectF rectF = layout.avatar;
                RectF rectF2 = layout.bubble;
                rectF.offset(rectF2.right, rectF2.top);
                layout.avatar.offset((-AndroidUtilities.m1081dp(4.0f)) - layout.avatar.width(), AndroidUtilities.m1081dp(3.0f));
            } else {
                RectF rectF3 = layout.avatar;
                RectF rectF4 = layout.bubble;
                rectF3.offset(rectF4.left, rectF4.top);
                layout.avatar.offset(AndroidUtilities.m1081dp(4.0f), AndroidUtilities.m1081dp(3.0f));
            }
            layout.reaction.set(0.0f, 0.0f, AndroidUtilities.m1081dp(28.0f), AndroidUtilities.m1081dp(28.0f));
            if (z) {
                layout.reaction.offset(layout.bubble.left + AndroidUtilities.m1081dp(5.0f), 0.0f);
            } else {
                layout.reaction.offset(layout.bubble.right - AndroidUtilities.m1081dp(33.0f), 0.0f);
            }
            layout.reaction.inset(AndroidUtilities.m1081dp(1.0f), AndroidUtilities.m1081dp(1.0f));
            layout.text.set(0.0f, (layout.bubble.top + AndroidUtilities.m1081dp(19.0f)) - spoilersTextView.getLayout().getLineBaseline(0));
            if (z) {
                layout.text.offset((layout.bubble.right - AndroidUtilities.m1081dp(32.0f)) - measuredWidth, 0.0f);
                return layout;
            }
            layout.text.offset(layout.bubble.left + AndroidUtilities.m1081dp(32.0f), 0.0f);
            return layout;
        }
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.conference.message.GroupCallMessageCell$VH */
    public static class C5153VH extends RecyclerView.ViewHolder {
        public final GroupCallMessageCell cell;

        public C5153VH(GroupCallMessageCell groupCallMessageCell) {
