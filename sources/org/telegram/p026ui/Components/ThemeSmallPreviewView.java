...
public class ThemeSmallPreviewView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ThemeSmallPreviewView(Context context, int i, Theme.ResourcesProvider resourcesProvider, int i2) {
        super(context);
        this.STROKE_RADIUS = AndroidUtilities.m1081dp(8.0f);
        this.INNER_RADIUS = AndroidUtilities.m1081dp(6.0f);
        this.INNER_RECT_SPACE = AndroidUtilities.m1081dp(4.0f);
        this.BUBBLE_HEIGHT = AndroidUtilities.m1081dp(21.0f);
        this.BUBBLE_WIDTH = AndroidUtilities.m1081dp(41.0f);
        ...
        imageReceiver.setRoundRadius(AndroidUtilities.m1081dp(8.0f));
        ...
        this.outlineBackgroundPaint.setStrokeWidth(AndroidUtilities.m1081dp(2.0f));
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (i3 == 1 || i3 == 4) {
            ...
            int iM1081dp = AndroidUtilities.m1081dp(i3 == 0 ? 77.0f : 83.0f);
            int size2 = View.MeasureSpec.getSize(i2);
            if (size2 == 0) {
                size2 = (int) (iM1081dp * 1.35f);
            }
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(iM1081dp, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, TLObject.FLAG_30));
        }
    ...
    public void setItem(final ChatThemeBottomSheet.ChatThemeItem chatThemeItem, long j, boolean z) {
        ...
        if (emojiThemes == null || emojiThemes.isAnyStub()) {
            setContentDescription(LocaleController.getString(C2702R.string.ChatNoTheme));
        } else {
    ...
    public /* synthetic */ void lambda$setItem$3(final ChatThemeBottomSheet.ChatThemeItem chatThemeItem, final int i) {
        final Bitmap bitmap = SvgHelper.getBitmap(C2702R.raw.default_pattern, AndroidUtilities.m1081dp(120.0f), AndroidUtilities.m1081dp(140.0f), -16777216, AndroidUtilities.density);
    ...
    class C50361 extends AnimatorListenerAdapter {
        final /* synthetic */ boolean val$selected;
    ...
    private Bitmap prescaleBitmap(Bitmap bitmap) {
        ...
        float fMax = Math.max(AndroidUtilities.m1081dp(120.0f) / bitmap.getWidth(), AndroidUtilities.m1081dp(140.0f) / bitmap.getHeight());
    ...
    private void fillOutBubblePaint(Paint paint, List list) {
        if (list.size() > 1) {
            ...
            float fM1081dp = this.INNER_RECT_SPACE + AndroidUtilities.m1081dp(8.0f);
            paint.setShader(new LinearGradient(0.0f, fM1081dp, 0.0f, fM1081dp + this.BUBBLE_HEIGHT, iArr, (float[]) null, Shader.TileMode.CLAMP));
            return;
        }
    ...
    public void updatePreviewBackground(ThemeDrawable themeDrawable) {
        ...
        if (iTheme != null && iTheme.getThemeId() != 0) {
            ...
            themeDrawable.outBubblePaintSecond.setAlpha(Function.USE_VARARGS);
        ...
        if (themeItem.themeInfo.getAccent(false) != null) {
            ...
            if (i != 0) {
                ...
                if (themeInfo != null && (themeInfo.previewWallpaperOffset > 0 || themeInfo.pathToWallpaper != null)) {
                    float fM1081dp = AndroidUtilities.m1081dp(112.0f);
                    float fM1081dp2 = AndroidUtilities.m1081dp(134.0f);
                    Theme.ThemeInfo themeInfo2 = themeItem.themeInfo;
                    Bitmap scaledBitmap = AndroidUtilities.getScaledBitmap(fM1081dp, fM1081dp2, themeInfo2.pathToWallpaper, themeInfo2.pathToFile, themeInfo2.previewWallpaperOffset);
    ...
    public StaticLayout getNoThemeStaticLayout() {
        ...
        textPaint.setColor(getThemedColor(Theme.key_chat_emojiPanelTrendingDescription));
        this.noThemeTextPaint.setTextSize(AndroidUtilities.m1081dp(noThemeStringTextSize()));
        this.noThemeTextPaint.setTypeface(AndroidUtilities.bold());
        int iM1081dp = AndroidUtilities.m1081dp(52.0f);
        int i = this.currentType;
        if (i == 3 || i == 4) {
            iM1081dp = AndroidUtilities.m1081dp(77.0f);
        }
        int i2 = iM1081dp;
    ...
    protected String noThemeString() {
        return LocaleController.getString(C2702R.string.ChatNoTheme);
    }
    ...
    private class ThemeDrawable {
        ...
        public void draw(Canvas canvas, float f) {
            ...
            if (themeSmallPreviewView.isSelected || themeSmallPreviewView.strokeAlphaAnimator != null) {
                ...
                float strokeWidth = (this.strokePaint.getStrokeWidth() * 0.5f) + (AndroidUtilities.m1081dp(4.0f) * (1.0f - ThemeSmallPreviewView.this.selectionProgress));
            ...
            if (emojiThemes == null || (emojiThemes.isAnyStub() && ThemeSmallPreviewView.this.chatThemeItem.chatTheme.wallpaper == null)) {
                ...
                if (themeSmallPreviewView2.fallbackWallpaper == null) {
                    ...
                    canvas.translate((ThemeSmallPreviewView.this.getWidth() - noThemeStaticLayout.getWidth()) * 0.5f, AndroidUtilities.m1081dp(18.0f));
            ...
            if (ThemeSmallPreviewView.this.currentType != 4) {
                if (ThemeSmallPreviewView.this.currentType == 2) {
                    if (ThemeSmallPreviewView.this.chatThemeItem.icon != null) {
                        canvas.drawBitmap(ThemeSmallPreviewView.this.chatThemeItem.icon, (r2.getWidth() - ThemeSmallPreviewView.this.chatThemeItem.icon.getWidth()) * 0.5f, AndroidUtilities.m1081dp(21.0f), (Paint) null);
                        return;
                    }
                    return;
                }
                float fM1081dp = ThemeSmallPreviewView.this.INNER_RECT_SPACE + AndroidUtilities.m1081dp(8.0f);
                float fM1081dp2 = ThemeSmallPreviewView.this.INNER_RECT_SPACE + AndroidUtilities.m1081dp(ThemeSmallPreviewView.this.currentType == 3 ? 5.0f : 22.0f);
                if (ThemeSmallPreviewView.this.currentType == 0 || ThemeSmallPreviewView.this.currentType == 3) {
                    ThemeSmallPreviewView.this.rectF.set(fM1081dp2, fM1081dp, (ThemeSmallPreviewView.this.BUBBLE_WIDTH * (ThemeSmallPreviewView.this.currentType == 3 ? 1.2f : 1.0f)) + fM1081dp2, ThemeSmallPreviewView.this.BUBBLE_HEIGHT + fM1081dp);
                } else {
                    fM1081dp = ThemeSmallPreviewView.this.getMeasuredHeight() * 0.12f;
                    ThemeSmallPreviewView.this.rectF.set(ThemeSmallPreviewView.this.getMeasuredWidth() - (ThemeSmallPreviewView.this.getMeasuredWidth() * 0.65f), fM1081dp, ThemeSmallPreviewView.this.getMeasuredWidth() - (ThemeSmallPreviewView.this.getMeasuredWidth() * 0.1f), ThemeSmallPreviewView.this.getMeasuredHeight() * 0.32f);
                }
                ...
                if (ThemeSmallPreviewView.this.currentType == 0 || ThemeSmallPreviewView.this.currentType == 3) {
                    float fM1081dp3 = ThemeSmallPreviewView.this.INNER_RECT_SPACE + AndroidUtilities.m1081dp(5.0f);
                    float fM1081dp4 = fM1081dp + ThemeSmallPreviewView.this.BUBBLE_HEIGHT + AndroidUtilities.m1081dp(4.0f);
                    ThemeSmallPreviewView.this.rectF.set(fM1081dp3, fM1081dp4, (ThemeSmallPreviewView.this.BUBBLE_WIDTH * (ThemeSmallPreviewView.this.currentType == 3 ? 0.8f : 1.0f)) + fM1081dp3, ThemeSmallPreviewView.this.BUBBLE_HEIGHT + fM1081dp4);
                } else {
                ...
                if (ThemeSmallPreviewView.this.currentType == 0 || ThemeSmallPreviewView.this.currentType == 3) {
                    ...
                    if (ThemeSmallPreviewView.this.themeUserByUserId != 0) {
                        ...
                        ThemeSmallPreviewView.this.rectF.set(fHeight - AndroidUtilities.m1081dp(f2), fCenterY - AndroidUtilities.m1081dp(f2), fHeight + AndroidUtilities.m1081dp(f2), AndroidUtilities.m1081dp(f2) + fCenterY);
                        ...
                        if (this.rotateDrawable == null) {
                            this.rotateDrawable = ThemeSmallPreviewView.this.getContext().getDrawable(C2702R.drawable.mini_replace_16).mutate();
                        }
                        int i2 = (int) fHeight2;
                        int i3 = (int) fCenterY;
                        this.rotateDrawable.setBounds(i2 - AndroidUtilities.m1081dp(f2), i3 - AndroidUtilities.m1081dp(f2), i2 + AndroidUtilities.m1081dp(f2), i3 + AndroidUtilities.m1081dp(f2));
