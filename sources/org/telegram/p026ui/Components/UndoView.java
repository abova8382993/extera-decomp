...
public class UndoView extends FrameLayout {
    ...
    public UndoView(Context context, BaseFragment baseFragment, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.enterOffsetMargin = AndroidUtilities.m1081dp(8.0f);
        this.timeReplaceProgress = 1.0f;
        this.resourcesProvider = resourcesProvider;
        this.parentFragment = baseFragment;
        this.fromTop = z;
        C50911 c50911 = new LinkSpanDrawable.LinksTextView(context, resourcesProvider) { // from class: org.telegram.ui.Components.UndoView.1
            C50911(Context context2, Theme.ResourcesProvider resourcesProvider2) {
        ...
        this.infoTextView = c50911;
        c50911.setTextSize(1, 15.0f);
        ...
        this.undoButton.setBackground(Theme.createRadSelectorDrawable(getThemedColor(i2) & 587202559, AndroidUtilities.m1081dp(2.0f), AndroidUtilities.m1081dp(2.0f)));
        ...
        this.rect = new RectF(AndroidUtilities.m1081dp(15.0f), AndroidUtilities.m1081dp(15.0f), AndroidUtilities.m1081dp(33.0f), AndroidUtilities.m1081dp(33.0f));
        ...
        this.backgroundDrawable = Theme.createRoundRectDrawable(AndroidUtilities.m1081dp(10.0f), getThemedColor(i3));
    ...
    class C50911 extends LinkSpanDrawable.LinksTextView {
        C50911(Context context2, Theme.ResourcesProvider resourcesProvider2) {
            super(context2, resourcesProvider2);
        }
    ...
    class C50922 extends AnimatorListenerAdapter {
        C50922() {
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:3397:0x0f73  */
    /* JADX WARN: Removed duplicated region for block: B:3398:0x0f7f  */
    /* JADX WARN: Removed duplicated region for block: B:3579:0x1863  */
    /* JADX WARN: Removed duplicated region for block: B:3582:0x1883  */
    /* JADX WARN: Removed duplicated region for block: B:3585:0x18aa  */
    /* JADX WARN: Removed duplicated region for block: B:3589:0x18ef  */
    /* JADX WARN: Removed duplicated region for block: B:3620:0x19a0  */
    /* JADX WARN: Removed duplicated region for block: B:3647:? A[RETURN, SYNTHETIC] */
    ...
    */
    public void showWithAction(java.util.ArrayList r30, int r31, java.lang.Object r32, java.lang.Object r33, java.lang.Runnable r34, java.lang.Runnable r35) {
        /*
            Method dump skipped, instruction units count: 6668
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.UndoView.showWithAction(java.util.ArrayList, int, java.lang.Object, java.lang.Object, java.lang.Runnable, java.lang.Runnable):void");
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        if (this.additionalTranslationY != 0.0f) {
            canvas.save();
            float measuredHeight = (getMeasuredHeight() - this.enterOffset) + AndroidUtilities.m1081dp(9.0f);
    ...
    protected void onDraw(Canvas canvas) {
        if (this.additionalTranslationY != 0.0f) {
            canvas.save();
            float measuredHeight = (getMeasuredHeight() - this.enterOffset) + this.enterOffsetMargin + AndroidUtilities.m1081dp(1.0f);
            if (measuredHeight > 0.0f) {
                canvas.clipRect(0.0f, 0.0f, getMeasuredWidth(), measuredHeight);
                super.dispatchDraw(canvas);
            }
        ...
        if (i == 1 || i == 95 || i == 0 || i == 27 || i == 26 || i == 81 || i == 88) {
            ...
            if (this.timeLayoutOut != null) {
                ...
                if (f3 < 1.0f) {
                    ...
                    canvas.save();
                    canvas.translate(this.rect.centerX() - (this.textWidth / 2), AndroidUtilities.m1081dp(17.2f) + (AndroidUtilities.m1081dp(10.0f) * this.timeReplaceProgress));
            ...
            if (this.timeLayout != null) {
                ...
                canvas.save();
                canvas.translate(this.rect.centerX() - (this.textWidth / 2), AndroidUtilities.m1081dp(17.2f) - (AndroidUtilities.m1081dp(10.0f) * (1.0f - this.timeReplaceProgress)));
    ...
    private void updatePosition() {
        setTranslationY(((this.enterOffset - this.enterOffsetMargin) + AndroidUtilities.m1081dp(8.0f)) - this.additionalTranslationY);
        invalidate();
    }
