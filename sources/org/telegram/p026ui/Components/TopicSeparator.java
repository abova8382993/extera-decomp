...
public class TopicSeparator {
    ...
    public TopicSeparator(int i, View view, Theme.ResourcesProvider resourcesProvider, boolean z) {
        ...
        path.rewind();
        path.moveTo(-AndroidUtilities.m1081dp(1.75f), -AndroidUtilities.m1081dp(4.0f));
        path.lineTo(AndroidUtilities.m1081dp(1.75f), 0.0f);
        path.lineTo(-AndroidUtilities.m1081dp(1.75f), AndroidUtilities.m1081dp(4.0f));
    ...
    public boolean update(MessageObject messageObject) {
        ...
        if (messageObject == null) {
            ...
            this.image.setRoundRadius(AndroidUtilities.m1081dp(10.0f));
    ...
    public void draw(Canvas canvas, int i, float f, float f2, float f3, float f4, boolean z) {
        ...
        text.ellipsize(i - AndroidUtilities.m1081dp(144.66f));
        float fM1081dp = AndroidUtilities.m1081dp(48.66f) + this.text.getWidth();
        float f7 = i;
        float f8 = 2.0f;
        float f9 = (f7 - fM1081dp) / 2.0f;
        int i2 = (int) fM1081dp;
        if (this.pathWidth == i2 && this.pathParentWidth == i && this.pathWithCenter == z && this.pathWithDots == this.withDots) {
            ...
            rectF.set(f9, AndroidUtilities.m1081dp(4.5f), f9 + fM1081dp, AndroidUtilities.m1081dp(28.5f));
            if (z) {
            ...
            if (this.withDots) {
                float f10 = f7 / 2.0f;
                float f11 = 1.833f;
                float fM1081dp2 = f10 - AndroidUtilities.m1081dp(1.833f);
                while (fM1081dp2 > 0.0f) {
                    RectF rectF2 = AndroidUtilities.rectTmp;
                    rectF2.set(fM1081dp2 - AndroidUtilities.m1081dp(3.66f), AndroidUtilities.m1081dp(15.5f), fM1081dp2, AndroidUtilities.m1081dp(17.5f));
                    this.path.addRoundRect(rectF2, AndroidUtilities.m1081dp(1.0f), AndroidUtilities.m1081dp(1.0f), Path.Direction.CW);
                    fM1081dp2 -= AndroidUtilities.m1081dp(8.33f);
                    f8 = f8;
                    f11 = f11;
                    fM1081dp = fM1081dp;
                }
                f5 = fM1081dp;
                f6 = f8;
                int iM1081dp = AndroidUtilities.m1081dp(f11);
                while (true) {
                    f10 += iM1081dp;
                    if (f10 >= f7) {
                        break;
                    ...
                    rectF3.set(f10, AndroidUtilities.m1081dp(15.5f), AndroidUtilities.m1081dp(3.66f) + f10, AndroidUtilities.m1081dp(17.5f));
                    this.path.addRoundRect(rectF3, AndroidUtilities.m1081dp(1.0f), AndroidUtilities.m1081dp(1.0f), Path.Direction.CW);
                    iM1081dp = AndroidUtilities.m1081dp(8.33f);
                }
            } else {
                f5 = fM1081dp;
                f6 = 2.0f;
        ...
        float f13 = f12 + f9;
        float f14 = f13 + f5;
        this.clickBounds.set(f13 - AndroidUtilities.m1081dp(4.0f), f2 - AndroidUtilities.m1081dp(4.0f), AndroidUtilities.m1081dp(4.0f) + f14, AndroidUtilities.m1081dp(32.0f) + f2);
        if (z) {
            AnimatedEmojiDrawable animatedEmojiDrawable = this.emojiImage;
            if (animatedEmojiDrawable != null) {
                animatedEmojiDrawable.setBounds((int) (AndroidUtilities.m1081dp(2.66f) + f13), (int) (AndroidUtilities.m1081dp(6.5f) + f2), (int) (AndroidUtilities.m1081dp(22.66f) + f13), (int) (AndroidUtilities.m1081dp(26.5f) + f2));
                this.emojiImage.setAlpha((int) (255.0f * f4));
                this.emojiImage.draw(canvas);
            } else {
                this.image.setImageCoords(AndroidUtilities.m1081dp(2.66f) + f13, AndroidUtilities.m1081dp(6.5f) + f2, AndroidUtilities.m1081dp(20.0f), AndroidUtilities.m1081dp(20.0f));
                this.image.setAlpha(f4);
                this.image.draw(canvas);
            }
            int color = Theme.getColor(Theme.key_chat_serviceText, this.resourcesProvider);
            this.text.draw(canvas, f13 + AndroidUtilities.m1081dp(27.66f), AndroidUtilities.m1081dp(16.5f) + f2, color, f4);
            canvas.save();
            canvas.translate(f14 - AndroidUtilities.m1081dp(11.25f), AndroidUtilities.m1081dp(16.5f) + f2);
            this.arrowPaint.setColor(Theme.multAlpha(color, 0.75f * f4));
            this.arrowPaint.setStrokeWidth(AndroidUtilities.m1081dp(1.66f));
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r6, boolean r7) {
        ...
        L6f:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.TopicSeparator.onTouchEvent(android.view.MotionEvent, boolean):boolean");
    }
    ...
    public static class Cell extends View {
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(33.0f), TLObject.FLAG_30));
        }
