...
public class SeekBarWaveform {
    ...
    */
    public void draw(android.graphics.Canvas r21, android.view.View r22) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Components.SeekBarWaveform.draw(android.graphics.Canvas, android.view.View):void");
    }
    ...
    private void drawFill(Canvas canvas, float f) {
        ...
        if (f2 > 0.0f) {
            if (this.loadingPaint == null || Math.abs(this.loadingPaintWidth - this.width) > AndroidUtilities.m1081dp(8.0f) || this.loadingPaintColor1 != this.innerColor || this.loadingPaintColor2 != this.outerColor) {
    ...
    private void addBar(Path path, float f, float f2) {
        float fDpf2 = AndroidUtilities.dpf2(2.0f);
        int iM1081dp = (this.height - AndroidUtilities.m1081dp(14.0f)) / 2;
        float f3 = f2 * this.waveScaling;
        RectF rectF = AndroidUtilities.rectTmp;
        float f4 = fDpf2 / 2.0f;
        rectF.set((AndroidUtilities.dpf2(1.0f) + f) - f4, AndroidUtilities.m1081dp(7.0f) + iM1081dp + ((-f3) - f4), f + AndroidUtilities.dpf2(1.0f) + f4, iM1081dp + AndroidUtilities.m1081dp(7.0f) + f3 + f4);
    ...
    public static class Particles {
        ...
        public Particles(int i, Runnable runnable) {
            ...
            paint.setStrokeWidth(AndroidUtilities.m1081dp(1.33f));
        }
        ...
        public void draw(Canvas canvas, float f) {
            ...
            while (i < this.particles.size()) {
                ...
                float f2 = jMin;
                float f3 = particle.f2026t - (f2 / particle.f2025d);
                particle.f2026t = f3;
                if (f3 < 0.0f) {
                    ...
                    float f4 = particle.f2030x;
                    float f5 = particle.f2028vx;
                    float f6 = particle.f2027v;
                    particle.f2030x = f4 + (((f5 * f6) * f2) / 500.0f);
                    float f7 = particle.f2031y;
                    float f8 = particle.f2029vy;
                    particle.f2031y = f7 + (((f6 * f8) * f2) / 500.0f);
                    particle.f2029vy = f8 - ((((long) AndroidUtilities.m1081dp(0.33f)) * jMin) / 500.0f);
                }
                i++;
            }
            if (this.emitArea != null) {
                ...
                for (int i2 = 0; i2 < iMin; i2++) {
                    ...
                    particle2.f2030x = rectF.left + (rectF.width() * Utilities.random.nextFloat());
                    RectF rectF2 = this.emitArea;
                    particle2.f2031y = rectF2.top + (rectF2.height() * Utilities.random.nextFloat());
                    double dNextInt = ((double) (Utilities.random.nextInt(DataTypes.EMPTY) - 125)) * 0.017453292519943295d;
                    particle2.f2028vx = ((float) (Math.cos(dNextInt) - Math.sin(dNextInt))) * 0.8f;
                    particle2.f2029vy = ((float) (Math.sin(dNextInt) + Math.cos(dNextInt))) - 0.2f;
                    particle2.f2026t = 1.0f;
                    particle2.f2027v = AndroidUtilities.m1081dp((Utilities.random.nextFloat() * 7.0f) + 10.0f);
                    particle2.f2025d = AndroidUtilities.lerp(420, 550, Utilities.random.nextFloat());
                    this.particles.add(particle2);
                }
            }
            for (int i3 = 0; i3 < this.particles.size(); i3++) {
                Particle particle3 = (Particle) this.particles.get(i3);
                this.paint.setAlpha((int) (255.0f * f * particle3.f2026t));
                canvas.drawPoint(particle3.f2030x, particle3.f2031y, this.paint);
            }
