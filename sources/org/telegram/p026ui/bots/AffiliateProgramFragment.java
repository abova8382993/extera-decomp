...
public class AffiliateProgramFragment extends GradientHeaderActivity implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(final Context context) {
        ...
        C71991 c71991 = new View(context) { // from class: org.telegram.ui.bots.AffiliateProgramFragment.1
            C71991(final Context context2) {
                super(context2);
            }
            ...
            protected void onMeasure(int i, int i2) {
                ...
                if (affiliateProgramFragment.isLandscapeMode) {
                    measuredHeight = (affiliateProgramFragment.statusBarHeight + ((BaseFragment) affiliateProgramFragment).actionBar.getMeasuredHeight()) - AndroidUtilities.m1081dp(16.0f);
                } else {
                    ...
                    int measuredHeight2 = iM1081dp + affiliateProgramFragment2.statusBarHeight;
                    if (affiliateProgramFragment2.backgroundView.getMeasuredHeight() + AndroidUtilities.m1081dp(24.0f) > measuredHeight2) {
                        measuredHeight2 = AffiliateProgramFragment.this.backgroundView.getMeasuredHeight() + AndroidUtilities.m1081dp(24.0f);
                    }
        ...
        this.emptyLayout = c71991;
        c71991.setBackgroundColor(Theme.getColor(Theme.key_dialogBackgroundGray));
        ...
        configureHeader(LocaleController.getString(C2702R.string.BotAffiliateProgramTitle), LocaleController.getString(C2702R.string.BotAffiliateProgramText), this.aboveTitleView, null);
        ...
        C72002 c72002 = new ButtonWithCounterView(context2, this.resourceProvider) { // from class: org.telegram.ui.bots.AffiliateProgramFragment.2
            @Override // org.telegram.p026ui.Stories.recorder.ButtonWithCounterView
            protected boolean subTextSplitToWords() {
                return false;
            }

            C72002(final Context context2, Theme.ResourcesProvider resourcesProvider) {
                super(context2, resourcesProvider);
            }
        };
        this.button = c72002;
        c72002.setText(LocaleController.getString(C2702R.string.AffiliateProgramStart), false);
        ...
        this.listView.setPadding(0, 0, 0, AndroidUtilities.m1081dp(84.0f));
    ...
    class C72002 extends ButtonWithCounterView {
        @Override // org.telegram.p026ui.Stories.recorder.ButtonWithCounterView
        protected boolean subTextSplitToWords() {
            return false;
        }
    ...
    public /* synthetic */ void lambda$createView$4(Context context, View view) {
        if (this.button.isEnabled()) {
            ...
            tableView.addRow(LocaleController.getString(C2702R.string.AffiliateProgramCommission), percents(this.program.commission_permille));
            String string = LocaleController.getString(C2702R.string.AffiliateProgramDuration);
            int i = this.program.duration_months;
            tableView.addRow(string, i <= 0 ? LocaleController.getString(C2702R.string.Infinity) : (i < 12 || i % 12 != 0) ? LocaleController.formatPluralString("Months", i, new Object[0]) : LocaleController.formatPluralString("Years", i / 12, new Object[0]));
            frameLayout.addView(tableView, LayoutHelper.createFrame(-1, -2.0f, Opcodes.DNEG, 24.0f, 0.0f, 24.0f, 0.0f));
            new AlertDialog.Builder(context, this.resourceProvider).setTitle(LocaleController.getString(C2702R.string.AffiliateProgramAlert)).setMessage(LocaleController.getString(this.new_program ? C2702R.string.AffiliateProgramStartAlertText : C2702R.string.AffiliateProgramUpdateAlertText)).setView(frameLayout).setPositiveButton(LocaleController.getString(this.new_program ? C2702R.string.AffiliateProgramStartAlertButton : C2702R.string.AffiliateProgramUpdateAlertButton), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.bots.AffiliateProgramFragment$$ExternalSyntheticLambda5
    ...
    public /* synthetic */ void lambda$createView$5(View view, int i) {
        ...
        int i2 = universalAdapter.getItem(i).f2056id;
        if (i2 == 4) {
            end();
        } else if (i2 == 2) {
    ...
    private void closeToProfile(boolean z) {
        ...
        if (backgroundFragment != null) {
            if (z) {
                BulletinFactory.m1195of(backgroundFragment).createSimpleBulletin(C2702R.raw.linkbroken, LocaleController.getString(C2702R.string.AffiliateProgramEndedTitle), AndroidUtilities.replaceTags(LocaleController.getString(C2702R.string.AffiliateProgramEndedText))).show();
            } else {
                BulletinFactory.m1195of(backgroundFragment).createSimpleBulletin(C2702R.raw.contact_check, LocaleController.getString(C2702R.string.AffiliateProgramStartedTitle), LocaleController.getString(C2702R.string.AffiliateProgramStartedText)).show();
            }
        }
    }

    private void update(boolean z) {
        this.button.setText(LocaleController.getString((this.new_program || this.program.end_date != 0) ? C2702R.string.AffiliateProgramStart : C2702R.string.AffiliateProgramUpdate), z);
        AndroidUtilities.cancelRunOnUIThread(this.updateTimerRunnable);
        this.updateTimerRunnable.run();
        this.buttonSubtext.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString((this.new_program || this.program.end_date != 0) ? C2702R.string.AffiliateProgramStartInfo : C2702R.string.AffiliateProgramUpdateInfo), new Runnable() { // from class: org.telegram.ui.bots.AffiliateProgramFragment$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$update$6() {
        Browser.openUrl(getContext(), LocaleController.getString((this.new_program || this.program.end_date != 0) ? C2702R.string.AffiliateProgramUpdateInfoLink : C2702R.string.AffiliateProgramStartInfoLink));
    }
    ...
    private class BulletinTextView extends TextView {
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            canvas.drawCircle(AndroidUtilities.m1081dp(3.5f), AndroidUtilities.m1081dp(11.5f), AndroidUtilities.m1081dp(2.5f), getPaint());
        }
    }
    ...
    private void end() {
        ...
        linearLayout.setOrientation(1);
        linearLayout.setPadding(AndroidUtilities.m1081dp(24.0f), 0, AndroidUtilities.m1081dp(24.0f), 0);
        TextView textView = new TextView(getContext());
        textView.setTextSize(1, 16.0f);
        int i = Theme.key_windowBackgroundWhiteBlackText;
        textView.setTextColor(Theme.getColor(i, this.resourceProvider));
        textView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2702R.string.AffiliateProgramStopText)));
        ...
        bulletinTextView.setPadding(AndroidUtilities.m1081dp(15.0f), 0, 0, 0);
        bulletinTextView.setTextSize(1, 16.0f);
        bulletinTextView.setTextColor(Theme.getColor(i, this.resourceProvider));
        bulletinTextView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2702R.string.AffiliateProgramStopText1)));
        ...
        bulletinTextView2.setPadding(AndroidUtilities.m1081dp(15.0f), 0, 0, 0);
        bulletinTextView2.setTextSize(1, 16.0f);
        bulletinTextView2.setTextColor(Theme.getColor(i, this.resourceProvider));
        bulletinTextView2.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2702R.string.AffiliateProgramStopText2)));
        ...
        bulletinTextView3.setPadding(AndroidUtilities.m1081dp(15.0f), 0, 0, 0);
        bulletinTextView3.setTextSize(1, 16.0f);
        bulletinTextView3.setTextColor(Theme.getColor(i, this.resourceProvider));
        bulletinTextView3.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2702R.string.AffiliateProgramStopText3)));
        linearLayout.addView(bulletinTextView3, LayoutHelper.createLinear(-1, -2, 0.0f, 0.0f, 0.0f, 10.0f));
        new AlertDialog.Builder(getContext(), this.resourceProvider).setTitle(LocaleController.getString(C2702R.string.AffiliateProgramAlert)).setView(linearLayout).setPositiveButton(LocaleController.getString(C2702R.string.AffiliateProgramStopButton), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.bots.AffiliateProgramFragment$$ExternalSyntheticLambda9
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i2) {
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        arrayList.add(FeatureCell.Factory.m1286as(C2702R.drawable.menu_feature_premium, LocaleController.getString(C2702R.string.BotAffiliateProgramFeature1Title), LocaleController.getString(C2702R.string.BotAffiliateProgramFeature1)));
        arrayList.add(FeatureCell.Factory.m1286as(C2702R.drawable.msg_channel, LocaleController.getString(C2702R.string.BotAffiliateProgramFeature2Title), LocaleController.getString(C2702R.string.BotAffiliateProgramFeature2)));
        arrayList.add(FeatureCell.Factory.m1286as(C2702R.drawable.menu_feature_links2, LocaleController.getString(C2702R.string.BotAffiliateProgramFeature3Title), LocaleController.getString(C2702R.string.BotAffiliateProgramFeature3)));
        arrayList.add(UItem.asShadow(1, null));
        arrayList.add(UItem.asHeader(LocaleController.getString(C2702R.string.AffiliateProgramCommission)));
        ...
        arrayList.add(UItem.asShadow(LocaleController.getString(C2702R.string.AffiliateProgramCommissionInfo)));
        arrayList.add(UItem.asHeader(LocaleController.getString(C2702R.string.AffiliateProgramDuration)));
        if (this.durationTexts == null) {
            ...
            for (int i = 0; i < this.durationValues.size(); i++) {
                ...
                if (iIntValue == 0) {
                    this.durationTexts[i] = LocaleController.getString(C2702R.string.Infinity);
        ...
        arrayList.add(UItem.asShadow(LocaleController.getString(C2702R.string.AffiliateProgramDurationInfo)));
        arrayList.add(ColorfulTextCell.Factory.m1285as(2, getThemedColor(Theme.key_color_green), C2702R.drawable.filled_earn_stars, LocaleController.getString(C2702R.string.AffiliateProgramExistingProgramsTitle), LocaleController.getString(C2702R.string.AffiliateProgramExistingProgramsText)));
        arrayList.add(UItem.asShadow(3, null));
        if (!this.new_program && this.program.end_date == 0) {
            arrayList.add(UItem.asButton(4, LocaleController.getString(C2702R.string.AffiliateProgramStop)).red());
    ...
    class C72013 extends StarParticlesView {
        C72013(Context context) {
            super(context);
            setClipWithGradient();
        }
    ...
    class C72024 extends UniversalAdapter {
        C72024(RecyclerListView recyclerListView, Context context, int i, int i2, boolean z, Utilities.Callback2 callback2, Theme.ResourcesProvider resourcesProvider) {
    ...
    protected RecyclerView.Adapter createAdapter() {
        C72024 c72024 = new UniversalAdapter(this.listView, getContext(), this.currentAccount, this.classGuid, true, new Utilities.Callback2() { // from class: org.telegram.ui.bots.AffiliateProgramFragment$$ExternalSyntheticLambda6
    ...
    public static class FeatureCell extends FrameLayout {
        ...
        public static class Factory extends UItem.UItemFactory {
            ...
            public static UItem m1286as(int i, CharSequence charSequence, CharSequence charSequence2) {
    ...
    public static class ColorfulTextCell extends FrameLayout {
        ...
        public ColorfulTextCell(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            textView3.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1081dp(4.0f), Theme.getColor(Theme.key_color_green, resourcesProvider)));
            textView3.setTextSize(1, 13.0f);
            textView3.setTypeface(AndroidUtilities.bold());
            textView3.setPadding(AndroidUtilities.m1081dp(5.0f), 0, AndroidUtilities.m1081dp(4.0f), 0);
        ...
        public void set(int i, int i2, CharSequence charSequence, CharSequence charSequence2) {
            ...
            this.imageView.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1081dp(9.0f), i));
            this.titleView.setText(charSequence);
            if (TextUtils.isEmpty(charSequence2)) {
                this.imageViewLayoutParams.topMargin = AndroidUtilities.m1081dp(10.0f);
                this.imageViewLayoutParams.bottomMargin = AndroidUtilities.m1081dp(10.0f);
            ...
            this.imageViewLayoutParams.topMargin = AndroidUtilities.m1081dp(14.33f);
            this.imageViewLayoutParams.bottomMargin = AndroidUtilities.m1081dp(10.0f);
            this.titleView.setTypeface(AndroidUtilities.bold());
            this.titleView.setTextSize(1, 15.0f);
            this.textLayoutLayoutParams.topMargin = AndroidUtilities.m1081dp(10.0f);
            this.textLayoutLayoutParams.bottomMargin = AndroidUtilities.m1081dp(8.66f);
        ...
        public static class Factory extends UItem.UItemFactory {
            ...
            /* JADX INFO: renamed from: as */
            public static UItem m1285as(int i, int i2, int i3, CharSequence charSequence, CharSequence charSequence2) {
                UItem uItemOfFactory = UItem.ofFactory(Factory.class);
    ...
    public void onInsets(int i, int i2, int i3, int i4) {
        this.listView.setPadding(0, 0, 0, AndroidUtilities.m1081dp(84.0f) + i4);
