...
public abstract class BotKeyboardView extends LinearLayout implements InAppKeyboardInsetView, ReplaceAnimator.Callback {
    ...
    public void setPanelHeight(int i) {
        ...
        int iMax = !this.isFullSize ? 44 : (int) Math.max(44.0f, (((this.panelHeight - AndroidUtilities.m1081dp(16.0f)) - ((this.botButtons.rows.size() - 1) * AndroidUtilities.m1081dp(4.0f))) / this.botButtons.rows.size()) / AndroidUtilities.density);
        this.buttonHeight = iMax;
        int iM1081dp = AndroidUtilities.m1081dp(iMax);
        for (ListAnimator.Entry entry : this.animator) {
            ...
            for (int i2 = 0; i2 < childCount; i2++) {
                ...
                if (layoutParams.height != iM1081dp) {
    ...
    public void setButtons(TLRPC.TL_replyKeyboardMarkup tL_replyKeyboardMarkup) {
        ...
        if (tL_replyKeyboardMarkup != null && !this.botButtons.rows.isEmpty()) {
            ...
            this.isFullSize = !z;
            this.buttonHeight = z ? 44 : (int) Math.max(44.0f, (((this.panelHeight - AndroidUtilities.m1081dp(16.0f)) - ((this.botButtons.rows.size() - 1) * AndroidUtilities.m1081dp(4.0f))) / this.botButtons.rows.size()) / AndroidUtilities.density);
            int i2 = 0;
    ...
    private class Button extends FrameLayout {
        ...
        public Button(Context context, TLRPC.KeyboardButton keyboardButton) {
            ...
            if ((keyboardButton instanceof TLRPC.TL_keyboardButtonWebView) || (keyboardButton instanceof TLRPC.TL_keyboardButtonSimpleWebView)) {
                imageView.setImageResource(C2702R.drawable.bot_webview);
        ...
        public void updateColors() {
            ...
            int iM1081dp2 = AndroidUtilities.m1081dp(11.0f);
            ...
            int i3 = (z && this.isTop) ? iM1081dp : iM1081dp2;
            boolean z2 = this.isRight;
            setBackground(Theme.createSimpleSelectorRoundRectDrawable(i3, (z2 && this.isTop) ? iM1081dp : iM1081dp2, (z2 && this.isBottom) ? iM1081dp : iM1081dp2, (z && this.isBottom) ? iM1081dp : iM1081dp2, i, i2, i2));
        }
    }
    ...
    public int getKeyboardHeight() {
        ...
        return this.isFullSize ? this.panelHeight : (tL_replyKeyboardMarkup.rows.size() * AndroidUtilities.m1081dp(this.buttonHeight)) + AndroidUtilities.m1081dp(16.0f) + ((this.botButtons.rows.size() - 1) * AndroidUtilities.m1081dp(4.0f));
    }
