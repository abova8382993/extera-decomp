...
public class BotSensors {
    ...
    private final SensorEventListener accelerometerListener = new C72151();
    private final SensorEventListener gyroscopeListener = new C72162();
    private final SensorEventListener absoluteOrientationListener = new C72173();
    private final SensorEventListener relativeOrientationListener = new C72184();
    ...
    class C72151 implements SensorEventListener {
    ...
    class C72162 implements SensorEventListener {
    ...
    class C72173 implements SensorEventListener {
        ...
        public void post() {
            ...
            if (SensorManager.getRotationMatrix(fArr, new float[9], this.gravity, this.geomagnetic)) {
                ...
                try {
                    ...
                    jSONObject.put(BuildConfig.FLAVOR_minApi, -r0[1]);
    ...
    class C72184 implements SensorEventListener {
        private long lastTime;
