...
public class ChatActivityBotWebViewButton extends FrameLayout {
    ...
    public void draw(Canvas canvas) {
        canvas.save();
        float height = (getHeight() - AndroidUtilities.m1081dp(32.0f)) / 2.0f;
        float fMax = Math.max((getWidth() - this.menuButtonWidth) - AndroidUtilities.m1081dp(4.0f), getHeight()) * this.progress;
        float fM1081dp = AndroidUtilities.m1081dp(16.0f) + fMax;
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(AndroidUtilities.m1081dp(14.0f) - fMax, (AndroidUtilities.m1081dp(4.0f) + height) - fMax, AndroidUtilities.m1081dp(6.0f) + this.menuButtonWidth + fMax, (getHeight() - AndroidUtilities.m1081dp(12.0f)) + fMax);
        this.path.rewind();
        ...
        canvas.translate(AndroidUtilities.m1081dp(10.0f), height);
        ...
        canvas.restore();
        canvas.translate((-AndroidUtilities.m1081dp(8.0f)) * (1.0f - this.progress), 0.0f);
        super.draw(canvas);
        canvas.restore();
    }
