...
public abstract class BotCommandsMenuContainer extends FrameLayout {
    ...
    public BotCommandsMenuContainer(Context context) {
        ...
        RecyclerListView recyclerListView = new RecyclerListView(context) { // from class: org.telegram.ui.bots.BotCommandsMenuContainer.1
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                float fM1081dp = BotCommandsMenuContainer.this.scrollYOffset - AndroidUtilities.m1081dp(8.0f);
                BotCommandsMenuContainer.this.containerY = fM1081dp - AndroidUtilities.m1081dp(16.0f);
                ...
                rectF.set((getMeasuredWidth() / 2.0f) - AndroidUtilities.m1081dp(12.0f), fM1081dp - AndroidUtilities.m1081dp(4.0f), (getMeasuredWidth() / 2.0f) + AndroidUtilities.m1081dp(12.0f), fM1081dp);
                canvas.drawRoundRect(rectF, AndroidUtilities.m1081dp(4.0f), AndroidUtilities.m1081dp(4.0f), BotCommandsMenuContainer.this.topBackground);
                super.dispatchDraw(canvas);
            }
        };
    ...
    private void checkDismiss() {
        ...
        if (this.listView.getTranslationY() > AndroidUtilities.m1081dp(16.0f)) {
            dismiss();
        } else {
            playEnterAnim(false);
        }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.entering && !this.dismissed) {
            this.listView.setTranslationY((r2.getMeasuredHeight() - this.listView.getPaddingTop()) + AndroidUtilities.m1081dp(16.0f));
            playEnterAnim(true);
            this.entering = false;
        }
    ...
    public void dismiss() {
        ...
        cancelCurrentAnimation();
        RecyclerListView recyclerListView = this.listView;
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(recyclerListView, (Property<RecyclerListView, Float>) FrameLayout.TRANSLATION_Y, recyclerListView.getTranslationY(), (getMeasuredHeight() - this.scrollYOffset) + AndroidUtilities.m1081dp(40.0f));
        this.currentAnimation = objectAnimatorOfFloat;
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() != 0 || motionEvent.getY() >= this.scrollYOffset - AndroidUtilities.m1081dp(24.0f)) {
    ...
    public void checkBackgroundBounds() {
        BlurredBackgroundDrawable blurredBackgroundDrawable = this.backgroundDrawable;
        if (blurredBackgroundDrawable != null) {
            blurredBackgroundDrawable.setBounds(0, ((int) this.scrollYOffset) - AndroidUtilities.m1081dp(25.0f), getMeasuredWidth(), getMeasuredHeight() + AndroidUtilities.m1081dp(5.0f));
