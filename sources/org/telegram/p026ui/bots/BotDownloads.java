...
public class BotDownloads {
    ...
    public void cancel(FileDownload fileDownload) {
        ...
        Long l = fileDownload.f2201id;
        if (l != null) {
            this.downloadManager.remove(l.longValue());
            fileDownload.f2201id = null;
        }
    ...
    public class FileDownload {
        ...
        public FileDownload(String str, String str2) {
            ...
            this.f2201id = Long.valueOf(BotDownloads.this.downloadManager.enqueue(request));
        }
        ...
        public void updateProgress() {
            ...
            query.setFilterById(this.f2201id.longValue());
        ...
        public Pair getProgress() {
            ...
            if (this.f2201id == null || this.cancelled) {
        ...
        public boolean isDownloading() {
            return (this.done || this.f2201id == null) ? false : true;
        }
    }

    public static void getMimeAndSize(String str, Utilities.Callback2 callback2) {
        if (cachedMimeAndSizes.containsKey(str)) {
            ...
            new AsyncTask() { // from class: org.telegram.ui.bots.BotDownloads.1
                ...
                AsyncTaskC72111(String str2, Utilities.Callback2 callback22) {
                    str = str2;
    ...
    class AsyncTaskC72111 extends AsyncTask {
        String mime;
        long size;
        final /* synthetic */ String val$url;
        final /* synthetic */ Utilities.Callback2 val$whenDone;
    ...
    public static AlertDialog showAlert(Context context, String str, String str2, String str3, final Utilities.Callback callback, long j, String str4) {
        ...
        builder.setTitle(LocaleController.getString(C2702R.string.BotDownloadFileTitle));
        builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString(C2702R.string.BotDownloadFileText, str3)));
        LinearLayout linearLayout = new LinearLayout(context);
        linearLayout.setPadding(AndroidUtilities.m1081dp(22.0f), 0, AndroidUtilities.m1081dp(22.0f), 0);
        linearLayout.setOrientation(0);
        ImageView imageView = new ImageView(context);
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        imageView.setBackground(Theme.createCircleDrawable(AndroidUtilities.m1081dp(44.0f), Theme.getColor(Theme.key_featuredStickers_addButton)));
        imageView.setImageResource(C2702R.drawable.msg_round_file_s);
        ...
        LoadingSpan loadingSpan = new LoadingSpan(animatedTextView, AndroidUtilities.m1081dp(55.0f));
        ...
        builder.setNegativeButton(LocaleController.getString(C2702R.string.Cancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.bots.BotDownloads$$ExternalSyntheticLambda1
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i2) {
                BotDownloads.$r8$lambda$SvY6Nau02KUegIqZhFcTpXoUtaQ(zArr, callback, alertDialog, i2);
            }
        });
        builder.setPositiveButton(LocaleController.getString(C2702R.string.BotDownloadFileDownload), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.bots.BotDownloads$$ExternalSyntheticLambda2
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i2) {
                BotDownloads.m19781$r8$lambda$0V5vVA5p02uOzaqNbeUDVEoiqw(zArr, callback, alertDialog, i2);
            }
        });
    ...
    public static /* synthetic */ void m19781$r8$lambda$0V5vVA5p02uOzaqNbeUDVEoiqw(boolean[] zArr, Utilities.Callback callback, AlertDialog alertDialog, int i) {
        if (zArr[0]) {
            return;
        }
    ...
    public static class DownloadBulletin extends Bulletin.ButtonLayout {
        ...
        public DownloadBulletin(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            BackgroundDrawable color = new BackgroundDrawable(AndroidUtilities.m1081dp(10.0f)).setColor(Theme.getColor(Theme.key_undo_background, resourcesProvider));
        ...
        public boolean set(FileDownload fileDownload) {
            ...
            if (fileDownload.isDownloading()) {
                ...
                if (((Long) progress.first).longValue() <= 0) {
                    this.subtitleView.setText(LocaleController.getString(C2702R.string.BotFileDownloading));
                ...
                if (fileDownload.done) {
                    this.subtitleView.setText(LocaleController.getString(C2702R.string.BotFileDownloaded));
                    setButton(2);
        ...
        private void setButton(int i) {
            ...
            if (i == 1) {
                Bulletin.UndoButton undoAction = new Bulletin.UndoButton(getContext(), true, this.resourcesProvider).setText(LocaleController.getString(C2702R.string.BotFileDownloadCancel)).setUndoAction(new Runnable() { // from class: org.telegram.ui.bots.BotDownloads$DownloadBulletin$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
            ...
            if (i == 2) {
                Bulletin.UndoButton undoAction2 = new Bulletin.UndoButton(getContext(), true, this.resourcesProvider).setText(LocaleController.getString(C2702R.string.BotFileDownloadOpen)).setUndoAction(new Runnable() { // from class: org.telegram.ui.bots.BotDownloads$DownloadBulletin$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(68.0f), TLObject.FLAG_30));
        }
        ...
        private static class StatusDrawable extends Drawable {
            ...
            public StatusDrawable(Context context, View view) {
                ...
                this.doc = context.getResources().getDrawable(C2702R.drawable.search_files_filled).mutate();
            ...
            public void setDone(boolean z) {
                ...
                this.done = true;
                this.cancelled = z;
                RLottieDrawable rLottieDrawable = new RLottieDrawable(z ? C2702R.raw.error : C2702R.raw.contact_check, z ? "error" : "contact_check", AndroidUtilities.m1081dp(40.0f), AndroidUtilities.m1081dp(40.0f));
            ...
            public void draw(Canvas canvas) {
                ...
                if (f3 < 1.0f) {
                    ...
                    canvas2.drawCircle(f6, f7, fM1081dp, this.strokePaint);
                    float f8 = f4 * 1.0f;
                    this.strokePaint.setColor(Theme.multAlpha(-1, f8));
                    f = 0.4f;
                    this.rect.set(f6 - fM1081dp, f7 - fM1081dp, f6 + fM1081dp, f7 + fM1081dp);
            ...
            public int getIntrinsicWidth() {
                return AndroidUtilities.m1081dp(40.0f);
            }
        ...
        private static class BackgroundDrawable extends Drawable {
            ...
            public BackgroundDrawable(int i) {
                ...
                this.f2200r = i;
                path.moveTo(-AndroidUtilities.m1081dp(6.5f), 0.0f);
                path.lineTo(AndroidUtilities.m1081dp(6.5f), 0.0f);
                path.lineTo(0.0f, -AndroidUtilities.m1081dp(6.16f));
                path.close();
            }
            ...
            public void draw(Canvas canvas) {
                ...
                this.rect.inset(AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(8.0f));
                RectF rectF = this.rect;
                int i = this.f2200r;
                canvas.drawRoundRect(rectF, i, i, this.paint);
                float f = this.arrowProgress.set(this.arrow);
                float fM1081dp = (this.rect.right + AndroidUtilities.m1081dp(8.0f)) - this.arrowX.set(this.arrowMargin);
                if (f > 0.0f) {
                    canvas.save();
                    canvas.translate(fM1081dp, AndroidUtilities.m1081dp(8.0f) + (AndroidUtilities.m1081dp(6.16f) * (1.0f - f)));
