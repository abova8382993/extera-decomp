...
public class BotBiometrySettings extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2702R.string.PrivacyBiometryBots));
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        arrayList.add(UItem.asShadow(LocaleController.getString(C2702R.string.PrivacyBiometryBotsInfo)));
    }
    ...
    public void onClick(UItem uItem, View view, int i, float f, float f2) {
        int i2;
        UniversalAdapter universalAdapter;
        if (uItem.viewType != 4 || (i2 = uItem.f2056id) < 0 || i2 >= this.biometryBots.size()) {
            return;
        }
        BotBiometry.Bot bot = (BotBiometry.Bot) this.biometryBots.get(uItem.f2056id);
        bot.disabled = !bot.disabled;
        BotBiometry.toggleBotDisabled(getContext(), this.currentAccount, bot.user.f1775id, bot.disabled);
        UniversalRecyclerView universalRecyclerView = this.listView;
        if (universalRecyclerView == null || (universalAdapter = universalRecyclerView.adapter) == null) {
            return;
        }
