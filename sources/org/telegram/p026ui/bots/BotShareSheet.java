...
import org.telegram.p026ui.web.HttpGetFileTask;
...
public class BotShareSheet extends BottomSheetWithRecyclerListView {
    ...
    public static void share(final Context context, final int i, final long j, final String str, final Theme.ResourcesProvider resourcesProvider, final Runnable runnable, final Utilities.Callback2 callback2) {
        ...
        tL_messages_getPreparedInlineMessage.f1715id = str;
                ...
                if (!file.exists()) {
                    ...
                    final HttpGetFileTask httpGetFileTask = new HttpGetFileTask(new Utilities.Callback() { // from class: org.telegram.ui.bots.BotShareSheet$$ExternalSyntheticLambda3
                        ...
                        public final void run(Object obj) {
                            BotShareSheet.m19804$r8$lambda$vgRbaSSp7en3a3AYtxdSwXe9Kw(fileArr, alertDialog, runnable2, (File) obj);
                        }
                    }, null);
    ...
    public static /* synthetic */ void m19804$r8$lambda$vgRbaSSp7en3a3AYtxdSwXe9Kw(File[] fileArr, AlertDialog alertDialog, Runnable runnable, File file) {
        fileArr[0] = file;
        alertDialog.dismiss();
        runnable.run();
    }
    ...
    public BotShareSheet(Context context, final int i, final long j, String str, final TLRPC.TL_messages_preparedInlineMessage tL_messages_preparedInlineMessage, File file, Theme.ResourcesProvider resourcesProvider, final Runnable runnable, final Utilities.Callback2 callback2) {
        ...
        this.headerPaddingBottom = AndroidUtilities.m1081dp(-10.0f);
        ...
        chatActionCell.setCustomText(LocaleController.getString(C2702R.string.BotShareMessagePreview));
        ...
        buttonWithCounterView.setText(LocaleController.getString(C2702R.string.BotShareMessageShare), false);
        ...
        this.recyclerListView.setPadding(0, 0, 0, AndroidUtilities.m1081dp(68.0f) + 1);
    ...
    public /* synthetic */ void lambda$new$6(final TLRPC.TL_messages_preparedInlineMessage tL_messages_preparedInlineMessage, final Utilities.Callback2 callback2, final int i, final long j, Runnable runnable, View view) {
        ...
        DialogsActivity dialogsActivity = new DialogsActivity(bundle) { // from class: org.telegram.ui.bots.BotShareSheet.5
            ...
            @Override // org.telegram.p026ui.DialogsActivity, org.telegram.p026ui.ActionBar.BaseFragment
    ...
    public /* synthetic */ boolean lambda$new$5(int i, TLRPC.TL_messages_preparedInlineMessage tL_messages_preparedInlineMessage, long j, BaseFragment baseFragment, Utilities.Callback2 callback2, DialogsActivity dialogsActivity, ArrayList arrayList, CharSequence charSequence, boolean z, boolean z2, int i2, int i3, TopicsFragment topicsFragment) {
        ...
        while (i5 < size) {
            ...
            if (!DialogObject.isEncryptedDialog(j2)) {
                ...
                map.put("id", _UrlKt.FRAGMENT_ENCODE_SET + tL_messages_preparedInlineMessage.result.f1608id);
                ...
                if (charSequence != null) {
                    ...
                    SendMessagesHelper.SendMessageParams sendMessageParamsM1124of = SendMessagesHelper.SendMessageParams.m1124of(charSequence.toString(), j4, messageObject3, messageObject3, null, true, null, null, null, true, 0, 0, null, false);
                    j4 = j4;
                    sendMessagesHelper.sendMessage(sendMessageParamsM1124of);
                }
    ...
    protected CharSequence getTitle() {
        return LocaleController.getString(C2702R.string.BotShareMessage);
    }
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        arrayList.add(UItem.asShadow(AndroidUtilities.replaceTags(LocaleController.formatString(C2702R.string.BotShareMessageInfo, this.botName))));
    }
    ...
    */
    public static org.telegram.messenger.MessageObject convert(int r18, long r19, org.telegram.tgnet.TLRPC.BotInlineResult r21, java.io.File r22) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.bots.BotShareSheet.convert(int, long, org.telegram.tgnet.TLRPC$BotInlineResult, java.io.File):org.telegram.messenger.MessageObject");
    }
