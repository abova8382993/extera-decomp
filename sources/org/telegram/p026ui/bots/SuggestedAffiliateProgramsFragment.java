...
public class SuggestedAffiliateProgramsFragment extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2702R.string.ChannelAffiliatePrograms));
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        for (int i = 0; i < channelSuggestedBots.bots.size(); i++) {
            arrayList.add(ChannelAffiliateProgramsFragment.BotCell.Factory.m1292as(channelSuggestedBots.bots.get(i), false));
        }
