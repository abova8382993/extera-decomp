...
public class CreateGroupCallSheet extends BottomSheetWithRecyclerListView {
    ...
    public CreateGroupCallSheet(Context context, Collection collection) {
        ...
        frameLayout2.setBackground(Theme.createCircleDrawable(AndroidUtilities.m1081dp(80.0f), Theme.getColor(Theme.key_featuredStickers_addButton, this.resourcesProvider)));
        ImageView imageView2 = new ImageView(context);
        imageView2.setImageResource(C2702R.drawable.filled_calls_users);
        ...
        linksTextViewMakeLinkTextView.setText(LocaleController.getString(C2702R.string.GroupCallCreateTitle));
        ...
        linksTextViewMakeLinkTextView2.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2702R.string.GroupCallCreateText)));
        ...
        linearLayout2.setPadding(this.backgroundPaddingLeft + AndroidUtilities.m1081dp(14.0f), AndroidUtilities.m1081dp(14.0f), this.backgroundPaddingLeft + AndroidUtilities.m1081dp(14.0f), AndroidUtilities.m1081dp(14.0f));
        ...
        recyclerListView.setPadding(i2, 0, i2, AndroidUtilities.m1081dp(76.0f));
    }
    ...
    public /* synthetic */ void lambda$new$1(View view, int i, float f, float f2) {
        ...
        if (obj instanceof TLRPC.User) {
            j = ((TLRPC.User) obj).f1775id;
        } else if (!(obj instanceof TLRPC.Chat)) {
            return;
        } else {
            j = ((TLRPC.Chat) obj).f1610id;
        }
    ...
    public /* synthetic */ void lambda$createCall$5(TLObject tLObject, ButtonWithCounterView buttonWithCounterView, boolean z, HashSet hashSet, TLRPC.TL_error tL_error) {
        ...
        if (!(tLObject instanceof TL_phone.groupCall)) {
            if (tL_error != null) {
                BulletinFactory.m1194of(this.topBulletinContainer, this.resourcesProvider).showForError(tL_error);
                return;
            }
            return;
        }
    ...
    protected CharSequence getTitle() {
        return LocaleController.getString(C2702R.string.GroupCallCreateTitle);
    }
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        arrayList.add(UItem.asHeader(LocaleController.getString(C2702R.string.GroupCallCreateAddMembers)));
