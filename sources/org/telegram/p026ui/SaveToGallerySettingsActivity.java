...
public class SaveToGallerySettingsActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        if (this.dialogException != null) {
            if (this.isNewException) {
                this.actionBar.setTitle(LocaleController.getString(C2702R.string.NotificationsNewException));
            } else {
                this.actionBar.setTitle(LocaleController.getString(C2702R.string.SaveToGalleryException));
            }
        } else {
            int i = this.type;
            if (i == 1) {
                this.actionBar.setTitle(LocaleController.getString(C2702R.string.SaveToGalleryPrivate));
            } else if (i == 2) {
                this.actionBar.setTitle(LocaleController.getString(C2702R.string.SaveToGalleryGroups));
            } else {
                this.actionBar.setTitle(LocaleController.getString(C2702R.string.SaveToGalleryChannels));
            }
        }
        ...
        if (this.dialogException != null) {
            ...
            textView.setText(LocaleController.getString(this.isNewException ? C2702R.string.AddException : C2702R.string.SaveException));
    ...
    public /* synthetic */ void lambda$createView$2(View view, int i, float f, float f2) {
        ...
        if (((Item) this.items.get(i)).viewType == 4) {
            AlertDialog alertDialogCreate = AlertsCreator.createSimpleAlert(getContext(), LocaleController.getString(C2702R.string.NotificationsDeleteAllExceptionTitle), LocaleController.getString(C2702R.string.NotificationsDeleteAllExceptionAlert), LocaleController.getString(C2702R.string.Delete), new Runnable() { // from class: org.telegram.ui.SaveToGallerySettingsActivity$$ExternalSyntheticLambda6
    ...
    public /* synthetic */ boolean lambda$createView$5(View view, final int i, float f, float f2) {
        ...
        ActionBarMenuSubItem actionBarMenuSubItemAddItem = ActionBarMenuItem.addItem(actionBarPopupWindowLayout, C2702R.drawable.msg_customize, LocaleController.getString(C2702R.string.EditException), false, null);
        ActionBarMenuSubItem actionBarMenuSubItemAddItem2 = ActionBarMenuItem.addItem(actionBarPopupWindowLayout, C2702R.drawable.msg_delete, LocaleController.getString(C2702R.string.DeleteException), false, null);
    ...
    private void updateRows() {
        ...
        int i4 = 5;
        this.items.add(new Item(i4, LocaleController.getString(C2702R.string.SaveToGallery)));
        ...
        int i7 = 4;
        if (this.dialogException != null) {
            string = LocaleController.getString(C2702R.string.SaveToGalleryHintCurrent);
        } else {
            int i8 = this.type;
            if (i8 == 1) {
                string = LocaleController.getString(C2702R.string.SaveToGalleryHintUser);
            } else if (i8 == 4) {
                string = LocaleController.getString(C2702R.string.SaveToGalleryHintChannels);
            } else {
                string = i8 == 2 ? LocaleController.getString(C2702R.string.SaveToGalleryHintGroup) : null;
            }
        }
        int i9 = 7;
        this.items.add(new Item(i9, string));
        if (getSettings().saveVideo) {
            this.items.add(new Item(i4, LocaleController.getString(C2702R.string.MaxVideoSize)));
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            switch (i) {
                case 1:
                    ...
                    textCell.setTextAndIcon((CharSequence) LocaleController.getString(C2702R.string.NotificationsAddAnException), C2702R.drawable.msg_contact_add, true);
                ...
                case 4:
                    ...
                    textCell2.setText(LocaleController.getString(C2702R.string.NotificationsDeleteAllException), false);
                ...
                case 8:
                    ...
                    selectableAnimatedTextView.setTextSize(AndroidUtilities.m1081dp(13.0f));
                    ...
                    selectableAnimatedTextView2.setTextSize(AndroidUtilities.m1081dp(13.0f));
                    ...
                    selectableAnimatedTextView3.setTextSize(AndroidUtilities.m1081dp(13.0f));
                    ...
                    seekBarView.setDelegate(new SeekBarView.SeekBarViewDelegate() { // from class: org.telegram.ui.SaveToGallerySettingsActivity.Adapter.1
                        ...
                        public void onSeekBarDrag(boolean z, float f) {
                            ...
                            if (f >= 1.0f) {
                                ...
                                selectableAnimatedTextView2.setText(LocaleController.formatString("UpToFileSize", C2702R.string.UpToFileSize, AndroidUtilities.formatFileSize(j3, true, false)), false);
                                selectableAnimatedTextView.setSelectedInternal(false, zIsAttachedToWindow);
                ...
                case 10:
                    ...
                    shadowSectionCell2.setBackgroundDrawable(Theme.getThemedDrawable(SaveToGallerySettingsActivity.this.getContext(), C2702R.drawable.greydivider_bottom, Theme.getColor(Theme.key_windowBackgroundGrayShadow, SaveToGallerySettingsActivity.this.getResourceProvider())));
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (((Item) SaveToGallerySettingsActivity.this.items.get(i)).viewType == 6) {
                ...
                if (i == SaveToGallerySettingsActivity.this.savePhotosRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getString(C2702R.string.SaveToGalleryPhotos), settings.savePhoto, true);
                    SaveToGallerySettingsActivity saveToGallerySettingsActivity = SaveToGallerySettingsActivity.this;
                    int i2 = Theme.key_statisticChartLine_lightblue;
                    textCheckCell.setColorfullIcon(saveToGallerySettingsActivity.getThemedColor(i2), C2702R.drawable.msg_filled_data_photos);
                    textCheckCell.setColorfullIcon(SaveToGallerySettingsActivity.this.getThemedColor(i2), C2702R.drawable.msg_filled_data_photos);
                    return;
                }
                textCheckCell.setTextAndCheck(LocaleController.getString(C2702R.string.SaveToGalleryVideos), settings.saveVideo, false);
                textCheckCell.setColorfullIcon(SaveToGallerySettingsActivity.this.getThemedColor(Theme.key_statisticChartLine_green), C2702R.drawable.msg_filled_data_videos);
                return;
            }
            if (((Item) SaveToGallerySettingsActivity.this.items.get(i)).viewType == 7) {
                ...
                if (i == saveToGallerySettingsActivity2.videoDividerRow) {
                    ...
                    if (saveToGallerySettingsActivity3.dialogException != null) {
                        textInfoPrivacyCell.setText(LocaleController.formatString("SaveToGalleryVideoHintCurrent", C2702R.string.SaveToGalleryVideoHintCurrent, new Object[0]));
                        return;
                    }
                    int i3 = saveToGallerySettingsActivity3.type;
                    if (i3 == 1) {
                        textInfoPrivacyCell.setText(LocaleController.formatString("SaveToGalleryVideoHintUser", C2702R.string.SaveToGalleryVideoHintUser, new Object[0]));
                        return;
                    } else if (i3 == 4) {
                        textInfoPrivacyCell.setText(LocaleController.formatString("SaveToGalleryVideoHintChannels", C2702R.string.SaveToGalleryVideoHintChannels, new Object[0]));
                        return;
                    } else {
                        if (i3 == 2) {
                            textInfoPrivacyCell.setText(LocaleController.formatString("SaveToGalleryVideoHintGroup", C2702R.string.SaveToGalleryVideoHintGroup, new Object[0]));
                            return;
                        }
                        return;
                    }
