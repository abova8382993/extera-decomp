...
import org.telegram.p026ui.Components.GigagroupConvertAlert;
...
public class ChatUsersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public void updateRows() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.ChatUsersActivity.updateRows():void");
    }
    ...
    public View createView(Context context) {
        ...
        int i2 = this.type;
        if (i2 == 3) {
            this.actionBar.setTitle(LocaleController.getString("ChannelPermissions", C2702R.string.ChannelPermissions));
        } else if (i2 == 0) {
            this.actionBar.setTitle(LocaleController.getString("ChannelBlacklist", C2702R.string.ChannelBlacklist));
        } else if (i2 == 1) {
            this.actionBar.setTitle(LocaleController.getString(C2702R.string.ChannelAdministrators));
        } else if (i2 == 2) {
            int i3 = this.selectType;
            if (i3 == 0) {
                if (this.isChannel) {
                    this.actionBar.setTitle(LocaleController.getString(C2702R.string.ChannelSubscribers));
                } else {
                    this.actionBar.setTitle(LocaleController.getString("ChannelMembers", C2702R.string.ChannelMembers));
                }
            } else if (i3 == 1) {
                this.actionBar.setTitle(LocaleController.getString("ChannelAddAdmin", C2702R.string.ChannelAddAdmin));
            } else if (i3 == 2) {
                this.actionBar.setTitle(LocaleController.getString("ChannelBlockUser", C2702R.string.ChannelBlockUser));
            } else if (i3 == 3) {
                this.actionBar.setTitle(LocaleController.getString("ChannelAddException", C2702R.string.ChannelAddException));
            }
        }
        ...
        if (this.selectType != 0 || this.type == 2 || (ChatObject.hasAdminRights(this.currentChat) && ((i = this.type) == 0 || i == 3))) {
            ...
            ActionBarMenuItem actionBarMenuItemSearchListener = actionBarMenuCreateMenu.addItem(0, C2702R.drawable.outline_header_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() { // from class: org.telegram.ui.ChatUsersActivity.2
            ...
            if (this.type == 3) {
                this.searchItem.setSearchFieldHint(LocaleController.getString("ChannelSearchException", C2702R.string.ChannelSearchException));
            } else {
                this.searchItem.setSearchFieldHint(LocaleController.getString("Search", C2702R.string.Search));
            }
            if (!ChatObject.isChannel(this.currentChat) && !this.currentChat.creator) {
                this.searchItem.setVisibility(8);
            }
            if (this.type == 3) {
                this.doneItem = actionBarMenuCreateMenu.addItemWithWidth(1, C2702R.drawable.ic_ab_done, AndroidUtilities.m1081dp(56.0f), LocaleController.getString("Done", C2702R.string.Done));
            }
        } else if (this.type == 1 && ChatObject.isChannelAndNotMegaGroup(this.currentChat) && ChatObject.hasAdminRights(this.currentChat)) {
            this.doneItem = this.actionBar.createMenu().addItemWithWidth(1, C2702R.drawable.ic_ab_done, AndroidUtilities.m1081dp(56.0f), LocaleController.getString("Done", C2702R.string.Done));
        }
        ...
        this.emptyView.subtitle.setText(LocaleController.getString(C2702R.string.SearchEmptyViewFilteredSubtitle2));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Removed duplicated region for block: B:361:0x0741  */
    ...
    */
    public /* synthetic */ void lambda$createView$5(android.view.View r27, int r28, float r29, float r30) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.ChatUsersActivity.lambda$createView$5(android.view.View, int, float, float):void");
    }

    /* JADX INFO: renamed from: org.telegram.ui.ChatUsersActivity$8 */
    class C35718 implements ChatUsersActivityDelegate {
        ...
        public void didSelectUser(long j) {
            ...
            if (ChatUsersActivity.this.participantsMap.get(j) == null) {
                ...
                tL_peerUser.user_id = user.f1775id;
                ...
                ChatUsersActivity.this.participantsMap.put(user.f1775id, tL_channelParticipantAdmin);
                ChatUsersActivity.sortAdmins(ChatUsersActivity.this.participants);
                ChatUsersActivity.this.updateListAnimated(diffCallbackSaveState);
            }
        }
    ...
    class C35729 implements GroupCreateActivity.ContactsAddActivityDelegate {
        ...
        public static /* synthetic */ void m7732$r8$lambda$WM9sKtXUV1LfNHXgRVln15qtBY(TLRPC.User user) {
        }

        C35729(GroupCreateActivity groupCreateActivity) {
        ...
        public void didSelectUsers(ArrayList arrayList, int i) {
            ...
            ChatUsersActivity.this.getMessagesController().addUsersToChat(ChatUsersActivity.this.currentChat, ChatUsersActivity.this, arrayList, i, new Consumer() { // from class: org.telegram.ui.ChatUsersActivity$9$$ExternalSyntheticLambda0
                ...
                @Override // androidx.core.util.Consumer
                public final void accept(Object obj) {
                    ChatUsersActivity.C35729.m7732$r8$lambda$WM9sKtXUV1LfNHXgRVln15qtBY((TLRPC.User) obj);
                }
            }, null);
        }
        ...
        public /* synthetic */ void lambda$didSelectUsers$0(TLRPC.User user) {
            ...
            if (longSparseArray.get(user.f1775id) == null) {
                if (ChatObject.isChannel(ChatUsersActivity.this.currentChat)) {
                    ...
                    longSparseArray.put(user.f1775id, tL_channelParticipant);
                } else {
                    TLRPC.TL_chatParticipant tL_chatParticipant = new TLRPC.TL_chatParticipant();
                    tL_chatParticipant.user_id = user.f1775id;
                    tL_chatParticipant.inviter_id = ChatUsersActivity.this.getUserConfig().getClientUserId();
                    arrayList.add(0, tL_chatParticipant);
                    longSparseArray.put(user.f1775id, tL_chatParticipant);
                }
            }
        ...
        public void needAddBot(TLRPC.User user) {
            ChatUsersActivity.this.openRightsEdit(user.f1775id, null, null, null, _UrlKt.FRAGMENT_ENCODE_SET, true, 0, false);
        }
    }
    ...
    public /* synthetic */ void lambda$createView$0(TextCell textCell, boolean z) {
        ...
        textCell.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(this.currentChat, 13) || ((chatFull = this.info) != null && chatFull.antispam && getParticipantsCount() < getMessagesController().telegramAntispamGroupSizeMin)) ? C2702R.drawable.permission_locked : 0);
    ...
    public /* synthetic */ void lambda$createView$2(TextCell textCell, boolean z) {
        ...
        textCell.setChecked(z);
        textCell.getCheckBox().setIcon((!ChatObject.canUserDoAdminAction(this.currentChat, 2) || ((chatFull = this.info) != null && chatFull.participants_hidden && getParticipantsCount() < getMessagesController().hiddenMembersGroupSizeMin)) ? C2702R.drawable.permission_locked : 0);
        BulletinFactory.m1195of(this).createSimpleBulletin(C2702R.raw.error, LocaleController.getString("UnknownError", C2702R.string.UnknownError)).show();
    }

    /* JADX INFO: renamed from: org.telegram.ui.ChatUsersActivity$10 */
    class DialogC355610 extends GigagroupConvertAlert {
        @Override // org.telegram.p026ui.Components.GigagroupConvertAlert
        protected void onCancel() {
        }

        DialogC355610(Context context, BaseFragment baseFragment) {
    ...
    public /* synthetic */ void lambda$createView$4(TLRPC.User user, TLObject tLObject, TLRPC.TL_chatAdminRights tL_chatAdminRights, TLRPC.TL_chatBannedRights tL_chatBannedRights, String str, boolean z, AlertDialog alertDialog, int i) {
        openRightsEdit(user.f1775id, tLObject, tL_chatAdminRights, tL_chatBannedRights, str, z, this.selectType == 1 ? 0 : 1, false);
    }
    ...
    public static void sortAdmins(ArrayList arrayList) {
        Collections.sort(arrayList, new Comparator() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda10
            ...
            public final int compare(Object obj, Object obj2) {
                return ChatUsersActivity.m7608$r8$lambda$_BfRbptXvn3KOW9KVkkKfld59E((TLObject) obj, (TLObject) obj2);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$_BfRbptXvn3KO-W9KVkkKfld59E, reason: not valid java name */
    public static /* synthetic */ int m7608$r8$lambda$_BfRbptXvn3KOW9KVkkKfld59E(TLObject tLObject, TLObject tLObject2) {
    ...
    public void onOwnerChaged(TLRPC.User user) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            TLObject tLObject = (TLObject) longSparseArray.get(user.f1775id);
            ...
            if (z3) {
                Collections.sort(arrayList, new Comparator() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda32
                    @Override // java.util.Comparator
                    public final int compare(Object obj, Object obj2) {
                        return ChatUsersActivity.m7610$r8$lambda$eZIOIndTE17GvvoOb21C1lPDHw((TLObject) obj, (TLObject) obj2);
                    }
                });
            }
        }
    ...
    /* JADX INFO: renamed from: $r8$lambda$eZIOIndTE17GvvoOb21C1-lPDHw, reason: not valid java name */
    public static /* synthetic */ int m7610$r8$lambda$eZIOIndTE17GvvoOb21C1lPDHw(TLObject tLObject, TLObject tLObject2) {
        int channelAdminParticipantType = getChannelAdminParticipantType(tLObject);
        int channelAdminParticipantType2 = getChannelAdminParticipantType(tLObject2);
        if (channelAdminParticipantType > channelAdminParticipantType2) {
            return 1;
        ...
        if (tLObject instanceof TLRPC.ChannelParticipant) {
            ...
            if (!(tLObject instanceof TLRPC.ChatParticipant)) {
                ...
                if (this.type == 2) {
                    ...
                    ItemOptions itemOptionsAddIf = ItemOptions.makeOptions(this, view).setScrimViewBackground(this.listView.getClipBackground(view)).addIf(z7, C2702R.drawable.msg_admins, LocaleController.getString(z5 ? C2702R.string.EditAdminRights : C2702R.string.SetAsAdmin), new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda14
                        @Override // java.lang.Runnable
                        public final void run() {
                            callback.run(0);
                        }
                    }).addIf(z9, C2702R.drawable.msg_permissions, LocaleController.getString("ChangePermissions", C2702R.string.ChangePermissions), new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda15
                        @Override // java.lang.Runnable
                        public final void run() {
                    ...
                    int i5 = C2702R.drawable.msg_remove;
                    if (this.isChannel) {
                        str4 = "ChannelRemoveUser";
                        i3 = C2702R.string.ChannelRemoveUser;
                    } else {
                        str4 = "KickFromGroup";
                        i3 = C2702R.string.KickFromGroup;
                    }
                ...
                if (this.type == 3 && ChatObject.canBlockUsers(this.currentChat)) {
                    itemOptionsMakeOptions.add(C2702R.drawable.msg_permissions, LocaleController.getString("ChannelEditPermissions", C2702R.string.ChannelEditPermissions), new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda17
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$createMenuForParticipant$14(j2, tL_chatBannedRights, str, tLObject);
                        }
                    });
                    itemOptionsMakeOptions.add(C2702R.drawable.msg_delete, (CharSequence) LocaleController.getString("ChannelDeleteFromList", C2702R.string.ChannelDeleteFromList), true, new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda18
                        @Override // java.lang.Runnable
                        public final void run() {
                    ...
                    if (ChatObject.canAddUsers(this.currentChat) && j2 > j) {
                        int i6 = C2702R.drawable.msg_contact_add;
                        if (this.isChannel) {
                            str3 = "ChannelAddToChannel";
                            i2 = C2702R.string.ChannelAddToChannel;
                        } else {
                            str3 = "ChannelAddToGroup";
                            i2 = C2702R.string.ChannelAddToGroup;
                        }
                    ...
                    itemOptionsMakeOptions.add(C2702R.drawable.msg_delete, (CharSequence) LocaleController.getString("ChannelDeleteFromList", C2702R.string.ChannelDeleteFromList), true, new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda20
                        @Override // java.lang.Runnable
                        public final void run() {
                    ...
                    if (this.currentChat.creator || !(tLObject instanceof TLRPC.TL_channelParticipantCreator)) {
                        itemOptionsMakeOptions.add(C2702R.drawable.msg_admins, LocaleController.getString("EditAdminRights", C2702R.string.EditAdminRights), new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda21
                            @Override // java.lang.Runnable
                            public final void run() {
                    ...
                    itemOptionsMakeOptions.add(C2702R.drawable.msg_remove, (CharSequence) LocaleController.getString("ChannelRemoveUserAdmin", C2702R.string.ChannelRemoveUserAdmin), true, new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda22
                        @Override // java.lang.Runnable
                        public final void run() {
    ...
    public /* synthetic */ void lambda$createMenuForParticipant$12(TLObject tLObject, TLRPC.User user, final Utilities.Callback callback) {
        if ((tLObject instanceof TLRPC.TL_channelParticipantAdmin) || (tLObject instanceof TLRPC.TL_chatParticipantAdmin)) {
            showDialog(new AlertDialog.Builder(getParentActivity()).setTitle(LocaleController.getString("AppName", C2702R.string.AppName)).setMessage(LocaleController.formatString(C2702R.string.AdminWillBeRemoved, UserObject.getUserName(user))).setPositiveButton(LocaleController.getString("OK", C2702R.string.f1556OK), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda24
    ...
    public /* synthetic */ void lambda$deletePeer$20(TLRPC.Updates updates) {
        getMessagesController().loadFullChat(updates.chats.get(0).f1610id, 0, true);
    }
    ...
    public boolean checkDiscard(boolean z) {
        ...
        if (z) {
            ...
            builder.setPositiveButton(LocaleController.getString("ApplyTheme", C2702R.string.ApplyTheme), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda4
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i) {
                    this.f$0.lambda$checkDiscard$23(alertDialog, i);
                }
            });
            builder.setNegativeButton(LocaleController.getString("PassportDiscard", C2702R.string.PassportDiscard), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda5
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i) {
    ...
    public String formatUserPermissions(TLRPC.TL_chatBannedRights tL_chatBannedRights) {
        ...
        if (z && this.defaultBannedRights.view_messages != z) {
            sb.append(LocaleController.getString("UserRestrictionsNoRead", C2702R.string.UserRestrictionsNoRead));
        }
        if (tL_chatBannedRights.send_messages && this.defaultBannedRights.send_plain != tL_chatBannedRights.send_plain) {
            if (sb.length() != 0) {
                sb.append(", ");
            }
            sb.append(LocaleController.getString("UserRestrictionsNoSendText", C2702R.string.UserRestrictionsNoSendText));
        }
        boolean z2 = tL_chatBannedRights.send_media;
        if (z2 && this.defaultBannedRights.send_media != z2) {
            ...
            sb.append(LocaleController.getString("UserRestrictionsNoSendMedia", C2702R.string.UserRestrictionsNoSendMedia));
        } else {
            boolean z3 = tL_chatBannedRights.send_photos;
            if (z3 && this.defaultBannedRights.send_photos != z3) {
                ...
                sb.append(LocaleController.getString("UserRestrictionsNoSendPhotos", C2702R.string.UserRestrictionsNoSendPhotos));
            }
            boolean z4 = tL_chatBannedRights.send_videos;
            if (z4 && this.defaultBannedRights.send_videos != z4) {
                ...
                sb.append(LocaleController.getString("UserRestrictionsNoSendVideos", C2702R.string.UserRestrictionsNoSendVideos));
            }
            ...
            if (z5 && this.defaultBannedRights.send_audios != z5) {
                ...
                sb.append(LocaleController.getString("UserRestrictionsNoSendMusic", C2702R.string.UserRestrictionsNoSendMusic));
            }
            ...
            if (z6 && this.defaultBannedRights.send_docs != z6) {
                ...
                sb.append(LocaleController.getString("UserRestrictionsNoSendDocs", C2702R.string.UserRestrictionsNoSendDocs));
            }
            boolean z7 = tL_chatBannedRights.send_voices;
            if (z7 && this.defaultBannedRights.send_voices != z7) {
                ...
                sb.append(LocaleController.getString("UserRestrictionsNoSendVoice", C2702R.string.UserRestrictionsNoSendVoice));
            }
            ...
            if (z8 && this.defaultBannedRights.send_roundvideos != z8) {
                ...
                sb.append(LocaleController.getString("UserRestrictionsNoSendRound", C2702R.string.UserRestrictionsNoSendRound));
            }
        }
        ...
        if (z9 && this.defaultBannedRights.send_stickers != z9) {
            ...
            sb.append(LocaleController.getString("UserRestrictionsNoSendStickers", C2702R.string.UserRestrictionsNoSendStickers));
        }
        ...
        if (z10 && this.defaultBannedRights.send_polls != z10) {
            ...
            sb.append(LocaleController.getString("UserRestrictionsNoSendPolls", C2702R.string.UserRestrictionsNoSendPolls));
        }
        ...
        if (z11 && !tL_chatBannedRights.send_plain && this.defaultBannedRights.embed_links != z11) {
            ...
            sb.append(LocaleController.getString("UserRestrictionsNoEmbedLinks", C2702R.string.UserRestrictionsNoEmbedLinks));
        }
        ...
        if (z12 && this.defaultBannedRights.invite_users != z12) {
            ...
            sb.append(LocaleController.getString("UserRestrictionsNoInviteUsers", C2702R.string.UserRestrictionsNoInviteUsers));
        }
        ...
        if (z13 && this.defaultBannedRights.pin_messages != z13) {
            ...
            sb.append(LocaleController.getString("UserRestrictionsNoPinMessages", C2702R.string.UserRestrictionsNoPinMessages));
        }
        ...
        if (z14 && this.defaultBannedRights.change_info != z14) {
            ...
            sb.append(LocaleController.getString("UserRestrictionsNoChangeInfo", C2702R.string.UserRestrictionsNoChangeInfo));
        }
        if (sb.length() != 0) {
    ...
    */
    public void processDone() {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.ChatUsersActivity.processDone():void");
    }
    ...
    private ArrayList loadChatParticipantsRequests(int i, int i2, boolean z) {
        ...
        tL_channels_getParticipants.filter.f1609q = _UrlKt.FRAGMENT_ENCODE_SET;
            ...
            getConnectionsManager().bindRequestToGuid(getConnectionsManager().sendRequest((TLObject) arrayListLoadChatParticipantsRequests.get(i5), new RequestDelegate() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda3
                ...
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ChatUsersActivity$$ExternalSyntheticLambda9
                        @Override // java.lang.Runnable
                        public final void run() {
                            ChatUsersActivity.m7607$r8$lambda$S7_OG1_C2T6hXc8Jg7kQwNGsa0(tL_error, tLObject, arrayList, i, atomicInteger, arrayList, runnable);
                        }
                    });
                }
            }), this.classGuid);
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public /* synthetic */ void lambda$loadChatParticipants$28(java.util.ArrayList r18, java.util.ArrayList r19) {
        /*
            Method dump skipped, instruction units count: 470
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.ChatUsersActivity.lambda$loadChatParticipants$28(java.util.ArrayList, java.util.ArrayList):void");
    }

    /* JADX INFO: renamed from: $r8$lambda$S-7_OG1_C2T6hXc8Jg7kQwNGsa0, reason: not valid java name */
    public static /* synthetic */ void m7607$r8$lambda$S7_OG1_C2T6hXc8Jg7kQwNGsa0(TLRPC.TL_error tL_error, TLObject tLObject, ArrayList arrayList, int i, AtomicInteger atomicInteger, ArrayList arrayList2, Runnable runnable) {
        ...
        */
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType != 0) {
                ...
                if (i == this.groupStartRow) {
                    if (ChatUsersActivity.this.type == 0) {
                        graySectionCell.setText(LocaleController.getString(C2702R.string.ChannelBlockedUsers));
                        return;
                    }
                    if (ChatUsersActivity.this.type == 3) {
                        graySectionCell.setText(LocaleController.getString(C2702R.string.ChannelRestrictedUsers));
                        return;
                    } else if (ChatUsersActivity.this.isChannel) {
                        graySectionCell.setText(LocaleController.getString(C2702R.string.ChannelSubscribers));
                        return;
                    } else {
                        graySectionCell.setText(LocaleController.getString(C2702R.string.ChannelMembers));
                        return;
                    }
                }
                if (i == this.globalStartRow) {
                    graySectionCell.setText(LocaleController.getString(C2702R.string.GlobalSearch));
                    return;
                } else {
                    if (i == this.contactsStartRow) {
                        graySectionCell.setText(LocaleController.getString(C2702R.string.Contacts));
                        return;
                    }
                    return;
                }
            ...
            if (z || (size = this.searchResult.size()) == 0) {
                ...
                int i3 = size + 1;
                if (i3 > i) {
                    CharSequence charSequence3 = (CharSequence) this.searchResultNames.get(i - 1);
    ...
    class ListAdapter extends RecyclerListView.SelectionAdapter {
            ...
            switch (i) {
                ...
                case 4:
                    ...
                    if (ChatUsersActivity.this.isChannel) {
                        textInfoPrivacyCell2.setText(LocaleController.getString(C2702R.string.NoBlockedChannel2));
                        textInfoPrivacyCell = textInfoPrivacyCell2;
                    } else {
                        textInfoPrivacyCell2.setText(LocaleController.getString(C2702R.string.NoBlockedGroup2));
                        textInfoPrivacyCell = textInfoPrivacyCell2;
                    }
                    break;
                case 5:
                ...
                default:
                    ...
                    slideChooseView.setOptions(ChatUsersActivity.this.selectedSlowmode, LocaleController.getString("SlowmodeOff", C2702R.string.SlowmodeOff), LocaleController.formatString(C2702R.string.SlowmodeSeconds, 5), LocaleController.formatString(C2702R.string.SlowmodeSeconds, 10), LocaleController.formatString(C2702R.string.SlowmodeSeconds, 30), LocaleController.formatString(C2702R.string.SlowmodeMinutes, 1), LocaleController.formatString(C2702R.string.SlowmodeMinutes, 5), LocaleController.formatString(C2702R.string.SlowmodeMinutes, 15), LocaleController.formatString(C2702R.string.SlowmodeHours, 1));
                    ...
                    break;
                case 10:
                    textInfoPrivacyCell = new LoadingCell(this.mContext, AndroidUtilities.m1081dp(40.0f), AndroidUtilities.m1081dp(120.0f));
                    break;
                case 11:
                    ...
                    flickerLoadingView.setPaddingLeft(AndroidUtilities.m1081dp(5.0f));
                ...
                case 15:
                    ...
                    slideChooseView2.setOptions(ChatUsersActivity.this.notRestrictBoosters > 0 ? ChatUsersActivity.this.notRestrictBoosters - 1 : 0, new Drawable[]{ContextCompat.getDrawable(ChatUsersActivity.this.getContext(), C2702R.drawable.mini_boost_profile_badge), ContextCompat.getDrawable(ChatUsersActivity.this.getContext(), C2702R.drawable.mini_boost_profile_badge2), ContextCompat.getDrawable(ChatUsersActivity.this.getContext(), C2702R.drawable.mini_boost_profile_badge2), ContextCompat.getDrawable(ChatUsersActivity.this.getContext(), C2702R.drawable.mini_boost_profile_badge2), ContextCompat.getDrawable(ChatUsersActivity.this.getContext(), C2702R.drawable.mini_boost_profile_badge2)}, "1", "2", "3", "4", "5");
        ...
        /* JADX WARN: Multi-variable type inference failed */
        /* JADX WARN: Removed duplicated region for block: B:449:0x0ad8 A[PHI: r4
  0x0ad8: PHI (r4v44 int) = (r4v10 int), (r4v48 int) binds: [B:457:0x0b04, B:448:0x0ad6] A[DONT_GENERATE, DONT_INLINE]] */
        /* JADX WARN: Removed duplicated region for block: B:510:0x0c27  */
