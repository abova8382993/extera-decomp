...
import org.telegram.p026ui.ProxyListActivity;
...
public class ProxyListActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public class TextDetailProxyCell extends FrameLayout {
        ...
        public TextDetailProxyCell(Context context) {
            ...
            this.valueTextView.setCompoundDrawablePadding(AndroidUtilities.m1081dp(6.0f));
            ...
            imageView.setImageResource(C2702R.drawable.msg_info);
            ...
            this.checkImageView.setContentDescription(LocaleController.getString(C2702R.string.Edit));
            ...
            if (SharedConfig.currentProxy == this.currentInfo && ProxyListActivity.this.useProxySettings) {
                if (ProxyListActivity.this.currentConnectionState == 3 || ProxyListActivity.this.currentConnectionState == 5) {
                    ...
                    if (this.currentInfo.ping != 0) {
                        this.valueTextView.setText(LocaleController.getString(C2702R.string.Connected) + ", " + LocaleController.formatString("Ping", C2702R.string.Ping, Long.valueOf(this.currentInfo.ping)));
                    } else {
                        this.valueTextView.setText(LocaleController.getString(C2702R.string.Connected));
                    }
                    ...
                    this.valueTextView.setText(LocaleController.getString(C2702R.string.Connecting));
                }
            } else {
                SharedConfig.ProxyInfo proxyInfo2 = this.currentInfo;
                if (proxyInfo2.checking) {
                    this.valueTextView.setText(LocaleController.getString(C2702R.string.Checking));
                    i = Theme.key_windowBackgroundWhiteGrayText2;
                } else if (proxyInfo2.available) {
                    if (proxyInfo2.ping != 0) {
                        this.valueTextView.setText(LocaleController.getString(C2702R.string.Available) + ", " + LocaleController.formatString("Ping", C2702R.string.Ping, Long.valueOf(this.currentInfo.ping)));
                    } else {
                        this.valueTextView.setText(LocaleController.getString(C2702R.string.Available));
                    }
                    i = Theme.key_windowBackgroundWhiteGreenText;
                } else {
                    this.valueTextView.setText(LocaleController.getString(C2702R.string.Unavailable));
        ...
        public void setSelectionEnabled(final boolean z, boolean z2) {
            ...
            final float fM1081dp = LocaleController.isRTL ? -AndroidUtilities.m1081dp(32.0f) : AndroidUtilities.m1081dp(32.0f);
            final float f = 0.0f;
            if (!z2) {
                if (!z) {
                    fM1081dp = 0.0f;
                }
                this.textView.setTranslationX(fM1081dp);
                this.valueTextView.setTranslationX(fM1081dp);
                this.checkImageView.setTranslationX(fM1081dp);
                ...
                checkBox2.setTranslationX(iM1081dp + fM1081dp);
            ...
            duration.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.ProxyListActivity$TextDetailProxyCell$$ExternalSyntheticLambda1
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    this.f$0.lambda$setSelectionEnabled$1(f, fM1081dp, valueAnimator);
                }
            });
        ...
        public /* synthetic */ void lambda$setSelectionEnabled$1(float f, float f2, ValueAnimator valueAnimator) {
            ...
            this.checkBox.setTranslationX((LocaleController.isRTL ? AndroidUtilities.m1081dp(32.0f) : -AndroidUtilities.m1081dp(32.0f)) + fLerp);
        ...
        public void setChecked(boolean z) {
            if (z) {
                if (this.checkDrawable == null) {
                    this.checkDrawable = getResources().getDrawable(C2702R.drawable.proxy_check).mutate();
                }
                Drawable drawable = this.checkDrawable;
                if (drawable != null) {
                    drawable.setColorFilter(new PorterDuffColorFilter(this.color, PorterDuff.Mode.MULTIPLY));
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2702R.string.ProxySettings));
        ...
        this.shareMenuItem = actionBarMenuCreateActionMode.addItemWithWidth(1, C2702R.drawable.msg_share, AndroidUtilities.m1081dp(54.0f));
        this.deleteMenuItem = actionBarMenuCreateActionMode.addItemWithWidth(0, C2702R.drawable.msg_delete, AndroidUtilities.m1081dp(54.0f));
        this.actionBar.setActionBarMenuOnItemClick(new C63222(context));
    ...
    public /* synthetic */ void lambda$createView$1(View view, int i) {
        ...
        if (i == this.deleteAllRow) {
            ...
            builder.setMessage(LocaleController.getString(C2702R.string.DeleteAllProxiesConfirm));
            builder.setNegativeButton(LocaleController.getString(C2702R.string.Cancel), null);
            builder.setTitle(LocaleController.getString(C2702R.string.DeleteProxyTitle));
            builder.setPositiveButton(LocaleController.getString(C2702R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ProxyListActivity$$ExternalSyntheticLambda6
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C63222 extends ActionBar.ActionBarMenuOnItemClick {
        final /* synthetic */ Context val$context;

        C63222(Context context) {
        ...
        public void onItemClick(int i) {
            ...
            if (i == 0) {
                ...
                builder.setMessage(LocaleController.getString(ProxyListActivity.this.selectedItems.size() > 1 ? C2702R.string.DeleteProxyMultiConfirm : C2702R.string.DeleteProxyConfirm));
                builder.setNegativeButton(LocaleController.getString(C2702R.string.Cancel), null);
                builder.setTitle(LocaleController.getString(C2702R.string.DeleteProxyTitle));
                builder.setPositiveButton(LocaleController.getString(C2702R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ProxyListActivity$2$$ExternalSyntheticLambda0
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            ...
            Intent intentCreateChooser = Intent.createChooser(intent, LocaleController.getString(ProxyListActivity.this.selectedItems.size() > 1 ? C2702R.string.ShareLinks : C2702R.string.ShareLink));
                    ...
                    public final void run(long j) {
                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ProxyListActivity$$ExternalSyntheticLambda7
                            ...
                            public final void run() {
                                ProxyListActivity.m16900$r8$lambda$5pbN7GOeBsh_eBQYt4oGxgPw4(proxyInfo, j);
                            }
                        });
                    }
                });
    ...
    public static /* synthetic */ void m16900$r8$lambda$5pbN7GOeBsh_eBQYt4oGxgPw4(SharedConfig.ProxyInfo proxyInfo, long j) {
            ...
            switch (viewHolder.getItemViewType()) {
                case 1:
                    ...
                    if (i == ProxyListActivity.this.proxyAddRow) {
                        textSettingsCell.setText(LocaleController.getString(C2702R.string.AddProxy), ProxyListActivity.this.deleteAllRow != -1);
                    } else if (i == ProxyListActivity.this.deleteAllRow) {
                        textSettingsCell.setTextColor(Theme.getColor(Theme.key_text_RedRegular));
                        textSettingsCell.setText(LocaleController.getString(C2702R.string.DeleteAllProxies), false);
                    }
                    break;
                case 2:
                    HeaderCell headerCell = (HeaderCell) viewHolder.itemView;
                    if (i == ProxyListActivity.this.connectionsHeaderRow) {
                        headerCell.setText(LocaleController.getString(C2702R.string.ProxyConnections));
                    }
                    break;
                case 3:
                    TextCheckCell textCheckCell = (TextCheckCell) viewHolder.itemView;
                    if (i == ProxyListActivity.this.useProxyRow) {
                        textCheckCell.setTextAndCheck(LocaleController.getString(C2702R.string.UseProxySettings), ProxyListActivity.this.useProxySettings, ProxyListActivity.this.rotationRow != -1);
                    } else if (i == ProxyListActivity.this.callsRow) {
                        textCheckCell.setTextAndCheck(LocaleController.getString(C2702R.string.UseProxyForCalls), ProxyListActivity.this.useProxyForCalls, false);
                    } else if (i == ProxyListActivity.this.rotationRow) {
                        textCheckCell.setTextAndCheck(LocaleController.getString(C2702R.string.UseProxyRotation), SharedConfig.proxyRotationEnabled, true);
                    }
                    break;
                case 4:
                    TextInfoPrivacyCell textInfoPrivacyCell = (TextInfoPrivacyCell) viewHolder.itemView;
                    if (i == ProxyListActivity.this.callsDetailRow) {
                        textInfoPrivacyCell.setText(LocaleController.getString(C2702R.string.UseProxyForCallsInfo));
                    } else if (i == ProxyListActivity.this.rotationTimeoutInfoRow) {
                        textInfoPrivacyCell.setText(LocaleController.getString(C2702R.string.ProxyRotationTimeoutInfo));
                    }
                    break;
                case 5:
                ...
                case 6:
                    if (i == ProxyListActivity.this.rotationTimeoutRow) {
                        ...
                        for (int i2 = 0; i2 < arrayList.size(); i2++) {
                            strArr[i2] = LocaleController.formatString(C2702R.string.ProxyRotationTimeoutSeconds, arrayList.get(i2));
                        }
