...
public abstract class CastSync {
    ...
    public static void check(int i) {
        ...
        try {
            ...
            sharedInstance.getSessionManager().addSessionManagerListener(new SessionManagerListener() { // from class: org.telegram.ui.CastSync.1
                ...
                public void onSessionStarted(CastSession castSession, String str) {
                    ...
                    remoteMediaClient.registerCallback(new RemoteMediaClient.Callback() { // from class: org.telegram.ui.CastSync.1.1
                        ...
                        public void onStatusUpdated() {
                            FileLog.m1090d("onStatusUpdated");
                            CastSync.syncInterface();
                        }

                        @Override // com.google.android.gms.cast.framework.media.RemoteMediaClient.Callback
                        public void onMediaError(MediaError mediaError) {
                            FileLog.m1091e("Chromecast Media Error: " + mediaError);
                        }
                    });
                ...
                class AnonymousClass1 extends RemoteMediaClient.Callback {
                    AnonymousClass1() {
                    }
    ...
    class C31351 implements SessionManagerListener {
        final /* synthetic */ int val$type;
    ...
    public static void doSyncVolume(boolean z) {
        ...
        if ((contentObserver != null) != z) {
            ...
            C31362 c31362 = new ContentObserver(new Handler()) { // from class: org.telegram.ui.CastSync.2
                C31362(Handler handler) {
                    super(handler);
                }
            ...
            syncingVolume = c31362;
            contentResolver.registerContentObserver(uri, true, c31362);
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C31362 extends ContentObserver {
        C31362(Handler handler) {
            super(handler);
        }
