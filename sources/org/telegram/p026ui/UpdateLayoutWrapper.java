...
public class UpdateLayoutWrapper extends ViewGroup {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int iM1081dp = zIsUpdateLayoutVisible ? AndroidUtilities.m1081dp(44.0f) + getPaddingBottom() : 0;
        setMeasuredDimension(size, iM1081dp);
        int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30);
        int iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(iM1081dp, TLObject.FLAG_30);
