...
public class PremiumFeatureCell extends FrameLayout {
    ...
    public void setData(PremiumPreviewFragment.PremiumFeatureData premiumFeatureData, boolean z) {
        if (UserConfig.getInstance(UserConfig.selectedAccount).isPremium() && premiumFeatureData.type == 12 && premiumFeatureData.icon == C2702R.drawable.filled_premium_status2) {
    ...
    public void setEmoji(long j, boolean z) {
        ...
        if (j == 0) {
            if (this.premiumStar == null) {
                Drawable drawableMutate = getContext().getResources().getDrawable(C2702R.drawable.msg_premium_prolfilestar).mutate();
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (this.drawDivider) {
            canvas.drawRect(AndroidUtilities.m1081dp(62.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight(), Theme.dividerPaint);
        }
    }
