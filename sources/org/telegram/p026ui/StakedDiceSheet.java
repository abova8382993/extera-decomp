...
public class StakedDiceSheet extends BottomSheetWithRecyclerListView {
    ...
    public StakedDiceSheet(final Context context, final int i, final Theme.ResourcesProvider resourcesProvider, final Utilities.Callback callback) {
        ...
        this.topView.setPadding(AndroidUtilities.m1081dp(16.0f), AndroidUtilities.m1081dp(20.0f), AndroidUtilities.m1081dp(16.0f), AndroidUtilities.m1081dp(4.0f));
        this.topView.setClipChildren(false);
        this.topView.setClipToPadding(false);
        ImageView imageView = new ImageView(context);
        imageView.setImageResource(C2702R.drawable.dice6);
        ...
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(LocaleController.getString(C2702R.string.StakeDiceTitle));
        spannableStringBuilder.append((CharSequence) " ");
        int length = spannableStringBuilder.length();
        spannableStringBuilder.append((CharSequence) LocaleController.getString(C2702R.string.StakeDiceTitleBeta));
        spannableStringBuilder.setSpan(new ReplacementSpan() { // from class: org.telegram.ui.StakedDiceSheet.1
            final Text text = new Text(LocaleController.getString(C2702R.string.StakeDiceTitleBeta), 12.0f, AndroidUtilities.bold());
            final Paint bgPaint = new Paint(1);

            @Override // android.text.style.ReplacementSpan
            public int getSize(Paint paint, CharSequence charSequence, int i3, int i4, Paint.FontMetricsInt fontMetricsInt) {
                return (int) (AndroidUtilities.m1081dp(16.0f) + this.text.getCurrentWidth());
            }

            @Override // android.text.style.ReplacementSpan
            public void draw(Canvas canvas, CharSequence charSequence, int i3, int i4, float f, int i5, int i6, int i7, Paint paint) {
                float fM1081dp = ((i5 + i7) / 2.0f) + AndroidUtilities.m1081dp(1.0f);
                this.bgPaint.setColor(Theme.getColor(Theme.key_featuredStickers_addButton, resourcesProvider));
                RectF rectF = AndroidUtilities.rectTmp;
                rectF.set(f, fM1081dp - AndroidUtilities.m1081dp(9.0f), AndroidUtilities.m1081dp(16.0f) + f + this.text.getCurrentWidth(), AndroidUtilities.m1081dp(9.0f) + fM1081dp);
                canvas.drawRoundRect(rectF, AndroidUtilities.m1081dp(9.0f), AndroidUtilities.m1081dp(9.0f), this.bgPaint);
                this.text.draw(canvas, f + AndroidUtilities.m1081dp(8.0f), fM1081dp, -1, 1.0f);
            }
        ...
        textViewMakeTextView2.setText(LocaleController.getString(C2702R.string.StakeDiceText));
        ...
        textViewMakeTextView3.setText(LocaleController.getString(C2702R.string.StakeDiceReturns));
        ...
        int i3 = C2702R.drawable.dice1;
        int i4 = C2702R.drawable.dice2;
        int i5 = C2702R.drawable.dice3;
        int i6 = C2702R.drawable.dice4;
        int i7 = C2702R.drawable.dice5;
        int i8 = C2702R.drawable.dice6;
        ...
        Utilities.Callback2Return callback2Return = new Utilities.Callback2Return() { // from class: org.telegram.ui.StakedDiceSheet$$ExternalSyntheticLambda4
            ...
            public final Object run(Object obj, Object obj2) {
                return StakedDiceSheet.m17382$r8$lambda$Avzvs7HEBCdkCHlzfUQfHJlva8(context, iArr, resourcesProvider, tableView, (Integer) obj, (Float) obj2);
            }
        };
        float f = 1.0f;
        ...
        ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C2702R.drawable.dice6);
        ...
        textViewMakeTextView4.setText(AndroidUtilities.replaceMultipleCharSequence("🎲", LocaleController.getString(C2702R.string.StakeDiceReturnsInfo), spannableStringBuilder2));
        ...
        this.editView.setPadding(AndroidUtilities.m1081dp(42.0f), AndroidUtilities.m1081dp(0.0f), AndroidUtilities.m1081dp(42.0f), AndroidUtilities.m1081dp(7.0f));
        ...
        outlineTextContainerView.setText(LocaleController.getString(C2702R.string.StakeDicePlaceholder));
        ...
        imageView2.setImageResource(C2702R.drawable.diamond);
        linearLayout4.addView(imageView2, LayoutHelper.createLinear(-2, -2, 0.0f, 19, 14, 0, 0, 0));
        linearLayout4.addView(editTextBoldCursor, LayoutHelper.createLinear(-1, -2, 1.0f, Opcodes.DNEG));
        ...
        Utilities.CallbackReturn callbackReturn = new Utilities.CallbackReturn() { // from class: org.telegram.ui.StakedDiceSheet$$ExternalSyntheticLambda6
            ...
            public final Object run(Object obj) {
                return StakedDiceSheet.m17383$r8$lambda$U3QzNjIEL4Nod70FOH84Lt4RXk(context, resourcesProvider, editTextBoldCursor, (Long) obj);
            }
        };
        ...
        while (true) {
            ...
            if (i9 < Utilities.divCeil(jArr.length, 3)) {
                ...
                ColoredImageSpan coloredImageSpan2 = new ColoredImageSpan(C2702R.drawable.mini_roll);
                coloredImageSpan2.setTranslateY(AndroidUtilities.m1081dp(f3));
                spannableStringBuilder3.setSpan(coloredImageSpan2, 0, spannableStringBuilder3.length(), 33);
                spannableStringBuilder3.append((CharSequence) "  ").append((CharSequence) LocaleController.getString(C2702R.string.StakeDiceButton));
                ...
                recyclerListView.setPadding(i14, 0, i14, AndroidUtilities.m1081dp(68.0f));
    ...
    public static /* synthetic */ TableView.TableRowContent m17382$r8$lambda$Avzvs7HEBCdkCHlzfUQfHJlva8(Context context, int[] iArr, Theme.ResourcesProvider resourcesProvider, TableView tableView, Integer num, Float f) {
        LinearLayout linearLayout = new LinearLayout(context);
        linearLayout.setOrientation(1);
        LinearLayout linearLayout2 = new LinearLayout(context);
    ...
    public static /* synthetic */ View m17383$r8$lambda$U3QzNjIEL4Nod70FOH84Lt4RXk(Context context, Theme.ResourcesProvider resourcesProvider, final EditTextBoldCursor editTextBoldCursor, final Long l) {
        TextView textView = new TextView(context);
        textView.setGravity(17);
        textView.setTextSize(1, 13.0f);
        ...
        textView.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1081dp(13.0f), Theme.multAlpha(Theme.getColor(i, resourcesProvider), 0.15f)));
    ...
    protected CharSequence getTitle() {
        return LocaleController.getString(C2702R.string.StakeDiceTitle);
    }
    ...
    public static void showStakeToast(BaseFragment baseFragment, int i, long j, final Utilities.Callback callback) {
        ...
        if (emojiGameInfo instanceof TLRPC.TL_emojiGameDiceInfo) {
            ...
            if (i == 1) {
                lottieLayout.imageView.setImageResource(C2702R.drawable.dice1);
            } else if (i == 2) {
                lottieLayout.imageView.setImageResource(C2702R.drawable.dice2);
            } else if (i == 3) {
                lottieLayout.imageView.setImageResource(C2702R.drawable.dice3);
            } else if (i == 4) {
                lottieLayout.imageView.setImageResource(C2702R.drawable.dice4);
            } else if (i == 5) {
                lottieLayout.imageView.setImageResource(C2702R.drawable.dice5);
            } else if (i == 6) {
                lottieLayout.imageView.setImageResource(C2702R.drawable.dice6);
            } else {
            ...
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(LocaleController.getString(C2702R.string.StakeDiceToast));
            ...
            lottieLayout.textView.setPadding(0, AndroidUtilities.m1081dp(8.0f), 0, AndroidUtilities.m1081dp(8.0f));
            ...
            lottieLayout.setButton(new Bulletin.UndoButton(safeLastFragment.getContext(), true, safeLastFragment.getResourceProvider()).setText(LocaleController.getString(C2702R.string.StakeDiceToastButton)).setUndoAction(new Runnable() { // from class: org.telegram.ui.StakedDiceSheet$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    callback.run(Long.valueOf(j2));
                }
            }));
            BulletinFactory.m1195of(safeLastFragment).create(lottieLayout, 2750).show();
        }
    }
}
