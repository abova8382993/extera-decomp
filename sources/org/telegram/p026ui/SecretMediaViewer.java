...
import org.telegram.p026ui.Components.TimerParticles;
import org.telegram.p026ui.Components.TranslateAlert2;
import org.telegram.p026ui.Components.VideoPlayer;
import org.telegram.p026ui.Components.VideoPlayerSeekBar;
...
public class SecretMediaViewer implements NotificationCenter.NotificationCenterDelegate, GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    ...
    private class SecretDeleteTimer extends FrameLayout {
        ...
        public SecretDeleteTimer(Context context) {
            ...
            paint.setStrokeWidth(AndroidUtilities.m1081dp(1.5f));
            ...
            this.afterDeleteProgressPaint.setStrokeWidth(AndroidUtilities.m1081dp(2.0f));
            Paint paint5 = new Paint(1);
            this.circlePaint = paint5;
            paint5.setColor(2130706432);
            RLottieDrawable rLottieDrawable = new RLottieDrawable(C2702R.raw.fire_on, _UrlKt.FRAGMENT_ENCODE_SET + C2702R.raw.fire_on, AndroidUtilities.m1081dp(16.0f), AndroidUtilities.m1081dp(16.0f));
        ...
        public void setOnce() {
            this.once = true;
            this.oncePaint.setTextSize(AndroidUtilities.m1081dp(13.0f));
        ...
        protected void onMeasure(int i, int i2) {
            ...
            float measuredWidth = getMeasuredWidth() - AndroidUtilities.m1081dp(35.0f);
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (i == NotificationCenter.updateMessageMedia) {
            if (this.currentMessageObject.getId() == ((TLRPC.Message) objArr[0]).f1636id) {
                if (this.isVideo && !this.videoWatchedOneTime) {
                    this.closeVideoAfterWatch = true;
                } else {
                    if (closePhoto(true, true)) {
    ...
    public void preparePlayer(File file) {
        ...
        if (this.videoPlayer == null) {
            C63641 c63641 = new VideoPlayer() { // from class: org.telegram.ui.SecretMediaViewer.1
                C63641() {
                }

                @Override // org.telegram.p026ui.Components.VideoPlayer
            ...
            this.videoPlayer = c63641;
            c63641.setTextureView(this.videoTextureView);
            this.videoPlayer.setDelegate(new C63752(file));
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C63641 extends VideoPlayer {
        C63641() {
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C63752 implements VideoPlayer.VideoPlayerDelegate {
    ...
    public void setParentActivity(final Activity activity) {
        ...
        C63773 c63773 = new FrameLayout(activity) { // from class: org.telegram.ui.SecretMediaViewer.3
            C63773(final Context activity2) {
                super(activity2);
            }
        ...
        this.windowView = c63773;
        c63773.setBackgroundDrawable(this.photoBackgroundDrawable);
        ...
        this.containerView = new FrameLayoutDrawer(activity2) { // from class: org.telegram.ui.SecretMediaViewer.4
            C63784(final Context activity2) {
                super(activity2);
            }
            ...
            protected void onLayout(boolean z, int i2, int i3, int i4, int i5) {
                ...
                if (SecretMediaViewer.this.secretHint != null && SecretMediaViewer.this.secretDeleteTimer != null) {
                    int currentActionBarHeight2 = ((((ActionBar.getCurrentActionBarHeight() - SecretMediaViewer.this.secretDeleteTimer.getMeasuredHeight()) / 2) + AndroidUtilities.statusBarHeight) + SecretMediaViewer.this.secretDeleteTimer.getMeasuredHeight()) - AndroidUtilities.m1081dp(10.0f);
        ...
        C63795 c63795 = new ActionBar(activity2) { // from class: org.telegram.ui.SecretMediaViewer.5
            C63795(final Context activity2) {
                super(activity2);
            }
        ...
        this.actionBar = c63795;
        c63795.setTitleColor(-1);
        ...
        this.actionBar.setTitleRightMargin(AndroidUtilities.m1081dp(70.0f));
        ...
        this.secretHint.setPadding(AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(8.0f));
        ...
        C63817 c63817 = new VideoPlayerSeekBar.SeekBarDelegate() { // from class: org.telegram.ui.SecretMediaViewer.7
            C63817() {
            }
        ...
        C63828 c63828 = new View(activity2) { // from class: org.telegram.ui.SecretMediaViewer.8
            C63828(final Context activity2) {
                super(activity2);
            }
        ...
        this.seekbarView = c63828;
        VideoPlayerSeekBar videoPlayerSeekBar = new VideoPlayerSeekBar(c63828);
        this.seekbar = videoPlayerSeekBar;
        videoPlayerSeekBar.setHorizontalPadding(AndroidUtilities.m1081dp(2.0f));
        this.seekbar.setColors(872415231, 872415231, -1, -1, -1, 1509949439);
        this.seekbar.setDelegate(c63817);
        ...
        C63839 c63839 = new TextSelectionHelper.SimpleTextSelectionHelper(null, new DarkThemeResourceProvider()) { // from class: org.telegram.ui.SecretMediaViewer.9
            @Override // org.telegram.p026ui.Cells.TextSelectionHelper
            public int getParentBottomPadding() {
                return 0;
            }

            C63839(TextSelectionHelper.SimpleSelectabeleView simpleSelectabeleView, Theme.ResourcesProvider resourcesProvider) {
                super(simpleSelectabeleView, resourcesProvider);
            }
        };
        this.textSelectionHelper = c63839;
        c63839.allowScrollPrentRelative = true;
        c63839.useMovingOffset = false;
        ...
        imageView.setBackground(Theme.createCircleDrawable(AndroidUtilities.m1081dp(64.0f), 1711276032));
        ...
        this.playButton.setPivotX(AndroidUtilities.m1081dp(32.0f));
        this.playButton.setPivotY(AndroidUtilities.m1081dp(32.0f));
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C63773 extends FrameLayout {
        C63773(final Activity activity2) {
            super(activity2);
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C63784 extends FrameLayoutDrawer {
        C63784(final Activity activity2) {
            super(activity2);
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C63795 extends ActionBar {
        C63795(final Activity activity2) {
            super(activity2);
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C63806 extends ActionBar.ActionBarMenuOnItemClick {
        C63806() {
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C63817 implements VideoPlayerSeekBar.SeekBarDelegate {
        C63817() {
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C63828 extends View {
        C63828(final Activity activity2) {
            super(activity2);
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C63839 extends TextSelectionHelper.SimpleTextSelectionHelper {
        @Override // org.telegram.p026ui.Cells.TextSelectionHelper
        public int getParentBottomPadding() {
            return 0;
        }
    ...
    private void setCurrentCaption(MessageObject messageObject, CharSequence charSequence, boolean z, boolean z2) {
        ...
        if (this.captionScrollView == null) {
            ...
            C636510 c636510 = new PhotoViewer.CaptionScrollView(this.containerView.getContext(), this.captionTextViewSwitcher, this.captionContainer) { // from class: org.telegram.ui.SecretMediaViewer.10
                C636510(Context context, PhotoViewer.CaptionTextViewSwitcher captionTextViewSwitcher, FrameLayout frameLayout2) {
            ...
            this.captionScrollView = c636510;
            this.captionTextViewSwitcher.setScrollView(c636510);
        ...
        if (z2) {
            ...
            TransitionSet duration = new TransitionSet().addTransition(new C636712(2, zIsEmpty2, zIsEmpty)).addTransition(new C636611(1, zIsEmpty2, zIsEmpty)).setDuration(200L);
            if (!zIsEmpty2) {
                this.captionScrollView.dontChangeTopMargin = true;
                duration.addTransition(new C636813());
            }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C636510 extends PhotoViewer.CaptionScrollView {
        C636510(Context context, PhotoViewer.CaptionTextViewSwitcher captionTextViewSwitcher, FrameLayout frameLayout2) {
            super(context, captionTextViewSwitcher, frameLayout2);
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C636611 extends Fade {
        final /* synthetic */ boolean val$isCaptionEmpty;
        final /* synthetic */ boolean val$isCurrentCaptionEmpty;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C636611(int i, boolean z, boolean z2) {
            super(i);
            this.val$isCurrentCaptionEmpty = z;
            this.val$isCaptionEmpty = z2;
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C636813 extends Transition {
        C636813() {
        }
    ...
    private void showSecretHint() {
        ...
        String string = LocaleController.getString(this.isVideo ? C2702R.string.VideoShownOnce : C2702R.string.PhotoShownOnce);
        ...
        this.secretHint.setIcon(C2702R.raw.fire_on);
        ...
        if (document != null) {
            ...
            while (true) {
                ...
                if (documentAttribute instanceof TLRPC.TL_documentAttributeVideo) {
                    ...
                    this.videoWidth = tL_documentAttributeVideo.f1621w;
                    this.videoHeight = tL_documentAttributeVideo.f1620h;
                    break;
                }
                i2++;
            }
            if (MessageObject.isGifDocument(document)) {
                this.actionBar.setTitle(LocaleController.getString(C2702R.string.DisappearingGif));
                ...
                this.actionBar.setTitle(LocaleController.getString(C2702R.string.DisappearingVideo));
            ...
            f2 = 1.0f;
            Object obj = null;
            this.actionBar.setTitle(LocaleController.getString(C2702R.string.DisappearingPhoto));
            ...
            if (closestPhotoSizeWithSize != null) {
                this.videoWidth = closestPhotoSizeWithSize.f1644w;
                this.videoHeight = closestPhotoSizeWithSize.f1643h;
                r14 = obj;
            }
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C636914 extends AnimatorListenerAdapter {
        C636914() {
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C637015 extends AnimatorListenerAdapter {
        C637015() {
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:465:0x0224  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void onDraw(android.graphics.Canvas r23) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.SecretMediaViewer.onDraw(android.graphics.Canvas):void");
    }

    /* JADX INFO: renamed from: org.telegram.ui.SecretMediaViewer$16 */
    class C637116 extends AnimationProperties.FloatProperty {
        C637116(String str) {
            super(str);
        }
    ...
    */
    public boolean closePhoto(boolean r26, boolean r27) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.SecretMediaViewer.closePhoto(boolean, boolean):boolean");
    }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C637217 extends AnimatorListenerAdapter {
        final /* synthetic */ PhotoViewer.PlaceProviderObject val$object;

        C637217(PhotoViewer.PlaceProviderObject placeProviderObject) {
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C637318 extends AnimatorListenerAdapter {
        C637318() {
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:593:0x01c1  */
    /* JADX WARN: Removed duplicated region for block: B:598:0x01ce  */
    /* JADX WARN: Removed duplicated region for block: B:602:0x01db  */
    /* JADX WARN: Removed duplicated region for block: B:620:0x0261 A[PHI: r3
  0x0261: PHI (r3v31 float) = (r3v26 float), (r3v27 float) binds: [B:619:0x025f, B:622:0x0267] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:626:0x0270 A[PHI: r3
  0x0270: PHI (r3v30 float) = (r3v28 float), (r3v29 float) binds: [B:625:0x026e, B:628:0x0276] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:627:0x0272  */
    /* JADX WARN: Removed duplicated region for block: B:649:0x02d2 A[PHI: r3
  0x02d2: PHI (r3v8 float) = (r3v3 float), (r3v4 float) binds: [B:648:0x02d0, B:651:0x02d8] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:655:0x02e3 A[PHI: r3
  0x02e3: PHI (r3v7 float) = (r3v5 float), (r3v6 float) binds: [B:654:0x02e1, B:657:0x02e9] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:656:0x02e5  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public boolean processTouchEvent(android.view.MotionEvent r13) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.SecretMediaViewer.processTouchEvent(android.view.MotionEvent):boolean");
    }

    /* JADX WARN: Removed duplicated region for block: B:52:0x0011 A[PHI: r3
  0x0011: PHI (r3v5 float) = (r3v0 float), (r3v1 float) binds: [B:51:0x000f, B:54:0x0017] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:58:0x0022 A[PHI: r3
  0x0022: PHI (r3v4 float) = (r3v2 float), (r3v3 float) binds: [B:57:0x0020, B:60:0x0028] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void checkMinMax(boolean r6) {
        ...
        L2b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.SecretMediaViewer.checkMinMax(boolean):void");
    }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C637419 extends AnimatorListenerAdapter {
        C637419() {
        }
    ...
    class C637620 extends AnimationProperties.FloatProperty {
        C637620(String str) {
            super(str);
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:117:0x0077 A[PHI: r10
  0x0077: PHI (r10v10 float) = (r10v5 float), (r10v6 float) binds: [B:116:0x0075, B:119:0x007d] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:123:0x0086 A[PHI: r10
  0x0086: PHI (r10v9 float) = (r10v7 float), (r10v8 float) binds: [B:122:0x0084, B:125:0x008c] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public boolean onDoubleTap(android.view.MotionEvent r10) {
        ...
        L99:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.SecretMediaViewer.onDoubleTap(android.view.MotionEvent):boolean");
    }
    ...
    class VideoPlayerControlFrameLayout extends FrameLayout {
        ...
        public /* synthetic */ void lambda$new$0(DynamicAnimation dynamicAnimation, float f, float f2) {
            SecretMediaViewer.this.seekbar.setSize((int) (((getMeasuredWidth() - AndroidUtilities.m1081dp(16.0f)) - f) - (this.parentWidth > this.parentHeight ? AndroidUtilities.m1081dp(48.0f) : 0)), getMeasuredHeight());
        }
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (SecretMediaViewer.this.seekbar.onTouch(motionEvent.getAction(), motionEvent.getX() - AndroidUtilities.m1081dp(2.0f), motionEvent.getY())) {
        ...
        */
        ...
        class C63851 extends AnimationProperties.FloatProperty {
            C63851(String str) {
                super(str);
            }
