...
public class DownloadProgressIcon extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public DownloadProgressIcon(int i, Context context) {
        ...
        this.downloadDrawable = new RLottieDrawable(C2702R.raw.download_progress, "download_progress", AndroidUtilities.m1081dp(28.0f), AndroidUtilities.m1081dp(28.0f), true, null);
        this.downloadCompleteDrawable = new RLottieDrawable(C2702R.raw.download_finish, "download_finish", AndroidUtilities.m1081dp(28.0f), AndroidUtilities.m1081dp(28.0f), true, null);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int measuredHeight = (getMeasuredHeight() / 2) + AndroidUtilities.m1081dp(8.0f);
        float fM1081dp = AndroidUtilities.m1081dp(1.0f);
        float fM1081dp2 = AndroidUtilities.m1081dp(16.0f);
        RectF rectF = AndroidUtilities.rectTmp;
        float f5 = measuredHeight;
        float f6 = f5 - fM1081dp;
        float f7 = f5 + fM1081dp;
        rectF.set(fM1081dp2, f6, getMeasuredWidth() - fM1081dp2, f7);
        canvas.drawRoundRect(rectF, fM1081dp, fM1081dp, this.paint2);
        rectF.set(fM1081dp2, f6, ((getMeasuredWidth() - (2.0f * fM1081dp2)) * this.currentProgress) + fM1081dp2, f7);
