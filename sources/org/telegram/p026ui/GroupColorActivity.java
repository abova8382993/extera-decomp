...
public class GroupColorActivity extends ChannelColorActivity {
    ...
    @Override // org.telegram.p026ui.ChannelColorActivity
    ...
    protected int getEmojiPackStrRes() {
        return C2702R.string.GroupEmojiPack;
    }

    @Override // org.telegram.p026ui.ChannelColorActivity
    protected int getEmojiPackInfoStrRes() {
        return C2702R.string.GroupEmojiPackInfo;
    }

    @Override // org.telegram.p026ui.ChannelColorActivity
    protected int getStickerPackStrRes() {
        return C2702R.string.GroupStickerPack;
    }

    @Override // org.telegram.p026ui.ChannelColorActivity
    protected int getStickerPackInfoStrRes() {
        return C2702R.string.GroupStickerPackInfo;
    }

    @Override // org.telegram.p026ui.ChannelColorActivity
    protected int getProfileInfoStrRes() {
        return C2702R.string.GroupProfileInfo;
    }

    @Override // org.telegram.p026ui.ChannelColorActivity
    protected int getEmojiStatusStrRes() {
        return C2702R.string.GroupEmojiStatus;
    }

    @Override // org.telegram.p026ui.ChannelColorActivity
    protected int getEmojiStatusInfoStrRes() {
        return C2702R.string.GroupEmojiStatusInfo;
    }

    @Override // org.telegram.p026ui.ChannelColorActivity
    protected int getWallpaperStrRes() {
        return C2702R.string.GroupWallpaper;
    }

    @Override // org.telegram.p026ui.ChannelColorActivity
    protected int getWallpaper2InfoStrRes() {
        return C2702R.string.GroupWallpaper2Info;
    }

    @Override // org.telegram.p026ui.ChannelColorActivity, org.telegram.p026ui.ActionBar.BaseFragment
    public View createView(Context context) {
        ...
        viewCreateView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserverOnGlobalLayoutListenerC56351(viewCreateView));
        return viewCreateView;
    }

    /* JADX INFO: renamed from: org.telegram.ui.GroupColorActivity$1 */
    class ViewTreeObserverOnGlobalLayoutListenerC56351 implements ViewTreeObserver.OnGlobalLayoutListener {
        final /* synthetic */ View val$view;

        ViewTreeObserverOnGlobalLayoutListenerC56351(View view) {
            this.val$view = view;
        }
    ...
    public void updateColors(boolean z) {
        ...
        CombinedDrawable combinedDrawable = new CombinedDrawable(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundWhite, this.resourceProvider)), Theme.getThemedDrawableByKey(getContext(), C2702R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow), 0, 0);
    ...
    @Override // org.telegram.p026ui.ChannelColorActivity, org.telegram.messenger.NotificationCenter.NotificationCenterDelegate
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        super.didReceivedNotification(i, i2, objArr);
        if (i == NotificationCenter.chatInfoDidLoad && ((TLRPC.ChatFull) objArr[0]).f1611id == (-this.dialogId)) {
