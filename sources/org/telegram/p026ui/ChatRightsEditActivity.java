...
import org.telegram.p026ui.Cells.DialogRadioCell;
...
import org.telegram.p026ui.Cells.TextCheckCell2;
import org.telegram.p026ui.Cells.TextDetailCell;
import org.telegram.p026ui.Cells.TextInfoPrivacyCell;
import org.telegram.p026ui.Cells.TextSettingsCell;
import org.telegram.p026ui.Cells.UserCell2;
...
public class ChatRightsEditActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ void m7507$r8$lambda$XGcFDpfrPJk_cEX0SQrzTbpuI(DialogInterface dialogInterface, int i) {
    }
    ...
    public View createView(final Context context) {
        ...
        if (i == 0) {
            this.actionBar.setTitle(LocaleController.getString(C2702R.string.EditAdmin));
        } else if (i == 2) {
            this.actionBar.setTitle(LocaleController.getString(C2702R.string.AddBot));
        } else {
            this.actionBar.setTitle(LocaleController.getString(C2702R.string.UserRestrictions));
        }
        ...
        if (this.canEdit || (!this.isChannel && this.currentChat.creator && UserObject.isUserSelf(this.currentUser))) {
            ...
            Drawable drawableMutate = context.getResources().getDrawable(C2702R.drawable.ic_ab_done).mutate();
            ...
            actionBarMenuCreateMenu.addItemWithWidth(1, 0, AndroidUtilities.m1081dp(56.0f), LocaleController.getString(C2702R.string.Done));
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.ChatRightsEditActivity.2
            ...
            protected void onLayout(boolean z2, int i3, int i4, int i5, int i6) {
                ...
                if (i8 != -1 && Math.abs(i8 - i7) > AndroidUtilities.m1081dp(20.0f)) {
    ...
    public /* synthetic */ void lambda$createView$6(Context context, View view, int i) {
        ...
        if (this.canEdit || ((this.currentChat.creator && this.currentType == 0 && i == this.anonymousRow) || i == 0)) {
            ...
            if (i == 0) {
                ...
                bundle.putLong("user_id", this.currentUser.f1775id);
            ...
            if (i == this.untilDateRow) {
                ...
                headerCell.setText(LocaleController.getString(C2702R.string.UserRestrictionsDuration));
                ...
                for (int i6 = 5; i5 < i6; i6 = 5) {
                    ...
                    bottomSheetCell.setPadding(AndroidUtilities.m1081dp(7.0f), 0, AndroidUtilities.m1081dp(7.0f), 0);
                    ...
                    if (i5 == 0) {
                        string = LocaleController.getString(C2702R.string.UserRestrictionsUntilForever);
                    } else if (i5 == 1) {
                        ...
                        string = LocaleController.getString(C2702R.string.UserRestrictionsCustom);
                    }
            ...
            if (view instanceof CheckBoxCell) {
                ...
                if (checkBoxCell.hasIcon()) {
                    if (this.currentType != 2) {
                        new AlertDialog.Builder(getParentActivity()).setTitle(LocaleController.getString(C2702R.string.UserRestrictionsCantModify)).setMessage(LocaleController.getString(C2702R.string.UserRestrictionsCantModifyDisabled)).setPositiveButton(LocaleController.getString(C2702R.string.f1556OK), null).create().show();
                        return;
                    }
                    return;
                }
            ...
            if (view instanceof TextCheckCell2) {
                ...
                if (!textCheckCell2.isEnabled()) {
                    ...
                    if (i9 == 2 || i9 == 0) {
                        ...
                        new AlertDialog.Builder(getParentActivity()).setTitle(LocaleController.getString(C2702R.string.UserRestrictionsCantModify)).setMessage(LocaleController.getString(C2702R.string.UserRestrictionsCantModifyEnabled)).setPositiveButton(LocaleController.getString(C2702R.string.f1556OK), null).create().show();
                        return;
                    }
                    return;
                }
    ...
    public /* synthetic */ void lambda$createView$5(BottomSheet.Builder builder, View view) {
        ...
        if (iIntValue == 0) {
            ...
            try {
                ...
                datePickerDialog.setButton(-1, LocaleController.getString(C2702R.string.Set), datePickerDialog);
                datePickerDialog.setButton(-2, LocaleController.getString(C2702R.string.Cancel), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ChatRightsEditActivity$$ExternalSyntheticLambda12
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
                        ChatRightsEditActivity.m7507$r8$lambda$XGcFDpfrPJk_cEX0SQrzTbpuI(dialogInterface, i);
                    }
                });
    ...
    public /* synthetic */ void lambda$createView$2(DatePicker datePicker, int i, int i2, int i3) {
        ...
        try {
            ...
            timePickerDialog.setButton(-1, LocaleController.getString(C2702R.string.Set), timePickerDialog);
            timePickerDialog.setButton(-2, LocaleController.getString(C2702R.string.Cancel), new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ChatRightsEditActivity$$ExternalSyntheticLambda20
                @Override // android.content.DialogInterface.OnClickListener
    ...
    public void lambda$initTransfer$8(final TLRPC.InputCheckPasswordSRP inputCheckPasswordSRP, final TwoStepVerificationActivity twoStepVerificationActivity) {
        ...
        if (ChatObject.isChannel(this.currentChat)) {
            ...
            tL_inputChannel.channel_id = chat.f1610id;
    ...
    public /* synthetic */ void lambda$initTransfer$13(TLRPC.TL_error tL_error, TLRPC.InputCheckPasswordSRP inputCheckPasswordSRP, final TwoStepVerificationActivity twoStepVerificationActivity, TLRPC.TL_channels_editCreator tL_channels_editCreator) {
        ...
        if ("PASSWORD_HASH_INVALID".equals(tL_error.text)) {
            if (inputCheckPasswordSRP == null) {
                ...
                if (this.isChannel) {
                    builder.setTitle(LocaleController.getString(C2702R.string.EditAdminChannelTransfer));
                } else {
                    builder.setTitle(LocaleController.getString(C2702R.string.EditAdminGroupTransfer));
                }
                builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString(C2702R.string.EditAdminTransferReadyAlertText, this.currentChat.title, UserObject.getFirstName(this.currentUser))));
                builder.setPositiveButton(LocaleController.getString(C2702R.string.EditAdminTransferChangeOwner), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ChatRightsEditActivity$$ExternalSyntheticLambda22
        ...
        if ("PASSWORD_MISSING".equals(tL_error.text) || tL_error.text.startsWith("PASSWORD_TOO_FRESH_") || tL_error.text.startsWith("SESSION_TOO_FRESH_")) {
            ...
            builder2.setTitle(LocaleController.getString(C2702R.string.EditAdminTransferAlertTitle));
            ...
            if (this.isChannel) {
                textView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("EditChannelAdminTransferAlertText", C2702R.string.EditChannelAdminTransferAlertText, UserObject.getFirstName(this.currentUser))));
            } else {
                textView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("EditAdminTransferAlertText", C2702R.string.EditAdminTransferAlertText, UserObject.getFirstName(this.currentUser))));
            }
            ...
            textView2.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2702R.string.EditAdminTransferAlertText1)));
            ...
            textView3.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2702R.string.EditAdminTransferAlertText2)));
            if (LocaleController.isRTL) {
            ...
            if ("PASSWORD_MISSING".equals(tL_error.text)) {
                builder2.setPositiveButton(LocaleController.getString(C2702R.string.EditAdminTransferSetPassword), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ChatRightsEditActivity$$ExternalSyntheticLambda23
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                ...
                textView4.setText(LocaleController.getString(C2702R.string.EditAdminTransferAlertText3));
    ...
    */
    public void onDonePressed() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.ChatRightsEditActivity.onDonePressed():void");
    }
    ...
    public /* synthetic */ void lambda$onDonePressed$21(AlertDialog alertDialog, int i) {
        ...
        if (this.asAdmin || this.initialAsAdmin) {
            getMessagesController().setUserAdminRole(this.currentChat.f1610id, this.currentUser, this.asAdmin ? this.adminRights : emptyAdminRights(false), this.currentRank, false, this, this.isAddingNew, this.asAdmin, this.botHash, runnable, new MessagesController.ErrorDelegate() { // from class: org.telegram.ui.ChatRightsEditActivity$$ExternalSyntheticLambda17
            ...
            getMessagesController().addUserToChat(this.currentChat.f1610id, this.currentUser, 0, this.botHash, this, true, runnable, new MessagesController.ErrorDelegate() { // from class: org.telegram.ui.ChatRightsEditActivity$$ExternalSyntheticLambda18
                @Override // org.telegram.messenger.MessagesController.ErrorDelegate
                public final boolean run(TLRPC.TL_error tL_error) {
    ...
    public /* synthetic */ void lambda$onDonePressed$18() {
        ...
        bundle.putLong("chat_id", this.currentChat.f1610id);
    ...
    public boolean checkDiscard(boolean z) {
        ...
        if (z) {
            AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
            builder.setTitle(LocaleController.getString(C2702R.string.UserRestrictionsApplyChanges));
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("UserRestrictionsApplyChangesText", C2702R.string.UserRestrictionsApplyChangesText, MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(this.chatId)).title)));
            builder.setPositiveButton(LocaleController.getString(C2702R.string.ApplyTheme), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ChatRightsEditActivity$$ExternalSyntheticLambda0
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i2) {
                    this.f$0.lambda$checkDiscard$23(alertDialog, i2);
                }
            });
            builder.setNegativeButton(LocaleController.getString(C2702R.string.PassportDiscard), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ChatRightsEditActivity$$ExternalSyntheticLambda1
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i2) {
    ...
    class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            switch (i) {
                ...
                case 8:
                    ...
                    ChatRightsEditActivity.this.addBotButtonText.setTextSize(AndroidUtilities.m1081dp(14.0f));
                    ...
                    sb.append(LocaleController.getString(C2702R.string.AddBotButton));
                    sb.append(" ");
                    sb.append(LocaleController.getString(ChatRightsEditActivity.this.asAdmin ? C2702R.string.AddBotButtonAsAdmin : C2702R.string.AddBotButtonAsMember));
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            switch (viewHolder.getItemViewType()) {
                case 0:
                    ((UserCell2) viewHolder.itemView).setData(ChatRightsEditActivity.this.currentUser, null, ChatRightsEditActivity.this.currentType == 2 ? LocaleController.getString(C2702R.string.Bot) : null, 0);
                    break;
                case 1:
                    TextInfoPrivacyCell textInfoPrivacyCell = (TextInfoPrivacyCell) viewHolder.itemView;
                    if (i == ChatRightsEditActivity.this.cantEditInfoRow) {
                        textInfoPrivacyCell.setText(LocaleController.getString(C2702R.string.EditAdminCantEdit));
                        ...
                        if (UserObject.isUserSelf(ChatRightsEditActivity.this.currentUser) && ChatRightsEditActivity.this.currentChat.creator) {
                            string = LocaleController.getString(C2702R.string.ChannelCreator);
                        } else {
                            string = LocaleController.getString(C2702R.string.ChannelAdmin);
                        }
                        textInfoPrivacyCell.setText(LocaleController.formatString("EditAdminRankInfo", C2702R.string.EditAdminRankInfo, string));
                    }
                    break;
                case 2:
                    ...
                    if (i == ChatRightsEditActivity.this.removeAdminRow) {
                        ...
                        if (ChatRightsEditActivity.this.currentType == 0) {
                            textSettingsCell.setText(LocaleController.getString(C2702R.string.EditAdminRemoveAdmin), false);
                        } else if (ChatRightsEditActivity.this.currentType == 1) {
                            textSettingsCell.setText(LocaleController.getString(C2702R.string.UserRestrictionsBlock), false);
                        }
                        ...
                        if (ChatRightsEditActivity.this.isChannel) {
                            textSettingsCell.setText(LocaleController.getString(C2702R.string.EditAdminChannelTransfer), false);
                        } else {
                            textSettingsCell.setText(LocaleController.getString(C2702R.string.EditAdminGroupTransfer), false);
                        }
                    }
                    break;
                case 3:
                    ...
                    if (i == 2) {
                        if (ChatRightsEditActivity.this.currentType == 2 || (ChatRightsEditActivity.this.currentUser != null && ChatRightsEditActivity.this.currentUser.bot)) {
                            headerCell.setText(LocaleController.getString(C2702R.string.BotRestrictionsCanDo));
                        } else if (ChatRightsEditActivity.this.currentType == 0) {
                            headerCell.setText(LocaleController.getString(C2702R.string.EditAdminWhatCanDo));
                        } else if (ChatRightsEditActivity.this.currentType == 1) {
                            headerCell.setText(LocaleController.getString(C2702R.string.UserRestrictionsCanDo));
                        }
                    } else if (i == ChatRightsEditActivity.this.rankHeaderRow) {
                        headerCell.setText(LocaleController.getString(C2702R.string.EditAdminRank));
                    }
                    break;
                case 4:
                case 9:
                    ...
                    if (i == ChatRightsEditActivity.this.sendMediaRow) {
                        ...
                        textCheckCell2.setTextAndCheck(LocaleController.getString(C2702R.string.UserRestrictionsSendMedia), sendMediaSelectedCount > 0, true, true);
                        ...
                        textCheckCell2.setIcon(ChatRightsEditActivity.this.allDefaultMediaBanned() ? C2702R.drawable.permission_locked : 0);
                        ...
                        textCheckCell2.setTextAndCheck(LocaleController.getString(C2702R.string.ChannelManageMessages), channelMessagesSelectedCount > 0, true, true);
                        ...
                        textCheckCell2.setTextAndCheck(LocaleController.getString(C2702R.string.ChannelManageStories), channelStoriesSelectedCount > 0, true, true);
                        ...
                        textCheckCell2.setTextAndCheck(LocaleController.getString(C2702R.string.ManageGroup), ChatRightsEditActivity.this.asAdmin, true);
                        textCheckCell2.setIcon((ChatRightsEditActivity.this.myAdminRights.add_admins || z2) ? 0 : C2702R.drawable.permission_locked);
                        ...
                        if (ChatRightsEditActivity.this.currentType == 0 || ChatRightsEditActivity.this.currentType == 2) {
                            if (ChatRightsEditActivity.this.isChannel) {
                                textCheckCell2.setTextAndCheck(LocaleController.getString(C2702R.string.EditAdminChangeChannelInfo), z && ChatRightsEditActivity.this.adminRights.change_info, true);
                            } else {
                                textCheckCell2.setTextAndCheck(LocaleController.getString(C2702R.string.EditAdminChangeGroupInfo), (z && ChatRightsEditActivity.this.adminRights.change_info) || !ChatRightsEditActivity.this.defaultBannedRights.change_info, true);
                            }
                            if (ChatRightsEditActivity.this.currentType == 2) {
                                textCheckCell2.setIcon((ChatRightsEditActivity.this.myAdminRights.change_info || z2) ? 0 : C2702R.drawable.permission_locked);
                            }
                        } else if (ChatRightsEditActivity.this.currentType == 1) {
                            textCheckCell2.setTextAndCheck(LocaleController.getString(C2702R.string.UserRestrictionsChangeInfo), (ChatRightsEditActivity.this.bannedRights.change_info || ChatRightsEditActivity.this.defaultBannedRights.change_info) ? false : true, ChatRightsEditActivity.this.manageTopicsRow != -1);
                            textCheckCell2.setIcon(ChatRightsEditActivity.this.defaultBannedRights.change_info ? C2702R.drawable.permission_locked : 0);
                        }
                    } else if (i == ChatRightsEditActivity.this.postMessagesRow) {
                        textCheckCell2.setTextAndCheck(LocaleController.getString(C2702R.string.EditAdminPostMessages), z && ChatRightsEditActivity.this.adminRights.post_messages, true);
                        if (ChatRightsEditActivity.this.currentType == 2) {
                            textCheckCell2.setIcon((ChatRightsEditActivity.this.myAdminRights.post_messages || z2) ? 0 : C2702R.drawable.permission_locked);
                        }
                    } else if (i == ChatRightsEditActivity.this.manageDirectRow) {
                        textCheckCell2.setTextAndCheck(LocaleController.getString(C2702R.string.EditAdminManageDirect), z && ChatRightsEditActivity.this.adminRights.manage_direct_messages, true);
                        if (ChatRightsEditActivity.this.currentType == 2) {
                            textCheckCell2.setIcon((ChatRightsEditActivity.this.myAdminRights.manage_direct_messages || z2) ? 0 : C2702R.drawable.permission_locked);
                        }
                    } else if (i == ChatRightsEditActivity.this.editMesagesRow) {
                        textCheckCell2.setTextAndCheck(LocaleController.getString(C2702R.string.EditAdminEditMessages), z && ChatRightsEditActivity.this.adminRights.edit_messages, true);
                        if (ChatRightsEditActivity.this.currentType == 2) {
                            textCheckCell2.setIcon((ChatRightsEditActivity.this.myAdminRights.edit_messages || z2) ? 0 : C2702R.drawable.permission_locked);
                        }
                    } else if (i == ChatRightsEditActivity.this.deleteMessagesRow) {
                        if (ChatRightsEditActivity.this.isChannel) {
                            textCheckCell2.setTextAndCheck(LocaleController.getString(C2702R.string.EditAdminDeleteMessages), z && ChatRightsEditActivity.this.adminRights.delete_messages, true);
                        } else {
                            textCheckCell2.setTextAndCheck(LocaleController.getString(C2702R.string.EditAdminGroupDeleteMessages), z && ChatRightsEditActivity.this.adminRights.delete_messages, true);
                        }
                        if (ChatRightsEditActivity.this.currentType == 2) {
                            textCheckCell2.setIcon((ChatRightsEditActivity.this.myAdminRights.delete_messages || z2) ? 0 : C2702R.drawable.permission_locked);
                        }
                    } else if (i == ChatRightsEditActivity.this.addAdminsRow) {
                        textCheckCell2.setTextAndCheck(LocaleController.getString(C2702R.string.EditAdminAddAdmins), z && ChatRightsEditActivity.this.adminRights.add_admins, (ChatRightsEditActivity.this.banUsersRow != -1 && ChatRightsEditActivity.this.isChannel) || ChatRightsEditActivity.this.anonymousRow != -1);
                        if (ChatRightsEditActivity.this.currentType == 2) {
                            textCheckCell2.setIcon((ChatRightsEditActivity.this.myAdminRights.add_admins || z2) ? 0 : C2702R.drawable.permission_locked);
                        }
                    } else if (i == ChatRightsEditActivity.this.anonymousRow) {
                        textCheckCell2.setTextAndCheck(LocaleController.getString(C2702R.string.EditAdminSendAnonymously), z && ChatRightsEditActivity.this.adminRights.anonymous, ChatRightsEditActivity.this.manageTopicsRow != -1);
                        if (ChatRightsEditActivity.this.currentType == 2) {
                            textCheckCell2.setIcon((ChatRightsEditActivity.this.myAdminRights.anonymous || z2) ? 0 : C2702R.drawable.permission_locked);
                        }
                    } else if (i == ChatRightsEditActivity.this.banUsersRow) {
                        textCheckCell2.setTextAndCheck(LocaleController.getString(C2702R.string.EditAdminBanUsers), z && ChatRightsEditActivity.this.adminRights.ban_users, true);
                        if (ChatRightsEditActivity.this.currentType == 2) {
                            textCheckCell2.setIcon((ChatRightsEditActivity.this.myAdminRights.ban_users || z2) ? 0 : C2702R.drawable.permission_locked);
                        }
                    } else if (i == ChatRightsEditActivity.this.startVoiceChatRow) {
                        textCheckCell2.setTextAndCheck(LocaleController.getString(C2702R.string.StartVoipChatPermission), z && ChatRightsEditActivity.this.adminRights.manage_call, true);
                        if (ChatRightsEditActivity.this.currentType == 2) {
                            textCheckCell2.setIcon((ChatRightsEditActivity.this.myAdminRights.manage_call || z2) ? 0 : C2702R.drawable.permission_locked);
                        }
                    } else if (i == ChatRightsEditActivity.this.manageTopicsRow) {
                        if (ChatRightsEditActivity.this.currentType == 0) {
                            textCheckCell2.setTextAndCheck(LocaleController.getString(C2702R.string.ManageTopicsPermission), z && ChatRightsEditActivity.this.adminRights.manage_topics, false);
                        } else if (ChatRightsEditActivity.this.currentType == 1) {
                            textCheckCell2.setTextAndCheck(LocaleController.getString(C2702R.string.CreateTopicsPermission), (ChatRightsEditActivity.this.bannedRights.manage_topics || ChatRightsEditActivity.this.defaultBannedRights.manage_topics) ? false : true, false);
                            textCheckCell2.setIcon(ChatRightsEditActivity.this.defaultBannedRights.manage_topics ? C2702R.drawable.permission_locked : 0);
                        } else if (ChatRightsEditActivity.this.currentType == 2) {
                            textCheckCell2.setTextAndCheck(LocaleController.getString(C2702R.string.ManageTopicsPermission), z && ChatRightsEditActivity.this.adminRights.manage_topics, false);
                            textCheckCell2.setIcon((ChatRightsEditActivity.this.myAdminRights.manage_topics || z2) ? 0 : C2702R.drawable.permission_locked);
                        }
                        ...
                        if (ChatRightsEditActivity.this.currentType == 0) {
                            if (ChatObject.isActionBannedByDefault(ChatRightsEditActivity.this.currentChat, 3)) {
                                textCheckCell2.setTextAndCheck(LocaleController.getString(C2702R.string.EditAdminAddUsers), ChatRightsEditActivity.this.adminRights.invite_users, true);
                            } else {
                                textCheckCell2.setTextAndCheck(LocaleController.getString(C2702R.string.EditAdminAddUsersViaLink), ChatRightsEditActivity.this.adminRights.invite_users, true);
                            }
                        } else if (ChatRightsEditActivity.this.currentType == 1) {
                            textCheckCell2.setTextAndCheck(LocaleController.getString(C2702R.string.UserRestrictionsInviteUsers), (ChatRightsEditActivity.this.bannedRights.invite_users || ChatRightsEditActivity.this.defaultBannedRights.invite_users) ? false : true, true);
                            textCheckCell2.setIcon(ChatRightsEditActivity.this.defaultBannedRights.invite_users ? C2702R.drawable.permission_locked : 0);
                        } else if (ChatRightsEditActivity.this.currentType == 2) {
                            textCheckCell2.setTextAndCheck(LocaleController.getString(C2702R.string.EditAdminAddUsersViaLink), z && ChatRightsEditActivity.this.adminRights.invite_users, true);
                            textCheckCell2.setIcon((ChatRightsEditActivity.this.myAdminRights.invite_users || z2) ? 0 : C2702R.drawable.permission_locked);
                        }
                    } else if (i == ChatRightsEditActivity.this.pinMessagesRow) {
                        if (ChatRightsEditActivity.this.currentType == 0 || ChatRightsEditActivity.this.currentType == 2) {
                            textCheckCell2.setTextAndCheck(LocaleController.getString(C2702R.string.EditAdminPinMessages), (z && ChatRightsEditActivity.this.adminRights.pin_messages) || !ChatRightsEditActivity.this.defaultBannedRights.pin_messages, true);
                            if (ChatRightsEditActivity.this.currentType == 2) {
                                textCheckCell2.setIcon((ChatRightsEditActivity.this.myAdminRights.pin_messages || z2) ? 0 : C2702R.drawable.permission_locked);
                            }
                        } else if (ChatRightsEditActivity.this.currentType == 1) {
                            textCheckCell2.setTextAndCheck(LocaleController.getString(C2702R.string.UserRestrictionsPinMessages), (ChatRightsEditActivity.this.bannedRights.pin_messages || ChatRightsEditActivity.this.defaultBannedRights.pin_messages) ? false : true, true);
                            textCheckCell2.setIcon(ChatRightsEditActivity.this.defaultBannedRights.pin_messages ? C2702R.drawable.permission_locked : 0);
                        }
                    } else if (i == ChatRightsEditActivity.this.sendMessagesRow) {
                        textCheckCell2.setTextAndCheck(LocaleController.getString(C2702R.string.UserRestrictionsSend), (ChatRightsEditActivity.this.bannedRights.send_plain || ChatRightsEditActivity.this.defaultBannedRights.send_plain) ? false : true, true);
                        textCheckCell2.setIcon(ChatRightsEditActivity.this.defaultBannedRights.send_plain ? C2702R.drawable.permission_locked : 0);
                    }
                ...
                case 6:
                    ...
                    if (i == ChatRightsEditActivity.this.untilDateRow) {
                        if (ChatRightsEditActivity.this.bannedRights.until_date == 0 || Math.abs(((long) ChatRightsEditActivity.this.bannedRights.until_date) - (System.currentTimeMillis() / 1000)) > 315360000) {
                            string2 = LocaleController.getString(C2702R.string.UserRestrictionsUntilForever);
                        } else {
                            string2 = LocaleController.formatDateForBan(ChatRightsEditActivity.this.bannedRights.until_date);
                        }
                        textDetailCell.setTextAndValue(LocaleController.getString(C2702R.string.UserRestrictionsDuration), string2, false);
                    }
                    break;
                case 7:
                    PollEditTextCell pollEditTextCell = (PollEditTextCell) viewHolder.itemView;
                    if (UserObject.isUserSelf(ChatRightsEditActivity.this.currentUser) && ChatRightsEditActivity.this.currentChat.creator) {
                        string3 = LocaleController.getString(C2702R.string.ChannelCreator);
                    } else {
                        string3 = LocaleController.getString(C2702R.string.ChannelAdmin);
                    }
                ...
                case 10:
                    ...
                    if (i == ChatRightsEditActivity.this.sendStickersRow) {
                        checkBoxCell.setText(LocaleController.getString(C2702R.string.SendMediaPermissionStickersGifs), _UrlKt.FRAGMENT_ENCODE_SET, (ChatRightsEditActivity.this.bannedRights.send_stickers || ChatRightsEditActivity.this.defaultBannedRights.send_stickers) ? false : true, true, z3);
                        checkBoxCell.setIcon(ChatRightsEditActivity.this.defaultBannedRights.send_stickers ? C2702R.drawable.permission_locked : 0);
                    } else if (i == ChatRightsEditActivity.this.embedLinksRow) {
                        checkBoxCell.setText(LocaleController.getString(C2702R.string.UserRestrictionsEmbedLinks), _UrlKt.FRAGMENT_ENCODE_SET, (ChatRightsEditActivity.this.bannedRights.embed_links || ChatRightsEditActivity.this.defaultBannedRights.embed_links || ChatRightsEditActivity.this.bannedRights.send_plain || ChatRightsEditActivity.this.defaultBannedRights.send_plain) ? false : true, true, z3);
                        checkBoxCell.setIcon(ChatRightsEditActivity.this.defaultBannedRights.embed_links ? C2702R.drawable.permission_locked : 0);
                    } else if (i == ChatRightsEditActivity.this.sendPollsRow) {
                        checkBoxCell.setText(LocaleController.getString(C2702R.string.SendMediaPolls), _UrlKt.FRAGMENT_ENCODE_SET, (ChatRightsEditActivity.this.bannedRights.send_polls || ChatRightsEditActivity.this.defaultBannedRights.send_polls) ? false : true, true, z3);
                        checkBoxCell.setIcon(ChatRightsEditActivity.this.defaultBannedRights.send_polls ? C2702R.drawable.permission_locked : 0);
                    } else if (i == ChatRightsEditActivity.this.sendPhotosRow) {
                        checkBoxCell.setText(LocaleController.getString(C2702R.string.SendMediaPermissionPhotos), _UrlKt.FRAGMENT_ENCODE_SET, (ChatRightsEditActivity.this.bannedRights.send_photos || ChatRightsEditActivity.this.defaultBannedRights.send_photos) ? false : true, true, z3);
                        checkBoxCell.setIcon(ChatRightsEditActivity.this.defaultBannedRights.send_photos ? C2702R.drawable.permission_locked : 0);
                    } else if (i == ChatRightsEditActivity.this.sendVideosRow) {
                        checkBoxCell.setText(LocaleController.getString(C2702R.string.SendMediaPermissionVideos), _UrlKt.FRAGMENT_ENCODE_SET, (ChatRightsEditActivity.this.bannedRights.send_videos || ChatRightsEditActivity.this.defaultBannedRights.send_videos) ? false : true, true, z3);
                        checkBoxCell.setIcon(ChatRightsEditActivity.this.defaultBannedRights.send_videos ? C2702R.drawable.permission_locked : 0);
                    } else if (i == ChatRightsEditActivity.this.sendMusicRow) {
                        checkBoxCell.setText(LocaleController.getString(C2702R.string.SendMediaPermissionMusic), _UrlKt.FRAGMENT_ENCODE_SET, (ChatRightsEditActivity.this.bannedRights.send_audios || ChatRightsEditActivity.this.defaultBannedRights.send_audios) ? false : true, true, z3);
                        checkBoxCell.setIcon(ChatRightsEditActivity.this.defaultBannedRights.send_audios ? C2702R.drawable.permission_locked : 0);
                    } else if (i == ChatRightsEditActivity.this.sendFilesRow) {
                        checkBoxCell.setText(LocaleController.getString(C2702R.string.SendMediaPermissionFiles), _UrlKt.FRAGMENT_ENCODE_SET, (ChatRightsEditActivity.this.bannedRights.send_docs || ChatRightsEditActivity.this.defaultBannedRights.send_docs) ? false : true, true, z3);
                        checkBoxCell.setIcon(ChatRightsEditActivity.this.defaultBannedRights.send_docs ? C2702R.drawable.permission_locked : 0);
                    } else if (i == ChatRightsEditActivity.this.sendVoiceRow) {
                        checkBoxCell.setText(LocaleController.getString(C2702R.string.SendMediaPermissionVoice), _UrlKt.FRAGMENT_ENCODE_SET, (ChatRightsEditActivity.this.bannedRights.send_voices || ChatRightsEditActivity.this.defaultBannedRights.send_voices) ? false : true, true, z3);
                        checkBoxCell.setIcon(ChatRightsEditActivity.this.defaultBannedRights.send_voices ? C2702R.drawable.permission_locked : 0);
                    } else if (i == ChatRightsEditActivity.this.sendRoundRow) {
                        checkBoxCell.setText(LocaleController.getString(C2702R.string.SendMediaPermissionRound), _UrlKt.FRAGMENT_ENCODE_SET, (ChatRightsEditActivity.this.bannedRights.send_roundvideos || ChatRightsEditActivity.this.defaultBannedRights.send_roundvideos) ? false : true, true, z3);
                        checkBoxCell.setIcon(ChatRightsEditActivity.this.defaultBannedRights.send_roundvideos ? C2702R.drawable.permission_locked : 0);
                    } else if (i == ChatRightsEditActivity.this.channelPostMessagesRow) {
                        checkBoxCell.setText(LocaleController.getString(C2702R.string.EditAdminPostMessages), _UrlKt.FRAGMENT_ENCODE_SET, ChatRightsEditActivity.this.adminRights.post_messages, true, z3);
                    } else if (i == ChatRightsEditActivity.this.channelEditMessagesRow) {
                        checkBoxCell.setText(LocaleController.getString(C2702R.string.EditAdminEditMessages), _UrlKt.FRAGMENT_ENCODE_SET, ChatRightsEditActivity.this.adminRights.edit_messages, true, z3);
                    } else if (i == ChatRightsEditActivity.this.channelDeleteMessagesRow) {
                        checkBoxCell.setText(LocaleController.getString(C2702R.string.EditAdminDeleteMessages), _UrlKt.FRAGMENT_ENCODE_SET, ChatRightsEditActivity.this.adminRights.delete_messages, true, z3);
                    } else if (i == ChatRightsEditActivity.this.channelPostStoriesRow) {
                        checkBoxCell.setText(LocaleController.getString(C2702R.string.EditAdminPostStories), _UrlKt.FRAGMENT_ENCODE_SET, ChatRightsEditActivity.this.adminRights.post_stories, true, z3);
                    } else if (i == ChatRightsEditActivity.this.channelEditStoriesRow) {
                        checkBoxCell.setText(LocaleController.getString(C2702R.string.EditAdminEditStories), _UrlKt.FRAGMENT_ENCODE_SET, ChatRightsEditActivity.this.adminRights.edit_stories, true, z3);
                    } else if (i == ChatRightsEditActivity.this.channelDeleteStoriesRow) {
                        checkBoxCell.setText(LocaleController.getString(C2702R.string.EditAdminDeleteStories), _UrlKt.FRAGMENT_ENCODE_SET, ChatRightsEditActivity.this.adminRights.delete_stories, true, z3);
                    }
                    break;
            }
        }
        ...
        public /* synthetic */ void lambda$onBindViewHolder$1(TextCheckCell2 textCheckCell2) {
            if (textCheckCell2.isEnabled()) {
                if (ChatRightsEditActivity.this.allDefaultMediaBanned()) {
                    new AlertDialog.Builder(ChatRightsEditActivity.this.getParentActivity()).setTitle(LocaleController.getString(C2702R.string.UserRestrictionsCantModify)).setMessage(LocaleController.getString(C2702R.string.UserRestrictionsCantModifyEnabled)).setPositiveButton(LocaleController.getString(C2702R.string.f1556OK), null).create().show();
                    return;
                }
    ...
    /* JADX WARN: Removed duplicated region for block: B:43:0x0080 A[PHI: r5
  0x0080: PHI (r5v26 boolean) = (r5v7 boolean), (r5v7 boolean), (r5v13 boolean), (r5v13 boolean), (r5v30 boolean), (r5v30 boolean) binds: [B:81:0x0118, B:83:0x011c, B:66:0x00e5, B:68:0x00eb, B:39:0x0077, B:41:0x007d] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void updateAsAdmin(boolean r9) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.ChatRightsEditActivity.updateAsAdmin(boolean):void");
    }
