...
public class PasscodeActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public android.view.View createView(final android.content.Context r28) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.PasscodeActivity.createView(android.content.Context):android.view.View");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$createView$1(int i, boolean z) {
        Runnable runnable;
        if (i < AndroidUtilities.m1081dp(20.0f) || (runnable = this.onShowKeyboardCallback) == null) {
            return;
        }
        runnable.run();
    ...
    public /* synthetic */ void lambda$createView$5(View view, final int i) {
        if (view.isEnabled()) {
            if (i == this.disablePasscodeRow) {
                AlertDialog alertDialogCreate = new AlertDialog.Builder(getParentActivity()).setTitle(LocaleController.getString(C2702R.string.DisablePasscode)).setMessage(LocaleController.getString(C2702R.string.DisablePasscodeConfirmMessage)).setNegativeButton(LocaleController.getString(C2702R.string.Cancel), null).setPositiveButton(LocaleController.getString(C2702R.string.DisablePasscodeTurnOff), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.PasscodeActivity$$ExternalSyntheticLambda15
            ...
            if (i == this.autoLockRow) {
                ...
                builder.setTitle(LocaleController.getString(C2702R.string.AutoLock));
                ...
                builder.setNegativeButton(LocaleController.getString(C2702R.string.Done), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.PasscodeActivity$$ExternalSyntheticLambda17
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            ...
            if (i == this.fingerprintRow) {
                ...
                AlertsCreator.showSimpleAlert(this, LocaleController.getString(C2702R.string.ScreenCaptureAlert));
            }
        }
    }
    ...
    public static /* synthetic */ String $r8$lambda$GkHM8SCihEibxZlPxpaEUpqlgj4(int i) {
        if (i == 0) {
            return LocaleController.getString(C2702R.string.AutoLockDisabled);
        }
        if (i == 1) {
            return LocaleController.formatString("AutoLockInTime", C2702R.string.AutoLockInTime, LocaleController.formatPluralString("Minutes", 1, new Object[0]));
        }
        if (i == 2) {
            return LocaleController.formatString("AutoLockInTime", C2702R.string.AutoLockInTime, LocaleController.formatPluralString("Minutes", 5, new Object[0]));
        }
        if (i == 3) {
            return LocaleController.formatString("AutoLockInTime", C2702R.string.AutoLockInTime, LocaleController.formatPluralString("Hours", 1, new Object[0]));
        }
        if (i == 4) {
            return LocaleController.formatString("AutoLockInTime", C2702R.string.AutoLockInTime, LocaleController.formatPluralString("Hours", 5, new Object[0]));
        }
        if (i == 5) {
            return LocaleController.getString(C2702R.string.AutoLockInstant);
        }
    ...
    class C59644 extends ActionBar.ActionBarMenuOnItemClick {
        final /* synthetic */ ActionBarMenuSubItem val$switchItem;

        C59644(ActionBarMenuSubItem actionBarMenuSubItem) {
        ...
        public /* synthetic */ void lambda$onItemClick$0(ActionBarMenuSubItem actionBarMenuSubItem) {
            actionBarMenuSubItem.setText(LocaleController.getString(PasscodeActivity.this.currentPasswordType == 0 ? C2702R.string.PasscodeSwitchToPassword : C2702R.string.PasscodeSwitchToPIN));
            actionBarMenuSubItem.setIcon(PasscodeActivity.this.currentPasswordType == 0 ? C2702R.drawable.msg_permissions : C2702R.drawable.msg_pin_code);
    ...
    class C59688 extends CodeFieldContainer {
        C59688(Context context) {
            super(context);
        }
    ...
    private void setCustomKeyboardVisible(final boolean z, boolean z2) {
        ...
        if (!z2) {
            ...
            this.keyboardView.setTranslationY(z ? 0.0f : AndroidUtilities.m1081dp(230.0f));
    ...
    public /* synthetic */ void lambda$setCustomKeyboardVisible$13(ValueAnimator valueAnimator) {
        ...
        this.keyboardView.setTranslationY((1.0f - fFloatValue) * AndroidUtilities.m1081dp(230.0f) * 0.75f);
        this.fragmentView.requestLayout();
    }
    ...
    */
    public void onConfigurationChanged(android.content.res.Configuration r5) {
        ...
        L3d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.PasscodeActivity.onConfigurationChanged(android.content.res.Configuration):void");
    }
    ...
    public void updateFields() {
        String string;
        if (this.type == 2) {
            string = LocaleController.getString(C2702R.string.EnterYourPasscodeInfo);
        } else if (this.passcodeSetStep == 0) {
            string = LocaleController.getString(this.currentPasswordType == 0 ? C2702R.string.CreatePasscodeInfoPIN : C2702R.string.CreatePasscodeInfoPassword);
        } else {
        ...
        if (this.type == 2) {
            this.descriptionTextSwitcher.setText(LocaleController.getString(C2702R.string.EnterYourPasscodeInfo), z);
        } else if (this.passcodeSetStep == 0) {
            this.descriptionTextSwitcher.setText(LocaleController.getString(this.currentPasswordType == 0 ? C2702R.string.CreatePasscodeInfoPIN : C2702R.string.CreatePasscodeInfoPassword), z);
        }
        if (isPinCode()) {
    ...
    public void processNext() {
        ...
        this.titleTextView.setText(LocaleController.getString(C2702R.string.ConfirmCreatePasscode));
        this.descriptionTextSwitcher.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2702R.string.PasscodeReinstallNotice)));
    ...
    public void processDone() {
        ...
        if (i == 2) {
            ...
            if (j > 0) {
                Toast.makeText(getParentActivity(), LocaleController.formatString("TooManyTries", C2702R.string.TooManyTries, LocaleController.formatPluralString("Seconds", Math.max(1, (int) Math.ceil(j / 1000.0d)), new Object[0])), 0).show();
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (i == PasscodeActivity.this.fingerprintRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getString(C2702R.string.UnlockFingerprint), SharedConfig.useFingerprintLock, false);
                    return;
                } else {
                    if (i == PasscodeActivity.this.captureRow) {
                        textCheckCell.setTextAndCheck(LocaleController.getString(C2702R.string.ScreenCaptureShowContent), SharedConfig.allowScreenCapture, false);
                        return;
                    }
                    return;
                }
            ...
            if (itemViewType != 1) {
                if (itemViewType != 2) {
                    if (itemViewType != 3) {
                        ...
                        rLottieImageHolderView.imageView.setAnimation(C2702R.raw.utyan_passcode, 100, 100);
                    ...
                    if (i == PasscodeActivity.this.captureHeaderRow) {
                        headerCell.setText(LocaleController.getString(C2702R.string.ScreenCaptureHeader));
                        return;
                    }
                    return;
                }
                ...
                if (i == PasscodeActivity.this.hintRow) {
                    textInfoPrivacyCell.setText(LocaleController.getString(C2702R.string.PasscodeScreenHint));
                    textInfoPrivacyCell.setBackground(null);
                    textInfoPrivacyCell.getTextView().setGravity(1);
                    return;
                } else if (i == PasscodeActivity.this.autoLockDetailRow) {
                    textInfoPrivacyCell.setText(LocaleController.getString(C2702R.string.AutoLockInfo));
                    textInfoPrivacyCell.getTextView().setGravity(LocaleController.isRTL ? 5 : 3);
                    return;
                } else {
                    if (i == PasscodeActivity.this.captureDetailRow) {
                        textInfoPrivacyCell.setText(LocaleController.getString(C2702R.string.ScreenCaptureInfo));
                        textInfoPrivacyCell.getTextView().setGravity(LocaleController.isRTL ? 5 : 3);
                        return;
                    }
                    return;
            ...
            if (i == PasscodeActivity.this.changePasscodeRow) {
                textSettingsCell.setText(LocaleController.getString(C2702R.string.ChangePasscode), true);
                if (SharedConfig.passcodeHash.isEmpty()) {
            ...
            if (i == PasscodeActivity.this.autoLockRow) {
                ...
                if (i4 == Integer.MAX_VALUE) {
                    string = LocaleController.getString(C2702R.string.AutoLockInstant);
                } else if (i4 == 0) {
                    string = LocaleController.formatString("AutoLockDisabled", C2702R.string.AutoLockDisabled, new Object[0]);
                } else {
                    string = i4 < 3600 ? LocaleController.formatString("AutoLockInTime", C2702R.string.AutoLockInTime, LocaleController.formatPluralString("Minutes", i4 / 60, new Object[0])) : i4 < 86400 ? LocaleController.formatString("AutoLockInTime", C2702R.string.AutoLockInTime, LocaleController.formatPluralString("Hours", (int) Math.ceil((i4 / 60.0f) / 60.0f), new Object[0])) : LocaleController.formatString("AutoLockInTime", C2702R.string.AutoLockInTime, LocaleController.formatPluralString("Days", (int) Math.ceil(((i4 / 60.0f) / 60.0f) / 24.0f), new Object[0]));
                }
                textSettingsCell.setTextAndValue(LocaleController.getString(C2702R.string.AutoLock), string, true);
            ...
            if (i == PasscodeActivity.this.disablePasscodeRow) {
                textSettingsCell.setText(LocaleController.getString(C2702R.string.DisablePasscode), false);
    ...
    static final class RLottieImageHolderView extends FrameLayout {
        ...
        private RLottieImageHolderView(Context context) {
            ...
            FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(iM1081dp, iM1081dp);
            layoutParams.gravity = 1;
            addView(rLottieImageView, layoutParams);
            setPadding(0, AndroidUtilities.m1081dp(32.0f), 0, 0);
