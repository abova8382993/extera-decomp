...
import org.telegram.p026ui.Stars.ExplainStarsSheet;
...
public class PasskeysActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2702R.string.Passkey));
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        arrayList.add(UItem.asTopView(LocaleController.getString(C2702R.string.PasskeyTopInfo), C2702R.raw.passkey));
        for (int i = 0; i < this.passkeys.size(); i++) {
            arrayList.add(PasskeyCell.Factory.m1240of((TL_account.Passkey) this.passkeys.get(i), new View.OnClickListener() { // from class: org.telegram.ui.PasskeysActivity$$ExternalSyntheticLambda3
        ...
        if (this.passkeys.size() + 1 <= getMessagesController().config.passkeysAccountPasskeysMax.get()) {
            ...
            arrayList.add(UItem.asButton(-1, C2702R.drawable.menu_passkey_add, LocaleController.getString(C2702R.string.PasskeyAdd)).accent());
        }
        arrayList.add(UItem.asShadow(AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(C2702R.string.PasskeyInfo), new Runnable() { // from class: org.telegram.ui.PasskeysActivity$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$fillItems$0();
            }
        }), true)));
        arrayList.add(UItem.asButton(-2, C2702R.drawable.msg_settings, LocaleController.getString(C2702R.string.Settings)));
        arrayList.add(UItem.asShadow(AndroidUtilities.replaceMultipleTags(LocaleController.getString(C2702R.string.PasskeyInfo2), new Runnable() { // from class: org.telegram.ui.PasskeysActivity$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void openMenu(View view) {
        ...
        final String str = passkeyCell.f2081id;
        final int i = 0;
        while (true) {
            if (i >= this.passkeys.size()) {
                i = -1;
                break;
            } else if (str.equals(((TL_account.Passkey) this.passkeys.get(i)).f1787id)) {
                break;
            } else {
                i++;
            }
        ...
        ItemOptions.makeOptions(this, passkeyCell).add(C2702R.drawable.msg_delete, (CharSequence) LocaleController.getString(C2702R.string.Delete), true, new Runnable() { // from class: org.telegram.ui.PasskeysActivity$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$openMenu$5(final TL_account.Passkey passkey, final String str, final int i) {
        new AlertDialog.Builder(getContext()).setTitle(LocaleController.getString(C2702R.string.PasskeyDeleteTitle)).setMessage(LocaleController.getString(C2702R.string.PasskeyDeleteText)).setPositiveButton(LocaleController.getString(C2702R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.PasskeysActivity$$ExternalSyntheticLambda9
    ...
    public /* synthetic */ void lambda$openMenu$3(int i, TL_account.Passkey passkey, TLRPC.Bool bool, TLRPC.TL_error tL_error) {
        if (bool instanceof TLRPC.TL_boolFalse) {
            BulletinFactory.m1195of(this).showForError("FALSE");
    ...
    public /* synthetic */ void lambda$onItemClick$6(TL_account.Passkey passkey, String str) {
        ...
        if ("EMPTY".equalsIgnoreCase(str)) {
            new AlertDialog.Builder(getContext()).setTitle(LocaleController.getString(C2702R.string.PasskeyNoOptionsTitle)).setMessage(LocaleController.getString(C2702R.string.PasskeyNoOptionsText)).setPositiveButton(LocaleController.getString(C2702R.string.f1556OK), null).show();
            return;
        }
        BulletinFactory bulletinFactoryM1195of = BulletinFactory.m1195of(this);
        if (str.startsWith("No create options")) {
            PasskeysUtil.showUnsupportedBulletin(bulletinFactoryM1195of);
        } else {
            bulletinFactoryM1195of.showForError(str, true);
        }
    }
    ...
    public void added(TL_account.Passkey passkey) {
        ...
        BulletinFactory.m1195of(this).createSimpleBulletin(C2702R.raw.passcode_lock_close, LocaleController.getString(C2702R.string.PasskeyAddedTitle), LocaleController.formatString(C2702R.string.PasskeyAddedText, passkey.name)).setDuration(5000).show(true);
    }
    ...
    public static class PasskeyCell extends FrameLayout {
        ...
        public PasskeyCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
            ...
            backupImageView.setImageResource(C2702R.drawable.msg2_permissions);
            ...
            imageView.setImageResource(C2702R.drawable.ic_ab_other);
        ...
        public void set(TL_account.Passkey passkey, View.OnClickListener onClickListener, boolean z) {
            ...
            if (j != 0) {
                ...
                frameLayout.setBackground(Theme.createRoundRectDrawable(iM1081dp, Theme.multAlpha(Theme.getColor(i, this.resourcesProvider), 0.04f)));
                ...
                this.imageView.setImageResource(C2702R.drawable.msg2_permissions);
            ...
            if (TextUtils.isEmpty(passkey.name)) {
                this.titleView.setText(LocaleController.getString(C2702R.string.PasskeyUnknown));
            } else {
                this.titleView.setText(passkey.name);
            }
            int i2 = passkey.last_usage_date;
            if (i2 != 0) {
                this.subtitleView.setText(LocaleController.formatString(C2702R.string.PasskeyLastUsedOn, LocaleController.formatDateTime(i2, false)));
            } else {
                this.subtitleView.setText(LocaleController.formatString(C2702R.string.PasskeyCreatedOn, LocaleController.formatDateTime(passkey.date, false)));
            }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (this.needDivider) {
                ...
                canvas.drawRect(AndroidUtilities.m1081dp(LocaleController.isRTL ? 0.0f : 72.0f), getMeasuredHeight() - 1, getWidth() - AndroidUtilities.m1081dp(LocaleController.isRTL ? 72.0f : 0.0f), getMeasuredHeight(), themePaint);
            }
        }
        ...
        public static class Factory extends UItem.UItemFactory {
            ...
            public static UItem m1240of(TL_account.Passkey passkey, View.OnClickListener onClickListener) {
    ...
    public static void showLearnSheet(final Context context, final int i, Theme.ResourcesProvider resourcesProvider, boolean z) {
        ...
        rLottieImageView.setAnimation(C2702R.raw.passkey, AndroidUtilities.m1081dp(115.0f), AndroidUtilities.m1081dp(115.0f));
        ...
        textViewMakeTextView.setText(LocaleController.getString(C2702R.string.PasskeyFeatureTitle));
        ...
        textViewMakeTextView2.setText(LocaleController.getString(C2702R.string.PasskeyFeatureSubtitle));
        ...
        featureCell.set(C2702R.drawable.msg2_permissions, LocaleController.getString(C2702R.string.PasskeyFeature1Title), LocaleController.getString(C2702R.string.PasskeyFeature1Subtitle));
        ...
        featureCell2.set(C2702R.drawable.menu_face, LocaleController.getString(C2702R.string.PasskeyFeature2Title), LocaleController.getString(C2702R.string.PasskeyFeature2Subtitle));
        ...
        featureCell3.set(C2702R.drawable.menu_privacy, LocaleController.getString(C2702R.string.PasskeyFeature3Title), LocaleController.getString(C2702R.string.PasskeyFeature3Subtitle));
        ...
        round.setText(LocaleController.getString(C2702R.string.PasskeyFeatureButton), false);
    ...
    public static /* synthetic */ void $r8$lambda$YbuzlWVIPDdYORbpgGojRqxLWg4(ButtonWithCounterView buttonWithCounterView, Context context, final BottomSheet bottomSheet, int i, final TL_account.Passkey passkey, String str) {
        ...
        if ("EMPTY".equalsIgnoreCase(str)) {
            new AlertDialog.Builder(context).setTitle(LocaleController.getString(C2702R.string.PasskeyNoOptionsTitle)).setMessage(LocaleController.getString(C2702R.string.PasskeyNoOptionsText)).setPositiveButton(LocaleController.getString(C2702R.string.f1556OK), null).setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.PasskeysActivity$$ExternalSyntheticLambda11
        ...
        final BulletinFactory bulletinFactoryM1194of = BulletinFactory.m1194of(bottomSheet.topBulletinContainer, bottomSheet.getResourcesProvider());
        if (str != null) {
            if (str.startsWith("No create options")) {
                PasskeysUtil.showUnsupportedBulletin(bulletinFactoryM1194of);
                return;
            } else {
                bulletinFactoryM1194of.showForError(str);
                return;
            }
        }
        if (passkey != null) {
            ...
            ConnectionsManager.getInstance(i).sendRequestTyped(new TL_account.getPasskeys(), new BotForumHelper$$ExternalSyntheticLambda2(), new Utilities.Callback2() { // from class: org.telegram.ui.PasskeysActivity$$ExternalSyntheticLambda12
                @Override // org.telegram.messenger.Utilities.Callback2
                public final void run(Object obj, Object obj2) {
                    PasskeysActivity.m15062$r8$lambda$IjsLdKNQgpIsFobjMO60p983YE(bottomSheet, passkey, bulletinFactoryM1194of, (TL_account.Passkeys) obj, (TLRPC.TL_error) obj2);
                }
            });
        }
    }
    ...
    public static /* synthetic */ void m15062$r8$lambda$IjsLdKNQgpIsFobjMO60p983YE(BottomSheet bottomSheet, final TL_account.Passkey passkey, BulletinFactory bulletinFactory, TL_account.Passkeys passkeys, TLRPC.TL_error tL_error) {
        if (passkeys == null) {
            if (tL_error != null) {
        ...
        while (i < passkeys.passkeys.size()) {
            if (TextUtils.equals(passkeys.passkeys.get(i).f1787id, passkey.f1787id)) {
