...
public abstract class CodeFieldContainer extends LinearLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        float fM1081dp = AndroidUtilities.m1081dp(1.5f);
        this.strokeWidth = fM1081dp;
        paint.setStrokeWidth(fM1081dp);
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (childAt instanceof CodeNumberField) {
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.m1081dp(4.0f), AndroidUtilities.m1081dp(4.0f), this.paint);
            }
        }
    ...
    */
    public void setNumbersCount(int r13, int r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.CodeFieldContainer.setNumbersCount(int, int):void");
    }

    /* JADX INFO: renamed from: org.telegram.ui.CodeFieldContainer$1 */
    class C35781 extends CodeNumberField {
        final /* synthetic */ int val$length;
        final /* synthetic */ int val$num;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C35781(Context context, int i, int i2) {
            super(context);
            i = i;
            i = i2;
        }
    ...
    class C35792 implements TextWatcher {
        final /* synthetic */ int val$length;
        final /* synthetic */ int val$num;
