...
public class DilogCacheBottomSheet extends BottomSheetWithRecyclerListView {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.DilogCacheBottomSheet$1 */
    class C53701 extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                CombinedDrawable combinedDrawable = new CombinedDrawable(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundGray)), Theme.getThemedDrawableByKey(viewGroup.getContext(), C2702R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
    ...
    public DilogCacheBottomSheet(CacheControlActivity cacheControlActivity, CacheControlActivity.DialogFileEntities dialogFileEntities, final CacheModel cacheModel, Delegate delegate) {
        String string;
        int i;
        boolean z;
        long j;
        ...
        C53712 c53712 = new StorageDiagramView(getContext(), dialogFileEntities.dialogId) { // from class: org.telegram.ui.DilogCacheBottomSheet.2
            final /* synthetic */ Delegate val$delegate;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C53712(Context context2, long j2, Delegate delegate2) {
                super(context2, j2);
                delegate = delegate2;
            }

            @Override // org.telegram.p026ui.Components.StorageDiagramView
            protected void onAvatarClick() {
                delegate.onAvatarClick();
            }
        };
        this.circleDiagramView = c53712;
        this.linearLayout.addView(c53712, LayoutHelper.createLinear(-2, -2, 1, 0, 16, 0, 16));
        CheckBoxCell checkBoxCell = null;
        int i2 = 0;
        for (int i3 = 8; i2 < i3; i3 = 8) {
            if (i2 == 0) {
                string = LocaleController.getString(C2702R.string.LocalPhotoCache);
                i = Theme.key_statisticChartLine_lightblue;
            } else if (i2 == 1) {
                string = LocaleController.getString(C2702R.string.LocalVideoCache);
                i = Theme.key_statisticChartLine_blue;
            } else if (i2 == 2) {
                string = LocaleController.getString(C2702R.string.LocalDocumentCache);
                i = Theme.key_statisticChartLine_green;
            } else if (i2 == 3) {
                string = LocaleController.getString(C2702R.string.LocalMusicCache);
                i = Theme.key_statisticChartLine_red;
            } else if (i2 == 4) {
                string = LocaleController.getString(C2702R.string.LocalAudioCache);
                i = Theme.key_statisticChartLine_lightgreen;
            } else if (i2 == 5) {
                string = LocaleController.getString(C2702R.string.LocalStickersCache);
                i = Theme.key_statisticChartLine_orange;
            } else if (i2 == 7) {
                string = LocaleController.getString(C2702R.string.LocalStoriesCache);
                i = Theme.key_statisticChartLine_indigo;
            } else {
                string = LocaleController.getString(C2702R.string.LocalMiscellaneousCache);
        ...
        C53723 c53723 = new CachedMediaLayout(getContext(), cacheControlActivity) { // from class: org.telegram.ui.DilogCacheBottomSheet.3
            C53723(Context context2, BaseFragment cacheControlActivity2) {
            ...
            protected void onMeasure(int i4, int i5) {
                super.onMeasure(i4, View.MeasureSpec.makeMeasureSpec((((BottomSheetWithRecyclerListView) DilogCacheBottomSheet.this).contentHeight - ActionBar.getCurrentActionBarHeight()) - AndroidUtilities.statusBarHeight, TLObject.FLAG_30));
            }
        };
        this.cachedMediaLayout = c53723;
        c53723.setBottomPadding(AndroidUtilities.m1081dp(80.0f));
        ...
        this.cachedMediaLayout.setDelegate(new CachedMediaLayout.Delegate() { // from class: org.telegram.ui.DilogCacheBottomSheet.4
            ...
            C53734(final CacheModel cacheModel2) {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.DilogCacheBottomSheet$2 */
    class C53712 extends StorageDiagramView {
        final /* synthetic */ Delegate val$delegate;
    ...
    /* JADX INFO: renamed from: org.telegram.ui.DilogCacheBottomSheet$3 */
    class C53723 extends CachedMediaLayout {
        C53723(Context context2, BaseFragment cacheControlActivity2) {
            super(context2, cacheControlActivity2);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.DilogCacheBottomSheet$4 */
    class C53734 implements CachedMediaLayout.Delegate {
        final /* synthetic */ CacheModel val$cacheModel;
    ...
    /* JADX INFO: renamed from: org.telegram.ui.DilogCacheBottomSheet$5 */
    class C53745 extends RecyclerView.OnScrollListener {
        C53745() {
        }
    ...
    public /* synthetic */ void lambda$createButton$3(View view) {
        ...
        builder.setMessage(LocaleController.getString(C2702R.string.ClearCacheForChat));
        builder.setNegativeButton(LocaleController.getString(C2702R.string.Cancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.DilogCacheBottomSheet$$ExternalSyntheticLambda2
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
                this.f$0.lambda$createButton$1(alertDialog, i);
            }
        });
        builder.setPositiveButton(LocaleController.getString(C2702R.string.Clear), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.DilogCacheBottomSheet$$ExternalSyntheticLambda3
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
