...
public class FiltersView extends RecyclerListView {
    ...
    public static final MediaFilterData[] filters = {new MediaFilterData(C2702R.drawable.search_media_filled, C2702R.string.SharedMediaTab2, new TLRPC.TL_inputMessagesFilterPhotoVideo(), 0), new MediaFilterData(C2702R.drawable.search_links_filled, C2702R.string.SharedLinksTab2, new TLRPC.TL_inputMessagesFilterUrl(), 2), new MediaFilterData(C2702R.drawable.search_files_filled, C2702R.string.SharedFilesTab2, new TLRPC.TL_inputMessagesFilterDocument(), 1), new MediaFilterData(C2702R.drawable.search_music_filled, C2702R.string.SharedMusicTab2, new TLRPC.TL_inputMessagesFilterMusic(), 3), new MediaFilterData(C2702R.drawable.search_voice_filled, C2702R.string.SharedVoiceTab2, new TLRPC.TL_inputMessagesFilterRoundVoice(), 5)};
    ...
    class C29361 extends LinearLayoutManager {
    ...
    public FiltersView(Context context, Theme.ResourcesProvider resourcesProvider) {
                    ...
                    if (i3 == 4) {
                        ...
                        if (tLObject instanceof TLRPC.User) {
                            ...
                            if (tLObject2 instanceof TLRPC.User) {
                                return ((TLRPC.User) tLObject).f1775id == ((TLRPC.User) tLObject2).f1775id;
                            }
                        }
                        if (tLObject instanceof TLRPC.Chat) {
                            TLObject tLObject3 = mediaFilterData2.chat;
                            return (tLObject3 instanceof TLRPC.Chat) && ((TLRPC.Chat) tLObject).f1610id == ((TLRPC.Chat) tLObject3).f1610id;
                        }
                    } else {
                        if (i3 == 6) {
        ...
        C29361 c29361 = new LinearLayoutManager(context) { // from class: org.telegram.ui.Adapters.FiltersView.1
            @Override // androidx.recyclerview.widget.LinearLayoutManager, androidx.recyclerview.widget.RecyclerView.LayoutManager
            public boolean supportsPredictiveItemAnimations() {
                return false;
            }

            C29361(Context context2) {
                super(context2);
            }
        ...
        this.layoutManager = c29361;
        c29361.setOrientation(0);
        ...
        addItemDecoration(new RecyclerView.ItemDecoration() { // from class: org.telegram.ui.Adapters.FiltersView.2
            ...
            public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
                ...
                rect.left = AndroidUtilities.m1081dp(8.0f);
                if (childAdapterPosition == state.getItemCount() - 1) {
                    rect.right = AndroidUtilities.m1081dp(10.0f);
                }
                if (childAdapterPosition == 0) {
                    rect.left = AndroidUtilities.m1081dp(10.0f);
                }
            }
        });
            ...
            protected void animateRemoveImpl(RecyclerView.ViewHolder viewHolder) {
                ...
                viewPropertyAnimatorAnimate.setDuration(getRemoveDuration()).alpha(0.0f).scaleX(0.0f).scaleY(0.0f).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Adapters.FiltersView.3.2
                    ...
                    public void onAnimationStart(Animator animator) {
                        C29383.this.dispatchRemoveStarting(viewHolder);
                    }
                    ...
                    public void onAnimationEnd(Animator animator) {
                        ...
                        view.setScaleX(1.0f);
                        view.setScaleY(1.0f);
                        C29383.this.dispatchRemoveFinished(viewHolder);
                        ((DefaultItemAnimator) C29383.this).mRemoveAnimations.remove(viewHolder);
                        C29383.this.dispatchFinishedWhenDone();
                    }
                }).start();
            }
        ...
        setSelectorRadius(AndroidUtilities.m1081dp(28.0f));
    ...
    class C29372 extends RecyclerView.ItemDecoration {
        C29372() {
        }
    ...
    class C29383 extends DefaultItemAnimator {
        private final float scaleFrom = 0.0f;
    ...
    public void setUsersAndDates(ArrayList arrayList, ArrayList arrayList2, boolean z) {
            ...
            for (int i = 0; i < arrayList.size(); i++) {
                ...
                if (obj instanceof TLRPC.User) {
                    ...
                    if (UserConfig.getInstance(UserConfig.selectedAccount).getCurrentUser().f1775id == user.f1775id) {
                        name = LocaleController.getString(C2702R.string.SavedMessages);
                    } else {
                        name = ContactsController.formatName(user.first_name, user.last_name, 10);
                    }
                    MediaFilterData mediaFilterData = new MediaFilterData(C2702R.drawable.search_users_filled, name, (TLRPC.MessagesFilter) null, 4);
                    ...
                    MediaFilterData mediaFilterData2 = new MediaFilterData(C2702R.drawable.search_users_filled, str, (TLRPC.MessagesFilter) null, 4);
        ...
        if (arrayList2 != null) {
            for (int i2 = 0; i2 < arrayList2.size(); i2++) {
                ...
                MediaFilterData mediaFilterData3 = new MediaFilterData(C2702R.drawable.search_date_filled, dateData.title, (TLRPC.MessagesFilter) null, 6);
                mediaFilterData3.setDate(dateData);
                this.usersFilters.add(mediaFilterData3);
            }
        }
        if (z) {
            this.usersFilters.add(new MediaFilterData(C2702R.drawable.chats_archive, C2702R.string.ArchiveSearchFilter, (TLRPC.MessagesFilter) null, 7));
        }
        if (getAdapter() != null) {
    ...
    public static void fillTipDates(String str, ArrayList arrayList) {
        ...
        if (LocaleController.getString(C2702R.string.SearchTipToday).toLowerCase().startsWith(strTrim) || "today".startsWith(strTrim)) {
            ...
            arrayList.add(new DateData(LocaleController.getString(C2702R.string.SearchTipToday), timeInMillis, calendar.getTimeInMillis() - 1));
            return;
        }
        if (LocaleController.getString(C2702R.string.SearchTipYesterday).toLowerCase().startsWith(strTrim) || "yesterday".startsWith(strTrim)) {
            ...
            arrayList.add(new DateData(LocaleController.getString(C2702R.string.SearchTipYesterday), timeInMillis2, calendar2.getTimeInMillis() - 86400001));
            return;
        }
    ...
    public static int getMonth(String str) {
        String[] strArr = {LocaleController.getString(C2702R.string.January).toLowerCase(), LocaleController.getString(C2702R.string.February).toLowerCase(), LocaleController.getString(C2702R.string.March).toLowerCase(), LocaleController.getString(C2702R.string.April).toLowerCase(), LocaleController.getString(C2702R.string.May).toLowerCase(), LocaleController.getString(C2702R.string.June).toLowerCase(), LocaleController.getString(C2702R.string.July).toLowerCase(), LocaleController.getString(C2702R.string.August).toLowerCase(), LocaleController.getString(C2702R.string.September).toLowerCase(), LocaleController.getString(C2702R.string.October).toLowerCase(), LocaleController.getString(C2702R.string.November).toLowerCase(), LocaleController.getString(C2702R.string.December).toLowerCase()};
    ...
    private class Adapter extends RecyclerListView.SelectionAdapter {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            viewHolder.itemView.setLayoutParams(new RecyclerView.LayoutParams(-2, AndroidUtilities.m1081dp(30.0f)));
            return viewHolder;
        }
    ...
    class C29394 extends DiffUtil.Callback {
        @Override // androidx.recyclerview.widget.DiffUtil.Callback
        public boolean areContentsTheSame(int i, int i2) {
            return true;
        }
    ...
    public static class FilterView extends FrameLayout {
        ...
        public void setData(MediaFilterData mediaFilterData) {
            ...
            if (mediaFilterData.filterType == 7) {
                CombinedDrawable combinedDrawableCreateCircleDrawableWithIcon = Theme.createCircleDrawableWithIcon(AndroidUtilities.m1081dp(32.0f), C2702R.drawable.chats_archive);
                this.thumbDrawable = combinedDrawableCreateCircleDrawableWithIcon;
                combinedDrawableCreateCircleDrawableWithIcon.setIconSize(AndroidUtilities.m1081dp(16.0f), AndroidUtilities.m1081dp(16.0f));
            ...
            CombinedDrawable combinedDrawableCreateCircleDrawableWithIcon2 = Theme.createCircleDrawableWithIcon(AndroidUtilities.m1081dp(32.0f), mediaFilterData.iconResFilled);
