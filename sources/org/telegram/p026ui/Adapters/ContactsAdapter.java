    ...
    */
    public static /* synthetic */ int $r8$lambda$ELiMIR3niEAcM_m7UV_uqfYJfuE(org.telegram.messenger.MessagesController r2, int r3, org.telegram.tgnet.TLRPC.TL_contact r4, org.telegram.tgnet.TLRPC.TL_contact r5) {
        ...
        L61:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Adapters.ContactsAdapter.$r8$lambda$ELiMIR3niEAcM_m7UV_uqfYJfuE(org.telegram.messenger.MessagesController, int, org.telegram.tgnet.TLRPC$TL_contact, org.telegram.tgnet.TLRPC$TL_contact):int");
    }
    ...
    */
    public int getSectionCount() {
        ...
        L66:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Adapters.ContactsAdapter.getSectionCount():int");
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(final ViewGroup viewGroup, int i) {
        ...
        if (i == 0) {
            ...
            if (i == 4) {
                FrameLayout frameLayout = new FrameLayout(this.mContext) { // from class: org.telegram.ui.Adapters.ContactsAdapter.2
                    ...
                    protected void onMeasure(int i2, int i3) {
                        ...
                        int iM1081dp = AndroidUtilities.m1081dp(50.0f);
                        int iM1081dp2 = ContactsAdapter.this.onlyUsers != 0 ? 0 : AndroidUtilities.m1081dp(30.0f) + iM1081dp;
                        ...
                        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i2), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(iM1081dp2 < paddingTop ? paddingTop - iM1081dp2 : 0, TLObject.FLAG_30));
                    }
                };
            ...
            dividerCell.setPadding(AndroidUtilities.m1081dp(LocaleController.isRTL ? 28.0f : 72.0f), AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(LocaleController.isRTL ? 72.0f : 28.0f), AndroidUtilities.m1081dp(8.0f));
    ...
    public void onBindViewHolder(int i, int i2, RecyclerView.ViewHolder viewHolder) {
        ...
        if (itemViewType == 0) {
            ...
            userCell.setChecked(this.selectedContacts.indexOfKey(user.f1775id) >= 0, false);
            LongSparseArray longSparseArray = this.ignoreUsers;
            if (longSparseArray != null) {
                if (longSparseArray.indexOfKey(user.f1775id) >= 0) {
        ...
        if (itemViewType != 1) {
            if (itemViewType == 2) {
                ...
                if (i5 == 0) {
                    ...
                    graySectionCell.setText(LocaleController.getString(C2702R.string.SortedByName));
                    return;
                } else {
                    graySectionCell.setText(LocaleController.getString(C2702R.string.SortedByLastSeen));
                    return;
                }
            }
            if (itemViewType == 4) {
                viewHolder.itemView.setPadding(0, AndroidUtilities.m1081dp(!this.hasPhonebook ? 96.0f : 25.0f), 0, AndroidUtilities.m1081dp(18.0f));
                return;
            }
            if (itemViewType != 7) {
                if (itemViewType != 8) {
            ...
            if (this.isEmptyWithMainTabs && i3 == 1 && i == 1) {
                headerCell.setText(LocaleController.getString(C2702R.string.InviteFriends));
                return;
            } else if (this.sortType == 1) {
                headerCell.setText(LocaleController.getString(C2702R.string.SortedByName));
                return;
            } else {
                headerCell.setText(LocaleController.getString(C2702R.string.SortedByLastSeen));
                return;
            }
        }
        ...
        if (i == 0) {
            if (this.needPhonebook) {
                if (i3 == 0) {
                    textCell.setTextAndValueAndColorfulIcon(LocaleController.getString(C2702R.string.InviteFriends), _UrlKt.FRAGMENT_ENCODE_SET, false, C2702R.drawable.settings_invite, -14899731, -15431455, false);
                    return;
                } else {
                    if (i3 == 1) {
                        textCell.setTextAndValueAndColorfulIcon(LocaleController.getString(C2702R.string.RecentCalls), _UrlKt.FRAGMENT_ENCODE_SET, false, C2702R.drawable.settings_calls, -11154873, -14175180, false);
                        return;
                    }
                    return;
                }
            ...
            if (this.isAdmin) {
                if (this.isChannel) {
                    textCell.setTextAndIcon((CharSequence) LocaleController.getString(C2702R.string.ChannelInviteViaLink), C2702R.drawable.msg_link2, false);
                    return;
                } else {
                    textCell.setTextAndIcon((CharSequence) LocaleController.getString(C2702R.string.InviteToGroupByLink), C2702R.drawable.msg_link2, false);
                    return;
                }
            }
            if (i3 == 0) {
                textCell.setTextAndValueAndColorfulIcon(LocaleController.getString(C2702R.string.NewGroup), _UrlKt.FRAGMENT_ENCODE_SET, false, C2702R.drawable.settings_group, -14899731, -15431455, false);
                return;
            } else {
                if (i3 == 1) {
                    textCell.setTextAndValueAndColorfulIcon(LocaleController.getString(C2702R.string.NewChannel), _UrlKt.FRAGMENT_ENCODE_SET, false, C2702R.drawable.settings_channel, -11154873, -14175180, false);
                    return;
                }
                return;
            }
