...
import org.telegram.p026ui.Cells.BotSwitchCell;
import org.telegram.p026ui.Cells.ContextLinkCell;
import org.telegram.p026ui.Cells.MentionCell;
...
public class MentionsAdapter extends RecyclerListView.SelectionAdapter implements NotificationCenter.NotificationCenterDelegate {
    ...
    private SendMessagesHelper.LocationProvider locationProvider = new SendMessagesHelper.LocationProvider(new SendMessagesHelper.LocationProvider.LocationProviderDelegate() { // from class: org.telegram.ui.Adapters.MentionsAdapter.1
        ...
        C29412(SendMessagesHelper.LocationProvider.LocationProviderDelegate locationProviderDelegate) {
    ...
    class C29401 implements SendMessagesHelper.LocationProvider.LocationProviderDelegate {
        C29401() {
        }
    ...
    class C29412 extends SendMessagesHelper.LocationProvider {
        C29412(SendMessagesHelper.LocationProvider.LocationProviderDelegate locationProviderDelegate) {
            super(locationProviderDelegate);
        }
    ...
    class C29423 implements SearchAdapterHelper.SearchAdapterHelperDelegate {
        @Override // org.telegram.ui.Adapters.SearchAdapterHelper.SearchAdapterHelperDelegate
        public /* synthetic */ boolean canApplySearchResults(int i) {
            return SearchAdapterHelper.SearchAdapterHelperDelegate.CC.$default$canApplySearchResults(this, i);
        }
    ...
    private void addStickerToResult(TLRPC.Document document, Object obj) {
        ...
        String str = document.dc_id + "_" + document.f1618id;
    ...
    */
    public void notifyDataSetChanged() {
        ...
        L7d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Adapters.MentionsAdapter.notifyDataSetChanged():void");
    }
    ...
    private boolean itemsEqual(Object obj, Object obj2) {
        ...
        if ((obj instanceof TLRPC.User) && (obj2 instanceof TLRPC.User) && ((TLRPC.User) obj).f1775id == ((TLRPC.User) obj2).f1775id) {
            return true;
        }
        if ((obj instanceof TLRPC.Chat) && (obj2 instanceof TLRPC.Chat) && ((TLRPC.Chat) obj).f1610id == ((TLRPC.Chat) obj2).f1610id) {
            return true;
        }
    ...
    public TLRPC.TL_inlineBotSwitchPM getBotContextSwitch() {
        ...
        if (user == null || user.f1775id == this.searchResultBotContextSwitchUserId) {
    ...
    public void processFoundUser(TLRPC.User user) {
        ...
        if (user != null && user.bot && user.bot_inline_placeholder != null) {
            ...
            if (this.foundContextBot.bot_inline_geo) {
                if (!MessagesController.getNotificationsSettings(this.currentAccount).getBoolean("inlinegeo_" + this.foundContextBot.f1775id, false) && (chatActivity = this.parentFragment) != null && chatActivity.getParentActivity() != null) {
                    ...
                    builder.setTitle(LocaleController.getString(C2702R.string.ShareYouLocationTitle));
                    builder.setMessage(LocaleController.getString(C2702R.string.ShareYouLocationInline));
                    final boolean[] zArr = new boolean[1];
                    builder.setPositiveButton(LocaleController.getString(C2702R.string.f1556OK), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Adapters.MentionsAdapter$$ExternalSyntheticLambda0
                        @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                        public final void onClick(AlertDialog alertDialog, int i) {
                            this.f$0.lambda$processFoundUser$2(zArr, user2, alertDialog, i);
                        }
                    });
                    builder.setNegativeButton(LocaleController.getString(C2702R.string.Cancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Adapters.MentionsAdapter$$ExternalSyntheticLambda1
                        @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                        public final void onClick(AlertDialog alertDialog, int i) {
    ...
    public /* synthetic */ void lambda$processFoundUser$2(boolean[] zArr, TLRPC.User user, AlertDialog alertDialog, int i) {
        zArr[0] = true;
        if (user != null) {
            MessagesController.getNotificationsSettings(this.currentAccount).edit().putBoolean("inlinegeo_" + user.f1775id, true).apply();
            checkLocationPermissionsOrStart();
        }
    }
    ...
    */
    private void searchForContextBot(java.lang.String r8, java.lang.String r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Adapters.MentionsAdapter.searchForContextBot(java.lang.String, java.lang.String):void");
    }

    /* JADX INFO: renamed from: org.telegram.ui.Adapters.MentionsAdapter$4 */
    /* JADX INFO: loaded from: classes6.dex */
    class RunnableC29434 implements Runnable {
        ...
        RunnableC29434(String str, String str2, MessagesController messagesController, MessagesStorage messagesStorage) {
            this.val$query = str;
    ...
    public String getBotCaption() {
        ...
        return LocaleController.getString(C2702R.string.SearchGifsTitle);
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:916:0x045c, code lost:
    
        r12 = -1;
        r14 = r14;
     */
    /* JADX WARN: Code restructure failed: missing block: B:934:0x049c, code lost:
    ...
    /* JADX WARN: Removed duplicated region for block: B:1057:0x06ae  */
    /* JADX WARN: Removed duplicated region for block: B:1060:0x06bb  */
    /* JADX WARN: Removed duplicated region for block: B:1063:0x06c3  */
    /* JADX WARN: Removed duplicated region for block: B:1065:0x06cd  */
    /* JADX WARN: Removed duplicated region for block: B:1072:0x06ed A[PHI: r22
  0x06ed: PHI (r22v7 boolean) = (r22v6 boolean), (r22v6 boolean), (r22v6 boolean), (r22v8 boolean) binds: [B:1071:0x06eb, B:1068:0x06db, B:1064:0x06cb, B:1058:0x06b8] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:884:0x03da  */
    /* JADX WARN: Removed duplicated region for block: B:939:0x04b4  */
    /* JADX WARN: Removed duplicated region for block: B:943:0x04be  */
    /* JADX WARN: Removed duplicated region for block: B:948:0x04c9  */
    /* JADX WARN: Removed duplicated region for block: B:950:0x04cd  */
    /* JADX WARN: Removed duplicated region for block: B:953:0x04d6  */
    /* JADX WARN: Removed duplicated region for block: B:955:0x04df  */
    /* JADX WARN: Removed duplicated region for block: B:957:0x04ea  */
    ...
    */
    public void lambda$searchUsernameOrHashtag$7(final java.lang.CharSequence r26, int r27, java.util.ArrayList r28, final boolean r29, final boolean r30) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Adapters.MentionsAdapter.lambda$searchUsernameOrHashtag$7(java.lang.CharSequence, int, java.util.ArrayList, boolean, boolean):void");
    }

    /* JADX INFO: renamed from: org.telegram.ui.Adapters.MentionsAdapter$5 */
    /* JADX INFO: loaded from: classes6.dex */
    class C29445 implements Comparator {
        final /* synthetic */ ArrayList val$favsStickers;
        final /* synthetic */ ArrayList val$recentStickers;

        C29445(ArrayList arrayList, ArrayList arrayList2) {
            arrayList = arrayList;
        ...
        private int getIndex(StickerResult stickerResult) {
            for (int i = 0; i < arrayList.size(); i++) {
                if (((TLRPC.Document) arrayList.get(i)).f1618id == stickerResult.sticker.f1618id) {
                    return i + 2000000;
                }
            }
            for (int i2 = 0; i2 < Math.min(20, arrayList.size()); i2++) {
                if (((TLRPC.Document) arrayList.get(i2)).f1618id == stickerResult.sticker.f1618id) {
                    return (arrayList.size() - i2) + 1000000;
                }
            }
            return -1;
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C29456 implements Comparator {
        final /* synthetic */ LongSparseArray val$newMap;
        final /* synthetic */ ArrayList val$users;

        C29456(LongSparseArray longSparseArray, ArrayList arrayList) {
        ...
        private long getId(TLObject tLObject) {
            if (tLObject instanceof TLRPC.User) {
                return ((TLRPC.User) tLObject).f1775id;
            }
            return -((TLRPC.Chat) tLObject).f1610id;
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class RunnableC29467 implements Runnable {
        ...
        RunnableC29467(TLRPC.Chat chat, String str, long j, ArrayList arrayList, LongSparseArray longSparseArray, MessagesController messagesController) {
            this.val$chat = chat;
        ...
        public void run() {
            ...
            tL_channelParticipantsMentions.f1609q = this.val$usernameString;
        ...
        if ((!this.allowBots || !this.allowChats) && arrayList != null) {
            ...
            while (it.hasNext()) {
                ...
                if ((tLObject instanceof TLRPC.Chat) && !this.allowChats) {
                    ...
                    if (user.bot || UserObject.isService(user.f1775id)) {
                        it.remove();
                    }
                }
            }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C29478 extends View {
        C29478(Context context) {
            super(context);
        }

        @Override // android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(8.0f), TLObject.FLAG_30));
        }
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        if (i == 0) {
            ...
            if (i == 3) {
                ...
                textView.setPadding(AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(8.0f));
                ...
                View c29478 = new View(this.mContext) { // from class: org.telegram.ui.Adapters.MentionsAdapter.8
                    C29478(Context context) {
                        super(context);
                    }
                    ...
                    protected void onMeasure(int i2, int i22) {
                        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i2), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(8.0f), TLObject.FLAG_30));
                    }
                };
                CombinedDrawable combinedDrawable = new CombinedDrawable(new ColorDrawable(this.stories ? Theme.multAlpha(-1, 0.15f) : Theme.getColor(Theme.key_windowBackgroundGray, this.resourcesProvider)), Theme.getThemedDrawable(this.mContext, C2702R.drawable.greydivider, Theme.getColor(Theme.key_windowBackgroundGrayShadow, this.resourcesProvider)), 0, 0);
                combinedDrawable.setFullsize(true);
                c29478.setBackground(combinedDrawable);
                view = c29478;
            } else {
        ...
        if (itemViewType == 3) {
            ...
            if (currentChat != null) {
                if (!ChatObject.hasAdminRights(currentChat) && (tL_chatBannedRights = currentChat.default_banned_rights) != null && tL_chatBannedRights.send_inline) {
                    textView.setText(LocaleController.getString(C2702R.string.GlobalAttachInlineRestricted));
                    return;
                } else if (AndroidUtilities.isBannedForever(currentChat.banned_rights)) {
                    textView.setText(LocaleController.getString(C2702R.string.AttachInlineRestrictedForever));
                    return;
                } else {
                    textView.setText(LocaleController.formatString("AttachInlineRestricted", C2702R.string.AttachInlineRestricted, LocaleController.formatDateForBan(currentChat.banned_rights.until_date)));
                    return;
                }
            }
            return;
    ...
    public void doSomeStickersAction() {
        ...
        if (isStickers()) {
            if (this.mentionsStickersActionTracker == null) {
                ...
                C29489 c29489 = new EmojiView.ChooseStickerActionTracker(this.currentAccount, this.dialog_id, this.threadMessageId) { // from class: org.telegram.ui.Adapters.MentionsAdapter.9
                    C29489(int i, long j, long j2) {
                        super(i, j, j2);
                    }
                ...
                mentionsAdapter.mentionsStickersActionTracker = c29489;
                c29489.checkVisibility();
            } else {
                mentionsAdapter = this;
            }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C29489 extends EmojiView.ChooseStickerActionTracker {
        C29489(int i, long j, long j2) {
            super(i, j, j2);
        }
    ...
    public static class HashtagHint extends LinearLayout {
        ...
        public void set(int i, String str, TLRPC.Chat chat) {
            ...
            if (i == 0) {
                CombinedDrawable combinedDrawable = new CombinedDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m1081dp(28.0f), Theme.getColor(Theme.key_featuredStickers_addButton, this.resourcesProvider)), getContext().getResources().getDrawable(C2702R.drawable.menu_hashtag).mutate());
                combinedDrawable.setIconOffset(AndroidUtilities.m1081dp(-0.66f), 0);
                combinedDrawable.setIconSize(AndroidUtilities.m1081dp(20.0f), AndroidUtilities.m1081dp(20.0f));
                this.imageView.setImageDrawable(combinedDrawable);
                this.titleView.setText(LocaleController.formatString(C2702R.string.HashtagSuggestion1Title, str));
                this.textView.setText(LocaleController.getString(C2702R.string.HashtagSuggestion1Text));
                return;
            }
            this.avatarDrawable.setInfo(chat);
            this.imageView.setForUserOrChat(chat, this.avatarDrawable);
            this.titleView.setText(PremiumPreviewFragment.applyNewSpan(LocaleController.formatString(C2702R.string.HashtagSuggestion2Title, str + "@" + ChatObject.getPublicUsername(chat)), 8));
            this.textView.setText(LocaleController.getString(C2702R.string.HashtagSuggestion2Text));
        }
