...
public class LocationActivityAdapter extends BaseLocationAdapter implements LocationController.LocationFetchCallback {
    ...
    public void setLiveLocations(ArrayList arrayList) {
        ...
        for (int i = 0; i < this.currentLiveLocations.size(); i++) {
            if (((LocationActivity.LiveLocation) this.currentLiveLocations.get(i)).f2079id == clientUserId || ((LocationActivity.LiveLocation) this.currentLiveLocations.get(i)).object.out) {
        ...
        if (sendLocationCell != null) {
            ...
            if (i == 8) {
                if (!TextUtils.isEmpty(this.overrideAddressName)) {
                    ...
                    string = LocaleController.getString(C2702R.string.UnknownLocation);
                }
                this.sendLocationCell.setText(LocaleController.getString(C2702R.string.SetThisLocation), string);
            ...
            if (i == 4 || this.customLocation != null) {
                if (!TextUtils.isEmpty(this.overrideAddressName)) {
                    ...
                    if ((location == null && this.gpsLocation == null) || this.fetchingLocation) {
                        string2 = LocaleController.getString(C2702R.string.Loading);
                ...
                if (this.locationType == 4) {
                    this.sendLocationCell.setText(LocaleController.getString(C2702R.string.ChatSetThisLocation), string2);
                } else {
                    this.sendLocationCell.setText(LocaleController.getString(C2702R.string.SendSelectedLocation), string2);
                }
                this.sendLocationCell.setHasLocation(true);
                return;
            }
            if (this.gpsLocation != null) {
                sendLocationCell.setText(LocaleController.getString(C2702R.string.SendLocation), LocaleController.formatString(C2702R.string.AccurateTo, LocaleController.formatPluralString("Meters", (int) this.gpsLocation.getAccuracy(), new Object[0])));
                this.sendLocationCell.setHasLocation(true);
                return;
            }
            String string3 = LocaleController.getString(C2702R.string.SendLocation);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        switch (i) {
            ...
            case 10:
                ...
                new CombinedDrawable(new ColorDrawable(getThemedColor(Theme.key_windowBackgroundGray)), Theme.getThemedDrawableByKey(this.mContext, C2702R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow)).setFullsize(true);
    ...
    */
    public void onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder r13, int r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Adapters.LocationActivityAdapter.onBindViewHolder(androidx.recyclerview.widget.RecyclerView$ViewHolder, int):void");
    }
    ...
    */
    public int getItemViewType(int r12) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Adapters.LocationActivityAdapter.getItemViewType(int):int");
    }
