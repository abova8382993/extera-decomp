...
public class StickersSearchAdapter extends RecyclerListView.SelectionAdapter {
    ...
    private Runnable searchRunnable = new RunnableC29571();
    ...
    class RunnableC29571 implements Runnable {
        RunnableC29571() {
        }
        ...
        */
        public void run() {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Adapters.StickersSearchAdapter.RunnableC29571.run():void");
        }
        ...
        public /* synthetic */ void lambda$run$1(TLRPC.TL_messages_searchStickerSets tL_messages_searchStickerSets, TLObject tLObject) {
            if (tL_messages_searchStickerSets.f1729q.equals(StickersSearchAdapter.this.searchQuery)) {
                clear();
            ...
            if (tL_messages_getStickers.emoticon.equals(StickersSearchAdapter.this.searchQuery)) {
                ...
                if (tLObject instanceof TLRPC.TL_messages_stickers) {
                    ...
                    for (int i = 0; i < size2; i++) {
                        ...
                        if (longSparseArray.indexOfKey(document.f1618id) < 0) {
    ...
    class C29582 extends StickerEmojiCell {
        C29582(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
    ...
    public /* synthetic */ void lambda$onCreateViewHolder$0(View view) {
        ...
        if (stickerSet == null || this.installingStickerSets.indexOfKey(stickerSet.set.f1646id) >= 0 || this.removingStickerSets.indexOfKey(stickerSet.set.f1646id) >= 0) {
            return;
        }
        if (featuredStickerSetInfoCell.isInstalled()) {
            this.removingStickerSets.put(stickerSet.set.f1646id, stickerSet);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        if (i == 0) {
            C29582 c29582 = new StickerEmojiCell(this.context, false, this.resourcesProvider) { // from class: org.telegram.ui.Adapters.StickersSearchAdapter.2
                C29582(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
                    super(context, z, resourcesProvider);
                }
            ...
            c29582.getImageView().setLayerNum(3);
            stickerSetNameCell = c29582;
        } else if (i == 1) {
            ...
            this.emptyImageView.setImageResource(C2702R.drawable.stickers_empty);
            ...
            linearLayout.setMinimumHeight(AndroidUtilities.m1081dp(112.0f));
    ...
    public void installStickerSet(TLRPC.StickerSetCovered stickerSetCovered, FeaturedStickerSetInfoCell featuredStickerSetInfoCell) {
        ...
        while (true) {
            ...
            if (stickerSetCoveredArr[i] != null) {
                TLRPC.TL_messages_stickerSet stickerSetById = MediaDataController.getInstance(this.currentAccount).getStickerSetById(this.primaryInstallingStickerSets[i].set.f1646id);
                if (stickerSetById != null && !stickerSetById.set.archived) {
                    this.primaryInstallingStickerSets[i] = null;
                    break;
                } else if (this.primaryInstallingStickerSets[i].set.f1646id == stickerSetCovered.set.f1646id) {
                    return;
                }
            }
            i++;
        ...
        this.installingStickerSets.put(stickerSetCovered.set.f1646id, stickerSetCovered);
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            if (stickerSetCovered2 != null && stickerSetCovered2.set.f1646id == stickerSetCovered.set.f1646id) {
    ...
    private void bindFeaturedStickerSetInfoCell(FeaturedStickerSetInfoCell featuredStickerSetInfoCell, int i, boolean z) {
        ...
        boolean z4 = unreadStickerSets != null && unreadStickerSets.contains(Long.valueOf(stickerSetCovered.set.f1646id));
        int i2 = 0;
        while (true) {
            TLRPC.StickerSetCovered[] stickerSetCoveredArr = this.primaryInstallingStickerSets;
            ...
            if (stickerSetCoveredArr[i2] != null) {
                TLRPC.TL_messages_stickerSet stickerSetById = MediaDataController.getInstance(this.currentAccount).getStickerSetById(this.primaryInstallingStickerSets[i2].set.f1646id);
                if (stickerSetById != null && !stickerSetById.set.archived) {
                    this.primaryInstallingStickerSets[i2] = null;
                } else if (this.primaryInstallingStickerSets[i2].set.f1646id == stickerSetCovered.set.f1646id) {
                    z2 = true;
                    break;
                }
            }
        ...
        if (z4) {
            mediaDataController.markFeaturedStickersByIdAsRead(false, stickerSetCovered.set.f1646id);
        }
        boolean z5 = this.installingStickerSets.indexOfKey(stickerSetCovered.set.f1646id) >= 0;
        boolean z6 = this.removingStickerSets.indexOfKey(stickerSetCovered.set.f1646id) >= 0;
        if (z5 || z6) {
            if (z5 && featuredStickerSetInfoCell2.isInstalled()) {
                this.installingStickerSets.remove(stickerSetCovered.set.f1646id);
                z5 = false;
            } else if (z6 && !featuredStickerSetInfoCell2.isInstalled()) {
                this.removingStickerSets.remove(stickerSetCovered.set.f1646id);
            }
        }
