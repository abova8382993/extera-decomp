...
public abstract class DialogsSearchAdapter extends RecyclerListView.SelectionAdapter {
    ...
    public enum Filter {
        All(0, C2702R.string.SearchMessagesFilterAll, C2702R.string.SearchMessagesFilterAllFrom),
        Private(8, C2702R.string.SearchMessagesFilterPrivate, C2702R.string.SearchMessagesFilterPrivateFrom),
        Groups(4, C2702R.string.SearchMessagesFilterGroup, C2702R.string.SearchMessagesFilterGroupFrom),
        Channels(2, C2702R.string.SearchMessagesFilterChannels, C2702R.string.SearchMessagesFilterChannelsFrom);
    ...
    public static class CategoryAdapterRecycler extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            hintDialogCell.setLayoutParams(new RecyclerView.LayoutParams(AndroidUtilities.m1081dp(80.0f), AndroidUtilities.m1081dp(86.0f)));
        ...
        try {
            ...
            if (!arrayList3.isEmpty()) {
                ...
                for (int i3 = 0; i3 < arrayList6.size(); i3++) {
                    RecentSearchObject recentSearchObject3 = (RecentSearchObject) longSparseArray.get(DialogObject.makeEncryptedDialogId(arrayList6.get(i3).f1622id));
            ...
            if (!arrayList.isEmpty()) {
                ...
                for (int i5 = 0; i5 < arrayList5.size(); i5++) {
                    ...
                    RecentSearchObject recentSearchObject6 = (RecentSearchObject) longSparseArray.get(user.f1775id);
    ...
    */
    public /* synthetic */ void lambda$searchDialogsInternal$13(java.lang.String r17, int r18, java.lang.String r19) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Adapters.DialogsSearchAdapter.lambda$searchDialogsInternal$13(java.lang.String, int, java.lang.String):void");
    }
    ...
    public void searchDialogs(final String str, int i, boolean z) {
        ...
        if (!TextUtils.equals(this.sponsoredQuery, strTrim)) {
            ...
            if (strTrim == null || strTrim.length() < 4 || RemoteUtils.getBooleanConfigValue("hide_ads", false).booleanValue() || (UserConfig.getInstance(this.currentAccount).isPremium() && MessagesController.getInstance(this.currentAccount).isSponsoredDisabled())) {
                ...
                this.sponsoredQuery = strTrim;
                tL_contacts_getSponsoredPeers.f1663q = strTrim;
    ...
    public Object getItem(int i) {
        ...
        if (isRecentSearchDisplayed()) {
            ...
            if (i > HasHints && (i2 = (i - 1) - (HasHints == true ? 1 : 0)) < arrayList.size()) {
                ...
                if (!(tLObject instanceof TLRPC.User)) {
                    return (!(tLObject instanceof TLRPC.Chat) || (chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(((TLRPC.Chat) tLObject).f1610id))) == null) ? tLObject : chat;
                }
                TLRPC.User user = MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(((TLRPC.User) tLObject).f1775id));
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        if (i == 5) {
            viewShowPremiumBlock.setLayoutParams(new RecyclerView.LayoutParams(-1, AndroidUtilities.m1081dp(86.0f)));
        } else {
    ...
    */
    public void onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder r31, int r32) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Adapters.DialogsSearchAdapter.onBindViewHolder(androidx.recyclerview.widget.RecyclerView$ViewHolder, int):void");
    }
    ...
    public /* synthetic */ void lambda$onBindViewHolder$30(GraySectionCell graySectionCell) {
        ...
        graySectionCell.setRightText(LocaleController.getString(!z ? C2702R.string.ShowMore : C2702R.string.ShowLess));
        notifyDataSetChanged();
    }
    ...
    public /* synthetic */ void lambda$onBindViewHolder$33(ArrayList arrayList, final int i, GraySectionCell graySectionCell) {
        ...
        graySectionCell.setRightText(LocaleController.getString(this.globalSearchCollapsed ? C2702R.string.ShowMore : C2702R.string.ShowLess), this.globalSearchCollapsed);
    ...
    */
    public int getItemViewType(int r12) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Adapters.DialogsSearchAdapter.getItemViewType(int):int");
    }
    ...
    static class EmptyLayout extends LinearLayout {
        ...
        public EmptyLayout(Context context, Theme.ResourcesProvider resourcesProvider, final Runnable runnable) {
            ...
            backupImageView.setImageDrawable(new RLottieDrawable(C2702R.raw.utyan_empty, "utyan_empty", AndroidUtilities.m1081dp(120.0f), AndroidUtilities.m1081dp(120.0f)));
            ...
            textView.setText(LocaleController.getString(C2702R.string.SearchMessagesFilterEmptyTitle));
            ...
            this.textView.setText(LocaleController.formatString(C2702R.string.SearchMessagesFilterEmptyText, _UrlKt.FRAGMENT_ENCODE_SET));
            this.textView.setGravity(17);
            addView(this.textView, LayoutHelper.createLinear(-1, -2, 1, 0, 0, 0, 14));
            TextView textView3 = new TextView(context);
            textView3.setPadding(AndroidUtilities.m1081dp(12.0f), AndroidUtilities.m1081dp(4.0f), AndroidUtilities.m1081dp(12.0f), AndroidUtilities.m1081dp(4.0f));
            textView3.setTextSize(1, 14.0f);
            textView3.setText(LocaleController.getString(C2702R.string.SearchMessagesFilterEmptySearchAll));
        ...
        public void setQuery(String str) {
            this.textView.setText(LocaleController.formatString(C2702R.string.SearchMessagesFilterEmptyText, str));
        }
    }
