...
public class NotificationsSettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    /* JADX WARN: Can't wrap try/catch for region: R(8:564|(2:712|566)(2:568|(2:715|714)(1:713))|567|683|571|574|716|714) */
    /* JADX WARN: Removed duplicated region for block: B:631:0x0354  */
    /* JADX WARN: Removed duplicated region for block: B:649:0x039c  */
    /* JADX WARN: Removed duplicated region for block: B:656:0x03b6 A[LOOP:5: B:655:0x03b4->B:656:0x03b6, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:659:0x03d0  */
    /*
    ...
    */
    public /* synthetic */ void lambda$loadExceptions$2(java.util.ArrayList r29, final java.lang.Runnable r30) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.NotificationsSettingsActivity.lambda$loadExceptions$2(java.util.ArrayList, java.lang.Runnable):void");
    }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2702R.string.NotificationsAndSounds));
        ...
        C59582 c59582 = new LinearLayoutManager(context, 1, false) { // from class: org.telegram.ui.NotificationsSettingsActivity.2
            @Override // androidx.recyclerview.widget.LinearLayoutManager, androidx.recyclerview.widget.RecyclerView.LayoutManager
            public boolean supportsPredictiveItemAnimations() {
                return false;
            }

            C59582(Context context2, int i, boolean z) {
                super(context2, i, z);
            }
        };
        this.layoutManager = c59582;
        recyclerListView2.setLayoutManager(c59582);
    ...
    class C59571 extends ActionBar.ActionBarMenuOnItemClick {
        C59571() {
        }
    ...
    class C59582 extends LinearLayoutManager {
        @Override // androidx.recyclerview.widget.LinearLayoutManager, androidx.recyclerview.widget.RecyclerView.LayoutManager
        public boolean supportsPredictiveItemAnimations() {
            return false;
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:447:0x04ac  */
    ...
    */
    public /* synthetic */ void lambda$createView$10(android.view.View r20, final int r21, float r22, float r23) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.NotificationsSettingsActivity.lambda$createView$10(android.view.View, int, float, float):void");
    }
    ...
    public /* synthetic */ void lambda$createView$4() {
        ...
        if (getParentActivity() != null) {
            Toast.makeText(getParentActivity(), LocaleController.getString("ResetNotificationsText", C2702R.string.ResetNotificationsText), 0).show();
        }
            ...
            if (uri == null || (ringtone = RingtoneManager.getRingtone(getParentActivity(), uri)) == null) {
                ...
                if (i == this.callsRingtoneRow) {
                    if (uri.equals(Settings.System.DEFAULT_RINGTONE_URI)) {
                        title = LocaleController.getString("DefaultRingtone", C2702R.string.DefaultRingtone);
                    } else {
    ...
    private void showExceptionsAlert(int i, final Runnable runnable) {
        ...
        if (arrayList.size() == 1) {
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString(C2702R.string.NotificationsExceptionsSingleAlert, pluralString2)));
        } else {
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString(C2702R.string.NotificationsExceptionsAlert, pluralString2)));
        }
        builder.setTitle(LocaleController.getString("NotificationsExceptions", C2702R.string.NotificationsExceptions));
        builder.setNeutralButton(LocaleController.getString("ViewExceptions", C2702R.string.ViewExceptions), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.NotificationsSettingsActivity$$ExternalSyntheticLambda9
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i2) {
                this.f$0.lambda$showExceptionsAlert$11(arrayList, arrayList2, alertDialog, i2);
            }
        });
        builder.setNegativeButton(LocaleController.getString("OK", C2702R.string.f1556OK), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.NotificationsSettingsActivity$$ExternalSyntheticLambda10
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i2) {
                runnable.run();
            }
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        /* JADX WARN: Removed duplicated region for block: B:565:0x0224  */
        /* JADX WARN: Removed duplicated region for block: B:566:0x0227  */
        /* JADX WARN: Removed duplicated region for block: B:569:0x022e  */
        /* JADX WARN: Removed duplicated region for block: B:576:0x024f  */
        /* JADX WARN: Removed duplicated region for block: B:588:0x0289  */
        /* JADX WARN: Removed duplicated region for block: B:626:0x034d  */
        /* JADX WARN: Removed duplicated region for block: B:627:0x034f  */
        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct code enable 'Show inconsistent code' option in preferences
