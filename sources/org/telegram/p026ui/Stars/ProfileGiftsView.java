...
public class ProfileGiftsView extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void setBounds(float f, float f2, float f3, boolean z, int i) {
        boolean z2 = Math.abs(f - this.left) > 0.1f || Math.abs(f2 - this.right) > 0.1f || Math.abs(f3 - this.f2090cy) > 0.1f;
        this.left = f;
        this.right = f2;
        if (!z) {
    ...
    public final class Gift {
        ...
        public Gift(TL_stars.TL_starGiftUnique tL_starGiftUnique) {
            ...
            this.f2091id = tL_starGiftUnique.f1796id;
            TLRPC.Document document = tL_starGiftUnique.getDocument();
            this.document = document;
            this.documentId = document == null ? 0L : document.f1618id;
        ...
        private void initParticles() {
            ...
            float fM1081dp = AndroidUtilities.m1081dp(36.0f);
            float f = (-fM1081dp) / 2.0f;
            float f2 = fM1081dp / 2.0f;
            this.particles.bounds.set(f, f, f2, f2);
        }

        public boolean equals(Gift gift) {
            return gift != null && gift.f2091id == this.f2091id;
        }
        ...
        public void draw(Canvas canvas, float f, float f2, float f3, float f4, float f5, float f6) {
            ...
            float fM1081dp = AndroidUtilities.m1081dp(45.0f);
    ...
    */
    public void update() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Stars.ProfileGiftsView.update():void");
    }
    ...
    */
    protected void dispatchDraw(android.graphics.Canvas r28) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Stars.ProfileGiftsView.dispatchDraw(android.graphics.Canvas):void");
    }
