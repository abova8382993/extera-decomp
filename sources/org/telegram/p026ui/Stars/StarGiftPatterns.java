...
public abstract class StarGiftPatterns {
    ...
    public static void drawPattern(Canvas canvas, int i, Drawable drawable, float f, float f2, float f3, float f4) {
        ...
        while (true) {
            ...
            float f10 = f6 * f4;
            float f11 = f7 * f4;
            drawable.setBounds((int) (AndroidUtilities.m1081dp(f9) - (AndroidUtilities.m1081dp(f11) / 2.0f)), (int) (AndroidUtilities.m1081dp(f10) - (AndroidUtilities.m1081dp(f11) / 2.0f)), (int) (AndroidUtilities.m1081dp(f9) + (AndroidUtilities.m1081dp(f11) / 2.0f)), (int) (AndroidUtilities.m1081dp(f10) + (AndroidUtilities.m1081dp(f11) / 2.0f)));
    ...
    public static void drawPatternBatch(Canvas canvas, int i, Paint paint, Bitmap bitmap, float f, float f2, float f3, float f4) {
        ...
        while (true) {
            ...
            if (i2 < fArr.length) {
                ...
                int i3 = i2 / 4;
                batchParticlesBuffer.setParticleVertexCords(i3, AndroidUtilities.m1081dp(f9) - (AndroidUtilities.m1081dp(f11) / 2.0f), AndroidUtilities.m1081dp(f10) - (AndroidUtilities.m1081dp(f11) / 2.0f), AndroidUtilities.m1081dp(f9) + (AndroidUtilities.m1081dp(f11) / 2.0f), AndroidUtilities.m1081dp(f10) + (AndroidUtilities.m1081dp(f11) / 2.0f));
    ...
    public static void drawProfileAnimatedPattern(Canvas canvas, Drawable drawable, int i, float f, float f2, RectF rectF, float f3) {
        ...
        for (int i6 = 54; i5 < i6; i6 = 54) {
            ...
            float fM1081dp = f36 - (AndroidUtilities.m1081dp(12.0f) * (1.0f - f2));
            if (interpolation < 1.0f) {
                fLerp = AndroidUtilities.lerp(f8, fLerp, CubicBezierInterpolator.EASE_IN.getInterpolation(interpolation));
                fM1081dp = AndroidUtilities.lerp(f9, fM1081dp, interpolation);
                fDpf27 = AndroidUtilities.lerp(AndroidUtilities.dpf2(8.0f), fDpf27, interpolation);
            }
            if (fM1081dp > AndroidUtilities.m1081dp(8.0f) + f17) {
                f5 = fClamp012;
                fClamp01 = 1.0f - Utilities.clamp01((((fM1081dp - fMax) - f4) - AndroidUtilities.m1081dp(8.0f)) / AndroidUtilities.m1081dp(56.0f));
            } else {
                f5 = fClamp012;
                fClamp01 = 1.0f;
            }
            float fClamp014 = (1.0f - Utilities.clamp01(MathUtils.distance(f11, f13, fLerp, fM1081dp) / (fMax2 * 2.0f))) * f3 * 0.5f * fClamp01;
            if (interpolation < 1.0f) {
                fClamp014 = AndroidUtilities.lerp(0.0f, fClamp014, interpolation);
            }
            drawable.setBounds((int) (fLerp - fDpf27), (int) (fM1081dp - fDpf27), (int) (fLerp + fDpf27), (int) (fM1081dp + fDpf27));
