...
import org.telegram.p026ui.Components.glass.GlassTabsView;
...
public class StarGiftPreviewSheet extends BottomSheetWithRecyclerListView {
    ...
    public static /* synthetic */ void m17437$r8$lambda$4FWGrWE3omtJROED_SUH0Jjw8(View view) {
    }
    ...
    public StarGiftPreviewSheet(Context context, Theme.ResourcesProvider resourcesProvider, int i, String str, final ArrayList arrayList, boolean z) {
        ...
        List.EL.sort(this.backdrops, Comparator.CC.comparingDouble(new ToDoubleFunction() { // from class: org.telegram.ui.Stars.StarGiftPreviewSheet$$ExternalSyntheticLambda7
            @Override // java.util.function.ToDoubleFunction
            public final double applyAsDouble(Object obj) {
                return StarGiftPreviewSheet.getRarityIndex((TL_stars.starGiftAttributeBackdrop) obj);
            }
        }));
        List.EL.sort(this.patterns, Comparator.CC.comparingDouble(new ToDoubleFunction() { // from class: org.telegram.ui.Stars.StarGiftPreviewSheet$$ExternalSyntheticLambda8
            @Override // java.util.function.ToDoubleFunction
            public final double applyAsDouble(Object obj) {
                return StarGiftPreviewSheet.getRarityIndex((TL_stars.starGiftAttributePattern) obj);
            }
        }));
        List.EL.sort(this.models, Comparator.CC.comparingDouble(new ToDoubleFunction() { // from class: org.telegram.ui.Stars.StarGiftPreviewSheet$$ExternalSyntheticLambda9
            @Override // java.util.function.ToDoubleFunction
            public final double applyAsDouble(Object obj) {
                return StarGiftPreviewSheet.getRarityIndex((TL_stars.starGiftAttributeModel) obj);
            }
        }));
        List.EL.sort(this.simpleModels, Comparator.CC.comparingDouble(new ToDoubleFunction() { // from class: org.telegram.ui.Stars.StarGiftPreviewSheet$$ExternalSyntheticLambda9
            @Override // java.util.function.ToDoubleFunction
            public final double applyAsDouble(Object obj) {
                return StarGiftPreviewSheet.getRarityIndex((TL_stars.starGiftAttributeModel) obj);
            }
        ...
        this.headerMoveTop = AndroidUtilities.m1081dp(6.0f);
        ...
        this.recyclerListView.setPadding(AndroidUtilities.m1081dp(16.0f), 0, AndroidUtilities.m1081dp(16.0f), AndroidUtilities.m1081dp(74.0f));
        ...
        StarGiftSheet.TopView topView = new StarGiftSheet.TopView(context, resourcesProvider, new Runnable() { // from class: org.telegram.ui.Stars.StarGiftPreviewSheet$$ExternalSyntheticLambda11
            ...
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                StarGiftPreviewSheet.m17437$r8$lambda$4FWGrWE3omtJROED_SUH0Jjw8(view);
            }
            ...
            float[] f2092r = new float[8];

            @Override // org.telegram.ui.Stars.StarGiftSheet.TopView
            public float getRealHeight() {
                return AndroidUtilities.m1081dp(315.0f);
            }
            ...
            protected void onSizeChanged(int i3, int i4, int i5, int i6) {
                ...
                fArr[0] = fM1081dp;
                this.path.rewind();
                this.path.addRoundRect(0.0f, 0.0f, i3, i4, this.f2092r, Path.Direction.CW);
            }
        ...
        imageView2.setImageResource(C2702R.drawable.filled_gift_pause_24);
        ...
        textView2.setText(LocaleController.getString(C2702R.string.Gift2PreviewRandomTraits));
        ...
        while (true) {
            ...
            if (i4 < buttonArr.length) {
                ...
                if (i4 == 0) {
                    this.buttons[i4].textView.setText(LocaleController.getString(C2702R.string.GiftPreviewModel));
                } else if (i4 == 1) {
                    this.buttons[i4].textView.setText(LocaleController.getString(C2702R.string.GiftPreviewBackdrop));
                } else if (i4 == 2) {
                    this.buttons[i4].textView.setText(LocaleController.getString(C2702R.string.GiftPreviewSymbol));
                }
                ...
                this.tabsSelectorView.setPadding(AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(8.0f));
    ...
    class C65205 extends UniversalAdapter {
        C65205(RecyclerListView recyclerListView, Context context, int i, int i2, boolean z, Utilities.Callback2 callback2, Theme.ResourcesProvider resourcesProvider) {
    ...
    protected RecyclerListView.SelectionAdapter createAdapter(RecyclerListView recyclerListView) {
        C65205 c65205 = new C65205(this.recyclerListView, getContext(), this.currentAccount, 0, true, new Utilities.Callback2() { // from class: org.telegram.ui.Stars.StarGiftPreviewSheet$$ExternalSyntheticLambda15
        ...
        this.adapter = c65205;
        c65205.setApplyBackground(false);
        return this.adapter;
    }
    ...
    public void updateTranslationHeader() {
        ...
        this.headerMoveTop = y <= 0.0f ? 0 : AndroidUtilities.m1081dp(6.0f);
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        arrayList.add(UItem.asSpace(AndroidUtilities.m1081dp(315.0f)));
        ...
        if (selectedTab != 0) {
            if (selectedTab == 1) {
                ...
                ArrayList arrayList2 = this.backdrops;
                int size = arrayList2.size();
                while (i < size) {
                    Object obj = arrayList2.get(i);
                    i++;
                    arrayList.add(GiftAttributeCell.Factory.asAttribute(selectedTab, new Attributes((TL_stars.starGiftAttributeBackdrop) obj, (TL_stars.starGiftAttributePattern) this.rPatterns.next(), (TL_stars.starGiftAttributeModel) this.rModels.next())));
                }
                return;
            }
            if (selectedTab == 2) {
                ...
                ArrayList arrayList3 = this.patterns;
                int size2 = arrayList3.size();
                while (i < size2) {
                    Object obj2 = arrayList3.get(i);
                    i++;
                    arrayList.add(GiftAttributeCell.Factory.asAttribute(selectedTab, new Attributes((TL_stars.starGiftAttributeBackdrop) this.rBackdrops.next(), (TL_stars.starGiftAttributePattern) obj2, (TL_stars.starGiftAttributeModel) this.rModels.next())));
                }
                return;
            }
            return;
        ...
        ArrayList arrayList4 = this.models;
        int size3 = arrayList4.size();
        int i2 = 0;
        while (i2 < size3) {
            Object obj3 = arrayList4.get(i2);
            i2++;
            arrayList.add(GiftAttributeCell.Factory.asAttribute(selectedTab, new Attributes((TL_stars.starGiftAttributeBackdrop) this.rBackdrops.next(), (TL_stars.starGiftAttributePattern) this.rPatterns.next(), (TL_stars.starGiftAttributeModel) obj3)));
        }
        ...
        ArrayList arrayList5 = this.simpleModels;
        int size4 = arrayList5.size();
        while (i < size4) {
            Object obj4 = arrayList5.get(i);
            i++;
            arrayList.add(GiftAttributeCell.Factory.asAttribute(selectedTab, new Attributes((TL_stars.starGiftAttributeBackdrop) this.rBackdrops.next(), (TL_stars.starGiftAttributePattern) this.rPatterns.next(), (TL_stars.starGiftAttributeModel) obj4)));
        }
    }
    ...
    public static class GiftAttributeCell extends FrameLayout implements FactorAnimator.Target {
        ...
        public GiftAttributeCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
            ...
            textView2.setPadding(AndroidUtilities.m1081dp(5.0f), AndroidUtilities.m1081dp(1.0f), AndroidUtilities.m1081dp(5.0f), AndroidUtilities.m1081dp(1.0f));
            textView2.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1081dp(10.0f), 285212671));
        ...
        public void checkPercentageViewBackground() {
            ...
            if (this.rarityColor != null) {
                ...
                iBlendARGB = ColorUtils.blendARGB(ColorUtils.setAlphaComponent(this.attributes.backdrop.center_color, Function.USE_VARARGS), ColorUtils.setAlphaComponent(this.attributes.backdrop.pattern_color, Function.USE_VARARGS), 0.5f);
    ...
    public void invalidateMergedVisibleBlurredPositionsAndSourcesImpl(int i) {
        ...
        if (BitwiseUtils.hasFlag(i, 2)) {
            ...
            float f2 = -(LiteMode.isEnabled(262144) ? 0 : AndroidUtilities.m1081dp(48.0f));
    ...
    private void applyBottomInset() {
        ...
        if (this.lastBottomInset != systemBottomInset) {
            ...
            this.recyclerListView.setPadding(AndroidUtilities.m1081dp(16.0f), 0, AndroidUtilities.m1081dp(16.0f), systemBottomInset + AndroidUtilities.m1081dp(74.0f));
            ((ViewGroup.MarginLayoutParams) this.tabsSelectorView.getLayoutParams()).bottomMargin = this.lastBottomInset + AndroidUtilities.m1081dp(5.0f);
    ...
    private static class Button extends FrameLayout {
        ...
        public Button(Context context) {
            ...
            this.titleView.setTextSize(AndroidUtilities.m1081dp(13.0f));
            ...
            this.percentView.setTextSize(AndroidUtilities.m1081dp(11.0f));
            this.percentView.setPadding(AndroidUtilities.m1081dp(4.0f), AndroidUtilities.m1081dp(1.0f), AndroidUtilities.m1081dp(4.0f), AndroidUtilities.m1081dp(1.0f));
            this.percentView.setSizeableBackground(new StarGiftSheet.RoundRectStrokeDrawable(AndroidUtilities.m1081dp(10.0f), 285212671));
    ...
    static class TabsSelectorView extends GlassTabsView implements FactorAnimator.Target {
        ...
        public TabsSelectorView(Context context, Theme.ResourcesProvider resourcesProvider, Utilities.Callback callback) {
            ...
            GlassTabView[] glassTabViewArr = {GlassTabView.createGiftTab(context, resourcesProvider, GlassTabView.TabAnimation.MODELS, C2702R.string.GiftPreviewModels, new Runnable() { // from class: org.telegram.ui.Stars.StarGiftPreviewSheet$TabsSelectorView$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$new$0();
                }
            }), GlassTabView.createGiftTab(context, resourcesProvider, GlassTabView.TabAnimation.COLORS, C2702R.string.GiftPreviewBackdrops, new Runnable() { // from class: org.telegram.ui.Stars.StarGiftPreviewSheet$TabsSelectorView$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$new$1();
                }
            }), GlassTabView.createGiftTab(context, resourcesProvider, GlassTabView.TabAnimation.SYMBOLS, C2702R.string.GiftPreviewSymbols, new Runnable() { // from class: org.telegram.ui.Stars.StarGiftPreviewSheet$TabsSelectorView$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
        ...
        private void updateLens() {
            ...
            setLensBounds(AndroidUtilities.lerp(AndroidUtilities.m1081dp(8.0f), getMeasuredWidth() - AndroidUtilities.m1081dp(8.0f), factor / 3.0f), AndroidUtilities.m1081dp(8.0f), AndroidUtilities.lerp(AndroidUtilities.m1081dp(8.0f), getMeasuredWidth() - AndroidUtilities.m1081dp(8.0f), (factor + 1.0f) / 3.0f), getMeasuredHeight() - AndroidUtilities.m1081dp(8.0f));
            MathUtils.clamp((int) ((1.0f - Math.abs(factor - 1.0f)) * 255.0f), 0, Function.USE_VARARGS);
        }
    ...
    public void setMode(Mode mode) {
        ...
        Mode mode2 = Mode.SELECTED;
        if (mode == mode2) {
            i = C2702R.drawable.filled_gift_play_24;
        } else {
            i = C2702R.drawable.filled_gift_pause_24;
        }
        imageView.setImageResource(i);
        TextView textView = this.giftStatusTextView;
        if (mode == mode2) {
            i2 = C2702R.string.Gift2PreviewSelectedTraits;
        } else {
            i2 = C2702R.string.Gift2PreviewRandomTraits;
        }
