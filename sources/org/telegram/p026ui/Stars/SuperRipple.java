...
import org.telegram.p026ui.Components.blur3.LiquidGlassEffect$$ExternalSyntheticApiModelOutline0;
...
public class SuperRipple extends ISuperRipple {
    ...
    public static class Effect {
        ...
        public final float f2121cx;

        /* JADX INFO: renamed from: cy */
        public final float f2122cy;
        public final float intensity;
    ...
    public SuperRipple(View view) {
        ...
        this.MAX_COUNT = 7;
        this.f2120t = new float[7];
        this.centerX = new float[7];
        this.centerY = new float[7];
        this.intensity = new float[7];
        RuntimeShader runtimeShaderM1226m = LiquidGlassEffect$$ExternalSyntheticApiModelOutline0.m1226m(AndroidUtilities.readRes(C2702R.raw.superripple_effect));
        this.shader = runtimeShaderM1226m;
        setupSizeUniforms(true);
        this.effect = RenderEffect.createRuntimeShaderEffect(runtimeShaderM1226m, "img");
    }
    ...
    */
    private void setupSizeUniforms(boolean r11) {
        ...
        Lbb:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Stars.SuperRipple.setupSizeUniforms(boolean):void");
    }

    @Override // org.telegram.p026ui.Stars.ISuperRipple
    ...
    public /* synthetic */ void lambda$animate$0(Effect effect, ValueAnimator valueAnimator) {
        effect.f2123t = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        updateProperties();
    }
    ...
    public void updateProperties() {
        ...
        if (!this.effects.isEmpty()) {
            ...
            for (int i = 0; i < this.count; i++) {
                ...
                boolean z4 = z3 || Math.abs(this.f2120t[i] - effect.f2123t) > 0.001f;
                this.f2120t[i] = effect.f2123t;
                boolean z5 = z4 || Math.abs(this.centerX[i] - effect.f2121cx) > 0.001f;
                this.centerX[i] = effect.f2121cx;
                boolean z6 = z5 || Math.abs(this.centerY[i] - effect.f2122cy) > 0.001f;
                this.centerY[i] = effect.f2122cy;
            ...
            if (z2) {
                ...
                this.shader.setFloatUniform("t", this.f2120t);
