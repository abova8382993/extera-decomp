...
import org.telegram.p026ui.Components.BatchParticlesDrawHelper;
...
import org.telegram.p026ui.Stories.LiveCommentsView;
    ...
    public StarsReactionsSheet(final Context context, final int i, final long j, final ChatActivity chatActivity, final MessageObject messageObject, ArrayList arrayList, boolean z, final boolean z2, long j2, final Theme.ResourcesProvider resourcesProvider) {
        ...
        if (arrayList != null) {
            ...
            while (i4 < size) {
                ...
                if (messageReactor3.anonymous && messageReactor3.f1638my) {
                    peerDialogId = clientUserId;
                }
                if (messageReactor3.f1638my || peerDialogId == clientUserId) {
        ...
        if (z2) {
            if (arrayList != null) {
                ...
                while (true) {
                    ...
                    if (((TLRPC.MessageReactor) arrayList.get(i5)).f1638my) {
                        break;
                    }
                    i5++;
                }
        ...
        this.slider = new StarsSlider(context, resourcesProvider) { // from class: org.telegram.ui.Stars.StarsReactionsSheet.1
            ...
            public void onValueChanged(int i6) {
                ...
                if (StarsReactionsSheet.this.buttonView != null) {
                    StarsReactionsSheet.this.buttonView.setText(StarsIntroActivity.replaceStars(LocaleController.formatString(C2702R.string.StarsReactionSend, LocaleController.formatNumber(j5, ',')), StarsReactionsSheet.this.starRef), true);
                }
                if (z2) {
        ...
        frameLayout3.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1081dp(14.0f), Theme.getColor(Theme.key_dialogBackgroundGray, resourcesProvider)));
        ...
        imageView.setImageResource(C2702R.drawable.arrows_select);
        ...
        frameLayout2.setPadding(AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(4.0f), AndroidUtilities.m1081dp(8.0f), 0);
        ...
        textView.setText(LocaleController.getString(C2702R.string.StarsReactionTitle2));
        ...
        imageView2.setImageResource(C2702R.drawable.ic_close_white);
        ...
        if (messageReactor != null) {
            ...
            chat = chat2;
            z4 = false;
            string = LocaleController.formatString(C2702R.string.StarsReactionText, chat2 == null ? _UrlKt.FRAGMENT_ENCODE_SET : chat2.title);
        }
        ...
        if (z3) {
            if (!z2) {
                View view = new View(context) { // from class: org.telegram.ui.Stars.StarsReactionsSheet.3
                    ...
                    private final Text text = new Text(LocaleController.getString(C2702R.string.StarsReactionTopSenders), 14.16f, AndroidUtilities.bold());

                    @Override // android.view.View
                    public void dispatchDraw(Canvas canvas) {
                        this.gradientMatrix.reset();
                        this.gradientMatrix.postTranslate(AndroidUtilities.m1081dp(14.0f), 0.0f);
                        this.gradientMatrix.postScale((getWidth() - AndroidUtilities.m1081dp(28.0f)) / 255.0f, 1.0f);
                        this.gradient.setLocalMatrix(this.gradientMatrix);
                        this.backgroundPaint.setShader(this.gradient);
                        float currentWidth = this.text.getCurrentWidth() + AndroidUtilities.m1081dp(30.0f);
                        this.separatorPaint.setColor(Theme.getColor(Theme.key_divider, resourcesProvider));
                        canvas.drawRect(AndroidUtilities.m1081dp(24.0f), (getHeight() / 2.0f) - 1.0f, ((getWidth() - currentWidth) / 2.0f) - AndroidUtilities.m1081dp(8.0f), getHeight() / 2.0f, this.separatorPaint);
                        canvas.drawRect(((getWidth() + currentWidth) / 2.0f) + AndroidUtilities.m1081dp(8.0f), (getHeight() / 2.0f) - 1.0f, getWidth() - AndroidUtilities.m1081dp(24.0f), getHeight() / 2.0f, this.separatorPaint);
        ...
        if (z2) {
            ...
            textViewMakeTextView.setText(LocaleController.getString(z ? C2702R.string.LiveStoryReactTitle : C2702R.string.LiveStoryReactAdminTitle));
            ...
            if (z) {
                i3 = C2702R.string.LiveStoryReactText;
            } else {
                i3 = z3 ? C2702R.string.LiveStoryReactAdminText : C2702R.string.LiveStoryReactAdminEmptyText;
            }
        ...
        textView3.setText(LocaleController.getString(C2702R.string.StarsReactionShowMeInTopSenders));
        LinearLayout linearLayout4 = new LinearLayout(context);
        this.checkLayout = linearLayout4;
        linearLayout4.setOrientation(0);
        linearLayout4.setPadding(AndroidUtilities.m1081dp(12.0f), AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(12.0f), AndroidUtilities.m1081dp(8.0f));
        ...
        updateSenders(0L);
        buttonWithCounterView.setText(StarsIntroActivity.replaceStars(LocaleController.formatString(C2702R.string.StarsReactionSend, LocaleController.formatNumber(50L, ',')), this.starRef), true);
        if (z) {
        ...
        if (z2 && !z) {
            linksTextView.setText(LocaleController.getString(C2702R.string.LiveStoryReactAdminCant));
        } else {
            linksTextView.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(C2702R.string.StarsReactionTerms), new Runnable() { // from class: org.telegram.ui.Stars.StarsReactionsSheet$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
                    Browser.openUrl(context2, LocaleController.getString(C2702R.string.StarsReactionTermsLink));
                }
            }));
        }
    ...
    public /* synthetic */ void lambda$new$2(int i, final boolean z, Long l) {
        ...
        if (l.longValue() >= 0) {
            ...
            safeLastFragment.presentFragment(new ProfileActivity(bundle) { // from class: org.telegram.ui.Stars.StarsReactionsSheet.4
                @Override // org.telegram.p026ui.ProfileActivity, org.telegram.p026ui.ActionBar.BaseFragment
        ...
        if ((!this.liveStories || this.sendEnabled || j <= 0) && this.topSendersView != null) {
            ...
            if (this.reactors != null) {
                for (int i = 0; i < this.reactors.size(); i++) {
                    ...
                    if (!z) {
                        j2 = peerDialogId;
                    } else if (messageReactor.f1638my) {
                        j2 = clientUserId;
                    } else {
                        peerDialogId = (-i) - 1;
                        j2 = peerDialogId;
                    }
                    if (messageReactor.f1638my || j2 == clientUserId) {
                        j3 = messageReactor.count;
                    } else {
                        arrayList.add(SenderData.m1265of(z, false, j2, messageReactor.count));
                    }
                }
            }
            long j4 = j3 + j;
            if (j4 > 0) {
                arrayList.add(SenderData.m1265of(this.peer == UserObject.ANONYMOUS, true, clientUserId, j4));
            }
  ...
  0x009a: PHI (r0v26 android.view.View) = (r0v25 android.view.View), (r0v25 android.view.View), (r0v28 android.view.View) binds: [B:16:0x003e, B:17:0x0040, B:36:0x0087] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    private void animate3dIcon(final java.lang.Runnable r17) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Stars.StarsReactionsSheet.animate3dIcon(java.lang.Runnable):void");
    }
    ...
    public /* synthetic */ void lambda$animate3dIcon$14(LiveCommentsView.LiveCommentView[] liveCommentViewArr, int[] iArr, RectF rectF, View view, ReactionsLayoutInBubble reactionsLayoutInBubble, ReactionsLayoutInBubble.ReactionButton reactionButton) {
        ...
        rectF.set(iArr[0] + reactionsLayoutInBubble.f2004x + reactionButton.f2006x + AndroidUtilities.m1081dp(4.0f), iArr[1] + reactionsLayoutInBubble.f2005y + reactionButton.f2007y + ((reactionButton.height - AndroidUtilities.m1081dp(22.0f)) / 2.0f), iArr[0] + reactionsLayoutInBubble.f2004x + reactionButton.f2006x + AndroidUtilities.m1081dp(26.0f), iArr[1] + reactionsLayoutInBubble.f2005y + reactionButton.f2007y + ((reactionButton.height + AndroidUtilities.m1081dp(22.0f)) / 2.0f));
    }
    ...
    public /* synthetic */ void lambda$animate3dIcon$15(Runnable runnable, RectF rectF, RectF rectF2, RectF rectF3, boolean[] zArr, Runnable runnable2, ValueAnimator valueAnimator) {
        ...
        this.icon3dView.setTranslationX(rectF3.centerX() - (AndroidUtilities.m1081dp(150.0f) / 2.0f));
        this.icon3dView.setTranslationY(rectF3.centerY() - (AndroidUtilities.m1081dp(150.0f) / 2.0f));
        float fLerp = AndroidUtilities.lerp(Math.max(rectF3.width() / AndroidUtilities.m1081dp(150.0f), rectF3.height() / AndroidUtilities.m1081dp(150.0f)), 1.0f, (float) Math.sin(((double) fFloatValue) * 3.141592653589793d));
    ...
    public static class StarsSlider extends View {
        ...
        public StarsSlider(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            this.topPaint = paint;
            this.topText = new Text(LocaleController.getString(C2702R.string.StarsReactionTop), 14.0f, AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_CONDENSED_BOLD));
            ...
            this.resourcesProvider = resourcesProvider;
            Drawable drawableMutate = context.getResources().getDrawable(C2702R.drawable.msg_premium_liststar).mutate();
            this.counterImage = drawableMutate;
            drawableMutate.setColorFilter(new PorterDuffColorFilter(-1, PorterDuff.Mode.SRC_IN));
            animatedTextDrawable.setTextColor(-1);
            animatedTextDrawable.setTypeface(AndroidUtilities.getTypeface("fonts/num.otf"));
            animatedTextDrawable.setTextSize(AndroidUtilities.m1081dp(21.0f));
            animatedTextDrawable.setCallback(this);
            animatedTextDrawable.setOverrideFullWidth(AndroidUtilities.displaySize.x);
            animatedTextDrawable.setGravity(17);
            animatedTextDrawable2.setTextColor(-570425345);
            animatedTextDrawable2.setTextSize(AndroidUtilities.m1081dp(11.0f));
        ...
        protected void onMeasure(int i, int i2) {
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m1081dp(220.0f));
            int measuredWidth = getMeasuredWidth();
            getMeasuredHeight();
            this.sliderInnerRect.set(AndroidUtilities.m1081dp(14.0f), AndroidUtilities.m1081dp(135.0f), measuredWidth - r6, r0 + AndroidUtilities.m1081dp(24.0f));
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            path.addRoundRect(rectF, fM1081dp, fM1081dp2, direction);
            ...
            rectF2.right = AndroidUtilities.lerp(rectF2.left + AndroidUtilities.m1081dp(24.0f), this.sliderRect.right, progress);
            this.sliderPath.rewind();
            this.sliderPath.addRoundRect(this.sliderRect, AndroidUtilities.m1081dp(12.0f), AndroidUtilities.m1081dp(12.0f), direction);
            ...
            if (j == -1 || getProgress((int) j) >= 1.0f || getProgress((int) this.currentTop) <= 0.0f) {
                ...
                float fM1081dp3 = this.sliderInnerRect.left + AndroidUtilities.m1081dp(12.0f) + ((this.sliderInnerRect.width() - AndroidUtilities.m1081dp(24.0f)) * Utilities.clamp01(getProgress((int) this.currentTop)));
                float f7 = this.overTop.set(Math.abs((this.sliderRect.right - ((float) AndroidUtilities.m1081dp(10.0f))) - fM1081dp3) < ((float) AndroidUtilities.m1081dp(14.0f)));
                f = 255.0f;
                f2 = 12.0f;
                float fLerp = AndroidUtilities.lerp(AndroidUtilities.m1081dp(9.0f), AndroidUtilities.m1081dp(16.0f), this.overTopText.set(Math.abs((this.sliderRect.right - ((float) AndroidUtilities.m1081dp(10.0f))) - fM1081dp3) < ((float) AndroidUtilities.m1081dp(12.0f))));
                float currentWidth = (this.topText.getCurrentWidth() + fM1081dp3) + ((float) (AndroidUtilities.m1081dp(16.0f) * 2)) > this.sliderInnerRect.right ? (fM1081dp3 - fLerp) - this.topText.getCurrentWidth() : fLerp + fM1081dp3;
                this.topPaint.setStrokeWidth(AndroidUtilities.m1081dp(1.0f));
                ...
                canvas2.drawLine(fM1081dp3, fLerp2, fM1081dp3, AndroidUtilities.lerp(rectF4.bottom, rectF4.centerY(), f7), this.topPaint);
            ...
            if (j2 != -1 && getProgress((int) j2) < 1.0f && getProgress((int) this.currentTop) > 0.0f) {
                float fM1081dp4 = this.sliderInnerRect.left + AndroidUtilities.m1081dp(f2) + ((this.sliderInnerRect.width() - AndroidUtilities.m1081dp(24.0f)) * Utilities.clamp01(getProgress((int) this.currentTop)));
                float f8 = this.overTop.set(Math.abs((this.sliderRect.right - ((float) AndroidUtilities.m1081dp(10.0f))) - fM1081dp4) < ((float) AndroidUtilities.m1081dp(14.0f)));
                float fLerp3 = AndroidUtilities.lerp(AndroidUtilities.m1081dp(9.0f), AndroidUtilities.m1081dp(16.0f), this.overTopText.set(Math.abs((this.sliderRect.right - ((float) AndroidUtilities.m1081dp(10.0f))) - fM1081dp4) < ((float) AndroidUtilities.m1081dp(f2))));
                float currentWidth2 = (this.topText.getCurrentWidth() + fM1081dp4) + ((float) (AndroidUtilities.m1081dp(16.0f) * 2)) > this.sliderInnerRect.right ? (fM1081dp4 - fLerp3) - this.topText.getCurrentWidth() : fLerp3 + fM1081dp4;
                this.topPaint.setStrokeWidth(AndroidUtilities.m1081dp(1.0f));
                ...
                canvas2.drawLine(fM1081dp4, fLerp4, fM1081dp4, AndroidUtilities.lerp(rectF6.bottom, rectF6.centerY(), f8), this.topPaint);
            ...
            if (this.drawPlus) {
                ...
                f6 = progress;
                f5 = 0.15f;
                this.plusPath.addRoundRect(fHeight - AndroidUtilities.m1081dp(1.0f), fCenterY - AndroidUtilities.m1081dp(6.0f), AndroidUtilities.m1081dp(1.0f) + fHeight, fCenterY + AndroidUtilities.m1081dp(6.0f), AndroidUtilities.m1081dp(1.0f), AndroidUtilities.m1081dp(1.0f), direction);
                this.plusPath.addRoundRect(fHeight - AndroidUtilities.m1081dp(6.0f), fCenterY - AndroidUtilities.m1081dp(1.0f), fHeight + AndroidUtilities.m1081dp(6.0f), fCenterY + AndroidUtilities.m1081dp(1.0f), AndroidUtilities.m1081dp(1.0f), AndroidUtilities.m1081dp(1.0f), direction);
            ...
            this.sliderCircleRect.set((this.sliderRect.right - AndroidUtilities.m1081dp(16.0f)) - AndroidUtilities.m1081dp(4.0f), this.sliderRect.centerY() - (AndroidUtilities.m1081dp(16.0f) / f4), this.sliderRect.right - AndroidUtilities.m1081dp(4.0f), this.sliderRect.centerY() + (AndroidUtilities.m1081dp(16.0f) / f4));
            canvas2.drawRoundRect(this.sliderCircleRect, AndroidUtilities.m1081dp(f2), AndroidUtilities.m1081dp(f2), this.sliderCirclePaint);
            float fM1081dp5 = AndroidUtilities.m1081dp(9.0f) / this.sliderInnerRect.width();
            RectF rectF8 = this.sliderCircleRect;
            float fLerp5 = AndroidUtilities.lerp(AndroidUtilities.lerp(rectF8.left, rectF8.right, f6), AndroidUtilities.lerp(this.sliderCircleRect.left + AndroidUtilities.m1081dp(9.0f), this.sliderCircleRect.right - AndroidUtilities.m1081dp(9.0f), f6), Math.min(Utilities.clamp01(f6 / fM1081dp5), Utilities.clamp01((1.0f - f6) / fM1081dp5)));
            float fMax = Math.max(this.counterSubText.getCurrentWidth() + AndroidUtilities.m1081dp(20.0f), this.counterText.getCurrentWidth() + AndroidUtilities.m1081dp(50.0f));
            float fM1081dp6 = AndroidUtilities.m1081dp(44.0f);
            float fClamp = Utilities.clamp(fLerp5 - (fMax / f4), (this.sliderInnerRect.right - fMax) - AndroidUtilities.m1081dp(4.0f), this.sliderInnerRect.left + AndroidUtilities.m1081dp(4.0f));
            this.textRect.set(fClamp, (this.sliderInnerRect.top - AndroidUtilities.m1081dp(21.0f)) - fM1081dp6, fMax + fClamp, this.sliderInnerRect.top - AndroidUtilities.m1081dp(21.0f));
            ...
            float fClamp3 = Utilities.clamp(fClamp2 - AndroidUtilities.m1081dp(9.0f), rectF10.right, rectF10.left);
            RectF rectF11 = this.textRect;
            float fClamp4 = Utilities.clamp(AndroidUtilities.m1081dp(9.0f) + fClamp2, rectF11.right, rectF11.left);
            float fClamp5 = Utilities.clamp(this.progress - this.aprogress, 1.0f, -1.0f) * 60.0f;
            float fM1081dp7 = this.textRect.bottom + AndroidUtilities.m1081dp(8.0f);
            ...
            if (fClamp3 < rectF18.right - f17) {
                ...
                this.textPath.lineTo(fClamp2 + f4, this.textRect.bottom + AndroidUtilities.m1081dp(8.0f));
            }
            this.textPath.lineTo(fClamp2, this.textRect.bottom + AndroidUtilities.m1081dp(8.0f) + 1.0f);
            RectF rectF19 = this.textRect;
            if (fClamp4 > rectF19.left + f17) {
                this.textPath.lineTo(fClamp2 - f4, rectF19.bottom + AndroidUtilities.m1081dp(8.0f));
            ...
            rectF23.inset(-AndroidUtilities.m1081dp(f2), -AndroidUtilities.m1081dp(f2));
            ...
            canvas2.restore();
            canvas2.save();
            canvas2.rotate(fClamp5, fClamp2, fM1081dp7);
            ...
            this.counterImage.setBounds((int) ((this.textRect.centerX() - (this.counterText.getCurrentWidth() / f4)) + AndroidUtilities.m1081dp(-12.0f)), (int) (this.textRect.centerY() - AndroidUtilities.m1081dp(10.0f)), (int) ((this.textRect.centerX() - (this.counterText.getCurrentWidth() / f4)) + AndroidUtilities.m1081dp(8.0f)), (int) (this.textRect.centerY() + AndroidUtilities.m1081dp(10.0f)));
            ...
            float fM1081dp8 = this.textRect.left + AndroidUtilities.m1081dp(24.0f);
            RectF rectF25 = this.textRect;
            animatedTextDrawable.setBounds(fM1081dp8, rectF25.top, rectF25.right, rectF25.bottom);
            ...
            float fM1081dp9 = rectF26.top + AndroidUtilities.m1081dp(10.0f);
            RectF rectF27 = this.textRect;
            animatedTextDrawable2.setBounds(f20, fM1081dp9, rectF27.right, rectF27.bottom + AndroidUtilities.m1081dp(10.0f));
    ...
    public static class Particles {
        ...
        public Particles(int i, int i2) {
            ...
            Bitmap bitmapCreateBitmap = Bitmap.createBitmap(iM1081dp, iM1081dp, Bitmap.Config.ARGB_8888);
            this.f2110b = bitmapCreateBitmap;
            Path path = new Path();
            float f = iM1081dp >> 1;
            int i4 = (int) (0.85f * f);
            path.moveTo(0.0f, f);
        ...
        public void removeParticlesOutside() {
            if (this.type == 2) {
                ...
                for (int i = 0; i < this.particles.size(); i++) {
                    ...
                    if (!this.bounds.contains((int) particle.f2116x, (int) particle.f2117y)) {
        ...
        public boolean process() {
            ...
            for (int i = 0; i < Math.min(this.visibleCount, this.particles.size()); i++) {
                ...
                particle.f2116x += particle.f2114vx * fMin;
                particle.f2117y += particle.f2115vy * fMin;
                float f2 = 4.0f * f;
                particle.f2112la = f2 - (f * f2);
            }
        ...
        public void generateGrid() {
            ArrayList arrayListPoissonDiskSampling = poissonDiskSampling(AndroidUtilities.m1081dp(30.0f), (int) this.bounds.width(), (int) this.bounds.height(), 15);
            ...
            if (this.batchParticlesBuffer != null) {
                ...
                this.batchParticlesBuffer = batchParticlesBuffer;
                batchParticlesBuffer.fillParticleTextureCords(0.0f, 0.0f, this.f2110b.getWidth(), this.f2110b.getHeight());
            }
            long jCurrentTimeMillis = System.currentTimeMillis();
            for (int i2 = 0; i2 < this.visibleCount; i2++) {
                ...
                particle.f2116x = f + rectF.left;
                particle.f2117y = pointF.y + rectF.top;
                particle.f2112la = AndroidUtilities.lerp(0.4f, 1.0f, Utilities.fastRandom.nextFloat());
                particle.f2113s *= 1.25f;
            }
        }

        static boolean isValidPoint(PointF[][] pointFArr, int i, int i2, float f, int i3, int i4, PointF pointF, float f2) {
            int iM1081dp = AndroidUtilities.m1081dp(15.0f) / 2;
            float f3 = pointF.x;
            float f4 = iM1081dp;
            if (f3 >= f4 && f3 < i - iM1081dp) {
                float f5 = pointF.y;
                if (f5 >= f4 && f5 < i2 - iM1081dp) {
        ...
        private static ArrayList poissonDiskSampling(float f, int i, int i2, int i3) {
            ...
            while (!arrayList2.isEmpty()) {
                int iNextInt = arrayList2.size() > i6 ? Utilities.fastRandom.nextInt(arrayList2.size() - i6) : i5;
                ...
                while (true) {
                    if (i9 < i3) {
                        ...
                        double dLerp2 = AndroidUtilities.lerp(i5, 360, Utilities.fastRandom.nextFloat());
        ...
        public void draw(Canvas canvas, int i, float f) {
            if (LiteMode.isEnabled(131072)) {
                ...
                if (this.batchParticlesBuffer != null) {
                    float width = this.f2110b.getWidth();
                    float height = this.f2110b.getHeight();
                    for (int i2 = 0; i2 < iMin; i2++) {
                        Particle particle = (Particle) this.particles.get(i2);
                        float f2 = particle.f2111a * particle.f2113s * f;
                        ...
                        float f5 = particle.f2116x;
                        float f6 = particle.f2117y;
                        batchParticlesBuffer.setParticleVertexCords(i2, f5 - f3, f6 - f4, f5 + f3, f4 + f6);
                        this.batchParticlesBuffer.setParticleColor(i2, ColorUtils.setAlphaComponent(i, (int) (Utilities.clamp01(particle.f2112la * f) * 255.0f)));
                    }
                    ...
                    for (int i3 = 0; i3 < iMin; i3++) {
                        ...
                        particle2.draw(canvas, i, particle2.f2112la * f);
                    }
                }
        ...
        public void gen(Particle particle, long j, boolean z) {
            ...
            RectF rectF = this.bounds;
            particle.f2116x = AndroidUtilities.lerp(rectF.left, rectF.right, Utilities.fastRandom.nextFloat());
            RectF rectF2 = this.bounds;
            particle.f2117y = AndroidUtilities.lerp(rectF2.top, rectF2.bottom, Utilities.fastRandom.nextFloat());
            if (this.type == 0) {
                particle.f2114vx = AndroidUtilities.m1081dp(AndroidUtilities.lerp(-7.0f, -18.0f, Utilities.fastRandom.nextFloat()));
                particle.f2115vy = AndroidUtilities.m1081dp(AndroidUtilities.lerp(-2.0f, 2.0f, Utilities.fastRandom.nextFloat()));
            } else {
                particle.f2114vx = this.bounds.centerX() - particle.f2116x;
                particle.f2115vy = this.bounds.centerY() - particle.f2117y;
                float fM1081dp = AndroidUtilities.m1081dp(AndroidUtilities.lerp(1.0f, 4.0f, Utilities.fastRandom.nextFloat()));
                float f = particle.f2114vx;
                float f2 = particle.f2115vy;
                float fSqrt = fM1081dp / ((float) Math.sqrt((f * f) + (f2 * f2)));
                particle.f2114vx *= fSqrt;
                particle.f2115vy *= fSqrt;
            }
            particle.f2111a = AndroidUtilities.lerp(0.4f, 1.0f, Utilities.fastRandom.nextFloat());
            particle.f2113s = AndroidUtilities.lerp(0.8f, 1.2f, Utilities.fastRandom.nextFloat()) * 0.7f;
        }
        ...
        public class Particle {
            ...
            public float f2114vx;

            /* JADX INFO: renamed from: vy */
            public float f2115vy;
            ...
            public void draw(Canvas canvas, int i, float f) {
                ...
                Particles.this.rect.set((int) (this.f2116x - ((((r8.f2110b.getWidth() / 2.0f) * this.f2111a) * this.f2113s) * f)), (int) (this.f2117y - ((((Particles.this.f2110b.getHeight() / 2.0f) * this.f2111a) * this.f2113s) * f)), (int) (this.f2116x + ((Particles.this.f2110b.getWidth() / 2.0f) * this.f2111a * this.f2113s * f)), (int) (this.f2117y + ((Particles.this.f2110b.getHeight() / 2.0f) * this.f2111a * this.f2113s * f)));
                Particles particles = Particles.this;
                canvas.drawBitmap(particles.f2110b, (Rect) null, particles.rect, particles.bPaint);
            }
        }
    }
    ...
    public static class SenderData {
        ...
        public boolean f2118my;
        public long stars;

        /* JADX INFO: renamed from: of */
        public static SenderData m1265of(boolean z, boolean z2, long j, long j2) {
            SenderData senderData = new SenderData();
            senderData.anonymous = z;
            senderData.f2118my = z2;
            senderData.did = j;
            senderData.stars = j2;
            return senderData;
        }
    ...
    public class TopSendersView extends View {
        ...
        public TopSendersView(Context context, boolean z) {
            ...
            paint.setStrokeWidth(AndroidUtilities.m1081dp(3.0f));
        ...
        public void setSenders(ArrayList<SenderData> arrayList) {
            ...
            while (true) {
                ...
                for (int i2 = 0; i2 < arrayList.size(); i2++) {
                    ...
                    boolean z = senderData2.f2118my;
                    if ((z && sender2.f2119my) || (!sender2.f2119my && !z && senderData2.did == sender2.did)) {
            ...
            for (int i3 = 0; i3 < arrayList.size(); i3++) {
                ...
                for (int i4 = 0; i4 < this.senders.size(); i4++) {
                    ...
                    boolean z2 = sender3.f2119my;
                    if ((z2 && senderData3.f2118my) || (!z2 && !senderData3.f2118my && sender3.did == senderData3.did)) {
                ...
                if (sender == null) {
                    for (int i5 = 0; i5 < this.oldSenders.size(); i5++) {
                        ...
                        boolean z3 = sender4.f2119my;
                        if ((z3 && senderData3.f2118my) || (!z3 && !senderData3.f2118my && sender4.did == senderData3.did)) {
                ...
                if (sender == null) {
                    sender = new Sender(senderData3.f2118my, senderData3.did);
        ...
        public class Sender {
            ...
            public void setAnonymous(boolean z) {
                String shortName;
                if (this.f2119my || this.anonymous == z) {
                    return;
                }
                this.anonymous = z;
                if (z) {
                    shortName = LocaleController.getString(C2702R.string.StarsReactionAnonymous);
                } else {
            ...
            public void setPrivacy(long j) {
                ...
                if (this.f2119my && getPrivacy() != j) {
                    ...
                    this.did = j;
                    if (this.anonymous) {
                        string = LocaleController.getString(C2702R.string.StarsReactionAnonymous);
                    } else {
                        if (j >= 0) {
            ...
            public void setPlace(int i) {
                ...
                Drawable drawableMutate = TopSendersView.this.getContext().getResources().getDrawable(C2702R.drawable.filled_stream_crown).mutate();
                this.crown = drawableMutate;
                int i2 = this.currentColor;
                PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
                drawableMutate.setColorFilter(new PorterDuffColorFilter(i2, mode));
                Drawable drawableMutate2 = TopSendersView.this.getContext().getResources().getDrawable(C2702R.drawable.filled_stream_crown_outline).mutate();
            ...
            public void draw(Canvas canvas) {
                ...
                canvas.save();
                float width = (TopSendersView.this.getWidth() - AndroidUtilities.m1081dp(80.0f)) / Math.max(1.0f, TopSendersView.this.count);
                float fM1081dp = AndroidUtilities.m1081dp(40.0f) + ((TopSendersView.this.count - (f3 + 0.5f)) * width);
                float fM1081dp2 = AndroidUtilities.m1081dp(40.0f);
                float f5 = width / 2.0f;
                this.clickBounds.set(fM1081dp - f5, fM1081dp2 - AndroidUtilities.m1081dp(50.0f), f5 + fM1081dp, AndroidUtilities.m1081dp(50.0f) + fM1081dp2);
                float f6 = (0.3f * f4) + 0.7f;
                canvas.scale(f6, f6, fM1081dp, fM1081dp2);
                float scale = this.bounce.getScale(0.04f);
                canvas.scale(scale, scale, fM1081dp, fM1081dp2);
                if (f4 > 0.0f) {
                    float f7 = this.animatedAnonymous.set(this.anonymous);
                    if (f7 < 1.0f) {
                        f2 = 255.0f;
                        f = 40.0f;
                        this.imageReceiver.setImageCoords(fM1081dp - (AndroidUtilities.m1081dp(56.0f) / 2.0f), fM1081dp2 - (AndroidUtilities.m1081dp(56.0f) / 2.0f), AndroidUtilities.m1081dp(56.0f), AndroidUtilities.m1081dp(56.0f));
                    ...
                    if (f7 > 0.0f) {
                        int i2 = (int) fM1081dp;
                        int i3 = (int) fM1081dp2;
                        this.anonymousAvatarDrawable.setBounds(i2 - (AndroidUtilities.m1081dp(56.0f) / 2), i3 - (AndroidUtilities.m1081dp(56.0f) / 2), i2 + (AndroidUtilities.m1081dp(56.0f) / 2), i3 + (AndroidUtilities.m1081dp(56.0f) / 2));
                        this.anonymousAvatarDrawable.setAlpha((int) (f4 * f2 * f7));
                        this.anonymousAvatarDrawable.draw(canvas);
                        this.anonymousAvatarDrawable.setAlpha(Function.USE_VARARGS);
                    }
                } else {
                    f = 40.0f;
                    f2 = 255.0f;
                ...
                RectF rectF = AndroidUtilities.rectTmp;
                rectF.set((fM1081dp - (this.starsText.getCurrentWidth() / 2.0f)) - AndroidUtilities.m1081dp(5.66f), (AndroidUtilities.m1081dp(23.0f) + fM1081dp2) - (AndroidUtilities.m1081dp(16.0f) / 2.0f), (this.starsText.getCurrentWidth() / 2.0f) + fM1081dp + AndroidUtilities.m1081dp(5.66f), AndroidUtilities.m1081dp(23.0f) + fM1081dp2 + (AndroidUtilities.m1081dp(16.0f) / 2.0f));
                ...
                text.draw(canvas, fM1081dp - (text.getCurrentWidth() / 2.0f), AndroidUtilities.m1081dp(23.0f) + fM1081dp2, -1, f4);
                this.text.ellipsize(width - AndroidUtilities.m1081dp(4.0f)).draw(canvas, fM1081dp - (this.text.getWidth() / 2.0f), fM1081dp2 + AndroidUtilities.m1081dp(42.0f), Theme.getColor(Theme.key_windowBackgroundWhiteBlackText, StarsReactionsSheet.this.resourcesProvider), f4);
                if (this.place > 0) {
                    int i5 = (int) fM1081dp;
                    int i6 = (int) fM1081dp2;
                    this.crownOutline.setBounds(i5 - AndroidUtilities.m1081dp(12.0f), i6 - AndroidUtilities.m1081dp(f), AndroidUtilities.m1081dp(12.0f) + i5, i6 - AndroidUtilities.m1081dp(16.0f));
                    this.crown.setBounds(i5 - AndroidUtilities.m1081dp(12.0f), i6 - AndroidUtilities.m1081dp(f), i5 + AndroidUtilities.m1081dp(12.0f), i6 - AndroidUtilities.m1081dp(16.0f));
                    ...
                    text2.draw(canvas, fM1081dp - (text2.getCurrentWidth() / 2.0f), fM1081dp2 - AndroidUtilities.m1081dp(27.0f), -1, f4);
                }
                canvas.restore();
            }
        }
