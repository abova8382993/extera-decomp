...
public class ComposeDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        if (f > 0.0f) {
            ...
            this.icon.setBounds(getBounds().left + this.f2066tx, getBounds().top + this.f2067ty, getBounds().left + this.f2066tx + this.icon.getIntrinsicWidth(), getBounds().top + this.f2067ty + this.icon.getIntrinsicHeight());
