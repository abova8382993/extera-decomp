...
import org.telegram.p026ui.SessionsActivity;
import org.telegram.p026ui.bots.BotBiometry;
import org.telegram.p026ui.bots.BotBiometrySettings;
...
public class PrivacySettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static /* synthetic */ void m16277$r8$lambda$DPP8PtFalvDYsSlbRJJHb1FeA(TLObject tLObject, TLRPC.TL_error tL_error) {
    }
    ...
    */
    public void onFragmentDestroy() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.PrivacySettingsActivity.onFragmentDestroy():void");
    }
    ...
    public View createView(final Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2702R.string.PrivacySettings));
        ...
        C62292 c62292 = new LinearLayoutManager(context, 1, false) { // from class: org.telegram.ui.PrivacySettingsActivity.2
            @Override // androidx.recyclerview.widget.LinearLayoutManager, androidx.recyclerview.widget.RecyclerView.LayoutManager
            public boolean supportsPredictiveItemAnimations() {
                return false;
            }

            C62292(final Context context2, int i, boolean z) {
                super(context2, i, z);
            }
        };
        this.layoutManager = c62292;
        recyclerListView2.setLayoutManager(c62292);
    ...
    class C62281 extends ActionBar.ActionBarMenuOnItemClick {
        C62281() {
        }
    ...
    class C62292 extends LinearLayoutManager {
        @Override // androidx.recyclerview.widget.LinearLayoutManager, androidx.recyclerview.widget.RecyclerView.LayoutManager
        public boolean supportsPredictiveItemAnimations() {
            return false;
        }
    ...
    public /* synthetic */ void lambda$createView$20(Context context, View view, int i) {
        ...
        if (view.isEnabled()) {
            ...
            if (i == this.deleteAccountRow) {
                ...
                builder.setTitle(LocaleController.getString("DeleteAccountTitle", C2702R.string.DeleteAccountTitle));
            ...
            if (i == this.emailLoginRow) {
                ...
                new AlertDialog.Builder(context).setTitle(spannableStringBuilderValueOf).setMessage(LocaleController.getString(C2702R.string.EmailLoginChangeMessage)).setPositiveButton(LocaleController.getString(C2702R.string.ChangeEmail), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.PrivacySettingsActivity$$ExternalSyntheticLambda10
            ...
            if (i == this.passwordRow) {
                ...
                if (!TwoStepVerificationActivity.canHandleCurrentPassword(password2, false)) {
                    AlertsCreator.showUpdateAppAlert(getParentActivity(), LocaleController.getString("UpdateAppAlert", C2702R.string.UpdateAppAlert), true);
                }
            ...
            if (i == this.passkeysRow) {
                ...
                if (password4 == null || !password4.has_password) {
                    BulletinFactory.m1195of(this).createSimpleBulletin(C2702R.raw.chats_infotip, AndroidUtilities.replaceTags(LocaleController.getString(C2702R.string.PaymentCardSavePaymentInformationInfoLine2).replace("*", "**")), LocaleController.getString(C2702R.string.Enable), new Runnable() { // from class: org.telegram.ui.PrivacySettingsActivity$$ExternalSyntheticLambda11
            ...
            if (i == this.contactsDeleteRow) {
                ...
                builder2.setTitle(LocaleController.getString("SyncContactsDeleteTitle", C2702R.string.SyncContactsDeleteTitle));
                builder2.setMessage(AndroidUtilities.replaceTags(LocaleController.getString("SyncContactsDeleteText", C2702R.string.SyncContactsDeleteText)));
                builder2.setNegativeButton(LocaleController.getString("Cancel", C2702R.string.Cancel), null);
                builder2.setPositiveButton(LocaleController.getString("Delete", C2702R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.PrivacySettingsActivity$$ExternalSyntheticLambda12
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                    public final void onClick(AlertDialog alertDialog, int i5) {
            ...
            if (i == this.contactsSuggestRow) {
                ...
                if (this.newSuggest) {
                    ...
                    builder3.setTitle(LocaleController.getString("SuggestContactsTitle", C2702R.string.SuggestContactsTitle));
                    builder3.setMessage(LocaleController.getString("SuggestContactsAlert", C2702R.string.SuggestContactsAlert));
                    builder3.setPositiveButton(LocaleController.getString("MuteDisable", C2702R.string.MuteDisable), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.PrivacySettingsActivity$$ExternalSyntheticLambda13
                        @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                        public final void onClick(AlertDialog alertDialog, int i5) {
                            this.f$0.lambda$createView$14(textCheckCell, alertDialog, i5);
                        }
                    });
                    builder3.setNegativeButton(LocaleController.getString("Cancel", C2702R.string.Cancel), null);
            ...
            if (i == this.paymentsClearRow) {
                ...
                builder4.setTitle(LocaleController.getString("PrivacyPaymentsClearAlertTitle", C2702R.string.PrivacyPaymentsClearAlertTitle));
                builder4.setMessage(LocaleController.getString("PrivacyPaymentsClearAlertText", C2702R.string.PrivacyPaymentsClearAlertText));
                LinearLayout linearLayout2 = new LinearLayout(getParentActivity());
                linearLayout2.setOrientation(1);
                builder4.setView(linearLayout2);
                for (int i5 = 0; i5 < 2; i5++) {
                    if (i5 == 0) {
                        string = LocaleController.getString("PrivacyClearShipping", C2702R.string.PrivacyClearShipping);
                    } else {
                        string = LocaleController.getString("PrivacyClearPayment", C2702R.string.PrivacyClearPayment);
                    }
                    this.clear[i5] = true;
                    ...
                    checkBoxCell.setPadding(AndroidUtilities.m1081dp(4.0f), 0, AndroidUtilities.m1081dp(4.0f), 0);
                ...
                builder4.setPositiveButton(LocaleController.getString("ClearButton", C2702R.string.ClearButton), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.PrivacySettingsActivity$$ExternalSyntheticLambda16
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                    public final void onClick(AlertDialog alertDialog, int i6) {
                        this.f$0.lambda$createView$19(alertDialog, i6);
                    }
                });
                builder4.setNegativeButton(LocaleController.getString("Cancel", C2702R.string.Cancel), null);
    ...
    public /* synthetic */ void lambda$createView$19(AlertDialog alertDialog, int i) {
        ...
        builder.setTitle(LocaleController.getString("PrivacyPaymentsClearAlertTitle", C2702R.string.PrivacyPaymentsClearAlertTitle));
        builder.setMessage(LocaleController.getString("PrivacyPaymentsClearAlert", C2702R.string.PrivacyPaymentsClearAlert));
        builder.setPositiveButton(LocaleController.getString("ClearButton", C2702R.string.ClearButton), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.PrivacySettingsActivity$$ExternalSyntheticLambda17
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
    ...
    public /* synthetic */ void lambda$createView$18(AlertDialog alertDialog, int i) {
        ...
        getConnectionsManager().sendRequest(tL_payments_clearSavedInfo, new RequestDelegate() { // from class: org.telegram.ui.PrivacySettingsActivity$$ExternalSyntheticLambda24
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                PrivacySettingsActivity.m16277$r8$lambda$DPP8PtFalvDYsSlbRJJHb1FeA(tLObject, tL_error);
            }
        });
        boolean[] zArr2 = this.clear;
        boolean z = zArr2[0];
        if (z && zArr2[1]) {
            string = LocaleController.getString("PrivacyPaymentsPaymentShippingCleared", C2702R.string.PrivacyPaymentsPaymentShippingCleared);
        } else if (z) {
            string = LocaleController.getString("PrivacyPaymentsShippingInfoCleared", C2702R.string.PrivacyPaymentsShippingInfoCleared);
        } else if (!zArr2[1]) {
            return;
        } else {
            string = LocaleController.getString("PrivacyPaymentsPaymentInfoCleared", C2702R.string.PrivacyPaymentsPaymentInfoCleared);
        }
        BulletinFactory.m1195of(this).createSimpleBulletin(C2702R.raw.chats_infotip, string).show();
    }
    ...
    public static String formatRulesString(AccountInstance accountInstance, int i) {
        ...
        if (privacyRules == null || privacyRules.size() == 0) {
            if (i == 3) {
                return LocaleController.getString(C2702R.string.P2PNobody);
            }
            return LocaleController.getString(C2702R.string.LastSeenNobody);
        }
        Boolean bool2 = null;
        byte b = -1;
        int size = 0;
        ...
        if (i == 12 && globalPrivacySettings != null && (disallowedGiftsSettings2 = globalPrivacySettings.disallowed_stargifts) != null && disallowedGiftsSettings2.disallow_unique_stargifts && disallowedGiftsSettings2.disallow_unlimited_stargifts && disallowedGiftsSettings2.disallow_limited_stargifts && !disallowedGiftsSettings2.disallow_premium_gifts) {
            return LocaleController.getString(C2702R.string.PrivacyValueGiftsOnlyPremium);
        }
        if (i == 12 && globalPrivacySettings != null && (disallowedGiftsSettings = globalPrivacySettings.disallowed_stargifts) != null && disallowedGiftsSettings.disallow_unique_stargifts && disallowedGiftsSettings.disallow_unlimited_stargifts && disallowedGiftsSettings.disallow_limited_stargifts && disallowedGiftsSettings.disallow_premium_gifts) {
            return LocaleController.getString(C2702R.string.PrivacyValueGiftsNone);
        }
        if (b == 0 || (b == -1 && size2 > 0)) {
            if (i == 3) {
                return size2 == 0 ? LocaleController.getString(C2702R.string.P2PEverybody) : LocaleController.formatString(C2702R.string.P2PEverybodyMinus, Integer.valueOf(size2));
            }
            if (i != 12) {
                return size2 == 0 ? LocaleController.getString(C2702R.string.LastSeenEverybody) : LocaleController.formatString(C2702R.string.LastSeenEverybodyMinus, Integer.valueOf(size2));
            }
            if (size2 == 0) {
                return LocaleController.getString((bool2 == null || bool2.booleanValue()) ? C2702R.string.LastSeenEverybody : C2702R.string.PrivacyValueEveryoneExceptBots);
            }
            return LocaleController.formatString((bool2 == null || bool2.booleanValue()) ? C2702R.string.LastSeenEverybodyMinus : C2702R.string.PrivacyValueEveryoneExceptBotsMinus, Integer.valueOf(size2));
        }
        if (b != 2 && (b != -1 || size2 <= 0 || size <= 0)) {
            if (b != 1 && size <= 0) {
                if (bool2 != null && bool2.booleanValue()) {
                    return LocaleController.getString(C2702R.string.PrivacyValueOnlyBots);
                }
                return "unknown";
            }
            if (i == 3) {
                return size == 0 ? LocaleController.getString(C2702R.string.P2PNobody) : LocaleController.formatString(C2702R.string.P2PNobodyPlus, Integer.valueOf(size));
            }
            if (size != 0) {
                return LocaleController.formatString(z ? C2702R.string.LastSeenNobodyPremiumPlus : C2702R.string.LastSeenNobodyPlus, Integer.valueOf(size));
            }
            if (z) {
                return LocaleController.getString(C2702R.string.LastSeenNobodyPremium);
            }
            if (bool2 != null && bool2.booleanValue()) {
                return LocaleController.getString(C2702R.string.PrivacyValueOnlyBots);
            }
        ...
        if (i == 3) {
            if (size == 0 && size2 == 0) {
                return LocaleController.getString("P2PContacts", C2702R.string.P2PContacts);
            }
            return (size == 0 || size2 == 0) ? size2 != 0 ? LocaleController.formatString(C2702R.string.P2PContactsMinus, Integer.valueOf(size2)) : LocaleController.formatString(C2702R.string.P2PContactsPlus, Integer.valueOf(size)) : LocaleController.formatString(C2702R.string.P2PContactsMinusPlus, Integer.valueOf(size2), Integer.valueOf(size));
        }
        if (size == 0 && size2 == 0) {
            if (z) {
                return LocaleController.getString(C2702R.string.LastSeenContactsPremium);
            }
            if (bool2 != null && bool2.booleanValue()) {
                return LocaleController.getString(C2702R.string.PrivacyContactsAndBotUsers);
            }
            return LocaleController.getString(C2702R.string.LastSeenContacts);
        }
        if (size != 0 && size2 != 0) {
            return LocaleController.formatString((bool2 == null || !bool2.booleanValue()) ? z ? C2702R.string.LastSeenContactsPremiumMinusPlus : C2702R.string.LastSeenContactsMinusPlus : C2702R.string.PrivacyContactsAndBotUsersMinusPlus, Integer.valueOf(size2), Integer.valueOf(size));
        }
        if (size2 != 0) {
            return LocaleController.formatString((bool2 == null || !bool2.booleanValue()) ? z ? C2702R.string.LastSeenContactsPremiumMinus : C2702R.string.LastSeenContactsMinus : C2702R.string.PrivacyContactsAndBotUsersMinus, Integer.valueOf(size2));
        }
        return LocaleController.formatString((bool2 == null || !bool2.booleanValue()) ? z ? C2702R.string.LastSeenContactsPremiumPlus : C2702R.string.LastSeenContactsPlus : C2702R.string.PrivacyContactsAndBotUsersPlus, Integer.valueOf(size));
    }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (i == PrivacySettingsActivity.this.webSessionsRow) {
                    textSettingsCell.setText(LocaleController.getString("WebSessionsTitle", C2702R.string.WebSessionsTitle), false);
                    ...
                    textSettingsCell.setTextAndValue(LocaleController.getString("PrivacyPhone", C2702R.string.PrivacyPhone), pluralString, true);
                    ...
                    textSettingsCell.setTextAndValue(LocaleController.getString("PrivacyLastSeen", C2702R.string.PrivacyLastSeen), pluralString, true);
                } else {
                    if (i == PrivacySettingsActivity.this.groupsRow) {
                        ...
                        textSettingsCell.setTextAndValue(LocaleController.getString(C2702R.string.PrivacyInvites), pluralString, false);
                        ...
                        textSettingsCell.setTextAndValue(LocaleController.getString("Calls", C2702R.string.Calls), pluralString, true);
                        ...
                        textSettingsCell.setTextAndValue(LocaleController.getString("PrivacyProfilePhoto", C2702R.string.PrivacyProfilePhoto), pluralString, true);
                        ...
                        textSettingsCell.setTextAndValue(LocaleController.getString("PrivacyBio", C2702R.string.PrivacyBio), pluralString, true);
                        ...
                        textSettingsCell.setTextAndValue(LocaleController.getString(C2702R.string.PrivacyMusic), pluralString, true);
                        ...
                        textSettingsCell.setTextAndValue(LocaleController.getString(C2702R.string.PrivacyBirthday), pluralString, true);
                        ...
                        textSettingsCell.setTextAndValue(LocaleController.getString(C2702R.string.PrivacyGifts), pluralString, true);
                        ...
                        textSettingsCell.setTextAndValue(LocaleController.getString("PrivacyForwards", C2702R.string.PrivacyForwards), pluralString, true);
                        ...
                        if (PrivacySettingsActivity.this.getContactsController().getLoadingPrivacyInfo(8)) {
                            ...
                            if (!PrivacySettingsActivity.this.getUserConfig().isPremium()) {
                                pluralString = LocaleController.getString(C2702R.string.P2PEverybody);
                            } else {
                                pluralString = PrivacySettingsActivity.formatRulesString(PrivacySettingsActivity.this.getAccountInstance(), 8);
                            }
                            z = false;
                        }
                        textSettingsCell.setTextAndValue(PrivacySettingsActivity.addPremiumStar(LocaleController.getString(C2702R.string.PrivacyVoiceMessages)), pluralString, PrivacySettingsActivity.this.noncontactsRow != -1);
                        ...
                        textSettingsCell.setTextAndValue((!PrivacySettingsActivity.this.getMessagesController().newNoncontactPeersRequirePremiumWithoutOwnpremium || PrivacySettingsActivity.this.getMessagesController().starsPaidMessagesAvailable) ? PrivacySettingsActivity.addPremiumStar(LocaleController.getString(C2702R.string.PrivacyMessages)) : LocaleController.getString(C2702R.string.PrivacyMessages), LocaleController.getString(PrivacySettingsActivity.this.feeValue ? C2702R.string.ContactsAndFee : PrivacySettingsActivity.this.noncontactsValue ? C2702R.string.ContactsAndPremium : C2702R.string.P2PEverybody), PrivacySettingsActivity.this.musicRow != -1);
                    } else if (i == PrivacySettingsActivity.this.passportRow) {
                        textSettingsCell.setText(LocaleController.getString("TelegramPassport", C2702R.string.TelegramPassport), true);
                        ...
                        textSettingsCell.setTextAndValue(LocaleController.getString("DeleteAccountIfAwayFor3", C2702R.string.DeleteAccountIfAwayFor3), pluralString, PrivacySettingsActivity.this.deleteAccountUpdate, false);
                        PrivacySettingsActivity.this.deleteAccountUpdate = false;
                    } else if (i == PrivacySettingsActivity.this.paymentsClearRow) {
                        textSettingsCell.setText(LocaleController.getString("PrivacyPaymentsClear", C2702R.string.PrivacyPaymentsClear), true);
                    } else if (i == PrivacySettingsActivity.this.botsBiometryRow) {
                        textSettingsCell.setText(LocaleController.getString(C2702R.string.PrivacyBiometryBotsButton), true);
                    } else if (i == PrivacySettingsActivity.this.secretMapRow) {
                        int i5 = SharedConfig.mapPreviewType;
                        if (i5 == 0) {
                            string = LocaleController.getString("MapPreviewProviderTelegram", C2702R.string.MapPreviewProviderTelegram);
                        } else if (i5 == 1) {
                            string = LocaleController.getString("MapPreviewProviderGoogle", C2702R.string.MapPreviewProviderGoogle);
                        } else if (i5 == 2) {
                            string = LocaleController.getString("MapPreviewProviderNobody", C2702R.string.MapPreviewProviderNobody);
                        } else {
                            string = LocaleController.getString("MapPreviewProviderYandex", C2702R.string.MapPreviewProviderYandex);
                        }
                        textSettingsCell.setTextAndValue(LocaleController.getString("MapPreviewProvider", C2702R.string.MapPreviewProvider), string, PrivacySettingsActivity.this.secretMapUpdate, true);
                        PrivacySettingsActivity.this.secretMapUpdate = false;
                    } else if (i == PrivacySettingsActivity.this.contactsDeleteRow) {
                        textSettingsCell.setText(LocaleController.getString("SyncContactsDelete", C2702R.string.SyncContactsDelete), true);
                    }
                    z = z;
                }
            ...
            if (itemViewType == 1) {
                ...
                if (i == PrivacySettingsActivity.this.deleteAccountDetailRow) {
                    textInfoPrivacyCell.setText(LocaleController.getString("DeleteAccountHelp", C2702R.string.DeleteAccountHelp));
                    return;
                }
                if (i == PrivacySettingsActivity.this.groupsDetailRow) {
                    textInfoPrivacyCell.setText(LocaleController.getString("GroupsAndChannelsHelp", C2702R.string.GroupsAndChannelsHelp));
                    return;
                }
                if (i == PrivacySettingsActivity.this.sessionsDetailRow) {
                    textInfoPrivacyCell.setText(LocaleController.getString("SessionsSettingsInfo", C2702R.string.SessionsSettingsInfo));
                    return;
                }
                if (i == PrivacySettingsActivity.this.secretDetailRow) {
                    textInfoPrivacyCell.setText(LocaleController.getString("SecretWebPageInfo", C2702R.string.SecretWebPageInfo));
                    return;
                }
                if (i == PrivacySettingsActivity.this.botsDetailRow) {
                    textInfoPrivacyCell.setText(LocaleController.getString("PrivacyBotsInfo", C2702R.string.PrivacyBotsInfo));
                    return;
                }
                if (i == PrivacySettingsActivity.this.privacyShadowRow) {
                    textInfoPrivacyCell.setText(LocaleController.getString(C2702R.string.PrivacyInvitesInfo));
                    return;
                } else if (i == PrivacySettingsActivity.this.contactsDetailRow) {
                    textInfoPrivacyCell.setText(LocaleController.getString("SuggestContactsInfo", C2702R.string.SuggestContactsInfo));
                    return;
                } else {
                    if (i == PrivacySettingsActivity.this.newChatsSectionRow) {
                        textInfoPrivacyCell.setText(LocaleController.getString("ArchiveAndMuteInfo", C2702R.string.ArchiveAndMuteInfo));
                        return;
                    }
                    return;
                }
            ...
            if (itemViewType == 2) {
                ...
                if (i == PrivacySettingsActivity.this.privacySectionRow) {
                    headerCell.setText(LocaleController.getString("PrivacyTitle", C2702R.string.PrivacyTitle));
                    return;
                }
                if (i == PrivacySettingsActivity.this.securitySectionRow) {
                    headerCell.setText(LocaleController.getString("SecurityTitle", C2702R.string.SecurityTitle));
                    return;
                }
                if (i == PrivacySettingsActivity.this.advancedSectionRow) {
                    headerCell.setText(LocaleController.getString("DeleteMyAccount", C2702R.string.DeleteMyAccount));
                    return;
                }
                if (i == PrivacySettingsActivity.this.secretSectionRow) {
                    headerCell.setText(LocaleController.getString("SecretChat", C2702R.string.SecretChat));
                    return;
                }
                if (i == PrivacySettingsActivity.this.botsSectionRow) {
                    headerCell.setText(LocaleController.getString("PrivacyBots", C2702R.string.PrivacyBots));
                    return;
                } else if (i == PrivacySettingsActivity.this.contactsSectionRow) {
                    headerCell.setText(LocaleController.getString("Contacts", C2702R.string.Contacts));
                    return;
                } else {
                    if (i == PrivacySettingsActivity.this.newChatsHeaderRow) {
                        headerCell.setText(LocaleController.getString("NewChatsFromNonContacts", C2702R.string.NewChatsFromNonContacts));
                        return;
                    }
                    return;
                }
            ...
            if (itemViewType == 3) {
                ...
                if (i == PrivacySettingsActivity.this.secretWebpageRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getString("SecretWebPage", C2702R.string.SecretWebPage), PrivacySettingsActivity.this.getMessagesController().secretWebpagePreview == 1, false);
                    return;
                }
                if (i == PrivacySettingsActivity.this.contactsSyncRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getString("SyncContacts", C2702R.string.SyncContacts), PrivacySettingsActivity.this.newSync, true);
                    return;
                } else if (i == PrivacySettingsActivity.this.contactsSuggestRow) {
                    textCheckCell.setTextAndCheck(LocaleController.getString("SuggestContacts", C2702R.string.SuggestContacts), PrivacySettingsActivity.this.newSuggest, false);
                    return;
                } else {
                    if (i == PrivacySettingsActivity.this.newChatsRow) {
                        textCheckCell.setTextAndCheck(LocaleController.getString("ArchiveAndMute", C2702R.string.ArchiveAndMute), PrivacySettingsActivity.this.archiveChats, false);
                        return;
                    }
                    return;
                }
            ...
            if (i == PrivacySettingsActivity.this.autoDeleteMesages) {
                ...
                if (globalTTl == -1) {
                    ...
                    if (globalTTl > 0) {
                        ...
                        string6 = LocaleController.getString("PasswordOff", C2702R.string.PasswordOff);
                    }
                    str6 = string6;
                }
                textCell.setTextAndValueAndIcon(LocaleController.getString("AutoDeleteMessages", C2702R.string.AutoDeleteMessages), str6, true, C2702R.drawable.msg2_autodelete, true);
            } else {
                int i6 = PrivacySettingsActivity.this.sessionsRow;
                ...
                if (i == i6) {
                    if (PrivacySettingsActivity.this.devicesActivityPreload.getSessionsCount() == 0) {
                        if (PrivacySettingsActivity.this.getMessagesController().lastKnownSessionsCount != 0) {
                            ...
                            textCell.setTextAndValueAndIcon(LocaleController.getString("SessionsTitle", C2702R.string.SessionsTitle), str5, true, C2702R.drawable.msg2_devices, false);
                        }
                    } else {
                    ...
                    textCell.setTextAndSpoilersValueAndIcon(LocaleController.getString(C2702R.string.EmailLogin), charSequence, C2702R.drawable.msg2_email, true);
                } else if (i == PrivacySettingsActivity.this.passwordRow) {
                    int i8 = C2702R.drawable.menu_2sv;
                    if (PrivacySettingsActivity.this.currentPassword == null) {
                        i3 = i8;
                        ...
                        if (PrivacySettingsActivity.this.currentPassword.has_password) {
                            i8 = C2702R.drawable.menu_2sv_on;
                            string5 = LocaleController.getString(C2702R.string.PasswordOn);
                        } else {
                            string5 = LocaleController.getString(C2702R.string.PasswordOff);
                        }
                        i3 = i8;
                        str3 = string5;
                    }
                    textCell.setTextAndValueAndIcon(LocaleController.getString(C2702R.string.TwoStepVerification), str3, true, i3, true);
                    ...
                    if (arrayList == null) {
                        ...
                        if (arrayList.size() == 1 && textCell.valueTextView.getPaint().measureText(((TL_account.Passkey) PrivacySettingsActivity.this.currentPasskeys.get(0)).name) < AndroidUtilities.displaySize.x / 3.0f) {
                            ...
                            string4 = LocaleController.getString(C2702R.string.PasswordOff);
                        }
                        str2 = string4;
                    }
                    textCell.setTextAndValueAndIcon(LocaleController.getString(C2702R.string.Passkey), str2, true, C2702R.drawable.msg2_permissions, true);
                } else if (i == PrivacySettingsActivity.this.passcodeRow) {
                    if (SharedConfig.passcodeHash.length() != 0) {
                        string3 = LocaleController.getString(C2702R.string.PasswordOn);
                        i2 = C2702R.drawable.msg2_secret;
                    } else {
                        string3 = LocaleController.getString(C2702R.string.PasswordOff);
                        i2 = C2702R.drawable.msg2_secret;
                    }
                    textCell.setTextAndValueAndIcon(LocaleController.getString(C2702R.string.Passcode), string3, true, i2, true);
                    ...
                    if (i9 == 0) {
                        string2 = LocaleController.getString("BlockedEmpty", C2702R.string.BlockedEmpty);
                    } else if (i9 > 0) {
                        string2 = String.format(LocaleController.getInstance().getCurrentLocale(), TimeModel.NUMBER_FORMAT, Integer.valueOf(i9));
                    } else {
                        str = _UrlKt.FRAGMENT_ENCODE_SET;
                        z = true;
                        textCell.setTextAndValueAndIcon(LocaleController.getString("BlockedUsers", C2702R.string.BlockedUsers), str, true, C2702R.drawable.msg2_block2, true);
                    }
                    str = string2;
                    textCell.setTextAndValueAndIcon(LocaleController.getString("BlockedUsers", C2702R.string.BlockedUsers), str, true, C2702R.drawable.msg2_block2, true);
                }
    ...
    public static CharSequence addPremiumStar(String str) {
        if (premiumStar == null) {
            ...
            AnimatedEmojiDrawable.WrapSizeDrawable wrapSizeDrawable = new AnimatedEmojiDrawable.WrapSizeDrawable(PremiumGradient.getInstance().premiumStarMenuDrawable, AndroidUtilities.m1081dp(16.0f), AndroidUtilities.m1081dp(16.0f));
            wrapSizeDrawable.setBounds(0, 0, AndroidUtilities.m1081dp(16.0f), AndroidUtilities.m1081dp(16.0f));
