...
public class SelectStoriesBottomSheet extends BottomSheetWithRecyclerListView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public SelectStoriesBottomSheet(BaseFragment baseFragment, long j, int i, final Utilities.Callback callback) {
        ...
        buttonWithCounterView.setText(LocaleController.getString(C2702R.string.StoriesAlbumMenuAddStories), false);
    ...
    public void onAttachedToWindow() {
        ...
        this.f2088id = this.storiesList.link();
    ...
    public void onDetachedFromWindow() {
        ...
        this.storiesList.unlink(this.f2088id);
    ...
    protected CharSequence getTitle() {
        return LocaleController.getString(C2702R.string.StoriesAlbumMenuAddStories);
    }
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        arrayList.add(UItem.asSpace(AndroidUtilities.m1081dp(16.0f)));
