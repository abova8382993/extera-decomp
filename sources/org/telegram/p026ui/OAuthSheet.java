...
public abstract class OAuthSheet {
    ...
    public static void handle(final boolean z, int i, final TLRPC.TL_messages_requestUrlAuth tL_messages_requestUrlAuth, TLRPC.UrlAuthResult urlAuthResult, final String str, TLRPC.UrlAuthResult urlAuthResult2, boolean z2) {
        ...
        if (urlAuthResult instanceof TLRPC.TL_urlAuthResultAccepted) {
            ...
            if (TextUtils.isEmpty(tL_urlAuthResultAccepted.url)) {
                ...
                if (!TextUtils.isEmpty(str2)) {
                    getBulletinFactory().createSimpleBulletin(C2702R.raw.contact_check, LocaleController.getString(C2702R.string.BotAuthLoggedInSuccessTitle), AndroidUtilities.replaceSingleLinkBold(LocaleController.formatString(z4 && ((TLRPC.TL_urlAuthResultRequest) urlAuthResult2).request_phone_number && !z2 ? C2702R.string.BotAuthLoggedInSuccessWithoutPhoneNumber : C2702R.string.BotAuthLoggedInSuccess, str2), Theme.getColor(Theme.key_featuredStickers_addButton))).show();
                }
        ...
        if (urlAuthResult instanceof TLRPC.TL_urlAuthResultRequest) {
            ...
            frameLayout4.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1081dp(14.0f), safeLastFragment5.getThemedColor(Theme.key_dialogBackgroundGray)));
            ...
            frameLayout3.setPadding(AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(4.0f), AndroidUtilities.m1081dp(8.0f), 0);
            ...
            backupImageView3.setRoundRadius(AndroidUtilities.m1081dp(40.0f));
            ...
            textViewMakeTextView.setText(AndroidUtilities.replaceSingleLink(LocaleController.formatString(C2702R.string.BotAuthTitle, tL_urlAuthResultRequest.domain), safeLastFragment5.getThemedColor(Theme.key_featuredStickers_addButton)));
            ...
            textViewMakeTextView2.setText(AndroidUtilities.replaceTags(LocaleController.getString(z5 ? C2702R.string.BotAuthBotSubtitle : C2702R.string.BotAuthSiteSubtitle)));
            linearLayout.addView(textViewMakeTextView2, LayoutHelper.createLinear(-1, -2, 49, 32, 0, 32, 24));
            if (TextUtils.isEmpty(tL_urlAuthResultRequest.platform) && TextUtils.isEmpty(tL_urlAuthResultRequest.browser) && TextUtils.isEmpty(tL_urlAuthResultRequest.region) && TextUtils.isEmpty(tL_urlAuthResultRequest.f1766ip)) {
                ...
                linearLayout2.setBackground(Theme.createRoundRectDrawableShadowed(AndroidUtilities.m1081dp(16.0f), safeLastFragment5.getThemedColor(Theme.key_windowBackgroundWhite)));
                ...
                if (TextUtils.isEmpty(tL_urlAuthResultRequest.platform) && TextUtils.isEmpty(tL_urlAuthResultRequest.browser)) {
                    ...
                    imageView2.setImageResource(C2702R.drawable.msg2_devices);
                    backupImageView = backupImageView2;
                ...
                if (TextUtils.isEmpty(tL_urlAuthResultRequest.region) && TextUtils.isEmpty(tL_urlAuthResultRequest.f1766ip)) {
                    z3 = false;
                } else {
                    LinearLayout linearLayout5 = new LinearLayout(context);
                    linearLayout5.setOrientation(0);
                    ImageView imageView3 = new ImageView(context);
                    imageView3.setImageResource(C2702R.drawable.msg2_language);
                    ...
                    textViewMakeTextView6.setText(TextUtils.isEmpty(tL_urlAuthResultRequest.f1766ip) ? "—" : LocaleController.formatString(C2702R.string.BotAuthBasedOnIP, tL_urlAuthResultRequest.f1766ip));
                ...
                textViewMakeTextView7.setText(LocaleController.getString(C2702R.string.BotAuthInfo));
            ...
            if (tL_urlAuthResultRequest.request_write_access) {
                ...
                frameLayout5.setBackground(Theme.createRoundRectDrawableShadowed(iM1081dp, safeLastFragment5.getThemedColor(i4)));
                final TextCheckCell textCheckCell2 = new TextCheckCell(context, safeLastFragment5.getResourceProvider());
                textCheckCell2.setTextAndCheck(LocaleController.getString(C2702R.string.BotAuthAllowMessages), true, false);
                ...
                textViewMakeTextView8.setText(LocaleController.formatString(C2702R.string.BotAuthAllowMessagesInfo, UserObject.getUserName(tL_urlAuthResultRequest.bot)));
            ...
            neutral.setText(LocaleController.getString(C2702R.string.Cancel));
            ...
            round.setText(LocaleController.getString(C2702R.string.BotAuthLogin));
    ...
    public static /* synthetic */ void $r8$lambda$7_3AeFi8ezkwu8oP5SRzNABRlBM(BottomSheet bottomSheet, FrameLayout frameLayout, ArrayList arrayList, final int[] iArr, final AvatarDrawable avatarDrawable, final BackupImageView backupImageView, View view) {
        ...
        itemOptionsMakeOptions.setDrawScrim(false).setOnTopOfScrim().setDimAlpha(0).setGravity(3).translate(-AndroidUtilities.m1081dp(8.0f), -AndroidUtilities.m1081dp(8.0f)).show();
    }
    ...
    public static /* synthetic */ void $r8$lambda$E4oOkmMDws9eYhC7NcjsgOvj6GQ(BottomSheet bottomSheet, boolean z, int[] iArr, TLRPC.TL_messages_requestUrlAuth tL_messages_requestUrlAuth, String str, TLRPC.TL_urlAuthResultRequest tL_urlAuthResultRequest, TLRPC.TL_messages_acceptUrlAuth tL_messages_acceptUrlAuth, TLRPC.UrlAuthResult urlAuthResult, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null) {
            BulletinFactory.m1194of(bottomSheet.topBulletinContainer, bottomSheet.getResourcesProvider()).showForError(tL_error);
        } else {
    ...
    public static /* synthetic */ void $r8$lambda$16vmLyJUJdWwk30gQWkPHNSF4Sk(TLRPC.TL_urlAuthResultRequest tL_urlAuthResultRequest, int[] iArr, Context context, BaseFragment baseFragment, boolean z, final boolean[] zArr, final Runnable runnable, View view) {
        if (tL_urlAuthResultRequest.request_phone_number) {
            TLRPC.User currentUser = UserConfig.getInstance(iArr[0]).getCurrentUser();
            AlertDialog.Builder title = new AlertDialog.Builder(context, baseFragment.getResourceProvider()).setTitle(LocaleController.getString(C2702R.string.BotAuthPhoneNumber));
            int i = C2702R.string.BotAuthPhoneNumberText;
            String userName = z ? UserObject.getUserName(tL_urlAuthResultRequest.bot) : tL_urlAuthResultRequest.domain;
            title.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString(i, userName, PhoneFormat.getInstance().format("+" + currentUser.phone).replaceAll(" ", " ")))).setNegativeButton(LocaleController.getString(C2702R.string.BotAuthPhoneNumberDeny), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.OAuthSheet$$ExternalSyntheticLambda8
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i2) {
                    OAuthSheet.m15026$r8$lambda$ySP0ee1tCATlERznI7eE6BBRkw(zArr, runnable, alertDialog, i2);
                }
            }).setPositiveButton(LocaleController.getString(C2702R.string.BotAuthPhoneNumberAccept), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.OAuthSheet$$ExternalSyntheticLambda9
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i2) {
    ...
    /* JADX INFO: renamed from: $r8$lambda$ySP-0ee1tCATlERznI7eE6BBRkw, reason: not valid java name */
    public static /* synthetic */ void m15026$r8$lambda$ySP0ee1tCATlERznI7eE6BBRkw(boolean[] zArr, Runnable runnable, AlertDialog alertDialog, int i) {
        zArr[0] = false;
        runnable.run();
    }
    ...
    public static BulletinFactory getBulletinFactory() {
        ...
        if (!BotWebViewSheet.activeSheets.isEmpty()) {
            ...
            if (botWebViewSheet != null) {
                ...
                return BulletinFactory.m1194of(Bulletin.BulletinWindow.make(parentActivity2), null);
            }
        }
        if (!ArticleViewer.activeSheets.isEmpty()) {
            ...
            if (articleViewer != null) {
                ...
                return BulletinFactory.m1194of(Bulletin.BulletinWindow.make(parentActivity), null);
            }
        }
