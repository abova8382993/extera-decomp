...
public class ArchivedStickersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        if (i == 0) {
            this.actionBar.setTitle(LocaleController.getString(C2702R.string.ArchivedStickers));
        } else if (i == 5) {
            this.actionBar.setTitle(LocaleController.getString(C2702R.string.ArchivedEmojiPacks));
        } else {
            this.actionBar.setTitle(LocaleController.getString(C2702R.string.ArchivedMasks));
        }
        ...
        if (this.currentType == 0) {
            emptyTextProgressView.setText(LocaleController.getString(C2702R.string.ArchivedStickersEmpty));
        } else {
            emptyTextProgressView.setText(LocaleController.getString(C2702R.string.ArchivedMasksEmpty));
        }
    ...
    class C29611 extends ActionBar.ActionBarMenuOnItemClick {
        C29611() {
        }
    ...
    public /* synthetic */ void lambda$createView$0(View view, int i) {
        ...
        TLRPC.StickerSetCovered stickerSetCovered = (TLRPC.StickerSetCovered) this.sets.get(i - this.stickersStartRow);
        if (stickerSetCovered.set.f1646id != 0) {
            tL_inputStickerSetShortName = new TLRPC.TL_inputStickerSetID();
            tL_inputStickerSetShortName.f1635id = stickerSetCovered.set.f1646id;
        } else {
        ...
        stickersAlert.setInstallDelegate(new StickersAlert.StickersAlertInstallDelegate() { // from class: org.telegram.ui.ArchivedStickersActivity.2
            ...
            C29622(View view2, TLRPC.StickerSetCovered stickerSetCovered2) {
                view = view2;
            ...
            public void onStickerSetInstalled() {
                ...
                longSparseArray.put(stickerSetCovered2.set.f1646id, stickerSetCovered2);
            }
        });
    ...
    class C29622 implements StickersAlert.StickersAlertInstallDelegate {
        final /* synthetic */ TLRPC.StickerSetCovered val$stickerSet;
        final /* synthetic */ View val$view;
    ...
    class C29633 extends RecyclerView.OnScrollListener {
        C29633() {
        }
    ...
    public void getStickers() {
        ...
        if (this.sets.isEmpty()) {
            ...
            j = ((TLRPC.StickerSetCovered) arrayList.get(arrayList.size() - 1)).set.f1646id;
        }
    ...
    public void lambda$processResponse$3(final TLRPC.TL_messages_archivedStickers tL_messages_archivedStickers) {
        if (!this.isInTransition) {
            ...
            while (i2 < size) {
                ...
                if (!this.loadedSets.contains(Long.valueOf(stickerSetCovered.set.f1646id))) {
                    this.loadedSets.add(Long.valueOf(stickerSetCovered.set.f1646id));
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (i == NotificationCenter.needAddArchivedStickers) {
            ...
            for (int size = arrayList.size() - 1; size >= 0; size--) {
                ...
                while (true) {
                    ...
                    if (((TLRPC.StickerSetCovered) this.sets.get(i3)).set.f1646id == ((TLRPC.StickerSetCovered) arrayList.get(size)).set.f1646id) {
        ...
        for (int i4 = 0; i4 < childCount; i4++) {
            ...
            if ((childAt instanceof ArchivedStickerSetCell) && (stickersSet = (archivedStickerSetCell = (ArchivedStickerSetCell) childAt).getStickersSet()) != null) {
                boolean zIsStickerPackInstalled = MediaDataController.getInstance(this.currentAccount).isStickerPackInstalled(stickersSet.set.f1646id);
                if (zIsStickerPackInstalled) {
                    this.installingStickerSets.remove(stickersSet.set.f1646id);
    ...
    class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            if (getItemViewType(i) == 0) {
                ...
                boolean zIsStickerPackInstalled = MediaDataController.getInstance(((BaseFragment) ArchivedStickersActivity.this).currentAccount).isStickerPackInstalled(stickerSetCovered.set.f1646id);
                archivedStickerSetCell.setChecked(zIsStickerPackInstalled, false, false);
                if (zIsStickerPackInstalled) {
                    ArchivedStickersActivity.this.installingStickerSets.remove(stickerSetCovered.set.f1646id);
                    archivedStickerSetCell.setDrawProgress(false, false);
                } else {
                    archivedStickerSetCell.setDrawProgress(ArchivedStickersActivity.this.installingStickerSets.indexOfKey(stickerSetCovered.set.f1646id) >= 0, false);
                }
            ...
            if (getItemViewType(i) == 2) {
                ...
                if (i == ArchivedStickersActivity.this.archiveInfoRow) {
                    ...
                    textInfoPrivacyCell.setText(LocaleController.getString(ArchivedStickersActivity.this.currentType == 5 ? C2702R.string.ArchivedEmojiInfo : C2702R.string.ArchivedStickersInfo));
                } else {
        ...
        public /* synthetic */ void lambda$onBindViewHolder$0(TLRPC.StickerSetCovered stickerSetCovered, ArchivedStickerSetCell archivedStickerSetCell, boolean z) {
            if (z) {
                ...
                if (ArchivedStickersActivity.this.installingStickerSets.indexOfKey(stickerSetCovered.set.f1646id) >= 0) {
                    return;
                }
                archivedStickerSetCell.setDrawProgress(true, true);
                ArchivedStickersActivity.this.installingStickerSets.put(stickerSetCovered.set.f1646id, stickerSetCovered);
            }
