...
public class CacheChatsExceptionsFragment extends BaseFragment {
    ...
    private void updateRows() {
        ...
        int i3 = 3;
        if (z) {
            this.items.add(new Item(i3, b6 == true ? 1 : 0));
            this.items.add(new Item(4, b4 == true ? 1 : 0));
        }
        this.items.add(new Item(i3, b2 == true ? 1 : 0));
