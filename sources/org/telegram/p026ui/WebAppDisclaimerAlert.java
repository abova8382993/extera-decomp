...
public class WebAppDisclaimerAlert {
    ...
    public static void show(final Context context, final Consumer consumer, TLRPC.User user, final Runnable runnable) {
        ...
        builder.setTitle(LocaleController.getString(C2702R.string.TermsOfUse));
        ...
        textView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2702R.string.BotWebAppDisclaimerSubtitle)));
        webAppDisclaimerAlert.cell.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(C2702R.string.BotWebAppDisclaimerCheck), new Runnable() { // from class: org.telegram.ui.WebAppDisclaimerAlert$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                Browser.openUrl(context, LocaleController.getString(C2702R.string.WebAppDisclaimerUrl));
            }
        }), _UrlKt.FRAGMENT_ENCODE_SET, false, false);
        builder.setView(linearLayout);
        builder.setPositiveButton(LocaleController.getString(C2702R.string.Continue), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.WebAppDisclaimerAlert$$ExternalSyntheticLambda1
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
                WebAppDisclaimerAlert.$r8$lambda$ieZxLpbNUQex9tFQgbaeiuh1B5I(consumer, zArr, alertDialog, i);
            }
        });
        builder.setNegativeButton(LocaleController.getString(C2702R.string.Cancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.WebAppDisclaimerAlert$$ExternalSyntheticLambda2
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
                alertDialog.dismiss();
            }
        ...
        webAppDisclaimerAlert.cell.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.WebAppDisclaimerAlert$$ExternalSyntheticLambda3
            ...
            public final void onClick(View view) {
                WebAppDisclaimerAlert.m19754$r8$lambda$ICLm3wirtfJP4fPzJ1h4N5G00Y(this.f$0, view);
            }
        });
    ...
    public static /* synthetic */ void m19754$r8$lambda$ICLm3wirtfJP4fPzJ1h4N5G00Y(WebAppDisclaimerAlert webAppDisclaimerAlert, View view) {
