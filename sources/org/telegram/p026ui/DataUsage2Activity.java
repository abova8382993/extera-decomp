...
import org.telegram.p026ui.DataUsage2Activity;
...
public class DataUsage2Activity extends BaseFragment {
    ...
    private static int[] particles = {C2702R.drawable.msg_filled_data_videos, C2702R.drawable.msg_filled_data_files, C2702R.drawable.msg_filled_data_photos, C2702R.drawable.msg_filled_data_messages, C2702R.drawable.msg_filled_data_music, C2702R.drawable.msg_filled_data_voice, C2702R.drawable.msg_filled_data_calls};
    private static int[] titles = {C2702R.string.LocalVideoCache, C2702R.string.LocalDocumentCache, C2702R.string.LocalPhotoCache, C2702R.string.MessagesSettings, C2702R.string.LocalMusicCache, C2702R.string.LocalAudioCache, C2702R.string.CallsDataUsage};
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2702R.string.NetworkUsage));
    ...
    private class PageAdapter extends ViewPagerFixed.Adapter {
        ...
        public String getItemTitle(int i) {
            if (i == 0) {
                return LocaleController.getString(C2702R.string.NetworkUsageAllTab);
            }
            if (i == 1) {
                return LocaleController.getString(C2702R.string.NetworkUsageMobileTab);
            }
            if (i == 2) {
                return LocaleController.getString(C2702R.string.NetworkUsageWiFiTab);
            }
            if (i == 3) {
                return LocaleController.getString(C2702R.string.NetworkUsageRoamingTab);
            }
    ...
    class ListView extends RecyclerListView {
        ...
        public /* synthetic */ void lambda$new$1(View view, int i) {
            ...
            if (view instanceof TextCell) {
                ...
                builder.setTitle(LocaleController.getString(C2702R.string.ResetStatisticsAlertTitle));
                builder.setMessage(LocaleController.getString(C2702R.string.ResetStatisticsAlert));
                builder.setPositiveButton(LocaleController.getString(C2702R.string.Reset), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.DataUsage2Activity$ListView$$ExternalSyntheticLambda3
        ...
        private void updateRows(boolean z) {
            ...
            long j2 = 0;
            if (this.totalSize > 0) {
                string = LocaleController.formatString(C2702R.string.YourNetworkUsageSince, LocaleController.getInstance().getFormatterStats().format(getResetStatsDate()));
            } else {
                string = LocaleController.formatString(C2702R.string.NoNetworkUsageSince, LocaleController.getInstance().getFormatterStats().format(getResetStatsDate()));
            }
            ...
            if (!arrayList.isEmpty()) {
                ...
                Drawable drawableMutate = getContext().getResources().getDrawable(C2702R.drawable.msg_mini_upload).mutate();
                ...
                drawableMutate.setBounds(0, AndroidUtilities.m1081dp(2.0f), AndroidUtilities.m1081dp(16.0f), AndroidUtilities.m1081dp(18.0f));
                spannableString2.setSpan(new ImageSpan(drawableMutate, 2), 0, 1, 33);
                SpannableString spannableString3 = new SpannableString("v");
                Drawable drawableMutate2 = getContext().getResources().getDrawable(C2702R.drawable.msg_mini_download).mutate();
                drawableMutate2.setColorFilter(new PorterDuffColorFilter(getThemedColor(i6), mode));
                drawableMutate2.setBounds(0, AndroidUtilities.m1081dp(2.0f), AndroidUtilities.m1081dp(16.0f), AndroidUtilities.m1081dp(18.0f));
                ...
                while (i7 < arrayList.size()) {
                    ...
                    if (i8 >= 0 && !this.collapsed[i8]) {
                        ...
                        if (DataUsage2Activity.stats[size2.index] == 0) {
                            ...
                            if (size2.outSize > j4 || size2.outCount > 0) {
                                i7++;
                                arrayList.add(i7, ItemInner.asCell(-1, 0, 0, TextUtils.concat(spannableString2, " ", LocaleController.getString(C2702R.string.BytesSent)), AndroidUtilities.formatFileSize(size2.outSize)));
                            }
                            if (size2.inSize > j4 || size2.inCount > 0) {
                                i7++;
                                arrayList.add(i7, ItemInner.asCell(-1, 0, 0, TextUtils.concat(spannableString3, " ", LocaleController.getString(C2702R.string.BytesReceived)), AndroidUtilities.formatFileSize(size2.inSize)));
                            }
                        }
                    }
                    i7++;
                ...
                if (!this.empty) {
                    this.itemInners.add(ItemInner.asSeparator(LocaleController.getString(C2702R.string.DataUsageSectionsInfo) + "\n"));
                }
            }
            if (!this.empty) {
                this.itemInners.add(ItemInner.asHeader(LocaleController.getString(C2702R.string.TotalNetworkUsage)));
                this.itemInners.add(ItemInner.asCell(-1, C2702R.drawable.msg_filled_data_sent, -11565578, -13276952, LocaleController.getString(C2702R.string.BytesSent), AndroidUtilities.formatFileSize(this.totalSizeOut)));
                this.itemInners.add(ItemInner.asCell(-1, C2702R.drawable.msg_filled_data_received, -11154873, -14175180, LocaleController.getString(C2702R.string.BytesReceived), AndroidUtilities.formatFileSize(this.totalSizeIn)));
            }
            if (!arrayList.isEmpty()) {
            ...
            if (this.currentType != 0) {
                ...
                this.itemInners.add(ItemInner.asCell(-2, C2702R.drawable.msg_download_settings, -11565578, -13276952, LocaleController.getString(C2702R.string.AutomaticDownloadSettings), null));
                int i9 = this.currentType;
                if (i9 == 1) {
                    string2 = LocaleController.getString(C2702R.string.AutomaticDownloadSettingsInfoMobile);
                } else if (i9 == 3) {
                    string2 = LocaleController.getString(C2702R.string.AutomaticDownloadSettingsInfoRoaming);
                } else {
                    string2 = LocaleController.getString(C2702R.string.AutomaticDownloadSettingsInfoWiFi);
                }
                this.itemInners.add(ItemInner.asSeparator(string2));
            }
            if (!arrayList.isEmpty()) {
                this.itemInners.add(new ItemInner(5, LocaleController.getString(C2702R.string.ResetStatistics)));
            }
            this.itemInners.add(ItemInner.asSeparator());
        ...
        public /* synthetic */ int lambda$scrollTo$3(int i) {
            ...
            this.layoutManager.scrollToPositionWithOffset(i2, AndroidUtilities.m1081dp(60.0f));
            return i2;
        }
        ...
        class Adapter extends AdapterWithDiffUtils {
            ...
            class C52931 extends CacheChart {
                ...
                C52931(Context context, int i, int[] iArr, int i2, int[] iArr2) {
                ...
                protected void onSectionDown(int i, boolean z) {
                    ...
                    if (i2 >= 0) {
                        ListView.this.highlightRow(new RecyclerListView.IntReturnCallback() { // from class: org.telegram.ui.DataUsage2Activity$ListView$Adapter$1$$ExternalSyntheticLambda0
                            @Override // org.telegram.ui.Components.RecyclerListView.IntReturnCallback
                            public final int run() {
                                return DataUsage2Activity.ListView.Adapter.C52931.$r8$lambda$ucK5uk8HNpiH2ZmDh4izJakau6w(i2);
                            }
                        }, 0);
                    } else {
                        ListView.this.removeHighlightRow();
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
                ...
                if (i == 0) {
                    ListView.this.chart = new C52931(ListView.this.getContext(), DataUsage2Activity.colors.length, DataUsage2Activity.colors, 1, DataUsage2Activity.particles);
    ...
    public static class RoundingCell extends View {
        ...
        public RoundingCell(Context context) {
            ...
            this.paint = paint;
            this.top = true;
            paint.setShadowLayer(AndroidUtilities.m1081dp(1.0f), 0.0f, AndroidUtilities.m1081dp(-0.66f), 251658240);
        ...
        public void setTop(boolean z) {
            ...
            if (z) {
                ...
                rectF.set(0.0f, AndroidUtilities.m1081dp(4.0f), getMeasuredWidth(), AndroidUtilities.m1081dp(4.0f) + (getMeasuredHeight() * 2));
                this.path.addRoundRect(rectF, fM1081dp, fM1081dp, Path.Direction.CW);
                return;
            }
            float fM1081dp2 = AndroidUtilities.m1081dp(8.0f);
            RectF rectF2 = AndroidUtilities.rectTmp;
            rectF2.set(0.0f, ((-getMeasuredHeight()) * 2) - AndroidUtilities.m1081dp(4.0f), getMeasuredWidth(), getMeasuredHeight() - AndroidUtilities.m1081dp(4.0f));
            this.path.addRoundRect(rectF2, fM1081dp2, fM1081dp2, Path.Direction.CW);
        }
        ...
        @Override // android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(13.0f), TLObject.FLAG_30));
            setTop(this.top);
        }
    ...
    class Cell extends FrameLayout {
        ...
        public Cell(Context context) {
            ...
            this.arrowView.setTranslationY(AndroidUtilities.m1081dp(1.0f));
    ...
    public boolean isSwipeBackEnabled(MotionEvent motionEvent) {
        return (motionEvent != null && motionEvent.getY() <= ((float) (ActionBar.getCurrentActionBarHeight() + AndroidUtilities.m1081dp(48.0f)))) || this.pager.getCurrentPosition() == 0;
    }
}
