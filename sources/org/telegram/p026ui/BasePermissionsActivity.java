    ...
    protected boolean checkPermissionsResult(int i, String[] strArr, int[] iArr) {
        ...
        if (i == 104) {
            if (z) {
                ...
                showPermissionErrorAlert(C2702R.raw.permission_request_camera, LocaleController.getString(C2702R.string.VoipNeedCameraPermission));
            }
        } else if (i == 4 || i == 151) {
            if (!z) {
                showPermissionErrorAlert(C2702R.raw.permission_request_folder, i == 151 ? LocaleController.getString(C2702R.string.PermissionNoStorageAvatar) : LocaleController.getString(C2702R.string.PermissionStorageWithHint));
            } else {
                ImageLoader.getInstance().checkMediaPaths();
            }
        } else if (i == 5) {
            if (!z) {
                showPermissionErrorAlert(C2702R.raw.permission_request_contacts, LocaleController.getString(C2702R.string.PermissionNoContactsSharing));
                return false;
            }
            ...
            if (i == 150 && !(z2 && z3)) {
                showPermissionErrorAlert(C2702R.raw.permission_request_camera, LocaleController.getString(C2702R.string.PermissionNoCameraMicVideo));
            } else if (!z2) {
                showPermissionErrorAlert(C2702R.raw.permission_request_microphone, LocaleController.getString(C2702R.string.PermissionNoAudioWithHint));
            } else if (!z3) {
                showPermissionErrorAlert(C2702R.raw.permission_request_camera, LocaleController.getString(C2702R.string.PermissionNoCameraWithHint));
            } else {
