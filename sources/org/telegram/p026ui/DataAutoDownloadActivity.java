...
import org.telegram.p026ui.Cells.MaxFileSizeCell;
...
public class DataAutoDownloadActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        if (i == 0) {
            this.actionBar.setTitle(LocaleController.getString(C2702R.string.AutoDownloadOnMobileData));
        } else if (i == 1) {
            this.actionBar.setTitle(LocaleController.getString(C2702R.string.AutoDownloadOnWiFiData));
        } else if (i == 2) {
            this.actionBar.setTitle(LocaleController.getString(C2702R.string.AutoDownloadOnRoamingData));
        }
    ...
    */
    public /* synthetic */ void lambda$createView$4(final android.view.View r26, int r27, float r28, float r29) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.DataAutoDownloadActivity.lambda$createView$4(android.view.View, int, float, float):void");
    }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (i == DataAutoDownloadActivity.this.autoDownloadRow) {
                    ...
                    textCheckCell.setTextAndCheck(LocaleController.getString(C2702R.string.AutoDownloadMedia), DataAutoDownloadActivity.this.typePreset.enabled, false);
            ...
            if (itemViewType == 2) {
                ...
                if (i == DataAutoDownloadActivity.this.usageHeaderRow) {
                    headerCell.setText(LocaleController.getString(C2702R.string.AutoDownloadDataUsage));
                    return;
                } else {
                    if (i == DataAutoDownloadActivity.this.typeHeaderRow) {
                        headerCell.setText(LocaleController.getString(C2702R.string.AutoDownloadTypes));
                        return;
                    }
                    return;
                }
            ...
            if (itemViewType != 4) {
                ...
                if (i == DataAutoDownloadActivity.this.typeSectionRow) {
                    textInfoPrivacyCell.setText(LocaleController.getString(C2702R.string.AutoDownloadAudioInfo));
                    ...
                    if (i == DataAutoDownloadActivity.this.autoDownloadSectionRow) {
                        if (DataAutoDownloadActivity.this.usageHeaderRow == -1) {
                            if (DataAutoDownloadActivity.this.currentType == 0) {
                                textInfoPrivacyCell.setText(LocaleController.getString(C2702R.string.AutoDownloadOnMobileDataInfo));
                            } else if (DataAutoDownloadActivity.this.currentType == 1) {
                                textInfoPrivacyCell.setText(LocaleController.getString(C2702R.string.AutoDownloadOnWiFiDataInfo));
                            } else if (DataAutoDownloadActivity.this.currentType == 2) {
                                textInfoPrivacyCell.setText(LocaleController.getString(C2702R.string.AutoDownloadOnRoamingDataInfo));
                            }
                            textInfoPrivacyCell.setImportantForAccessibility(1);
                            return;
                        }
            ...
            if (i == DataAutoDownloadActivity.this.photosRow) {
                string2 = LocaleController.getString(C2702R.string.AutoDownloadPhotos);
                i3 = 1;
            } else if (i == DataAutoDownloadActivity.this.videosRow) {
                string2 = LocaleController.getString(C2702R.string.AutoDownloadVideos);
                i3 = 4;
            } else {
                if (i == DataAutoDownloadActivity.this.storiesRow) {
                    string = LocaleController.getString(C2702R.string.AutoDownloadStories);
                    notificationsCheckCell.setDrawLine(false);
                } else {
                    string = LocaleController.getString(C2702R.string.AutoDownloadFiles);
                    i3 = 8;
                }
                string2 = string;
            }
            ...
            if (i != DataAutoDownloadActivity.this.storiesRow) {
                ...
                while (true) {
                    ...
                    if ((iArr[i4] & i3) != 0) {
                        ...
                        if (i4 == 0) {
                            sb3.append(LocaleController.getString(C2702R.string.AutoDownloadContacts));
                        } else if (i4 == 1) {
                            sb3.append(LocaleController.getString(C2702R.string.AutoDownloadPm));
                        } else if (i4 == 2) {
                            sb3.append(LocaleController.getString(C2702R.string.AutoDownloadGroups));
                        } else if (i4 == 3) {
                            sb3.append(LocaleController.getString(C2702R.string.AutoDownloadChannels));
                        }
                        i2++;
                    }
                    i4++;
                ...
                if (i2 == 4) {
                    sb3.setLength(0);
                    if (i == DataAutoDownloadActivity.this.photosRow) {
                        sb3.append(LocaleController.getString(C2702R.string.AutoDownloadOnAllChats));
                    } else {
                        sb3.append(LocaleController.formatString("AutoDownloadUpToOnAllChats", C2702R.string.AutoDownloadUpToOnAllChats, AndroidUtilities.formatFileSize(j)));
                    }
                } else if (i2 == 0) {
                    sb3.append(LocaleController.getString(C2702R.string.AutoDownloadOff));
                } else {
                    if (i == DataAutoDownloadActivity.this.photosRow) {
                        sb = new StringBuilder(LocaleController.formatString("AutoDownloadOnFor", C2702R.string.AutoDownloadOnFor, sb3.toString()));
                    } else {
                        sb = new StringBuilder(LocaleController.formatString("AutoDownloadOnUpToFor", C2702R.string.AutoDownloadOnUpToFor, AndroidUtilities.formatFileSize(j), sb3.toString()));
                    }
                    sb2 = sb;
                }
                sb2 = sb3;
            } else if (currentWiFiPreset.preloadStories) {
                sb2 = new StringBuilder(LocaleController.formatString("AutoDownloadOn", C2702R.string.AutoDownloadOn, sb3.toString()));
                i2 = 1;
            } else {
                sb2 = new StringBuilder(LocaleController.formatString("AutoDownloadOff", C2702R.string.AutoDownloadOff, sb3.toString()));
                i2 = 0;
            }
    ...
    public void updatePresetChoseView(SlideChooseView slideChooseView) {
        ...
        for (int i = 0; i < this.presets.size(); i++) {
            ...
            if (preset == this.lowPreset) {
                strArr[i] = LocaleController.getString(C2702R.string.AutoDownloadLow);
            } else if (preset == this.mediumPreset) {
                strArr[i] = LocaleController.getString(C2702R.string.AutoDownloadMedium);
            } else if (preset == this.highPreset) {
                strArr[i] = LocaleController.getString(C2702R.string.AutoDownloadHigh);
            } else {
                strArr[i] = LocaleController.getString(C2702R.string.AutoDownloadCustom);
            }
        }
