...
import org.telegram.p026ui.Components.RecyclerListView$$ExternalSyntheticLambda1;
...
public abstract class GradientHeaderActivity extends BaseFragment {
        ...
        View view = new View(context) { // from class: org.telegram.ui.GradientHeaderActivity.3
            ...
            protected void onMeasure(int i, int i2) {
                ...
                if (gradientHeaderActivity.isLandscapeMode) {
                    gradientHeaderActivity.firstViewHeight = (gradientHeaderActivity.statusBarHeight + ((BaseFragment) gradientHeaderActivity).actionBar.getMeasuredHeight()) - AndroidUtilities.m1081dp(16.0f);
                } else {
                    int iM1081dp = AndroidUtilities.m1081dp(140.0f);
                    GradientHeaderActivity gradientHeaderActivity2 = GradientHeaderActivity.this;
                    int iMax = iM1081dp + gradientHeaderActivity2.statusBarHeight;
                    if (gradientHeaderActivity2.backgroundView.getMeasuredHeight() + AndroidUtilities.m1081dp(24.0f) > iMax) {
                        iMax = Math.max(iMax, (GradientHeaderActivity.this.backgroundView.getMeasuredHeight() + AndroidUtilities.m1081dp(24.0f)) - GradientHeaderActivity.this.minusHeaderHeight);
                    }
    ...
    public View createView(Context context) {
        ...
        Rect rect = new Rect();
        Drawable drawableMutate = ContextCompat.getDrawable(context, C2702R.drawable.sheet_shadow_round).mutate();
        ...
        if (this.useFillLastLayoutManager) {
            this.layoutManager = new FillLastLinearLayoutManager(context, (AndroidUtilities.m1081dp(68.0f) + this.statusBarHeight) - AndroidUtilities.m1081dp(16.0f), this.listView);
        } else {
        ...
        if (adapterCreateAdapter instanceof UniversalAdapter) {
            ...
            recyclerListView.setSections(callbackReturn, iM1081dp, fM1081dp, new RecyclerListView$$ExternalSyntheticLambda1(recyclerListView2), true);
        } else {
        ...
        this.listView.addOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.GradientHeaderActivity.4
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int i) {
                ...
                if (i == 0) {
                    int bottom = ((BaseFragment) GradientHeaderActivity.this).actionBar.getBottom() + AndroidUtilities.m1081dp(16.0f);
    ...
    public class ContentView extends NestedSizeNotifierLayout {
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            int bottom2 = ((BaseFragment) GradientHeaderActivity.this).actionBar.getBottom() + AndroidUtilities.m1081dp(16.0f);
            ...
            if (GradientHeaderActivity.this.currentYOffset < AndroidUtilities.m1081dp(30.0f) + bottom2) {
                GradientHeaderActivity.this.progressToFull = ((bottom2 + AndroidUtilities.m1081dp(30.0f)) - GradientHeaderActivity.this.currentYOffset) / AndroidUtilities.m1081dp(30.0f);
            }
            ...
            GradientHeaderActivity.this.particlesView.setTranslationY((backgroundView.getY() + backgroundView.aboveTitleLayout.getY()) - AndroidUtilities.m1081dp(30.0f));
            backgroundView.titleView.setTranslationX((AndroidUtilities.m1081dp(72.0f) - backgroundView.titleView.getLeft()) * (1.0f - CubicBezierInterpolator.EASE_OUT_QUINT.getInterpolation(1.0f - (GradientHeaderActivity.this.totalProgress > 0.3f ? (GradientHeaderActivity.this.totalProgress - 0.3f) / 0.7f : 0.0f))));
            ...
            if (GradientHeaderActivity.this.whiteBackground) {
                if (this.backgroundGradient == null) {
                    LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.m1081dp(350.0f), new int[]{GradientHeaderActivity.this.getThemedColor(Theme.key_windowBackgroundWhite), GradientHeaderActivity.this.getThemedColor(Theme.key_windowBackgroundGray)}, new float[]{0.3f, 1.0f}, Shader.TileMode.CLAMP);
            ...
            ((BaseFragment) GradientHeaderActivity.this).parentLayout.drawHeaderShadow(canvas, Function.USE_VARARGS, ((BaseFragment) GradientHeaderActivity.this).actionBar.getMeasuredHeight());
        }
