...
import org.telegram.p026ui.Components.Crop.CropAreaView;
import org.telegram.p026ui.Components.PhotoCropView;
...
public class SuggestUserPhotoView extends View {
    ...
    public SuggestUserPhotoView(Context context) {
        ...
        Drawable drawable = ContextCompat.getDrawable(context, C2702R.drawable.msg_arrow_avatar);
    ...
    public void draw(Canvas canvas) {
        ...
        int measuredHeight = getMeasuredHeight() - AndroidUtilities.m1081dp(30.0f);
        int iM1081dp = measuredWidth - AndroidUtilities.m1081dp(46.0f);
        int iM1081dp2 = AndroidUtilities.m1081dp(46.0f) + measuredWidth;
        setImageCoords(this.currentPhoto, iM1081dp, measuredHeight);
        setImageCoords(this.newPhoto, iM1081dp2, measuredHeight);
        ...
        this.path.reset();
        this.path.addCircle(iM1081dp2, measuredHeight, AndroidUtilities.m1081dp(30.0f), Path.Direction.CW);
        this.currentPhoto.draw(canvas);
        if (this.containterView != null) {
            float fM1081dp = AndroidUtilities.m1081dp(60.0f);
            CropAreaView cropAreaView = this.photoCropView.cropView.areaView;
            float f = fM1081dp / cropAreaView.size;
            ...
            canvas.translate((iM1081dp2 - AndroidUtilities.m1081dp(30.0f)) / f, (measuredHeight - AndroidUtilities.m1081dp(30.0f)) / f);
    ...
    private void setImageCoords(ImageReceiver imageReceiver, int i, int i2) {
        imageReceiver.setImageCoords(i - AndroidUtilities.m1081dp(30.0f), i2 - AndroidUtilities.m1081dp(30.0f), AndroidUtilities.m1081dp(60.0f), AndroidUtilities.m1081dp(60.0f));
    }

    @Override // android.view.View
    protected void onMeasure(int i, int i2) {
        this.currentPhoto.setRoundRadius(AndroidUtilities.m1081dp(30.0f));
        this.newPhoto.setRoundRadius(AndroidUtilities.m1081dp(30.0f));
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(86.0f), TLObject.FLAG_30));
    }
