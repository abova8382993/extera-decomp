...
public class FilteredSearchView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public FilteredSearchView(BaseFragment baseFragment) {
        ...
        this.provider = new PhotoViewer.EmptyPhotoViewerProvider() { // from class: org.telegram.ui.FilteredSearchView.2
            ...
            */
            public org.telegram.ui.PhotoViewer.PlaceProviderObject getPlaceForPhoto(org.telegram.messenger.MessageObject r9, org.telegram.tgnet.TLRPC.FileLocation r10, int r11, boolean r12, boolean r13) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.FilteredSearchView.C54202.getPlaceForPhoto(org.telegram.messenger.MessageObject, org.telegram.tgnet.TLRPC$FileLocation, int, boolean, boolean):org.telegram.ui.PhotoViewer$PlaceProviderObject");
            }
        };
                ...
                if (getAdapter() == FilteredSearchView.this.sharedPhotoVideoAdapter) {
                    for (int i = 0; i < getChildCount(); i++) {
                        if (getChildViewHolder(getChildAt(i)).getItemViewType() == 1) {
                            canvas.save();
                            canvas.translate(getChildAt(i).getX(), (getChildAt(i).getY() - getChildAt(i).getMeasuredHeight()) + AndroidUtilities.m1081dp(2.0f));
        ...
        recyclerListView.setPadding(0, 0, 0, AndroidUtilities.m1081dp(3.0f));
        ...
        recyclerListView.setOnScrollListener(new C54246());
        ...
        chatActionCell.setTranslationY(-AndroidUtilities.m1081dp(48.0f));
    ...
    class C54246 extends RecyclerView.OnScrollListener {
        C54246() {
        }
    ...
    public static CharSequence createFromInfoString(MessageObject messageObject, boolean z, int i, TextPaint textPaint) {
        ...
        if (messageObject.isSponsored()) {
            if (messageObject.sponsoredCanReport) {
                return LocaleController.getString(C2702R.string.SponsoredMessageAd);
            }
            if (messageObject.sponsoredRecommended) {
                return LocaleController.getString(C2702R.string.SponsoredMessage2Recommended);
            }
            return LocaleController.getString(C2702R.string.SponsoredMessage2);
        }
        ...
        if (spannableStringBuilderArr[i] == null) {
            ...
            if (i == 0) {
                i2 = C2702R.drawable.attach_arrow_right;
            } else if (i == 1) {
                i2 = C2702R.drawable.msg_mini_arrow_mediathin;
            } else {
                if (i != 2) {
                    return _UrlKt.FRAGMENT_ENCODE_SET;
                }
                i2 = C2702R.drawable.msg_mini_arrow_mediabold;
            }
        ...
        if (user != null && chat2 != null) {
            ...
            if (ChatObject.isForum(chat2) && (tL_forumTopicFindTopic2 = MessagesController.getInstance(UserConfig.selectedAccount).getTopicsController().findTopic(chat2.f1610id, MessageObject.getTopicId(messageObject.currentAccount, messageObject.messageOwner, true))) != null) {
            ...
            if (ChatObject.isForum(chat) && (tL_forumTopicFindTopic = MessagesController.getInstance(UserConfig.selectedAccount).getTopicsController().findTopic(chat.f1610id, MessageObject.getTopicId(messageObject.currentAccount, messageObject.messageOwner, true))) != null) {
    ...
    public /* synthetic */ void lambda$search$4(final long j, final String str, final FiltersView.MediaFilterData mediaFilterData, final int i, final long j2, long j3, final boolean z, boolean z2, String str2, final int i2) {
        ...
        if (j != 0) {
            ...
            tL_messages_searchGlobal.f1728q = str;
        ...
        ConnectionsManager.getInstance(i).sendRequest(tLObject, new RequestDelegate() { // from class: org.telegram.ui.FilteredSearchView$$ExternalSyntheticLambda3
    ...
    public /* synthetic */ void lambda$search$2(int i, TLRPC.TL_error tL_error, TLObject tLObject, int i2, boolean z, String str, ArrayList arrayList, FiltersView.MediaFilterData mediaFilterData, long j, long j2, ArrayList arrayList2, ArrayList arrayList3) {
        ...
        if (tL_error != null) {
            this.emptyView.title.setText(LocaleController.getString(C2702R.string.SearchEmptyViewTitle2));
        ...
        if (this.messages.isEmpty()) {
            if (mediaFilterData != null) {
                if (TextUtils.isEmpty(this.currentDataQuery) && j == 0 && j2 == 0) {
                    this.emptyView.title.setText(LocaleController.getString(C2702R.string.SearchEmptyViewTitle));
                    int i4 = mediaFilterData.filterType;
                    if (i4 == 1) {
                        string = LocaleController.getString(C2702R.string.SearchEmptyViewFilteredSubtitleFiles);
                    } else if (i4 == 0) {
                        string = LocaleController.getString(C2702R.string.SearchEmptyViewFilteredSubtitleMedia);
                    } else if (i4 == 2) {
                        string = LocaleController.getString(C2702R.string.SearchEmptyViewFilteredSubtitleLinks);
                    } else if (i4 == 3) {
                        string = LocaleController.getString(C2702R.string.SearchEmptyViewFilteredSubtitleMusic);
                    } else {
                        string = LocaleController.getString(C2702R.string.SearchEmptyViewFilteredSubtitleVoice);
                    }
                    this.emptyView.subtitle.setVisibility(0);
        ...
        if (!z) {
            ...
            if (str != null && str.length() >= 3 && (LocaleController.getString(C2702R.string.SavedMessages).toLowerCase().startsWith(str) || "saved messages".startsWith(str))) {
                int i6 = 0;
                while (true) {
                    if (i6 < this.localTipChats.size()) {
                        if ((this.localTipChats.get(i6) instanceof TLRPC.User) && UserConfig.getInstance(UserConfig.selectedAccount).getCurrentUser().f1775id == ((TLRPC.User) this.localTipChats.get(i6)).f1775id) {
                            break;
                        } else {
                            i6++;
                        }
            ...
            if (str != null && str.length() >= 3 && (LocaleController.getString(C2702R.string.ArchiveSearchFilter).toLowerCase().startsWith(str) || "archive".startsWith(str))) {
                        ...
                        if (layoutManager != null) {
                            ...
                            objectAnimatorOfFloat2.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.FilteredSearchView.7.2
                                ...
                                public void onAnimationEnd(Animator animator) {
                                    ...
                                    ViewTreeObserverOnPreDrawListenerC54257 viewTreeObserverOnPreDrawListenerC54257 = ViewTreeObserverOnPreDrawListenerC54257.this;
    ...
    */
    public void messagesDeleted(long r9, java.util.ArrayList r11) {
        ...
        L8c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.FilteredSearchView.messagesDeleted(long, java.util.ArrayList):void");
    }
    ...
    class SharedLinksAdapter extends RecyclerListView.SectionsAdapter {
        private Context mContext;
        private final SharedLinkCell.SharedLinkCellDelegate sharedLinkCellDelegate = new C54331();
        ...
        class C54331 implements SharedLinkCell.SharedLinkCellDelegate {
            C54331() {
            }
            ...
            public void onLinkPress(final String str, boolean z) {
                if (z) {
                    ...
                    builder.setItems(new CharSequence[]{LocaleController.getString(C2702R.string.Open), LocaleController.getString(C2702R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.FilteredSearchView$SharedLinksAdapter$1$$ExternalSyntheticLambda0
    ...
    private void hideFloatingDateView(boolean z) {
        ...
        if (z) {
            ...
            this.floatingDateAnimation = animatorSet2;
            animatorSet2.setDuration(180L);
            this.floatingDateAnimation.playTogether(ObjectAnimator.ofFloat(this.floatingDateView, (Property<ChatActionCell, Float>) View.ALPHA, 0.0f), ObjectAnimator.ofFloat(this.floatingDateView, (Property<ChatActionCell, Float>) View.TRANSLATION_Y, -AndroidUtilities.m1081dp(48.0f)));
            this.floatingDateAnimation.setInterpolator(CubicBezierInterpolator.EASE_OUT);
