...
import org.telegram.p026ui.Cells.SettingsSearchCell;
...
import org.telegram.p026ui.Stories.recorder.DualCameraView;
...
import org.telegram.p026ui.bots.BotLocation;
import org.telegram.p026ui.bots.SetupEmojiStatusSheet;
...
public class SettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, ImageUpdater.ImageUpdaterDelegate, MainTabsActivity.TabFragmentDelegate, FactorAnimator.Target {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2702R.string.Settings));
        ...
        ActionBarMenuItem actionBarMenuItemSearchListener = actionBarMenuCreateMenu.addItem(0, C2702R.drawable.outline_header_search, this.resourceProvider).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() { // from class: org.telegram.ui.SettingsActivity.3
        ...
        ActionBarMenuItem actionBarMenuItemAddItem = actionBarMenuCreateMenu.addItem(1, C2702R.drawable.ic_ab_other);
        this.otherItem = actionBarMenuItemAddItem;
        actionBarMenuItemAddItem.addSubItem(2, C2702R.drawable.msg_leave, LocaleController.getString(C2702R.string.LogOut));
        ...
        this.listView.setPadding(0, AndroidUtilities.statusBarHeight + AndroidUtilities.m1081dp(12.0f), 0, AndroidUtilities.navigationBarHeight + this.additionNavigationBarHeight);
        ...
        this.contentView.addView(view, LayoutHelper.createFrame(-1, DataTypes.EMPTY, 48));
        ...
        radialProgressView.setSize(AndroidUtilities.m1081dp(26.0f));
        ...
        frameLayout2.setBackground(Theme.createCircleDrawable(AndroidUtilities.m1081dp(32.0f), getThemedColor(Theme.key_windowBackgroundGray)));
        this.cameraButton.setPadding(AndroidUtilities.m1081dp(2.0f), AndroidUtilities.m1081dp(2.0f), AndroidUtilities.m1081dp(2.0f), AndroidUtilities.m1081dp(2.0f));
        this.cameraButton.setClipToPadding(false);
        FrameLayout frameLayout3 = new FrameLayout(context);
        this.cameraBackground = frameLayout3;
        frameLayout3.setBackground(Theme.createCircleDrawable(AndroidUtilities.m1081dp(30.0f), getThemedColor(Theme.key_featuredStickers_addButton)));
        ImageView imageView = new ImageView(context);
        this.cameraImageView = imageView;
        imageView.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
        this.cameraImageView.setImageResource(C2702R.drawable.filled_premium_camera);
        ...
        this.versionView.setPadding(AndroidUtilities.m1081dp(21.0f), AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(21.0f), AndroidUtilities.m1081dp(10.0f));
    ...
    public /* synthetic */ void lambda$createView$6(View view) {
        ...
        if (i < 2 && !BuildVars.DEBUG_PRIVATE_VERSION) {
            try {
                Toast.makeText(getParentActivity(), LocaleController.getString(C2702R.string.DebugMenuLongPress), 0).show();
                return;
            } catch (Exception e) {
                FileLog.m1093e(e);
                return;
    ...
    */
    private void updateActionBarVisible(boolean r5, boolean r6) {
        ...
        L75:
            ...
            android.animation.ValueAnimator r5 = r4.actionBarVisibleAnimator
            org.telegram.ui.Components.CubicBezierInterpolator r6 = org.telegram.p026ui.Components.CubicBezierInterpolator.EASE_OUT_QUINT
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.SettingsActivity.updateActionBarVisible(boolean, boolean):void");
    }
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        if (set.contains("PREMIUM_GRACE")) {
            arrayList.add(SuggestionCell.Factory.m1252of(LocaleController.getString(C2702R.string.GraceSuggestionTitle), LocaleController.getString(C2702R.string.GraceSuggestionMessage), null, null, LocaleController.getString(C2702R.string.GraceSuggestionButton), new View.OnClickListener() { // from class: org.telegram.ui.SettingsActivity$$ExternalSyntheticLambda16
                @Override // android.view.View.OnClickListener
            ...
            String string = LocaleController.formatString(C2702R.string.CheckPhoneNumber, str);
            ...
            arrayList.add(SuggestionCell.Factory.m1252of(charSequence, AndroidUtilities.replaceSingleTag(LocaleController.getString(C2702R.string.CheckPhoneNumberInfo), new Runnable() { // from class: org.telegram.ui.SettingsActivity$$ExternalSyntheticLambda17
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$fillItems$9();
                }
            }), LocaleController.getString(C2702R.string.CheckPhoneNumberNo), new View.OnClickListener() { // from class: org.telegram.ui.SettingsActivity$$ExternalSyntheticLambda18
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.lambda$fillItems$10(view);
                }
            }, StarGiftSheet.replaceUnderstood(LocaleController.getString(C2702R.string.CheckPhoneNumberYes2)), new View.OnClickListener() { // from class: org.telegram.ui.SettingsActivity$$ExternalSyntheticLambda19
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            arrayList.add(SuggestionCell.Factory.m1252of(LocaleController.getString(C2702R.string.YourPasswordHeader), LocaleController.getString(C2702R.string.YourPasswordRemember), LocaleController.getString(C2702R.string.YourPasswordRememberNo), new View.OnClickListener() { // from class: org.telegram.ui.SettingsActivity$$ExternalSyntheticLambda20
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.lambda$fillItems$12(view);
                }
            }, LocaleController.getString(C2702R.string.YourPasswordRememberYes), new View.OnClickListener() { // from class: org.telegram.ui.SettingsActivity$$ExternalSyntheticLambda21
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
        ...
        arrayList.add(SettingCell.Factory.m1249of(-1, -1560528, -1560528, Theme.isCurrentThemeMonet() ? C2702R.drawable.ic_foreground_solid : C2702R.drawable.ic_foreground, LocaleController.getString(C2702R.string.Preferences)));
        arrayList.add(UItem.asShadow(null));
        arrayList.add(SettingCell.Factory.m1250of(1, -14899731, -15431455, C2702R.drawable.settings_account, LocaleController.getString(C2702R.string.SettingsAccount), LocaleController.getString(C2702R.string.SettingsAccountInfo)));
        arrayList.add(SettingCell.Factory.m1250of(2, -1007845, -1996271, C2702R.drawable.settings_chat, LocaleController.getString(C2702R.string.SettingsChat), LocaleController.getString(C2702R.string.SettingsChatInfo)));
        arrayList.add(SettingCell.Factory.m1250of(3, -11154873, -14175180, C2702R.drawable.settings_privacy, LocaleController.getString(C2702R.string.SettingsPrivacySecurity), LocaleController.getString(C2702R.string.SettingsPrivacySecurityInfo)));
        arrayList.add(SettingCell.Factory.m1250of(5, -765355, -2148011, C2702R.drawable.settings_sounds, LocaleController.getString(C2702R.string.SettingsNotifications), LocaleController.getString(C2702R.string.SettingsNotificationsInfo)));
        arrayList.add(SettingCell.Factory.m1250of(6, -11565578, -13276952, C2702R.drawable.settings_data, LocaleController.getString(C2702R.string.SettingsData), LocaleController.getString(C2702R.string.SettingsDataInfo)));
        arrayList.add(SettingCell.Factory.m1250of(7, -14899731, -15497247, C2702R.drawable.settings_folders, LocaleController.getString(C2702R.string.SettingsFolders), LocaleController.getString(C2702R.string.SettingsFoldersInfo)));
        arrayList.add(SettingCell.Factory.m1251of(8, -13451058, -14836538, C2702R.drawable.settings_devices, LocaleController.getString(C2702R.string.SettingsDevices), LocaleController.getString(C2702R.string.SettingsDevicesInfo), getDevicesCount()));
        arrayList.add(SettingCell.Factory.m1250of(9, -881871, -1940716, C2702R.drawable.settings_power, LocaleController.getString(C2702R.string.SettingsPowerSaving), LocaleController.getString(C2702R.string.SettingsPowerSavingInfo)));
        arrayList.add(SettingCell.Factory.m1251of(10, -3903756, -6335009, C2702R.drawable.settings_language, LocaleController.getString(C2702R.string.SettingsLanguage), null, LocaleController.getCurrentLanguageName()));
        arrayList.add(UItem.asShadow(null));
        if (!getMessagesController().premiumFeaturesBlocked()) {
            arrayList.add(SettingCell.Factory.m1249of(11, -4826625, -10388225, C2702R.drawable.settings_premium, LocaleController.getString(C2702R.string.TelegramPremium)));
        }
        ...
        if (zStarsPurchaseAvailable) {
            ...
            arrayList.add(SettingCell.Factory.m1251of(12, -1071598, -1608430, C2702R.drawable.settings_stars, LocaleController.getString(C2702R.string.TelegramStars), null, (!starsController.balanceAvailable() || starsController.getBalance().amount <= 0) ? _UrlKt.FRAGMENT_ENCODE_SET : StarsIntroActivity.formatStarsAmount(starsController.getBalance(), 0.85f, ' ')));
        }
        ...
        if (BuildVars.isBetaApp() || (StarsController.getInstance(this.currentAccount, true).balanceAvailable() && (StarsController.getInstance(this.currentAccount, true).hasTransactions() || StarsController.getInstance(this.currentAccount, true).getBalance().positive()))) {
            ...
            int i = C2702R.drawable.settings_ton;
            String string2 = LocaleController.getString(C2702R.string.MyTON);
            if (tonInstance.balanceAvailable() && j > 0) {
                starsAmount = StarsIntroActivity.formatStarsAmount(tonInstance.getBalance(), 0.85f, ' ');
            }
            arrayList.add(SettingCell.Factory.m1251of(13, -14965523, -15431455, i, string2, null, starsAmount));
        }
        if (!getMessagesController().premiumFeaturesBlocked()) {
            arrayList.add(SettingCell.Factory.m1249of(15, -765355, -2148011, C2702R.drawable.settings_business, LocaleController.getString(C2702R.string.TelegramBusiness)));
        }
        if (!getMessagesController().premiumPurchaseBlocked()) {
            arrayList.add(SettingCell.Factory.m1249of(16, -816335, -1940716, C2702R.drawable.settings_gift, LocaleController.getString(C2702R.string.SendAGift)));
        }
        if (((UItem) arrayList.get(arrayList.size() - 1)).viewType != 7) {
            arrayList.add(UItem.asShadow(null));
        }
        arrayList.add(UItem.asHeader(LocaleController.getString(C2702R.string.SettingsHelp)));
        arrayList.add(SettingCell.Factory.m1249of(17, -1007845, -1996271, C2702R.drawable.settings_ask, LocaleController.getString(C2702R.string.AskAQuestion)));
        arrayList.add(SettingCell.Factory.m1249of(18, -14965523, -15431455, C2702R.drawable.settings_faq, LocaleController.getString(C2702R.string.TelegramFAQ)));
        arrayList.add(SettingCell.Factory.m1249of(23, -3903756, -6335009, C2702R.drawable.settings_features, LocaleController.getString(C2702R.string.TelegramFeatures)));
        arrayList.add(SettingCell.Factory.m1249of(19, -11154873, -14175180, C2702R.drawable.settings_policy, LocaleController.getString(C2702R.string.PrivacyPolicy)));
        if (BuildVars.LOGS_ENABLED || BuildVars.DEBUG_PRIVATE_VERSION) {
            arrayList.add(UItem.asShadow(null));
            arrayList.add(UItem.asHeader(LocaleController.getString(C2702R.string.SettingsDebug)));
            arrayList.add(SettingCell.Factory.m1249of(20, -11154873, -14175180, 0, LocaleController.getString(C2702R.string.DebugSendLogs)));
            arrayList.add(SettingCell.Factory.m1249of(21, -11154873, -14175180, 0, LocaleController.getString(C2702R.string.DebugSendLastLogs)));
            arrayList.add(SettingCell.Factory.m1249of(22, -765355, -2148011, 0, LocaleController.getString(C2702R.string.DebugClearLogs)));
        }
    ...
    public /* synthetic */ void lambda$fillItems$9() {
        Browser.openUrl(getContext(), LocaleController.getString(C2702R.string.CheckPhoneNumberLearnMoreUrl));
    }
    ...
    public void onClick(UItem uItem, View view, int i, float f, float f2) {
        ...
        switch (uItem.f2056id) {
            ...
            case 17:
                ...
                break;
            case 18:
                Browser.openUrl(getParentActivity(), LocaleController.getString(C2702R.string.TelegramFaqUrl));
                break;
            case 19:
                Browser.openUrl(getParentActivity(), LocaleController.getString(C2702R.string.PrivacyPolicyUrl));
                break;
            case 20:
            ...
            case 23:
                if (MessagesController.getInstance(this.currentAccount).isFrozen()) {
                    ...
                    Browser.openUrl(getContext(), LocaleController.getString(C2702R.string.TelegramFeaturesUrl));
                }
                break;
        }
    }
    ...
    public boolean onLongClick(UItem uItem, View view, int i, float f, float f2) {
        ...
        ItemOptions.makeOptions(this, view).add(C2702R.drawable.msg_link2, LocaleController.getString(C2702R.string.CopyLink), new Runnable() { // from class: org.telegram.ui.SettingsActivity$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$onLongClick$14(String str) {
        ...
        BulletinFactory.m1195of(this).createCopyLinkBulletin().show();
    }
    ...
    public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
        ...
        this.listView.setPadding(0, i + AndroidUtilities.m1081dp(12.0f), 0, this.navigationBarHeight + this.additionNavigationBarHeight);
    ...
    public static class AccountCell extends LinearLayout implements Theme.Colorable {
        ...
        public AccountCell(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            this.botDrawable = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(this.textView, AndroidUtilities.m1081dp(24.0f), 7);
            this.emojiStatusDrawable = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(this.textView, AndroidUtilities.m1081dp(24.0f), 7);
            ...
            this.counterView.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1081dp(10.0f), Theme.getColor(Theme.key_featuredStickers_addButton, resourcesProvider)));
            ImageView imageView = new ImageView(context);
        ...
        public void updateColors() {
            ...
            this.counterView.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1081dp(10.0f), Theme.getColor(Theme.key_featuredStickers_addButton, this.resourcesProvider)));
        ...
        */
        ...
        public static class Factory extends UItem.UItemFactory {
            ...
            public static UItem m1248of(int i, int i2) {
    ...
    public static class SettingCell extends LinearLayout implements Theme.Colorable {
        ...
        public void set(int i, int i2, int i3, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3) {
            ...
            this.titleView.setTranslationX(i3 == 0 ? AndroidUtilities.m1081dp(2.0f) : 0.0f);
            this.subtitleView.setTranslationX(i3 == 0 ? AndroidUtilities.m1081dp(2.0f) : 0.0f);
        ...
        @Override // android.widget.LinearLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(this.twoLines ? 60.0f : 50.0f), TLObject.FLAG_30));
        }
        ...
        public static class Background extends Drawable {
            ...
            public Background() {
                ...
                LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.m1081dp(28.0f), new int[]{1308622847, 0, 452984831}, new float[]{0.0f, 0.5f, 1.0f}, Shader.TileMode.CLAMP);
            ...
            public void setColor(int i, int i2, boolean z) {
                ...
                float fM1081dp = AndroidUtilities.m1081dp(28.0f);
                if (z) {
                    i = color;
                }
                if (z) {
            ...
            public void draw(Canvas canvas) {
                ...
                canvas.drawRoundRect(rectF, fM1081dp, fM1081dp, this.paint);
                if (this.border) {
                    float fM1081dp2 = AndroidUtilities.m1081dp(1.0f);
                    this.strokePaint.setStrokeWidth(fM1081dp2);
                    this.matrix.reset();
                    this.matrix.postTranslate(rectF.left, rectF.top);
                    float f = fM1081dp2 / 2.0f;
                    rectF.inset(f, f);
                    canvas.drawRoundRect(rectF, fM1081dp, fM1081dp, this.strokePaint);
                }
            }
        }
        ...
        public static class Factory extends UItem.UItemFactory {
            ...
            public void bindView(View view, UItem uItem, boolean z, UniversalAdapter universalAdapter, UniversalRecyclerView universalRecyclerView) {
                ...
                settingCell.getIconView().setScaleType(uItem.f2056id == -1 ? ImageView.ScaleType.CENTER_CROP : ImageView.ScaleType.CENTER);
            }

            /* JADX INFO: renamed from: of */
            public static UItem m1249of(int i, int i2, int i3, int i4, CharSequence charSequence) {
                return m1251of(i, i2, i3, i4, charSequence, null, null);
            }

            /* JADX INFO: renamed from: of */
            public static UItem m1250of(int i, int i2, int i3, int i4, CharSequence charSequence, CharSequence charSequence2) {
                return m1251of(i, i2, i3, i4, charSequence, charSequence2, null);
            }

            /* JADX INFO: renamed from: of */
            public static UItem m1251of(int i, int i2, int i3, int i4, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3) {
                UItem uItemOfFactory = UItem.ofFactory(Factory.class);
                uItemOfFactory.f2056id = i;
    ...
    public static class SuggestionCell extends LinearLayout implements Theme.Colorable {
        ...
        private ButtonWithCounterView f2089no;
        private final Theme.ResourcesProvider resourcesProvider;
        ...
        public SuggestionCell(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            this.f2089no = new ButtonWithCounterView(context, resourcesProvider).setRound();
            this.yes = new ButtonWithCounterView(context, resourcesProvider).setRound();
            linearLayout.addView(this.f2089no, LayoutHelper.createLinear(0, 42, 1.0f, 112, 0, 0, 12, 0));
        ...
        public void set(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, View.OnClickListener onClickListener, CharSequence charSequence4, View.OnClickListener onClickListener2) {
            ...
            this.f2089no.setVisibility(TextUtils.isEmpty(charSequence3) ? 8 : 0);
            this.f2089no.setText(charSequence3);
            this.f2089no.setOnClickListener(onClickListener);
        ...
        public static class Factory extends UItem.UItemFactory {
            ...
            /* JADX INFO: renamed from: of */
            public static UItem m1252of(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, View.OnClickListener onClickListener, CharSequence charSequence4, View.OnClickListener onClickListener2) {
                UItem uItemOfFactory = UItem.ofFactory(Factory.class);
                uItemOfFactory.text = charSequence;
    ...
    */
    public void openDebugMenu() {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.SettingsActivity.openDebugMenu():void");
    }
    ...
    public /* synthetic */ void lambda$openDebugMenu$18(DialogInterface dialogInterface, int i) throws Throwable {
        ...
        try {
            ...
            if (i == 16) {
                ...
                Toast.makeText(getParentActivity(), LocaleController.getString(SharedConfig.debugWebView ? C2702R.string.DebugMenuWebViewDebugEnabled : C2702R.string.DebugMenuWebViewDebugDisabled), 0).show();
                return;
            }
            if (i == 17) {
            ...
            if (i != 20) {
                ...
                if (i == 23) {
                    ...
                    Toast.makeText(getParentActivity(), LocaleController.getString(!zDualAvailableStatic ? C2702R.string.DebugMenuDualOnToast : C2702R.string.DebugMenuDualOffToast), 0).show();
                    return;
                }
                if (i == 24) {
            ...
            showDialog(new DialogC64908(getParentActivity(), null, sb5.toString(), false, null, false));
    ...
    class DialogC64908 extends ShareAlert {
        DialogC64908(Context context, ArrayList arrayList, String str, boolean z, String str2, boolean z2) {
        ...
        public /* synthetic */ void lambda$onSend$0(LongSparseArray longSparseArray, int i) {
            BulletinFactory.createInviteSentBulletin(SettingsActivity.this.getParentActivity(), SettingsActivity.this.contentView, longSparseArray.size(), longSparseArray.size() == 1 ? ((TLRPC.Dialog) longSparseArray.valueAt(0)).f1616id : 0L, i, getThemedColor(Theme.key_undo_background), getThemedColor(Theme.key_undo_infoColor)).show();
        }
    }
    ...
    public /* synthetic */ void lambda$didUploadPhoto$19(TLRPC.TL_error tL_error, TLObject tLObject, String str) {
        ...
        if (tL_error == null) {
            ...
            getMessagesController().getDialogPhotos(user.f1775id).addPhotoAtStart(tL_photos_photo.photo);
            ArrayList arrayList2 = new ArrayList();
            arrayList2.add(user);
