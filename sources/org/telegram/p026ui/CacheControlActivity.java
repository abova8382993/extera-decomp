...
import org.telegram.p026ui.CachedMediaLayout;
...
import org.telegram.p026ui.Cells.TextCheckBoxCell;
...
import org.telegram.p026ui.Components.CacheChart;
...
import org.telegram.p026ui.Components.NestedSizeNotifierLayout;
...
import org.telegram.p026ui.Components.StorageDiagramView;
import org.telegram.p026ui.Components.StorageUsageView;
import org.telegram.p026ui.Components.TypefaceSpan;
import org.telegram.p026ui.DilogCacheBottomSheet;
import org.telegram.p026ui.KeepMediaPopupView;
import org.telegram.p026ui.Storage.CacheModel;
...
public class CacheControlActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void updateDatabaseItemSize() {
        if (this.clearDatabaseItem != null) {
            ...
            spannableStringBuilder.append((CharSequence) LocaleController.getString(C2702R.string.ClearLocalDatabase));
    ...
    public static void calculateTotalSize(final Utilities.Callback callback) {
        ...
        Utilities.cacheClearQueue.postRunnable(new Runnable() { // from class: org.telegram.ui.CacheControlActivity$$ExternalSyntheticLambda3
            ...
            public final void run() {
                CacheControlActivity.m5642$r8$lambda$fNB1ypvT1aLKISN4xQOCLaHAGk(callback);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$fNB1ypvT1aLKISN4x-QOCLaHAGk, reason: not valid java name */
    public static /* synthetic */ void m5642$r8$lambda$fNB1ypvT1aLKISN4xQOCLaHAGk(final Utilities.Callback callback) {
        canceled = false;
            ...
            if (!z && this.totalSize > 0) {
                ...
                for (int i = 0; i < this.itemInners.size(); i++) {
                    ...
                    if (itemInner.viewType == 11) {
                        ...
                        if (i2 < 0) {
                            if (this.collapsed) {
                                segmentSizeArr[10] = CacheChart.SegmentSize.m1196of(itemInner.size, this.selected[10]);
                            }
                        } else {
                            segmentSizeArr[i2] = CacheChart.SegmentSize.m1196of(itemInner.size, this.selected[i2]);
                        }
                    }
                }
    ...
    private void updateRows(boolean z) {
        ...
        if (this.calculating) {
            ...
            if (this.photoSize > 0) {
                c = '\n';
                arrayList.add(ItemInner.asCheckBox(LocaleController.getString(C2702R.string.LocalPhotoCache), 0, this.photoSize, Theme.key_statisticChartLine_lightblue));
            } else {
                c = '\n';
            }
            if (this.videoSize > 0) {
                arrayList.add(ItemInner.asCheckBox(LocaleController.getString(C2702R.string.LocalVideoCache), 1, this.videoSize, Theme.key_statisticChartLine_blue));
            }
            if (this.documentsSize > 0) {
                arrayList.add(ItemInner.asCheckBox(LocaleController.getString(C2702R.string.LocalDocumentCache), 2, this.documentsSize, Theme.key_statisticChartLine_green));
            }
            if (this.musicSize > 0) {
                arrayList.add(ItemInner.asCheckBox(LocaleController.getString(C2702R.string.LocalMusicCache), 3, this.musicSize, Theme.key_statisticChartLine_purple));
            }
            if (this.audioSize > 0) {
                j = 0;
                arrayList.add(ItemInner.asCheckBox(LocaleController.getString(C2702R.string.LocalAudioCache), 4, this.audioSize, Theme.key_statisticChartLine_lightgreen));
            } else {
                j = 0;
            }
            if (this.storiesSize > j) {
                arrayList.add(ItemInner.asCheckBox(LocaleController.getString(C2702R.string.LocalStoriesCache), 5, this.storiesSize, Theme.key_statisticChartLine_red));
            }
            if (this.stickersCacheSize > j) {
                arrayList.add(ItemInner.asCheckBox(LocaleController.getString(C2702R.string.LocalStickersCache), 6, this.stickersCacheSize, Theme.key_statisticChartLine_orange));
            }
            if (this.cacheSize > j) {
                arrayList.add(ItemInner.asCheckBox(LocaleController.getString(C2702R.string.LocalProfilePhotosCache), 7, this.cacheSize, Theme.key_statisticChartLine_cyan));
            }
            if (this.cacheTempSize > j) {
                arrayList.add(ItemInner.asCheckBox(LocaleController.getString(C2702R.string.LocalMiscellaneousCache), 8, this.cacheTempSize, Theme.key_statisticChartLine_purple));
            }
            if (this.logsSize > j) {
                arrayList.add(ItemInner.asCheckBox(LocaleController.getString(C2702R.string.LocalLogsCache), 9, this.logsSize, Theme.key_statisticChartLine_golden));
            }
            if (arrayList.isEmpty()) {
                z2 = false;
            } else {
                ...
                if (arrayList.size() > 5) {
                    ...
                    this.percents[c] = i2;
                    this.itemInners.add(ItemInner.asCheckBox(LocaleController.getString(C2702R.string.LocalOther), -1, j2, Theme.key_statisticChartLine_golden));
                    if (!this.collapsed) {
        ...
        if (z2) {
            ...
            this.itemInners.add(ItemInner.asInfo(LocaleController.getString(C2702R.string.StorageUsageInfo)));
        } else {
            this.sectionsEndRow = -1;
        }
        this.itemInners.add(new ItemInner(3, LocaleController.getString(C2702R.string.AutoDeleteCachedMedia), null));
        ...
        this.itemInners.add(ItemInner.asInfo(LocaleController.getString(C2702R.string.KeepMediaInfoPart)));
        if (this.totalDeviceSize > j) {
            this.itemInners.add(new ItemInner(3, LocaleController.getString(C2702R.string.MaxCacheSize), null));
            this.itemInners.add(new ItemInner(14));
            this.itemInners.add(ItemInner.asInfo(LocaleController.getString(C2702R.string.MaxCacheSizeInfo)));
        }
    ...
    */
    public static int countDirJava(java.lang.String r11, int r12) {
        ...
        L79:
            if (r7 == 0) goto L7f
            int r6 = org.telegram.p026ui.CacheControlActivity.LISTDIR_DOCTYPE_OTHER_THAN_MUSIC
            if (r12 == r6) goto Lc0
        L7f:
            if (r7 != 0) goto L85
            int r6 = org.telegram.p026ui.CacheControlActivity.LISTDIR_DOCTYPE_MUSIC
            if (r12 == r6) goto Lc0
        L85:
            if (r9 == 0) goto L8b
            int r6 = org.telegram.p026ui.CacheControlActivity.LISTDIR_DOCTYPE2_OTHER
            if (r12 == r6) goto Lc0
        L8b:
            if (r9 != 0) goto L91
            int r6 = org.telegram.p026ui.CacheControlActivity.LISTDIR_DOCTYPE2_EMOJI
            if (r12 == r6) goto Lc0
        L91:
            if (r8 == 0) goto L97
            int r6 = org.telegram.p026ui.CacheControlActivity.LISTDIR_DOCTYPE2_OTHER
        ...
        L97:
            if (r8 != 0) goto L9e
            int r6 = org.telegram.p026ui.CacheControlActivity.LISTDIR_DOCTYPE2_TEMP
            if (r12 != r6) goto L9e
            goto Lc0
        L9e:
        ...
        Lc5:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.CacheControlActivity.countDirJava(java.lang.String, int):int");
    }
    ...
    */
    public static void cleanDirJava(java.lang.String r11, int r12, int[] r13, org.telegram.messenger.Utilities.Callback r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.CacheControlActivity.cleanDirJava(java.lang.String, int, int[], org.telegram.messenger.Utilities$Callback):void");
    }
    ...
    */
    public void lambda$cleanupFolders$11(final org.telegram.messenger.Utilities.Callback2 r26, final java.lang.Runnable r27) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.CacheControlActivity.lambda$cleanupFolders$11(org.telegram.messenger.Utilities$Callback2, java.lang.Runnable):void");
    }
    ...
    public /* synthetic */ void lambda$cleanupFoldersInternal$15(long j) {
        Bulletin bulletinCreateSimpleBulletin = BulletinFactory.m1195of(this).createSimpleBulletin(C2702R.raw.ic_delete, LocaleController.formatString(C2702R.string.CacheWasCleared, AndroidUtilities.formatFileSize(j)));
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2702R.string.StorageUsage));
        ...
        this.actionModeTitle.setTextSize(AndroidUtilities.m1081dp(18.0f));
        ...
        this.actionModeSubtitle.setTextSize(AndroidUtilities.m1081dp(14.0f));
        ...
        this.actionModeClearButton.setPadding(AndroidUtilities.m1081dp(14.0f), 0, AndroidUtilities.m1081dp(14.0f), 0);
        ...
        this.actionModeClearButton.setText(LocaleController.getString(C2702R.string.CacheClear));
        ...
        ActionBarMenuItem actionBarMenuItemAddItem = this.actionBar.createMenu().addItem(2, C2702R.drawable.ic_ab_other);
        ActionBarMenuSubItem actionBarMenuSubItemAddSubItem = actionBarMenuItemAddItem.addSubItem(3, C2702R.drawable.msg_delete, LocaleController.getString(C2702R.string.ClearLocalDatabase));
        ...
        if (BuildVars.DEBUG_PRIVATE_VERSION) {
            ActionBarMenuSubItem actionBarMenuSubItemAddSubItem2 = actionBarMenuItemAddItem.addSubItem(4, C2702R.drawable.msg_delete, "Full Reset Database");
    ...
    public void clearSelectedFiles() {
        ...
        builder.setTitle(LocaleController.getString(C2702R.string.ClearCache));
        builder.setMessage(LocaleController.getString(C2702R.string.ClearCacheForChats));
        builder.setPositiveButton(LocaleController.getString(C2702R.string.Clear), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.CacheControlActivity$$ExternalSyntheticLambda10
    ...
    public void cleanupDialogFiles(DialogFileEntities dialogFileEntities, StorageDiagramView.ClearViewData[] clearViewDataArr, CacheModel cacheModel) {
        ...
        int i6 = C2702R.raw.ic_delete;
        int i7 = C2702R.string.CacheWasCleared;
        String fileSize = AndroidUtilities.formatFileSize(j - this.totalSize);
        Object[] objArr = new Object[1];
        objArr[z ? 1 : 0] = fileSize;
        Bulletin bulletinCreateSimpleBulletin = bulletinFactoryM1195of.createSimpleBulletin(i6, LocaleController.formatString(i7, objArr));
    ...
    public void clearDatabase(final boolean z) {
        ...
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        spannableStringBuilder.append((CharSequence) LocaleController.getString(C2702R.string.LocalDatabaseClearText));
        spannableStringBuilder.append((CharSequence) "\n\n");
        spannableStringBuilder.append((CharSequence) AndroidUtilities.replaceTags(LocaleController.formatString("LocalDatabaseClearText2", C2702R.string.LocalDatabaseClearText2, AndroidUtilities.formatFileSize(this.databaseSize))));
        builder.setMessage(spannableStringBuilder);
        builder.setNegativeButton(LocaleController.getString(C2702R.string.Cancel), null);
        builder.setPositiveButton(LocaleController.getString(C2702R.string.CacheClear), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.CacheControlActivity$$ExternalSyntheticLambda12
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
    ...
    class CacheChartHeader extends FrameLayout {
        ...
        public CacheChartHeader(Context context) {
            ...
            this.title.setTextSize(AndroidUtilities.m1081dp(20.0f));
            this.title.setText(LocaleController.getString(C2702R.string.StorageUsage));
            ...
            while (i < 3) {
                ...
                this.subtitle[i].setPadding(AndroidUtilities.m1081dp(24.0f), 0, AndroidUtilities.m1081dp(24.0f), 0);
                if (i == 0) {
                    this.subtitle[i].setText(LocaleController.getString(C2702R.string.StorageUsageCalculating));
                } else if (i == 1) {
                    this.subtitle[i].setAlpha(0.0f);
                    this.subtitle[i].setText(LocaleController.getString(C2702R.string.StorageUsageTelegram));
                    this.subtitle[i].setVisibility(4);
                } else if (i == 2) {
                    this.subtitle[i].setText(LocaleController.getString(C2702R.string.StorageCleared2));
                    this.subtitle[i].setAlpha(0.0f);
                    this.subtitle[i].setVisibility(4);
                }
        ...
        public void setData(boolean z, float f, float f2) {
            ...
            if (z) {
                string = LocaleController.getString(C2702R.string.StorageUsage);
            } else {
                string = LocaleController.getString(C2702R.string.StorageCleared);
            }
            animatedTextView.setText(string);
            if (z) {
                if (f < 0.01f) {
                    this.subtitle[1].setText(LocaleController.formatString(C2702R.string.StorageUsageTelegramLess, CacheControlActivity.this.formatPercent(f)));
                } else {
                    this.subtitle[1].setText(LocaleController.formatString(C2702R.string.StorageUsageTelegram, CacheControlActivity.this.formatPercent(f)));
                }
                switchSubtitle(1);
            } else {
                switchSubtitle(2);
        ...
        private void updateViewVisible(View view, boolean z, boolean z2) {
            ...
            if (!z2) {
                ...
                view.setTranslationY(z ? 0.0f : AndroidUtilities.m1081dp(8.0f));
                invalidate();
                return;
            }
            if (z) {
                if (view.getVisibility() != 0) {
                    ...
                    view.setAlpha(0.0f);
                    view.setTranslationY(AndroidUtilities.m1081dp(8.0f));
                }
        ...
        protected void onMeasure(int i, int i2) {
            ...
            int iMin = (int) Math.min(AndroidUtilities.m1081dp(174.0f), ((double) size) * 0.8d);
            super.measureChildren(View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30), i2);
            int iM1081dp = AndroidUtilities.m1081dp(72.0f);
            int i3 = 0;
            int iMax = 0;
            while (true) {
                TextView[] textViewArr = this.subtitle;
                if (i3 >= textViewArr.length) {
                    setMeasuredDimension(size, iM1081dp + iMax);
                    this.progressRect.set((size - iMin) / 2.0f, r8 - AndroidUtilities.m1081dp(30.0f), (size + iMin) / 2.0f, r8 - AndroidUtilities.m1081dp(26.0f));
                    return;
                }
                iMax = Math.max(iMax, textViewArr[i3].getMeasuredHeight() - (i3 == 2 ? AndroidUtilities.m1081dp(16.0f) : 0));
                i3++;
            }
        }
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            float f6 = 1.0f - f;
            float fMax = Math.max(this.progressRect.left + (Math.max(AndroidUtilities.m1081dp(4.0f), this.progressRect.width() * f5) * f6), this.progressRect.left + (Math.max(AndroidUtilities.m1081dp(4.0f), this.progressRect.width() * f3) * f6)) + AndroidUtilities.m1081dp(1.0f);
            RectF rectF3 = this.progressRect;
            rectF2.set(fMax, rectF3.top, rectF3.right, rectF3.bottom);
            if (rectF2.left >= rectF2.right || rectF2.width() <= AndroidUtilities.m1081dp(3.0f)) {
                rectF = rectF2;
            } else {
                rectF = rectF2;
                drawRoundRect(canvas, rectF, AndroidUtilities.m1081dp(AndroidUtilities.lerp(1, 2, f)), AndroidUtilities.m1081dp(2.0f), this.loadingBackgroundPaint);
            }
            ...
            float fMax2 = this.progressRect.left + (Math.max(AndroidUtilities.m1081dp(4.0f), this.progressRect.width() * f3) * f6) + AndroidUtilities.m1081dp(1.0f);
            RectF rectF4 = this.progressRect;
            rectF.set(fMax2, rectF4.top, rectF4.left + (Math.max(AndroidUtilities.m1081dp(4.0f), this.progressRect.width() * f5) * f6), this.progressRect.bottom);
            if (rectF.width() > AndroidUtilities.m1081dp(3.0f)) {
                drawRoundRect(canvas, rectF, AndroidUtilities.m1081dp(1.0f), AndroidUtilities.m1081dp(f5 > 0.97f ? 2.0f : 1.0f), this.usedPercentPaint);
            }
            ...
            rectF.set(f7, rectF5.top, (f6 * Math.max(AndroidUtilities.m1081dp(4.0f), this.progressRect.width() * f3)) + f7, this.progressRect.bottom);
            drawRoundRect(canvas, rectF, AndroidUtilities.m1081dp(2.0f), AndroidUtilities.m1081dp(f3 > 0.97f ? 2.0f : 1.0f), this.percentPaint);
    ...
    class ClearingCacheView extends FrameLayout {
        ...
        public ClearingCacheView(Context context) {
            ...
            this.imageView.setAnimation(C2702R.raw.utyan_cache, 150, 150);
            ...
            this.percentsTextView.setTextSize(AndroidUtilities.m1081dp(24.0f));
            ...
            this.title.setTypeface(AndroidUtilities.bold());
            this.title.setText(LocaleController.getString(C2702R.string.ClearingCache));
            ...
            this.subtitle.setText(LocaleController.getString(C2702R.string.ClearingCacheDescription));
        ...
        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(350.0f), TLObject.FLAG_30));
        }
        ...
        class ProgressView extends View {
            ...
            protected void onDraw(Canvas canvas) {
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.m1081dp(3.0f), AndroidUtilities.m1081dp(3.0f), this.out);
                rectF.set(0.0f, 0.0f, getMeasuredWidth() * this.progressT.set(this.progress), getMeasuredHeight());
                canvas.drawRoundRect(rectF, AndroidUtilities.m1081dp(3.0f), AndroidUtilities.m1081dp(3.0f), this.f1838in);
            }
        }
    }
    ...
    class ClearCacheButtonInternal extends ClearCacheButton {
        public ClearCacheButtonInternal(Context context) {
            super(context);
            ((ViewGroup.MarginLayoutParams) this.button.getLayoutParams()).topMargin = AndroidUtilities.m1081dp(5.0f);
        ...
        public /* synthetic */ void lambda$new$1(View view) {
            ...
            sb.append(LocaleController.getString(C2702R.string.ClearCache));
            ...
            if (button instanceof TextView) {
                ...
                button.setBackground(Theme.getRoundRectSelectorDrawable(AndroidUtilities.m1081dp(6.0f), Theme.multAlpha(Theme.getColor(i), 0.12f)));
            }
        }
    ...
    public static class ClearCacheButton extends FrameLayout {
        ...
        public ClearCacheButton(Context context) {
            ...
            FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.CacheControlActivity.ClearCacheButton.1
                @Override // android.view.ViewGroup, android.view.View
                protected void dispatchDraw(Canvas canvas) {
                    int measuredWidth = (((getMeasuredWidth() - AndroidUtilities.m1081dp(8.0f)) - ((int) ClearCacheButton.this.valueTextView.getCurrentWidth())) + ((int) ClearCacheButton.this.textView.getCurrentWidth())) / 2;
                    if (LocaleController.isRTL) {
                        super.dispatchDraw(canvas);
                        return;
                    }
                    ...
                    ClearCacheButton.this.valueTextView.setBounds(measuredWidth + AndroidUtilities.m1081dp(8.0f), 0, getWidth(), getHeight());
            ...
            if (LocaleController.isRTL) {
                ...
                textView.setText(LocaleController.getString(C2702R.string.ClearCache));
            ...
            this.textView.setTextSize(AndroidUtilities.m1081dp(14.0f));
            this.textView.setText(LocaleController.getString(C2702R.string.ClearCache));
            ...
            this.valueTextView.setTextSize(AndroidUtilities.m1081dp(14.0f));
        ...
        public void setSize(boolean z, long j) {
            ...
            if (z) {
                string = LocaleController.getString(C2702R.string.ClearCache);
            } else {
                string = LocaleController.getString(C2702R.string.ClearSelectedCache);
            }
                ...
                if (i2 >= 0) {
                    CacheControlActivity.this.listView.highlightRow(new RecyclerListView.IntReturnCallback() { // from class: org.telegram.ui.CacheControlActivity$ListAdapter$1$$ExternalSyntheticLambda0
                        ...
                        public final int run() {
                            return CacheControlActivity.ListAdapter.C30971.$r8$lambda$iMXUJM708KRukDjxcnPvpwfmnk0(i2);
                        }
                    }, 0);
                } else {
                    CacheControlActivity.this.listView.removeHighlightRow();
            ...
            if (i == 0) {
                ...
                switch (i) {
                    ...
                    case 4:
                        ...
                        slideChooseView.setOptions(i2 == 3 ? 1 : i2 == 4 ? 0 : i2 + 2, LocaleController.formatPluralString("Days", 3, new Object[0]), LocaleController.formatPluralString("Weeks", 1, new Object[0]), LocaleController.formatPluralString("Months", 1, new Object[0]), LocaleController.getString(C2702R.string.KeepMediaForever));
                    ...
                    case 8:
                        ...
                        CachedMediaLayout cachedMediaLayout = new CachedMediaLayout(this.mContext, CacheControlActivity.this) { // from class: org.telegram.ui.CacheControlActivity.ListAdapter.2
                            @Override // org.telegram.p026ui.CachedMediaLayout, android.widget.FrameLayout, android.view.View
                            protected void onMeasure(int i3, int i4) {
                                super.onMeasure(i3, View.MeasureSpec.makeMeasureSpec((View.MeasureSpec.getSize(i4) - (ActionBar.getCurrentActionBarHeight() / 2)) - AndroidUtilities.m1081dp(12.0f), TLObject.FLAG_30));
                            }

                            @Override // org.telegram.p026ui.CachedMediaLayout
                    ...
                    case 9:
                        ...
                        C30971 c30971 = new C30971(this.mContext);
                        cacheControlActivity2.cacheChart = c30971;
                        c30971.setTag(-33024);
                        view = c30971;
                    ...
                    case 14:
                        ...
                        for (int i3 = 0; i3 < arrayList.size(); i3++) {
                            if (((Integer) arrayList.get(i3)).intValue() == 1) {
                                ...
                                strArr[i3] = LocaleController.getString(C2702R.string.NoLimit);
                            } else {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (i == CacheControlActivity.this.migrateOldFolderRow) {
                    textSettingsCell.setTextAndValue(LocaleController.getString(C2702R.string.MigrateOldFolder), null, false);
                    return;
                }
                return;
            }
            ...
            if (((ItemInner) CacheControlActivity.this.itemInners.get(i)).keepMediaType == 0) {
                textCell.setTextAndValueAndColorfulIcon(LocaleController.getString(C2702R.string.PrivateChats), keepMediaString, true, C2702R.drawable.msg_filled_menu_users, -11565578, -13276952, true);
            } else if (((ItemInner) CacheControlActivity.this.itemInners.get(i)).keepMediaType == 1) {
                textCell.setTextAndValueAndColorfulIcon(LocaleController.getString(C2702R.string.GroupChats), keepMediaString, true, C2702R.drawable.msg_filled_menu_groups, -11154873, -14175180, true);
            } else if (((ItemInner) CacheControlActivity.this.itemInners.get(i)).keepMediaType == 2) {
                textCell.setTextAndValueAndColorfulIcon(LocaleController.getString(C2702R.string.CacheChannels), keepMediaString, true, C2702R.drawable.msg_filled_menu_channels, -1007845, -1996271, true);
            } else if (((ItemInner) CacheControlActivity.this.itemInners.get(i)).keepMediaType == 3) {
                textCell.setTextAndValueAndColorfulIcon(LocaleController.getString(C2702R.string.CacheStories), keepMediaString, false, C2702R.drawable.msg_filled_stories, -765355, -2148011, false);
            }
    ...
    public static class UserCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
        ...
        public UserCell(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            this.valueTextView.setTextSize(AndroidUtilities.m1081dp(16.0f));
        ...
        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m1081dp(50.0f) + (this.needDivider ? 1 : 0));
            int measuredWidth = ((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight()) - AndroidUtilities.m1081dp(34.0f);
            int i3 = measuredWidth / 2;
            if (this.imageView.getVisibility() == 0) {
                this.imageView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(38.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(38.0f), TLObject.FLAG_30));
            }
            if (this.valueTextView.getVisibility() == 0) {
                ...
                measuredWidth = (measuredWidth - this.valueTextView.getMeasuredWidth()) - AndroidUtilities.m1081dp(8.0f);
            }
            int measuredWidth2 = this.valueTextView.getMeasuredWidth() + AndroidUtilities.m1081dp(12.0f);
            if (LocaleController.isRTL) {
            ...
            if (checkBox2 != null) {
                checkBox2.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(24.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(24.0f), TLObject.FLAG_30));
            }
        }
        ...
        protected void dispatchDraw(Canvas canvas) {
            super.dispatchDraw(canvas);
            if (this.needDivider) {
                canvas.drawLine(LocaleController.isRTL ? 0.0f : AndroidUtilities.m1081dp(72.0f), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m1081dp(72.0f) : 0), getMeasuredHeight() - 1, Theme.dividerPaint);
            }
        }
