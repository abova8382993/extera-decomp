...
public class ActionBarMenuSubItem extends FrameLayout {
    ...
    public void makeCheckView(int i) {
        if (i > 0) {
            ...
            if (i == 1) {
                ...
                this.textView.setPadding(!LocaleController.isRTL ? AndroidUtilities.m1081dp(34.0f) : 0, 0, !LocaleController.isRTL ? 0 : AndroidUtilities.m1081dp(34.0f), 0);
                return;
            }
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(this.itemHeight), TLObject.FLAG_30));
        if (!this.expandIfMultiline || this.textView.getLayout().getLineCount() <= 1) {
            return;
        }
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(this.itemHeight + 8), TLObject.FLAG_30));
    }
    ...
    public void setRightIcon(int i) {
        ...
        if (LocaleController.isRTL) {
            layoutParams.leftMargin = this.rightIcon != null ? AndroidUtilities.m1081dp(32.0f) : 0;
        } else {
            layoutParams.rightMargin = this.rightIcon != null ? AndroidUtilities.m1081dp(32.0f) : 0;
        }
        this.textView.setLayoutParams(layoutParams);
        setPadding(AndroidUtilities.m1081dp(LocaleController.isRTL ? 8.0f : 18.0f), 0, AndroidUtilities.m1081dp(LocaleController.isRTL ? 18.0f : 8.0f), 0);
        if (i == 0) {
    ...
    public void setTextAndIcon(CharSequence charSequence, int i, Drawable drawable) {
        ...
        if (i != 0 || drawable != null || this.checkView != null) {
            ...
            if (this.checkViewLeft) {
                iM1081dp = this.checkView != null ? AndroidUtilities.m1081dp(43.0f) : 0;
            } else {
                iM1081dp = AndroidUtilities.m1081dp((i == 0 && drawable == null) ? 0.0f : 43.0f);
            }
            if (this.checkViewLeft) {
                iM1081dp2 = AndroidUtilities.m1081dp((i == 0 && drawable == null) ? 0.0f : 43.0f);
            } else {
                iM1081dp2 = this.checkView != null ? AndroidUtilities.m1081dp(43.0f) : 0;
            }
            textViewEmojis.setPadding(iM1081dp, 0, iM1081dp2, 0);
        } else {
            this.iconResId = 0;
    ...
    public void setTextAndIcon(CharSequence charSequence, ImageLocation imageLocation, String str, Drawable drawable, Object obj) {
        this.textView.setText(charSequence);
        this.textView.setPadding((this.checkViewLeft && this.checkView == null) ? 0 : AndroidUtilities.m1081dp(43.0f), 0, (!this.checkViewLeft && this.checkView == null) ? 0 : AndroidUtilities.m1081dp(43.0f), 0);
        if (this.backupImageView == null) {
            BackupImageView backupImageView = new BackupImageView(getContext());
            this.backupImageView = backupImageView;
            backupImageView.setRoundRadius(AndroidUtilities.m1081dp(5.0f));
    ...
    public void setEnabledByColor(boolean z, final int i, final int i2) {
        ...
        this.enabledAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.ActionBar.ActionBarMenuSubItem.1
            ...
            C28381(boolean z2, final int i3, final int i22) {
                z = z2;
                i = i3;
                i = i22;
            }
    ...
    class C28381 extends AnimatorListenerAdapter {
        final /* synthetic */ int val$colorDisabled;
        final /* synthetic */ int val$colorEnabled;
        final /* synthetic */ boolean val$enabled;
    ...
    public void setEnabledByColor(boolean z, final int i, final int i2, final int i3) {
        ...
        this.enabledAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.ActionBar.ActionBarMenuSubItem.2
            ...
            C28392(boolean z2, final int i4, final int i32, final int i22) {
                z = z2;
                i = i4;
                i = i32;
                i = i22;
    ...
    class C28392 extends AnimatorListenerAdapter {
        final /* synthetic */ int val$colorEnabled;
        final /* synthetic */ boolean val$enabled;
        final /* synthetic */ int val$iconColorDisabled;
        final /* synthetic */ int val$textColorDisabled;
    ...
    public void setSubtext(CharSequence charSequence) {
        ...
        if ((!zIsEmpty) != (this.subtextView.getVisibility() == 0)) {
            ...
            FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.textView.getLayoutParams();
            layoutParams.bottomMargin = zIsEmpty ? 0 : AndroidUtilities.m1081dp(10.0f);
            this.textView.setLayoutParams(layoutParams);
        }
