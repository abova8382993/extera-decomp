...
public class BottomSheetTabDialog extends Dialog {
    ...
    public BottomSheetTabDialog(BottomSheetTabsOverlay.Sheet sheet) {
        super(sheet.mo5374getWindowView().getContext(), C2702R.style.TransparentDialog);
        Paint paint = new Paint(1);
        this.navigationBarPaint = paint;
        this.sheet = sheet;
        BottomSheetTabsOverlay.SheetView sheetViewMo5374getWindowView = sheet.mo5374getWindowView();
        this.sheetView = sheetViewMo5374getWindowView;
        ...
        WindowView windowView = new WindowView(sheetViewMo5374getWindowView);
