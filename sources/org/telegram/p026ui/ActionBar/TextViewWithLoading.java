...
public abstract class TextViewWithLoading extends TextView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (f < 1.0f) {
            ...
            canvas2.translate(0.0f, AndroidUtilities.m1081dp(6.0f) * f);
        ...
        if (f > 0.0f) {
            ...
            int iM1081dp = width - ((int) (AndroidUtilities.m1081dp(6.0f) * (1.0f - f)));
            this.spinner.setAlpha((int) (f * 255.0f));
            CircularProgressDrawable circularProgressDrawable = this.spinner;
            circularProgressDrawable.setBounds(iM1081dp - (circularProgressDrawable.getIntrinsicWidth() / 2), height - (this.spinner.getIntrinsicWidth() / 2), iM1081dp + (this.spinner.getIntrinsicWidth() / 2), height + (this.spinner.getIntrinsicHeight() / 2));
