...
import org.telegram.p026ui.Stars.BalanceCloud;
...
public class AlertDialog extends Dialog implements Drawable.Callback, NotificationCenter.NotificationCenterDelegate {
    ...
    public static class AlertDialogCell extends FrameLayout {
        ...
        public AlertDialogCell(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            setPadding(AndroidUtilities.m1081dp(23.0f), 0, AndroidUtilities.m1081dp(23.0f), 0);
        ...
        public void setTextAndIcon(CharSequence charSequence, int i) {
            ...
            if (i != 0) {
                ...
                this.textView.setPadding(LocaleController.isRTL ? 0 : AndroidUtilities.m1081dp(46.0f), 0, LocaleController.isRTL ? AndroidUtilities.m1081dp(46.0f) : 0, 0);
            } else {
    ...
    public AlertDialog(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (i != 3 || this.blurredBackground) {
            Drawable drawableMutate = context.getResources().getDrawable(C2702R.drawable.popup_fixed_alert4).mutate();
    ...
    public class AlertDialogView extends LinearLayout {
        ...
        */
        ...
        public /* synthetic */ void lambda$onMeasure$0() {
            ...
            int iM1081dp2 = AndroidUtilities.displaySize.x - AndroidUtilities.m1081dp(56.0f);
            if (AndroidUtilities.isTablet()) {
                if (AndroidUtilities.isSmallTablet()) {
                    iM1081dp = AndroidUtilities.m1081dp(446.0f);
                } else {
                    iM1081dp = AndroidUtilities.m1081dp(496.0f);
                }
            } else {
                iM1081dp = AndroidUtilities.m1081dp(356.0f);
            }
            Window window = AlertDialog.this.getWindow();
            WindowManager.LayoutParams layoutParams = new WindowManager.LayoutParams();
            layoutParams.copyFrom(window.getAttributes());
            layoutParams.width = Math.min(iM1081dp, iM1081dp2) + AlertDialog.this.backgroundPaddings.left + AlertDialog.this.backgroundPaddings.right;
            try {
        ...
        public void draw(Canvas canvas) {
            ...
            if (AlertDialog.this.blurredBackground && !AlertDialog.this.blurredNativeBackground) {
                if (AlertDialog.this.progressViewStyle == 3 && AlertDialog.this.progressViewContainer != null) {
                    fM1081dp = AndroidUtilities.m1081dp(18.0f);
                ...
                if (AlertDialog.this.blurPaint != null) {
                    ...
                    canvas.drawRoundRect(AndroidUtilities.rectTmp, fM1081dp, fM1081dp, AlertDialog.this.blurPaint);
                }
                ...
                canvas.drawRoundRect(rectF, fM1081dp, fM1081dp, AlertDialog.this.dimBlurPaint);
    ...
    protected View inflateContent(boolean z) {
        ...
        if ((this.blurredBackground || this.progressViewStyle == 3) && this.progressViewStyle != 2) {
            ...
            this.containerView.setOutlineProvider(ViewOutlineProviderImpl.boundsWithPaddingRoundRect(AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(20.0f)));
        ...
        if (this.topResId != 0 || this.topAnimationId != 0 || this.topDrawable != null) {
            ...
            if (drawable != null) {
                ...
                if (obj instanceof AttachableDrawable) {
                    ...
                    this.topImageView.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: org.telegram.ui.ActionBar.AlertDialog.1
                        ...
                        ViewOnAttachStateChangeListenerC28531(AttachableDrawable attachableDrawable2) {
            ...
            if (this.topAnimationIsNew) {
                ...
                gradientDrawable.setCornerRadius(AndroidUtilities.m1081dp(128.0f));
                this.topImageView.setBackground(new Drawable() { // from class: org.telegram.ui.ActionBar.AlertDialog.2
                    ...
                    C28542(GradientDrawable gradientDrawable2) {
                        gradientDrawable = gradientDrawable2;
                        this.size = AlertDialog.this.topAnimationSize + AndroidUtilities.m1081dp(52.0f);
                    }
                ...
                this.topImageView.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1081dp(10.0f), 0, this.topBackgroundColor));
            }
            if (this.topAnimationIsNew) {
                this.topImageView.setTranslationY(AndroidUtilities.m1081dp(16.0f));
            } else {
        ...
        if (this.progressViewStyle == 0) {
            this.shadow[0] = (BitmapDrawable) getContext().getResources().getDrawable(C2702R.drawable.header_shadow).mutate();
            this.shadow[1] = (BitmapDrawable) getContext().getResources().getDrawable(C2702R.drawable.header_shadow_reverse).mutate();
            this.shadow[0].setAlpha(0);
            this.shadow[1].setAlpha(0);
            this.shadow[0].setCallback(this);
            this.shadow[1].setCallback(this);
            C28553 c28553 = new ScrollView(getContext()) { // from class: org.telegram.ui.ActionBar.AlertDialog.3
                C28553(Context context) {
                    super(context);
                }
            ...
            this.contentScrollView = c28553;
            c28553.setVerticalScrollBarEnabled(false);
        ...
        if (i4 == 2) {
            ...
            if (!this.blurredBackground || this.blurredNativeBackground) {
                this.progressViewContainer.setBackgroundDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m1081dp(f3), this.backgroundColor));
            }
            c = 2;
            ...
            radialProgressView.setSize(AndroidUtilities.m1081dp(32.0f));
        ...
        if (z2) {
            if (this.verticalButtons) {
                ...
                if (charSequence2 != null) {
                    f5 = 64.0f;
                    iMeasureText = (int) (0 + textPaint.measureText(charSequence2, 0, charSequence2.length()) + AndroidUtilities.m1081dp(24.0f));
                } else {
                    f5 = 64.0f;
                    iMeasureText = 0;
                }
                if (this.negativeButtonText != null) {
                    if (iMeasureText > 0) {
                        iMeasureText += AndroidUtilities.m1081dp(f);
                    }
                    CharSequence charSequence3 = this.negativeButtonText;
                    iMeasureText = (int) (iMeasureText + textPaint.measureText(charSequence3, 0, charSequence3.length()) + AndroidUtilities.m1081dp(24.0f));
                }
                if (this.negative2ButtonText != null) {
                    ...
                    iMeasureText = (int) (iMeasureText + textPaint.measureText(charSequence4, 0, charSequence4.length()) + AndroidUtilities.m1081dp(24.0f));
                }
                if (this.neutralButtonText != null) {
                    ...
                    iMeasureText = (int) (iMeasureText + textPaint.measureText(charSequence5, 0, charSequence5.length()) + AndroidUtilities.m1081dp(24.0f));
                }
                if (iMeasureText > AndroidUtilities.displaySize.x - AndroidUtilities.m1081dp(f5)) {
                            ...
                            if (num != null) {
                                if (num.intValue() == -1) {
                                    ...
                                    if (LocaleController.isRTL) {
                                        ...
                                        if (view6 != null) {
                                            paddingLeft += view6.getMeasuredWidth() + AndroidUtilities.m1081dp(8.0f);
                                        }
                                        childAt.layout(paddingLeft, getPaddingTop(), childAt.getMeasuredWidth() + paddingLeft, getPaddingTop() + childAt.getMeasuredHeight());
                                    } else {
                                        int paddingRight = (i10 - getPaddingRight()) - childAt.getMeasuredWidth();
                                        if (view6 != null) {
                                            paddingRight -= view6.getMeasuredWidth() + AndroidUtilities.m1081dp(8.0f);
                                        }
            ...
            if (this.bottomView != null) {
                f6 = 6.0f;
                this.buttonsLayout.setPadding(AndroidUtilities.m1081dp(16.0f), 0, AndroidUtilities.m1081dp(16.0f), AndroidUtilities.m1081dp(4.0f));
                this.buttonsLayout.setTranslationY(-AndroidUtilities.m1081dp(6.0f));
            } else {
                f6 = 6.0f;
                this.buttonsLayout.setPadding(AndroidUtilities.m1081dp(f), AndroidUtilities.m1081dp(f), AndroidUtilities.m1081dp(f), AndroidUtilities.m1081dp(f));
            }
            this.containerView.addView(this.buttonsLayout, LayoutHelper.createLinear(-1, 52));
            if (this.topAnimationIsNew) {
                this.buttonsLayout.setTranslationY(-AndroidUtilities.m1081dp(f));
            }
            if (this.positiveButtonText != null) {
                final C28575 c28575 = new TextViewWithLoading(getContext()) { // from class: org.telegram.ui.ActionBar.AlertDialog.5
                    C28575(Context context) {
                        super(context);
                    }
                    ...
                    @Override // org.telegram.p026ui.ActionBar.TextViewWithLoading, android.widget.TextView
                    public void setTextColor(int i6) {
                        super.setTextColor(i6);
                        setBackground(Theme.getRoundRectSelectorDrawable(AndroidUtilities.m1081dp(20.0f), i6));
                    }
                };
                c28575.setMinWidth(AndroidUtilities.m1081dp(f5));
                c28575.setTag(-1);
                c28575.setTextSize(1, 16.0f);
                c28575.setTextColor(getThemedColor(this.dialogButtonColorKey));
                c28575.setGravity(17);
                c28575.setTypeface(AndroidUtilities.bold());
                c28575.setText(this.positiveButtonText);
                c28575.setBackground(Theme.getRoundRectSelectorDrawable(AndroidUtilities.m1081dp(f2), getThemedColor(this.dialogButtonColorKey)));
                c28575.setPadding(AndroidUtilities.m1081dp(f4), 0, AndroidUtilities.m1081dp(f4), 0);
                if (this.verticalButtons) {
                    this.buttonsLayout.addView(c28575, LayoutHelper.createLinear(-1, 40, 7));
                } else {
                    this.buttonsLayout.addView(c28575, LayoutHelper.createFrame(-2, 40, 53));
                }
                c28575.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda4
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view6) {
                        this.f$0.lambda$inflateContent$4(c28575, view6);
                    }
                });
            }
            if (this.negativeButtonText != null) {
                final C28586 c28586 = new TextViewWithLoading(getContext()) { // from class: org.telegram.ui.ActionBar.AlertDialog.6
                    C28586(Context context) {
                        super(context);
                    }
                ...
                c28586.setMinWidth(AndroidUtilities.m1081dp(f5));
                c28586.setTag(-2);
                c28586.setTextSize(1, 16.0f);
                c28586.setTextColor(getThemedColor(this.dialogButtonColorKey));
                c28586.setGravity(17);
                c28586.setTypeface(AndroidUtilities.bold());
                c28586.setEllipsize(TextUtils.TruncateAt.END);
                c28586.setSingleLine(true);
                c28586.setText(this.negativeButtonText.toString());
                c28586.setBackground(Theme.getRoundRectSelectorDrawable(AndroidUtilities.m1081dp(f2), getThemedColor(this.dialogButtonColorKey)));
                c28586.setPadding(AndroidUtilities.m1081dp(f4), 0, AndroidUtilities.m1081dp(f4), 0);
                if (this.verticalButtons) {
                    this.buttonsLayout.addView(c28586, 0, LayoutHelper.createLinear(-1, 40, 7));
                } else {
                    this.buttonsLayout.addView(c28586, LayoutHelper.createFrame(-2, 40, 53));
                }
                c28586.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda5
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view6) {
                        this.f$0.lambda$inflateContent$5(c28586, view6);
                    }
                });
            }
            if (this.neutralButtonText != null) {
                final C28597 c28597 = new TextViewWithLoading(getContext()) { // from class: org.telegram.ui.ActionBar.AlertDialog.7
                    C28597(Context context) {
                        super(context);
                    }
                ...
                c28597.setMinWidth(AndroidUtilities.m1081dp(f5));
                c28597.setTag(-3);
                c28597.setTextSize(1, 16.0f);
                c28597.setTextColor(getThemedColor(this.dialogButtonColorKey));
                c28597.setGravity(17);
                c28597.setTypeface(AndroidUtilities.bold());
                c28597.setEllipsize(TextUtils.TruncateAt.END);
                c28597.setSingleLine(true);
                c28597.setText(this.neutralButtonText.toString());
                c28597.setBackground(Theme.getRoundRectSelectorDrawable(AndroidUtilities.m1081dp(f2), getThemedColor(this.dialogButtonColorKey)));
                c28597.setPadding(AndroidUtilities.m1081dp(f4), 0, AndroidUtilities.m1081dp(f4), 0);
                if (this.verticalButtons) {
                    this.buttonsLayout.addView(c28597, 1, LayoutHelper.createLinear(-1, 40, 7));
                } else {
                    this.buttonsLayout.addView(c28597, LayoutHelper.createFrame(-2, 40, 51));
                }
                c28597.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda6
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view6) {
                        this.f$0.lambda$inflateContent$6(c28597, view6);
                    }
                });
            }
            if (this.negative2ButtonText != null) {
                final C28608 c28608 = new TextViewWithLoading(getContext()) { // from class: org.telegram.ui.ActionBar.AlertDialog.8
                    C28608(Context context) {
                        super(context);
                    }
                    ...
                    public void setTextColor(int i6) {
                        super.setTextColor(i6);
                        setBackgroundDrawable(Theme.getRoundRectSelectorDrawable(AndroidUtilities.m1081dp(6.0f), i6));
                    }
                };
                c28608.setMinWidth(AndroidUtilities.m1081dp(f5));
                c28608.setTag(-4);
                c28608.setTextSize(1, 16.0f);
                c28608.setTextColor(getThemedColor(this.dialogButtonColorKey));
                c28608.setGravity(17);
                c28608.setTypeface(AndroidUtilities.bold());
                c28608.setEllipsize(TextUtils.TruncateAt.END);
                c28608.setSingleLine(true);
                c28608.setText(this.negative2ButtonText.toString());
                c28608.setBackground(Theme.getRoundRectSelectorDrawable(AndroidUtilities.m1081dp(f6), getThemedColor(this.dialogButtonColorKey)));
                c28608.setPadding(AndroidUtilities.m1081dp(f4), 0, AndroidUtilities.m1081dp(f4), 0);
                if (this.verticalButtons) {
                    this.buttonsLayout.addView(c28608, 0, LayoutHelper.createLinear(-1, 36, 7));
                } else {
                    this.buttonsLayout.addView(c28608, LayoutHelper.createFrame(-2, 36, 53));
                }
                c28608.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda7
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view6) {
                        this.f$0.lambda$inflateContent$7(c28608, view6);
                    }
                });
            }
            if (this.verticalButtons) {
                for (int i6 = 1; i6 < this.buttonsLayout.getChildCount(); i6++) {
                    ((ViewGroup.MarginLayoutParams) this.buttonsLayout.getChildAt(i6).getLayoutParams()).topMargin = AndroidUtilities.m1081dp(f6);
                }
            }
        } else {
            f4 = 12.0f;
        ...
        if (this.needStarsBalance) {
            ...
            int iM1081dp2 = (i7 - AndroidUtilities.m1081dp(48.0f)) - (this.additioanalHorizontalPadding * 2);
            if (AndroidUtilities.isTablet()) {
                if (AndroidUtilities.isSmallTablet()) {
                    iM1081dp = AndroidUtilities.m1081dp(446.0f);
                } else {
            ...
            int iMin = Math.min(iM1081dp, iM1081dp2);
    ...
    class ViewOnAttachStateChangeListenerC28531 implements View.OnAttachStateChangeListener {
        final /* synthetic */ AttachableDrawable val$d;
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C28553 extends ScrollView {
        C28553(Context context) {
            super(context);
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C28564 extends FrameLayout {
        C28564(Context context) {
            super(context);
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C28575 extends TextViewWithLoading {
        C28575(Context context) {
            super(context);
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C28586 extends TextViewWithLoading {
        C28586(Context context) {
            super(context);
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C28597 extends TextViewWithLoading {
        C28597(Context context) {
            super(context);
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C28608 extends TextViewWithLoading {
        C28608(Context context) {
            super(context);
        }
    ...
    public Browser.Progress makeButtonLoading(int i, final boolean z, boolean z2) {
        ...
        return new Browser.Progress(new Runnable() { // from class: org.telegram.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda12
            @Override // java.lang.Runnable
            public final void run() {
                AlertDialog.m4726$r8$lambda$B4fp4rFk_mbEvWTBZXG5SwPoB0(button);
            }
    ...
    public static /* synthetic */ void m4726$r8$lambda$B4fp4rFk_mbEvWTBZXG5SwPoB0(View view) {
    ...
    public void setMessageLineSpacing(float f) {
        TextView textView = this.messageTextView;
        if (textView != null) {
            textView.setLineSpacing(AndroidUtilities.m1081dp(f), 1.0f);
        }
    }
    ...
    public void showCancelAlert() {
        if (this.canCacnel && this.cancelDialog == null) {
            ...
            builder.setTitle(LocaleController.getString(C2702R.string.StopLoadingTitle));
            builder.setMessage(LocaleController.getString(C2702R.string.StopLoading));
            builder.setPositiveButton(LocaleController.getString(C2702R.string.WaitMore), null);
            builder.setNegativeButton(LocaleController.getString(C2702R.string.Stop), new OnButtonClickListener() { // from class: org.telegram.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda10
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C28619 extends AnimatorListenerAdapter {
        final /* synthetic */ int val$num;
