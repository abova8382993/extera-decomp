...
public class SimpleTextView extends View implements Drawable.Callback {
    ...
    public SimpleTextView(Context context) {
        ...
        this.drawablePadding = AndroidUtilities.m1081dp(4.0f);
    ...
    public void setTextSize(int i) {
        float fM1081dp = AndroidUtilities.m1081dp(i);
        if (fM1081dp == this.textPaint.getTextSize()) {
            return;
        }
        this.textPaint.setTextSize(fM1081dp);
    ...
    private void updateFadePaints() {
        if ((this.fadePaint == null || this.fadePaintBack == null) && this.scrollNonFitText) {
            ...
            paint.setShader(new LinearGradient(0.0f, 0.0f, AndroidUtilities.m1081dp(6.0f), 0.0f, new int[]{-1, 0}, new float[]{0.0f, 1.0f}, tileMode));
            Paint paint2 = this.fadePaint;
            PorterDuff.Mode mode = PorterDuff.Mode.DST_OUT;
            paint2.setXfermode(new PorterDuffXfermode(mode));
            Paint paint3 = new Paint();
            this.fadePaintBack = paint3;
            paint3.setShader(new LinearGradient(0.0f, 0.0f, AndroidUtilities.m1081dp(6.0f), 0.0f, new int[]{0, -1}, new float[]{0.0f, 1.0f}, tileMode));
            this.fadePaintBack.setXfermode(new PorterDuffXfermode(mode));
        }
        Boolean bool = this.forceEllipsizeByGradientLeft;
        boolean zBooleanValue = bool != null ? bool.booleanValue() : false;
        if (!(this.fadeEllpsizePaint != null && this.fadeEllpsizePaintWidth == AndroidUtilities.m1081dp(this.ellipsizeByGradientWidthDp) && this.ellipsizeByGradientLeft == zBooleanValue) && this.ellipsizeByGradient) {
            ...
            if (zBooleanValue) {
                ...
                int iM1081dp = AndroidUtilities.m1081dp(this.ellipsizeByGradientWidthDp);
                this.fadeEllpsizePaintWidth = iM1081dp;
                paint4.setShader(new LinearGradient(0.0f, 0.0f, iM1081dp, 0.0f, new int[]{-1, 0}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP));
            } else {
                Paint paint5 = this.fadeEllpsizePaint;
                int iM1081dp2 = AndroidUtilities.m1081dp(this.ellipsizeByGradientWidthDp);
                this.fadeEllpsizePaintWidth = iM1081dp2;
                paint5.setShader(new LinearGradient(0.0f, 0.0f, iM1081dp2, 0.0f, new int[]{0, -1}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP));
            }
    ...
    private void calcOffset(int i) {
        ...
        if (layout.getLineCount() > 0) {
            ...
            if ((i2 & 7) == 1) {
                ...
                this.offsetX = -AndroidUtilities.m1081dp(8.0f);
            }
                ...
                if (this.buildFullLayout) {
                    ...
                    if (!this.ellipsizeByGradient && !charSequenceEllipsize.equals(charSequence3)) {
                        ...
                        if (staticLayoutCreateStaticLayout != null) {
                            ...
                            this.firstLineLayout = new StaticLayout(charSequenceEllipsize, 0, charSequenceEllipsize.length(), this.textPaint, this.scrollNonFitText ? AndroidUtilities.m1081dp(2000.0f) : AndroidUtilities.m1081dp(8.0f) + i3, getAlignment(), 1.0f, 0.0f, false);
                            StaticLayout staticLayout = new StaticLayout(charSequenceSubSequence2, 0, charSequenceSubSequence2.length(), this.textPaint, this.scrollNonFitText ? AndroidUtilities.m1081dp(2000.0f) : AndroidUtilities.m1081dp(8.0f) + i3, getAlignment(), 1.0f, 0.0f, false);
                            ...
                            this.partLayout = new StaticLayout(charSequence4, 0, charSequence4.length(), this.textPaint, this.scrollNonFitText ? AndroidUtilities.m1081dp(2000.0f) : AndroidUtilities.m1081dp(8.0f) + i3, getAlignment(), 1.0f, 0.0f, false);
                            this.fullLayout = StaticLayoutEx.createStaticLayout(spannableStringBuilderValueOf2, this.textPaint, AndroidUtilities.m1081dp(8.0f) + i3 + this.fullLayoutAdditionalWidth, getAlignment(), 1.0f, 0.0f, false, truncateAt, i3 + this.fullLayoutAdditionalWidth, this.fullTextMaxLines, false);
                        }
                    } else {
                        CharSequence charSequence5 = charSequenceEllipsize;
                        this.layout = new StaticLayout(charSequence5, 0, charSequence5.length(), this.textPaint, (this.scrollNonFitText || this.ellipsizeByGradient) ? AndroidUtilities.m1081dp(2000.0f) : AndroidUtilities.m1081dp(8.0f) + i3, getAlignment(), 1.0f, 0.0f, false);
                    ...
                    this.layout = new StaticLayout(charSequence6, 0, charSequence6.length(), this.textPaint, (this.scrollNonFitText || this.ellipsizeByGradient) ? AndroidUtilities.m1081dp(2000.0f) : AndroidUtilities.m1081dp(8.0f) + i3, getAlignment(), 1.0f, 0.0f, false);
                }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (z || this.ellipsizeByGradient) {
            canvas2 = canvas;
            iSaveLayerAlpha = canvas2.saveLayerAlpha(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), Function.USE_VARARGS, 31);
        } else {
        ...
        int iM1081dp = this.totalWidth + AndroidUtilities.m1081dp(16.0f);
        float f7 = this.scrollingOffset;
        if (f7 != f) {
            if (this.leftDrawable != null && !this.leftDrawableOutside) {
                int i25 = ((int) (-f7)) + iM1081dp;
                if ((this.gravity & 112) == 16) {
            ...
            if (this.rightDrawable == null || this.rightDrawableOutside) {
                ...
                int i27 = this.textWidth + i19 + this.drawablePadding + ((int) (-this.scrollingOffset)) + iM1081dp;
                if ((this.gravity & 112) == 16) {
            ...
            if (this.rightDrawable2 != null && !this.rightDrawableOutside) {
                ...
                int intrinsicWidth7 = this.textWidth + i19 + this.drawablePadding + ((int) (-this.scrollingOffset)) + iM1081dp;
                if (this.rightDrawable != null) {
        ...
        if (this.layout != null) {
            if (this.leftDrawableOutside || this.rightDrawableOutside || this.ellipsizeByGradient || this.paddingRight > 0) {
                ...
                canvas2.clipRect(i19, 0, maxTextWidth - AndroidUtilities.m1081dp((drawable6 == null || (drawable6 instanceof AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable) || !this.rightDrawableOutside) ? f : 2.0f), getMeasuredHeight());
            }
            ...
            if (this.partLayout != null && this.fullAlpha < 1.0f) {
                ...
                if (this.partLayout.getText().length() == 1) {
                    fM1081dp = AndroidUtilities.m1081dp(this.fullTextMaxLines == 1 ? 0.5f : 4.0f);
                } else {
                    fM1081dp = f;
                }
                if (this.layout.getLineLeft(0) != f) {
                    f6 = f;
                    canvas2.translate((-this.layout.getLineWidth(0)) + fM1081dp, f6);
                } else {
                    f6 = f;
                    canvas2.translate(this.layout.getLineWidth(0) - fM1081dp, f6);
                }
            ...
            if (z) {
                if (this.scrollingOffset < AndroidUtilities.m1081dp(10.0f)) {
                    this.fadePaint.setAlpha((int) ((this.scrollingOffset / AndroidUtilities.m1081dp(10.0f)) * f5));
                } else if (this.scrollingOffset > (this.totalWidth + AndroidUtilities.m1081dp(f2)) - AndroidUtilities.m1081dp(10.0f)) {
                    this.fadePaint.setAlpha((int) ((f4 - ((this.scrollingOffset - ((this.totalWidth + AndroidUtilities.m1081dp(f2)) - AndroidUtilities.m1081dp(10.0f))) / AndroidUtilities.m1081dp(10.0f))) * f5));
                } else {
                    this.fadePaint.setAlpha(Function.USE_VARARGS);
                }
                canvas2.drawRect(i19, 0.0f, AndroidUtilities.m1081dp(6.0f) + i19, getMeasuredHeight(), this.fadePaint);
                canvas2.save();
                canvas2.translate((getMaxTextWidth() - this.paddingRight) - AndroidUtilities.m1081dp(6.0f), 0.0f);
                canvas2.drawRect(0.0f, 0.0f, AndroidUtilities.m1081dp(6.0f), getMeasuredHeight(), this.fadePaintBack);
                canvas2.restore();
                ...
                if (!this.ellipsizeByGradientLeft) {
                    ...
                    canvas2.translate(maxTextWidth2 - AndroidUtilities.m1081dp((drawable7 == null || (drawable7 instanceof AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable) || !this.rightDrawableOutside) ? 0.0f : 2.0f), 0.0f);
                }
        ...
        if (this.rightDrawable != null && this.rightDrawableOutside) {
            ...
            int iMin = Math.min(i40 + (f13 == 0.0f ? -iM1081dp : (int) (-f13)) + iM1081dp, (getMaxTextWidth() - this.paddingRight) + this.drawablePadding);
        ...
        int iMin2 = Math.min(i42 + (f14 == 0.0f ? -iM1081dp : (int) (-f14)) + iM1081dp, (getMaxTextWidth() - this.paddingRight) + this.drawablePadding);
        if (this.rightDrawable != null) {
        ...
        if (this.scrollNonFitText) {
            if (this.textDoesNotFit || this.scrollingOffset != 0.0f) {
                ...
                if (i > 0) {
                    ...
                    int iM1081dp = this.totalWidth + AndroidUtilities.m1081dp(16.0f);
                    if (this.scrollingOffset < AndroidUtilities.m1081dp(100.0f)) {
                        fM1081dp = ((this.scrollingOffset / AndroidUtilities.m1081dp(100.0f)) * 20.0f) + 30.0f;
                    } else {
                        fM1081dp = this.scrollingOffset >= ((float) (iM1081dp - AndroidUtilities.m1081dp(100.0f))) ? 50.0f - (((this.scrollingOffset - (iM1081dp - AndroidUtilities.m1081dp(100.0f))) / AndroidUtilities.m1081dp(100.0f)) * 20.0f) : 50.0f;
                    }
                    float fM1081dp2 = this.scrollingOffset + ((j / 1000.0f) * AndroidUtilities.m1081dp(fM1081dp));
                    this.scrollingOffset = fM1081dp2;
                    this.lastUpdateTime = jElapsedRealtime;
                    if (fM1081dp2 > iM1081dp) {
                        this.scrollingOffset = 0.0f;
                        this.currentScrollDelay = 500;
                    }
                }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.rightDrawableOnClickListener == null || this.rightDrawable == null) {
            ...
            AndroidUtilities.rectTmp.set(this.rightDrawableX - AndroidUtilities.m1081dp(16.0f), this.rightDrawableY - AndroidUtilities.m1081dp(16.0f), this.rightDrawableX + AndroidUtilities.m1081dp(16.0f), this.rightDrawableY + AndroidUtilities.m1081dp(16.0f));
        ...
        if (this.rightDrawable2OnClickListener != null && this.rightDrawable2 != null) {
            AndroidUtilities.rectTmp.set(this.rightDrawable2X - AndroidUtilities.m1081dp(16.0f), this.rightDrawable2Y - AndroidUtilities.m1081dp(16.0f), this.rightDrawable2X + AndroidUtilities.m1081dp(16.0f), this.rightDrawable2Y + AndroidUtilities.m1081dp(16.0f));
