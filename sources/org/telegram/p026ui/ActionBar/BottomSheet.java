...
public class BottomSheet extends Dialog implements BaseFragment.AttachedSheet {
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C28661 extends ColorDrawable {
        C28661(int i) {
            super(i);
        }
    ...
    public class ContainerView extends FrameLayout {
        ...
        class C28751 extends AnimatorListenerAdapter {
            C28751() {
            }
        ...
        public boolean processTouchEvent(MotionEvent motionEvent, boolean z) {
            ...
            if (BottomSheet.this.canSwipeToBack(motionEvent) || this.allowedSwipeToBack) {
                ...
                BottomSheet.this.onScrollUpBegin(this.f1825y);
                this.startedTrackingPointerId = motionEvent.getPointerId(0);
                this.maybeStartTracking = true;
                cancelCurrentAnimation();
                ...
                boolean zOnScrollUp = BottomSheet.this.onScrollUp(this.f1825y + y3);
                this.velocityTracker.addMovement(motionEvent);
                if (!BottomSheet.this.disableScroll && this.maybeStartTracking && !this.startedTracking && y3 > 0.0f && y3 / 3.0f > Math.abs(fAbs) && Math.abs(y3) >= BottomSheet.this.touchSlop) {
                    ...
                    float f2 = this.f1825y + y3;
                    this.f1825y = f2;
                    if (!zOnScrollUp) {
                        this.f1825y = Math.max(f2, 0.0f);
                    }
                    BottomSheet.this.containerView.setTranslationY(Math.max(this.f1825y, 0.0f));
                    BottomSheet.this.onContainerViewTranslation();
                    this.startedTrackingY = (int) motionEvent.getY();
                    BottomSheet.this.container.invalidate();
                }
                ...
                BottomSheet.this.onScrollUpEnd(this.f1825y);
                if (this.startedTracking || this.f1825y > 0.0f) {
        ...
        class C28762 extends AnimatorListenerAdapter {
            C28762() {
            }
        ...
        class C28773 extends AnimatorListenerAdapter {
            C28773() {
            }
        ...
        */
        ...
        /* JADX WARN: Removed duplicated region for block: B:370:0x00c7  */
        /* JADX WARN: Removed duplicated region for block: B:374:0x00e1  */
        /* JADX WARN: Removed duplicated region for block: B:411:0x01f7  */
        /* JADX WARN: Removed duplicated region for block: B:416:0x0206  */
        /* JADX WARN: Removed duplicated region for block: B:419:0x0218  */
        ...
        */
        ...
        class C28784 extends AnimatorListenerAdapter {
            C28784() {
            }
    ...
    protected int getBottomSheetWidth(boolean z, int i, int i2) {
        return z ? i : (int) Math.max(i * 0.8f, Math.min(AndroidUtilities.m1081dp(480.0f), i));
    }
    ...
    public static class BottomSheetCell extends FrameLayout {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(i4), TLObject.FLAG_30));
        }
        ...
        public void setTextAndIcon(CharSequence charSequence, int i, Drawable drawable, boolean z) {
            ...
            if (i != 0 || drawable != null) {
                ...
                if (z) {
                    this.textView.setPadding(AndroidUtilities.m1081dp(LocaleController.isRTL ? 21.0f : 72.0f), 0, AndroidUtilities.m1081dp(LocaleController.isRTL ? 72.0f : 21.0f), 0);
                    this.imageView.setPadding(LocaleController.isRTL ? 0 : AndroidUtilities.m1081dp(5.0f), 0, LocaleController.isRTL ? AndroidUtilities.m1081dp(5.0f) : 5, 0);
                    return;
                } else {
                    this.textView.setPadding(AndroidUtilities.m1081dp(LocaleController.isRTL ? 16.0f : 72.0f), 0, AndroidUtilities.m1081dp(LocaleController.isRTL ? 72.0f : 16.0f), 0);
                    this.imageView.setPadding(0, 0, 0, 0);
                    return;
                }
            }
            this.imageView.setVisibility(4);
            this.textView.setPadding(AndroidUtilities.m1081dp(z ? 21.0f : 16.0f), 0, AndroidUtilities.m1081dp(z ? 21.0f : 16.0f), 0);
        }

        public void setChecked(boolean z) {
            ImageView imageView = this.imageView2;
            this.checked = z;
            imageView.setImageResource(z ? C2702R.drawable.checkbig : 0);
        }
    ...
    public BottomSheet(Context context, boolean z, boolean z2, Theme.ResourcesProvider resourcesProvider) {
        ...
        C28672 c28672 = new ContainerView(getContext()) { // from class: org.telegram.ui.ActionBar.BottomSheet.2
            C28672(Context context2) {
                super(context2);
            }
        ...
        this.container = c28672;
        c28672.setClipChildren(false);
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C28672 extends ContainerView {
        C28672(Context context2) {
            super(context2);
        }
    ...
    private void onCreateInternal() {
        ...
        if (this.containerView == null) {
            C28683 c28683 = new FrameLayout(getContext()) { // from class: org.telegram.ui.ActionBar.BottomSheet.3
                @Override // android.view.View
                public boolean hasOverlappingRendering() {
                    return false;
                }

                C28683(Context context) {
                    super(context);
                }
            ...
            this.containerView = c28683;
            c28683.setBackgroundDrawable(this.shadowDrawable);
            this.containerView.setPadding(this.backgroundPaddingLeft, ((this.applyTopPadding ? AndroidUtilities.m1081dp(8.0f) : 0) + this.backgroundPaddingTop) - 1, this.backgroundPaddingLeft, this.applyBottomPadding ? AndroidUtilities.m1081dp(8.0f) : 0);
        }
        ...
        if (this.title != null) {
            C28694 c28694 = new TextView(getContext()) { // from class: org.telegram.ui.ActionBar.BottomSheet.4
                C28694(Context context) {
                    super(context);
                }
                        ...
                        if (BottomSheet.this.containerView != null) {
                            for (int i4 = 1; i4 < BottomSheet.this.containerView.getChildCount(); i4++) {
                                ...
                                if (childAt instanceof BottomSheetCell) {
                                    ...
                                    measuredHeight += AndroidUtilities.m1081dp(48.0f);
                                }
                            }
                        }
                    }
            ...
            this.titleView = c28694;
            c28694.setText(this.title);
            if (this.bigTitle) {
                this.titleView.setTextColor(getThemedColor(Theme.key_dialogTextBlack));
                this.titleView.setTextSize(1, 20.0f);
                this.titleView.setTypeface(AndroidUtilities.bold());
                this.titleView.setPadding(AndroidUtilities.m1081dp(21.0f), AndroidUtilities.m1081dp(this.multipleLinesTitle ? 14.0f : 6.0f), AndroidUtilities.m1081dp(21.0f), AndroidUtilities.m1081dp(8.0f));
            } else {
                this.titleView.setTextColor(getThemedColor(Theme.key_dialogTextGray2));
                this.titleView.setTextSize(1, 16.0f);
                this.titleView.setPadding(AndroidUtilities.m1081dp(16.0f), AndroidUtilities.m1081dp(this.multipleLinesTitle ? 8.0f : 0.0f), AndroidUtilities.m1081dp(16.0f), AndroidUtilities.m1081dp(8.0f));
            }
        ...
        if (view != null) {
            ...
            if (!this.useBackgroundTopPadding) {
                ...
                ((ViewGroup.MarginLayoutParams) this.customView.getLayoutParams()).topMargin = (-this.backgroundPaddingTop) + AndroidUtilities.m1081dp(f);
            } else {
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C28683 extends FrameLayout {
        @Override // android.view.View
        public boolean hasOverlappingRendering() {
            return false;
        }
    ...
    public void show() {
        if (AndroidUtilities.isSafeToShow(getContext())) {
            ...
            RunnableC28705 runnableC28705 = new Runnable() { // from class: org.telegram.ui.ActionBar.BottomSheet.5
                RunnableC28705() {
                }
            ...
            this.startAnimationRunnable = runnableC28705;
            AndroidUtilities.runOnUIThread(runnableC28705, j);
        }
    }

    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.BottomSheet$5 */
    /* JADX INFO: loaded from: classes6.dex */
    class RunnableC28705 implements Runnable {
        RunnableC28705() {
        }
    ...
    public void startOpenAnimation() {
        ...
        if (this.transitionFromRight) {
            this.containerView.setTranslationX(AndroidUtilities.m1081dp(48.0f));
            this.containerView.setAlpha(0.0f);
            this.containerView.setTranslationY(0.0f);
        } else {
            this.containerView.setTranslationY(getContainerViewHeight() + this.keyboardHeight + AndroidUtilities.m1081dp(10.0f) + Math.max(0, Math.min(AndroidUtilities.navigationBarHeight, getBottomInset())));
        }
        onContainerViewTranslation();
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C28716 extends AnimatorListenerAdapter {
        C28716() {
        }
    ...
    public void dismissWithButtonClick(final int i) {
        ...
        this.currentSheetAnimation = new AnimatorSet();
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(this.containerView, (Property<ViewGroup, Float>) View.TRANSLATION_Y, getContainerViewHeight() + this.keyboardHeight + AndroidUtilities.m1081dp(10.0f) + Math.max(0, Math.min(AndroidUtilities.navigationBarHeight, getBottomInset())));
        ...
        this.currentSheetAnimation.addListener(new C28727(i));
        NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.stopAllHeavyOperations, 512);
        this.currentSheetAnimation.start();
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C28727 extends AnimatorListenerAdapter {
    ...
    */
    public void lambda$new$0() {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.ActionBar.BottomSheet.lambda$new$0():void");
    }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C28738 extends AnimatorListenerAdapter {
        C28738() {
        }
    ...
    public int getNavigationBarColor(int i) {
        ...
        if (!attachedToParent() || (viewGroup = this.containerView) == null) {
            ...
            fClamp01 = Utilities.clamp01(1.0f - (this.containerView.getTranslationY() / (((getContainerViewHeight() + this.keyboardHeight) + AndroidUtilities.m1081dp(10.0f)) + (this.scrollNavBar ? Math.max(0, Math.min(AndroidUtilities.navigationBarHeight, getBottomInset())) : 0))));
        }
    ...
    public void setOverlayNavBarColor(int i) {
        ...
        if (this.attachedFragment != null) {
            LaunchActivity.instance.checkSystemBarColors(true, true, true);
            AndroidUtilities.setLightNavigationBar(mo5374getWindowView(), AndroidUtilities.computePerceivedBrightness(getNavigationBarColor(getThemedColor(Theme.key_windowBackgroundGray))) >= 0.721f);
        } else {
    ...
    public void registerBackCallback() {
        if (this.backAnimationCallback == null && ExteraConfig.predictiveBackAnimation) {
            ...
            C28749 c28749 = new OnBackAnimationCallback() { // from class: org.telegram.ui.ActionBar.BottomSheet.9
                C28749() {
                }
            ...
            this.backAnimationCallback = c28749;
            if (this.keyboardVisible) {
                return;
            }
            this.onBackInvokedDispatcher.registerOnBackInvokedCallback(1000000, c28749);
            this.isBackCallbackRegistered = true;
        }
    }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C28749 implements OnBackAnimationCallback {
        C28749() {
        }
    ...
    public BulletinFactory getBulletinFactory() {
        return BulletinFactory.m1194of(this.topBulletinContainer, this.resourcesProvider);
    }
}
