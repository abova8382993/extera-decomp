...
public class BackDrawable extends Drawable {
    ...
    public BackDrawable(boolean z) {
        ...
        this.prevPaint.setStrokeWidth(AndroidUtilities.m1081dp(2.0f));
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.currentRotation != this.finalRotation) {
            if (this.lastFrameTime != 0) {
                int iCurrentTimeMillis = (int) (((long) this.currentAnimationTime) + (System.currentTimeMillis() - this.lastFrameTime));
        ...
        if (this.alwaysClose) {
            canvas.rotate((f4 * (this.reverseAngle ? -180 : Opcodes.GETFIELD)) + 135.0f);
            f = 1.0f;
        } else {
            canvas.rotate((this.reverseAngle ? -225 : Opcodes.I2D) * f4);
            f = f4;
        }
        float f5 = 1.0f - f;
        canvas.drawLine(AndroidUtilities.m1081dp(AndroidUtilities.lerp(-6.75f, -8.0f, f)), 0.0f, AndroidUtilities.m1081dp(8.0f) - ((this.paint.getStrokeWidth() / 2.0f) * f5), 0.0f, this.paint);
        float fM1081dp = AndroidUtilities.m1081dp(-0.25f);
        float fM1081dp2 = AndroidUtilities.m1081dp(AndroidUtilities.lerp(7.0f, 8.0f, f)) - ((this.paint.getStrokeWidth() / 4.0f) * f5);
        float fM1081dp3 = AndroidUtilities.m1081dp(AndroidUtilities.lerp(-7.25f, 0.0f, f));
        canvas.drawLine(fM1081dp3, -fM1081dp, 0.0f, -fM1081dp2, this.paint);
        canvas.drawLine(fM1081dp3, fM1081dp, 0.0f, fM1081dp2, this.paint);
        canvas.restore();
    }
