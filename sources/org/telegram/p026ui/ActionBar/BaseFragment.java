...
import com.exteragram.messenger.icons.p010ui.picker.IconObserver;
...
public abstract class BaseFragment {
    ...
    public interface AttachedSheet {
        ...
        /* JADX INFO: renamed from: org.telegram.ui.ActionBar.BaseFragment$AttachedSheet$-CC */
        /* JADX INFO: loaded from: classes6.dex */
    ...
    public INavigationLayout[] showAsSheet(BaseFragment baseFragment, BottomSheetParams bottomSheetParams) {
        ...
        DialogC28651 dialogC28651 = new DialogC28651(getParentActivity(), true, baseFragment.getResourceProvider(), bottomSheetParams, iNavigationLayoutArr, baseFragment, bottomSheetArr);
        final BottomSheet[] bottomSheetArr = {dialogC28651};
        if (bottomSheetParams != null) {
            dialogC28651.setAllowNestedScroll(bottomSheetParams.allowNestedScroll);
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class DialogC28651 extends BottomSheet {
        ...
        DialogC28651(Context context, boolean z, Theme.ResourcesProvider resourcesProvider, final BottomSheetParams bottomSheetParams, INavigationLayout[] iNavigationLayoutArr, final BaseFragment baseFragment, BottomSheet[] bottomSheetArr) {
            ...
            setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.ActionBar.BaseFragment$1$$ExternalSyntheticLambda0
                @Override // android.content.DialogInterface.OnDismissListener
                public final void onDismiss(DialogInterface dialogInterface) {
                    BaseFragment.DialogC28651.$r8$lambda$Rx21TGQLU2yUDDxrvshPgjTbRus(baseFragment, bottomSheetParams, dialogInterface);
                }
            });
        }
        ...
        if (this.sheetsStack != null) {
            for (int i = 0; i < this.sheetsStack.size(); i++) {
                ...
                if (attachedSheet != null && attachedSheet.attachedToParent()) {
                    AndroidUtilities.removeFromParent(attachedSheet.mo5374getWindowView());
                    layoutContainer.addView(attachedSheet.mo5374getWindowView());
                }
            }
        }
    }
    ...
    public boolean isStoryViewer(View view) {
        if (this.sheetsStack != null) {
            for (int i = 0; i < this.sheetsStack.size(); i++) {
                AttachedSheet attachedSheet = this.sheetsStack.get(i);
                if ((attachedSheet instanceof StoryViewer) && view == attachedSheet.mo5374getWindowView()) {
                    return true;
                }
            }
        }
    ...
    */
    public org.telegram.p026ui.Stories.StoryViewer getOrCreateStoryViewer() {
        /*
            r3 = this;
        ...
        Lb:
            ...
            boolean r0 = r0 instanceof org.telegram.p026ui.Stories.StoryViewer
            if (r0 == 0) goto L31
            java.util.ArrayList<org.telegram.ui.ActionBar.BaseFragment$AttachedSheet> r0 = r3.sheetsStack
            int r2 = r0.size()
            int r2 = r2 - r1
            java.lang.Object r0 = r0.get(r2)
            org.telegram.ui.Stories.StoryViewer r0 = (org.telegram.p026ui.Stories.StoryViewer) r0
            goto L32
        L31:
            r0 = 0
        L32:
        ...
        L4d:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.ActionBar.BaseFragment.getOrCreateStoryViewer():org.telegram.ui.Stories.StoryViewer");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public org.telegram.p026ui.Stories.StoryViewer getOrCreateStoryViewer(int r5) {
        /*
            r4 = this;
        ...
        L5d:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.ActionBar.BaseFragment.getOrCreateStoryViewer(int):org.telegram.ui.Stories.StoryViewer");
    }
