...
import org.telegram.p026ui.Components.BackButtonMenu;
...
public class ActionBarLayout extends FrameLayout implements INavigationLayout, FloatingDebugProvider {
    ...
    @Override // org.telegram.p026ui.ActionBar.INavigationLayout
    ...
    public class LayoutContainer extends FrameLayout {
        ...
        protected boolean drawChild(Canvas canvas, View view, long j) {
            ...
            if (lastSheet != null && lastSheet.isFullyVisible() && lastSheet.mo5374getWindowView() != view) {
                return true;
            }
        ...
        /* JADX WARN: Removed duplicated region for block: B:144:0x0041 A[RETURN] */
        ...
        */
        public boolean dispatchTouchEvent(android.view.MotionEvent r6) {
            /*
                r5 = this;
                r6.getAction()
                org.telegram.ui.ActionBar.ActionBarLayout r0 = org.telegram.p026ui.ActionBar.ActionBarLayout.this
                boolean r0 = org.telegram.p026ui.ActionBar.ActionBarLayout.m4620$$Nest$fgetinPreviewMode(r0)
                r1 = 1
                r2 = 0
                if (r0 == 0) goto L17
                org.telegram.ui.ActionBar.ActionBarLayout r0 = org.telegram.p026ui.ActionBar.ActionBarLayout.this
                org.telegram.ui.ActionBar.ActionBarPopupWindow$ActionBarPopupWindowLayout r0 = org.telegram.p026ui.ActionBar.ActionBarLayout.m4627$$Nest$fgetpreviewMenu(r0)
                if (r0 != 0) goto L17
                r0 = r1
                goto L18
            L17:
            ...
            L18:
                if (r0 != 0) goto L22
                org.telegram.ui.ActionBar.ActionBarLayout r3 = org.telegram.p026ui.ActionBar.ActionBarLayout.this
                boolean r3 = org.telegram.p026ui.ActionBar.ActionBarLayout.m4632$$Nest$fgettransitionAnimationPreviewMode(r3)
                if (r3 == 0) goto L30
            L22:
            ...
            L30:
                if (r0 == 0) goto L3b
                org.telegram.ui.ActionBar.ActionBarLayout r0 = org.telegram.p026ui.ActionBar.ActionBarLayout.this     // Catch: java.lang.Throwable -> L39
    ...
    public EmptyBaseFragment getSheetFragment(boolean z) {
        ...
        if (this.sheetFragment == null) {
            C28051 c28051 = new EmptyBaseFragment() { // from class: org.telegram.ui.ActionBar.ActionBarLayout.1
                C28051() {
                }
            ...
            this.sheetFragment = c28051;
            c28051.setParentLayout(this);
            EmptyBaseFragment emptyBaseFragment = this.sheetFragment;
    ...
    class C28051 extends EmptyBaseFragment {
        C28051() {
        }
    ...
    public void setFragmentStack(List<BaseFragment> list) {
        ...
        if (this.main) {
            ...
            FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(-1, AndroidUtilities.m1081dp(76.0f));
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.isKeyboardVisible = measureKeyboardHeight() > AndroidUtilities.m1081dp(20.0f);
    ...
    */
    protected void onLayout(boolean r9, int r10, int r11, int r12, int r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.ActionBar.ActionBarLayout.onLayout(boolean, int, int, int, int):void");
    }
    ...
    public void setInnerTranslationX(float f) {
        ...
        if (newBackTransitions()) {
            measuredWidth = Utilities.clamp01(f / (AndroidUtilities.m1081dp(56.0f) * 6));
        } else {
    ...
    /* JADX WARN: Removed duplicated region for block: B:1010:0x0356  */
    /* JADX WARN: Removed duplicated region for block: B:1012:0x0383  */
    /* JADX WARN: Removed duplicated region for block: B:1015:0x0389  */
    /* JADX WARN: Removed duplicated region for block: B:1016:0x038c  */
    /* JADX WARN: Removed duplicated region for block: B:1020:0x0392  */
    /* JADX WARN: Removed duplicated region for block: B:1023:0x039a  */
    /* JADX WARN: Removed duplicated region for block: B:861:0x0092  */
    /* JADX WARN: Removed duplicated region for block: B:925:0x01e0  */
    /* JADX WARN: Removed duplicated region for block: B:964:0x026f  */
    /* JADX WARN: Removed duplicated region for block: B:975:0x0287  */
    @Override // android.view.ViewGroup
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    protected boolean drawChild(android.graphics.Canvas r21, android.view.View r22, long r23) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.ActionBar.ActionBarLayout.drawChild(android.graphics.Canvas, android.view.View, long):boolean");
    }
    ...
    private void drawPreviewDrawables(Canvas canvas, ViewGroup viewGroup) {
        if (viewGroup.getChildAt(0) != null) {
            ...
            if (this.previewMenu == null) {
                int iM1081dp = AndroidUtilities.m1081dp(32.0f);
                int measuredWidth = (getMeasuredWidth() - iM1081dp) / 2;
                int top = (int) ((r1.getTop() + viewGroup.getTranslationY()) - AndroidUtilities.m1081dp(12.0f));
                Theme.moveUpDrawable.setBounds(measuredWidth, top, iM1081dp + measuredWidth, (iM1081dp / 2) + top);
    ...
    /* JADX WARN: Removed duplicated region for block: B:739:0x0271  */
    /* JADX WARN: Removed duplicated region for block: B:742:0x0276  */
    /* JADX WARN: Removed duplicated region for block: B:758:0x0300  */
    @Override // android.view.View
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public boolean onTouchEvent(android.view.MotionEvent r11) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.ActionBar.ActionBarLayout.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public void onBackProgress(float f) {
        if (this.predictiveInput) {
            float fM1081dp = AndroidUtilities.m1081dp(72.0f) * f;
            this.predictiveBackHasProgress = f > 0.0f;
            this.containerView.setTranslationX(fM1081dp);
            if (ExteraConfig.springAnimations) {
                this.containerViewBack.setTranslationX((-(this.containerView.getMeasuredWidth() - fM1081dp)) * 0.35f);
            }
            setInnerTranslationX(fM1081dp);
        }
    }
    ...
    private void animateBackEndAnimation(boolean z) {
        ...
        if (!z) {
            ...
            if (!zShouldOverrideSlideTransition) {
                long j = iMax;
                animatorSet.playTogether(ObjectAnimator.ofFloat(this.containerView, (Property<LayoutContainer, Float>) property, r6.getMeasuredWidth() + (this.predictiveBackInProgress ? AndroidUtilities.m1081dp(56.0f) : 0)).setDuration(j), ObjectAnimator.ofFloat(this, "innerTranslationX", this.containerView.getMeasuredWidth()).setDuration(j));
                if (newBackTransitions()) {
    ...
    class C28092 extends AnimatorListenerAdapter {
        private boolean cancelled;
        final /* synthetic */ boolean val$backAnimation;
    ...
    private void applySpringProgress(float f) {
        ...
        if (this.springIsPreview) {
            if (this.openingAnimation) {
                ...
                if (this.previewMenu != null) {
                    float f4 = 1.0f - f2;
                    this.containerView.setTranslationY(AndroidUtilities.m1081dp(40.0f) * f4);
                    this.previewMenu.setTranslationY((-AndroidUtilities.m1081dp(70.0f)) * f4);
    ...
    public void startLayoutAnimation(boolean z, boolean z2, boolean z3) {
        if (z2) {
        ...
        RunnableC28103 runnableC28103 = new Runnable() { // from class: org.telegram.ui.ActionBar.ActionBarLayout.3
            final /* synthetic */ boolean val$first;
            final /* synthetic */ boolean val$open;
            final /* synthetic */ boolean val$preview;

            RunnableC28103(boolean z22, boolean z32, boolean z4) {
                z = z22;
                z = z32;
                z = z4;
            }
                ...
                if (z) {
                    ...
                    if (z) {
                        ...
                        if (ActionBarLayout.this.previewMenu != null) {
                            ...
                            ActionBarLayout.this.containerView.setTranslationY(AndroidUtilities.m1081dp(40.0f) * f3);
                            ActionBarLayout.this.previewMenu.setTranslationY((-AndroidUtilities.m1081dp(70.0f)) * f3);
                        ...
                        ActionBarLayout.this.containerView.setTranslationX(AndroidUtilities.m1081dp(48.0f) * (1.0f - interpolation));
                    }
                } else {
                    ...
                    if (z) {
                        ...
                        ActionBarLayout.this.containerViewBack.setTranslationX(AndroidUtilities.m1081dp(48.0f) * interpolation);
                    }
                }
                if (ActionBarLayout.this.animationProgress < 1.0f) {
                    ActionBarLayout.this.startLayoutAnimation(z, false, z);
                } else {
                    ActionBarLayout.this.onAnimationEndCheck(false);
                }
            }
        };
        this.animationRunnable = runnableC28103;
        AndroidUtilities.runOnUIThread(runnableC28103);
    }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class RunnableC28103 implements Runnable {
        final /* synthetic */ boolean val$first;
        final /* synthetic */ boolean val$open;
        final /* synthetic */ boolean val$preview;
    ...
    /* JADX WARN: Removed duplicated region for block: B:963:0x0210  */
    ...
    */
    public boolean presentFragment(org.telegram.ui.ActionBar.INavigationLayout.NavigationParams r22) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.ActionBar.ActionBarLayout.presentFragment(org.telegram.ui.ActionBar.INavigationLayout$NavigationParams):boolean");
    }

    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.ActionBarLayout$4 */
    /* JADX INFO: loaded from: classes6.dex */
    class C28114 extends ViewOutlineProvider {
        final /* synthetic */ boolean val$isSupportEdgeToEdge;
        ...
        public void getOutline(View view, Outline outline) {
            outline.setRoundRect(0, z ? 0 : AndroidUtilities.statusBarHeight, view.getMeasuredWidth(), view.getMeasuredHeight(), AndroidUtilities.m1081dp(6.0f));
        }
    }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C28125 extends AnimatorListenerAdapter {
        C28125() {
        }
    ...
    class RunnableC28136 implements Runnable {
        final /* synthetic */ BaseFragment val$currentFragment;
        final /* synthetic */ BaseFragment val$fragment;
        final /* synthetic */ boolean val$noDelay;
        final /* synthetic */ boolean val$preview;

        RunnableC28136(boolean z, BaseFragment baseFragment, BaseFragment baseFragment2, boolean z2) {
            z = z;
            baseFragment = baseFragment;
    ...
    class RunnableC28147 implements Runnable {
        final /* synthetic */ BaseFragment val$currentFragment;
        final /* synthetic */ BaseFragment val$fragment;
        final /* synthetic */ boolean val$preview;

        RunnableC28147(BaseFragment baseFragment, BaseFragment baseFragment2, boolean z) {
            baseFragment = baseFragment;
            baseFragment = baseFragment2;
            z = z;
        }
    ...
    class RunnableC28158 implements Runnable {
        final /* synthetic */ BaseFragment val$fragment;
        final /* synthetic */ boolean val$preview;

        RunnableC28158(BaseFragment baseFragment, boolean z) {
            baseFragment = baseFragment;
            z = z;
        }
    ...
    public void movePreviewFragment(float f) {
        if (this.inPreviewMode && this.previewMenu == null && !this.transitionAnimationPreviewMode) {
            ...
            if (f2 > 0.0f) {
                f2 = 0.0f;
            } else if (f2 < (-AndroidUtilities.m1081dp(60.0f))) {
    ...
    public void expandPreviewFragment() {
        ...
        try {
            ...
            animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.ActionBar.ActionBarLayout.9
                ...
                C28169(final BaseFragment baseFragment22) {
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C28169 extends AnimatorListenerAdapter {
        final /* synthetic */ BaseFragment val$fragment;
                ...
                if (z3) {
                    ...
                    if (animatorSetOnCustomTransitionAnimation == null) {
                        if (!this.inPreviewMode && (this.containerView.isKeyboardVisible || this.containerViewBack.isKeyboardVisible)) {
                            RunnableC280610 runnableC280610 = new Runnable() { // from class: org.telegram.ui.ActionBar.ActionBarLayout.10
                                RunnableC280610() {
                                }
                            ...
                            this.waitingForKeyboardCloseRunnable = runnableC280610;
                            AndroidUtilities.runOnUIThread(runnableC280610, 200L);
                        } else {
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class RunnableC280610 implements Runnable {
        RunnableC280610() {
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C280711 extends AnimatorListenerAdapter {
        C280711() {
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:138:0x0016  */
    /* JADX WARN: Removed duplicated region for block: B:142:0x002c  */
    @Override // org.telegram.p026ui.ActionBar.INavigationLayout
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void removeFragmentFromStack(org.telegram.p026ui.ActionBar.BaseFragment r4, boolean r5) {
        /*
            r3 = this;
        ...
        L7d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.ActionBar.ActionBarLayout.removeFragmentFromStack(org.telegram.ui.ActionBar.BaseFragment, boolean):void");
    }
    ...
    public /* synthetic */ void lambda$animateThemedValues$15(int i, INavigationLayout.ThemeAnimationSettings themeAnimationSettings, Runnable runnable) {
        ...
        if (z) {
            ...
            animatorSet.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.ActionBar.ActionBarLayout.12
                ...
                C280812(INavigationLayout.ThemeAnimationSettings themeAnimationSettings2) {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.ActionBarLayout$12 */
    /* JADX INFO: loaded from: classes6.dex */
    class C280812 extends AnimatorListenerAdapter {
        final /* synthetic */ INavigationLayout.ThemeAnimationSettings val$settings;
    ...
    public /* synthetic */ void lambda$new$17() {
        if (this.attached && getLastFragment() != null && this.containerView.getChildCount() == 0) {
            if (BuildVars.DEBUG_VERSION) {
                FileLog.m1093e(new RuntimeException(TextUtils.join(", ", this.lastActions)));
            }
    ...
    /* JADX WARN: Removed duplicated region for block: B:182:0x001d  */
    /* JADX WARN: Removed duplicated region for block: B:193:0x0045 A[PHI: r0
 ...
 binds: [B:183:0x001e, B:185:0x0024, B:187:0x002e, B:191:0x0042] A[DONT_GENERATE, DONT_INLINE]] */
    @Override // android.view.ViewGroup, android.view.View
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public boolean dispatchTouchEvent(android.view.MotionEvent r6) {
        /*
            ...
            if (r2 == 0) goto L1d
            android.view.View r2 = r0.mo5374getWindowView()
            if (r2 != 0) goto L1e
        L1d:
            r0 = r1
        L1e:
        ...
        L63:
            r5.tabsEvents = r3
        L65:
            android.view.View r0 = r1.mo5374getWindowView()
        ...
        L7c:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.ActionBar.ActionBarLayout.dispatchTouchEvent(android.view.MotionEvent):boolean");
    }
