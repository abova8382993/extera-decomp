...
public class BottomSheetTabsOverlay extends View {
    ...
    public interface Sheet {
        ...
        /* JADX INFO: renamed from: org.telegram.ui.ActionBar.BottomSheetTabsOverlay$Sheet$-CC */
        /* JADX INFO: loaded from: classes6.dex */
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (tabPreview != null) {
                ...
                boolean zContains = this.pressTab.tabDrawable.closeRipple.getBounds().contains((int) (motionEvent.getX() - this.pressTab.clickBounds.left), (int) ((motionEvent.getY() - this.pressTab.clickBounds.top) - AndroidUtilities.m1081dp(24.0f)));
            ...
            if (tabPreview2 != null) {
                if (tabPreview2.isPressed()) {
                    ...
                    if (this.pressTabClose) {
                        boolean zContains2 = this.pressTab.tabDrawable.closeRipple.getBounds().contains((int) (motionEvent.getX() - this.pressTab.clickBounds.left), (int) ((motionEvent.getY() - this.pressTab.clickBounds.top) - AndroidUtilities.m1081dp(24.0f)));
                ...
                if (!this.pressTab.isPressed()) {
                    if (this.horizontallySwiping) {
                        this.pressTab.dismissProgress = (motionEvent.getX() - this.startX) / AndroidUtilities.m1081dp(300.0f);
            ...
            if (tabPreview3 != null) {
                ...
                this.pressTab.setPressed(false);
                if (this.pressTabClose) {
                    this.pressTabClose = this.pressTab.tabDrawable.closeRipple.getBounds().contains((int) (motionEvent.getX() - this.pressTab.clickBounds.left), (int) ((motionEvent.getY() - this.pressTab.clickBounds.top) - AndroidUtilities.m1081dp(24.0f)));
                }
                if (this.pressTabClose) {
    ...
    private float getScrollStep() {
        return AndroidUtilities.m1081dp(200.0f);
    }
    ...
    public boolean dismissSheet(final Sheet sheet) {
        ...
        this.animator.addListener(new C28812(webTabDataSaveState, sheet));
    ...
    public static /* synthetic */ void $r8$lambda$hXGnNPWO7I1wkl5xjJT0SgMoWSw(Sheet sheet) {
        if (sheet == null || sheet.mo5374getWindowView() == null) {
            return;
        }
        sheet.mo5374getWindowView().setDrawingFromOverlay(true);
    }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C28812 extends AnimatorListenerAdapter {
        final /* synthetic */ Sheet val$sheet;
        final /* synthetic */ BottomSheetTabs.WebTabData val$tab;

        C28812(BottomSheetTabs.WebTabData webTabData, Sheet sheet) {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            if (view != null && webTabData.previewBitmap == null && (i = webTabData.viewWidth) > 0 && (i2 = webTabData.viewHeight) > 0) {
                if (Build.VERSION.SDK_INT >= 26) {
                    ...
                    BottomSheetTabsOverlay.renderHardwareViewToBitmap(view, f, new Utilities.Callback() { // from class: org.telegram.ui.ActionBar.BottomSheetTabsOverlay$2$$ExternalSyntheticLambda0
                        @Override // org.telegram.messenger.Utilities.Callback
                        public final void run(Object obj) {
                            BottomSheetTabsOverlay.C28812.$r8$lambda$GCfik7AYPJcOu1GrqTlmVf7Z84w(webTabData, sheet, (Bitmap) obj);
                        }
                    });
            ...
            this.val$sheet.mo5374getWindowView().setDrawingFromOverlay(false);
        ...
        public static /* synthetic */ void $r8$lambda$GCfik7AYPJcOu1GrqTlmVf7Z84w(BottomSheetTabs.WebTabData webTabData, Sheet sheet, Bitmap bitmap) {
            ...
            sheet.mo5374getWindowView().setDrawingFromOverlay(false);
            sheet.release();
        }
    }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.BottomSheetTabsOverlay$3 */
    /* JADX INFO: loaded from: classes6.dex */
    class C28823 extends AnimatorListenerAdapter {
        C28823() {
        }
    ...
    private void drawDismissingTab(Canvas canvas) {
        if (this.dismissingSheet != null) {
            ...
            SheetView sheetViewMo5374getWindowView = this.dismissingSheet.mo5374getWindowView();
            RectF rectF2 = this.rect;
            float f = this.dismissProgress;
            float fDrawInto = sheetViewMo5374getWindowView.drawInto(canvas, rectF2, f, this.clipRect, f, false);
            if (this.dismissingTab != null) {
                this.clipPath.rewind();
                this.clipPath.addRoundRect(this.clipRect, fDrawInto, fDrawInto, Path.Direction.CW);
                canvas.save();
                canvas.clipPath(this.clipPath);
                float fM1081dp = this.clipRect.top - (AndroidUtilities.m1081dp(50.0f) * (1.0f - this.dismissProgress));
                RectF rectF3 = this.rect;
                RectF rectF4 = this.clipRect;
                rectF3.set(rectF4.left, fM1081dp, rectF4.right, AndroidUtilities.m1081dp(50.0f) + fM1081dp);
    ...
    /* JADX WARN: Removed duplicated region for block: B:457:0x0260  */
    ...
    */
    private void drawTabsPreview(android.graphics.Canvas r42) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.ActionBar.BottomSheetTabsOverlay.drawTabsPreview(android.graphics.Canvas):void");
    }
    ...
    static class TabPreview {
        ...
        public void animateDismiss(float f) {
            ...
            this.dismissAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.ActionBar.BottomSheetTabsOverlay.TabPreview.1
                final /* synthetic */ float val$dismissTo;
        ...
        /* JADX INFO: renamed from: org.telegram.ui.ActionBar.BottomSheetTabsOverlay$TabPreview$1 */
        /* JADX INFO: loaded from: classes6.dex */
        class C28831 extends AnimatorListenerAdapter {
            final /* synthetic */ float val$dismissTo;
        ...
        public void draw(Canvas canvas, RectF rectF, boolean z, float f, float f2, float f3, float f4) {
            ...
            float currentActionBarHeight = ((AndroidUtilities.statusBarHeight + ActionBar.getCurrentActionBarHeight()) - AndroidUtilities.m1081dp(50.0f)) * f3;
            canvas.save();
            canvas.rotate(this.dismissProgress * 20.0f, rectF.centerX() + (AndroidUtilities.m1081dp(50.0f) * this.dismissProgress), rectF.bottom + AndroidUtilities.m1081dp(350.0f));
            float scale = this.bounce.getScale(0.01f);
            canvas.scale(scale, scale, rectF.centerX(), rectF.centerY());
            float fLerp2 = AndroidUtilities.lerp(AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(6.0f), f2);
            if (z) {
                this.shadowPaint.setColor(0);
                this.shadowPaint.setShadowLayer(AndroidUtilities.m1081dp(30.0f), 0.0f, AndroidUtilities.m1081dp(10.0f), Theme.multAlpha(536870912, fClamp * f2 * f7));
            ...
            this.shadowPaint.setColor(0);
            float f9 = fClamp * f2;
            this.shadowPaint.setShadowLayer(AndroidUtilities.m1081dp(30.0f), 0.0f, AndroidUtilities.m1081dp(10.0f), Theme.multAlpha(536870912, f9 * f7));
            ...
            canvas.drawRoundRect(rectF, fLerp2, fLerp2, this.backgroundPaint);
            canvas.save();
            canvas.translate(rectF.left, rectF.top + (AndroidUtilities.m1081dp(50.0f) * fLerp) + currentActionBarHeight);
            canvas.scale(1.0f, AndroidUtilities.lerp(1.0f, 1.25f, f8));
            BottomSheetTabs.WebTabData webTabData = this.tabData;
            if (webTabData != null && (obj = webTabData.previewNode) != null && Build.VERSION.SDK_INT >= 29 && BotFullscreenButtons$$ExternalSyntheticApiModelOutline1.m1087m(obj).hasDisplayList()) {
                RenderNode renderNodeM1087m = BotFullscreenButtons$$ExternalSyntheticApiModelOutline1.m1087m(this.tabData.previewNode);
                float fWidth = rectF.width() / renderNodeM1087m.getWidth();
                canvas.scale(fWidth, fWidth);
                renderNodeM1087m.setAlpha(f9);
                ...
                if (webTabData2 != null && webTabData2.previewBitmap != null) {
                    ...
                    rectF2.bottom = rectF2.top + Math.min(rectF.height(), AndroidUtilities.m1081dp(50.0f));
            ...
            rectF22.bottom = rectF22.top + Math.min(rectF.height(), AndroidUtilities.m1081dp(50.0f));
            this.tabBounds.offset(0.0f, f6);
            this.tabDrawable.setExpandProgress(f2);
            canvas.scale(1.0f, fLerp, this.tabBounds.centerX(), this.tabBounds.top);
            this.tabDrawable.draw(canvas, this.tabBounds, f5, fClamp * fClamp, f4);
    ...
    public static void renderHardwareViewToBitmap(View view, float f, final Utilities.Callback callback) {
        ...
        final SurfaceTexture surfaceTextureM1159m = BottomSheetTabsOverlay$$ExternalSyntheticApiModelOutline0.m1159m(false);
        surfaceTextureM1159m.setDefaultBufferSize(view.getWidth(), view.getHeight());
        final Surface surface = new Surface(surfaceTextureM1159m);
        ...
        PixelCopy.request(surface, bitmapCreateBitmap, new PixelCopy.OnPixelCopyFinishedListener() { // from class: org.telegram.ui.ActionBar.BottomSheetTabsOverlay$$ExternalSyntheticLambda8
            ...
            public final void onPixelCopyFinished(int i) {
                BottomSheetTabsOverlay.$r8$lambda$XU58vQduemRbiaLID3mmX5TDEEs(callback, bitmapCreateBitmap, surface, surfaceTextureM1159m, i);
            }
        }, new Handler());
    }
