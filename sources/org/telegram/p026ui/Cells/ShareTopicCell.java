...
public class ShareTopicCell extends FrameLayout {
    ...
    public ShareTopicCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        setBackground(Theme.createRadSelectorDrawable(Theme.getColor(Theme.key_listSelector), AndroidUtilities.m1081dp(2.0f), AndroidUtilities.m1081dp(2.0f)));
    }

    @Override // android.widget.FrameLayout, android.view.View
    protected void onMeasure(int i, int i2) {
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(103.0f), TLObject.FLAG_30));
    }
    ...
    public void setTopic(TLRPC.Dialog dialog, TLRPC.TL_forumTopic tL_forumTopic, boolean z, CharSequence charSequence) {
        ...
        if (ChatObject.isMonoForum(chat)) {
            ...
            if (DialogObject.isUserDialog(peerDialogId)) {
                ...
                this.imageView.setRoundRadius(AndroidUtilities.m1081dp(28.0f));
            } else {
        ...
        this.imageView.setRoundRadius((chat == null || !chat.forum || z) ? AndroidUtilities.m1081dp(28.0f) : AndroidUtilities.m1081dp(16.0f));
        this.currentDialog = dialog.f1616id;
        this.currentTopic = tL_forumTopic.f1670id;
    }
