...
public class GroupCreateSectionCell extends FrameLayout {
    ...
    public GroupCreateSectionCell(Context context) {
        ...
        Drawable drawable = getResources().getDrawable(C2702R.drawable.shadowdown);
    ...
    protected void onDraw(Canvas canvas) {
        this.drawable.setBounds(0, getMeasuredHeight() - AndroidUtilities.m1081dp(3.0f), getMeasuredWidth(), getMeasuredHeight());
