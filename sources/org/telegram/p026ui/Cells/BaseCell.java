...
public abstract class BaseCell extends ViewGroup implements SizeNotifierFrameLayout.IViewWithInvalidateCallback {
    ...
    private final class CheckForTap implements Runnable {
        /* synthetic */ CheckForTap(BaseCell baseCell, BaseCellIA baseCellIA) {
            this();
        }
    ...
    public void draw(Canvas canvas) {
        ...
        if (i >= 29) {
            if (z != (this.renderNode != null)) {
                if (z) {
                    RenderNode renderNodeM1086m = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1086m("basecell");
                    this.renderNode = renderNodeM1086m;
                    renderNodeM1086m.setClipToBounds(false);
    ...
    public static class RippleDrawableSafe extends RippleDrawable {
        ...
        public void draw(Canvas canvas) {
            ...
            try {
                ...
                FileLog.m1092e("probably forgot to put setCallback", e);
            } finally {
