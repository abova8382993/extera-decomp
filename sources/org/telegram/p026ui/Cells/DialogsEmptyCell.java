...
public class DialogsEmptyCell extends LinearLayout {
    ...
    public DialogsEmptyCell(final Context context) {
        ...
        setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.Cells.DialogsEmptyCell$$ExternalSyntheticLambda0
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return DialogsEmptyCell.m6119$r8$lambda$ugpKNg6fsNS82BgCbqgLNnBV0(view, motionEvent);
            }
        });
        ...
        this.subtitleView.setInAnimation(context, C2702R.anim.alpha_in);
        this.subtitleView.setOutAnimation(context, C2702R.anim.alpha_out);
    ...
    public static /* synthetic */ boolean m6119$r8$lambda$ugpKNg6fsNS82BgCbqgLNnBV0(View view, MotionEvent motionEvent) {
        return true;
    }
    ...
    public void setType(int i, boolean z) {
        ...
        this.currentType = i;
        if (i == 0 || i == 1) {
            i2 = C2702R.raw.utyan_newborn;
            string = LocaleController.getString(C2702R.string.NoChatsHelp);
            this.titleView.setText(LocaleController.getString(C2702R.string.NoChats));
        } else if (i == 2) {
            this.imageView.setAutoRepeat(false);
            i2 = C2702R.raw.filter_no_chats;
            if (z) {
                this.titleView.setText(LocaleController.getString(C2702R.string.FilterNoChatsToForward));
                string = LocaleController.getString(C2702R.string.FilterNoChatsToForwardInfo);
            } else {
                this.titleView.setText(LocaleController.getString(C2702R.string.FilterNoChatsToDisplay));
                string = LocaleController.getString(C2702R.string.FilterNoChatsToDisplayInfo);
            }
        } else {
            this.imageView.setAutoRepeat(true);
            i2 = C2702R.raw.filter_new;
            string = LocaleController.getString(C2702R.string.FilterAddingChatsInfo);
            this.titleView.setText(LocaleController.getString(C2702R.string.FilterAddingChats));
        }
        if (i2 != 0) {
            ...
            if (this.currentType == 1) {
                if (isUtyanAnimationTriggered()) {
                    ...
                    String string2 = LocaleController.getString(C2702R.string.NoChatsContactsHelp);
    ...
    public void startUtyanCollapseAnimation(boolean z) {
        ...
        if (z) {
            String string = LocaleController.getString(C2702R.string.NoChatsContactsHelp);
            if (AndroidUtilities.isTablet() && !AndroidUtilities.isSmallTablet()) {
                string = string.replace('\n', ' ');
            }
    ...
    private int measureUtyanHeight(int i) {
        ...
        return (int) (size + ((AndroidUtilities.m1081dp(320.0f) - size) * this.utyanCollapseProgress));
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (i3 == 2 || i3 == 3) {
            ...
            if (!arrayList.isEmpty()) {
                size -= (((AndroidUtilities.m1081dp(72.0f) * arrayList.size()) + arrayList.size()) - 1) + AndroidUtilities.m1081dp(50.0f);
            }
