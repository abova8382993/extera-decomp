...
public class NotificationsCheckCell extends FrameLayout {
    ...
    public NotificationsCheckCell(Context context, int i, int i2, int i3, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.valueTextView.setTextSize(AndroidUtilities.m1081dp(13.0f));
        ...
        Switch r3 = new Switch(context, resourcesProvider) { // from class: org.telegram.ui.Cells.NotificationsCheckCell.1
            @Override // org.telegram.p026ui.Components.Switch
    ...
    protected void onMeasure(int i, int i2) {
        if (this.isMultiline) {
            ...
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(this.currentHeight), TLObject.FLAG_30));
        }
    }
    ...
    public void setMultiline(boolean z) {
        ...
        if (z) {
            ...
            this.multilineValueTextView.setPadding(0, 0, 0, AndroidUtilities.m1081dp(8.0f));
        } else {
            this.multilineValueTextView.setVisibility(8);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.needDivider) {
            if (LocaleController.isRTL) {
                ...
                fM1081dp = AndroidUtilities.m1081dp(this.imageView != null ? this.textOffset - AndroidUtilities.m1081dp(2.0f) : 20.0f);
            }
            float f = fM1081dp;
            float measuredHeight = getMeasuredHeight() - 1;
            int measuredWidth = getMeasuredWidth();
            if (LocaleController.isRTL) {
                iM1081dp = AndroidUtilities.m1081dp(this.imageView != null ? this.textOffset - AndroidUtilities.m1081dp(2.0f) : 20.0f);
            } else {
                iM1081dp = 0;
            }
        ...
        if (this.drawLine) {
            int iM1081dp2 = LocaleController.isRTL ? AndroidUtilities.m1081dp(76.0f) : (getMeasuredWidth() - AndroidUtilities.m1081dp(76.0f)) - 1;
            canvas.drawRect(iM1081dp2, (getMeasuredHeight() - AndroidUtilities.m1081dp(22.0f)) / 2, iM1081dp2 + 2, r2 + AndroidUtilities.m1081dp(22.0f), Theme.dividerPaint);
        }
    }
