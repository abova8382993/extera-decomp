...
public class UnconfirmedAuthHintCell extends FrameLayout {
    ...
    public static /* synthetic */ void m6323$r8$lambda$BxLL04nNHETLUQ16lksruDUVQc(ArrayList arrayList) {
    }
    ...
    public UnconfirmedAuthHintCell(Context context) {
        ...
        textView.setText(LocaleController.getString(C2702R.string.UnconfirmedAuthTitle));
        ...
        textViewWithLoading.setPadding(AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(5.0f), AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(7.0f));
        textViewWithLoading.setTypeface(AndroidUtilities.bold());
        textViewWithLoading.setTextSize(1, 14.22f);
        textViewWithLoading.setText(LocaleController.getString(C2702R.string.UnconfirmedAuthConfirm));
        ...
        textViewWithLoading2.setPadding(AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(5.0f), AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(7.0f));
        textViewWithLoading2.setTypeface(AndroidUtilities.bold());
        textViewWithLoading2.setTextSize(1, 14.22f);
        textViewWithLoading2.setText(LocaleController.getString(C2702R.string.UnconfirmedAuthDeny));
    ...
    public void set(final BaseFragment baseFragment, final int i) {
        ...
        this.titleTextView.setText(LocaleController.getString(C2702R.string.UnconfirmedAuthTitle));
        this.yesButton.setText(LocaleController.getString(C2702R.string.UnconfirmedAuthConfirm));
        this.yesButton.setLoading(false, false);
        this.noButton.setText(LocaleController.getString(C2702R.string.UnconfirmedAuthDeny));
        this.noButton.setLoading(false, false);
        if (arrayList != null && arrayList.size() == 1) {
            String str = _UrlKt.FRAGMENT_ENCODE_SET + arrayList.get(0).device;
            if (!TextUtils.isEmpty(arrayList.get(0).location) && !str.isEmpty()) {
                str = str + ", ";
            }
            this.messageTextView.setText(LocaleController.formatString(C2702R.string.UnconfirmedAuthSingle, str + arrayList.get(0).location));
    ...
    public static /* synthetic */ void $r8$lambda$VsgCjKaKq9oLljJk7R6BjSxv6QY(final BaseFragment baseFragment, int i, ArrayList arrayList, View view) {
        String string = LocaleController.getString(C2702R.string.UnconfirmedAuthConfirmedMessage);
        ...
        coloredImageSpan.setWidth(AndroidUtilities.m1081dp(12.0f));
        spannableString.setSpan(coloredImageSpan, 0, spannableString.length(), 33);
        AndroidUtilities.replaceCharSequence(">", spannableStringBuilderReplaceSingleTag, spannableString);
        BulletinFactory.m1195of(baseFragment).createSimpleBulletin(C2702R.raw.contact_check, LocaleController.getString(C2702R.string.UnconfirmedAuthConfirmed), spannableStringBuilderReplaceSingleTag).show();
        MessagesController.getInstance(i).getUnconfirmedAuthController().confirm(arrayList, new Utilities.Callback() { // from class: org.telegram.ui.Cells.UnconfirmedAuthHintCell$$ExternalSyntheticLambda3
            ...
            public final void run(Object obj) {
                UnconfirmedAuthHintCell.m6323$r8$lambda$BxLL04nNHETLUQ16lksruDUVQc((ArrayList) obj);
            }
        });
    ...
    public void updateColors() {
        ...
        this.yesButton.setBackground(Theme.createSelectorDrawable(Theme.multAlpha(Theme.getColor(i), Theme.isCurrentThemeDark() ? 0.3f : 0.15f), 7, AndroidUtilities.m1081dp(8.0f)));
        ...
        this.noButton.setBackground(Theme.createSelectorDrawable(Theme.multAlpha(Theme.getColor(i2), Theme.isCurrentThemeDark() ? 0.3f : 0.15f), 7, AndroidUtilities.m1081dp(8.0f)));
    }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (f > 0.0f) {
                if (f < 1.0f) {
                    ...
                    canvas2.translate(0.0f, AndroidUtilities.m1081dp(-12.0f) * f);
                ...
                if (this.progressDrawable == null) {
                    CircularProgressDrawable circularProgressDrawable = new CircularProgressDrawable(AndroidUtilities.m1081dp(16.0f), AndroidUtilities.m1081dp(2.0f), getCurrentTextColor());
                ...
                float f3 = 1.0f - f;
                this.progressDrawable.setBounds(getWidth() / 2, (getHeight() / 2) + ((int) (AndroidUtilities.m1081dp(12.0f) * f3)), getWidth() / 2, (getHeight() / 2) + ((int) (f3 * AndroidUtilities.m1081dp(12.0f))));
    ...
    public void showLoginPreventedSheet(ArrayList arrayList) {
        if (arrayList == null || arrayList.size() == 0) {
            BulletinFactory.m1194of(Bulletin.BulletinWindow.make(getContext()), null).createErrorBulletin(LocaleController.getString(C2702R.string.UnknownError)).show();
            return;
        }
        ...
        rLottieImageView.setAnimation(C2702R.raw.ic_ban, 50, 50);
        rLottieImageView.playAnimation();
        rLottieImageView.setScaleType(ImageView.ScaleType.CENTER);
        rLottieImageView.setBackground(Theme.createCircleDrawable(AndroidUtilities.m1081dp(80.0f), Theme.getColor(Theme.key_windowBackgroundWhiteValueText)));
        ...
        textView2.setGravity(17);
        if (arrayList.size() == 1) {
            textView2.setText(LocaleController.formatString(C2702R.string.UnconfirmedAuthDeniedMessageSingle, from((UnconfirmedAuthController.UnconfirmedAuth) arrayList.get(0))));
        } else {
            String str = "\n";
            for (int i = 0; i < Math.min(arrayList.size(), 10); i++) {
                str = str + "• " + from((UnconfirmedAuthController.UnconfirmedAuth) arrayList.get(i)) + "\n";
            }
            textView2.setText(LocaleController.formatString(C2702R.string.UnconfirmedAuthDeniedMessageMultiple, str));
        }
        textView2.setTextColor(Theme.getColor(Theme.key_dialogTextBlack));
        linearLayout.addView(textView2, LayoutHelper.createLinear(-1, -2, 40.0f, 9.0f, 40.0f, 0.0f));
        FrameLayout frameLayout = new FrameLayout(getContext());
        frameLayout.setPadding(AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(10.0f));
        int iM1081dp = AndroidUtilities.m1081dp(8.0f);
        int i2 = Theme.key_text_RedBold;
        frameLayout.setBackground(Theme.createRoundRectDrawable(iM1081dp, Theme.multAlpha(Theme.getColor(i2), Theme.isCurrentThemeDark() ? 0.2f : 0.15f)));
        TextView textView3 = new TextView(getContext());
        textView3.setTypeface(AndroidUtilities.bold());
        textView3.setTextSize(1, 14.0f);
        textView3.setGravity(17);
        textView3.setTextColor(Theme.getColor(i2));
        textView3.setText(LocaleController.getString(C2702R.string.UnconfirmedAuthDeniedWarning));
        ...
        buttonWithCounterView.setText(LocaleController.getString(C2702R.string.GotIt), false);
        ...
        buttonWithCounterView.setTimer(5, new Runnable() { // from class: org.telegram.ui.Cells.UnconfirmedAuthHintCell$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                UnconfirmedAuthHintCell.m6325$r8$lambda$sjRWXBHKvFpazvxwtiyIFnxmFs(bottomSheetShow);
            }
        });
        buttonWithCounterView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Cells.UnconfirmedAuthHintCell$$ExternalSyntheticLambda6
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                UnconfirmedAuthHintCell.m6324$r8$lambda$FmPsg7Mq8dur9rHWnNTbvXVYpo(buttonWithCounterView, bottomSheetShow, view);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$sjRWXBHKvFpazvxwtiyIF-nxmFs, reason: not valid java name */
    public static /* synthetic */ void m6325$r8$lambda$sjRWXBHKvFpazvxwtiyIFnxmFs(BottomSheet bottomSheet) {
    ...
    public static /* synthetic */ void m6324$r8$lambda$FmPsg7Mq8dur9rHWnNTbvXVYpo(ButtonWithCounterView buttonWithCounterView, BottomSheet bottomSheet, View view) {
    ...
    private static String from(UnconfirmedAuthController.UnconfirmedAuth unconfirmedAuth) {
        ...
        String str = _UrlKt.FRAGMENT_ENCODE_SET + unconfirmedAuth.device;
