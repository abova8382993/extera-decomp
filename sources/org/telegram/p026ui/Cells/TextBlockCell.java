...
public class TextBlockCell extends FrameLayout {
    ...
    protected void onDraw(Canvas canvas) {
        if (this.needDivider) {
            canvas.drawLine(LocaleController.isRTL ? 0.0f : AndroidUtilities.m1081dp(19.0f), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m1081dp(19.0f) : 0), getMeasuredHeight() - 1, Theme.dividerPaint);
        }
    }
}
