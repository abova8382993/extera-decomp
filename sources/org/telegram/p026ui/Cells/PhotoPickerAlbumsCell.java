...
public class PhotoPickerAlbumsCell extends FrameLayout {
    ...
    private class AlbumView extends FrameLayout {
        ...
        public AlbumView(Context context) {
            ...
            linearLayout.setBackgroundResource(C2702R.drawable.album_shadow);
    ...
    public void setAlbum(int i, MediaController.AlbumEntry albumEntry) {
        ...
        if (albumEntry != null) {
            ...
            albumView.countTextView.setText(String.format(TimeModel.NUMBER_FORMAT, Integer.valueOf(albumEntry.photos.size())));
            return;
        }
        this.albumViews[i].setVisibility(4);
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (AndroidUtilities.isTablet()) {
            iM1081dp = ((AndroidUtilities.m1081dp(490.0f) - AndroidUtilities.m1081dp(12.0f)) - ((this.albumsCount - 1) * AndroidUtilities.m1081dp(4.0f))) / this.albumsCount;
        } else {
            iM1081dp = ((AndroidUtilities.displaySize.x - AndroidUtilities.m1081dp(12.0f)) - ((this.albumsCount - 1) * AndroidUtilities.m1081dp(4.0f))) / this.albumsCount;
        }
        for (int i3 = 0; i3 < this.albumsCount; i3++) {
            ...
            layoutParams.topMargin = AndroidUtilities.m1081dp(4.0f);
            layoutParams.leftMargin = (AndroidUtilities.m1081dp(4.0f) + iM1081dp) * i3;
            layoutParams.width = iM1081dp;
            layoutParams.height = iM1081dp;
            layoutParams.gravity = 51;
            this.albumViews[i3].setLayoutParams(layoutParams);
        }
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(4.0f) + iM1081dp, TLObject.FLAG_30));
    }
}
