...
public class MemberRequestCell extends FrameLayout {
    ...
    public MemberRequestCell(Context context, final OnClickListener onClickListener, boolean z) {
        ...
        int iM1081dp = AndroidUtilities.m1081dp(17.0f);
        ...
        textView.setPadding(iM1081dp, 0, iM1081dp, 0);
        textView.setText(LocaleController.getString(z ? C2702R.string.AddToChannel : C2702R.string.AddToGroup));
        ...
        float fMeasureText = textView.getPaint().measureText(textView.getText().toString()) + (iM1081dp * 2);
        TextView textView2 = new TextView(getContext());
        textView2.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1081dp(4.0f), 0, Theme.getColor(Theme.key_listSelector), -16777216));
        textView2.setGravity((LocaleController.isRTL ? 5 : 3) | 16);
        textView2.setMaxLines(1);
        textView2.setPadding(iM1081dp, 0, iM1081dp, 0);
        textView2.setText(LocaleController.getString(C2702R.string.Dismiss));
        ...
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(-2, AndroidUtilities.m1081dp(32.0f), LocaleController.isRTL ? 5 : 3);
        layoutParams.topMargin = AndroidUtilities.m1081dp(62.0f);
        layoutParams.leftMargin = LocaleController.isRTL ? 0 : (int) (AndroidUtilities.m1081dp(79.0f) + fMeasureText);
        layoutParams.rightMargin = LocaleController.isRTL ? (int) (fMeasureText + AndroidUtilities.m1081dp(79.0f)) : 0;
    ...
    public void setData(LongSparseArray longSparseArray, TLRPC.TL_chatInviteImporter tL_chatInviteImporter, boolean z) {
        ...
        if (tL_chatInviteImporter.via_chatlist) {
            this.statusTextView.setText(LocaleController.getString(C2702R.string.JoinedViaFolder));
            return;
        }
        long j = tL_chatInviteImporter.approved_by;
        if (j == 0) {
            this.statusTextView.setText(LocaleController.formatString("RequestedToJoinAt", C2702R.string.RequestedToJoinAt, dateAudio));
            return;
        }
        TLRPC.User user2 = (TLRPC.User) longSparseArray.get(j);
        if (user2 != null) {
            this.statusTextView.setText(LocaleController.formatString("AddedBy", C2702R.string.AddedBy, UserObject.getFirstName(user2), dateAudio));
        } else {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(107.0f), TLObject.FLAG_30));
    }
