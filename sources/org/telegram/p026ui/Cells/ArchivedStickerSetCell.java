...
import org.telegram.p026ui.Components.ViewHelper;
...
public class ArchivedStickerSetCell extends FrameLayout implements Checkable {
    ...
    public ArchivedStickerSetCell(Context context, boolean z) {
        ...
        if (z) {
            ...
            progressButton2.setMinWidth(iM1081dp);
            progressButton2.setMinimumWidth(iM1081dp);
            ...
            progressButton2.setText(LocaleController.getString(C2702R.string.StickersRemove));
        ...
        if (stickerSetCovered instanceof TLRPC.TL_stickerSetFullCovered) {
            ...
            while (true) {
                if (i < arrayList.size()) {
                    ...
                    if (document3 != null && document3.f1618id == j) {
                        document2 = document3;
                        break;
                    }
                    i++;
