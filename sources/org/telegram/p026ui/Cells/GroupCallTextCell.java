...
public abstract class GroupCallTextCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.valueTextView.measure(View.MeasureSpec.makeMeasureSpec(size - AndroidUtilities.m1081dp(this.leftPadding), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(20.0f), TLObject.FLAG_30));
        this.textView.measure(View.MeasureSpec.makeMeasureSpec((size - AndroidUtilities.m1081dp(this.leftPadding + 71)) - this.valueTextView.getTextWidth(), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(20.0f), TLObject.FLAG_30));
        ...
        setMeasuredDimension(size, AndroidUtilities.m1081dp(50.0f) + (this.needDivider ? 1 : 0));
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int iM1081dp2 = LocaleController.isRTL ? AndroidUtilities.m1081dp(this.leftPadding) : 0;
        SimpleTextView simpleTextView = this.valueTextView;
        simpleTextView.layout(iM1081dp2, textHeight, simpleTextView.getMeasuredWidth() + iM1081dp2, this.valueTextView.getMeasuredHeight() + textHeight);
        ...
        simpleTextView2.layout(iM1081dp, textHeight2, simpleTextView2.getMeasuredWidth() + iM1081dp, this.textView.getMeasuredHeight() + textHeight2);
        if (this.imageView.getVisibility() == 0) {
            int iM1081dp3 = AndroidUtilities.m1081dp(5.0f);
            int iM1081dp4 = !LocaleController.isRTL ? AndroidUtilities.m1081dp(this.imageLeft) : (i6 - this.imageView.getMeasuredWidth()) - AndroidUtilities.m1081dp(this.imageLeft);
        ...
        if (this.valueImageView.getVisibility() == 0) {
            ...
            int iM1081dp5 = LocaleController.isRTL ? AndroidUtilities.m1081dp(23.0f) : (i6 - this.valueImageView.getMeasuredWidth()) - AndroidUtilities.m1081dp(23.0f);
            ImageView imageView2 = this.valueImageView;
            imageView2.layout(iM1081dp5, measuredHeight, imageView2.getMeasuredWidth() + iM1081dp5, this.valueImageView.getMeasuredHeight() + measuredHeight);
        }
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.needDivider) {
            if (LocaleController.isRTL) {
                ...
                fM1081dp = AndroidUtilities.m1081dp(this.imageView.getVisibility() == 0 ? 68.0f : 20.0f);
            }
            float f = fM1081dp;
            float measuredHeight = getMeasuredHeight() - 1;
            int measuredWidth = getMeasuredWidth();
            if (LocaleController.isRTL) {
                iM1081dp = AndroidUtilities.m1081dp(this.imageView.getVisibility() == 0 ? 68.0f : 20.0f);
            } else {
                iM1081dp = 0;
            }
            canvas.drawLine(f, measuredHeight, measuredWidth - iM1081dp, getMeasuredHeight() - 1, this.dividerPaint);
        }
    }
