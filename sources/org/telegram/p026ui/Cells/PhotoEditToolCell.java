...
public class PhotoEditToolCell extends FrameLayout {
    ...
    class RunnableC32141 implements Runnable {
        RunnableC32141() {
        }
    ...
    public /* synthetic */ void lambda$setSeekBarDelegate$0(PhotoEditorSeekBar.PhotoEditorSeekBarDelegate photoEditorSeekBarDelegate, int i, int i2) {
        ...
        if (i2 > 0) {
            ...
            this.valueTextView.setText(_UrlKt.FRAGMENT_ENCODE_SET + i2);
        }
    ...
    class C32152 extends AnimatorListenerAdapter {
        C32152() {
        }
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(40.0f), TLObject.FLAG_30));
    }
    ...
    public void setIconAndTextAndValue(String str, float f, int i, int i2) {
        ...
        if (f > 0.0f) {
            ...
            this.valueTextView.setText(_UrlKt.FRAGMENT_ENCODE_SET + ((int) f));
        }
