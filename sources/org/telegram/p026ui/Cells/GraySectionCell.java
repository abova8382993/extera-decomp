...
public class GraySectionCell extends FrameLayout implements Theme.Colorable {
    ...
    public GraySectionCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        C31941 c31941 = new AnimatedTextView(getContext(), true, true, true) { // from class: org.telegram.ui.Cells.GraySectionCell.1
            C31941(Context context2, boolean z, boolean z2, boolean z3) {
        ...
        this.rightTextView = c31941;
        c31941.setPadding(AndroidUtilities.m1081dp(2.0f), 0, AndroidUtilities.m1081dp(2.0f), 0);
        this.rightTextView.setAnimationProperties(0.9f, 0L, 420L, CubicBezierInterpolator.EASE_OUT_QUINT);
        this.rightTextView.setTextSize(AndroidUtilities.m1081dp(14.0f));
    ...
    class C31941 extends AnimatedTextView {
        C31941(Context context2, boolean z, boolean z2, boolean z3) {
            super(context2, z, z2, z3);
        }
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(this.layerHeight), TLObject.FLAG_30));
    }
    ...
    public void setRightTextMargin(int i) {
        float f = i;
        this.rightTextViewLayoutParams.leftMargin = AndroidUtilities.m1081dp(f);
        this.rightTextViewLayoutParams.rightMargin = AndroidUtilities.m1081dp(f);
