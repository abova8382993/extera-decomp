...
public class DialogMeUrlCell extends BaseCell {
    ...
    public DialogMeUrlCell(Context context) {
        ...
        this.messageTop = AndroidUtilities.m1081dp(40.0f);
        this.avatarTop = AndroidUtilities.m1081dp(10.0f);
    ...
    protected void onMeasure(int i, int i2) {
        setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m1081dp(72.0f) + (this.useSeparator ? 1 : 0));
    }
    ...
    public void buildLayout() {
        ...
        if (recentMeUrl instanceof TLRPC.TL_recentMeUrlChat) {
            ...
            if (!LocaleController.isRTL) {
                this.nameLockLeft = AndroidUtilities.m1081dp(AndroidUtilities.leftBaseline);
                this.nameLeft = AndroidUtilities.m1081dp(AndroidUtilities.leftBaseline + 4);
            } else {
                this.nameLockLeft = getMeasuredWidth() - AndroidUtilities.m1081dp(AndroidUtilities.leftBaseline);
                this.nameLeft = AndroidUtilities.m1081dp(14.0f);
            }
            userName = chat.title;
            ...
            if (!LocaleController.isRTL) {
                this.nameLeft = AndroidUtilities.m1081dp(AndroidUtilities.leftBaseline);
            } else {
                this.nameLeft = AndroidUtilities.m1081dp(14.0f);
            }
            if (user != null) {
                if (user.bot) {
                    this.nameLockTop = AndroidUtilities.m1081dp(16.5f);
                    if (!LocaleController.isRTL) {
                        this.nameLockLeft = AndroidUtilities.m1081dp(AndroidUtilities.leftBaseline);
                        this.nameLeft = AndroidUtilities.m1081dp(AndroidUtilities.leftBaseline + 4);
                    } else {
        ...
        if (TextUtils.isEmpty(userName)) {
            userName = LocaleController.getString(C2702R.string.HiddenName);
        }
        if (!LocaleController.isRTL) {
            measuredWidth = getMeasuredWidth() - this.nameLeft;
            iM1081dp = AndroidUtilities.m1081dp(14.0f);
        } else {
            measuredWidth = getMeasuredWidth() - this.nameLeft;
            iM1081dp = AndroidUtilities.m1081dp(AndroidUtilities.leftBaseline);
        }
        int iM1081dp2 = measuredWidth - iM1081dp;
        if (this.drawNameLock) {
            iM1081dp2 -= AndroidUtilities.m1081dp(4.0f) + Theme.dialogs_lockDrawable.getIntrinsicWidth();
        }
        if (this.drawVerified) {
            int iM1081dp3 = AndroidUtilities.m1081dp(6.0f) + Theme.dialogs_verifiedDrawable.getIntrinsicWidth();
            iM1081dp2 -= iM1081dp3;
            if (LocaleController.isRTL) {
                this.nameLeft += iM1081dp3;
            }
        }
        int iMax = Math.max(AndroidUtilities.m1081dp(12.0f), iM1081dp2);
        try {
            StaticLayout staticLayout = new StaticLayout(TextUtils.ellipsize(userName.replace('\n', ' '), textPaint, iMax - AndroidUtilities.m1081dp(12.0f), TextUtils.TruncateAt.END), textPaint, iMax, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            i = iMax;
            try {
        ...
        int measuredWidth3 = getMeasuredWidth() - AndroidUtilities.m1081dp(AndroidUtilities.leftBaseline + 16);
        if (!LocaleController.isRTL) {
            this.messageLeft = AndroidUtilities.m1081dp(AndroidUtilities.leftBaseline);
            measuredWidth2 = AndroidUtilities.m1081dp(AndroidUtilities.isTablet() ? 13.0f : 9.0f);
        } else {
            this.messageLeft = AndroidUtilities.m1081dp(16.0f);
            measuredWidth2 = getMeasuredWidth() - AndroidUtilities.m1081dp(AndroidUtilities.isTablet() ? 65.0f : 61.0f);
        }
        this.avatarImage.setImageCoords(measuredWidth2, this.avatarTop, AndroidUtilities.m1081dp(52.0f), AndroidUtilities.m1081dp(52.0f));
        int iMax2 = Math.max(AndroidUtilities.m1081dp(12.0f), measuredWidth3);
        try {
            this.messageLayout = new StaticLayout(TextUtils.ellipsize(str3, textPaint2, iMax2 - AndroidUtilities.m1081dp(12.0f), TextUtils.TruncateAt.END), textPaint2, iMax2, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        } catch (Exception e3) {
            FileLog.m1093e(e3);
        }
        if (LocaleController.isRTL) {
            ...
            if (staticLayout2 != null && staticLayout2.getLineCount() > 0) {
                ...
                if (this.drawVerified) {
                    this.nameMuteLeft = (int) (((((double) this.nameLeft) + (((double) i) - dCeil)) - ((double) AndroidUtilities.m1081dp(6.0f))) - ((double) Theme.dialogs_verifiedDrawable.getIntrinsicWidth()));
                }
                if (lineLeft == 0.0f) {
                    double d = i;
                    if (dCeil < d) {
        ...
        if (staticLayout4 != null && staticLayout4.getLineCount() > 0) {
            ...
            if (this.drawVerified) {
                this.nameMuteLeft = (int) (this.nameLeft + lineRight + AndroidUtilities.m1081dp(6.0f));
            }
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.nameLayout != null) {
            canvas2.save();
            canvas2.translate(this.nameLeft, AndroidUtilities.m1081dp(13.0f));
        ...
        if (this.drawVerified) {
            BaseCell.setDrawableBounds(Theme.dialogs_verifiedDrawable, this.nameMuteLeft, AndroidUtilities.m1081dp(16.5f));
            BaseCell.setDrawableBounds(Theme.dialogs_verifiedCheckDrawable, this.nameMuteLeft, AndroidUtilities.m1081dp(16.5f));
