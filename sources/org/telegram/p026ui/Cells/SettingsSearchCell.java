...
public class SettingsSearchCell extends FrameLayout {
    ...
    public void setTextAndValueAndIcon(CharSequence charSequence, String[] strArr, int i, boolean z) {
        ...
        layoutParams.leftMargin = AndroidUtilities.m1081dp(LocaleController.isRTL ? 16.0f : 71.0f);
        layoutParams.rightMargin = AndroidUtilities.m1081dp(LocaleController.isRTL ? 71.0f : 16.0f);
        if (strArr != null) {
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
            for (int i2 = 0; i2 < strArr.length; i2++) {
                if (i2 != 0) {
                    spannableStringBuilder.append((CharSequence) " > ");
                    Drawable drawableMutate = getContext().getResources().getDrawable(C2702R.drawable.settings_arrow).mutate();
            ...
            layoutParams2.leftMargin = AndroidUtilities.m1081dp(LocaleController.isRTL ? 16.0f : 71.0f);
            layoutParams2.rightMargin = AndroidUtilities.m1081dp(LocaleController.isRTL ? 71.0f : 16.0f);
        } else {
            layoutParams.topMargin = AndroidUtilities.m1081dp(21.0f);
    ...
    public void setTextAndValue(CharSequence charSequence, String[] strArr, boolean z, boolean z2) {
            ...
            if (strArr != null) {
                ...
                for (int i2 = 0; i2 < strArr.length; i2++) {
                    if (i2 != 0) {
                        ...
                        Drawable drawableMutate2 = getContext().getResources().getDrawable(C2702R.drawable.settings_arrow).mutate();
        ...
        layoutParams2.rightMargin = iM1081dp2;
        layoutParams2.leftMargin = iM1081dp2;
        this.imageView.setVisibility(8);
        this.needDivider = z2;
        setWillNotDraw(!z2);
        this.left = 16;
    ...
    protected void onDraw(Canvas canvas) {
        if (this.needDivider) {
            canvas.drawLine(LocaleController.isRTL ? 0.0f : AndroidUtilities.m1081dp(this.left), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m1081dp(this.left) : 0), getMeasuredHeight() - 1, Theme.dividerPaint);
        }
    }
    ...
    public static class Factory extends UItem.UItemFactory {
        ...
        public static UItem m1178of(CharSequence charSequence, ProfileActivity.SearchAdapter.SearchResult searchResult) {
        ...
        /* JADX INFO: renamed from: of */
        public static UItem m1177of(CharSequence charSequence, MessagesController.FaqSearchResult faqSearchResult) {
            UItem uItemOfFactory = UItem.ofFactory(Factory.class);
            uItemOfFactory.text = charSequence;
