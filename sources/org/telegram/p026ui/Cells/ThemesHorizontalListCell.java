...
import org.telegram.p026ui.ThemeSetUrlActivity;
...
public abstract class ThemesHorizontalListCell extends RecyclerListView implements NotificationCenter.NotificationCenterDelegate {
    ...
    class InnerThemeView extends FrameLayout {
        ...
        public InnerThemeView(Context context) {
            ...
            this.inDrawable = context.getResources().getDrawable(C2702R.drawable.minibubble_in).mutate();
            this.outDrawable = context.getResources().getDrawable(C2702R.drawable.minibubble_out).mutate();
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp((this.isLast ? 22 : 15) + 76 + (this.isFirst ? 22 : 0)), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(148.0f), TLObject.FLAG_30));
        }
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (action == 0 || action == 1) {
                ...
                if (x > this.rect.centerX() && y < this.rect.centerY() - AndroidUtilities.m1081dp(10.0f)) {
                    if (action == 0) {
                        this.pressed = true;
                    } else {
                        try {
        ...
        public void applyTheme() {
            ...
            if (this.themeInfo.pathToFile == null) {
                ...
                this.optionsDrawable = getResources().getDrawable(C2702R.drawable.preview_dots).mutate();
            ...
            if (i != 0 && themeInfo.previewBackgroundGradientColor2 != 0) {
                ...
                motionBackgroundDrawable.setRoundRadius(AndroidUtilities.m1081dp(6.0f));
                ...
                gradientDrawable.setCornerRadius(AndroidUtilities.m1081dp(6.0f));
                this.backgroundDrawable = gradientDrawable;
                dArrRgbToHsv = AndroidUtilities.rgbToHsv(Color.red(this.themeInfo.getPreviewBackgroundColor()), Color.green(this.themeInfo.getPreviewBackgroundColor()), Color.blue(this.themeInfo.getPreviewBackgroundColor()));
            } else if (themeInfo.previewWallpaperOffset > 0 || themeInfo.pathToWallpaper != null) {
                float fM1081dp = AndroidUtilities.m1081dp(76.0f);
                float fM1081dp2 = AndroidUtilities.m1081dp(97.0f);
                Theme.ThemeInfo themeInfo3 = this.themeInfo;
                Bitmap scaledBitmap = AndroidUtilities.getScaledBitmap(fM1081dp, fM1081dp2, themeInfo3.pathToWallpaper, themeInfo3.pathToFile, themeInfo3.previewWallpaperOffset);
            ...
            if (this.themeInfo.getPreviewBackgroundColor() == 0 && this.themeInfo.previewParsed && this.backgroundDrawable == null) {
                Drawable drawableCreateDefaultWallpaper = Theme.createDefaultWallpaper(100, DataTypes.EMPTY);
                ...
                if (drawableCreateDefaultWallpaper instanceof MotionBackgroundDrawable) {
                    ((MotionBackgroundDrawable) drawableCreateDefaultWallpaper).setRoundRadius(AndroidUtilities.m1081dp(6.0f));
                }
            }
            invalidate();
        }
        ...
        public void setTheme(Theme.ThemeInfo themeInfo, boolean z, boolean z2) {
            ...
            layoutParams.leftMargin = AndroidUtilities.m1081dp(this.isFirst ? 49.0f : 27.0f);
            ...
            if (themeInfo3.pathToFile != null && !themeInfo3.previewParsed) {
                ...
                if ((!zExists || !parseTheme() || !zExists) && (tL_theme = (themeInfo2 = this.themeInfo).info) != null) {
                    if (tL_theme.document != null) {
                        ...
                        Drawable drawableMutate = getResources().getDrawable(C2702R.drawable.msg_theme).mutate();
                        ...
                        Drawable drawableMutate2 = getResources().getDrawable(C2702R.drawable.preview_custom).mutate();
        ...
        protected void onDraw(Canvas canvas) {
            ...
            int iM1081dp = this.isFirst ? AndroidUtilities.m1081dp(22.0f) : 0;
            float f = iM1081dp;
            float fM1081dp = AndroidUtilities.m1081dp(11.0f);
            this.rect.set(f, fM1081dp, AndroidUtilities.m1081dp(76.0f) + iM1081dp, r3 + AndroidUtilities.m1081dp(97.0f));
            String string = TextUtils.ellipsize(getThemeName(), this.textPaint, (getMeasuredWidth() - AndroidUtilities.m1081dp(this.isFirst ? 10.0f : 15.0f)) - (this.isLast ? AndroidUtilities.m1081dp(7.0f) : 0), TextUtils.TruncateAt.END).toString();
            ...
            canvas.drawText(string, ((AndroidUtilities.m1081dp(76.0f) - iCeil) / 2) + iM1081dp, AndroidUtilities.m1081dp(131.0f), this.textPaint);
            Theme.ThemeInfo themeInfo = this.themeInfo;
            ...
            if (tL_theme == null || (tL_theme.document != null && themeInfo.themeLoaded)) {
                ...
                if (drawable2 != null) {
                    if (this.bitmapShader != null) {
                        ...
                        if (f2 > this.rect.width()) {
                            this.shaderMatrix.setTranslate(f - ((f2 - this.rect.width()) / 2.0f), fM1081dp);
                        } else {
                            this.shaderMatrix.setTranslate(f, fM1081dp - (((height / fWidth) - this.rect.height()) / 2.0f));
                        }
                        this.shaderMatrix.preScale(fMin, fMin);
                        this.bitmapShader.setLocalMatrix(this.shaderMatrix);
                        canvas.drawRoundRect(this.rect, AndroidUtilities.m1081dp(6.0f), AndroidUtilities.m1081dp(6.0f), this.bitmapPaint);
                    } else {
                    ...
                    canvas.drawRoundRect(this.rect, AndroidUtilities.m1081dp(6.0f), AndroidUtilities.m1081dp(6.0f), this.paint);
                }
                ...
                if (themeInfo2.accentBaseColor != 0) {
                    if ("Day".equals(themeInfo2.name) || "Arctic Blue".equals(this.themeInfo.name)) {
                        ...
                        canvas.drawRoundRect(this.rect, AndroidUtilities.m1081dp(6.0f), AndroidUtilities.m1081dp(6.0f), Theme.chat_instantViewRectPaint);
                    }
                ...
                this.inDrawable.setBounds(AndroidUtilities.m1081dp(6.0f) + iM1081dp, AndroidUtilities.m1081dp(22.0f), AndroidUtilities.m1081dp(49.0f) + iM1081dp, AndroidUtilities.m1081dp(36.0f));
                this.inDrawable.draw(canvas);
                this.outDrawable.setBounds(AndroidUtilities.m1081dp(27.0f) + iM1081dp, AndroidUtilities.m1081dp(41.0f), iM1081dp + AndroidUtilities.m1081dp(70.0f), AndroidUtilities.m1081dp(55.0f));
                this.outDrawable.draw(canvas);
                if (this.optionsDrawable != null && ThemesHorizontalListCell.this.currentType == 0) {
                    int iM1081dp2 = ((int) this.rect.right) - AndroidUtilities.m1081dp(16.0f);
                    int iM1081dp3 = ((int) this.rect.top) + AndroidUtilities.m1081dp(6.0f);
                    Drawable drawable3 = this.optionsDrawable;
                    drawable3.setBounds(iM1081dp2, iM1081dp3, drawable3.getIntrinsicWidth() + iM1081dp2, this.optionsDrawable.getIntrinsicHeight() + iM1081dp3);
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(32, LocaleController.getString(C2702R.string.AccDescrMoreOptions)));
        }
    }
    ...
    class C32731 extends LinearLayoutManager {
        @Override // androidx.recyclerview.widget.LinearLayoutManager, androidx.recyclerview.widget.RecyclerView.LayoutManager
        public boolean supportsPredictiveItemAnimations() {
            return false;
        }
    ...
    public /* synthetic */ void lambda$new$0(View view, int i) {
        ...
        if (left < 0) {
            smoothScrollBy(left - AndroidUtilities.m1081dp(8.0f), 0);
    ...
    public void scrollToCurrentTheme(int i, boolean z) {
        ...
        if (iIndexOf >= 0 || (iIndexOf = this.customThemes.indexOf(this.prevThemeInfo) + this.defaultThemes.size()) >= 0) {
            if (z) {
                ...
                this.horizontalLayoutManager.scrollToPositionWithOffset(iIndexOf, (i - AndroidUtilities.m1081dp(76.0f)) / 2);
            }
        }
    }
}
