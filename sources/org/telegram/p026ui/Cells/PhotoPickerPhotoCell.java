...
public class PhotoPickerPhotoCell extends FrameLayout {
    ...
    public PhotoPickerPhotoCell(Context context) {
        ...
        this.videoInfoContainer.setPadding(AndroidUtilities.m1081dp(3.0f), 0, AndroidUtilities.m1081dp(3.0f), 0);
        addView(this.videoInfoContainer, LayoutHelper.createFrame(-1, 16, 83));
        ImageView imageView = new ImageView(context);
        imageView.setImageResource(C2702R.drawable.ic_video);
    ...
    public void setImage(MediaController.PhotoEntry photoEntry) {
        Drawable drawable = getResources().getDrawable(C2702R.drawable.nophotos);
        ...
        if (photoEntry.path != null) {
            ...
            if (photoEntry.isVideo) {
                ...
                setContentDescription(LocaleController.getString(C2702R.string.AttachVideo) + ", " + LocaleController.formatDuration(photoEntry.duration));
                this.imageView.setImage("vthumb://" + photoEntry.imageId + ":" + photoEntry.path, null, drawable);
                return;
            }
            this.videoInfoContainer.setVisibility(4);
            setContentDescription(LocaleController.getString(C2702R.string.AttachPhoto));
