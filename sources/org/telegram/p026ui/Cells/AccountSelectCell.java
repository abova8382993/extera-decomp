...
public class AccountSelectCell extends FrameLayout {
    ...
    public AccountSelectCell(Context context, boolean z) {
        ...
        if (z) {
            ...
            this.infoTextView.setMaxWidth(AndroidUtilities.m1081dp(320.0f));
        ...
        imageView.setImageResource(C2702R.drawable.account_check);
    ...
    private int width() {
        float fM1081dp = AndroidUtilities.m1081dp(196.0f);
        float fM1081dp2 = AndroidUtilities.m1081dp((this.checkImageView != null ? 50 : 0) + 69);
        float fMeasureText = this.textView.getTextPaint().measureText(this.textView.getText().toString());
        TextView textView = this.infoTextView;
        return (int) Math.max(fM1081dp, fM1081dp2 + Math.max(fMeasureText, textView != null ? textView.getPaint().measureText(this.infoTextView.getText().toString()) : 0.0f));
    }
    ...
    protected void onMeasure(int i, int i2) {
        if (this.checkImageView != null || (this.infoTextView != null && getLayoutParams().width != -2)) {
            ...
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(width(), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(56.0f), TLObject.FLAG_30));
        } else {
