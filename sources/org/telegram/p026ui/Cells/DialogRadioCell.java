...
public class DialogRadioCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int measuredWidth = ((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight()) - AndroidUtilities.m1081dp((this.valueTextView.getVisibility() == 0 ? 12 : 0) + 84);
        this.radioButton.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(22.0f), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(22.0f), TLObject.FLAG_30));
        if (this.valueTextView.getVisibility() == 0) {
            ...
            measuredWidth -= this.valueTextView.getMeasuredWidth() + AndroidUtilities.m1081dp(12.0f);
        }
