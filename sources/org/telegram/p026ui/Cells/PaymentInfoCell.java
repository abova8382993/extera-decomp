...
public class PaymentInfoCell extends FrameLayout {
    ...
    public PaymentInfoCell(Context context) {
        ...
        backupImageView.getImageReceiver().setRoundRadius(AndroidUtilities.m1081dp(8.0f));
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.imageView.getVisibility() != 8) {
            iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(120.0f), TLObject.FLAG_30);
            i3 = i;
        } else {
            int iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(0, 0);
            i3 = i;
            measureChildWithMargins(this.detailTextView, i3, 0, i2, 0);
            ((FrameLayout.LayoutParams) this.detailExTextView.getLayoutParams()).topMargin = AndroidUtilities.m1081dp(33.0f) + this.detailTextView.getMeasuredHeight() + AndroidUtilities.m1081dp(3.0f);
    ...
    public void setInfo(String str, String str2, TLRPC.WebDocument webDocument, String str3, Object obj) {
        ...
        float f = 640;
        float fM1081dp = f / (((int) (iMin * 0.7f)) - AndroidUtilities.m1081dp(2.0f));
        int i = (int) (f / fM1081dp);
        int i2 = (int) (360 / fM1081dp);
