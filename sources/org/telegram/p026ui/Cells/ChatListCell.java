...
public abstract class ChatListCell extends LinearLayout {
    ...
    private class ListView extends FrameLayout {
        ...
        public ListView(Context context, boolean z) {
            ...
            this.isThreeLines = z;
            setContentDescription(LocaleController.getString(z ? C2702R.string.ChatListExpanded : C2702R.string.ChatListDefault));
        ...
        protected void onDraw(Canvas canvas) {
            ...
            this.rect.set(AndroidUtilities.m1081dp(1.0f), AndroidUtilities.m1081dp(1.0f), getMeasuredWidth() - AndroidUtilities.m1081dp(1.0f), AndroidUtilities.m1081dp(73.0f));
            ...
            this.rect.set(0.0f, 0.0f, getMeasuredWidth(), AndroidUtilities.m1081dp(74.0f));
            Theme.dialogs_onlineCirclePaint.setColor(Color.argb((int) ((1.0f - this.button.getProgress()) * 31.0f), iRed, iGreen, iBlue));
            canvas.drawRoundRect(this.rect, AndroidUtilities.m1081dp(6.0f), AndroidUtilities.m1081dp(6.0f), Theme.dialogs_onlineCirclePaint);
            String string = LocaleController.getString(this.isThreeLines ? C2702R.string.ChatListExpanded : C2702R.string.ChatListDefault);
            ...
            int i = 2;
            canvas.drawText(string, measuredWidth / 2, AndroidUtilities.m1081dp(96.0f), this.textPaint);
            int i2 = 0;
            while (i2 < i) {
                int iM1081dp = AndroidUtilities.m1081dp(i2 == 0 ? 21.0f : 53.0f);
                Theme.dialogs_onlineCirclePaint.setColor(Color.argb(i2 == 0 ? 204 : 90, iRed, iGreen, iBlue));
                canvas.drawCircle(AndroidUtilities.m1081dp(22.0f), iM1081dp, AndroidUtilities.m1081dp(11.0f), Theme.dialogs_onlineCirclePaint);
                int i3 = 0;
                while (true) {
                    if (i3 < (this.isThreeLines ? 3 : i)) {
                        ...
                        if (this.isThreeLines) {
                            float f = i3 * 7;
                            this.rect.set(AndroidUtilities.m1081dp(41.0f), iM1081dp - AndroidUtilities.m1081dp(8.3f - f), getMeasuredWidth() - AndroidUtilities.m1081dp(i3 == 0 ? 72.0f : 48.0f), iM1081dp - AndroidUtilities.m1081dp(5.3f - f));
                            canvas.drawRoundRect(this.rect, AndroidUtilities.dpf2(1.5f), AndroidUtilities.dpf2(1.5f), Theme.dialogs_onlineCirclePaint);
                        } else {
                            int i4 = i3 * 10;
                            this.rect.set(AndroidUtilities.m1081dp(41.0f), iM1081dp - AndroidUtilities.m1081dp(7 - i4), getMeasuredWidth() - AndroidUtilities.m1081dp(i3 == 0 ? 72.0f : 48.0f), iM1081dp - AndroidUtilities.m1081dp(3 - i4));
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            accessibilityNodeInfo.setContentDescription(LocaleController.getString(this.isThreeLines ? C2702R.string.ChatListExpanded : C2702R.string.ChatListDefault));
        }
    }
    ...
    public ChatListCell(Context context) {
        ...
        setOrientation(0);
        setPadding(AndroidUtilities.m1081dp(21.0f), AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(21.0f), 0);
        int i = 0;
        while (true) {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(123.0f), TLObject.FLAG_30));
    }
}
