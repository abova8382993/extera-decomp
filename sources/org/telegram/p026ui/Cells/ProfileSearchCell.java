...
import org.telegram.p026ui.Components.PhotoBubbleClip;
...
public class ProfileSearchCell extends BaseCell implements NotificationCenter.NotificationCenterDelegate, Theme.Colorable {
    ...
    private TLRPC.TL_sponsoredPeer f1860ad;
    ...
    public ProfileSearchCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.countTop = AndroidUtilities.m1081dp(19.0f);
        ...
        AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable swapAnimatedEmojiDrawable = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(this, AndroidUtilities.m1081dp(20.0f));
        this.botVerificationDrawable = swapAnimatedEmojiDrawable;
        swapAnimatedEmojiDrawable.setCallback(this);
        AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable swapAnimatedEmojiDrawable2 = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(this, AndroidUtilities.m1081dp(20.0f));
    ...
    public void setData(Object obj, TLRPC.EncryptedChat encryptedChat, CharSequence charSequence, CharSequence charSequence2, boolean z, boolean z2) {
        ...
        if (obj instanceof TLRPC.User) {
            ...
            this.chat = null;
            this.contact = null;
            requirementToContactIsUserContactBlocked = this.showPremiumBlocked ? MessagesController.getInstance(this.currentAccount).isUserContactBlocked(this.user.f1775id) : null;
            ...
            if (this.showPremiumBlocked && contact.user != null) {
                requirementToContactIsUserContactBlocked = MessagesController.getInstance(this.currentAccount).isUserContactBlocked(this.contact.user.f1775id);
            }
            this.premiumBlocked = DialogObject.isPremiumBlocked(requirementToContactIsUserContactBlocked);
            this.starsPriceBlocked = DialogObject.getMessagesStarsPrice(requirementToContactIsUserContactBlocked);
            setOpenBotButton(false);
    ...
    public void setOpenBotButton(boolean z) {
        ...
        if (this.openButtonText == null) {
            this.openButtonText = new Text(LocaleController.getString(C2702R.string.BotOpen), 14.0f, AndroidUtilities.bold());
        }
        int currentWidth = z ? ((int) this.openButtonText.getCurrentWidth()) + AndroidUtilities.m1081dp(30.0f) : 0;
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (i == NotificationCenter.userIsPremiumBlockedUpadted) {
            ...
            if (this.user != null) {
                if (this.showPremiumBlocked) {
                    requirementToContactIsUserContactBlocked = MessagesController.getInstance(this.currentAccount).isUserContactBlocked(this.user.f1775id);
                }
            } else {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        setMeasuredDimension(View.MeasureSpec.getSize(i), this.callCellStyle ? AndroidUtilities.m1081dp(56.0f) : AndroidUtilities.m1081dp(60.0f) + (this.useSeparator ? 1 : 0));
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.checkBox != null) {
            int iM1081dp = LocaleController.isRTL ? (i3 - i) - AndroidUtilities.m1081dp(42.0f) : AndroidUtilities.m1081dp(42.0f);
            int iM1081dp2 = AndroidUtilities.m1081dp(36.0f);
            CheckBox2 checkBox2 = this.checkBox;
            checkBox2.layout(iM1081dp, iM1081dp2, checkBox2.getMeasuredWidth() + iM1081dp, this.checkBox.getMeasuredHeight() + iM1081dp2);
        }
        if (z) {
            buildLayout();
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:1412:0x04fc  */
    /*
    ...
    */
    public void buildLayout() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Cells.ProfileSearchCell.buildLayout():void");
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:627:0x0052 A[PHI: r3
  0x0052: PHI (r3v5 org.telegram.tgnet.TLRPC$FileLocation) = (r3v0 org.telegram.tgnet.TLRPC$FileLocation), (r3v7 org.telegram.tgnet.TLRPC$FileLocation) binds: [B:623:0x0048, B:625:0x004e] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:636:0x007c A[PHI: r3
  0x007c: PHI (r3v1 org.telegram.tgnet.TLRPC$FileLocation) = (r3v0 org.telegram.tgnet.TLRPC$FileLocation), (r3v3 org.telegram.tgnet.TLRPC$FileLocation) binds: [B:632:0x0072, B:634:0x0078] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public void update(int r15) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Cells.ProfileSearchCell.update(int):void");
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.useSeparator) {
            ...
            if (LocaleController.isRTL) {
                canvas2 = canvas;
                canvas2.drawLine(0.0f, getMeasuredHeight() - 1, getMeasuredWidth() - AndroidUtilities.m1081dp(AndroidUtilities.leftBaseline), getMeasuredHeight() - 1, paint2);
            } else {
                canvas2 = canvas;
                canvas2.drawLine(AndroidUtilities.m1081dp(AndroidUtilities.leftBaseline), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, paint2);
            }
        } else {
            canvas2 = canvas;
        }
        ...
        if (staticLayout != null) {
            if (LocaleController.isRTL) {
                iCeil = (int) (this.nameLeft + staticLayout.getLineRight(0) + AndroidUtilities.m1081dp(6.0f));
            } else if (staticLayout.getLineLeft(0) == 0.0f) {
                iCeil = (this.nameLeft - AndroidUtilities.m1081dp(3.0f)) - this.botVerificationDrawable.getIntrinsicWidth();
            } else {
                iCeil = (int) (((((double) (this.nameLeft + this.nameWidth)) - Math.ceil(this.nameLayout.getLineWidth(0))) - ((double) AndroidUtilities.m1081dp(3.0f))) - ((double) this.botVerificationDrawable.getIntrinsicWidth()));
            }
            ...
            canvas2.restore();
            if (!LocaleController.isRTL) {
                lineRight = (int) (this.nameLeft + this.nameLayout.getLineRight(0) + AndroidUtilities.m1081dp(6.0f));
            } else if (this.nameLayout.getLineLeft(0) == 0.0f) {
                lineRight = (this.nameLeft - AndroidUtilities.m1081dp(3.0f)) - this.statusDrawable.getIntrinsicWidth();
            } else {
                lineRight = (int) (((((double) (this.nameLeft + this.nameWidth)) - Math.ceil(this.nameLayout.getLineWidth(0))) - ((double) AndroidUtilities.m1081dp(3.0f))) - ((double) this.statusDrawable.getIntrinsicWidth()));
            }
        ...
        if (this.f1860ad != null && this.adText != null && this.adBackgroundPaint != null) {
            ...
            int width2 = ((int) this.adText.getWidth()) + AndroidUtilities.m1081dp(12.66f);
            int iM1081dp = AndroidUtilities.m1081dp(17.33f);
            if (LocaleController.isRTL) {
                width = AndroidUtilities.m1081dp(12.0f);
            } else {
                width = (getWidth() - AndroidUtilities.m1081dp(12.0f)) - width2;
            }
            float f = width;
            this.adBounds.set(f, this.nameTop, width + width2, r10 + iM1081dp);
            this.adBounds.inset(-AndroidUtilities.m1081dp(6.0f), -AndroidUtilities.m1081dp(6.0f));
            canvas2.save();
            ...
            this.adText.draw(canvas2, AndroidUtilities.m1081dp(6.33f), f3, color, 1.0f);
            canvas2.restore();
        }
        if (this.statusLayout != null) {
            canvas2.save();
            canvas2.translate(this.statusLeft + this.sublabelOffsetX, AndroidUtilities.m1081dp(this.callCellStyle ? 35.0f : 33.0f) + this.sublabelOffsetY);
            this.statusLayout.draw(canvas2);
            canvas2.restore();
        }
        if (this.countLayout != null) {
            this.rect.set(this.countLeft - AndroidUtilities.m1081dp(5.5f), this.countTop, r15 + this.countWidth + AndroidUtilities.m1081dp(11.0f), this.countTop + AndroidUtilities.m1081dp(23.0f));
            ...
            canvas2.save();
            canvas2.translate(this.countLeft, this.countTop + AndroidUtilities.m1081dp(4.0f));
        ...
        if (this.actionLayout != null) {
            ...
            rectF3.set(this.actionLeft, this.countTop, r7 + this.actionLayout.getWidth(), this.countTop + AndroidUtilities.m1081dp(23.0f));
            rectF3.inset(-AndroidUtilities.m1081dp(16.0f), -AndroidUtilities.m1081dp(4.0f));
            this.actionButton.setRect(rectF3);
            this.actionButton.setRounded(true);
            this.actionButton.draw(canvas2);
            canvas2.save();
            canvas2.translate(this.actionLeft, this.countTop + AndroidUtilities.m1081dp(4.0f));
        ...
        if (!this.dontDrawAvatar) {
            ...
            if (chat != null && chat.monoforum) {
                ...
                if (user != null) {
                    StoriesUtilities.drawAvatarWithStory(user.f1775id, canvas2, this.avatarImage, this.avatarStoryParams);
                } else if (chat != null) {
                    StoriesUtilities.drawAvatarWithStory(-chat.f1610id, canvas2, this.avatarImage, this.avatarStoryParams);
                } else {
                    this.avatarImage.setImageCoords(this.avatarStoryParams.originalAvatarRect);
                    this.avatarImage.draw(canvas2);
                }
        ...
        if (f5 > 0.0f) {
            float centerY = this.avatarImage.getCenterY() + AndroidUtilities.m1081dp(14.0f);
            float centerX = this.avatarImage.getCenterX() + AndroidUtilities.m1081dp(16.0f);
            canvas2.save();
            Theme.dialogs_onlineCirclePaint.setColor(Theme.getColor(Theme.key_windowBackgroundWhite, this.resourcesProvider));
            canvas2.drawCircle(centerX, centerY, AndroidUtilities.m1081dp(11.33f) * f5, Theme.dialogs_onlineCirclePaint);
            ...
            this.premiumGradient.gradientMatrix((int) (centerX - AndroidUtilities.m1081dp(10.0f)), (int) (centerY - AndroidUtilities.m1081dp(10.0f)), (int) (AndroidUtilities.m1081dp(10.0f) + centerX), (int) (AndroidUtilities.m1081dp(10.0f) + centerY), 0.0f, 0.0f);
            canvas2.drawCircle(centerX, centerY, AndroidUtilities.m1081dp(10.0f) * f5, this.premiumGradient.paint);
            if (this.lockDrawable == null) {
                Drawable drawableMutate = getContext().getResources().getDrawable(C2702R.drawable.msg_mini_lock2).mutate();
        ...
        float fM1081dp = AndroidUtilities.m1081dp(28.0f) + this.openButtonText.getCurrentWidth();
        float fM1081dp2 = LocaleController.isRTL ? AndroidUtilities.m1081dp(15.0f) : (getWidth() - fM1081dp) - AndroidUtilities.m1081dp(15.0f);
        float fM1081dp3 = AndroidUtilities.m1081dp(28.0f);
        this.openButtonBackgroundPaint.setColor(Theme.getColor(Theme.key_featuredStickers_addButton));
        this.openButtonRect.set(fM1081dp2, (getHeight() - fM1081dp3) / 2.0f, fM1081dp + fM1081dp2, (getHeight() + fM1081dp3) / 2.0f);
        canvas2.save();
        ...
        this.openButtonText.draw(canvas2, fM1081dp2 + AndroidUtilities.m1081dp(14.0f), getHeight() / 2.0f, -1, 1.0f);
        canvas2.restore();
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.drawCheck) {
            sb.append(", ");
            sb.append(LocaleController.getString(C2702R.string.AccDescrVerified));
            sb.append("\n");
        }
        if (this.statusLayout != null) {
            if (sb.length() > 0) {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        } else if (this.f1860ad != null && this.onSponsoredOptionsClick != null) {
            ...
            if (motionEvent.getAction() == 0 || motionEvent.getAction() == 2) {
                ...
                if (motionEvent.getAction() == 1) {
                    if (this.adBounce.isPressed()) {
                        this.onSponsoredOptionsClick.run(this, this.f1860ad);
                    }
