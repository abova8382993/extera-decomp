...
public class FeaturedStickerSetInfoCell extends FrameLayout {
    ...
    public FeaturedStickerSetInfoCell(Context context, int i, boolean z, boolean z2, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (z2) {
            ...
            this.delButton.setText(LocaleController.getString(C2702R.string.StickersRemove));
            if (z) {
    ...
    public void setStickerSet(TLRPC.StickerSetCovered stickerSetCovered, boolean z, boolean z2, int i, int i2, boolean z3) {
        ...
        if (this.canAddRemove) {
            if (this.hasOnClick) {
                ...
                boolean z4 = z3 || MediaDataController.getInstance(this.currentAccount).isStickerPackInstalled(stickerSetCovered.set.f1646id);
                this.isInstalled = z4;
                if (!z2) {
                    if (z4) {
    ...
    class C31931 extends AnimatorListenerAdapter {
        C31931() {
        }
    ...
    */
    protected void onDraw(android.graphics.Canvas r8) {
        ...
        L3b:
            ...
            int r1 = org.telegram.p026ui.ActionBar.Theme.key_featuredStickers_unread
        ...
        L6a:
            ...
            android.graphics.Paint r6 = org.telegram.p026ui.ActionBar.Theme.getThemePaint(r0, r1)
            r2 = 0
            r3 = 0
            r5 = 0
            r1 = r8
        ...
        L82:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Cells.FeaturedStickerSetInfoCell.onDraw(android.graphics.Canvas):void");
    }
