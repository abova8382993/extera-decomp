...
public class TextSettingsCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.imageView.getVisibility() == 0) {
            if (this.imageViewIsColorful) {
                this.imageView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(28.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(28.0f), TLObject.FLAG_30));
            } else {
            ...
            if (this.betterLayout) {
                measuredWidth2 -= this.imageView.getMeasuredWidth() + AndroidUtilities.m1081dp(8.0f);
            }
        }
        ...
        if (backupImageView != null) {
            ...
            if (this.betterLayout) {
                measuredWidth2 -= this.valueBackupImageView.getMeasuredWidth() + AndroidUtilities.m1081dp(8.0f);
            }
        }
        if (this.valueTextView.getVisibility() == 0) {
            ...
            if (this.betterLayout) {
                measuredWidth = measuredWidth2 - (this.valueTextView.getMeasuredWidth() + AndroidUtilities.m1081dp(8.0f));
            } else {
            ...
            if (this.valueImageView.getVisibility() == 0) {
                ...
                if (LocaleController.isRTL) {
                    marginLayoutParams.leftMargin = AndroidUtilities.m1081dp(this.padding + 4) + this.valueTextView.getMeasuredWidth();
                } else {
                    marginLayoutParams.rightMargin = AndroidUtilities.m1081dp(this.padding + 4) + this.valueTextView.getMeasuredWidth();
                }
            }
        }
    ...
    public void setIcon(int i) {
        ...
        if (i == 0) {
            this.imageView.setVisibility(8);
            if (LocaleController.isRTL) {
                marginLayoutParams.rightMargin = AndroidUtilities.m1081dp(this.padding);
                return;
            } else {
                marginLayoutParams.leftMargin = AndroidUtilities.m1081dp(this.padding);
                return;
            }
        }
        ...
        if (LocaleController.isRTL) {
            marginLayoutParams.rightMargin = AndroidUtilities.m1081dp(71.0f);
        } else {
            marginLayoutParams.leftMargin = AndroidUtilities.m1081dp(71.0f);
        }
    }
    ...
    */
    protected void dispatchDraw(android.graphics.Canvas r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Cells.TextSettingsCell.dispatchDraw(android.graphics.Canvas):void");
    }
