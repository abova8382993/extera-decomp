...
public class GroupCreateUserCell extends FrameLayout {
    ...
    private void updatePremiumBlocked(boolean z) {
        ...
        if (this.showPremiumBlocked) {
            ...
            if (requirementToContact != null) {
                ...
                requirementToContactIsUserContactBlocked = MessagesController.getInstance(this.currentAccount).isUserContactBlocked(((TLRPC.User) this.currentObject).f1775id);
            }
        }
    ...
    public GroupCreateUserCell(Context context, int i, int i2, boolean z, boolean z2, Theme.ResourcesProvider resourcesProvider) {
        ...
        imageView.setImageResource(C2702R.drawable.msg_arrow_forward);
    ...
    public void setPremium() {
        ...
        this.nameTextView.setText(LocaleController.getString(C2702R.string.PrivacyPremium));
        ...
        this.statusTextView.setText(LocaleController.getString(C2702R.string.PrivacyPremiumText));
        this.openChatView.setVisibility(8);
        updateTextMargins();
    }
    ...
    private void updateTextMargins() {
        ...
        float f2 = i3;
        layoutParams.leftMargin = AndroidUtilities.m1081dp(f2);
        ...
        layoutParams2.leftMargin = AndroidUtilities.m1081dp(f2);
    }
    ...
    public void setMiniapps() {
        ...
        this.nameTextView.setText(LocaleController.getString(C2702R.string.PrivacyMiniapps));
        SimpleTextView simpleTextView = this.statusTextView;
        int i = Theme.key_windowBackgroundWhiteGrayText;
        simpleTextView.setTag(Integer.valueOf(i));
        SimpleTextView simpleTextView2 = this.statusTextView;
        ...
        SimpleTextView simpleTextView3 = this.statusTextView;
        simpleTextView3.setEmojiColor(simpleTextView3.getTextColor());
        this.statusTextView.setText(LocaleController.getString(C2702R.string.PrivacyMiniappsText));
        this.openChatView.setVisibility(8);
        updateTextMargins();
    }
    ...
    public static Drawable makePremiumUsersDrawable(Context context, boolean z) {
        ...
        }, context.getResources().getDrawable(C2702R.drawable.msg_settings_premium), 0, 0);
        if (z) {
            combinedDrawable.setIconSize(AndroidUtilities.m1081dp(18.0f), AndroidUtilities.m1081dp(18.0f));
        }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        super.onMeasure(iMakeMeasureSpec, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp((!(obj instanceof String) || "premium".equalsIgnoreCase((String) obj) || "miniapps".equalsIgnoreCase((String) this.currentObject)) ? 58.0f : 50.0f), TLObject.FLAG_30));
    }
    ...
    public void update(int i) {
        ...
        if (obj instanceof String) {
            ((FrameLayout.LayoutParams) this.nameTextView.getLayoutParams()).topMargin = AndroidUtilities.m1081dp(15.0f);
            ...
            CheckBox2 checkBox2 = this.checkBox;
            if (checkBox2 != null) {
                ((FrameLayout.LayoutParams) checkBox2.getLayoutParams()).topMargin = AndroidUtilities.m1081dp(25.0f);
                if (LocaleController.isRTL) {
                    ((FrameLayout.LayoutParams) this.checkBox.getLayoutParams()).rightMargin = AndroidUtilities.m1081dp(31.0f);
                } else {
                    ((FrameLayout.LayoutParams) this.checkBox.getLayoutParams()).leftMargin = AndroidUtilities.m1081dp(32.0f);
                }
            }
            ...
            int iM1081dp2 = AndroidUtilities.m1081dp(46.0f);
            layoutParams4.height = iM1081dp2;
            layoutParams3.width = iM1081dp2;
            CheckBox2 checkBox22 = this.checkBox;
            if (checkBox22 != null) {
                ((FrameLayout.LayoutParams) checkBox22.getLayoutParams()).topMargin = AndroidUtilities.m1081dp(31.0f) + this.padding;
                if (LocaleController.isRTL) {
                    ((FrameLayout.LayoutParams) this.checkBox.getLayoutParams()).rightMargin = AndroidUtilities.m1081dp(38.0f) + this.padding;
                } else {
                    ((FrameLayout.LayoutParams) this.checkBox.getLayoutParams()).leftMargin = AndroidUtilities.m1081dp(38.0f) + this.padding;
                }
            }
            ...
            if (obj2 instanceof TLRPC.User) {
                ...
                if (this.currentStatus == null) {
                    if (user.bot) {
                        ...
                        this.statusTextView.setText(LocaleController.getString(C2702R.string.Bot));
                ...
                if (this.currentStatus == null) {
                    ...
                    if (chat2.participants_count != 0) {
                        ...
                        this.statusTextView.setText(LocaleController.getString(C2702R.string.MegaLocation));
                    } else if (!ChatObject.isPublic(chat2)) {
                        if (ChatObject.isChannel(chat2) && !chat2.megagroup) {
                            this.statusTextView.setText(LocaleController.getString(C2702R.string.ChannelPrivate));
                        } else {
                            this.statusTextView.setText(LocaleController.getString(C2702R.string.MegaPrivate));
                        }
                    } else if (ChatObject.isChannel(chat2) && !chat2.megagroup) {
                        this.statusTextView.setText(LocaleController.getString(C2702R.string.ChannelPublic));
                    } else {
                        this.statusTextView.setText(LocaleController.getString(C2702R.string.MegaPublic));
                    }
                }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.premiumBlockedT.set(this.premiumBlocked) <= 0.0f && this.checkBoxType == 2 && (this.isChecked || this.checkProgress > 0.0f)) {
            ...
            float fM1081dp = AndroidUtilities.m1081dp(18.0f) + (AndroidUtilities.m1081dp(4.0f) * this.checkProgress);
            float f = left - fM1081dp;
            float f2 = top - fM1081dp;
            float f3 = left + fM1081dp;
            float f4 = top + fM1081dp;
            float f5 = fM1081dp * 2.0f;
            canvas.drawRoundRect(f, f2, f3, f4, ExteraConfig.getAvatarCorners(f5, true), ExteraConfig.getAvatarCorners(f5, true), this.paint);
        }
        if (this.drawDivider) {
            int iM1081dp = AndroidUtilities.m1081dp(LocaleController.isRTL ? 0.0f : this.padding + 72);
            int measuredWidth = getMeasuredWidth() - AndroidUtilities.m1081dp(LocaleController.isRTL ? this.padding + 72 : 0.0f);
            if (this.forceDarkTheme) {
                Theme.dividerExtraPaint.setColor(Theme.getColor(Theme.key_voipgroup_actionBar, this.resourcesProvider));
                canvas.drawRect(iM1081dp, getMeasuredHeight() - 1, measuredWidth, getMeasuredHeight(), Theme.dividerExtraPaint);
            } else {
                canvas.drawRect(iM1081dp, getMeasuredHeight() - 1, measuredWidth, getMeasuredHeight(), Theme.getThemePaint("paintDivider", this.resourcesProvider));
            }
        }
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (f > 0.0f) {
            float y = this.avatarImageView.getY() + (this.avatarImageView.getHeight() / 2.0f) + AndroidUtilities.m1081dp(18.0f);
            float x = this.avatarImageView.getX() + (this.avatarImageView.getWidth() / 2.0f) + AndroidUtilities.m1081dp(18.0f);
            canvas.save();
            Theme.dialogs_onlineCirclePaint.setColor(Theme.getColor(Theme.key_windowBackgroundWhite, this.resourcesProvider));
            canvas.drawCircle(x, y, AndroidUtilities.m1081dp(11.33f) * f, Theme.dialogs_onlineCirclePaint);
            if (this.blockedOverridden == null) {
                ...
                this.premiumGradient.gradientMatrix((int) (x - AndroidUtilities.m1081dp(10.0f)), (int) (y - AndroidUtilities.m1081dp(10.0f)), (int) (AndroidUtilities.m1081dp(10.0f) + x), (int) (AndroidUtilities.m1081dp(10.0f) + y), 0.0f, 0.0f);
            ...
            canvas.drawCircle(x, y, AndroidUtilities.m1081dp(10.0f) * f, paint);
