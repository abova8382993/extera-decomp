...
public class StickerCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(76.0f) + getPaddingLeft() + getPaddingRight(), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(78.0f), TLObject.FLAG_30));
    }
    ...
    */
    protected boolean drawChild(android.graphics.Canvas r5, android.view.View r6, long r7) {
        ...
        L64:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Cells.StickerCell.drawChild(android.graphics.Canvas, android.view.View, long):boolean");
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (str != null) {
            accessibilityNodeInfo.setText(str + " " + LocaleController.getString(C2702R.string.AttachSticker));
        } else {
            accessibilityNodeInfo.setText(LocaleController.getString(C2702R.string.AttachSticker));
        }
