...
public class InviteUserCell extends FrameLayout {
    ...
    public InviteUserCell(Context context, boolean z) {
        ...
        addView(linearLayout, LayoutHelper.createFrame(-1, -1.0f, Opcodes.DNEG, z2 ? 0 : 72, 0.0f, z2 ? 72 : 0, 0.0f));
        ...
        progressButton.setText(LocaleController.getString(C2702R.string.Invite));
