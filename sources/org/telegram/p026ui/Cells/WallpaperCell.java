...
import org.telegram.p026ui.Components.CheckBox;
...
public abstract class WallpaperCell extends FrameLayout {
    ...
    public class WallpaperView extends FrameLayout {
        ...
        public WallpaperView(Context context) {
            ...
            C32811 c32811 = new BackupImageView(context) { // from class: org.telegram.ui.Cells.WallpaperCell.WallpaperView.1
                final /* synthetic */ WallpaperCell val$this$0;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C32811(Context context2, WallpaperCell wallpaperCell) {
                    super(context2);
                ...
                protected void onDraw(Canvas canvas) {
                    ...
                    if (WallpaperView.this.isSelected) {
                        ...
                        canvas2.drawCircle(measuredWidth, measuredHeight, AndroidUtilities.m1081dp(20.0f), WallpaperCell.this.circlePaint);
            ...
            this.imageView = c32811;
            addView(c32811, LayoutHelper.createFrame(-1, -1, 51));
            ImageView imageView = new ImageView(context2);
            this.imageView2 = imageView;
            imageView.setImageResource(C2702R.drawable.ic_gallery_background);
            ...
            CheckBox checkBox = new CheckBox(context2, C2702R.drawable.round_check2);
        ...
        class C32811 extends BackupImageView {
            final /* synthetic */ WallpaperCell val$this$0;
        ...
        public void setWallpaper(Object obj, Object obj2, Drawable drawable, boolean z) {
            ...
            if (obj instanceof TLRPC.TL_wallPaper) {
                ...
                TLRPC.PhotoSize closestPhotoSizeWithSize = FileLoader.getClosestPhotoSizeWithSize(tL_wallPaper.document.thumbs, AndroidUtilities.m1081dp(100));
                TLRPC.PhotoSize closestPhotoSizeWithSize2 = FileLoader.getClosestPhotoSizeWithSize(tL_wallPaper.document.thumbs, AndroidUtilities.m1081dp(Opcodes.GETFIELD));
                ...
                if (colorWallpaper.path != null || colorWallpaper.pattern != null || "d".equals(colorWallpaper.slug)) {
                    ...
                    if ("d".equals(colorWallpaper.slug)) {
                        if (colorWallpaper.defaultCache == null) {
                            colorWallpaper.defaultCache = SvgHelper.getBitmap(C2702R.raw.default_pattern, 100, Opcodes.GETFIELD, -16777216);
                        }
            ...
            if (obj instanceof MediaController.SearchImage) {
                ...
                if (photo != null) {
                    TLRPC.PhotoSize closestPhotoSizeWithSize4 = FileLoader.getClosestPhotoSizeWithSize(photo.sizes, AndroidUtilities.m1081dp(100));
                    TLRPC.PhotoSize closestPhotoSizeWithSize5 = FileLoader.getClosestPhotoSizeWithSize(searchImage.photo.sizes, AndroidUtilities.m1081dp(Opcodes.GETFIELD));
        ...
        class C32822 extends AnimatorListenerAdapter {
            final /* synthetic */ boolean val$checked;
    ...
    public WallpaperCell(Context context, int i) {
        ...
        while (true) {
            ...
            if (i2 < wallpaperViewArr.length) {
                ...
                this.checkDrawable = context.getResources().getDrawable(C2702R.drawable.background_selected).mutate();
    ...
    protected void onMeasure(int i, int i2) {
        int i3 = 0;
        if (this.spanCount == 1) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(this.size + AndroidUtilities.m1081dp(6.0f), TLObject.FLAG_30));
            setPadding(0, 0, 0, AndroidUtilities.m1081dp(6.0f));
            return;
        }
        int size = View.MeasureSpec.getSize(i);
        int iM1081dp = size - AndroidUtilities.m1081dp(((this.spanCount - 1) * 6) + 28);
        int i4 = iM1081dp / this.spanCount;
        int i5 = this.currentType;
        int iM1081dp2 = (i5 == 0 || i5 == 2 || i5 == 3) ? AndroidUtilities.m1081dp(180.0f) : i4;
        setMeasuredDimension(size, (this.isTop ? AndroidUtilities.m1081dp(14.0f) : 0) + iM1081dp2 + AndroidUtilities.m1081dp(this.isBottom ? 14.0f : 6.0f));
        while (true) {
            int i6 = this.spanCount;
            if (i3 >= i6) {
                return;
            }
            this.wallpaperViews[i3].measure(View.MeasureSpec.makeMeasureSpec(i3 == i6 + (-1) ? iM1081dp : i4, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(iM1081dp2, TLObject.FLAG_30));
            iM1081dp -= i4;
            i3++;
        }
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int iM1081dp2 = this.isTop ? AndroidUtilities.m1081dp(14.0f) : 0;
        for (int i5 = 0; i5 < this.spanCount; i5++) {
            ...
            wallpaperView.layout(iM1081dp, iM1081dp2, iM1081dp + measuredWidth, wallpaperView.getMeasuredHeight() + iM1081dp2);
            iM1081dp += measuredWidth + AndroidUtilities.m1081dp(6.0f);
        }
    }
