...
public class AudioPlayerCell extends FrameLayout implements DownloadController.FileDownloadProgressListener {
    ...
    public static /* synthetic */ void m5847$r8$lambda$rQ9o2aGm7Anfro19pIupw3wso(View view) {
    }
    ...
    public AudioPlayerCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Cells.AudioPlayerCell$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                AudioPlayerCell.m5847$r8$lambda$rQ9o2aGm7Anfro19pIupw3wso(view);
            }
        });
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int size = (View.MeasureSpec.getSize(i) - AndroidUtilities.m1081dp(AndroidUtilities.leftBaseline)) - AndroidUtilities.m1081dp(48.0f);
        try {
            StaticLayout staticLayout = new StaticLayout(TextUtils.ellipsize(this.currentMessageObject.getMusicTitle().replace('\n', ' '), Theme.chat_contextResult_titleTextPaint, Math.min((int) Math.ceil(Theme.chat_contextResult_titleTextPaint.measureText(r0)), size), TextUtils.TruncateAt.END), Theme.chat_contextResult_titleTextPaint, size + AndroidUtilities.m1081dp(4.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        ...
        try {
            ...
            StaticLayout staticLayout2 = new StaticLayout(TextUtils.ellipsize(charSequenceReplace, Theme.chat_contextResult_descriptionTextPaint, size, TextUtils.TruncateAt.END), Theme.chat_contextResult_descriptionTextPaint, size + AndroidUtilities.m1081dp(4.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        ...
        int iM1081dp = AndroidUtilities.m1081dp(4.0f) + size2;
        this.buttonX = iM1081dp;
        int iM1081dp2 = AndroidUtilities.m1081dp(6.0f);
        this.buttonY = iM1081dp2;
        radialProgress2.setProgressRect(iM1081dp, iM1081dp2, size2 + AndroidUtilities.m1081dp(48.0f), AndroidUtilities.m1081dp(50.0f));
    }
    ...
    public void setMessageObject(MessageObject messageObject, boolean z, View.OnClickListener onClickListener, boolean z2, View.OnTouchListener onTouchListener) {
        ...
        this.needDivider = z2;
        this.optionsButton.setImageResource(z ? C2702R.drawable.list_reorder : C2702R.drawable.ic_ab_other);
    ...
    */
    private boolean checkAudioMotionEvent(android.view.MotionEvent r9) {
        ...
        L7e:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Cells.AudioPlayerCell.checkAudioMotionEvent(android.view.MotionEvent):boolean");
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.titleLayout != null) {
            canvas.save();
            canvas.translate(AndroidUtilities.m1081dp(LocaleController.isRTL ? 16.0f : AndroidUtilities.leftBaseline) + ((LocaleController.isRTL && this.optionsButton.getVisibility() == 0) ? AndroidUtilities.m1081dp(32.0f) : 0), this.titleY);
        ...
        if (this.descriptionLayout != null) {
            ...
            canvas.save();
            int iM1081dp2 = AndroidUtilities.m1081dp(LocaleController.isRTL ? 16.0f : AndroidUtilities.leftBaseline);
            if (LocaleController.isRTL && this.optionsButton.getVisibility() == 0) {
                iM1081dp = AndroidUtilities.m1081dp(32.0f);
            }
            canvas.translate(iM1081dp2 + iM1081dp, this.descriptionY);
        ...
        if (LocaleController.isRTL) {
            canvas.drawRect(0.0f, getHeight() - 1, getWidth() - AndroidUtilities.m1081dp(AndroidUtilities.leftBaseline), getHeight(), themePaint);
        } else {
            canvas.drawRect(AndroidUtilities.m1081dp(AndroidUtilities.leftBaseline), getHeight() - 1, getWidth(), getHeight(), themePaint);
        }
    }
