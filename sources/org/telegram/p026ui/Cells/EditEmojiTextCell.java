...
public abstract class EditEmojiTextCell extends FrameLayout {
    ...
    public EditEmojiTextCell(Context context, SizeNotifierFrameLayout sizeNotifierFrameLayout, String str, final boolean z, final int i, int i2, final Theme.ResourcesProvider resourcesProvider) {
        ...
        animatedTextDrawable.setTextSize(AndroidUtilities.m1081dp(15.33f));
        ...
        EditTextEmoji editTextEmoji = new EditTextEmoji(context, sizeNotifierFrameLayout, null, i2, true) { // from class: org.telegram.ui.Cells.EditEmojiTextCell.2
            ...
            protected void onDraw(Canvas canvas) {
                ...
                int iMin = Math.min(AndroidUtilities.m1081dp(48.0f), getHeight());
                float f2 = z ? 0.0f : -AndroidUtilities.m1081dp(1.0f);
                EditEmojiTextCell.this.limit.setBounds(getScrollX(), (getHeight() + f2) - iMin, (getScrollX() + getWidth()) - AndroidUtilities.m1081dp((z ? 0 : 44) + 12), f2 + getHeight());
                EditEmojiTextCell.this.limit.draw(canvas);
            }

            @Override // org.telegram.p026ui.Components.EditTextEmoji
            protected void extendActionMode(ActionMode actionMode, Menu menu) {
                if (menu.findItem(C2702R.id.menu_bold) != null) {
                    return;
                }
                menu.removeItem(R.id.shareText);
                menu.add(C2702R.id.menu_groupbolditalic, C2702R.id.menu_spoiler, 6, LocaleController.getString(C2702R.string.Spoiler));
                ...
                menu.add(C2702R.id.menu_groupbolditalic, C2702R.id.menu_bold, 7, spannableStringBuilder);
                ...
                menu.add(C2702R.id.menu_groupbolditalic, C2702R.id.menu_italic, 8, spannableStringBuilder2);
                ...
                menu.add(C2702R.id.menu_groupbolditalic, C2702R.id.menu_strike, 9, spannableStringBuilder3);
                menu.add(C2702R.id.menu_groupbolditalic, C2702R.id.menu_regular, 10, LocaleController.getString(C2702R.string.Regular));
            }
        ...
        editText.setPadding(paddingLeft, paddingTop, AndroidUtilities.m1081dp(f), editText.getPaddingBottom());
        ...
        editText.setCursorSize(AndroidUtilities.m1081dp(19.0f));
    ...
    public void setOnChangeIconListener(View.OnClickListener onClickListener) {
        ...
        while (true) {
            ...
            this.iconImageView[i].setPadding(iM1081dp, iM1081dp, iM1081dp, iM1081dp);
