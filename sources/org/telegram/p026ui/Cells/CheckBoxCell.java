...
public class CheckBoxCell extends FrameLayout {
    ...
    public CheckBoxCell(Context context, int i, int i2, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        boolean z2 = true;
        if (z) {
            C31681 c31681 = new AnimatedTextView(context) { // from class: org.telegram.ui.Cells.CheckBoxCell.1
                C31681(Context context2) {
                    super(context2);
                }
            ...
            this.animatedTextView = c31681;
            NotificationCenter.listenEmojiLoading(c31681);
            this.animatedTextView.setEllipsizeByGradient(true);
            this.animatedTextView.setRightPadding(AndroidUtilities.m1081dp(8.0f));
            ...
            this.animatedTextView.setTextSize(AndroidUtilities.m1081dp(16.0f));
            if (i == 7) {
            ...
            if (i == 3) {
                ...
                this.animatedTextView.setPadding(0, 0, 0, AndroidUtilities.m1081dp(3.0f));
            } else {
                this.animatedTextView.setRightPadding(AndroidUtilities.m1081dp(i2));
            ...
            C31692 c31692 = new LinkSpanDrawable.LinksTextView(context2) { // from class: org.telegram.ui.Cells.CheckBoxCell.2
                C31692(Context context2) {
                    super(context2);
                }
            ...
            this.linksTextView = c31692;
            NotificationCenter.listenEmojiLoading(c31692);
            ...
            if (i == 3) {
                ...
                this.linksTextView.setPadding(0, 0, 0, AndroidUtilities.m1081dp(3.0f));
            } else {
        ...
        if (isCheckboxRound()) {
            ...
            CheckBoxSquare checkBoxSquare = new CheckBoxSquare(context2, z2, resourcesProvider);
        ...
        if (i == 6) {
            CollapseButton collapseButton = new CollapseButton(context2, C2702R.drawable.msg_folders_groups);
            this.collapseButton = collapseButton;
            addView(collapseButton, LayoutHelper.createFrameRelatively(-2.0f, -2.0f, 8388629, f, 0.0f, i2 - 11, 0.0f));
        } else if (i == 8) {
            CollapseButton collapseButton2 = new CollapseButton(context2, 0);
            ...
            addView(this.avatarImageView, LayoutHelper.createFrameRelatively(34.0f, 34.0f, NavigationBarView.ITEM_GRAVITY_START_CENTER, 56.0f, 0.0f, 0.0f, 0.0f));
        }
        updateTextColor();
    }

    /* JADX INFO: renamed from: org.telegram.ui.Cells.CheckBoxCell$1 */
    class C31681 extends AnimatedTextView {
        C31681(Context context2) {
            super(context2);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Cells.CheckBoxCell$2 */
    class C31692 extends LinkSpanDrawable.LinksTextView {
        C31692(Context context2) {
            super(context2);
        }
    ...
    public void setCollapsed(Boolean bool) {
        ...
        if (this.collapsedArrow == null) {
            ...
            Drawable drawableMutate = getContext().getResources().getDrawable(C2702R.drawable.arrow_more).mutate();
    ...
    public void updateCollapseArrowTranslation() {
        ...
        if (LocaleController.isRTL) {
            left = (this.textView.getRight() - measuredWidth) - AndroidUtilities.m1081dp(20.0f);
        } else {
            left = this.textView.getLeft() + measuredWidth + AndroidUtilities.m1081dp(4.0f);
        }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.currentType == 3) {
            this.valueTextView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(10.0f), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(50.0f), TLObject.FLAG_30));
            this.textView.measure(View.MeasureSpec.makeMeasureSpec(size - AndroidUtilities.m1081dp(34.0f), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(50.0f), Integer.MIN_VALUE));
            this.checkBox.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(this.checkBoxSize), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(this.checkBoxSize), TLObject.FLAG_30));
            setMeasuredDimension(this.textView.getMeasuredWidth() + AndroidUtilities.m1081dp(29.0f), AndroidUtilities.m1081dp(50.0f));
            ...
            int measuredWidth = ((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight()) - AndroidUtilities.m1081dp(isCheckboxRound() ? 60.0f : 34.0f);
            if (this.textAnimated) {
                measuredWidth += (int) this.animatedTextView.getRightPadding();
            }
            if (this.currentType == 7) {
                measuredWidth -= AndroidUtilities.m1081dp(34.0f);
            }
            ...
            if (collapseButton != null) {
                collapseButton.measure(View.MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), TLObject.FLAG_30));
                measuredWidth2 += this.collapseButton.getMeasuredWidth() - AndroidUtilities.m1081dp(11.0f);
            }
            if (this.textView.getLayoutParams().width == -1) {
                View view = this.textView;
                view.measure(View.MeasureSpec.makeMeasureSpec(((measuredWidth - ((int) Math.abs(view.getTranslationX()))) - measuredWidth2) - AndroidUtilities.m1081dp(8.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), Integer.MIN_VALUE));
            } else {
                View view2 = this.textView;
                view2.measure(View.MeasureSpec.makeMeasureSpec(((measuredWidth - ((int) Math.abs(view2.getTranslationX()))) - measuredWidth2) - AndroidUtilities.m1081dp(8.0f), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), Integer.MIN_VALUE));
            }
            BackupImageView backupImageView = this.avatarImageView;
            if (backupImageView != null) {
                backupImageView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(34.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(34.0f), TLObject.FLAG_30));
            }
            this.checkBox.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(this.checkBoxSize), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(this.checkBoxSize), TLObject.FLAG_30));
        }
        ...
        if (view3 != null) {
            ...
            this.click1Container.measure(View.MeasureSpec.makeMeasureSpec((size - marginLayoutParams.leftMargin) - marginLayoutParams.rightMargin, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(50.0f), TLObject.FLAG_30));
        }
        View view4 = this.click2Container;
        if (view4 != null) {
            view4.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(56.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(50.0f), TLObject.FLAG_30));
        }
        View view5 = this.collapsedArrow;
        if (view5 != null) {
            view5.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(16.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(16.0f), TLObject.FLAG_30));
        }
    }
    ...
    public void setUserOrChat(TLObject tLObject) {
        ...
        if (z && ((TLRPC.User) tLObject).f1775id == MessagesController.getInstance(UserConfig.selectedAccount).telegramAntispamUserId) {
            name = LocaleController.getString(C2702R.string.ChannelAntiSpamUser);
        }
        if (this.textAnimated) {
    ...
    public void setPad(int i) {
        int iM1081dp = AndroidUtilities.m1081dp(i * 40 * (LocaleController.isRTL ? -1 : 1));
        View view = this.checkBox;
        if (view != null) {
            view.setTranslationX(iM1081dp);
        }
        float f = iM1081dp;
    ...
    public void setMultiline(boolean z) {
        ...
        if (this.isMultiline) {
            ...
            layoutParams2.topMargin = AndroidUtilities.m1081dp(15.0f);
        }
    ...
    protected void onDraw(Canvas canvas) {
        if (this.needDivider) {
            int iM1081dp = AndroidUtilities.m1081dp(isCheckboxRound() ? 60.0f : 20.0f) + ((int) Math.abs(this.textView.getTranslationX()));
            if (this.currentType == 7) {
                iM1081dp += AndroidUtilities.m1081dp(39.0f);
            }
            ...
            Paint paint2 = paint;
            float f = LocaleController.isRTL ? 0.0f : iM1081dp;
            float measuredHeight = getMeasuredHeight() - 1;
            int measuredWidth = getMeasuredWidth();
            if (!LocaleController.isRTL) {
                iM1081dp = 0;
            }
            canvas.drawLine(f, measuredHeight, measuredWidth - iM1081dp, getMeasuredHeight() - 1, paint2);
        }
    }
    ...
    public class CollapseButton extends LinearLayout {
        ...
        public CollapseButton(Context context, int i) {
            ...
            if (LocaleController.isRTL) {
                ...
                addView(animatedTextView, LayoutHelper.createLinear(-2, 16, 16, 0, 0, this.iconView != null ? 3 : 11, 0));
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(32.0f), TLObject.FLAG_30));
        }
    ...
    public void reset() {
        if (this.textAnimated) {
            this.animatedTextView.setText(_UrlKt.FRAGMENT_ENCODE_SET);
        } else {
            this.linksTextView.setText(_UrlKt.FRAGMENT_ENCODE_SET);
        }
        BackupImageView backupImageView = this.avatarImageView;
        if (backupImageView != null) {
