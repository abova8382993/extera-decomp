...
public class AvailableReactionCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec((int) (AndroidUtilities.m1081dp(58.0f) + Theme.dividerPaint.getStrokeWidth()), TLObject.FLAG_30));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int iM1081dp = AndroidUtilities.m1081dp(81.0f);
        int i = 0;
        if (LocaleController.isRTL) {
            i = iM1081dp;
            iM1081dp = 0;
        }
        canvas.drawLine(getPaddingLeft() + iM1081dp, getHeight() - strokeWidth, (getWidth() - getPaddingRight()) - i, getHeight() - strokeWidth, Theme.dividerPaint);
    }
