  ...
  0x0017: PHI (r3v2 int) = (r3v0 int), (r3v1 int) binds: [B:6:0x0015, B:12:0x0026] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public /* synthetic */ void lambda$new$1() {
        ...
        L2b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Cells.GroupCallUserCell.lambda$new$1():void");
    }
    ...
    public void setProgressToAvatarPreview(float f) {
        ...
        this.nameTextView.setTranslationX((LocaleController.isRTL ? AndroidUtilities.m1081dp(53.0f) : -AndroidUtilities.m1081dp(53.0f)) * f);
        if (isSelfUser() && f > 0.0f) {
            float f2 = 1.0f - f;
            this.fullAboutTextView.setTranslationX((LocaleController.isRTL ? -AndroidUtilities.m1081dp(53.0f) : AndroidUtilities.m1081dp(53.0f)) * f2);
            ...
            int iM1081dp = AndroidUtilities.m1081dp(53.0f);
            if (!z) {
                iM1081dp = -iM1081dp;
            }
            simpleTextView.setTranslationX(iM1081dp * f);
        } else {
            ...
            while (true) {
                ...
                if (!TextUtils.isEmpty(simpleTextViewArr[4].getText()) && this.statusTextView[4].getLineCount() > 1) {
                    this.statusTextView[i].setFullLayoutAdditionalWidth(AndroidUtilities.m1081dp(92.0f), LocaleController.isRTL ? AndroidUtilities.m1081dp(48.0f) : AndroidUtilities.m1081dp(53.0f));
                    this.statusTextView[i].setFullAlpha(f);
                    this.statusTextView[i].setTranslationX(0.0f);
                    this.statusTextView[i].invalidate();
                } else {
                    this.statusTextView[i].setTranslationX((LocaleController.isRTL ? AndroidUtilities.m1081dp(53.0f) : -AndroidUtilities.m1081dp(53.0f)) * f);
    ...
    private static class VerifiedDrawable extends Drawable {
        ...
        public VerifiedDrawable(Context context) {
            ...
            drawableArr[0] = context.getResources().getDrawable(C2702R.drawable.verified_area).mutate();
            this.drawables[0].setColorFilter(new PorterDuffColorFilter(-9063442, PorterDuff.Mode.MULTIPLY));
            this.drawables[1] = context.getResources().getDrawable(C2702R.drawable.verified_check).mutate();
        }
    ...
    public GroupCallUserCell(Context context) {
        ...
        this.nameTextView.setDrawablePadding(AndroidUtilities.m1081dp(6.0f));
        ...
        this.leftDrawable = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(this.nameTextView, AndroidUtilities.m1081dp(20.0f), 9);
        this.rightDrawable = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(this.nameTextView, AndroidUtilities.m1081dp(20.0f), 9);
        Drawable drawable = context.getResources().getDrawable(C2702R.drawable.voice_volume_mini);
        ...
        while (true) {
            ...
            if (i == 4) {
                ...
                if (i == 0) {
                    ...
                    this.statusTextView[i].setText(LocaleController.getString(C2702R.string.Listening));
                } else if (i == 1) {
                    this.statusTextView[i].setTextColor(Theme.getColor(Theme.key_voipgroup_speakingText));
                    this.statusTextView[i].setText(LocaleController.getString(C2702R.string.Speaking));
                    this.statusTextView[i].setDrawablePadding(AndroidUtilities.m1081dp(2.0f));
                } else if (i == 2) {
                    this.statusTextView[i].setTextColor(Theme.getColor(Theme.key_voipgroup_mutedByAdminIcon));
                    this.statusTextView[i].setText(LocaleController.getString(C2702R.string.VoipGroupMutedForMe));
                } else if (i == 3) {
                    this.statusTextView[i].setTextColor(Theme.getColor(Theme.key_voipgroup_listeningText));
                    this.statusTextView[i].setText(LocaleController.getString(C2702R.string.WantsToSpeak));
                }
        ...
        this.muteDrawable = new RLottieDrawable(C2702R.raw.voice_outlined2, _UrlKt.FRAGMENT_ENCODE_SET + C2702R.raw.voice_outlined2, AndroidUtilities.m1081dp(34.0f), AndroidUtilities.m1081dp(32.0f), true, null);
        this.shakeHandDrawable = new RLottieDrawable(C2702R.raw.hand_1, _UrlKt.FRAGMENT_ENCODE_SET + C2702R.raw.hand_1, AndroidUtilities.m1081dp(34.0f), AndroidUtilities.m1081dp(32.0f), true, null);
        ...
        this.avatarWavesDrawable = new AvatarWavesDrawable(AndroidUtilities.m1081dp(26.0f), AndroidUtilities.m1081dp(29.0f));
    ...
    public int getClipHeight() {
        ...
        if (simpleTextView.getLineCount() > 1) {
            return simpleTextView.getTop() + simpleTextView.getTextHeight() + AndroidUtilities.m1081dp(8.0f);
        }
    ...
    public boolean isSelfUser() {
        ...
        if (j > 0) {
            ...
            return user != null && user.f1775id == j;
        }
        TLRPC.Chat chat = this.currentChat;
        return chat != null && chat.f1610id == (-j);
    }
            ...
            if (user != null && user.verified) {
                ...
                if (user2 != null && user2.premium) {
                    if (this.premiumDrawable == null) {
                        ...
                        this.premiumDrawable = new AnimatedEmojiDrawable.WrapSizeDrawable(this.premiumDrawable, AndroidUtilities.m1081dp(14.0f), AndroidUtilities.m1081dp(14.0f)) { // from class: org.telegram.ui.Cells.GroupCallUserCell.3
                            @Override // org.telegram.ui.Components.AnimatedEmojiDrawable.WrapSizeDrawable, android.graphics.drawable.Drawable
                            public void draw(Canvas canvas) {
                                canvas.save();
                                canvas.translate(AndroidUtilities.m1081dp(-2.0f), AndroidUtilities.m1081dp(0.0f));
                                super.draw(canvas);
                                canvas.restore();
                            }
                        };
    ...
    */
    private void applyParticipantChanges(boolean r21, boolean r22) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Cells.GroupCallUserCell.applyParticipantChanges(boolean, boolean):void");
    }
    ...
    public void applyStatus(int i) {
        ...
        if (i == 0) {
            while (true) {
                ...
                simpleTextViewArr[i2].setTranslationY(i2 == i ? 0.0f : AndroidUtilities.m1081dp(-2.0f));
            ...
            while (true) {
                ...
                if (i2 == i) {
                    ...
                    fM1081dp = AndroidUtilities.m1081dp(i2 == 0 ? 2.0f : -2.0f);
                }
                simpleTextView.setTranslationY(fM1081dp);
                this.statusTextView[i2].setAlpha(i2 == i ? 1.0f : 0.0f);
                i2++;
            }
        }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (this.needDivider) {
            ...
            canvas2 = canvas;
            canvas2.drawLine(LocaleController.isRTL ? 0.0f : AndroidUtilities.m1081dp(68.0f), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m1081dp(68.0f) : 0), getMeasuredHeight() - 1, this.dividerPaint);
    ...
    public static class AvatarWavesDrawable {
        ...
        */
        public void draw(android.graphics.Canvas r8, float r9, float r10, android.view.View r11) {
            ...
            L1f:
                r8.save()
                org.telegram.ui.Components.CubicBezierInterpolator r0 = org.telegram.p026ui.Components.CubicBezierInterpolator.DEFAULT
            ...
            L61:
                ...
                r4 = 2
                if (r3 != r4) goto L77
                int r3 = org.telegram.p026ui.ActionBar.Theme.key_voipgroup_mutedByAdminIcon
            L72:
                int r3 = org.telegram.p026ui.ActionBar.Theme.getColor(r3)
                goto L7a
            L77:
                int r3 = org.telegram.p026ui.ActionBar.Theme.key_voipgroup_listeningText
                goto L72
            L7a:
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (accessibilityNodeInfo.isEnabled()) {
            ...
            accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, LocaleController.getString((!groupCallParticipant.muted || groupCallParticipant.can_self_unmute) ? C2702R.string.VoipMute : C2702R.string.VoipUnmute)));
        }
    }
