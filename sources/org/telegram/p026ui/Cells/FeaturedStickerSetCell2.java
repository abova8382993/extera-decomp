...
public class FeaturedStickerSetCell2 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public FeaturedStickerSetCell2(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        textView3.setText(LocaleController.getString(C2702R.string.StickersRemove));
        ...
        premiumButtonView.setButton(LocaleController.getString(C2702R.string.Unlock), new View.OnClickListener() { // from class: org.telegram.ui.Cells.FeaturedStickerSetCell2$$ExternalSyntheticLambda0
        ...
        try {
            ...
            ((ViewGroup.MarginLayoutParams) premiumButtonView.getTextView().getLayoutParams()).leftMargin = AndroidUtilities.m1081dp(3.0f);
            premiumButtonView.getChildAt(0).setPadding(AndroidUtilities.m1081dp(8.0f), 0, AndroidUtilities.m1081dp(8.0f), 0);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (measuredWidth2 < measuredWidth) {
            layoutParams.rightMargin = AndroidUtilities.m1081dp(14.0f) + ((measuredWidth - measuredWidth2) / 2);
        } else {
            layoutParams.rightMargin = AndroidUtilities.m1081dp(14.0f);
        }
    ...
    public void setStickersSet(TLRPC.StickerSetCovered stickerSetCovered, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        this.unread = z2;
        if (z2) {
            C31911 c31911 = new Drawable() { // from class: org.telegram.ui.Cells.FeaturedStickerSetCell2.1
                ...
                public void draw(Canvas canvas) {
                    ...
                    canvas.drawCircle(AndroidUtilities.m1081dp(4.0f), AndroidUtilities.m1081dp(5.0f), AndroidUtilities.m1081dp(3.0f), this.paint);
                }
                ...
                public int getIntrinsicHeight() {
                    return AndroidUtilities.m1081dp(8.0f);
                }
            };
            TextView textView = this.textView;
            boolean z5 = LocaleController.isRTL;
            C31911 c319112 = z5 ? null : c31911;
            if (!z5) {
                c31911 = null;
            }
            textView.setCompoundDrawablesWithIntrinsicBounds(c319112, (Drawable) null, c31911, (Drawable) null);
        } else {
        ...
        if ((stickerSetCovered instanceof TLRPC.TL_stickerSetNoCovered) && (stickerSet = stickerSetCovered.set) != null) {
            this.waitingForStickerSetId = Long.valueOf(stickerSet.f1646id);
            ...
            if (stickerSet3 != null && (arrayList = stickerSet3.documents) != null && !arrayList.isEmpty()) {
                ...
                while (true) {
                    ...
                    if (((TLRPC.Document) stickerSet3.documents.get(i)).f1618id == stickerSetCovered.set.thumb_document_id) {
            ...
            if (!stickerSetCovered.covers.isEmpty()) {
                ...
                if (stickerSetCovered.set != null) {
                    for (int i2 = 0; i2 < stickerSetCovered.covers.size(); i2++) {
                        if (((TLRPC.Document) stickerSetCovered.covers.get(i2)).f1618id == stickerSetCovered.set.thumb_document_id) {
                ...
                if (!tL_stickerSetFullCovered.documents.isEmpty()) {
                    ...
                    for (int i3 = 0; i3 < arrayList2.size(); i3++) {
                        if (((TLRPC.Document) arrayList2.get(i3)).f1618id == stickerSetCovered.set.thumb_document_id) {
        ...
        this.isInstalled = z3 || MediaDataController.getInstance(this.currentAccount).isStickerPackInstalled(stickerSetCovered2.set.f1646id);
    ...
    class C31922 extends AnimatorListenerAdapter {
        C31922() {
        }
    ...
    protected void onDraw(Canvas canvas) {
        if (this.needDivider) {
            canvas.drawLine(LocaleController.isRTL ? 0.0f : AndroidUtilities.m1081dp(71.0f), getHeight() - 1, getWidth() - (LocaleController.isRTL ? AndroidUtilities.m1081dp(71.0f) : 0), getHeight() - 1, Theme.dividerPaint);
        }
    }
    ...
    public static final class Factory extends UItem.UItemFactory {
        ...
        public static UItem m1175of(TLRPC.StickerSetCovered stickerSetCovered) {
