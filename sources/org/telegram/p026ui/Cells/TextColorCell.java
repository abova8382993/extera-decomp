...
public class TextColorCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(50.0f) + (this.needDivider ? 1 : 0), TLObject.FLAG_30));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.needDivider) {
            canvas2 = canvas;
            canvas2.drawLine(LocaleController.isRTL ? 0.0f : AndroidUtilities.m1081dp(20.0f), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m1081dp(20.0f) : 0), getMeasuredHeight() - 1, Theme.dividerPaint);
        } else {
            canvas2 = canvas;
        }
        ...
        if (i != 0) {
            ...
            canvas2.drawCircle(LocaleController.isRTL ? AndroidUtilities.m1081dp(33.0f) : getMeasuredWidth() - AndroidUtilities.m1081dp(33.0f), getMeasuredHeight() / 2, AndroidUtilities.m1081dp(10.0f), colorPaint);
        }
    }
}
