...
public class TextDetailCell extends FrameLayout {
    ...
    public TextDetailCell(Context context, int i, Theme.ResourcesProvider resourcesProvider, boolean z, boolean z2) {
        ...
        if (z) {
            setMinimumHeight(AndroidUtilities.m1081dp(60.0f));
        } else {
        ...
        spoilersTextView.setPadding(AndroidUtilities.m1081dp(6.0f), AndroidUtilities.m1081dp(2.0f), AndroidUtilities.m1081dp(6.0f), AndroidUtilities.m1081dp(5.0f));
        float f = i - 6;
        ...
        linksTextView.setPadding(0, AndroidUtilities.m1081dp(1.0f), 0, AndroidUtilities.m1081dp(6.0f));
        if (z) {
            float f2 = i;
        ...
        linksTextView2.setPadding(0, AndroidUtilities.m1081dp(1.0f), 0, AndroidUtilities.m1081dp(6.0f));
        if (z) {
            float f4 = i;
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (!this.multiline) {
            i2 = View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(60.0f) + (this.needDivider ? 1 : 0), TLObject.FLAG_30);
        }
    ...
    public void setImage(Drawable drawable, CharSequence charSequence) {
        ((ViewGroup.MarginLayoutParams) this.valueTextView.getLayoutParams()).rightMargin = (LocaleController.isRTL || drawable == null) ? AndroidUtilities.m1081dp(23.0f) : AndroidUtilities.m1081dp(58.0f);
        ...
        if (drawable == null) {
            ...
            this.imageView.setBackground(Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m1081dp(48.0f), 0, Theme.getColor(Theme.key_listSelector, this.resourcesProvider)));
            this.imageView.setImportantForAccessibility(1);
        }
        int iM1081dp = AndroidUtilities.m1081dp(23.0f) + (drawable != null ? AndroidUtilities.m1081dp(48.0f) : 0);
    ...
    protected void onDraw(Canvas canvas) {
        if (this.needDivider) {
            ...
            canvas.drawLine(LocaleController.isRTL ? 0.0f : AndroidUtilities.m1081dp(20.0f), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m1081dp(20.0f) : 0), getMeasuredHeight() - 1, paint);
        }
    }
