...
public class StickerSetCell extends FrameLayout {
    ...
    public StickerSetCell(Context context, Theme.ResourcesProvider resourcesProvider, int i) {
        ...
        if (i != 0) {
            ...
            if (i == 1) {
                ...
                this.optionsButton.setImageResource(C2702R.drawable.msg_actions);
                ...
                this.reorderButton.setImageResource(C2702R.drawable.list_reorder);
                ...
                this.optionsButton.setImageResource(C2702R.drawable.floating_check);
        ...
        PremiumButtonView premiumButtonView = new PremiumButtonView(context, AndroidUtilities.m1081dp(4.0f), false, resourcesProvider);
        this.premiumButtonView = premiumButtonView;
        premiumButtonView.setIcon(C2702R.raw.unlock_icon);
        this.premiumButtonView.setButton(LocaleController.getString(C2702R.string.Unlock), new View.OnClickListener() { // from class: org.telegram.ui.Cells.StickerSetCell$$ExternalSyntheticLambda7
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        try {
            ...
            ((ViewGroup.MarginLayoutParams) this.premiumButtonView.getTextView().getLayoutParams()).leftMargin = AndroidUtilities.m1081dp(3.0f);
        ...
        this.sideButtons.setPadding(AndroidUtilities.m1081dp(10.0f), 0, AndroidUtilities.m1081dp(10.0f), 0);
        ...
        C32481 c32481 = new TextView(context) { // from class: org.telegram.ui.Cells.StickerSetCell.1
            C32481(Context context2) {
                super(context2);
            }
        ...
        this.textView = c32481;
        NotificationCenter.listenEmojiLoading(c32481);
        ...
        if (i == 3) {
            ...
            imageView6.setImageResource(C2702R.drawable.msg_close);
            this.deleteView.setPadding(AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(8.0f));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(58.0f) + (this.needDivider ? 1 : 0), TLObject.FLAG_30));
    }
    ...
    public void setStickersSet(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, boolean z, boolean z2) {
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            while (true) {
                ...
                if (document != null && document.f1618id == tL_messages_stickerSet.set.thumb_document_id) {
                    break;
                } else {
                    i++;
                }
    ...
    public /* synthetic */ void lambda$setStickersSet$4(TLRPC.Document document) {
        if (this.stickersSet.documents.isEmpty()) {
            ...
            if (tL_messages_stickerSet.set.thumb_document_id == document.f1618id) {
    ...
    public void setChecked(boolean z, boolean z2) {
        ...
        if (this.emojis) {
            ...
            this.sideButtons.setVisibility(z3 ? 0 : 4);
            if (!z3) {
    ...
    class C32492 extends AnimatorListenerAdapter {
        final /* synthetic */ boolean val$checked;
    ...
    class C32503 extends AnimatorListenerAdapter {
        final /* synthetic */ boolean val$checked;
    ...
    protected void onDraw(Canvas canvas) {
        if (this.needDivider) {
            canvas.drawLine(LocaleController.isRTL ? 0.0f : AndroidUtilities.m1081dp(71.0f), getHeight() - 1, (getWidth() - getPaddingRight()) - (LocaleController.isRTL ? AndroidUtilities.m1081dp(71.0f) : 0), getHeight() - 1, Theme.dividerPaint);
        }
    }

    public void updateRightMargin() {
        this.sideButtons.measure(View.MeasureSpec.makeMeasureSpec(999999, Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(58.0f), TLObject.FLAG_30));
        int iM1081dp = AndroidUtilities.m1081dp(26.0f) + this.sideButtons.getMeasuredWidth();
        if (LocaleController.isRTL) {
            ((ViewGroup.MarginLayoutParams) this.textView.getLayoutParams()).leftMargin = iM1081dp;
            ((ViewGroup.MarginLayoutParams) this.valueTextView.getLayoutParams()).leftMargin = iM1081dp;
        } else {
            ((ViewGroup.MarginLayoutParams) this.textView.getLayoutParams()).rightMargin = iM1081dp;
            ((ViewGroup.MarginLayoutParams) this.valueTextView.getLayoutParams()).rightMargin = iM1081dp;
        }
    }
    ...
    public void updateButtonState(int i, boolean z) {
        ...
        if (i == 1) {
            this.premiumButtonView.setButton(LocaleController.getString(C2702R.string.Unlock), new View.OnClickListener() { // from class: org.telegram.ui.Cells.StickerSetCell$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            this.premiumButtonView.setButton(LocaleController.getString(C2702R.string.Restore), new View.OnClickListener() { // from class: org.telegram.ui.Cells.StickerSetCell$$ExternalSyntheticLambda1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    class C32514 extends AnimatorListenerAdapter {
        final /* synthetic */ int val$state;
    ...
    public static final class Factory extends UItem.UItemFactory {
        ...
        public void bindView(View view, UItem uItem, boolean z, UniversalAdapter universalAdapter, UniversalRecyclerView universalRecyclerView) {
            ...
            boolean zIsStickerPackInstalled = MediaDataController.getInstance(universalAdapter.currentAccount).isStickerPackInstalled(tL_messages_stickerSet.set.f1646id);
        ...
        public static UItem m1180of(TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
