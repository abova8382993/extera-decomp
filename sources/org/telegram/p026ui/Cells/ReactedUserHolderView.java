...
import org.telegram.p026ui.Components.MessageSeenCheckDrawable;
import org.telegram.p026ui.Components.StatusBadgeComponent;
...
public class ReactedUserHolderView extends FrameLayout {
    ...
    static {
        int i = C2702R.drawable.msg_mini_checks;
        int i2 = Theme.key_windowBackgroundWhiteGrayText;
        seenDrawable = new MessageSeenCheckDrawable(i, i2);
        reactDrawable = new MessageSeenCheckDrawable(C2702R.drawable.msg_reactions, i2, 16, 16, 5.66f);
        int i3 = C2702R.drawable.mini_repost_story;
        int i4 = Theme.key_stories_circle1;
        repostDrawable = new MessageSeenCheckDrawable(i3, i4);
        forwardDrawable = new MessageSeenCheckDrawable(C2702R.drawable.mini_forward_story, i4);
    }
    ...
    public ReactedUserHolderView(int i, int i2, Context context, Theme.ResourcesProvider resourcesProvider, boolean z, boolean z2) {
        ...
        this.params = new StoriesUtilities.AvatarStoryParams(false, resourcesProvider) { // from class: org.telegram.ui.Cells.ReactedUserHolderView.1
            C32261(boolean z3, Theme.ResourcesProvider resourcesProvider2) {
        ...
        setLayoutParams(new RecyclerView.LayoutParams(-1, AndroidUtilities.m1081dp(50.0f)));
        int i3 = i == STYLE_STORY ? 48 : 34;
        C32272 c32272 = new BackupImageView(context) { // from class: org.telegram.ui.Cells.ReactedUserHolderView.2
            final /* synthetic */ int val$style;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C32272(Context context2, int i4) {
                super(context2);
                i = i4;
            }
        ...
        this.avatarView = c32272;
        float f = i3;
        c32272.setRoundRadius(ExteraConfig.getAvatarCorners(f));
        ...
        C32283 c32283 = new SimpleTextView(context2) { // from class: org.telegram.ui.Cells.ReactedUserHolderView.3
            C32283(Context context2) {
                super(context2);
            }
        ...
        this.titleView = c32283;
        NotificationCenter.listenEmojiLoading(c32283);
        ...
        this.titleView.setRightPadding(AndroidUtilities.m1081dp(30.0f));
        this.titleView.setTranslationX(LocaleController.isRTL ? AndroidUtilities.m1081dp(30.0f) : 0.0f);
        ...
        this.titleView.setDrawablePadding(AndroidUtilities.m1081dp(3.0f));
        ...
        this.subtitleView.setTranslationX(LocaleController.isRTL ? AndroidUtilities.m1081dp(30.0f) : 0.0f);
    ...
    class C32261 extends StoriesUtilities.AvatarStoryParams {
        C32261(boolean z3, Theme.ResourcesProvider resourcesProvider2) {
            super(z3, resourcesProvider2);
        }
    ...
    class C32272 extends BackupImageView {
        final /* synthetic */ int val$style;
    ...
    class C32283 extends SimpleTextView {
        C32283(Context context2) {
            super(context2);
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:497:0x01cd  */
    /* JADX WARN: Removed duplicated region for block: B:500:0x01ed  */
    /* JADX WARN: Removed duplicated region for block: B:528:0x02f7  */
    /* JADX WARN: Removed duplicated region for block: B:531:0x030e  */
    /* JADX WARN: Removed duplicated region for block: B:532:0x0310  */
    /* JADX WARN: Removed duplicated region for block: B:538:0x0326  */
    /* JADX WARN: Removed duplicated region for block: B:544:0x033b  */
    ...
    */
    public void setUserReaction(org.telegram.tgnet.TLRPC.User r19, org.telegram.tgnet.TLRPC.Chat r20, org.telegram.tgnet.TLRPC.Reaction r21, boolean r22, long r23, org.telegram.tgnet.tl.TL_stories.StoryItem r25, boolean r26, boolean r27, boolean r28) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.Cells.ReactedUserHolderView.setUserReaction(org.telegram.tgnet.TLRPC$User, org.telegram.tgnet.TLRPC$Chat, org.telegram.tgnet.TLRPC$Reaction, boolean, long, org.telegram.tgnet.tl.TL_stories$StoryItem, boolean, boolean, boolean):void");
    }
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(this.style == STYLE_DEFAULT ? 50 : 58), TLObject.FLAG_30));
    }
    ...
    class C32294 extends AnimatorListenerAdapter {
        final /* synthetic */ float val$alpha;
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (this.drawDivider) {
            float fM1081dp = AndroidUtilities.m1081dp(this.style == STYLE_STORY ? 73.0f : 55.0f);
            if (LocaleController.isRTL) {
                canvas.drawLine(0.0f, getMeasuredHeight() - 1, getMeasuredWidth() - fM1081dp, getMeasuredHeight() - 1, Theme.getThemePaint("paintDivider", this.resourcesProvider));
            } else {
                canvas.drawLine(fM1081dp, getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, Theme.getThemePaint("paintDivider", this.resourcesProvider));
            }
        }
        if (z) {
            canvas.restore();
