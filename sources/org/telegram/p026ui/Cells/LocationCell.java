...
public class LocationCell extends FrameLayout {
    ...
    public LocationCell(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        ShapeDrawable shapeDrawableCreateCircleDrawable = Theme.createCircleDrawable(AndroidUtilities.m1081dp(42.0f), -1);
        this.circleDrawable = shapeDrawableCreateCircleDrawable;
        backupImageView.setBackground(shapeDrawableCreateCircleDrawable);
        this.imageView.setSize(AndroidUtilities.m1081dp(30.0f), AndroidUtilities.m1081dp(30.0f));
        ...
        this.nameTextView.setTextSize(AndroidUtilities.m1081dp(16.0f));
        ...
        this.addressTextView.setTextSize(AndroidUtilities.m1081dp(14.0f));
    ...
    protected void onMeasure(int i, int i2) {
        if (this.wrapContent) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(64.0f) + (this.needDivider ? 1 : 0), TLObject.FLAG_30));
        } else {
    ...
    public void setLocation(TLRPC.TL_messageMediaVenue tL_messageMediaVenue, String str, int i, boolean z, boolean z2) {
        ...
        if (tL_messageMediaVenue != null && (str2 = tL_messageMediaVenue.icon) != null) {
            if ("pin".equals(str2) || tL_messageMediaVenue.icon.startsWith("emoji")) {
                Drawable drawableMutate = getResources().getDrawable(C2702R.drawable.pin).mutate();
                ...
                CombinedDrawable combinedDrawable = new CombinedDrawable(Theme.createCircleDrawable(AndroidUtilities.m1081dp(42.0f), 0), drawableMutate);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        globalGradientView.setParentSize(getMeasuredWidth(), getMeasuredHeight(), (-(getParent() instanceof ViewGroup ? ((ViewGroup) getParent()).indexOfChild(this) : 0)) * AndroidUtilities.m1081dp(56.0f));
        ...
        canvas.translate(AndroidUtilities.m1081dp(2.0f), (getMeasuredHeight() - AndroidUtilities.m1081dp(56.0f)) / 2);
        ...
        if (this.needDivider) {
            ...
            canvas.drawLine(LocaleController.isRTL ? 0.0f : AndroidUtilities.m1081dp(72.0f), getHeight() - 1, LocaleController.isRTL ? getWidth() - AndroidUtilities.m1081dp(72.0f) : getWidth(), getHeight() - 1, paint);
        }
    }
