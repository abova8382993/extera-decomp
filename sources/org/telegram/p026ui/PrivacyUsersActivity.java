...
public class PrivacyUsersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        if (i == 1) {
            this.actionBar.setTitle(LocaleController.getString(C2702R.string.BlockedUsers));
        } else if (i == 2) {
        ...
        if (this.currentType == 1) {
            emptyTextProgressView.setText(LocaleController.getString(C2702R.string.NoBlocked));
        } else {
            emptyTextProgressView.setText(LocaleController.getString(C2702R.string.NoContacts));
        }
    ...
    public void showUnblockAlert(final Long l, View view) {
        ...
        int i = this.currentType;
        itemOptionsAddIf.addIf(i != 1, i == 0 ? C2702R.drawable.msg_user_remove : 0, (CharSequence) LocaleController.getString(C2702R.string.Remove), true, new Runnable() { // from class: org.telegram.ui.PrivacyUsersActivity$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
    ...
    class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                textCell.setText(LocaleController.getString(C2702R.string.NotificationsDeleteAllException), false);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType != 0) {
                if (itemViewType == 1) {
                    ...
                    if (i == PrivacyUsersActivity.this.blockUserDetailRow) {
                        if (PrivacyUsersActivity.this.currentType == 1) {
                            ...
                            textInfoPrivacyCell.setText(LocaleController.getString(C2702R.string.BlockedUsersInfo));
                            return;
                        } else {
                ...
                if (itemViewType == 2) {
                    ...
                    if (PrivacyUsersActivity.this.currentType == 1) {
                        manageChatTextCell.setText(LocaleController.getString(C2702R.string.BlockUser), null, C2702R.drawable.msg_contact_add, false);
                        return;
                    } else {
                        manageChatTextCell.setText(LocaleController.getString(C2702R.string.PrivacyAddAnException), null, C2702R.drawable.msg_contact_add, PrivacyUsersActivity.this.uidArray.size() > 0);
                        return;
                    }
                }
                if (itemViewType != 3) {
                ...
                if (i == PrivacyUsersActivity.this.usersHeaderRow) {
                    if (PrivacyUsersActivity.this.currentType == 1) {
                        ...
                        headerCell.setText(LocaleController.getString(C2702R.string.PrivacyExceptions));
                        return;
                    }
                }
                return;
            ...
            if (jLongValue > 0) {
                ...
                if (user != null) {
                    if (user.bot) {
                        string2 = LocaleController.getString(C2702R.string.Bot).substring(0, 1).toUpperCase() + LocaleController.getString(C2702R.string.Bot).substring(1);
                    } else {
                        String str = user.phone;
                        if (str != null && str.length() != 0) {
                            string2 = PhoneFormat.getInstance().format("+" + user.phone);
                        } else {
                            string2 = LocaleController.getString(C2702R.string.NumberUnknown);
                        }
                    }
            ...
            if (chat != null) {
                ...
                if (i2 != 0) {
                    ...
                    string = LocaleController.getString(C2702R.string.MegaLocation);
