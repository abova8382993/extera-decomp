...
import org.telegram.p026ui.LNavigation.NavigationExt;
...
public class ContactAddActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, ImageUpdater.ImageUpdaterDelegate {
    ...
    public View createView(final Context context) {
        ...
        if (this.addContact) {
            this.actionBar.setTitle(LocaleController.getString(C2702R.string.NewContact));
        } else {
            this.actionBar.setTitle(LocaleController.getString(C2702R.string.EditContact));
        }
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.ContactAddActivity.1
            ...
            public void onItemClick(int i) {
                ...
                if (userFull != null) {
                    ...
                    ContactAddActivity.this.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.userInfoDidLoad, Long.valueOf(userFull.f1776id), userFull);
                }
                ContactAddActivity.this.finishFragment();
        ...
        this.doneButton = this.actionBar.createMenu().addItem(1, LocaleController.getString(C2702R.string.Done).toUpperCase());
        ...
        C52572 c52572 = new View(context) { // from class: org.telegram.ui.ContactAddActivity.2
            final /* synthetic */ Paint val$paint;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C52572(final Context context2, Paint paint2) {
                super(context2);
                paint = paint2;
            }
        ...
        this.avatarOverlay = c52572;
        this.infoLayout.addView(c52572, LayoutHelper.createFrame(64, 64.0f, (LocaleController.isRTL ? 5 : 3) | 48, 16.0f, 13.0f, 16.0f, 13.0f));
        ...
        EditTextCell editTextCell = new EditTextCell(context2, LocaleController.getString(C2702R.string.FirstName), false, false, -1, this.resourcesProvider);
        ...
        this.firstNameField.editText.setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: org.telegram.ui.ContactAddActivity.3
            ...
            ViewOnFocusChangeListenerC52583() {
            }
        ...
        EditTextCell editTextCell2 = new EditTextCell(context2, LocaleController.getString(C2702R.string.LastName), false, false, -1, this.resourcesProvider);
        ...
        EditTextCell editTextCell3 = new EditTextCell(context2, LocaleController.getString(C2702R.string.AddNotes), true, true, getMessagesController().config.contactNoteLengthLimit.get(), this.resourcesProvider);
        ...
        if (!this.addContact) {
            ...
            textCell.setTextAndIcon((CharSequence) LocaleController.formatString(C2702R.string.SuggestUserPhoto, user.first_name), C2702R.drawable.msg_addphoto, true);
            ...
            final RLottieDrawable rLottieDrawable = new RLottieDrawable(C2702R.raw.photo_suggest_icon, _UrlKt.FRAGMENT_ENCODE_SET + C2702R.raw.photo_suggest_icon, AndroidUtilities.m1081dp(50.0f), AndroidUtilities.m1081dp(50.0f), false, null);
            this.suggestPhoto.imageView.setTranslationX((float) (-AndroidUtilities.m1081dp(8.0f)));
            ...
            textCell3.setTextAndIcon((CharSequence) LocaleController.formatString(C2702R.string.UserSetPhoto, user.first_name), C2702R.drawable.msg_addphoto, false);
            this.setAvatarCell.setBackground(Theme.getSelectorDrawable(true, this.resourcesProvider));
            this.setAvatarCell.setColors(i3, i4);
            final RLottieDrawable rLottieDrawable2 = new RLottieDrawable(C2702R.raw.camera_outline, _UrlKt.FRAGMENT_ENCODE_SET + C2702R.raw.camera_outline, AndroidUtilities.m1081dp(50.0f), AndroidUtilities.m1081dp(50.0f), false, null);
            this.setAvatarCell.imageView.setTranslationX((float) (-AndroidUtilities.m1081dp(8.0f)));
            ...
            this.oldPhotoCell = new TextCell(context2, this.resourcesProvider) { // from class: org.telegram.ui.ContactAddActivity.4
                C52594(final Context context2, Theme.ResourcesProvider resourcesProvider) {
                ...
                protected void onMeasure(int i5, int i6) {
                    ...
                    ContactAddActivity.this.oldAvatarView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(30.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(30.0f), TLObject.FLAG_30));
                ...
                protected void onLayout(boolean z3, int i5, int i6, int i7, int i8) {
                    ...
                    ContactAddActivity.this.oldAvatarView.layout(iM1081dp, measuredHeight, ContactAddActivity.this.oldAvatarView.getMeasuredWidth() + iM1081dp, ContactAddActivity.this.oldAvatarView.getMeasuredHeight() + measuredHeight);
                }
            };
            ...
            this.oldPhotoCell.setText(LocaleController.getString(C2702R.string.ResetToOriginalPhoto), false);
            ...
            textCell4.setTextAndIcon((CharSequence) LocaleController.formatString(C2702R.string.UserSuggestBirthday, new Object[0]), C2702R.drawable.menu_birthday, false);
            ...
            this.suggestBirthday.imageView.setTranslationX(AndroidUtilities.m1081dp(4.0f));
        ...
        this.listView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.ContactAddActivity.5
            ...
            C52605(FrameLayout frameLayout5) {
        ...
        frameLayout5.addView(this.listView, LayoutHelper.createFrame(-1, -1, Opcodes.DNEG));
    ...
    class C52561 extends ActionBar.ActionBarMenuOnItemClick {
        C52561() {
        }
    ...
    class ViewOnFocusChangeListenerC52583 implements View.OnFocusChangeListener {
        boolean focused;
    ...
    public /* synthetic */ void lambda$createView$10(Context context, final TLRPC.User user, View view) {
        AlertsCreator.createSimpleAlert(context, LocaleController.getString(C2702R.string.ResetToOriginalPhotoTitle), LocaleController.formatString(C2702R.string.ResetToOriginalPhotoMessage, user.first_name), LocaleController.getString(C2702R.string.Reset), new Runnable() { // from class: org.telegram.ui.ContactAddActivity$$ExternalSyntheticLambda16
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$createView$9(TLRPC.User user) {
        ...
        if (photo != null) {
            user2.photo.photo_id = photo.f1642id;
    ...
    public /* synthetic */ void lambda$createView$14(TLRPC.User user, View view) {
        showDialog(AlertsCreator.createBirthdayPickerDialog(getContext(), LocaleController.formatString(C2702R.string.UserSuggestBirthdayTitle, UserObject.getForcedFirstName(user)), LocaleController.getString(C2702R.string.UserSuggestBirthdayButton), null, new Utilities.Callback() { // from class: org.telegram.ui.ContactAddActivity$$ExternalSyntheticLambda15
    ...
    public /* synthetic */ void lambda$createView$13(TL_account.TL_birthday tL_birthday) {
        ...
        tL_users_suggestBirthday.f1769id = getMessagesController().getInputUser(this.user_id);
    ...
    public /* synthetic */ void lambda$createView$11() {
        presentFragment(ChatActivity.m1188of(this.user_id), true);
    }

    /* JADX INFO: renamed from: org.telegram.ui.ContactAddActivity$5 */
    class C52605 extends RecyclerView.OnScrollListener {
        final /* synthetic */ FrameLayout val$frameLayout;
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        if (TextUtils.isEmpty(getPhone())) {
            arrayList.add(UItem.asShadow(AndroidUtilities.replaceCharSequence("%1$s", AndroidUtilities.replaceTags(LocaleController.getString(C2702R.string.MobileHiddenExceptionInfo)), UserObject.getFirstName(user))));
        } else if (this.needAddException) {
            arrayList.add(UItem.asShadow(AndroidUtilities.replaceTags(LocaleController.formatString("MobileVisibleInfo", C2702R.string.MobileVisibleInfo, UserObject.getFirstName(user)))));
        } else {
            arrayList.add(UItem.asShadow(null));
        }
        if (this.addContact && this.needAddException) {
            this.checkShare = false;
            arrayList.add(UItem.asCheck(2, LocaleController.getString(C2702R.string.AddContactShareNumber)).setChecked(this.checkShare));
            arrayList.add(UItem.asShadow(LocaleController.formatString(C2702R.string.AddContactShareNumberInfo, UserObject.getFirstName(user))));
        }
        arrayList.add(UItem.asCustom(this.noteField));
        arrayList.add(UItem.asShadow(LocaleController.getString(C2702R.string.AddNotesInfo)));
        if (!this.addContact) {
            TLRPC.UserFull userFull = getMessagesController().getUserFull(this.user_id);
            ...
            arrayList.add(UItem.asShadow(null));
            arrayList.add(UItem.asButton(1, LocaleController.getString(C2702R.string.DeleteContact)).red());
        }
        arrayList.add(UItem.asShadow(null));
        if (this.firstSet) {
    ...
    public void onItemClick(UItem uItem, View view, int i, float f, float f2) {
        ...
        if (i2 == 1) {
            ...
            new AlertDialog.Builder(getParentActivity(), this.resourcesProvider).setTitle(LocaleController.getString(C2702R.string.DeleteContact)).setMessage(LocaleController.getString(C2702R.string.AreYouSureDeleteContact)).setPositiveButton(LocaleController.getString(C2702R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ContactAddActivity$$ExternalSyntheticLambda12
    ...
    class C52616 extends AnimatorListenerAdapter {
        final /* synthetic */ boolean val$show;
    ...
    private void updateAvatarLayout() {
        ...
        if (TextUtils.isEmpty(getPhone())) {
            this.nameTextView.setText(LocaleController.getString(C2702R.string.MobileHidden));
        } else {
    ...
    public /* synthetic */ void lambda$sendPhotoChangedRequest$21(TLRPC.FileLocation fileLocation, TLRPC.InputFile inputFile, TLObject tLObject, TLRPC.FileLocation fileLocation2, int i) {
        ...
        if (user != null) {
            ...
            if (getParentActivity() != null) {
                if (i == 2) {
                    BulletinFactory.m1195of(this).createUsersBulletin(arrayList2, AndroidUtilities.replaceTags(LocaleController.formatString("UserCustomPhotoSeted", C2702R.string.UserCustomPhotoSeted, user.first_name))).show();
                } else {
                    BulletinFactory.m1195of(this).createUsersBulletin(arrayList2, AndroidUtilities.replaceTags(LocaleController.formatString("UserCustomPhotoSeted", C2702R.string.UserCustomPhotoSeted, user.first_name))).show();
                }
            }
