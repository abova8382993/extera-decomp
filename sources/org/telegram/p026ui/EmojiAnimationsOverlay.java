...
import org.telegram.p026ui.Components.StickerSetBulletinLayout;
import org.telegram.p026ui.Components.StickersAlert;
import org.telegram.p026ui.Stories.StoryReactionWidgetView;
...
public class EmojiAnimationsOverlay implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void checkStickerPack() {
        ...
        if (this.set != null) {
            ...
            for (int i = 0; i < this.set.documents.size(); i++) {
                map.put(Long.valueOf(((TLRPC.Document) this.set.documents.get(i)).f1618id), (TLRPC.Document) this.set.documents.get(i));
            }
    ...
    class RunnableC53771 implements Runnable {
        final /* synthetic */ int val$animation;
        final /* synthetic */ int val$messageId;
                        ...
                        if (drawingObject.isMessageEffect && (childAt instanceof ChatMessageCell)) {
                            ...
                            if (drawingObject.isPremiumSticker) {
                                ...
                                if (drawingObject.isOut) {
                                    fM1081dp = ((-photoImage.getImageWidth()) * 2.0f) + AndroidUtilities.m1081dp(24.0f);
                                } else {
                                    fM1081dp = -AndroidUtilities.m1081dp(24.0f);
                                }
                                float f5 = imageX + fM1081dp;
    ...
    public boolean onTapItem(ChatMessageCell chatMessageCell, ChatActivity chatActivity, boolean z) {
        ...
        if ((printingStringType == null || printingStringType.intValue() != 5) && this.hintRunnable == null && zShowAnimationForCell && ((Bulletin.getVisibleBulletin() == null || !Bulletin.getVisibleBulletin().isShowing()) && SharedConfig.emojiInteractionsHintCount > 0 && UserConfig.getInstance(this.currentAccount).getClientUserId() != chatActivity.currentUser.f1775id)) {
            ...
            stickerSetBulletinLayout.titleTextView.setText(Emoji.replaceEmoji(AndroidUtilities.replaceTags(LocaleController.formatString("EmojiInteractionTapHint", C2702R.string.EmojiInteractionTapHint, chatActivity.currentUser.first_name)), stickerSetBulletinLayout.titleTextView.getPaint().getFontMetricsInt(), false));
            ...
            RunnableC53782 runnableC53782 = new Runnable() { // from class: org.telegram.ui.EmojiAnimationsOverlay.2
                final /* synthetic */ Bulletin val$bulletin;

                RunnableC53782(Bulletin bulletin) {
                    bulletin = bulletin;
                }
            ...
            this.hintRunnable = runnableC53782;
            AndroidUtilities.runOnUIThread(runnableC53782, 1500L);
        }
        return zShowAnimationForCell;
    }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class RunnableC53782 implements Runnable {
        final /* synthetic */ Bulletin val$bulletin;
    ...
    public boolean showAnimationForActionCell(ChatActionCell chatActionCell, TLRPC.Document document, TLRPC.VideoSize videoSize) {
        ...
        for (int i3 = 0; i3 < this.drawingObjects.size(); i3++) {
            ...
            if (((DrawingObject) this.drawingObjects.get(i3)).document != null && document != null && ((DrawingObject) this.drawingObjects.get(i3)).document.f1618id == document.f1618id) {
                i2++;
            }
        }
        if (i >= 4) {
        ...
        if (i2 > 0) {
            Integer num = (Integer) this.lastAnimationIndex.get(Long.valueOf(document.f1618id));
            int iIntValue = num == null ? 0 : num.intValue();
            this.lastAnimationIndex.put(Long.valueOf(document.f1618id), Integer.valueOf((iIntValue + 1) % 4));
    ...
    private void preloadAnimation(TLRPC.Document document) {
        ...
        if (map == null || !map.containsKey(Long.valueOf(document.f1618id))) {
            if (this.preloaded == null) {
                this.preloaded = new HashMap();
            }
            this.preloaded.put(Long.valueOf(document.f1618id), Boolean.TRUE);
            ...
            if (z9 || ((arrayList != null && !arrayList.isEmpty()) || z8)) {
                ...
                while (i4 < this.drawingObjects.size()) {
                    ...
                    if (((DrawingObject) this.drawingObjects.get(i4)).document == null || document == null) {
                        ...
                        z5 = z7;
                        z6 = z8;
                        if (((DrawingObject) this.drawingObjects.get(i4)).document.f1618id == document.f1618id) {
                            i6++;
                        }
                    }
                    i4++;
                ...
                if (z && z11 && i5 > 0) {
                    ...
                    if (stickerSetByName == null) {
                        stickerSetByName = MediaDataController.getInstance(this.currentAccount).getStickerSetById(inputStickerSet.f1635id);
                    }
                    if (stickerSetByName == null) {
                ...
                if (z9) {
                    ...
                    while (true) {
                        ...
                        if (document2 != null && document2.f1618id == j2) {
                            break;
                        }
                        i7++;
                    }
                        ...
                        if (messageObject != null && messageObject.isAnimatedAnimatedEmoji()) {
                            if (iAbs < 0 || iAbs > arrayList.size() - 1) {
                                ...
                                for (int i8 = z10 ? 1 : 0; i8 < arrayList.size(); i8++) {
                                    ...
                                    if (document3 != null) {
                                        HashMap map = this.preloaded;
                                        Boolean bool = map != null ? (Boolean) map.get(Long.valueOf(document3.f1618id)) : null;
                ...
                if (premiumStickerAnimation == null) {
                    int filterWidth = getFilterWidth();
                    Integer num = (Integer) this.lastAnimationIndex.get(Long.valueOf(document2.f1618id));
                    if (num == null) {
                        iIntValue2 = z10 ? 1 : 0;
                    } else {
                    ...
                    int i9 = iIntValue2 + 1;
                    this.lastAnimationIndex.put(Long.valueOf(document2.f1618id), Integer.valueOf(i9));
                    ...
                    drawingObject.imageReceiver.setDelegate(new ImageReceiver.ImageReceiverDelegate() { // from class: org.telegram.ui.EmojiAnimationsOverlay.3
                        ...
                        C53793(DrawingObject drawingObject2, boolean z12, final MessageObject messageObject2) {
                    ...
                    if (i6 > 0) {
                        Integer num2 = (Integer) this.lastAnimationIndex.get(Long.valueOf(document2.f1618id));
                        int iIntValue3 = num2 == null ? 0 : num2.intValue();
                        i3 = iAbs;
                        this.lastAnimationIndex.put(Long.valueOf(document2.f1618id), Integer.valueOf((iIntValue3 + 1) % 4));
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C53793 implements ImageReceiver.ImageReceiverDelegate {
        final /* synthetic */ DrawingObject val$drawingObject;
        final /* synthetic */ MessageObject val$messageObject;
        final /* synthetic */ boolean val$sendTap;
    ...
    public void lambda$createDrawingObject$0(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, final MessageObject messageObject) {
        ...
        stickerSetBulletinLayout.subtitleTextView.setText(LocaleController.getString(C2702R.string.PremiumStickerTooltip));
        ...
        undoButton.setText(LocaleController.getString(C2702R.string.ViewAction));
    ...
    */
    public static java.lang.String unwrapEmoji(java.lang.String r8) {
        ...
        L8d:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p026ui.EmojiAnimationsOverlay.unwrapEmoji(java.lang.String):java.lang.String");
    }
