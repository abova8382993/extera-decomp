...
public class PhotoCropActivity extends BaseFragment {
    ...
    class PhotoCropView extends FrameLayout {
        ...
        private void init() {
            ...
            this.rectPaint.setStrokeWidth(AndroidUtilities.m1081dp(2.0f));
        ...
        */
        ...
        private void updateBitmapSize() {
            ...
            this.bitmapX = ((this.viewWidth - this.bitmapWidth) / 2) + AndroidUtilities.m1081dp(14.0f);
            int iM1081dp = ((this.viewHeight - this.bitmapHeight) / 2) + AndroidUtilities.m1081dp(14.0f);
            this.bitmapY = iM1081dp;
            if (this.rectX == -1.0f && this.rectY == -1.0f) {
                if (this.freeform) {
                    ...
                    if (this.bitmapWidth > this.bitmapHeight) {
                        this.rectY = iM1081dp;
                        this.rectX = ((this.viewWidth - r1) / 2) + AndroidUtilities.m1081dp(14.0f);
                        int i5 = this.bitmapHeight;
                        this.rectSizeX = i5;
                        this.rectSizeY = i5;
                    } else {
                        this.rectX = this.bitmapX;
                        this.rectY = ((this.viewHeight - r0) / 2) + AndroidUtilities.m1081dp(14.0f);
        ...
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            ...
            this.viewWidth = (i3 - i) - AndroidUtilities.m1081dp(28.0f);
            this.viewHeight = (i4 - i2) - AndroidUtilities.m1081dp(28.0f);
            updateBitmapSize();
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            float f8 = iM1081dp;
            float f9 = iM1081dp * 3;
            canvas.drawRect(f7 + f8, this.rectY + f8, f7 + f8 + AndroidUtilities.m1081dp(20.0f), this.rectY + f9, this.circlePaint);
            float f10 = this.rectX;
            float f11 = this.rectY;
            canvas.drawRect(f10 + f8, f11 + f8, f10 + f9, f11 + f8 + AndroidUtilities.m1081dp(20.0f), this.circlePaint);
            float fM1081dp = ((this.rectX + this.rectSizeX) - f8) - AndroidUtilities.m1081dp(20.0f);
            float f12 = this.rectY;
            canvas.drawRect(fM1081dp, f12 + f8, (this.rectX + this.rectSizeX) - f8, f12 + f9, this.circlePaint);
            float f13 = this.rectX;
            float f14 = this.rectSizeX;
            float f15 = this.rectY;
            canvas.drawRect((f13 + f14) - f9, f15 + f8, (f13 + f14) - f8, f15 + f8 + AndroidUtilities.m1081dp(20.0f), this.circlePaint);
            canvas.drawRect(this.rectX + f8, ((this.rectY + this.rectSizeY) - f8) - AndroidUtilities.m1081dp(20.0f), this.rectX + f9, (this.rectY + this.rectSizeY) - f8, this.circlePaint);
            float f16 = this.rectX;
            canvas.drawRect(f16 + f8, (this.rectY + this.rectSizeY) - f9, f16 + f8 + AndroidUtilities.m1081dp(20.0f), (this.rectY + this.rectSizeY) - f8, this.circlePaint);
            float fM1081dp2 = ((this.rectX + this.rectSizeX) - f8) - AndroidUtilities.m1081dp(20.0f);
            float f17 = this.rectY;
            float f18 = this.rectSizeY;
            canvas.drawRect(fM1081dp2, (f17 + f18) - f9, (this.rectX + this.rectSizeX) - f8, (f17 + f18) - f8, this.circlePaint);
            canvas.drawRect((this.rectX + this.rectSizeX) - f9, ((this.rectY + this.rectSizeY) - f8) - AndroidUtilities.m1081dp(20.0f), (this.rectX + this.rectSizeX) - f8, (this.rectY + this.rectSizeY) - f8, this.circlePaint);
    ...
    public boolean onFragmentCreate() {
        ...
        if (this.imageToCrop == null) {
            ...
            if (AndroidUtilities.isTablet()) {
                iMax = AndroidUtilities.m1081dp(520.0f);
            } else {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2702R.string.CropImage));
        ...
        this.actionBar.createMenu().addItemWithWidth(1, C2702R.drawable.ic_ab_done, AndroidUtilities.m1081dp(56.0f), LocaleController.getString(C2702R.string.Done));
