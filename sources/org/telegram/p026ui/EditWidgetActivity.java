...
public class EditWidgetActivity extends BaseFragment {
    ...
    public class WidgetPreviewCell extends FrameLayout {
        ...
        public WidgetPreviewCell(Context context) {
            ...
            setPadding(0, AndroidUtilities.m1081dp(24.0f), 0, AndroidUtilities.m1081dp(24.0f));
            LinearLayout linearLayout = new LinearLayout(context);
            linearLayout.setOrientation(1);
            addView(linearLayout, LayoutHelper.createFrame(-2, -2, 17));
            ChatActionCell chatActionCell = new ChatActionCell(context);
            chatActionCell.setCustomText(LocaleController.getString(C2702R.string.WidgetPreview));
            linearLayout.addView(chatActionCell, LayoutHelper.createLinear(-2, -2, 17, 0, 0, 0, 4));
            LinearLayout linearLayout2 = new LinearLayout(context);
            linearLayout2.setOrientation(1);
            linearLayout2.setBackgroundResource(C2702R.drawable.widget_bg);
            ...
            if (EditWidgetActivity.this.widgetType == 0) {
                while (i < 2) {
                    this.cells[i] = (ViewGroup) EditWidgetActivity.this.getParentActivity().getLayoutInflater().inflate(C2702R.layout.shortcut_widget_item, (ViewGroup) null);
                ...
                EditWidgetActivity.this.previewImageView.setImageResource(C2702R.drawable.chats_widget_preview);
            } else if (EditWidgetActivity.this.widgetType == 1) {
                while (i < 2) {
                    this.cells[i] = (ViewGroup) EditWidgetActivity.this.getParentActivity().getLayoutInflater().inflate(C2702R.layout.contacts_widget_item, (ViewGroup) null);
                ...
                EditWidgetActivity.this.previewImageView.setImageResource(C2702R.drawable.contacts_widget_preview);
            }
            updateDialogs();
        ...
        /* JADX WARN: Can't wrap try/catch for region: R(9:1046|(1:1048)(2:1050|(1:1052)(8:1053|(1:1055)(1:1056)|1057|1301|1058|1062|1305|1070))|1049|1057|1301|1058|1062|1305|1070) */
        /* JADX WARN: Code restructure failed: missing block: B:1060:0x03eb, code lost:
        
            r0 = move-exception;
         */
        /* JADX WARN: Code restructure failed: missing block: B:1061:0x03ec, code lost:
        
            org.telegram.messenger.FileLog.m1093e(r0);
         */
        /* JADX WARN: Multi-variable type inference failed */
        /* JADX WARN: Removed duplicated region for block: B:1005:0x0296  */
        /* JADX WARN: Removed duplicated region for block: B:1074:0x043c  */
        /* JADX WARN: Removed duplicated region for block: B:1148:0x0692  */
        /* JADX WARN: Removed duplicated region for block: B:1274:0x08c2  */
        /* JADX WARN: Removed duplicated region for block: B:1287:0x090a  */
        /* JADX WARN: Removed duplicated region for block: B:904:0x008a  */
        /* JADX WARN: Removed duplicated region for block: B:905:0x0095  */
        ...
        */
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1081dp(264.0f), TLObject.FLAG_30));
        }
    ...
    public View createView(final Context context) {
        ...
        if (this.widgetType == 0) {
            this.actionBar.setTitle(LocaleController.getString(C2702R.string.WidgetChats));
        } else {
            this.actionBar.setTitle(LocaleController.getString(C2702R.string.WidgetShortcuts));
        }
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.EditWidgetActivity.1
            ...
            public void onItemClick(int i) {
                ...
                for (int i2 = 0; i2 < EditWidgetActivity.this.selectedDialogs.size(); i2++) {
                    arrayList.add(MessagesStorage.TopicKey.m1115of(((Long) EditWidgetActivity.this.selectedDialogs.get(i2)).longValue(), 0L));
                }
        ...
        this.listView.setOnItemLongClickListener(new C53762());
        return this.fragmentView;
    }

    /* JADX INFO: renamed from: org.telegram.ui.EditWidgetActivity$1 */
    class C53751 extends ActionBar.ActionBarMenuOnItemClick {
        C53751() {
        }
    ...
    class C53762 implements RecyclerListView.OnItemLongClickListenerExtended {
        ...
        public boolean onItemClick(View view, final int i, float f, float f2) {
            if (EditWidgetActivity.this.getParentActivity() != null && (view instanceof GroupCreateUserCell)) {
                ((ImageView) view.getTag(C2702R.id.object_tag)).getHitRect(this.rect);
                if (!this.rect.contains((int) f, (int) f2)) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(EditWidgetActivity.this.getParentActivity());
                    builder.setItems(new CharSequence[]{LocaleController.getString(C2702R.string.Delete)}, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.EditWidgetActivity$2$$ExternalSyntheticLambda0
    ...
    class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                textInfoPrivacyCell.setBackgroundDrawable(Theme.getThemedDrawableByKey(this.mContext, C2702R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                ...
                groupCreateUserCell.setTag(C2702R.id.object_tag, imageView);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (i == EditWidgetActivity.this.infoRow) {
                    ...
                    if (EditWidgetActivity.this.widgetType == 0) {
                        spannableStringBuilder.append((CharSequence) LocaleController.getString(C2702R.string.EditWidgetChatsInfo));
                    } else if (EditWidgetActivity.this.widgetType == 1) {
                        spannableStringBuilder.append((CharSequence) LocaleController.getString(C2702R.string.EditWidgetContactsInfo));
                    }
                    if (SharedConfig.passcodeHash.length() > 0) {
                        spannableStringBuilder.append((CharSequence) "\n\n").append((CharSequence) AndroidUtilities.replaceTags(LocaleController.getString(C2702R.string.WidgetPasscode2)));
                    }
            ...
            textCell.setTextAndIcon(LocaleController.getString(C2702R.string.SelectChats), new CombinedDrawable(drawable, drawable2), EditWidgetActivity.this.chatsStartRow != -1);
            textCell.getImageView().setPadding(0, AndroidUtilities.m1081dp(7.0f), 0, 0);
        }
