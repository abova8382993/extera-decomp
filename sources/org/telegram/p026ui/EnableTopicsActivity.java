...
public class EnableTopicsActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2702R.string.TopicsTitle));
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        arrayList.add(UItem.asTopView(LocaleController.getString(C2702R.string.TopicsInfo), C2702R.raw.topics_top));
        arrayList.add(UItem.asCheck(1, LocaleController.getString(C2702R.string.TopicsEnable)).setChecked(this.forum));
        if (this.forum) {
            arrayList.add(UItem.asShadow(null));
            arrayList.add(UItem.asHeader(LocaleController.getString(C2702R.string.TopicsLayout)));
            ...
            arrayList.add(UItem.asShadow(LocaleController.getString(C2702R.string.TopicsLayoutInfo)));
        }
    }
    ...
    public void onItemClick(UItem uItem, View view, int i, float f, float f2) {
        if (uItem.f2056id != 1 || this.currentChat == null) {
            return;
        }
    ...
    static class TopicsLayoutSwitcher extends LinearLayout {
        ...
        public TopicsLayoutSwitcher(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            setOrientation(0);
            setPadding(AndroidUtilities.m1081dp(8.0f), 0, AndroidUtilities.m1081dp(8.0f), 0);
            FrameLayout frameLayout = new FrameLayout(context);
            ...
            backupImageView.setImageDrawable(new RLottieDrawable(C2702R.raw.topics_tabs, "topics_tabs", AndroidUtilities.m1081dp(160.0f), AndroidUtilities.m1081dp(160.0f)));
            ...
            textViewMakeTextView.setText(LocaleController.getString(C2702R.string.TopicsLayoutTabs));
            textViewMakeTextView.setPadding(AndroidUtilities.m1081dp(12.0f), 0, AndroidUtilities.m1081dp(12.0f), 0);
            frameLayout2.addView(textViewMakeTextView, LayoutHelper.createFrame(-2, -2, 17));
            FrameLayout frameLayout3 = new FrameLayout(context);
            this.leftTitleBackground = frameLayout3;
            frameLayout3.setPadding(AndroidUtilities.m1081dp(12.0f), 0, AndroidUtilities.m1081dp(12.0f), 0);
            int iM1081dp = AndroidUtilities.m1081dp(13.0f);
            int i2 = Theme.key_featuredStickers_addButton;
            frameLayout3.setBackground(Theme.createRoundRectDrawable(iM1081dp, Theme.getColor(i2, resourcesProvider)));
            ...
            textViewMakeTextView2.setText(LocaleController.getString(C2702R.string.TopicsLayoutTabs));
            ...
            backupImageView2.setImageDrawable(new RLottieDrawable(C2702R.raw.topics_list, "topics_list", AndroidUtilities.m1081dp(160.0f), AndroidUtilities.m1081dp(160.0f)));
            ...
            textViewMakeTextView3.setText(LocaleController.getString(C2702R.string.TopicsLayoutList));
            textViewMakeTextView3.setPadding(AndroidUtilities.m1081dp(12.0f), 0, AndroidUtilities.m1081dp(12.0f), 0);
            ...
            frameLayout6.setPadding(AndroidUtilities.m1081dp(12.0f), 0, AndroidUtilities.m1081dp(12.0f), 0);
            frameLayout6.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1081dp(13.0f), Theme.getColor(i2, resourcesProvider)));
            ...
            textViewMakeTextView4.setText(LocaleController.getString(C2702R.string.TopicsLayoutList));
