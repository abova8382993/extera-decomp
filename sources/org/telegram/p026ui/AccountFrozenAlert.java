...
public abstract class AccountFrozenAlert {
    ...
    public static void show(final Context context, final int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        rLottieImageView.setAnimation(C2702R.raw.media_forbidden, AndroidUtilities.m1081dp(115.0f), AndroidUtilities.m1081dp(115.0f));
        ...
        textView.setText(LocaleController.getString(C2702R.string.AccountFrozenTitle));
        ...
        featureCell.set(C2702R.drawable.msg_block2, LocaleController.getString(C2702R.string.AccountFrozen1Title), LocaleController.getString(C2702R.string.AccountFrozen1Text));
        ...
        featureCell2.set(C2702R.drawable.menu_privacy, LocaleController.getString(C2702R.string.AccountFrozen2Title), LocaleController.getString(C2702R.string.AccountFrozen2Text));
        ...
        featureCell3.set(C2702R.drawable.menu_feature_hourglass, LocaleController.getString(C2702R.string.AccountFrozen3Title), AndroidUtilities.replaceSingleTag(LocaleController.formatString(C2702R.string.AccountFrozen3Text, LocaleController.formatYearMonthDay(MessagesController.getInstance(i).freezeUntilDate, true)), new Runnable() { // from class: org.telegram.ui.AccountFrozenAlert$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                runnable.run();
            }
        ...
        buttonWithCounterView.setText(LocaleController.getString(C2702R.string.AccountFrozenButtonAppeal), false);
        ...
        buttonWithCounterView2.setText(LocaleController.getString(C2702R.string.AccountFrozenButtonUnderstood), false);
