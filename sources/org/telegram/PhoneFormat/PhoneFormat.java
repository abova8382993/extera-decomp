    ...
    public CallingCodeInfo callingCodeInfo(String str) {
        ...
        while (i3 < sValue163) {
            ...
            while (i4 < sValue164) {
                ...
                if (iIndexOf != -1) {
                    int iIndexOf2 = phoneRule.format.indexOf("]]");
                    String strSubstring = phoneRule.format.substring(0, iIndexOf);
                    String strSubstring2 = phoneRule.format.substring(iIndexOf2 + 2);
                    Object[] objArr = new Object[2];
                    objArr[0] = strSubstring;
                    objArr[b == true ? 1 : 0] = strSubstring2;
                    phoneRule.format = String.format("%s%s", objArr);
                }
                arrayList4.add(phoneRule);
                if (phoneRule.hasIntlPrefix) {
                    z2 = b == true ? 1 : 0;
                    ruleSet.hasRuleWithIntlPrefix = z2;
                } else {
                    z2 = b == true ? 1 : 0;
                }
