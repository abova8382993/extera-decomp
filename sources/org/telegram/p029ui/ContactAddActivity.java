...
import org.telegram.p029ui.LNavigation.NavigationExt;
...
public class ContactAddActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, ImageUpdater.ImageUpdaterDelegate {
    ...
    public View createView(final Context context) {
        ...
        if (this.addContact) {
            this.actionBar.setTitle(LocaleController.getString(C2888R.string.NewContact));
        } else {
            this.actionBar.setTitle(LocaleController.getString(C2888R.string.EditContact));
        }
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.ContactAddActivity.1
            ...
            public void onItemClick(int i) {
                ...
                if (userFull != null) {
                    ...
                    ContactAddActivity.this.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.userInfoDidLoad, Long.valueOf(userFull.f1826id), userFull);
                }
                ContactAddActivity.this.finishFragment();
        ...
        this.doneButton = this.actionBar.createMenu().addItem(1, LocaleController.getString(C2888R.string.Done).toUpperCase());
        ...
        EditTextCell editTextCell = new EditTextCell(context, LocaleController.getString(C2888R.string.FirstName), false, false, -1, this.resourcesProvider);
        ...
        EditTextCell editTextCell2 = new EditTextCell(context, LocaleController.getString(C2888R.string.LastName), false, false, -1, this.resourcesProvider);
        ...
        EditTextCell editTextCell3 = new EditTextCell(context, LocaleController.getString(C2888R.string.AddNotes), true, true, getMessagesController().config.contactNoteLengthLimit.get(), this.resourcesProvider);
        ...
        if (!this.addContact) {
            ...
            textCell.setTextAndIcon((CharSequence) LocaleController.formatString(C2888R.string.SuggestUserPhoto, user.first_name), C2888R.drawable.msg_addphoto, true);
            ...
            final RLottieDrawable rLottieDrawable = new RLottieDrawable(C2888R.raw.photo_suggest_icon, _UrlKt.FRAGMENT_ENCODE_SET + C2888R.raw.photo_suggest_icon, AndroidUtilities.m1124dp(50.0f), AndroidUtilities.m1124dp(50.0f), false, null);
            this.suggestPhoto.imageView.setTranslationX((float) (-AndroidUtilities.m1124dp(8.0f)));
            ...
            textCell3.setTextAndIcon((CharSequence) LocaleController.formatString(C2888R.string.UserSetPhoto, user.first_name), C2888R.drawable.msg_addphoto, false);
            this.setAvatarCell.setBackground(Theme.getSelectorDrawable(true, this.resourcesProvider));
            this.setAvatarCell.setColors(i3, i4);
            final RLottieDrawable rLottieDrawable2 = new RLottieDrawable(C2888R.raw.camera_outline, _UrlKt.FRAGMENT_ENCODE_SET + C2888R.raw.camera_outline, AndroidUtilities.m1124dp(50.0f), AndroidUtilities.m1124dp(50.0f), false, null);
            this.setAvatarCell.imageView.setTranslationX((float) (-AndroidUtilities.m1124dp(8.0f)));
            ...
            this.oldPhotoCell = new TextCell(context, this.resourcesProvider) { // from class: org.telegram.ui.ContactAddActivity.4
                ...
                protected void onMeasure(int i5, int i6) {
                    ...
                    ContactAddActivity.this.oldAvatarView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(30.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(30.0f), TLObject.FLAG_30));
                ...
                protected void onLayout(boolean z3, int i5, int i6, int i7, int i8) {
                    ...
                    ContactAddActivity.this.oldAvatarView.layout(iM1124dp, measuredHeight, ContactAddActivity.this.oldAvatarView.getMeasuredWidth() + iM1124dp, ContactAddActivity.this.oldAvatarView.getMeasuredHeight() + measuredHeight);
                }
            };
            ...
            this.oldPhotoCell.setText(LocaleController.getString(C2888R.string.ResetToOriginalPhoto), false);
            ...
            textCell4.setTextAndIcon((CharSequence) LocaleController.formatString(C2888R.string.UserSuggestBirthday, new Object[0]), C2888R.drawable.menu_birthday, false);
            ...
            this.suggestBirthday.imageView.setTranslationX(AndroidUtilities.m1124dp(4.0f));
    ...
    public /* synthetic */ void lambda$createView$10(Context context, final TLRPC.User user, View view) {
        AlertsCreator.createSimpleAlert(context, LocaleController.getString(C2888R.string.ResetToOriginalPhotoTitle), LocaleController.formatString(C2888R.string.ResetToOriginalPhotoMessage, user.first_name), LocaleController.getString(C2888R.string.Reset), new Runnable() { // from class: org.telegram.ui.ContactAddActivity$$ExternalSyntheticLambda16
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$createView$9(TLRPC.User user) {
        ...
        if (photo != null) {
            user2.photo.photo_id = photo.f1692id;
    ...
    public /* synthetic */ void lambda$createView$14(TLRPC.User user, View view) {
        showDialog(AlertsCreator.createBirthdayPickerDialog(getContext(), LocaleController.formatString(C2888R.string.UserSuggestBirthdayTitle, UserObject.getForcedFirstName(user)), LocaleController.getString(C2888R.string.UserSuggestBirthdayButton), null, new Utilities.Callback() { // from class: org.telegram.ui.ContactAddActivity$$ExternalSyntheticLambda15
    ...
    public /* synthetic */ void lambda$createView$13(TL_account.TL_birthday tL_birthday) {
        ...
        tL_users_suggestBirthday.f1819id = getMessagesController().getInputUser(this.user_id);
    ...
    public /* synthetic */ void lambda$createView$11() {
        presentFragment(ChatActivity.m1239of(this.user_id), true);
    }
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        if (TextUtils.isEmpty(getPhone())) {
            arrayList.add(UItem.asShadow(AndroidUtilities.replaceCharSequence("%1$s", AndroidUtilities.replaceTags(LocaleController.getString(C2888R.string.MobileHiddenExceptionInfo)), UserObject.getFirstName(user))));
        } else if (this.needAddException) {
            arrayList.add(UItem.asShadow(AndroidUtilities.replaceTags(LocaleController.formatString("MobileVisibleInfo", C2888R.string.MobileVisibleInfo, UserObject.getFirstName(user)))));
        } else {
            arrayList.add(UItem.asShadow(null));
        }
        if (this.addContact && this.needAddException) {
            this.checkShare = false;
            arrayList.add(UItem.asCheck(2, LocaleController.getString(C2888R.string.AddContactShareNumber)).setChecked(this.checkShare));
            arrayList.add(UItem.asShadow(LocaleController.formatString(C2888R.string.AddContactShareNumberInfo, UserObject.getFirstName(user))));
        }
        arrayList.add(UItem.asCustom(this.noteField));
        arrayList.add(UItem.asShadow(LocaleController.getString(C2888R.string.AddNotesInfo)));
        if (!this.addContact) {
            TLRPC.UserFull userFull = getMessagesController().getUserFull(this.user_id);
            ...
            arrayList.add(UItem.asShadow(null));
            arrayList.add(UItem.asButton(1, LocaleController.getString(C2888R.string.DeleteContact)).red());
        }
        arrayList.add(UItem.asShadow(null));
        if (this.firstSet) {
    ...
    public void onItemClick(UItem uItem, View view, int i, float f, float f2) {
        ...
        if (i2 == 1) {
            ...
            new AlertDialog.Builder(getParentActivity(), this.resourcesProvider).setTitle(LocaleController.getString(C2888R.string.DeleteContact)).setMessage(LocaleController.getString(C2888R.string.AreYouSureDeleteContact)).setPositiveButton(LocaleController.getString(C2888R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ContactAddActivity$$ExternalSyntheticLambda12
    ...
    private void updateAvatarLayout() {
        ...
        if (TextUtils.isEmpty(getPhone())) {
            this.nameTextView.setText(LocaleController.getString(C2888R.string.MobileHidden));
        } else {
    ...
    public /* synthetic */ void lambda$sendPhotoChangedRequest$21(TLRPC.FileLocation fileLocation, TLRPC.InputFile inputFile, TLObject tLObject, TLRPC.FileLocation fileLocation2, int i) {
        ...
        if (user != null) {
            ...
            if (getParentActivity() != null) {
                if (i == 2) {
                    BulletinFactory.m1246of(this).createUsersBulletin(arrayList2, AndroidUtilities.replaceTags(LocaleController.formatString("UserCustomPhotoSeted", C2888R.string.UserCustomPhotoSeted, user.first_name))).show();
                } else {
                    BulletinFactory.m1246of(this).createUsersBulletin(arrayList2, AndroidUtilities.replaceTags(LocaleController.formatString("UserCustomPhotoSeted", C2888R.string.UserCustomPhotoSeted, user.first_name))).show();
                }
            }
