...
public class GiftOfferSheet extends BottomSheetWithRecyclerListView {
    ...
    public GiftOfferSheet(final Context context, final int i, final long j, TL_stars.TL_starGiftUnique tL_starGiftUnique, final Theme.ResourcesProvider resourcesProvider, Runnable runnable) {
        ...
        linearLayout.setPadding(0, AndroidUtilities.m1124dp(12.0f), 0, AndroidUtilities.m1124dp(16.0f));
        ...
        if (zCanUseTon) {
            ...
            arrayList.add(LocaleController.getString(C2888R.string.SuggestedOfferStars));
            arrayList.add(LocaleController.getString(C2888R.string.SuggestedOfferTON));
        ...
        editTextBoldCursor.setPadding(AndroidUtilities.m1124dp(42.0f), AndroidUtilities.m1124dp(16.0f), AndroidUtilities.m1124dp(16.0f), AndroidUtilities.m1124dp(16.0f));
        int i2 = Theme.key_windowBackgroundWhiteBlackText;
        editTextBoldCursor.setTextColor(Theme.getColor(i2));
        editTextBoldCursor.requestFocus();
        outlineTextContainerView.setLeftPadding(AndroidUtilities.m1124dp(28.0f));
        ...
        imageView2.setImageResource(C2888R.drawable.ton);
        ...
        editTextBoldCursor2.setPadding(AndroidUtilities.m1124dp(16.0f), AndroidUtilities.m1124dp(16.0f), AndroidUtilities.m1124dp(16.0f), AndroidUtilities.m1124dp(16.0f));
        ...
        outlineTextContainerView2.setText(LocaleController.getString(C2888R.string.GiftOfferDuration));
        ...
        recyclerListView.setPadding(i6, 0, i6, AndroidUtilities.m1124dp(64.0f));
    ...
    public /* synthetic */ void lambda$new$4(Context context, View view) {
        ...
        while (true) {
            ...
            if (i < iArr.length) {
                ...
                AlertsCreator.createCustomPicker(context, LocaleController.getString(C2888R.string.GiftOfferDuration), i2, strArr, new Utilities.Callback() { // from class: org.telegram.ui.Stars.GiftOfferSheet$$ExternalSyntheticLambda11
    ...
    public /* synthetic */ void lambda$new$5(int i, Context context, Theme.ResourcesProvider resourcesProvider, long j, View view) {
        if (this.buttonView.isEnabled()) {
            ...
            if (amountUtils$AmountM1197of == null || amountUtils$AmountM1197of.asNano() < this.inputAmount.asNano()) {
    ...
    private void onCurrencyChanged(boolean z) {
        ...
        if (amountUtils$Currency == amountUtils$Currency2) {
            this.publishingTimeHint.setText(AndroidUtilities.replaceTags(LocaleController.formatString(C2888R.string.GiftOfferDurationInfoStars, shortName)));
            ...
            this.publishingTimeHint.setText(AndroidUtilities.replaceTags(LocaleController.formatString(C2888R.string.GiftOfferDurationInfoTON, shortName)));
    ...
    private void checkBalanceCloudVisibility() {
        boolean z = (this.isFullyVisible && !isDismissed() && this.balanceCloud != null && this.containerView.getY() > ((float) AndroidUtilities.m1124dp(32.0f))) || this.currencyTabsView == null;
    ...
    private void checkButtonOfferText(boolean z) {
        ...
        int i = C2888R.string.GiftOfferButtonStars;
        if (z2) {
    ...
    private void checkAmountInputText(boolean z) {
        int i;
        if (this.inputAmount.currency == AmountUtils$Currency.STARS) {
            i = C2888R.string.GiftOfferStarsToOffer;
        } else {
            i = C2888R.string.GiftOfferTONToOffer;
        }
    ...
    private void checkAmountInputTextHint(boolean z) {
        ...
        if ((i4 & 4) != 0) {
            if (amountUtils$Currency == AmountUtils$Currency.STARS) {
                i3 = C2888R.string.GiftOfferStarsToOfferInfoIsHigh;
            } else {
                i3 = C2888R.string.GiftOfferTONToOfferInfoIsHigh;
            }
            ...
            if (amountUtils$Currency == AmountUtils$Currency.STARS) {
                i2 = C2888R.string.GiftOfferStarsToOfferInfoIsLow;
            } else {
                i2 = C2888R.string.GiftOfferTONToOfferInfoIsLow;
            }
            ...
            if (amountUtils$Currency == AmountUtils$Currency.STARS) {
                i = C2888R.string.GiftOfferStarsToOfferInfo;
            } else {
                i = C2888R.string.GiftOfferTONToOfferInfo;
            }
    ...
    protected CharSequence getTitle() {
        return LocaleController.getString(C2888R.string.GiftOfferToBuyTitle);
    }
    ...
    private void openConfirmAlert() {
        ...
        textView.setText(LocaleController.getString(C2888R.string.GiftOfferConfirmSend));
        ...
        AmountUtils$Currency amountUtils$Currency2 = AmountUtils$Currency.STARS;
        if (amountUtils$Currency == amountUtils$Currency2) {
            string = LocaleController.formatString(C2888R.string.GiftOfferTransferInfoTextStars, strAsFormatString, DialogObject.getShortName(this.dialogId), this.giftName);
        } else {
            string = LocaleController.formatString(C2888R.string.GiftOfferTransferInfoTextTON, strAsFormatString, DialogObject.getShortName(this.dialogId), this.giftName);
        }
        ...
        tableView.addRow(LocaleController.getString(C2888R.string.GiftOfferRowOffer), StarsIntroActivity.replaceStarsWithPlain(z, LocaleController.formatString(C2888R.string.GiftOfferAmount, strAsFormatString), 0.8f));
        if (sendPaidMessagesStars > 0) {
            tableView.addRow(LocaleController.getString(C2888R.string.GiftOfferRowFee), StarsIntroActivity.replaceStarsWithPlain(LocaleController.formatString(C2888R.string.GiftOfferAmount, amountUtils$AmountFromDecimal.asFormatString()), 0.8f));
        }
        tableView.addRow(LocaleController.getString(C2888R.string.GiftOfferRowDuration), LocaleController.formatPluralString("GiftOfferHours", this.selectedDuration / 3600, new Object[0]));
        ...
        if (sendPaidMessagesStars == 0) {
            spannableStringBuilder.append((CharSequence) StarsIntroActivity.replaceStars(z, LocaleController.formatString(C2888R.string.GiftOfferPay, strAsFormatString)));
        } else if (z) {
            spannableStringBuilder.append(LocaleController.formatSpannable(C2888R.string.GiftOfferPayMulti, StarsIntroActivity.replaceStars(true, (CharSequence) LocaleController.formatString(C2888R.string.GiftOfferPayMultiPart, strAsFormatString)), StarsIntroActivity.replaceStars(LocaleController.formatString(C2888R.string.GiftOfferPayMultiPart, amountUtils$AmountFromDecimal.asFormatString()))));
        } else {
            spannableStringBuilder.append((CharSequence) StarsIntroActivity.replaceStars(LocaleController.formatString(C2888R.string.GiftOfferPay, AmountUtils$Amount.fromNano(this.inputAmount.asNano() + amountUtils$AmountFromDecimal.asNano(), amountUtils$Currency2).asFormatString())));
        }
        final boolean z2 = z;
    ...
    public /* synthetic */ void lambda$openConfirmAlert$9(long j, boolean z, AmountUtils$Amount amountUtils$Amount, long j2, final AlertDialog alertDialog, int i) {
        ...
        if (j > 0) {
            ...
            if (amountUtils$AmountM1197of == null || amountUtils$AmountM1197of.asNano() < amountUtils$AmountFromNano.asNano()) {
    ...
    public /* synthetic */ void lambda$openConfirmAlert$7(Browser.Progress progress, AlertDialog alertDialog, TLRPC.Updates updates, TLRPC.TL_error tL_error) {
        ...
        if (safeLastFragment != null) {
            if (updates != null) {
                BulletinFactory.m1246of(safeLastFragment).createSimpleBulletin(C2888R.raw.forward, LocaleController.getString(C2888R.string.GiftOfferSentTitle), AndroidUtilities.replaceTags(LocaleController.formatString(C2888R.string.GiftOfferSentText, this.giftName, DialogObject.getShortName(this.dialogId)))).ignoreDetach().show();
            } else {
    ...
    public static void openOfferAcceptAlert(final BaseFragment baseFragment, Context context, Theme.ResourcesProvider resourcesProvider, final int i, long j, final int i2, TLRPC.TL_messageActionStarGiftPurchaseOffer tL_messageActionStarGiftPurchaseOffer) {
        ...
        if (amountUtils$AmountOfSafe.currency == AmountUtils$Currency.STARS) {
            string = LocaleController.formatString(C2888R.string.GiftOfferTransferInfoTextSellStars, strAsFormatString, DialogObject.getShortName(j), str, strAsFormatString2);
        } else {
            string = LocaleController.formatString(C2888R.string.GiftOfferTransferInfoTextSellTON, strAsFormatString, DialogObject.getShortName(j), str, strAsFormatString2);
        }
        ...
        if (amountUtils$AmountFromUsd.asDouble() > 0.0d && starGift.value_usd_amount > 0) {
            if (amountUtils$AmountFromUsd.asNano() >= amountMinusFee.asNano()) {
                ...
                spannableStringBuilderReplaceTags = AndroidUtilities.replaceTags(LocaleController.formatString(C2888R.string.GiftOfferAmountLowerHint2, iRound + "%", starGift.title));
                z = iRound > 10;
            } else {
                int iRound2 = (int) Math.round(((amountMinusFee.asDouble() / amountUtils$AmountFromUsd.asDouble()) - 1.0d) * 100.0d);
                spannableStringBuilderReplaceTags = AndroidUtilities.replaceTags(LocaleController.formatString(C2888R.string.GiftOfferAmountHigherHint2, iRound2 + "%", starGift.title));
                z = false;
            }
            TextView textView2 = new TextView(context);
            textView2.setTextSize(1, 13.0f);
        ...
        new AlertDialog.Builder(context, resourcesProvider).setView(linearLayout).setPositiveButton(StarsIntroActivity.replaceStars(z2, LocaleController.formatString(C2888R.string.GiftOfferSellFor, strAsFormatString2)), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Stars.GiftOfferSheet$$ExternalSyntheticLambda0
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
    ...
    public static /* synthetic */ void $r8$lambda$gwQEkKs_SOAXz1zUreKS8Dm31cc(int i, final int i2, final BaseFragment baseFragment, final AlertDialog alertDialog, int i3) {
        ...
        ConnectionsManager.getInstance(i2).sendRequestTyped(tL_resolveStarGiftOffer, new Utilities.Callback2() { // from class: org.telegram.ui.Stars.GiftOfferSheet$$ExternalSyntheticLambda1
            @Override // org.telegram.messenger.Utilities.Callback2
            public final void run(Object obj, Object obj2) {
                GiftOfferSheet.m18186$r8$lambda$IzHiAyep2_oXhadHlpCz1iaQM(i2, baseFragment, progressMakeButtonLoading, alertDialog, (TLRPC.Updates) obj, (TLRPC.TL_error) obj2);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$IzHiAye-p2_oXhadHlpCz1iaQ-M, reason: not valid java name */
    public static /* synthetic */ void m18186$r8$lambda$IzHiAyep2_oXhadHlpCz1iaQM(int i, final BaseFragment baseFragment, final Browser.Progress progress, final AlertDialog alertDialog, TLRPC.Updates updates, final TLRPC.TL_error tL_error) {
        if (updates != null && tL_error == null) {
