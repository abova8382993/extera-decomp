...
public class ProfileGiftsView extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void setBounds(float f, float f2, float f3, boolean z, int i) {
        boolean z2 = Math.abs(f - this.left) > 0.1f || Math.abs(f2 - this.right) > 0.1f || Math.abs(f3 - this.f2140cy) > 0.1f;
        this.left = f;
        this.right = f2;
        if (!z) {
    ...
    public final class Gift {
        ...
        public Gift(TL_stars.TL_starGiftUnique tL_starGiftUnique) {
            ...
            this.f2141id = tL_starGiftUnique.f1846id;
            TLRPC.Document document = tL_starGiftUnique.getDocument();
            this.document = document;
            this.documentId = document == null ? 0L : document.f1668id;
        ...
        private void initParticles() {
            ...
            float fM1124dp = AndroidUtilities.m1124dp(36.0f);
            float f = (-fM1124dp) / 2.0f;
            float f2 = fM1124dp / 2.0f;
            this.particles.bounds.set(f, f, f2, f2);
        }

        public boolean equals(Gift gift) {
            return gift != null && gift.f2141id == this.f2141id;
        }
        ...
        public void draw(Canvas canvas, float f, float f2, float f3, float f4, float f5, float f6) {
            ...
            float fM1124dp = AndroidUtilities.m1124dp(45.0f);
    ...
    */
    public void update() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Stars.ProfileGiftsView.update():void");
    }
    ...
    */
    protected void dispatchDraw(android.graphics.Canvas r28) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Stars.ProfileGiftsView.dispatchDraw(android.graphics.Canvas):void");
    }
