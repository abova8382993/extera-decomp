...
public class StarGiftUniqueActionLayout {
    ...
    public StarGiftUniqueActionLayout(int i, ChatActionCell chatActionCell, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.emoji = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(chatActionCell, AndroidUtilities.m1124dp(28.0f));
    }
    ...
    */
    public void set(org.telegram.messenger.MessageObject r18, boolean r19) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Stars.StarGiftUniqueActionLayout.set(org.telegram.messenger.MessageObject, boolean):void");
    }
    ...
    public void draw(Canvas canvas) {
        ...
        this.backgroundPath.addRoundRect(this.backgroundRect, AndroidUtilities.m1124dp(14.0f), AndroidUtilities.m1124dp(14.0f), Path.Direction.CW);
        canvas.save();
        ...
        canvas.save();
        canvas.translate(width, AndroidUtilities.m1124dp(65.0f));
        ...
        canvas.restore();
        this.imageReceiver.setImageCoords(width - (AndroidUtilities.m1124dp(110.0f) / 2.0f), AndroidUtilities.m1124dp(10.0f), AndroidUtilities.m1124dp(110.0f), AndroidUtilities.m1124dp(110.0f));
        ...
        int i = iMultAlpha;
        this.title.ellipsize(getWidth() - AndroidUtilities.m1124dp(12.0f));
        Text text = this.title;
        text.draw(canvas, width - (text.getCurrentWidth() / 2.0f), this.titleY, -1, 1.0f);
        this.subtitle.ellipsize(getWidth() - AndroidUtilities.m1124dp(12.0f));
        Text text2 = this.subtitle;
        int i2 = i;
        text2.draw(canvas, width - (text2.getCurrentWidth() / 2.0f), this.subtitleY, i2, 1.0f);
        float fM1124dp = this.nameWidth + AndroidUtilities.m1124dp(9.0f) + this.valueWidth;
        ...
        while (i3 < size) {
            ...
            Text text3 = row.name;
            float f2 = width - (fM1124dp / 2.0f);
            text3.draw(canvas, (f2 + this.nameWidth) - text3.getCurrentWidth(), row.f2159y, i2, 1.0f);
            row.value.draw(canvas, f2 + this.nameWidth + AndroidUtilities.m1124dp(9.0f), row.f2159y, -1, 1.0f);
            i3 = i4;
            i2 = i2;
        }
        int i5 = i2;
        if (!this.repost) {
            this.buttonRect.set(width - ((this.buttonText.getCurrentWidth() + AndroidUtilities.m1124dp(30.0f)) / 2.0f), this.buttonY, width + ((this.buttonText.getCurrentWidth() + AndroidUtilities.m1124dp(30.0f)) / 2.0f), this.buttonY + this.buttonHeight);
            ...
            canvas.restore();
            this.ribbon.setBounds(((int) this.backgroundRect.right) - AndroidUtilities.m1124dp(46.67f), ((int) this.backgroundRect.top) - AndroidUtilities.m1124dp(1.33f), ((int) this.backgroundRect.right) + AndroidUtilities.m1124dp(1.33f), ((int) this.backgroundRect.top) + AndroidUtilities.m1124dp(46.67f));
    ...
    public void drawOutbounds(Canvas canvas) {
        ...
        this.buttonText.draw(canvas, this.buttonRect.left + AndroidUtilities.m1124dp(15.0f), this.buttonRect.centerY(), -1, 1.0f);
        canvas.restore();
