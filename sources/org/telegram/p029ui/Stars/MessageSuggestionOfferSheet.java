...
public class MessageSuggestionOfferSheet extends BottomSheet {
    ...
    public MessageSuggestionOfferSheet(final Context context, final int i, final long j, MessageSuggestionParams messageSuggestionParams, final ChatActivity chatActivity, final Theme.ResourcesProvider resourcesProvider, int i2, final Utilities.Callback callback) {
        ...
        if (i2 == 0) {
            i3 = C2888R.string.PostSuggestionsOfferTitle;
        } else {
            i3 = C2888R.string.PostSuggestionsOfferChangeTitle;
        }
        ...
        imageView2.setImageResource(C2888R.drawable.star_small_inner);
        ...
        imageView3.setImageResource(C2888R.drawable.ton);
        ...
        outlineTextContainerView2.setText(LocaleController.getString(C2888R.string.PostSuggestionsOfferTitleTime));
        ...
        imageView4.setImageResource(C2888R.drawable.arrow_more);
        ...
        spannableStringBuilder.append((CharSequence) AndroidUtilities.replaceTags(LocaleController.getString(C2888R.string.PostSuggestionsAddTimeHint)));
        spannableStringBuilder.append(' ');
        spannableStringBuilder.append((CharSequence) AndroidUtilities.replaceTags(LocaleController.formatString(C2888R.string.PostSuggestionsAddTimeHint2, Long.valueOf(MessagesController.getInstance(i).config.starsSuggestedPostAgeMin.get(TimeUnit.HOURS)))));
        ...
        if (i2 == 1) {
            buttonWithCounterView.setText(LocaleController.getString(C2888R.string.PostSuggestionsOfferChangeUpdateTerms), false);
        }
    ...
    public /* synthetic */ void lambda$new$6(ChatActivity chatActivity, int i, Context context, Theme.ResourcesProvider resourcesProvider, long j, Utilities.Callback callback, View view) {
        ...
        if (!this.isMonoForumAdmin && (amountUtils$AmountM1197of == null || amountUtils$AmountM1197of.asNano() < this.inputAmount.asNano())) {
        ...
        callback.run(MessageSuggestionParams.m1153of(this.inputAmount, this.selectedTime));
        lambda$new$0();
    }
    ...
    private void onCurrencyChanged(boolean z) {
        ...
        if (amountUtils$Currency == amountUtils$Currency2) {
            this.starsCountEditHint.setText(LocaleController.getString(C2888R.string.PostSuggestionsOfferSubtitleStars));
            ...
            this.starsCountEditHint.setText(LocaleController.getString(C2888R.string.PostSuggestionsOfferSubtitleTON));
    ...
    private void checkButtonOfferText(boolean z) {
        ...
        if (this.mode == 0) {
            if (!this.inputAmount.isZero()) {
                ...
                int i = C2888R.string.PostSuggestionsOfferStars;
                if (z2) {
            ...
            this.buttonView.setText(LocaleController.getString(C2888R.string.PostSuggestionsOfferForFree), z);
            return;
        }
        this.buttonView.setText(LocaleController.getString(C2888R.string.PostSuggestionsOfferChangeUpdateTerms), z);
    }
    ...
    private void checkAmountInputText(boolean z) {
        ...
        if ((i2 & 4) != 0) {
            this.starsCountEditOutline.setText(LocaleController.formatString(C2888R.string.SuggestAPostTooMuch, getInputAmountMax().formatAsDecimalSpaced()));
            return;
        }
        if ((i2 & 2) != 0) {
            this.starsCountEditOutline.setText(LocaleController.formatString(C2888R.string.SuggestAPostTooSmall, getInputAmountMin().formatAsDecimalSpaced()));
            return;
        }
        if (this.inputAmount.currency == AmountUtils$Currency.STARS) {
            i = C2888R.string.PostSuggestionsOfferTitlePriceStars;
        } else {
            i = C2888R.string.PostSuggestionsOfferTitlePriceTON;
        }
    ...
    public static String formatDateTime(long j) {
        if (j <= 0) {
            return LocaleController.getString(C2888R.string.PostSuggestionsAnytime);
        }
