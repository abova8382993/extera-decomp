...
import org.telegram.p029ui.Components.blur3.LiquidGlassEffect$$ExternalSyntheticApiModelOutline0;
...
public class SuperRipple extends ISuperRipple {
    ...
    public static class Effect {
        ...
        public final float f2171cx;

        /* JADX INFO: renamed from: cy */
        public final float f2172cy;
        public final float intensity;
    ...
    public SuperRipple(View view) {
        ...
        this.MAX_COUNT = 7;
        this.f2170t = new float[7];
        this.centerX = new float[7];
        this.centerY = new float[7];
        this.intensity = new float[7];
        RuntimeShader runtimeShaderM1278m = LiquidGlassEffect$$ExternalSyntheticApiModelOutline0.m1278m(AndroidUtilities.readRes(C2888R.raw.superripple_effect));
        this.shader = runtimeShaderM1278m;
        setupSizeUniforms(true);
        this.effect = RenderEffect.createRuntimeShaderEffect(runtimeShaderM1278m, "img");
    }
    ...
    */
    private void setupSizeUniforms(boolean r11) {
        ...
        Lbb:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Stars.SuperRipple.setupSizeUniforms(boolean):void");
    }

    @Override // org.telegram.p029ui.Stars.ISuperRipple
    ...
    public /* synthetic */ void lambda$animate$0(Effect effect, ValueAnimator valueAnimator) {
        effect.f2173t = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        updateProperties();
    }
    ...
    public void updateProperties() {
        ...
        if (!this.effects.isEmpty()) {
            ...
            for (int i = 0; i < this.count; i++) {
                ...
                boolean z4 = z3 || Math.abs(this.f2170t[i] - effect.f2173t) > 0.001f;
                this.f2170t[i] = effect.f2173t;
                boolean z5 = z4 || Math.abs(this.centerX[i] - effect.f2171cx) > 0.001f;
                this.centerX[i] = effect.f2171cx;
                boolean z6 = z5 || Math.abs(this.centerY[i] - effect.f2172cy) > 0.001f;
                this.centerY[i] = effect.f2172cy;
            ...
            if (z2) {
                ...
                this.shader.setFloatUniform("t", this.f2170t);
