...
public class SellGiftEnterPriceSheet extends BottomSheet {
    ...
    public SellGiftEnterPriceSheet(Context context, Theme.ResourcesProvider resourcesProvider, int i, AmountUtils$Amount amountUtils$Amount, final Utilities.Callback callback) {
        ...
        textCheckbox2Cell.setTextAndValue(LocaleController.getString(C2888R.string.ResellGiftPriceOnlyTON), LocaleController.getString(C2888R.string.ResellGiftPriceHintOnlyTON), true, false);
        ...
        round.setText(LocaleController.getString(C2888R.string.ResellGiftButton), false);
    ...
    private void onCurrencyChanged(boolean z) {
        ...
        AmountUtils$Currency amountUtils$Currency2 = AmountUtils$Currency.STARS;
        if (amountUtils$Currency == amountUtils$Currency2) {
            this.titleView.setText(LocaleController.getString(C2888R.string.ResellGiftTitle), z);
            ...
            this.titleView.setText(LocaleController.getString(C2888R.string.ResellGiftTitleTON), z);
    ...
    private void checkAmountInputText(boolean z) {
        ...
        if ((i2 & 4) != 0) {
            this.starsCountEditOutline.setText(LocaleController.formatString(C2888R.string.ResellGiftPriceTooMuch, getInputAmountMax().formatAsDecimalSpaced()));
            return;
        }
        if ((i2 & 2) != 0) {
            this.starsCountEditOutline.setText(LocaleController.formatString(C2888R.string.ResellGiftPriceTooSmall, getInputAmountMin().formatAsDecimalSpaced()));
            return;
        }
        if (this.inputAmount.currency == AmountUtils$Currency.STARS) {
            i = C2888R.string.ResellGiftPriceTitle;
        } else {
            i = C2888R.string.ResellGiftPriceTitleTON;
        }
    ...
    private void checkRateText(boolean z) {
        ...
        if (amountUtils$Currency == AmountUtils$Currency.STARS) {
            ...
            this.starsCountEditHint.setText(AndroidUtilities.replaceTags(LocaleController.formatString(C2888R.string.ResellGiftInfoTON, amountUtils$Amount.applyPerMille(appGlobalConfig.tonStarGiftResaleCommissionPermille.get()).asDecimalString())));
        }
