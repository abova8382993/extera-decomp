...
import org.telegram.p029ui.Components.VideoPlayerSeekBar;
...
public class SecretMediaViewer implements NotificationCenter.NotificationCenterDelegate, GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    ...
    private class SecretDeleteTimer extends FrameLayout {
        ...
        public SecretDeleteTimer(Context context) {
            ...
            paint.setStrokeWidth(AndroidUtilities.m1124dp(1.5f));
            ...
            this.afterDeleteProgressPaint.setStrokeWidth(AndroidUtilities.m1124dp(2.0f));
            Paint paint5 = new Paint(1);
            this.circlePaint = paint5;
            paint5.setColor(2130706432);
            RLottieDrawable rLottieDrawable = new RLottieDrawable(C2888R.raw.fire_on, _UrlKt.FRAGMENT_ENCODE_SET + C2888R.raw.fire_on, AndroidUtilities.m1124dp(16.0f), AndroidUtilities.m1124dp(16.0f));
        ...
        public void setOnce() {
            this.once = true;
            this.oncePaint.setTextSize(AndroidUtilities.m1124dp(13.0f));
        ...
        protected void onMeasure(int i, int i2) {
            ...
            float measuredWidth = getMeasuredWidth() - AndroidUtilities.m1124dp(35.0f);
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (i == NotificationCenter.updateMessageMedia) {
            if (this.currentMessageObject.getId() == ((TLRPC.Message) objArr[0]).f1686id) {
                if (this.isVideo && !this.videoWatchedOneTime) {
                    this.closeVideoAfterWatch = true;
                } else {
                    if (closePhoto(true, true)) {
    ...
    public void preparePlayer(File file) {
        ...
        if (this.videoPlayer == null) {
            VideoPlayer videoPlayer = new VideoPlayer() { // from class: org.telegram.ui.SecretMediaViewer.1
                @Override // org.telegram.p029ui.Components.VideoPlayer
            ...
            this.videoPlayer.setDelegate(new C65772(file));
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C65772 implements VideoPlayer.VideoPlayerDelegate {
    ...
    public void setParentActivity(final Activity activity) {
        ...
        this.containerView = new FrameLayoutDrawer(activity) { // from class: org.telegram.ui.SecretMediaViewer.4
            ...
            protected void onLayout(boolean z, int i2, int i3, int i4, int i5) {
                ...
                if (SecretMediaViewer.this.secretHint != null && SecretMediaViewer.this.secretDeleteTimer != null) {
                    int currentActionBarHeight2 = ((((ActionBar.getCurrentActionBarHeight() - SecretMediaViewer.this.secretDeleteTimer.getMeasuredHeight()) / 2) + AndroidUtilities.statusBarHeight) + SecretMediaViewer.this.secretDeleteTimer.getMeasuredHeight()) - AndroidUtilities.m1124dp(10.0f);
        ...
        this.actionBar.setTitleRightMargin(AndroidUtilities.m1124dp(70.0f));
        ...
        this.secretHint.setPadding(AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(8.0f));
        ...
        videoPlayerSeekBar.setHorizontalPadding(AndroidUtilities.m1124dp(2.0f));
        ...
        imageView.setBackground(Theme.createCircleDrawable(AndroidUtilities.m1124dp(64.0f), 1711276032));
        ...
        this.playButton.setPivotX(AndroidUtilities.m1124dp(32.0f));
        this.playButton.setPivotY(AndroidUtilities.m1124dp(32.0f));
    ...
    private void setCurrentCaption(MessageObject messageObject, CharSequence charSequence, boolean z, boolean z2) {
        ...
        if (z2) {
            ...
            TransitionSet duration = new TransitionSet().addTransition(new C656912(2, zIsEmpty2, zIsEmpty)).addTransition(new C656811(1, zIsEmpty2, zIsEmpty)).setDuration(200L);
            if (!zIsEmpty2) {
                this.captionScrollView.dontChangeTopMargin = true;
                duration.addTransition(new C657013());
            }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C656811 extends Fade {
        final /* synthetic */ boolean val$isCaptionEmpty;
        final /* synthetic */ boolean val$isCurrentCaptionEmpty;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C656811(int i, boolean z, boolean z2) {
            super(i);
            this.val$isCurrentCaptionEmpty = z;
            this.val$isCaptionEmpty = z2;
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C657013 extends Transition {
        C657013() {
        }
    ...
    private void showSecretHint() {
        ...
        String string = LocaleController.getString(this.isVideo ? C2888R.string.VideoShownOnce : C2888R.string.PhotoShownOnce);
        ...
        this.secretHint.setIcon(C2888R.raw.fire_on);
        ...
        if (document != null) {
            ...
            while (true) {
                ...
                if (documentAttribute instanceof TLRPC.TL_documentAttributeVideo) {
                    ...
                    this.videoWidth = tL_documentAttributeVideo.f1671w;
                    this.videoHeight = tL_documentAttributeVideo.f1670h;
                    break;
                }
                i2++;
            }
            if (MessageObject.isGifDocument(document)) {
                this.actionBar.setTitle(LocaleController.getString(C2888R.string.DisappearingGif));
                ...
                this.actionBar.setTitle(LocaleController.getString(C2888R.string.DisappearingVideo));
            ...
            f2 = 1.0f;
            Object obj = null;
            this.actionBar.setTitle(LocaleController.getString(C2888R.string.DisappearingPhoto));
            ...
            if (closestPhotoSizeWithSize != null) {
                this.videoWidth = closestPhotoSizeWithSize.f1694w;
                this.videoHeight = closestPhotoSizeWithSize.f1693h;
                r14 = obj;
            }
        }
    ...
    */
    public void onDraw(android.graphics.Canvas r23) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.SecretMediaViewer.onDraw(android.graphics.Canvas):void");
    }
    ...
    */
    public boolean closePhoto(boolean r26, boolean r27) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.SecretMediaViewer.closePhoto(boolean, boolean):boolean");
    }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C657417 extends AnimatorListenerAdapter {
        final /* synthetic */ PhotoViewer.PlaceProviderObject val$object;

        C657417(PhotoViewer.PlaceProviderObject placeProviderObject) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Removed duplicated region for block: B:113:0x0261 A[PHI: r3
  0x0261: PHI (r3v31 float) = (r3v26 float), (r3v27 float) binds: [B:112:0x025f, B:115:0x0267] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:119:0x0270 A[PHI: r3
  0x0270: PHI (r3v30 float) = (r3v28 float), (r3v29 float) binds: [B:118:0x026e, B:121:0x0276] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:142:0x02d2 A[PHI: r3
  0x02d2: PHI (r3v8 float) = (r3v3 float), (r3v4 float) binds: [B:141:0x02d0, B:144:0x02d8] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:148:0x02e3 A[PHI: r3
    ...
    */
    public boolean processTouchEvent(android.view.MotionEvent r13) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.SecretMediaViewer.processTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    */
    private void checkMinMax(boolean r6) {
        ...
        L2b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.SecretMediaViewer.checkMinMax(boolean):void");
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:18:0x0077 A[PHI: r10
  0x0077: PHI (r10v10 float) = (r10v5 float), (r10v6 float) binds: [B:17:0x0075, B:20:0x007d] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:24:0x0086 A[PHI: r10
    ...
    */
    public boolean onDoubleTap(android.view.MotionEvent r10) {
        ...
        L99:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.SecretMediaViewer.onDoubleTap(android.view.MotionEvent):boolean");
    }
    ...
    class VideoPlayerControlFrameLayout extends FrameLayout {
        ...
        public /* synthetic */ void lambda$new$0(DynamicAnimation dynamicAnimation, float f, float f2) {
            SecretMediaViewer.this.seekbar.setSize((int) (((getMeasuredWidth() - AndroidUtilities.m1124dp(16.0f)) - f) - (this.parentWidth > this.parentHeight ? AndroidUtilities.m1124dp(48.0f) : 0)), getMeasuredHeight());
        }
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (SecretMediaViewer.this.seekbar.onTouch(motionEvent.getAction(), motionEvent.getX() - AndroidUtilities.m1124dp(2.0f), motionEvent.getY())) {
