...
public class KeepMediaPopupView extends ActionBarPopupWindow.ActionBarPopupWindowLayout {
    ...
    public KeepMediaPopupView(final BaseFragment baseFragment, Context context) {
        ...
        setFitItems(true);
        this.oneDay = ActionBarMenuItem.addItem(this, C2888R.drawable.msg_autodelete_1d, LocaleController.formatPluralString("Days", 1, new Object[0]), false, null);
        this.twoDay = ActionBarMenuItem.addItem(this, C2888R.drawable.msg_autodelete_2d, LocaleController.formatPluralString("Days", 2, new Object[0]), false, null);
        this.oneWeek = ActionBarMenuItem.addItem(this, C2888R.drawable.msg_autodelete_1w, LocaleController.formatPluralString("Weeks", 1, new Object[0]), false, null);
        this.oneMonth = ActionBarMenuItem.addItem(this, C2888R.drawable.msg_autodelete_1m, LocaleController.formatPluralString("Months", 1, new Object[0]), false, null);
        this.forever = ActionBarMenuItem.addItem(this, C2888R.drawable.msg_cancel, LocaleController.getString(C2888R.string.AutoDeleteMediaNever), false, null);
        ActionBarMenuSubItem actionBarMenuSubItemAddItem = ActionBarMenuItem.addItem(this, C2888R.drawable.msg_delete, LocaleController.getString(C2888R.string.DeleteException), false, null);
        ...
        view.setBackground(Theme.getThemedDrawableByKey(context, C2888R.drawable.greydivider, Theme.key_windowBackgroundGrayShadow, null));
        this.gap.addView(view, LayoutHelper.createFrame(-1, -1.0f));
        this.gap.setTag(C2888R.id.fit_width_tag, 1);
        ...
        linksTextView.setText(LocaleController.getString(C2888R.string.KeepMediaPopupDescription));
    ...
    public void update(int i) {
        ...
        if (keepMediaExceptions.isEmpty()) {
            this.exceptionsView.titleView.setText(LocaleController.getString(C2888R.string.AddAnException));
            this.exceptionsView.titleView.setRightPadding(AndroidUtilities.m1124dp(8.0f));
            ...
            this.exceptionsView.titleView.setRightPadding(AndroidUtilities.m1124dp((Math.max(0, iMin - 1) * 12) + 64));
    ...
    private class ExceptionsView extends FrameLayout {
        ...
        public ExceptionsView(Context context) {
            ...
            this.titleView.setRightPadding(AndroidUtilities.m1124dp(68.0f));
    ...
    public void updateAvatarsPosition() {
        if (this.exceptions != null) {
            this.exceptionsView.avatarsImageView.setTranslationX(AndroidUtilities.m1124dp(12.0f) * (3 - Math.min(3, this.exceptions.size())));
        }
    }
