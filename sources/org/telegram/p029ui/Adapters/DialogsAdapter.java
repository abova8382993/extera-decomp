...
import org.telegram.p029ui.Cells.DialogMeUrlCell;
import org.telegram.p029ui.Cells.DialogsEmptyCell;
import org.telegram.p029ui.Cells.DialogsHintCell;
import org.telegram.p029ui.Cells.DialogsRequestedEmptyCell;
...
public class DialogsAdapter extends RecyclerListView.SelectionAdapter implements DialogCell.DialogCellDelegate {
    ...
    public int findDialogPosition(long j) {
        for (int i = 0; i < this.itemInternals.size(); i++) {
            if (((ItemInternal) this.itemInternals.get(i)).dialog != null && ((ItemInternal) this.itemInternals.get(i)).dialog.f1666id == j) {
                return i;
            }
        }
        return -1;
    ...
    public int fixScrollGap(RecyclerListView recyclerListView, int i, int i2, boolean z, boolean z2, boolean z3, boolean z4) {
        int iM1124dp = AndroidUtilities.m1124dp(SharedConfig.useThreeLinesLayout ? 76.0f : 70.0f);
        int paddingTop = ((recyclerListView.getPaddingTop() + i2) - (i * iM1124dp)) - i;
        if (z) {
            paddingTop += iM1124dp;
        }
    ...
    private class ItemInternal extends AdapterWithDiffUtils.Item {
        ...
        public ItemInternal(int i, TLRPC.Dialog dialog) {
            ...
            this.dialog = dialog;
            if (dialog != null) {
                int i2 = DialogsAdapter.this.dialogsStableIds.get(dialog.f1666id, -1);
                if (i2 >= 0) {
                    this.stableId = i2;
                } else {
                    ...
                    this.stableId = i3;
                    DialogsAdapter.this.dialogsStableIds.put(dialog.f1666id, i3);
                }
            } else if (i == 19) {
                this.stableId = 5;
            } else {
            ...
            if (dialog != null) {
                if (DialogsAdapter.this.dialogsType == 7 || DialogsAdapter.this.dialogsType == 8) {
                    ...
                    this.pinned = dialogFilter != null && dialogFilter.pinnedDialogs.indexOfKey(dialog.f1666id) >= 0;
                } else {
                    this.pinned = dialog.pinned;
                }
                this.isFolder = dialog.isFolder;
                this.isForumCell = MessagesController.getInstance(DialogsAdapter.this.currentAccount).isForum(dialog.f1666id);
            }
        }
        ...
        boolean compare(ItemInternal itemInternal) {
            ...
            if (i == 0) {
                ...
                return dialog3 != null && (dialog2 = itemInternal.dialog) != null && dialog3.f1666id == dialog2.f1666id && this.isFolder == itemInternal.isFolder && this.isForumCell == itemInternal.isForumCell && this.pinned == itemInternal.pinned;
            }
            if (i == 14) {
                TLRPC.Dialog dialog4 = this.dialog;
                return dialog4 != null && (dialog = itemInternal.dialog) != null && dialog4.f1666id == dialog.f1666id && dialog4.isFolder == dialog.isFolder;
            }
            if (i == 4) {
    ...
    */
    public static /* synthetic */ int $r8$lambda$_IyqYv0ErkEI_Omrn2azgDWluho(org.telegram.messenger.MessagesController r2, int r3, org.telegram.tgnet.TLRPC.TL_contact r4, org.telegram.tgnet.TLRPC.TL_contact r5) {
        ...
        L5d:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Adapters.DialogsAdapter.$r8$lambda$_IyqYv0ErkEI_Omrn2azgDWluho(org.telegram.messenger.MessagesController, int, org.telegram.tgnet.TLRPC$TL_contact, org.telegram.tgnet.TLRPC$TL_contact):int");
    }
    ...
    */
    public androidx.recyclerview.widget.RecyclerView.ViewHolder onCreateViewHolder(android.view.ViewGroup r13, int r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Adapters.DialogsAdapter.onCreateViewHolder(android.view.ViewGroup, int):androidx.recyclerview.widget.RecyclerView$ViewHolder");
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if (itemViewType != 0) {
                    ...
                    if (itemViewType != 6) {
                        if (itemViewType != 7) {
                            if (itemViewType != 11) {
                                if (itemViewType != 12) {
                                    if (itemViewType != 20) {
                                        if (itemViewType == 21) {
                                            ...
                                            customDialog.name = LocaleController.getString(C2888R.string.StoriesForwardTitle);
                                            customDialog.message = LocaleController.getString(C2888R.string.StoriesForwardText);
                                            ...
                                            switch (itemViewType) {
                                                case 14:
                                                    ...
                                                    if (i2 == 0) {
                                                        headerCell.setText(LocaleController.getString(C2888R.string.MyChannels));
                                                    } else if (i2 == 1) {
                                                        headerCell.setText(LocaleController.getString(C2888R.string.MyGroups));
                                                    } else if (i2 == 2) {
                                                        headerCell.setText(LocaleController.getString(C2888R.string.FilterGroups));
                                                    }
                                                    break;
                                                case 15:
                                        ...
                                        if (dialogsActivity3 == null || !dialogsActivity3.isReplyTo) {
                                            if (this.dialogsType == 3) {
                                                if (i == 0) {
                                                    graySectionCell.setText(LocaleController.getString(C2888R.string.ForwardDialogYourChannel));
                                                } else {
                                                    graySectionCell.setText(LocaleController.getString(C2888R.string.ReplyDialogYourChats));
                                                }
                                            }
                                        } else if (i == 0) {
                                            graySectionCell.setText(LocaleController.getString(C2888R.string.ReplyDialogMessageAuthor));
                                        } else {
                                            graySectionCell.setText(LocaleController.getString(C2888R.string.ReplyDialogYourChats));
                                        }
                                    }
                                    ...
                                    if (requestPeerType != null) {
                                        if (requestPeerType instanceof TLRPC.TL_requestPeerTypeBroadcast) {
                                            textCell.setTextAndIcon((CharSequence) LocaleController.getString(C2888R.string.CreateChannelForThis), C2888R.drawable.msg_channel_create, true);
                                        } else {
                                            textCell.setTextAndIcon((CharSequence) LocaleController.getString(C2888R.string.CreateGroupForThis), C2888R.drawable.msg_groups_create, true);
                                        }
                                    } else {
                                        textCell.setTextAndIcon(LocaleController.getString(C2888R.string.CreateGroupForImport), C2888R.drawable.msg_groups_create, this.dialogsCount != 0);
                                    }
                                ...
                                textInfoPrivacyCell.setText(LocaleController.getString(C2888R.string.TapOnThePencilButton));
                                if (this.arrowDrawable == null) {
                                    Drawable drawable = this.mContext.getResources().getDrawable(C2888R.drawable.arrow_newchat);
                            ...
                            if (i4 != 11 && i4 != 12 && i4 != 13) {
                                headerCell2.setText(LocaleController.getString((this.dialogsCount == 0 && this.forceUpdatingContacts) ? C2888R.string.ConnectingYourContacts : C2888R.string.YourContacts));
                            } else if (i == 0) {
                                headerCell2.setText(LocaleController.getString(C2888R.string.ImportHeader));
                            } else {
                                headerCell2.setText(LocaleController.getString(C2888R.string.ImportHeaderContacts));
                            }
                        }
                    } else {
            ...
            if (i7 == 2 || i7 == 15) {
                ...
                if (dialog.f1666id != 0) {
                    chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(-dialog.f1666id));
                ...
                if (chat != null) {
                    ...
                    if (user != null) {
                        ...
                        if (!UserObject.isReplyUser(user)) {
                            if (user.bot) {
                                userStatus = LocaleController.getString(C2888R.string.Bot);
                            } else {
                ...
                if (i7 == 0 && AndroidUtilities.isTablet()) {
                    dialogCell2.setDialogSelected(dialog.f1666id == this.openedDialogId);
                }
                dialogCell2.setChecked(this.selectedDialogs.contains(Long.valueOf(dialog.f1666id)), false);
                ...
                if (dialogsPreloader != null && i < 10) {
                    dialogsPreloader.add(dialog.f1666id);
                }
            }
        }
    ...
    public void moveDialogs(RecyclerListView recyclerListView, int i, int i2) {
        ...
        if (i3 == 7 || i3 == 8) {
            ...
            int i4 = dialogFilter.pinnedDialogs.get(dialog.f1666id);
            dialogFilter.pinnedDialogs.put(dialog.f1666id, dialogFilter.pinnedDialogs.get(dialog2.f1666id));
            dialogFilter.pinnedDialogs.put(dialog2.f1666id, i4);
        } else {
    ...
    public void openStory(DialogCell dialogCell, Runnable runnable) {
        ...
        if (MessagesController.getInstance(this.currentAccount).getStoriesController().hasStories(dialogCell.getDialogId())) {
            ...
            this.parentFragment.getOrCreateStoryViewer().open(this.parentFragment.getContext(), dialogCell.getDialogId(), StoriesListPlaceProvider.m1320of((RecyclerListView) dialogCell.getParent()));
        }
    }
    ...
    public void openHiddenStories() {
        ...
        this.parentFragment.getOrCreateStoryViewer().open(this.mContext, null, arrayList, 0, null, null, StoriesListPlaceProvider.m1321of(this.recyclerListView, true), false);
    }
    ...
    public static class DialogsPreloader {
        ...
        public void start() {
            ...
            MessagesController.getInstance(UserConfig.selectedAccount).ensureMessagesLoaded(jLongValue, 0, new C31171(jLongValue));
        }

        /* JADX INFO: renamed from: org.telegram.ui.Adapters.DialogsAdapter$DialogsPreloader$1 */
        /* JADX INFO: loaded from: classes6.dex */
        class C31171 implements MessagesController.MessagesLoadedCallback {
    ...
    public class LastEmptyView extends FrameLayout {
        ...
        /* JADX WARN: Removed duplicated region for block: B:75:0x016c A[PHI: r13
  0x016c: PHI (r13v9 int) = (r13v7 int), (r13v16 int) binds: [B:87:0x0199, B:74:0x016a] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    private void updateItemList() {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Adapters.DialogsAdapter.updateItemList():void");
    }
    ...
    public int getItemHeight(int i) {
        ...
        if (((ItemInternal) this.itemInternals.get(i)).isForumCell && !this.collapsedView) {
            iM1124dp = AndroidUtilities.m1124dp(SharedConfig.useThreeLinesLayout ? 86.0f : 91.0f);
        } else {
            iM1124dp = AndroidUtilities.m1124dp(SharedConfig.useThreeLinesLayout ? 76.0f : 70.0f);
        }
        return iM1124dp + 1;
    }
}
