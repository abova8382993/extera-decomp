...
public class SearchAdapterHelper {
    ...
    public interface SearchAdapterHelperDelegate {
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Adapters.SearchAdapterHelper$SearchAdapterHelperDelegate$-CC */
    ...
    public void queryServerSearch(final String str, boolean z, final boolean z2, final boolean z3, boolean z4, final boolean z5, long j, boolean z6, int i, final int i2, final long j2, final Runnable runnable) {
        ...
        if (str.length() > 0) {
            if (j != 0) {
                ...
                tL_channels_getParticipants.filter.f1659q = str;
        ...
        if (!z5 && z6 && str.startsWith("+") && str.length() > 3) {
            ...
            for (int i5 = 0; i5 < size2; i5++) {
                ...
                if (user != null && (str2 = user.phone) != null && str2.startsWith(strStripExceptNumbers)) {
                    ...
                    this.phoneSearchMap.put(user.f1825id, user);
                }
            }
            if (!z9) {
        ...
        if (this.delegate.canApplySearchResults(i) && tL_error == null) {
                ...
                while (i5 < arrayList.size()) {
                    ...
                    if (chat3 != null) {
                        if (!z || ((z2 && !ChatObject.canAddBotsToChat(chat3)) || ((!this.allowGlobalResults && ChatObject.isNotInChat(chat3)) || !filter(chat3)))) {
                            ...
                            j2 = j3;
                            addUniqueObject(this.globalSearch, this.globalSearchMap, chat3, -chat3.f1660id);
                        }
                    } else {
                        j2 = j3;
                        if (user2 != null && !z2 && ((z3 || !user2.bot) && ((z4 || !user2.self) && ((this.allowGlobalResults || i4 != 1 || user2.contact) && filter(user2))))) {
                            addUniqueObject(this.globalSearch, this.globalSearchMap, user2, user2.f1825id);
                        }
                    }
                    i5++;
                    j3 = j2;
            ...
            if (!this.allResultsAreGlobal) {
                for (int i6 = 0; i6 < tL_contacts_found.my_results.size(); i6++) {
                    ...
                    if (chat != null) {
                        if (z && ((!z2 || ChatObject.canAddBotsToChat(chat)) && (-chat.f1660id) != j && filter(chat))) {
                            addUniqueObject(this.localServerSearch, this.globalSearch, this.globalSearchMap, chat, -chat.f1660id);
                        }
                    } else if (user != null && !z2 && ((z3 || !user.bot) && ((z4 || !user.self) && user.f1825id != j && filter(user)))) {
                        addUniqueObject(this.localServerSearch, this.globalSearch, this.globalSearchMap, user, user.f1825id);
                    }
                }
            }
    ...
    private void removeGroupSearchFromGlobal() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (user != null) {
                ...
                this.globalSearchMap.remove(user.f1825id);
            }
        }
    }
        ...
        if (this.globalSearchMap.size() != 0) {
            ...
            while (i < size2) {
                ...
                if (obj instanceof TLRPC.User) {
                    ...
                    TLRPC.User user2 = (TLRPC.User) this.globalSearchMap.get(user.f1825id);
                    if (user2 != null) {
                        this.globalSearch.remove(user2);
                        this.localServerSearch.remove(user2);
                        this.globalSearchMap.remove(user2.f1825id);
                    }
                    TLObject tLObject = (TLObject) this.groupSearchMap.get(user.f1825id);
                    if (tLObject != null) {
                        this.groupSearch.remove(tLObject);
                        this.groupSearchMap.remove(user.f1825id);
                    }
                    Object obj2 = this.phoneSearchMap.get(user.f1825id);
                    if (obj2 != null) {
                        this.phonesSearch.remove(obj2);
                        this.phoneSearchMap.remove(user.f1825id);
                    }
                } else if ((obj instanceof TLRPC.Chat) && (chat = (TLRPC.Chat) this.globalSearchMap.get(-((TLRPC.Chat) obj).f1660id)) != null) {
                    this.globalSearch.remove(chat);
                    this.localServerSearch.remove(chat);
                    this.globalSearchMap.remove(-chat.f1660id);
                }
                i++;
            }
        }
    ...
    /* JADX INFO: renamed from: setHashtags */
