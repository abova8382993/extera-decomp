...
public abstract class SearchAdapter extends RecyclerListView.SelectionAdapter {
    ...
    public /* synthetic */ void lambda$processSearch$0(String str, int i, ArrayList arrayList, int i2) {
            ...
            if ((this.allowSelf || !user.self) && (!this.onlyMutual || user.mutual_contact)) {
                ...
                if (longSparseArray == null || longSparseArray.indexOfKey(tL_contact.user_id) < 0) {
                    ...
                    if (UserObject.isReplyUser(user)) {
                        strArr2[2] = LocaleController.getString(C2888R.string.RepliesTitle).toLowerCase();
                    } else if (user.self) {
                        strArr2[2] = LocaleController.getString(C2888R.string.SavedMessages).toLowerCase();
                    }
                    int i13 = i9;
                    int i14 = i13;
                    while (i13 < i7) {
        ...
        if (this.allUnregistredContacts == null) {
            ...
            while (i18 < size) {
                ...
                contactEntry.f1878q1 = (contact2.first_name + " " + contact2.last_name).toLowerCase();
                contactEntry.f1879q2 = (contact2.last_name + " " + contact2.first_name).toLowerCase();
        ...
        for (int i19 = i17; i19 < this.allUnregistredContacts.size(); i19++) {
            ...
            if ((translitString != null && (contactEntry2.f1878q1.toLowerCase().contains(translitString) || contactEntry2.f1878q1.toLowerCase().contains(translitString))) || contactEntry2.f1878q1.toLowerCase().contains(lowerCase) || contactEntry2.f1878q1.toLowerCase().contains(lowerCase)) {
    ...
    */
    public void onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder r14, int r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Adapters.SearchAdapter.onBindViewHolder(androidx.recyclerview.widget.RecyclerView$ViewHolder, int):void");
    }
