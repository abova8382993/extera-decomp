...
public final class MultiLayoutTypingAnimator implements Choreographer.FrameCallback {
    ...
    private float speedPxPerSec = AndroidUtilities.m1124dp(40.0f);
    ...
    private void recalcSpeed() {
        ...
        float fM1124dp = AndroidUtilities.m1124dp(40.0f);
        if (fComputeRemainingPixels <= 0.001f) {
            this.speedPxPerSec = fM1124dp;
        } else {
            this.speedPxPerSec = Math.max(fM1124dp, fComputeRemainingPixels / 1.05f);
        }
    }
    ...
    */
    private float computeRemainingPixels() {
        ...
        L61:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.MultiLayoutTypingAnimator.computeRemainingPixels():float");
    }
    ...
    public static void drawLayoutWithLastLineFade(Canvas canvas, Layout layout, int i, float f) {
        ...
        float fLerp = AndroidUtilities.lerp(-AndroidUtilities.m1124dp(50.0f), f2, f3);
        AndroidUtilities.m1124dp(50.0f);
        float f4 = lineTop;
        float f5 = lineBottom;
        ...
        if (paragraphDirection >= 0) {
            matrix.setScale(AndroidUtilities.m1124dp(50.0f), 1.0f);
