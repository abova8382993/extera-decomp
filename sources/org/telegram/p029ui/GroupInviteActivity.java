...
public class GroupInviteActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2888R.string.InviteLink));
    ...
    public /* synthetic */ void lambda$createView$1(View view, int i) {
        ...
        if (i == this.shareLinkRow) {
            ...
            try {
                ...
                getParentActivity().startActivityForResult(Intent.createChooser(intent, LocaleController.getString(C2888R.string.InviteToGroupByLink)), 500);
                return;
            } catch (Exception e2) {
                FileLog.m1136e(e2);
                return;
        ...
        if (i == this.revokeLinkRow) {
            ...
            builder.setPositiveButton(LocaleController.getString(C2888R.string.RevokeButton), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.GroupInviteActivity$$ExternalSyntheticLambda3
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        if (i == NotificationCenter.chatInfoDidLoad) {
            ...
            if (chatFull.f1661id == this.chatId && iIntValue == this.classGuid) {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (i == GroupInviteActivity.this.copyLinkRow) {
                    textSettingsCell.setText(LocaleController.getString(C2888R.string.CopyLink), true);
                    return;
                } else if (i == GroupInviteActivity.this.shareLinkRow) {
                    textSettingsCell.setText(LocaleController.getString(C2888R.string.ShareLink), false);
                    return;
                } else {
                    if (i == GroupInviteActivity.this.revokeLinkRow) {
                        textSettingsCell.setText(LocaleController.getString(C2888R.string.RevokeLink), true);
                        return;
                    }
                    return;
                }
            ...
            if (i == GroupInviteActivity.this.shadowRow) {
                ...
                if (ChatObject.isChannel(chat) && !chat.megagroup) {
                    textInfoPrivacyCell.setText(LocaleController.getString(C2888R.string.ChannelLinkInfo));
                } else {
                    textInfoPrivacyCell.setText(LocaleController.getString(C2888R.string.LinkInfo));
                }
                textInfoPrivacyCell.setBackgroundDrawable(Theme.getThemedDrawableByKey(this.mContext, C2888R.drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
            }
        }
