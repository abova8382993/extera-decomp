...
public class CameraScanActivity extends BaseFragment {
    ...
    class DialogC33141 extends BottomSheet {
        ...
        DialogC33141(Context context, boolean z, INavigationLayout[] iNavigationLayoutArr, int i, boolean z2, CameraScanActivityDelegate cameraScanActivityDelegate) {
            super(context, z);
            ...
            AnonymousClass1 anonymousClass1 = new CameraScanActivity(i) { // from class: org.telegram.ui.CameraScanActivity.1.1
                ...
                public void finishFragment() {
                    setFinishing(true);
                    DialogC33141.this.lambda$new$0();
                }
    ...
    public static BottomSheet showAsSheet(Activity activity, boolean z, int i, CameraScanActivityDelegate cameraScanActivityDelegate) {
        ...
        DialogC33141 dialogC33141 = new DialogC33141(activity, false, new INavigationLayout[]{INavigationLayout.CC.newLayout(activity, false)}, i, z, cameraScanActivityDelegate);
        dialogC33141.setUseLightStatusBar(false);
        AndroidUtilities.setLightNavigationBar((Dialog) dialogC33141, false);
        AndroidUtilities.setNavigationBarColor((Dialog) dialogC33141, -16777216, false);
        dialogC33141.setUseLightStatusBar(false);
        dialogC33141.getWindow().addFlags(512);
        dialogC33141.show();
        return dialogC33141;
    }
    ...
    public CameraScanActivity(int i) {
        ...
        this.requestShot = new RunnableC33207();
    ...
    public View createView(Context context) {
        ...
        C33163 c33163 = new ViewGroup(context) { // from class: org.telegram.ui.CameraScanActivity.3
            Path path = new Path();

            C33163(Context context2) {
                super(context2);
                this.path = new Path();
            }
            ...
            protected void onMeasure(int i, int i2) {
                ...
                if (CameraScanActivity.this.currentType == 0) {
                    ...
                    if (CameraScanActivity.this.galleryButton != null) {
                        CameraScanActivity.this.galleryButton.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(60.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(60.0f), TLObject.FLAG_30));
                    }
                    CameraScanActivity.this.flashButton.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(60.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(60.0f), TLObject.FLAG_30));
                }
                CameraScanActivity.this.titleTextView.measure(View.MeasureSpec.makeMeasureSpec(size - AndroidUtilities.m1124dp(72.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, 0));
                if (CameraScanActivity.this.currentType == 3) {
                    CameraScanActivity.this.descriptionText.measure(View.MeasureSpec.makeMeasureSpec(size - AndroidUtilities.m1124dp(72.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, 0));
                } else {
            ...
            protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
                ...
                if (CameraScanActivity.this.currentType != 0) {
                    ...
                    int i7 = measuredHeight - iM1124dp;
                    CameraScanActivity.this.titleTextView.layout(AndroidUtilities.m1124dp(36.0f), i7, AndroidUtilities.m1124dp(36.0f) + CameraScanActivity.this.titleTextView.getMeasuredWidth(), CameraScanActivity.this.titleTextView.getMeasuredHeight() + i7);
                    if (CameraScanActivity.this.currentType == 3) {
                        int measuredHeight2 = i7 + CameraScanActivity.this.titleTextView.getMeasuredHeight() + AndroidUtilities.m1124dp(8.0f);
                        CameraScanActivity.this.descriptionText.layout(AndroidUtilities.m1124dp(36.0f), measuredHeight2, AndroidUtilities.m1124dp(36.0f) + CameraScanActivity.this.descriptionText.getMeasuredWidth(), CameraScanActivity.this.descriptionText.getMeasuredHeight() + measuredHeight2);
                    }
                    ...
                    if (CameraScanActivity.this.needGalleryButton) {
                        measuredWidth = (i5 / 2) + AndroidUtilities.m1124dp(35.0f);
                    } else {
                        measuredWidth = (i5 / 2) - (CameraScanActivity.this.flashButton.getMeasuredWidth() / 2);
                    }
                    int iM1124dp2 = ((i6 - iMin) / 2) + iMin + AndroidUtilities.m1124dp(80.0f);
                    CameraScanActivity.this.flashButton.layout(measuredWidth, iM1124dp2, CameraScanActivity.this.flashButton.getMeasuredWidth() + measuredWidth, CameraScanActivity.this.flashButton.getMeasuredHeight() + iM1124dp2);
                    if (CameraScanActivity.this.galleryButton != null) {
                        int iM1124dp3 = ((i5 / 2) - AndroidUtilities.m1124dp(35.0f)) - CameraScanActivity.this.galleryButton.getMeasuredWidth();
                        CameraScanActivity.this.galleryButton.layout(iM1124dp3, iM1124dp2, CameraScanActivity.this.galleryButton.getMeasuredWidth() + iM1124dp3, CameraScanActivity.this.galleryButton.getMeasuredHeight() + iM1124dp2);
                    }
                } else {
                    if (CameraScanActivity.this.cameraView != null) {
                        CameraScanActivity.this.cameraView.layout(0, 0, CameraScanActivity.this.cameraView.getMeasuredWidth(), CameraScanActivity.this.cameraView.getMeasuredHeight());
                    ...
                    int i8 = (int) (i6 * 0.65f);
                    CameraScanActivity.this.titleTextView.layout(AndroidUtilities.m1124dp(36.0f), i8, AndroidUtilities.m1124dp(36.0f) + CameraScanActivity.this.titleTextView.getMeasuredWidth(), CameraScanActivity.this.titleTextView.getMeasuredHeight() + i8);
                }
                if (CameraScanActivity.this.currentType != 3) {
                    int i9 = (int) (i6 * 0.74f);
            ...
            protected boolean drawChild(Canvas canvas, View view, long j) {
                ...
                int iLerp = AndroidUtilities.lerp(0, AndroidUtilities.m1124dp(4.0f), Math.min(1.0f, CameraScanActivity.this.qrAppearingValue * 20.0f));
                int i7 = iLerp / 2;
                int iLerp2 = AndroidUtilities.lerp(Math.min(i, i2), AndroidUtilities.m1124dp(20.0f), Math.min(1.2f, (float) Math.pow(CameraScanActivity.this.qrAppearingValue, 1.7999999523162842d)));
        ...
        c33163.setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.CameraScanActivity$$ExternalSyntheticLambda0
            @Override // android.view.View.OnTouchListener
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return CameraScanActivity.$r8$lambda$4cb0ykEfSywGHVBhUUdlyxjpdNo(view, motionEvent);
            }
        });
        this.fragmentView = c33163;
        if (isQr()) {
        ...
        if (this.currentType == 0) {
            ...
            c33163.setBackgroundColor(-16777216);
            c33163.addView(this.actionBar);
        }
        int i2 = this.currentType;
        if (i2 == 2 || i2 == 3) {
            this.actionBar.setTitle(LocaleController.getString(C2888R.string.AuthAnotherClientScan));
        }
        Paint paint = new Paint(1);
        paint.setPathEffect(LinkPath.getRoundedEffect());
        paint.setColor(ColorUtils.setAlphaComponent(-1, 40));
        C33174 c33174 = new TextView(context2) { // from class: org.telegram.ui.CameraScanActivity.4
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C33174(Context context2, Paint paint2) {
                super(context2);
                paint = paint2;
            ...
            protected void onMeasure(int i3, int i4) {
                ...
                if (getText() instanceof Spanned) {
                    ...
                    for (int i5 = 0; i5 < uRLSpanNoUnderlineArr.length; i5++) {
                        ...
                        this.textPath.setBaselineShift(i6 != 0 ? i6 + AndroidUtilities.m1124dp(i6 > 0 ? 5.0f : -2.0f) : 0);
        ...
        this.titleTextView = c33174;
        c33174.setGravity(1);
        this.titleTextView.setTextSize(1, 24.0f);
        c33163.addView(this.titleTextView);
        TextView textView = new TextView(context2);
        this.descriptionText = textView;
        textView.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteGrayText6));
        this.descriptionText.setGravity(1);
        this.descriptionText.setTextSize(1, 16.0f);
        c33163.addView(this.descriptionText);
        ...
        if (i3 == 0) {
            this.titleTextView.setText(LocaleController.getString(C2888R.string.PassportScanPassport));
            this.descriptionText.setText(LocaleController.getString(C2888R.string.PassportScanPassportInfo));
            this.titleTextView.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteBlackText));
            this.recognizedMrzView.setTypeface(Typeface.MONOSPACE);
        } else {
            if (!this.needGalleryButton) {
                if (i3 == 1 || i3 == 3) {
                    this.titleTextView.setText(LocaleController.getString(C2888R.string.AuthAnotherClientScan));
                } else {
                    SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(LocaleController.getString(C2888R.string.AuthAnotherClientInfo5));
                    String[] strArr = {LocaleController.getString(C2888R.string.AuthAnotherClientDownloadClientUrl), LocaleController.getString(C2888R.string.AuthAnotherWebClientUrl)};
                    int i4 = 0;
            ...
            this.recognizedMrzView.setPadding(AndroidUtilities.m1124dp(10.0f), 0, AndroidUtilities.m1124dp(10.0f), AndroidUtilities.m1124dp(10.0f));
            if (!this.needGalleryButton) {
                this.recognizedMrzView.setText(LocaleController.getString(C2888R.string.AuthAnotherClientNotFound));
            }
            c33163.addView(this.recognizedMrzView);
            if (this.needGalleryButton) {
                ImageView imageView = new ImageView(context2);
                this.galleryButton = imageView;
                imageView.setScaleType(ImageView.ScaleType.CENTER);
                this.galleryButton.setImageResource(C2888R.drawable.qr_gallery);
                this.galleryButton.setBackgroundDrawable(Theme.createSelectorDrawableFromDrawables(Theme.createCircleDrawable(AndroidUtilities.m1124dp(60.0f), 587202559), Theme.createCircleDrawable(AndroidUtilities.m1124dp(60.0f), 1157627903)));
                c33163.addView(this.galleryButton);
            ...
            this.flashButton.setImageResource(C2888R.drawable.qr_flashlight);
            this.flashButton.setBackgroundDrawable(Theme.createCircleDrawable(AndroidUtilities.m1124dp(60.0f), 587202559));
            c33163.addView(this.flashButton);
    ...
    class C33152 extends ActionBar.ActionBarMenuOnItemClick {
        C33152() {
        }
    ...
    class C33163 extends ViewGroup {
        Path path = new Path();
    ...
    class C33185 implements PhotoAlbumPickerActivity.PhotoAlbumPickerActivityDelegate {
        C33185() {
        }
    ...
    class C33196 extends AnimatorListenerAdapter {
        C33196() {
        }
    ...
    class RunnableC33207 implements Runnable {
        RunnableC33207() {
        }
 ...
 binds: [B:136:0x00e2, B:139:0x00e7, B:121:0x0072, B:124:0x0077] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public org.telegram.ui.CameraScanActivity.QrResult tryReadQr(byte[] r25, org.telegram.messenger.camera.Size r26, int r27, int r28, int r29, android.graphics.Bitmap r30) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.CameraScanActivity.tryReadQr(byte[], org.telegram.messenger.camera.Size, int, int, int, android.graphics.Bitmap):org.telegram.ui.CameraScanActivity$QrResult");
    }
