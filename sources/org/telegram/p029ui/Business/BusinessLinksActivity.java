...
import org.telegram.p029ui.Components.URLSpanCopyToClipboard;
...
public class BusinessLinksActivity extends UniversalFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void openRenameAlert(Context context, final int i, final TL_account.TL_businessChatLink tL_businessChatLink, Theme.ResourcesProvider resourcesProvider, boolean z) {
        ...
        builder.setTitle(LocaleController.getString(C2888R.string.BusinessLinksRenameTitle));
        final C32381 c32381 = new EditTextBoldCursor(context) { // from class: org.telegram.ui.Business.BusinessLinksActivity.1
            ...
            C32381(Context context2, Theme.ResourcesProvider resourcesProvider2) {
                super(context2);
        ...
        c32381.setInputType(49153);
        c32381.setTextSize(1, 18.0f);
        c32381.setText(tL_businessChatLink.title);
        int i2 = Theme.key_dialogTextBlack;
        c32381.setTextColor(Theme.getColor(i2, resourcesProvider2));
        c32381.setHintColor(Theme.getColor(Theme.key_groupcreate_hintText, resourcesProvider2));
        c32381.setCursorColor(Theme.getColor(Theme.key_chat_messagePanelCursor));
        c32381.setHintText(LocaleController.getString(C2888R.string.BusinessLinksNamePlaceholder));
        c32381.setSingleLine(true);
        c32381.setFocusable(true);
        c32381.setLineColors(Theme.getColor(Theme.key_windowBackgroundWhiteInputField, resourcesProvider2), Theme.getColor(Theme.key_windowBackgroundWhiteInputFieldActivated, resourcesProvider2), Theme.getColor(Theme.key_text_RedRegular, resourcesProvider2));
        c32381.setImeOptions(6);
        c32381.setBackgroundDrawable(null);
        c32381.setPadding(0, 0, AndroidUtilities.m1124dp(42.0f), 0);
        LinearLayout linearLayout = new LinearLayout(context2);
        linearLayout.setOrientation(1);
        TextView textView = new TextView(context2);
        textView.setTextColor(Theme.getColor(i2, resourcesProvider2));
        textView.setTextSize(1, 16.0f);
        textView.setText(LocaleController.getString(C2888R.string.BusinessLinksRenameMessage));
        linearLayout.addView(textView, LayoutHelper.createLinear(-1, -2, 24.0f, 5.0f, 24.0f, 12.0f));
        linearLayout.addView(c32381, LayoutHelper.createLinear(-1, -2, 24.0f, 0.0f, 24.0f, 10.0f));
        builder.setView(linearLayout);
        builder.setWidth(AndroidUtilities.m1124dp(292.0f));
        c32381.setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: org.telegram.ui.Business.BusinessLinksActivity$$ExternalSyntheticLambda4
            @Override // android.widget.TextView.OnEditorActionListener
            public final boolean onEditorAction(TextView textView2, int i3, KeyEvent keyEvent) {
                return BusinessLinksActivity.$r8$lambda$DtBQAB1IVKEeN5sJZ6_I4zgsmCc(c32381, i, tL_businessChatLink, alertDialogArr, view, textView2, i3, keyEvent);
            }
        });
        builder.setPositiveButton(LocaleController.getString(C2888R.string.Done), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Business.BusinessLinksActivity$$ExternalSyntheticLambda5
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i3) {
                BusinessLinksActivity.$r8$lambda$cxMI8a8s6tOBqxsSlMOAHU39TGw(c32381, i, tL_businessChatLink, alertDialog, i3);
            }
        });
        builder.setNegativeButton(LocaleController.getString(C2888R.string.Cancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Business.BusinessLinksActivity$$ExternalSyntheticLambda6
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i3) {
                alertDialog.dismiss();
            }
        ...
        if (z2) {
            ...
            currentDialog.setOnShowListener(new DialogInterface.OnShowListener() { // from class: org.telegram.ui.Business.BusinessLinksActivity$$ExternalSyntheticLambda8
                ...
                public final void onShow(DialogInterface dialogInterface) {
                    BusinessLinksActivity.$r8$lambda$uViQvlykjsAe5Vxc8gEsQJWvtWI(c32381, dialogInterface);
                }
            });
            ...
            builder.overrideDismissListener(new Utilities.Callback() { // from class: org.telegram.ui.Business.BusinessLinksActivity$$ExternalSyntheticLambda9
                ...
                public final void run(Object obj) {
                    BusinessLinksActivity.$r8$lambda$JbvWftK4TSlZUFN3lwTgZOzHk8g(view, c32381, (Runnable) obj);
                }
            });
            ...
            alertDialogCreate2.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.Business.BusinessLinksActivity$$ExternalSyntheticLambda10
                @Override // android.content.DialogInterface.OnDismissListener
                public final void onDismiss(DialogInterface dialogInterface) {
                    AndroidUtilities.hideKeyboard(c32381);
                }
            });
            alertDialogArr[0].setOnShowListener(new DialogInterface.OnShowListener() { // from class: org.telegram.ui.Business.BusinessLinksActivity$$ExternalSyntheticLambda11
                @Override // android.content.DialogInterface.OnShowListener
                public final void onShow(DialogInterface dialogInterface) {
                    BusinessLinksActivity.$r8$lambda$UcDw_lm1x7o2YELRhLAwjiy5CUg(view, c32381, dialogInterface);
                }
            });
            alertDialogArr[0].show();
        }
        alertDialogArr[0].setDismissDialogByButtons(false);
        c32381.setSelection(c32381.getText().length());
    }

    /* JADX INFO: renamed from: org.telegram.ui.Business.BusinessLinksActivity$1 */
    class C32381 extends EditTextBoldCursor {
        AnimatedTextView.AnimatedTextDrawable limit;
        AnimatedColor limitColor = new AnimatedColor(this);
        private int limitCount;
        final /* synthetic */ Theme.ResourcesProvider val$resourcesProvider;
    ...
    protected CharSequence getTitle() {
        return LocaleController.getString(C2888R.string.BusinessLinks);
    }
    ...
    */
    private static int getPrivacyType(java.util.ArrayList r9) {
        ...
        L4a:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Business.BusinessLinksActivity.getPrivacyType(java.util.ArrayList):int");
    }

    @Override // org.telegram.p029ui.Components.UniversalFragment
    protected void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        String string;
        arrayList.add(UItem.asTopView(LocaleController.getString(C2888R.string.BusinessLinksInfo), C2888R.raw.biz_links));
        universalAdapter.whiteSectionStart();
        if (BusinessLinksController.getInstance(this.currentAccount).canAddNew()) {
            arrayList.add(UItem.asButton(1, C2888R.drawable.menu_link_create, LocaleController.getString(C2888R.string.BusinessLinksAdd)).accent());
        }
        ...
        if (arrayList3.size() == 2) {
            string = LocaleController.formatString(C2888R.string.BusinessLinksFooterTwoLinks, arrayList3.get(0), arrayList3.get(1));
        } else {
            string = LocaleController.formatString(C2888R.string.BusinessLinksFooterOneLink, arrayList3.get(0));
        }
    ...
    protected boolean onLongClick(UItem uItem, View view, int i, float f, float f2) {
        ...
        itemOptionsMakeOptions.add(C2888R.drawable.msg_copy, LocaleController.getString(C2888R.string.Copy), new Runnable() { // from class: org.telegram.ui.Business.BusinessLinksActivity$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                BusinessLinksActivity.$r8$lambda$22WngckNHnN_AZ8f8CZXwLcfKho(tL_businessChatLink);
            }
        });
        itemOptionsMakeOptions.add(C2888R.drawable.msg_share, LocaleController.getString(C2888R.string.LinkActionShare), new Runnable() { // from class: org.telegram.ui.Business.BusinessLinksActivity$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$onLongClick$9(tL_businessChatLink);
            }
        });
        itemOptionsMakeOptions.add(C2888R.drawable.msg_edit, LocaleController.getString(C2888R.string.Rename), new Runnable() { // from class: org.telegram.ui.Business.BusinessLinksActivity$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$onLongClick$10(tL_businessChatLink);
            }
        });
        itemOptionsMakeOptions.add(C2888R.drawable.msg_delete, (CharSequence) LocaleController.getString(C2888R.string.Delete), true, new Runnable() { // from class: org.telegram.ui.Business.BusinessLinksActivity$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public static /* synthetic */ void $r8$lambda$22WngckNHnN_AZ8f8CZXwLcfKho(TL_account.TL_businessChatLink tL_businessChatLink) {
        ...
        BulletinFactory.m1246of(LaunchActivity.getLastFragment()).createCopyLinkBulletin().show();
    }
    ...
    public /* synthetic */ void lambda$onLongClick$12(final TL_account.TL_businessChatLink tL_businessChatLink) {
        AlertDialog alertDialogCreate = new AlertDialog.Builder(getContext(), getResourceProvider()).setTitle(LocaleController.getString(C2888R.string.BusinessLinksDeleteTitle)).setMessage(LocaleController.getString(C2888R.string.BusinessLinksDeleteMessage)).setPositiveButton(LocaleController.getString(C2888R.string.Remove), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Business.BusinessLinksActivity$$ExternalSyntheticLambda12
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
    ...
    public static class BusinessLinkView extends FrameLayout {
        ...
        public BusinessLinkView(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            imageView.setPadding(AndroidUtilities.m1124dp(9.0f), AndroidUtilities.m1124dp(9.0f), AndroidUtilities.m1124dp(9.0f), AndroidUtilities.m1124dp(9.0f));
            imageView.setColorFilter(new PorterDuffColorFilter(-1, PorterDuff.Mode.SRC_IN));
            imageView.setBackground(Theme.createCircleDrawable(AndroidUtilities.m1124dp(36.0f), Theme.getColor(Theme.key_featuredStickers_addButton)));
        ...
        public void set(BusinessLinkWrapper businessLinkWrapper, boolean z) {
            ...
            if (i == 0) {
                this.clicksCountTextView.setText(LocaleController.formatString(C2888R.string.NoClicks, new Object[0]));
            } else {
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(56.0f) + (this.needDivider ? 1 : 0), TLObject.FLAG_30));
        }
