...
public class ChatbotsActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2888R.string.BusinessBots));
        ...
        this.editText.setHint(LocaleController.getString(C2888R.string.BusinessBotLink));
        ...
        FrameLayout frameLayout5 = new FrameLayout(context) { // from class: org.telegram.ui.Business.ChatbotsActivity.3
            ...
            protected void onMeasure(int i4, int i5) {
                super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i4), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(58.0f), TLObject.FLAG_30));
            }
        };
        ...
        textView.setText(LocaleController.getString(C2888R.string.BusinessBotNotFound));
        ...
        CircularProgressDrawable circularProgressDrawable = new CircularProgressDrawable(getThemedColor(i4)) { // from class: org.telegram.ui.Business.ChatbotsActivity.4
            @Override // org.telegram.p029ui.Components.CircularProgressDrawable, android.graphics.drawable.Drawable
        ...
        this.emptyViewLoading.setTranslationY(AndroidUtilities.m1124dp(8.0f));
        SpannableStringBuilder spannableStringBuilderReplaceSingleTag = AndroidUtilities.replaceSingleTag(LocaleController.getString(C2888R.string.BusinessBotsInfo), new Runnable() { // from class: org.telegram.ui.Business.ChatbotsActivity$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
        ...
        if (iIndexOf >= 0) {
            ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C2888R.drawable.arrow_newchat);
        ...
        searchAdapterHelper.setDelegate(new C32475());
    ...
    public /* synthetic */ void lambda$createView$1() {
        Browser.openUrl(getContext(), LocaleController.getString(C2888R.string.BusinessBotsInfoLink));
    }

    /* JADX INFO: renamed from: org.telegram.ui.Business.ChatbotsActivity$5 */
    class C32475 implements SearchAdapterHelper.SearchAdapterHelperDelegate {
    ...
    public void updateSearchLoading() {
        ...
        if (this.wasLoading != (this.searchHelper.isSearchInProgress() || this.scheduledLoading || this.foundBots.size() > 0)) {
            ...
            this.wasLoading = z;
            ViewPropertyAnimator duration = this.emptyViewText.animate().alpha(z ? 0.0f : 1.0f).translationY(z ? -AndroidUtilities.m1124dp(8.0f) : 0.0f).setDuration(320L);
            CubicBezierInterpolator cubicBezierInterpolator = CubicBezierInterpolator.EASE_OUT_QUINT;
            duration.setInterpolator(cubicBezierInterpolator).start();
            this.emptyViewLoading.animate().alpha(z ? 1.0f : 0.0f).translationY(z ? 0.0f : AndroidUtilities.m1124dp(8.0f)).setDuration(320L).setInterpolator(cubicBezierInterpolator).start();
        }
    }
    ...
    private void checkAlert(int i, boolean z, final Runnable runnable) {
        if (!this.shownUsernamePermissionsAlert && i == PERMISSION_PROFILE_USERNAME && z) {
            new AlertDialog.Builder(getContext(), getResourceProvider()).setTitle(LocaleController.getString(C2888R.string.BusinessBotPermissionsWarning)).setMessage(AndroidUtilities.replaceTags(LocaleController.formatString(C2888R.string.BusinessBotPermissionsUsernamesWarningText, UserObject.getPublicUsername(this.selectedBot)))).setNegativeButton(LocaleController.getString(C2888R.string.Cancel), null).setPositiveButton(LocaleController.getString(C2888R.string.Allow), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Business.ChatbotsActivity$$ExternalSyntheticLambda25
        ...
        if (!this.shownGiftsPermissionsAlert && z && (i == PERMISSION_GIFTS_SELL || i == PERMISSION_GIFTS_SETTINGS || i == PERMISSION_GIFTS_TRANSFER || i == PERMISSION_GIFTS_TRANSFER_STARS)) {
            new AlertDialog.Builder(getContext(), getResourceProvider()).setTitle(LocaleController.getString(C2888R.string.BusinessBotPermissionsWarning)).setMessage(AndroidUtilities.replaceTags(LocaleController.formatString(C2888R.string.BusinessBotPermissionsGiftsWarningText, UserObject.getPublicUsername(this.selectedBot)))).setNegativeButton(LocaleController.getString(C2888R.string.Cancel), null).setPositiveButton(LocaleController.getString(C2888R.string.Allow), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Business.ChatbotsActivity$$ExternalSyntheticLambda26
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i2) {
    ...
    */
    public void fillItems(java.util.ArrayList r10, org.telegram.p029ui.Components.UniversalAdapter r11) {
        /*
            Method dump skipped, instruction units count: 1078
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Business.ChatbotsActivity.fillItems(java.util.ArrayList, org.telegram.ui.Components.UniversalAdapter):void");
    }
    ...
    public void onClick(UItem uItem, final View view, int i, float f, float f2) {
        ...
        if (uItem.viewType == 13) {
            ...
            if (!user.bot_business) {
                showDialog(new AlertDialog.Builder(getContext(), this.resourceProvider).setTitle(LocaleController.getString(C2888R.string.BusinessBotNotSupportedTitle)).setMessage(AndroidUtilities.replaceTags(LocaleController.getString(C2888R.string.BusinessBotNotSupportedMessage))).setPositiveButton(LocaleController.getString(C2888R.string.f1606OK), null).create());
                return;
            }
    ...
    public void processDone() {
        ...
        if (this.recipientsHelper.validate(this.listView)) {
            ...
            TL_account.TL_connectedBot tL_connectedBot = this.currentBot;
            if (tL_connectedBot != null && ((user = this.selectedBot) == null || tL_connectedBot.bot_id != user.f1825id)) {
            ...
            if (this.selectedBot != null) {
                ...
                if (tL_connectedBot2 != null) {
                    tL_connectedBot2.bot_id = this.selectedBot.f1825id;
    ...
    public boolean hasChanges() {
        ...
        if ((user == null ? 0L : user.f1825id) != (tL_connectedBot != null ? tL_connectedBot.bot_id : 0L)) {
            return true;
        }
        if (user != null) {
    ...
    public boolean onBackPressed(boolean z) {
        ...
        builder.setMessage(LocaleController.getString(C2888R.string.BusinessBotUnsavedChanges));
        builder.setPositiveButton(LocaleController.getString(C2888R.string.ApplyTheme), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Business.ChatbotsActivity$$ExternalSyntheticLambda1
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
                this.f$0.lambda$onBackPressed$23(alertDialog, i);
            }
        });
        builder.setNegativeButton(LocaleController.getString(C2888R.string.PassportDiscard), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Business.ChatbotsActivity$$ExternalSyntheticLambda2
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
