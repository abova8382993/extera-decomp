...
public class BusinessBotButton extends FrameLayout {
    ...
    public BusinessBotButton(Context context, final ChatActivity chatActivity, final Theme.ResourcesProvider resourcesProvider) {
        ...
        animatedTextView2.setText(LocaleController.getString(C2888R.string.BizBotStatusManages));
        ...
        clickableAnimatedTextView.setBackgroundDrawable(Theme.createSimpleSelectorRoundRectDrawable(iM1124dp, Theme.getColor(i, resourcesProvider), Theme.blendOver(Theme.getColor(i, resourcesProvider), Theme.multAlpha(-1, 0.12f))));
        clickableAnimatedTextView.setTextSize(AndroidUtilities.m1124dp(14.0f));
        ...
        clickableAnimatedTextView.setPadding(AndroidUtilities.m1124dp(13.0f), 0, AndroidUtilities.m1124dp(13.0f), 0);
        ...
        clickableAnimatedTextView.setText(LocaleController.getString(this.paused ? C2888R.string.BizBotStart : C2888R.string.BizBotStop));
        ...
        imageView.setImageResource(C2888R.drawable.msg_mini_customize);
    ...
    public /* synthetic */ void lambda$new$0(View view) {
        ...
        this.paused = !z;
        this.pauseButton.setText(LocaleController.getString(!z ? C2888R.string.BizBotStart : C2888R.string.BizBotStop), true);
        this.subtitleView.cancelAnimation();
        this.subtitleView.setText(LocaleController.getString(this.paused ? C2888R.string.BizBotStatusStopped : C2888R.string.BizBotStatusManages), true);
        if (this.paused) {
            this.flags |= 1;
        } else {
            this.flags &= -2;
    ...
    public /* synthetic */ void lambda$new$3(ChatActivity chatActivity, Theme.ResourcesProvider resourcesProvider, View view) {
        ...
        itemOptionsMakeOptions.add(C2888R.drawable.msg_cancel, (CharSequence) LocaleController.getString(C2888R.string.BizBotRemove), true, new Runnable() { // from class: org.telegram.ui.Business.BusinessBotButton$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
        ...
        if (this.manageUrl != null) {
            itemOptionsMakeOptions.add(C2888R.drawable.msg_settings, LocaleController.getString(C2888R.string.BizBotManage), new Runnable() { // from class: org.telegram.ui.Business.BusinessBotButton$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
        ...
        itemOptionsMakeOptions.translate(AndroidUtilities.m1124dp(10.0f), AndroidUtilities.m1124dp(7.0f));
    ...
    public void updateTextRightPadding() {
        float paddingLeft = this.leftMargin + this.pauseButton.getPaddingLeft() + this.pauseButton.getDrawable().getCurrentWidth() + this.pauseButton.getPaddingRight() + AndroidUtilities.m1124dp(12.0f);
    ...
    public void set(long j, long j2, String str, int i) {
        ...
        this.subtitleView.setText(LocaleController.getString(this.paused ? C2888R.string.BizBotStatusStopped : C2888R.string.BizBotStatusManages));
        this.pauseButton.setText(LocaleController.getString(this.paused ? C2888R.string.BizBotStart : C2888R.string.BizBotStop));
    }
}
