...
public class CreateTopicEmptyView extends LinearLayout {
    ...
    public CreateTopicEmptyView(Context context, FrameLayout frameLayout, Theme.ResourcesProvider resourcesProvider) {
        ...
        setBackground(Theme.createServiceDrawable(AndroidUtilities.m1124dp(18.0f), this, frameLayout, getThemedPaint("paintChatActionBackground")));
        ...
        textView.setMaxWidth(AndroidUtilities.m1124dp(210.0f));
        textView.setText(LocaleController.getString(C2888R.string.AlmostDone));
        TextView textView2 = new TextView(context);
        textView2.setTextSize(1, 13.0f);
        textView2.setTextColor(getThemedColor(i));
        textView2.setGravity(1);
        textView2.setMaxWidth(AndroidUtilities.m1124dp(160.0f));
        textView2.setText(LocaleController.getString(C2888R.string.TopicEmptyViewDescription));
