...
import org.telegram.p029ui.Components.MemberRequestsBottomSheet;
...
public class ChatActivityMemberRequestsDelegate {
        ...
        if (this.root == null) {
            ...
            AvatarsImageView avatarsImageView = new AvatarsImageView(this.fragment.getParentActivity(), false) { // from class: org.telegram.ui.Delegates.ChatActivityMemberRequestsDelegate.1
                ...
                protected void onMeasure(int i, int i2) {
                    super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(this.avatarsDrawable.count == 0 ? 0 : ((r2 - 1) * 20) + 24), TLObject.FLAG_30), i2);
                }
            };
            ...
            imageView.setBackground(Theme.createSelectorDrawable(this.fragment.getThemedColor(Theme.key_inappPlayerClose) & 436207615, 1, AndroidUtilities.m1124dp(14.0f)));
            ...
            this.closeView.setContentDescription(LocaleController.getString(C2888R.string.Close));
            this.closeView.setImageResource(C2888R.drawable.miniplayer_close);
    ...
    public /* synthetic */ void lambda$getView$1(View view) {
        this.fragment.getMessagesController().setChatPendingRequestsOnClose(this.currentChat.f1660id, this.pendingRequestsCount);
    ...
    private void showBottomSheet() {
        if (this.bottomSheet == null) {
            this.bottomSheet = new MemberRequestsBottomSheet(this.fragment, this.currentChat.f1660id) { // from class: org.telegram.ui.Delegates.ChatActivityMemberRequestsDelegate.2
    ...
    private void setPendingRequests(int i, List list, boolean z) {
        ...
        if (i <= 0) {
            if (this.currentChat != null) {
                this.fragment.getMessagesController().setChatPendingRequestsOnClose(this.currentChat.f1660id, 0);
    ...
    private void animatePendingRequests(boolean z, boolean z2) {
        ...
        if (z) {
            if (this.closePendingRequestsCount == -1 && this.currentChat != null) {
                this.closePendingRequestsCount = this.fragment.getMessagesController().getChatPendingRequestsOnClosed(this.currentChat.f1660id);
            }
