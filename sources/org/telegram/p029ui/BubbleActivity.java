...
public class BubbleActivity extends BasePermissionsActivity implements INavigationLayout.INavigationLayoutDelegate {
    ...
    private void onPasscodePause() {
        ...
        if (!SharedConfig.passcodeHash.isEmpty()) {
            SharedConfig.lastPauseTime = (int) (SystemClock.elapsedRealtime() / 1000);
            RunnableC32261 runnableC32261 = new Runnable() { // from class: org.telegram.ui.BubbleActivity.1
                RunnableC32261() {
                }
            ...
            this.lockRunnable = runnableC32261;
            if (SharedConfig.appLocked || (i = SharedConfig.autoLockIn) == Integer.MAX_VALUE) {
                AndroidUtilities.runOnUIThread(runnableC32261, 1000L);
            } else if (i != 0) {
                AndroidUtilities.runOnUIThread(runnableC32261, (((long) i) * 1000) + 1000);
            }
        } else {
    ...
    class RunnableC32261 implements Runnable {
        RunnableC32261() {
        }
