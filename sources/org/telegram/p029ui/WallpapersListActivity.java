...
import org.telegram.p029ui.Cells.WallpaperCell;
...
public class WallpapersListActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private static final int[] searchColorsNamesR = {C2888R.string.Blue, C2888R.string.Red, C2888R.string.Orange, C2888R.string.Yellow, C2888R.string.Green, C2888R.string.Teal, C2888R.string.Purple, C2888R.string.Pink, C2888R.string.Brown, C2888R.string.Black, C2888R.string.Gray, C2888R.string.White};
    ...
    public View createView(Context context) {
        ...
        this.updater = new WallpaperUpdater(getParentActivity(), this, new C73881());
        this.hasOwnBackground = true;
        this.actionBar.setBackButtonImage(C2888R.drawable.ic_ab_back);
        this.actionBar.setAllowOverlayTitle(true);
        int i2 = this.currentType;
        if (i2 == 0) {
            this.actionBar.setTitle(LocaleController.getString(C2888R.string.ChatBackground));
        } else if (i2 == 2) {
            this.actionBar.setTitle("Channel Wallpaper");
        } else if (i2 == 1) {
            this.actionBar.setTitle(LocaleController.getString(C2888R.string.SelectColorTitle));
        }
        this.actionBar.setActionBarMenuOnItemClick(new C73892());
        boolean z = false;
        if (this.currentType == 0) {
            ActionBarMenuItem actionBarMenuItemSearchListener = this.actionBar.createMenu().addItem(0, C2888R.drawable.outline_header_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() { // from class: org.telegram.ui.WallpapersListActivity.3
                ...
                public void onCaptionCleared() {
                    ...
                    WallpapersListActivity.this.searchItem.setSearchFieldHint(LocaleController.getString(C2888R.string.SearchBackgrounds));
                }
            });
            this.searchItem = actionBarMenuItemSearchListener;
            actionBarMenuItemSearchListener.setSearchFieldHint(LocaleController.getString(C2888R.string.SearchBackgrounds));
            ...
            this.actionModeViews.add(actionBarMenuCreateActionMode.addItemWithWidth(3, C2888R.drawable.msg_forward, AndroidUtilities.m1124dp(54.0f), LocaleController.getString(C2888R.string.Forward)));
            this.actionModeViews.add(actionBarMenuCreateActionMode.addItemWithWidth(4, C2888R.drawable.msg_delete, AndroidUtilities.m1124dp(54.0f), LocaleController.getString(C2888R.string.Delete)));
    ...
    class C73881 implements WallpaperUpdater.WallpaperUpdaterDelegate {
    ...
    class C73892 extends ActionBar.ActionBarMenuOnItemClick {
        C73892() {
        }
        ...
        public void onItemClick(int i) {
            ...
            builder.setMessage(LocaleController.formatString("DeleteChatBackgroundsAlert", C2888R.string.DeleteChatBackgroundsAlert, new Object[0]));
            builder.setPositiveButton(LocaleController.getString(C2888R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.WallpapersListActivity$2$$ExternalSyntheticLambda0
        ...
        public /* synthetic */ void lambda$onItemClick$2(AlertDialog alertDialog, int i) {
            ...
            for (int i2 = 0; i2 < WallpapersListActivity.this.selectedWallPapers.size(); i2++) {
                ...
                if (objValueAt instanceof ColorWallpaper) {
                    ...
                    if (wallPaper == null || wallPaper.f1833id >= 0) {
                        objValueAt = wallPaper;
                    } else {
                        WallpapersListActivity.this.getMessagesStorage().deleteWallpaper(colorWallpaper.parentWallpaper.f1833id);
                ...
                if (objValueAt instanceof TLRPC.WallPaper) {
                    ...
                    if (objValueAt instanceof TLRPC.TL_wallPaperNoFile) {
                        ...
                        tL_inputWallPaperNoFile.f1742id = wallPaper2.f1833id;
                        savewallpaper.wallpaper = tL_inputWallPaperNoFile;
                    } else {
                        TLRPC.TL_inputWallPaper tL_inputWallPaper = new TLRPC.TL_inputWallPaper();
                        tL_inputWallPaper.f1741id = wallPaper2.f1833id;
            ...
            if (arrayList.size() > 1 || ((MessagesStorage.TopicKey) arrayList.get(0)).dialogId == UserConfig.getInstance(((BaseFragment) WallpapersListActivity.this).currentAccount).getClientUserId() || charSequence != null) {
                ...
                for (int i4 = 0; i4 < arrayList.size(); i4++) {
                    ...
                    if (charSequence != null) {
                        SendMessagesHelper.getInstance(((BaseFragment) WallpapersListActivity.this).currentAccount).sendMessage(SendMessagesHelper.SendMessageParams.m1175of(charSequence.toString(), j, null, null, null, true, null, null, null, true, 0, 0, null, false));
                    }
                    if (!TextUtils.isEmpty(sb)) {
                        SendMessagesHelper.getInstance(((BaseFragment) WallpapersListActivity.this).currentAccount).sendMessage(SendMessagesHelper.SendMessageParams.m1175of(sb.toString(), j, null, null, null, true, null, null, null, true, 0, 0, null, false));
                    }
                }
                ...
                SendMessagesHelper.getInstance(((BaseFragment) WallpapersListActivity.this).currentAccount).sendMessage(SendMessagesHelper.SendMessageParams.m1175of(sb.toString(), j2, null, null, null, true, null, null, null, true, 0, 0, null, false));
            }
            return true;
        }
    }
    ...
    public /* synthetic */ void lambda$createView$4(View view, int i) {
        ...
        if (i == this.setColorRow) {
            ...
            builder.setTitle(LocaleController.getString(C2888R.string.ResetChatBackgroundsAlertTitle));
            builder.setMessage(LocaleController.getString(C2888R.string.ResetChatBackgroundsAlert));
            builder.setPositiveButton(LocaleController.getString(C2888R.string.Reset), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.WallpapersListActivity$$ExternalSyntheticLambda4
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i2) {
    ...
    public boolean onItemLongClick(WallpaperCell wallpaperCell, Object obj, int i) {
        ...
        if (i2 != 2 && i2 != 3) {
            ...
            if (!this.actionBar.isActionModeShowed() && getParentActivity() != null && (obj2 instanceof TLRPC.WallPaper)) {
                ...
                this.selectedWallPapers.put(((TLRPC.WallPaper) obj2).f1833id, obj);
    ...
    */
    public void onItemClick(org.telegram.p029ui.Cells.WallpaperCell r19, java.lang.Object r20, int r21) {
        /*
            Method dump skipped, instruction units count: 222
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.WallpapersListActivity.onItemClick(org.telegram.ui.Cells.WallpaperCell, java.lang.Object, int):void");
    }
    ...
    */
    public void didReceivedNotification(int r20, int r21, java.lang.Object... r22) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.WallpapersListActivity.didReceivedNotification(int, int, java.lang.Object[]):void");
    }
        ...
        if (!z) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (obj instanceof TLRPC.WallPaper) {
                    long j2 = ((TLRPC.WallPaper) obj).f1833id;
                    if (j2 >= 0) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (!"fqv01SQemVIBAAAApND8LDRUhRU".equals(wallPaper.slug)) {
                    if ((wallPaper instanceof TLRPC.TL_wallPaper) && !(wallPaper.document instanceof TLRPC.TL_documentEmpty)) {
                        ...
                        if (wallPaper.pattern && (document = wallPaper.document) != null && !this.patternsDict.containsKey(Long.valueOf(document.f1668id))) {
    ...
    private void fillWallpapersWithCustom() {
        ...
        if (i6 == 0 || i6 == 2) {
            ...
            if (r5 instanceof TLRPC.WallPaper) {
                ...
                r10 = r52;
                j = tL_wallPaper3.f1833id;
            } else {
                str = this.selectedBackgroundSlug;
                j = (!(r5 instanceof ColorWallpaper) || (wallPaper = ((ColorWallpaper) r5).parentWallpaper) == null) ? 0L : wallPaper.f1833id;
                r10 = r5;
                tL_wallPaper = null;
            }
    ...
    public /* synthetic */ int lambda$fillWallpapersWithCustom$9(long j, String str, boolean z, Object obj, Object obj2) {
        ...
        if (j != 0) {
            if (wallPaper.f1833id == j) {
                return -1;
            }
            if (wallPaper2.f1833id == j) {
                return 1;
            }
        } else {
    ...
    private class ColorCell extends View {
        ...
        protected void onMeasure(int i, int i2) {
            setMeasuredDimension(AndroidUtilities.m1124dp(50.0f), AndroidUtilities.m1124dp(62.0f));
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawCircle(AndroidUtilities.m1124dp(25.0f), AndroidUtilities.m1124dp(31.0f), AndroidUtilities.m1124dp(18.0f), WallpapersListActivity.this.colorPaint);
            if (this.color == Theme.getColor(Theme.key_windowBackgroundWhite)) {
                canvas.drawCircle(AndroidUtilities.m1124dp(25.0f), AndroidUtilities.m1124dp(31.0f), AndroidUtilities.m1124dp(18.0f), WallpapersListActivity.this.colorFramePaint);
            }
        }
    }
    ...
    class SearchAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public /* synthetic */ void lambda$searchImages$3(int i, TLObject tLObject) {
            ...
            if (tLObject != null) {
                ...
                for (int i2 = 0; i2 < size2; i2++) {
                    ...
                    if ("photo".equals(botInlineResult.type) && !this.searchResultKeys.containsKey(botInlineResult.f1658id)) {
                        ...
                        if (photo != null) {
                            ...
                            if (closestPhotoSizeWithSize != null) {
                                searchImage.width = closestPhotoSizeWithSize.f1694w;
                                searchImage.height = closestPhotoSizeWithSize.f1693h;
        ...
        public /* synthetic */ void lambda$onCreateViewHolder$5(View view, int i) {
            String string = LocaleController.getString(C2888R.string.BackgroundSearchColor);
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i != 0) {
                ...
                if (i == 1) {
                    ...
                    recyclerListView.setPadding(AndroidUtilities.m1124dp(7.0f), 0, AndroidUtilities.m1124dp(7.0f), 0);
                ...
                graySectionCell = new WallpaperCell(this.mContext) { // from class: org.telegram.ui.WallpapersListActivity.SearchAdapter.1
                    @Override // org.telegram.p029ui.Cells.WallpaperCell
            ...
            if (i == 1) {
                graySectionCell.setLayoutParams(new RecyclerView.LayoutParams(-1, AndroidUtilities.m1124dp(60.0f)));
            } else {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType != 0) {
                ...
                ((GraySectionCell) viewHolder.itemView).setText(LocaleController.getString(C2888R.string.SearchByColor));
                return;
            }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (i == WallpapersListActivity.this.uploadImageRow) {
                    textCell.setTextAndIcon((CharSequence) LocaleController.getString(C2888R.string.SelectFromGallery), C2888R.drawable.msg_photos, true);
                    return;
                }
                if (i == WallpapersListActivity.this.setColorRow) {
                    textCell.setTextAndIcon((CharSequence) LocaleController.getString(C2888R.string.SetColor), C2888R.drawable.msg_palette, true);
                    return;
                }
                if (i == WallpapersListActivity.this.resetRow) {
                    textCell.setText(LocaleController.getString(C2888R.string.ResetChatBackgrounds), false);
                    return;
                } else {
                    if (i == WallpapersListActivity.this.galleryRow) {
                        textCell.setTextAndIcon((CharSequence) "Choose from gallery", C2888R.drawable.msg_background, false);
            ...
            if (itemViewType != 2) {
                ...
                if (i == WallpapersListActivity.this.resetInfoRow) {
                    textInfoPrivacyCell.setText(LocaleController.getString(C2888R.string.ResetChatBackgroundsInfo));
                    return;
                } else {
