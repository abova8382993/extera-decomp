...
public class AddressBarList extends FrameLayout {
    ...
    public AddressBarList(Context context) {
        ...
        imageView2.setImageResource(C2888R.drawable.msg_copy);
        ...
        this.space = new View(context) { // from class: org.telegram.ui.web.AddressBarList.2
            ...
            protected void onMeasure(int i3, int i4) {
                super.onMeasure(i3, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(6.0f), TLObject.FLAG_30));
            }
        };
    ...
    public void clearRecentSearches(View view) {
        new AlertDialog.Builder(getContext()).setTitle(LocaleController.getString(C2888R.string.WebRecentClearTitle)).setMessage(LocaleController.getString(C2888R.string.WebRecentClearText)).setPositiveButton(LocaleController.getString(C2888R.string.f1606OK), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.web.AddressBarList$$ExternalSyntheticLambda11
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        while (i < this.suggestions.size()) {
            ...
            arrayList.add(Address2View.Factory.m1345as(1, str, new View.OnClickListener() { // from class: org.telegram.ui.web.AddressBarList$$ExternalSyntheticLambda5
        ...
        if (!recentSearches.isEmpty()) {
            arrayList.add(UItem.asGraySection(LocaleController.getString(C2888R.string.WebSectionRecent), LocaleController.getString(C2888R.string.WebRecentClear), new View.OnClickListener() { // from class: org.telegram.ui.web.AddressBarList$$ExternalSyntheticLambda6
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            while (i2 < recentSearches.size()) {
                ...
                arrayList.add(Address2View.Factory.m1345as(0, str2, new View.OnClickListener() { // from class: org.telegram.ui.web.AddressBarList$$ExternalSyntheticLambda7
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
        ...
        arrayList.add(UItem.asGraySection(LocaleController.getString(C2888R.string.WebSectionBookmarks)));
        for (int i3 = 0; i3 < this.bookmarksList.links.size(); i3++) {
            ...
            if (!TextUtils.isEmpty(getLink(messageObject))) {
                arrayList.add(BookmarkView.Factory.m1346as(messageObject, true));
            }
        }
    ...
    public void setCurrent(Bitmap bitmap, String str, String str2, final Runnable runnable, Utilities.Callback callback, Utilities.Callback callback2, Utilities.Callback callback3, View.OnClickListener onClickListener) {
        String strDecode;
        if (bitmap == null) {
            this.currentIconView.setImageResource(C2888R.drawable.msg_language);
    ...
    public static class Address2View extends FrameLayout {
        ...
        public Address2View(Context context) {
            ...
            imageView.setImageResource(C2888R.drawable.menu_clear_recent);
            ...
            imageView2.setImageResource(C2888R.drawable.menu_browser_arrowup);
        ...
        public void setColors(int i, int i2) {
            ...
            this.insertView.setBackground(Theme.createRadSelectorDrawable(0, Theme.multAlpha(i2, 0.15f), AndroidUtilities.m1124dp(4.0f), AndroidUtilities.m1124dp(4.0f)));
        }
        ...
        public void set(int i, String str, View.OnClickListener onClickListener, boolean z, boolean z2, AddressBarList addressBarList, boolean z3) {
            ...
            this.iconView.setImageResource(i == 0 ? C2888R.drawable.msg_clear_recent : C2888R.drawable.msg_search);
        ...
        public void setAsShowMore(AddressBarList addressBarList) {
            this.iconView.setImageResource(C2888R.drawable.arrow_more);
        ...
        protected void onDraw(Canvas canvas) {
            super.onDraw(canvas);
            if (this.needDivider) {
                canvas.drawRect(AndroidUtilities.m1124dp(64.0f), getHeight() - Math.max(AndroidUtilities.m1124dp(0.66f), 1), getWidth(), getHeight(), this.dividerPaint);
            }
        }
        ...
        public static class Factory extends UItem.UItemFactory {
            ...
            public static UItem m1345as(int i, String str, View.OnClickListener onClickListener, boolean z, boolean z2, AddressBarList addressBarList) {
    ...
    public static class BookmarkView extends FrameLayout implements Theme.Colorable {
        ...
        public BookmarkView(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            backupImageView.setRoundRadius(AndroidUtilities.m1124dp(6.0f));
            ...
            imageView.setImageResource(C2888R.drawable.attach_arrow_right);
        ...
        public void set(MessageObject messageObject, boolean z, String str, boolean z2, boolean z3) {
            ...
            if (webMetadata != null && (bitmap = webMetadata.favicon) != null) {
                ...
                this.iconView.setImage(ImageLocation.getForPhoto(FileLoader.getClosestPhotoSizeWithSize(photo.sizes, AndroidUtilities.m1124dp(32.0f), true, null, true), webPage.photo), AndroidUtilities.m1124dp(32.0f) + "_" + AndroidUtilities.m1124dp(32.0f), ImageLocation.getForPhoto(FileLoader.getClosestPhotoSizeWithSize(webPage.photo.sizes, AndroidUtilities.m1124dp(32.0f), true, null, false), webPage.photo), AndroidUtilities.m1124dp(32.0f) + "_" + AndroidUtilities.m1124dp(32.0f), 0, messageObject);
            } else {
                ...
                CombinedDrawable combinedDrawable = new CombinedDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m1124dp(6.0f), Theme.multAlpha(this.textColor, 0.1f)), new Drawable(strSubstring) { // from class: org.telegram.ui.web.AddressBarList.BookmarkView.2
            ...
            this.textLayoutParams.rightMargin = AndroidUtilities.m1124dp(52.0f);
        ...
        public void set(BrowserHistory.Entry entry, String str, boolean z) {
            ...
            if (webMetadata != null && (bitmap = webMetadata.favicon) != null) {
                ...
                CombinedDrawable combinedDrawable = new CombinedDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m1124dp(6.0f), Theme.multAlpha(this.textColor, 0.1f)), new Drawable(strSubstring) { // from class: org.telegram.ui.web.AddressBarList.BookmarkView.3
                    private final Text text;
                    final /* synthetic */ String val$firstLetter;
            ...
            this.textLayoutParams.rightMargin = AndroidUtilities.m1124dp(70.0f);
            this.textLayout.setLayoutParams(this.textLayoutParams);
            this.needDivider = z;
            setWillNotDraw(!z);
        }
        ...
        protected void onDraw(Canvas canvas) {
            super.onDraw(canvas);
            if (this.needDivider) {
                canvas.drawRect(AndroidUtilities.m1124dp(59.0f), getHeight() - Math.max(AndroidUtilities.m1124dp(0.66f), 1), getWidth(), getHeight(), this.dividerPaint);
            }
        }
        ...
        public static class Factory extends UItem.UItemFactory {
            ...
            /* JADX INFO: renamed from: as */
            public static UItem m1346as(MessageObject messageObject, boolean z) {
                UItem uItemOfFactory = UItem.ofFactory(Factory.class);
            ...
            /* JADX INFO: renamed from: as */
            public static UItem m1347as(MessageObject messageObject, boolean z, String str) {
                UItem uItemOfFactory = UItem.ofFactory(Factory.class);
                uItemOfFactory.intValue = 3;
                uItemOfFactory.accent = z;
                uItemOfFactory.object2 = messageObject;
            ...
            /* JADX INFO: renamed from: as */
            public static UItem m1348as(BrowserHistory.Entry entry, String str) {
                UItem uItemOfFactory = UItem.ofFactory(Factory.class);
                uItemOfFactory.intValue = 3;
        ...
        if (string != null) {
            try {
                ...
                Collections.sort(arrayList, new Comparator() { // from class: org.telegram.ui.web.AddressBarList$$ExternalSyntheticLambda4
                    @Override // java.util.Comparator
                    public final int compare(Object obj, Object obj2) {
                        return AddressBarList.m20717$r8$lambda$M1RWMsq_khurYUX4HFPRF86Yew((AddressBarList.QueryEntry) obj, (AddressBarList.QueryEntry) obj2);
                    }
                });
            } catch (Exception e) {
                FileLog.m1136e(e);
    ...
    public static /* synthetic */ int m20717$r8$lambda$M1RWMsq_khurYUX4HFPRF86Yew(QueryEntry queryEntry, QueryEntry queryEntry2) {
        return (int) (queryEntry2.rank - queryEntry.rank);
    }
