...
import org.telegram.p029ui.Cells.TextCheckbox2Cell;
...
public class RestrictedLanguagesSelectActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(this.type == 1 ? C2888R.string.TranslationTarget : C2888R.string.DoNotTranslate));
        ...
        this.actionBar.createMenu().addItem(0, C2888R.drawable.outline_header_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() { // from class: org.telegram.ui.RestrictedLanguagesSelectActivity.2
        ...
        }).setSearchFieldHint(LocaleController.getString(C2888R.string.Search));
    ...
    public /* synthetic */ void lambda$createView$1(View view, int i) {
        ...
        if (this.selectedLanguages.contains(strNormalizeRestrictedLanguage)) {
            Collection.EL.removeIf(this.selectedLanguages, new Predicate() { // from class: org.telegram.ui.RestrictedLanguagesSelectActivity$$ExternalSyntheticLambda6
                ...
                public /* synthetic */ Predicate m1298or(Predicate predicate) {
    ...
    private void fillLanguages() {
        ...
        if (this.type == 1) {
            ...
            language2.ownDisplayName = LocaleController.getString(C2888R.string.TranslationTargetApp);
            ...
            language2.f1618q = (language2.ownDisplayName + " " + language2.displayName).toLowerCase(Locale.US);
        ...
        for (int i3 = 0; i3 < arrayList2.size(); i3++) {
            ...
            language5.f1618q = language5.code.toLowerCase();
    ...
    private void processSearch(String str) {
        ...
        for (int i = 0; i < this.allLanguages.size(); i++) {
            ...
            if (language.f1618q.startsWith(lowerCase)) {
                this.searchResult.add(0, language);
            } else if (language.f1618q.contains(lowerCase)) {
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                headerCell.setText(LocaleController.getString(C2888R.string.ChooseLanguages));
        ...
        */
        public void onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder r6, int r7) {
            ...
            Lb:
                ...
                org.telegram.ui.Cells.ShadowSectionCell r6 = (org.telegram.p029ui.Cells.ShadowSectionCell) r6
                return
            L10:
                android.view.View r6 = r6.itemView
                org.telegram.ui.Cells.TextCheckbox2Cell r6 = (org.telegram.p029ui.Cells.TextCheckbox2Cell) r6
                boolean r0 = r5.search
                r2 = 0
                r3 = 0
                if (r0 == 0) goto L44
                if (r7 < 0) goto L35
                org.telegram.ui.RestrictedLanguagesSelectActivity r0 = org.telegram.p029ui.RestrictedLanguagesSelectActivity.this
                java.util.ArrayList r0 = org.telegram.p029ui.RestrictedLanguagesSelectActivity.m17798$$Nest$fgetsearchResult(r0)
                int r0 = r0.size()
                if (r7 >= r0) goto L35
                org.telegram.ui.RestrictedLanguagesSelectActivity r0 = org.telegram.p029ui.RestrictedLanguagesSelectActivity.this
                java.util.ArrayList r0 = org.telegram.p029ui.RestrictedLanguagesSelectActivity.m17798$$Nest$fgetsearchResult(r0)
            ...
            L44:
                org.telegram.ui.RestrictedLanguagesSelectActivity r0 = org.telegram.p029ui.RestrictedLanguagesSelectActivity.this
                int r0 = org.telegram.p029ui.RestrictedLanguagesSelectActivity.m17800$$Nest$fgetseparatorRow(r0)
                if (r0 < 0) goto L56
                org.telegram.ui.RestrictedLanguagesSelectActivity r0 = org.telegram.p029ui.RestrictedLanguagesSelectActivity.this
                int r0 = org.telegram.p029ui.RestrictedLanguagesSelectActivity.m17800$$Nest$fgetseparatorRow(r0)
                if (r7 <= r0) goto L56
            ...
            L56:
                if (r7 < 0) goto L7f
                org.telegram.ui.RestrictedLanguagesSelectActivity r0 = org.telegram.p029ui.RestrictedLanguagesSelectActivity.this
                java.util.ArrayList r0 = org.telegram.p029ui.RestrictedLanguagesSelectActivity.m17793$$Nest$fgetallLanguages(r0)
                int r0 = r0.size()
                if (r7 >= r0) goto L7f
                org.telegram.ui.RestrictedLanguagesSelectActivity r0 = org.telegram.p029ui.RestrictedLanguagesSelectActivity.this
                java.util.ArrayList r0 = org.telegram.p029ui.RestrictedLanguagesSelectActivity.m17793$$Nest$fgetallLanguages(r0)
            ...
            L89:
                ...
                org.telegram.ui.RestrictedLanguagesSelectActivity r7 = org.telegram.p029ui.RestrictedLanguagesSelectActivity.this
                int r7 = org.telegram.p029ui.RestrictedLanguagesSelectActivity.m17801$$Nest$fgettype(r7)
                if (r7 != r1) goto La3
                org.telegram.ui.RestrictedLanguagesSelectActivity r7 = org.telegram.p029ui.RestrictedLanguagesSelectActivity.this
                java.lang.String r0 = r3.code
                boolean r7 = org.telegram.p029ui.RestrictedLanguagesSelectActivity.m17802$$Nest$misTargetChecked(r7, r0)
                r6.setChecked(r7)
                return
            La3:
                org.telegram.ui.RestrictedLanguagesSelectActivity r7 = org.telegram.p029ui.RestrictedLanguagesSelectActivity.this
                java.util.HashSet r7 = org.telegram.p029ui.RestrictedLanguagesSelectActivity.m17799$$Nest$fgetselectedLanguages(r7)
                java.lang.String r0 = r3.code
                java.lang.String r0 = org.telegram.p029ui.RestrictedLanguagesSelectActivity.m17803$$Nest$smnormalizeRestrictedLanguage(r0)
