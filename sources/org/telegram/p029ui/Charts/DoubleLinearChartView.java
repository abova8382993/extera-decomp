...
public class DoubleLinearChartView extends BaseChartView {
    ...
    protected void drawChart(Canvas canvas) {
        ...
        if (this.chartData != null) {
            ...
            if (i2 == 2) {
                ...
                canvas.scale((f13 * 2.0f) + 1.0f, 1.0f, transitionParams.f1917pX, transitionParams.f1918pY);
            } else if (i2 == 1) {
                ...
                canvas.scale(f15, f15, transitionParams2.f1917pX, transitionParams2.f1918pY);
            } else {
    ...
    protected void drawSelection(Canvas canvas) {
        ...
        while (true) {
            ...
            if (lineViewData.enabled || lineViewData.alpha != 0.0f) {
                float f6 = lineViewData.line.f1916y[this.selectedIndex] * ((DoubleLinearChartData) this.chartData).linesK[this.tmpI];
    ...
    */
    protected void drawSignaturesToHorizontalLines(android.graphics.Canvas r19, org.telegram.p029ui.Charts.view_data.ChartHorizontalLinesData r20) {
        /*
            Method dump skipped, instruction units count: 345
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Charts.DoubleLinearChartView.drawSignaturesToHorizontalLines(android.graphics.Canvas, org.telegram.ui.Charts.view_data.ChartHorizontalLinesData):void");
    }
