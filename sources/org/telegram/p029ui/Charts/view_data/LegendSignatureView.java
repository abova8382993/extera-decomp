...
public class LegendSignatureView extends FrameLayout {
    ...
    class RunnableC35621 implements Runnable {
        RunnableC35621() {
        }
    ...
    public LegendSignatureView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        imageView.setImageResource(C2888R.drawable.ic_chevron_right_black_18dp);
        RadialProgressView radialProgressView = new RadialProgressView(context);
        this.progressView = radialProgressView;
        radialProgressView.setSize(AndroidUtilities.m1124dp(12.0f));
        this.progressView.setStrokeWidth(AndroidUtilities.m1124dp(0.5f));
    ...
    public void recolor() {
        ...
        this.shadowDrawable = getContext().getResources().getDrawable(C2888R.drawable.stats_tooltip).mutate();
        this.backgroundDrawable = Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1124dp(4.0f), Theme.getColor(Theme.key_dialogBackground, this.resourcesProvider), Theme.getColor(Theme.key_listSelector, this.resourcesProvider), -16777216);
        CombinedDrawable combinedDrawable = new CombinedDrawable(this.shadowDrawable, this.backgroundDrawable, AndroidUtilities.m1124dp(3.0f), AndroidUtilities.m1124dp(3.0f));
    ...
    public void setData(int i, long j, ArrayList arrayList, boolean z, int i2, float f) {
        ...
        for (int i5 = 0; i5 < arrayList.size(); i5++) {
            if (((LineViewData) arrayList.get(i5)).enabled) {
                j2 += ((LineViewData) arrayList.get(i5)).line.f1916y[i];
            }
        }
        int i6 = 0;
        while (i6 < length) {
            ...
            if (!lineViewData.enabled) {
                ...
                i3 = i6;
                int i8 = i4;
                textViewEmojis.setText(formatWholeNumber(lineViewData.line.f1916y[i], i2, i7, textViewEmojis, f));
                if (i2 == 1) {
                    TextView textView2 = holder.signature;
                    int i9 = i7 == 0 ? C2888R.string.ChartInTON : C2888R.string.ChartInUSD;
                    Object[] objArr = new Object[1];
                    objArr[i8] = lineViewData.line.name;
                    textView2.setText(LocaleController.formatString(i9, objArr));
                } else if (i2 == 2) {
                    TextView textView3 = holder.signature;
                    int i10 = i7 == 0 ? C2888R.string.ChartInXTR : C2888R.string.ChartInUSD;
                    Object[] objArr2 = new Object[1];
                    objArr2[i8] = lineViewData.line.name;
                    textView3.setText(StarsIntroActivity.replaceStarsWithPlain(LocaleController.formatString(i10, objArr2), 0.7f));
                } else {
                    holder.signature.setText(lineViewData.line.name);
                }
                int i11 = lineViewData.line.colorKey;
                if (i11 >= 0 && Theme.hasThemeKey(i11)) {
                ...
                textView4.setTextColor(Theme.getColor(i12, this.resourcesProvider));
                if (this.showPercentage && (textView = holder.percentage) != null) {
                    textView.setVisibility(i8);
                    holder.percentage.setTextColor(Theme.getColor(i12, this.resourcesProvider));
                    float f2 = ((LineViewData) arrayList.get(i3)).line.f1916y[i] / j2;
                    if (f2 < 0.1f && f2 != 0.0f) {
    ...
    class C35632 extends AnimatorListenerAdapter {
        C35632() {
        }
    ...
    class Holder {
        ...
        Holder() {
            ...
            linearLayout.setPadding(AndroidUtilities.m1124dp(4.0f), AndroidUtilities.m1124dp(2.0f), AndroidUtilities.m1124dp(4.0f), AndroidUtilities.m1124dp(2.0f));
            if (LegendSignatureView.this.showPercentage) {
                ...
                this.percentage.getLayoutParams().width = AndroidUtilities.m1124dp(36.0f);
