...
import org.telegram.p029ui.Charts.view_data.StackLinearViewData;
  ...
  0x05d7: PHI (r17v4 float) = (r17v3 float), (r17v3 float), (r17v5 float) binds: [B:151:0x04ab, B:159:0x04f4, B:213:0x05d7] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    protected void drawChart(android.graphics.Canvas r42) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Charts.StackLinearChartView.drawChart(android.graphics.Canvas):void");
    }

    private int quarterForPoint(float f, float f2) {
        float fCenterX = this.chartArea.centerX();
        float fCenterY = this.chartArea.centerY() + AndroidUtilities.m1124dp(16.0f);
    ...
    */
    protected void drawPickerChart(android.graphics.Canvas r26) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Charts.StackLinearChartView.drawPickerChart(android.graphics.Canvas):void");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void fillTransitionParams(org.telegram.p029ui.Charts.view_data.TransitionParams r21) {
        /*
            Method dump skipped, instruction units count: 355
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Charts.StackLinearChartView.fillTransitionParams(org.telegram.ui.Charts.view_data.TransitionParams):void");
    }
}
