...
import org.telegram.p029ui.Components.OverlayActionBarLayoutDialog;
...
import org.telegram.p029ui.bots.BotButtons;
...
public class BotWebViewSheet extends Dialog implements NotificationCenter.NotificationCenterDelegate, BottomSheetTabsOverlay.Sheet {
    ...
    public void showJustAddedBulletin() {
        ...
        if (z && tL_attachMenuBot.show_in_attach_menu) {
            string = LocaleController.formatString(C2888R.string.BotAttachMenuShortcatAddedAttachAndSide, user.first_name);
        } else if (z) {
            string = LocaleController.formatString(C2888R.string.BotAttachMenuShortcatAddedSide, user.first_name);
        } else {
            string = LocaleController.formatString(C2888R.string.BotAttachMenuShortcatAddedAttach, user.first_name);
        }
    ...
    public /* synthetic */ void lambda$showJustAddedBulletin$1(final String str) {
        showBulletin(new Utilities.CallbackReturn() { // from class: org.telegram.ui.bots.BotWebViewSheet$$ExternalSyntheticLambda56
            ...
            public final Object run(Object obj) {
                return ((BulletinFactory) obj).createSimpleBulletin(C2888R.raw.contact_check, AndroidUtilities.replaceTags(str)).setDuration(5000);
            }
        });
    }
    ...
    public boolean restoreState(BaseFragment baseFragment, BottomSheetTabs.WebTabData webTabData) {
        ...
        AndroidUtilities.updateImageViewImageAnimated(this.actionBar.getBackButton(), this.backButtonShown ? C2888R.drawable.ic_ab_back : C2888R.drawable.ic_close_white);
    ...
    public BotWebViewSheet(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            */
            protected void onMeasure(int r5, int r6) {
                ...
                L20:
                    ...
                    if (r2 == 0) goto L4c
                    org.telegram.ui.bots.BotWebViewSheet r2 = org.telegram.p029ui.bots.BotWebViewSheet.this
                    boolean r2 = org.telegram.p029ui.bots.BotWebViewSheet.m20608$$Nest$fgetdismissed(r2)
                    if (r2 != 0) goto L4c
                    org.telegram.ui.bots.BotWebViewSheet r2 = org.telegram.p029ui.bots.BotWebViewSheet.this
                    boolean r2 = org.telegram.p029ui.bots.BotWebViewSheet.m20629$$Nest$fgetresetOffsetY(r2)
                    if (r2 == 0) goto L4c
                    org.telegram.ui.bots.BotWebViewSheet r2 = org.telegram.p029ui.bots.BotWebViewSheet.this
                    r3 = 1
                    org.telegram.p029ui.bots.BotWebViewSheet.m20648$$Nest$fputignoreLayout(r2, r3)
                    r4.setOffsetY(r0)
                    org.telegram.ui.bots.BotWebViewSheet r0 = org.telegram.p029ui.bots.BotWebViewSheet.this
                    org.telegram.p029ui.bots.BotWebViewSheet.m20648$$Nest$fputignoreLayout(r0, r1)
                    org.telegram.ui.bots.BotWebViewSheet r0 = org.telegram.p029ui.bots.BotWebViewSheet.this
                    org.telegram.p029ui.bots.BotWebViewSheet.m20654$$Nest$fputresetOffsetY(r0, r1)
                L4c:
                    org.telegram.ui.bots.BotWebViewSheet r0 = org.telegram.p029ui.bots.BotWebViewSheet.this
                    boolean r0 = org.telegram.p029ui.bots.BotWebViewSheet.m20610$$Nest$fgetfullscreen(r0)
                ...
                L7a:
                    ...
                    int r6 = r6 - r0
                    int r0 = org.telegram.p029ui.ActionBar.ActionBar.getCurrentActionBarHeight()
                    int r6 = r6 - r0
                L8e:
                    org.telegram.ui.bots.BotWebViewSheet r0 = org.telegram.p029ui.bots.BotWebViewSheet.this
                    org.telegram.ui.bots.BotButtons r0 = org.telegram.p029ui.bots.BotWebViewSheet.m20600$$Nest$fgetbotButtons(r0)
                    if (r0 == 0) goto Lad
                    org.telegram.ui.bots.BotWebViewSheet r0 = org.telegram.p029ui.bots.BotWebViewSheet.this
                    org.telegram.ui.bots.BotButtons r0 = org.telegram.p029ui.bots.BotWebViewSheet.m20600$$Nest$fgetbotButtons(r0)
                ...
                Lad:
                    ...
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.bots.BotWebViewSheet.C74291.onMeasure(int, int):void");
            }
            ...
            public void setTranslationY(float f) {
                ...
                if (BotWebViewSheet.this.fullscreenButtons != null) {
                    BotWebViewSheet.this.fullscreenButtons.setTranslationY(AndroidUtilities.m1124dp(24.0f) + f);
                }
                if (BotWebViewSheet.this.bulletinContainer != null) {
                    BotWebViewSheet.this.bulletinContainer.setTranslationY(AndroidUtilities.lerp(ActionBar.getCurrentActionBarHeight() - AndroidUtilities.m1124dp(24.0f), BotWebViewSheet.this.insets.top + AndroidUtilities.m1124dp(70.0f), BotWebViewSheet.this.fullscreenProgress) + BotWebViewSheet.this.swipeContainer.getTranslationY());
                }
            }
        };
        ...
        this.webViewContainer.setDelegate(new C74393(context, resourcesProvider));
        this.linePaint.setStyle(Paint.Style.FILL_AND_STROKE);
        this.linePaint.setStrokeWidth(AndroidUtilities.m1124dp(4.0f));
        ...
        BotButtons botButtons = new BotButtons(getContext(), resourcesProvider) { // from class: org.telegram.ui.bots.BotWebViewSheet.4
            ...
            @Override // org.telegram.p029ui.bots.BotButtons, android.widget.FrameLayout, android.view.View
        ...
        this.actionBarShadow = ContextCompat.getDrawable(getContext(), C2888R.drawable.header_shadow).mutate();
        ActionBar actionBar = new ActionBar(context, resourcesProvider) { // from class: org.telegram.ui.bots.BotWebViewSheet.5
            @Override // org.telegram.p029ui.ActionBar.ActionBar, android.widget.FrameLayout, android.view.View
            protected void onMeasure(int i2, int i3) {
    ...
    class C74393 implements BotWebViewContainer.Delegate {
        ...
        C74393(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        public void onSharedTo(ArrayList arrayList) {
            ...
            if (arrayList.size() == 1) {
                pluralString = LocaleController.formatString(C2888R.string.BotSharedToOne, MessagesController.getInstance(BotWebViewSheet.this.currentAccount).getPeerName(((Long) arrayList.get(0)).longValue()));
            } else {
            ...
            BotWebViewSheet.this.showBulletin(new Utilities.CallbackReturn() { // from class: org.telegram.ui.bots.BotWebViewSheet$3$$ExternalSyntheticLambda6
                @Override // org.telegram.messenger.Utilities.CallbackReturn
                public final Object run(Object obj) {
                    return ((BulletinFactory) obj).createSimpleBulletin(C2888R.raw.forward, AndroidUtilities.replaceTags(pluralString));
                }
            });
        }
        ...
        public void onLocationGranted(boolean z) {
            ...
            if (z) {
                ...
                undoObject.undoText = LocaleController.getString(C2888R.string.UndoNoCaps);
                ...
                BotWebViewSheet.this.showBulletin(new Utilities.CallbackReturn() { // from class: org.telegram.ui.bots.BotWebViewSheet$3$$ExternalSyntheticLambda12
                    ...
                    public final Object run(Object obj) {
                        ...
                        return ((BulletinFactory) obj).createUsersBulletin(Arrays.asList(user2), AndroidUtilities.replaceTags(LocaleController.formatString(C2888R.string.BotLocationPermissionRequestGranted, UserObject.getUserName(user2))), null, undoObject).setDuration(5000);
                    }
                });
                return;
            }
            final SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
            spannableStringBuilder.append((CharSequence) AndroidUtilities.replaceTags(LocaleController.formatString(C2888R.string.BotLocationPermissionRequestDeniedApp, UserObject.getUserName(user))));
            spannableStringBuilder.append((CharSequence) " ");
            spannableStringBuilder.append(AndroidUtilities.replaceArrows(AndroidUtilities.makeClickable(LocaleController.getString(C2888R.string.BotLocationPermissionRequestDeniedAppSettings), new Runnable() { // from class: org.telegram.ui.bots.BotWebViewSheet$3$$ExternalSyntheticLambda13
                @Override // java.lang.Runnable
                public final void run() {
            ...
            BotWebViewSheet.this.showBulletin(new Utilities.CallbackReturn() { // from class: org.telegram.ui.bots.BotWebViewSheet$3$$ExternalSyntheticLambda14
                @Override // org.telegram.messenger.Utilities.CallbackReturn
                public final Object run(Object obj) {
                    return ((BulletinFactory) obj).createSimpleBulletinDetail(C2888R.raw.error, spannableStringBuilder).setDuration(5000);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$onLocationGranted$4() {
            ...
            safeLastFragment.presentFragment(ProfileActivity.m1294of(BotWebViewSheet.this.botId));
        ...
        public void onEmojiStatusGranted(boolean z) {
            ...
            if (z) {
                ...
                BotWebViewSheet.this.showBulletin(new Utilities.CallbackReturn() { // from class: org.telegram.ui.bots.BotWebViewSheet$3$$ExternalSyntheticLambda1
                    ...
                    public final Object run(Object obj) {
                        TLRPC.User user2 = user;
                        return ((BulletinFactory) obj).createUsersBulletin(Arrays.asList(user2), AndroidUtilities.replaceTags(LocaleController.formatString(C2888R.string.BotEmojiStatusPermissionRequestGranted, UserObject.getUserName(user2))), null, undoObject).setDuration(5000);
                    }
                });
            }
        }
        ...
        public void onEmojiStatusSet(final TLRPC.Document document) {
            BotWebViewSheet.this.showBulletin(new Utilities.CallbackReturn() { // from class: org.telegram.ui.bots.BotWebViewSheet$3$$ExternalSyntheticLambda3
                @Override // org.telegram.messenger.Utilities.CallbackReturn
                public final Object run(Object obj) {
                    return ((BulletinFactory) obj).createEmojiBulletin(document, LocaleController.getString(C2888R.string.BotEmojiStatusUpdated));
                }
            });
        }
        ...
        public void onSetBackButtonVisible(boolean z) {
            ...
            AndroidUtilities.updateImageViewImageAnimated(backButton, z ? C2888R.drawable.ic_ab_back : C2888R.drawable.ic_close_white);
            if (BotWebViewSheet.this.fullscreenButtons != null) {
        ...
        public void onSetupMainButton(boolean z, boolean z2, String str, long j, int i, int i2, boolean z3, boolean z4) {
            BotWebViewSheet.this.botButtons.setMainState(BotButtons.ButtonState.m1337of(z, z2, z3, z4, str, j, i, i2), true);
        ...
        public void onSetupSecondaryButton(boolean z, boolean z2, String str, long j, int i, int i2, boolean z3, boolean z4, String str2) {
            BotWebViewSheet.this.botButtons.setSecondaryState(BotButtons.ButtonState.m1338of(z, z2, z3, z4, str, j, i, i2, str2), true);
            if (BotWebViewSheet.this.fullscreen) {
                BotWebViewSheet.this.updateFullscreenLayout();
                BotWebViewSheet.this.updateWindowFlags();
            }
    ...
    public /* synthetic */ void lambda$new$7(int i, boolean z) {
        if (i > AndroidUtilities.m1124dp(20.0f)) {
            ChatAttachAlertBotWebViewLayout.WebViewSwipeContainer webViewSwipeContainer = this.swipeContainer;
    ...
    public /* synthetic */ Boolean lambda$new$17(Void r2) {
        return Boolean.valueOf(this.windowView.getKeyboardHeight() >= AndroidUtilities.m1124dp(20.0f));
    }
    ...
    public /* synthetic */ WindowInsets lambda$onCreate$18(View view, WindowInsets windowInsets) {
        ...
        if (i2 > this.insets.bottom && i2 > AndroidUtilities.m1124dp(20.0f)) {
    ...
    public void updateFullscreenLayout() {
        ...
        if (this.fullscreen) {
            ...
            BotWebViewContainer botWebViewContainer = this.webViewContainer;
            Rect rect = this.insets;
            botWebViewContainer.reportSafeInsets(new Rect(rect.left, rect.top, rect.right, (this.keyboardInset <= i && ((botButtons = this.botButtons) == null || botButtons.getTotalHeight() <= 0)) ? this.insets.bottom : 0), AndroidUtilities.m1124dp(46.0f));
        ...
        this.swipeContainerLayoutParams.topMargin = AndroidUtilities.m1124dp(24.0f);
        ...
        if (!this.fullscreenInProgress) {
            ...
            if (this.fullscreen) {
                this.swipeContainer.setTopActionBarOffsetY(-AndroidUtilities.m1124dp(24.0f));
            } else {
                this.swipeContainer.setTopActionBarOffsetY((ActionBar.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight) - AndroidUtilities.m1124dp(24.0f));
            }
    ...
    public void requestWebView(BaseFragment baseFragment, WebViewRequestProps webViewRequestProps) {
        ...
        if ((user2 != null && user2.verified) || (userFull != null && (user = userFull.user) != null && user.verified)) {
            Drawable drawableMutate = getContext().getResources().getDrawable(C2888R.drawable.verified_profile).mutate();
            ...
            this.actionBar.getTitleTextView().setDrawablePadding(AndroidUtilities.m1124dp(2.0f));
            this.actionBar.getTitleTextView().setRightDrawable(new Drawable() { // from class: org.telegram.ui.bots.BotWebViewSheet.9
                ...
                public void draw(Canvas canvas) {
                    canvas.save();
                    canvas.translate(0.0f, AndroidUtilities.m1124dp(1.0f));
        ...
        if (this.onVerifiedAge == null) {
            actionBarMenuCreateMenu.addItem(C2888R.id.menu_collapse_bot, C2888R.drawable.arrow_more);
        }
        ...
        this.pinItem = this.optionsItem.addSubItem(C2888R.id.menu_pin, C2888R.drawable.msg_pin, LocaleController.getString(C2888R.string.PinMessage));
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.bots.BotWebViewSheet.10
            ...
            public void onItemClick(int i3) {
                if (i3 == -1) {
                    ...
                    BotWebViewSheet.this.onCheckDismissByUser();
                } else if (i3 == C2888R.id.menu_collapse_bot) {
        ...
        tL_inputBotAppID.f1727id = botApp.f1657id;
    ...
    public void openOptions() {
        ...
        if (botDownloads.hasFiles()) {
            ...
            itemOptionsMakeSwipeback.add(C2888R.drawable.msg_arrow_back, LocaleController.getString(C2888R.string.Back), new RatePill$$ExternalSyntheticLambda1(itemOptionsMakeOptions));
            ...
            itemOptionsMakeSwipeback.setMinWidth(AndroidUtilities.m1124dp(180.0f));
            itemOptionsMakeOptions.add(C2888R.drawable.menu_download_round, LocaleController.getString(C2888R.string.BotDownloads), new Runnable() { // from class: org.telegram.ui.bots.BotWebViewSheet$$ExternalSyntheticLambda34
                @Override // java.lang.Runnable
                public final void run() {
        ...
        ItemOptions itemOptionsAddIf = itemOptionsMakeOptions.addIf(this.onVerifiedAge == null, C2888R.drawable.msg_bot, LocaleController.getString(C2888R.string.BotWebViewOpenBot), new Runnable() { // from class: org.telegram.ui.bots.BotWebViewSheet$$ExternalSyntheticLambda35
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$openOptions$35();
            }
        }).addIf(this.onVerifiedAge == null && this.hasSettings, C2888R.drawable.msg_settings, LocaleController.getString(C2888R.string.BotWebViewSettings), new Runnable() { // from class: org.telegram.ui.bots.BotWebViewSheet$$ExternalSyntheticLambda36
            @Override // java.lang.Runnable
            public final void run() {
        ...
        itemOptionsAddIf.add(z ? C2888R.drawable.msg_unpin : C2888R.drawable.msg_pin, LocaleController.getString(z ? C2888R.string.UnpinMessage : C2888R.string.PinMessage), new Runnable() { // from class: org.telegram.ui.bots.BotWebViewSheet$$ExternalSyntheticLambda37
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$openOptions$37();
            }
        }).add(C2888R.drawable.msg_retry, LocaleController.getString(C2888R.string.BotWebViewReloadPage), new Runnable() { // from class: org.telegram.ui.bots.BotWebViewSheet$$ExternalSyntheticLambda38
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$openOptions$38();
            }
        }).addIf(this.onVerifiedAge == null && user != null && user.bot_has_main_app, C2888R.drawable.msg_home, LocaleController.getString(C2888R.string.AddShortcut), new Runnable() { // from class: org.telegram.ui.bots.BotWebViewSheet$$ExternalSyntheticLambda39
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$openOptions$39();
            }
        }).addIf(this.onVerifiedAge == null, C2888R.drawable.menu_intro, LocaleController.getString(C2888R.string.BotWebViewToS), new Runnable() { // from class: org.telegram.ui.bots.BotWebViewSheet$$ExternalSyntheticLambda40
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$openOptions$40();
            }
        }).addIf(this.onVerifiedAge == null && tL_attachMenuBot != null && (tL_attachMenuBot.show_in_side_menu || tL_attachMenuBot.show_in_attach_menu), C2888R.drawable.msg_delete, LocaleController.getString(C2888R.string.BotWebViewDeleteBot), new Runnable() { // from class: org.telegram.ui.bots.BotWebViewSheet$$ExternalSyntheticLambda41
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$openOptions$35() {
        ...
        if (activity instanceof LaunchActivity) {
            ((LaunchActivity) activity).lambda$runLinkRequest$106(ChatActivity.m1239of(this.botId));
        }
        dismiss(true);
    }
    ...
    public void showBulletin(Utilities.CallbackReturn callbackReturn) {
        ((Bulletin) callbackReturn.run(BulletinFactory.m1245of(this.bulletinContainer, this.resourcesProvider))).show(true);
    }
    ...
    public void updateDownloadBulletinArrow() {
        ...
        if (this.fullscreen) {
            downloadBulletin.setArrow(AndroidUtilities.lerp(AndroidUtilities.m1124dp(24.0f), AndroidUtilities.m1124dp(26.0f), this.fullscreenProgress));
        } else if (this.actionBarTransitionProgress > 0.5f) {
            downloadBulletin.setArrow(AndroidUtilities.m1124dp(24.0f));
        } else {
    ...
    private void updateDownloadBulletin() {
        ...
        for (Map.Entry entry : this.fileItems.entrySet()) {
            ...
            if (fileDownload.isDownloading()) {
                actionBarMenuSubItem.setRightIcon(C2888R.drawable.msg_close);
                actionBarMenuSubItem.subtextView.setPadding(0, 0, AndroidUtilities.m1124dp(32.0f), 0);
    ...
    public void show() {
        if (AndroidUtilities.isSafeToShow(getContext())) {
            ...
            this.windowView.addOnLayoutChangeListener(new ViewOnLayoutChangeListenerC743111());
            super.show();
            this.superDismissed = false;
    ...
    /* JADX INFO: loaded from: classes7.dex */
    class ViewOnLayoutChangeListenerC743111 implements View.OnLayoutChangeListener {
        ViewOnLayoutChangeListenerC743111() {
        }
    ...
    public void dismiss(boolean z, final Runnable runnable) {
        ...
        if (z) {
            ...
            Rect rect = this.insets;
            webViewSwipeContainer.stickTo(totalHeight + rect.top + rect.bottom + this.windowView.measureKeyboardHeight() + (isFullSize() ? AndroidUtilities.m1124dp(200.0f) : 0), true, new Runnable() { // from class: org.telegram.ui.bots.BotWebViewSheet$$ExternalSyntheticLambda12
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void setFullscreen(final boolean z, boolean z2, boolean z3) {
        ...
        if (z2) {
            ...
            final float f2 = fMin;
            final float translationY = z ? this.swipeContainer.getTranslationY() : -AndroidUtilities.m1124dp(24.0f);
            final float currentActionBarHeight = z ? -AndroidUtilities.m1124dp(24.0f) : (ActionBar.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight) - AndroidUtilities.m1124dp(24.0f);
            ...
            if (z) {
                ...
                this.swipeContainer.setTopActionBarOffsetY(currentActionBarHeight2 - AndroidUtilities.m1124dp(24.0f));
            }
            this.swipeContainer.invalidateTranslation();
            this.swipeContainer.invalidate();
            ...
            this.fullscreenAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.bots.BotWebViewSheet.15
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    if (!z) {
                        BotWebViewSheet.this.updateFullscreenLayout();
                        BotWebViewSheet.this.updateWindowFlags();
                        BotWebViewSheet.this.swipeContainer.setForceOffsetY(currentActionBarHeight2 - AndroidUtilities.m1124dp(24.0f));
                        BotWebViewSheet.this.swipeContainer.setTopActionBarOffsetY(currentActionBarHeight2 - AndroidUtilities.m1124dp(24.0f));
                        BotWebViewSheet.this.swipeContainer.setSwipeOffsetY(0.0f);
                    } else {
                        BotWebViewSheet.this.swipeContainer.setForceOffsetY(-AndroidUtilities.m1124dp(24.0f));
                        BotWebViewSheet.this.swipeContainer.setTopActionBarOffsetY(-AndroidUtilities.m1124dp(24.0f));
                        BotWebViewSheet.this.swipeContainer.setSwipeOffsetY(0.0f);
                    }
                    BotWebViewSheet botWebViewSheet = BotWebViewSheet.this;
                    botWebViewSheet.fullscreenProgress = z ? botWebViewSheet.fullscreenTransitionProgress : 1.0f - botWebViewSheet.fullscreenTransitionProgress;
    ...
    public class WindowView extends SizeNotifierFrameLayout implements BottomSheetTabsOverlay.SheetView {
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.save();
            float f2 = 1.0f - f;
            float fLerp = AndroidUtilities.isTablet() ? AndroidUtilities.lerp(BotWebViewSheet.this.swipeContainer.getTranslationY() + AndroidUtilities.m1124dp(12.0f), AndroidUtilities.statusBarHeight / 2.0f, BotWebViewSheet.this.actionBarTransitionProgress) : AndroidUtilities.lerp(BotWebViewSheet.this.swipeContainer.getTranslationY(), AndroidUtilities.statusBarHeight + (ActionBar.getCurrentActionBarHeight() / 2.0f), f) + AndroidUtilities.m1124dp(12.0f);
            canvas.scale(f2, f2, getWidth() / 2.0f, fLerp);
            canvas.drawLine((getWidth() / 2.0f) - AndroidUtilities.m1124dp(16.0f), fLerp, (getWidth() / 2.0f) + AndroidUtilities.m1124dp(16.0f), fLerp, BotWebViewSheet.this.linePaint);
            canvas.restore();
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            if (motionEvent.getAction() == 0 && (motionEvent.getY() <= AndroidUtilities.lerp(BotWebViewSheet.this.swipeContainer.getTranslationY() + AndroidUtilities.m1124dp(24.0f), 0.0f, BotWebViewSheet.this.actionBarTransitionProgress) || motionEvent.getX() > BotWebViewSheet.this.swipeContainer.getRight() || motionEvent.getX() < BotWebViewSheet.this.swipeContainer.getLeft())) {
                BotWebViewSheet.this.dismiss(true, null);
                return true;
            }
        ...
        public RectF getRect() {
            this.rect.set(BotWebViewSheet.this.swipeContainer.getLeft(), BotWebViewSheet.this.swipeContainer.getTranslationY() + AndroidUtilities.m1124dp(24.0f), BotWebViewSheet.this.swipeContainer.getRight(), getHeight());
            return this.rect;
        }
        ...
        public float drawInto(Canvas canvas, RectF rectF, float f, RectF rectF2, float f2, boolean z) {
            ...
            float fLerp = AndroidUtilities.lerp(AndroidUtilities.m1124dp(16.0f) * (AndroidUtilities.isTablet() ? 1.0f : 1.0f - BotWebViewSheet.this.actionBarTransitionProgress), AndroidUtilities.m1124dp(10.0f), f);
            ...
            if (BotWebViewSheet.this.swipeContainer != null) {
                canvas.save();
                canvas.translate(rectF2.left, Math.max(BotWebViewSheet.this.swipeContainer.getY(), rectF2.top) + (f * AndroidUtilities.m1124dp(51.0f)));
