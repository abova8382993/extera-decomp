...
public class BotSensors {
    ...
    private final SensorEventListener accelerometerListener = new C74181();
    private final SensorEventListener gyroscopeListener = new C74192();
    private final SensorEventListener absoluteOrientationListener = new C74203();
    private final SensorEventListener relativeOrientationListener = new C74214();
    ...
    class C74181 implements SensorEventListener {
    ...
    class C74192 implements SensorEventListener {
    ...
    class C74203 implements SensorEventListener {
    ...
    class C74214 implements SensorEventListener {
        private long lastTime;
