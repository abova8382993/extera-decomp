...
public class BottomSheetTabs extends FrameLayout {
    ...
    public void openTab(final WebTabData webTabData) {
        ...
        if (webTabData.needsContext) {
            ...
            final ChatActivity chatActivityM1239of = ChatActivity.m1239of(webTabData.props.botId);
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ActionBar.BottomSheetTabs$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    this.f$0.lambda$openTab$1(lastFragment, chatActivityM1239of);
                }
            }, 220L);
        }
    }
    ...
    public WebTabData tryReopenTab(TLRPC.WebPage webPage) {
        ...
        for (int i = 0; i < tabs2.size(); i++) {
            ...
            if (articleViewer != null && !articleViewer.pagesStack.isEmpty()) {
                ...
                if ((obj instanceof TLRPC.WebPage) && ((TLRPC.WebPage) obj).f1834id == webPage.f1834id) {
                    openTab(webTabData);
                    return webTabData;
                }
            }
    ...
    private void updateMultipleTitle() {
        ...
        if (tabs2.isEmpty()) {
            ...
            setContentDescription(LocaleController.formatString(C2888R.string.AccDescrTabs, _UrlKt.FRAGMENT_ENCODE_SET));
            return;
        }
        setImportantForAccessibility(1);
        int i2 = C2888R.string.AccDescrTabs;
    ...
    public void removeTab(final WebTabData webTabData, final Utilities.Callback callback) {
        ...
        }).setNegativeButton(LocaleController.getString(C2888R.string.Cancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ActionBar.BottomSheetTabs$$ExternalSyntheticLambda5
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
        ...
        alertDialogCreate.setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: org.telegram.ui.ActionBar.BottomSheetTabs$$ExternalSyntheticLambda6
            ...
            public final void onDismiss(DialogInterface dialogInterface) {
                BottomSheetTabs.m5603$r8$lambda$wYmzJHTOpTZmii2flzYplpdWs(zArr, callback, dialogInterface);
            }
        });
    ...
    /* JADX INFO: renamed from: $r8$lambda$wY--mzJHTOpTZmii2flzYplpdWs, reason: not valid java name */
    public static /* synthetic */ void m5603$r8$lambda$wYmzJHTOpTZmii2flzYplpdWs(boolean[] zArr, Utilities.Callback callback, DialogInterface dialogInterface) {
        if (zArr[0]) {
            return;
        }
        callback.run(Boolean.FALSE);
        ...
        if (this.drawTabs) {
            for (int i2 = 0; i2 < tabDrawables2.size(); i2++) {
                ...
                if (alpha > 0.0f && position <= 1.99f) {
                    ...
                    tabDrawable.draw(canvas, this.rect, AndroidUtilities.m1124dp(10.0f), alpha, 1.0f);
                }
            }
        }
    }
    ...
    public void getTabBounds(RectF rectF, float f) {
        rectF.set(AndroidUtilities.m1124dp(4.0f), (getHeight() - AndroidUtilities.m1124dp(4.0f)) - AndroidUtilities.m1124dp(50.0f), getWidth() - AndroidUtilities.m1124dp(4.0f), getHeight() - AndroidUtilities.m1124dp(4.0f));
        rectF.offset(0.0f, (-AndroidUtilities.m1124dp(8.0f)) * f);
    ...
    public static class TabDrawable {
        ...
        public TabDrawable(View view, WebTabData webTabData) {
            ...
            if (webTabData.isArticle()) {
                this.iconDrawable = view.getContext().getResources().getDrawable(C2888R.drawable.msg_instant).mutate();
            }
            this.progress = webTabData.articleProgress;
            path.rewind();
            path.moveTo(0.0f, 0.0f);
            path.lineTo(AndroidUtilities.m1124dp(12.0f), AndroidUtilities.m1124dp(12.0f));
            path.moveTo(AndroidUtilities.m1124dp(12.0f), 0.0f);
            path.lineTo(0.0f, AndroidUtilities.m1124dp(12.0f));
            path2.rewind();
            path2.moveTo(0.0f, AndroidUtilities.m1124dp(6.33f) / 2.0f);
            path2.lineTo(AndroidUtilities.m1124dp(12.66f) / 2.0f, (-AndroidUtilities.m1124dp(6.33f)) / 2.0f);
            path2.lineTo(AndroidUtilities.m1124dp(12.66f), AndroidUtilities.m1124dp(6.33f) / 2.0f);
        }
        ...
        public void draw(Canvas canvas, RectF rectF, float f, float f2, float f3) {
            ...
            this.backgroundPaint.setShadowLayer(AndroidUtilities.m1124dp(2.33f), 0.0f, AndroidUtilities.m1124dp(1.0f), Theme.multAlpha(268435456, f2));
            ...
            this.iconPaint.setStrokeWidth(AndroidUtilities.m1124dp(2.0f));
            canvas2.save();
            canvas2.translate(rectF.left, rectF.centerY());
            int iBlendARGB3 = ColorUtils.blendARGB(553648127, 553648127, fLerp2);
            this.closeRipple.setBounds(AndroidUtilities.m1124dp(25.0f) + (-AndroidUtilities.m1124dp(25.0f)), -AndroidUtilities.m1124dp(25.0f), AndroidUtilities.m1124dp(25.0f) + AndroidUtilities.m1124dp(25.0f), AndroidUtilities.m1124dp(25.0f));
            ...
            canvas2.restore();
            canvas2.save();
            canvas2.translate(rectF.left + AndroidUtilities.m1124dp(18.0f), rectF.centerY() - AndroidUtilities.m1124dp(6.0f));
            float f6 = f4 * f3;
            int i = (int) f6;
            ...
            canvas2.restore();
            canvas2.save();
            canvas2.translate(rectF.right - AndroidUtilities.m1124dp(30.66f), rectF.centerY());
            ...
            if (this.favicon != null) {
                ...
                float f7 = iM1124dp2;
                float f8 = f7 / 2.0f;
                rect.set((int) (rectF.left + AndroidUtilities.m1124dp(56.0f)), (int) (rectF.centerY() - f8), (int) (rectF.left + AndroidUtilities.m1124dp(56.0f) + f7), (int) (rectF.centerY() + f8));
                ...
                int intrinsicHeight = (int) ((fM1124dp / this.iconDrawable.getIntrinsicHeight()) * this.iconDrawable.getIntrinsicWidth());
                Rect rect2 = AndroidUtilities.rectTmp2;
                float f9 = (fM1124dp / 2.0f) * 0.7f;
                rect2.set((int) (rectF.left + AndroidUtilities.m1124dp(56.0f)), (int) (rectF.centerY() - f9), (int) (rectF.left + AndroidUtilities.m1124dp(56.0f) + (intrinsicHeight * 0.7f)), (int) (rectF.centerY() + f9));
                ...
                iM1124dp = intrinsicHeight - AndroidUtilities.m1124dp(2.0f);
            }
            Text text = this.overrideTitle;
            if (text != null) {
                text.ellipsize((int) ((rectF.width() - AndroidUtilities.m1124dp(100.0f)) - r4)).draw(canvas2, rectF.left + AndroidUtilities.m1124dp(60.0f) + iM1124dp, rectF.centerY(), iBlendARGB2, (1.0f - this.expandProgress) * f2 * f3);
            }
            this.title.ellipsize((int) ((rectF.width() - AndroidUtilities.m1124dp(100.0f)) - r3)).draw(canvas, iM1124dp + rectF.left + AndroidUtilities.m1124dp(60.0f), rectF.centerY(), iBlendARGB2, (this.overrideTitle != null ? this.expandProgress : 1.0f) * f2 * f3);
        }
    }
        ...
        public String getTitle() {
            if (this.isWeb || this.articleViewer != null) {
                if (TextUtils.isEmpty(this.title)) {
                    return LocaleController.getString(C2888R.string.WebEmpty);
                }
                return this.title;
            }
    ...
    public static class ClipTools {
        ...
        public void clip(Canvas canvas, boolean z, boolean z2, int i, int i2, float f) {
            ...
            int iMin = Math.min(1, height / AndroidUtilities.m1124dp(60.0f)) * AndroidUtilities.m1124dp(10.0f);
            if (height <= 0) {
                return;
            }
            ...
            if (z) {
                this.clipShadowPaint.setShadowLayer(AndroidUtilities.m1124dp(2.0f), 0.0f, AndroidUtilities.m1124dp(1.0f), 268435456);
