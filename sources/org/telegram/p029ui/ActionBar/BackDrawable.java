...
public class BackDrawable extends Drawable {
    ...
    public BackDrawable(boolean z) {
        ...
        this.prevPaint.setStrokeWidth(AndroidUtilities.m1124dp(2.0f));
    ...
    public void draw(Canvas canvas) {
        ...
        float f5 = 1.0f - f;
        canvas.drawLine(AndroidUtilities.m1124dp(AndroidUtilities.lerp(-6.75f, -8.0f, f)), 0.0f, AndroidUtilities.m1124dp(8.0f) - ((this.paint.getStrokeWidth() / 2.0f) * f5), 0.0f, this.paint);
        float fM1124dp = AndroidUtilities.m1124dp(-0.25f);
        float fM1124dp2 = AndroidUtilities.m1124dp(AndroidUtilities.lerp(7.0f, 8.0f, f)) - ((this.paint.getStrokeWidth() / 4.0f) * f5);
        float fM1124dp3 = AndroidUtilities.m1124dp(AndroidUtilities.lerp(-7.25f, 0.0f, f));
        canvas.drawLine(fM1124dp3, -fM1124dp, 0.0f, -fM1124dp2, this.paint);
        canvas.drawLine(fM1124dp3, fM1124dp, 0.0f, fM1124dp2, this.paint);
        canvas.restore();
    }
