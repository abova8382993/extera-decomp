...
public class ActionBarMenuSubItem extends FrameLayout {
    ...
    public void makeCheckView(int i) {
        if (i > 0) {
            ...
            if (i == 1) {
                ...
                this.textView.setPadding(!LocaleController.isRTL ? AndroidUtilities.m1124dp(34.0f) : 0, 0, !LocaleController.isRTL ? 0 : AndroidUtilities.m1124dp(34.0f), 0);
                return;
            }
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(this.itemHeight), TLObject.FLAG_30));
        if (!this.expandIfMultiline || this.textView.getLayout().getLineCount() <= 1) {
            return;
        }
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(this.itemHeight + 8), TLObject.FLAG_30));
    }
    ...
    public void setRightIcon(int i) {
        ...
        if (LocaleController.isRTL) {
            layoutParams.leftMargin = this.rightIcon != null ? AndroidUtilities.m1124dp(32.0f) : 0;
        } else {
            layoutParams.rightMargin = this.rightIcon != null ? AndroidUtilities.m1124dp(32.0f) : 0;
        }
        this.textView.setLayoutParams(layoutParams);
        setPadding(AndroidUtilities.m1124dp(LocaleController.isRTL ? 8.0f : 18.0f), 0, AndroidUtilities.m1124dp(LocaleController.isRTL ? 18.0f : 8.0f), 0);
        if (i == 0) {
    ...
    public void setTextAndIcon(CharSequence charSequence, int i, Drawable drawable) {
        ...
        if (i != 0 || drawable != null || this.checkView != null) {
            ...
            if (this.checkViewLeft) {
                iM1124dp = this.checkView != null ? AndroidUtilities.m1124dp(43.0f) : 0;
            } else {
                iM1124dp = AndroidUtilities.m1124dp((i == 0 && drawable == null) ? 0.0f : 43.0f);
            }
            if (this.checkViewLeft) {
                iM1124dp2 = AndroidUtilities.m1124dp((i == 0 && drawable == null) ? 0.0f : 43.0f);
            } else {
                iM1124dp2 = this.checkView != null ? AndroidUtilities.m1124dp(43.0f) : 0;
            }
            textViewEmojis.setPadding(iM1124dp, 0, iM1124dp2, 0);
        } else {
            this.iconResId = 0;
    ...
    public void setTextAndIcon(CharSequence charSequence, ImageLocation imageLocation, String str, Drawable drawable, Object obj) {
        this.textView.setText(charSequence);
        this.textView.setPadding((this.checkViewLeft && this.checkView == null) ? 0 : AndroidUtilities.m1124dp(43.0f), 0, (!this.checkViewLeft && this.checkView == null) ? 0 : AndroidUtilities.m1124dp(43.0f), 0);
        if (this.backupImageView == null) {
            BackupImageView backupImageView = new BackupImageView(getContext());
            this.backupImageView = backupImageView;
            backupImageView.setRoundRadius(AndroidUtilities.m1124dp(5.0f));
    ...
    public void setSubtext(CharSequence charSequence) {
        ...
        if ((!zIsEmpty) != (this.subtextView.getVisibility() == 0)) {
            ...
            FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.textView.getLayoutParams();
            layoutParams.bottomMargin = zIsEmpty ? 0 : AndroidUtilities.m1124dp(10.0f);
            this.textView.setLayoutParams(layoutParams);
        }
