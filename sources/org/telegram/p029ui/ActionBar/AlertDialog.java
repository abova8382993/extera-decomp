...
public class AlertDialog extends Dialog implements Drawable.Callback, NotificationCenter.NotificationCenterDelegate {
    ...
    public static class AlertDialogCell extends FrameLayout {
        ...
        public AlertDialogCell(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            setPadding(AndroidUtilities.m1124dp(23.0f), 0, AndroidUtilities.m1124dp(23.0f), 0);
        ...
        public void setTextAndIcon(CharSequence charSequence, int i) {
            ...
            if (i != 0) {
                ...
                this.textView.setPadding(LocaleController.isRTL ? 0 : AndroidUtilities.m1124dp(46.0f), 0, LocaleController.isRTL ? AndroidUtilities.m1124dp(46.0f) : 0, 0);
            } else {
    ...
    public AlertDialog(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (i != 3 || this.blurredBackground) {
            Drawable drawableMutate = context.getResources().getDrawable(C2888R.drawable.popup_fixed_alert4).mutate();
    ...
    public class AlertDialogView extends LinearLayout {
        ...
        */
        ...
        public /* synthetic */ void lambda$onMeasure$0() {
            ...
            int iM1124dp2 = AndroidUtilities.displaySize.x - AndroidUtilities.m1124dp(56.0f);
            if (AndroidUtilities.isTablet()) {
                if (AndroidUtilities.isSmallTablet()) {
                    iM1124dp = AndroidUtilities.m1124dp(446.0f);
                } else {
                    iM1124dp = AndroidUtilities.m1124dp(496.0f);
                }
            } else {
                iM1124dp = AndroidUtilities.m1124dp(356.0f);
            }
            Window window = AlertDialog.this.getWindow();
            WindowManager.LayoutParams layoutParams = new WindowManager.LayoutParams();
            layoutParams.copyFrom(window.getAttributes());
            layoutParams.width = Math.min(iM1124dp, iM1124dp2) + AlertDialog.this.backgroundPaddings.left + AlertDialog.this.backgroundPaddings.right;
            try {
        ...
        public void draw(Canvas canvas) {
            ...
            if (AlertDialog.this.blurredBackground && !AlertDialog.this.blurredNativeBackground) {
                if (AlertDialog.this.progressViewStyle == 3 && AlertDialog.this.progressViewContainer != null) {
                    fM1124dp = AndroidUtilities.m1124dp(18.0f);
                ...
                if (AlertDialog.this.blurPaint != null) {
                    ...
                    canvas.drawRoundRect(AndroidUtilities.rectTmp, fM1124dp, fM1124dp, AlertDialog.this.blurPaint);
                }
                ...
                canvas.drawRoundRect(rectF, fM1124dp, fM1124dp, AlertDialog.this.dimBlurPaint);
    ...
    protected View inflateContent(boolean z) {
        ...
        if ((this.blurredBackground || this.progressViewStyle == 3) && this.progressViewStyle != 2) {
            ...
            this.containerView.setOutlineProvider(ViewOutlineProviderImpl.boundsWithPaddingRoundRect(AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(20.0f)));
        ...
        if (this.topResId != 0 || this.topAnimationId != 0 || this.topDrawable != null) {
            ...
            if (drawable != null) {
                ...
                if (obj instanceof AttachableDrawable) {
                    ...
                    this.topImageView.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: org.telegram.ui.ActionBar.AlertDialog.1
                        ...
                        ViewOnAttachStateChangeListenerC30401(AttachableDrawable attachableDrawable2) {
            ...
            if (this.topAnimationIsNew) {
                ...
                gradientDrawable.setCornerRadius(AndroidUtilities.m1124dp(128.0f));
                this.topImageView.setBackground(new Drawable() { // from class: org.telegram.ui.ActionBar.AlertDialog.2
                    ...
                    C30412(GradientDrawable gradientDrawable2) {
                        gradientDrawable = gradientDrawable2;
                        this.size = AlertDialog.this.topAnimationSize + AndroidUtilities.m1124dp(52.0f);
                    }
                ...
                this.topImageView.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1124dp(10.0f), 0, this.topBackgroundColor));
            }
            if (this.topAnimationIsNew) {
                this.topImageView.setTranslationY(AndroidUtilities.m1124dp(16.0f));
            } else {
        ...
        if (this.progressViewStyle == 0) {
            this.shadow[0] = (BitmapDrawable) getContext().getResources().getDrawable(C2888R.drawable.header_shadow).mutate();
            this.shadow[1] = (BitmapDrawable) getContext().getResources().getDrawable(C2888R.drawable.header_shadow_reverse).mutate();
            this.shadow[0].setAlpha(0);
            this.shadow[1].setAlpha(0);
            this.shadow[0].setCallback(this);
            this.shadow[1].setCallback(this);
            C30423 c30423 = new ScrollView(getContext()) { // from class: org.telegram.ui.ActionBar.AlertDialog.3
                C30423(Context context) {
                    super(context);
                }
            ...
            this.contentScrollView = c30423;
            c30423.setVerticalScrollBarEnabled(false);
        ...
        if (i4 == 2) {
            ...
            if (!this.blurredBackground || this.blurredNativeBackground) {
                this.progressViewContainer.setBackgroundDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m1124dp(f3), this.backgroundColor));
            }
            c = 2;
            ...
            radialProgressView.setSize(AndroidUtilities.m1124dp(32.0f));
        ...
        if (z2) {
            if (this.verticalButtons) {
                ...
                if (charSequence2 != null) {
                    f5 = 64.0f;
                    iMeasureText = (int) (0 + textPaint.measureText(charSequence2, 0, charSequence2.length()) + AndroidUtilities.m1124dp(24.0f));
                } else {
                    f5 = 64.0f;
                    iMeasureText = 0;
                }
                if (this.negativeButtonText != null) {
                    if (iMeasureText > 0) {
                        iMeasureText += AndroidUtilities.m1124dp(f);
                    }
                    CharSequence charSequence3 = this.negativeButtonText;
                    iMeasureText = (int) (iMeasureText + textPaint.measureText(charSequence3, 0, charSequence3.length()) + AndroidUtilities.m1124dp(24.0f));
                }
                if (this.negative2ButtonText != null) {
                    ...
                    iMeasureText = (int) (iMeasureText + textPaint.measureText(charSequence4, 0, charSequence4.length()) + AndroidUtilities.m1124dp(24.0f));
                }
                if (this.neutralButtonText != null) {
                    ...
                    iMeasureText = (int) (iMeasureText + textPaint.measureText(charSequence5, 0, charSequence5.length()) + AndroidUtilities.m1124dp(24.0f));
                }
                if (iMeasureText > AndroidUtilities.displaySize.x - AndroidUtilities.m1124dp(f5)) {
                            ...
                            if (num != null) {
                                if (num.intValue() == -1) {
                                    ...
                                    if (LocaleController.isRTL) {
                                        ...
                                        if (view6 != null) {
                                            paddingLeft += view6.getMeasuredWidth() + AndroidUtilities.m1124dp(8.0f);
                                        }
                                        childAt.layout(paddingLeft, getPaddingTop(), childAt.getMeasuredWidth() + paddingLeft, getPaddingTop() + childAt.getMeasuredHeight());
                                    } else {
                                        int paddingRight = (i10 - getPaddingRight()) - childAt.getMeasuredWidth();
                                        if (view6 != null) {
                                            paddingRight -= view6.getMeasuredWidth() + AndroidUtilities.m1124dp(8.0f);
                                        }
            ...
            if (this.bottomView != null) {
                f6 = 6.0f;
                this.buttonsLayout.setPadding(AndroidUtilities.m1124dp(16.0f), 0, AndroidUtilities.m1124dp(16.0f), AndroidUtilities.m1124dp(4.0f));
                this.buttonsLayout.setTranslationY(-AndroidUtilities.m1124dp(6.0f));
            } else {
                f6 = 6.0f;
                this.buttonsLayout.setPadding(AndroidUtilities.m1124dp(f), AndroidUtilities.m1124dp(f), AndroidUtilities.m1124dp(f), AndroidUtilities.m1124dp(f));
            }
            this.containerView.addView(this.buttonsLayout, LayoutHelper.createLinear(-1, 52));
            if (this.topAnimationIsNew) {
                this.buttonsLayout.setTranslationY(-AndroidUtilities.m1124dp(f));
            }
            if (this.positiveButtonText != null) {
                final C30445 c30445 = new TextViewWithLoading(getContext()) { // from class: org.telegram.ui.ActionBar.AlertDialog.5
                    C30445(Context context) {
                        super(context);
                    }
                    ...
                    @Override // org.telegram.p029ui.ActionBar.TextViewWithLoading, android.widget.TextView
                    public void setTextColor(int i6) {
                        super.setTextColor(i6);
                        setBackground(Theme.getRoundRectSelectorDrawable(AndroidUtilities.m1124dp(20.0f), i6));
                    }
                };
                c30445.setMinWidth(AndroidUtilities.m1124dp(f5));
                c30445.setTag(-1);
                c30445.setTextSize(1, 16.0f);
                c30445.setTextColor(getThemedColor(this.dialogButtonColorKey));
                c30445.setGravity(17);
                c30445.setTypeface(AndroidUtilities.bold());
                c30445.setText(this.positiveButtonText);
                c30445.setBackground(Theme.getRoundRectSelectorDrawable(AndroidUtilities.m1124dp(f2), getThemedColor(this.dialogButtonColorKey)));
                c30445.setPadding(AndroidUtilities.m1124dp(f4), 0, AndroidUtilities.m1124dp(f4), 0);
                if (this.verticalButtons) {
                    this.buttonsLayout.addView(c30445, LayoutHelper.createLinear(-1, 40, 7));
                } else {
                    this.buttonsLayout.addView(c30445, LayoutHelper.createFrame(-2, 40, 53));
                }
                c30445.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda4
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view6) {
                        this.f$0.lambda$inflateContent$4(c30445, view6);
                    }
                });
            }
            if (this.negativeButtonText != null) {
                final C30456 c30456 = new TextViewWithLoading(getContext()) { // from class: org.telegram.ui.ActionBar.AlertDialog.6
                    C30456(Context context) {
                        super(context);
                    }
                ...
                c30456.setMinWidth(AndroidUtilities.m1124dp(f5));
                c30456.setTag(-2);
                c30456.setTextSize(1, 16.0f);
                c30456.setTextColor(getThemedColor(this.dialogButtonColorKey));
                c30456.setGravity(17);
                c30456.setTypeface(AndroidUtilities.bold());
                c30456.setEllipsize(TextUtils.TruncateAt.END);
                c30456.setSingleLine(true);
                c30456.setText(this.negativeButtonText.toString());
                c30456.setBackground(Theme.getRoundRectSelectorDrawable(AndroidUtilities.m1124dp(f2), getThemedColor(this.dialogButtonColorKey)));
                c30456.setPadding(AndroidUtilities.m1124dp(f4), 0, AndroidUtilities.m1124dp(f4), 0);
                if (this.verticalButtons) {
                    this.buttonsLayout.addView(c30456, 0, LayoutHelper.createLinear(-1, 40, 7));
                } else {
                    this.buttonsLayout.addView(c30456, LayoutHelper.createFrame(-2, 40, 53));
                }
                c30456.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda5
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view6) {
                        this.f$0.lambda$inflateContent$5(c30456, view6);
                    }
                });
            }
            if (this.neutralButtonText != null) {
                final C30467 c30467 = new TextViewWithLoading(getContext()) { // from class: org.telegram.ui.ActionBar.AlertDialog.7
                    C30467(Context context) {
                        super(context);
                    }
                ...
                c30467.setMinWidth(AndroidUtilities.m1124dp(f5));
                c30467.setTag(-3);
                c30467.setTextSize(1, 16.0f);
                c30467.setTextColor(getThemedColor(this.dialogButtonColorKey));
                c30467.setGravity(17);
                c30467.setTypeface(AndroidUtilities.bold());
                c30467.setEllipsize(TextUtils.TruncateAt.END);
                c30467.setSingleLine(true);
                c30467.setText(this.neutralButtonText.toString());
                c30467.setBackground(Theme.getRoundRectSelectorDrawable(AndroidUtilities.m1124dp(f2), getThemedColor(this.dialogButtonColorKey)));
                c30467.setPadding(AndroidUtilities.m1124dp(f4), 0, AndroidUtilities.m1124dp(f4), 0);
                if (this.verticalButtons) {
                    this.buttonsLayout.addView(c30467, 1, LayoutHelper.createLinear(-1, 40, 7));
                } else {
                    this.buttonsLayout.addView(c30467, LayoutHelper.createFrame(-2, 40, 51));
                }
                c30467.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda6
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view6) {
                        this.f$0.lambda$inflateContent$6(c30467, view6);
                    }
                });
            }
            if (this.negative2ButtonText != null) {
                final C30478 c30478 = new TextViewWithLoading(getContext()) { // from class: org.telegram.ui.ActionBar.AlertDialog.8
                    C30478(Context context) {
                        super(context);
                    }
                    ...
                    public void setTextColor(int i6) {
                        super.setTextColor(i6);
                        setBackgroundDrawable(Theme.getRoundRectSelectorDrawable(AndroidUtilities.m1124dp(6.0f), i6));
                    }
                };
                c30478.setMinWidth(AndroidUtilities.m1124dp(f5));
                c30478.setTag(-4);
                c30478.setTextSize(1, 16.0f);
                c30478.setTextColor(getThemedColor(this.dialogButtonColorKey));
                c30478.setGravity(17);
                c30478.setTypeface(AndroidUtilities.bold());
                c30478.setEllipsize(TextUtils.TruncateAt.END);
                c30478.setSingleLine(true);
                c30478.setText(this.negative2ButtonText.toString());
                c30478.setBackground(Theme.getRoundRectSelectorDrawable(AndroidUtilities.m1124dp(f6), getThemedColor(this.dialogButtonColorKey)));
                c30478.setPadding(AndroidUtilities.m1124dp(f4), 0, AndroidUtilities.m1124dp(f4), 0);
                if (this.verticalButtons) {
                    this.buttonsLayout.addView(c30478, 0, LayoutHelper.createLinear(-1, 36, 7));
                } else {
                    this.buttonsLayout.addView(c30478, LayoutHelper.createFrame(-2, 36, 53));
                }
                c30478.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda7
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view6) {
                        this.f$0.lambda$inflateContent$7(c30478, view6);
                    }
                });
            }
            if (this.verticalButtons) {
                for (int i6 = 1; i6 < this.buttonsLayout.getChildCount(); i6++) {
                    ((ViewGroup.MarginLayoutParams) this.buttonsLayout.getChildAt(i6).getLayoutParams()).topMargin = AndroidUtilities.m1124dp(f6);
                }
            }
        } else {
            f4 = 12.0f;
        ...
        if (this.needStarsBalance) {
            ...
            int iM1124dp2 = (i7 - AndroidUtilities.m1124dp(48.0f)) - (this.additioanalHorizontalPadding * 2);
            if (AndroidUtilities.isTablet()) {
                if (AndroidUtilities.isSmallTablet()) {
                    iM1124dp = AndroidUtilities.m1124dp(446.0f);
                } else {
            ...
            int iMin = Math.min(iM1124dp, iM1124dp2);
        ...
        if (this.blurredBackground) {
            if (supportsNativeBlur()) {
                if (this.progressViewStyle == 0) {
                    ...
                    float fM1124dp = AndroidUtilities.m1124dp(f4);
    ...
    class ViewOnAttachStateChangeListenerC30401 implements View.OnAttachStateChangeListener {
        final /* synthetic */ AttachableDrawable val$d;
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C30423 extends ScrollView {
        C30423(Context context) {
            super(context);
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C30434 extends FrameLayout {
        C30434(Context context) {
            super(context);
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C30445 extends TextViewWithLoading {
        C30445(Context context) {
            super(context);
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C30456 extends TextViewWithLoading {
        C30456(Context context) {
            super(context);
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C30467 extends TextViewWithLoading {
        C30467(Context context) {
            super(context);
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C30478 extends TextViewWithLoading {
        C30478(Context context) {
            super(context);
        }
    ...
    public Browser.Progress makeButtonLoading(int i, final boolean z, boolean z2) {
        ...
        return new Browser.Progress(new Runnable() { // from class: org.telegram.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda12
            @Override // java.lang.Runnable
            public final void run() {
                AlertDialog.m5438$r8$lambda$B4fp4rFk_mbEvWTBZXG5SwPoB0(button);
            }
    ...
    public static /* synthetic */ void m5438$r8$lambda$B4fp4rFk_mbEvWTBZXG5SwPoB0(View view) {
    ...
    public void setMessageLineSpacing(float f) {
        TextView textView = this.messageTextView;
        if (textView != null) {
            textView.setLineSpacing(AndroidUtilities.m1124dp(f), 1.0f);
        }
    }
    ...
    public void showCancelAlert() {
        if (this.canCacnel && this.cancelDialog == null) {
            ...
            builder.setNegativeButton(LocaleController.getString(C2888R.string.Stop), new OnButtonClickListener() { // from class: org.telegram.ui.ActionBar.AlertDialog$$ExternalSyntheticLambda10
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C30489 extends AnimatorListenerAdapter {
        final /* synthetic */ int val$num;
