...
import org.telegram.p029ui.Components.FloatSeekBarAccessibilityDelegate;
...
public abstract class ActionBarMenuSlider extends FrameLayout {
    ...
    public ActionBarMenuSlider(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        C30211 c30211 = new AnimatedTextView.AnimatedTextDrawable(false, true, true) { // from class: org.telegram.ui.ActionBar.ActionBarMenuSlider.1
            C30211(boolean z, boolean z2, boolean z3) {
                super(z, z2, z3);
            }
        ...
        this.leftTextDrawable = c30211;
        c30211.setCallback(this);
        ...
        C30222 c30222 = new AnimatedTextView.AnimatedTextDrawable(false, true, true) { // from class: org.telegram.ui.ActionBar.ActionBarMenuSlider.2
            C30222(boolean z, boolean z2, boolean z3) {
                super(z, z2, z3);
            }
        ...
        this.rightTextDrawable = c30222;
        c30222.setCallback(this);
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.ActionBarMenuSlider$1 */
    class C30211 extends AnimatedTextView.AnimatedTextDrawable {
        C30211(boolean z, boolean z2, boolean z3) {
            super(z, z2, z3);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.ActionBarMenuSlider$2 */
    class C30222 extends AnimatedTextView.AnimatedTextDrawable {
        C30222(boolean z, boolean z2, boolean z3) {
            super(z, z2, z3);
        }
    ...
    public void setValue(float f, boolean z) {
        ...
        if (!z) {
            ...
            this.valueAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.ActionBar.ActionBarMenuSlider.3
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    ActionBarMenuSlider.this.value = f;
                    ActionBarMenuSlider.this.invalidate();
                }
            });
        ...
        String leftStringValue = getLeftStringValue(fClamp2);
        ...
        String rightStringValue = getRightStringValue(fClamp2);
        ...
        this.fillPaint.setColor(getColorValue(fClamp2));
    }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.ActionBarMenuSlider$3 */
    /* JADX INFO: loaded from: classes6.dex */
    class C30233 extends AnimatorListenerAdapter {
        final /* synthetic */ float val$newValue;
    ...
    public void setDrawShadow(boolean z) {
        this.drawShadow = z;
        int iM1124dp = z ? AndroidUtilities.m1124dp(8.0f) : 0;
        setPadding(iM1124dp, iM1124dp, iM1124dp, iM1124dp);
        invalidate();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.drawShadow) {
            canvas.drawRoundRect(rectF, AndroidUtilities.m1124dp(this.roundRadiusDp), AndroidUtilities.m1124dp(this.roundRadiusDp), this.shadowPaint);
        }
        if (this.drawBlur) {
            ...
            if (f < 1.0f) {
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.m1124dp(this.roundRadiusDp), AndroidUtilities.m1124dp(this.roundRadiusDp), this.pseudoBlurPaint);
            }
            if (this.blurBitmap != null && this.value < 1.0f && f > 0.0f) {
                this.blurPaint.setAlpha((int) (f * 255.0f));
                canvas.drawRoundRect(rectF, AndroidUtilities.m1124dp(this.roundRadiusDp), AndroidUtilities.m1124dp(this.roundRadiusDp), this.blurPaint);
            }
            canvas.drawRoundRect(rectF, AndroidUtilities.m1124dp(this.roundRadiusDp), AndroidUtilities.m1124dp(this.roundRadiusDp), this.brightenBlurPaint);
            canvas.drawRoundRect(rectF, AndroidUtilities.m1124dp(this.roundRadiusDp), AndroidUtilities.m1124dp(this.roundRadiusDp), this.darkenBlurPaint);
            this.fillPaint.setColor(-1);
        } else {
            canvas.drawRoundRect(rectF, AndroidUtilities.m1124dp(this.roundRadiusDp), AndroidUtilities.m1124dp(this.roundRadiusDp), this.backgroundPaint);
        }
        drawStops(canvas);
        ...
        canvas.drawRoundRect(rectF, AndroidUtilities.m1124dp(this.roundRadiusDp), AndroidUtilities.m1124dp(this.roundRadiusDp), this.fillPaint);
        drawStops(canvas);
        if (!this.backgroundDark) {
    ...
    private void drawStops(Canvas canvas) {
        ...
        while (true) {
            ...
            float f = fArr[i];
            RectF rectF = AndroidUtilities.rectTmp;
            canvas.drawRect(rectF.left + (rectF.width() * f), rectF.top, rectF.left + (rectF.width() * f) + AndroidUtilities.m1124dp(0.66f), rectF.bottom, this.stopPaint);
            i++;
        }
    }
    ...
    private void drawText(Canvas canvas, boolean z) {
        ...
        this.leftTextDrawable.setBounds(getPaddingLeft() + AndroidUtilities.m1124dp(20.0f), getMeasuredHeight() / 2, (getMeasuredWidth() - getPaddingRight()) - AndroidUtilities.m1124dp(20.0f), getMeasuredHeight() / 2);
        ...
        this.rightTextDrawable.setBounds(getPaddingLeft() + AndroidUtilities.m1124dp(20.0f), getMeasuredHeight() / 2, (getMeasuredWidth() - getPaddingRight()) - AndroidUtilities.m1124dp(20.0f), getMeasuredHeight() / 2);
    ...
    public static class SpeedSlider extends ActionBarMenuSlider {
        ...
        public SpeedSlider(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            C30241 c30241 = new FloatSeekBarAccessibilityDelegate(false) { // from class: org.telegram.ui.ActionBar.ActionBarMenuSlider.SpeedSlider.1
                @Override // org.telegram.p029ui.Components.FloatSeekBarAccessibilityDelegate
                ...
                public CharSequence getContentDescription(View view) {
                    return SpeedIconDrawable.formatNumber(SpeedSlider.this.getSpeed()) + "x  " + LocaleController.getString(C2888R.string.AccDescrSpeedSlider);
                }
            };
            this.seekBarAccessibilityDelegate = c30241;
            setAccessibilityDelegate(c30241);
        }

        /* JADX INFO: renamed from: org.telegram.ui.ActionBar.ActionBarMenuSlider$SpeedSlider$1 */
        class C30241 extends FloatSeekBarAccessibilityDelegate {
            @Override // org.telegram.p029ui.Components.FloatSeekBarAccessibilityDelegate
            protected float getDelta() {
                return 0.2f;
            }
        ...
        @Override // org.telegram.p029ui.ActionBar.ActionBarMenuSlider
