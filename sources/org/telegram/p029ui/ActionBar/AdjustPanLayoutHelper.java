...
import androidx.core.view.C0372x30864cc7;
    ...
    */
    public void startTransition(int r7, int r8, boolean r9) {
        ...
        L27:
            r1 = r2
        L28:
            org.telegram.ui.LaunchActivity r3 = org.telegram.p029ui.LaunchActivity.instance
            if (r3 == 0) goto L3d
        ...
        La7:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.ActionBar.AdjustPanLayoutHelper.startTransition(int, int, boolean):void");
    }
    ...
    public void updateTransition(float f) {
        ...
        float f2 = (int) ((this.from * f) + (this.f1874to * (1.0f - f)));
        if (applyTranslation()) {
    ...
    public AdjustPanLayoutHelper(View view, boolean z) {
        ...
        this.onPreDrawListener = new ViewTreeObserver.OnPreDrawListener() { // from class: org.telegram.ui.ActionBar.AdjustPanLayoutHelper.2
            ...
            public boolean onPreDraw() {
                ...
                if (!adjustPanLayoutHelper.heightAnimationEnabled() || Math.abs(AdjustPanLayoutHelper.this.previousHeight - height) < AndroidUtilities.m1124dp(20.0f)) {
    ...
    private void setupNewCallback() {
        ...
        view.setWindowInsetsAnimationCallback(new WindowInsetsAnimation$Callback(1) { // from class: org.telegram.ui.ActionBar.AdjustPanLayoutHelper.4
            public WindowInsets onProgress(WindowInsets windowInsets, List list) {
                WindowInsetsAnimation windowInsetsAnimationM135m;
                if (AdjustPanLayoutHelper.this.animationInProgress && AndroidUtilities.screenRefreshRate >= 90.0f) {
                    Iterator it = list.iterator();
                    while (true) {
                        if (!it.hasNext()) {
                            windowInsetsAnimationM135m = null;
                            break;
                        }
                        windowInsetsAnimationM135m = C0372x30864cc7.m135m(it.next());
                        if ((windowInsetsAnimationM135m.getTypeMask() & WindowInsetsCompat.Type.ime()) != 0) {
                            break;
                        }
                    }
                    if (windowInsetsAnimationM135m != null) {
                        long jElapsedRealtime = SystemClock.elapsedRealtime();
                        AdjustPanLayoutHelper adjustPanLayoutHelper = AdjustPanLayoutHelper.this;
                        if (jElapsedRealtime >= adjustPanLayoutHelper.startAfter) {
                            adjustPanLayoutHelper.usingInsetAnimator = true;
                            AdjustPanLayoutHelper.this.updateTransition(windowInsetsAnimationM135m.getInterpolatedFraction());
                        }
                    }
                }
                return windowInsets;
