...
public final class FloatingActionMode extends ActionMode {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.FloatingActionMode$1 */
    class RunnableC30711 implements Runnable {
        RunnableC30711() {
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ActionBar.FloatingActionMode$2 */
    class RunnableC30722 implements Runnable {
        RunnableC30722() {
        }
    ...
    public FloatingActionMode(Context context, ActionMode.Callback2 callback2, View view, FloatingToolbar floatingToolbar) {
        ...
        setType(1);
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() { // from class: org.telegram.ui.ActionBar.FloatingActionMode$$ExternalSyntheticLambda0
        ...
        this.mBottomAllowance = AndroidUtilities.m1124dp(20.0f);
    ...
    private void setFloatingToolbar(FloatingToolbar floatingToolbar) {
        FloatingToolbar onMenuItemClickListener = floatingToolbar.setMenu(this.mMenu).setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() { // from class: org.telegram.ui.ActionBar.FloatingActionMode$$ExternalSyntheticLambda1
