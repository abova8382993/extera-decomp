...
public class EmojiThemes {
    ...
    public EmojiThemes(int i, TLRPC.TL_theme tL_theme, boolean z) {
        ...
        this.key = ThemeKey.m1213of(tL_theme);
    ...
    public EmojiThemes(int i, TLRPC.TL_chatThemeUniqueGift tL_chatThemeUniqueGift) {
        ...
        this.key = ThemeKey.m1212of(tL_chatThemeUniqueGift);
    ...
    public static EmojiThemes createPreviewFullTheme(int i, TLRPC.TL_theme tL_theme) {
        ...
        emojiThemes.key = ThemeKey.m1213of(tL_theme);
    ...
    */
    public android.util.SparseIntArray getPreviewColors(int r13, int r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.ActionBar.EmojiThemes.getPreviewColors(int, int):android.util.SparseIntArray");
    }
    ...
    public SparseIntArray createColors(int i, int i2) {
        ...
        if (themeInfo2 == null) {
            ...
            themeInfo3.setCurrentAccentId(themeAccentCreateNewAccent.f1877id);
    ...
    public void loadWallpaper(int i, final ResultCallback resultCallback) {
        ...
        if (wallpaper != null) {
            ...
            loadWallpaperImage(this.currentAccount, wallpaper.f1833id, wallpaper, new Utilities.Callback() { // from class: org.telegram.ui.ActionBar.EmojiThemes$$ExternalSyntheticLambda0
    ...
    public static /* synthetic */ void $r8$lambda$VCkI0d8L2PeP2148z7K7_BYAE3Y(final Utilities.Callback callback, TLRPC.WallPaper wallPaper, final int i, final int i2, final long j, WallpaperBitmapHolder wallpaperBitmapHolder) {
        ...
        imageReceiver.setDelegate(new ImageReceiver.ImageReceiverDelegate() { // from class: org.telegram.ui.ActionBar.EmojiThemes$$ExternalSyntheticLambda6
            ...
            public final void didSetImage(ImageReceiver imageReceiver2, boolean z, boolean z2, boolean z3) {
                EmojiThemes.m5622$r8$lambda$y3jiPzp6fdq2si5rHBAam_1H8(i, callback, i2, j, imageReceiver2, z, z2, z3);
            }
    ...
    /* JADX INFO: renamed from: $r8$lambda$y3j-iPzp6fdq2s-i5rHBAam_1H8, reason: not valid java name */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static /* synthetic */ void m5622$r8$lambda$y3jiPzp6fdq2si5rHBAam_1H8(int r0, org.telegram.messenger.Utilities.Callback r1, int r2, long r3, org.telegram.messenger.ImageReceiver r5, boolean r6, boolean r7, boolean r8) {
        /*
        ...
        L3c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.ActionBar.EmojiThemes.m5622$r8$lambda$y3jiPzp6fdq2si5rHBAam_1H8(int, org.telegram.messenger.Utilities$Callback, int, long, org.telegram.messenger.ImageReceiver, boolean, boolean, boolean):void");
    }
    ...
    public void loadWallpaperThumb(int i, final ResultCallback resultCallback) {
        ...
        if (document == null) {
            ...
            imageReceiver.setDelegate(new ImageReceiver.ImageReceiverDelegate() { // from class: org.telegram.ui.ActionBar.EmojiThemes$$ExternalSyntheticLambda3
                @Override // org.telegram.messenger.ImageReceiver.ImageReceiverDelegate
                public final void didSetImage(ImageReceiver imageReceiver2, boolean z, boolean z2, boolean z3) {
                    EmojiThemes.m5621$r8$lambda$jK27KEF1yFfzj46vlIaI1Pon0c(resultCallback, themeId, wallpaperThumbFile, imageReceiver2, z, z2, z3);
                }
    ...
    /* JADX INFO: renamed from: $r8$lambda$jK27KEF1yFf-zj46vlIaI1Pon0c, reason: not valid java name */
    public static /* synthetic */ void m5621$r8$lambda$jK27KEF1yFfzj46vlIaI1Pon0c(ResultCallback resultCallback, long j, final File file, ImageReceiver imageReceiver, boolean z, boolean z2, boolean z3) {
    ...
    public static class ThemeItem implements ITheme {
        ...
        @Override // org.telegram.p029ui.ActionBar.theme.ITheme
        public long getThemeId() {
            TLRPC.TL_theme tL_theme = this.tlTheme;
            if (tL_theme != null) {
                return tL_theme.f1808id;
            }
