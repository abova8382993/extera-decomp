...
public class LivePlayer implements NotificationCenter.NotificationCenterDelegate, AudioManager.OnAudioFocusChangeListener {
    ...
    public static /* synthetic */ void m18649$r8$lambda$Zf53pjibKnjUHxoDqBPPYdZKM(int[] iArr, float[] fArr, boolean[] zArr) {
    }
    ...
    public void continueStreaming() {
        ...
        PermissionRequest.ensureAllPermissions(C2888R.raw.permission_request_camera, C2888R.string.PermissionNoCameraMicVideo, new String[]{"android.permission.CAMERA", "android.permission.RECORD_AUDIO"}, new Utilities.Callback() { // from class: org.telegram.ui.Stories.LivePlayer$$ExternalSyntheticLambda9
    ...
    public /* synthetic */ void lambda$continueStreaming$0(Boolean bool) {
        if (bool.booleanValue() && !this.destroyed) {
            ...
            configureAudio();
            init();
            NotificationCenter.getInstance(this.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.liveStoryUpdated, Long.valueOf(this.inputCall.f1682id));
        }
    }
    ...
    public LivePlayer(Context context, int i, TL_stories.StoryItem storyItem, long j, int i2, boolean z, TLRPC.InputGroupCall inputGroupCall, boolean z2, boolean z3) {
        ...
        this.outgoing = z2;
        this.isFront = z3;
        this.instanceSink = new C68521();
        FileLog.m1133d("[LivePlayer] setup to call " + inputGroupCall.f1682id);
    ...
    class C68521 extends VoIPService.ProxyVideoSink {
        C68521() {
        }
    ...
    private void init() {
        ...
        NativeInstance nativeInstanceMakeGroup = NativeInstance.makeGroup(VoIPHelper.getLogFilePath("live_" + this.inputCall.f1682id), 0L, false, SharedConfig.noiseSupression, new NativeInstance.PayloadCallback() { // from class: org.telegram.ui.Stories.LivePlayer$$ExternalSyntheticLambda2
            ...
            public final void run(int[] iArr, float[] fArr, boolean[] zArr) {
                LivePlayer.m18649$r8$lambda$Zf53pjibKnjUHxoDqBPPYdZKM(iArr, fArr, zArr);
            }
        ...
        nativeInstanceMakeGroup.setOnStateUpdatedListener(new C68532());
    ...
    public /* synthetic */ void lambda$init$9(final TLObject tLObject, TLRPC.TL_error tL_error) {
        if (tLObject instanceof TLRPC.Updates) {
            ...
            while (i3 < size2) {
                ...
                if (tL_updateGroupCallParticipants.call.f1682id == getCallId() && !z) {
                    int i4 = 0;
                    while (true) {
            ...
            FileLog.m1133d("[LivePlayer] joined call " + this.inputCall.f1682id);
            this.joined = true;
    ...
    public /* synthetic */ void lambda$init$1(ArrayList arrayList) {
        ...
        while (i < size) {
            ...
            NotificationCenter.getInstance(this.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.liveStoryMessageUpdate, Long.valueOf(tL_updateGroupCallMessage.call.f1682id), tL_updateGroupCallMessage, Boolean.TRUE);
        }
    }
    ...
    public /* synthetic */ void lambda$init$8() {
        NotificationCenter.getInstance(this.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.liveStoryUpdated, Long.valueOf(this.call.f1675id));
        setPolling(true);
    }
    ...
    /* JADX INFO: loaded from: classes7.dex */
    class C68532 implements Instance.OnStateUpdatedListener {
        C68532() {
        }
        ...
        public void onStateUpdated(int i, boolean z) {
            ...
            FileLog.m1133d("[LivePlayer] connectionState = " + i);
    ...
    public void setVolume(float f) {
        ...
        FileLog.m1133d("setVolume(" + fClamp01 + ")");
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        if (i == NotificationCenter.storyGroupCallUpdated) {
            ...
            if (this.dialogId == jLongValue) {
                ...
                NotificationCenter.getInstance(this.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.liveStoryUpdated, Long.valueOf(groupCall.f1675id));
            }
        }
    }
    ...
    public void storyDeleted() {
        ...
        tL_storyItemDeleted.f1857id = this.storyId;
    ...
    public boolean equals(TLRPC.InputGroupCall inputGroupCall) {
        ...
        return inputGroupCall2 == inputGroupCall || inputGroupCall2.f1682id == inputGroupCall.f1682id;
    }
    ...
    public void destroy() {
        ...
        FileLog.m1133d("[LivePlayer] destroyed");
        if (this.joined) {
            TL_phone.leaveGroupCall leavegroupcall = new TL_phone.leaveGroupCall();
            leavegroupcall.call = this.inputCall;
    ...
    public /* synthetic */ void lambda$poll$32(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (tLObject instanceof Vector) {
            ...
            if ("GROUPCALL_JOIN_MISSING".equals(tL_error.text)) {
                FileLog.m1133d("[LivePlayer] received GROUPCALL_JOIN_MISSING on checkGroupCall => rejoining");
