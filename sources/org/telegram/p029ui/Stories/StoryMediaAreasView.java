...
public abstract class StoryMediaAreasView extends FrameLayout implements View.OnClickListener {
    ...
    public void set(TL_stories.StoryItem storyItem, ArrayList arrayList, EmojiAnimationsOverlay emojiAnimationsOverlay) {
        ...
        for (int i2 = 0; i2 < arrayList.size(); i2++) {
            ...
            if (mediaArea != null && mediaArea.coordinates != null) {
                ...
                double d = mediaAreaCoordinates.f1853w;
                double d2 = mediaAreaCoordinates.f1852h;
            }
        }
        this.malicious = false;
    ...
    protected void onMeasure(int i, int i2) {
        ...
        for (int i3 = 0; i3 < getChildCount(); i3++) {
            ...
            if (childAt == frameLayout) {
                ...
                areaView.measure(View.MeasureSpec.makeMeasureSpec((int) Math.ceil((areaView.mediaArea.coordinates.f1853w / 100.0d) * ((double) size)), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec((int) Math.ceil((areaView.mediaArea.coordinates.f1852h / 100.0d) * ((double) size2)), TLObject.FLAG_30));
            } else if (childAt instanceof FitViewWidget) {
                FitViewWidget fitViewWidget = (FitViewWidget) getChildAt(i3);
                fitViewWidget.measure(View.MeasureSpec.makeMeasureSpec((int) Math.ceil((fitViewWidget.mediaArea.coordinates.f1853w / 100.0d) * ((double) size)), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec((int) Math.ceil((fitViewWidget.mediaArea.coordinates.f1852h / 100.0d) * ((double) size2)), TLObject.FLAG_30));
            }
        }
    ...
    */
    public void onClick(android.view.View r19) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Stories.StoryMediaAreasView.onClick(android.view.View):void");
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        for (int i5 = 0; i5 < getChildCount(); i5++) {
            ...
            if (childAt == this.hintsContainer) {
                ...
                areaView.setTranslationX((float) ((areaView.mediaArea.coordinates.f1854x / 100.0d) * ((double) getMeasuredWidth())));
                areaView.setTranslationY((float) ((areaView.mediaArea.coordinates.f1855y / 100.0d) * ((double) getMeasuredHeight())));
                ...
                fitViewWidget.setTranslationX((float) ((fitViewWidget.mediaArea.coordinates.f1854x / 100.0d) * ((double) getMeasuredWidth())));
                fitViewWidget.setTranslationY((float) ((fitViewWidget.mediaArea.coordinates.f1855y / 100.0d) * ((double) getMeasuredHeight())));
    ...
    */
    private void drawHighlight(android.graphics.Canvas r18) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Stories.StoryMediaAreasView.drawHighlight(android.graphics.Canvas):void");
    }
