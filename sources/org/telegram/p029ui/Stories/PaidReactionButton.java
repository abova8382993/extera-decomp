...
public class PaidReactionButton extends View {
    ...
    public static class PaidReactionButtonEffectsView extends View {
        ...
        public PaidReactionButtonEffectsView(Context context, int i) {
            ...
            this.effectAssets = new int[]{C2888R.raw.star_reaction_effect1, C2888R.raw.star_reaction_effect2, C2888R.raw.star_reaction_effect3, C2888R.raw.star_reaction_effect4, C2888R.raw.star_reaction_effect5};
            this.chips = new ArrayList();
            this.hidden = true;
            this.currentAccount = i;
            animatedTextDrawable.setCallback(this);
            animatedTextDrawable.setHacks(false, true, true);
            animatedTextDrawable.setTextSize(AndroidUtilities.m1124dp(40.0f));
            animatedTextDrawable.setTypeface(AndroidUtilities.getTypeface("fonts/num.otf"));
            animatedTextDrawable.setShadowLayer(AndroidUtilities.m1124dp(12.0f), 0.0f, AndroidUtilities.m1124dp(3.5f), 0);
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            int iM1124dp = (int) (AndroidUtilities.m1124dp(90.0f) * fLerp);
            int i = 0;
            int i2 = 0;
            while (i2 < this.effects.size()) {
                ...
                if (rLottieDrawable.getCurrentFrame() >= rLottieDrawable.getFramesCount()) {
                    ...
                    rLottieDrawable.setBounds((int) ((this.reactionBounds.left + (AndroidUtilities.m1124dp(15.0f) * fLerp)) - f), (int) (this.reactionBounds.centerY() - f), (int) (this.reactionBounds.left + (AndroidUtilities.m1124dp(15.0f) * fLerp) + f), (int) (this.reactionBounds.centerY() + f));
            ...
            float fM1124dp = this.reactionBounds.top - AndroidUtilities.m1124dp(1.0f);
            canvas.save();
            canvas.translate(fCenterX, fM1124dp);
        ...
        public void playEffect() {
            ...
            RLottieDrawable rLottieDrawable = new RLottieDrawable(i, _UrlKt.FRAGMENT_ENCODE_SET + i, AndroidUtilities.m1124dp(70.0f), AndroidUtilities.m1124dp(70.0f));
        ...
        public class Chip {
            ...
            public Chip(View view, int i, long j, int i2, int i3, boolean z) {
                ...
                if (z) {
                    ...
                    RLottieDrawable rLottieDrawable = new RLottieDrawable(i4, _UrlKt.FRAGMENT_ENCODE_SET + i4, AndroidUtilities.m1124dp(70.0f), AndroidUtilities.m1124dp(70.0f));
                ...
                imageReceiver.setImageCoords(AndroidUtilities.m1124dp(2.0f), AndroidUtilities.m1124dp(2.0f), AndroidUtilities.m1124dp(14.0f), AndroidUtilities.m1124dp(14.0f));
                imageReceiver.setRoundRadius(AndroidUtilities.m1124dp(7.0f));
                ...
                ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C2888R.drawable.star);
            ...
            public boolean draw(Canvas canvas) {
                ...
                float fM1124dp = AndroidUtilities.m1124dp(23.0f) + this.text.getCurrentWidth();
                float fM1124dp2 = AndroidUtilities.m1124dp(18.0f);
                ...
                canvas.translate(AndroidUtilities.m1124dp(4.0f) * ((this.randomTranslation * 2.0f) - 1.0f), 0.0f);
                canvas.rotate(((this.randomRotation * 2.0f) - 1.0f) * 1.5f);
                canvas.translate(0.0f, (-AndroidUtilities.m1124dp(200.0f)) * ((float) Math.pow(d, 0.800000011920929d)));
                canvas.translate(AndroidUtilities.m1124dp(5.0f) * fSin * ((float) Math.pow(d, 0.5d)), 0.0f);
                ...
                canvas.translate((-fM1124dp) / 2.0f, (-fM1124dp2) / 2.0f);
                float f3 = fM1124dp2 / 2.0f;
                canvas.drawRoundRect(0.0f, 0.0f, fM1124dp, fM1124dp2, f3, f3, this.backgroundPaint);
                this.imageReceiver.draw(canvas);
                this.text.draw(canvas, AndroidUtilities.m1124dp(18.0f), f3, -1, fLerp);
                canvas.restore();
                if (this.effect != null) {
                    canvas.save();
                    canvas.translate(AndroidUtilities.m1124dp(4.0f) * ((this.randomTranslation * 2.0f) - 1.0f), 0.0f);
                    canvas.rotate(((this.randomRotation * 2.0f) - 1.0f) * 1.5f);
                    canvas.translate(0.0f, (-AndroidUtilities.m1124dp(200.0f)) * ((float) Math.pow(d, 0.800000011920929d)));
                    canvas.translate(fSin * AndroidUtilities.m1124dp(5.0f) * ((float) Math.pow(d, 0.5d)), 0.0f);
                    int iM1124dp = AndroidUtilities.m1124dp(90.0f);
                    int i2 = (-iM1124dp) / 2;
                    int i3 = iM1124dp / 2;
                    this.effect.setBounds(i2, AndroidUtilities.m1124dp(8.0f) + i2, i3, AndroidUtilities.m1124dp(8.0f) + i3);
    ...
    public PaidReactionButton(Context context, PaidReactionButtonEffectsView paidReactionButtonEffectsView, BlurredBackgroundColorProvider blurredBackgroundColorProvider) {
        ...
        this.iconDrawable = context.getResources().getDrawable(C2888R.drawable.star).mutate();
        ...
        animatedTextDrawable.setTextSize(AndroidUtilities.m1124dp(9.0f));
        animatedTextDrawable.setCallback(this);
        animatedTextDrawable.setTypeface(AndroidUtilities.getTypeface("fonts/num.otf"));
    ...
    @Override // android.view.View
    protected void dispatchDraw(Canvas canvas) {
        float fM1124dp = AndroidUtilities.m1124dp(38.0f);
        float f = this.animatedFilled.set(this.filled);
        float f2 = this.animatedShowCounter.set(this.stars > 0);
        this.rect.set((getWidth() - fM1124dp) / 2.0f, (getHeight() - fM1124dp) / 2.0f, (getWidth() + fM1124dp) / 2.0f, (getHeight() + fM1124dp) / 2.0f);
        ...
        this.iconDrawable.setBounds((getWidth() - iM1124dp) / 2, (getHeight() - iM1124dp) / 2, (getWidth() + iM1124dp) / 2, (getHeight() + iM1124dp) / 2);
        ...
        canvas.restore();
        if (f2 > 0.0f) {
            float fMax = Math.max(AndroidUtilities.m1124dp(12.0f), AndroidUtilities.m1124dp(6.0f) + this.countText.getCurrentWidth());
            float fIsNotEmpty = this.countScale * this.countText.isNotEmpty() * f2;
            canvas.save();
            RectF rectF3 = AndroidUtilities.rectTmp;
            rectF3.set(getWidth() - fMax, 0.0f, getWidth(), AndroidUtilities.m1124dp(13.0f));
            canvas.scale(fIsNotEmpty, fIsNotEmpty, rectF3.centerX(), rectF3.centerY());
            rectF3.inset(-AndroidUtilities.m1124dp(2.0f), -AndroidUtilities.m1124dp(2.0f));
            ...
            canvas.translate(rectF3.left + ((fMax - this.countText.getCurrentWidth()) / 2.0f), AndroidUtilities.m1124dp(6.33f));
