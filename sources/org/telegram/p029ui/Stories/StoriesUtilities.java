...
import org.telegram.p029ui.Components.Shaker$$ExternalSyntheticLambda0;
...
public abstract class StoriesUtilities {
    ...
    class RunnableC69381 implements Runnable {
        RunnableC69381() {
        }
    ...
    */
    public static void drawAvatarWithStory(long r26, android.graphics.Canvas r28, org.telegram.messenger.ImageReceiver r29, boolean r30, org.telegram.ui.Stories.StoriesUtilities.AvatarStoryParams r31) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Stories.StoriesUtilities.drawAvatarWithStory(long, android.graphics.Canvas, org.telegram.messenger.ImageReceiver, boolean, org.telegram.ui.Stories.StoriesUtilities$AvatarStoryParams):void");
    }

    public static void drawLive(Canvas canvas, RectF rectF, float f, boolean z, float f2) {
        Canvas canvas2;
        if (liveText == null) {
            liveText = new Text(LocaleController.getString(C2888R.string.LiveStoryBadge), 9.66f, AndroidUtilities.bold());
        }
        ...
        float fLerp = AndroidUtilities.lerp(AndroidUtilities.m1124dp(4.66f), AndroidUtilities.m1124dp(7.0f), f2);
        float width = liveText.getWidth() + fLerp + fLerp;
        float fLerp2 = AndroidUtilities.lerp(AndroidUtilities.m1124dp(15.0f), AndroidUtilities.m1124dp(18.0f), f2);
        float fM1124dp = AndroidUtilities.m1124dp(2.0f);
        canvas.save();
        float f3 = width / 2.0f;
        float f4 = 0.8f * fLerp2;
        float f5 = fLerp2 * 0.2f;
        liveRect.set((rectF.centerX() - f3) - fM1124dp, (rectF.bottom - f4) - fM1124dp, rectF.centerX() + f3 + fM1124dp, rectF.bottom + f5 + fM1124dp);
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private static void drawSegmentsInternal(android.graphics.Canvas r20, org.telegram.p029ui.Stories.StoriesController r21, org.telegram.messenger.ImageReceiver r22, org.telegram.ui.Stories.StoriesUtilities.AvatarStoryParams r23, android.graphics.Paint r24, android.graphics.Paint r25, android.graphics.Paint r26, android.graphics.Paint r27, boolean r28) {
        /*
            Method dump skipped, instruction units count: 496
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Stories.StoriesUtilities.drawSegmentsInternal(android.graphics.Canvas, org.telegram.ui.Stories.StoriesController, org.telegram.messenger.ImageReceiver, org.telegram.ui.Stories.StoriesUtilities$AvatarStoryParams, android.graphics.Paint, android.graphics.Paint, android.graphics.Paint, android.graphics.Paint, boolean):void");
    }
    ...
    private static void drawCircleInternal(Canvas canvas, View view, AvatarStoryParams avatarStoryParams, Paint paint, boolean z) {
        if (z || ExteraConfig.avatarCorners != 28.0f) {
            ...
            rectF.set(rectTmp);
            rectF.inset(AndroidUtilities.m1124dp(0.5f), AndroidUtilities.m1124dp(0.5f));
    ...
    public static int getInset(int i, int i2) {
        ...
        if (i == 2) {
            return AndroidUtilities.m1124dp(3.0f);
        }
        if (i == 1) {
    ...
    public static void setThumbImage(AvatarDrawable avatarDrawable, ImageReceiver imageReceiver, TL_stories.StoryItem storyItem, int i, int i2) {
        ...
        if (messageMedia != null && (document = messageMedia.document) != null) {
            imageReceiver.setImage(ImageLocation.getForDocument(FileLoader.getClosestPhotoSizeWithSize(document.thumbs, AndroidUtilities.m1124dp(Math.max(i, i2)), false, null, true), storyItem.media.document), i + "_" + i2, null, null, ImageLoader.createStripedBitmap(storyItem.media.document.thumbs), 0L, null, storyItem, 0);
            return;
        }
        TLRPC.Photo photo = messageMedia != null ? messageMedia.photo : null;
        if (photo != null && (arrayList = photo.sizes) != null) {
            imageReceiver.setImage(null, null, ImageLocation.getForPhoto(FileLoader.getClosestPhotoSizeWithSize(arrayList, AndroidUtilities.m1124dp(Math.max(i, i2)), false, null, true), photo), i + "_" + i2, null, null, ImageLoader.createStripedBitmap(photo.sizes), 0L, null, storyItem, 0);
            return;
        }
        imageReceiver.clearImage();
    }
    ...
    public static CharSequence getUploadingStr(TextView textView, boolean z, boolean z2) {
        String string;
        if (z2) {
            string = LocaleController.getString(C2888R.string.StoryEditing);
        } else {
            string = LocaleController.getString(C2888R.string.UploadingStory);
        }
        if (string.indexOf("…") <= 0) {
            return string;
        }
    ...
    public static CharSequence createExpiredStoryString() {
        return createExpiredStoryString(false, C2888R.string.ExpiredStory, new Object[0]);
    }
    ...
    public static CharSequence createExpiredStoryString(boolean z, int i, Object... objArr) {
        ...
        ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C2888R.drawable.msg_mini_bomb);
        if (z) {
    ...
    public static CharSequence createReplyStoryString() {
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        spannableStringBuilder.append((CharSequence) "d ").append((CharSequence) LocaleController.getString(C2888R.string.Story));
        spannableStringBuilder.setSpan(new ColoredImageSpan(C2888R.drawable.msg_mini_replystory2), 0, 1, 0);
        return spannableStringBuilder;
    }
    ...
    public static void applyViewedUser(TL_stories.StoryItem storyItem, TLRPC.User user) {
        ...
        if (storyViews.views_count == 0) {
            ...
            storyViews.recent_viewers.add(Long.valueOf(user.f1825id));
        }
    }
    ...
    public static EnsureStoryFileLoadedObject ensureStoryFileLoaded(TL_stories.PeerStories peerStories, final Runnable runnable) {
        ...
        ensureStoryFileLoadedObject.runnable = new Runnable() { // from class: org.telegram.ui.Stories.StoriesUtilities$$ExternalSyntheticLambda0
            ...
            public final void run() {
                StoriesUtilities.m19011$r8$lambda$vj5KJCnxfshabut8bbOCF844fQ(ensureStoryFileLoadedObject, runnable);
            }
        };
        ...
        Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.Stories.StoriesUtilities$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                StoriesUtilities.m19010$r8$lambda$kfHW3kZyQMzq2sFs9GFKip6YvU(runnableArr, ensureStoryFileLoadedObject);
            }
        };
        AndroidUtilities.runOnUIThread(runnable2, 3000L);
        C69392 c69392 = new ImageReceiver() { // from class: org.telegram.ui.Stories.StoriesUtilities.2
            final /* synthetic */ EnsureStoryFileLoadedObject val$ensureStoryFileLoadedObject;
            final /* synthetic */ Runnable[] val$runnableRef;

            C69392(final Runnable[] runnableArr2, final EnsureStoryFileLoadedObject ensureStoryFileLoadedObject2) {
        ...
        ensureStoryFileLoadedObject2.imageReceiver = c69392;
        c69392.setAllowLoadingOnAttachedOnly(true);
    ...
    public static /* synthetic */ void m19011$r8$lambda$vj5KJCnxfshabut8bbOCF844fQ(EnsureStoryFileLoadedObject ensureStoryFileLoadedObject, Runnable runnable) {
    ...
    public static /* synthetic */ void m19010$r8$lambda$kfHW3kZyQMzq2sFs9GFKip6YvU(Runnable[] runnableArr, EnsureStoryFileLoadedObject ensureStoryFileLoadedObject) {
        runnableArr[0] = null;
        ensureStoryFileLoadedObject.runnable.run();
    ...
    /* JADX INFO: loaded from: classes7.dex */
    class C69392 extends ImageReceiver {
        final /* synthetic */ EnsureStoryFileLoadedObject val$ensureStoryFileLoadedObject;
        final /* synthetic */ Runnable[] val$runnableRef;
    ...
    public static class AvatarStoryParams {
        ...
        public void openStory(long j, Runnable runnable) {
            ...
            lastFragment.getOrCreateStoryViewer().open(lastFragment.getContext(), j, parent instanceof RecyclerView ? StoriesListPlaceProvider.m1320of((RecyclerListView) parent) : null);
        }
        ...
        */
        public /* synthetic */ void lambda$load$2(org.telegram.tgnet.TLObject r10, long r11, android.view.View r13, final org.telegram.ui.Stories.StoriesUtilities.AvatarStoryParams r14, org.telegram.messenger.MessagesController r15) {
            /*
                ...
                r8 = r14
                r3.<init>()
                org.telegram.p029ui.Stories.StoriesUtilities.ensureStoryFileLoaded(r10, r3)
                r10 = r0
                goto L45
            L41:
                r4 = r9
