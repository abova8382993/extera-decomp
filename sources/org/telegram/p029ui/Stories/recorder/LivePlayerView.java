...
public class LivePlayerView extends FrameLayout implements RendererCommon.RendererEvents, NotificationCenter.NotificationCenterDelegate {
            ...
            if (j2 != 0 && this.firstFrameRendered && this.textureView != null) {
                ...
                if (bitmap != null) {
                    ...
                    if (bitmap.getWidth() > bitmap.getHeight()) {
                        width = AndroidUtilities.m1124dp(100.0f);
                        iM1124dp = (int) ((bitmap.getHeight() / bitmap.getWidth()) * AndroidUtilities.m1124dp(100.0f));
                    } else {
                        iM1124dp = AndroidUtilities.m1124dp(100.0f);
                        width = (int) ((bitmap.getWidth() / bitmap.getHeight()) * AndroidUtilities.m1124dp(100.0f));
                    }
                    Bitmap bitmapCreateBitmap = Bitmap.createBitmap(width, iM1124dp, Bitmap.Config.ARGB_8888);
                    Canvas canvas = new Canvas(bitmapCreateBitmap);
                    float width2 = width / bitmap.getWidth();
                    canvas.scale(width2, width2);
                    canvas.drawBitmap(bitmap, 0.0f, 0.0f, paint);
                    Utilities.stackBlurBitmap(bitmapCreateBitmap, AndroidUtilities.m1124dp(4.0f));
                    try {
    ...
    static class EmptyView extends FrameLayout {
        ...
        public static /* synthetic */ void m19329$r8$lambda$hSJLXY4uSxrNh54uMzLml8e9oY(View view) {
        }
        ...
        public EmptyView(Context context) {
            ...
            textView.setText(LocaleController.getString(C2888R.string.LiveStoryDisconnected));
            ...
            buttonWithCounterView.setText(LocaleController.getString(C2888R.string.LiveStoryDisconnectedContinue), false);
            linearLayout.addView(buttonWithCounterView, LayoutHelper.createLinear((int) ((buttonWithCounterView.text.getWidth() + AndroidUtilities.m1124dp(24.0f)) / AndroidUtilities.density), 38, 1, 0, 18, 0, 0));
            buttonWithCounterView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Stories.recorder.LivePlayerView$EmptyView$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    LivePlayerView.EmptyView.m19329$r8$lambda$hSJLXY4uSxrNh54uMzLml8e9oY(view);
                }
            });
        ...
        public void setVisibility(int i) {
            ...
            this.imageView.setImageDrawable(new RLottieDrawable(C2888R.raw.utyan_empty2, "utyan_empty2", AndroidUtilities.m1124dp(130.0f), AndroidUtilities.m1124dp(130.0f)));
