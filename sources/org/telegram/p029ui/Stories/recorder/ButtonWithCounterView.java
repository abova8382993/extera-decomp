...
public class ButtonWithCounterView extends FrameLayout implements Loadable {
    ...
    public void setRoundRadius(int i) {
        this.radiusDp = i;
        if (this.filled) {
            setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1124dp(i), this.backgroundColor));
        } else {
            setBackground(null);
        }
        updateColors();
    ...
    public void setFilled(boolean z) {
        ...
        this.filled = z;
        if (z) {
            setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1124dp(this.radiusDp), this.backgroundColor));
    ...
    public ButtonWithCounterView(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (z) {
            int iM1124dp = AndroidUtilities.m1124dp(this.radiusDp);
            int color = Theme.getColor(Theme.key_featuredStickers_addButton, resourcesProvider);
            this.backgroundColor = color;
            setBackground(Theme.createRoundRectDrawable(iM1124dp, color));
        }
        ...
        animatedTextDrawable3.setTextSize(AndroidUtilities.m1124dp(12.0f));
    ...
    public void setColor(int i) {
        if (this.filled) {
            ...
            setBackground(Theme.createRoundRectDrawable(iM1124dp, i));
            return;
        }
    ...
    public void setColor(int i, int i2) {
        if (this.filled) {
            setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1124dp(this.radiusDp), i));
            View view = this.rippleView;
    ...
    public void setCountFilled(boolean z) {
        this.countFilled = z;
        this.countText.setTextSize(AndroidUtilities.m1124dp(z ? 12.0f : 14.0f));
        updateColors();
    }
    ...
    @Override // org.telegram.p029ui.Components.Loadable
    ...
    public void withCounterIcon() {
        ...
        Drawable drawableMutate = ContextCompat.getDrawable(getContext(), C2888R.drawable.mini_boost_button).mutate();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (f < 1.0f) {
            ...
            float fM1124dp = this.withCounterIcon ? AndroidUtilities.m1124dp(12.0f) : 0.0f;
            float fCalculateCounterWidth = currentWidth + fM1124dp + calculateCounterWidth(AndroidUtilities.m1124dp(17.66f) + this.countText.getCurrentWidth(), f2);
            ...
            rect.offset(0, (int) ((-AndroidUtilities.m1124dp(7.0f)) * this.subTextT));
            ...
            if (this.subTextVisible) {
                ...
                rect.set((int) (((getMeasuredWidth() - fCalculateCounterWidth) - getWidth()) / 2.0f), (int) (((getMeasuredHeight() - this.subText.getHeight()) / 2.0f) - AndroidUtilities.m1124dp(1.0f)), (int) ((((getMeasuredWidth() - fCalculateCounterWidth) + getWidth()) / 2.0f) + fCalculateCounterWidth), (int) (((getMeasuredHeight() + this.subText.getHeight()) / 2.0f) - AndroidUtilities.m1124dp(1.0f)));
                rect.offset(0, AndroidUtilities.m1124dp(11.0f));
                canvas.save();
            ...
            rect.set((int) (((getMeasuredWidth() - fCalculateCounterWidth) / 2.0f) + currentWidth + AndroidUtilities.m1124dp(this.countFilled ? 5.0f : 2.0f)), (int) ((getMeasuredHeight() - AndroidUtilities.m1124dp(18.0f)) / 2.0f), (int) (((getMeasuredWidth() - fCalculateCounterWidth) / 2.0f) + currentWidth + AndroidUtilities.m1124dp((this.countFilled ? 5 : 2) + 10) + Math.max(AndroidUtilities.m1124dp(9.0f), this.countText.getCurrentWidth() + fM1124dp)), (int) ((getMeasuredHeight() + AndroidUtilities.m1124dp(18.0f)) / 2.0f));
            ...
            if (this.countFilled) {
                ...
                float fM1124dp2 = AndroidUtilities.m1124dp(this.withCounterIcon ? 4.0f : 10.0f);
                canvas.drawRoundRect(rectF, fM1124dp2, fM1124dp2, this.paint);
            }
            rect.offset(-AndroidUtilities.m1124dp((this.countText.getText() != null ? this.countText.getText().length() : 0) > 1 ? 0.3f : 0.0f), -AndroidUtilities.m1124dp(0.2f));
            ...
            if (this.countFilled && this.withCounterIcon) {
                ...
                this.counterDrawable.setBounds(AndroidUtilities.m1124dp(1.0f) + rect.left, AndroidUtilities.m1124dp(2.0f) + rect.top, AndroidUtilities.m1124dp(1.0f) + rect.left + this.counterDrawable.getIntrinsicWidth(), AndroidUtilities.m1124dp(2.0f) + rect.top + this.counterDrawable.getIntrinsicHeight());
                this.counterDrawable.draw(canvas);
                canvas.translate(fM1124dp / 2.0f, 0.0f);
            }
    ...
    private int getWrapWidth() {
        return getPaddingLeft() + ((int) (this.text.getCurrentWidth() + (this.withCounterIcon ? AndroidUtilities.m1124dp(12.0f) : 0.0f) + calculateCounterWidth(AndroidUtilities.m1124dp(15.66f) + this.countText.getCurrentWidth(), this.countAlphaAnimated.set(this.countAlpha)))) + getPaddingRight();
    }
