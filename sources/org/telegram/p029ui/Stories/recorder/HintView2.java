...
import org.telegram.p029ui.ProfileActivity$$ExternalSyntheticLambda72;
...
public class HintView2 extends View {
    ...
    public HintView2(Context context, int i) {
        ...
        this.rounding = AndroidUtilities.m1124dp(8.0f);
        this.innerPadding = new RectF(AndroidUtilities.m1124dp(11.0f), AndroidUtilities.m1124dp(6.0f), AndroidUtilities.m1124dp(11.0f), AndroidUtilities.m1124dp(7.0f));
        this.closeButtonMargin = AndroidUtilities.m1124dp(2.0f);
        this.arrowHalfWidth = AndroidUtilities.m1124dp(7.0f);
        this.arrowHeight = AndroidUtilities.m1124dp(6.0f);
        ...
        this.iconMargin = AndroidUtilities.m1124dp(2.0f);
        this.hideRunnable = new ProfileActivity$$ExternalSyntheticLambda72(this);
        this.bounceT = 1.0f;
    ...
    public HintView2 setRounding(float f) {
        this.rounding = AndroidUtilities.m1124dp(f);
    ...
    public HintView2 setFlicker(float f, int i) {
        ...
        LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, AndroidUtilities.m1124dp(64.0f), 0.0f, new int[]{Theme.multAlpha(i, 0.0f), Theme.multAlpha(i, 1.0f), Theme.multAlpha(i, 0.0f)}, new float[]{0.0f, 0.5f, 1.0f}, tileMode);
        this.flickerStrokeGradient = linearGradient;
        this.flickerStrokePaint.setShader(linearGradient);
        this.flickerGradient = new LinearGradient(0.0f, 0.0f, AndroidUtilities.m1124dp(64.0f), 0.0f, new int[]{Theme.multAlpha(i, 0.0f), Theme.multAlpha(i, 0.5f), Theme.multAlpha(i, 0.0f)}, new float[]{0.0f, 0.5f, 1.0f}, tileMode);
    ...
    public HintView2 setMultilineText(boolean z) {
        this.multiline = z;
        if (z) {
            this.innerPadding.set(AndroidUtilities.m1124dp(15.0f), AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(15.0f), AndroidUtilities.m1124dp(8.0f));
            this.closeButtonMargin = AndroidUtilities.m1124dp(6.0f);
            return this;
        }
        this.innerPadding.set(AndroidUtilities.m1124dp(11.0f), AndroidUtilities.m1124dp(6.0f), AndroidUtilities.m1124dp(this.closeButton ? 15.0f : 11.0f), AndroidUtilities.m1124dp(7.0f));
        this.closeButtonMargin = AndroidUtilities.m1124dp(2.0f);
        return this;
    }
    ...
    public HintView2 setMaxWidth(float f) {
        this.textMaxWidth = AndroidUtilities.m1124dp(f);
        return this;
    }
    ...
    public HintView2 setIcon(int i) {
        RLottieDrawable rLottieDrawable = new RLottieDrawable(i, _UrlKt.FRAGMENT_ENCODE_SET + i, AndroidUtilities.m1124dp(34.0f), AndroidUtilities.m1124dp(34.0f));
    ...
    */
    public static java.lang.CharSequence cutInFancyHalfText(java.lang.CharSequence r12, android.text.TextPaint r13) {
        ...
        L6d:
            ...
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Stories.recorder.HintView2.cutInFancyHalfText(java.lang.CharSequence, android.text.TextPaint):java.lang.CharSequence");
    }
    ...
    public HintView2 setIconMargin(int i) {
        this.iconMargin = AndroidUtilities.m1124dp(i);
        return this;
    }
    ...
    public HintView2 setJoint(float f, float f2) {
        if (Math.abs(this.joint - f) >= 1.0f || Math.abs(this.jointTranslate - AndroidUtilities.m1124dp(f2)) >= 1.0f) {
            this.pathSet = false;
            invalidate();
        }
        this.joint = f;
        this.jointTranslate = AndroidUtilities.m1124dp(f2);
        return this;
    }
    ...
    protected void drawBgPath(Canvas canvas) {
        ...
        if (this.flicker) {
            ...
            float fCurrentTimeMillis = (-iM1124dp) + ((((System.currentTimeMillis() - this.flickerStart) % 4000) / 4000.0f) * ((this.pathLastWidth * 4.0f) + (iM1124dp * 2)));
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (this.closeButton) {
            if (this.closeButtonDrawable == null) {
                Drawable drawableMutate = getContext().getResources().getDrawable(C2888R.drawable.msg_mini_close_tooltip).mutate();
        ...
        if (hintView2.bounceT != 1.0f) {
            ...
            if (i == 3 || i == 1) {
                canvas.translate(0.0f, (hintView2.bounceT - 1.0f) * Math.max(i == 3 ? hintView2.getPaddingBottom() : hintView2.getPaddingTop(), AndroidUtilities.m1124dp(24.0f)) * (hintView2.direction == 1 ? -1 : 1));
            } else {
                canvas.translate((hintView2.bounceT - 1.0f) * Math.max(i == 0 ? hintView2.getPaddingLeft() : hintView2.getPaddingRight(), AndroidUtilities.m1124dp(24.0f)) * (hintView2.direction == 0 ? -1 : 1), 0.0f);
            }
        }
        ...
        if (hintView2.closeButton) {
            if (hintView2.closeButtonDrawable == null) {
                Drawable drawableMutate2 = hintView2.getContext().getResources().getDrawable(C2888R.drawable.msg_mini_close_tooltip).mutate();
    ...
    private void fillPath(Path path, float f, float f2, float f3, RectF rectF, Rect rect) {
        ...
        if (this.direction == 0) {
            path.lineTo(rectF.left, this.arrowHalfWidth + fClamp + AndroidUtilities.m1124dp(2.0f));
            path.lineTo(rectF.left, this.arrowHalfWidth + fClamp);
            path.lineTo(rectF.left - this.arrowHeight, AndroidUtilities.m1124dp(1.0f) + fClamp);
            float f14 = rectF.left;
            float f15 = this.arrowHeight;
            this.arrowX = f14 - f15;
            this.arrowY = fClamp;
            path.lineTo(f14 - f15, fClamp - AndroidUtilities.m1124dp(1.0f));
            path.lineTo(rectF.left, fClamp - this.arrowHalfWidth);
            path.lineTo(rectF.left, (fClamp - this.arrowHalfWidth) - AndroidUtilities.m1124dp(2.0f));
            if (rect != null) {
        ...
        if (this.direction == 1) {
            path.lineTo((fClamp - this.arrowHalfWidth) - AndroidUtilities.m1124dp(2.0f), rectF.top);
            path.lineTo(fClamp - this.arrowHalfWidth, rectF.top);
            path.lineTo(fClamp - AndroidUtilities.m1124dp(1.0f), rectF.top - this.arrowHeight);
            this.arrowX = fClamp;
            this.arrowY = rectF.top - this.arrowHeight;
            path.lineTo(AndroidUtilities.m1124dp(1.0f) + fClamp, rectF.top - this.arrowHeight);
            path.lineTo(this.arrowHalfWidth + fClamp, rectF.top);
            path.lineTo(this.arrowHalfWidth + fClamp + AndroidUtilities.m1124dp(2.0f), rectF.top);
            if (rect != null) {
        ...
        if (this.direction == 2) {
            path.lineTo(rectF.right, (fClamp - this.arrowHalfWidth) - AndroidUtilities.m1124dp(2.0f));
            path.lineTo(rectF.right, fClamp - this.arrowHalfWidth);
            path.lineTo(rectF.right + this.arrowHeight, fClamp - AndroidUtilities.m1124dp(1.0f));
            float f22 = rectF.right;
            float f23 = this.arrowHeight;
            this.arrowX = f22 + f23;
            this.arrowY = fClamp;
            path.lineTo(f22 + f23, AndroidUtilities.m1124dp(1.0f) + fClamp);
            path.lineTo(rectF.right, this.arrowHalfWidth + fClamp);
            path.lineTo(rectF.right, this.arrowHalfWidth + fClamp + AndroidUtilities.m1124dp(2.0f));
            if (rect != null) {
        ...
        if (this.direction == 3) {
            path.lineTo(this.arrowHalfWidth + fClamp + AndroidUtilities.m1124dp(2.0f), rectF.bottom);
            path.lineTo(this.arrowHalfWidth + fClamp, rectF.bottom);
            path.lineTo(AndroidUtilities.m1124dp(1.0f) + fClamp, rectF.bottom + this.arrowHeight);
            this.arrowX = fClamp;
            this.arrowY = rectF.bottom + this.arrowHeight;
            path.lineTo(fClamp - AndroidUtilities.m1124dp(1.0f), rectF.bottom + this.arrowHeight);
            path.lineTo(fClamp - this.arrowHalfWidth, rectF.bottom);
            path.lineTo((fClamp - this.arrowHalfWidth) - AndroidUtilities.m1124dp(2.0f), rectF.bottom);
            if (rect != null) {
