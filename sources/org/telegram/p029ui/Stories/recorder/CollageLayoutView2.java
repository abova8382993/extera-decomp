...
public abstract class CollageLayoutView2 extends FrameLayout implements ItemOptions.ScrimView {
    ...
    public float f2190dx;

    /* JADX INFO: renamed from: dy */
    public float f2191dy;
    ...
    public CollageLayoutView2(Context context, BlurringShader.BlurManager blurManager, FrameLayout frameLayout, Theme.ResourcesProvider resourcesProvider) {
        ...
        paint.setColor(-1);
        paint.setStrokeWidth(AndroidUtilities.m1124dp(8.0f));
        int iM1124dp = AndroidUtilities.m1124dp(300.0f);
        this.gradientWidth = iM1124dp;
        LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, iM1124dp, 0.0f, new int[]{0, -1, -1, 0}, new float[]{0.0f, 0.2f, 0.8f, 1.0f}, Shader.TileMode.CLAMP);
    ...
    public void drawScrim(Canvas canvas, float f) {
        ...
        if (part != null) {
            ...
            float f2 = part2.layout.f2186h;
            float f3 = this.animatedColumns[part2.f2189y].set(r0.columns[r3]);
            this.rect.set((getMeasuredWidth() / f3) * part2.f2188x, (getMeasuredHeight() / f2) * part2.f2189y, (getMeasuredWidth() / f3) * (part2.f2188x + 1), (getMeasuredHeight() / f2) * (part2.f2189y + 1));
    ...
    public void getBounds(RectF rectF) {
        ...
        if (part != null) {
            CollageLayout.Part part2 = part.part;
            float f = part2.layout.f2186h;
            float f2 = this.animatedColumns[part2.f2189y].set(r1.columns[r4]);
            rectF.set((getMeasuredWidth() / f2) * part2.f2188x, (getMeasuredHeight() / f) * part2.f2189y, (getMeasuredWidth() / f2) * (part2.f2188x + 1), (getMeasuredHeight() / f) * (part2.f2189y + 1));
            return;
        }
    ...
    public Object getBlurRenderNode() {
        if (this.renderNode == null && Build.VERSION.SDK_INT >= 31) {
            this.renderNode = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1129m("CameraViewRenderNode");
            RenderNode renderNodeM1129m = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1129m("CameraViewRenderNodeBlur");
            this.blurRenderNode = renderNodeM1129m;
            BotFullscreenButtons$$ExternalSyntheticApiModelOutline1.m1130m(renderNodeM1129m);
            renderNodeM1129m.setRenderEffect(RenderEffect.createBlurEffect(AndroidUtilities.m1124dp(32.0f), AndroidUtilities.m1124dp(32.0f), Shader.TileMode.DECAL));
        }
    ...
    private void finishNode(Canvas canvas) {
        ...
        RenderNode renderNodeM1130m = BotFullscreenButtons$$ExternalSyntheticApiModelOutline1.m1130m(this.renderNode);
        renderNodeM1130m.endRecording();
        canvas.drawRenderNode(renderNodeM1130m);
        Object obj = this.blurRenderNode;
        if (obj != null) {
            RenderNode renderNodeM1130m2 = BotFullscreenButtons$$ExternalSyntheticApiModelOutline1.m1130m(obj);
            renderNodeM1130m2.setPosition(0, 0, getWidth(), getHeight());
            renderNodeM1130m2.beginRecording().drawRenderNode(renderNodeM1130m);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (!hasLayout() && !this.reordering && !this.reorderingTouch && this.animatedRows.get() == this.currentLayout.f2186h && this.animatedColumns[0].get() == this.currentLayout.columns[0] && this.qrDrawer.hasNoDraw()) {
        ...
        float f6 = this.animatedRows.set(this.currentLayout.f2186h);
        int i2 = 0;
        while (true) {
            d = f6;
            f = 0.0f;
        ...
        int i3 = this.currentLayout.f2186h;
        while (true) {
        ...
        while (i4 < this.parts.size()) {
            ...
            int i5 = i;
            float f7 = f2;
            float f8 = this.animatedColumns[part3.f2189y].set(part3.layout.columns[r2]);
            if (this.reordering || this.reorderingTouch) {
                ...
                z = true;
                f4 = f;
                this.rect.set((getMeasuredWidth() / f8) * part3.f2188x, (getMeasuredHeight() / f6) * part3.f2189y, (getMeasuredWidth() / f8) * (part3.f2188x + 1), (part3.f2189y + 1) * (getMeasuredHeight() / f6));
            }
        ...
        while (i < this.removingParts.size()) {
            ...
            int i10 = i;
            this.rect.set((getMeasuredWidth() / f11) * part5.f2188x, (getMeasuredHeight() / f6) * part5.f2189y, (getMeasuredWidth() / f11) * (part5.f2188x + 1), (getMeasuredHeight() / f6) * (part5.f2189y + 1));
            float[] fArr3 = this.lefts;
            int i11 = part5.f2189y;
            fArr3[i11] = Math.min(fArr3[i11], this.rect.left);
            float[] fArr4 = this.rights;
            int i12 = part5.f2189y;
        ...
        if (f5 > f3 && (part = this.reorderingPart) != null) {
            ...
            float f12 = this.animatedColumns[part6.f2189y].set(this.currentLayout.columns[r7]);
            if (this.reorderingTouch) {
                AndroidUtilities.lerp(part.fromBounds, part.bounds, part.boundsTransition, this.rect);
            } else {
                this.rect.set((getMeasuredWidth() / f12) * part6.f2188x, (getMeasuredHeight() / f6) * part6.f2189y, (getMeasuredWidth() / f12) * (part6.f2188x + 1), (getMeasuredHeight() / f6) * (part6.f2189y + 1));
            }
            canvasBeginRecording.save();
            canvasBeginRecording.translate(AndroidUtilities.lerp(this.ldx, this.f2190dx, part.boundsTransition) * f5, AndroidUtilities.lerp(this.ldy, this.f2191dy, part.boundsTransition) * f5);
        ...
        for (int i14 = i8; i14 < this.parts.size(); i14++) {
            ...
            if (f13 > 0.0f) {
                float f14 = this.animatedColumns[part8.f2189y].set(part8.layout.columns[r8]);
                if (this.reordering || this.reorderingTouch) {
                    AndroidUtilities.lerp(part7.fromBounds, part7.bounds, part7.boundsTransition, this.rect);
                } else {
                    this.rect.set((getMeasuredWidth() / f14) * part8.f2188x, (getMeasuredHeight() / f6) * part8.f2189y, (getMeasuredWidth() / f14) * (part8.f2188x + 1), (getMeasuredHeight() / f6) * (part8.f2189y + 1));
                }
                RectF rectF = AndroidUtilities.rectTmp;
                rectF.set(this.rect);
                rectF.inset(AndroidUtilities.m1124dp(4.0f), AndroidUtilities.m1124dp(4.0f));
                ...
                float fM1124dp = (part9.f2188x == 0 && part9.f2189y == 0) ? AndroidUtilities.m1124dp(8.0f) : 0.0f;
                fArr5[1] = fM1124dp;
                fArr5[i8] = fM1124dp;
                float[] fArr6 = this.radii;
                CollageLayout.Part part10 = part7.part;
                float fM1124dp2 = (part10.f2188x == part10.layout.f2187w + (-1) && part10.f2189y == 0) ? AndroidUtilities.m1124dp(8.0f) : 0.0f;
                fArr6[2] = fM1124dp2;
                fArr6[1] = fM1124dp2;
                float[] fArr7 = this.radii;
                CollageLayout.Part part11 = part7.part;
                int i16 = part11.f2188x;
                CollageLayout collageLayout = part11.layout;
                float fM1124dp3 = (i16 == collageLayout.f2187w + (-1) && part11.f2189y == collageLayout.f2186h + (-1)) ? AndroidUtilities.m1124dp(8.0f) : 0.0f;
                fArr7[4] = fM1124dp3;
                fArr7[3] = fM1124dp3;
                float[] fArr8 = this.radii;
                CollageLayout.Part part12 = part7.part;
                float fM1124dp4 = (part12.f2188x == 0 && part12.f2189y == part12.layout.f2186h + (-1)) ? AndroidUtilities.m1124dp(8.0f) : 0.0f;
                fArr8[6] = fM1124dp4;
                fArr8[5] = fM1124dp4;
    ...
    private void drawPart(Canvas canvas, RectF rectF, Part part) {
        ...
        if (part != this.reorderingPart || this.animatedReordering.get() <= 0.0f) {
            ...
            rectF2.set(rectF);
            rectF2.inset(AndroidUtilities.m1124dp(10.0f) * this.animatedReordering.get(), AndroidUtilities.m1124dp(10.0f) * this.animatedReordering.get());
            float fM1124dp = AndroidUtilities.m1124dp(12.0f) * this.animatedReordering.get();
            this.clipPath.addRoundRect(rectF2, fM1124dp, fM1124dp, Path.Direction.CW);
        ...
        if (part != null && part.content != null) {
            ...
            if (this.cameraViewBlurRenderNode != null && Build.VERSION.SDK_INT >= 29 && canvas.isHardwareAccelerated()) {
                RenderNode renderNodeM1130m = BotFullscreenButtons$$ExternalSyntheticApiModelOutline1.m1130m(this.cameraViewBlurRenderNode);
                float fMax = Math.max(rectF.width() / renderNodeM1130m.getWidth(), rectF.height() / renderNodeM1130m.getHeight());
                canvas.save();
    ...
    public Part getPartAt(float f, float f2) {
        ...
        for (int i = 0; i < this.parts.size(); i++) {
            Part part = (Part) this.parts.get(i);
            float f4 = this.animatedColumns[part.part.f2189y].get();
            this.rect.set((getMeasuredWidth() / f4) * r3.f2188x, (getMeasuredHeight() / f3) * r3.f2189y, (getMeasuredWidth() / f4) * (r3.f2188x + 1), (getMeasuredHeight() / f3) * (r3.f2189y + 1));
    ...
    public int getPartIndexAt(float f, float f2) {
        float f3 = this.animatedRows.get();
        for (int i = 0; i < this.parts.size(); i++) {
            float f4 = this.animatedColumns[((Part) this.parts.get(i)).part.f2189y].get();
            this.rect.set((getMeasuredWidth() / f4) * r2.f2188x, (getMeasuredHeight() / f3) * r2.f2189y, (getMeasuredWidth() / f4) * (r2.f2188x + 1), (getMeasuredHeight() / f3) * (r2.f2189y + 1));
            if (this.rect.contains(f, f2)) {
                return i;
            }
        }
    ...
    public void onLongPress() {
        ...
        imageView.setImageResource(C2888R.drawable.menu_lightbulb);
        ...
        textView.setText(LocaleController.getString(C2888R.string.StoryCollageMenuHint));
        ...
        if (this.longPressedPart.content.isVideo) {
            ...
            onValueChange.fixWidth = AndroidUtilities.m1124dp(220.0f);
            itemOptionsMakeOptions.addView(onValueChange).addSpaceGap();
        }
        itemOptionsMakeOptions.setFixedWidth(Opcodes.REM_INT_LIT8).add(C2888R.drawable.menu_camera_retake, LocaleController.getString(C2888R.string.StoreCollageRetake), new Runnable() { // from class: org.telegram.ui.Stories.recorder.CollageLayoutView2$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$onLongPress$2();
            }
        }).add(C2888R.drawable.msg_delete, (CharSequence) LocaleController.getString(C2888R.string.Delete), true, new Runnable() { // from class: org.telegram.ui.Stories.recorder.CollageLayoutView2$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
        ...
        }).setGravity(1).allowCenter(true).setBlur(true).setRoundRadius(AndroidUtilities.m1124dp(12.0f), AndroidUtilities.m1124dp(10.0f)).setOnDismiss(new Runnable() { // from class: org.telegram.ui.Stories.recorder.CollageLayoutView2$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            this.f2192tx = motionEvent.getX();
            this.f2193ty = motionEvent.getY();
            ...
            if (MathUtils.distance(motionEvent.getX(), motionEvent.getY(), this.f2192tx, this.f2193ty) > AndroidUtilities.touchSlop * 1.2f && (runnable = this.onLongPressPart) != null) {
                AndroidUtilities.cancelRunOnUIThread(runnable);
                this.onLongPressPart = null;
            }
            if (!this.reorderingTouch && getFilledProgress() >= 1.0f && this.pressedPart != null && partAt != null && MathUtils.distance(motionEvent.getX(), motionEvent.getY(), this.f2192tx, this.f2193ty) > AndroidUtilities.touchSlop * 1.2f) {
                ...
                if (partIndexAt >= 0 && iIndexOf >= 0 && partIndexAt != iIndexOf) {
                    ...
                    float f = this.currentLayout.f2186h;
                    float f2 = this.animatedColumns[this.reorderingPart.part.f2189y].get();
                    this.rect.set((getMeasuredWidth() / f2) * r3.f2188x, (getMeasuredHeight() / f) * r3.f2189y, (getMeasuredWidth() / f2) * (r3.f2188x + 1), (getMeasuredHeight() / f) * (r3.f2189y + 1));
                    this.ldx = this.f2190dx;
                    this.ldy = this.f2191dy;
                    this.f2192tx = this.rect.centerX();
                    this.f2193ty = this.rect.centerY();
                }
                this.f2190dx = motionEvent.getX() - this.f2192tx;
                this.f2191dy = motionEvent.getY() - this.f2193ty;
                invalidate();
    ...
    public class Part {
        ...
        public void setContent(StoryEntry storyEntry) {
            ...
            if (storyEntry2 == null) {
                ...
                C70203 c70203 = new C70203();
                this.videoPlayer = c70203;
                c70203.allowMultipleInstances(true);
        ...
        class C70203 extends VideoPlayerHolderBase {
            C70203() {
            }
    ...
    */
    public /* synthetic */ void lambda$new$7() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Stories.recorder.CollageLayoutView2.lambda$new$7():void");
    }
}
