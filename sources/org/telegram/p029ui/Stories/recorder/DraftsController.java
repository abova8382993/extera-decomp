    ...
    */
    public static /* synthetic */ void $r8$lambda$RiC0JImjTCT65pJVD7o8arqUXPQ(org.telegram.messenger.MessagesStorage r5, org.telegram.ui.Stories.recorder.DraftsController.StoryDraft r6) {
        ...
        L8:
            ...
            long r1 = r6.f2195id     // Catch: java.lang.Throwable -> L4a java.lang.Exception -> L4c
            r3 = 1
        ...
        L4c:
            r5 = move-exception
            org.telegram.messenger.FileLog.m1136e(r5)     // Catch: java.lang.Throwable -> L4a
            if (r0 == 0) goto L55
            r0.dispose()
        L55:
            return
        ...
        L5b:
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Stories.recorder.DraftsController.$r8$lambda$RiC0JImjTCT65pJVD7o8arqUXPQ(org.telegram.messenger.MessagesStorage, org.telegram.ui.Stories.recorder.DraftsController$StoryDraft):void");
    }
    ...
    */
    public static /* synthetic */ void $r8$lambda$6IXZXV8p4lXLYDofSjSWK6WcFX8(org.telegram.messenger.MessagesStorage r5, org.telegram.ui.Stories.recorder.DraftsController.StoryDraft r6) {
        ...
        L5b:
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Stories.recorder.DraftsController.$r8$lambda$6IXZXV8p4lXLYDofSjSWK6WcFX8(org.telegram.messenger.MessagesStorage, org.telegram.ui.Stories.recorder.DraftsController$StoryDraft):void");
    }
    ...
    public void saveForEdit(StoryEntry storyEntry, long j, TL_stories.StoryItem storyItem) {
        ...
        while (i < size) {
            ...
            if (storyEntry2.isEdit && storyEntry2.editStoryId == storyItem.f1857id) {
    ...
    public StoryEntry getForEdit(long j, TL_stories.StoryItem storyItem) {
        ...
        while (i < size) {
            ...
            if (storyEntry.isEdit && storyItem.f1857id == storyEntry.editStoryId && j == storyEntry.editStoryPeerId && ((document = (messageMedia = storyItem.media).document) == null || document.f1668id == storyEntry.editDocumentId)) {
                TLRPC.Photo photo = messageMedia.photo;
                if (photo == null || photo.f1692id == storyEntry.editPhotoId) {
    ...
    public static class StoryDraft {
        ...
        public StoryDraft(StoryEntry storyEntry) {
            ...
            this.f2195id = storyEntry.draftId;
        ...
        public StoryEntry toEntry() {
            ...
            storyEntry.draftId = this.f2195id;
            storyEntry.isDraft = true;
