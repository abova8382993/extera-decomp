...
public abstract class RoundVideoRecorder extends FrameLayout {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        int measuredWidth = ((i3 - i) - this.cameraView.getMeasuredWidth()) - AndroidUtilities.m1124dp(16.0f);
        int iM1124dp = AndroidUtilities.m1124dp(72.0f);
        CameraView cameraView = this.cameraView;
        cameraView.layout(measuredWidth, iM1124dp, cameraView.getMeasuredWidth() + measuredWidth, this.cameraView.getMeasuredHeight() + iM1124dp);
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        this.shadowPaint.setShadowLayer(AndroidUtilities.m1124dp(2.0f), 0.0f, AndroidUtilities.m1124dp(0.66f), Theme.multAlpha(536870912, this.alpha));
        ...
        if (this.recordingStarted > 0) {
            ...
            this.progressPaint.setShadowLayer(AndroidUtilities.m1124dp(1.0f), 0.0f, AndroidUtilities.m1124dp(0.33f), Theme.multAlpha(536870912, this.alpha));
            rectF.inset(-AndroidUtilities.m1124dp(7.665f), -AndroidUtilities.m1124dp(7.665f));
