...
public class SliderView extends View {
    ...
    public SliderView(Context context, int i) {
        ...
        if (i == 0) {
            ...
            animatedTextDrawable3.setTextSize(AndroidUtilities.m1124dp(14.0f));
            ...
            if (i == 1) {
                animatedTextDrawable3.setText(LocaleController.getString(C2888R.string.FlashWarmth));
            } else if (i == 2) {
                animatedTextDrawable3.setText(LocaleController.getString(C2888R.string.FlashIntensity));
            } else if (i == 3) {
                animatedTextDrawable3.setText(LocaleController.getString(C2888R.string.WallpaperDimming));
            }
        }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        rectF.set(0.0f, 0.0f, this.f2229w, this.f2227h);
        ...
        canvas.saveLayerAlpha(0.0f, 0.0f, this.f2229w, this.f2227h, 255, 31);
        if (this.currentType == 0) {
            this.text.setBounds(AndroidUtilities.m1124dp(42.0f), -AndroidUtilities.m1124dp(1.0f), this.f2229w, this.f2227h - AndroidUtilities.m1124dp(1.0f));
            this.text.draw(canvas);
        } else {
            this.text2.setBounds(AndroidUtilities.m1124dp(12.33f), -AndroidUtilities.m1124dp(1.0f), (this.f2229w - ((int) this.text.getCurrentWidth())) - AndroidUtilities.m1124dp(6.0f), this.f2227h - AndroidUtilities.m1124dp(1.0f));
            this.text2.draw(canvas);
            this.text.setBounds(this.f2229w - AndroidUtilities.m1124dp(111.0f), -AndroidUtilities.m1124dp(1.0f), this.f2229w - AndroidUtilities.m1124dp(11.0f), this.f2227h - AndroidUtilities.m1124dp(1.0f));
            this.text.draw(canvas);
        }
        if (this.currentType == 0) {
        ...
        canvas.save();
        canvas.drawRect(0.0f, 0.0f, this.f2229w * f2, this.f2227h, this.whitePaint);
        canvas.restore();
        canvas.restore();
        canvas.restore();
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (motionEvent.getAction() == 1 && System.currentTimeMillis() - this.pressTime < ViewConfiguration.getTapTimeout()) {
                ...
                this.value = x / this.f2229w;
                this.valueIsAnimated = true;
            } else {
                this.value = Utilities.clamp(this.value + ((x - this.lastTouchX) / this.f2229w), 1.0f, 0.0f);
                this.valueIsAnimated = false;
                z = true;
            }
    ...
    protected void onMeasure(int i, int i2) {
        if (this.currentType == 3) {
            this.f2228r = AndroidUtilities.dpf2(8.0f);
        } else {
            this.f2228r = AndroidUtilities.dpf2(12.0f);
        }
        this.textPaint.setTextSize(AndroidUtilities.m1124dp(16.0f));
        this.text.setTextSize(AndroidUtilities.m1124dp(15.0f));
        int i3 = this.fixWidth;
        if (i3 > 0) {
            this.f2229w = i3;
            this.f2227h = AndroidUtilities.m1124dp(48.0f);
        } else if (this.currentType == 0) {
            this.f2229w = (int) Math.min(this.textPaint.measureText(LocaleController.getString(C2888R.string.StoryAudioRemove)) + AndroidUtilities.m1124dp(88.0f), View.MeasureSpec.getSize(i));
            this.f2227h = AndroidUtilities.m1124dp(48.0f);
        } else {
            this.f2229w = AndroidUtilities.m1124dp(190.0f);
            this.f2227h = AndroidUtilities.m1124dp(44.0f);
        }
        setMeasuredDimension(this.f2229w, this.f2227h);
        if (this.currentType == 0) {
            float fM1124dp = AndroidUtilities.m1124dp(25.0f);
            float f = this.f2227h / 2.0f;
            this.speaker1Paint.setPathEffect(new CornerPathEffect(AndroidUtilities.dpf2(1.33f)));
            this.speaker1Path.rewind();
            this.speaker1Path.moveTo(fM1124dp - AndroidUtilities.dpf2(8.66f), f - AndroidUtilities.dpf2(2.9f));
            this.speaker1Path.lineTo(fM1124dp - AndroidUtilities.dpf2(3.0f), f - AndroidUtilities.dpf2(2.9f));
            this.speaker1Path.lineTo(fM1124dp - AndroidUtilities.dpf2(3.0f), AndroidUtilities.dpf2(2.9f) + f);
            this.speaker1Path.lineTo(fM1124dp - AndroidUtilities.dpf2(8.66f), AndroidUtilities.dpf2(2.9f) + f);
            ...
            this.speaker2Path.moveTo(fM1124dp - AndroidUtilities.dpf2(7.5f), f);
            this.speaker2Path.lineTo(fM1124dp, f - AndroidUtilities.dpf2(7.33f));
            this.speaker2Path.lineTo(fM1124dp, AndroidUtilities.dpf2(7.33f) + f);
            this.speaker2Path.close();
            this.speakerWave1Path.rewind();
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set((fM1124dp - AndroidUtilities.dpf2(0.33f)) - AndroidUtilities.m1124dp(4.33f), f - AndroidUtilities.m1124dp(4.33f), (fM1124dp - AndroidUtilities.dpf2(0.33f)) + AndroidUtilities.m1124dp(4.33f), AndroidUtilities.m1124dp(4.33f) + f);
            ...
            this.speakerWave2Paint.setStrokeWidth(AndroidUtilities.m1124dp(2.0f));
            this.speakerWave2Path.rewind();
            rectF.set((fM1124dp - AndroidUtilities.dpf2(0.33f)) - AndroidUtilities.m1124dp(8.0f), f - AndroidUtilities.m1124dp(8.0f), (fM1124dp - AndroidUtilities.dpf2(0.33f)) + AndroidUtilities.m1124dp(8.0f), f + AndroidUtilities.m1124dp(8.0f));
