...
public class StoryUploadingService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void onDestroy() {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m1133d("upload story destroy");
        }
    }
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m1133d("start upload story");
        }
        if (this.builder == null) {
            ...
            this.builder.setTicker(LocaleController.getString(C2888R.string.StoryUploading));
            this.builder.setContentText(LocaleController.getString(C2888R.string.StoryUploading));
        }
