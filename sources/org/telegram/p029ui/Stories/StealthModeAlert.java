...
public class StealthModeAlert extends BottomSheet {
    ...
    public static /* synthetic */ void m18963$r8$lambda$8RCZlFLwVhO4hPcjt6fZFCu1jw() {
    }
    ...
    public StealthModeAlert(Context context, final float f, final int i, final Theme.ResourcesProvider resourcesProvider) {
            ...
            protected void onAttachedToWindow() {
                ...
                Bulletin.addDelegate(StealthModeAlert.this.container, new Bulletin.Delegate() { // from class: org.telegram.ui.Stories.StealthModeAlert.1.1
                    ...
                    public int getTopOffset(int i2) {
                        return (int) (f + AndroidUtilities.m1124dp(58.0f));
                    }
                });
            }
        ...
        imageView.setBackground(Theme.createCircleDrawable(AndroidUtilities.m1124dp(80.0f), Theme.getColor(Theme.key_featuredStickers_addButton)));
        imageView.setImageResource(C2888R.drawable.large_stealth);
        ...
        textView.setText(LocaleController.getString(C2888R.string.StealthModeTitle));
        ...
        if (UserConfig.getInstance(this.currentAccount).isPremium()) {
            simpleTextView.setText(LocaleController.getString(C2888R.string.StealthModeHint));
        } else {
            simpleTextView.setText(LocaleController.getString(C2888R.string.StealthModePremiumHint));
        }
        linearLayout.addView(simpleTextView, LayoutHelper.createLinear(-2, -2, 1, 36, 10, 36, 0));
        ItemCell itemCell = new ItemCell(getContext());
        itemCell.imageView.setImageResource(C2888R.drawable.msg_stealth_5min);
        itemCell.textView.setText(LocaleController.getString(C2888R.string.HideRecentViews));
        itemCell.description.setText(LocaleController.getString(C2888R.string.HideRecentViewsDescription));
        linearLayout.addView(itemCell, LayoutHelper.createLinear(-1, -2, 0, 0, 20, 0, 0));
        ItemCell itemCell2 = new ItemCell(getContext());
        itemCell2.imageView.setImageResource(C2888R.drawable.msg_stealth_25min);
        itemCell2.textView.setText(LocaleController.getString(C2888R.string.HideNextViews));
        itemCell2.description.setText(LocaleController.getString(C2888R.string.HideNextViewsDescription));
        linearLayout.addView(itemCell2, LayoutHelper.createLinear(-1, -2, 0, 0, 10, 0, 0));
        PremiumButtonView premiumButtonView = new PremiumButtonView(context, AndroidUtilities.m1124dp(8.0f), true, resourcesProvider);
        ...
        if (!currentUser.premium) {
            premiumButtonView.setIcon(C2888R.raw.unlock_icon);
            premiumButtonView.setButton(LocaleController.getString(C2888R.string.UnlockStealthMode), new View.OnClickListener() { // from class: org.telegram.ui.Stories.StealthModeAlert$$ExternalSyntheticLambda1
    ...
    public /* synthetic */ void lambda$new$3(TLRPC.User user, int i, Theme.ResourcesProvider resourcesProvider, View view) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_stories_activateStealthMode, new RequestDelegate() { // from class: org.telegram.ui.Stories.StealthModeAlert$$ExternalSyntheticLambda3
                ...
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Stories.StealthModeAlert$$ExternalSyntheticLambda4
                        @Override // java.lang.Runnable
                        public final void run() {
                            StealthModeAlert.m18963$r8$lambda$8RCZlFLwVhO4hPcjt6fZFCu1jw();
                        }
                    });
                }
            });
        ...
        BulletinFactory bulletinFactoryM1245of = BulletinFactory.m1245of(this.container, resourcesProvider);
        if (bulletinFactoryM1245of != null) {
            bulletinFactoryM1245of.createErrorBulletin(AndroidUtilities.replaceTags(LocaleController.getString(C2888R.string.StealthModeCooldownHint))).show(true);
        }
    }
    ...
    public static void showStealthModeEnabledBulletin() {
        ...
        if (lastFragment.getLastStoryViewer() != null) {
            bulletinFactoryGlobal = BulletinFactory.m1245of(lastFragment.getLastStoryViewer().windowView, lastFragment.getLastStoryViewer().getResourceProvider());
        } else {
            bulletinFactoryGlobal = BulletinFactory.global();
        }
        if (bulletinFactoryGlobal != null) {
            bulletinFactoryGlobal.createSimpleLargeBulletin(C2888R.drawable.msg_stories_stealth2, LocaleController.getString(C2888R.string.StealthModeOn), LocaleController.getString(C2888R.string.StealthModeOnHint)).show();
        }
    }
    ...
    private void updateButton(boolean z) {
        ...
        if (stealthMode != null && ConnectionsManager.getInstance(this.currentAccount).getCurrentTime() < stealthMode.active_until_date) {
            ...
            this.button.setOverlayText(LocaleController.getString(C2888R.string.StealthModeIsActive), true, z);
        ...
        if (stealthMode != null) {
            ...
            if (currentTime <= i) {
                ...
                this.button.setOverlayText(LocaleController.formatString("AvailableIn", C2888R.string.AvailableIn, sb.toString()), true, z);
        ...
        int i3 = this.type;
        if (i3 == 0) {
            this.button.setOverlayText(LocaleController.getString(C2888R.string.EnableStealthMode), true, z);
        } else if (i3 == 1) {
            this.button.setOverlayText(LocaleController.getString(C2888R.string.EnableStealthModeAndOpenStory), true, z);
        }
        this.button.overlayTextView.setTextColor(Theme.getColor(Theme.key_featuredStickers_buttonText));
    }
