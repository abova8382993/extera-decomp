...
import org.telegram.p029ui.Stories.ProfileStoriesView;
...
public class ProfileStoriesView extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    class StoryCircle {
        ...
        public StoryCircle(TL_stories.StoryItem storyItem) {
            ...
            this.imageReceiver.setRoundRadius(AndroidUtilities.m1124dp(200.0f));
  ...
  0x0192: PHI (r9v18 org.telegram.tgnet.tl.TL_stories$StoryItem) = (r9v17 org.telegram.tgnet.tl.TL_stories$StoryItem), (r9v20 org.telegram.tgnet.tl.TL_stories$StoryItem) binds: [B:84:0x013f, B:105:0x018f] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public void updateStories(boolean r21, boolean r22) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Stories.ProfileStoriesView.updateStories(boolean, boolean):void");
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
                ...
                if (i3 > 0 && ((StoryCircle) profileStoriesView3.circles.get(i3 - 1)).cachedIndex > storyCircle.cachedIndex) {
                    Collections.sort(profileStoriesView3.circles, new Comparator() { // from class: org.telegram.ui.Stories.ProfileStoriesView$$ExternalSyntheticLambda0
                        ...
                        public final int compare(Object obj, Object obj2) {
                            return ProfileStoriesView.m18920$r8$lambda$JQNPIPP51ie698WIdXQXlPmQs((ProfileStoriesView.StoryCircle) obj, (ProfileStoriesView.StoryCircle) obj2);
                        }
                    });
                    break;
                }
        ...
        if (fLerp2 < 1.0f) {
            ...
            if (zIsLastUploadingFailed) {
                ...
                errorPaint.setStrokeWidth(AndroidUtilities.m1124dp(f));
                ...
                if (i7 != 0) {
                    ...
                    rectF4.inset(-AndroidUtilities.m1124dp(12.0f), -AndroidUtilities.m1124dp(12.0f));
                    ...
                    rectF4.set(profileStoriesView3.rect3);
                    rectF4.inset(-AndroidUtilities.m1124dp(3.0f), -AndroidUtilities.m1124dp(3.0f));
        ...
        if (profileStoriesView3.expandProgress <= f3 || fClamp >= 1.0f) {
            ...
            profileStoriesView3.f2181w = f3;
            for (int i9 = 0; i9 < profileStoriesView3.circles.size(); i9++) {
                profileStoriesView3.f2181w += AndroidUtilities.m1124dp(14.0f) * ((StoryCircle) profileStoriesView3.circles.get(i9)).cachedScale;
            }
            float fM1124dp = 0.0f;
            for (int i10 = 0; i10 < profileStoriesView3.circles.size(); i10++) {
                ...
                float fM1124dp2 = (AndroidUtilities.m1124dp(28.0f) / f) * f20;
                float f22 = profileStoriesView3.left + fM1124dp2 + fM1124dp;
                fM1124dp += AndroidUtilities.m1124dp(18.0f) * f20;
                float f23 = f22 + fM1124dp2;
                fMax = Math.max(fMax, f23);
                profileStoriesView3.rect2.set(f22 - fM1124dp2, f2 - fM1124dp2, f23, f2 + fM1124dp2);
        ...
        if (fMax3 > 0.0f) {
            float fLerp6 = AndroidUtilities.lerp(profileStoriesView.rect1.right + AndroidUtilities.m1124dp(16.0f), fMax + AndroidUtilities.m1124dp(f4), profileStoriesView.expandProgress);
            float fLerp7 = AndroidUtilities.lerp(profileStoriesView.getWidth(), f8, profileStoriesView.expandProgress);
            float fLerp8 = AndroidUtilities.lerp(profileStoriesView.rect1.centerY(), profileStoriesView.f2180cy, profileStoriesView.expandProgress);
            profileStoriesView.titleDrawable.setBounds((int) fLerp6, (int) (fLerp8 - AndroidUtilities.m1124dp(18.0f)), (int) fLerp7, (int) (fLerp8 + AndroidUtilities.m1124dp(18.0f)));
    ...
    public static /* synthetic */ int m18920$r8$lambda$JQNPIPP51ie698WIdXQXlPmQs(StoryCircle storyCircle, StoryCircle storyCircle2) {
    ...
    private void drawArc(Canvas canvas, RectF rectF, float f, float f2, boolean z, Paint paint) {
        ...
        if (zIsForum || (ExteraConfig.avatarCorners != 28.0f && this.expandProgress < 0.2f)) {
            float avatarCorners = ExteraConfig.getAvatarCorners(rectF.height() + AndroidUtilities.m1124dp(4.0f), true, zIsForum);
    ...
    public void setBounds(float f, float f2, float f3, boolean z) {
        boolean z2 = Math.abs(f - this.left) > 0.1f || Math.abs(f2 - this.right) > 0.1f || Math.abs(f3 - this.f2180cy) > 0.1f;
        this.left = f;
        this.right = f2;
        if (!z) {
    ...
    class C69133 implements StoryViewer.PlaceProvider {
    ...
    private float getExpandRight() {
        return this.expandRight - (this.expandRightPadAnimated.set(this.expandRightPad) * AndroidUtilities.m1124dp(71.0f));
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.expandProgress < 0.9f) {
            ...
            zContains = motionEvent.getX() >= this.left && motionEvent.getX() <= this.right && Math.abs(motionEvent.getY() - this.f2180cy) < ((float) AndroidUtilities.m1124dp(32.0f));
        }
