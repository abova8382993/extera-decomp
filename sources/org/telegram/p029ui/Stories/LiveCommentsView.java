...
public abstract class LiveCommentsView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public LiveCommentsView(Context context, final StoryViewer storyViewer, final ViewGroup viewGroup, View view, FrameLayout frameLayout) {
        ...
        view.setAlpha(0.5f);
        C68391 c68391 = new RecyclerListView(context) { // from class: org.telegram.ui.Stories.LiveCommentsView.1
            C68391(Context context2) {
                super(context2);
            }
                ...
                for (int i2 = 0; i2 < getChildCount(); i2++) {
                    ...
                    if (childAt instanceof LiveCommentView) {
                        ...
                        if (liveCommentView.message != null) {
                            return liveCommentView.message.f2178id;
                        }
                    }
                }
                return -1;
        ...
        this.listView = c68391;
        c68391.setWillNotDraw(false);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(context2, 1, true);
        this.layoutManager = linearLayoutManager;
        c68391.setLayoutManager(linearLayoutManager);
        C68402 c68402 = new UniversalAdapter(c68391, context2, i, 0, false, new Utilities.Callback2() { // from class: org.telegram.ui.Stories.LiveCommentsView$$ExternalSyntheticLambda4
            @Override // org.telegram.messenger.Utilities.Callback2
            public final void run(Object obj, Object obj2) {
                this.f$0.fillItems((ArrayList) obj, (UniversalAdapter) obj2);
            }
        }, new DarkThemeResourceProvider()) { // from class: org.telegram.ui.Stories.LiveCommentsView.2
            C68402(RecyclerListView c683912, Context context2, int i2, int i3, boolean z, Utilities.Callback2 callback2, Theme.ResourcesProvider resourcesProvider) {
                super(c683912, context2, i2, i3, z, callback2, resourcesProvider);
            }
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
                ...
                if (LiveCommentsView.this.callHighlight) {
                    ...
                    if (view2 instanceof LiveCommentView) {
                        ...
                        if (liveCommentView.message == null || liveCommentView.message.f2178id != LiveCommentsView.this.highlightingMessageId) {
                            return;
                        }
        ...
        this.adapter = c68402;
        c683912.setAdapter(c68402);
        c68402.setApplyBackground(false);
        c683912.setPadding(AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(7.5f), AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(7.5f));
        c683912.setClipToPadding(false);
        addView(c683912, LayoutHelper.createFrame(-1, -1.0f, 87, 0.0f, 0.0f, 0.0f, 34.0f));
        c683912.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.telegram.ui.Stories.LiveCommentsView$$ExternalSyntheticLambda5
            @Override // org.telegram.ui.Components.RecyclerListView.OnItemClickListener
            public final void onItemClick(View view2, int i2) {
                this.f$0.lambda$new$5(viewGroup, storyViewer, view2, i2);
            }
        });
        C68413 c68413 = new DefaultItemAnimator() { // from class: org.telegram.ui.Stories.LiveCommentsView.3
        ...
        c68413.setSupportsChangeAnimations(false);
        c68413.setDelayAnimations(false);
        CubicBezierInterpolator cubicBezierInterpolator = CubicBezierInterpolator.EASE_OUT_QUINT;
        c68413.setInterpolator(cubicBezierInterpolator);
        c68413.setDurations(280L);
        c68413.setDelayIncrement(14L);
        c683912.setItemAnimator(c68413);
        ...
        C68424 c68424 = new RecyclerListView(context2) { // from class: org.telegram.ui.Stories.LiveCommentsView.4
            C68424(Context context2) {
                super(context2);
            }
        ...
        this.topListView = c68424;
        c68424.setWillNotDraw(false);
        ...
        c68424.setLayoutManager(linearLayoutManager2);
        UniversalAdapter universalAdapter = new UniversalAdapter(c68424, context2, i2, 0, new Utilities.Callback2() { // from class: org.telegram.ui.Stories.LiveCommentsView$$ExternalSyntheticLambda7
            @Override // org.telegram.messenger.Utilities.Callback2
            public final void run(Object obj, Object obj2) {
        ...
        c68424.setAdapter(universalAdapter);
        universalAdapter.setApplyBackground(false);
        c68424.setPadding(AndroidUtilities.m1124dp(8.0f), 0, AndroidUtilities.m1124dp(8.0f), 0);
        c68424.setClipToPadding(false);
        addView(c68424, LayoutHelper.createFrame(-1, 26.0f, 87, 0.0f, 0.0f, 0.0f, 9.66f));
        c68424.setOnItemClickListener(new RecyclerListView.OnItemClickListenerExtended() { // from class: org.telegram.ui.Stories.LiveCommentsView$$ExternalSyntheticLambda8
        ...
        C68435 c68435 = new DefaultItemAnimator() { // from class: org.telegram.ui.Stories.LiveCommentsView.5
            @Override // androidx.recyclerview.widget.DefaultItemAnimator
            protected float animateByScale(View view2) {
                return 0.5f;
            }
        ...
        c68435.setSupportsChangeAnimations(false);
        c68435.setDelayAnimations(false);
        c68435.setInterpolator(cubicBezierInterpolator);
        c68435.setDurations(350L);
        c68424.setItemAnimator(c68435);
        updateTopMessages(false);
    }

    /* JADX INFO: renamed from: org.telegram.ui.Stories.LiveCommentsView$1 */
    class C68391 extends RecyclerListView {
        C68391(Context context2) {
            super(context2);
        }
    ...
    class C68402 extends UniversalAdapter {
        C68402(RecyclerListView c683912, Context context2, int i2, int i3, boolean z, Utilities.Callback2 callback2, Theme.ResourcesProvider resourcesProvider) {
            super(c683912, context2, i2, i3, z, callback2, resourcesProvider);
        }
    ...
    public /* synthetic */ void lambda$new$5(ViewGroup viewGroup, final StoryViewer storyViewer, View view, int i) {
        ...
        boolean z = true;
        itemOptionsMakeOptions.addText(LocaleController.formatString(C2888R.string.LiveStoryMessageSent, LocaleController.formatDateTime(message.date, true)), 15);
        itemOptionsMakeOptions.addGap();
        itemOptionsMakeOptions.add(C2888R.drawable.msg_openprofile, LocaleController.getString(C2888R.string.OpenProfile), new Runnable() { // from class: org.telegram.ui.Stories.LiveCommentsView$$ExternalSyntheticLambda13
            @Override // java.lang.Runnable
            public final void run() {
                storyViewer.presentFragment(ProfileActivity.m1294of(message.dialogId));
            }
        });
        itemOptionsMakeOptions.addIf(!message.isReaction, C2888R.drawable.msg_copy, LocaleController.getString(C2888R.string.Copy), new Runnable() { // from class: org.telegram.ui.Stories.LiveCommentsView$$ExternalSyntheticLambda14
            @Override // java.lang.Runnable
            public final void run() {
        ...
        itemOptionsMakeOptions.addIf(z, C2888R.drawable.msg_delete, LocaleController.getString(C2888R.string.Delete), new Runnable() { // from class: org.telegram.ui.Stories.LiveCommentsView$$ExternalSyntheticLambda15
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$new$2(LiveCommentView liveCommentView) {
        ...
        if (AndroidUtilities.shouldShowClipboardToast()) {
            Toast.makeText(getContext(), LocaleController.getString(C2888R.string.TextCopied), 0).show();
        }
    }
    ...
    class C68413 extends DefaultItemAnimator {
        @Override // androidx.recyclerview.widget.DefaultItemAnimator
        protected float animateByScale(View view2) {
            return 0.5f;
        }
    ...
    class C68424 extends RecyclerListView {
        C68424(Context context2) {
            super(context2);
        }
    ...
    */
    public /* synthetic */ void lambda$new$7(android.view.View r10, int r11, float r12, float r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Stories.LiveCommentsView.lambda$new$7(android.view.View, int, float, float):void");
    }

    /* JADX INFO: renamed from: org.telegram.ui.Stories.LiveCommentsView$5 */
    class C68435 extends DefaultItemAnimator {
        @Override // androidx.recyclerview.widget.DefaultItemAnimator
        protected float animateByScale(View view2) {
            return 0.5f;
        }
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        for (int i = 0; i < this.messages.size(); i++) {
            ...
            if (message.fromAdmin || !message.isReaction || message.stars >= sendPaidMessagesStars) {
                arrayList.add(LiveCommentView.Factory.m1317of(message));
            }
        }
    }
    ...
    public void fillTopItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        for (int i = 0; i < this.topMessages.size(); i++) {
            arrayList.add(LiveTopSenderView.Factory.m1318of((TopSender) this.topMessages.get(i)));
        }
    }
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        ...
        rectF.set(0.0f, y, getWidth(), AndroidUtilities.m1124dp(12.0f) + y);
        this.gradientClip.draw(canvas, rectF, 1, 1.0f);
        rectF.set(0.0f, (this.listView.getY() + this.listView.getHeight()) - AndroidUtilities.m1124dp(12.0f), getWidth(), this.listView.getBottom() + this.listView.getHeight());
    ...
    private void updateTopMessages(boolean z) {
        ...
        if (z) {
            ViewPropertyAnimator viewPropertyAnimatorTranslationY = this.listView.animate().translationY(this.hasTopMessages ? 0.0f : AndroidUtilities.m1124dp(35.0f));
            CubicBezierInterpolator cubicBezierInterpolator = CubicBezierInterpolator.EASE_OUT_QUINT;
            ...
            this.topListView.animate().translationY(this.hasTopMessages ? 0.0f : AndroidUtilities.m1124dp(35.0f)).alpha(this.hasTopMessages ? 1.0f : 0.0f).setInterpolator(cubicBezierInterpolator).setDuration(420L).start();
            return;
        }
        this.listView.setTranslationY(!zIsEmpty ? 0.0f : AndroidUtilities.m1124dp(35.0f));
        this.topListView.setTranslationY(this.hasTopMessages ? 0.0f : AndroidUtilities.m1124dp(35.0f));
    ...
    public void setKeyboardOffset(float f, float f2, float f3) {
        ...
        if (Math.abs(this.keyboardFinalOffset - f3) > 0.1f) {
            ...
            this.listView.setPadding(AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(7.5f) + Math.max(0, ((int) f3) - this.listView.getTop()), AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(7.5f));
            if (!this.listView.canScrollVertically(1)) {
                this.layoutManager.scrollToPositionWithOffset(0, AndroidUtilities.m1124dp(100.0f));
            }
        }
    ...
    public boolean setup(long j, TLRPC.InputGroupCall inputGroupCall) {
        ...
        if ((inputGroupCall2 == null ? 0L : inputGroupCall2.f1682id) != (inputGroupCall != null ? inputGroupCall.f1682id : 0L)) {
            clear();
            z = true;
        } else {
            z = false;
    ...
    public /* synthetic */ void lambda$pollStars$10(TL_phone.getGroupCallStars getgroupcallstars, TL_phone.groupCallStars groupcallstars, TLRPC.TL_error tL_error) {
        ...
        if (inputGroupCall == null || inputGroupCall.f1682id != getgroupcallstars.call.f1682id) {
            return;
        }
        if (groupcallstars != null) {
            ...
            while (true) {
                ...
                if (!groupcallstars.top_donors.get(i).f1845my) {
                    i++;
    ...
    public LiveCommentView findComment(int i) {
        for (int i2 = 0; i2 < this.listView.getChildCount(); i2++) {
            ...
            if (childAt instanceof LiveCommentView) {
                LiveCommentView liveCommentView = (LiveCommentView) childAt;
                if (liveCommentView.message != null && liveCommentView.message.f2178id == i) {
    ...
    public void sendStars(long j, boolean z) {
        ...
        if (bulletin == null || !bulletin.isShowing()) {
            ...
            Bulletin bulletinCreate = BulletinFactory.m1245of(this.topBulletinContainer, darkThemeResourceProvider).create(this.bulletinLayout, -1);
    ...
    private int getTotalMyStars() {
        ...
        for (int i2 = 0; i2 < this.topDonors.size(); i2++) {
            if (((TL_phone.groupCallDonor) this.topDonors.get(i2)).f1845my) {
    ...
    public void openStarsSheet(boolean z) {
        ...
        if (this.topDonors != null) {
            for (int i = 0; i < this.topDonors.size(); i++) {
                ...
                tL_messageReactor.f1688my = groupcalldonor.f1845my;
    ...
    class C68446 extends DarkThemeResourceProvider {
        C68446() {
        }
    ...
    public /* synthetic */ Integer lambda$openStarsSheet$11(Long l, Long l2) {
        ...
        Bulletin bulletinCreateSimpleBulletin = BulletinFactory.m1245of(this.topBulletinContainer, new DarkThemeResourceProvider()).createSimpleBulletin(C2888R.raw.stars_topup, getStarsToastTitle(), getStarsToastSubtitle());
        boolean z = false;
    ...
    private String getStarsToastTitle() {
        return LocaleController.getString(C2888R.string.StarsSentTitle);
    }
    ...
    class C68457 extends AnimatorListenerAdapter {
        final /* synthetic */ boolean val$collapsed;
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        if (i == NotificationCenter.liveStoryMessageUpdate) {
            ...
            if (tLObject instanceof TLRPC.TL_updateGroupCallMessage) {
                ...
                TLRPC.InputGroupCall inputGroupCall2 = this.inputCall;
                if (inputGroupCall2 == null || inputGroupCall2.f1682id != jLongValue) {
                    return;
                }
    ...
    public void delete(int i) {
        ...
        while (true) {
            if (i2 >= this.messages.size()) {
                ...
                if (((Message) this.messages.get(i2)).f2178id == i) {
        ...
        if (message.f2178id < 0 && message.isReaction) {
            long j = message.stars;
            if (j > 0) {
                this.totalStars -= j;
                onStarsCountUpdated();
    ...
    public boolean isAdmin() {
        ...
        LivePlayer livePlayer = this.livePlayer;
        if (livePlayer == null || (inputGroupCall = this.inputCall) == null || inputGroupCall.f1682id != livePlayer.getCallId() || !this.livePlayer.isCreator()) {
    ...
    public /* synthetic */ void lambda$send$16(TL_phone.sendGroupCallMessage sendgroupcallmessage, final int i, final long j, final long j2, final TLRPC.TL_textWithEntities tL_textWithEntities, TLObject tLObject, final TLRPC.TL_error tL_error) {
        ...
        while (i2 < size) {
            ...
            if (sendgroupcallmessage.random_id == tL_updateMessageID.random_id) {
                updateMessageId(i, tL_updateMessageID.f1814id);
            }
        }
    ...
    public /* synthetic */ void lambda$send$15(int i, TLRPC.TL_error tL_error, final long j, final long j2, final TLRPC.TL_textWithEntities tL_textWithEntities) {
        ...
        BulletinFactory.m1245of(this.topBulletinContainer, new DarkThemeResourceProvider()).showForError(tL_error, true);
    }
    ...
    public void push(int i, int i2, boolean z, long j, TLRPC.TL_textWithEntities tL_textWithEntities, long j2, boolean z2) {
        ...
        for (int i4 = 0; i4 < this.messages.size(); i4++) {
            if (((Message) this.messages.get(i4)).f2178id == i2) {
                return;
            }
        }
        int currentTime = ConnectionsManager.getInstance(this.currentAccount).getCurrentTime();
        ...
        if (message.f2178id >= 0) {
            for (int size = this.messages.size() - 1; size >= 0; size--) {
                if (message.f2178id < ((Message) this.messages.get(size)).f2178id) {
                    i3 = size + 1;
                    break;
                }
            }
        ...
        if (i3 <= 0 && !z2 && (!this.listView.canScrollVertically(1) || message.f2178id < 0)) {
            this.layoutManager.scrollToPositionWithOffset(0, AndroidUtilities.m1124dp(100.0f));
            int i6 = message.f2178id;
            if (i6 > 0) {
                this.maxReadId = i6;
            }
        }
        ...
        if (!z2 && i2 > 0 && message.stars > 0) {
            ...
            if (groupcalldonor == null) {
                ...
                groupcalldonor.f1845my = UserConfig.getInstance(this.currentAccount).getClientUserId() == message.dialogId;
    ...
    private void updateMessagesPlaces() {
        ...
        Collections.sort(arrayList, new Comparator() { // from class: org.telegram.ui.Stories.LiveCommentsView$$ExternalSyntheticLambda11
            ...
            public final int compare(Object obj, Object obj2) {
                return LiveCommentsView.m18630$r8$lambda$y3Wo3CjgU70cCc3MVU1TZwWVTU((TL_phone.groupCallDonor) obj, (TL_phone.groupCallDonor) obj2);
            }
        });
        int size = arrayList.size();
    ...
    public static /* synthetic */ int m18630$r8$lambda$y3Wo3CjgU70cCc3MVU1TZwWVTU(TL_phone.groupCallDonor groupcalldonor, TL_phone.groupCallDonor groupcalldonor2) {
    ...
    public static class LiveCommentView extends FrameLayout implements ItemOptions.ScrimView {
        ...
        public LiveCommentView(Context context, int i, boolean z) {
            ...
            this.currentAccount = i;
            this.filled = z;
            C68471 c68471 = new LinearLayout(context) { // from class: org.telegram.ui.Stories.LiveCommentsView.LiveCommentView.1
                Path clipPath = new Path();
                StarsReactionsSheet.Particles particles;

                C68471(Context context2) {
                    super(context2);
                ...
                protected void dispatchDraw(Canvas canvas) {
                    if (LiveCommentView.this.drawParticles) {
                        ...
                        this.clipPath.addRoundRect(rectF, AndroidUtilities.m1124dp(13.0f), AndroidUtilities.m1124dp(13.0f), Path.Direction.CW);
                        canvas.save();
            ...
            this.layout = c68471;
            c68471.setOrientation(0);
            addView(c68471, LayoutHelper.createFrame(-2, -2.0f, 51, 0.0f, 0.5f, 0.0f, 0.5f));
            this.avatarDrawable = new AvatarDrawable();
            BackupImageView backupImageView = new BackupImageView(context2);
            this.avatarView = backupImageView;
            backupImageView.setRoundRadius(AndroidUtilities.m1124dp(11.0f));
            c68471.addView(backupImageView, LayoutHelper.createLinear(22, 22, 0.0f, 51, 3, 2, 3, 2));
            LinearLayout linearLayout = new LinearLayout(context2);
            this.textLayout = linearLayout;
            linearLayout.setOrientation(1);
            c68471.addView(linearLayout, LayoutHelper.createLinear(-2, -2, 1.0f, 51, 4, 3, 7, 3));
            ...
            spoilersTextView3.setShadowLayer(AndroidUtilities.m1124dp(2.5f), 0.0f, AndroidUtilities.m1124dp(1.5f), Theme.multAlpha(-16777216, 0.6f));
            ...
            textView.setPadding(AndroidUtilities.m1124dp(4.66f), 0, AndroidUtilities.m1124dp(4.66f), 0);
            textView.setVisibility(8);
            c68471.addView(textView, LayoutHelper.createLinear(-2, 16, 0.0f, 21, -3, 0, 6, 0));
            ...
            c68471.addView(textView2, LayoutHelper.createLinear(-2, -2, 0.0f, 85, 0, 3, 10, 0));
        }

        /* JADX INFO: renamed from: org.telegram.ui.Stories.LiveCommentsView$LiveCommentView$1 */
        class C68471 extends LinearLayout {
            Path clipPath = new Path();
            StarsReactionsSheet.Particles particles;
        ...
        public void highlight() {
            ...
            this.highlightingMessageId = message.f2178id;
            ...
            this.highlightAnimator.addListener(new C68482());
        ...
        class C68482 extends AnimatorListenerAdapter {
            C68482() {
            }

            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
                if (LiveCommentView.this.message == null || LiveCommentView.this.highlightingMessageId != LiveCommentView.this.message.f2178id) {
                    return;
                }
        ...
        */
        ...
        public static /* synthetic */ int m18636$r8$lambda$F7X9DwFaQsZa6QS3jF4kyw0G_o(Pair pair, Pair pair2) {
            return ((Integer) pair.first).intValue() - ((Integer) pair2.first).intValue();
        }

        /* JADX INFO: renamed from: org.telegram.ui.Stories.LiveCommentsView$LiveCommentView$3 */
        class C68493 extends ReplacementSpan {
            private final RectF rect = new RectF();

            /* JADX INFO: renamed from: bg */
            private final Paint f2177bg = new Paint(1);
            private final Text text = new Text(LocaleController.getString(C2888R.string.LiveStoryBadge), 8.0f, AndroidUtilities.bold());
            ...
            public int getSize(Paint paint, CharSequence charSequence, int i, int i2, Paint.FontMetricsInt fontMetricsInt) {
                return (int) (this.text.getWidth() + AndroidUtilities.m1124dp(8.0f));
            }

            @Override // android.text.style.ReplacementSpan
            public void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
                float fM1124dp = ((i3 + i5) / 2.0f) + AndroidUtilities.m1124dp(0.0f);
                this.rect.set(f, fM1124dp - AndroidUtilities.m1124dp(6.0f), this.text.getWidth() + f + AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(6.0f) + fM1124dp);
                this.f2177bg.setColor(-572850);
                RectF rectF = this.rect;
                canvas.drawRoundRect(rectF, rectF.height() / 2.0f, this.rect.height() / 2.0f, this.f2177bg);
                this.text.draw(canvas, AndroidUtilities.m1124dp(4.0f) + f, fM1124dp, -1, 1.0f);
            }
        }
        ...
        public static class Factory extends UItem.UItemFactory {
            ...
            public static UItem m1317of(Message message) {
    ...
    public static class LiveTopSenderView extends FrameLayout {
        ...
        public LiveTopSenderView(Context context) {
            ...
            C68501 c68501 = new LinearLayout(context) { // from class: org.telegram.ui.Stories.LiveCommentsView.LiveTopSenderView.1
                StarsReactionsSheet.Particles particles;
            ...
            this.layout = c68501;
            c68501.setOrientation(0);
            addView(c68501, LayoutHelper.createFrame(-2, -2.0f, 119, 0.0f, 0.0f, 6.0f, 0.0f));
            this.avatarDrawable = new AvatarDrawable();
            BackupImageView backupImageView = new BackupImageView(context2);
            this.avatarView = backupImageView;
            backupImageView.setRoundRadius(AndroidUtilities.m1124dp(11.0f));
            c68501.addView(backupImageView, LayoutHelper.createLinear(22, 22, 0.0f, 51, 3, 2, 7, 2));
            ImageView imageView = new ImageView(context2);
            this.crownView = imageView;
            imageView.setVisibility(8);
            c68501.addView(imageView, LayoutHelper.createLinear(18, 18, 19, 0, 0, 3, 0));
            C68512 c68512 = new TextView(context2) { // from class: org.telegram.ui.Stories.LiveCommentsView.LiveTopSenderView.2
                private int width = -1;
                private final GradientClip clip = new GradientClip();

                C68512(Context context2) {
                    super(context2);
                    this.width = -1;
                ...
                protected void onMeasure(int i, int i2) {
                    super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(100.0f), Integer.MIN_VALUE), i2);
                }
                ...
                protected void onDraw(Canvas canvas) {
                    ...
                    if (this.width > AndroidUtilities.m1124dp(100.0f)) {
                        canvas.saveLayerAlpha(0.0f, 0.0f, getWidth(), getHeight(), 255, 31);
                        super.onDraw(canvas);
                        canvas.save();
                        RectF rectF = AndroidUtilities.rectTmp;
                        rectF.set(getWidth() - AndroidUtilities.m1124dp(15.0f), 0.0f, getWidth(), getHeight());
            ...
            this.textView = c68512;
            c68512.setLines(1);
            c68512.setSingleLine();
            c68512.setTextColor(-1);
            c68512.setTextSize(1, 14.0f);
            c68512.setTypeface(AndroidUtilities.bold());
            c68501.addView(c68512, LayoutHelper.createLinear(-2, -2, 16, 0, 0, 7, 0));
        }

        /* JADX INFO: renamed from: org.telegram.ui.Stories.LiveCommentsView$LiveTopSenderView$1 */
        class C68501 extends LinearLayout {
            StarsReactionsSheet.Particles particles;
            final Path clipPath = new Path();
            final Paint fillPaint = new Paint(1);
            long lastDialogId = 0;
        ...
        public static class Factory extends UItem.UItemFactory {
            ...
            /* JADX INFO: renamed from: of */
            public static UItem m1318of(TopSender topSender) {
                UItem uItemOfFactory = UItem.ofFactory(Factory.class);
    ...
    public static class CrownDrawable extends Drawable {
        ...
        public CrownDrawable(Context context, int i) {
            this.crown = context.getResources().getDrawable(C2888R.drawable.filled_stream_crown).mutate();
        ...
        public void draw(Canvas canvas) {
            ...
            this.text.draw(canvas, bounds.centerX() - (this.text.getCurrentWidth() / 2.0f), bounds.centerY() + AndroidUtilities.m1124dp(0.15f), -1, this.crown.getAlpha() / 255.0f);
            canvas.restore();
        }
    ...
    class C68468 extends DarkThemeResourceProvider {
        C68468() {
        }
    ...
    public static void openDeleteMessage(Context context, long j, final Utilities.Callback3 callback3) {
        C68468 c68468 = new DarkThemeResourceProvider() { // from class: org.telegram.ui.Stories.LiveCommentsView.8
            C68468() {
            }
        ...
        final BottomSheet bottomSheet = new BottomSheet(context, false, c68468);
        bottomSheet.fixNavigationBar();
        LinearLayout linearLayout = new LinearLayout(context);
        linearLayout.setOrientation(1);
        TextView textView = new TextView(context);
        textView.setTextSize(1, 20.0f);
        textView.setTextColor(Theme.getColor(Theme.key_dialogTextBlack, c68468));
        textView.setTypeface(AndroidUtilities.bold());
        textView.setText(LocaleController.getString(C2888R.string.DeleteSingleMessagesTitle));
        linearLayout.addView(textView, LayoutHelper.createLinear(-1, -2, 22.0f, 12.0f, 22.0f, 0.0f));
        HeaderCell headerCell = new HeaderCell(context, c68468);
        headerCell.setText(LocaleController.getString(C2888R.string.DeleteAdditionalActions));
        linearLayout.addView(headerCell, LayoutHelper.createLinear(-1, -2, 0.0f, 0.0f, 0.0f, 4.0f));
        final CheckBoxCell checkBoxCell = new CheckBoxCell(context, 4, 21, true, c68468);
        ...
        checkBoxCell.setText(LocaleController.getString(C2888R.string.DeleteReportSpam), null, false, true);
        ...
        checkBoxCell.setBackground(Theme.createSelectorDrawable(Theme.getColor(i4, c68468), 2));
        linearLayout.addView(checkBoxCell, LayoutHelper.createLinear(-1, -2));
        final CheckBoxCell checkBoxCell2 = new CheckBoxCell(context, 4, 21, true, c68468);
        checkBoxCell2.getCheckBoxRound().setColor(i, i2, i3);
        checkBoxCell2.setText(LocaleController.formatString(C2888R.string.DeleteAllFrom, DialogObject.getName(j)), null, false, true);
        ...
        checkBoxCell2.setBackground(Theme.createSelectorDrawable(Theme.getColor(i4, c68468), 2));
        linearLayout.addView(checkBoxCell2, LayoutHelper.createLinear(-1, -2));
        final CheckBoxCell checkBoxCell3 = new CheckBoxCell(context, 4, 21, true, c68468);
        checkBoxCell3.getCheckBoxRound().setColor(i, i2, i3);
        checkBoxCell3.setText(LocaleController.formatString(C2888R.string.DeleteBan, DialogObject.getName(j)), null, false, false);
        ...
        checkBoxCell3.setBackground(Theme.createSelectorDrawable(Theme.getColor(i4, c68468), 2));
        linearLayout.addView(checkBoxCell3, LayoutHelper.createLinear(-1, -2));
        TextInfoPrivacyCell textInfoPrivacyCell = new TextInfoPrivacyCell(context, c68468);
        ...
        ButtonWithCounterView buttonWithCounterView = new ButtonWithCounterView(context, c68468);
        buttonWithCounterView.setText(LocaleController.getString(C2888R.string.DeleteProceedBtn), false);
