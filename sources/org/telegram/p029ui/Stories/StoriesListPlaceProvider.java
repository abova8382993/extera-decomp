...
public class StoriesListPlaceProvider implements StoryViewer.PlaceProvider {
    ...
    public static StoriesListPlaceProvider m1320of(RecyclerListView recyclerListView) {
        return m1321of(recyclerListView, false);
    }

    /* JADX INFO: renamed from: of */
    public static StoriesListPlaceProvider m1321of(RecyclerListView recyclerListView, boolean z) {
        return new StoriesListPlaceProvider(recyclerListView, z);
    }

    /* JADX INFO: renamed from: of */
    public static StoriesListPlaceProvider m1319of(ProfileChannelCell profileChannelCell) {
    ...
    public static /* synthetic */ void $r8$lambda$dVvQM61LLLmGehYO5ae62iOJhMA(Path path, Canvas canvas, RectF rectF, float f, boolean z) {
        ...
        path.addCircle((rectF.right + AndroidUtilities.m1124dp(7.0f)) - (AndroidUtilities.m1124dp(14.0f) * fPow), (rectF.bottom + AndroidUtilities.m1124dp(7.0f)) - (AndroidUtilities.m1124dp(14.0f) * fPow), AndroidUtilities.m1124dp(11.0f), Path.Direction.CW);
