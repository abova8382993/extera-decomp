...
public class StoryWidgetsImageDecorator extends ImageReceiver.Decorator {
    ...
    public class ReactionWidget extends DrawingObject {
        ...
        public void draw(Canvas canvas, ImageReceiver imageReceiver, float f) {
            if (this.imageHolder.isLoaded()) {
                ...
                float f3 = (float) (d + ((((double) f2) * mediaAreaCoordinates.f1854x) / 100.0d));
                double d2 = storyWidgetsImageDecorator.imageY;
                float f4 = storyWidgetsImageDecorator.imageH;
                float f5 = (float) (d2 + ((((double) f4) * mediaAreaCoordinates.f1855y) / 100.0d));
                float f6 = ((float) ((((double) f2) * mediaAreaCoordinates.f1853w) / 100.0d)) / 2.0f;
                float f7 = ((float) ((((double) f4) * mediaAreaCoordinates.f1852h) / 100.0d)) / 2.0f;
    ...
    public class WeatherWidget extends DrawingObject {
        ...
        public void draw(Canvas canvas, ImageReceiver imageReceiver, float f) {
            ...
            float f4 = storyWidgetsImageDecorator.imageH;
            float f5 = (float) (d2 + ((((double) f4) * mediaAreaCoordinates.f1855y) / 100.0d));
            float f6 = (float) ((((double) f2) * mediaAreaCoordinates.f1853w) / 100.0d);
            float f7 = (float) ((((double) f4) * mediaAreaCoordinates.f1852h) / 100.0d);
            canvas.save();
