...
import org.telegram.p029ui.Cells.ReactedUserHolderView;
...
import org.telegram.p029ui.Components.MessageContainsEmojiButton;
...
import org.telegram.p029ui.Components.ReplaceableIconDrawable;
import org.telegram.p029ui.Components.SearchField;
import org.telegram.p029ui.ProfileActivity;
import org.telegram.p029ui.RecyclerListViewScroller;
import org.telegram.p029ui.Stories.SelfStoryViewsPage;
...
public abstract class SelfStoryViewsPage extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public SelfStoryViewsPage(final StoryViewer storyViewer, Context context, FiltersState filtersState, Consumer consumer) {
        ...
        textView.setPadding(AndroidUtilities.m1124dp(21.0f), AndroidUtilities.m1124dp(6.0f), AndroidUtilities.m1124dp(21.0f), AndroidUtilities.m1124dp(8.0f));
        ...
        this.recyclerListView.setOnItemLongClickListener(new C69204(storyViewer));
        ...
        C69215 c69215 = new C69215(getContext(), true, 13.0f, this.resourcesProvider);
        this.searchField = c69215;
        c69215.setHint(LocaleController.getString(C2888R.string.Search));
    ...
    public /* synthetic */ void lambda$new$0(StoryViewer storyViewer, View view, int i) {
        ...
        if (storyView instanceof TL_stories.TL_storyView) {
            storyViewer.presentFragment(ProfileActivity.m1294of(storyView.user_id));
            return;
        }
        if (storyView instanceof TL_stories.TL_storyViewPublicRepost) {
            storyViewer.fragment.createOverlayStoryViewer().open(getContext(), ((TL_stories.TL_storyViewPublicRepost) item.view).story, StoriesListPlaceProvider.m1320of(this.recyclerListView));
            return;
        }
        TL_stories.StoryReaction storyReaction = item.reaction;
        if (storyReaction instanceof TL_stories.TL_storyReaction) {
            storyViewer.presentFragment(ProfileActivity.m1294of(DialogObject.getPeerDialogId(storyReaction.peer_id)));
            return;
        }
        if (storyReaction instanceof TL_stories.TL_storyReactionPublicRepost) {
            storyViewer.fragment.createOverlayStoryViewer().open(getContext(), ((TL_stories.TL_storyReactionPublicRepost) item.reaction).story, StoriesListPlaceProvider.m1320of(this.recyclerListView));
            return;
        }
    ...
    class C69204 implements RecyclerListView.OnItemLongClickListener {
        ...
        public boolean onItemClick(View view, int i) {
            ...
            boolean z2 = messagesController.blockePeers.indexOfKey(user.f1825id) >= 0;
            boolean z3 = user.contact || ContactsController.getInstance(SelfStoryViewsPage.this.currentAccount).contactsDict.get(Long.valueOf(user.f1825id)) != null;
            ...
            final ItemOptions itemOptionsAddIf = ItemOptions.makeOptions(this.val$storyViewer.containerView, SelfStoryViewsPage.this.resourcesProvider, view).setGravity(3).ignoreX().setScrimViewBackground(new ColorDrawable(Theme.getColor(Theme.key_dialogBackground, SelfStoryViewsPage.this.resourcesProvider))).setDimAlpha(133).addIf((!zIsStoryShownToUser || zIsBlocked || z2 || zIsUserSelf) ? false : true, C2888R.drawable.msg_stories_myhide, LocaleController.formatString(C2888R.string.StoryHideFrom, strSubstring), new Runnable() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$4$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onItemClick$0(messagesController, user, str, reactedUserHolderView, storyView);
                }
            }).makeMultiline(false).cutTextInFancyHalf().addIf((!zIsBlocked || z2 || zIsUserSelf) ? false : true, C2888R.drawable.msg_menu_stories, LocaleController.formatString(C2888R.string.StoryShowBackTo, str), new Runnable() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$4$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onItemClick$1(messagesController, user, str, reactedUserHolderView, storyView);
                }
            }).makeMultiline(false).cutTextInFancyHalf().addIf((z3 || z2 || zIsUserSelf) ? false : true, C2888R.drawable.msg_user_remove, (CharSequence) LocaleController.getString(C2888R.string.BlockUser), true, new Runnable() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$4$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onItemClick$2(messagesController, user, reactedUserHolderView, storyView);
                }
            }).addIf((z3 || !z2 || zIsUserSelf) ? false : true, C2888R.drawable.msg_block, LocaleController.getString(C2888R.string.Unblock), new Runnable() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$4$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onItemClick$3(messagesController, user, reactedUserHolderView, storyView);
                }
            }).addIf(z3 && !zIsUserSelf, C2888R.drawable.msg_user_remove, (CharSequence) LocaleController.getString(C2888R.string.StoryDeleteContact), true, new Runnable() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$4$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public /* synthetic */ void lambda$onItemClick$0(MessagesController messagesController, TLRPC.User user, String str, ReactedUserHolderView reactedUserHolderView, TL_stories.StoryView storyView) {
            messagesController.getStoriesController().updateBlockUser(user.f1825id, true);
            SelfStoryViewsPage selfStoryViewsPage = SelfStoryViewsPage.this;
            BulletinFactory.m1245of(selfStoryViewsPage, selfStoryViewsPage.resourcesProvider).createSimpleBulletin(C2888R.raw.ic_ban, LocaleController.formatString(C2888R.string.StoryHidFromToast, str)).show();
        ...
        public /* synthetic */ void lambda$onItemClick$1(MessagesController messagesController, TLRPC.User user, String str, ReactedUserHolderView reactedUserHolderView, TL_stories.StoryView storyView) {
            messagesController.getStoriesController().updateBlockUser(user.f1825id, false);
            SelfStoryViewsPage selfStoryViewsPage = SelfStoryViewsPage.this;
            BulletinFactory.m1245of(selfStoryViewsPage, selfStoryViewsPage.resourcesProvider).createSimpleBulletin(C2888R.raw.contact_check, LocaleController.formatString(C2888R.string.StoryShownBackToToast, str)).show();
            reactedUserHolderView.animateAlpha(SelfStoryViewsPage.this.isStoryShownToUser(storyView) ? 1.0f : 0.5f, true);
        }
        ...
        public /* synthetic */ void lambda$onItemClick$2(MessagesController messagesController, TLRPC.User user, ReactedUserHolderView reactedUserHolderView, TL_stories.StoryView storyView) {
            messagesController.blockPeer(user.f1825id);
            SelfStoryViewsPage selfStoryViewsPage = SelfStoryViewsPage.this;
            BulletinFactory.m1245of(selfStoryViewsPage, selfStoryViewsPage.resourcesProvider).createBanBulletin(true).show();
            reactedUserHolderView.animateAlpha(SelfStoryViewsPage.this.isStoryShownToUser(storyView) ? 1.0f : 0.5f, true);
        }
        ...
        public /* synthetic */ void lambda$onItemClick$3(MessagesController messagesController, TLRPC.User user, ReactedUserHolderView reactedUserHolderView, TL_stories.StoryView storyView) {
            messagesController.getStoriesController().updateBlockUser(user.f1825id, false);
            messagesController.unblockPeer(user.f1825id);
            SelfStoryViewsPage selfStoryViewsPage = SelfStoryViewsPage.this;
            BulletinFactory.m1245of(selfStoryViewsPage, selfStoryViewsPage.resourcesProvider).createBanBulletin(false).show();
            reactedUserHolderView.animateAlpha(SelfStoryViewsPage.this.isStoryShownToUser(storyView) ? 1.0f : 0.5f, true);
        }
        ...
        public /* synthetic */ void lambda$onItemClick$4(TLRPC.User user, String str, ReactedUserHolderView reactedUserHolderView, TL_stories.StoryView storyView) {
            ...
            SelfStoryViewsPage selfStoryViewsPage = SelfStoryViewsPage.this;
            BulletinFactory.m1245of(selfStoryViewsPage, selfStoryViewsPage.resourcesProvider).createSimpleBulletin(C2888R.raw.ic_ban, LocaleController.formatString(C2888R.string.DeletedFromYourContacts, str)).show();
            reactedUserHolderView.animateAlpha(SelfStoryViewsPage.this.isStoryShownToUser(storyView) ? 1.0f : 0.5f, true);
        }
    ...
    class C69215 extends SearchField {
        Runnable runnable;

        C69215(Context context, boolean z, float f, Theme.ResourcesProvider resourcesProvider) {
            super(context, z, f, resourcesProvider);
        }

        @Override // org.telegram.p029ui.Components.SearchField
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        this.shadowDrawable.setBounds(-AndroidUtilities.m1124dp(6.0f), paddingTop, getMeasuredWidth() + AndroidUtilities.m1124dp(6.0f), getMeasuredHeight());
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        if (view == this.recyclerListView) {
            canvas.save();
            canvas.clipRect(0, AndroidUtilities.m1124dp(this.TOP_PADDING), getMeasuredWidth(), getMeasuredHeight());
    ...
    public void setStoryItem(long j, SelfStoryViewsView.StoryItemInternal storyItemInternal) {
        ...
        NotificationsController.getInstance(this.currentAccount).processSeenStoryReactions(j, storyItemInternal.storyItem.f1857id);
    }
    ...
    */
    private void updateViewsVisibility() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Stories.SelfStoryViewsPage.updateViewsVisibility():void");
    }
    ...
    public static void preload(int i, long j, TL_stories.StoryItem storyItem) {
        ...
        ViewsModel viewsModel = sparseArray == null ? null : (ViewsModel) sparseArray.get(storyItem.f1857id);
        ...
        if (viewsModel == null || viewsModel.totalCount != i2) {
            ...
            sparseArray.put(storyItem.f1857id, viewsModel2);
        }
    }
    ...
    public boolean onBackPressed() {
        ...
        if (Math.abs(this.topViewsContainer.getTranslationY() - this.recyclerListView.getPaddingTop()) <= AndroidUtilities.m1124dp(2.0f)) {
            return false;
        }
        this.recyclerListView.dispatchTouchEvent(AndroidUtilities.emptyMotionEvent());
    ...
    public static class ViewsModel {
        ...
        public void loadNext() {
            ...
            if (this.isChannel) {
                ...
                tL_getStoryReactionsList.f1858id = this.storyItem.f1857id;
                ...
                this.loading = true;
                FileLog.m1133d("SelfStoryViewsPage reactions load next " + this.storyItem.f1857id + " " + this.initial + " offset=" + tL_getStoryReactionsList.offset);
            ...
            tL_stories_getStoryViewsList.f1866id = this.storyItem.f1857id;
            ...
            if (this.useLocalFilters) {
                tL_stories_getStoryViewsList.f1867q = _UrlKt.FRAGMENT_ENCODE_SET;
                ...
                tL_stories_getStoryViewsList.f1867q = str2;
            ...
            this.loading = true;
            FileLog.m1133d("SelfStoryViewsPage load next " + this.storyItem.f1857id + " " + this.initial + " offset=" + tL_stories_getStoryViewsList.offset + " q" + tL_stories_getStoryViewsList.f1867q + " " + tL_stories_getStoryViewsList.just_contacts + " " + tL_stories_getStoryViewsList.reactions_first);
        ...
        public /* synthetic */ void lambda$loadNext$0(int[] iArr, TLObject tLObject, TLRPC.TL_error tL_error) {
            if (iArr[0] != this.reqId) {
                FileLog.m1133d("SelfStoryViewsPage reactions " + this.storyItem.f1857id + " localId != reqId");
                return;
            }
            this.loading = false;
            this.reqId = -1;
            ...
            FileLog.m1133d("SelfStoryViewsPage reactions " + this.storyItem.f1857id + " response  totalItems " + this.reactions.size() + " has next " + this.hasNext);
        ...
        public /* synthetic */ void lambda$loadNext$2(int[] iArr, TLObject tLObject, TLRPC.TL_error tL_error) {
            boolean z;
            if (iArr[0] != this.reqId) {
                FileLog.m1133d("SelfStoryViewsPage " + this.storyItem.f1857id + " localId != reqId");
                return;
            }
            this.loading = false;
            this.reqId = -1;
            if (tLObject != null) {
                ...
                if (i2 > storyViews.views_count) {
                    ...
                    for (int i3 = 0; i3 < Math.min(3, storyViewsList.users.size()); i3++) {
                        this.storyItem.views.recent_viewers.add(Long.valueOf(storyViewsList.users.get(i3).f1825id));
                    }
            ...
            FileLog.m1133d("SelfStoryViewsPage " + this.storyItem.f1857id + " response  totalItems " + this.views.size() + " has next " + this.hasNext);
        ...
        private void applyLocalFilter() {
            ...
            Collections.sort(this.views, Comparator.CC.comparingInt(new ToIntFunction() { // from class: org.telegram.ui.Stories.SelfStoryViewsPage$ViewsModel$$ExternalSyntheticLambda2
                ...
                public final int applyAsInt(Object obj) {
                    return SelfStoryViewsPage.ViewsModel.m18956$r8$lambda$keJViVULdsq7Tmm19unD9O4elA((TL_stories.StoryView) obj);
                }
            }));
        }

        /* JADX INFO: renamed from: $r8$lambda$keJViVULdsq7T-mm19unD9O4elA, reason: not valid java name */
        public static /* synthetic */ int m18956$r8$lambda$keJViVULdsq7Tmm19unD9O4elA(TL_stories.StoryView storyView) {
    ...
    class HeaderView extends FrameLayout {
        ...
        public HeaderView(Context context) {
            ...
            textView.setText(LocaleController.getString(C2888R.string.AllViewers));
            ...
            this.allViewersView.setPadding(AndroidUtilities.m1124dp(12.0f), AndroidUtilities.m1124dp(4.0f), AndroidUtilities.m1124dp(12.0f), AndroidUtilities.m1124dp(4.0f));
            TextView textView3 = new TextView(context);
            this.contactsViewersView = textView3;
            textView3.setText(LocaleController.getString(C2888R.string.Contacts));
            ...
            this.contactsViewersView.setPadding(AndroidUtilities.m1124dp(12.0f), AndroidUtilities.m1124dp(4.0f), AndroidUtilities.m1124dp(12.0f), AndroidUtilities.m1124dp(4.0f));
            linearLayout.setPadding(0, AndroidUtilities.m1124dp(6.0f), 0, AndroidUtilities.m1124dp(6.0f));
            ...
            linearLayout2.setPadding(AndroidUtilities.m1124dp(6.0f), 0, AndroidUtilities.m1124dp(6.0f), 0);
            linearLayout2.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1124dp(26.0f), Theme.getColor(i, SelfStoryViewsPage.this.resourcesProvider)));
            ...
            replaceableIconDrawable.setIcon(C2888R.drawable.menu_views_reactions3, false);
            ImageView imageView = new ImageView(getContext());
            imageView.setScaleType(ImageView.ScaleType.FIT_XY);
            imageView.setImageDrawable(this.replacableDrawable);
            imageView.setPadding(AndroidUtilities.m1124dp(1.0f), AndroidUtilities.m1124dp(1.0f), AndroidUtilities.m1124dp(1.0f), AndroidUtilities.m1124dp(1.0f));
            linearLayout2.addView(imageView, LayoutHelper.createLinear(26, 26));
            ImageView imageView2 = new ImageView(getContext());
            imageView2.setImageResource(C2888R.drawable.arrow_more);
        ...
        class C69231 extends CustomPopupMenu {
            @Override // org.telegram.p029ui.Components.CustomPopupMenu
            protected void onDismissed() {
            }

            C69231(Context context, Theme.ResourcesProvider resourcesProvider, boolean z) {
            ...
            protected void onCreate(ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout) {
                ...
                if (z) {
                    i = C2888R.drawable.menu_views_reposts;
                } else {
                    i = selfStoryViewsPage.state.sortByReactions ? C2888R.drawable.menu_views_reactions2 : C2888R.drawable.menu_views_reactions;
                }
                ActionBarMenuSubItem actionBarMenuSubItemAddItem = ActionBarMenuItem.addItem(actionBarPopupWindowLayout, i, LocaleController.getString(z ? C2888R.string.SortByReposts : C2888R.string.SortByReactions), false, SelfStoryViewsPage.this.resourcesProvider);
                ...
                ActionBarMenuSubItem actionBarMenuSubItemAddItem2 = ActionBarMenuItem.addItem(actionBarPopupWindowLayout, !SelfStoryViewsPage.this.state.sortByReactions ? C2888R.drawable.menu_views_recent2 : C2888R.drawable.menu_views_recent, LocaleController.getString(C2888R.string.SortByTime), false, SelfStoryViewsPage.this.resourcesProvider);
                if (SelfStoryViewsPage.this.state.sortByReactions) {
                ...
                ActionBarMenuItem.addText(actionBarPopupWindowLayout, LocaleController.getString(z ? C2888R.string.StoryReactionsSortDescription : C2888R.string.StoryViewsSortDescription), SelfStoryViewsPage.this.resourcesProvider);
            }
        ...
        public /* synthetic */ void lambda$new$2(View view) {
            SelfStoryViewsPage.this.popupMenu = new C69231(getContext(), SelfStoryViewsPage.this.resourcesProvider, false);
            CustomPopupMenu customPopupMenu = SelfStoryViewsPage.this.popupMenu;
            LinearLayout linearLayout = this.buttonContainer;
            customPopupMenu.show(linearLayout, 0, (-linearLayout.getMeasuredHeight()) - AndroidUtilities.m1124dp(8.0f));
        }
    ...
    public void updateViewState(boolean z) {
        ...
        if (z2) {
            ViewsModel viewsModel = this.currentModel;
            i = (viewsModel == null || !viewsModel.isChannel) ? C2888R.drawable.menu_views_reactions3 : C2888R.drawable.menu_views_reposts3;
        } else {
            i = C2888R.drawable.menu_views_recent3;
        }
    ...
    private class RecyclerListViewInner extends RecyclerListView implements StoriesListPlaceProvider.ClippedView {
        ...
        public void updateClip(int[] iArr) {
            iArr[0] = AndroidUtilities.m1124dp(SelfStoryViewsPage.this.TOP_PADDING);
