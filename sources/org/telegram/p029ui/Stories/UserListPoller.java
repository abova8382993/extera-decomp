...
public class UserListPoller {
    ...
    Runnable requestCollectedRunnables = new RunnableC69681();
    ...
    class RunnableC69681 implements Runnable {
        RunnableC69681() {
        }
        ...
        public void run() {
            ...
            for (int i = 0; i < arrayList.size(); i++) {
                tL_stories_getPeerMaxIDs.f1863id.add(MessagesController.getInstance(UserListPoller.this.currentAccount).getInputPeer(((Long) arrayList.get(i)).longValue()));
            }
