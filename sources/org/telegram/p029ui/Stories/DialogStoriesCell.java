...
import org.telegram.p029ui.ActionBar.ActionBarAnimatedSubtitleOverlayContainer;
...
import org.telegram.p029ui.Components.EllipsizeSpanAnimator;
...
public abstract class DialogStoriesCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, FactorAnimator.Target {
    ...
    public DialogStoriesCell(Context context, BaseFragment baseFragment, int i, int i2) {
        ...
        this.menuItemsOffset = AndroidUtilities.m1124dp(68.0f);
        ...
        recyclerListView.setPadding(AndroidUtilities.m1124dp(3.0f), 0, AndroidUtilities.m1124dp(3.0f), 0);
        ...
        ActionBarAnimatedSubtitleOverlayContainer actionBarAnimatedSubtitleOverlayContainer = new ActionBarAnimatedSubtitleOverlayContainer(context, null, this.ellipsizeSpanAnimator) { // from class: org.telegram.ui.Stories.DialogStoriesCell.6
            @Override // org.telegram.p029ui.ActionBar.ActionBarAnimatedSubtitleOverlayContainer, me.vkryl.android.animator.ReplaceAnimator.Callback
        ...
        this.grayPaint.setStrokeWidth(AndroidUtilities.m1124dp(1.0f));
        this.addNewStoryDrawable = ContextCompat.getDrawable(getContext(), C2888R.drawable.msg_mini_addstory);
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                while (i3 < DialogStoriesCell.this.viewsDrawInParent.size()) {
                    ...
                    if (storyCell2.getAlpha() != 1.0f) {
                        canvas2 = canvas;
                        canvas2.saveLayerAlpha(-AndroidUtilities.m1124dp(4.0f), -AndroidUtilities.m1124dp(4.0f), AndroidUtilities.m1124dp(50.0f), AndroidUtilities.m1124dp(50.0f), (int) (storyCell2.getAlpha() * 255.0f), 31);
                    } else {
                        canvas2 = canvas;
                    }
                    canvas2.scale(storyCell2.getScaleX(), storyCell2.getScaleY(), AndroidUtilities.m1124dp(14.0f), storyCell2.getCy());
        ...
        this.listViewMini.addItemDecoration(new RecyclerView.ItemDecoration() { // from class: org.telegram.ui.Stories.DialogStoriesCell.8
            ...
            public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
                ...
                if (childLayoutPosition == 1) {
                    rect.left = (-AndroidUtilities.m1124dp(85.0f)) + AndroidUtilities.m1124dp(31.0f);
    ...
    public /* synthetic */ void lambda$openStoryForCell$5(StoryCell storyCell, final long j) {
        ...
        orCreateStoryViewer.open(getContext(), null, arrayList, size, null, null, StoriesListPlaceProvider.m1320of(this.recyclerListView).with(new StoriesListPlaceProvider.LoadNextInterface() { // from class: org.telegram.ui.Stories.DialogStoriesCell$$ExternalSyntheticLambda19
    ...
    */
    protected void dispatchDraw(android.graphics.Canvas r31) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Stories.DialogStoriesCell.dispatchDraw(android.graphics.Canvas):void");
    }
    ...
    protected void onMeasure(int i, int i2) {
        float fM1124dp = AndroidUtilities.m1124dp((AndroidUtilities.isTablet() || getResources().getConfiguration().orientation != 2) ? 20.0f : 18.0f);
        this.titleView.setTextSize(fM1124dp);
        this.titleViewOut.setTextSize(fM1124dp);
        this.currentCellWidth = AndroidUtilities.m1124dp(70.0f);
        AndroidUtilities.rectTmp.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(89.0f), TLObject.FLAG_30));
    }
    ...
    public void setProgressToCollapse(float f, boolean z) {
        ...
        final boolean z2 = f > this.f2174K;
    ...
    */
    public void openStoryRecorder(final long r13) {
        ...
        L90:
            ...
            int r2 = r12.currentAccount
            org.telegram.ui.Stories.recorder.StoryRecorder r0 = org.telegram.p029ui.Stories.recorder.StoryRecorder.getInstance(r0, r2)
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Stories.DialogStoriesCell.openStoryRecorder(long):void");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void setTitleOverlayText(java.lang.String r6, int r7) {
        /*
            r5 = this;
            r5.cancelTitleOverrideAnimation()
            int r0 = org.telegram.messenger.C2888R.string.ConnectingToProxyWithDots
            r1 = 0
            r2 = 1
            if (r7 != r0) goto L23
            int r0 = org.telegram.messenger.C2888R.string.TitleSetupProxy
            java.lang.String r0 = org.telegram.messenger.LocaleController.getString(r0)
            r3 = 1076538027(0x402aaaab, float:2.6666667)
            int r3 = org.telegram.messenger.AndroidUtilities.m1124dp(r3)
            float r3 = (float) r3
            r4 = 1073741824(0x40000000, float:2.0)
            int r4 = org.telegram.messenger.AndroidUtilities.m1124dp(r4)
            float r4 = (float) r4
            java.lang.CharSequence r0 = org.telegram.messenger.AndroidUtilities.replaceArrows(r0, r2, r3, r4)
            goto L24
        L23:
            r0 = r1
        L24:
            org.telegram.ui.ActionBar.ActionBarAnimatedSubtitleOverlayContainer r3 = r5.subtitleOverlayContainer
            r3.setText(r0, r2)
            r0 = 0
            if (r6 == 0) goto L5b
            r5.hasOverlayText = r2
            int r3 = r5.overlayTextId
            if (r3 == r7) goto L69
            r5.overlayTextId = r7
            ...
            if (r7 != 0) goto L51
            java.lang.String r7 = "..."
            int r7 = android.text.TextUtils.indexOf(r6, r7)
            if (r7 < 0) goto L51
            android.text.SpannableString r6 = android.text.SpannableString.valueOf(r6)
            org.telegram.ui.Components.EllipsizeSpanAnimator r3 = r5.ellipsizeSpanAnimator
            r3.wrap(r6, r7)
            r7 = r2
            goto L52
        L51:
            r7 = r0
        L52:
            org.telegram.ui.Components.AnimatedTextView r3 = r5.titleView
            boolean r4 = org.telegram.messenger.LocaleController.isRTL
            r4 = r4 ^ r2
            r3.setText(r6, r4)
            goto L6a
        L5b:
            r5.hasOverlayText = r0
            r5.overlayTextId = r0
            org.telegram.ui.Components.AnimatedTextView r6 = r5.titleView
            java.lang.CharSequence r7 = r5.currentTitle
        ...
        L69:
            r7 = r0
        L6a:
            org.telegram.ui.Components.AnimatedTextView r6 = r5.titleViewOut
            r6.setText(r1, r0)
            org.telegram.ui.Components.AnimatedTextView r6 = r5.titleViewOut
            r0 = 8
            r6.setVisibility(r0)
            me.vkryl.android.animator.BoolAnimator r6 = r5.animatorHasTitleText
            boolean r0 = r5.hasOverlayText
            r6.setValue(r0, r2)
            if (r7 == 0) goto L87
            org.telegram.ui.Components.EllipsizeSpanAnimator r6 = r5.ellipsizeSpanAnimator
            org.telegram.ui.Components.AnimatedTextView r7 = r5.titleView
            r6.addView(r7)
            return
        L87:
            org.telegram.ui.Components.EllipsizeSpanAnimator r6 = r5.ellipsizeSpanAnimator
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Stories.DialogStoriesCell.setTitleOverlayText(java.lang.String, int):void");
    }
    ...
    public void openSelfStories() {
        if (this.storiesController.hasSelfStories()) {
            ...
            this.fragment.getOrCreateStoryViewer().open(getContext(), null, arrayList, 0, null, null, StoriesListPlaceProvider.m1320of(this.listViewMini), false);
        }
    }
    ...
    public void setOverscroll(float f) {
        this.overscrollProgress = f / AndroidUtilities.m1124dp(90.0f);
        invalidate();
    ...
    private AnimatedTextView createTitleView() {
        ...
        animatedTextView.setPadding(0, AndroidUtilities.m1124dp(8.0f), 0, AndroidUtilities.m1124dp(8.0f));
        animatedTextView.setTextSize(AndroidUtilities.m1124dp((AndroidUtilities.isTablet() || getResources().getConfiguration().orientation != 2) ? 20.0f : 18.0f));
    ...
    public class StoryCell extends FrameLayout {
        ...
        private float f2175cx;

        /* JADX INFO: renamed from: cy */
        private float f2176cy;
        long dialogId;
        ...
        public void setDialogId(long j) {
            ...
            if (DialogStoriesCell.this.storiesController.isLastUploadingFailed(j)) {
                ...
                this.textView.setText(LocaleController.getString(C2888R.string.FailedStory));
            ...
            if (this.isSelf) {
                if (z && this.isUploadingState && !this.mini) {
                    ...
                    this.textView.setTranslationY(AndroidUtilities.m1124dp(5.0f));
                ...
                this.textView.setTextSize(10);
                this.textView.setText(LocaleController.getString(C2888R.string.MyStory));
                return;
            }
            if (this.user != null) {
                this.textView.setTextSize(11);
        ...
        public /* synthetic */ void lambda$setDialogId$0(View view, ValueAnimator valueAnimator) {
            ...
            view.setAlpha(f);
            view.setTranslationY((-AndroidUtilities.m1124dp(5.0f)) * fFloatValue);
            this.textView.setAlpha(fFloatValue);
            this.textView.setTranslationY(AndroidUtilities.m1124dp(5.0f) * f);
        }
        ...
        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.mini ? AndroidUtilities.m1124dp(70.0f) : DialogStoriesCell.this.currentCellWidth, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(81.0f), TLObject.FLAG_30));
        }

        float getCy() {
            float fM1124dp = AndroidUtilities.m1124dp(48.0f);
            float fM1124dp2 = AndroidUtilities.m1124dp(26.33f);
            return AndroidUtilities.lerp(AndroidUtilities.m1124dp(5.0f), (ActionBar.getCurrentActionBarHeight() - fM1124dp2) / 2.0f, DialogStoriesCell.this.collapsedProgress1) + (AndroidUtilities.lerp(fM1124dp, fM1124dp2, this.progressToCollapsed) / 2.0f);
        }
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            float fM1124dp = AndroidUtilities.m1124dp(48.0f);
            float fM1124dp2 = AndroidUtilities.m1124dp(26.33f);
            float fM1124dp3 = AndroidUtilities.m1124dp(8.0f) * Utilities.clamp(DialogStoriesCell.this.overscrollProgress / 0.5f, 1.0f, 0.0f);
            if (this.selectedForOverscroll) {
                fM1124dp3 += AndroidUtilities.m1124dp(16.0f) * Utilities.clamp((DialogStoriesCell.this.overscrollProgress - 0.5f) / 0.5f, 1.0f, 0.0f);
            }
            float fLerp = AndroidUtilities.lerp(fM1124dp + fM1124dp3, fM1124dp2, this.progressToCollapsed);
            ...
            float fLerp3 = AndroidUtilities.lerp(AndroidUtilities.m1124dp(5.0f), (ActionBar.getCurrentActionBarHeight() - fM1124dp2) / 2.0f, this.progressToCollapsed);
            ...
            this.params.originalAvatarRect.set(fLerp2, fLerp3, fLerp2 + fLerp, f12);
            ...
            if (this.progressToCollapsed != 0.0f) {
                float fM1124dp4 = AndroidUtilities.m1124dp(3.0f) + f11;
                float f15 = this.f2175cx;
                f7 = 3.0f;
                float f16 = this.f2176cy;
                float f17 = f11 * 2.0f;
                f8 = 2.0f;
                f6 = 1.0f;
                f3 = f13;
                ...
                r9 = 1;
                f9 = fLerp2;
                canvas.drawRoundRect(f15 - fM1124dp4, f16 - fM1124dp4, f15 + fM1124dp4, f16 + fM1124dp4, ExteraConfig.getAvatarCorners(f17 + AndroidUtilities.m1124dp(f), true), ExteraConfig.getAvatarCorners(f17 + AndroidUtilities.m1124dp(f), true), DialogStoriesCell.this.backgroundPaint);
                canvas2 = canvas;
            } else {
                canvas2 = canvas;
                f3 = f13;
            ...
            canvas2.save();
            float f18 = this.bounceScale;
            canvas2.scale(f18, f18, this.f2175cx, this.f2176cy);
            ...
            if (r5 != 0 || (this.progressWasDrawn && (radialProgress = this.radialProgress) != null && radialProgress.getAnimatedProgress() < 0.98f)) {
                if (r5 == 0) {
                    ...
                    for (int i = 0; i < uploadingAndEditingStories.size(); i++) {
                        f19 += ((StoriesController.UploadingStory) uploadingAndEditingStories.get(i)).progress;
                    }
                    size = (DialogStoriesCell.this.storiesController.uploadedStories + f19) / (r2 + uploadingAndEditingStories.size());
                ...
                this.radialProgress.setProgressRect((int) (this.avatarImage.getImageX() - AndroidUtilities.m1124dp(f7)), (int) (this.avatarImage.getImageY() - AndroidUtilities.m1124dp(f7)), (int) (this.avatarImage.getImageX2() + AndroidUtilities.m1124dp(f7)), (int) (this.avatarImage.getImageY2() + AndroidUtilities.m1124dp(f7)));
                ...
                float f20 = this.failT.set(this.isFail);
                if (this.drawAvatar) {
                    ...
                    float f21 = f20 * avatarStoryParams3.progressToSegments;
                    avatarStoryParams3.animate = (this.progressWasDrawn ? 1 : 0) ^ r9;
                    avatarStoryParams3.progressToArc = getArcProgress(this.f2175cx, f11);
                    ...
                    avatarStoryParams4.alpha = f6 - f21;
                    ...
                    if (f21 > 0.0f) {
                        ...
                        errorPaint.setStrokeWidth(AndroidUtilities.m1124dp(f8));
                        errorPaint.setAlpha((int) (255.0f * f21));
                        canvas2.drawCircle(f3, f4, (f11 + AndroidUtilities.m1124dp(4.0f)) * this.params.getScale(), errorPaint);
                    }
                    f20 = f21;
                }
                ...
                if (this.drawAvatar) {
                    canvas2.save();
                    float f22 = f6 - fClamp;
                    canvas2.scale(f22, f22, this.f2175cx + AndroidUtilities.m1124dp(f2), this.f2176cy + AndroidUtilities.m1124dp(f2));
                    drawPlus(canvas2, this.f2175cx, this.f2176cy, f6);
                    drawFail(canvas2, this.f2175cx, this.f2176cy, f20);
                    canvas2.restore();
                }
            }
            canvas2.restore();
            if (this.crossfadeToDialog && this.progressToCollapsed2 > 0.0f) {
                this.crossfadeToAvatarImage.setImageCoords(f9, f10, fLerp, fLerp);
                this.crossfadeToAvatarImage.setAlpha(this.progressToCollapsed2);
                this.crossfadeToAvatarImage.draw(canvas2);
            }
            this.textViewContainer.setTranslationY(f5 + (AndroidUtilities.m1124dp(7.0f) * (1.0f - this.progressToCollapsed)));
            this.textViewContainer.setTranslationX(f9 - measuredWidth);
            if (!this.mini) {
                if (this.isSelf) {
                    this.textAlpha = 1.0f;
                } else {
        ...
        private float getArcProgress(float f, float f2) {
            if (!this.isLast && DialogStoriesCell.this.overscrollProgress <= 0.0f) {
                if (AndroidUtilities.lerp(getMeasuredWidth(), AndroidUtilities.m1124dp(16.0f), CubicBezierInterpolator.EASE_OUT.getInterpolation(this.progressToCollapsed)) < (f2 + AndroidUtilities.dpf2(3.5f)) * 2.0f) {
        ...
        public void drawPlus(Canvas canvas, float f, float f2, float f3) {
            ...
            if (this.isSelf && !DialogStoriesCell.this.storiesController.hasStories(this.dialogId) && Utilities.isNullOrEmpty(DialogStoriesCell.this.storiesController.getUploadingStories(this.dialogId))) {
                float fM1124dp = f + AndroidUtilities.m1124dp(16.0f);
                float fM1124dp2 = f2 + AndroidUtilities.m1124dp(16.0f);
                DialogStoriesCell dialogStoriesCell2 = DialogStoriesCell.this;
                ...
                canvas.drawCircle(fM1124dp, fM1124dp2, AndroidUtilities.m1124dp(11.0f), DialogStoriesCell.this.backgroundPaint);
                canvas.drawCircle(fM1124dp, fM1124dp2, AndroidUtilities.m1124dp(9.0f), DialogStoriesCell.this.addCirclePaint);
                if (DialogStoriesCell.this.type == 0) {
                ...
                DialogStoriesCell.this.addNewStoryDrawable.setBounds((int) (fM1124dp - (DialogStoriesCell.this.addNewStoryDrawable.getIntrinsicWidth() / 2.0f)), (int) (fM1124dp2 - (DialogStoriesCell.this.addNewStoryDrawable.getIntrinsicHeight() / 2.0f)), (int) (fM1124dp + (DialogStoriesCell.this.addNewStoryDrawable.getIntrinsicWidth() / 2.0f)), (int) (fM1124dp2 + (DialogStoriesCell.this.addNewStoryDrawable.getIntrinsicHeight() / 2.0f)));
        ...
        public void drawFail(Canvas canvas, float f, float f2, float f3) {
            ...
            float fM1124dp = f + AndroidUtilities.m1124dp(17.0f);
            float fM1124dp2 = f2 + AndroidUtilities.m1124dp(17.0f);
            DialogStoriesCell dialogStoriesCell = DialogStoriesCell.this;
            ...
            float fM1124dp3 = AndroidUtilities.m1124dp(9.0f) * CubicBezierInterpolator.EASE_OUT_BACK.getInterpolation(f3);
            canvas.drawCircle(fM1124dp, fM1124dp2, AndroidUtilities.m1124dp(2.0f) + fM1124dp3, DialogStoriesCell.this.backgroundPaint);
            canvas.drawCircle(fM1124dp, fM1124dp2, fM1124dp3, DialogStoriesCell.this.addCirclePaint);
            DialogStoriesCell dialogStoriesCell4 = DialogStoriesCell.this;
            dialogStoriesCell4.addCirclePaint.setColor(Theme.multAlpha(dialogStoriesCell4.getTextColor(), f3));
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(fM1124dp - AndroidUtilities.m1124dp(1.0f), fM1124dp2 - AndroidUtilities.dpf2(4.6f), AndroidUtilities.m1124dp(1.0f) + fM1124dp, AndroidUtilities.dpf2(1.6f) + fM1124dp2);
            canvas.drawRoundRect(rectF, AndroidUtilities.m1124dp(3.0f), AndroidUtilities.m1124dp(3.0f), DialogStoriesCell.this.addCirclePaint);
            rectF.set(fM1124dp - AndroidUtilities.m1124dp(1.0f), AndroidUtilities.dpf2(2.6f) + fM1124dp2, fM1124dp + AndroidUtilities.m1124dp(1.0f), fM1124dp2 + AndroidUtilities.dpf2(4.6f));
            canvas.drawRoundRect(rectF, AndroidUtilities.m1124dp(3.0f), AndroidUtilities.m1124dp(3.0f), DialogStoriesCell.this.addCirclePaint);
        }
        ...
        public void setProgressToCollapsed(float f, float f2, float f3, boolean z) {
            ...
            if (!this.mini) {
                DialogStoriesCell dialogStoriesCell = DialogStoriesCell.this;
                fClamp = 1.0f - Utilities.clamp(dialogStoriesCell.collapsedProgress / dialogStoriesCell.f2174K, 1.0f, 0.0f);
            }
    ...
    public Drawable createVerifiedDrawable() {
        final Drawable drawableMutate = ContextCompat.getDrawable(getContext(), C2888R.drawable.verified_area).mutate();
        final Drawable drawableMutate2 = ContextCompat.getDrawable(getContext(), C2888R.drawable.verified_check).mutate();
    ...
    static float getAvatarRight(int i, float f) {
        float fLerp = AndroidUtilities.lerp(AndroidUtilities.m1124dp(48.0f), AndroidUtilities.m1124dp(26.33f), f) / 2.0f;
    ...
    private HintView2 makePremiumHint() {
        ...
        this.premiumHint.setPadding(AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(24.0f), AndroidUtilities.m1124dp(8.0f), 0);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        if (this.currentState == 2) {
            ...
            this.miniItemsClickArea.setRect((int) this.listViewMini.getX(), (int) this.listViewMini.getY(), (int) (this.listViewMini.getX() + AndroidUtilities.m1124dp((size * 26.33f) - (Math.max(0, size - 1) * 16.0f))), (int) (this.listViewMini.getY() + this.listViewMini.getHeight()));
    ...
    public void updateStatus(TLRPC.User user, boolean z) {
        ...
        if (emojiStatusDocumentId != null) {
            ...
            if (this.premiumStar == null) {
                ...
                this.premiumStar = new AnimatedEmojiDrawable.WrapSizeDrawable(this.premiumStar, AndroidUtilities.m1124dp(18.0f), AndroidUtilities.m1124dp(18.0f)) { // from class: org.telegram.ui.Stories.DialogStoriesCell.13
