...
import org.telegram.p029ui.Cells.CreationTextCell;
...
import org.telegram.p029ui.Components.DotDividerSpan;
...
public class ManageLinksActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private final LinkEditActivity.Callback linkEditActivityCallback = new C60966();
    ...
    */
    public /* synthetic */ void lambda$loadLinks$5(org.telegram.tgnet.TLRPC.TL_chatInviteExported r7, final boolean r8, final org.telegram.tgnet.TLObject r9, final org.telegram.tgnet.TLRPC.TL_error r10) {
        ...
        L39:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.ManageLinksActivity.lambda$loadLinks$5(org.telegram.tgnet.TLRPC$TL_chatInviteExported, boolean, org.telegram.tgnet.TLObject, org.telegram.tgnet.TLRPC$TL_error):void");
    }
    ...
    */
    public /* synthetic */ void lambda$loadLinks$3(org.telegram.tgnet.TLRPC.TL_chatInviteExported r7, org.telegram.tgnet.TLRPC.TL_error r8, org.telegram.tgnet.TLObject r9, boolean r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.ManageLinksActivity.lambda$loadLinks$3(org.telegram.tgnet.TLRPC$TL_chatInviteExported, org.telegram.tgnet.TLRPC$TL_error, org.telegram.tgnet.TLObject, boolean):void");
    }
    ...
    */
    public void updateRows(boolean r7) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.ManageLinksActivity.updateRows(boolean):void");
    }
    ...
    public View createView(final Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2888R.string.InviteLinks));
        ...
        this.linkIcon = ContextCompat.getDrawable(context, C2888R.drawable.msg_link_1);
        this.linkIconRevoked = ContextCompat.getDrawable(context, C2888R.drawable.msg_link_2);
        this.linkIconRevenue = ContextCompat.getDrawable(context, C2888R.drawable.large_income);
    ...
    public /* synthetic */ void lambda$createView$9(Context context, View view, int i) {
        ...
        if (i == this.revokeAllRow) {
            ...
            builder.setTitle(LocaleController.getString(C2888R.string.DeleteAllRevokedLinks));
            builder.setMessage(LocaleController.getString(C2888R.string.DeleteAllRevokedLinkHelp));
            builder.setPositiveButton(LocaleController.getString(C2888R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ManageLinksActivity$$ExternalSyntheticLambda6
    ...
    public class HintInnerCell extends FrameLayout {
        ...
        public HintInnerCell(Context context) {
            ...
            this.messageTextView.setText(LocaleController.getString(ManageLinksActivity.this.isChannel ? C2888R.string.PrimaryLinkHelpChannel : C2888R.string.PrimaryLinkHelp));
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            switch (i) {
                ...
                case 8:
                    ...
                    textSettingsCell.setText(LocaleController.getString(C2888R.string.DeleteAllRevokedLinks), false);
  ...
  0x015a: PHI (r0v30 org.telegram.tgnet.TLRPC$TL_chatInviteExported) = (r0v28 org.telegram.tgnet.TLRPC$TL_chatInviteExported), (r0v36 org.telegram.tgnet.TLRPC$TL_chatInviteExported) binds: [B:53:0x0177, B:50:0x0158] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public /* synthetic */ void lambda$revokePermanent$11(TLRPC.TL_error tL_error, TLObject tLObject, TLRPC.TL_chatInviteExported tL_chatInviteExported) {
        if (tL_error == null) {
            ...
            updateRecyclerViewAnimated(diffCallbackSaveListState);
            BulletinFactory.m1246of(this).createSimpleBulletin(C2888R.raw.linkbroken, LocaleController.getString(C2888R.string.InviteRevokedHint)).show();
        }
    }
    ...
    class LinkCell extends FrameLayout {
        ...
        public /* synthetic */ void lambda$new$7(View view) {
            ...
            if (view2 instanceof ViewGroup) {
                ...
                if (this.invite.revoked) {
                    itemOptionsMakeOptions.add(C2888R.drawable.msg_delete, (CharSequence) LocaleController.getString(C2888R.string.Delete), true, new Runnable() { // from class: org.telegram.ui.ManageLinksActivity$LinkCell$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
                    ...
                    itemOptionsMakeOptions.add(C2888R.drawable.msg_copy, LocaleController.getString(C2888R.string.CopyLink), new Runnable() { // from class: org.telegram.ui.ManageLinksActivity$LinkCell$$ExternalSyntheticLambda2
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$new$2();
                        }
                    });
                    itemOptionsMakeOptions.add(C2888R.drawable.msg_share, LocaleController.getString(C2888R.string.ShareLink), new Runnable() { // from class: org.telegram.ui.ManageLinksActivity$LinkCell$$ExternalSyntheticLambda3
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$new$3();
                        }
                    });
                    itemOptionsMakeOptions.addIf(!this.invite.permanent && ManageLinksActivity.this.canEdit, C2888R.drawable.msg_edit, LocaleController.getString(C2888R.string.EditLink), new Runnable() { // from class: org.telegram.ui.ManageLinksActivity$LinkCell$$ExternalSyntheticLambda4
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$new$4();
                        }
                    });
                    itemOptionsMakeOptions.addIf(ManageLinksActivity.this.canEdit, C2888R.drawable.msg_delete, (CharSequence) LocaleController.getString(C2888R.string.RevokeLink), true, new Runnable() { // from class: org.telegram.ui.ManageLinksActivity$LinkCell$$ExternalSyntheticLambda5
                        @Override // java.lang.Runnable
                        public final void run() {
        ...
        public /* synthetic */ void lambda$new$1() {
            final TLRPC.TL_chatInviteExported tL_chatInviteExported = this.invite;
            new AlertDialog.Builder(ManageLinksActivity.this.getParentActivity()).setTitle(LocaleController.getString(C2888R.string.DeleteLink)).setMessage(LocaleController.getString(C2888R.string.DeleteLinkHelp)).setPositiveButton(LocaleController.getString(C2888R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ManageLinksActivity$LinkCell$$ExternalSyntheticLambda7
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                        ...
                        if (z) {
                            if (longSparseArray != null && longSparseArray.size() == 1) {
                                ...
                                if (j == 0 || j == ManageLinksActivity.this.getUserConfig().getClientUserId()) {
                                    ...
                                    string = LocaleController.formatString(C2888R.string.InvLinkToUser, ManageLinksActivity.this.getMessagesController().getPeerName(j, true));
                                }
                            } else {
                            ...
                            Bulletin bulletinCreateSimpleBulletin = BulletinFactory.m1246of(ManageLinksActivity.this).createSimpleBulletin(C2888R.raw.forward, AndroidUtilities.replaceTags(string));
        ...
        public /* synthetic */ void lambda$new$6() {
            final TLRPC.TL_chatInviteExported tL_chatInviteExported = this.invite;
            new AlertDialog.Builder(ManageLinksActivity.this.getParentActivity()).setMessage(LocaleController.getString(C2888R.string.RevokeAlert)).setTitle(LocaleController.getString(C2888R.string.RevokeLink)).setPositiveButton(LocaleController.getString(C2888R.string.RevokeButton), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ManageLinksActivity$LinkCell$$ExternalSyntheticLambda6
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i) {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            this.paint2.setStrokeWidth(AndroidUtilities.m1124dp(2.0f));
        }
        ...
        */
        ...
        public void setLink(TLRPC.TL_chatInviteExported tL_chatInviteExported, int i) {
            ...
            if (tL_chatInviteExported.subscription_pricing != null) {
                ...
                if (i3 == 2592000) {
                    this.priceSubitleView.setText(LocaleController.getString(C2888R.string.StarsParticipantSubscriptionPerMonth));
                } else if (i3 == 300) {
                    this.priceSubitleView.setText("per 5 minutes");
                } else if (i3 == 60) {
                    this.priceSubitleView.setText("each minute");
                }
                iM1124dp = AndroidUtilities.m1124dp(28.0f) + ((int) Math.max(HintView2.measureCorrectly(this.priceTitleView.getText(), this.priceTitleView.getPaint()), HintView2.measureCorrectly(this.priceSubitleView.getText(), this.priceSubitleView.getPaint())));
            } else {
                this.priceLayout.setVisibility(8);
                this.optionsView.setVisibility(8);
            }
            ((ViewGroup.MarginLayoutParams) this.textLayout.getLayoutParams()).rightMargin = iM1124dp;
            ...
            if (i4 == 0 && tL_chatInviteExported.usage_limit == 0 && tL_chatInviteExported.requested == 0) {
                pluralString = LocaleController.getString(tL_chatInviteExported.subscription_pricing != null ? C2888R.string.NoOneSubscribed : C2888R.string.NoOneJoined);
            } else {
            ...
            if (tL_chatInviteExported.permanent && !tL_chatInviteExported.revoked) {
                ...
                dotDividerSpan.setTopPadding(AndroidUtilities.m1124dp(1.5f));
                ...
                spannableStringBuilder2.append((CharSequence) LocaleController.getString(C2888R.string.Permanent));
            ...
            if (tL_chatInviteExported.expired || tL_chatInviteExported.revoked) {
                ...
                dotDividerSpan2.setTopPadding(AndroidUtilities.m1124dp(1.5f));
                ...
                if (z || (i2 = tL_chatInviteExported.usage_limit) <= 0 || tL_chatInviteExported.usage < i2) {
                    spannableStringBuilder3.append((CharSequence) LocaleController.getString(z ? C2888R.string.Revoked : C2888R.string.Expired));
                } else {
                    spannableStringBuilder3.append((CharSequence) LocaleController.getString(C2888R.string.LinkLimitReached));
                }
            ...
            if (tL_chatInviteExported.expire_date > 0) {
                ...
                dotDividerSpan3.setTopPadding(AndroidUtilities.m1124dp(1.5f));
    ...
    class C60966 implements LinkEditActivity.Callback {
        C60966() {
        }
