...
public class GroupCallUserCell extends FrameLayout {
    ...
    /* JADX INFO: renamed from: onMuteClick, reason: merged with bridge method [inline-methods] */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Removed duplicated region for block: B:7:0x0017 A[PHI: r2 r3
  ...
  0x0017: PHI (r3v2 int) = (r3v0 int), (r3v1 int) binds: [B:6:0x0015, B:12:0x0026] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public /* synthetic */ void lambda$new$1() {
        ...
        L2b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Cells.GroupCallUserCell.lambda$new$1():void");
    }
    ...
    public void setProgressToAvatarPreview(float f) {
        ...
        this.nameTextView.setTranslationX((LocaleController.isRTL ? AndroidUtilities.m1124dp(53.0f) : -AndroidUtilities.m1124dp(53.0f)) * f);
        if (isSelfUser() && f > 0.0f) {
            float f2 = 1.0f - f;
            this.fullAboutTextView.setTranslationX((LocaleController.isRTL ? -AndroidUtilities.m1124dp(53.0f) : AndroidUtilities.m1124dp(53.0f)) * f2);
            ...
            int iM1124dp = AndroidUtilities.m1124dp(53.0f);
            if (!z) {
                iM1124dp = -iM1124dp;
            }
            simpleTextView.setTranslationX(iM1124dp * f);
        } else {
            ...
            while (true) {
                ...
                if (!TextUtils.isEmpty(simpleTextViewArr[4].getText()) && this.statusTextView[4].getLineCount() > 1) {
                    this.statusTextView[i].setFullLayoutAdditionalWidth(AndroidUtilities.m1124dp(92.0f), LocaleController.isRTL ? AndroidUtilities.m1124dp(48.0f) : AndroidUtilities.m1124dp(53.0f));
                    this.statusTextView[i].setFullAlpha(f);
                    this.statusTextView[i].setTranslationX(0.0f);
                    this.statusTextView[i].invalidate();
                } else {
                    this.statusTextView[i].setTranslationX((LocaleController.isRTL ? AndroidUtilities.m1124dp(53.0f) : -AndroidUtilities.m1124dp(53.0f)) * f);
    ...
    private static class VerifiedDrawable extends Drawable {
        ...
        public VerifiedDrawable(Context context) {
            ...
            drawableArr[0] = context.getResources().getDrawable(C2888R.drawable.verified_area).mutate();
            this.drawables[0].setColorFilter(new PorterDuffColorFilter(-9063442, PorterDuff.Mode.MULTIPLY));
            this.drawables[1] = context.getResources().getDrawable(C2888R.drawable.verified_check).mutate();
        }
    ...
    public GroupCallUserCell(Context context) {
        ...
        radialProgressView.setSize(AndroidUtilities.m1124dp(26.0f));
        ...
        this.nameTextView.setDrawablePadding(AndroidUtilities.m1124dp(6.0f));
        ...
        this.leftDrawable = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(this.nameTextView, AndroidUtilities.m1124dp(20.0f), 9);
        this.rightDrawable = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(this.nameTextView, AndroidUtilities.m1124dp(20.0f), 9);
        Drawable drawable = context.getResources().getDrawable(C2888R.drawable.voice_volume_mini);
        ...
        while (true) {
            ...
            if (i == 4) {
                ...
                if (i == 0) {
                    ...
                    this.statusTextView[i].setText(LocaleController.getString(C2888R.string.Listening));
                } else if (i == 1) {
                    this.statusTextView[i].setTextColor(Theme.getColor(Theme.key_voipgroup_speakingText));
                    this.statusTextView[i].setText(LocaleController.getString(C2888R.string.Speaking));
                    this.statusTextView[i].setDrawablePadding(AndroidUtilities.m1124dp(2.0f));
                } else if (i == 2) {
                    this.statusTextView[i].setTextColor(Theme.getColor(Theme.key_voipgroup_mutedByAdminIcon));
                    this.statusTextView[i].setText(LocaleController.getString(C2888R.string.VoipGroupMutedForMe));
                } else if (i == 3) {
                    this.statusTextView[i].setTextColor(Theme.getColor(Theme.key_voipgroup_listeningText));
                    this.statusTextView[i].setText(LocaleController.getString(C2888R.string.WantsToSpeak));
                }
        ...
        this.muteDrawable = new RLottieDrawable(C2888R.raw.voice_outlined2, _UrlKt.FRAGMENT_ENCODE_SET + C2888R.raw.voice_outlined2, AndroidUtilities.m1124dp(34.0f), AndroidUtilities.m1124dp(32.0f), true, null);
        this.shakeHandDrawable = new RLottieDrawable(C2888R.raw.hand_1, _UrlKt.FRAGMENT_ENCODE_SET + C2888R.raw.hand_1, AndroidUtilities.m1124dp(34.0f), AndroidUtilities.m1124dp(32.0f), true, null);
        ...
        this.avatarWavesDrawable = new AvatarWavesDrawable(AndroidUtilities.m1124dp(26.0f), AndroidUtilities.m1124dp(29.0f));
    ...
    public int getClipHeight() {
        ...
        if (simpleTextView.getLineCount() > 1) {
            return simpleTextView.getTop() + simpleTextView.getTextHeight() + AndroidUtilities.m1124dp(8.0f);
        }
    ...
    public boolean isSelfUser() {
        ...
        if (j > 0) {
            ...
            return user != null && user.f1825id == j;
        }
        TLRPC.Chat chat = this.currentChat;
        return chat != null && chat.f1660id == (-j);
    }
            ...
            if (user != null && user.verified) {
                ...
                if (user2 != null && user2.premium) {
                    if (this.premiumDrawable == null) {
                        ...
                        this.premiumDrawable = new AnimatedEmojiDrawable.WrapSizeDrawable(this.premiumDrawable, AndroidUtilities.m1124dp(14.0f), AndroidUtilities.m1124dp(14.0f)) { // from class: org.telegram.ui.Cells.GroupCallUserCell.3
                            @Override // org.telegram.ui.Components.AnimatedEmojiDrawable.WrapSizeDrawable, android.graphics.drawable.Drawable
                            public void draw(Canvas canvas) {
                                canvas.save();
                                canvas.translate(AndroidUtilities.m1124dp(-2.0f), AndroidUtilities.m1124dp(0.0f));
                                super.draw(canvas);
                                canvas.restore();
                            }
                        };
    ...
    */
    private void applyParticipantChanges(boolean r21, boolean r22) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Cells.GroupCallUserCell.applyParticipantChanges(boolean, boolean):void");
    }
    ...
    public void applyStatus(int i) {
        ...
        if (i == 0) {
            while (true) {
                ...
                simpleTextViewArr[i2].setTranslationY(i2 == i ? 0.0f : AndroidUtilities.m1124dp(-2.0f));
            ...
            while (true) {
                ...
                if (i2 == i) {
                    ...
                    fM1124dp = AndroidUtilities.m1124dp(i2 == 0 ? 2.0f : -2.0f);
                }
                simpleTextView.setTranslationY(fM1124dp);
                this.statusTextView[i2].setAlpha(i2 == i ? 1.0f : 0.0f);
                i2++;
            }
        }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (this.needDivider) {
            ...
            canvas2 = canvas;
            canvas2.drawLine(LocaleController.isRTL ? 0.0f : AndroidUtilities.m1124dp(68.0f), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m1124dp(68.0f) : 0), getMeasuredHeight() - 1, this.dividerPaint);
    ...
    public static class AvatarWavesDrawable {
        ...
        */
        public void draw(android.graphics.Canvas r8, float r9, float r10, android.view.View r11) {
            ...
            L1f:
                r8.save()
                org.telegram.ui.Components.CubicBezierInterpolator r0 = org.telegram.p029ui.Components.CubicBezierInterpolator.DEFAULT
            ...
            L61:
                ...
                r4 = 2
                if (r3 != r4) goto L77
                int r3 = org.telegram.p029ui.ActionBar.Theme.key_voipgroup_mutedByAdminIcon
            L72:
                int r3 = org.telegram.p029ui.ActionBar.Theme.getColor(r3)
                goto L7a
            L77:
                int r3 = org.telegram.p029ui.ActionBar.Theme.key_voipgroup_listeningText
                goto L72
            L7a:
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (accessibilityNodeInfo.isEnabled()) {
            ...
            accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, LocaleController.getString((!groupCallParticipant.muted || groupCallParticipant.can_self_unmute) ? C2888R.string.VoipMute : C2888R.string.VoipUnmute)));
        }
    }
