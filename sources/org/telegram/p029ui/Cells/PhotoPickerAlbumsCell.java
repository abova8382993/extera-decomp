...
public class PhotoPickerAlbumsCell extends FrameLayout {
    ...
    private class AlbumView extends FrameLayout {
        ...
        public AlbumView(Context context) {
            ...
            linearLayout.setBackgroundResource(C2888R.drawable.album_shadow);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (AndroidUtilities.isTablet()) {
            iM1124dp = ((AndroidUtilities.m1124dp(490.0f) - AndroidUtilities.m1124dp(12.0f)) - ((this.albumsCount - 1) * AndroidUtilities.m1124dp(4.0f))) / this.albumsCount;
        } else {
            iM1124dp = ((AndroidUtilities.displaySize.x - AndroidUtilities.m1124dp(12.0f)) - ((this.albumsCount - 1) * AndroidUtilities.m1124dp(4.0f))) / this.albumsCount;
        }
        for (int i3 = 0; i3 < this.albumsCount; i3++) {
            ...
            layoutParams.topMargin = AndroidUtilities.m1124dp(4.0f);
            layoutParams.leftMargin = (AndroidUtilities.m1124dp(4.0f) + iM1124dp) * i3;
            layoutParams.width = iM1124dp;
            layoutParams.height = iM1124dp;
            layoutParams.gravity = 51;
            this.albumViews[i3].setLayoutParams(layoutParams);
        }
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(4.0f) + iM1124dp, TLObject.FLAG_30));
    }
}
