...
import org.telegram.p029ui.Components.CheckBox;
...
public abstract class WallpaperCell extends FrameLayout {
    ...
    public class WallpaperView extends FrameLayout {
        ...
        public WallpaperView(Context context) {
            ...
            BackupImageView backupImageView = new BackupImageView(context) { // from class: org.telegram.ui.Cells.WallpaperCell.WallpaperView.1
                ...
                protected void onDraw(Canvas canvas) {
                    ...
                    if (WallpaperView.this.isSelected) {
                        ...
                        canvas2.drawCircle(measuredWidth, measuredHeight, AndroidUtilities.m1124dp(20.0f), WallpaperCell.this.circlePaint);
            ...
            imageView.setImageResource(C2888R.drawable.ic_gallery_background);
            ...
            CheckBox checkBox = new CheckBox(context, C2888R.drawable.round_check2);
        ...
        public void setWallpaper(Object obj, Object obj2, Drawable drawable, boolean z) {
            ...
            if (obj instanceof TLRPC.TL_wallPaper) {
                ...
                TLRPC.PhotoSize closestPhotoSizeWithSize = FileLoader.getClosestPhotoSizeWithSize(tL_wallPaper.document.thumbs, AndroidUtilities.m1124dp(100));
                TLRPC.PhotoSize closestPhotoSizeWithSize2 = FileLoader.getClosestPhotoSizeWithSize(tL_wallPaper.document.thumbs, AndroidUtilities.m1124dp(180));
                ...
                if (colorWallpaper.path != null || colorWallpaper.pattern != null || "d".equals(colorWallpaper.slug)) {
                    ...
                    if ("d".equals(colorWallpaper.slug)) {
                        if (colorWallpaper.defaultCache == null) {
                            colorWallpaper.defaultCache = SvgHelper.getBitmap(C2888R.raw.default_pattern, 100, 180, -16777216);
                        }
            ...
            if (obj instanceof MediaController.SearchImage) {
                ...
                if (photo != null) {
                    TLRPC.PhotoSize closestPhotoSizeWithSize4 = FileLoader.getClosestPhotoSizeWithSize(photo.sizes, AndroidUtilities.m1124dp(100));
                    TLRPC.PhotoSize closestPhotoSizeWithSize5 = FileLoader.getClosestPhotoSizeWithSize(searchImage.photo.sizes, AndroidUtilities.m1124dp(180));
    ...
    public WallpaperCell(Context context, int i) {
        ...
        while (true) {
            ...
            if (i2 < wallpaperViewArr.length) {
                ...
                this.checkDrawable = context.getResources().getDrawable(C2888R.drawable.background_selected).mutate();
    ...
    protected void onMeasure(int i, int i2) {
        int i3 = 0;
        if (this.spanCount == 1) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(this.size + AndroidUtilities.m1124dp(6.0f), TLObject.FLAG_30));
            setPadding(0, 0, 0, AndroidUtilities.m1124dp(6.0f));
            return;
        }
        int size = View.MeasureSpec.getSize(i);
        int iM1124dp = size - AndroidUtilities.m1124dp(((this.spanCount - 1) * 6) + 28);
        int i4 = iM1124dp / this.spanCount;
        int i5 = this.currentType;
        int iM1124dp2 = (i5 == 0 || i5 == 2 || i5 == 3) ? AndroidUtilities.m1124dp(180.0f) : i4;
        setMeasuredDimension(size, (this.isTop ? AndroidUtilities.m1124dp(14.0f) : 0) + iM1124dp2 + AndroidUtilities.m1124dp(this.isBottom ? 14.0f : 6.0f));
        while (true) {
            int i6 = this.spanCount;
            if (i3 >= i6) {
                return;
            }
            this.wallpaperViews[i3].measure(View.MeasureSpec.makeMeasureSpec(i3 == i6 + (-1) ? iM1124dp : i4, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(iM1124dp2, TLObject.FLAG_30));
            iM1124dp -= i4;
            i3++;
        }
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int iM1124dp2 = this.isTop ? AndroidUtilities.m1124dp(14.0f) : 0;
        for (int i5 = 0; i5 < this.spanCount; i5++) {
            ...
            wallpaperView.layout(iM1124dp, iM1124dp2, iM1124dp + measuredWidth, wallpaperView.getMeasuredHeight() + iM1124dp2);
            iM1124dp += measuredWidth + AndroidUtilities.m1124dp(6.0f);
        }
    }
