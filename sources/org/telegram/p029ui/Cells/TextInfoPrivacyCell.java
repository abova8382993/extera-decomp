...
public class TextInfoPrivacyCell extends FrameLayout {
    ...
    public TextInfoPrivacyCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        C34471 c34471 = new LinkSpanDrawable.LinksTextView(context, linkCollector, resourcesProvider) { // from class: org.telegram.ui.Cells.TextInfoPrivacyCell.1
            C34471(Context context2, LinkSpanDrawable.LinkCollector linkCollector2, Theme.ResourcesProvider resourcesProvider2) {
                super(context2, linkCollector2, resourcesProvider2);
            }
        ...
        this.textView = c34471;
        c34471.setTextSize(1, 14.0f);
        this.textView.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_REGULAR));
        this.textView.setGravity(LocaleController.isRTL ? 5 : 3);
        this.textView.setPadding(0, AndroidUtilities.m1124dp(10.0f), 0, AndroidUtilities.m1124dp(17.0f));
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Cells.TextInfoPrivacyCell$1 */
    class C34471 extends LinkSpanDrawable.LinksTextView {
        C34471(Context context2, LinkSpanDrawable.LinkCollector linkCollector2, Theme.ResourcesProvider resourcesProvider2) {
            super(context2, linkCollector2, resourcesProvider2);
        }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (i3 == -1) {
            ...
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(this.fixedSize), TLObject.FLAG_30));
        } else {
    ...
    public void setText(CharSequence charSequence) {
        ...
        if (charSequence == null) {
            this.textView.setPadding(0, AndroidUtilities.m1124dp(2.0f), 0, 0);
        } else {
            this.textView.setPadding(0, AndroidUtilities.m1124dp(this.topPadding), 0, AndroidUtilities.m1124dp(this.bottomPadding));
        }
