...
import org.telegram.p029ui.Components.CornerPath;
...
public abstract class TextSelectionHelper {
        ...
        public void run() {
            ...
            if (TextSelectionHelper.this.scrolling) {
                ...
                if (textSelectionHelper.multiselect && textSelectionHelper.selectedView == null) {
                    lineHeight = AndroidUtilities.m1124dp(8.0f);
    ...
    final Runnable startSelectionRunnable = new Runnable() { // from class: org.telegram.ui.Cells.TextSelectionHelper.2
        ...
        public void run() {
            ...
            if (charOffsetFromCord >= text.length()) {
                ...
                if (f < textSelectionHelper6.layoutBlock.layout.getLineRight(lineCount) + AndroidUtilities.m1124dp(4.0f) && f > TextSelectionHelper.this.layoutBlock.layout.getLineLeft(lineCount)) {
    ...
    class RunnableC34491 implements Runnable {
        RunnableC34491() {
        }
    ...
    class RunnableC34502 implements Runnable {
        RunnableC34502() {
        }
    ...
    public TextSelectionHelper() {
        ...
        this.cornerRadius = fM1124dp;
        paint.setPathEffect(new CornerPathEffect(fM1124dp));
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            this.textArea.inset(-AndroidUtilities.m1124dp(8.0f), -AndroidUtilities.m1124dp(8.0f));
            if (!this.textArea.contains(this.capturedX, this.capturedY) || this.maybeSelectedView == null) {
                ...
                if (charOffsetFromCord >= text.length()) {
                    ...
                    if (f < textSelectionHelper.layoutBlock.layout.getLineRight(lineCount) + AndroidUtilities.m1124dp(4.0f) && f > textSelectionHelper.layoutBlock.layout.getLineLeft(lineCount)) {
                        charOffsetFromCord = text.length() - 1;
                    }
                }
                if (charOffsetFromCord >= 0 && charOffsetFromCord < text.length() && text.charAt(charOffsetFromCord) != '\n') {
    ...
    public void showMagnifier(int i) {
        ...
        int lineTop = (int) (((((layout.getLineTop(lineForOffset) + this.textY) + coordsInParent[1]) - lineBottom) - AndroidUtilities.m1124dp(8.0f)) + this.layoutBlock.yOffset);
        ...
        if (this.magnifier == null) {
            TextSelectionHelper$$ExternalSyntheticApiModelOutline1.m1235m();
            this.magnifier = TextSelectionHelper$$ExternalSyntheticApiModelOutline0.m1234m(this.textSelectionOverlay);
        ...
        this.magnifier.show(this.magnifierXanimated, this.magnifierYanimated + (lineBottom * 1.5f) + AndroidUtilities.m1124dp(8.0f));
    ...
    class RunnableC34513 implements Runnable {
        RunnableC34513() {
        }
    ...
    public class TextSelectionOverlay extends View {
        ...
        /* JADX WARN: Removed duplicated region for block: B:345:0x00f8  */
        /* JADX WARN: Removed duplicated region for block: B:353:0x012d  */
        /* JADX WARN: Removed duplicated region for block: B:562:0x04c6  */
    ...
    class ActionModeCallbackC34524 implements ActionMode.Callback {
        ...
        ActionModeCallbackC34524() {
        }

        @Override // android.view.ActionMode.Callback
        public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            menu.add(0, R.id.copy, 0, R.string.copy);
            menu.add(0, C2888R.id.menu_quote, 1, LocaleController.getString(C2888R.string.Quote));
            menu.add(0, R.id.selectAll, 2, R.string.selectAll);
            menu.add(0, 3, 3, LocaleController.getString(C2888R.string.TranslateMessage));
            return true;
        }
        ...
        public /* synthetic */ void lambda$onPrepareActionMode$1(Menu menu, Exception exc) {
            FileLog.m1134e("mlkit: failed to detect language in selection");
            FileLog.m1136e(exc);
            this.translateFromLanguage = null;
            updateTranslateButton(menu);
        }
        ...
        public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
            ...
            if (itemId == C2888R.id.menu_quote) {
    ...
    private ActionMode.Callback createActionCallback() {
        return new ActionMode.Callback2() { // from class: org.telegram.ui.Cells.TextSelectionHelper.5
            ...
            C34535(ActionMode.Callback callback) {
                callback = callback;
            }
            ...
            public void onGetContentRect(ActionMode actionMode, View view, Rect rect) {
                ...
                if (TextSelectionHelper.this.isInSelectionMode()) {
                    ...
                    if (textSelectionHelper.selectedView != null) {
                        ...
                        int iM1124dp = (((iArrOffsetToCord[1] + textSelectionHelper3.textY) + coordsInParent[1]) + (i3 / 2)) - AndroidUtilities.m1124dp(4.0f);
                        if (iM1124dp >= 1) {
                            i2 = iM1124dp;
                        }
                    } else {
    ...
    class C34535 extends ActionMode.Callback2 {
        final /* synthetic */ ActionMode.Callback val$callback;
    ...
    /* JADX WARN: Removed duplicated region for block: B:120:0x0106 A[LOOP:1: B:119:0x0104->B:120:0x0106, LOOP_END] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    protected void drawSelection(android.graphics.Canvas r24, android.text.Layout r25, int r26, int r27, boolean r28, boolean r29, float r30) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Cells.TextSelectionHelper.drawSelection(android.graphics.Canvas, android.text.Layout, int, int, boolean, boolean, float):void");
    }
    ...
    public static class SimpleTextSelectionHelper extends TextSelectionHelper {
        ...
        @Override // org.telegram.p029ui.Cells.TextSelectionHelper
    ...
    public static class ChatListTextSelectionHelper extends TextSelectionHelper {
        ...
        public void draw(MessageObject messageObject, MessageObject.TextLayoutBlock textLayoutBlock, Canvas canvas) {
            ...
            if (iClamp != iClamp2) {
                ...
                if (textLayoutBlock.quote) {
                    ...
                    iM1124dp = AndroidUtilities.m1124dp(0.0f);
                }
                drawSelection(canvas, textLayoutBlock.textLayout, iClamp, iClamp2, true, true, iM1124dp);
            }
        }
            ...
            if (chatMessageCell.hasCaptionLayout()) {
                ...
                for (int i3 = 0; i3 < captionLayout.textLayoutBlocks.size(); i3++) {
                    ...
                    if (f >= textLayoutBlock.textYOffset(captionLayout.textLayoutBlocks) && f <= textLayoutBlock.textYOffset(captionLayout.textLayoutBlocks) + textLayoutBlock.padTop + textLayoutBlock.height(chatMessageCell.transitionParams)) {
                        ...
                        float f2 = -(textLayoutBlock.isRtl() ? ((int) Math.ceil(captionLayout.textXOffset)) - (textLayoutBlock.quote ? AndroidUtilities.m1124dp(10.0f) : 0) : 0);
                        layoutBlock.xOffset = f2;
                        if (textLayoutBlock.code && !textLayoutBlock.quote) {
                            layoutBlock.xOffset = f2 + AndroidUtilities.m1124dp(8.0f);
                        }
            ...
            for (int i4 = 0; i4 < messageObject.textLayoutBlocks.size(); i4++) {
                ...
                if (f3 >= textLayoutBlock2.textYOffset(messageObject.textLayoutBlocks) && f3 <= textLayoutBlock2.textYOffset(messageObject.textLayoutBlocks) + textLayoutBlock2.padTop + textLayoutBlock2.height(chatMessageCell.transitionParams)) {
                    ...
                    if (textLayoutBlock2.quote) {
                        ...
                        iM1124dp = textLayoutBlock2.code ? AndroidUtilities.m1124dp(0.0f) : 0;
                    }
                    float f4 = -(textLayoutBlock2.isRtl() ? ((int) Math.ceil(messageObject.textXOffset)) - iM1124dp : 0);
                    layoutBlock.xOffset = f4;
                    if (textLayoutBlock2.code && !textLayoutBlock2.quote) {
                        layoutBlock.xOffset = f4 + AndroidUtilities.m1124dp(8.0f);
                    }
        ...
        protected void fillLayoutForOffset(int i, LayoutBlock layoutBlock, boolean z) {
            ...
            if (chatMessageCell.hasCaptionLayout()) {
                ...
                if (captionLayout.textLayoutBlocks.size() == 1) {
                    ...
                    float f = -(textLayoutBlock.isRtl() ? ((int) Math.ceil(captionLayout.textXOffset)) - (textLayoutBlock.quote ? AndroidUtilities.m1124dp(10.0f) : 0) : 0);
                    layoutBlock.xOffset = f;
                    if (textLayoutBlock.code && !textLayoutBlock.quote) {
                        layoutBlock.xOffset = f + AndroidUtilities.m1124dp(8.0f);
                    }
                    layoutBlock.charOffset = 0;
                    return;
                }
                for (int i2 = 0; i2 < captionLayout.textLayoutBlocks.size(); i2++) {
                    ...
                    if (i3 >= 0 && i3 <= textLayoutBlock2.textLayout.getText().length()) {
                        ...
                        float f2 = -(textLayoutBlock2.isRtl() ? ((int) Math.ceil(captionLayout.textXOffset)) - (textLayoutBlock2.quote ? AndroidUtilities.m1124dp(10.0f) : 0) : 0);
                        layoutBlock.xOffset = f2;
                        if (textLayoutBlock2.code && !textLayoutBlock2.quote) {
                            layoutBlock.xOffset = f2 + AndroidUtilities.m1124dp(8.0f);
                        }
            ...
            if (arrayList.size() == 1) {
                ...
                float f3 = -(textLayoutBlock3.isRtl() ? ((int) Math.ceil(messageObject.textXOffset)) - (textLayoutBlock3.quote ? AndroidUtilities.m1124dp(10.0f) : 0) : 0);
                layoutBlock.xOffset = f3;
                if (textLayoutBlock3.code && !textLayoutBlock3.quote) {
                    layoutBlock.xOffset = f3 + AndroidUtilities.m1124dp(8.0f);
                }
                layoutBlock.charOffset = 0;
                return;
            }
            for (int i4 = 0; i4 < messageObject.textLayoutBlocks.size(); i4++) {
                ...
                if (i5 >= 0 && i5 <= textLayoutBlock4.textLayout.getText().length()) {
                    ...
                    float f4 = -(textLayoutBlock4.isRtl() ? ((int) Math.ceil(messageObject.textXOffset)) - (textLayoutBlock4.quote ? AndroidUtilities.m1124dp(10.0f) : 0) : 0);
                    layoutBlock.xOffset = f4;
        ...
        protected void onExitSelectionMode(boolean z) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Cells.TextSelectionHelper$ChatListTextSelectionHelper$$ExternalSyntheticLambda0
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    TextSelectionHelper.ChatListTextSelectionHelper.m7019$r8$lambda$Gcwvj2Ry5WM_FcJtCCC93mDpYk(chatMessageCell, id, valueAnimator);
                }
            });
            valueAnimatorOfFloat.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Cells.TextSelectionHelper.ChatListTextSelectionHelper.1
                ...
                C34561(final ChatMessageCell chatMessageCell2) {
        ...
        public static /* synthetic */ void m7019$r8$lambda$Gcwvj2Ry5WM_FcJtCCC93mDpYk(ChatMessageCell chatMessageCell, int i, ValueAnimator valueAnimator) {
        ...
        /* JADX INFO: loaded from: classes6.dex */
        class C34561 extends AnimatorListenerAdapter {
            final /* synthetic */ ChatMessageCell val$cell;
    ...
    public static class ArticleTextSelectionHelper extends TextSelectionHelper {
        ...
        private int findClosestLayoutIndex(int i, int i2, ArticleSelectableView articleSelectableView) {
            ...
            if (row > 0 && i3 < AndroidUtilities.m1124dp(24.0f)) {
