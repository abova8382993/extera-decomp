...
public class SendLocationCell extends FrameLayout {
    ...
    */
    private void updateImage() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Cells.SendLocationCell.updateImage():void");
    }
    ...
    public void checkText() {
        ...
        if (sharingLocationInfo != null) {
            if (this.liveDisable) {
                String string = LocaleController.getString(C2888R.string.StopLiveLocation);
            ...
            setText(LocaleController.getString(C2888R.string.SharingLiveLocation), LocaleController.getString(C2888R.string.SharingLiveLocationAdd));
            return;
        }
        setText(LocaleController.getString(C2888R.string.SendLiveLocation), LocaleController.getString(C2888R.string.SendLiveLocationInfo));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!this.useDivider || (themePaint = Theme.getThemePaint("paintDivider", this.resourcesProvider)) == null) {
            ...
            canvas2 = canvas;
            canvas2.drawRect(LocaleController.isRTL ? 0.0f : AndroidUtilities.m1124dp(73.0f), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m1124dp(73.0f) : 0), getMeasuredHeight(), themePaint);
        }
        if (this.liveDisable) {
            return;
        }
        ...
        if (LocaleController.isRTL) {
            this.rect.set(AndroidUtilities.m1124dp(13.0f), (getMeasuredHeight() / 2.0f) - AndroidUtilities.m1124dp(15.0f), AndroidUtilities.m1124dp(43.0f), (getMeasuredHeight() / 2.0f) + AndroidUtilities.m1124dp(15.0f));
        } else {
            this.rect.set(getMeasuredWidth() - AndroidUtilities.m1124dp(43.0f), (getMeasuredHeight() / 2.0f) - AndroidUtilities.m1124dp(15.0f), getMeasuredWidth() - AndroidUtilities.m1124dp(13.0f), (getMeasuredHeight() / 2.0f) + AndroidUtilities.m1124dp(15.0f));
        }
        canvas2.save();
        float f4 = 1.0f;
        ...
        int iCenterY = (int) (rectF.centerY() - AndroidUtilities.m1124dp(13.0f));
        RectF rectF2 = this.rect;
        animatedTextDrawable.setBounds(i2, iCenterY, (int) rectF2.right, (int) (rectF2.centerY() + AndroidUtilities.m1124dp(12.0f)));
