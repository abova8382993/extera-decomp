...
public class EditTextCell extends FrameLayout {
    ...
    public EditTextCell(Context context, String str, final boolean z, final boolean z2, final int i, final Theme.ResourcesProvider resourcesProvider) {
        ...
        EditTextCaption editTextCaption = new EditTextCaption(context, resourcesProvider) { // from class: org.telegram.ui.Cells.EditTextCell.2
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                EditTextCell.this.limit.setBounds(getScrollX(), 0, ((getScrollX() + getWidth()) - getPaddingRight()) + AndroidUtilities.m1124dp(42.0f), getHeight());
            ...
            protected void extendActionMode(ActionMode actionMode, Menu menu) {
                if (z2 && menu.findItem(C2888R.id.menu_bold) == null) {
                    ...
                    menu.add(C2888R.id.menu_groupbolditalic, C2888R.id.menu_strike, 8, spannableStringBuilder3);
        ...
        editTextCaption.setPadding(AndroidUtilities.m1124dp(21.0f), AndroidUtilities.m1124dp(15.0f), AndroidUtilities.m1124dp((i > 0 ? 42 : 0) + 21), AndroidUtilities.m1124dp(15.0f));
    ...
    public ImageView setLeftDrawable(Drawable drawable) {
        ...
        layoutParams.leftMargin = AndroidUtilities.m1124dp(24.0f);
