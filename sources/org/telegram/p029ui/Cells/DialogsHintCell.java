...
public class DialogsHintCell extends FrameLayout {
    ...
    public DialogsHintCell(Context context) {
        ...
        setPadding(AndroidUtilities.m1124dp(9.0f), AndroidUtilities.m1124dp(5.0f), AndroidUtilities.m1124dp(9.0f), AndroidUtilities.m1124dp(7.0f));
        ...
        linearLayout.setPadding(LocaleController.isRTL ? AndroidUtilities.m1124dp(24.0f) : 0, 0, LocaleController.isRTL ? 0 : AndroidUtilities.m1124dp(24.0f), 0);
        ...
        imageView.setImageResource(C2888R.drawable.arrow_newchat);
        ...
        imageView2.setPadding(AndroidUtilities.m1124dp(6.0f), AndroidUtilities.m1124dp(6.0f), AndroidUtilities.m1124dp(6.0f), AndroidUtilities.m1124dp(6.0f));
    ...
    public void setAvatars(int i, ArrayList arrayList) {
        ...
        if (iMin <= 1) {
            avatarsImageView.setAvatarsTextSize(AndroidUtilities.m1124dp(22.0f));
            this.avatarsImageView.setSize(AndroidUtilities.m1124dp(36.0f));
        } else {
            avatarsImageView.setAvatarsTextSize(AndroidUtilities.m1124dp(20.0f));
            this.avatarsImageView.setSize(AndroidUtilities.m1124dp(30.0f));
        }
        this.avatarsImageView.setCount(iMin);
        this.avatarsImageView.setVisibility(iMin <= 0 ? 8 : 0);
        this.avatarsImageView.getLayoutParams().width = iMin <= 1 ? AndroidUtilities.m1124dp(36.0f) : AndroidUtilities.m1124dp(((iMin - 1) * 18) + 30);
        if (z) {
    ...
    public void setText(CharSequence charSequence, CharSequence charSequence2, boolean z, boolean z2) {
        ...
        int iM1124dp = z ? AndroidUtilities.m1124dp(24.0f) : 0;
        ...
        linearLayout.setPadding(i, 0, iM1124dp, 0);
        updateColors();
    }
