...
public class TextCheckCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        if (this.isMultiline) {
            ...
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(this.valueTextView.getVisibility() == 0 ? 64.0f : this.height) + (this.needDivider ? 1 : 0), TLObject.FLAG_30));
        }
    }
    ...
    public void setIcon(int i) {
        ...
        int iM1124dp = AndroidUtilities.m1124dp(71.0f);
        this.padding = iM1124dp;
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) this.textView.getLayoutParams();
        boolean z = LocaleController.isRTL;
        marginLayoutParams.leftMargin = z ? marginLayoutParams.leftMargin : iM1124dp;
        marginLayoutParams.rightMargin = z ? iM1124dp : marginLayoutParams.rightMargin;
        ViewGroup.MarginLayoutParams marginLayoutParams2 = (ViewGroup.MarginLayoutParams) this.valueTextView.getLayoutParams();
        boolean z2 = LocaleController.isRTL;
        marginLayoutParams2.leftMargin = z2 ? marginLayoutParams2.leftMargin : iM1124dp;
        if (!z2) {
            iM1124dp = marginLayoutParams2.rightMargin;
        }
        marginLayoutParams2.rightMargin = iM1124dp;
    ...
    public void setTextAndValueAndCheck(CharSequence charSequence, String str, boolean z, boolean z2, boolean z3) {
        if (str != null && str.contains("->")) {
            this.valueTextView.setText(VerticalImageSpan.createSpan(getContext(), C2888R.drawable.search_arrow, str, "->", Theme.key_windowBackgroundWhiteGrayText2, this.resourcesProvider));
        } else {
        ...
        if (z2) {
            ...
            this.valueTextView.setPadding(0, 0, 0, AndroidUtilities.m1124dp(11.0f));
        } else {
            this.valueTextView.setLines(1);
            this.valueTextView.setMaxLines(1);
            this.valueTextView.setSingleLine(true);
        ...
        layoutParams.topMargin = AndroidUtilities.m1124dp(10.0f);
        this.textView.setLayoutParams(layoutParams);
    ...
    public void setAnimationProgress(float f) {
        ...
        float fMax = Math.max(lastTouchX, getMeasuredWidth() - lastTouchX) + AndroidUtilities.m1124dp(40.0f);
    ...
    private float getLastTouchX() {
        if (this.isAnimatingToThumbInsteadOfTouch) {
            return LocaleController.isRTL ? AndroidUtilities.m1124dp(22.0f) : getMeasuredWidth() - AndroidUtilities.m1124dp(42.0f);
        }
    ...
    */
    protected void onDraw(android.graphics.Canvas r8) {
        ...
        L37:
            ...
            goto L3c
        L39:
            android.graphics.Paint r0 = org.telegram.p029ui.ActionBar.Theme.dividerPaint
            goto L37
        L3c:
            if (r6 == 0) goto L83
        ...
        L83:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Cells.TextCheckCell.onDraw(android.graphics.Canvas):void");
    }
    ...
    public void setColorfullIcon(int i, int i2) {
        if (this.imageView == null) {
            ...
            this.padding = AndroidUtilities.m1124dp(65.0f);
        ...
        rLottieImageView2.setBackground(Theme.createRoundRectDrawable(iM1124dp, i));
    }
