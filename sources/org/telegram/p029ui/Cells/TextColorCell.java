...
public class TextColorCell extends FrameLayout {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.needDivider) {
            canvas2 = canvas;
            canvas2.drawLine(LocaleController.isRTL ? 0.0f : AndroidUtilities.m1124dp(20.0f), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m1124dp(20.0f) : 0), getMeasuredHeight() - 1, Theme.dividerPaint);
        } else {
            canvas2 = canvas;
        }
        ...
        if (i != 0) {
            ...
            canvas2.drawCircle(LocaleController.isRTL ? AndroidUtilities.m1124dp(33.0f) : getMeasuredWidth() - AndroidUtilities.m1124dp(33.0f), getMeasuredHeight() / 2, AndroidUtilities.m1124dp(10.0f), colorPaint);
        }
    }
}
