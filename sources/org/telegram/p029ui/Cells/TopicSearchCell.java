...
public class TopicSearchCell extends FrameLayout {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (this.drawDivider) {
            ...
            if (LocaleController.isRTL) {
                canvas.drawLine(0.0f, getMeasuredHeight() - 1, getMeasuredWidth() - iM1124dp, getMeasuredHeight() - 1, Theme.dividerPaint);
            } else {
                canvas.drawLine(iM1124dp, getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, Theme.dividerPaint);
            }
        }
    }
}
