...
import org.telegram.p029ui.ThemeSetUrlActivity;
...
public abstract class ThemesHorizontalListCell extends RecyclerListView implements NotificationCenter.NotificationCenterDelegate {
    ...
    class InnerThemeView extends FrameLayout {
        ...
        public InnerThemeView(Context context) {
            ...
            this.inDrawable = context.getResources().getDrawable(C2888R.drawable.minibubble_in).mutate();
            this.outDrawable = context.getResources().getDrawable(C2888R.drawable.minibubble_out).mutate();
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp((this.isLast ? 22 : 15) + 76 + (this.isFirst ? 22 : 0)), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(148.0f), TLObject.FLAG_30));
        }
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (action == 0 || action == 1) {
                ...
                if (x > this.rect.centerX() && y < this.rect.centerY() - AndroidUtilities.m1124dp(10.0f)) {
                    if (action == 0) {
                        this.pressed = true;
                    } else {
                        try {
        ...
        public void applyTheme() {
            ...
            if (this.themeInfo.pathToFile == null) {
                ...
                this.optionsDrawable = getResources().getDrawable(C2888R.drawable.preview_dots).mutate();
            ...
            if (i != 0 && themeInfo.previewBackgroundGradientColor2 != 0) {
                ...
                motionBackgroundDrawable.setRoundRadius(AndroidUtilities.m1124dp(6.0f));
                ...
                gradientDrawable.setCornerRadius(AndroidUtilities.m1124dp(6.0f));
                this.backgroundDrawable = gradientDrawable;
                dArrRgbToHsv = AndroidUtilities.rgbToHsv(Color.red(this.themeInfo.getPreviewBackgroundColor()), Color.green(this.themeInfo.getPreviewBackgroundColor()), Color.blue(this.themeInfo.getPreviewBackgroundColor()));
            } else if (themeInfo.previewWallpaperOffset > 0 || themeInfo.pathToWallpaper != null) {
                float fM1124dp = AndroidUtilities.m1124dp(76.0f);
                float fM1124dp2 = AndroidUtilities.m1124dp(97.0f);
                Theme.ThemeInfo themeInfo3 = this.themeInfo;
                Bitmap scaledBitmap = AndroidUtilities.getScaledBitmap(fM1124dp, fM1124dp2, themeInfo3.pathToWallpaper, themeInfo3.pathToFile, themeInfo3.previewWallpaperOffset);
            ...
            if (this.themeInfo.getPreviewBackgroundColor() == 0 && this.themeInfo.previewParsed && this.backgroundDrawable == null) {
                ...
                if (drawableCreateDefaultWallpaper instanceof MotionBackgroundDrawable) {
                    ((MotionBackgroundDrawable) drawableCreateDefaultWallpaper).setRoundRadius(AndroidUtilities.m1124dp(6.0f));
                }
            }
            invalidate();
        }
        ...
        public void setTheme(Theme.ThemeInfo themeInfo, boolean z, boolean z2) {
            ...
            layoutParams.leftMargin = AndroidUtilities.m1124dp(this.isFirst ? 49.0f : 27.0f);
            ...
            if (themeInfo3.pathToFile != null && !themeInfo3.previewParsed) {
                ...
                if ((!zExists || !parseTheme() || !zExists) && (tL_theme = (themeInfo2 = this.themeInfo).info) != null) {
                    if (tL_theme.document != null) {
                        ...
                        Drawable drawableMutate = getResources().getDrawable(C2888R.drawable.msg_theme).mutate();
                        ...
                        Drawable drawableMutate2 = getResources().getDrawable(C2888R.drawable.preview_custom).mutate();
        ...
        protected void onDraw(Canvas canvas) {
            ...
            int iM1124dp = this.isFirst ? AndroidUtilities.m1124dp(22.0f) : 0;
            float f = iM1124dp;
            float fM1124dp = AndroidUtilities.m1124dp(11.0f);
            this.rect.set(f, fM1124dp, AndroidUtilities.m1124dp(76.0f) + iM1124dp, r3 + AndroidUtilities.m1124dp(97.0f));
            String string = TextUtils.ellipsize(getThemeName(), this.textPaint, (getMeasuredWidth() - AndroidUtilities.m1124dp(this.isFirst ? 10.0f : 15.0f)) - (this.isLast ? AndroidUtilities.m1124dp(7.0f) : 0), TextUtils.TruncateAt.END).toString();
            ...
            canvas.drawText(string, ((AndroidUtilities.m1124dp(76.0f) - iCeil) / 2) + iM1124dp, AndroidUtilities.m1124dp(131.0f), this.textPaint);
            Theme.ThemeInfo themeInfo = this.themeInfo;
            ...
            if (tL_theme == null || (tL_theme.document != null && themeInfo.themeLoaded)) {
                ...
                if (drawable2 != null) {
                    if (this.bitmapShader != null) {
                        ...
                        if (f2 > this.rect.width()) {
                            this.shaderMatrix.setTranslate(f - ((f2 - this.rect.width()) / 2.0f), fM1124dp);
                        } else {
                            this.shaderMatrix.setTranslate(f, fM1124dp - (((height / fWidth) - this.rect.height()) / 2.0f));
                        }
                        this.shaderMatrix.preScale(fMin, fMin);
                        this.bitmapShader.setLocalMatrix(this.shaderMatrix);
                        canvas.drawRoundRect(this.rect, AndroidUtilities.m1124dp(6.0f), AndroidUtilities.m1124dp(6.0f), this.bitmapPaint);
                    } else {
                    ...
                    canvas.drawRoundRect(this.rect, AndroidUtilities.m1124dp(6.0f), AndroidUtilities.m1124dp(6.0f), this.paint);
                }
                ...
                this.inDrawable.setBounds(AndroidUtilities.m1124dp(6.0f) + iM1124dp, AndroidUtilities.m1124dp(22.0f), AndroidUtilities.m1124dp(49.0f) + iM1124dp, AndroidUtilities.m1124dp(36.0f));
                this.inDrawable.draw(canvas);
                this.outDrawable.setBounds(AndroidUtilities.m1124dp(27.0f) + iM1124dp, AndroidUtilities.m1124dp(41.0f), iM1124dp + AndroidUtilities.m1124dp(70.0f), AndroidUtilities.m1124dp(55.0f));
                this.outDrawable.draw(canvas);
                if (this.optionsDrawable != null && ThemesHorizontalListCell.this.currentType == 0) {
                    int iM1124dp2 = ((int) this.rect.right) - AndroidUtilities.m1124dp(16.0f);
                    int iM1124dp3 = ((int) this.rect.top) + AndroidUtilities.m1124dp(6.0f);
                    Drawable drawable3 = this.optionsDrawable;
                    drawable3.setBounds(iM1124dp2, iM1124dp3, drawable3.getIntrinsicWidth() + iM1124dp2, this.optionsDrawable.getIntrinsicHeight() + iM1124dp3);
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(32, LocaleController.getString(C2888R.string.AccDescrMoreOptions)));
        }
    }
    ...
    public /* synthetic */ void lambda$new$0(View view, int i) {
        ...
        if (left < 0) {
            smoothScrollBy(left - AndroidUtilities.m1124dp(8.0f), 0);
    ...
    public void scrollToCurrentTheme(int i, boolean z) {
        ...
        if (iIndexOf >= 0 || (iIndexOf = this.customThemes.indexOf(this.prevThemeInfo) + this.defaultThemes.size()) >= 0) {
            if (z) {
                ...
                this.horizontalLayoutManager.scrollToPositionWithOffset(iIndexOf, (i - AndroidUtilities.m1124dp(76.0f)) / 2);
            }
        }
    }
}
