...
public abstract class StickerEmojiCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, RecyclerListViewWithOverlayDraw.OverlayView {
    ...
    public StickerEmojiCell(Context context, boolean z, final Theme.ResourcesProvider resourcesProvider) {
        ...
        ImageReceiver imageReceiver = new ImageReceiver() { // from class: org.telegram.ui.Cells.StickerEmojiCell.1
            ...
            protected boolean setImageBitmapByKey(Drawable drawable, String str, int i, boolean z2, int i2) {
                if ((drawable instanceof BitmapDrawable) && StickerEmojiCell.this.editModeIconColor == 0) {
                    ...
                    StickerEmojiCell.this.editModeIcon.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1124dp(12.0f), StickerEmojiCell.this.editModeIconColor));
                    invalidate();
                }
        ...
        this.imageView.setRoundRadius(ExteraConfig.stickerShape == 0 ? 0 : AndroidUtilities.m1124dp(4.0f));
        ...
        premiumLockIconView.setPadding(AndroidUtilities.m1124dp(4.0f), AndroidUtilities.m1124dp(4.0f), AndroidUtilities.m1124dp(4.0f), AndroidUtilities.m1124dp(4.0f));
        ...
        imageView.setImageResource(C2888R.drawable.mini_more_dots);
        this.editModeIcon.setPadding(AndroidUtilities.m1124dp(2.0f), AndroidUtilities.m1124dp(2.0f), AndroidUtilities.m1124dp(2.0f), AndroidUtilities.m1124dp(2.0f));
        this.editModeIcon.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1124dp(12.0f), Theme.getColor(Theme.key_dialogTextGray2, resourcesProvider)));
    ...
    public MessageObject.SendAnimationData getSendAnimationData() {
        ...
        sendAnimationData.f1599x = imageReceiver.getCenterX() + r2[0];
        sendAnimationData.f1600y = imageReceiver.getCenterY() + r2[1];
    ...
    public void setSticker(TLRPC.Document document, SendMessagesHelper.ImportingSticker importingSticker, Object obj, String str, boolean z, boolean z2) {
        ...
        this.editModeIcon.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1124dp(12.0f), Theme.getColor(Theme.key_dialogTextGray2)));
        if (z2) {
        ...
        if (importingSticker != null) {
            ...
            if (document != null) {
                ...
                if (str != null) {
                    ...
                    this.emojiTextView.setText(Emoji.replaceEmoji(MediaDataController.getInstance(this.currentAccount).getEmojiForSticker(this.sticker.f1668id), this.emojiTextView.getPaint().getFontMetricsInt(), false));
                    this.emojiTextView.setVisibility(0);
                } else {
    ...
    private void updatePremiumStatus(boolean z) {
        ...
        if (!UserConfig.getInstance(this.currentAccount).isPremium()) {
            ...
            layoutParams.bottomMargin = AndroidUtilities.m1124dp(8.0f);
            this.premiumIconView.setPadding(AndroidUtilities.m1124dp(4.0f), AndroidUtilities.m1124dp(4.0f), AndroidUtilities.m1124dp(4.0f), AndroidUtilities.m1124dp(4.0f));
        } else {
            int iM1124dp2 = AndroidUtilities.m1124dp(16.0f);
            layoutParams.width = iM1124dp2;
            layoutParams.height = iM1124dp2;
            layoutParams.gravity = 85;
            layoutParams.bottomMargin = AndroidUtilities.m1124dp(8.0f);
            layoutParams.rightMargin = AndroidUtilities.m1124dp(8.0f);
            this.premiumIconView.setPadding(AndroidUtilities.m1124dp(1.0f), AndroidUtilities.m1124dp(1.0f), AndroidUtilities.m1124dp(1.0f), AndroidUtilities.m1124dp(1.0f));
        }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        String string = LocaleController.getString(C2888R.string.AttachSticker);
    ...
    */
    private void drawInternal(android.view.View r8, android.graphics.Canvas r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Cells.StickerEmojiCell.drawInternal(android.view.View, android.graphics.Canvas):void");
    }
}
