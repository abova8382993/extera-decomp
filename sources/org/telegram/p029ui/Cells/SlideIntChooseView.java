...
public class SlideIntChooseView extends FrameLayout {
    ...
    public SlideIntChooseView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        C34281 c34281 = new SeekBarView(context, resourcesProvider) { // from class: org.telegram.ui.Cells.SlideIntChooseView.1
            C34281(Context context2, Theme.ResourcesProvider resourcesProvider2) {
        ...
        this.seekBarView = c34281;
        c34281.setReportChanges(true);
        c34281.setDelegate(new SeekBarView.SeekBarViewDelegate() { // from class: org.telegram.ui.Cells.SlideIntChooseView.2
        ...
        addView(c34281, LayoutHelper.createFrame(-1, 38.0f, 55, 6.0f, 30.0f, 6.0f, 0.0f));
    }

    /* JADX INFO: renamed from: org.telegram.ui.Cells.SlideIntChooseView$1 */
    class C34281 extends SeekBarView {
        C34281(Context context2, Theme.ResourcesProvider resourcesProvider2) {
            super(context2, resourcesProvider2);
        }
    ...
    class C34292 implements SeekBarView.SeekBarViewDelegate {
        @Override // org.telegram.ui.Components.SeekBarView.SeekBarViewDelegate
        public /* synthetic */ CharSequence getContentDescription() {
            return SeekBarView.SeekBarViewDelegate.CC.$default$getContentDescription(this);
        }
    ...
    class C34303 extends AnimatorListenerAdapter {
        final /* synthetic */ float val$value;
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(75.0f), TLObject.FLAG_30));
        if (Build.VERSION.SDK_INT >= 29) {
            setSystemGestureExclusionRects(Arrays.asList(new Rect(0, 0, AndroidUtilities.m1124dp(80.0f), getMeasuredHeight()), new Rect(getMeasuredWidth() - AndroidUtilities.m1124dp(80.0f), 0, getMeasuredWidth(), getMeasuredHeight())));
        }
    }
