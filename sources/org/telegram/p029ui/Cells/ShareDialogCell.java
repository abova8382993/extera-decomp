...
public class ShareDialogCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ShareDialogCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        setBackground(Theme.createRadSelectorDrawable(Theme.getColor(Theme.key_listSelector, resourcesProvider), AndroidUtilities.m1124dp(2.0f), AndroidUtilities.m1124dp(2.0f)));
    }
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        if (i == NotificationCenter.userIsPremiumBlockedUpadted) {
            TL_account.RequirementToContact requirementToContactIsUserContactBlocked = this.user != null ? MessagesController.getInstance(this.currentAccount).isUserContactBlocked(this.user.f1825id) : null;
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(this.currentType == 2 ? 95.0f : 103.0f), TLObject.FLAG_30));
    }

    protected String repostToCustomName() {
        return LocaleController.getString(C2888R.string.FwdMyStory);
    }
    ...
    public void setDialog(long j, boolean z, CharSequence charSequence) {
        ...
        if (j == Long.MAX_VALUE) {
            ...
            if (this.currentType != 2 && UserObject.isReplyUser(this.user)) {
                this.nameTextView.setText(LocaleController.getString(C2888R.string.RepliesTitle));
                ...
                this.nameTextView.setText(LocaleController.getString(C2888R.string.SavedMessages));
    ...
    public void setTopic(TLRPC.TL_forumTopic tL_forumTopic, boolean z, boolean z2) {
        ...
        SpringAnimation springAnimation = (SpringAnimation) this.topicTextView.getTag(C2888R.id.spring_tag);
        ...
        if (z2) {
            ...
            this.topicTextView.setTag(C2888R.id.spring_tag, springAnimation2);
            springAnimation2.start();
        } else if (z4) {
            this.topicTextView.setAlpha(1.0f);
            this.nameTextView.setAlpha(0.0f);
            this.topicTextView.setTranslationX(0.0f);
            this.nameTextView.setTranslationX(AndroidUtilities.m1124dp(10.0f));
        } else {
            this.topicTextView.setAlpha(0.0f);
            this.nameTextView.setAlpha(1.0f);
            this.topicTextView.setTranslationX(-AndroidUtilities.m1124dp(10.0f));
    ...
    public /* synthetic */ void lambda$setTopic$1(DynamicAnimation dynamicAnimation, float f, float f2) {
        ...
        this.topicTextView.setTranslationX(f4 * (-AndroidUtilities.m1124dp(10.0f)));
        this.nameTextView.setTranslationX(f3 * AndroidUtilities.m1124dp(10.0f));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setTopic$2(DynamicAnimation dynamicAnimation, boolean z, float f, float f2) {
        this.topicTextView.setTag(C2888R.id.spring_tag, null);
    }
    ...
    */
    protected boolean drawChild(android.graphics.Canvas r25, android.view.View r26, long r27) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Cells.ShareDialogCell.drawChild(android.graphics.Canvas, android.view.View, long):boolean");
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int iM1124dp = AndroidUtilities.m1124dp(this.currentType == 2 ? 24.0f : 28.0f);
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.set(left - iM1124dp, top - iM1124dp, left + iM1124dp, top + iM1124dp);
        canvas.drawRoundRect(rectF, this.imageView.getRoundRadius()[0] + AndroidUtilities.m1124dp(2.0f), this.imageView.getRoundRadius()[0] + AndroidUtilities.m1124dp(2.0f), Theme.checkboxSquare_checkPaint);
        super.onDraw(canvas);
    }
    ...
    public static class RepostStoryDrawable extends Drawable {
        ...
        public RepostStoryDrawable(Context context, View view, boolean z, Theme.ResourcesProvider resourcesProvider) {
            this(context, view, z, C2888R.drawable.large_repost_story, resourcesProvider);
        }
        ...
        public RepostStoryDrawable(Context context, View view, boolean z, int i, Theme.ResourcesProvider resourcesProvider) {
            ...
            this.paint = paint;
            this.alpha = 255;
            LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, AndroidUtilities.m1124dp(56.0f), AndroidUtilities.m1124dp(56.0f), new int[]{Theme.getColor(Theme.key_stories_circle1, resourcesProvider), Theme.getColor(Theme.key_stories_circle2, resourcesProvider)}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP);
            this.gradient = linearGradient;
            paint.setShader(linearGradient);
            if (z) {
                RLottieDrawable rLottieDrawable = new RLottieDrawable(C2888R.raw.story_repost, "story_repost", AndroidUtilities.m1124dp(42.0f), AndroidUtilities.m1124dp(42.0f), true, null);
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.restore();
            int iM1124dp = AndroidUtilities.m1124dp(this.lottieDrawable != null ? 20.0f : 15.0f);
            Rect rect = AndroidUtilities.rectTmp2;
            rect.set(getBounds().centerX() - iM1124dp, getBounds().centerY() - iM1124dp, getBounds().centerX() + iM1124dp, getBounds().centerY() + iM1124dp);
