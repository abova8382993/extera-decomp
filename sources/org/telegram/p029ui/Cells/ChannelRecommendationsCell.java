...
public class ChannelRecommendationsCell {
    ...
    private float f1893lx;

    /* JADX INFO: renamed from: ly */
    private float f1894ly;
    ...
    private int blockWidth = AndroidUtilities.m1124dp(66.0f);
    ...
    public void setMessageObject(MessageObject messageObject) {
        ...
        this.serviceTextPaint.setTextSize(AndroidUtilities.m1124dp(14.0f));
        this.serviceTextPaint.setColor(this.cell.getThemedColor(Theme.key_chat_serviceText));
        this.serviceText = new StaticLayout(LocaleController.getString(C2888R.string.ChannelJoined), this.serviceTextPaint, this.msg.getMaxMessageTextWidth(), Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
        ...
        this.cell.totalHeight = AndroidUtilities.m1124dp(14.66f) + this.serviceTextHeight;
        ...
        if (this.headerText == null) {
            this.headerText = new Text(LocaleController.getString(this.dialogId > 0 ? C2888R.string.SimilarBots : C2888R.string.SimilarChannels), 14.0f, AndroidUtilities.bold()).hackClipBounds();
        }
        if (isExpanded()) {
            this.cell.totalHeight += AndroidUtilities.m1124dp(144.0f);
            this.backgroundPaint.setColor(this.cell.getThemedColor(Theme.key_chat_inBubble));
        }
        float size2 = (this.blockWidth * this.channels.size()) + (AndroidUtilities.m1124dp(9.0f) * (this.channels.size() - 1));
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.serviceText != null) {
            ...
            rectF.set((this.serviceTextLeft + width) - AndroidUtilities.m1124dp(8.66f), AndroidUtilities.m1124dp(4.0f), this.serviceTextRight + width + AndroidUtilities.m1124dp(8.66f), AndroidUtilities.m1124dp(10.66f) + this.serviceTextHeight);
            this.cell.drawServiceBackground(canvas, rectF, AndroidUtilities.m1124dp(11.0f), 1.0f);
            canvas.translate(width, AndroidUtilities.m1124dp(7.33f));
            this.serviceText.draw(canvas);
            canvas.restore();
            fM1124dp = AndroidUtilities.m1124dp(10.66f) + this.serviceTextHeight + 0.0f;
        } else {
            fM1124dp = 0.0f;
        }
        ...
        if (fClamp > 0.0f) {
            int width2 = this.cell.getWidth() - AndroidUtilities.m1124dp(18.0f);
            this.blockWidth = (int) (width2 > AndroidUtilities.m1124dp(441.0f) ? AndroidUtilities.m1124dp(66.0f) : Math.max((width2 / 4.5f) - AndroidUtilities.m1124dp(9.0f), AndroidUtilities.m1124dp(66.0f)));
            this.channelsScrollWidth = (r5 * this.channels.size()) + (AndroidUtilities.m1124dp(9.0f) * (this.channels.size() - 1));
            int iMin = (int) Math.min(width2, this.blockWidth * 6.5f);
            this.backgroundBounds.set((this.cell.getWidth() - iMin) / 2.0f, AndroidUtilities.m1124dp(10.0f) + fM1124dp, (this.cell.getWidth() + iMin) / 2.0f, fM1124dp + AndroidUtilities.m1124dp(138.0f));
            this.scrollX = Utilities.clamp(this.scrollX, this.channelsScrollWidth - (this.backgroundBounds.width() - AndroidUtilities.m1124dp(14.0f)), 0.0f);
            checkBackgroundPath(fClamp);
            canvas.save();
            float f5 = (0.6f * fClamp) + 0.4f;
            canvas.scale(f5, f5, this.backgroundBounds.centerX(), this.backgroundBounds.top - AndroidUtilities.m1124dp(6.0f));
            float f6 = 255.0f;
            ...
            float f7 = 20.0f;
            if (text != null) {
                text.draw(canvas, AndroidUtilities.m1124dp(17.0f) + this.backgroundBounds.left, AndroidUtilities.m1124dp(20.0f) + this.backgroundBounds.top, this.cell.getThemedColor(Theme.key_windowBackgroundWhiteBlackText), fClamp);
                canvas2 = canvas;
            } else {
                canvas2 = canvas;
            }
            float f8 = this.loadingAlpha.set(this.loading);
            float fM1124dp2 = (this.backgroundBounds.left + AndroidUtilities.m1124dp(7.0f)) - this.scrollX;
            float fM1124dp3 = this.blockWidth + AndroidUtilities.m1124dp(9.0f);
            int iFloor = (int) Math.floor(((this.backgroundBounds.left - iMin) - fM1124dp2) / fM1124dp3);
            int iCeil = (int) Math.ceil((this.backgroundBounds.right - fM1124dp2) / fM1124dp3);
            if (f8 < 1.0f) {
                ...
                while (true) {
                    ...
                    canvas2.save();
                    float f10 = f6;
                    canvas2.translate((iMax * fM1124dp3) + fM1124dp2, this.backgroundBounds.bottom - ChannelBlock.height());
            ...
            if (f8 > 0.0f) {
                ...
                for (int iMax2 = Math.max(0, iFloor); iMax2 < iCeil; iMax2++) {
                    ChannelBlock.fillPath(this.loadingPath, this.blockWidth, (iMax2 * fM1124dp3) + fM1124dp2);
                }
            ...
            float fM1124dp4 = this.backgroundBounds.right - AndroidUtilities.m1124dp(f13);
            float fM1124dp5 = this.backgroundBounds.top + AndroidUtilities.m1124dp(f13);
            canvas2.save();
            canvas2.scale(scale, scale, fM1124dp4, fM1124dp5);
            this.closePaint.setStrokeWidth(AndroidUtilities.m1124dp(1.33f));
            canvas2.drawLine(fM1124dp4 - AndroidUtilities.m1124dp(f2), fM1124dp5 - AndroidUtilities.m1124dp(f2), AndroidUtilities.m1124dp(f2) + fM1124dp4, AndroidUtilities.m1124dp(f2) + fM1124dp5, this.closePaint);
            canvas.drawLine(fM1124dp4 - AndroidUtilities.m1124dp(f2), fM1124dp5 + AndroidUtilities.m1124dp(f2), fM1124dp4 + AndroidUtilities.m1124dp(f2), fM1124dp5 - AndroidUtilities.m1124dp(f2), this.closePaint);
            this.closeBounds.set(fM1124dp4 - AndroidUtilities.m1124dp(12.0f), fM1124dp5 - AndroidUtilities.m1124dp(12.0f), fM1124dp4 + AndroidUtilities.m1124dp(12.0f), fM1124dp5 + AndroidUtilities.m1124dp(12.0f));
            canvas.restore();
            canvas.restore();
        }
    }
    ...
    private void checkBackgroundPath(float f) {
        ...
        float fM1124dp = AndroidUtilities.m1124dp(16.66f) * 2.0f;
        ...
        float f4 = rectF2.top;
        rectF.set(f3, f4, f3 + fM1124dp, f4 + fM1124dp);
        this.backgroundPath.arcTo(rectF, -90.0f, -90.0f);
        float f5 = this.backgroundBounds.left;
        float f6 = f2 - fM1124dp;
        rectF.set(f5, f6, f5 + fM1124dp, f2);
        this.backgroundPath.arcTo(rectF, -180.0f, -90.0f);
        float f7 = this.backgroundBounds.right;
        rectF.set(f7 - fM1124dp, f6, f7, f2);
        this.backgroundPath.arcTo(rectF, -270.0f, -90.0f);
        RectF rectF3 = this.backgroundBounds;
        float f8 = rectF3.right;
        float f9 = rectF3.top;
        rectF.set(f8 - fM1124dp, f9, f8, fM1124dp + f9);
        this.backgroundPath.arcTo(rectF, 0.0f, -90.0f);
        this.backgroundPath.lineTo(this.backgroundBounds.centerX() + AndroidUtilities.m1124dp(8.0f), this.backgroundBounds.top);
        this.backgroundPath.lineTo(this.backgroundBounds.centerX(), this.backgroundBounds.top - AndroidUtilities.m1124dp(6.0f));
        this.backgroundPath.lineTo(this.backgroundBounds.centerX() - AndroidUtilities.m1124dp(8.0f), this.backgroundBounds.top);
    ...
    static class ChannelBlock {
        ...
        public static int height() {
            return AndroidUtilities.m1124dp(99.0f);
        }
        ...
        public ChannelBlock(int i, final ChatMessageCell chatMessageCell, TLObject[] tLObjectArr, int i2) {
            ...
            this.bounce = new ButtonBounce(chatMessageCell) { // from class: org.telegram.ui.Cells.ChannelRecommendationsCell.ChannelBlock.1
                @Override // org.telegram.p029ui.Components.ButtonBounce
            ...
            this.nameTextPaint.setTextSize(AndroidUtilities.m1124dp(11.0f));
            boolean zIsPremium = UserConfig.getInstance(chatMessageCell.currentAccount).isPremium();
            this.name = LocaleController.getString(zIsPremium ? C2888R.string.MoreSimilar : C2888R.string.UnlockSimilar);
            this.subscribersStrokePaint.setStyle(Paint.Style.STROKE);
            this.isLock = true;
            this.subscribersDrawable = zIsPremium ? null : chatMessageCell.getContext().getResources().getDrawable(C2888R.drawable.mini_switch_lock).mutate();
        ...
        public ChannelBlock(int i, final ChatMessageCell chatMessageCell, TLObject tLObject) {
            ...
            this.subscribersStrokePaint.setStyle(Paint.Style.STROKE);
            this.isLock = false;
            this.subscribersDrawable = chatMessageCell.getContext().getResources().getDrawable(C2888R.drawable.mini_reply_user).mutate();
        ...
        public void drawText(Canvas canvas, int i, float f) {
            ...
            if (this.nameText != null) {
                canvas.save();
                canvas.translate((i - this.nameText.getWidth()) / 2.0f, AndroidUtilities.m1124dp(66.33f));
            ...
            if (text != null) {
                text.ellipsize(i - AndroidUtilities.m1124dp(32.0f));
                float fM1124dp = (f2 - (AndroidUtilities.m1124dp(this.subscribersDrawable != null ? 17.0f : 8.0f) + this.subscribersText.getWidth())) / 2.0f;
                float fM1124dp2 = AndroidUtilities.m1124dp(4.165f) + avatarSize();
                Drawable drawable = this.subscribersDrawable;
                if (drawable != null) {
                    drawable.setBounds((int) ((this.isLock ? this.subscribersText.getWidth() + AndroidUtilities.m1124dp(1.33f) : 0.0f) + fM1124dp + AndroidUtilities.m1124dp(3.0f)), (int) (fM1124dp2 - ((this.subscribersDrawable.getIntrinsicHeight() / 2.0f) * 0.625f)), (int) ((this.isLock ? this.subscribersText.getWidth() + AndroidUtilities.m1124dp(1.33f) : 0.0f) + fM1124dp + AndroidUtilities.m1124dp(3.0f) + (this.subscribersDrawable.getIntrinsicWidth() * 0.625f)), (int) (((this.subscribersDrawable.getIntrinsicHeight() / 2.0f) * 0.625f) + fM1124dp2));
                    this.subscribersDrawable.draw(canvas);
                }
                canvas2 = canvas;
                this.subscribersText.draw(canvas2, fM1124dp + AndroidUtilities.m1124dp(!this.isLock ? 12.66f : 4.0f), fM1124dp2, -1, f);
            } else {
                canvas2 = canvas;
            }
            canvas2.restore();
        ...
        */
        ...
        public static void fillPath(Path path, int i, float f) {
            ...
            path.addCircle((f2 / 2.0f) + f, AndroidUtilities.m1124dp(10.0f) + (avatarSize() / 2.0f), avatarSize() / 2.0f, direction);
            float f3 = 0.4f * f2;
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(((f2 - f3) / 2.0f) + f, AndroidUtilities.m1124dp(69.0f), ((f3 + f2) / 2.0f) + f, AndroidUtilities.m1124dp(79.0f));
            path.addRoundRect(rectF, AndroidUtilities.m1124dp(3.0f), AndroidUtilities.m1124dp(3.0f), direction);
            float f4 = 0.35f * f2;
            rectF.set(((f2 - f4) / 2.0f) + f, AndroidUtilities.m1124dp(83.0f), f + ((f2 + f4) / 2.0f), AndroidUtilities.m1124dp(91.0f));
            path.addRoundRect(rectF, AndroidUtilities.m1124dp(2.5f), AndroidUtilities.m1124dp(2.5f), direction);
        }
    ...
    */
    public boolean checkTouchEvent(android.view.MotionEvent r18) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Cells.ChannelRecommendationsCell.checkTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public void computeScroll() {
        if (this.scroller.computeScrollOffset()) {
            ...
            this.scrollX = currX;
            this.scrollX = Utilities.clamp(currX, this.channelsScrollWidth - (this.backgroundBounds.width() - AndroidUtilities.m1124dp(14.0f)), 0.0f);
            this.cell.invalidateOutbounds();
        }
    }

    private void scroll(float f) {
        this.scrollX = Utilities.clamp(this.scrollX + f, this.channelsScrollWidth - (this.backgroundBounds.width() - AndroidUtilities.m1124dp(14.0f)), 0.0f);
        this.cell.invalidateOutbounds();
    }
}
