...
public class ProfileSearchCell extends BaseCell implements NotificationCenter.NotificationCenterDelegate, Theme.Colorable {
    ...
    private TLRPC.TL_sponsoredPeer f1910ad;
    ...
    public ProfileSearchCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.countTop = AndroidUtilities.m1124dp(19.0f);
        ...
        AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable swapAnimatedEmojiDrawable = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(this, AndroidUtilities.m1124dp(20.0f));
        this.botVerificationDrawable = swapAnimatedEmojiDrawable;
        swapAnimatedEmojiDrawable.setCallback(this);
        AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable swapAnimatedEmojiDrawable2 = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(this, AndroidUtilities.m1124dp(20.0f));
    ...
    public void setData(Object obj, TLRPC.EncryptedChat encryptedChat, CharSequence charSequence, CharSequence charSequence2, boolean z, boolean z2) {
        ...
        if (obj instanceof TLRPC.User) {
            ...
            this.chat = null;
            this.contact = null;
            requirementToContactIsUserContactBlocked = this.showPremiumBlocked ? MessagesController.getInstance(this.currentAccount).isUserContactBlocked(this.user.f1825id) : null;
            ...
            if (this.showPremiumBlocked && contact.user != null) {
                requirementToContactIsUserContactBlocked = MessagesController.getInstance(this.currentAccount).isUserContactBlocked(this.contact.user.f1825id);
            }
            this.premiumBlocked = DialogObject.isPremiumBlocked(requirementToContactIsUserContactBlocked);
            this.starsPriceBlocked = DialogObject.getMessagesStarsPrice(requirementToContactIsUserContactBlocked);
            setOpenBotButton(false);
    ...
    public void setOpenBotButton(boolean z) {
        ...
        int currentWidth = z ? ((int) this.openButtonText.getCurrentWidth()) + AndroidUtilities.m1124dp(30.0f) : 0;
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (i == NotificationCenter.userIsPremiumBlockedUpadted) {
            ...
            if (this.user != null) {
                if (this.showPremiumBlocked) {
                    requirementToContactIsUserContactBlocked = MessagesController.getInstance(this.currentAccount).isUserContactBlocked(this.user.f1825id);
                }
            } else {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        setMeasuredDimension(View.MeasureSpec.getSize(i), this.callCellStyle ? AndroidUtilities.m1124dp(56.0f) : AndroidUtilities.m1124dp(60.0f) + (this.useSeparator ? 1 : 0));
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.checkBox != null) {
            int iM1124dp = LocaleController.isRTL ? (i3 - i) - AndroidUtilities.m1124dp(42.0f) : AndroidUtilities.m1124dp(42.0f);
            int iM1124dp2 = AndroidUtilities.m1124dp(36.0f);
            CheckBox2 checkBox2 = this.checkBox;
            checkBox2.layout(iM1124dp, iM1124dp2, checkBox2.getMeasuredWidth() + iM1124dp, this.checkBox.getMeasuredHeight() + iM1124dp2);
        }
        if (z) {
            buildLayout();
        }
    ...
    */
    public void buildLayout() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Cells.ProfileSearchCell.buildLayout():void");
    }
    ...
    */
    public void update(int r15) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Cells.ProfileSearchCell.update(int):void");
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.useSeparator) {
            ...
            if (LocaleController.isRTL) {
                canvas2 = canvas;
                canvas2.drawLine(0.0f, getMeasuredHeight() - 1, getMeasuredWidth() - AndroidUtilities.m1124dp(AndroidUtilities.leftBaseline), getMeasuredHeight() - 1, paint2);
            } else {
                canvas2 = canvas;
                canvas2.drawLine(AndroidUtilities.m1124dp(AndroidUtilities.leftBaseline), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, paint2);
            }
        } else {
            canvas2 = canvas;
        }
        ...
        if (staticLayout != null) {
            if (LocaleController.isRTL) {
                iCeil = (int) (this.nameLeft + staticLayout.getLineRight(0) + AndroidUtilities.m1124dp(6.0f));
            } else if (staticLayout.getLineLeft(0) == 0.0f) {
                iCeil = (this.nameLeft - AndroidUtilities.m1124dp(3.0f)) - this.botVerificationDrawable.getIntrinsicWidth();
            } else {
                iCeil = (int) (((((double) (this.nameLeft + this.nameWidth)) - Math.ceil(this.nameLayout.getLineWidth(0))) - ((double) AndroidUtilities.m1124dp(3.0f))) - ((double) this.botVerificationDrawable.getIntrinsicWidth()));
            }
            ...
            canvas2.restore();
            if (!LocaleController.isRTL) {
                lineRight = (int) (this.nameLeft + this.nameLayout.getLineRight(0) + AndroidUtilities.m1124dp(6.0f));
            } else if (this.nameLayout.getLineLeft(0) == 0.0f) {
                lineRight = (this.nameLeft - AndroidUtilities.m1124dp(3.0f)) - this.statusDrawable.getIntrinsicWidth();
            } else {
                lineRight = (int) (((((double) (this.nameLeft + this.nameWidth)) - Math.ceil(this.nameLayout.getLineWidth(0))) - ((double) AndroidUtilities.m1124dp(3.0f))) - ((double) this.statusDrawable.getIntrinsicWidth()));
            }
        ...
        if (this.f1910ad != null && this.adText != null && this.adBackgroundPaint != null) {
            ...
            int width2 = ((int) this.adText.getWidth()) + AndroidUtilities.m1124dp(12.66f);
            int iM1124dp = AndroidUtilities.m1124dp(17.33f);
            if (LocaleController.isRTL) {
                width = AndroidUtilities.m1124dp(12.0f);
            } else {
                width = (getWidth() - AndroidUtilities.m1124dp(12.0f)) - width2;
            }
            float f = width;
            this.adBounds.set(f, this.nameTop, width + width2, r10 + iM1124dp);
            this.adBounds.inset(-AndroidUtilities.m1124dp(6.0f), -AndroidUtilities.m1124dp(6.0f));
            canvas2.save();
            ...
            this.adText.draw(canvas2, AndroidUtilities.m1124dp(6.33f), f3, color, 1.0f);
            canvas2.restore();
        }
        if (this.statusLayout != null) {
            canvas2.save();
            canvas2.translate(this.statusLeft + this.sublabelOffsetX, AndroidUtilities.m1124dp(this.callCellStyle ? 35.0f : 33.0f) + this.sublabelOffsetY);
            this.statusLayout.draw(canvas2);
            canvas2.restore();
        }
        if (this.countLayout != null) {
            this.rect.set(this.countLeft - AndroidUtilities.m1124dp(5.5f), this.countTop, r15 + this.countWidth + AndroidUtilities.m1124dp(11.0f), this.countTop + AndroidUtilities.m1124dp(23.0f));
            ...
            canvas2.save();
            canvas2.translate(this.countLeft, this.countTop + AndroidUtilities.m1124dp(4.0f));
        ...
        if (this.actionLayout != null) {
            ...
            rectF3.set(this.actionLeft, this.countTop, r7 + this.actionLayout.getWidth(), this.countTop + AndroidUtilities.m1124dp(23.0f));
            rectF3.inset(-AndroidUtilities.m1124dp(16.0f), -AndroidUtilities.m1124dp(4.0f));
            this.actionButton.setRect(rectF3);
            this.actionButton.setRounded(true);
            this.actionButton.draw(canvas2);
            canvas2.save();
            canvas2.translate(this.actionLeft, this.countTop + AndroidUtilities.m1124dp(4.0f));
        ...
        if (!this.dontDrawAvatar) {
            ...
            if (chat != null && chat.monoforum) {
                ...
                if (user != null) {
                    StoriesUtilities.drawAvatarWithStory(user.f1825id, canvas2, this.avatarImage, this.avatarStoryParams);
                } else if (chat != null) {
                    StoriesUtilities.drawAvatarWithStory(-chat.f1660id, canvas2, this.avatarImage, this.avatarStoryParams);
                } else {
                    this.avatarImage.setImageCoords(this.avatarStoryParams.originalAvatarRect);
                    this.avatarImage.draw(canvas2);
                }
        ...
        if (f5 > 0.0f) {
            float centerY = this.avatarImage.getCenterY() + AndroidUtilities.m1124dp(14.0f);
            float centerX = this.avatarImage.getCenterX() + AndroidUtilities.m1124dp(16.0f);
            canvas2.save();
            Theme.dialogs_onlineCirclePaint.setColor(Theme.getColor(Theme.key_windowBackgroundWhite, this.resourcesProvider));
            canvas2.drawCircle(centerX, centerY, AndroidUtilities.m1124dp(11.33f) * f5, Theme.dialogs_onlineCirclePaint);
            ...
            this.premiumGradient.gradientMatrix((int) (centerX - AndroidUtilities.m1124dp(10.0f)), (int) (centerY - AndroidUtilities.m1124dp(10.0f)), (int) (AndroidUtilities.m1124dp(10.0f) + centerX), (int) (AndroidUtilities.m1124dp(10.0f) + centerY), 0.0f, 0.0f);
            canvas2.drawCircle(centerX, centerY, AndroidUtilities.m1124dp(10.0f) * f5, this.premiumGradient.paint);
        ...
        float fM1124dp = AndroidUtilities.m1124dp(28.0f) + this.openButtonText.getCurrentWidth();
        float fM1124dp2 = LocaleController.isRTL ? AndroidUtilities.m1124dp(15.0f) : (getWidth() - fM1124dp) - AndroidUtilities.m1124dp(15.0f);
        float fM1124dp3 = AndroidUtilities.m1124dp(28.0f);
        this.openButtonBackgroundPaint.setColor(Theme.getColor(Theme.key_featuredStickers_addButton));
        this.openButtonRect.set(fM1124dp2, (getHeight() - fM1124dp3) / 2.0f, fM1124dp + fM1124dp2, (getHeight() + fM1124dp3) / 2.0f);
        canvas2.save();
        ...
        this.openButtonText.draw(canvas2, fM1124dp2 + AndroidUtilities.m1124dp(14.0f), getHeight() / 2.0f, -1, 1.0f);
        canvas2.restore();
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        } else if (this.f1910ad != null && this.onSponsoredOptionsClick != null) {
            ...
            if (motionEvent.getAction() == 0 || motionEvent.getAction() == 2) {
                ...
                if (motionEvent.getAction() == 1) {
                    if (this.adBounce.isPressed()) {
                        this.onSponsoredOptionsClick.run(this, this.f1910ad);
                    }
