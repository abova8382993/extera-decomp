...
public class PhotoAttachPhotoCell extends FrameLayout {
    ...
    public PhotoAttachPhotoCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        FrameLayout frameLayout2 = new FrameLayout(context) { // from class: org.telegram.ui.Cells.PhotoAttachPhotoCell.3
            ...
            protected void onDraw(Canvas canvas) {
                ...
                canvas.drawRoundRect(this.rect, AndroidUtilities.m1124dp(4.0f), AndroidUtilities.m1124dp(4.0f), Theme.chat_timeBackgroundPaint);
            }
        };
        this.videoInfoContainer = frameLayout2;
        frameLayout2.setWillNotDraw(false);
        this.videoInfoContainer.setPadding(AndroidUtilities.m1124dp(5.0f), 0, AndroidUtilities.m1124dp(5.0f), 0);
        ...
        imageView.setImageResource(C2888R.drawable.play_mini_video);
        ...
        this.itemSize = AndroidUtilities.m1124dp(80.0f);
    }
        ...
        if (this.highQuality != z) {
            ...
            if (photoEntry != null) {
                if (photoEntry.isVideo) {
                    ...
                    ((FrameLayout.LayoutParams) this.videoTextView.getLayoutParams()).leftMargin = AndroidUtilities.m1124dp(13.0f);
                    this.videoTextView.setText(AndroidUtilities.formatShortDuration(this.photoEntry.duration));
                    return;
                }
                boolean z2 = photoEntry.highQuality;
                if (z2 && !ExteraConfig.alwaysSendInHD) {
                    this.videoInfoContainer.setVisibility(0);
                    this.videoPlayImageView.setVisibility(8);
                    ((FrameLayout.LayoutParams) this.videoTextView.getLayoutParams()).leftMargin = AndroidUtilities.m1124dp(0.0f);
                    this.videoTextView.setText(LocaleController.getString(C2888R.string.ShortHighQuality));
                    return;
                }
                if (!z2 && ExteraConfig.alwaysSendInHD) {
                    this.videoInfoContainer.setVisibility(0);
                    this.videoPlayImageView.setVisibility(8);
                    ((FrameLayout.LayoutParams) this.videoTextView.getLayoutParams()).leftMargin = AndroidUtilities.m1124dp(0.0f);
                    this.videoTextView.setText(LocaleController.getString(C2888R.string.ShortStandardQuality));
                    return;
                }
                this.videoPlayImageView.setVisibility(8);
    ...
    public void setStarsPrice(long j, boolean z) {
        ...
        if (j > 0) {
            ...
            if (this.star == null) {
                ...
                ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C2888R.drawable.star_small_inner);
            ...
            if (z) {
                if (this.lock == null) {
                    ...
                    ColoredImageSpan coloredImageSpan2 = new ColoredImageSpan(C2888R.drawable.msg_mini_lock2);
    ...
    public void setItemSize(int i) {
        ...
        layoutParams3.topMargin = iM1124dp;
        layoutParams3.rightMargin = iM1124dp;
    ...
    protected void onMeasure(int i, int i2) {
        if (this.itemSizeChanged) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.itemSize, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(this.itemSize + AndroidUtilities.m1124dp(2.0f), TLObject.FLAG_30));
            return;
        }
        if (this.isVertical) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(80.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp((this.isLast ? 0 : 6) + 80), TLObject.FLAG_30));
        } else {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp((this.isLast ? 0 : 6) + 80), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(80.0f), TLObject.FLAG_30));
        }
    }
    ...
    public void setPhotoEntry(MediaController.PhotoEntry photoEntry, boolean z, boolean z2, boolean z3) {
        ...
        if (photoEntry.isVideo) {
            ...
            boolean z5 = photoEntry.highQuality;
            if (z5 && !ExteraConfig.alwaysSendInHD) {
                this.videoInfoContainer.setVisibility(0);
                this.videoPlayImageView.setVisibility(8);
                ((FrameLayout.LayoutParams) this.videoTextView.getLayoutParams()).leftMargin = AndroidUtilities.m1124dp(0.0f);
                this.videoTextView.setText(LocaleController.getString(C2888R.string.ShortHighQuality));
            } else if (!z5 && ExteraConfig.alwaysSendInHD) {
                this.videoInfoContainer.setVisibility(0);
                this.videoPlayImageView.setVisibility(8);
                ((FrameLayout.LayoutParams) this.videoTextView.getLayoutParams()).leftMargin = AndroidUtilities.m1124dp(0.0f);
                this.videoTextView.setText(LocaleController.getString(C2888R.string.ShortStandardQuality));
    ...
    public void setPhotoEntry(MediaController.SearchImage searchImage, boolean z, boolean z2) {
        ...
        this.isLast = z2;
        Drawable drawable = this.zoomOnSelect ? Theme.chat_attachEmptyDrawable : getResources().getDrawable(C2888R.drawable.nophotos);
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r6) {
        /*
            ...
            android.graphics.Rect r1 = org.telegram.p029ui.Cells.PhotoAttachPhotoCell.rect
            r0.getHitRect(r1)
            int r0 = r6.getAction()
            r1 = 1
            r2 = 0
            if (r0 != 0) goto L27
            android.graphics.Rect r0 = org.telegram.p029ui.Cells.PhotoAttachPhotoCell.rect
            float r3 = r6.getX()
            int r3 = (int) r3
            float r4 = r6.getY()
            int r4 = (int) r4
        ...
        L7c:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Cells.PhotoAttachPhotoCell.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (photoEntry != null && photoEntry.isVideo) {
            sb.append(LocaleController.getString(C2888R.string.AttachVideo) + ", " + LocaleController.formatDuration(this.photoEntry.duration));
        } else {
            sb.append(LocaleController.getString(C2888R.string.AttachPhoto));
        }
        ...
        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C2888R.id.acc_action_open_photo, LocaleController.getString(C2888R.string.Open)));
    }

    @Override // android.view.View
    public boolean performAccessibilityAction(int i, Bundle bundle) {
        if (i == C2888R.id.acc_action_open_photo) {
