...
public class FilteredSearchView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, FactorAnimator.Target {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.FilteredSearchView$1 */
    class RunnableC56201 implements Runnable {
        RunnableC56201() {
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.FilteredSearchView$2 */
    class C56212 extends PhotoViewer.EmptyPhotoViewerProvider {
        C56212() {
        }
        ...
        */
        public org.telegram.ui.PhotoViewer.PlaceProviderObject getPlaceForPhoto(org.telegram.messenger.MessageObject r9, org.telegram.tgnet.TLRPC.FileLocation r10, int r11, boolean r12, boolean r13) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.FilteredSearchView.C56212.getPlaceForPhoto(org.telegram.messenger.MessageObject, org.telegram.tgnet.TLRPC$FileLocation, int, boolean, boolean):org.telegram.ui.PhotoViewer$PlaceProviderObject");
        }
    }
    ...
    public FilteredSearchView(BaseFragment baseFragment) {
        ...
        C56223 c56223 = new RecyclerListView(parentActivity) { // from class: org.telegram.ui.FilteredSearchView.3
            C56223(Context parentActivity2) {
                ...
                if (getAdapter() == FilteredSearchView.this.sharedPhotoVideoAdapter) {
                    for (int i = 0; i < getChildCount(); i++) {
                        if (getChildViewHolder(getChildAt(i)).getItemViewType() == 1) {
                            canvas.save();
                            canvas.translate(getChildAt(i).getX(), (getChildAt(i).getY() - getChildAt(i).getMeasuredHeight()) + AndroidUtilities.m1124dp(2.0f));
        ...
        this.recyclerListView = c56223;
        c56223.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: org.telegram.ui.FilteredSearchView$$ExternalSyntheticLambda2
            @Override // org.telegram.ui.Components.RecyclerListView.OnItemClickListener
            public final void onItemClick(View view, int i) {
                this.f$0.lambda$new$1(view, i);
            }
        });
        c56223.setOnItemLongClickListener(new RecyclerListView.OnItemLongClickListenerExtended() { // from class: org.telegram.ui.FilteredSearchView.4
            C56234() {
            }
        ...
        c56223.setLayoutManager(linearLayoutManager);
        C56245 c56245 = new FlickerLoadingView(parentActivity2) { // from class: org.telegram.ui.FilteredSearchView.5
            C56245(Context parentActivity2) {
                super(parentActivity2);
            }
        ...
        this.loadingView = c56245;
        addView(c56245);
        addView(c56223);
        c56223.setSectionsType(2);
        c56223.setSkipDrawSection(true);
        c56223.setOnScrollListener(new C56256());
        FloatingDateView floatingDateView = new FloatingDateView(parentActivity2);
        ...
        StickerEmptyView stickerEmptyView = new StickerEmptyView(parentActivity2, c56245, 1);
        this.emptyView = stickerEmptyView;
        addView(stickerEmptyView);
        c56223.setEmptyView(this.emptyView);
        this.emptyView.setVisibility(8);
        checkUi_floatingDateView();
    }

    /* JADX INFO: renamed from: org.telegram.ui.FilteredSearchView$3 */
    class C56223 extends RecyclerListView {
        C56223(Context parentActivity2) {
            super(parentActivity2);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.FilteredSearchView$4 */
    class C56234 implements RecyclerListView.OnItemLongClickListenerExtended {
        C56234() {
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.FilteredSearchView$5 */
    class C56245 extends FlickerLoadingView {
        C56245(Context parentActivity2) {
            super(parentActivity2);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.FilteredSearchView$6 */
    class C56256 extends RecyclerView.OnScrollListener {
        C56256() {
        }
    ...
    public static CharSequence createFromInfoString(MessageObject messageObject, boolean z, int i, TextPaint textPaint) {
        ...
        if (messageObject.isSponsored()) {
            if (messageObject.sponsoredCanReport) {
                return LocaleController.getString(C2888R.string.SponsoredMessageAd);
            }
            if (messageObject.sponsoredRecommended) {
                return LocaleController.getString(C2888R.string.SponsoredMessage2Recommended);
            }
            return LocaleController.getString(C2888R.string.SponsoredMessage2);
        }
        ...
        if (spannableStringBuilderArr[i] == null) {
            ...
            if (i == 0) {
                i2 = C2888R.drawable.attach_arrow_right;
            } else if (i == 1) {
                i2 = C2888R.drawable.msg_mini_arrow_mediathin;
            } else {
                if (i != 2) {
                    return _UrlKt.FRAGMENT_ENCODE_SET;
                }
                i2 = C2888R.drawable.msg_mini_arrow_mediabold;
            }
        ...
        if (user != null && chat2 != null) {
            ...
            if (ChatObject.isForum(chat2) && (tL_forumTopicFindTopic2 = MessagesController.getInstance(UserConfig.selectedAccount).getTopicsController().findTopic(chat2.f1660id, MessageObject.getTopicId(messageObject.currentAccount, messageObject.messageOwner, true))) != null) {
            ...
            if (ChatObject.isForum(chat) && (tL_forumTopicFindTopic = MessagesController.getInstance(UserConfig.selectedAccount).getTopicsController().findTopic(chat.f1660id, MessageObject.getTopicId(messageObject.currentAccount, messageObject.messageOwner, true))) != null) {
        ...
        return charSequenceReplaceEmoji == null ? _UrlKt.FRAGMENT_ENCODE_SET : charSequenceReplaceEmoji;
    }
    ...
    public /* synthetic */ void lambda$search$4(final long j, final String str, final FiltersView.MediaFilterData mediaFilterData, final int i, final long j2, long j3, final boolean z, boolean z2, String str2, final int i2) {
        ...
        if (j != 0) {
            ...
            if (z && str.equals(this.lastMessagesSearchString) && !this.messages.isEmpty()) {
                tL_messages_search.offset_id = ((MessageObject) this.messages.get(r2.size() - 1)).getId();
            } else {
        ...
        ConnectionsManager.getInstance(i).sendRequest(tLObject, new RequestDelegate() { // from class: org.telegram.ui.FilteredSearchView$$ExternalSyntheticLambda4
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject2, TLRPC.TL_error tL_error) {
                this.f$0.lambda$search$3(i, str, i2, z, mediaFilterData, j, j2, arrayList3, arrayList4, tLObject2, tL_error);
            }
        });
    }
    ...
    public /* synthetic */ void lambda$search$2(int i, TLRPC.TL_error tL_error, TLObject tLObject, int i2, boolean z, String str, ArrayList arrayList, FiltersView.MediaFilterData mediaFilterData, long j, long j2, ArrayList arrayList2, ArrayList arrayList3) {
        ...
        if (this.messages.isEmpty()) {
            if (mediaFilterData != null) {
                if (TextUtils.isEmpty(this.currentDataQuery) && j == 0 && j2 == 0) {
                    this.emptyView.title.setText(LocaleController.getString(C2888R.string.SearchEmptyViewTitle));
                    int i4 = mediaFilterData.filterType;
                    if (i4 == 1) {
                        string = LocaleController.getString(C2888R.string.SearchEmptyViewFilteredSubtitleFiles);
                    } else if (i4 == 0) {
                        string = LocaleController.getString(C2888R.string.SearchEmptyViewFilteredSubtitleMedia);
                    } else if (i4 == 2) {
                        string = LocaleController.getString(C2888R.string.SearchEmptyViewFilteredSubtitleLinks);
                    } else if (i4 == 3) {
                        string = LocaleController.getString(C2888R.string.SearchEmptyViewFilteredSubtitleMusic);
                    } else {
                        string = LocaleController.getString(C2888R.string.SearchEmptyViewFilteredSubtitleVoice);
                    }
                    this.emptyView.subtitle.setVisibility(0);
        ...
        if (!z) {
            ...
            if (str != null && str.length() >= 3 && (LocaleController.getString(C2888R.string.SavedMessages).toLowerCase().startsWith(str) || "saved messages".startsWith(str))) {
                int i6 = 0;
                while (true) {
                    if (i6 < this.localTipChats.size()) {
                        if ((this.localTipChats.get(i6) instanceof TLRPC.User) && UserConfig.getInstance(UserConfig.selectedAccount).getCurrentUser().f1825id == ((TLRPC.User) this.localTipChats.get(i6)).f1825id) {
                            break;
                        } else {
                            i6++;
                        }
            ...
            if (str != null && str.length() >= 3 && (LocaleController.getString(C2888R.string.ArchiveSearchFilter).toLowerCase().startsWith(str) || "archive".startsWith(str))) {
        ...
        if ((this.loadingView.getVisibility() == 0 && this.recyclerListView.getChildCount() == 0) || (this.recyclerListView.getAdapter() != this.sharedPhotoVideoAdapter && view != null)) {
            getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() { // from class: org.telegram.ui.FilteredSearchView.7
                ...
                ViewTreeObserverOnPreDrawListenerC56267(View view2, int childAdapterPosition2) {
                    view = view2;
                ...
                public boolean onPreDraw() {
                    ...
                    for (int i8 = 0; i8 < childCount; i8++) {
                        ...
                        if (view == null || FilteredSearchView.this.recyclerListView.getChildAdapterPosition(childAt2) >= i) {
                        ...
                        if (layoutManager != null) {
                            ...
                            objectAnimatorOfFloat2.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.FilteredSearchView.7.2
                                ...
                                public void onAnimationEnd(Animator animator) {
                                    ...
                                    ViewTreeObserverOnPreDrawListenerC56267 viewTreeObserverOnPreDrawListenerC56267 = ViewTreeObserverOnPreDrawListenerC56267.this;
                ...
                /* JADX INFO: renamed from: org.telegram.ui.FilteredSearchView$7$1 */
                ...
                /* JADX INFO: renamed from: org.telegram.ui.FilteredSearchView$7$2 */
    ...
    /* JADX INFO: renamed from: org.telegram.ui.FilteredSearchView$7 */
    /* JADX INFO: loaded from: classes6.dex */
    class ViewTreeObserverOnPreDrawListenerC56267 implements ViewTreeObserver.OnPreDrawListener {
        final /* synthetic */ View val$finalProgressView;
        final /* synthetic */ int val$finalProgressViewPosition;
        ...
        public boolean onPreDraw() {
            ...
            if (view2 != null && view2.getParent() == null) {
                FilteredSearchView.this.recyclerListView.addView(view);
                RecyclerView.LayoutManager layoutManager2 = FilteredSearchView.this.recyclerListView.getLayoutManager();
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void messagesDeleted(long r9, java.util.ArrayList r11) {
        /*
            r8 = this;
            r0 = 0
            r1 = r0
            r2 = r1
        L3:
            java.util.ArrayList r3 = r8.messages
            int r3 = r3.size()
            if (r1 >= r3) goto L83
            java.util.ArrayList r3 = r8.messages
        ...
        L31:
            ...
            int r7 = r7.intValue()
            if (r6 != r7) goto L7e
            java.util.ArrayList r2 = r8.messages
            r2.remove(r1)
            android.util.SparseArray r2 = r8.messagesById
            int r6 = r3.getId()
            r2.remove(r6)
            java.util.HashMap r2 = r8.sectionArrays
            ...
            int r2 = r2.size()
            if (r2 != 0) goto L76
            java.util.ArrayList r2 = r8.sections
            java.lang.String r6 = r3.monthKey
            r2.remove(r6)
            java.util.HashMap r2 = r8.sectionArrays
            java.lang.String r6 = r3.monthKey
        ...
        L8c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.FilteredSearchView.messagesDeleted(long, java.util.ArrayList):void");
    }
    ...
    private class SharedPhotoVideoAdapter extends RecyclerListView.SelectionAdapter {
        ...
        /* JADX INFO: renamed from: org.telegram.ui.FilteredSearchView$SharedPhotoVideoAdapter$1 */
        /* JADX INFO: loaded from: classes6.dex */
        class C56351 implements SharedPhotoVideoCell.SharedPhotoVideoCellDelegate {
            C56351() {
            }
        ...
        /* JADX INFO: renamed from: org.telegram.ui.FilteredSearchView$SharedPhotoVideoAdapter$2 */
        /* JADX INFO: loaded from: classes6.dex */
        class C56362 extends FlickerLoadingView {
            C56362(Context context) {
                super(context);
            }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                sharedPhotoVideoCell.setDelegate(new SharedPhotoVideoCell.SharedPhotoVideoCellDelegate() { // from class: org.telegram.ui.FilteredSearchView.SharedPhotoVideoAdapter.1
                    ...
                    @Override // org.telegram.ui.Cells.SharedPhotoVideoCell.SharedPhotoVideoCellDelegate
                    public void didClickItem(SharedPhotoVideoCell sharedPhotoVideoCell2, int i2, MessageObject messageObject, int i22) {
                        FilteredSearchView.this.onItemClick(i2, sharedPhotoVideoCell2, messageObject, i22);
                    }

                    @Override // org.telegram.ui.Cells.SharedPhotoVideoCell.SharedPhotoVideoCellDelegate
                    public boolean didLongClickItem(SharedPhotoVideoCell sharedPhotoVideoCell2, int i2, MessageObject messageObject, int i22) {
                        if (FilteredSearchView.this.uiCallback.actionModeShowing()) {
                            didClickItem(sharedPhotoVideoCell2, i2, messageObject, i22);
                            return true;
                        }
                        return FilteredSearchView.this.onItemLongClick(messageObject, sharedPhotoVideoCell2, i22);
                    }
                });
                ...
                C56362 c56362 = new FlickerLoadingView(this.mContext) { // from class: org.telegram.ui.FilteredSearchView.SharedPhotoVideoAdapter.2
                    C56362(Context context) {
                        super(context);
                    }
                ...
                c56362.setIsSingleCell(true);
                c56362.setViewType(2);
                view = c56362;
            }
    ...
    class SharedLinksAdapter extends RecyclerListView.SectionsAdapter {
        private Context mContext;
        private final SharedLinkCell.SharedLinkCellDelegate sharedLinkCellDelegate = new C56321();
        ...
        /* JADX INFO: renamed from: org.telegram.ui.FilteredSearchView$SharedLinksAdapter$1 */
        class C56321 implements SharedLinkCell.SharedLinkCellDelegate {
            C56321() {
            }
            ...
            public void onLinkPress(final String str, boolean z) {
                if (z) {
                    ...
                    builder.setItems(new CharSequence[]{LocaleController.getString(C2888R.string.Open), LocaleController.getString(C2888R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.FilteredSearchView$SharedLinksAdapter$1$$ExternalSyntheticLambda0
        ...
        public void onBindViewHolder(int i, int i2, RecyclerView.ViewHolder viewHolder) {
            if (viewHolder.getItemViewType() != 2) {
                ...
                sharedLinkCell.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() { // from class: org.telegram.ui.FilteredSearchView.SharedLinksAdapter.2
                    ...
                    ViewTreeObserverOnPreDrawListenerC56342(SharedLinkCell sharedLinkCell2, MessageObject messageObject2, boolean z22) {
                    ...
                    public boolean onPreDraw() {
                        ...
                        if (FilteredSearchView.this.uiCallback.actionModeShowing()) {
                            FilteredSearchView.this.messageHashIdTmp.set(messageObject.getId(), messageObject.getDialogId());
                            sharedLinkCell.setChecked(FilteredSearchView.this.uiCallback.isSelected(FilteredSearchView.this.messageHashIdTmp), z);
                            return true;
                        }
        ...
        /* JADX INFO: renamed from: org.telegram.ui.FilteredSearchView$SharedLinksAdapter$2 */
        /* JADX INFO: loaded from: classes6.dex */
        class ViewTreeObserverOnPreDrawListenerC56342 implements ViewTreeObserver.OnPreDrawListener {
            final /* synthetic */ boolean val$animated;
            final /* synthetic */ MessageObject val$messageObject;
            final /* synthetic */ SharedLinkCell val$sharedLinkCell;
    ...
    private class SharedDocumentsAdapter extends RecyclerListView.SectionsAdapter {
        ...
        /* JADX INFO: renamed from: org.telegram.ui.FilteredSearchView$SharedDocumentsAdapter$1 */
        /* JADX INFO: loaded from: classes6.dex */
        class C56291 extends SharedAudioCell {
            C56291(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
            ...
            if (i != 0) {
                if (i == 1) {
                    ...
                    graySectionCell = new SharedAudioCell(this.mContext, 1, null) { // from class: org.telegram.ui.FilteredSearchView.SharedDocumentsAdapter.1
                        C56291(Context context, int i3, Theme.ResourcesProvider resourcesProvider) {
            ...
            if (viewHolder.getItemViewType() != 2) {
                ...
                if (itemViewType == 1) {
                    ...
                    sharedDocumentCell.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() { // from class: org.telegram.ui.FilteredSearchView.SharedDocumentsAdapter.2
                        ...
                        ViewTreeObserverOnPreDrawListenerC56302(SharedDocumentCell sharedDocumentCell2, MessageObject messageObject2, boolean z22) {
                            sharedDocumentCell = sharedDocumentCell2;
                            messageObject = messageObject2;
                            z = z22;
                        }
                        ...
                        public boolean onPreDraw() {
                            ...
                            if (FilteredSearchView.this.uiCallback.actionModeShowing()) {
                                FilteredSearchView.this.messageHashIdTmp.set(messageObject.getId(), messageObject.getDialogId());
                                sharedDocumentCell.setChecked(FilteredSearchView.this.uiCallback.isSelected(FilteredSearchView.this.messageHashIdTmp), z);
                                return true;
                            }
                ...
                sharedAudioCell.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() { // from class: org.telegram.ui.FilteredSearchView.SharedDocumentsAdapter.3
                    ...
                    ViewTreeObserverOnPreDrawListenerC56313(SharedAudioCell sharedAudioCell2, MessageObject messageObject22, boolean z32) {
                    ...
                    public boolean onPreDraw() {
                        ...
                        if (FilteredSearchView.this.uiCallback.actionModeShowing()) {
                            FilteredSearchView.this.messageHashIdTmp.set(messageObject.getId(), messageObject.getDialogId());
                            sharedAudioCell.setChecked(FilteredSearchView.this.uiCallback.isSelected(FilteredSearchView.this.messageHashIdTmp), z);
                            return true;
                        }
        ...
        /* JADX INFO: renamed from: org.telegram.ui.FilteredSearchView$SharedDocumentsAdapter$2 */
        /* JADX INFO: loaded from: classes6.dex */
        class ViewTreeObserverOnPreDrawListenerC56302 implements ViewTreeObserver.OnPreDrawListener {
            final /* synthetic */ boolean val$animated;
            final /* synthetic */ MessageObject val$messageObject;
            final /* synthetic */ SharedDocumentCell val$sharedDocumentCell;
        ...
        /* JADX INFO: renamed from: org.telegram.ui.FilteredSearchView$SharedDocumentsAdapter$3 */
        /* JADX INFO: loaded from: classes6.dex */
        class ViewTreeObserverOnPreDrawListenerC56313 implements ViewTreeObserver.OnPreDrawListener {
            final /* synthetic */ boolean val$animated;
            final /* synthetic */ MessageObject val$messageObject;
            final /* synthetic */ SharedAudioCell val$sharedAudioCell;
    ...
    class OnlyUserFiltersAdapter extends RecyclerListView.SelectionAdapter {
        ...
        /* JADX INFO: renamed from: org.telegram.ui.FilteredSearchView$OnlyUserFiltersAdapter$1 */
        /* JADX INFO: loaded from: classes6.dex */
        class C56271 extends DialogCell {
            @Override // org.telegram.p029ui.Cells.DialogCell
            public boolean isForumCell() {
                return false;
            }

            C56271(DialogsActivity dialogsActivity, Context context, boolean z, boolean z2) {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            View c56271;
            if (i == 0) {
                c56271 = new DialogCell(null, viewGroup.getContext(), true, true) { // from class: org.telegram.ui.FilteredSearchView.OnlyUserFiltersAdapter.1
                    @Override // org.telegram.p029ui.Cells.DialogCell
                    public boolean isForumCell() {
                        return false;
                    }
                ...
                c56271 = graySectionCell;
            }
            c56271.setLayoutParams(new RecyclerView.LayoutParams(-1, -2));
            return new RecyclerListView.Holder(c56271);
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            if (viewHolder.getItemViewType() == 0) {
                ...
                dialogCell.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() { // from class: org.telegram.ui.FilteredSearchView.OnlyUserFiltersAdapter.2
                    ...
                    ViewTreeObserverOnPreDrawListenerC56282(DialogCell dialogCell2, MessageObject messageObject2, boolean z) {
        ...
        /* JADX INFO: renamed from: org.telegram.ui.FilteredSearchView$OnlyUserFiltersAdapter$2 */
        /* JADX INFO: loaded from: classes6.dex */
        class ViewTreeObserverOnPreDrawListenerC56282 implements ViewTreeObserver.OnPreDrawListener {
            final /* synthetic */ boolean val$animated;
            final /* synthetic */ DialogCell val$cell;
            final /* synthetic */ MessageObject val$messageObject;
    ...
    /* JADX INFO: renamed from: hideFloatingDateView */
    ...
    private void checkUi_floatingDateView() {
        ...
        this.floatingDateView.setTranslationY((-AndroidUtilities.m1124dp(24.0f)) * (1.0f - floatValue));
    ...
    private static class FloatingDateView extends View {
        ...
        public void setBlurredBackgroundDrawable(BlurredBackgroundDrawable blurredBackgroundDrawable) {
            ...
            blurredBackgroundDrawable.setRadius(AndroidUtilities.m1124dp(11.5f));
            this.bgDrawable.setPadding(AndroidUtilities.m1124dp(5.0f));
        }
