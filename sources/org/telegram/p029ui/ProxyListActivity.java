...
public class ProxyListActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public class TextDetailProxyCell extends FrameLayout {
        ...
        public TextDetailProxyCell(Context context) {
            ...
            this.valueTextView.setCompoundDrawablePadding(AndroidUtilities.m1124dp(6.0f));
            ...
            imageView.setImageResource(C2888R.drawable.msg_info);
            ...
            this.checkImageView.setContentDescription(LocaleController.getString(C2888R.string.Edit));
            ...
            if (SharedConfig.currentProxy == this.currentInfo && ProxyListActivity.this.useProxySettings) {
                if (ProxyListActivity.this.currentConnectionState == 3 || ProxyListActivity.this.currentConnectionState == 5) {
                    ...
                    if (this.currentInfo.ping != 0) {
                        this.valueTextView.setText(LocaleController.getString(C2888R.string.Connected) + ", " + LocaleController.formatString("Ping", C2888R.string.Ping, Long.valueOf(this.currentInfo.ping)));
                    } else {
                        this.valueTextView.setText(LocaleController.getString(C2888R.string.Connected));
                    }
                    ...
                    this.valueTextView.setText(LocaleController.getString(C2888R.string.Connecting));
                }
            } else {
                SharedConfig.ProxyInfo proxyInfo2 = this.currentInfo;
                if (proxyInfo2.checking) {
                    this.valueTextView.setText(LocaleController.getString(C2888R.string.Checking));
                    i = Theme.key_windowBackgroundWhiteGrayText2;
                } else if (proxyInfo2.available) {
                    if (proxyInfo2.ping != 0) {
                        this.valueTextView.setText(LocaleController.getString(C2888R.string.Available) + ", " + LocaleController.formatString("Ping", C2888R.string.Ping, Long.valueOf(this.currentInfo.ping)));
                    } else {
                        this.valueTextView.setText(LocaleController.getString(C2888R.string.Available));
                    }
                    i = Theme.key_windowBackgroundWhiteGreenText;
                } else {
                    this.valueTextView.setText(LocaleController.getString(C2888R.string.Unavailable));
        ...
        public void setSelectionEnabled(final boolean z, boolean z2) {
            ...
            final float fM1124dp = LocaleController.isRTL ? -AndroidUtilities.m1124dp(32.0f) : AndroidUtilities.m1124dp(32.0f);
            final float f = 0.0f;
            if (!z2) {
                if (!z) {
                    fM1124dp = 0.0f;
                }
                this.textView.setTranslationX(fM1124dp);
                this.valueTextView.setTranslationX(fM1124dp);
                this.checkImageView.setTranslationX(fM1124dp);
                ...
                checkBox2.setTranslationX(iM1124dp + fM1124dp);
            ...
            duration.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.ProxyListActivity$TextDetailProxyCell$$ExternalSyntheticLambda1
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    this.f$0.lambda$setSelectionEnabled$1(f, fM1124dp, valueAnimator);
                }
            });
        ...
        public /* synthetic */ void lambda$setSelectionEnabled$1(float f, float f2, ValueAnimator valueAnimator) {
            ...
            this.checkBox.setTranslationX((LocaleController.isRTL ? AndroidUtilities.m1124dp(32.0f) : -AndroidUtilities.m1124dp(32.0f)) + fLerp);
        ...
        public void setChecked(boolean z) {
            if (z) {
                if (this.checkDrawable == null) {
                    this.checkDrawable = getResources().getDrawable(C2888R.drawable.proxy_check).mutate();
                }
                Drawable drawable = this.checkDrawable;
                if (drawable != null) {
                    drawable.setColorFilter(new PorterDuffColorFilter(this.color, PorterDuff.Mode.MULTIPLY));
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2888R.string.ProxySettings));
        ...
        this.shareMenuItem = actionBarMenuCreateActionMode.addItemWithWidth(1, C2888R.drawable.msg_share, AndroidUtilities.m1124dp(54.0f));
        this.deleteMenuItem = actionBarMenuCreateActionMode.addItemWithWidth(0, C2888R.drawable.msg_delete, AndroidUtilities.m1124dp(54.0f));
        this.actionBar.setActionBarMenuOnItemClick(new C65242(context));
    ...
    public /* synthetic */ void lambda$createView$1(View view, int i) {
        ...
        if (i == this.proxyReactToVpnRow) {
            SharedPreferences.Editor editorEdit3 = ExteraConfig.preferences.edit();
            boolean z3 = !ExteraConfig.doNotUseProxyWithVpn;
            ExteraConfig.doNotUseProxyWithVpn = z3;
            editorEdit3.putBoolean("doNotUseProxyWithVpn", z3).apply();
            ((TextCheckCell) view).setChecked(ExteraConfig.doNotUseProxyWithVpn);
            ApplicationLoader.checkProxyForVpnState();
            return;
        }
        if (i == this.callsRow) {
            boolean z4 = !this.useProxyForCalls;
            this.useProxyForCalls = z4;
            ((TextCheckCell) view).setChecked(z4);
            SharedPreferences.Editor editorEdit4 = MessagesController.getGlobalMainSettings().edit();
            editorEdit4.putBoolean("proxy_enabled_calls", this.useProxyForCalls);
            editorEdit4.apply();
            return;
        }
        if (i >= this.proxyStartRow && i < this.proxyEndRow) {
            ...
            SharedPreferences.Editor editorEdit5 = MessagesController.getGlobalMainSettings().edit();
            editorEdit5.putString("proxy_ip", proxyInfo2.address);
            editorEdit5.putString("proxy_pass", proxyInfo2.password);
            editorEdit5.putString("proxy_user", proxyInfo2.username);
            editorEdit5.putInt("proxy_port", proxyInfo2.port);
            editorEdit5.putString("proxy_secret", proxyInfo2.secret);
            editorEdit5.putBoolean("proxy_enabled", this.useProxySettings);
            if (!proxyInfo2.secret.isEmpty()) {
                this.useProxyForCalls = false;
                editorEdit5.putBoolean("proxy_enabled_calls", false);
            }
            editorEdit5.apply();
            ...
            boolean z5 = this.useProxySettings;
        ...
        if (i == this.deleteAllRow) {
            ...
            builder.setMessage(LocaleController.getString(C2888R.string.DeleteAllProxiesConfirm));
            builder.setNegativeButton(LocaleController.getString(C2888R.string.Cancel), null);
            builder.setTitle(LocaleController.getString(C2888R.string.DeleteProxyTitle));
            builder.setPositiveButton(LocaleController.getString(C2888R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ProxyListActivity$$ExternalSyntheticLambda6
    ...
    class C65242 extends ActionBar.ActionBarMenuOnItemClick {
        final /* synthetic */ Context val$context;

        C65242(Context context) {
        ...
        public void onItemClick(int i) {
            ...
            if (i == 0) {
                ...
                builder.setMessage(LocaleController.getString(ProxyListActivity.this.selectedItems.size() > 1 ? C2888R.string.DeleteProxyMultiConfirm : C2888R.string.DeleteProxyConfirm));
                builder.setNegativeButton(LocaleController.getString(C2888R.string.Cancel), null);
                builder.setTitle(LocaleController.getString(C2888R.string.DeleteProxyTitle));
                builder.setPositiveButton(LocaleController.getString(C2888R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ProxyListActivity$2$$ExternalSyntheticLambda0
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            ...
            Intent intentCreateChooser = Intent.createChooser(intent, LocaleController.getString(ProxyListActivity.this.selectedItems.size() > 1 ? C2888R.string.ShareLinks : C2888R.string.ShareLink));
                    ...
                    public final void run(long j) {
                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ProxyListActivity$$ExternalSyntheticLambda7
                            ...
                            public final void run() {
                                ProxyListActivity.m17662$r8$lambda$5pbN7GOeBsh_eBQYt4oGxgPw4(proxyInfo, j);
                            }
                        });
                    }
                });
    ...
    /* JADX INFO: renamed from: $r8$lambda$5pbN7G-OeBs-h_eBQYt4oGxgPw4, reason: not valid java name */
    public static /* synthetic */ void m17662$r8$lambda$5pbN7GOeBsh_eBQYt4oGxgPw4(SharedConfig.ProxyInfo proxyInfo, long j) {
    ...
    class ListAdapter extends RecyclerListView.SelectionAdapter {
            ...
            switch (viewHolder.getItemViewType()) {
                case 1:
                    ...
                    if (i == ProxyListActivity.this.proxyAddRow) {
                        textSettingsCell.setText(LocaleController.getString(C2888R.string.AddProxy), ProxyListActivity.this.deleteAllRow != -1);
                    } else if (i == ProxyListActivity.this.deleteAllRow) {
                        textSettingsCell.setTextColor(Theme.getColor(Theme.key_text_RedRegular));
                        textSettingsCell.setText(LocaleController.getString(C2888R.string.DeleteAllProxies), false);
                    }
                    break;
                case 2:
                    HeaderCell headerCell = (HeaderCell) viewHolder.itemView;
                    if (i == ProxyListActivity.this.connectionsHeaderRow) {
                        headerCell.setText(LocaleController.getString(C2888R.string.ProxyConnections));
                    }
                    break;
                case 3:
                    TextCheckCell textCheckCell = (TextCheckCell) viewHolder.itemView;
                    if (i == ProxyListActivity.this.useProxyRow) {
                        textCheckCell.setTextAndCheck(LocaleController.getString(C2888R.string.UseProxySettings), ProxyListActivity.this.useProxySettings, true);
                    } else if (i == ProxyListActivity.this.proxyReactToVpnRow) {
                        textCheckCell.setTextAndCheck(LocaleController.getString(C2888R.string.ProxyDoNotUseWithVPN), ExteraConfig.doNotUseProxyWithVpn, ProxyListActivity.this.rotationRow != -1);
                    } else if (i == ProxyListActivity.this.callsRow) {
                        textCheckCell.setTextAndCheck(LocaleController.getString(C2888R.string.UseProxyForCalls), ProxyListActivity.this.useProxyForCalls, false);
                    } else if (i == ProxyListActivity.this.rotationRow) {
                        String string = LocaleController.getString(C2888R.string.UseProxyRotation);
                ...
                case 4:
                    ...
                    if (i == ProxyListActivity.this.callsDetailRow) {
                        textInfoPrivacyCell.setText(LocaleController.getString(C2888R.string.UseProxyForCallsInfo));
                    } else if (i == ProxyListActivity.this.rotationTimeoutInfoRow) {
                        textInfoPrivacyCell.setText(LocaleController.getString(C2888R.string.ProxyRotationTimeoutInfo));
                    }
                    break;
                case 5:
                ...
                case 6:
                    if (i == ProxyListActivity.this.rotationTimeoutRow) {
                        ...
                        for (int i2 = 0; i2 < arrayList.size(); i2++) {
                            strArr[i2] = LocaleController.formatString(C2888R.string.ProxyRotationTimeoutSeconds, arrayList.get(i2));
                        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i, List list) {
            ...
            if (viewHolder.getItemViewType() == 3 && list.contains(0)) {
                ...
                if (i == ProxyListActivity.this.proxyReactToVpnRow) {
                    textCheckCell.setChecked(ExteraConfig.doNotUseProxyWithVpn);
                    return;
                } else if (i == ProxyListActivity.this.callsRow) {
        ...
        public void onViewAttachedToWindow(RecyclerView.ViewHolder viewHolder) {
            if (viewHolder.getItemViewType() == 3) {
                ...
                if (adapterPosition == ProxyListActivity.this.proxyReactToVpnRow) {
                    textCheckCell.setChecked(ExteraConfig.doNotUseProxyWithVpn);
