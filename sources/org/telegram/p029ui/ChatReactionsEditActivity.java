    ...
    */
    public boolean onFragmentCreate() {
        ...
        L4f:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.ChatReactionsEditActivity.onFragmentCreate():boolean");
    }
    ...
    public View createView(final Context context) {
        ...
        if (this.isChannel) {
            ...
            this.enableReactionsCell.setTextAndCheck(LocaleController.getString(C2888R.string.EnableReactions), !this.chatReactions.isEmpty(), false);
        ...
        radioCell.setText(LocaleController.getString(C2888R.string.AllReactions), false, true);
        RadioCell radioCell2 = new RadioCell(context);
        this.someReactions = radioCell2;
        radioCell2.setText(LocaleController.getString(C2888R.string.SomeReactions), false, true);
        RadioCell radioCell3 = new RadioCell(context);
        this.disableReactions = radioCell3;
        radioCell3.setText(LocaleController.getString(C2888R.string.NoReactions), false, false);
        ...
        RecyclerListView.SelectionAdapter selectionAdapter = new RecyclerListView.SelectionAdapter() { // from class: org.telegram.ui.ChatReactionsEditActivity.2
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i3) {
                ...
                if (itemViewType != 0) {
                    ...
                    if (i3 == 0) {
                        headerCell.setText(LocaleController.getString(C2888R.string.AvailableReactions));
                    } else {
                        headerCell.setText(LocaleController.getString(C2888R.string.OnlyAllowThisReactions));
                    }
                ...
                if (chatReactionsEditActivity.isChannel) {
                    textInfoPrivacyCell.setText(ChatObject.isChannelAndNotMegaGroup(chatReactionsEditActivity.currentChat) ? LocaleController.getString(C2888R.string.EnableReactionsChannelInfo) : LocaleController.getString(C2888R.string.EnableReactionsGroupInfo));
                    return;
                }
                int i4 = chatReactionsEditActivity.selectedType;
                if (i4 == 1) {
                    textInfoPrivacyCell.setText(LocaleController.getString(C2888R.string.EnableSomeReactionsInfo));
                } else if (i4 == 0) {
                    textInfoPrivacyCell.setText(LocaleController.getString(C2888R.string.EnableAllReactionsInfo));
                } else if (i4 == 2) {
                    textInfoPrivacyCell.setText(LocaleController.getString(C2888R.string.DisableReactionsInfo));
                }
            }
