...
public class LinkManager {
    ...
    */
    private boolean handleSettings(java.util.List r17) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.LinkManager.handleSettings(java.util.List):boolean");
    }
    ...
    class C59241 extends GroupCreateActivity {
        C59241(Bundle bundle) {
            super(bundle);
        }
    ...
    public /* synthetic */ void lambda$handleSettings$10(TLObject tLObject, final String str) {
        ...
        if (!TwoStepVerificationActivity.canHandleCurrentPassword(password, false)) {
            AlertsCreator.showUpdateAppAlert(this.activity, LocaleController.getString(C2888R.string.UpdateAppAlert), true);
        }
    ...
    public /* synthetic */ void lambda$handleInvoiceSlug$16(TLRPC.TL_error tL_error, TLObject tLObject, TLRPC.TL_inputInvoiceSlug tL_inputInvoiceSlug, String str) {
        ...
        if (tL_error != null) {
            if ("SUBSCRIPTION_ALREADY_ACTIVE".equalsIgnoreCase(tL_error.text)) {
                getBulletinFactory().createErrorBulletin(LocaleController.getString(C2888R.string.PaymentInvoiceSubscriptionLinkAlreadyPaid)).show();
            } else {
                getBulletinFactory().createErrorBulletin(LocaleController.getString(C2888R.string.PaymentInvoiceLinkInvalid)).show();
            }
    ...
    public /* synthetic */ void lambda$handleOAuth$18(TLRPC.TL_messages_requestUrlAuth tL_messages_requestUrlAuth, TLRPC.UrlAuthResult urlAuthResult, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null) {
            if ("URL_EXPIRED".equalsIgnoreCase(tL_error.text)) {
                getBulletinFactory().createSimpleBulletin(C2888R.raw.error, LocaleController.getString(C2888R.string.BotAuthLoggedInFailTitle), LocaleController.getString(C2888R.string.BotAuthLoggedInFailNoDomain)).show();
                return;
            } else {
    ...
    */
    public static boolean isWebAppLink(java.lang.String r7) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.LinkManager.isWebAppLink(java.lang.String):boolean");
    }
}
