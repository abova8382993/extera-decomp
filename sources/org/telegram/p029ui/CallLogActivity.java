...
import org.telegram.p029ui.Components.ProgressButton;
...
public class CallLogActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, MainTabsActivity.TabFragmentDelegate {
    ...
    class EmptyTextProgressView extends FrameLayout {
        ...
        public EmptyTextProgressView(Context context, View view) {
            ...
            rLottieImageView.setAnimation(C2888R.raw.utyan_call, 110, 110);
            ...
            textView.setText(LocaleController.getString(C2888R.string.MakeYourFirstCall));
            ...
            String string = LocaleController.formatString(C2888R.string.MakeYourFirstCallHint, Integer.valueOf(CallLogActivity.this.getMessagesController().conferenceCallSizeLimit));
            ...
            setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.CallLogActivity$EmptyTextProgressView$$ExternalSyntheticLambda1
                ...
                public final boolean onTouch(View view2, MotionEvent motionEvent) {
                    return CallLogActivity.EmptyTextProgressView.m6501$r8$lambda$r2yXPcVr5CyXIjl7raCNSCXp8(view2, motionEvent);
                }
            });
        }
        ...
        /* JADX INFO: renamed from: $r8$lambda$-r2yXPcVr5CyXI-jl7raCNSCXp8, reason: not valid java name */
        public static /* synthetic */ boolean m6501$r8$lambda$r2yXPcVr5CyXIjl7raCNSCXp8(View view, MotionEvent motionEvent) {
            return true;
        }
    ...
    */
    public void didReceivedNotification(int r17, int r18, java.lang.Object... r19) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.CallLogActivity.didReceivedNotification(int, int, java.lang.Object[]):void");
    }

    /* JADX INFO: renamed from: eq */
    private static boolean m1220eq(long j, ArrayList arrayList) {
        return arrayList.size() == 1 && ((TLRPC.User) arrayList.get(0)).f1825id == j;
    }

    /* JADX INFO: renamed from: eq */
    private static boolean m1221eq(Set set, ArrayList arrayList) {
        ...
        while (i < size) {
            ...
            i++;
            if (!set.contains(Long.valueOf(((TLRPC.User) obj).f1825id))) {
                return false;
            }
        }
        return true;
    ...
    private static class CallCell extends FrameLayout {
        ...
        public CallCell(Context context, int i) {
            ...
            profileSearchCell.setPadding(LocaleController.isRTL ? AndroidUtilities.m1124dp(32.0f) : 0, 0, LocaleController.isRTL ? 0 : AndroidUtilities.m1124dp(32.0f), 0);
            profileSearchCell.setSublabelOffset(AndroidUtilities.m1124dp(LocaleController.isRTL ? 2.0f : -2.0f), -AndroidUtilities.m1124dp(7.0f));
            addView(profileSearchCell, LayoutHelper.createFrame(-1, -1.0f));
            AvatarsImageView avatarsImageView = new AvatarsImageView(context, false);
            this.avatarsImageView = avatarsImageView;
            avatarsImageView.setAvatarsTextSize(AndroidUtilities.m1124dp(18.0f));
            avatarsImageView.setStepFactor(0.4f);
            avatarsImageView.setSize(AndroidUtilities.m1124dp(29.0f));
            ...
            imageView.setContentDescription(LocaleController.getString(C2888R.string.Call));
        ...
        public void set(CallLogRow callLogRow, View.OnClickListener onClickListener) {
            ...
            this.imageView.setImageResource(callLogRow.video ? C2888R.drawable.menu_videocall : C2888R.drawable.menu_call_create_2_24);
        ...
        private static ImageSpan iconOut(Context context) {
            Drawable drawableMutate = context.getResources().getDrawable(C2888R.drawable.mini_call_out_16).mutate();
        ...
        private static ImageSpan iconIn(Context context) {
            Drawable drawableMutate = context.getResources().getDrawable(C2888R.drawable.mini_call_in_16).mutate();
            drawableMutate.setBounds(0, 0, drawableMutate.getIntrinsicWidth(), drawableMutate.getIntrinsicHeight());
            drawableMutate.setColorFilter(new PorterDuffColorFilter(Theme.getColor(Theme.key_windowBackgroundWhiteGrayText3), PorterDuff.Mode.MULTIPLY));
            return new ImageSpan(drawableMutate, 0);
        }
        ...
        public static final class Factory extends UItem.UItemFactory {
            ...
            public static UItem m1224of(CallLogRow callLogRow, View.OnClickListener onClickListener) {
    ...
    private static class GroupCallCell extends FrameLayout {
        ...
        public GroupCallCell(Context context) {
            super(context);
            String string = LocaleController.getString(C2888R.string.VoipChatJoin);
            ...
            this.profileSearchCell = profileSearchCell;
            profileSearchCell.setCallCellStyle();
            profileSearchCell.setPadding(LocaleController.isRTL ? AndroidUtilities.m1124dp(44.0f) + iCeil : 0, 0, LocaleController.isRTL ? 0 : AndroidUtilities.m1124dp(44.0f) + iCeil, 0);
            profileSearchCell.setSublabelOffset(0, -AndroidUtilities.m1124dp(4.0f));
            addView(profileSearchCell, LayoutHelper.createFrame(-1, -1.0f));
            ...
            progressButton.setPadding(AndroidUtilities.m1124dp(14.0f), 0, AndroidUtilities.m1124dp(14.0f), 0);
        ...
        public void setChat(TLRPC.Chat chat, View.OnClickListener onClickListener) {
            ...
            this.button.setTag(Long.valueOf(chat.f1660id));
            if (ChatObject.isChannel(chat) && !chat.megagroup) {
                if (!ChatObject.isPublic(chat)) {
                    lowerCase = LocaleController.getString(C2888R.string.ChannelPrivate).toLowerCase();
                } else {
                    lowerCase = LocaleController.getString(C2888R.string.ChannelPublic).toLowerCase();
                }
            } else if (chat.has_geo) {
                lowerCase = LocaleController.getString(C2888R.string.MegaLocation);
            } else if (!ChatObject.isPublic(chat)) {
                lowerCase = LocaleController.getString(C2888R.string.MegaPrivate).toLowerCase();
            } else {
                lowerCase = LocaleController.getString(C2888R.string.MegaPublic).toLowerCase();
            }
        ...
        public static final class Factory extends UItem.UItemFactory {
            ...
            /* JADX INFO: renamed from: of */
            public static UItem m1225of(TLRPC.Chat chat, View.OnClickListener onClickListener) {
                UItem uItemOfFactory = UItem.ofFactory(Factory.class);
    ...
    public View createView(Context context) {
        this.additionNavigationBarHeight = (!this.hasMainTabs || ExteraConfig.BottomNavigationBar.hidden() || ExteraConfig.BottomNavigationBar.floating()) ? 0 : AndroidUtilities.m1124dp(72.0f);
        this.additionFloatingButtonOffset = (this.hasMainTabs && ExteraConfig.BottomNavigationBar.visible()) ? AndroidUtilities.m1124dp(64.0f) : 0;
        if (!this.hasMainTabs) {
            this.actionBar.setBackButtonDrawable(new BackDrawable(false));
        }
        this.actionBar.setAllowOverlayTitle(true);
        this.actionBar.setTitle(LocaleController.getString(C2888R.string.Calls));
        ...
        ActionBarMenuItem actionBarMenuItemAddItem = this.actionBar.createMenu().addItem(10, C2888R.drawable.ic_ab_other);
        this.otherItem = actionBarMenuItemAddItem;
        actionBarMenuItemAddItem.setContentDescription(LocaleController.getString(C2888R.string.AccDescrMoreOptions));
        ...
        this.contentView = new SizeNotifierFrameLayout(context) { // from class: org.telegram.ui.CallLogActivity.2
            ...
            protected void onMeasure(int i2, int i3) {
                ...
                ((ViewGroup.MarginLayoutParams) CallLogActivity.this.topPanelLayout.getLayoutParams()).topMargin = ((BaseFragment) CallLogActivity.this).actionBar.getMeasuredHeight() - AndroidUtilities.m1124dp(14.0f);
        ...
        this.listView.setOnScrollListener(new C33073());
        if (this.loading) {
        ...
        fragmentFloatingButton.imageView.setImageResource(C2888R.drawable.filled_calls_plus);
        this.floatingButton.setContentDescription(LocaleController.getString(C2888R.string.Call));
    ...
    class C33073 extends RecyclerView.OnScrollListener {
        ...
        public void onScrolled(RecyclerView recyclerView, int i, int i2) {
            ...
            if (i2 != 0 && this.scrollUpdated) {
                ...
                CallLogActivity.this.mainTabsHiddenByScroll = ExteraConfig.BottomNavigationBar.floating() && i2 > 0;
        ...
        public /* synthetic */ void lambda$onScrolled$0(CallLogRow callLogRow) {
            CallLogActivity.this.getCalls(((TLRPC.Message) callLogRow.calls.get(r3.size() - 1)).f1686id, 100);
        }
    }
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        if (!zIsEmpty || !zIsEmpty2) {
            arrayList.add(UItem.asButton(1, C2888R.drawable.menu_call_create, LocaleController.getString(C2888R.string.GroupCallCreate2)).accent());
            if (!getUserConfig().showCallsTab) {
                arrayList.add(UItem.asButton(2, C2888R.drawable.menu_add_tab_24, LocaleController.getString(C2888R.string.GroupCallShowInMainTabs)).accent());
            }
        ...
        if (!zIsEmpty) {
            ...
            while (i2 < size) {
                ...
                if (l != null && (chat = getMessagesController().getChat(l)) != null) {
                    arrayList.add(GroupCallCell.Factory.m1225of(chat, new View.OnClickListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda19
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
        ...
        while (i < size2) {
            ...
            arrayList.add(CallCell.Factory.m1224of(callLogRow, onCallClick(callLogRow)).setChecked(isSelected(callLogRow.calls)));
        }
        if (this.endReached) {
            return;
        }
    ...
    public /* synthetic */ void lambda$onCallClick$8(CallLogRow callLogRow, View view) {
        if (callLogRow.users.size() == 1) {
            ...
            TLRPC.UserFull userFull = getMessagesController().getUserFull(user.f1825id);
        ...
        while (i < size) {
            Object obj = arrayList.get(i);
            i++;
            hashSet.add(Long.valueOf(((TLRPC.User) obj).f1825id));
        }
        final TLRPC.TL_inputGroupCallInviteMessage tL_inputGroupCallInviteMessage = new TLRPC.TL_inputGroupCallInviteMessage();
        tL_inputGroupCallInviteMessage.msg_id = ((TLRPC.Message) callLogRow.calls.get(0)).f1686id;
    ...
    public void onClick(UItem uItem, View view, int i, float f, float f2) {
        ...
        if (i2 == 2) {
            ...
            BulletinFactory.m1246of(this).createSimpleBulletin(C2888R.raw.contact_check, AndroidUtilities.replaceTags(LocaleController.getString(C2888R.string.GroupCallTabWasShownTitle)), LocaleController.getString(C2888R.string.UndoNoCaps), 5000, true, new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda22
                @Override // java.lang.Runnable
                public final void run() {
        ...
        if (obj instanceof CallLogRow) {
            ...
            if (callLogRow.call_id != 0 && !callLogRow.calls.isEmpty()) {
                ...
                while (i3 < size) {
                    ...
                    i3++;
                    hashSet.add(Long.valueOf(((TLRPC.User) obj2).f1825id));
                }
                final TLRPC.TL_inputGroupCallInviteMessage tL_inputGroupCallInviteMessage = new TLRPC.TL_inputGroupCallInviteMessage();
                tL_inputGroupCallInviteMessage.msg_id = ((TLRPC.Message) callLogRow.calls.get(0)).f1686id;
                final AlertDialog alertDialog = new AlertDialog(getContext(), 3);
            ...
            bundle.putInt("message_id", ((TLRPC.Message) callLogRow.calls.get(0)).f1686id);
        ...
        if (view instanceof GroupCallCell) {
            ...
            bundle2.putLong("chat_id", ((GroupCallCell) view).currentChat.f1660id);
            getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.closeChats, new Object[0]);
    ...
    public void onBecomeFullyVisible() {
        ...
        this.hideCallTabsHintView.setPadding(0, AndroidUtilities.m1124dp(4.0f), 0, 0);
        this.hideCallTabsHintView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2888R.string.TapToHideCallsTab)));
        this.contentView.addView(this.hideCallTabsHintView, LayoutHelper.createFrame(-1, 80, 48));
        this.hideCallTabsHintView.setTranslationY((AndroidUtilities.statusBarHeight + ActionBar.getCurrentActionBarHeight()) - AndroidUtilities.m1124dp(16.0f));
    ...
    public ActionBar createActionBar(Context context) {
        ...
        actionBarCreateActionBar.getAdditionalSubTitleOverlayContainer().setTranslationX(AndroidUtilities.m1124dp(4.0f));
        actionBarCreateActionBar.getAdditionalSubTitleOverlayContainer().setTranslationY(-AndroidUtilities.m1124dp(2.0f));
        actionBarCreateActionBar.getTitlesContainer().setTranslationX(AndroidUtilities.m1124dp(4.0f));
    ...
    public void showDeleteAlert(final boolean z) {
        ...
        if (z) {
            builder.setTitle(LocaleController.getString(C2888R.string.DeleteAllCalls));
            builder.setMessage(LocaleController.getString(C2888R.string.DeleteAllCallsText));
        } else {
            builder.setTitle(LocaleController.getString(C2888R.string.DeleteCalls));
            builder.setMessage(LocaleController.getString(C2888R.string.DeleteSelectedCallsText));
        }
        final boolean[] zArr = {false};
        FrameLayout frameLayout = new FrameLayout(getParentActivity());
        CheckBoxCell checkBoxCell = new CheckBoxCell(getParentActivity(), 1);
        checkBoxCell.setBackground(Theme.getSelectorDrawable(false));
        checkBoxCell.setText(LocaleController.getString(C2888R.string.DeleteCallsForEveryone), _UrlKt.FRAGMENT_ENCODE_SET, false, false);
        checkBoxCell.setPadding(LocaleController.isRTL ? AndroidUtilities.m1124dp(8.0f) : 0, 0, LocaleController.isRTL ? 0 : AndroidUtilities.m1124dp(8.0f), 0);
        ...
        builder.setPositiveButton(LocaleController.getString(C2888R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda32
    ...
    private boolean isSelected(ArrayList arrayList) {
        ...
        for (int i = 0; i < size; i++) {
            if (this.selectedIds.contains(Integer.valueOf(((TLRPC.Message) arrayList.get(i)).f1686id))) {
                return true;
            }
        }
        return false;
    ...
    private void createActionMode() {
        ...
        this.actionModeViews.add(actionBarMenuCreateActionMode.addItemWithWidth(2, C2888R.drawable.msg_delete, AndroidUtilities.m1124dp(54.0f), LocaleController.getString(C2888R.string.Delete)));
    }
    ...
    private boolean addOrRemoveSelectedDialog(ArrayList arrayList, CallCell callCell) {
        ...
        if (isSelected(arrayList)) {
            int size = arrayList.size();
            for (int i = 0; i < size; i++) {
                this.selectedIds.remove(Integer.valueOf(((TLRPC.Message) arrayList.get(i)).f1686id));
            }
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            Integer numValueOf = Integer.valueOf(((TLRPC.Message) arrayList.get(i2)).f1686id);
    ...
    */
    public /* synthetic */ void lambda$getCalls$20(org.telegram.tgnet.TLRPC.TL_error r18, org.telegram.tgnet.TLObject r19) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.CallLogActivity.lambda$getCalls$20(org.telegram.tgnet.TLRPC$TL_error, org.telegram.tgnet.TLObject):void");
    }

    public static /* synthetic */ boolean $r8$lambda$_0SBMTDZzqEhCFeXNeob46nKQg4(long j, TLRPC.User user) {
        return user.f1825id == j;
    }
    ...
    public void onRequestPermissionsResultFragment(int i, String[] strArr, int[] iArr) {
        ...
        if (i == 101 || i == 102 || i == 103) {
            ...
            if (iArr.length <= 0 || !z) {
                ...
                TLRPC.UserFull userFull = this.lastCallUser != null ? getMessagesController().getUserFull(this.lastCallUser.f1825id) : null;
    ...
    public void checkUi_listViewPadding() {
        this.listView.setPadding(0, AndroidUtilities.m1124dp(this.ADDITIONAL_LIST_HEIGHT_DP) + this.actionBar.getMeasuredHeight() + ((int) this.topPanelLayout.getAnimatedHeightWithPadding(AndroidUtilities.m1124dp(14.0f))), 0, AndroidUtilities.m1124dp(this.ADDITIONAL_LIST_HEIGHT_DP) + this.navigationBarHeight + this.additionNavigationBarHeight);
    ...
    public void checkUi_listClip() {
        if (this.listView.hasActiveEdgeEffects()) {
            ...
            this.tmpClipRect.set(0, AndroidUtilities.m1124dp(this.ADDITIONAL_LIST_HEIGHT_DP) + this.actionBar.getMeasuredHeight(), this.listView.getMeasuredWidth(), this.listView.getMeasuredHeight() - AndroidUtilities.m1124dp(this.ADDITIONAL_LIST_HEIGHT_DP));
    ...
    public static void showCallLinkSheet(final Context context, int i, final TLRPC.InputGroupCall inputGroupCall, final String str, final Theme.ResourcesProvider resourcesProvider, boolean z, final boolean z2) {
        ...
        linearLayout.setPadding(0, 0, 0, AndroidUtilities.m1124dp(8.0f));
        FrameLayout frameLayout = new FrameLayout(context);
        ...
        imageView2.setImageResource(C2888R.drawable.ic_ab_other);
        ...
        linksTextViewMakeLinkTextView.setText(LocaleController.getString(C2888R.string.GroupCallCreatedLinkTitle));
        ...
        linksTextViewMakeLinkTextView2.setText(LocaleController.getString(C2888R.string.GroupCallCreatedLinkText));
        ...
        linksTextViewMakeLinkTextView3.setPadding(AndroidUtilities.m1124dp(16.0f), AndroidUtilities.m1124dp(14.0f), 0, AndroidUtilities.m1124dp(14.0f));
        ...
        imageView3.setImageDrawable(ContextCompat.getDrawable(context, C2888R.drawable.ic_ab_other));
        imageView3.setContentDescription(LocaleController.getString(C2888R.string.AccDescrMoreOptions));
        ...
        spannableStringBuilder.append((CharSequence) LocaleController.getString(C2888R.string.GroupCallCreatedLinkCopy));
        spannableStringBuilder.setSpan(new ColoredImageSpan(C2888R.drawable.msg_copy_filled), 0, 1, 33);
        ...
        spannableStringBuilder2.append((CharSequence) LocaleController.getString(C2888R.string.GroupCallCreatedLinkShare));
        spannableStringBuilder2.setSpan(new ColoredImageSpan(C2888R.drawable.msg_share_filled), 0, 1, 33);
        ...
        if (z) {
            TextView textView = new TextView(context) { // from class: org.telegram.ui.CallLogActivity.6
                ...
                protected void dispatchDraw(Canvas canvas) {
                    ...
                    float f = iMax / 2.0f;
                    canvas.drawLine(0.0f, height, ((getWidth() / 2.0f) - f) - AndroidUtilities.m1124dp(8.0f), height, this.paint);
                    canvas.drawLine((getWidth() / 2.0f) + f + AndroidUtilities.m1124dp(8.0f), height, getWidth(), height, this.paint);
                    super.dispatchDraw(canvas);
                }
            };
            textView.setGravity(17);
            textView.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteGrayText2, resourcesProvider));
            textView.setText(" " + LocaleController.getString(C2888R.string.GroupCallCreatedLinkJoinOr) + " ");
            ...
            linksTextViewMakeLinkTextView4.setText(AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(C2888R.string.GroupCallCreatedLinkJoinText), runnable), true));
        ...
        buttonWithCounterView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda43
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                CallLogActivity.m6455$r8$lambda$1EFOwZ77UqkTcqErUyM45xhGTk(strArr, bottomSheetShow, resourcesProvider, view);
            }
        });
        final Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda44
            @Override // java.lang.Runnable
            public final void run() {
                CallLogActivity.m6457$r8$lambda$2prmdrrmAf0kUoNk0dOqcJaAs(inputGroupCall, i2, strArr, frameLayout3, linksTextViewMakeLinkTextView3, bottomSheetShow, resourcesProvider);
            }
        };
        imageView3.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda45
            ...
            public final void onClick(View view) {
                ...
                ItemOptions.makeOptions(bottomSheet.container, resourcesProvider2, frameLayout4).add(C2888R.drawable.msg_copy, LocaleController.getString(C2888R.string.Copy), new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda49
                    @Override // java.lang.Runnable
                    public final void run() {
                        CallLogActivity.$r8$lambda$PLg6mSTanxGc9UtnR7bnEEzTVXc(strArr2, bottomSheet, resourcesProvider2);
                    }
                }).add(C2888R.drawable.msg_qrcode, LocaleController.getString(C2888R.string.GetQRCode), new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda50
                    @Override // java.lang.Runnable
                    public final void run() {
                        CallLogActivity.m6467$r8$lambda$ofizaQ8fz8pIkZ0CmoIzuZ1WxU(context, strArr2);
                    }
                }).addIf(z2, C2888R.drawable.msg_delete, (CharSequence) LocaleController.getString(C2888R.string.RevokeLink), true, runnable2).show();
            }
        });
        buttonWithCounterView2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda46
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                new ShareAlert(context, null, str, false, strArr[0], false, resourcesProvider) { // from class: org.telegram.ui.CallLogActivity.8
                        ...
                        if (z3) {
                            if (longSparseArray != null && longSparseArray.size() == 1) {
                                ...
                                if (j == 0 || j == UserConfig.getInstance(this.currentAccount).getClientUserId()) {
                                    string = LocaleController.getString(C2888R.string.InvLinkToSavedMessages);
                                } else {
                                    string = LocaleController.formatString(C2888R.string.InvLinkToUser, MessagesController.getInstance(this.currentAccount).getPeerName(j, true));
                                }
                            } else {
                                string = LocaleController.formatString(C2888R.string.InvLinkToChats, LocaleController.formatPluralString("Chats", longSparseArray == null ? 1 : longSparseArray.size(), new Object[0]));
                            }
                            Bulletin bulletinCreateSimpleBulletin = BulletinFactory.m1245of(bottomSheet.topBulletinContainer, this.resourcesProvider).createSimpleBulletin(C2888R.raw.forward, AndroidUtilities.replaceTags(string));
        ...
        if (z2) {
            imageView2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda47
                ...
                public final void onClick(View view) {
                    BottomSheet bottomSheet = bottomSheetShow;
                    ItemOptions.makeOptions(bottomSheet.getContainer(), resourcesProvider, imageView2).add(C2888R.drawable.menu_link_revoke, LocaleController.getString(C2888R.string.GroupCallCreatedLinkRevoke), runnable2).setOnTopOfScrim().translate(0.0f, -AndroidUtilities.m1124dp(6.0f)).setDimAlpha(0).show();
                }
            });
        }
    }
    ...
    public static /* synthetic */ void $r8$lambda$BsdDJzHH2jXeuHHHw9yzq0gKRJM(String[] strArr, BottomSheet bottomSheet, Theme.ResourcesProvider resourcesProvider, View view) {
        ...
        BulletinFactory.m1245of(bottomSheet.topBulletinContainer, resourcesProvider).createCopyBulletin(LocaleController.getString(C2888R.string.LinkCopied)).show();
    }

    /* JADX INFO: renamed from: $r8$lambda$1EFOwZ77UqkTcqErUyM45x-hGTk, reason: not valid java name */
    public static /* synthetic */ void m6455$r8$lambda$1EFOwZ77UqkTcqErUyM45xhGTk(String[] strArr, BottomSheet bottomSheet, Theme.ResourcesProvider resourcesProvider, View view) {
        AndroidUtilities.addToClipboard(strArr[0]);
        BulletinFactory.m1245of(bottomSheet.topBulletinContainer, resourcesProvider).createCopyBulletin(LocaleController.getString(C2888R.string.LinkCopied)).show();
    }

    /* JADX INFO: renamed from: $r8$lambda$2prmd-rrmA-f0kUoNk0dOqcJaAs, reason: not valid java name */
    public static /* synthetic */ void m6457$r8$lambda$2prmdrrmAf0kUoNk0dOqcJaAs(final TLRPC.InputGroupCall inputGroupCall, final int i, final String[] strArr, final FrameLayout frameLayout, final LinkSpanDrawable.LinksTextView linksTextView, final BottomSheet bottomSheet, final Theme.ResourcesProvider resourcesProvider) {
        ...
        ConnectionsManager.getInstance(i).sendRequest(exportgroupcallinvite, new RequestDelegate() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda51
            ...
            public final void run(TLObject tLObject2, TLRPC.TL_error tL_error2) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        CallLogActivity.m6461$r8$lambda$XP3zZ7XrhNj3c7Y0VBP453XMXs(tLObject2, strArr, frameLayout, linksTextView, bottomSheet, resourcesProvider);
                    }
                });
            }
        });
    ...
    /* JADX INFO: renamed from: $r8$lambda$X-P3zZ7XrhNj3c7Y0VBP453XMXs, reason: not valid java name */
    public static /* synthetic */ void m6461$r8$lambda$XP3zZ7XrhNj3c7Y0VBP453XMXs(TLObject tLObject, String[] strArr, final FrameLayout frameLayout, final LinkSpanDrawable.LinksTextView linksTextView, BottomSheet bottomSheet, Theme.ResourcesProvider resourcesProvider) {
        if (tLObject instanceof TL_phone.exportedGroupCallInvite) {
            ...
            duration.start();
            BulletinFactory.m1245of(bottomSheet.topBulletinContainer, resourcesProvider).createSimpleBulletin(C2888R.raw.linkbroken, LocaleController.getString(C2888R.string.GroupCallCreatedLinkRevokedTitle), LocaleController.getString(C2888R.string.GroupCallCreatedLinkRevokedText)).show();
        }
    }
    ...
    /* JADX INFO: renamed from: $r8$lambda$ofiza-Q8fz8pIkZ0CmoIzuZ1WxU, reason: not valid java name */
    public static /* synthetic */ void m6467$r8$lambda$ofizaQ8fz8pIkZ0CmoIzuZ1WxU(Context context, String[] strArr) {
        QRCodeBottomSheet qRCodeBottomSheet = new QRCodeBottomSheet(context, LocaleController.getString(C2888R.string.InviteByQRCode), strArr[0], LocaleController.getString(C2888R.string.QRCodeLinkGroupCall), false);
    ...
    private void openCreateCall() {
        ...
        presentFragment(new C33139(bundle));
    }

    /* JADX INFO: renamed from: org.telegram.ui.CallLogActivity$9 */
    class C33139 extends GroupCreateActivity {
        C33139(Bundle bundle) {
            super(bundle);
        }

        @Override // org.telegram.p029ui.GroupCreateActivity
        protected void onCallUsersSelected(final HashSet hashSet, final boolean z) {
            if (hashSet.size() == 1) {
                ...
                if (userFull == null) {
                    ...
                    tL_users_getFullUser.f1817id = getMessagesController().getInputUser(user.f1825id);
        ...
        public /* synthetic */ void lambda$onCallUsersSelected$2(TLObject tLObject, boolean z, HashSet hashSet, TLRPC.TL_error tL_error) {
            ...
            if (!(tLObject instanceof TL_phone.groupCall)) {
                if (tL_error != null) {
                    BulletinFactory.m1246of(CallLogActivity.this).showForError(tL_error);
                    return;
                }
                return;
            }
        ...
        ConnectionsManager.getInstance(i).sendRequest(createconferencecall, new RequestDelegate() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda30
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda33
                    @Override // java.lang.Runnable
                    public final void run() {
                        CallLogActivity.m6465$r8$lambda$gyhVDjUE7ARRTUf1l96t6off0(tLObject, i, alertDialog, context, resourcesProvider, runnable);
                    }
                });
            }
        });
    ...
    /* JADX INFO: renamed from: $r8$lambda$gyhVDjUE7-ARRTUf1l96t6o-ff0, reason: not valid java name */
    public static /* synthetic */ void m6465$r8$lambda$gyhVDjUE7ARRTUf1l96t6off0(TLObject tLObject, final int i, final AlertDialog alertDialog, final Context context, final Theme.ResourcesProvider resourcesProvider, final Runnable runnable) {
        int i2 = 0;
        if (tLObject instanceof TLRPC.Updates) {
            TLRPC.Updates updates = (TLRPC.Updates) tLObject;
            ...
            ConnectionsManager.getInstance(i).sendRequest(exportgroupcallinvite, new RequestDelegate() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda38
                ...
                public final void run(TLObject tLObject2, TLRPC.TL_error tL_error) {
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda39
                        @Override // java.lang.Runnable
                        public final void run() {
                            CallLogActivity.m6466$r8$lambda$k3EfdJ6Yoam0W237sh_2inFJEA(tLObject2, alertDialog, context, i, exportgroupcallinvite, resourcesProvider, runnable);
                        }
                    });
                }
            });
    ...
    /* JADX INFO: renamed from: $r8$lambda$k3EfdJ6Yoa-m0W237sh_2inFJEA, reason: not valid java name */
    public static /* synthetic */ void m6466$r8$lambda$k3EfdJ6Yoam0W237sh_2inFJEA(TLObject tLObject, AlertDialog alertDialog, Context context, int i, TL_phone.exportGroupCallInvite exportgroupcallinvite, Theme.ResourcesProvider resourcesProvider, Runnable runnable) {
        if (tLObject instanceof TL_phone.exportedGroupCallInvite) {
            alertDialog.dismiss();
    ...
    private void showItemOptions() {
        ...
        itemOptionsMakeOptions.addIf(getUserConfig().showCallsTab, C2888R.drawable.msg_archive_hide, LocaleController.getString(C2888R.string.HideCallTab), new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda15
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$showItemOptions$42();
            }
        });
        itemOptionsMakeOptions.addIf(!this.calls.isEmpty(), C2888R.drawable.msg_delete, (CharSequence) LocaleController.getString(C2888R.string.DeleteAllCalls), true, new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda16
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$showItemOptions$42() {
        ...
        (this.hasMainTabs ? BulletinFactory.global() : BulletinFactory.m1246of(this)).createSimpleBulletin(C2888R.raw.contact_check, AndroidUtilities.replaceTags(LocaleController.getString(C2888R.string.GroupCallTabWasHiddenTitle)), LocaleController.getString(C2888R.string.UndoNoCaps), 5000, true, new Runnable() { // from class: org.telegram.ui.CallLogActivity$$ExternalSyntheticLambda26
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void blur3_InvalidateBlur() {
        ...
        int iM1124dp = AndroidUtilities.m1124dp(48.0f) + ((int) this.topPanelLayout.getAnimatedHeightWithPadding(AndroidUtilities.m1124dp(7.0f)));
        int measuredHeight = (this.fragmentView.getMeasuredHeight() - this.navigationBarHeight) - AndroidUtilities.m1124dp(8.0f);
        int iM1124dp2 = measuredHeight - AndroidUtilities.m1124dp(56.0f);
        this.iBlur3PositionActionBar.set(0.0f, -iM1124dp, this.fragmentView.getMeasuredWidth(), this.actionBar.getMeasuredHeight() + iM1124dp);
        this.iBlur3PositionMainTabs.set(0.0f, iM1124dp2, this.fragmentView.getMeasuredWidth(), measuredHeight);
