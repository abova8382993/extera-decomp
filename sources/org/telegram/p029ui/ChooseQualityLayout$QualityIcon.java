...
public class ChooseQualityLayout$QualityIcon extends Drawable {
    ...
    public ChooseQualityLayout$QualityIcon(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.castFill = context.getResources().getDrawable(C2888R.drawable.mini_casting_fill).mutate();
        paint.setColor(-1);
        paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.DST_OUT));
        animatedTextDrawable.setTypeface(AndroidUtilities.getTypeface("fonts/num.otf"));
        animatedTextDrawable.setTextColor(-16777216);
        animatedTextDrawable.setTextSize(AndroidUtilities.m1124dp(7.0f));
        ...
        animatedTextDrawable2.setTextSize(AndroidUtilities.m1124dp(7.0f));
        ...
        rectF.set(AndroidUtilities.m1124dp(0.66f), AndroidUtilities.m1124dp(4.0f), AndroidUtilities.m1124dp(13.0f), AndroidUtilities.m1124dp(13.33f));
        path.addRoundRect(rectF, AndroidUtilities.m1124dp(2.66f), AndroidUtilities.m1124dp(2.66f), Path.Direction.CW);
    ...
    public void draw(Canvas canvas) {
        ...
        float fM1124dp = (AndroidUtilities.m1124dp(5.0f) * this.topText.isNotEmpty()) + this.topText.getCurrentWidth();
        float fM1124dp2 = (AndroidUtilities.m1124dp(5.0f) * this.bottomText.isNotEmpty()) + this.bottomText.getCurrentWidth();
        int saveCount = canvas.getSaveCount();
        Rect bounds = getBounds();
        if (fM1124dp > 0.0f || fM1124dp2 > 0.0f || f5 > 0.0f) {
            canvas2 = canvas;
        ...
        rect.set(AndroidUtilities.m1124dp(6.0f), AndroidUtilities.m1124dp(6.0f), (AndroidUtilities.m1124dp(6.0f) + bounds.width()) - AndroidUtilities.m1124dp(12.0f), (AndroidUtilities.m1124dp(6.0f) + bounds.height()) - AndroidUtilities.m1124dp(12.0f));
        ...
        float fM1124dp3 = AndroidUtilities.m1124dp(10.0f);
        if (fM1124dp > 0.0f) {
            float f6 = fM1124dp3 / 2.0f;
            f = 2.0f;
            f2 = 3.0f;
            this.rect.set(fWidth - fM1124dp, fHeight - f6, fWidth, fHeight + f6);
            canvas2.drawRoundRect(this.rect, AndroidUtilities.m1124dp(3.0f), AndroidUtilities.m1124dp(3.0f), this.bgLinePaint);
        } else {
            f = 2.0f;
            f2 = 3.0f;
        }
        if (fM1124dp2 > 0.0f) {
            float f7 = fM1124dp3 / f;
            f3 = 0.0f;
            this.rect.set(fWidth - fM1124dp2, fHeight2 - f7, fWidth, f7 + fHeight2);
            canvas2.drawRoundRect(this.rect, AndroidUtilities.m1124dp(f2), AndroidUtilities.m1124dp(f2), this.bgLinePaint);
        } else {
            f3 = 0.0f;
        }
        float f8 = 1.0f - f5;
        if (fM1124dp * f8 > f3) {
            ...
            float f9 = fM1124dp3 / f;
            this.rect.set(fWidth - fM1124dp, fHeight - f9, fWidth, fHeight + f9);
            this.rect.inset(AndroidUtilities.m1124dp(1.0f), AndroidUtilities.m1124dp(1.0f));
            canvas2.drawRoundRect(this.rect, AndroidUtilities.m1124dp(f2), AndroidUtilities.m1124dp(f2), this.bgPaint);
            this.rect.inset(-AndroidUtilities.m1124dp(1.0f), -AndroidUtilities.m1124dp(1.0f));
        ...
        if (f5 > f3) {
            ...
            drawable2.setBounds((bounds.right - drawable2.getIntrinsicWidth()) - AndroidUtilities.m1124dp(f2), bounds.top + AndroidUtilities.m1124dp(0.66f), bounds.right - AndroidUtilities.m1124dp(f2), bounds.top + AndroidUtilities.m1124dp(0.66f) + this.castFill.getIntrinsicHeight());
        ...
        if (fM1124dp2 > 0.0f) {
            ...
            float f10 = fM1124dp3 / f;
            this.rect.set(fWidth - fM1124dp2, fHeight2 - f10, fWidth, fHeight2 + f10);
            this.rect.inset(AndroidUtilities.m1124dp(1.0f), AndroidUtilities.m1124dp(1.0f));
            canvas2.drawRoundRect(this.rect, AndroidUtilities.m1124dp(f2), AndroidUtilities.m1124dp(f2), this.bgPaint);
            this.rect.inset(-AndroidUtilities.m1124dp(1.0f), -AndroidUtilities.m1124dp(1.0f));
    ...
    public int getIntrinsicWidth() {
        return this.base.getIntrinsicWidth() + AndroidUtilities.m1124dp(12.0f);
    }

    @Override // android.graphics.drawable.Drawable
    public int getIntrinsicHeight() {
        return this.base.getIntrinsicHeight() + AndroidUtilities.m1124dp(12.0f);
    }
}
