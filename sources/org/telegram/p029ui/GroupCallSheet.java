    ...
    */
    public static void show(android.content.Context r9, final int r10, final long r11, final org.telegram.tgnet.TLRPC.InputGroupCall r13, final org.telegram.messenger.browser.Browser.Progress r14) {
        ...
        L2e:
            ...
            goto L2c
        L43:
            org.telegram.ui.LaunchActivity r9 = org.telegram.p029ui.LaunchActivity.instance
            if (r9 == 0) goto L5c
            ...
            r11 = 0
            r12 = 0
            org.telegram.p029ui.GroupCallActivity.create(r9, r10, r11, r12, r13, r14)
            return
        L5b:
            r4 = r9
        L5c:
        ...
        L96:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.GroupCallSheet.show(android.content.Context, int, long, org.telegram.tgnet.TLRPC$InputGroupCall, org.telegram.messenger.browser.Browser$Progress):void");
    }
    ...
    public static /* synthetic */ void $r8$lambda$Akf10XNgC6J0t1JRJKCuBgnc3cI(AlertDialog alertDialog, Browser.Progress progress, TLObject tLObject, int i, Context context, long j, TLRPC.InputGroupCall inputGroupCall, TLRPC.TL_error tL_error) {
        ...
        if (tLObject instanceof TL_phone.groupCall) {
            ...
            if (VoIPService.getSharedInstance() == null || (conferenceCall = VoIPService.getSharedInstance().conference) == null || (groupCall = conferenceCall.groupCall) == null || groupcall.call.f1675id != groupCall.f1675id) {
                i2 = i;
            } else {
                i2 = i;
        ...
        if (safeLastFragment2 != null) {
            BulletinFactory.m1246of(safeLastFragment2).createSimpleBulletin(C2888R.raw.error, LocaleController.getString(C2888R.string.LinkIsNoActive)).show();
        }
    }
    ...
    public static void show(final Context context, final int i, final long j, final TLRPC.InputGroupCall inputGroupCall, TLRPC.GroupCall groupCall, ArrayList arrayList) {
        ...
        linearLayout.setPadding(AndroidUtilities.m1124dp(14.0f), 0, AndroidUtilities.m1124dp(14.0f), AndroidUtilities.m1124dp(8.0f));
        FrameLayout frameLayout = new FrameLayout(context);
        frameLayout.setBackground(Theme.createCircleDrawable(AndroidUtilities.m1124dp(80.0f), Theme.getColor(Theme.key_featuredStickers_addButton, darkThemeResourceProvider)));
        ImageView imageView = new ImageView(context);
        imageView.setImageResource(C2888R.drawable.filled_calls_users);
        ...
        linksTextViewMakeLinkTextView.setText(LocaleController.getString(C2888R.string.GroupCallLinkTitle));
        ...
        List list = (List) Collection.EL.stream(arrayList).map(new Function() { // from class: org.telegram.ui.GroupCallSheet$$ExternalSyntheticLambda3
            ...
            public /* synthetic */ Predicate m1285or(Predicate predicate) {
        ...
        linksTextViewMakeLinkTextView2.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2888R.string.GroupCallLinkText)));
        ...
        if (!zIsEmpty) {
            ...
            avatarsImageView.setSize(AndroidUtilities.m1124dp(38.0f));
            ...
            if (list.size() == 1) {
                linksTextViewMakeLinkTextView3.setText(AndroidUtilities.replaceTags(LocaleController.formatString(C2888R.string.GroupCallLinkText2One, DialogObject.getShortName(i, ((Long) list.get(0)).longValue()))));
            } else if (list.size() == 2) {
                linksTextViewMakeLinkTextView3.setText(AndroidUtilities.replaceTags(LocaleController.formatString(C2888R.string.GroupCallLinkText2Two, DialogObject.getShortName(i, ((Long) list.get(0)).longValue()), DialogObject.getShortName(i, ((Long) list.get(1)).longValue()))));
            } else {
        ...
        linearLayout2.setPadding(AndroidUtilities.m1124dp(12.0f), AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(12.0f), AndroidUtilities.m1124dp(8.0f));
        ...
        buttonWithCounterView.setText(LocaleController.getString(C2888R.string.GroupCallLinkJoin), false);
        ...
        buttonWithCounterView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.GroupCallSheet$$ExternalSyntheticLambda6
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                GroupCallSheet.m14765$r8$lambda$plmRm_ZCfuxi0WM15hUydZwDTE(bottomSheetCreate, context, checkBox2, i, inputGroupCall, view2);
            }
        });
    ...
    public static /* synthetic */ void m14765$r8$lambda$plmRm_ZCfuxi0WM15hUydZwDTE(BottomSheet bottomSheet, Context context, CheckBox2 checkBox2, int i, TLRPC.InputGroupCall inputGroupCall, View view) {
    ...
    static class UserView extends FrameLayout {
        ...
        public void set(long j) {
            ...
            this.textView.setMaxWidth(Math.max(AndroidUtilities.m1124dp(41.0f), HintView2.cutInFancyHalf(this.textView.getText(), this.textView.getPaint())));
        }

        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(82.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i2), TLObject.FLAG_30));
        }
