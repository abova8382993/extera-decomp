...
import org.telegram.p029ui.AvatarPreviewer;
import org.telegram.p029ui.Cells.ChatActionCell;
import org.telegram.p029ui.Cells.ChatActionCell$$ExternalSyntheticApiModelOutline0;
import org.telegram.p029ui.Cells.ChatActionCell$$ExternalSyntheticApiModelOutline1;
import org.telegram.p029ui.Cells.ChatLoadingCell;
import org.telegram.p029ui.Cells.ChatMessageCell;
import org.telegram.p029ui.Cells.ChatUnreadCell;
import org.telegram.p029ui.Cells.TextSelectionHelper;
import org.telegram.p029ui.Components.AdminLogFilterAlert2;
...
import org.telegram.p029ui.Components.ChatScrimPopupContainerLayout;
...
import org.telegram.p029ui.Components.InviteLinkBottomSheet;
import org.telegram.p029ui.Components.LayoutHelper;
import org.telegram.p029ui.Components.PhonebookShareAlert;
...
public class ChannelAdminLogActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private String searchQuery = _UrlKt.FRAGMENT_ENCODE_SET;
    ...
    private void updateEmptyPlaceholder() {
        ...
        if (!TextUtils.isEmpty(this.searchQuery)) {
            ...
            this.emptyView.setPadding(AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(3.0f), AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(3.0f));
            this.emptyView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2888R.string.NoLogFound)));
        } else if (this.selectedAdmins != null || this.currentFilter != null) {
            this.emptyImageView.setVisibility(8);
            this.emptyView.setPadding(AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(3.0f), AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(3.0f));
            this.emptyView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2888R.string.NoLogFoundFiltered)));
        } else {
            this.emptyImageView.setVisibility(0);
            this.emptyView.setPadding(AndroidUtilities.m1124dp(16.0f), AndroidUtilities.m1124dp(16.0f), AndroidUtilities.m1124dp(16.0f), AndroidUtilities.m1124dp(16.0f));
            if (this.currentChat.megagroup) {
                this.emptyView.setText(smallerNewNewLine(AndroidUtilities.replaceTags(LocaleController.getString(C2888R.string.EventLogEmpty2))));
            } else {
                this.emptyView.setText(smallerNewNewLine(AndroidUtilities.replaceTags(LocaleController.getString(C2888R.string.EventLogEmptyChannel2))));
            }
        }
    }
    ...
    private CharSequence smallerNewNewLine(CharSequence charSequence) {
        ...
        if (iCharSequenceIndexOf >= 0 && Build.VERSION.SDK_INT >= 29) {
            ...
            ((SpannableStringBuilder) charSequence).setSpan(ChatActionCell$$ExternalSyntheticApiModelOutline0.m1226m(AndroidUtilities.m1124dp(8.0f)), iCharSequenceIndexOf + 1, iCharSequenceIndexOf + 2, 33);
        }
        return charSequence;
    }

    /* JADX INFO: renamed from: reloadLastMessages, reason: merged with bridge method [inline-methods] */
    public void lambda$processSelectedOption$20() {
        ...
        tL_channels_getAdminLog.f1703q = this.searchQuery;
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_getAdminLog, new RequestDelegate() { // from class: org.telegram.ui.ChannelAdminLogActivity$$ExternalSyntheticLambda19
    ...
    */
    public /* synthetic */ void lambda$reloadLastMessages$0(org.telegram.tgnet.TLRPC.TL_channels_adminLogResults r12) {
        ...
        Lab:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.ChannelAdminLogActivity.lambda$reloadLastMessages$0(org.telegram.tgnet.TLRPC$TL_channels_adminLogResults):void");
    }
    ...
    */
    public /* synthetic */ void lambda$loadMessages$3(org.telegram.tgnet.TLRPC.TL_channels_adminLogResults r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.ChannelAdminLogActivity.lambda$loadMessages$3(org.telegram.tgnet.TLRPC$TL_channels_adminLogResults):void");
    }
    ...
    private MessageObject actionMessagesDeletedBy(long j, long j2, ArrayList arrayList, boolean z, boolean z2) {
        ...
        if (messageObject == null) {
            ...
            tL_message.dialog_id = -this.currentChat.f1660id;
        ...
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(MessageObject.replaceWithLink(LocaleController.formatPluralString(z2 ? "EventLogDeletedMultipleMessagesToExpand" : "EventLogDeletedMultipleMessages", arrayList.size(), TextUtils.join(", ", Collection.EL.stream(arrayList).map(new Function() { // from class: org.telegram.ui.ChannelAdminLogActivity$$ExternalSyntheticLambda11
        ...
        }).distinct().map(new Function() { // from class: org.telegram.ui.ChannelAdminLogActivity$$ExternalSyntheticLambda12
            public /* synthetic */ Function andThen(Function function) {
                return Function$CC.$default$andThen(this, function);
            }
        ...
        }).filter(new Predicate() { // from class: org.telegram.ui.ChannelAdminLogActivity$$ExternalSyntheticLambda13
            ...
            public /* synthetic */ Predicate m1236or(Predicate predicate) {
                return Predicate$CC.$default$or(this, predicate);
            }

            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return ChannelAdminLogActivity.m7095$r8$lambda$jAlypGwhTAgRhhBaFgBF5z7YCc((String) obj);
            }
        ...
        if (z2 && arrayList.size() > 1) {
            ...
            if (showDrawableFindDrawable == null) {
                showDrawableFindDrawable = new ProfileActivity.ShowDrawable(LocaleController.getString(z ? C2888R.string.EventLogDeletedMultipleMessagesHide : C2888R.string.EventLogDeletedMultipleMessagesShow));
                showDrawableFindDrawable.textDrawable.setTypeface(AndroidUtilities.bold());
                showDrawableFindDrawable.textDrawable.setTextSize(AndroidUtilities.m1124dp(10.0f));
                showDrawableFindDrawable.setTextColor(-1);
                showDrawableFindDrawable.setBackgroundColor(503316480);
            } else {
                showDrawableFindDrawable.textDrawable.setText(LocaleController.getString(z ? C2888R.string.EventLogDeletedMultipleMessagesHide : C2888R.string.EventLogDeletedMultipleMessagesShow), false);
            }
    ...
    /* JADX INFO: renamed from: $r8$lambda$jAlypGwhTAgRhhBaF-gBF5z7YCc, reason: not valid java name */
    public static /* synthetic */ boolean m7095$r8$lambda$jAlypGwhTAgRhhBaFgBF5z7YCc(String str) {
        return str != null;
    }
    ...
    public View createView(Context context) {
        ...
        ActionBarMenuItem actionBarMenuItemSearchListener = this.actionBar.createMenu().addItem(0, C2888R.drawable.outline_header_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() { // from class: org.telegram.ui.ChannelAdminLogActivity.4
        ...
        actionBarMenuItemSearchListener.setSearchFieldHint(LocaleController.getString("Search", C2888R.string.Search));
        this.avatarContainer.setEnabled(false);
        this.avatarContainer.setTitle(this.currentChat.title);
        this.avatarContainer.setSubtitle(LocaleController.getString("EventLogAllEvents", C2888R.string.EventLogAllEvents));
        ...
        SizeNotifierFrameLayout sizeNotifierFrameLayout = new SizeNotifierFrameLayout(context) { // from class: org.telegram.ui.ChannelAdminLogActivity.5
            ...
            protected void onAttachedToWindow() {
                ...
                MessageObject playingMessageObject = MediaController.getInstance().getPlayingMessageObject();
                if (playingMessageObject == null || !playingMessageObject.isRoundVideo() || playingMessageObject.eventId == 0 || playingMessageObject.getDialogId() != (-ChannelAdminLogActivity.this.currentChat.f1660id)) {
                    return;
                }
                ...
                for (int i4 = 0; i4 < childCount; i4++) {
                    ...
                    if (childAt != null && childAt.getVisibility() != 8 && childAt != ((BaseFragment) ChannelAdminLogActivity.this).actionBar) {
                        if (childAt == ChannelAdminLogActivity.this.chatListView || childAt == ChannelAdminLogActivity.this.progressView) {
                            childAt.measure(View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(Math.max(AndroidUtilities.m1124dp(10.0f), paddingTop - AndroidUtilities.m1124dp(50.0f)), TLObject.FLAG_30));
            ...
            */
            protected void onLayout(boolean r10, int r11, int r12, int r13, int r14) {
                /*
                    ...
                    To view this dump change 'Code comments level' option to 'DEBUG'
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.ChannelAdminLogActivity.C34975.onLayout(boolean, int, int, int, int):void");
            }
        ...
        linearLayout.setBackground(Theme.createServiceDrawable(AndroidUtilities.m1124dp(12.0f), this.emptyView, this.contentView));
        this.emptyLayoutView.setOrientation(1);
        ImageView imageView = new ImageView(context);
        this.emptyImageView = imageView;
        ImageView.ScaleType scaleType = ImageView.ScaleType.CENTER;
        imageView.setScaleType(scaleType);
        this.emptyImageView.setImageResource(C2888R.drawable.large_log_actions);
        ...
        TextView textView = new TextView(context) { // from class: org.telegram.ui.ChannelAdminLogActivity.6
            ...
            protected void onMeasure(int i2, int i3) {
                super.onMeasure(View.MeasureSpec.makeMeasureSpec(Math.min(View.MeasureSpec.getSize(i2), AndroidUtilities.m1124dp(220.0f)), View.MeasureSpec.getMode(i2)), i3);
            }
        };
        ...
        this.emptyView.setPadding(AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(5.0f), AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(5.0f));
        ...
        RecyclerListView recyclerListView = new RecyclerListView(context) { // from class: org.telegram.ui.ChannelAdminLogActivity.7
            ...
            public boolean drawChild(Canvas canvas, View view, long j) {
                ...
                if ((view instanceof ChatMessageCell) && (avatarImage = (chatMessageCell = (ChatMessageCell) view).getAvatarImage()) != null) {
                    ...
                    if (y3 - AndroidUtilities.m1124dp(48.0f) < y2) {
                        y3 = y2 + AndroidUtilities.m1124dp(48.0f);
                    }
                    ...
                    if (z) {
                        avatarImage.setImageY(y3 - AndroidUtilities.m1124dp(44.0f));
                    }
        ...
        this.chatListView.setPadding(0, AndroidUtilities.m1124dp(4.0f), 0, AndroidUtilities.m1124dp(3.0f));
        RecyclerListView recyclerListView3 = this.chatListView;
        C35019 c35019 = new C35019(null, this.chatListView, this.resourceProvider);
        this.chatListItemAnimator = c35019;
        recyclerListView3.setItemAnimator(c35019);
        ...
        this.chatListView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.ChannelAdminLogActivity.11
            ...
            private final int scrollValue = AndroidUtilities.m1124dp(100.0f);
        ...
        view.setBackground(Theme.createServiceDrawable(AndroidUtilities.m1124dp(18.0f), this.progressView2, this.contentView));
        this.progressView.addView(this.progressView2, LayoutHelper.createFrame(36, 36, 17));
        RadialProgressView radialProgressView = new RadialProgressView(context);
        this.progressBar = radialProgressView;
        radialProgressView.setStyle(2);
        this.progressBar.setSize(AndroidUtilities.m1124dp(28.0f));
        ...
        this.bottomOverlayChat.setPadding(0, AndroidUtilities.m1124dp(3.0f), 0, 0);
        ...
        this.bottomOverlayChatText.setText(LocaleController.getString("SETTINGS", C2888R.string.SETTINGS).toUpperCase());
        ...
        imageView2.setImageResource(C2888R.drawable.msg_help);
        ...
        this.bottomOverlayImage.setContentDescription(LocaleController.getString("BotHelp", C2888R.string.BotHelp));
        ...
        this.searchContainer.setPadding(0, AndroidUtilities.m1124dp(3.0f), 0, 0);
        ...
        this.searchCalendarButton.setImageResource(C2888R.drawable.msg_calendar);
        ...
        undoView.setAdditionalTranslationY(AndroidUtilities.m1124dp(51.0f));
    ...
    class C35019 extends ChatListItemAnimator {
        Runnable finishRunnable;
        int scrollAnimationIndex;

        C35019(ChatActivity chatActivity, RecyclerListView recyclerListView, Theme.ResourcesProvider resourcesProvider) {
        ...
        public void onAnimationStart() {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1133d("admin logs chatItemAnimator disable notifications");
            }
        }
        ...
        public /* synthetic */ void lambda$onAllAnimationsDone$0() {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1133d("admin logs chatItemAnimator enable notifications");
            }
        }
    }
    ...
    public /* synthetic */ void lambda$createView$9(View view) {
        ...
        adminLogFilterAlert2.setAdminLogFilterAlertDelegate(new AdminLogFilterAlert2.AdminLogFilterAlertDelegate() { // from class: org.telegram.ui.ChannelAdminLogActivity$$ExternalSyntheticLambda10
    ...
    public /* synthetic */ void lambda$createView$8(TLRPC.TL_channelAdminLogEventsFilter tL_channelAdminLogEventsFilter, LongSparseArray longSparseArray) {
        ...
        if (tL_channelAdminLogEventsFilter != null || longSparseArray != null) {
            this.avatarContainer.setSubtitle(LocaleController.getString("EventLogSelectedEvents", C2888R.string.EventLogSelectedEvents));
        } else {
            this.avatarContainer.setSubtitle(LocaleController.getString("EventLogAllEvents", C2888R.string.EventLogAllEvents));
        }
        loadMessages(true);
    ...
    public /* synthetic */ void lambda$createView$10(View view) {
        ...
        if (this.currentChat.megagroup) {
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.getString("EventLogInfoDetail", C2888R.string.EventLogInfoDetail)));
        } else {
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.getString("EventLogInfoDetailChannel", C2888R.string.EventLogInfoDetailChannel)));
        }
        builder.setPositiveButton(LocaleController.getString("OK", C2888R.string.f1606OK), null);
        builder.setTitle(LocaleController.getString("EventLogInfoTitle", C2888R.string.EventLogInfoTitle));
    ...
    */
    public boolean createMenu(final android.view.View r25, final float r26, final float r27) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.ChannelAdminLogActivity.createMenu(android.view.View, float, float):boolean");
    }
    ...
    public /* synthetic */ void lambda$createMenu$14(final ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, View view, float f, float f2) {
        ...
        int y = 0;
        ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout = new ActionBarPopupWindow.ActionBarPopupWindowLayout(getParentActivity(), C2888R.drawable.popup_fixed_alert, getResourceProvider(), 0);
        actionBarPopupWindowLayout.setMinimumWidth(AndroidUtilities.m1124dp(200.0f));
        Rect rect = new Rect();
        getParentActivity().getResources().getDrawable(C2888R.drawable.popup_fixed_alert).mutate().getPadding(rect);
        ...
        while (true) {
            ...
            if (arrayList.get(i) == null) {
                ...
                actionBarMenuSubItem.setMinimumWidth(AndroidUtilities.m1124dp(200.0f));
                ...
                actionBarMenuSubItem.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.ChannelAdminLogActivity$$ExternalSyntheticLambda23
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view2) {
        ...
        this.scrimPopupWindow.setAnimationStyle(C2888R.style.PopupContextAnimation);
        this.scrimPopupWindow.setFocusable(true);
        chatScrimPopupContainerLayout.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(1000.0f), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(1000.0f), Integer.MIN_VALUE));
        ...
        int left = (((view.getLeft() + ((int) f)) - chatScrimPopupContainerLayout.getMeasuredWidth()) + rect.left) - AndroidUtilities.m1124dp(28.0f);
        if (left < AndroidUtilities.m1124dp(6.0f)) {
            left = AndroidUtilities.m1124dp(6.0f);
        } else if (left > (this.chatListView.getMeasuredWidth() - AndroidUtilities.m1124dp(6.0f)) - chatScrimPopupContainerLayout.getMeasuredWidth()) {
            left = (this.chatListView.getMeasuredWidth() - AndroidUtilities.m1124dp(6.0f)) - chatScrimPopupContainerLayout.getMeasuredWidth();
        }
        ...
        int measuredHeight = chatScrimPopupContainerLayout.getMeasuredHeight() + AndroidUtilities.m1124dp(48.0f);
        ...
        if (measuredHeight < height) {
            ...
            if ((measuredHeight - rect.top) - rect.bottom > AndroidUtilities.m1124dp(240.0f)) {
                y += AndroidUtilities.m1124dp(240.0f) - measuredHeight;
            }
            if (y < this.chatListView.getY() + AndroidUtilities.m1124dp(24.0f)) {
                y = (int) (this.chatListView.getY() + AndroidUtilities.m1124dp(24.0f));
            } else {
                int i3 = height - measuredHeight;
                if (y > i3 - AndroidUtilities.m1124dp(8.0f)) {
                    y = i3 - AndroidUtilities.m1124dp(8.0f);
                }
            }
    ...
    */
    public /* synthetic */ void lambda$createMenu$15(org.telegram.tgnet.TLRPC.ChannelParticipant r9, java.util.ArrayList r10, java.util.ArrayList r11, java.util.ArrayList r12, java.lang.Runnable r13) {
        ...
        L70:
            ...
            if (r9 == 0) goto L9d
        L82:
            int r9 = org.telegram.messenger.C2888R.string.Restrict
            java.lang.String r9 = org.telegram.messenger.LocaleController.getString(r9)
            r10.add(r9)
            int r9 = org.telegram.messenger.C2888R.drawable.msg_block2
            ...
            r12.add(r9)
        L9d:
            int r9 = org.telegram.messenger.C2888R.string.Ban
            java.lang.String r9 = org.telegram.messenger.LocaleController.getString(r9)
            r10.add(r9)
            int r9 = org.telegram.messenger.C2888R.drawable.msg_block
            java.lang.Integer r9 = java.lang.Integer.valueOf(r9)
            r11.add(r9)
            r9 = 35
            java.lang.Integer r9 = java.lang.Integer.valueOf(r9)
        ...
        Lb8:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.ChannelAdminLogActivity.lambda$createMenu$15(org.telegram.tgnet.TLRPC$ChannelParticipant, java.util.ArrayList, java.util.ArrayList, java.util.ArrayList, java.lang.Runnable):void");
    }
    ...
    */
    private void processSelectedOption(int r20) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.ChannelAdminLogActivity.processSelectedOption(int):void");
    }
    ...
    public /* synthetic */ void lambda$processSelectedOption$17(TLObject tLObject) {
        if (tLObject instanceof TLRPC.TL_boolTrue) {
            BulletinFactory.m1246of(this).createSimpleBulletin(C2888R.raw.msg_antispam, LocaleController.getString(C2888R.string.ChannelAntiSpamFalsePositiveReported)).show();
        } else if (tLObject instanceof TLRPC.TL_boolFalse) {
            BulletinFactory.m1246of(this).createSimpleBulletin(C2888R.raw.error, LocaleController.getString("UnknownError", C2888R.string.UnknownError)).show();
        } else {
            BulletinFactory.m1246of(this).createSimpleBulletin(C2888R.raw.error, LocaleController.getString("UnknownError", C2888R.string.UnknownError)).show();
        }
    }
    ...
    public /* synthetic */ void lambda$processSelectedOption$19(TLRPC.User user) {
        BulletinFactory.m1246of(this).createSimpleBulletin(C2888R.raw.ic_ban, AndroidUtilities.replaceTags(LocaleController.formatString(C2888R.string.RestrictedParticipantSending, UserObject.getFirstName(user)))).show(false);
    ...
    private int getMessageType(MessageObject messageObject) {
        ...
        if (messageObject.isSticker() || messageObject.isAnimatedSticker()) {
            ...
            if (inputStickerSet instanceof TLRPC.TL_inputStickerSetID) {
                if (!MediaDataController.getInstance(this.currentAccount).isStickerPackInstalled(inputStickerSet.f1685id)) {
                    return 7;
                }
    ...
    public /* synthetic */ void lambda$loadAdmins$21(TLRPC.TL_error tL_error, TLObject tLObject) {
        ...
        if (tL_error == null) {
            ...
            if (this.currentChat != null && (chatFull = getMessagesController().getChatFull(this.currentChat.f1660id)) != null && chatFull.antispam) {
    ...
    private void loadAntispamUser(long j) {
        ...
        tL_users_getUsers.f1818id.add(tL_inputUser);
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_users_getUsers, new RequestDelegate() { // from class: org.telegram.ui.ChannelAdminLogActivity$$ExternalSyntheticLambda14
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    public void updateMessagesVisiblePart() {
        ...
        for (int i3 = 0; i3 < childCount; i3++) {
            ...
            if (childAt instanceof ChatMessageCell) {
                ...
                chatMessageCell.setVisiblePart(i4, measuredHeight2 - i4, (this.contentView.getHeightWithKeyboard() - AndroidUtilities.m1124dp(48.0f)) - this.chatListView.getTop(), 0.0f, (childAt.getY() + this.actionBar.getMeasuredHeight()) - this.contentView.getBackgroundTranslationY(), this.contentView.getMeasuredWidth(), this.contentView.getBackgroundSizeY(), 0, 0, 0);
    ...
    public void alertUserOpenError(MessageObject messageObject) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
        builder.setTitle(LocaleController.getString("AppName", C2888R.string.AppName));
        builder.setPositiveButton(LocaleController.getString("OK", C2888R.string.f1606OK), null);
        if (messageObject.type == 3) {
            builder.setMessage(LocaleController.getString("NoPlayerInstalled", C2888R.string.NoPlayerInstalled));
        } else {
            builder.setMessage(LocaleController.formatString("NoHandleAppInstalled", C2888R.string.NoHandleAppInstalled, messageObject.getDocument().mime_type));
        }
        showDialog(builder.create());
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x0034, code lost:
        ...
        r5.putLong("ban_chat_id", r4.currentChat.f1660id);
     */
    ...
    */
    public void addCanBanUser(android.os.Bundle r5, long r6) {
        /*
            ...
            if (r1 == 0) goto L3d
            java.util.ArrayList r1 = r4.admins
            if (r1 == 0) goto L3d
        ...
        L31:
            ...
            goto L12
        L34:
            org.telegram.tgnet.TLRPC$Chat r6 = r4.currentChat
            long r6 = r6.f1660id
        ...
        L3d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.ChannelAdminLogActivity.addCanBanUser(android.os.Bundle, long):void");
    }
    ...
    public void showOpenUrlAlert(final String str, boolean z) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
        builder.setTitle(LocaleController.getString("OpenUrlTitle", C2888R.string.OpenUrlTitle));
        builder.setMessage(LocaleController.formatString("OpenUrlAlert2", C2888R.string.OpenUrlAlert2, str));
        builder.setPositiveButton(LocaleController.getString("Open", C2888R.string.Open), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ChannelAdminLogActivity$$ExternalSyntheticLambda16
    ...
    public class ChatActivityAdapter extends RecyclerView.Adapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                chatMessageCell2.setDelegate(new C35021());
                ...
                ChatActionCell chatActionCell = new ChatActionCell(this.mContext) { // from class: org.telegram.ui.ChannelAdminLogActivity.ChatActivityAdapter.2
                    @Override // org.telegram.p029ui.Cells.ChatActionCell, android.view.View
                    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
                        super.onInitializeAccessibilityNodeInfo(accessibilityNodeInfo);
                        accessibilityNodeInfo.setVisibleToUser(true);
                    }
                };
                chatActionCell.setDelegate(new C35063());
        ...
        class C35021 implements ChatMessageCell.ChatMessageCellDelegate {
            ...
            public void didPressUserAvatar(ChatMessageCell chatMessageCell, TLRPC.User user, float f, float f2, boolean z) {
                if (user == null || user.f1825id == UserConfig.getInstance(((BaseFragment) ChannelAdminLogActivity.this).currentAccount).getClientUserId()) {
                    return;
                }
                openProfile(user);
            }
            ...
            public boolean didLongPressUserAvatar(final ChatMessageCell chatMessageCell, final TLRPC.User user, float f, float f2) {
                AvatarPreviewer.Data dataM1216of;
                if (user != null && user.f1825id != UserConfig.getInstance(((BaseFragment) ChannelAdminLogActivity.this).currentAccount).getClientUserId()) {
                    TLRPC.User user2 = ChannelAdminLogActivity.this.getMessagesController().getUser(Long.valueOf(user.f1825id));
                    if (user2 != null) {
                        user = user2;
                    }
                    AvatarPreviewer.MenuItem[] menuItemArr = {AvatarPreviewer.MenuItem.OPEN_PROFILE, AvatarPreviewer.MenuItem.SEND_MESSAGE};
                    TLRPC.UserFull userFull = ChannelAdminLogActivity.this.getMessagesController().getUserFull(user.f1825id);
                    if (userFull == null) {
                        dataM1216of = AvatarPreviewer.Data.m1216of(user, ((BaseFragment) ChannelAdminLogActivity.this).classGuid, menuItemArr);
                    } else {
                        dataM1216of = AvatarPreviewer.Data.m1217of(user, userFull, menuItemArr);
                    }
                    if (AvatarPreviewer.canPreview(dataM1216of)) {
                        ...
                        avatarPreviewer.show((ViewGroup) channelAdminLogActivity.fragmentView, channelAdminLogActivity.getResourceProvider(), dataM1216of, new AvatarPreviewer.Callback() { // from class: org.telegram.ui.ChannelAdminLogActivity$ChatActivityAdapter$1$$ExternalSyntheticLambda1
            ...
            public /* synthetic */ void lambda$didLongPressUserAvatar$0(ChatMessageCell chatMessageCell, TLRPC.User user, AvatarPreviewer.MenuItem menuItem) {
                int i = C349423.$SwitchMap$org$telegram$ui$AvatarPreviewer$MenuItem[menuItem.ordinal()];
                if (i == 1) {
            ...
            private void openProfile(TLRPC.User user) {
                ...
                ChannelAdminLogActivity.this.addCanBanUser(bundle, user.f1825id);
            ...
            public void didPressUrl(ChatMessageCell chatMessageCell, CharacterStyle characterStyle, boolean z) {
                ...
                if (characterStyle instanceof URLSpanMono) {
                    ...
                    if (AndroidUtilities.shouldShowClipboardToast()) {
                        Toast.makeText(ChannelAdminLogActivity.this.getParentActivity(), LocaleController.getString("TextCopied", C2888R.string.TextCopied), 0).show();
                        return;
                    }
                    return;
                }
                ...
                if (z) {
                    ...
                    builder.setItems(new CharSequence[]{LocaleController.getString("Open", C2888R.string.Open), LocaleController.getString("Copy", C2888R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ChannelAdminLogActivity$ChatActivityAdapter$1$$ExternalSyntheticLambda0
            ...
            public void didPressReplyMessage(ChatMessageCell chatMessageCell, int i, float f, float f2, boolean z) {
                ...
                if (messageObject.getDialogId() == (-ChannelAdminLogActivity.this.currentChat.f1660id)) {
                ...
                Bundle bundle = new Bundle();
                bundle.putLong("chat_id", ChannelAdminLogActivity.this.currentChat.f1660id);
            ...
            /*
                ...
                To view partially-correct code enable 'Show inconsistent code' option in preferences
            */
            public void didPressImage(org.telegram.p029ui.Cells.ChatMessageCell r11, float r12, float r13, boolean r14) {
                /*
                    Method dump skipped, instruction units count: 499
                    To view this dump change 'Code comments level' option to 'DEBUG'
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.ChannelAdminLogActivity.ChatActivityAdapter.C35021.didPressImage(org.telegram.ui.Cells.ChatMessageCell, float, float, boolean):void");
            }
            ...
            public void didPressInstantButton(ChatMessageCell chatMessageCell, int i) {
                ...
                if (tL_channelAdminLogEvent != null && (tL_channelAdminLogEvent.action instanceof TLRPC.TL_channelAdminLogEventActionEditMessage)) {
                    ...
                    if (ChatObject.isForum(ChannelAdminLogActivity.this.currentChat)) {
                        ForumUtilities.applyTopic(chatActivity, MessagesStorage.TopicKey.m1166of(messageObject.getDialogId(), MessageObject.getTopicId(((BaseFragment) ChannelAdminLogActivity.this).currentAccount, messageObject.messageOwner, true)));
                    }
        ...
        class C35063 implements ChatActionCell.ChatActionCellDelegate {
            ...
            public void needOpenInviteLink(final TLRPC.TL_chatInviteExported tL_chatInviteExported) {
                ...
                if (obj == null) {
                    ...
                    tL_messages_getExportedChatInvite.peer = ChannelAdminLogActivity.this.getMessagesController().getInputPeer(-ChannelAdminLogActivity.this.currentChat.f1660id);
                ...
                if (obj instanceof TLRPC.TL_messages_exportedChatInvite) {
                    ...
                    BulletinFactory.m1246of(ChannelAdminLogActivity.this).createSimpleBulletin(C2888R.raw.linkbroken, LocaleController.getString("LinkHashExpired", C2888R.string.LinkHashExpired)).show();
                }
            }
            ...
            public /* synthetic */ void lambda$needOpenInviteLink$2(final TLRPC.TL_chatInviteExported tL_chatInviteExported, final boolean[] zArr, final AlertDialog alertDialog, TLObject tLObject, TLRPC.TL_error tL_error) {
                ...
                if (tL_error == null) {
                    ...
                    for (int i = 0; i < tL_messages_exportedChatInvite.users.size(); i++) {
                        ...
                        ChannelAdminLogActivity.this.usersMap.put(Long.valueOf(user.f1825id), user);
                    }
                } else {
            ...
            public long getDialogId() {
                return -ChannelAdminLogActivity.this.currentChat.f1660id;
            }
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.ChannelAdminLogActivity$23 */
    static /* synthetic */ class C349423 {
    ...
    public void showInviteLinkBottomSheet(TLRPC.TL_messages_exportedChatInvite tL_messages_exportedChatInvite, HashMap map) {
        TLRPC.ChatFull chatFull = getMessagesController().getChatFull(this.currentChat.f1660id);
        InviteLinkBottomSheet inviteLinkBottomSheet = new InviteLinkBottomSheet(this.contentView.getContext(), (TLRPC.TL_chatInviteExported) tL_messages_exportedChatInvite.invite, chatFull, map, this, chatFull.f1661id, false, ChatObject.isChannel(this.currentChat));
    ...
    */
    public void scrollToMessage(org.telegram.messenger.MessageObject r13, boolean r14) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.ChannelAdminLogActivity.scrollToMessage(org.telegram.messenger.MessageObject, boolean):void");
    }
    ...
    private void startMessageUnselect() {
        ...
        Runnable runnable2 = new Runnable() { // from class: org.telegram.ui.ChannelAdminLogActivity$$ExternalSyntheticLambda22
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void showNoQuoteFound() {
        BulletinFactory.m1246of(this).createSimpleBulletin(C2888R.raw.error, LocaleController.getString(C2888R.string.QuoteNotFound)).show(true);
    }
    ...
    private int getScrollOffsetForMessage(int i) {
        return Math.max(-AndroidUtilities.m1124dp(2.0f), (this.chatListView.getMeasuredHeight() - i) / 2);
    }
    ...
    private int scrollOffsetForQuote(MessageObject messageObject) {
        ...
        if (!TextUtils.isEmpty(messageObject.caption) && (chatMessageCell = this.dummyMessageCell) != null && (textLayoutBlocks = chatMessageCell.captionLayout) != null) {
            iM1124dp = (int) chatMessageCell.captionY;
            ...
            if (chatMessageCell3 == null || !chatMessageCell3.linkPreviewAbove) {
                ...
                iM1124dp = chatMessageCell3.linkPreviewHeight + AndroidUtilities.m1124dp(10.0f);
                charSequence = charSequence2;
            }
        }
        ...
        for (int i = 0; i < arrayList.size(); i++) {
            ...
            if (iFindQuoteStart > i2) {
                if (iFindQuoteStart - i2 > string.length() - 1) {
                    lineTop = iM1124dp + ((int) (textLayoutBlock.textYOffset(arrayList) + textLayoutBlock.padTop + textLayoutBlock.height));
                } else {
                    lineTop = r5.getLineTop(r5.getLineForOffset(iFindQuoteStart - textLayoutBlock.charactersOffset)) + iM1124dp + textLayoutBlock.textYOffset(arrayList) + textLayoutBlock.padTop;
                }
    ...
    public boolean isKeyboardVisible() {
        return this.contentView.getKeyboardHeight() > AndroidUtilities.m1124dp(20.0f);
    }
    ...
    */
    public void saveScrollPosition(boolean r8) {
        ...
        L43:
            if (r1 == 0) goto L6d
            boolean r8 = r1 instanceof org.telegram.p029ui.Cells.ChatMessageCell
            if (r8 == 0) goto L53
            r8 = r1
            org.telegram.ui.Cells.ChatMessageCell r8 = (org.telegram.p029ui.Cells.ChatMessageCell) r8
            org.telegram.messenger.MessageObject r8 = r8.getMessageObject()
            long r3 = r8.eventId
            goto L63
        L53:
            boolean r8 = r1 instanceof org.telegram.p029ui.Cells.ChatActionCell
            if (r8 == 0) goto L61
            r8 = r1
            org.telegram.ui.Cells.ChatActionCell r8 = (org.telegram.p029ui.Cells.ChatActionCell) r8
            org.telegram.messenger.MessageObject r8 = r8.getMessageObject()
            long r3 = r8.eventId
            goto L63
        L61:
        ...
        L6d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.ChannelAdminLogActivity.saveScrollPosition(boolean):void");
    }
