...
import org.telegram.p029ui.Stories.StoryReactionWidgetView;
...
public class EmojiAnimationsOverlay implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void checkStickerPack() {
        ...
        if (this.set != null) {
            ...
            for (int i = 0; i < this.set.documents.size(); i++) {
                map.put(Long.valueOf(((TLRPC.Document) this.set.documents.get(i)).f1668id), (TLRPC.Document) this.set.documents.get(i));
            }
                        ...
                        if (drawingObject.isMessageEffect && (childAt instanceof ChatMessageCell)) {
                            ...
                            if (drawingObject.isPremiumSticker) {
                                ...
                                if (drawingObject.isOut) {
                                    fM1124dp = ((-photoImage.getImageWidth()) * 2.0f) + AndroidUtilities.m1124dp(24.0f);
                                } else {
                                    fM1124dp = -AndroidUtilities.m1124dp(24.0f);
                                }
                                float f5 = imageX + fM1124dp;
    ...
    public boolean onTapItem(ChatMessageCell chatMessageCell, ChatActivity chatActivity, boolean z) {
        ...
        if ((printingStringType == null || printingStringType.intValue() != 5) && this.hintRunnable == null && zShowAnimationForCell && ((Bulletin.getVisibleBulletin() == null || !Bulletin.getVisibleBulletin().isShowing()) && SharedConfig.emojiInteractionsHintCount > 0 && UserConfig.getInstance(this.currentAccount).getClientUserId() != chatActivity.currentUser.f1825id)) {
            ...
            stickerSetBulletinLayout.titleTextView.setText(Emoji.replaceEmoji(AndroidUtilities.replaceTags(LocaleController.formatString("EmojiInteractionTapHint", C2888R.string.EmojiInteractionTapHint, chatActivity.currentUser.first_name)), stickerSetBulletinLayout.titleTextView.getPaint().getFontMetricsInt(), false));
    ...
    public boolean showAnimationForActionCell(ChatActionCell chatActionCell, TLRPC.Document document, TLRPC.VideoSize videoSize) {
        ...
        for (int i3 = 0; i3 < this.drawingObjects.size(); i3++) {
            ...
            if (((DrawingObject) this.drawingObjects.get(i3)).document != null && document != null && ((DrawingObject) this.drawingObjects.get(i3)).document.f1668id == document.f1668id) {
                i2++;
            }
        }
        if (i >= 4) {
        ...
        if (i2 > 0) {
            Integer num = (Integer) this.lastAnimationIndex.get(Long.valueOf(document.f1668id));
            int iIntValue = num == null ? 0 : num.intValue();
            this.lastAnimationIndex.put(Long.valueOf(document.f1668id), Integer.valueOf((iIntValue + 1) % 4));
    ...
    private void preloadAnimation(TLRPC.Document document) {
        ...
        if (map == null || !map.containsKey(Long.valueOf(document.f1668id))) {
            if (this.preloaded == null) {
                this.preloaded = new HashMap();
            }
            this.preloaded.put(Long.valueOf(document.f1668id), Boolean.TRUE);
            ...
            if (z9 || ((arrayList != null && !arrayList.isEmpty()) || z8)) {
                ...
                while (i4 < this.drawingObjects.size()) {
                    ...
                    if (((DrawingObject) this.drawingObjects.get(i4)).document == null || document == null) {
                        ...
                        z5 = z7;
                        z6 = z8;
                        if (((DrawingObject) this.drawingObjects.get(i4)).document.f1668id == document.f1668id) {
                            i6++;
                        }
                    }
                    i4++;
                ...
                if (z && z11 && i5 > 0) {
                    ...
                    if (stickerSetByName == null) {
                        stickerSetByName = MediaDataController.getInstance(this.currentAccount).getStickerSetById(inputStickerSet.f1685id);
                    }
                    if (stickerSetByName == null) {
                ...
                if (z9) {
                    ...
                    while (true) {
                        ...
                        if (document2 != null && document2.f1668id == j2) {
                            break;
                        }
                        i7++;
                    }
                        ...
                        if (messageObject != null && messageObject.isAnimatedAnimatedEmoji()) {
                            if (iAbs < 0 || iAbs > arrayList.size() - 1) {
                                ...
                                for (int i8 = z10 ? 1 : 0; i8 < arrayList.size(); i8++) {
                                    ...
                                    if (document3 != null) {
                                        HashMap map = this.preloaded;
                                        Boolean bool = map != null ? (Boolean) map.get(Long.valueOf(document3.f1668id)) : null;
                ...
                if (premiumStickerAnimation == null) {
                    int filterWidth = getFilterWidth();
                    Integer num = (Integer) this.lastAnimationIndex.get(Long.valueOf(document2.f1668id));
                    if (num == null) {
                        iIntValue2 = z10 ? 1 : 0;
                    } else {
                    ...
                    int i9 = iIntValue2 + 1;
                    this.lastAnimationIndex.put(Long.valueOf(document2.f1668id), Integer.valueOf(i9));
                    ...
                    if (drawingObject.imageReceiver.getLottieAnimation() != null) {
                        drawingObject.imageReceiver.getLottieAnimation().setCurrentFrame(z10 ? 1 : 0, z10, true);
                    }
                    i3 = iAbs;
                } else {
                    int filterWidth2 = getFilterWidth();
                    if (i6 > 0) {
                        Integer num2 = (Integer) this.lastAnimationIndex.get(Long.valueOf(document2.f1668id));
                        int iIntValue3 = num2 == null ? 0 : num2.intValue();
                        i3 = iAbs;
                        this.lastAnimationIndex.put(Long.valueOf(document2.f1668id), Integer.valueOf((iIntValue3 + 1) % 4));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: showStickerSetBulletin, reason: merged with bridge method [inline-methods] */
    public void lambda$createDrawingObject$0(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, final MessageObject messageObject) {
        ...
        stickerSetBulletinLayout.subtitleTextView.setText(LocaleController.getString(C2888R.string.PremiumStickerTooltip));
        ...
        undoButton.setText(LocaleController.getString(C2888R.string.ViewAction));
    ...
    */
    public static java.lang.String unwrapEmoji(java.lang.String r8) {
        ...
        L8d:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.EmojiAnimationsOverlay.unwrapEmoji(java.lang.String):java.lang.String");
    }
