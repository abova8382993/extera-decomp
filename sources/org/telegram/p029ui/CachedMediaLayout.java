...
public abstract class CachedMediaLayout extends FrameLayout implements NestedSizeNotifierLayout.ChildLayout {
    ...
    public CachedMediaLayout(Context context, BaseFragment baseFragment) {
        ...
        pageArr[0] = new Page(LocaleController.getString(C2888R.string.FilterChats), 0, new DialogsAdapter());
        this.allPages[1] = new Page(LocaleController.getString(C2888R.string.MediaTab), 1, new MediaAdapter(false));
        this.allPages[2] = new Page(LocaleController.getString(C2888R.string.SharedFilesTab2), 2, new DocumentsAdapter());
        this.allPages[3] = new Page(LocaleController.getString(C2888R.string.Music), 3, new MusicAdapter());
        int i = 0;
        while (true) {
            ...
            if (i < pageArr2.length) {
                ...
                View c32861 = new View(getContext()) { // from class: org.telegram.ui.CachedMediaLayout.1
                    C32861(Context context2) {
                        super(context2);
                    }
                ...
                this.divider = c32861;
                addView(c32861, LayoutHelper.createFrame(-1, 1.0f, 0, 0.0f, 48.0f, 0.0f, 0.0f));
                c32861.getLayoutParams().height = 1;
                this.viewPagerFixed.setAdapter(new C32872(context, baseFragment));
                ...
                imageView.setContentDescription(LocaleController.getString(C2888R.string.Close));
                linearLayout.addView(imageView, new LinearLayout.LayoutParams(AndroidUtilities.m1124dp(54.0f), -1));
                ...
                animatedTextView.setTextSize(AndroidUtilities.m1124dp(18.0f));
                ...
                actionBarMenuItem.setIcon(C2888R.drawable.msg_clear);
                actionBarMenuItem.setContentDescription(LocaleController.getString(C2888R.string.Delete));
                actionBarMenuItem.setDuplicateParentStateEnabled(false);
                linearLayout.addView(actionBarMenuItem, new LinearLayout.LayoutParams(AndroidUtilities.m1124dp(54.0f), -1));
    ...
    class C32872 extends ViewPagerFixed.Adapter {
        ...
        C32872(Context context, BaseFragment baseFragment) {
                ...
                public void onItemClick(View view, int i2) {
                    ...
                    if (view instanceof SharedPhotoVideoCell2) {
                        ...
                        if (mediaAdapter.isStories) {
                            ...
                            tL_storyItem.f1857id = Objects.hash(fileInfo.file.getAbsolutePath());
                            tL_storyItem.attachPath = itemInner.file.file.getAbsolutePath();
                            tL_storyItem.date = -1;
                            C32872.this.val$parentFragment.getOrCreateStoryViewer().open(C32872.this.val$context, tL_storyItem, StoriesListPlaceProvider.m1320of(recyclerListView));
                            return;
                        }
        ...
        public /* synthetic */ boolean lambda$createView$5(final RecyclerListView recyclerListView, final BaseFragment baseFragment, final View view, int i, float f, float f2) {
            ...
            if ((view instanceof CacheCell) || (view instanceof SharedPhotoVideoCell2)) {
                ...
                if (view instanceof SharedPhotoVideoCell2) {
                    ActionBarMenuItem.addItem(actionBarPopupWindowLayout, C2888R.drawable.msg_view_file, LocaleController.getString(C2888R.string.CacheOpenFile), false, null).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CachedMediaLayout$2$$ExternalSyntheticLambda1
                        @Override // android.view.View.OnClickListener
                    ...
                    ActionBarMenuItem.addItem(actionBarPopupWindowLayout, C2888R.drawable.msg_played, LocaleController.getString(C2888R.string.PlayFile), false, null).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CachedMediaLayout$2$$ExternalSyntheticLambda2
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view2) {
                    ...
                    ActionBarMenuItem.addItem(actionBarPopupWindowLayout, C2888R.drawable.msg_view_file, LocaleController.getString(C2888R.string.CacheOpenFile), false, null).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CachedMediaLayout$2$$ExternalSyntheticLambda3
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view2) {
                ...
                if (fileInfo.dialogId != 0 && fileInfo.messageId != 0) {
                    ActionBarMenuItem.addItem(actionBarPopupWindowLayout, C2888R.drawable.msg_viewintopic, LocaleController.getString(C2888R.string.ViewInChat), false, null).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CachedMediaLayout$2$$ExternalSyntheticLambda4
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view2) {
                ...
                ActionBarMenuItem.addItem(actionBarPopupWindowLayout, C2888R.drawable.msg_select, LocaleController.getString(!CachedMediaLayout.this.cacheModel.selectedFiles.contains(itemInner.file) ? C2888R.string.Select : C2888R.string.Deselect), false, null).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.CachedMediaLayout$2$$ExternalSyntheticLambda5
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view2) {
    ...
    private class DialogsAdapter extends BaseAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (dialogFileEntities.dialogId == Long.MAX_VALUE) {
                dialogPhotoTitle = LocaleController.getString(C2888R.string.CacheOtherChats);
    ...
    private class MediaAdapter extends BaseFilesAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            C32891 c32891 = new SharedPhotoVideoCell2(viewGroup.getContext(), this.sharedResources, CachedMediaLayout.this.parentFragment.getCurrentAccount()) { // from class: org.telegram.ui.CachedMediaLayout.MediaAdapter.1
                C32891(Context context, SharedPhotoVideoCell2.SharedResources sharedResources, int i2) {
                    super(context, sharedResources, i2);
                }

                @Override // org.telegram.p029ui.Cells.SharedPhotoVideoCell2
            ...
            c32891.setStyle(1);
            return new RecyclerListView.Holder(c32891);
        }

        /* JADX INFO: renamed from: org.telegram.ui.CachedMediaLayout$MediaAdapter$1 */
        class C32891 extends SharedPhotoVideoCell2 {
            C32891(Context context, SharedPhotoVideoCell2.SharedResources sharedResources, int i2) {
                super(context, sharedResources, i2);
            }
    ...
    private class DocumentsAdapter extends BaseFilesAdapter {
        ...
        class C32881 extends CacheCell {
            C32881(Context context) {
                super(context);
            }
        ...
        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            C32881 c32881 = new CacheCell(viewGroup.getContext()) { // from class: org.telegram.ui.CachedMediaLayout.DocumentsAdapter.1
                C32881(Context context) {
                    super(context);
                }
            ...
            c32881.type = 2;
            c32881.container.addView(new SharedDocumentCell(viewGroup.getContext(), 3, null));
            return new RecyclerListView.Holder(c32881);
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            sharedDocumentCell.setTextAndValueAndTypeAndThumb(fileInfo.messageType == 5 ? LocaleController.getString(C2888R.string.AttachRound) : fileInfo.file.getName(), LocaleController.formatDateAudio(fileInfo.file.lastModified() / 1000, true), Utilities.getExtension(fileInfo.file.getName()), null, 0, z2);
            if (!z) {
                sharedDocumentCell.setPhoto(fileInfo.file.getPath());
            }
            sharedDocumentCell.getImageView().setRoundRadius(AndroidUtilities.m1124dp(fileInfo.messageType == 5 ? 20.0f : 4.0f));
    ...
    private class MusicAdapter extends BaseFilesAdapter {
        ...
        class C32901 extends CacheCell {
            C32901(Context context) {
                super(context);
            }
        ...
        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            C32901 c32901 = new CacheCell(viewGroup.getContext()) { // from class: org.telegram.ui.CachedMediaLayout.MusicAdapter.1
                C32901(Context context) {
                    super(context);
                }
            ...
            c32901.type = 3;
            C32912 c32912 = new SharedAudioCell(viewGroup.getContext(), 0, null) { // from class: org.telegram.ui.CachedMediaLayout.MusicAdapter.2
                final /* synthetic */ CacheCell val$cacheCell;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C32912(Context context, int i2, Theme.ResourcesProvider resourcesProvider, CacheCell c329012) {
            ...
            c32912.setCheckForButtonPress(true);
            c329012.container.addView(c32912);
            return new RecyclerListView.Holder(c329012);
        }

        /* JADX INFO: renamed from: org.telegram.ui.CachedMediaLayout$MusicAdapter$2 */
        class C32912 extends SharedAudioCell {
            final /* synthetic */ CacheCell val$cacheCell;
    ...
    */
    public /* synthetic */ void lambda$checkMessageObjectForAudio$3(final org.telegram.ui.Storage.CacheModel.FileInfo r12, final org.telegram.tgnet.TLRPC.TL_documentAttributeAudio r13) throws java.lang.Throwable {
        ...
        L35:
            ...
            goto L30
        L37:
            org.telegram.messenger.FileLog.m1136e(r0)     // Catch: java.lang.Throwable -> L32
            if (r2 == 0) goto L3f
        ...
        L52:
            throw r12
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.CachedMediaLayout.lambda$checkMessageObjectForAudio$3(org.telegram.ui.Storage.CacheModel$FileInfo, org.telegram.tgnet.TLRPC$TL_documentAttributeAudio):void");
    }
    ...
    class CacheCell extends FrameLayout {
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            if (this.drawDivider) {
                if (LocaleController.isRTL) {
                    canvas.drawLine(0.0f, getMeasuredHeight() - 1, getMeasuredWidth() - AndroidUtilities.m1124dp(48.0f), getMeasuredHeight() - 1, Theme.dividerPaint);
                } else {
                    canvas.drawLine(getMeasuredWidth() - AndroidUtilities.m1124dp(90.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, Theme.dividerPaint);
                }
            }
        }
    }
