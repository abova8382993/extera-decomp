...
import org.telegram.p029ui.Cells.FeaturedStickerSetCell2;
import org.telegram.p029ui.Cells.StickerSetCell;
...
import org.telegram.p029ui.Components.ReorderingBulletinLayout;
import org.telegram.p029ui.Components.ShareAlert;
import org.telegram.p029ui.Components.StickersAlert;
import org.telegram.p029ui.Components.TrendingStickersAlert;
...
public class StickersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private ArrayList getFeaturedSets() {
        ...
        if (this.currentType == 5) {
            ...
            while (i < arrayList.size()) {
                if (arrayList.get(i) == null || mediaDataController.isStickerPackInstalled(((TLRPC.StickerSetCovered) arrayList.get(i)).set.f1696id, false)) {
                    arrayList.remove(i);
                    i--;
                }
                i++;
    ...
    public View createView(Context context) {
        ...
        int i = this.currentType;
        if (i == 0) {
            this.actionBar.setTitle(LocaleController.getString(C2888R.string.StickersName));
        } else if (i == 1) {
            this.actionBar.setTitle(LocaleController.getString(C2888R.string.Masks));
        } else if (i == 5) {
            this.actionBar.setTitle(LocaleController.getString(C2888R.string.Emoji));
        }
        ...
        this.shareMenuItem = actionBarMenuCreateActionMode.addItemWithWidth(2, C2888R.drawable.msg_share, AndroidUtilities.m1124dp(54.0f));
        this.archiveMenuItem = actionBarMenuCreateActionMode.addItemWithWidth(0, C2888R.drawable.msg_archive, AndroidUtilities.m1124dp(54.0f));
        this.deleteMenuItem = actionBarMenuCreateActionMode.addItemWithWidth(1, C2888R.drawable.msg_delete, AndroidUtilities.m1124dp(54.0f));
    ...
    private String suggestStickersName() {
        ...
        if (i == 0) {
            return LocaleController.getString(C2888R.string.SuggestStickersAll);
        }
        if (i == 1) {
            return LocaleController.getString(C2888R.string.SuggestStickersInstalled);
        }
        return LocaleController.getString(C2888R.string.SuggestStickersNone);
    }
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        while (true) {
            ...
            if (this.loadingFeaturedStickerSets.contains(Long.valueOf(((TLRPC.StickerSetCovered) this.featured.get(i2)).set.f1696id))) {
        ...
        if (this.currentType == 0) {
            ...
            int i3 = C2888R.drawable.msg2_trending;
            String string = LocaleController.getString(C2888R.string.FeaturedStickers);
            ...
            if (archivedStickersCount > 0) {
                ...
                if (i4 == 0) {
                    arrayList.add(UItem.asButton(2, C2888R.drawable.msg2_archived_stickers, LocaleController.getString(C2888R.string.ArchivedStickers), LocaleController.formatNumber(archivedStickersCount, ',')));
                } else {
                    arrayList.add(UItem.asButton(2, LocaleController.getString(i4 == 5 ? C2888R.string.ArchivedEmojiPacks : C2888R.string.ArchivedMasks), LocaleController.formatNumber(archivedStickersCount, ',')));
                }
            }
            this.emojiPacksRow = arrayList.size();
            int i5 = C2888R.drawable.msg2_smile_status;
            String string2 = LocaleController.getString(C2888R.string.Emoji);
            if (size2 > 0) {
            ...
            if (i6 == 0) {
                ...
                arrayList.add(UItem.asButton(2, LocaleController.getString(i6 == 5 ? C2888R.string.ArchivedEmojiPacks : C2888R.string.ArchivedMasks), LocaleController.formatNumber(archivedStickersCount, ',')));
            }
            if (this.currentType == 1) {
                arrayList.add(UItem.asShadow(LocaleController.getString(C2888R.string.ArchivedMasksInfo)));
            }
        }
        if (this.currentType == 0) {
            this.reactionsDoubleTapRow = arrayList.size();
            arrayList.add(UItem.asSettingsCell(4, C2888R.drawable.msg2_reactions2, LocaleController.getString(C2888R.string.DoubleTapSetting)).onBind(new Utilities.Callback() { // from class: org.telegram.ui.StickersActivity$$ExternalSyntheticLambda12
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    this.f$0.setQuickReactionImage((View) obj);
                }
            }));
            arrayList.add(UItem.asShadow(addStickersBotSpan(LocaleController.getString(this.currentType == 5 ? C2888R.string.EmojiBotInfo : C2888R.string.StickersBotInfo))));
            arrayList.add(UItem.asHeader(LocaleController.getString(C2888R.string.StickersSettings)));
            this.suggestRow = arrayList.size();
            arrayList.add(UItem.asSettingsCell(5, LocaleController.getString(C2888R.string.SuggestStickers), suggestStickersName()));
            this.largeEmojiRow = arrayList.size();
            arrayList.add(UItem.asCheck(6, LocaleController.getString(C2888R.string.LargeEmoji)).setChecked(SharedConfig.allowBigEmoji));
            this.dynamicPackOrder = arrayList.size();
            arrayList.add(UItem.asCheck(7, LocaleController.getString(C2888R.string.DynamicPackOrder)).setChecked(SharedConfig.updateStickersOrderOnSend));
            arrayList.add(UItem.asShadow(LocaleController.getString(C2888R.string.DynamicPackOrderInfo)));
        }
        if (this.currentType == 5) {
            arrayList.add(UItem.asCheck(9, LocaleController.getString(C2888R.string.SuggestAnimatedEmoji)).setChecked(SharedConfig.suggestAnimatedEmoji));
            arrayList.add(UItem.asShadow(LocaleController.getString(C2888R.string.SuggestAnimatedEmojiInfo)));
        }
        if (this.sets.size() > 0) {
            universalAdapter.whiteSectionStart();
            if (this.currentType == 5 || (!this.featured.isEmpty() && this.currentType == 0)) {
                arrayList.add(UItem.asHeader(LocaleController.getString(this.currentType == 5 ? C2888R.string.ChooseStickerMyEmojiPacks : C2888R.string.ChooseStickerMyStickerSets)));
            }
            ...
            while (i7 < size3) {
                ...
                arrayList.add(StickerSetCell.Factory.m1233of(tL_messages_stickerSet).setClickCallback(new View.OnClickListener() { // from class: org.telegram.ui.StickersActivity$$ExternalSyntheticLambda13
                ...
                }).setChecked(this.selectedSets.contains(Long.valueOf(tL_messages_stickerSet.set.f1696id))));
            }
            ...
            if (i8 != 1 && i8 != 5) {
                ...
                arrayList.add(UItem.asShadow(LocaleController.getString(C2888R.string.MasksInfo)));
            }
        }
        ...
        if (this.currentType == 5 && !this.featured.isEmpty()) {
            ...
            arrayList.add(UItem.asHeader(LocaleController.getString(this.currentType == 5 ? C2888R.string.FeaturedEmojiPacks : C2888R.string.FeaturedStickers)));
            ...
            while (i < size4) {
                ...
                arrayList.add(FeaturedStickerSetCell2.Factory.m1228of(stickerSetCovered).setClickCallback(new View.OnClickListener() { // from class: org.telegram.ui.StickersActivity$$ExternalSyntheticLambda15
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        this.f$0.onFeaturedAddClick(view);
                    }
                }).setLocked(this.loadingFeaturedStickerSets.contains(Long.valueOf(stickerSetCovered.set.f1696id))));
            }
            if (z) {
                arrayList.add(UItem.asButton(8, C2888R.drawable.msg2_trending, LocaleController.getString(C2888R.string.ShowMoreEmojiPacks)).accent());
            }
        }
        int i9 = this.currentType;
        if (i9 == 5) {
            arrayList.add(UItem.asShadow(addStickersBotSpan(LocaleController.getString(i9 == 5 ? C2888R.string.EmojiBotInfo : C2888R.string.StickersBotInfo))));
        }
    }
    ...
    public void onClick(UItem uItem, final View view, int i, float f, float f2) {
        ...
        if (obj instanceof TLRPC.StickerSetCovered) {
            ...
            tL_inputStickerSetID2.f1685id = stickerSet3.f1696id;
        ...
        switch (uItem.f2105id) {
                    ...
                    if (featuredSets != null) {
                        for (int i2 = 0; i2 < featuredSets.size(); i2++) {
                            ...
                            if (stickerSetCovered != null && stickerSetCovered.set != null) {
                                ...
                                tL_inputStickerSetID3.f1685id = stickerSet4.f1696id;
            ...
            case 4:
                ...
                break;
            case 5:
                ItemOptions.makeOptions(this, view).addChecked(SharedConfig.suggestStickers == 0, LocaleController.getString(C2888R.string.SuggestStickersAll), new Runnable() { // from class: org.telegram.ui.StickersActivity$$ExternalSyntheticLambda7
                    @Override // java.lang.Runnable
                    public final void run() {
                        StickersActivity.$r8$lambda$IqXvhUBY50Bhj0yCxfWSEqn5CRI(view);
                    }
                }).addChecked(SharedConfig.suggestStickers == 1, LocaleController.getString(C2888R.string.SuggestStickersInstalled), new Runnable() { // from class: org.telegram.ui.StickersActivity$$ExternalSyntheticLambda8
                    @Override // java.lang.Runnable
                    public final void run() {
                        StickersActivity.$r8$lambda$8K5rbn3DXzUBLU4mUe9Ff5sQT70(view);
                    }
                }).addChecked(SharedConfig.suggestStickers == 2, LocaleController.getString(C2888R.string.SuggestStickersNone), new Runnable() { // from class: org.telegram.ui.StickersActivity$$ExternalSyntheticLambda9
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public static /* synthetic */ void $r8$lambda$IqXvhUBY50Bhj0yCxfWSEqn5CRI(View view) {
        ...
        ((TextSettingsCell) view).setValue(LocaleController.getString(C2888R.string.SuggestStickersAll), true);
    }

    public static /* synthetic */ void $r8$lambda$8K5rbn3DXzUBLU4mUe9Ff5sQT70(View view) {
        SharedConfig.setSuggestStickers(1);
        ((TextSettingsCell) view).setValue(LocaleController.getString(C2888R.string.SuggestStickersInstalled), true);
    }

    public static /* synthetic */ void $r8$lambda$ohvYuUetgKUAp9Hnpx7Pdppbn0A(View view) {
        SharedConfig.setSuggestStickers(2);
        ((TextSettingsCell) view).setValue(LocaleController.getString(C2888R.string.SuggestStickersNone), true);
    }
    ...
    public void lambda$new$5() {
        if (this.needReorder) {
            ...
            for (int i2 = 0; i2 < this.sets.size(); i2++) {
                tL_messages_reorderStickerSets.order.add(Long.valueOf(((TLRPC.TL_messages_stickerSet) this.sets.get(i2)).set.f1696id));
            }
            ...
            if (SharedConfig.updateStickersOrderOnSend) {
                SharedConfig.toggleUpdateStickersOrderOnSend();
                BulletinFactory.m1246of(this).createSimpleBulletin(C2888R.raw.filter_reorder, LocaleController.getString(C2888R.string.DynamicPackOrderOff), LocaleController.getString(C2888R.string.DynamicPackOrderOffInfo)).show();
                this.listView.adapter.update(true);
            }
        }
    }
    ...
    public void openStickerSetOptions(View view) {
        ...
        ItemOptions.makeOptions(this, stickerSetCell).add(C2888R.drawable.msg_archive, LocaleController.getString(C2888R.string.StickersHide), new Runnable() { // from class: org.telegram.ui.StickersActivity$$ExternalSyntheticLambda17
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$openStickerSetOptions$8(stickersSet);
            }
        }).addIf(!stickersSet.set.official, C2888R.drawable.msg_link, LocaleController.getString(C2888R.string.StickersCopy), new Runnable() { // from class: org.telegram.ui.StickersActivity$$ExternalSyntheticLambda18
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$openStickerSetOptions$9(stickersSet);
            }
        }).add(C2888R.drawable.msg_reorder, LocaleController.getString(C2888R.string.StickersReorder), new Runnable() { // from class: org.telegram.ui.StickersActivity$$ExternalSyntheticLambda19
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$openStickerSetOptions$10(stickerSetCell);
            }
        }).addIf(!stickersSet.set.official, C2888R.drawable.msg_share, LocaleController.getString(C2888R.string.StickersShare), new Runnable() { // from class: org.telegram.ui.StickersActivity$$ExternalSyntheticLambda20
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$openStickerSetOptions$11(stickersSet);
            }
        }).addIf(!stickersSet.set.official, C2888R.drawable.msg_delete, (CharSequence) LocaleController.getString(C2888R.string.StickersRemove), true, new Runnable() { // from class: org.telegram.ui.StickersActivity$$ExternalSyntheticLambda21
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$openStickerSetOptions$11(TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        try {
            ...
            getParentActivity().startActivityForResult(Intent.createChooser(intent, LocaleController.getString(C2888R.string.StickersShare)), 500);
        } catch (Exception e) {
            FileLog.m1136e(e);
        }
    }
                ...
                if (stickerSetCell.addButtonView == view) {
                    ...
                    while (true) {
                        if (i >= featuredEmojiSets.size()) {
                            ...
                            if (stickersSet.set.f1696id == featuredEmojiSets.get(i).set.f1696id) {
                    ...
                    if (stickerSetCovered != null) {
                        if (!this.loadingFeaturedStickerSets.contains(Long.valueOf(stickerSetCovered.set.f1696id))) {
                            this.loadingFeaturedStickerSets.add(Long.valueOf(stickerSetCovered.set.f1696id));
                        }
                    }
    ...
    public void onFeaturedAddClick(View view) {
        ...
        if (this.loadingFeaturedStickerSets.contains(Long.valueOf(stickerSet.set.f1696id))) {
            return;
        }
        this.loadingFeaturedStickerSets.add(Long.valueOf(stickerSet.set.f1696id));
    ...
    public void lambda$openStickerSetOptions$10(StickerSetCell stickerSetCell) {
        ...
        if (this.selectedSets.contains(Long.valueOf(stickersSet.set.f1696id))) {
            this.selectedSets.remove(Long.valueOf(stickersSet.set.f1696id));
            stickerSetCell.setChecked(false, true);
        } else {
            this.selectedSets.add(Long.valueOf(stickersSet.set.f1696id));
    ...
    private void toggleSelected(TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        ...
        if (this.selectedSets.contains(Long.valueOf(tL_messages_stickerSet.set.f1696id))) {
            this.selectedSets.remove(Long.valueOf(tL_messages_stickerSet.set.f1696id));
        } else {
            this.selectedSets.add(Long.valueOf(tL_messages_stickerSet.set.f1696id));
        }
        this.listView.adapter.update(true);
        checkActionMode();
    }
    ...
    private void checkActionMode() {
        ...
        Bulletin.make(this, new ReorderingBulletinLayout(getContext(), LocaleController.getString(C2888R.string.StickersReorderHint), null), 3250).show();
    }
    ...
    public void processSelectionMenu(final int i) {
        ...
        if (i == 0 || i == 1) {
            ...
            for (int i3 = 0; i3 < size2; i3++) {
                ...
                if (this.selectedSets.contains(Long.valueOf(tL_messages_stickerSet2.set.f1696id))) {
            ...
            if (size3 != 0) {
                if (size3 == 1) {
                    ...
                    while (true) {
                        ...
                        if (this.selectedSets.contains(Long.valueOf(tL_messages_stickerSet3.set.f1696id))) {
                ...
                if (i == 1) {
                    builder.setTitle(LocaleController.formatString(C2888R.string.DeleteStickerSetsAlertTitle, LocaleController.formatPluralString("StickerSets", size3, new Object[0])));
                    builder.setMessage(LocaleController.formatString(C2888R.string.DeleteStickersAlertMessage, Integer.valueOf(size3)));
                    string = LocaleController.getString(C2888R.string.Delete);
                } else {
                    builder.setTitle(LocaleController.formatString(C2888R.string.ArchiveStickerSetsAlertTitle, LocaleController.formatPluralString("StickerSets", size3, new Object[0])));
                    builder.setMessage(LocaleController.formatString(C2888R.string.ArchiveStickersAlertMessage, Integer.valueOf(size3)));
                    string = LocaleController.getString(C2888R.string.Archive);
                }
