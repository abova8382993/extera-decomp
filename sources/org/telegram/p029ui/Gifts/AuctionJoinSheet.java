...
import org.telegram.p029ui.Stars.BagRandomizer;
...
public class AuctionJoinSheet extends BottomSheetWithRecyclerListView implements GiftAuctionController.OnAuctionUpdateListener {
    ...
    public static /* synthetic */ void m14318$r8$lambda$6BJrnfi3ZJ3cJs3Bf_9BJtCOLU(View view) {
    }
    ...
    public static /* synthetic */ void m14324$r8$lambda$_AmuCjii1BRDD1h5poia39kI0(View view) {
    }
    ...
    public static /* synthetic */ void m14327$r8$lambda$lOauVwazGWP_yO4vu_vKA8mJfY(View view) {
    }
    ...
    private AuctionJoinSheet(final Context context, final Theme.ResourcesProvider resourcesProvider, final long j, final TL_stars.StarGift starGift, final Runnable runnable) {
        ...
        long j2 = starGift.f1846id;
        this.giftId = j2;
        this.headerMoveTop = AndroidUtilities.m1124dp(6.0f);
        ...
        giftCell.setImageSize(AndroidUtilities.m1124dp(100.0f));
        ...
        linksTextView.setText(TextUtils.concat(AndroidUtilities.replaceTags(LocaleController.formatPluralString("Gift2AuctionInfo2", starGift.gifts_per_round, str2)), " ", AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(C2888R.string.Gift2AuctionInfoLearnMore), new Runnable() { // from class: org.telegram.ui.Gifts.AuctionJoinSheet$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                AuctionJoinSheet.showMoreInfo(context, resourcesProvider, starGift);
            }
        }), true, AndroidUtilities.m1124dp(2.6666667f), AndroidUtilities.m1124dp(1.0f))));
        ...
        String string2 = LocaleController.getString(C2888R.string.Gift2AuctionTableStarted);
        ...
        tableView.addRow(LocaleController.getString(C2888R.string.Gift2AuctionTableEnded), _UrlKt.FRAGMENT_ENCODE_SET, textViewButtonsArr);
        ...
        TableRow tableRowAddRow = tableView.addRow(LocaleController.getString(C2888R.string.GiftValueAveragePrice), _UrlKt.FRAGMENT_ENCODE_SET, textViewButtonsArr);
        ...
        recyclerListView.setPadding(i9, 0, i9, AndroidUtilities.m1124dp(64.0f));
        ...
        if (auctionSubscribeToGiftAuction != null && (tL_starGiftAuctionState2 = auctionSubscribeToGiftAuction.auctionStateActive) != null) {
            if (tL_starGiftAuctionState2.start_date > ConnectionsManager.getInstance(this.currentAccount).getCurrentTime()) {
                tableView.addRow(LocaleController.getString(C2888R.string.Gift2AuctionTableCurrentRounds), LocaleController.formatNumber(this.auction.auctionStateActive.total_rounds, ','));
            } else {
                tableView.addRow(LocaleController.getString(C2888R.string.Gift2AuctionTableCurrentRound), LocaleController.formatString(C2888R.string.OfS, LocaleController.formatNumber(this.auction.auctionStateActive.current_round, ','), LocaleController.formatNumber(this.auction.auctionStateActive.total_rounds, ',')));
            }
        }
        ...
        if (auction != null && (tL_starGiftAuctionState = auction.auctionStateActive) != null && (arrayList = tL_starGiftAuctionState.rounds) != null) {
            ...
            while (i10 < size) {
                ...
                if (i11 == i2) {
                    int i12 = C2888R.string.Gift2AuctionTableCurrentRoundsOne;
                    Object[] objArr = new Object[i];
                    objArr[0] = Integer.valueOf(i11);
                    string = LocaleController.formatString(i12, objArr);
                } else {
                    int i13 = C2888R.string.Gift2AuctionTableCurrentRoundsTwo;
                ...
                if (starGiftAuctionRound.num == i2) {
                    int i15 = C2888R.string.Gift2AuctionTableCurrentRoundsOneDuration;
        ...
        if (auction2 == null || auction2.previewAttributes == null) {
            ...
            StarGiftSheet.TopView topView = new StarGiftSheet.TopView(context, resourcesProvider, new Runnable() { // from class: org.telegram.ui.Gifts.AuctionJoinSheet$$ExternalSyntheticLambda12
                ...
                float[] f2119r = new float[8];

                @Override // org.telegram.ui.Stars.StarGiftSheet.TopView
                public float getRealHeight() {
                    return AndroidUtilities.m1124dp(288.0f);
                }
                ...
                protected void onSizeChanged(int i16, int i17, int i18, int i19) {
                    ...
                    fArr[0] = fM1124dp;
                    this.path.rewind();
                    this.path.addRoundRect(0.0f, 0.0f, i16, i17, this.f2119r, Path.Direction.CW);
                }
            ...
            if (auction3.auctionStateFinished != null) {
                this.headerStatus.setText(LocaleController.getString(C2888R.string.Gift2AuctionEndedNoDot));
            } else if (auction3.isUpcoming()) {
                this.headerStatus.setText(LocaleController.getString(C2888R.string.Gift2LinkUpcomingAuction));
            } else {
                this.headerStatus.setText(LocaleController.getString(C2888R.string.Gift2LinkGiftAuction));
            }
            this.headerStatus.setBackground(Theme.createRadSelectorDrawable(0, 285212671, 13, 13));
            this.headerStatus.setPadding(AndroidUtilities.m1124dp(12.0f), 0, AndroidUtilities.m1124dp(12.0f), 0);
            ...
            textView4.setText(AndroidUtilities.replaceArrows(LocaleController.getString(C2888R.string.Gift2AuctionLearnMore2), false, AndroidUtilities.m1124dp(2.6666667f), AndroidUtilities.m1124dp(1.0f)));
            textView4.setPadding(AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(8.0f));
            ...
            linksTextView3.setText(AndroidUtilities.replaceArrows(LocaleController.formatSpannable(C2888R.string.Gift2AuctionVariants, spannableStringBuilder2, LocaleController.formatNumber(j3, ',')), true, AndroidUtilities.m1124dp(2.6666667f), AndroidUtilities.m1124dp(1.0f)));
        }
            ...
            if ((j == 0 || j == UserConfig.getInstance(this.currentAccount).getClientUserId()) && (arrayList = (auction = this.auction).previewAttributes) != null) {
                ...
                new SendGiftSheet(context, this.currentAccount, this.auction.gift, j, runnable, false, false) { // from class: org.telegram.ui.Gifts.AuctionJoinSheet.2
                    ...
                    protected BulletinFactory getParentBulletinFactory() {
                        return BulletinFactory.m1245of(this.container, this.resourcesProvider);
                    }
                }.show();
            }
        }
    ...
    public void showAveragePriceHint() {
        ...
        this.showHint.run(this.auctionRowAveragePriceText, LocaleController.formatString(C2888R.string.Gift2AveragePriceHint, Long.valueOf(tL_starGiftAuctionStateFinished.average_price), this.auction.gift.title));
    }
    ...
    */
    private void updateTable(boolean r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Gifts.AuctionJoinSheet.updateTable(boolean):void");
    }
    ...
    public static void showMoreInfo(Context context, Theme.ResourcesProvider resourcesProvider, TL_stars.StarGift starGift) {
        ...
        imageView.setPadding(AndroidUtilities.m1124dp(17.0f), AndroidUtilities.m1124dp(17.0f), AndroidUtilities.m1124dp(17.0f), AndroidUtilities.m1124dp(17.0f));
        imageView.setImageResource(C2888R.drawable.filled_gift_sell_24);
        ...
        textView.setTypeface(AndroidUtilities.bold());
        textView.setGravity(17);
        textView.setText(LocaleController.getString(C2888R.string.GiftAuctionInfoHeader));
        textView.setTextSize(1, 20.0f);
        ...
        TextView textView2 = new TextView(context);
        textView2.setGravity(17);
        textView2.setText(LocaleController.getString(C2888R.string.GiftAuctionInfoText));
        ...
        premiumFeatureCell.imageView.setImageResource(C2888R.drawable.menu_top_bidders_24);
        ...
        premiumFeatureCell2.title.setText(LocaleController.getString(C2888R.string.GiftAuctionInfo2Header));
        ...
        premiumFeatureCell2.imageView.setImageResource(C2888R.drawable.menu_carryover_24);
        ...
        premiumFeatureCell3.title.setText(LocaleController.getString(C2888R.string.GiftAuctionInfo3Header));
        premiumFeatureCell3.description.setText(LocaleController.getString(C2888R.string.GiftAuctionInfo3Text));
        premiumFeatureCell3.nextIcon.setVisibility(8);
        premiumFeatureCell3.imageView.setImageResource(C2888R.drawable.menu_bid_refund_24);
        ...
        buttonWithCounterView.setText(StarGiftSheet.replaceUnderstood(LocaleController.getString(C2888R.string.Understood)), false);
    ...
    public static void show(final Context context, final Theme.ResourcesProvider resourcesProvider, final int i, final long j, long j2, final Runnable runnable) {
        GiftAuctionController.getInstance(i).getOrRequestAuction(j2, new Utilities.Callback2() { // from class: org.telegram.ui.Gifts.AuctionJoinSheet$$ExternalSyntheticLambda0
            @Override // org.telegram.messenger.Utilities.Callback2
            public final void run(Object obj, Object obj2) {
                AuctionJoinSheet.m14326$r8$lambda$hP_lRUuYCaP75u8lhXvsZQZlQw(context, resourcesProvider, i, j, runnable, (GiftAuctionController.Auction) obj, (TLRPC.TL_error) obj2);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$hP_lRU-uYCaP75u8lhXvsZQZlQw, reason: not valid java name */
    public static /* synthetic */ void m14326$r8$lambda$hP_lRUuYCaP75u8lhXvsZQZlQw(Context context, Theme.ResourcesProvider resourcesProvider, int i, long j, Runnable runnable, GiftAuctionController.Auction auction, TLRPC.TL_error tL_error) {
        if (auction != null) {
    ...
    public static void initActionBar(ActionBar actionBar, final Context context, final Theme.ResourcesProvider resourcesProvider, int i, final TL_stars.StarGift starGift) {
        ...
        ActionBarMenuItem actionBarMenuItemAddItem = actionBar.createMenu().addItem(0, C2888R.drawable.ic_ab_other);
        ...
        actionBarMenuItemAddItem.addSubItem(4, C2888R.drawable.msg_info, LocaleController.getString(C2888R.string.MoreInfo));
        actionBarMenuItemAddItem.addSubItem(3, C2888R.drawable.menu_feature_links, LocaleController.getString(C2888R.string.CopyLink));
        actionBarMenuItemAddItem.addSubItem(2, C2888R.drawable.msg_share, LocaleController.getString(C2888R.string.ShareLink));
    }
    ...
    private static void openAuctionTransferAlert(Context context, Theme.ResourcesProvider resourcesProvider, int i, long j, long j2, final Runnable runnable) {
        ...
        textView.setText(LocaleController.getString(C2888R.string.Gift2AuctionsChangeRecipient));
        ...
        textView2.setText(AndroidUtilities.replaceTags(LocaleController.formatString(C2888R.string.Gift2AuctionsChangeRecipient2, DialogObject.getShortName(j), DialogObject.getShortName(j2))));
        linearLayout.addView(textView2, LayoutHelper.createLinear(-1, -2, 48, 24, 4, 24, 4));
        new AlertDialog.Builder(context, resourcesProvider).setView(linearLayout).setPositiveButton(LocaleController.getString(C2888R.string.Continue), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Gifts.AuctionJoinSheet$$ExternalSyntheticLambda17
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i3) {
                runnable.run();
            }
        }).setNegativeButton(LocaleController.getString(C2888R.string.Cancel), null).create().show();
    }
}
