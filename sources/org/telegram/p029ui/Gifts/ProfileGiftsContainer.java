...
import org.telegram.p029ui.CallLogActivity$$ExternalSyntheticLambda7;
...
import org.telegram.p029ui.Stars.ProfileGiftsView;
...
public abstract class ProfileGiftsContainer extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
        ...
        if (this.externalPaddingTop != i) {
            ...
            for (View view : this.viewPager.getViewPages()) {
                if (view instanceof Page) {
                    ...
                    page.listView.setPadding(AndroidUtilities.m1124dp(9.0f), this.externalPaddingTop, AndroidUtilities.m1124dp(9.0f), AndroidUtilities.m1124dp(86.0f));
    ...
    public static class Page extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
        ...
        public Page(final ProfileGiftsContainer profileGiftsContainer, int i, Theme.ResourcesProvider resourcesProvider) {
            ...
            universalRecyclerView.setPadding(AndroidUtilities.m1124dp(9.0f), profileGiftsContainer.externalPaddingTop, AndroidUtilities.m1124dp(9.0f), AndroidUtilities.m1124dp(86.0f));
        ...
        public void setVisibleHeight(int i) {
            ...
            float fClamp01 = Utilities.clamp01(AndroidUtilities.ilerp(i, AndroidUtilities.m1124dp(150.0f), AndroidUtilities.m1124dp(220.0f)));
        ...
        private void updateEmptyView() {
            ...
            if (this.parent.list == this.list) {
                ...
                this.emptyView1Title.setText(LocaleController.getString(C2888R.string.ProfileGiftsNotFoundTitle));
                ...
                this.emptyView1Button.setText(LocaleController.getString(C2888R.string.ProfileGiftsNotFoundButton));
                ...
                this.emptyView1Button.setPadding(AndroidUtilities.m1124dp(10.0f), AndroidUtilities.m1124dp(4.0f), AndroidUtilities.m1124dp(10.0f), AndroidUtilities.m1124dp(4.0f));
            ...
            this.emptyView2Title.setText(LocaleController.getString(C2888R.string.Gift2CollectionEmptyTitle));
            ...
            this.emptyView2Subtitle.setText(LocaleController.getString(C2888R.string.Gift2CollectionEmptyText));
            ...
            buttonWithCounterView.setText(LocaleController.getString(C2888R.string.Gift2CollectionEmptyButton), false);
        ...
        public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
            ...
            if (this.parent.list == this.list) {
                arrayList.add(UItem.asSpace(AndroidUtilities.m1124dp(20.0f)));
                if (this.parent.dialogId == UserConfig.getInstance(this.currentAccount).getClientUserId()) {
                    arrayList.add(TextFactory.asText(Theme.getColor(Theme.key_windowBackgroundWhiteGrayText2, this.resourcesProvider), 17, 14.0f, LocaleController.getString(C2888R.string.ProfileGiftsInfo), true, AndroidUtilities.m1124dp(24.0f)));
                }
                arrayList.add(UItem.asSpace(AndroidUtilities.m1124dp(82.0f)));
            } else if (!arrayList.isEmpty()) {
                arrayList.add(UItem.asSpace(AndroidUtilities.m1124dp(82.0f)));
            }
            if (!arrayList.isEmpty()) {
                arrayList.add(0, UItem.asSpace(AndroidUtilities.m1124dp(this.hasTabs ? 42.0f : 12.0f)));
            }
                ...
                if (this.reordering) {
                    if (!this.isCollection && (savedStarGift.gift instanceof TL_stars.TL_starGiftUnique)) {
                        ...
                        if (this.list.togglePinned(savedStarGift, z2, true)) {
                            BulletinFactory.m1246of(this.parent.fragment).createSimpleBulletin(C2888R.raw.chats_infotip, LocaleController.formatPluralStringComma("GiftsPinLimit", MessagesController.getInstance(this.currentAccount).stargiftsPinnedToTopLimit)).show();
                        }
                        if (z) {
                            return;
                        }
            ...
            if (view instanceof GiftSheet.GiftCell) {
                ...
                if (obj instanceof TL_stars.SavedStarGift) {
                    ...
                    if (profileGiftsContainer.collections.isMine()) {
                        ...
                        itemOptionsMakeSwipeback.add(C2888R.drawable.ic_ab_back, LocaleController.getString(C2888R.string.Back), new Runnable() { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer$Page$$ExternalSyntheticLambda6
                            @Override // java.lang.Runnable
                            public final void run() {
                        ...
                        ScrollView scrollView = new ScrollView(getContext()) { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer.Page.5
                            ...
                            protected void onMeasure(int i3, int i4) {
                                super.onMeasure(i3, View.MeasureSpec.makeMeasureSpec(Math.min(AndroidUtilities.m1124dp(260.0f), View.MeasureSpec.getSize(i4)), View.MeasureSpec.getMode(i4)));
                            }
                        };
                        LinearLayout linearLayout = new LinearLayout(getContext());
                        ...
                        if (this.parent.collections.getCollections().size() + 1 < MessagesController.getInstance(this.currentAccount).config.stargiftsCollectionsLimit.get()) {
                            ...
                            actionBarMenuSubItem.setTextAndIcon(LocaleController.getString(C2888R.string.Gift2NewCollection), C2888R.drawable.menu_folder_add);
                        ...
                        while (i4 < size) {
                            ...
                            actionBarMenuSubItem2.setPadding(AndroidUtilities.m1124dp(f3), i2, AndroidUtilities.m1124dp(f3), i2);
                            ...
                            if (tL_starGiftCollection.icon != null) {
                                ...
                                actionBarMenuSubItem2.setTextAndIcon(tL_starGiftCollection.title, C2888R.drawable.msg_folders);
                            }
                        ...
                        itemOptionsMakeOptions.add(C2888R.drawable.msg_addfolder, LocaleController.getString(C2888R.string.Gift2AddToCollection), new Runnable() { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer$Page$$ExternalSyntheticLambda13
                            @Override // java.lang.Runnable
                            public final void run() {
                    ...
                    if (savedStarGift.gift instanceof TL_stars.TL_starGiftUnique) {
                        if (this.parent.canReorder() && !this.isCollection && (!savedStarGift.unsaved || !savedStarGift.pinned_to_top)) {
                            ...
                            itemOptionsMakeOptions.add(z3 ? C2888R.drawable.msg_unpin : C2888R.drawable.msg_pin, LocaleController.getString(z3 ? C2888R.string.Gift2Unpin : C2888R.string.Gift2Pin), new Runnable() { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer$Page$$ExternalSyntheticLambda14
                                @Override // java.lang.Runnable
                                public final void run() {
                                    this.f$0.lambda$onItemLongPress$13(savedStarGift, giftCell, view);
                                }
                            });
                            itemOptionsMakeOptions.addIf(savedStarGift.pinned_to_top, C2888R.drawable.tabs_reorder, LocaleController.getString(C2888R.string.Gift2Reorder), new Runnable() { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer$Page$$ExternalSyntheticLambda15
                                @Override // java.lang.Runnable
                                public final void run() {
                            ...
                            itemOptionsMakeOptions.add(C2888R.drawable.tabs_reorder, LocaleController.getString(C2888R.string.Gift2Reorder), new Runnable() { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer$Page$$ExternalSyntheticLambda16
                                @Override // java.lang.Runnable
                                public final void run() {
                        ...
                        if (StarGiftSheet.isMineWithActions(this.currentAccount, DialogObject.getPeerDialogId(tL_starGiftUnique.owner_id))) {
                            ...
                            itemOptionsMakeOptions.add(zIsWorn ? C2888R.drawable.menu_takeoff : C2888R.drawable.menu_wear, LocaleController.getString(zIsWorn ? C2888R.string.Gift2Unwear : C2888R.string.Gift2Wear), new Runnable() { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer$Page$$ExternalSyntheticLambda17
                                @Override // java.lang.Runnable
                                public final void run() {
                        ...
                        itemOptionsMakeOptions.addIf(str != null, C2888R.drawable.msg_link2, LocaleController.getString(C2888R.string.CopyLink), new Runnable() { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer$Page$$ExternalSyntheticLambda18
                            @Override // java.lang.Runnable
                            public final void run() {
                                this.f$0.lambda$onItemLongPress$17(str);
                            }
                        });
                        itemOptionsMakeOptions.addIf(str != null, C2888R.drawable.msg_share, LocaleController.getString(C2888R.string.ShareFile), new Runnable() { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer$Page$$ExternalSyntheticLambda19
                            @Override // java.lang.Runnable
                            public final void run() {
                        ...
                        itemOptionsMakeOptions.add(C2888R.drawable.tabs_reorder, LocaleController.getString(C2888R.string.Gift2Reorder), new Runnable() { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer$Page$$ExternalSyntheticLambda7
                            @Override // java.lang.Runnable
                            public final void run() {
                    ...
                    if (StarGiftSheet.isMineWithActions(this.currentAccount, this.parent.dialogId)) {
                        ...
                        itemOptionsMakeOptions.add(z4 ? C2888R.drawable.msg_message : C2888R.drawable.menu_hide_gift, LocaleController.getString(z4 ? C2888R.string.Gift2ShowGift : C2888R.string.Gift2HideGift), new Runnable() { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer$Page$$ExternalSyntheticLambda8
                            @Override // java.lang.Runnable
                            public final void run() {
                    ...
                    if (starGift2 instanceof TL_stars.TL_starGiftUnique) {
                        itemOptionsMakeOptions.addIf(DialogObject.getPeerDialogId(((TL_stars.TL_starGiftUnique) starGift2).owner_id) == UserConfig.getInstance(this.currentAccount).getClientUserId(), C2888R.drawable.menu_transfer, LocaleController.getString(C2888R.string.Gift2TransferOption), new Runnable() { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer$Page$$ExternalSyntheticLambda9
                            @Override // java.lang.Runnable
                            public final void run() {
                    ...
                    if (this.parent.collections.isMine() && this.isCollection) {
                        int i7 = C2888R.drawable.msg_removefolder;
                        String string = LocaleController.getString(C2888R.string.Gift2RemoveFromCollection);
                    ...
                    itemOptionsMakeOptions.animateToSize(iMin - AndroidUtilities.m1124dp(32.0f), (int) (iMin * 0.6f));
        ...
        public /* synthetic */ void lambda$onItemLongPress$7(TL_stars.SavedStarGift savedStarGift, TL_stars.TL_starGiftCollection tL_starGiftCollection) {
            ...
            BulletinFactory.m1246of(this.parent.fragment).createSimpleMultiBulletin(savedStarGift.gift.getDocument(), AndroidUtilities.replaceTags(LocaleController.formatString(C2888R.string.Gift2AddedToCollection, StarGiftSheet.getGiftName(savedStarGift.gift), tL_starGiftCollection.title))).show();
        }
        ...
        public /* synthetic */ void lambda$onItemLongPress$10(boolean z, TL_stars.TL_starGiftCollection tL_starGiftCollection, TL_stars.SavedStarGift savedStarGift, ItemOptions itemOptions, View view) {
            if (!z) {
                ...
                BulletinFactory.m1246of(this.parent.fragment).createSimpleMultiBulletin(savedStarGift.gift.getDocument(), AndroidUtilities.replaceTags(LocaleController.formatString(C2888R.string.Gift2RemovedFromCollection, StarGiftSheet.getGiftName(savedStarGift.gift), tL_starGiftCollection.title))).show();
            }
            itemOptions.dismiss();
            this.parent.updateTabsShown(true);
        }
        ...
        public /* synthetic */ void lambda$onItemLongPress$13(TL_stars.SavedStarGift savedStarGift, GiftSheet.GiftCell giftCell, final View view) {
            ...
            if (!z) {
                BulletinFactory.m1246of(this.parent.fragment).createSimpleBulletin(C2888R.raw.ic_pin, LocaleController.getString(C2888R.string.Gift2PinnedTitle), LocaleController.getString(C2888R.string.Gift2PinnedSubtitle)).show();
            } else {
                BulletinFactory.m1246of(this.parent.fragment).createSimpleBulletin(C2888R.raw.ic_unpin, LocaleController.getString(C2888R.string.Gift2Unpinned)).show();
            }
        ...
        public /* synthetic */ BulletinFactory lambda$onItemLongPress$12(View view, boolean z) {
            ...
            this.listView.scrollToPosition(0);
            return BulletinFactory.m1246of(this.parent.fragment);
        }
        ...
        public /* synthetic */ void lambda$onItemLongPress$16(TL_stars.SavedStarGift savedStarGift) {
            new StarGiftSheet(getContext(), this.currentAccount, this.parent.dialogId, this.resourcesProvider) { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer.Page.7
                ...
                public BulletinFactory getBulletinFactory() {
                    return BulletinFactory.m1246of(Page.this.parent.fragment);
                }
        ...
        public /* synthetic */ void lambda$onItemLongPress$17(String str) {
            ...
            BulletinFactory.m1246of(this.parent.fragment).createCopyLinkBulletin(false).show();
        }
        ...
        public /* synthetic */ void lambda$onItemLongPress$22(TL_stars.SavedStarGift savedStarGift, ItemOptions itemOptions) {
            ...
            if (tL_starGiftCollectionFindById != null) {
                BulletinFactory.m1246of(this.parent.fragment).createSimpleMultiBulletin(savedStarGift.gift.getDocument(), AndroidUtilities.replaceTags(LocaleController.formatString(C2888R.string.Gift2RemovedFromCollection, StarGiftSheet.getGiftName(savedStarGift.gift), tL_starGiftCollectionFindById.title))).show();
            }
        }
    ...
    */
    public ProfileGiftsContainer(final org.telegram.p029ui.ActionBar.BaseFragment r26, final android.content.Context r27, final int r28, long r29, final org.telegram.ui.ActionBar.Theme.ResourcesProvider r31) {
        /*
            Method dump skipped, instruction units count: 797
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Gifts.ProfileGiftsContainer.<init>(org.telegram.ui.ActionBar.BaseFragment, android.content.Context, int, long, org.telegram.ui.ActionBar.Theme$ResourcesProvider):void");
    }
    ...
    public /* synthetic */ Boolean lambda$new$7(final int i, final BaseFragment baseFragment, final Context context, final Theme.ResourcesProvider resourcesProvider, Integer num, View view) {
        ...
        ItemOptions itemOptionsAddIf = ItemOptions.makeOptions(baseFragment, view).setScrimViewBackground(new Drawable() { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer.3
            ...
            private final Drawable f2122bg;
            ...
            {
                this.f2122bg = Theme.createRoundRectDrawable(AndroidUtilities.m1124dp(16.0f), AndroidUtilities.m1124dp(16.0f), ProfileGiftsContainer.this.backgroundColor);
            }
            ...
            public void draw(Canvas canvas) {
                ...
                this.f2122bg.setBounds(this.bgBounds);
                this.f2122bg.draw(canvas);
            }

            @Override // android.graphics.drawable.Drawable
            public void setAlpha(int i4) {
                this.f2122bg.setAlpha(i4);
            }
        }).addIf(zIsMine, C2888R.drawable.menu_gift_add, LocaleController.getString(C2888R.string.Gift2CollectionsAdd), new Runnable() { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer$$ExternalSyntheticLambda12
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.addGifts();
            }
        }).addIf(!TextUtils.isEmpty(publicUsername), C2888R.drawable.msg_share, LocaleController.getString(C2888R.string.Gift2CollectionsShare), new Runnable() { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer$$ExternalSyntheticLambda13
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$new$2(i, publicUsername, tL_starGiftCollection, context, resourcesProvider, baseFragment);
            }
        }).addIf(zIsMine, C2888R.drawable.msg_edit, LocaleController.getString(C2888R.string.Gift2CollectionsRename), new Runnable() { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer$$ExternalSyntheticLambda14
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$new$4(tL_starGiftCollection);
            }
        }).addIf(zIsMine, C2888R.drawable.tabs_reorder, LocaleController.getString(C2888R.string.Gift2CollectionsReorder), new Runnable() { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer$$ExternalSyntheticLambda15
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$new$5();
            }
        }).addIf(zIsMine, C2888R.drawable.msg_delete, (CharSequence) LocaleController.getString(C2888R.string.Gift2CollectionsDelete), true, new Runnable() { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer$$ExternalSyntheticLambda16
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$new$2(int i, String str, TL_stars.TL_starGiftCollection tL_starGiftCollection, Context context, Theme.ResourcesProvider resourcesProvider, final BaseFragment baseFragment) {
        ...
        new ShareAlert(context, null, str2, false, str2, false, resourcesProvider) { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer.4
            ...
            protected void onSend(LongSparseArray longSparseArray, int i2, TLRPC.TL_forumTopic tL_forumTopic, boolean z) {
                BulletinFactory bulletinFactoryM1246of;
                if (z && (bulletinFactoryM1246of = BulletinFactory.m1246of(baseFragment)) != null) {
                    if (longSparseArray.size() == 1) {
                        long jKeyAt = longSparseArray.keyAt(0);
                        if (jKeyAt == UserConfig.getInstance(this.currentAccount).clientUserId) {
                            bulletinFactoryM1246of.createSimpleBulletin(C2888R.raw.saved_messages, AndroidUtilities.replaceTags(LocaleController.formatString(C2888R.string.GiftCollectionSharedToSavedMessages, new Object[0])), 5000).hideAfterBottomSheet(false).show();
                        } else if (jKeyAt < 0) {
                            bulletinFactoryM1246of.createSimpleBulletin(C2888R.raw.forward, AndroidUtilities.replaceTags(LocaleController.formatString(C2888R.string.GiftCollectionSharedTo, tL_forumTopic != null ? tL_forumTopic.title : MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(-jKeyAt)).title)), 5000).hideAfterBottomSheet(false).show();
                        } else {
                            bulletinFactoryM1246of.createSimpleBulletin(C2888R.raw.forward, AndroidUtilities.replaceTags(LocaleController.formatString(C2888R.string.GiftCollectionSharedTo, MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(jKeyAt)).first_name)), 5000).hideAfterBottomSheet(false).show();
                        }
                    } else {
                        bulletinFactoryM1246of.createSimpleBulletin(C2888R.raw.forward, AndroidUtilities.replaceTags(LocaleController.formatPluralString("GiftCollectionSharedToManyChats", longSparseArray.size(), Integer.valueOf(longSparseArray.size())))).hideAfterBottomSheet(false).show();
                    }
                    try {
    ...
    public /* synthetic */ void lambda$new$10(final BaseFragment baseFragment, int i, View view) {
        ...
        BulletinFactory.m1246of(baseFragment).createSimpleBulletinDetail(zIsChecked ? C2888R.raw.silent_unmute : C2888R.raw.silent_mute, LocaleController.getString(zIsChecked ? C2888R.string.Gift2ChannelNotifyChecked : C2888R.string.Gift2ChannelNotifyNotChecked)).show();
    ...
    public void updateTabsY() {
        ...
        float fMin = Math.min(this.externalPaddingTop, getTabsHeight() - AndroidUtilities.m1124dp(42.0f));
        float fClamp01 = Utilities.clamp01(AndroidUtilities.ilerp(fMin - this.externalPaddingTop, -AndroidUtilities.m1124dp(42.0f), 0.0f));
    ...
    public void updateButton() {
        ...
        if (viewPagerFixed.getCurrentPosition() == this.viewPager.getNextPosition()) {
            currentPositionAlpha = (AndroidUtilities.m1124dp(68.0f) + 2) * (shouldHideButton(this.viewPager.getCurrentPosition()) ? 1.0f : 0.0f);
        } else {
            currentPositionAlpha = (((shouldHideButton(this.viewPager.getCurrentPosition()) ? 1.0f : 0.0f) * this.viewPager.getCurrentPositionAlpha()) + ((shouldHideButton(this.viewPager.getNextPosition()) ? 1.0f : 0.0f) * this.viewPager.getNextPositionAlpha())) * (AndroidUtilities.m1124dp(68.0f) + 2);
        }
        float fM1124dp = currentPositionAlpha + ((((-this.buttonContainer.getTop()) + this.visibleHeight) - AndroidUtilities.m1124dp(this.buttonContainerHeightDp)) - 1);
        this.animatorBottomButtonVisibility.setValue(this.visibleHeight > AndroidUtilities.m1124dp(184.0f), true);
        float floatValue = this.animatorBottomButtonVisibility.getFloatValue();
        float fLerp = AndroidUtilities.lerp(AndroidUtilities.m1124dp(60.0f) + fM1124dp, fM1124dp, floatValue);
        this.bulletinContainer.setTranslationY(fLerp - AndroidUtilities.m1124dp(200.0f));
    ...
    public int getBottomOffset() {
        float translationY = this.buttonContainer.getTranslationY() - ((((-this.buttonContainer.getTop()) + Math.max(AndroidUtilities.m1124dp(240.0f), this.visibleHeight)) - AndroidUtilities.m1124dp(this.buttonContainerHeightDp)) - 1);
        if (this.visibleHeight < AndroidUtilities.m1124dp(240.0f)) {
            translationY += Math.min(AndroidUtilities.m1124dp(240.0f) - this.visibleHeight, AndroidUtilities.m1124dp(this.buttonContainerHeightDp));
        }
        return (int) (AndroidUtilities.m1124dp(this.buttonContainerHeightDp) - translationY);
    }
    ...
    public CharSequence getLastEmojis(Paint.FontMetricsInt fontMetricsInt) {
        ...
        for (int i = 0; arrayList.size() < 3 && i < this.list.gifts.size(); i++) {
            ...
            if (document != null && !hashSet.contains(Long.valueOf(document.f1668id))) {
    ...
    public long getLastEmojisHash() {
        ...
        if (giftsList != null && !giftsList.gifts.isEmpty()) {
            ...
            for (int i2 = 0; i < 3 && i2 < this.list.gifts.size(); i2++) {
                ...
                if (document != null) {
                    hashSet.add(Long.valueOf(document.f1668id));
                    jHash = Objects.hash(Long.valueOf(jHash), Long.valueOf(document.f1668id));
                    i++;
                }
            }
        }
    ...
    public void updateColors() {
        ...
        this.button.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1124dp(19.0f), processColor(Theme.getColor(Theme.key_featuredStickers_addButton, this.resourcesProvider))));
    ...
    public static class UnpinSheet extends BottomSheet {
        ...
        public UnpinSheet(Context context, long j, final TL_stars.SavedStarGift savedStarGift, Theme.ResourcesProvider resourcesProvider, final Utilities.Callback0Return callback0Return) {
            ...
            textViewMakeTextView.setText(LocaleController.getString(C2888R.string.Gift2UnpinAlertTitle));
            ...
            textViewMakeTextView2.setText(LocaleController.getString(C2888R.string.Gift2UnpinAlertSubtitle));
            ...
            buttonWithCounterView.setText(LocaleController.getString(C2888R.string.Gift2UnpinAlertButton), false);
        ...
        public /* synthetic */ void lambda$new$0(StarsController.GiftsList giftsList, ArrayList arrayList, UniversalAdapter universalAdapter) {
            ...
            while (i < size) {
                ...
                if (savedStarGift.pinned_to_top) {
                    arrayList.add(PeerColorActivity.GiftCell.Factory.asGiftCell(savedStarGift).setChecked(this.selectedGift == savedStarGift.gift.f1846id).setSpanCount(1));
                }
            }
        }
        ...
        public /* synthetic */ void lambda$new$1(ButtonWithCounterView buttonWithCounterView, UItem uItem, View view, Integer num, Float f, Float f2) {
            long j = ((TL_stars.SavedStarGift) uItem.object).gift.f1846id;
        ...
        public /* synthetic */ void lambda$new$2(StarsController.GiftsList giftsList, TL_stars.SavedStarGift savedStarGift, Utilities.Callback0Return callback0Return, View view) {
            ...
            while (true) {
                if (i >= pinned.size()) {
                    ...
                    if (((TL_stars.SavedStarGift) pinned.get(i)).gift.f1846id == this.selectedGift) {
            ...
            lambda$new$0();
            ((BulletinFactory) callback0Return.run()).createSimpleBulletin(C2888R.raw.ic_pin, LocaleController.formatString(C2888R.string.Gift2ReplacedPinTitle, StarGiftSheet.getGiftName(savedStarGift.gift)), LocaleController.formatString(C2888R.string.Gift2ReplacedPinSubtitle, StarGiftSheet.getGiftName(savedStarGift2.gift))).show();
        }
    }
    ...
    public void openEnterNameAlert(String str, final Utilities.Callback callback) {
        ...
        if (str != null) {
            builder.setTitle(LocaleController.getString(C2888R.string.Gift2EditCollectionNameTitle));
        } else {
            builder.setTitle(LocaleController.getString(C2888R.string.Gift2NewCollectionTitle));
            builder.setMessage(LocaleController.getString(C2888R.string.Gift2NewCollectionText));
        }
        ...
        editTextCaption.setHintText(LocaleController.getString(C2888R.string.Gift2NewCollectionHint));
        ...
        builder.setPositiveButton(LocaleController.getString(str != null ? C2888R.string.Edit : C2888R.string.Create), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer$$ExternalSyntheticLambda19
        ...
        builder.setNegativeButton(LocaleController.getString(C2888R.string.Cancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer$$ExternalSyntheticLambda20
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
                alertDialog.dismiss();
            }
        ...
        alertDialogArr[0].setOnShowListener(new DialogInterface.OnShowListener() { // from class: org.telegram.ui.Gifts.ProfileGiftsContainer$$ExternalSyntheticLambda22
            ...
            public final void onShow(DialogInterface dialogInterface) {
                ProfileGiftsContainer.m14356$r8$lambda$Y_hy7wxb_R6l3jqf9bz9a6WDA(editTextCaption, dialogInterface);
            }
        });
    ...
    public static /* synthetic */ void m14356$r8$lambda$Y_hy7wxb_R6l3jqf9bz9a6WDA(EditTextCaption editTextCaption, DialogInterface dialogInterface) {
    ...
    public /* synthetic */ void lambda$addGifts$21(int i, Page page, ArrayList arrayList) {
        ...
        if (tL_starGiftCollectionFindById != null) {
            if (arrayList.size() > 1) {
                Bulletin bulletinCreateSimpleMultiBulletin = BulletinFactory.m1246of(this.fragment).createSimpleMultiBulletin(((TL_stars.SavedStarGift) arrayList.get(0)).gift.getDocument(), AndroidUtilities.replaceTags(LocaleController.formatPluralStringComma("Gift2AddedToCollectionMany", arrayList.size(), tL_starGiftCollectionFindById.title)));
            ...
            if (arrayList.size() == 1) {
                ...
                Bulletin bulletinCreateSimpleMultiBulletin2 = BulletinFactory.m1246of(this.fragment).createSimpleMultiBulletin(savedStarGift.gift.getDocument(), AndroidUtilities.replaceTags(LocaleController.formatString(C2888R.string.Gift2AddedToCollection, StarGiftSheet.getGiftName(savedStarGift.gift), tL_starGiftCollectionFindById.title)));
    ...
    public static class SelectGiftsBottomSheet extends BottomSheetWithRecyclerListView implements NotificationCenter.NotificationCenterDelegate {
        ...
        public SelectGiftsBottomSheet(BaseFragment baseFragment, long j, int i, final Utilities.Callback callback) {
            ...
            this.actionBar.setActionBarMenuOnItemClick(new C56971(this.actionBar.createMenu().addItem(1, C2888R.drawable.ic_ab_other), j));
            ...
            buttonWithCounterView.setText(LocaleController.getString(C2888R.string.Gift2CollectionAddGiftsButton), false);
            buttonWithCounterView.setEnabled(false);
            ...
            this.recyclerListView.setPadding(this.backgroundPaddingLeft + AndroidUtilities.m1124dp(9.0f), 0, this.backgroundPaddingLeft + AndroidUtilities.m1124dp(9.0f), 0);
        ...
        class C56971 extends ActionBar.ActionBarMenuOnItemClick {
            final /* synthetic */ long val$dialogId;
            final /* synthetic */ ActionBarMenuItem val$other;

            C56971(ActionBarMenuItem actionBarMenuItem, long j) {
            ...
            public /* synthetic */ void lambda$onItemClick$0(ActionBarMenuSubItem actionBarMenuSubItem, ActionBarMenuSubItem actionBarMenuSubItem2, ActionBarMenuSubItem actionBarMenuSubItem3, ActionBarMenuSubItem actionBarMenuSubItem4, ActionBarMenuSubItem actionBarMenuSubItem5, boolean z, ActionBarMenuSubItem actionBarMenuSubItem6, ActionBarMenuSubItem actionBarMenuSubItem7) {
                if (actionBarMenuSubItem != null) {
                    actionBarMenuSubItem.setTextAndIcon(LocaleController.getString(SelectGiftsBottomSheet.this.list.sort_by_date ? C2888R.string.Gift2FilterSortByValue : C2888R.string.Gift2FilterSortByDate), SelectGiftsBottomSheet.this.list.sort_by_date ? C2888R.drawable.menu_sort_value : C2888R.drawable.menu_sort_date);
                }
        ...
        protected CharSequence getTitle() {
            return LocaleController.getString(C2888R.string.Gift2CollectionAddGiftsTitle);
        }
        ...
        public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
            ...
            arrayList.add(UItem.asSpace(AndroidUtilities.m1124dp(68.0f)));
        }
    }
