...
public class ChannelBoostLayout extends FrameLayout {
        ...
        this.adapter = new AdapterWithDiffUtils() { // from class: org.telegram.ui.ChannelBoostLayout.1
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
                ...
                switch (i) {
                    ...
                    case 3:
                        ...
                        return new RecyclerListView.Holder(overviewCell);
                    case 4:
                        LimitPreviewView limitPreviewView = new LimitPreviewView(ChannelBoostLayout.this.getContext(), C2888R.drawable.filled_limit_boost, 0, 0, ChannelBoostLayout.this.resourcesProvider);
                        limitPreviewView.isStatistic = true;
                        limitPreviewView.setTag(-33024);
                        limitPreviewView.setPadding(0, AndroidUtilities.m1124dp(20.0f), 0, AndroidUtilities.m1124dp(20.0f));
                    ...
                    case 8:
                        ...
                        textView.setText(LocaleController.getString(ChannelBoostLayout.this.isChannel() ? C2888R.string.NoBoostersHint : C2888R.string.NoBoostersGroupHint));
                    ...
                    case 10:
                        ...
                        textCell.setTextAndIcon((CharSequence) LocaleController.formatString("BoostingGetBoostsViaGifts", C2888R.string.BoostingGetBoostsViaGifts, new Object[0]), C2888R.drawable.msg_gift_premium, false);
            ...
            */
            public void onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder r13, int r14) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.ChannelBoostLayout.C35121.onBindViewHolder(androidx.recyclerview.widget.RecyclerView$ViewHolder, int):void");
            }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public /* synthetic */ void lambda$new$0(android.content.Context r18, long r19, org.telegram.ui.ActionBar.Theme.ResourcesProvider r21, org.telegram.p029ui.ActionBar.BaseFragment r22, android.view.View r23, int r24) {
        /*
            Method dump skipped, instruction units count: 288
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.ChannelBoostLayout.lambda$new$0(android.content.Context, long, org.telegram.ui.ActionBar.Theme$ResourcesProvider, org.telegram.ui.ActionBar.BaseFragment, android.view.View, int):void");
    }
    ...
    public void updateRows(boolean z) {
        ...
        if (this.boostsStatus != null) {
            ...
            this.items.add(new ItemInternal(1, LocaleController.getString(C2888R.string.StatisticOverview)));
