...
public class SponsoredMessageInfoView extends FrameLayout {
    public SponsoredMessageInfoView(final Context context, final Runnable runnable, Theme.ResourcesProvider resourcesProvider) {
        ...
        textView.setText(LocaleController.getString(C2888R.string.SponsoredMessageInfo));
        ...
        linksTextView3.setLineSpacing(AndroidUtilities.m1124dp(2.0f), 1.0f);
        ...
        TextView textView2 = new TextView(context) { // from class: org.telegram.ui.SponsoredMessageInfoView.1
            ...
            protected void onDraw(Canvas canvas) {
                ...
                rectF.set(AndroidUtilities.m1124dp(1.0f), AndroidUtilities.m1124dp(1.0f), getMeasuredWidth() - AndroidUtilities.m1124dp(1.0f), getMeasuredHeight() - AndroidUtilities.m1124dp(1.0f));
                canvas.drawRoundRect(rectF, AndroidUtilities.m1124dp(4.0f), AndroidUtilities.m1124dp(4.0f), paint);
            }
        };
        textView2.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.SponsoredMessageInfoView.2
            ...
            public void onClick(View view) {
                ...
                Browser.openUrl(context, LocaleController.getString(C2888R.string.SponsoredMessageAlertLearnMoreUrl));
            }
        });
        textView2.setPadding(AndroidUtilities.m1124dp(12.0f), 0, AndroidUtilities.m1124dp(12.0f), 0);
        textView2.setText(LocaleController.getString(C2888R.string.SponsoredMessageAlertLearnMoreUrl));
        ...
        linksTextView4.setLineSpacing(AndroidUtilities.m1124dp(2.0f), 1.0f);
        linksTextView4.setTextColor(Theme.getColor(i, resourcesProvider));
        linksTextView4.setTextSize(1, 14.0f);
        textView.setPadding(AndroidUtilities.m1124dp(22.0f), 0, AndroidUtilities.m1124dp(22.0f), 0);
        linearLayout.addView(textView);
        linksTextView.setPadding(AndroidUtilities.m1124dp(22.0f), 0, AndroidUtilities.m1124dp(22.0f), 0);
        linearLayout.addView(linksTextView, LayoutHelper.createLinear(-1, -2, 0, 0, 18, 0, 0));
        linksTextView2.setPadding(AndroidUtilities.m1124dp(22.0f), 0, AndroidUtilities.m1124dp(22.0f), 0);
        linearLayout.addView(linksTextView2, LayoutHelper.createLinear(-1, -2, 0, 0, 24, 0, 0));
        linksTextView3.setPadding(AndroidUtilities.m1124dp(22.0f), 0, AndroidUtilities.m1124dp(22.0f), 0);
        ...
        linksTextView4.setPadding(AndroidUtilities.m1124dp(22.0f), 0, AndroidUtilities.m1124dp(22.0f), 0);
