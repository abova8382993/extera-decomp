    ...
    */
    private void setDefaultGroupName() {
        ...
        L31:
            ...
            int r9 = org.telegram.messenger.C2888R.string.GroupCreateMembersFive     // Catch: java.lang.Exception -> L58
        ...
        L5a:
            ...
            int r4 = org.telegram.messenger.C2888R.string.GroupCreateMembersFour     // Catch: java.lang.Exception -> L58
            java.lang.String r0 = r0.first_name     // Catch: java.lang.Exception -> L58
        ...
        L7b:
            ...
            int r4 = org.telegram.messenger.C2888R.string.GroupCreateMembersThree     // Catch: java.lang.Exception -> L58
            java.lang.String r0 = r0.first_name     // Catch: java.lang.Exception -> L58
        ...
        L96:
            ...
            int r4 = org.telegram.messenger.C2888R.string.GroupCreateMembersTwo     // Catch: java.lang.Exception -> L58
            java.lang.String r0 = r0.first_name     // Catch: java.lang.Exception -> L58
        ...
        Lc6:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.GroupCreateFinalActivity.setDefaultGroupName():void");
    }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2888R.string.NewGroup));
        ...
        SizeNotifierFrameLayout sizeNotifierFrameLayout = new SizeNotifierFrameLayout(context) { // from class: org.telegram.ui.GroupCreateFinalActivity.2
            ...
            protected void onMeasure(int i2, int i3) {
                ...
                if (measureKeyboardHeight() > AndroidUtilities.m1124dp(20.0f) && !GroupCreateFinalActivity.this.editText.isPopupShowing()) {
            ...
            */
            protected void onLayout(boolean r11, int r12, int r13, int r14, int r15) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.GroupCreateFinalActivity.C58532.onLayout(boolean, int, int, int, int):void");
            }
        ...
        this.shadowDrawable = context.getResources().getDrawable(C2888R.drawable.greydivider_top).mutate();
        ...
        frameLayout.setBackground(Theme.createRoundRectDrawableShadowed(AndroidUtilities.m1124dp(16.0f), getThemedColor(Theme.key_windowBackgroundWhite)));
        ...
        this.avatarImage.setContentDescription(LocaleController.getString(C2888R.string.ChoosePhoto));
        ...
        this.cameraDrawable = new RLottieDrawable(C2888R.raw.camera, _UrlKt.FRAGMENT_ENCODE_SET + C2888R.raw.camera, AndroidUtilities.m1124dp(52.0f), AndroidUtilities.m1124dp(52.0f), false, null);
        ...
        this.avatarEditor.setPadding(AndroidUtilities.m1124dp(0.0f), 0, 0, AndroidUtilities.m1124dp(1.0f));
        ...
        editTextEmoji2.setHint(LocaleController.getString((i2 == 0 || i2 == 4 || i2 == 5) ? C2888R.string.EnterGroupNamePlaceholder : C2888R.string.EnterListName));
        ...
        this.floatingButton.setContentDescription(LocaleController.getString(C2888R.string.Done));
        this.floatingButton.imageView.setImageResource(C2888R.drawable.checkbig);
    ...
    public class GroupCreateAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void notifyDataSetChanged() {
            ...
            if (GroupCreateFinalActivity.this.chatType == 5) {
                ...
                this.items.add(new InnerItem(5, LocaleController.getString(C2888R.string.ForumToggleDescription)));
            } else {
                this.items.add(new InnerItem(4));
                this.items.add(new InnerItem(5, LocaleController.getString(C2888R.string.GroupCreateAutodeleteDescription)));
            }
            ...
            switch (viewHolder.getItemViewType()) {
                case 1:
                    ...
                    if (GroupCreateFinalActivity.this.currentGroupCreateAddress != null && i == 1) {
                        headerCell.setText(LocaleController.getString(C2888R.string.AttachLocation));
                    } else {
                ...
                case 4:
                    ...
                    if (GroupCreateFinalActivity.this.ttlPeriod == 0) {
                        tTLString = LocaleController.getString(C2888R.string.PasswordOff);
                    } else {
                        tTLString = LocaleController.formatTTLString(GroupCreateFinalActivity.this.ttlPeriod);
                    }
                    textCell.setTextAndValueAndIcon(LocaleController.getString(C2888R.string.AutoDeleteMessages), tTLString, ((BaseFragment) GroupCreateFinalActivity.this).fragmentBeginToShow, C2888R.drawable.msg_autodelete, false);
                    break;
                case 5:
                ...
                case 6:
                    ...
                    textCell2.setTextAndCheckAndIcon(LocaleController.getString(C2888R.string.ChannelTopics), true, C2888R.drawable.msg_topics, false);
