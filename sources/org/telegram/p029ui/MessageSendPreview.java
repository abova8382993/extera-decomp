...
public class MessageSendPreview extends Dialog implements NotificationCenter.NotificationCenterDelegate {
    ...
    public MessageSendPreview(final Context context, final Theme.ResourcesProvider resourcesProvider) {
        ...
        frameLayout.getViewTreeObserver().addOnGlobalFocusChangeListener(new ViewTreeObserverOnGlobalFocusChangeListenerC61142());
        C61153 c61153 = new C61153(context, resourcesProvider);
        this.containerView = c61153;
        c61153.setClipToPadding(false);
        frameLayout.addView(c61153, LayoutHelper.createFrame(-1, -1, 119));
        ...
        RecyclerListView recyclerListView = new RecyclerListView(context, resourcesProvider) { // from class: org.telegram.ui.MessageSendPreview.5
            ...
            protected void onMeasure(int i2, int i3) {
                super.onMeasure(i2, View.MeasureSpec.makeMeasureSpec(Math.max(0, ((AndroidUtilities.displaySize.y - (AndroidUtilities.m1124dp(MessageSendPreview.this.messageObjects.isEmpty() ? -6.0f : 48.0f) + (MessageSendPreview.this.optionsView == null ? 0 : MessageSendPreview.this.optionsView.getMeasuredHeight()))) - AndroidUtilities.m1124dp(8.0f)) - MessageSendPreview.this.insets.top), Integer.MIN_VALUE));
                int iMax = Math.max(MessageSendPreview.this.sendButtonWidth, -((MessageSendPreview.this.sendButtonInitialPosition[0] + AndroidUtilities.m1124dp(7.0f)) - getMeasuredWidth()));
                float fMax = Math.max(1, getMeasuredWidth() - iMax) / Math.max(1, ((getMeasuredWidth() - iMax) - AndroidUtilities.m1124dp(8.0f)) + Math.max(0, MessageSendPreview.this.messageObjectsWidth - ((getMeasuredWidth() - iMax) - AndroidUtilities.m1124dp((MessageSendPreview.this.groupedMessagesMap.isEmpty() ? 0 : 40) + 8))));
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                rectF.set(0.0f, getScrollY(), getWidth(), getScrollY() + AndroidUtilities.m1124dp(14.0f));
                this.clip.draw(canvas, rectF, true, f);
                rectF.set(0.0f, (getScrollY() + getHeight()) - AndroidUtilities.m1124dp(14.0f), getWidth(), getScrollY() + getHeight());
                    ...
                    if (i3 != 2 || MessageSendPreview.this.chatListView.isFastScrollAnimationRunning()) {
                            ...
                            if (childAt2 instanceof ChatMessageCell) {
                                ...
                                if (childAt2.getY() <= MessageSendPreview.this.chatListView.getHeight() && childAt2.getY() + childAt2.getHeight() >= 0.0f && (currentMessagesGroup = chatMessageCell.getCurrentMessagesGroup()) != null && ((i3 != 0 || currentMessagesGroup.messages.size() != 1) && ((i3 != 1 || currentMessagesGroup.transitionParams.drawBackgroundForDeletedItems) && ((i3 != 0 || !chatMessageCell.getMessageObject().deleted) && ((i3 != 1 || chatMessageCell.getMessageObject().deleted) && ((i3 != 2 || chatMessageCell.willRemovedAfterAnimation()) && (i3 == 2 || !chatMessageCell.willRemovedAfterAnimation()))))))) {
                                    ...
                                    if ((chatMessageCell.getCurrentPosition().flags & 4) == 0) {
                                        y -= AndroidUtilities.m1124dp(10.0f);
                                    }
                                    if ((chatMessageCell.getCurrentPosition().flags & 8) == 0) {
                                        y2 += AndroidUtilities.m1124dp(10.0f);
                                    }
                        ...
                        while (i9 < this.drawingGroups.size()) {
                            ...
                            if (groupedMessages2 != null) {
                                ...
                                if (f3 < (-AndroidUtilities.m1124dp(20.0f))) {
                                    f3 = -AndroidUtilities.m1124dp(20.0f);
                                }
                                if (measuredHeight > MessageSendPreview.this.chatListView.getMeasuredHeight() + AndroidUtilities.m1124dp(20.0f)) {
                                    measuredHeight = MessageSendPreview.this.chatListView.getMeasuredHeight() + AndroidUtilities.m1124dp(20.0f);
                                }
                ...
                for (int i3 = 0; i3 < 3; i3++) {
                    ...
                    if (i3 != 2 || MessageSendPreview.this.chatListView.isFastScrollAnimationRunning()) {
                        ...
                        for (int i9 = 0; i9 < this.drawingGroups.size(); i9++) {
                            ...
                            float measuredHeight = transitionParams3.bottom + transitionParams3.offsetBottom;
                            if (f2 < (-AndroidUtilities.m1124dp(20.0f))) {
                                f2 = -AndroidUtilities.m1124dp(20.0f);
                            }
                            float f4 = f2;
                            if (measuredHeight > MessageSendPreview.this.chatListView.getMeasuredHeight() + AndroidUtilities.m1124dp(20.0f)) {
                                measuredHeight = MessageSendPreview.this.chatListView.getMeasuredHeight() + AndroidUtilities.m1124dp(20.0f);
        ...
        recyclerListView.setItemAnimator(new C61197(null, recyclerListView, resourcesProvider));
                ...
                while (true) {
                    if (i2 < size) {
                        ...
                        if (b == b2 && ((groupedMessagePosition.minX != currentPosition.minX || groupedMessagePosition.maxX != currentPosition.maxX || b != b2 || groupedMessagePosition.maxY != currentPosition.maxY) && b == b2)) {
                            iRound -= ((int) Math.ceil(fMax * groupedMessagePosition.f1597ph)) - AndroidUtilities.m1124dp(4.0f);
                            break;
                        }
                        i2++;
                    } else {
        ...
        c61153.addView(recyclerListView, LayoutHelper.createFrame(-1, -2.0f));
        ...
        this.effectOverlay = new EmojiAnimationsOverlay(frameLayout2, i) { // from class: org.telegram.ui.MessageSendPreview.13
            ...
            @Override // org.telegram.p029ui.EmojiAnimationsOverlay
    ...
    class ViewTreeObserverOnGlobalFocusChangeListenerC61142 implements ViewTreeObserver.OnGlobalFocusChangeListener {
        ViewTreeObserverOnGlobalFocusChangeListenerC61142() {
        }
        ...
        public /* synthetic */ void lambda$onGlobalFocusChanged$0(View view) {
            ...
            if (MessageSendPreview.this.anchorSendButton != null) {
                ...
                iArr[0] = iArr[0] + ((MessageSendPreview.this.anchorSendButton.getWidth() - MessageSendPreview.this.anchorSendButton.width(MessageSendPreview.this.anchorSendButton.getHeight())) - AndroidUtilities.m1124dp(6.0f));
            }
        }
    }

    /* JADX INFO: renamed from: org.telegram.ui.MessageSendPreview$3 */
    class C61153 extends SizeNotifierFrameLayout {
        ...
        C61153(Context context, Theme.ResourcesProvider resourcesProvider) {
            super(context);
        ...
        */
        protected void dispatchDraw(android.graphics.Canvas r28) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.MessageSendPreview.C61153.dispatchDraw(android.graphics.Canvas):void");
        }
    ...
    class C61197 extends ChatListItemAnimator {
        ...
        C61197(ChatActivity chatActivity, RecyclerListView recyclerListView, Theme.ResourcesProvider resourcesProvider) {
        ...
        public void onAnimationStart() {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1133d("chatItemAnimator disable notifications");
            }
        }
        ...
        public /* synthetic */ void lambda$onAllAnimationsDone$0() {
            this.finishRunnable = null;
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1133d("chatItemAnimator enable notifications");
            }
        }
    ...
    public void setMessageObjects(ArrayList arrayList) {
        ...
        this.chatLayoutManager.scrollToPositionWithOffset(itemCount > 10 ? itemCount % 10 : 0, AndroidUtilities.m1124dp(12.0f), true);
    }
    ...
    public void setSendButton(final ChatActivityEnterView.SendButton sendButton, final boolean z, View.OnClickListener onClickListener) {
        ...
        iArr[0] = iArr[0] + ((this.anchorSendButton.getWidth() - this.anchorSendButton.width(sendButton.getHeight())) - AndroidUtilities.m1124dp(6.0f));
    }
    ...
    public void allowEffectSelector(BaseFragment baseFragment) {
        ...
        this.effectSelectorContainer.setPadding(0, 0, 0, AndroidUtilities.m1124dp(24.0f));
        ...
        this.effectSelector.setPadding(AndroidUtilities.m1124dp(4.0f), AndroidUtilities.m1124dp(22.0f), AndroidUtilities.m1124dp(4.0f), AndroidUtilities.m1124dp(22.0f));
        this.effectSelector.setDelegate(new C611216(baseFragment));
        this.effectSelector.setTop(false);
        this.effectSelector.setClipChildren(false);
        this.effectSelector.setClipToPadding(false);
        this.effectSelector.setVisibility(0);
        this.effectSelector.setHint(LocaleController.getString(C2888R.string.AddEffectMessageHint));
        this.effectSelector.setBubbleOffset(AndroidUtilities.m1124dp(-25.0f));
        this.effectSelector.setMiniBubblesOffset(AndroidUtilities.m1124dp(2.0f));
    ...
    class C611216 implements ReactionsContainerLayout.ReactionsContainerDelegate {
        ...
        C611216(BaseFragment baseFragment) {
        ...
        */
        public void onReactionClicked(android.view.View r18, org.telegram.ui.Components.Reactions.ReactionsLayoutInBubble.VisibleReaction r19, boolean r20, boolean r21) {
            /*
                ...
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.MessageSendPreview.C611216.onReactionClicked(android.view.View, org.telegram.ui.Components.Reactions.ReactionsLayoutInBubble$VisibleReaction, boolean, boolean):void");
        }
    ...
    public /* synthetic */ void lambda$allowEffectSelector$3(Integer num) {
        boolean z = num.intValue() - this.insets.bottom > AndroidUtilities.m1124dp(20.0f);
    ...
    public void hideEffectSelector() {
        ...
        if (reactionsContainerLayout != null && this.effectSelectorShown) {
            ...
            this.effectSelector.animate().alpha(0.01f).translationY(-AndroidUtilities.m1124dp(12.0f)).scaleX(0.6f).scaleY(0.6f).setDuration(180L).start();
        }
    }
    ...
    public void layout() {
        ...
        int width = iArr[0] + ((this.anchorSendButton.getWidth() - this.anchorSendButton.width()) - AndroidUtilities.m1124dp(6.0f));
        iArr[0] = width;
        int[] iArr2 = this.sendButtonInitialPosition;
        iArr2[0] = width;
        iArr2[1] = iArr[1];
        int measuredHeight = (this.chatListView.getMeasuredHeight() - this.sendButton.getHeight()) + (this.effectSelector != null ? AndroidUtilities.m1124dp(320.0f) : 0);
        int iM1124dp = this.insets.top + AndroidUtilities.m1124dp(8.0f);
        int iM1124dp2 = AndroidUtilities.m1124dp(this.messageObjects.isEmpty() ? -6.0f : 48.0f);
        View view = this.optionsView;
        int measuredHeight2 = iM1124dp2 + (view == null ? 0 : view.getMeasuredHeight());
        int measuredHeight3 = (this.containerView.getMeasuredHeight() - AndroidUtilities.m1124dp(8.0f)) - this.insets.bottom;
        if (iArr[1] + measuredHeight2 > measuredHeight3) {
            iArr[1] = measuredHeight3 - measuredHeight2;
        }
        if (iArr[1] - measuredHeight < iM1124dp) {
            iArr[1] = iM1124dp + measuredHeight;
        }
        ...
        this.sendButton.setX((iArr[0] - (r3.getWidth() - this.sendButton.width())) + AndroidUtilities.m1124dp(6.0f));
        this.sendButton.setY(iArr[1]);
        this.chatListView.setX((iArr[0] + AndroidUtilities.m1124dp(7.0f)) - this.chatListView.getMeasuredWidth());
        if (this.layoutDone) {
        ...
        if (view2 != null) {
            view2.setX((iArr[0] + AndroidUtilities.m1124dp(7.0f)) - this.optionsView.getMeasuredWidth());
            this.optionsView.setY(iArr[1] + (this.messageObjects.isEmpty() ? -AndroidUtilities.m1124dp(6.0f) : this.sendButton.getHeight()));
        }
        FrameLayout frameLayout = this.effectSelectorContainer;
        if (frameLayout != null) {
            frameLayout.setX(Math.max(0, ((iArr[0] + this.sendButton.width()) - this.effectSelectorContainer.getMeasuredWidth()) - AndroidUtilities.m1124dp(6.0f)));
            ...
            if (rectF != null) {
                ...
                if (reactionsContainerLayout != null) {
                    reactionsContainerLayout.setY(Math.max(this.insets.top, (this.cameraRect.top - AndroidUtilities.m1124dp(24.0f)) - this.effectSelector.getMeasuredHeight()));
                    return;
                }
                return;
            }
            ...
            float fMax2 = Math.max(this.insets.top, height - frameLayout3.getMeasuredHeight()) + AndroidUtilities.m1124dp(24.0f);
    ...
    private static class VisiblePart {
        ...
        public static VisiblePart m1290of(ChatMessageCell chatMessageCell) {
    ...
    public void dismissInto(ChatMessageCell chatMessageCell, float f, float f2) {
        ...
        if (this.mainMessageCell != null && chatMessageCell != null) {
            ...
            this.fromPart = VisiblePart.m1290of(this.mainMessageCell);
        }
    ...
    public void scrollTo(boolean z) {
        ...
        this.chatLayoutManager.scrollToPositionWithOffset(i, AndroidUtilities.m1124dp(12.0f), z);
    ...
    public void drawStarsPrice(Canvas canvas, float f, float f2, float f3, float f4) {
        ...
        float f5 = (f + f3) / 2.0f;
        float f6 = (f2 + f4) / 2.0f;
        float fM1124dp = AndroidUtilities.m1124dp(28.0f) + this.buttonText.getCurrentWidth();
        float fM1124dp2 = AndroidUtilities.m1124dp(32.0f);
        RectF rectF = AndroidUtilities.rectTmp;
        float f7 = fM1124dp / 2.0f;
        float f8 = f5 - f7;
        float f9 = fM1124dp2 / 2.0f;
        rectF.set(f8, f6 - f9, f5 + f7, f6 + f9);
        canvas.save();
        canvas.drawRoundRect(rectF, f9, f9, this.buttonBgPaint);
        this.buttonText.draw(canvas, f8 + AndroidUtilities.m1124dp(14.0f), f6, -1, 1.0f);
        canvas.restore();
    }
}
