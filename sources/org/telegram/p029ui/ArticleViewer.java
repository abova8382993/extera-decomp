...
import org.telegram.p029ui.ActionBar.BottomSheetTabDialog;
...
import org.telegram.p029ui.Components.AnchorSpan;
import org.telegram.p029ui.Components.AnimatedArrowDrawable;
...
import org.telegram.p029ui.Components.SmoothScroller;
import org.telegram.p029ui.Components.StaticLayoutEx;
import org.telegram.p029ui.Components.TableLayout;
import org.telegram.p029ui.Components.TextPaintImageReceiverSpan;
import org.telegram.p029ui.Components.TextPaintMarkSpan;
import org.telegram.p029ui.Components.TextPaintSpan;
import org.telegram.p029ui.Components.TextPaintUrlSpan;
import org.telegram.p029ui.Components.TextPaintWebpageUrlSpan;
...
import org.telegram.p029ui.web.RestrictedDomainsList;
import org.telegram.p029ui.web.SearchEngine;
import org.telegram.p029ui.web.WebActionBar;
import org.telegram.p029ui.web.WebBrowserSettings;
...
public class ArticleViewer implements NotificationCenter.NotificationCenterDelegate {
    ...
    public class DrawingText implements TextSelectionHelper.TextLayoutBlock {
        ...
        public void draw(Canvas canvas, View view) {
            ...
            if (ArticleViewer.this.pressedLinkOwnerLayout == this && ArticleViewer.this.pressedLink == null && ArticleViewer.this.drawBlockSelection) {
                ...
                canvas2 = canvas;
                canvas2.drawRect((-AndroidUtilities.m1124dp(2.0f)) + lineLeft, 0.0f, lineLeft + width + AndroidUtilities.m1124dp(2.0f), getHeight(), ArticleViewer.urlPaint);
            } else {
                canvas2 = canvas;
            }
    ...
    private class TextSizeCell extends FrameLayout {
        ...
        public TextSizeCell(Context context) {
            ...
            textPaint.setTextSize(AndroidUtilities.m1124dp(16.0f));
            ...
            this.sizeBar.setDelegate(new SeekBarView.SeekBarViewDelegate() { // from class: org.telegram.ui.ArticleViewer.TextSizeCell.1
                ...
                C32031(ArticleViewer articleViewer) {
                    articleViewer = articleViewer;
                }
        ...
        class C32031 implements SeekBarView.SeekBarViewDelegate {
            final /* synthetic */ ArticleViewer val$this$0;
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawText(_UrlKt.FRAGMENT_ENCODE_SET + SharedConfig.ivFontSize, getMeasuredWidth() - AndroidUtilities.m1124dp(39.0f), AndroidUtilities.m1124dp(28.0f), this.textPaint);
        }
    ...
    public class FontCell extends FrameLayout {
        ...
        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(48.0f), TLObject.FLAG_30));
        }
    ...
    class C31511 extends AnimationProperties.FloatProperty {
        C31511(String str) {
            super(str);
        }
    ...
    private class WindowView extends FrameLayout {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            ArticleViewer articleViewer = ArticleViewer.this;
            if (articleViewer.sheet == null) {
                articleViewer.keyboardVisible = size2 < AndroidUtilities.displaySize.y - AndroidUtilities.m1124dp(100.0f);
            }
        ...
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            ...
            if (ArticleViewer.this.lastInsets != null) {
                ...
                if (windowInsets.getSystemWindowInsetRight() != 0) {
                    ...
                    this.f1883bX = 0;
                    this.f1884bY = (i4 - i2) - this.bHeight;
                }
        ...
        class C32051 extends AnimatorListenerAdapter {
            final /* synthetic */ boolean val$backAnimation;
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            int i2 = this.f1883bX;
            if (i2 == 0 && (i = this.f1884bY) == 0) {
                canvas.drawRect(i2, i, i2 + this.bWidth, i + this.bHeight, this.blackPaint);
            } else {
                canvas.drawRect(i2 - getTranslationX(), this.f1884bY, (this.f1883bX + this.bWidth) - getTranslationX(), this.f1884bY + this.bHeight, this.blackPaint);
            }
        }
    ...
    class CheckForLongPress implements Runnable {
        ...
        public void run() {
            ...
            int iM1124dp = (iArr[1] + ArticleViewer.this.pressedLayoutY) - AndroidUtilities.m1124dp(54.0f);
            if (iM1124dp < 0) {
                iM1124dp = 0;
            }
            ArticleViewer.this.pressedLinkOwnerView.invalidate();
            ...
            ArticleViewer articleViewer5 = ArticleViewer.this;
            articleViewer5.showPopup(articleViewer5.pressedLinkOwnerView, 48, 0, iM1124dp);
    ...
    private void createPaint(boolean z) {
        if (quoteLinePaint == null) {
            ...
            tableLinePaint.setStrokeWidth(AndroidUtilities.m1124dp(1.0f));
            Paint paint2 = new Paint();
            tableHalfLinePaint = paint2;
            paint2.setStyle(style);
            tableHalfLinePaint.setStrokeWidth(AndroidUtilities.m1124dp(1.0f) / 2.0f);
    ...
    public void showCopyPopup(final String str) {
        ...
        builder.setItems(new CharSequence[]{LocaleController.getString(C2888R.string.Open), LocaleController.getString(C2888R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.ArticleViewer$$ExternalSyntheticLambda49
            ...
            if (iLastIndexOf != -1) {
                ...
                if (str.toLowerCase().contains(lowerCase)) {
                    if (TextUtils.isEmpty(strDecode)) {
                        ...
                        linearLayoutManager.scrollToPositionWithOffset((sheet == null || !sheet.halfSize()) ? 0 : 1, this.sheet != null ? AndroidUtilities.m1124dp(32.0f) : 0);
                        checkScrollAnimated();
                        return;
                    }
    ...
    public void showPopup(View view, int i, int i2, int i3) {
        ...
        if (this.popupLayout == null) {
            ...
            actionBarPopupWindowLayout.setPadding(AndroidUtilities.m1124dp(1.0f), AndroidUtilities.m1124dp(1.0f), AndroidUtilities.m1124dp(1.0f), AndroidUtilities.m1124dp(1.0f));
            this.popupLayout.setBackgroundDrawable(this.parentActivity.getResources().getDrawable(C2888R.drawable.menu_copy));
            ...
            this.deleteView.setPadding(AndroidUtilities.m1124dp(20.0f), 0, AndroidUtilities.m1124dp(20.0f), 0);
            this.deleteView.setTextSize(1, 15.0f);
            this.deleteView.setTypeface(AndroidUtilities.bold());
            this.deleteView.setText(LocaleController.getString(C2888R.string.Copy).toUpperCase());
        ...
        this.popupLayout.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(1000.0f), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(1000.0f), Integer.MIN_VALUE));
    ...
    public /* synthetic */ void lambda$showPopup$4(View view) {
        ...
        if (drawingText != null) {
            ...
            if (AndroidUtilities.shouldShowClipboardToast()) {
                Toast.makeText(this.parentActivity, LocaleController.getString(C2888R.string.TextCopied), 0).show();
            }
        }
        ActionBarPopupWindow actionBarPopupWindow = this.popupWindow;
        if (actionBarPopupWindow == null || !actionBarPopupWindow.isShowing()) {
    ...
    */
    private boolean openAllParentBlocks(org.telegram.ui.ArticleViewer.TL_pageBlockDetailsChild r5) {
        /*
            r4 = this;
            org.telegram.tgnet.TLRPC$PageBlock r5 = org.telegram.ui.ArticleViewer.TL_pageBlockDetailsChild.m6090$$Nest$fgetparent(r5)
        ...
        L18:
            ...
            org.telegram.tgnet.TLRPC$PageBlock r0 = org.telegram.ui.ArticleViewer.TL_pageBlockDetailsChild.m6089$$Nest$fgetblock(r5)
        ...
        L40:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.ArticleViewer.openAllParentBlocks(org.telegram.ui.ArticleViewer$TL_pageBlockDetailsChild):boolean");
    }
        ...
        if (obj != null) {
            ...
            if (obj instanceof TLRPC.WebPage) {
                ...
                if (this.pagesStack.size() == 1 || i == -1) {
                    ...
                    String str = "article" + webPage.f1834id;
                    int i4 = sharedPreferences.getInt(str, -1);
                    boolean z2 = sharedPreferences.getBoolean(str + "r", true);
                    Point point = AndroidUtilities.displaySize;
                    if (z2 == (point.x <= point.y ? 0 : 1)) {
                        iM1124dp = sharedPreferences.getInt(str + "o", 0) - this.pages[z ? 1 : 0].listView.getPaddingTop();
                    } else {
                        iM1124dp = AndroidUtilities.m1124dp(10.0f);
                    }
                    if (i4 != -1) {
                        this.pages[z ? 1 : 0].layoutManager.scrollToPositionWithOffset(i4, iM1124dp);
                    }
                } else {
                    LinearLayoutManager linearLayoutManager = this.pages[z ? 1 : 0].layoutManager;
                    Sheet sheet2 = this.sheet;
                    linearLayoutManager.scrollToPositionWithOffset((sheet2 == null || !sheet2.halfSize()) ? 0 : 1, this.sheet != null ? AndroidUtilities.m1124dp(32.0f) : 0);
                }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C31622 extends AnimatorListenerAdapter {
        final /* synthetic */ int val$index;
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C31693 extends AnimatorListenerAdapter {
        C31693() {
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C31704 extends AnimatorListenerAdapter {
        C31704() {
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C31715 extends AnimatorListenerAdapter {
        C31715() {
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C31726 extends AnimatorListenerAdapter {
        final /* synthetic */ int val$intoIndex;
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C31737 extends TextSelectionHelper.Callback {
        C31737() {
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C31748 extends TextView {
        C31748(Context context) {
            super(context);
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C31759 extends FrameLayout {
        final /* synthetic */ LinearLayout val$linearLayout;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C31759(Context context, LinearLayout linearLayout) {
            super(context);
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, i2);
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(linearLayout.getMeasuredHeight() + AndroidUtilities.m1124dp(8.0f), TLObject.FLAG_30));
        }
    }

    /* JADX INFO: renamed from: org.telegram.ui.ArticleViewer$10 */
    /* JADX INFO: loaded from: classes6.dex */
    class C315210 extends BottomSheet.BottomSheetDelegate {
        C315210() {
        }
    ...
    private boolean scrollToAnchor(String str, boolean z) {
        ...
        if (numValueOf != null) {
            ...
            if (tL_textAnchor != null) {
                ...
                C31748 c31748 = new TextView(this.parentActivity) { // from class: org.telegram.ui.ArticleViewer.8
                    C31748(Context context) {
                        super(context);
                    }
                ...
                c31748.setTextSize(1, 16.0f);
                c31748.setTypeface(AndroidUtilities.bold());
                c31748.setText(LocaleController.getString(C2888R.string.InstantViewReference));
                c31748.setGravity((this.pages[0].adapter.isRtl ? 5 : 3) | 16);
                c31748.setTextColor(getTextColor());
                c31748.setPadding(AndroidUtilities.m1124dp(18.0f), 0, AndroidUtilities.m1124dp(18.0f), 0);
                linearLayout.addView(c31748, new LinearLayout.LayoutParams(-1, AndroidUtilities.m1124dp(48.0f) + 1));
                ...
                C31759 c31759 = new FrameLayout(this.parentActivity) { // from class: org.telegram.ui.ArticleViewer.9
                    final /* synthetic */ LinearLayout val$linearLayout;

                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    C31759(Context context, LinearLayout linearLayout2) {
                        super(context);
                ...
                c31759.addView(linearLayout2, -1, -2);
                c31759.addView(overlayView, -1, -2);
                builder.setCustomView(c31759);
                ...
                if (z) {
                    ...
                    smoothScroller.setOffset((-AndroidUtilities.m1124dp(56.0f)) - num.intValue());
                    this.pages[0].layoutManager.startSmoothScroll(smoothScroller);
                } else {
                    this.pages[0].layoutManager.scrollToPositionWithOffset(numValueOf.intValue(), (-AndroidUtilities.m1124dp(56.0f)) - num.intValue());
                }
            }
            return true;
        }
    ...
    public CharSequence getText(TLRPC.WebPage webPage, View view, TLRPC.RichText richText, TLRPC.RichText richText2, TLRPC.PageBlock pageBlock, int i) {
        ...
        if (richText2 instanceof TLRPC.TL_textImage) {
            ...
            if (documentWithId != null) {
                ...
                int iM1124dp = AndroidUtilities.m1124dp(tL_textImage.f1807w);
                int iM1124dp2 = AndroidUtilities.m1124dp(tL_textImage.f1806h);
                int iAbs = Math.abs(i);
                if (iM1124dp > iAbs) {
                    iM1124dp2 = (int) (iM1124dp2 * (iAbs / iM1124dp));
                } else {
                    iAbs = iM1124dp;
                }
                int i7 = iM1124dp2;
            ...
            int iM1124dp3 = AndroidUtilities.m1124dp(tL_textImage.f1807w);
            int iM1124dp4 = AndroidUtilities.m1124dp(tL_textImage.f1806h);
            int iAbs2 = Math.abs(i);
            if (iM1124dp3 > iAbs2) {
                iM1124dp4 = (int) (iM1124dp4 * (iAbs2 / iM1124dp3));
                i2 = iAbs2;
            } else {
                i2 = iM1124dp3;
            }
    ...
    /* JADX WARN: Removed duplicated region for block: B:350:0x0271  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private android.text.TextPaint getTextPaint(org.telegram.tgnet.TLRPC.RichText r11, org.telegram.tgnet.TLRPC.RichText r12, org.telegram.tgnet.TLRPC.PageBlock r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.ArticleViewer.getTextPaint(org.telegram.tgnet.TLRPC$RichText, org.telegram.tgnet.TLRPC$RichText, org.telegram.tgnet.TLRPC$PageBlock):android.text.TextPaint");
    }
    ...
    public DrawingText createLayoutForText(View view, CharSequence charSequence, TLRPC.RichText richText, int i, int i2, TLRPC.PageBlock pageBlock, Layout.Alignment alignment, int i3, WebpageAdapter webpageAdapter) {
        ...
        int iM1124dp3 = i < 0 ? AndroidUtilities.m1124dp(10.0f) : i;
        if (charSequence != null) {
            ...
            articleViewer = this;
            pageBlock2 = pageBlock;
            text = articleViewer.getText(webpageAdapter, view, richText, richText, pageBlock2, iM1124dp3);
        }
        if (TextUtils.isEmpty(text)) {
            return null;
        }
        int iM1124dp4 = AndroidUtilities.m1124dp(SharedConfig.ivFontSize - 16);
        if ((pageBlock2 instanceof TLRPC.TL_pageBlockEmbedPost) && richText == null) {
            if (((TLRPC.TL_pageBlockEmbedPost) pageBlock2).author == charSequence) {
                ...
                embedPostAuthorPaint.setTextSize(AndroidUtilities.m1124dp(15.0f) + iM1124dp4);
                ...
                embedPostDatePaint.setTextSize(AndroidUtilities.m1124dp(14.0f) + iM1124dp4);
            ...
            channelNamePaint.setTextSize(AndroidUtilities.m1124dp(15.0f));
            channelNamePhotoPaint.setColor(-1);
            channelNamePhotoPaint.setTextSize(AndroidUtilities.m1124dp(15.0f));
            ...
            if (charSequence == ((TLRPC.TL_pageRelatedArticle) tL_pageBlockRelatedArticlesChild.parent.articles.get(tL_pageBlockRelatedArticlesChild.num)).title) {
                ...
                relatedArticleHeaderPaint.setTextSize(AndroidUtilities.m1124dp(15.0f) + iM1124dp4);
                ...
                relatedArticleTextPaint.setTextSize(AndroidUtilities.m1124dp(14.0f) + iM1124dp4);
            ...
            listTextPointerPaint.setTextSize(AndroidUtilities.m1124dp(19.0f) + iM1124dp4);
            listTextNumPaint.setTextSize(AndroidUtilities.m1124dp(16.0f) + iM1124dp4);
        ...
        if (i3 != 0) {
            if (pageBlock2 instanceof TLRPC.TL_pageBlockPullquote) {
                ...
                r1 = 1;
                CreateStaticLayout = StaticLayoutEx.createStaticLayout(charSequenceReplaceEmoji, textPaint9, iM1124dp3, Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false, TextUtils.TruncateAt.END, iM1124dp3, i3);
            } else {
                TextPaint textPaint10 = textPaint;
                r1 = 1;
                CreateStaticLayout = StaticLayoutEx.createStaticLayout(charSequenceReplaceEmoji, textPaint10, iM1124dp3, alignment, 1.0f, AndroidUtilities.m1124dp(4.0f), false, TextUtils.TruncateAt.END, iM1124dp3, i3);
            }
        } else {
            ...
            if (pageBlock2 instanceof TLRPC.TL_pageBlockPullquote) {
                ...
                staticLayout = new StaticLayout(charSequence2, textPaint11, iM1124dp3, Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
            } else {
                charSequence2 = charSequenceReplaceEmoji;
                staticLayout = new StaticLayout(charSequence2, textPaint11, iM1124dp3, alignment, 1.0f, AndroidUtilities.m1124dp(4.0f), false);
            }
            ...
            if (textPaintWebpageUrlSpanArr == null || textPaintWebpageUrlSpanArr.length <= 0) {
                ...
                try {
                    ...
                    for (int i6 = 0; i6 < textPaintWebpageUrlSpanArr.length; i6++) {
                        ...
                        if (i7 != 0) {
                            iM1124dp2 = i7 + AndroidUtilities.m1124dp(i7 > 0 ? 5.0f : -2.0f);
                        } else {
                            iM1124dp2 = 0;
                        }
                        linkPath.setBaselineShift(iM1124dp2);
                ...
                if (textPaintMarkSpanArr != null && textPaintMarkSpanArr.length > 0) {
                    ...
                    try {
                        ...
                        for (int i8 = 0; i8 < textPaintMarkSpanArr.length; i8++) {
                            ...
                            if (i9 != 0) {
                                iM1124dp = i9 + AndroidUtilities.m1124dp(i9 > 0 ? 5.0f : -2.0f);
                            } else {
                                iM1124dp = 0;
                            }
                            linkPath2.setBaselineShift(iM1124dp);
                                ...
                                if (textPaintUrlSpanArr != null && textPaintUrlSpanArr.length > 0) {
                                    ...
                                    if (linkSpanDrawable == null || linkSpanDrawable.getSpan() != textPaintUrlSpan) {
                                        ...
                                        try {
                                            ...
                                            if (i6 != 0) {
                                                iM1124dp = i6 + AndroidUtilities.m1124dp(i6 > 0 ? 5.0f : -2.0f);
                                            } else {
                                                iM1124dp = 0;
                                            }
                                            linkPathObtainNewPath.setBaselineShift(iM1124dp);
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C315311 extends Browser.Progress {
        final /* synthetic */ LinkSpanDrawable val$link;
        final /* synthetic */ DrawingText val$text;

        C315311(DrawingText drawingText, LinkSpanDrawable linkSpanDrawable) {
    ...
    public Browser.Progress makeProgress(LinkSpanDrawable linkSpanDrawable, DrawingText drawingText) {
        ...
        return new Browser.Progress() { // from class: org.telegram.ui.ArticleViewer.11
            ...
            C315311(DrawingText drawingText2, LinkSpanDrawable linkSpanDrawable2) {
    ...
    public void setParentActivity(final Activity activity, BaseFragment baseFragment) {
        ...
        this.slideDotDrawable = activity.getResources().getDrawable(C2888R.drawable.slide_dot_small);
        this.slideDotBigDrawable = activity.getResources().getDrawable(C2888R.drawable.slide_dot_big);
        ...
        C315412 c315412 = new FrameLayout(activity) { // from class: org.telegram.ui.ArticleViewer.12
            C315412(final Context activity3) {
                super(activity3);
            }
            ...
            */
            protected boolean drawChild(android.graphics.Canvas r11, android.view.View r12, long r13) {
                /*
                    r10 = this;
                    org.telegram.ui.ArticleViewer r2 = org.telegram.p029ui.ArticleViewer.this
                    org.telegram.ui.ArticleViewer$WindowView r2 = org.telegram.p029ui.ArticleViewer.m5930$$Nest$fgetwindowView(r2)
                    if (r2 == 0) goto L92
                    org.telegram.ui.ArticleViewer r2 = org.telegram.p029ui.ArticleViewer.this
                    org.telegram.ui.ArticleViewer$WindowView r2 = org.telegram.p029ui.ArticleViewer.m5930$$Nest$fgetwindowView(r2)
                    boolean r2 = org.telegram.ui.ArticleViewer.WindowView.m6173$$Nest$fgetmovingPage(r2)
                    if (r2 != 0) goto L20
                    org.telegram.ui.ArticleViewer r2 = org.telegram.p029ui.ArticleViewer.this
                    org.telegram.ui.ArticleViewer$WindowView r2 = org.telegram.p029ui.ArticleViewer.m5930$$Nest$fgetwindowView(r2)
                    boolean r2 = org.telegram.ui.ArticleViewer.WindowView.m6174$$Nest$fgetopeningPage(r2)
                    if (r2 == 0) goto L92
                L20:
                    int r2 = r10.getMeasuredWidth()
                    org.telegram.ui.ArticleViewer r3 = org.telegram.p029ui.ArticleViewer.this
                    org.telegram.ui.ArticleViewer$PageLayout[] r3 = r3.pages
                    r4 = 0
                    r3 = r3[r4]
                    float r3 = r3.getTranslationX()
                    int r3 = (int) r3
                    org.telegram.ui.ArticleViewer r5 = org.telegram.p029ui.ArticleViewer.this
                ...
                L42:
                    ...
                    if (r3 == 0) goto L91
                    org.telegram.ui.ArticleViewer r4 = org.telegram.p029ui.ArticleViewer.this
                ...
                L70:
                    org.telegram.ui.ArticleViewer r2 = org.telegram.p029ui.ArticleViewer.this
                    android.graphics.Paint r2 = org.telegram.p029ui.ArticleViewer.m5920$$Nest$fgetscrimPaint(r2)
                    ...
                    float r4 = (float) r2
                    org.telegram.ui.ArticleViewer r2 = org.telegram.p029ui.ArticleViewer.this
                    android.graphics.Paint r5 = org.telegram.p029ui.ArticleViewer.m5920$$Nest$fgetscrimPaint(r2)
                    r2 = 0
                    r0 = r11
                ...
                L92:
                    ...
                    return r0
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.ArticleViewer.C315412.drawChild(android.graphics.Canvas, android.view.View, long):boolean");
            }
        ...
        this.containerView = c315412;
        this.windowView.addView(c315412, LayoutHelper.createFrame(-1, -1, 51));
        if (this.sheet == null) {
        ...
        Sheet sheet2 = this.sheet;
        frameLayout3.addView(frameLayout2, LayoutHelper.createFrame(-1, -1.0f, 119, 0.0f, (sheet2 == null || sheet2.halfSize()) ? 0.0f : 56.0f, 0.0f, 0.0f));
        ...
        C315513 c315513 = new WebActionBar(activity3, getResourcesProvider()) { // from class: org.telegram.ui.ArticleViewer.13
            C315513(final Context activity3, Theme.ResourcesProvider resourcesProvider) {
                super(activity3, resourcesProvider);
            }

            @Override // org.telegram.p029ui.web.WebActionBar
            ...
            @Override // org.telegram.p029ui.web.WebActionBar, android.widget.FrameLayout, android.view.View
        ...
        this.actionBar = c315513;
        c315513.occupyStatusBar(this.sheet != null);
        ...
        C316018 c316018 = new FrameLayout(this.parentActivity) { // from class: org.telegram.ui.ArticleViewer.18
            C316018(Context context) {
                super(context);
            }
        ...
        this.searchPanel = c316018;
        c316018.setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.ArticleViewer$$ExternalSyntheticLambda22
            @Override // android.view.View.OnTouchListener
        ...
        this.searchPanel.setTranslationY(AndroidUtilities.m1124dp(51.0f));
        ...
        this.searchPanel.setPadding(0, AndroidUtilities.m1124dp(3.0f), 0, 0);
        ...
        this.searchUpButton.setImageResource(C2888R.drawable.msg_go_up);
        ...
        this.searchUpButton.setContentDescription(LocaleController.getString(C2888R.string.AccDescrSearchNext));
        ImageView imageView4 = new ImageView(this.parentActivity);
        this.searchDownButton = imageView4;
        imageView4.setScaleType(scaleType);
        this.searchDownButton.setImageResource(C2888R.drawable.msg_go_down);
        ...
        this.searchDownButton.setContentDescription(LocaleController.getString(C2888R.string.AccDescrSearchPrev));
        ...
        this.searchCountText.setTextSize(AndroidUtilities.m1124dp(15.0f));
        ...
        articleTextSelectionHelper2.setCallback(new TextSelectionHelper.Callback() { // from class: org.telegram.ui.ArticleViewer.19
            ...
            public void onTextCopied() {
                if (AndroidUtilities.shouldShowClipboardToast()) {
                    BulletinFactory.m1245of(ArticleViewer.this.containerView, null).createCopyBulletin(LocaleController.getString(C2888R.string.TextCopied)).show();
                }
            }
        });
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C315412 extends FrameLayout {
        C315412(final Activity activity3) {
            super(activity3);
        }
                ...
                if (this.previewsReqId == 0) {
                    if ((!reportCell.hasViews || f >= view.getMeasuredWidth() / 2) && !reportCell.web) {
                        ...
                        if (userOrChat instanceof TLRPC.TL_user) {
                            openPreviewsChat((TLRPC.User) userOrChat, adapter.currentPage.f1834id);
                            return;
                        }
                        final int i2 = UserConfig.selectedAccount;
                        final long j = adapter.currentPage.f1834id;
                        showProgressView(true, true);
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C315513 extends WebActionBar {
        C315513(final Activity activity3, Theme.ResourcesProvider resourcesProvider) {
            super(activity3, resourcesProvider);
        }
    ...
    public /* synthetic */ void lambda$setParentActivity$21(final Activity activity, View view) {
        ...
        if (pageLayout.isWeb()) {
            ...
            if (this.addressBarList != null) {
                ...
                if (TextUtils.isEmpty(title)) {
                    title = LocaleController.getString(C2888R.string.WebEmpty);
                }
            ...
            this.actionBar.showAddress(_UrlKt.FRAGMENT_ENCODE_SET, new Utilities.Callback() { // from class: org.telegram.ui.ArticleViewer$$ExternalSyntheticLambda29
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    ArticleViewer.m5849$r8$lambda$2xiPyqtpjVazUYUJ_fXqeSNKjA(pageLayout, activity, (String) obj);
                }
            });
            return;
        }
        if (this.sheet != null) {
            ...
            if (this.sheet.halfSize()) {
                ...
                smoothScroller.setOffset(-AndroidUtilities.m1124dp(32.0f));
            } else {
    ...
    public /* synthetic */ void lambda$setParentActivity$19(String str, PageLayout pageLayout, View view) {
        ...
        AndroidUtilities.addToClipboard(str);
        BulletinFactory.m1245of(pageLayout.webViewContainer, getResourcesProvider()).createCopyLinkBulletin().show(true);
    }

    /* JADX INFO: renamed from: $r8$lambda$2xiPyqtpjVazUYUJ_fXqeS-NKjA */
    public static /* synthetic */ void m5849$r8$lambda$2xiPyqtpjVazUYUJ_fXqeSNKjA(PageLayout pageLayout, Activity activity, String str) {
        if (TextUtils.isEmpty(str) || pageLayout.getWebView() == null) {
            return;
        }
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(str.trim());
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C315614 implements TextWatcher {
        @Override // android.text.TextWatcher
        public void beforeTextChanged(CharSequence charSequence, int i2, int i3, int i4) {
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C315715 extends RecyclerView.OnScrollListener {
        C315715() {
        }
    ...
    public /* synthetic */ boolean lambda$setParentActivity$29(View view) {
                ...
                while (i2 < currentIndex) {
                    ...
                    if (last != null) {
                        ...
                        last.setTextAndIcon(itemAtIndex.getTitle(), 0, new Drawable() { // from class: org.telegram.ui.ArticleViewer.16
                            ...
                            C315816(Bitmap favicon2, Paint paint) {
                                bitmap = favicon2;
                                paint = paint;
                            }
            ...
            if (obj instanceof CachedWeb) {
                ...
                if (last2 != null) {
                    ...
                    last2.setTextAndIcon(cachedWeb.getTitle(), 0, new Drawable() { // from class: org.telegram.ui.ArticleViewer.17
                        ...
                        C315917(Bitmap favicon22, Paint paint) {
                            bitmap = favicon22;
                            paint = paint;
                        }
                ...
                if (last3 != null) {
                    last3.setTextAndIcon(webPage.title, C2888R.drawable.msg_instant);
                    ...
                    last3.imageView.getLayoutParams().width = AndroidUtilities.m1124dp(24.0f);
        ...
        itemOptionsMakeOptions.setScrimViewBackground(Theme.createCircleDrawable(AndroidUtilities.m1124dp(40.0f), this.actionBar.getBackgroundColor()));
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C315816 extends Drawable {
        final /* synthetic */ Bitmap val$finalBitmap;
        final /* synthetic */ Paint val$paint;
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C315917 extends Drawable {
        final /* synthetic */ Bitmap val$finalBitmap;
        final /* synthetic */ Paint val$paint;
    ...
    public /* synthetic */ void lambda$setParentActivity$39(Activity activity, Integer num) {
        ...
        if (num.intValue() == 6) {
            ...
            SendMessagesHelper.getInstance(this.currentAccount).sendMessage(SendMessagesHelper.SendMessageParams.m1174of(strMagic2tonsite2, clientUserId));
            ...
            BulletinFactory.m1245of(frameLayout, getResourcesProvider()).createSimpleBulletin(C2888R.raw.saved_messages, AndroidUtilities.replaceSingleTag(LocaleController.getString(C2888R.string.WebBookmarkedToast), new Runnable() { // from class: org.telegram.ui.ArticleViewer$$ExternalSyntheticLambda36
                @Override // java.lang.Runnable
                public final void run() {
        ...
        if (num.intValue() == 3) {
            ...
            if (this.pages[0].isWeb() && !RestrictedDomainsList.getInstance().isRestricted(hostAuthority2) && RestrictedDomainsList.getInstance().incrementOpen(hostAuthority2) >= 2) {
                ...
                builder.setTitle(LocaleController.getString(C2888R.string.BrowserExternalTitle));
                ...
                textView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2888R.string.BrowserExternalText)));
                checkBoxCell.setText(AndroidUtilities.replaceTags(LocaleController.formatString(C2888R.string.BrowserExternalCheck, hostAuthority2)), _UrlKt.FRAGMENT_ENCODE_SET, false, false);
                builder.setView(linearLayout);
                builder.setPositiveButton(LocaleController.getString(C2888R.string.Continue), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ArticleViewer$$ExternalSyntheticLambda44
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                    public final void onClick(AlertDialog alertDialog, int i) {
                        ArticleViewer.$r8$lambda$7KKE5Usa_0QX3Ls8_4QAuVSOHaI(checkBoxCell, callback, runnable, alertDialog, i);
                    }
                });
                builder.setNegativeButton(LocaleController.getString(C2888R.string.Cancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ArticleViewer$$ExternalSyntheticLambda45
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                    public final void onClick(AlertDialog alertDialog, int i) {
        ...
        if (num.intValue() == 4) {
            ...
            linearLayout2.setPadding(0, 0, 0, AndroidUtilities.m1124dp(4.0f));
            linearLayout2.setOrientation(1);
            HeaderCell headerCell = new HeaderCell(this.parentActivity, getResourcesProvider());
            headerCell.setText(LocaleController.getString(C2888R.string.FontSize));
            ...
            headerCell2.setText(LocaleController.getString(C2888R.string.FontType));
            ...
            while (i < 2) {
                ...
                if (i == 0) {
                    this.fontCells[i].setTextAndTypeface(LocaleController.getString(C2888R.string.Default), Typeface.DEFAULT);
                } else if (i == 1) {
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C316018 extends FrameLayout {
        C316018(Context context) {
            super(context);
        }
    ...
    public /* synthetic */ void lambda$setParentActivity$42(Integer num) {
        ...
        frameLayout.setTranslationY(f + (AndroidUtilities.m1124dp(51.0f) * (1.0f - this.searchPanelAlpha)));
    }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C316119 extends TextSelectionHelper.Callback {
        C316119() {
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C316320 implements PinchToZoomHelper.Callback {
        @Override // org.telegram.ui.PinchToZoomHelper.Callback
        public /* synthetic */ TextureView getCurrentTextureView() {
            return PinchToZoomHelper.Callback.CC.$default$getCurrentTextureView(this);
        }
    ...
    public void showRestrictedWebsiteToast() {
        ...
        BulletinFactory.m1245of(frameLayout, getResourcesProvider()).createSimpleBulletin(C2888R.raw.chats_infotip, AndroidUtilities.replaceSingleTag(LocaleController.getString(C2888R.string.BrowserExternalRestricted), new Runnable() { // from class: org.telegram.ui.ArticleViewer$$ExternalSyntheticLambda54
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void updateSearchButtons() {
        ...
        if (this.searchResults != null || this.pages[0].isWeb()) {
            ...
            if (size == 0) {
                this.searchCountText.setText(LocaleController.getString(C2888R.string.NoResult));
            } else if (size == 1) {
                this.searchCountText.setText(LocaleController.getString(C2888R.string.OneResult));
            } else {
    ...
    */
    public /* synthetic */ void lambda$processSearch$48(java.util.ArrayList r17, java.util.HashMap r18, final java.lang.String r19, final int r20) {
        ...
        L6e:
            ...
            r4.<init>()
            org.telegram.ui.ArticleViewer.SearchResult.m6074$$Nest$fputindex(r4, r2)
            org.telegram.ui.ArticleViewer.SearchResult.m6073$$Nest$fputblock(r4, r5)
            org.telegram.ui.ArticleViewer.SearchResult.m6075$$Nest$fputtext(r4, r13)
            r8.add(r4)
        L7f:
            r2 = r3
            goto L55
        ...
        L84:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.ArticleViewer.lambda$processSearch$48(java.util.ArrayList, java.util.HashMap, java.lang.String, int):void");
    }
    ...
    public void showSearchPanel(boolean z) {
        ...
        this.searchPanelAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.ArticleViewer.21
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                ArticleViewer.this.searchPanel.setTranslationY(ArticleViewer.this.searchPanelTranslation + ((1.0f - ArticleViewer.this.searchPanelAlpha) * AndroidUtilities.m1124dp(51.0f)));
                if (z) {
                    return;
                }
    ...
    public /* synthetic */ void lambda$showSearchPanel$50(ValueAnimator valueAnimator) {
        ...
        this.searchPanel.setTranslationY(this.searchPanelTranslation + ((1.0f - fFloatValue) * AndroidUtilities.m1124dp(51.0f)));
    }

    /* JADX INFO: renamed from: org.telegram.ui.ArticleViewer$21 */
    /* JADX INFO: loaded from: classes6.dex */
    class C316421 extends AnimatorListenerAdapter {
        final /* synthetic */ boolean val$show;
    ...
    /* JADX WARN: Removed duplicated region for block: B:117:0x00ba A[SYNTHETIC] */
    ...
    */
    private void scrollToSearchIndex(int r13) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.ArticleViewer.scrollToSearchIndex(int):void");
    }
    ...
    private void checkScrollAnimated(Runnable runnable) {
        if (this.currentHeaderHeight == AndroidUtilities.m1124dp(56.0f)) {
            if (runnable != null) {
                runnable.run();
                return;
            }
        ...
        ValueAnimator duration = ValueAnimator.ofObject(new IntEvaluator(), Integer.valueOf(this.currentHeaderHeight), Integer.valueOf(AndroidUtilities.m1124dp(56.0f))).setDuration(180L);
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C316522 extends AnimatorListenerAdapter {
        final /* synthetic */ Runnable val$callback;
    ...
    public void setCurrentHeaderHeight(int i) {
        ...
        int iClamp = Utilities.clamp(i, AndroidUtilities.m1124dp(56.0f), AndroidUtilities.m1124dp(24.0f));
    ...
    private boolean open(final MessageObject messageObject, TLRPC.WebPage webPage, String str, String str2, Browser.Progress progress) {
        ...
        if (r5 == 0) {
            ...
            setCurrentHeaderHeight(AndroidUtilities.m1124dp(56.0f));
        }
        Sheet sheet2 = this.sheet;
        ...
        if (r5 == 0) {
            ...
            if (sheet3 == null) {
                ...
                animatorSet.addListener(new C316623());
    ...
    public /* synthetic */ void lambda$open$52(TLObject tLObject, int i, TLRPC.WebPage webPage, MessageObject messageObject, boolean z, String str) {
        ...
        if (tLObject2 instanceof TLRPC.TL_webPage) {
            ...
            if (!this.pagesStack.isEmpty() && this.pagesStack.get(0) == webPage) {
                ...
                if (this.pagesStack.size() == 1) {
                    ApplicationLoader.applicationContext.getSharedPreferences("articles", 0).edit().remove("article" + tL_webPage.f1834id).apply();
            ...
            longSparseArray.put(tL_webPage.f1834id, tL_webPage);
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C316623 extends AnimatorListenerAdapter {
        C316623() {
        }
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C316724 extends AnimatorListenerAdapter {
        final /* synthetic */ boolean val$show;
    ...
    public void saveCurrentPagePosition() {
        ...
        String str = "article" + this.pages[0].adapter.currentPage.f1834id;
    ...
    public void close(boolean z, boolean z2) {
        ...
        WindowView windowView = this.windowView;
        Property property = View.ALPHA;
        animatorSet.playTogether(ObjectAnimator.ofFloat(windowView, (Property<WindowView, Float>) property, 0.0f), ObjectAnimator.ofFloat(this.containerView, (Property<FrameLayout, Float>) property, 0.0f), ObjectAnimator.ofFloat(this.windowView, (Property<WindowView, Float>) View.TRANSLATION_X, 0.0f, AndroidUtilities.m1124dp(56.0f)));
    ...
    /* JADX INFO: loaded from: classes6.dex */
    class C316825 extends AnimatorListenerAdapter {
        C316825() {
        }
    ...
    public /* synthetic */ void lambda$joinChannel$63(final BlockChannelCell blockChannelCell, final int i, final TLRPC.TL_channels_joinChannel tL_channels_joinChannel, final TLRPC.Chat chat, TLObject tLObject, final TLRPC.TL_error tL_error) {
        ...
        if (!z) {
            MessagesController.getInstance(i).generateJoinMessage(chat.f1660id, true);
        }
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.ArticleViewer$$ExternalSyntheticLambda69
            @Override // java.lang.Runnable
            public final void run() {
                MessagesController.getInstance(i).loadFullChat(chat.f1660id, 0, true);
            }
        }, 1000L);
    ...
    class WebpageAdapter extends RecyclerListView.SelectionAdapter {
        ...
        /* JADX WARN: Removed duplicated region for block: B:346:0x04e2  */
        /* JADX WARN: Removed duplicated region for block: B:352:0x04fe  */
        /* JADX WARN: Removed duplicated region for block: B:378:0x056e A[SYNTHETIC] */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        ...
        class C32041 extends View {
            C32041(Context context) {
                super(context);
            }
        ...
        */
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (this.currentBlock.level > 0) {
                canvas2 = canvas;
                canvas2.drawRect(AndroidUtilities.m1124dp(18.0f), 0.0f, AndroidUtilities.m1124dp(20.0f), getMeasuredHeight() - (this.currentBlock.bottom ? AndroidUtilities.m1124dp(6.0f) : 0), ArticleViewer.quoteLinePaint);
            } else {
                canvas2 = canvas;
            }
            ...
            if (this.currentDocument != null) {
                ...
                for (int i = 0; i < document.attributes.size(); i++) {
                    if (document.attributes.get(i) instanceof TLRPC.TL_documentAttributeVideo) {
                        ...
                        this.aspectRatioFrameLayout.setAspectRatio(tL_documentAttributeVideo.f1671w / tL_documentAttributeVideo.f1670h, 0);
                    }
                }
        ...
        class C31921 extends VideoPlayerHolderBase {
            @Override // org.telegram.messenger.video.VideoPlayerHolderBase
            public boolean needRepeat() {
                return true;
            }
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            StringBuilder sb = new StringBuilder(LocaleController.getString(C2888R.string.AttachVideo));
            if (this.captionLayout != null) {
                sb.append(", ");
    ...
    class BlockAudioCell extends View implements DownloadController.FileDownloadProgressListener, TextSelectionHelper.ArticleSelectableView {
        ...
        public BlockAudioCell(Context context, WebpageAdapter webpageAdapter) {
            super(context);
            this.textY = AndroidUtilities.m1124dp(58.0f);
            this.parentAdapter = webpageAdapter;
            RadialProgress2 radialProgress2 = new RadialProgress2(this);
            this.radialProgress = radialProgress2;
            radialProgress2.setCircleRadius(AndroidUtilities.m1124dp(24.0f));
            this.TAG = DownloadController.getInstance(ArticleViewer.this.currentAccount).generateObserverTag();
        ...
        */
        public boolean onTouchEvent(android.view.MotionEvent r13) {
            ...
            L36:
                ...
                int r6 = org.telegram.messenger.AndroidUtilities.m1124dp(r5)
                int r2 = r2 + r6
                float r2 = (float) r2
                ...
                if (r2 < 0) goto L66
                int r2 = org.telegram.messenger.AndroidUtilities.m1124dp(r5)
                int r0 = r0 + r2
                float r0 = (float) r0
            ...
            L8f:
                ...
                r8 = r12
                r7 = r13
                boolean r13 = org.telegram.p029ui.ArticleViewer.m5960$$Nest$mcheckLayoutForLinks(r5, r6, r7, r8, r9, r10, r11)
                if (r13 != 0) goto Lc1
                org.telegram.ui.ArticleViewer r5 = org.telegram.p029ui.ArticleViewer.this
        ...
        protected void onMeasure(int i, int i2) {
            ...
            int size = View.MeasureSpec.getSize(i);
            int iM1124dp = AndroidUtilities.m1124dp(54.0f);
            TLRPC.TL_pageBlockAudio tL_pageBlockAudio = this.currentBlock;
            int i3 = 1;
            if (tL_pageBlockAudio != null) {
                if (tL_pageBlockAudio.level > 0) {
                    this.textX = AndroidUtilities.m1124dp(r0 * 14) + AndroidUtilities.m1124dp(18.0f);
                } else {
                    this.textX = AndroidUtilities.m1124dp(18.0f);
                }
                int iM1124dp2 = (size - this.textX) - AndroidUtilities.m1124dp(18.0f);
                int iM1124dp3 = AndroidUtilities.m1124dp(44.0f);
                this.buttonX = AndroidUtilities.m1124dp(16.0f);
                int iM1124dp4 = AndroidUtilities.m1124dp(5.0f);
                this.buttonY = iM1124dp4;
                RadialProgress2 radialProgress2 = this.radialProgress;
                int i4 = this.buttonX;
                radialProgress2.setProgressRect(i4, iM1124dp4, i4 + iM1124dp3, iM1124dp4 + iM1124dp3);
                ArticleViewer articleViewer = ArticleViewer.this;
                TLRPC.TL_pageBlockAudio tL_pageBlockAudio2 = this.currentBlock;
                DrawingText drawingTextCreateLayoutForText = articleViewer.createLayoutForText(this, null, tL_pageBlockAudio2.caption.text, iM1124dp2, this.textY, tL_pageBlockAudio2, this.parentAdapter);
                this.captionLayout = drawingTextCreateLayoutForText;
                if (drawingTextCreateLayoutForText != null) {
                    int iM1124dp5 = AndroidUtilities.m1124dp(8.0f) + this.captionLayout.getHeight();
                    this.creditOffset = iM1124dp5;
                    iM1124dp += iM1124dp5 + AndroidUtilities.m1124dp(8.0f);
                }
                int iM1124dp6 = iM1124dp;
                ArticleViewer articleViewer2 = ArticleViewer.this;
                TLRPC.TL_pageBlockAudio tL_pageBlockAudio3 = this.currentBlock;
                DrawingText drawingTextCreateLayoutForText2 = articleViewer2.createLayoutForText(this, null, tL_pageBlockAudio3.caption.credit, iM1124dp2, this.creditOffset + this.textY, tL_pageBlockAudio3, this.parentAdapter.isRtl ? StaticLayoutEx.ALIGN_RIGHT() : Layout.Alignment.ALIGN_NORMAL, this.parentAdapter);
                this.creditLayout = drawingTextCreateLayoutForText2;
                if (drawingTextCreateLayoutForText2 != null) {
                    iM1124dp6 += AndroidUtilities.m1124dp(4.0f) + this.creditLayout.getHeight();
                }
                if (!this.isFirst && this.currentBlock.level <= 0) {
                    iM1124dp6 += AndroidUtilities.m1124dp(8.0f);
                }
                ...
                int iM1124dp7 = this.buttonX + AndroidUtilities.m1124dp(50.0f) + iM1124dp3;
                this.seekBarX = iM1124dp7;
                int iM1124dp8 = (size - iM1124dp7) - AndroidUtilities.m1124dp(18.0f);
                if (!TextUtils.isEmpty(musicTitle) || !TextUtils.isEmpty(musicAuthor)) {
                    ...
                    CharSequence charSequenceEllipsize = TextUtils.ellipsize(spannableStringBuilder, Theme.chat_audioTitlePaint, iM1124dp8, TextUtils.TruncateAt.END);
                    DrawingText drawingText = ArticleViewer.this.new DrawingText();
                    this.titleLayout = drawingText;
                    drawingText.textLayout = new StaticLayout(charSequenceEllipsize, ArticleViewer.audioTimePaint, iM1124dp8, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                    this.titleLayout.parentBlock = this.currentBlock;
                    this.seekBarY = this.buttonY + ((iM1124dp3 - AndroidUtilities.m1124dp(30.0f)) / 2) + AndroidUtilities.m1124dp(11.0f);
                } else {
                    this.titleLayout = null;
                    this.seekBarY = this.buttonY + ((iM1124dp3 - AndroidUtilities.m1124dp(30.0f)) / 2);
                }
                this.seekBar.setSize(iM1124dp8, AndroidUtilities.m1124dp(30.0f));
                i3 = iM1124dp6;
            }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (this.durationLayout != null) {
                canvas.save();
                canvas.translate(this.buttonX + AndroidUtilities.m1124dp(54.0f), this.seekBarY + AndroidUtilities.m1124dp(6.0f));
                this.durationLayout.draw(canvas);
                canvas.restore();
            }
            if (this.titleLayout != null) {
                canvas.save();
                this.titleLayout.f1881x = this.buttonX + AndroidUtilities.m1124dp(54.0f);
                this.titleLayout.f1882y = this.seekBarY - AndroidUtilities.m1124dp(16.0f);
                DrawingText drawingText = this.titleLayout;
                canvas.translate(drawingText.f1881x, drawingText.f1882y);
                ArticleViewer.this.drawTextSelection(canvas, this, 0);
            ...
            if (this.captionLayout != null) {
                ...
                int i2 = this.textX;
                drawingText2.f1881x = i2;
                int i3 = this.textY;
                drawingText2.f1882y = i3;
            ...
            if (this.creditLayout != null) {
                ...
                int i4 = this.textX;
                drawingText3.f1881x = i4;
                drawingText3.f1882y = this.textY + this.creditOffset;
            ...
            if (this.currentBlock.level > 0) {
                canvas.drawRect(AndroidUtilities.m1124dp(18.0f), 0.0f, AndroidUtilities.m1124dp(20.0f), getMeasuredHeight() - (this.currentBlock.bottom ? AndroidUtilities.m1124dp(6.0f) : 0), ArticleViewer.quoteLinePaint);
            }
        }
        ...
        public void updatePlayingMessageProgress() {
            ...
            if (str == null || (str != null && !str.equals(shortDuration))) {
                ...
                ArticleViewer.audioTimePaint.setTextSize(AndroidUtilities.m1124dp(16.0f));
    ...
    private class BlockEmbedPostCell extends View implements TextSelectionHelper.ArticleSelectableView {
        ...
        public BlockEmbedPostCell(Context context, WebpageAdapter webpageAdapter) {
            ...
            imageReceiver.setRoundRadius(AndroidUtilities.m1124dp(20.0f));
            this.avatarImageView.setImageCoords(AndroidUtilities.m1124dp(32.0f), AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(40.0f), AndroidUtilities.m1124dp(40.0f));
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (tL_pageBlockEmbedPost != null) {
                if (tL_pageBlockEmbedPost instanceof TL_pageBlockEmbedPostCaption) {
                    this.textX = AndroidUtilities.m1124dp(18.0f);
                    this.textY = AndroidUtilities.m1124dp(4.0f);
                    int iM1124dp = size - AndroidUtilities.m1124dp(50.0f);
                    ArticleViewer articleViewer = ArticleViewer.this;
                    TLRPC.TL_pageBlockEmbedPost tL_pageBlockEmbedPost2 = this.currentBlock;
                    DrawingText drawingTextCreateLayoutForText = articleViewer.createLayoutForText(this, null, tL_pageBlockEmbedPost2.caption.text, iM1124dp, this.textY, tL_pageBlockEmbedPost2, this.parentAdapter);
                    this.captionLayout = drawingTextCreateLayoutForText;
                    if (drawingTextCreateLayoutForText != null) {
                        int iM1124dp2 = AndroidUtilities.m1124dp(4.0f) + this.captionLayout.getHeight();
                        this.creditOffset = iM1124dp2;
                        iM1124dp = iM1124dp2 + AndroidUtilities.m1124dp(4.0f);
                    }
                    ArticleViewer articleViewer2 = ArticleViewer.this;
                    TLRPC.TL_pageBlockEmbedPost tL_pageBlockEmbedPost3 = this.currentBlock;
                    DrawingText drawingTextCreateLayoutForText2 = articleViewer2.createLayoutForText(this, null, tL_pageBlockEmbedPost3.caption.credit, iM1124dp, this.creditOffset + this.textY, tL_pageBlockEmbedPost3, this.parentAdapter.isRtl ? StaticLayoutEx.ALIGN_RIGHT() : Layout.Alignment.ALIGN_NORMAL, this.parentAdapter);
                    this.creditLayout = drawingTextCreateLayoutForText2;
                    if (drawingTextCreateLayoutForText2 != null) {
                        iM1124dp += AndroidUtilities.m1124dp(4.0f) + this.creditLayout.getHeight();
                    }
                    i3 = iM1124dp;
                } else {
                    ...
                    if (z) {
                        ...
                        if (z2) {
                            ...
                            this.avatarImageView.setImage(ImageLocation.getForPhoto(FileLoader.getClosestPhotoSizeWithSize(photoWithId.sizes, AndroidUtilities.m1124dp(40.0f), true), photoWithId), "40_40", this.avatarDrawable, 0L, (String) null, this.parentAdapter.currentPage, 1);
                        }
                    }
                    ArticleViewer articleViewer3 = ArticleViewer.this;
                    String str = this.currentBlock.author;
                    int iM1124dp3 = size - AndroidUtilities.m1124dp((this.avatarVisible ? 54 : 0) + 50);
                    TLRPC.TL_pageBlockEmbedPost tL_pageBlockEmbedPost4 = this.currentBlock;
                    Layout.Alignment alignment = Layout.Alignment.ALIGN_NORMAL;
                    DrawingText drawingTextCreateLayoutForText3 = articleViewer3.createLayoutForText(this, str, null, iM1124dp3, 0, tL_pageBlockEmbedPost4, alignment, 1, this.parentAdapter);
                    this.nameLayout = drawingTextCreateLayoutForText3;
                    if (drawingTextCreateLayoutForText3 != null) {
                        drawingTextCreateLayoutForText3.f1881x = AndroidUtilities.m1124dp((this.avatarVisible ? 54 : 0) + 32);
                        this.nameLayout.f1882y = AndroidUtilities.m1124dp(this.dateLayout != null ? 10.0f : 19.0f);
                    }
                    if (this.currentBlock.date != 0) {
                        this.dateLayout = ArticleViewer.this.createLayoutForText(this, LocaleController.getInstance().getChatFullDate().format(((long) this.currentBlock.date) * 1000), null, size - AndroidUtilities.m1124dp((this.avatarVisible ? 54 : 0) + 50), AndroidUtilities.m1124dp(29.0f), this.currentBlock, this.parentAdapter);
                    } else {
                        this.dateLayout = null;
                    }
                    int iM1124dp4 = AndroidUtilities.m1124dp(56.0f);
                    if (this.currentBlock.blocks.isEmpty()) {
                        this.textX = AndroidUtilities.m1124dp(32.0f);
                        this.textY = AndroidUtilities.m1124dp(56.0f);
                        int iM1124dp5 = size - AndroidUtilities.m1124dp(50.0f);
                        ArticleViewer articleViewer4 = ArticleViewer.this;
                        TLRPC.TL_pageBlockEmbedPost tL_pageBlockEmbedPost5 = this.currentBlock;
                        DrawingText drawingTextCreateLayoutForText4 = articleViewer4.createLayoutForText(this, null, tL_pageBlockEmbedPost5.caption.text, iM1124dp5, this.textY, tL_pageBlockEmbedPost5, this.parentAdapter);
                        this.captionLayout = drawingTextCreateLayoutForText4;
                        if (drawingTextCreateLayoutForText4 != null) {
                            int iM1124dp6 = AndroidUtilities.m1124dp(4.0f) + this.captionLayout.getHeight();
                            this.creditOffset = iM1124dp6;
                            iM1124dp4 += iM1124dp6 + AndroidUtilities.m1124dp(4.0f);
                        }
                        ArticleViewer articleViewer5 = ArticleViewer.this;
                        TLRPC.TL_pageBlockEmbedPost tL_pageBlockEmbedPost6 = this.currentBlock;
                        DrawingText drawingTextCreateLayoutForText5 = articleViewer5.createLayoutForText(this, null, tL_pageBlockEmbedPost6.caption.credit, iM1124dp5, this.creditOffset + this.textY, tL_pageBlockEmbedPost6, this.parentAdapter.isRtl ? StaticLayoutEx.ALIGN_RIGHT() : alignment, this.parentAdapter);
                        this.creditLayout = drawingTextCreateLayoutForText5;
                        if (drawingTextCreateLayoutForText5 != null) {
                            iM1124dp4 += AndroidUtilities.m1124dp(4.0f) + this.creditLayout.getHeight();
                        }
                    } else {
                    ...
                    if (drawingText != null) {
                        drawingText.f1881x = AndroidUtilities.m1124dp((this.avatarVisible ? 54 : 0) + 32);
                        this.dateLayout.f1882y = AndroidUtilities.m1124dp(29.0f);
                    }
                    DrawingText drawingText2 = this.captionLayout;
                    if (drawingText2 != null) {
                        drawingText2.f1881x = this.textX;
                        drawingText2.f1882y = this.textY;
                    }
                    DrawingText drawingText3 = this.creditLayout;
                    if (drawingText3 != null) {
                        drawingText3.f1881x = this.textX;
                        drawingText3.f1882y = this.textY;
                    }
                    i3 = iM1124dp4;
                }
                this.lineHeight = i3;
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (tL_pageBlockEmbedPost instanceof TL_pageBlockEmbedPostCaption) {
                ...
                if (this.nameLayout != null) {
                    canvas.save();
                    canvas.translate(AndroidUtilities.m1124dp((this.avatarVisible ? 54 : 0) + 32), AndroidUtilities.m1124dp(this.dateLayout != null ? 10.0f : 19.0f));
                    ArticleViewer.this.drawTextSelection(canvas, this, 0);
                ...
                if (this.dateLayout != null) {
                    canvas.save();
                    canvas.translate(AndroidUtilities.m1124dp((this.avatarVisible ? 54 : 0) + 32), AndroidUtilities.m1124dp(29.0f));
                    ArticleViewer.this.drawTextSelection(canvas, this, i);
                ...
                canvas2 = canvas;
                canvas2.drawRect(AndroidUtilities.m1124dp(18.0f), AndroidUtilities.m1124dp(6.0f), AndroidUtilities.m1124dp(20.0f), this.lineHeight - (this.currentBlock.level == 0 ? AndroidUtilities.m1124dp(6.0f) : 0), ArticleViewer.quoteLinePaint);
                i = i;
            }
            if (this.captionLayout != null) {
                canvas2.save();
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (tL_pageBlockParagraph != null) {
                ...
                if (tL_pageBlockParagraph.level == 0) {
                    this.textY = AndroidUtilities.m1124dp(8.0f);
                    this.textX = AndroidUtilities.m1124dp(18.0f);
                } else {
                    this.textY = 0;
                    this.textX = AndroidUtilities.m1124dp((r15 * 14) + 18);
                }
                DrawingText drawingTextCreateLayoutForText = ArticleViewer.this.createLayoutForText(this, null, this.currentBlock.text, (size - AndroidUtilities.m1124dp(18.0f)) - this.textX, this.textY, this.currentBlock, this.parentAdapter.isRtl ? StaticLayoutEx.ALIGN_RIGHT() : Layout.Alignment.ALIGN_NORMAL, 0, this.parentAdapter);
                this.textLayout = drawingTextCreateLayoutForText;
                if (drawingTextCreateLayoutForText != null) {
                    int height = drawingTextCreateLayoutForText.getHeight();
                    if (this.currentBlock.level > 0) {
                        iM1124dp = AndroidUtilities.m1124dp(8.0f);
                    } else {
                        iM1124dp = AndroidUtilities.m1124dp(16.0f);
                    }
                    i3 = height + iM1124dp;
                    DrawingText drawingText = this.textLayout;
                    drawingText.f1881x = this.textX;
                    drawingText.f1882y = this.textY;
                }
            } else {
                i3 = 1;
            }
    ...
    class BlockEmbedCell extends FrameLayout implements TextSelectionHelper.ArticleSelectableView {
        ...
        public BlockEmbedCell(Context context, WebpageAdapter webpageAdapter) {
            ...
            if (Looper.myLooper() == Looper.getMainLooper()) {
                WebPlayerView webPlayerView = new WebPlayerView(context, false, false, new WebPlayerView.WebPlayerViewDelegate() { // from class: org.telegram.ui.ArticleViewer.BlockEmbedCell.1
                    ...
                    C31811(ArticleViewer articleViewer) {
                        articleViewer = articleViewer;
                    }
                ...
                touchyWebView.setWebChromeClient(new C31822(ArticleViewer.this));
                touchyWebView.setWebViewClient(new C31833(ArticleViewer.this));
        ...
        class C31811 implements WebPlayerView.WebPlayerViewDelegate {
            final /* synthetic */ ArticleViewer val$this$0;
        ...
        class C31822 extends WebChromeClient {
            final /* synthetic */ ArticleViewer val$this$0;

            C31822(ArticleViewer articleViewer) {
        ...
        class C31833 extends WebViewClient {
            final /* synthetic */ ArticleViewer val$this$0;

            C31833(ArticleViewer articleViewer) {
                this.val$this$0 = articleViewer;
            }
            ...
            public boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
                try {
                    ...
                    new AlertDialog.Builder(BlockEmbedCell.this.getContext(), null).setTitle(LocaleController.getString(C2888R.string.ChromeCrashTitle)).setMessage(AndroidUtilities.replaceSingleTag(LocaleController.getString(C2888R.string.ChromeCrashMessage), new Runnable() { // from class: org.telegram.ui.ArticleViewer$BlockEmbedCell$3$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
    ...
    public class BlockTableCell extends FrameLayout implements TableLayout.TableLayoutDelegate, TextSelectionHelper.ArticleSelectableView {
        ...
        public BlockTableCell(Context context, WebpageAdapter webpageAdapter) {
            super(context);
            this.parentAdapter = webpageAdapter;
            C31911 c31911 = new HorizontalScrollView(context) { // from class: org.telegram.ui.ArticleViewer.BlockTableCell.1
                final /* synthetic */ ArticleViewer val$this$0;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C31911(Context context2, ArticleViewer articleViewer) {
                    super(context2);
                    articleViewer = articleViewer;
                }
                ...
                public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
                    ...
                    if (BlockTableCell.this.tableLayout.getMeasuredWidth() > getMeasuredWidth() - AndroidUtilities.m1124dp(36.0f) && zOnInterceptTouchEvent) {
                        ArticleViewer.this.windowView.requestDisallowInterceptTouchEvent(true);
                    }
                ...
                public boolean onTouchEvent(MotionEvent motionEvent) {
                    if (BlockTableCell.this.tableLayout.getMeasuredWidth() <= getMeasuredWidth() - AndroidUtilities.m1124dp(36.0f)) {
                        return false;
                    }
                    return super.onTouchEvent(motionEvent);
                }
            ...
            this.scrollView = c31911;
            c31911.setPadding(AndroidUtilities.m1124dp(18.0f), 0, AndroidUtilities.m1124dp(18.0f), 0);
        ...
        class C31911 extends HorizontalScrollView {
            final /* synthetic */ ArticleViewer val$this$0;
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (tL_pageBlockTable != null) {
                if (tL_pageBlockTable.level > 0) {
                    int iM1124dp2 = AndroidUtilities.m1124dp(r14 * 14);
                    this.listX = iM1124dp2;
                    iM1124dp = iM1124dp2 + AndroidUtilities.m1124dp(18.0f);
                    this.textX = iM1124dp;
                } else {
                    this.listX = 0;
                    this.textX = AndroidUtilities.m1124dp(18.0f);
                    iM1124dp = AndroidUtilities.m1124dp(36.0f);
                }
                int i3 = size - iM1124dp;
                ArticleViewer articleViewer = ArticleViewer.this;
                ...
                if (drawingTextCreateLayoutForText != null) {
                    this.textY = 0;
                    height = drawingTextCreateLayoutForText.getHeight() + AndroidUtilities.m1124dp(8.0f);
                    this.listY = height;
                    DrawingText drawingText = this.titleLayout;
                    drawingText.f1881x = this.textX;
                    drawingText.f1882y = this.textY;
                } else {
                    this.listY = AndroidUtilities.m1124dp(8.0f);
                    height = 0;
                }
                ...
                measuredHeight = height + this.scrollView.getMeasuredHeight() + AndroidUtilities.m1124dp(8.0f);
                TLRPC.TL_pageBlockTable tL_pageBlockTable3 = this.currentBlock;
                if (tL_pageBlockTable3.level > 0 && !tL_pageBlockTable3.bottom) {
                    measuredHeight += AndroidUtilities.m1124dp(8.0f);
                }
            } else {
                measuredHeight = 1;
            }
        ...
        public void updateChildTextPositions() {
            ...
            for (int i2 = 0; i2 < childCount; i2++) {
                ...
                if (drawingText != null) {
                    drawingText.f1881x = ((childAt.getTextX() + this.listX) + AndroidUtilities.m1124dp(18.0f)) - this.scrollView.getScrollX();
                    childAt.textLayout.f1882y = childAt.getTextY() + this.listY;
        ...
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            ...
            if (this.firstLayout) {
                if (this.parentAdapter.isRtl) {
                    this.scrollView.setScrollX((this.tableLayout.getMeasuredWidth() - this.scrollView.getMeasuredWidth()) + AndroidUtilities.m1124dp(36.0f));
                } else {
    ...
    private class BlockCollageCell extends FrameLayout implements TextSelectionHelper.ArticleSelectableView {
        ...
        public class GroupedMessages {
            ...
            /* JADX WARN: Removed duplicated region for block: B:340:0x0545  */
            /*
                Code decompiled incorrectly, please refer to instructions dump.
                To view partially-correct code enable 'Show inconsistent code' option in preferences
            */
        ...
        public BlockCollageCell(Context context, WebpageAdapter webpageAdapter) {
            ...
            this.parentAdapter = webpageAdapter;
            C31761 c31761 = new RecyclerListView(context) { // from class: org.telegram.ui.ArticleViewer.BlockCollageCell.1
                final /* synthetic */ ArticleViewer val$this$0;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C31761(Context context2, ArticleViewer articleViewer) {
                    super(context2);
                    articleViewer = articleViewer;
                }
            ...
            this.innerListView = c31761;
            c31761.addItemDecoration(new RecyclerView.ItemDecoration() { // from class: org.telegram.ui.ArticleViewer.BlockCollageCell.2
                final /* synthetic */ ArticleViewer val$this$0;

                C31772(ArticleViewer articleViewer) {
                    articleViewer = articleViewer;
                }
                    ...
                    while (true) {
                        if (i < size) {
                            ...
                            if (b == b2 && ((groupedMessagePosition2.minX != groupedMessagePosition.minX || groupedMessagePosition2.maxX != groupedMessagePosition.maxX || b != b2 || groupedMessagePosition2.maxY != groupedMessagePosition.maxY) && b == b2)) {
                                iDp2 -= ((int) Math.ceil(fMax * groupedMessagePosition2.f1597ph)) - AndroidUtilities.m1124dp(4.0f);
                                break;
                            }
                            i++;
                        } else {
            ...
            C31783 c31783 = new GridLayoutManagerFixed(context2, MediaDataController.MAX_STYLE_RUNS_COUNT, 1, true) { // from class: org.telegram.ui.ArticleViewer.BlockCollageCell.3
                final /* synthetic */ ArticleViewer val$this$0;
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C31783(Context context2, int i, int i2, boolean z, ArticleViewer articleViewer) {
            ...
            c31783.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() { // from class: org.telegram.ui.ArticleViewer.BlockCollageCell.4
                final /* synthetic */ ArticleViewer val$this$0;

                C31794(ArticleViewer articleViewer) {
                    articleViewer = articleViewer;
                }
            ...
            this.innerListView.setLayoutManager(c31783);
            RecyclerListView recyclerListView = this.innerListView;
            C31805 c31805 = new RecyclerView.Adapter() { // from class: org.telegram.ui.ArticleViewer.BlockCollageCell.5
                final /* synthetic */ ArticleViewer val$this$0;

                C31805(ArticleViewer articleViewer) {
                    articleViewer = articleViewer;
                }
            ...
            this.innerAdapter = c31805;
            recyclerListView.setAdapter(c31805);
        ...
        class C31761 extends RecyclerListView {
            final /* synthetic */ ArticleViewer val$this$0;
        ...
        class C31772 extends RecyclerView.ItemDecoration {
            final /* synthetic */ ArticleViewer val$this$0;
        ...
        class C31783 extends GridLayoutManagerFixed {
            final /* synthetic */ ArticleViewer val$this$0;
        ...
        class C31794 extends GridLayoutManager.SpanSizeLookup {
            final /* synthetic */ ArticleViewer val$this$0;
        ...
        class C31805 extends RecyclerView.Adapter {
            final /* synthetic */ ArticleViewer val$this$0;
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (tL_pageBlockCollage != null) {
                if (tL_pageBlockCollage.level > 0) {
                    int iM1124dp4 = AndroidUtilities.m1124dp(r14 * 14) + AndroidUtilities.m1124dp(18.0f);
                    this.listX = iM1124dp4;
                    this.textX = iM1124dp4;
                    iM1124dp2 = size - (iM1124dp4 + AndroidUtilities.m1124dp(18.0f));
                    iM1124dp = iM1124dp2;
                } else {
                    this.listX = 0;
                    this.textX = AndroidUtilities.m1124dp(18.0f);
                    iM1124dp = size - AndroidUtilities.m1124dp(36.0f);
                    iM1124dp2 = size;
                }
                this.innerListView.measure(View.MeasureSpec.makeMeasureSpec(iM1124dp2, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(0, 0));
                int measuredHeight = this.innerListView.getMeasuredHeight();
                int iM1124dp5 = measuredHeight + AndroidUtilities.m1124dp(8.0f);
                this.textY = iM1124dp5;
                ArticleViewer articleViewer = ArticleViewer.this;
                TLRPC.TL_pageBlockCollage tL_pageBlockCollage2 = this.currentBlock;
                blockCollageCell = this;
                DrawingText drawingTextCreateLayoutForText = articleViewer.createLayoutForText(blockCollageCell, null, tL_pageBlockCollage2.caption.text, iM1124dp, iM1124dp5, tL_pageBlockCollage2, this.parentAdapter);
                blockCollageCell.captionLayout = drawingTextCreateLayoutForText;
                if (drawingTextCreateLayoutForText != null) {
                    int iM1124dp6 = AndroidUtilities.m1124dp(4.0f) + blockCollageCell.captionLayout.getHeight();
                    blockCollageCell.creditOffset = iM1124dp6;
                    measuredHeight += iM1124dp6 + AndroidUtilities.m1124dp(4.0f);
                    DrawingText drawingText = blockCollageCell.captionLayout;
                    drawingText.f1881x = blockCollageCell.textX;
                    drawingText.f1882y = blockCollageCell.textY;
                } else {
                    blockCollageCell.creditOffset = 0;
                }
                ArticleViewer articleViewer2 = ArticleViewer.this;
                TLRPC.TL_pageBlockCollage tL_pageBlockCollage3 = blockCollageCell.currentBlock;
                DrawingText drawingTextCreateLayoutForText2 = articleViewer2.createLayoutForText(blockCollageCell, null, tL_pageBlockCollage3.caption.credit, iM1124dp, blockCollageCell.creditOffset + blockCollageCell.textY, tL_pageBlockCollage3, blockCollageCell.parentAdapter.isRtl ? StaticLayoutEx.ALIGN_RIGHT() : Layout.Alignment.ALIGN_NORMAL, blockCollageCell.parentAdapter);
                blockCollageCell.creditLayout = drawingTextCreateLayoutForText2;
                if (drawingTextCreateLayoutForText2 != null) {
                    measuredHeight += AndroidUtilities.m1124dp(4.0f) + blockCollageCell.creditLayout.getHeight();
                    DrawingText drawingText2 = blockCollageCell.creditLayout;
                    drawingText2.f1881x = blockCollageCell.textX;
                    drawingText2.f1882y = blockCollageCell.textY + blockCollageCell.creditOffset;
                }
                iM1124dp3 = measuredHeight + AndroidUtilities.m1124dp(16.0f);
                ...
                if (tL_pageBlockCollage4.level > 0 && !tL_pageBlockCollage4.bottom) {
                    iM1124dp3 += AndroidUtilities.m1124dp(8.0f);
                }
            } else {
                blockCollageCell = this;
            }
            setMeasuredDimension(size, iM1124dp3);
            blockCollageCell.inLayout = false;
        }

        @Override // android.widget.FrameLayout, android.view.ViewGroup, android.view.View
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            this.innerListView.layout(this.listX, AndroidUtilities.m1124dp(8.0f), this.listX + this.innerListView.getMeasuredWidth(), this.innerListView.getMeasuredHeight() + AndroidUtilities.m1124dp(8.0f));
        }
    ...
    private class BlockSlideshowCell extends FrameLayout implements TextSelectionHelper.ArticleSelectableView {
        ...
        public BlockSlideshowCell(Context context, WebpageAdapter webpageAdapter) {
            ...
            C31871 c31871 = new ViewPager(context) { // from class: org.telegram.ui.ArticleViewer.BlockSlideshowCell.1
                final /* synthetic */ ArticleViewer val$this$0;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C31871(Context context2, ArticleViewer articleViewer) {
                    super(context2);
                    articleViewer = articleViewer;
                }
            ...
            this.innerListView = c31871;
            c31871.addOnPageChangeListener(new ViewPager.OnPageChangeListener() { // from class: org.telegram.ui.ArticleViewer.BlockSlideshowCell.2
                final /* synthetic */ ArticleViewer val$this$0;
                ...
                C31882(ArticleViewer articleViewer) {
                    articleViewer = articleViewer;
                }
            ...
            C31893 c31893 = new PagerAdapter() { // from class: org.telegram.ui.ArticleViewer.BlockSlideshowCell.3
                final /* synthetic */ ArticleViewer val$this$0;

                C31893(ArticleViewer articleViewer) {
                    articleViewer = articleViewer;
                }
            ...
            this.innerAdapter = c31893;
            viewPager.setAdapter(c31893);
            ...
            C31904 c31904 = new View(context2) { // from class: org.telegram.ui.ArticleViewer.BlockSlideshowCell.4
                final /* synthetic */ ArticleViewer val$this$0;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C31904(Context context2, ArticleViewer articleViewer) {
                    super(context2);
                    articleViewer = articleViewer;
                }
                ...
                protected void onDraw(Canvas canvas) {
                    ...
                    int iM1124dp = (AndroidUtilities.m1124dp(7.0f) * count) + ((count - 1) * AndroidUtilities.m1124dp(6.0f)) + AndroidUtilities.m1124dp(4.0f);
                    if (iM1124dp < getMeasuredWidth()) {
                        measuredWidth = (getMeasuredWidth() - iM1124dp) / 2;
                    } else {
                        int iM1124dp2 = AndroidUtilities.m1124dp(4.0f);
                        int iM1124dp3 = AndroidUtilities.m1124dp(13.0f);
                        int measuredWidth2 = ((getMeasuredWidth() - AndroidUtilities.m1124dp(8.0f)) / 2) / iM1124dp3;
                        int i2 = (count - measuredWidth2) - 1;
                        if (BlockSlideshowCell.this.currentPage == i2 && BlockSlideshowCell.this.pageOffset < 0.0f) {
                            measuredWidth = iM1124dp2 - (((int) (BlockSlideshowCell.this.pageOffset * iM1124dp3)) + (((count - (measuredWidth2 * 2)) - 1) * iM1124dp3));
                        } else {
                            if (BlockSlideshowCell.this.currentPage >= i2) {
                                i = ((count - (measuredWidth2 * 2)) - 1) * iM1124dp3;
                            } else if (BlockSlideshowCell.this.currentPage > measuredWidth2) {
                                i = ((int) (BlockSlideshowCell.this.pageOffset * iM1124dp3)) + ((BlockSlideshowCell.this.currentPage - measuredWidth2) * iM1124dp3);
                            } else if (BlockSlideshowCell.this.currentPage != measuredWidth2 || BlockSlideshowCell.this.pageOffset <= 0.0f) {
                                measuredWidth = iM1124dp2;
                            } else {
                                i = (int) (BlockSlideshowCell.this.pageOffset * iM1124dp3);
                            }
                            measuredWidth = iM1124dp2 - i;
                        }
                    }
                    int i3 = 0;
                    while (i3 < BlockSlideshowCell.this.currentBlock.items.size()) {
                        int iM1124dp4 = AndroidUtilities.m1124dp(4.0f) + measuredWidth + (AndroidUtilities.m1124dp(13.0f) * i3);
                        ...
                        drawable.setBounds(iM1124dp4 - AndroidUtilities.m1124dp(5.0f), 0, iM1124dp4 + AndroidUtilities.m1124dp(5.0f), AndroidUtilities.m1124dp(10.0f));
                        drawable.draw(canvas);
                        i3++;
                    }
                }
            };
            this.dotsContainer = c31904;
            addView(c31904);
            setWillNotDraw(false);
        }

        /* JADX INFO: renamed from: org.telegram.ui.ArticleViewer$BlockSlideshowCell$1 */
        class C31871 extends ViewPager {
            final /* synthetic */ ArticleViewer val$this$0;
        ...
        class C31882 implements ViewPager.OnPageChangeListener {
            final /* synthetic */ ArticleViewer val$this$0;
        ...
        class C31893 extends PagerAdapter {
            final /* synthetic */ ArticleViewer val$this$0;
        ...
        protected void onMeasure(int i, int i2) {
            ...
            int size = View.MeasureSpec.getSize(i);
            if (this.currentBlock != null) {
                int iM1124dp2 = AndroidUtilities.m1124dp(310.0f);
                this.innerListView.measure(View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(iM1124dp2, TLObject.FLAG_30));
                this.currentBlock.items.size();
                this.dotsContainer.measure(View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(10.0f), TLObject.FLAG_30));
                int iM1124dp3 = size - AndroidUtilities.m1124dp(36.0f);
                int iM1124dp4 = iM1124dp2 + AndroidUtilities.m1124dp(16.0f);
                this.textY = iM1124dp4;
                ArticleViewer articleViewer = ArticleViewer.this;
                TLRPC.TL_pageBlockSlideshow tL_pageBlockSlideshow = this.currentBlock;
                DrawingText drawingTextCreateLayoutForText = articleViewer.createLayoutForText(this, null, tL_pageBlockSlideshow.caption.text, iM1124dp3, iM1124dp4, tL_pageBlockSlideshow, this.parentAdapter);
                this.captionLayout = drawingTextCreateLayoutForText;
                if (drawingTextCreateLayoutForText != null) {
                    int iM1124dp5 = AndroidUtilities.m1124dp(4.0f) + this.captionLayout.getHeight();
                    this.creditOffset = iM1124dp5;
                    iM1124dp2 += iM1124dp5 + AndroidUtilities.m1124dp(4.0f);
                    DrawingText drawingText = this.captionLayout;
                    drawingText.f1881x = this.textX;
                    drawingText.f1882y = this.textY;
                } else {
                ...
                DrawingText drawingTextCreateLayoutForText2 = articleViewer2.createLayoutForText(this, null, tL_pageBlockSlideshow2.caption.credit, iM1124dp3, this.creditOffset + this.textY, tL_pageBlockSlideshow2, this.parentAdapter.isRtl ? StaticLayoutEx.ALIGN_RIGHT() : Layout.Alignment.ALIGN_NORMAL, this.parentAdapter);
                this.creditLayout = drawingTextCreateLayoutForText2;
                if (drawingTextCreateLayoutForText2 != null) {
                    iM1124dp2 += AndroidUtilities.m1124dp(4.0f) + this.creditLayout.getHeight();
                    DrawingText drawingText2 = this.creditLayout;
                    drawingText2.f1881x = this.textX;
                    drawingText2.f1882y = this.textY + this.creditOffset;
                }
                iM1124dp = iM1124dp2 + AndroidUtilities.m1124dp(16.0f);
            } else {
                iM1124dp = 1;
            }
        ...
        @Override // android.widget.FrameLayout, android.view.ViewGroup, android.view.View
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            this.innerListView.layout(0, AndroidUtilities.m1124dp(8.0f), this.innerListView.getMeasuredWidth(), AndroidUtilities.m1124dp(8.0f) + this.innerListView.getMeasuredHeight());
            int bottom = this.innerListView.getBottom() - AndroidUtilities.m1124dp(23.0f);
    ...
    private class BlockListItemCell extends ViewGroup implements TextSelectionHelper.ArticleSelectableView {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (tL_pageBlockListItem != null) {
                ...
                int i4 = 0;
                this.textY = (tL_pageBlockListItem.index == 0 && this.currentBlock.parent.level == 0) ? AndroidUtilities.m1124dp(10.0f) : 0;
                this.numOffsetY = 0;
                if (this.currentBlock.parent.lastMaxNumCalcWidth != size || this.currentBlock.parent.lastFontSize != SharedConfig.ivFontSize) {
                    ...
                    for (int i5 = 0; i5 < size2; i5++) {
                        ...
                        if (tL_pageBlockListItem2.num != null) {
                            tL_pageBlockListItem2.numLayout = ArticleViewer.this.createLayoutForText(this, tL_pageBlockListItem2.num, null, size - AndroidUtilities.m1124dp(54.0f), this.textY, this.currentBlock, this.parentAdapter);
                ...
                if (this.parentAdapter.isRtl) {
                    ...
                    this.textX = AndroidUtilities.m1124dp(24.0f) + this.currentBlock.parent.maxNumWidth + (this.currentBlock.parent.level * AndroidUtilities.m1124dp(12.0f));
                }
                int iM1124dp5 = (size - AndroidUtilities.m1124dp(18.0f)) - this.textX;
                if (this.parentAdapter.isRtl) {
                    iM1124dp5 -= (AndroidUtilities.m1124dp(6.0f) + this.currentBlock.parent.maxNumWidth) + (this.currentBlock.parent.level * AndroidUtilities.m1124dp(12.0f));
                }
                int iM1124dp6 = iM1124dp5;
                if (this.currentBlock.textItem != null) {
                    DrawingText drawingTextCreateLayoutForText = ArticleViewer.this.createLayoutForText(this, null, this.currentBlock.textItem, iM1124dp6, this.textY, this.currentBlock, this.parentAdapter.isRtl ? StaticLayoutEx.ALIGN_RIGHT() : Layout.Alignment.ALIGN_NORMAL, this.parentAdapter);
                    this.textLayout = drawingTextCreateLayoutForText;
                    if (drawingTextCreateLayoutForText != null && drawingTextCreateLayoutForText.getLineCount() > 0) {
                        if (this.currentBlock.numLayout != null && this.currentBlock.numLayout.getLineCount() > 0) {
                            this.numOffsetY = (this.currentBlock.numLayout.getLineAscent(0) + AndroidUtilities.m1124dp(2.5f)) - this.textLayout.getLineAscent(0);
                        }
                        measuredHeight = this.textLayout.getHeight();
                        iM1124dp = AndroidUtilities.m1124dp(8.0f);
                        iM1124dp4 = measuredHeight + iM1124dp;
                    }
                    iM1124dp4 = 0;
                } else {
                    if (this.currentBlock.blockItem != null) {
                        ...
                        if (viewHolder != null) {
                            ...
                            if (view instanceof BlockParagraphCell) {
                                this.blockY = i6 - AndroidUtilities.m1124dp(8.0f);
                                if (!this.parentAdapter.isRtl) {
                                    this.blockX -= AndroidUtilities.m1124dp(18.0f);
                                }
                                iM1124dp6 += AndroidUtilities.m1124dp(18.0f);
                                iM1124dp3 = 0 - AndroidUtilities.m1124dp(8.0f);
                            } else {
                                if ((view instanceof BlockHeaderCell) || (view instanceof BlockSubheaderCell) || (view instanceof BlockTitleCell) || (view instanceof BlockSubtitleCell)) {
                                    ...
                                    iM1124dp2 = AndroidUtilities.m1124dp(18.0f);
                                } else if (ArticleViewer.this.isListItemBlock(this.currentBlock.blockItem)) {
                                    this.blockX = 0;
                                    this.blockY = 0;
                                    this.textY = 0;
                                    iM1124dp3 = ((this.currentBlock.index == 0 && this.currentBlock.parent.level == 0) ? 0 - AndroidUtilities.m1124dp(10.0f) : 0) - AndroidUtilities.m1124dp(8.0f);
                                    iM1124dp6 = size;
                                } else {
                                    if (this.blockLayout.itemView instanceof BlockTableCell) {
                                        this.blockX -= AndroidUtilities.m1124dp(18.0f);
                                        iM1124dp2 = AndroidUtilities.m1124dp(36.0f);
                                    }
                                    iM1124dp3 = 0;
                                }
                                iM1124dp6 += iM1124dp2;
                            ...
                            this.blockLayout.itemView.measure(View.MeasureSpec.makeMeasureSpec(iM1124dp6, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(0, 0));
                            if ((this.blockLayout.itemView instanceof BlockParagraphCell) && this.currentBlock.numLayout != null && this.currentBlock.numLayout.getLineCount() > 0 && (drawingText = (blockParagraphCell = (BlockParagraphCell) this.blockLayout.itemView).textLayout) != null && drawingText.getLineCount() > 0) {
                                this.numOffsetY = (this.currentBlock.numLayout.getLineAscent(0) + AndroidUtilities.m1124dp(2.5f)) - blockParagraphCell.textLayout.getLineAscent(0);
                            }
                            if (this.currentBlock.blockItem instanceof TLRPC.TL_pageBlockDetails) {
                                ...
                                if (this.currentBlock.index == 0 && this.currentBlock.parent.level == 0) {
                                    iM1124dp3 -= AndroidUtilities.m1124dp(10.0f);
                                }
                                iM1124dp3 -= AndroidUtilities.m1124dp(8.0f);
                            } else {
                            ...
                            if (this.verticalAlign && this.currentBlock.numLayout != null) {
                                this.textY = ((this.blockLayout.itemView.getMeasuredHeight() - this.currentBlock.numLayout.getHeight()) / 2) - AndroidUtilities.m1124dp(4.0f);
                                this.drawDot = false;
                            }
                            measuredHeight = iM1124dp3 + this.blockLayout.itemView.getMeasuredHeight();
                        } else {
                            measuredHeight = 0;
                        }
                        iM1124dp = AndroidUtilities.m1124dp(8.0f);
                ...
                if (this.currentBlock.parent.items.get(this.currentBlock.parent.items.size() - 1) == this.currentBlock) {
                    iM1124dp4 += AndroidUtilities.m1124dp(8.0f);
                }
                if (this.currentBlock.index == 0 && this.currentBlock.parent.level == 0) {
                    iM1124dp4 += AndroidUtilities.m1124dp(10.0f);
                }
                i3 = iM1124dp4;
                ...
                if (viewHolder2 != null && (viewHolder2.itemView instanceof TextSelectionHelper.ArticleSelectableView)) {
                    ...
                    while (i4 < size3) {
                        ...
                        if (textLayoutBlock instanceof DrawingText) {
                            ...
                            drawingText3.f1881x += this.blockX;
                            drawingText3.f1882y += this.blockY;
                        }
                    }
                }
            }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (this.currentBlock.numLayout != null) {
                canvas.save();
                if (this.parentAdapter.isRtl) {
                    canvas.translate(((measuredWidth - AndroidUtilities.m1124dp(15.0f)) - this.currentBlock.parent.maxNumWidth) - (this.currentBlock.parent.level * AndroidUtilities.m1124dp(12.0f)), (this.textY + this.numOffsetY) - (this.drawDot ? AndroidUtilities.m1124dp(1.0f) : 0));
                } else {
                    canvas.translate(((AndroidUtilities.m1124dp(15.0f) + this.currentBlock.parent.maxNumWidth) - ((int) Math.ceil(this.currentBlock.numLayout.getLineWidth(0)))) + (this.currentBlock.parent.level * AndroidUtilities.m1124dp(12.0f)), (this.textY + this.numOffsetY) - (this.drawDot ? AndroidUtilities.m1124dp(1.0f) : 0));
                }
    ...
    private class BlockOrderedListItemCell extends ViewGroup implements TextSelectionHelper.ArticleSelectableView {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (tL_pageBlockOrderedListItem != null) {
                this.textLayout = null;
                int i4 = 0;
                this.textY = (tL_pageBlockOrderedListItem.index == 0 && this.currentBlock.parent.level == 0) ? AndroidUtilities.m1124dp(10.0f) : 0;
                this.numOffsetY = 0;
                if (this.currentBlock.parent.lastMaxNumCalcWidth != size || this.currentBlock.parent.lastFontSize != SharedConfig.ivFontSize) {
                    this.currentBlock.parent.lastMaxNumCalcWidth = size;
                    this.currentBlock.parent.lastFontSize = SharedConfig.ivFontSize;
                    ...
                    for (int i5 = 0; i5 < size2; i5++) {
                        ...
                        if (tL_pageBlockOrderedListItem2.num != null) {
                            tL_pageBlockOrderedListItem2.numLayout = ArticleViewer.this.createLayoutForText(this, tL_pageBlockOrderedListItem2.num, null, size - AndroidUtilities.m1124dp(54.0f), this.textY, this.currentBlock, this.parentAdapter);
                ...
                if (this.parentAdapter.isRtl) {
                    ...
                    this.textX = AndroidUtilities.m1124dp(24.0f) + this.currentBlock.parent.maxNumWidth + (this.currentBlock.parent.level * AndroidUtilities.m1124dp(20.0f));
                }
                this.verticalAlign = false;
                int iM1124dp5 = (size - AndroidUtilities.m1124dp(18.0f)) - this.textX;
                if (this.parentAdapter.isRtl) {
                    iM1124dp5 -= (AndroidUtilities.m1124dp(6.0f) + this.currentBlock.parent.maxNumWidth) + (this.currentBlock.parent.level * AndroidUtilities.m1124dp(20.0f));
                }
                int iM1124dp6 = iM1124dp5;
                if (this.currentBlock.textItem != null) {
                    DrawingText drawingTextCreateLayoutForText = ArticleViewer.this.createLayoutForText(this, null, this.currentBlock.textItem, iM1124dp6, this.textY, this.currentBlock, this.parentAdapter.isRtl ? StaticLayoutEx.ALIGN_RIGHT() : Layout.Alignment.ALIGN_NORMAL, this.parentAdapter);
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (this.currentBlock.numLayout != null) {
                canvas.save();
                if (this.parentAdapter.isRtl) {
                    canvas.translate(((measuredWidth - AndroidUtilities.m1124dp(18.0f)) - this.currentBlock.parent.maxNumWidth) - (this.currentBlock.parent.level * AndroidUtilities.m1124dp(20.0f)), this.textY + this.numOffsetY);
                } else {
                    canvas.translate(((AndroidUtilities.m1124dp(18.0f) + this.currentBlock.parent.maxNumWidth) - ((int) Math.ceil(this.currentBlock.numLayout.getLineWidth(0)))) + (this.currentBlock.parent.level * AndroidUtilities.m1124dp(20.0f)), this.textY + this.numOffsetY);
                }
                this.currentBlock.numLayout.draw(canvas, this);
                canvas.restore();
            }
    ...
    private class BlockDetailsCell extends View implements Drawable.Callback, TextSelectionHelper.ArticleSelectableView {
        ...
        public BlockDetailsCell(Context context, WebpageAdapter webpageAdapter) {
            super(context);
            this.textX = AndroidUtilities.m1124dp(50.0f);
            this.textY = AndroidUtilities.m1124dp(11.0f) + 1;
            this.parentAdapter = webpageAdapter;
        ...
        protected void onMeasure(int i, int i2) {
            int size = View.MeasureSpec.getSize(i);
            int iM1124dp = AndroidUtilities.m1124dp(39.0f);
            TLRPC.TL_pageBlockDetails tL_pageBlockDetails = this.currentBlock;
            if (tL_pageBlockDetails != null) {
                DrawingText drawingTextCreateLayoutForText = ArticleViewer.this.createLayoutForText(this, null, tL_pageBlockDetails.title, size - AndroidUtilities.m1124dp(52.0f), 0, this.currentBlock, this.parentAdapter.isRtl ? StaticLayoutEx.ALIGN_RIGHT() : Layout.Alignment.ALIGN_NORMAL, this.parentAdapter);
                this.textLayout = drawingTextCreateLayoutForText;
                if (drawingTextCreateLayoutForText != null) {
                    iM1124dp = Math.max(iM1124dp, AndroidUtilities.m1124dp(21.0f) + this.textLayout.getHeight());
                    int height = ((this.textLayout.getHeight() + AndroidUtilities.m1124dp(21.0f)) - this.textLayout.getHeight()) / 2;
                    this.textY = height;
                    DrawingText drawingText = this.textLayout;
                    drawingText.f1881x = this.textX;
                    drawingText.f1882y = height;
                }
            }
            setMeasuredDimension(size, iM1124dp + 1);
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.save();
            canvas.translate(AndroidUtilities.m1124dp(18.0f), ((getMeasuredHeight() - AndroidUtilities.m1124dp(13.0f)) - 1) / 2);
    ...
    private static class BlockDetailsBottomCell extends View {
        ...
        @Override // android.view.View
        protected void onMeasure(int i, int i2) {
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m1124dp(4.0f) + 1);
        }
    ...
    private class BlockRelatedArticlesShadowCell extends View {
        ...
        public BlockRelatedArticlesShadowCell(Context context) {
            super(context);
            CombinedDrawable combinedDrawable = new CombinedDrawable(new ColorDrawable(ArticleViewer.this.getThemedColor(Theme.key_iv_backgroundGray)), Theme.getThemedDrawable(context, C2888R.drawable.greydivider_bottom, -16777216));
        ...
        @Override // android.view.View
        protected void onMeasure(int i, int i2) {
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m1124dp(12.0f));
    ...
    private class BlockRelatedArticlesHeaderCell extends View implements TextSelectionHelper.ArticleSelectableView {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (tL_pageBlockRelatedArticles != null) {
                ...
                DrawingText drawingTextCreateLayoutForText = ArticleViewer.this.createLayoutForText(blockRelatedArticlesHeaderCell, null, tL_pageBlockRelatedArticles.title, size - AndroidUtilities.m1124dp(52.0f), 0, this.currentBlock, Layout.Alignment.ALIGN_NORMAL, 1, this.parentAdapter);
                blockRelatedArticlesHeaderCell.textLayout = drawingTextCreateLayoutForText;
                if (drawingTextCreateLayoutForText != null) {
                    blockRelatedArticlesHeaderCell.textY = AndroidUtilities.m1124dp(6.0f) + ((AndroidUtilities.m1124dp(32.0f) - blockRelatedArticlesHeaderCell.textLayout.getHeight()) / 2);
                }
            } else {
                blockRelatedArticlesHeaderCell = this;
            }
            if (blockRelatedArticlesHeaderCell.textLayout != null) {
                setMeasuredDimension(size, AndroidUtilities.m1124dp(38.0f));
                DrawingText drawingText = blockRelatedArticlesHeaderCell.textLayout;
                drawingText.f1881x = blockRelatedArticlesHeaderCell.textX;
                drawingText.f1882y = blockRelatedArticlesHeaderCell.textY;
                return;
            }
    ...
    private class BlockRelatedArticlesCell extends View implements TextSelectionHelper.ArticleSelectableView {
        ...
        public BlockRelatedArticlesCell(Context context, WebpageAdapter webpageAdapter) {
            super(context);
            this.textX = AndroidUtilities.m1124dp(18.0f);
            this.textY = AndroidUtilities.m1124dp(10.0f);
            this.parentAdapter = webpageAdapter;
            ImageReceiver imageReceiver = new ImageReceiver(this);
            this.imageView = imageReceiver;
        ...
        protected void onMeasure(int i, int i2) {
            ...
            int iM1124dp = AndroidUtilities.m1124dp(SharedConfig.ivFontSize - 16);
            ...
            int iM1124dp3 = size - AndroidUtilities.m1124dp(36.0f);
            if (this.drawImage) {
                float fM1124dp = AndroidUtilities.m1124dp(44.0f);
                this.imageView.setImageCoords((size - r2) - AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(8.0f), fM1124dp, fM1124dp);
                iM1124dp3 = (int) (iM1124dp3 - (this.imageView.getImageWidth() + AndroidUtilities.m1124dp(6.0f)));
            }
            int i4 = iM1124dp3;
            int iM1124dp4 = AndroidUtilities.m1124dp(18.0f);
            ...
            if (drawingText != null) {
                ...
                i3 = 4 - lineCount;
                this.textOffset = this.textLayout.getHeight() + AndroidUtilities.m1124dp(6.0f) + iM1124dp;
                iM1124dp4 += this.textLayout.getHeight();
                int i5 = 0;
                while (true) {
                    if (i5 >= lineCount) {
                        z2 = false;
            ...
            if (tL_pageRelatedArticle.published_date != 0 && !TextUtils.isEmpty(tL_pageRelatedArticle.author)) {
                string = LocaleController.formatString("ArticleDateByAuthor", C2888R.string.ArticleDateByAuthor, LocaleController.getInstance().getChatFullDate().format(((long) tL_pageRelatedArticle.published_date) * 1000), tL_pageRelatedArticle.author);
            } else if (!TextUtils.isEmpty(tL_pageRelatedArticle.author)) {
                string = LocaleController.formatString("ArticleByAuthor", C2888R.string.ArticleByAuthor, tL_pageRelatedArticle.author);
            ...
            if (drawingTextCreateLayoutForText != null) {
                iM1124dp4 += drawingTextCreateLayoutForText.getHeight();
                if (this.textLayout != null) {
                    iM1124dp4 += AndroidUtilities.m1124dp(6.0f) + iM1124dp;
                }
                DrawingText drawingText3 = this.textLayout2;
                drawingText3.f1881x = this.textX;
                drawingText3.f1882y = this.textY + this.textOffset;
            }
            setMeasuredDimension(size, Math.max(iM1124dp2, iM1124dp4) + (this.divider ? 1 : 0));
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.save();
            canvas.translate(this.textX, AndroidUtilities.m1124dp(10.0f));
            if (this.textLayout != null) {
                ArticleViewer.this.drawTextSelection(canvas, this, 0);
                this.textLayout.draw(canvas, this);
                i = 1;
            ...
            canvas.restore();
            if (this.divider) {
                canvas.drawLine(this.parentAdapter.isRtl ? 0.0f : AndroidUtilities.m1124dp(17.0f), getMeasuredHeight() - 1, getMeasuredWidth() - (this.parentAdapter.isRtl ? AndroidUtilities.m1124dp(17.0f) : 0), getMeasuredHeight() - 1, ArticleViewer.dividerPaint);
            }
        }
    ...
    private class BlockHeaderCell extends View implements TextSelectionHelper.ArticleSelectableView {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (tL_pageBlockHeader != null) {
                DrawingText drawingTextCreateLayoutForText = ArticleViewer.this.createLayoutForText(this, null, tL_pageBlockHeader.text, size - AndroidUtilities.m1124dp(36.0f), this.textY, this.currentBlock, this.parentAdapter.isRtl ? StaticLayoutEx.ALIGN_RIGHT() : Layout.Alignment.ALIGN_NORMAL, this.parentAdapter);
                this.textLayout = drawingTextCreateLayoutForText;
                if (drawingTextCreateLayoutForText != null) {
                    iM1124dp = AndroidUtilities.m1124dp(16.0f) + this.textLayout.getHeight();
                    DrawingText drawingText = this.textLayout;
                    drawingText.f1881x = this.textX;
                    drawingText.f1882y = this.textY;
                } else {
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            accessibilityNodeInfo.setText(((Object) this.textLayout.getText()) + ", " + LocaleController.getString(C2888R.string.AccDescrIVHeading));
        }
    ...
    private static class BlockDividerCell extends View {
        ...
        @Override // android.view.View
        protected void onMeasure(int i, int i2) {
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m1124dp(18.0f));
        }

        @Override // android.view.View
        protected void onDraw(Canvas canvas) {
            this.rect.set(getMeasuredWidth() / 3, AndroidUtilities.m1124dp(8.0f), r0 * 2, AndroidUtilities.m1124dp(10.0f));
            canvas.drawRoundRect(this.rect, AndroidUtilities.m1124dp(1.0f), AndroidUtilities.m1124dp(1.0f), ArticleViewer.dividerPaint);
        }
    }
    ...
    private class BlockSubtitleCell extends View implements TextSelectionHelper.ArticleSelectableView {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (tL_pageBlockSubtitle != null) {
                DrawingText drawingTextCreateLayoutForText = ArticleViewer.this.createLayoutForText(this, null, tL_pageBlockSubtitle.text, size - AndroidUtilities.m1124dp(36.0f), this.textY, this.currentBlock, this.parentAdapter.isRtl ? StaticLayoutEx.ALIGN_RIGHT() : Layout.Alignment.ALIGN_NORMAL, this.parentAdapter);
                this.textLayout = drawingTextCreateLayoutForText;
                if (drawingTextCreateLayoutForText != null) {
                    iM1124dp = AndroidUtilities.m1124dp(16.0f) + this.textLayout.getHeight();
                    DrawingText drawingText = this.textLayout;
    ...
    private class BlockPullquoteCell extends View implements TextSelectionHelper.ArticleSelectableView {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (tL_pageBlockPullquote != null) {
                DrawingText drawingTextCreateLayoutForText = ArticleViewer.this.createLayoutForText(this, null, tL_pageBlockPullquote.text, size - AndroidUtilities.m1124dp(36.0f), this.textY, this.currentBlock, this.parentAdapter);
                this.textLayout = drawingTextCreateLayoutForText;
                if (drawingTextCreateLayoutForText != null) {
                    iM1124dp = AndroidUtilities.m1124dp(8.0f) + this.textLayout.getHeight();
                    DrawingText drawingText = this.textLayout;
                    drawingText.f1881x = this.textX;
                    drawingText.f1882y = this.textY;
                } else {
                ...
                this.textY2 = AndroidUtilities.m1124dp(2.0f) + iM1124dp;
                DrawingText drawingTextCreateLayoutForText2 = ArticleViewer.this.createLayoutForText(this, null, this.currentBlock.caption, size - AndroidUtilities.m1124dp(36.0f), this.textY2, this.currentBlock, this.parentAdapter);
                this.textLayout2 = drawingTextCreateLayoutForText2;
                if (drawingTextCreateLayoutForText2 != null) {
                    iM1124dp += AndroidUtilities.m1124dp(8.0f) + this.textLayout2.getHeight();
                    DrawingText drawingText2 = this.textLayout2;
                    drawingText2.f1881x = this.textX;
                    drawingText2.f1882y = this.textY2;
                }
                if (iM1124dp != 0) {
                    iM1124dp += AndroidUtilities.m1124dp(8.0f);
                }
    ...
    private class BlockBlockquoteCell extends View implements TextSelectionHelper.ArticleSelectableView {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            int size = View.MeasureSpec.getSize(i);
            if (this.currentBlock != null) {
                int iM1124dp2 = size - AndroidUtilities.m1124dp(50.0f);
                if (this.currentBlock.level > 0) {
                    iM1124dp2 -= AndroidUtilities.m1124dp(r0 * 14);
                }
                int i3 = iM1124dp2;
                ArticleViewer articleViewer = ArticleViewer.this;
                ...
                this.textLayout = drawingTextCreateLayoutForText;
                iM1124dp = drawingTextCreateLayoutForText != null ? AndroidUtilities.m1124dp(8.0f) + this.textLayout.getHeight() : 0;
                if (this.currentBlock.level > 0) {
                    if (this.parentAdapter.isRtl) {
                        this.textX = AndroidUtilities.m1124dp((this.currentBlock.level * 14) + 14);
                    } else {
                        this.textX = AndroidUtilities.m1124dp(this.currentBlock.level * 14) + AndroidUtilities.m1124dp(32.0f);
                    }
                } else if (this.parentAdapter.isRtl) {
                    this.textX = AndroidUtilities.m1124dp(14.0f);
                } else {
                    this.textX = AndroidUtilities.m1124dp(32.0f);
                }
                int iM1124dp3 = iM1124dp + AndroidUtilities.m1124dp(8.0f);
                this.textY2 = iM1124dp3;
                ArticleViewer articleViewer2 = ArticleViewer.this;
                TLRPC.TL_pageBlockBlockquote tL_pageBlockBlockquote2 = this.currentBlock;
                DrawingText drawingTextCreateLayoutForText2 = articleViewer2.createLayoutForText(this, null, tL_pageBlockBlockquote2.caption, i3, iM1124dp3, tL_pageBlockBlockquote2, this.parentAdapter);
                this.textLayout2 = drawingTextCreateLayoutForText2;
                if (drawingTextCreateLayoutForText2 != null) {
                    iM1124dp += AndroidUtilities.m1124dp(8.0f) + this.textLayout2.getHeight();
                }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (this.parentAdapter.isRtl) {
                canvas.drawRect(getMeasuredWidth() - AndroidUtilities.m1124dp(20.0f), AndroidUtilities.m1124dp(6.0f), r1 + AndroidUtilities.m1124dp(2.0f), getMeasuredHeight() - AndroidUtilities.m1124dp(6.0f), ArticleViewer.quoteLinePaint);
            } else {
                canvas.drawRect(AndroidUtilities.m1124dp((this.currentBlock.level * 14) + 18), AndroidUtilities.m1124dp(6.0f), AndroidUtilities.m1124dp((this.currentBlock.level * 14) + 20), getMeasuredHeight() - AndroidUtilities.m1124dp(6.0f), ArticleViewer.quoteLinePaint);
            }
            if (this.currentBlock.level > 0) {
                canvas.drawRect(AndroidUtilities.m1124dp(18.0f), 0.0f, AndroidUtilities.m1124dp(20.0f), getMeasuredHeight() - (this.currentBlock.bottom ? AndroidUtilities.m1124dp(6.0f) : 0), ArticleViewer.quoteLinePaint);
            }
    ...
    class BlockPhotoCell extends FrameLayout implements DownloadController.FileDownloadProgressListener, TextSelectionHelper.ArticleSelectableView {
        ...
        public void setBlock(TLRPC.TL_pageBlockPhoto tL_pageBlockPhoto, boolean z, boolean z2, boolean z3) {
            ...
            if (!TextUtils.isEmpty(this.currentBlock.url)) {
                this.linkDrawable = getResources().getDrawable(C2888R.drawable.msg_instant_link);
            }
        ...
        */
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (!TextUtils.isEmpty(this.currentBlock.url) && !(this.currentPhoto instanceof WebInstantView.WebPhoto)) {
                int measuredWidth = getMeasuredWidth() - AndroidUtilities.m1124dp(35.0f);
                int imageY = (int) (this.imageView.getImageY() + AndroidUtilities.m1124dp(11.0f));
                this.linkDrawable.setBounds(measuredWidth, imageY, AndroidUtilities.m1124dp(24.0f) + measuredWidth, AndroidUtilities.m1124dp(24.0f) + imageY);
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            super.onInitializeAccessibilityNodeInfo(accessibilityNodeInfo);
            accessibilityNodeInfo.setEnabled(true);
            StringBuilder sb = new StringBuilder(LocaleController.getString(C2888R.string.AttachPhoto));
            if (this.captionLayout != null) {
                sb.append(", ");
                sb.append(this.captionLayout.getText());
            }
    ...
    private class BlockMapCell extends FrameLayout implements TextSelectionHelper.ArticleSelectableView {
        ...
        /* JADX WARN: Removed duplicated region for block: B:88:0x009c A[PHI: r0
  0x009c: PHI (r0v3 int) = (r0v2 int), (r0v42 int) binds: [B:84:0x0062, B:86:0x0087] A[DONT_GENERATE, DONT_INLINE]] */
        @Override // android.widget.FrameLayout, android.view.View
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (this.currentMapProvider == 2 && this.imageView.hasNotThumb()) {
                if (ArticleViewer.this.chat_redLocationIcon == null) {
                    ArticleViewer.this.chat_redLocationIcon = ContextCompat.getDrawable(getContext(), C2888R.drawable.map_pin).mutate();
                }
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            super.onInitializeAccessibilityNodeInfo(accessibilityNodeInfo);
            accessibilityNodeInfo.setEnabled(true);
            StringBuilder sb = new StringBuilder(LocaleController.getString(C2888R.string.Map));
            if (this.captionLayout != null) {
                sb.append(", ");
                sb.append(this.captionLayout.getText());
            }
    ...
    class BlockChannelCell extends FrameLayout implements TextSelectionHelper.ArticleSelectableView {
        ...
        public BlockChannelCell(Context context, WebpageAdapter webpageAdapter, int i) {
            super(context);
            this.textX = AndroidUtilities.m1124dp(18.0f);
            this.textY = AndroidUtilities.m1124dp(11.0f);
            this.parentAdapter = webpageAdapter;
            setWillNotDraw(false);
            this.backgroundPaint = new Paint();
            this.currentType = i;
            ...
            this.textView.setText(LocaleController.getString(C2888R.string.ChannelJoin));
            ...
            imageView.setImageResource(C2888R.drawable.list_check);
        ...
        public void setBlock(TLRPC.TL_pageBlockChannel tL_pageBlockChannel) {
            ...
            TLRPC.Chat chat = MessagesController.getInstance(ArticleViewer.this.currentAccount).getChat(Long.valueOf(tL_pageBlockChannel.channel.f1660id));
        ...
        protected void onMeasure(int i, int i2) {
            int size = View.MeasureSpec.getSize(i);
            setMeasuredDimension(size, AndroidUtilities.m1124dp(48.0f));
            this.textView.measure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(39.0f), TLObject.FLAG_30));
            this.buttonWidth = this.textView.getMeasuredWidth();
            this.progressView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(39.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(39.0f), TLObject.FLAG_30));
            this.imageView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(39.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(39.0f), TLObject.FLAG_30));
            TLRPC.TL_pageBlockChannel tL_pageBlockChannel = this.currentBlock;
            if (tL_pageBlockChannel != null) {
                this.textLayout = ArticleViewer.this.createLayoutForText(this, tL_pageBlockChannel.channel.title, null, (size - AndroidUtilities.m1124dp(52.0f)) - this.buttonWidth, this.textY, this.currentBlock, StaticLayoutEx.ALIGN_LEFT(), 1, this.parentAdapter);
                if (this.parentAdapter.isRtl) {
        ...
        @Override // android.widget.FrameLayout, android.view.ViewGroup, android.view.View
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            this.imageView.layout((this.textX2 + (this.buttonWidth / 2)) - AndroidUtilities.m1124dp(19.0f), 0, this.textX2 + (this.buttonWidth / 2) + AndroidUtilities.m1124dp(20.0f), AndroidUtilities.m1124dp(39.0f));
            this.progressView.layout((this.textX2 + (this.buttonWidth / 2)) - AndroidUtilities.m1124dp(19.0f), 0, this.textX2 + (this.buttonWidth / 2) + AndroidUtilities.m1124dp(20.0f), AndroidUtilities.m1124dp(39.0f));
            TextView textView = this.textView;
            int i5 = this.textX2;
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), AndroidUtilities.m1124dp(39.0f), this.backgroundPaint);
            DrawingText drawingText = this.textLayout;
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (tL_pageBlockAuthorDate != null) {
                ...
                if (this.currentBlock.published_date != 0 && !TextUtils.isEmpty(text)) {
                    NewSpannable = LocaleController.formatString("ArticleDateByAuthor", C2888R.string.ArticleDateByAuthor, LocaleController.getInstance().getChatFullDate().format(((long) this.currentBlock.published_date) * 1000), text);
                } else if (!TextUtils.isEmpty(text)) {
                    NewSpannable = LocaleController.formatString("ArticleByAuthor", C2888R.string.ArticleByAuthor, text);
                } else {
                ...
                DrawingText drawingTextCreateLayoutForText = ArticleViewer.this.createLayoutForText(this, NewSpannable, null, i3 - AndroidUtilities.m1124dp(36.0f), this.textY, this.currentBlock, this.parentAdapter);
                this.textLayout = drawingTextCreateLayoutForText;
                if (drawingTextCreateLayoutForText != null) {
                    int iM1124dp = AndroidUtilities.m1124dp(16.0f) + this.textLayout.getHeight();
                    if (this.parentAdapter.isRtl) {
                        this.textX = (int) Math.floor(((i3 - this.textLayout.getLineLeft(0)) - this.textLayout.getLineWidth(0)) - AndroidUtilities.m1124dp(16.0f));
                    } else {
                        this.textX = AndroidUtilities.m1124dp(18.0f);
                    }
                    DrawingText drawingText = this.textLayout;
    ...
    private class BlockTitleCell extends View implements TextSelectionHelper.ArticleSelectableView {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (tL_pageBlockTitle != null) {
                if (tL_pageBlockTitle.first) {
                    iM1124dp = AndroidUtilities.m1124dp(8.0f);
                    this.textY = AndroidUtilities.m1124dp(16.0f);
                } else {
                    this.textY = AndroidUtilities.m1124dp(8.0f);
                    iM1124dp = 0;
                }
                DrawingText drawingTextCreateLayoutForText = ArticleViewer.this.createLayoutForText(this, null, this.currentBlock.text, size - AndroidUtilities.m1124dp(36.0f), this.textY, this.currentBlock, this.parentAdapter.isRtl ? StaticLayoutEx.ALIGN_RIGHT() : Layout.Alignment.ALIGN_NORMAL, this.parentAdapter);
                this.textLayout = drawingTextCreateLayoutForText;
                if (drawingTextCreateLayoutForText != null) {
                    iM1124dp += AndroidUtilities.m1124dp(16.0f) + this.textLayout.getHeight();
                    DrawingText drawingText = this.textLayout;
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            accessibilityNodeInfo.setText(((Object) this.textLayout.getText()) + ", " + LocaleController.getString(C2888R.string.AccDescrIVTitle));
        }
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (tL_pageBlockFooter != null) {
                ...
                if (tL_pageBlockFooter.level == 0) {
                    ...
                    this.textY = 0;
                    this.textX = AndroidUtilities.m1124dp((r14 * 14) + 18);
                }
                DrawingText drawingTextCreateLayoutForText = ArticleViewer.this.createLayoutForText(this, null, this.currentBlock.text, (size - AndroidUtilities.m1124dp(18.0f)) - this.textX, this.textY, this.currentBlock, this.parentAdapter.isRtl ? StaticLayoutEx.ALIGN_RIGHT() : Layout.Alignment.ALIGN_NORMAL, this.parentAdapter);
                this.textLayout = drawingTextCreateLayoutForText;
                if (drawingTextCreateLayoutForText != null) {
                    int height = drawingTextCreateLayoutForText.getHeight();
                    if (this.currentBlock.level > 0) {
    ...
    class BlockPreformattedCell extends FrameLayout implements TextSelectionHelper.ArticleSelectableView {
        ...
        public BlockPreformattedCell(Context context, WebpageAdapter webpageAdapter) {
            super(context);
            this.parentAdapter = webpageAdapter;
            C31851 c31851 = new HorizontalScrollView(context) { // from class: org.telegram.ui.ArticleViewer.BlockPreformattedCell.1
                final /* synthetic */ ArticleViewer val$this$0;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C31851(Context context2, ArticleViewer articleViewer) {
                    super(context2);
                    articleViewer = articleViewer;
                }
            ...
            this.scrollView = c31851;
            c31851.setPadding(0, AndroidUtilities.m1124dp(8.0f), 0, AndroidUtilities.m1124dp(8.0f));
            addView(this.scrollView, LayoutHelper.createFrame(-1, -2.0f));
            this.textContainer = new View(context2) { // from class: org.telegram.ui.ArticleViewer.BlockPreformattedCell.2
                final /* synthetic */ ArticleViewer val$this$0;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C31862(Context context2, ArticleViewer articleViewer) {
                    super(context2);
                    articleViewer = articleViewer;
                }
                ...
                protected void onMeasure(int i, int i2) {
                    ...
                    if (BlockPreformattedCell.this.currentBlock != null) {
                        ...
                        blockPreformattedCell.textLayout = ArticleViewer.this.createLayoutForText(this, null, blockPreformattedCell.currentBlock.text, AndroidUtilities.m1124dp(5000.0f), 0, BlockPreformattedCell.this.currentBlock, BlockPreformattedCell.this.parentAdapter);
                    ...
                    setMeasuredDimension(iMax + AndroidUtilities.m1124dp(32.0f), height);
                }
                ...
                protected void onDraw(Canvas canvas) {
                    if (BlockPreformattedCell.this.textLayout != null) {
                        ...
                        canvas.restore();
                        BlockPreformattedCell.this.textLayout.f1881x = (int) getX();
                        BlockPreformattedCell.this.textLayout.f1882y = (int) getY();
                    }
                }
            };
            ...
            layoutParams.leftMargin = iM1124dp;
            int iM1124dp2 = AndroidUtilities.m1124dp(12.0f);
            layoutParams.bottomMargin = iM1124dp2;
            layoutParams.topMargin = iM1124dp2;
        ...
        class C31851 extends HorizontalScrollView {
            final /* synthetic */ ArticleViewer val$this$0;
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawRect(0.0f, AndroidUtilities.m1124dp(8.0f), getMeasuredWidth(), getMeasuredHeight() - AndroidUtilities.m1124dp(8.0f), ArticleViewer.preformattedBackgroundPaint);
        }
    ...
    private class BlockSubheaderCell extends View implements TextSelectionHelper.ArticleSelectableView {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (tL_pageBlockSubheader != null) {
                DrawingText drawingTextCreateLayoutForText = ArticleViewer.this.createLayoutForText(this, null, tL_pageBlockSubheader.text, size - AndroidUtilities.m1124dp(36.0f), this.textY, this.currentBlock, this.parentAdapter.isRtl ? StaticLayoutEx.ALIGN_RIGHT() : Layout.Alignment.ALIGN_NORMAL, this.parentAdapter);
                this.textLayout = drawingTextCreateLayoutForText;
                if (drawingTextCreateLayoutForText != null) {
                    iM1124dp = AndroidUtilities.m1124dp(16.0f) + this.textLayout.getHeight();
                    DrawingText drawingText = this.textLayout;
    ...
    private class ReportCell extends FrameLayout {
        ...
        public ReportCell(Context context, boolean z) {
            ...
            TextView textView = new TextView(context);
            this.textView = textView;
            textView.setText(LocaleController.getString(z ? C2888R.string.PreviewFeedbackAuto : C2888R.string.PreviewFeedback2));
            this.textView.setTextSize(1, 12.0f);
            this.textView.setGravity(17);
            this.textView.setPadding(AndroidUtilities.m1124dp(18.0f), 0, AndroidUtilities.m1124dp(18.0f), 0);
            ...
            this.viewsTextView.setPadding(AndroidUtilities.m1124dp(18.0f), 0, AndroidUtilities.m1124dp(18.0f), 0);
            addView(this.viewsTextView, LayoutHelper.createFrame(-1, 34.0f, 51, 0.0f, 10.0f, 0.0f, 0.0f));
        }

        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(44.0f), TLObject.FLAG_30));
        }
    ...
    private class RealPageBlocksAdapter implements PhotoViewer.PageBlocksAdapter {
        ...
        */
        public java.lang.CharSequence getCaption(int r9) {
            ...
            L29:
                if (r0 != 0) goto L88
                org.telegram.ui.ArticleViewer r9 = org.telegram.p029ui.ArticleViewer.this
                r0 = 2
                org.telegram.tgnet.TLRPC$RichText r3 = org.telegram.p029ui.ArticleViewer.m5969$$Nest$mgetBlockCaption(r9, r5, r0)
                org.telegram.ui.ArticleViewer r0 = org.telegram.p029ui.ArticleViewer.this
                org.telegram.tgnet.TLRPC$WebPage r1 = r8.page
                r9 = 1120403456(0x42c80000, float:100.0)
                int r9 = org.telegram.messenger.AndroidUtilities.m1124dp(r9)
                int r6 = -r9
                r2 = 0
                r4 = r3
                java.lang.CharSequence r9 = org.telegram.p029ui.ArticleViewer.m5973$$Nest$mgetText(r0, r1, r2, r3, r4, r5, r6)
                boolean r0 = r9 instanceof android.text.Spannable
                if (r0 == 0) goto L87
                r0 = r9
                android.text.Spannable r0 = (android.text.Spannable) r0
                int r1 = r9.length()
                java.lang.Class<org.telegram.ui.Components.TextPaintUrlSpan> r2 = org.telegram.p029ui.Components.TextPaintUrlSpan.class
                java.lang.Object[] r1 = r0.getSpans(r7, r1, r2)
                org.telegram.ui.Components.TextPaintUrlSpan[] r1 = (org.telegram.p029ui.Components.TextPaintUrlSpan[]) r1
    ...
    public class PageLayout extends FrameLayout {
        ...
        public PageLayout(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            C31931 c31931 = new WebpageListView(context, resourcesProvider) { // from class: org.telegram.ui.ArticleViewer.PageLayout.1
                final /* synthetic */ ArticleViewer val$this$0;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C31931(Context context2, Theme.ResourcesProvider resourcesProvider2, ArticleViewer articleViewer) {
                    super(context2, resourcesProvider2);
                    articleViewer = articleViewer;
                }

                @Override // org.telegram.ui.ArticleViewer.WebpageListView, org.telegram.p029ui.Components.RecyclerListView, androidx.recyclerview.widget.RecyclerView, android.view.ViewGroup, android.view.View
                protected void onLayout(boolean z, int i2, int i3, int i4, int i5) {
                    super.onLayout(z, i2, i3, i4, i5);
                    PageLayout.this.overrideProgress = -1.0f;
                }
            };
            this.listView = c31931;
            c31931.setClipToPadding(false);
            float f = 56.0f;
            c31931.setPadding(0, AndroidUtilities.m1124dp(56.0f), 0, 0);
            c31931.setTopGlowOffset(AndroidUtilities.m1124dp(56.0f));
            ((DefaultItemAnimator) c31931.getItemAnimator()).setDelayAnimations(false);
            ...
            c31931.setAdapter(webpageAdapter);
            LinearLayoutManager linearLayoutManager = new LinearLayoutManager(context2, 1, false);
            this.layoutManager = linearLayoutManager;
            c31931.setLayoutManager(linearLayoutManager);
            c31931.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.ArticleViewer.PageLayout.2
                final /* synthetic */ ArticleViewer val$this$0;

                C31942(ArticleViewer articleViewer) {
                    articleViewer = articleViewer;
                }
            ...
            addView(c31931, LayoutHelper.createFrame(-1, -1.0f));
            C31953 c31953 = new ChatAttachAlertBotWebViewLayout.WebViewSwipeContainer(getContext()) { // from class: org.telegram.ui.ArticleViewer.PageLayout.3
                private boolean ignoreLayout;
                final /* synthetic */ ArticleViewer val$this$0;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C31953(Context context2, ArticleViewer articleViewer) {
                    super(context2);
                    articleViewer = articleViewer;
                }
                ...
                protected void onMeasure(int i2, int i3) {
                    ...
                    Sheet sheet2 = ArticleViewer.this.sheet;
                    super.onMeasure(i2, View.MeasureSpec.makeMeasureSpec((size - AndroidUtilities.m1124dp((sheet2 == null || sheet2.halfSize()) ? 56.0f : 0.0f)) - AndroidUtilities.statusBarHeight, TLObject.FLAG_30));
                }
            ...
            this.swipeContainer = c31953;
            c31953.setShouldWaitWebViewScroll(true);
            c31953.setFullSize(true);
            c31953.setAllowFullSizeSwipe(true);
            C31964 c31964 = new BotWebViewContainer(getContext(), resourcesProvider2, ArticleViewer.this.getThemedColor(Theme.key_windowBackgroundWhite), false) { // from class: org.telegram.ui.ArticleViewer.PageLayout.4
                final /* synthetic */ ArticleViewer val$this$0;

                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                C31964(Context context2, Theme.ResourcesProvider resourcesProvider2, int i2, boolean z, ArticleViewer articleViewer) {
            ...
            this.webViewContainer = c31964;
            c31964.setOnCloseRequestedListener(new Runnable() { // from class: org.telegram.ui.ArticleViewer$PageLayout$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$new$0();
                }
            });
            c31964.setWebViewProgressListener(new Consumer() { // from class: org.telegram.ui.ArticleViewer$PageLayout$$ExternalSyntheticLambda1
                @Override // androidx.core.util.Consumer
                public final void accept(Object obj) {
                    this.f$0.lambda$new$1((Float) obj);
                }
            });
            c31964.setDelegate(new BotWebViewContainer.Delegate() { // from class: org.telegram.ui.ArticleViewer.PageLayout.5
                final /* synthetic */ ArticleViewer val$this$0;
                ...
                C31975(ArticleViewer articleViewer) {
                    articleViewer = articleViewer;
                }
            ...
            c31964.setWebViewScrollListener(new BotWebViewContainer.WebViewScrollListener() { // from class: org.telegram.ui.ArticleViewer.PageLayout.6
                final /* synthetic */ ArticleViewer val$this$0;

                C31986(ArticleViewer articleViewer) {
                    articleViewer = articleViewer;
                }
            ...
            c31953.addView(c31964, LayoutHelper.createFrame(-1, -1.0f));
            c31953.setScrollEndListener(new Runnable() { // from class: org.telegram.ui.ArticleViewer$PageLayout$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$new$2();
                }
            });
            c31953.setDelegate(new ChatAttachAlertBotWebViewLayout.WebViewSwipeContainer.Delegate() { // from class: org.telegram.ui.ArticleViewer$PageLayout$$ExternalSyntheticLambda3
            ...
            c31953.setScrollListener(new Runnable() { // from class: org.telegram.ui.ArticleViewer$PageLayout$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
            ...
            c31953.setTopActionBarOffsetY(AndroidUtilities.m1124dp(f) + AndroidUtilities.statusBarHeight);
            addView(c31953, LayoutHelper.createFrame(-1, -1.0f));
            cleanup();
            setType(0);
        }

        /* JADX INFO: renamed from: org.telegram.ui.ArticleViewer$PageLayout$1 */
        class C31931 extends WebpageListView {
            final /* synthetic */ ArticleViewer val$this$0;
        ...
        class C31942 extends RecyclerView.OnScrollListener {
            final /* synthetic */ ArticleViewer val$this$0;
        ...
        class C31953 extends ChatAttachAlertBotWebViewLayout.WebViewSwipeContainer {
            private boolean ignoreLayout;
            final /* synthetic */ ArticleViewer val$this$0;
        ...
        class C31964 extends BotWebViewContainer {
            final /* synthetic */ ArticleViewer val$this$0;
        ...
        class C31975 implements BotWebViewContainer.Delegate {
            final /* synthetic */ ArticleViewer val$this$0;
        ...
        class C31986 implements BotWebViewContainer.WebViewScrollListener {
            final /* synthetic */ ArticleViewer val$this$0;
                ...
                if (!isTonsite()) {
                    try {
                        try {
                            ...
                            if (strArrSplit.length > 2 && ArticleViewer.this.actionBar != null && HintView2.measureCorrectly(strIDN_toUnicode, ArticleViewer.this.actionBar.titlePaint) > AndroidUtilities.displaySize.x - AndroidUtilities.m1124dp(162.0f)) {
        ...
        public void scrollToTop(boolean z) {
            ...
            Sheet sheet2 = ArticleViewer.this.sheet;
            linearLayoutManager.scrollToPositionWithOffset((sheet2 == null || !sheet2.halfSize()) ? 0 : 1, ArticleViewer.this.sheet != null ? AndroidUtilities.m1124dp(32.0f) : 0);
        }
        ...
        public void setTranslationX(float f) {
            ...
            if (ArticleViewer.this.windowView.movingPage) {
                ArticleViewer.this.containerView.invalidate();
                ArticleViewer articleViewer = ArticleViewer.this;
                articleViewer.setCurrentHeaderHeight((int) (articleViewer.windowView.startMovingHeaderHeight + ((AndroidUtilities.m1124dp(56.0f) - ArticleViewer.this.windowView.startMovingHeaderHeight) * (f / getMeasuredWidth()))));
            }
            Sheet sheet = ArticleViewer.this.sheet;
            if (sheet != null) {
    ...
    public class Sheet implements BaseFragment.AttachedSheet, BottomSheetTabsOverlay.Sheet {
        ...
        public /* synthetic */ void lambda$new$0(Integer num) {
            ArticleViewer.this.keyboardVisible = num.intValue() - AndroidUtilities.navigationBarHeight > AndroidUtilities.m1124dp(20.0f);
        }
        ...
        public WindowView mo6088getWindowView() {
        ...
        public void animateOpen(boolean z, boolean z2, Runnable runnable) {
            ...
            if (z2) {
                ...
                this.openAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.ArticleViewer.Sheet.1
                    ...
                    C32011(boolean z3, Runnable runnable2) {
                        z = z3;
                        runnable = runnable2;
                    }
        ...
        class C32011 extends AnimatorListenerAdapter {
            final /* synthetic */ Runnable val$callback;
            final /* synthetic */ boolean val$open;
        ...
        public void animateDismiss(boolean z, boolean z2, Runnable runnable) {
            ...
            if (z2) {
                ...
                this.dismissAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.ArticleViewer.Sheet.2
                    ...
                    C32022(boolean z3, Runnable runnable2) {
                        z = z3;
                        runnable = runnable2;
                    }
        ...
        class C32022 extends AnimatorListenerAdapter {
            final /* synthetic */ Runnable val$callback;
            final /* synthetic */ boolean val$dismiss;
        ...
        public void checkNavColor() {
            ...
            if (bottomSheetTabDialog2 != null) {
                ...
                AndroidUtilities.setLightNavigationBar(mo6088getWindowView(), AndroidUtilities.computePerceivedBrightness(getNavigationBarColor(ArticleViewer.this.getThemedColor(Theme.key_windowBackgroundGray))) >= 0.721f);
            }
        }
        ...
        public int getEmptyPadding() {
            ...
            return (iM1124dp + (view == null ? AndroidUtilities.displaySize.y : view.getHeight())) - (getListTop() - getListPaddingTop());
        }
        ...
        public class WindowView extends SizeNotifierFrameLayout implements BaseFragment.AttachedSheetWindow, BottomSheetTabsOverlay.SheetView {
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                float f2 = iLerp;
                this.rect.set(0.0f, f2, getWidth(), getHeight() + AndroidUtilities.m1124dp(16.0f));
                float f3 = 1.0f - f;
                float fM1124dp = AndroidUtilities.m1124dp(16.0f) * f3;
                if (f < 1.0f) {
                    this.shadowPaint.setColor(0);
                    c = 1;
                    i = 0;
                    this.shadowPaint.setShadowLayer(AndroidUtilities.m1124dp(18.0f), 0.0f, -AndroidUtilities.m1124dp(3.0f), Theme.multAlpha(-16777216, fMin * 0.26f));
                    canvas2.drawRoundRect(this.rect, fM1124dp, fM1124dp, this.shadowPaint);
                } else {
                    i = 0;
                    c = 1;
                }
                if (fM1124dp <= 0.0f) {
                    ...
                    this.clipPath.addRoundRect(this.rect, fM1124dp, fM1124dp, Path.Direction.CW);
                ...
                if (f < 1.0f) {
                    ...
                    float listPaddingTop = (f2 + (Sheet.this.getListPaddingTop() / 2.0f)) - (AndroidUtilities.m1124dp(8.0f) * f);
                    float fLerp2 = AndroidUtilities.lerp(AndroidUtilities.m1124dp(32.0f), AndroidUtilities.m1124dp(48.0f), f) / 2.0f;
                    this.rect.set(width - fLerp2, listPaddingTop - AndroidUtilities.m1124dp(2.0f), width + fLerp2, listPaddingTop + AndroidUtilities.m1124dp(2.0f));
            ...
            public float drawInto(Canvas canvas, RectF rectF, float f, RectF rectF2, float f2, boolean z) {
                ...
                float fLerp = AndroidUtilities.lerp(AndroidUtilities.m1124dp(16.0f), AndroidUtilities.m1124dp(10.0f), f);
        ...
        public BulletinFactory getBulletinFactory() {
            ...
            return BulletinFactory.m1245of(frameLayout, ArticleViewer.this.getResourcesProvider());
        }
    }
    ...
    public static class ErrorContainer extends FrameLayout {
        ...
        public ErrorContainer(Context context) {
            ...
            linearLayout.setPadding(AndroidUtilities.m1124dp(32.0f), AndroidUtilities.m1124dp(24.0f), AndroidUtilities.m1124dp(32.0f), AndroidUtilities.m1124dp(24.0f));
            linearLayout.setOrientation(1);
            ...
            buttonWithCounterView.setMinWidth(AndroidUtilities.m1124dp(140.0f));
            buttonWithCounterView.setText(LocaleController.getString(C2888R.string.Refresh), false);
            ...
            buttonWithCounterView2.setMinWidth(AndroidUtilities.m1124dp(140.0f));
            buttonWithCounterView2.setText(LocaleController.getString(C2888R.string.PageBlockedGoBack), false);
            ...
            buttonWithCounterView3.setMinWidth(AndroidUtilities.m1124dp(140.0f));
            buttonWithCounterView3.setText(LocaleController.getString(C2888R.string.PageBlockedProceed), false);
        ...
        public void set(String str, String str2) {
            this.titleView.setText(LocaleController.getString(C2888R.string.WebErrorTitle));
            this.descriptionView.setText(AndroidUtilities.replaceTags(LocaleController.formatString(C2888R.string.WebErrorInfoBot, str)));
            this.codeView.setText(str2);
        }

        public void set(String str, int i, String str2) {
            if (i == 590) {
                this.titleView.setText(LocaleController.getString(C2888R.string.PageBlocked));
                this.descriptionView.setText(AndroidUtilities.replaceTags(LocaleController.formatString(C2888R.string.PageBlockedDescription, str)));
            ...
            this.descriptionView.setText(Emoji.replaceEmoji(AndroidUtilities.replaceTags((strMagic2tonsite == null || Uri.parse(strMagic2tonsite) == null || Uri.parse(strMagic2tonsite).getAuthority() == null) ? LocaleController.getString(C2888R.string.WebErrorInfo) : LocaleController.formatString(C2888R.string.WebErrorInfoDomain, Uri.parse(strMagic2tonsite).getAuthority())), this.descriptionView.getPaint().getFontMetricsInt(), false));
            this.codeView.setText(str2);
        }
