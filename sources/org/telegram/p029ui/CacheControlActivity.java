...
import org.telegram.p029ui.CachedMediaLayout;
...
import org.telegram.p029ui.Components.CacheChart;
...
import org.telegram.p029ui.Components.StorageDiagramView;
import org.telegram.p029ui.Components.StorageUsageView;
import org.telegram.p029ui.Components.TypefaceSpan;
import org.telegram.p029ui.DilogCacheBottomSheet;
import org.telegram.p029ui.KeepMediaPopupView;
...
public class CacheControlActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void updateDatabaseItemSize() {
        if (this.clearDatabaseItem != null) {
            ...
            spannableStringBuilder.append((CharSequence) LocaleController.getString(C2888R.string.ClearLocalDatabase));
    ...
    public static void calculateTotalSize(final Utilities.Callback callback) {
        ...
        Utilities.cacheClearQueue.postRunnable(new Runnable() { // from class: org.telegram.ui.CacheControlActivity$$ExternalSyntheticLambda3
            ...
            public final void run() {
                CacheControlActivity.m6353$r8$lambda$fNB1ypvT1aLKISN4xQOCLaHAGk(callback);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$fNB1ypvT1aLKISN4x-QOCLaHAGk */
    public static /* synthetic */ void m6353$r8$lambda$fNB1ypvT1aLKISN4xQOCLaHAGk(final Utilities.Callback callback) {
        canceled = false;
            ...
            if (!z && this.totalSize > 0) {
                ...
                for (int i = 0; i < this.itemInners.size(); i++) {
                    ...
                    if (itemInner.viewType == 11) {
                        ...
                        if (i2 < 0) {
                            if (this.collapsed) {
                                segmentSizeArr[10] = CacheChart.SegmentSize.m1247of(itemInner.size, this.selected[10]);
                            }
                        } else {
                            segmentSizeArr[i2] = CacheChart.SegmentSize.m1247of(itemInner.size, this.selected[i2]);
                        }
                    }
                }
    ...
    private void updateRows(boolean z) {
        ...
        if (this.calculating) {
            ...
            if (this.photoSize > 0) {
                c = '\n';
                arrayList.add(ItemInner.asCheckBox(LocaleController.getString(C2888R.string.LocalPhotoCache), 0, this.photoSize, Theme.key_statisticChartLine_lightblue));
            } else {
                c = '\n';
            }
            if (this.videoSize > 0) {
                arrayList.add(ItemInner.asCheckBox(LocaleController.getString(C2888R.string.LocalVideoCache), 1, this.videoSize, Theme.key_statisticChartLine_blue));
            }
            if (this.documentsSize > 0) {
                arrayList.add(ItemInner.asCheckBox(LocaleController.getString(C2888R.string.LocalDocumentCache), 2, this.documentsSize, Theme.key_statisticChartLine_green));
            }
            if (this.musicSize > 0) {
                arrayList.add(ItemInner.asCheckBox(LocaleController.getString(C2888R.string.LocalMusicCache), 3, this.musicSize, Theme.key_statisticChartLine_purple));
            }
            if (this.audioSize > 0) {
                j = 0;
                arrayList.add(ItemInner.asCheckBox(LocaleController.getString(C2888R.string.LocalAudioCache), 4, this.audioSize, Theme.key_statisticChartLine_lightgreen));
            } else {
                j = 0;
            }
            if (this.storiesSize > j) {
                arrayList.add(ItemInner.asCheckBox(LocaleController.getString(C2888R.string.LocalStoriesCache), 5, this.storiesSize, Theme.key_statisticChartLine_red));
            }
            if (this.stickersCacheSize > j) {
                arrayList.add(ItemInner.asCheckBox(LocaleController.getString(C2888R.string.LocalStickersCache), 6, this.stickersCacheSize, Theme.key_statisticChartLine_orange));
            }
            if (this.cacheSize > j) {
                arrayList.add(ItemInner.asCheckBox(LocaleController.getString(C2888R.string.LocalProfilePhotosCache), 7, this.cacheSize, Theme.key_statisticChartLine_cyan));
            }
            if (this.cacheTempSize > j) {
                arrayList.add(ItemInner.asCheckBox(LocaleController.getString(C2888R.string.LocalMiscellaneousCache), 8, this.cacheTempSize, Theme.key_statisticChartLine_purple));
            }
            if (this.logsSize > j) {
                arrayList.add(ItemInner.asCheckBox(LocaleController.getString(C2888R.string.LocalLogsCache), 9, this.logsSize, Theme.key_statisticChartLine_golden));
            }
            if (arrayList.isEmpty()) {
                z2 = false;
            } else {
                ...
                if (arrayList.size() > 5) {
                    ...
                    this.percents[c] = i2;
                    this.itemInners.add(ItemInner.asCheckBox(LocaleController.getString(C2888R.string.LocalOther), -1, j2, Theme.key_statisticChartLine_golden));
                    if (!this.collapsed) {
        ...
        if (z2) {
            ...
            this.itemInners.add(ItemInner.asInfo(LocaleController.getString(C2888R.string.StorageUsageInfo)));
        } else {
            this.sectionsEndRow = -1;
        }
        this.itemInners.add(new ItemInner(3, LocaleController.getString(C2888R.string.AutoDeleteCachedMedia), null));
        ...
        this.itemInners.add(ItemInner.asInfo(LocaleController.getString(C2888R.string.KeepMediaInfoPart)));
        if (this.totalDeviceSize > j) {
            this.itemInners.add(new ItemInner(3, LocaleController.getString(C2888R.string.MaxCacheSize), null));
            this.itemInners.add(new ItemInner(14));
            this.itemInners.add(ItemInner.asInfo(LocaleController.getString(C2888R.string.MaxCacheSizeInfo)));
        }
    ...
    */
    public static int countDirJava(java.lang.String r11, int r12) {
        ...
        L79:
            if (r7 == 0) goto L7f
            int r6 = org.telegram.p029ui.CacheControlActivity.LISTDIR_DOCTYPE_OTHER_THAN_MUSIC
            if (r12 == r6) goto Lc0
        L7f:
            if (r7 != 0) goto L85
            int r6 = org.telegram.p029ui.CacheControlActivity.LISTDIR_DOCTYPE_MUSIC
            if (r12 == r6) goto Lc0
        L85:
            if (r9 == 0) goto L8b
            int r6 = org.telegram.p029ui.CacheControlActivity.LISTDIR_DOCTYPE2_OTHER
            if (r12 == r6) goto Lc0
        L8b:
            if (r9 != 0) goto L91
            int r6 = org.telegram.p029ui.CacheControlActivity.LISTDIR_DOCTYPE2_EMOJI
            if (r12 == r6) goto Lc0
        L91:
            if (r8 == 0) goto L97
            int r6 = org.telegram.p029ui.CacheControlActivity.LISTDIR_DOCTYPE2_OTHER
        ...
        L97:
            if (r8 != 0) goto L9e
            int r6 = org.telegram.p029ui.CacheControlActivity.LISTDIR_DOCTYPE2_TEMP
            if (r12 != r6) goto L9e
            goto Lc0
        L9e:
        ...
        Lc5:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.CacheControlActivity.countDirJava(java.lang.String, int):int");
    }
    ...
    */
    public static void cleanDirJava(java.lang.String r11, int r12, int[] r13, org.telegram.messenger.Utilities.Callback r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.CacheControlActivity.cleanDirJava(java.lang.String, int, int[], org.telegram.messenger.Utilities$Callback):void");
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:199:0x00fa A[PHI: r15 r18
  0x00fa: PHI (r15v21 int) = (r15v12 int), (r15v17 int), (r15v20 int) binds: [B:198:0x00f8, B:253:0x0213, B:239:0x01a5] A[DONT_GENERATE, DONT_INLINE]
  0x00fa: PHI (r18v16 int) = (r18v10 int), (r18v13 int), (r18v10 int) binds: [B:198:0x00f8, B:253:0x0213, B:239:0x01a5] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:200:0x00fe  */
    /* JADX INFO: renamed from: cleanupFoldersInternal */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void lambda$cleanupFolders$11(final org.telegram.messenger.Utilities.Callback2 r23, final java.lang.Runnable r24) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.CacheControlActivity.lambda$cleanupFolders$11(org.telegram.messenger.Utilities$Callback2, java.lang.Runnable):void");
    }
    ...
    public /* synthetic */ void lambda$cleanupFoldersInternal$16(boolean z, final long j, Runnable runnable) {
        ...
        loadDialogEntities();
        PillStackConfig.notifySettingsChanged(PillStackConfig.PillType.CACHE.f298id);
        if (runnable != null) {
            runnable.run();
        }
    }
    ...
    public /* synthetic */ void lambda$cleanupFoldersInternal$15(long j) {
        Bulletin bulletinCreateSimpleBulletin = BulletinFactory.m1246of(this).createSimpleBulletin(C2888R.raw.ic_delete, LocaleController.formatString(C2888R.string.CacheWasCleared, AndroidUtilities.formatFileSize(j)));
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2888R.string.StorageUsage));
        ...
        this.actionModeTitle.setTextSize(AndroidUtilities.m1124dp(18.0f));
        ...
        this.actionModeSubtitle.setTextSize(AndroidUtilities.m1124dp(14.0f));
        ...
        this.actionModeClearButton.setPadding(AndroidUtilities.m1124dp(14.0f), 0, AndroidUtilities.m1124dp(14.0f), 0);
        ...
        this.actionModeClearButton.setText(LocaleController.getString(C2888R.string.CacheClear));
        ...
        ActionBarMenuItem actionBarMenuItemAddItem = this.actionBar.createMenu().addItem(2, C2888R.drawable.ic_ab_other);
        ActionBarMenuSubItem actionBarMenuSubItemAddSubItem = actionBarMenuItemAddItem.addSubItem(3, C2888R.drawable.msg_delete, LocaleController.getString(C2888R.string.ClearLocalDatabase));
        ...
        if (BuildVars.DEBUG_PRIVATE_VERSION) {
            ActionBarMenuSubItem actionBarMenuSubItemAddSubItem2 = actionBarMenuItemAddItem.addSubItem(4, C2888R.drawable.msg_delete, "Full Reset Database");
        ...
        C32692 c32692 = new NestedSizeNotifierLayout(context) { // from class: org.telegram.ui.CacheControlActivity.2
            C32692(Context context2) {
                super(context2);
            }
        ...
        this.nestedSizeNotifierLayout = c32692;
        this.fragmentView = c32692;
        c32692.setBackgroundColor(Theme.getColor(Theme.key_windowBackgroundGray));
        C32703 c32703 = new RecyclerListView(context2) { // from class: org.telegram.ui.CacheControlActivity.3
            C32703(Context context2) {
                super(context2);
            }
        ...
        c32692.addView(this.listView, LayoutHelper.createFrame(-1, -1.0f));
        this.listView.setAdapter(this.listAdapter);
        C32714 c32714 = new DefaultItemAnimator() { // from class: org.telegram.ui.CacheControlActivity.4
            C32714() {
            }
        ...
        c32714.setDurations(350L);
        c32714.setInterpolator(cubicBezierInterpolator);
        c32714.setDelayAnimations(false);
        c32714.setSupportsChangeAnimations(false);
        this.listView.setItemAnimator(c32714);
        ...
        c32692.addView(this.actionBar, LayoutHelper.createFrame(-1, -2.0f));
        this.nestedSizeNotifierLayout.setTargetListView(this.listView);
        return this.fragmentView;
    }

    /* JADX INFO: renamed from: org.telegram.ui.CacheControlActivity$1 */
    /* JADX INFO: loaded from: classes6.dex */
    class C32681 extends ActionBar.ActionBarMenuOnItemClick {
        C32681() {
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.CacheControlActivity$2 */
    /* JADX INFO: loaded from: classes6.dex */
    class C32692 extends NestedSizeNotifierLayout {
        C32692(Context context2) {
            super(context2);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.CacheControlActivity$3 */
    /* JADX INFO: loaded from: classes6.dex */
    class C32703 extends RecyclerListView {
        C32703(Context context2) {
            super(context2);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.CacheControlActivity$4 */
    /* JADX INFO: loaded from: classes6.dex */
    class C32714 extends DefaultItemAnimator {
        C32714() {
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.CacheControlActivity$5 */
    /* JADX INFO: loaded from: classes6.dex */
    class C32725 extends RecyclerView.OnScrollListener {
        boolean pinned;
    ...
    public void clearSelectedFiles() {
        ...
        builder.setTitle(LocaleController.getString(C2888R.string.ClearCache));
        builder.setMessage(LocaleController.getString(C2888R.string.ClearCacheForChats));
        builder.setPositiveButton(LocaleController.getString(C2888R.string.Clear), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.CacheControlActivity$$ExternalSyntheticLambda10
    ...
    public void showClearCacheDialog(DialogFileEntities dialogFileEntities) {
        ...
        DilogCacheBottomSheet dilogCacheBottomSheet = new DilogCacheBottomSheet(this, dialogFileEntities, dialogFileEntities.createCacheModel(), new DilogCacheBottomSheet.Delegate() { // from class: org.telegram.ui.CacheControlActivity.6
            final /* synthetic */ DialogFileEntities val$entities;

            C32736(DialogFileEntities dialogFileEntities2) {
                dialogFileEntities = dialogFileEntities2;
            }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.CacheControlActivity$6 */
    /* JADX INFO: loaded from: classes6.dex */
    class C32736 implements DilogCacheBottomSheet.Delegate {
        final /* synthetic */ DialogFileEntities val$entities;
    ...
    public void cleanupDialogFiles(DialogFileEntities dialogFileEntities, StorageDiagramView.ClearViewData[] clearViewDataArr, CacheModel cacheModel) {
        ...
        int i6 = C2888R.raw.ic_delete;
        int i7 = C2888R.string.CacheWasCleared;
        String fileSize = AndroidUtilities.formatFileSize(j - this.totalSize);
        Object[] objArr = new Object[1];
        objArr[z ? 1 : 0] = fileSize;
        Bulletin bulletinCreateSimpleBulletin = bulletinFactoryM1246of.createSimpleBulletin(i6, LocaleController.formatString(i7, objArr));
    ...
    public void clearDatabase(final boolean z) {
        ...
        builder.setTitle(LocaleController.getString(C2888R.string.LocalDatabaseClearTextTitle));
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        spannableStringBuilder.append((CharSequence) LocaleController.getString(C2888R.string.LocalDatabaseClearText));
        spannableStringBuilder.append((CharSequence) "\n\n");
        spannableStringBuilder.append((CharSequence) AndroidUtilities.replaceTags(LocaleController.formatString("LocalDatabaseClearText2", C2888R.string.LocalDatabaseClearText2, AndroidUtilities.formatFileSize(this.databaseSize))));
        builder.setMessage(spannableStringBuilder);
        builder.setNegativeButton(LocaleController.getString(C2888R.string.Cancel), null);
        builder.setPositiveButton(LocaleController.getString(C2888R.string.CacheClear), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.CacheControlActivity$$ExternalSyntheticLambda12
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
    ...
    class CacheChartHeader extends FrameLayout {
        ...
        public CacheChartHeader(Context context) {
            ...
            this.title.setTextSize(AndroidUtilities.m1124dp(20.0f));
            this.title.setText(LocaleController.getString(C2888R.string.StorageUsage));
            ...
            while (i < 3) {
                ...
                this.subtitle[i].setPadding(AndroidUtilities.m1124dp(24.0f), 0, AndroidUtilities.m1124dp(24.0f), 0);
                if (i == 0) {
                    this.subtitle[i].setText(LocaleController.getString(C2888R.string.StorageUsageCalculating));
                } else if (i == 1) {
                    this.subtitle[i].setAlpha(0.0f);
                    this.subtitle[i].setText(LocaleController.getString(C2888R.string.StorageUsageTelegram));
                    this.subtitle[i].setVisibility(4);
                } else if (i == 2) {
                    this.subtitle[i].setText(LocaleController.getString(C2888R.string.StorageCleared2));
                    this.subtitle[i].setAlpha(0.0f);
                    this.subtitle[i].setVisibility(4);
                }
        ...
        public void setData(boolean z, float f, float f2) {
            ...
            if (z) {
                string = LocaleController.getString(C2888R.string.StorageUsage);
            } else {
                string = LocaleController.getString(C2888R.string.StorageCleared);
            }
            animatedTextView.setText(string);
            if (z) {
                if (f < 0.01f) {
                    this.subtitle[1].setText(LocaleController.formatString(C2888R.string.StorageUsageTelegramLess, CacheControlActivity.this.formatPercent(f)));
                } else {
                    this.subtitle[1].setText(LocaleController.formatString(C2888R.string.StorageUsageTelegram, CacheControlActivity.this.formatPercent(f)));
                }
                switchSubtitle(1);
            } else {
                switchSubtitle(2);
        ...
        private void updateViewVisible(View view, boolean z, boolean z2) {
            ...
            if (!z2) {
                ...
                view.setTranslationY(z ? 0.0f : AndroidUtilities.m1124dp(8.0f));
                invalidate();
                return;
            }
            if (z) {
                if (view.getVisibility() != 0) {
                    ...
                    view.setAlpha(0.0f);
                    view.setTranslationY(AndroidUtilities.m1124dp(8.0f));
                }
        ...
        protected void onMeasure(int i, int i2) {
            ...
            int iMin = (int) Math.min(AndroidUtilities.m1124dp(174.0f), ((double) size) * 0.8d);
            super.measureChildren(View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30), i2);
            int iM1124dp = AndroidUtilities.m1124dp(72.0f);
            int i3 = 0;
            int iMax = 0;
            while (true) {
                TextView[] textViewArr = this.subtitle;
                if (i3 >= textViewArr.length) {
                    setMeasuredDimension(size, iM1124dp + iMax);
                    this.progressRect.set((size - iMin) / 2.0f, r8 - AndroidUtilities.m1124dp(30.0f), (size + iMin) / 2.0f, r8 - AndroidUtilities.m1124dp(26.0f));
                    return;
                }
                iMax = Math.max(iMax, textViewArr[i3].getMeasuredHeight() - (i3 == 2 ? AndroidUtilities.m1124dp(16.0f) : 0));
                i3++;
            }
        }
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            float f6 = 1.0f - f;
            float fMax = Math.max(this.progressRect.left + (Math.max(AndroidUtilities.m1124dp(4.0f), this.progressRect.width() * f5) * f6), this.progressRect.left + (Math.max(AndroidUtilities.m1124dp(4.0f), this.progressRect.width() * f3) * f6)) + AndroidUtilities.m1124dp(1.0f);
            RectF rectF3 = this.progressRect;
            rectF2.set(fMax, rectF3.top, rectF3.right, rectF3.bottom);
            if (rectF2.left >= rectF2.right || rectF2.width() <= AndroidUtilities.m1124dp(3.0f)) {
                rectF = rectF2;
            } else {
                rectF = rectF2;
                drawRoundRect(canvas, rectF, AndroidUtilities.m1124dp(AndroidUtilities.lerp(1, 2, f)), AndroidUtilities.m1124dp(2.0f), this.loadingBackgroundPaint);
            }
            ...
            float fMax2 = this.progressRect.left + (Math.max(AndroidUtilities.m1124dp(4.0f), this.progressRect.width() * f3) * f6) + AndroidUtilities.m1124dp(1.0f);
            RectF rectF4 = this.progressRect;
            rectF.set(fMax2, rectF4.top, rectF4.left + (Math.max(AndroidUtilities.m1124dp(4.0f), this.progressRect.width() * f5) * f6), this.progressRect.bottom);
            if (rectF.width() > AndroidUtilities.m1124dp(3.0f)) {
                drawRoundRect(canvas, rectF, AndroidUtilities.m1124dp(1.0f), AndroidUtilities.m1124dp(f5 > 0.97f ? 2.0f : 1.0f), this.usedPercentPaint);
            }
            ...
            rectF.set(f7, rectF5.top, (f6 * Math.max(AndroidUtilities.m1124dp(4.0f), this.progressRect.width() * f3)) + f7, this.progressRect.bottom);
            drawRoundRect(canvas, rectF, AndroidUtilities.m1124dp(2.0f), AndroidUtilities.m1124dp(f3 > 0.97f ? 2.0f : 1.0f), this.percentPaint);
    ...
    class ClearingCacheView extends FrameLayout {
        ...
        public ClearingCacheView(Context context) {
            ...
            this.imageView.setAnimation(C2888R.raw.utyan_cache, 150, 150);
            ...
            this.percentsTextView.setTextSize(AndroidUtilities.m1124dp(24.0f));
            ...
            this.title.setTypeface(AndroidUtilities.bold());
            this.title.setText(LocaleController.getString(C2888R.string.ClearingCache));
            ...
            this.subtitle.setText(LocaleController.getString(C2888R.string.ClearingCacheDescription));
        ...
        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(350.0f), TLObject.FLAG_30));
        }
        ...
        class ProgressView extends View {
            ...
            protected void onDraw(Canvas canvas) {
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.m1124dp(3.0f), AndroidUtilities.m1124dp(3.0f), this.out);
                rectF.set(0.0f, 0.0f, getMeasuredWidth() * this.progressT.set(this.progress), getMeasuredHeight());
                canvas.drawRoundRect(rectF, AndroidUtilities.m1124dp(3.0f), AndroidUtilities.m1124dp(3.0f), this.f1888in);
            }
        }
    }
    ...
    class ClearCacheButtonInternal extends ClearCacheButton {
        public ClearCacheButtonInternal(Context context) {
            super(context);
            ((ViewGroup.MarginLayoutParams) this.button.getLayoutParams()).topMargin = AndroidUtilities.m1124dp(5.0f);
        ...
        public /* synthetic */ void lambda$new$1(View view) {
            ...
            sb.append(LocaleController.getString(C2888R.string.ClearCache));
            ...
            if (button instanceof TextView) {
                ...
                button.setBackground(Theme.getRoundRectSelectorDrawable(AndroidUtilities.m1124dp(6.0f), Theme.multAlpha(Theme.getColor(i), 0.12f)));
            }
        }
        ...
        /* JADX INFO: renamed from: org.telegram.ui.CacheControlActivity$ClearCacheButtonInternal$1 */
        class DialogC32821 extends BottomSheet {
            @Override // org.telegram.p029ui.ActionBar.BottomSheet
            protected boolean canDismissWithTouchOutside() {
                return false;
            }

            DialogC32821(Context context, boolean z) {
                super(context, z);
            }
        }

        private void doClearCache() {
            final DialogC32821 dialogC32821 = new BottomSheet(getContext(), false) { // from class: org.telegram.ui.CacheControlActivity.ClearCacheButtonInternal.1
                @Override // org.telegram.p029ui.ActionBar.BottomSheet
                protected boolean canDismissWithTouchOutside() {
                    return false;
                }
            ...
            dialogC32821.fixNavigationBar();
            dialogC32821.setCanDismissWithSwipe(false);
            dialogC32821.setCancelable(false);
            final ClearingCacheView clearingCacheView = CacheControlActivity.this.new ClearingCacheView(getContext());
            dialogC32821.setCustomView(clearingCacheView);
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.CacheControlActivity$ClearCacheButtonInternal$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$doClearCache$3(zArr, jArr, dialogC32821);
                }
            }, 150L);
    ...
    public static class ClearCacheButton extends FrameLayout {
        ...
        public ClearCacheButton(Context context) {
            super(context);
            C32741 c32741 = new FrameLayout(context) { // from class: org.telegram.ui.CacheControlActivity.ClearCacheButton.1
                C32741(Context context2) {
                    super(context2);
                }

                @Override // android.view.ViewGroup, android.view.View
                protected void dispatchDraw(Canvas canvas) {
                    int measuredWidth = (((getMeasuredWidth() - AndroidUtilities.m1124dp(8.0f)) - ((int) ClearCacheButton.this.valueTextView.getCurrentWidth())) + ((int) ClearCacheButton.this.textView.getCurrentWidth())) / 2;
                    if (LocaleController.isRTL) {
                        super.dispatchDraw(canvas);
                        return;
                    }
                    ...
                    ClearCacheButton.this.valueTextView.setBounds(measuredWidth + AndroidUtilities.m1124dp(8.0f), 0, getWidth(), getHeight());
            ...
            c32741.setBackground(Theme.AdaptiveRipple.filledRectByKey(i, 24.0f));
            ...
            if (LocaleController.isRTL) {
                ...
                textView.setText(LocaleController.getString(C2888R.string.ClearCache));
            ...
            this.textView.setTextSize(AndroidUtilities.m1124dp(14.0f));
            this.textView.setText(LocaleController.getString(C2888R.string.ClearCache));
            ...
            this.valueTextView.setTextSize(AndroidUtilities.m1124dp(14.0f));
        ...
        /* JADX INFO: renamed from: org.telegram.ui.CacheControlActivity$ClearCacheButton$1 */
        class C32741 extends FrameLayout {
            C32741(Context context2) {
                super(context2);
            }
        ...
        public void setSize(boolean z, long j) {
            ...
            if (z) {
                string = LocaleController.getString(C2888R.string.ClearCache);
            } else {
                string = LocaleController.getString(C2888R.string.ClearSelectedCache);
            }
    ...
    class ListAdapter extends AdapterWithDiffUtils {
        ...
        /* JADX INFO: renamed from: org.telegram.ui.CacheControlActivity$ListAdapter$1 */
        class C32831 extends CacheChart {
            public static /* synthetic */ int $r8$lambda$iMXUJM708KRukDjxcnPvpwfmnk0(int i) {
                return i;
            }

            @Override // org.telegram.p029ui.Components.CacheChart
            protected void onSectionClick(int i) {
            }

            C32831(Context context) {
                super(context);
            }
                ...
                if (i2 >= 0) {
                    CacheControlActivity.this.listView.highlightRow(new RecyclerListView.IntReturnCallback() { // from class: org.telegram.ui.CacheControlActivity$ListAdapter$1$$ExternalSyntheticLambda0
                        ...
                        public final int run() {
                            return CacheControlActivity.ListAdapter.C32831.$r8$lambda$iMXUJM708KRukDjxcnPvpwfmnk0(i2);
                        }
                    }, 0);
                } else {
                    CacheControlActivity.this.listView.removeHighlightRow();
            ...
            if (i == 0) {
                ...
                switch (i) {
                    ...
                    case 4:
                        ...
                        slideChooseView.setOptions(i2 == 3 ? 1 : i2 == 4 ? 0 : i2 + 2, LocaleController.formatPluralString("Days", 3, new Object[0]), LocaleController.formatPluralString("Weeks", 1, new Object[0]), LocaleController.formatPluralString("Months", 1, new Object[0]), LocaleController.getString(C2888R.string.KeepMediaForever));
                    ...
                    case 8:
                        CacheControlActivity cacheControlActivity = CacheControlActivity.this;
                        C32842 c32842 = new CachedMediaLayout(this.mContext, CacheControlActivity.this) { // from class: org.telegram.ui.CacheControlActivity.ListAdapter.2
                            C32842(Context context, BaseFragment baseFragment) {
                                super(context, baseFragment);
                            }

                            @Override // org.telegram.p029ui.CachedMediaLayout, android.widget.FrameLayout, android.view.View
                            protected void onMeasure(int i3, int i4) {
                                super.onMeasure(i3, View.MeasureSpec.makeMeasureSpec((View.MeasureSpec.getSize(i4) - (ActionBar.getCurrentActionBarHeight() / 2)) - AndroidUtilities.m1124dp(12.0f), TLObject.FLAG_30));
                            }

                            @Override // org.telegram.p029ui.CachedMediaLayout
                        ...
                        cacheControlActivity.cachedMediaLayout = c32842;
                        ...
                        c32842.setLayoutParams(new RecyclerView.LayoutParams(-1, -1));
                        view2 = c32842;
                        textSettingsCell = view2;
                        break;
                    case 9:
                        CacheControlActivity cacheControlActivity2 = CacheControlActivity.this;
                        C32831 c32831 = new C32831(this.mContext);
                        cacheControlActivity2.cacheChart = c32831;
                        c32831.setTag(-33024);
                        view = c32831;
                    ...
                    case 14:
                        ...
                        for (int i3 = 0; i3 < arrayList.size(); i3++) {
                            if (((Integer) arrayList.get(i3)).intValue() == 1) {
                                ...
                                strArr[i3] = LocaleController.getString(C2888R.string.NoLimit);
                            } else {
        ...
        /* JADX INFO: renamed from: org.telegram.ui.CacheControlActivity$ListAdapter$2 */
        class C32842 extends CachedMediaLayout {
            C32842(Context context, BaseFragment baseFragment) {
                super(context, baseFragment);
            }
        ...
        /* JADX INFO: renamed from: org.telegram.ui.CacheControlActivity$ListAdapter$3 */
        class C32853 implements CachedMediaLayout.Delegate {
            @Override // org.telegram.ui.CachedMediaLayout.Delegate
            public /* synthetic */ void dismiss() {
                CachedMediaLayout.Delegate.CC.$default$dismiss(this);
            }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (i == CacheControlActivity.this.migrateOldFolderRow) {
                    textSettingsCell.setTextAndValue(LocaleController.getString(C2888R.string.MigrateOldFolder), null, false);
                    return;
                }
                return;
            }
            ...
            if (((ItemInner) CacheControlActivity.this.itemInners.get(i)).keepMediaType == 0) {
                textCell.setTextAndValueAndColorfulIcon(LocaleController.getString(C2888R.string.PrivateChats), keepMediaString, true, C2888R.drawable.msg_filled_menu_users, -11565578, -13276952, true);
            } else if (((ItemInner) CacheControlActivity.this.itemInners.get(i)).keepMediaType == 1) {
                textCell.setTextAndValueAndColorfulIcon(LocaleController.getString(C2888R.string.GroupChats), keepMediaString, true, C2888R.drawable.msg_filled_menu_groups, -11154873, -14175180, true);
            } else if (((ItemInner) CacheControlActivity.this.itemInners.get(i)).keepMediaType == 2) {
                textCell.setTextAndValueAndColorfulIcon(LocaleController.getString(C2888R.string.CacheChannels), keepMediaString, true, C2888R.drawable.msg_filled_menu_channels, -1007845, -1996271, true);
            } else if (((ItemInner) CacheControlActivity.this.itemInners.get(i)).keepMediaType == 3) {
                textCell.setTextAndValueAndColorfulIcon(LocaleController.getString(C2888R.string.CacheStories), keepMediaString, false, C2888R.drawable.msg_filled_stories, -765355, -2148011, false);
            }
    ...
    public static class UserCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
        ...
        public UserCell(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            this.valueTextView.setTextSize(AndroidUtilities.m1124dp(16.0f));
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (this.imageView.getVisibility() == 0) {
                this.imageView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(38.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(38.0f), TLObject.FLAG_30));
            }
            if (this.valueTextView.getVisibility() == 0) {
                ...
                measuredWidth = (measuredWidth - this.valueTextView.getMeasuredWidth()) - AndroidUtilities.m1124dp(8.0f);
            }
            int measuredWidth2 = this.valueTextView.getMeasuredWidth() + AndroidUtilities.m1124dp(12.0f);
            if (LocaleController.isRTL) {
    ...
    public static class ItemInner extends AdapterWithDiffUtils.Item {
        ...
        /* synthetic */ ItemInner(int i, CacheControlActivityIA cacheControlActivityIA) {
            this(i);
        }
