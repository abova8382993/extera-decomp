...
import org.telegram.p029ui.ChangeUsernameActivity;
import org.telegram.p029ui.ChatEditTypeActivity;
...
import org.telegram.p029ui.Components.JoinToSendSettingsView;
...
public class ChatEditTypeActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public boolean onFragmentCreate() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.ChatEditTypeActivity.onFragmentCreate():boolean");
    }
    ...
    public void onResume() {
        ...
        if (textSettingsCell != null && (chatFull = this.info) != null) {
            if (chatFull.stickerset != null) {
                textSettingsCell.setTextAndValue(LocaleController.getString(C2888R.string.GroupStickers), this.info.stickerset.title, false);
            } else {
                textSettingsCell.setText(LocaleController.getString(C2888R.string.GroupStickers), false);
            }
        }
    ...
    public View createView(final Context context) {
        ...
        SectionsScrollView sectionsScrollView = new SectionsScrollView(context, this.linearLayout, this.resourceProvider, false) { // from class: org.telegram.ui.ChatEditTypeActivity.2
            ...
            public boolean requestChildRectangleOnScreen(View view, Rect rect, boolean z) {
                rect.bottom += AndroidUtilities.m1124dp(60.0f);
        ...
        if (this.isForcePublic) {
            this.actionBar.setTitle(LocaleController.getString(C2888R.string.TypeLocationGroup));
        } else if (this.isChannel) {
            this.actionBar.setTitle(LocaleController.getString(C2888R.string.ChannelSettingsTitle));
        } else {
            this.actionBar.setTitle(LocaleController.getString(C2888R.string.GroupSettingsTitle));
        }
        ...
        if (this.isChannel) {
            this.headerCell2.setText(LocaleController.getString(C2888R.string.ChannelTypeHeader));
        } else {
            this.headerCell2.setText(LocaleController.getString(C2888R.string.GroupTypeHeader));
        }
        ...
        if (this.isChannel) {
            radioButtonCell.setTextAndValue(LocaleController.getString(C2888R.string.ChannelPrivate), LocaleController.getString(C2888R.string.ChannelPrivateInfo), false, this.isPrivate);
        } else {
            radioButtonCell.setTextAndValue(LocaleController.getString(C2888R.string.MegaPrivate), LocaleController.getString(C2888R.string.MegaPrivateInfo), false, this.isPrivate);
        }
        ...
        if (this.isChannel) {
            radioButtonCell2.setTextAndValue(LocaleController.getString(C2888R.string.ChannelPublic), LocaleController.getString(C2888R.string.ChannelPublicInfo), false, !this.isPrivate);
        } else {
            radioButtonCell2.setTextAndValue(LocaleController.getString(C2888R.string.MegaPublic), LocaleController.getString(C2888R.string.MegaPublicInfo), false, !this.isPrivate);
        }
        ...
        this.usernameTextView.setHint(LocaleController.getString(C2888R.string.ChannelUsernamePlaceholder));
        this.usernameTextView.setCursorColor(Theme.getColor(i3));
        this.usernameTextView.setCursorSize(AndroidUtilities.m1124dp(20.0f));
        ...
        C37176 c37176 = new C37176(context, 12, this.resourceProvider);
        this.checkTextView = c37176;
        c37176.setBottomPadding(6);
        ...
        textCell.setTextAndIcon((CharSequence) LocaleController.getString(C2888R.string.ManageInviteLinks), C2888R.drawable.msg_link2, false);
        ...
        this.saveHeaderCell.setText(LocaleController.getString(C2888R.string.SavingContentTitle));
        ...
        textCheckCell.setTextAndCheck(LocaleController.getString(C2888R.string.RestrictSavingContent), this.isSaveRestricted, false);
        ...
        if (this.isChannel && !ChatObject.isMegagroup(this.currentChat)) {
            this.saveRestrictInfoCell.setText(LocaleController.getString(C2888R.string.RestrictSavingContentInfoChannel));
        } else {
            this.saveRestrictInfoCell.setText(LocaleController.getString(C2888R.string.RestrictSavingContentInfoGroup));
        }
    ...
    class C37176 extends TextInfoPrivacyCell {
        int prevHeight;
        ValueAnimator translateAnimator;

        C37176(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        @Override // org.telegram.p029ui.Cells.TextInfoPrivacyCell
                ...
                for (int i = 0; i < typefaceSpanArr.length; i++) {
                    charSequence.setSpan(new ClickableSpan() { // from class: org.telegram.ui.ChatEditTypeActivity.6.1
                        ...
                        public void onClick(View view) {
                            Browser.openUrl(C37176.this.getContext(), "https://fragment.com/username/" + string);
                        }
            ...
            if (this.prevHeight != -1 && ChatEditTypeActivity.this.linearLayout != null) {
                ...
                valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.ChatEditTypeActivity$6$$ExternalSyntheticLambda0
                    ...
                    public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                        ChatEditTypeActivity.C37176.m8151$r8$lambda$5iypMHzfd2L8oljr3QXR7PEQpM(arrayList, height, valueAnimator2);
                    }
                });
        ...
        public static /* synthetic */ void m8151$r8$lambda$5iypMHzfd2L8oljr3QXR7PEQpM(ArrayList arrayList, float f, ValueAnimator valueAnimator) {
    ...
    class UsernamesListView extends RecyclerListView {
        ...
        public static /* synthetic */ void m8152$r8$lambda$oQEsyq3f16mseGL6oDuSzZA71Y(TLObject tLObject, TLRPC.TL_error tL_error) {
        }
        ...
        public UsernamesListView(Context context) {
            ...
            setOnItemClickListener(new C37181(ChatEditTypeActivity.this));
        ...
        class C37181 implements RecyclerListView.OnItemClickListener {
            final /* synthetic */ ChatEditTypeActivity val$this$0;

            C37181(ChatEditTypeActivity chatEditTypeActivity) {
            ...
            public void onItemClick(final View view, int i) {
                ...
                if (tL_username.editable) {
                    ...
                    if (view2 instanceof ScrollView) {
                        ((ScrollView) view2).smoothScrollTo(0, chatEditTypeActivity.linkContainer.getTop() - AndroidUtilities.m1124dp(128.0f));
                    }
                ...
                new AlertDialog.Builder(UsernamesListView.this.getContext(), ChatEditTypeActivity.this.getResourceProvider()).setTitle(LocaleController.getString(tL_username.active ? C2888R.string.UsernameDeactivateLink : C2888R.string.UsernameActivateLink)).setMessage(LocaleController.getString(tL_username.active ? C2888R.string.UsernameDeactivateLinkChannelMessage : C2888R.string.UsernameActivateLinkChannelMessage)).setPositiveButton(LocaleController.getString(tL_username.active ? C2888R.string.Hide : C2888R.string.Show), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$1$$ExternalSyntheticLambda1
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                    public final void onClick(AlertDialog alertDialog, int i2) {
                        this.f$0.lambda$onItemClick$4(tL_username, view, alertDialog, i2);
                    }
                }).setNegativeButton(LocaleController.getString(C2888R.string.Cancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$1$$ExternalSyntheticLambda2
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                    public final void onClick(AlertDialog alertDialog, int i2) {
                        alertDialog.dismiss();
                    }
            ...
            public /* synthetic */ void lambda$onItemClick$4(final TLRPC.TL_username tL_username, View view, AlertDialog alertDialog, int i) {
                if (tL_username.editable) {
                    ...
                    tL_inputChannel.channel_id = ChatEditTypeActivity.this.currentChat.f1660id;
            ...
            public /* synthetic */ void lambda$onItemClick$1(final TLRPC.TL_username tL_username, final boolean z) {
                new AlertDialog.Builder(UsernamesListView.this.getContext(), ((RecyclerListView) UsernamesListView.this).resourcesProvider).setTitle(LocaleController.getString(C2888R.string.UsernameActivateErrorTitle)).setMessage(LocaleController.getString(C2888R.string.UsernameActivateErrorMessage)).setPositiveButton(LocaleController.getString(C2888R.string.f1606OK), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$1$$ExternalSyntheticLambda0
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
        ...
        public void sendReorder() {
            ...
            ChatEditTypeActivity.this.getConnectionsManager().sendRequest(tL_channels_reorderUsernames, new RequestDelegate() { // from class: org.telegram.ui.ChatEditTypeActivity$UsernamesListView$$ExternalSyntheticLambda0
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    ChatEditTypeActivity.UsernamesListView.m8152$r8$lambda$oQEsyq3f16mseGL6oDuSzZA71Y(tLObject, tL_error);
                }
            });
            updateChat();
        }
        ...
        private class Adapter extends RecyclerListView.SelectionAdapter {
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
                ...
                if (itemViewType == 0) {
                    ...
                    ((HeaderCell) viewHolder.itemView).setText(LocaleController.getString(C2888R.string.UsernamesChannelHeader));
                    return;
                }
                if (itemViewType != 1) {
                    if (itemViewType != 2) {
                    ...
                    ((TextInfoPrivacyCell) viewHolder.itemView).setText(LocaleController.getString(C2888R.string.UsernamesChannelHelp));
                    ((TextInfoPrivacyCell) viewHolder.itemView).setBackgroundDrawable(Theme.getThemedDrawableByKey(UsernamesListView.this.getContext(), C2888R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                    return;
                }
    ...
    public /* synthetic */ void lambda$loadAdminedChannels$20(View view) {
        ...
        if (this.isChannel) {
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("RevokeLinkAlertChannel", C2888R.string.RevokeLinkAlertChannel, getMessagesController().linkPrefix + "/" + ChatObject.getPublicUsername(currentChannel), currentChannel.title)));
        } else {
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("RevokeLinkAlert", C2888R.string.RevokeLinkAlert, getMessagesController().linkPrefix + "/" + ChatObject.getPublicUsername(currentChannel), currentChannel.title)));
        }
        builder.setNegativeButton(LocaleController.getString(C2888R.string.Cancel), null);
        builder.setPositiveButton(LocaleController.getString(C2888R.string.RevokeButton), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ChatEditTypeActivity$$ExternalSyntheticLambda27
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
    ...
    private void updatePrivatePublic() {
        ...
        if (!this.isPrivate && !this.canCreatePublic && getUserConfig().isPremium()) {
            ...
            this.manageLinksInfoCell.setText(LocaleController.getString((chatFull != null && chatFull.paid_media_allowed && ChatObject.isChannelAndNotMegaGroup(getMessagesController().getChat(Long.valueOf(this.chatId)))) ? C2888R.string.ManageLinksInfoHelpPaid : C2888R.string.ManageLinksInfoHelp));
        }
    ...
    public boolean checkUserName(final String str) {
            ...
            for (int i = 0; i < str.length(); i++) {
                ...
                if (i == 0 && cCharAt >= '0' && cCharAt <= '9') {
                    if (this.isChannel) {
                        ...
                        this.checkTextView.setText(LocaleController.getString(C2888R.string.LinkInvalidStartNumberMega));
                    }
                    this.checkTextView.setTextColorByKey(Theme.key_text_RedRegular);
                    return false;
                }
        ...
        if (str == null || str.length() < 4) {
            if (this.isChannel) {
                ...
                this.checkTextView.setText(LocaleController.getString(C2888R.string.LinkInvalidShortMega));
            }
            this.checkTextView.setTextColorByKey(Theme.key_text_RedRegular);
            return false;
        }
    ...
    public /* synthetic */ void lambda$generateLink$26(TLRPC.TL_error tL_error, TLObject tLObject, boolean z) {
        if (tL_error == null) {
            ...
            if (z) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                builder.setMessage(LocaleController.getString(C2888R.string.RevokeAlertNewLink));
