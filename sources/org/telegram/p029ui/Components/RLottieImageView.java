...
public class RLottieImageView extends ImageView {
    ...
    public void setAnimation(int i, int i2, int i3, int[] iArr) {
        setAnimation(new RLottieDrawable(i, _UrlKt.FRAGMENT_ENCODE_SET + i, AndroidUtilities.m1124dp(i2), AndroidUtilities.m1124dp(i3), false, iArr));
    }
    ...
    public void setAnimation(TLRPC.Document document, final int i, final int i2) {
        ...
        setImageDrawable(new Drawable() { // from class: org.telegram.ui.Components.RLottieImageView.2
            ...
            public void draw(Canvas canvas) {
                ...
                rect.set(getBounds().centerX() - (AndroidUtilities.m1124dp(i) / 2), getBounds().centerY() - (AndroidUtilities.m1124dp(i2) / 2), getBounds().centerX() + (AndroidUtilities.m1124dp(i) / 2), getBounds().centerY() + (AndroidUtilities.m1124dp(i2) / 2));
