...
public class GroupCallFullscreenAdapter extends RecyclerListView.SelectionAdapter {
    ...
    public void scrollTo(ChatObject.VideoParticipant videoParticipant, RecyclerListView recyclerListView) {
        ...
        for (int i = 0; i < this.videoParticipants.size(); i++) {
            if (((ChatObject.VideoParticipant) this.videoParticipants.get(i)).equals(videoParticipant)) {
                linearLayoutManager.scrollToPositionWithOffset(i, AndroidUtilities.m1124dp(13.0f));
                return;
            }
        }
    }
    ...
    public class GroupCallUserCell extends FrameLayout implements GroupCallStatusIcon.Callback {
        ...
        public GroupCallUserCell(Context context) {
            ...
            this.avatarWavesDrawable = new GroupCallUserCell.AvatarWavesDrawable(AndroidUtilities.m1124dp(26.0f), AndroidUtilities.m1124dp(29.0f));
            this.avatarDrawable.setTextSize((int) (AndroidUtilities.m1124dp(18.0f) / 1.15f));
            ...
            this.selectionPaint.setStrokeWidth(AndroidUtilities.m1124dp(2.0f));
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (this.name != null) {
                int iMin = (int) Math.min(AndroidUtilities.m1124dp(46.0f), this.textPaint.measureText(this.name));
                this.nameWidth = iMin;
                this.drawingName = TextUtils.ellipsize(this.name, this.textPaint, iMin, TextUtils.TruncateAt.END).toString();
            }
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(80.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(80.0f), TLObject.FLAG_30));
        }
        ...
        public void setProgressToFullscreen(float f) {
            ...
            float f2 = 1.0f - f;
            float fM1124dp = ((AndroidUtilities.m1124dp(46.0f) / AndroidUtilities.m1124dp(40.0f)) * f2) + (1.0f * f);
            ...
            this.avatarImageView.setScaleX(fM1124dp);
            this.avatarImageView.setScaleY(fM1124dp);
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            float fM1124dp = ((AndroidUtilities.m1124dp(46.0f) / AndroidUtilities.m1124dp(40.0f)) * (1.0f - f)) + (f * 1.0f);
            this.avatarImageView.setScaleX(this.avatarWavesDrawable.getAvatarScale() * fM1124dp);
            this.avatarImageView.setScaleY(this.avatarWavesDrawable.getAvatarScale() * fM1124dp);
        ...
        */
        private void drawSelection(android.graphics.Canvas r7) {
            ...
            L33:
                ...
                int r1 = org.telegram.messenger.AndroidUtilities.m1124dp(r0)
                float r1 = (float) r1
        ...
        public void drawOverlays(Canvas canvas) {
            if (this.drawingName != null) {
                canvas.save();
                int measuredWidth = ((getMeasuredWidth() - this.nameWidth) - AndroidUtilities.m1124dp(24.0f)) / 2;
                this.textPaint.setAlpha((int) (this.progress * 255.0f * getAlpha()));
                canvas.drawText(this.drawingName, AndroidUtilities.m1124dp(22.0f) + measuredWidth, AndroidUtilities.m1124dp(69.0f), this.textPaint);
                canvas.restore();
                canvas.save();
                canvas.translate(measuredWidth, AndroidUtilities.m1124dp(53.0f));
        ...
        */
        public void updateState(boolean r9) {
            ...
            L19:
                ...
                goto L16
            L28:
                int r0 = org.telegram.p029ui.ActionBar.Theme.key_voipgroup_nameText
                int r0 = org.telegram.p029ui.ActionBar.Theme.getColor(r0)
                int r1 = org.telegram.p029ui.ActionBar.Theme.key_voipgroup_listeningText
