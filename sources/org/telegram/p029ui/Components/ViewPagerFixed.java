...
public class ViewPagerFixed extends FrameLayout {
    ...
    */
    private boolean prepareForMoving(android.view.MotionEvent r7, boolean r8) {
        ...
        L9f:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.ViewPagerFixed.prepareForMoving(android.view.MotionEvent, boolean):boolean");
    }
    ...
    */
    public boolean onTouchEventInternal(android.view.MotionEvent r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.ViewPagerFixed.onTouchEventInternal(android.view.MotionEvent):boolean");
    }
    ...
    public static class TabsView extends FrameLayout {
        ...
        public class TabView extends View {
            ...
            @Override // android.view.View
            public int getId() {
                return this.currentTab.f2107id;
            }

            @Override // android.view.View
            protected void onMeasure(int i, int i2) {
                setMeasuredDimension(this.currentTab.getWidth(false, TabsView.this.textPaint) + AndroidUtilities.m1124dp(TabsView.this.tabMarginDp * 2) + TabsView.this.additionalTabWidth, View.MeasureSpec.getSize(i2));
            }
            ...
            protected void onDraw(Canvas canvas) {
                ...
                if (this.currentTab.f2107id != Integer.MAX_VALUE && TabsView.this.editingAnimationProgress != 0.0f) {
                    canvas2.save();
                    float f5 = TabsView.this.editingAnimationProgress * (this.currentPosition % 2 == 0 ? 1.0f : -1.0f);
                    canvas2.translate(AndroidUtilities.m1124dp(0.66f) * f5, 0.0f);
                ...
                int i10 = i;
                int i11 = i2;
                if (this.currentTab.f2107id == i10) {
                ...
                } else if ((TabsView.this.animatingIndicator || TabsView.this.manualScrollingToId != -1) && ((i7 = this.currentTab.f2107id) == i10 || i7 == i11)) {
                ...
                if (i14 > 0) {
                    ...
                    iM1124dp = Math.max(AndroidUtilities.m1124dp(10.0f), iCeil) + AndroidUtilities.m1124dp(10.0f);
                } else {
                    str = null;
                    iCeil = 0;
                    iM1124dp = 0;
                }
                if (this.currentTab.f2107id == Integer.MAX_VALUE || (!TabsView.this.isEditing && TabsView.this.editingStartAnimationProgress == 0.0f)) {
                    f = 0.0f;
                } else {
                    f = 0.0f;
                    iM1124dp = (int) (iM1124dp + ((AndroidUtilities.m1124dp(20.0f) - iM1124dp) * TabsView.this.editingStartAnimationProgress));
                }
                int i15 = iM1124dp;
                int i16 = this.currentTab.titleWidth;
                if (i15 != 0) {
                    iM1124dp2 = AndroidUtilities.m1124dp((str != null ? 1.0f : TabsView.this.editingStartAnimationProgress) * 6.0f) + i15;
                } else {
                    iM1124dp2 = 0;
                }
                this.tabWidth = i16 + iM1124dp2;
                ...
                if (text2 != null) {
                    ...
                    i8 = iCeil;
                    f3 = 1.0f;
                    text2.ellipsize(AndroidUtilities.m1124dp(400.0f)).draw(canvas2, measuredWidth + this.textOffsetX, getMeasuredHeight() / 2, TabsView.this.textPaint.getColor(), 1.0f);
                    canvas2 = canvas2;
                } else {
                    str2 = str;
                    i8 = iCeil;
                ...
                if (str2 != null || (this.currentTab.f2107id != Integer.MAX_VALUE && (TabsView.this.isEditing || TabsView.this.editingStartAnimationProgress != f))) {
                    ...
                    if (Theme.hasThemeKey(i12) && Theme.hasThemeKey(i13)) {
                        ...
                        if ((TabsView.this.animatingIndicator || TabsView.this.manualScrollingToPosition != -1) && ((i9 = this.currentTab.f2107id) == i10 || i9 == i11)) {
                    ...
                    int iM1124dp3 = measuredWidth + this.currentTab.titleWidth + AndroidUtilities.m1124dp(6.0f);
                    int measuredHeight = (getMeasuredHeight() - AndroidUtilities.m1124dp(20.0f)) / 2;
                    if (this.currentTab.f2107id != Integer.MAX_VALUE && ((TabsView.this.isEditing || TabsView.this.editingStartAnimationProgress != f) && str2 == null)) {
                    ...
                    this.rect.set(iM1124dp3, measuredHeight, iM1124dp3 + i15, AndroidUtilities.m1124dp(20.0f) + measuredHeight);
                    RectF rectF = this.rect;
                    float f6 = AndroidUtilities.density;
                    canvas2.drawRoundRect(rectF, f6 * 11.5f, f6 * 11.5f, TabsView.this.counterPaint);
                    if (str2 != null) {
                        if (this.currentTab.f2107id != Integer.MAX_VALUE) {
                            TabsView.this.textCounterPaint.setAlpha((int) ((f3 - TabsView.this.editingStartAnimationProgress) * 255.0f));
                        }
                        RectF rectF2 = this.rect;
                        canvas2.drawText(str2, rectF2.left + ((rectF2.width() - i8) / f2), measuredHeight + AndroidUtilities.m1124dp(14.5f), TabsView.this.textCounterPaint);
                    }
                    if (this.currentTab.f2107id != Integer.MAX_VALUE && (TabsView.this.isEditing || TabsView.this.editingStartAnimationProgress != f)) {
                        ...
                        canvas2.drawLine(this.rect.centerX() - fM1124dp, this.rect.centerY() - fM1124dp, this.rect.centerX() + fM1124dp, this.rect.centerY() + fM1124dp, TabsView.this.deletePaint);
                        canvas.drawLine(this.rect.centerX() - fM1124dp, this.rect.centerY() + fM1124dp, this.rect.centerX() + fM1124dp, this.rect.centerY() - fM1124dp, TabsView.this.deletePaint);
                    }
                }
                if (this.currentTab.f2107id != Integer.MAX_VALUE && TabsView.this.editingAnimationProgress != f) {
                    canvas.restore();
                }
                canvas.restore();
            }
            ...
            public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
                ...
                accessibilityNodeInfo.setSelected((this.currentTab == null || TabsView.this.selectedTabId == -1 || this.currentTab.f2107id != TabsView.this.selectedTabId) ? false : true);
            }
        }
        ...
        public TabsView(Context context, boolean z, int i, Theme.ResourcesProvider resourcesProvider) {
            ...
            textPaint.setTextSize(AndroidUtilities.m1124dp((i == 9 || i == 10 || i == -2) ? 14.0f : 15.0f));
                ...
                public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int i3) {
                    LinearSmoothScroller linearSmoothScroller = new LinearSmoothScroller(recyclerView.getContext()) { // from class: org.telegram.ui.Components.ViewPagerFixed.TabsView.3.1
                        ...
                        protected void onTargetFound(View view, RecyclerView.State state2, RecyclerView.SmoothScroller.Action action) {
                            ...
                            } else if (iCalculateDxToMakeVisible < 0 || (iCalculateDxToMakeVisible == 0 && view.getRight() + AndroidUtilities.m1124dp(21.0f) > TabsView.this.getMeasuredWidth())) {
                                iCalculateDxToMakeVisible -= AndroidUtilities.m1124dp(60.0f);
                            }
            ...
            this.listView.setPadding(AndroidUtilities.m1124dp(7.0f), 0, AndroidUtilities.m1124dp(7.0f), 0);
        ...
        public /* synthetic */ void lambda$new$0(View view, int i, float f, float f2) {
            ...
            if (tabsViewDelegate2 == null || tabsViewDelegate2.canPerformActions()) {
                ...
                if (callback2Return == null || !((Boolean) callback2Return.run(Integer.valueOf(tabView.currentTab.f2107id), Integer.valueOf(i))).booleanValue()) {
                    scrollToTab(tabView.currentTab.f2107id, i);
                }
            }
        }
        ...
        public /* synthetic */ boolean lambda$new$1(View view, int i) {
            ...
            return ((Boolean) callback2Return.run(Integer.valueOf(((TabView) view).currentTab.f2107id), view)).booleanValue();
        }
        ...
        public void addTab(int i, CharSequence charSequence) {
            ...
            this.allTabsWidth += tab.getWidth(true, this.textPaint) + AndroidUtilities.m1124dp(this.tabMarginDp * 2);
            this.tabs.add(tab);
        }
                ...
                this.itemTouchHelper = new ItemTouchHelper(new ItemTouchHelper.Callback() { // from class: org.telegram.ui.Components.ViewPagerFixed.TabsView.6
                    ...
                    public boolean onMove(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder viewHolder2) {
                        ...
                        while (i < size) {
                            ...
                            i++;
                            arrayList.add(Integer.valueOf(((Tab) obj).f2107id));
                        }
        ...
        private void updateTabsWidths() {
            ...
            for (int i = 0; i < size; i++) {
                ...
                this.positionToX.put(i, (this.additionalTabWidth / 2) + iM1124dp);
                iM1124dp += width + AndroidUtilities.m1124dp(this.tabMarginDp * 2) + this.additionalTabWidth;
            }
        }
        ...
        */
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (!this.tabs.isEmpty()) {
                int size = (View.MeasureSpec.getSize(i) - AndroidUtilities.m1124dp(7.0f)) - AndroidUtilities.m1124dp(7.0f);
        ...
        public void setIsEditing(boolean z) {
            ...
            for (int i = 0; i < size; i++) {
                arrayList.get(i);
                tL_messages_updateDialogFiltersOrder.order.add(Integer.valueOf(arrayList.get(i).f1601id));
            }
        ...
        private class ListAdapter extends RecyclerListView.SelectionAdapter {
            ...
            public long getItemId(int i) {
                return ((Tab) TabsView.this.tabs.get(i)).f2107id;
            }
        ...
        while (true) {
            ...
            if (view != null && view.getVisibility() == 0 && (recyclerListViewFindRecyclerView = findRecyclerView(this.viewPages[i])) != null) {
                for (int i2 = 0; i2 < recyclerListViewFindRecyclerView.getChildCount(); i2++) {
                    ...
                    if (childAt.getY() < AndroidUtilities.m1124dp(203.0f) + AndroidUtilities.m1124dp(100.0f)) {
