...
import org.telegram.p029ui.Adapters.MentionsAdapter;
import org.telegram.p029ui.Adapters.PaddedListAdapter;
...
public abstract class MentionsContainerView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public MentionsContainerView(Context context, long j, long j2, BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider) {
            ...
            */
            public org.telegram.ui.PhotoViewer.PlaceProviderObject getPlaceForPhoto(org.telegram.messenger.MessageObject r4, org.telegram.tgnet.TLRPC.FileLocation r5, int r6, boolean r7, boolean r8) {
                /*
                    ...
                    r4 = 0
                    if (r6 < 0) goto L75
                    org.telegram.ui.Components.MentionsContainerView r5 = org.telegram.p029ui.Components.MentionsContainerView.this
                    java.util.ArrayList r5 = org.telegram.p029ui.Components.MentionsContainerView.m10836$$Nest$fgetbotContextResults(r5)
                    int r5 = r5.size()
                    if (r6 < r5) goto L10
                    goto L75
                L10:
                    ...
                    org.telegram.ui.Components.MentionsContainerView r7 = org.telegram.p029ui.Components.MentionsContainerView.this
                    java.util.ArrayList r7 = org.telegram.p029ui.Components.MentionsContainerView.m10836$$Nest$fgetbotContextResults(r7)
                    java.lang.Object r6 = r7.get(r6)
                    r7 = 0
                    r8 = r7
                L26:
                    if (r8 >= r5) goto L75
                    org.telegram.ui.Components.MentionsContainerView r0 = org.telegram.p029ui.Components.MentionsContainerView.this
                    org.telegram.ui.Components.MentionsContainerView$MentionsListView r0 = r0.getListView()
                    android.view.View r0 = r0.getChildAt(r8)
                    boolean r1 = r0 instanceof org.telegram.p029ui.Cells.ContextLinkCell
                    if (r1 == 0) goto L44
                    r1 = r0
                    org.telegram.ui.Cells.ContextLinkCell r1 = (org.telegram.p029ui.Cells.ContextLinkCell) r1
                ...
                L45:
                    ...
                    r4 = r4[r6]
                    r5.viewY = r4
                    org.telegram.ui.Components.MentionsContainerView r4 = org.telegram.p029ui.Components.MentionsContainerView.this
                ...
                L75:
                    return r4
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.MentionsContainerView.C45485.getPlaceForPhoto(org.telegram.messenger.MessageObject, org.telegram.tgnet.TLRPC$FileLocation, int, boolean, boolean):org.telegram.ui.PhotoViewer$PlaceProviderObject");
            }
        ...
        this.listViewPadding = (int) Math.min(AndroidUtilities.m1124dp(126.0f), AndroidUtilities.displaySize.y * 0.22f);
        this.listView = new MentionsListView(context, resourcesProvider);
        C45441 c45441 = new LinearLayoutManager(context) { // from class: org.telegram.ui.Components.MentionsContainerView.1
            @Override // androidx.recyclerview.widget.LinearLayoutManager, androidx.recyclerview.widget.RecyclerView.LayoutManager
            public boolean supportsPredictiveItemAnimations() {
                return false;
            }

            C45441(Context context2) {
                super(context2);
            }
            ...
            public void setReverseLayout(boolean z) {
                ...
                MentionsContainerView.this.listView.setTranslationY((z ? -1 : 1) * AndroidUtilities.m1124dp(6.0f));
            }
        };
        this.linearLayoutManager = c45441;
        c45441.setOrientation(1);
        C45452 c45452 = new ExtendedGridLayoutManager(context2, 100, false, false) { // from class: org.telegram.ui.Components.MentionsContainerView.2
            private Size size = new Size();

            C45452(Context context2, int i, boolean z, boolean z2) {
            ...
            protected Size getSizeForItem(int i) {
                ...
                if (item instanceof TLRPC.BotInlineResult) {
                    ...
                    if (document != null) {
                        ...
                        size4.width = closestPhotoSizeWithSize2 != null ? closestPhotoSizeWithSize2.f1694w : 100.0f;
                        size4.height = closestPhotoSizeWithSize2 != null ? closestPhotoSizeWithSize2.f1693h : 100.0f;
                        while (i2 < botInlineResult.document.attributes.size()) {
                            ...
                            if ((documentAttribute instanceof TLRPC.TL_documentAttributeImageSize) || (documentAttribute instanceof TLRPC.TL_documentAttributeVideo)) {
                                ...
                                size5.width = documentAttribute.f1671w;
                                size5.height = documentAttribute.f1670h;
                                break;
                            }
                            i2++;
                        }
                        ...
                        while (i2 < botInlineResult.content.attributes.size()) {
                            ...
                            if ((documentAttribute2 instanceof TLRPC.TL_documentAttributeImageSize) || (documentAttribute2 instanceof TLRPC.TL_documentAttributeVideo)) {
                                ...
                                size6.width = documentAttribute2.f1671w;
                                size6.height = documentAttribute2.f1670h;
                                break;
                            }
                            i2++;
                        }
                        ...
                        while (i2 < botInlineResult.thumb.attributes.size()) {
                            ...
                            if ((documentAttribute3 instanceof TLRPC.TL_documentAttributeImageSize) || (documentAttribute3 instanceof TLRPC.TL_documentAttributeVideo)) {
                                ...
                                size7.width = documentAttribute3.f1671w;
                                size7.height = documentAttribute3.f1670h;
                                break;
                            }
                            i2++;
                        }
                        ...
                        if (photo != null && (closestPhotoSizeWithSize = FileLoader.getClosestPhotoSizeWithSize(photo.sizes, AndroidUtilities.getPhotoSize())) != null) {
                            ...
                            size8.width = closestPhotoSizeWithSize.f1694w;
                            size8.height = closestPhotoSizeWithSize.f1693h;
                        }
                    }
                }
                return this.size;
        ...
        this.gridLayoutManager = c45452;
        c45452.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() { // from class: org.telegram.ui.Components.MentionsContainerView.3
            C45463() {
            }
        ...
        this.listView.setTranslationY(AndroidUtilities.m1124dp(6.0f));
        addView(this.listView, LayoutHelper.createFrame(-1, -1.0f));
        setReversed(false);
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.MentionsContainerView$1 */
    class C45441 extends LinearLayoutManager {
        @Override // androidx.recyclerview.widget.LinearLayoutManager, androidx.recyclerview.widget.RecyclerView.LayoutManager
        public boolean supportsPredictiveItemAnimations() {
            return false;
        }
    ...
    class C45452 extends ExtendedGridLayoutManager {
        private Size size = new Size();
    ...
    class C45463 extends GridLayoutManager.SpanSizeLookup {
        C45463() {
        }
    ...
    class C45474 implements MentionsAdapter.MentionsAdapterDelegate {
        C45474() {
        }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        this.containerPadding = AndroidUtilities.m1124dp(((this.adapter.isStickers() || this.adapter.isBotContext()) && this.adapter.isMediaLayout() && this.adapter.getBotContextSwitch() == null && this.adapter.getBotWebViewSwitch() == null ? 2 : 0) + 2);
        canvas.save();
        ...
        if (zIsReversed) {
            ...
            fMin = Math.min(fM1124dp, Math.abs(getMeasuredHeight() - this.containerBottom));
            if (fMin > 0.0f) {
            ...
            if (this.listView.getLayoutManager() == this.gridLayoutManager) {
                this.containerPadding += AndroidUtilities.m1124dp(2.0f);
                fM1124dp += AndroidUtilities.m1124dp(2.0f);
            }
            ...
            fMin = Math.min(fM1124dp, Math.abs(this.containerTop));
            if (fMin > 0.0f) {
                canvas.clipRect(0, 0, getWidth(), getHeight());
        ...
        if (this.paint == null) {
            ...
            this.paint = paint;
            paint.setShadowLayer(AndroidUtilities.m1124dp(4.0f), 0.0f, 0.0f, 503316480);
        }
    ...
    public void updateVisibility(boolean z) {
        if (z) {
            ...
            if (!this.shown) {
                ...
                if (getVisibility() == 8) {
                    this.hideT = 1.0f;
                    this.listView.setTranslationY(zIsReversed ? -(this.listViewPadding + AndroidUtilities.m1124dp(12.0f)) : r2.computeVerticalScrollOffset() + this.listViewPadding);
                }
            }
            setVisibility(0);
        } else {
    ...
    private void updateListViewTranslation(final boolean z, boolean z2) {
        ...
        boolean zIsReversed = isReversed();
        if (z) {
            fM1124dp = (-this.containerPadding) - AndroidUtilities.m1124dp(6.0f);
        } else {
        ...
        float fMax = zIsReversed ? -Math.max(0.0f, f - fM1124dp) : Math.max(0.0f, f - fM1124dp) + (-f);
        if (z && !zIsReversed) {
    ...
    class C45485 extends PhotoViewer.EmptyPhotoViewerProvider {
        C45485() {
        }
    ...
    public /* synthetic */ void lambda$withDelegate$4(Delegate delegate, View view, int i) {
        ...
        if (item instanceof TLRPC.TL_document) {
            ...
            if (UserObject.getPublicUsername(user) != null) {
                ...
                spannableString.setSpan(new URLSpanUserMention(_UrlKt.FRAGMENT_ENCODE_SET + user.f1825id, 3), 0, firstName.length() + 1, 33);
    ...
    public class MentionsListView extends RecyclerListView {
        ...
        public MentionsListView(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.Components.MentionsContainerView.MentionsListView.1
                ...
                C45491(MentionsContainerView mentionsContainerView) {
            ...
            addItemDecoration(new RecyclerView.ItemDecoration() { // from class: org.telegram.ui.Components.MentionsContainerView.MentionsListView.2
                ...
                C45502(MentionsContainerView mentionsContainerView) {
                    mentionsContainerView = mentionsContainerView;
                }
                ...
                public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
                    ...
                    rect.right = MentionsContainerView.this.gridLayoutManager.isLastInRow(childAdapterPosition) ? 0 : AndroidUtilities.m1124dp(2.0f);
                }
            });
        }

        /* JADX INFO: renamed from: org.telegram.ui.Components.MentionsContainerView$MentionsListView$1 */
        class C45491 extends RecyclerView.OnScrollListener {
            final /* synthetic */ MentionsContainerView val$this$0;
        ...
        class C45502 extends RecyclerView.ItemDecoration {
            final /* synthetic */ MentionsContainerView val$this$0;
        ...
        protected void onMeasure(int i, int i2) {
            ...
            MentionsContainerView.this.listViewPadding = (int) Math.min(AndroidUtilities.m1124dp(126.0f), AndroidUtilities.displaySize.y * 0.22f);
    ...
    public void checkBackgroundBounds() {
        ...
        BlurredBackgroundDrawable blurredBackgroundDrawable = this.backgroundDrawable;
        if (blurredBackgroundDrawable != null) {
            blurredBackgroundDrawable.setBounds(0, ((int) this.containerTop) - AndroidUtilities.m1124dp(5.0f), getMeasuredWidth(), ((int) this.containerBottom) + AndroidUtilities.m1124dp(5.0f));
            this.clipPath.rewind();
            this.clipBounds.set(this.backgroundDrawable.getPaddedBounds());
            if (isGif()) {
                this.clipBounds.inset(AndroidUtilities.m1124dp(2.0f), AndroidUtilities.m1124dp(2.0f));
                this.clipPath.addRoundRect(this.clipBounds, AndroidUtilities.m1124dp(20.0f), AndroidUtilities.m1124dp(20.0f), Path.Direction.CW);
            } else {
                this.clipPath.addRoundRect(this.clipBounds, AndroidUtilities.m1124dp(22.0f), AndroidUtilities.m1124dp(22.0f), Path.Direction.CW);
            }
            this.clipPath.close();
            invalidate();
        }
    ...
    private void checkListViewPadding() {
        ...
        if (this.backgroundDrawable == null) {
            ...
            this.listView.setPadding(AndroidUtilities.m1124dp(zIsGif ? 7.0f : 5.0f), zIsGif ? AndroidUtilities.m1124dp(2.0f) : 0, AndroidUtilities.m1124dp(zIsGif ? 7.0f : 5.0f), zIsGif ? AndroidUtilities.m1124dp(2.0f) : 0);
        }
    }
}
