...
public class TermsOfServiceView extends FrameLayout {
    ...
    public TermsOfServiceView(Context context) {
        ...
        imageView.setImageResource(C2888R.drawable.logo_middle);
        ...
        this.titleTextView.setText(LocaleController.getString(C2888R.string.PrivacyPolicyAndTerms));
        ...
        this.textView.setLineSpacing(AndroidUtilities.m1124dp(2.0f), 1.0f);
        linearLayout.addView(this.textView, LayoutHelper.createLinear(-1, -2, 3, 0, 15, 0, 15));
        ScrollView scrollView = new ScrollView(context);
        this.scrollView = scrollView;
        scrollView.setVerticalScrollBarEnabled(false);
        this.scrollView.setOverScrollMode(2);
        this.scrollView.setPadding(AndroidUtilities.m1124dp(24.0f), i, AndroidUtilities.m1124dp(24.0f), AndroidUtilities.m1124dp(75.0f));
        ...
        textView3.setText(LocaleController.getString(C2888R.string.Decline).toUpperCase());
        ...
        textView3.setPadding(AndroidUtilities.m1124dp(20.0f), AndroidUtilities.m1124dp(10.0f), AndroidUtilities.m1124dp(20.0f), AndroidUtilities.m1124dp(10.0f));
        ...
        textView4.setText(LocaleController.getString(C2888R.string.Accept));
        textView4.setGravity(17);
        textView4.setTypeface(AndroidUtilities.bold());
        textView4.setTextColor(-1);
        textView4.setTextSize(1, 14.0f);
        textView4.setBackgroundDrawable(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1124dp(4.0f), -11491093, -12346402));
        ...
        layoutParams.bottomMargin = AndroidUtilities.m1124dp(75.0f);
    ...
    public /* synthetic */ void lambda$new$4(View view) {
        ...
        builder.setTitle(LocaleController.getString(C2888R.string.TermsOfService));
        builder.setPositiveButton(LocaleController.getString(C2888R.string.DeclineDeactivate), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.TermsOfServiceView$$ExternalSyntheticLambda3
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
                this.f$0.lambda$new$3(alertDialog, i);
            }
        });
        builder.setNegativeButton(LocaleController.getString(C2888R.string.Back), null);
        builder.setMessage(LocaleController.getString(C2888R.string.TosUpdateDecline));
        builder.show();
    }
    ...
    public /* synthetic */ void lambda$new$3(AlertDialog alertDialog, int i) {
        ...
        builder.setPositiveButton(LocaleController.getString(C2888R.string.Deactivate), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.TermsOfServiceView$$ExternalSyntheticLambda5
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
    ...
    public /* synthetic */ void lambda$new$6(View view) {
        if (this.currentTos.min_age_confirm != 0) {
            AlertDialog.Builder builder = new AlertDialog.Builder(view.getContext());
            builder.setTitle(LocaleController.getString(C2888R.string.TosAgeTitle));
            builder.setPositiveButton(LocaleController.getString(C2888R.string.Agree), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.TermsOfServiceView$$ExternalSyntheticLambda2
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i) {
            ...
            builder.setNegativeButton(LocaleController.getString(C2888R.string.Cancel), null);
            builder.setMessage(LocaleController.formatString("TosAgeText", C2888R.string.TosAgeText, LocaleController.formatPluralString("Years", this.currentTos.min_age_confirm, new Object[0])));
            builder.show();
            return;
        }
        accept();
    ...
    private void accept() {
        ...
        tL_help_acceptTermsOfService.f1724id = this.currentTos.f1726id;
    ...
    public void show(int i, TLRPC.TL_help_termsOfService tL_help_termsOfService) {
        ...
        addBulletsToText(spannableStringBuilder, SignatureVisitor.SUPER, AndroidUtilities.m1124dp(10.0f), -11491093, AndroidUtilities.m1124dp(4.0f));
