...
import org.telegram.p029ui.Components.EdgeEffectTrackerFactory;
...
import org.telegram.p029ui.Components.blur3.drawable.color.BlurredBackgroundProvider;
...
public class RecyclerListView extends RecyclerView implements IBlur3Capture {
    ...
    class C49291 extends View.AccessibilityDelegate {
        C49291() {
        }
    ...
    public static abstract class SectionsAdapter extends FastScrollAdapter {
        ...
        /* JADX INFO: loaded from: classes7.dex */
        class C49391 extends DiffUtil.Callback {
            final /* synthetic */ ArrayList val$oldHashes;
    ...
    public class FastScroll extends View {
        ...
        class RunnableC49361 implements Runnable {
            RunnableC49361() {
            }
        ...
        public FastScroll(Context context, int i) {
            ...
            this.type = i;
            if (i == 0) {
                this.letterPaint.setTextSize(AndroidUtilities.m1124dp(45.0f));
                this.isRtl = LocaleController.isRTL;
            } else {
                this.isRtl = false;
                this.letterPaint.setTextSize(AndroidUtilities.m1124dp(13.0f));
                ...
                Drawable drawableMutate = ContextCompat.getDrawable(context, C2888R.drawable.calendar_date).mutate();
            ...
            for (int i3 = 0; i3 < 8; i3++) {
                this.radii[i3] = AndroidUtilities.m1124dp(44.0f);
            }
            this.scrollX = AndroidUtilities.m1124dp(this.isRtl ? 10.0f : (i == 0 ? 132 : 240) - 15);
            if (RecyclerListView.this.hasSections()) {
                this.scrollX += AndroidUtilities.m1124dp(this.isRtl ? -4.0f : 6.0f);
            }
            updateColors();
            setFocusableInTouchMode(true);
            this.touchSlop = ViewConfiguration.get(context).getScaledTouchSlop();
            this.fastScrollShadowDrawable = ContextCompat.getDrawable(context, C2888R.drawable.fast_scroll_shadow);
        }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:165:0x0159, code lost:
            ...
            if (r0 <= (org.telegram.messenger.AndroidUtilities.m1124dp(30.0f) + r8)) goto L167;
         */
        @Override // android.view.View
        /*
        ...
        */
                ...
                if (linearLayoutManager.getOrientation() == 1) {
                    ...
                    if (adapter instanceof FastScrollAdapter) {
                        ...
                        if (this.letterLayout.getLineCount() > 0) {
                            ...
                            if (this.isRtl) {
                                this.textX = (AndroidUtilities.m1124dp(10.0f) + ((AndroidUtilities.m1124dp(88.0f) - this.letterLayout.getLineWidth(0)) / 2.0f)) - this.letterLayout.getLineLeft(0);
                            } else {
                                this.textX = ((AndroidUtilities.m1124dp(88.0f) - this.letterLayout.getLineWidth(0)) / 2.0f) - this.letterLayout.getLineLeft(0);
                            }
                            this.textY = (AndroidUtilities.m1124dp(88.0f) - this.letterLayout.getHeight()) / 2;
                        }
                    }
                }
            }
        ...
        protected void onMeasure(int i, int i2) {
            setMeasuredDimension(AndroidUtilities.m1124dp(this.type == 0 ? 132.0f : 240.0f), View.MeasureSpec.getSize(i2));
            this.arrowPath.reset();
            this.arrowPath.setLastPoint(0.0f, 0.0f);
            this.arrowPath.lineTo(AndroidUtilities.m1124dp(4.0f), -AndroidUtilities.m1124dp(4.0f));
            this.arrowPath.lineTo(-AndroidUtilities.m1124dp(4.0f), -AndroidUtilities.m1124dp(4.0f));
        ...
        */
        ...
        public int getScrollBarY() {
            return ((int) Math.ceil((getMeasuredHeight() - AndroidUtilities.m1124dp(54.0f)) * this.progress)) + AndroidUtilities.m1124dp(17.0f);
        }
        ...
        public void applyBlurDrawables(BlurredBackgroundDrawableViewFactory blurredBackgroundDrawableViewFactory, BlurredBackgroundProvider blurredBackgroundProvider) {
            ...
            this.blurredCircleDrawable.setRadius(AndroidUtilities.m1124dp(24.0f));
            ...
            this.blurredTagDrawable.setRadius(AndroidUtilities.m1124dp(14.0f));
        }
    ...
    class RecyclerListViewItemClickListener implements RecyclerView.OnItemTouchListener {
        ...
        class C49381 extends GestureDetectorFixDoubleTap.OnGestureListener {
            ...
            C49381(RecyclerListView recyclerListView) {
    ...
    class C49302 extends RecyclerView.AdapterDataObserver {
        C49302() {
        }
    ...
    public RecyclerListView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.scroller = new Runnable() { // from class: org.telegram.ui.Components.RecyclerListView.6
            ...
            public void run() {
                ...
                RecyclerListView.this.multiSelectionListener.scrollBy(iM1124dp);
    ...
    class C49313 extends RecyclerView.OnScrollListener {
        C49313() {
        }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (fastScroll != null && fastScroll.getLayoutParams() != null) {
            ...
            this.fastScroll.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(132.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(measuredHeight, TLObject.FLAG_30));
        }
                    ...
                    if (this.sectionsAdapter != null) {
                            ...
                            if (i == 2) {
                                ...
                                for (int i4 = 0; i4 < childCount; i4++) {
                                    ...
                                    if (bottom > this.sectionOffset + paddingTop) {
                                        ...
                                        if (bottom >= this.sectionOffset + paddingTop + AndroidUtilities.m1124dp(32.0f) && bottom < i3) {
                                            view2 = childAt;
                                            i3 = bottom;
                                        }
                                    }
                        ...
                        while (i7 < childCount2) {
                            ...
                            if (bottom2 > this.sectionOffset + paddingTop) {
                                ...
                                if (bottom2 >= this.sectionOffset + paddingTop + AndroidUtilities.m1124dp(f2) && bottom2 < i8) {
                                    i8 = bottom2;
                                }
                            }
                            i7++;
                                ...
                                if (i10 == this.startSection) {
                                    ...
                                    if (positionInSectionForPosition2 == countForSection3 - 1) {
                                        ...
                                        if (childAt3 != null) {
                                            ...
                                            top = -AndroidUtilities.m1124dp(100.0f);
                                        }
                                    ...
                                    if (childAt4 != null) {
                                        ...
                                        sectionHeaderView2.setTag(Integer.valueOf(-AndroidUtilities.m1124dp(100.0f)));
                                    }
                                }
                                i9 += countForSection3;
                            }
    ...
    class C49324 extends AnimatorListenerAdapter {
        C49324() {
        }
    ...
    class C49335 extends FrameLayout {
        C49335(Context context) {
            super(context);
        }
    ...
    public static class FoucsableOnTouchListener implements View.OnTouchListener {
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            ...
            if (motionEvent.getAction() == 0) {
                this.f2059x = motionEvent.getX();
                this.f2060y = motionEvent.getY();
                this.onFocus = true;
                parent.requestDisallowInterceptTouchEvent(true);
            }
            if (motionEvent.getAction() == 2) {
                float x = this.f2059x - motionEvent.getX();
                float y = this.f2060y - motionEvent.getY();
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.multiSelectionGesture && motionEvent.getAction() != 0 && motionEvent.getAction() != 1 && motionEvent.getAction() != 3) {
            ...
            if (this.multiSelectionGestureStarted) {
                ...
                if (motionEvent.getY() > (getMeasuredHeight() - AndroidUtilities.m1124dp(56.0f)) - this.listPaddings[1] && (this.currentSelectedPosition >= this.startSelectionFrom || !this.multiSelectionListener.limitReached())) {
                    startMultiselectScroll(false);
                } else if (motionEvent.getY() < AndroidUtilities.m1124dp(56.0f) + this.listPaddings[0] && (this.currentSelectedPosition <= this.startSelectionFrom || !this.multiSelectionListener.limitReached())) {
    ...
    class RunnableC49346 implements Runnable {
        RunnableC49346() {
        }
    ...
    public void setSections() {
        setSections(AndroidUtilities.m1124dp(12.0f), AndroidUtilities.m1124dp(16.0f), false);
    }

    public void setSections(boolean z) {
        setSections(AndroidUtilities.m1124dp(12.0f), AndroidUtilities.m1124dp(16.0f), z);
    }
    ...
    public static class ListSectionsDecoration extends RecyclerView.ItemDecoration implements IBlur3Capture {
        ...
        public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
            ...
            if (((Boolean) this.isSectionItem.run(view)).booleanValue()) {
                ...
                if (z) {
                    rect.top = this.enableTopPadding ? this.padding : AndroidUtilities.m1124dp(4.0f);
                }
                if (z2) {
    ...
    public Drawable getClipBackground(View view) {
        ...
        return new Drawable() { // from class: org.telegram.ui.Components.RecyclerListView.7
            ...
            C49357(View view2, Path path2, RectF rectF2) {
                view = view2;
                path = path2;
                rectF = rectF2;
            }
    ...
    public static class SectionsDrawer {
        ...
        public static void draw(List list, float f, Utilities.Callback5 callback5) {
            ...
            for (int i2 = 0; i2 < list.size(); i2 = i) {
                float fMax = ((Section) list.get(i2)).f2061to;
                i = i2 + 1;
                while (i < list.size() && ((Section) list.get(i)).from <= 1.5f + fMax) {
                    fMax = Math.max(fMax, ((Section) list.get(i)).f2061to);
                    i++;
                }
