...
public class PremiumTierCell extends ViewGroup {
    ...
    public PremiumTierCell(Context context) {
        ...
        this.discountView.setPadding(AndroidUtilities.m1124dp(3.0f), 0, AndroidUtilities.m1124dp(3.0f), 0);
        ...
        setPadding(AndroidUtilities.m1124dp(4.0f), AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(4.0f), AndroidUtilities.m1124dp(8.0f));
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        rect.set(AndroidUtilities.m1124dp(this.leftPaddingToCheckboxDp) + getPaddingLeft(), (int) ((getMeasuredHeight() - this.checkBox.getMeasuredHeight()) / 2.0f), 0, 0);
        checkRtlAndLayout(this.checkBox);
        int measuredHeight = (int) ((getMeasuredHeight() - this.pricePerMonthView.getMeasuredHeight()) / 2.0f);
        if (AndroidUtilities.m1124dp(this.leftPaddingToCheckboxDp + this.leftPaddingToTextDp + 24) + this.checkBox.getMeasuredWidth() + (this.pricePerYearStrikeView.getVisibility() == 0 ? this.pricePerYearStrikeView.getMeasuredWidth() : 0) + this.pricePerYearView.getMeasuredWidth() + getPaddingLeft() > getMeasuredWidth() - this.pricePerMonthView.getMeasuredWidth() && this.discountView.getVisibility() == 0) {
            measuredHeight = getPaddingTop() + AndroidUtilities.m1124dp(2.0f);
        }
        rect.set(((getMeasuredWidth() - this.pricePerMonthView.getMeasuredWidth()) - AndroidUtilities.m1124dp(16.0f)) - getPaddingRight(), measuredHeight, 0, 0);
        checkRtlAndLayout(this.pricePerMonthView);
        rect.set(AndroidUtilities.m1124dp(this.leftPaddingToCheckboxDp + this.leftPaddingToTextDp) + this.checkBox.getMeasuredWidth() + getPaddingLeft(), this.pricePerYearView.getVisibility() == 8 ? (int) ((getMeasuredHeight() - this.titleView.getMeasuredHeight()) / 2.0f) : getPaddingTop(), 0, 0);
        checkRtlAndLayout(this.titleView);
        if (this.discountView.getVisibility() == 0) {
            rect.set(AndroidUtilities.m1124dp(this.leftPaddingToCheckboxDp + this.leftPaddingToTextDp + 6) + this.checkBox.getMeasuredWidth() + getPaddingLeft() + this.titleView.getMeasuredWidth(), getPaddingTop() + AndroidUtilities.m1124dp(2.0f), 0, 0);
            checkRtlAndLayout(this.discountView);
        }
        rect.set(AndroidUtilities.m1124dp(this.leftPaddingToCheckboxDp + this.leftPaddingToTextDp) + this.checkBox.getMeasuredWidth() + getPaddingLeft(), (getMeasuredHeight() - this.pricePerYearStrikeView.getMeasuredHeight()) - getPaddingBottom(), 0, 0);
        checkRtlAndLayout(this.pricePerYearStrikeView);
        rect.set(AndroidUtilities.m1124dp(this.leftPaddingToCheckboxDp + this.leftPaddingToTextDp) + this.checkBox.getMeasuredWidth() + (this.pricePerYearStrikeView.getVisibility() == 0 ? this.pricePerYearStrikeView.getMeasuredWidth() + AndroidUtilities.m1124dp(6.0f) : 0) + getPaddingLeft(), (getMeasuredHeight() - this.pricePerYearView.getMeasuredHeight()) - getPaddingBottom(), 0, 0);
    ...
    protected void dispatchDraw(Canvas canvas) {
        if (this.isDrawingGradient) {
            ...
            rectF.set(this.pricePerMonthView.getLeft(), this.pricePerMonthView.getTop() + AndroidUtilities.m1124dp(4.0f), this.pricePerMonthView.getRight(), this.pricePerMonthView.getBottom() - AndroidUtilities.m1124dp(4.0f));
            canvas.drawRoundRect(rectF, AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(8.0f), paint);
            rectF.set(this.pricePerYearStrikeView.getLeft(), this.pricePerYearStrikeView.getTop() + AndroidUtilities.m1124dp(3.0f), this.pricePerYearStrikeView.getRight(), this.pricePerYearStrikeView.getBottom() - AndroidUtilities.m1124dp(3.0f));
            canvas.drawRoundRect(rectF, AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(8.0f), paint);
            rectF.set(this.titleView.getLeft(), this.titleView.getTop() + AndroidUtilities.m1124dp(4.0f), this.titleView.getRight(), this.titleView.getBottom() - AndroidUtilities.m1124dp(4.0f));
            canvas.drawRoundRect(rectF, AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(8.0f), paint);
            invalidate();
            return;
        }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int iM1124dp = AndroidUtilities.m1124dp(58.0f);
        int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(28.0f), TLObject.FLAG_30);
        this.checkBox.measure(iMakeMeasureSpec, iMakeMeasureSpec);
        this.pricePerMonthView.measure(View.MeasureSpec.makeMeasureSpec(size - this.checkBox.getMeasuredWidth(), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(iM1124dp, Integer.MIN_VALUE));
        this.titleView.measure(View.MeasureSpec.makeMeasureSpec((size - this.checkBox.getMeasuredWidth()) - this.pricePerMonthView.getMeasuredWidth(), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(iM1124dp, Integer.MIN_VALUE));
        if (this.discountView.getVisibility() == 0) {
            this.discountView.measure(View.MeasureSpec.makeMeasureSpec((size - this.checkBox.getMeasuredWidth()) - this.pricePerMonthView.getMeasuredWidth(), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(iM1124dp, Integer.MIN_VALUE));
        } else {
        ...
        this.pricePerYearStrikeView.measure(View.MeasureSpec.makeMeasureSpec(size - this.checkBox.getMeasuredWidth(), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(iM1124dp, Integer.MIN_VALUE));
        this.pricePerYearView.measure(View.MeasureSpec.makeMeasureSpec(((size - this.checkBox.getMeasuredWidth()) - (this.pricePerYearStrikeView.getVisibility() == 0 ? this.pricePerYearStrikeView.getMeasuredWidth() : 0)) - AndroidUtilities.m1124dp(6.0f), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(iM1124dp, Integer.MIN_VALUE));
    ...
    public void bind(PremiumPreviewFragment.SubscriptionTier subscriptionTier, boolean z) {
        ...
        if (months == 1) {
            this.titleView.setText(LocaleController.getString(C2888R.string.PremiumTierMonthly));
        } else if (months == 6) {
            this.titleView.setText(LocaleController.getString(C2888R.string.PremiumTierSemiannual));
        } else if (months != 12) {
            ...
            this.titleView.setText(LocaleController.getString(C2888R.string.PremiumTierAnnual));
        }
        ...
        if (!z2) {
            if (subscriptionTier.getDiscount() <= 0) {
                ...
                this.discountView.setText(LocaleController.formatString(C2888R.string.GiftPremiumOptionDiscount, Integer.valueOf(subscriptionTier.getDiscount())));
            ...
            this.pricePerYearView.setText(LocaleController.formatString(C2888R.string.PricePerYear, subscriptionTier.getFormattedPricePerYear()));
            this.pricePerMonthView.setText(LocaleController.formatString(C2888R.string.PricePerMonthMe, subscriptionTier.getFormattedPricePerMonth()));
            if (subscriptionTier.subscriptionOption.current) {
                this.pricePerYearView.setVisibility(0);
                this.pricePerYearView.setText(LocaleController.getString(C2888R.string.YourCurrentPlan));
            }
        } else {
            this.discountView.setText(LocaleController.formatString(C2888R.string.GiftPremiumOptionDiscount, 10));
            this.discountView.setVisibility(0);
            this.pricePerYearStrikeView.setVisibility(0);
            this.pricePerYearView.setVisibility(0);
            this.pricePerYearStrikeView.setText("USD00.00");
            this.pricePerYearView.setText(LocaleController.formatString(C2888R.string.PricePerYear, Integer.valueOf(MediaDataController.MAX_STYLE_RUNS_COUNT)));
            this.pricePerMonthView.setText(LocaleController.formatString(C2888R.string.PricePerMonthMe, 100));
        }
        requestLayout();
    }
    ...
    public void updateColors() {
        ...
        this.color0 = color;
        this.color1 = color2;
        int iM1124dp = AndroidUtilities.m1124dp(200.0f);
        this.gradientWidth = iM1124dp;
        LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, iM1124dp, 0.0f, new int[]{color2, color, color, color2}, new float[]{0.0f, 0.4f, 0.6f, 1.0f}, Shader.TileMode.CLAMP);
