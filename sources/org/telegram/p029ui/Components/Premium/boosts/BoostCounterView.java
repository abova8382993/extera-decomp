...
public class BoostCounterView extends View {
    ...
    public BoostCounterView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        animatedTextDrawable.setTextSize(AndroidUtilities.m1124dp(11.5f));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec((int) (AndroidUtilities.m1124dp(15.0f) + this.countText.getWidth()), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(26.0f), TLObject.FLAG_30));
    }
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        canvas.save();
        canvas.translate(AndroidUtilities.m1124dp(3.0f), AndroidUtilities.m1124dp(3.0f));
        Rect rect = AndroidUtilities.rectTmp2;
        rect.set(0, 0, AndroidUtilities.m1124dp(8.0f) + ((int) this.countText.getCurrentWidth()), AndroidUtilities.m1124dp(20.0f));
        ...
        canvas.drawRoundRect(rectF, AndroidUtilities.m1124dp(10.0f), AndroidUtilities.m1124dp(10.0f), this.bgPaint);
        rect.set(0, 0, (int) rectF.width(), AndroidUtilities.m1124dp(19.0f));
