...
public abstract class BoostRepository {
    ...
    public static ArrayList getMyChannels(long j) {
        ...
        for (int i = 0; i < allDialogs.size(); i++) {
            ...
            if (DialogObject.isChatDialog(dialog.f1666id) && ChatObject.isBoostSupported(messagesController.getChat(Long.valueOf(-dialog.f1666id)))) {
    ...
    public static void payGiftCodeByInvoice(List list, TLRPC.TL_premiumGiftCodeOption tL_premiumGiftCodeOption, TLRPC.Chat chat, TLRPC.TL_textWithEntities tL_textWithEntities, final BaseFragment baseFragment, final Utilities.Callback callback, final Utilities.Callback callback2) {
        ...
        if (chat != null) {
            ...
            tL_inputStorePaymentPremiumGiftCode.boost_peer = messagesController.getInputPeer(-chat.f1660id);
        }
        ...
        connectionsManager.sendRequest(tL_payments_getPaymentForm, new RequestDelegate() { // from class: org.telegram.ui.Components.Premium.boosts.BoostRepository$$ExternalSyntheticLambda23
    ...
    public static /* synthetic */ void $r8$lambda$UWLhHkJVaeOtePsTVLUViRxh8vo(TLRPC.TL_error tL_error, final Utilities.Callback callback, TLObject tLObject, MessagesController messagesController, TLRPC.TL_inputInvoicePremiumGiftCode tL_inputInvoicePremiumGiftCode, BaseFragment baseFragment, final Utilities.Callback callback2) {
        ...
        if (paymentFormActivity != null) {
            paymentFormActivity.setPaymentFormCallback(new PaymentFormActivity.PaymentFormCallback() { // from class: org.telegram.ui.Components.Premium.boosts.BoostRepository$$ExternalSyntheticLambda42
    ...
    public static /* synthetic */ void $r8$lambda$mYSDz_ltJBzqsKE5_IeTomNxvh8(final TLRPC.TL_inputStorePaymentPremiumGiftCode tL_inputStorePaymentPremiumGiftCode, TLRPC.TL_premiumGiftCodeOption tL_premiumGiftCodeOption, ConnectionsManager connectionsManager, final Utilities.Callback callback, final Utilities.Callback callback2, final BaseFragment baseFragment, final BillingResult billingResult, final List list) {
        ...
        connectionsManager.sendRequest(tL_payments_canPurchaseStore, new RequestDelegate() { // from class: org.telegram.ui.Components.Premium.boosts.BoostRepository$$ExternalSyntheticLambda32
            @Override // org.telegram.tgnet.RequestDelegate
    ...
    public static void launchPreparedGiveaway(TL_stories.PrepaidGiveaway prepaidGiveaway, List list, List list2, TLRPC.Chat chat, int i, boolean z, boolean z2, boolean z3, int i2, String str, final Utilities.Callback callback, final Utilities.Callback callback2) {
        ...
        if (prepaidGiveaway instanceof TL_stories.TL_prepaidGiveaway) {
            ...
            tL_inputStorePaymentStarsGiveaway.boost_peer = messagesController.getInputPeer(-chat.f1660id);
            ...
            while (it2.hasNext()) {
                ...
                if (tLObject instanceof TLRPC.Chat) {
                    tL_inputStorePaymentStarsGiveaway.additional_peers.add(messagesController.getInputPeer(-((TLRPC.Chat) tLObject).f1660id));
                }
            }
        } else {
            ...
            while (it4.hasNext()) {
                ...
                if (tLObject2 instanceof TLRPC.Chat) {
                    tL_inputStorePaymentStarsGiveaway.additional_peers.add(messagesController.getInputPeer(-((TLRPC.Chat) tLObject2).f1660id));
                }
            }
        }
        TLRPC.TL_payments_launchPrepaidGiveaway tL_payments_launchPrepaidGiveaway = new TLRPC.TL_payments_launchPrepaidGiveaway();
        tL_payments_launchPrepaidGiveaway.giveaway_id = prepaidGiveaway.f1856id;
        tL_payments_launchPrepaidGiveaway.peer = messagesController.getInputPeer(-chat.f1660id);
        tL_payments_launchPrepaidGiveaway.purpose = tL_inputStorePaymentStarsGiveaway;
        connectionsManager.sendRequest(tL_payments_launchPrepaidGiveaway, new RequestDelegate() { // from class: org.telegram.ui.Components.Premium.boosts.BoostRepository$$ExternalSyntheticLambda29
            @Override // org.telegram.tgnet.RequestDelegate
    ...
    public static void payGiveAwayByInvoice(List list, List list2, TLRPC.TL_premiumGiftCodeOption tL_premiumGiftCodeOption, TLRPC.Chat chat, int i, boolean z, final BaseFragment baseFragment, boolean z2, boolean z3, String str, final Utilities.Callback callback, final Utilities.Callback callback2) {
        ...
        while (it.hasNext()) {
            TLObject tLObject = (TLObject) it.next();
            if (tLObject instanceof TLRPC.Chat) {
                tL_inputStorePaymentPremiumGiveaway.additional_peers.add(messagesController.getInputPeer(-((TLRPC.Chat) tLObject).f1660id));
            }
        }
        tL_inputStorePaymentPremiumGiveaway.boost_peer = messagesController.getInputPeer(-chat.f1660id);
        tL_inputStorePaymentPremiumGiveaway.boost_peer = messagesController.getInputPeer(-chat.f1660id);
    ...
    public static /* synthetic */ void $r8$lambda$VfNNzLz2r9dG197A_eLlLbrOSU8(TLRPC.TL_error tL_error, final Utilities.Callback callback, TLObject tLObject, MessagesController messagesController, TLRPC.TL_inputInvoicePremiumGiftCode tL_inputInvoicePremiumGiftCode, BaseFragment baseFragment, final Utilities.Callback callback2) {
        ...
        if (paymentFormActivity != null) {
            paymentFormActivity.setPaymentFormCallback(new PaymentFormActivity.PaymentFormCallback() { // from class: org.telegram.ui.Components.Premium.boosts.BoostRepository$$ExternalSyntheticLambda38
                @Override // org.telegram.ui.PaymentFormActivity.PaymentFormCallback
                public final void onInvoiceStatusChanged(PaymentFormActivity.InvoiceStatus invoiceStatus) {
                    BoostRepository.m11668$r8$lambda$J0yHjds9RgDYKvt_Tecd4MSrg(callback2, callback, invoiceStatus);
                }
            });
            LaunchActivity.getLastFragment().showAsSheet(paymentFormActivity, new BaseFragment.BottomSheetParams());
        } else {
    ...
    /* JADX INFO: renamed from: $r8$lambda$J0-yHjds9RgDYKvt_T-ecd4MSrg */
    public static /* synthetic */ void m11668$r8$lambda$J0yHjds9RgDYKvt_Tecd4MSrg(Utilities.Callback callback, Utilities.Callback callback2, PaymentFormActivity.InvoiceStatus invoiceStatus) {
        if (invoiceStatus == PaymentFormActivity.InvoiceStatus.PAID) {
            callback.run(null);
        } else if (invoiceStatus != PaymentFormActivity.InvoiceStatus.PENDING) {
            callback2.run(null);
    ...
    public static void payGiveAwayByGoogle(List list, List list2, final TLRPC.TL_premiumGiftCodeOption tL_premiumGiftCodeOption, TLRPC.Chat chat, int i, boolean z, final BaseFragment baseFragment, boolean z2, boolean z3, String str, final Utilities.Callback callback, final Utilities.Callback callback2) {
        ...
        BillingController.getInstance().queryProductDetails(Arrays.asList(QueryProductDetailsParams.Product.newBuilder().setProductType("inapp").setProductId(tL_premiumGiftCodeOption.store_product).build()), new ProductDetailsResponseListener() { // from class: org.telegram.ui.Components.Premium.boosts.BoostRepository$$ExternalSyntheticLambda24
            @Override // com.android.billingclient.api.ProductDetailsResponseListener
        ...
        connectionsManager.sendRequest(tL_payments_canPurchaseStore, new RequestDelegate() { // from class: org.telegram.ui.Components.Premium.boosts.BoostRepository$$ExternalSyntheticLambda28
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.Premium.boosts.BoostRepository$$ExternalSyntheticLambda39
                    @Override // java.lang.Runnable
                    public final void run() {
                        BoostRepository.m11667$r8$lambda$EsswBawrvnmZnHQ3bnrVP4EnZM(tL_error, callback, tLObject, list, billingResult, callback, baseFragment, tL_inputStorePaymentPremiumGiveaway);
                    }
                });
            }
        });
    ...
    public static /* synthetic */ void m11667$r8$lambda$EsswBawrvnmZnHQ3bnrVP4EnZM(TLRPC.TL_error tL_error, final Utilities.Callback callback, TLObject tLObject, List list, final BillingResult billingResult, final Utilities.Callback callback2, BaseFragment baseFragment, TLRPC.TL_inputStorePaymentPremiumGiveaway tL_inputStorePaymentPremiumGiveaway) {
        if (tL_error != null) {
            ...
            BillingController.getInstance().addResultListener(((ProductDetails) list.get(0)).getProductId(), new Consumer() { // from class: org.telegram.ui.Components.Premium.boosts.BoostRepository$$ExternalSyntheticLambda48
                @Override // androidx.core.util.Consumer
                public final void accept(Object obj) {
                    BoostRepository.m11674$r8$lambda$ig8rwkvloatAUQHYzF830bssQs(billingResult, callback2, (BillingResult) obj);
                }
            });
    ...
    /* JADX INFO: renamed from: $r8$lambda$ig8rwkvloatAUQHYz-F830bssQs */
    public static /* synthetic */ void m11674$r8$lambda$ig8rwkvloatAUQHYzF830bssQs(BillingResult billingResult, final Utilities.Callback callback, BillingResult billingResult2) {
        if (billingResult.getResponseCode() == 0) {
    ...
    public static /* synthetic */ void $r8$lambda$AFyj1erWiMy20hRempUW1ilRtHw(final Utilities.Callback callback, TLObject tLObject, TLRPC.TL_error tL_error) {
        final Comparator boostRepository$$ExternalSyntheticLambda35;
        if (tLObject != null) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                ...
                boostRepository$$ExternalSyntheticLambda35 = new BoostRepository$$ExternalSyntheticLambda34(collator);
            } else {
                boostRepository$$ExternalSyntheticLambda35 = new BoostRepository$$ExternalSyntheticLambda35();
            }
            Collections.sort(arrayList, boostRepository$$ExternalSyntheticLambda35);
            Iterator it = map.values().iterator();
            while (it.hasNext()) {
                Collections.sort((List) it.next(), new Comparator() { // from class: org.telegram.ui.Components.Premium.boosts.BoostRepository$$ExternalSyntheticLambda36
                    @Override // java.util.Comparator
                    public final int compare(Object obj, Object obj2) {
                        return boostRepository$$ExternalSyntheticLambda35.compare(((TLRPC.TL_help_country) obj).default_name, ((TLRPC.TL_help_country) obj2).default_name);
                    }
                });
            }
    ...
    public static int loadGiftOptions(final int i, final TLRPC.Chat chat, final Utilities.Callback callback) {
        ...
        if (chat != null) {
            ...
            tL_payments_getPremiumGiftCodeOptions.boost_peer = messagesController.getInputPeer(-chat.f1660id);
        }
        ...
        if (tLObject instanceof Vector) {
            ...
            if (arrayList2.isEmpty() || !isGoogleBillingAvailable()) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.Premium.boosts.BoostRepository$$ExternalSyntheticLambda15
                    @Override // java.lang.Runnable
                    public final void run() {
                        BoostRepository.m11675$r8$lambda$li8FkIw_gPYVwIEkZVlffnvmp0(chat, i, arrayList, callback);
                    }
                });
            } else {
                BillingController.getInstance().queryProductDetails(arrayList2, new ProductDetailsResponseListener() { // from class: org.telegram.ui.Components.Premium.boosts.BoostRepository$$ExternalSyntheticLambda16
                    @Override // com.android.billingclient.api.ProductDetailsResponseListener
                    public final void onProductDetailsResponse(BillingResult billingResult, List list) {
                        BoostRepository.$r8$lambda$bX1Qy1NzkHRThQpQTS9V_h6PO20(arrayList, chat, i, callback, billingResult, list);
                    }
                });
            }
        }
    ...
    /* JADX INFO: renamed from: $r8$lambda$li8FkIw_gPYVwIEk-ZVlffnvmp0 */
    public static /* synthetic */ void m11675$r8$lambda$li8FkIw_gPYVwIEkZVlffnvmp0(TLRPC.Chat chat, int i, List list, Utilities.Callback callback) {
        if (chat == null) {
    ...
    public static /* synthetic */ void $r8$lambda$bX1Qy1NzkHRThQpQTS9V_h6PO20(final List list, final TLRPC.Chat chat, final int i, final Utilities.Callback callback, BillingResult billingResult, List list2) {
        Iterator it = list2.iterator();
        while (it.hasNext()) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.Premium.boosts.BoostRepository$$ExternalSyntheticLambda18
            @Override // java.lang.Runnable
            public final void run() {
                BoostRepository.$r8$lambda$s4NAJe2MjR8VDQOS7QV7nBvE3oc(chat, i, list, callback);
            }
        });
    }

    public static /* synthetic */ void $r8$lambda$s4NAJe2MjR8VDQOS7QV7nBvE3oc(TLRPC.Chat chat, int i, List list, Utilities.Callback callback) {
        if (chat == null) {
            saveGiftOptionsToCache(i, list);
        }
        callback.run(list);
    ...
    public static int searchContacts(String str, final boolean z, final Utilities.Callback callback) {
        ...
        return connectionsManager.sendRequest(tL_contacts_search, new RequestDelegate() { // from class: org.telegram.ui.Components.Premium.boosts.BoostRepository$$ExternalSyntheticLambda45
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    public static /* synthetic */ void $r8$lambda$wcN_4ONodN04ixunRt6ZS1wHMbw(MessagesController messagesController, boolean z, final Utilities.Callback callback, TLObject tLObject, TLRPC.TL_error tL_error) {
        if (tLObject instanceof TLRPC.TL_contacts_found) {
            ...
            for (int i = 0; i < tL_contacts_found.users.size(); i++) {
                ...
                if (!user.self && !UserObject.isDeleted(user) && ((z || !user.bot) && !UserObject.isService(user.f1825id))) {
                    arrayList.add(user);
                }
            }
    ...
    */
    public static void searchContactsLocally(java.lang.String r12, boolean r13, org.telegram.messenger.Utilities.Callback r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.Premium.boosts.BoostRepository.searchContactsLocally(java.lang.String, boolean, org.telegram.messenger.Utilities$Callback):void");
    }
    ...
    public static void searchChats(final long j, int i, String str, int i2, final Utilities.Callback callback) {
        ...
        connectionsManager.sendRequest(tL_contacts_search, new RequestDelegate() { // from class: org.telegram.ui.Components.Premium.boosts.BoostRepository$$ExternalSyntheticLambda19
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                BoostRepository.m11676$r8$lambda$ps5PoP1v0VQnUSMm24oobXVob8(messagesController, j, callback, tLObject, tL_error);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$ps5PoP1v0-VQnUSMm24oobXVob8 */
    public static /* synthetic */ void m11676$r8$lambda$ps5PoP1v0VQnUSMm24oobXVob8(MessagesController messagesController, long j, final Utilities.Callback callback, TLObject tLObject, TLRPC.TL_error tL_error) {
        if (tLObject instanceof TLRPC.TL_contacts_found) {
            TLRPC.TL_contacts_found tL_contacts_found = (TLRPC.TL_contacts_found) tLObject;
            ...
            for (int i = 0; i < tL_contacts_found.chats.size(); i++) {
                ...
                if (chat.f1660id != j && ChatObject.isBoostSupported(chat)) {
    ...
    public static void loadChatParticipants(long j, int i, String str, int i2, int i3, final Utilities.Callback callback) {
        ...
        tL_channelParticipantsRecent.f1659q = str;
        ...
        connectionsManager.sendRequest(tL_payments_getGiveawayInfo, new RequestDelegate() { // from class: org.telegram.ui.Components.Premium.boosts.BoostRepository$$ExternalSyntheticLambda10
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.Premium.boosts.BoostRepository$$ExternalSyntheticLambda13
                    @Override // java.lang.Runnable
                    public final void run() {
                        BoostRepository.m11669$r8$lambda$J6qxWY_dgKgsiDrmGLQuQhZJJs(tL_error, callback, tLObject, callback);
                    }
                });
            }
        });
    ...
    /* JADX INFO: renamed from: $r8$lambda$J6qxWY_dgKgsiD-rmGLQuQhZJJs */
    public static /* synthetic */ void m11669$r8$lambda$J6qxWY_dgKgsiDrmGLQuQhZJJs(TLRPC.TL_error tL_error, Utilities.Callback callback, TLObject tLObject, Utilities.Callback callback2) {
        if (tL_error != null) {
            callback.run(tL_error);
