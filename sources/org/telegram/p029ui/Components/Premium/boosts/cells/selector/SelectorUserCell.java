...
public class SelectorUserCell extends BaseCell {
    ...
    public SelectorUserCell(Context context, boolean z, boolean z2, Theme.ResourcesProvider resourcesProvider, boolean z3) {
        ...
        imageView2.setImageResource(C2888R.drawable.menu_phone);
        ...
        imageView3.setImageResource(C2888R.drawable.menu_videocall);
    ...
    public void setUser(TLRPC.User user) {
        ...
        this.imageView.setRoundRadius(AndroidUtilities.m1124dp(20.0f));
        ...
        if (UserObject.isBot(user)) {
            ...
            if (i > 0) {
                ...
                setSubtitle(LocaleController.getString(C2888R.string.Bot));
            }
        } else {
    ...
    public void setChat(TLRPC.Chat chat, int i) {
        ...
        this.imageView.setRoundRadius(AndroidUtilities.m1124dp(ChatObject.isForum(chat) ? 12.0f : 20.0f));
        ...
        if (i >= 1) {
            ...
            string = LocaleController.getString(zIsChannelAndNotMegaGroup ? C2888R.string.DiscussChannel : C2888R.string.AccDescrGroup);
        }
        setSubtitle(string);
    ...
    public void setBoost(TL_stories.TL_myBoost tL_myBoost) {
        ...
        this.subtitleTextView.setTextColor(Theme.getColor(Theme.key_dialogTextGray3, this.resourcesProvider));
        setSubtitle(LocaleController.formatString(C2888R.string.BoostExpireOn, LocaleController.getInstance().getFormatterBoostExpired().format(new Date(((long) tL_myBoost.expires) * 1000))));
        int i = tL_myBoost.cooldown_until_date;
        if (i > 0) {
            setSubtitle(LocaleController.formatString(C2888R.string.BoostingAvailableIn, buildCountDownTime((((long) i) * 1000) - System.currentTimeMillis())));
    ...
    public void updateTimer() {
        ...
        setSubtitle(LocaleController.formatString(C2888R.string.BoostExpireOn, LocaleController.getInstance().getFormatterBoostExpired().format(new Date(((long) this.boost.expires) * 1000))));
