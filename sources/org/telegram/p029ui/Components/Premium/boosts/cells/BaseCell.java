...
public abstract class BaseCell extends FrameLayout {
    ...
    public BaseCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        avatarDrawable.setRoundRadius(AndroidUtilities.m1124dp(40.0f));
    ...
    public void setSubtitle(CharSequence charSequence) {
        ...
        if (this.imageView.getVisibility() == 8) {
            if (LocaleController.isRTL) {
                this.titleTextView.setTranslationX(AndroidUtilities.m1124dp(40.0f));
                this.subtitleTextView.setTranslationX(AndroidUtilities.m1124dp(40.0f));
            } else {
                this.titleTextView.setTranslationX(AndroidUtilities.m1124dp(-40.0f));
                this.subtitleTextView.setTranslationX(AndroidUtilities.m1124dp(-40.0f));
            }
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(getFullHeight()), TLObject.FLAG_30));
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (this.needDivider) {
            ...
            if (LocaleController.isRTL) {
                canvas.drawRect(0.0f, getHeight() - 1, getWidth() - AndroidUtilities.m1124dp(iDividerPadding), getHeight(), this.dividerPaint);
            } else {
                canvas.drawRect(AndroidUtilities.m1124dp(iDividerPadding), getHeight() - 1, getWidth(), getHeight(), this.dividerPaint);
            }
        }
    }
}
