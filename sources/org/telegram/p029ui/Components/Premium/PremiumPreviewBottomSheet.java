...
public class PremiumPreviewBottomSheet extends BottomSheetWithRecyclerListView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public PremiumPreviewBottomSheet(final BaseFragment baseFragment, final int i, TLRPC.User user, GiftPremiumBottomSheet$GiftTier giftPremiumBottomSheet$GiftTier, TL_stars.StarGift starGift, Theme.ResourcesProvider resourcesProvider) {
        ...
        premiumGradientTools.f2032y1 = 1.0f;
        premiumGradientTools.f2031x2 = 0.0f;
        premiumGradientTools.f2033y2 = 0.0f;
        premiumGradientTools.f2028cx = 0.0f;
        premiumGradientTools.f2029cy = 0.0f;
        updateRows();
        this.recyclerListView.setPadding(AndroidUtilities.m1124dp(6.0f), 0, AndroidUtilities.m1124dp(6.0f), 0);
    ...
    */
    public void setTitle(boolean r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.Premium.PremiumPreviewBottomSheet.setTitle(boolean):void");
    }
    ...
    protected CharSequence getTitle() {
        return LocaleController.getString(C2888R.string.TelegramPremium);
    }
    ...
    class Adapter extends RecyclerListView.SelectionAdapter {
            ...
            if (i == 0) {
                ...
                if (view == null) {
                    premiumPreviewBottomSheet.iconTextureView = new GLIconTextureView(context, i2) { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet.Adapter.2
                        @Override // org.telegram.p029ui.Components.Premium.GLIcon.GLIconTextureView, android.view.TextureView, android.view.View
                        protected void onAttachedToWindow() {
                            super.onAttachedToWindow();
                            setPaused(false);
                        }

                        @Override // org.telegram.p029ui.Components.Premium.GLIcon.GLIconTextureView, android.view.View
                ...
                PremiumPreviewBottomSheet.this.starParticlesView = new StarParticlesView(context) { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet.Adapter.4
                    @Override // org.telegram.p029ui.Components.Premium.StarParticlesView, android.view.View
                    protected void onMeasure(int i5, int i6) {
                        super.onMeasure(i5, i6);
                        this.drawable.rect2.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight() - AndroidUtilities.m1124dp(52.0f));
                    }
                ...
                shadowSectionCell = new View(context) { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet.Adapter.7
                    ...
                    protected void onMeasure(int i5, int i6) {
                        super.onMeasure(i5, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(68.0f), TLObject.FLAG_30));
                    }
                };
            } else if (i == 4) {
                ...
                shadowSectionCell = new PremiumFeatureCell(context, ((BottomSheet) PremiumPreviewBottomSheet.this).resourcesProvider) { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet.Adapter.6
                    ...
                    protected void dispatchDraw(Canvas canvas2) {
                        ...
                        canvas2.drawRoundRect(rectF, AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(8.0f), PremiumPreviewBottomSheet.this.gradientTools.paint);
                ...
                String string = LocaleController.getString("GiftPremiumPrivacyPolicyAndTerms", C2888R.string.GiftPremiumPrivacyPolicyAndTerms);
                ...
                }), AndroidUtilities.replaceSingleTag(LocaleController.getString("GiftPremiumPrivacyPolicy", C2888R.string.GiftPremiumPrivacyPolicy), i5, 0, new Runnable() { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet$Adapter$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public /* synthetic */ void lambda$onCreateViewHolder$0() {
            Browser.openUrl(PremiumPreviewBottomSheet.this.fragment.getParentActivity(), LocaleController.getString(C2888R.string.TermsOfServiceUrl));
        }

        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onCreateViewHolder$1() {
            Browser.openUrl(PremiumPreviewBottomSheet.this.fragment.getParentActivity(), LocaleController.getString(C2888R.string.PrivacyPolicyUrl));
        }
    ...
    protected boolean onCustomOpenAnimation() {
        ...
        this.enterAnimator.addListener(new C47824(rightDrawable));
    ...
    class C47824 extends AnimatorListenerAdapter {
        final /* synthetic */ Drawable val$startEnterFromDrawable;

        C47824(Drawable drawable) {
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (i == NotificationCenter.groupStickersDidLoad && (inputStickerSet = this.statusStickerSet) != null && inputStickerSet.f1685id == ((Long) objArr[0]).longValue()) {
            setTitle(true);
        }
    }
}
