...
public class StarParticlesView extends View {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.drawable.rect.set(0.0f, 0.0f, getStarsRectWidth(), AndroidUtilities.m1124dp(140.0f));
        ...
        this.drawable.rect2.set(-AndroidUtilities.m1124dp(15.0f), -AndroidUtilities.m1124dp(15.0f), getMeasuredWidth() + AndroidUtilities.m1124dp(15.0f), getMeasuredHeight() + AndroidUtilities.m1124dp(15.0f));
    ...
    public void setClipWithGradient() {
        ...
        LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.m1124dp(12.0f), new int[]{16777215, -1}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.isLiteModeParticlesAllowed) {
            ...
            if (this.clipGradientPaint != null) {
                ...
                this.clipGradientMatrix.postTranslate(0.0f, (getHeight() + 1) - AndroidUtilities.m1124dp(12.0f));
                this.clipGradient.setLocalMatrix(this.clipGradientMatrix);
                canvas2.drawRect(0.0f, getHeight() - AndroidUtilities.m1124dp(12.0f), getWidth(), getHeight(), this.clipGradientPaint);
                this.clipGradientMatrix.reset();
                this.clipGradientMatrix.postRotate(180.0f);
                this.clipGradientMatrix.postTranslate(0.0f, AndroidUtilities.m1124dp(12.0f));
                this.clipGradient.setLocalMatrix(this.clipGradientMatrix);
                canvas2.drawRect(0.0f, 0.0f, getWidth(), AndroidUtilities.m1124dp(12.0f), this.clipGradientPaint);
                canvas2.restore();
                canvas2.restore();
            }
    ...
    public static class Drawable {
        ...
        public float f2041k1 = 0.85f;

        /* JADX INFO: renamed from: k2 */
        public float f2042k2 = 0.85f;

        /* JADX INFO: renamed from: k3 */
        public float f2043k3 = 0.9f;
        public long minLifeTime = 2000;
        public int randLifeTime = MediaDataController.MAX_STYLE_RUNS_COUNT;

        /* JADX INFO: renamed from: dt */
        private final float f2040dt = 1000.0f / AndroidUtilities.screenRefreshRate;
        ...
        */
        ...
        public void onDraw(Canvas canvas, float f) {
            ...
            if (this.useRotate) {
                this.matrix.reset();
                float f2 = jClamp;
                float f3 = this.f2037a + ((f2 / 40000.0f) * 360.0f);
                this.f2037a = f3;
                this.f2038a1 += (f2 / 50000.0f) * 360.0f;
                this.f2039a2 += (f2 / 60000.0f) * 360.0f;
                this.matrix.setRotate(f3, this.rect.centerX() + this.centerOffsetX, this.rect.centerY() + this.centerOffsetY);
                this.matrix2.setRotate(this.f2038a1, this.rect.centerX() + this.centerOffsetX, this.rect.centerY() + this.centerOffsetY);
                this.matrix3.setRotate(this.f2039a2, this.rect.centerX() + this.centerOffsetX, this.rect.centerY() + this.centerOffsetY);
                this.pointsCount1 = 0;
                this.pointsCount2 = 0;
                this.pointsCount3 = 0;
                for (int i = 0; i < this.particles.size(); i++) {
        ...
        public class Particle {
            ...
            private float f2045x;

            /* JADX INFO: renamed from: x2 */
            private float f2046x2;

            /* JADX INFO: renamed from: y */
            private float f2047y;

            /* JADX INFO: renamed from: y2 */
            private float f2048y2;
            ...
            public void updatePoint() {
                ...
                if (i == 0) {
                    ...
                    fArr[i2 * 2] = this.f2045x;
                    fArr[(i2 * 2) + 1] = this.f2047y;
                ...
                if (i == 1) {
                    ...
                    fArr2[i3 * 2] = this.f2045x;
                    fArr2[(i3 * 2) + 1] = this.f2047y;
                ...
                if (i == 2) {
                    ...
                    fArr3[i4 * 2] = this.f2045x;
                    fArr3[(i4 * 2) + 1] = this.f2047y;
            ...
            */
            ...
            public void genPosition(long j) {
                ...
                if (drawable2.distributionAlgorithm) {
                    ...
                    while (i2 < 10) {
                        ...
                        while (i3 < Drawable.this.particles.size()) {
                            ...
                            if (drawable3.startFromCenter) {
                                f2 = ((Particle) drawable3.particles.get(i3)).f2046x2 - fAbs3;
                                f3 = ((Particle) Drawable.this.particles.get(i3)).f2048y2;
                            } else {
                                f2 = ((Particle) drawable3.particles.get(i3)).f2045x - fAbs3;
                                f3 = ((Particle) Drawable.this.particles.get(i3)).f2047y;
                            }
                            float f8 = f3 - fAbs4;
                    ...
                    if (drawable2.isCircle) {
                        ...
                        if (!Drawable.this.flip[this.starIndex] || this.first) {
                            ...
                            fAbs5 = Math.min(fAbs5, AndroidUtilities.m1124dp(10.0f));
                            fM1124dp = AndroidUtilities.m1124dp(30.0f) + 0.0f;
                        }
                        double d = fAbs5;
                        double d2 = fAbs6;
                        this.f2045x = Drawable.this.rect.centerX() + Drawable.this.centerOffsetX + ((float) (Math.sin(Math.toRadians(d2)) * d));
                        this.f2047y = Drawable.this.rect.centerY() + fM1124dp + Drawable.this.centerOffsetY + ((float) (d * Math.cos(Math.toRadians(d2))));
                    } else {
                        this.f2045x = drawable2.rect.left + Math.abs(Utilities.fastRandom.nextInt() % Drawable.this.rect.width());
                        this.f2047y = Drawable.this.rect.top + Math.abs(Utilities.fastRandom.nextInt() % Drawable.this.rect.height());
                    }
                }
                ...
                if (drawable4.flip[this.starIndex]) {
                    ...
                    float f12 = this.f2047y;
                    float fCenterY = drawable4.rect.centerY();
                    Drawable drawable5 = Drawable.this;
                    dAtan2 = Math.atan2(f12 - (fCenterY + drawable5.centerOffsetY), this.f2045x - (drawable5.rect.centerX() + Drawable.this.centerOffsetX));
                }
