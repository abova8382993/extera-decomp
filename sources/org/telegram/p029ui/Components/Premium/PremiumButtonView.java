...
public class PremiumButtonView extends FrameLayout implements Loadable {
    ...
    public PremiumButtonView(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
        this(context, AndroidUtilities.m1124dp(8.0f), z, resourcesProvider);
    }
    ...
    public PremiumButtonView(Context context, int i, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        AnimatedTextView animatedTextView = new AnimatedTextView(context, true, true, true) { // from class: org.telegram.ui.Components.Premium.PremiumButtonView.1
            ...
            protected void onDraw(Canvas canvas) {
                if (PremiumButtonView.this.loadingT > 0.0f) {
                    ...
                    int iM1124dp = (int) ((1.0f - PremiumButtonView.this.loadingT) * AndroidUtilities.m1124dp(24.0f));
                    PremiumButtonView.this.loadingDrawable.setBounds(0, iM1124dp, getWidth(), getHeight() + iM1124dp);
                ...
                if (PremiumButtonView.this.loadingT < 1.0f) {
                    if (PremiumButtonView.this.loadingT != 0.0f) {
                        canvas.save();
                        canvas.translate(0.0f, (int) (PremiumButtonView.this.loadingT * AndroidUtilities.m1124dp(-24.0f)));
        ...
        AnimatedTextView animatedTextView2 = this.buttonTextView;
        int i2 = Theme.key_featuredStickers_buttonText;
        animatedTextView2.setTextColor(Theme.getColor(i2));
        this.buttonTextView.setTextSize(AndroidUtilities.m1124dp(14.0f));
        ...
        if (z) {
            AnimatedTextView animatedTextView3 = new AnimatedTextView(context, true, true, true) { // from class: org.telegram.ui.Components.Premium.PremiumButtonView.2
                @Override // org.telegram.p029ui.Components.AnimatedTextView, android.view.View
                protected void onDraw(Canvas canvas) {
                    if (PremiumButtonView.this.loadingT > 0.0f) {
                        if (PremiumButtonView.this.loadingDrawable == null) {
            ...
            this.overlayTextView = animatedTextView3;
            animatedTextView3.setPadding(AndroidUtilities.m1124dp(34.0f), 0, AndroidUtilities.m1124dp(34.0f), 0);
            this.overlayTextView.setGravity(17);
            this.overlayTextView.setTextColor(Theme.getColor(i2, resourcesProvider));
            this.overlayTextView.setTextSize(AndroidUtilities.m1124dp(14.0f));
            this.overlayTextView.setTypeface(AndroidUtilities.bold());
            this.overlayTextView.getDrawable().setAllowCancel(true);
            this.overlayTextView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1124dp(8.0f), 0, ColorUtils.setAlphaComponent(Theme.getColor(i2), 120)));
    ...
    protected void dispatchDraw(Canvas canvas) {
        if (this.counterView != null) {
            this.counterOffset.set(((r0.counterDrawable.getWidth() * 0.85f) + AndroidUtilities.m1124dp(3.0f)) / 2.0f);
            this.counterOffset2.set((getMeasuredWidth() / 2.0f) + (this.overlayTextView.getDrawable().getWidth() / 2.0f) + AndroidUtilities.m1124dp(3.0f));
    ...
    public void updateOverlayProgress() {
        ...
        this.overlayTextView.setTranslationY(AndroidUtilities.m1124dp(12.0f) * (1.0f - this.overlayProgress));
        this.buttonLayout.setAlpha(1.0f - this.overlayProgress);
        this.buttonLayout.setTranslationY((-AndroidUtilities.m1124dp(12.0f)) * this.overlayProgress);
