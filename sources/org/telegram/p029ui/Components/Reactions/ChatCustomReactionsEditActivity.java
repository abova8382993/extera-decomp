...
public class ChatCustomReactionsEditActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public android.view.View createView(android.content.Context r24) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.Reactions.ChatCustomReactionsEditActivity.createView(android.content.Context):android.view.View");
    }
    ...
    public /* synthetic */ void lambda$createView$6() {
        Browser.openUrl(getContext(), LocaleController.getString(C2888R.string.ChannelEnablePaidReactionsInfoLink));
    }
    ...
    public /* synthetic */ void lambda$createView$7(TLRPC.TL_error tL_error) {
        ...
        BulletinFactory.m1246of(this).createErrorBulletin(pluralString).show();
    }
    ...
    private void initSelectAnimatedEmojiDialog() {
        ...
        C48815 c48815 = new C48815(this, getContext(), false, null, 6, false, getResourceProvider(), 16, Theme.getColor(Theme.key_windowBackgroundWhiteBlackText, getResourceProvider()));
        this.selectAnimatedEmojiDialog = c48815;
        c48815.setAnimationsEnabled(false);
    ...
    class C48815 extends SelectAnimatedEmojiDialog {
        private boolean firstLayout;

        C48815(BaseFragment baseFragment, Context context, boolean z, Integer num, int i, boolean z2, Theme.ResourcesProvider resourcesProvider, int i2, int i3) {
        ...
        protected void onEmojiSelected(View view, Long l, TLRPC.Document document, TL_stars.TL_starGiftUnique tL_starGiftUnique, Integer num) {
            ...
            if (ChatCustomReactionsEditActivity.this.selectedEmojisMap.size() - (ChatCustomReactionsEditActivity.this.selectedEmojisMap.containsKey(-1L) ? 1 : 0) >= ChatCustomReactionsEditActivity.this.maxReactionsCount) {
                BulletinFactory.m1246of(ChatCustomReactionsEditActivity.this).createErrorBulletin(LocaleController.formatPluralString("ReactionMaxCountError", ChatCustomReactionsEditActivity.this.maxReactionsCount, new Object[0])).show();
                return;
            }
            try {
    ...
    public boolean checkChangesBeforeExit(boolean z) {
        ...
        if (z && z3) {
            ...
            builder.setMessage(LocaleController.getString("ReactionApplyChangesDialog", C2888R.string.ReactionApplyChangesDialog));
            builder.setPositiveButton(LocaleController.getString("ApplyTheme", C2888R.string.ApplyTheme), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.Reactions.ChatCustomReactionsEditActivity$$ExternalSyntheticLambda10
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i) {
                    this.f$0.lambda$checkChangesBeforeExit$14(alertDialog, i);
                }
            });
            builder.setNegativeButton(LocaleController.getString(C2888R.string.Discard), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.Reactions.ChatCustomReactionsEditActivity$$ExternalSyntheticLambda11
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i) {
    ...
    public void checkMaxCustomReactions(boolean z) {
        ...
        if (this.boostsStatus.level < size) {
            if (z) {
                BulletinFactory.m1246of(this).createSimpleBulletin(C2888R.raw.chats_infotip, AndroidUtilities.replaceTags(LocaleController.formatPluralString("ReactionReachLvlForReactionShort", size, Integer.valueOf(size)))).show();
            }
        ...
        for (Long l : this.selectedEmojisIds) {
            if (l.longValue() != -1) {
                ...
                while (true) {
                    ...
                    if (l.longValue() == tL_availableReaction.activate_animation.f1668id) {
        ...
        if (this.paidCheckCell.isChecked()) {
            ...
            try {
                ...
                AnimatedEmojiSpan animatedEmojiSpan2 = new AnimatedEmojiSpan(j, null) { // from class: org.telegram.ui.Components.Reactions.ChatCustomReactionsEditActivity.11
                    ...
                    {
                        Bitmap bitmapCreateBitmap = Bitmap.createBitmap(AndroidUtilities.m1124dp(24.0f), AndroidUtilities.m1124dp(24.0f), Bitmap.Config.ARGB_8888);
                        this.bitmap = bitmapCreateBitmap;
                        Drawable drawableMutate = ChatCustomReactionsEditActivity.this.getContext().getResources().getDrawable(C2888R.drawable.star_small_inner).mutate();
                        drawableMutate.setBounds(0, 0, AndroidUtilities.m1124dp(24.0f), AndroidUtilities.m1124dp(24.0f));
                    ...
                    public void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
                        ...
                        canvas.save();
                        canvas.translate(f, ((i3 + i5) / 2.0f) - AndroidUtilities.m1124dp(12.0f));
                        float f2 = this.extraScale;
                        canvas.scale(f2, f2, f + AndroidUtilities.m1124dp(12.0f), AndroidUtilities.m1124dp(12.0f));
                    ...
                    public int getSize(Paint paint, CharSequence charSequence, int i, int i2, Paint.FontMetricsInt fontMetricsInt) {
                        return super.getSize(paint, charSequence, i, i2, fontMetricsInt) + AndroidUtilities.m1124dp(5.0f);
                    }
                };
