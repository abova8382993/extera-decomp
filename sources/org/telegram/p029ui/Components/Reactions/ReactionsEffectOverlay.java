...
public class ReactionsEffectOverlay {
    ...
    */
    ...
    class C49001 extends FrameLayout {
        ...
        C49001(Context context, BaseFragment baseFragment, View view, boolean z, MessageObject messageObject, ChatActivity chatActivity, int i, int i2, boolean z2, float f, float f2, float f3, ReactionsLayoutInBubble.VisibleReaction visibleReaction) {
            super(context);
        ...
        */
        protected void dispatchDraw(android.graphics.Canvas r23) {
            /*
                ...
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.Reactions.ReactionsEffectOverlay.C49001.dispatchDraw(android.graphics.Canvas):void");
        }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static void show(org.telegram.p029ui.ActionBar.BaseFragment r16, org.telegram.p029ui.Components.ReactionsContainerLayout r17, android.view.View r18, android.view.View r19, float r20, float r21, org.telegram.ui.Components.Reactions.ReactionsLayoutInBubble.VisibleReaction r22, int r23, int r24) {
        /*
    ...
    public static int sizeForBigReaction() {
        int iM1124dp = AndroidUtilities.m1124dp(350.0f);
        Point point = AndroidUtilities.displaySize;
        return (int) (Math.round(Math.min(iM1124dp, Math.min(point.x, point.y)) * 0.7f) / AndroidUtilities.density);
    }

    public static int sizeForAroundReaction() {
        return (int) ((AndroidUtilities.m1124dp(40.0f) * 2.0f) / AndroidUtilities.density);
    }
