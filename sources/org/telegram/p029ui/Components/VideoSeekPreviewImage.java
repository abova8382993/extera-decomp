...
import org.telegram.p029ui.Components.VideoSeekPreviewImage;
...
public abstract class VideoSeekPreviewImage extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public VideoSeekPreviewImage(Context context, VideoSeekPreviewImageDelegate videoSeekPreviewImageDelegate) {
        ...
        setVisibility(4);
        this.frameDrawable = context.getResources().getDrawable(C2888R.drawable.videopreview);
    ...
    public /* synthetic */ void lambda$new$0(ImageReceiver imageReceiver, boolean z, boolean z2, boolean z3) {
        ...
        if (z) {
            ...
            if (f > 1.0f) {
                ...
                int i3 = (int) (iM1124dp * f);
                i = iM1124dp;
                iM1124dp = i3;
            }
            ViewGroup.LayoutParams layoutParams = getLayoutParams();
            if (getVisibility() == 0 && layoutParams.width == iM1124dp && layoutParams.height == i) {
                return;
            }
    ...
    */
    public void setProgress(org.telegram.messenger.MessageObject r13, final float r14, int r15) {
        ...
        L83:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.VideoSeekPreviewImage.setProgress(org.telegram.messenger.MessageObject, float, int):void");
    }
    ...
    public /* synthetic */ void lambda$setProgress$2(float f, long j) {
        ...
        int iMax = Math.max(200, AndroidUtilities.m1124dp(100.0f));
    ...
    public /* synthetic */ void lambda$setProgress$1(Bitmap bitmap) {
        ...
        if (bitmap != null) {
            ...
            if (width > 1.0f) {
                i = (int) (iM1124dp / width);
            } else {
                iM1124dp = (int) (iM1124dp * width);
                i = iM1124dp;
            }
            ViewGroup.LayoutParams layoutParams = getLayoutParams();
            if (getVisibility() != 0 || layoutParams.width != iM1124dp || layoutParams.height != i) {
    ...
    public void open(MessageObject messageObject, VideoPlayer videoPlayer) {
        ...
        long j = documentFindDocumentByMimeType == null ? 0L : documentFindDocumentByMimeType.f1668id;
    ...
    public /* synthetic */ void lambda$open$5(VideoPlayer.VideoUri videoUri, MessageObject messageObject) {
        ...
        if (videoUri.isCached()) {
            ...
            if (FileLoader.getInstance(i).isLoadingFile(FileLoader.getAttachFileName(document))) {
                absolutePath = new File(FileLoader.getDirectory(4), document.dc_id + "_" + document.f1668id + ".temp").getAbsolutePath();
            } else {
    ...
    public /* synthetic */ void lambda$open$7(Uri uri, MessageObject messageObject) {
        ...
        if ("tg".equals(uri.getScheme())) {
            ...
            tL_document.f1668id = Utilities.parseLong(uri.getQueryParameter("id")).longValue();
            ...
            if (FileLoader.getInstance(iIntValue).isLoadingFile(FileLoader.getAttachFileName(tL_document))) {
                absolutePath = new File(FileLoader.getDirectory(4), tL_document.dc_id + "_" + tL_document.f1668id + ".temp").getAbsolutePath();
            } else {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.drawStoryBoard) {
            ...
            this.ytPath.addRoundRect(rectF, AndroidUtilities.m1124dp(6.0f), AndroidUtilities.m1124dp(6.0f), Path.Direction.CW);
            ...
            canvas.drawText(this.frameTime, (getMeasuredWidth() - this.timeWidth) / 2.0f, getMeasuredHeight() - AndroidUtilities.m1124dp(9.0f), this.textPaint);
            return;
        }
        ...
        canvas.drawRoundRect(this.bitmapRect, AndroidUtilities.m1124dp(6.0f), AndroidUtilities.m1124dp(6.0f), this.bitmapPaint);
        this.frameDrawable.setBounds(0, 0, getMeasuredWidth(), getMeasuredHeight());
        this.frameDrawable.draw(canvas);
        canvas.drawText(this.frameTime, (getMeasuredWidth() - this.timeWidth) / 2.0f, getMeasuredHeight() - AndroidUtilities.m1124dp(9.0f), this.textPaint);
    }
