package org.telegram.p029ui.Components.conference;
...
public abstract class GroupCallActivityButtonsLayout extends ViewGroup {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(76.0f), TLObject.FLAG_30);
        int iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(76.0f), TLObject.FLAG_30);
    ...
    private void doLayout(boolean z, boolean z2) {
        ...
        if (!z3) {
            int iMin2 = Math.min(AndroidUtilities.m1124dp(50.0f) + Math.max((int) ((measuredWidth2 - (AndroidUtilities.m1124dp(50.0f) * i2)) / (i2 + 0.333f)), 0), measuredWidth2 / i2);
            iMin = AndroidUtilities.m1124dp(76.0f);
            i = (measuredWidth2 - (i2 * iMin2)) / 2;
            measuredWidth2 = iMin2;
        } else {
            iMin = Math.min(AndroidUtilities.m1124dp(50.0f) + Math.max((int) ((measuredHeight2 - (AndroidUtilities.m1124dp(50.0f) * i2)) / (i2 + 0.333f)), 0), measuredHeight2 / i2);
        ...
        while (it2.hasNext()) {
            ...
            if (buttonHolder.isVisible) {
                if (!z3) {
                    ...
                    measuredHeight = getMeasuredHeight() - AndroidUtilities.m1124dp(76.0f);
                } else {
