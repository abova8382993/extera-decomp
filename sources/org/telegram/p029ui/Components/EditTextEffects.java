...
public abstract class EditTextEffects extends EditText {
    ...
    public /* synthetic */ void lambda$new$2() {
        ...
        this.spoilers.get(0).setOnRippleEndCallback(new Runnable() { // from class: org.telegram.ui.Components.EditTextEffects$$ExternalSyntheticLambda4
    ...
    public EditTextEffects(Context context) {
        ...
        this.spoilerTimeout = new Runnable() { // from class: org.telegram.ui.Components.EditTextEffects$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
        ...
        if (Looper.getMainLooper().getThread() == Thread.currentThread()) {
            this.clickDetector = new SpoilersClickDetector(this, this.spoilers, new SpoilersClickDetector.OnSpoilerClickedListener() { // from class: org.telegram.ui.Components.EditTextEffects$$ExternalSyntheticLambda1
    ...
    public void onSpoilerClicked(SpoilerEffect spoilerEffect, float f, float f2) {
        ...
        spoilerEffect.setOnRippleEndCallback(new Runnable() { // from class: org.telegram.ui.Components.EditTextEffects$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$onSpoilerClicked$4() {
        post(new Runnable() { // from class: org.telegram.ui.Components.EditTextEffects$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
    ...
    protected void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        ...
        if (!this.suppressOnTextChanged) {
            ...
            if ((charSequence instanceof Spannable) && layout != null) {
                int primaryHorizontal = (int) layout.getPrimaryHorizontal(layout.getLineForOffset(i));
                int lineTop = (int) ((layout.getLineTop(r4) + layout.getLineBottom(r4)) / 2.0f);
                Iterator<SpoilerEffect> it = this.spoilers.iterator();
                while (true) {
                    if (!it.hasNext()) {
                        break;
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (QuoteSpan.onTouch(motionEvent, getPaddingTop() - getScrollY(), this.quoteBlocks, new Runnable() { // from class: org.telegram.ui.Components.EditTextEffects$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.clipToPadding && getScrollY() != 0) {
            canvas.clipRect(-AndroidUtilities.m1124dp(3.0f), (getScrollY() - super.getExtendedPaddingTop()) - this.offsetY, getMeasuredWidth(), ((getMeasuredHeight() + getScrollY()) + super.getExtendedPaddingBottom()) - this.offsetY);
        }
        this.path.rewind();
        Iterator<SpoilerEffect> it = this.spoilers.iterator();
        while (it.hasNext()) {
        ...
        if (this.drawAnimatedEmojiDrawables && this.animatedEmojiDrawables != null) {
            ...
            AnimatedEmojiSpan.drawAnimatedEmojis(canvas, getLayout(), this.animatedEmojiDrawables, 0.0f, this.spoilers, computeVerticalScrollOffset() - AndroidUtilities.m1124dp(6.0f), computeVerticalScrollOffset() + computeVerticalScrollExtent(), 0.0f, 1.0f, this.animatedEmojiColorFilter);
            canvas.restore();
        }
        canvas.restore();
        canvas.save();
