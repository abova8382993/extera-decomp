...
public abstract class ReportAlert extends BottomSheet {
    ...
    public ReportAlert(Context context, final int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        rLottieImageView.setAnimation(C2888R.raw.report_police, 120, 120);
        ...
        if (i == 0) {
            textView.setText(LocaleController.getString(C2888R.string.ReportTitleSpam));
        } else if (i == 6) {
            textView.setText(LocaleController.getString(C2888R.string.ReportTitleFake));
        } else if (i == 1) {
            textView.setText(LocaleController.getString(C2888R.string.ReportTitleViolence));
        } else if (i == 2) {
            textView.setText(LocaleController.getString(C2888R.string.ReportTitleChild));
        } else if (i == 5) {
            textView.setText(LocaleController.getString(C2888R.string.ReportTitlePornography));
        } else if (i == 100) {
            textView.setText(LocaleController.getString(C2888R.string.ReportChat));
        }
        ...
        textView2.setText(LocaleController.getString(C2888R.string.ReportInfo));
        ...
        this.editText.setHint(LocaleController.getString(C2888R.string.ReportHint));
        ...
        this.clearButton.setText(LocaleController.getString(C2888R.string.ReportSend));
