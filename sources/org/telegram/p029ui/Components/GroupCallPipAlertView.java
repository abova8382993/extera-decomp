...
public class GroupCallPipAlertView extends LinearLayout implements VoIPService.StateListener, NotificationCenter.NotificationCenterDelegate {
    ...
    public GroupCallPipAlertView(final Context context, int i) {
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.Components.GroupCallPipAlertView.1
            ...
            public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
                ...
                if (sharedInstance != null && ChatObject.isChannelOrGiga(sharedInstance.getChat())) {
                    accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, LocaleController.getString(C2888R.string.VoipChannelOpenVoiceChat)));
                } else {
                    accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, LocaleController.getString(C2888R.string.VoipGroupOpenVoiceChat)));
                }
            }
        };
        this.groupInfoContainer = frameLayout;
        frameLayout.setPadding(AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(8.0f));
        ...
        this.groupInfoContainer.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1124dp(6.0f), 0, ColorUtils.setAlphaComponent(-1, 76)));
        ...
        this.leaveButton.setData(C2888R.drawable.calls_decline, -1, -3257782, 0.3f, false, LocaleController.getString(C2888R.string.VoipGroupLeave), false, false);
    ...
    */
    protected void onDraw(android.graphics.Canvas r22) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.GroupCallPipAlertView.onDraw(android.graphics.Canvas):void");
    }

    @Override // android.widget.LinearLayout, android.view.View
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(230.0f), TLObject.FLAG_30), i2);
    }
    ...
    protected void onAttachedToWindow() {
        ...
        if (sharedInstance != null && sharedInstance.groupCall != null) {
            ...
            avatarDrawable.setColor(Theme.getColor(Theme.keys_avatar_background[AvatarDrawable.getColorIndex(chat != null ? chat.f1660id : 0L)]), Theme.getColor(Theme.keys_avatar_background2[AvatarDrawable.getColorIndex(chat != null ? chat.f1660id : 0L)]));
            ...
            if (sharedInstance.isConference() && (call = sharedInstance.groupCall) != null) {
                if (call.sortedParticipants.size() == 1) {
                    strTrim = LocaleController.getString(C2888R.string.ConferenceChat);
                } else {
    ...
    private void updateMembersCount() {
        ...
        if (!sharedInstance.isSwitchingStream() && (callState == 1 || callState == 2 || callState == 6 || callState == 5)) {
            this.subtitleView.setText(LocaleController.getString(C2888R.string.VoipGroupConnecting));
            return;
        }
    ...
    private void updateButtons(boolean z) {
        ...
        if (sharedInstance.mutedByAdmin()) {
            this.muteButton.setData(C2888R.drawable.calls_unmute, -1, ColorUtils.setAlphaComponent(-1, 76), 0.1f, true, LocaleController.getString(C2888R.string.VoipMutedByAdminShort), true, z);
        } else {
            this.muteButton.setData(C2888R.drawable.calls_unmute, -1, ColorUtils.setAlphaComponent(-1, (int) ((sharedInstance.isMicMute() ? 0.3f : 0.15f) * 255.0f)), 0.1f, true, LocaleController.getString(sharedInstance.isMicMute() ? C2888R.string.VoipUnmute : C2888R.string.VoipMute), sharedInstance.isMicMute(), z);
        }
        invalidate();
    }
