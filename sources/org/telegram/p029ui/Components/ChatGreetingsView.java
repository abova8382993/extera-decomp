...
public abstract class ChatGreetingsView extends LinearLayout {
    ...
    public ChatGreetingsView(Context context, TLRPC.User user, int i, TLRPC.Document document, Theme.ResourcesProvider resourcesProvider) {
        super(context);
        this.showGreetings = !ExteraConfig.disableGreetingSticker;
        setOrientation(1);
        this.currentAccount = i;
        this.resourcesProvider = resourcesProvider;
        setPadding(0, AndroidUtilities.m1124dp(8.0f), 0, 0);
        ...
        updateLayout();
        updateColors();
        setText(LocaleController.getString(C2888R.string.NoMessages), LocaleController.getString(C2888R.string.NoMessagesGreetingsDescription));
    ...
    public void setPremiumLock(boolean z, boolean z2, CharSequence charSequence, CharSequence charSequence2, View.OnClickListener onClickListener) {
        ...
        if (z) {
            if (this.premiumIconView == null) {
                ...
                this.premiumIconView.setBackground(Theme.createCircleDrawable(AndroidUtilities.m1124dp(78.0f), 469762048));
                if (z2) {
                    this.premiumIconView.setImageResource(C2888R.drawable.filled_chatlist2);
                } else {
                    this.premiumIconView.setAnimation(C2888R.raw.large_message_lock, 80, 80);
            ...
            this.premiumTextView.setLineSpacing(AndroidUtilities.m1124dp(2.0f), 1.0f);
            if (this.premiumButtonView == null) {
                ...
                this.premiumButtonView.setPadding(AndroidUtilities.m1124dp(13.0f), AndroidUtilities.m1124dp(5.0f), AndroidUtilities.m1124dp(13.0f), AndroidUtilities.m1124dp(8.0f));
                this.premiumButtonView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1124dp(15.0f), 503316480, AndroidUtilities.DARK_STATUS_BAR_OVERLAY));
    ...
    private void updateLayout() {
        removeAllViews();
        setPadding(0, (this.showGreetings || this.preview) ? AndroidUtilities.m1124dp(8.0f) : 0, 0, 0);
        if (this.premiumLock) {
        ...
        boolean z = this.showGreetings;
        int i = (z || this.preview) ? 20 : 9;
        int i2 = 6;
        int i3 = (z || this.preview) ? 6 : 2;
        int i4 = (z || this.preview) ? 20 : 9;
        if (!z && !this.preview) {
            i2 = 3;
        }
        addView(textView2, LayoutHelper.createLinear(-2, -2, 1, i, i3, i4, i2));
    ...
    public void setSticker(TLRPC.Document document) {
        ...
        if (document == null) {
            if (this.preview) {
                this.stickerExplicitlyHidden = true;
                this.wasDraw = true;
                this.stickerToSendView.clearImage();
                this.nextStickerToSendView.clearImage();
                this.stickerContainer.setVisibility(8);
                this.stickerToSendView.setOnClickListener(null);
                return;
            }
            return;
        }
        this.stickerExplicitlyHidden = false;
    ...
    public void setNextSticker(TLRPC.Document document, Runnable runnable) {
        ...
        this.nextStickerToSendView.getImageReceiver().setDelegate(new C42092(runnable));
        SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(document, Theme.key_chat_serviceBackground, 1.0f);
        if (svgThumb != null) {
            document2 = document;
    ...
    class C42092 implements ImageReceiver.ImageReceiverDelegate {
    ...
    public void toggleToNextSticker() {
        ...
        animatorSet3.playTogether(objectAnimatorOfFloat, objectAnimatorOfFloat2, ObjectAnimator.ofFloat(this.nextStickerToSendView, (Property<BackupImageView, Float>) property3, 0.7f, 1.0f), ObjectAnimator.ofFloat(this.nextStickerToSendView, (Property<BackupImageView, Float>) property4, -AndroidUtilities.m1124dp(24.0f), 0.0f), ObjectAnimator.ofFloat(this.stickerToSendView, (Property<BackupImageView, Float>) property, 1.0f, 0.0f), ObjectAnimator.ofFloat(this.stickerToSendView, (Property<BackupImageView, Float>) property2, 1.0f, 0.7f), ObjectAnimator.ofFloat(this.stickerToSendView, (Property<BackupImageView, Float>) property3, 1.0f, 0.7f), ObjectAnimator.ofFloat(this.stickerToSendView, (Property<BackupImageView, Float>) property4, 0.0f, AndroidUtilities.m1124dp(24.0f)));
    ...
    public static String createFilter(TLRPC.Document document) {
        ...
        while (true) {
            ...
            if (documentAttribute instanceof TLRPC.TL_documentAttributeImageSize) {
                iM1124dp = documentAttribute.f1671w;
                i = documentAttribute.f1670h;
                break;
            }
            i2++;
        }
        if (MessageObject.isAnimatedStickerDocument(document, true) && iM1124dp == 0 && i == 0) {
            iM1124dp = 512;
            i = 512;
        }
        if (iM1124dp == 0) {
            i = (int) f2;
            iM1124dp = i + AndroidUtilities.m1124dp(100.0f);
        }
        int i3 = (int) (i * (f2 / iM1124dp));
        int i4 = (int) f2;
        float f3 = i3;
        if (f3 > f2) {
            i4 = (int) (i4 * (f2 / f3));
    ...
    public void setPreview(CharSequence charSequence, CharSequence charSequence2) {
        ...
        if (TextUtils.isEmpty(charSequence == null ? null : charSequence.toString().trim())) {
            charSequence = LocaleController.getString(C2888R.string.NoMessages);
        }
        textView.setText(charSequence);
        TextView textView2 = this.descriptionView;
        if (TextUtils.isEmpty(charSequence2 != null ? charSequence2.toString().trim() : null)) {
            charSequence2 = LocaleController.getString(C2888R.string.NoMessagesGreetingsDescription);
        }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (this.disableBackground) {
            ...
            canvas2 = canvas;
            canvas2.drawRoundRect(0.0f, 0.0f, getWidth(), getHeight(), AndroidUtilities.m1124dp(16.0f), AndroidUtilities.m1124dp(16.0f), Theme.getThemePaint("paintChatActionBackground", this.resourcesProvider));
        }
        if (!this.wasDraw) {
            this.wasDraw = true;
            if (!this.stickerExplicitlyHidden) {
    ...
    public static void showPremiumSheet(Context context, int i, long j, Theme.ResourcesProvider resourcesProvider) {
        ...
        rLottieImageView.setScaleType(ImageView.ScaleType.CENTER);
        rLottieImageView.setAnimation(C2888R.raw.large_message_lock, 80, 80);
        ...
        textView.setText(LocaleController.getString(zPremiumFeaturesBlocked ? C2888R.string.PremiumMessageHeaderLocked : C2888R.string.PremiumMessageHeader));
        ...
        textView2.setText(AndroidUtilities.replaceTags(LocaleController.formatString(zPremiumFeaturesBlocked ? C2888R.string.PremiumMessageTextLocked : C2888R.string.PremiumMessageText, firstName, firstName)));
        ...
        if (!zPremiumFeaturesBlocked) {
            ...
            premiumButtonView.setOverlayText(LocaleController.getString(C2888R.string.PremiumMessageButton), false, false);
