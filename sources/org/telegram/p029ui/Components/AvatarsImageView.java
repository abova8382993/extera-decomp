...
public class AvatarsImageView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.plusText != null) {
            ...
            rectF.set(getWidth() - AndroidUtilities.m1124dp(22.0f), getHeight() - AndroidUtilities.m1124dp(22.0f), getWidth() - AndroidUtilities.m1124dp(0.0f), getHeight() - AndroidUtilities.m1124dp(0.0f));
            this.premiumGradient.gradientMatrix(rectF);
            canvas.drawCircle(rectF.centerX(), rectF.centerY(), (rectF.width() / 2.0f) + AndroidUtilities.m1124dp(1.33f), this.plusBgPaint);
