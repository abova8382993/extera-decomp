...
public class BackupImageView extends View {
    ...
    public void drawBlurredText(Canvas canvas, float f) {
        ...
        float currentWidth = this.blurText.getCurrentWidth() + AndroidUtilities.m1124dp(18.0f);
        float fM1124dp = AndroidUtilities.m1124dp(28.0f);
        float f2 = (measuredWidth - currentWidth) / 2.0f;
        float f3 = measuredHeight / 2.0f;
        RectF rectF = AndroidUtilities.rectTmp;
        float f4 = fM1124dp / 2.0f;
        ...
        this.blurText.draw(canvas, f2 + AndroidUtilities.m1124dp(9.0f), f3, -1, f);
        canvas.restore();
    }
