...
import org.telegram.p029ui.ActionBar.theme.ITheme;
...
public class ThemeSmallPreviewView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ThemeSmallPreviewView(Context context, int i, Theme.ResourcesProvider resourcesProvider, int i2) {
        super(context);
        this.STROKE_RADIUS = AndroidUtilities.m1124dp(8.0f);
        this.INNER_RADIUS = AndroidUtilities.m1124dp(6.0f);
        this.INNER_RECT_SPACE = AndroidUtilities.m1124dp(4.0f);
        this.BUBBLE_HEIGHT = AndroidUtilities.m1124dp(21.0f);
        this.BUBBLE_WIDTH = AndroidUtilities.m1124dp(41.0f);
        ...
        this.outlineBackgroundPaint.setStrokeWidth(AndroidUtilities.m1124dp(2.0f));
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (i3 == 1 || i3 == 4) {
            ...
            int iM1124dp = AndroidUtilities.m1124dp(i3 == 0 ? 77.0f : 83.0f);
            int size2 = View.MeasureSpec.getSize(i2);
            if (size2 == 0) {
                size2 = (int) (iM1124dp * 1.35f);
            }
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(iM1124dp, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2, TLObject.FLAG_30));
        }
    ...
    public void setItem(final ChatThemeBottomSheet.ChatThemeItem chatThemeItem, long j, boolean z) {
        ...
        if (emojiThemes == null || emojiThemes.isAnyStub()) {
            setContentDescription(LocaleController.getString(C2888R.string.ChatNoTheme));
        } else {
    ...
    public /* synthetic */ void lambda$setItem$3(final ChatThemeBottomSheet.ChatThemeItem chatThemeItem, final int i) {
        final Bitmap bitmap = SvgHelper.getBitmap(C2888R.raw.default_pattern, AndroidUtilities.m1124dp(120.0f), AndroidUtilities.m1124dp(140.0f), -16777216, AndroidUtilities.density);
    ...
    private Bitmap prescaleBitmap(Bitmap bitmap) {
        ...
        float fMax = Math.max(AndroidUtilities.m1124dp(120.0f) / bitmap.getWidth(), AndroidUtilities.m1124dp(140.0f) / bitmap.getHeight());
    ...
    private void fillOutBubblePaint(Paint paint, List list) {
        if (list.size() > 1) {
            ...
            float fM1124dp = this.INNER_RECT_SPACE + AndroidUtilities.m1124dp(8.0f);
            paint.setShader(new LinearGradient(0.0f, fM1124dp, 0.0f, fM1124dp + this.BUBBLE_HEIGHT, iArr, (float[]) null, Shader.TileMode.CLAMP));
            return;
        }
        ...
        if (themeItem.themeInfo.getAccent(false) != null) {
            ...
            if (i != 0) {
                ...
                if (themeInfo != null && (themeInfo.previewWallpaperOffset > 0 || themeInfo.pathToWallpaper != null)) {
                    float fM1124dp = AndroidUtilities.m1124dp(112.0f);
                    float fM1124dp2 = AndroidUtilities.m1124dp(134.0f);
                    Theme.ThemeInfo themeInfo2 = themeItem.themeInfo;
                    Bitmap scaledBitmap = AndroidUtilities.getScaledBitmap(fM1124dp, fM1124dp2, themeInfo2.pathToWallpaper, themeInfo2.pathToFile, themeInfo2.previewWallpaperOffset);
    ...
    public StaticLayout getNoThemeStaticLayout() {
        ...
        textPaint.setColor(getThemedColor(Theme.key_chat_emojiPanelTrendingDescription));
        this.noThemeTextPaint.setTextSize(AndroidUtilities.m1124dp(noThemeStringTextSize()));
        this.noThemeTextPaint.setTypeface(AndroidUtilities.bold());
        int iM1124dp = AndroidUtilities.m1124dp(52.0f);
        int i = this.currentType;
        if (i == 3 || i == 4) {
            iM1124dp = AndroidUtilities.m1124dp(77.0f);
        }
        int i2 = iM1124dp;
    ...
    protected String noThemeString() {
        return LocaleController.getString(C2888R.string.ChatNoTheme);
    }
    ...
    private class ThemeDrawable {
        ...
        public void draw(Canvas canvas, float f) {
            ...
            if (themeSmallPreviewView.isSelected || themeSmallPreviewView.strokeAlphaAnimator != null) {
                ...
                float strokeWidth = (this.strokePaint.getStrokeWidth() * 0.5f) + (AndroidUtilities.m1124dp(4.0f) * (1.0f - ThemeSmallPreviewView.this.selectionProgress));
            ...
            if (emojiThemes == null || (emojiThemes.isAnyStub() && ThemeSmallPreviewView.this.chatThemeItem.chatTheme.wallpaper == null)) {
                ...
                if (themeSmallPreviewView2.fallbackWallpaper == null) {
                    ...
                    canvas.translate((ThemeSmallPreviewView.this.getWidth() - noThemeStaticLayout.getWidth()) * 0.5f, AndroidUtilities.m1124dp(18.0f));
            ...
            if (ThemeSmallPreviewView.this.currentType != 4) {
                if (ThemeSmallPreviewView.this.currentType == 2) {
                    if (ThemeSmallPreviewView.this.chatThemeItem.icon != null) {
                        canvas.drawBitmap(ThemeSmallPreviewView.this.chatThemeItem.icon, (r2.getWidth() - ThemeSmallPreviewView.this.chatThemeItem.icon.getWidth()) * 0.5f, AndroidUtilities.m1124dp(21.0f), (Paint) null);
                        return;
                    }
                    return;
                }
                float fM1124dp = ThemeSmallPreviewView.this.INNER_RECT_SPACE + AndroidUtilities.m1124dp(8.0f);
                float fM1124dp2 = ThemeSmallPreviewView.this.INNER_RECT_SPACE + AndroidUtilities.m1124dp(ThemeSmallPreviewView.this.currentType == 3 ? 5.0f : 22.0f);
                if (ThemeSmallPreviewView.this.currentType == 0 || ThemeSmallPreviewView.this.currentType == 3) {
                    ThemeSmallPreviewView.this.rectF.set(fM1124dp2, fM1124dp, (ThemeSmallPreviewView.this.BUBBLE_WIDTH * (ThemeSmallPreviewView.this.currentType == 3 ? 1.2f : 1.0f)) + fM1124dp2, ThemeSmallPreviewView.this.BUBBLE_HEIGHT + fM1124dp);
                } else {
                    fM1124dp = ThemeSmallPreviewView.this.getMeasuredHeight() * 0.12f;
                    ThemeSmallPreviewView.this.rectF.set(ThemeSmallPreviewView.this.getMeasuredWidth() - (ThemeSmallPreviewView.this.getMeasuredWidth() * 0.65f), fM1124dp, ThemeSmallPreviewView.this.getMeasuredWidth() - (ThemeSmallPreviewView.this.getMeasuredWidth() * 0.1f), ThemeSmallPreviewView.this.getMeasuredHeight() * 0.32f);
                }
                ...
                if (ThemeSmallPreviewView.this.currentType == 0 || ThemeSmallPreviewView.this.currentType == 3) {
                    float fM1124dp3 = ThemeSmallPreviewView.this.INNER_RECT_SPACE + AndroidUtilities.m1124dp(5.0f);
                    float fM1124dp4 = fM1124dp + ThemeSmallPreviewView.this.BUBBLE_HEIGHT + AndroidUtilities.m1124dp(4.0f);
                    ThemeSmallPreviewView.this.rectF.set(fM1124dp3, fM1124dp4, (ThemeSmallPreviewView.this.BUBBLE_WIDTH * (ThemeSmallPreviewView.this.currentType == 3 ? 0.8f : 1.0f)) + fM1124dp3, ThemeSmallPreviewView.this.BUBBLE_HEIGHT + fM1124dp4);
                } else {
                ...
                if (ThemeSmallPreviewView.this.currentType == 0 || ThemeSmallPreviewView.this.currentType == 3) {
                    ...
                    if (ThemeSmallPreviewView.this.themeUserByUserId != 0) {
                        ...
                        ThemeSmallPreviewView.this.rectF.set(fHeight - AndroidUtilities.m1124dp(f2), fCenterY - AndroidUtilities.m1124dp(f2), fHeight + AndroidUtilities.m1124dp(f2), AndroidUtilities.m1124dp(f2) + fCenterY);
                        ...
                        if (this.rotateDrawable == null) {
                            this.rotateDrawable = ThemeSmallPreviewView.this.getContext().getDrawable(C2888R.drawable.mini_replace_16).mutate();
                        }
                        int i2 = (int) fHeight2;
                        int i3 = (int) fCenterY;
                        this.rotateDrawable.setBounds(i2 - AndroidUtilities.m1124dp(f2), i3 - AndroidUtilities.m1124dp(f2), i2 + AndroidUtilities.m1124dp(f2), i3 + AndroidUtilities.m1124dp(f2));
