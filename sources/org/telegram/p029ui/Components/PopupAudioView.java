...
public class PopupAudioView extends BaseCell implements SeekBar.SeekBarDelegate, DownloadController.FileDownloadProgressListener {
    ...
    protected void onMeasure(int i, int i2) {
        setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m1124dp(56.0f));
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        this.seekBarX = AndroidUtilities.m1124dp(54.0f);
        this.buttonX = AndroidUtilities.m1124dp(10.0f);
        this.timeX = (getMeasuredWidth() - this.timeWidth) - AndroidUtilities.m1124dp(16.0f);
        this.seekBar.setSize((getMeasuredWidth() - AndroidUtilities.m1124dp(70.0f)) - this.timeWidth, AndroidUtilities.m1124dp(30.0f));
        this.progressView.width = (getMeasuredWidth() - AndroidUtilities.m1124dp(94.0f)) - this.timeWidth;
        this.progressView.height = AndroidUtilities.m1124dp(30.0f);
        this.seekBarY = AndroidUtilities.m1124dp(13.0f);
        this.buttonY = AndroidUtilities.m1124dp(10.0f);
        updateProgress();
        if (z || !this.wasLayout) {
            this.wasLayout = true;
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (i4 == 0 || i4 == 1) {
            ...
            canvas.translate(this.seekBarX + AndroidUtilities.m1124dp(12.0f), this.seekBarY);
        ...
        BaseCell.setDrawableBounds(drawable, ((iM1124dp - drawable.getIntrinsicWidth()) / 2) + this.buttonX, ((iM1124dp - drawable.getIntrinsicHeight()) / 2) + this.buttonY);
        drawable.draw(canvas);
        canvas.save();
        canvas.translate(this.timeX, AndroidUtilities.m1124dp(18.0f));
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r8) {
        ...
        Lb4:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.PopupAudioView.onTouchEvent(android.view.MotionEvent):boolean");
    }
