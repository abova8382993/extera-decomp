...
public class PhonebookShareAlert extends BottomSheet {
    ...
    public class UserCell extends LinearLayout {
        public UserCell(Context context) {
            ...
            avatarDrawable.setTextSize(AndroidUtilities.m1124dp(30.0f));
    ...
    public class TextCheckBoxCell extends FrameLayout {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            setMeasuredDimension(View.MeasureSpec.getSize(i), Math.max(AndroidUtilities.m1124dp(64.0f), this.textView.getMeasuredHeight() + this.valueTextView.getMeasuredHeight() + AndroidUtilities.m1124dp(20.0f)) + (this.needDivider ? 1 : 0));
        }

        @Override // android.widget.FrameLayout, android.view.ViewGroup, android.view.View
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            super.onLayout(z, i, i2, i3, i4);
            int measuredHeight = this.textView.getMeasuredHeight() + AndroidUtilities.m1124dp(13.0f);
    ...
    */
    ...
    public /* synthetic */ void lambda$new$2(int i, View view, View view2) {
        ...
        if (this.isImport) {
            ...
            builder.setItems(new CharSequence[]{LocaleController.getString(C2888R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.PhonebookShareAlert$$ExternalSyntheticLambda6
        ...
        if (i == 0) {
            try {
                ...
                if (AndroidUtilities.shouldShowClipboardToast()) {
                    Toast.makeText(this.parentFragment.getParentActivity(), LocaleController.getString(C2888R.string.TextCopied), 0).show();
                }
            } catch (Exception e) {
                FileLog.m1136e(e);
            }
    ...
    public /* synthetic */ boolean lambda$new$3(int i, Theme.ResourcesProvider resourcesProvider, Context context, View view) {
        ...
        if (BulletinFactory.canShowBulletin(this.parentFragment)) {
            if (vcardItem.type == 3) {
                BulletinFactory.m1245of((FrameLayout) this.containerView, resourcesProvider).createCopyLinkBulletin().show();
            } else {
                Bulletin.SimpleLayout simpleLayout = new Bulletin.SimpleLayout(context, resourcesProvider);
                int i4 = vcardItem.type;
                if (i4 == 0) {
                    simpleLayout.textView.setText(LocaleController.getString(C2888R.string.PhoneCopied));
                    simpleLayout.imageView.setImageResource(C2888R.drawable.msg_calls);
                } else if (i4 == 1) {
                    simpleLayout.textView.setText(LocaleController.getString(C2888R.string.EmailCopied));
                    simpleLayout.imageView.setImageResource(C2888R.drawable.msg_mention);
                } else {
                    simpleLayout.textView.setText(LocaleController.getString(C2888R.string.TextCopied));
                    simpleLayout.imageView.setImageResource(C2888R.drawable.msg_info);
                }
                if (AndroidUtilities.shouldShowClipboardToast()) {
    ...
    public /* synthetic */ void lambda$new$6(Theme.ResourcesProvider resourcesProvider, View view) {
        ...
        if (this.isImport) {
            ...
            builder.setTitle(LocaleController.getString(C2888R.string.AddContactTitle));
            builder.setNegativeButton(LocaleController.getString(C2888R.string.Cancel), null);
            builder.setItems(new CharSequence[]{LocaleController.getString(C2888R.string.CreateNewContact), LocaleController.getString(C2888R.string.AddToExistingContact)}, new DialogInterface.OnClickListener() { // from class: org.telegram.ui.Components.PhonebookShareAlert.5
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    String str3;
                    String str4;
                    DialogInterfaceOnClickListenerC46845 dialogInterfaceOnClickListenerC46845;
                    Integer num;
                    boolean z2;
                    String str5;
                    boolean z3;
                    DialogInterfaceOnClickListenerC46845 dialogInterfaceOnClickListenerC468452 = this;
                    int i3 = 3;
                    Integer num2 = 3;
                    int i4 = 1;
                    if (i == 0) {
                    ...
                    while (true) {
                        ...
                        dialogInterfaceOnClickListenerC468452.fillRowWithType(vcardItem.getRawType(false), contentValues);
                    ...
                    while (i6 < PhonebookShareAlert.this.other.size()) {
                        ...
                        if (i7 == i4) {
                            ...
                            dialogInterfaceOnClickListenerC468452.fillRowWithType(vcardItem2.getRawType(z4), contentValues2);
                            arrayList.add(contentValues2);
                        } else if (i7 == i3) {
                            ContentValues contentValues3 = new ContentValues();
                            contentValues3.put(str2, "vnd.android.cursor.item/website");
                            contentValues3.put(str, vcardItem2.getValue(z4));
                            dialogInterfaceOnClickListenerC468452.fillUrlRowWithType(vcardItem2.getRawType(z4), contentValues3);
                            ...
                            if (i7 == 2) {
                                ...
                                z2 = false;
                                dialogInterfaceOnClickListenerC46845 = this;
                                num = num2;
                                str3 = str2;
                                str4 = str6;
                            } else {
                            ...
                            i6 = i2 + 1;
                            dialogInterfaceOnClickListenerC468452 = dialogInterfaceOnClickListenerC46845;
                            str = str4;
                            z4 = z2;
                            num2 = num;
                            z5 = z;
                        ...
                        str4 = str;
                        str3 = str2;
                        dialogInterfaceOnClickListenerC46845 = dialogInterfaceOnClickListenerC468452;
                        i6 = i2 + 1;
                        dialogInterfaceOnClickListenerC468452 = dialogInterfaceOnClickListenerC46845;
                        str = str4;
                        z4 = z2;
                    ...
                    DialogInterfaceOnClickListenerC46845 dialogInterfaceOnClickListenerC468453 = dialogInterfaceOnClickListenerC468452;
    ...
    protected void onStart() {
        ...
        Bulletin.addDelegate((FrameLayout) this.containerView, new Bulletin.Delegate() { // from class: org.telegram.ui.Components.PhonebookShareAlert.6
            ...
            public int getBottomOffset(int i) {
                return AndroidUtilities.m1124dp(74.0f);
            }
        });
    }
        ...
        public void onBindViewHolder(View view, int i, int i2) {
            ...
            if (i2 == 1) {
                ...
                if (i >= PhonebookShareAlert.this.phoneStartRow && i < PhonebookShareAlert.this.phoneEndRow) {
                    ...
                    i3 = C2888R.drawable.msg_calls;
                } else {
                    vcardItem = (AndroidUtilities.VcardItem) PhonebookShareAlert.this.other.get(i - PhonebookShareAlert.this.vcardStartRow);
                    int i4 = vcardItem.type;
                    if (i4 == 1) {
                        i3 = C2888R.drawable.msg_mention;
                    } else if (i4 == 2) {
                        i3 = C2888R.drawable.msg_location;
                    } else if (i4 == 3) {
                        i3 = C2888R.drawable.msg_link;
                    } else if (i4 == 4) {
                        i3 = C2888R.drawable.msg_info;
                    } else if (i4 == 5) {
                        i3 = C2888R.drawable.msg_calendar2;
                    } else if (i4 == 6) {
                        if ("ORG".equalsIgnoreCase(vcardItem.getRawType(true))) {
                            i3 = C2888R.drawable.msg_work;
                        } else {
                            i3 = C2888R.drawable.msg_jobtitle;
                        }
                    } else if (i4 == 20) {
                        i3 = C2888R.drawable.msg_info;
                    } else {
