...
public class DialogsActivityTopPanelLayout extends AnimatedLinearLayout {
    ...
    private void checkBoundsAndClipping() {
        ...
        float fMin = Math.min(AndroidUtilities.m1124dp(24.0f), Math.min(this.clipRectF.width(), this.clipRectF.height()) / 2.0f);
        ...
        if (blurredBackgroundDrawable != null) {
            ...
            this.backgroundDrawable.setBounds(AndroidUtilities.m1124dp(4.0f), AndroidUtilities.m1124dp(14.0f), getMeasuredWidth() - AndroidUtilities.m1124dp(4.0f), ((getPaddingTop() + getPaddingBottom()) + ((int) totalHeight)) - AndroidUtilities.m1124dp(14.0f));
            this.backgroundDrawable.setRadius(Math.min(AndroidUtilities.m1124dp(24.0f), totalHeight / 2.0f));
        }
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        while (i < entriesCount) {
            ...
            canvas2.drawLine(getPaddingLeft() + (AndroidUtilities.m1124dp(16.0f) * f), paddingTop, getWidth() - (getPaddingRight() + (AndroidUtilities.m1124dp(16.0f) * f)), paddingTop, Theme.dividerPaint);
