...
import org.telegram.p029ui.Components.PollVotesAlert;
...
public class PollVotesAlert extends BottomSheet {
    ...
    public class SectionCell extends FrameLayout {
        ...
        protected void onMeasure(int i, int i2) {
            int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(32.0f), TLObject.FLAG_30);
            ...
            measureChildWithMargins(this.textView, i, this.middleTextView.getMeasuredWidth() + this.righTextView.getMeasuredWidth() + AndroidUtilities.m1124dp(32.0f), iMakeMeasureSpec, 0);
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m1124dp(32.0f));
        }
        ...
        public void setText(CharSequence charSequence, ArrayList arrayList, int i, int i2, int i3, boolean z) {
            ...
            if (i3 == 1) {
                this.righTextView.setText(LocaleController.getString(C2888R.string.PollExpand), z);
            } else {
                this.righTextView.setText(LocaleController.getString(C2888R.string.PollCollapse), z);
            }
        }
    }
    ...
    public class UserCell extends LinearLayout {
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(48.0f) + (this.needDivider ? 1 : 0), TLObject.FLAG_30));
        }
  ...
  0x0077: PHI (r1v7 java.lang.String) = (r1v0 java.lang.String), (r1v0 java.lang.String), (r1v0 java.lang.String), (r1v10 java.lang.String) binds: [B:41:0x0056, B:43:0x005a, B:45:0x005f, B:52:0x0074] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (this.drawPlaceholder || this.placeholderAlpha != 0.0f) {
                ...
                if (this.placeholderNum % 2 == 0) {
                    iM1124dp = AndroidUtilities.m1124dp(65.0f);
                    iM1124dp2 = AndroidUtilities.m1124dp(48.0f);
                } else {
                    iM1124dp = AndroidUtilities.m1124dp(65.0f);
                    iM1124dp2 = AndroidUtilities.m1124dp(60.0f);
                }
                if (LocaleController.isRTL) {
                    iM1124dp = (getMeasuredWidth() - iM1124dp) - iM1124dp2;
                }
                PollVotesAlert.this.rect.set(iM1124dp, r2 - AndroidUtilities.m1124dp(4.0f), iM1124dp + iM1124dp2, AndroidUtilities.m1124dp(4.0f) + r2);
                canvas.drawRoundRect(PollVotesAlert.this.rect, AndroidUtilities.m1124dp(4.0f), AndroidUtilities.m1124dp(4.0f), PollVotesAlert.this.placeholderPaint);
                if (this.placeholderNum % 2 == 0) {
                    iM1124dp3 = AndroidUtilities.m1124dp(119.0f);
                    iM1124dp4 = AndroidUtilities.m1124dp(60.0f);
                } else {
                    iM1124dp3 = AndroidUtilities.m1124dp(131.0f);
                    iM1124dp4 = AndroidUtilities.m1124dp(80.0f);
                }
                if (LocaleController.isRTL) {
                    iM1124dp3 = (getMeasuredWidth() - iM1124dp3) - iM1124dp4;
                }
                PollVotesAlert.this.rect.set(iM1124dp3, r2 - AndroidUtilities.m1124dp(4.0f), iM1124dp3 + iM1124dp4, r2 + AndroidUtilities.m1124dp(4.0f));
                canvas.drawRoundRect(PollVotesAlert.this.rect, AndroidUtilities.m1124dp(4.0f), AndroidUtilities.m1124dp(4.0f), PollVotesAlert.this.placeholderPaint);
            }
            if (this.needDivider) {
                canvas.drawLine(LocaleController.isRTL ? 0.0f : AndroidUtilities.m1124dp(64.0f), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m1124dp(64.0f) : 0), getMeasuredHeight() - 1, Theme.dividerPaint);
            }
        }
    }
    ...
    public PollVotesAlert(final ChatActivity chatActivity, MessageObject messageObject) {
        ...
        while (i3 < size) {
            ...
            if (tL_pollAnswerVoters.voters == 0) {
                ...
                tL_messages_getPollVotes.f1764id = this.messageObject.getId();
        ...
        updatePlaceholder();
        Drawable drawableMutate = parentActivity.getResources().getDrawable(C2888R.drawable.sheet_shadow_round).mutate();
        ...
        FrameLayout frameLayout = new FrameLayout(parentActivity) { // from class: org.telegram.ui.Components.PollVotesAlert.3
            ...
            protected void onMeasure(int i8, int i9) {
                ...
                int iM1124dp = ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop + AndroidUtilities.m1124dp(15.0f) + AndroidUtilities.statusBarHeight;
                ...
                for (int i10 = 0; i10 < sectionCount; i10++) {
                    if (i10 == 0) {
                        ...
                        iM1124dp += PollVotesAlert.this.titleTextView.getMeasuredHeight();
                    } else {
                        iM1124dp += AndroidUtilities.m1124dp(32.0f) + (AndroidUtilities.m1124dp(50.0f) * (PollVotesAlert.this.listAdapter.getCountForSection(i10) - 1));
                    }
                }
                int iM1124dp2 = (iM1124dp < paddingTop ? paddingTop - iM1124dp : paddingTop - ((paddingTop / 5) * 3)) + AndroidUtilities.m1124dp(8.0f);
                if (PollVotesAlert.this.listView.getPaddingTop() != iM1124dp2) {
                    this.ignoreLayout = true;
                    PollVotesAlert.this.listView.setPinnedSectionOffsetY(-iM1124dp2);
                    PollVotesAlert.this.listView.setPadding(0, iM1124dp2, 0, 0);
                    this.ignoreLayout = false;
                }
            ...
            public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
                if (motionEvent.getAction() == 0 && PollVotesAlert.this.scrollOffsetY != 0 && motionEvent.getY() < PollVotesAlert.this.scrollOffsetY + AndroidUtilities.m1124dp(12.0f) && PollVotesAlert.this.actionBar.getAlpha() == 0.0f) {
            ...
            protected void onDraw(Canvas canvas) {
                ...
                int translationY = (PollVotesAlert.this.scrollOffsetY - ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop) - iM1124dp;
                ...
                int measuredHeight = getMeasuredHeight() + AndroidUtilities.m1124dp(15.0f) + ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop;
                if (((BottomSheet) PollVotesAlert.this).backgroundPaddingTop + translationY < ActionBar.getCurrentActionBarHeight()) {
                    ...
                    float fMin = Math.min(1.0f, ((ActionBar.getCurrentActionBarHeight() - translationY) - ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop) / fM1124dp);
                ...
                if (f != 1.0f) {
                    ...
                    this.rect.set(((BottomSheet) PollVotesAlert.this).backgroundPaddingLeft, ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop + r1, getMeasuredWidth() - ((BottomSheet) PollVotesAlert.this).backgroundPaddingLeft, ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop + r1 + AndroidUtilities.m1124dp(24.0f));
                ...
                if (f != 0.0f) {
                    ...
                    this.rect.set((getMeasuredWidth() - iM1124dp3) / 2, i9, (getMeasuredWidth() + iM1124dp3) / 2, i9 + AndroidUtilities.m1124dp(4.0f));
        ...
        this.listView.setLayoutManager(new LinearLayoutManager(getContext(), i2, z) { // from class: org.telegram.ui.Components.PollVotesAlert.5
            ...
            protected int getExtraLayoutSpace(RecyclerView.State state) {
                return AndroidUtilities.m1124dp(4000.0f);
            }
        });
        ...
        this.listView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.Components.PollVotesAlert.6
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int i9) {
                if (i9 == 0) {
                    if (((PollVotesAlert.this.scrollOffsetY - ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop) - AndroidUtilities.m1124dp(13.0f)) + ((BottomSheet) PollVotesAlert.this).backgroundPaddingTop >= ActionBar.getCurrentActionBarHeight() || !PollVotesAlert.this.listView.canScrollVertically(1)) {
                        return;
                    }
                    ...
                    if (holder == null || holder.itemView.getTop() <= AndroidUtilities.m1124dp(7.0f)) {
                        return;
                    }
                    PollVotesAlert.this.listView.smoothScrollBy(0, holder.itemView.getTop() - AndroidUtilities.m1124dp(7.0f));
                }
            }
        });
        ...
        this.titleTextView.setPadding(AndroidUtilities.m1124dp(21.0f), AndroidUtilities.m1124dp(5.0f), AndroidUtilities.m1124dp(14.0f), AndroidUtilities.m1124dp(21.0f));
        ...
        this.actionBar.setTitle(LocaleController.getString(C2888R.string.PollResults));
        if (this.poll.quiz) {
        ...
        if (arrayList == null || arrayList.isEmpty()) {
            ...
            if (view instanceof UserCell) {
                ...
                if (userCell.currentUser != null) {
                    bundle.putLong("user_id", userCell.currentUser.f1825id);
                } else {
                    bundle.putLong("chat_id", userCell.currentChat.f1660id);
                }
                lambda$new$0();
                ProfileActivity profileActivity = new ProfileActivity(bundle);
                if (userCell.currentUser != null) {
                    TLRPC.User currentUser = chatActivity.getCurrentUser();
                    if (currentUser != null && currentUser.f1825id == userCell.currentUser.f1825id) {
                        i2 = 1;
                    }
                    profileActivity.setPlayProfileAnimation(i2);
                } else {
                    TLRPC.Chat currentChat = chatActivity.getCurrentChat();
                    if (currentChat != null && currentChat.f1660id == userCell.currentChat.f1660id) {
                        i2 = 1;
                    }
                    profileActivity.setPlayProfileAnimation(i2);
                }
    ...
    private void updateButtons() {
        ...
        Collections.sort(arrayList, new Comparator() { // from class: org.telegram.ui.Components.PollVotesAlert$$ExternalSyntheticLambda3
            ...
            public final int compare(Object obj, Object obj2) {
                return PollVotesAlert.m11453$r8$lambda$FQIb_wws2uU5VAs1x2U4THvRXQ((PollVotesAlert.Button) obj, (PollVotesAlert.Button) obj2);
            }
        });
    ...
    public static /* synthetic */ int m11453$r8$lambda$FQIb_wws2uU5VAs1x2U4THvRXQ(Button button, Button button2) {
    ...
    public void updateLayout(boolean z) {
        ...
        int iM1124dp2 = top + (layoutParams.topMargin - AndroidUtilities.m1124dp(11.0f));
        if (this.scrollOffsetY != iM1124dp2) {
            RecyclerListView recyclerListView2 = this.listView;
            this.scrollOffsetY = iM1124dp2;
            recyclerListView2.setTopGlowOffset(iM1124dp2 - layoutParams.topMargin);
            this.containerView.invalidate();
        }
    }
    ...
    public void updatePlaceholder() {
        ...
        float fM1124dp = AndroidUtilities.m1124dp(500.0f);
        this.gradientWidth = fM1124dp;
        LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, fM1124dp, 0.0f, new int[]{color2, averageColor, color2}, new float[]{0.0f, 0.18f, 0.36f}, Shader.TileMode.REPEAT);
    ...
    public class Adapter extends RecyclerListView.SectionsAdapter {
        ...
        private SectionCell createSectionCell() {
            return new SectionCell(this.mContext) { // from class: org.telegram.ui.Components.PollVotesAlert.Adapter.1
                ...
                protected void onCollapseClick() {
                    VotesList votesList = (VotesList) getTag(C2888R.id.object_tag);
        ...
        public View getSectionHeaderView(int i, View view) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (Arrays.equals(pollAnswer.option, votesList.option) && ((Button) PollVotesAlert.this.votesPercents.get(votesList)) != null) {
                    ...
                    sectionCell.setTag(C2888R.id.object_tag, votesList);
                    return view;
                }
            }
            return view;
        ...
        public void onBindViewHolder(int i, int i2, RecyclerView.ViewHolder viewHolder) {
            ...
            if (itemViewType != 2) {
                ...
                VotesList votesList = (VotesList) PollVotesAlert.this.voters.get(i - 1);
                textCell.setTextAndIcon((CharSequence) LocaleController.formatPluralString("ShowVotes", votesList.count - votesList.getCount(), new Object[0]), C2888R.drawable.arrow_more, false);
                return;
            }
            ...
            for (int i4 = 0; i4 < size; i4++) {
                ...
                if (Arrays.equals(pollAnswer.option, votesList2.option) && ((Button) PollVotesAlert.this.votesPercents.get(votesList2)) != null) {
                    ...
                    sectionCell.setTag(C2888R.id.object_tag, votesList2);
                    return;
                }
            }
        }
    ...
    public void animateSectionUpdates(View view) {
        ...
        while (i < this.listView.getChildCount()) {
            ...
            if ((pinnedHeader instanceof SectionCell) && (pinnedHeader.getTag(C2888R.id.object_tag) instanceof VotesList)) {
                SectionCell sectionCell = (SectionCell) pinnedHeader;
                VotesList votesList = (VotesList) pinnedHeader.getTag(C2888R.id.object_tag);
