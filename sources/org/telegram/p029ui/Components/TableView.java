...
public class TableView extends TableLayout {
    ...
    public TableView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        float fMax = Math.max(1, AndroidUtilities.m1124dp(0.66f));
        this.f2096w = fMax;
        this.f2095hw = fMax / 2.0f;
    ...
    public TableRow addRowMonospaced(CharSequence charSequence, final CharSequence charSequence2, int i, final Runnable runnable) {
        ...
        frameLayout.setPadding(AndroidUtilities.m1124dp(12.66f), AndroidUtilities.m1124dp(9.33f), AndroidUtilities.m1124dp(10.66f), AndroidUtilities.m1124dp(9.33f));
        ...
        if (runnable != null) {
            ...
            imageView.setImageResource(C2888R.drawable.msg_copy);
            ...
            imageView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.TableView$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view) {
                    TableView.m12768$r8$lambda$94D2tet7nd1WDBXBAcVpSQDBqE(charSequence2, runnable, view);
                }
            });
    ...
    public static /* synthetic */ void m12768$r8$lambda$94D2tet7nd1WDBXBAcVpSQDBqE(CharSequence charSequence, Runnable runnable, View view) {
    ...
    public TableRow addWalletAddressRow(CharSequence charSequence, final CharSequence charSequence2, final Runnable runnable) {
        ...
        linksTextView.setPadding(AndroidUtilities.m1124dp(12.66f), AndroidUtilities.m1124dp(9.33f), AndroidUtilities.m1124dp(10.66f), AndroidUtilities.m1124dp(9.33f));
    ...
    public TableRow addRowUserWithEmojiStatus(CharSequence charSequence, final int i, final long j, final Runnable runnable) {
        ...
        linksSimpleTextView.setPadding(AndroidUtilities.m1124dp(12.66f), AndroidUtilities.m1124dp(9.33f), AndroidUtilities.m1124dp(12.66f), AndroidUtilities.m1124dp(9.33f));
        ...
        if (j == UserObject.ANONYMOUS) {
            string = LocaleController.getString(C2888R.string.StarsTransactionHidden);
            ...
            if (UserObject.isService(j)) {
                string = LocaleController.getString(C2888R.string.StarsTransactionUnknown);
                CombinedDrawable platformDrawable2 = StarsIntroActivity.StarsTransactionView.getPlatformDrawable("fragment");
                platformDrawable2.setIconSize(AndroidUtilities.m1124dp(16.0f), AndroidUtilities.m1124dp(16.0f));
        ...
        final AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable swapAnimatedEmojiDrawable = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(linksSimpleTextView, AndroidUtilities.m1124dp(20.0f));
        swapAnimatedEmojiDrawable.setColor(Integer.valueOf(color));
        swapAnimatedEmojiDrawable.offset(AndroidUtilities.m1124dp(12.0f), 0);
        ...
        final Drawable drawableMutate = getContext().getResources().getDrawable(C2888R.drawable.msg_premium_liststar).mutate();
    ...
    */
    ...
    public TableRow addRowUser(CharSequence charSequence, int i, long j, final Runnable runnable, CharSequence charSequence2, Runnable runnable2) {
        ...
        textViewButtons.setPadding(AndroidUtilities.m1124dp(12.66f), AndroidUtilities.m1124dp(9.33f), AndroidUtilities.m1124dp(12.66f), AndroidUtilities.m1124dp(9.33f));
    ...
    public TableRow addRowDateTime(CharSequence charSequence, int i) {
        long j = ((long) i) * 1000;
        return addRow(charSequence, LocaleController.formatString(C2888R.string.formatDateAtTime, LocaleController.getInstance().getFormatterGiveawayCard().format(new Date(j)), LocaleController.getInstance().getFormatterDay().format(new Date(j))));
    }
    ...
    public TableRowFullContent addFullRow(CharSequence charSequence) {
        ...
        spoilersTextView.setPadding(AndroidUtilities.m1124dp(12.66f), AndroidUtilities.m1124dp(9.33f), AndroidUtilities.m1124dp(12.66f), AndroidUtilities.m1124dp(9.33f));
        TableRow tableRow = new TableRow(getContext());
        TableRow.LayoutParams layoutParams = new TableRow.LayoutParams(-2, -1);
        layoutParams.span = 2;
    ...
    public static class TableRowTitle extends TextView {
        ...
        public TableRowTitle(TableView tableView, CharSequence charSequence) {
            ...
            this.resourcesProvider = resourcesProvider;
            setPadding(AndroidUtilities.m1124dp(12.66f), AndroidUtilities.m1124dp(9.33f), AndroidUtilities.m1124dp(12.66f), AndroidUtilities.m1124dp(9.33f));
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (this.first || this.last) {
                ...
                float f = this.first ? fM1124dp : 0.0f;
                fArr2[1] = f;
                fArr[0] = f;
                ...
                rectF.set(this.table.f2095hw, this.table.f2095hw, getWidth() + this.table.f2095hw, getHeight() + (this.table.f2095hw * AndroidUtilities.m1124dp(this.last ? -1.0f : 1.0f)));
                ...
                canvas2 = canvas;
                canvas2.drawRect(this.table.f2095hw, this.table.f2095hw, getWidth() + this.table.f2095hw, getHeight() + this.table.f2095hw, this.table.backgroundPaint);
                canvas2.drawRect(this.table.f2095hw, this.table.f2095hw, getWidth() + this.table.f2095hw, getHeight() + this.table.f2095hw, this.table.borderPaint);
            }
    ...
    public static class TableRowFullContent extends FrameLayout {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (this.first || this.last) {
                ...
                float[] fArr3 = this.table.radii;
                float[] fArr4 = this.table.radii;
                float f2 = this.first ? fM1124dp : 0.0f;
                fArr4[3] = f2;
                fArr3[2] = f2;
                float[] fArr5 = this.table.radii;
                float[] fArr6 = this.table.radii;
                float f3 = this.last ? fM1124dp : 0.0f;
                fArr6[5] = f3;
                fArr5[4] = f3;
    ...
    public static class TableRowContent extends FrameLayout {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (this.first || this.last) {
                ...
                float[] fArr = this.table.radii;
                float[] fArr2 = this.table.radii;
                float f = (this.first && this.left) ? fM1124dp : 0.0f;
                fArr2[1] = f;
                fArr[0] = f;
                float[] fArr3 = this.table.radii;
                float[] fArr4 = this.table.radii;
                float f2 = (this.first && this.right) ? fM1124dp : 0.0f;
                fArr4[3] = f2;
                fArr3[2] = f2;
                float[] fArr5 = this.table.radii;
                float[] fArr6 = this.table.radii;
                float f3 = (this.last && this.right) ? fM1124dp : 0.0f;
                fArr6[5] = f3;
                fArr5[4] = f3;
                float[] fArr7 = this.table.radii;
                float[] fArr8 = this.table.radii;
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        this.borderPaint.setStrokeWidth(this.f2096w);
