...
public class AttachBotIntroTopView extends View {
    ...
    public AttachBotIntroTopView(Context context) {
        ...
        this.attachDrawable = ContextCompat.getDrawable(context, C2888R.drawable.input_attach).mutate().getConstantState().newDrawable();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        rectF.set(0.0f, 0.0f, getWidth(), getHeight() + AndroidUtilities.m1124dp(10.0f));
        canvas.drawRoundRect(rectF, AndroidUtilities.m1124dp(10.0f), AndroidUtilities.m1124dp(10.0f), this.backgroundPaint);
        this.imageReceiver.setImageCoords((getWidth() / 2.0f) - AndroidUtilities.m1124dp(66.0f), (getHeight() / 2.0f) - (AndroidUtilities.m1124dp(42.0f) / 2.0f), AndroidUtilities.m1124dp(42.0f), AndroidUtilities.m1124dp(42.0f));
        this.imageReceiver.draw(canvas);
        canvas.drawLine((getWidth() / 2.0f) - AndroidUtilities.m1124dp(8.0f), getHeight() / 2.0f, (getWidth() / 2.0f) + AndroidUtilities.m1124dp(8.0f), getHeight() / 2.0f, this.paint);
        canvas.drawLine(getWidth() / 2.0f, (getHeight() / 2.0f) - AndroidUtilities.m1124dp(8.0f), getWidth() / 2.0f, AndroidUtilities.m1124dp(8.0f) + (getHeight() / 2.0f), this.paint);
        this.attachDrawable.setBounds((getWidth() / 2) + AndroidUtilities.m1124dp(24.0f), (getHeight() / 2) - (AndroidUtilities.m1124dp(42.0f) / 2), (getWidth() / 2) + AndroidUtilities.m1124dp(66.0f), (getHeight() / 2) + (AndroidUtilities.m1124dp(42.0f) / 2));
