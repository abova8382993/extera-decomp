...
public class EditTextCaption extends EditTextBoldCursor {
    ...
    public static /* synthetic */ void $r8$lambda$V2eUCR_CoSrMwX_lV4DOS0oNCCI() {
    }
    ...
    class C42791 implements TextWatcher {
        @Override // android.text.TextWatcher
        public void beforeTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        }
    ...
    public void makeSelectedDate() {
        ...
        AlertsCreator.createFormattedDatePickerDialog(getContext(), new AlertsCreator.FormattedDatePickerDelegate() { // from class: org.telegram.ui.Components.EditTextCaption$$ExternalSyntheticLambda7
            ...
            public final void run() {
                EditTextCaption.$r8$lambda$V2eUCR_CoSrMwX_lV4DOS0oNCCI();
            }
    ...
    public void makeSelectedUrl() {
        ...
        ?? r2 = builder;
        r2.setTitle(LocaleController.getString(C2888R.string.CreateLink));
        ?? frameLayout = new FrameLayout(getContext());
        final C42802 c42802 = new EditTextBoldCursor(getContext()) { // from class: org.telegram.ui.Components.EditTextCaption.2
            C42802(Context context) {
                super(context);
            }

            @Override // org.telegram.p029ui.Components.EditTextBoldCursor, android.widget.TextView, android.view.View
            protected void onMeasure(int i, int i2) {
                super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(64.0f), TLObject.FLAG_30));
            }
        };
        c42802.setTextSize(1, 18.0f);
        c42802.setText("http://");
        c42802.setTextColor(getThemedColor(Theme.key_dialogTextBlack));
        c42802.setHintText(LocaleController.getString(C2888R.string.URL));
        c42802.setHeaderHintColor(getThemedColor(Theme.key_windowBackgroundWhiteBlueHeader));
        c42802.setSingleLine(true);
        c42802.setFocusable(true);
        c42802.setTransformHintToHeader(true);
        c42802.setLineColors(getThemedColor(Theme.key_windowBackgroundWhiteInputField), getThemedColor(Theme.key_windowBackgroundWhiteInputFieldActivated), getThemedColor(Theme.key_text_RedRegular));
        c42802.setImeOptions(6);
        c42802.setBackgroundDrawable(null);
        c42802.requestFocus();
        c42802.setPadding(0, 0, 0, 0);
        c42802.setHighlightColor(getThemedColor(Theme.key_chat_inTextSelectionHighlight));
        c42802.setHandlesColor(getThemedColor(Theme.key_chat_TextSelectionCursor));
        frameLayout.addView(c42802, LayoutHelper.createFrame(-1, -1, 119));
        final TextView textView = new TextView(getContext());
        textView.setTextSize(1, 12.0f);
        textView.setTypeface(AndroidUtilities.bold());
        textView.setText(LocaleController.getString(C2888R.string.Paste));
        textView.setPadding(AndroidUtilities.m1124dp(10.0f), 0, AndroidUtilities.m1124dp(10.0f), 0);
        textView.setGravity(17);
        int themedColor = getThemedColor(Theme.key_windowBackgroundWhiteBlueText2);
        textView.setTextColor(themedColor);
        textView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1124dp(6.0f), Theme.multAlpha(themedColor, 0.12f), Theme.multAlpha(themedColor, 0.15f)));
        ...
        final Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.EditTextCaption$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$makeSelectedUrl$2(c42802, textView);
            }
        };
        textView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.EditTextCaption$$ExternalSyntheticLambda1
            ...
            public final void onClick(View view) {
                this.f$0.lambda$makeSelectedUrl$3(c42802, runnable, view);
            }
        });
        c42802.addTextChangedListener(new TextWatcher() { // from class: org.telegram.ui.Components.EditTextCaption.3
            ...
            C42813(final Runnable runnable2) {
                runnable = runnable2;
            }
        ...
        if (clipboardManager != null && clipboardManager.hasPrimaryClip()) {
            ...
            if (charSequenceCoerceToText != null) {
                c42802.setText(charSequenceCoerceToText);
                c42802.setSelection(0, c42802.getText().length());
            }
        }
        runnable2.run();
        ...
        r2.setPositiveButton(LocaleController.getString(C2888R.string.f1606OK), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.EditTextCaption$$ExternalSyntheticLambda2
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
                this.f$0.lambda$makeSelectedUrl$4(selectionStart, selectionEnd, c42802, alertDialog, i);
            }
        });
        r2.setNegativeButton(LocaleController.getString(C2888R.string.Cancel), null);
        if (this.adaptiveCreateLinkDialog) {
            ...
            this.creationLinkDialog.setOnShowListener(new DialogInterface.OnShowListener() { // from class: org.telegram.ui.Components.EditTextCaption$$ExternalSyntheticLambda4
                ...
                public final void onShow(DialogInterface dialogInterface) {
                    EditTextCaption.$r8$lambda$BDEyp03_BHErR3sGWzR_AKrcIkc(c42802, dialogInterface);
                }
            });
            ...
            r2.show().setOnShowListener(new DialogInterface.OnShowListener() { // from class: org.telegram.ui.Components.EditTextCaption$$ExternalSyntheticLambda5
                @Override // android.content.DialogInterface.OnShowListener
                public final void onShow(DialogInterface dialogInterface) {
                    EditTextCaption.$r8$lambda$mnIHNYAxl78VPgpL2mJASkqy918(c42802, dialogInterface);
                }
            });
        }
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) c42802.getLayoutParams();
        if (marginLayoutParams != null) {
            ...
            marginLayoutParams.height = AndroidUtilities.m1124dp(36.0f);
            c42802.setLayoutParams(marginLayoutParams);
        }
        c42802.setSelection(0, c42802.getText().length());
    }
    ...
    /* JADX INFO: loaded from: classes7.dex */
    class C42802 extends EditTextBoldCursor {
        C42802(Context context) {
            super(context);
        }
    ...
    /* JADX INFO: loaded from: classes7.dex */
    class C42813 implements TextWatcher {
        final /* synthetic */ Runnable val$checkPaste;
    ...
    public static /* synthetic */ void $r8$lambda$BDEyp03_BHErR3sGWzR_AKrcIkc(EditTextBoldCursor editTextBoldCursor, DialogInterface dialogInterface) {
        editTextBoldCursor.requestFocus();
        AndroidUtilities.showKeyboard(editTextBoldCursor);
    }

    public static /* synthetic */ void $r8$lambda$mnIHNYAxl78VPgpL2mJASkqy918(EditTextBoldCursor editTextBoldCursor, DialogInterface dialogInterface) {
        editTextBoldCursor.requestFocus();
        AndroidUtilities.showKeyboard(editTextBoldCursor);
    }
    ...
    /* JADX INFO: loaded from: classes7.dex */
    class ActionModeCallbackC42824 implements ActionMode.Callback {
        final /* synthetic */ ActionMode.Callback val$callback;

        ActionModeCallbackC42824(ActionMode.Callback callback) {
            callback = callback;
        }
    ...
    private ActionMode.Callback overrideCallback(ActionMode.Callback callback) {
        return new ActionMode.Callback2() { // from class: org.telegram.ui.Components.EditTextCaption.5
            ...
            C42835(ActionMode.Callback callback2, ActionMode.Callback callback3) {
                callback = callback2;
                callback = callback3;
            }
    ...
    /* JADX INFO: loaded from: classes7.dex */
    class C42835 extends ActionMode.Callback2 {
        final /* synthetic */ ActionMode.Callback val$callback;
        final /* synthetic */ ActionMode.Callback val$wrap;
    ...
    public boolean performMenuAction(int i) {
        if (i == C2888R.id.menu_regular) {
            makeSelectedRegular();
            return true;
        }
        if (i == C2888R.id.menu_bold) {
            makeSelectedBold();
            return true;
        }
        if (i == C2888R.id.menu_italic) {
            makeSelectedItalic();
            return true;
        }
        if (i == C2888R.id.menu_bold_italic) {
            makeSelectedBold();
            makeSelectedItalic();
            return true;
        }
        if (i == C2888R.id.menu_mono) {
            makeSelectedMono();
            return true;
        }
        if (i == C2888R.id.menu_link) {
            makeSelectedUrl();
            return true;
        }
        if (i == C2888R.id.menu_strike) {
            makeSelectedStrike();
            return true;
        }
        if (i == C2888R.id.menu_underline) {
            makeSelectedUnderline();
            return true;
        }
        if (i == C2888R.id.menu_spoiler) {
            makeSelectedSpoiler();
            return true;
        }
        if (i == C2888R.id.menu_quote) {
            makeSelectedQuote();
            return true;
        }
        if (i != C2888R.id.menu_date) {
            return false;
        }
        makeSelectedDate();
        return true;
    ...
    protected void onMeasure(int i, int i2) {
        ...
        try {
            ...
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m1124dp(51.0f));
            FileLog.m1136e(e);
        }
        ...
        if (this.captionLayout == null || (charSequence = this.lastLayoutText) == null || !TextUtils.equals(charSequence, this.caption) || this.lastLayoutWidth != measuredWidth) {
            ...
            try {
                ...
                this.yOffset = ((getMeasuredHeight() - this.captionLayout.getLineBottom(0)) / 2) + AndroidUtilities.m1124dp(0.5f);
            } catch (Exception e2) {
                FileLog.m1136e(e2);
            }
        }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (hasSelection()) {
            accessibilityNodeInfoCompatWrap.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C2888R.id.menu_spoiler, LocaleController.getString(C2888R.string.Spoiler)));
            accessibilityNodeInfoCompatWrap.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C2888R.id.menu_bold, LocaleController.getString(C2888R.string.Bold)));
            accessibilityNodeInfoCompatWrap.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C2888R.id.menu_italic, LocaleController.getString(C2888R.string.Italic)));
            accessibilityNodeInfoCompatWrap.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C2888R.id.menu_bold_italic, LocaleController.getString(C2888R.string.BoldItalic)));
            accessibilityNodeInfoCompatWrap.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C2888R.id.menu_mono, LocaleController.getString(C2888R.string.Mono)));
            accessibilityNodeInfoCompatWrap.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C2888R.id.menu_strike, LocaleController.getString(C2888R.string.Strike)));
            accessibilityNodeInfoCompatWrap.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C2888R.id.menu_underline, LocaleController.getString(C2888R.string.Underline)));
            accessibilityNodeInfoCompatWrap.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C2888R.id.menu_link, LocaleController.getString(C2888R.string.CreateLink)));
            accessibilityNodeInfoCompatWrap.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C2888R.id.menu_regular, LocaleController.getString(C2888R.string.Regular)));
            accessibilityNodeInfoCompatWrap.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(C2888R.id.menu_date, LocaleController.getString(C2888R.string.FormattedDate)));
        }
    }
    ...
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        ...
        return new InputConnectionWrapper(InputConnectionCompat.createWrapper(inputConnectionOnCreateInputConnection, editorInfo, new InputConnectionCompat.OnCommitContentListener() { // from class: org.telegram.ui.Components.EditTextCaption$$ExternalSyntheticLambda6
            ...
            public final boolean onCommitContent(InputContentInfoCompat inputContentInfoCompat, int i, Bundle bundle) {
                return this.f$0.lambda$onCreateInputConnection$8(inputContentInfoCompat, i, bundle);
            }
        }), true) { // from class: org.telegram.ui.Components.EditTextCaption.6
            C42846(InputConnection inputConnection, boolean z) {
    ...
    public /* synthetic */ boolean lambda$onCreateInputConnection$8(InputContentInfoCompat inputContentInfoCompat, int i, Bundle bundle) {
    ...
    /* JADX INFO: loaded from: classes7.dex */
    class C42846 extends InputConnectionWrapper {
        C42846(InputConnection inputConnection, boolean z) {
            super(inputConnection, z);
        }
