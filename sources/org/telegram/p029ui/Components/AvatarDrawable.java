...
public class AvatarDrawable extends Drawable {
    ...
    public AvatarDrawable(Theme.ResourcesProvider resourcesProvider) {
        ...
        this.namePaint.setTextSize(AndroidUtilities.m1124dp(18.0f));
    }
    ...
    public AvatarDrawable(TLRPC.User user, boolean z) {
        ...
        this.isProfile = z;
        if (user != null) {
            setInfo(user.f1825id, user.first_name, user.last_name, null);
    ...
    public static String colorName(int i) {
        return LocaleController.getString(new int[]{C2888R.string.ColorRed, C2888R.string.ColorOrange, C2888R.string.ColorViolet, C2888R.string.ColorGreen, C2888R.string.ColorCyan, C2888R.string.ColorBlue, C2888R.string.ColorPink}[i % 7]);
    }
    ...
    public void setInfo(int i, TLRPC.User user) {
        if (user != null) {
            setInfo(user.f1825id, user.first_name, user.last_name, null, user.color != null ? Integer.valueOf(UserObject.getColorId(user)) : null, UserObject.getPeerColorForAvatar(i, user));
            this.drawDeleted = UserObject.isDeleted(user);
        }
    }
    ...
    public void setInfo(int i, TLRPC.Chat chat) {
        if (chat != null) {
            setInfo(chat.f1660id, chat.title, null, null, chat.color != null ? Integer.valueOf(ChatObject.getColorId(chat)) : null, ChatObject.getPeerColorForAvatar(i, chat));
        }
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (i3 == 2) {
            ...
            } else if (intrinsicWidth3 > iWidth - AndroidUtilities.m1124dp(6.0f) || intrinsicHeight3 > iWidth - AndroidUtilities.m1124dp(6.0f)) {
                float fM1124dp = iWidth / AndroidUtilities.m1124dp(50.0f);
                intrinsicWidth3 = (int) (intrinsicWidth3 * fM1124dp);
                intrinsicHeight3 = (int) (intrinsicHeight3 * fM1124dp);
            }
            ...
            if (this.invalidateTextLayout) {
                ...
                if (this.stringBuilder.length() > 0) {
                    ...
                    if (staticLayout == null || !TextUtils.equals(charSequenceReplaceEmoji, staticLayout.getText())) {
                        try {
                            StaticLayout staticLayout2 = new StaticLayout(charSequenceReplaceEmoji, this.namePaint, AndroidUtilities.m1124dp(100.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            ...
            if (this.textLayout != null) {
                float f7 = iWidth;
                float fM1124dp2 = f7 / AndroidUtilities.m1124dp(50.0f);
                float f8 = f7 / 2.0f;
                canvas.scale(fM1124dp2, fM1124dp2, f8, f8);
