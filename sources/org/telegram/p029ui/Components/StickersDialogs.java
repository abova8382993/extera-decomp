...
public abstract class StickersDialogs {
    ...
    public static /* synthetic */ void m12718$r8$lambda$_hnR8VeKoqzA2OPCRcOT4Rt9Us() {
    }
    ...
    public static void showNameEditorDialog(TLRPC.StickerSet stickerSet, Theme.ResourcesProvider resourcesProvider, final Context context, final Utilities.Callback2 callback2) {
        ...
        builder.setTitle(LocaleController.getString(z ? C2888R.string.EditStickerPack : C2888R.string.NewStickerPack));
        builder.setMessage(LocaleController.getString(C2888R.string.StickersChooseNameForStickerPack));
        FrameLayout frameLayout = new FrameLayout(context);
        frameLayout.setPadding(AndroidUtilities.m1124dp(24.0f), 0, AndroidUtilities.m1124dp(20.0f), 0);
        ...
        editTextBoldCursor.setPadding(AndroidUtilities.m1124dp(LocaleController.isRTL ? 28.0f : 0.0f), 0, AndroidUtilities.m1124dp(LocaleController.isRTL ? 0.0f : 28.0f), 0);
        ...
        builder.setPositiveButton(LocaleController.getString(z ? C2888R.string.Done : C2888R.string.Create), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.StickersDialogs$$ExternalSyntheticLambda1
        ...
        builder.setNegativeButton(LocaleController.getString(C2888R.string.Cancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.StickersDialogs$$ExternalSyntheticLambda2
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i2) {
    ...
    public static void showDeleteForEveryOneDialog(final TLRPC.StickerSet stickerSet, Theme.ResourcesProvider resourcesProvider, Context context, final Runnable runnable) {
        ...
        AlertDialog alertDialogCreate = new AlertDialog.Builder(context, resourcesProvider).setTitle(LocaleController.getString(C2888R.string.StickersDeleteStickerSetTitle)).setMessage(LocaleController.getString(C2888R.string.StickersDeleteStickerSetDescription)).setPositiveButton(LocaleController.getString(C2888R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.StickersDialogs$$ExternalSyntheticLambda6
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
                StickersDialogs.m12717$r8$lambda$YO0w2MC46Ze4CtRzzGkru9YLik(runnable, stickerSet, alertDialog, i);
            }
    ...
    public static /* synthetic */ void m12717$r8$lambda$YO0w2MC46Ze4CtRzzGkru9YLik(Runnable runnable, TLRPC.StickerSet stickerSet, AlertDialog alertDialog, int i) {
        runnable.run();
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.StickersDialogs$$ExternalSyntheticLambda10
                    ...
                    public final void run() {
                        StickersDialogs.m12718$r8$lambda$_hnR8VeKoqzA2OPCRcOT4Rt9Us();
                    }
                });
            }
        });
    ...
    private static void openStickerPickerDialog(final TLRPC.TL_messages_stickerSet tL_messages_stickerSet, BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider) {
        ...
        emojiBottomSheet.whenDocumentSelected(new Utilities.Callback3Return() { // from class: org.telegram.ui.Components.StickersDialogs$$ExternalSyntheticLambda8
            ...
            public final Object run(Object obj, Object obj2, Object obj3) {
                return StickersDialogs.m12720$r8$lambda$o7KvI6jticMZZAlTouYSxsHIg(i, context, tL_messages_stickerSet, obj, (TLRPC.Document) obj2, (Boolean) obj3);
            }
        });
    ...
    public static /* synthetic */ Boolean m12720$r8$lambda$o7KvI6jticMZZAlTouYSxsHIg(final int i, Context context, TLRPC.TL_messages_stickerSet tL_messages_stickerSet, final Object obj, final TLRPC.Document document, Boolean bool) {
    ...
    public static /* synthetic */ void $r8$lambda$PWfBenhYVsMMCsELCmX85DIeeW0(AlertDialog alertDialog, TLObject tLObject, int i, final TLRPC.Document document, TLRPC.TL_error tL_error, Object obj, TLRPC.TL_stickers_addStickerToSet tL_stickers_addStickerToSet) {
        ...
        if (MediaDataController.getInstance(i).isStickerPackInstalled(tL_messages_stickerSet.set.f1696id)) {
            tLObject2 = tLObject;
        } else {
            tLObject2 = tLObject;
    ...
    public static void showAddStickerDialog(final TLRPC.TL_messages_stickerSet tL_messages_stickerSet, View view, final BaseFragment baseFragment, final Theme.ResourcesProvider resourcesProvider) {
        ...
        ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout = new ActionBarPopupWindow.ActionBarPopupWindowLayout(context, C2888R.drawable.popup_fixed_alert3, resourcesProvider, 0);
        ArrayList arrayList = new ArrayList();
        final ArrayList arrayList2 = new ArrayList();
        ArrayList arrayList3 = new ArrayList();
        arrayList.add(LocaleController.getString(C2888R.string.StickersCreateNewSticker));
        arrayList3.add(Integer.valueOf(C2888R.drawable.menu_sticker_add));
        arrayList2.add(0);
        arrayList.add(LocaleController.getString(C2888R.string.StickersAddAnExistingSticker));
        arrayList3.add(Integer.valueOf(C2888R.drawable.menu_sticker_select));
        arrayList2.add(1);
        ...
        View.OnClickListener onClickListener = new View.OnClickListener() { // from class: org.telegram.ui.Components.StickersDialogs$$ExternalSyntheticLambda5
            ...
            public final void onClick(View view2) {
                StickersDialogs.m12716$r8$lambda$KwNe0gshzMmIwENIJT3PkIZ_Wc(actionBarPopupWindow, arrayList2, tL_messages_stickerSet, baseFragment, resourcesProvider, view2);
            }
        };
        ...
        actionBarPopupWindowLayout.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(1000.0f), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(1000.0f), Integer.MIN_VALUE));
    ...
    public static /* synthetic */ void m12716$r8$lambda$KwNe0gshzMmIwENIJT3PkIZ_Wc(ActionBarPopupWindow actionBarPopupWindow, ArrayList arrayList, TLRPC.TL_messages_stickerSet tL_messages_stickerSet, BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider, View view) {
