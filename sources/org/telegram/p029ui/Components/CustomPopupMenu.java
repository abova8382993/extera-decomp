...
public abstract class CustomPopupMenu {
    ...
    public CustomPopupMenu(Context context, Theme.ResourcesProvider resourcesProvider, boolean z) {
        ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout = new ActionBarPopupWindow.ActionBarPopupWindowLayout(context, C2888R.drawable.popup_fixed_alert2, resourcesProvider, z ? 1 : 0);
        ...
        this.popupWindow.setAnimationStyle(C2888R.style.PopupContextAnimation2);
