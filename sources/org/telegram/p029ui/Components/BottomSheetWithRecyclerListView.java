...
public abstract class BottomSheetWithRecyclerListView extends BottomSheet {
    ...
    public BottomSheetWithRecyclerListView(Context context, BaseFragment baseFragment, boolean z, final boolean z2, boolean z3, final boolean z4, ActionBarType actionBarType, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.headerShadowDrawable = ContextCompat.getDrawable(context, C2888R.drawable.header_shadow).mutate();
        if (z3) {
            ...
            sizeNotifierFrameLayout = new SizeNotifierFrameLayout(context) { // from class: org.telegram.ui.Components.BottomSheetWithRecyclerListView.2
                ...
                private void onMeasureInternal(int i, int i2) {
                    ...
                    int i4 = 0;
                    if (editTextEmoji2 != null && !editTextEmoji2.isWaitingForKeyboardOpen() && AndroidUtilities.m1124dp(20.0f) >= 0 && !BottomSheetWithRecyclerListView.this.editTextEmoji.isPopupShowing() && !BottomSheetWithRecyclerListView.this.editTextEmoji.isAnimatePopupClosing()) {
                ...
                */
                protected void onLayout(boolean r11, int r12, int r13, int r14, int r15) {
                    ...
                    */
                    throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.BottomSheetWithRecyclerListView.C39232.onLayout(boolean, int, int, int, int):void");
                }
            };
        }
    ...
    public void setSlidingActionBar() {
        ...
        this.headerPaddingTop = AndroidUtilities.m1124dp(16.0f);
        this.headerPaddingBottom = AndroidUtilities.m1124dp(-20.0f);
    ...
    private class PaddingView extends View {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (i3 == 0) {
                iM1124dp = AndroidUtilities.m1124dp(300.0f);
            } else {
                iM1124dp = (int) (i3 * bottomSheetWithRecyclerListView.topPadding);
            }
            BottomSheetWithRecyclerListView bottomSheetWithRecyclerListView2 = BottomSheetWithRecyclerListView.this;
            int i4 = iM1124dp - (((bottomSheetWithRecyclerListView2.headerTotalHeight - bottomSheetWithRecyclerListView2.headerHeight) - bottomSheetWithRecyclerListView2.headerPaddingTop) - bottomSheetWithRecyclerListView2.headerPaddingBottom);
            if (i4 < 1) {
                i4 = 1;
            }
    ...
    */
    public void postDrawInternal(android.graphics.Canvas r8, android.view.View r9) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.BottomSheetWithRecyclerListView.postDrawInternal(android.graphics.Canvas, android.view.View):void");
    }
    ...
    */
    public void preDrawInternal(android.graphics.Canvas r13, android.view.View r14) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.BottomSheetWithRecyclerListView.preDrawInternal(android.graphics.Canvas, android.view.View):void");
    }
