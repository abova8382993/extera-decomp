...
public class BatteryDrawable extends Drawable {
    ...
    public void setFillValue(float f, boolean z) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.BatteryDrawable$$ExternalSyntheticLambda0
    ...
    public int getIntrinsicWidth() {
        return AndroidUtilities.m1124dp(this.scale * 24.0f);
    }
