...
public abstract class DrawingInBackgroundThreadDrawable implements NotificationCenter.NotificationCenterDelegate {
    ...
    private final Runnable bitmapCreateTask = new Runnable() { // from class: org.telegram.ui.Components.DrawingInBackgroundThreadDrawable.1
        ...
        /* JADX WARN: Removed duplicated region for block: B:33:0x0020 A[Catch: Exception -> 0x001e, TryCatch #0 {Exception -> 0x001e, blocks: (B:24:0x0000, B:26:0x000b, B:28:0x0015, B:37:0x0042, B:33:0x0020, B:35:0x0026, B:36:0x0029), top: B:42:0x0000 }] */
        ...
        */
        public void run() {
            /*
                r4 = this;
                org.telegram.ui.Components.DrawingInBackgroundThreadDrawable r0 = org.telegram.p029ui.Components.DrawingInBackgroundThreadDrawable.this     // Catch: java.lang.Exception -> L1e
                ...
                org.telegram.ui.Components.DrawingInBackgroundThreadDrawable r2 = org.telegram.p029ui.Components.DrawingInBackgroundThreadDrawable.this     // Catch: java.lang.Exception -> L1e
            ...
            L72:
                ...
                org.telegram.ui.Components.DrawingInBackgroundThreadDrawable r0 = org.telegram.p029ui.Components.DrawingInBackgroundThreadDrawable.this
                r1 = 1
                r0.error = r1
            L7a:
                org.telegram.ui.Components.DrawingInBackgroundThreadDrawable r0 = org.telegram.p029ui.Components.DrawingInBackgroundThreadDrawable.this
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.DrawingInBackgroundThreadDrawable.RunnableC42711.run():void");
        }
    };
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.DrawingInBackgroundThreadDrawable$1 */
    class RunnableC42711 implements Runnable {
        RunnableC42711() {
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.DrawingInBackgroundThreadDrawable$2 */
    class RunnableC42722 implements Runnable {
        RunnableC42722() {
        }
    ...
    public static class DispatchQueuePool {
        ...
        /* synthetic */ DispatchQueuePool(int i, DrawingInBackgroundThreadDrawableIA drawingInBackgroundThreadDrawableIA) {
            this(i);
        }
