...
public abstract class PullForegroundDrawable {
    ...
    public PullForegroundDrawable(CharSequence charSequence, CharSequence charSequence2) {
        ...
        try {
            this.generalTopicDrawable = ApplicationLoader.applicationContext.getResources().getDrawable(C2888R.drawable.msg_filled_general).mutate();
    ...
    public static int getMaxOverscroll() {
        return AndroidUtilities.m1124dp(72.0f);
    }
    ...
    */
    public void draw(android.graphics.Canvas r35, boolean r36) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.PullForegroundDrawable.draw(android.graphics.Canvas, boolean):void");
    }
    ...
    public void startOutAnimation() {
        ...
        this.outOverScroll = this.listView.getTranslationY() / AndroidUtilities.m1124dp(100.0f);
        ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
    ...
    private class ArrowDrawable extends Drawable {
        ...
        private void updatePath() {
            ...
            this.path.lineTo(iM1124dp - AndroidUtilities.dpf2(4.95f), AndroidUtilities.dpf2(9.0f));
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.drawRect(AndroidUtilities.dpf2(7.56f), AndroidUtilities.dpf2(8.0f), AndroidUtilities.m1124dp(18.0f) - AndroidUtilities.dpf2(7.56f), AndroidUtilities.dpf2(11.1f), this.paint);
            canvas.restore();
        }
    }
}
