...
public abstract class GroupCallRenderersContainer extends FrameLayout {
    ...
    public GroupCallRenderersContainer(Context context, RecyclerView recyclerView, RecyclerView recyclerView2, ArrayList arrayList, ChatObject.Call call, final GroupCallActivity groupCallActivity) {
        ...
        imageView.setPadding(AndroidUtilities.m1124dp(16.0f), 0, AndroidUtilities.m1124dp(16.0f), 0);
        ...
        final Drawable drawableCreateSimpleSelectorRoundRectDrawable = Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1124dp(20.0f), 0, ColorUtils.setAlphaComponent(-1, 100));
        View view3 = new View(context) { // from class: org.telegram.ui.Components.voip.GroupCallRenderersContainer.4
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                canvas.save();
                drawableCreateSimpleSelectorRoundRectDrawable.setBounds(0, 0, AndroidUtilities.m1124dp(50.0f) + ((int) measuredWidth), getMeasuredHeight());
        ...
        CrossOutDrawable crossOutDrawable = new CrossOutDrawable(context, C2888R.drawable.msg_pin_filled, -1);
        this.pinDrawable = crossOutDrawable;
        crossOutDrawable.setOffsets(-AndroidUtilities.m1124dp(1.0f), AndroidUtilities.m1124dp(2.0f), AndroidUtilities.m1124dp(1.0f));
        imageView2.setImageDrawable(this.pinDrawable);
        imageView2.setPadding(AndroidUtilities.m1124dp(16.0f), 0, AndroidUtilities.m1124dp(16.0f), 0);
        ...
        this.pinTextView.setText(LocaleController.getString(C2888R.string.CallVideoPin));
        ...
        this.unpinTextView.setText(LocaleController.getString(C2888R.string.CallVideoUnpin));
        ...
        this.pipView.setImageResource(C2888R.drawable.ic_goinline);
        this.pipView.setContentDescription(LocaleController.getString(C2888R.string.AccDescrPipMode));
        int iM1124dp = AndroidUtilities.m1124dp(4.0f);
        this.pipView.setPadding(iM1124dp, iM1124dp, iM1124dp, iM1124dp);
        ...
        final ShapeDrawable shapeDrawableCreateRoundRectDrawable = Theme.createRoundRectDrawable(AndroidUtilities.m1124dp(18.0f), ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_voipgroup_listViewBackground), Opcodes.SUB_DOUBLE_2ADDR));
        ...
        for (int i = 0; i < 2; i++) {
            this.undoView[i] = new UndoView(context) { // from class: org.telegram.ui.Components.voip.GroupCallRenderersContainer.6
                @Override // org.telegram.p029ui.Components.UndoView, android.view.View
                public void invalidate() {
                    super.invalidate();
                    GroupCallRenderersContainer.this.invalidate();
                }
            ...
            this.undoView[i].setAdditionalTranslationY(AndroidUtilities.m1124dp(10.0f));
    ...
    public void setIsTablet(boolean z) {
        if (this.isTablet != z) {
            ...
            layoutParams.rightMargin = z ? AndroidUtilities.m1124dp(328.0f) : 0;
            layoutParams.bottomMargin = z ? -AndroidUtilities.m1124dp(8.0f) : 0;
            if (this.isTablet) {
                this.backButton.setImageDrawable(ContextCompat.getDrawable(getContext(), C2888R.drawable.msg_calls_minimize));
                return;
            }
            BackDrawable backDrawable = new BackDrawable(false);
            backDrawable.setColor(-1);
    ...
    */
    protected void dispatchDraw(android.graphics.Canvas r22) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.voip.GroupCallRenderersContainer.dispatchDraw(android.graphics.Canvas):void");
    }
    ...
    */
    public void requestFullscreen(org.telegram.messenger.ChatObject.VideoParticipant r17) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.voip.GroupCallRenderersContainer.requestFullscreen(org.telegram.messenger.ChatObject$VideoParticipant):void");
    }
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r14) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.voip.GroupCallRenderersContainer.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    protected void onMeasure(int i, int i2) {
        if (GroupCallActivity.isTabletMode) {
            ((ViewGroup.MarginLayoutParams) this.topShadowView.getLayoutParams()).rightMargin = AndroidUtilities.m1124dp(328.0f);
        } else if (GroupCallActivity.isLandscapeMode) {
            ((ViewGroup.MarginLayoutParams) this.topShadowView.getLayoutParams()).rightMargin = isRtmpStream() ? 0 : AndroidUtilities.m1124dp(90.0f);
        } else {
        ...
        this.pinContainer.getLayoutParams().height = AndroidUtilities.m1124dp(40.0f);
        ...
        this.pinContainer.getLayoutParams().width = AndroidUtilities.m1124dp(46.0f) + (!this.hasPinnedVideo ? this.pinTextView : this.unpinTextView).getMeasuredWidth();
        ((ViewGroup.MarginLayoutParams) this.speakingMembersToast.getLayoutParams()).rightMargin = GroupCallActivity.isLandscapeMode ? AndroidUtilities.m1124dp(45.0f) : 0;
        for (int i3 = 0; i3 < 2; i3++) {
            ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) this.undoView[i3].getLayoutParams();
            if (this.isTablet) {
                marginLayoutParams.rightMargin = AndroidUtilities.m1124dp(344.0f);
            } else {
                marginLayoutParams.rightMargin = GroupCallActivity.isLandscapeMode ? AndroidUtilities.m1124dp(180.0f) : 0;
            }
        }
    ...
    public void setVisibleParticipant(boolean z) {
        ...
        if (i2 != 0) {
            if (i2 == 1) {
                ...
                iM1124dp = AndroidUtilities.m1124dp(88.0f);
            }
        }
        ((FrameLayout.LayoutParams) this.speakingMembersText.getLayoutParams()).leftMargin = iM1124dp;
        ((FrameLayout.LayoutParams) this.speakingMembersText.getLayoutParams()).rightMargin = AndroidUtilities.m1124dp(16.0f);
        this.showSpeakingMembersToast = z3;
        invalidate();
        while (i2 < 3) {
