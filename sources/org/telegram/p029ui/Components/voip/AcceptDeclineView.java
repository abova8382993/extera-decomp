...
public class AcceptDeclineView extends View {
    ...
    public AcceptDeclineView(Context context) {
        ...
        ImageWithWavesView.AvatarWavesDrawable avatarWavesDrawable = new ImageWithWavesView.AvatarWavesDrawable(AndroidUtilities.m1124dp(45.0f), AndroidUtilities.m1124dp(50.0f), AndroidUtilities.m1124dp(8.0f), 4);
        ...
        this.buttonWidth = AndroidUtilities.m1124dp(60.0f);
        ...
        String string = LocaleController.getString(C2888R.string.AcceptCall);
        String string2 = LocaleController.getString(C2888R.string.DeclineCall);
        String string3 = LocaleController.getString(C2888R.string.RetryCall);
        ...
        this.callDrawable = ContextCompat.getDrawable(context, C2888R.drawable.calls_decline).mutate();
        Drawable drawableMutate = ContextCompat.getDrawable(context, C2888R.drawable.ic_close_white).mutate();
        ...
        RLottieDrawable rLottieDrawable = new RLottieDrawable(C2888R.raw.call_accept, _UrlKt.FRAGMENT_ENCODE_SET + C2888R.raw.call_accept, AndroidUtilities.m1124dp(48.0f), AndroidUtilities.m1124dp(48.0f), true, null);
        ...
        this.acceptVideoDrawable = ContextCompat.getDrawable(context, C2888R.drawable.calls_video).mutate();
        paint.setColor(-1);
        paint.setAlpha(20);
        Drawable drawableCreateSimpleSelectorCircleDrawable = Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m1124dp(52.0f), 0, ColorUtils.setAlphaComponent(-1, 76));
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.maxOffset = (getMeasuredWidth() / 2.0f) - ((this.buttonWidth / 2.0f) + AndroidUtilities.m1124dp(46.0f));
        int iM1124dp = (this.buttonWidth - AndroidUtilities.m1124dp(28.0f)) / 2;
        this.callDrawable.setBounds(iM1124dp, iM1124dp, AndroidUtilities.m1124dp(28.0f) + iM1124dp, AndroidUtilities.m1124dp(28.0f) + iM1124dp);
        this.cancelDrawable.setBounds(iM1124dp, iM1124dp, AndroidUtilities.m1124dp(28.0f) + iM1124dp, AndroidUtilities.m1124dp(28.0f) + iM1124dp);
        this.linePaint.setStrokeWidth(AndroidUtilities.m1124dp(3.0f));
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r7) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.voip.AcceptDeclineView.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    protected void onDraw(Canvas canvas) {
        if (!this.retryMod) {
            if (this.expandSmallRadius) {
                float fM1124dp = this.smallRadius + (AndroidUtilities.m1124dp(2.0f) * 0.04f);
                this.smallRadius = fM1124dp;
                if (fM1124dp > AndroidUtilities.m1124dp(4.0f)) {
                    this.smallRadius = AndroidUtilities.m1124dp(4.0f);
                    this.expandSmallRadius = false;
                }
            } else {
                float fM1124dp2 = this.smallRadius - (AndroidUtilities.m1124dp(2.0f) * 0.04f);
                this.smallRadius = fM1124dp2;
                if (fM1124dp2 < 0.0f) {
            ...
            if (this.expandBigRadius) {
                float fM1124dp3 = this.bigRadius + (AndroidUtilities.m1124dp(4.0f) * 0.03f);
                this.bigRadius = fM1124dp3;
                if (fM1124dp3 > AndroidUtilities.m1124dp(10.0f)) {
                    this.bigRadius = AndroidUtilities.m1124dp(10.0f);
                    this.expandBigRadius = false;
                }
            } else {
                float fM1124dp4 = this.bigRadius - (AndroidUtilities.m1124dp(5.0f) * 0.03f);
                this.bigRadius = fM1124dp4;
                if (fM1124dp4 < AndroidUtilities.m1124dp(5.0f)) {
                    this.bigRadius = AndroidUtilities.m1124dp(5.0f);
                    this.expandBigRadius = true;
                }
            }
            invalidate();
        }
        this.bigRadius += AndroidUtilities.m1124dp(8.0f) * 0.005f;
        this.declineRect.set((getMeasuredWidth() - AndroidUtilities.m1124dp(46.0f)) - this.buttonWidth, AndroidUtilities.m1124dp(40.0f), getMeasuredWidth() - AndroidUtilities.m1124dp(46.0f), AndroidUtilities.m1124dp(40.0f) + this.buttonWidth);
        canvas.save();
        canvas.translate(0.0f, AndroidUtilities.m1124dp(40.0f));
        canvas.save();
        ...
        canvas.translate(((this.rigthOffsetX + getMeasuredWidth()) - AndroidUtilities.m1124dp(46.0f)) - this.buttonWidth, 0.0f);
        if (this.retryMod) {
        ...
        canvas.save();
        canvas.translate((this.buttonWidth / 2.0f) - (this.declineLayout.getWidth() / 2.0f), this.buttonWidth + AndroidUtilities.m1124dp(4.0f));
        this.declineLayout.draw(canvas);
        canvas.restore();
        if (this.leftDrag) {
            this.rippleDrawable.setBounds(AndroidUtilities.m1124dp(4.0f), AndroidUtilities.m1124dp(4.0f), this.buttonWidth - AndroidUtilities.m1124dp(4.0f), this.buttonWidth - AndroidUtilities.m1124dp(4.0f));
            this.rippleDrawable.draw(canvas);
        }
        canvas.restore();
        this.acceptRect.set(AndroidUtilities.m1124dp(46.0f), AndroidUtilities.m1124dp(40.0f), AndroidUtilities.m1124dp(46.0f) + this.buttonWidth, AndroidUtilities.m1124dp(40.0f) + this.buttonWidth);
        canvas.save();
        ...
        canvas.translate(this.leftOffsetX + AndroidUtilities.m1124dp(46.0f), 0.0f);
        if (!this.retryMod) {
        ...
        if (this.retryMod) {
            canvas.save();
            canvas.translate((this.buttonWidth / 2.0f) - (this.retryLayout.getWidth() / 2.0f), this.buttonWidth + AndroidUtilities.m1124dp(4.0f));
            this.retryLayout.draw(canvas);
            canvas.restore();
        } else {
            canvas.save();
            canvas.translate((this.buttonWidth / 2.0f) - (this.acceptLayout.getWidth() / 2.0f), this.buttonWidth + AndroidUtilities.m1124dp(4.0f));
        ...
        if (this.isVideo) {
            ...
            canvas.translate((AndroidUtilities.m1124dp(48.0f) - iM1124dp) / 2.0f, (AndroidUtilities.m1124dp(48.0f) - iM1124dp) / 2.0f);
            this.acceptVideoDrawable.setBounds(0, 0, iM1124dp, iM1124dp);
