...
public class CellFlickerDrawable {
    ...
    public CellFlickerDrawable() {
        this(64, Opcodes.SUB_DOUBLE_2ADDR, 160);
    }
    ...
    public CellFlickerDrawable(int i, int i2, int i3) {
        ...
        this.size = AndroidUtilities.m1124dp(i3);
        float f = this.size;
        ...
        this.paintOutline.setStrokeWidth(AndroidUtilities.m1124dp(2.0f));
    }
    ...
    public void setColors(int i) {
        setColors(i, 64, Opcodes.SUB_DOUBLE_2ADDR);
    }
