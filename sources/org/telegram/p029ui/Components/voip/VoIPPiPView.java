...
public class VoIPPiPView implements VoIPService.StateListener, IPipSourceDelegate, NotificationCenter.NotificationCenterDelegate {
    ...
    private void setRelativePosition(float f, float f2) {
        ...
        float fM1124dp3 = AndroidUtilities.m1124dp(60.0f);
        float fM1124dp4 = AndroidUtilities.m1124dp(16.0f);
        ...
        layoutParams.x = (int) ((f * (((f3 - fM1124dp) - fM1124dp2) - measuredWidth)) - (this.xOffset - fM1124dp));
        layoutParams.y = (int) ((f2 * (((f4 - fM1124dp3) - fM1124dp4) - measuredHeight)) - (this.yOffset - fM1124dp3));
    ...
    public VoIPPiPView(final Context context, int i, int i2, boolean z) {
        ...
        final Drawable drawable = ContextCompat.getDrawable(context, C2888R.drawable.calls_pip_outershadow);
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.Components.voip.VoIPPiPView.4
            ...
            protected void onDraw(Canvas canvas) {
                ...
                drawable.setBounds(VoIPPiPView.this.floatingView.getLeft() - AndroidUtilities.m1124dp(2.0f), VoIPPiPView.this.floatingView.getTop() - AndroidUtilities.m1124dp(2.0f), VoIPPiPView.this.floatingView.getRight() + AndroidUtilities.m1124dp(2.0f), VoIPPiPView.this.floatingView.getBottom() + AndroidUtilities.m1124dp(2.0f));
        ...
        if (z) {
            ...
            this.floatingView.addView(this.topShadow, -1, AndroidUtilities.m1124dp(60.0f));
            ImageView imageView = new ImageView(context);
            this.closeIcon = imageView;
            imageView.setImageResource(C2888R.drawable.pip_close);
            this.closeIcon.setPadding(AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(8.0f));
            this.closeIcon.setContentDescription(LocaleController.getString(C2888R.string.Close));
            ...
            imageView2.setImageResource(C2888R.drawable.pip_enlarge);
            this.enlargeIcon.setPadding(AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(8.0f));
            this.enlargeIcon.setContentDescription(LocaleController.getString(C2888R.string.Open));
    ...
    class FloatingView extends FrameLayout {
        ...
        public FloatingView(Context context) {
            ...
            setOutlineProvider(new ViewOutlineProvider() { // from class: org.telegram.ui.Components.voip.VoIPPiPView.FloatingView.1
                ...
                public void getOutline(View view, Outline outline) {
                    outline.setRoundRect(0, 0, view.getMeasuredWidth(), view.getMeasuredHeight(), (1.0f / view.getScaleX()) * AndroidUtilities.m1124dp(4.0f));
                }
            });
        ...
        protected void onMeasure(int i, int i2) {
            ...
            this.topPadding = AndroidUtilities.m1124dp(60.0f);
            this.bottomPadding = AndroidUtilities.m1124dp(16.0f);
        }
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            VoIPPiPView.this.currentUserTextureView.setTranslationX((-AndroidUtilities.m1124dp(4.0f)) * (1.0f / getScaleX()) * VoIPPiPView.this.progressToCameraMini);
            VoIPPiPView.this.currentUserTextureView.setTranslationY((-AndroidUtilities.m1124dp(4.0f)) * (1.0f / getScaleY()) * VoIPPiPView.this.progressToCameraMini);
            VoIPPiPView.this.currentUserTextureView.setRoundCorners(AndroidUtilities.m1124dp(8.0f) * (1.0f / getScaleY()) * VoIPPiPView.this.progressToCameraMini);
            VoIPPiPView voIPPiPView = VoIPPiPView.this;
        ...
        */
        ...
        public void expand(boolean z) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.voip.VoIPPiPView$FloatingView$$ExternalSyntheticLambda1
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    VoIPPiPView.FloatingView.m13460$r8$lambda$IozzDMM2wo9rwKfitkKti6NbPU(scaleX2, valueAnimator);
                }
            });
            valueAnimatorOfFloat.setDuration(300L).setInterpolator(CubicBezierInterpolator.DEFAULT);
            valueAnimatorOfFloat.addListener(new C54413(z));
        ...
        public /* synthetic */ void lambda$expand$1(final float f, final VoIPPiPView voIPPiPView) {
            ...
            valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Components.voip.VoIPPiPView$FloatingView$$ExternalSyntheticLambda2
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    VoIPPiPView.FloatingView.m13461$r8$lambda$nnUQfHzfHnDL_MoShkmrtDfByk(f, f2, voIPPiPView, valueAnimator);
                }
            });
        ...
        public static /* synthetic */ void m13461$r8$lambda$nnUQfHzfHnDL_MoShkmrtDfByk(float f, float f2, VoIPPiPView voIPPiPView, ValueAnimator valueAnimator) {
            float fFloatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        ...
        public static /* synthetic */ void m13460$r8$lambda$IozzDMM2wo9rwKfitkKti6NbPU(float f, ValueAnimator valueAnimator) {
            float fFloatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        ...
        class C54413 extends AnimatorListenerAdapter {
