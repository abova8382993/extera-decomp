...
public class RateCallLayout extends FrameLayout {
    ...
    public /* synthetic */ void lambda$new$3(Context context, float f, float f2, int i) {
        if (i >= 4) {
            ...
            int iM1124dp = AndroidUtilities.m1124dp(133.0f);
            rLottieImageView.setAnimation(C2888R.raw.rate, 133, 133);
            int[] iArr = new int[2];
    ...
    public void show(OnRateSelected onRateSelected) {
        ...
        animatorSet.playTogether(objectAnimatorOfFloat, objectAnimatorOfFloat2, ObjectAnimator.ofFloat(this.rateCallContainer, (Property<RateCallContainer, Float>) property3, 0.7f, 1.0f), ObjectAnimator.ofFloat(this.rateCallContainer, (Property<RateCallContainer, Float>) property4, AndroidUtilities.m1124dp(24.0f), 0.0f));
        ...
        while (i < this.startsViews.length) {
            ...
            animatorArr[c3] = objectAnimatorOfFloat6;
    ...
    public static class StarContainer extends FrameLayout {
        ...
        public StarContainer(Context context) {
            ...
            this.defaultStar.setAnimation(C2888R.raw.star_stroke, 37, 37);
            this.selectedStar.setAnimation(C2888R.raw.star_fill, 37, 37);
            ...
            Drawable drawableCreateSimpleSelectorCircleDrawable = Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m1124dp(37.0f), 0, ColorUtils.setAlphaComponent(-1, 76));
    ...
    public static class RateCallContainer extends FrameLayout {
        ...
        public RateCallContainer(Context context, VoIPBackgroundProvider voIPBackgroundProvider) {
            ...
            textView.setText(LocaleController.getString(C2888R.string.VoipRateCallTitle));
            ...
            textView2.setText(LocaleController.getString(C2888R.string.VoipRateCallDescription));
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            canvas.drawRoundRect(this.bgRect, AndroidUtilities.m1124dp(28.0f), AndroidUtilities.m1124dp(28.0f), this.backgroundProvider.getDarkPaint());
