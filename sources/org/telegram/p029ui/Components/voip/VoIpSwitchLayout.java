...
public class VoIpSwitchLayout extends FrameLayout {
    ...
    private void setText(Type type, boolean z) {
        ...
        if (iOrdinal != 0) {
            if (iOrdinal == 1) {
                string = LocaleController.getString(C2888R.string.VoipFlip);
            } else if (iOrdinal != 2) {
                if (iOrdinal == 3) {
                    string = LocaleController.getString(C2888R.string.VoipAudioRoutingBluetooth);
                } else if (iOrdinal == 4) {
                    string = LocaleController.getString(C2888R.string.VoipSpeaker);
                } else {
                    string = _UrlKt.FRAGMENT_ENCODE_SET;
                }
            } else if (z) {
                string = LocaleController.getString(C2888R.string.VoipStartVideo);
            } else {
                string = LocaleController.getString(C2888R.string.VoipStopVideo);
            }
        } else if (z) {
            string = LocaleController.getString(C2888R.string.VoipUnmute);
        } else {
            string = LocaleController.getString(C2888R.string.VoipMute);
        }
        ...
        if (this.currentTextView.getVisibility() == 8 && this.newTextView.getVisibility() == 8) {
            ...
            this.currentTextView.animate().alpha(0.0f).translationY(-AndroidUtilities.m1124dp(4.0f)).setDuration(140L).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.voip.VoIpSwitchLayout.1
            ...
            this.newTextView.setTranslationY(AndroidUtilities.m1124dp(5.0f));
    ...
    */
    public void setType(org.telegram.ui.Components.voip.VoIpSwitchLayout.Type r13, boolean r14, boolean r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.voip.VoIpSwitchLayout.setType(org.telegram.ui.Components.voip.VoIpSwitchLayout$Type, boolean, boolean):void");
    }
    ...
    public void lambda$setType$0(int i) {
        this.voIpButtonView.unSelectedIcon = new RLottieDrawable(C2888R.raw.speaker_to_bt, _UrlKt.FRAGMENT_ENCODE_SET + C2888R.raw.speaker_to_bt, i, i, true, null);
        this.voIpButtonView.selectedIcon = new RLottieDrawable(C2888R.raw.speaker_to_bt, _UrlKt.FRAGMENT_ENCODE_SET + C2888R.raw.speaker_to_bt, i, i, true, null);
    ...
    public void lambda$setType$2(int i) {
        this.voIpButtonView.unSelectedIcon = new RLottieDrawable(C2888R.raw.bt_to_speaker, _UrlKt.FRAGMENT_ENCODE_SET + C2888R.raw.bt_to_speaker, i, i, true, null);
        this.voIpButtonView.selectedIcon = new RLottieDrawable(C2888R.raw.bt_to_speaker, _UrlKt.FRAGMENT_ENCODE_SET + C2888R.raw.bt_to_speaker, i, i, true, null);
        this.voIpButtonView.selectedIcon.setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.MULTIPLY));
    }
    ...
    public static class VoIpButtonView extends View {
        ...
        public VoIpButtonView(Context context, VoIPBackgroundProvider voIPBackgroundProvider) {
            ...
            this.maxRadius = iM1124dp;
            this.unselectedRadius = iM1124dp;
            this.selectedRadius = 0;
        ...
        private boolean isClick(float f, float f2, float f3, float f4) {
            return Math.abs(f - f2) <= ((float) AndroidUtilities.m1124dp(48.0f)) && Math.abs(f3 - f4) <= ((float) AndroidUtilities.m1124dp(48.0f));
        }
    }
}
