...
public class QuoteHighlight extends Path {
    ...
    private final AnimatedFloat f2052t;
    ...
    public QuoteHighlight(final ChatMessageCell chatMessageCell, int i, int i2) {
        ...
        this.f2052t = new AnimatedFloat(0.0f, new Runnable() { // from class: org.telegram.ui.Components.QuoteHighlight$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                QuoteHighlight.m11852$r8$lambda$4waOk2vMbE18qeSW6UP2HXYHDU(chatMessageCell);
            }
        ...
        this.cornerPathEffectSize = iM1124dp;
        paint.setPathEffect(new CornerPathEffect(iM1124dp));
    }

    /* JADX INFO: renamed from: $r8$lambda$4waOk2vMbE18qeSW6UP2-HXYHDU, reason: not valid java name */
    public static /* synthetic */ void m11852$r8$lambda$4waOk2vMbE18qeSW6UP2HXYHDU(ChatMessageCell chatMessageCell) {
    ...
    public QuoteHighlight(final View view, final ViewParent viewParent, int i, ArrayList arrayList, int i2, int i3, float f) {
        ...
        this.quotesToExpand = new ArrayList();
        this.cell = null;
        this.f2052t = new AnimatedFloat(0.0f, new Runnable() { // from class: org.telegram.ui.Components.QuoteHighlight$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
        ...
        for (int i5 = 0; i5 < arrayList.size(); i5++) {
            ...
            if (textLayoutBlock != null && i2 <= textLayoutBlock.charactersEnd && i3 >= (i4 = textLayoutBlock.charactersOffset)) {
                ...
                if (textLayoutBlock.code && !textLayoutBlock.quote) {
                    this.currentOffsetX = f2 + AndroidUtilities.m1124dp(10.0f);
                }
                this.currentOffsetY = textLayoutBlock.textYOffset(arrayList) + textLayoutBlock.padTop;
                this.minX = textLayoutBlock.quote ? AndroidUtilities.m1124dp(10.0f) : 0.0f;
        ...
        if (this.rectangles.size() > 0) {
            ...
            rect.first = true;
            rect.top -= AndroidUtilities.m1124dp(0.66f);
            rect2.last = true;
            rect2.bottom += AndroidUtilities.m1124dp(0.66f);
        }
    }
    ...
    public float getT() {
        return this.f2052t.set(1.0f);
    }

    public void draw(Canvas canvas, float f, float f2, android.graphics.Rect rect, float f3) {
        float f4 = this.f2052t.set(1.0f);
        canvas.save();
        if (this.todo) {
            int iLerp = AndroidUtilities.lerp(AndroidUtilities.m1124dp(4.0f), 0, f4);
    ...
    public void addRect(float f, float f2, float f3, float f4) {
        ...
        float f9 = fMax2 + f5;
        Rect rect = new Rect();
        rect.left = f6 - AndroidUtilities.m1124dp(3.0f);
        rect.right = f9 + AndroidUtilities.m1124dp(3.0f);
        rect.top = f8;
        rect.bottom = f4 + f7;
