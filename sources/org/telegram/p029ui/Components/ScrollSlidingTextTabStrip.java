...
public class ScrollSlidingTextTabStrip extends HorizontalScrollView implements Theme.Colorable {
    ...
    public interface ScrollSlidingTabStripDelegate {
        ...
        /* JADX INFO: renamed from: org.telegram.ui.Components.ScrollSlidingTextTabStrip$ScrollSlidingTabStripDelegate$-CC, reason: invalid class name */
    ...
    public ScrollSlidingTextTabStrip(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        C49532 c49532 = new C49532(context);
        this.tabsContainer = c49532;
        c49532.setOrientation(0);
        c49532.setPadding(AndroidUtilities.m1124dp(7.0f), 0, AndroidUtilities.m1124dp(7.0f), 0);
        c49532.setLayoutParams(new FrameLayout.LayoutParams(-1, -1));
        addView(c49532);
        updateColors();
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.ScrollSlidingTextTabStrip$2 */
    class C49532 extends LinearLayout {

        /* JADX INFO: renamed from: sx */
        private float f2067sx;

        /* JADX INFO: renamed from: sy */
        private float f2068sy;

        C49532(Context context) {
            super(context);
        }
        ...
        public boolean dispatchTouchEvent(MotionEvent motionEvent) {
            ...
            if (motionEvent.getAction() == 0) {
                ...
                if (ScrollSlidingTextTabStrip.this.dragging != null && getParent() != null) {
                    ...
                    this.f2067sx = motionEvent.getX();
                    this.f2068sy = motionEvent.getY();
                    getParent().requestDisallowInterceptTouchEvent(true);
                }
            } else {
                if (motionEvent.getAction() == 2) {
                    if (ScrollSlidingTextTabStrip.this.dragging != null) {
                        ScrollSlidingTextTabStrip.this.dragging.setTranslationX(motionEvent.getX() - this.f2067sx);
                        ...
                        if (motionEvent.getX() < AndroidUtilities.m1124dp(16.0f)) {
                            ScrollSlidingTextTabStrip.this.scrollBy(-AndroidUtilities.m1124dp(1.0f), 0);
                        } else if (motionEvent.getX() >= getWidth() - AndroidUtilities.m1124dp(16.0f)) {
                            ScrollSlidingTextTabStrip.this.scrollBy(AndroidUtilities.m1124dp(1.0f), 0);
                        }
                        ...
                        if (iFindPosition != iIndexOfChild && ScrollSlidingTextTabStrip.this.delegate.canReorder(ScrollSlidingTextTabStrip.this.positionToId.get(iFindPosition))) {
                            ...
                            if (childAt.getLeft() > ScrollSlidingTextTabStrip.this.dragging.getLeft()) {
                                this.f2067sx += ((childAt.getLeft() + childAt.getWidth()) - ScrollSlidingTextTabStrip.this.dragging.getWidth()) - ScrollSlidingTextTabStrip.this.dragging.getLeft();
                            } else {
                                this.f2067sx += childAt.getLeft() - ScrollSlidingTextTabStrip.this.dragging.getLeft();
                            }
                            ScrollSlidingTextTabStrip.this.dragging.setTranslationX(motionEvent.getX() - this.f2067sx);
    ...
    private void checkBoundsAndClipping() {
        ...
        this.rect.inset(AndroidUtilities.m1124dp(7.0f), AndroidUtilities.m1124dp(7.0f));
        if (f >= 1.0f) {
        ...
        if (blurredBackgroundDrawable != null) {
            ...
            this.backgroundDrawable.setBounds(((int) this.rect.left) - AndroidUtilities.m1124dp(7.0f), 0, ((int) this.rect.right) + AndroidUtilities.m1124dp(7.0f), getMeasuredHeight());
    ...
    public void addTextTab(final int i, CharSequence charSequence, SparseArray sparseArray) {
        ...
        int iCeil = ((int) Math.ceil(HintView2.measureCorrectly(r6, textView.getPaint()))) + AndroidUtilities.m1124dp(32.0f);
    ...
    public void setOpen(boolean z) {
        ...
        this.isOpen = z;
        setPadding(AndroidUtilities.m1124dp(z ? 0.0f : 6.0f), getPaddingTop(), AndroidUtilities.m1124dp(this.isOpen ? 0.0f : 6.0f), getPaddingBottom());
        invalidate();
        if (!this.fitsItems) {
            this.prevRect.set(this.rect);
            this.rectT.force(0.0f);
            this.left.force(AndroidUtilities.m1124dp(this.isOpen ? 6.0f : -6.0f));
        }
        checkBoundsAndClipping();
    }
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        if (view == this.tabsContainer) {
            ...
            this.selectorDrawable.setBounds(getPaddingLeft() + ((int) translationX) + AndroidUtilities.m1124dp(4.0f), getPaddingTop() + AndroidUtilities.m1124dp(4.0f), (getPaddingLeft() + ((int) translationX2)) - AndroidUtilities.m1124dp(4.0f), (measuredHeight - getPaddingBottom()) - AndroidUtilities.m1124dp(4.0f));
    ...
    protected void onMeasure(int i, int i2) {
        int size = View.MeasureSpec.getSize(i) - AndroidUtilities.m1124dp(22.0f);
        int childCount = this.tabsContainer.getChildCount();
    ...
    public void scrollToChild(int i, boolean z) {
        ...
        if (left - AndroidUtilities.m1124dp(50.0f) < scrollX) {
            if (z) {
                smoothScrollTo(left - AndroidUtilities.m1124dp(50.0f), 0);
                return;
            } else {
                scrollTo(left - AndroidUtilities.m1124dp(50.0f), 0);
                return;
            }
        }
        int i2 = left + measuredWidth;
        if (AndroidUtilities.m1124dp(21.0f) + i2 > scrollX + getWidth()) {
            if (z) {
                smoothScrollTo(i2, 0);
            } else {
                scrollTo(i2, 0);
