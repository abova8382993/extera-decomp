...
public class SizeNotifierFrameLayout extends FrameLayout implements Theme.Colorable {
    ...
    public void startBlur() {
        ...
        if (this.blurIsRunning && !this.blurGeneratingTuskIsRunning && this.invalidateBlur && SharedConfig.chatBlurEnabled() && !DRAW_USING_RENDERNODE()) {
            if (Color.alpha(Theme.getColor(Theme.key_chat_BlurAlphaSlow)) != 255 || ExteraConfig.forceBlur) {
                ...
                int iM1124dp = AndroidUtilities.m1124dp(100.0f) + ActionBar.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight;
                if (measuredWidth == 0 || iM1124dp == 0) {
                    return;
                }
                ...
                this.blurBackgroundTask.radius = (int) (((int) (Math.max(6, Math.max(iM1124dp, measuredWidth) / 180) * 2.5f)) * BlurSettingsBottomSheet.blurRadius);
    ...
    class BlurBackgroundTask implements Runnable {
        ...
        public /* synthetic */ void lambda$run$2() {
            ...
            SizeNotifierFrameLayout.this.blurCrossfade.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.SizeNotifierFrameLayout.BlurBackgroundTask.1
                ...
                C51321(BlurBitmap blurBitmap22) {
        ...
        class C51321 extends AnimatorListenerAdapter {
            final /* synthetic */ BlurBitmap val$oldBitmap;
    ...
    public static float getRenderNodeScale() {
        ...
        if (devicePerformanceClass == 1) {
            ...
            iM1124dp = AndroidUtilities.m1124dp(15.0f);
        }
        return iM1124dp;
    }
        ...
        if (DRAW_USING_RENDERNODE()) {
            ...
            if (i3 >= 255 || !this.blurNodeInvalidated[i4] || this.blurNodeInvalidatedThisFrame[i4]) {
                ...
                if (renderNodeArr[i4] == null) {
                    ...
                    sb.append("blurNode");
                    sb.append(i4);
                    renderNodeArr[i4] = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1129m(sb.toString());
                ...
                int measuredWidth = getMeasuredWidth();
                int currentActionBarHeight = ActionBar.getCurrentActionBarHeight() + AndroidUtilities.statusBarHeight + AndroidUtilities.m1124dp(100.0f);
                this.blurNodes[i4].setPosition(0, 0, (int) (measuredWidth / renderNodeScale), (int) (((iM1124dp * 2) + currentActionBarHeight) / renderNodeScale));
                ...
                recordingCanvasBeginRecording.translate(0.0f, iM1124dp);
                if (!z) {
            ...
            if (renderNode != null && i3 < 255) {
                ...
                canvas.translate(0.0f, -iM1124dp);
