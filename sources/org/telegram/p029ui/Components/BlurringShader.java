...
import org.telegram.p029ui.Components.Paint.Shader;
...
public class BlurringShader {
    ...
    public boolean setup(float f, boolean z, int i) {
        ...
        String res = AndroidUtilities.readRes(C2888R.raw.blur_vrt);
        String res2 = AndroidUtilities.readRes(C2888R.raw.blur_frg);
    ...
    public void draw(float[] fArr, int i, int i2, int i3) {
        ...
        GLES20.glUseProgram(program.f1933gl);
    ...
    public static class BlurManager {
        ...
        public void setRenderNode(View view, Object obj, int i) {
            ...
            if (obj != null && Build.VERSION.SDK_INT >= 31) {
                ...
                RenderNode renderNodeM1129m = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1129m("blurRenderNode");
                renderNodeM1129m.setRenderEffect(RenderEffect.createBlurEffect(AndroidUtilities.m1124dp(35.0f), AndroidUtilities.m1124dp(35.0f), Shader.TileMode.CLAMP));
                renderNodeM1129m.setPosition(0, 0, renderNodeM1130m.getWidth(), renderNodeM1130m.getHeight());
                RecordingCanvas recordingCanvasBeginRecording = renderNodeM1129m.beginRecording();
        ...
        public BlurManager(View view) {
            ...
            view.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: org.telegram.ui.Components.BlurringShader.BlurManager.1
                ViewOnAttachStateChangeListenerC39191() {
                }
        ...
        class ViewOnAttachStateChangeListenerC39191 implements View.OnAttachStateChangeListener {
            ViewOnAttachStateChangeListenerC39191() {
            }
    ...
    public static class StoryBlurDrawer {
        ...
        public StoryBlurDrawer(BlurManager blurManager, View view, int i, boolean z) {
            ...
            view.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: org.telegram.ui.Components.BlurringShader.StoryBlurDrawer.1
                ...
                ViewOnAttachStateChangeListenerC39201(BlurManager blurManager2) {
        ...
        class ViewOnAttachStateChangeListenerC39201 implements View.OnAttachStateChangeListener {
            final /* synthetic */ BlurManager val$manager;
        ...
        public void drawRect(Canvas canvas, float f, float f2, float f3, boolean z) {
            if (this.manager.hasRenderNode() && Build.VERSION.SDK_INT >= 31) {
                ...
                RenderNode renderNodeM1130m = BotFullscreenButtons$$ExternalSyntheticApiModelOutline1.m1130m(this.manager.blurRenderNode);
                if (!renderNodeM1130m.hasDisplayList()) {
                    RenderNode renderNodeM1130m2 = BotFullscreenButtons$$ExternalSyntheticApiModelOutline1.m1130m(this.manager.renderNode);
                    renderNodeM1130m.setPosition(0, 0, renderNodeM1130m2.getWidth(), renderNodeM1130m2.getHeight());
                    RecordingCanvas recordingCanvasBeginRecording = renderNodeM1130m.beginRecording();
                    recordingCanvasBeginRecording.drawColor(getBackgroundColor());
                    recordingCanvasBeginRecording.drawRenderNode(renderNodeM1130m2);
                ...
                canvas.drawColor(getBackgroundColor());
                if (setupMatrix(renderNodeM1130m.getWidth(), renderNodeM1130m.getHeight(), true) && renderNodeM1130m.hasDisplayList()) {
                    this.matrix.postTranslate(-f, -f2);
                    this.paint.setAlpha((int) (f3 * 255.0f));
                    canvas.saveLayer(null, this.paint);
                    canvas.concat(this.matrix);
                    if (z) {
                        if (this.clipPathWidth != renderNodeM1130m.getWidth() || this.clipPathHeight != renderNodeM1130m.getHeight()) {
                            this.clipPath.rewind();
                            RectF rectF = AndroidUtilities.rectTmp;
                            int width = renderNodeM1130m.getWidth();
                            this.clipPathWidth = width;
                            int height = renderNodeM1130m.getHeight();
                            this.clipPathHeight = height;
                            rectF.set(0.0f, 0.0f, width, height);
                            this.clipPath.addRoundRect(rectF, AndroidUtilities.m1124dp(12.0f), AndroidUtilities.m1124dp(12.0f), Path.Direction.CW);
                        }
        ...
        class C39212 extends Drawable {
            ...
            C39212(float f, float f2, Drawable drawable, float f3) {
                f = f;
                f = f2;
                drawable = drawable;
                f = f3;
        ...
        public Drawable makeDrawable(float f, float f2, Drawable drawable, float f3) {
            return new Drawable() { // from class: org.telegram.ui.Components.BlurringShader.StoryBlurDrawer.2
                ...
                C39212(float f4, float f22, Drawable drawable2, float f32) {
                    f = f4;
                    f = f22;
                    drawable = drawable2;
                    f = f32;
