...
public class TableLayout extends View {
        ...
        */
        public void measure(int r2, int r3, boolean r4) {
            ...
            L18:
                ...
                int r2 = r1.textHeight
                int r3 = r3 - r2
                org.telegram.ui.Components.TableLayout r2 = org.telegram.p029ui.Components.TableLayout.this
                int r2 = org.telegram.p029ui.Components.TableLayout.m12753$$Nest$fgetitemPaddingTop(r2)
                int r3 = r3 - r2
                r1.textY = r3
                goto L31
            L29:
            ...
            L4a:
                org.telegram.ui.Components.TableLayout r2 = org.telegram.p029ui.Components.TableLayout.this
                org.telegram.ui.Components.TableLayout$TableLayoutDelegate r2 = org.telegram.p029ui.Components.TableLayout.m12749$$Nest$fgetdelegate(r2)
                org.telegram.tgnet.TLRPC$TL_pageTableCell r3 = r1.cell
                int r4 = r1.measuredWidth
                org.telegram.ui.Components.TableLayout r0 = org.telegram.p029ui.Components.TableLayout.this
                int r0 = org.telegram.p029ui.Components.TableLayout.m12752$$Nest$fgetitemPaddingLeft(r0)
                int r0 = r0 * 2
                int r4 = r4 - r0
                org.telegram.ui.ArticleViewer$DrawingText r2 = r2.createTextLayout(r3, r4)
                r1.setTextLayout(r2)
                int r2 = r1.textHeight
                org.telegram.ui.Components.TableLayout r3 = org.telegram.p029ui.Components.TableLayout.this
                int r3 = org.telegram.p029ui.Components.TableLayout.m12753$$Nest$fgetitemPaddingTop(r3)
                int r3 = r3 * 2
                int r2 = r2 + r3
                r1.fixedHeight = r2
            L71:
                ...
                int r4 = r1.textWidth
                int r3 = r3 - r4
                org.telegram.ui.Components.TableLayout r4 = org.telegram.p029ui.Components.TableLayout.this
                int r4 = org.telegram.p029ui.Components.TableLayout.m12752$$Nest$fgetitemPaddingLeft(r4)
                int r3 = r3 - r4
                int r2 = r2 + r3
                r1.textX = r2
                return
            ...
            La2:
                org.telegram.ui.Components.TableLayout r3 = org.telegram.p029ui.Components.TableLayout.this
                int r3 = org.telegram.p029ui.Components.TableLayout.m12752$$Nest$fgetitemPaddingLeft(r3)
                int r2 = r2 + r3
                r1.textX = r2
                return
            Lac:
                org.telegram.ui.Components.TableLayout r2 = org.telegram.p029ui.Components.TableLayout.this
                int r2 = org.telegram.p029ui.Components.TableLayout.m12752$$Nest$fgetitemPaddingLeft(r2)
                r1.textX = r2
            Lb4:
                return
            */
        ...
        public int getTextX() {
            return this.f2093x + this.textX;
        }

        public int getTextY() {
            return this.f2094y + this.textY;
        }
        ...
        public void draw(Canvas canvas, View view) {
            ...
            boolean z = false;
            boolean z2 = true;
            boolean z3 = this.f2093x + this.measuredWidth == TableLayout.this.getMeasuredWidth();
            boolean z4 = this.f2094y + this.measuredHeight == TableLayout.this.getMeasuredHeight();
            ...
            if (this.cell.header || (TableLayout.this.isStriped && this.layoutParams.rowSpec.span.min % 2 == 0)) {
                if (this.f2093x == 0 && this.f2094y == 0) {
                ...
                if (z2) {
                    TableLayout.this.rect.set(this.f2093x, this.f2094y, r3 + this.measuredWidth, r5 + this.measuredHeight);
                    ...
                    canvas2.drawRect(this.f2093x, this.f2094y, r2 + this.measuredWidth, r4 + this.measuredHeight, TableLayout.this.delegate.getHeaderPaint());
                    canvas2 = canvas;
                } else {
                    canvas2 = canvas;
                    canvas2.drawRect(this.f2093x, this.f2094y, r1 + this.measuredWidth, r3 + this.measuredHeight, TableLayout.this.delegate.getStripPaint());
                }
            }
            ...
            if (TableLayout.this.drawLines) {
                ...
                if (i2 == 0) {
                    ...
                    int i4 = this.f2093x;
                    canvas2.drawLine(i4 + strokeWidth, f7, i4 + strokeWidth, f8, linePaint);
                    paint = linePaint;
                    paint2 = linePaint2;
                } else {
                    paint = linePaint;
                    paint2 = linePaint2;
                    canvas.drawLine(i2 - strokeWidth2, this.f2094y, i2 - strokeWidth2, r3 + this.measuredHeight, paint2);
                }
                int i5 = this.f2094y;
                if (i5 == 0) {
                    int i6 = this.f2093x;
                    ...
                    if (f10 == TableLayout.this.getMeasuredWidth()) {
                        f10 -= iM1124dp;
                    }
                    int i7 = this.f2094y;
                    canvas.drawLine(f9, i7 + strokeWidth, f10, i7 + strokeWidth, paint);
                } else {
                    canvas.drawLine(this.f2093x, i5 - strokeWidth2, r2 + this.measuredWidth, i5 - strokeWidth2, paint2);
                }
                float f11 = (z3 && (i = this.f2094y) == 0) ? i + iM1124dp : this.f2094y - strokeWidth;
                if (z3 && z4) {
                    f = (this.f2094y + this.measuredHeight) - iM1124dp;
                } else {
                    f = (this.f2094y + this.measuredHeight) - strokeWidth;
                }
                float f12 = f;
                int i8 = this.f2093x;
                int i9 = this.measuredWidth;
                Paint paint3 = paint;
                canvas.drawLine((i8 + i9) - strokeWidth, f11, (i8 + i9) - strokeWidth, f12, paint3);
                int i10 = this.f2093x;
                float f13 = (i10 == 0 && z4) ? i10 + iM1124dp : i10 - strokeWidth;
                if (z3 && z4) {
                    f2 = (i10 + this.measuredWidth) - iM1124dp;
                } else {
                ...
                canvas.drawLine(f13, (i11 + i12) - strokeWidth, f14, (i11 + i12) - strokeWidth, paint3);
                if (this.f2093x == 0 && this.f2094y == 0) {
                    RectF rectF = TableLayout.this.rect;
                    int i13 = this.f2093x;
                    int i14 = this.f2094y;
                    float f15 = iM1124dp * 2;
                    rectF.set(i13 + strokeWidth, i14 + strokeWidth, i13 + strokeWidth + f15, i14 + strokeWidth + f15);
                ...
                if (z3 && this.f2094y == 0) {
                    ...
                    float f16 = iM1124dp * 2;
                    int i17 = this.f2094y;
                    rectF2.set(((i15 + i16) - strokeWidth) - f16, i17 + strokeWidth, (i15 + i16) - strokeWidth, i17 + strokeWidth + f16);
                ...
                if (this.f2093x == 0 && z4) {
                    ...
                    float f17 = iM1124dp * 2;
                    rectF3.set(i18 + strokeWidth, ((i19 + i20) - strokeWidth) - f17, i18 + strokeWidth + f17, (i19 + i20) - strokeWidth);
                    canvas.drawArc(TableLayout.this.rect, 180.0f, -90.0f, false, paint3);
                }
                if (z3 && z4) {
                    ...
                    float f18 = iM1124dp * 2;
                    int i23 = this.f2094y;
                    int i24 = this.measuredHeight;
                    rectF4.set(((i21 + i22) - strokeWidth) - f18, ((i23 + i24) - strokeWidth) - f18, (i21 + i22) - strokeWidth, (i23 + i24) - strokeWidth);
                    canvas.drawArc(TableLayout.this.rect, 0.0f, 90.0f, false, paint3);
                }
            }
        }
    ...
    public TableLayout(Context context, TableLayoutDelegate tableLayoutDelegate, TextSelectionHelper.ArticleTextSelectionHelper articleTextSelectionHelper) {
        ...
        this.itemPaddingTop = AndroidUtilities.m1124dp(7.0f);
        this.itemPaddingLeft = AndroidUtilities.m1124dp(8.0f);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (i6 < childCount2) {
            ...
            Bounds bounds = (Bounds) tableLayout.mHorizontalAxis.getGroupBounds().getValue(i6);
            Bounds bounds2 = (Bounds) tableLayout.mVerticalAxis.getGroupBounds().getValue(i6);
            ...
            int offset = bounds.getOffset(tableLayout, childAt, absoluteAlignment, measurement + i11, true);
            tableLayout = this;
            int i12 = iMax2;
            int offset2 = bounds2.getOffset(tableLayout, childAt, absoluteAlignment2, measurement2 + margin4, false);
            ...
            if (childAt.cell != null) {
                ...
                if (childAt.fixedHeight != 0 && childAt.fixedHeight != sizeInCell2 && childAt.layoutParams.rowSpec.span.max - childAt.layoutParams.rowSpec.span.min <= 1) {
                    ...
                    while (true) {
                        if (i16 < size) {
                            Point point = (Point) tableLayout.rowSpans.get(i16);
                            if (point.f2016x > childAt.layoutParams.rowSpec.span.min || point.f2017y <= childAt.layoutParams.rowSpec.span.min) {
                                i16++;
                            }
                        } else {
        ...
        int i17 = 0;
        while (i17 < size2) {
            Child child = (Child) tableLayout.cellsToFixHeight.get(i17);
            ...
            for (int i18 = child.index + 1; i18 < size3; i18++) {
                Child child2 = (Child) tableLayout.childrens.get(i18);
            ...
            if (!z) {
                ...
                while (true) {
                    ...
                    Child child3 = (Child) tableLayout.childrens.get(i20);
            ...
            if (!z) {
                ...
                for (int i23 = 0; i23 < size4; i23++) {
                    Child child4 = (Child) tableLayout.childrens.get(i23);
                    if (child != child4) {
    ...
    final class Axis {
        ...
        private PackedMap createGroupBounds() {
            Assoc assocM1274of = Assoc.m1274of(Spec.class, Bounds.class);
            int childCount = TableLayout.this.getChildCount();
            for (int i = 0; i < childCount; i++) {
                LayoutParams layoutParams = TableLayout.this.getChildAt(i).getLayoutParams();
                boolean z = this.horizontal;
                Spec spec = z ? layoutParams.columnSpec : layoutParams.rowSpec;
                assocM1274of.put(spec, spec.getAbsoluteAlignment(z).getBounds());
            }
            return assocM1274of.pack();
        }
        ...
        private PackedMap createLinks(boolean z) {
            Assoc assocM1274of = Assoc.m1274of(Interval.class, MutableInt.class);
            Spec[] specArr = (Spec[]) getGroupBounds().keys;
            int length = specArr.length;
            for (int i = 0; i < length; i++) {
                assocM1274of.put(z ? specArr[i].span : specArr[i].span.inverse(), new MutableInt());
            }
            return assocM1274of.pack();
        }
    ...
    static final class Assoc extends ArrayList {
        ...
        public static Assoc m1274of(Class cls, Class cls2) {
