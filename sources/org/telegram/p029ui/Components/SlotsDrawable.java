...
public class SlotsDrawable extends RLottieDrawable {
            ...
            if (jArr[i4] != 0) {
                ...
                if (TextUtils.isEmpty(res)) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.SlotsDrawable$$ExternalSyntheticLambda9
                        @Override // java.lang.Runnable
                        public final void run() {
                            SlotsDrawable.m12621$r8$lambda$CRSx3qZRDIU7oRxYGW02aqy5aI(document, i3, messageObject2, chatMessageCell2, tL_messages_stickerSet2);
                        }
                    });
                    z = true;
                } else {
    ...
    public static /* synthetic */ void m12621$r8$lambda$CRSx3qZRDIU7oRxYGW02aqy5aI(TLRPC.Document document, int i, MessageObject messageObject, ChatMessageCell chatMessageCell, TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
    ...
    */
    public /* synthetic */ void lambda$setDiceNumber$10(org.telegram.tgnet.TLRPC.TL_messages_stickerSet r18, final int r19, final org.telegram.messenger.MessageObject r20, final org.telegram.p029ui.Cells.ChatMessageCell r21, final boolean r22) {
        /*
            Method dump skipped, instruction units count: 293
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.SlotsDrawable.lambda$setDiceNumber$10(org.telegram.tgnet.TLRPC$TL_messages_stickerSet, int, org.telegram.messenger.MessageObject, org.telegram.ui.Cells.ChatMessageCell, boolean):void");
    }
