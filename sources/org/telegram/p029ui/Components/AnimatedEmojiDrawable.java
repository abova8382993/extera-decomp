...
public class AnimatedEmojiDrawable extends Drawable {
    ...
    public static AnimatedEmojiDrawable make(int i, int i2, TLRPC.Document document) {
        ...
        AnimatedEmojiDrawable animatedEmojiDrawable = (AnimatedEmojiDrawable) longSparseArray.get(document.f1668id);
        if (animatedEmojiDrawable != null) {
            return animatedEmojiDrawable;
        }
    ...
    public static class EmojiDocumentFetcher {
        ...
        private boolean checkThread() {
            ...
            FileLog.m1135e("EmojiDocumentFetcher", new IllegalStateException("Wrong thread"));
            return false;
        }
            ...
            try {
                ...
                while (sQLiteCursorQueryFinalized.next()) {
                    ...
                    try {
                        ...
                        if (documentTLdeserialize != null && documentTLdeserialize.f1668id != 0) {
                            arrayList2.add(documentTLdeserialize);
                            hashSet.remove(Long.valueOf(documentTLdeserialize.f1668id));
                        }
                    } catch (Exception e) {
                        FileLog.m1136e(e);
                    }
            ...
            if (tLObject instanceof Vector) {
                ...
                for (int i = 0; i < arrayList2.size(); i++) {
                    if (arrayList2.get(i) instanceof TLRPC.Document) {
                        hashSet.remove(Long.valueOf(((TLRPC.Document) arrayList2.get(i)).f1668id));
                    }
                }
                if (hashSet.isEmpty()) {
                    return;
                    ...
                    if (arrayList.get(i) instanceof TLRPC.Document) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                sQLitePreparedStatementExecuteFast.bindLong(1, document.f1668id);
            ...
            if (checkThread()) {
                ...
                for (int i = 0; i < arrayList.size(); i++) {
                    if (arrayList.get(i) instanceof TLRPC.Document) {
                        ...
                        if (map != null && (arrayList2 = (ArrayList) map.remove(Long.valueOf(document.f1668id))) != null) {
        ...
        public void putDocument(TLRPC.Document document) {
            ...
            synchronized (this) {
                try {
                    ...
                    this.emojiDocumentsCache.put(Long.valueOf(document.f1668id), document);
                } catch (Throwable th) {
                    throw th;
                }
            }
    ...
    public long getDocumentId() {
        ...
        return document != null ? document.f1668id : this.documentId;
    }
    ...
    class C38331 extends ImageReceiver {
        C38331() {
        }
    ...
    private void createImageReceiver() {
        if (this.imageReceiver == null) {
            C38331 c38331 = new C38331();
            this.imageReceiver = c38331;
            c38331.setCurrentAccount(this.currentAccount);
    ...
    /* JADX WARN: Removed duplicated region for block: B:320:0x0218  */
    /* JADX WARN: Removed duplicated region for block: B:322:0x0225  */
    /* JADX WARN: Removed duplicated region for block: B:326:0x022e  */
    /* JADX WARN: Removed duplicated region for block: B:327:0x025f  */
    /* JADX WARN: Removed duplicated region for block: B:353:0x03a5  */
    /* JADX WARN: Removed duplicated region for block: B:363:0x03b6  */
    /* JADX WARN: Removed duplicated region for block: B:366:0x03c2  */
    /* JADX WARN: Removed duplicated region for block: B:368:0x03c6  */
    /* JADX WARN: Removed duplicated region for block: B:371:0x03d8  */
    ...
    */
    private void initDocument(boolean r36) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.AnimatedEmojiDrawable.initDocument(boolean):void");
    }
    ...
    class ViewOnAttachStateChangeListenerC38342 implements View.OnAttachStateChangeListener {
        ViewOnAttachStateChangeListenerC38342() {
        }
    ...
    */
    public boolean isDefaultStatusEmoji() {
        ...
        L35:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.AnimatedEmojiDrawable.isDefaultStatusEmoji():boolean");
    }
    ...
    public static class SwapAnimatedEmojiDrawable extends Drawable implements AnimatedEmojiSpan.InvalidateHolder {
            ...
            if (this.drawables[0] != null) {
                ...
                if (drawable3 instanceof AnimatedEmojiDrawable) {
                    if (((AnimatedEmojiDrawable) drawable3).imageReceiver != null) {
                        ((AnimatedEmojiDrawable) this.drawables[0]).imageReceiver.setRoundRadius(AndroidUtilities.m1124dp(4.0f));
                    }
                    if (f < 1.0f) {
        ...
        public void set(TLRPC.Document document, int i, boolean z) {
            Drawable drawable = this.drawables[0];
            if ((drawable instanceof AnimatedEmojiDrawable) && document != null && ((AnimatedEmojiDrawable) drawable).getDocumentId() == document.f1668id) {
                return;
            }
            if (z) {
                this.changeProgress.set(0.0f, true);
