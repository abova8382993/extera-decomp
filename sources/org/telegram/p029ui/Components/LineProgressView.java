...
public class LineProgressView extends LinearProgressIndicator {
    ...
    public void setProgressType(int i) {
        ...
        if (i == 0) {
            ...
            setWavelengthDeterminate(AndroidUtilities.m1124dp(40.0f));
            setWaveAmplitude(AndroidUtilities.m1124dp(3.0f));
            setWaveSpeed(AndroidUtilities.m1124dp(15.0f));
    ...
    private void init() {
        ...
        setTrackThickness(AndroidUtilities.m1124dp(2.0f));
        setTrackCornerRadius(AndroidUtilities.m1124dp(1.0f));
        setTrackStopIndicatorSize(AndroidUtilities.m1124dp(2.0f));
        setIndicatorTrackGapSize(AndroidUtilities.m1124dp(2.0f));
