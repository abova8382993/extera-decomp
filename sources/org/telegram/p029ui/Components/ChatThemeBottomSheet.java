...
public class ChatThemeBottomSheet extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ChatThemeBottomSheet(final ChatActivity chatActivity, ChatActivity.ThemeDelegate themeDelegate) {
        ...
        textView.setText(LocaleController.getString(C2888R.string.SelectTheme));
        textView.setTextColor(getThemedColor(Theme.key_dialogTextBlack));
        textView.setTextSize(1, 20.0f);
        textView.setTypeface(AndroidUtilities.bold());
        textView.setPadding(AndroidUtilities.m1124dp(12.0f), AndroidUtilities.m1124dp(6.0f), AndroidUtilities.m1124dp(12.0f), AndroidUtilities.m1124dp(8.0f));
        ...
        int iM1124dp2 = AndroidUtilities.m1124dp(28.0f);
        int i3 = C2888R.raw.sun_outline;
        StringBuilder sb = new StringBuilder();
        String firstName = _UrlKt.FRAGMENT_ENCODE_SET;
        sb.append(_UrlKt.FRAGMENT_ENCODE_SET);
        sb.append(C2888R.raw.sun_outline);
        RLottieDrawable rLottieDrawable = new RLottieDrawable(i3, sb.toString(), iM1124dp2, iM1124dp2, false, null);
        ...
        RLottieImageView rLottieImageView = new RLottieImageView(getContext()) { // from class: org.telegram.ui.Components.ChatThemeBottomSheet.1
            ...
            public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
                ...
                if (ChatThemeBottomSheet.this.forceDark) {
                    accessibilityNodeInfo.setText(LocaleController.getString(C2888R.string.AccDescrSwitchToDayTheme));
                } else {
                    accessibilityNodeInfo.setText(LocaleController.getString(C2888R.string.AccDescrSwitchToNightTheme));
                }
            }
        };
        ...
        recyclerListView.setPadding(AndroidUtilities.m1124dp(12.0f), 0, AndroidUtilities.m1124dp(12.0f), 0);
        ...
        view.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1124dp(6.0f), getThemedColor(i2), getThemedColor(Theme.key_featuredStickers_addButtonPressed)));
        ...
        if (this.currentWallpaper == null) {
            this.chooseBackgroundTextView.setText(LocaleController.getString(C2888R.string.ChooseBackgroundFromGallery));
        } else {
            this.chooseBackgroundTextView.setText(LocaleController.getString(C2888R.string.ChooseANewWallpaper));
        }
        ...
        this.applyTextView.setTextSize(AndroidUtilities.m1124dp(15.0f));
        ...
        this.applySubTextView.setTextSize(AndroidUtilities.m1124dp(12.0f));
        this.applySubTextView.setAlpha(0.0f);
        this.applySubTextView.setTranslationY(AndroidUtilities.m1124dp(11.0f));
        ...
        if (this.currentWallpaper != null) {
            ...
            this.cancelOrResetTextView.setText(LocaleController.getString(C2888R.string.RestToDefaultBackground));
            ...
            this.themeHintTextView.setText(LocaleController.formatString("ChatThemeApplyHint", C2888R.string.ChatThemeApplyHint, firstName));
    ...
    public void updateButtonColors() {
        ...
        if (textView != null) {
            ...
            this.themeHintTextView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1124dp(6.0f), 0, ColorUtils.setAlphaComponent(getThemedColor(Theme.key_featuredStickers_addButton), 76)));
        }
        TextView textView2 = this.cancelOrResetTextView;
        if (textView2 != null) {
            int i = Theme.key_text_RedRegular;
            textView2.setTextColor(getThemedColor(i));
            this.cancelOrResetTextView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1124dp(6.0f), 0, ColorUtils.setAlphaComponent(getThemedColor(i), 76)));
        }
        ...
        this.chooseBackgroundTextView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1124dp(6.0f), 0, ColorUtils.setAlphaComponent(getThemedColor(i3), 76)));
    }
    ...
    */
    private void updateState(boolean r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.ChatThemeBottomSheet.updateState(boolean):void");
    }
    ...
    private void updateApplySubTextTranslation(final boolean z, boolean z2) {
        ...
        if (z2) {
            ...
            this.subTextTranslationAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ChatThemeBottomSheet.5
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    ChatThemeBottomSheet.this.applyTextView.setTranslationY((-AndroidUtilities.m1124dp(7.0f)) * ChatThemeBottomSheet.this.subTextTranslation);
                }
            });
        ...
        this.applyTextView.setTranslationY((-AndroidUtilities.m1124dp(7.0f)) * this.subTextTranslation);
    }
    ...
    public void loadNext() {
        ...
        if (chatThemeController.isGiftThemesFullyLoaded()) {
            chatThemeController.requestAllChatThemes(new C42246(chatThemeController), false);
        } else {
            chatThemeController.loadNextChatThemes(new C42257(chatThemeController));
        }
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.ChatThemeBottomSheet$6 */
    class C42246 implements ResultCallback {
        final /* synthetic */ ChatThemeController val$chatThemeController;

        C42246(ChatThemeController chatThemeController) {
    ...
    class C42257 implements ResultCallback {
        final /* synthetic */ ChatThemeController val$chatThemeController;

        C42257(ChatThemeController chatThemeController) {
            this.val$chatThemeController = chatThemeController;
        }
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.hintView.setBottomOffset(-AndroidUtilities.m1124dp(8.0f));
        if (this.forceDark) {
            this.hintView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ChatThemeDaySwitchTooltip", C2888R.string.ChatThemeDaySwitchTooltip, new Object[0])));
        } else {
            this.hintView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ChatThemeNightSwitchTooltip", C2888R.string.ChatThemeNightSwitchTooltip, new Object[0])));
        }
    ...
    public void close() {
        if (hasChanges()) {
            ...
            builder.setTitle(LocaleController.getString(C2888R.string.ChatThemeSaveDialogTitle));
            builder.setMessage(LocaleController.getString(C2888R.string.ChatThemeSaveDialogText));
            builder.setPositiveButton(LocaleController.getString(C2888R.string.ChatThemeSaveDialogApply), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.ChatThemeBottomSheet$$ExternalSyntheticLambda1
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i) {
                    this.f$0.lambda$close$9(alertDialog, i);
                }
            });
            builder.setNegativeButton(LocaleController.getString(C2888R.string.ChatThemeSaveDialogDiscard), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.ChatThemeBottomSheet$$ExternalSyntheticLambda2
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i) {
        ...
        ThemeDescription.ThemeDescriptionDelegate themeDescriptionDelegate = new ThemeDescription.ThemeDescriptionDelegate() { // from class: org.telegram.ui.Components.ChatThemeBottomSheet.8
            ...
            public void onAnimationProgress(float f) {
                ...
                if (ChatThemeBottomSheet.this.chatAttachButton != null) {
                    ChatThemeBottomSheet.this.chatAttachButton.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1124dp(0.0f), ChatThemeBottomSheet.this.getThemedColor(Theme.key_windowBackgroundWhite), ColorUtils.setAlphaComponent(ChatThemeBottomSheet.this.getThemedColor(i), 76)));
                }
    ...
    private void applySelectedTheme(boolean z) {
        ...
        if (chatThemeItem != null && emojiThemes != this.currentTheme) {
            ...
            if (currentUser != null && !currentUser.self) {
                ...
                if (z2) {
                    stickerSetBulletinLayout.titleTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ThemeAlsoDisabledForHint", C2888R.string.ThemeAlsoDisabledForHint, currentUser.first_name)));
                } else {
                    stickerSetBulletinLayout.titleTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ThemeAlsoAppliedForHint", C2888R.string.ThemeAlsoAppliedForHint, currentUser.first_name)));
                }
    ...
    public static void openGalleryForBackground(Activity activity, BaseFragment baseFragment, long j, Theme.ResourcesProvider resourcesProvider, Utilities.Callback callback, ThemePreviewActivity.DayNightSwitchDelegate dayNightSwitchDelegate, TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus) {
        ...
        chatAttachAlert.setupPhotoPicker(LocaleController.getString(C2888R.string.ChooseBackground));
        chatAttachAlert.setDelegate(new C421612(chatAttachAlert, tL_premium_boostsStatus, resourcesProvider, dayNightSwitchDelegate, j, callback, baseFragment));
    ...
    class C421612 implements ChatAttachAlert.ChatAttachViewDelegate {
        long start;
        ...
        C421612(ChatAttachAlert chatAttachAlert, TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus, Theme.ResourcesProvider resourcesProvider, ThemePreviewActivity.DayNightSwitchDelegate dayNightSwitchDelegate, long j, Utilities.Callback callback, BaseFragment baseFragment) {
            ...
            try {
                ...
                if (str != null) {
                    ...
                    ThemePreviewActivity themePreviewActivity = new ThemePreviewActivity(new WallpapersListActivity.FileWallpaper(_UrlKt.FRAGMENT_ENCODE_SET, file, file), bitmapLoadBitmap) { // from class: org.telegram.ui.Components.ChatThemeBottomSheet.12.1
                        @Override // org.telegram.p029ui.ThemePreviewActivity
                    ...
                    themePreviewActivity.setDelegate(new ThemePreviewActivity.WallpaperActivityDelegate() { // from class: org.telegram.ui.Components.ChatThemeBottomSheet$12$$ExternalSyntheticLambda0
                        ...
                        public final void didSetNewBackground(TLRPC.WallPaper wallPaper) {
                            ChatThemeBottomSheet.C421612.$r8$lambda$yCNJNz_wi4txAgZrLSpOt3PRB_4(chatAttachAlert, callback, wallPaper);
                        }
                    });
        ...
        public void onWallpaperSelected(Object obj) {
            ...
            themePreviewActivity.setDelegate(new ThemePreviewActivity.WallpaperActivityDelegate() { // from class: org.telegram.ui.Components.ChatThemeBottomSheet$12$$ExternalSyntheticLambda1
                @Override // org.telegram.ui.ThemePreviewActivity.WallpaperActivityDelegate
                public final void didSetNewBackground(TLRPC.WallPaper wallPaper) {
                    ChatThemeBottomSheet.C421612.m9696$r8$lambda$6dRX3czrryVZ6jB_jue3GVp8Y(chatAttachAlert, callback, wallPaper);
                }
            });
            BaseFragment.BottomSheetParams bottomSheetParams = new BaseFragment.BottomSheetParams();
            bottomSheetParams.transitionFromLeft = true;
        ...
        public static /* synthetic */ void m9696$r8$lambda$6dRX3czrryVZ6jB_jue3GVp8Y(ChatAttachAlert chatAttachAlert, Utilities.Callback callback, TLRPC.WallPaper wallPaper) {
            chatAttachAlert.dismissInternal();
            if (callback != null) {
                callback.run(wallPaper);
            }
    ...
    private void openGalleryForBackground() {
        ...
        chatAttachAlert.drawNavigationBar = true;
        chatAttachAlert.setupPhotoPicker(LocaleController.getString(C2888R.string.ChooseBackground));
        this.chatAttachAlert.setDelegate(new C421713());
        ...
        this.chatAttachButtonText.setText(LocaleController.getString(C2888R.string.SetColorAsBackground));
        ...
        this.chatAttachButton.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1124dp(0.0f), getThemedColor(Theme.key_windowBackgroundWhite), ColorUtils.setAlphaComponent(getThemedColor(i), 76)));
    ...
    class C421713 implements ChatAttachAlert.ChatAttachViewDelegate {
        long start;
    ...
    public /* synthetic */ void lambda$openGalleryForBackground$17(View view) {
        if (this.chatAttachAlert.getCurrentAttachLayout() == this.chatAttachAlert.getPhotoLayout()) {
            this.chatAttachButtonText.setText(LocaleController.getString(C2888R.string.ChooseBackgroundFromGallery));
