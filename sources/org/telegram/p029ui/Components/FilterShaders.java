  ...
  0x0075: PHI (r2v9 float) = (r2v5 float), (r2v6 float) binds: [B:13:0x0073, B:16:0x007a] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public boolean drawBlurPass() {
        ...
        if (blurType == 1) {
            ...
            GLES20.glUniform2f(this.radialBlurExcludePointHandle, blurExcludePoint.f2016x, blurExcludePoint.f2017y);
            ...
            GLES20.glUniform2f(this.linearBlurExcludePointHandle, blurExcludePoint2.f2016x, blurExcludePoint2.f2017y);
