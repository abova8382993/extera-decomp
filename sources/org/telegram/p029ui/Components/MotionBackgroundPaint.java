        ...
        if (this.gradientShader.setup(bitmap) | z2 | this.patternShader.setup(bitmap2)) {
            if (i3 >= 0) {
                if (Build.VERSION.SDK_INT >= 29) {
                    ...
                    MotionBackgroundPaint$$ExternalSyntheticApiModelOutline1.m1260m();
                    paint.setShader(MotionBackgroundPaint$$ExternalSyntheticApiModelOutline0.m1259m(this.gradientShader.shader, new ComposeShader(this.colorShader, this.patternShader.shader, PorterDuff.Mode.DST_IN), BlendMode.SOFT_LIGHT));
                } else {
