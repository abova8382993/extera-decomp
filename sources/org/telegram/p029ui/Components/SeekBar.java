...
public class SeekBar {
    ...
    private int lineHeight = AndroidUtilities.m1124dp(2.0f);
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.currentRadius != fM1124dp) {
            ...
            if (f3 < fM1124dp) {
                float fM1124dp2 = f3 + (AndroidUtilities.m1124dp(1.0f) * (jElapsedRealtime / 60.0f));
                this.currentRadius = fM1124dp2;
                if (fM1124dp2 > fM1124dp) {
                    this.currentRadius = fM1124dp;
                }
            } else {
                float fM1124dp3 = f3 - (AndroidUtilities.m1124dp(1.0f) * (jElapsedRealtime / 60.0f));
    ...
    /* JADX WARN: Removed duplicated region for block: B:92:0x01db A[EDGE_INSN: B:92:0x01db->B:83:0x01db BREAK  A[LOOP:2: B:29:0x00a5->B:82:0x01d1], SYNTHETIC] */
    ...
    */
    private void drawProgressBar(android.graphics.Canvas r26, android.graphics.RectF r27, android.graphics.Paint r28) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.SeekBar.drawProgressBar(android.graphics.Canvas, android.graphics.RectF, android.graphics.Paint):void");
    }
    ...
    private void updateTimestampAnimation() {
        ...
        int i = thumbWidth;
        this.lastWidth = Math.abs((i / 2.0f) - (this.width - (i / 2.0f))) - AndroidUtilities.m1124dp(66.0f);
