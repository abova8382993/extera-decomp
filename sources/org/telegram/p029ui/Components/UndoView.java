...
public class UndoView extends FrameLayout {
    ...
    public UndoView(Context context, BaseFragment baseFragment, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.enterOffsetMargin = AndroidUtilities.m1124dp(8.0f);
        ...
        this.undoButton.setBackground(Theme.createRadSelectorDrawable(getThemedColor(i2) & 587202559, AndroidUtilities.m1124dp(2.0f), AndroidUtilities.m1124dp(2.0f)));
        ...
        this.rect = new RectF(AndroidUtilities.m1124dp(15.0f), AndroidUtilities.m1124dp(15.0f), AndroidUtilities.m1124dp(33.0f), AndroidUtilities.m1124dp(33.0f));
        ...
        this.backgroundDrawable = Theme.createRoundRectDrawable(AndroidUtilities.m1124dp(10.0f), getThemedColor(i3));
    ...
    /* JADX WARN: Removed duplicated region for block: B:477:0x0f73  */
    /* JADX WARN: Removed duplicated region for block: B:478:0x0f7f  */
    /* JADX WARN: Removed duplicated region for block: B:659:0x1863  */
    /* JADX WARN: Removed duplicated region for block: B:662:0x1883  */
    /* JADX WARN: Removed duplicated region for block: B:665:0x18aa  */
    /* JADX WARN: Removed duplicated region for block: B:669:0x18ef  */
    /* JADX WARN: Removed duplicated region for block: B:700:0x19a0  */
    ...
    */
    public void showWithAction(java.util.ArrayList r30, int r31, java.lang.Object r32, java.lang.Object r33, java.lang.Runnable r34, java.lang.Runnable r35) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.UndoView.showWithAction(java.util.ArrayList, int, java.lang.Object, java.lang.Object, java.lang.Runnable, java.lang.Runnable):void");
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        if (this.additionalTranslationY != 0.0f) {
            canvas.save();
            float measuredHeight = (getMeasuredHeight() - this.enterOffset) + AndroidUtilities.m1124dp(9.0f);
    ...
    protected void onDraw(Canvas canvas) {
        if (this.additionalTranslationY != 0.0f) {
            canvas.save();
            float measuredHeight = (getMeasuredHeight() - this.enterOffset) + this.enterOffsetMargin + AndroidUtilities.m1124dp(1.0f);
            if (measuredHeight > 0.0f) {
                canvas.clipRect(0.0f, 0.0f, getMeasuredWidth(), measuredHeight);
                super.dispatchDraw(canvas);
            }
        ...
        if (i == 1 || i == 95 || i == 0 || i == 27 || i == 26 || i == 81 || i == 88) {
            ...
            if (this.timeLayoutOut != null) {
                ...
                if (f3 < 1.0f) {
                    ...
                    canvas.save();
                    canvas.translate(this.rect.centerX() - (this.textWidth / 2), AndroidUtilities.m1124dp(17.2f) + (AndroidUtilities.m1124dp(10.0f) * this.timeReplaceProgress));
            ...
            if (this.timeLayout != null) {
                ...
                canvas.save();
                canvas.translate(this.rect.centerX() - (this.textWidth / 2), AndroidUtilities.m1124dp(17.2f) - (AndroidUtilities.m1124dp(10.0f) * (1.0f - this.timeReplaceProgress)));
    ...
    private void updatePosition() {
        setTranslationY(((this.enterOffset - this.enterOffsetMargin) + AndroidUtilities.m1124dp(8.0f)) - this.additionalTranslationY);
        invalidate();
    }
