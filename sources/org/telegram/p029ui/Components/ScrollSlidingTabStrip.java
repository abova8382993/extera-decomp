...
public abstract class ScrollSlidingTabStrip extends HorizontalScrollView {
    ...
    public ScrollSlidingTabStrip(Context context, Theme.ResourcesProvider resourcesProvider, boolean z) {
        ...
        this.scrollOffset = AndroidUtilities.m1124dp(33.0f);
        this.underlineHeight = AndroidUtilities.m1124dp(2.0f);
        this.dividerPadding = AndroidUtilities.m1124dp(12.0f);
        this.tabPadding = AndroidUtilities.m1124dp(24.0f);
        this.lastScrollX = 0;
        ...
        this.expanded = false;
        this.stickerTabExpandedWidth = AndroidUtilities.m1124dp(EXPANDED_WIDTH);
        this.stickerTabWidth = AndroidUtilities.m1124dp(33.0f);
  ...
  0x0021: PHI (r0v13 int) = (r0v5 int), (r0v8 int), (r0v16 int) binds: [B:14:0x0049, B:11:0x0038, B:5:0x001f] A[DONT_GENERATE, DONT_INLINE]] */
            ...
            */
            public void run() {
                /*
                    ...
                    org.telegram.ui.Components.ScrollSlidingTabStrip r2 = org.telegram.p029ui.Components.ScrollSlidingTabStrip.this
                    ...
                    org.telegram.ui.Components.ScrollSlidingTabStrip r1 = org.telegram.p029ui.Components.ScrollSlidingTabStrip.this
                ...
                L4c:
                    ...
                    r2 = 0
                    r1.scrollBy(r0, r2)
                    org.telegram.ui.Components.ScrollSlidingTabStrip r0 = org.telegram.p029ui.Components.ScrollSlidingTabStrip.this
                    java.lang.Runnable r0 = r0.scrollRunnable
                    org.telegram.messenger.AndroidUtilities.runOnUIThread(r0)
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.ScrollSlidingTabStrip.RunnableC49516.run():void");
            }
        };
        ...
        this.tabsContainer.setPadding(AndroidUtilities.m1124dp(9.5f), 0, AndroidUtilities.m1124dp(9.5f), 0);
        addView(this.tabsContainer, new FrameLayout.LayoutParams(-1, -1, 16));
        Paint paint = new Paint();
        this.rectPaint = paint;
        paint.setAntiAlias(true);
        this.rectPaint.setStyle(Paint.Style.FILL);
        this.defaultTabLayoutParams = new LinearLayout.LayoutParams(AndroidUtilities.m1124dp(33.0f), -1);
    ...
    public void beginUpdate(boolean z) {
        ...
        if (z) {
            ...
            autoTransition.addTransition(new C49483());
    ...
    class C49483 extends Transition {
    ...
    public FrameLayout addIconTab(int i, Drawable drawable) {
        ...
        frameLayout.setTag(C2888R.id.index_tag, Integer.valueOf(i2));
    ...
    public /* synthetic */ void lambda$addIconTab$0(View view) {
        this.delegate.onPageSelected(((Integer) view.getTag(C2888R.id.index_tag)).intValue());
    }
    ...
    public StickerTabView addStickerIconTab(int i, Drawable drawable) {
        ...
        stickerTabView.setTag(C2888R.id.index_tag, Integer.valueOf(i2));
    ...
    public void addStickerTab(TLRPC.Chat chat) {
        ...
        if (stickerTabView != null) {
            ...
            avatarDrawable.setTextSize(AndroidUtilities.m1124dp(14.0f));
        ...
        stickerTabView.setTag(C2888R.id.index_tag, Integer.valueOf(i));
    ...
    public View addEmojiTab(int i, Emoji.EmojiDrawable emojiDrawable, TLRPC.Document document) {
        ...
        stickerTabView.isChatSticker = false;
        stickerTabView.setTag(C2888R.id.index_tag, Integer.valueOf(i2));
        stickerTabView.setTag(C2888R.id.parent_tag, emojiDrawable);
        stickerTabView.setTag(C2888R.id.object_tag, document);
        stickerTabView.setSelected(i2 == this.currentPosition);
        this.tabTypes.put(str, stickerTabView);
        return stickerTabView;
    }
    ...
    public View addStickerTab(TLObject tLObject, TLRPC.Document document, TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        ...
        sb.append("set");
        sb.append(tL_messages_stickerSet == null ? document.f1668id : tL_messages_stickerSet.set.f1696id);
        ...
        stickerTabView.setTag(C2888R.id.index_tag, Integer.valueOf(i));
        stickerTabView.setTag(C2888R.id.parent_tag, tL_messages_stickerSet);
        stickerTabView.setTag(C2888R.id.object_tag, document);
        stickerTabView.setSelected(i == this.currentPosition);
        ...
        if (this.expanded != z) {
            ...
            this.expandStickerAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.ScrollSlidingTabStrip.4
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    for (int i2 = 0; i2 < ScrollSlidingTabStrip.this.tabsContainer.getChildCount(); i2++) {
                        ...
                        childAt.getLayoutParams().width = AndroidUtilities.m1124dp(33.0f);
                    }
                    ScrollSlidingTabStrip scrollSlidingTabStrip2 = ScrollSlidingTabStrip.this;
                    scrollSlidingTabStrip2.animateToExpanded = false;
                    scrollSlidingTabStrip2.getLayoutParams().height = AndroidUtilities.m1124dp(36.0f);
            ...
            if (z) {
                ...
                for (int i = 0; i < this.tabsContainer.getChildCount(); i++) {
                    ...
                    childAt.getLayoutParams().width = AndroidUtilities.m1124dp(EXPANDED_WIDTH);
                }
                this.tabsContainer.requestLayout();
                getLayoutParams().height = AndroidUtilities.m1124dp(86.0f);
            }
            if (z) {
    ...
    public float getExpandedOffset() {
        if (this.animateToExpanded) {
            return AndroidUtilities.m1124dp(50.0f) * this.expandProgress;
        }
        return 0.0f;
    }
    ...
    */
    public void setImages() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.ScrollSlidingTabStrip.setImages():void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public int getTabSize() {
        return AndroidUtilities.m1124dp(this.animateToExpanded ? EXPANDED_WIDTH : 33.0f);
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (this.animateToExpanded) {
            height = getHeight() - (AndroidUtilities.m1124dp(50.0f) * (1.0f - this.expandProgress));
        }
        float f3 = height;
        ...
        if (isInEditMode() || this.tabCount == 0 || this.indicatorHeight < 0) {
            ...
            if (childAt2 != null && childAt != null) {
                float f7 = f5 - iFloor;
                float fLerp = AndroidUtilities.lerp(childAt2.getLeft() + childAt2.getTranslationX() + (AndroidUtilities.lerp(AndroidUtilities.m1124dp(33.0f), AndroidUtilities.m1124dp(EXPANDED_WIDTH), this.expandProgress) / 2.0f), childAt.getLeft() + childAt.getTranslationX() + (AndroidUtilities.lerp(AndroidUtilities.m1124dp(33.0f), AndroidUtilities.m1124dp(EXPANDED_WIDTH), this.expandProgress) / 2.0f), f7);
                ...
                left = childAt2.getLeft() + childAt2.getTranslationX() + (AndroidUtilities.lerp(AndroidUtilities.m1124dp(33.0f), AndroidUtilities.m1124dp(EXPANDED_WIDTH), this.expandProgress) / 2.0f);
                textWidth = childAt2 instanceof StickerTabView ? ((StickerTabView) childAt2).getTextWidth() : 0.0f;
            } else if (childAt != null) {
                left = childAt.getLeft() + childAt.getTranslationX() + (AndroidUtilities.lerp(AndroidUtilities.m1124dp(33.0f), AndroidUtilities.m1124dp(EXPANDED_WIDTH), this.expandProgress) / 2.0f);
                if (childAt instanceof StickerTabView) {
            ...
            float fAbs = (1.25f - ((Math.abs(0.5f - this.currentPositionAnimated.getTransitionProgressInterpolated()) * 0.25f) * 2.0f)) * fM1124dp;
            float fAbs2 = fM1124dp * ((Math.abs(0.5f - this.currentPositionAnimated.getTransitionProgressInterpolated()) * 0.1f * 2.0f) + 0.9f);
            float interpolation = CubicBezierInterpolator.EASE_IN.getInterpolation(this.expandProgress);
            float fLerp2 = f6 + AndroidUtilities.lerp(0, AndroidUtilities.m1124dp(26.0f), interpolation);
            float fLerp3 = AndroidUtilities.lerp(fAbs, textWidth + AndroidUtilities.m1124dp(10.0f), interpolation) / 2.0f;
            ...
            if (this.draggingView != null) {
                ...
                if (i3 != i4) {
                    ...
                    for (int i5 = 0; i5 < this.tabsContainer.getChildCount(); i5++) {
                        this.tabsContainer.getChildAt(i5).setTag(C2888R.id.index_tag, Integer.valueOf(i5));
                    }
                }
                ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
