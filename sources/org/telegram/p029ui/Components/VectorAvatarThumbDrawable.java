...
public class VectorAvatarThumbDrawable extends Drawable implements AnimatedEmojiSpan.InvalidateHolder, AttachableDrawable, NotificationCenter.NotificationCenterDelegate {
    ...
    public VectorAvatarThumbDrawable(TLRPC.VideoSize videoSize, boolean z, int i) {
        ...
        if (videoSize instanceof TLRPC.TL_videoSizeStickerMarkup) {
            ...
            C53171 c53171 = new ImageReceiver() { // from class: org.telegram.ui.Components.VectorAvatarThumbDrawable.1
                C53171() {
                }
            ...
            this.imageReceiver = c53171;
            c53171.setInvalidateAll(true);
            if (i == 1) {
    ...
    class C53171 extends ImageReceiver {
        C53171() {
        }
    ...
    */
    private void setImage() {
        ...
        L4f:
            ...
            r4 = r2
        L52:
            int r1 = org.telegram.p029ui.ActionBar.Theme.key_windowBackgroundWhiteGrayIcon
        ...
        L8f:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.VectorAvatarThumbDrawable.setImage():void");
    }
        ...
        if (obj != null && getClass() == obj.getClass()) {
            ...
            if (this.type == vectorAvatarThumbDrawable.type) {
                ...
                if (i == gradientTools2.color1 && gradientTools.color2 == gradientTools2.color2 && gradientTools.color3 == gradientTools2.color3 && gradientTools.color4 == gradientTools2.color4) {
                    ...
                    if (tL_videoSizeStickerMarkup2 != null && (tL_videoSizeStickerMarkup = vectorAvatarThumbDrawable.sizeStickerMarkup) != null && tL_videoSizeStickerMarkup2.stickerset.f1685id == tL_videoSizeStickerMarkup.stickerset.f1685id && tL_videoSizeStickerMarkup2.sticker_id == tL_videoSizeStickerMarkup.sticker_id) {
                        return true;
                    }
                }
            }
