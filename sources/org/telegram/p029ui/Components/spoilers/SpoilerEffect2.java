package org.telegram.p029ui.Components.spoilers;
...
public class SpoilerEffect2 {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.spoilers.SpoilerEffect2$1 */
    /* JADX INFO: loaded from: classes7.dex */
    class C53681 extends FrameLayout {
        @Override // android.view.ViewGroup
        protected boolean drawChild(Canvas canvas, View view, long j) {
            return false;
        }

        C53681(Context context) {
            super(context);
        }
    }

    private static FrameLayout makeTextureViewContainer(ViewGroup viewGroup) {
        C53681 c53681 = new FrameLayout(viewGroup.getContext()) { // from class: org.telegram.ui.Components.spoilers.SpoilerEffect2.1
            @Override // android.view.ViewGroup
            protected boolean drawChild(Canvas canvas, View view, long j) {
                return false;
            }
    ...
    private SpoilerEffect2(int i, ViewGroup viewGroup, int i2, int i3) {
        ...
        C53692 c53692 = new TextureView(viewGroup.getContext()) { // from class: org.telegram.ui.Components.spoilers.SpoilerEffect2.2
            C53692(Context context) {
                super(context);
            }
        ...
        this.textureView = c53692;
        c53692.setSurfaceTextureListener(new TextureView.SurfaceTextureListener() { // from class: org.telegram.ui.Components.spoilers.SpoilerEffect2.3
            @Override // android.view.TextureView.SurfaceTextureListener
            public void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
            }

            TextureViewSurfaceTextureListenerC53703() {
            }
        ...
        c53692.setOpaque(false);
        viewGroup.addView(c53692);
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.spoilers.SpoilerEffect2$2 */
    /* JADX INFO: loaded from: classes7.dex */
    class C53692 extends TextureView {
        C53692(Context context) {
            super(context);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.spoilers.SpoilerEffect2$3 */
    /* JADX INFO: loaded from: classes7.dex */
    class TextureViewSurfaceTextureListenerC53703 implements TextureView.SurfaceTextureListener {
        @Override // android.view.TextureView.SurfaceTextureListener
        public void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
        }
    ...
    private class SpoilerThread extends Thread {
        ...
        private void init() {
            ...
            GLES20.glShaderSource(iGlCreateShader, AndroidUtilities.readRes(C2888R.raw.spoiler_vertex) + "\n// " + Math.random());
            GLES20.glCompileShader(iGlCreateShader);
            int[] iArr = new int[1];
            GLES20.glGetShaderiv(iGlCreateShader, 35713, iArr, 0);
            if (iArr[0] == 0) {
                FileLog.m1134e("SpoilerEffect2, compile vertex shader error: " + GLES20.glGetShaderInfoLog(iGlCreateShader));
                GLES20.glDeleteShader(iGlCreateShader);
                this.running = false;
                return;
            }
            GLES20.glShaderSource(iGlCreateShader2, AndroidUtilities.readRes(C2888R.raw.spoiler_fragment) + "\n// " + Math.random());
            GLES20.glCompileShader(iGlCreateShader2);
            GLES20.glGetShaderiv(iGlCreateShader2, 35713, iArr, 0);
            if (iArr[0] == 0) {
                FileLog.m1134e("SpoilerEffect2, compile fragment shader error: " + GLES20.glGetShaderInfoLog(iGlCreateShader2));
            ...
            if (iArr[0] == 0) {
                FileLog.m1134e("SpoilerEffect2, link draw program error: " + GLES20.glGetProgramInfoLog(this.drawProgram));
                this.running = false;
                return;
            }
        ...
        private void drawFrame(float f) {
            ...
            GLES20.glVertexAttribPointer(3, 1, 5126, false, 24, 20);
            GLES20.glEnableVertexAttribArray(3);
            GLES20.glUniform1f(this.timeHandle, this.f2112t);
        ...
        private void checkGlErrors() {
            while (true) {
                ...
                FileLog.m1134e("spoiler gles error " + iGlGetError);
            }
        }
    }
}
