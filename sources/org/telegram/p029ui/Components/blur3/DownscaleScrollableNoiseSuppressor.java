...
public class DownscaleScrollableNoiseSuppressor {
    ...
    public DownscaleScrollableNoiseSuppressor(boolean z, boolean z2) {
        ...
        while (true) {
            ...
            renderNodeArr[i] = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1129m(null);
            i++;
        }
    }
    ...
    */
    public void drawInline(android.graphics.Canvas r7, int r8) {
        ...
        L54:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.blur3.DownscaleScrollableNoiseSuppressor.drawInline(android.graphics.Canvas, int):void");
    }
    ...
    public class DownscaledRenderNode {
        ...
        public DownscaledRenderNode(String str, int i, boolean z) {
            this.renderNodeOriginalWithOffset = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1129m(null);
            int i2 = i + 1;
            ...
            for (int i3 = 0; i3 < i2; i3++) {
                ...
                renderNodeArr[i3] = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1129m(str + "_down_" + i);
            }
            if (i > 0 || z) {
                this.renderNodeRestored = new RenderNode[i2];
                for (int i4 = 0; i4 < i2; i4++) {
                    this.renderNodeRestored[i4] = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1129m(null);
                }
            } else {
        ...
        public void invalidateRenderNodes(RenderNode renderNode) {
            ...
            float f = width;
            int iRound = Math.round((DownscaleScrollableNoiseSuppressor.this.f2109k * f) / this.scaleX);
            float f2 = height;
            int iRound2 = Math.round((DownscaleScrollableNoiseSuppressor.this.f2109k * f2) / this.scaleY);
            float f3 = iRound;
            float f4 = f3 / f;
            float f5 = iRound2;
            float f6 = f5 / f2;
            float f7 = (f * DownscaleScrollableNoiseSuppressor.this.f2109k) / f3;
            float f8 = (f2 * DownscaleScrollableNoiseSuppressor.this.f2109k) / f5;
    ...
    private class SourcePart {
        ...
        private SourcePart() {
            this.renderNode = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1129m(null);
    ...
    private RecordingCanvas beginRecordingRect(int i) {
        ...
        int iWidth = rect.width() / this.f2109k;
        int iHeight = rect.height() / this.f2109k;
