...
public class LiquidGlassEffect {
    ...
    public LiquidGlassEffect(RenderNode renderNode) {
        ...
        RuntimeShader runtimeShaderM1278m = LiquidGlassEffect$$ExternalSyntheticApiModelOutline0.m1278m(AndroidUtilities.readRes(C2888R.raw.liquid_glass_shader));
        this.shader = runtimeShaderM1278m;
        RenderEffect renderEffectCreateRuntimeShaderEffect = RenderEffect.createRuntimeShaderEffect(runtimeShaderM1278m, "img");
