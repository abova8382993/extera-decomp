...
public class CubicBezierInterpolator implements Interpolator {
    ...
    protected PointF f1951a;

    /* JADX INFO: renamed from: b */
    protected PointF f1952b;

    /* JADX INFO: renamed from: c */
    protected PointF f1953c;
    ...
    public CubicBezierInterpolator(PointF pointF, PointF pointF2) {
        this.f1951a = new PointF();
        this.f1952b = new PointF();
        this.f1953c = new PointF();
        float f = pointF.x;
        if (f < 0.0f || f > 1.0f) {
    ...
    protected float getBezierCoordinateY(float f) {
        PointF pointF = this.f1953c;
        PointF pointF2 = this.start;
        float f2 = pointF2.y * 3.0f;
        pointF.y = f2;
        PointF pointF3 = this.f1952b;
        float f3 = ((this.end.y - pointF2.y) * 3.0f) - f2;
        pointF3.y = f3;
        PointF pointF4 = this.f1951a;
    ...
    private float getXDerivate(float f) {
        return this.f1953c.x + (f * ((this.f1952b.x * 2.0f) + (this.f1951a.x * 3.0f * f)));
    }
