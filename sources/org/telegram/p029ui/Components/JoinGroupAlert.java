...
public class JoinGroupAlert extends BottomSheet {
    ...
    public JoinGroupAlert(Context context, TLObject tLObject, String str, BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider, final int i) {
        ...
        imageView.setImageResource(C2888R.drawable.ic_layer_close);
        ...
        if (chatInvite != null) {
            ...
            TLRPC.ChatFull chatFull = MessagesController.getInstance(this.currentAccount).getChatFull(this.currentChat.f1660id);
        ...
        if (chatInvite6 == null || chatInvite6.request_needed) {
            ...
            this.requestProgressView.setSize(AndroidUtilities.m1124dp(32.0f));
            ...
            textView3.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1124dp(8.0f), getThemedColor(i4), getThemedColor(Theme.key_featuredStickers_addButtonPressed)));
            this.requestTextView.setEllipsize(truncateAt);
            this.requestTextView.setGravity(17);
            this.requestTextView.setSingleLine(true);
            this.requestTextView.setText(LocaleController.getString(z6 ? C2888R.string.RequestToJoinChannel : C2888R.string.RequestToJoinGroup));
            ...
            textView4.setText(LocaleController.getString(z6 ? C2888R.string.RequestToJoinChannelDescription : C2888R.string.RequestToJoinGroupDescription));
        ...
        if (!chatInvite6.participants.isEmpty()) {
            ...
            avatarsImageView.setAvatarsTextSize(AndroidUtilities.m1124dp(20.0f));
            float f = 38;
            avatarsImageView.setSize(AndroidUtilities.m1124dp(f));
            ...
            if (iMin == 1) {
                ...
                string = LocaleController.formatString("RequestToJoinMembersTwo", C2888R.string.RequestToJoinMembersTwo, ellipsize(textView5, this.chatInvite, 0), ellipsize(textView5, this.chatInvite, 1));
            } else if (iMax == 3) {
                string = LocaleController.formatString("RequestToJoinMembersThree", C2888R.string.RequestToJoinMembersThree, ellipsize(textView5, this.chatInvite, 0), ellipsize(textView5, this.chatInvite, 1), ellipsize(textView5, this.chatInvite, 2));
            } else {
        ...
        textView6.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1124dp(24.0f), getThemedColor(Theme.key_featuredStickers_addButton), getThemedColor(Theme.key_featuredStickers_addButtonPressed)));
        ScaleStateListAnimator.apply(textView6, 0.02f, 1.2f);
        textView6.setEllipsize(TextUtils.TruncateAt.END);
        textView6.setGravity(17);
        textView6.setSingleLine(true);
        textView6.setText(LocaleController.getString(z4 ? C2888R.string.ProfileJoinChannel : C2888R.string.ProfileJoinGroup));
    ...
    public /* synthetic */ void lambda$new$7(final boolean z, View view) {
        ...
        if (this.chatInvite == null && this.currentChat != null) {
            MessagesController.getInstance(this.currentAccount).addUserToChat(this.currentChat.f1660id, UserConfig.getInstance(this.currentAccount).getCurrentUser(), 0, null, null, true, new Runnable() { // from class: org.telegram.ui.Components.JoinGroupAlert$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public static void showBulletin(Context context, BaseFragment baseFragment, boolean z) {
        ...
        twoLineLottieLayout.imageView.setAnimation(C2888R.raw.timer_3, 28, 28);
        twoLineLottieLayout.titleTextView.setText(LocaleController.getString(C2888R.string.RequestToJoinSent));
        if (z) {
            string = LocaleController.getString(C2888R.string.RequestToJoinChannelSentDescription);
        } else {
            string = LocaleController.getString(C2888R.string.RequestToJoinGroupSentDescription);
        }
    ...
    private CharSequence ellipsize(TextView textView, TLRPC.ChatInvite chatInvite, int i) {
        ...
        return TextUtils.ellipsize(str.trim(), textView.getPaint(), AndroidUtilities.m1124dp(120.0f), TextUtils.TruncateAt.END);
    }
    ...
    private void openChat(long j, boolean z) {
        ...
        if (MessagesController.getInstance(this.currentAccount).checkCanOpenChat(bundle, this.fragment)) {
            C45261 c45261 = new C45261(bundle, z, j);
            BaseFragment baseFragment = this.fragment;
            baseFragment.presentFragment(c45261, baseFragment instanceof ChatActivity);
        }
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.JoinGroupAlert$1 */
    class C45261 extends ChatActivity {
        private boolean shownToast;
        final /* synthetic */ long val$chatId;
        final /* synthetic */ boolean val$showJoined;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C45261(Bundle bundle, boolean z, long j) {
            super(bundle);
        ...
        public void onBecomeFullyVisible() {
            ...
            if (ChatObject.canManageMyTag(chat)) {
                ...
                String string = LocaleController.getString(C2888R.string.JoinedGroup);
                String string2 = LocaleController.getString(C2888R.string.JoinedGroupAddTag);
                final long j = this.val$chatId;
                bulletinFactoryM1246of.createSimpleBulletin(i, string, string2, new Runnable() { // from class: org.telegram.ui.Components.JoinGroupAlert$1$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
            ...
            BulletinFactory.m1246of(this).createSimpleBulletin(C2888R.raw.contact_check, LocaleController.getString(C2888R.string.JoinedGroup)).hideAfterBottomSheet(false).show(true);
        }
