...
public class MessagePrivateSeenView extends FrameLayout {
    ...
    public MessagePrivateSeenView(Context context, int i, MessageObject messageObject, Runnable runnable, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (i == 1) {
            i2 = C2888R.drawable.menu_edited_stamp;
        } else if (i == 2) {
            i2 = C2888R.drawable.menu_forward_stamp;
        } else if (messageObject.isVoice()) {
            i2 = C2888R.drawable.msg_played;
        } else {
            i2 = C2888R.drawable.msg_seen;
        }
        ...
        spannableStringBuilder.setSpan(new LoadingSpan(textView, AndroidUtilities.m1124dp(96.0f), AndroidUtilities.m1124dp(2.0f), resourcesProvider), 0, spannableStringBuilder.length() - 1, 17);
        ...
        textView3.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1124dp(20.0f), Theme.multAlpha(Theme.getColor(Theme.key_divider, resourcesProvider), 0.75f)));
        textView3.setTextColor(Theme.getColor(i4, resourcesProvider));
        textView3.setTextSize(1, 11.0f);
        textView3.setPadding(AndroidUtilities.m1124dp(5.33f), AndroidUtilities.m1124dp(2.0f), AndroidUtilities.m1124dp(5.33f), AndroidUtilities.m1124dp(2.33f));
    ...
    public /* synthetic */ void lambda$request$1(TLRPC.TL_error tL_error, TLObject tLObject) {
        if (tL_error != null) {
            if ("USER_PRIVACY_RESTRICTED".equals(tL_error.text)) {
                this.valueTextView.setText(LocaleController.getString(C2888R.string.PmReadUnknown));
                this.premiumTextView.setVisibility(8);
            } else if ("YOUR_PRIVACY_RESTRICTED".equals(tL_error.text)) {
                this.isPremiumLocked = true;
                this.valueTextView.setText(LocaleController.getString(C2888R.string.PmRead));
                this.premiumTextView.setText(LocaleController.getString(C2888R.string.PmReadShowWhen));
            } else {
                this.valueTextView.setText(LocaleController.getString("UnknownError"));
                this.premiumTextView.setVisibility(8);
                BulletinFactory.m1245of(Bulletin.BulletinWindow.make(getContext()), this.resourcesProvider).showForError(tL_error);
            }
    ...
    public static void showSheet(final Context context, final int i, long j, final boolean z, final Runnable runnable, final Runnable runnable2, final Theme.ResourcesProvider resourcesProvider) {
        ...
        linearLayout.setPadding(AndroidUtilities.m1124dp(16.0f), 0, AndroidUtilities.m1124dp(16.0f), 0);
        RLottieImageView rLottieImageView = new RLottieImageView(context);
        rLottieImageView.setScaleType(ImageView.ScaleType.CENTER);
        rLottieImageView.setAnimation(z ? C2888R.raw.large_lastseen : C2888R.raw.large_readtime, 70, 70);
        ...
        textView.setText(LocaleController.getString(z ? C2888R.string.PremiumLastSeenHeader1 : C2888R.string.PremiumReadHeader1));
        ...
        if (z) {
            i2 = zPremiumFeaturesBlocked ? C2888R.string.PremiumLastSeenText1Locked : C2888R.string.PremiumLastSeenText1;
        } else {
            i2 = zPremiumFeaturesBlocked ? C2888R.string.PremiumReadText1Locked : C2888R.string.PremiumReadText1;
        }
        ...
        round.setText(LocaleController.getString(z ? C2888R.string.PremiumLastSeenButton1 : C2888R.string.PremiumReadButton1), false);
        ...
        round.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.MessagePrivateSeenView$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                MessagePrivateSeenView.m10885$r8$lambda$1onCj4pvO6L8Hb9bbMPAmbQKA4(round, z, i, bottomSheet, runnable2, context, resourcesProvider, view);
            }
        });
        if (!zPremiumFeaturesBlocked) {
            SimpleTextView simpleTextView = new SimpleTextView(context) { // from class: org.telegram.ui.Components.MessagePrivateSeenView.1
                ...
                protected void dispatchDraw(Canvas canvas) {
                    ...
                    canvas.drawLine(0.0f, height, ((getWidth() / 2.0f) - (getTextWidth() / 2.0f)) - AndroidUtilities.m1124dp(8.0f), height, this.paint);
                    canvas.drawLine((getWidth() / 2.0f) + (getTextWidth() / 2.0f) + AndroidUtilities.m1124dp(8.0f), height, getWidth(), height, this.paint);
            ...
            simpleTextView.setText(" " + LocaleController.getString(C2888R.string.PremiumOr) + " ");
            ...
            textView3.setText(LocaleController.getString(z ? C2888R.string.PremiumLastSeenHeader2 : C2888R.string.PremiumReadHeader2));
            ...
            textView4.setText(AndroidUtilities.replaceTags(LocaleController.formatString(z ? C2888R.string.PremiumLastSeenText2 : C2888R.string.PremiumReadText2, str)));
            ...
            premiumButtonView.setOverlayText(LocaleController.getString(z ? C2888R.string.PremiumLastSeenButton2 : C2888R.string.PremiumReadButton2), false, false);
    ...
    public static /* synthetic */ void m10885$r8$lambda$1onCj4pvO6L8Hb9bbMPAmbQKA4(final ButtonWithCounterView buttonWithCounterView, boolean z, int i, final BottomSheet bottomSheet, final Runnable runnable, final Context context, final Theme.ResourcesProvider resourcesProvider, View view) {
            ...
            ConnectionsManager.getInstance(i).sendRequest(setprivacy, new RequestDelegate() { // from class: org.telegram.ui.Components.MessagePrivateSeenView$$ExternalSyntheticLambda2
                ...
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.MessagePrivateSeenView$$ExternalSyntheticLambda6
                        @Override // java.lang.Runnable
                        public final void run() {
                            MessagePrivateSeenView.m10887$r8$lambda$guwLb45BisSIq2eY_xOdk0X5nY(tL_error, buttonWithCounterView, bottomSheet, runnable);
                        }
                    });
                }
            });
        ...
        ConnectionsManager.getInstance(i).sendRequest(setglobalprivacysettings, new RequestDelegate() { // from class: org.telegram.ui.Components.MessagePrivateSeenView$$ExternalSyntheticLambda3
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.MessagePrivateSeenView$$ExternalSyntheticLambda4
                    @Override // java.lang.Runnable
                    public final void run() {
                        MessagePrivateSeenView.m10889$r8$lambda$mFKiuqa7A9qEAjUuAbSEUUzIag(tL_error, context, resourcesProvider, buttonWithCounterView, bottomSheet, runnable);
                    }
                });
            }
        });
    ...
    public static /* synthetic */ void m10887$r8$lambda$guwLb45BisSIq2eY_xOdk0X5nY(TLRPC.TL_error tL_error, ButtonWithCounterView buttonWithCounterView, BottomSheet bottomSheet, Runnable runnable) {
        if (tL_error != null) {
        ...
        BulletinFactory.global().createSimpleBulletin(C2888R.raw.chats_infotip, LocaleController.getString(C2888R.string.PremiumLastSeenSet)).show();
        if (runnable != null) {
            runnable.run();
        }
    }
    ...
    public static /* synthetic */ void m10889$r8$lambda$mFKiuqa7A9qEAjUuAbSEUUzIag(TLRPC.TL_error tL_error, Context context, Theme.ResourcesProvider resourcesProvider, ButtonWithCounterView buttonWithCounterView, BottomSheet bottomSheet, Runnable runnable) {
        if (tL_error != null) {
            BulletinFactory.m1245of(Bulletin.BulletinWindow.make(context), resourcesProvider).showForError(tL_error);
            return;
        }
        buttonWithCounterView.setLoading(false);
        bottomSheet.lambda$new$0();
        BulletinFactory.m1245of(Bulletin.BulletinWindow.make(context), resourcesProvider).createSimpleBulletin(C2888R.raw.chats_infotip, LocaleController.getString(C2888R.string.PremiumReadSet)).show();
        if (runnable != null) {
            runnable.run();
        }
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.minWidth < 0.0f) {
            ...
            if (this.type == 0) {
                ...
                float fMax = Math.max(this.minWidth, AndroidUtilities.m1124dp(144.0f));
                this.minWidth = fMax;
                float fMax2 = Math.max(fMax, AndroidUtilities.m1124dp(48.0f) + this.valueTextView.getPaint().measureText(LocaleController.getString(C2888R.string.PmReadUnknown)));
                this.minWidth = fMax2;
                float fMax3 = Math.max(fMax2, AndroidUtilities.m1124dp(64.0f) + this.valueTextView.getPaint().measureText(LocaleController.getString(C2888R.string.PmRead) + this.premiumTextView.getPaint().measureText(LocaleController.getString(C2888R.string.PmReadShowWhen))));
                this.minWidth = fMax3;
                float fMax4 = Math.max(fMax3, ((float) AndroidUtilities.m1124dp(48.0f)) + this.valueTextView.getPaint().measureText(LocaleController.formatString(C2888R.string.PmReadTodayAt, LocaleController.getInstance().getFormatterDay().format(new Date(jCurrentTimeMillis)))));
                this.minWidth = fMax4;
                if (this.messageDiff > 86400) {
                    this.minWidth = Math.max(fMax4, AndroidUtilities.m1124dp(48.0f) + this.valueTextView.getPaint().measureText(LocaleController.formatString(C2888R.string.PmReadYesterdayAt, LocaleController.getInstance().getFormatterDay().format(new Date(jCurrentTimeMillis)))));
                }
                if (this.messageDiff > 172800) {
                    float fMax5 = Math.max(this.minWidth, AndroidUtilities.m1124dp(48.0f) + this.valueTextView.getPaint().measureText(LocaleController.formatString(C2888R.string.PmReadDateTimeAt, LocaleController.getInstance().getFormatterDayMonth().format(new Date(jCurrentTimeMillis)), LocaleController.getInstance().getFormatterDay().format(new Date(jCurrentTimeMillis)))));
                    this.minWidth = fMax5;
                    this.minWidth = Math.max(fMax5, AndroidUtilities.m1124dp(48.0f) + this.valueTextView.getPaint().measureText(LocaleController.formatString(C2888R.string.PmReadDateTimeAt, LocaleController.getInstance().getFormatterYear().format(new Date(jCurrentTimeMillis)), LocaleController.getInstance().getFormatterDay().format(new Date(jCurrentTimeMillis)))));
                }
            } else {
                this.minWidth = AndroidUtilities.m1124dp(48.0f) + this.valueTextView.getPaint().measureText(this.valueTextView.getText().toString());
            }
        }
