...
public class CropRotationWheel extends FrameLayout {
    ...
    public CropRotationWheel(Context context) {
        ...
        imageView.setImageResource(C2888R.drawable.msg_photo_flip);
        ...
        this.mirrorButton.setContentDescription(LocaleController.getString(C2888R.string.AccDescrMirror));
        addView(this.mirrorButton, LayoutHelper.createFrame(70, 64, 19));
        ImageView imageView3 = new ImageView(context);
        this.aspectRatioButton = imageView3;
        imageView3.setImageResource(C2888R.drawable.msg_photo_cropfix);
        ...
        this.aspectRatioButton.setContentDescription(LocaleController.getString(C2888R.string.AccDescrAspectRatio));
        addView(this.aspectRatioButton, LayoutHelper.createFrame(70, 64, 19));
        ImageView imageView4 = new ImageView(context);
        this.rotation90Button = imageView4;
        imageView4.setImageResource(C2888R.drawable.msg_photo_rotate);
        ...
        this.rotation90Button.setContentDescription(LocaleController.getString(C2888R.string.AccDescrRotate));
        addView(this.rotation90Button, LayoutHelper.createFrame(70, 64, 21));
        TextPaint textPaint = new TextPaint(1);
        this.degreesTextPaint = textPaint;
        textPaint.setColor(-1);
        this.degreesTextPaint.setTextSize(AndroidUtilities.m1124dp(14.0f));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(Math.min(View.MeasureSpec.getSize(i), AndroidUtilities.m1124dp(400.0f)), TLObject.FLAG_30), i2);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        this.bluePaint.setAlpha(255);
        this.tempRect.left = (width - AndroidUtilities.m1124dp(2.5f)) / 2;
        this.tempRect.top = (height - AndroidUtilities.m1124dp(22.0f)) / 2;
        this.tempRect.right = (AndroidUtilities.m1124dp(2.5f) + width) / 2;
        this.tempRect.bottom = (height + AndroidUtilities.m1124dp(22.0f)) / 2;
        canvas3.drawRoundRect(this.tempRect, AndroidUtilities.m1124dp(2.0f), AndroidUtilities.m1124dp(2.0f), this.bluePaint);
        canvas3.drawText(this.degreesText, (width - this.degreesTextPaint.measureText(this.degreesText)) / 2.0f, AndroidUtilities.m1124dp(14.0f), this.degreesTextPaint);
    }

    protected void drawLine(Canvas canvas, int i, float f, int i2, int i3, boolean z, Paint paint) {
        int iM1124dp = (int) ((i2 / 2.0f) - AndroidUtilities.m1124dp(70.0f));
        int iCos = (i2 / 2) + ((int) (((double) iM1124dp) * Math.cos(Math.toRadians(90.0f - ((i * 5) + f)))));
        float fAbs = Math.abs(r8) / iM1124dp;
        ...
        int i4 = z ? 4 : 2;
        int iM1124dp2 = AndroidUtilities.m1124dp(z ? 16.0f : 12.0f);
        int i5 = i4 / 2;
        canvas.drawRect(iCos - i5, (i3 - iM1124dp2) / 2, iCos + i5, (i3 + iM1124dp2) / 2, paint2);
    }
}
