package org.telegram.p029ui.Components.Crop;
...
public class CropAreaView extends ViewGroup {
    ...
    public float f1947tx;

    /* JADX INFO: renamed from: ty */
    public float f1948ty;
    ...
    public CropAreaView(Context context) {
        ...
        this.sidePadding = AndroidUtilities.m1124dp(16.0f);
        this.minWidth = AndroidUtilities.m1124dp(32.0f);
        ...
        this.shadowPaint.setStrokeWidth(AndroidUtilities.m1124dp(2.0f));
    ...
    private void updateSubtitle() {
        if (this.subtitle != null) {
            if (this.subtitlePaint == null) {
                ...
                this.subtitlePaint.setTextSize(AndroidUtilities.m1124dp(13.0f));
                this.subtitlePaint.setTextAlign(Paint.Align.CENTER);
            }
            this.subtitleLayout = new StaticLayout(this.subtitle, this.subtitlePaint, getMeasuredWidth() - AndroidUtilities.m1124dp(120.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            return;
        }
    ...
    public void setIsVideo(boolean z) {
        this.minWidth = AndroidUtilities.m1124dp(z ? 64.0f : 32.0f);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int i3;
        if (this.freeform) {
            int iM1124dp = AndroidUtilities.m1124dp(2.0f / this.scale);
            int iM1124dp2 = AndroidUtilities.m1124dp(16.0f / this.scale);
            int iM1124dp3 = AndroidUtilities.m1124dp(3.0f / this.scale);
            RectF rectF = this.actualRect;
            float f2 = rectF.left;
            int i4 = ((int) f2) - iM1124dp;
            float f3 = rectF.top;
            int i5 = ((int) f3) - iM1124dp;
            int i6 = (int) (rectF.right - f2);
            int i7 = iM1124dp * 2;
            int i8 = i6 + i7;
            int i9 = ((int) (rectF.bottom - f3)) + i7;
            canvas.save();
            canvas.translate(this.f1947tx, this.f1948ty);
            float f4 = this.scale;
            float f5 = (i8 / 2) + i4;
            float f6 = (i9 / 2) + i5;
            ...
            if (this.dimVisibile) {
                ...
                float f11 = i + iM1124dp;
                canvas.drawRect(0.0f, 0.0f, getWidth(), f11, this.dimPaint);
                float f12 = (i + i9) - iM1124dp;
                canvas.drawRect(0.0f, f11, i4 + iM1124dp, f12, this.dimPaint);
                canvas.drawRect((i4 + i8) - iM1124dp, f11, getWidth(), f12, this.dimPaint);
            ...
            canvas.drawRect(f14, f15, f16, r6 + iM1124dp, this.framePaint);
            float f17 = i16 + iM1124dp;
            int i18 = i + i9;
            float f18 = i18 - i12;
            canvas.drawRect(f14, f15, f17, f18, this.framePaint);
            canvas.drawRect(f14, r8 - iM1124dp, f16, f18, this.framePaint);
            canvas.drawRect(r4 - iM1124dp, f15, f16, f18, this.framePaint);
            int i19 = 0;
            while (i19 < 3) {
            ...
            if (this.circleBitmap != null) {
                ...
                if (getMeasuredHeight() > getMeasuredWidth() && this.subtitleLayout != null) {
                    canvas.save();
                    canvas.translate(getMeasuredWidth() / 2.0f, f45 + AndroidUtilities.m1124dp(16.0f));
    ...
    */
    public void calculateRect(android.graphics.RectF r13, float r14) {
        ...
        L7f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.Crop.CropAreaView.calculateRect(android.graphics.RectF, float):void");
    }
