...
public class RecordedAudioPlayerView extends View {
    ...
    public void checkWaveform() {
        int measuredWidth = getMeasuredWidth() - AndroidUtilities.m1124dp(27.0f);
        if (this.lastWaveformWidth == measuredWidth) {
            return;
        }
        int iM1124dp = measuredWidth / AndroidUtilities.m1124dp(3.0f);
        int iM1124dp2 = AndroidUtilities.m1124dp(2.0f);
        int iM1124dp3 = AndroidUtilities.m1124dp(12.0f);
        byte bMin = 127;
        byte bMax = -128;
        for (int i = 0; i < iM1124dp; i++) {
            byte[] bArr = this.waveformData;
            byte b = bArr == null ? (byte) 0 : bArr[(int) ((i / iM1124dp) * bArr.length)];
            bMin = (byte) Math.min((int) bMin, (int) b);
            bMax = (byte) Math.max((int) bMax, (int) b);
        }
        this.waveformPath.rewind();
        for (int i2 = 0; i2 < iM1124dp; i2++) {
            byte[] bArr2 = this.waveformData;
            float fLerp = AndroidUtilities.lerp(iM1124dp2, iM1124dp3, Utilities.clamp01(AndroidUtilities.ilerp((int) (bArr2 == null ? (byte) 0 : bArr2[(int) ((i2 / iM1124dp) * bArr2.length)]), (int) bMin, (int) bMax)));
            float fM1124dp = AndroidUtilities.m1124dp(3.0f) * i2;
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(fM1124dp, (-fLerp) / 2.0f, AndroidUtilities.m1124dp(2.0f) + fM1124dp, fLerp / 2.0f);
            this.waveformPath.addRoundRect(rectF, AndroidUtilities.m1124dp(1.0f), AndroidUtilities.m1124dp(1.0f), Path.Direction.CW);
        }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.backgroundRect.set(0.0f, (getMeasuredHeight() - fM1124dp) / 2.0f, getMeasuredWidth(), (getMeasuredHeight() + fM1124dp) / 2.0f);
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        float fM1124dp = AndroidUtilities.m1124dp(32.0f);
        this.backgroundRect.set(0.0f, (getHeight() - fM1124dp) / 2.0f, getWidth(), (getHeight() + fM1124dp) / 2.0f);
    }
    ...
    public void drawIn(Canvas canvas, RectF rectF, float f) {
        ...
        int iLerp = (int) AndroidUtilities.lerp(rectF.left + AndroidUtilities.m1124dp(11.33f), rectF.right - AndroidUtilities.m1124dp(11.33f), Utilities.clamp01(this.left));
        int iLerp2 = (int) AndroidUtilities.lerp(rectF.left + AndroidUtilities.m1124dp(11.33f), rectF.right - AndroidUtilities.m1124dp(11.33f), Utilities.clamp01(this.right));
        checkWaveform();
        canvas.save();
        this.clipPath.rewind();
        this.clipPath.addRoundRect(rectF, AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(8.0f), Path.Direction.CW);
        canvas.clipPath(this.clipPath);
        canvas.drawRect(rectF.left, rectF.top, iLerp - AndroidUtilities.m1124dp(1.33f), rectF.bottom, this.darkerBackgroundPaint);
        canvas.drawRect(AndroidUtilities.m1124dp(1.33f) + iLerp2, rectF.top, rectF.right, rectF.bottom, this.darkerBackgroundPaint);
        canvas.save();
        canvas.translate(rectF.left + AndroidUtilities.m1124dp(14.0f), rectF.centerY());
        ...
        float fClamp2 = Utilities.clamp(AndroidUtilities.lerp(rectF.left + AndroidUtilities.m1124dp(13.0f), rectF.right - AndroidUtilities.m1124dp(14.0f), fClamp), f3, f2);
        if (fClamp2 < f3) {
            canvas.save();
        ...
        this.handleRect.set(iLerp - AndroidUtilities.m1124dp(7.0f), rectF.centerY() - AndroidUtilities.m1124dp(5.33f), iLerp - AndroidUtilities.m1124dp(5.33f), rectF.centerY() + AndroidUtilities.m1124dp(5.33f));
        RectF rectF2 = this.handleRect;
        canvas.drawRoundRect(rectF2, rectF2.width() / 2.0f, this.handleRect.width() / 2.0f, this.handlePaint);
        this.handleRect.set(AndroidUtilities.m1124dp(5.33f) + iLerp2, rectF.centerY() - AndroidUtilities.m1124dp(5.33f), AndroidUtilities.m1124dp(7.0f) + iLerp2, rectF.centerY() + AndroidUtilities.m1124dp(5.33f));
        RectF rectF3 = this.handleRect;
        canvas.drawRoundRect(rectF3, rectF3.width() / 2.0f, this.handleRect.width() / 2.0f, this.handlePaint);
        this.leftHandleClickRect.set(iLerp - AndroidUtilities.m1124dp(24.0f), 0.0f, AndroidUtilities.m1124dp(6.0f) + iLerp, getHeight());
        this.rightHandleClickRect.set(iLerp2 - AndroidUtilities.m1124dp(6.0f), 0.0f, AndroidUtilities.m1124dp(24.0f) + iLerp2, getHeight());
        float f4 = this.showBadge.set(!this.progressPressed);
        if (f4 > 0.0f) {
            float fM1124dp = (int) (AndroidUtilities.m1124dp(30.0f) + this.text.getCurrentWidth());
            float f5 = this.showDuration.set(fM1124dp <= ((float) ((iLerp2 - iLerp) - AndroidUtilities.m1124dp(8.0f))));
            float fLerp = AndroidUtilities.lerp(AndroidUtilities.m1124dp(24.0f), fM1124dp, f5);
            float f6 = iLerp + iLerp2;
            float fM1124dp2 = AndroidUtilities.m1124dp(20.0f) / 2.0f;
            this.badgeRect.set((f6 - fLerp) / 2.0f, rectF.centerY() - fM1124dp2, (f6 + fLerp) / 2.0f, rectF.centerY() + fM1124dp2);
            ...
            this.badgeClickRect.inset(-AndroidUtilities.m1124dp(6.0f), -AndroidUtilities.m1124dp(6.0f));
            canvas.save();
            int iM1124dp = AndroidUtilities.m1124dp(12.0f);
            canvas.translate(AndroidUtilities.lerp(this.badgeRect.centerX() - (iM1124dp / 2.0f), this.badgeRect.left + AndroidUtilities.m1124dp(6.0f), f5), this.badgeRect.centerY());
            this.playPauseDrawable.setBounds(0, (-iM1124dp) / 2, iM1124dp, iM1124dp / 2);
            this.playPauseDrawable.setAlpha((int) (f4 * 255.0f));
            this.playPauseDrawable.draw(canvas);
            canvas.restore();
            if (f5 > 0.0f) {
                canvas.save();
                canvas.translate(this.badgeRect.left + AndroidUtilities.m1124dp(21.66f), this.badgeRect.centerY() - AndroidUtilities.m1124dp(1.0f));
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (this.leftPressed) {
                this.left = Utilities.clamp(AndroidUtilities.ilerp(motionEvent.getX(), this.backgroundRect.left + AndroidUtilities.m1124dp(11.33f), this.backgroundRect.right - AndroidUtilities.m1124dp(11.33f)), Utilities.clamp01(this.right - Math.max(1.0f / this.duration, AndroidUtilities.m1124dp(30.0f) / (this.backgroundRect.width() - AndroidUtilities.m1124dp(22.66f)))), 0.0f);
                invalidate();
            } else if (this.rightPressed) {
                this.right = Utilities.clamp(AndroidUtilities.ilerp(motionEvent.getX(), this.backgroundRect.left + AndroidUtilities.m1124dp(11.33f), this.backgroundRect.right - AndroidUtilities.m1124dp(11.33f)), 1.0f, Utilities.clamp01(this.left + Math.max(1.0f / this.duration, AndroidUtilities.m1124dp(30.0f) / (this.backgroundRect.width() - AndroidUtilities.m1124dp(22.66f)))));
                invalidate();
            } else if (this.progressPressed) {
                VideoPlayer videoPlayer = this.player;
                if (videoPlayer != null) {
                    float fClamp = Utilities.clamp(AndroidUtilities.ilerp(motionEvent.getX(), this.backgroundRect.left + AndroidUtilities.m1124dp(11.33f), this.backgroundRect.right - AndroidUtilities.m1124dp(11.33f)), this.right, this.left);
