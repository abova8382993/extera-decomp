...
public class VideoPlayerSeekBar {
    ...
    private int lineHeight = AndroidUtilities.m1124dp(4.0f);
    private int smallLineHeight = AndroidUtilities.m1124dp(2.0f);
    ...
    public VideoPlayerSeekBar(View view) {
        ...
        thumbWidth = AndroidUtilities.m1124dp(24.0f);
    ...
    public void setProgress(float f, boolean z) {
        ...
        if (z) {
            if (Math.abs(iCeil - this.thumbX) > AndroidUtilities.m1124dp(10.0f)) {
        ...
        if (Math.abs(this.animatedThumbX - this.thumbX) > AndroidUtilities.m1124dp(8.0f)) {
            this.animatedThumbX = this.thumbX;
        }
    }
        ...
        try {
            ...
            Collections.sort(this.timestamps, new Comparator() { // from class: org.telegram.ui.Components.VideoPlayerSeekBar$$ExternalSyntheticLambda0
                ...
                public final int compare(Object obj, Object obj2) {
                    return VideoPlayerSeekBar.m13058$r8$lambda$o3EHnMr9BcAI6WfiUzSrQzpwFA((Pair) obj, (Pair) obj2);
                }
            });
        } catch (Exception e) {
            FileLog.m1136e(e);
    ...
    public static /* synthetic */ int m13058$r8$lambda$o3EHnMr9BcAI6WfiUzSrQzpwFA(Pair pair, Pair pair2) {
    ...
    public void draw(Canvas canvas, View view) {
        ...
        int i = this.height;
        rectF.top = AndroidUtilities.lerp((i - this.lineHeight) / 2.0f, (i - AndroidUtilities.m1124dp(3.0f)) - this.smallLineHeight, this.transitionProgress);
        RectF rectF2 = this.rect;
        int i2 = this.height;
        rectF2.bottom = AndroidUtilities.lerp((this.lineHeight + i2) / 2.0f, i2 - AndroidUtilities.m1124dp(3.0f), this.transitionProgress);
        ...
        float fM1124dp = AndroidUtilities.m1124dp(this.pressed ? 8.0f : 6.0f);
        if (this.currentRadius != fM1124dp) {
            ...
            if (f14 < fM1124dp) {
                float fM1124dp2 = f14 + (AndroidUtilities.m1124dp(1.0f) * (j / 60.0f));
                this.currentRadius = fM1124dp2;
                if (fM1124dp2 > fM1124dp) {
                    this.currentRadius = fM1124dp;
                }
            } else {
                float fM1124dp3 = f14 - (AndroidUtilities.m1124dp(1.0f) * (j / 60.0f));
                this.currentRadius = fM1124dp3;
                if (fM1124dp3 < fM1124dp) {
                    this.currentRadius = fM1124dp;
                }
            }
    ...
    */
    private void drawProgressBar(android.graphics.Canvas r26, android.graphics.RectF r27, android.graphics.Paint r28) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.VideoPlayerSeekBar.drawProgressBar(android.graphics.Canvas, android.graphics.RectF, android.graphics.Paint):void");
    }
    ...
    private void drawTimestampLabel(Canvas canvas) {
        ...
        float fAbs = Math.abs(fLerp - f4) - AndroidUtilities.m1124dp(16.0f);
        ...
        canvas.save();
        int i2 = this.height;
        canvas.translate(fLerp + ((fLerp2 - f2) * this.transitionProgress), AndroidUtilities.lerp((this.lineHeight + i2) / f, i2 - AndroidUtilities.m1124dp(3.0f), this.transitionProgress) + AndroidUtilities.m1124dp(12.0f));
