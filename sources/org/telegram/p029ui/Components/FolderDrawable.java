    ...
    public void draw(Canvas canvas) {
        ...
        if (path != null) {
            if (this.pathInvalidated) {
                path.rewind();
                this.path.moveTo(m1257x(0.4871f), m1258y(0.6025f));
                this.path.lineTo(m1257x(0.8974f), m1258y(0.6025f));
                this.path.lineTo(m1257x(1.0f), m1258y(0.7564f));
                this.path.lineTo(m1257x(0.8974f), m1258y(0.9102f));
                this.path.lineTo(m1257x(0.4871f), m1258y(0.9102f));
                this.path.close();
                this.pathInvalidated = false;
                this.strokePaint.setStrokeWidth(AndroidUtilities.m1124dp(3.0f));
            }
