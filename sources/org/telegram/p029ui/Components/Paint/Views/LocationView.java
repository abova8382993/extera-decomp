...
public class LocationView extends EntityView {
    ...
    private static String deg(double d) {
        ...
        sb2.append(string);
        sb2.append(dFloor2 <= 0.0d ? MVEL.VERSION_SUB : _UrlKt.FRAGMENT_ENCODE_SET);
        sb2.append(dFloor2 < 10.0d ? MVEL.VERSION_SUB : _UrlKt.FRAGMENT_ENCODE_SET);
        sb2.append((int) dFloor2);
        sb2.append("'");
        String string2 = sb2.toString();
        double dFloor3 = Math.floor(Math.floor(dFloor2) * 60.0d);
        StringBuilder sb3 = new StringBuilder();
        sb3.append(string2);
        sb3.append(dFloor3 <= 0.0d ? MVEL.VERSION_SUB : _UrlKt.FRAGMENT_ENCODE_SET);
        if (dFloor3 < 10.0d) {
            str = MVEL.VERSION_SUB;
        }
        sb3.append(str);
        sb3.append((int) dFloor3);
        sb3.append("\"");
        return sb3.toString();
    }
