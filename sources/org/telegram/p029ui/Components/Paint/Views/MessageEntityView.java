...
public abstract class MessageEntityView extends EntityView {
        ...
        RecyclerListView recyclerListView = new RecyclerListView(context, this.resourcesProvider) { // from class: org.telegram.ui.Components.Paint.Views.MessageEntityView.2
            ...
            */
            private void drawChatForegroundElements(android.graphics.Canvas r18) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.Paint.Views.MessageEntityView.C46402.drawChatForegroundElements(android.graphics.Canvas):void");
            }
            ...
            */
            private void drawChatBackgroundElements(android.graphics.Canvas r26) {
                /*
                    ...
                    To view this dump change 'Code comments level' option to 'DEBUG'
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.Paint.Views.MessageEntityView.C46402.drawChatBackgroundElements(android.graphics.Canvas):void");
            }
            ...
            */
            public boolean drawChild(android.graphics.Canvas r20, android.view.View r21, long r22) {
                /*
                    ...
                    To view this dump change 'Code comments level' option to 'DEBUG'
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.Paint.Views.MessageEntityView.C46402.drawChild(android.graphics.Canvas, android.view.View, long):boolean");
            }
        };
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i4) {
                if (i4 == 1) {
                    return new RecyclerListView.Holder(new ChatActionCell(context, false, MessageEntityView.this.resourcesProvider) { // from class: org.telegram.ui.Components.Paint.Views.MessageEntityView.3.1
                        ...
                        @Override // org.telegram.p029ui.Cells.ChatActionCell
    ...
    public float getBubbleBounds(RectF rectF) {
        ...
        for (int i = 0; i < this.listView.getChildCount(); i++) {
            ...
            if (childAt instanceof ChatMessageCell) {
                ...
                if (chatMessageCell.getMessageObject() != null && chatMessageCell.getMessageObject().isRoundVideo() && chatMessageCell.getPhotoImage() != null) {
                    ...
                    float x3 = this.container.getX() + childAt.getX() + chatMessageCell.getBackgroundDrawableLeft() + AndroidUtilities.m1124dp(1.0f);
                    if (this.groupedMessages == null) {
                        x3 += AndroidUtilities.m1124dp(8.0f);
                    }
                    float x4 = ((this.container.getX() + childAt.getX()) + chatMessageCell.getBackgroundDrawableRight()) - AndroidUtilities.m1124dp(1.66f);
                    float y3 = this.container.getY() + childAt.getY() + chatMessageCell.getBackgroundDrawableTop() + AndroidUtilities.m1124dp(2.0f);
                    y = ((this.container.getY() + childAt.getY()) + chatMessageCell.getBackgroundDrawableBottom()) - AndroidUtilities.m1124dp(1.0f);
                    x = x3;
                    x2 = x4;
                    y2 = y3;
                }
        ...
        return AndroidUtilities.m1124dp(SharedConfig.bubbleRadius);
    }
    ...
    */
    protected void onMeasure(int r5, int r6) {
        ...
        L8a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.Paint.Views.MessageEntityView.onMeasure(int, int):void");
    }
    ...
    public org.telegram.p029ui.Components.Rect getSelectionBounds() {
        ...
        return new org.telegram.p029ui.Components.Rect(((getPositionX() * scaleX) - (((getMeasuredWidth() * getScale()) / 2.0f) * scaleX)) - AndroidUtilities.m1124dp(35.5f), ((getPositionY() * scaleX) - (((getMeasuredHeight() * getScale()) / 2.0f) * scaleX)) - AndroidUtilities.m1124dp(35.5f), (getMeasuredWidth() * getScale() * scaleX) + AndroidUtilities.m1124dp(71.0f), (getMeasuredHeight() * getScale() * scaleX) + AndroidUtilities.m1124dp(71.0f));
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void setupTheme(org.telegram.p029ui.Stories.recorder.StoryEntry r8) {
        /*
            Method dump skipped, instruction units count: 208
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.Paint.Views.MessageEntityView.setupTheme(org.telegram.ui.Stories.recorder.StoryEntry):void");
    }
    ...
    public TLRPC.Message copyMessage(TLRPC.Message message) {
        ...
        tL_messageService.f1686id = message.f1686id;
