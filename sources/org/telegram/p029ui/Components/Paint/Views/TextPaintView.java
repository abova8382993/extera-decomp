...
public class TextPaintView extends EntityView {
    ...
    public TextPaintView(Context context, Point point, int i, CharSequence charSequence, Swatch swatch, int i2) {
        ...
        this.editText.setPadding(AndroidUtilities.m1124dp(7.0f), AndroidUtilities.m1124dp(7.0f), AndroidUtilities.m1124dp(7.0f), AndroidUtilities.m1124dp(7.0f));
        this.editText.setClickable(false);
        this.editText.setEnabled(false);
        this.editText.setCursorColor(-1);
        this.editText.setTextSize(0, this.baseFontSize);
        this.editText.setCursorSize(AndroidUtilities.m1124dp(this.baseFontSize * 0.4f));
    ...
    public void updateHint() {
        if (this.editText.getText().length() <= 0) {
            this.editText.setHint(LocaleController.getString(C2888R.string.TextPlaceholder));
    ...
    public void setBaseFontSize(int i) {
        ...
        this.editText.setCursorSize(AndroidUtilities.m1124dp(f * 0.4f));
    ...
    */
    public void updateColor() {
        ...
        L8c:
            ...
            int r0 = org.telegram.p029ui.ActionBar.Theme.multAlpha(r0, r2)
            r1.setHighlightColor(r0)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.Paint.Views.TextPaintView.updateColor():void");
    }
    ...
    public Rect getSelectionBounds() {
        ...
        float measuredHeight = (getMeasuredHeight() * getScale()) + (AndroidUtilities.m1124dp(52.0f) / scaleX);
    ...
    public class TextViewSelectionView extends EntityView.SelectionView {
        ...
        protected int pointInsideHandle(float f, float f2) {
            ...
            return (f <= f5 - fM1124dp2 || f2 <= measuredHeight - fM1124dp2 || f >= f5 + fM1124dp2 || f2 >= measuredHeight + fM1124dp2) ? 0 : 2;
        }
