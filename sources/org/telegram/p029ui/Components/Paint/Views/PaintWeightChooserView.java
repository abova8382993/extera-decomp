...
public class PaintWeightChooserView extends View {
    ...
    public PaintWeightChooserView(Context context) {
        ...
        this.colorPaint.setShadowLayer(AndroidUtilities.m1124dp(4.0f), 0.0f, AndroidUtilities.m1124dp(2.0f), 1342177280);
        this.backgroundPaint.setColor(1090519039);
        this.backgroundPaint.setShadowLayer(AndroidUtilities.m1124dp(3.0f), 0.0f, AndroidUtilities.m1124dp(1.0f), 637534208);
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.Paint.Views.PaintWeightChooserView$1 */
    class C46491 extends GestureDetector.SimpleOnGestureListener {
        float startDeltaY;
        float startWeight;
        boolean startedY;
    ...
    protected void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        this.touchRect.set(0.0f, (getHeight() - height) / 2.0f, AndroidUtilities.m1124dp(32.0f), (getHeight() + height) / 2.0f);
    }
    ...
    */
    protected void onDraw(android.graphics.Canvas r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.Paint.Views.PaintWeightChooserView.onDraw(android.graphics.Canvas):void");
    }

    private void drawCircleWithShadow(Canvas canvas, float f, float f2, float f3, boolean z) {
        if (z) {
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set((f - f3) - AndroidUtilities.m1124dp(6.0f), (f2 - f3) - AndroidUtilities.m1124dp(6.0f), f + f3 + AndroidUtilities.m1124dp(6.0f), f2 + f3 + AndroidUtilities.m1124dp(6.0f));
