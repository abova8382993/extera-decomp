...
import org.telegram.p029ui.Components.Paint.ObjectDetectionEmojis;
...
public class StickerMakerView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public StickerMakerView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        paint.setPathEffect(new DashPathEffect(new float[]{AndroidUtilities.m1124dp(5.0f), AndroidUtilities.m1124dp(10.0f)}, 0.5f));
        ...
        paint3.setColor(-1);
        paint3.setStrokeWidth(AndroidUtilities.m1124dp(3.0f));
        paint3.setStyle(style);
        paint3.setStrokeCap(cap);
        paint3.setPathEffect(new CornerPathEffect(AndroidUtilities.m1124dp(20.0f)));
        float fM1124dp = AndroidUtilities.m1124dp(4.0f);
        BlurMaskFilter.Blur blur = BlurMaskFilter.Blur.NORMAL;
        paint3.setMaskFilter(new BlurMaskFilter(fM1124dp, blur));
        paint4.setColor(-1);
        paint4.setStrokeWidth(AndroidUtilities.m1124dp(3.0f));
        paint4.setStyle(style);
        paint4.setStrokeCap(cap);
        paint4.setPathEffect(new CornerPathEffect(AndroidUtilities.m1124dp(20.0f)));
        paint4.setMaskFilter(new BlurMaskFilter(AndroidUtilities.m1124dp(4.0f), blur));
        ...
        this.weightChooserView.setTranslationX(-AndroidUtilities.m1124dp(18.0f));
    ...
    public class SegmentedObject {
        ...
        public void initPoints() {
            ...
            int iCeil = (int) Math.ceil(length / AndroidUtilities.m1124dp(2.0f));
            ...
            while (true) {
                ...
                if (i < i2) {
                    ...
                    this.bordersFillPaint.setPathEffect(new CornerPathEffect(AndroidUtilities.m1124dp(10.0f)));
                    ...
                    this.bordersStrokePaint.setPathEffect(new CornerPathEffect(AndroidUtilities.m1124dp(10.0f)));
                    this.pointsPaint.setStyle(style);
                    this.pointsPaint.setStrokeWidth(AndroidUtilities.m1124dp(4.0f));
                    this.pointsPaint.setColor(-1);
                    this.pointsPaint.setStrokeCap(cap);
                    Paint paint4 = this.pointsPaint;
                    float fM1124dp = AndroidUtilities.m1124dp(0.33f);
                    BlurMaskFilter.Blur blur = BlurMaskFilter.Blur.NORMAL;
                    paint4.setMaskFilter(new BlurMaskFilter(fM1124dp, blur));
                    ...
                    this.pointsHighlightPaint.setStrokeWidth(AndroidUtilities.m1124dp(20.0f));
                    this.pointsHighlightPaint.setColor(Theme.multAlpha(-1, 0.04f));
                    this.pointsHighlightPaint.setMaskFilter(new BlurMaskFilter(AndroidUtilities.m1124dp(60.0f), blur));
                    return;
                }
            }
        }
        ...
        public void drawOutline(Canvas canvas, boolean z, float f, float f2) {
            ...
            if (StickerMakerView.this.sourceBitmap != null) {
                ...
                paint.setStrokeWidth(AndroidUtilities.m1124dp(f));
                ...
                if (StickerMakerView.this.outlineBoundsPath != null && z) {
                    ...
                    paint.setStrokeWidth(AndroidUtilities.m1124dp(f * 2.0f));
    ...
    public void setOutlineVisible(boolean z) {
        ...
        this.weightChooserView.animate().alpha(z ? 1.0f : 0.0f).translationX(z ? 0.0f : AndroidUtilities.m1124dp(-18.0f)).setInterpolator(CubicBezierInterpolator.EASE_OUT_QUINT).setDuration(320L).start();
        if (getParent() instanceof View) {
            ((View) getParent()).invalidate();
        }
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            if (this.outlineVisible) {
                ...
                this.exclusionRect.set(0, (getMeasuredHeight() - measuredHeight) / 2, AndroidUtilities.m1124dp(20.0f), (getMeasuredHeight() + measuredHeight) / 2);
            }
    ...
    public void enableClippingMode(final Utilities.Callback callback) {
        ...
        this.actionTextView.setText(LocaleController.getString(C2888R.string.SegmentationTabToCrop));
    ...
    public /* synthetic */ void lambda$enableClippingMode$1(Utilities.Callback callback, View view) {
        ...
        SegmentedObject[] segmentedObjectArr = this.objects;
        if (segmentedObjectArr == null || segmentedObjectArr.length == 0 || this.sourceBitmap == null || (segmentedObjectObjectBehind = objectBehind(this.f2000tx, this.f2001ty)) == null) {
            return;
        }
    ...
    */
    public boolean dispatchTouchEvent(android.view.MotionEvent r6) {
        ...
        L5c:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.Paint.Views.StickerMakerView.dispatchTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.actionTextView.setTranslationY(-((getMeasuredWidth() / 2.0f) + AndroidUtilities.m1124dp(10.0f)));
        if (Build.VERSION.SDK_INT >= 29) {
            this.exclusionRects.clear();
            if (this.outlineVisible) {
                this.exclusionRects.add(this.exclusionRect);
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        RectF rectF = AndroidUtilities.rectTmp;
        float f3 = measuredWidth + fM1124dp;
        rectF.set(fM1124dp, fM1124dp, f3, f3);
    ...
    public /* synthetic */ void lambda$segmentImage$5(int i, List list, final ArrayList arrayList, final Utilities.Callback callback) {
        ...
        if (list.isEmpty()) {
            ...
            if (bitmapCreateSmoothEdgesSegmentedImage == null) {
                FileLog.m1136e(new RuntimeException("createSmoothEdgesSegmentedImage failed on empty image"));
                return;
            }
    ...
    static class SubjectMock {
        ...
        public static SubjectMock m1262of(Subject subject) {
    ...
    public static /* synthetic */ void $r8$lambda$N34q7RjOP0nAX0Rvuf8jtIHGY0g(Utilities.Callback callback, SubjectSegmentationResult subjectSegmentationResult) {
        ...
        for (int i = 0; i < subjectSegmentationResult.getSubjects().size(); i++) {
            arrayList.add(SubjectMock.m1262of((Subject) subjectSegmentationResult.getSubjects().get(i)));
        }
        callback.run(arrayList);
    }
    ...
    public /* synthetic */ void lambda$segment$10(List list) {
        if (list.size() <= 0) {
            FileLog.m1133d("objimg: no objects");
            return;
        }
        this.detectedEmoji = ObjectDetectionEmojis.labelToEmoji(((ImageLabel) list.get(0)).getIndex());
        FileLog.m1133d("objimg: detected #" + ((ImageLabel) list.get(0)).getIndex() + " " + this.detectedEmoji + " " + ((ImageLabel) list.get(0)).getText());
    ...
    private void showLoadingDialog() {
        if (this.loadingToast == null) {
            this.loadingToast = new DownloadButton.PreparingVideoToast(getContext(), LocaleController.getString(C2888R.string.PreparingSticker));
        }
    ...
    private void showError(TLRPC.TL_error tL_error) {
        ...
        BulletinFactory.m1245of((FrameLayout) getParent(), this.resourcesProvider).createErrorBulletin(tL_error.text).show();
    }
