...
public class LinkPreview extends View {
    ...
    public LinkPreview(Context context, float f) {
        ...
        this.icon = context.getResources().getDrawable(C2888R.drawable.story_link).mutate();
    ...
    public void setupLayout() {
        ...
        if (withPreview()) {
            ...
            this.f1994h += this.density * 7.33f;
            ...
            this.f1995w = Math.max(this.f1995w, Math.min(maxWidth.getCurrentWidth() + (this.density * 20.0f), f5));
            this.f1994h = this.f1994h + this.messageText.getHeight() + (this.density * 7.0f);
            ...
            if (photo != null) {
                ...
                if (closestPhotoSizeWithSize2 != null) {
                    i = closestPhotoSizeWithSize2.f1694w;
                    i2 = closestPhotoSizeWithSize2.f1693h;
                } else {
                    i = 0;
                    i2 = 0;
                }
                ...
                if (document != null) {
                    ...
                    if (closestPhotoSizeWithSize4 != null) {
                        int i6 = closestPhotoSizeWithSize4.f1694w;
                        i2 = closestPhotoSizeWithSize4.f1693h;
                        i = i6;
                    } else {
                        i = 0;
                        i2 = 0;
            ...
            if (zIsEmpty) {
                ...
                float f7 = this.f1995w;
                float currentWidth = maxWidth2.getCurrentWidth();
                float f8 = this.density;
                this.f1995w = Math.max(f7, Math.min(currentWidth + (f8 * f2) + ((this.hasPhoto && this.smallPhoto) ? f8 * 60.0f : 0.0f), f5));
            ...
            if (zIsEmpty2) {
                ...
                float f10 = this.f1995w;
                float currentWidth2 = maxWidth3.getCurrentWidth();
                float f11 = this.density;
                this.f1995w = Math.max(f10, Math.min(currentWidth2 + (f11 * f2) + ((this.hasPhoto && this.smallPhoto) ? f11 * 60.0f : 0.0f), f5));
            ...
            if (!zIsEmpty3) {
                ...
                this.f1995w = Math.max(this.f1995w, Math.min(this.descriptionLayoutWidth + (this.density * f2), f5));
            ...
            if (this.hasPhoto && !this.smallPhoto) {
                if (i <= 0 || i2 <= 0) {
                    ...
                    this.photoHeight = Math.min((Math.max(0.0f, this.f1995w - (this.density * f2)) / i) * i2, this.density * 200.0f);
                }
            ...
            this.f1994h = this.f1994h + f14 + (f13 * 11.0f);
        } else {
            ...
            this.f1995w = (f17 * f18) + (this.layoutWidth * this.textScale);
            this.f1994h = ((rectF2.top + rectF2.bottom) * f18) + Math.max(f18 * 30.0f, this.layout.getHeight() * this.textScale);
        }
        if (!this.animated) {
    ...
    public void drawInternal(Canvas canvas) {
        ...
        setupLayout();
        float f5 = this.width.set(this.f1995w);
        float f6 = this.height.set(this.f1994h);
    ...
    protected void onMeasure(int i, int i2) {
        setupLayout();
        setMeasuredDimension(this.padx + ((int) Math.ceil(this.f1995w)) + this.padx, this.pady + ((int) Math.ceil(this.f1994h)) + this.pady);
    }
