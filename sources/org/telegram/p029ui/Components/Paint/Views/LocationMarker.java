...
public class LocationMarker extends View {
    ...
    public LocationMarker(Context context, int i, float f, int i2) {
        ...
        this.type = i2;
        this.icon = context.getResources().getDrawable(C2888R.drawable.map_pin3).mutate();
            ...
            for (int i = 0; i < tL_messages_stickerSet.packs.size(); i++) {
                ...
                if (containsEmoji(tL_stickerPack.emoticon, str) && !tL_stickerPack.documents.isEmpty()) {
                    ...
                    for (int i2 = 0; i2 < tL_messages_stickerSet.documents.size(); i2++) {
                        if (((TLRPC.Document) tL_messages_stickerSet.documents.get(i2)).f1668id == jLongValue) {
    ...
    public void setupLayout() {
        if (this.relayout) {
            ...
            this.f1997w = (f5 * f6) + (this.layoutWidth * this.textScale);
            this.f1996h = ((rectF2.top + rectF2.bottom) * f6) + Math.max(f6 * 21.33f, this.layout.getHeight() * this.textScale);
            this.relayout = false;
        }
    }
    ...
    public int getWidthInternal() {
        return this.padx + Math.round(this.f1997w) + this.padx;
    }

    public int getHeightInternal() {
        return this.pady + Math.round(this.f1996h) + this.pady;
    }

    public float getRadius() {
        return this.f1996h * 0.2f;
    }
    ...
    public void drawInternal(Canvas canvas) {
        ...
        int i = this.padx;
        int i2 = this.pady;
        rectF.set(i, i2, i + this.f1997w, i2 + this.f1996h);
        ...
        if (this.hasFlag) {
            ...
            if (f2 > 0.0f) {
                ...
                imageReceiver.setImageCoords(f3 + (f4 * f5), this.pady + ((this.f1996h - (f5 * 21.33f)) / 2.0f), f5 * 21.33f, f5 * 21.33f);
                canvas.save();
            ...
            if (f2 < 1.0f) {
                ...
                imageReceiver2.setImageCoords(f6 + (f7 * f8), this.pady + ((this.f1996h - (f8 * 21.33f)) / 2.0f), f8 * 21.33f, f8 * 21.33f);
                canvas.save();
            ...
            int i4 = this.pady;
            float f11 = this.f1996h;
            drawable.setBounds(((int) (f9 * f10)) + i3, ((int) ((f11 - (f10 * 21.33f)) / 2.0f)) + i4, i3 + ((int) ((f9 + 21.33f) * f10)), i4 + ((int) ((f11 + (f10 * 21.33f)) / 2.0f)));
            this.icon.draw(canvas);
        }
        canvas.save();
        canvas.translate(this.padx + ((this.padding.left + ((this.hasFlag || this.forceEmoji) ? 2.25f : 0.0f) + 21.33f + 3.25f) * this.density), this.pady + (this.f1996h / 2.0f));
