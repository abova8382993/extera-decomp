...
public abstract class Render {
    ...
    private static void PaintSegment(Point point, Point point2, RenderState renderState) {
        ...
        float fAtan2 = Math.abs(renderState2.angle) > 0.0f ? renderState2.angle : (float) Math.atan2(pointSubstract.f1982y, pointSubstract.f1981x);
        float f2 = (float) ((((((double) renderState2.baseWeight) * point2.f1983z) * ((double) renderState2.scale)) * 1.0d) / ((double) renderState2.viewportScale));
