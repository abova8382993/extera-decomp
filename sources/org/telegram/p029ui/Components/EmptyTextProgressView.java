...
public class EmptyTextProgressView extends FrameLayout {
    ...
    public EmptyTextProgressView(Context context, View view, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.textView.setText(LocaleController.getString(C2888R.string.NoResult));
        ...
        setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.Components.EmptyTextProgressView$$ExternalSyntheticLambda0
            ...
            public final boolean onTouch(View view2, MotionEvent motionEvent) {
                return EmptyTextProgressView.m10228$r8$lambda$Vq18KDUqpLFj2u41GI6nolj8(view2, motionEvent);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$Vq18KDUqpLFj2-u41GI6no-lj-8, reason: not valid java name */
    public static /* synthetic */ boolean m10228$r8$lambda$Vq18KDUqpLFj2u41GI6nolj8(View view, MotionEvent motionEvent) {
        return true;
    }
    ...
    public void setTopImage(int i) {
        ...
        this.textView.setCompoundDrawablePadding(AndroidUtilities.m1124dp(1.0f));
    }
        ...
        for (int i7 = 0; i7 < childCount; i7++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (childAt == view && (view instanceof FlickerLoadingView)) {
                    ...
                    if (i8 == 2) {
                        measuredHeight = (AndroidUtilities.m1124dp(100.0f) - childAt.getMeasuredHeight()) / 2;
                        paddingTop = getPaddingTop();
                    } else if (i8 == 1) {
