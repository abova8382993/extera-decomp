...
public class Switch extends View {
    ...
    private int getOverlayPadding() {
        if (ExteraConfig.newSwitchStyle) {
            return AndroidUtilities.m1124dp(5.0f);
        }
        return 0;
    }
    ...
    public void setDrawRipple(boolean z) {
        ...
        if (this.rippleDrawable == null) {
            ...
            rippleDrawableSafe.setRadius(AndroidUtilities.m1124dp(18.0f));
        ...
        if (Build.VERSION.SDK_INT >= 28 && z) {
            this.rippleDrawable.setHotspot(this.isChecked ? 0.0f : AndroidUtilities.m1124dp(100.0f), AndroidUtilities.m1124dp(18.0f));
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.Switch$2 */
    class C51882 extends AnimatorListenerAdapter {
        C51882() {
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.Switch$3 */
    class C51893 extends AnimatorListenerAdapter {
        C51893() {
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:255:0x029c  */
    ...
    /* JADX WARN: Removed duplicated region for block: B:357:0x02af A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:361:0x05a1 A[SYNTHETIC] */
    @Override // android.view.View
    /*
    ...
    */
    protected void onDraw(android.graphics.Canvas r32) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.Switch.onDraw(android.graphics.Canvas):void");
    }
