...
public class SuggestEmojiView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.SuggestEmojiView$1 */
    /* JADX INFO: loaded from: classes7.dex */
    class C51831 implements ContentPreviewViewer.ContentPreviewViewerDelegate {
        ...
        public void copyEmoji(TLRPC.Document document) {
            ...
            BulletinFactory.m1246of(SuggestEmojiView.this.enterView.getParentFragment()).createCopyBulletin(LocaleController.getString(C2888R.string.EmojiCopied)).show();
        }
        ...
        public void setAsEmojiStatus(TLRPC.Document document, Integer num) {
            ...
            if (parentFragment != null) {
                ...
                BulletinFactory.m1246of(parentFragment).createEmojiBulletin(document, LocaleController.getString(C2888R.string.SetAsEmojiStatusInfo), LocaleController.getString(C2888R.string.UndoNoCaps), runnable).show();
            }
        }
        ...
        public void setAsBadge(final TLRPC.Document document) {
            ...
            final BaseFragment parentFragment = SuggestEmojiView.this.enterView == null ? null : SuggestEmojiView.this.enterView.getParentFragment();
            final Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.SuggestEmojiView$1$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    BadgesController.INSTANCE.updateBadge(badge, new Consumer() { // from class: org.telegram.ui.Components.SuggestEmojiView$1$$ExternalSyntheticLambda4
                        @Override // java.util.function.Consumer
                        /* JADX INFO: renamed from: accept */
                        public final void m940v(Object obj) {
                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.SuggestEmojiView$1$$ExternalSyntheticLambda5
                                @Override // java.lang.Runnable
                                public final void run() {
                                    SuggestEmojiView.C51831.$r8$lambda$2whgXLzBqz4yP9CNbNBbP88YKH4(str, baseFragment);
                                }
                            });
                        }
            ...
            badgesController.updateBadge(new BadgeDTO(document.f1668id, badge != null ? badge.getText() : null), new Consumer() { // from class: org.telegram.ui.Components.SuggestEmojiView$1$$ExternalSyntheticLambda1
                @Override // java.util.function.Consumer
                /* JADX INFO: renamed from: accept */
                public final void m940v(Object obj) {
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.SuggestEmojiView$1$$ExternalSyntheticLambda3
                        @Override // java.lang.Runnable
                        public final void run() {
                            SuggestEmojiView.C51831.$r8$lambda$7poGLY6Q4YTEAgwqJr6NoecHU9k(str, baseFragment, document, runnable);
                        }
                    });
                }
        ...
        public static /* synthetic */ void $r8$lambda$2whgXLzBqz4yP9CNbNBbP88YKH4(String str, BaseFragment baseFragment) {
            if (str == null || !str.equals("ok")) {
                BulletinFactory.m1246of(baseFragment).createErrorBulletin(LocaleController.getString(C2888R.string.UnknownError)).show();
            }
        }

        public static /* synthetic */ void $r8$lambda$7poGLY6Q4YTEAgwqJr6NoecHU9k(String str, BaseFragment baseFragment, TLRPC.Document document, Runnable runnable) {
            if (str == null || !str.equals("ok")) {
                BulletinFactory.m1246of(baseFragment).createErrorBulletin(LocaleController.getString(C2888R.string.UnknownError)).show();
            } else {
                BulletinFactory.m1246of(baseFragment).createEmojiBulletin(document, LocaleController.getString(C2888R.string.SetAsBadgeStatusInfo), LocaleController.getString(C2888R.string.UndoNoCaps), runnable).show();
            }
        }
    ...
    public ContentPreviewViewer.ContentPreviewViewerDelegate getPreviewDelegate() {
        if (this.previewDelegate == null) {
            this.previewDelegate = new C51831();
        }
    ...
    public SuggestEmojiView(Context context, final int i, AnchorViewDelegate anchorViewDelegate, Theme.ResourcesProvider resourcesProvider) {
        super(context);
        this.direction = 0;
        this.horizontalPadding = AndroidUtilities.m1124dp(10.0f);
    ...
    private void createListView() {
        ...
        C51842 c51842 = new FrameLayout(getContext()) { // from class: org.telegram.ui.Components.SuggestEmojiView.2
            C51842(Context context) {
                super(context);
            }
            ...
            protected void onMeasure(int i, int i2) {
                setPadding(SuggestEmojiView.this.horizontalPadding, SuggestEmojiView.this.direction == 0 ? AndroidUtilities.m1124dp(8.0f) : AndroidUtilities.m1124dp(6.66f), SuggestEmojiView.this.horizontalPadding, SuggestEmojiView.this.direction == 0 ? AndroidUtilities.m1124dp(6.66f) : AndroidUtilities.m1124dp(8.0f));
        ...
        this.containerView = c51842;
        CubicBezierInterpolator cubicBezierInterpolator = CubicBezierInterpolator.EASE_OUT_QUINT;
        this.showFloat1 = new AnimatedFloat(c51842, 120L, 350L, cubicBezierInterpolator);
        ...
        C51853 c51853 = new RecyclerListView(getContext()) { // from class: org.telegram.ui.Components.SuggestEmojiView.3
            private boolean left;
            private boolean right;

            C51853(Context context) {
                super(context);
            }
        ...
        this.listView = c51853;
        Adapter adapter = new Adapter(this);
        this.adapter = adapter;
        c51853.setAdapter(adapter);
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.SuggestEmojiView$2 */
    /* JADX INFO: loaded from: classes7.dex */
    class C51842 extends FrameLayout {
        C51842(Context context) {
            super(context);
        }
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.SuggestEmojiView$3 */
    /* JADX INFO: loaded from: classes7.dex */
    class C51853 extends RecyclerListView {
        private boolean left;
        private boolean right;
    ...
    /* JADX INFO: renamed from: org.telegram.ui.Components.SuggestEmojiView$4 */
    /* JADX INFO: loaded from: classes7.dex */
    class C51864 implements TextWatcher {
        @Override // android.text.TextWatcher
        public void beforeTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        }
    ...
    private void searchKeywords(final String str) {
        ...
        if (str2 != null && this.lastQueryType == 1 && str2.equals(str) && !this.clear && (arrayList = this.keywordResults) != null && !arrayList.isEmpty()) {
            ...
            this.lastSpanY = AndroidUtilities.m1124dp(10.0f);
    ...
    public void drawContainerBegin(Canvas canvas) {
        ...
        if (anchorViewDelegate != null && anchorViewDelegate.getEditField() != null) {
            ...
            if (emojiSpan != null && emojiSpan.drawn) {
                ...
                this.arrowX = this.enterView.getEditField().getX() + this.enterView.getEditField().getPaddingLeft() + AndroidUtilities.m1124dp(12.0f);
            }
        }
        ...
        ArrayList arrayList2 = this.keywordResults;
        float size = left2 + ((arrayList2 == null ? 0 : arrayList2.size()) * AndroidUtilities.m1124dp(44.0f));
        ...
        if (anchorViewDelegate2 != null && anchorViewDelegate2.getEditField() != null) {
            ...
            if (i == 0) {
                this.containerView.setTranslationY(((-this.enterView.getEditField().getHeight()) - this.enterView.getEditField().getScrollY()) + this.lastSpanY + AndroidUtilities.m1124dp(5.0f));
            } else if (i == 1) {
                this.containerView.setTranslationY(((-getMeasuredHeight()) - this.enterView.getEditField().getScrollY()) + this.lastSpanY + AndroidUtilities.m1124dp(20.0f) + this.containerView.getHeight());
            }
        }
        float f8 = f6 / 4.0f;
        float f9 = f6 / 2.0f;
        int iMax = (int) Math.max((this.arrowX - Math.max(f8, Math.min(f9, AndroidUtilities.m1124dp(66.0f)))) - this.listView.getLeft(), 0.0f);
        ...
        this.listView.setTranslationX(((int) Math.max((f4 - Math.max(f8, Math.min(f9, AndroidUtilities.m1124dp(66.0f)))) - this.listView.getLeft(), 0.0f)) - iMax);
        float paddingLeft2 = (f7 - f9) + this.listView.getPaddingLeft() + this.listView.getTranslationX();
        float top = this.listView.getTop() + this.listView.getTranslationY() + this.listView.getPaddingTop() + (this.direction == 0 ? 0 : AndroidUtilities.m1124dp(6.66f));
        ...
        float bottom = (this.listView.getBottom() + this.listView.getTranslationY()) - (this.direction == 0 ? AndroidUtilities.m1124dp(6.66f) : 0);
        float fMin2 = Math.min(AndroidUtilities.m1124dp(9.0f), f9) * 2.0f;
        ...
        if (i2 == 0) {
            ...
            this.path.lineTo(AndroidUtilities.m1124dp(8.66f) + f4, bottom);
            this.path.lineTo(f4, AndroidUtilities.m1124dp(6.66f) + bottom);
            this.path.lineTo(f4 - AndroidUtilities.m1124dp(8.66f), bottom);
        } else {
            f = 6.66f;
            if (i2 == 1) {
                ...
                this.path.lineTo(f4 - AndroidUtilities.m1124dp(8.66f), top);
                this.path.lineTo(f4, top - AndroidUtilities.m1124dp(6.66f));
                this.path.lineTo(AndroidUtilities.m1124dp(8.66f) + f4, top);
            }
        }
        this.path.close();
        if (this.backgroundPaint == null) {
            ...
            paint.setPathEffect(new CornerPathEffect(AndroidUtilities.m1124dp(2.0f)));
            this.backgroundPaint.setShadowLayer(AndroidUtilities.m1124dp(4.33f), 0.0f, AndroidUtilities.m1124dp(0.33333334f), AndroidUtilities.DARK_STATUS_BAR_OVERLAY);
            this.backgroundPaint.setColor(Theme.getColor(Theme.key_chat_stickersHintPanel, this.resourcesProvider));
        }
        if (f2 < 1.0f) {
            this.circlePath.rewind();
            float fM1124dp = this.direction == 0 ? AndroidUtilities.m1124dp(f) + bottom : top - AndroidUtilities.m1124dp(f);
            double d = f4 - paddingLeft2;
            double d2 = fM1124dp - top;
            double d3 = f4 - fMin;
            double d4 = fM1124dp - bottom;
            this.circlePath.addCircle(f4, fM1124dp, ((float) Math.sqrt(Math.max(Math.max(Math.pow(d, 2.0d) + Math.pow(d2, 2.0d), Math.pow(d3, 2.0d) + Math.pow(d2, 2.0d)), Math.max(Math.pow(d, 2.0d) + Math.pow(d4, 2.0d), Math.pow(d3, 2.0d) + Math.pow(d4, 2.0d))))) * f2, Path.Direction.CW);
            canvas.save();
    ...
    public void drawContainerEnd(Canvas canvas) {
        ...
        if (f4 > 0.0f) {
            ...
            Theme.chat_gradientRightDrawable.setBounds(i, (int) top, AndroidUtilities.m1124dp(32.0f) + i, (int) bottom);
        ...
        if (f5 > 0.0f) {
            int i2 = (int) fMin;
            Theme.chat_gradientLeftDrawable.setBounds(i2 - AndroidUtilities.m1124dp(32.0f), (int) top, i2, (int) bottom);
    ...
    public class EmojiImageView extends View {
        ...
        @Override // android.view.View
        protected void onMeasure(int i, int i2) {
            setPadding(AndroidUtilities.m1124dp(3.0f), AndroidUtilities.m1124dp((this.direction == 0 ? 0.0f : 6.66f) + 3.0f), AndroidUtilities.m1124dp(3.0f), AndroidUtilities.m1124dp((this.direction != 0 ? 0.0f : 6.66f) + 3.0f));
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(44.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(52.0f), TLObject.FLAG_30));
        }
