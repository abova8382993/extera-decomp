package org.telegram.p029ui.Components.glass;
...
import org.telegram.p029ui.MainTabsLayout;
...
public class GlassTabView extends FrameLayout implements MainTabsLayout.Tab, FactorAnimator.Target {
    ...
    public GlassTabView(Context context) {
        ...
        animatedTextDrawable.setTextSize(AndroidUtilities.m1124dp(10.0f));
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (floatValue2 > 0.0f) {
            ...
            float fMax = Math.max(fDpf24, this.counter.getCurrentWidth() + AndroidUtilities.m1124dp(8.0f));
            ...
            if (this.usePremiumCounter) {
                if (this.premiumStarDrawable == null) {
                    this.premiumStarDrawable = getContext().getResources().getDrawable(C2888R.drawable.star).mutate();
                }
                PremiumGradient.getInstance().updateMainGradientMatrix(0, 0, AndroidUtilities.m1124dp(96.0f), AndroidUtilities.m1124dp(16.0f), 0.0f, 0.0f);
                ...
                this.premiumStarDrawable.setBounds(iDpf2, iDpf22, AndroidUtilities.m1124dp(14.0f) + iDpf2, AndroidUtilities.m1124dp(14.0f) + iDpf22);
    ...
    private void checkPlayAnimation(boolean z) {
        ...
        if (tL_attachMenuBot != null) {
            ...
            if (animatedAttachMenuBotIcon == null || (document = animatedAttachMenuBotIcon.icon) == null) {
            ...
            } else if (this.lastBotIconId != document.f1668id) {
                ...
                this.lastBotIconId = document.f1668id;
            }
            updateColors();
            return;
        }
    ...
    public static GlassTabView createAttachTab(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        glassTabView.textView.setPadding(AndroidUtilities.m1124dp(8.0f), 0, AndroidUtilities.m1124dp(8.0f), 0);
        glassTabView.checkPlayAnimation(false);
        glassTabView.imageView.setLayoutParams(LayoutHelper.createFrame(24, 24.0f, 49, 0.0f, 4.0f, 0.0f, 0.0f));
        glassTabView.colorDefault = Theme.getColor(Theme.key_glass_tabUnselected, resourcesProvider);
        glassTabView.colorSelected = Theme.getColor(Theme.key_glass_tabSelected, resourcesProvider);
    ...
    public float measureAttachTabWidth() {
        ...
        return Math.min(AndroidUtilities.m1124dp(84.0f), (int) (fMeasureTextWidth + (AndroidUtilities.lerp(AndroidUtilities.dpf2(16.0f), AndroidUtilities.m1124dp(8.0f), MathUtils.clamp((fMeasureTextWidth - AndroidUtilities.m1124dp(40.0f)) / AndroidUtilities.m1124dp(16.0f), 0.0f, 1.0f)) * 2.0f)));
    }
    ...
    public enum TabAnimation {
        CONTACTS(C2888R.raw.tab_contacts, C2888R.drawable.tabs_contact_active_24, C2888R.drawable.tabs_contacts_24, -1, -1),
        CALLS(C2888R.raw.tab_calls, C2888R.drawable.tabs_calls_active_24, C2888R.drawable.tabs_calls_24, -1, -1),
        CHATS(C2888R.raw.tab_chats, C2888R.drawable.tabs_chats_active_24, C2888R.drawable.tabs_chats_24, -1, -1),
        SETTINGS(C2888R.raw.tab_settings, C2888R.drawable.filled_profile_settings, C2888R.drawable.outline_profile_settings, -1, -1),
        CHECKLIST(C2888R.raw.tab_checklist, C2888R.raw.tab_checklist_reverse),
        COLORS(C2888R.raw.tab_colors, C2888R.raw.tab_colors_reverse),
        FILES(C2888R.raw.tab_files, C2888R.raw.tab_files_reverse),
        GALLERY(C2888R.raw.tab_gallery, C2888R.raw.tab_gallery_reverse),
        GIFT(C2888R.raw.tab_gift, C2888R.raw.tab_gift_reverse),
        LOCATION(C2888R.raw.tab_location, C2888R.raw.tab_location_reverse),
        MODELS(C2888R.raw.tab_models, C2888R.raw.tab_models_reverse),
        MUSIC(C2888R.raw.tab_music, C2888R.raw.tab_music_reverse),
        POLL(C2888R.raw.tab_poll, C2888R.raw.tab_poll_reverse),
        SYMBOLS(C2888R.raw.tab_symbols, C2888R.raw.tab_symbols_reverse),
        REPLIES(C2888R.raw.tab_reply, C2888R.raw.tab_reply_reverse),
        WALLET(C2888R.raw.tab_wallet, C2888R.raw.tab_wallet_reverse),
        BOOSTS(C2888R.raw.boosts, 25, 49),
        MONETIZATION(C2888R.raw.monetize, 19, 45);
    ...
    public void setAttachBot(TLRPC.User user, TLRPC.TL_attachMenuBot tL_attachMenuBot, int i) {
        ...
        this.backupImageView.setSize(AndroidUtilities.m1124dp(24.0f), AndroidUtilities.m1124dp(24.0f));
