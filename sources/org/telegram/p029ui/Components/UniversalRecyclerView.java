...
public class UniversalRecyclerView extends RecyclerListView {
    ...
    public UniversalRecyclerView(Context context, int i, int i2, boolean z, Utilities.Callback2 callback2, final Utilities.Callback5 callback5, final Utilities.Callback5Return callback5Return, Theme.ResourcesProvider resourcesProvider, int i3, int i4) {
        ...
        if (i3 == -1) {
            C53011 c53011 = new LinearLayoutManager(context, i4, false) { // from class: org.telegram.ui.Components.UniversalRecyclerView.1
                C53011(Context context2, int i42, boolean z2) {
            ...
            this.layoutManager = c53011;
            setLayoutManager(c53011);
        } else {
            C53022 c53022 = new ExtendedGridLayoutManager(context2, i3) { // from class: org.telegram.ui.Components.UniversalRecyclerView.2
                C53022(Context context2, int i32) {
                    super(context2, i32);
                }
            ...
            c53022.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() { // from class: org.telegram.ui.Components.UniversalRecyclerView.3
                final /* synthetic */ ExtendedGridLayoutManager val$layoutManager1;

                C53033(ExtendedGridLayoutManager c530222) {
                    extendedGridLayoutManager = c530222;
                }
            ...
            this.layoutManager = c530222;
            setLayoutManager(c530222);
        }
        ...
        C53044 c53044 = new DefaultItemAnimator() { // from class: org.telegram.ui.Components.UniversalRecyclerView.4
            C53044() {
            }
        ...
        c53044.setSupportsChangeAnimations(false);
        c53044.setDelayAnimations(false);
        c53044.setInterpolator(CubicBezierInterpolator.EASE_OUT_QUINT);
        c53044.setDurations(350L);
        setItemAnimator(c53044);
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.UniversalRecyclerView$1 */
    class C53011 extends LinearLayoutManager {
        C53011(Context context2, int i42, boolean z2) {
            super(context2, i42, z2);
        }
    ...
    class C53022 extends ExtendedGridLayoutManager {
        C53022(Context context2, int i32) {
            super(context2, i32);
        }
    ...
    class C53033 extends GridLayoutManager.SpanSizeLookup {
        final /* synthetic */ ExtendedGridLayoutManager val$layoutManager1;
    ...
    class C53044 extends DefaultItemAnimator {
        C53044() {
        }
    ...
    class C53055 extends LinearLayoutManager {
        C53055(Context context, int i, boolean z) {
            super(context, i, z);
        }
    ...
    public void makeHorizontal() {
        C53055 c53055 = new LinearLayoutManager(getContext(), 0, false) { // from class: org.telegram.ui.Components.UniversalRecyclerView.5
            C53055(Context context, int i, boolean z) {
                super(context, i, z);
            }
        ...
        this.layoutManager = c53055;
        setLayoutManager(c53055);
    }
    ...
    public void setSpanCount(int i) {
        ...
        C53066 c53066 = new ExtendedGridLayoutManager(getContext(), i) { // from class: org.telegram.ui.Components.UniversalRecyclerView.6
            C53066(Context context, int i2) {
                super(context, i2);
            }
        ...
        c53066.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() { // from class: org.telegram.ui.Components.UniversalRecyclerView.7
            final /* synthetic */ ExtendedGridLayoutManager val$layoutManager1;

            C53077(ExtendedGridLayoutManager c530662) {
                extendedGridLayoutManager = c530662;
            }
        ...
        this.layoutManager = c530662;
        setLayoutManager(c530662);
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.UniversalRecyclerView$6 */
    /* JADX INFO: loaded from: classes7.dex */
    class C53066 extends ExtendedGridLayoutManager {
        C53066(Context context, int i2) {
            super(context, i2);
        }
    ...
    /* JADX INFO: loaded from: classes7.dex */
    class C53077 extends GridLayoutManager.SpanSizeLookup {
        final /* synthetic */ ExtendedGridLayoutManager val$layoutManager1;
    ...
    private class TouchHelperCallback extends ItemTouchHelper.Callback {
        ...
        public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (i == 0) {
                if (viewHolder != null) {
                    viewHolder.itemView.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1124dp(16.0f), Theme.getColor(Theme.key_windowBackgroundWhite)));
    ...
    public /* synthetic */ Boolean lambda$setSections$3(View view) {
        ...
        Object tag = childViewHolder.itemView.getTag(C2888R.id.parent_tag);
