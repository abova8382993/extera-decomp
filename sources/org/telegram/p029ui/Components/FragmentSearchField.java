...
import com.exteragram.messenger.pillstack.p014ui.PillStackView;
...
public class FragmentSearchField extends FrameLayout implements FactorAnimator.Target, Theme.Colorable, NotificationCenter.NotificationCenterDelegate {
    ...
    public FragmentSearchField(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.contentClipRadius = AndroidUtilities.m1124dp(20.0f);
        ...
        editTextBoldCursor.setPadding(AndroidUtilities.m1124dp(48.0f), 0, AndroidUtilities.m1124dp(48.0f), 0);
        ...
        imageView2.setImageResource(C2888R.drawable.miniplayer_close);
    ...
    protected void dispatchDraw(Canvas canvas) {
        canvas.save();
        Drawable drawable = this.f1971bg;
        if (drawable != null) {
            drawable.setBounds(getPaddingLeft(), getPaddingTop(), getWidth() - getPaddingRight(), getHeight() - getPaddingBottom());
            this.f1971bg.draw(canvas);
        }
        BlurredBackgroundDrawable blurredBackgroundDrawable = this.blurredBackgroundDrawable;
        if (blurredBackgroundDrawable != null) {
            blurredBackgroundDrawable.setBounds(getPaddingLeft() - AndroidUtilities.m1124dp(4.0f), getPaddingTop() - AndroidUtilities.m1124dp(4.0f), (getWidth() - getPaddingRight()) + AndroidUtilities.m1124dp(4.0f), (getHeight() - getPaddingBottom()) + AndroidUtilities.m1124dp(4.0f));
    ...
    public void setupBlurredBackground(BlurredBackgroundDrawable blurredBackgroundDrawable) {
        blurredBackgroundDrawable.setRadius(AndroidUtilities.m1124dp(20.0f));
        blurredBackgroundDrawable.setPadding(AndroidUtilities.m1124dp(4.0f));
    ...
    private void checkUi_editTextPaddings() {
        int iMax = Math.max(((int) this.animatorSearchFiltersWidth.getFactor()) + AndroidUtilities.m1124dp(6.0f), AndroidUtilities.m1124dp(48.0f));
        int iM1124dp = AndroidUtilities.m1124dp(48.0f) + this.additionalIconsLayout.getMeasuredWidth();
        boolean z = LocaleController.isRTL;
        int i = z ? iM1124dp : iMax;
        if (!z) {
            iMax = iM1124dp;
        }
    ...
    public void setSectionBackground() {
        ...
        setPadding(AndroidUtilities.m1124dp(3.0f), AndroidUtilities.m1124dp(3.0f), AndroidUtilities.m1124dp(3.0f), AndroidUtilities.m1124dp(3.0f));
        updateColors();
    }
    ...
    public void updateColors() {
        ...
        if (this.isSectionBackground) {
            drawableCreateRoundRectDrawable = Theme.createRoundRectDrawableShadowed(AndroidUtilities.m1124dp(20.0f), getThemedColor(Theme.key_windowBackgroundWhite));
        } else {
            drawableCreateRoundRectDrawable = Theme.createRoundRectDrawable(AndroidUtilities.m1124dp(20.0f), getThemedColor(Theme.key_windowBackgroundWhiteBlackText, zIsDark ? 0.07f : 0.05f));
        }
        this.f1971bg = drawableCreateRoundRectDrawable;
        ...
        this.closeIcon.setBackground(Theme.createSelectorDrawable(getThemedColor(Theme.key_listSelector), 1, AndroidUtilities.m1124dp(17.0f)));
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            if (childAt instanceof ActionBarMenuItem) {
                ...
                childAt.setBackground(Theme.createSelectorDrawable(getThemedColor(Theme.key_listSelector), 1, AndroidUtilities.m1124dp(17.0f)));
            }
        }
    ...
    private void updatePillStack(boolean z) {
        boolean z2;
        if (this.showPillStack && !PillStackConfig.activePills.isEmpty()) {
            ...
            for (int i = 0; i < PillStackConfig.activePills.size(); i++) {
                Integer num = (Integer) PillStackConfig.activePills.get(i);
                BasePill pill = getPill(num);
                if (pill != null) {
                    pillStackView2.addPill(pill);
                    if (num.intValue() == PillStackConfig.lastActivePillId) {
