...
import org.telegram.p029ui.LinkEditActivity;
import org.telegram.p029ui.ManageLinksActivity;
...
public class InviteLinkBottomSheet extends BottomSheet {
    ...
    public InviteLinkBottomSheet(final Context context, final TLRPC.TL_chatInviteExported tL_chatInviteExported, final TLRPC.ChatFull chatFull, final HashMap map, final BaseFragment baseFragment, final long j, boolean z, boolean z2) {
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.Components.InviteLinkBottomSheet.1
            ...
            protected void onDraw(Canvas canvas) {
                int iMin;
                float fMin;
                int iM1124dp = (InviteLinkBottomSheet.this.scrollOffsetY - ((BottomSheet) InviteLinkBottomSheet.this).backgroundPaddingTop) - AndroidUtilities.m1124dp(8.0f);
                int measuredHeight = getMeasuredHeight() + AndroidUtilities.m1124dp(36.0f) + ((BottomSheet) InviteLinkBottomSheet.this).backgroundPaddingTop;
        ...
        RecyclerListView recyclerListView = new RecyclerListView(context) { // from class: org.telegram.ui.Components.InviteLinkBottomSheet.2
            ...
            protected void onMeasure(int i, int i2) {
                if (this.lastH != View.MeasureSpec.getSize(i2)) {
                    ...
                    if (i4 < (i3 - measuredHeight) + AndroidUtilities.m1124dp(60.0f)) {
        ...
        this.titleTextView.setPadding(AndroidUtilities.m1124dp(23.0f), 0, AndroidUtilities.m1124dp(23.0f), 0);
        this.titleTextView.setGravity(16);
        this.titleTextView.setTypeface(AndroidUtilities.bold());
        if (!z) {
            if (tL_chatInviteExported.expired) {
                this.titleTextView.setText(LocaleController.getString(C2888R.string.ExpiredLink));
            } else if (tL_chatInviteExported.revoked) {
                this.titleTextView.setText(LocaleController.getString(C2888R.string.RevokedLink));
            } else {
                this.titleTextView.setText(LocaleController.getString(C2888R.string.InviteLink));
            }
    ...
    */
    public /* synthetic */ void lambda$new$3(final org.telegram.tgnet.TLRPC.TL_chatInviteExported r24, java.util.HashMap r25, org.telegram.tgnet.TLRPC.ChatFull r26, final android.content.Context r27, final long r28, final org.telegram.p029ui.ActionBar.BaseFragment r30, android.view.View r31, int r32) {
        /*
            Method dump skipped, instruction units count: 303
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.InviteLinkBottomSheet.lambda$new$3(org.telegram.tgnet.TLRPC$TL_chatInviteExported, java.util.HashMap, org.telegram.tgnet.TLRPC$ChatFull, android.content.Context, long, org.telegram.ui.ActionBar.BaseFragment, android.view.View, int):void");
    }
    ...
    private void updateColorForView(View view) {
        if (view instanceof HeaderCell) {
            ...
            CombinedDrawable combinedDrawable = new CombinedDrawable(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundGray)), Theme.getThemedDrawableByKey(view.getContext(), C2888R.drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
        ...
        if (childViewHolder != null) {
            if (childViewHolder.getItemViewType() == 7) {
                CombinedDrawable combinedDrawable2 = new CombinedDrawable(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundGray)), Theme.getThemedDrawableByKey(view.getContext(), C2888R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow), 0, 0);
                combinedDrawable2.setFullsize(true);
                view.setBackgroundDrawable(combinedDrawable2);
                return;
            }
            if (childViewHolder.getItemViewType() == 2) {
                CombinedDrawable combinedDrawable3 = new CombinedDrawable(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundGray)), Theme.getThemedDrawableByKey(view.getContext(), C2888R.drawable.greydivider, Theme.key_windowBackgroundGrayShadow), 0, 0);
    ...
    private void loadCreator() {
        ...
        tL_users_getUsers.f1818id.add(MessagesController.getInstance(UserConfig.selectedAccount).getInputUser(this.invite.admin_id));
    ...
    */
    private void updateRows() {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.InviteLinkBottomSheet.updateRows():void");
    }
    ...
    class Adapter extends RecyclerListView.SelectionAdapter {
            ...
            switch (i) {
                ...
                case 3:
                    ...
                    LinkActionView linkActionView = new LinkActionView(context, inviteLinkBottomSheet.fragment, inviteLinkBottomSheet, inviteLinkBottomSheet.chatId, false, InviteLinkBottomSheet.this.isChannel) { // from class: org.telegram.ui.Components.InviteLinkBottomSheet.Adapter.1
                        @Override // org.telegram.p029ui.Components.LinkActionView
                        public void showBulletin(int i2, CharSequence charSequence) {
                            InviteLinkBottomSheet inviteLinkBottomSheet2 = InviteLinkBottomSheet.this;
                            Bulletin bulletinCreateSimpleBulletin = BulletinFactory.m1245of(inviteLinkBottomSheet2.container, ((BottomSheet) inviteLinkBottomSheet2).resourcesProvider).createSimpleBulletin(i2, charSequence);
                            bulletinCreateSimpleBulletin.hideAfterBottomSheet = false;
                            bulletinCreateSimpleBulletin.show(true);
                        }
                    };
                    linkActionView.setDelegate(new C44962());
                ...
                case 4:
                    ...
                    CombinedDrawable combinedDrawable = new CombinedDrawable(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundGray)), Theme.getThemedDrawableByKey(context, C2888R.drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                    combinedDrawable.setFullsize(true);
                ...
                case 5:
                    ...
                    flickerLoadingView.setPaddingLeft(AndroidUtilities.m1124dp(10.0f));
                ...
                case 6:
                    emptyHintRow = new View(context) { // from class: org.telegram.ui.Components.InviteLinkBottomSheet.Adapter.3
                        ...
                        protected void onMeasure(int i2, int i3) {
                            super.onMeasure(i2, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(5.0f), TLObject.FLAG_30));
                        }
                    };
                    revenueUserCell = emptyHintRow;
                    break;
                case 7:
                    ...
                    CombinedDrawable combinedDrawable2 = new CombinedDrawable(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundGray)), Theme.getThemedDrawableByKey(context, C2888R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow), 0, 0);
                    combinedDrawable2.setFullsize(true);
        ...
        class C44962 implements LinkActionView.Delegate {
        ...
        /* JADX WARN: Removed duplicated region for block: B:83:0x023b A[PHI: r0
  0x023b: PHI (r0v12 org.telegram.tgnet.TLRPC$User) = (r0v11 org.telegram.tgnet.TLRPC$User), (r0v55 org.telegram.tgnet.TLRPC$User) binds: [B:77:0x0203, B:81:0x022b] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public /* synthetic */ void lambda$loadUsers$6(TLRPC.TL_error tL_error, TLObject tLObject, List list, boolean z, boolean z2, boolean z3, boolean z4) {
        if (tL_error == null) {
            ...
            for (int i = 0; i < tL_messages_chatInviteImporters.users.size(); i++) {
                ...
                this.users.put(Long.valueOf(user.f1825id), user);
            }
            boolean z5 = true;
    ...
    private class EmptyHintRow extends FrameLayout {
        ...
        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1124dp(84.0f), TLObject.FLAG_30));
        }
    }
    ...
    private class RevenueUserCell extends UserCell {
        ...
        public void setRevenue(TL_stars.TL_starsSubscriptionPricing tL_starsSubscriptionPricing, int i) {
            ...
            String string = i2 == 2592000 ? LocaleController.getString(C2888R.string.StarsParticipantSubscriptionPerMonth) : i2 == 300 ? "per 5 minutes" : "per each minute";
    ...
    private class RevenueCell extends FrameLayout {
        ...
        public RevenueCell(Context context) {
            ...
            imageView.setImageResource(C2888R.drawable.large_income);
        ...
        public void set(TL_stars.TL_starsSubscriptionPricing tL_starsSubscriptionPricing, int i) {
            ...
            if (i2 == 2592000) {
                ...
                sb.append(LocaleController.formatString(C2888R.string.LinkRevenuePrice, Long.valueOf(tL_starsSubscriptionPricing.amount)));
                if (i > 0) {
                    str = " x " + i;
                }
                sb.append(str);
                textView.setText(StarsIntroActivity.replaceStarsWithPlain(sb.toString(), 0.8f));
                this.subtitleView.setText(i == 0 ? LocaleController.getString(C2888R.string.NoOneSubscribed) : LocaleController.formatString(C2888R.string.LinkRevenuePriceInfo, BillingController.getInstance().formatCurrency((long) ((tL_starsSubscriptionPricing.amount / 1000.0d) * ((double) MessagesController.getInstance(((BottomSheet) InviteLinkBottomSheet.this).currentAccount).starsUsdWithdrawRate1000) * ((double) i)), "USD")));
                return;
            }
            ...
            if (i == 0) {
                string = LocaleController.getString(C2888R.string.NoOneSubscribed);
            } else {
    ...
    public static BottomSheet showSubscriptionSheet(final Context context, int i, long j, TL_stars.TL_starsSubscriptionPricing tL_starsSubscriptionPricing, final TLRPC.TL_chatInviteImporter tL_chatInviteImporter, TLRPC.ChannelParticipant channelParticipant, Theme.ResourcesProvider resourcesProvider) {
        ...
        LinearLayout linearLayout = new LinearLayout(context);
        linearLayout.setOrientation(1);
        linearLayout.setPadding(AndroidUtilities.m1124dp(16.0f), AndroidUtilities.m1124dp(20.0f), AndroidUtilities.m1124dp(16.0f), AndroidUtilities.m1124dp(4.0f));
        ...
        imageView.setTranslationX(AndroidUtilities.m1124dp(34.0f));
        imageView.setTranslationY(AndroidUtilities.m1124dp(35.0f));
        imageView.setScaleX(1.1f);
        imageView.setScaleY(1.1f);
        ImageView imageView2 = new ImageView(context);
        imageView2.setImageDrawable(drawable2);
        frameLayout.addView(imageView2, LayoutHelper.createFrame(28, 28, 17));
        imageView2.setTranslationX(AndroidUtilities.m1124dp(34.0f));
        imageView2.setTranslationY(AndroidUtilities.m1124dp(35.0f));
        TextView textView = new TextView(context);
        textView.setTextColor(Theme.getColor(Theme.key_dialogTextBlack, resourcesProvider));
        textView.setTextSize(1, 20.0f);
        textView.setTypeface(AndroidUtilities.bold());
        textView.setGravity(17);
        textView.setText(LocaleController.getString(C2888R.string.StarsSubscriptionTitle));
        ...
        if (i3 == 2592000) {
            ...
            textView2.setText(StarsIntroActivity.replaceStarsWithPlain(LocaleController.formatString(C2888R.string.StarsSubscriptionPrice, Long.valueOf(tL_starsSubscriptionPricing.amount)), 0.8f));
        } else {
            bottomSheetArr = bottomSheetArr2;
        ...
        if (i4 == 2592000) {
            textView3.setText(LocaleController.formatString(C2888R.string.StarsParticipantSubscriptionApproxMonth, BillingController.getInstance().formatCurrency((int) ((tL_starsSubscriptionPricing.amount / 1000.0d) * ((double) MessagesController.getInstance(i).starsUsdWithdrawRate1000)), "USD")));
        } else {
        ...
        linksTextView.setPadding(AndroidUtilities.m1124dp(12.66f), AndroidUtilities.m1124dp(9.33f), AndroidUtilities.m1124dp(12.66f), AndroidUtilities.m1124dp(9.33f));
        ...
        spannableStringBuilder.setSpan(new ClickableSpan() { // from class: org.telegram.ui.Components.InviteLinkBottomSheet.5
            ...
            public void onClick(View view) {
                ...
                if (safeLastFragment != null) {
                    safeLastFragment.presentFragment(ProfileActivity.m1294of(tL_chatInviteImporter.user_id));
                }
            }
        ...
        if (!z) {
            tableView.addRowUnpadded(LocaleController.getString(C2888R.string.StarsParticipantSubscription), linksTextView);
        }
        tableView.addRow(LocaleController.getString(C2888R.string.StarsParticipantSubscriptionStart), LocaleController.formatString(C2888R.string.formatDateAtTime, LocaleController.getInstance().getFormatterGiveawayCard().format(new Date(((long) tL_chatInviteImporter.date) * 1000)), LocaleController.getInstance().getFormatterDay().format(new Date(((long) tL_chatInviteImporter.date) * 1000))));
        int currentTime = ConnectionsManager.getInstance(i).getCurrentTime();
        if (channelParticipant != null) {
            tableView.addRow(LocaleController.getString(channelParticipant.subscription_until_date > currentTime ? C2888R.string.StarsParticipantSubscriptionRenews : C2888R.string.StarsParticipantSubscriptionExpired), LocaleController.formatString(C2888R.string.formatDateAtTime, LocaleController.getInstance().getFormatterGiveawayCard().format(new Date(((long) channelParticipant.subscription_until_date) * 1000)), LocaleController.getInstance().getFormatterDay().format(new Date(((long) channelParticipant.subscription_until_date) * 1000))));
        }
        ...
        linksTextView2.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(C2888R.string.StarsTransactionTOS), new Runnable() { // from class: org.telegram.ui.Components.InviteLinkBottomSheet$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
