...
public class RecyclerItemsEnterAnimator {
    ...
    public void showItemsAnimated(int i) {
        ...
        ViewTreeObserverOnPreDrawListenerC49282 viewTreeObserverOnPreDrawListenerC49282 = new ViewTreeObserverOnPreDrawListenerC49282(progressView, i);
        this.preDrawListeners.add(viewTreeObserverOnPreDrawListenerC49282);
        this.listView.getViewTreeObserver().addOnPreDrawListener(viewTreeObserverOnPreDrawListenerC49282);
    }

    /* JADX INFO: renamed from: org.telegram.ui.Components.RecyclerItemsEnterAnimator$2 */
    class ViewTreeObserverOnPreDrawListenerC49282 implements ViewTreeObserver.OnPreDrawListener {
        final /* synthetic */ int val$finalFrom;
        final /* synthetic */ View val$finalProgressView;

        ViewTreeObserverOnPreDrawListenerC49282(View view, int i) {
