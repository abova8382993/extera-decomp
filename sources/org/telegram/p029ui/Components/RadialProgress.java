...
public class RadialProgress {
    ...
    private int diff = AndroidUtilities.m1124dp(4.0f);
    ...
    public RadialProgress(View view) {
        ...
        this.miniProgressPaint.setStrokeWidth(AndroidUtilities.m1124dp(2.0f));
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.drawMiniProgress && this.currentDrawable != null) {
            ...
            if (Math.abs(this.progressRect.width() - AndroidUtilities.m1124dp(44.0f)) < AndroidUtilities.density) {
                ...
                fCenterY = this.progressRect.centerY() + AndroidUtilities.m1124dp(f5);
                i = 20;
                i2 = 0;
            } else {
                fCenterX = this.progressRect.centerX() + AndroidUtilities.m1124dp(18.0f);
                fCenterY = this.progressRect.centerY() + AndroidUtilities.m1124dp(18.0f);
                i = 22;
                i2 = 2;
            }
            int i3 = i / 2;
            ...
            if (canvas2 != null) {
                ...
                f3 = -90.0f;
                f4 = 1.0f;
                canvas2.drawCircle(AndroidUtilities.m1124dp(f6), AndroidUtilities.m1124dp(f6), AndroidUtilities.m1124dp(i3 + 1) * f2, Theme.checkboxSquare_eraserPaint);
            } else {
                f3 = -90.0f;
                f4 = 1.0f;
                ...
                canvas.drawCircle(fCenterX, fCenterY, AndroidUtilities.m1124dp(12.0f), this.miniProgressBackgroundPaint);
            }
            if (this.miniDrawCanvas != null) {
            ...
            if (drawable4 != null) {
                ...
                float f7 = i3;
                this.previousMiniDrawable.setBounds((int) (fCenterX - (AndroidUtilities.m1124dp(f7) * f2)), (int) (fCenterY - (AndroidUtilities.m1124dp(f7) * f2)), (int) ((AndroidUtilities.m1124dp(f7) * f2) + fCenterX), (int) ((AndroidUtilities.m1124dp(f7) * f2) + fCenterY));
            ...
            if (!this.hideCurrentDrawable && (drawable2 = this.currentMiniDrawable) != null) {
                ...
                float f8 = i3;
                this.currentMiniDrawable.setBounds((int) (fCenterX - AndroidUtilities.m1124dp(f8)), (int) (fCenterY - AndroidUtilities.m1124dp(f8)), (int) (AndroidUtilities.m1124dp(f8) + fCenterX), (int) (AndroidUtilities.m1124dp(f8) + fCenterY));
            ...
            if (this.currentMiniWithRound || this.previousMiniWithRound) {
                ...
                float f9 = i3 - 2;
                this.cicleRect.set(fCenterX - (AndroidUtilities.m1124dp(f9) * f2), fCenterY - (AndroidUtilities.m1124dp(f9) * f2), fCenterX + (AndroidUtilities.m1124dp(f9) * f2), fCenterY + (AndroidUtilities.m1124dp(f9) * f2));
