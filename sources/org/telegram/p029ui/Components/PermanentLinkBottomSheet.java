...
public class PermanentLinkBottomSheet extends BottomSheet {
    ...
    public PermanentLinkBottomSheet(Context context, boolean z, final BaseFragment baseFragment, final TLRPC.ChatFull chatFull, long j, boolean z2) {
        ...
        RLottieDrawable rLottieDrawable = new RLottieDrawable(C2888R.raw.shared_link_enter, _UrlKt.FRAGMENT_ENCODE_SET + C2888R.raw.shared_link_enter, AndroidUtilities.m1124dp(90.0f), AndroidUtilities.m1124dp(90.0f), false, null);
        ...
        textView.setText(LocaleController.getString(C2888R.string.InviteLink));
        ...
        textView2.setText(LocaleController.getString(z2 ? C2888R.string.LinkInfoChannel : C2888R.string.LinkInfo));
        ...
        textView3.setText(LocaleController.getString(C2888R.string.ManageInviteLinks));
        ...
        textView3.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1124dp(8.0f), 0, ColorUtils.setAlphaComponent(Theme.getColor(i), 120)));
    ...
    public /* synthetic */ void lambda$new$2(TLRPC.ChatFull chatFull, BaseFragment baseFragment, View view) {
        ManageLinksActivity manageLinksActivity = new ManageLinksActivity(chatFull.f1661id, 0L, 0);
    ...
    public void updateColors() {
        ...
        int i = Theme.key_featuredStickers_addButton;
        rLottieImageView.setBackground(Theme.createCircleDrawable(iM1124dp, Theme.getColor(i)));
        this.manage.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1124dp(8.0f), 0, ColorUtils.setAlphaComponent(Theme.getColor(i), 120)));
