...
import org.telegram.p029ui.Components.ProfileMetaballView;
...
public class ProfileGalleryBlurView extends View {
    ...
    public void setSize(int i) {
        ...
        this.actionSize = i;
        this.size = (int) (AndroidUtilities.m1124dp(64.0f) * 1.5f);
    }
    ...
    private void initRenderNode() {
        if (this.blurNode == null) {
            ...
            this.blurNode = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1129m("profileBlurNode");
    ...
    private void initActionsRenderNode() {
        ...
        if (this.actionsBlurNode == null) {
            this.actionsBlurNode = BotFullscreenButtons$$ExternalSyntheticApiModelOutline0.m1129m("profileActionsBlurNode");
    ...
    private void captureActionsBlurRenderNode(float f, ProfileActivity.AvatarImageView avatarImageView, float f2, float f3) {
        ...
        if (profileMusicView2 != null) {
            if (avatarImageView != null) {
                profileMusicView2.drawingBlur(this.actionsBlurNode, avatarImageView, renderNodeScale / f2, (-f3) + AndroidUtilities.m1124dp(22.0f));
            } else {
                profileMusicView2.drawingBlur(this.actionsBlurNode, null, renderNodeScale, (-f3) + AndroidUtilities.m1124dp(22.0f));
            }
        }
    }
    ...
    private float getRenderNodeScale() {
        return AndroidUtilities.m1124dp(1.0f);
    }
