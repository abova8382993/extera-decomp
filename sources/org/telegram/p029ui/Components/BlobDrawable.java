...
public class BlobDrawable {
    ...
    private final float f1929L;

    /* JADX INFO: renamed from: N */
    protected final float f1930N;
    ...
    public BlobDrawable(int i, int i2) {
        ...
        this.f1931m = new Matrix();
        float f = i;
        this.f1930N = f;
        this.f1929L = (float) (Math.tan(3.141592653589793d / ((double) (f * 2.0f))) * 1.3333333333333333d);
        ...
        for (int i3 = 0; i3 < this.f1930N; i3++) {
    ...
    public void draw(float f, float f2, Canvas canvas, Paint paint) {
        ...
        while (true) {
            ...
            if (f3 < f4) {
                ...
                float fMin = this.f1929L * (Math.min(f9, f11) + ((Math.max(f9, f11) - Math.min(f9, f11)) / 2.0f)) * this.cubicBezierK;
                this.f1931m.reset();
                this.f1931m.setRotate(f13, f, f2);
                ...
                fArr7[3] = f16;
                this.f1931m.reset();
                this.f1931m.setRotate(f14, f, f2);
                this.f1931m.mapPoints(this.pointEnd);
                if (i == 0) {
                    Path path = this.path;
