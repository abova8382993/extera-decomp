...
public class PhotoFilterCurvesControl extends View {
    ...
    public PhotoFilterCurvesControl(Context context, PhotoFilterView.CurvesToolValue curvesToolValue) {
        ...
        this.paint.setStrokeWidth(AndroidUtilities.m1124dp(1.0f));
        Paint paint = this.paint;
        Paint.Style style = Paint.Style.STROKE;
        paint.setStyle(style);
        this.paintDash.setColor(-1711276033);
        this.paintDash.setStrokeWidth(AndroidUtilities.m1124dp(2.0f));
        this.paintDash.setStyle(style);
        this.paintCurve.setColor(-1);
        this.paintCurve.setStrokeWidth(AndroidUtilities.m1124dp(2.0f));
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r8) {
        ...
        L78:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.PhotoFilterCurvesControl.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    private void selectSegmentWithPoint(float f) {
        ...
        Rect rect = this.actualArea;
        this.activeSegment = (int) Math.floor(((f - rect.f2057x) / (rect.width / 5.0f)) + 1.0f);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (i3 < 5) {
            ...
            canvas.drawText(str, rect3.f2057x + ((f - fMeasureText) / 2.0f) + (i3 * f), (rect3.f2058y + rect3.height) - AndroidUtilities.m1124dp(4.0f), this.textPaint);
            i3++;
        }
        ...
        for (int i4 = 0; i4 < fArrInterpolateCurve.length / 2; i4++) {
            if (i4 == 0) {
                ...
                int i5 = i4 * 2;
                path.moveTo(rect4.f2057x + (fArrInterpolateCurve[i5] * rect4.width), rect4.f2058y + ((1.0f - fArrInterpolateCurve[i5 + 1]) * rect4.height));
            } else {
                Path path2 = this.path;
                Rect rect5 = this.actualArea;
                int i6 = i4 * 2;
                path2.lineTo(rect5.f2057x + (fArrInterpolateCurve[i6] * rect5.width), rect5.f2058y + ((1.0f - fArrInterpolateCurve[i6 + 1]) * rect5.height));
            }
        }
