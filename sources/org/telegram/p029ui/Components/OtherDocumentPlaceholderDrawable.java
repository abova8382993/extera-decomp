...
public class OtherDocumentPlaceholderDrawable extends RecyclableDrawable implements DownloadController.FileDownloadProgressListener {
    ...
    public OtherDocumentPlaceholderDrawable(Context context, View view, MessageObject messageObject) {
        docPaint.setTextSize(AndroidUtilities.m1124dp(14.0f));
        namePaint.setTextSize(AndroidUtilities.m1124dp(19.0f));
        sizePaint.setTextSize(AndroidUtilities.m1124dp(15.0f));
        buttonPaint.setTextSize(AndroidUtilities.m1124dp(15.0f));
        percentPaint.setTextSize(AndroidUtilities.m1124dp(15.0f));
        openPaint.setTextSize(AndroidUtilities.m1124dp(15.0f));
        progressPaint.setStrokeWidth(AndroidUtilities.m1124dp(2.0f));
        ...
        if (document != null) {
            ...
            if (((int) Math.ceil(docPaint.measureText(r0))) > AndroidUtilities.m1124dp(40.0f)) {
                this.ext = TextUtils.ellipsize(this.ext, docPaint, AndroidUtilities.m1124dp(40.0f), TextUtils.TruncateAt.END).toString();
            }
            ...
            if (((int) Math.ceil(namePaint.measureText(this.fileName))) > AndroidUtilities.m1124dp(320.0f)) {
                this.fileName = TextUtils.ellipsize(this.fileName, namePaint, AndroidUtilities.m1124dp(320.0f), TextUtils.TruncateAt.END).toString();
            }
        }
        checkFileExist();
    }
    ...
    public void draw(Canvas canvas) {
        ...
        int iM1124dp2 = (iHeight - AndroidUtilities.m1124dp(240.0f)) / 2;
        int iM1124dp3 = (iWidth - AndroidUtilities.m1124dp(48.0f)) / 2;
        this.thumbDrawable.setBounds(iM1124dp3, iM1124dp2, AndroidUtilities.m1124dp(48.0f) + iM1124dp3, AndroidUtilities.m1124dp(48.0f) + iM1124dp2);
        this.thumbDrawable.draw(canvas);
        canvas.drawText(this.ext, (iWidth - ((int) Math.ceil(docPaint.measureText(this.ext)))) / 2, AndroidUtilities.m1124dp(31.0f) + iM1124dp2, docPaint);
        canvas.drawText(this.fileName, (iWidth - ((int) Math.ceil(namePaint.measureText(this.fileName)))) / 2, AndroidUtilities.m1124dp(96.0f) + iM1124dp2, namePaint);
        canvas.drawText(this.fileSize, (iWidth - ((int) Math.ceil(sizePaint.measureText(this.fileSize)))) / 2, AndroidUtilities.m1124dp(125.0f) + iM1124dp2, sizePaint);
        if (this.loaded) {
            string = LocaleController.getString(C2888R.string.OpenFile);
            textPaint = openPaint;
            iM1124dp = 0;
        } else {
            if (this.loading) {
                string = LocaleController.getString(C2888R.string.Cancel).toUpperCase();
            } else {
                string = LocaleController.getString(C2888R.string.TapToDownload);
            }
            iM1124dp = AndroidUtilities.m1124dp(28.0f);
            textPaint = buttonPaint;
        }
        canvas.drawText(string, (iWidth - ((int) Math.ceil(textPaint.measureText(string)))) / 2, AndroidUtilities.m1124dp(235.0f) + iM1124dp2 + iM1124dp, textPaint);
        if (this.progressVisible) {
            if (this.progress != null) {
                canvas.drawText(this.progress, (iWidth - ((int) Math.ceil(percentPaint.measureText(r1)))) / 2, AndroidUtilities.m1124dp(210.0f) + iM1124dp2, percentPaint);
            }
            int iM1124dp4 = (iWidth - AndroidUtilities.m1124dp(240.0f)) / 2;
            int iM1124dp5 = iM1124dp2 + AndroidUtilities.m1124dp(232.0f);
            progressPaint.setColor(-10327179);
            progressPaint.setAlpha((int) (this.animatedAlphaValue * 255.0f));
            float f = iM1124dp5;
            canvas.drawRect(((int) (AndroidUtilities.m1124dp(240.0f) * this.animatedProgressValue)) + iM1124dp4, f, AndroidUtilities.m1124dp(240.0f) + iM1124dp4, AndroidUtilities.m1124dp(2.0f) + iM1124dp5, progressPaint);
            progressPaint.setColor(-1);
            progressPaint.setAlpha((int) (this.animatedAlphaValue * 255.0f));
            float f2 = iM1124dp4;
            canvas.drawRect(f2, f, f2 + (AndroidUtilities.m1124dp(240.0f) * this.animatedProgressValue), iM1124dp5 + AndroidUtilities.m1124dp(2.0f), progressPaint);
            updateAnimation();
        }
        canvas.restore();
    }
    ...
    @Override // org.telegram.p029ui.Components.RecyclableDrawable
    public void recycle() {
    ...
    */
    public void checkFileExist() {
        ...
        La6:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p029ui.Components.OtherDocumentPlaceholderDrawable.checkFileExist():void");
    }
