...
public abstract class JobIntentService extends Service {
    ...
    public static abstract class WorkEnqueuer {
        ...
        public void ensureJobId(int i) {
            if (!this.mHasJobId) {
                ...
                Dex$$ExternalSyntheticBUOutline1.m211m("Given job ID ", i, " is different than previous ", this.mJobId);
            }
        }
    }
    ...
    public static final class JobWorkEnqueuer extends WorkEnqueuer {
        ...
        @Override // org.telegram.messenger.support.JobIntentService.WorkEnqueuer
        public void enqueueWork(Intent intent) {
            this.mJobScheduler.enqueue(this.mJobInfo, AbstractC2838x35c7cea7.m1097m(intent));
        }
    }
    ...
    public static void enqueueWork(Context context, ComponentName componentName, int i, Intent intent) {
        if (intent == null) {
            g$$ExternalSyntheticBUOutline1.m207m("work must not be null");
            return;
        }
        synchronized (sLock) {
    ...
    public static WorkEnqueuer getWorkEnqueuer(Context context, ComponentName componentName, boolean z, int i) {
        ...
        if (Build.VERSION.SDK_INT < 26) {
            ...
            if (!z) {
                g$$ExternalSyntheticBUOutline1.m207m("Can't be here without a job id");
                return null;
            }
