...
public class FileLoader extends BaseController {
    ...
    public void setLocalPathTo(TLObject tLObject, String str) {
        ...
        if (tLObject instanceof TLRPC.Document) {
            ...
            this.filePathDatabase.putPath(document.f1253id, document.dc_id, i, 1, str);
            return;
        }
    ...
    public /* synthetic */ void lambda$uploadFile$5(boolean z, String str, long j, int i, boolean z2, boolean z3) {
        ...
        fileUploadOperation.setDelegate(new C27341(z, str, z3));
        if (z3) {
    ...
    /* JADX INFO: loaded from: classes5.dex */
    public class C27341 implements FileUploadOperation.FileUploadOperationDelegate {
        final /* synthetic */ boolean val$encrypted;
        final /* synthetic */ String val$location;
        final /* synthetic */ boolean val$small;

        public C27341(boolean z, String str, boolean z2) {
        ...
        public /* synthetic */ void lambda$didFinishUploadingFile$0(boolean z, String str, boolean z2, TLRPC.InputFile inputFile, TLRPC.InputEncryptedFile inputEncryptedFile, byte[] bArr, byte[] bArr2, FileUploadOperation fileUploadOperation) {
            ...
            if (z) {
                ...
                fileLoader.uploadOperationPaths.remove(str);
            }
            FileLoader fileLoader2 = FileLoader.this;
            if (z2) {
                fileLoader2.currentUploadSmallOperationsCount--;
                ...
                fileLoader2.currentUploadOperationsCount--;
    ...
    public /* synthetic */ void lambda$changePriority$11(String str, int i) {
        ...
        FileLog.m1045d("update priority " + str + " position in queue " + fileLoadOperation.getPositionInQueue() + " account=" + this.currentAccount);
    }
  ...
  0x0170: PHI (r5v4 org.telegram.messenger.FileLoadOperation) = (r5v28 org.telegram.messenger.FileLoadOperation), (r5v29 org.telegram.messenger.FileLoadOperation) binds: [B:240:0x0163, B:242:0x016e] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:277:0x0206  */
    /* JADX WARN: Removed duplicated region for block: B:283:0x021a A[PHI: r4
  0x021a: PHI (r4v28 java.io.File) = (r4v14 java.io.File), (r4v31 java.io.File) binds: [B:293:0x0238, B:282:0x0218] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public class C27352 implements FileLoadOperation.FileLoadOperationDelegate {
        ...
        public C27352(Object obj, TLRPC.Document document, String str, int i) {
        ...
        public void didPreFinishLoading(final FileLoadOperation fileLoadOperation, File file) {
            ...
            FileLoader.fileLoaderQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.FileLoader$2$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    FileLoader.C27352.m5429$r8$lambda$mxbBfeFTETIsHMKtk_6I_mmOw(fileLoadOperation, queue);
                }
            });
        }

        /* JADX INFO: renamed from: $r8$lambda$mxbBfe-FTETIsHMKtk_6I_m-mOw */
        public static /* synthetic */ void m5429$r8$lambda$mxbBfeFTETIsHMKtk_6I_mmOw(FileLoadOperation fileLoadOperation, FileLoaderPriorityQueue fileLoaderPriorityQueue) {
        ...
        public void saveFilePath(FilePathDatabase.PathData pathData, File file) {
            FileLoader.this.getFileDatabase().putPath(pathData.f1143id, pathData.f1142dc, pathData.type, 0, file != null ? file.toString() : null);
        }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public java.io.File getPathToAttach(org.telegram.tgnet.TLObject r10, java.lang.String r11, java.lang.String r12, boolean r13, boolean r14) {
        /*
    ...
    */
    ...
    public static String getAttachFileName(TLObject tLObject, String str, String str2) {
        ...
        if (z) {
            ...
            int length = extensionByMimeType.length();
            int i = document.dc_id;
            if (length > 1) {
                return i + "_" + document.f1253id + extensionByMimeType;
            }
            return i + "_" + document.f1253id;
        }
        if (tLObject instanceof SecureDocument) {
            SecureDocument secureDocument = (SecureDocument) tLObject;
            return secureDocument.secureFile.dc_id + "_" + secureDocument.secureFile.f1393id + ".jpg";
        }
        if (tLObject instanceof TLRPC.TL_secureFile) {
            TLRPC.TL_secureFile tL_secureFile = (TLRPC.TL_secureFile) tLObject;
            return tL_secureFile.dc_id + "_" + tL_secureFile.f1393id + ".jpg";
        }
    ...
    public static boolean isSamePhoto(TLRPC.FileLocation fileLocation, TLRPC.Photo photo) {
        if (fileLocation != null && (photo instanceof TLRPC.TL_photo)) {
            ...
            if ((-fileLocation.volume_id) == photo.f1276id) {
                return true;
            }
        }
        return false;
    ...
    public static long getPhotoId(TLObject tLObject) {
        if (tLObject instanceof TLRPC.Photo) {
            return ((TLRPC.Photo) tLObject).f1276id;
        }
        if (tLObject instanceof TLRPC.ChatPhoto) {
    ...
    public static class LoadOperationUIObject {
        ...
        public /* synthetic */ LoadOperationUIObject(FileLoaderIA fileLoaderIA) {
            this();
        }
        ...
        while (true) {
            ...
            if (i < fileLoaderPriorityQueueArr.length) {
                if (fileLoaderPriorityQueueArr[i].getCount() > 0 || this.largeFilesQueue[i].getCount() > 0) {
                    FileLog.m1045d("download queue: dc" + (i + 1) + " account=" + this.currentAccount + " small_operations=" + this.smallFilesQueue[i].getCount() + " large_operations=" + this.largeFilesQueue[i].getCount());
                }
                i++;
            } else {
                dumpFilesQueue();
    ...
    public void uploadFile(final String str, final Utilities.Callback<TLRPC.InputFile> callback) {
        ...
        final NotificationCenter.NotificationCenterDelegate[] notificationCenterDelegateArr = {new NotificationCenter.NotificationCenterDelegate() { // from class: org.telegram.messenger.FileLoader$$ExternalSyntheticLambda19
            ...
            public final void didReceivedNotification(int i, int i2, Object[] objArr) {
                FileLoader.m5412$r8$lambda$gKJsZClCE1qk51wAobZ3vhvknU(str, callback, runnable, i, i2, objArr);
            }
        }};
    ...
    public static /* synthetic */ void m5412$r8$lambda$gKJsZClCE1qk51wAobZ3vhvknU(String str, Utilities.Callback callback, Runnable runnable, int i, int i2, Object[] objArr) {
