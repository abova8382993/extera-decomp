...
public class ContactsController extends BaseController {
    ...
    public class MyContentObserver extends ContentObserver {
        ...
        public static /* synthetic */ void m5345$r8$lambda$V7bWM39F88C9Ch7Xl0TeFehTo() {
            for (int i = 0; i < 16; i++) {
        ...
        public MyContentObserver() {
            ...
            this.checkRunnable = new Runnable() { // from class: org.telegram.messenger.ContactsController$MyContentObserver$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    ContactsController.MyContentObserver.m5345$r8$lambda$V7bWM39F88C9Ch7Xl0TeFehTo();
                }
            };
        }
    ...
    public class C27271 extends Collator {
        @Override // java.text.Collator
        public CollationKey getCollationKey(String str) {
            return null;
        }
    ...
    public String getInviteText(int i) {
        ...
        if (i <= 1) {
            return LocaleController.formatString(C2797R.string.InviteText2, str);
        }
        try {
            ...
            for (int i = 0; i < accountsByType.length; i++) {
                ...
                while (true) {
                    if (i2 < 16) {
                        ...
                        if (currentUser != null) {
                            if (account.name.equals(_UrlKt.FRAGMENT_ENCODE_SET + currentUser.f1407id)) {
    ...
    public /* synthetic */ void lambda$checkContacts$5() {
        if (checkContactsInternal()) {
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1045d("detected contacts change");
            }
    ...
    public /* synthetic */ void lambda$forceImportContacts$6() {
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m1045d("force import contacts");
        }
    ...
    public /* synthetic */ void lambda$syncPhoneBookByAlert$7(HashMap map, boolean z, boolean z2, boolean z3) {
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m1045d("sync contacts by alert");
        }
    ...
    public void deleteAllContacts(final Runnable runnable) {
        ...
        for (int i = 0; i < size; i++) {
            tL_contacts_deleteContacts.f1298id.add(getMessagesController().getInputUser(this.contacts.get(i).user_id));
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:542:0x0547 A[Catch: all -> 0x054b, TRY_LEAVE, TryCatch #2 {all -> 0x054b, blocks: (B:540:0x0542, B:542:0x0547), top: B:568:0x0542 }] */
    /* JADX WARN: Removed duplicated region for block: B:554:0x055c  */
    /* JADX WARN: Removed duplicated region for block: B:572:0x0550 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    ...
    */
    ...
    public /* synthetic */ void lambda$migratePhoneBookToV7$12(SparseArray sparseArray) {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m1045d("migrated contacts " + map.size() + " of " + sparseArray.size());
        }
  ...
  0x01da: PHI (r16v21 int) = (r16v13 int), (r16v23 int), (r16v23 int), (r16v23 int) binds: [B:341:0x01b2, B:343:0x01bc, B:345:0x01c4, B:349:0x01d4] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public /* synthetic */ void lambda$performSyncPhoneBook$20(HashMap map, SparseArray sparseArray, final boolean[] zArr, HashMap map2, TLRPC.TL_contacts_importContacts tL_contacts_importContacts, int i, final HashMap map3, final boolean z, final HashMap map4, final ArrayList arrayList, final HashMap map5, TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (tL_error == null) {
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1045d("contacts imported");
            }
            ...
            if (!tL_contacts_importedContacts.retry_contacts.isEmpty()) {
                ...
                zArr[0] = true;
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m1045d("result has retry contacts");
                }
            }
            ...
            zArr[0] = true;
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1045d("import contacts error " + tL_error.text);
            }
        }
    ...
    public void loadContacts(boolean z, final long j) {
        ...
        if (z) {
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1045d("load contacts from cache");
            }
            getMessagesStorage().getContacts();
        } else {
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1045d("load contacts from server");
            }
    ...
    public /* synthetic */ void lambda$loadContacts$28(long j, TLObject tLObject, TLRPC.TL_error tL_error) {
        if (tL_error == null) {
            ...
            if (j != 0 && (contacts_contacts instanceof TLRPC.TL_contacts_contactsNotModified)) {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m1045d("load contacts don't change");
                    return;
                }
                return;
            }
    ...
    public /* synthetic */ void lambda$processLoadedContacts$36(final int i, final ArrayList arrayList, ArrayList arrayList2, LongSparseArray longSparseArray, final boolean z) {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m1045d("done loading contacts");
        }
    ...
    public /* synthetic */ void lambda$mergePhonebookAndTelegramContacts$41(boolean z, ArrayList arrayList, final HashMap map, final HashMap map2, final ArrayList arrayList2) {
        ...
        while (it.hasNext()) {
            Collections.sort((ArrayList) it.next(), new Comparator() { // from class: org.telegram.messenger.ContactsController$$ExternalSyntheticLambda25
                @Override // java.util.Comparator
                public final int compare(Object obj, Object obj2) {
                    return ContactsController.m5332$r8$lambda$WzPKw0eDXIhv6oQVE8ad2kfSmY(localeCollator, obj, obj2);
                }
            });
        }
    ...
    public static /* synthetic */ int m5332$r8$lambda$WzPKw0eDXIhv6oQVE8ad2kfSmY(Collator collator, Object obj, Object obj2) {
        String name;
        String name2;
    ...
    private void buildContactsSectionsArrays(boolean z) {
        ...
        Collections.sort(arrayList, new Comparator() { // from class: org.telegram.messenger.ContactsController$$ExternalSyntheticLambda18
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                return ContactsController.m5337$r8$lambda$hj1bMqpqHFptNGw1SaNPswetxQ(localeCollator, (String) obj, (String) obj2);
            }
        });
        this.usersSectionsDict = map;
    ...
    public static /* synthetic */ int m5337$r8$lambda$hj1bMqpqHFptNGw1SaNPswetxQ(Collator collator, String str, String str2) {
        char cCharAt = str.charAt(0);
        char cCharAt2 = str2.charAt(0);
        if (cCharAt == '#') {
            return 1;
        ...
        if (hasContactsPermission() && account != null && hasContactsWritePermission()) {
            ...
            try {
                ...
                if (cursorQuery != null) {
                    ...
                    cursorQuery.close();
                    FileLog.m1045d("performWriteContactsToPhoneBookInternal contacts array " + arrayList.size() + " " + z2 + " bookContactsSize=" + longSparseArray.size() + " currentAccount=" + this.currentAccount);
                ...
                FileLog.m1045d("performWriteContactsToPhoneBookInternal " + (System.currentTimeMillis() - jCurrentTimeMillis));
            } catch (Throwable th2) {
                th = th2;
                cursor = cursorQuery;
                if (cursor != null) {
    ...
    private void applyContactsUpdates(ArrayList<Long> arrayList, ConcurrentHashMap<Long, TLRPC.User> concurrentHashMap, final ArrayList<TLRPC.TL_contact> arrayList2, final ArrayList<Long> arrayList3) {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m1045d("process update - contacts add = " + arrayList2.size() + " delete = " + arrayList3.size());
        }
        StringBuilder sb = new StringBuilder();
    ...
    public void processContactsUpdates(ArrayList<Long> arrayList, ConcurrentHashMap<Long, TLRPC.User> concurrentHashMap) {
        ...
        if (!this.contactsLoaded || !this.contactsBookLoaded) {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1045d("delay update - contacts add = " + arrayList2.size() + " delete = " + arrayList3.size());
                return;
            }
            return;
        }
    ...
    public long addContactToPhoneBook(TLRPC.User user, boolean z) {
        ...
        if (z) {
            try {
                contentResolver.delete(ContactsContract.RawContacts.CONTENT_URI.buildUpon().appendQueryParameter("caller_is_syncadapter", "true").appendQueryParameter("account_name", this.systemAccount.name).appendQueryParameter("account_type", this.systemAccount.type).build(), "sync2 = " + user.f1407id, null);
            } catch (Exception unused) {
            }
        }
    ...
    private void applyContactToPhoneBook(ArrayList<ContentProviderOperation> arrayList, TLRPC.User user) {
        ...
        builderNewInsert.withValue("sync2", Long.valueOf(user.f1407id));
        ...
        builderNewInsert3.withValue("data1", Long.valueOf(user.f1407id));
        builderNewInsert3.withValue("data2", "Telegram Profile");
        builderNewInsert3.withValue("data3", LocaleController.formatString("ContactShortcutMessage", C2797R.string.ContactShortcutMessage, name));
        builderNewInsert3.withValue("data4", Long.valueOf(user.f1407id));
        ...
        builderNewInsert4.withValue("data1", Long.valueOf(user.f1407id));
        builderNewInsert4.withValue("data2", "Telegram Voice Call");
        builderNewInsert4.withValue("data3", LocaleController.formatString("ContactShortcutVoiceCall", C2797R.string.ContactShortcutVoiceCall, name));
        builderNewInsert4.withValue("data4", Long.valueOf(user.f1407id));
        ...
        builderNewInsert5.withValue("data1", Long.valueOf(user.f1407id));
        builderNewInsert5.withValue("data2", "Telegram Video Call");
        builderNewInsert5.withValue("data3", LocaleController.formatString("ContactShortcutVideoCall", C2797R.string.ContactShortcutVideoCall, name));
        builderNewInsert5.withValue("data4", Long.valueOf(user.f1407id));
    ...
    public void markAsContacted(final String str) {
        ...
        Utilities.phoneBookQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.ContactsController$$ExternalSyntheticLambda60
            @Override // java.lang.Runnable
            public final void run() {
                ContactsController.m5326$r8$lambda$KdxsDzNdBySWkSquPm6yasNp8U(str);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$KdxsDzNdBySWk-SquPm6yasNp8U */
    public static /* synthetic */ void m5326$r8$lambda$KdxsDzNdBySWkSquPm6yasNp8U(String str) {
    ...
    public void addContact(final TLRPC.User user, TLRPC.TL_textWithEntities tL_textWithEntities, boolean z) {
        ...
        tL_contacts_addContact.f1296id = getMessagesController().getInputUser(user);
    ...
    public /* synthetic */ void lambda$addContact$52(final TLRPC.User user, TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (userProfilePhoto != null && userProfilePhoto.personal) {
            for (int i = 0; i < updates.users.size(); i++) {
                if (updates.users.get(i).f1407id == user.f1407id) {
        ...
        for (int i2 = 0; i2 < updates.users.size(); i2++) {
            ...
            if (user2.f1407id == user.f1407id) {
                ...
                TLRPC.TL_contact tL_contact = new TLRPC.TL_contact();
                tL_contact.user_id = user2.f1407id;
    ...
    public /* synthetic */ void lambda$addContact$51(TLRPC.Updates updates, TLRPC.User user) {
        ...
        for (int i = 0; i < updates.users.size(); i++) {
            ...
            if (user2.contact && this.contactsDict.get(Long.valueOf(user2.f1407id)) == null) {
                TLRPC.TL_contact tL_contact = new TLRPC.TL_contact();
                tL_contact.user_id = user2.f1407id;
                this.contacts.add(tL_contact);
                this.contactsDict.put(Long.valueOf(tL_contact.user_id), tL_contact);
    ...
    public void deleteContactsUndoable(Context context, BaseFragment baseFragment, final ArrayList<TLRPC.User> arrayList) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            TLRPC.TL_contact tL_contact = this.contactsDict.get(Long.valueOf(user.f1407id));
            user.contact = false;
            this.contacts.remove(tL_contact);
            this.contactsDict.remove(Long.valueOf(user.f1407id));
    ...
    public /* synthetic */ void lambda$deleteContactsUndoable$53(HashMap map) {
        for (Map.Entry entry : map.entrySet()) {
            ...
            user.contact = true;
            this.contacts.add(tL_contact);
            this.contactsDict.put(Long.valueOf(user.f1407id), tL_contact);
        }
        buildContactsSectionsArrays(true);
        getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.updateInterfaces, Integer.valueOf(MessagesController.UPDATE_MASK_NAME));
        getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.contactsDidLoad, new Object[0]);
    ...
    public void deleteContact(final ArrayList<TLRPC.User> arrayList, final boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            TLRPC.User user = arrayList.get(i);
            getMessagesController().getStoriesController().removeContact(user.f1407id);
            TLRPC.InputUser inputUser = getMessagesController().getInputUser(user);
            if (inputUser != null) {
                user.contact = false;
                arrayList2.add(Long.valueOf(user.f1407id));
                tL_contacts_deleteContacts.f1298id.add(inputUser);
            }
        }
    ...
    public /* synthetic */ void lambda$deleteContact$55(ArrayList arrayList) {
        ...
        while (i < size) {
            ...
            i++;
            deleteContactFromPhoneBook(((TLRPC.User) obj).f1407id);
        }
    }
    ...
    public /* synthetic */ void lambda$deleteContact$56(ArrayList arrayList, boolean z, String str) {
        ...
        getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.contactsDidLoad, new Object[0]);
        if (z) {
            NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.showBulletin, 1, LocaleController.formatString("DeletedFromYourContacts", C2797R.string.DeletedFromYourContacts, str));
        }
    }
    ...
    */
        ...
        if (hasContactsPermission()) {
            try {
                ...
                if (cursorQuery2 != null && cursorQuery2.moveToFirst()) {
                    ...
                    ContentProviderOperation.Builder builderWithSelection = ContentProviderOperation.newUpdate(uri).withSelection("raw_contact_id=? AND mimetype=?", new String[]{i3 + _UrlKt.FRAGMENT_ENCODE_SET, "vnd.android.cursor.item/phone_v2"});
    ...
    public static String formatName(TLObject tLObject) {
        ...
        return LocaleController.getString(C2797R.string.HiddenName);
    }
        ...
        if (LocaleController.nameDisplayOrder == 1) {
            if (str != null && str.length() > 0) {
                ...
                if (i > 0 && str2.length() > i + 2) {
                    return str2.substring(0, i).concat("…");
                }
                sb.append(str2);
            }
        } else if (str2 != null && str2.length() > 0) {
    ...
    public class PhoneBookContact {
        ...
        public /* synthetic */ PhoneBookContact(ContactsController contactsController, ContactsControllerIA contactsControllerIA) {
            this();
        }
