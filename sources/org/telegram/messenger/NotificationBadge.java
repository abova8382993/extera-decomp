...
public class NotificationBadge {
        ...
        public void executeBadge(int i) {
            ...
            if (NotificationBadge.canResolveBroadcast(intent) || NotificationBadge.canResolveBroadcast(intent2)) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.NotificationBadge$NewHtcHomeBadger$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        NotificationBadge.NewHtcHomeBadger.m6136$r8$lambda$LNOrzcbHoddZHaXpWj71zfhB0w(intent, intent2);
                    }
                });
            }
        }

        /* JADX INFO: renamed from: $r8$lambda$LNOrzcbHoddZ-HaXpWj71zfhB0w, reason: not valid java name */
        public static /* synthetic */ void m6136$r8$lambda$LNOrzcbHoddZHaXpWj71zfhB0w(Intent intent, Intent intent2) {
            ApplicationLoader.applicationContext.sendBroadcast(intent);
    ...
    public static class XiaomiHomeBadger implements Badger {
        ...
        public void executeBadge(int i) {
            Object objValueOf;
            Object objValueOf2 = _UrlKt.FRAGMENT_ENCODE_SET;
            try {
                ...
                if (i == 0) {
                    objValueOf = _UrlKt.FRAGMENT_ENCODE_SET;
                } else {
