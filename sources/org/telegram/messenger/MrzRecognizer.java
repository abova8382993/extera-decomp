...
public class MrzRecognizer {
    ...
    private static int parseGender(char c2) {
        if (c2 != 'F') {
            return c2 != 'M' ? 0 : 1;
        }
        return 2;
    ...
    /* JADX WARN: Removed duplicated region for block: B:187:0x027d A[SYNTHETIC] */
    ...
    */
    ...
    private static int checksum(String str) {
        ...
        for (int i2 = 0; i2 < charArray.length; i2++) {
            ...
            i += ((c2 < '0' || c2 > '9') ? (c2 < 'A' || c2 > 'Z') ? 0 : c2 - '7' : c2 - '0') * iArr[i2 % 3];
        }
        return i % 10;
    }
    ...
    private static void parseBirthDate(String str, Result result) {
        try {
            ...
            result.birthYear = i;
            int i2 = (Calendar.getInstance().get(1) % 100) - 5;
            int i3 = result.birthYear;
            result.birthYear = i < i2 ? i3 + 2000 : i3 + 1900;
