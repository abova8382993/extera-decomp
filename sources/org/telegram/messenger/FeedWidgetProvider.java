...
public class FeedWidgetProvider extends AppWidgetProvider {
    ...
    public static void updateWidget(Context context, AppWidgetManager appWidgetManager, int i) {
        ...
        RemoteViews remoteViews = new RemoteViews(context.getPackageName(), C2797R.layout.feed_widget_layout);
        remoteViews.setRemoteAdapter(C2797R.id.list_view, intent);
