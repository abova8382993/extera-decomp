...
public class ChatObject {
    ...
    public static boolean isIgnoredChatRestrictionsForBoosters(TLRPC.Chat chat) {
        if (chat != null) {
            return isIgnoredChatRestrictionsForBoosters(MessagesController.getInstance(UserConfig.selectedAccount).getChatFull(chat.f1245id));
        }
        return false;
    }
    ...
    public static boolean isPossibleRemoveChatRestrictionsByBoosts(TLRPC.Chat chat) {
        if (chat != null) {
            return isPossibleRemoveChatRestrictionsByBoosts(MessagesController.getInstance(UserConfig.selectedAccount).getChatFull(chat.f1245id));
        }
        return false;
    }
    ...
    public static String getAllowedSendString(TLRPC.Chat chat) {
        ...
        if (canSendPhoto(chat)) {
            sb.append(LocaleController.getString(C2797R.string.SendMediaPermissionPhotos));
        }
        if (canSendVideo(chat)) {
            if (sb.length() > 0) {
                sb.append(", ");
            }
            sb.append(LocaleController.getString(C2797R.string.SendMediaPermissionVideos));
        }
        if (canSendStickers(chat)) {
            if (sb.length() > 0) {
                sb.append(", ");
            }
            sb.append(LocaleController.getString(C2797R.string.SendMediaPermissionStickersGifs));
        }
        if (canSendMusic(chat)) {
            if (sb.length() > 0) {
                sb.append(", ");
            }
            sb.append(LocaleController.getString(C2797R.string.SendMediaPermissionMusic));
        }
        if (canSendDocument(chat)) {
            if (sb.length() > 0) {
                sb.append(", ");
            }
            sb.append(LocaleController.getString(C2797R.string.SendMediaPermissionFiles));
        }
        if (canSendVoice(chat)) {
            if (sb.length() > 0) {
                sb.append(", ");
            }
            sb.append(LocaleController.getString(C2797R.string.SendMediaPermissionVoice));
        }
        if (canSendRoundVideo(chat)) {
            if (sb.length() > 0) {
                sb.append(", ");
            }
            sb.append(LocaleController.getString(C2797R.string.SendMediaPermissionRound));
        }
        if (canSendEmbed(chat)) {
            if (sb.length() > 0) {
                sb.append(", ");
            }
            sb.append(LocaleController.getString(C2797R.string.SendMediaEmbededLinks));
        }
        return sb.toString();
    }
    ...
    public static class Call {
        ...
        private final Runnable updateCurrentSpeakingRunnable = new Runnable() { // from class: org.telegram.messenger.ChatObject.Call.1
            ...
            public void run() {
                ...
                boolean z = false;
                while (true) {
                    int size = Call.this.currentSpeakingPeers.size();
                    call = Call.this;
                    if (i >= size) {
                        break;
                    }
                    long jKeyAt = call.currentSpeakingPeers.keyAt(i);
                    if (jUptimeMillis - Call.this.currentSpeakingPeers.get(jKeyAt).lastSpeakTime >= 500) {
                        ...
                        if (jKeyAt > 0) {
                            TLRPC.User user = MessagesController.getInstance(call2.currentAccount.getCurrentAccount()).getUser(Long.valueOf(jKeyAt));
                            StringBuilder sb = new StringBuilder("remove from speaking ");
                            sb.append(jKeyAt);
                            sb.append(" ");
                            sb.append(user != null ? user.first_name : null);
                            Log.m321d("GroupCall", sb.toString());
                        } else {
                            TLRPC.Chat chat = MessagesController.getInstance(call2.currentAccount.getCurrentAccount()).getChat(Long.valueOf(-jKeyAt));
                            StringBuilder sb2 = new StringBuilder("remove from speaking ");
                            sb2.append(jKeyAt);
                            sb2.append(" ");
                            sb2.append(chat != null ? chat.title : null);
                            Log.m321d("GroupCall", sb2.toString());
                        }
                        i--;
                        z = true;
                    }
                ...
                if (call.currentSpeakingPeers.size() > 0) {
                    AndroidUtilities.runOnUIThread(Call.this.updateCurrentSpeakingRunnable, 550L);
                }
                if (z) {
                    Call.this.currentAccount.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.groupCallSpeakingUsersUpdated, Long.valueOf(Call.this.chatId), Long.valueOf(Call.this.call.f1260id), Boolean.FALSE);
                }
            }
        };
        ...
        /* JADX INFO: loaded from: classes5.dex */
        public class RunnableC27251 implements Runnable {
            public RunnableC27251() {
            }
        ...
        public /* synthetic */ void lambda$createRtmpStreamParticipant$1() {
            this.currentAccount.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.groupCallUpdated, Long.valueOf(this.chatId), Long.valueOf(this.call.f1260id), Boolean.FALSE);
        }
        ...
        public void addSelfDummyParticipant(boolean z) {
            ...
            tL_groupCallParticipant.can_self_unmute = z2;
            ...
            AccountInstance accountInstance = this.currentAccount;
            if (selfId > 0) {
                TLRPC.UserFull userFull = MessagesController.getInstance(accountInstance.getCurrentAccount()).getUserFull(selfId);
                if (userFull != null) {
                    tL_groupCallParticipant.about = userFull.about;
                }
            } else {
                TLRPC.ChatFull chatFull = MessagesController.getInstance(accountInstance.getCurrentAccount()).getChatFull(-selfId);
                if (chatFull != null) {
        ...
        public void migrateToChat(TLRPC.Chat chat) {
            this.chatId = chat.f1245id;
            VoIPService sharedInstance = VoIPService.getSharedInstance();
            if (sharedInstance == null || sharedInstance.getAccount() != this.currentAccount.getCurrentAccount() || sharedInstance.getChat() == null || sharedInstance.getChat().f1245id != (-this.chatId)) {
                return;
            }
        ...
        private void onParticipantsLoad(ArrayList<TLRPC.GroupCallParticipant> arrayList, boolean z, String str, String str2, int i, int i2) {
            ...
            TLRPC.GroupCallParticipant groupCallParticipant3 = this.participants.get(getSelfId());
            LongSparseArray<TLRPC.GroupCallParticipant> longSparseArray = null;
            if (TextUtils.isEmpty(str)) {
                int size = this.participants.size();
                LongSparseArray<TLRPC.GroupCallParticipant> longSparseArray2 = this.participants;
                if (size != 0) {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m1045d("new participants count " + this.call.participants_count);
                }
            }
            ...
            for (int i3 = 0; i3 <= size2; i3++) {
                ...
                TLRPC.GroupCallParticipant groupCallParticipant4 = this.participants.get(MessageObject.getPeerId(groupCallParticipant.peer));
                ...
                } else if (longSparseArray != null && (groupCallParticipant2 = longSparseArray.get(MessageObject.getPeerId(groupCallParticipant.peer))) != null) {
        ...
        public void processTypingsUpdate(AccountInstance accountInstance, ArrayList<Long> arrayList, int i) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                TLRPC.GroupCallParticipant groupCallParticipant = this.participants.get(l.longValue());
            ...
            if (this.loadingGuids.remove(Integer.valueOf(i))) {
                if (tLObject != null) {
                    ...
                    for (int i2 = 0; i2 < size; i2++) {
                        ...
                        TLRPC.GroupCallParticipant groupCallParticipant2 = this.participants.get(peerId);
        ...
        private void processAllSources(TLRPC.GroupCallParticipant groupCallParticipant, boolean z) {
            ...
            while (i3 < 2) {
                ...
                if (tL_groupCallParticipantVideo != null) {
                    ...
                    if (z) {
                        String str = tL_groupCallParticipantVideo.endpoint;
                        if (i3 == 0) {
        ...
        public void processVoiceLevelsUpdate(int[] iArr, float[] fArr, boolean[] zArr) {
            ...
            while (i < iArr2.length) {
                int i2 = iArr2[i];
                if (i2 == 0) {
                    groupCallParticipant = this.participants.get(getSelfId());
                } else {
                ...
                if (groupCallParticipant != null) {
                    ...
                    if (f > 0.1f) {
                        ...
                        if (this.currentSpeakingPeers.get(peerId, null) == null) {
                            AccountInstance accountInstance = this.currentAccount;
                            if (peerId > 0) {
                                TLRPC.User user = MessagesController.getInstance(accountInstance.getCurrentAccount()).getUser(Long.valueOf(peerId));
                                StringBuilder sb = new StringBuilder("add to current speaking ");
                                sb.append(peerId);
                                sb.append(" ");
                                ...
                                j2 = jUptimeMillis;
                                TLRPC.Chat chat = MessagesController.getInstance(accountInstance.getCurrentAccount()).getChat(Long.valueOf(-peerId));
                                StringBuilder sb2 = new StringBuilder("add to current speaking ");
                                sb2.append(peerId);
                                sb2.append(" ");
                        ...
                        j = jElapsedRealtime;
                        j2 = jUptimeMillis;
                        if (j2 - groupCallParticipant.lastSpeakTime < 500 || this.currentSpeakingPeers.get(peerId, null) == null) {
                            z = z2;
                        } else {
                            this.currentSpeakingPeers.remove(peerId);
                            AccountInstance accountInstance2 = this.currentAccount;
                            if (peerId > 0) {
                                TLRPC.User user2 = MessagesController.getInstance(accountInstance2.getCurrentAccount()).getUser(Long.valueOf(peerId));
                                StringBuilder sb3 = new StringBuilder("remove from speaking ");
                                sb3.append(peerId);
                                sb3.append(" ");
                                sb3.append(user2 == null ? null : user2.first_name);
                                Log.m321d("GroupCall", sb3.toString());
                                z = z2;
                            } else {
                                MessagesController messagesController = MessagesController.getInstance(accountInstance2.getCurrentAccount());
                                z = z2;
                                TLRPC.Chat chat2 = messagesController.getChat(Long.valueOf(-peerId));
                                StringBuilder sb4 = new StringBuilder("remove from speaking ");
                                sb4.append(peerId);
                                sb4.append(" ");
                                sb4.append(chat2 == null ? null : chat2.title);
                                Log.m321d("GroupCall", sb4.toString());
                            }
                            z3 = true;
                        }
            ...
            if (z3) {
                ...
                this.currentAccount.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.groupCallSpeakingUsersUpdated, Long.valueOf(this.chatId), Long.valueOf(this.call.f1260id), Boolean.FALSE);
            }
        }

        public void updateVisibleParticipants() {
            sortParticipants();
            this.currentAccount.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.groupCallUpdated, Long.valueOf(this.chatId), Long.valueOf(this.call.f1260id), Boolean.FALSE, 0L);
        }
        ...
        private void processUpdatesQueue() {
            ...
            if (arrayList != null && !arrayList.isEmpty()) {
                ...
                while (true) {
                    ...
                    ArrayList<TL_update.TL_updateGroupCallParticipants> arrayList2 = this.updatesQueue;
                    if (size > 0) {
                        TL_update.TL_updateGroupCallParticipants tL_updateGroupCallParticipants = arrayList2.get(0);
                        ...
                        if (iIsValidUpdate == 0) {
                            ...
                            if (iIsValidUpdate == 1) {
                                if (this.updatesStartWaitTime != 0 && (z || Math.abs(System.currentTimeMillis() - this.updatesStartWaitTime) <= 1500)) {
                                    if (BuildVars.LOGS_ENABLED) {
                                        FileLog.m1045d("HOLE IN GROUP CALL UPDATES QUEUE - will wait more time");
                                    }
                                    if (z) {
                                ...
                                if (BuildVars.LOGS_ENABLED) {
                                    FileLog.m1045d("HOLE IN GROUP CALL UPDATES QUEUE - reload participants");
                                }
                        ...
                        arrayList2.clear();
                        if (BuildVars.LOGS_ENABLED) {
                            FileLog.m1045d("GROUP CALL UPDATES QUEUE PROCEED - OK");
                        }
                    }
                }
            }
        ...
        public void checkQueue() {
            ...
            if (this.updatesStartWaitTime != 0 && System.currentTimeMillis() - this.updatesStartWaitTime >= 1500) {
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m1045d("QUEUE GROUP CALL UPDATES WAIT TIMEOUT - CHECK QUEUE");
                }
                processUpdatesQueue();
            }
        ...
        public /* synthetic */ void lambda$loadGroupCall$10(TLObject tLObject) {
            ...
            if (tLObject != null) {
                ...
                if (i != i2) {
                    groupCall.participants_count = i2;
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m1045d("new participants reload count " + this.call.participants_count);
                    }
                    this.currentAccount.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.groupCallUpdated, Long.valueOf(this.chatId), Long.valueOf(this.call.f1260id), Boolean.FALSE);
                }
            }
        ...
        public void processParticipantsUpdate(TL_update.TL_updateGroupCallParticipants tL_updateGroupCallParticipants, boolean z) {
            ...
            if (!z) {
                ...
                if (z4 && this.call.version + 1 < tL_updateGroupCallParticipants.version) {
                    if (this.reloadingMembers || this.updatesStartWaitTime == 0 || Math.abs(System.currentTimeMillis() - this.updatesStartWaitTime) <= 1500) {
                        ...
                        if (BuildVars.LOGS_ENABLED) {
                            FileLog.m1045d("add TL_updateGroupCallParticipants to queue " + tL_updateGroupCallParticipants.version);
                        }
                ...
                if (z4 && tL_updateGroupCallParticipants.version < this.call.version) {
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m1045d("ignore processParticipantsUpdate because of version");
                        return;
                    }
                    return;
                }
            ...
            while (i3 < size2) {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    z2 = z5;
                    FileLog.m1045d("process participant " + peerId + " left = " + groupCallParticipant.left + " versioned " + groupCallParticipant.versioned + " flags = " + groupCallParticipant.flags + " self = " + selfId + " volume = " + groupCallParticipant.volume);
                } else {
                    z2 = z5;
                }
                TLRPC.GroupCallParticipant groupCallParticipant2 = this.participants.get(peerId);
                if (groupCallParticipant.left) {
                    if (groupCallParticipant2 == null) {
                        ...
                        if (tL_updateGroupCallParticipants.version == this.call.version) {
                            if (BuildVars.LOGS_ENABLED) {
                                FileLog.m1045d("unknowd participant left, reload call");
                            }
                            z6 = z2;
                        }
                    } else {
                    ...
                    if (groupCallParticipant2 != null) {
                        ...
                        if (this.currentSpeakingPeers.get(peerId, null) != null) {
                            ...
                            if (peerId > j5) {
                                TLRPC.User user = MessagesController.getInstance(accountInstance.getCurrentAccount()).getUser(Long.valueOf(peerId));
                                StringBuilder sb = new StringBuilder("left remove from speaking ");
                                sb.append(peerId);
                                sb.append(" ");
                                sb.append(user == null ? null : user.first_name);
                                Log.m321d("GroupCall", sb.toString());
                                ...
                                j2 = jElapsedRealtime;
                                TLRPC.Chat chat = MessagesController.getInstance(accountInstance.getCurrentAccount()).getChat(Long.valueOf(-peerId));
                                StringBuilder sb2 = new StringBuilder("left remove from speaking ");
                                sb2.append(peerId);
                                sb2.append(" ");
                                sb2.append(chat == null ? null : chat.title);
                                Log.m321d("GroupCall", sb2.toString());
                    ...
                    if (groupCallParticipant2 != null) {
                        if (BuildVars.LOGS_ENABLED) {
                            FileLog.m1045d("new participant, update old");
                        }
                        ...
                        if (groupCallParticipant.muted && this.currentSpeakingPeers.get(peerId, null) != null) {
                            ...
                            if (peerId > j5) {
                                TLRPC.User user2 = MessagesController.getInstance(accountInstance2.getCurrentAccount()).getUser(Long.valueOf(peerId));
                                StringBuilder sb3 = new StringBuilder("muted remove from speaking ");
                                sb3.append(peerId);
                                sb3.append(" ");
                                sb3.append(user2 == null ? null : user2.first_name);
                                Log.m321d("GroupCall", sb3.toString());
                            } else {
                                TLRPC.Chat chat2 = MessagesController.getInstance(accountInstance2.getCurrentAccount()).getChat(Long.valueOf(-peerId));
                                StringBuilder sb4 = new StringBuilder("muted remove from speaking ");
                                sb4.append(peerId);
                                sb4.append(" ");
                                sb4.append(chat2 == null ? null : chat2.title);
                                Log.m321d("GroupCall", sb4.toString());
                        ...
                        if (groupCallParticipant.just_joined) {
                            ...
                            if (tL_updateGroupCallParticipants.version == groupCall2.version) {
                                if (BuildVars.LOGS_ENABLED) {
                                    FileLog.m1045d("new participant, just joined, reload call");
                                }
                                z6 = true;
                            } else if (BuildVars.LOGS_ENABLED) {
                                FileLog.m1045d("new participant, just joined");
                            }
                        }
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1045d("new participants count after update " + this.call.participants_count);
            }
            if (z6) {
                loadGroupCall();
            }
            if (z7) {
                ...
                this.currentAccount.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.groupCallUpdated, Long.valueOf(this.chatId), Long.valueOf(this.call.f1260id), Boolean.valueOf(z10), Long.valueOf(j4));
            }
            if (z9) {
                this.currentAccount.getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.groupCallSpeakingUsersUpdated, Long.valueOf(this.chatId), Long.valueOf(this.call.f1260id), Boolean.FALSE);
            }
        ...
        public TLRPC.InputGroupCall getInputGroupCall(boolean z) {
            ...
            if (z) {
                ...
                tL_inputGroupCallSlug.slug = Uri.parse(this.call.invite_link).getPathSegments().get(r2.size() - 1);
        ...
        public void sortParticipants() {
            ...
            if (this.sortedParticipants.isEmpty()) {
                ...
                groupCallParticipant = arrayList2.get(arrayList2.size() - 1);
            }
            ...
            int size3 = 0;
            while (true) {
                int size4 = this.sortedParticipants.size();
                arrayList = this.sortedParticipants;
                if (i6 >= size4) {
                    break;
                }
                TLRPC.GroupCallParticipant groupCallParticipant4 = arrayList.get(i6);
            ...
            int i7 = 0;
            while (i7 < size5) {
                TLRPC.GroupCallParticipant groupCallParticipant5 = arrayList.get(i7);
                i7++;
    ...
    public static boolean hasStories(TLRPC.Chat chat) {
        return chat != null && MessagesController.getInstance(UserConfig.selectedAccount).getStoriesController().hasStories(-chat.f1245id);
    }
    ...
    public static boolean canDeleteTopic(int i, TLRPC.Chat chat, long j) {
        return (j == 1 || chat == null || !canDeleteTopic(i, chat, MessagesController.getInstance(i).getTopicsController().findTopic(chat.f1245id, j))) ? false : true;
    }
    ...
    public static boolean canDeleteTopic(int i, TLRPC.Chat chat, TLRPC.TL_forumTopic tL_forumTopic) {
        ...
        if (!canUserDoAction(chat, 13)) {
            if (isMyTopic(i, tL_forumTopic) && (message = tL_forumTopic.topMessage) != null && (message2 = tL_forumTopic.topicStartMessage) != null) {
                int i2 = message.f1271id - message2.f1271id;
    ...
    public static boolean isMyTopic(int i, TLRPC.Chat chat, long j) {
        return chat != null && chat.forum && isMyTopic(i, chat.f1245id, j);
    }
    ...
    public static String getRestrictedErrorText(TLRPC.Chat chat, int i) {
        if (i == 23) {
            if (chat == null || isActionBannedByDefault(chat, i)) {
                return LocaleController.getString(C2797R.string.GlobalAttachGifRestricted);
            }
            if (AndroidUtilities.isBannedForever(chat.banned_rights)) {
                return LocaleController.formatString("AttachGifRestrictedForever", C2797R.string.AttachGifRestrictedForever, new Object[0]);
            }
            return LocaleController.formatString("AttachGifRestricted", C2797R.string.AttachGifRestricted, LocaleController.formatDateForBan(chat.banned_rights.until_date));
        }
        if (i == 8) {
            if (chat == null || isActionBannedByDefault(chat, i)) {
                return LocaleController.getString(C2797R.string.GlobalAttachStickersRestricted);
            }
            if (AndroidUtilities.isBannedForever(chat.banned_rights)) {
                return LocaleController.formatString("AttachStickersRestrictedForever", C2797R.string.AttachStickersRestrictedForever, new Object[0]);
            }
            return LocaleController.formatString("AttachStickersRestricted", C2797R.string.AttachStickersRestricted, LocaleController.formatDateForBan(chat.banned_rights.until_date));
        }
        if (i == 16) {
            if (chat == null || isActionBannedByDefault(chat, i)) {
                return LocaleController.getString(C2797R.string.GlobalAttachPhotoRestricted);
            }
            if (AndroidUtilities.isBannedForever(chat.banned_rights)) {
                return LocaleController.formatString("AttachPhotoRestrictedForever", C2797R.string.AttachPhotoRestrictedForever, new Object[0]);
            }
            return LocaleController.formatString("AttachPhotoRestricted", C2797R.string.AttachPhotoRestricted, LocaleController.formatDateForBan(chat.banned_rights.until_date));
        }
        if (i == 17) {
            if (chat == null || isActionBannedByDefault(chat, i)) {
                return LocaleController.getString(C2797R.string.GlobalAttachVideoRestricted);
            }
            if (AndroidUtilities.isBannedForever(chat.banned_rights)) {
                return LocaleController.formatString("AttachVideoRestrictedForever", C2797R.string.AttachVideoRestrictedForever, new Object[0]);
            }
            return LocaleController.formatString("AttachVideoRestricted", C2797R.string.AttachVideoRestricted, LocaleController.formatDateForBan(chat.banned_rights.until_date));
        }
        if (i == 19) {
            if (chat == null || isActionBannedByDefault(chat, i)) {
                return LocaleController.getString(C2797R.string.GlobalAttachDocumentsRestricted);
            }
            if (AndroidUtilities.isBannedForever(chat.banned_rights)) {
                return LocaleController.formatString("AttachDocumentsRestrictedForever", C2797R.string.AttachDocumentsRestrictedForever, new Object[0]);
            }
            return LocaleController.formatString("AttachDocumentsRestricted", C2797R.string.AttachDocumentsRestricted, LocaleController.formatDateForBan(chat.banned_rights.until_date));
        }
        if (i == 7) {
            if (chat == null || isActionBannedByDefault(chat, i)) {
                return LocaleController.getString(C2797R.string.GlobalAttachMediaRestricted);
            }
            if (AndroidUtilities.isBannedForever(chat.banned_rights)) {
                return LocaleController.formatString("AttachMediaRestrictedForever", C2797R.string.AttachMediaRestrictedForever, new Object[0]);
            }
            return LocaleController.formatString("AttachMediaRestricted", C2797R.string.AttachMediaRestricted, LocaleController.formatDateForBan(chat.banned_rights.until_date));
        }
        if (i == 18) {
            if (chat == null || isActionBannedByDefault(chat, i)) {
                return LocaleController.getString(C2797R.string.GlobalAttachAudioRestricted);
            }
            if (AndroidUtilities.isBannedForever(chat.banned_rights)) {
                return LocaleController.formatString("AttachAudioRestrictedForever", C2797R.string.AttachAudioRestrictedForever, new Object[0]);
            }
            return LocaleController.formatString("AttachAudioRestricted", C2797R.string.AttachAudioRestricted, LocaleController.formatDateForBan(chat.banned_rights.until_date));
        }
        if (i == 22) {
            if (chat == null || isActionBannedByDefault(chat, i)) {
                return LocaleController.getString(C2797R.string.GlobalAttachPlainRestricted);
            }
            if (AndroidUtilities.isBannedForever(chat.banned_rights)) {
                return LocaleController.formatString("AttachPlainRestrictedForever", C2797R.string.AttachPlainRestrictedForever, new Object[0]);
            }
            return LocaleController.formatString("AttachPlainRestricted", C2797R.string.AttachPlainRestricted, LocaleController.formatDateForBan(chat.banned_rights.until_date));
        }
        if (i == 21) {
            if (chat == null || isActionBannedByDefault(chat, i)) {
                return LocaleController.getString(C2797R.string.GlobalAttachRoundRestricted);
            }
            if (AndroidUtilities.isBannedForever(chat.banned_rights)) {
                return LocaleController.formatString("AttachRoundRestrictedForever", C2797R.string.AttachRoundRestrictedForever, new Object[0]);
            }
            return LocaleController.formatString("AttachRoundRestricted", C2797R.string.AttachRoundRestricted, LocaleController.formatDateForBan(chat.banned_rights.until_date));
        }
        if (i == 20) {
            if (chat == null || isActionBannedByDefault(chat, i)) {
                return LocaleController.getString(C2797R.string.GlobalAttachVoiceRestricted);
            }
            if (AndroidUtilities.isBannedForever(chat.banned_rights)) {
                return LocaleController.formatString("AttachVoiceRestrictedForever", C2797R.string.AttachVoiceRestrictedForever, new Object[0]);
            }
            return LocaleController.formatString("AttachVoiceRestricted", C2797R.string.AttachVoiceRestricted, LocaleController.formatDateForBan(chat.banned_rights.until_date));
        }
