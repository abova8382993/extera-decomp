...
public class FactCheckController {
    ...
    public TLRPC.TL_factCheck getFactCheck(final MessageObject messageObject) {
        ...
        final Key keyM1132of = Key.m1132of(messageObject);
        if (keyM1132of == null || keyM1132of.messageId < 0) {
            return null;
        }
        TLRPC.TL_factCheck tL_factCheck3 = this.localCache.get(keyM1132of.hash);
        if (tL_factCheck3 != null) {
            messageObject.messageOwner.factcheck = tL_factCheck3;
            return tL_factCheck3;
        }
        if (this.loading.contains(keyM1132of)) {
            return messageObject.messageOwner.factcheck;
        }
        HashMap<Key, Utilities.Callback<TLRPC.TL_factCheck>> map = this.toload.get(keyM1132of.dialogId);
        if (map == null) {
            LongSparseArray<HashMap<Key, Utilities.Callback<TLRPC.TL_factCheck>>> longSparseArray2 = this.toload;
            long j = keyM1132of.dialogId;
            HashMap<Key, Utilities.Callback<TLRPC.TL_factCheck>> map2 = new HashMap<>();
            longSparseArray2.put(j, map2);
            map = map2;
        }
        if (!map.containsKey(keyM1132of)) {
            map.put(keyM1132of, new Utilities.Callback() { // from class: org.telegram.messenger.FactCheckController$$ExternalSyntheticLambda15
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    this.f$0.lambda$getFactCheck$0(keyM1132of, messageObject, (TLRPC.TL_factCheck) obj);
                }
            });
            scheduleLoadMissing();
        }
    ...
    static class Key {
        ...
        public int hashCode() {
            return CameraTimestamp$$ExternalSyntheticBackport0.m47m(this.hash);
        }

        /* JADX INFO: renamed from: of */
        public static Key m1132of(MessageObject messageObject) {
            TLRPC.Message message;
    ...
    */
    public static /* synthetic */ void $r8$lambda$eRU3nxQjWPT8Oj30fqwMG3VVK3A(org.telegram.messenger.MessagesStorage r10, java.util.ArrayList r11, final org.telegram.messenger.Utilities.Callback r12) throws java.lang.Throwable {
        ...
        La6:
            ...
            goto Lb2
        Laa:
            org.telegram.messenger.FileLog.m1136e(r10)     // Catch: java.lang.Throwable -> L2c
            if (r1 == 0) goto Lb2
            r1.dispose()
        Lb2:
    ...
    private void saveToDatabase(final TLRPC.TL_factCheck tL_factCheck) {
        ...
        messagesStorage.getStorageQueue().postRunnable(new Runnable() { // from class: org.telegram.messenger.FactCheckController$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() throws Throwable {
                FactCheckController.m4031$r8$lambda$hwZvWtn8X40ulbUsYqEavkirk8(messagesStorage, tL_factCheck);
            }
        });
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static /* synthetic */ void m4031$r8$lambda$hwZvWtn8X40ulbUsYqEavkirk8(org.telegram.messenger.MessagesStorage r6, org.telegram.tgnet.TLRPC.TL_factCheck r7) throws java.lang.Throwable {
        /*
            r0 = 0
        ...
        L49:
            ...
            r1 = r0
        L4b:
            org.telegram.messenger.FileLog.m1136e(r7)     // Catch: java.lang.Throwable -> L59
            if (r0 == 0) goto L53
            r0.dispose()
        L53:
            if (r1 == 0) goto L58
        ...
        L64:
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.messenger.FactCheckController.m4031$r8$lambda$hwZvWtn8X40ulbUsYqEavkirk8(org.telegram.messenger.MessagesStorage, org.telegram.tgnet.TLRPC$TL_factCheck):void");
    }
    ...
    public void openFactCheckEditor(Context context, final Theme.ResourcesProvider resourcesProvider, final MessageObject messageObject, boolean z) {
        ...
        builder2.setTitle(LocaleController.getString(C2888R.string.FactCheckDialog));
        ...
        final EditTextCaption editTextCaption = new EditTextCaption(context, resourcesProvider) { // from class: org.telegram.messenger.FactCheckController.1
            ...
            protected void extendActionMode(ActionMode actionMode, Menu menu) {
                if (menu.findItem(C2888R.id.menu_bold) != null) {
                    return;
                }
                menu.removeItem(android.R.id.shareText);
                SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(LocaleController.getString(C2888R.string.Bold));
                spannableStringBuilder.setSpan(new TypefaceSpan(AndroidUtilities.bold()), 0, spannableStringBuilder.length(), 33);
                menu.add(C2888R.id.menu_groupbolditalic, C2888R.id.menu_bold, 6, spannableStringBuilder);
                SpannableStringBuilder spannableStringBuilder2 = new SpannableStringBuilder(LocaleController.getString(C2888R.string.Italic));
                ...
                menu.add(C2888R.id.menu_groupbolditalic, C2888R.id.menu_italic, 7, spannableStringBuilder2);
                menu.add(C2888R.id.menu_groupbolditalic, C2888R.id.menu_link, 8, LocaleController.getString(C2888R.string.CreateLink));
                menu.add(C2888R.id.menu_groupbolditalic, C2888R.id.menu_regular, 9, LocaleController.getString(C2888R.string.Regular));
            }
        ...
        editTextCaption.setHintText(LocaleController.getString(C2888R.string.FactCheckPlaceholder));
        ...
        editTextCaption.addTextChangedListener(new TextWatcher() { // from class: org.telegram.messenger.FactCheckController.3
            ...
            public void afterTextChanged(Editable editable) {
                ...
                if (textViewArr[0] != null) {
                    ...
                    textViewArr[0].setText(LocaleController.getString(z5 ? C2888R.string.Done : C2888R.string.Remove));
        ...
        builder2.setWidth(AndroidUtilities.m1124dp(292.0f));
        builder2.setPositiveButton(LocaleController.getString(C2888R.string.Done), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.messenger.FactCheckController$$ExternalSyntheticLambda2
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i2) {
                this.f$0.lambda$openFactCheckEditor$8(editTextCaption, i, messageObject, z4, alertDialog, i2);
            }
        });
        builder2.setNegativeButton(LocaleController.getString("Cancel", C2888R.string.Cancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.messenger.FactCheckController$$ExternalSyntheticLambda3
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i2) {
                alertDialog.dismiss();
            }
    ...
    public /* synthetic */ void lambda$applyFactCheck$15(final TLObject tLObject, TLRPC.TL_textWithEntities tL_textWithEntities, boolean z, AlertDialog alertDialog) {
        if (tLObject instanceof TLRPC.Updates) {
            ...
            if (safeLastFragment != null) {
                ...
                if (z2 || !z) {
                    BulletinFactory.m1246of(safeLastFragment).createSimpleBulletin(z2 ? C2888R.raw.ic_delete : C2888R.raw.contact_check, LocaleController.getString(z2 ? C2888R.string.FactCheckDeleted : C2888R.string.FactCheckEdited)).show();
                }
            }
        }
        alertDialog.dismiss();
