...
public class LocationSharingService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void lambda$onCreate$1() {
        ...
        Utilities.stageQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.LocationSharingService$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                LocationSharingService.m5642$r8$lambda$jDpuTonJalawPNBnRWljHyRr88();
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$jDpuTo-nJalawPNBnRWljHyRr88 */
    public static /* synthetic */ void m5642$r8$lambda$jDpuTonJalawPNBnRWljHyRr88() {
        for (int i = 0; i < 16; i++) {
    ...
    private void updateNotification(boolean z) {
        ...
        String str = String.format(string, LocaleController.getString(C2797R.string.AttachLiveLocation), pluralString);
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        try {
            if (this.builder == null) {
                ...
                this.builder.setSmallIcon(C2797R.drawable.live_loc);
                this.builder.setContentIntent(activity);
                NotificationsController.checkOtherNotificationsChannel();
                this.builder.setChannelId(NotificationsController.OTHER_NOTIFICATIONS_CHANNEL);
                this.builder.setContentTitle(LocaleController.getString(C2797R.string.AppName));
                this.builder.addAction(0, LocaleController.getString(C2797R.string.StopLiveLocation), PendingIntent.getBroadcast(ApplicationLoader.applicationContext, 2, new Intent(ApplicationLoader.applicationContext, (Class<?>) StopLiveLocationReceiver.class), 167772160));
            }
