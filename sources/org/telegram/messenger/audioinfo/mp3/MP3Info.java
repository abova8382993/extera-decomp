...
public class MP3Info extends AudioInfo {
    ...
    public MP3Info(InputStream inputStream, long j, Level level) throws IOException {
        ...
        if (j2 <= 0 || j2 >= DurationKt.MILLIS_IN_HOUR) {
            try {
                this.duration = calculateDuration(mP3Input, j, new StopReadCondition(j) { // from class: org.telegram.messenger.audioinfo.mp3.MP3Info.1
                    ...
                    public C28211(long j3) {
                        this.val$fileLength = j3;
                        this.stopPosition = j3 - 128;
                    }
    ...
    /* JADX INFO: renamed from: org.telegram.messenger.audioinfo.mp3.MP3Info$1 */
    public class C28211 implements StopReadCondition {
        final long stopPosition;
        final /* synthetic */ long val$fileLength;
    ...
    public MP3Frame readFirstFrame(MP3Input mP3Input, StopReadCondition stopReadCondition) throws IOException {
        ...
        int i2 = 0;
        while (i != -1) {
            if (i2 == 255 && (i & Opcodes.SHL_INT_LIT8) == 224) {
                mP3Input.mark(2);
                ...
                MP3Frame.Header header = new MP3Frame.Header(i, i3, i4);
                mP3Input.reset();
                ...
                try {
                    ...
                    if (!mP3Frame.isChecksumError()) {
                        ...
                        if (i6 != -1 && i7 != -1) {
                            if (i6 == 255 && (i7 & Opcodes.CONST_METHOD_HANDLE) == (i & Opcodes.CONST_METHOD_HANDLE)) {
    ...
    public MP3Frame readNextFrame(MP3Input mP3Input, StopReadCondition stopReadCondition, MP3Frame mP3Frame) throws MP3Exception, IOException {
        ...
        if (i != -1 && i2 != -1) {
            if (i == 255 && (i2 & Opcodes.SHL_INT_LIT8) == 224) {
                int i3 = stopReadCondition.stopRead(mP3Input) ? -1 : mP3Input.read();
                int i4 = stopReadCondition.stopRead(mP3Input) ? -1 : mP3Input.read();
                if (i3 == -1 || i4 == -1) {
                    return null;
    ...
    public long calculateDuration(MP3Input mP3Input, long j, StopReadCondition stopReadCondition) throws MP3Exception, IOException {
        ...
        if (firstFrame != null) {
            ...
            long j2 = bitrate;
            int duration = XCallback.PRIORITY_HIGHEST / firstFrame.getHeader().getDuration();
            boolean z = false;
            int i = 1;
            while (true) {
                if (i == duration && !z && j > 0) {
