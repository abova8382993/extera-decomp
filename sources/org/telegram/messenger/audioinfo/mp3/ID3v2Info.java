...
public class ID3v2Info extends AudioInfo {
    ...
    public static class AttachedPicture {
        ...
        public AttachedPicture(byte b2, String str, String str2, byte[] bArr) {
            this.type = b2;
    ...
    public void parseFrame(ID3v2FrameBody iD3v2FrameBody) throws IOException, ID3v2Exception {
        ...
        switch (frameId) {
            ...
            case "COMM":
                ...
                if (this.comment == null || (str = commentOrUnsynchronizedLyricsFrame.description) == null || _UrlKt.FRAGMENT_ENCODE_SET.equals(str)) {
            ...
            case "APIC":
                if (this.cover == null || this.coverPictureType != 3) {
                    ...
                    if (this.cover == null || (b2 = attachedPictureFrame.type) == 3 || b2 == 0) {
                        try {
                    ...
                    if (iIndexOf2 < 0) {
                        try {
                            ...
                            if (logger3.isLoggable(this.debugLevel)) {
                                logger3.log(this.debugLevel, "Could not parse disc number: ".concat(textFrame3));
                                return;
                            }
                            return;
                        }
                        ...
                        try {
                            ...
                            if (logger4.isLoggable(this.debugLevel)) {
                                logger4.log(this.debugLevel, "Could not parse disc number: ".concat(textFrame3));
                            }
                        }
                        try {
                            ...
                            if (logger5.isLoggable(this.debugLevel)) {
                                logger5.log(this.debugLevel, "Could not parse number of discs: ".concat(textFrame3));
                                return;
                            }
                            return;
                        }
                    ...
                    if (iIndexOf3 < 0) {
                        try {
                            ...
                            if (logger6.isLoggable(this.debugLevel)) {
                                logger6.log(this.debugLevel, "Could not parse track number: ".concat(textFrame4));
                                return;
                            }
                            return;
                        }
                        ...
                        try {
                            ...
                            if (logger7.isLoggable(this.debugLevel)) {
                                logger7.log(this.debugLevel, "Could not parse track number: ".concat(textFrame4));
                            }
                        }
                        try {
                            ...
                            if (logger8.isLoggable(this.debugLevel)) {
                                logger8.log(this.debugLevel, "Could not parse number of tracks: ".concat(textFrame4));
                                return;
                            }
                            return;
                        }
                ...
                if (textFrame5.length() > 0) {
                    try {
                        ...
                        if (logger9.isLoggable(this.debugLevel)) {
                            logger9.log(this.debugLevel, "Could not parse year: ".concat(textFrame5));
                            return;
                        }
                        return;
                    }
                ...
                if (textFrame6.length() >= 4) {
                    try {
                        ...
                        if (logger10.isLoggable(this.debugLevel)) {
                            logger10.log(this.debugLevel, "Could not parse year from: ".concat(textFrame6));
                            return;
                        }
                        return;
                    }
