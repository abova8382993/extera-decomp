...
public class MP4Atom extends MP4Box<RangeInputStream> {
    ...
    public MP4Atom nextChildUpTo(String str) throws IOException {
        ...
        ZipFileSystem$$ExternalSyntheticBUOutline0.m996m("atom type mismatch, not found: ", str);
        return null;
    }
    ...
    public BigDecimal readShortFixedPoint() throws IOException {
        return new BigDecimal(String.valueOf((int) this.data.readByte()) + _UrlKt.FRAGMENT_ENCODE_SET + String.valueOf(this.data.readUnsignedByte()));
    }

    public BigDecimal readIntegerFixedPoint() throws IOException {
        return new BigDecimal(String.valueOf((int) this.data.readShort()) + _UrlKt.FRAGMENT_ENCODE_SET + String.valueOf(this.data.readUnsignedShort()));
    }
