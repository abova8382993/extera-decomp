...
public class SharedConfig {
    ...
    public static /* synthetic */ void m4901$r8$lambda$AgzMnIFjDK3Boj0GV34UBf8Qd8(AlertDialog alertDialog, int i) {
    }

    /* JADX INFO: renamed from: $r8$lambda$c1nolnMM8hkF5gEowxjTAWjtK-M */
    public static /* synthetic */ void m4902$r8$lambda$c1nolnMM8hkF5gEowxjTAWjtKM() {
    }
    ...
    public static /* synthetic */ void $r8$lambda$5WZZbls8uHKhzrNqXgCrVdV5Lyk() {
        ...
        ImageLoader.getInstance().checkMediaPaths(new Runnable() { // from class: org.telegram.messenger.SharedConfig$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                SharedConfig.m4902$r8$lambda$c1nolnMM8hkF5gEowxjTAWjtKM();
            }
        });
        readOnlyStorageDirAlertShowed = true;
        AlertDialog.Builder builder = new AlertDialog.Builder(lastFragment.getParentActivity());
        builder.setTitle(LocaleController.getString(C2888R.string.SdCardError));
        builder.setSubtitle(LocaleController.getString(C2888R.string.SdCardErrorDescription));
        builder.setPositiveButton(LocaleController.getString(C2888R.string.DoNotUseSDCard), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.messenger.SharedConfig$$ExternalSyntheticLambda4
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
                SharedConfig.m4901$r8$lambda$AgzMnIFjDK3Boj0GV34UBf8Qd8(alertDialog, i);
            }
        });
        ...
        if (!TextUtils.isEmpty(string5)) {
            ...
            if (int32 == -1) {
                ...
                if (b == 2) {
                    ...
                    FileLog.m1134e("Unknown proxy schema version: " + ((int) b));
                }
            } else {
    ...
    public static void saveProxyList() {
        ...
        Collections.sort(arrayList, new Comparator() { // from class: org.telegram.messenger.SharedConfig$$ExternalSyntheticLambda2
            ...
            public final int compare(Object obj, Object obj2) {
                return SharedConfig.m4900$r8$lambda$3gtbUfC6wnjRm8ZleoIGK_ytoQ((SharedConfig.ProxyInfo) obj, (SharedConfig.ProxyInfo) obj2);
            }
        });
    ...
    public static /* synthetic */ int m4900$r8$lambda$3gtbUfC6wnjRm8ZleoIGK_ytoQ(ProxyInfo proxyInfo, ProxyInfo proxyInfo2) {
    ...
    public static int measureDevicePerformanceClass() {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m1133d("device performance info selected_class = " + i3 + " (cpu_count = " + i2 + ", freq = " + iCeil + ", memoryClass = " + memoryClass + ", android version " + i + ", manufacture " + Build.MANUFACTURER + ", screenRefreshRate=" + AndroidUtilities.screenRefreshRate + ", screenMaxRefreshRate=" + AndroidUtilities.screenMaxRefreshRate + ")");
        }
        return i3;
    }
