...
public class ChromecastController implements SessionManagerListener<CastSession> {
    ...
    public void setCurrentMediaAndCastIfNeeded(ChromecastMediaVariations chromecastMediaVariations) {
        ...
        if (CastSync.isActive() && m1094eq(media, chromecastMediaVariations)) {
            return;
        }
    ...
    public static boolean m1094eq(ChromecastMediaVariations chromecastMediaVariations, ChromecastMediaVariations chromecastMediaVariations2) {
        ...
        for (int i = 0; i < chromecastMediaVariations.getVariationsCount(); i++) {
            if (!m1093eq(chromecastMediaVariations.getVariation(i), chromecastMediaVariations2.getVariation(i))) {
                return false;
            }
        }
        return true;
    ...
    /* JADX INFO: renamed from: eq */
    public static boolean m1093eq(ChromecastMedia chromecastMedia, ChromecastMedia chromecastMedia2) {
