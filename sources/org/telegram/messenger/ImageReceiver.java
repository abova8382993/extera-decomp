...
import org.telegram.p035ui.Components.RecyclableDrawable;
import org.telegram.p035ui.Components.VectorAvatarThumbDrawable;
...
public class ImageReceiver implements NotificationCenter.NotificationCenterDelegate, AnimatedEmojiSpan.InvalidateHolder {
    ...
    public interface ImageReceiverDelegate {
        ...
        default void didSetImageBitmap(int i, String str, Drawable drawable) {
        }
    ...
    public static class SetImageBackup {
        ...
        public /* synthetic */ SetImageBackup(ImageReceiverIA imageReceiverIA) {
            this();
        }
    ...
    public ImageReceiver(View view) {
        ...
        this.clip = true;
        this.invalidateRunnable = new ImageReceiver$$ExternalSyntheticLambda1(this);
    ...
    */
    ...
    public void setImage(ImageLocation imageLocation, String str, ImageLocation imageLocation2, String str2, ImageLocation imageLocation3, String str3, Drawable drawable, long j, String str4, Object obj, int i) {
        ...
        if (key == null && this.needsQualityThumb && ((obj instanceof MessageObject) || this.qulityThumbDocument != null)) {
            ...
            if (document != null && document.dc_id != 0 && document.f1253id != 0) {
                key = "q_" + document.dc_id + "_" + document.f1253id;
    ...
    /* JADX WARN: Can't wrap try/catch for region: R(8:820|(1:822)(8:824|(2:826|(1:828))|829|(1:832)|857|833|(1:843)(4:836|(1:838)|839|842)|(2:848|849)(1:870))|823|(1:832)|857|833|(1:843)(1:844)|(0)(0)) */
    /* JADX WARN: Code restructure failed: missing block: B:840:0x08d7, code lost:
    
        r0 = move-exception;
     */
    /* JADX WARN: Code restructure failed: missing block: B:846:0x08f7, code lost:
    
        org.telegram.messenger.FileLog.m1048e(r0);
     */
    /* JADX WARN: Removed duplicated region for block: B:848:0x08fc  */
    /* JADX WARN: Removed duplicated region for block: B:870:? A[RETURN, SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void drawDrawable(android.graphics.Canvas r40, android.graphics.drawable.Drawable r41, int r42, android.graphics.BitmapShader r43, int r44, int r45, int r46, org.telegram.messenger.ImageReceiver.BackgroundThreadDrawHolder r47) {
        /*
    ...
    private void checkAlphaAnimation(boolean z, BackgroundThreadDrawHolder backgroundThreadDrawHolder) {
        ...
        if (f != 1.0f) {
            ...
            if (backgroundThreadDrawHolder != null) {
                AndroidUtilities.runOnUIThread(new ImageReceiver$$ExternalSyntheticLambda1(this));
            } else {
                invalidate();
            }
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:373:0x02d1 A[Catch: Exception -> 0x02d5, TRY_LEAVE, TryCatch #2 {Exception -> 0x02d5, blocks: (B:304:0x01c2, B:357:0x025a, B:371:0x02cc, B:373:0x02d1), top: B:421:0x01c2 }] */
    /* JADX WARN: Removed duplicated region for block: B:416:0x035d A[LOOP:0: B:414:0x0355->B:416:0x035d, LOOP_END] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:89:0x0094 A[RETURN] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public org.telegram.messenger.ImageReceiver.BitmapHolder getBitmapSafe() {
        /*
            r6 = this;
            org.telegram.ui.Components.AnimatedFileDrawable r0 = r6.getAnimation()
            org.telegram.ui.Components.RLottieDrawable r1 = r6.getLottieAnimation()
            r2 = 0
            r3 = 0
            if (r1 == 0) goto L19
            boolean r4 = r1.hasBitmap()
            if (r4 == 0) goto L19
            android.graphics.Bitmap r6 = r1.getAnimatedBitmap()
        L16:
            r0 = r2
            goto L8c
        L19:
            ...
            if (r1 == 0) goto L35
            android.graphics.Bitmap r6 = r0.getAnimatedBitmap()
            ...
            return r0
        L35:
            android.graphics.drawable.Drawable r0 = r6.currentMediaDrawable
            boolean r1 = r0 instanceof android.graphics.drawable.BitmapDrawable
            if (r1 == 0) goto L4f
            boolean r1 = r0 instanceof org.telegram.p035ui.Components.AnimatedFileDrawable
            if (r1 != 0) goto L4f
            boolean r1 = r0 instanceof org.telegram.p035ui.Components.RLottieDrawable
            if (r1 != 0) goto L4f
            android.graphics.drawable.BitmapDrawable r0 = (android.graphics.drawable.BitmapDrawable) r0
            android.graphics.Bitmap r0 = r0.getBitmap()
            java.lang.String r6 = r6.currentMediaKey
        L4b:
            r5 = r0
            r0 = r6
            r6 = r5
            goto L8c
        L4f:
            android.graphics.drawable.Drawable r1 = r6.currentImageDrawable
            boolean r4 = r1 instanceof android.graphics.drawable.BitmapDrawable
            if (r4 == 0) goto L66
            boolean r4 = r1 instanceof org.telegram.p035ui.Components.AnimatedFileDrawable
            if (r4 != 0) goto L66
            boolean r4 = r0 instanceof org.telegram.p035ui.Components.RLottieDrawable
            if (r4 != 0) goto L66
            android.graphics.drawable.BitmapDrawable r1 = (android.graphics.drawable.BitmapDrawable) r1
            android.graphics.Bitmap r0 = r1.getBitmap()
            java.lang.String r6 = r6.currentImageKey
            goto L4b
        L66:
            android.graphics.drawable.Drawable r1 = r6.currentThumbDrawable
            boolean r4 = r1 instanceof android.graphics.drawable.BitmapDrawable
            if (r4 == 0) goto L7d
            boolean r4 = r1 instanceof org.telegram.p035ui.Components.AnimatedFileDrawable
            if (r4 != 0) goto L7d
            boolean r0 = r0 instanceof org.telegram.p035ui.Components.RLottieDrawable
            if (r0 != 0) goto L7d
            android.graphics.drawable.BitmapDrawable r1 = (android.graphics.drawable.BitmapDrawable) r1
            android.graphics.Bitmap r0 = r1.getBitmap()
            java.lang.String r6 = r6.currentThumbKey
            goto L4b
        L7d:
            android.graphics.drawable.Drawable r6 = r6.staticThumbDrawable
    ...
    public float getImageAspectRatio() {
        float fWidth;
        float fHeight;
        int i = this.imageOrientation % 180;
    ...
    /* JADX WARN: Removed duplicated region for block: B:274:0x0060  */
    /* JADX WARN: Removed duplicated region for block: B:277:0x0067  */
    /* JADX WARN: Removed duplicated region for block: B:307:0x00c1  */
