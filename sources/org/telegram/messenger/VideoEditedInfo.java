...
public class VideoEditedInfo {
    ...
    public static class MediaEntity {
        ...
        public MediaEntity(AbstractSerializedData abstractSerializedData, boolean z, boolean z2) {
            ...
            this.f1623x = abstractSerializedData.readFloat(z2);
            this.f1624y = abstractSerializedData.readFloat(z2);
        ...
        public void serializeTo(AbstractSerializedData abstractSerializedData, boolean z) {
            ...
            abstractSerializedData.writeFloat(this.f1623x);
            abstractSerializedData.writeFloat(this.f1624y);
        ...
        public MediaEntity copy() {
            ...
            mediaEntity.f1623x = this.f1623x;
            mediaEntity.f1624y = this.f1624y;
            ...
            mediaEntity.f1622W = this.f1622W;
            mediaEntity.f1621H = this.f1621H;
    ...
    public String getString() {
        ...
        if (this.avatarStartTime != -1 || this.filterState != null || this.paintPath != null || this.blurPath != null || (((arrayList = this.mediaEntities) != null && !arrayList.isEmpty()) || this.cropState != null)) {
            ...
            if (this.filterState != null) {
                ...
                if (point != null) {
                    serializedData.writeFloat(point.f2016x);
                    serializedData.writeFloat(this.filterState.blurExcludePoint.f2017y);
                } else {
