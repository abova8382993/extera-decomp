...
public class ChatThemeController extends BaseController {
    ...
    public void requestChatTheme(ThemeKey themeKey, final ResultCallback resultCallback) {
        ...
        requestAllChatThemes(new C28181(themeKey, resultCallback), false);
    }

    /* JADX INFO: renamed from: org.telegram.messenger.ChatThemeController$1 */
    /* JADX INFO: loaded from: classes5.dex */
    class C28181 implements ResultCallback {
        ...
        C28181(ThemeKey themeKey, ResultCallback resultCallback) {
    ...
    public static boolean equals(TLRPC.WallPaper wallPaper, TLRPC.WallPaper wallPaper2) {
        ...
        if (wallPaper != null && wallPaper2 != null) {
            ...
            if (wallPaper.f1833id == wallPaper2.f1833id && TextUtils.equals(ChatBackgroundDrawable.hash(wallPaper.settings), ChatBackgroundDrawable.hash(wallPaper2.settings)) && TextUtils.equals(getWallpaperEmoticon(wallPaper), getWallpaperEmoticon(wallPaper2))) {
                return true;
            }
        }
        return false;
    ...
    public void setDialogTheme(long j, TLRPC.ChatTheme chatTheme, boolean z) {
        setDialogTheme(j, ThemeKey.m1212of(chatTheme), chatTheme, z);
    }
    ...
    private void loadWallpaperPatternBitmap(long j, final Utilities.Callback<WallpaperBitmapHolder> callback) {
        ...
        chatThemeQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.ChatThemeController$$ExternalSyntheticLambda16
            ...
            public final void run() throws Throwable {
                ChatThemeController.m3949$r8$lambda$G3j5HioHYW8g2375iNZBBkeAd8(file, callback);
            }
        });
    }
    ...
    */
    public static /* synthetic */ void m3949$r8$lambda$G3j5HioHYW8g2375iNZBBkeAd8(java.io.File r13, final org.telegram.messenger.Utilities.Callback r14) throws java.lang.Throwable {
        /*
            r0 = 1
            r1 = 0
        ...
        L83:
            ...
            r7 = r4
        L86:
            org.telegram.messenger.FileLog.m1136e(r13)
        L89:
            if (r4 == 0) goto L90
        ...
        L90:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.messenger.ChatThemeController.m3949$r8$lambda$G3j5HioHYW8g2375iNZBBkeAd8(java.io.File, org.telegram.messenger.Utilities$Callback):void");
    }
    ...
    private void saveWallpaperPatternBitmap(final Bitmap bitmap, final List<WallpaperGiftPatternPosition> list, long j) {
        ...
        chatThemeQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.ChatThemeController$$ExternalSyntheticLambda18
            @Override // java.lang.Runnable
            public final void run() {
                ChatThemeController.m3953$r8$lambda$dr00SseyJI8nxcIUsEgc8hy4M(file, list, bitmap);
            }
        });
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static /* synthetic */ void m3953$r8$lambda$dr00SseyJI8nxcIUsEgc8hy4M(java.io.File r3, java.util.List r4, android.graphics.Bitmap r5) {
        /*
        ...
        L87:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.messenger.ChatThemeController.m3953$r8$lambda$dr00SseyJI8nxcIUsEgc8hy4M(java.io.File, java.util.List, android.graphics.Bitmap):void");
    }
    ...
    public static boolean wallpaperEquals(TLRPC.WallPaper wallPaper, TLRPC.WallPaper wallPaper2) {
        ...
        if ((wallPaper instanceof TLRPC.TL_wallPaper) && (wallPaper2 instanceof TLRPC.TL_wallPaper)) {
            return wallPaper.f1833id == wallPaper2.f1833id;
        }
        if ((wallPaper instanceof TLRPC.TL_wallPaperNoFile) && (wallPaper2 instanceof TLRPC.TL_wallPaperNoFile)) {
            ...
            if (wallPaper.f1833id == wallPaper2.f1833id) {
                return true;
            }
        }
        return false;
    ...
    public int setWallpaperToPeer(final long j, final String str, Theme.OverrideWallpaperInfo overrideWallpaperInfo, MessageObject messageObject, final Runnable runnable) {
        ...
        if (messageObject != null && (messageObject.messageOwner.action instanceof TLRPC.TL_messageActionSetChatWallPaper)) {
            ...
            tL_messages_setChatWallPaper.f1784id = messageObject.getId();
            if (j >= 0) {
            ...
            tL_wallPaper.f1833id = wallPaper2.f1833id;
            ...
            tL_wallPaper2.f1833id = wallPaper3.f1833id;
