...
public class ChannelBoostsController {
    ...
    public static /* synthetic */ void $r8$lambda$4kR6chzkmjvJRhfUBkGHu8w7IOM(TLObject tLObject, Consumer consumer, TLRPC.TL_error tL_error) {
        ...
        if (tL_error != null && lastFragment != null && "CHANNEL_PRIVATE".equals(tL_error.text)) {
            ...
            if (launchActivity == null || !launchActivity.isFinishing()) {
                ...
                builder.setTopAnimation(C2797R.raw.not_available, 52, false, Theme.getColor(i), map);
                builder.setTopAnimationIsNew(true);
                builder.setTitle(LocaleController.getString(C2797R.string.ChannelPrivate));
                builder.setMessage(LocaleController.getString(C2797R.string.ChannelCantOpenPrivate2));
    ...
    public void userCanBoostChannel(long j, final TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus, final Consumer<CanApplyBoost> consumer) {
        ...
        BoostRepository.getMyBoosts(new Utilities.Callback() { // from class: org.telegram.messenger.ChannelBoostsController$$ExternalSyntheticLambda2
            ...
            public final void run(Object obj) {
                ChannelBoostsController.m5289$r8$lambda$QUjpU3jxTyAfx8XRNTCZyEH0Y(canApplyBoost, tL_premium_boostsStatus, consumer, (TL_stories.TL_premium_myBoosts) obj);
            }
    ...
    /* JADX INFO: renamed from: $r8$lambda$QUjpU3-jxTyAfx8X-RNTCZyEH0Y */
    public static /* synthetic */ void m5289$r8$lambda$QUjpU3jxTyAfx8XRNTCZyEH0Y(CanApplyBoost canApplyBoost, TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus, Consumer consumer, TL_stories.TL_premium_myBoosts tL_premium_myBoosts) {
        ...
        public void setMyBoosts(TL_stories.TL_premium_myBoosts tL_premium_myBoosts) {
            ...
            if (this.slot == 0) {
                ...
                while (i3 < size3) {
                    ...
                    if (peer != null && DialogObject.getPeerDialogId(peer) != (-this.currentChat.f1245id)) {
