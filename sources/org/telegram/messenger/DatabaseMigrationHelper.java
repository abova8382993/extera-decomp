...
public class DatabaseMigrationHelper {
    public static int migrate(MessagesStorage messagesStorage, int i) {
            ...
            while (sQLiteCursorQueryFinalized10.next()) {
                ...
                if (nativeByteBufferByteBufferValue2 != null) {
                    ...
                    if (chatParticipantsTLdeserialize != null) {
                        ...
                        sQLitePreparedStatementExecuteFast2.bindByteBuffer(2, nativeByteBuffer3);
        ...
        if (i4 == 80) {
            ...
            if (sQLiteCursorQueryFinalized8 != null) {
                ...
                while (sQLiteCursorQueryFinalized8.next()) {
                    NativeByteBuffer nativeByteBufferByteBufferValue3 = sQLiteCursorQueryFinalized8.byteBufferValue(i3);
        ...
        if (i4 == 83) {
                ...
                while (sQLiteCursorQueryFinalized2.next()) {
                    ...
                    if (nativeByteBufferByteBufferValue6 != null) {
                        ...
                        if (nativeByteBufferByteBufferValue7 != null) {
                            ...
                            sQLitePreparedStatementExecuteFast10.bindByteBuffer(10, nativeByteBuffer);
                        } else {
                            nativeByteBuffer = nativeByteBufferByteBufferValue7;
                        ...
                        if (nativeByteBufferByteBufferValue8 != null) {
                            nativeByteBuffer2 = nativeByteBufferByteBufferValue8;
                            sQLitePreparedStatementExecuteFast10.bindByteBuffer(14, nativeByteBuffer2);
                        } else {
                            nativeByteBuffer2 = nativeByteBufferByteBufferValue8;
            ...
            SQLiteCursor sQLiteCursorQueryFinalized12 = database.queryFinalized("SELECT did, last_mid, last_mid_i FROM dialogs WHERE 1", new Object[0]);
            SQLitePreparedStatement sQLitePreparedStatementExecuteFast11 = database.executeFast("UPDATE dialogs SET last_mid = ?, last_mid_i = ? WHERE did = ?");
            ...
            int i16 = 0;
            SQLiteCursor sQLiteCursorQueryFinalized13 = database.queryFinalized("SELECT uid, mid FROM unread_push_messages WHERE 1", new Object[0]);
            SQLitePreparedStatement sQLitePreparedStatementExecuteFast12 = database.executeFast("UPDATE unread_push_messages SET mid = ? WHERE uid = ? AND mid = ?");
            ...
            if (arrayList != null) {
                SQLitePreparedStatement sQLitePreparedStatementExecuteFast13 = database.executeFast("UPDATE dialogs SET did = ? WHERE did = ?");
                SQLitePreparedStatement sQLitePreparedStatementExecuteFast14 = database.executeFast("UPDATE dialog_filter_pin_v2 SET peer = ? WHERE peer = ?");
                SQLitePreparedStatement sQLitePreparedStatementExecuteFast15 = database.executeFast("UPDATE dialog_filter_ep SET peer = ? WHERE peer = ?");
            ...
            if (arrayList2 != null) {
                SQLitePreparedStatement sQLitePreparedStatementExecuteFast16 = database.executeFast("UPDATE dialogs SET did = ? WHERE did = ?");
        ...
        if (i4 == 84) {
            ...
            database.beginTransaction();
            try {
                sQLiteCursorQueryFinalized = database.queryFinalized("SELECT mid, uid, date, type, data FROM media_v3 WHERE 1", new Object[0]);
            } catch (Exception e8) {
                FileLog.m1136e(e8);
                sQLiteCursorQueryFinalized = null;
            }
            if (sQLiteCursorQueryFinalized != null) {
                SQLitePreparedStatement sQLitePreparedStatementExecuteFast17 = database.executeFast("REPLACE INTO media_v4 VALUES(?, ?, ?, ?, ?)");
        ...
        if (i4 == 116 || i4 == 117 || i4 == 118) {
            ...
            messagesStorage2.getMessagesController().getStoriesController().cleanup();
            i4 = 119;
        }
        if (i4 == 119) {
        ...
        if (i4 == 143) {
            ...
            messagesStorage2.getUserConfig().clearFilters();
            i4 = 144;
        }
        if (i4 == 144) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:72:0x02d9 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static boolean recoverDatabase(java.io.File r20, java.io.File r21, java.io.File r22, int r23) {
        /*
