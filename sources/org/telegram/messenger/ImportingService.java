...
public class ImportingService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void onDestroy() {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m1045d("destroy import service");
        }
    }
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m1045d("start import service");
        }
        if (this.builder == null) {
            ...
            boolean zHasImportingHistory = hasImportingHistory();
            NotificationCompat.Builder builder2 = this.builder;
            if (zHasImportingHistory) {
                builder2.setTicker(LocaleController.getString(C2797R.string.ImporImportingService));
                this.builder.setContentText(LocaleController.getString(C2797R.string.ImporImportingService));
            } else {
                builder2.setTicker(LocaleController.getString(C2797R.string.ImporImportingStickersService));
                this.builder.setContentText(LocaleController.getString(C2797R.string.ImporImportingStickersService));
            }
        }
