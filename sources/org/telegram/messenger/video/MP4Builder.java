...
public class MP4Builder {
    ...
    private FileChannel f1225fc = null;
    ...
    public MP4Builder createMovie(Mp4Movie mp4Movie, boolean z, boolean z2) {
        ...
        this.f1225fc = fileOutputStream.getChannel();
        FileTypeBox fileTypeBoxCreateFileTypeBox = createFileTypeBox(z2);
        fileTypeBoxCreateFileTypeBox.getBox(this.f1225fc);
    ...
    private void flushCurrentMdat() throws IOException {
        long jPosition = this.f1225fc.position();
        this.f1225fc.position(this.mdat.getOffset());
        this.mdat.getBox(this.f1225fc);
        this.f1225fc.position(jPosition);
    ...
    public long writeSampleData(int i, ByteBuffer byteBuffer, MediaCodec.BufferInfo bufferInfo, boolean z) {
        ...
        if (z) {
            ...
            this.sizeBuffer.position(0);
            this.f1225fc.write(this.sizeBuffer);
            byteBuffer.position(bufferInfo.offset + 4);
        } else {
            byteBuffer.position(bufferInfo.offset);
        }
        byteBuffer.limit(bufferInfo.offset + bufferInfo.size);
        this.f1225fc.write(byteBuffer);
    ...
    public void finishMovie() {
        ...
        createMovieBox(this.currentMp4Movie).getBox(this.f1225fc);
        this.fos.flush();
        if (this.allowSyncFiles) {
            this.fos.getFD().sync();
        }
    ...
    public static class InterleaveChunkMdat implements Box {
        ...
        public /* synthetic */ InterleaveChunkMdat(MP4BuilderIA mP4BuilderIA) {
            this();
        }
