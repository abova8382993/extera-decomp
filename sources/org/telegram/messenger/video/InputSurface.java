...
public class InputSurface {
    ...
    private void eglSetup() {
        ...
        if (!EGL14.eglChooseConfig(this.mEGLDisplay, new int[]{12324, 8, 12323, 8, 12322, 8, 12352, 4, 12610, 1, 12344}, 0, eGLConfigArr, 0, 1, new int[1], 0)) {
            GlShader$$ExternalSyntheticBUOutline1.m1250m("unable to find RGB888+recordable ES2 EGL config");
            return;
        }
        this.mEGLContext = EGL14.eglCreateContext(this.mEGLDisplay, eGLConfigArr[0], EGL14.EGL_NO_CONTEXT, new int[]{12440, 2, 12344}, 0);
        checkEglError("eglCreateContext");
        if (this.mEGLContext == null) {
            GlShader$$ExternalSyntheticBUOutline1.m1250m("null context");
            return;
        }
    ...
    private void checkEglError(String str) {
        ...
        if (z) {
            GlShader$$ExternalSyntheticBUOutline1.m1250m("EGL error encountered (see log)");
        }
    }
}
