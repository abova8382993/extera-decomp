...
public class AudioDecoder {
    ...
    private void selectTrack() {
        ...
        if (i3 < 0) {
            GlShader$$ExternalSyntheticBUOutline1.m1250m("No audio track found in source");
        } else {
    ...
    public int getSampleRate() {
        try {
            ...
            FileLog.m1048e(e);
            try {
                return this.getInputMediaFormat().getInteger("sample-rate");
            } catch (Exception e2) {
                FileLog.m1048e(e2);
                return -1;
            }
    ...
    public int getBitrateRate() {
        try {
            ...
            return this.getInputMediaFormat().getInteger("bitrate");
        }
    }
    ...
    public int getChannelCount() {
        try {
            ...
            FileLog.m1048e(e);
            try {
                return this.getInputMediaFormat().getInteger("channel-count");
            } catch (Exception e2) {
                FileLog.m1048e(e2);
                return -1;
            }
        ...
        while (!z && !this.decodingDone) {
            if (!this.allInputExtracted && (iDequeueInputBuffer = this.decoder.dequeueInputBuffer(0L)) >= 0) {
                ...
                if (sampleData >= 0 && this.extractor.getSampleTime() <= this.endTimeUs) {
                    ...
                    boolean z2 = this.loopingEnabled;
