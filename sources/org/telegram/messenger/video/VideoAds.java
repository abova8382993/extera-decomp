...
public class VideoAds {
    ...
    public /* synthetic */ void lambda$show$2(CloseDrawable closeDrawable, View view) {
        ...
        if (UserConfig.getInstance(this.currentAccount).isPremium()) {
            ...
            this.bulletinFactory.createAdReportedBulletin(LocaleController.getString(C2888R.string.AdHidden)).show();
            return;
        }
        showPremium();
    }
    ...
    */
    ...
    public static class AdOptionsDrawable extends Drawable {
        ...
        public final Text text = new Text(LocaleController.getString(C2888R.string.SponsoredMessageAd), 11.0f, AndroidUtilities.bold());
        ...
        public AdOptionsDrawable(Context context, int i) {
            this.color = i;
            Drawable drawableMutate = context.getResources().getDrawable(C2888R.drawable.ic_ab_other).mutate();
        ...
        public void draw(Canvas canvas) {
            ...
            this.text.draw(canvas, rectF.left + AndroidUtilities.m1124dp(5.0f), rectF.centerY(), this.color, this.alpha);
            this.icon.setBounds(getBounds().right - AndroidUtilities.m1124dp(12.99f), getBounds().centerY() - AndroidUtilities.m1124dp(5.665f), getBounds().right - AndroidUtilities.m1124dp(1.66f), getBounds().centerY() + AndroidUtilities.m1124dp(5.665f));
        ...
        public int getIntrinsicWidth() {
            return (int) (AndroidUtilities.m1124dp(4.0f) + this.text.getWidth() + AndroidUtilities.m1124dp(18.0f));
        }
    }
    ...
    public static class CloseDrawable extends Drawable {
        ...
        public void draw(Canvas canvas) {
            ...
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(fCenterX - AndroidUtilities.m1124dp(9.0f), fCenterY - AndroidUtilities.m1124dp(9.0f), AndroidUtilities.m1124dp(9.0f) + fCenterX, AndroidUtilities.m1124dp(9.0f) + fCenterY);
            canvas.drawArc(rectF, -90.0f, f * (-360.0f), false, this.paint);
            float f4 = this.showCrossAnimated.set((1.0f - f) * 360.0f > 75.0f);
            float fLerp = AndroidUtilities.lerp(fCenterX, AndroidUtilities.m1124dp(8.0f) + fCenterX, f2);
            float fLerp2 = AndroidUtilities.lerp(fCenterY, fCenterY - AndroidUtilities.m1124dp(8.0f), f2);
            float fLerp3 = AndroidUtilities.lerp(AndroidUtilities.m1124dp(5.0f), AndroidUtilities.m1124dp(3.0f), f2) * AndroidUtilities.lerp(0.35f, 1.0f, f4);
    ...
    public static class AdLayout extends Bulletin.ButtonLayout {
        ...
        public AdLayout(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            backupImageView.setRoundRadius(AndroidUtilities.m1124dp(48.0f));
            ...
            simpleTextView.setPadding(AndroidUtilities.m1124dp(4.0f), 0, AndroidUtilities.m1124dp(4.0f), 0);
