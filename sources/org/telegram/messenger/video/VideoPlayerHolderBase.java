...
public class VideoPlayerHolderBase {
    ...
    public /* synthetic */ void lambda$preparePlayer$0(boolean z, float f, Uri uri) {
        ...
        FileLog.m1045d("videoplayerholderbase.preparePlayer(): preparePlayer new player as preload uri=" + uri);
    ...
    public /* synthetic */ void lambda$start$2(boolean z, float f, Uri uri, boolean z2, boolean z3, long j) {
        if (this.released) {
            FileLog.m1045d("videoplayerholderbase returned from start: released");
            return;
        }
        if (this.videoPlayer == null) {
            ensurePlayerCreated(z);
            this.videoPlayer.setPlaybackSpeed(f);
            FileLog.m1045d("videoplayerholderbase.start(): preparePlayer new player uri=" + uri);
            ...
            if (!z2) {
                ...
                if (surface2 != null) {
                    ...
                    if (surfaceView2 != null) {
                        videoPlayer2.setSurfaceView(surfaceView2);
                    } else {
            ...
            FileLog.m1045d("videoplayerholderbase.start(): player already exist");
            if (!z2) {
                ...
                if (surface3 != null) {
                    ...
                    if (surfaceView3 != null) {
                        videoPlayer3.setSurfaceView(surfaceView3);
                    } else {
                ...
                if (surface4 != null) {
                    ...
                    if (surfaceView4 != null) {
                        videoPlayer4.setSurfaceView(surfaceView4);
                    } else {
                        videoPlayer4.setTextureView(this.textureView);
                    }
                }
                this.videoPlayer.setPlayWhenReady(false);
            }
    ...
    private void ensurePlayerCreated(boolean z) {
        ...
        videoPlayer2.setDelegate(new C28632());
        this.videoPlayer.setIsStory();
    }

    /* JADX INFO: renamed from: org.telegram.messenger.video.VideoPlayerHolderBase$2 */
    public class C28632 implements VideoPlayer.VideoPlayerDelegate {
        ...
        public void onStateChanged(boolean z, int i) {
            ...
            if (i == 3 || i == 2) {
                ...
                boolean zNeedRepeat = VideoPlayerHolderBase.this.needRepeat();
                ...
                if (zNeedRepeat) {
                    ...
                    videoPlayerHolderBase5.progress = 1.0f;
                }
            }
        ...
        public void onError(VideoPlayer videoPlayer, Exception exc) {
            ...
            VideoPlayerHolderBase videoPlayerHolderBase = VideoPlayerHolderBase.this;
            videoPlayerHolderBase.triesCount--;
            if (VideoPlayerHolderBase.this.triesCount > 0) {
                VideoPlayerHolderBase videoPlayerHolderBase2 = VideoPlayerHolderBase.this;
                DispatchQueue dispatchQueue = videoPlayerHolderBase2.dispatchQueue;
                ...
                videoPlayerHolderBase2.initRunnable = runnable;
                dispatchQueue.postRunnable(runnable);
                return;
            }
    ...
    public /* synthetic */ void lambda$setAudioEnabled$8(boolean z, boolean z2) {
        ...
        if (z && !this.videoPlayer.createdWithAudioTrack()) {
            ...
            FileLog.m1045d("videoplayerholderbase.setAudioEnabled(): repreparePlayer as audio track is enabled back uri=" + uri);
            this.videoPlayer.preparePlayer(uri, "other");
            this.videoPlayer.setWorkerQueue(this.dispatchQueue);
            if (!z2) {
                Surface surface = this.surface;
                if (surface != null) {
                    ...
                    VideoPlayer videoPlayer2 = this.videoPlayer;
                    if (surfaceView != null) {
                        videoPlayer2.setSurfaceView(surfaceView);
                    } else {
                        videoPlayer2.setTextureView(this.textureView);
                    }
                }
    ...
    public float getPlaybackProgress(long j) {
        if (this.lastState == 4) {
            ...
            this.progress = j != 0 ? j2 / j : j2 / this.playerDuration;
            if (!this.seeking) {
