    ...
    private void profile_tier_level(int i, CAVLCReader cAVLCReader) {
        ...
        if (i2 > 0) {
            ...
            for (int i4 = i2; i4 < 8; i4++) {
                iArr[i4] = cAVLCReader.readU(2, "reserved_zero_2bits[" + i4 + "]");
            }
        }
        int[] iArr2 = new int[i2];
        ...
        while (i5 < i2) {
            if (zArr2[i5]) {
                zArr = zArr2;
                iArr2[i5] = cAVLCReader.readU(2, "sub_layer_profile_space[" + i5 + "]");
                zArr4[i5] = cAVLCReader.readBool("sub_layer_tier_flag[" + i5 + "]");
                iArr3[i5] = cAVLCReader.readU(5, "sub_layer_profile_idc[" + i5 + "]");
                int i6 = 0;
                while (i6 < 32) {
            ...
            if (zArr3[i5]) {
                iArr4[i5] = cAVLCReader.readU(8, "sub_layer_level_idc[" + i5 + "]");
            }
            i5++;
            i2 = i;
            zArr2 = zArr;
