    ...
    */
    ...
    public void prepare() {
        ...
        for (i = 1; i < arrayList.size(); i++) {
            ((SamplePresentationTime) arrayList.get(i)).f1229dt = this.sampleDurations[i] + ((SamplePresentationTime) arrayList.get(i - 1)).f1229dt;
        }
        if (z) {
            ...
            for (int i3 = 0; i3 < this.samplePresentationTimes.size(); i3++) {
                ...
                this.sampleCompositions[samplePresentationTime2.index] = (int) (samplePresentationTime2.presentationTime - samplePresentationTime2.f1229dt);
            }
        }
    }
