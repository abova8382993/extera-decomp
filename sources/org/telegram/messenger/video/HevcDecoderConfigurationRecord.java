...
public class HevcDecoderConfigurationRecord {
    ...
    public void parse(ByteBuffer byteBuffer) {
        ...
        this.reserved2 = (uInt82 & Opcodes.INVOKE_CUSTOM) >> 2;
        this.parallelismType = uInt82 & 3;
        int uInt83 = IsoTypeReader.readUInt8(byteBuffer);
        this.reserved3 = (uInt83 & Opcodes.INVOKE_CUSTOM) >> 2;
    ...
    private static VisualSampleEntry createSampleEntry(ArrayList<ByteBuffer> arrayList, ArrayList<ByteBuffer> arrayList2, ArrayList<ByteBuffer> arrayList3, SequenceParameterSetRbsp sequenceParameterSetRbsp) {
        ...
        int i2 = 0;
        while (i2 < size) {
            ByteBuffer byteBuffer = arrayList3.get(i2);
            i2++;
        ...
        while (i < size3) {
            ByteBuffer byteBuffer3 = arrayList2.get(i);
            i++;
