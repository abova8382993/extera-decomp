...
public class UserObject {
    ...
    public static boolean isAnonymous(TLRPC.User user) {
        return user != null && user.f1407id == ANONYMOUS;
    }
    ...
    public static String getFirstName(TLRPC.User user, boolean z) {
        ...
        return !TextUtils.isEmpty(str) ? str : LocaleController.getString(C2797R.string.HiddenName);
    }
    ...
    public static int getColorId(TLRPC.User user) {
        ...
        return (!(peerColor instanceof TLRPC.TL_peerColor) || (peerColor.flags & 1) == 0) ? (int) (user.f1407id % 7) : peerColor.color;
    }
    ...
    public static boolean m1088eq(TL_account.RequirementToContact requirementToContact, TL_account.RequirementToContact requirementToContact2) {
    ...
    public static boolean areGiftsDisabled(TLRPC.UserFull userFull) {
        ...
        return (userFull == null || userFull.f1408id != UserConfig.getInstance(UserConfig.selectedAccount).getClientUserId()) && userFull != null && (disallowedGiftsSettings = userFull.disallowed_stargifts) != null && disallowedGiftsSettings.disallow_limited_stargifts && disallowedGiftsSettings.disallow_unlimited_stargifts && disallowedGiftsSettings.disallow_unique_stargifts && disallowedGiftsSettings.disallow_premium_gifts;
    }
