...
public class PipSource {
    ...
    public /* synthetic */ PipSource(PipActivityController pipActivityController, Builder builder, PipSourceIA pipSourceIA) {
    ...
    private PipSource(PipActivityController pipActivityController, Builder builder) {
        ...
        Builder.m6465$$Nest$fgetactionListener(builder);
    ...
    */
    ...
    public static class Builder {
        ...
        public static /* bridge */ /* synthetic */ IPipActivityActionListener m6465$$Nest$fgetactionListener(Builder builder) {
            builder.getClass();
            return null;
        }
