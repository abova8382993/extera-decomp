...
public class MessageSuggestionParams {
    ...
    public static MessageSuggestionParams m1057of(TLRPC.SuggestedPost suggestedPost) {
        if (suggestedPost == null) {
            return empty();
        }
        return new MessageSuggestionParams(AmountUtils$Amount.m1099of(suggestedPost.price), suggestedPost.schedule_date);
    }

    /* JADX INFO: renamed from: of */
    public static MessageSuggestionParams m1058of(TLRPC.TL_messageActionSuggestedPostApproval tL_messageActionSuggestedPostApproval) {
        return m1056of(AmountUtils$Amount.m1099of(tL_messageActionSuggestedPostApproval.price), tL_messageActionSuggestedPostApproval.schedule_date);
    }

    /* JADX INFO: renamed from: of */
    public static MessageSuggestionParams m1056of(AmountUtils$Amount amountUtils$Amount, long j) {
