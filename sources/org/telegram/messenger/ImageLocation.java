...
public class ImageLocation {
    ...
    public static ImageLocation getForDocument(TLRPC.Document document) {
        ...
        imageLocation.f1592iv = document.f1669iv;
    ...
    public static ImageLocation getForUser(TLRPC.User user, int i) {
        ...
        if (user != null && user.access_hash != 0 && (userProfilePhoto = user.photo) != null) {
            ...
            if (MessagesController.getInstance(i3).isPremiumUser(user) && user.photo.has_video && (userFull = MessagesController.getInstance(i3).getUserFull(user.f1825id)) != null && (photo = userFull.profile_photo) != null && (arrayList = photo.video_sizes) != null && !arrayList.isEmpty()) {
                if (i == 4) {
                ...
                while (true) {
                    ...
                    if ("p".equals(((TLRPC.VideoSize) userFull.profile_photo.video_sizes.get(i4)).type)) {
                        closestVideoSizeWithSize = (TLRPC.VideoSize) userFull.profile_photo.video_sizes.get(i4);
                        break;
                    }
                    i4++;
                }
    ...
    public static ImageLocation getForStickerSet(TLRPC.StickerSet stickerSet) {
        ...
        if (stickerSet.access_hash != 0) {
            ...
            tL_inputStickerSetShortName.f1685id = stickerSet.f1696id;
    ...
    private static ImageLocation getForPhoto(TLRPC.FileLocation fileLocation, int i, TLRPC.Photo photo, TLRPC.Document document, TLRPC.InputPeer inputPeer, int i2, int i3, TLRPC.InputStickerSet inputStickerSet, String str) {
        ...
        if (fileLocation instanceof TLRPC.TL_fileLocationToBeDeprecated) {
            ...
            if (photo != null) {
                ...
                imageLocation.photoId = photo.f1692id;
            ...
            if (document != null) {
                ...
                imageLocation.documentId = document.f1668id;
                imageLocation.thumbSize = str;
            }
            return imageLocation;
        }
        ...
        imageLocation.f1592iv = fileLocation.f1674iv;
    ...
    public static String getStrippedKey(Object obj, Object obj2, Object obj3) {
        if ((obj instanceof TLRPC.WebPage) || ((obj instanceof MessageObject) && ((MessageObject) obj).type == 29)) {
            ...
            if (obj2 instanceof TLRPC.Document) {
                return "stripped" + FileRefController.getKeyForParentObject(obj) + "_" + ((TLRPC.Document) obj2).f1668id;
            }
            if (obj2 instanceof TLRPC.Photo) {
                return "stripped" + FileRefController.getKeyForParentObject(obj) + "_" + ((TLRPC.Photo) obj2).f1692id;
            }
    ...
    public String getKey(Object obj, Object obj2, boolean z) {
        if (this.secureDocument != null) {
            return this.secureDocument.secureFile.dc_id + "_" + this.secureDocument.secureFile.f1804id;
        }
        ...
        if (document != null) {
            if (z || !(document instanceof DocumentObject.ThemeDocument)) {
                if (document.f1668id == 0 || document.dc_id == 0) {
                    return null;
                }
                return this.document.dc_id + "_" + this.document.f1668id;
            }
            ...
            sb.append("_");
            sb.append(themeDocument.themeSettings.message_colors.size() > 1 ? ((Integer) themeDocument.themeSettings.message_colors.get(1)).intValue() : 0);
            sb.append("_");
            sb.append(themeDocument.themeSettings.message_colors.size() > 0 ? ((Integer) themeDocument.themeSettings.message_colors.get(0)).intValue() : 0);
            return sb.toString();
        }
