...
public class UserConfig extends BaseController {
    ...
    public void setCurrentUser(TLRPC.User user) {
        synchronized (this.sync) {
            ...
            this.clientUserId = user.f1407id;
        ...
        synchronized (this.sync) {
            try {
                ...
                if (user != null) {
                    ...
                    this.clientUserId = this.currentUser.f1407id;
                }
    ...
    public void setShowContactsTab(final BaseFragment baseFragment, final boolean z) {
        ...
        (baseFragment != null ? BulletinFactory.m1143of(baseFragment) : BulletinFactory.global()).createSimpleBulletin(C2797R.raw.contact_check, LocaleController.getString(z ? C2797R.string.ContactsTabWasShownTitle : C2797R.string.ContactsTabWasHiddenTitle), LocaleController.getString(C2797R.string.UndoNoCaps), 5000, true, new Runnable() { // from class: org.telegram.messenger.UserConfig$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
