...
public class FilesMigrationService extends Service {
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        Notification notificationBuild = FilesMigrationService$$ExternalSyntheticApiModelOutline0.m1050m(this, NotificationsController.OTHER_NOTIFICATIONS_CHANNEL).setContentTitle(getText(C2797R.string.MigratingFiles)).setAutoCancel(false).setSmallIcon(IconManager.getNotificationSystemIcon()).build();
        isRunning = true;
        new C27371().start();
    ...
    /* JADX INFO: renamed from: org.telegram.messenger.FilesMigrationService$1 */
    /* JADX INFO: loaded from: classes5.dex */
    public class C27371 extends Thread {
        public C27371() {
        }
    ...
    public void migrateOldFolder() {
        ...
        File file2 = new File(ApplicationLoader.applicationContext.getExternalFilesDir(null), "exteraGram");
        File file3 = new File(externalStorageDirectory, "exteraGram");
        this.totalFilesCount = getFilesCount(file3);
        long jCurrentTimeMillis = System.currentTimeMillis();
        if (file3.canRead() && file3.canWrite()) {
            moveDirectory(file3, file2);
        }
        FileLog.m1045d("move time = " + (System.currentTimeMillis() - jCurrentTimeMillis));
    ...
    private void updateProgress() {
        if (System.currentTimeMillis() - this.lastUpdateTime > 20 || this.movedFilesCount >= this.totalFilesCount - 1) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.FilesMigrationService$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public /* synthetic */ void lambda$updateProgress$1(int i) {
        FilesMigrationService$$ExternalSyntheticApiModelOutline1.m1051m();
        ((NotificationManager) getSystemService("notification")).notify(301, FilesMigrationService$$ExternalSyntheticApiModelOutline0.m1050m(this, NotificationsController.OTHER_NOTIFICATIONS_CHANNEL).setContentTitle(getText(C2797R.string.MigratingFiles)).setContentText(String.format("%s/%s", Integer.valueOf(i), Integer.valueOf(this.totalFilesCount))).setSmallIcon(IconManager.getNotificationSystemIcon()).setAutoCancel(false).setProgress(this.totalFilesCount, i, false).build());
    }
    ...
    public static void checkBottomSheet(BaseFragment baseFragment) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            hasOldFolder = new File(externalStorageDirectory, "exteraGram").exists();
        }
        if (hasOldFolder) {
    ...
    public static class FilesMigrationBottomSheet extends BottomSheet {
        ...
        public FilesMigrationBottomSheet(BaseFragment baseFragment) {
            ...
            textView.setText(LocaleController.getString(C2797R.string.MigrateOldFolderTitle));
            linearLayout.addView(textView, LayoutHelper.createFrame(-1, -2.0f, 0, 21.0f, 30.0f, 21.0f, 0.0f));
            TextView textView2 = new TextView(parentActivity);
            textView2.setGravity(8388611);
            textView2.setTextSize(1, 15.0f);
            textView2.setTextColor(Theme.getColor(i));
            textView2.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2797R.string.MigrateOldFolderDescription)));
            ...
            textView3.setText(LocaleController.getString(C2797R.string.MigrateOldFolderButton));
