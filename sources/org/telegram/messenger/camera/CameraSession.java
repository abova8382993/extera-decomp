            ...
            if (camera != null) {
                ...
                if (parameters != null) {
                    if (z && BuildVars.LOGS_ENABLED) {
                        FileLog.m1045d("set preview size = " + this.previewSize.getWidth() + " " + this.previewSize.getHeight());
                    }
                    parameters.setPreviewSize(this.previewSize.getWidth(), this.previewSize.getHeight());
                    if (z && BuildVars.LOGS_ENABLED) {
                        FileLog.m1045d("set picture size = " + this.pictureSize.getWidth() + " " + this.pictureSize.getHeight());
                    }
                    ...
                    try {
                        ...
                        if (i3 == 1) {
                            this.sameTakePictureOrientation = (360 - i4) % 360 == i;
                        } else {
                            this.sameTakePictureOrientation = i4 == i;
                        }
    ...
    */
        ...
        try {
            ...
            if (camera != null) {
                ...
                if (parameters != null) {
                    ...
                    try {
                        parameters.setRotation(i);
                        int i4 = this.info.facing;
                        int i5 = this.displayOrientation;
                        if (i4 == 1) {
                            this.sameTakePictureOrientation = (360 - i5) % 360 == i;
                        } else {
                            this.sameTakePictureOrientation = i5 == i;
                        }
                    } catch (Exception unused) {
                    }
    ...
    public void configureRecorder(int i, MediaRecorder mediaRecorder) {
        ...
        if (zHasProfile && (i == 1 || !zHasProfile2)) {
            ...
            Segment$$ExternalSyntheticBUOutline1.m992m("cannot find valid CamcorderProfile");
            return;
        }
        this.isVideo = true;
    }
