...
public class CameraView extends FrameLayout implements TextureView.SurfaceTextureListener, CameraController.ICameraView, CameraController.ErrorCallback {
    ...
    class C29121 implements ValueAnimator.AnimatorUpdateListener {
        C29121() {
        }
    ...
    class C29132 extends AnimatorListenerAdapter {
        C29132() {
        }
    ...
    public CameraView(Context context, boolean z, boolean z2) {
        ...
        this.focusAreaSize = AndroidUtilities.m1124dp(96.0f);
        this.outerPaint.setColor(-1);
        this.outerPaint.setStyle(Paint.Style.STROKE);
        this.outerPaint.setStrokeWidth(AndroidUtilities.m1124dp(2.0f));
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m1133d("CameraView start create thread");
        }
    ...
    private void updateCameraInfoSize(int i) {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m1133d("camera preview " + this.previewSize[0]);
        }
        requestLayout();
    }
    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
        Object obj;
        CameraSessionWrapper cameraSessionWrapper;
        if ((this.inited || (cameraSessionWrapper = this.cameraSession[0]) == null || !cameraSessionWrapper.isInitiated()) && ((obj = this.renderNode) == null || BotFullscreenButtons$$ExternalSyntheticApiModelOutline1.m1130m(obj).hasDisplayList())) {
            return;
        }
    ...
    public void onSurfaceTextureUpdatedInternal() {
        ...
        if (obj == null || BotFullscreenButtons$$ExternalSyntheticApiModelOutline1.m1130m(obj).hasDisplayList()) {
            return;
        }
        invalidate();
    }
    ...
    public void showTexture(boolean z, boolean z2) {
        ...
        this.textureView.setAlpha(z3 ? 1.0f : 0.0f);
    }
    ...
    class C29143 extends AnimatorListenerAdapter {
        final /* synthetic */ boolean val$show;
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (view == this.textureView && canvas.isHardwareAccelerated() && (obj2 = this.renderNode) != null) {
            RenderNode renderNodeM1130m = BotFullscreenButtons$$ExternalSyntheticApiModelOutline1.m1130m(obj2);
        ...
        if (view == this.textureView && canvas.isHardwareAccelerated() && (obj = this.renderNode) != null) {
            ...
            if (obj3 != null) {
                RenderNode renderNodeM1130m3 = BotFullscreenButtons$$ExternalSyntheticApiModelOutline1.m1130m(obj3);
                renderNodeM1130m3.setPosition(0, 0, getWidth(), getHeight());
                renderNodeM1130m3.beginRecording().drawRenderNode(renderNodeM1130m2);
                renderNodeM1130m3.endRecording();
            }
        }
        if (this.focusProgress != 1.0f || this.innerAlpha != 0.0f || this.outerAlpha != 0.0f) {
            int iM1124dp = AndroidUtilities.m1124dp(30.0f);
            long jCurrentTimeMillis = System.currentTimeMillis();
            ...
            float f = iM1124dp;
            canvas.drawCircle(this.f1628cx, this.f1629cy, ((1.0f - interpolation) * f) + f, this.outerPaint);
            canvas.drawCircle(this.f1628cx, this.f1629cy, f * interpolation, this.innerPaint);
    ...
    public TextureView makeBlurTextureView() {
        if (this.blurTextureView == null) {
            ...
            textureView.setSurfaceTextureListener(new TextureView.SurfaceTextureListener() { // from class: org.telegram.messenger.camera.CameraView.4
                ...
                TextureViewSurfaceTextureListenerC29154() {
                }
    ...
    class TextureViewSurfaceTextureListenerC29154 implements TextureView.SurfaceTextureListener {
        @Override // android.view.TextureView.SurfaceTextureListener
        public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i2) {
        }
    ...
    public class CameraGLThread extends DispatchQueue {
        ...
        private boolean initGL() {
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1133d("CameraView start init gl");
            }
            ...
            if (iArr[0] > 0) {
                ...
                if (surfaceTexture != null) {
                    ...
                    int iLoadShader = CameraView.this.loadShader(35633, AndroidUtilities.readRes(C2888R.raw.camera_vert));
                    int iLoadShader2 = CameraView.this.loadShader(35632, AndroidUtilities.readRes(C2888R.raw.camera_frag));
                    if (iLoadShader != 0 && iLoadShader2 != 0) {
                        ...
                        if (iArr3[0] == 0) {
                            if (BuildVars.LOGS_ENABLED) {
                                FileLog.m1134e("failed link shader");
                            }
                    ...
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m1134e("failed creating shader");
                    }
                    finish();
                    return false;
                }
        ...
        private boolean initBlurGL() {
            ...
            if (eGLContextEglCreateContext == null || eGLContextEglCreateContext == EGL10.EGL_NO_CONTEXT) {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m1134e("eglCreateContext (blur) failed " + GLUtils.getEGLErrorString(this.egl10.eglGetError()));
                }
                return false;
            }
            ...
            if (surfaceTexture != null) {
                ...
                int iLoadShader = CameraView.this.loadShader(35633, AndroidUtilities.readRes(C2888R.raw.camera_blur_vert));
                int iLoadShader2 = CameraView.this.loadShader(35632, AndroidUtilities.readRes(C2888R.raw.camera_blur_frag));
                if (iLoadShader != 0 && iLoadShader2 != 0) {
                    int iGlCreateProgram = GLES20.glCreateProgram();
        ...
        /* JADX WARN: Removed duplicated region for block: B:384:0x04a6  */
        ...
        */
            ...
            switch (i) {
                ...
                case 6:
                    ...
                    if (!egl10.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, this.eglContext)) {
                        if (BuildVars.LOGS_ENABLED) {
                            FileLog.m1133d("CameraView eglMakeCurrent failed " + GLUtils.getEGLErrorString(this.egl10.eglGetError()));
                            return;
                        }
                        return;
                    }
                ...
                case 3:
                    ...
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m1133d("CameraView set gl renderer session " + i5 + " angle=" + worldAngle);
                    }
        ...
        private void updateScale(int i) {
            if (CameraView.this.previewSize[i] != null) {
                ...
                FileLog.m1133d("CameraView camera scaleX = " + CameraView.this.scaleX + " scaleY = " + CameraView.this.scaleY);
            }
        }
    ...
    class C29165 extends AnimatorListenerAdapter {
        C29165() {
        }
    ...
    public /* synthetic */ void lambda$createCamera$13(final int i, SurfaceTexture surfaceTexture) {
        ...
        if (this.useCamera2) {
            ...
            this.cameraSession[i] = CameraSessionWrapper.m1189of(camera2SessionCreate);
        ...
        this.cameraSession[i] = CameraSessionWrapper.m1190of(cameraSession);
        cameraGLThread.setCurrentSession(this.cameraSession[i], i);
        requestLayout();
    ...
    public /* synthetic */ void lambda$createCamera$11(int i, CameraSession cameraSession, final CameraGLThread cameraGLThread) {
        if (this.cameraSession[i] != null) {
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1133d("CameraView camera initied " + i);
            }
    ...
    class VideoRecorder implements Runnable {
        ...
        /* synthetic */ VideoRecorder(CameraView cameraView, CameraViewIA cameraViewIA) {
            this();
        }
        ...
        private VideoRecorder() {
            ...
            this.recorderRunnable = new RunnableC29171();
        }

        /* JADX INFO: renamed from: org.telegram.messenger.camera.CameraView$VideoRecorder$1 */
        class RunnableC29171 implements Runnable {
            RunnableC29171() {
            }
            ...
            */
            public void run() {
                /*
                    ...
                    To view this dump change 'Code comments level' option to 'DEBUG'
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.messenger.camera.CameraView.VideoRecorder.RunnableC29171.run():void");
            }
                ...
                try {
                    if (this.ready) {
                        ...
                        if (timestamp == 0) {
                            ...
                            if (BuildVars.LOGS_ENABLED) {
                                FileLog.m1133d("CameraView fix timestamp enabled");
                            }
                        } else {
        ...
        public void handleAudioFrameAvailable(InstantCameraView.AudioBufferInfo audioBufferInfo) {
            ...
            if (this.audioFirst == -1) {
                if (this.videoFirst == -1) {
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m1133d("CameraView video record not yet started");
                        return;
                    }
                    return;
                }
                while (true) {
                    for (int i = 0; i < audioBufferInfo2.results; i++) {
                        if (i == 0 && Math.abs(this.videoFirst - audioBufferInfo2.offset[i]) > 10000000) {
                            ...
                            this.audioFirst = j3;
                            if (BuildVars.LOGS_ENABLED) {
                                FileLog.m1133d("CameraView detected desync between audio and video " + this.desyncTime);
                            }
                        } else {
                            ...
                            if (j4 >= this.videoFirst) {
                                ...
                                this.audioFirst = j4;
                                if (BuildVars.LOGS_ENABLED) {
                                    FileLog.m1133d("CameraView found first audio frame at " + i + " timestamp = " + audioBufferInfo2.offset[i]);
                                }
                            } else {
                                if (BuildVars.LOGS_ENABLED) {
                                    FileLog.m1133d("CameraView ignore first audio frame at " + i + " timestamp = " + audioBufferInfo2.offset[i]);
                                }
                            }
                        }
                    }
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m1133d("CameraView first audio frame not found, removing buffers " + audioBufferInfo2.results);
                    }
                            ...
                            if (i2 < i3) {
                                if (this.running) {
                                    ...
                                    if (audioBufferInfo2.offset[i2] >= this.videoLast - this.desyncTime) {
                                        if (BuildVars.LOGS_ENABLED) {
                                            FileLog.m1133d("CameraView stop audio encoding because of stoped video recording at " + audioBufferInfo2.offset[i2] + " last video " + this.videoLast);
                                        }
        ...
        public void handleVideoFrameAvailable(long j, Integer num) {
            ...
            if (this.videoFirst == -1) {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m1133d("CameraView first video frame was at " + this.videoFirst);
                }
            }
            this.videoLast = j;
                    ...
                    if (CameraView.this.cameraTexture[i2][0] != 0) {
                        ...
                        if (i2 == 1) {
                            ...
                            if (i < 0) {
                                ...
                                GLES20.glUniform1f(this.roundRadiusHandle, AndroidUtilities.m1124dp(16.0f));
                                GLES20.glUniform1f(this.scaleHandle, 1.0f);
                            ...
                            GLES20.glUniform1f(this.alphaHandle, 1.0f);
                            if (z2) {
                                GLES20.glUniform1f(this.roundRadiusHandle, AndroidUtilities.lerp(AndroidUtilities.m1124dp(12.0f), AndroidUtilities.m1124dp(16.0f), f));
                                GLES20.glUniform1f(this.scaleHandle, 1.0f);
        ...
        public void handleStopRecording(int i) {
            ...
            if (this.writingToDifferentFile && !this.fileToWrite.renameTo(this.videoFile)) {
                FileLog.m1134e("unable to rename file, try move file");
                try {
                    AndroidUtilities.copyFile(this.fileToWrite, this.videoFile);
                    this.fileToWrite.delete();
                } catch (IOException e5) {
                    FileLog.m1136e(e5);
                    FileLog.m1134e("unable to move file");
                }
            }
        ...
        public void prepareEncoder() {
            ...
            try {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m1133d("CameraView initied audio record with channels " + this.audioRecorder.getChannelCount() + " sample rate = " + this.audioRecorder.getSampleRate() + " bufferSize = " + i);
                }
                ...
                try {
                    ...
                    if (this.outputMimeType.equals(VIDEO_MIME_TYPE) && (mediaCodec = this.videoEncoder) != null && !mediaCodec.getCodecInfo().isHardwareAccelerated()) {
                        FileLog.m1134e("hevc encoder isn't hardware accelerated");
                        this.videoEncoder.release();
                        this.videoEncoder = null;
                    }
                } catch (Throwable th) {
                    FileLog.m1134e("can't get hevc encoder");
                    FileLog.m1136e(th);
                }
