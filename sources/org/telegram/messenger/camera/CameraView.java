...
public class CameraView extends FrameLayout implements TextureView.SurfaceTextureListener, CameraController.ICameraView, CameraController.ErrorCallback {
    ...
    /* JADX INFO: renamed from: org.telegram.messenger.camera.CameraView$1 */
    public class C28281 implements ValueAnimator.AnimatorUpdateListener {
        public C28281() {
        }
    ...
    /* JADX INFO: renamed from: org.telegram.messenger.camera.CameraView$2 */
    public class C28292 extends AnimatorListenerAdapter {
        public C28292() {
        }
    ...
    public void toggleDual(boolean z) {
        ...
        if (!z2) {
            ...
            CameraSessionWrapper cameraSessionWrapper2 = cameraSessionWrapperArr[1];
            if (cameraSessionWrapper2 == null || !cameraSessionWrapper2.isInitiated()) {
                this.dual = true ^ this.dual;
                return;
            }
    ...
    public CameraView(Context context, boolean z, boolean z2) {
        ...
        this.focusAreaSize = AndroidUtilities.m1036dp(96.0f);
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m1045d("CameraView start create thread");
        }
    ...
    private void updateCameraInfoSize(int i) {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m1045d("camera preview " + this.previewSize[0]);
        }
        requestLayout();
    }
    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
        Object obj;
        CameraSessionWrapper cameraSessionWrapper;
        if ((this.inited || (cameraSessionWrapper = this.cameraSession[0]) == null || !cameraSessionWrapper.isInitiated()) && ((obj = this.renderNode) == null || BotFullscreenButtons$$ExternalSyntheticApiModelOutline1.m1042m(obj).hasDisplayList())) {
            return;
        }
    ...
    public void onSurfaceTextureUpdatedInternal() {
        ...
        if (obj == null || BotFullscreenButtons$$ExternalSyntheticApiModelOutline1.m1042m(obj).hasDisplayList()) {
            return;
        }
        invalidate();
    }
    ...
    public void showTexture(boolean z, boolean z2) {
        ...
        if (z2) {
            ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(textureView.getAlpha(), z ? 1.0f : 0.0f);
        ...
        textureView.setAlpha(z3 ? 1.0f : 0.0f);
    }
    ...
    /* JADX INFO: renamed from: org.telegram.messenger.camera.CameraView$3 */
    public class C28303 extends AnimatorListenerAdapter {
        final /* synthetic */ boolean val$show;
    ...
    public boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (view == this.textureView && canvas.isHardwareAccelerated() && (obj2 = this.renderNode) != null) {
            RenderNode renderNodeM1042m = BotFullscreenButtons$$ExternalSyntheticApiModelOutline1.m1042m(obj2);
        ...
        if (view == this.textureView && canvas.isHardwareAccelerated() && (obj = this.renderNode) != null) {
            ...
            if (obj3 != null) {
                RenderNode renderNodeM1042m3 = BotFullscreenButtons$$ExternalSyntheticApiModelOutline1.m1042m(obj3);
                renderNodeM1042m3.setPosition(0, 0, getWidth(), getHeight());
                renderNodeM1042m3.beginRecording().drawRenderNode(renderNodeM1042m2);
                renderNodeM1042m3.endRecording();
            }
        }
        if (this.focusProgress != 1.0f || this.innerAlpha != 0.0f || this.outerAlpha != 0.0f) {
            ...
            float f = iM1036dp;
            canvas.drawCircle(this.f1192cx, this.f1193cy, ((1.0f - interpolation) * f) + f, this.outerPaint);
            canvas.drawCircle(this.f1192cx, this.f1193cy, f * interpolation, this.innerPaint);
    ...
    public TextureView makeBlurTextureView() {
        if (this.blurTextureView == null) {
            ...
            textureView.setSurfaceTextureListener(new TextureView.SurfaceTextureListener() { // from class: org.telegram.messenger.camera.CameraView.4
                ...
                public TextureViewSurfaceTextureListenerC28314() {
                }
    ...
    /* JADX INFO: renamed from: org.telegram.messenger.camera.CameraView$4 */
    public class TextureViewSurfaceTextureListenerC28314 implements TextureView.SurfaceTextureListener {
        @Override // android.view.TextureView.SurfaceTextureListener
        public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i2) {
        }
    ...
    public class CameraGLThread extends DispatchQueue {
        ...
        private boolean initGL() {
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1045d("CameraView start init gl");
            }
            ...
            if (eGLDisplayEglGetDisplay == EGL10.EGL_NO_DISPLAY) {
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m1046e("eglGetDisplay failed " + GLUtils.getEGLErrorString(this.egl10.eglGetError()));
                }
            ...
            if (!this.egl10.eglInitialize(eGLDisplayEglGetDisplay, new int[2])) {
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m1046e("eglInitialize failed " + GLUtils.getEGLErrorString(this.egl10.eglGetError()));
                }
                finish();
                return false;
            }
            ...
            if (!this.egl10.eglChooseConfig(this.eglDisplay, new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 0, 12325, 0, 12326, 0, 12344}, eGLConfigArr, 1, iArr)) {
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m1046e("eglChooseConfig failed " + GLUtils.getEGLErrorString(this.egl10.eglGetError()));
                }
                finish();
                return false;
            }
            if (iArr[0] > 0) {
                ...
                if (eGLContextEglCreateContext == null || eGLContextEglCreateContext == eGLContext) {
                    ...
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m1046e("eglCreateContext failed " + GLUtils.getEGLErrorString(this.egl10.eglGetError()));
                    }
                    finish();
                    return false;
                }
                ...
                if (surfaceTexture != null) {
                    ...
                    if (eGLSurfaceEglCreateWindowSurface == null || eGLSurfaceEglCreateWindowSurface == EGL10.EGL_NO_SURFACE) {
                        if (BuildVars.LOGS_ENABLED) {
                            FileLog.m1046e("createWindowSurface failed " + GLUtils.getEGLErrorString(this.egl10.eglGetError()));
                        }
                        finish();
                        return false;
                    }
                    if (!this.egl10.eglMakeCurrent(this.eglDisplay, eGLSurfaceEglCreateWindowSurface, eGLSurfaceEglCreateWindowSurface, this.eglContext)) {
                        if (BuildVars.LOGS_ENABLED) {
                            FileLog.m1046e("eglMakeCurrent failed " + GLUtils.getEGLErrorString(this.egl10.eglGetError()));
                        }
                        finish();
                        return false;
                    }
                    android.opengl.Matrix.setIdentityM(CameraView.this.mSTMatrix[0], 0);
                    int iLoadShader = CameraView.this.loadShader(35633, AndroidUtilities.readRes(C2797R.raw.camera_vert));
                    int iLoadShader2 = CameraView.this.loadShader(35632, AndroidUtilities.readRes(C2797R.raw.camera_frag));
                    if (iLoadShader != 0 && iLoadShader2 != 0) {
                        ...
                        if (iArr3[0] == 0) {
                            if (BuildVars.LOGS_ENABLED) {
                                FileLog.m1046e("failed link shader");
                            }
                        ...
                        if (this.initDual) {
                            boolean z = this.initDualReverse;
                            CameraView cameraView = CameraView.this;
                            if (z) {
                                cameraView.createCamera(this.cameraSurface[1], 1);
                                CameraView.this.createCamera(this.cameraSurface[0], 0);
                            } else {
                                cameraView.createCamera(this.cameraSurface[0], 0);
                        ...
                        CameraView cameraView2 = CameraView.this;
                        if (matrix2 != null) {
                            getValues(matrix2, cameraView2.cameraMatrix[1]);
                        } else {
                            getValues(matrix, cameraView2.cameraMatrix[1]);
                        }
                        CameraView.this.lastShapeTo = this.shapeTo;
                        return true;
                    }
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m1046e("failed creating shader");
                    }
                    finish();
                    return false;
                }
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1046e("eglConfig not initialized");
            }
            finish();
            return false;
        }
        ...
        private boolean initBlurGL() {
            ...
            if (eGLContextEglCreateContext == null || eGLContextEglCreateContext == EGL10.EGL_NO_CONTEXT) {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m1046e("eglCreateContext (blur) failed " + GLUtils.getEGLErrorString(this.egl10.eglGetError()));
                }
                return false;
            }
            ...
            if (surfaceTexture != null) {
                ...
                int iLoadShader = CameraView.this.loadShader(35633, AndroidUtilities.readRes(C2797R.raw.camera_blur_vert));
                int iLoadShader2 = CameraView.this.loadShader(35632, AndroidUtilities.readRes(C2797R.raw.camera_blur_frag));
                if (iLoadShader != 0 && iLoadShader2 != 0) {
                    int iGlCreateProgram = GLES20.glCreateProgram();
                    ...
                    int i = iArr[0];
                    int i2 = this.drawBlurProgram;
                    if (i == 0) {
                        GLES20.glDeleteProgram(i2);
                        this.drawBlurProgram = 0;
                    } else {
                        this.blurPositionHandle = GLES20.glGetAttribLocation(i2, "aPosition");
        ...
        /* JADX WARN: Removed duplicated region for block: B:379:0x0489  */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        private void onDraw(int r28, int r29, boolean r30, boolean r31) {
            /*
            ...
            switch (i) {
                ...
                case 6:
                    ...
                    if (!egl10.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, this.eglContext)) {
                        if (BuildVars.LOGS_ENABLED) {
                            FileLog.m1045d("CameraView eglMakeCurrent failed " + GLUtils.getEGLErrorString(this.egl10.eglGetError()));
                            return;
                        }
                        return;
                    }
                ...
                case 3:
                    ...
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m1045d("CameraView set gl renderer session " + i5 + " angle=" + worldAngle);
                    }
        ...
        private void updateScale(int i) {
            if (CameraView.this.previewSize[i] != null) {
                ...
                if (i2 == height) {
                    ...
                    CameraView cameraView = CameraView.this;
                    if (i2 > height) {
                        cameraView.scaleX = height / cameraView.surfaceWidth;
                        CameraView.this.scaleY = 1.0f;
                    } else {
                        cameraView.scaleX = 1.0f;
                        CameraView.this.scaleY = i2 / r4.surfaceHeight;
                    }
                }
                FileLog.m1045d("CameraView camera scaleX = " + CameraView.this.scaleX + " scaleY = " + CameraView.this.scaleY);
            }
        }
    ...
    /* JADX INFO: renamed from: org.telegram.messenger.camera.CameraView$5 */
    public class C28325 extends AnimatorListenerAdapter {
        public C28325() {
        }
    ...
    public /* synthetic */ void lambda$createCamera$13(final int i, SurfaceTexture surfaceTexture) {
        ...
        if (BuildVars.LOGS_ENABLED) {
            ...
            sb.append(this.useCamera2 ? "2" : _UrlKt.FRAGMENT_ENCODE_SET);
            sb.append(" session ");
            sb.append(i);
        ...
        if (this.useCamera2) {
            ...
            this.cameraSession[i] = CameraSessionWrapper.m1089of(camera2SessionCreate);
        ...
        this.cameraSession[i] = CameraSessionWrapper.m1090of(cameraSession);
        cameraGLThread.setCurrentSession(this.cameraSession[i], i);
        requestLayout();
    ...
    public /* synthetic */ void lambda$createCamera$11(int i, CameraSession cameraSession, final CameraGLThread cameraGLThread) {
        if (this.cameraSession[i] != null) {
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1045d("CameraView camera initied " + i);
            }
    ...
    public class VideoRecorder implements Runnable {
        ...
        public /* synthetic */ VideoRecorder(CameraView cameraView, CameraViewIA cameraViewIA) {
            this();
        }
        ...
        private VideoRecorder() {
            ...
            this.recorderRunnable = new RunnableC28331();
        }

        /* JADX INFO: renamed from: org.telegram.messenger.camera.CameraView$VideoRecorder$1 */
        public class RunnableC28331 implements Runnable {
            public RunnableC28331() {
            }

            /* JADX WARN: Code restructure failed: missing block: B:87:0x002f, code lost:
            
                if (org.telegram.messenger.camera.CameraView.VideoRecorder.this.sendWhenDone == 0) goto L139;
             */
            @Override // java.lang.Runnable
            /*
                Code decompiled incorrectly, please refer to instructions dump.
            ...
            */
            public void run() {
                /*
                    ...
                    To view this dump change 'Code comments level' option to 'DEBUG'
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.messenger.camera.CameraView.VideoRecorder.RunnableC28331.run():void");
            }
                ...
                try {
                    if (this.ready) {
                        ...
                        if (timestamp == 0) {
                            ...
                            if (BuildVars.LOGS_ENABLED) {
                                FileLog.m1045d("CameraView fix timestamp enabled");
                            }
                        } else {
        ...
        public void handleAudioFrameAvailable(InstantCameraView.AudioBufferInfo audioBufferInfo) {
            ...
            if (this.audioFirst == -1) {
                if (this.videoFirst == -1) {
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m1045d("CameraView video record not yet started");
                        return;
                    }
                    return;
                }
                while (true) {
                    for (int i = 0; i < audioBufferInfo2.results; i++) {
                        if (i == 0 && Math.abs(this.videoFirst - audioBufferInfo2.offset[i]) > 10000000) {
                            ...
                            this.audioFirst = j3;
                            if (BuildVars.LOGS_ENABLED) {
                                FileLog.m1045d("CameraView detected desync between audio and video " + this.desyncTime);
                            }
                        } else {
                            ...
                            if (j4 >= this.videoFirst) {
                                ...
                                this.audioFirst = j4;
                                if (BuildVars.LOGS_ENABLED) {
                                    FileLog.m1045d("CameraView found first audio frame at " + i + " timestamp = " + audioBufferInfo2.offset[i]);
                                }
                            } else {
                                if (BuildVars.LOGS_ENABLED) {
                                    FileLog.m1045d("CameraView ignore first audio frame at " + i + " timestamp = " + audioBufferInfo2.offset[i]);
                                }
                            }
                        }
                    }
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m1045d("CameraView first audio frame not found, removing buffers " + audioBufferInfo2.results);
                    }
                            ...
                            if (i2 < i3) {
                                if (this.running) {
                                    ...
                                    if (audioBufferInfo2.offset[i2] >= this.videoLast - this.desyncTime) {
                                        if (BuildVars.LOGS_ENABLED) {
                                            FileLog.m1045d("CameraView stop audio encoding because of stoped video recording at " + audioBufferInfo2.offset[i2] + " last video " + this.videoLast);
                                        }
        ...
        public void handleVideoFrameAvailable(long j, Integer num) {
            ...
            if (this.videoFirst == -1) {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m1045d("CameraView first video frame was at " + this.videoFirst);
                }
            }
            this.videoLast = j;
                ...
                if (i != -1 || z2) {
                    ...
                    if (CameraView.this.cameraTexture[i2][0] != 0) {
                        ...
                        if (size != null && CameraView.this.cameraSession[i2] != null) {
                            ...
                            if (i2 == 0) {
                                GLES20.glUniform2f(i3, CameraView.this.pixelW, CameraView.this.pixelH);
                            } else {
                                GLES20.glUniform2f(i3, CameraView.this.pixelDualW, CameraView.this.pixelDualH);
                            }
                        }
                        ...
                        if (i2 == 1) {
                            ...
                            if (i < 0) {
                                ...
                                int i6 = this.roundRadiusHandle;
                                if (!z2) {
                                    GLES20.glUniform1f(i6, AndroidUtilities.m1036dp(16.0f));
                                    GLES20.glUniform1f(this.scaleHandle, 1.0f);
                            ...
                            GLES20.glUniform1f(i5, 1.0f);
                            int i7 = this.roundRadiusHandle;
                            if (z2) {
                                GLES20.glUniform1f(i7, AndroidUtilities.lerp(AndroidUtilities.m1036dp(12.0f), AndroidUtilities.m1036dp(16.0f), f));
                                GLES20.glUniform1f(this.scaleHandle, 1.0f);
        ...
        public void handleStopRecording(int i) {
            ...
            if (this.writingToDifferentFile && !this.fileToWrite.renameTo(this.videoFile)) {
                FileLog.m1046e("unable to rename file, try move file");
                try {
                    AndroidUtilities.copyFile(this.fileToWrite, this.videoFile);
                    this.fileToWrite.delete();
                } catch (IOException e5) {
                    FileLog.m1048e(e5);
                    FileLog.m1046e("unable to move file");
                }
            }
            ...
            this.eglConfig = null;
            this.handler.exit();
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.camera.CameraView$VideoRecorder$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public void prepareEncoder() {
            ...
            try {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m1045d("CameraView initied audio record with channels " + this.audioRecorder.getChannelCount() + " sample rate = " + this.audioRecorder.getSampleRate() + " bufferSize = " + i);
                }
                ...
                try {
                    ...
                    if (this.outputMimeType.equals(VIDEO_MIME_TYPE) && (mediaCodec = this.videoEncoder) != null && !mediaCodec.getCodecInfo().isHardwareAccelerated()) {
                        FileLog.m1046e("hevc encoder isn't hardware accelerated");
                        this.videoEncoder.release();
                        this.videoEncoder = null;
                    }
                } catch (Throwable th) {
                    FileLog.m1046e("can't get hevc encoder");
                    FileLog.m1048e(th);
                }
                ...
                int i3 = iArr2[0];
                int i4 = this.drawProgram;
                if (i3 == 0) {
                    GLES20.glDeleteProgram(i4);
                    this.drawProgram = 0;
                    return;
                }
                this.positionHandle = GLES20.glGetAttribLocation(i4, "aPosition");
                this.textureHandle = GLES20.glGetAttribLocation(this.drawProgram, "aTextureCoord");
                this.vertexMatrixHandle = GLES20.glGetUniformLocation(this.drawProgram, "uMVPMatrix");
                this.textureMatrixHandle = GLES20.glGetUniformLocation(this.drawProgram, "uSTMatrix");
                this.cameraMatrixHandle = GLES20.glGetUniformLocation(this.drawProgram, "cameraMatrix");
                    ...
                    if (i > 1) {
                        ...
                        if ((i2 & 2) == 0) {
                            ...
                            if (this.outputMimeType.equals(VIDEO_MIME_TYPE)) {
                                GlShader$$ExternalSyntheticBUOutline1.m1250m("need fix parsing csd data");
                                return;
                            }
