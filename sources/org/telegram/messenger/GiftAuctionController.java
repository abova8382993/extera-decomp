...
public class GiftAuctionController extends BaseController {
    ...
    public /* synthetic */ void lambda$requestGiftAuctionInternal$4(final Utilities.Callback2 callback2, final TL_payments.TL_StarGiftAuctionState tL_StarGiftAuctionState, final TLRPC.TL_error tL_error) {
        ...
        if (tL_StarGiftAuctionState != null && !this.upgrades.get(tL_StarGiftAuctionState.gift.f1846id, Boolean.FALSE).booleanValue()) {
            this.upgrades.put(tL_StarGiftAuctionState.gift.f1846id, Boolean.TRUE);
            requestAuctionUpgrades(tL_StarGiftAuctionState.gift.f1846id, new Utilities.Callback() { // from class: org.telegram.messenger.GiftAuctionController$$ExternalSyntheticLambda1
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
            ...
            if (tL_StarGiftAuctionState != null) {
                onGiftAuctionStateReceivedInternal(tL_StarGiftAuctionState.gift.f1846id, tL_StarGiftAuctionState);
            }
    ...
    public /* synthetic */ void lambda$requestGiftAuctionInternal$3(TL_payments.TL_StarGiftAuctionState tL_StarGiftAuctionState, Utilities.Callback2 callback2, TLRPC.TL_error tL_error, ArrayList arrayList) {
        getOrCreateAuction(tL_StarGiftAuctionState.gift.f1846id).previewAttributes = arrayList;
        onGiftAuctionStateReceivedInternal(tL_StarGiftAuctionState.gift.f1846id, tL_StarGiftAuctionState);
        callback2.run(tL_StarGiftAuctionState, tL_error);
    }
    ...
    private void applyGiftAuctionStateAndPerformUpdate(TL_stars.StarGift starGift, TL_stars.StarGiftAuctionState starGiftAuctionState, TL_stars.TL_StarGiftAuctionUserState tL_StarGiftAuctionUserState) {
        ...
        boolean zApplyGift;
        AuctionInternal orCreateAuction = getOrCreateAuction(starGift.f1846id);
        ...
        if (zApplyGift) {
            updateActiveAuctions();
            performAuctionUpdate(starGift2.f1846id);
        }
    }
    ...
    static class AuctionInternal {
        ...
        /* synthetic */ AuctionInternal(long j, GiftAuctionControllerIA giftAuctionControllerIA) {
            this(j);
        }
    ...
    public static class Auction {
        ...
        /* synthetic */ Auction(int i, TL_stars.StarGift starGift, TL_stars.StarGiftAuctionState starGiftAuctionState, TL_stars.TL_StarGiftAuctionUserState tL_StarGiftAuctionUserState, GiftAuctionControllerIA giftAuctionControllerIA) {
        ...
        private Auction(int i, TL_stars.StarGift starGift, TL_stars.StarGiftAuctionState starGiftAuctionState, TL_stars.TL_StarGiftAuctionUserState tL_StarGiftAuctionUserState) {
            ...
            this.giftId = starGift.f1846id;
            TLRPC.Document document = starGift.sticker;
            this.giftDocumentId = document != null ? document.f1668id : 0L;
