...
public class SecretChatHelper extends BaseController {
    ...
    private TLRPC.TL_messageService createServiceSecretMessage(TLRPC.EncryptedChat encryptedChat, TLRPC.DecryptedMessageAction decryptedMessageAction) {
        ...
        tL_messageService.dialog_id = DialogObject.makeEncryptedDialogId(encryptedChat.f1672id);
    ...
    protected void processUpdateEncryption(TLRPC.TL_updateEncryption tL_updateEncryption, ConcurrentHashMap<Long, TLRPC.User> concurrentHashMap) {
        ...
        final long jMakeEncryptedDialogId = DialogObject.makeEncryptedDialogId(encryptedChat.f1672id);
        final TLRPC.EncryptedChat encryptedChatDB = getMessagesController().getEncryptedChatDB(encryptedChat.f1672id, false);
        if ((encryptedChat instanceof TLRPC.TL_encryptedChatRequested) && encryptedChatDB == null) {
            ...
            tL_dialog.f1666id = jMakeEncryptedDialogId;
    ...
    public /* synthetic */ void lambda$processUpdateEncryption$1(TLRPC.Dialog dialog, long j) {
        ...
        getMessagesController().dialogs_dict.put(dialog.f1666id, dialog);
    ...
    public void sendNotifyLayerMessage(TLRPC.EncryptedChat encryptedChat, TLRPC.Message message) {
        if ((encryptedChat instanceof TLRPC.TL_encryptedChat) && !this.sendingNotifyLayer.contains(Integer.valueOf(encryptedChat.f1672id))) {
            this.sendingNotifyLayer.add(Integer.valueOf(encryptedChat.f1672id));
            TLRPC.TL_decryptedMessageService tL_decryptedMessageService = new TLRPC.TL_decryptedMessageService();
            if (message != null) {
                tL_decryptedMessageService.action = message.action.encryptedAction;
            } else {
    ...
    public void sendResendMessage(TLRPC.EncryptedChat encryptedChat, int i, int i2, TLRPC.Message message) {
        if (encryptedChat instanceof TLRPC.TL_encryptedChat) {
            SparseIntArray sparseIntArray = this.requestedHoles.get(encryptedChat.f1672id);
            if (sparseIntArray == null || sparseIntArray.indexOfKey(i) < 0) {
                if (sparseIntArray == null) {
                    sparseIntArray = new SparseIntArray();
                    this.requestedHoles.put(encryptedChat.f1672id, sparseIntArray);
                }
    ...
    private void updateMediaPaths(MessageObject messageObject, TLRPC.EncryptedFile encryptedFile, TLRPC.DecryptedMessage decryptedMessage, String str) {
        ...
        if (encryptedFile != null) {
            ...
            if ((messageMedia instanceof TLRPC.TL_messageMediaPhoto) && (photo = messageMedia.photo) != null) {
                ...
                tL_fileEncryptedLocation.f1674iv = decryptedMessageMedia.f1664iv;
                tL_fileEncryptedLocation.dc_id = encryptedFile.dc_id;
                tL_fileEncryptedLocation.volume_id = encryptedFile.f1673id;
            ...
            document2.f1668id = encryptedFile.f1673id;
            ...
            document2.f1669iv = decryptedMessageMedia2.f1664iv;
    ...
    public /* synthetic */ void lambda$performSendEncryptedRequest$8(final TLRPC.EncryptedChat encryptedChat, final TLRPC.DecryptedMessage decryptedMessage, final TLRPC.Message message, TLRPC.InputEncryptedFile inputEncryptedFile, final MessageObject messageObject, final String str) {
        ...
        try {
            ...
            if (i == 0 && message.seq_out == 0) {
                ...
                getMessagesStorage().setMessageSeq(message.f1686id, message.seq_in, message.seq_out);
            } else {
                tL_decryptedMessageLayer.in_seq_no = i;
                tL_decryptedMessageLayer.out_seq_no = message.seq_out;
            }
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1133d(decryptedMessage + " send message with in_seq = " + tL_decryptedMessageLayer.in_seq_no + " out_seq = " + tL_decryptedMessageLayer.out_seq_no);
            }
            ...
            if (inputEncryptedFile == null) {
                if (decryptedMessage instanceof TLRPC.TL_decryptedMessageService) {
                    ...
                    tL_inputEncryptedChat.chat_id = encryptedChat.f1672id;
                    ...
                    tL_inputEncryptedChat2.chat_id = encryptedChat.f1672id;
                ...
                tL_inputEncryptedChat3.chat_id = encryptedChat.f1672id;
            ...
            getConnectionsManager().sendRequest(tLObject, new RequestDelegate() { // from class: org.telegram.messenger.SecretChatHelper$$ExternalSyntheticLambda8
    ...
    public /* synthetic */ void lambda$performSendEncryptedRequest$7(TLRPC.DecryptedMessage decryptedMessage, TLRPC.EncryptedChat encryptedChat, final TLRPC.Message message, MessageObject messageObject, String str, TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (tL_error == null && (decryptedMessage.action instanceof TLRPC.TL_decryptedMessageActionNotifyLayer)) {
            TLRPC.EncryptedChat encryptedChat2 = getMessagesController().getEncryptedChat(Integer.valueOf(encryptedChat.f1672id));
            ...
            this.sendingNotifyLayer.remove(Integer.valueOf(encryptedChat2.f1672id));
    ...
    public /* synthetic */ void lambda$performSendEncryptedRequest$5(final TLRPC.Message message, TLRPC.messages_SentEncryptedMessage messages_sentencryptedmessage, final int i) {
        ...
        getMessagesStorage().updateMessageStateAndId(message.random_id, 0L, Integer.valueOf(message.f1686id), message.f1686id, messages_sentencryptedmessage.date, false, 0, 0);
    ...
    public /* synthetic */ void lambda$performSendEncryptedRequest$4(TLRPC.Message message, int i) {
        ...
        Integer numValueOf2 = Integer.valueOf(message.f1686id);
        ...
        getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.messageReceivedByServer2, Integer.valueOf(message.f1686id), Integer.valueOf(message.f1686id), message, Long.valueOf(message.dialog_id), 0L, Integer.valueOf(i), bool);
        getSendMessagesHelper().processSentMessage(message.f1686id);
        getSendMessagesHelper().removeFromSendingMessages(message.f1686id, false);
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:308:0x07e7  */
    ...
    */
    ...
    public /* synthetic */ void lambda$processDecryptedObject$12(final long j) {
        ...
        if (dialog != null) {
            ...
            getMessagesController().dialogMessage.remove(dialog.f1666id);
        }
    ...
    public /* synthetic */ void lambda$resendMessages$15(int i, TLRPC.EncryptedChat encryptedChat, int i2) {
        ...
        try {
            ...
            int i5 = 1;
            int i6 = 2;
            SQLiteCursor sQLiteCursorQueryFinalized = getMessagesStorage().getDatabase().queryFinalized(String.format(Locale.US, "SELECT uid FROM requested_holes WHERE uid = %d AND ((seq_out_start >= %d AND %d <= seq_out_end) OR (seq_out_start >= %d AND %d <= seq_out_end))", Integer.valueOf(encryptedChat3.f1672id), Integer.valueOf(i3), Integer.valueOf(i3), Integer.valueOf(i2), Integer.valueOf(i2)), new Object[0]);
            boolean next = sQLiteCursorQueryFinalized.next();
            sQLiteCursorQueryFinalized.dispose();
            if (next) {
                return;
            }
            long jMakeEncryptedDialogId = DialogObject.makeEncryptedDialogId(encryptedChat3.f1672id);
            ...
            Collections.sort(arrayList, new Comparator() { // from class: org.telegram.messenger.SecretChatHelper$$ExternalSyntheticLambda15
            ...
            try {
                ...
                Integer numValueOf = Integer.valueOf(encryptedChat2.f1672id);
    ...
    public void checkSecretHoles(TLRPC.EncryptedChat encryptedChat, ArrayList<TLRPC.Message> arrayList) {
        ...
        int i;
        int i2;
        ArrayList<TL_decryptedMessageHolder> arrayList2 = this.secretHolesQueue.get(encryptedChat.f1672id);
        if (arrayList2 == null) {
            return;
        }
        ...
        if (arrayList2.isEmpty()) {
            this.secretHolesQueue.remove(encryptedChat3.f1672id);
        }
        if (z) {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private boolean decryptWithMtProtoVersion(org.telegram.tgnet.NativeByteBuffer r22, byte[] r23, byte[] r24, int r25, boolean r26, boolean r27) {
        /*
    ...
    */
    ...
    public void acceptSecretChat(final TLRPC.EncryptedChat encryptedChat) {
        if (this.acceptingChats.get(encryptedChat.f1672id) != null) {
            return;
        }
        this.acceptingChats.put(encryptedChat.f1672id, encryptedChat);
        ...
        if (tL_error == null) {
            ...
            if (tLObject instanceof TLRPC.TL_messages_dhConfig) {
                if (!Utilities.isGoodPrime(messages_dhconfig.f1836p, messages_dhconfig.f1835g)) {
                    this.acceptingChats.remove(encryptedChat.f1672id);
                    declineSecretChat(encryptedChat.f1672id, false);
                    return;
                } else {
                    getMessagesStorage().setSecretPBytes(messages_dhconfig.f1836p);
                    getMessagesStorage().setSecretG(messages_dhconfig.f1835g);
            ...
            if (tLObject instanceof TLRPC.TL_messages_dhConfig) {
                if (!Utilities.isGoodPrime(messages_dhconfig.f1836p, messages_dhconfig.f1835g)) {
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SecretChatHelper$$ExternalSyntheticLambda26
                        @Override // java.lang.Runnable
                        public final void run() {
                            SecretChatHelper.m4830$r8$lambda$YqWuikQ_EiNlArvmwjHadrTP0(context, alertDialog);
                        }
                    });
                    return;
                }
    ...
    public static /* synthetic */ void m4830$r8$lambda$YqWuikQ_EiNlArvmwjHadrTP0(Context context, AlertDialog alertDialog) {
        try {
    ...
    public /* synthetic */ void lambda$startSecretChat$26(Context context, AlertDialog alertDialog, TLObject tLObject, byte[] bArr, TLRPC.User user) {
        ...
        tL_dialog.f1666id = DialogObject.makeEncryptedDialogId(encryptedChat.f1672id);
        tL_dialog.unread_count = 0;
        tL_dialog.top_message = 0;
        tL_dialog.last_message_date = getConnectionsManager().getCurrentTime();
        getMessagesController().dialogs_dict.put(tL_dialog.f1666id, tL_dialog);
    ...
    public /* synthetic */ void lambda$startSecretChat$27(Context context, AlertDialog alertDialog) {
        ...
        builder.setMessage(LocaleController.getString(C2888R.string.CreateEncryptedChatError));
