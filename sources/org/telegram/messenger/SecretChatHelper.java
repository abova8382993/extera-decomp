...
public class SecretChatHelper extends BaseController {
    ...
    private TLRPC.TL_messageService createServiceSecretMessage(TLRPC.EncryptedChat encryptedChat, TLRPC.DecryptedMessageAction decryptedMessageAction) {
        ...
        tL_messageService.dialog_id = DialogObject.makeEncryptedDialogId(encryptedChat.f1257id);
        ...
        TLRPC.Peer peer = tL_messageService.peer_id;
        if (j == clientUserId) {
            peer.user_id = encryptedChat.admin_id;
        } else {
            peer.user_id = encryptedChat.participant_id;
        }
    ...
    public void processUpdateEncryption(TL_update.TL_updateEncryption tL_updateEncryption, ConcurrentHashMap<Long, TLRPC.User> concurrentHashMap) {
        ...
        final long jMakeEncryptedDialogId = DialogObject.makeEncryptedDialogId(encryptedChat.f1257id);
        final TLRPC.EncryptedChat encryptedChatDB = getMessagesController().getEncryptedChatDB(encryptedChat.f1257id, false);
        if ((encryptedChat instanceof TLRPC.TL_encryptedChatRequested) && encryptedChatDB == null) {
            ...
            tL_dialog.f1251id = jMakeEncryptedDialogId;
    ...
    public /* synthetic */ void lambda$processUpdateEncryption$1(TLRPC.Dialog dialog, long j) {
        ...
        getMessagesController().dialogs_dict.put(dialog.f1251id, dialog);
    ...
    public void sendNotifyLayerMessage(TLRPC.EncryptedChat encryptedChat, TLRPC.Message message) {
        if ((encryptedChat instanceof TLRPC.TL_encryptedChat) && !this.sendingNotifyLayer.contains(Integer.valueOf(encryptedChat.f1257id))) {
            this.sendingNotifyLayer.add(Integer.valueOf(encryptedChat.f1257id));
            TLRPC.TL_decryptedMessageService tL_decryptedMessageService = new TLRPC.TL_decryptedMessageService();
            if (message != null) {
                tL_decryptedMessageService.action = message.action.encryptedAction;
            } else {
    ...
    public void sendResendMessage(TLRPC.EncryptedChat encryptedChat, int i, int i2, TLRPC.Message message) {
        if (encryptedChat instanceof TLRPC.TL_encryptedChat) {
            SparseIntArray sparseIntArray = this.requestedHoles.get(encryptedChat.f1257id);
            if (sparseIntArray == null || sparseIntArray.indexOfKey(i) < 0) {
                if (sparseIntArray == null) {
                    sparseIntArray = new SparseIntArray();
                    this.requestedHoles.put(encryptedChat.f1257id, sparseIntArray);
                }
    ...
    private void updateMediaPaths(MessageObject messageObject, TLRPC.EncryptedFile encryptedFile, TLRPC.DecryptedMessage decryptedMessage, String str) {
        ...
        if (encryptedFile != null) {
            ...
            if ((messageMedia instanceof TLRPC.TL_messageMediaPhoto) && (photo = messageMedia.photo) != null) {
                ...
                tL_fileEncryptedLocation.f1259iv = decryptedMessageMedia.f1249iv;
                tL_fileEncryptedLocation.dc_id = encryptedFile.dc_id;
                tL_fileEncryptedLocation.volume_id = encryptedFile.f1258id;
                ...
                new File(FileLoader.getDirectory(4), str2.concat(".jpg")).renameTo(getFileLoader().getPathToAttach(photoSize));
            ...
            document2.f1253id = encryptedFile.f1258id;
            ...
            document2.f1254iv = decryptedMessageMedia2.f1249iv;
    ...
    public /* synthetic */ void lambda$performSendEncryptedRequest$8(final TLRPC.EncryptedChat encryptedChat, final TLRPC.DecryptedMessage decryptedMessage, final TLRPC.Message message, TLRPC.InputEncryptedFile inputEncryptedFile, final MessageObject messageObject, final String str) {
        ...
        try {
            ...
            if (i == 0 && message.seq_out == 0) {
                ...
                getMessagesStorage().setMessageSeq(message.f1271id, message.seq_in, message.seq_out);
            } else {
                tL_decryptedMessageLayer.in_seq_no = i;
                tL_decryptedMessageLayer.out_seq_no = message.seq_out;
            }
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1045d(decryptedMessage + " send message with in_seq = " + tL_decryptedMessageLayer.in_seq_no + " out_seq = " + tL_decryptedMessageLayer.out_seq_no);
            }
            ...
            if (inputEncryptedFile == null) {
                if (decryptedMessage instanceof TLRPC.TL_decryptedMessageService) {
                    ...
                    tL_inputEncryptedChat.chat_id = encryptedChat.f1257id;
                    ...
                    tL_inputEncryptedChat2.chat_id = encryptedChat.f1257id;
                ...
                tL_inputEncryptedChat3.chat_id = encryptedChat.f1257id;
            ...
            getConnectionsManager().sendRequest(tLObject, new RequestDelegate() { // from class: org.telegram.messenger.SecretChatHelper$$ExternalSyntheticLambda11
                @Override // org.telegram.tgnet.RequestDelegate
                public final void run(TLObject tLObject3, TLRPC.TL_error tL_error) {
                    this.f$0.lambda$performSendEncryptedRequest$7(decryptedMessage, encryptedChat, message, messageObject, str, tLObject3, tL_error);
                }
            }, 64);
        } catch (Exception e) {
            FileLog.m1048e(e);
    ...
    public /* synthetic */ void lambda$performSendEncryptedRequest$7(TLRPC.DecryptedMessage decryptedMessage, TLRPC.EncryptedChat encryptedChat, final TLRPC.Message message, MessageObject messageObject, String str, TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (tL_error == null && (decryptedMessage.action instanceof TLRPC.TL_decryptedMessageActionNotifyLayer)) {
            TLRPC.EncryptedChat encryptedChat2 = getMessagesController().getEncryptedChat(Integer.valueOf(encryptedChat.f1257id));
            ...
            this.sendingNotifyLayer.remove(Integer.valueOf(encryptedChat2.f1257id));
    ...
    public /* synthetic */ void lambda$performSendEncryptedRequest$5(final TLRPC.Message message, TLRPC.messages_SentEncryptedMessage messages_sentencryptedmessage, final int i) {
        ...
        getMessagesStorage().updateMessageStateAndId(message.random_id, 0L, Integer.valueOf(message.f1271id), message.f1271id, messages_sentencryptedmessage.date, false, 0, 0);
    ...
    public /* synthetic */ void lambda$performSendEncryptedRequest$4(TLRPC.Message message, int i) {
        ...
        Integer numValueOf2 = Integer.valueOf(message.f1271id);
        ...
        getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.messageReceivedByServer2, Integer.valueOf(message.f1271id), Integer.valueOf(message.f1271id), message, Long.valueOf(message.dialog_id), 0L, Integer.valueOf(i), bool);
        getSendMessagesHelper().processSentMessage(message.f1271id);
        getSendMessagesHelper().removeFromSendingMessages(message.f1271id, false);
    }
    ...
    */
    public org.telegram.tgnet.TLRPC.Message processDecryptedObject(org.telegram.tgnet.TLRPC.EncryptedChat r18, org.telegram.tgnet.TLRPC.EncryptedFile r19, int r20, org.telegram.tgnet.TLObject r21, boolean r22) {
        /*
            Method dump skipped, instruction units count: 2393
    ...
    public /* synthetic */ void lambda$processDecryptedObject$12(final long j) {
        ...
        if (dialog != null) {
            ...
            getMessagesController().dialogMessage.remove(dialog.f1251id);
        }
    ...
    /* JADX WARN: Type inference failed for: r0v16, types: [org.telegram.messenger.SendMessagesHelper] */
    /* JADX WARN: Type inference failed for: r0v32, types: [org.telegram.tgnet.InputSerializedData, org.telegram.tgnet.NativeByteBuffer] */
    /* JADX WARN: Type inference failed for: r14v0, types: [org.telegram.SQLite.SQLiteCursor] */
    /* JADX WARN: Type inference failed for: r1v12, types: [org.telegram.tgnet.TLRPC$Message] */
    /* JADX WARN: Type inference failed for: r1v13, types: [java.lang.Object] */
    /* JADX WARN: Type inference failed for: r1v15, types: [org.telegram.tgnet.TLRPC$Message] */
    ...
    public /* synthetic */ void lambda$resendMessages$15(int i, TLRPC.EncryptedChat encryptedChat, int i2) {
        ...
        try {
            ...
            ?? r8 = 0;
            SQLiteCursor sQLiteCursorQueryFinalized = getMessagesStorage().getDatabase().queryFinalized(String.format(Locale.US, "SELECT uid FROM requested_holes WHERE uid = %d AND ((seq_out_start >= %d AND %d <= seq_out_end) OR (seq_out_start >= %d AND %d <= seq_out_end))", Integer.valueOf(encryptedChat3.f1257id), Integer.valueOf(i3), Integer.valueOf(i3), Integer.valueOf(i2), Integer.valueOf(i2)), new Object[0]);
            boolean next = sQLiteCursorQueryFinalized.next();
            sQLiteCursorQueryFinalized.dispose();
            if (next) {
                return;
            }
            long jMakeEncryptedDialogId = DialogObject.makeEncryptedDialogId(encryptedChat3.f1257id);
            ...
            while (QueryFinalized.next()) {
                ...
                if (ByteBufferValue != 0) {
                    CreateDeleteMessage = TLRPC.Message.TLdeserialize(ByteBufferValue, ByteBufferValue.readInt32(r8), r8);
                    ...
                    j = jMakeEncryptedDialogId;
                    CreateDeleteMessage = createDeleteMessage(iIntValue3, iIntValue2, iIntValue, j2, encryptedChat3);
                }
            ...
            Collections.sort(arrayList, new Comparator() { // from class: org.telegram.messenger.SecretChatHelper$$ExternalSyntheticLambda18
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SecretChatHelper$$ExternalSyntheticLambda19
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$resendMessages$14(arrayList);
                }
            });
            getSendMessagesHelper().processUnsentMessages(arrayList, null, new ArrayList(), new ArrayList(), arrayList2);
            getMessagesStorage().getDatabase().executeFast(String.format(Locale.US, "REPLACE INTO requested_holes VALUES(%d, %d, %d)", Integer.valueOf(encryptedChat2.f1257id), Integer.valueOf(i3), Integer.valueOf(i2))).stepThis().dispose();
        } catch (Exception e) {
            FileLog.m1048e(e);
        }
    }
    ...
    public void checkSecretHoles(TLRPC.EncryptedChat encryptedChat, ArrayList<TLRPC.Message> arrayList) {
        ...
        int i;
        int i2;
        ArrayList<TL_decryptedMessageHolder> arrayList2 = this.secretHolesQueue.get(encryptedChat.f1257id);
        if (arrayList2 == null) {
            return;
        }
        ...
        while (arrayList2.size() > 0 && ((i = (tL_decryptedMessageLayer = (tL_decryptedMessageHolder = arrayList2.get(0)).layer).out_seq_no) == (i2 = encryptedChat.seq_in) || i2 == i - 2)) {
            this.applyPeerLayer(encryptedChat, tL_decryptedMessageLayer.layer);
            ...
            TLRPC.Message messageProcessDecryptedObject = secretChatHelper.processDecryptedObject(encryptedChat2, tL_decryptedMessageHolder.file, tL_decryptedMessageHolder.date, tL_decryptedMessageHolder.layer.message, tL_decryptedMessageHolder.new_key_used);
            if (messageProcessDecryptedObject != null) {
                arrayList.add(messageProcessDecryptedObject);
            }
            z = true;
            this = secretChatHelper;
            encryptedChat = encryptedChat2;
        }
        SecretChatHelper secretChatHelper2 = this;
        TLRPC.EncryptedChat encryptedChat3 = encryptedChat;
        if (arrayList2.isEmpty()) {
            secretChatHelper2.secretHolesQueue.remove(encryptedChat3.f1257id);
        }
        if (z) {
            secretChatHelper2.getMessagesStorage().updateEncryptedChatSeq(encryptedChat3, true);
        }
    }
    ...
    */
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:105:0x022d A[Catch: Exception -> 0x003e, TryCatch #0 {Exception -> 0x003e, blocks: (B:7:0x0021, B:9:0x0025, B:11:0x0031, B:14:0x0041, B:16:0x004c, B:18:0x0067, B:27:0x007f, B:31:0x0096, B:36:0x009f, B:39:0x00a9, B:46:0x00c2, B:48:0x00d3, B:49:0x00d9, B:51:0x00dd, B:53:0x00e3, B:55:0x00e7, B:57:0x00f5, B:58:0x00fb, B:59:0x00fe, B:61:0x0105, B:63:0x0109, B:65:0x0110, B:67:0x0114, B:68:0x0146, B:72:0x014f, B:76:0x0156, B:78:0x0159, B:80:0x015d, B:81:0x0163, B:83:0x017a, B:84:0x0186, B:86:0x018d, B:88:0x01c9, B:91:0x01e4, B:92:0x01ec, B:99:0x0214, B:101:0x0225, B:102:0x0228, B:94:0x0204, B:96:0x0208, B:105:0x022d, B:107:0x0234, B:20:0x006b, B:24:0x0077), top: B:111:0x0021 }] */
    /* JADX WARN: Removed duplicated region for block: B:27:0x007f A[Catch: Exception -> 0x003e, TryCatch #0 {Exception -> 0x003e, blocks: (B:7:0x0021, B:9:0x0025, B:11:0x0031, B:14:0x0041, B:16:0x004c, B:18:0x0067, B:27:0x007f, B:31:0x0096, B:36:0x009f, B:39:0x00a9, B:46:0x00c2, B:48:0x00d3, B:49:0x00d9, B:51:0x00dd, B:53:0x00e3, B:55:0x00e7, B:57:0x00f5, B:58:0x00fb, B:59:0x00fe, B:61:0x0105, B:63:0x0109, B:65:0x0110, B:67:0x0114, B:68:0x0146, B:72:0x014f, B:76:0x0156, B:78:0x0159, B:80:0x015d, B:81:0x0163, B:83:0x017a, B:84:0x0186, B:86:0x018d, B:88:0x01c9, B:91:0x01e4, B:92:0x01ec, B:99:0x0214, B:101:0x0225, B:102:0x0228, B:94:0x0204, B:96:0x0208, B:105:0x022d, B:107:0x0234, B:20:0x006b, B:24:0x0077), top: B:111:0x0021 }] */
    /* JADX WARN: Type inference failed for: r0v14 */
    /* JADX WARN: Type inference failed for: r0v6 */
    /* JADX WARN: Type inference failed for: r0v7, types: [org.telegram.messenger.BaseController, org.telegram.messenger.SecretChatHelper] */
    /* JADX WARN: Type inference failed for: r5v4, types: [org.telegram.tgnet.TLRPC$Message] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    */
    ...
    public void acceptSecretChat(final TLRPC.EncryptedChat encryptedChat) {
        if (this.acceptingChats.get(encryptedChat.f1257id) != null) {
            return;
        }
        this.acceptingChats.put(encryptedChat.f1257id, encryptedChat);
        ...
        if (tL_error == null) {
            ...
            if (tLObject instanceof TLRPC.TL_messages_dhConfig) {
                if (!Utilities.isGoodPrime(messages_dhconfig.f1418p, messages_dhconfig.f1417g)) {
                    this.acceptingChats.remove(encryptedChat.f1257id);
                    declineSecretChat(encryptedChat.f1257id, false);
                    return;
                } else {
                    getMessagesStorage().setSecretPBytes(messages_dhconfig.f1418p);
                    getMessagesStorage().setSecretG(messages_dhconfig.f1417g);
    ...
    public void startSecretChat(final Context context, final TLRPC.User user) {
        ...
        tL_messages_getDhConfig.random_length = 256;
        tL_messages_getDhConfig.version = getMessagesStorage().getLastSecretVersion();
        final int iSendRequest = getConnectionsManager().sendRequest(tL_messages_getDhConfig, new RequestDelegate() { // from class: org.telegram.messenger.SecretChatHelper$$ExternalSyntheticLambda9
            @Override // org.telegram.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
            ...
            if (tLObject instanceof TLRPC.TL_messages_dhConfig) {
                if (!Utilities.isGoodPrime(messages_dhconfig.f1418p, messages_dhconfig.f1417g)) {
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.SecretChatHelper$$ExternalSyntheticLambda26
                        @Override // java.lang.Runnable
                        public final void run() {
                            SecretChatHelper.m6217$r8$lambda$YqWuikQ_EiNlArvmwjHadrTP0(context, alertDialog);
                        }
                    });
                    return;
                }
    ...
    /* JADX INFO: renamed from: $r8$lambda$YqWuikQ_EiNlArv-mwjHadr-TP0, reason: not valid java name */
    public static /* synthetic */ void m6217$r8$lambda$YqWuikQ_EiNlArvmwjHadrTP0(Context context, AlertDialog alertDialog) {
        try {
    ...
    public /* synthetic */ void lambda$startSecretChat$26(Context context, AlertDialog alertDialog, TLObject tLObject, byte[] bArr, TLRPC.User user) {
        ...
        tL_dialog.f1251id = DialogObject.makeEncryptedDialogId(encryptedChat.f1257id);
        tL_dialog.unread_count = 0;
        tL_dialog.top_message = 0;
        tL_dialog.last_message_date = getConnectionsManager().getCurrentTime();
        getMessagesController().dialogs_dict.put(tL_dialog.f1251id, tL_dialog);
    ...
    public /* synthetic */ void lambda$startSecretChat$27(Context context, AlertDialog alertDialog) {
        ...
        builder.setMessage(LocaleController.getString(C2797R.string.CreateEncryptedChatError));
