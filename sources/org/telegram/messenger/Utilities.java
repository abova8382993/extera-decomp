...
public class Utilities {
    ...
    public static Bitmap stackBlurBitmapMax(Bitmap bitmap, boolean z) {
        ...
        int iM1124dp2 = (int) ((AndroidUtilities.m1124dp(20.0f) * bitmap.getHeight()) / bitmap.getWidth());
        Bitmap bitmapCreateBitmap = Bitmap.createBitmap(iM1124dp, iM1124dp2, Bitmap.Config.ARGB_8888);
        ...
        canvas.restore();
        stackBlurBitmap(bitmapCreateBitmap, Math.max(10, Math.max(iM1124dp, iM1124dp2) / 150));
        return bitmapCreateBitmap;
    }

    public static Bitmap stackBlurBitmapWithScaleFactor(Bitmap bitmap, float f) {
        int iMax = (int) Math.max(AndroidUtilities.m1124dp(20.0f), bitmap.getWidth() / f);
        int iMax2 = (int) Math.max((AndroidUtilities.m1124dp(20.0f) * bitmap.getHeight()) / bitmap.getWidth(), bitmap.getHeight() / f);
