...
public class MessagePreviewParams {
    ...
    public class Messages {
        ...
        public Messages(Boolean bool, int i, ArrayList<MessageObject> arrayList, long j, SparseBooleanArray sparseBooleanArray) {
            LongSparseArray<MessageObject.GroupedMessages> longSparseArray;
            ...
            int i6 = 0;
            while (true) {
                int size3 = this.groupedMessagesMap.size();
                longSparseArray = this.groupedMessagesMap;
                if (i6 >= size3) {
                    break;
                }
                longSparseArray.valueAt(i6).calculate();
                i6++;
            }
    ...
    */
    public org.telegram.messenger.MessageObject toPreviewMessage(org.telegram.messenger.MessageObject r12, java.lang.Boolean r13, int r14) {
        /*
    ...
    /* JADX INFO: renamed from: org.telegram.messenger.MessagePreviewParams$1 */
    /* JADX INFO: loaded from: classes5.dex */
    public class C27811 extends MessageObject {
        final /* synthetic */ int val$msgtype;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C27811(int i, TLRPC.Message message, boolean z, boolean z2, int i2) {
