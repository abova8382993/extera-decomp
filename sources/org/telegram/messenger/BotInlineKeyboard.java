...
public class BotInlineKeyboard {
    ...
    public static class Builder {
        ...
        public void addSuggestionKeyboard() {
            this.buttons.add(new Button[]{new ButtonCustom(1, C2797R.string.PostSuggestionsInlineDecline, C2797R.drawable.filled_bot_decline_24), new ButtonCustom(2, C2797R.string.PostSuggestionsInlineAccept, C2797R.drawable.filled_bot_approve_24)});
            this.buttons.add(new Button[]{new ButtonCustom(3, C2797R.string.PostSuggestionsInlineEdit, C2797R.drawable.filled_bot_suggest_24)});
        }

        public void addGiftOfferKeyboard() {
            this.buttons.add(new Button[]{new ButtonCustom(5, C2797R.string.GiftOfferDecline, C2797R.drawable.filled_bot_decline_24), new ButtonCustom(6, C2797R.string.GiftOfferAccept, C2797R.drawable.filled_bot_approve_24)});
        }

        public void addSharingOfferKeyboard() {
            this.buttons.add(new Button[]{new ButtonCustom(7, C2797R.string.DisableSharingOfferDecline, C2797R.drawable.filled_bot_decline_24), new ButtonCustom(8, C2797R.string.DisableSharingOfferAccept, C2797R.drawable.filled_bot_approve_24)});
        }

        public void addContinueThreadKeyboard() {
            this.buttons.add(new Button[]{new ButtonCustom(4, C2797R.string.BotForumContinueChat, 0)});
        }
