...
public final class RuntimeClassNameTypeAdapterFactory<T> implements TypeAdapterFactory {
    ...
    public static <T> RuntimeClassNameTypeAdapterFactory<T> m1173of(Class<T> cls, String str, ExclusionStrategy exclusionStrategy) {
        return new RuntimeClassNameTypeAdapterFactory<>(cls, str, exclusionStrategy);
    }

    /* JADX INFO: renamed from: of */
    public static <T> RuntimeClassNameTypeAdapterFactory<T> m1172of(Class<T> cls) {
