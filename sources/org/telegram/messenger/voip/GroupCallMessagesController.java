...
public class GroupCallMessagesController extends BaseController {
    ...
    public void processUpdate(TLRPC.TL_updateGroupCallMessage tL_updateGroupCallMessage) {
        final long j = tL_updateGroupCallMessage.call.f1682id;
        long peerDialogId = DialogObject.getPeerDialogId(tL_updateGroupCallMessage.message.from_id);
        long j2 = tL_updateGroupCallMessage.message.f1676id;
    ...
    public void processUpdate(TLRPC.TL_updateGroupCallEncryptedMessage tL_updateGroupCallEncryptedMessage) {
        final long j = tL_updateGroupCallEncryptedMessage.call.f1682id;
    ...
    public /* synthetic */ void lambda$processUpdate$3(long j, long j2, byte[] bArr) {
        long j3;
        final long j4;
        ...
        try {
            ...
            j3 = j2;
            j4 = j;
            groupCallMessagesController = this;
        ...
        if (tL_groupCallMessageTLJsonDeserialize != null) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.voip.GroupCallMessagesController$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$processUpdate$1(j4, groupCallMessage);
                }
            });
            return;
        }
        ...
        tL_textWithEntities.text = LocaleController.getString(C2888R.string.GroupCalMessageDecryptionError);
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.voip.GroupCallMessagesController$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$processUpdate$2(j4, groupCallMessage2);
            }
        });
    }
    ...
    public boolean sendCallMessage(long j, TLRPC.TL_textWithEntities tL_textWithEntities, long j2, TLRPC.InputGroupCall inputGroupCall) {
        ...
        if (sharedInstance.isConference()) {
            ...
            if (conferenceCall == null || (groupCall = conferenceCall.groupCall) == null || groupCall.f1675id != j2) {
                return false;
            }
        ...
        final Runnable runnable = new Runnable() { // from class: org.telegram.messenger.voip.GroupCallMessagesController$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                GroupCallMessagesController.m5173$r8$lambda$BoiMzYkL9iUych8eS3PH9Yfbqk(groupCallMessage);
            }
        };
    ...
    public static /* synthetic */ void m5173$r8$lambda$BoiMzYkL9iUych8eS3PH9Yfbqk(GroupCallMessage groupCallMessage) {
    ...
    private byte[] groupCallMessageDecrypt(long j, long j2, byte[] bArr) {
        ...
        TLRPC.GroupCall groupCall;
        VoIPService sharedInstance = VoIPService.getSharedInstance();
        if (sharedInstance == null || sharedInstance.getAccount() != this.currentAccount || (conferenceCall = sharedInstance.conference) == null || (groupCall = conferenceCall.groupCall) == null || groupCall.f1675id != j) {
            return null;
        }
        long callId = conferenceCall.getCallId();
        if (callId == -1) {
