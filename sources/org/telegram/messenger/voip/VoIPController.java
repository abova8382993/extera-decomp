...
public class VoIPController {
    ...
    public void setEncryptionKey(byte[] bArr, boolean z) {
        if (bArr.length != 256) {
            IntegerType$$ExternalSyntheticBUOutline0.m547m("key length must be exactly 256 bytes but is ", bArr.length);
        } else {
            ensureNativeInstance();
    ...
    public void ensureNativeInstance() {
        ...
        Segment$$ExternalSyntheticBUOutline1.m992m("Native instance is not valid");
    }
    ...
    public void setConfig(double d, double d2, int i, long j) {
        ...
        boolean z2 = MessagesController.getGlobalMainSettings().getBoolean("dbg_dump_call_stats", false);
        long j3 = this.nativeInst;
        boolean z3 = true;
        if (zIsAvailable && VoIPServerConfig.getBoolean("use_system_aec", true)) {
            j2 = j3;
            z = false;
        } else {
            j2 = j3;
        ...
        nativeSetConfig(j2, d, d2, i, z, z3, true, logFilePath, (BuildVars.DEBUG_VERSION && z2) ? getLogFilePath("voipStats") : null, BuildVars.DEBUG_VERSION);
    }
    ...
    public void getStats(Stats stats) {
        ensureNativeInstance();
        if (stats == null) {
            g$$ExternalSyntheticBUOutline2.m208m("You're not supposed to pass null here");
        } else {
    ...
    public void setProxy(String str, int i, String str2, String str3) {
        ensureNativeInstance();
        if (str == null) {
            g$$ExternalSyntheticBUOutline2.m208m("address can't be null");
        } else {
