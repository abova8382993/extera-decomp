...
public class AudioRecordJNI {
    ...
    private NoiseSuppressor f1650ns;
        ...
        if (zTryInit) {
            try {
                if (AutomaticGainControl.isAvailable()) {
                    ...
                    VLog.m1207w("AutomaticGainControl is not available on this device :(");
                }
            } catch (Throwable th) {
                VLog.m1203e("error creating AutomaticGainControl", th);
            }
            try {
                if (NoiseSuppressor.isAvailable()) {
                    NoiseSuppressor noiseSuppressorCreate = NoiseSuppressor.create(this.audioRecord.getAudioSessionId());
                    this.f1650ns = noiseSuppressorCreate;
                    if (noiseSuppressorCreate != null) {
                        noiseSuppressorCreate.setEnabled(Instance.getGlobalServerConfig().useSystemNs && isGoodAudioEffect(this.f1650ns));
                    }
                } else {
                    VLog.m1207w("NoiseSuppressor is not available on this device :(");
                }
            } catch (Throwable th2) {
                VLog.m1203e("error creating NoiseSuppressor", th2);
            }
            try {
                if (AcousticEchoCanceler.isAvailable()) {
                    ...
                    VLog.m1207w("AcousticEchoCanceler is not available on this device");
                }
            } catch (Throwable th3) {
                VLog.m1203e("error creating AcousticEchoCanceler", th3);
            }
    ...
    private boolean tryInit(int i, int i2) {
        ...
        VLog.m1205i("Trying to initialize AudioRecord with source=" + i + " and sample rate=" + i2);
        try {
            i3 = i2;
            try {
                ...
                e = e;
                VLog.m1203e("AudioRecord init failed!", e);
            }
        } catch (Exception e2) {
            e = e2;
            i3 = i2;
    ...
    public void release() {
        ...
        NoiseSuppressor noiseSuppressor = this.f1650ns;
    ...
    public boolean start() {
        ...
        if (audioRecord != null && audioRecord.getState() == 1) {
            try {
                ...
                VLog.m1203e("Error initializing AudioRecord", e);
            }
        }
        return false;
    }
    ...
    public /* synthetic */ void lambda$startThread$0(ByteBuffer byteBuffer) {
        ...
        VLog.m1205i("audiorecord thread exits");
    }
    ...
    private static boolean isGoodAudioEffect(AudioEffect audioEffect) {
        ...
        VLog.m1201d(audioEffect.getClass().getSimpleName() + ": implementor=" + descriptor.implementor + ", name=" + descriptor.name);
