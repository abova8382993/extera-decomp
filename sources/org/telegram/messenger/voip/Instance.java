...
public final class Instance {
    ...
    public static void setGlobalServerConfig(String str) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1135e("failed to parse tgvoip server config", e);
            }
        }
    }
    ...
    public static final class Endpoint {
        ...
        public String toString() {
            return "Endpoint{id=" + this.f1653id + ", ipv4='" + this.ipv4 + "', ipv6='" + this.ipv6 + "', port=" + this.port + ", type=" + this.type + ", peerTag=" + Arrays.toString(this.peerTag) + ", turn=" + this.turn + ", stun=" + this.stun + ", username=" + this.username + ", password=" + this.password + ", tcp=" + this.tcp + '}';
        }
    }
    ...
    public static final class Candidate {
        ...
        /* JADX INFO: renamed from: id */
        public final String f1651id;

        /* JADX INFO: renamed from: ip */
        public final String f1652ip;
        ...
        public String toString() {
            return "Candidate{port=" + this.port + ", protocol=" + this.protocol + ", network=" + this.network + ", generation=" + this.generation + ", id=" + this.f1651id + ", component=" + this.component + ", foundation=" + this.foundation + ", priority=" + this.priority + ", ip=" + this.f1652ip + ", type=" + this.type + ", tcpType=" + this.tcpType + ", relAddr=" + this.relAddr + ", relPort=" + this.relPort + '}';
        }
    }
