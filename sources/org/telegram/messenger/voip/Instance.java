...
public final class Instance {
    ...
    public static void setGlobalServerConfig(String str) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1047e("failed to parse tgvoip server config", e);
            }
        }
    }
    ...
    private static void checkHasDelegate() {
        ...
        Segment$$ExternalSyntheticBUOutline1.m992m("tgvoip version is not set");
    }
    ...
    public static final class Endpoint {
        ...
        public String toString() {
            return "Endpoint{id=" + this.f1238id + ", ipv4='" + this.ipv4 + "', ipv6='" + this.ipv6 + "', port=" + this.port + ", type=" + this.type + ", peerTag=" + Arrays.toString(this.peerTag) + ", turn=" + this.turn + ", stun=" + this.stun + ", username=" + this.username + ", password=" + this.password + ", tcp=" + this.tcp + '}';
        }
    }
    ...
    public static final class Candidate {
        ...
        /* JADX INFO: renamed from: id */
        public final String f1236id;

        /* JADX INFO: renamed from: ip */
        public final String f1237ip;
        ...
        public String toString() {
            return "Candidate{port=" + this.port + ", protocol=" + this.protocol + ", network=" + this.network + ", generation=" + this.generation + ", id=" + this.f1236id + ", component=" + this.component + ", foundation=" + this.foundation + ", priority=" + this.priority + ", ip=" + this.f1237ip + ", type=" + this.type + ", tcpType=" + this.tcpType + ", relAddr=" + this.relAddr + ", relPort=" + this.relPort + '}';
        }
    }
    ...
    public static final class ServerConfig {
        ...
        public String getString(String str) {
            return getString(str, _UrlKt.FRAGMENT_ENCODE_SET);
        }
