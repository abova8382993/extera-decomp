...
public class VideoCapturerDevice {
    ...
    public VideoCapturerDevice(final boolean z) {
        ...
        Logging.m1252d("VideoCapturerDevice", "device model = " + Build.MANUFACTURER + Build.MODEL);
    ...
    public /* synthetic */ void lambda$init$5(final long j, String str) {
        ...
        if ("screen".equals(str)) {
            if (this.videoCapturer == null) {
                this.videoCapturer = new ScreenCapturerAndroid(mediaProjectionPermissionResultData, new C28661());
                final Point screenCaptureSize = getScreenCaptureSize();
        ...
        if (this.videoCapturer == null) {
            this.videoCapturer = camera2Enumerator.createCapturer(str2, new C28672());
            ...
            FileLog.m1045d("VideoCapturerDevice init(" + j + "): videoCapturer.switchCamera CAMERA");
    ...
    public class C28661 extends MediaProjection.Callback {
        public C28661() {
        }
        ...
        public void onStop() {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.voip.VideoCapturerDevice$1$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    VideoCapturerDevice.C28661.m6593$r8$lambda$ZQSuWiFDNOs2qmwnLNxKb4FvRU();
                }
            });
        }

        /* JADX INFO: renamed from: $r8$lambda$ZQSuWiFDNOs2qmwnLNxKb-4FvRU */
        public static /* synthetic */ void m6593$r8$lambda$ZQSuWiFDNOs2qmwnLNxKb4FvRU() {
    ...
    public /* synthetic */ void lambda$init$2(long j, Point point) {
        if (this.videoCapturerSurfaceTextureHelper != null) {
            ...
            FileLog.m1045d("VideoCapturerDevice init(" + j + "): videoCapturer.startCapture SCREEN");
    ...
    public class C28672 implements CameraVideoCapturer.CameraEventsHandler {
        ...
        public void onFirstFrameAvailable() {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.voip.VideoCapturerDevice$2$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    VideoCapturerDevice.C28672.$r8$lambda$nw9ghc47P82EeNmCdLj2fBnzRy0();
                }
            });
        }
    ...
    public /* synthetic */ void lambda$init$3(long j) {
        ...
        this.videoCapturer.initialize(this.videoCapturerSurfaceTextureHelper, ApplicationLoader.applicationContext, this.nativeCapturerObserver);
        FileLog.m1045d("VideoCapturerDevice init(" + j + "): videoCapturer.startCapture CAMERA");
    ...
    public class C28683 implements CameraVideoCapturer.CameraSwitchHandler {
        ...
        public void onCameraSwitchDone(final boolean z) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.voip.VideoCapturerDevice$3$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    VideoCapturerDevice.C28683.$r8$lambda$67_itrkxqu4lzdGSiVNTf3YO7M8(z);
                }
            });
        }
    ...
    public /* synthetic */ void lambda$init$4(String str) {
        ((CameraVideoCapturer) this.videoCapturer).switchCamera(new C28683(), str);
    }
    ...
    private void onStateChanged(final long j, final int i) {
        FileLog.m1045d("VideoCapturerDevice onStateChanged(" + j + ", " + i + ")");
    ...
    public /* synthetic */ void lambda$onStateChanged$6(int i, long j) {
        ...
        if (i == 2) {
            FileLog.m1045d("VideoCapturerDevice onStateChanged(" + j + ", " + i + "): videoCapturer.startCapture");
            this.videoCapturer.startCapture(CAPTURE_WIDTH, CAPTURE_HEIGHT, 30);
            return;
        }
        try {
            FileLog.m1045d("VideoCapturerDevice onStateChanged(" + j + ", " + i + "): videoCapturer.stopCapture");
    ...
    private void onDestroy() {
        FileLog.m1045d("VideoCapturerDevice onDestroy ptr=" + this.nativePtr);
        this.nativePtr = 0L;
    ...
    public /* synthetic */ void lambda$onDestroy$8() {
        ...
        if (this.videoCapturer != null) {
            FileLog.m1045d("VideoCapturerDevice onDestroy: videoCapturer.stopCapture");
            try {
                this.videoCapturer.stopCapture();
