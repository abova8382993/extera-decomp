...
public class PasskeysController {
    public static void create(final Context context, final int i, final Utilities.Callback2<TL_account.Passkey, String> callback2) {
        if (BuildVars.SUPPORTS_PASSKEYS) {
            final CredentialManager credentialManagerCreate = CredentialManager.create(context);
            ...
            ConnectionsManager.getInstance(i).sendRequestTyped(new TL_account.initPasskeyRegistration(), new AiTonesController$$ExternalSyntheticLambda0(), new Utilities.Callback2() { // from class: org.telegram.messenger.PasskeysController$$ExternalSyntheticLambda12
                ...
                public final void run(Object obj, Object obj2) {
                    PasskeysController.m6169$r8$lambda$uzlz7C9RirnBVnV8ty3z_v7jkQ(alertDialog, callback2, credentialManagerCreate, context, i, (TL_account.passkeyRegistrationOptions) obj, (TLRPC.TL_error) obj2);
                }
            });
        }
    }
    ...
    public static /* synthetic */ void m6169$r8$lambda$uzlz7C9RirnBVnV8ty3z_v7jkQ(AlertDialog alertDialog, final Utilities.Callback2 callback2, CredentialManager credentialManager, final Context context, final int i, TL_account.passkeyRegistrationOptions passkeyregistrationoptions, TLRPC.TL_error tL_error) {
        alertDialog.dismiss();
        if (tL_error != null) {
        ...
        try {
            ...
            try {
                credentialManager.createCredential(context, new CreatePublicKeyCredentialRequest(string, PasskeysUtil.computeClientDataHash(strGenerateClientDataJSONRaw), false, str), ktxCallback(new Utilities.Callback2() { // from class: org.telegram.messenger.PasskeysController$$ExternalSyntheticLambda8
                    @Override // org.telegram.messenger.Utilities.Callback2
                    public final void run(Object obj, Object obj2) {
                        PasskeysController.m6166$r8$lambda$1MjSTZs9CI0K3y07f5XdZkv0jE(callback2, strGenerateClientDataJSONRaw, context, i, (CreateCredentialResponse) obj, (Throwable) obj2);
                    }
                }));
            } catch (Exception e) {
                FileLog.m1048e(e);
    ...
    public static /* synthetic */ void m6166$r8$lambda$1MjSTZs9CI0K3y07f5XdZkv0jE(final Utilities.Callback2 callback2, String str, final Context context, final int i, CreateCredentialResponse createCredentialResponse, final Throwable th) {
        ...
        try {
            ...
            inputpasskeycredentialpublickey.f1423id = jSONObject.getString("id");
            ...
            FileLog.m1045d("AAGUID: " + bytesToHex(Arrays.copyOfRange(inputpasskeyresponseregister.attestation_object, 67, 83)));
    ...
    public static /* synthetic */ void $r8$lambda$y0t8xdzxstUVdPjML0pMI_yGUOg(Context context, final int i, TL_account.registerPasskey registerpasskey, final Utilities.Callback2 callback2) {
        final AlertDialog alertDialog = new AlertDialog(context, 3);
        alertDialog.showDelayed(500L);
        final int iSendRequestTyped = ConnectionsManager.getInstance(i).sendRequestTyped(registerpasskey, new AiTonesController$$ExternalSyntheticLambda0(), new Utilities.Callback2() { // from class: org.telegram.messenger.PasskeysController$$ExternalSyntheticLambda10
            @Override // org.telegram.messenger.Utilities.Callback2
            public final void run(Object obj, Object obj2) {
    ...
    public static Runnable login(final Context context, final int i, final boolean z, final Utilities.Callback3<Long, TLRPC.auth_Authorization, String> callback3) {
        ...
        final int iSendRequestTyped = ConnectionsManager.getInstance(i).sendRequestTyped(initpasskeylogin, new AiTonesController$$ExternalSyntheticLambda0(), new Utilities.Callback2() { // from class: org.telegram.messenger.PasskeysController$$ExternalSyntheticLambda0
            @Override // org.telegram.messenger.Utilities.Callback2
            public final void run(Object obj, Object obj2) {
        ...
        return new Runnable() { // from class: org.telegram.messenger.PasskeysController$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                PasskeysController.m6168$r8$lambda$r0BjSG3ZEIMsdcfxhA6pR0B2FM(zArr, runnableArr);
            }
        };
    }
    ...
    public static /* synthetic */ void $r8$lambda$3L4sUw_47wNxWVaSQ6GIWRaiOEQ(boolean[] zArr, Utilities.Callback3 callback3, boolean z, CredentialManager credentialManager, Context context, int i, Runnable[] runnableArr, TL_account.passkeyLoginOptions passkeyloginoptions, TLRPC.TL_error tL_error) {
        ...
        try {
            ...
            try {
                ...
                credentialManager.getCredentialAsync(context, getCredentialRequestBuild, cancellationSignal, context.getMainExecutor(), new C27931(strGenerateClientDataJSONRaw, callback3, context, i));
    ...
    public class C27931 implements CredentialManagerCallback<GetCredentialResponse, GetCredentialException> {
        final /* synthetic */ String val$clientDataJSON;
        final /* synthetic */ Context val$context;
        final /* synthetic */ int val$currentAccount;
        final /* synthetic */ Utilities.Callback3 val$done;

        public C27931(String str, Utilities.Callback3 callback3, Context context, int i) {
        ...
        public void onResult(GetCredentialResponse getCredentialResponse) {
            ...
            try {
                ...
                finishpasskeylogin.credential.f1423id = jSONObject.getString("id");
                ...
                final int iSendRequestTyped = connectionsManager.sendRequestTyped(finishpasskeylogin, aiTonesController$$ExternalSyntheticLambda0, new Utilities.Callback2() { // from class: org.telegram.messenger.PasskeysController$1$$ExternalSyntheticLambda0
                    @Override // org.telegram.messenger.Utilities.Callback2
                    public final void run(Object obj, Object obj2) {
                        PasskeysController.C27931.$r8$lambda$gx4vqzEbMkPbuY3kEBWRgHgji2Q(alertDialog, callback3, j, (TLRPC.auth_Authorization) obj, (TLRPC.TL_error) obj2);
                    }
                }, i, 72);
                ...
                alertDialog.setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: org.telegram.messenger.PasskeysController$1$$ExternalSyntheticLambda1
                    @Override // android.content.DialogInterface.OnCancelListener
                    public final void onCancel(DialogInterface dialogInterface) {
                        PasskeysController.C27931.$r8$lambda$aD_TSB9_08HxxMQbIkVP1CwvnZ0(i2, iSendRequestTyped, callback32, j, dialogInterface);
                    }
                });
            } catch (Exception e) {
                FileLog.m1048e(e);
    ...
    public static /* synthetic */ void m6168$r8$lambda$r0BjSG3ZEIMsdcfxhA6pR0B2FM(boolean[] zArr, Runnable[] runnableArr) {
        zArr[0] = true;
    ...
    public static <T> Continuation<T> ktxCallback(final CoroutineContext coroutineContext, final Utilities.Callback2<T, Throwable> callback2) {
        return new Continuation<T>() { // from class: org.telegram.messenger.PasskeysController.2
            ...
            public void resumeWith(Object obj) {
                ...
                if (z) {
                    callback22.run(null, ((Result.Failure) obj).exception);
                } else {
                    callback22.run(obj, null);
                }
            }
        };
    }
