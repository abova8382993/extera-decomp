...
public abstract class CacheFetcher<Args, R> {
    ...
    public void getRemote(int i, Args args, long j, Utilities.Callback4<Boolean, R, Long, Boolean> callback4) {
    }
    ...
    public void setLocal(int i, Args args, R r, long j) {
    }
    ...
    public void getLocal(int i, Args args, Utilities.Callback2<Long, R> callback2) {
    ...
    public /* synthetic */ void lambda$fetch$0(Pair pair, Object obj, int i, Object obj2, Boolean bool, Object obj3, Long l, Boolean bool2) {
        ...
        if (obj3 != null) {
            CacheFetcher cacheFetcher2 = this;
            obj4 = obj3;
            cacheFetcher2.setLocal(i, obj2, obj4, l.longValue());
            cacheFetcher2.cacheResult(pair, obj4);
            cacheFetcher = cacheFetcher2;
        } else {
            cacheFetcher = this;
            obj4 = obj3;
        }
        cacheFetcher.callCallbacks(pair, obj4, true);
    }
