...
public abstract class PhotoUtilities {
    public static void applyPhotoToUser(TLRPC.Photo photo, TLRPC.User user, boolean z) {
        ...
        tL_userProfilePhoto.photo_id = photo.f1276id;
            ...
            public final void didUploadPhoto(TLRPC.InputFile inputFile, TLRPC.InputFile inputFile2, double d, String str, TLRPC.PhotoSize photoSize, TLRPC.PhotoSize photoSize2, boolean z, TLRPC.VideoSize videoSize) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.utils.PhotoUtilities$$ExternalSyntheticLambda4
                    ...
                    public final void run() {
                        PhotoUtilities.m6508$r8$lambda$7MejB92G72HNHArTnHvAEjZ0Ys(inputFile, inputFile2, d, videoSize, i, photoSize2, photoSize, runnable, iNavigationLayout, imageUpdater);
                    }
                });
            }
        });
    ...
    public static /* synthetic */ void m6508$r8$lambda$7MejB92G72HNHArTnHvAEjZ0Ys(TLRPC.InputFile inputFile, TLRPC.InputFile inputFile2, double d, TLRPC.VideoSize videoSize, final int i, final TLRPC.PhotoSize photoSize, final TLRPC.PhotoSize photoSize2, final Runnable runnable, final INavigationLayout iNavigationLayout, ImageUpdater imageUpdater) {
        ...
        ConnectionsManager.getInstance(i).sendRequest(tL_photos_uploadProfilePhoto, new RequestDelegate() { // from class: org.telegram.messenger.utils.PhotoUtilities$$ExternalSyntheticLambda6
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.utils.PhotoUtilities$$ExternalSyntheticLambda7
                    @Override // java.lang.Runnable
                    public final void run() {
                        PhotoUtilities.m6511$r8$lambda$qx2kormntPEvjsmL_mb7R_n0Dg(tLObject, i, photoSize, photoSize, runnable, iNavigationLayout);
                    }
                });
            }
        });
    ...
    public static /* synthetic */ void m6511$r8$lambda$qx2kormntPEvjsmL_mb7R_n0Dg(TLObject tLObject, final int i, TLRPC.PhotoSize photoSize, TLRPC.PhotoSize photoSize2, Runnable runnable, final INavigationLayout iNavigationLayout) {
        if (tLObject instanceof TLRPC.TL_photos_photo) {
            ...
            BulletinFactory.m1143of(iNavigationLayout.getLastFragment()).createUsersBulletin(Collections.singletonList(user), AndroidUtilities.replaceTags(LocaleController.getString(C2797R.string.ApplyAvatarHintTitle)), AndroidUtilities.replaceSingleTag(LocaleController.getString(C2797R.string.ApplyAvatarHint), new Runnable() { // from class: org.telegram.messenger.utils.PhotoUtilities$$ExternalSyntheticLambda8
                @Override // java.lang.Runnable
                public final void run() {
                    PhotoUtilities.m6509$r8$lambda$ozcDEvBk9PRJN_Uvr7r6EfrkSw(i, iNavigationLayout);
                }
            }), null).show();
        }
    }
    ...
    public static /* synthetic */ void m6509$r8$lambda$ozcDEvBk9PRJN_Uvr7r6EfrkSw(int i, INavigationLayout iNavigationLayout) {
    ...
    public static void showAvatartConstructorForUpdateUserPhoto(final ChatActivity chatActivity, TLRPC.VideoSize videoSize) {
        ...
        imageUpdater.setDelegate(new ImageUpdater.ImageUpdaterDelegate() { // from class: org.telegram.messenger.utils.PhotoUtilities$$ExternalSyntheticLambda0
            ...
            public final void didUploadPhoto(TLRPC.InputFile inputFile, TLRPC.InputFile inputFile2, double d, String str, TLRPC.PhotoSize photoSize, TLRPC.PhotoSize photoSize2, boolean z, TLRPC.VideoSize videoSize2) {
                PhotoUtilities.m6507$r8$lambda$4UaqjCAnbRsMNEcpG9vGjmmDbE(chatActivity, fileLocationArr, fileLocationArr2, clientUserId, inputFile, inputFile2, d, str, photoSize, photoSize2, z, videoSize2);
            }
        });
    }
    ...
    public static /* synthetic */ void $r8$lambda$VGyOKEJ4EPt_YZymp46qHxmuRrU(TLRPC.TL_error tL_error, final ChatActivity chatActivity, TLObject tLObject, TLRPC.FileLocation[] fileLocationArr, String str, TLRPC.FileLocation[] fileLocationArr2, final long j) {
        if (tL_error == null) {
            ...
            chatActivity.getMessagesController().getDialogPhotos(user.f1407id).addPhotoAtStart(tL_photos_photo.photo);
            ...
            BulletinFactory.m1143of(chatActivity).createUsersBulletin(Collections.singletonList(user), AndroidUtilities.replaceTags(LocaleController.getString(C2797R.string.ApplyAvatarHintTitle)), AndroidUtilities.replaceSingleTag(LocaleController.getString(C2797R.string.ApplyAvatarHint), new Runnable() { // from class: org.telegram.messenger.utils.PhotoUtilities$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
                    PhotoUtilities.m6510$r8$lambda$qLMsmLE_mPCuS_MPL8DHMzZJas(j, chatActivity);
                }
            }), null).show();
        }
    }
    ...
    public static /* synthetic */ void m6510$r8$lambda$qLMsmLE_mPCuS_MPL8DHMzZJas(long j, ChatActivity chatActivity) {
        Bundle bundle = new Bundle();
