...
public abstract class RectFMergeBounding {
    private static final Comparator<RectF> RECT_COMPARATOR = new Comparator() { // from class: org.telegram.messenger.utils.RectFMergeBounding$$ExternalSyntheticLambda0
        @Override // java.util.Comparator
        public final int compare(Object obj, Object obj2) {
            return RectFMergeBounding.m6512$r8$lambda$3FEaNDNxTEmLiir9NQLN9ndvqw((RectF) obj, (RectF) obj2);
        }
    };

    public static int mergeOverlapping(List<RectF> list, int i, List<RectF> list2) {
        boolean z;
        if (list == null || i <= 0) {
            return 0;
        }
        ...
        do {
            ...
            while (true) {
                ...
                RectF rectF3 = list2.get(i3);
                i3++;
                for (int i4 = i3; i4 < i; i4++) {
                    RectF rectF4 = list2.get(i4);
    ...
    public static /* synthetic */ int m6512$r8$lambda$3FEaNDNxTEmLiir9NQLN9ndvqw(RectF rectF, RectF rectF2) {
