...
public class AmountUtils$Amount {
    ...
    public String asDecimalString() {
        return zzah$$ExternalSyntheticBackportWithForwarding0.m371m(new BigDecimal(asNano()).divide(BigDecimal.valueOf(getDecimals(this.currency)), MathContext.UNLIMITED)).toPlainString();
    }
    ...
    public String asFormatString(char c2) {
        StringBuilder sb = new StringBuilder(LocaleController.formatNumber(asDecimal(), c2));
    ...
    public String formatAsDecimalSpaced() {
        if (isRound()) {
            int i = AmountUtils$1.f1224xdde0284e[this.currency.ordinal()];
            if (i == 1) {
        ...
        int i2 = AmountUtils$1.f1224xdde0284e[this.currency.ordinal()];
        if (i2 == 1) {
            return LocaleController.formatString(C2797R.string.StarsCountX, asDecimalString());
        }
        if (i2 == 2) {
            return LocaleController.formatString(C2797R.string.TonCountX, asDecimalString());
        }
        return _UrlKt.FRAGMENT_ENCODE_SET;
    }
    ...
    public static AmountUtils$Amount fromDecimal(String str, AmountUtils$Currency amountUtils$Currency) {
        try {
            ...
            if (bigDecimalMultiply.compareTo(BigDecimal.valueOf(LongCompanionObject.MAX_VALUE)) > 0) {
                return null;
            }
    ...
    public static AmountUtils$Amount m1099of(TL_stars.StarsAmount starsAmount) {
    ...
    public static AmountUtils$Amount ofSafe(TL_stars.StarsAmount starsAmount) {
        AmountUtils$Amount amountUtils$AmountM1099of = m1099of(starsAmount);
        return amountUtils$AmountM1099of != null ? amountUtils$AmountM1099of : fromNano(0L, AmountUtils$Currency.STARS);
    }

    public static boolean equals(TL_stars.StarsAmount starsAmount, TL_stars.StarsAmount starsAmount2) {
        return equals(m1099of(starsAmount), m1099of(starsAmount2));
    }
