...
public class BitmapsCache {
    ...
    private static final int f1633N = Utilities.clamp(Runtime.getRuntime().availableProcessors() - 2, 6, 1);
    ...
    class RunnableC29301 implements Runnable {
        RunnableC29301() {
        }
    ...
    public BitmapsCache(File file, Cacheable cacheable, CacheOptions cacheOptions, int i, int i2, boolean z) {
        ...
        this.file = file3;
        this.useSharedBuffers = i < AndroidUtilities.m1124dp(60.0f) && i2 < AndroidUtilities.m1124dp(60.0f);
        ...
        if (i <= 0) {
            ...
            RLottieDrawable.lottieCacheGenerateQueue.postRunnable(new Runnable() { // from class: org.telegram.messenger.utils.BitmapsCache$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    BitmapsCache.m5090$r8$lambda$75FwZaXfPh7AZ0gZ3tKl5Rqbyg();
                }
            });
        }
    }
    ...
    public static /* synthetic */ void m5090$r8$lambda$75FwZaXfPh7AZ0gZ3tKl5Rqbyg() {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:220:0x01ae, code lost:
        ...
        org.telegram.messenger.FileLog.m1133d("cancelled cache generation");
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:223:0x01b8, code lost:
        ...
        if (r14 >= org.telegram.messenger.utils.BitmapsCache.f1633N) goto L275;
     */
    ...
    */
    ...
    class FrameOffset {
        ...
        /* synthetic */ FrameOffset(BitmapsCache bitmapsCache, int i, BitmapsCacheIA bitmapsCacheIA) {
            this(i);
        }
    ...
    static class CacheGeneratorSharedTools {
        ...
        /* synthetic */ CacheGeneratorSharedTools(BitmapsCacheIA bitmapsCacheIA) {
            this();
        }

        private CacheGeneratorSharedTools() {
            this.byteArrayOutputStream = new ImmutableByteArrayOutputStream[BitmapsCache.f1633N];
            this.bitmap = new Bitmap[BitmapsCache.f1633N];
        }
        ...
        void allocate(int i, int i2) {
            ...
            this.lastSize = i3;
            for (int i4 = 0; i4 < BitmapsCache.f1633N; i4++) {
        ...
        void release() {
            ...
            for (int i = 0; i < BitmapsCache.f1633N; i++) {
