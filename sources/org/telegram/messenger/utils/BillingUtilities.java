...
public abstract class BillingUtilities {
    ...
    public static String savePurpose(TLRPC.InputStorePaymentPurpose inputStorePaymentPurpose) {
        ...
        FileLog.m1133d("BillingUtilities.savePurpose id=" + jNextLong + " paymentPurpose=" + inputStorePaymentPurpose);
        ...
        FileLog.m1133d("BillingUtilities.savePurpose id_hex=" + strBytesToHex + " paymentPurpose=" + inputStorePaymentPurpose);
        TL_savedPurpose tL_savedPurpose = new TL_savedPurpose();
        tL_savedPurpose.f1632id = jNextLong;
        ...
        if (tL_savedPurpose.getObjectSize() > 28) {
            FileLog.m1133d("BillingUtilities.savePurpose: sending short version, original size is " + tL_savedPurpose.getObjectSize() + " bytes");
        ...
        FileLog.m1133d("BillingUtilities.savePurpose: saved {" + strBytesToHex2 + "} under " + strBytesToHex);
    ...
    public static TLRPC.InputStorePaymentPurpose getPurpose(String str) {
        FileLog.m1133d("BillingUtilities.getPurpose " + str);
        ...
        if (tL_savedPurposeTLdeserialize.purpose != null) {
            FileLog.m1133d("BillingUtilities.getPurpose: got purpose from received obfuscated profile id");
            return tL_savedPurposeTLdeserialize.purpose;
        }
        SerializedData serializedData2 = new SerializedData(8);
        serializedData2.writeInt64(tL_savedPurposeTLdeserialize.f1632id);
        String strBytesToHex = Utilities.bytesToHex(serializedData2.toByteArray());
        serializedData2.cleanup();
        FileLog.m1133d("BillingUtilities.getPurpose: searching purpose under " + strBytesToHex);
        String string = ApplicationLoader.applicationContext.getSharedPreferences("purchases", 0).getString(strBytesToHex, null);
        if (string == null) {
            FileLog.m1133d("BillingUtilities.getPurpose: purpose under " + strBytesToHex + " not found");
            throw new RuntimeException("no purpose under " + strBytesToHex + " found :(");
        }
        FileLog.m1133d("BillingUtilities.getPurpose: got {" + string + "} under " + strBytesToHex);
    ...
    public static void clearPurpose(String str) {
        try {
            FileLog.m1133d("BillingUtilities.clearPurpose: got {" + str + "}");
            SerializedData serializedData = new SerializedData(Utilities.hexToBytes(str));
            TL_savedPurpose tL_savedPurposeTLdeserialize = TL_savedPurpose.TLdeserialize(serializedData, serializedData.readInt32(true), true);
            SerializedData serializedData2 = new SerializedData(8);
            serializedData2.writeInt64(tL_savedPurposeTLdeserialize.f1632id);
            String strBytesToHex = Utilities.bytesToHex(serializedData2.toByteArray());
            serializedData2.cleanup();
            FileLog.m1133d("BillingUtilities.clearPurpose: id_hex = " + strBytesToHex);
    ...
    public static class TL_savedPurpose extends TLObject {
        ...
        public void readParams(InputSerializedData inputSerializedData, boolean z) {
            ...
            this.f1632id = inputSerializedData.readInt64(z);
            if ((this.flags & 1) != 0) {
        ...
        public void serializeToStream(OutputSerializedData outputSerializedData) {
            ...
            outputSerializedData.writeInt64(this.f1632id);
            if ((this.flags & 1) != 0) {
    ...
    public static Pair extractDeveloperPayload(Purchase purchase) {
        ...
        if (accountIdentifiers == null) {
            FileLog.m1133d("Billing: Extract payload. No AccountIdentifiers");
            return null;
        }
        ...
        if (obfuscatedAccountId == null || obfuscatedAccountId.isEmpty() || obfuscatedProfileId == null || obfuscatedProfileId.isEmpty()) {
            FileLog.m1133d("Billing: Extract payload. Empty AccountIdentifiers");
            return null;
        }
        try {
            try {
                ...
                FileLog.m1135e("Billing: Extract payload, failed to get purpose", e);
                purpose = null;
            }
            String str = new String(Base64.decode(obfuscatedAccountId, 0), Charsets.UTF_8);
            FileLog.m1133d("Billing: Extract payload. obfuscatedAccountIdString=" + str);
            if (str.startsWith("account-")) {
                ...
                if (accountInstanceFindAccountById == null) {
                    FileLog.m1133d("Billing: Extract payload. AccountInstance not found, accountId=" + j);
                    return null;
                }
            ...
            FileLog.m1135e("Billing: Extract Payload", e2);
            return null;
        }
    }
