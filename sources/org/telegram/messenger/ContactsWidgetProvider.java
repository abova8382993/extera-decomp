    ...
    public static void updateWidget(Context context, AppWidgetManager appWidgetManager, int i) {
        ...
        if (!sharedPreferences.getBoolean("deleted" + i, false)) {
            ...
            if (i4 == -1) {
                ...
                editorEdit.putInt("type" + i, 0).apply();
            }
            ...
            if (cellsForSize == 1 || iCeil <= 1) {
                i3 = C2888R.layout.contacts_widget_layout_1;
            } else if (cellsForSize == 2 || iCeil <= 2) {
                i3 = C2888R.layout.contacts_widget_layout_2;
            } else if (cellsForSize == 3 || iCeil <= 3) {
                i3 = C2888R.layout.contacts_widget_layout_3;
            } else {
                i3 = C2888R.layout.contacts_widget_layout_4;
            }
        } else {
            i2 = i;
            i3 = C2888R.layout.contacts_widget_layout_1;
        ...
        remoteViews.setRemoteAdapter(i2, C2888R.id.list_view, intent);
        remoteViews.setEmptyView(C2888R.id.list_view, C2888R.id.empty_view);
        Intent intent2 = new Intent(ApplicationLoader.applicationContext, (Class<?>) LaunchActivity.class);
        intent2.setAction("com.tmessages.openchat" + Math.random() + Integer.MAX_VALUE);
        intent2.addFlags(67108864);
        intent2.addCategory("android.intent.category.LAUNCHER");
        remoteViews.setPendingIntentTemplate(C2888R.id.list_view, PendingIntent.getActivity(ApplicationLoader.applicationContext, 0, intent2, 167772160));
        appWidgetManager.updateAppWidget(i2, remoteViews);
        appWidgetManager.notifyAppWidgetViewDataChanged(i2, C2888R.id.list_view);
    }
}
