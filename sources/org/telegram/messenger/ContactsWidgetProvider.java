    ...
    public static void updateWidget(Context context, AppWidgetManager appWidgetManager, int i) {
        ...
        if (!sharedPreferences.getBoolean("deleted" + i, false)) {
            ...
            if (cellsForSize == 1 || iCeil <= 1) {
                i3 = C2797R.layout.contacts_widget_layout_1;
            } else if (cellsForSize == 2 || iCeil <= 2) {
                i3 = C2797R.layout.contacts_widget_layout_2;
            } else if (cellsForSize == 3 || iCeil <= 3) {
                i3 = C2797R.layout.contacts_widget_layout_3;
            } else {
                i3 = C2797R.layout.contacts_widget_layout_4;
            }
        } else {
            i2 = i;
            i3 = C2797R.layout.contacts_widget_layout_1;
