    ...
    public static NotchInfo getInfo(Context context) {
        ...
        if (identifier != 0) {
            ...
            try {
                ...
                if (i != 17 && Math.abs(rectF.centerX() - (displayMetrics2.widthPixels / 2.0f)) <= AndroidUtilities.m1124dp(2.0f)) {
                    i = 17;
                }
                ...
                notchInfo.isLikelyCircle = rectF.width() <= ((float) AndroidUtilities.m1124dp(32.0f)) || rectF.width() <= rectF.height();
                return notchInfo;
            } catch (Throwable th) {
                FileLog.m1135e("Failed to parse notch info", th);
            }
        }
        return null;
    }
