...
public class SvgHelper {
            ...
            for (int i5 = 0; i5 < size; i5++) {
                ...
                if (obj instanceof Matrix) {
                    ...
                    if (obj instanceof Path) {
                        ...
                        Line line = (Line) obj;
                        canvas.drawLine(line.f1611x1, line.f1613y1, line.f1612x2, line.f1614y2, paint);
                    } else if (obj instanceof Circle) {
                        Circle circle = (Circle) obj;
                        canvas.drawCircle(circle.f1609x1, circle.f1610y1, circle.rad, paint);
    ...
    public static class ParserHelper {
        ...
        private CharSequence f1616s;

        public ParserHelper(CharSequence charSequence, int i) {
            this.f1616s = charSequence;
            this.pos = i;
            this.f1615n = charSequence.length();
        ...
        private char read() {
            ...
            return this.f1616s.charAt(i3);
        }

        public void skipWhitespace() {
            while (true) {
                int i = this.pos;
                if (i >= this.f1615n || !Character.isWhitespace(this.f1616s.charAt(i))) {
                    return;
                } else {
                    advance();
                }
        ...
        public void skipNumberSeparator() {
            while (true) {
                ...
                char cCharAt = this.f1616s.charAt(i);
                if (cCharAt != '\t' && cCharAt != '\n' && cCharAt != ' ' && cCharAt != ',') {
                    return;
                } else {
                    advance();
