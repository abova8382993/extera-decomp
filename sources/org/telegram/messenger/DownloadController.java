...
public class DownloadController extends BaseController implements NotificationCenter.NotificationCenterDelegate {
    ...
    private final LongSparseArray<Long> typingTimes;
    ...
    public DownloadController(int i) {
        ...
        C27301 c27301 = new BroadcastReceiver() { // from class: org.telegram.messenger.DownloadController.1
            public C27301() {
            }
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            ApplicationLoader.applicationContext.registerReceiver(c27301, intentFilter, 4);
        } else {
            ApplicationLoader.applicationContext.registerReceiver(c27301, intentFilter);
        }
    ...
    public class C27301 extends BroadcastReceiver {
        public C27301() {
        }
    ...
    public void loadAutoDownloadConfig(boolean z) {
        ...
        if (z || Math.abs(System.currentTimeMillis() - getUserConfig().autoDownloadConfigLoadTime) >= DurationKt.MILLIS_IN_DAY) {
    ...
    public void checkAutodownloadSettings() {
        ...
        ArrayList<DownloadObject> arrayList3;
        ArrayList<DownloadObject> arrayList4;
        ...
        if ((currentDownloadMask & 1) != 0) {
            ...
            int i = 0;
            while (true) {
                int size = this.photoDownloadQueue.size();
                arrayList = this.photoDownloadQueue;
                if (i >= size) {
                    break;
                }
                DownloadObject downloadObject = arrayList.get(i);
        ...
        if ((currentDownloadMask & 2) != 0) {
            ...
            int i2 = 0;
            while (true) {
                int size2 = this.audioDownloadQueue.size();
                arrayList2 = this.audioDownloadQueue;
                if (i2 >= size2) {
                    break;
                }
                getFileLoader().cancelLoadFile((TLRPC.Document) arrayList2.get(i2).object);
                i2++;
            }
            arrayList2.clear();
        }
        if ((currentDownloadMask & 8) != 0) {
            ...
            int i3 = 0;
            while (true) {
                int size3 = this.documentDownloadQueue.size();
                arrayList3 = this.documentDownloadQueue;
                if (i3 >= size3) {
                    break;
                }
                getFileLoader().cancelLoadFile((TLRPC.Document) arrayList3.get(i3).object);
                i3++;
            }
            arrayList3.clear();
        }
        if ((currentDownloadMask & 4) != 0) {
            ...
            int i4 = 0;
            while (true) {
                int size4 = this.videoDownloadQueue.size();
                arrayList4 = this.videoDownloadQueue;
                if (i4 >= size4) {
                    break;
                }
                getFileLoader().cancelLoadFile((TLRPC.Document) arrayList4.get(i4).object);
                i4++;
            }
            arrayList4.clear();
        }
    ...
    public boolean canDownloadMedia(int i, long j) {
        ...
        return (i == 1 || (j != 0 && j <= currentMobilePreset.sizes[typeToIndex(i)])) && (i == 2 || (currentMobilePreset.mask[1] & i) != 0);
    }
    ...
    */
    private int canDownloadMediaInternal(org.telegram.messenger.MessageObject r15) {
        /*
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private int canDownloadMediaInternal(org.telegram.messenger.MessageObject r13, long r14) {
        /*
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public int canDownloadMedia(org.telegram.tgnet.TLRPC.Message r14) {
        /*
            Method dump skipped, instruction units count: 335
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public int canDownloadMedia(org.telegram.tgnet.TLRPC.Message r13, org.telegram.tgnet.TLRPC.MessageMedia r14) {
        /*
        ...
        for (int i3 = 0; i3 < arrayList.size(); i3++) {
            ...
            if (tLObject instanceof TLRPC.Document) {
                ...
                if (str == null && !this.downloadQueueKeys.containsKey(str)) {
                    ...
                    this.downloadQueuePairs.put(new Pair<>(Long.valueOf(downloadObject.f1139id), Integer.valueOf(downloadObject.type)), downloadObject);
                }
            }
    ...
    private void checkDownloadFinished(String str, int i) {
        ...
        if (downloadObject != null) {
            ...
            this.downloadQueuePairs.remove(new Pair(Long.valueOf(downloadObject.f1139id), Integer.valueOf(downloadObject.type)));
            if (i == 0 || i == 2) {
                getMessagesStorage().removeFromDownloadQueue(downloadObject.f1139id, downloadObject.type, false);
            }
    ...
    public /* synthetic */ void lambda$startDownloadFile$5(TLRPC.Document document, final MessageObject messageObject) {
        ...
        while (true) {
            ...
            if (messageObject2 != null && (document3 = messageObject2.getDocument()) != null && document3.f1253id == document.f1253id) {
                z2 = true;
                break;
            }
            i++;
        ...
        if (z2) {
            ...
            for (int i2 = 0; i2 < this.downloadingFiles.size(); i2++) {
                ...
                if (messageObject3 != null && (document2 = messageObject3.getDocument()) != null && document2.f1253id == document.f1253id) {
                    break;
                }
            }
            z = z2;
    ...
    public /* synthetic */ void lambda$startDownloadFile$4(MessageObject messageObject) {
        try {
            ...
            sQLitePreparedStatementExecuteFast.bindLong(3, messageObject.getDocument().f1253id);
    ...
    public /* synthetic */ void lambda$onDownloadComplete$7(TLRPC.Document document, final MessageObject messageObject) {
        for (int i = 0; i < this.downloadingFiles.size(); i++) {
            if (this.downloadingFiles.get(i).getDocument() != null && this.downloadingFiles.get(i).getDocument().f1253id == document.f1253id) {
                this.downloadingFiles.remove(i);
                int i2 = 0;
                while (true) {
                    int size = this.recentDownloadingFiles.size();
                    ArrayList<MessageObject> arrayList = this.recentDownloadingFiles;
                    if (i2 < size) {
                        if (arrayList.get(i2).getDocument() != null && this.recentDownloadingFiles.get(i2).getDocument().f1253id == document.f1253id) {
                            break;
                        } else {
                            i2++;
                        }
    ...
    public /* synthetic */ void lambda$onDownloadComplete$6(MessageObject messageObject) {
        try {
            getMessagesStorage().getDatabase().executeFast(String.format(Locale.ENGLISH, "UPDATE downloading_documents SET state = 1, date = %d WHERE hash = %d AND id = %d", Long.valueOf(System.currentTimeMillis()), Integer.valueOf(messageObject.getDocument().dc_id), Long.valueOf(messageObject.getDocument().f1253id))).stepThis().dispose();
            ...
            if (iIntValue > 100) {
                ...
                while (sQLiteCursorQueryFinalized3.next()) {
                    ...
                    downloadingDocumentEntry.f1138id = sQLiteCursorQueryFinalized3.longValue(1);
                ...
                for (int i = 0; i < arrayList.size(); i++) {
                    ...
                    sQLitePreparedStatementExecuteFast.bindLong(2, ((DownloadingDocumentEntry) arrayList.get(i)).f1138id);
                    sQLitePreparedStatementExecuteFast.step();
                }
                sQLitePreparedStatementExecuteFast.dispose();
            }
    ...
    public /* synthetic */ void lambda$onDownloadFail$8(MessageObject messageObject, int i) {
        ...
        for (int i2 = 0; i2 < this.downloadingFiles.size(); i2++) {
            ...
            if (document2 == null || (document != null && document2.f1253id == document.f1253id)) {
                this.downloadingFiles.remove(i2);
                getNotificationCenter().lambda$postNotificationNameOnUIThread$1(NotificationCenter.onDownloadingFilesChanged, new Object[0]);
                if (i == 0) {
                    NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.showBulletin, 1, LocaleController.formatString("MessageNotFound", C2797R.string.MessageNotFound, new Object[0]));
                    return;
                } else {
                    if (i == -1) {
    ...
    public /* synthetic */ void lambda$onDownloadFail$9(MessageObject messageObject) {
        try {
            ...
            sQLitePreparedStatementExecuteFast.bindLong(2, messageObject.getDocument().f1253id);
            sQLitePreparedStatementExecuteFast.step();
            sQLitePreparedStatementExecuteFast.dispose();
        } catch (Exception e) {
            FileLog.m1048e(e);
    ...
    /* JADX INFO: loaded from: classes5.dex */
    public static class DownloadingDocumentEntry {
        int hash;

        /* JADX INFO: renamed from: id */
        long f1138id;

        public /* synthetic */ DownloadingDocumentEntry(DownloadControllerIA downloadControllerIA) {
            this();
        }
    ...
    public /* synthetic */ void lambda$deleteRecentFiles$14(ArrayList arrayList) {
        try {
            ...
            for (int i = 0; i < arrayList.size(); i++) {
                ...
                sQLitePreparedStatementExecuteFast.bindLong(2, ((MessageObject) arrayList.get(i)).getDocument().f1253id);
                sQLitePreparedStatementExecuteFast.step();
                try {
    ...
    public boolean isDownloading(int i) {
        for (int i2 = 0; i2 < this.downloadingFiles.size(); i2++) {
            if (this.downloadingFiles.get(i2).messageOwner.f1271id == i) {
                return true;
            }
        }
        return false;
