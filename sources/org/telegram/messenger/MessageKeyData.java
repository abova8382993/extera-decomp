...
public class MessageKeyData {
    ...
    public static MessageKeyData generateMessageKeyData(byte[] bArr, byte[] bArr2, boolean z, int i) {
        ...
        if (i != 1) {
            ...
            byte[] bArrComputeSHA2562 = Utilities.computeSHA256(serializedData2.toByteArray());
            serializedData2.cleanup();
            SerializedData serializedData3 = new SerializedData();
            serializedData3.writeBytes(bArrComputeSHA256, 0, 8);
            serializedData3.writeBytes(bArrComputeSHA2562, 8, 16);
            ...
            serializedData4.writeBytes(bArrComputeSHA2562, 0, 8);
            serializedData4.writeBytes(bArrComputeSHA256, 8, 16);
            serializedData4.writeBytes(bArrComputeSHA2562, 24, 8);
        ...
        serializedData10.writeBytes(bArrComputeSHA12, 0, 8);
        serializedData10.writeBytes(bArrComputeSHA13, 16, 4);
        serializedData10.writeBytes(bArrComputeSHA14, 0, 8);
