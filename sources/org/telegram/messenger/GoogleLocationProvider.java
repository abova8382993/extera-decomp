    ...
    public void getLastLocation(final Consumer<Location> consumer) {
        this.locationProviderClient.getLastLocation().addOnCompleteListener(new OnCompleteListener() { // from class: org.telegram.messenger.GoogleLocationProvider$$ExternalSyntheticLambda1
            ...
            public final void onComplete(Task task) {
                GoogleLocationProvider.m5493$r8$lambda$pgimAzDDNnR94RGDhgpM2y3jLE(consumer, task);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$pg-imAzDDNnR94RGDhgpM2y3jLE, reason: not valid java name */
    public static /* synthetic */ void m5493$r8$lambda$pgimAzDDNnR94RGDhgpM2y3jLE(Consumer consumer, Task task) {
