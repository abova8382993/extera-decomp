...
final class PredefinedCommands {
    static {
        ...
        MacroInfo.Commands.put(RegisterSpec.PREFIX, new PredefMacroInfo(54, 1));
        ...
        MacroInfo.Commands.put("jlmTextbf", new PredefMacroInfo(Opcodes.REM_FLOAT_2ADDR, 1));
        MacroInfo.Commands.put("jlmTextitbf", new PredefMacroInfo(203, 1));
        MacroInfo.Commands.put("DeclareMathSizes", new PredefMacroInfo(Opcodes.SUB_DOUBLE_2ADDR, 4));
        MacroInfo.Commands.put("magnification", new PredefMacroInfo(Opcodes.MUL_DOUBLE_2ADDR, 1));
        MacroInfo.Commands.put("hline", new PredefMacroInfo(Opcodes.DIV_DOUBLE_2ADDR, 0));
        MacroInfo.Commands.put("tiny", new PredefMacroInfo(Opcodes.REM_DOUBLE_2ADDR, 0));
        MacroInfo.Commands.put("scriptsize", new PredefMacroInfo(Opcodes.ADD_INT_LIT16, 0));
        MacroInfo.Commands.put("footnotesize", new PredefMacroInfo(Opcodes.RSUB_INT, 0));
        MacroInfo.Commands.put("small", new PredefMacroInfo(Opcodes.MUL_INT_LIT16, 0));
        MacroInfo.Commands.put("normalsize", new PredefMacroInfo(Opcodes.DIV_INT_LIT16, 0));
        MacroInfo.Commands.put("large", new PredefMacroInfo(Opcodes.REM_INT_LIT16, 0));
        MacroInfo.Commands.put("Large", new PredefMacroInfo(Opcodes.AND_INT_LIT16, 0));
        MacroInfo.Commands.put("LARGE", new PredefMacroInfo(Opcodes.OR_INT_LIT16, 0));
        MacroInfo.Commands.put("huge", new PredefMacroInfo(Opcodes.XOR_INT_LIT16, 0));
        MacroInfo.Commands.put("Huge", new PredefMacroInfo(Opcodes.ADD_INT_LIT8, 0));
        MacroInfo.Commands.put("jlatexmathcumsup", new PredefMacroInfo(Opcodes.RSUB_INT_LIT8, 1));
        MacroInfo.Commands.put("jlatexmathcumsub", new PredefMacroInfo(Opcodes.MUL_INT_LIT8, 1));
        MacroInfo.Commands.put("hstrok", new PredefMacroInfo(Opcodes.DIV_INT_LIT8, 0));
        MacroInfo.Commands.put("Hstrok", new PredefMacroInfo(Opcodes.REM_INT_LIT8, 0));
        MacroInfo.Commands.put("dstrok", new PredefMacroInfo(Opcodes.AND_INT_LIT8, 0));
        MacroInfo.Commands.put("Dstrok", new PredefMacroInfo(Opcodes.OR_INT_LIT8, 0));
        MacroInfo.Commands.put("dotminus", new PredefMacroInfo(Opcodes.XOR_INT_LIT8, 0));
        MacroInfo.Commands.put("ratio", new PredefMacroInfo(Opcodes.SHL_INT_LIT8, 0));
        MacroInfo.Commands.put("smallfrowneq", new PredefMacroInfo(Opcodes.SHR_INT_LIT8, 0));
        MacroInfo.Commands.put("geoprop", new PredefMacroInfo(Opcodes.USHR_INT_LIT8, 0));
        ...
        MacroInfo.Commands.put(",", new PredefMacroInfo(Opcodes.INVOKE_POLYMORPHIC_RANGE, 0));
        MacroInfo.Commands.put(":", new PredefMacroInfo(Opcodes.INVOKE_CUSTOM, 0));
        MacroInfo.Commands.put(";", new PredefMacroInfo(Opcodes.INVOKE_CUSTOM_RANGE, 0));
        MacroInfo.Commands.put("thinspace", new PredefMacroInfo(Opcodes.CONST_METHOD_HANDLE, 0));
