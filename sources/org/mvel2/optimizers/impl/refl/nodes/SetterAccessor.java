...
public class SetterAccessor implements AccessorNode {
    ...
    public Object setValue(Object obj, Object obj2, VariableResolverFactory variableResolverFactory, Object obj3) {
        ...
        try {
            if (z) {
                return method.invoke(obj, DataConversion.convert(obj3, this.targetType));
            }
            return method.invoke(obj, (obj3 == null && this.primitive) ? PropertyTools.getPrimitiveInitialValue(this.targetType) : obj3);
