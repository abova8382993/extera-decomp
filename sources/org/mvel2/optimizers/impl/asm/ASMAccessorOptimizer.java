...
public class ASMAccessorOptimizer extends AbstractOptimizer implements AccessorOptimizer {
    ...
    private ASMAccessorOptimizer(ClassWriter classWriter, MethodVisitor methodVisitor, ArrayList<ExecutableStatement> arrayList, String str, StringAppender stringAppender, int i) {
        ...
        this.stacksize = 1;
        this.maxlocals = 1;
        this.f1569cw = classWriter;
        this.f1570mv = methodVisitor;
    ...
    private void _initJIT() {
        ...
        this.f1569cw = new ClassWriter(3);
        synchronized (Runtime.getRuntime()) {
            ClassWriter classWriter = this.f1569cw;
            int i = OPCODES_VERSION;
            String str = "ASMAccessorImpl_" + String.valueOf(this.f1569cw.hashCode()).replaceAll("\\-", "_") + (System.currentTimeMillis() / 10) + ((int) (Math.random() * 100.0d));
            this.className = str;
            classWriter.visit(i, 33, str, null, "java/lang/Object", new String[]{NAMESPACE + "compiler/Accessor"});
        }
        MethodVisitor methodVisitorVisitMethod = this.f1569cw.visitMethod(1, "<init>", "()V", null, null);
        ...
        MethodVisitor methodVisitorVisitMethod2 = this.f1569cw.visitMethod(1, "getValue", "(Ljava/lang/Object;Ljava/lang/Object;L" + NAMESPACE + "integration/VariableResolverFactory;)Ljava/lang/Object;", null, null);
        this.f1570mv = methodVisitorVisitMethod2;
    ...
    private void _initJIT2() {
        ...
        methodVisitorVisitMethod.visitMaxs(1, 1);
        methodVisitorVisitMethod.visitEnd();
        MethodVisitor methodVisitorVisitMethod2 = this.f1569cw.visitMethod(1, "setValue", "(Ljava/lang/Object;Ljava/lang/Object;L" + NAMESPACE + "integration/VariableResolverFactory;Ljava/lang/Object;)Ljava/lang/Object;", null, null);
        this.f1570mv = methodVisitorVisitMethod2;
        methodVisitorVisitMethod2.visitCode();
    }
    ...
    public Accessor optimizeSetAccessor(ParserContext parserContext, char[] cArr, int i, int i2, Object obj, Object obj2, VariableResolverFactory variableResolverFactory, boolean z, Object obj3, Class cls) {
        ...
        if (cArrSubset != null) {
            ...
            this.f1570mv.visitVarInsn(25, 1);
        }
        try {
            skipWhitespace();
            if (this.collection) {
                ...
                this.f1570mv.visitTypeInsn(192, Type.getInternalName(obj4.getClass()));
                if (obj4 instanceof Map) {
                    if (MVEL.COMPILER_OPT_ALLOW_OVERRIDE_ALL_PROPHANDLING && PropertyHandlerFactory.hasPropertyHandler(Map.class)) {
                        ...
                        this.f1570mv.visitVarInsn(25, 4);
                        ...
                        this.f1570mv.visitMethodInsn(185, "java/util/Map", "put", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;");
                        this.f1570mv.visitInsn(87);
                        this.f1570mv.visitVarInsn(25, 4);
                    }
                } else {
                    ...
                    if (z2) {
                        if (MVEL.COMPILER_OPT_ALLOW_OVERRIDE_ALL_PROPHANDLING && PropertyHandlerFactory.hasPropertyHandler(List.class)) {
                            ...
                            this.f1570mv.visitMethodInsn(185, "java/util/List", "set", "(ILjava/lang/Object;)Ljava/lang/Object;");
                            this.f1570mv.visitVarInsn(25, 4);
                        }
            ...
            if (GlobalListenerFactory.hasSetListeners()) {
                this.f1570mv.visitVarInsn(25, 1);
                this.f1570mv.visitLdcInsn(str);
                this.f1570mv.visitVarInsn(25, 3);
                this.f1570mv.visitVarInsn(25, 4);
                this.f1570mv.visitMethodInsn(184, NAMESPACE + "integration/GlobalListenerFactory", "notifySetListeners", "(Ljava/lang/Object;Ljava/lang/String;L" + NAMESPACE + "integration/VariableResolverFactory;Ljava/lang/Object;)V");
            ...
            if (fieldOrWriteAccessor instanceof Field) {
                ...
                if (field.getType().isPrimitive()) {
                    this.f1570mv.visitVarInsn(58, 5);
                    this.f1570mv.visitVarInsn(25, 4);
                    if (primitiveInitialValue == null) {
                        primitiveInitialValue = PropertyTools.getPrimitiveInitialValue(field.getType());
                    }
                    label = new Label();
                    this.f1570mv.visitJumpInsn(199, label);
                    this.f1570mv.visitVarInsn(25, 5);
                    this.f1570mv.visitInsn(3);
                    this.f1570mv.visitFieldInsn(181, Type.getInternalName(field.getDeclaringClass()), str, Type.getDescriptor(field.getType()));
                    this.f1570mv.visitJumpInsn(167, label2);
                    this.f1570mv.visitLabel(label);
                    this.f1570mv.visitVarInsn(25, 5);
                    this.f1570mv.visitVarInsn(25, 4);
                ...
                this.f1570mv.visitFieldInsn(181, Type.getInternalName(field.getDeclaringClass()), str, Type.getDescriptor(field.getType()));
                this.f1570mv.visitLabel(label2);
                this.f1570mv.visitVarInsn(25, 4);
                ...
                if (primitiveInitialValue != null && !cls3.isAssignableFrom(primitiveInitialValue.getClass())) {
                    ...
                    if (cls3.isPrimitive()) {
                        ...
                        this.f1570mv.visitJumpInsn(199, label4);
                        this.f1570mv.visitInsn(3);
                        this.f1570mv.visitMethodInsn(182, Type.getInternalName(method.getDeclaringClass()), method.getName(), Type.getMethodDescriptor(method));
                        this.f1570mv.visitJumpInsn(167, label3);
                        this.f1570mv.visitLabel(label4);
                        this.f1570mv.visitVarInsn(25, 4);
                        unwrapPrimitive(cls3);
                    } else {
                        checkcast(cls3);
                ...
                this.f1570mv.visitMethodInsn(182, Type.getInternalName(method.getDeclaringClass()), method.getName(), Type.getMethodDescriptor(method));
                this.f1570mv.visitLabel(label3);
                this.f1570mv.visitVarInsn(25, 4);
    ...
    private void _finishJIT() {
        ...
        if (this.returnType == Void.TYPE) {
            this.f1570mv.visitInsn(1);
        }
        this.f1570mv.visitInsn(176);
        dumpAdvancedDebugging();
        this.f1570mv.visitMaxs(this.stacksize, this.maxlocals);
        this.f1570mv.visitEnd();
        MethodVisitor methodVisitorVisitMethod = this.f1569cw.visitMethod(1, "getKnownEgressType", "()Ljava/lang/Class;", null, null);
        this.f1570mv = methodVisitorVisitMethod;
        methodVisitorVisitMethod.visitCode();
        visitConstantClass(this.returnType);
        this.f1570mv.visitInsn(176);
        this.f1570mv.visitMaxs(1, 1);
        this.f1570mv.visitEnd();
        if (this.propNull) {
            this.f1569cw.visitField(1, "nullPropertyHandler", "L" + NAMESPACE + "integration/PropertyHandler;", null, null).visitEnd();
        }
        if (this.methNull) {
            this.f1569cw.visitField(1, "nullMethodHandler", "L" + NAMESPACE + "integration/PropertyHandler;", null, null).visitEnd();
        }
        buildInputs();
        StringAppender stringAppender = this.buildLog;
        if (stringAppender != null && stringAppender.length() != 0 && this.expr != null) {
            MethodVisitor methodVisitorVisitMethod2 = this.f1569cw.visitMethod(1, "toString", "()Ljava/lang/String;", null, null);
            this.f1570mv = methodVisitorVisitMethod2;
            methodVisitorVisitMethod2.visitCode();
            this.f1570mv.visitLabel(new Label());
            this.f1570mv.visitLdcInsn(this.buildLog.toString() + "\n\n## { " + new String(this.expr) + " }");
            this.f1570mv.visitInsn(176);
            this.f1570mv.visitLabel(new Label());
            this.f1570mv.visitMaxs(1, 1);
            this.f1570mv.visitEnd();
        }
        this.f1569cw.visitEnd();
    }
    ...
    private void visitConstantClass(Class<?> cls) {
        ...
        if (cls.isPrimitive()) {
            this.f1570mv.visitFieldInsn(178, ReflectionUtil.toNonPrimitiveType(cls).getName().replace(".", "/"), "TYPE", "Ljava/lang/Class;");
        } else {
            this.f1570mv.visitLdcInsn(Type.getType(cls));
        }
    }
    ...
    private Accessor _initializeAccessor() throws IllegalAccessException, NoSuchMethodException, InstantiationException, InvocationTargetException {
        ...
        Class clsLoadClass = loadClass(this.className, this.f1569cw.toByteArray());
        try {
    ...
    private Accessor compileAccessor() {
        ...
        try {
            if (MVEL.COMPILER_OPT_ALLOW_OVERRIDE_ALL_PROPHANDLING) {
                ...
                while (true) {
                    ...
                    if (this.nullSafe && this.cursor < this.end) {
                        this.f1570mv.visitInsn(89);
                        Label label2 = new Label();
                        this.f1570mv.visitJumpInsn(199, label2);
                        this.f1570mv.visitInsn(176);
                        this.f1570mv.visitLabel(label2);
                    }
                }
            ...
            throw new PropertyAccessException(new String(this.expr), this.expr, this.f1568st, e, this.pCtx);
        } catch (IndexOutOfBoundsException e2) {
            throw new PropertyAccessException(new String(this.expr), this.expr, this.f1568st, e2, this.pCtx);
        } catch (NullPointerException e3) {
            throw new PropertyAccessException(new String(this.expr), this.expr, this.f1568st, e3, this.pCtx);
        } catch (InvocationTargetException e4) {
            throw new PropertyAccessException(new String(this.expr), this.expr, this.f1568st, e4, this.pCtx);
        } catch (PropertyAccessException e5) {
            throw new CompileException(e5.getMessage(), this.expr, this.f1568st, e5);
        } catch (CompileException e6) {
            throw e6;
        } catch (OptimizationNotSupported e7) {
            throw e7;
        } catch (Exception e8) {
            throw new CompileException(e8.getMessage(), this.expr, this.f1568st, e8);
        }
    }
    ...
    private Object getWithProperty(Object obj) {
        ...
        for (WithNode.ParmValuePair parmValuePair : WithNode.compileWithExpressions(cArr, i2, i3 - i2, strTrim, this.ingressType, this.pCtx)) {
            this.f1570mv.visitInsn(89);
            this.f1570mv.visitVarInsn(58, this.compileDepth + 5);
            ...
            if (parmValuePair.getSetExpression() == null) {
                ...
                this.f1570mv.visitVarInsn(25, 0);
                this.f1570mv.visitFieldInsn(180, this.className, "p" + (this.compiledInputs.size() - 1), "L" + NAMESPACE + "compiler/ExecutableStatement;");
                this.f1570mv.visitVarInsn(25, this.compileDepth + 5);
                this.f1570mv.visitVarInsn(25, 2);
                this.f1570mv.visitVarInsn(25, 3);
                addSubstatement(parmValuePair.getStatement());
                this.f1570mv.visitMethodInsn(185, NAMESPACE + "compiler/ExecutableStatement", "setValue", "(Ljava/lang/Object;Ljava/lang/Object;L" + NAMESPACE + "integration/VariableResolverFactory;Ljava/lang/Object;)Ljava/lang/Object;");
                this.f1570mv.visitInsn(87);
            }
        }
        return obj;
    ...
    private Object getBeanProperty(Object obj, String str) throws IllegalAccessException, InvocationTargetException {
        ...
        if (PropertyHandlerFactory.hasPropertyHandler(cls)) {
            ...
            if (propertyHandler instanceof ProducesBytecode) {
                ((ProducesBytecode) propertyHandler).produceBytecodeGet(this.f1570mv, str, this.variableFactory);
        ...
        if (fieldOrAccessor != null && GlobalListenerFactory.hasGetListeners()) {
            this.f1570mv.visitVarInsn(25, 1);
            this.f1570mv.visitLdcInsn(fieldOrAccessor.getName());
            this.f1570mv.visitVarInsn(25, 3);
            this.f1570mv.visitMethodInsn(184, NAMESPACE + "integration/GlobalListenerFactory", "notifyGetListeners", "(Ljava/lang/Object;Ljava/lang/String;L" + NAMESPACE + "integration/VariableResolverFactory;)V");
        ...
        if (fieldOrAccessor != null) {
            ...
            try {
                ...
                if (this.returnType != fieldOrAccessor.getDeclaringClass()) {
                    this.f1570mv.visitTypeInsn(192, Type.getInternalName(fieldOrAccessor.getDeclaringClass()));
                }
                this.returnType = ((Method) fieldOrAccessor).getReturnType();
                if (fieldOrAccessor.getDeclaringClass().isInterface()) {
                    this.f1570mv.visitMethodInsn(185, Type.getInternalName(fieldOrAccessor.getDeclaringClass()), fieldOrAccessor.getName(), Type.getMethodDescriptor((Method) fieldOrAccessor));
                } else {
                    this.f1570mv.visitMethodInsn(182, Type.getInternalName(fieldOrAccessor.getDeclaringClass()), fieldOrAccessor.getName(), Type.getMethodDescriptor((Method) fieldOrAccessor));
                }
                ...
                if (methodDetermineActualTargetMethod == null) {
                    throw new PropertyAccessException("could not access field: " + cls.getName() + "." + str, this.expr, this.f1568st, e2, this.pCtx);
                }
                this.f1570mv.visitTypeInsn(192, Type.getInternalName(methodDetermineActualTargetMethod.getDeclaringClass()));
                this.returnType = methodDetermineActualTargetMethod.getReturnType();
                this.f1570mv.visitMethodInsn(185, Type.getInternalName(methodDetermineActualTargetMethod.getDeclaringClass()), fieldOrAccessor.getName(), Type.getMethodDescriptor(method));
        ...
        if (obj instanceof Map) {
            ...
            if (map.containsKey(str) || this.nullSafe) {
                this.f1570mv.visitTypeInsn(192, "java/util/Map");
                this.f1570mv.visitLdcInsn(str);
                this.f1570mv.visitMethodInsn(185, "java/util/Map", "get", "(Ljava/lang/Object;)Ljava/lang/Object;");
                return map.get(str);
            }
        }
            ...
            for (Method method3 : cls3.getMethods()) {
                if (str.equals(method3.getName())) {
                    ...
                    if (parserContext2 == null || parserContext2.getParserConfiguration() == null ? MVEL.COMPILER_OPT_ALLOW_NAKED_METH_CALL : this.pCtx.getParserConfiguration().isAllowNakedMethCall()) {
                        this.f1570mv.visitInsn(87);
                        this.f1570mv.visitMethodInsn(184, Type.getInternalName(method3.getDeclaringClass()), method3.getName(), Type.getMethodDescriptor(method3));
        ...
        if (obj == null) {
            throw new PropertyAccessException("unresolvable property or identifier: " + str, this.expr, this.f1568st, this.pCtx);
        }
        throw new PropertyAccessException("could not access: " + str + "; in class: " + obj.getClass().getName(), this.expr, this.f1568st, this.pCtx);
    }
    ...
    private Object optimizeFieldMethodProperty(Object obj, String str, Class<?> cls, Member member) throws IllegalAccessException {
        ...
        if ((member.getModifiers() & 8) != 0) {
            if ((member.getModifiers() & 16) != 0 && ((property instanceof String) || ((Field) member).getType().isPrimitive())) {
                ...
                this.f1570mv.visitLdcInsn(obj2);
            ...
            MethodVisitor methodVisitor = this.f1570mv;
            ...
            this.f1570mv.visitTypeInsn(192, Type.getInternalName(cls));
            MethodVisitor methodVisitor2 = this.f1570mv;
    ...
    private void writeFunctionPointerStub(Class cls, Method method) {
        ...
        this.f1570mv.visitMethodInsn(182, "java/lang/Class", "getMethods", "()[Ljava/lang/reflect/Method;");
        this.f1570mv.visitVarInsn(58, 7);
        this.f1570mv.visitInsn(3);
        this.f1570mv.visitVarInsn(54, 5);
        this.f1570mv.visitVarInsn(25, 7);
        this.f1570mv.visitInsn(190);
        this.f1570mv.visitVarInsn(54, 6);
        Label label = new Label();
        this.f1570mv.visitJumpInsn(167, label);
        Label label2 = new Label();
        this.f1570mv.visitLabel(label2);
        this.f1570mv.visitVarInsn(25, 7);
        this.f1570mv.visitVarInsn(21, 5);
        this.f1570mv.visitInsn(50);
        this.f1570mv.visitVarInsn(58, 4);
        this.f1570mv.visitLabel(new Label());
        this.f1570mv.visitLdcInsn(method.getName());
        this.f1570mv.visitVarInsn(25, 4);
        this.f1570mv.visitMethodInsn(182, "java/lang/reflect/Method", "getName", "()Ljava/lang/String;");
        this.f1570mv.visitMethodInsn(182, "java/lang/String", "equals", "(Ljava/lang/Object;)Z");
        Label label3 = new Label();
        this.f1570mv.visitJumpInsn(153, label3);
        this.f1570mv.visitLabel(new Label());
        this.f1570mv.visitVarInsn(25, 4);
        this.f1570mv.visitInsn(176);
        this.f1570mv.visitLabel(label3);
        this.f1570mv.visitIincInsn(5, 1);
        this.f1570mv.visitLabel(label);
        this.f1570mv.visitVarInsn(21, 5);
        this.f1570mv.visitVarInsn(21, 6);
        this.f1570mv.visitJumpInsn(161, label2);
        this.f1570mv.visitLabel(new Label());
        this.f1570mv.visitInsn(1);
        this.f1570mv.visitInsn(176);
    }
    ...
    private Object getCollectionProperty(Object obj, String str) throws IllegalAccessException, InvocationTargetException {
        ...
        skipWhitespace();
        if (this.cursor == this.end) {
            throw new CompileException("unterminated '['", this.expr, this.f1568st);
        }
        if (scanTo(']')) {
            throw new CompileException("unterminated '['", this.expr, this.f1568st);
        }
        ...
        if (z) {
            this.f1570mv.visitTypeInsn(192, "java/util/List");
            writeLiteralOrSubexpression(executableStatement, cls);
            this.f1570mv.visitMethodInsn(185, "java/util/List", "get", "(I)Ljava/lang/Object;");
        ...
        if (zIsArray) {
            this.f1570mv.visitTypeInsn(192, Type.getDescriptor(obj.getClass()));
        ...
        if (obj instanceof CharSequence) {
            this.f1570mv.visitTypeInsn(192, "java/lang/CharSequence");
            if (value instanceof Integer) {
                Integer num = (Integer) value;
                intPush(num.intValue());
                this.f1570mv.visitMethodInsn(185, "java/lang/CharSequence", "charAt", "(I)C");
                wrapPrimitive(cls2);
        ...
        throw new CompileException("illegal use of []: unknown type: " + obj.getClass().getName(), this.expr, this.f1568st);
    }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:361:0x002b  */
    /*
    ...
    */
    ...
    private void dataConversion(Class cls) {
        ...
        ldcClassConstant(cls);
        this.f1570mv.visitMethodInsn(184, NAMESPACE + "DataConversion", "convert", "(Ljava/lang/Object;Ljava/lang/Class;)Ljava/lang/Object;");
    }
    ...
    private void unwrapPrimitive(Class cls) {
        if (cls == Boolean.TYPE) {
            this.f1570mv.visitTypeInsn(192, "java/lang/Boolean");
            this.f1570mv.visitMethodInsn(182, "java/lang/Boolean", "booleanValue", "()Z");
            return;
        }
        if (cls == Integer.TYPE) {
            this.f1570mv.visitTypeInsn(192, "java/lang/Integer");
            this.f1570mv.visitMethodInsn(182, "java/lang/Integer", "intValue", "()I");
            return;
        }
        if (cls == Float.TYPE) {
            this.f1570mv.visitTypeInsn(192, "java/lang/Float");
            this.f1570mv.visitMethodInsn(182, "java/lang/Float", "floatValue", "()F");
            return;
        }
        if (cls == Double.TYPE) {
            this.f1570mv.visitTypeInsn(192, "java/lang/Double");
            this.f1570mv.visitMethodInsn(182, "java/lang/Double", "doubleValue", "()D");
            return;
        }
        if (cls == Short.TYPE) {
            this.f1570mv.visitTypeInsn(192, "java/lang/Short");
            this.f1570mv.visitMethodInsn(182, "java/lang/Short", "shortValue", "()S");
            return;
        }
        if (cls == Long.TYPE) {
            this.f1570mv.visitTypeInsn(192, "java/lang/Long");
            this.f1570mv.visitMethodInsn(182, "java/lang/Long", "longValue", "()J");
        } else if (cls == Byte.TYPE) {
            this.f1570mv.visitTypeInsn(192, "java/lang/Byte");
            this.f1570mv.visitMethodInsn(182, "java/lang/Byte", "byteValue", "()B");
        } else if (cls == Character.TYPE) {
            this.f1570mv.visitTypeInsn(192, "java/lang/Character");
            this.f1570mv.visitMethodInsn(182, "java/lang/Character", "charValue", "()C");
        }
    }
    ...
    private void wrapPrimitive(Class<? extends Object> cls) {
        ...
        if (i != 48) {
            if (cls == cls4 || cls == Boolean.class) {
                ...
                this.f1570mv.visitMethodInsn(184, "java/lang/Boolean", "valueOf", "(Z)Ljava/lang/Boolean;");
                return;
            }
            if (cls == cls3 || cls == Integer.class) {
                debug("INVOKESTATIC java/lang/Integer.valueOf");
                this.f1570mv.visitMethodInsn(184, "java/lang/Integer", "valueOf", "(I)Ljava/lang/Integer;");
                return;
            }
            if (cls == cls2 || cls == Float.class) {
                debug("INVOKESTATIC java/lang/Float.valueOf");
                this.f1570mv.visitMethodInsn(184, "java/lang/Float", "valueOf", "(F)Ljava/lang/Float;");
                return;
            }
            if (cls == Double.TYPE || cls == Double.class) {
                debug("INVOKESTATIC java/lang/Double.valueOf");
                this.f1570mv.visitMethodInsn(184, "java/lang/Double", "valueOf", "(D)Ljava/lang/Double;");
                return;
            }
            if (cls == Short.TYPE || cls == Short.class) {
                debug("INVOKESTATIC java/lang/Short.valueOf");
                this.f1570mv.visitMethodInsn(184, "java/lang/Short", "valueOf", "(S)Ljava/lang/Short;");
                return;
            }
            if (cls == Long.TYPE || cls == Long.class) {
                debug("INVOKESTATIC java/lang/Long.valueOf");
                this.f1570mv.visitMethodInsn(184, "java/lang/Long", "valueOf", "(J)Ljava/lang/Long;");
                return;
            } else if (cls == Byte.TYPE || cls == Byte.class) {
                debug("INVOKESTATIC java/lang/Byte.valueOf");
                this.f1570mv.visitMethodInsn(184, "java/lang/Byte", "valueOf", "(B)Ljava/lang/Byte;");
                return;
            } else {
                if (cls == Character.TYPE || cls == Character.class) {
                    debug("INVOKESTATIC java/lang/Character.valueOf");
                    this.f1570mv.visitMethodInsn(184, "java/lang/Character", "valueOf", "(C)Ljava/lang/Character;");
                    return;
                }
                return;
            }
        ...
        if (cls == cls4 || cls == Boolean.class) {
            ...
            this.f1570mv.visitTypeInsn(187, "java/lang/Boolean");
            debug("DUP X1");
            this.f1570mv.visitInsn(90);
            debug("SWAP");
            this.f1570mv.visitInsn(95);
            debug("INVOKESPECIAL java/lang/Boolean.<init>::(Z)V");
            this.f1570mv.visitMethodInsn(183, "java/lang/Boolean", "<init>", "(Z)V");
            return;
        }
        if (cls == cls3 || cls == Integer.class) {
            debug("NEW java/lang/Integer");
            this.f1570mv.visitTypeInsn(187, "java/lang/Integer");
            debug("DUP X1");
            this.f1570mv.visitInsn(90);
            debug("SWAP");
            this.f1570mv.visitInsn(95);
            debug("INVOKESPECIAL java/lang/Integer.<init>::(I)V");
            this.f1570mv.visitMethodInsn(183, "java/lang/Integer", "<init>", "(I)V");
            return;
        }
        if (cls == cls2 || cls == Float.class) {
            debug("NEW java/lang/Float");
            this.f1570mv.visitTypeInsn(187, "java/lang/Float");
            debug("DUP X1");
            this.f1570mv.visitInsn(90);
            debug("SWAP");
            this.f1570mv.visitInsn(95);
            debug("INVOKESPECIAL java/lang/Float.<init>::(F)V");
            this.f1570mv.visitMethodInsn(183, "java/lang/Float", "<init>", "(F)V");
            return;
        }
        if (cls == Double.TYPE || cls == Double.class) {
            debug("NEW java/lang/Double");
            this.f1570mv.visitTypeInsn(187, "java/lang/Double");
            debug("DUP X2");
            this.f1570mv.visitInsn(91);
            debug("DUP X2");
            this.f1570mv.visitInsn(91);
            debug("POP");
            this.f1570mv.visitInsn(87);
            debug("INVOKESPECIAL java/lang/Double.<init>::(D)V");
            this.f1570mv.visitMethodInsn(183, "java/lang/Double", "<init>", "(D)V");
            return;
        }
        if (cls == Short.TYPE || cls == Short.class) {
            debug("NEW java/lang/Short");
            this.f1570mv.visitTypeInsn(187, "java/lang/Short");
            debug("DUP X1");
            this.f1570mv.visitInsn(90);
            debug("SWAP");
            this.f1570mv.visitInsn(95);
            debug("INVOKESPECIAL java/lang/Short.<init>::(S)V");
            this.f1570mv.visitMethodInsn(183, "java/lang/Short", "<init>", "(S)V");
            return;
        }
        if (cls == Long.TYPE || cls == Long.class) {
            debug("NEW java/lang/Long");
            this.f1570mv.visitTypeInsn(187, "java/lang/Long");
            debug("DUP X1");
            this.f1570mv.visitInsn(90);
            debug("SWAP");
            this.f1570mv.visitInsn(95);
            debug("INVOKESPECIAL java/lang/Long.<init>::(L)V");
            this.f1570mv.visitMethodInsn(183, "java/lang/Float", "<init>", "(L)V");
            return;
        }
        if (cls == Byte.TYPE || cls == Byte.class) {
            debug("NEW java/lang/Byte");
            this.f1570mv.visitTypeInsn(187, "java/lang/Byte");
            debug("DUP X1");
            this.f1570mv.visitInsn(90);
            debug("SWAP");
            this.f1570mv.visitInsn(95);
            debug("INVOKESPECIAL java/lang/Byte.<init>::(B)V");
            this.f1570mv.visitMethodInsn(183, "java/lang/Byte", "<init>", "(B)V");
            return;
        }
        if (cls == Character.TYPE || cls == Character.class) {
            debug("NEW java/lang/Character");
            this.f1570mv.visitTypeInsn(187, "java/lang/Character");
            debug("DUP X1");
            this.f1570mv.visitInsn(90);
            debug("SWAP");
            this.f1570mv.visitInsn(95);
            debug("INVOKESPECIAL java/lang/Character.<init>::(C)V");
            this.f1570mv.visitMethodInsn(183, "java/lang/Character", "<init>", "(C)V");
        }
    }

    private void anyArrayCheck(Class cls) {
        if (cls == boolean[].class) {
            this.f1570mv.visitTypeInsn(192, "[Z");
            return;
        }
        if (cls == int[].class) {
            this.f1570mv.visitTypeInsn(192, "[I");
            return;
        }
        if (cls == float[].class) {
            this.f1570mv.visitTypeInsn(192, "[F");
            return;
        }
        if (cls == double[].class) {
            this.f1570mv.visitTypeInsn(192, "[D");
            return;
        }
        if (cls == short[].class) {
            this.f1570mv.visitTypeInsn(192, "[S");
            return;
        }
        if (cls == long[].class) {
            this.f1570mv.visitTypeInsn(192, "[J");
            return;
        }
        if (cls == byte[].class) {
            this.f1570mv.visitTypeInsn(192, "[B");
        } else if (cls == char[].class) {
            this.f1570mv.visitTypeInsn(192, "[C");
        } else {
            this.f1570mv.visitTypeInsn(192, "[Ljava/lang/Object;");
        }
    }
    ...
    private void createArray(Class cls, int i) {
        intPush(i);
        if (cls.isPrimitive()) {
            this.f1570mv.visitIntInsn(188, toPrimitiveTypeOperand(cls));
        } else {
            this.f1570mv.visitTypeInsn(189, Type.getInternalName(cls));
        }
    }
    ...
    public void arrayStore(Class cls) {
        if (cls.isPrimitive()) {
            if (cls == Integer.TYPE) {
                this.f1570mv.visitInsn(79);
                return;
            }
            if (cls == Character.TYPE) {
                this.f1570mv.visitInsn(85);
                return;
            }
            if (cls == Boolean.TYPE) {
                this.f1570mv.visitInsn(84);
                return;
            }
            if (cls == Double.TYPE) {
                this.f1570mv.visitInsn(82);
                return;
            }
            if (cls == Float.TYPE) {
                this.f1570mv.visitInsn(81);
                return;
            }
            if (cls == Short.TYPE) {
                this.f1570mv.visitInsn(86);
                return;
            } else if (cls == Long.TYPE) {
                this.f1570mv.visitInsn(80);
                return;
            } else {
                if (cls == Byte.TYPE) {
                    this.f1570mv.visitInsn(84);
        ...
        this.f1570mv.visitInsn(83);
    }

    public void wrapRuntimeConverstion(Class cls) {
        ldcClassConstant(getWrapperClass(cls));
        this.f1570mv.visitMethodInsn(184, _UrlKt.FRAGMENT_ENCODE_SET + NAMESPACE + "DataConversion", "convert", "(Ljava/lang/Object;Ljava/lang/Class;)Ljava/lang/Object;");
    }
    ...
    private Object addSubstatement(ExecutableStatement executableStatement) {
        ...
        this.f1570mv.visitVarInsn(25, 2);
        this.f1570mv.visitVarInsn(25, 3);
        this.f1570mv.visitMethodInsn(185, Type.getInternalName(ExecutableStatement.class), "getValue", "(Ljava/lang/Object;L" + NAMESPACE + "integration/VariableResolverFactory;)Ljava/lang/Object;");
        return null;
    }
    ...
    private void loadVariableByName(String str) {
        this.f1570mv.visitVarInsn(25, 3);
        this.f1570mv.visitLdcInsn(str);
        this.f1570mv.visitMethodInsn(185, _UrlKt.FRAGMENT_ENCODE_SET + NAMESPACE + "integration/VariableResolverFactory", "getVariableResolver", "(Ljava/lang/String;)L" + NAMESPACE + "integration/VariableResolver;");
        this.f1570mv.visitMethodInsn(185, _UrlKt.FRAGMENT_ENCODE_SET + NAMESPACE + "integration/VariableResolver", "getValue", "()Ljava/lang/Object;");
    ...
    private void loadVariableByIndex(int i) {
        this.f1570mv.visitVarInsn(25, 3);
        intPush(i);
        this.f1570mv.visitMethodInsn(185, _UrlKt.FRAGMENT_ENCODE_SET + NAMESPACE + "integration/VariableResolverFactory", "getIndexedVariableResolver", "(I)L" + NAMESPACE + "integration/VariableResolver;");
        this.f1570mv.visitMethodInsn(185, _UrlKt.FRAGMENT_ENCODE_SET + NAMESPACE + "integration/VariableResolver", "getValue", "()Ljava/lang/Object;");
        this.returnType = Object.class;
    }
    ...
    private void loadField(int i) {
        this.f1570mv.visitVarInsn(25, 0);
        this.f1570mv.visitFieldInsn(180, this.className, "p" + i, "L" + NAMESPACE + "compiler/ExecutableStatement;");
    }

    private void ldcClassConstant(Class cls) {
        if (OPCODES_VERSION == 48) {
            this.f1570mv.visitLdcInsn(cls.getName());
            this.f1570mv.visitMethodInsn(184, "java/lang/Class", "forName", "(Ljava/lang/String;)Ljava/lang/Class;");
            Label label = new Label();
            this.f1570mv.visitJumpInsn(167, label);
            this.f1570mv.visitTypeInsn(187, "java/lang/NoClassDefFoundError");
            this.f1570mv.visitInsn(90);
            this.f1570mv.visitInsn(95);
            this.f1570mv.visitMethodInsn(182, "java/lang/Throwable", "getMessage", "()Ljava/lang/String;");
            this.f1570mv.visitMethodInsn(183, "java/lang/NoClassDefFoundError", "<init>", "(Ljava/lang/String;)V");
            this.f1570mv.visitInsn(191);
            this.f1570mv.visitLabel(label);
            return;
        }
        this.f1570mv.visitLdcInsn(Type.getType((Class<?>) cls));
    }
    ...
    private void buildInputs() {
        ...
        for (int i = 0; i < size; i++) {
            this.f1569cw.visitField(2, "p" + i, "L" + NAMESPACE + "compiler/ExecutableStatement;", null, null).visitEnd();
            stringAppender.append("L" + NAMESPACE + "compiler/ExecutableStatement;");
        }
        stringAppender.append(")V");
        MethodVisitor methodVisitorVisitMethod = this.f1569cw.visitMethod(1, "<init>", stringAppender.toString(), null, null);
        methodVisitorVisitMethod.visitCode();
        methodVisitorVisitMethod.visitVarInsn(25, 0);
        methodVisitorVisitMethod.visitMethodInsn(183, "java/lang/Object", "<init>", "()V");
        int i2 = 0;
    ...
    private int _getAccessor(Object obj, Class cls) {
        ...
        if (obj instanceof List) {
            this.f1570mv.visitTypeInsn(187, LIST_IMPL);
            this.f1570mv.visitInsn(89);
            this.f1570mv.visitInsn(89);
            List list = (List) obj;
            intPush(list.size());
            this.f1570mv.visitMethodInsn(183, LIST_IMPL, "<init>", "(I)V");
            Iterator it = list.iterator();
            while (it.hasNext()) {
                if (_getAccessor(it.next(), cls) != 3) {
                    this.f1570mv.visitInsn(87);
                }
                this.f1570mv.visitMethodInsn(185, "java/util/List", "add", "(Ljava/lang/Object;)Z");
                this.f1570mv.visitInsn(87);
                this.f1570mv.visitInsn(89);
            }
        ...
        if (obj instanceof Map) {
            this.f1570mv.visitTypeInsn(187, MAP_IMPL);
            this.f1570mv.visitInsn(89);
            this.f1570mv.visitInsn(89);
            Map map = (Map) obj;
            intPush(map.size());
            this.f1570mv.visitMethodInsn(183, MAP_IMPL, "<init>", "(I)V");
        ...
        if (obj instanceof ExecutableLiteral) {
            ...
            if (cls != null && cls != cls4) {
                if (!DataConversion.canConvert(cls4, cls)) {
                    throw new CompileException("was expecting type: " + cls.getName() + "; but found type: " + cls4.getName(), this.expr, this.f1568st);
                }
    ...
    private void addPrintOut(String str) {
        this.f1570mv.visitFieldInsn(178, "java/lang/System", "out", "Ljava/io/PrintStream;");
        this.f1570mv.visitLdcInsn(str);
        this.f1570mv.visitMethodInsn(182, "java/io/PrintStream", "println", "(Ljava/lang/String;)V");
    }
    ...
    private void intPush(int i) {
        if (i < 0 || i >= 6) {
            if (i > -127 && i < 128) {
                this.f1570mv.visitIntInsn(16, i);
                return;
            } else if (i > 32767) {
                this.f1570mv.visitLdcInsn(Integer.valueOf(i));
                return;
            } else {
                this.f1570mv.visitIntInsn(17, i);
                return;
            }
        }
        if (i == 0) {
        ...
        if (i == 1) {
            this.f1570mv.visitInsn(4);
            return;
        }
        if (i == 2) {
            this.f1570mv.visitInsn(5);
            return;
        }
        if (i == 3) {
            this.f1570mv.visitInsn(6);
        } else if (i == 4) {
            this.f1570mv.visitInsn(7);
        } else {
            if (i != 5) {
                return;
            }
            this.f1570mv.visitInsn(8);
        }
    }
    ...
    public Accessor optimizeObjectCreation(ParserContext parserContext, char[] cArr, int i, int i2, Object obj, Object obj2, VariableResolverFactory variableResolverFactory) {
        ...
        try {
            if (methodOrConstructor != null) {
                ...
                this.f1570mv.visitTypeInsn(187, Type.getInternalName(clsFindClass));
                this.f1570mv.visitInsn(89);
                ...
                if (bestConstructorCandidate == null) {
                    ...
                    throw new CompileException("unable to find constructor: " + clsFindClass.getName() + "(" + sb.toString() + ")", this.expr, this.f1568st);
                }
                ...
                while (i8 < methodOrConstructor.size()) {
                    ...
                    this.f1570mv.visitVarInsn(25, 2);
                    this.f1570mv.visitVarInsn(25, 3);
                    this.f1570mv.visitMethodInsn(185, _UrlKt.FRAGMENT_ENCODE_SET + NAMESPACE + "compiler/ExecutableStatement", "getValue", "(Ljava/lang/Object;L" + NAMESPACE + "integration/VariableResolverFactory;)Ljava/lang/Object;");
                    ...
                    if (obj3 != null && !obj3.getClass().isAssignableFrom(baseComponentType)) {
                        ...
                        if (baseComponentType.isPrimitive()) {
                            ...
                            this.f1570mv.visitTypeInsn(192, Type.getInternalName(cls2));
                        }
                    } else {
                        this.f1570mv.visitTypeInsn(192, Type.getInternalName(baseComponentType));
                    }
                    if (i7 >= 0) {
                        arrayStore(baseComponentType);
                    }
                ...
                this.f1570mv.visitMethodInsn(183, Type.getInternalName(cls3), "<init>", Type.getConstructorDescriptor(constructor2));
                _finishJIT();
                Accessor accessor_initializeAccessor = _initializeAccessor();
            ...
            this.f1570mv.visitTypeInsn(187, Type.getInternalName(clsFindClass2));
            this.f1570mv.visitInsn(89);
            this.f1570mv.visitMethodInsn(183, Type.getInternalName(clsFindClass2), "<init>", Type.getConstructorDescriptor(clsFindClass2.getConstructor(EMPTYCLS)));
            _finishJIT();
            ...
            throw new CompileException("class or class reference not found: " + new String(cArr), cArr, this.f1568st);
        } catch (Exception e) {
    ...
    private void propHandlerByteCodePut(String str, Object obj, Class cls, Object obj2) {
        PropertyHandler propertyHandler = PropertyHandlerFactory.getPropertyHandler(cls);
        if (propertyHandler instanceof ProducesBytecode) {
            ((ProducesBytecode) propertyHandler).produceBytecodePut(this.f1570mv, str, this.variableFactory);
    ...
    private void writeOutNullHandler(Member member, int i) {
        ...
        if (i == 0) {
            this.propNull = true;
            this.f1570mv.visitFieldInsn(180, this.className, "nullPropertyHandler", "L" + NAMESPACE + "integration/PropertyHandler;");
        } else {
            this.methNull = true;
            this.f1570mv.visitFieldInsn(180, this.className, "nullMethodHandler", "L" + NAMESPACE + "integration/PropertyHandler;");
        }
        this.f1570mv.visitLdcInsn(member.getName());
        this.f1570mv.visitVarInsn(25, 1);
        this.f1570mv.visitVarInsn(25, 3);
        this.f1570mv.visitMethodInsn(185, NAMESPACE + "integration/PropertyHandler", "getProperty", "(Ljava/lang/String;Ljava/lang/Object;L" + NAMESPACE + "integration/VariableResolverFactory;)Ljava/lang/Object;");
        this.f1570mv.visitLabel(label);
    }
