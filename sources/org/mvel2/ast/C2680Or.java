...
public class C2680Or extends BooleanNode {
    public C2680Or(ASTNode aSTNode, ASTNode aSTNode2, boolean z, ParserContext parserContext) {
        super(parserContext);
        this.left = aSTNode;
    ...
    public void setRightMost(ASTNode aSTNode) {
        C2680Or c2680Or = this;
        while (true) {
            ASTNode aSTNode2 = c2680Or.right;
            if (aSTNode2 == null || !(aSTNode2 instanceof C2680Or)) {
                break;
            } else {
                c2680Or = (C2680Or) aSTNode2;
            }
        }
        c2680Or.right = aSTNode;
    }
    ...
    public ASTNode getRightMost() {
        ...
        C2680Or c2680Or = this;
        while (true) {
            aSTNode = c2680Or.right;
            if (aSTNode == null || !(aSTNode instanceof C2680Or)) {
                break;
            }
            c2680Or = (C2680Or) aSTNode;
        }
        return aSTNode;
    }
