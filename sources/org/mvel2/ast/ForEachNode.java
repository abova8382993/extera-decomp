...
public class ForEachNode extends BlockNode {
    ...
    public Object getReducedValue(Object obj, Object obj2, VariableResolverFactory variableResolverFactory) {
        ...
        throw new CompileException("non-iterable type: ".concat(objEval != null ? objEval.getClass().getName() : "null"), this.expr, this.start);
    }
    ...
    private void handleCond(char[] cArr, int i, int i2, int i3, ParserContext parserContext) {
        ...
        if (i5 == i4 || cArr[i5] != ':') {
            Sign$$ExternalSyntheticBUOutline0.m1013m("expected : in foreach", cArr, i5);
            return;
        }
        int i6 = i5 - i;
        ...
        if (iIndexOf != -1) {
            ...
            try {
                ...
                Sign$$ExternalSyntheticBUOutline0.m1013m("cannot resolve identifier: ".concat(strSubstring), cArr, i);
                return;
            }
        }
        int i7 = i5 + 1;
    ...
    private void determineIterType(Class cls) {
        ...
        if (CharSequence.class.isAssignableFrom(cls)) {
            ...
            Sign$$ExternalSyntheticBUOutline0.m1013m("non-iterable type: ".concat(cls.getName()), this.expr, this.start);
        }
    }
    ...
    private void enforceTypeSafety(Class cls, Class cls2) {
        ...
        Sign$$ExternalSyntheticBUOutline0.m1013m("type mismatch in foreach: expected: " + cls.getName() + "; but found: " + ParseTools.getBaseComponentType(cls2), this.expr, this.start);
    }
}
