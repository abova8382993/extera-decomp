...
public class Function extends ASTNode implements Safe {
    ...
    public Object getReducedValueAccelerated(Object obj, Object obj2, VariableResolverFactory variableResolverFactory) {
        ...
        if (this.name != null) {
            if (!variableResolverFactory.isIndexedFactory() && variableResolverFactory.isResolveable(this.name)) {
                Sign$$ExternalSyntheticBUOutline0.m1013m("duplicate function: " + this.name, this.expr, this.start);
                return null;
            }
    ...
    public Object call(Object obj, Object obj2, VariableResolverFactory variableResolverFactory, Object[] objArr) {
        ...
        boolean z = this.compiledMode;
        ExecutableStatement executableStatement = this.compiledBlock;
        if (z) {
            return executableStatement.getValue(obj2, new StackDemarcResolverFactory(new DefaultLocalVariableResolverFactory(variableResolverFactory, this.parameters)));
        }
        return executableStatement.getValue(obj2, new StackDemarcResolverFactory(new DefaultLocalVariableResolverFactory(variableResolverFactory, this.parameters)));
    }
    ...
    public void checkArgumentCount(int i) {
        if (i != this.parmNum) {
            StringBuilder sb = new StringBuilder("bad number of arguments in function call: ");
            sb.append(i);
            sb.append(" (expected: ");
            int i2 = this.parmNum;
