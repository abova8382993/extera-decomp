...
public class ByteVector {
    ...
    public ByteVector putUTF8(String str) {
        ...
        if (length > 65535) {
            g$$ExternalSyntheticBUOutline1.m207m("UTF8 string too large");
            return null;
        }
        int i = this.length;
        ...
        while (i < length) {
            ...
            if (cCharAt2 >= 1 && cCharAt2 <= 127) {
                ...
                if (cCharAt2 <= 2047) {
                    ...
                    bArr2[i8] = (byte) (((cCharAt2 >> '\f') & 15) | com.android.p006dx.p009io.Opcodes.SHL_INT_LIT8);
                    int i10 = i8 + 2;
    ...
    private void enlarge(int i) {
        ...
        byte[] bArr = this.data;
        if (i2 > bArr.length) {
            Buffer$$ExternalSyntheticBUOutline2.m976m("Internal error");
            return;
        }
