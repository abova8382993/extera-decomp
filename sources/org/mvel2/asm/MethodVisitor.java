...
public abstract class MethodVisitor {
    ...
    protected MethodVisitor f1060mv;
    ...
    public void visitParameter(String str, int i) {
        if (this.api < 327680) {
            ByteString$$ExternalSyntheticBUOutline0.m979m(REQUIRES_ASM5);
            return;
        }
        MethodVisitor methodVisitor = this.f1060mv;
    ...
    public void visitMethodInsn(int i, String str, String str2, String str3, boolean z) {
        ...
        if (z != (i == 185)) {
            ByteString$$ExternalSyntheticBUOutline0.m979m("INVOKESPECIAL/STATIC on interfaces requires ASM5");
        } else {
    ...
    public void visitLdcInsn(Object obj) {
        ...
        if (this.api < 458752 && (obj instanceof ConstantDynamic)) {
            ByteString$$ExternalSyntheticBUOutline0.m979m("This feature requires ASM7");
            return;
        }
        MethodVisitor methodVisitor = this.f1060mv;
        if (methodVisitor != null) {
