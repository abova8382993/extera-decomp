...
final class Constants {
    ...
    static boolean isWhitelisted(String str) {
        ...
        if (Pattern.matches("org/mvel2/asm/util/Trace(Annotation|Class|Field|Method|Module|RecordComponent|Signature)Visitor(\\$.*)?", str)) {
            return true;
        }
        StringBuilder sb = new StringBuilder();
        sb.append("org/mvel2/asm/util/Check");
