...
class Frame {
                ...
                if (cCharAt != 'Z') {
                        ...
                        if (cCharAt2 == 'F') {
                            ...
                            switch (cCharAt2) {
                                ...
                                case 'D':
                                    ...
                                    break;
                                default:
                                    g$$ExternalSyntheticBUOutline1.m207m("Invalid descriptor fragment: ".concat(str.substring(i2)));
                                    return 0;
                            }
                        } else {
                            iAddType = LONG;
                    ...
                    switch (cCharAt) {
                        ...
                        case 'D':
                            return DOUBLE;
                        default:
                            g$$ExternalSyntheticBUOutline1.m207m("Invalid descriptor: ".concat(str.substring(i)));
                            return 0;
                    }
                }
            }
    ...
    */
    private int getInitializedType(org.mvel2.asm.SymbolTable r9, int r10) {
        /*
            r8 = this;
        ...
        L45:
            r10 = r10 & r5
            org.mvel2.asm.Symbol r10 = r9.getType(r10)
        ...
        L54:
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: org.mvel2.asm.Frame.getInitializedType(org.mvel2.asm.SymbolTable, int):int");
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:364:0x02fc  */
    /* JADX WARN: Removed duplicated region for block: B:366:0x0303  */
    /* JADX WARN: Removed duplicated region for block: B:368:0x0307  */
    /* JADX WARN: Removed duplicated region for block: B:370:0x030e  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void execute(int r19, int r20, org.mvel2.asm.Symbol r21, org.mvel2.asm.SymbolTable r22) {
        /*
            Method dump skipped, instruction units count: 1170
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: org.mvel2.asm.Frame.execute(int, int, org.mvel2.asm.Symbol, org.mvel2.asm.SymbolTable):void");
    }
