...
public class CompiledDeclareNode extends Node {
    ...
    public CompiledDeclareNode(int i, String str, char[] cArr, int i2, int i3, ParserContext parserContext) {
        ...
        this.cEnd = i4;
        this.end = i3;
        this.f1069ce = MVEL.compileExpression(cArr, i2, i4 - i2, parserContext);
    }
    ...
    public Object eval(TemplateRuntime templateRuntime, TemplateOutputStream templateOutputStream, Object obj, VariableResolverFactory variableResolverFactory) {
        ...
        templateRuntime.getNamedTemplateRegistry().addNamedTemplate((String) MVEL.executeExpression(this.f1069ce, obj, variableResolverFactory, String.class), new CompiledTemplate(templateRuntime.getTemplate(), this.nestedNode));
        Node node = this.next;
        if (node != null) {
