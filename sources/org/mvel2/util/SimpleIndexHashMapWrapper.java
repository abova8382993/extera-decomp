...
public class SimpleIndexHashMapWrapper<K, V> implements Map<K, V> {
    ...
    public SimpleIndexHashMapWrapper(SimpleIndexHashMapWrapper<K, V> simpleIndexHashMapWrapper, boolean z) {
        ...
        int i3 = 0;
        while (i3 < size2) {
            SimpleIndexHashMapWrapper<K, V>.ValueContainer<K, V> valueContainer4 = arrayList.get(i3);
            i3++;
    ...
    public V put(K k, V v) {
        ...
        if (valueContainer == null) {
            GlShader$$ExternalSyntheticBUOutline1.m1250m("cannot add a new entry.  you must allocate a new key with addKey() first.");
            return null;
        }
        this.indexBasedLookup.add(valueContainer);
