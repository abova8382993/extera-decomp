...
public class CompilerTools {
        ...
        while (aSTLinkedList.hasMoreNodes()) {
            ...
            if (aSTNodeNextNode.getFields() == -1) {
                ...
                if (aSTNodeNextNode2.getFields() == -1) {
                    ...
                    if (iIntValue2 == -1) {
                        Sign$$ExternalSyntheticBUOutline0.m1013m("illegal use of operator: " + aSTNodeNextNode2.getName(), aSTNodeNextNode2.getExpr(), aSTNodeNextNode.getStart());
                        return null;
                    }
                ...
                if (aSTNodeNextNode10.getFields() == -1) {
                    ...
                    if (aSTNodeNextNode10.isOperator() && (aSTNodeNextNode10.getOperator().intValue() == 21 || aSTNodeNextNode10.getOperator().intValue() == 22)) {
                        if (aSTNodeNextNode10.getOperator().intValue() == 21) {
                            c2572Or = new And(aSTNodeNextNode9, aSTLinkedList4.nextNode(), parserContext4.isStrongTyping(), parserContext4);
                        } else {
                            c2572Or = new C2572Or(aSTNodeNextNode9, aSTLinkedList4.nextNode(), parserContext4.isStrongTyping(), parserContext4);
                        }
                        ...
                        while (aSTLinkedList4.hasMoreNodes()) {
                            ...
                            if (aSTNodeNextNode11.getOperator().intValue() == 21) {
                                c2572Or.setRightMost(new And(c2572Or.getRightMost(), aSTLinkedList4.nextNode(), parserContext4.isStrongTyping(), parserContext4));
                            } else {
                                c2572Or = new C2572Or(c2572Or, aSTLinkedList4.nextNode(), parserContext4.isStrongTyping(), parserContext4);
                            }
                            aSTNodeNextNode10 = aSTNodeNextNode11;
                        }
                        aSTLinkedList5.addTokenNode(c2572Or);
            ...
            switch (i) {
                ...
                case 29:
                    if (parserContext.isStrongTyping() && aSTNode.getEgressType() != Boolean.class && aSTNode.getEgressType() != Boolean.TYPE) {
                        Instance$$ExternalSyntheticBUOutline0.m1010m("Condition of ternary operator is not of type boolean. Found ", aSTNode.getEgressType());
                        return;
                    }
                    break;
            }
    ...
    public static Number signNumber(Object obj) {
        ...
        Sign$$ExternalSyntheticBUOutline0.m1013m("expected a numeric type but found: ".concat(obj.getClass().getName()), new char[0], 0);
        return null;
    }
}
