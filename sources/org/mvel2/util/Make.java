...
public class Make {
    ...
    public static class Map<K, V> {
        ...
        public static <K, V> Map<K, V> start(Class<? extends java.util.Map> cls) {
            try {
                ...
                Make$Map$$ExternalSyntheticBUOutline0.m1024m("error creating instance", th);
                return null;
            }
        }
    ...
    public static class String {
        ...
        public String _append(char c2) {
            this.stringAppender.append(c2);
            return this;
        }
