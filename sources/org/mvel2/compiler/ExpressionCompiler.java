...
public class ExpressionCompiler extends AbstractParser {
                    ...
                    if (aSTNodeNextToken != null) {
                                    ...
                                    if (aSTNodeNextTokenSkipSymbols2 != null && aSTNodeNextTokenSkipSymbols2.isLiteral() && aSTNodeNextTokenSkipSymbols.getOperator().intValue() < 34) {
                                        ...
                                        while (true) {
                                            ...
                                            if (aSTNodeNextTokenSkipSymbols4 != null) {
                                                boolean zIsLiteral = aSTNodeNextTokenSkipSymbols4.isLiteral();
                                                ...
                                                if (zIsLiteral) {
                                                    ...
                                                    if (!executionStack2.isEmpty()) {
                                                        aSTLinkedList.addTokenNode(new LiteralNode(getStackValueResult(), this.pCtx));
                                                    }
                                                    aSTLinkedList.addTokenNode(new OperatorNode(aSTNodeNextTokenSkipSymbols3.getOperator(), this.expr, this.f1065st, this.pCtx), verify(this.pCtx, aSTNodeNextTokenSkipSymbols4));
                                                }
                                            } else if (z) {
                                                aSTLinkedList.addTokenNode(new LiteralNode(getStackValueResult(), this.pCtx));
                                            } else {
                        ...
                        if (!this.verifyOnly) {
                            try {
                                ...
                                throw new CompileException(e.getMessage(), this.expr, this.f1065st, e);
                            }
                        }
                        try {
                            ...
                            throw new CompileException(e2.getMessage(), this.expr, this.f1065st, e2);
                        }
                    }
                }
            } catch (NullPointerException e3) {
                Negation$$ExternalSyntheticBUOutline0.m1011m("not a statement, or badly formed structure", this.expr, this.f1065st, e3);
                return null;
            } catch (CompileException e4) {
                throw ErrorUtil.rewriteIfNeeded(e4, this.expr, this.f1065st);
            }
        } catch (Throwable th) {
            if (th instanceof RuntimeException) {
                throw th;
            }
            Negation$$ExternalSyntheticBUOutline0.m1011m(th.getMessage(), this.expr, this.f1065st, th);
            return null;
        }
    }

    private Object getStackValueResult() {
        int i = this.fields & 524288;
        Object objPop = this.stk.pop();
        return i == 0 ? objPop : CompilerTools.signNumber(objPop);
    }
    ...
    private boolean compileReduce(int i, ASTLinkedList aSTLinkedList) {
        ...
        if (iArithmeticFunctionReduction == -3) {
            ...
            aSTLinkedList.addTokenNode(new LiteralNode(getStackValueResult(), this.pCtx));
            aSTLinkedList.addTokenNode(new OperatorNode(num, this.expr, this.f1065st, this.pCtx), verify(this.pCtx, aSTNode));
            return false;
        }
        ...
        aSTLinkedList.addTokenNode(new LiteralNode(this.stk.pop(), this.pCtx), new OperatorNode((Integer) this.stk.pop(), this.expr, this.f1065st, this.pCtx));
    ...
    /* JADX WARN: Code restructure failed: missing block: B:82:0x01a0, code lost:
        ...
        if (org.mvel2.util.ParseTools.unboxPrimitive(r3.getKnownEgressType()).equals(r6.returnType) != false) goto L105;
     */
    ...
    */
    public org.mvel2.ast.ASTNode verify(org.mvel2.ParserContext r7, org.mvel2.ast.ASTNode r8) {
        /*
