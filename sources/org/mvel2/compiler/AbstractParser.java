...
public class AbstractParser implements Parser, Serializable {
    ...
    protected org.mvel2.ast.ASTNode nextToken() {
        /*
            Method dump skipped, instruction units count: 5102
        ...
        while (true) {
            ...
            if (this.lastNode.isLiteral() && (this.lastNode.getLiteralValue() instanceof Class)) {
                ...
                if (z) {
                    ...
                    captureToEOS();
                    this.splitAccumulator.add(new TypedVarNode(this.expr, this.f1568st, (this.cursor - r3) - 1, this.fields | 128, (Class) this.lastNode.getLiteralValue(), this.pCtx));
                }
    ...
    private ASTNode _captureBlock(ASTNode aSTNode, char[] cArr, boolean z, int i) {
        ...
        if (i == 2048) {
            ...
            if (!z) {
                ...
                this.f1568st = iTrimRight;
                return ifNode.setElseBlock(cArr, iTrimRight, trimLeft(iBalancedCaptureWithLineAccounting2) - this.f1568st, this.pCtx);
            }
    ...
    */
    ...
    public int nextNonBlank() {
        int i = this.cursor;
        if (i + 1 >= this.end) {
            throw new CompileException("unexpected end of statement", this.expr, this.f1568st);
        }
        while (i != this.end && ParseTools.isWhitespace(this.expr[i])) {
            i++;
        }
    ...
    public void expectNextChar_IW(char c) {
        ...
        throw new CompileException("unexpected character ('" + this.expr[this.cursor] + "'); was expecting: " + c, this.expr, this.f1568st);
    }
    ...
    protected void addFatalError(String str) {
        this.pCtx.addError(new ErrorDetail(this.expr, this.f1568st, true, str));
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:211:0x0192, code lost:
        ...
        if (r8.stk.isReduceable() == false) goto L218;
     */
    ...
    */
    ...
    protected void reduce() {
        try {
            ...
            this.stk.m1118op(iIntValue);
        } catch (ArithmeticException e) {
            throw new CompileException("arithmetic error: " + e.getMessage(), this.expr, this.f1568st, e);
        } catch (ClassCastException e2) {
            throw new CompileException("syntax error or incompatable types", this.expr, this.f1568st, e2);
        } catch (Exception e3) {
            throw new CompileException("failed to subEval expression", this.expr, this.f1568st, e3);
        }
    }
