...
public class PropertyAccessor {
    ...
    private Object get() {
        ...
        try {
            ...
            throw new PropertyAccessException("array or collections index out of bounds in property: ".concat(new String(this.property, this.cursor, i2)), this.property, this.cursor, e2, this.pCtx);
        } catch (NullPointerException e3) {
            throw new PropertyAccessException("null pointer exception in property: ".concat(new String(this.property)), this.property, this.cursor, e3, this.pCtx);
            ...
            throw ErrorUtil.rewriteIfNeeded(e5, this.property, this.f1055st);
        } catch (Exception e6) {
            throw new PropertyAccessException("unknown exception in expression: ".concat(new String(this.property)), this.property, this.cursor, e6, this.pCtx);
        }
    }
    ...
    private Object getAllowOverride() {
        while (this.cursor < this.end) {
            ...
            if (z) {
                ...
                this.nullHandle = false;
            } else if (obj == null && this.cursor < this.end) {
                throw null;
            }
            this.first = false;
        }
    ...
    private void set(Object obj) {
        ...
        try {
            ...
            this.curr = obj2;
            if (obj2 == null) {
                throw new PropertyAccessException("cannot bind to null context: ".concat(new String(this.property, this.cursor, this.length)), this.property, this.cursor, this.pCtx);
            }
            this.end = i;
            if (nextToken() == 2) {
                ...
                if (!MVEL.COMPILER_OPT_ALLOW_OVERRIDE_ALL_PROPHANDLING) {
                    ...
                    boolean zHasPropertyHandler = PropertyHandlerFactory.hasPropertyHandler(obj3.getClass());
                    Object obj4 = this.curr;
                    if (zHasPropertyHandler) {
                        PropertyHandlerFactory.getPropertyHandler(obj4.getClass()).setProperty(str, this.ctx, this.variableFactory, obj);
                        return;
                    }
            ...
            if (memberCheckWriteCache == null) {
                ...
                Member fieldOrWriteAccessor = obj != null ? PropertyTools.getFieldOrWriteAccessor(obj6.getClass(), strCapture, obj.getClass()) : PropertyTools.getFieldOrWriteAccessor(obj6.getClass(), strCapture);
            ...
            Object obj7 = this.curr;
            if (obj7 instanceof Map) {
                ((Map) obj7).put(MVEL.eval(strCapture, this.ctx, this.variableFactory), obj);
                return;
            }
            if (obj7 instanceof FunctionInstance) {
                ((PrototypalFunctionInstance) obj7).getResolverFactory().getVariableResolver(strCapture).setValue(obj);
                return;
            }
            StringBuilder sb = new StringBuilder("could not access/write property (");
            sb.append(strCapture);
            sb.append(") in: ");
            Object obj8 = this.curr;
            sb.append(obj8 == null ? "Unknown" : obj8.getClass().getName());
            throw new PropertyAccessException(sb.toString(), this.property, this.cursor, this.pCtx);
        } catch (IllegalAccessException e) {
            throw new PropertyAccessException("could not access property", this.property, this.f1055st, e, this.pCtx);
        } catch (InvocationTargetException e2) {
            throw new PropertyAccessException("could not access property", this.property, this.f1055st, e2, this.pCtx);
        }
    }
    ...
    */
    ...
    private String capture() {
        return new String(this.property, this.f1055st, trimLeft(this.cursor) - this.f1055st);
    }
    ...
    public static void reportCacheSizes() {
        ...
        StringBuilder sb = new StringBuilder("read property cache: ");
        ...
        StringBuilder sb2 = new StringBuilder("write property cache: ");
        ...
        StringBuilder sb3 = new StringBuilder("method cache: ");
    ...
    */
    ...
    private boolean scanTo(char c2) {
        while (true) {
            int i = this.cursor;
            int i2 = this.end;
            if (i >= i2) {
    ...
    private Object getCollectionProperty(Object obj, String str) {
        if (str.length() != 0 && (obj = getBeanProperty(obj, str)) == null) {
            g$$ExternalSyntheticBUOutline2.m208m("null pointer on indexed access for: ".concat(str));
            return null;
        }
        this.currType = null;
        int i = this.cursor + 1;
        ...
        try {
            ...
            throw new PropertyAccessException("illegal use of []: unknown type: ".concat(obj.getClass().getName()), this.property, this.f1055st, e, this.pCtx);
        }
    }
    ...
    private Object getCollectionPropertyAO(Object obj, String str) {
        ...
        try {
            ...
            throw new PropertyAccessException("illegal use of []: unknown type: ".concat(obj.getClass().getName()), this.property, this.f1055st, this.pCtx);
        }
    }
