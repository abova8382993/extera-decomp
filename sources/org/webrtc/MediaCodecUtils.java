...
class MediaCodecUtils {
    ...
    public static /* synthetic */ class C75881 {
    ...
    public static Map<String, String> getCodecProperties(VideoCodecMimeType videoCodecMimeType, boolean z) {
        int i = C75881.$SwitchMap$org$webrtc$VideoCodecMimeType[videoCodecMimeType.ordinal()];
        if (i == 1 || i == 2 || i == 3 || i == 4) {
            return new HashMap();
        }
        if (i == 5) {
        ...
        Native$$ExternalSyntheticBUOutline5.m554m("Unsupported codec: ", videoCodecMimeType);
        return null;
    }
