...
public class NetworkMonitor {
    ...
    private static void assertIsTrue(boolean z) {
        ...
        Buffer$$ExternalSyntheticBUOutline2.m976m("Expected to be true");
    }
    ...
    public void startMonitoring(Context context) {
        startMonitoring(context, _UrlKt.FRAGMENT_ENCODE_SET);
    }

    @Deprecated
    public void startMonitoring() {
        startMonitoring(ContextUtils.getApplicationContext(), _UrlKt.FRAGMENT_ENCODE_SET);
    }

    @CalledByNative
    private void startMonitoring(Context context, long j, String str) {
        Logging.m1252d(TAG, "Start monitoring with native observer " + j + " fieldTrialsString: " + str);
        if (context == null) {
    ...
    private void stopMonitoring(long j) {
        Logging.m1252d(TAG, "Stop monitoring with native observer " + j);
        stopMonitoring();
        synchronized (this.nativeNetworkObservers) {
