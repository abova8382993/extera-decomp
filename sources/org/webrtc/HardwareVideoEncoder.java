...
class HardwareVideoEncoder implements VideoEncoder {
            ...
            synchronized (this.countLock) {
                ...
                while (this.count > 0) {
                    try {
                        ...
                        Logging.m1356e(HardwareVideoEncoder.TAG, "Interrupted while waiting on busy count", e);
                        z = true;
                    }
                }
            }
    ...
    public VideoCodecStatus initEncode(VideoEncoder.Settings settings, VideoEncoder.Callback callback) {
        ...
        Logging.m1354d(TAG, "initEncode name: " + this.codecName + " type: " + this.codecType + " width: " + this.width + " height: " + this.height + " framerate_fps: " + settings.maxFramerate + " bitrate_kbps: " + settings.startBitrate + " surface mode: " + this.useSurfaceMode);
    ...
    */
    ...
    public VideoCodecStatus release() {
        ...
        if (this.outputThread == null) {
            ...
            if (!ThreadUtils.joinUninterruptibly(this.outputThread, 5000L)) {
                Logging.m1355e(TAG, "Media encoder release timeout");
                videoCodecStatus = VideoCodecStatus.TIMEOUT;
            } else if (this.shutdownException != null) {
                Logging.m1356e(TAG, "Media encoder release exception", this.shutdownException);
    ...
    public VideoCodecStatus encode(VideoFrame videoFrame, VideoEncoder.EncodeInfo encodeInfo) {
        ...
        if (this.outputBuilders.size() > 2) {
            Logging.m1355e(TAG, "Dropped frame, encoder queue full");
    ...
    private VideoCodecStatus encodeTextureBuffer(VideoFrame videoFrame, long j) {
        ...
        try {
            ...
            Logging.m1356e(TAG, "encodeTexture failed", e);
    ...
    private VideoCodecStatus encodeByteBuffer(VideoFrame videoFrame, VideoFrame.Buffer buffer, int i) {
        ...
        try {
            ...
            if (iDequeueInputBuffer == -1) {
                Logging.m1354d(TAG, "Dropped frame, no input buffers available");
                return VideoCodecStatus.NO_OUTPUT;
            }
            try {
                ByteBuffer inputBuffer = this.codec.getInputBuffer(iDequeueInputBuffer);
                if (inputBuffer.capacity() < this.frameSizeBytes) {
                    Logging.m1355e(TAG, "Input buffer size: " + inputBuffer.capacity() + " is smaller than frame size: " + this.frameSizeBytes);
                    return VideoCodecStatus.ERROR;
                }
    ...
    private VideoCodecStatus resetCodec(int i, int i2, boolean z) {
        FileLog.m1133d("resetCodec " + i + "x" + i2);
        this.encodeThreadChecker.checkIsOnValidThread();
    ...
    private void requestKeyFrame(long j) {
        ...
        try {
            ...
            Logging.m1356e(TAG, "requestKeyFrame failed", e);
        }
    }
    ...
    protected void deliverEncodedImage() {
        ...
        try {
            ...
            if ((bufferInfo.flags & 2) != 0) {
                Logging.m1354d(TAG, "Config frame generated. Offset: " + bufferInfo.offset + ". Size: " + bufferInfo.size);
            ...
            if (z) {
                Logging.m1354d(TAG, "Sync frame generated");
            }
            ...
            if (z && this.configBuffer != null) {
                Logging.m1354d(TAG, "Prepending config buffer of size " + this.configBuffer.capacity() + " to output buffer with offset " + bufferInfo.offset + ", size " + bufferInfo.size);
            ...
            Logging.m1356e(TAG, "deliverOutput failed", e);
        }
    }
    ...
    public /* synthetic */ void lambda$deliverEncodedImage$0(int i) {
        try {
            ...
            Logging.m1356e(TAG, "releaseOutputBuffer failed", e);
        }
    ...
    public void releaseCodecOnOutputThread() {
        ...
        try {
            ...
            Logging.m1356e(TAG, "Media encoder stop failed", e);
        }
        try {
            this.codec.release();
        } catch (Exception e2) {
            Logging.m1356e(TAG, "Media encoder release failed", e2);
    ...
    private VideoCodecStatus updateBitrate() {
        ...
        try {
            ...
            Logging.m1356e(TAG, "updateBitrate failed", e);
            return VideoCodecStatus.ERROR;
        }
    }
    ...
    private void updateInputFormat(MediaFormat mediaFormat) {
        ...
        Logging.m1354d(TAG, "updateInputFormat format: " + mediaFormat + " stride: " + this.stride + " sliceHeight: " + this.sliceHeight + " isSemiPlanar: " + this.isSemiPlanar + " frameSizeBytes: " + this.frameSizeBytes);
    }
