...
class HardwareVideoEncoder implements VideoEncoder {
    ...
    public static class BusyCount {
        ...
        public /* synthetic */ BusyCount(HardwareVideoEncoderIA hardwareVideoEncoderIA) {
            this();
        }
            ...
            synchronized (this.countLock) {
                ...
                while (this.count > 0) {
                    try {
                        ...
                        Logging.m1254e(HardwareVideoEncoder.TAG, "Interrupted while waiting on busy count", e);
                        z = true;
                    }
                }
            }
    ...
    public VideoCodecStatus initEncode(VideoEncoder.Settings settings, VideoEncoder.Callback callback) {
        ...
        Logging.m1252d(TAG, "initEncode name: " + this.codecName + " type: " + this.codecType + " width: " + this.width + " height: " + this.height + " framerate_fps: " + settings.maxFramerate + " bitrate_kbps: " + settings.startBitrate + " surface mode: " + this.useSurfaceMode);
        return initEncodeInternal();
    }

    /* JADX WARN: Removed duplicated region for block: B:81:0x00a8 A[Catch: IllegalStateException -> 0x009b, IllegalArgumentException -> 0x009e, TryCatch #3 {IllegalArgumentException -> 0x009e, IllegalStateException -> 0x009b, blocks: (B:60:0x002d, B:62:0x0066, B:66:0x0075, B:81:0x00a8, B:71:0x0084, B:73:0x008c, B:78:0x00a1, B:82:0x00af, B:84:0x00ba, B:85:0x00bf, B:87:0x00c5, B:88:0x00cc, B:90:0x00e5, B:91:0x0101), top: B:100:0x002d }] */
    /*
    ...
    */
    ...
    public VideoCodecStatus release() {
        ...
        if (this.outputThread == null) {
            ...
            if (!ThreadUtils.joinUninterruptibly(this.outputThread, 5000L)) {
                Logging.m1253e(TAG, "Media encoder release timeout");
                videoCodecStatus = VideoCodecStatus.TIMEOUT;
            } else if (this.shutdownException != null) {
                Logging.m1254e(TAG, "Media encoder release exception", this.shutdownException);
    ...
    public VideoCodecStatus encode(VideoFrame videoFrame, VideoEncoder.EncodeInfo encodeInfo) {
        ...
        if (this.outputBuilders.size() > 2) {
            Logging.m1253e(TAG, "Dropped frame, encoder queue full");
    ...
    private VideoCodecStatus encodeTextureBuffer(VideoFrame videoFrame, long j) {
        ...
        try {
            ...
            Logging.m1254e(TAG, "encodeTexture failed", e);
    ...
    private VideoCodecStatus encodeByteBuffer(VideoFrame videoFrame, VideoFrame.Buffer buffer, int i) {
        ...
        try {
            ...
            if (iDequeueInputBuffer == -1) {
                Logging.m1252d(TAG, "Dropped frame, no input buffers available");
                return VideoCodecStatus.NO_OUTPUT;
            }
            try {
                ByteBuffer inputBuffer = this.codec.getInputBuffer(iDequeueInputBuffer);
                if (inputBuffer.capacity() < this.frameSizeBytes) {
                    Logging.m1253e(TAG, "Input buffer size: " + inputBuffer.capacity() + " is smaller than frame size: " + this.frameSizeBytes);
                    return VideoCodecStatus.ERROR;
                }
                ...
                try {
                    ...
                    Logging.m1254e(TAG, "queueInputBuffer failed", e);
                    return VideoCodecStatus.ERROR;
                }
            } catch (IllegalStateException e2) {
                Logging.m1254e(TAG, "getInputBuffer with index=" + iDequeueInputBuffer + " failed", e2);
                return VideoCodecStatus.ERROR;
            }
        } catch (IllegalStateException e3) {
            Logging.m1254e(TAG, "dequeueInputBuffer failed", e3);
            return VideoCodecStatus.ERROR;
        }
    }
    ...
    private VideoCodecStatus resetCodec(int i, int i2, boolean z) {
        FileLog.m1045d("resetCodec " + i + "x" + i2);
        this.encodeThreadChecker.checkIsOnValidThread();
    ...
    private void requestKeyFrame(long j) {
        ...
        try {
            ...
            Logging.m1254e(TAG, "requestKeyFrame failed", e);
        }
    }

    /* JADX INFO: renamed from: org.webrtc.HardwareVideoEncoder$1 */
    public class C75851 extends Thread {
        public C75851() {
        }
    ...
    public void deliverEncodedImage() {
        ...
        try {
            ...
            if ((bufferInfo.flags & 2) != 0) {
                Logging.m1252d(TAG, "Config frame generated. Offset: " + bufferInfo.offset + ". Size: " + bufferInfo.size);
            ...
            if (z) {
                Logging.m1252d(TAG, "Sync frame generated");
            }
            ...
            if (z && this.configBuffer != null) {
                Logging.m1252d(TAG, "Prepending config buffer of size " + this.configBuffer.capacity() + " to output buffer with offset " + bufferInfo.offset + ", size " + bufferInfo.size);
            ...
            Logging.m1254e(TAG, "deliverOutput failed", e);
        }
    }
    ...
    public /* synthetic */ void lambda$deliverEncodedImage$0(int i) {
        try {
            ...
            Logging.m1254e(TAG, "releaseOutputBuffer failed", e);
        }
    ...
    public void releaseCodecOnOutputThread() {
        this.outputThreadChecker.checkIsOnValidThread();
        Logging.m1252d(TAG, "Releasing MediaCodec on output thread");
        this.outputBuffersBusyCount.waitForZero();
        try {
            this.codec.stop();
        } catch (Exception e) {
            Logging.m1254e(TAG, "Media encoder stop failed", e);
        }
        try {
            this.codec.release();
        } catch (Exception e2) {
            Logging.m1254e(TAG, "Media encoder release failed", e2);
            this.shutdownException = e2;
        }
        this.configBuffer = null;
        Logging.m1252d(TAG, "Release on output thread done");
    }
    ...
    private VideoCodecStatus updateBitrate() {
        ...
        try {
            ...
            Logging.m1254e(TAG, "updateBitrate failed", e);
            return VideoCodecStatus.ERROR;
        }
    }
    ...
    private void updateInputFormat(MediaFormat mediaFormat) {
        ...
        Logging.m1252d(TAG, "updateInputFormat format: " + mediaFormat + " stride: " + this.stride + " sliceHeight: " + this.sliceHeight + " isSemiPlanar: " + this.isSemiPlanar + " frameSizeBytes: " + this.frameSizeBytes);
    }
    ...
    public boolean isSemiPlanar(int i) {
        ...
        CharCodeKt$$ExternalSyntheticBUOutline0.m873m("Unsupported colorFormat: ", i);
        return false;
    }
}
