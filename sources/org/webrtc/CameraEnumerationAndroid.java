...
public class CameraEnumerationAndroid {
    ...
    public static class CaptureFormat {
        ...
        public static int frameSize(int i, int i2, int i3) {
            if (i3 != 17) {
                ByteString$$ExternalSyntheticBUOutline0.m979m("Don't know how to calculate the frame size of non-NV21 image formats.");
                return 0;
            }
        ...
        public int hashCode() {
            return (((this.width * 65497) + this.height) * Opcodes.INVOKE_POLYMORPHIC_RANGE) + 1 + this.framerate.hashCode();
        }
    }
