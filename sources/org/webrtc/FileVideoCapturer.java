...
public class FileVideoCapturer implements VideoCapturer {
    ...
    public static class VideoReaderY4M implements VideoReader {
        ...
        public VideoReaderY4M(String str) throws IOException {
            ...
            while (true) {
                ...
                if (i == -1) {
                    MVEL$$ExternalSyntheticBUOutline0.m1006m("Found end of file before end of header for file: ", str);
                    throw null;
                }
                if (i != 10) {
                    sb.append((char) i);
                    ...
                    Logging.m1252d(TAG, "Color space: " + strSubstring);
                    if (!strSubstring.equals("420") && !strSubstring.equals("420mpeg2")) {
                        g$$ExternalSyntheticBUOutline1.m207m("Does not support any other color space than I420 or I420mpeg2");
                        throw null;
                    }
                    if (i2 % 2 == 1 || i3 % 2 == 1) {
                        g$$ExternalSyntheticBUOutline1.m207m("Does not support odd width or height");
                        throw null;
                    }
                    this.frameWidth = i2;
                    this.frameHeight = i3;
                    Logging.m1252d(TAG, "frame dim: (" + i2 + ", " + i3 + ")");
                    return;
                }
            }
        }
        ...
        public void close() {
            try {
                ...
                Logging.m1254e(TAG, "Problem closing file", e);
            }
        }
    }
    ...
    public FileVideoCapturer(String str) throws IOException {
        try {
            ...
            Logging.m1252d(TAG, "Could not open video file: " + str);
            throw e;
        }
    }
