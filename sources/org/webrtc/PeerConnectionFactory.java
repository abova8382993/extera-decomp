...
public class PeerConnectionFactory {
    ...
    public static class InitializationOptions {
        ...
        public /* synthetic */ InitializationOptions(Context context, String str, boolean z, NativeLibraryLoader nativeLibraryLoader, String str2, Loggable loggable, Logging.Severity severity, PeerConnectionFactoryIA peerConnectionFactoryIA) {
        ...
        public static class Builder {
            ...
            private String fieldTrials = _UrlKt.FRAGMENT_ENCODE_SET;
    ...
    public static class Builder {
        ...
        public /* synthetic */ Builder(PeerConnectionFactoryIA peerConnectionFactoryIA) {
            this();
        }
        ...
        public Builder setAudioEncoderFactoryFactory(AudioEncoderFactoryFactory audioEncoderFactoryFactory) {
            if (audioEncoderFactoryFactory == null) {
                g$$ExternalSyntheticBUOutline1.m207m("PeerConnectionFactory.Builder does not accept a null AudioEncoderFactoryFactory.");
                return null;
            }
        ...
        public Builder setAudioDecoderFactoryFactory(AudioDecoderFactoryFactory audioDecoderFactoryFactory) {
            if (audioDecoderFactoryFactory == null) {
                g$$ExternalSyntheticBUOutline1.m207m("PeerConnectionFactory.Builder does not accept a null AudioDecoderFactoryFactory.");
                return null;
            }
        ...
        public Builder setAudioProcessingFactory(AudioProcessingFactory audioProcessingFactory) {
            if (audioProcessingFactory == null) {
                g$$ExternalSyntheticBUOutline2.m208m("PeerConnectionFactory builder does not accept a null AudioProcessingFactory.");
                return null;
            }
    ...
    public static void initialize(InitializationOptions initializationOptions) {
        ...
        if (loggable != null) {
            ...
            Logging.m1252d(TAG, "PeerConnectionFactory was initialized without an injected Loggable. Any existing Loggable will be deleted.");
    ...
    public static void checkInitializeHasBeenCalled() {
        if (!NativeLibrary.isLoaded() || ContextUtils.getApplicationContext() == null) {
            Segment$$ExternalSyntheticBUOutline1.m992m("PeerConnectionFactory.initialize was not called before creating a PeerConnectionFactory.");
        }
    }
    ...
    public static String fieldTrialsFindFullName(String str) {
        return NativeLibrary.isLoaded() ? nativeFindFieldTrialsFullName(str) : _UrlKt.FRAGMENT_ENCODE_SET;
    }
    ...
    public PeerConnectionFactory(long j) {
        ...
        if (j == 0) {
            GlShader$$ExternalSyntheticBUOutline1.m1250m("Failed to initialize PeerConnectionFactory!");
            throw null;
        }
    ...
    private void checkPeerConnectionFactoryExists() {
        ...
        Segment$$ExternalSyntheticBUOutline1.m992m("PeerConnectionFactory has been disposed.");
    }
    ...
    private static void printStackTrace(ThreadInfo threadInfo, boolean z) {
        ...
        if (stackTrace.length > 0) {
            Logging.m1256w(TAG, name + " stacktrace:");
            for (StackTraceElement stackTraceElement : stackTrace) {
                Logging.m1256w(TAG, stackTraceElement.toString());
            }
        }
        if (z) {
            Logging.m1256w(TAG, "*** *** *** *** *** *** *** *** *** *** *** *** *** *** *** ***");
            Logging.m1256w(TAG, "pid: " + Process.myPid() + ", tid: " + threadInfo.tid + ", name: " + name + "  >>> WebRTC <<<");
    ...
    private void onNetworkThreadReady() {
        ...
        Logging.m1252d(TAG, "onNetworkThreadReady");
    }
    ...
    private void onWorkerThreadReady() {
        ...
        Logging.m1252d(TAG, "onWorkerThreadReady");
    }
    ...
    private void onSignalingThreadReady() {
        ...
        Logging.m1252d(TAG, "onSignalingThreadReady");
    }
}
