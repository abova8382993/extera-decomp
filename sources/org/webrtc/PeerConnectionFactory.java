...
public class PeerConnectionFactory {
    ...
    public static class InitializationOptions {
        ...
        /* synthetic */ InitializationOptions(Context context, String str, boolean z, NativeLibraryLoader nativeLibraryLoader, String str2, Loggable loggable, Logging.Severity severity, PeerConnectionFactoryIA peerConnectionFactoryIA) {
    ...
    public static class Builder {
        ...
        /* synthetic */ Builder(PeerConnectionFactoryIA peerConnectionFactoryIA) {
            this();
        }
    ...
    public static void initialize(InitializationOptions initializationOptions) {
        ...
        if (loggable != null) {
            ...
            Logging.m1354d(TAG, "PeerConnectionFactory was initialized without an injected Loggable. Any existing Loggable will be deleted.");
    ...
    private static void printStackTrace(ThreadInfo threadInfo, boolean z) {
        ...
        if (stackTrace.length > 0) {
            Logging.m1358w(TAG, name + " stacktrace:");
            for (StackTraceElement stackTraceElement : stackTrace) {
                Logging.m1358w(TAG, stackTraceElement.toString());
            }
        }
        if (z) {
            Logging.m1358w(TAG, "*** *** *** *** *** *** *** *** *** *** *** *** *** *** *** ***");
            Logging.m1358w(TAG, "pid: " + Process.myPid() + ", tid: " + threadInfo.tid + ", name: " + name + "  >>> WebRTC <<<");
    ...
    private void onNetworkThreadReady() {
        ...
        Logging.m1354d(TAG, "onNetworkThreadReady");
    }
    ...
    private void onWorkerThreadReady() {
        ...
        Logging.m1354d(TAG, "onWorkerThreadReady");
    }
    ...
    private void onSignalingThreadReady() {
        ...
        Logging.m1354d(TAG, "onSignalingThreadReady");
    }
}
