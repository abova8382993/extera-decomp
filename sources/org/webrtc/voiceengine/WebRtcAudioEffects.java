...
public class WebRtcAudioEffects {
    ...
    private NoiseSuppressor f1878ns;
    ...
    public static boolean isAcousticEchoCancelerBlacklisted() {
        ...
        if (zContains) {
            Logging.m1256w(TAG, str + " is blacklisted for HW AEC usage!");
        }
        return zContains;
    }
    ...
    public static boolean isNoiseSuppressorBlacklisted() {
        ...
        if (zContains) {
            Logging.m1256w(TAG, str + " is blacklisted for HW NS usage!");
        }
        return zContains;
    }
    ...
    public static boolean canUseAcousticEchoCanceler() {
        ...
        Logging.m1252d(TAG, "canUseAcousticEchoCanceler: " + z);
        return z;
    }
    ...
    public static boolean canUseNoiseSuppressor() {
        ...
        Logging.m1252d(TAG, "canUseNoiseSuppressor: " + z);
        return z;
    }
    ...
    public boolean setNS(boolean z) {
        ...
        if (this.f1878ns != null && z != this.shouldEnableNs) {
    ...
    public void enable(int i) {
        ...
        if (isNoiseSuppressorSupported()) {
            ...
            this.f1878ns = noiseSuppressorCreate;
            if (noiseSuppressorCreate != null) {
                ...
                if (this.f1878ns.setEnabled(z) != 0) {
                ...
                sb2.append(z);
                sb2.append(", is now: ");
                sb2.append(this.f1878ns.getEnabled() ? "enabled" : "disabled");
    ...
    public void release() {
        ...
        NoiseSuppressor noiseSuppressor = this.f1878ns;
