...
public class WebRtcAudioRecord {
    ...
    public static void setErrorCallback(WebRtcAudioRecordErrorCallback webRtcAudioRecordErrorCallback) {
        Logging.m1354d(TAG, "Set error callback");
    ...
    private class AudioRecordThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                Logging.m1355e(WebRtcAudioRecord.TAG, "AudioRecord.stop failed: " + e2.getMessage());
            }
        }
    ...
    private boolean enableBuiltInAEC(boolean z) {
        ...
        if (webRtcAudioEffects == null) {
            Logging.m1355e(TAG, "Built-in AEC is not supported on this platform");
            return false;
        }
    ...
    private boolean enableBuiltInNS(boolean z) {
        ...
        WebRtcAudioEffects webRtcAudioEffects = this.effects;
        if (webRtcAudioEffects == null) {
            Logging.m1355e(TAG, "Built-in NS is not supported on this platform");
            return false;
        }
        ...
        if (this.captureType == 1) {
            if (Build.VERSION.SDK_INT >= 29) {
                try {
                    ...
                    WebRtcAudioRecord$$ExternalSyntheticApiModelOutline1.m1365m();
                    AudioPlaybackCaptureConfiguration.Builder builderM1364m = WebRtcAudioRecord$$ExternalSyntheticApiModelOutline0.m1364m(mediaProjection);
                    builderM1364m.addMatchingUsage(1);
                    builderM1364m.addMatchingUsage(14);
                    builderM1364m.addMatchingUsage(0);
                    AudioRecord.Builder builder = new AudioRecord.Builder();
                    builder.setAudioPlaybackCaptureConfig(builderM1364m.build());
    ...
    public static synchronized void setAudioSource(int i) {
        Logging.m1358w(TAG, "Audio source is changed from: " + audioSource + " to " + i);
        audioSource = i;
    }
    ...
    private void releaseAudioResources(boolean z) {
        Logging.m1354d(TAG, "releaseAudioResources " + z);
        if (z) {
            AudioRecord audioRecord = this.deviceAudioRecord;
            if (audioRecord != null) {
                audioRecord.release();
