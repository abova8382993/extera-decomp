...
class Camera2Session implements CameraSession {
    ...
    private class CameraStateCallback extends CameraDevice.StateCallback {
        /* synthetic */ CameraStateCallback(Camera2Session camera2Session, Camera2SessionIA camera2SessionIA) {
            this();
        }
        ...
        public void onOpened(CameraDevice cameraDevice) {
            Camera2Session.this.checkIsOnCameraThread();
            Logging.m1354d(Camera2Session.TAG, "Camera opened.");
        ...
        public void onClosed(CameraDevice cameraDevice) {
            Camera2Session.this.checkIsOnCameraThread();
            Logging.m1354d(Camera2Session.TAG, "Camera device closed.");
    ...
    class CaptureSessionCallback extends CameraCaptureSession.StateCallback {
        /* synthetic */ CaptureSessionCallback(Camera2Session camera2Session, Camera2SessionIA camera2SessionIA) {
            this();
        }
        ...
        public void onConfigured(CameraCaptureSession cameraCaptureSession) {
            Camera2Session.this.checkIsOnCameraThread();
            Logging.m1354d(Camera2Session.TAG, "Camera capture session configured.");
            ...
            try {
                ...
                Logging.m1354d(Camera2Session.TAG, "Camera device successfully started.");
        ...
        public /* synthetic */ void lambda$onConfigured$0(VideoFrame videoFrame) {
            ...
            if (Camera2Session.this.state != SessionState.RUNNING) {
                Logging.m1354d(Camera2Session.TAG, "Texture frame captured but camera is no longer running.");
                return;
            }
        ...
        private void chooseStabilizationMode(CaptureRequest.Builder builder) {
            ...
            if (iArr != null) {
                for (int i : iArr) {
                    if (i == 1) {
                        ...
                        Logging.m1354d(Camera2Session.TAG, "Using optical stabilization.");
                        return;
                    }
                }
            }
            for (int i2 : (int[]) Camera2Session.this.cameraCharacteristics.get(CameraCharacteristics.CONTROL_AVAILABLE_VIDEO_STABILIZATION_MODES)) {
                if (i2 == 1) {
                    ...
                    Logging.m1354d(Camera2Session.TAG, "Using video stabilization.");
                    return;
                }
            }
            Logging.m1354d(Camera2Session.TAG, "Stabilization not available.");
        }
        ...
        private void chooseFocusMode(CaptureRequest.Builder builder) {
            for (int i : (int[]) Camera2Session.this.cameraCharacteristics.get(CameraCharacteristics.CONTROL_AF_AVAILABLE_MODES)) {
                if (i == 3) {
                    ...
                    Logging.m1354d(Camera2Session.TAG, "Using continuous video auto-focus.");
                    return;
                }
            }
            Logging.m1354d(Camera2Session.TAG, "Auto-focus is not available.");
        }
    }

    private static class CameraCaptureCallback extends CameraCaptureSession.CaptureCallback {
        /* synthetic */ CameraCaptureCallback(Camera2SessionIA camera2SessionIA) {
            this();
        }
        ...
        public void onCaptureFailed(CameraCaptureSession cameraCaptureSession, CaptureRequest captureRequest, CaptureFailure captureFailure) {
            Logging.m1354d(Camera2Session.TAG, "Capture failed: " + captureFailure);
        }
    }
    ...
    private Camera2Session(CameraSession.CreateSessionCallback createSessionCallback, CameraSession.Events events, Context context, CameraManager cameraManager, SurfaceTextureHelper surfaceTextureHelper, String str, int i, int i2, int i3) {
        Logging.m1354d(TAG, "Create new camera2 session on camera " + str);
    ...
    private void findCaptureFormat() {
        ...
        Logging.m1354d(TAG, "Available preview sizes: " + supportedSizes);
        ...
        Logging.m1354d(TAG, "Using capture format: " + this.captureFormat);
    }

    private void openCamera() {
        checkIsOnCameraThread();
        Logging.m1354d(TAG, "Opening camera " + this.cameraId);
    ...
    public void stop() {
        Logging.m1354d(TAG, "Stop camera2 session on camera " + this.cameraId);
        checkIsOnCameraThread();
