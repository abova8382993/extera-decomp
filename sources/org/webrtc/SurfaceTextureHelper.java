...
public class SurfaceTextureHelper {
    ...
    public /* synthetic */ SurfaceTextureHelper(EglBase.Context context, Handler handler, boolean z, YuvConverter yuvConverter, FrameRefMonitor frameRefMonitor, SurfaceTextureHelperIA surfaceTextureHelperIA) {
    ...
    public static SurfaceTextureHelper create(String str, EglBase.Context context, boolean z, YuvConverter yuvConverter, FrameRefMonitor frameRefMonitor) {
        ...
        return (SurfaceTextureHelper) ThreadUtils.invokeAtFrontUninterruptibly(handler, new Callable<SurfaceTextureHelper>() { // from class: org.webrtc.SurfaceTextureHelper.1
            ...
            public CallableC76001(Handler handler2, boolean z2, YuvConverter yuvConverter2, FrameRefMonitor frameRefMonitor2, String str2) {
                handler = handler2;
                z = z2;
                yuvConverter = yuvConverter2;
                frameRefMonitor = frameRefMonitor2;
                str = str2;
            }
            ...
            public SurfaceTextureHelper call() {
                try {
                    ...
                    Logging.m1254e(SurfaceTextureHelper.TAG, str + " create failure", e);
                    return null;
                }
            }
        });
    ...
    public class CallableC76001 implements Callable<SurfaceTextureHelper> {
        final /* synthetic */ boolean val$alignTimestamps;
        final /* synthetic */ FrameRefMonitor val$frameRefMonitor;
        final /* synthetic */ Handler val$handler;
        final /* synthetic */ String val$threadName;
    ...
    public class C76012 implements TextureBufferImpl.RefCountMonitor {
        public C76012() {
        }
    ...
    public class RunnableC76023 implements Runnable {
        public RunnableC76023() {
        }

        @Override // java.lang.Runnable
        public void run() {
            Logging.m1252d(SurfaceTextureHelper.TAG, "Setting listener to " + SurfaceTextureHelper.this.pendingListener);
    ...
    private SurfaceTextureHelper(EglBase.Context context, Handler handler, boolean z, YuvConverter yuvConverter, FrameRefMonitor frameRefMonitor) {
        ...
        if (handler.getLooper().getThread() != Thread.currentThread()) {
            Segment$$ExternalSyntheticBUOutline1.m992m("SurfaceTextureHelper must be created on the handler thread");
            throw null;
        }
    ...
    public /* synthetic */ void lambda$new$0(SurfaceTexture surfaceTexture) {
        if (this.hasPendingTexture) {
            Logging.m1252d(TAG, "A frame is already pending, dropping frame.");
        }
    ...
    public void startListening(VideoSink videoSink) {
        if (this.listener != null || this.pendingListener != null) {
            Segment$$ExternalSyntheticBUOutline1.m992m("SurfaceTextureHelper listener has already been set.");
        } else {
    ...
    public void stopListening() {
        Logging.m1252d(TAG, "stopListening()");
    ...
    public void setTextureSize(final int i, final int i2) {
        if (i <= 0) {
            CharCodeKt$$ExternalSyntheticBUOutline0.m873m("Texture width must be positive, but was ", i);
        } else if (i2 <= 0) {
            CharCodeKt$$ExternalSyntheticBUOutline0.m873m("Texture height must be positive, but was ", i2);
        } else {
    ...
    private void tryDeliverTextureFrame() {
        ...
        if (this.textureWidth == 0 || this.textureHeight == 0) {
            Logging.m1256w(TAG, "Texture size has not been set.");
            return;
        }
    ...
    private void release() {
        ...
        if (this.isTextureInUse || !this.isQuitting) {
            Segment$$ExternalSyntheticBUOutline1.m992m("Unexpected release.");
            return;
        }
