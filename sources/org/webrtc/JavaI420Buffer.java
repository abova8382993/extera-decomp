...
public class JavaI420Buffer implements VideoFrame.I420Buffer {
    ...
    private static void checkCapacity(ByteBuffer byteBuffer, int i, int i2, int i3) {
        ...
        Dex$$ExternalSyntheticBUOutline1.m211m("Buffer must be at least ", i4, " bytes, but was ", byteBuffer.capacity());
    }
    ...
    public static JavaI420Buffer wrap(int i, int i2, ByteBuffer byteBuffer, int i3, ByteBuffer byteBuffer2, int i4, ByteBuffer byteBuffer3, int i5, Runnable runnable) {
        if (byteBuffer == null || byteBuffer2 == null || byteBuffer3 == null) {
            g$$ExternalSyntheticBUOutline1.m207m("Data buffers cannot be null.");
            return null;
        }
        if (!byteBuffer.isDirect() || !byteBuffer2.isDirect() || !byteBuffer3.isDirect()) {
            g$$ExternalSyntheticBUOutline1.m207m("Data buffers must be direct byte buffers.");
            return null;
        }
    ...
    public static JavaI420Buffer allocate(int i, int i2) {
        ...
        return new JavaI420Buffer(i, i2, byteBufferSlice, i, byteBufferSlice2, i4, byteBufferNativeAllocateByteBuffer.slice(), i4, new Runnable() { // from class: org.webrtc.JavaI420Buffer$$ExternalSyntheticLambda1
