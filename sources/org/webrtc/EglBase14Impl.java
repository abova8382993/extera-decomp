...
class EglBase14Impl implements EglBase14 {
    ...
    private void createSurfaceInternal(Object obj, boolean z) {
        if (!(obj instanceof Surface) && !(obj instanceof SurfaceTexture)) {
            Segment$$ExternalSyntheticBUOutline1.m992m("Input must be either a Surface or SurfaceTexture");
            return;
        }
        checkIsNotReleased();
        if (z) {
            ...
            Instance$$ExternalSyntheticBUOutline0.m1010m("Failed to create window surface: 0x", Integer.toHexString(EGL14.eglGetError()));
            return;
        }
