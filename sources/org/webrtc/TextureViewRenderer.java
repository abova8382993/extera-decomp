...
import org.telegram.p029ui.ActionBar.Theme$$ExternalSyntheticLambda9;
...
public class TextureViewRenderer extends TextureView implements TextureView.SurfaceTextureListener, VideoSink, RendererCommon.RendererEvents {
        ...
        if (LiteMode.isEnabled(512)) {
            ...
            if (textureView == null) {
                ...
                textureView.setSurfaceTextureListener(new TextureView.SurfaceTextureListener() { // from class: org.webrtc.TextureViewRenderer.1
                    ...
                    TextureViewSurfaceTextureListenerC75501() {
                    }
    ...
    class TextureViewSurfaceTextureListenerC75501 implements TextureView.SurfaceTextureListener {
        @Override // android.view.TextureView.SurfaceTextureListener
        public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i2) {
        }
    ...
    public void setIsCamera(boolean z) {
        ...
        C75512 c75512 = new OrientationHelper() { // from class: org.webrtc.TextureViewRenderer.2
            C75512() {
            }
        ...
        this.orientationHelper = c75512;
        c75512.start();
    }

    /* JADX INFO: renamed from: org.webrtc.TextureViewRenderer$2 */
    class C75512 extends OrientationHelper {
        C75512() {
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:85:0x0025 A[PHI: r0
  0x0025: PHI (r0v15 int) = (r0v5 int), (r0v17 int), (r0v20 int) binds: [B:111:0x005b, B:97:0x003b, B:84:0x0023] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:86:0x0027 A[PHI: r0
  0x0027: PHI (r0v8 int) = (r0v5 int), (r0v5 int), (r0v5 int), (r0v17 int), (r0v17 int), (r0v17 int), (r0v20 int) binds: [B:109:0x0057, B:110:0x0059, B:111:0x005b, B:95:0x0037, B:96:0x0039, B:97:0x003b, B:84:0x0023] A[DONT_GENERATE, DONT_INLINE]] */
    @Override // org.webrtc.RendererCommon.RendererEvents
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void onFrameResolutionChanged(final int r8, final int r9, int r10) throws java.lang.Throwable {
        /*
            r7 = this;
        ...
        L5e:
            ...
            java.lang.Object r10 = org.webrtc.TextureViewRenderer.TextureEglRenderer.m20966$$Nest$fgetlayoutLock(r10)
            monitor-enter(r10)
            java.lang.Runnable r0 = r7.updateScreenRunnable     // Catch: java.lang.Throwable -> L83
            if (r0 == 0) goto L71
            org.telegram.messenger.AndroidUtilities.cancelRunOnUIThread(r0)     // Catch: java.lang.Throwable -> L6d
            goto L71
        L6d:
            r0 = move-exception
            r8 = r0
            ...
            goto L86
        L71:
            org.webrtc.TextureViewRenderer$$ExternalSyntheticLambda0 r1 = new org.webrtc.TextureViewRenderer$$ExternalSyntheticLambda0     // Catch: java.lang.Throwable -> L83
            r2 = r7
            r3 = r8
            r4 = r9
            r1.<init>()     // Catch: java.lang.Throwable -> L80
            r2.updateScreenRunnable = r1     // Catch: java.lang.Throwable -> L80
            r7.postOrRun(r1)     // Catch: java.lang.Throwable -> L80
    ...
    private void logD(String str) {
        Logging.m1354d(TAG, this.resourceName + ": " + str);
    }
