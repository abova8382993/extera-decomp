...
public class Logging {
    ...
    public static void log(Severity severity, String str, String str2) {
        ...
        if (str == null || str2 == null) {
            g$$ExternalSyntheticBUOutline1.m207m("Logging tag or message may not be null.");
            return;
        }
        if (loggable != null) {
        ...
        int i = C75871.$SwitchMap$org$webrtc$Logging$Severity[severity.ordinal()];
        if (i == 1) {
            level = Level.SEVERE;
        } else if (i == 2) {
            level = Level.WARNING;
    ...
    public static /* synthetic */ class C75871 {
    ...
    public static void m1252d(String str, String str2) {
        log(Severity.LS_INFO, str, str2);
    }

    /* JADX INFO: renamed from: e */
    public static void m1253e(String str, String str2) {
        log(Severity.LS_ERROR, str, str2);
    }

    /* JADX INFO: renamed from: w */
    public static void m1256w(String str, String str2) {
        log(Severity.LS_WARNING, str, str2);
    }

    /* JADX INFO: renamed from: e */
    public static void m1254e(String str, String str2, Throwable th) {
    ...
    /* JADX INFO: renamed from: w */
    public static void m1257w(String str, String str2, Throwable th) {
    ...
    public static void m1255v(String str, String str2) {
