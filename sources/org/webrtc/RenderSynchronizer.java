...
public final class RenderSynchronizer {
    ...
    public void registerListener(Listener listener) {
        ...
        synchronized (this.lock) {
            try {
                if (!this.isListening) {
                    Logging.m1354d(TAG, "First listener, subscribing to frame callbacks");
        ...
        synchronized (this.lock) {
            try {
                if (this.listeners.isEmpty()) {
                    Logging.m1354d(TAG, "No listeners, unsubscribing to frame callbacks");
