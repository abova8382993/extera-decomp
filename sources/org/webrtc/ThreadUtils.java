...
public class ThreadUtils {
    ...
    public static void checkIsOnMainThread() {
        ...
        Segment$$ExternalSyntheticBUOutline1.m992m("Not on main thread!");
    }
        ...
        handler.post(new Runnable() { // from class: org.webrtc.ThreadUtils.3
            ...
            public void run() {
                try {
                    ...
                    c1CaughtException.f1874e = e2;
                }
                countDownLatch.countDown();
            }
        });
        awaitUninterruptibly(countDownLatch);
        Exception exc = c1CaughtException.f1874e;
        if (exc != null) {
            RuntimeException runtimeException = new RuntimeException(exc);
            runtimeException.setStackTrace(concatStackTraces(c1CaughtException.f1874e.getStackTrace(), runtimeException.getStackTrace()));
