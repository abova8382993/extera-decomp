...
public class MediaStreamTrack {
    ...
    public enum MediaType {
        ...
        public static MediaType fromNativeIndex(int i) {
            ...
            CharCodeKt$$ExternalSyntheticBUOutline0.m873m("Unknown native media type: ", i);
            return null;
        }
    }
    ...
    public MediaStreamTrack(long j) {
        if (j == 0) {
            g$$ExternalSyntheticBUOutline1.m207m("nativeTrack may not be null");
            throw null;
        }
        this.nativeTrack = j;
    }
    ...
    private void checkMediaStreamTrackExists() {
        ...
        Segment$$ExternalSyntheticBUOutline1.m992m("MediaStreamTrack has been disposed.");
    }
}
