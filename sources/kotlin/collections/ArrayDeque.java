...
public final class ArrayDeque<E> extends AbstractMutableList<E> {
    ...
    public ArrayDeque(int i) {
        ...
        if (i == 0) {
            ...
            CharCodeKt$$ExternalSyntheticBUOutline0.m873m("Illegal Capacity: ", i);
            throw null;
        }
    ...
    private final void ensureCapacity(int minCapacity) {
        if (minCapacity < 0) {
            Segment$$ExternalSyntheticBUOutline1.m992m("Deque is too big.");
            return;
        }
    ...
    public final E first() {
        ...
        UIntArray$Iterator$$ExternalSyntheticBUOutline0.m891m("ArrayDeque is empty.");
        return null;
    }
    ...
    public int lastIndexOf(Object element) {
        ...
        if (!isEmpty() && this.head >= iPositiveMod) {
            while (true) {
                ...
                Object[] objArr = this.elementData;
                if (-1 < iPositiveMod) {
                    if (Intrinsics.areEqual(element, objArr[iPositiveMod])) {
