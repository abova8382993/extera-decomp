...
public abstract class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    private static final Pair findAnyOf$StringsKt__StringsKt(CharSequence charSequence, Collection collection, int i, boolean z, boolean z2) {
        ...
        if (!z && collection.size() == 1) {
            ...
            return TuplesKt.m1081to(Integer.valueOf(iIndexOf$default), str);
        }
        CharSequence charSequence3 = charSequence;
            ...
            if ((step > 0 && first <= last) || (step < 0 && last <= first)) {
                ...
                while (true) {
                    ...
                    if (str3 == null) {
                        ...
                        return TuplesKt.m1081to(Integer.valueOf(i2), str3);
                    }
                }
            }
        } else {
            ...
            if ((step2 > 0 && first2 <= last2) || (step2 < 0 && last2 <= first2)) {
                ...
                while (true) {
                    ...
                    if (str5 == null) {
                        ...
                        return TuplesKt.m1081to(Integer.valueOf(i3), str5);
                    }
                }
            }
        }
    ...
    public static final Pair rangesDelimitedBy$lambda$0$StringsKt__StringsKt(char[] cArr, boolean z, CharSequence DelimitedRangesSequence, int i) {
        ...
        return TuplesKt.m1081to(Integer.valueOf(iIndexOfAny), 1);
    }
    ...
    public static final Pair rangesDelimitedBy$lambda$1$StringsKt__StringsKt(List list, boolean z, CharSequence DelimitedRangesSequence, int i) {
        Intrinsics.checkNotNullParameter(DelimitedRangesSequence, "$this$DelimitedRangesSequence");
        Pair pairFindAnyOf$StringsKt__StringsKt = findAnyOf$StringsKt__StringsKt(DelimitedRangesSequence, list, i, z, false);
        if (pairFindAnyOf$StringsKt__StringsKt != null) {
            return TuplesKt.m1081to(pairFindAnyOf$StringsKt__StringsKt.getFirst(), Integer.valueOf(((String) pairFindAnyOf$StringsKt__StringsKt.getSecond()).length()));
        }
        return null;
    }
