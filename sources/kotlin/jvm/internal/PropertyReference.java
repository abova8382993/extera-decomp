...
public abstract class PropertyReference extends CallableReference implements KProperty {
    ...
    public KProperty getReflected() {
        if (this.syntheticJavaProperty) {
            ByteString$$ExternalSyntheticBUOutline0.m979m("Kotlin reflection is not yet supported for synthetic Java properties. Please follow/upvote https://youtrack.jetbrains.com/issue/KT-55980");
            return null;
        }
