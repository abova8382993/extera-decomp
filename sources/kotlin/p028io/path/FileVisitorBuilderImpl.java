...
public final class FileVisitorBuilderImpl implements FileVisitorBuilder {
    ...
    @Override // kotlin.p028io.path.FileVisitorBuilder
    ...
    private final void checkIsNotBuilt() {
        if (this.isBuilt) {
            Segment$$ExternalSyntheticBUOutline1.m992m("This builder was already built");
        }
    }
