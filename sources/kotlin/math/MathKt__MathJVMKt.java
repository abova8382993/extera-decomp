...
public class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    public static final double asinh(double d) {
        ...
        if (d < d2) {
            ...
            return Math.abs(d) >= Constants.taylor_2_bound ? d - (((d * d) * d) / 6.0d) : d;
        }
    ...
    private static final double m933ln(double d) {
        return Math.log(d);
    }
    ...
    public static int roundToInt(double d) {
        if (Double.isNaN(d)) {
            g$$ExternalSyntheticBUOutline1.m207m("Cannot round NaN value.");
            return 0;
        }
        if (d > 2.147483647E9d) {
    ...
    @InlineOnly
    /* JADX INFO: renamed from: ln */
    private static final float m934ln(float f) {
