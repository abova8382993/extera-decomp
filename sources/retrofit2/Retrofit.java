...
public final class Retrofit {
    ...
    private void validateServiceInterface(Class<?> cls) {
        if (!cls.isInterface()) {
            g$$ExternalSyntheticBUOutline1.m207m("API declarations must be interfaces.");
            return;
        }
    ...
    public static final class Builder {
        ...
        public Builder baseUrl(HttpUrl httpUrl) {
            ...
            if (!_UrlKt.FRAGMENT_ENCODE_SET.equals(httpUrl.pathSegments().get(r0.size() - 1))) {
                Native$$ExternalSyntheticBUOutline5.m554m("baseUrl must end in /: ", httpUrl);
                return null;
            }
            this.baseUrl = httpUrl;
            return this;
        ...
        public Retrofit build() {
            if (this.baseUrl == null) {
                Segment$$ExternalSyntheticBUOutline1.m992m("Base URL required.");
                return null;
            }
