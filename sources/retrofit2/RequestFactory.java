...
final class RequestFactory {
    ...
    public Request create(@Nullable Object obj, Object[] objArr) {
        ...
        return requestBuilder.get().tag((Class<? super Invocation>) Invocation.class, new Invocation(this.service, obj, this.method, arrayList)).build();
    }
    ...
    public static final class Builder {
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i, Type type, Annotation[] annotationArr, Annotation annotation) {
            ...
            if (annotation instanceof Part) {
                ...
                Headers headersM955of = Headers.m955of("Content-Disposition", "form-data; name=\"" + strValue5 + "\"", "Content-Transfer-Encoding", part.encoding());
                if (Iterable.class.isAssignableFrom(rawType8)) {
                    if (!(type instanceof ParameterizedType)) {
                        throw Utils.parameterError(this.method, i, rawType8.getSimpleName() + " must include generic type (e.g., " + rawType8.getSimpleName() + "<String>)", new Object[0]);
                    }
                    ...
                    return new ParameterHandler.Part(this.method, i, headersM955of, this.retrofit.requestBodyConverter(parameterUpperBound4, annotationArr, this.methodAnnotations)).iterable();
                }
                if (rawType8.isArray()) {
                    ...
                    return new ParameterHandler.Part(this.method, i, headersM955of, this.retrofit.requestBodyConverter(clsBoxIfPrimitive, annotationArr, this.methodAnnotations)).array();
                }
                if (MultipartBody.Part.class.isAssignableFrom(rawType8)) {
                    throw Utils.parameterError(this.method, i, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                }
                return new ParameterHandler.Part(this.method, i, headersM955of, this.retrofit.requestBodyConverter(type, annotationArr, this.methodAnnotations));
            }
            ...
            validateResolvableType(i, type);
            Class<?> clsBoxIfPrimitive2 = boxIfPrimitive(Utils.getRawType(type));
            for (int i2 = i - 1; i2 >= 0; i2--) {
                ParameterHandler<?> parameterHandler = this.parameterHandlers[i2];
                if ((parameterHandler instanceof ParameterHandler.Tag) && ((ParameterHandler.Tag) parameterHandler).cls.equals(clsBoxIfPrimitive2)) {
                    throw Utils.parameterError(this.method, i, "@Tag type " + clsBoxIfPrimitive2.getName() + " is duplicate of " + Platform.reflection.describeMethodParameter(this.method, i2) + " and would always overwrite its value.", new Object[0]);
                }
            }
            return new ParameterHandler.Tag(clsBoxIfPrimitive2);
        }
