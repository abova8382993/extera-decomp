...
class SVGParser {
    ...
    public static class FontWeightKeywords {
        ...
        static {
            ...
            map.put("700", 700);
            map.put("800", 800);
            map.put("900", Integer.valueOf(RichMessageLayout.PART_MAX_HEIGHT_DP));
        }
    ...
    public SVG parse(InputStream inputStream, boolean z) {
    ...
    public class SAXHandler extends DefaultHandler2 {
        ...
        public /* synthetic */ SAXHandler(SVGParser sVGParser, C10241 c10241) {
            this();
        }
    ...
    public void startElement(String str, String str2, String str3, Attributes attributes) throws SVGParseException {
        ...
        if ("http://www.w3.org/2000/svg".equals(str) || _UrlKt.FRAGMENT_ENCODE_SET.equals(str)) {
            ...
            switch (C10241.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGElem[sVGElemFromString.ordinal()]) {
                case 1:
                    svg(attributes);
                    break;
                case 2:
    ...
    public void endElement(String str, String str2, String str3) {
        ...
        if ("http://www.w3.org/2000/svg".equals(str) || _UrlKt.FRAGMENT_ENCODE_SET.equals(str)) {
            ...
            int i2 = C10241.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGElem[SVGElem.fromString(str2).ordinal()];
    ...
    private void parseAttributesSVG(SVG.Svg svg, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            int i2 = C10241.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()];
            if (i2 == 1) {
                svg.f148x = parseLength(strTrim);
            } else if (i2 == 2) {
                svg.f149y = parseLength(strTrim);
            } else if (i2 == 3) {
                SVG.Length length = parseLength(strTrim);
                svg.width = length;
                if (length.isNegative()) {
                    SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid <svg> element. width cannot be negative");
                    return;
                }
            } else if (i2 == 4) {
                ...
                if (length2.isNegative()) {
                    SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid <svg> element. height cannot be negative");
                    return;
                }
            } else if (i2 == 5) {
                svg.version = strTrim;
    ...
    /* JADX INFO: renamed from: com.caverock.androidsvg.SVGParser$1 */
    ...
    private void m238g(Attributes attributes) throws SVGParseException {
        debug("<g>", new Object[0]);
        if (this.currentElement == null) {
            SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid document. Root element must be <svg>");
            return;
        }
    ...
    private void parseAttributesUse(SVG.Use use, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            int i2 = C10241.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()];
            if (i2 == 1) {
                use.f172x = parseLength(strTrim);
            } else if (i2 == 2) {
                use.f173y = parseLength(strTrim);
            } else if (i2 == 3) {
                SVG.Length length = parseLength(strTrim);
                use.width = length;
                if (length.isNegative()) {
                    SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid <use> element. width cannot be negative");
                    return;
                }
            } else if (i2 == 4) {
                SVG.Length length2 = parseLength(strTrim);
                use.height = length2;
                if (length2.isNegative()) {
                    SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid <use> element. height cannot be negative");
                    return;
                }
    ...
    private void parseAttributesImage(SVG.Image image, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            int i2 = C10241.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()];
            if (i2 == 1) {
                image.f133x = parseLength(strTrim);
            } else if (i2 == 2) {
                image.f134y = parseLength(strTrim);
            } else if (i2 == 3) {
                SVG.Length length = parseLength(strTrim);
                image.width = length;
                if (length.isNegative()) {
        ...
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            if (i2 == 8) {
                ...
                if (fValueOf.floatValue() < 0.0f) {
                    SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid <path> element. pathLength cannot be negative");
                    return;
                }
            }
        }
    ...
    private void parseAttributesRect(SVG.Rect rect, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            int i2 = C10241.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()];
            if (i2 == 1) {
                rect.f146x = parseLength(strTrim);
            } else if (i2 == 2) {
                rect.f147y = parseLength(strTrim);
            } else if (i2 == 3) {
                SVG.Length length = parseLength(strTrim);
                rect.width = length;
                if (length.isNegative()) {
                    SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid <rect> element. width cannot be negative");
                    return;
                }
            } else if (i2 == 4) {
                SVG.Length length2 = parseLength(strTrim);
                rect.height = length2;
                if (length2.isNegative()) {
                    SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid <rect> element. height cannot be negative");
                    return;
                }
            } else if (i2 == 10) {
                ...
                if (length3.isNegative()) {
                    SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid <rect> element. rx cannot be negative");
                    return;
                }
            } else if (i2 != 11) {
                continue;
                ...
                if (length4.isNegative()) {
                    SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid <rect> element. ry cannot be negative");
                    return;
                }
            }
        }
    ...
    private void parseAttributesCircle(SVG.Circle circle, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            String strTrim = attributes.getValue(i).trim();
            switch (C10241.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()]) {
                case 12:
                    circle.f126cx = parseLength(strTrim);
                    break;
                case 13:
                    circle.f127cy = parseLength(strTrim);
                    break;
                case 14:
                    SVG.Length length = parseLength(strTrim);
                    circle.f128r = length;
                    if (length.isNegative()) {
                        SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid <circle> element. r cannot be negative");
                        return;
                    }
                    break;
                    break;
    ...
    private void parseAttributesEllipse(SVG.Ellipse ellipse, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            switch (C10241.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()]) {
                case 10:
                    SVG.Length length = parseLength(strTrim);
                    ellipse.f131rx = length;
                    if (length.isNegative()) {
                        SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid <ellipse> element. rx cannot be negative");
                        return;
                    }
                    break;
                    break;
                case 11:
                    SVG.Length length2 = parseLength(strTrim);
                    ellipse.f132ry = length2;
                    if (length2.isNegative()) {
                        SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid <ellipse> element. ry cannot be negative");
                        return;
                    }
                    break;
                    break;
                case 12:
                    ellipse.f129cx = parseLength(strTrim);
                    break;
                case 13:
                    ellipse.f130cy = parseLength(strTrim);
                    break;
            }
        }
    }
    ...
    private void parseAttributesLine(SVG.Line line, Attributes attributes) {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            switch (C10241.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()]) {
                case 15:
                    line.f135x1 = parseLength(strTrim);
                    break;
                case 16:
                    line.f137y1 = parseLength(strTrim);
                    break;
                case 17:
                    line.f136x2 = parseLength(strTrim);
                    break;
                case 18:
                    line.f138y2 = parseLength(strTrim);
                    break;
            }
        }
    }
            ...
            if (SVGAttr.fromString(attributes.getLocalName(i)) == SVGAttr.points) {
                ...
                while (!textScanner.empty()) {
                    ...
                    if (Float.isNaN(fNextFloat)) {
                        SVGParser$$ExternalSyntheticBUOutline2.m241m("Invalid <", str, "> points attribute. Non-coordinate content found in list.");
                        return;
                    }
                    textScanner.skipCommaWhitespace();
                    float fNextFloat2 = textScanner.nextFloat();
                    if (Float.isNaN(fNextFloat2)) {
                        SVGParser$$ExternalSyntheticBUOutline2.m241m("Invalid <", str, "> points attribute. There should be an even number of coordinates.");
                        return;
                    } else {
                        textScanner.skipCommaWhitespace();
    ...
    private void parseAttributesTextPosition(SVG.TextPositionedContainer textPositionedContainer, Attributes attributes) {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            int i2 = C10241.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()];
            if (i2 == 1) {
                textPositionedContainer.f162x = parseLengthList(strTrim);
            } else if (i2 == 2) {
                textPositionedContainer.f163y = parseLengthList(strTrim);
            } else if (i2 == 19) {
                textPositionedContainer.f160dx = parseLengthList(strTrim);
            } else if (i2 == 20) {
                textPositionedContainer.f161dy = parseLengthList(strTrim);
            }
        }
    }
    ...
    private void tspan(Attributes attributes) throws SVGParseException {
        ...
        if (!(svgContainer instanceof SVG.TextContainer)) {
            SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid document. <tspan> elements are only valid inside <text> or other <tspan> elements.");
            return;
        }
    ...
    private void tref(Attributes attributes) throws SVGParseException {
        ...
        if (!(svgContainer instanceof SVG.TextContainer)) {
            SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid document. <tref> elements are only valid inside <text> or <tspan> elements.");
            return;
        }
    ...
    private void parseAttributesTRef(SVG.TRef tRef, Attributes attributes) {
        for (int i = 0; i < attributes.getLength(); i++) {
            String strTrim = attributes.getValue(i).trim();
            if (C10241.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()] == 6 && (_UrlKt.FRAGMENT_ENCODE_SET.equals(attributes.getURI(i)) || "http://www.w3.org/1999/xlink".equals(attributes.getURI(i)))) {
                tRef.href = strTrim;
            }
        }
    }
        ...
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            switch (C10241.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()]) {
                ...
                case 28:
                    ...
                    if (length.isNegative()) {
                        SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid <marker> element. markerWidth cannot be negative");
                        return;
                    }
                    break;
                    break;
                case 29:
                    ...
                    if (length2.isNegative()) {
                        SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid <marker> element. markerHeight cannot be negative");
                        return;
                    }
                    break;
                    break;
                case 30:
                    if ("strokeWidth".equals(strTrim)) {
                        ...
                        SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid value for attribute markerUnits");
                        return;
                    }
                    break;
                case 31:
    ...
    */
    private void parseAttributesGradient(com.caverock.androidsvg.SVG.GradientElement r5, org.xml.sax.Attributes r6) throws com.caverock.androidsvg.SVGParseException {
        ...
        L1:
            ...
            int[] r2 = com.caverock.androidsvg.SVGParser.C10241.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr
        ...
        L26:
            ...
            goto L79
        L2d:
            java.lang.String r4 = "Invalid spreadMethod attribute. \""
            java.lang.String r5 = "\" is not a valid value."
            com.caverock.androidsvg.SVGParser$$ExternalSyntheticBUOutline2.m241m(r4, r1, r5)
            return
        L35:
        ...
        L58:
            ...
            com.caverock.androidsvg.SVGParser$$ExternalSyntheticBUOutline1.m240m(r4)
            return
        L5e:
            java.lang.String r2 = ""
    ...
    private void parseAttributesLinearGradient(SVG.SvgLinearGradient svgLinearGradient, Attributes attributes) {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            switch (C10241.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()]) {
                case 15:
                    svgLinearGradient.f151x1 = parseLength(strTrim);
                    break;
                case 16:
                    svgLinearGradient.f153y1 = parseLength(strTrim);
                    break;
                case 17:
                    svgLinearGradient.f152x2 = parseLength(strTrim);
                    break;
                case 18:
                    svgLinearGradient.f154y2 = parseLength(strTrim);
                    break;
            }
        }
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void parseAttributesRadialGradient(com.caverock.androidsvg.SVG.SvgRadialGradient r4, org.xml.sax.Attributes r5) throws com.caverock.androidsvg.SVGParseException {
        /*
            r3 = this;
            r3 = 0
        L1:
            ...
            int[] r1 = com.caverock.androidsvg.SVGParser.C10241.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr
        ...
        L2a:
            goto L59
        L2b:
            com.caverock.androidsvg.SVG$Length r0 = parseLength(r0)
            r4.f159r = r0
            boolean r0 = r0.isNegative()
            if (r0 != 0) goto L38
            goto L59
        L38:
            java.lang.String r3 = "Invalid <radialGradient> element. r cannot be negative"
            com.caverock.androidsvg.SVGParser$$ExternalSyntheticBUOutline1.m240m(r3)
            return
        L3e:
            com.caverock.androidsvg.SVG$Length r0 = parseLength(r0)
            r4.f156cy = r0
    ...
    private void stop(Attributes attributes) throws SVGParseException {
        ...
        if (!(svgContainer instanceof SVG.GradientElement)) {
            SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid document. <stop> elements are only valid inside <linearGradient> or <radialGradient> elements.");
            return;
        }
    ...
    private void parseAttributesStop(SVG.Stop stop, Attributes attributes) {
        for (int i = 0; i < attributes.getLength(); i++) {
            String strTrim = attributes.getValue(i).trim();
            if (C10241.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()] == 37) {
    ...
    private Float parseGradientOffset(String str) throws SVGParseException {
        if (str.length() == 0) {
            SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid offset value in <stop> (empty string)");
            return null;
        }
        ...
        try {
            ...
            throw new SVGParseException("Invalid offset value in <stop>: ".concat(str), e);
        }
    }
    ...
    private void parseAttributesClipPath(SVG.ClipPath clipPath, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            String strTrim = attributes.getValue(i).trim();
            if (C10241.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()] == 38) {
                if ("objectBoundingBox".equals(strTrim)) {
                    clipPath.clipPathUnitsAreUser = Boolean.FALSE;
                } else if ("userSpaceOnUse".equals(strTrim)) {
                    clipPath.clipPathUnitsAreUser = Boolean.TRUE;
                } else {
                    SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid value for attribute clipPathUnits");
                    return;
                }
            }
        }
    ...
    */
    ...
    private void parseAttributesMask(SVG.Mask mask, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            int i2 = C10241.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()];
            if (i2 == 1) {
                mask.f139x = parseLength(strTrim);
            } else if (i2 == 2) {
                mask.f140y = parseLength(strTrim);
            } else if (i2 == 3) {
                SVG.Length length = parseLength(strTrim);
                mask.width = length;
                if (length.isNegative()) {
                    SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid <mask> element. width cannot be negative");
                    return;
                }
            } else if (i2 == 4) {
                SVG.Length length2 = parseLength(strTrim);
                mask.height = length2;
                if (length2.isNegative()) {
                    SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid <mask> element. height cannot be negative");
                    return;
                }
            } else if (i2 != 43) {
                if (i2 != 44) {
                    ...
                    SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid value for attribute maskContentUnits");
                    return;
                }
            } else if ("objectBoundingBox".equals(strTrim)) {
                ...
                SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid value for attribute maskUnits");
                return;
            }
        }
    }
    ...
    public static class TextScanner {
        ...
        public String nextTokenWithWhitespace(char c2) {
            return nextToken(c2, true);
        }

        public String nextToken(char c2, boolean z) {
            if (empty()) {
                return null;
            }
            char cCharAt = this.input.charAt(this.position);
            if ((!z && isWhitespace(cCharAt)) || cCharAt == c2) {
                return null;
            }
            int i = this.position;
            int iAdvanceChar = advanceChar();
            while (iAdvanceChar != -1 && iAdvanceChar != c2 && (z || !isWhitespace(iAdvanceChar))) {
    ...
    private void parseAttributesCore(SVG.SvgElementBase svgElementBase, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            if (qName.equals("id") || qName.equals("xml:id")) {
                svgElementBase.f150id = attributes.getValue(i).trim();
                return;
            }
            if (qName.equals("xml:space")) {
                ...
                if ("default".equals(strTrim)) {
                    ...
                    return;
                } else if ("preserve".equals(strTrim)) {
                    svgElementBase.spacePreserve = Boolean.TRUE;
                    return;
                } else {
                    SVGParser$$ExternalSyntheticBUOutline0.m239m("Invalid value for \"xml:space\" attribute: ", strTrim);
                    return;
                }
            }
        }
    ...
    public static void processStyleProperty(SVG.Style style, String str, String str2) {
        ...
        try {
            switch (C10241.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(str).ordinal()]) {
                case 47:
    ...
    private Matrix parseTransformList(String str) throws SVGParseException {
        ...
        while (!textScanner.empty()) {
            ...
            if (strNextFunction == null) {
                SVGParser$$ExternalSyntheticBUOutline0.m239m("Bad transform function encountered in transform list: ", str);
                return null;
            }
            switch (strNextFunction) {
                case "matrix":
                    ...
                    if (Float.isNaN(fNextFloat6) || !textScanner.consume(')')) {
                        SVGParser$$ExternalSyntheticBUOutline0.m239m("Invalid transform list: ", str);
                        return null;
                    }
                ...
                case "translate":
                    ...
                    break;
                default:
                    SVGParser$$ExternalSyntheticBUOutline2.m241m("Invalid transform list fn: ", strNextFunction, ")");
                    return null;
            }
    ...
    public static SVG.Length parseLength(String str) throws SVGParseException {
        if (str.length() == 0) {
            SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid length value (empty string)");
            return null;
        }
        int length = str.length();
    ...
    private static List<SVG.Length> parseLengthList(String str) throws SVGParseException {
        if (str.length() == 0) {
            SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid length list (empty string)");
            return null;
        }
    ...
    private static float parseFloat(String str) throws SVGParseException {
        int length = str.length();
        if (length == 0) {
            SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid float value (empty string)");
            return 0.0f;
        }
    ...
    private static float parseFloat(String str, int i, int i2) throws SVGParseException {
        ...
        SVGParser$$ExternalSyntheticBUOutline0.m239m("Invalid float value: ", str);
        return 0.0f;
    }
    ...
    private static SVG.Box parseViewBox(String str) throws SVGParseException {
        ...
        if (Float.isNaN(fNextFloat) || Float.isNaN(fNextFloat2) || Float.isNaN(fNextFloat3) || Float.isNaN(fNextFloat4)) {
            SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid viewBox definition - should have four numbers");
            return null;
        }
        if (fNextFloat3 < 0.0f) {
            SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid viewBox. width cannot be negative");
            return null;
        }
        if (fNextFloat4 < 0.0f) {
            SVGParser$$ExternalSyntheticBUOutline1.m240m("Invalid viewBox. height cannot be negative");
            return null;
        }
    ...
    public static PreserveAspectRatio parsePreserveAspectRatio(String str) throws SVGParseException {
        ...
        if (!textScanner.empty()) {
            ...
            if (strNextToken2.equals("meet")) {
                ...
                SVGParser$$ExternalSyntheticBUOutline0.m239m("Invalid preserveAspectRatio definition: ", str);
                return null;
            }
        }
    ...
    private static SVG.Colour parseColourKeyword(String str) throws SVGParseException {
        ...
        if (num == null) {
            SVGParser$$ExternalSyntheticBUOutline0.m239m("Invalid colour keyword: ", str);
            return null;
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:225:0x027b, code lost:
    ...
    /* JADX WARN: Removed duplicated region for block: B:239:0x0268 A[SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private static com.caverock.androidsvg.SVG.PathDefinition parsePath(java.lang.String r19) {
        /*
