...
class CSSParser {
        ...
        public String toString() {
            ...
            if (list != null) {
                for (Attrib attrib : list) {
                    ...
                    int i = C10211.$SwitchMap$com$caverock$androidsvg$CSSParser$AttribOp[attrib.operation.ordinal()];
                    if (i == 1) {
    ...
    public static class Selector {
        ...
        public /* synthetic */ Selector(C10211 c10211) {
            this();
        }
        ...
        public void addedIdAttribute() {
            this.specificity += DurationKt.NANOS_IN_MILLIS;
        }
    ...
    public static class CSSTextScanner extends SVGParser.TextScanner {
        ...
        public List<Selector> nextSelectorGroup() {
            ...
            Selector selector = new Selector(c10211);
            while (!empty() && nextSimpleSelector(selector)) {
                if (skipCommaWhitespace()) {
                    arrayList.add(selector);
                    selector = new Selector(c10211);
                }
            }
            if (!selector.isEmpty()) {
                arrayList.add(selector);
        ...
        */
        ...
        private void parsePseudoClass(Selector selector, SimpleSelector simpleSelector) throws CSSParseException {
            ...
            C10211 c10211 = null;
            switch (C10211.$SwitchMap$com$caverock$androidsvg$CSSParser$PseudoClassIdents[pseudoClassIdentsFromString.ordinal()]) {
                case 1:
                ...
                case 6:
                    ...
                    return;
                case 7:
                    PseudoClass pseudoClassRoot = new PseudoClassRoot(c10211);
                    selector.addedAttributeOrPseudo();
                    pseudoClass = pseudoClassRoot;
                    simpleSelector.addPseudo(pseudoClass);
                    return;
                case 8:
                    PseudoClass pseudoClassEmpty = new PseudoClassEmpty(c10211);
                    selector.addedAttributeOrPseudo();
                ...
                case 12:
                    ...
                    if (anPlusBNextAnPlusB == null) {
                        throw new CSSParseException("Invalid or missing parameter section for pseudo class: ".concat(strNextIdentifier));
                    }
                    pseudoClassAnPlusB = new PseudoClassAnPlusB(anPlusBNextAnPlusB.f121a, anPlusBNextAnPlusB.f122b, z, z2, simpleSelector.tag);
                    selector.addedAttributeOrPseudo();
                    pseudoClass = pseudoClassAnPlusB;
                    simpleSelector.addPseudo(pseudoClass);
                    return;
                case 13:
                    ...
                    return;
                case 14:
                    PseudoClass pseudoClassTarget = new PseudoClassTarget(c10211);
                    selector.addedAttributeOrPseudo();
                ...
                case 24:
                    ...
                    return;
                default:
                    throw new CSSParseException("Unsupported pseudo class: ".concat(strNextIdentifier));
            }
        }
    ...
    /* JADX INFO: renamed from: com.caverock.androidsvg.CSSParser$1 */
    ...
    public static class RuleMatchContext {
        ...
        public String toString() {
            ...
            if (svgElementBase != null) {
                return String.format("<%s id=\"%s\">", svgElementBase.getNodeName(), this.targetElement.f150id);
            }
            return _UrlKt.FRAGMENT_ENCODE_SET;
        }
    }
    ...
    private static boolean selectorMatch(RuleMatchContext ruleMatchContext, SimpleSelector simpleSelector, List<SVG.SvgContainer> list, int i, SVG.SvgElementBase svgElementBase) {
        ...
        if (list3 != null) {
            for (Attrib attrib : list3) {
                ...
                str2.getClass();
                if (str2.equals("id")) {
                    if (!attrib.value.equals(svgElementBase.f150id)) {
                        return false;
                    }
    ...
    public static class PseudoClassAnPlusB implements PseudoClass {
        ...
        public boolean matches(RuleMatchContext ruleMatchContext, SVG.SvgElementBase svgElementBase) {
            ...
            int i4 = this.f124a;
            int i5 = this.f125b;
            return i4 == 0 ? i3 == i5 : (i3 - i5) % i4 == 0 && (Integer.signum(i3 - i5) == 0 || Integer.signum(i3 - this.f125b) == Integer.signum(this.f124a));
        }
        ...
        public String toString() {
            ...
            int i = this.f124a;
            return z ? String.format("nth-%schild(%dn%+d of type <%s>)", str, Integer.valueOf(i), Integer.valueOf(this.f125b), this.nodeName) : String.format("nth-%schild(%dn%+d)", str, Integer.valueOf(i), Integer.valueOf(this.f125b));
        }
    }
    ...
    public static class PseudoClassRoot implements PseudoClass {
        ...
        public /* synthetic */ PseudoClassRoot(C10211 c10211) {
            this();
        }
    ...
    public static class PseudoClassEmpty implements PseudoClass {
        ...
        public /* synthetic */ PseudoClassEmpty(C10211 c10211) {
            this();
        }
    ...
    public static class PseudoClassTarget implements PseudoClass {
        ...
        public /* synthetic */ PseudoClassTarget(C10211 c10211) {
            this();
        }
