...
public final class Native implements Version {
    ...
    public static native long indexOf(Pointer pointer, long j, long j2, byte b2);
    ...
    public static native void setByte(Pointer pointer, long j, long j2, byte b2);

    public static native void setChar(Pointer pointer, long j, long j2, char c2);
    ...
    public static native void setMemory(Pointer pointer, long j, long j2, long j3, byte b2);
    ...
    static {
        ...
        C20601 c20601 = new Callback.UncaughtExceptionHandler() { // from class: com.sun.jna.Native.1
        ...
        DEFAULT_HANDLER = c20601;
        callbackExceptionHandler = c20601;
    ...
    /* JADX INFO: renamed from: com.sun.jna.Native$1 */
    public class C20601 implements Callback.UncaughtExceptionHandler {
        @Override // com.sun.jna.Callback.UncaughtExceptionHandler
        public void uncaughtException(Callback callback, Throwable th) {
            Native.LOG.log(Level.WARNING, "JNA: Callback " + callback + " threw the following exception", th);
        }
    ...
    /* JADX INFO: renamed from: com.sun.jna.Native$2 */
    public class C20612 {
        public void finalize() throws Throwable {
            Native.dispose();
            super.finalize();
    ...
    public static <T extends Library> T load(String str, Class<T> cls, Map<String, ?> map) {
        if (!Library.class.isAssignableFrom(cls)) {
            Native$$ExternalSyntheticBUOutline4.m553m("Interface (", cls.getSimpleName(), ") of library=", str, " does not extend ", Library.class.getSimpleName());
            return null;
        }
    ...
    private static void loadLibraryInstance(Class<?> cls) {
        ...
        try {
            ...
            Native$$ExternalSyntheticBUOutline3.m552m("Could not access instance of ", cls, " (", e, ")");
        }
    }
    ...
    public static Map<String, Object> getLibraryOptions(Class<?> cls) {
        ...
        try {
            ...
            Utils$$ExternalSyntheticBUOutline2.m1268m("OPTIONS must be a public field of type java.util.Map (", e, "): ", clsFindEnclosingLibraryClass);
            return null;
        }
        ...
        if (property2 != null) {
            ...
            while (stringTokenizer.hasMoreTokens()) {
                ...
                if (Platform.isMac()) {
                    ...
                    String strConcat = absolutePath.substring(0, absolutePath.lastIndexOf(str)).concat(str2);
                    Logger logger2 = LOG;
                    Level level2 = DEBUG_JNA_LOAD_LEVEL;
                    logger2.log(level2, "Looking in {0}", strConcat);
                    if (new File(strConcat).exists()) {
                        try {
                            logger2.log(level2, "Trying {0}", strConcat);
                            System.setProperty("jnidispatch.path", strConcat);
                            System.load(strConcat);
                            jnidispatchPath = strConcat;
                            logger2.log(level2, "Found jnidispatch at {0}", strConcat);
                            return;
                        } catch (UnsatisfiedLinkError e2) {
                            LOG.log(Level.WARNING, "File found at " + strConcat + " but not loadable: " + e2.getMessage(), (Throwable) e2);
                        }
                    } else {
                        continue;
                    }
    ...
    public static File extractFromResourcePath(String str, ClassLoader classLoader) throws Throwable {
        ...
        if (resource == null) {
            ...
            if (strSubstring.startsWith(str2)) {
                if (str2.startsWith("darwin")) {
                    resource = classLoader.getResource("darwin/".concat(strSubstring.substring(str2.length() + 1)));
                }
                if (resource == null) {
                ...
                if (strSubstring.startsWith("com/sun/jna/" + str2 + "/")) {
                    if (str2.startsWith("com/sun/jna/darwin")) {
                        resource = classLoader.getResource("com/sun/jna/darwin".concat(strSubstring.substring(("com/sun/jna/" + str2).length() + 1)));
                    }
                    if (resource == null) {
                        resource = classLoader.getResource(strMapSharedLibraryName);
                    }
        ...
        if (resource.getProtocol().toLowerCase().equals("file")) {
            ...
            Native$$ExternalSyntheticBUOutline1.m550m("File URL ", resource, " could not be properly decoded");
            return null;
        }
        if (!Boolean.getBoolean("jna.nounpack")) {
            ...
            try {
                if (inputStreamOpenStream == null) {
                    Model$$ExternalSyntheticBUOutline0.m1247m("Can't obtain InputStream for ".concat(strSubstring));
                } else {
                    try {
    ...
    public static Library synchronizedLibrary(Library library) {
        ...
        if (!Proxy.isProxyClass(cls)) {
            g$$ExternalSyntheticBUOutline1.m207m("Library must be a proxy class");
            return null;
        }
        InvocationHandler invocationHandler = Proxy.getInvocationHandler(library);
        if (!(invocationHandler instanceof Library.Handler)) {
            Native$$ExternalSyntheticBUOutline5.m554m("Unrecognized proxy handler: ", invocationHandler);
            return null;
        }
        return (Library) Proxy.newProxyInstance(cls.getClassLoader(), cls.getInterfaces(), new InvocationHandler() { // from class: com.sun.jna.Native.3
            ...
            public C20623(Library library2) {
                library = library2;
            }
    ...
    /* JADX INFO: renamed from: com.sun.jna.Native$3 */
    public class C20623 implements InvocationHandler {
        final /* synthetic */ Library val$library;
    ...
    /* JADX INFO: renamed from: com.sun.jna.Native$4 */
    public class C20634 implements PrivilegedAction<Method> {
        @Override // java.security.PrivilegedAction
        public Method run() {
            try {
                Method declaredMethod = ClassLoader.class.getDeclaredMethod("findLibrary", String.class);
    ...
    public static File getTempDir() throws IOException {
        ...
        if (!file.exists()) {
            Native$$ExternalSyntheticBUOutline1.m550m("JNA temporary directory '", file, "' does not exist");
            return null;
        }
        if (file.canWrite()) {
            return file;
        }
        Native$$ExternalSyntheticBUOutline1.m550m("JNA temporary directory '", file, "' is not writable");
        return null;
    }
    ...
    /* JADX INFO: renamed from: com.sun.jna.Native$5 */
    public class C20645 implements FilenameFilter {
        @Override // java.io.FilenameFilter
        public boolean accept(File file, String str) {
            return str.endsWith(".x") && str.startsWith(Native.JNA_TMPLIB_PREFIX);
        }
    ...
    public static int getNativeSize(Class<?> cls, Object obj) {
        if (cls.isArray()) {
            ...
            Native$$ExternalSyntheticBUOutline5.m554m("Arrays of length zero not allowed: ", cls);
            return 0;
        }
        ...
        try {
            ...
            Union$$ExternalSyntheticBUOutline0.m558m("The type \"", cls.getName(), "\" is not supported: ", e.getMessage());
            return 0;
        }
    }
    ...
    public static int getNativeSize(Class<?> cls) {
        ...
        Native$$ExternalSyntheticBUOutline2.m551m("Native size for type \"", cls.getName(), "\" is unknown");
        return 0;
    }
    ...
    public static Class<?> findDirectMappedClass(Class<?> cls) {
        ...
        Native$$ExternalSyntheticBUOutline0.m549m("Can't determine class with native methods from the current context (", cls, ")");
        return null;
    }
    ...
    public static Class<?> getCallingClass() {
        ...
        if (classContext == null) {
            Segment$$ExternalSyntheticBUOutline1.m992m("The SecurityManager implementation on this platform is broken; you must explicitly provide the class to register");
            return null;
        }
        if (classContext.length < 4) {
            Segment$$ExternalSyntheticBUOutline1.m992m("This method must be called from the static initializer of a class");
            return null;
        }
        return classContext[3];
    }

    /* JADX INFO: renamed from: com.sun.jna.Native$6 */
    public class C20656 extends SecurityManager {
        @Override // java.lang.SecurityManager
        public Class<?>[] getClassContext() {
            return super.getClassContext();
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:175:0x01a4 A[FALL_THROUGH] */
    /*
    ...
    */
    ...
    public static NativeLibrary getNativeLibrary(Library library) {
        if (library == null) {
            g$$ExternalSyntheticBUOutline1.m207m("null passed to getNativeLibrary");
            return null;
        }
        if (!Proxy.isProxyClass(library.getClass())) {
            g$$ExternalSyntheticBUOutline1.m207m("library object passed to getNativeLibrary in not a proxy");
            return null;
        }
        InvocationHandler invocationHandler = Proxy.getInvocationHandler(library);
        if (!(invocationHandler instanceof Library.Handler)) {
            g$$ExternalSyntheticBUOutline1.m207m("Object is not a properly initialized Library interface instance");
            return null;
        }
    ...
    public static void main(String[] strArr) {
        ...
        System.out.println("Version: ".concat(implementationVersion != null ? implementationVersion : "5.18.1 (package information missing)"));
    ...
    /* JADX INFO: renamed from: com.sun.jna.Native$7 */
    public class C20667 extends ThreadLocal<Memory> {
        @Override // java.lang.ThreadLocal
        public Memory initialValue() {
            Memory memory = new Memory(4L);
            memory.clear();
    ...
    public static class AWT {
        ...
        public static long getComponentID(Object obj) throws HeadlessException {
            ...
            if (component.isLightweight()) {
                g$$ExternalSyntheticBUOutline1.m207m("Component must be heavyweight");
                return 0L;
            }
            if (!component.isDisplayable()) {
                Segment$$ExternalSyntheticBUOutline1.m992m("Component must be displayable");
                return 0L;
            }
            if (Platform.isX11() && System.getProperty("java.version").startsWith("1.4") && !component.isVisible()) {
                Segment$$ExternalSyntheticBUOutline1.m992m("Component must be visible");
                return 0L;
            }
