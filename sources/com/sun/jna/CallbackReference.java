...
public class CallbackReference extends WeakReference<Callback> implements Closeable {
    ...
    private static Callback getCallback(Class<?> cls, Pointer pointer, boolean z) {
        ...
        if (!cls.isInterface()) {
            g$$ExternalSyntheticBUOutline1.m207m("Callback type must be an interface");
            return null;
        }
        ...
        if (z) {
            ...
            for (int i5 = 0; i5 < parameterTypes3.length; i5++) {
                ...
                if (!isAllowableNativeType(nativeType)) {
                    Native$$ExternalSyntheticBUOutline2.m551m("Callback argument ", parameterTypes3[i5], " requires custom type conversion");
                    throw null;
                }
            }
            Class<?> nativeType2 = getNativeType(returnType2);
            if (!isAllowableNativeType(nativeType2)) {
                Native$$ExternalSyntheticBUOutline2.m551m("Callback return type ", nativeType2, " requires custom type conversion");
                throw null;
            }
    ...
    public static Class<?> findCallbackClass(Class<?> cls) {
        if (!Callback.class.isAssignableFrom(cls)) {
            g$$ExternalSyntheticBUOutline1.m207m(cls.getName().concat(" is not derived from com.sun.jna.Callback"));
            return null;
        }
        if (!cls.isInterface()) {
    ...
    private static Method getCallbackMethod(Class<?> cls) {
        ...
        g$$ExternalSyntheticBUOutline1.m207m("Callback must implement a single public method, or one public method named 'callback'");
        return null;
    }
    ...
    public class DefaultCallbackProxy implements CallbackProxy {
        ...
        public DefaultCallbackProxy(Method method, TypeMapper typeMapper, String str) {
            ...
            try {
                ...
                Native$$ExternalSyntheticBUOutline5.m554m("Callback method is inaccessible, make sure the interface is public: ", method);
                throw null;
            }
        }
        ...
        public Object callback(Object[] objArr) {
            try {
                ...
                Native.getCallbackExceptionHandler().uncaughtException(this.getCallback(), th);
                return null;
            }
        }
