...
public class Function extends Pointer {
    ...
    public Function(NativeLibrary nativeLibrary, String str, int i, String str2) {
        ...
        if (str == null) {
            g$$ExternalSyntheticBUOutline2.m208m("Function name must not be null");
            throw null;
        }
        ...
        try {
            ...
            Function$$ExternalSyntheticBUOutline0.m546m("Error looking up function '", str, "': ", e.getMessage());
            throw null;
        }
    }
    ...
    public Function(Pointer pointer, int i, String str) {
        ...
        if (pointer == null || pointer.peer == 0) {
            g$$ExternalSyntheticBUOutline2.m208m("Function address may not be null");
            throw null;
        }
    ...
    private void checkCallingConvention(int i) {
        ...
        CharCodeKt$$ExternalSyntheticBUOutline0.m873m("Unrecognized calling convention: ", i);
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:124:0x0091 A[PHI: r2
  0x0091: PHI (r2v1 com.sun.jna.FromNativeConverter) = (r2v0 com.sun.jna.FromNativeConverter), (r2v14 com.sun.jna.FromNativeConverter) binds: [B:120:0x0084, B:122:0x008a] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        ...
        if (cls == WString.class) {
            ...
            if (cls == String[].class) {
                ...
                if (cls != Pointer[].class) {
                    ...
                    StringBuilder sb2 = new StringBuilder("Unsupported return type ");
                    sb2.append(cls);
                    Utils$$ExternalSyntheticBUOutline1.m1267m(sb2, " in function ", getName());
                    return null;
                }
    ...
    private Object convertArgument(Object[] objArr, int i, Method method, TypeMapper typeMapper, boolean z, Class<?> cls) {
        ...
        if (Structure[].class.isAssignableFrom(cls3)) {
            ...
            if (structureArr.length == 0) {
                g$$ExternalSyntheticBUOutline1.m207m("Structure array must have non-zero length");
                return null;
            }
        ...
        if (cls3.isArray()) {
            Buffer$$ExternalSyntheticBUOutline4.m978m("Unsupported array argument type: ", cls3.getComponentType());
            return null;
        }
