...
public class Pointer {
    ...
    public static final Pointer createConstant(int i) {
        return new Opaque(((long) i) & 4294967295L);
    }
    ...
    public long indexOf(long j, byte b2) {
        return Native.indexOf(this, this.peer, j, b2);
    }
    ...
    public Object getValue(long j, Class<?> cls, Object obj) {
        ...
        if (cls == WString.class) {
            ...
            if (pointer4 != null) {
                return new WString(pointer4.getWideString(0L));
            }
            return null;
        }
        ...
        if (Platform.HAS_BUFFERS && Buffer.class.isAssignableFrom(cls)) {
            ...
            Segment$$ExternalSyntheticBUOutline1.m992m("Can't autogenerate a direct buffer on memory read");
            return null;
        }
        ...
        if (!cls.isArray()) {
            Native$$ExternalSyntheticBUOutline0.m549m("Reading \"", cls, "\" from memory is not supported");
            return null;
        }
        if (obj == null) {
            Segment$$ExternalSyntheticBUOutline1.m992m("Need an initialized array");
            return null;
        }
    ...
    private void readArray(long j, Object obj, Class<?> cls) {
        ...
        Native$$ExternalSyntheticBUOutline0.m549m("Reading array of ", cls, " from memory not supported");
    }
    ...
    public void setValue(long j, Object obj, Class<?> cls) {
        ...
        if (NativeMapped.class.isAssignableFrom(cls)) {
            ...
            Native$$ExternalSyntheticBUOutline0.m549m("Writing ", cls, " to memory is not supported");
        }
    }
    ...
    private void writeArray(long j, Object obj, Class<?> cls) {
        ...
        Native$$ExternalSyntheticBUOutline0.m549m("Writing array of ", cls, " to memory not supported");
    }

    public void setMemory(long j, long j2, byte b2) {
        Native.setMemory(this, this.peer, j, j2, b2);
    }

    public void setByte(long j, byte b2) {
        Native.setByte(this, this.peer, j, b2);
    }
    ...
    public void setChar(long j, char c2) {
        Native.setChar(this, this.peer, j, c2);
    }
    ...
    public String dump(long j, int i) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            byte b2 = getByte(((long) i2) + j);
            int i3 = i2 % 4;
            if (i3 == 0) {
                printWriter.print("[");
            }
            if (b2 >= 0 && b2 < 16) {
                printWriter.print(MVEL.VERSION_SUB);
            }
            printWriter.print(Integer.toHexString(b2 & UByte.MAX_VALUE));
            if (i3 == 3 && i2 < i - 1) {
                printWriter.println("]");
            }
        }
    ...
    public static class Opaque extends Pointer {
        ...
        public /* synthetic */ Opaque(long j, C20701 c20701) {
            this(j);
        }
