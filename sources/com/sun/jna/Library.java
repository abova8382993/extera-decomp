    ...
    public static class Handler implements InvocationHandler {
        ...
        public Handler(String str, Class<?> cls, Map<String, ?> map) {
            if (str != null && _UrlKt.FRAGMENT_ENCODE_SET.equals(str.trim())) {
                Native$$ExternalSyntheticBUOutline0.m549m("Invalid library name \"", str, "\"");
                throw null;
            }
            if (!cls.isInterface()) {
                Library$Handler$$ExternalSyntheticBUOutline0.m548m(str, " does not implement an interface: ", cls.getName());
                throw null;
            }
