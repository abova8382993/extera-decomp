...
public class AudioSpecificConfig extends BaseDescriptor {
    ...
    static {
        ...
        samplingFrequencyIndexMap.put(8, Integer.valueOf(CarAudioRecord.AUDIO_CONTENT_SAMPLING_RATE));
    ...
    */
    public void parseDetail(java.nio.ByteBuffer r10) {
        /*
            Method dump skipped, instruction units count: 510
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.googlecode.mp4parser.boxes.mp4.objectdescriptors.AudioSpecificConfig.parseDetail(java.nio.ByteBuffer):void");
    }
    ...
    public int serializedSize() {
        ...
        ByteString$$ExternalSyntheticBUOutline0.m979m("can't serialize that yet");
        return 0;
    }

    public ByteBuffer serialize() {
        ByteBuffer byteBufferAllocate = ByteBuffer.allocate(serializedSize());
        IsoTypeWriter.writeUInt8(byteBufferAllocate, 5);
        IsoTypeWriter.writeUInt8(byteBufferAllocate, serializedSize() - 2);
        BitWriterBuffer bitWriterBuffer = new BitWriterBuffer(byteBufferAllocate);
    ...
    private void parseGaSpecificConfig(int i, int i2, int i3, BitReaderBuffer bitReaderBuffer) {
        ...
        if (i2 == 0) {
            ByteString$$ExternalSyntheticBUOutline0.m979m("can't parse program_config_element yet");
            return;
        }
        if (i3 == 6 || i3 == 20) {
