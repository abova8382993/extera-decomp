...
public class Polygon implements Serializable {
    ...
    public Polygon(LinearRing linearRing, List<LinearRing> list) {
        ...
        this.innerRings__is_initialized = false;
        if (linearRing == null) {
            g$$ExternalSyntheticBUOutline1.m207m("Required field \"outerRing\" cannot be null");
            throw null;
        }
        if (list == null) {
            g$$ExternalSyntheticBUOutline1.m207m("Required field \"innerRings\" cannot be null");
            throw null;
        }
