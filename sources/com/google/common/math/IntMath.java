...
public abstract class IntMath {
    ...
    static final int[] powersOf10 = {1, 10, 100, MediaDataController.MAX_STYLE_RUNS_COUNT, XCallback.PRIORITY_HIGHEST, AppDataDirGuesser.PER_USER_RANGE, 1000000, 10000000, 100000000, Http2Connection.DEGRADED_PONG_TIMEOUT_NS};
    ...
    public static int divide(int i, int i2, RoundingMode roundingMode) {
        ...
        int i5 = ((i ^ i2) >> 31) | 1;
        switch (C18121.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
