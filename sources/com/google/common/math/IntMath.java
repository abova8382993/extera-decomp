...
public abstract class IntMath {
    ...
    static final int[] powersOf10 = {1, 10, 100, MediaDataController.MAX_STYLE_RUNS_COUNT, XCallback.PRIORITY_HIGHEST, AppDataDirGuesser.PER_USER_RANGE, DurationKt.NANOS_IN_MILLIS, 10000000, 100000000, 1000000000};
    ...
    public static int log2(int i, RoundingMode roundingMode) {
        ...
        switch (C18461.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
