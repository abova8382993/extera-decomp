...
abstract class AbstractMapBasedMultimap<K, V> extends AbstractMultimap<K, V> implements Serializable {
    ...
    public class KeySet extends Maps.KeySet<K, Collection<V>> {
        ...
        public class C18311 implements Iterator<K> {
            Map.Entry<K, Collection<V>> entry;
            final /* synthetic */ KeySet this$1;
            final /* synthetic */ Iterator val$entryIterator;

            public C18311(KeySet keySet, Iterator it) {
                it = it;
                this.this$1 = keySet;
            }
        ...
        public Iterator<K> iterator() {
            return new Iterator<K>(this) { // from class: com.google.common.collect.AbstractMapBasedMultimap.KeySet.1
                ...
                public C18311(KeySet this, Iterator it) {
                    it = it;
                    this.this$1 = this;
                }
    ...
    public class C18291 extends AbstractMapBasedMultimap<K, V>.Itr<V> {
    ...
    public class C18302 extends AbstractMapBasedMultimap<K, V>.Itr<Map.Entry<K, V>> {
        public C18302() {
        }
