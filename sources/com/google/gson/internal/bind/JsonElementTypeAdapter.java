...
class JsonElementTypeAdapter extends TypeAdapter<JsonElement> {
    ...
    public static /* synthetic */ class C19961 {
    ...
    private JsonElement tryBeginNesting(JsonReader jsonReader, JsonToken jsonToken) throws IOException {
        int i = C19961.$SwitchMap$com$google$gson$stream$JsonToken[jsonToken.ordinal()];
        if (i == 1) {
    ...
    private JsonElement readTerminal(JsonReader jsonReader, JsonToken jsonToken) throws IOException {
        ...
        DexMaker$$ExternalSyntheticBUOutline0.m217m("Unexpected token: ", jsonToken);
        return null;
    }
    ...
    public void write(JsonWriter jsonWriter, JsonElement jsonElement) throws IOException {
        ...
        Buffer$$ExternalSyntheticBUOutline4.m978m("Couldn't write ", jsonElement.getClass());
    }
}
