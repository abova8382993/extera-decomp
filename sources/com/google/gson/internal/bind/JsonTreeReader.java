...
import androidx.recyclerview.widget.RecyclerView$$ExternalSyntheticBUOutline0;
...
public final class JsonTreeReader extends JsonReader {
    ...
    public class C19971 extends Reader {
        @Override // java.io.Reader
        public int read(char[] cArr, int i, int i2) {
            throw new AssertionError();
        }
    ...
    private void expect(JsonToken jsonToken) {
        ...
        sb.append(" but was ");
        sb.append(peek());
        RecyclerView$$ExternalSyntheticBUOutline0.m191m(sb, locationString());
    }
    ...
    public JsonElement nextJsonElement() throws MalformedJsonException {
        ...
        if (jsonTokenPeek == JsonToken.NAME || jsonTokenPeek == JsonToken.END_ARRAY || jsonTokenPeek == JsonToken.END_OBJECT || jsonTokenPeek == JsonToken.END_DOCUMENT) {
            LiveData$$ExternalSyntheticBUOutline0.m184m("Unexpected ", jsonTokenPeek, " when reading a JsonElement.");
            return null;
        }
    ...
    /* JADX INFO: loaded from: classes5.dex */
    public static /* synthetic */ class C19982 {
    ...
    public void skipValue() throws MalformedJsonException {
        int i = C19982.$SwitchMap$com$google$gson$stream$JsonToken[peek().ordinal()];
        if (i == 1) {
            nextName(true);
            return;
        }
