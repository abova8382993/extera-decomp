...
public final class JsonTreeWriter extends JsonWriter {
    ...
    public class C19991 extends Writer {
        @Override // java.io.Writer
        public void write(char[] cArr, int i, int i2) {
            throw new AssertionError();
        }
    ...
    public JsonElement get() {
        if (!this.stack.isEmpty()) {
            CstInsn$$ExternalSyntheticBUOutline0.m219m("Expected one JSON element but was ", this.stack);
            return null;
        }
        return this.product;
    }
    ...
    public JsonWriter name(String str) {
        ...
        if (this.stack.isEmpty() || this.pendingName != null) {
            Segment$$ExternalSyntheticBUOutline1.m992m("Did not expect a name");
            return null;
        }
        if (peek() instanceof JsonObject) {
    ...
    public JsonWriter value(Number number) {
        ...
        if (!isLenient()) {
            ...
            if (Double.isNaN(dDoubleValue) || Double.isInfinite(dDoubleValue)) {
                Native$$ExternalSyntheticBUOutline5.m554m("JSON forbids NaN and infinities: ", number);
                return null;
            }
        }
