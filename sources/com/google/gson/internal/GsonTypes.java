...
public abstract class GsonTypes {
    ...
    public static Class<?> getRawType(Type type) {
        ...
        Utils$$ExternalSyntheticBUOutline2.m1268m("Expected a Class, ParameterizedType, or GenericArrayType, but <", type, "> is of type ", type == null ? "null" : type.getClass().getName());
        return null;
    }
    ...
    */
    ...
    public static void checkNotPrimitive(Type type) {
        if ((type instanceof Class) && ((Class) type).isPrimitive()) {
            g$$ExternalSyntheticBUOutline1.m207m("Primitive type is not allowed");
        }
    }
    ...
    public static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        public ParameterizedTypeImpl(Type type, Class<?> cls, Type... typeArr) {
            ...
            if (type == null && GsonTypes.requiresOwnerType(cls)) {
                Native$$ExternalSyntheticBUOutline5.m554m("Must specify owner type for ", cls);
                throw null;
            }
    ...
    public static final class WildcardTypeImpl implements WildcardType, Serializable {
        ...
        public WildcardTypeImpl(Type[] typeArr, Type[] typeArr2) {
            if (typeArr2.length > 1) {
                g$$ExternalSyntheticBUOutline1.m207m("At most one lower bound is supported");
                throw null;
            }
            if (typeArr.length != 1) {
                g$$ExternalSyntheticBUOutline1.m207m("Exactly one upper bound must be specified");
                throw null;
            }
            if (typeArr2.length == 1) {
                ...
                if (typeArr[0] != Object.class) {
                    g$$ExternalSyntheticBUOutline1.m207m("When lower bound is specified, upper bound must be Object");
                    throw null;
                }
