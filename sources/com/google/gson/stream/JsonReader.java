...
public class JsonReader implements Closeable {
    ...
    public int doPeek() throws IOException {
        ...
        if (i2 == 1) {
            ...
            if (i2 == 4) {
                ...
                Segment$$ExternalSyntheticBUOutline1.m992m("JsonReader is closed");
                return 0;
            }
        }
    ...
    private int peekKeyword() {
        ...
        while (true) {
            ...
            if (i2 < length) {
                ...
                if (c3 != str.charAt(i2) && (!z || c3 != str2.charAt(i2))) {
                    break;
                }
                i2++;
            } else {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:165:0x0093, code lost:
        ...
        if (isLiteral(r14) != false) goto L188;
     */
    /* JADX WARN: Code restructure failed: missing block: B:188:0x00c8, code lost:
    ...
    */
    ...
    private boolean isLiteral(char c2) throws MalformedJsonException {
        if (c2 == '\t' || c2 == '\n' || c2 == '\f' || c2 == '\r' || c2 == ' ') {
            return false;
        }
        if (c2 != '#') {
    ...
    */
    ...
    private void skipQuotedValue(char c2) throws MalformedJsonException {
        char[] cArr = this.buffer;
        do {
            int i = this.pos;
            int i2 = this.limit;
    ...
    */
    private int nextNonWhitespace(boolean r9) throws java.io.IOException {
        ...
        L15:
            ...
            java.lang.String r8 = r8.locationString()
            java.lang.StringBuilder r0 = new java.lang.StringBuilder
        ...
        */
        ...
        L93:
            ...
            com.google.gson.stream.MalformedJsonException r8 = r8.syntaxError(r9)
            throw r8
        L9a:
            r1 = 35
            if (r5 != r1) goto Lac
            ...
            if (i < i2) {
                ...
                switch (i3) {
                    ...
                    case 8:
                        break;
                    default:
                        UseCase$$ExternalSyntheticBUOutline0.m85m("Unknown scope value: ", i3);
                        return null;
                }
                i++;
            } else {
    ...
    /* JADX INFO: renamed from: com.google.gson.stream.JsonReader$1 */
    public class C20461 extends JsonReaderInternalAccess {
        @Override // com.google.gson.internal.JsonReaderInternalAccess
        public void promoteNameToValue(JsonReader jsonReader) throws IOException {
            if (jsonReader instanceof JsonTreeReader) {
                ((JsonTreeReader) jsonReader).promoteNameToValue();
