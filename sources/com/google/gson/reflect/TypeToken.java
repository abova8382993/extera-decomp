...
public class TypeToken<T> {
    ...
    private Type getTypeTokenTypeArgument() {
        ...
        if (genericSuperclass instanceof ParameterizedType) {
            ...
            CstInsn$$ExternalSyntheticBUOutline0.m219m("TypeToken must be created with a type argument: new TypeToken<...>() {}; When using code shrinkers (ProGuard, R8, ...) make sure that generic signatures are preserved.\nSee ", TroubleshootingGuide.createUrl("type-token-raw"));
            return null;
        }
        Segment$$ExternalSyntheticBUOutline1.m992m("Must only create direct subclasses of TypeToken");
        return null;
    }
    ...
    private static void verifyNoTypeVariable(Type type) {
        ...
        if (!(type instanceof WildcardType)) {
            ...
            g$$ExternalSyntheticBUOutline1.m207m("TypeToken captured `null` as type argument; probably a compiler / runtime bug");
            return;
        }
    ...
    public static TypeToken<?> getParameterized(Type type, Type... typeArr) {
        ...
        if (!(type instanceof Class)) {
            Native$$ExternalSyntheticBUOutline5.m554m("rawType must be of type Class, but was ", type);
            return null;
        }
        ...
        if (GsonTypes.requiresOwnerType(type)) {
            Native$$ExternalSyntheticBUOutline2.m551m("Raw type ", cls.getName(), " is not supported because it requires specifying an owner type");
            return null;
        }
