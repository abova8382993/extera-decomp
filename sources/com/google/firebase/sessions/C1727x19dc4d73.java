...
public final class C1727x19dc4d73 implements Factory {
    private final Provider firebaseAppProvider;

    public C1727x19dc4d73(Provider provider) {
    ...
    public static C1727x19dc4d73 create(Provider provider) {
        return new C1727x19dc4d73(provider);
    }
