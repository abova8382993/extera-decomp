...
public abstract class DaggerFirebaseSessionsComponent {
    ...
    public static final class FirebaseSessionsComponentImpl implements FirebaseSessionsComponent {
        ...
        private void initialize(Context context, CoroutineContext coroutineContext, CoroutineContext coroutineContext2, FirebaseApp firebaseApp, FirebaseInstallationsApi firebaseInstallationsApi, Provider<TransportFactory> provider) {
            ...
            this.timeProvider = DoubleCheck.provider(C1946x7ce4ac45.create());
            this.firebaseInstallationsApiProvider = InstanceFactory.create(firebaseInstallationsApi);
            this.applicationInfoProvider = DoubleCheck.provider(C1943x19dc4d73.create(this.firebaseAppProvider));
            ...
            com.google.firebase.sessions.dagger.internal.Provider<DataStore<SessionConfigs>> provider2 = DoubleCheck.provider(C1944x884ab35.create(this.appContextProvider, this.blockingDispatcherProvider));
            ...
            com.google.firebase.sessions.dagger.internal.Provider<UuidGenerator> provider5 = DoubleCheck.provider(C1947x6dacf2b9.create());
            ...
            this.sessionDataStoreProvider = DoubleCheck.provider(C1945xa7e684e2.create(this.appContextProvider, this.blockingDispatcherProvider, provider7));
