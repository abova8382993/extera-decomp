    ...
    */
    private void handleNotifications(java.io.InputStream r11) throws java.io.IOException {
        ...
        L34:
            ...
            boolean r4 = r5.has(r2)     // Catch: org.json.JSONException -> L54
            if (r4 == 0) goto L56
            boolean r4 = r5.getBoolean(r2)     // Catch: org.json.JSONException -> L54
            if (r4 == 0) goto L56
            com.google.firebase.remoteconfig.ConfigUpdateListener r4 = r10.retryCallback     // Catch: org.json.JSONException -> L54
            com.google.firebase.remoteconfig.FirebaseRemoteConfigServerException r5 = new com.google.firebase.remoteconfig.FirebaseRemoteConfigServerException     // Catch: org.json.JSONException -> L54
            java.lang.String r6 = "The server is temporarily unavailable. Try again in a few minutes."
            com.google.firebase.remoteconfig.FirebaseRemoteConfigException$Code r7 = com.google.firebase.remoteconfig.FirebaseRemoteConfigException.Code.CONFIG_UPDATE_UNAVAILABLE     // Catch: org.json.JSONException -> L54
            r5.<init>(r6, r7)     // Catch: org.json.JSONException -> L54
            r4.onError(r5)     // Catch: org.json.JSONException -> L54
            goto L9c
        L54:
            r4 = move-exception
            goto L83
        L56:
            boolean r4 = r10.isEventListenersEmpty()     // Catch: org.json.JSONException -> L54
            if (r4 == 0) goto L5d
            goto L9c
        L5d:
            boolean r4 = r5.has(r1)     // Catch: org.json.JSONException -> L54
            if (r4 == 0) goto L75
            com.google.firebase.remoteconfig.internal.ConfigFetchHandler r4 = r10.configFetchHandler     // Catch: org.json.JSONException -> L54
            long r6 = r4.getTemplateVersionNumber()     // Catch: org.json.JSONException -> L54
            long r8 = r5.getLong(r1)     // Catch: org.json.JSONException -> L54
            int r4 = (r8 > r6 ? 1 : (r8 == r6 ? 0 : -1))
            if (r4 <= 0) goto L75
            r4 = 3
            r10.autoFetch(r4, r8)     // Catch: org.json.JSONException -> L54
        L75:
            boolean r4 = r5.has(r0)     // Catch: org.json.JSONException -> L54
            if (r4 == 0) goto L15
            int r4 = r5.getInt(r0)     // Catch: org.json.JSONException -> L54
            r10.updateBackoffMetadataWithRetryInterval(r4)     // Catch: org.json.JSONException -> L54
            goto L15
        L83:
            ...
            try {
                ...
                return Tasks.whenAllComplete((Task<?>[]) new Task[]{taskFetchNowWithTypeAndAttemptNumber, task}).continueWithTask(this.scheduledExecutorService, new Continuation() { // from class: com.google.firebase.remoteconfig.internal.ConfigAutoFetch$$ExternalSyntheticLambda0
                    ...
                    public final Object then(Task task2) {
                        return ConfigAutoFetch.m3450$r8$lambda$ANmcpkzunHxZeIZpnwJj9GhHSM(this.f$0, taskFetchNowWithTypeAndAttemptNumber, task, j, i2, task2);
                    }
                });
            } catch (Throwable th) {
                th = th;
    ...
    public static /* synthetic */ Task m3450$r8$lambda$ANmcpkzunHxZeIZpnwJj9GhHSM(ConfigAutoFetch configAutoFetch, Task task, Task task2, long j, int i, Task task3) throws JSONException {
