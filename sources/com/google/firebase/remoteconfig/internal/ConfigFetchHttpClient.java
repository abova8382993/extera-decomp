...
public class ConfigFetchHttpClient {
    ...
    @Keep
    ConfigFetchHandler.FetchResponse fetch(HttpURLConnection httpURLConnection, String str, String str2, Map<String, String> map, String str3, Map<String, String> map2, Long l, Date date, Map<String, String> map3) {
    ...
    private JSONObject createFetchRequestBody(String str, String str2, Map map, Long l, Map map2) throws FirebaseRemoteConfigClientException {
