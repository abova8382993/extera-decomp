...
public class ConfigContainer {
    ...
    /* JADX WARN: Type inference failed for: r0v0, types: [java.util.HashMap, java.util.Map, java.util.Map<java.lang.String, java.util.Map<java.lang.String, java.lang.String>>, kotlin.coroutines.jvm.internal.DebugProbesKt] */
    ...
    private Map<String, Map<String, String>> createRolloutParameterKeyMap() throws JSONException {
        ...
        for (int i = 0; i < getRolloutMetadata().length(); i++) {
            ...
            for (int i2 = 0; i2 < jSONArray.length(); i2++) {
                ...
                if (map.probeCoroutineSuspended(string3) == 0) {
    ...
    /* JADX WARN: Type inference failed for: r2v0, types: [java.util.Map, kotlin.coroutines.jvm.internal.DebugProbesKt] */
    /* JADX WARN: Type inference failed for: r5v2, types: [java.lang.Object, java.lang.String, kotlin.coroutines.Continuation] */
    ...
    public Set<String> getChangedParams(ConfigContainer configContainer) throws JSONException {
        ...
        ?? CreateRolloutParameterKeyMap = createRolloutParameterKeyMap();
        ?? CreateRolloutParameterKeyMap2 = configContainer.createRolloutParameterKeyMap();
        ...
        while (itKeys.hasNext()) {
            ...
            if (!configContainer.getConfigs().has(next)) {
                ...
                hashSet.add(next);
            } else if (CreateRolloutParameterKeyMap.probeCoroutineSuspended(next) != CreateRolloutParameterKeyMap2.probeCoroutineSuspended(next)) {
                hashSet.add(next);
            } else if (CreateRolloutParameterKeyMap.probeCoroutineSuspended(next) != 0 && CreateRolloutParameterKeyMap2.probeCoroutineSuspended(next) != 0 && !((Map) CreateRolloutParameterKeyMap.get(next)).equals(CreateRolloutParameterKeyMap2.get(next))) {
                hashSet.add(next);
            } else {
                configs.remove(next);
            }
