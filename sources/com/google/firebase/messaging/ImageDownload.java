...
public class ImageDownload implements Closeable {
    ...
    public Bitmap blockingDownload() throws IOException {
        ...
        if (bitmapDecodeByteArray == null) {
            ZipFilesKt$$ExternalSyntheticBUOutline1.m999m("Failed to decode image: ", this.url);
            return null;
        }
    ...
    private byte[] blockingDownloadBytes() throws IOException {
        ...
        if (uRLConnectionOpenConnection.getContentLength() > 1048576) {
            Model$$ExternalSyntheticBUOutline0.m1247m("Content-Length exceeds max size of 1048576");
            return null;
        }
        ...
        try {
            ...
            Model$$ExternalSyntheticBUOutline0.m1247m("Image exceeds max size of 1048576");
            return null;
        } catch (Throwable th) {
            if (inputStream != null) {
                try {
