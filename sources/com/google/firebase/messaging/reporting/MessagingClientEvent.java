...
public final class MessagingClientEvent {
    ...
    public static final class Builder {
        ...
        private String message_id_ = _UrlKt.FRAGMENT_ENCODE_SET;
        private String instance_id_ = _UrlKt.FRAGMENT_ENCODE_SET;
        private MessageType message_type_ = MessageType.UNKNOWN;
        private SDKPlatform sdk_platform_ = SDKPlatform.UNKNOWN_OS;
        private String package_name_ = _UrlKt.FRAGMENT_ENCODE_SET;
        private String collapse_key_ = _UrlKt.FRAGMENT_ENCODE_SET;
        private int priority_ = 0;
        private int ttl_ = 0;
        private String topic_ = _UrlKt.FRAGMENT_ENCODE_SET;
        private long bulk_id_ = 0;
        private Event event_ = Event.UNKNOWN_EVENT;
        private String analytics_label_ = _UrlKt.FRAGMENT_ENCODE_SET;
        private long campaign_id_ = 0;
        private String composer_label_ = _UrlKt.FRAGMENT_ENCODE_SET;
