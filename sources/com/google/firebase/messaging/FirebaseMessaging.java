...
public class FirebaseMessaging {
    ...
    private void handleProxiedNotificationData() {
        this.gmsRpc.getProxyNotificationData().addOnSuccessListener(this.initExecutor, new OnSuccessListener() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda6
            @Override // com.google.android.gms.tasks.OnSuccessListener
            public final void onSuccess(Object obj) {
                FirebaseMessaging.m3442$r8$lambda$OcHVRAfKigQNKnoW0h_KJWqi8(this.f$0, (CloudMessage) obj);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$Oc-HVRAfKigQNKnoW0h_K-JWqi8 */
    public static /* synthetic */ void m3442$r8$lambda$OcHVRAfKigQNKnoW0h_KJWqi8(FirebaseMessaging firebaseMessaging, CloudMessage cloudMessage) {
    ...
    public Task<String> getToken() {
        ...
        this.initExecutor.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                FirebaseMessaging.m3441$r8$lambda$BDlJxll8ZplUMRagiuAzBf5hpo(this.f$0, taskCompletionSource);
            }
        });
    ...
    public static /* synthetic */ void m3441$r8$lambda$BDlJxll8ZplUMRagiuAzBf5hpo(FirebaseMessaging firebaseMessaging, TaskCompletionSource taskCompletionSource) {
        firebaseMessaging.getClass();
        try {
