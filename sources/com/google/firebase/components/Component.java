...
public final class Component<T> {
    ...
    public /* synthetic */ Component(String str, Set set, Set set2, int i, int i2, ComponentFactory componentFactory, Set set3, C18611 c18611) {
    ...
    public static <T> Component<T> m527of(final T t, Class<T> cls, Class<? super T>... clsArr) {
        return builder(cls, clsArr).factory(new ComponentFactory() { // from class: com.google.firebase.components.Component$$ExternalSyntheticLambda1
            ...
            public final Object create(ComponentContainer componentContainer) {
                return Component.$r8$lambda$1XnijlikLlzJWfIqLOXy2V5iuHw(t, componentContainer);
            }
        }).build();
    }
    ...
    public static <T> Component<T> intoSet(final T t, Class<T> cls) {
        return intoSetBuilder(cls).factory(new ComponentFactory() { // from class: com.google.firebase.components.Component$$ExternalSyntheticLambda0
            @Override // com.google.firebase.components.ComponentFactory
            public final Object create(ComponentContainer componentContainer) {
                return Component.$r8$lambda$OZ0j4a0bDeW_qgAe4WJTrUMuxVw(t, componentContainer);
            }
        }).build();
    }
    ...
    public static class Builder<T> {
        ...
        public /* synthetic */ Builder(Qualified qualified, Qualified[] qualifiedArr, C18611 c18611) {
            this(qualified, qualifiedArr);
        }

        public /* synthetic */ Builder(Class cls, Class[] clsArr, C18611 c18611) {
            this(cls, clsArr);
        }
