...
final class AutoValue_StaticSessionData_AppData extends StaticSessionData.AppData {
    ...
    public AutoValue_StaticSessionData_AppData(String str, String str2, String str3, String str4, int i, DevelopmentPlatformProvider developmentPlatformProvider) {
        if (str == null) {
            g$$ExternalSyntheticBUOutline2.m208m("Null appIdentifier");
            throw null;
        }
        this.appIdentifier = str;
        if (str2 == null) {
            g$$ExternalSyntheticBUOutline2.m208m("Null versionCode");
            throw null;
        }
        this.versionCode = str2;
        if (str3 == null) {
            g$$ExternalSyntheticBUOutline2.m208m("Null versionName");
            throw null;
        }
        this.versionName = str3;
        if (str4 == null) {
            g$$ExternalSyntheticBUOutline2.m208m("Null installUuid");
            throw null;
        }
        this.installUuid = str4;
        this.deliveryMechanism = i;
        if (developmentPlatformProvider == null) {
            g$$ExternalSyntheticBUOutline2.m208m("Null developmentPlatformProvider");
            throw null;
        }
