...
final class C1900x7c929f5b extends CrashlyticsReport.Session.Event.Application.Execution.Signal {
    private final long address;
    private final String code;
    private final String name;

    private C1900x7c929f5b(String str, String str2, long j) {
        this.name = str;
        this.code = str2;
        this.address = j;
    }
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Signal.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Signal.Builder setCode(String str) {
            if (str == null) {
                g$$ExternalSyntheticBUOutline2.m208m("Null code");
                return null;
            }
            this.code = str;
            return this;
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Signal build() {
            ...
            return new C1900x7c929f5b(str, str2, this.address);
        }
    }
}
