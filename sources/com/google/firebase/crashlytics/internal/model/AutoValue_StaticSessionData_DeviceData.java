...
final class AutoValue_StaticSessionData_DeviceData extends StaticSessionData.DeviceData {
    ...
    public AutoValue_StaticSessionData_DeviceData(int i, String str, int i2, long j, long j2, boolean z, int i3, String str2, String str3) {
        this.arch = i;
        if (str == null) {
            g$$ExternalSyntheticBUOutline2.m208m("Null model");
            throw null;
        }
        this.model = str;
        ...
        this.state = i3;
        if (str2 == null) {
            g$$ExternalSyntheticBUOutline2.m208m("Null manufacturer");
            throw null;
        }
        this.manufacturer = str2;
        if (str3 == null) {
            g$$ExternalSyntheticBUOutline2.m208m("Null modelClass");
            throw null;
        }
