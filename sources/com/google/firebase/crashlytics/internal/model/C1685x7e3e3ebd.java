...
final class C1685x7e3e3ebd extends CrashlyticsReport.Session.Event.Application.Execution.Thread {
    private final List frames;
    private final int importance;
    private final String name;

    private C1685x7e3e3ebd(String str, int i, List list) {
        this.name = str;
        this.importance = i;
        this.frames = list;
    }
    ...
    static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Thread.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Thread build() {
            ...
            return new C1685x7e3e3ebd(str, this.importance, list);
        }
    }
}
