...
final class AutoValue_CrashlyticsReport_Session extends CrashlyticsReport.Session {
    ...
    private final CrashlyticsReport.Session.OperatingSystem f633os;
    ...
    public String toString() {
        return "Session{generator=" + this.generator + ", identifier=" + this.identifier + ", appQualitySessionId=" + this.appQualitySessionId + ", startedAt=" + this.startedAt + ", endedAt=" + this.endedAt + ", crashed=" + this.crashed + ", app=" + this.app + ", user=" + this.user + ", os=" + this.f633os + ", device=" + this.device + ", events=" + this.events + ", generatorType=" + this.generatorType + "}";
    }
    ...
    public int hashCode() {
        ...
        CrashlyticsReport.Session.OperatingSystem operatingSystem = this.f633os;
    ...
    public static final class Builder extends CrashlyticsReport.Session.Builder {
        ...
        /* JADX INFO: renamed from: os */
        private CrashlyticsReport.Session.OperatingSystem f634os;
        private byte set$0;
        ...
        public CrashlyticsReport.Session.Builder setGenerator(String str) {
            if (str == null) {
                g$$ExternalSyntheticBUOutline2.m208m("Null generator");
                return null;
            }
            this.generator = str;
            return this;
        ...
        public CrashlyticsReport.Session.Builder setIdentifier(String str) {
            if (str == null) {
                g$$ExternalSyntheticBUOutline2.m208m("Null identifier");
                return null;
            }
            this.identifier = str;
            return this;
        ...
        public CrashlyticsReport.Session.Builder setApp(CrashlyticsReport.Session.Application application) {
            if (application == null) {
                g$$ExternalSyntheticBUOutline2.m208m("Null app");
                return null;
            }
            this.app = application;
            return this;
        ...
        public CrashlyticsReport.Session build() {
            ...
            return new AutoValue_CrashlyticsReport_Session(str, str2, this.appQualitySessionId, this.startedAt, this.endedAt, this.crashed, application, this.user, this.f634os, this.device, this.events, this.generatorType);
        }
    }
}
