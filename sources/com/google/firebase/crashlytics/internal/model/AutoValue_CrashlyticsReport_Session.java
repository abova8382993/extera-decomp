...
final class AutoValue_CrashlyticsReport_Session extends CrashlyticsReport.Session {
    ...
    private final CrashlyticsReport.Session.OperatingSystem f580os;
    ...
    public String toString() {
        return "Session{generator=" + this.generator + ", identifier=" + this.identifier + ", appQualitySessionId=" + this.appQualitySessionId + ", startedAt=" + this.startedAt + ", endedAt=" + this.endedAt + ", crashed=" + this.crashed + ", app=" + this.app + ", user=" + this.user + ", os=" + this.f580os + ", device=" + this.device + ", events=" + this.events + ", generatorType=" + this.generatorType + "}";
    }
    ...
    public int hashCode() {
        ...
        CrashlyticsReport.Session.OperatingSystem operatingSystem = this.f580os;
    ...
    static final class Builder extends CrashlyticsReport.Session.Builder {
        ...
        /* JADX INFO: renamed from: os */
        private CrashlyticsReport.Session.OperatingSystem f581os;
        private byte set$0;
        ...
        public CrashlyticsReport.Session build() {
            ...
            return new AutoValue_CrashlyticsReport_Session(str, str2, this.appQualitySessionId, this.startedAt, this.endedAt, this.crashed, application, this.user, this.f581os, this.device, this.events, this.generatorType);
        }
    }
}
