...
public class UserMetadata {
        ...
        synchronized (this.sessionIdentifier) {
            ...
            this.crashlyticsWorkers.diskWrite.submit(new Runnable() { // from class: com.google.firebase.crashlytics.internal.metadata.UserMetadata$$ExternalSyntheticLambda0
                ...
                public final void run() throws Throwable {
                    UserMetadata.m3425$r8$lambda$sua7MVTuuODCDLBTraqW_AyS1g(this.f$0, str, keys, rolloutAssignmentList);
                }
            });
        }
    }
    ...
    public static /* synthetic */ void m3425$r8$lambda$sua7MVTuuODCDLBTraqW_AyS1g(UserMetadata userMetadata, String str, Map map, List list) throws Throwable {
    ...
    public Map<String, String> getCustomKeys(Map<String, String> map) {
        ...
        if (i > 0) {
            Logger.getLogger().m537w("Ignored " + i + " keys when adding event specific keys. Maximum allowable: 1024");
        }
    ...
    public class SerializeableKeysMap {
        ...
        private void scheduleSerializationTaskIfNeeded() {
            ...
            if (AbstractC1302xa830b2f.m312m(this.queuedSerializer, null, runnable)) {
