...
public class HttpGetRequest {
    ...
    public HttpResponse execute() throws Throwable {
        ...
        try {
            ...
            Logger.getLogger().m535v("GET Request URL: " + strCreateUrlWithParams);
    ...
    private String createParamsString(Map<String, String> map) {
        ...
        sb.append("=");
        sb.append(next.getValue() != null ? URLEncoder.encode(next.getValue(), "UTF-8") : _UrlKt.FRAGMENT_ENCODE_SET);
        while (it.hasNext()) {
            Map.Entry<String, String> next2 = it.next();
            sb.append("&");
            sb.append(next2.getKey());
            sb.append("=");
            sb.append(next2.getValue() != null ? URLEncoder.encode(next2.getValue(), "UTF-8") : _UrlKt.FRAGMENT_ENCODE_SET);
        }
        return sb.toString();
    }
