  ...
  (r0v0 com.google.firebase.crashlytics.internal.common.CommonUtils$Architecture) from 0x0085: INVOKE (r5v5 java.util.HashMap), ("x86"), (r0v0 com.google.firebase.crashlytics.internal.common.CommonUtils$Architecture) INTERFACE call: java.util.Map.put(java.lang.Object, java.lang.Object):java.lang.Object A[MD:(K, V):V (c)] (LINE:116)
    ...
    static final class Architecture {
        ...
        static Architecture getValue() {
            ...
            if (TextUtils.isEmpty(str)) {
                Logger.getLogger().m507v("Architecture#getValue()::Build.CPU_ABI returned null or empty");
                return UNKNOWN;
            }
    ...
    private static String hash(byte[] bArr, String str) {
        try {
            ...
            Logger.getLogger().m504e("Could not create hashing algorithm: " + str + ", returning empty string.", e);
    ...
    public static List getBuildIdInfo(Context context) {
        ...
        if (resourcesIdentifier == 0 || resourcesIdentifier2 == 0 || resourcesIdentifier3 == 0) {
            Logger.getLogger().m501d(String.format("Could not find resources: %d %d %d", Integer.valueOf(resourcesIdentifier), Integer.valueOf(resourcesIdentifier2), Integer.valueOf(resourcesIdentifier3)));
            return arrayList;
        }
        ...
        if (stringArray.length != stringArray3.length || stringArray2.length != stringArray3.length) {
            Logger.getLogger().m501d(String.format("Lengths did not match: %d %d %d", Integer.valueOf(stringArray.length), Integer.valueOf(stringArray2.length), Integer.valueOf(stringArray3.length)));
            return arrayList;
        }
