...
public abstract class CommonUtils {
  ...
  (r0v0 com.google.firebase.crashlytics.internal.common.CommonUtils$Architecture) from 0x0085: INVOKE (r5v5 java.util.HashMap), ("x86"), (r0v0 com.google.firebase.crashlytics.internal.common.CommonUtils$Architecture) INTERFACE call: java.util.Map.put(java.lang.Object, java.lang.Object):java.lang.Object A[MD:(K, V):V (c)] (LINE:116)
    ...
    public static final class Architecture {
        ...
        public static Architecture getValue() {
            ...
            if (TextUtils.isEmpty(str)) {
                Logger.getLogger().m535v("Architecture#getValue()::Build.CPU_ABI returned null or empty");
                return UNKNOWN;
            }
    ...
    public static String streamToString(InputStream inputStream) {
        ...
        try {
            String next = scannerUseDelimiter.hasNext() ? scannerUseDelimiter.next() : _UrlKt.FRAGMENT_ENCODE_SET;
    ...
    private static String hash(byte[] bArr, String str) {
        try {
            ...
            Logger.getLogger().m532e("Could not create hashing algorithm: " + str + ", returning empty string.", e);
    ...
    public static String createInstanceIdFrom(String... strArr) {
        if (strArr != null && strArr.length != 0) {
            ...
            for (String str : strArr) {
                if (str != null) {
                    arrayList.add(str.replace("-", _UrlKt.FRAGMENT_ENCODE_SET).toLowerCase(Locale.US));
                }
            }
    ...
    public static List<BuildIdInfo> getBuildIdInfo(Context context) {
        ...
        if (resourcesIdentifier == 0 || resourcesIdentifier2 == 0 || resourcesIdentifier3 == 0) {
            Logger.getLogger().m529d(String.format("Could not find resources: %d %d %d", Integer.valueOf(resourcesIdentifier), Integer.valueOf(resourcesIdentifier2), Integer.valueOf(resourcesIdentifier3)));
            return arrayList;
        }
        ...
        if (stringArray.length != stringArray3.length || stringArray2.length != stringArray3.length) {
            Logger.getLogger().m529d(String.format("Lengths did not match: %d %d %d", Integer.valueOf(stringArray.length), Integer.valueOf(stringArray2.length), Integer.valueOf(stringArray3.length)));
            return arrayList;
        }
