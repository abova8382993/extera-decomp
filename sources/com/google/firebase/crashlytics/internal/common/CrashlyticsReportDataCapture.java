...
public class CrashlyticsReportDataCapture {
    ...
    static {
        ...
        map.put("x86", 0);
        map.put("x86_64", 1);
        GENERATOR = String.format(Locale.US, "Crashlytics Android SDK/%s", "20.0.5");
    }
    ...
    private CrashlyticsReport.Session.Event.Application.Execution.Signal populateSignalData() {
        return CrashlyticsReport.Session.Event.Application.Execution.Signal.builder().setName(MVEL.VERSION_SUB).setCode(MVEL.VERSION_SUB).setAddress(0L).build();
    }
