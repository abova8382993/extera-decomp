...
public class DataCollectionArbiter {
    ...
    public void grantDataCollectionPermission(boolean z) {
        if (!z) {
            Segment$$ExternalSyntheticBUOutline1.m992m("An invalid data collection token was used.");
        } else {
    ...
    private void logDataCollectionState(boolean z) {
        ...
        Logger.getLogger().m529d(String.format("Crashlytics automatic data collection %s by %s.", str2, str));
    }
    ...
    private static Boolean readCrashlyticsDataCollectionEnabledFromManifest(Context context) {
        ...
        try {
            ...
            Logger.getLogger().m532e("Could not read data collection permission from manifest", e);
            return null;
        }
    }
