...
public class CachedSettingsIo {
    ...
    public JSONObject readCachedSettings() throws Throwable {
        ...
        Logger.getLogger().m529d("Checking for cached settings...");
            ...
            try {
                ...
                if (settingsFile.exists()) {
                    ...
                    try {
                        ...
                        e = e;
                        Logger.getLogger().m532e("Failed to fetch cached settings", e);
                        CommonUtils.closeOrLog(fileInputStream, "Error while closing settings cache file.");
                        return null;
                    }
                } else {
                    Logger.getLogger().m535v("Settings file does not exist.");
                    jSONObject = null;
                }
                ...
                th = th;
                CommonUtils.closeOrLog(appSearchSession, "Error while closing settings cache file.");
                throw th;
            }
        } catch (Throwable th2) {
            th = th2;
    ...
    public void writeCachedSettings(long j, JSONObject jSONObject) throws Throwable {
        Logger.getLogger().m535v("Writing settings to cache file...");
        if (jSONObject == null) {
            return;
        }
        ...
        try {
            try {
                ...
                try {
                    ...
                    Logger.getLogger().m532e("Failed to cache settings", e);
