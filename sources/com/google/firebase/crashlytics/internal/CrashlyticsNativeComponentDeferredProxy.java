...
public final class CrashlyticsNativeComponentDeferredProxy implements CrashlyticsNativeComponent {
    ...
    public CrashlyticsNativeComponentDeferredProxy(Deferred deferred) {
        ...
        deferred.whenAvailable(new Deferred.DeferredHandler() { // from class: com.google.firebase.crashlytics.internal.CrashlyticsNativeComponentDeferredProxy$$ExternalSyntheticLambda0
            ...
            public final void handle(Provider provider) {
                CrashlyticsNativeComponentDeferredProxy.$r8$lambda$aFyqACfbzgBCqUDIOJCUOrXTRjw(this.f$0, provider);
            }
        });
    }
    ...
    public static /* synthetic */ void $r8$lambda$aFyqACfbzgBCqUDIOJCUOrXTRjw(CrashlyticsNativeComponentDeferredProxy crashlyticsNativeComponentDeferredProxy, Provider provider) {
        ...
        Logger.getLogger().m501d("Crashlytics native component now available.");
    ...
    public void prepareNativeSession(final String str, final String str2, final long j, final StaticSessionData staticSessionData) {
        Logger.getLogger().m507v("Deferring native open session: " + str);
