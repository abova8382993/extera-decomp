...
public class RemoteConfigDeferredProxy {
    ...
    public void setupListener(UserMetadata userMetadata) {
        if (userMetadata == null) {
            Logger.getLogger().m537w("Didn't successfully register with UserMetadata for rollouts listener");
        } else {
    ...
    public static /* synthetic */ void $r8$lambda$tM9cwbkvs3BgPiTMmQjNX30V2r4(CrashlyticsRemoteConfigListener crashlyticsRemoteConfigListener, Provider provider) {
        ...
        Logger.getLogger().m529d("Registering RemoteConfig Rollouts subscriber");
    }
}
