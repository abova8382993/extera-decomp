...
public class FirebaseApp {
    ...
    protected FirebaseApp(final Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        ComponentRuntime.Builder processor = ComponentRuntime.builder(UiExecutor.INSTANCE).addLazyComponentRegistrars(listDiscoverLazy).addComponentRegistrar(new FirebaseCommonRegistrar()).addComponentRegistrar(new ExecutorsRegistrar()).addComponent(Component.m499of(context, Context.class, new Class[0])).addComponent(Component.m499of(this, FirebaseApp.class, new Class[0])).addComponent(Component.m499of(firebaseOptions, FirebaseOptions.class, new Class[0])).setProcessor(new ComponentMonitor());
        if (UserManagerCompat.isUserUnlocked(context) && FirebaseInitProvider.isCurrentlyInitializing()) {
            processor.addComponent(Component.m499of(startupTime, StartupTime.class, new Class[0]));
        }
        ...
        addBackgroundStateChangeListener(new BackgroundStateChangeListener() { // from class: com.google.firebase.FirebaseApp$$ExternalSyntheticLambda1
            ...
            public final void onBackgroundStateChanged(boolean z) {
                FirebaseApp.m3510$r8$lambda$ACPzvYjhpDUdi_U1Jr3TE9psg(this.f$0, z);
            }
        });
        FirebaseTrace.popTrace();
    }
    ...
    public static /* synthetic */ void m3510$r8$lambda$ACPzvYjhpDUdi_U1Jr3TE9psg(FirebaseApp firebaseApp, boolean z) {
        if (z) {
    ...
    private static class UserUnlockReceiver extends BroadcastReceiver {
        ...
        public static void ensureReceiverRegistered(Context context) {
            if (INSTANCE.get() == null) {
                ...
                if (AbstractC1272xa830b30.m315m(INSTANCE, null, userUnlockReceiver)) {
        ...
        public static void ensureBackgroundStateListenerRegistered(Context context) {
            if (PlatformVersion.isAtLeastIceCreamSandwich() && (context.getApplicationContext() instanceof Application)) {
                ...
                if (INSTANCE.get() == null) {
                    ...
                    if (AbstractC1272xa830b30.m315m(INSTANCE, null, globalBackgroundStateListener)) {
