...
final class ProtobufDataEncoderContext implements ObjectEncoderContext {
    ...
    private static final ObjectEncoder<Map.Entry<Object, Object>> DEFAULT_MAP_ENCODER = new ObjectEncoder() { // from class: com.google.firebase.encoders.proto.ProtobufDataEncoderContext$$ExternalSyntheticLambda0
        ...
        public final void encode(Object obj, Object obj2) {
            ProtobufDataEncoderContext.m3434$r8$lambda$HMpWU6Ryr444SahjVbEVRqtyxs((Map.Entry) obj, (ObjectEncoderContext) obj2);
        }
    };

    /* JADX INFO: renamed from: $r8$lambda$HMpWU6Ryr444SahjVbEVRqty-xs */
    public static /* synthetic */ void m3434$r8$lambda$HMpWU6Ryr444SahjVbEVRqtyxs(Map.Entry entry, ObjectEncoderContext objectEncoderContext) {
    ...
    public static /* synthetic */ class C19191 {
        ...
        static {
            ...
            try {
                f637x531607dd[Protobuf.IntEncoding.SIGNED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f637x531607dd[Protobuf.IntEncoding.FIXED.ordinal()] = 3;
    ...
    public ProtobufDataEncoderContext add(FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (!z || i != 0) {
            ...
            int i2 = C19191.f637x531607dd[protobuf.intEncoding().ordinal()];
            if (i2 == 1) {
    ...
    public ProtobufDataEncoderContext add(FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (!z || j != 0) {
            Protobuf protobuf = getProtobuf(fieldDescriptor);
            int i = C19191.f637x531607dd[protobuf.intEncoding().ordinal()];
            if (i == 1) {
                writeVarInt32(protobuf.tag() << 3);
                writeVarInt64(j);
                return this;
