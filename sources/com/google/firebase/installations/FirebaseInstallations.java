...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    class ThreadFactoryC18801 implements ThreadFactory {
        private final AtomicInteger mCount = new AtomicInteger(1);
    ...
    private PersistedInstallationEntry registerFidWithServer(PersistedInstallationEntry persistedInstallationEntry) throws FirebaseInstallationsException {
        ...
        int i = C18813.f585xc38d2559[installationResponseCreateFirebaseInstallation.getResponseCode().ordinal()];
        if (i == 1) {
    ...
    private PersistedInstallationEntry fetchAuthTokenFromServer(PersistedInstallationEntry persistedInstallationEntry) throws FirebaseInstallationsException {
        ...
        int i = C18813.f586xe5baa01a[tokenResultGenerateAuthToken.getResponseCode().ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C18813 {
        ...
        static {
            ...
            try {
                f586xe5baa01a[TokenResult.ResponseCode.BAD_CONFIG.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f586xe5baa01a[TokenResult.ResponseCode.AUTH_ERROR.ordinal()] = 3;
            ...
            try {
                f585xc38d2559[InstallationResponse.ResponseCode.BAD_CONFIG.ordinal()] = 2;
