...
final class AutoValue_TokenResult extends TokenResult {
    ...
    public /* synthetic */ AutoValue_TokenResult(String str, long j, TokenResult.ResponseCode responseCode, C19261 c19261) {
    ...
    public static final class Builder extends TokenResult.Builder {
        ...
        public TokenResult build() {
            if (this.set$0 != 1) {
                Segment$$ExternalSyntheticBUOutline1.m992m("Missing required properties: tokenExpirationTimestamp");
                return null;
            }
