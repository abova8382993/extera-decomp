...
final class GenericGFPoly {
    ...
    public GenericGFPoly addOrSubtract(GenericGFPoly genericGFPoly) {
        if (!this.field.equals(genericGFPoly.field)) {
            g$$ExternalSyntheticBUOutline1.m207m("GenericGFPolys do not have same GenericGF field");
            return null;
        }
        if (isZero()) {
    ...
    public GenericGFPoly multiply(int i) {
        ...
        while (true) {
            ...
            if (i2 < length) {
                iArr[i2] = genericGF.multiply(this.coefficients[i2], i);
                i2++;
            } else {
    ...
    public GenericGFPoly[] divide(GenericGFPoly genericGFPoly) {
        ...
        if (genericGFPoly.isZero()) {
            g$$ExternalSyntheticBUOutline1.m207m("Divide by 0");
            return null;
        }
