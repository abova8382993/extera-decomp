...
public final class BitMatrix implements Cloneable {
    ...
    public BitMatrix(int i, int i2, int i3) {
        if (i < 1 || i2 < 1) {
            g$$ExternalSyntheticBUOutline1.m207m("Both dimensions must be greater than 0");
            throw null;
        }
        this.width = i;
        this.height = i2;
    ...
    public void setRegion(int i, int i2, int i3, int i4) {
        if (i2 < 0 || i < 0) {
            g$$ExternalSyntheticBUOutline1.m207m("Left and top must be nonnegative");
            return;
        }
        if (i4 < 1 || i3 < 1) {
            g$$ExternalSyntheticBUOutline1.m207m("Height and width must be at least 1");
            return;
        }
        int i5 = i3 + i;
        int i6 = i4 + i2;
        if (i6 > this.height || i5 > this.width) {
            g$$ExternalSyntheticBUOutline1.m207m("The region must fit inside the matrix");
            return;
        }
        while (i2 < i6) {
