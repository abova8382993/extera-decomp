...
public abstract class MobileVisionBase<DetectionResultT> implements Closeable, LifecycleObserver {
    public static final /* synthetic */ int $r8$clinit = 0;
    private static final GmsLogger zzb = new GmsLogger("MobileVisionBase", _UrlKt.FRAGMENT_ENCODE_SET);
    ...
    public MobileVisionBase(MLTask<DetectionResultT, InputImage> mLTask, Executor executor) {
        ...
        this.zzg = mLTask.callAfterLoad(executor, new Callable() { // from class: com.google.mlkit.vision.common.internal.zzb
            ...
            public final void onFailure(Exception exc) {
                MobileVisionBase.zzb.m346e("MobileVisionBase", "Error preloading model resource", exc);
            }
        });
    }
