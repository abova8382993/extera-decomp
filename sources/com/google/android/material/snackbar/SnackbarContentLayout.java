...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attributeSet) {
        ...
        this.contentInterpolator = MotionUtils.resolveThemeInterpolator(context, C1379R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
    }

    @Override // android.view.View
    public void onFinishInflate() {
        super.onFinishInflate();
        this.messageView = (TextView) findViewById(C1379R.id.snackbar_text);
        this.actionView = (Button) findViewById(C1379R.id.snackbar_action);
        this.closeView = (Button) findViewById(C1379R.id.mtrl_snackbar_close);
    }
    ...
    public void updateActionTextColorAlphaIfNeeded(float f) {
        if (f != 1.0f) {
            this.actionView.setTextColor(MaterialColors.layer(MaterialColors.getColor(this, C1379R.attr.colorSurface), this.actionView.getCurrentTextColor(), f));
        }
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        int dimensionPixelSize = getResources().getDimensionPixelSize(C1379R.dimen.design_snackbar_padding_vertical_2lines);
        int dimensionPixelSize2 = getResources().getDimensionPixelSize(C1379R.dimen.design_snackbar_padding_vertical);
