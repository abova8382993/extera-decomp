...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    static {
        int i = C1349R.attr.snackbarButtonStyle;
        SNACKBAR_BUTTON_STYLE_ATTR = new int[]{i};
        SNACKBAR_CONTENT_STYLE_ATTRS = new int[]{i, C1349R.attr.snackbarTextViewStyle};
    }
    ...
    private static Snackbar makeInternal(Context context, View view, CharSequence charSequence, int i) {
        ...
        if (hasSnackbarContentStyleAttrs(context)) {
            i2 = C1349R.layout.mtrl_layout_snackbar_include;
        } else {
            i2 = C1349R.layout.design_layout_snackbar_include;
        }
