...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
    ...
    public TimePickerView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.selectionListener = new View.OnClickListener() { // from class: com.google.android.material.timepicker.TimePickerView.1
            ...
            public void onClick(View view) {
                if (TimePickerView.this.onSelectionChangeListener != null) {
                    TimePickerView.this.onSelectionChangeListener.onSelectionChanged(((Integer) view.getTag(C1379R.id.selection_type)).intValue());
                }
            }
        };
        LayoutInflater.from(context).inflate(C1379R.layout.material_timepicker, this);
        ClockFaceView clockFaceView = (ClockFaceView) findViewById(C1379R.id.material_clock_face);
        this.clockFace = clockFaceView;
        MaterialButtonToggleGroup materialButtonToggleGroup = (MaterialButtonToggleGroup) findViewById(C1379R.id.material_clock_period_toggle);
        ...
        materialButtonToggleGroup.addOnButtonCheckedListener(new MaterialButtonToggleGroup.OnButtonCheckedListener() { // from class: com.google.android.material.timepicker.TimePickerView$$ExternalSyntheticLambda0
            ...
            public final void onButtonChecked(MaterialButtonToggleGroup materialButtonToggleGroup2, int i2, boolean z) {
                TimePickerView.$r8$lambda$N5NRqpZD74A3LGLNZxV7Y_usDfU(this.f$0, materialButtonToggleGroup2, i2, z);
            }
        });
        this.minuteView = (Chip) findViewById(C1379R.id.material_minute_tv);
        this.hourView = (Chip) findViewById(C1379R.id.material_hour_tv);
        this.clockHandView = (ClockHandView) findViewById(C1379R.id.material_clock_hand);
        clockFaceView.setOnEnterKeyPressedListener(new ClockFaceView.OnEnterKeyPressedListener() { // from class: com.google.android.material.timepicker.TimePickerView$$ExternalSyntheticLambda1
            ...
            public final void onEnterKeyPressed() {
                TimePickerView.m3396$r8$lambda$aD1oT4on2FtZictvw3RwjUfCE(this.f$0);
            }
        });
        setupDoubleTap();
        setUpDisplay();
    ...
    public static /* synthetic */ void $r8$lambda$N5NRqpZD74A3LGLNZxV7Y_usDfU(TimePickerView timePickerView, MaterialButtonToggleGroup materialButtonToggleGroup, int i, boolean z) {
        if (!z) {
        ...
        if (onPeriodChangeListener != null) {
            onPeriodChangeListener.onPeriodChange(i == C1379R.id.material_clock_period_pm_button ? 1 : 0);
        }
    }

    /* JADX INFO: renamed from: $r8$lambda$aD1oT4on2FtZictvw3Rw--jUfCE, reason: not valid java name */
    public static /* synthetic */ void m3396$r8$lambda$aD1oT4on2FtZictvw3RwjUfCE(TimePickerView timePickerView) {
        OnSelectionChange onSelectionChange;
        if (!timePickerView.hourView.isChecked() || (onSelectionChange = timePickerView.onSelectionChangeListener) == null) {
            return;
        }
    ...
    private void setUpDisplay() {
        this.minuteView.setTag(C1379R.id.selection_type, 12);
        this.hourView.setTag(C1379R.id.selection_type, 10);
    ...
    public void updateTime(int i, int i2, int i3) {
        int i4;
        if (i == 1) {
            i4 = C1379R.id.material_clock_period_pm_button;
        } else {
            i4 = C1379R.id.material_clock_period_am_button;
        }
