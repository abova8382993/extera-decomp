...
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.OnDoubleTapListener {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, null, C1379R.attr.materialTimePickerStyle, C1379R.style.Widget_MaterialComponents_TimePicker);
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(null, C1379R.styleable.MaterialTimePicker, C1379R.attr.materialTimePickerStyle, C1379R.style.Widget_MaterialComponents_TimePicker);
        this.clockIcon = typedArrayObtainStyledAttributes.getResourceId(C1379R.styleable.MaterialTimePicker_clockIcon, 0);
        this.keyboardIcon = typedArrayObtainStyledAttributes.getResourceId(C1379R.styleable.MaterialTimePicker_keyboardIcon, 0);
        int color = typedArrayObtainStyledAttributes.getColor(C1379R.styleable.MaterialTimePicker_backgroundTint, 0);
    ...
    private void restoreState(Bundle bundle) {
        ...
        int i = 1;
        if (!getResources().getBoolean(C1379R.bool.timepicker_force_input_mode_keyboard) && this.time.format != 1) {
            i = 0;
        }
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        final ViewGroup viewGroup2 = (ViewGroup) layoutInflater.inflate(C1379R.layout.material_timepicker_dialog, viewGroup);
        TimePickerView timePickerView = (TimePickerView) viewGroup2.findViewById(C1379R.id.material_timepicker_view);
        this.timePickerView = timePickerView;
        timePickerView.setOnDoubleTapListener(this);
        this.textInputStub = (ViewStub) viewGroup2.findViewById(C1379R.id.material_textinput_timepicker);
        this.modeButton = (MaterialButton) viewGroup2.findViewById(C1379R.id.material_timepicker_mode_button);
        this.okButton = (Button) viewGroup2.findViewById(C1379R.id.material_timepicker_ok_button);
        this.cancelButton = (Button) viewGroup2.findViewById(C1379R.id.material_timepicker_cancel_button);
        TextView textView = (TextView) viewGroup2.findViewById(C1379R.id.header_title);
        ...
        this.modeButton.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.timepicker.MaterialTimePicker$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                MaterialTimePicker.m3394$r8$lambda$pinxgCSKLWy6LHDG69A2DAj8qk(this.f$0, view);
            }
        });
        return viewGroup2;
    }
    ...
    public static /* synthetic */ void m3394$r8$lambda$pinxgCSKLWy6LHDG69A2DAj8qk(MaterialTimePicker materialTimePicker, View view) {
    ...
    private ModeButtonData getModeButtonData(int i) {
        if (i == 0) {
            return new ModeButtonData(this.keyboardIcon, C1379R.string.material_timepicker_text_input_mode_description, C1379R.string.material_timepicker_text_input_mode_tooltip);
        }
        if (i == 1) {
            return new ModeButtonData(this.clockIcon, C1379R.string.material_timepicker_clock_mode_description, C1379R.string.material_timepicker_clock_mode_tooltip);
        }
        CharCodeKt$$ExternalSyntheticBUOutline0.m873m("no button data for mode: ", i);
        return null;
    }
    ...
    private int getThemeResId() {
        ...
        TypedValue typedValueResolve = MaterialAttributes.resolve(requireContext(), C1379R.attr.materialTimePickerTheme);
