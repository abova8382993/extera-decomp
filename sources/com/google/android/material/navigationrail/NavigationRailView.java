...
public class NavigationRailView extends NavigationBarView {
    ...
    public NavigationRailView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1379R.attr.navigationRailStyle);
    }

    public NavigationRailView(Context context, AttributeSet attributeSet, int i) {
        this(context, attributeSet, i, C1379R.style.Widget_MaterialComponents_NavigationRailView);
    }
    ...
    public NavigationRailView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.expandedItemSpacing = getContext().getResources().getDimensionPixelSize(C1379R.dimen.m3_navigation_rail_expanded_item_spacing);
        this.expandedItemGravity = NavigationBarView.ITEM_GRAVITY_START_CENTER;
        this.expandedIconGravity = 1;
        TintTypedArray tintTypedArrayObtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attributeSet, C1379R.styleable.NavigationRailView, i, i2, new int[0]);
        this.contentMarginTop = tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelSize(C1379R.styleable.NavigationRailView_contentMarginTop, getResources().getDimensionPixelSize(C1379R.dimen.mtrl_navigation_rail_margin));
        this.headerMarginBottom = tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelSize(C1379R.styleable.NavigationRailView_headerMarginBottom, getResources().getDimensionPixelSize(C1379R.dimen.mtrl_navigation_rail_margin));
        this.scrollingEnabled = tintTypedArrayObtainTintedStyledAttributes.getBoolean(C1379R.styleable.NavigationRailView_scrollingEnabled, false);
        setSubmenuDividersEnabled(tintTypedArrayObtainTintedStyledAttributes.getBoolean(C1379R.styleable.NavigationRailView_submenuDividersEnabled, false));
        addContentContainer();
        int resourceId = tintTypedArrayObtainTintedStyledAttributes.getResourceId(C1379R.styleable.NavigationRailView_headerLayout, 0);
        if (resourceId != 0) {
            addHeaderView(resourceId);
        }
        setMenuGravity(tintTypedArrayObtainTintedStyledAttributes.getInt(C1379R.styleable.NavigationRailView_menuGravity, 49));
        int dimensionPixelSize = tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelSize(C1379R.styleable.NavigationRailView_itemMinHeight, -1);
        int dimensionPixelSize2 = tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelSize(C1379R.styleable.NavigationRailView_itemMinHeight, -1);
        dimensionPixelSize = tintTypedArrayObtainTintedStyledAttributes.hasValue(C1379R.styleable.NavigationRailView_collapsedItemMinHeight) ? tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelSize(C1379R.styleable.NavigationRailView_collapsedItemMinHeight, -1) : dimensionPixelSize;
        dimensionPixelSize2 = tintTypedArrayObtainTintedStyledAttributes.hasValue(C1379R.styleable.NavigationRailView_expandedItemMinHeight) ? tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelSize(C1379R.styleable.NavigationRailView_expandedItemMinHeight, -1) : dimensionPixelSize2;
        setCollapsedItemMinimumHeight(dimensionPixelSize);
        setExpandedItemMinimumHeight(dimensionPixelSize2);
        this.minExpandedWidth = tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelSize(C1379R.styleable.NavigationRailView_expandedMinWidth, context2.getResources().getDimensionPixelSize(C1379R.dimen.m3_navigation_rail_min_expanded_width));
        this.maxExpandedWidth = tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelSize(C1379R.styleable.NavigationRailView_expandedMaxWidth, context2.getResources().getDimensionPixelSize(C1379R.dimen.m3_navigation_rail_max_expanded_width));
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C1379R.styleable.NavigationRailView_paddingTopSystemWindowInsets)) {
            this.paddingTopSystemWindowInsets = Boolean.valueOf(tintTypedArrayObtainTintedStyledAttributes.getBoolean(C1379R.styleable.NavigationRailView_paddingTopSystemWindowInsets, false));
        }
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C1379R.styleable.NavigationRailView_paddingBottomSystemWindowInsets)) {
            this.paddingBottomSystemWindowInsets = Boolean.valueOf(tintTypedArrayObtainTintedStyledAttributes.getBoolean(C1379R.styleable.NavigationRailView_paddingBottomSystemWindowInsets, false));
        }
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C1379R.styleable.NavigationRailView_paddingStartSystemWindowInsets)) {
            this.paddingStartSystemWindowInsets = Boolean.valueOf(tintTypedArrayObtainTintedStyledAttributes.getBoolean(C1379R.styleable.NavigationRailView_paddingStartSystemWindowInsets, false));
        }
        int dimensionPixelOffset = getResources().getDimensionPixelOffset(C1379R.dimen.m3_navigation_rail_item_padding_top_with_large_font);
        int dimensionPixelOffset2 = getResources().getDimensionPixelOffset(C1379R.dimen.m3_navigation_rail_item_padding_bottom_with_large_font);
        ...
        setCollapsedItemSpacing(tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelSize(C1379R.styleable.NavigationRailView_itemSpacing, 0));
        setExpanded(tintTypedArrayObtainTintedStyledAttributes.getBoolean(C1379R.styleable.NavigationRailView_expanded, false));
    ...
    public void expand() {
        ...
        setExpanded(true);
        announceForAccessibility(getResources().getString(C1379R.string.nav_rail_expanded_a11y_label));
    }
    ...
    public void collapse() {
        if (this.expanded) {
            setExpanded(false);
            announceForAccessibility(getResources().getString(C1379R.string.nav_rail_collapsed_a11y_label));
        }
    }
