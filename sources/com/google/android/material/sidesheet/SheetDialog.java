...
abstract class SheetDialog<C extends SheetCallback> extends AppCompatDialog {
    private static final int COORDINATOR_LAYOUT_ID = C1349R.id.coordinator;
    private static final int TOUCH_OUTSIDE_ID = C1349R.id.touch_outside;
    ...
    private View wrapInSheet(int i, View view, ViewGroup.LayoutParams layoutParams) {
        ...
        this.coordinator.findViewById(TOUCH_OUTSIDE_ID).setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.sidesheet.SheetDialog$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view2) {
                SheetDialog.m3489$r8$lambda$mcfSNnLeC1nhFpP13QvNGQH5Q(this.f$0, view2);
            }
        });
    ...
    public static /* synthetic */ void m3489$r8$lambda$mcfSNnLeC1nhFpP13QvNGQH5Q(SheetDialog sheetDialog, View view) {
    ...
    private void maybeUpdateWindowAnimationsBasedOnLayoutDirection() {
        ...
        if (Gravity.getAbsoluteGravity(((CoordinatorLayout.LayoutParams) this.sheet.getLayoutParams()).gravity, this.sheet.getLayoutDirection()) == 3) {
            i = C1349R.style.Animation_Material3_SideSheetDialog_Left;
        } else {
            i = C1349R.style.Animation_Material3_SideSheetDialog_Right;
        }
