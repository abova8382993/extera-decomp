...
abstract class SheetDialog<C extends SheetCallback> extends AppCompatDialog {
    private static final int COORDINATOR_LAYOUT_ID = C1379R.id.coordinator;
    private static final int TOUCH_OUTSIDE_ID = C1379R.id.touch_outside;
    ...
    private View wrapInSheet(int i, View view, ViewGroup.LayoutParams layoutParams) {
        ...
        this.coordinator.findViewById(TOUCH_OUTSIDE_ID).setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.sidesheet.SheetDialog$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view2) {
                SheetDialog.m3382$r8$lambda$mcfSNnLeC1nhFpP13QvNGQH5Q(this.f$0, view2);
            }
        });
    ...
    /* JADX INFO: renamed from: $r8$lambda$mcfSNnLeC1nhFpP-13QvN-GQH5Q, reason: not valid java name */
    public static /* synthetic */ void m3382$r8$lambda$mcfSNnLeC1nhFpP13QvNGQH5Q(SheetDialog sheetDialog, View view) {
    ...
    public void setSheetEdge(int i) {
        ...
        if (frameLayout == null) {
            Segment$$ExternalSyntheticBUOutline1.m992m("Sheet view reference is null; sheet edge cannot be changed if the sheet view is null.");
            return;
        }
        if (frameLayout.isLaidOut()) {
            Segment$$ExternalSyntheticBUOutline1.m992m("Sheet view has been laid out; sheet edge cannot be changed once the sheet has been laid out.");
            return;
        }
    ...
    private void maybeUpdateWindowAnimationsBasedOnLayoutDirection() {
        ...
        if (Gravity.getAbsoluteGravity(((CoordinatorLayout.LayoutParams) this.sheet.getLayoutParams()).gravity, this.sheet.getLayoutDirection()) == 3) {
            i = C1379R.style.Animation_Material3_SideSheetDialog_Left;
        } else {
            i = C1379R.style.Animation_Material3_SideSheetDialog_Right;
        }
