...
public class SideSheetDialog extends SheetDialog<SideSheetCallback> {
    private static final int SIDE_SHEET_DIALOG_THEME_ATTR = C1379R.attr.sideSheetDialogTheme;
    private static final int SIDE_SHEET_DIALOG_DEFAULT_THEME_RES = C1379R.style.Theme_Material3_Light_SideSheetDialog;
    ...
    public int getLayoutResId() {
        return C1379R.layout.m3_side_sheet_dialog;
    }

    @Override // com.google.android.material.sidesheet.SheetDialog
    public int getDialogId() {
        return C1379R.id.m3_side_sheet;
    }
    ...
    public SideSheetBehavior<? extends View> getBehavior() {
        ...
        if (!(behavior instanceof SideSheetBehavior)) {
            Segment$$ExternalSyntheticBUOutline1.m992m("The view is not associated with SideSheetBehavior");
            return null;
        }
