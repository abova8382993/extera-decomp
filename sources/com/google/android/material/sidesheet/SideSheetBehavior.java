...
public class SideSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> implements Sheet<SideSheetCallback> {
    private static final int DEFAULT_ACCESSIBILITY_PANE_TITLE = C1379R.string.side_sheet_accessibility_pane_title;
    private static final int DEF_STYLE_RES = C1379R.style.Widget_Material3_SideSheet;
    ...
    public SideSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1379R.styleable.SideSheetBehavior_Layout);
        if (typedArrayObtainStyledAttributes.hasValue(C1379R.styleable.SideSheetBehavior_Layout_backgroundTint)) {
            this.backgroundTint = MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes, C1379R.styleable.SideSheetBehavior_Layout_backgroundTint);
        }
        if (typedArrayObtainStyledAttributes.hasValue(C1379R.styleable.SideSheetBehavior_Layout_shapeAppearance)) {
            this.shapeAppearanceModel = ShapeAppearanceModel.builder(context, attributeSet, 0, DEF_STYLE_RES).build();
        }
        if (typedArrayObtainStyledAttributes.hasValue(C1379R.styleable.SideSheetBehavior_Layout_coplanarSiblingViewId)) {
            setCoplanarSiblingViewId(typedArrayObtainStyledAttributes.getResourceId(C1379R.styleable.SideSheetBehavior_Layout_coplanarSiblingViewId, -1));
        }
        createMaterialShapeDrawableIfNeeded(context);
        this.elevation = typedArrayObtainStyledAttributes.getDimension(C1379R.styleable.SideSheetBehavior_Layout_android_elevation, -1.0f);
        setDraggable(typedArrayObtainStyledAttributes.getBoolean(C1379R.styleable.SideSheetBehavior_Layout_behavior_draggable, true));
    ...
    private void setSheetEdge(int i) {
        ...
        if (sheetDelegate == null || sheetDelegate.getSheetEdge() != i) {
            ...
            CharsKt__CharKt$$ExternalSyntheticBUOutline0.m940m("Invalid sheet edge position value: ", i, ". Must be 0 or 1.");
        }
    }
    ...
    private int calculateCurrentOffset(int i, V v) {
        ...
        WearAuthSheet$$ExternalSyntheticBUOutline0.m1225m("Unexpected value: ", this.state);
        return 0;
    }
    ...
    public int getOuterEdgeOffsetForState(int i) {
        ...
        CharCodeKt$$ExternalSyntheticBUOutline0.m873m("Invalid state to get outer edge offset: ", i);
        return 0;
    }
    ...
    private ValueAnimator.AnimatorUpdateListener getCoplanarFinishAnimatorUpdateListener() {
        ...
        return new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.sidesheet.SideSheetBehavior$$ExternalSyntheticLambda2
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                SideSheetBehavior.m3383$r8$lambda$vg37JzyumMkESCn5KJfiWrmBw(this.f$0, marginLayoutParams, coplanarSiblingAdjacentMargin, coplanarSiblingView, valueAnimator);
            }
        };
    }

    /* JADX INFO: renamed from: $r8$lambda$v-g37JzyumMkESCn5K-JfiWrmBw, reason: not valid java name */
    public static /* synthetic */ void m3383$r8$lambda$vg37JzyumMkESCn5KJfiWrmBw(SideSheetBehavior sideSheetBehavior, ViewGroup.MarginLayoutParams marginLayoutParams, int i, View view, ValueAnimator valueAnimator) {
        sideSheetBehavior.sheetDelegate.updateCoplanarSiblingAdjacentMargin(marginLayoutParams, AnimationUtils.lerp(i, 0, valueAnimator.getAnimatedFraction()));
        view.requestLayout();
    }
    ...
    public class StateSettlingTracker {
        private final Runnable continueSettlingRunnable = new Runnable() { // from class: com.google.android.material.sidesheet.SideSheetBehavior$StateSettlingTracker$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                SideSheetBehavior.StateSettlingTracker.m3384$r8$lambda$moQjjbcBo6ApC5WH96319nIACo(this.f$0);
            }
        };
        ...
        public static /* synthetic */ void m3384$r8$lambda$moQjjbcBo6ApC5WH96319nIACo(StateSettlingTracker stateSettlingTracker) {
    ...
    public static <V extends View> SideSheetBehavior<V> from(V v) {
        ...
        if (!(behavior instanceof SideSheetBehavior)) {
            g$$ExternalSyntheticBUOutline1.m207m("The view is not associated with SideSheetBehavior");
            return null;
        }
