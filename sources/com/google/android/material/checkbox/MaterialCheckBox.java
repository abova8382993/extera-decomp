...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    private static final int DEF_STYLE_RES = C1379R.style.Widget_MaterialComponents_CompoundButton_CheckBox;
    private static final int[] INDETERMINATE_STATE_SET = {C1379R.attr.state_indeterminate};
    ...
    public MaterialCheckBox(Context context, AttributeSet attributeSet, int i) {
        ...
        this.transitionToUnchecked = AnimatedVectorDrawableCompat.create(getContext(), C1379R.drawable.mtrl_checkbox_button_checked_unchecked);
        ...
        TintTypedArray tintTypedArrayObtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attributeSet, C1379R.styleable.MaterialCheckBox, i, i2, new int[0]);
        this.buttonIconDrawable = tintTypedArrayObtainTintedStyledAttributes.getDrawable(C1379R.styleable.MaterialCheckBox_buttonIcon);
        if (this.buttonDrawable != null && ThemeEnforcement.isMaterial3Theme(context2) && isButtonDrawableLegacy(tintTypedArrayObtainTintedStyledAttributes)) {
            ...
            this.buttonDrawable = AppCompatResources.getDrawable(context2, C1379R.drawable.mtrl_checkbox_button);
            this.usingMaterialButtonDrawable = true;
            if (this.buttonIconDrawable == null) {
                this.buttonIconDrawable = AppCompatResources.getDrawable(context2, C1379R.drawable.mtrl_checkbox_button_icon);
            }
        }
        this.buttonIconTintList = MaterialResources.getColorStateList(context2, tintTypedArrayObtainTintedStyledAttributes, C1379R.styleable.MaterialCheckBox_buttonIconTint);
        this.buttonIconTintMode = ViewUtils.parseTintMode(tintTypedArrayObtainTintedStyledAttributes.getInt(C1379R.styleable.MaterialCheckBox_buttonIconTintMode, -1), PorterDuff.Mode.SRC_IN);
        this.useMaterialThemeColors = tintTypedArrayObtainTintedStyledAttributes.getBoolean(C1379R.styleable.MaterialCheckBox_useMaterialThemeColors, false);
        this.centerIfNoTextEnabled = tintTypedArrayObtainTintedStyledAttributes.getBoolean(C1379R.styleable.MaterialCheckBox_centerIfNoTextEnabled, true);
        this.errorShown = tintTypedArrayObtainTintedStyledAttributes.getBoolean(C1379R.styleable.MaterialCheckBox_errorShown, false);
        this.errorAccessibilityLabel = tintTypedArrayObtainTintedStyledAttributes.getText(C1379R.styleable.MaterialCheckBox_errorAccessibilityLabel);
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C1379R.styleable.MaterialCheckBox_checkedState)) {
            setCheckedState(tintTypedArrayObtainTintedStyledAttributes.getInt(C1379R.styleable.MaterialCheckBox_checkedState, 0));
        }
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C1379R.styleable.MaterialCheckBox_rippleColor)) {
            setRippleColor(MaterialResources.getColorStateList(context2, tintTypedArrayObtainTintedStyledAttributes, C1379R.styleable.MaterialCheckBox_rippleColor));
        }
    ...
    public void setCheckedState(int i) {
        AutofillManager autofillManagerM390m;
        ...
        if (this.checkedState != i) {
            ...
            if (Build.VERSION.SDK_INT >= 26 && (autofillManagerM390m = MaterialCheckBox$$ExternalSyntheticApiModelOutline1.m390m(getContext().getSystemService(MaterialCheckBox$$ExternalSyntheticApiModelOutline0.m389m()))) != null) {
                autofillManagerM390m.notifyValueChanged(this);
            }
    ...
    private void setUpDefaultButtonDrawableAnimationIfNeeded() {
        ...
        if (this.usingMaterialButtonDrawable) {
            ...
            ((AnimatedStateListDrawable) drawable).addTransition(C1379R.id.checked, C1379R.id.unchecked, animatedVectorDrawableCompat, false);
            ((AnimatedStateListDrawable) this.buttonDrawable).addTransition(C1379R.id.indeterminate, C1379R.id.unchecked, this.transitionToUnchecked, false);
        }
    }
    ...
    private String getButtonStateDescription() {
        ...
        if (i == 1) {
            return getResources().getString(C1379R.string.mtrl_checkbox_state_description_checked);
        }
        if (i == 0) {
            return getResources().getString(C1379R.string.mtrl_checkbox_state_description_unchecked);
        }
        return getResources().getString(C1379R.string.mtrl_checkbox_state_description_indeterminate);
    }
    ...
    private boolean isButtonDrawableLegacy(TintTypedArray tintTypedArray) {
        return tintTypedArray.getResourceId(C1379R.styleable.MaterialCheckBox_android_button, 0) == FRAMEWORK_BUTTON_DRAWABLE_RES_ID && tintTypedArray.getResourceId(C1379R.styleable.MaterialCheckBox_buttonCompat, 0) == 0;
    }
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.materialThemeColorsTintList == null) {
            ...
            int color3 = MaterialColors.getColor(this, C1379R.attr.colorSurface);
            int color4 = MaterialColors.getColor(this, C1379R.attr.colorOnSurface);
