...
public abstract class NavigationBarMenuView extends ViewGroup implements MenuView {
    ...
    public NavigationBarMenuView(Context context) {
        ...
        if (isInEditMode()) {
            ...
            autoTransition.setDuration(MotionUtils.resolveThemeDuration(getContext(), C1379R.attr.motionDurationMedium4, getResources().getInteger(C1379R.integer.material_motion_duration_long_1)));
            autoTransition.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C1379R.attr.motionEasingStandard, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
    ...
    public void buildMenuView() {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (z) {
                ...
                if (size2 > 0) {
                    g$$ExternalSyntheticBUOutline1.m207m("Only one layer of submenu is supported; a submenu inside a submenu is not supported by the Navigation Bar.");
                    return;
                }
    ...
    private NavigationBarItemView getNewItem() {
        Pools$Pool<NavigationBarItemView> pools$Pool = this.itemPool;
        NavigationBarItemView navigationBarItemViewAcquire = pools$Pool != null ? pools$Pool.acquire() : null;
