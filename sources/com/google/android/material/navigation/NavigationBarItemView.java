...
public abstract class NavigationBarItemView extends FrameLayout implements NavigationBarMenuItemView {
    ...
    public NavigationBarItemView(Context context) {
        ...
        this.contentContainer = (LinearLayout) findViewById(C1379R.id.navigation_bar_item_content_container);
        LinearLayout linearLayout = (LinearLayout) findViewById(C1379R.id.navigation_bar_item_inner_content_container);
        this.innerContentContainer = linearLayout;
        this.activeIndicatorView = findViewById(C1379R.id.navigation_bar_item_active_indicator_view);
        this.iconContainer = (FrameLayout) findViewById(C1379R.id.navigation_bar_item_icon_container);
        this.icon = (ImageView) findViewById(C1379R.id.navigation_bar_item_icon_view);
        BaselineLayout baselineLayout = (BaselineLayout) findViewById(C1379R.id.navigation_bar_item_labels_group);
        this.labelGroup = baselineLayout;
        TextView textView = (TextView) findViewById(C1379R.id.navigation_bar_item_small_label_view);
        this.smallLabel = textView;
        TextView textView2 = (TextView) findViewById(C1379R.id.navigation_bar_item_large_label_view);
        ...
        this.activeIndicatorExpandedDesiredHeight = getResources().getDimensionPixelSize(C1379R.dimen.m3_navigation_item_expanded_active_indicator_height_default);
    ...
    public static /* synthetic */ void $r8$lambda$QomMk9yO0suSBr2t2awa7nYn3bM(NavigationBarItemView navigationBarItemView, View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        ...
        if (navigationBarItemView.itemIconGravity == 1 && navigationBarItemView.activeIndicatorExpandedDesiredWidth == -2) {
            ...
            if (navigationBarItemView.activeIndicatorExpandedDesiredWidth != -2 || navigationBarItemView.activeIndicatorView.getMeasuredWidth() == i9) {
                z = false;
            } else {
            ...
            if (navigationBarItemView.activeIndicatorView.getMeasuredHeight() < i10) {
    ...
    private void initializeDefaultExpandedLabelGroupViews() {
        float dimension = getResources().getDimension(C1379R.dimen.default_navigation_text_size);
        float dimension2 = getResources().getDimension(C1379R.dimen.default_navigation_active_text_size);
    ...
    private void maybeAnimateActiveIndicatorToProgress(final float f) {
        ...
        this.activeIndicatorAnimator.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C1379R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
        this.activeIndicatorAnimator.setDuration(MotionUtils.resolveThemeDuration(getContext(), C1379R.attr.motionDurationLong2, getResources().getInteger(C1379R.integer.material_motion_duration_long_1)));
    ...
    private void refreshItemBackground() {
        ...
        this.iconContainer.setForeground(drawable);
    ...
    public void updateActiveIndicatorLayoutParams(int i) {
        if (i > 0 || getVisibility() != 0) {
            ...
            if (this.itemIconGravity == 1) {
                int iMin2 = i - (this.activeIndicatorExpandedMarginHorizontal * 2);
                int i2 = this.activeIndicatorExpandedDesiredWidth;
                if (i2 != -1) {
                    if (i2 == -2) {
                        iMin2 = this.contentContainer.getMeasuredWidth();
                    } else {
    ...
    public int getItemBackgroundResId() {
        return C1379R.drawable.mtrl_navigation_bar_item_background;
    }

    public int getItemDefaultMarginResId() {
        return C1379R.dimen.mtrl_navigation_bar_item_default_margin;
    }
    ...
    public static class ActiveIndicatorTransform {
        ...
        public float calculateAlpha(float f, float f2) {
            return AnimationUtils.lerp(0.0f, 1.0f, f2 == 0.0f ? 0.8f : 0.0f, f2 == 0.0f ? 1.0f : ALPHA_FRACTION, f);
        }
