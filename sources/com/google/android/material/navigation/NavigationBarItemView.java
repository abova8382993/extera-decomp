...
public abstract class NavigationBarItemView extends FrameLayout implements NavigationBarMenuItemView {
    ...
    public NavigationBarItemView(Context context) {
        ...
        this.contentContainer = (LinearLayout) findViewById(C1349R.id.navigation_bar_item_content_container);
        LinearLayout linearLayout = (LinearLayout) findViewById(C1349R.id.navigation_bar_item_inner_content_container);
        this.innerContentContainer = linearLayout;
        this.activeIndicatorView = findViewById(C1349R.id.navigation_bar_item_active_indicator_view);
        this.iconContainer = (FrameLayout) findViewById(C1349R.id.navigation_bar_item_icon_container);
        this.icon = (ImageView) findViewById(C1349R.id.navigation_bar_item_icon_view);
        BaselineLayout baselineLayout = (BaselineLayout) findViewById(C1349R.id.navigation_bar_item_labels_group);
        this.labelGroup = baselineLayout;
        TextView textView = (TextView) findViewById(C1349R.id.navigation_bar_item_small_label_view);
        this.smallLabel = textView;
        TextView textView2 = (TextView) findViewById(C1349R.id.navigation_bar_item_large_label_view);
        ...
        this.activeIndicatorExpandedDesiredHeight = getResources().getDimensionPixelSize(C1349R.dimen.m3_navigation_item_expanded_active_indicator_height_default);
    ...
    private void initializeDefaultExpandedLabelGroupViews() {
        float dimension = getResources().getDimension(C1349R.dimen.default_navigation_text_size);
        float dimension2 = getResources().getDimension(C1349R.dimen.default_navigation_active_text_size);
    ...
    private void maybeAnimateActiveIndicatorToProgress(final float f) {
        ...
        this.activeIndicatorAnimator.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C1349R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
        this.activeIndicatorAnimator.setDuration(MotionUtils.resolveThemeDuration(getContext(), C1349R.attr.motionDurationLong2, getResources().getInteger(C1349R.integer.material_motion_duration_long_1)));
    ...
    protected int getItemBackgroundResId() {
        return C1349R.drawable.mtrl_navigation_bar_item_background;
    }

    protected int getItemDefaultMarginResId() {
        return C1349R.dimen.mtrl_navigation_bar_item_default_margin;
    }
