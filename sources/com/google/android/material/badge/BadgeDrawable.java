...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private static final int DEFAULT_STYLE = C1349R.style.Widget_MaterialComponents_Badge;
    private static final int DEFAULT_THEME_ATTR = C1349R.attr.badgeStyle;
    ...
    private String getTextBadgeText() {
        ...
        return String.format(context.getString(C1349R.string.m3_exceed_max_badge_text_suffix), text.substring(0, maxCharacterCount - 1), DEFAULT_EXCEED_MAX_BADGE_TEXT_SUFFIX);
    }
    ...
    private String getNumberBadgeText() {
        ...
        return String.format(this.state.getNumberLocale(), context.getString(C1349R.string.mtrl_exceed_max_badge_number_suffix), Integer.valueOf(this.maxBadgeNumber), DEFAULT_EXCEED_MAX_BADGE_NUMBER_SUFFIX);
    }
