...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private static final int DEFAULT_STYLE = C1379R.style.Widget_MaterialComponents_Badge;
    private static final int DEFAULT_THEME_ATTR = C1379R.attr.badgeStyle;
    ...
    public void updateBadgeCoordinates(View view, ViewGroup viewGroup) {
        if (!(viewGroup instanceof FrameLayout)) {
            g$$ExternalSyntheticBUOutline1.m207m("customBadgeParent must be a FrameLayout");
        } else {
    ...
    private int getTotalHorizontalOffsetForState() {
        ...
        if (this.state.offsetAlignmentMode == 1) {
            boolean zHasBadgeContent2 = hasBadgeContent();
            BadgeState badgeState2 = this.state;
            horizontalOffsetWithoutText += zHasBadgeContent2 ? badgeState2.horizontalInsetWithText : badgeState2.horizontalInset;
        }
    ...
    private void calculateCenterAndBounds(Rect rect, View view) {
        ...
        boolean zHasBadgeContent = hasBadgeContent();
        BadgeState badgeState = this.state;
        float f3 = zHasBadgeContent ? badgeState.badgeWithTextRadius : badgeState.badgeRadius;
    ...
    private String getTextBadgeText() {
        ...
        return String.format(context.getString(C1379R.string.m3_exceed_max_badge_text_suffix), text.substring(0, maxCharacterCount - 1), DEFAULT_EXCEED_MAX_BADGE_TEXT_SUFFIX);
    }
    ...
    private String getNumberBadgeText() {
        ...
        return String.format(this.state.getNumberLocale(), context.getString(C1379R.string.mtrl_exceed_max_badge_number_suffix), Integer.valueOf(this.maxBadgeNumber), DEFAULT_EXCEED_MAX_BADGE_NUMBER_SUFFIX);
    }
