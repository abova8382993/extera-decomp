...
abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    public AnimatorSet createAnimator(MotionSpec motionSpec) {
        ...
        if (motionSpec.hasPropertyValues("labelOpacity")) {
            arrayList.add(motionSpec.getAnimator("labelOpacity", this.fab, new Property<ExtendedFloatingActionButton, Float>(Float.class, "LABEL_OPACITY_PROPERTY") { // from class: com.google.android.material.floatingactionbutton.BaseMotionStrategy.1
                public C14901(Class cls, String str) {
                    super(cls, str);
                }
                ...
                public void set(ExtendedFloatingActionButton extendedFloatingActionButton, Float f) {
                    if (f.floatValue() == 1.0f) {
                        ...
                        extendedFloatingActionButton.silentlyUpdateTextColor(ColorStateList.valueOf(ColorUtils.setAlphaComponent(extendedFloatingActionButton.getCurrentOriginalTextColor(), Math.round(AnimationUtils.lerp(0.0f, Color.alpha(r2), f.floatValue())))));
                    }
                }
            }));
        }
    ...
    /* JADX INFO: renamed from: com.google.android.material.floatingactionbutton.BaseMotionStrategy$1 */
    public class C14901 extends Property<ExtendedFloatingActionButton, Float> {
        public C14901(Class cls, String str) {
            super(cls, str);
        }
