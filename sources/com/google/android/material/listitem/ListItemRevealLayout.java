...
public class ListItemRevealLayout extends ViewGroup implements RevealableListItem {
    ...
    public ListItemRevealLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1379R.attr.listItemRevealLayoutStyle);
    }

    public ListItemRevealLayout(Context context, AttributeSet attributeSet, int i) {
        this(context, attributeSet, i, C1379R.style.Widget_Material3_ListItemRevealLayout);
    }
    ...
    public ListItemRevealLayout(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TintTypedArray tintTypedArrayObtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attributeSet, C1379R.styleable.ListItemRevealLayout, i, i2, new int[0]);
        this.minChildWidth = tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelSize(C1379R.styleable.ListItemRevealLayout_minChildWidth, getResources().getDimensionPixelSize(C1379R.dimen.m3_list_reveal_min_child_width));
        this.primaryActionSwipeMode = tintTypedArrayObtainTintedStyledAttributes.getInt(C1379R.styleable.ListItemRevealLayout_primaryActionSwipeMode, 0);
    ...
    public void measureIntrinsicSize(int i, int i2) {
        ...
        while (i5 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                i3 = i;
                i4 = i2;
                listItemRevealLayout.measureChildWithMargins(childAt, i3, measuredWidth, i4, 0);
        ...
        int i6 = i;
        int i7 = i2;
        int iMax2 = Math.max(measuredWidth + listItemRevealLayout2.getPaddingLeft() + listItemRevealLayout2.getPaddingRight(), listItemRevealLayout2.getSuggestedMinimumWidth());
        int iResolveSizeAndState = View.resolveSizeAndState(Math.max(iMax + listItemRevealLayout2.getPaddingTop() + listItemRevealLayout2.getPaddingBottom(), listItemRevealLayout2.getSuggestedMinimumHeight()), i7, 0) & 16777215;
        listItemRevealLayout2.intrinsicWidth = View.resolveSizeAndState(iMax2, i6, 0);
        listItemRevealLayout2.intrinsicHeight = View.resolveSizeAndState(iResolveSizeAndState, i7, iCombineMeasuredStates << 16);
    }
