...
public class ListItemCardView extends MaterialCardView implements SwipeableListItem {
    private static final int[] SWIPED_STATE_SET = {C1379R.attr.state_swiped};
    ...
    public ListItemCardView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1379R.attr.listItemCardViewStyle);
    }

    public ListItemCardView(Context context, AttributeSet attributeSet, int i) {
        this(context, attributeSet, i, C1379R.style.Widget_Material3_ListItemCardView);
    }
    ...
    public ListItemCardView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.swipeMaxOvershoot = getResources().getDimensionPixelSize(C1379R.dimen.m3_list_max_swipe_overshoot);
        TintTypedArray tintTypedArrayObtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attributeSet, C1379R.styleable.ListItemCardView, i, i2, new int[0]);
        this.swipeEnabled = tintTypedArrayObtainTintedStyledAttributes.getBoolean(C1379R.styleable.ListItemCardView_swipeEnabled, true);
