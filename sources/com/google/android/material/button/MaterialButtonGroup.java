...
public class MaterialButtonGroup extends LinearLayout {
    ...
    private static final int DEF_STYLE_RES = C1379R.style.Widget_Material3_MaterialButtonGroup;
    ...
    public MaterialButtonGroup(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1379R.attr.materialButtonGroupStyle);
    }
    ...
    public MaterialButtonGroup(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C1379R.styleable.MaterialButtonGroup, i, i2, new int[0]);
        if (typedArrayObtainStyledAttributes.hasValue(C1379R.styleable.MaterialButtonGroup_buttonSizeChange)) {
            this.buttonSizeChange = StateListSizeChange.create(context2, typedArrayObtainStyledAttributes, C1379R.styleable.MaterialButtonGroup_buttonSizeChange);
        }
        if (typedArrayObtainStyledAttributes.hasValue(C1379R.styleable.MaterialButtonGroup_shapeAppearance)) {
            StateListShapeAppearanceModel stateListShapeAppearanceModelCreate = StateListShapeAppearanceModel.create(context2, typedArrayObtainStyledAttributes, C1379R.styleable.MaterialButtonGroup_shapeAppearance);
            this.groupStateListShapeAppearance = stateListShapeAppearanceModelCreate;
            if (stateListShapeAppearanceModelCreate == null) {
                this.groupStateListShapeAppearance = new StateListShapeAppearanceModel.Builder(ShapeAppearanceModel.builder(context2, typedArrayObtainStyledAttributes.getResourceId(C1379R.styleable.MaterialButtonGroup_shapeAppearance, 0), typedArrayObtainStyledAttributes.getResourceId(C1379R.styleable.MaterialButtonGroup_shapeAppearanceOverlay, 0)).build()).build();
            }
        }
        if (typedArrayObtainStyledAttributes.hasValue(C1379R.styleable.MaterialButtonGroup_innerCornerSize)) {
            this.innerCornerSize = StateListCornerSize.create(context2, typedArrayObtainStyledAttributes, C1379R.styleable.MaterialButtonGroup_innerCornerSize, new AbsoluteCornerSize(0.0f));
        }
        this.spacing = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1379R.styleable.MaterialButtonGroup_android_spacing, 0);
        setChildrenDrawingOrderEnabled(true);
        setEnabled(typedArrayObtainStyledAttributes.getBoolean(C1379R.styleable.MaterialButtonGroup_android_enabled, true));
        setOverflowMode(typedArrayObtainStyledAttributes.getInt(C1379R.styleable.MaterialButtonGroup_overflowMode, 0));
        this.overflowMenuItemIconPadding = getResources().getDimensionPixelOffset(C1379R.dimen.m3_btn_group_overflow_item_icon_horizontal_padding);
    ...
    public void initializeButtonOverflow(Context context, TypedArray typedArray) {
        Drawable drawable = typedArray.getDrawable(C1379R.styleable.MaterialButtonGroup_overflowButtonIcon);
        MaterialButton materialButton = (MaterialButton) LayoutInflater.from(context).inflate(C1379R.layout.m3_button_group_overflow_button, (ViewGroup) this, false);
        ...
        if (this.overflowButton.getContentDescription() == null) {
            this.overflowButton.setContentDescription(getResources().getString(C1379R.string.mtrl_button_overflow_icon_content_description));
        }
        this.overflowButton.setVisibility(8);
        PopupMenu popupMenu = new PopupMenu(getContext(), this.overflowButton, 17, 0, MaterialAttributes.resolveOrThrow(this, C1379R.attr.materialButtonGroupPopupMenuStyle));
        ...
        this.overflowButton.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.button.MaterialButtonGroup$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                MaterialButtonGroup.m3307$r8$lambda$nSb5s0Ox4JObG6P_T034TqSgIw(this.f$0, view);
            }
        });
    ...
    public static /* synthetic */ void m3307$r8$lambda$nSb5s0Ox4JObG6P_T034TqSgIw(MaterialButtonGroup materialButtonGroup, View view) {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.overflowMode != 2) {
            ...
            g$$ExternalSyntheticBUOutline1.m207m("The wrap overflow mode is not compatible to the vertical orientation.");
            return;
        } else {
            if (View.MeasureSpec.getMode(i) == Integer.MIN_VALUE) {
                g$$ExternalSyntheticBUOutline1.m207m("The wrap overflow mode is not compatible with wrap_content layout width.");
                return;
            }
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1379R.styleable.MaterialButtonGroup_Layout);
            this.overflowIcon = typedArrayObtainStyledAttributes.getDrawable(C1379R.styleable.MaterialButtonGroup_Layout_layout_overflowIcon);
            this.overflowText = typedArrayObtainStyledAttributes.getText(C1379R.styleable.MaterialButtonGroup_Layout_layout_overflowText);
            typedArrayObtainStyledAttributes.recycle();
        }
