...
public class MaterialSplitButton extends MaterialButtonGroup {
    private static final int DEF_STYLE_RES = C1379R.style.Widget_Material3_MaterialSplitButton;
    ...
    public MaterialSplitButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1379R.attr.materialSplitButtonStyle);
    }
    ...
    public void addView(View view, int i, ViewGroup.LayoutParams layoutParams) {
        ...
        if (!(view instanceof MaterialButton)) {
            g$$ExternalSyntheticBUOutline1.m207m("MaterialSplitButton can only hold MaterialButtons.");
            return;
        }
        if (getChildCount() > 2) {
            g$$ExternalSyntheticBUOutline1.m207m("MaterialSplitButton can only hold two MaterialButtons.");
            return;
        }
        ...
        if (indexOfChild(view) == 1) {
            ...
            if (materialButton.isChecked()) {
                i2 = C1379R.string.mtrl_button_expanded_content_description;
            } else {
                i2 = C1379R.string.mtrl_button_collapsed_content_description;
            }
    ...
    public static /* synthetic */ void $r8$lambda$0AaOSuB0iM3T9__daCv7yo8umdw(MaterialSplitButton materialSplitButton, MaterialButton materialButton, MaterialButton materialButton2, boolean z) {
        ...
        if (z) {
            i = C1379R.string.mtrl_button_expanded_content_description;
        } else {
            i = C1379R.string.mtrl_button_collapsed_content_description;
        }
