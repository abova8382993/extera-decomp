...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    private void initialize() {
        TypedArray typedArrayObtainStyledAttributes = getContext().getTheme().obtainStyledAttributes(new int[]{C1379R.attr.enableEdgeToEdge});
    ...
    private FrameLayout ensureContainerAndBehavior() {
        if (this.container == null) {
            FrameLayout frameLayout = (FrameLayout) View.inflate(getContext(), C1379R.layout.design_bottom_sheet_dialog, null);
            this.container = frameLayout;
            this.protectionLayout = (ProtectionLayout) frameLayout.findViewById(C1379R.id.protection_layout);
            List<Protection> list = this.protectionsList;
            if (list != null) {
                setProtections(list);
            }
            this.coordinator = (CoordinatorLayout) this.container.findViewById(C1379R.id.coordinator);
            FrameLayout frameLayout2 = (FrameLayout) this.container.findViewById(C1379R.id.design_bottom_sheet);
    ...
    private View wrapInBottomSheet(int i, View view, ViewGroup.LayoutParams layoutParams) {
        ensureContainerAndBehavior();
        CoordinatorLayout coordinatorLayout = (CoordinatorLayout) this.container.findViewById(C1379R.id.coordinator);
        if (i != 0 && view == null) {
        ...
        coordinatorLayout.findViewById(C1379R.id.touch_outside).setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.bottomsheet.BottomSheetDialog.2
    ...
    private static int getThemeResId(Context context, int i) {
        ...
        if (context.getTheme().resolveAttribute(C1379R.attr.bottomSheetDialogTheme, typedValue, true)) {
            return typedValue.resourceId;
        }
        return C1379R.style.Theme_Design_Light_BottomSheetDialog;
    }
