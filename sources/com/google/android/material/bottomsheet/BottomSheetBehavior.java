...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> implements MaterialBackHandler {
    ...
    private static final int DEF_STYLE_RES = C1379R.style.Widget_Design_BottomSheet_Modal;
        ...
        this.dragCallback = new ViewDragHelper.Callback() { // from class: com.google.android.material.bottomsheet.BottomSheetBehavior.5
            ...
            */
            public void onViewReleased(android.view.View r9, float r10, float r11) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: com.google.android.material.bottomsheet.BottomSheetBehavior.C14155.onViewReleased(android.view.View, float, float):void");
            }
    ...
    public BottomSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        this.peekHeightGestureInsetBuffer = context.getResources().getDimensionPixelSize(C1379R.dimen.mtrl_min_touch_target_size);
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1379R.styleable.BottomSheetBehavior_Layout);
        if (typedArrayObtainStyledAttributes.hasValue(C1379R.styleable.BottomSheetBehavior_Layout_backgroundTint)) {
            this.backgroundTint = MaterialResources.getColorStateList(context, typedArrayObtainStyledAttributes, C1379R.styleable.BottomSheetBehavior_Layout_backgroundTint);
        }
        if (typedArrayObtainStyledAttributes.hasValue(C1379R.styleable.BottomSheetBehavior_Layout_shapeAppearance)) {
            this.shapeAppearanceModelDefault = ShapeAppearanceModel.builder(context, attributeSet, C1379R.attr.bottomSheetStyle, DEF_STYLE_RES).build();
        }
        createMaterialShapeDrawableIfNeeded(context);
        createShapeValueAnimator();
        this.elevation = typedArrayObtainStyledAttributes.getDimension(C1379R.styleable.BottomSheetBehavior_Layout_android_elevation, -1.0f);
        if (typedArrayObtainStyledAttributes.hasValue(C1379R.styleable.BottomSheetBehavior_Layout_android_maxWidth)) {
            setMaxWidth(typedArrayObtainStyledAttributes.getDimensionPixelSize(C1379R.styleable.BottomSheetBehavior_Layout_android_maxWidth, -1));
        }
        if (typedArrayObtainStyledAttributes.hasValue(C1379R.styleable.BottomSheetBehavior_Layout_android_maxHeight)) {
            setMaxHeight(typedArrayObtainStyledAttributes.getDimensionPixelSize(C1379R.styleable.BottomSheetBehavior_Layout_android_maxHeight, -1));
        }
        TypedValue typedValuePeekValue = typedArrayObtainStyledAttributes.peekValue(C1379R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight);
        if (typedValuePeekValue != null && (i = typedValuePeekValue.data) == -1) {
            setPeekHeight(i);
        } else {
            setPeekHeight(typedArrayObtainStyledAttributes.getDimensionPixelSize(C1379R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight, -1));
        }
        setHideable(typedArrayObtainStyledAttributes.getBoolean(C1379R.styleable.BottomSheetBehavior_Layout_behavior_hideable, false));
        setGestureInsetBottomIgnored(typedArrayObtainStyledAttributes.getBoolean(C1379R.styleable.BottomSheetBehavior_Layout_gestureInsetBottomIgnored, false));
        setFitToContents(typedArrayObtainStyledAttributes.getBoolean(C1379R.styleable.BottomSheetBehavior_Layout_behavior_fitToContents, true));
        setSkipCollapsed(typedArrayObtainStyledAttributes.getBoolean(C1379R.styleable.BottomSheetBehavior_Layout_behavior_skipCollapsed, false));
        setDraggable(typedArrayObtainStyledAttributes.getBoolean(C1379R.styleable.BottomSheetBehavior_Layout_behavior_draggable, true));
        setDraggableOnNestedScroll(typedArrayObtainStyledAttributes.getBoolean(C1379R.styleable.BottomSheetBehavior_Layout_behavior_draggableOnNestedScroll, true));
        setSaveFlags(typedArrayObtainStyledAttributes.getInt(C1379R.styleable.BottomSheetBehavior_Layout_behavior_saveFlags, 0));
        setHalfExpandedRatio(typedArrayObtainStyledAttributes.getFloat(C1379R.styleable.BottomSheetBehavior_Layout_behavior_halfExpandedRatio, HIDE_THRESHOLD));
        TypedValue typedValuePeekValue2 = typedArrayObtainStyledAttributes.peekValue(C1379R.styleable.BottomSheetBehavior_Layout_behavior_expandedOffset);
        if (typedValuePeekValue2 != null && typedValuePeekValue2.type == 16) {
            setExpandedOffset(typedValuePeekValue2.data);
        } else {
            setExpandedOffset(typedArrayObtainStyledAttributes.getDimensionPixelOffset(C1379R.styleable.BottomSheetBehavior_Layout_behavior_expandedOffset, 0));
        }
        setSignificantVelocityThreshold(typedArrayObtainStyledAttributes.getInt(C1379R.styleable.BottomSheetBehavior_Layout_behavior_significantVelocityThreshold, 500));
        this.multipleScrollingChildrenSupported = typedArrayObtainStyledAttributes.getBoolean(C1379R.styleable.f457xdccd7a5b, false);
        this.paddingBottomSystemWindowInsets = typedArrayObtainStyledAttributes.getBoolean(C1379R.styleable.BottomSheetBehavior_Layout_paddingBottomSystemWindowInsets, false);
        this.paddingLeftSystemWindowInsets = typedArrayObtainStyledAttributes.getBoolean(C1379R.styleable.BottomSheetBehavior_Layout_paddingLeftSystemWindowInsets, false);
        this.paddingRightSystemWindowInsets = typedArrayObtainStyledAttributes.getBoolean(C1379R.styleable.BottomSheetBehavior_Layout_paddingRightSystemWindowInsets, false);
        this.paddingTopSystemWindowInsets = typedArrayObtainStyledAttributes.getBoolean(C1379R.styleable.BottomSheetBehavior_Layout_paddingTopSystemWindowInsets, true);
        this.marginLeftSystemWindowInsets = typedArrayObtainStyledAttributes.getBoolean(C1379R.styleable.BottomSheetBehavior_Layout_marginLeftSystemWindowInsets, false);
        this.marginRightSystemWindowInsets = typedArrayObtainStyledAttributes.getBoolean(C1379R.styleable.BottomSheetBehavior_Layout_marginRightSystemWindowInsets, false);
        this.marginTopSystemWindowInsets = typedArrayObtainStyledAttributes.getBoolean(C1379R.styleable.BottomSheetBehavior_Layout_marginTopSystemWindowInsets, false);
        this.shouldRemoveExpandedCorners = typedArrayObtainStyledAttributes.getBoolean(C1379R.styleable.BottomSheetBehavior_Layout_shouldRemoveExpandedCorners, true);
    ...
    public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, V v, int i) {
        ...
        if (this.viewRef == null) {
            this.peekHeightMin = coordinatorLayout.getResources().getDimensionPixelSize(C1379R.dimen.design_bottom_sheet_peek_height_min);
    ...
    */
    ...
    public void setHalfExpandedRatio(float f) {
        if (f <= 0.0f || f >= 1.0f) {
            g$$ExternalSyntheticBUOutline1.m207m("ratio must be a float value between 0 and 1");
            return;
        }
    ...
    public void setExpandedOffset(int i) {
        if (i < 0) {
            g$$ExternalSyntheticBUOutline1.m207m("offset must be greater than or equal to 0");
        } else {
    ...
    public void setState(int i) {
        ...
        if (weakReference == null || weakReference.get() == null) {
            ...
            runAfterLayout(v, new Runnable() { // from class: com.google.android.material.bottomsheet.BottomSheetBehavior.1
                ...
                public RunnableC14111(View v2, int i22) {
                    view = v2;
                    i = i22;
                }
    ...
    public class RunnableC14111 implements Runnable {
        final /* synthetic */ View val$child;
        final /* synthetic */ int val$finalState;
    ...
    public class C14122 extends AnimatorListenerAdapter {
        public C14122() {
        }
    ...
    public class C14133 implements ValueAnimator.AnimatorUpdateListener {
        public C14133() {
        }
    ...
    public class C14144 implements ViewUtils.OnApplyWindowInsetsListener {
        final /* synthetic */ boolean val$shouldHandleGestureInsets;
    ...
    private int getTopOffsetForState(int i) {
        ...
        CharCodeKt$$ExternalSyntheticBUOutline0.m873m("Invalid state to get top offset: ", i);
        return 0;
    }

    /* JADX INFO: renamed from: com.google.android.material.bottomsheet.BottomSheetBehavior$5 */
    public class C14155 extends ViewDragHelper.Callback {
        private long viewCapturedMillis;
    ...
    public class StateSettlingTracker {
        ...
        public /* synthetic */ StateSettlingTracker(BottomSheetBehavior bottomSheetBehavior, RunnableC14111 runnableC14111) {
            this();
        }

        /* JADX INFO: renamed from: com.google.android.material.bottomsheet.BottomSheetBehavior$StateSettlingTracker$1 */
        public class RunnableC14181 implements Runnable {
            public RunnableC14181() {
            }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public class C14171 implements Parcelable.ClassLoaderCreator<SavedState> {
            @Override // android.os.Parcelable.ClassLoaderCreator
            public SavedState createFromParcel(Parcel parcel, ClassLoader classLoader) {
                return new SavedState(parcel, classLoader);
            }
    ...
    public static <V extends View> BottomSheetBehavior<V> from(V v) {
        ...
        if (!(layoutParams instanceof CoordinatorLayout.LayoutParams)) {
            g$$ExternalSyntheticBUOutline1.m207m("The view is not a child of CoordinatorLayout");
            return null;
        }
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) layoutParams).getBehavior();
        if (!(behavior instanceof BottomSheetBehavior)) {
            g$$ExternalSyntheticBUOutline1.m207m("The view is not associated with BottomSheetBehavior");
            return null;
        }
    ...
    private void updateAccessibilityActions(View view, int i) {
        ...
        if (!this.fitToContents && this.state != 6) {
            this.expandHalfwayActionIds.put(i, addAccessibilityActionForState(view, C1379R.string.bottomsheet_action_expand_halfway, 6));
        }
        ...
        if (i2 == 3) {
            if (canCollapse()) {
                this.collapseActionIds.put(i, addAccessibilityActionForState(view, C1379R.string.bottomsheet_action_collapse, 4));
            }
        } else if (i2 == 4) {
            this.expandActionIds.put(i, addAccessibilityActionForState(view, C1379R.string.bottomsheet_action_expand, 3));
        } else {
            if (i2 != 6) {
                return;
            }
    ...
    public class C14166 implements AccessibilityViewCommand {
    ...
    public static Protection getDefaultBottomGradientProtection(Context context) {
        Integer colorOrNull = MaterialColors.getColorOrNull(context, C1379R.attr.colorSurfaceContainerLow);
        if (colorOrNull == null) {
            colorOrNull = Integer.valueOf(MaterialColors.getColor(context, C1379R.attr.colorSurface, BottomSheetBehavior.class.getSimpleName()));
        }
