...
public class BottomNavigationMenuView extends NavigationBarMenuView {
    ...
    public BottomNavigationMenuView(Context context) {
        ...
        this.inactiveItemMaxWidth = resources.getDimensionPixelSize(C1349R.dimen.design_bottom_navigation_item_max_width);
        this.inactiveItemMinWidth = resources.getDimensionPixelSize(C1349R.dimen.design_bottom_navigation_item_min_width);
        this.activeItemMaxWidth = resources.getDimensionPixelSize(C1349R.dimen.design_bottom_navigation_active_item_max_width);
        this.activeItemMinWidth = resources.getDimensionPixelSize(C1349R.dimen.design_bottom_navigation_active_item_min_width);
    }
        ...
        if (getItemIconGravity() == 0) {
            ...
            while (i5 < childCount) {
                ...
                if (childAt2.getVisibility() != 8) {
                    childAt2.measure(View.MeasureSpec.makeMeasureSpec(this.tempChildWidths.get(i5).intValue(), TLObject.FLAG_30), iMakeMeasureSpec);
            ...
            while (i5 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (childAt3.getMeasuredWidth() < iRound) {
                        childAt3.measure(View.MeasureSpec.makeMeasureSpec(iRound, TLObject.FLAG_30), iMakeMeasureSpec);
                    }
