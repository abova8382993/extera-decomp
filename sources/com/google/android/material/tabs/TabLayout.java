...
public class TabLayout extends HorizontalScrollView {
    ...
    private static final int DEF_STYLE_RES = C1379R.style.Widget_Design_TabLayout;
    ...
    public TabLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1379R.attr.tabStyle);
    }
    ...
    public TabLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C1379R.styleable.TabLayout, i, i2, C1379R.styleable.TabLayout_tabTextAppearance);
        ...
        setSelectedTabIndicator(MaterialResources.getDrawable(context2, typedArrayObtainStyledAttributes, C1379R.styleable.TabLayout_tabIndicator));
        setSelectedTabIndicatorColor(typedArrayObtainStyledAttributes.getColor(C1379R.styleable.TabLayout_tabIndicatorColor, 0));
        slidingTabIndicator.setSelectedIndicatorHeight(typedArrayObtainStyledAttributes.getDimensionPixelSize(C1379R.styleable.TabLayout_tabIndicatorHeight, -1));
        setSelectedTabIndicatorGravity(typedArrayObtainStyledAttributes.getInt(C1379R.styleable.TabLayout_tabIndicatorGravity, 0));
        setTabIndicatorAnimationMode(typedArrayObtainStyledAttributes.getInt(C1379R.styleable.TabLayout_tabIndicatorAnimationMode, 0));
        setTabIndicatorFullWidth(typedArrayObtainStyledAttributes.getBoolean(C1379R.styleable.TabLayout_tabIndicatorFullWidth, true));
        int dimensionPixelSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1379R.styleable.TabLayout_tabPadding, 0);
        this.tabPaddingBottom = dimensionPixelSize;
        this.tabPaddingEnd = dimensionPixelSize;
        this.tabPaddingTop = dimensionPixelSize;
        this.tabPaddingStart = dimensionPixelSize;
        this.tabPaddingStart = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1379R.styleable.TabLayout_tabPaddingStart, dimensionPixelSize);
        this.tabPaddingTop = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1379R.styleable.TabLayout_tabPaddingTop, this.tabPaddingTop);
        this.tabPaddingEnd = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1379R.styleable.TabLayout_tabPaddingEnd, this.tabPaddingEnd);
        this.tabPaddingBottom = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1379R.styleable.TabLayout_tabPaddingBottom, this.tabPaddingBottom);
        if (ThemeEnforcement.isMaterial3Theme(context2)) {
            this.defaultTabTextAppearance = C1379R.attr.textAppearanceTitleSmall;
        } else {
            this.defaultTabTextAppearance = C1379R.attr.textAppearanceButton;
        }
        int resourceId = typedArrayObtainStyledAttributes.getResourceId(C1379R.styleable.TabLayout_tabTextAppearance, C1379R.style.TextAppearance_Design_Tab);
        this.tabTextAppearance = resourceId;
        TypedArray typedArrayObtainStyledAttributes2 = context2.obtainStyledAttributes(resourceId, R$styleable.TextAppearance);
        try {
            ...
            if (typedArrayObtainStyledAttributes.hasValue(C1379R.styleable.TabLayout_tabSelectedTextAppearance)) {
                this.selectedTabTextAppearance = typedArrayObtainStyledAttributes.getResourceId(C1379R.styleable.TabLayout_tabSelectedTextAppearance, resourceId);
            }
            int i3 = this.selectedTabTextAppearance;
            if (i3 != -1) {
                typedArrayObtainStyledAttributes2 = context2.obtainStyledAttributes(i3, R$styleable.TextAppearance);
                try {
                    this.selectedTabTextSize = typedArrayObtainStyledAttributes2.getDimensionPixelSize(R$styleable.TextAppearance_android_textSize, (int) this.tabTextSize);
                    ColorStateList colorStateList = MaterialResources.getColorStateList(context2, typedArrayObtainStyledAttributes2, R$styleable.TextAppearance_android_textColor);
            ...
            if (typedArrayObtainStyledAttributes.hasValue(C1379R.styleable.TabLayout_tabTextColor)) {
                this.tabTextColors = MaterialResources.getColorStateList(context2, typedArrayObtainStyledAttributes, C1379R.styleable.TabLayout_tabTextColor);
            }
            if (typedArrayObtainStyledAttributes.hasValue(C1379R.styleable.TabLayout_tabSelectedTextColor)) {
                this.tabTextColors = createColorStateList(this.tabTextColors.getDefaultColor(), typedArrayObtainStyledAttributes.getColor(C1379R.styleable.TabLayout_tabSelectedTextColor, 0));
            }
            this.tabIconTint = MaterialResources.getColorStateList(context2, typedArrayObtainStyledAttributes, C1379R.styleable.TabLayout_tabIconTint);
            this.tabIconTintMode = ViewUtils.parseTintMode(typedArrayObtainStyledAttributes.getInt(C1379R.styleable.TabLayout_tabIconTintMode, -1), null);
            this.tabRippleColorStateList = MaterialResources.getColorStateList(context2, typedArrayObtainStyledAttributes, C1379R.styleable.TabLayout_tabRippleColor);
            this.tabIndicatorAnimationDuration = typedArrayObtainStyledAttributes.getInt(C1379R.styleable.TabLayout_tabIndicatorAnimationDuration, 300);
            this.tabIndicatorTimeInterpolator = MotionUtils.resolveThemeInterpolator(context2, C1379R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
            this.requestedTabMinWidth = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1379R.styleable.TabLayout_tabMinWidth, -1);
            this.requestedTabMaxWidth = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1379R.styleable.TabLayout_tabMaxWidth, -1);
            this.tabBackgroundResId = typedArrayObtainStyledAttributes.getResourceId(C1379R.styleable.TabLayout_tabBackground, 0);
            this.contentInsetStart = typedArrayObtainStyledAttributes.getDimensionPixelSize(C1379R.styleable.TabLayout_tabContentStart, 0);
            this.mode = typedArrayObtainStyledAttributes.getInt(C1379R.styleable.TabLayout_tabMode, 1);
            this.tabGravity = typedArrayObtainStyledAttributes.getInt(C1379R.styleable.TabLayout_tabGravity, 0);
            this.inlineLabel = typedArrayObtainStyledAttributes.getBoolean(C1379R.styleable.TabLayout_tabInlineLabel, false);
            this.unboundedRipple = typedArrayObtainStyledAttributes.getBoolean(C1379R.styleable.TabLayout_tabUnboundedRipple, false);
            typedArrayObtainStyledAttributes.recycle();
            Resources resources = getResources();
            this.tabTextMultiLineSize = resources.getDimensionPixelSize(C1379R.dimen.design_tab_text_size_2line);
            this.scrollableTabMinWidth = resources.getDimensionPixelSize(C1379R.dimen.design_tab_scrollable_min_width);
            applyModeAndGravity();
        } finally {
        }
    }
    ...
    public void addTab(Tab tab, int i, boolean z) {
        if (tab.parent != this) {
            g$$ExternalSyntheticBUOutline1.m207m("Tab belongs to a different TabLayout.");
            return;
        }
        configureTab(tab, i);
        addTabView(tab);
    ...
    public Tab newTab() {
        ...
        if (tabCreateTabFromPool.f487id != -1) {
            tabCreateTabFromPool.view.setId(tabCreateTabFromPool.f487id);
        }
    ...
    public void removeTab(Tab tab) {
        if (tab.parent != this) {
            g$$ExternalSyntheticBUOutline1.m207m("Tab does not belong to this TabLayout.");
        } else {
    ...
    private TabView createTabView(Tab tab) {
        ...
        TabView tabViewAcquire = pools$Pool != null ? pools$Pool.acquire() : null;
    ...
    private void addViewInternal(View view) {
        if (view instanceof TabItem) {
            ...
            g$$ExternalSyntheticBUOutline1.m207m("Only TabItem instances can be added to TabLayout");
        }
    }
    ...
    */
    ...
    public class C16421 implements ValueAnimator.AnimatorUpdateListener {
        public C16421() {
        }
    ...
    public static class Tab {
        ...
        public Tab setIcon(int i) {
            TabLayout tabLayout = this.parent;
            if (tabLayout == null) {
                g$$ExternalSyntheticBUOutline1.m207m("Tab not attached to a TabLayout");
                return null;
            }
    ...
    public final class TabView extends LinearLayout {
        ...
        public void updateBackgroundDrawable(Context context) {
            ...
            Drawable drawableWrap = gradientDrawable;
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            accessibilityNodeInfoCompatWrap.setRoleDescription(getResources().getString(C1379R.string.item_view_role_description));
        }
        ...
        private void inflateAndAddDefaultIconView() {
            ImageView imageView = (ImageView) LayoutInflater.from(getContext()).inflate(C1379R.layout.design_layout_tab_icon, (ViewGroup) this, false);
            this.iconView = imageView;
            addView(imageView, 0);
        }

        private void inflateAndAddDefaultTextView() {
            TextView textView = (TextView) LayoutInflater.from(getContext()).inflate(C1379R.layout.design_layout_tab_text, (ViewGroup) this, false);
        ...
        public BadgeDrawable getOrCreateBadge() {
            ...
            Segment$$ExternalSyntheticBUOutline1.m992m("Unable to create badge");
            return null;
        }
        ...
        public class ViewOnLayoutChangeListenerC16441 implements View.OnLayoutChangeListener {
            final /* synthetic */ View val$view;

            public ViewOnLayoutChangeListenerC16441(View view) {
                view = view;
            }
        ...
        private void addOnLayoutChangeListener(View view) {
            ...
            view.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: com.google.android.material.tabs.TabLayout.TabView.1
                ...
                public ViewOnLayoutChangeListenerC16441(View view2) {
                    view = view2;
                }
    ...
    public class SlidingTabIndicator extends LinearLayout {
        ...
        private void updateOrRecreateIndicatorAnimation(boolean z, int i, int i2) {
            ...
            TabLayout.this.indicatorPosition = i;
            C16431 c16431 = new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.tabs.TabLayout.SlidingTabIndicator.1
                final /* synthetic */ View val$currentView;
                final /* synthetic */ View val$targetView;

                public C16431(View childAt3, View childAt22) {
                    view = childAt3;
                    view = childAt22;
                }
            ...
            if (z) {
                ...
                valueAnimator.addUpdateListener(c16431);
                valueAnimator.start();
                return;
            }
            this.indicatorAnimator.removeAllUpdateListeners();
            this.indicatorAnimator.addUpdateListener(c16431);
        }

        /* JADX INFO: renamed from: com.google.android.material.tabs.TabLayout$SlidingTabIndicator$1 */
        public class C16431 implements ValueAnimator.AnimatorUpdateListener {
            final /* synthetic */ View val$currentView;
            final /* synthetic */ View val$targetView;
