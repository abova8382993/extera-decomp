...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    ...
    private static final int DEF_STYLE_RES = C1379R.style.MaterialAlertDialog_MaterialComponents;
    private static final int MATERIAL_ALERT_DIALOG_THEME_OVERLAY = C1379R.attr.materialAlertDialogTheme;
    ...
    public MaterialAlertDialogBuilder(Context context, int i) {
        ...
        int color = MaterialColors.getColor(context2, C1379R.attr.colorSurface, getClass().getCanonicalName());
        TypedArray typedArrayObtainStyledAttributes = context2.obtainStyledAttributes(null, C1379R.styleable.MaterialAlertDialog, i2, i3);
        int color2 = typedArrayObtainStyledAttributes.getColor(C1379R.styleable.MaterialAlertDialog_backgroundTint, color);
