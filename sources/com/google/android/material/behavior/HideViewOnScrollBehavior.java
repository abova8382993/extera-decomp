...
public class HideViewOnScrollBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    private static final int ENTER_ANIM_DURATION_ATTR = C1379R.attr.motionDurationLong2;
    private static final int EXIT_ANIM_DURATION_ATTR = C1379R.attr.motionDurationMedium4;
    private static final int ENTER_EXIT_ANIM_EASING_ATTR = C1379R.attr.motionEasingEmphasizedInterpolator;
    ...
    private void setViewEdgeInternal(int i) {
        ...
        if (hideViewOnScrollDelegate == null || hideViewOnScrollDelegate.getViewEdge() != i) {
            ...
            if (i == 1) {
                ...
                CharsKt__CharKt$$ExternalSyntheticBUOutline0.m940m("Invalid view edge position value: ", i, ". Must be 0, 1 or 2.");
            }
        }
    }
    ...
    public static <V extends View> HideViewOnScrollBehavior<V> from(V v) {
        ...
        if (!(behavior instanceof HideViewOnScrollBehavior)) {
            g$$ExternalSyntheticBUOutline1.m207m("The view is not associated with HideViewOnScrollBehavior");
            return null;
        }
