...
public class MaterialSwitch extends SwitchCompat {
    private static final int DEF_STYLE_RES = C1379R.style.Widget_Material3_CompoundButton_MaterialSwitch;
    private static final int[] STATE_SET_WITH_ICON = {C1379R.attr.state_with_icon};
    ...
    public MaterialSwitch(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1379R.attr.materialSwitchStyle);
    }
    ...
    public MaterialSwitch(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray tintTypedArrayObtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attributeSet, C1379R.styleable.MaterialSwitch, i, i2, new int[0]);
        this.thumbIconDrawable = tintTypedArrayObtainTintedStyledAttributes.getDrawable(C1379R.styleable.MaterialSwitch_thumbIcon);
        this.thumbIconSize = tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelSize(C1379R.styleable.MaterialSwitch_thumbIconSize, -1);
        this.thumbIconTintList = tintTypedArrayObtainTintedStyledAttributes.getColorStateList(C1379R.styleable.MaterialSwitch_thumbIconTint);
        int i3 = tintTypedArrayObtainTintedStyledAttributes.getInt(C1379R.styleable.MaterialSwitch_thumbIconTintMode, -1);
        PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
        this.thumbIconTintMode = ViewUtils.parseTintMode(i3, mode);
        this.trackDecorationDrawable = tintTypedArrayObtainTintedStyledAttributes.getDrawable(C1379R.styleable.MaterialSwitch_trackDecoration);
        this.trackDecorationTintList = tintTypedArrayObtainTintedStyledAttributes.getColorStateList(C1379R.styleable.MaterialSwitch_trackDecorationTint);
        this.trackDecorationTintMode = ViewUtils.parseTintMode(tintTypedArrayObtainTintedStyledAttributes.getInt(C1379R.styleable.MaterialSwitch_trackDecorationTintMode, -1), mode);
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        FocusRingDrawable focusRingDrawableFind;
        super.onLayout(z, i, i2, i3, i4);
        if (this.trackDrawable == null || (focusRingDrawableFind = FocusRingDrawable.find(getBackground())) == null) {
            return;
        }
        focusRingDrawableFind.mutate();
        focusRingDrawableFind.setFocusRingBounds(this.trackDrawable.getBounds());
    }
