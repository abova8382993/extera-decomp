...
public final class ThemeEnforcement {
    ...
    private static final int[] MATERIAL_CHECK_ATTRS = {C1379R.attr.colorPrimaryVariant};
    ...
    private static void checkCompatibleTheme(Context context, AttributeSet attributeSet, int i, int i2) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1379R.styleable.ThemeEnforcement, i, i2);
        boolean z = typedArrayObtainStyledAttributes.getBoolean(C1379R.styleable.ThemeEnforcement_enforceMaterialTheme, false);
        typedArrayObtainStyledAttributes.recycle();
        if (z) {
            TypedValue typedValue = new TypedValue();
            if (!context.getTheme().resolveAttribute(C1379R.attr.isMaterialTheme, typedValue, true) || (typedValue.type == 18 && typedValue.data == 0)) {
    ...
    private static void checkTextAppearance(Context context, AttributeSet attributeSet, int[] iArr, int i, int i2, int... iArr2) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1379R.styleable.ThemeEnforcement, i, i2);
        if (!typedArrayObtainStyledAttributes.getBoolean(C1379R.styleable.ThemeEnforcement_enforceTextAppearance, false)) {
            typedArrayObtainStyledAttributes.recycle();
            return;
        }
        if (iArr2 == null || iArr2.length == 0) {
            zIsCustomTextAppearanceValid = typedArrayObtainStyledAttributes.getResourceId(C1379R.styleable.ThemeEnforcement_android_textAppearance, -1) != -1;
        } else {
        ...
        g$$ExternalSyntheticBUOutline1.m207m("This component requires that you specify a valid TextAppearance attribute. Update your app theme to inherit from Theme.MaterialComponents (or a descendant).");
    }
    ...
    public static boolean isMaterial3Theme(Context context) {
        return MaterialAttributes.resolveBoolean(context, C1379R.attr.isMaterial3Theme, false);
    }
    ...
    private static void checkTheme(Context context, int[] iArr, String str) {
        ...
        Native$$ExternalSyntheticBUOutline0.m549m("The style on this component requires your app theme to be ", str, " (or a descendant).");
    }
}
