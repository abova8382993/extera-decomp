...
public class ShadowDrawableWrapper extends DrawableWrapperCompat {
    ...
    public ShadowDrawableWrapper(Context context, Drawable drawable, float f, float f2, float f3) {
        ...
        this.shadowStartColor = ContextCompat.getColor(context, C1379R.color.design_fab_shadow_start_color);
        this.shadowMiddleColor = ContextCompat.getColor(context, C1379R.color.design_fab_shadow_mid_color);
        this.shadowEndColor = ContextCompat.getColor(context, C1379R.color.design_fab_shadow_end_color);
    ...
    public void setShadowSize(float f, float f2) {
        if (f < 0.0f || f2 < 0.0f) {
            g$$ExternalSyntheticBUOutline1.m207m("invalid shadow size");
            return;
        }
        float even = toEven(f);
