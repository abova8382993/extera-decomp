...
public final class MaterialShapes {
    ...
    public static Matrix createScaleMatrix(float f, float f2) {
        Matrix matrix = new Matrix();
        matrix.setScale(f, f2);
        return matrix;
    }

    public static Matrix createRotationMatrix(float f) {
        Matrix matrix = new Matrix();
        matrix.setRotate(f);
        return matrix;
    }

    public static Matrix createSkewMatrix(float f, float f2) {
        Matrix matrix = new Matrix();
        matrix.setSkew(f, f2);
        return matrix;
    }
