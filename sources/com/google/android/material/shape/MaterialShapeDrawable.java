...
public class MaterialShapeDrawable extends Drawable implements Shapeable {
    ...
    /* JADX INFO: renamed from: com.google.android.material.shape.MaterialShapeDrawable$1 */
    public class C16061 implements ShapeAppearanceModel.CornerSizeUnaryOperator {
        public C16061() {
        }
    ...
    public static MaterialShapeDrawable createWithElevationOverlay(Context context, float f, ColorStateList colorStateList) {
        if (colorStateList == null) {
            colorStateList = ColorStateList.valueOf(MaterialColors.getColor(context, C1379R.attr.colorSurface, MaterialShapeDrawable.class.getSimpleName()));
        }
    ...
    /* JADX INFO: renamed from: com.google.android.material.shape.MaterialShapeDrawable$2 */
    public class C16072 implements ShapeAppearancePathProvider.PathListener {
        public C16072() {
        }
    ...
    public StateListShapeAppearanceModel getStateListShapeAppearanceModel() {
        ShapeAppearance shapeAppearance = this.drawableState.shapeAppearance;
        if (shapeAppearance instanceof StateListShapeAppearanceModel) {
            return (StateListShapeAppearanceModel) shapeAppearance;
        }
        return null;
    }
    ...
    private void maybeDrawCompatShadow(Canvas canvas) {
        if (hasCompatShadow()) {
            ...
            if (iWidth < 0 || iHeight < 0) {
                throw new IllegalStateException("Invalid shadow bounds. Check that the treatments result in a valid path. extra width: " + iWidth + " extra height: " + iHeight + " path bounds: " + this.pathBounds);
            }
    ...
    public float calculateRoundRectCornerSize() {
        float fCalculateRoundRectCornerSize = calculateRoundRectCornerSize(getBoundsAsRectF(), this.drawableState.shapeAppearance.getDefaultShape(), this.springAnimatedCornerSizes);
        return fCalculateRoundRectCornerSize >= 0.0f ? fCalculateRoundRectCornerSize * this.drawableState.interpolation : fCalculateRoundRectCornerSize;
    }
