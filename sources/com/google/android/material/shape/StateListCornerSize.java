    ...
    private void loadCornerSizesFromItems(Context context, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next == 2 && depth2 <= depth && xmlPullParser.getName().equals("item")) {
                ...
                if (theme == null) {
                    typedArrayObtainStyledAttributes = resources.obtainAttributes(attributeSet, C1349R.styleable.ShapeAppearance);
                } else {
                    typedArrayObtainStyledAttributes = theme.obtainStyledAttributes(attributeSet, C1349R.styleable.ShapeAppearance, 0, 0);
                }
                CornerSize cornerSize = ShapeAppearanceModel.getCornerSize(typedArrayObtainStyledAttributes, C1349R.styleable.ShapeAppearance_cornerSize, new AbsoluteCornerSize(0.0f));
                ...
                for (int i2 = 0; i2 < attributeCount; i2++) {
                    ...
                    if (attributeNameResource != C1349R.attr.cornerSize) {
                        int i3 = i + 1;
