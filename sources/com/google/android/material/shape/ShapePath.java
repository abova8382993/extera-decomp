...
public class ShapePath {
    ...
    public void lineTo(float f, float f2) {
        ...
        pathLineOperation.f434x = f;
        pathLineOperation.f435y = f2;
    ...
    public void lineTo(float f, float f2, float f3, float f4) {
        ...
        pathLineOperation2.f434x = f3;
        pathLineOperation2.f435y = f4;
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot(this.operation.f435y - this.startY, this.operation.f434x - this.startX), 0.0f);
        ...
        float getAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation.f435y - this.startY) / (this.operation.f434x - this.startX)));
        }
    }
    ...
    static class InnerCornerShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            ...
            double dHypot = Math.hypot(this.operation1.f434x - this.startX, this.operation1.f435y - this.startY);
            double dHypot2 = Math.hypot(this.operation2.f434x - this.operation1.f434x, this.operation2.f435y - this.operation1.f435y);
            ...
            this.renderMatrix.set(matrix);
            this.renderMatrix.preTranslate(this.operation1.f434x, this.operation1.f435y);
            this.renderMatrix.preRotate(getStartAngle());
        ...
        float getStartAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation1.f435y - this.startY) / (this.operation1.f434x - this.startX)));
        }

        float getEndAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation2.f435y - this.operation1.f435y) / (this.operation2.f434x - this.operation1.f434x)));
        }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        public void applyToPath(Matrix matrix, Path path) {
            ...
            path.lineTo(this.f434x, this.f435y);
