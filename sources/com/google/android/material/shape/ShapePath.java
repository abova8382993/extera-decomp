...
public class ShapePath {
    ...
    public void lineTo(float f, float f2) {
        ...
        pathLineOperation.f485x = f;
        pathLineOperation.f486y = f2;
    ...
    public void lineTo(float f, float f2, float f3, float f4) {
        ...
        pathLineOperation2.f485x = f3;
        pathLineOperation2.f486y = f4;
    ...
    public static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot(this.operation.f486y - this.startY, this.operation.f485x - this.startX), 0.0f);
        ...
        public float getAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation.f486y - this.startY) / (this.operation.f485x - this.startX)));
        }
    }
    ...
    public static class InnerCornerShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            ...
            double dHypot = Math.hypot(this.operation1.f485x - this.startX, this.operation1.f486y - this.startY);
            double dHypot2 = Math.hypot(this.operation2.f485x - this.operation1.f485x, this.operation2.f486y - this.operation1.f486y);
            ...
            this.renderMatrix.set(matrix);
            this.renderMatrix.preTranslate(this.operation1.f485x, this.operation1.f486y);
            this.renderMatrix.preRotate(getStartAngle());
        ...
        public float getStartAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation1.f486y - this.startY) / (this.operation1.f485x - this.startX)));
        }

        public float getEndAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation2.f486y - this.operation1.f486y) / (this.operation2.f485x - this.operation1.f485x)));
        }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        public void applyToPath(Matrix matrix, Path path) {
            ...
            path.lineTo(this.f485x, this.f486y);
