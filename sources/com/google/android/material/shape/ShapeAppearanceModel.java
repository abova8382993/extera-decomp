...
public class ShapeAppearanceModel implements ShapeAppearance {
    ...
    public /* synthetic */ ShapeAppearanceModel(Builder builder, C16091 c16091) {
        this(builder);
    }
    ...
    public static Builder builder(Context context, AttributeSet attributeSet, int i, int i2, CornerSize cornerSize) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1379R.styleable.MaterialShape, i, i2);
        int resourceId = typedArrayObtainStyledAttributes.getResourceId(C1379R.styleable.MaterialShape_shapeAppearance, 0);
        int resourceId2 = typedArrayObtainStyledAttributes.getResourceId(C1379R.styleable.MaterialShape_shapeAppearanceOverlay, 0);
    ...
    public static Builder builder(Resources.Theme theme, int i) {
        return builder(theme.obtainStyledAttributes(i, C1379R.styleable.ShapeAppearance), new AbsoluteCornerSize(0.0f));
    }
    ...
    private static Builder builder(Context context, int i, int i2, CornerSize cornerSize) {
        ...
        return builder(contextThemeWrapper.obtainStyledAttributes(C1379R.styleable.ShapeAppearance), cornerSize);
    }

    private static Builder builder(TypedArray typedArray, CornerSize cornerSize) {
        try {
            int i = typedArray.getInt(C1379R.styleable.ShapeAppearance_cornerFamily, 0);
            int i2 = typedArray.getInt(C1379R.styleable.ShapeAppearance_cornerFamilyTopLeft, i);
            int i3 = typedArray.getInt(C1379R.styleable.ShapeAppearance_cornerFamilyTopRight, i);
            int i4 = typedArray.getInt(C1379R.styleable.ShapeAppearance_cornerFamilyBottomRight, i);
            int i5 = typedArray.getInt(C1379R.styleable.ShapeAppearance_cornerFamilyBottomLeft, i);
            CornerSize cornerSize2 = getCornerSize(typedArray, C1379R.styleable.ShapeAppearance_cornerSize, cornerSize);
            CornerSize cornerSize3 = getCornerSize(typedArray, C1379R.styleable.ShapeAppearance_cornerSizeTopLeft, cornerSize2);
            CornerSize cornerSize4 = getCornerSize(typedArray, C1379R.styleable.ShapeAppearance_cornerSizeTopRight, cornerSize2);
            CornerSize cornerSize5 = getCornerSize(typedArray, C1379R.styleable.ShapeAppearance_cornerSizeBottomRight, cornerSize2);
            return new Builder().setTopLeftCorner(i2, cornerSize3).setTopRightCorner(i3, cornerSize4).setBottomRightCorner(i4, cornerSize5).setBottomLeftCorner(i5, getCornerSize(typedArray, C1379R.styleable.ShapeAppearance_cornerSizeBottomLeft, cornerSize2));
        } finally {
            typedArray.recycle();
        }
    }
