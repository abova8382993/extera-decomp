...
public final class SlideDistanceProvider implements VisibilityAnimatorProvider {
    ...
    public void setSlideDistance(int i) {
        if (i < 0) {
            g$$ExternalSyntheticBUOutline1.m207m("Slide distance must be positive. If attempting to reverse the direction of the slide, use setSlideEdge(int) instead.");
        } else {
    ...
    private int getSlideDistanceOrDefault(Context context) {
        ...
        return i != -1 ? i : context.getResources().getDimensionPixelSize(C1379R.dimen.mtrl_transition_shared_axis_slide_distance);
    }
    ...
    private static Animator createTranslationAppearAnimator(View view, View view2, int i, int i2) {
        ...
        CharCodeKt$$ExternalSyntheticBUOutline0.m873m("Invalid slide direction: ", i);
        return null;
    }
