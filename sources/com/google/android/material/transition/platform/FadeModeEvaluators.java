...
class FadeModeEvaluators {
    ...
    private static final FadeModeEvaluator f492IN = new FadeModeEvaluator() { // from class: com.google.android.material.transition.platform.FadeModeEvaluators.1
    ...
    public static FadeModeEvaluator get(int i, boolean z) {
        ...
        CharCodeKt$$ExternalSyntheticBUOutline0.m873m("Invalid fade mode: ", i);
        return null;
    }
