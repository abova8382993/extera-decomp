...
class LoadingIndicatorAnimatorDelegate {
    ...
    private void maybeInitializeAnimators() {
        if (this.springAnimation == null) {
            this.springAnimation = (SpringAnimation) new SpringAnimation(this, MORPH_FACTOR).setSpring(new SpringForce().setStiffness(SPRING_STIFFNESS).setDampingRatio(SPRING_DAMPING_RATIO)).setMinimumVisibleChange(0.01f);
        }
    ...
    class C15051 extends AnimatorListenerAdapter {
        C15051() {
        }
    ...
    class C15062 extends Property<LoadingIndicatorAnimatorDelegate, Float> {
        C15062(Class cls, String str) {
            super(cls, str);
        }
    ...
    class C15073 extends FloatPropertyCompat {
        C15073(String str) {
            super(str);
        }
