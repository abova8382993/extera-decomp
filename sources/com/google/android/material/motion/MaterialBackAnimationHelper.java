...
public abstract class MaterialBackAnimationHelper<V extends View> {
    ...
    public MaterialBackAnimationHelper(V v) {
        ...
        this.hideDurationMax = MotionUtils.resolveThemeDuration(context, C1379R.attr.motionDurationMedium2, 300);
        this.hideDurationMin = MotionUtils.resolveThemeDuration(context, C1379R.attr.motionDurationShort3, 150);
        this.cancelDuration = MotionUtils.resolveThemeDuration(context, C1379R.attr.motionDurationShort2, 100);
    }
