...
public class ElevationOverlayProvider {
    ...
    public ElevationOverlayProvider(Context context) {
        this(MaterialAttributes.resolveBoolean(context, C1379R.attr.elevationOverlayEnabled, false), MaterialColors.getColor(context, C1379R.attr.elevationOverlayColor, 0), MaterialColors.getColor(context, C1379R.attr.elevationOverlayAccentColor, 0), MaterialColors.getColor(context, C1379R.attr.colorSurface, 0), context.getResources().getDisplayMetrics().density);
    }
