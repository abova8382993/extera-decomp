...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    private static final int DEF_STYLE_RES = C1379R.style.Widget_Design_AppBarLayout;
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1379R.attr.appBarLayoutStyle);
    }
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C1379R.styleable.AppBarLayout, i, i2, new int[0]);
        this.liftOnScrollColor = MaterialResources.getColorStateList(context2, typedArrayObtainStyledAttributes, C1379R.styleable.AppBarLayout_liftOnScrollColor);
        this.liftOnScrollColorDuration = MotionUtils.resolveThemeDuration(context2, C1379R.attr.motionDurationMedium2, getResources().getInteger(C1379R.integer.app_bar_elevation_anim_duration));
        this.liftOnScrollColorInterpolator = MotionUtils.resolveThemeInterpolator(context2, C1379R.attr.motionEasingStandardInterpolator, AnimationUtils.LINEAR_INTERPOLATOR);
        if (typedArrayObtainStyledAttributes.hasValue(C1379R.styleable.AppBarLayout_expanded)) {
            setExpanded(typedArrayObtainStyledAttributes.getBoolean(C1379R.styleable.AppBarLayout_expanded, false), false, false);
        }
        if (typedArrayObtainStyledAttributes.hasValue(C1379R.styleable.AppBarLayout_elevation)) {
            ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(this, typedArrayObtainStyledAttributes.getDimensionPixelSize(C1379R.styleable.AppBarLayout_elevation, 0));
        }
        setBackground(typedArrayObtainStyledAttributes.getDrawable(C1379R.styleable.AppBarLayout_android_background));
        if (Build.VERSION.SDK_INT >= 26) {
            if (typedArrayObtainStyledAttributes.hasValue(C1379R.styleable.AppBarLayout_android_keyboardNavigationCluster)) {
                setKeyboardNavigationCluster(typedArrayObtainStyledAttributes.getBoolean(C1379R.styleable.AppBarLayout_android_keyboardNavigationCluster, false));
            }
            if (typedArrayObtainStyledAttributes.hasValue(C1379R.styleable.AppBarLayout_android_touchscreenBlocksFocus)) {
                setTouchscreenBlocksFocus(typedArrayObtainStyledAttributes.getBoolean(C1379R.styleable.AppBarLayout_android_touchscreenBlocksFocus, false));
            }
        }
        this.appBarElevation = getResources().getDimension(C1379R.dimen.design_appbar_elevation);
        this.liftOnScroll = typedArrayObtainStyledAttributes.getBoolean(C1379R.styleable.AppBarLayout_liftOnScroll, false);
        this.liftOnScrollTargetViewId = typedArrayObtainStyledAttributes.getResourceId(C1379R.styleable.AppBarLayout_liftOnScrollTargetViewId, -1);
        setStatusBarForeground(typedArrayObtainStyledAttributes.getDrawable(C1379R.styleable.AppBarLayout_statusBarForeground));
    ...
    public class C13821 implements OnApplyWindowInsetsListener {
        public C13821() {
        }
    ...
    private void initializeLiftOnScrollWithColor(final MaterialShapeDrawable materialShapeDrawable, final ColorStateList colorStateList) {
        final Integer colorOrNull = MaterialColors.getColorOrNull(getContext(), C1379R.attr.colorSurface);
        this.liftOnScrollColorUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.appbar.AppBarLayout$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                AppBarLayout.$r8$lambda$pWyguk4NB6CmY3Ase6MwHO_zXKU(this.f$0, colorStateList, materialShapeDrawable, colorOrNull, valueAnimator);
            }
        };
    }

    public static /* synthetic */ void $r8$lambda$pWyguk4NB6CmY3Ase6MwHO_zXKU(AppBarLayout appBarLayout, ColorStateList colorStateList, MaterialShapeDrawable materialShapeDrawable, Integer num, ValueAnimator valueAnimator) {
        Integer num2;
        appBarLayout.getClass();
        float fFloatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        int iLayer = MaterialColors.layer(appBarLayout.backgroundOriginalColor, colorStateList.getDefaultColor(), fFloatValue);
    ...
    private void initializeLiftOnScrollWithElevation(Context context, final MaterialShapeDrawable materialShapeDrawable) {
        ...
        this.liftOnScrollColorUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.appbar.AppBarLayout$$ExternalSyntheticLambda1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                AppBarLayout.$r8$lambda$PpQ1I3993Gy02bYDF0fSWxB_DpQ(this.f$0, materialShapeDrawable, valueAnimator);
            }
        };
    }

    public static /* synthetic */ void $r8$lambda$PpQ1I3993Gy02bYDF0fSWxB_DpQ(AppBarLayout appBarLayout, MaterialShapeDrawable materialShapeDrawable, ValueAnimator valueAnimator) {
        appBarLayout.getClass();
        float fFloatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        ...
        Iterator<LiftOnScrollProgressListener> it2 = appBarLayout.liftProgressListeners.iterator();
        while (it2.hasNext()) {
            it2.next().onUpdate(fFloatValue, materialShapeDrawable.getResolvedTintColor(), fFloatValue / appBarLayout.appBarElevation);
        }
    }
    ...
    public void setOrientation(int i) {
        if (i != 1) {
            g$$ExternalSyntheticBUOutline1.m207m("AppBarLayout is always vertical and does not support horizontal orientation");
        } else {
    ...
    public int[] onCreateDrawableState(int i) {
        ...
        int i2 = C1379R.attr.state_liftable;
        if (!z) {
            i2 = -i2;
        }
        iArr[0] = i2;
        iArr[1] = (z && this.lifted) ? C1379R.attr.state_lifted : -C1379R.attr.state_lifted;
        int i3 = C1379R.attr.state_collapsible;
        if (!z) {
            i3 = -i3;
        }
        iArr[2] = i3;
        iArr[3] = (z && this.lifted) ? C1379R.attr.state_collapsed : -C1379R.attr.state_collapsed;
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.scrollFlags = 1;
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1379R.styleable.AppBarLayout_Layout);
            this.scrollFlags = typedArrayObtainStyledAttributes.getInt(C1379R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            setScrollEffect(typedArrayObtainStyledAttributes.getInt(C1379R.styleable.AppBarLayout_Layout_layout_scrollEffect, 0));
            if (typedArrayObtainStyledAttributes.hasValue(C1379R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                this.scrollInterpolator = android.view.animation.AnimationUtils.loadInterpolator(context, typedArrayObtainStyledAttributes.getResourceId(C1379R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0));
            }
            typedArrayObtainStyledAttributes.recycle();
        }
        ...
        */
        public void onNestedPreScroll(androidx.coordinatorlayout.widget.CoordinatorLayout r7, T r8, android.view.View r9, int r10, int r11, int[] r12, int r13) {
            ...
            L18:
                ...
                r2 = r8
                r3 = r11
                int r6 = r0.scroll(r1, r2, r3, r4, r5)
                r12[r10] = r6
                goto L27
            L26:
                r2 = r8
            L27:
                boolean r6 = r2.isLiftOnScroll()
                if (r6 == 0) goto L34
                boolean r6 = r2.shouldLift(r9)
                r2.setLiftedState(r6)
            L34:
                return
            */
        ...
        private void animateOffsetWithDuration(CoordinatorLayout coordinatorLayout, T t, int i, int i2) {
            ...
            if (valueAnimator == null) {
                ...
                this.offsetAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.appbar.AppBarLayout.BaseBehavior.1
                    ...
                    public C13831(CoordinatorLayout coordinatorLayout2, AppBarLayout t2) {
                        coordinatorLayout = coordinatorLayout2;
                        appBarLayout = t2;
                    }
                    ...
                    public void onAnimationUpdate(ValueAnimator valueAnimator3) {
                        BaseBehavior.this.setHeaderTopBottomOffset(coordinatorLayout, appBarLayout, ((Integer) valueAnimator3.getAnimatedValue()).intValue());
                    }
                });
            } else {
                valueAnimator.cancel();
        ...
        public class C13831 implements ValueAnimator.AnimatorUpdateListener {
            final /* synthetic */ AppBarLayout val$child;
            final /* synthetic */ CoordinatorLayout val$coordinatorLayout;
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, T t, int i) {
            ...
            if (savedState == null || (pendingAction & 8) != 0) {
                ...
                if (this.savedState.firstVisibleChildAtMinimumHeight) {
                    iRound = childAt.getMinimumHeight() + t.getTopInset();
                } else {
        ...
        private void addAccessibilityDelegateIfNeeded(CoordinatorLayout coordinatorLayout, T t) {
            ...
            ViewCompat.setAccessibilityDelegate(coordinatorLayout, new AccessibilityDelegateCompat() { // from class: com.google.android.material.appbar.AppBarLayout.BaseBehavior.2
                ...
                public C13842(AppBarLayout t2, CoordinatorLayout coordinatorLayout2) {
                    appBarLayout = t2;
                    coordinatorLayout = coordinatorLayout2;
                }
                    ...
                    if (i == 8192) {
                        if (BaseBehavior.this.getTopBottomOffsetForScrollingSibling() != 0) {
                            ...
                            if (zCanScrollVertically) {
                                ...
                                if (i2 != 0) {
                                    BaseBehavior.this.onNestedPreScroll(coordinatorLayout, appBarLayout, childWithScrollingBehavior, 0, i2, new int[]{0, 0}, 1);
                                    return true;
                                }
                            } else {
        ...
        public class C13842 extends AccessibilityDelegateCompat {
            final /* synthetic */ AppBarLayout val$appBarLayout;
            final /* synthetic */ CoordinatorLayout val$coordinatorLayout;
        ...
        public static class SavedState extends AbsSavedState {
            ...
            public class C13851 implements Parcelable.ClassLoaderCreator<SavedState> {
                @Override // android.os.Parcelable.ClassLoaderCreator
                public SavedState createFromParcel(Parcel parcel, ClassLoader classLoader) {
                    return new SavedState(parcel, classLoader);
                }
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1379R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(typedArrayObtainStyledAttributes.getDimensionPixelSize(C1379R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            typedArrayObtainStyledAttributes.recycle();
        }
