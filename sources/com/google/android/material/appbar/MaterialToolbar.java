...
public class MaterialToolbar extends Toolbar {
    private static final int DEF_STYLE_RES = C1349R.style.Widget_MaterialComponents_Toolbar;
    ...
    public MaterialToolbar(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C1349R.styleable.MaterialToolbar, i, i2, new int[0]);
        if (typedArrayObtainStyledAttributes.hasValue(C1349R.styleable.MaterialToolbar_navigationIconTint)) {
            setNavigationIconTint(typedArrayObtainStyledAttributes.getColor(C1349R.styleable.MaterialToolbar_navigationIconTint, -1));
        }
        this.titleCentered = typedArrayObtainStyledAttributes.getBoolean(C1349R.styleable.MaterialToolbar_titleCentered, false);
        this.subtitleCentered = typedArrayObtainStyledAttributes.getBoolean(C1349R.styleable.MaterialToolbar_subtitleCentered, false);
        int i3 = typedArrayObtainStyledAttributes.getInt(C1349R.styleable.MaterialToolbar_logoScaleType, -1);
        if (i3 >= 0) {
        ...
        if (typedArrayObtainStyledAttributes.hasValue(C1349R.styleable.MaterialToolbar_logoAdjustViewBounds)) {
            this.logoAdjustViewBounds = Boolean.valueOf(typedArrayObtainStyledAttributes.getBoolean(C1349R.styleable.MaterialToolbar_logoAdjustViewBounds, false));
        }
    ...
    private void layoutTitleCenteredHorizontally(View view, Pair<Integer, Integer> pair) {
        ...
        if (iMax > 0) {
            i += iMax;
            i2 -= iMax;
            view.measure(View.MeasureSpec.makeMeasureSpec(i2 - i, TLObject.FLAG_30), view.getMeasuredHeightAndState());
        }
