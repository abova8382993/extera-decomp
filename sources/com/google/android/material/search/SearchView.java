...
public class SearchView extends FrameLayout implements CoordinatorLayout.AttachedBehavior, MaterialBackHandler {
    private static final int DEF_STYLE_RES = C1349R.style.Widget_Material3_SearchView;
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1349R.attr.materialSearchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C1349R.styleable.SearchView, i, i2, new int[0]);
        this.backgroundColor = typedArrayObtainStyledAttributes.getColor(C1349R.styleable.SearchView_backgroundTint, 0);
        int resourceId = typedArrayObtainStyledAttributes.getResourceId(C1349R.styleable.SearchView_headerLayout, -1);
        int resourceId2 = typedArrayObtainStyledAttributes.getResourceId(C1349R.styleable.SearchView_android_textAppearance, -1);
        String string = typedArrayObtainStyledAttributes.getString(C1349R.styleable.SearchView_android_text);
        String string2 = typedArrayObtainStyledAttributes.getString(C1349R.styleable.SearchView_android_hint);
        String string3 = typedArrayObtainStyledAttributes.getString(C1349R.styleable.SearchView_searchPrefixText);
        boolean z = typedArrayObtainStyledAttributes.getBoolean(C1349R.styleable.SearchView_useDrawerArrowDrawable, false);
        this.animatedNavigationIcon = typedArrayObtainStyledAttributes.getBoolean(C1349R.styleable.SearchView_animateNavigationIcon, true);
        this.animatedMenuItems = typedArrayObtainStyledAttributes.getBoolean(C1349R.styleable.SearchView_animateMenuItems, true);
        boolean z2 = typedArrayObtainStyledAttributes.getBoolean(C1349R.styleable.SearchView_hideNavigationIcon, false);
        this.autoShowKeyboard = typedArrayObtainStyledAttributes.getBoolean(C1349R.styleable.SearchView_autoShowKeyboard, true);
        this.backHandlingEnabled = typedArrayObtainStyledAttributes.getBoolean(C1349R.styleable.SearchView_backHandlingEnabled, true);
        this.dividerVisible = typedArrayObtainStyledAttributes.getBoolean(C1349R.styleable.SearchView_dividerVisible, true);
        boolean z3 = typedArrayObtainStyledAttributes.getBoolean(C1349R.styleable.SearchView_containedAnimationEnabled, false);
        this.containedAnimationEnabled = z3;
        typedArrayObtainStyledAttributes.recycle();
        LayoutInflater.from(context2).inflate(C1349R.layout.mtrl_search_view, this);
        this.layoutInflated = true;
        this.scrim = findViewById(C1349R.id.open_search_view_scrim);
        this.rootView = (ClippableRoundedCornerLayout) findViewById(C1349R.id.open_search_view_root);
        this.backgroundView = findViewById(C1349R.id.open_search_view_background);
        this.statusBarSpacer = findViewById(C1349R.id.open_search_view_status_bar_spacer);
        this.headerContainer = (FrameLayout) findViewById(C1349R.id.open_search_view_header_container);
        this.toolbarContainer = (FrameLayout) findViewById(C1349R.id.open_search_view_toolbar_container);
        this.toolbar = (MaterialToolbar) findViewById(C1349R.id.open_search_view_toolbar);
        this.dummyToolbar = (Toolbar) findViewById(C1349R.id.open_search_view_dummy_toolbar);
        this.dummyTextView = (TextView) findViewById(C1349R.id.open_search_view_dummy_text_view);
        this.searchPrefix = (TextView) findViewById(C1349R.id.open_search_view_search_prefix);
        this.textContainer = (LinearLayout) findViewById(C1349R.id.open_search_view_text_container);
        this.editText = (EditText) findViewById(C1349R.id.open_search_view_edit_text);
        this.clearButton = (ImageButton) findViewById(C1349R.id.open_search_view_clear_button);
        this.divider = findViewById(C1349R.id.open_search_view_divider);
        this.contentContainer = (TouchObserverFrameLayout) findViewById(C1349R.id.open_search_view_content_container);
    ...
    public static /* synthetic */ boolean m3484$r8$lambda$m5jol66nZNnGCtW581117_ung(View view, MotionEvent motionEvent) {
        return true;
    }
    ...
    private void setUpRootView() {
        this.rootView.setOnTouchListener(new View.OnTouchListener() { // from class: com.google.android.material.search.SearchView$$ExternalSyntheticLambda6
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return SearchView.m3484$r8$lambda$m5jol66nZNnGCtW581117_ung(view, motionEvent);
            }
        });
    }
    ...
    private float getOverlayElevation() {
        ...
        return getResources().getDimension(C1349R.dimen.m3_searchview_elevation);
    }
    ...
    private void setUpBackButton(boolean z, boolean z2) {
        ...
        if (z) {
            ...
            drawerArrowDrawable.setColor(MaterialColors.getColor(this, C1349R.attr.colorOnSurface));
    ...
    private void setUpClearButton() {
        this.clearButton.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.search.SearchView$$ExternalSyntheticLambda12
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                SearchView.m3481$r8$lambda$jEPC5P2snL5cxZFNR2VSY2UDU(this.f$0, view);
            }
        });
    ...
    public static /* synthetic */ void m3481$r8$lambda$jEPC5P2snL5cxZFNR2VSY2UDU(SearchView searchView, View view) {
    ...
    private void setUpToolbarInsetListener() {
        ViewUtils.doOnApplyWindowInsets(this.toolbar, new ViewUtils.OnApplyWindowInsetsListener() { // from class: com.google.android.material.search.SearchView$$ExternalSyntheticLambda2
            ...
            public final WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat, ViewUtils.RelativePadding relativePadding) {
                return SearchView.m3482$r8$lambda$kajH3YISJpjEqc1frQhPp6eysc(this.f$0, view, windowInsetsCompat, relativePadding);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$kajH3YISJpjEqc1frQhPp6eys-c, reason: not valid java name */
    public static /* synthetic */ WindowInsetsCompat m3482$r8$lambda$kajH3YISJpjEqc1frQhPp6eysc(SearchView searchView, View view, WindowInsetsCompat windowInsetsCompat, ViewUtils.RelativePadding relativePadding) {
    ...
    void requestFocusAndShowKeyboardIfNeeded() {
        if (this.autoShowKeyboard) {
            ...
            this.editText.postDelayed(new Runnable() { // from class: com.google.android.material.search.SearchView$$ExternalSyntheticLambda8
                @Override // java.lang.Runnable
                public final void run() {
                    SearchView.m3480$r8$lambda$hjCk2cQgBXiiPy2VRWY45FZQT8(this.f$0);
                }
    ...
    public static /* synthetic */ void m3480$r8$lambda$hjCk2cQgBXiiPy2VRWY45FZQT8(SearchView searchView) {
    ...
    public void requestFocusAndShowKeyboard() {
        this.editText.postDelayed(new Runnable() { // from class: com.google.android.material.search.SearchView$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                SearchView.m3483$r8$lambda$lAHMLoHAC9X2g5ElTDzRS4Ig4s(this.f$0);
            }
        }, TALKBACK_FOCUS_CHANGE_DELAY_MS);
    }

    /* JADX INFO: renamed from: $r8$lambda$lAHMLoHAC9X-2g5ElTDzRS4Ig4s, reason: not valid java name */
    public static /* synthetic */ void m3483$r8$lambda$lAHMLoHAC9X2g5ElTDzRS4Ig4s(SearchView searchView) {
        if (searchView.editText.requestFocus()) {
            searchView.editText.sendAccessibilityEvent(8);
        }
    ...
    protected int getDefaultNavigationIconResource() {
        return C1349R.drawable.ic_arrow_back_black_24;
    }
