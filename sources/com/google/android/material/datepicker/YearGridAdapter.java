...
class YearGridAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        return new ViewHolder((TextView) LayoutInflater.from(viewGroup.getContext()).inflate(C1379R.layout.mtrl_calendar_year, viewGroup, false));
    }
    ...
    /* JADX INFO: renamed from: com.google.android.material.datepicker.YearGridAdapter$1 */
    public class ViewOnClickListenerC14881 implements View.OnClickListener {
        final /* synthetic */ int val$year;

        public ViewOnClickListenerC14881(int i) {
            i = i;
        }
    ...
    private View.OnClickListener createYearClickListener(int i) {
        return new View.OnClickListener() { // from class: com.google.android.material.datepicker.YearGridAdapter.1
            ...
            public ViewOnClickListenerC14881(int i2) {
                i = i2;
            }
