...
public final class CalendarConstraints implements Parcelable {
    ...
    private CalendarConstraints(Month month, Month month2, DateValidator dateValidator, Month month3, int i) {
        ...
        if (month3 != null && month.compareTo(month3) > 0) {
            g$$ExternalSyntheticBUOutline1.m207m("start Month cannot be after current Month");
            throw null;
        }
        if (month3 != null && month3.compareTo(month2) > 0) {
            g$$ExternalSyntheticBUOutline1.m207m("current Month cannot be after end Month");
            throw null;
        }
        if (i < 0 || i > UtcDates.getUtcCalendar().getMaximum(7)) {
            g$$ExternalSyntheticBUOutline1.m207m("firstDayOfWeek is not valid");
            throw null;
        }
