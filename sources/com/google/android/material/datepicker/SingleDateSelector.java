...
public class SingleDateSelector implements DateSelector<Long> {
    ...
    public View onCreateTextInputView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle, CalendarConstraints calendarConstraints, final OnSelectionChangedListener<Long> onSelectionChangedListener) {
        ...
        View viewInflate = layoutInflater.inflate(C1349R.layout.mtrl_picker_text_input_date, viewGroup, false);
        final TextInputLayout textInputLayout = (TextInputLayout) viewInflate.findViewById(C1349R.id.mtrl_picker_text_input_date);
    ...
    public int getDefaultThemeResId(Context context) {
        return MaterialAttributes.resolveOrThrow(context, C1349R.attr.materialCalendarTheme, MaterialDatePicker.class.getCanonicalName());
    }
    ...
    public String getSelectionDisplayString(Context context) {
        ...
        Long l = this.selectedItem;
        if (l == null) {
            return resources.getString(C1349R.string.mtrl_picker_date_header_unselected);
        }
        return resources.getString(C1349R.string.mtrl_picker_date_header_selected, DateStrings.getYearMonthDay(l.longValue()));
    }
    ...
    public String getSelectionContentDescription(Context context) {
        ...
        Long l = this.selectedItem;
        if (l == null) {
            yearMonthDay = resources.getString(C1349R.string.mtrl_picker_announce_current_selection_none);
        } else {
            yearMonthDay = DateStrings.getYearMonthDay(l.longValue());
        }
        return resources.getString(C1349R.string.mtrl_picker_announce_current_selection, yearMonthDay);
    }
    ...
    public int getDefaultTitleResId() {
        return C1349R.string.mtrl_picker_date_header_title;
    }
