...
public class MaterialDatePicker<S> extends DialogFragment {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        this.background = new MaterialShapeDrawable(context, null, C1349R.attr.materialCalendarStyle, C1349R.style.Widget_MaterialComponents_MaterialCalendar);
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(null, C1349R.styleable.MaterialCalendar, C1349R.attr.materialCalendarStyle, C1349R.style.Widget_MaterialComponents_MaterialCalendar);
        int color = typedArrayObtainStyledAttributes.getColor(C1349R.styleable.MaterialCalendar_backgroundTint, 0);
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View viewInflate = layoutInflater.inflate(this.fullscreen ? C1349R.layout.mtrl_picker_fullscreen : C1349R.layout.mtrl_picker_dialog, viewGroup);
        ...
        if (this.fullscreen) {
            viewInflate.findViewById(C1349R.id.mtrl_calendar_frame).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -2));
        } else {
            viewInflate.findViewById(C1349R.id.mtrl_calendar_main_pane).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -1));
        }
        TextView textView = (TextView) viewInflate.findViewById(C1349R.id.mtrl_picker_header_selection_text);
        this.headerSelectionText = textView;
        textView.setAccessibilityLiveRegion(1);
        this.headerToggleButton = (CheckableImageButton) viewInflate.findViewById(C1349R.id.mtrl_picker_header_toggle);
        this.headerTitleTextView = (TextView) viewInflate.findViewById(C1349R.id.mtrl_picker_title_text);
        initHeaderToggle(context);
        this.confirmButton = (Button) viewInflate.findViewById(C1349R.id.confirm_button);
        ...
        Button button = (Button) viewInflate.findViewById(C1349R.id.cancel_button);
    ...
    public void onStart() {
        ...
        if (this.fullscreen) {
            ...
            int dimensionPixelOffset = getResources().getDimensionPixelOffset(C1349R.dimen.mtrl_calendar_dialog_background_inset);
    ...
    private void enableEdgeToEdgeIfNeeded(Window window) {
        ...
        View viewFindViewById = requireView().findViewById(C1349R.id.fullscreen_header);
        ...
        ViewCompat.setOnApplyWindowInsetsListener(viewFindViewById, new OnApplyWindowInsetsListener() { // from class: com.google.android.material.datepicker.MaterialDatePicker.1
            ...
            C14471(int i, View viewFindViewById2, int i2, int paddingTop2, int i3) {
                i = i;
            ...
            public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                ...
                if (i >= 0) {
                    view.getLayoutParams().height = i + insets.top;
                    View view2 = view;
                    view2.setLayoutParams(view2.getLayoutParams());
                }
                View view3 = view;
                view3.setPadding(i + insets.left, i + insets.top, i + insets.right, view3.getPaddingBottom());
    ...
    class C14471 implements OnApplyWindowInsetsListener {
        final /* synthetic */ View val$headerLayout;
        final /* synthetic */ int val$originalHeaderHeight;
        final /* synthetic */ int val$originalPaddingLeft;
        final /* synthetic */ int val$originalPaddingRight;
    ...
    private void startPickerFragment() {
        ...
        getChildFragmentManager().beginTransaction().replace(C1349R.id.mtrl_calendar_frame, this.pickerFragment, str).commitNow();
    }

    /* JADX INFO: renamed from: com.google.android.material.datepicker.MaterialDatePicker$2 */
    class C14482 extends OnSelectionChangedListener<S> {
        C14482() {
        }
    ...
    public static /* synthetic */ void $r8$lambda$_7eg0aLhI4_FyxsSORjppBhoKm4(MaterialDatePicker materialDatePicker, View view) {
        ...
        materialDatePicker.updateToggleTooltip(materialDatePicker.headerToggleButton);
    ...
    private void updateToggleContentDescription(CheckableImageButton checkableImageButton) {
        String string;
        if (this.inputMode == 1) {
            string = checkableImageButton.getContext().getString(C1349R.string.mtrl_picker_toggle_to_calendar_input_mode);
        } else {
            string = checkableImageButton.getContext().getString(C1349R.string.mtrl_picker_toggle_to_text_input_mode);
        }
    ...
    private void updateToggleTooltip(CheckableImageButton checkableImageButton) {
        String string;
        if (this.inputMode == 1) {
            string = checkableImageButton.getContext().getString(C1349R.string.mtrl_picker_toggle_to_calendar_input_mode_tooltip);
        } else {
            string = checkableImageButton.getContext().getString(C1349R.string.mtrl_picker_toggle_to_text_input_mode_tooltip);
        }
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        stateListDrawable.addState(new int[]{R.attr.state_checked}, AppCompatResources.getDrawable(context, C1349R.drawable.material_ic_calendar_black_24dp));
        stateListDrawable.addState(new int[0], AppCompatResources.getDrawable(context, C1349R.drawable.material_ic_edit_black_24dp));
    ...
    static boolean isNestedScrollable(Context context) {
        return readMaterialCalendarStyleBoolean(context, C1349R.attr.nestedScrollable);
    }

    static boolean readMaterialCalendarStyleBoolean(Context context, int i) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, C1349R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{i});
    ...
    private static int getPaddedPickerWidth(Context context) {
        ...
        int dimensionPixelOffset = resources.getDimensionPixelOffset(C1349R.dimen.mtrl_calendar_content_padding);
        int i = Month.current().daysInWeek;
        return (dimensionPixelOffset * 2) + (resources.getDimensionPixelSize(C1349R.dimen.mtrl_calendar_day_width) * i) + ((i - 1) * resources.getDimensionPixelOffset(C1349R.dimen.mtrl_calendar_month_horizontal_padding));
    }
    ...
    public static final class Builder<S> {
        ...
        public static Builder<Pair> dateRangePicker() {
