...
class UtcDates {
    ...
    public static String getDefaultTextInputHint(Resources resources, SimpleDateFormat simpleDateFormat) {
        ...
        String string = resources.getString(C1379R.string.mtrl_picker_text_input_year_abbr);
        String string2 = resources.getString(C1379R.string.mtrl_picker_text_input_month_abbr);
        String string3 = resources.getString(C1379R.string.mtrl_picker_text_input_day_abbr);
    ...
    public static String getDatePatternAsInputFormat(String str) {
        return str.replaceAll("[^dMy/\\-.]", _UrlKt.FRAGMENT_ENCODE_SET).replaceAll("d{1,2}", "dd").replaceAll("M{1,2}", "MM").replaceAll("y{1,4}", "yyyy").replaceAll("\\.$", _UrlKt.FRAGMENT_ENCODE_SET).replaceAll("My", "M/y");
    }
