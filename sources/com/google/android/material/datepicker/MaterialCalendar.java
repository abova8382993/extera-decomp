...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (zIsFullscreen) {
            i = C1379R.layout.mtrl_calendar_vertical;
            i2 = 1;
        } else {
            i = C1379R.layout.mtrl_calendar_horizontal;
            i2 = 0;
        }
        View viewInflate = layoutInflaterCloneInContext.inflate(i, viewGroup, false);
        viewInflate.setMinimumHeight(getDialogPickerHeight(requireContext()));
        GridView gridView = (GridView) viewInflate.findViewById(C1379R.id.mtrl_calendar_days_of_week);
        ...
        this.recyclerView = (RecyclerView) viewInflate.findViewById(C1379R.id.mtrl_calendar_months);
        ...
        int integer = contextThemeWrapper.getResources().getInteger(C1379R.integer.mtrl_calendar_year_selector_span);
        RecyclerView recyclerView = (RecyclerView) viewInflate.findViewById(C1379R.id.mtrl_calendar_year_selector_frame);
        ...
        if (viewInflate.findViewById(C1379R.id.month_navigation_fragment_toggle) != null) {
    ...
    public static int getDayHeight(Context context) {
        return context.getResources().getDimensionPixelSize(C1379R.dimen.mtrl_calendar_day_height);
    }
    ...
    private void updateAccessibilityPaneTitle(View view) {
        ...
        CalendarSelector calendarSelector = this.calendarSelector;
        if (calendarSelector == CalendarSelector.YEAR) {
            ViewCompat.setAccessibilityPaneTitle(view, getString(C1379R.string.mtrl_picker_pane_title_year_view));
        } else if (calendarSelector == CalendarSelector.DAY) {
            ViewCompat.setAccessibilityPaneTitle(view, getString(C1379R.string.mtrl_picker_pane_title_calendar_view));
        }
    }

    private void addActionsToMonthNavigation(View view, final MonthsPagerAdapter monthsPagerAdapter) {
        MaterialButton materialButton = (MaterialButton) view.findViewById(C1379R.id.month_navigation_fragment_toggle);
        ...
        ViewCompat.setAccessibilityDelegate(this.monthDropSelect, new AccessibilityDelegateCompat() { // from class: com.google.android.material.datepicker.MaterialCalendar.7
            ...
            public void onInitializeAccessibilityNodeInfo(View view2, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                MaterialCalendar materialCalendar = MaterialCalendar.this;
                if (visibility == 0) {
                    string = materialCalendar.getString(C1379R.string.mtrl_picker_toggle_to_year_selection);
                } else {
                    string = materialCalendar.getString(C1379R.string.mtrl_picker_toggle_to_day_selection);
                }
                accessibilityNodeInfoCompat.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(16, string));
            }
        });
        View viewFindViewById = view.findViewById(C1379R.id.month_navigation_previous);
        this.monthPrev = viewFindViewById;
        viewFindViewById.setTag(NAVIGATION_PREV_TAG);
        TooltipCompat.setTooltipText(this.monthPrev, getString(C1379R.string.mtrl_picker_prev_month_tooltip));
        View viewFindViewById2 = view.findViewById(C1379R.id.month_navigation_next);
        this.monthNext = viewFindViewById2;
        viewFindViewById2.setTag(NAVIGATION_NEXT_TAG);
        TooltipCompat.setTooltipText(this.monthNext, getString(C1379R.string.mtrl_picker_next_month_tooltip));
        this.yearFrame = view.findViewById(C1379R.id.mtrl_calendar_year_selector_frame);
        this.dayFrame = view.findViewById(C1379R.id.mtrl_calendar_day_selector_frame);
        setSelector(CalendarSelector.DAY);
        ...
        this.recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() { // from class: com.google.android.material.datepicker.MaterialCalendar.8
            ...
            public void onScrolled(RecyclerView recyclerView, int i, int i2) {
                ...
                MaterialCalendar materialCalendar = MaterialCalendar.this;
                if (i < 0) {
                    iFindLastVisibleItemPosition = materialCalendar.getLayoutManager().findFirstVisibleItemPosition();
                } else {
                    iFindLastVisibleItemPosition = materialCalendar.getLayoutManager().findLastVisibleItemPosition();
                }
    ...
    private static int getDialogPickerHeight(Context context) {
        ...
        int dimensionPixelSize = resources.getDimensionPixelSize(C1379R.dimen.mtrl_calendar_navigation_height) + resources.getDimensionPixelOffset(C1379R.dimen.mtrl_calendar_navigation_top_padding) + resources.getDimensionPixelOffset(C1379R.dimen.mtrl_calendar_navigation_bottom_padding);
        int dimensionPixelSize2 = resources.getDimensionPixelSize(C1379R.dimen.mtrl_calendar_days_of_week_height);
        int i = MonthAdapter.MAXIMUM_WEEKS;
        return dimensionPixelSize + dimensionPixelSize2 + (resources.getDimensionPixelSize(C1379R.dimen.mtrl_calendar_day_height) * i) + ((i - 1) * resources.getDimensionPixelOffset(C1379R.dimen.mtrl_calendar_month_vertical_padding)) + resources.getDimensionPixelOffset(C1379R.dimen.mtrl_calendar_bottom_padding);
    }
