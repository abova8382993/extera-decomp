...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (zIsFullscreen) {
            i = C1349R.layout.mtrl_calendar_vertical;
            i2 = 1;
        } else {
            i = C1349R.layout.mtrl_calendar_horizontal;
            i2 = 0;
        }
        View viewInflate = layoutInflaterCloneInContext.inflate(i, viewGroup, false);
        viewInflate.setMinimumHeight(getDialogPickerHeight(requireContext()));
        GridView gridView = (GridView) viewInflate.findViewById(C1349R.id.mtrl_calendar_days_of_week);
        ...
        this.recyclerView = (RecyclerView) viewInflate.findViewById(C1349R.id.mtrl_calendar_months);
        this.recyclerView.setLayoutManager(new SmoothCalendarLayoutManager(getContext(), i2, false) { // from class: com.google.android.material.datepicker.MaterialCalendar.2
            ...
            C14382(Context context, int i22, boolean z, int i222) {
                super(context, i222, z);
                i = i222;
            }
        ...
        int integer = contextThemeWrapper.getResources().getInteger(C1349R.integer.mtrl_calendar_year_selector_span);
        RecyclerView recyclerView = (RecyclerView) viewInflate.findViewById(C1349R.id.mtrl_calendar_year_selector_frame);
        ...
        if (viewInflate.findViewById(C1349R.id.month_navigation_fragment_toggle) != null) {
    ...
    class C14341 extends AccessibilityDelegateCompat {
        C14341() {
        }
    ...
    class C14382 extends SmoothCalendarLayoutManager {
        final /* synthetic */ int val$orientation;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C14382(Context context, int i222, boolean z, int i2222) {
            super(context, i2222, z);
            i = i2222;
        }
    ...
    class C14393 implements OnDayClickListener {
        C14393() {
        }
    ...
    class C14404 implements OnMonthNavigationListener {
        C14404() {
        }
    ...
    class C14415 extends AccessibilityDelegateCompat {
        C14415() {
        }
    ...
    class C14426 extends RecyclerView.ItemDecoration {
    ...
    static int getDayHeight(Context context) {
        return context.getResources().getDimensionPixelSize(C1349R.dimen.mtrl_calendar_day_height);
    }
    ...
    private void updateAccessibilityPaneTitle(View view) {
        ...
        CalendarSelector calendarSelector = this.calendarSelector;
        if (calendarSelector == CalendarSelector.YEAR) {
            ViewCompat.setAccessibilityPaneTitle(view, getString(C1349R.string.mtrl_picker_pane_title_year_view));
        } else if (calendarSelector == CalendarSelector.DAY) {
            ViewCompat.setAccessibilityPaneTitle(view, getString(C1349R.string.mtrl_picker_pane_title_calendar_view));
        }
    }

    private void addActionsToMonthNavigation(View view, MonthsPagerAdapter monthsPagerAdapter) {
        MaterialButton materialButton = (MaterialButton) view.findViewById(C1349R.id.month_navigation_fragment_toggle);
        ...
        ViewCompat.setAccessibilityDelegate(this.monthDropSelect, new AccessibilityDelegateCompat() { // from class: com.google.android.material.datepicker.MaterialCalendar.7
            ...
            public void onInitializeAccessibilityNodeInfo(View view2, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                if (MaterialCalendar.this.dayFrame.getVisibility() == 0) {
                    string = MaterialCalendar.this.getString(C1349R.string.mtrl_picker_toggle_to_year_selection);
                } else {
                    string = MaterialCalendar.this.getString(C1349R.string.mtrl_picker_toggle_to_day_selection);
                }
                accessibilityNodeInfoCompat.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(16, string));
            }
        });
        View viewFindViewById = view.findViewById(C1349R.id.month_navigation_previous);
        this.monthPrev = viewFindViewById;
        viewFindViewById.setTag(NAVIGATION_PREV_TAG);
        TooltipCompat.setTooltipText(this.monthPrev, getString(C1349R.string.mtrl_picker_prev_month_tooltip));
        View viewFindViewById2 = view.findViewById(C1349R.id.month_navigation_next);
        this.monthNext = viewFindViewById2;
        viewFindViewById2.setTag(NAVIGATION_NEXT_TAG);
        TooltipCompat.setTooltipText(this.monthNext, getString(C1349R.string.mtrl_picker_next_month_tooltip));
        this.yearFrame = view.findViewById(C1349R.id.mtrl_calendar_year_selector_frame);
        this.dayFrame = view.findViewById(C1349R.id.mtrl_calendar_day_selector_frame);
        setSelector(CalendarSelector.DAY);
        ...
        this.recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() { // from class: com.google.android.material.datepicker.MaterialCalendar.8
            ...
            C14448(MonthsPagerAdapter monthsPagerAdapter2) {
        ...
        this.monthNext.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.datepicker.MaterialCalendar.10
            ...
            ViewOnClickListenerC143510(MonthsPagerAdapter monthsPagerAdapter2) {
                monthsPagerAdapter = monthsPagerAdapter2;
            }
        ...
        this.monthPrev.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.datepicker.MaterialCalendar.11
            ...
            ViewOnClickListenerC143611(MonthsPagerAdapter monthsPagerAdapter2) {
                monthsPagerAdapter = monthsPagerAdapter2;
            }
        ...
        updateNavigationButtonsEnabled(monthsPagerAdapter2.getPosition(this.current));
    }

    /* JADX INFO: renamed from: com.google.android.material.datepicker.MaterialCalendar$7 */
    class C14437 extends AccessibilityDelegateCompat {
        C14437() {
        }
    ...
    class C14448 extends RecyclerView.OnScrollListener {
        final /* synthetic */ MonthsPagerAdapter val$monthsPagerAdapter;
    ...
    class ViewOnClickListenerC14459 implements View.OnClickListener {
        ViewOnClickListenerC14459() {
        }
    ...
    class ViewOnClickListenerC143510 implements View.OnClickListener {
        final /* synthetic */ MonthsPagerAdapter val$monthsPagerAdapter;
    ...
    class ViewOnClickListenerC143611 implements View.OnClickListener {
        final /* synthetic */ MonthsPagerAdapter val$monthsPagerAdapter;
    ...
    /* JADX INFO: renamed from: com.google.android.material.datepicker.MaterialCalendar$12 */
    class RunnableC143712 implements Runnable {
        final /* synthetic */ int val$position;

        RunnableC143712(int i) {
            i = i;
        }
    ...
    private static int getDialogPickerHeight(Context context) {
        ...
        int dimensionPixelSize = resources.getDimensionPixelSize(C1349R.dimen.mtrl_calendar_navigation_height) + resources.getDimensionPixelOffset(C1349R.dimen.mtrl_calendar_navigation_top_padding) + resources.getDimensionPixelOffset(C1349R.dimen.mtrl_calendar_navigation_bottom_padding);
        int dimensionPixelSize2 = resources.getDimensionPixelSize(C1349R.dimen.mtrl_calendar_days_of_week_height);
        int i = MonthAdapter.MAXIMUM_WEEKS;
        return dimensionPixelSize + dimensionPixelSize2 + (resources.getDimensionPixelSize(C1349R.dimen.mtrl_calendar_day_height) * i) + ((i - 1) * resources.getDimensionPixelOffset(C1349R.dimen.mtrl_calendar_month_vertical_padding)) + resources.getDimensionPixelOffset(C1349R.dimen.mtrl_calendar_bottom_padding);
    }
