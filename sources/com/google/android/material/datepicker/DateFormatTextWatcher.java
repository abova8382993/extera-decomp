...
abstract class DateFormatTextWatcher extends TextWatcherAdapter {
    ...
    public DateFormatTextWatcher(final String str, DateFormat dateFormat, TextInputLayout textInputLayout, CalendarConstraints calendarConstraints) {
        ...
        this.outOfRange = textInputLayout.getContext().getString(C1379R.string.mtrl_picker_out_of_range);
    ...
    public static /* synthetic */ void $r8$lambda$WisZO76PIdPa6C8OvZJgtYqx1W8(DateFormatTextWatcher dateFormatTextWatcher, String str) {
        ...
        textInputLayout.setError(context.getString(C1379R.string.mtrl_picker_invalid_format) + "\n" + String.format(context.getString(C1379R.string.mtrl_picker_invalid_format_use), dateFormatTextWatcher.sanitizeDateString(str)) + "\n" + String.format(context.getString(C1379R.string.mtrl_picker_invalid_format_example), dateFormatTextWatcher.sanitizeDateString(dateFormat.format(new Date(UtcDates.getTodayCalendar().getTimeInMillis())))));
    ...
    private Runnable createRangeErrorCallback(final long j) {
        return new Runnable() { // from class: com.google.android.material.datepicker.DateFormatTextWatcher$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                DateFormatTextWatcher.m3364$r8$lambda$HHcrrijRZjKFRrqXL2jy2ZghE(this.f$0, j);
            }
        };
    }

    /* JADX INFO: renamed from: $r8$lambda$HHcrrijRZjKF-RrqXL2jy2Z-ghE, reason: not valid java name */
    public static /* synthetic */ void m3364$r8$lambda$HHcrrijRZjKFRrqXL2jy2ZghE(DateFormatTextWatcher dateFormatTextWatcher, long j) {
