...
public class RangeDateSelector implements DateSelector<Pair<Long, Long>> {
    ...
    public int getDefaultThemeResId(Context context) {
        ...
        if (Math.min(displayMetrics.widthPixels, displayMetrics.heightPixels) > resources.getDimensionPixelSize(C1379R.dimen.mtrl_calendar_maximum_default_fullscreen_minor_axis)) {
            i = C1379R.attr.materialCalendarTheme;
        } else {
            i = C1379R.attr.materialCalendarFullscreenTheme;
        }
    ...
    public String getSelectionDisplayString(Context context) {
        ...
        if (l == null && this.selectedEndItem == null) {
            return resources.getString(C1379R.string.mtrl_picker_range_header_unselected);
        }
        Long l2 = this.selectedEndItem;
        if (l2 == null) {
            return resources.getString(C1379R.string.mtrl_picker_range_header_only_start_selected, DateStrings.getDateString(l.longValue()));
        }
        if (l == null) {
            return resources.getString(C1379R.string.mtrl_picker_range_header_only_end_selected, DateStrings.getDateString(l2.longValue()));
        }
        Pair<String, String> dateRangeString = DateStrings.getDateRangeString(l, l2);
        return resources.getString(C1379R.string.mtrl_picker_range_header_selected, dateRangeString.first, dateRangeString.second);
    }
    ...
    public String getSelectionContentDescription(Context context) {
        ...
        if (str == null) {
            string = resources.getString(C1379R.string.mtrl_picker_announce_current_selection_none);
        } else {
            string = str;
        }
        String str2 = dateRangeString.second;
        if (str2 == null) {
            string2 = resources.getString(C1379R.string.mtrl_picker_announce_current_selection_none);
        } else {
            string2 = str2;
        }
        return resources.getString(C1379R.string.mtrl_picker_announce_current_range_selection, string, string2);
    }
    ...
    public int getDefaultTitleResId() {
        return C1379R.string.mtrl_picker_range_header_title;
    }
    ...
    public View onCreateTextInputView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle, CalendarConstraints calendarConstraints, final OnSelectionChangedListener<Pair<Long, Long>> onSelectionChangedListener) {
        ...
        View viewInflate = layoutInflater.inflate(C1379R.layout.mtrl_picker_text_input_date_range, viewGroup, false);
        final TextInputLayout textInputLayout = (TextInputLayout) viewInflate.findViewById(C1379R.id.mtrl_picker_text_input_range_start);
        final TextInputLayout textInputLayout2 = (TextInputLayout) viewInflate.findViewById(C1379R.id.mtrl_picker_text_input_range_end);
        EditText editText = textInputLayout.getEditText();
        EditText editText2 = textInputLayout2.getEditText();
        Integer colorOrNull = MaterialColors.getColorOrNull(viewInflate.getContext(), C1379R.attr.colorOnSurfaceVariant);
        if (colorOrNull != null) {
        ...
        this.invalidRangeStartError = viewInflate.getResources().getString(C1379R.string.mtrl_picker_invalid_range);
