...
final class LinearIndeterminateDisjointAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    private static final int[] DELAY_TO_MOVE_SEGMENT_ENDS = {1267, MediaDataController.MAX_STYLE_RUNS_COUNT, 333, 0};
    private static final Property<LinearIndeterminateDisjointAnimatorDelegate, Float> ANIMATION_FRACTION = new Property<LinearIndeterminateDisjointAnimatorDelegate, Float>(Float.class, "animationFraction") { // from class: com.google.android.material.progressindicator.LinearIndeterminateDisjointAnimatorDelegate.3
        public C15783(Class cls, String str) {
            super(cls, str);
        }
    ...
    public LinearIndeterminateDisjointAnimatorDelegate(Context context, LinearProgressIndicatorSpec linearProgressIndicatorSpec) {
        ...
        this.interpolatorArray = new Interpolator[]{AnimationUtilsCompat.loadInterpolator(context, C1379R.anim.linear_indeterminate_line1_head_interpolator), AnimationUtilsCompat.loadInterpolator(context, C1379R.anim.linear_indeterminate_line1_tail_interpolator), AnimationUtilsCompat.loadInterpolator(context, C1379R.anim.linear_indeterminate_line2_head_interpolator), AnimationUtilsCompat.loadInterpolator(context, C1379R.anim.linear_indeterminate_line2_tail_interpolator)};
    }
    ...
    public class C15761 extends AnimatorListenerAdapter {
        public C15761() {
        }
    ...
    public class C15772 extends AnimatorListenerAdapter {
        public C15772() {
        }
    ...
    /* JADX INFO: renamed from: com.google.android.material.progressindicator.LinearIndeterminateDisjointAnimatorDelegate$3 */
    public class C15783 extends Property<LinearIndeterminateDisjointAnimatorDelegate, Float> {
        public C15783(Class cls, String str) {
            super(cls, str);
        }
