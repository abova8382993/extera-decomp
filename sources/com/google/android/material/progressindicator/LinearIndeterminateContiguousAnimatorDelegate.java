...
final class LinearIndeterminateContiguousAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    class C15421 extends AnimatorListenerAdapter {
        C15421() {
        }
    ...
    class C15432 extends Property<LinearIndeterminateContiguousAnimatorDelegate, Float> {
        C15432(Class cls, String str) {
            super(cls, str);
        }
