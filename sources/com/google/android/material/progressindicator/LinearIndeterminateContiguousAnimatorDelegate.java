...
final class LinearIndeterminateContiguousAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    private static final Property<LinearIndeterminateContiguousAnimatorDelegate, Float> ANIMATION_FRACTION = new Property<LinearIndeterminateContiguousAnimatorDelegate, Float>(Float.class, "animationFraction") { // from class: com.google.android.material.progressindicator.LinearIndeterminateContiguousAnimatorDelegate.2
        public C15752(Class cls, String str) {
            super(cls, str);
        }
    ...
    /* JADX INFO: renamed from: com.google.android.material.progressindicator.LinearIndeterminateContiguousAnimatorDelegate$1 */
    public class C15741 extends AnimatorListenerAdapter {
        public C15741() {
        }
    ...
    /* JADX INFO: renamed from: com.google.android.material.progressindicator.LinearIndeterminateContiguousAnimatorDelegate$2 */
    public class C15752 extends Property<LinearIndeterminateContiguousAnimatorDelegate, Float> {
        public C15752(Class cls, String str) {
            super(cls, str);
        }
