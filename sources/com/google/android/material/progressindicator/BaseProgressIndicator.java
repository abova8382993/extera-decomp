...
public abstract class BaseProgressIndicator<S extends BaseProgressIndicatorSpec> extends ProgressBar {
    ...
    static final int DEF_STYLE_RES = C1379R.style.Widget_MaterialComponents_ProgressIndicator;
    ...
    public BaseProgressIndicator(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.hideAfterMaxProgressListener = new DynamicAnimation.OnAnimationEndListener() { // from class: com.google.android.material.progressindicator.BaseProgressIndicator$$ExternalSyntheticLambda0
            ...
            public final void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z, float f, float f2) {
                BaseProgressIndicator.$r8$lambda$9LFVkjgCbQazReD7AnEDM8_FfLk(this.f$0, dynamicAnimation, z, f, f2);
            }
        };
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C1379R.styleable.BaseProgressIndicator, i, i2, new int[0]);
        this.showDelay = typedArrayObtainStyledAttributes.getInt(C1379R.styleable.BaseProgressIndicator_showDelay, -1);
        this.minHideDelay = Math.min(typedArrayObtainStyledAttributes.getInt(C1379R.styleable.BaseProgressIndicator_minHideDelay, -1), 1000);
    ...
    public void setProgressDrawable(Drawable drawable) {
        ...
        if (!this.initialized) {
            ...
            g$$ExternalSyntheticBUOutline1.m207m("Cannot set framework drawable as progress drawable.");
        }
    }
    ...
    public void setIndeterminateDrawable(Drawable drawable) {
        if (drawable instanceof IndeterminateDrawable) {
            ...
            g$$ExternalSyntheticBUOutline1.m207m("Cannot set framework drawable as indeterminate drawable.");
        }
    }
    ...
    public void setVisibilityAfterHide(int i) {
        if (i != 0 && i != 4 && i != 8) {
            g$$ExternalSyntheticBUOutline1.m207m("The component's visibility must be one of VISIBLE, INVISIBLE, and GONE defined in View.");
        } else {
            this.visibilityAfterHide = i;
        }
    }

    public static /* synthetic */ void $r8$lambda$9LFVkjgCbQazReD7AnEDM8_FfLk(BaseProgressIndicator baseProgressIndicator, DynamicAnimation dynamicAnimation, boolean z, float f, float f2) {
        if (baseProgressIndicator.getProgressDrawable() == null || baseProgressIndicator.getProgressDrawable().getLevel() != 10000) {
            return;
        }
