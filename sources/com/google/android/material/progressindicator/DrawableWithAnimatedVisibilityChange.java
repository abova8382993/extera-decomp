...
abstract class DrawableWithAnimatedVisibilityChange extends Drawable implements Animatable {
    ...
    private static final Property<DrawableWithAnimatedVisibilityChange, Float> GROW_FRACTION = new Property<DrawableWithAnimatedVisibilityChange, Float>(Float.class, "growFraction") { // from class: com.google.android.material.progressindicator.DrawableWithAnimatedVisibilityChange.3
        public C15733(Class cls, String str) {
            super(cls, str);
        }
    ...
    private void setShowAnimator(ValueAnimator valueAnimator) {
        ...
        if (valueAnimator2 != null && valueAnimator2.isRunning()) {
            g$$ExternalSyntheticBUOutline1.m207m("Cannot set showAnimator while the current showAnimator is running.");
        } else {
    ...
    public class C15711 extends AnimatorListenerAdapter {
        public C15711() {
        }
    ...
    private void setHideAnimator(ValueAnimator valueAnimator) {
        ...
        if (valueAnimator2 != null && valueAnimator2.isRunning()) {
            g$$ExternalSyntheticBUOutline1.m207m("Cannot set hideAnimator while the current hideAnimator is running.");
        } else {
    ...
    public class C15722 extends AnimatorListenerAdapter {
        public C15722() {
        }
    ...
    public float getPhaseFraction() {
        ...
        if (this.baseSpec.hasWavyEffect(isDeterminateDrawable()) && this.baseSpec.waveSpeed != 0) {
            ...
            if (systemAnimatorDurationScale > 0.0f) {
                ...
                float fUptimeMillis = (SystemClock.uptimeMillis() % ((long) r6)) / ((int) (((i * 1000.0f) / this.baseSpec.waveSpeed) * systemAnimatorDurationScale));
    ...
    public class C15733 extends Property<DrawableWithAnimatedVisibilityChange, Float> {
        public C15733(Class cls, String str) {
            super(cls, str);
        }
