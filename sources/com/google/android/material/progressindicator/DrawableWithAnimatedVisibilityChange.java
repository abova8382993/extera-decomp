...
abstract class DrawableWithAnimatedVisibilityChange extends Drawable implements Animatable {
    ...
    class C15391 extends AnimatorListenerAdapter {
        C15391() {
        }
    ...
    class C15402 extends AnimatorListenerAdapter {
        C15402() {
        }
    ...
    float getPhaseFraction() {
        ...
        if (this.baseSpec.hasWavyEffect(isDeterminateDrawable()) && this.baseSpec.waveSpeed != 0) {
            ...
            if (systemAnimatorDurationScale > 0.0f) {
                ...
                float fUptimeMillis = (SystemClock.uptimeMillis() % ((long) r0)) / ((int) (((i * 1000.0f) / this.baseSpec.waveSpeed) * systemAnimatorDurationScale));
    ...
    class C15413 extends Property<DrawableWithAnimatedVisibilityChange, Float> {
        C15413(Class cls, String str) {
            super(cls, str);
        }
