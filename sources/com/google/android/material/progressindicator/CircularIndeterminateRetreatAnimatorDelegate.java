...
final class CircularIndeterminateRetreatAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    private static final Property<CircularIndeterminateRetreatAnimatorDelegate, Float> ANIMATION_FRACTION = new Property<CircularIndeterminateRetreatAnimatorDelegate, Float>(Float.class, "animationFraction") { // from class: com.google.android.material.progressindicator.CircularIndeterminateRetreatAnimatorDelegate.3
        public C15683(Class cls, String str) {
            super(cls, str);
        }
    ...
    private static final Property<CircularIndeterminateRetreatAnimatorDelegate, Float> COMPLETE_END_FRACTION = new Property<CircularIndeterminateRetreatAnimatorDelegate, Float>(Float.class, "completeEndFraction") { // from class: com.google.android.material.progressindicator.CircularIndeterminateRetreatAnimatorDelegate.4
        public C15694(Class cls, String str) {
            super(cls, str);
        }
    ...
    public CircularIndeterminateRetreatAnimatorDelegate(Context context, CircularProgressIndicatorSpec circularProgressIndicatorSpec) {
        ...
        this.standardInterpolator = MotionUtils.resolveThemeInterpolator(context, C1379R.attr.motionEasingStandardInterpolator, DEFAULT_INTERPOLATOR);
    }
    ...
    /* JADX INFO: renamed from: com.google.android.material.progressindicator.CircularIndeterminateRetreatAnimatorDelegate$1 */
    public class C15661 extends AnimatorListenerAdapter {
        public C15661() {
        }
    ...
    /* JADX INFO: renamed from: com.google.android.material.progressindicator.CircularIndeterminateRetreatAnimatorDelegate$2 */
    public class C15672 extends AnimatorListenerAdapter {
        public C15672() {
        }
    ...
    /* JADX INFO: renamed from: com.google.android.material.progressindicator.CircularIndeterminateRetreatAnimatorDelegate$3 */
    public class C15683 extends Property<CircularIndeterminateRetreatAnimatorDelegate, Float> {
        public C15683(Class cls, String str) {
            super(cls, str);
        }
    ...
    /* JADX INFO: renamed from: com.google.android.material.progressindicator.CircularIndeterminateRetreatAnimatorDelegate$4 */
    public class C15694 extends Property<CircularIndeterminateRetreatAnimatorDelegate, Float> {
        public C15694(Class cls, String str) {
            super(cls, str);
        }
