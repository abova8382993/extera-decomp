...
public final class DrawableUtils {
    ...
    public static ColorStateList getColorStateListOrNull(Drawable drawable) {
        ...
        if (Build.VERSION.SDK_INT < 29 || !DrawableUtils$$ExternalSyntheticApiModelOutline0.m376m(drawable)) {
            return null;
        }
        return DrawableUtils$$ExternalSyntheticApiModelOutline1.m377m(drawable).getColorStateList();
    }
