...
public class DynamicColors {
    ...
    private static final int[] DYNAMIC_COLOR_THEME_OVERLAY_ATTRIBUTE = {C1349R.attr.dynamicColorThemeOverlay};
    ...
    static {
        ...
        DYNAMIC_COLOR_SUPPORTED_MANUFACTURERS = DesugarCollections.unmodifiableMap(map);
        HashMap map2 = new HashMap();
        map2.put("asus", deviceSupportCondition);
        map2.put("jio", deviceSupportCondition);
        DYNAMIC_COLOR_SUPPORTED_BRANDS = DesugarCollections.unmodifiableMap(map2);
