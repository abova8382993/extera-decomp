...
public class DynamicColorsOptions {
    ...
    public class C14531 implements DynamicColors.Precondition {
        @Override // com.google.android.material.color.DynamicColors.Precondition
        public boolean shouldApplyDynamicColors(Activity activity, int i) {
            return true;
        }
    ...
    public class C14542 implements DynamicColors.OnAppliedCallback {
        @Override // com.google.android.material.color.DynamicColors.OnAppliedCallback
        public void onApplied(Activity activity) {
        }
    }

    public /* synthetic */ DynamicColorsOptions(Builder builder, C14531 c14531) {
        this(builder);
    }
