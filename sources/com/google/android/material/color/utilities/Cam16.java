...
public final class Cam16 {
    ...
    private final double f462j;
    private final double jstar;

    /* JADX INFO: renamed from: m */
    private final double f463m;

    /* JADX INFO: renamed from: q */
    private final double f464q;

    /* JADX INFO: renamed from: s */
    private final double f465s;
    ...
    private static Cam16 fromJchInViewingConditions(double d, double d2, double d3, ViewingConditions viewingConditions) {
        double d4 = d / 100.0d;
        double c2 = (4.0d / viewingConditions.getC()) * Math.sqrt(d4) * (viewingConditions.getAw() + 4.0d) * viewingConditions.getFlRoot();
        ...
        return new Cam16(d3, d2, d, c2, flRoot, dSqrt, d5, dLog1p * Math.cos(radians), dLog1p * Math.sin(radians));
    }
