...
public final class DynamicColor {
    ...
    public static /* synthetic */ TonalPalette m3309$r8$lambda$HYDTTRX49hWk5qNJTOhVJLMxRg(TonalPalette tonalPalette, DynamicScheme dynamicScheme) {
        return tonalPalette;
    }
    ...
    public static DynamicColor fromArgb(String str, int i) {
        ...
        return fromPalette(str, new Function() { // from class: com.google.android.material.color.utilities.DynamicColor$$ExternalSyntheticLambda0
            ...
            public final Object apply(Object obj) {
                return DynamicColor.m3309$r8$lambda$HYDTTRX49hWk5qNJTOhVJLMxRg(tonalPaletteFromInt, (DynamicScheme) obj);
            }
    ...
    public double getTone(DynamicScheme dynamicScheme) {
        ...
        if (function != null) {
            ...
            if ((dDoubleValue2 - dDoubleValue) * d2 < delta) {
                double d5 = delta * d2;
                dDoubleValue2 = MathUtils.clampDouble(0.0d, 100.0d, dDoubleValue + d5);
                if ((dDoubleValue2 - dDoubleValue) * d2 < delta) {
                    dDoubleValue = MathUtils.clampDouble(0.0d, 100.0d, dDoubleValue2 - d5);
                }
            }
