        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ColorResourcesLoaderCreator$$ExternalSyntheticApiModelOutline1.m373m();
                        ResourcesLoader resourcesLoaderM372m = ColorResourcesLoaderCreator$$ExternalSyntheticApiModelOutline0.m372m();
                        resourcesLoaderM372m.addProvider(ResourcesProvider.loadFromTable(parcelFileDescriptorDup, null));
                        if (parcelFileDescriptorDup != null) {
                            parcelFileDescriptorDup.close();
                        }
                        fileOutputStream.close();
                        Os.close(fileDescriptorMemfd_create);
                        return resourcesLoaderM372m;
                    } finally {
                    }
                } finally {
                }
