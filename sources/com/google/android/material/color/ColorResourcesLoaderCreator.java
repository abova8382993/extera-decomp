        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ColorResourcesLoaderCreator$$ExternalSyntheticApiModelOutline1.m392m();
                        ResourcesLoader resourcesLoaderM391m = ColorResourcesLoaderCreator$$ExternalSyntheticApiModelOutline0.m391m();
                        resourcesLoaderM391m.addProvider(ResourcesProvider.loadFromTable(parcelFileDescriptorDup, null));
                        if (parcelFileDescriptorDup != null) {
                            parcelFileDescriptorDup.close();
                        }
                        fileOutputStream.close();
                        Os.close(fileDescriptorMemfd_create);
                        return resourcesLoaderM391m;
                    } finally {
                    }
                } finally {
                }
