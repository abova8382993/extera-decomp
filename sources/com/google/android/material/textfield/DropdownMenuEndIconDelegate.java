...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    public DropdownMenuEndIconDelegate(EndCompoundLayout endCompoundLayout) {
        ...
        this.animationFadeInDuration = MotionUtils.resolveThemeDuration(endCompoundLayout.getContext(), C1379R.attr.motionDurationShort3, 67);
        this.animationFadeOutDuration = MotionUtils.resolveThemeDuration(endCompoundLayout.getContext(), C1379R.attr.motionDurationShort3, 50);
        this.animationFadeInterpolator = MotionUtils.resolveThemeInterpolator(endCompoundLayout.getContext(), C1379R.attr.motionEasingLinearInterpolator, AnimationUtils.LINEAR_INTERPOLATOR);
    }
    ...
    public int getIconDrawableResId() {
        return C1379R.drawable.mtrl_dropdown_arrow;
    }

    @Override // com.google.android.material.textfield.EndIconDelegate
    public int getIconContentDescriptionResId() {
        return C1379R.string.exposed_dropdown_menu_content_description;
    }
    ...
    public void afterEditTextChanged(Editable editable) {
        ...
        this.autoCompleteTextView.post(new Runnable() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda6
            ...
            public final void run() {
                DropdownMenuEndIconDelegate.m3389$r8$lambda$y8fy3mWjKkDKEPGKU3W34ch_Uw(this.f$0);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$-y8fy3mWjKkDKEPGKU3W34ch_Uw, reason: not valid java name */
    public static /* synthetic */ void m3389$r8$lambda$y8fy3mWjKkDKEPGKU3W34ch_Uw(DropdownMenuEndIconDelegate dropdownMenuEndIconDelegate) {
    ...
    private void setUpDropdownShowHideBehavior() {
        this.autoCompleteTextView.setOnTouchListener(new View.OnTouchListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda1
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return DropdownMenuEndIconDelegate.m3390$r8$lambda$rHz86UpD1kaGbWDU0jLf2Nncs(this.f$0, view, motionEvent);
            }
        });
        this.autoCompleteTextView.setOnDismissListener(new AutoCompleteTextView.OnDismissListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda2
            ...
            public final void onDismiss() {
                DropdownMenuEndIconDelegate.m3391$r8$lambda$scsWsP1aqfljH19IzwcrEYD_Bo(this.f$0);
            }
        });
    ...
    public static /* synthetic */ boolean m3390$r8$lambda$rHz86UpD1kaGbWDU0jLf2Nncs(DropdownMenuEndIconDelegate dropdownMenuEndIconDelegate, View view, MotionEvent motionEvent) {
    ...
    public static /* synthetic */ void m3391$r8$lambda$scsWsP1aqfljH19IzwcrEYD_Bo(DropdownMenuEndIconDelegate dropdownMenuEndIconDelegate) {
        dropdownMenuEndIconDelegate.updateDropdownPopupDirty();
        dropdownMenuEndIconDelegate.setEndIconChecked(false);
    }
    ...
    private static AutoCompleteTextView castAutoCompleteTextViewOrThrow(EditText editText) {
        if (!(editText instanceof AutoCompleteTextView)) {
            GlShader$$ExternalSyntheticBUOutline1.m1250m("EditText needs to be an AutoCompleteTextView if an Exposed Dropdown Menu is being used.");
            return null;
        }
