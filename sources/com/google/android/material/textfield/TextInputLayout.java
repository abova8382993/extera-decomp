...
public class TextInputLayout extends LinearLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private static final int DEF_STYLE_RES = C1379R.style.Widget_Design_TextInputLayout;
    ...
    public TextInputLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1379R.attr.textInputStyle);
    }
    ...
    public TextInputLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.lengthCounter = new LengthCounter() { // from class: com.google.android.material.textfield.TextInputLayout$$ExternalSyntheticLambda1
            ...
            public final int countLength(Editable editable) {
                return TextInputLayout.$r8$lambda$o92w5de0KdW2_dMexjlsVyV6EjQ(editable);
            }
        };
        ...
        TintTypedArray tintTypedArrayObtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attributeSet, C1379R.styleable.TextInputLayout, i, i2, C1379R.styleable.TextInputLayout_counterTextAppearance, C1379R.styleable.TextInputLayout_counterOverflowTextAppearance, C1379R.styleable.TextInputLayout_errorTextAppearance, C1379R.styleable.TextInputLayout_helperTextTextAppearance, C1379R.styleable.TextInputLayout_hintTextAppearance);
        ...
        this.hintEnabled = tintTypedArrayObtainTintedStyledAttributes.getBoolean(C1379R.styleable.TextInputLayout_hintEnabled, true);
        setHint(tintTypedArrayObtainTintedStyledAttributes.getText(C1379R.styleable.TextInputLayout_android_hint));
        this.hintAnimationEnabled = tintTypedArrayObtainTintedStyledAttributes.getBoolean(C1379R.styleable.TextInputLayout_hintAnimationEnabled, true);
        this.expandedHintEnabled = tintTypedArrayObtainTintedStyledAttributes.getBoolean(C1379R.styleable.TextInputLayout_expandedHintEnabled, true);
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C1379R.styleable.TextInputLayout_android_minEms)) {
            setMinEms(tintTypedArrayObtainTintedStyledAttributes.getInt(C1379R.styleable.TextInputLayout_android_minEms, -1));
        } else if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C1379R.styleable.TextInputLayout_android_minWidth)) {
            setMinWidth(tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelSize(C1379R.styleable.TextInputLayout_android_minWidth, -1));
        }
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C1379R.styleable.TextInputLayout_android_maxEms)) {
            setMaxEms(tintTypedArrayObtainTintedStyledAttributes.getInt(C1379R.styleable.TextInputLayout_android_maxEms, -1));
        } else if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C1379R.styleable.TextInputLayout_android_maxWidth)) {
            setMaxWidth(tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelSize(C1379R.styleable.TextInputLayout_android_maxWidth, -1));
        }
        this.shapeAppearanceModel = ShapeAppearanceModel.builder(context2, attributeSet, i, i2).build();
        this.boxLabelCutoutPaddingPx = context2.getResources().getDimensionPixelOffset(C1379R.dimen.mtrl_textinput_box_label_cutout_padding);
        this.boxCollapsedPaddingTopPx = tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelOffset(C1379R.styleable.TextInputLayout_boxCollapsedPaddingTop, 0);
        this.extraSpaceBetweenPlaceholderAndHint = getResources().getDimensionPixelSize(C1379R.dimen.m3_multiline_hint_filled_text_extra_space);
        this.boxStrokeWidthDefaultPx = tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelSize(C1379R.styleable.TextInputLayout_boxStrokeWidth, context2.getResources().getDimensionPixelSize(C1379R.dimen.mtrl_textinput_box_stroke_width_default));
        this.boxStrokeWidthFocusedPx = tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelSize(C1379R.styleable.TextInputLayout_boxStrokeWidthFocused, context2.getResources().getDimensionPixelSize(C1379R.dimen.mtrl_textinput_box_stroke_width_focused));
        this.boxStrokeWidthPx = this.boxStrokeWidthDefaultPx;
        float dimension = tintTypedArrayObtainTintedStyledAttributes.getDimension(C1379R.styleable.TextInputLayout_boxCornerRadiusTopStart, -1.0f);
        float dimension2 = tintTypedArrayObtainTintedStyledAttributes.getDimension(C1379R.styleable.TextInputLayout_boxCornerRadiusTopEnd, -1.0f);
        float dimension3 = tintTypedArrayObtainTintedStyledAttributes.getDimension(C1379R.styleable.TextInputLayout_boxCornerRadiusBottomEnd, -1.0f);
        float dimension4 = tintTypedArrayObtainTintedStyledAttributes.getDimension(C1379R.styleable.TextInputLayout_boxCornerRadiusBottomStart, -1.0f);
        ...
        ColorStateList colorStateList = MaterialResources.getColorStateList(context2, tintTypedArrayObtainTintedStyledAttributes, C1379R.styleable.TextInputLayout_boxBackgroundColor);
        if (colorStateList != null) {
            ...
            if (colorStateList.isStateful()) {
                ...
                ColorStateList colorStateList2 = AppCompatResources.getColorStateList(context2, C1379R.color.mtrl_filled_background_color);
        ...
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C1379R.styleable.TextInputLayout_android_textColorHint)) {
            ColorStateList colorStateList3 = tintTypedArrayObtainTintedStyledAttributes.getColorStateList(C1379R.styleable.TextInputLayout_android_textColorHint);
            this.focusedTextColor = colorStateList3;
            this.defaultHintTextColor = colorStateList3;
        }
        ColorStateList colorStateList4 = MaterialResources.getColorStateList(context2, tintTypedArrayObtainTintedStyledAttributes, C1379R.styleable.TextInputLayout_boxStrokeColor);
        this.focusedStrokeColor = tintTypedArrayObtainTintedStyledAttributes.getColor(C1379R.styleable.TextInputLayout_boxStrokeColor, 0);
        this.defaultStrokeColor = ContextCompat.getColor(context2, C1379R.color.mtrl_textinput_default_box_stroke_color);
        this.disabledColor = ContextCompat.getColor(context2, C1379R.color.mtrl_textinput_disabled_color);
        this.hoveredStrokeColor = ContextCompat.getColor(context2, C1379R.color.mtrl_textinput_hovered_box_stroke_color);
        if (colorStateList4 != null) {
            setBoxStrokeColorStateList(colorStateList4);
        }
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C1379R.styleable.TextInputLayout_boxStrokeErrorColor)) {
            setBoxStrokeErrorColor(MaterialResources.getColorStateList(context2, tintTypedArrayObtainTintedStyledAttributes, C1379R.styleable.TextInputLayout_boxStrokeErrorColor));
        }
        if (tintTypedArrayObtainTintedStyledAttributes.getResourceId(C1379R.styleable.TextInputLayout_hintTextAppearance, -1) != -1) {
            setHintTextAppearance(tintTypedArrayObtainTintedStyledAttributes.getResourceId(C1379R.styleable.TextInputLayout_hintTextAppearance, 0));
        }
        this.cursorColor = tintTypedArrayObtainTintedStyledAttributes.getColorStateList(C1379R.styleable.TextInputLayout_cursorColor);
        this.cursorErrorColor = tintTypedArrayObtainTintedStyledAttributes.getColorStateList(C1379R.styleable.TextInputLayout_cursorErrorColor);
        int resourceId = tintTypedArrayObtainTintedStyledAttributes.getResourceId(C1379R.styleable.TextInputLayout_errorTextAppearance, 0);
        CharSequence text = tintTypedArrayObtainTintedStyledAttributes.getText(C1379R.styleable.TextInputLayout_errorContentDescription);
        int i3 = tintTypedArrayObtainTintedStyledAttributes.getInt(C1379R.styleable.TextInputLayout_errorAccessibilityLiveRegion, 1);
        boolean z = tintTypedArrayObtainTintedStyledAttributes.getBoolean(C1379R.styleable.TextInputLayout_errorEnabled, false);
        int resourceId2 = tintTypedArrayObtainTintedStyledAttributes.getResourceId(C1379R.styleable.TextInputLayout_helperTextTextAppearance, 0);
        boolean z2 = tintTypedArrayObtainTintedStyledAttributes.getBoolean(C1379R.styleable.TextInputLayout_helperTextEnabled, false);
        CharSequence text2 = tintTypedArrayObtainTintedStyledAttributes.getText(C1379R.styleable.TextInputLayout_helperText);
        int resourceId3 = tintTypedArrayObtainTintedStyledAttributes.getResourceId(C1379R.styleable.TextInputLayout_placeholderTextAppearance, 0);
        CharSequence text3 = tintTypedArrayObtainTintedStyledAttributes.getText(C1379R.styleable.TextInputLayout_placeholderText);
        boolean z3 = tintTypedArrayObtainTintedStyledAttributes.getBoolean(C1379R.styleable.TextInputLayout_counterEnabled, false);
        setCounterMaxLength(tintTypedArrayObtainTintedStyledAttributes.getInt(C1379R.styleable.TextInputLayout_counterMaxLength, -1));
        this.counterTextAppearance = tintTypedArrayObtainTintedStyledAttributes.getResourceId(C1379R.styleable.TextInputLayout_counterTextAppearance, 0);
        this.counterOverflowTextAppearance = tintTypedArrayObtainTintedStyledAttributes.getResourceId(C1379R.styleable.TextInputLayout_counterOverflowTextAppearance, 0);
        setBoxBackgroundMode(tintTypedArrayObtainTintedStyledAttributes.getInt(C1379R.styleable.TextInputLayout_boxBackgroundMode, 0));
        ...
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C1379R.styleable.TextInputLayout_errorTextColor)) {
            setErrorTextColor(tintTypedArrayObtainTintedStyledAttributes.getColorStateList(C1379R.styleable.TextInputLayout_errorTextColor));
        }
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C1379R.styleable.TextInputLayout_helperTextTextColor)) {
            setHelperTextColor(tintTypedArrayObtainTintedStyledAttributes.getColorStateList(C1379R.styleable.TextInputLayout_helperTextTextColor));
        }
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C1379R.styleable.TextInputLayout_hintTextColor)) {
            setHintTextColor(tintTypedArrayObtainTintedStyledAttributes.getColorStateList(C1379R.styleable.TextInputLayout_hintTextColor));
        }
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C1379R.styleable.TextInputLayout_counterTextColor)) {
            setCounterTextColor(tintTypedArrayObtainTintedStyledAttributes.getColorStateList(C1379R.styleable.TextInputLayout_counterTextColor));
        }
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C1379R.styleable.TextInputLayout_counterOverflowTextColor)) {
            setCounterOverflowTextColor(tintTypedArrayObtainTintedStyledAttributes.getColorStateList(C1379R.styleable.TextInputLayout_counterOverflowTextColor));
        }
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C1379R.styleable.TextInputLayout_placeholderTextColor)) {
            setPlaceholderTextColor(tintTypedArrayObtainTintedStyledAttributes.getColorStateList(C1379R.styleable.TextInputLayout_placeholderTextColor));
        }
        EndCompoundLayout endCompoundLayout = new EndCompoundLayout(this, tintTypedArrayObtainTintedStyledAttributes);
        this.endLayout = endCompoundLayout;
        boolean z4 = tintTypedArrayObtainTintedStyledAttributes.getBoolean(C1379R.styleable.TextInputLayout_android_enabled, true);
        setHintMaxLines(tintTypedArrayObtainTintedStyledAttributes.getInt(C1379R.styleable.TextInputLayout_hintMaxLines, 1));
    ...
    private static Drawable getOutlinedBoxBackgroundWithRipple(Context context, MaterialShapeDrawable materialShapeDrawable, int i, int[][] iArr) {
        int color = MaterialColors.getColor(context, C1379R.attr.colorSurface, "TextInputLayout");
    ...
    private MaterialShapeDrawable getDropDownMaterialShapeDrawable(boolean z) {
        ...
        float dimensionPixelOffset2 = getResources().getDimensionPixelOffset(C1379R.dimen.mtrl_shape_corner_size_small_component);
        ...
        if (editText instanceof MaterialAutoCompleteTextView) {
            ...
            dimensionPixelOffset = getResources().getDimensionPixelOffset(C1379R.dimen.m3_comp_outlined_autocomplete_menu_container_elevation);
        }
        int dimensionPixelOffset3 = getResources().getDimensionPixelOffset(C1379R.dimen.mtrl_exposed_dropdown_menu_popup_vertical_padding);
    ...
    private void updateBoxCollapsedPaddingTop() {
        if (this.boxBackgroundMode == 1) {
            if (MaterialResources.isFontScaleAtLeast2_0(getContext())) {
                this.boxCollapsedPaddingTopPx = getResources().getDimensionPixelSize(C1379R.dimen.material_font_2_0_box_collapsed_padding_top);
            } else if (MaterialResources.isFontScaleAtLeast1_3(getContext())) {
                this.boxCollapsedPaddingTopPx = getResources().getDimensionPixelSize(C1379R.dimen.material_font_1_3_box_collapsed_padding_top);
            }
        }
    }
    ...
    private void adjustFilledEditTextPaddingForLargeFont() {
        ...
        if (!isHintTextSingleLine()) {
            EditText editText = this.editText;
            editText.setPaddingRelative(editText.getPaddingStart(), (int) (this.collapsingTextHelper.getCollapsedTextHeight() + this.extraSpaceBetweenPlaceholderAndHint), this.editText.getPaddingEnd(), getResources().getDimensionPixelSize(C1379R.dimen.material_filled_edittext_font_1_3_padding_bottom));
        } else if (MaterialResources.isFontScaleAtLeast2_0(getContext())) {
            EditText editText2 = this.editText;
            editText2.setPaddingRelative(editText2.getPaddingStart(), getResources().getDimensionPixelSize(C1379R.dimen.material_filled_edittext_font_2_0_padding_top), this.editText.getPaddingEnd(), getResources().getDimensionPixelSize(C1379R.dimen.material_filled_edittext_font_2_0_padding_bottom));
        } else if (MaterialResources.isFontScaleAtLeast1_3(getContext())) {
            EditText editText3 = this.editText;
            editText3.setPaddingRelative(editText3.getPaddingStart(), getResources().getDimensionPixelSize(C1379R.dimen.material_filled_edittext_font_1_3_padding_top), this.editText.getPaddingEnd(), getResources().getDimensionPixelSize(C1379R.dimen.material_filled_edittext_font_1_3_padding_bottom));
        }
    }
    ...
    private void setEditText(EditText editText) {
        if (this.editText != null) {
            g$$ExternalSyntheticBUOutline1.m207m("We already have an EditText, can only have one");
            return;
        }
        ...
        this.editText.addTextChangedListener(new TextWatcher(editText) { // from class: com.google.android.material.textfield.TextInputLayout.1
            ...
            public C16541(EditText editText2) {
    ...
    public class C16541 implements TextWatcher {
        int previousLineCount;
        final /* synthetic */ EditText val$editText;
    ...
    public void setCounterEnabled(boolean z) {
        if (this.counterEnabled != z) {
            if (z) {
                ...
                appCompatTextView.setId(C1379R.id.textinput_counter);
                ...
                ((ViewGroup.MarginLayoutParams) this.counterView.getLayoutParams()).setMarginStart(getResources().getDimensionPixelOffset(C1379R.dimen.mtrl_textinput_counter_margin_start));
    ...
    public void updateCounter(Editable editable) {
        ...
        if (i == -1) {
            ...
            this.counterView.setText(BidiFormatter.getInstance().unicodeWrap(getContext().getString(C1379R.string.character_counter_pattern, Integer.valueOf(iCountLength), Integer.valueOf(this.counterMaxLength))));
        }
    ...
    private static void updateCounterContentDescription(Context context, TextView textView, int i, int i2, boolean z) {
        int i3;
        if (z) {
            i3 = C1379R.string.character_counter_overflowed_content_description;
        } else {
            i3 = C1379R.string.character_counter_content_description;
        }
    ...
    public void setPlaceholderText(CharSequence charSequence) {
        if (this.placeholderTextView == null) {
            ...
            appCompatTextView.setId(C1379R.id.textinput_placeholder);
    ...
    public class C16552 extends AccessibilityDelegateCompat {
        public C16552() {
        }
    ...
    private Fade createPlaceholderFadeTransition() {
        Fade fade = new Fade();
        fade.setDuration(MotionUtils.resolveThemeDuration(getContext(), C1379R.attr.motionDurationShort2, 87));
        fade.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C1379R.attr.motionEasingLinearInterpolator, AnimationUtils.LINEAR_INTERPOLATOR));
        return fade;
    }
    ...
    public void setTextAppearanceCompatWithErrorFallback(TextView textView, int i) {
        ...
        textView.setTextColor(ContextCompat.getColor(getContext(), C1379R.color.design_error));
    }
    ...
    private Rect calculateCollapsedTextBounds(Rect rect) {
        ...
        if (i != 1) {
            int i2 = rect.left;
            if (i == 2) {
                rect2.left = i2 + this.editText.getPaddingLeft();
                rect2.top = rect.top - calculateLabelMarginTop();
                rect2.right = rect.right - this.editText.getPaddingRight();
                return rect2;
            }
            rect2.left = getLabelLeftBoundAlignedWithPrefixAndSuffix(i2, zIsLayoutRtl);
    ...
    private int calculateBoxBackgroundColor() {
        return this.boxBackgroundMode == 1 ? MaterialColors.layer(MaterialColors.getColor(this, C1379R.attr.colorSurface, 0), this.boxBackgroundColor) : this.boxBackgroundColor;
    }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public class C16581 implements Parcelable.ClassLoaderCreator<SavedState> {
            @Override // android.os.Parcelable.ClassLoaderCreator
            public SavedState createFromParcel(Parcel parcel, ClassLoader classLoader) {
                return new SavedState(parcel, classLoader);
            }
    ...
    public class RunnableC16563 implements Runnable {
        public RunnableC16563() {
        }
    ...
    public boolean updateDummyDrawables() {
        ...
        if (shouldUpdateStartDummyDrawable()) {
            int iMax = Math.max(0, this.startLayout.getMeasuredWidth() - this.editText.getPaddingLeft());
            if (this.startDummyDrawable == null || this.startDummyDrawableWidth != iMax) {
                ColorDrawable colorDrawable = new ColorDrawable();
                this.startDummyDrawable = colorDrawable;
                this.startDummyDrawableWidth = iMax;
        ...
        if (shouldUpdateEndDummyDrawable()) {
            ...
            if (drawable3 != null && this.endDummyDrawableWidth != iMax2) {
                this.endDummyDrawableWidth = iMax2;
    ...
    public void animateToExpansionFraction(float f) {
        ...
        if (this.animator == null) {
            ...
            valueAnimator.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C1379R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
            this.animator.setDuration(MotionUtils.resolveThemeDuration(getContext(), C1379R.attr.motionDurationMedium4, 167));
    ...
    /* JADX INFO: renamed from: com.google.android.material.textfield.TextInputLayout$4 */
    public class C16574 implements ValueAnimator.AnimatorUpdateListener {
        public C16574() {
        }
    ...
    public static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            ...
            String string = !zIsEmpty2 ? hint.toString() : _UrlKt.FRAGMENT_ENCODE_SET;
