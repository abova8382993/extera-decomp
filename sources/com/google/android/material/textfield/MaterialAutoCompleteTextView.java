...
public class MaterialAutoCompleteTextView extends AppCompatAutoCompleteTextView {
    ...
    public MaterialAutoCompleteTextView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C1349R.styleable.MaterialAutoCompleteTextView, i, R$style.Widget_AppCompat_AutoCompleteTextView, new int[0]);
        if (typedArrayObtainStyledAttributes.hasValue(C1349R.styleable.MaterialAutoCompleteTextView_android_inputType) && typedArrayObtainStyledAttributes.getInt(C1349R.styleable.MaterialAutoCompleteTextView_android_inputType, 0) == 0) {
            setKeyListener(null);
        }
        this.simpleItemLayout = typedArrayObtainStyledAttributes.getResourceId(C1349R.styleable.MaterialAutoCompleteTextView_simpleItemLayout, C1349R.layout.mtrl_auto_complete_simple_item);
        this.popupElevation = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C1349R.styleable.MaterialAutoCompleteTextView_android_popupElevation, C1349R.dimen.mtrl_exposed_dropdown_menu_popup_elevation);
        if (typedArrayObtainStyledAttributes.hasValue(C1349R.styleable.MaterialAutoCompleteTextView_dropDownBackgroundTint)) {
            this.dropDownBackgroundTint = ColorStateList.valueOf(typedArrayObtainStyledAttributes.getColor(C1349R.styleable.MaterialAutoCompleteTextView_dropDownBackgroundTint, 0));
        }
        this.simpleItemSelectedColor = typedArrayObtainStyledAttributes.getColor(C1349R.styleable.MaterialAutoCompleteTextView_simpleItemSelectedColor, 0);
        this.simpleItemSelectedRippleColor = MaterialResources.getColorStateList(context2, typedArrayObtainStyledAttributes, C1349R.styleable.MaterialAutoCompleteTextView_simpleItemSelectedRippleColor);
        ...
        if (typedArrayObtainStyledAttributes.hasValue(C1349R.styleable.MaterialAutoCompleteTextView_simpleItems)) {
            setSimpleItems(typedArrayObtainStyledAttributes.getResourceId(C1349R.styleable.MaterialAutoCompleteTextView_simpleItems, 0));
        }
    ...
    public boolean onKeyDown(int i, KeyEvent keyEvent) {
        if (shouldShowPopup(i)) {
            ...
            textInputLayoutFindTextInputLayoutAncestor.getEndIconView().performClick();
            return true;
        }
    ...
    protected void onAttachedToWindow() {
        ...
        if (textInputLayoutFindTextInputLayoutAncestor != null && textInputLayoutFindTextInputLayoutAncestor.isProvidingHint() && super.getHint() == null && ManufacturerUtils.isMeizuDevice()) {
            setHint(_UrlKt.FRAGMENT_ENCODE_SET);
        }
    }
