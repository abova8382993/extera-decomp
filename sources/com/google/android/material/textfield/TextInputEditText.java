...
public class TextInputEditText extends AppCompatEditText {
    ...
    public TextInputEditText(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C1349R.styleable.TextInputEditText, i, C1349R.style.Widget_Design_TextInputEditText, new int[0]);
        setTextInputLayoutFocusedRectEnabled(typedArrayObtainStyledAttributes.getBoolean(C1349R.styleable.TextInputEditText_textInputLayoutFocusedRectEnabled, false));
    ...
    private String getAccessibilityNodeInfoText(TextInputLayout textInputLayout) {
        ...
        if (zIsEmpty) {
            return !TextUtils.isEmpty(string) ? string : _UrlKt.FRAGMENT_ENCODE_SET;
        }
