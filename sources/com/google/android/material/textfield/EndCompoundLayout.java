...
class EndCompoundLayout extends LinearLayout {
    ...
    public class C16491 extends TextWatcherAdapter {
        public C16491() {
        }
    ...
    public class C16502 implements TextInputLayout.OnEditTextAttachedListener {
        public C16502() {
        }
    ...
    public EndCompoundLayout(TextInputLayout textInputLayout, TintTypedArray tintTypedArray) {
        ...
        C16502 c16502 = new TextInputLayout.OnEditTextAttachedListener() { // from class: com.google.android.material.textfield.EndCompoundLayout.2
            public C16502() {
            }
        ...
        this.onEditTextAttachedListener = c16502;
        ...
        CheckableImageButton checkableImageButtonCreateIconView = createIconView(this, layoutInflaterFrom, C1379R.id.text_input_error_icon);
        this.errorIconView = checkableImageButtonCreateIconView;
        CheckableImageButton checkableImageButtonCreateIconView2 = createIconView(frameLayout, layoutInflaterFrom, C1379R.id.text_input_end_icon);
        ...
        checkableImageButtonCreateIconView.setOnFocusableChangedListener(new CheckableImageButton.OnFocusableChangedListener() { // from class: com.google.android.material.textfield.EndCompoundLayout$$ExternalSyntheticLambda0
            ...
            public final void onFocusableChanged(View view, boolean z) {
                EndCompoundLayout.$r8$lambda$IztteKYnB40iROh4NmVj4elY4VI(this.f$0, view, z);
            }
        });
        checkableImageButtonCreateIconView2.setOnFocusableChangedListener(new CheckableImageButton.OnFocusableChangedListener() { // from class: com.google.android.material.textfield.EndCompoundLayout$$ExternalSyntheticLambda1
            @Override // com.google.android.material.internal.CheckableImageButton.OnFocusableChangedListener
            public final void onFocusableChanged(View view, boolean z) {
                EndCompoundLayout endCompoundLayout = this.f$0;
                IconHelper.updateIconTooltip(endCompoundLayout.endIconView, endCompoundLayout.endIconOnLongClickListener, endCompoundLayout.getEndIconContentDescription());
            }
        });
        textInputLayout.addOnEditTextAttachedListener(c16502);
        addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: com.google.android.material.textfield.EndCompoundLayout.3
            public ViewOnAttachStateChangeListenerC16513() {
            }
    ...
    public static /* synthetic */ void $r8$lambda$IztteKYnB40iROh4NmVj4elY4VI(EndCompoundLayout endCompoundLayout, View view, boolean z) {
        CheckableImageButton checkableImageButton = endCompoundLayout.errorIconView;
        IconHelper.updateIconTooltip(checkableImageButton, endCompoundLayout.errorIconOnLongClickListener, checkableImageButton.getContentDescription());
    }

    /* JADX INFO: renamed from: com.google.android.material.textfield.EndCompoundLayout$3 */
    public class ViewOnAttachStateChangeListenerC16513 implements View.OnAttachStateChangeListener {
        public ViewOnAttachStateChangeListenerC16513() {
        }
    ...
    private CheckableImageButton createIconView(ViewGroup viewGroup, LayoutInflater layoutInflater, int i) {
        CheckableImageButton checkableImageButton = (CheckableImageButton) layoutInflater.inflate(C1379R.layout.design_text_input_end_icon, viewGroup, false);
    ...
    private void initErrorIconView(TintTypedArray tintTypedArray) {
        if (tintTypedArray.hasValue(C1379R.styleable.TextInputLayout_errorIconTint)) {
            this.errorIconTintList = MaterialResources.getColorStateList(getContext(), tintTypedArray, C1379R.styleable.TextInputLayout_errorIconTint);
        }
        if (tintTypedArray.hasValue(C1379R.styleable.TextInputLayout_errorIconTintMode)) {
            this.errorIconTintMode = ViewUtils.parseTintMode(tintTypedArray.getInt(C1379R.styleable.TextInputLayout_errorIconTintMode, -1), null);
        }
        if (tintTypedArray.hasValue(C1379R.styleable.TextInputLayout_errorIconDrawable)) {
            setErrorIconDrawable(tintTypedArray.getDrawable(C1379R.styleable.TextInputLayout_errorIconDrawable));
        }
        this.errorIconView.setContentDescription(getResources().getText(C1379R.string.error_icon_content_description));
    ...
    private void initEndIconView(TintTypedArray tintTypedArray) {
        if (!tintTypedArray.hasValue(C1379R.styleable.TextInputLayout_passwordToggleEnabled)) {
            if (tintTypedArray.hasValue(C1379R.styleable.TextInputLayout_endIconTint)) {
                this.endIconTintList = MaterialResources.getColorStateList(getContext(), tintTypedArray, C1379R.styleable.TextInputLayout_endIconTint);
            }
            if (tintTypedArray.hasValue(C1379R.styleable.TextInputLayout_endIconTintMode)) {
                this.endIconTintMode = ViewUtils.parseTintMode(tintTypedArray.getInt(C1379R.styleable.TextInputLayout_endIconTintMode, -1), null);
            }
        }
        if (tintTypedArray.hasValue(C1379R.styleable.TextInputLayout_endIconMode)) {
            setEndIconMode(tintTypedArray.getInt(C1379R.styleable.TextInputLayout_endIconMode, 0));
            if (tintTypedArray.hasValue(C1379R.styleable.TextInputLayout_endIconContentDescription)) {
                setEndIconContentDescription(tintTypedArray.getText(C1379R.styleable.TextInputLayout_endIconContentDescription));
            }
            setEndIconCheckable(tintTypedArray.getBoolean(C1379R.styleable.TextInputLayout_endIconCheckable, true));
        } else if (tintTypedArray.hasValue(C1379R.styleable.TextInputLayout_passwordToggleEnabled)) {
            if (tintTypedArray.hasValue(C1379R.styleable.TextInputLayout_passwordToggleTint)) {
                this.endIconTintList = MaterialResources.getColorStateList(getContext(), tintTypedArray, C1379R.styleable.TextInputLayout_passwordToggleTint);
            }
            if (tintTypedArray.hasValue(C1379R.styleable.TextInputLayout_passwordToggleTintMode)) {
                this.endIconTintMode = ViewUtils.parseTintMode(tintTypedArray.getInt(C1379R.styleable.TextInputLayout_passwordToggleTintMode, -1), null);
            }
            setEndIconMode(tintTypedArray.getBoolean(C1379R.styleable.TextInputLayout_passwordToggleEnabled, false) ? 1 : 0);
            setEndIconContentDescription(tintTypedArray.getText(C1379R.styleable.TextInputLayout_passwordToggleContentDescription));
        }
        setEndIconMinSize(tintTypedArray.getDimensionPixelSize(C1379R.styleable.TextInputLayout_endIconMinSize, getResources().getDimensionPixelSize(C1379R.dimen.mtrl_min_touch_target_size)));
        if (tintTypedArray.hasValue(C1379R.styleable.TextInputLayout_endIconScaleType)) {
            setEndIconScaleType(IconHelper.convertScaleType(tintTypedArray.getInt(C1379R.styleable.TextInputLayout_endIconScaleType, -1)));
        }
    }

    private void initSuffixTextView(TintTypedArray tintTypedArray) {
        this.suffixTextView.setVisibility(8);
        this.suffixTextView.setId(C1379R.id.textinput_suffix_text);
        ...
        setSuffixTextAppearance(tintTypedArray.getResourceId(C1379R.styleable.TextInputLayout_suffixTextAppearance, 0));
        if (tintTypedArray.hasValue(C1379R.styleable.TextInputLayout_suffixTextColor)) {
            setSuffixTextColor(tintTypedArray.getColorStateList(C1379R.styleable.TextInputLayout_suffixTextColor));
        }
        setSuffixText(tintTypedArray.getText(C1379R.styleable.TextInputLayout_suffixText));
    }
    ...
    public void setEndIconMinSize(int i) {
        if (i < 0) {
            g$$ExternalSyntheticBUOutline1.m207m("endIconSize cannot be less than 0");
    ...
    public static class EndIconDelegates {
        ...
        public EndIconDelegates(EndCompoundLayout endCompoundLayout, TintTypedArray tintTypedArray) {
            ...
            this.customEndIconDrawableId = tintTypedArray.getResourceId(C1379R.styleable.TextInputLayout_endIconDrawable, 0);
            this.passwordIconDrawableId = tintTypedArray.getResourceId(C1379R.styleable.TextInputLayout_passwordToggleDrawable, 0);
        }
        ...
        private EndIconDelegate create(int i) {
            ...
            CharCodeKt$$ExternalSyntheticBUOutline0.m873m("Invalid end icon mode: ", i);
            return null;
        }
    }
}
