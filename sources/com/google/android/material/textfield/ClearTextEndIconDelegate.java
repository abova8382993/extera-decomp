...
class ClearTextEndIconDelegate extends EndIconDelegate {
    ...
    public ClearTextEndIconDelegate(EndCompoundLayout endCompoundLayout) {
        ...
        this.animationFadeDuration = MotionUtils.resolveThemeDuration(endCompoundLayout.getContext(), C1379R.attr.motionDurationShort3, 100);
        this.animationScaleDuration = MotionUtils.resolveThemeDuration(endCompoundLayout.getContext(), C1379R.attr.motionDurationShort3, 150);
        ...
        this.animationScaleInterpolator = MotionUtils.resolveThemeInterpolator(endCompoundLayout.getContext(), C1379R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR);
    }
    ...
    public int getIconDrawableResId() {
        return C1379R.drawable.mtrl_ic_cancel;
    }

    @Override // com.google.android.material.textfield.EndIconDelegate
    public int getIconContentDescriptionResId() {
        return C1379R.string.clear_text_end_icon_content_description;
    }
