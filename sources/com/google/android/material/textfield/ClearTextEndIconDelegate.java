...
class ClearTextEndIconDelegate extends EndIconDelegate {
    ...
    ClearTextEndIconDelegate(EndCompoundLayout endCompoundLayout) {
        ...
        this.animationFadeDuration = MotionUtils.resolveThemeDuration(endCompoundLayout.getContext(), C1349R.attr.motionDurationShort3, 100);
        this.animationScaleDuration = MotionUtils.resolveThemeDuration(endCompoundLayout.getContext(), C1349R.attr.motionDurationShort3, 150);
        ...
        this.animationScaleInterpolator = MotionUtils.resolveThemeInterpolator(endCompoundLayout.getContext(), C1349R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR);
    }
    ...
    int getIconDrawableResId() {
        return C1349R.drawable.mtrl_ic_cancel;
    }

    @Override // com.google.android.material.textfield.EndIconDelegate
    int getIconContentDescriptionResId() {
        return C1349R.string.clear_text_end_icon_content_description;
    }
