...
public final class KeylineState {
    ...
    public static KeylineState lerp(KeylineState keylineState, KeylineState keylineState2, float f) {
        if (keylineState.getItemSize() != keylineState2.getItemSize()) {
            g$$ExternalSyntheticBUOutline1.m207m("Keylines being linearly interpolated must have the same item size.");
            return null;
        }
        ...
        if (keylines.size() != keylines2.size()) {
            g$$ExternalSyntheticBUOutline1.m207m("Keylines being linearly interpolated must have the same number of keylines.");
            return null;
        }
    ...
    public static final class Builder {
        ...
        public Builder addKeyline(float f, float f2, float f3, boolean z, boolean z2, float f4, float f5, float f6) {
            ...
            if (z2) {
                if (z) {
                    g$$ExternalSyntheticBUOutline1.m207m("Anchor keylines cannot be focal.");
                    return null;
                }
                int i = this.latestAnchorKeylineIndex;
                if (i != -1 && i != 0) {
                    g$$ExternalSyntheticBUOutline1.m207m("Anchor keylines must be either the first or last keyline.");
                    return null;
                }
            ...
            if (z) {
                ...
                if (this.lastFocalKeylineIndex != -1 && this.tmpKeylines.size() - this.lastFocalKeylineIndex > 1) {
                    g$$ExternalSyntheticBUOutline1.m207m("Keylines marked as focal must be placed next to each other. There cannot be non-focal keylines between focal keylines.");
                    return null;
                }
                if (f3 != this.tmpFirstFocalKeyline.maskedItemSize) {
                    g$$ExternalSyntheticBUOutline1.m207m("Keylines that are marked as focal must all have the same masked item size.");
                    return null;
                }
                ...
                if (keyline2 == null && keyline.maskedItemSize < this.lastKeylineMaskedSize) {
                    g$$ExternalSyntheticBUOutline1.m207m("Keylines before the first focal keyline must be ordered by incrementing masked item size.");
                    return null;
                }
                if (this.tmpLastFocalKeyline != null && keyline.maskedItemSize > this.lastKeylineMaskedSize) {
                    g$$ExternalSyntheticBUOutline1.m207m("Keylines after the last focal keyline must be ordered by decreasing masked item size.");
                    return null;
                }
            }
        ...
        public KeylineState build() {
            if (this.tmpFirstFocalKeyline == null) {
                Segment$$ExternalSyntheticBUOutline1.m992m("There must be a keyline marked as focal.");
                return null;
            }
            ArrayList arrayList = new ArrayList();
