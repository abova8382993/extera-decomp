...
public class MaskableFrameLayout extends FrameLayout implements Maskable, Shapeable {
    ...
    public void setShapeAppearanceModel(ShapeAppearanceModel shapeAppearanceModel) {
        ...
        FocusRingDrawable focusRingDrawableFind = FocusRingDrawable.find(getBackground());
        if (focusRingDrawableFind != null) {
            focusRingDrawableFind.mutate();
            focusRingDrawableFind.setFocusRingShapeAppearance(this.shapeAppearanceModel);
        }
        FocusRingDrawable focusRingDrawableFind2 = FocusRingDrawable.find(getForeground());
        if (focusRingDrawableFind2 != null) {
            focusRingDrawableFind2.mutate();
            focusRingDrawableFind2.setFocusRingShapeAppearance(this.shapeAppearanceModel);
        }
    }
