...
final class CarouselStrategyHelper {
    ...
    public static float getExtraSmallSize(Context context) {
        return context.getResources().getDimension(C1379R.dimen.m3_carousel_gone_size);
    }

    public static float getSmallSizeMin(Context context) {
        return context.getResources().getDimension(C1379R.dimen.m3_carousel_small_item_size_min);
    }

    public static float getSmallSizeMax(Context context) {
        return context.getResources().getDimension(C1379R.dimen.m3_carousel_small_item_size_max);
    }
