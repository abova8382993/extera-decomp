...
public class CarouselLayoutManager extends RecyclerView.LayoutManager implements Carousel, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public static /* synthetic */ void $r8$lambda$l_qCTHOyjlXYirl7hEzmLbCJVAg(final CarouselLayoutManager carouselLayoutManager, View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
    ...
    public CarouselLayoutManager(CarouselStrategy carouselStrategy, int i) {
        ...
        this.recyclerViewSizeChangeListener = new View.OnLayoutChangeListener() { // from class: com.google.android.material.carousel.CarouselLayoutManager$$ExternalSyntheticLambda1
            ...
            public final void onLayoutChange(View view, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
                CarouselLayoutManager.$r8$lambda$l_qCTHOyjlXYirl7hEzmLbCJVAg(this.f$0, view, i2, i3, i4, i5, i6, i7, i8, i9);
            }
        };
    ...
    public CarouselLayoutManager(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.recyclerViewSizeChangeListener = new View.OnLayoutChangeListener() { // from class: com.google.android.material.carousel.CarouselLayoutManager$$ExternalSyntheticLambda1
            ...
            public final void onLayoutChange(View view, int i22, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
                CarouselLayoutManager.$r8$lambda$l_qCTHOyjlXYirl7hEzmLbCJVAg(this.f$0, view, i22, i3, i4, i5, i6, i7, i8, i9);
            }
        };
        this.currentEstimatedPosition = -1;
        this.carouselAlignment = 0;
    ...
    private void setCarouselAttributes(Context context, AttributeSet attributeSet) {
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1379R.styleable.Carousel);
            setCarouselAlignment(typedArrayObtainStyledAttributes.getInt(C1379R.styleable.Carousel_carousel_alignment, 0));
    ...
    private int calculateEndScroll(RecyclerView.State state, KeylineStateList keylineStateList) {
        ...
        int itemCount = (int) (((((state.getItemCount() - 1) * startState.getItemSize()) * (zIsLayoutRtl ? -1.0f : 1.0f)) - (firstFocalKeyline.loc - getParentStart())) + (((zIsLayoutRtl ? -1 : 1) * firstFocalKeyline.maskedItemSize) / 2.0f));
    ...
    private float calculateChildOffsetCenterForLocation(float f, KeylineRange keylineRange) {
        ...
        return fLerp + ((f - keyline3.loc) * (1.0f - keyline3.mask));
    }
    ...
    public void measureChildWithMargins(View view, int i, int i2) {
        ...
        float itemSize2;
        if (!(view instanceof Maskable)) {
            Segment$$ExternalSyntheticBUOutline1.m992m("All children of a RecyclerView using CarouselLayoutManager must use MaskableFrameLayout as their root ViewGroup.");
            return;
        }
    ...
    public static class DebugItemDecoration extends RecyclerView.ItemDecoration {
        ...
        public void onDrawOver(Canvas canvas, RecyclerView recyclerView, RecyclerView.State state) {
            ...
            this.linePaint.setStrokeWidth(recyclerView.getResources().getDimension(C1379R.dimen.m3_carousel_debug_keyline_width));
