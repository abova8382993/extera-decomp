...
public class CarouselLayoutManager extends RecyclerView.LayoutManager implements Carousel, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private void setCarouselAttributes(Context context, AttributeSet attributeSet) {
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1349R.styleable.Carousel);
            setCarouselAlignment(typedArrayObtainStyledAttributes.getInt(C1349R.styleable.Carousel_carousel_alignment, 0));
    ...
    private static class DebugItemDecoration extends RecyclerView.ItemDecoration {
        ...
        public void onDrawOver(Canvas canvas, RecyclerView recyclerView, RecyclerView.State state) {
            ...
            this.linePaint.setStrokeWidth(recyclerView.getResources().getDimension(C1349R.dimen.m3_carousel_debug_keyline_width));
