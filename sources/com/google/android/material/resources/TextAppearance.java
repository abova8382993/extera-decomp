...
public class TextAppearance {
    ...
    public TextAppearance(Context context, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes2 = context.obtainStyledAttributes(i, C1349R.styleable.MaterialTextAppearance);
        this.hasLetterSpacing = typedArrayObtainStyledAttributes2.hasValue(C1349R.styleable.MaterialTextAppearance_android_letterSpacing);
        this.letterSpacing = typedArrayObtainStyledAttributes2.getFloat(C1349R.styleable.MaterialTextAppearance_android_letterSpacing, 0.0f);
        if (Build.VERSION.SDK_INT >= 26) {
            this.fontVariationSettings = typedArrayObtainStyledAttributes2.getString(MaterialResources.getIndexWithValue(typedArrayObtainStyledAttributes2, C1349R.styleable.MaterialTextAppearance_fontVariationSettings, C1349R.styleable.MaterialTextAppearance_android_fontVariationSettings));
        }
