...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable, MaterialCheckable<Chip> {
    ...
    private static final int DEF_STYLE_RES = C1379R.style.Widget_MaterialComponents_Chip_Action;
    ...
    public class C14421 extends TextAppearanceFontCallback {
    ...
    public Chip(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1379R.attr.chipStyle);
    }
    ...
    public Chip(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C1379R.styleable.Chip, i, i2, new int[0]);
        boolean zHasValue = typedArrayObtainStyledAttributes.hasValue(C1379R.styleable.Chip_shapeAppearance);
        ...
        super.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: com.google.android.material.chip.Chip$$ExternalSyntheticLambda0
            ...
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                Chip.$r8$lambda$BX4ppTUZCDnixncojra1Ulz3cAk(this.f$0, compoundButton, z);
            }
        });
    }
    ...
    private void initMinTouchTarget(Context context, AttributeSet attributeSet, int i) {
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C1379R.styleable.Chip, i, DEF_STYLE_RES, new int[0]);
        this.ensureMinTouchTargetSize = typedArrayObtainStyledAttributes.getBoolean(C1379R.styleable.Chip_ensureMinTouchTargetSize, false);
        this.minTouchTargetSize = (int) Math.ceil(typedArrayObtainStyledAttributes.getDimension(C1379R.styleable.Chip_chipMinTouchTargetSize, MaterialAttributes.resolveMinimumAccessibleTouchTarget(context)));
        typedArrayObtainStyledAttributes.recycle();
    }
    ...
    private void validateAttributes(AttributeSet attributeSet) {
        ...
        if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, "drawableLeft") != null) {
            ByteString$$ExternalSyntheticBUOutline0.m979m("Please set left drawable using R.attr#chipIcon.");
            return;
        }
        if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, "drawableStart") != null) {
            ByteString$$ExternalSyntheticBUOutline0.m979m("Please set start drawable using R.attr#chipIcon.");
            return;
        }
        if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, "drawableEnd") != null) {
            ByteString$$ExternalSyntheticBUOutline0.m979m("Please set end drawable using R.attr#closeIcon.");
            return;
        }
        ...
        if (!attributeSet.getAttributeBooleanValue(NAMESPACE_ANDROID, "singleLine", true) || attributeSet.getAttributeIntValue(NAMESPACE_ANDROID, "lines", 1) != 1 || attributeSet.getAttributeIntValue(NAMESPACE_ANDROID, "minLines", 1) != 1 || attributeSet.getAttributeIntValue(NAMESPACE_ANDROID, "maxLines", 1) != 1) {
            ByteString$$ExternalSyntheticBUOutline0.m979m("Chip does not support multi-line text");
    ...
    public class C14432 extends ViewOutlineProvider {
        public C14432() {
        }
    ...
    public void setCompoundDrawablesWithIntrinsicBounds(Drawable drawable, Drawable drawable2, Drawable drawable3, Drawable drawable4) {
        if (drawable != null) {
            ...
            ByteString$$ExternalSyntheticBUOutline0.m979m("Please set right drawable using R.attr#closeIcon.");
        } else {
    ...
    public void setEllipsize(TextUtils.TruncateAt truncateAt) {
        ...
        if (truncateAt == TextUtils.TruncateAt.MARQUEE) {
            ByteString$$ExternalSyntheticBUOutline0.m979m("Text within a chip are not allowed to scroll.");
            return;
        }
        ...
        public void onPopulateNodeForVirtualView(int i, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            ...
            if (i == 1) {
                ...
                if (closeIconContentDescription != null) {
                    ...
                    int i2 = C1379R.string.mtrl_chip_close_icon_content_description;
