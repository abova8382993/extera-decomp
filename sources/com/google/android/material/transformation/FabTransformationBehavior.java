...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    public boolean layoutDependsOn(CoordinatorLayout coordinatorLayout, View view, View view2) {
        if (view.getVisibility() == 8) {
            Segment$$ExternalSyntheticBUOutline1.m992m("This behavior cannot be attached to a GONE view. Set the view to INVISIBLE instead.");
            return false;
        }
    ...
    private ViewGroup calculateChildContentContainer(View view) {
        View viewFindViewById = view.findViewById(C1379R.id.mtrl_child_content_container);
