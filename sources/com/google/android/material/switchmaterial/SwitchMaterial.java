...
public class SwitchMaterial extends SwitchCompat {
    private static final int DEF_STYLE_RES = C1349R.style.Widget_MaterialComponents_CompoundButton_Switch;
    ...
    public SwitchMaterial(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C1349R.styleable.SwitchMaterial, i, i2, new int[0]);
        this.useMaterialThemeColors = typedArrayObtainStyledAttributes.getBoolean(C1349R.styleable.SwitchMaterial_useMaterialThemeColors, false);
    ...
    private ColorStateList getMaterialThemeColorsThumbTintList() {
        if (this.materialThemeColorsThumbTintList == null) {
            int color = MaterialColors.getColor(this, C1349R.attr.colorSurface);
            int color2 = MaterialColors.getColor(this, R$attr.colorControlActivated);
            float dimension = getResources().getDimension(C1349R.dimen.mtrl_switch_thumb_elevation);
    ...
    private ColorStateList getMaterialThemeColorsTrackTintList() {
        if (this.materialThemeColorsTrackTintList == null) {
            ...
            int color = MaterialColors.getColor(this, C1349R.attr.colorSurface);
            int color2 = MaterialColors.getColor(this, R$attr.colorControlActivated);
            int color3 = MaterialColors.getColor(this, C1349R.attr.colorOnSurface);
