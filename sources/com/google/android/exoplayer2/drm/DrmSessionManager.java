    ...
    public interface DrmSessionReference {
        public static final DrmSessionReference EMPTY = new DrmSessionReference() { // from class: com.google.android.exoplayer2.drm.DrmSessionManager$DrmSessionReference$$ExternalSyntheticLambda0
            ...
            public final void release() {
                DrmSessionManager.DrmSessionReference.m2982$r8$lambda$mHbvMsH9yNicHOP1JlFDgcPEQU();
            }
        };

        /* JADX INFO: renamed from: $r8$lambda$mHbvMsH9yNicH-OP1JlFDgcPEQU, reason: not valid java name */
        static /* synthetic */ void m2982$r8$lambda$mHbvMsH9yNicHOP1JlFDgcPEQU() {
        }
