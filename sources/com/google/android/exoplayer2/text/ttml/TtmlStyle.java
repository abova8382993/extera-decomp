...
final class TtmlStyle {
    ...
    public int getFontColor() {
        if (!this.hasFontColor) {
            Segment$$ExternalSyntheticBUOutline1.m992m("Font color has not been defined.");
            return 0;
        }
    ...
    public int getBackgroundColor() {
        if (!this.hasBackgroundColor) {
            Segment$$ExternalSyntheticBUOutline1.m992m("Background color has not been defined.");
            return 0;
        }
