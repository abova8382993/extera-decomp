...
final class TtmlNode {
    ...
    public static TtmlNode buildTextNode(String str) {
        return new TtmlNode(null, TtmlRenderUtil.applyTextElementSpacePolicy(str), -9223372036854775807L, -9223372036854775807L, null, null, _UrlKt.FRAGMENT_ENCODE_SET, null, null);
    }
    ...
    private void traverseForImage(long j, String str, List list) {
        if (!_UrlKt.FRAGMENT_ENCODE_SET.equals(this.regionId)) {
            str = this.regionId;
        }
    ...
    private void traverseForStyle(long j, Map map, Map map2, String str, Map map3) {
        if (isActive(j)) {
            String str2 = _UrlKt.FRAGMENT_ENCODE_SET.equals(this.regionId) ? str : this.regionId;
    ...
    private static void cleanUpText(SpannableStringBuilder spannableStringBuilder) {
        for (DeleteTextSpan deleteTextSpan : (DeleteTextSpan[]) spannableStringBuilder.getSpans(0, spannableStringBuilder.length(), DeleteTextSpan.class)) {
            spannableStringBuilder.replace(spannableStringBuilder.getSpanStart(deleteTextSpan), spannableStringBuilder.getSpanEnd(deleteTextSpan), _UrlKt.FRAGMENT_ENCODE_SET);
        }
