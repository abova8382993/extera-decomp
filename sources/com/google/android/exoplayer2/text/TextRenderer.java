...
public final class TextRenderer extends BaseRenderer implements Handler.Callback {
    ...
    private long getNextEventTime() {
        ...
        Assertions.checkNotNull(this.subtitle);
        return this.nextSubtitleEventIndex >= this.subtitle.getEventTimeCount() ? LongCompanionObject.MAX_VALUE : this.subtitle.getEventTime(this.nextSubtitleEventIndex);
    }
    ...
    private void clearOutput() {
        updateOutput(new CueGroup(ImmutableList.m508of(), getPresentationTimeUs(this.lastRendererPositionUs)));
    }
    ...
    private void handleDecoderError(SubtitleDecoderException subtitleDecoderException) {
        Log.m323e("TextRenderer", "Subtitle decoding failed. streamFormat=" + this.streamFormat, subtitleDecoderException);
        clearOutput();
        replaceDecoder();
    }
