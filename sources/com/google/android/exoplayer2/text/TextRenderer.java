...
public final class TextRenderer extends BaseRenderer implements Handler.Callback {
    ...
    private void clearOutput() {
        updateOutput(new CueGroup(ImmutableList.m482of(), getPresentationTimeUs(this.lastRendererPositionUs)));
    }
    ...
    private void handleDecoderError(SubtitleDecoderException subtitleDecoderException) {
        Log.m326e("TextRenderer", "Subtitle decoding failed. streamFormat=" + this.streamFormat, subtitleDecoderException);
        clearOutput();
        replaceDecoder();
    }
