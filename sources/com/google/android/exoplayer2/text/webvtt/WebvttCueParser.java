...
public abstract class WebvttCueParser {
    ...
    private static WebvttCueInfo parseCue(String str, Matcher matcher, ParsableByteArray parsableByteArray, List<WebvttCssStyle> list) {
        ...
        try {
            ...
            Log.m326w("WebvttCueParser", "Skipping cue with bad header: " + matcher.group());
            return null;
        }
    }
        ...
        while (matcher.find()) {
            ...
            try {
                if ("line".equals(str2)) {
                    ...
                    Log.m326w("WebvttCueParser", "Unknown cue setting " + str2 + ":" + str3);
                }
            } catch (NumberFormatException unused) {
                Log.m326w("WebvttCueParser", "Skipping bad cue setting: " + matcher.group());
            }
        }
    }
    ...
    private static int parseLineAnchor(String str) {
        ...
        switch (str) {
            ...
            case "start":
                return 0;
            default:
                Log.m326w("WebvttCueParser", "Invalid anchor value: ".concat(str));
    ...
    private static int parseVerticalAttribute(String str) {
        ...
        Log.m326w("WebvttCueParser", "Invalid 'vertical' value: ".concat(str));
        return Integer.MIN_VALUE;
    }
    ...
    private static int parseTextAlignment(String str) {
        ...
        switch (str) {
            ...
            case "start":
                return 1;
            default:
                Log.m326w("WebvttCueParser", "Invalid alignment value: ".concat(str));
                return 2;
        }
    }
    ...
    private static void applyEntity(String str, SpannableStringBuilder spannableStringBuilder) {
        ...
        switch (str) {
            ...
            case "nbsp":
                ...
                break;
            default:
                Log.m326w("WebvttCueParser", "ignoring unsupported entity: '&" + str + ";'");
                break;
        }
    }
    ...
    public static final class WebvttCueInfoBuilder {
        ...
        private static Layout.Alignment convertTextAlignment(int i) {
            if (i != 1) {
                ...
                if (i != 3) {
                    if (i != 4) {
                        if (i != 5) {
                            Log.m326w("WebvttCueParser", "Unknown textAlignment: " + i);
                            return null;
                        }
                    }
                }
        ...
        private static float deriveMaxSize(int i, float f) {
            ...
            Segment$$ExternalSyntheticBUOutline1.m992m(String.valueOf(i));
            return 0.0f;
        }
    }
    ...
    public static final class StartTag {
        ...
        public static StartTag buildWholeCueVirtualTag() {
            return new StartTag(_UrlKt.FRAGMENT_ENCODE_SET, 0, _UrlKt.FRAGMENT_ENCODE_SET, Collections.EMPTY_SET);
        }
    }
