...
public final class WebvttCssStyle {
    ...
    private String targetId = _UrlKt.FRAGMENT_ENCODE_SET;
    private String targetTag = _UrlKt.FRAGMENT_ENCODE_SET;
    private Set<String> targetClasses = Collections.EMPTY_SET;
    private String targetVoice = _UrlKt.FRAGMENT_ENCODE_SET;
    ...
    public int getSpecificityScore(String str, String str2, Set<String> set, String str3) {
        ...
        int iUpdateScoreForMatch = updateScoreForMatch(updateScoreForMatch(updateScoreForMatch(0, this.targetId, str, TLObject.FLAG_30), this.targetTag, str2, 2), this.targetVoice, str3, 4);
    ...
    public int getFontColor() {
        if (!this.hasFontColor) {
            Segment$$ExternalSyntheticBUOutline1.m992m("Font color not defined");
            return 0;
        }
    ...
    public int getBackgroundColor() {
        if (!this.hasBackgroundColor) {
            Segment$$ExternalSyntheticBUOutline1.m992m("Background color not defined.");
            return 0;
        }
