...
public final class Format implements Bundleable {
    ...
    public /* synthetic */ Format(Builder builder, FormatIA formatIA) {
        this(builder);
    }
    ...
    public static class Builder {
        ...
        public /* synthetic */ Builder(Format format, FormatIA formatIA) {
            this(format);
        }
        ...
        public Builder setId(int i) {
            this.f354id = Integer.toString(i);
            return this;
        }
    ...
    public String toString() {
        return "Format(" + this.f353id + ", " + this.label + ", " + this.containerMimeType + ", " + this.sampleMimeType + ", " + this.codecs + ", " + this.bitrate + ", " + this.language + ", [" + this.width + ", " + this.height + ", " + this.frameRate + "], [" + this.channelCount + ", " + this.sampleRate + "])";
    }
    ...
    public static String toLogString(Format format) {
        ...
        if (format.drmInitData != null) {
            ...
            while (true) {
                ...
                if (uuid.equals(AbstractC1260C.COMMON_PSSH_UUID)) {
                    linkedHashSet.add("cenc");
                } else if (uuid.equals(AbstractC1260C.CLEARKEY_UUID)) {
                    linkedHashSet.add("clearkey");
                } else if (uuid.equals(AbstractC1260C.PLAYREADY_UUID)) {
                    linkedHashSet.add("playready");
                } else if (uuid.equals(AbstractC1260C.WIDEVINE_UUID)) {
                    linkedHashSet.add("widevine");
                } else if (uuid.equals(AbstractC1260C.UUID_NIL)) {
            ...
            sb.append(", drm=[");
            Joiner.m501on(',').appendTo(sb, linkedHashSet);
            sb.append(']');
        }
        ...
        if (format.selectionFlags != 0) {
            ...
            Joiner.m501on(',').appendTo(sb, arrayList);
            sb.append("]");
        }
        if (format.roleFlags != 0) {
            ...
            sb.append(", roleFlags=[");
            Joiner.m501on(',').appendTo(sb, arrayList2);
            sb.append("]");
        }
        return sb.toString();
    }
    ...
    public Bundle toBundle(boolean z) {
        ...
        bundle.putString(FIELD_ID, this.f353id);
