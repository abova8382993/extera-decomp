...
public class MediaCodecAudioRenderer extends MediaCodecRenderer implements MediaClock {
    ...
    protected int supportsFormat(MediaCodecSelector mediaCodecSelector, Format format) {
        ...
        if (zSupportsFormatDrm && this.audioSink.supportsFormat(format) && (!z3 || MediaCodecUtil.getDecryptOnlyDecoderInfo() != null)) {
            return RendererCapabilities.CC.create(4, 8, 32);
        }
        ...
        return RendererCapabilities.CC.create(i3, i, 32, mediaCodecInfo.hardwareAccelerated ? 64 : 0, z ? 128 : 0);
    }
    ...
    private static List getDecoderInfos(MediaCodecSelector mediaCodecSelector, Format format, boolean z, AudioSink audioSink) {
        ...
        if (audioSink.supportsFormat(format) && (decryptOnlyDecoderInfo = MediaCodecUtil.getDecryptOnlyDecoderInfo()) != null) {
            return ImmutableList.m483of((Object) decryptOnlyDecoderInfo);
        }
    ...
    protected void onCodecError(Exception exc) {
        Log.m326e("MediaCodecAudioRenderer", "Audio codec error", exc);
    ...
    private final class AudioSinkListener implements AudioSink.Listener {
        ...
        public void onAudioSinkError(Exception exc) {
            Log.m326e("MediaCodecAudioRenderer", "Audio sink error", exc);
