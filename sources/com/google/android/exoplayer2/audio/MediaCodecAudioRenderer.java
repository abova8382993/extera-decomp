...
public class MediaCodecAudioRenderer extends MediaCodecRenderer implements MediaClock {
    ...
    public int supportsFormat(MediaCodecSelector mediaCodecSelector, Format format) {
        ...
        if (zSupportsFormatDrm && this.audioSink.supportsFormat(format) && (!z3 || MediaCodecUtil.getDecryptOnlyDecoderInfo() != null)) {
            return RendererCapabilities.create(4, 8, 32);
        }
        ...
        return RendererCapabilities.create(i3, i, 32, mediaCodecInfo.hardwareAccelerated ? 64 : 0, z ? 128 : 0);
    }
    ...
    private static List<MediaCodecInfo> getDecoderInfos(MediaCodecSelector mediaCodecSelector, Format format, boolean z, AudioSink audioSink) {
        ...
        if (audioSink.supportsFormat(format) && (decryptOnlyDecoderInfo = MediaCodecUtil.getDecryptOnlyDecoderInfo()) != null) {
            return ImmutableList.m509of(decryptOnlyDecoderInfo);
        }
    ...
    public void onCodecError(Exception exc) {
        Log.m323e("MediaCodecAudioRenderer", "Audio codec error", exc);
    ...
    public void onPositionReset(long j, boolean z) throws ExoPlaybackException {
        ...
        boolean z2 = this.experimentalKeepAudioTrackOnSeek;
        AudioSink audioSink = this.audioSink;
        if (z2) {
    ...
    public final class AudioSinkListener implements AudioSink.Listener {
        ...
        public void onAudioSinkError(Exception exc) {
            Log.m323e("MediaCodecAudioRenderer", "Audio sink error", exc);
