...
public class DefaultTrackSelector extends MappingTrackSelector {
    private static final Ordering<Integer> FORMAT_VALUE_ORDERING = Ordering.from(new Comparator() { // from class: com.google.android.exoplayer2.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda0
        ...
        public final int compare(Object obj, Object obj2) {
            return DefaultTrackSelector.$r8$lambda$ab5pcQn94AtNhTwBQsSm2Lfz01g((Integer) obj, (Integer) obj2);
        }
    });
    private static final Ordering<Integer> NO_ORDER = Ordering.from(new Comparator() { // from class: com.google.android.exoplayer2.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda1
        @Override // java.util.Comparator
        public final int compare(Object obj, Object obj2) {
            return DefaultTrackSelector.$r8$lambda$TgzEdaT8vw77vbxe4MS8W_aJRBE((Integer) obj, (Integer) obj2);
        }
    });
    ...
    public static final class Parameters extends TrackSelectionParameters implements Bundleable {
        ...
        public /* synthetic */ Parameters(Builder builder, DefaultTrackSelectorIA defaultTrackSelectorIA) {
            this(builder);
        }
        ...
        public static final class Builder extends TrackSelectionParameters.Builder {
            ...
            public /* synthetic */ Builder(Bundle bundle, DefaultTrackSelectorIA defaultTrackSelectorIA) {
                this(bundle);
            }

            public /* synthetic */ Builder(Parameters parameters, DefaultTrackSelectorIA defaultTrackSelectorIA) {
                this(parameters);
            }
            ...
            private void setSelectionOverridesFromBundle(Bundle bundle) {
                ...
                if (parcelableArrayList == null) {
                    immutableListFromBundleList = ImmutableList.m508of();
                } else {
        ...
        static {
            ...
            FIELD_ALLOW_VIDEO_MIXED_MIME_TYPE_ADAPTIVENESS = Util.intToStringMaxRadix(WebSocketProtocol.CLOSE_CLIENT_GOING_AWAY);
            ...
            FIELD_ALLOW_AUDIO_MIXED_SAMPLE_RATE_ADAPTIVENESS = Util.intToStringMaxRadix(WebSocketProtocol.CLOSE_NO_STATUS_CODE);
    ...
    public static final class SelectionOverride implements Bundleable {
        ...
        public static final Bundleable.Creator<SelectionOverride> CREATOR = new Bundleable.Creator() { // from class: com.google.android.exoplayer2.trackselection.DefaultTrackSelector$SelectionOverride$$ExternalSyntheticLambda0
            @Override // com.google.android.exoplayer2.Bundleable.Creator
            public final Bundleable fromBundle(Bundle bundle) {
                return DefaultTrackSelector.SelectionOverride.$r8$lambda$NrcuImclxfyMS7IzFykzM9hD3rk(bundle);
            }
        };
        ...
        public static /* synthetic */ SelectionOverride $r8$lambda$NrcuImclxfyMS7IzFykzM9hD3rk(Bundle bundle) {
    ...
    private DefaultTrackSelector(TrackSelectionParameters trackSelectionParameters, ExoTrackSelection.Factory factory, Context context) {
        ...
        if (this.parameters.constrainAudioChannelCountToDeviceCapabilities && context == null) {
            Log.m326w("DefaultTrackSelector", "Audio channel count constraints cannot be applied without reference to Context. Build the track selector instance with one of the non-deprecated constructors that take a Context argument.");
        }
    }
    ...
    public Pair<ExoTrackSelection.Definition, Integer> selectVideoTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, final int[] iArr2, final Parameters parameters) {
    ...
    public Pair<ExoTrackSelection.Definition, Integer> selectTextTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, final Parameters parameters, final String str) {
    ...
    private <T extends TrackInfo<T>> Pair<ExoTrackSelection.Definition, Integer> selectTracksForType(int i, MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, TrackInfo.Factory<T> factory, Comparator<List<T>> comparator) {
        int i2;
        RandomAccess randomAccessM509of;
                    ...
                    while (i5 < trackGroup.length) {
                        ...
                        if (zArr[i5] || selectionEligibility == 0) {
                            ...
                            if (selectionEligibility == 1) {
                                randomAccessM509of = ImmutableList.m509of(t);
                            } else {
                                ArrayList arrayList2 = new ArrayList();
                                arrayList2.add(t);
                                int i6 = i5 + 1;
                                ...
                                randomAccessM509of = arrayList2;
                            }
                            i2 = rendererCount;
                            arrayList.add(randomAccessM509of);
                        }
                        i5++;
                        rendererCount = i2;
                    }
    ...
    */
    ...
    public static final class TextTrackInfo extends TrackInfo<TextTrackInfo> implements Comparable<TextTrackInfo> {
        ...
        public TextTrackInfo(int i, TrackGroup trackGroup, int i2, Parameters parameters, int i3, String str) {
            ImmutableList<String> immutableListM509of;
            int formatLanguageScore;
            super(i, trackGroup, i2);
            int i4 = 0;
            this.isWithinRendererCapabilities = DefaultTrackSelector.isSupported(i3, false);
            ...
            if (parameters.preferredTextLanguages.isEmpty()) {
                immutableListM509of = ImmutableList.m509of(_UrlKt.FRAGMENT_ENCODE_SET);
            } else {
                immutableListM509of = parameters.preferredTextLanguages;
            }
            int i6 = 0;
            while (true) {
                if (i6 >= immutableListM509of.size()) {
                    i6 = Integer.MAX_VALUE;
                    formatLanguageScore = 0;
                    break;
                } else {
                    formatLanguageScore = DefaultTrackSelector.getFormatLanguageScore(this.format, immutableListM509of.get(i6), parameters.selectUndeterminedTextLanguage);
                    if (formatLanguageScore > 0) {
                        break;
                    } else {
                        i6++;
        ...
        public void ensureInitialized(DefaultTrackSelector defaultTrackSelector, Looper looper) {
            if (this.listener == null && this.handler == null) {
                this.listener = new Spatializer$OnSpatializerStateChangedListener() { // from class: com.google.android.exoplayer2.trackselection.DefaultTrackSelector.SpatializerWrapperV32.1
                    ...
                    public C13561(DefaultTrackSelector defaultTrackSelector2) {
                ...
                spatializer.addOnSpatializerStateChangedListener(new MediaRoute2Provider$$ExternalSyntheticLambda1(handler), this.listener);
            }
        }

        /* JADX INFO: renamed from: com.google.android.exoplayer2.trackselection.DefaultTrackSelector$SpatializerWrapperV32$1 */
        public class C13561 implements Spatializer$OnSpatializerStateChangedListener {
            final /* synthetic */ DefaultTrackSelector val$defaultTrackSelector;
