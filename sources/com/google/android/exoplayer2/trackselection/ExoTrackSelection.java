...
public interface ExoTrackSelection extends TrackSelection {
    ...
    public static final class Definition {
        ...
        public Definition(TrackGroup trackGroup, int[] iArr, int i) {
            if (iArr.length == 0) {
                Log.m326e("ETSDefinition", "Empty tracks are not allowed", new IllegalArgumentException());
            }
    ...
    /* JADX INFO: renamed from: com.google.android.exoplayer2.trackselection.ExoTrackSelection$-CC, reason: invalid class name */
