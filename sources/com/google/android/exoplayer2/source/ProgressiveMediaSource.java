...
public final class ProgressiveMediaSource extends BaseMediaSource implements ProgressiveMediaPeriod.Listener {
    ...
    public /* synthetic */ ProgressiveMediaSource(MediaItem mediaItem, DataSource.Factory factory, ProgressiveMediaExtractor.Factory factory2, DrmSessionManager drmSessionManager, LoadErrorHandlingPolicy loadErrorHandlingPolicy, int i, ProgressiveMediaSourceIA progressiveMediaSourceIA) {
    ...
    public static final class Factory implements MediaSource.Factory {
        ...
        /* JADX INFO: renamed from: $r8$lambda$ynE478wrfTfYlYvAxVK-MNZ7MWE */
        public static /* synthetic */ ProgressiveMediaExtractor m3115$r8$lambda$ynE478wrfTfYlYvAxVKMNZ7MWE(ExtractorsFactory extractorsFactory, PlayerId playerId) {
        ...
        public Factory(DataSource.Factory factory, final ExtractorsFactory extractorsFactory) {
            this(factory, new ProgressiveMediaExtractor.Factory() { // from class: com.google.android.exoplayer2.source.ProgressiveMediaSource$Factory$$ExternalSyntheticLambda0
                ...
                public final ProgressiveMediaExtractor createProgressiveMediaExtractor(PlayerId playerId) {
                    return ProgressiveMediaSource.Factory.m3115$r8$lambda$ynE478wrfTfYlYvAxVKMNZ7MWE(extractorsFactory, playerId);
                }
            });
        }
    ...
    private void notifySourceInfoRefreshed() {
        ...
        if (this.timelineIsPlaceholder) {
            singlePeriodTimeline = new ForwardingTimeline(singlePeriodTimeline) { // from class: com.google.android.exoplayer2.source.ProgressiveMediaSource.1
                public C13461(Timeline singlePeriodTimeline2) {
    ...
    /* JADX INFO: renamed from: com.google.android.exoplayer2.source.ProgressiveMediaSource$1 */
    public class C13461 extends ForwardingTimeline {
        public C13461(Timeline singlePeriodTimeline2) {
            super(singlePeriodTimeline2);
        }
