...
final class ProgressiveMediaPeriod implements MediaPeriod, ExtractorOutput, Loader.Callback<ExtractingLoadable>, Loader.ReleaseCallback, SampleQueue.UpstreamFormatChangedListener {
    ...
    public long selectTracks(ExoTrackSelection[] exoTrackSelectionArr, boolean[] zArr, SampleStream[] sampleStreamArr, boolean[] zArr2, long j) {
        ...
        if (this.enabledTrackCount == 0) {
            ...
            boolean zIsLoading = this.loader.isLoading();
    ...
    public long getBufferedPositionUs() {
        ...
        if (largestQueuedTimestampUs == LongCompanionObject.MAX_VALUE) {
    ...
    public static final class TrackId {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj != null && TrackId.class == obj.getClass()) {
                ...
                if (this.f368id == trackId.f368id && this.isIcyTrack == trackId.isIcyTrack) {
                    return true;
                }
            }
            return false;
        ...
        public int hashCode() {
            return (this.f368id * 31) + (this.isIcyTrack ? 1 : 0);
        }
    }
