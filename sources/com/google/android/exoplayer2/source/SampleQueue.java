    ...
    */
    public void sampleMetadata(long r12, int r14, int r15, int r16, com.google.android.exoplayer2.extractor.TrackOutput.CryptoData r17) {
        ...
        L2f:
            ...
            com.google.android.exoplayer2.util.Log.m326w(r7, r1)
    ...
    public Format getAdjustedUpstreamFormat(Format format) {
        return (this.sampleOffsetUs == 0 || format.subsampleOffsetUs == LongCompanionObject.MAX_VALUE) ? format : format.buildUpon().setSubsampleOffsetUs(format.subsampleOffsetUs + this.sampleOffsetUs).build();
    }
    ...
    public static final class SharedSampleMetadata {
        ...
        public /* synthetic */ SharedSampleMetadata(Format format, DrmSessionManager.DrmSessionReference drmSessionReference, SampleQueueIA sampleQueueIA) {
