...
public final class SsMediaSource extends BaseMediaSource implements Loader.Callback<ParsingLoadable<SsManifest>> {
    ...
    public /* synthetic */ SsMediaSource(MediaItem mediaItem, SsManifest ssManifest, DataSource.Factory factory, ParsingLoadable.Parser parser, SsChunkSource.Factory factory2, CompositeSequenceableLoaderFactory compositeSequenceableLoaderFactory, DrmSessionManager drmSessionManager, LoadErrorHandlingPolicy loadErrorHandlingPolicy, long j, SsMediaSourceIA ssMediaSourceIA) {
    ...
    private void processManifest() {
        ...
        if (jMax2 == LongCompanionObject.MAX_VALUE) {
            long j = ssManifest.isLive ? -9223372036854775807L : 0L;
            SsManifest ssManifest2 = this.manifest;
            boolean z = ssManifest2.isLive;
            singlePeriodTimeline = new SinglePeriodTimeline(j, 0L, 0L, 0L, true, z, z, ssManifest2, this.mediaItem);
        } else if (ssManifest.isLive) {
            ...
            singlePeriodTimeline = new SinglePeriodTimeline(-9223372036854775807L, j4, j3, jMsToUs, true, true, true, this.manifest, this.mediaItem);
        } else {
            ...
            long j6 = j5;
            singlePeriodTimeline = new SinglePeriodTimeline(jMax2 + j6, j6, jMax2, 0L, true, false, false, this.manifest, this.mediaItem);
        }
