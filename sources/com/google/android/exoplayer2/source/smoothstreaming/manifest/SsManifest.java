...
public class SsManifest implements FilterableManifest {
    ...
    public static class StreamElement {
        ...
        private StreamElement(String str, String str2, int i, String str3, long j, String str4, int i2, int i3, int i4, int i5, String str5, Format[] formatArr, List list, long[] jArr, long j2) {
            this.baseUri = str;
        ...
        public Uri buildRequestUri(int i, int i2) {
            ...
            String string2 = ((Long) this.chunkStartTimes.get(i2)).toString();
