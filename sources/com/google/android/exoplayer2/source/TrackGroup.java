...
public final class TrackGroup implements Bundleable {
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            this.hashCode = ((527 + this.f369id.hashCode()) * 31) + Arrays.hashCode(this.formats);
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && TrackGroup.class == obj.getClass()) {
            ...
            if (this.f369id.equals(trackGroup.f369id) && Arrays.equals(this.formats, trackGroup.formats)) {
                return true;
            }
        }
        return false;
    ...
    public Bundle toBundle() {
        ...
        bundle.putString(FIELD_ID, this.f369id);
        return bundle;
    }
    ...
    private static void logErrorMessage(String str, String str2, String str3, int i) {
        Log.m323e("TrackGroup", _UrlKt.FRAGMENT_ENCODE_SET, new IllegalStateException("Different " + str + " combined in one TrackGroup: '" + str2 + "' (track 0) and '" + str3 + "' (track " + i + ")"));
    }
}
