    ...
    public long selectTracks(ExoTrackSelection[] exoTrackSelectionArr, boolean[] zArr, SampleStream[] sampleStreamArr, boolean[] zArr2, long j) {
        ...
        for (int i2 = 0; i2 < exoTrackSelectionArr.length; i2++) {
            ...
            if (exoTrackSelection != null) {
                String str = exoTrackSelection.getTrackGroup().f369id;
        ...
        while (i3 < this.periods.length) {
            ...
            if (i5 == 0) {
                ...
                Segment$$ExternalSyntheticBUOutline1.m992m("Children enabled at different positions.");
                return 0L;
            }
            boolean z = false;
    ...
    */
    public long readDiscontinuity() {
        /*
            r18 = this;
            r0 = r18
            com.google.android.exoplayer2.source.MediaPeriod[] r1 = r0.enabledPeriods
            int r2 = r1.length
        ...
        Ld:
            ...
            if (r12 != 0) goto L41
            com.google.android.exoplayer2.source.MediaPeriod[] r7 = r0.enabledPeriods
            int r8 = r7.length
            r12 = r5
        L25:
            r16 = r3
        ...
        L2e:
            ...
            goto L25
        L3b:
            okio.Segment$$ExternalSyntheticBUOutline1.m992m(r15)
            return r13
        L3f:
            r7 = r10
            goto L61
        ...
        L66:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.source.MergingMediaPeriod.readDiscontinuity():long");
    }
    ...
    public long seekToUs(long j) {
        ...
        while (true) {
            ...
            if (mediaPeriodArr[i].seekToUs(jSeekToUs) != jSeekToUs) {
                Segment$$ExternalSyntheticBUOutline1.m992m("Unexpected child seekToUs result.");
                return 0L;
            }
            i++;
        }
        ...
        while (true) {
            ...
            if (i2 < mediaPeriodArr.length) {
                ...
                while (i5 < i4) {
                    ...
                    TrackGroup trackGroupCopyWithId = trackGroup.copyWithId(i2 + ":" + trackGroup.f369id);
