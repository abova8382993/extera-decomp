    ...
    public long selectTracks(ExoTrackSelection[] exoTrackSelectionArr, boolean[] zArr, SampleStream[] sampleStreamArr, boolean[] zArr2, long j) {
        ...
        for (int i2 = 0; i2 < exoTrackSelectionArr.length; i2++) {
            ...
            if (exoTrackSelection != null) {
                String str = exoTrackSelection.getTrackGroup().f321id;
        ...
        while (i3 < this.periods.length) {
            for (int i4 = i; i4 < exoTrackSelectionArr.length; i4++) {
                ...
                if (iArr2[i4] == i3) {
                    ...
                    exoTrackSelectionArr2[i4] = new ForwardingTrackSelection(exoTrackSelection2, (TrackGroup) Assertions.checkNotNull((TrackGroup) this.childTrackGroupByMergedTrackGroup.get(exoTrackSelection2.getTrackGroup())));
                } else {
        ...
        while (true) {
            ...
            if (i2 < mediaPeriodArr.length) {
                ...
                while (i5 < i4) {
                    ...
                    TrackGroup trackGroupCopyWithId = trackGroup.copyWithId(i2 + ":" + trackGroup.f321id);
