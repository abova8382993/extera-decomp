    ...
    */
    ...
    private static DrmInitData.SchemeData parseDrmSchemeData(String str, String str2, Map map) throws ParserException {
        ...
        if ("urn:uuid:edef8ba9-79d6-4ace-a3c8-27dcd51d21ed".equals(str2)) {
            ...
            return new DrmInitData.SchemeData(AbstractC1229C.WIDEVINE_UUID, "video/mp4", Base64.decode(stringAttr.substring(stringAttr.indexOf(44)), 0));
        }
        if ("com.widevine".equals(str2)) {
            return new DrmInitData.SchemeData(AbstractC1229C.WIDEVINE_UUID, "hls", Util.getUtf8Bytes(str));
        }
