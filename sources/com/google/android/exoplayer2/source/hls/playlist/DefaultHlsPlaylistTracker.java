...
public final class DefaultHlsPlaylistTracker implements HlsPlaylistTracker, Loader.Callback {
    ...
    public void onLoadCompleted(ParsingLoadable parsingLoadable, long j, long j2) {
        ...
        if (z) {
            hlsMultivariantPlaylistCreateSingleVariantMultivariantPlaylist = HlsMultivariantPlaylist.createSingleVariantMultivariantPlaylist(hlsPlaylist.baseUri);
        } else {
            hlsMultivariantPlaylistCreateSingleVariantMultivariantPlaylist = (HlsMultivariantPlaylist) hlsPlaylist;
        }
        this.multivariantPlaylist = hlsMultivariantPlaylistCreateSingleVariantMultivariantPlaylist;
        this.primaryMediaPlaylistUrl = ((HlsMultivariantPlaylist.Variant) hlsMultivariantPlaylistCreateSingleVariantMultivariantPlaylist.variants.get(0)).url;
