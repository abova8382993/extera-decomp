...
public final class HlsMediaSource extends BaseMediaSource implements HlsPlaylistTracker.PrimaryPlaylistListener {
    ...
    public /* synthetic */ HlsMediaSource(MediaItem mediaItem, HlsDataSourceFactory hlsDataSourceFactory, HlsExtractorFactory hlsExtractorFactory, CompositeSequenceableLoaderFactory compositeSequenceableLoaderFactory, DrmSessionManager drmSessionManager, LoadErrorHandlingPolicy loadErrorHandlingPolicy, HlsPlaylistTracker hlsPlaylistTracker, long j, boolean z, int i, boolean z2, HlsMediaSourceIA hlsMediaSourceIA) {
    ...
    public void onPrimaryPlaylistRefreshed(HlsMediaPlaylist hlsMediaPlaylist) {
        ...
        if (this.playlistTracker.isLive()) {
            hlsMediaSource = this;
            singlePeriodTimelineCreateTimelineForOnDemand = hlsMediaSource.createTimelineForLive(hlsMediaPlaylist, j, jUsToMs, hlsManifest);
        } else {
            hlsMediaSource = this;
            singlePeriodTimelineCreateTimelineForOnDemand = hlsMediaSource.createTimelineForOnDemand(hlsMediaPlaylist, j, jUsToMs, hlsManifest);
        }
        hlsMediaSource.refreshSourceInfo(singlePeriodTimelineCreateTimelineForOnDemand);
    }
    ...
    */
    private com.google.android.exoplayer2.source.SinglePeriodTimeline createTimelineForOnDemand(com.google.android.exoplayer2.source.hls.playlist.HlsMediaPlaylist r25, long r26, long r28, com.google.android.exoplayer2.source.hls.HlsManifest r30) {
        ...
        L34:
            ...
            r0 = r24
            com.google.android.exoplayer2.MediaItem r0 = r0.mediaItem
            r23 = 0
