...
public abstract class SegmentBase {
    ...
    public static abstract class MultiSegmentBase extends SegmentBase {
        ...
        public final long getSegmentTimeUs(long j) {
            ...
            if (list != null) {
                j2 = list.get((int) (j - j3)).startTime - this.presentationTimeOffset;
            } else {
                j2 = (j - j3) * this.duration;
            }
    ...
    public static final class SegmentTemplate extends MultiSegmentBase {
        ...
        public RangedUri getInitialization(Representation representation) {
            ...
            if (urlTemplate != null) {
                ...
                return new RangedUri(urlTemplate.buildUri(format.f353id, 0L, format.bitrate, 0L), 0L, -1L);
            }
        ...
        public RangedUri getSegmentUrl(Representation representation, long j) {
            ...
            long j3 = this.startNumber;
            if (list != null) {
                j2 = list.get((int) (j - j3)).startTime;
            } else {
                j2 = (j - j3) * this.duration;
            }
            long j4 = j2;
            ...
            Format format = representation.format;
            return new RangedUri(urlTemplate.buildUri(format.f353id, j, format.bitrate, j4), 0L, -1L);
        }
