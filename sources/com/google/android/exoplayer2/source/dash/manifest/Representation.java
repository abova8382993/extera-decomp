...
public abstract class Representation {
    ...
    public /* synthetic */ Representation(long j, Format format, List list, SegmentBase segmentBase, List list2, List list3, List list4, RepresentationIA representationIA) {
    ...
    public static Representation newInstance(long j, Format format, List<BaseUrl> list, SegmentBase segmentBase, List<Descriptor> list2, List<Descriptor> list3, List<Descriptor> list4, String str) {
        ...
        g$$ExternalSyntheticBUOutline1.m207m("segmentBase must be of type SingleSegmentBase or MultiSegmentBase");
        return null;
    }
