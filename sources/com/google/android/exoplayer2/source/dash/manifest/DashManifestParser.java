...
public class DashManifestParser extends DefaultHandler implements ParsingLoadable.Parser {
    ...
    */
    protected com.google.android.exoplayer2.source.dash.manifest.DashManifest parseMediaPresentationDescription(org.xmlpull.v1.XmlPullParser r41, android.net.Uri r42) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
                    ...
                    if (XmlPullParserUtil.isStartTag(xmlPullParser3, "EventStream")) {
                        ...
                        if (XmlPullParserUtil.isStartTag(xmlPullParser3, "SegmentBase")) {
                            ...
                            if (XmlPullParserUtil.isStartTag(xmlPullParser3, "SegmentTemplate")) {
                                ...
                                obj = null;
                                segmentTemplate = dashManifestParser.parseSegmentTemplate(xmlPullParser3, null, ImmutableList.m482of(), j12, duration2, j18, availabilityTimeOffsetUs, j4);
                                j6 = duration2;
                                xmlPullParser2 = xmlPullParser3;
                                j8 = j12;
                                j9 = j18;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    protected com.google.android.exoplayer2.source.dash.manifest.AdaptationSet parseAdaptationSet(org.xmlpull.v1.XmlPullParser r44, java.util.List r45, com.google.android.exoplayer2.source.dash.manifest.SegmentBase r46, long r47, long r49, long r51, long r53, long r55, boolean r57) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    protected com.google.android.exoplayer2.source.dash.manifest.DashManifestParser.RepresentationInfo parseRepresentation(org.xmlpull.v1.XmlPullParser r33, java.util.List r34, java.lang.String r35, java.lang.String r36, int r37, int r38, float r39, int r40, int r41, java.lang.String r42, java.util.List r43, java.util.List r44, java.util.List r45, java.util.List r46, com.google.android.exoplayer2.source.dash.manifest.SegmentBase r47, long r48, long r50, long r52, long r54, long r56, boolean r58) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
    ...
    private static void fillInClearKeyInformation(ArrayList arrayList) {
        ...
        while (true) {
            ...
            if (AbstractC1229C.CLEARKEY_UUID.equals(schemeData.uuid) && (str = schemeData.licenseServerUrl) != null) {
                arrayList.remove(i);
                break;
            }
            i++;
        ...
        for (int i2 = 0; i2 < arrayList.size(); i2++) {
            ...
            if (AbstractC1229C.COMMON_PSSH_UUID.equals(schemeData2.uuid) && schemeData2.licenseServerUrl == null) {
                arrayList.set(i2, new DrmInitData.SchemeData(AbstractC1229C.CLEARKEY_UUID, str, schemeData2.mimeType, schemeData2.data));
            }
        }
    }
    ...
    protected static int parseCea608AccessibilityChannel(List list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if ("urn:scte:dash:cc:cea-608:2015".equals(descriptor.schemeIdUri) && (str = descriptor.value) != null) {
                ...
                Log.m329w("MpdParser", "Unable to parse CEA-608 channel number from: " + descriptor.value);
            }
        }
        return -1;
    }
    ...
    protected static int parseCea708AccessibilityChannel(List list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if ("urn:scte:dash:cc:cea-708:2015".equals(descriptor.schemeIdUri) && (str = descriptor.value) != null) {
                ...
                Log.m329w("MpdParser", "Unable to parse CEA-708 service block number from: " + descriptor.value);
            }
        }
        return -1;
    }
