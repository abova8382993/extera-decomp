...
public class DashManifestParser extends DefaultHandler implements ParsingLoadable.Parser<DashManifest> {
    ...
    */
    public com.google.android.exoplayer2.source.dash.manifest.DashManifest parseMediaPresentationDescription(org.xmlpull.v1.XmlPullParser r41, android.net.Uri r42) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
                    ...
                    if (XmlPullParserUtil.isStartTag(xmlPullParser3, "EventStream")) {
                        ...
                        if (XmlPullParserUtil.isStartTag(xmlPullParser3, "SegmentBase")) {
                            ...
                            if (XmlPullParserUtil.isStartTag(xmlPullParser3, "SegmentTemplate")) {
                                ...
                                obj = null;
                                segmentTemplate = dashManifestParser.parseSegmentTemplate(xmlPullParser3, null, ImmutableList.m508of(), j12, duration2, j18, availabilityTimeOffsetUs, j4);
                                j6 = duration2;
                                xmlPullParser2 = xmlPullParser3;
                                j8 = j12;
                                j9 = j18;
    ...
    /* JADX WARN: Removed duplicated region for block: B:74:0x036a A[LOOP:0: B:3:0x0091->B:74:0x036a, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:75:0x0324 A[EDGE_INSN: B:75:0x0324->B:68:0x0324 BREAK  A[LOOP:0: B:3:0x0091->B:74:0x036a], SYNTHETIC] */
    ...
    jadx.core.utils.exceptions.JadxOverflowException: Type inference error: updates count limit reached with updateSeq = 8991. Try increasing type updates limit count.
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public com.google.android.exoplayer2.source.dash.manifest.AdaptationSet parseAdaptationSet(org.xmlpull.v1.XmlPullParser r44, java.util.List<com.google.android.exoplayer2.source.dash.manifest.BaseUrl> r45, com.google.android.exoplayer2.source.dash.manifest.SegmentBase r46, long r47, long r49, long r51, long r53, long r55, boolean r57) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:55:0x0217 A[LOOP:0: B:3:0x006d->B:55:0x0217, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:56:0x01c8 A[EDGE_INSN: B:56:0x01c8->B:45:0x01c8 BREAK  A[LOOP:0: B:3:0x006d->B:55:0x0217], SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public com.google.android.exoplayer2.source.dash.manifest.DashManifestParser.RepresentationInfo parseRepresentation(org.xmlpull.v1.XmlPullParser r33, java.util.List<com.google.android.exoplayer2.source.dash.manifest.BaseUrl> r34, java.lang.String r35, java.lang.String r36, int r37, int r38, float r39, int r40, int r41, java.lang.String r42, java.util.List<com.google.android.exoplayer2.source.dash.manifest.Descriptor> r43, java.util.List<com.google.android.exoplayer2.source.dash.manifest.Descriptor> r44, java.util.List<com.google.android.exoplayer2.source.dash.manifest.Descriptor> r45, java.util.List<com.google.android.exoplayer2.source.dash.manifest.Descriptor> r46, com.google.android.exoplayer2.source.dash.manifest.SegmentBase r47, long r48, long r50, long r52, long r54, long r56, boolean r58) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if ((Ascii.equalsIgnoreCase("http://dashif.org/thumbnail_tile", descriptor.schemeIdUri) || Ascii.equalsIgnoreCase("http://dashif.org/guidelines/thumbnail_tile", descriptor.schemeIdUri)) && (str = descriptor.value) != null) {
                ...
                if (strArrSplit.length != 2) {
                    ...
                    try {
                        return Pair.create(Integer.valueOf(Integer.parseInt(strArrSplit[c2])), Integer.valueOf(Integer.parseInt(strArrSplit[1])));
    ...
    private static void fillInClearKeyInformation(ArrayList<DrmInitData.SchemeData> arrayList) {
        ...
        while (true) {
            ...
            if (AbstractC1260C.CLEARKEY_UUID.equals(schemeData.uuid) && (str = schemeData.licenseServerUrl) != null) {
                arrayList.remove(i);
                break;
            }
            i++;
        ...
        for (int i2 = 0; i2 < arrayList.size(); i2++) {
            ...
            if (AbstractC1260C.COMMON_PSSH_UUID.equals(schemeData2.uuid) && schemeData2.licenseServerUrl == null) {
                arrayList.set(i2, new DrmInitData.SchemeData(AbstractC1260C.CLEARKEY_UUID, str, schemeData2.mimeType, schemeData2.data));
            }
        }
    }
    ...
    public static int parseCea608AccessibilityChannel(List<Descriptor> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if ("urn:scte:dash:cc:cea-608:2015".equals(descriptor.schemeIdUri) && (str = descriptor.value) != null) {
                ...
                Log.m326w("MpdParser", "Unable to parse CEA-608 channel number from: " + descriptor.value);
            }
        }
        return -1;
    }
    ...
    public static int parseCea708AccessibilityChannel(List<Descriptor> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if ("urn:scte:dash:cc:cea-708:2015".equals(descriptor.schemeIdUri) && (str = descriptor.value) != null) {
                ...
                Log.m326w("MpdParser", "Unable to parse CEA-708 service block number from: " + descriptor.value);
            }
        }
        return -1;
    }
