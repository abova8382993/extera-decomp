...
public final class DashMediaSource extends BaseMediaSource {
    ...
    public /* synthetic */ DashMediaSource(MediaItem mediaItem, DashManifest dashManifest, DataSource.Factory factory, ParsingLoadable.Parser parser, DashChunkSource.Factory factory2, CompositeSequenceableLoaderFactory compositeSequenceableLoaderFactory, DrmSessionManager drmSessionManager, LoadErrorHandlingPolicy loadErrorHandlingPolicy, long j, DashMediaSourceIA dashMediaSourceIA) {
    ...
    public MediaPeriod createPeriod(MediaSource.MediaPeriodId mediaPeriodId, Allocator allocator, long j) {
        ...
        this.periodsById.put(dashMediaPeriod.f371id, dashMediaPeriod);
    ...
    public void releasePeriod(MediaPeriod mediaPeriod) {
        ...
        this.periodsById.remove(dashMediaPeriod.f371id);
    }
    ...
    public void onManifestLoadCompleted(ParsingLoadable<DashManifest> parsingLoadable, long j, long j2) {
        ...
        if (result.dynamic) {
            if (periodCount - i > result.getPeriodCount()) {
                Log.m326w("DashMediaSource", "Loaded out of sync manifest");
            } else {
                long j4 = this.expiredManifestPublishTimeUs;
                if (j4 != -9223372036854775807L && result.publishTimeMs * 1000 <= j4) {
                    Log.m326w("DashMediaSource", "Loaded stale dynamic manifest: " + result.publishTimeMs + ", " + this.expiredManifestPublishTimeUs);
                } else {
                    this.staleManifestReloadAttempt = 0;
                }
            }
    ...
    /* JADX INFO: renamed from: com.google.android.exoplayer2.source.dash.DashMediaSource$1 */
    public class C13481 implements SntpClient.InitializationCallback {
        public C13481() {
        }
    ...
    public void onUtcTimestampResolutionError(IOException iOException) {
        Log.m323e("DashMediaSource", "Failed to resolve time offset.", iOException);
        processManifest(true);
    }
    ...
    */
    ...
    public static final class DashTimeline extends Timeline {
        ...
        public Timeline.Period getPeriod(int i, Timeline.Period period, boolean z) {
            ...
            return period.set(z ? this.manifest.getPeriod(i).f374id : null, z ? Integer.valueOf(this.firstPeriodId + i) : null, 0, this.manifest.getPeriodDurationUs(i), Util.msToUs(this.manifest.getPeriod(i).startMs - this.manifest.getPeriod(0).startMs) - this.offsetInFirstPeriodUs);
        }
    ...
    public final class DefaultPlayerEmsgCallback implements PlayerEmsgHandler.PlayerEmsgCallback {
        public /* synthetic */ DefaultPlayerEmsgCallback(DashMediaSource dashMediaSource, DashMediaSourceIA dashMediaSourceIA) {
            this();
        }
    ...
    public final class ManifestCallback implements Loader.Callback<ParsingLoadable<DashManifest>> {
        public /* synthetic */ ManifestCallback(DashMediaSource dashMediaSource, DashMediaSourceIA dashMediaSourceIA) {
            this();
        }
    ...
    public final class UtcTimestampCallback implements Loader.Callback<ParsingLoadable<Long>> {
        public /* synthetic */ UtcTimestampCallback(DashMediaSource dashMediaSource, DashMediaSourceIA dashMediaSourceIA) {
            this();
        }
    ...
    public static final class XsDateTimeParser implements ParsingLoadable.Parser<Long> {
        public /* synthetic */ XsDateTimeParser(DashMediaSourceIA dashMediaSourceIA) {
            this();
        }
