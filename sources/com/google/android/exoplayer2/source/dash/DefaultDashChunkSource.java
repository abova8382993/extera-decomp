...
public class DefaultDashChunkSource implements DashChunkSource {
    ...
    public DefaultDashChunkSource(ChunkExtractor.Factory factory, LoaderErrorThrower loaderErrorThrower, DashManifest dashManifest, BaseUrlExclusionList baseUrlExclusionList, int i, int[] iArr, ExoTrackSelection exoTrackSelection, int i2, DataSource dataSource, long j, int i3, boolean z, List list, PlayerEmsgHandler.PlayerTrackEmsgHandler playerTrackEmsgHandler, PlayerId playerId) {
        ...
        while (i5 < this.representationHolders.length) {
            ...
            representationHolderArr[i5] = new RepresentationHolder(j2, representation, baseUrl, chunkExtractorCreateProgressiveMediaExtractor, 0L, representation.getIndex());
            i5++;
        ...
        if (playerTrackEmsgHandler == null || !playerTrackEmsgHandler.maybeRefreshManifestBeforeLoadingNextChunk(jMsToUs)) {
            ...
            while (i3 < length) {
                ...
                if (representationHolder.segmentIndex == null) {
                    ...
                    i2 = i3;
                    long segmentNum = getSegmentNum(representationHolder, mediaChunk3, j2, firstAvailableSegmentNum, lastAvailableSegmentNum);
            ...
            boolean z3 = j8 != -9223372036854775807L ? r1 == true ? 1 : 0 : false;
            ...
            long segmentNum2 = getSegmentNum(representationHolderUpdateSelectedBaseUrl, mediaChunk4, j2, firstAvailableSegmentNum2, lastAvailableSegmentNum2);
            ...
            if (j8 != -9223372036854775807L) {
                while (iMin > r1 && representationHolderUpdateSelectedBaseUrl.getSegmentStartTimeUs((((long) iMin) + segmentNum2) - 1) >= j8) {
                    iMin--;
                }
            }
    ...
    protected Chunk newMediaChunk(RepresentationHolder representationHolder, DataSource dataSource, int i, Format format, int i2, Object obj, long j, int i3, long j2, long j3) {
        ...
        int i7 = 1;
        while (i6 < i3) {
            RangedUri rangedUriAttemptMerge = segmentUrl.attemptMerge(representationHolder.getSegmentUrl(j + ((long) i6)), representationHolder.selectedBaseUrl.url);
            if (rangedUriAttemptMerge == null) {
                break;
            }
            i7++;
        ...
        return new ContainerMediaChunk(dataSource, DashUtil.buildDataSpec(representation, representationHolder.selectedBaseUrl.url, segmentUrl, i5), format, i2, obj, segmentStartTimeUs, segmentEndTimeUs2, j2, j5, j, i8, -representation.presentationTimeOffsetUs, representationHolder.chunkExtractor);
    }
