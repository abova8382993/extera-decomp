...
public final class IcyHeaders implements Metadata.Entry {
    ...
    public static IcyHeaders parse(Map<String, List<String>> map) {
        ...
        if (list != null) {
            ...
            try {
                i2 = Integer.parseInt(str4) * MediaDataController.MAX_STYLE_RUNS_COUNT;
                if (i2 > 0) {
                    z = true;
                } else {
                    try {
                        Log.m326w("IcyHeaders", "Invalid bitrate: " + str4);
                        z = false;
                        i2 = -1;
                    } catch (NumberFormatException unused) {
                        Log.m326w("IcyHeaders", "Invalid bitrate header: " + str4);
                        z = false;
                    }
                }
        ...
        if (list6 != null) {
            ...
            try {
                ...
                if (i4 > 0) {
                    ...
                    try {
                        Log.m326w("IcyHeaders", "Invalid metadata interval: " + str5);
                        z2 = z;
