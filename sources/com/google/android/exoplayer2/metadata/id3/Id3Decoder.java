...
public final class Id3Decoder extends SimpleMetadataDecoder {
    ...
    public Metadata decode(byte[] bArr, int i) throws Throwable {
        ...
        if (!validateFrames(parsableByteArray, id3HeaderDecodeHeader.majorVersion, i2, false)) {
            if (id3HeaderDecodeHeader.majorVersion != 4 || !validateFrames(parsableByteArray, 4, i2, true)) {
                Log.m326w("Id3Decoder", "Failed to validate ID3 tag with majorVersion=" + id3HeaderDecodeHeader.majorVersion);
                return null;
            }
            z = true;
        }
    ...
    private static Id3Header decodeHeader(ParsableByteArray parsableByteArray) {
        if (parsableByteArray.bytesLeft() < 10) {
            Log.m326w("Id3Decoder", "Data too short to be an ID3 tag");
            return null;
        }
        int unsignedInt24 = parsableByteArray.readUnsignedInt24();
        if (unsignedInt24 != 4801587) {
            Log.m326w("Id3Decoder", "Unexpected first three bytes of ID3 tag header: 0x".concat(String.format("%06X", Integer.valueOf(unsignedInt24))));
            return null;
        }
        ...
        if (unsignedByte == 2) {
            if ((unsignedByte2 & 64) != 0) {
                Log.m326w("Id3Decoder", "Skipped ID3 tag with majorVersion=2 and undefined compression scheme");
                return null;
            }
            ...
            if (unsignedByte != 4) {
                Log.m326w("Id3Decoder", "Skipped ID3 tag with unsupported majorVersion=" + unsignedByte);
                return null;
            }
            if ((unsignedByte2 & 64) != 0) {
  ...
  0x007c: PHI (r3v16 int) = (r3v5 int), (r3v19 int) binds: [B:42:0x0089, B:33:0x0079] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:168:0x0201 A[Catch: all -> 0x01ea, TryCatch #2 {all -> 0x01ea, blocks: (B:170:0x020b, B:157:0x01e5, B:167:0x01fc, B:168:0x0201), top: B:177:0x0111 }] */
    /* JADX WARN: Removed duplicated region for block: B:170:0x020b A[Catch: all -> 0x01ea, TRY_LEAVE, TryCatch #2 {all -> 0x01ea, blocks: (B:170:0x020b, B:157:0x01e5, B:167:0x01fc, B:168:0x0201), top: B:177:0x0111 }] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private static com.google.android.exoplayer2.metadata.id3.Id3Frame decodeFrame(int r19, com.google.android.exoplayer2.util.ParsableByteArray r20, boolean r21, int r22, com.google.android.exoplayer2.metadata.id3.Id3Decoder.FramePredicate r23) throws java.lang.Throwable {
        /*
    ...
    private static ImmutableList<String> decodeTextInformationFrameValues(byte[] bArr, int i, int i2) {
        if (i2 >= bArr.length) {
            return ImmutableList.m509of(_UrlKt.FRAGMENT_ENCODE_SET);
        }
        ...
        return immutableListBuild.isEmpty() ? ImmutableList.m509of(_UrlKt.FRAGMENT_ENCODE_SET) : immutableListBuild;
    }
