...
public final class ApicFrame extends Id3Frame {
    ...
    public String toString() {
        return this.f317id + ": mimeType=" + this.mimeType + ", description=" + this.description;
    }
    ...
    /* JADX INFO: renamed from: com.google.android.exoplayer2.metadata.id3.ApicFrame$1 */
    class C12821 implements Parcelable.Creator {
        C12821() {
        }
