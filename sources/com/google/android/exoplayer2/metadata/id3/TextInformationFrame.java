...
public final class TextInformationFrame extends Id3Frame {
    ...
    public /* synthetic */ TextInformationFrame(Parcel parcel, TextInformationFrameIA textInformationFrameIA) {
        this(parcel);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && TextInformationFrame.class == obj.getClass()) {
            ...
            if (Util.areEqual(this.f365id, textInformationFrame.f365id) && Util.areEqual(this.description, textInformationFrame.description) && this.values.equals(textInformationFrame.values)) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        int iHashCode = (527 + this.f365id.hashCode()) * 31;
    ...
    public String toString() {
        return this.f365id + ": description=" + this.description + ": values=" + this.values;
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeString(this.f365id);
    ...
    public class C13211 implements Parcelable.Creator<TextInformationFrame> {
        @Override // android.os.Parcelable.Creator
        public TextInformationFrame createFromParcel(Parcel parcel) {
            return new TextInformationFrame(parcel);
        }
