    ...
    private final class LoadTask extends Handler implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                Log.m326e("LoadTask", "Unexpected exception loading stream", e2);
                obtainMessage(2, new UnexpectedLoaderException(e2)).sendToTarget();
            } catch (OutOfMemoryError e3) {
                if (this.released) {
                    return;
                }
                Log.m326e("LoadTask", "OutOfMemory error loading stream", e3);
                obtainMessage(2, new UnexpectedLoaderException(e3)).sendToTarget();
            } catch (Error e4) {
                if (!this.released) {
                    Log.m326e("LoadTask", "Unexpected error loading stream", e4);
        ...
        public void handleMessage(Message message) {
            ...
            if (i2 == 1) {
                try {
                    ...
                    Log.m326e("LoadTask", "Unexpected exception handling load completed", e);
