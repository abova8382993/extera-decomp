...
public final class Loader implements LoaderErrorThrower {
    ...
    public static final class LoadErrorAction {
        ...
        public /* synthetic */ LoadErrorAction(int i, long j, LoaderIA loaderIA) {
            this(i, j);
        }
    ...
    public final class LoadTask<T extends Loadable> extends Handler implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                Log.m323e("LoadTask", "Unexpected exception loading stream", e2);
                obtainMessage(2, new UnexpectedLoaderException(e2)).sendToTarget();
            } catch (OutOfMemoryError e3) {
                if (this.released) {
                    return;
                }
                Log.m323e("LoadTask", "OutOfMemory error loading stream", e3);
                obtainMessage(2, new UnexpectedLoaderException(e3)).sendToTarget();
            } catch (Error e4) {
                if (!this.released) {
                    Log.m323e("LoadTask", "Unexpected error loading stream", e4);
        ...
        public void handleMessage(Message message) {
            ...
            if (i2 == 1) {
                try {
                    ...
                    Log.m323e("LoadTask", "Unexpected exception handling load completed", e);
