    ...
    private DataSource getRtmpDataSource() {
        if (this.rtmpDataSource == null) {
            try {
                ...
                Log.m326w("DefaultDataSource", "Attempting to play RTMP stream without depending on the RTMP extension");
            } catch (Exception e) {
                Make$Map$$ExternalSyntheticBUOutline0.m1024m("Error instantiating RTMP extension", e);
                return null;
            }
            if (this.rtmpDataSource == null) {
