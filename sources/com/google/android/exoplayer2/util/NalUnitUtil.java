...
public abstract class NalUnitUtil {
    ...
    public static boolean isNalUnitSei(String str, byte b2) {
        return (MediaController.VIDEO_MIME_TYPE.equals(str) && (b2 & 31) == 6) || ("video/hevc".equals(str) && ((b2 & 126) >> 1) == 39);
    }
        ...
        if (parsableNalUnitBitArray.readBit() && parsableNalUnitBitArray.readBit()) {
            ...
            if (bits4 == 255) {
                ...
                if (bits4 < fArr.length) {
                    ...
                    Log.m326w("NalUnitUtil", "Unexpected aspect_ratio_idc value: " + bits4);
                }
            }
        }
            ...
            if (parsableNalUnitBitArray.readBit()) {
                ...
                if (bits5 == 255) {
                    ...
                    if (bits5 < fArr.length) {
                        ...
                        Log.m326w("NalUnitUtil", "Unexpected aspect_ratio_idc value: " + bits5);
                    }
                }
            }
            if (parsableNalUnitBitArray.readBit()) {
