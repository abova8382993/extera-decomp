...
final class DefaultOggSeeker implements OggSeeker {
    ...
    private long getNextSeekPosition(ExtractorInput extractorInput) throws IOException {
        ...
        if (!this.pageHeader.skipToNextPage(extractorInput, this.end)) {
            ...
            Model$$ExternalSyntheticBUOutline0.m1247m("No ogg page can be found.");
            return 0L;
        }
    ...
    public final class OggSeekMap implements SeekMap {
        public /* synthetic */ OggSeekMap(DefaultOggSeeker defaultOggSeeker, DefaultOggSeekerIA defaultOggSeekerIA) {
            this();
        }
