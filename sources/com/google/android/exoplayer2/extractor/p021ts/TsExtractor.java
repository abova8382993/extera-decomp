...
public final class TsExtractor implements Extractor {
    ...
    */
    public boolean sniff(com.google.android.exoplayer2.extractor.ExtractorInput r6) {
        /*
            r5 = this;
        ...
        L29:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.extractor.p021ts.TsExtractor.sniff(com.google.android.exoplayer2.extractor.ExtractorInput):boolean");
    }
    ...
    private void resetPayloadReaders() {
        ...
        while (true) {
            ...
            if (i < size) {
                sparseArray.put(sparseArrayCreateInitialPayloadReaders.keyAt(i), sparseArrayCreateInitialPayloadReaders.valueAt(i));
                i++;
            } else {
    ...
    public class PatReader implements SectionPayloadReader {
        ...
        @Override // com.google.android.exoplayer2.extractor.p021ts.SectionPayloadReader
    ...
    public class PmtReader implements SectionPayloadReader {
        ...
        public void consume(ParsableByteArray parsableByteArray) {
            ...
            while (iBytesLeft > 0) {
                ...
                if (!TsExtractor.this.trackIds.get(i4)) {
                    if (TsExtractor.this.mode == 2 && bits == 21) {
                        tsPayloadReaderCreatePayloadReader = TsExtractor.this.id3Reader;
                    } else {
                        tsPayloadReaderCreatePayloadReader = TsExtractor.this.payloadReaderFactory.createPayloadReader(bits, esInfo2);
                    }
        ...
        /*
            ...
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        private com.google.android.exoplayer2.extractor.ts.TsPayloadReader.EsInfo readEsInfo(com.google.android.exoplayer2.util.ParsableByteArray r12, int r13) {
            /*
