...
public class MatroskaExtractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() { // from class: com.google.android.exoplayer2.extractor.mkv.MatroskaExtractor$$ExternalSyntheticLambda0
        ...
        public final Extractor[] createExtractors() {
            return MatroskaExtractor.m3026$r8$lambda$87TamK49CzdHuvU83sCFZ0l6iA();
        }
    };
    ...
    public static /* synthetic */ Extractor[] m3026$r8$lambda$87TamK49CzdHuvU83sCFZ0l6iA() {
    ...
    public void endMasterElement(int i) throws ParserException {
        ...
        if (i == 25152) {
            ...
            if (track3.hasContentEncryption) {
                ...
                track3.drmInitData = new DrmInitData(new DrmInitData.SchemeData(AbstractC1260C.UUID_NIL, "video/webm", this.currentTrack.cryptoData.encryptionKey));
                return;
            }
            return;
        }
    ...
    */
    public void binaryElement(int r25, int r26, com.google.android.exoplayer2.extractor.ExtractorInput r27) throws com.google.android.exoplayer2.ParserException {
        /*
    ...
    */
                ...
                if ((b2 & 1) == 1) {
                    ...
                    if (z2) {
                        ...
                        while (true) {
                            ...
                            if (i7 == 0) {
                                byteBuffer2.putShort((short) (unsignedIntToInt - i6));
                            } else {
                                byteBuffer2.putInt(unsignedIntToInt - i6);
                            }
                            i5++;
                            i6 = unsignedIntToInt;
                        }
        ...
        if ("V_MPEG4/ISO/AVC".equals(track.codecId) || "V_MPEGH/ISO/HEVC".equals(track.codecId)) {
            ...
            while (this.sampleBytesRead < iLimit2) {
                ...
                if (i12 == 0) {
                    ...
                    int iWriteToOutput = writeToOutput(extractorInput, trackOutput, i12);
            ...
            while (true) {
                ...
                int iWriteToOutput2 = writeToOutput(extractorInput, trackOutput, iLimit2 - i13);
    ...
    private SeekMap buildSeekMap(LongArray longArray, LongArray longArray2) {
        ...
        jArrCopyOf2[i] = j;
        if (j <= 0) {
            Log.m326w("MatroskaExtractor", "Discarding last cue point with unexpected duration: " + j);
        ...
        */
        ...
        private static Pair<String, List<byte[]>> parseFourCcPrivate(ParsableByteArray parsableByteArray) throws ParserException {
            try {
                ...
                Log.m326w("MatroskaExtractor", "Unknown FourCC. Setting mimeType to video/x-unknown");
