...
public class MatroskaExtractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() { // from class: com.google.android.exoplayer2.extractor.mkv.MatroskaExtractor$$ExternalSyntheticLambda0
        ...
        public final Extractor[] createExtractors() {
            return MatroskaExtractor.m3133$r8$lambda$87TamK49CzdHuvU83sCFZ0l6iA();
        }
    ...
    public static /* synthetic */ Extractor[] m3133$r8$lambda$87TamK49CzdHuvU83sCFZ0l6iA() {
    ...
    protected void endMasterElement(int i) throws ParserException {
        ...
        if (i == 25152) {
            ...
            if (track3.hasContentEncryption) {
                ...
                track3.drmInitData = new DrmInitData(new DrmInitData.SchemeData(AbstractC1229C.UUID_NIL, "video/webm", this.currentTrack.cryptoData.encryptionKey));
                return;
            }
            return;
        }
    ...
    */
    ...
    private SeekMap buildSeekMap(LongArray longArray, LongArray longArray2) {
        ...
        jArrCopyOf2[i] = j;
        if (j <= 0) {
            Log.m329w("MatroskaExtractor", "Discarding last cue point with unexpected duration: " + j);
        ...
        */
        ...
        private static Pair parseFourCcPrivate(ParsableByteArray parsableByteArray) throws ParserException {
            try {
                ...
                Log.m329w("MatroskaExtractor", "Unknown FourCC. Setting mimeType to video/x-unknown");
