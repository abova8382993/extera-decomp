...
abstract class AtomParsers {
    ...
    public static Metadata parseMdtaFromMeta(Atom.ContainerAtom containerAtom) {
        ...
        while (parsableByteArray2.bytesLeft() > 8) {
            ...
            if (i5 >= 0 && i5 < i) {
                ...
                Log.m329w("AtomParsers", "Skipped metadata with unknown key index: " + i5);
            }
    ...
    private static Track parseTrak(Atom.ContainerAtom containerAtom, Atom.LeafAtom leafAtom, long j, DrmInitData drmInitData, boolean z, boolean z2) throws ParserException {
        ...
        StsdData stsd = parseStsd(leafAtomOfType.data, tkhd.f313id, tkhd.rotationDegrees, (String) mdhd.second, drmInitData, z2);
        ...
        return new Track(tkhd.f313id, trackTypeForHdlr, ((Long) mdhd.first).longValue(), mvhd, jScaleLargeTimestamp, stsd.format, stsd.requiredSampleTransformation, stsd.trackEncryptionBoxes, stsd.nalUnitLengthFieldLength, jArr, jArr2);
    }
    ...
    */
    ...
    private static void parseTextSampleEntry(ParsableByteArray parsableByteArray, int i, int i2, int i3, int i4, String str, StsdData stsdData) {
        ...
        ImmutableList immutableListM483of = null;
        ...
        if (i != 1414810956) {
            if (i == 1954034535) {
                ...
                immutableListM483of = ImmutableList.m483of((Object) bArr);
        ...
        stsdData.format = new Format.Builder().setId(i4).setSampleMimeType(str2).setLanguage(str).setSubsampleOffsetUs(j).setInitializationData(immutableListM483of).build();
    }
    ...
    private static void parseVideoSampleEntry(ParsableByteArray parsableByteArray, int i, int i2, int i3, int i4, int i5, DrmInitData drmInitData, StsdData stsdData, int i6) throws ParserException {
        ...
        while (position - i9 < i10) {
            ...
            if (i14 == 1635148611) {
                ...
                listM483of = avcConfig.initializationData;
                ...
                listM483of = hevcConfig.initializationData;
                ...
                if (i14 == 1685480259 || i14 == 1685485123) {
                    ...
                    if (i14 == 1681012275) {
                        ...
                        listM483of = bArr3 != null ? ImmutableList.m483of((Object) bArr3) : list;
                        str = str6;
                        projFromParent = bArr;
                        paspFromParent = f;
                        position = i7 + i13;
                        ...
                        if (i15 == 1852009592 || i15 == 1852009571) {
                            ...
                            Log.m329w("AtomParsers", "Unsupported color type: " + Atom.getAtomTypeString(i15));
                        }
                    }
                }
                listM483of = list;
        ...
        public StszSampleSizeBox(Atom.LeafAtom leafAtom, Format format) {
            ...
            if ("audio/raw".equals(format.sampleMimeType)) {
                ...
                if (unsignedIntToInt == 0 || unsignedIntToInt % pcmFrameSize != 0) {
                    Log.m329w("AtomParsers", "Audio sample size mismatch. stsd sample size: " + pcmFrameSize + ", stsz sample size: " + unsignedIntToInt);
