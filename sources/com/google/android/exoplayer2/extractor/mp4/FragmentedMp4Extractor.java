...
public class FragmentedMp4Extractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() { // from class: com.google.android.exoplayer2.extractor.mp4.FragmentedMp4Extractor$$ExternalSyntheticLambda0
        ...
        public final Extractor[] createExtractors() {
            return FragmentedMp4Extractor.m3044$r8$lambda$EbWg24HAiluodvRuBK7KGHbPlM();
        }
    };
    ...
    /* JADX INFO: renamed from: $r8$lambda$EbWg24HAil-uodvRuBK7KGHbPlM */
    public static /* synthetic */ Extractor[] m3044$r8$lambda$EbWg24HAiluodvRuBK7KGHbPlM() {
    ...
    private void onMoovContainerAtomRead(Atom.ContainerAtom containerAtom) {
        ...
        if (this.trackBundles.size() == 0) {
            while (i < size2) {
                ...
                this.trackBundles.put(track.f362id, new TrackBundle(this.extractorOutput.track(i, track.type), trackSampleTable, getDefaultSampleValues(sparseArray, track.f362id)));
        ...
        while (i < size2) {
            ...
            this.trackBundles.get(track2.f362id).reset(trackSampleTable2, getDefaultSampleValues(sparseArray, track2.f362id));
            i++;
        }
    }
    ...
    private void onEmsgLeafAtomRead(ParsableByteArray parsableByteArray) {
        ...
        if (fullAtomVersion == 0) {
            ...
            if (fullAtomVersion != 1) {
                Log.m326w("FragmentedMp4Extractor", "Skipping unsupported emsg version: " + fullAtomVersion);
                return;
            }
        ...
        if (jAdjustSampleTimestamp == -9223372036854775807L) {
            arrayDeque.addLast(new MetadataSampleInfo(jScaleLargeTimestamp, true, iBytesLeft));
    ...
    private static int parseTrun(TrackBundle trackBundle, int i, int i2, ParsableByteArray parsableByteArray, int i3) throws ParserException {
        ...
        while (i13 < i12) {
            ...
            int i14 = i13;
            long jScaleLargeTimestamp = Util.scaleLargeTimestamp((((long) i10) + j4) - j2, 1000000L, j3);
            jArr3[i14] = jScaleLargeTimestamp;
            if (!trackFragment.nextFragmentDecodeTimeIncludesMoov) {
                jArr3[i14] = jScaleLargeTimestamp + trackBundle.moovSampleTable.durationUs;
            }
            iArr[i14] = i7;
    ...
    private boolean readSample(ExtractorInput extractorInput) throws ParserException {
        ...
        if (nextTrackBundle == null) {
            ...
            if (currentSampleOffset < 0) {
                Log.m326w("FragmentedMp4Extractor", "Ignoring negative offset to sample data.");
        ...
        if (this.parserState == 3) {
            ...
            boolean zEquals = "audio/ac4".equals(nextTrackBundle.moovSampleTable.track.format.sampleMimeType);
        ...
        if (track.nalUnitLengthFieldLength == 0) {
            ...
            while (true) {
                ...
                this.sampleBytesWritten += trackOutput.sampleData((DataReader) extractorInput, i6 - i5, false);
            }
        } else {
            ...
            while (this.sampleBytesWritten < this.sampleSize) {
                ...
                if (i10 == 0) {
                    ...
                    if (this.processSeiNalUnitPayload) {
                        ...
                        i = i3;
                        iSampleData = trackOutput.sampleData((DataReader) extractorInput, i10, false);
                    }
    ...
    private static DrmInitData getDrmInitDataFromAtoms(List<Atom.LeafAtom> list) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (leafAtom.type == 1886614376) {
                ...
                if (uuid == null) {
                    Log.m326w("FragmentedMp4Extractor", "Skipped pssh atom (failed to extract uuid)");
                } else {
    ...
    public static final class TrackBundle {
        ...
        public int outputSampleEncryptionData(int i, int i2) {
            ...
            if (i2 != 0) {
                ...
                int i4 = (((data2[2] & UByte.MAX_VALUE) << 8) | (data2[3] & UByte.MAX_VALUE)) + i2;
