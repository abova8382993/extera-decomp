    ...
    */
    public com.google.android.exoplayer2.extractor.SeekMap.SeekPoints getSeekPoints(long r17, int r19) {
        /*
            ...
            int r5 = r4.length
            if (r5 != 0) goto L13
            com.google.android.exoplayer2.extractor.SeekMap$SeekPoints r0 = new com.google.android.exoplayer2.extractor.SeekMap$SeekPoints
            com.google.android.exoplayer2.extractor.SeekPoint r1 = com.google.android.exoplayer2.extractor.SeekPoint.START
            r0.<init>(r1)
            return r0
        L13:
            r5 = -1
    ...
    private int readSefData(ExtractorInput extractorInput, PositionHolder positionHolder) throws ParserException {
    ...
    private void processMoovAtom(Atom.ContainerAtom containerAtom) {
        ...
        while (i3 < size) {
            ...
            if (trackSampleTable.sampleCount == 0) {
                ...
                i2 = i3;
                boolean zEquals = "audio/true-hd".equals(track.format.sampleMimeType);
                int i4 = trackSampleTable.maximumSize;
                ...
                if (track.type != 2 || j3 <= 0) {
                    ...
                    int i6 = trackSampleTable.sampleCount;
                    z = true;
                    if (i6 > 1) {
                        builderBuildUpon.setFrameRate(i6 / (j3 / 1000000.0f));
                    }
                }
    ...
    private int getTrackIndexOfNextReadSample(long j) {
        ...
        return (j2 == LongCompanionObject.MAX_VALUE || !z || j3 < j2 + 524288) ? i2 : i;
    }
