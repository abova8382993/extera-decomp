    ...
    */
    ...
    private void processMoovAtom(Atom.ContainerAtom containerAtom) {
        ...
        if (leafAtomOfType != null) {
            Pair udta = AtomParsers.parseUdta(leafAtomOfType);
        ...
        List traks = AtomParsers.parseTraks(containerAtom, gaplessInfoHolder, -9223372036854775807L, null, (this.flags & 1) != 0, z3, new Function() { // from class: com.google.android.exoplayer2.extractor.mp4.Mp4Extractor$$ExternalSyntheticLambda0
