    ...
    */
    ...
    public static Metadata.Entry parseIlstElement(ParsableByteArray parsableByteArray) {
        ...
        try {
            ...
            Log.m324d("MetadataUtil", "Skipped unknown metadata entry: " + Atom.getAtomTypeString(i));
    ...
    private static TextInformationFrame parseTextAttribute(int i, String str, ParsableByteArray parsableByteArray) {
        ...
        if (parsableByteArray.readInt() == 1684108385) {
            ...
            return new TextInformationFrame(str, null, ImmutableList.m483of((Object) parsableByteArray.readNullTerminatedString(i2 - 16)));
        }
        Log.m329w("MetadataUtil", "Failed to parse text attribute: " + Atom.getAtomTypeString(i));
        return null;
    }
    ...
    private static CommentFrame parseCommentAttribute(int i, ParsableByteArray parsableByteArray) {
        ...
        Log.m329w("MetadataUtil", "Failed to parse comment attribute: " + Atom.getAtomTypeString(i));
        return null;
    }
    ...
    private static Id3Frame parseUint8Attribute(int i, String str, ParsableByteArray parsableByteArray, boolean z, boolean z2) {
        ...
        if (uint8AttributeValue >= 0) {
            if (z) {
                return new TextInformationFrame(str, null, ImmutableList.m483of((Object) Integer.toString(uint8AttributeValue)));
            }
            return new CommentFrame(TranslateController.UNKNOWN_LANGUAGE, str, Integer.toString(uint8AttributeValue));
        }
        Log.m329w("MetadataUtil", "Failed to parse uint8 attribute: " + Atom.getAtomTypeString(i));
        return null;
    }
    ...
    private static TextInformationFrame parseIndexAndCountAttribute(int i, String str, ParsableByteArray parsableByteArray) {
        ...
        if (parsableByteArray.readInt() == 1684108385 && i2 >= 22) {
            ...
            if (unsignedShort > 0) {
                ...
                return new TextInformationFrame(str, null, ImmutableList.m483of((Object) str2));
            }
        }
        Log.m329w("MetadataUtil", "Failed to parse index/count attribute: " + Atom.getAtomTypeString(i));
        return null;
    }
    ...
    */
    private static com.google.android.exoplayer2.metadata.id3.TextInformationFrame parseStandardGenreAttribute(com.google.android.exoplayer2.util.ParsableByteArray r3) {
        ...
        L12:
            ...
            com.google.common.collect.ImmutableList r3 = com.google.common.collect.ImmutableList.m483of(r3)
            r1.<init>(r2, r0, r3)
            return r1
        L20:
            java.lang.String r3 = "MetadataUtil"
            java.lang.String r1 = "Failed to parse standard genre code"
            com.google.android.exoplayer2.util.Log.m329w(r3, r1)
            return r0
        */
    ...
    private static ApicFrame parseCoverArt(ParsableByteArray parsableByteArray) {
        ...
        int i = parsableByteArray.readInt();
        if (parsableByteArray.readInt() != 1684108385) {
            Log.m329w("MetadataUtil", "Failed to parse cover art attribute");
            return null;
        }
        ...
        if (str == null) {
            Log.m329w("MetadataUtil", "Unrecognized cover art flags: " + fullAtomFlags);
            return null;
        }
    ...
    private static int parseUint8AttributeValue(ParsableByteArray parsableByteArray) {
        ...
        Log.m329w("MetadataUtil", "Failed to parse uint8 attribute value");
        return -1;
    }
}
