...
public final class WavExtractor implements Extractor {
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() { // from class: com.google.android.exoplayer2.extractor.wav.WavExtractor$$ExternalSyntheticLambda0
        ...
        public final Extractor[] createExtractors() {
            return WavExtractor.m3073$r8$lambda$hJhS_tAOYd6XskUkvwF6Vj5ae0();
        }
    };
    ...
    /* JADX INFO: renamed from: $r8$lambda$hJhS_-tAOYd6XskUkvwF6Vj5ae0, reason: not valid java name */
    public static /* synthetic */ Extractor[] m3073$r8$lambda$hJhS_tAOYd6XskUkvwF6Vj5ae0() {
    ...
    private void skipToSampleData(ExtractorInput extractorInput) throws ParserException {
        ...
        if (length != -1 && this.dataEndPosition > length) {
            Log.m326w("WavExtractor", "Data exceeds input length: " + this.dataEndPosition + ", " + length);
    ...
    public static final class ImaAdPcmOutputWriter implements OutputWriter {
        ...
        private static final int[] STEP_TABLE = {7, 8, 9, 10, 11, 12, 13, 14, 16, 17, 19, 21, 23, 25, 28, 31, 34, 37, 41, 45, 50, 55, 60, 66, 73, 80, 88, 97, 107, 118, 130, 143, 157, 173, 190, Opcodes.RSUB_INT, 230, Opcodes.INVOKE_CUSTOM_RANGE, 279, HttpStatusCodesKt.HTTP_TEMP_REDIRECT, 337, 371, 408, 449, 494, 544, 598, 658, 724, 796, 876, 963, 1060, 1166, 1282, 1411, 1552, 1707, 1878, 2066, 2272, 2499, 2749, 3024, 3327, 3660, 4026, 4428, 4871, 5358, 5894, 6484, 7132, 7845, 8630, 9493, 10442, 11487, 12635, 13899, 15289, 16818, 18500, 20350, 22385, 24623, 27086, 29794, 32767};
        ...
        */
        ...
        private void decodeBlockForChannel(byte[] bArr, int i, int i2, byte[] bArr2) {
            ...
            for (int i10 = 0; i10 < i7 * 2; i10++) {
                ...
                int i11 = i10 % 2 == 0 ? b2 & 15 : (b2 & UByte.MAX_VALUE) >> 4;
