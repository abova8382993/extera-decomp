...
public abstract class VorbisUtil {
    ...
    public static Metadata parseVorbisComments(List<String> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if (strArrSplitAtFirst.length != 2) {
                Log.m326w("VorbisUtil", "Failed to parse Vorbis comment: " + str);
                ...
                try {
                    ...
                    Log.m327w("VorbisUtil", "Failed to parse vorbis picture", e);
                }
            } else {
    ...
    private static void readMappings(int i, VorbisBitArray vorbisBitArray) throws ParserException {
        ...
        for (int i2 = 0; i2 < bits; i2++) {
            ...
            if (bits2 != 0) {
                Log.m322e("VorbisUtil", "mapping type other than 0 not supported: " + bits2);
            } else {
