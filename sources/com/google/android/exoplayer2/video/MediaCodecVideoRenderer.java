...
public class MediaCodecVideoRenderer extends MediaCodecRenderer {
    ...
    protected void onCodecError(Exception exc) {
        Log.m326e("MediaCodecVideoRenderer", "Video codec error", exc);
    ...
    protected CodecMaxValues getCodecMaxValues(MediaCodecInfo mediaCodecInfo, Format format, Format[] formatArr) {
        ...
        if (z) {
            Log.m329w("MediaCodecVideoRenderer", "Resolutions unknown. Codec max resolution: " + iMax + "x" + iMax2);
            ...
            if (codecMaxSize != null) {
                ...
                Log.m329w("MediaCodecVideoRenderer", "Codec max resolution adjusted to: " + iMax + "x" + iMax2);
            }
        }
        return new CodecMaxValues(iMax, iMax2, maxInputSize);
    }
