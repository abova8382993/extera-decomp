    ...
    */
    ...
    public void updateDefaultDisplayRefreshRateParams(Display display) {
        if (display != null) {
            ...
            Log.m326w("VideoFrameReleaseHelper", "Unable to query display refresh rate");
            this.vsyncDurationNs = -9223372036854775807L;
            this.vsyncOffsetNs = -9223372036854775807L;
        }
    }
    ...
    public static final class Api30 {
        public static void setSurfaceFrameRate(Surface surface, float f) {
            try {
                ...
                Log.m323e("VideoFrameReleaseHelper", "Failed to call Surface.setFrameRate", e);
            }
        }
    }
    ...
    public static final class VSyncSampler implements Choreographer.FrameCallback, Handler.Callback {
        ...
        private void createChoreographerInstanceInternal() {
            try {
                ...
                Log.m327w("VideoFrameReleaseHelper", "Vsync sampling disabled due to platform error", e);
            }
        }
