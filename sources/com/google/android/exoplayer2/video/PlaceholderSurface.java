            ...
            try {
                ...
                try {
                    try {
                        ...
                        Log.m326e("PlaceholderSurface", "Failed to initialize placeholder surface", e);
                        this.initException = new IllegalStateException(e);
                        synchronized (this) {
                            notify();
                        }
                    } catch (Error e2) {
                        Log.m326e("PlaceholderSurface", "Failed to initialize placeholder surface", e2);
                        this.initError = e2;
                        synchronized (this) {
                            notify();
                        }
                    ...
                    Log.m326e("PlaceholderSurface", "Failed to initialize placeholder surface", e3);
