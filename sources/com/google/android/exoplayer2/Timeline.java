...
public abstract class Timeline implements Bundleable {
    ...
    public static final class Window implements Bundleable {
        ...
        public int hashCode() {
            int iHashCode = (((Opcodes.RSUB_INT_LIT8 + this.uid.hashCode()) * 31) + this.mediaItem.hashCode()) * 31;
    ...
    public static final class Period implements Bundleable {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj != null && Period.class.equals(obj.getClass())) {
                ...
                if (Util.areEqual(this.f359id, period.f359id) && Util.areEqual(this.uid, period.uid) && this.windowIndex == period.windowIndex && this.durationUs == period.durationUs && this.positionInWindowUs == period.positionInWindowUs && this.isPlaceholder == period.isPlaceholder && Util.areEqual(this.adPlaybackState, period.adPlaybackState)) {
                    return true;
                }
            }
            return false;
        ...
        public int hashCode() {
            Object obj = this.f359id;
            int iHashCode = (Opcodes.RSUB_INT_LIT8 + (obj == null ? 0 : obj.hashCode())) * 31;
    ...
    /* JADX INFO: renamed from: com.google.android.exoplayer2.Timeline$1 */
    public class C12751 extends Timeline {
        @Override // com.google.android.exoplayer2.Timeline
        public int getIndexOfPeriod(Object obj) {
            return -1;
        }
    ...
    public int hashCode() {
        Window window = new Window();
        Period period = new Period();
        int windowCount = Opcodes.RSUB_INT_LIT8 + getWindowCount();
        for (int i = 0; i < getWindowCount(); i++) {
    ...
    public static final class RemotableTimeline extends Timeline {
        ...
        public Period getPeriod(int i, Period period, boolean z) {
            ...
            period.set(period2.f359id, period2.uid, period2.windowIndex, period2.durationUs, period2.positionInWindowUs, period2.adPlaybackState, period2.isPlaceholder);
            return period;
        }
