...
public abstract class MediaCodecUtil {
    ...
    public static class DecoderQueryException extends Exception {
        public /* synthetic */ DecoderQueryException(Throwable th, MediaCodecUtilIA mediaCodecUtilIA) {
            this(th);
        }
        ...
        try {
            ...
            if (z && decoderInfosInternal.isEmpty() && Util.SDK_INT <= 23) {
                ...
                if (!decoderInfosInternal.isEmpty()) {
                    Log.m326w("MediaCodecUtil", "MediaCodecList API didn't list secure decoder for: " + str + ". Assuming: " + decoderInfosInternal.get(0).name);
                }
            }
    ...
    public static List<MediaCodecInfo> getDecoderInfosSortedByFormatSupport(List<MediaCodecInfo> list, final Format format) {
        ...
        sortByScore(arrayList, new ScoreProvider() { // from class: com.google.android.exoplayer2.mediacodec.MediaCodecUtil$$ExternalSyntheticLambda0
            ...
            public final int getScore(Object obj) {
                return MediaCodecUtil.m3082$r8$lambda$sLOK7ccsSur1NtiGvNU7qvptuU(format, (MediaCodecInfo) obj);
            }
        });
        return arrayList;
    }

    /* JADX INFO: renamed from: $r8$lambda$sLOK7ccsS-ur1NtiGvNU7qvptuU */
    public static /* synthetic */ int m3082$r8$lambda$sLOK7ccsSur1NtiGvNU7qvptuU(Format format, MediaCodecInfo mediaCodecInfo) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:135:0x008d A[PHI: r16
  0x008d: PHI (r16v9 boolean) = (r16v5 boolean), (r16v11 boolean) binds: [B:141:0x009d, B:133:0x008a] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:165:0x00fc A[Catch: Exception -> 0x0146, TRY_ENTER, TryCatch #4 {Exception -> 0x0146, blocks: (B:103:0x000a, B:105:0x001d, B:168:0x011b, B:108:0x002d, B:111:0x0038, B:162:0x00f4, B:165:0x00fc, B:167:0x0102, B:169:0x0123, B:170:0x0144), top: B:183:0x000a }] */
    /* JADX WARN: Removed duplicated region for block: B:190:0x0123 A[ADDED_TO_REGION, REMOVE, SYNTHETIC] */
    /*
    ...
    */
        ...
        if (i < 21 && list.size() > 1) {
            ...
            if ("OMX.SEC.mp3.dec".equals(str2) || "OMX.SEC.MP3.Decoder".equals(str2) || "OMX.brcm.audio.mp3.decoder".equals(str2)) {
                sortByScore(list, new ScoreProvider() { // from class: com.google.android.exoplayer2.mediacodec.MediaCodecUtil$$ExternalSyntheticLambda3
                    @Override // com.google.android.exoplayer2.mediacodec.MediaCodecUtil.ScoreProvider
                    public final int getScore(Object obj) {
                        return MediaCodecUtil.m3081$r8$lambda$gFxzaZ51c5G_GcWNtAzN1F2QZg((MediaCodecInfo) obj);
                    }
                });
            }
        }
    ...
    /* JADX INFO: renamed from: $r8$lambda$gFxzaZ51c5G_GcWNtAzN1F-2QZg */
    public static /* synthetic */ int m3081$r8$lambda$gFxzaZ51c5G_GcWNtAzN1F2QZg(MediaCodecInfo mediaCodecInfo) {
    ...
    private static Pair<Integer, Integer> getDolbyVisionProfileAndLevel(String str, String[] strArr) {
        if (strArr.length < 3) {
            Log.m326w("MediaCodecUtil", "Ignoring malformed Dolby Vision codec string: " + str);
            return null;
        }
        ...
        if (numDolbyVisionStringToProfile == null) {
            Log.m326w("MediaCodecUtil", "Unknown Dolby Vision profile string: " + strGroup);
            return null;
        }
        String str2 = strArr[2];
        Integer numDolbyVisionStringToLevel = dolbyVisionStringToLevel(str2);
        if (numDolbyVisionStringToLevel == null) {
            Log.m326w("MediaCodecUtil", "Unknown Dolby Vision level string: " + str2);
            return null;
        }
    ...
    private static Pair<Integer, Integer> getHevcProfileAndLevel(String str, String[] strArr) {
        if (strArr.length < 4) {
            Log.m326w("MediaCodecUtil", "Ignoring malformed HEVC codec string: " + str);
            return null;
        }
        int i = 1;
        Matcher matcher = PROFILE_PATTERN.matcher(strArr[1]);
        ...
        if (!"1".equals(strGroup)) {
            if (!"2".equals(strGroup)) {
                Log.m326w("MediaCodecUtil", "Unknown HEVC profile string: " + strGroup);
                return null;
            }
            i = 2;
        }
        ...
        if (numHevcCodecStringToProfileLevel == null) {
            Log.m326w("MediaCodecUtil", "Unknown HEVC level string: " + str2);
            return null;
        }
    ...
    private static Pair<Integer, Integer> getAvcProfileAndLevel(String str, String[] strArr) {
        ...
        int i2;
        if (strArr.length < 2) {
            Log.m326w("MediaCodecUtil", "Ignoring malformed AVC codec string: " + str);
            return null;
        }
        try {
            ...
            if (iAvcProfileNumberToConst == -1) {
                Log.m326w("MediaCodecUtil", "Unknown AVC profile: " + i2);
                return null;
            }
            int iAvcLevelNumberToConst = avcLevelNumberToConst(i);
            if (iAvcLevelNumberToConst == -1) {
                Log.m326w("MediaCodecUtil", "Unknown AVC level: " + i);
                return null;
            }
    ...
    private static Pair<Integer, Integer> getVp9ProfileAndLevel(String str, String[] strArr) {
        if (strArr.length < 3) {
            Log.m326w("MediaCodecUtil", "Ignoring malformed VP9 codec string: " + str);
            return null;
        }
        try {
            ...
            if (iVp9ProfileNumberToConst == -1) {
                Log.m326w("MediaCodecUtil", "Unknown VP9 profile: " + i);
                return null;
            }
            int iVp9LevelNumberToConst = vp9LevelNumberToConst(i2);
            if (iVp9LevelNumberToConst == -1) {
                Log.m326w("MediaCodecUtil", "Unknown VP9 level: " + i2);
                return null;
            }
    ...
    private static Pair<Integer, Integer> getAv1ProfileAndLevel(String str, String[] strArr, ColorInfo colorInfo) {
        int i;
        if (strArr.length < 4) {
            Log.m326w("MediaCodecUtil", "Ignoring malformed AV1 codec string: " + str);
            return null;
        }
        int i2 = 1;
        try {
            ...
            if (i3 != 0) {
                Log.m326w("MediaCodecUtil", "Unknown AV1 profile: " + i3);
                return null;
            }
            if (i5 != 8 && i5 != 10) {
                Log.m326w("MediaCodecUtil", "Unknown AV1 bit depth: " + i5);
                return null;
            }
            if (i5 != 8) {
            ...
            if (iAv1LevelNumberToConst == -1) {
                Log.m326w("MediaCodecUtil", "Unknown AV1 level: " + i4);
                return null;
            }
    ...
    private static Pair<Integer, Integer> getAacCodecProfileAndLevel(String str, String[] strArr) {
        ...
        if (strArr.length != 3) {
            Log.m326w("MediaCodecUtil", "Ignoring malformed MP4A codec string: " + str);
            return null;
        }
        try {
    ...
    public static final class MediaCodecListCompatV16 implements MediaCodecListCompat {
        public /* synthetic */ MediaCodecListCompatV16(MediaCodecUtilIA mediaCodecUtilIA) {
            this();
        }
