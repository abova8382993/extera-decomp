...
public abstract class MediaCodecUtil {
        ...
        try {
            ...
            if (z && decoderInfosInternal.isEmpty() && Util.SDK_INT <= 23) {
                ...
                if (!decoderInfosInternal.isEmpty()) {
                    Log.m329w("MediaCodecUtil", "MediaCodecList API didn't list secure decoder for: " + str + ". Assuming: " + ((MediaCodecInfo) decoderInfosInternal.get(0)).name);
                }
            }
    ...
    public static List getDecoderInfosSortedByFormatSupport(List list, final Format format) {
        ...
        sortByScore(arrayList, new ScoreProvider() { // from class: com.google.android.exoplayer2.mediacodec.MediaCodecUtil$$ExternalSyntheticLambda0
            ...
            public final int getScore(Object obj) {
                return MediaCodecUtil.m3189$r8$lambda$sLOK7ccsSur1NtiGvNU7qvptuU(format, (MediaCodecInfo) obj);
            }
        });
        return arrayList;
    }
    ...
    public static /* synthetic */ int m3189$r8$lambda$sLOK7ccsSur1NtiGvNU7qvptuU(Format format, MediaCodecInfo mediaCodecInfo) {
  ...
  0x008d: PHI (r16v9 boolean) = (r16v5 boolean), (r16v11 boolean) binds: [B:41:0x009d, B:33:0x008a] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    private static java.util.ArrayList getDecoderInfosInternal(com.google.android.exoplayer2.mediacodec.MediaCodecUtil.CodecKey r19, com.google.android.exoplayer2.mediacodec.MediaCodecUtil.MediaCodecListCompat r20) throws com.google.android.exoplayer2.mediacodec.MediaCodecUtil.DecoderQueryException {
        /*
        ...
        if (i < 21 && list.size() > 1) {
            ...
            if ("OMX.SEC.mp3.dec".equals(str2) || "OMX.SEC.MP3.Decoder".equals(str2) || "OMX.brcm.audio.mp3.decoder".equals(str2)) {
                sortByScore(list, new ScoreProvider() { // from class: com.google.android.exoplayer2.mediacodec.MediaCodecUtil$$ExternalSyntheticLambda3
                    @Override // com.google.android.exoplayer2.mediacodec.MediaCodecUtil.ScoreProvider
                    public final int getScore(Object obj) {
                        return MediaCodecUtil.m3188$r8$lambda$gFxzaZ51c5G_GcWNtAzN1F2QZg((MediaCodecInfo) obj);
                    }
                });
            }
        }
    ...
    public static /* synthetic */ int m3188$r8$lambda$gFxzaZ51c5G_GcWNtAzN1F2QZg(MediaCodecInfo mediaCodecInfo) {
    ...
    private static Pair getDolbyVisionProfileAndLevel(String str, String[] strArr) {
        if (strArr.length < 3) {
            Log.m329w("MediaCodecUtil", "Ignoring malformed Dolby Vision codec string: " + str);
            return null;
        }
        ...
        if (numDolbyVisionStringToProfile == null) {
            Log.m329w("MediaCodecUtil", "Unknown Dolby Vision profile string: " + strGroup);
            return null;
        }
        String str2 = strArr[2];
        Integer numDolbyVisionStringToLevel = dolbyVisionStringToLevel(str2);
        if (numDolbyVisionStringToLevel == null) {
            Log.m329w("MediaCodecUtil", "Unknown Dolby Vision level string: " + str2);
            return null;
        }
    ...
    private static Pair getHevcProfileAndLevel(String str, String[] strArr) {
        if (strArr.length < 4) {
            Log.m329w("MediaCodecUtil", "Ignoring malformed HEVC codec string: " + str);
            return null;
        }
        int i = 1;
        Matcher matcher = PROFILE_PATTERN.matcher(strArr[1]);
        ...
        if (!"1".equals(strGroup)) {
            if (!"2".equals(strGroup)) {
                Log.m329w("MediaCodecUtil", "Unknown HEVC profile string: " + strGroup);
                return null;
            }
            i = 2;
        }
        ...
        if (numHevcCodecStringToProfileLevel == null) {
            Log.m329w("MediaCodecUtil", "Unknown HEVC level string: " + str2);
            return null;
        }
    ...
    private static Pair getAvcProfileAndLevel(String str, String[] strArr) {
        ...
        int i2;
        if (strArr.length < 2) {
            Log.m329w("MediaCodecUtil", "Ignoring malformed AVC codec string: " + str);
            return null;
        }
        try {
            ...
            if (iAvcProfileNumberToConst == -1) {
                Log.m329w("MediaCodecUtil", "Unknown AVC profile: " + i2);
                return null;
            }
            int iAvcLevelNumberToConst = avcLevelNumberToConst(i);
            if (iAvcLevelNumberToConst == -1) {
                Log.m329w("MediaCodecUtil", "Unknown AVC level: " + i);
                return null;
            }
    ...
    private static Pair getVp9ProfileAndLevel(String str, String[] strArr) {
        if (strArr.length < 3) {
            Log.m329w("MediaCodecUtil", "Ignoring malformed VP9 codec string: " + str);
            return null;
        }
        try {
            ...
            if (iVp9ProfileNumberToConst == -1) {
                Log.m329w("MediaCodecUtil", "Unknown VP9 profile: " + i);
                return null;
            }
            int iVp9LevelNumberToConst = vp9LevelNumberToConst(i2);
            if (iVp9LevelNumberToConst == -1) {
                Log.m329w("MediaCodecUtil", "Unknown VP9 level: " + i2);
                return null;
            }
    ...
    private static Pair getAv1ProfileAndLevel(String str, String[] strArr, ColorInfo colorInfo) {
        int i;
        if (strArr.length < 4) {
            Log.m329w("MediaCodecUtil", "Ignoring malformed AV1 codec string: " + str);
            return null;
        }
        int i2 = 1;
        try {
            ...
            if (i3 != 0) {
                Log.m329w("MediaCodecUtil", "Unknown AV1 profile: " + i3);
                return null;
            }
            if (i5 != 8 && i5 != 10) {
                Log.m329w("MediaCodecUtil", "Unknown AV1 bit depth: " + i5);
                return null;
            }
            if (i5 != 8) {
            ...
            if (iAv1LevelNumberToConst == -1) {
                Log.m329w("MediaCodecUtil", "Unknown AV1 level: " + i4);
                return null;
            }
    ...
    private static Pair getAacCodecProfileAndLevel(String str, String[] strArr) {
        ...
        if (strArr.length != 3) {
            Log.m329w("MediaCodecUtil", "Ignoring malformed MP4A codec string: " + str);
            return null;
        }
        try {
