...
public abstract class MediaCodecRenderer extends BaseRenderer {
    ...
    public abstract MediaCodecAdapter.Configuration getMediaCodecConfiguration(MediaCodecInfo mediaCodecInfo, Format format, MediaCrypto mediaCrypto, float f, EGLContext eGLContext);
    ...
    public abstract void onCodecInitialized(String str, MediaCodecAdapter.Configuration configuration, long j, long j2);
    ...
    public void onStreamChanged(Format[] formatArr, long j, long j2) {
        ...
        if (i == this.pendingOutputStreamOffsetsUs.length) {
            Log.m326w("MediaCodecRenderer", "Too many stream changes, so dropping offset: " + this.pendingOutputStreamOffsetsUs[this.pendingOutputStreamOffsetCount - 1]);
        } else {
        ...
        if (i == 2) {
            ...
            if (i2 >= 23) {
                try {
                    ...
                    Log.m327w("MediaCodecRenderer", "Failed to update the DRM session, releasing the codec instead.", e);
                    releaseCodec();
                    return true;
                }
            }
    ...
    /* JADX WARN: Removed duplicated region for block: B:115:0x00ad A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:121:0x004a A[SYNTHETIC] */
    ...
    */
    private void maybeInitCodecWithFallback(android.media.MediaCrypto r8, boolean r9) throws com.google.android.exoplayer2.mediacodec.MediaCodecRenderer.DecoderInitializationException {
        ...
        L61:
            ...
            com.google.android.exoplayer2.util.Log.m326w(r4, r3)     // Catch: java.lang.Exception -> L74
            r5 = 50
        ...
        L77:
            ...
            com.google.android.exoplayer2.util.Log.m327w(r4, r5, r3)
            ...
            goto La4
        L9e:
            com.google.android.exoplayer2.mediacodec.MediaCodecRenderer$DecoderInitializationException r2 = com.google.android.exoplayer2.mediacodec.MediaCodecRenderer.DecoderInitializationException.m3080$$Nest$mcopyWithFallbackException(r2, r4)
    ...
    private List<MediaCodecInfo> getAvailableCodecInfos(boolean z) {
        ...
        if (!decoderInfos2.isEmpty()) {
            Log.m326w("MediaCodecRenderer", "Drm session requires secure decoder for " + this.inputFormat.sampleMimeType + ", but no secure decoder available. Trying to proceed with " + decoderInfos2 + ".");
        }
    ...
    private void initCodec(MediaCodecInfo mediaCodecInfo, MediaCrypto mediaCrypto) {
        ...
        try {
            ...
            if (!mediaCodecInfo.isFormatSupported(this.inputFormat)) {
                Log.m326w("MediaCodecRenderer", Util.formatInvariant("Format exceeds selected codec's capabilities [%s, %s]", Format.toLogString(this.inputFormat), str));
            }
            this.codecInfo = mediaCodecInfo;
    ...
    /* JADX WARN: Type inference failed for: r15v0, types: [com.google.android.exoplayer2.BaseRenderer, com.google.android.exoplayer2.mediacodec.MediaCodecRenderer] */
    /* JADX WARN: Type inference failed for: r15v1, types: [com.google.android.exoplayer2.BaseRenderer, com.google.android.exoplayer2.mediacodec.MediaCodecRenderer] */
    ...
    private boolean feedInputBuffer() throws ExoPlaybackException {
        ...
        try {
            ...
            try {
                if (zIsEncrypted) {
                    mediaCodecAdapter.queueSecureInputBuffer(this.inputIndex, 0, this.buffer.cryptoInfo, j, 0);
                } else {
                    mediaCodecAdapter.queueInputBuffer(this.inputIndex, 0, this.buffer.data.limit(), j, 0);
                }
                resetInputBuffer();
                this.codecReceivedBuffers = true;
                this.codecReconfigurationState = 0;
