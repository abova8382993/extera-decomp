...
public final class MediaCodecInfo {
    ...
    private void logNoSupport(String str) {
        Log.m324d("MediaCodecInfo", "NoSupport [" + str + "] [" + this.name + ", " + this.mimeType + "] [" + Util.DEVICE_DEBUG_INFO + "]");
    }

    private void logAssumedSupport(String str) {
        Log.m324d("MediaCodecInfo", "AssumedSupport [" + str + "] [" + this.name + ", " + this.mimeType + "] [" + Util.DEVICE_DEBUG_INFO + "]");
    }
    ...
    private static int adjustMaxInputChannelCount(String str, String str2, int i) {
        ...
        Log.m329w("MediaCodecInfo", "AssumedMaxChannelAdjustment: " + str + ", [" + i + " to " + i2 + "]");
        return i2;
    }
    ...
    private static final class Api29 {
        public static int areResolutionAndFrameRateCovered(MediaCodecInfo.VideoCapabilities videoCapabilities, int i, int i2, double d) {
            ...
            MediaCodecInfo$Api29$$ExternalSyntheticApiModelOutline1.m317m();
            MediaCodecInfo.VideoCapabilities.PerformancePoint performancePointM316m = MediaCodecInfo$Api29$$ExternalSyntheticApiModelOutline0.m316m(i, i2, (int) d);
            for (int i3 = 0; i3 < supportedPerformancePoints.size(); i3++) {
                if (MediaCodecInfo$Api29$$ExternalSyntheticApiModelOutline2.m318m(supportedPerformancePoints.get(i3)).covers(performancePointM316m)) {
                    return 2;
                }
            }
            return 1;
