...
public final class MediaCodecInfo {
    ...
    private void logNoSupport(String str) {
        Log.m321d("MediaCodecInfo", "NoSupport [" + str + "] [" + this.name + ", " + this.mimeType + "] [" + Util.DEVICE_DEBUG_INFO + "]");
    }

    private void logAssumedSupport(String str) {
        Log.m321d("MediaCodecInfo", "AssumedSupport [" + str + "] [" + this.name + ", " + this.mimeType + "] [" + Util.DEVICE_DEBUG_INFO + "]");
    }
    ...
    private static int adjustMaxInputChannelCount(String str, String str2, int i) {
        ...
        Log.m326w("MediaCodecInfo", "AssumedMaxChannelAdjustment: " + str + ", [" + i + " to " + i2 + "]");
        return i2;
    }
    ...
    public static final class Api29 {
        public static int areResolutionAndFrameRateCovered(MediaCodecInfo.VideoCapabilities videoCapabilities, int i, int i2, double d) {
            ...
            MediaCodecInfo$Api29$$ExternalSyntheticApiModelOutline1.m314m();
            MediaCodecInfo.VideoCapabilities.PerformancePoint performancePointM313m = MediaCodecInfo$Api29$$ExternalSyntheticApiModelOutline0.m313m(i, i2, (int) d);
            for (int i3 = 0; i3 < supportedPerformancePoints.size(); i3++) {
                if (MediaCodecInfo$Api29$$ExternalSyntheticApiModelOutline2.m315m(supportedPerformancePoints.get(i3)).covers(performancePointM313m)) {
                    return 2;
                }
            }
            return 1;
