...
final class zzgk {
    ...
    static int zzc(zzkr zzkrVar, byte[] bArr, int i, int i2, int i3, zzgj zzgjVar) throws zzje {
    ...
    static int zzd(zzkr zzkrVar, byte[] bArr, int i, int i2, zzgj zzgjVar) throws zzje {
        Object objZze = zzkrVar.zze();
    ...
    static int zze(zzkr zzkrVar, int i, byte[] bArr, int i2, int i3, zzjb zzjbVar, zzgj zzgjVar) throws zzje {
    ...
    static int zzf(byte[] bArr, int i, zzjb zzjbVar, zzgj zzgjVar) throws zzje {
    ...
    static int zzg(byte[] bArr, int i, zzgj zzgjVar) throws zzje {
        ...
        if (i2 == 0) {
            zzgjVar.zzc = _UrlKt.FRAGMENT_ENCODE_SET;
            return iZzi;
        }
    ...
    static int zzh(int i, byte[] bArr, int i2, int i3, zzlm zzlmVar, zzgj zzgjVar) throws zzje {
        ...
        if (i4 == 2) {
            ...
            if (i5 == 0) {
                ...
                zzlmVar.zzj(i, zzgw.zzm(bArr, iZzi, i5));
            }
            return iZzi + i5;
        }
        if (i4 != 3) {
        ...
        while (true) {
            ...
            i2 = zzh(i7, bArr, iZzi2, i3, zzlmVarZzf, zzgjVar);
        }
        if (i2 > i3 || i7 != i6) {
            throw zzje.zzg();
        }
    ...
    static int zzm(Object obj, zzkr zzkrVar, byte[] bArr, int i, int i2, int i3, zzgj zzgjVar) throws zzje {
        int iZzc = ((zzkh) zzkrVar).zzc(obj, bArr, i, i2, i3, zzgjVar);
        zzgjVar.zzc = obj;
        return iZzc;
    }

    static int zzn(Object obj, zzkr zzkrVar, byte[] bArr, int i, int i2, zzgj zzgjVar) throws zzje {
        int iZzj = i + 1;
        int i3 = bArr[i];
        if (i3 < 0) {
