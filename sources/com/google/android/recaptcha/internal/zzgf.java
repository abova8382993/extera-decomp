...
public abstract class zzgf<MessageType extends zzgf<MessageType, BuilderType>, BuilderType extends zzge<MessageType, BuilderType>> implements zzke {
        ...
        for (Object obj2 : iterable) {
            if (obj2 == null) {
                ...
                while (true) {
                    size4--;
                    if (size4 < size3) {
                        g$$ExternalSyntheticBUOutline2.m208m(str2);
                        return;
                    }
                    list.remove(size4);
                }
    ...
    public final zzgw zzb() {
        try {
            ...
            zzgf$$ExternalSyntheticBUOutline0.m496m("Serializing ", getClass().getName(), " to a ByteString threw an IOException (should never happen).", e);
            return null;
        }
    }
