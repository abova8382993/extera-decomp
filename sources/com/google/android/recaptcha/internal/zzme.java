...
public final class zzme {
    ...
    public static zzib zza(long j) {
        ...
        CameraSelector$$ExternalSyntheticBUOutline0.m71m("Duration is not valid. See proto definition for valid values. Seconds (%s) must be in range [-315,576,000,000, +315,576,000,000]. Nanos (%s) must be in range [-999,999,999, +999,999,999]. Nanos must have the same sign as seconds", new Object[]{Long.valueOf(jZzg), Integer.valueOf(iZzf)});
        return null;
    }
}
