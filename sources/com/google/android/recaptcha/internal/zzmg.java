...
public final class zzmg {
    ...
    public static zzlj zza(zzlj zzljVar) {
        ...
        CameraSelector$$ExternalSyntheticBUOutline0.m71m("Timestamp is not valid. See proto definition for valid values. Seconds (%s) must be in range [-62,135,596,800, +253,402,300,799]. Nanos (%s) must be in range [0, +999,999,999].", new Object[]{Long.valueOf(jZzg), Integer.valueOf(iZzf)});
        return null;
    }
    ...
    public static String zzc(zzlj zzljVar) {
        ...
        if (iZzf != 0) {
            sb.append(".");
            sb.append(iZzf % DurationKt.NANOS_IN_MILLIS == 0 ? String.format(Locale.ENGLISH, "%1$03d", Integer.valueOf(iZzf / DurationKt.NANOS_IN_MILLIS)) : iZzf % MediaDataController.MAX_STYLE_RUNS_COUNT == 0 ? String.format(Locale.ENGLISH, "%1$06d", Integer.valueOf(iZzf / MediaDataController.MAX_STYLE_RUNS_COUNT)) : String.format(Locale.ENGLISH, "%1$09d", Integer.valueOf(iZzf)));
        }
        sb.append("Z");
        return sb.toString();
    }
