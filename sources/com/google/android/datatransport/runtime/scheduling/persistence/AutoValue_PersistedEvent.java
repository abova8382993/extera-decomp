...
final class AutoValue_PersistedEvent extends PersistedEvent {
    ...
    public String toString() {
        return "PersistedEvent{id=" + this.f304id + ", transportContext=" + this.transportContext + ", event=" + this.event + "}";
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PersistedEvent) {
            ...
            if (this.f304id == persistedEvent.getId() && this.transportContext.equals(persistedEvent.getTransportContext()) && this.event.equals(persistedEvent.getEvent())) {
                return true;
            }
        }
        return false;
