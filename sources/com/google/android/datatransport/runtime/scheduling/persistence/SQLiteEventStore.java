...
public class SQLiteEventStore implements EventStore, SynchronizationGuard, ClientHealthMetricsStore {
    private static final Encoding PROTOBUF_ENCODING = Encoding.m294of("proto");
    ...
    public PersistedEvent persist(final TransportContext transportContext, final EventInternal eventInternal) {
        Logging.m297d("SQLiteEventStore", "Storing event with priority=%s, name=%s for destination %s", transportContext.getPriority(), eventInternal.getTransportName(), transportContext.getBackendName());
        long jLongValue = ((Long) inTransaction(new Function() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore$$ExternalSyntheticLambda6
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore.Function
            public final Object apply(Object obj) {
                return SQLiteEventStore.m2716$r8$lambda$Yygha28Nx4WElzmz7AGC_M3niQ(this.f$0, eventInternal, transportContext, (SQLiteDatabase) obj);
            }
        })).longValue();
        if (jLongValue < 1) {
            return null;
    ...
    public static /* synthetic */ Long m2716$r8$lambda$Yygha28Nx4WElzmz7AGC_M3niQ(SQLiteEventStore sQLiteEventStore, EventInternal eventInternal, TransportContext transportContext, SQLiteDatabase sQLiteDatabase) {
    ...
    public boolean hasPendingEventsFor(final TransportContext transportContext) {
        return ((Boolean) inTransaction(new Function() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore$$ExternalSyntheticLambda12
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore.Function
            public final Object apply(Object obj) {
                return SQLiteEventStore.m2713$r8$lambda$G8uJS54jP30MGd1qBdzDbSf55k(this.f$0, transportContext, (SQLiteDatabase) obj);
            }
        })).booleanValue();
    }

    /* JADX INFO: renamed from: $r8$lambda$G8uJ-S54jP30MGd1qBdzDbSf55k, reason: not valid java name */
    public static /* synthetic */ Boolean m2713$r8$lambda$G8uJS54jP30MGd1qBdzDbSf55k(SQLiteEventStore sQLiteEventStore, TransportContext transportContext, SQLiteDatabase sQLiteDatabase) {
    ...
    public Iterable<PersistedEvent> loadBatch(final TransportContext transportContext) {
        return (Iterable) inTransaction(new Function() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore$$ExternalSyntheticLambda10
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore.Function
            public final Object apply(Object obj) {
                return SQLiteEventStore.m2712$r8$lambda$c5yRpmc2PusxokESpsItypEVU(this.f$0, transportContext, (SQLiteDatabase) obj);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$-c5yRpmc2Pusxok-ESpsItypEVU, reason: not valid java name */
    public static /* synthetic */ List m2712$r8$lambda$c5yRpmc2PusxokESpsItypEVU(SQLiteEventStore sQLiteEventStore, TransportContext transportContext, SQLiteDatabase sQLiteDatabase) {
    ...
    private byte[] readPayload(long j) {
        return (byte[]) tryWithCursor(getDb().query("event_payloads", new String[]{"bytes"}, "event_id = ?", new String[]{String.valueOf(j)}, null, null, "sequence_num"), new Function() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore$$ExternalSyntheticLambda24
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore.Function
            public final Object apply(Object obj) {
                return SQLiteEventStore.m2714$r8$lambda$MhWEBJkjZ48pXSpbhiwCbV5kA((Cursor) obj);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$MhWEBJkj-Z48pXSpbh-iwCbV5kA, reason: not valid java name */
    public static /* synthetic */ byte[] m2714$r8$lambda$MhWEBJkjZ48pXSpbhiwCbV5kA(Cursor cursor) {
        ArrayList arrayList = new ArrayList();
        int length = 0;
        while (cursor.moveToNext()) {
    ...
    /* JADX WARN: Type inference failed for: r1v1, types: [java.lang.Long, kotlin.coroutines.Continuation] */
    ...
    private List<PersistedEvent> join(List<PersistedEvent> list, Map<Long, Set<Metadata>> map) {
        ...
        while (listIterator.hasNext()) {
            ...
            if (map.probeCoroutineSuspended(Long.valueOf(next.getId())) != 0) {
                EventInternal.Builder builder = next.getEvent().toBuilder();
                for (Metadata metadata : (Set) map.get(Long.valueOf(next.getId()))) {
    ...
    public void recordLogEventDropped(final long j, final LogEventDropped.Reason reason, final String str) {
        inTransaction(new Function() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore$$ExternalSyntheticLambda15
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore.Function
            public final Object apply(Object obj) {
                return SQLiteEventStore.m2718$r8$lambda$m2CidbNtM3iXXm7FvzU6_pgJWc(str, reason, j, (SQLiteDatabase) obj);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$m2Cid-bNtM3iXXm7FvzU6_pgJWc, reason: not valid java name */
    public static /* synthetic */ Object m2718$r8$lambda$m2CidbNtM3iXXm7FvzU6_pgJWc(String str, LogEventDropped.Reason reason, long j, SQLiteDatabase sQLiteDatabase) {
    ...
    private LogEventDropped.Reason convertToReason(int i) {
        ...
        Logging.m296d("SQLiteEventStore", "%n is not valid. No matched LogEventDropped-Reason found. Treated it as REASON_UNKNOWN", Integer.valueOf(i));
        return reason;
    }
    ...
    public static /* synthetic */ ClientMetrics $r8$lambda$wkPqtdo8abVVVntIT0LL_IpuNhI(final SQLiteEventStore sQLiteEventStore, String str, final Map map, final ClientMetrics.Builder builder, SQLiteDatabase sQLiteDatabase) {
        ...
        return (ClientMetrics) tryWithCursor(sQLiteDatabase.rawQuery(str, new String[0]), new Function() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore$$ExternalSyntheticLambda23
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore.Function
            public final Object apply(Object obj) {
                return SQLiteEventStore.m2715$r8$lambda$RbOgrU7H41WTgNTtm08JTmKZL8(this.f$0, map, builder, (Cursor) obj);
            }
        });
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r0v2, types: [java.lang.Object, java.lang.String, kotlin.coroutines.Continuation] */
    ...
    public static /* synthetic */ ClientMetrics m2715$r8$lambda$RbOgrU7H41WTgNTtm08JTmKZL8(SQLiteEventStore sQLiteEventStore, Map map, ClientMetrics.Builder builder, Cursor cursor) {
        sQLiteEventStore.getClass();
        while (cursor.moveToNext()) {
            ?? string = cursor.getString(0);
            LogEventDropped.Reason reasonConvertToReason = sQLiteEventStore.convertToReason(cursor.getInt(1));
            long j = cursor.getLong(2);
            if (map.probeCoroutineSuspended(string) == 0) {
    ...
    public static /* synthetic */ TimeWindow $r8$lambda$zOq4Ptcu6jxQh2yulOulwMnkbKw(final long j, SQLiteDatabase sQLiteDatabase) {
        return (TimeWindow) tryWithCursor(sQLiteDatabase.rawQuery("SELECT last_metrics_upload_ms FROM global_log_event_state LIMIT 1", new String[0]), new Function() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore$$ExternalSyntheticLambda26
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore.Function
            public final Object apply(Object obj) {
                return SQLiteEventStore.m2711$r8$lambda$2sc8nDh80TMJWoAz3fuM4SGoA(j, (Cursor) obj);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$-2sc8nDh-80TMJWoAz3fuM4SGoA, reason: not valid java name */
    public static /* synthetic */ TimeWindow m2711$r8$lambda$2sc8nDh80TMJWoAz3fuM4SGoA(long j, Cursor cursor) {
        cursor.moveToNext();
    ...
    public void resetClientMetrics() {
        inTransaction(new Function() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore$$ExternalSyntheticLambda14
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore.Function
            public final Object apply(Object obj) {
                return SQLiteEventStore.m2719$r8$lambda$tjc_qlQgTB9tdANbPFpY4kEz4U(this.f$0, (SQLiteDatabase) obj);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$tjc_qlQgTB-9tdANbPFpY4kEz4U, reason: not valid java name */
    public static /* synthetic */ Object m2719$r8$lambda$tjc_qlQgTB9tdANbPFpY4kEz4U(SQLiteEventStore sQLiteEventStore, SQLiteDatabase sQLiteDatabase) {
        sQLiteEventStore.getClass();
    ...
    private void ensureBeginTransaction(final SQLiteDatabase sQLiteDatabase) {
        retryIfDbLocked(new Producer() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore$$ExternalSyntheticLambda0
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore.Producer
            public final Object produce() {
                return SQLiteEventStore.m2717$r8$lambda$bBQL4XWV8rqSJshoDiUR95y_jM(sQLiteDatabase);
            }
    ...
    public static /* synthetic */ Object m2717$r8$lambda$bBQL4XWV8rqSJshoDiUR95y_jM(SQLiteDatabase sQLiteDatabase) {
