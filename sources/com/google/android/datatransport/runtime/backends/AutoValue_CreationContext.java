...
final class AutoValue_CreationContext extends CreationContext {
    ...
    public AutoValue_CreationContext(Context context, Clock clock, Clock clock2, String str) {
        if (context == null) {
            g$$ExternalSyntheticBUOutline2.m208m("Null applicationContext");
            throw null;
        }
        this.applicationContext = context;
        if (clock == null) {
            g$$ExternalSyntheticBUOutline2.m208m("Null wallClock");
            throw null;
        }
        this.wallClock = clock;
        if (clock2 == null) {
            g$$ExternalSyntheticBUOutline2.m208m("Null monotonicClock");
            throw null;
        }
