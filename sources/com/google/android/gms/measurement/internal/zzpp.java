...
public final class zzpp extends zzjf {
    ...
    */
    public final int zzF(java.lang.String r13, java.lang.String r14, java.lang.String r15, java.lang.Object r16, android.os.Bundle r17, java.util.List r18, boolean r19, boolean r20) {
        /*
            Method dump skipped, instruction units count: 352
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzpp.zzF(java.lang.String, java.lang.String, java.lang.String, java.lang.Object, android.os.Bundle, java.util.List, boolean, boolean):int");
    }
    ...
    public final boolean zzaj(int i, boolean z) {
        ...
        if (zzak() < i / MediaDataController.MAX_STYLE_RUNS_COUNT) {
    ...
    public final int zzak() {
        if (this.zzi == null) {
            this.zzi = Integer.valueOf(GoogleApiAvailabilityLight.getInstance().getApkVersion(this.zzu.zzaZ()) / MediaDataController.MAX_STYLE_RUNS_COUNT);
        }
    ...
    public final long zzam(long j, long j2) {
        return (j + (j2 * 60000)) / DurationKt.MILLIS_IN_DAY;
    }
