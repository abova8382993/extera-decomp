...
final class zzkj implements Runnable {
    ...
    public final void run() {
        ...
        try {
            zzljVar.zzu.zzt().zzp(new zzah(bundle.getString("app_id"), _UrlKt.FRAGMENT_ENCODE_SET, new zzpl(strCheckNotEmpty, 0L, null, _UrlKt.FRAGMENT_ENCODE_SET), bundle.getLong("creation_timestamp"), bundle.getBoolean("active"), bundle.getString("trigger_event_name"), null, bundle.getLong("trigger_timeout"), null, bundle.getLong("time_to_live"), zzljVar.zzu.zzk().zzaf(bundle.getString("app_id"), bundle.getString("expired_event_name"), bundle.getBundle("expired_event_params"), _UrlKt.FRAGMENT_ENCODE_SET, bundle.getLong("creation_timestamp"), 0L, true, true)));
