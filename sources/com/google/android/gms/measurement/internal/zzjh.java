...
public abstract class zzjh {
    ...
    public static Object zzb(Bundle bundle, String str, Class cls, Object obj) {
        ...
        EncodedValueReader$$ExternalSyntheticBUOutline0.m213m("Invalid conditional user property field type. '%s' expected [%s] but was [%s]", new Object[]{str, cls.getCanonicalName(), obj2.getClass().getCanonicalName()});
        return null;
    }
}
