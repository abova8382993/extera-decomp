...
public abstract class zzfy {
    ...
    private static final List zzbl = DesugarCollections.synchronizedList(new ArrayList());
    public static final zzfx zzc;
    public static final zzfx zzd;
    public static final zzfx zze;
    public static final zzfx zzf;
    ...
    static {
        ...
        Long lValueOf = Long.valueOf(RealWebSocket.CANCEL_AFTER_CLOSE_MILLIS);
        zzL = zza("measurement.alarm_manager.minimum_interval", lValueOf, lValueOf, zzcx.zza, false);
        ...
        zzar = zza("measurement.rb.attribution.app_allowlist", _UrlKt.FRAGMENT_ENCODE_SET, _UrlKt.FRAGMENT_ENCODE_SET, zzee.zza, false);
        ...
        zzau = zza("measurement.rb.attribution.query_parameters_to_remove", _UrlKt.FRAGMENT_ENCODE_SET, _UrlKt.FRAGMENT_ENCODE_SET, zzeh.zza, false);
        ...
        zzay = zza("measurement.rb.max_trigger_registrations_per_day", numValueOf, numValueOf, zzen.zza, false);
