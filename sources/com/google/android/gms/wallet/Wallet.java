    ...
    public static final class WalletOptions implements Api.ApiOptions.HasAccountOptions {
        ...
        public static final class Builder {
            ...
            public Builder setEnvironment(int i) {
                if (i != 0) {
                    if (i == 0) {
                        ...
                        g$$ExternalSyntheticBUOutline1.m207m(String.format(Locale.US, "Invalid environment value %d", Integer.valueOf(i)));
                        return null;
                    }
                }
                this.zza = i;
            ...
            public Builder setTheme(int i) {
                ...
                g$$ExternalSyntheticBUOutline1.m207m(String.format(Locale.US, "Invalid theme value %d", Integer.valueOf(i)));
                return null;
            }
        }

        /* JADX INFO: Access modifiers changed from: private */
        WalletOptions(Builder builder) {
        ...
        public /* synthetic */ WalletOptions(Builder builder, zzar zzarVar) {
            this(builder);
        }

        public /* synthetic */ WalletOptions(zzar zzarVar) {
            this(new Builder());
        }
