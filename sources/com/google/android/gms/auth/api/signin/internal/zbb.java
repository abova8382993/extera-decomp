...
import com.google.android.gms.internal.p037authapi.zbbc;
    ...
    public final void run() {
        ...
        try {
            ...
            if (responseCode == 200) {
                ...
                zba.m350e("Unable to revoke access!", new Object[0]);
            }
            Logger logger = zba;
            StringBuilder sb2 = new StringBuilder(String.valueOf(responseCode).length() + 15);
            sb2.append("Response Code: ");
            sb2.append(responseCode);
            logger.m349d(sb2.toString(), new Object[0]);
        } catch (IOException e) {
            zba.m350e("IOException when revoking access: ".concat(String.valueOf(e.toString())), new Object[0]);
        } catch (Exception e2) {
            zba.m350e("Exception when revoking access: ".concat(String.valueOf(e2.toString())), new Object[0]);
        }
