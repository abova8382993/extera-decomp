...
public class AdvertisingIdClient {
    ...
    public static Info getAdvertisingIdInfo(Context context) {
        ...
        try {
            ...
            advertisingIdClient.zzc(infoZzd, true, 0.0f, SystemClock.elapsedRealtime() - jElapsedRealtime, _UrlKt.FRAGMENT_ENCODE_SET, null);
            return infoZzd;
        } finally {
        }
    }
    ...
    public final boolean zzc(Info info, boolean z, float f, long j, String str, Throwable th) {
        ...
        if (info != null) {
            map.put("limit_ad_tracking", true != info.isLimitAdTrackingEnabled() ? MVEL.VERSION_SUB : "1");
