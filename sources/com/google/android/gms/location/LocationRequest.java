...
public final class LocationRequest extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public static LocationRequest create() {
        return new LocationRequest(102, DurationKt.MILLIS_IN_HOUR, 600000L, 0L, LongCompanionObject.MAX_VALUE, LongCompanionObject.MAX_VALUE, Integer.MAX_VALUE, 0.0f, true, DurationKt.MILLIS_IN_HOUR, 0, 0, null, false, new WorkSource(), null);
    }
    ...
    public String toString() {
        ...
        long j2 = this.zzi;
        if (!zIsPassive ? j2 != this.zzb : j2 != LongCompanionObject.MAX_VALUE) {
    ...
    public LocationRequest(int i, long j, long j2, long j3, long j4, long j5, int i2, float f, boolean z, long j6, int i3, int i4, String str, boolean z2, WorkSource workSource, com.google.android.gms.internal.location.zzd zzdVar) {
        ...
        this.zzc = j2;
        this.zzd = j3;
        this.zze = j4 == LongCompanionObject.MAX_VALUE ? j5 : Math.min(Math.max(1L, j4 - SystemClock.elapsedRealtime()), j5);
        this.zzf = i2;
        this.zzg = f;
        this.zzh = z;
        this.zzi = j6 != -1 ? j6 : j;
    ...
    public static final class Builder {
        ...
        public LocationRequest build() {
            ...
            return new LocationRequest(i, j, j2, jMax, LongCompanionObject.MAX_VALUE, j3, i2, f, z, j4, this.zzj, this.zzk, this.zzl, this.zzm, new WorkSource(this.zzn), this.zzo);
        }
