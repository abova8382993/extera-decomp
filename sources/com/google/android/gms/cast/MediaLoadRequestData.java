...
public class MediaLoadRequestData extends AbstractSafeParcelable {
    ...
    public static class Builder {
        ...
        public Builder setPlaybackRate(double d) {
            if (Double.compare(d, 2.0d) > 0 || Double.compare(d, 0.5d) < 0) {
                g$$ExternalSyntheticBUOutline1.m207m("playbackRate must be between PLAYBACK_RATE_MIN and PLAYBACK_RATE_MAX");
                return null;
            }
            this.zze = d;
            return this;
    ...
    public /* synthetic */ MediaLoadRequestData(MediaInfo mediaInfo, MediaQueueData mediaQueueData, Boolean bool, long j, double d, long[] jArr, JSONObject jSONObject, String str, String str2, String str3, String str4, long j2, byte[] bArr) {
    ...
    public JSONObject toJson() {
        ...
        try {
            ...
            zzb.m335e("Error transforming MediaLoadRequestData into JSONObject", e);
