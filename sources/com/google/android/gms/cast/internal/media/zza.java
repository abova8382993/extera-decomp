...
public abstract class zza {
    ...
    public static Calendar zzd(String str) {
        ...
        if (TextUtils.isEmpty(str)) {
            zza.m333d("Input string is empty or null", new Object[0]);
            return null;
        }
        String strZze = zze(str);
        if (TextUtils.isEmpty(strZze)) {
            zza.m333d("Invalid date format", new Object[0]);
            return null;
        }
        ...
        if (TextUtils.isEmpty(strZzf)) {
            ...
            StringBuilder sb = new StringBuilder(String.valueOf(strZze).length() + 1 + String.valueOf(strZzf).length());
            sb.append(strZze);
            sb.append("T");
            sb.append(strZzf);
            strZze = sb.toString();
        ...
        try {
            ...
            zza.m336e(e, "Error parsing string", new Object[0]);
            return null;
        }
    }
    ...
    private static String zze(String str) {
        ...
        try {
            ...
            zza.m336e(e, "Error extracting the date", new Object[0]);
            return null;
        }
    }
    ...
    private static String zzf(String str) {
        if (TextUtils.isEmpty(str)) {
            zza.m333d("string is empty or null", new Object[0]);
            return null;
        }
        int iIndexOf = str.indexOf(84);
        int i = iIndexOf + 1;
        if (iIndexOf != 8) {
            zza.m333d("T delimeter is not found", new Object[0]);
            return null;
        }
        try {
            ...
            if (cCharAt != '+' && cCharAt != '-') {
                if (cCharAt == 'Z' && strSubstring.length() == zzb[0].length() + 6) {
                    return strSubstring.substring(0, strSubstring.length() - 1).concat("+0000");
                }
                return null;
            }
            ...
            zza.m336e(e, "Error extracting the time substring: %s", new Object[0]);
            return null;
        }
    }
