...
public class MediaInfo extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    /* JADX WARN: Removed duplicated region for block: B:119:0x00b8 A[LOOP:0: B:91:0x0023->B:119:0x00b8, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:156:0x01a0 A[LOOP:1: B:127:0x00e8->B:156:0x01a0, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:167:0x00c1 A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:169:0x01a7 A[SYNTHETIC] */
    /*
            ...
            while (i5 < jSONArray.length()) {
                ...
                if (jSONObject3.has("roles")) {
                    ...
                    for (int i7 = 0; i7 < jSONArray2.length(); i7++) {
                        zzfnVar.zzb(jSONArray2.optString(i7));
                    }
                    zzfqVarZzc = zzfnVar.zzc();
                } else {
                    zzfqVarZzc = null;
                }
                arrayList.add(new MediaTrack(j, i6, strOptStringOrNull, strOptStringOrNull2, strOptStringOrNull3, strOptStringOrNull4, i2, zzfqVarZzc, jSONObject3.optJSONObject("customData")));
                i5++;
                i4 = 2;
            }
