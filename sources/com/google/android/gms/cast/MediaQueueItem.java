...
public class MediaQueueItem extends AbstractSafeParcelable {
    ...
    public int hashCode() {
        return com.google.android.gms.common.internal.Objects.hashCode(this.zzb, Integer.valueOf(this.zzc), Boolean.valueOf(this.zzd), Double.valueOf(this.zze), Double.valueOf(this.zzf), Double.valueOf(this.zzg), Integer.valueOf(Arrays.hashCode(this.zzh)), String.valueOf(this.zzi));
    }
    ...
    public final void zza() {
        if (this.zzb == null) {
            g$$ExternalSyntheticBUOutline1.m207m("media cannot be null.");
            return;
        }
        if (!Double.isNaN(this.zze) && this.zze < 0.0d) {
            g$$ExternalSyntheticBUOutline1.m207m("startTime cannot be negative or NaN.");
            return;
        }
        if (Double.isNaN(this.zzf)) {
            g$$ExternalSyntheticBUOutline1.m207m("playbackDuration cannot be NaN.");
        } else if (Double.isNaN(this.zzg) || this.zzg < 0.0d) {
            g$$ExternalSyntheticBUOutline1.m207m("preloadTime cannot be negative or Nan.");
        }
    }
