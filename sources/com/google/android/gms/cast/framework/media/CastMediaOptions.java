...
public class CastMediaOptions extends AbstractSafeParcelable {
    ...
    public ImagePicker getImagePicker() {
        ...
        if (zzdVar != null) {
            try {
                MediaSessionCompat$$ExternalSyntheticThrowCCEIfNotNull0.m2m(ObjectWrapper.unwrap(zzdVar.zzf()));
                return null;
            } catch (RemoteException e) {
                zza.m334d(e, "Unable to call %s on %s.", "getWrappedClientObject", zzd.class.getSimpleName());
            }
        }
        return null;
    }
