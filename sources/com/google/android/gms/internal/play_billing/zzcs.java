...
public final class zzcs {
    ...
    public final zzcs zza(zzdh zzdhVar) {
        if (zzdhVar.zzd()) {
            g$$ExternalSyntheticBUOutline1.m207m(zzbf.zza("range must not be empty, but was %s", zzdhVar));
            return null;
        }
    ...
    public final zzct zzc() {
        ...
        while (zzcyVar.hasNext()) {
            ...
            while (zzcyVar.hasNext()) {
                ...
                if (zzdhVarZzc.zza.zza(zzdhVar.zzb) > 0 || zzdhVar.zza.zza(zzdhVarZzc.zzb) > 0) {
                    break;
                }
