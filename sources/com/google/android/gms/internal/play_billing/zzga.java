...
abstract class zzga {
    ...
    public static int zza(byte[] bArr, int i, zzfz zzfzVar) throws zzhr {
        ...
        int i2 = zzfzVar.zza;
        if (i2 < 0) {
            zzga$$ExternalSyntheticBUOutline0.m374m("CodedInputStream encountered an embedded string or message which claimed to have negative size.");
            return 0;
        }
        if (i2 > bArr.length - iZzh) {
            zzga$$ExternalSyntheticBUOutline0.m374m("While parsing a protocol message, the input ended unexpectedly in the middle of a field.  This could mean either that the input has been truncated or that an embedded message misreported its own length.");
            return 0;
        }
        if (i2 == 0) {
    ...
    public static int zzg(int i, byte[] bArr, int i2, int i3, zzjk zzjkVar, zzfz zzfzVar) throws zzhr {
        if ((i >>> 3) == 0) {
            zzga$$ExternalSyntheticBUOutline0.m374m("Protocol message contained an invalid tag (zero).");
            return 0;
        }
        int i4 = i & 7;
        if (i4 == 0) {
        ...
        zzfzVar.zze--;
        if (i2 > i3 || i8 != i6) {
            zzga$$ExternalSyntheticBUOutline0.m374m("Failed to parse the message.");
            return 0;
        }
    ...
    private static void zzo(int i) throws zzhr {
        ...
        zzga$$ExternalSyntheticBUOutline0.m374m("Protocol message had too many levels of nesting.  May be malicious.  Use setRecursionLimit() to increase the recursion depth limit.");
    }
}
