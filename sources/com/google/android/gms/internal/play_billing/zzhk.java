...
public abstract class zzhk<MessageType extends zzhk<MessageType, BuilderType>, BuilderType extends zzhg<MessageType, BuilderType>> extends zzfv<MessageType, BuilderType> {
    ...
    public final int zzk() {
        if (zzA()) {
            ...
            JsonArray$$ExternalSyntheticBUOutline0.m542m("serialized size must be non-negative, was ", iZzc);
            return 0;
        }
        int i = this.zzd & Integer.MAX_VALUE;
        if (i != Integer.MAX_VALUE) {
        ...
        JsonArray$$ExternalSyntheticBUOutline0.m542m("serialized size must be non-negative, was ", iZzc2);
        return 0;
    }
}
