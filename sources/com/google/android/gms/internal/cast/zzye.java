...
final class zzye extends zzxa implements RandomAccess, zzyj {
    ...
    static {
        int[] iArr = new int[0];
        zza = iArr;
        zzb = new zzye(iArr, 0, false);
    }

    public static zzye zzd() {
        return zzb;
    }
    ...
    private final void zzj(int i) {
        if (i < 0 || i >= this.zzd) {
            IntList$$ExternalSyntheticBUOutline0.m236m(zzk(i));
        }
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        System.arraycopy(zzyeVar.zzc, 0, this.zzc, this.zzd, zzyeVar.zzd);
        this.zzd = i3;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzd != zzyeVar.zzd) {
            return false;
        }
        int[] iArr = zzyeVar.zzc;
    ...
    public final zzyj zzf(int i) {
        if (i >= this.zzd) {
            return new zzye(i == 0 ? zza : Arrays.copyOf(this.zzc, i), this.zzd, true);
        }
    ...
    private zzye(int[] iArr, int i, boolean z) {
        super(z);
        this.zzc = iArr;
        this.zzd = i;
    }
