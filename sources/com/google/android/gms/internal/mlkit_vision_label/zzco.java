...
final class zzco implements ObjectEncoderContext {
    ...
    public final zzco zzd(FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (!z || i != 0) {
    ...
    public final zzco zze(FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (!z || j != 0) {
            zzcm zzcmVarZzj = zzj(fieldDescriptor);
            zzcl zzclVar = zzcl.DEFAULT;
            int iOrdinal = zzcmVarZzj.zzb().ordinal();
