...
public final class zzbg extends zzav {
    ...
    private static zzao zzd(zzbe zzbeVar, zzao zzaoVar, zzao zzaoVar2) {
        ...
        g$$ExternalSyntheticBUOutline1.m207m("Non-iterable type in for...of loop.");
        return null;
    }
        ...
        switch (iOrdinal) {
            case 26:
                ...
                if (!(list.get(0) instanceof zzas)) {
                    g$$ExternalSyntheticBUOutline1.m207m("Variable name in FOR_IN must be a string");
                    return null;
                }
            ...
            case 27:
                ...
                if (!(list.get(0) instanceof zzas)) {
                    g$$ExternalSyntheticBUOutline1.m207m("Variable name in FOR_IN_CONST must be a string");
                    return null;
                }
            ...
            case 28:
                ...
                if (!(list.get(0) instanceof zzas)) {
                    g$$ExternalSyntheticBUOutline1.m207m("Variable name in FOR_IN_LET must be a string");
                    return null;
                }
            ...
            case 29:
                ...
                if (!(zzaoVarZza2 instanceof zzae)) {
                    g$$ExternalSyntheticBUOutline1.m207m("Initializer variables in FOR_LET must be an ArrayList");
                    return null;
                }
            ...
            case 30:
                ...
                if (!(list.get(0) instanceof zzas)) {
                    g$$ExternalSyntheticBUOutline1.m207m("Variable name in FOR_OF must be a string");
                    return null;
                }
            ...
            case 31:
                ...
                if (!(list.get(0) instanceof zzas)) {
                    g$$ExternalSyntheticBUOutline1.m207m("Variable name in FOR_OF_CONST must be a string");
                    return null;
                }
            ...
            case 32:
                ...
                if (!(list.get(0) instanceof zzas)) {
                    g$$ExternalSyntheticBUOutline1.m207m("Variable name in FOR_OF_LET must be a string");
                    return null;
                }
