...
public final class zzqt {
    ...
    private final String zze = _UrlKt.FRAGMENT_ENCODE_SET;
    ...
    public final zzqs zza() {
        ...
        if (iIndexOf >= 0) {
            ...
            if (str.contains("@")) {
                g$$ExternalSyntheticBUOutline1.m207m("Invalid package name: ".concat(str));
                return null;
            }
            strSubstring = str;
        }
    ...
    public final ListenableFuture zzd(String str) {
        zzlk zzlkVar = this.zzb;
        return Futures.transform(zzlkVar.zzh().zza(this.zzd, _UrlKt.FRAGMENT_ENCODE_SET), zzqp.zza, zzlkVar.zzg());
    }
