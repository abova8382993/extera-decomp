...
public abstract class zzwl {
    ...
    public static zzwl zza(zzwl zzwlVar, zzwl zzwlVar2) {
        ...
        ImmutableSet<zzwl> immutableSetM521of = ImmutableSet.m521of(zzwlVar, zzwlVar2);
        if (immutableSetM521of.isEmpty()) {
            return zzwk.zza;
        }
        if (immutableSetM521of.size() == 1) {
            return (zzwl) immutableSetM521of.iterator().next();
        }
        int size = 0;
        for (zzwl zzwlVar3 : immutableSetM521of) {
            do {
        ...
        for (zzwl zzwlVar4 : immutableSetM521of) {
            do {
                int i = 0;
                while (true) {
    ...
    public final zzwl zzb() {
        if (this.zzd) {
            Segment$$ExternalSyntheticBUOutline1.m992m("Already frozen");
            return null;
        }
        this.zzd = true;
