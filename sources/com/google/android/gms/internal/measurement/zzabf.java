...
public enum zzabf {
    ...
    static {
        ...
        for (zzabf zzabfVar : values()) {
            if (map.put(Character.valueOf(zzabfVar.zzG), zzabfVar) != null) {
                Segment$$ExternalSyntheticBUOutline1.m992m("duplicate format character: ".concat(String.valueOf(zzabfVar)));
                return;
            }
        }
    ...
    public static final zzabf zza(char c2) {
        return (zzabf) zzF.get(Character.valueOf(c2));
    }
