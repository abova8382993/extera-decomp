...
public final class zzrf {
    ...
    public final ListenableFuture zza() {
        if (zzky.zzb(this.zzc) || zzg().zze() + DurationKt.MILLIS_IN_DAY >= System.currentTimeMillis()) {
    ...
    public final zzqn zzc(boolean z) {
        zzni zzniVarZzg = zzg();
        return new zzqn(zzniVarZzg.zzc(), ImmutableList.copyOf((Collection) zzniVarZzg.zzi()), zzniVarZzg.zzb(), zzniVarZzg.zzd(), (zzniVarZzg.zzj() && zzniVarZzg.zzk().zzb() == ((long) Build.VERSION.SDK_INT)) ? zzniVarZzg.zzk().zza() : _UrlKt.FRAGMENT_ENCODE_SET, ImmutableList.copyOf((Collection) zzniVarZzg.zzf()), ImmutableList.copyOf((Collection) zzniVarZzg.zzh()), zzniVarZzg.zza(), zzniVarZzg.zzm(), zzniVarZzg.zzl(), zzniVarZzg.zzn());
    }
