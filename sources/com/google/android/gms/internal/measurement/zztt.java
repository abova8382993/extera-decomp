...
public final class zztt {
    ...
    public final zztp zza(zztr zztrVar) {
        ...
        if (pairCreate == null) {
            ...
            Preconditions.checkArgument((iLastIndexOf == -1 ? _UrlKt.FRAGMENT_ENCODE_SET : strNullToEmpty.substring(iLastIndexOf + 1)).equals("pb"), "Uri extension must be .pb: %s", uriZza2);
        ...
        Preconditions.checkArgument(zztrVar2.zza().equals(zztrVar3.zza()), strLenientFormat, "uri");
        ...
        g$$ExternalSyntheticBUOutline1.m207m(Strings.lenientFormat(strLenientFormat, "unknown"));
        return null;
    }
}
