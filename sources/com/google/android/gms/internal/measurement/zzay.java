...
public final class zzay extends zzav {
    ...
    private static zzao zzc(zzg zzgVar, List list) {
        ...
        if (!(zzaoVarZza2 instanceof zzae)) {
            CameraSelector$$ExternalSyntheticBUOutline0.m71m("FN requires an ArrayValue of parameter names found %s", new Object[]{zzaoVarZza2.getClass().getCanonicalName()});
            return null;
        }
    ...
    public final zzao zza(String str, zzg zzgVar, List list) {
        ...
        if (iOrdinal == 2) {
            ...
            if (!(zzaoVarZza2 instanceof zzae)) {
                CameraSelector$$ExternalSyntheticBUOutline0.m71m("Function arguments for Apply are not a list found %s", new Object[]{zzaoVarZza2.getClass().getCanonicalName()});
                return null;
            }
            if (!strZzc.isEmpty()) {
                return zzaoVarZza.zzcG(strZzc, zzgVar, ((zzae) zzaoVarZza2).zzb());
            }
            g$$ExternalSyntheticBUOutline1.m207m("Function name for apply is undefined");
            return null;
        }
        if (iOrdinal == 15) {
        ...
        if (iOrdinal != 19) {
            if (iOrdinal == 20) {
                ...
                if (zzanVar.zzg() == null) {
                    zzgVar.zze(_UrlKt.FRAGMENT_ENCODE_SET, zzanVar);
                    return zzanVar;
                }
            ...
            if (iOrdinal == 60) {
                ...
                if (!(zzaoVarZza7 instanceof zzae)) {
                    g$$ExternalSyntheticBUOutline1.m207m("Malformed SWITCH statement, cases are not a list");
                    return null;
                }
                if (!(zzaoVarZza8 instanceof zzae)) {
                    g$$ExternalSyntheticBUOutline1.m207m("Malformed SWITCH statement, case statements are not a list");
                    return null;
                }
