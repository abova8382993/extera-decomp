...
public final class zzlk {
    ...
    public static void zza(Context context) {
        ...
        if (applicationContext != null) {
            AbstractC1302xa830b2f.m312m(zzc, null, applicationContext);
        }
    }
    ...
    public static zzlk zzb() {
        ...
        if (context == null) {
            zzls.zzb();
            Segment$$ExternalSyntheticBUOutline1.m992m("Must call PhenotypeContext.setContext() first");
            return null;
        }
        zzlk zzlkVar2 = zzd;
        if (zzlkVar2 != null) {
            ...
            synchronized (zzb) {
                try {
                    if (zzd != null) {
                        ...
                        zzlkVar = (zzlk) Optional.absent().mo499or(new Supplier() { // from class: com.google.android.gms.internal.measurement.zzll
                            @Override // com.google.common.base.Supplier
                            public final /* synthetic */ Object get() {
                                int i = zzlk.$r8$clinit;
