    ...
    public final zzao zza(String str, zzg zzgVar, List list) {
        ...
        if (iOrdinal == 3) {
            ...
            if (!(zzaoVarZza instanceof zzas)) {
                CameraSelector$$ExternalSyntheticBUOutline0.m71m("Expected string for assign var. got %s", new Object[]{zzaoVarZza.getClass().getCanonicalName()});
                return null;
            }
            if (!zzgVar.zzd(zzaoVarZza.zzc())) {
                CameraSelector$$ExternalSyntheticBUOutline0.m71m("Attempting to assign undefined value %s", new Object[]{zzaoVarZza.zzc()});
                return null;
            }
        ...
        if (iOrdinal == 14) {
            ...
            if (list.size() % 2 != 0) {
                CameraSelector$$ExternalSyntheticBUOutline0.m71m("CONST requires an even number of arguments, found %s", new Object[]{Integer.valueOf(list.size())});
                return null;
            }
            while (i < list.size() - 1) {
                zzao zzaoVarZza3 = zzgVar.zza((zzao) list.get(i));
                if (!(zzaoVarZza3 instanceof zzas)) {
                    CameraSelector$$ExternalSyntheticBUOutline0.m71m("Expected string for const name. got %s", new Object[]{zzaoVarZza3.getClass().getCanonicalName()});
                    return null;
                }
        ...
        if (iOrdinal == 24) {
            ...
            while (i < list.size()) {
                ...
                if (zzaoVarZza4 instanceof zzag) {
                    Segment$$ExternalSyntheticBUOutline1.m992m("ControlValue cannot be in an expression list");
                    return null;
                }
                i++;
            }
        ...
        if (iOrdinal == 33) {
            ...
            CameraSelector$$ExternalSyntheticBUOutline0.m71m("Expected string for get var. got %s", new Object[]{zzaoVarZza5.getClass().getCanonicalName()});
            return null;
        }
        if (iOrdinal == 49) {
        ...
        if (iOrdinal == 58) {
            ...
            if (zzaoVarZza6 == zzao.zzf || zzaoVarZza6 == zzao.zzg) {
                EncodedValueReader$$ExternalSyntheticBUOutline0.m213m("Can't set property %s of %s", new Object[]{zzaoVarZza7.zzc(), zzaoVarZza6.zzc()});
                return null;
            }
        ...
        if (iOrdinal == 17) {
            ...
            while (it.hasNext()) {
                ...
                if (zzaoVarZza9 instanceof zzag) {
                    Segment$$ExternalSyntheticBUOutline1.m992m("Failed to evaluate array element");
                    return null;
                }
        ...
        if (iOrdinal == 18) {
            ...
            if (list.size() % 2 != 0) {
                CameraSelector$$ExternalSyntheticBUOutline0.m71m("CREATE_OBJECT requires an even number of arguments, found %s", new Object[]{Integer.valueOf(list.size())});
                return null;
            }
            ...
            while (i < list.size() - 1) {
                ...
                if ((zzaoVarZza10 instanceof zzag) || (zzaoVarZza11 instanceof zzag)) {
                    Segment$$ExternalSyntheticBUOutline1.m992m("Failed to evaluate map entry");
                    return null;
                }
            ...
            case 62:
                ...
                if (zzaoVarZza14 instanceof zzat) {
                    ...
                    if ((zzaoVarZza14 instanceof zzap) || (zzaoVarZza14 instanceof zzag)) {
                        CameraSelector$$ExternalSyntheticBUOutline0.m71m("Unsupported value type %s in typeof", new Object[]{zzaoVarZza14});
                        return null;
                    }
                    str2 = "object";
                }
            ...
            case 64:
                ...
                while (it2.hasNext()) {
                    ...
                    if (!(zzaoVarZza15 instanceof zzas)) {
                        CameraSelector$$ExternalSyntheticBUOutline0.m71m("Expected string for var name. got %s", new Object[]{zzaoVarZza15.getClass().getCanonicalName()});
                        return null;
                    }
