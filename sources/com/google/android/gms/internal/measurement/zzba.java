...
public abstract class zzba {
    private static zzao zzb(zzae zzaeVar, zzg zzgVar, List list, boolean z) {
        ...
        if (!(zzaoVarZza2 instanceof zzai)) {
            g$$ExternalSyntheticBUOutline1.m207m("Callback should be a method");
            return null;
        }
        if (list.size() == 2) {
            zzaoVarZza = zzgVar.zza((zzao) list.get(1));
            if (zzaoVarZza instanceof zzag) {
                g$$ExternalSyntheticBUOutline1.m207m("Failed to parse initial value");
                return null;
            }
        } else {
            if (zzaeVar.zzh() == 0) {
                Segment$$ExternalSyntheticBUOutline1.m992m("Empty array with no initial value error");
                return null;
            }
            zzaoVarZza = null;
        }
        ...
        while ((i2 - i) * i3 >= 0) {
            if (zzaeVar.zzo(i)) {
                ...
                if (zzaoVarZza instanceof zzag) {
                    Segment$$ExternalSyntheticBUOutline1.m992m("Reduce operation failed");
                    return null;
                }
                i += i3;
            } else {
    ...
    public static zzao zza(String str, zzae zzaeVar, zzg zzgVar, List list) {
        ...
        switch (str.hashCode()) {
            case -1776922004:
                ...
                g$$ExternalSyntheticBUOutline1.m207m("Command not supported");
                return null;
            case -1354795244:
                if (str.equals("concat")) {
                    ...
                    if (!list.isEmpty()) {
                        ...
                        while (it.hasNext()) {
                            ...
                            if (zzaoVarZza instanceof zzag) {
                                Segment$$ExternalSyntheticBUOutline1.m992m("Failed evaluation of arguments");
                                return null;
                            }
                        ...
                        if (list.size() > 2) {
                            for (int i3 = 2; i3 < list.size(); i3++) {
                                ...
                                if (zzaoVarZza3 instanceof zzag) {
                                    g$$ExternalSyntheticBUOutline1.m207m("Failed to parse elements to add");
                                    return null;
                                }
                    ...
                    if (!list.isEmpty()) {
                        ...
                        while (it2.hasNext()) {
                            ...
                            if (zzaoVarZza7 instanceof zzag) {
                                Segment$$ExternalSyntheticBUOutline1.m992m("Argument evaluation failed");
                                return null;
                            }
            ...
            case 3267882:
                if (str.equals("join")) {
                    ...
                    if (!list.isEmpty()) {
                        ...
                        strZzc = ((zzaoVarZza9 instanceof zzam) || (zzaoVarZza9 instanceof zzat)) ? _UrlKt.FRAGMENT_ENCODE_SET : zzaoVarZza9.zzc();
                    }
                    ...
                    if (zzaeVar.zzh() >= 2) {
                        ...
                        if (!list.isEmpty()) {
                            ...
                            if (!(zzaoVarZza11 instanceof zzai)) {
                                g$$ExternalSyntheticBUOutline1.m207m("Comparator should be a method");
                                return null;
                            }
            ...
            case 96891675:
                if (str.equals("every")) {
                    ...
                    if (zzaeVar.zzh() != 0 && zzc(zzaeVar, zzgVar, (zzan) zzaoVarZza12, Boolean.FALSE, Boolean.TRUE).zzh() != zzaeVar.zzh()) {
                        return zzao.zzl;
                    }
                    return zzao.zzk;
                }
