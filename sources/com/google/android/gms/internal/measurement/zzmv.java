...
public final class zzmv implements Comparable {
    ...
    public final String toString() {
        ...
        StringBuilder sb = new StringBuilder(String.valueOf(strZza).length() + 1 + strValueOf.length());
        sb.append(strZza);
        sb.append(":");
    ...
    public final Object zzb() {
        ...
        if (i != 5) {
            Buffer$$ExternalSyntheticBUOutline2.m976m("Impossible, this was validated when parsed or created");
            return null;
        }
