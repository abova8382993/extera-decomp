...
public abstract class zzh {
    public static void zza(String str, int i, List list) {
        ...
        CameraSelector$$ExternalSyntheticBUOutline0.m71m("%s operation requires %s parameters found %s", new Object[]{str, Integer.valueOf(i), Integer.valueOf(list.size())});
    }
    ...
    public static void zzb(String str, int i, List list) {
        ...
        CameraSelector$$ExternalSyntheticBUOutline0.m71m("%s operation requires at least %s parameters found %s", new Object[]{str, Integer.valueOf(i), Integer.valueOf(list.size())});
    }
    ...
    public static void zzc(String str, int i, List list) {
        ...
        CameraSelector$$ExternalSyntheticBUOutline0.m71m("%s operation requires at most %s parameters found %s", new Object[]{str, Integer.valueOf(i), Integer.valueOf(list.size())});
    }
    ...
    public static zzbk zze(String str) {
        ...
        CameraSelector$$ExternalSyntheticBUOutline0.m71m("Unsupported commandId %s", new Object[]{str});
        return null;
    }
    ...
    public static int zzl(zzg zzgVar) {
        ...
        Segment$$ExternalSyntheticBUOutline1.m992m("Instructions allowed exceeded");
        return 0;
    }
}
