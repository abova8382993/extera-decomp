...
public final class zznd {
    ...
    public final zzmw zzc() {
        ...
        if (collectionValues == null) {
            immutableMapBuildKeepingLast = ImmutableMap.m515of();
        } else {
            ...
            for (zzmi zzmiVar : collectionValues) {
                ...
                if (i == 0) {
                    ...
                    if (i != 4) {
                        Segment$$ExternalSyntheticBUOutline1.m992m("Could not serialize Flag for override: ".concat(String.valueOf(zzmiVar.zza())));
                        return null;
                    }
