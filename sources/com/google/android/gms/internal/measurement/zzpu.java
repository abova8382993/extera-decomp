...
public abstract class zzpu {
    ...
    public static ListenableFuture zza(zzlk zzlkVar, final String str, String str2) {
        ...
        zztp zztpVarZza = zzttVarZzd.zza(zztrVarZzg);
        final String str3 = _UrlKt.FRAGMENT_ENCODE_SET;
        return zztpVarZza.zzb(new Function(str, str3) { // from class: com.google.android.gms.internal.measurement.zzpt
            ...
            public final /* synthetic */ Object apply(Object obj) {
                ...
                if (!zznqVar.zza().contains(_UrlKt.FRAGMENT_ENCODE_SET)) {
                    zznqVar.zzb(_UrlKt.FRAGMENT_ENCODE_SET);
                }
                zznt zzntVar = (zznt) zznuVar.zzco();
                zznqVar.zzc(_UrlKt.FRAGMENT_ENCODE_SET);
