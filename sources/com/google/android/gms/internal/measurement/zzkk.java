...
public final class zzkk extends GoogleApi {
    ...
    public final Task zzb(final String str, String str2, @Nullable String str3) {
        ...
        final String str5 = _UrlKt.FRAGMENT_ENCODE_SET;
        return doRead(builder.run(new RemoteCall(str, str5, str4) { // from class: com.google.android.gms.internal.measurement.zzkb
            private final /* synthetic */ String zza;
            private final /* synthetic */ String zzb = _UrlKt.FRAGMENT_ENCODE_SET;
