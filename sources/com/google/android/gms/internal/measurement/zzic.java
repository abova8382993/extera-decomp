...
public final class zzic extends zzmb implements zznn {
    ...
    public final zzic zzaP(String str) {
        zzaX();
        ((zzid) this.zza).zzbY(_UrlKt.FRAGMENT_ENCODE_SET);
        return this;
    }
    ...
    public final List zzb() {
        return DesugarCollections.unmodifiableList(((zzid) this.zza).zzc());
    }
    ...
    public final List zzk() {
        return DesugarCollections.unmodifiableList(((zzid) this.zza).zzf());
    }
