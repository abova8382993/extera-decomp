...
public final class zzagu implements zzagt {
    ...
    public final long zzC() {
        return ((Long) zza.zzb(29, "measurement.monitoring.sample_period_millis", DurationKt.MILLIS_IN_DAY).get()).longValue();
    }
    ...
    public final String zzF() {
        return (String) zza.zzd(32, "measurement.rb.attribution.app_allowlist", _UrlKt.FRAGMENT_ENCODE_SET).get();
    }
    ...
    public final String zzO() {
        return (String) zza.zzd(44, "measurement.sgtm.service_upload_apps_list", _UrlKt.FRAGMENT_ENCODE_SET).get();
    }
    ...
    public final long zzS() {
        return ((Long) zza.zzb(48, "measurement.sgtm.upload.min_delay_after_background", 600000L).get()).longValue();
    }
    ...
    public final long zzV() {
        return ((Long) zza.zzb(51, "measurement.sgtm.upload.retry_interval", 600000L).get()).longValue();
    }
    ...
    public final long zzX() {
        return ((Long) zza.zzb(53, "measurement.upload.stale_data_deletion_interval", DurationKt.MILLIS_IN_DAY).get()).longValue();
    }
    ...
    public final String zzad() {
        return (String) zza.zzd(59, "measurement.rb.attribution.query_parameters_to_remove", _UrlKt.FRAGMENT_ENCODE_SET).get();
    }

    @Override // com.google.android.gms.internal.measurement.zzagt
    public final String zzae() {
        return (String) zza.zzd(60, "measurement.rb.attribution.uri_scheme", "https").get();
    }
    ...
    public final long zzaj() {
        return ((Long) zza.zzb(65, "measurement.upload.interval", DurationKt.MILLIS_IN_HOUR).get()).longValue();
    }
    ...
    public final long zzax() {
        return ((Long) zza.zzb(79, "measurement.upload.window_interval", DurationKt.MILLIS_IN_HOUR).get()).longValue();
    }
    ...
    @Override // com.google.android.gms.internal.measurement.zzagt
    public final long zzb() {
        return ((Long) zza.zzb(1, "measurement.app_uninstalled_additional_ad_id_cache_time", DurationKt.MILLIS_IN_HOUR).get()).longValue();
    }
    ...
    public final long zzf() {
        return ((Long) zza.zzb(5, "measurement.config.cache_time", DurationKt.MILLIS_IN_DAY).get()).longValue();
    }
    ...
    public final String zzh() {
        return (String) zza.zzd(8, "measurement.config.url_scheme", "https").get();
    }
    ...
    @Override // com.google.android.gms.internal.measurement.zzagt
    public final long zzk() {
        return ((Long) zza.zzb(11, "45769094", DurationKt.MILLIS_IN_HOUR).get()).longValue();
    }

    @Override // com.google.android.gms.internal.measurement.zzagt
    public final long zzl() {
        return ((Long) zza.zzb(12, "measurement.session.engagement_interval", DurationKt.MILLIS_IN_HOUR).get()).longValue();
    }
