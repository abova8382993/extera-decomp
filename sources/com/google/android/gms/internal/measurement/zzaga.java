        ...
        if (this.zzb != 0) {
            for (int i = 0; i < this.zzb; i++) {
                ...
                if (i3 == 0) {
                    ...
                    if (i3 != 5) {
                        HttpUrl$$ExternalSyntheticBUOutline0.m958m(new zzaeg("Protocol message tag had invalid wire type."));
                        return;
                    }
        ...
        for (int i3 = 0; i3 < this.zzb; i3++) {
            ...
            if (i6 != 0) {
                if (i6 == 1) {
                    ...
                    if (i6 != 5) {
                        Recorder$$ExternalSyntheticBUOutline0.m107m(new zzaeg("Protocol message tag had invalid wire type."));
                        return 0;
                    }
