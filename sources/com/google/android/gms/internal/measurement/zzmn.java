...
public final class zzmn implements zzmj {
    ...
    public final ListenableFuture zza(String str, String str2) {
        ...
        Preconditions.checkNotNull(_UrlKt.FRAGMENT_ENCODE_SET);
        return zzf(this.zza.zzb(str, _UrlKt.FRAGMENT_ENCODE_SET, null).continueWith(MoreExecutors.directExecutor(), new Continuation(this) { // from class: com.google.android.gms.internal.measurement.zzmm
                ...
                for (zzjf zzjfVar : zzjhVar.zzd) {
                    for (zzjo zzjoVar : zzjfVar.zzb) {
                        ...
                        if (i == 1) {
                            ...
                            if (i != 5) {
                                zzhd$$ExternalSyntheticBUOutline0.m353m(String.valueOf(i).length() + 24, "Unrecognized flag type: ", i);
                                return null;
                            }
