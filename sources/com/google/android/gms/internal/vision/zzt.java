    ...
    protected final Object zzd() {
        ...
        synchronized (this.zzb) {
            ...
            try {
                ...
                AbstractC1348L.m363d("Cannot load thick client module, fall back to load optional module %s", str);
                try {
                    dynamiteModuleLoad = DynamiteModule.load(this.zza, DynamiteModule.PREFER_REMOTE, str);
                } catch (DynamiteModule.LoadingException e) {
                    AbstractC1348L.m365e(e, "Error loading optional module %s", str);
                    if (!this.zzf) {
                        AbstractC1348L.m363d("Broadcasting download intent for dependency %s", this.zze);
