    ...
    public static class zza extends zzii {
        ...
        public zza(byte[] bArr, int i, int i2) {
            ...
            if (((bArr.length - i2) | i2) < 0) {
                CameraSelector$$ExternalSyntheticBUOutline0.m71m("Array range is invalid. Buffer.length=%d, offset=%d, length=%d", new Object[]{Integer.valueOf(bArr.length), 0, Integer.valueOf(i2)});
                throw null;
            }
            this.zzb = bArr;
            this.zzc = 0;
