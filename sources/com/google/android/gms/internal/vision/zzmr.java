...
interface zzmr {
    ...
    void zza(int i, zzht zzhtVar);

    void zza(int i, zzkf zzkfVar, Map map);

    void zza(int i, Object obj);

    void zza(int i, Object obj, zzlc zzlcVar);

    void zza(int i, String str);

    void zza(int i, List list);

    void zza(int i, List list, zzlc zzlcVar);
    ...
    void zzb(int i, Object obj, zzlc zzlcVar);

    void zzb(int i, List list);

    void zzb(int i, List list, zzlc zzlcVar);
