...
public enum zzob implements zzcb {
    ...
    MODEL_DOWNLOAD(100),
    MODEL_UPDATE(101),
    REMOTE_MODEL_IS_DOWNLOADED(Opcodes.INVOKE_POLYMORPHIC_RANGE),
    REMOTE_MODEL_DELETE_ON_DEVICE(Opcodes.INVOKE_CUSTOM),
    ...
    AGGREGATED_ON_DEVICE_BARCODE_DETECTION(Opcodes.REM_FLOAT_2ADDR),
    AGGREGATED_ON_DEVICE_FACE_DETECTION(203),
    AGGREGATED_ON_DEVICE_IMAGE_LABEL_DETECTION(Opcodes.SUB_DOUBLE_2ADDR),
    AGGREGATED_ON_DEVICE_OBJECT_INFERENCE(Opcodes.MUL_DOUBLE_2ADDR),
    AGGREGATED_ON_DEVICE_TEXT_DETECTION(Opcodes.DIV_DOUBLE_2ADDR),
    AGGREGATED_ON_DEVICE_POSE_DETECTION(Opcodes.REM_DOUBLE_2ADDR),
    ...
    AGGREGATED_ON_DEVICE_FACE_MESH_DETECTION(Opcodes.REM_INT_LIT16),
    AGGREGATED_ON_DEVICE_IMAGE_QUALITY_ANALYSIS_DETECTION(Opcodes.AND_INT_LIT16),
    AGGREGATED_ON_DEVICE_IMAGE_CAPTIONING_INFERENCE(Opcodes.OR_INT_LIT16),
    AGGREGATED_ON_DEVICE_DOCUMENT_DETECT_PROCESS(Opcodes.XOR_INT_LIT16),
    AGGREGATED_ON_DEVICE_DOCUMENT_CROP_PROCESS(Opcodes.ADD_INT_LIT8),
    AGGREGATED_ON_DEVICE_DOCUMENT_ENHANCE_PROCESS(Opcodes.RSUB_INT_LIT8),
    AGGREGATED_ON_DEVICE_STAIN_REMOVAL_PROCESS(Opcodes.MUL_INT_LIT8),
    AGGREGATED_ON_DEVICE_SHADOW_REMOVAL_PROCESS(Opcodes.DIV_INT_LIT8),
    AGGREGATED_ON_DEVICE_SUBJECT_SEGMENTATION_INFERENCE(Opcodes.REM_INT_LIT8),
