...
public abstract class zzdm {
    public static int zza(int i, int i2, String str) {
        ...
        if (i < 0) {
            strZza = zzdn.zza("%s (%s) must not be negative", "index", Integer.valueOf(i));
        } else {
            if (i2 < 0) {
                CharCodeKt$$ExternalSyntheticBUOutline0.m873m("negative size: ", i2);
                return 0;
            }
            strZza = zzdn.zza("%s (%s) must be less than size (%s)", "index", Integer.valueOf(i), Integer.valueOf(i2));
        }
    ...
    public static int zzb(int i, int i2, String str) {
        ...
        IntList$$ExternalSyntheticBUOutline0.m236m(zzd(i, i2, "index"));
        return 0;
    }
