...
public abstract class zzbn extends zzba {
    ...
    public static class zza extends zzbn {
        ...
        public zza(byte[] bArr, int i, int i2) {
            super();
            if (bArr == null) {
                g$$ExternalSyntheticBUOutline2.m208m("buffer");
                throw null;
            }
            int i3 = i + i2;
            if ((i | i2 | (bArr.length - i3)) < 0) {
                CameraSelector$$ExternalSyntheticBUOutline0.m71m("Array range is invalid. Buffer.length=%d, offset=%d, length=%d", new Object[]{Integer.valueOf(bArr.length), Integer.valueOf(i), Integer.valueOf(i2)});
                throw null;
            }
            this.buffer = bArr;
            this.offset = i;
        ...
        @Override // com.google.android.gms.internal.clearcut.zzbn
        public final void zza(byte b2) throws zzc {
            try {
        ...
        @Override // com.google.android.gms.internal.clearcut.zzbn
        public final void zza(zzdo zzdoVar, zzef zzefVar) {
            zzas zzasVar = (zzas) zzdoVar;
            int iZzs = zzasVar.zzs();
            if (iZzs == -1) {
                iZzs = zzefVar.zzm(zzasVar);
    ...
    public static final class zze extends zzbn {
        ...
        public final void write(byte[] bArr, int i, int i2) throws zzc {
            ...
            g$$ExternalSyntheticBUOutline2.m208m("value");
        }
    ...
    public static zzbn zza(ByteBuffer byteBuffer) {
        ...
        g$$ExternalSyntheticBUOutline1.m207m("ByteBuffer is read-only");
        return null;
    }
    ...
    public abstract void zza(zzdo zzdoVar, zzef zzefVar);
