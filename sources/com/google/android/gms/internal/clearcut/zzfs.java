...
import com.google.android.gms.vision.Frame$Builder$$ExternalSyntheticBUOutline0;
...
public final class zzfs {
                    ...
                    if (cCharAt2 < 2048) {
                        ...
                        if (55296 <= cCharAt2 && cCharAt2 <= 57343) {
                            if (Character.codePointAt(charSequence, i) < 65536) {
                                Frame$Builder$$ExternalSyntheticBUOutline0.m382m(39, "Unpaired surrogate at index ", i);
                                return 0;
                            }
                            i++;
                        }
            ...
            while (i2 < length) {
                ...
                if (cCharAt2 < 128) {
                    ...
                    if (cCharAt2 >= 55296 && 57343 >= cCharAt2) {
                        ...
                        zzhd$$ExternalSyntheticBUOutline0.m353m(39, "Unpaired surrogate at index ", i2 - 1);
                        return;
                    }
    ...
    public final void zzem() {
        ...
        EncodedValueReader$$ExternalSyntheticBUOutline0.m213m("Did not write as much data as expected, %s bytes remaining.", new Object[]{Integer.valueOf(this.zzgd.remaining())});
    }
