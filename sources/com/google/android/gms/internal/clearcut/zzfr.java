...
interface zzfr {
    ...
    void zza(int i, zzbb zzbbVar);

    void zza(int i, zzdh zzdhVar, Map map);

    void zza(int i, Object obj);

    void zza(int i, Object obj, zzef zzefVar);

    void zza(int i, String str);

    void zza(int i, List list);

    void zza(int i, List list, zzef zzefVar);
    ...
    void zzb(int i, Object obj, zzef zzefVar);

    void zzb(int i, List list);

    void zzb(int i, List list, zzef zzefVar);
    ...
    void zzf(int i, List list, boolean z);
