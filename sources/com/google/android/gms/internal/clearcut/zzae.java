...
public abstract class zzae<T> {
    ...
    private zzae(zzao zzaoVar, String str, T t) {
        ...
        if (zzaoVar.zzef == null && zzaoVar.zzeg == null) {
            g$$ExternalSyntheticBUOutline1.m207m("Must pass a valid SharedPreferences file name or ContentProvider URI");
            throw null;
        }
        if (zzaoVar.zzef != null && zzaoVar.zzeg != null) {
            g$$ExternalSyntheticBUOutline1.m207m("Must pass one of SharedPreferences file name or ContentProvider URI");
            throw null;
        }
        this.zzdr = zzaoVar;
    ...
    public final T get() {
        if (zzh == null) {
            Segment$$ExternalSyntheticBUOutline1.m992m("Must call PhenotypeFlag.init() first");
            return null;
        }
        if (this.zzdr.zzek) {
            T tZzm = zzm();
