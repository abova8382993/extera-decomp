...
final class zzao implements ObjectEncoderContext {
    ...
    final zzao zzd(FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (!z || i != 0) {
    ...
    final zzao zze(FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (!z || j != 0) {
            zzam zzamVarZzj = zzj(fieldDescriptor);
            zzal zzalVar = zzal.DEFAULT;
            int iOrdinal = zzamVarZzj.zzb().ordinal();
