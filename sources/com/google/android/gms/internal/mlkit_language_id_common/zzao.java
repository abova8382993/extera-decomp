...
final class zzao implements ObjectEncoderContext {
    ...
    public final zzao zzd(FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (!z || i != 0) {
            zzam zzamVarZzj = zzj(fieldDescriptor);
            zzal zzalVar = zzal.DEFAULT;
            int iOrdinal = zzamVarZzj.zzb().ordinal();
            if (iOrdinal == 0) {
                zzn(zzamVarZzj.zza() << 3);
                zzn(i);
                return this;
            }
            if (iOrdinal == 1) {
    ...
    public final zzao zze(FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (!z || j != 0) {
            zzam zzamVarZzj = zzj(fieldDescriptor);
            zzal zzalVar = zzal.DEFAULT;
            int iOrdinal = zzamVarZzj.zzb().ordinal();
