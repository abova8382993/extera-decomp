...
public final class zzli {
    ...
    public final void zze(com.google.mlkit.p024nl.languageid.internal.zzf zzfVar, zzhy zzhyVar) {
        long jElapsedRealtime = SystemClock.elapsedRealtime();
        if (this.zzk.get(zzhyVar) != null && jElapsedRealtime - ((Long) this.zzk.get(zzhyVar)).longValue() <= 30000) {
            return;
        }
