...
public final class FaceDetector extends Detector<Face> {
    ...
    public static class Builder {
        ...
        public Builder setLandmarkType(int i) {
            if (i != 0 && i != 1 && i != 2) {
                Frame$Builder$$ExternalSyntheticBUOutline0.m382m(34, "Invalid landmark type: ", i);
                return null;
            }
            this.zzb = i;
            return this;
        ...
        public Builder setMode(int i) {
            if (i != 0 && i != 1 && i != 2) {
                Frame$Builder$$ExternalSyntheticBUOutline0.m382m(25, "Invalid mode: ", i);
                return null;
            }
            this.zzf = i;
            return this;
        ...
        public FaceDetector build() {
            ...
            if (!FaceDetector.zzb(zzfVar)) {
                g$$ExternalSyntheticBUOutline1.m207m("Invalid build options");
                return null;
            }
