...
public abstract class BaseGmsClient<T extends IInterface> {
    ...
    public final void checkConnected() {
        ...
        Segment$$ExternalSyntheticBUOutline1.m992m("Not connected. Call connect() and wait for onConnected() to be called.");
    }
    ...
    public String getEndpointPackageName() {
        ...
        GlShader$$ExternalSyntheticBUOutline1.m1250m("Failed to connect when checking package");
        return null;
    }
