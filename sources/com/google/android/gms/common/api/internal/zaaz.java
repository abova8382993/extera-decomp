...
public final class zaaz extends GoogleApiClient implements zabu {
    ...
    private final void zam(int i) {
        ...
        if (num == null) {
            ...
            zaaz$$ExternalSyntheticBUOutline0.m343m(strZag2.length() + 51 + strZag.length(), "Cannot use sign-in mode: ", strZag2, ". Mode was already set to ", strZag);
            return;
        }
        if (this.zal != null) {
            return;
        ...
        if (iIntValue == 1) {
            zaazVar = this;
            if (!zRequiresSignIn) {
                Segment$$ExternalSyntheticBUOutline1.m992m("SIGN_IN_MODE_REQUIRED cannot be used on a GoogleApiClient that does not contain any authenticated APIs. Use connect() instead.");
                return;
            } else if (zProvidesSignIn) {
                Segment$$ExternalSyntheticBUOutline1.m992m("Cannot use SIGN_IN_MODE_REQUIRED with GOOGLE_SIGN_IN_API. Use connect(SIGN_IN_MODE_OPTIONAL) instead.");
                return;
            }
        } else {
    ...
    public final String zae() {
        ...
        dump(_UrlKt.FRAGMENT_ENCODE_SET, null, new PrintWriter(stringWriter), null);
