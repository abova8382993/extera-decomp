    ...
    public final /* synthetic */ Set zap() {
        ...
        for (Api api : mapZaa.keySet()) {
            ...
            if (!zabdVar.zab.containsKey(api.zac())) {
                MediaSessionCompat$$ExternalSyntheticThrowCCEIfNotNull0.m2m(mapZaa.get(api));
                throw null;
            }
        }
        return hashSet;
