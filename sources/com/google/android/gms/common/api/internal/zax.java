        ...
        for (Api api : map2.keySet()) {
            ...
            if (arrayMap.containsKey(anyClientKeyZac)) {
                ...
                if (!arrayMap2.containsKey(anyClientKeyZac)) {
                    Segment$$ExternalSyntheticBUOutline1.m992m("Each API in the isOptionalMap must have a corresponding client in the clients map.");
                    return null;
                }
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (arrayMap3.containsKey(api2)) {
                ...
                if (!arrayMap4.containsKey(api2)) {
                    Segment$$ExternalSyntheticBUOutline1.m992m("Each ClientCallbacks must have a corresponding API in the isOptionalMap");
                    return null;
                }
