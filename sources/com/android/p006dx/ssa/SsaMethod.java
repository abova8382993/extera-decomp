...
public final class SsaMethod {
    ...
    public void makeExitBlock() {
        if (this.exitBlockIndex >= 0) {
            GlShader$$ExternalSyntheticBUOutline1.m1250m("must be called at most once");
            return;
        }
    ...
    public SsaInsn getDefinitionForRegister(int i) {
        if (this.backMode) {
            GlShader$$ExternalSyntheticBUOutline1.m1250m("No def list in back mode");
            return null;
        }
    ...
    /* JADX INFO: renamed from: com.android.dx.ssa.SsaMethod$1 */
    public class C10071 implements SsaInsn.Visitor {
        public C10071() {
        }
    ...
    private void buildUseList() {
        if (this.backMode) {
            GlShader$$ExternalSyntheticBUOutline1.m1250m("No use list in back mode");
            return;
        }
    ...
    /* JADX INFO: renamed from: com.android.dx.ssa.SsaMethod$2 */
    public class C10082 implements SsaInsn.Visitor {
        public C10082() {
        }
    ...
    private void removeFromUseList(SsaInsn ssaInsn, RegisterSpecList registerSpecList) {
        ...
        for (int i = 0; i < size; i++) {
            if (!this.useList[registerSpecList.get(i).getReg()].remove(ssaInsn)) {
                GlShader$$ExternalSyntheticBUOutline1.m1250m("use not found");
                return;
            }
        }
    }
    ...
    public void updateOneDefinition(SsaInsn ssaInsn, RegisterSpec registerSpec) {
        ...
        if (result != null) {
            ...
            if (ssaInsnArr[reg] != null) {
                GlShader$$ExternalSyntheticBUOutline1.m1250m("Duplicate add of insn");
            } else {
