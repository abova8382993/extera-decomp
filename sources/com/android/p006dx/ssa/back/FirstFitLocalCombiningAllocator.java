...
import com.android.p006dx.ssa.InterferenceRegisterMapper;
...
public class FirstFitLocalCombiningAllocator extends RegisterAllocator {
    ...
    private void addMapping(RegisterSpec registerSpec, int i) {
        ...
        if (this.ssaRegsMapped.get(reg) || !canMapReg(registerSpec, i)) {
            GlShader$$ExternalSyntheticBUOutline1.m1250m("attempt to add invalid register mapping");
            return;
        }
        int category = registerSpec.getCategory();
    ...
    */
    private int fitPlanForRange(int r11, com.android.p006dx.ssa.NormalSsaInsn r12, int[] r13, java.util.BitSet r14) {
        /*
            r10 = this;
        ...
        L7d:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.p006dx.ssa.back.FirstFitLocalCombiningAllocator.fitPlanForRange(int, com.android.dx.ssa.NormalSsaInsn, int[], java.util.BitSet):int");
    }
