...
public class LivenessAnalyzer {
    ...
    private void handleTailRecursion() {
        while (true) {
            ...
            int i = C10151.$SwitchMap$com$android$dx$ssa$back$LivenessAnalyzer$NextFunction[nextFunction.ordinal()];
            if (i == 1) {
    ...
    public void run() {
        for (SsaInsn ssaInsn : this.ssaMeth.getUseListForRegister(this.regV)) {
            ...
            if (ssaInsn instanceof PhiInsn) {
                ...
                if (iIndexOf < 0) {
                    GlShader$$ExternalSyntheticBUOutline1.m1250m("insn not found in it's own block");
                    return;
                } else {
