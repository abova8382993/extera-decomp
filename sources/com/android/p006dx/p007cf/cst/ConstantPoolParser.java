package com.android.p006dx.p007cf.cst;
...
public final class ConstantPoolParser {
    ...
    private void parse() {
        ...
        if (parseObserver != null) {
            parseObserver.parsed(this.bytes, 8, 2, "constant_pool_count: " + Hex.m231u2(this.offsets.length));
        ...
        if (this.observer != null) {
            for (int i2 = 1; i2 < this.offsets.length; i2++) {
                ...
                if (orNull != null) {
                    ...
                    this.observer.parsed(this.bytes, i3, i4 - i3, bitSet.get(i2) ? Hex.m231u2(i2) + ": utf8{\"" + orNull.toHuman() + "\"}" : Hex.m231u2(i2) + ": " + orNull.toString());
                }
            }
            this.observer.changeIndent(-1);
        ...
        while (true) {
            ...
            if (i2 < iArr.length) {
                ...
                switch (unsignedByte) {
                    ...
                    case 17:
                    default:
                        throw new ParseException("unknown tag byte: " + Hex.m230u1(unsignedByte));
                    case 3:
                    case 4:
                    case 9:
                    case 10:
                    ...
                    case 18:
                        try {
                            ...
                            e.addContext("...while preparsing cst " + Hex.m231u2(i2) + " at offset " + Hex.m233u4(unsignedShort));
                            throw e;
                        }
                        break;
                    case 5:
    ...
    private Constant parse0(int i, BitSet bitSet) {
        ...
        try {
            ...
            e.addContext("...while parsing cst " + Hex.m231u2(i) + " at offset " + Hex.m233u4(i2));
            throw e;
        } catch (RuntimeException e2) {
            ParseException parseException = new ParseException(e2);
            parseException.addContext("...while parsing cst " + Hex.m231u2(i) + " at offset " + Hex.m233u4(i2));
    ...
    private static int getMethodHandleTypeForKind(int i) {
        switch (i) {
            ...
            case 9:
                return 8;
            default:
                CharCodeKt$$ExternalSyntheticBUOutline0.m873m("invalid kind: ", i);
                return 0;
        }
    }
}
