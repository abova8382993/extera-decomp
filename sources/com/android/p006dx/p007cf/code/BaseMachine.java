...
public abstract class BaseMachine implements Machine {
    ...
    @Override // com.android.p006dx.p007cf.code.Machine
    ...
    public final void popArgs(Frame frame, Type type) {
        ...
        BaseMachine$$ExternalSyntheticBUOutline0.m218m(type.toHuman(), this.args[0].getType().toHuman());
    }
    ...
    public final void popArgs(Frame frame, Type type, Type type2) {
        ...
        if (!Merger.isPossiblyAssignableFrom(type, this.args[0])) {
            ...
            BaseMachine$$ExternalSyntheticBUOutline0.m218m(type2.toHuman(), this.args[1].getType().toHuman());
        }
    }
    ...
    public final void popArgs(Frame frame, Type type, Type type2, Type type3) {
        ...
        if (!Merger.isPossiblyAssignableFrom(type, this.args[0])) {
            ...
            BaseMachine$$ExternalSyntheticBUOutline0.m218m(type3.toHuman(), this.args[2].getType().toHuman());
        }
    }
    ...
    public final TypeBearer arg(int i) {
        if (i >= this.argCount) {
            g$$ExternalSyntheticBUOutline1.m207m("n >= argCount");
            return null;
        }
        try {
            return this.args[i];
        } catch (ArrayIndexOutOfBoundsException unused) {
            g$$ExternalSyntheticBUOutline1.m207m("n < 0");
            return null;
        }
    }
    ...
    public final RegisterSpec getLocalTarget(boolean z) {
        ...
        if (this.resultCount != 1) {
            StringBuilder sb = new StringBuilder("local target with ");
    ...
    public final TypeBearer result(int i) {
        if (i >= this.resultCount) {
            g$$ExternalSyntheticBUOutline1.m207m("n >= resultCount");
            return null;
        }
        try {
