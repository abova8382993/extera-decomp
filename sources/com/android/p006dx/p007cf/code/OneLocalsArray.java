...
public class OneLocalsArray extends LocalsArray {
    ...
    public void annotate(ExceptionWithContext exceptionWithContext) {
        ...
        while (true) {
            ...
            exceptionWithContext.addContext("locals[" + Hex.m231u2(i) + "]: " + (typeBearer == null ? "<invalid>" : typeBearer.toString()));
            i++;
        }
    }
    ...
    public String toHuman() {
        ...
        while (true) {
            ...
            if (i < typeBearerArr.length) {
                TypeBearer typeBearer = typeBearerArr[i];
                sb.append("locals[" + Hex.m231u2(i) + "]: " + (typeBearer == null ? "<invalid>" : typeBearer.toString()) + "\n");
                i++;
            } else {
                return sb.toString();
            }
    ...
    public void set(int i, TypeBearer typeBearer) {
        ...
        try {
            ...
            if (i < 0) {
                IntList$$ExternalSyntheticBUOutline0.m236m("idx < 0");
                return;
            }
    ...
    private static TypeBearer throwSimException(int i, String str) {
        throw new SimException("local " + Hex.m231u2(i) + ": " + str);
    }
}
