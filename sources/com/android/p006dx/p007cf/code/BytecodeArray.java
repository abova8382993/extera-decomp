...
public final class BytecodeArray {
    ...
    public BytecodeArray(ByteArray byteArray, ConstantPool constantPool) {
        ...
        if (constantPool == null) {
            g$$ExternalSyntheticBUOutline2.m208m("pool == null");
            throw null;
        }
    ...
    public void processWorkSet(int[] iArr, Visitor visitor) {
        if (visitor == null) {
            g$$ExternalSyntheticBUOutline2.m208m("visitor == null");
            return;
        }
        while (true) {
    ...
    public int parseInstruction(int i, Visitor visitor) {
        ...
        try {
            ...
            try {
                    ...
                    switch (unsignedByte) {
                        ...
                        case 193:
                            ...
                            try {
                                ...
                                e = e;
                                simException = e;
                                simException.addContext("...at bytecode offset " + Hex.m233u4(i2));
                                throw simException;
                            } catch (RuntimeException e2) {
                                e = e2;
                                runtimeException = e;
                                SimException simException2 = new SimException(runtimeException);
                                simException2.addContext("...at bytecode offset " + Hex.m233u4(i2));
                                throw simException2;
                            }
                        case 185:
                ...
                simException22.addContext("...at bytecode offset " + Hex.m233u4(i2));
    ...
    */
    private int parseNewarray(int r12, com.android.dx.cf.code.BytecodeArray.Visitor r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.p006dx.p007cf.code.BytecodeArray.parseNewarray(int, com.android.dx.cf.code.BytecodeArray$Visitor):int");
    }
