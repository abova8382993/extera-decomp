    ...
    private void removeBlockAndSpecialSuccessors(int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (i3 >= minimumUnreservedLabel) {
                ...
                if (iLabelToResultIndex < 0) {
                    Instance$$ExternalSyntheticBUOutline0.m1010m("Invalid label ", Hex.m231u2(i3));
                    return;
                }
                removeBlockAndSpecialSuccessors(iLabelToResultIndex);
            }
    ...
    private void doit() {
        ...
        while (true) {
            ...
            try {
                ...
                e.addContext("...while working on block " + Hex.m231u2(iFindFirst));
                throw e;
            }
        }
        addReturnBlock();
    ...
    private void processBlock(ByteBlock byteBlock, Frame frame, int[] iArr) {
        ...
        while (size < size4) {
            ...
            try {
                ...
                e.addContext("...while merging to block " + Hex.m231u2(i5));
                throw e;
            }
        }
        int i7 = size4;
        ...
        if (z || size3 != 0) {
            ...
            while (i9 < size3) {
                ...
                try {
                    ...
                    e = e3;
                    e.addContext("...while merging exception to block " + Hex.m231u2(i2));
                    throw e;
                }
            }
            frame2 = frame4;
            ...
            if (!Ropper.this.isSubroutineCaller(basicBlockLabelToBlock)) {
                ...
                if (subroutineSubroutineFromRetBlock != null) {
                    if (subroutineSubroutineFromRetBlock.startBlock != this.subroutineStart) {
                        StaticFieldStub$$ExternalSyntheticBUOutline0.m1029m("ret instruction returns to label ", Hex.m231u2(subroutineSubroutineFromRetBlock.startBlock), " expected: ", Hex.m231u2(this.subroutineStart));
                        return;
                    } else {
