...
public class ClassPathOpener {
    ...
    public static int compareClassNames(String str, String str2) {
        return str.replace(Typography.dollar, '0').replace("package-info", _UrlKt.FRAGMENT_ENCODE_SET).compareTo(str2.replace(Typography.dollar, '0').replace("package-info", _UrlKt.FRAGMENT_ENCODE_SET));
    }
