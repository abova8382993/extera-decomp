...
abstract class MemberListParser {
    ...
    private final DirectClassFile f99cf;
    ...
    public final int getCount() {
        return this.f99cf.getBytes().getUnsignedShort(this.offset);
    }
    ...
    private void parse() {
        ...
        ByteArray bytes = this.f99cf.getBytes();
        ConstantPool constantPool2 = this.f99cf.getConstantPool();
        ParseObserver parseObserver = this.observer;
        if (parseObserver != null) {
            parseObserver.parsed(bytes, this.offset, 2, humanName() + "s_count: " + Hex.m231u2(count));
        }
        int i5 = 0;
        while (i5 < count) {
            try {
                ...
                AttributeListParser attributeListParser = new AttributeListParser(this.f99cf, attributeContext, i4 + 6, this.attributeFactory);
