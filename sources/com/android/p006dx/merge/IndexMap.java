...
public final class IndexMap {
    ...
    public int adjustType(int i) {
        ...
        return this.typeIds[i] & UShort.MAX_VALUE;
    }
    ...
    public int adjustProto(int i) {
        return this.protoIds[i] & UShort.MAX_VALUE;
    }

    public int adjustField(int i) {
        return this.fieldIds[i] & UShort.MAX_VALUE;
    }

    public int adjustMethod(int i) {
        return this.methodIds[i] & UShort.MAX_VALUE;
    }
        ...
        public void transform(EncodedValueReader encodedValueReader) {
            ...
            switch (iPeek) {
                ...
                case 31:
                    ...
                    break;
                default:
                    DexMerger$$ExternalSyntheticBUOutline0.m223m("Unexpected type: ", Integer.toHexString(encodedValueReader.peek()));
                    break;
            }
        }
