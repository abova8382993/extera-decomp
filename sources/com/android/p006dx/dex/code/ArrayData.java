...
import com.android.p006dx.rop.cst.CstLiteral32;
...
public final class ArrayData extends VariableSizeInsn {
    ...
    public ArrayData(SourcePosition sourcePosition, CodeAddress codeAddress, ArrayList<Constant> arrayList, Constant constant) {
        ...
        if (arrayList == null) {
            g$$ExternalSyntheticBUOutline2.m208m("values == null");
            throw null;
        }
        if (arrayList.size() <= 0) {
            g$$ExternalSyntheticBUOutline1.m207m("Illegal number of init values");
            throw null;
        }
        ...
        if (constant == CstType.BYTE_ARRAY || constant == CstType.BOOLEAN_ARRAY) {
            ...
            g$$ExternalSyntheticBUOutline1.m207m("Unexpected constant type");
            throw null;
        }
