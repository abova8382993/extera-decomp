...
public final class DalvInsnList extends FixedSizeList {
    ...
    public void writeTo(AnnotatedOutput annotatedOutput) {
        ...
        DalvInsnList$$ExternalSyntheticBUOutline0.m220m("write length mismatch; expected ", codeSize(), " but actually wrote ", cursor2);
    }
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (dalvInsn instanceof CstInsn) {
                ...
                if (dalvInsn.getOpcode().getFamily() != 250) {
                    GlShader$$ExternalSyntheticBUOutline1.m1250m("Expecting invoke-polymorphic");
                    return 0;
                }
