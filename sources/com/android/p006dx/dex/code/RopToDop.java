...
public final class RopToDop {
    ...
    public static Dop dopFor(Insn insn) {
        ...
        if (opcode2 == 5) {
            ...
            GlShader$$ExternalSyntheticBUOutline1.m1250m("Unexpected constant type");
            return null;
        }
        if (opcode2 == 41) {
        ...
        if (opcode2 == 55) {
            ...
            switch (result.getBasicType()) {
                ...
                default:
                    GlShader$$ExternalSyntheticBUOutline1.m1250m("Unexpected basic type");
                    return null;
            }
        }
        switch (opcode2) {
        ...
        MVEL$$ExternalSyntheticBUOutline0.m1006m("unknown rop: ", opcode);
        return null;
    }
}
