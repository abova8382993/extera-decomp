...
import com.android.p006dx.util.Writers;
...
public final class ClassDefItem extends IndexedItem {
    ...
    public ClassDefItem(CstType cstType, int i, CstType cstType2, TypeList typeList, CstString cstString) {
        if (cstType == null) {
            g$$ExternalSyntheticBUOutline2.m208m("thisClass == null");
            throw null;
        }
        if (typeList == null) {
            g$$ExternalSyntheticBUOutline2.m208m("interfaces == null");
            throw null;
        }
    ...
    public void writeTo(DexFile dexFile, AnnotatedOutput annotatedOutput) {
        ...
        if (zAnnotates) {
            ...
            annotatedOutput.annotate(4, "  interfaces_off:      " + Hex.m233u4(absoluteOffsetOr0));
            ...
            sb3.append(Hex.m233u4(iIndexOf3));
            sb3.append(" // ");
            CstString cstString = this.sourceFile;
            ...
            annotatedOutput.annotate(4, "  class_data_off:      " + Hex.m233u4(absoluteOffset2));
            annotatedOutput.annotate(4, "  static_values_off:   " + Hex.m233u4(absoluteOffsetOr02));
        }
    ...
    public void debugPrint(Writer writer, boolean z) {
        ...
        printWriterPrintWriterFor.println("  accessFlags: " + Hex.m231u2(this.accessFlags));
