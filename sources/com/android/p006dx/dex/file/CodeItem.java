...
public final class CodeItem extends OffsettedItem {
    ...
    public CodeItem(CstMethodRef cstMethodRef, DalvCode dalvCode, boolean z, TypeList typeList) {
        ...
        if (typeList == null) {
            g$$ExternalSyntheticBUOutline2.m208m("throwsList == null");
            throw null;
        }
    ...
    public void debugPrint(PrintWriter printWriter, String str, boolean z) {
        ...
        printWriter.println("regs: " + Hex.m231u2(getRegistersSize()) + "; ins: " + Hex.m231u2(getInsSize()) + "; outs: " + Hex.m231u2(getOutsSize()));
    ...
    public void writeTo0(DexFile dexFile, AnnotatedOutput annotatedOutput) {
        ...
        if (zAnnotates) {
            ...
            sb.append(Hex.m231u2(registersSize));
            annotatedOutput.annotate(2, sb.toString());
            annotatedOutput.annotate(2, "  ins_size:       " + Hex.m231u2(insSize));
            annotatedOutput.annotate(2, "  outs_size:      " + Hex.m231u2(outsSize));
            annotatedOutput.annotate(2, "  tries_size:     " + Hex.m231u2(iTriesSize));
            annotatedOutput.annotate(4, "  debug_off:      " + Hex.m233u4(absoluteOffset));
            annotatedOutput.annotate(4, "  insns_size:     " + Hex.m233u4(iCodeSize));
