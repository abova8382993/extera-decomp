...
public class OptimizerOptions {
    ...
    public void loadOptimizeLists(String str, String str2) {
        ...
        if (str != null && str2 != null) {
            GlShader$$ExternalSyntheticBUOutline1.m1250m("optimize and don't optimize lists  are mutually exclusive.");
            return;
        }
        if (str != null) {
    ...
    private static HashSet<String> loadStringsFromFile(String str) {
        ...
        try {
            ...
            a$$ExternalSyntheticBUOutline0.m201m("Error with optimize list: ", str, e);
            return null;
        }
    }
