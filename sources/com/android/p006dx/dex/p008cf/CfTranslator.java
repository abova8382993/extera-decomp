...
import com.android.p006dx.dex.file.CallSiteIdsSection;
...
import com.android.p006dx.dex.file.FieldIdsSection;
import com.android.p006dx.dex.file.MethodHandlesSection;
import com.android.p006dx.dex.file.MethodIdsSection;
...
import com.android.p006dx.p007cf.iface.Field;
...
import com.android.p006dx.rop.code.LocalVariableExtractor;
...
import com.android.p006dx.rop.cst.CstInvokeDynamic;
...
public class CfTranslator {
    ...
    /* JADX INFO: renamed from: com.android.dx.dex.cf.CfTranslator$1 */
    public static class C09421 implements DalvCode.AssignIndicesCallback {
    ...
    private static void updateDexStatistics(DxContext dxContext, CfOptions cfOptions, DexOptions dexOptions, RopMethod ropMethod, RopMethod ropMethod2, LocalVariableInfo localVariableInfo, int i, int i2) {
        ...
        C09421 c09421 = new DalvCode.AssignIndicesCallback() { // from class: com.android.dx.dex.cf.CfTranslator.1
            @Override // com.android.dx.dex.code.DalvCode.AssignIndicesCallback
            public int getIndex(Constant constant) {
                return 0;
            }
        };
        dalvCodeTranslate.assignIndices(c09421);
        dalvCodeTranslate2.assignIndices(c09421);
