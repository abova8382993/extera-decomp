package com.android.p006dx.command.annotool;

import com.android.p006dx.command.annotool.Main;
...
import com.android.p006dx.p007cf.attrib.BaseAnnotations;
...
class AnnotationLister {
    ...
    public static /* synthetic */ class C09362 {
    ...
    private void printMatchPackage(String str) {
        ...
        while (it.hasNext()) {
            int i = C09362.$SwitchMap$com$android$dx$command$annotool$Main$PrintType[it.next().ordinal()];
            if (i == 1 || i == 2 || i == 3) {
