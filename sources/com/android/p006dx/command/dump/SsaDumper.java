...
public class SsaDumper extends BlockDumper {
    ...
    @Override // com.android.p006dx.command.dump.BlockDumper, com.android.p006dx.command.dump.BaseDumper, com.android.p006dx.p007cf.iface.ParseObserver
    public void endParsingMember(ByteArray byteArray, int i, String str, String str2, Member member) {
        ...
        if ((member instanceof Method) && shouldDumpMethod(str) && (member.getAccessFlags() & 1280) == 0) {
            ...
            sb.append("first ");
            sb.append(Hex.m231u2(ssaMethodDebugDeadCodeRemover.blockIndexToRopLabel(ssaMethodDebugDeadCodeRemover.getEntryBlockIndex())));
            sb.append('\n');
            ...
            while (i2 < size) {
                ...
                sb.append("block ");
                sb.append(Hex.m231u2(ssaBasicBlock.getRopLabel()));
                sb.append('\n');
                ...
                for (int iNextSetBit = predecessors.nextSetBit(0); iNextSetBit >= 0; iNextSetBit = predecessors.nextSetBit(iNextSetBit + 1)) {
                    sb.append("  pred ");
                    sb.append(Hex.m231u2(ssaMethodDebugDeadCodeRemover.blockIndexToRopLabel(iNextSetBit)));
                    sb.append('\n');
                }
                ...
                if (ssaBasicBlock.getSuccessors().cardinality() == 0) {
                    ...
                    for (int i4 = 0; i4 < size3; i4++) {
                        sb.append("  next ");
                        sb.append(Hex.m231u2(ropLabelSuccessorList.get(i4)));
