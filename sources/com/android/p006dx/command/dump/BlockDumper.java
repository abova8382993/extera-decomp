...
import com.android.p006dx.p007cf.code.BasicBlocker;
import com.android.p006dx.p007cf.code.ByteBlock;
import com.android.p006dx.p007cf.code.ByteBlockList;
...
import com.android.p006dx.p007cf.direct.CodeObserver;
...
public class BlockDumper extends BaseDumper {
    ...
    @Override // com.android.p006dx.command.dump.BaseDumper, com.android.p006dx.p007cf.iface.ParseObserver
    ...
    private void regularDump(ConcreteMethod concreteMethod) {
        ...
        while (i < size) {
            ...
            if (i2 < start) {
                parsed(bytes, i2, start - i2, "dead code " + Hex.m231u2(i2) + ".." + Hex.m231u2(start));
            }
            parsed(bytes, start, 0, "block " + Hex.m231u2(byteBlock.getLabel()) + ": " + Hex.m231u2(start) + ".." + Hex.m231u2(end));
            changeIndent(1);
            while (start < end) {
            ...
            if (size2 == 0) {
                ...
                for (int i3 = 0; i3 < size2; i3++) {
                    parsed(bytes, end, 0, "next " + Hex.m231u2(successors.get(i3)));
                }
            }
            ...
            for (int i4 = 0; i4 < size3; i4++) {
                ...
                sb.append(" -> ");
                sb.append(Hex.m231u2(item.getHandlerPc()));
        ...
        if (i2 < size4) {
            parsed(bytes, i2, size4 - i2, "dead code " + Hex.m231u2(i2) + ".." + Hex.m231u2(size4));
        }
        this.suppressDump = true;
    }
    ...
    private void ropDump(ConcreteMethod concreteMethod) {
        ...
        sb.append("first " + Hex.m231u2(ropMethodConvert.getFirstLabel()) + "\n");
        for (int i : labelsInOrder) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                sb.append("  pred ");
                sb.append(Hex.m231u2(intListLabelToPredecessors.get(i2)));
                sb.append("\n");
            }
