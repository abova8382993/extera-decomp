...
public final class Prototype implements Comparable<Prototype> {
        ...
        while (true) {
            ...
            if (cCharAt != ')') {
                ...
                if (cCharAt == 'L') {
                    ...
                    if (iIndexOf == -1) {
                        g$$ExternalSyntheticBUOutline1.m207m("bad descriptor");
                        return null;
                    }
                    i = iIndexOf + 1;
                } else {
    ...
    private Prototype(String str, Type type, StdTypeList stdTypeList) {
        ...
        if (type == null) {
            g$$ExternalSyntheticBUOutline2.m208m("returnType == null");
            throw null;
        }
        if (stdTypeList == null) {
            g$$ExternalSyntheticBUOutline2.m208m("parameterTypes == null");
            throw null;
        }
        this.descriptor = str;
