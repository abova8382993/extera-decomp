...
public final class CstType extends TypedConstant {
    ...
    private static void internInitial(CstType cstType) {
        ...
        DexMaker$$ExternalSyntheticBUOutline0.m217m("Attempted re-init of ", cstType);
    }
    ...
    public static CstType forBoxedPrimitiveType(Type type) {
        switch (type.getBasicType()) {
            ...
            case 8:
                return SHORT;
            default:
                Native$$ExternalSyntheticBUOutline5.m554m("not primitive: ", type);
                return null;
        }
    }
    ...
    public CstType(Type type) {
        ...
        if (type == Type.KNOWN_NULL) {
            ByteString$$ExternalSyntheticBUOutline0.m979m("KNOWN_NULL is not representable");
            throw null;
        }
        this.type = type;
    ...
    public String typeName() {
        return TeXSymbolParser.TYPE_ATTR;
    }
