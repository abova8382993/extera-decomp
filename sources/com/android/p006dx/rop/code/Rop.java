...
public final class Rop {
    ...
    public Rop(int i, Type type, TypeList typeList, TypeList typeList2, int i2, boolean z, String str) {
        ...
        if (i2 < 1 || i2 > 6) {
            CharCodeKt$$ExternalSyntheticBUOutline0.m873m("invalid branchingness: ", i2);
            throw null;
        }
        if (typeList2.size() != 0 && i2 != 6) {
            g$$ExternalSyntheticBUOutline1.m207m("exceptions / branchingness mismatch");
            throw null;
        }
        this.opcode = i;
        this.result = type;
    ...
    public String toString() {
        ...
        if (size2 != 0) {
            ...
            if (i3 == 1) {
                ...
                sb.append(" " + Hex.m230u1(this.branchingness));
            }
        }
        sb.append('}');
        return sb.toString();
