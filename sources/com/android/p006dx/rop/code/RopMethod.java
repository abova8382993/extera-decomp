...
public final class RopMethod {
    ...
    public RopMethod(BasicBlockList basicBlockList, int i) {
        if (basicBlockList == null) {
            g$$ExternalSyntheticBUOutline2.m208m("blocks == null");
            throw null;
        }
        if (i < 0) {
            g$$ExternalSyntheticBUOutline1.m207m("firstLabel < 0");
            throw null;
        }
    ...
    public IntList labelToPredecessors(int i) {
        ...
        Instance$$ExternalSyntheticBUOutline0.m1010m("no such block: ", Hex.m231u2(i));
        return null;
    }
