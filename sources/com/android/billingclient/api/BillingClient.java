...
public abstract class BillingClient {
    ...
    public static final class Builder {
        ...
        public BillingClient build() {
            if (this.zzc == null) {
                g$$ExternalSyntheticBUOutline1.m207m("Please provide a valid Context.");
                return null;
            }
            if (this.zzd == null) {
                ...
                g$$ExternalSyntheticBUOutline1.m207m("Please provide a valid listener for purchases updates.");
                return null;
            }
            if (this.zzb == null || !this.zzb.isEnabledForOneTimeProducts()) {
                g$$ExternalSyntheticBUOutline1.m207m("Pending purchases for one-time products must be supported.");
                return null;
            }
            if (this.zzd == null) {
