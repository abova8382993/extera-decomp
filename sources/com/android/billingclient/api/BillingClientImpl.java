...
class BillingClientImpl extends BillingClient {
    ...
    public BillingResult launchBillingFlow(Activity activity, final BillingFlowParams billingFlowParams) {
        ...
        MediaSessionCompat$$ExternalSyntheticThrowCCEIfNotNull0.m2m(com.google.android.gms.internal.play_billing.zzcx.zza(arrayListZzg, null));
            ...
            if (arrayListZzg.isEmpty()) {
                ...
                if (arrayListZzg.size() > 1) {
                    ...
                    if (1 < arrayListZzg.size()) {
                        MediaSessionCompat$$ExternalSyntheticThrowCCEIfNotNull0.m2m(arrayListZzg.get(1));
                        throw null;
                    }
