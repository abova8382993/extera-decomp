...
public final class ProductDetails {
    ...
    public ProductDetails(String str) {
        ...
        String strOptString2 = jSONObject.optString(TeXSymbolParser.TYPE_ATTR);
        this.zzd = strOptString2;
        if (TextUtils.isEmpty(strOptString)) {
            g$$ExternalSyntheticBUOutline1.m207m("Product id cannot be empty.");
            throw null;
        }
        if (TextUtils.isEmpty(strOptString2)) {
            g$$ExternalSyntheticBUOutline1.m207m("Product type cannot be empty.");
            throw null;
        }
