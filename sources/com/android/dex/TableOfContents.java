...
public final class TableOfContents {
    ...
    private void readHeader(Dex.Section section) {
        ...
        if (i != 112) {
            DexMerger$$ExternalSyntheticBUOutline0.m223m("Unexpected header: 0x", Integer.toHexString(i));
            return;
        }
        int i2 = section.readInt();
        if (i2 != 305419896) {
            DexMerger$$ExternalSyntheticBUOutline0.m223m("Unexpected endian tag: 0x", Integer.toHexString(i2));
            return;
        }
    ...
    private void readMap(Dex.Section section) {
        ...
        while (i3 < i2) {
            ...
            if ((i6 != 0 && i6 != i4) || ((i = section3.off) != -1 && i != i5)) {
                DexMerger$$ExternalSyntheticBUOutline0.m223m("Unexpected map value for 0x", Integer.toHexString(s));
                return;
            }
            section3.size = i4;
            section3.off = i5;
    ...
    public void computeSizesFromOffsets() {
        ...
        for (int length = this.sections.length - 1; length >= 0; length--) {
            ...
            if (i2 != -1) {
                if (i2 > i) {
                    Dex$$ExternalSyntheticBUOutline2.m212m("Map is unsorted at ", section);
                    return;
                } else {
    ...
    private Section getSection(short s) {
        ...
        CharCodeKt$$ExternalSyntheticBUOutline0.m873m("No such map item: ", s);
        return null;
    }
