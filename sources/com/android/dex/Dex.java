...
public final class Dex {
    ...
    public Dex(File file) throws IOException {
        ...
        if (FileUtils.hasArchiveSuffix(file.getName())) {
            ...
            Dex$$ExternalSyntheticBUOutline2.m212m("Expected classes.dex in ", file);
            throw null;
        }
        ...
        Dex$$ExternalSyntheticBUOutline2.m212m("unknown output extension: ", file);
        throw null;
    }
    ...
    public static void checkBounds(int i, int i2) {
        if (i < 0 || i >= i2) {
            Dex$$ExternalSyntheticBUOutline0.m210m("index:", i, ", length=", i2);
        }
    }
    ...
    public Section open(int i) {
        if (i < 0 || i >= this.data.capacity()) {
            Dex$$ExternalSyntheticBUOutline1.m211m("position=", i, " length=", this.data.capacity());
            return null;
        }
        ByteBuffer byteBufferDuplicate = this.data.duplicate();
    ...
    public Section appendSection(int i, String str) {
        if ((i & 3) != 0) {
            Segment$$ExternalSyntheticBUOutline1.m992m("Not four byte aligned!");
            return null;
        }
    ...
    public final class Section implements ByteInput, ByteOutput {
        ...
        public /* synthetic */ Section(Dex dex, String str, ByteBuffer byteBuffer, C09091 c09091) {
            this(str, byteBuffer);
        }
        ...
        public Annotation readAnnotation() {
            ...
            return new Annotation(Dex.this, b2, new EncodedValue(getBytesFrom(iPosition)));
        }
        ...
        public void writeUnsignedShort(int i) {
            short s = (short) i;
            if (i != (65535 & s)) {
                CharCodeKt$$ExternalSyntheticBUOutline0.m873m("Expected an unsigned short: ", i);
            } else {
                writeShort(s);
            }
        }
    ...
    public final class StringTable extends AbstractList<String> implements RandomAccess {
        ...
        public /* synthetic */ StringTable(Dex dex, C09091 c09091) {
            this();
        }
    ...
    public final class TypeIndexToDescriptorIndexTable extends AbstractList<Integer> implements RandomAccess {
        ...
        public /* synthetic */ TypeIndexToDescriptorIndexTable(Dex dex, C09091 c09091) {
            this();
        }
    ...
    public final class TypeIndexToDescriptorTable extends AbstractList<String> implements RandomAccess {
        ...
        public /* synthetic */ TypeIndexToDescriptorTable(Dex dex, C09091 c09091) {
            this();
        }
    ...
    public final class ProtoIdTable extends AbstractList<ProtoId> implements RandomAccess {
        ...
        public /* synthetic */ ProtoIdTable(Dex dex, C09091 c09091) {
            this();
        }
    ...
    public final class FieldIdTable extends AbstractList<FieldId> implements RandomAccess {
        ...
        public /* synthetic */ FieldIdTable(Dex dex, C09091 c09091) {
            this();
        }
    ...
    public final class MethodIdTable extends AbstractList<MethodId> implements RandomAccess {
        ...
        public /* synthetic */ MethodIdTable(Dex dex, C09091 c09091) {
            this();
        }
    ...
    public final class ClassDefIterator implements Iterator<ClassDef> {
        ...
        private final Section f87in;

        private ClassDefIterator() {
            this.f87in = Dex.this.open(Dex.this.tableOfContents.classDefs.off);
            this.count = 0;
        }

        public /* synthetic */ ClassDefIterator(Dex dex, C09091 c09091) {
            this();
        }
        ...
        public ClassDef next() {
            ...
            this.count++;
            return this.f87in.readClassDef();
        }
    ...
    public final class ClassDefIterable implements Iterable<ClassDef> {
        ...
        public /* synthetic */ ClassDefIterable(Dex dex, C09091 c09091) {
            this();
        }
