...
public final class ByteArrayAnnotatedOutput implements AnnotatedOutput, ByteOutput {
    ...
    public ByteArrayAnnotatedOutput() {
        this(MediaDataController.MAX_STYLE_RUNS_COUNT);
    }
  ...
  0x0017: PHI (r1v3 int) = (r1v0 int), (r1v1 int) binds: [B:9:0x0015, B:12:0x001b] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public void enableAnnotations(int r4, boolean r5) {
        /*
            r3 = this;
            java.util.ArrayList r0 = r3.annotations
            if (r0 != 0) goto L36
            int r0 = r3.cursor
            if (r0 != 0) goto L36
            r0 = 40
    ...
    public void writeAnnotationsTo(Writer writer) throws IOException {
        ...
        while (true) {
            ...
            Annotation annotation = (Annotation) this.annotations.get(i3);
        ...
        while (i3 < size) {
            right.write(((Annotation) this.annotations.get(i3)).getText());
            i3++;
        }
        twoColumnOutput.flush();
    }
    ...
    private void ensureCapacity(int i) {
        byte[] bArr = this.data;
        if (bArr.length < i) {
            byte[] bArr2 = new byte[(i * 2) + MediaDataController.MAX_STYLE_RUNS_COUNT];
