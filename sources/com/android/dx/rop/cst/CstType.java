...
public final class CstType extends TypedConstant {
    ...
    private static final ConcurrentMap interns = new ConcurrentHashMap(MediaDataController.MAX_STYLE_RUNS_COUNT, 0.75f);
    ...
    public static CstType intern(Type type) {
        ...
        CstType cstType2 = (CstType) interns.putIfAbsent(type, cstType);
