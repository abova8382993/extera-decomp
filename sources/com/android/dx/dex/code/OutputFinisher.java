...
public final class OutputFinisher {
    ...
    public HashSet getAllConstants() {
        ...
        ArrayList arrayList = this.insns;
        int size = arrayList.size();
        int i = 0;
        while (i < size) {
            Object obj = arrayList.get(i);
            i++;
            addConstants(hashSet, (DalvInsn) obj);
        }
        return hashSet;
    }

    private static void addConstants(HashSet hashSet, DalvInsn dalvInsn) {
    ...
    private static void addConstants(HashSet hashSet, RegisterSpec registerSpec) {
        if (registerSpec == null) {
            return;
        }
        registerSpec.getLocalItem();
    ...
    public void assignIndices(DalvCode.AssignIndicesCallback assignIndicesCallback) {
        ...
        while (i < size) {
            Object obj = arrayList.get(i);
            i++;
            DalvInsn dalvInsn = (DalvInsn) obj;
            if (dalvInsn instanceof CstInsn) {
    ...
    */
    private java.util.ArrayList performExpansion(com.android.dx.dex.code.Dop[] r13) {
        /*
            r12 = this;
            java.util.ArrayList r0 = r12.insns
            int r0 = r0.size()
        ...
        L14:
            if (r4 >= r0) goto L89
            java.util.ArrayList r5 = r12.insns
        ...
        L29:
            ...
            r8 = r9
        L42:
            boolean r9 = r5 instanceof com.android.dx.dex.code.CodeAddress
            if (r9 == 0) goto L53
            r9 = r5
            com.android.dx.dex.code.CodeAddress r9 = (com.android.dx.dex.code.CodeAddress) r9
        ...
        L53:
            ...
            r1.add(r8)
        L58:
            boolean r8 = r5 instanceof com.android.dx.dex.code.ZeroSizeInsn
            if (r8 != 0) goto L78
            int r8 = r2.size()
            if (r8 <= 0) goto L78
            int r8 = r2.size()
        ...
        L67:
            ...
            int r9 = r9 + 1
            com.android.dx.dex.code.CodeAddress r11 = (com.android.dx.dex.code.CodeAddress) r11
            r1.add(r11)
            goto L67
        L75:
            r2.clear()
    ...
    private void align64bits(Dop[] dopArr) {
        do {
            ...
            while (i6 < size) {
                ...
                i6++;
                RegisterSpecList registers = ((DalvInsn) obj).getRegisters();
    ...
    private void shiftParameters(int i) {
        ...
        for (int i5 = 0; i5 < size; i5++) {
            DalvInsn dalvInsn = (DalvInsn) this.insns.get(i5);
            if (!(dalvInsn instanceof CodeAddress)) {
