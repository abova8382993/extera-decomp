...
public abstract class Dops {
    ...
    static {
        ...
        Dop dop107 = new Dop(111, 111, Opcodes.LNEG, insnFormat11, false);
        INVOKE_SUPER = dop107;
        Dop dop108 = new Dop(112, 112, Opcodes.FNEG, insnFormat11, false);
        INVOKE_DIRECT = dop108;
        Dop dop109 = new Dop(113, 113, Opcodes.DNEG, insnFormat11, false);
        INVOKE_STATIC = dop109;
        Dop dop110 = new Dop(114, 114, Opcodes.ISHL, insnFormat11, false);
        INVOKE_INTERFACE = dop110;
        Dop dop111 = new Dop(116, 110, -1, insnFormat12, false);
        INVOKE_VIRTUAL_RANGE = dop111;
        Dop dop112 = new Dop(Opcodes.LNEG, 111, -1, insnFormat12, false);
        INVOKE_SUPER_RANGE = dop112;
        Dop dop113 = new Dop(Opcodes.FNEG, 112, -1, insnFormat12, false);
        INVOKE_DIRECT_RANGE = dop113;
        Dop dop114 = new Dop(Opcodes.DNEG, 113, -1, insnFormat12, false);
        INVOKE_STATIC_RANGE = dop114;
        Dop dop115 = new Dop(Opcodes.ISHL, 114, -1, insnFormat12, false);
        INVOKE_INTERFACE_RANGE = dop115;
        Dop dop116 = new Dop(Opcodes.LSHR, Opcodes.LSHR, -1, insnFormat2, true);
        NEG_INT = dop116;
        Dop dop117 = new Dop(Opcodes.IUSHR, Opcodes.IUSHR, -1, insnFormat2, true);
        NOT_INT = dop117;
        Dop dop118 = new Dop(Opcodes.LUSHR, Opcodes.LUSHR, -1, insnFormat2, true);
        NEG_LONG = dop118;
        ...
        NEG_DOUBLE = dop121;
        Dop dop122 = new Dop(Opcodes.LOR, Opcodes.LOR, -1, insnFormat2, true);
        INT_TO_LONG = dop122;
        Dop dop123 = new Dop(Opcodes.IXOR, Opcodes.IXOR, -1, insnFormat2, true);
        INT_TO_FLOAT = dop123;
        Dop dop124 = new Dop(Opcodes.LXOR, Opcodes.LXOR, -1, insnFormat2, true);
        INT_TO_DOUBLE = dop124;
        Dop dop125 = new Dop(Opcodes.IINC, Opcodes.IINC, -1, insnFormat2, true);
        LONG_TO_INT = dop125;
        Dop dop126 = new Dop(Opcodes.I2L, Opcodes.I2L, -1, insnFormat2, true);
        LONG_TO_FLOAT = dop126;
        Dop dop127 = new Dop(Opcodes.I2F, Opcodes.I2F, -1, insnFormat2, true);
        LONG_TO_DOUBLE = dop127;
        Dop dop128 = new Dop(Opcodes.I2D, Opcodes.I2D, -1, insnFormat2, true);
        FLOAT_TO_INT = dop128;
        Dop dop129 = new Dop(Opcodes.L2I, Opcodes.L2I, -1, insnFormat2, true);
        FLOAT_TO_LONG = dop129;
        Dop dop130 = new Dop(Opcodes.L2F, Opcodes.L2F, -1, insnFormat2, true);
        FLOAT_TO_DOUBLE = dop130;
        Dop dop131 = new Dop(Opcodes.L2D, Opcodes.L2D, -1, insnFormat2, true);
        DOUBLE_TO_INT = dop131;
        Dop dop132 = new Dop(Opcodes.F2I, Opcodes.F2I, -1, insnFormat2, true);
        DOUBLE_TO_LONG = dop132;
        Dop dop133 = new Dop(Opcodes.F2L, Opcodes.F2L, -1, insnFormat2, true);
        DOUBLE_TO_FLOAT = dop133;
        Dop dop134 = new Dop(Opcodes.F2D, Opcodes.F2D, -1, insnFormat2, true);
        INT_TO_BYTE = dop134;
        Dop dop135 = new Dop(Opcodes.D2I, Opcodes.D2I, -1, insnFormat2, true);
        INT_TO_CHAR = dop135;
        Dop dop136 = new Dop(Opcodes.D2L, Opcodes.D2L, -1, insnFormat2, true);
        INT_TO_SHORT = dop136;
        Dop dop137 = new Dop(Opcodes.D2F, Opcodes.D2F, -1, insnFormat14, true);
        ADD_INT = dop137;
        Dop dop138 = new Dop(Opcodes.I2B, Opcodes.I2B, -1, insnFormat14, true);
        SUB_INT = dop138;
        Dop dop139 = new Dop(Opcodes.I2C, Opcodes.I2C, -1, insnFormat14, true);
        MUL_INT = dop139;
        Dop dop140 = new Dop(Opcodes.I2S, Opcodes.I2S, -1, insnFormat14, true);
        DIV_INT = dop140;
        Dop dop141 = new Dop(Opcodes.LCMP, Opcodes.LCMP, -1, insnFormat14, true);
        REM_INT = dop141;
        Dop dop142 = new Dop(Opcodes.FCMPL, Opcodes.FCMPL, -1, insnFormat14, true);
        AND_INT = dop142;
        Dop dop143 = new Dop(150, 150, -1, insnFormat14, true);
        OR_INT = dop143;
        Dop dop144 = new Dop(Opcodes.DCMPL, Opcodes.DCMPL, -1, insnFormat14, true);
        XOR_INT = dop144;
        Dop dop145 = new Dop(Opcodes.DCMPG, Opcodes.DCMPG, -1, insnFormat14, true);
        SHL_INT = dop145;
        Dop dop146 = new Dop(Opcodes.IFEQ, Opcodes.IFEQ, -1, insnFormat14, true);
        SHR_INT = dop146;
        Dop dop147 = new Dop(Opcodes.IFNE, Opcodes.IFNE, -1, insnFormat14, true);
        USHR_INT = dop147;
        Dop dop148 = new Dop(155, 155, -1, insnFormat14, true);
        ADD_LONG = dop148;
        Dop dop149 = new Dop(Opcodes.IFGE, Opcodes.IFGE, -1, insnFormat14, true);
        SUB_LONG = dop149;
        Dop dop150 = new Dop(Opcodes.IFGT, Opcodes.IFGT, -1, insnFormat14, true);
        MUL_LONG = dop150;
        Dop dop151 = new Dop(Opcodes.IFLE, Opcodes.IFLE, -1, insnFormat14, true);
        DIV_LONG = dop151;
        Dop dop152 = new Dop(Opcodes.IF_ICMPEQ, Opcodes.IF_ICMPEQ, -1, insnFormat14, true);
        REM_LONG = dop152;
        Dop dop153 = new Dop(Opcodes.IF_ICMPNE, Opcodes.IF_ICMPNE, -1, insnFormat14, true);
        AND_LONG = dop153;
        Dop dop154 = new Dop(Opcodes.IF_ICMPLT, Opcodes.IF_ICMPLT, -1, insnFormat14, true);
        OR_LONG = dop154;
        Dop dop155 = new Dop(Opcodes.IF_ICMPGE, Opcodes.IF_ICMPGE, -1, insnFormat14, true);
        XOR_LONG = dop155;
        Dop dop156 = new Dop(Opcodes.IF_ICMPGT, Opcodes.IF_ICMPGT, -1, insnFormat14, true);
        SHL_LONG = dop156;
        Dop dop157 = new Dop(Opcodes.IF_ICMPLE, Opcodes.IF_ICMPLE, -1, insnFormat14, true);
        SHR_LONG = dop157;
        Dop dop158 = new Dop(Opcodes.IF_ACMPEQ, Opcodes.IF_ACMPEQ, -1, insnFormat14, true);
        USHR_LONG = dop158;
        Dop dop159 = new Dop(Opcodes.IF_ACMPNE, Opcodes.IF_ACMPNE, -1, insnFormat14, true);
        ADD_FLOAT = dop159;
        Dop dop160 = new Dop(Opcodes.GOTO, Opcodes.GOTO, -1, insnFormat14, true);
        SUB_FLOAT = dop160;
        Dop dop161 = new Dop(168, 168, -1, insnFormat14, true);
        MUL_FLOAT = dop161;
        Dop dop162 = new Dop(Opcodes.RET, Opcodes.RET, -1, insnFormat14, true);
        DIV_FLOAT = dop162;
        Dop dop163 = new Dop(Opcodes.TABLESWITCH, Opcodes.TABLESWITCH, -1, insnFormat14, true);
        REM_FLOAT = dop163;
        Dop dop164 = new Dop(Opcodes.LOOKUPSWITCH, Opcodes.LOOKUPSWITCH, -1, insnFormat14, true);
        ADD_DOUBLE = dop164;
        Dop dop165 = new Dop(Opcodes.IRETURN, Opcodes.IRETURN, -1, insnFormat14, true);
        SUB_DOUBLE = dop165;
        Dop dop166 = new Dop(Opcodes.LRETURN, Opcodes.LRETURN, -1, insnFormat14, true);
        MUL_DOUBLE = dop166;
        Dop dop167 = new Dop(Opcodes.FRETURN, Opcodes.FRETURN, -1, insnFormat14, true);
        DIV_DOUBLE = dop167;
        Dop dop168 = new Dop(Opcodes.DRETURN, Opcodes.DRETURN, -1, insnFormat14, true);
        REM_DOUBLE = dop168;
        Dop dop169 = new Dop(Opcodes.ARETURN, Opcodes.D2F, Opcodes.D2F, insnFormat2, true);
        ADD_INT_2ADDR = dop169;
        Dop dop170 = new Dop(Opcodes.RETURN, Opcodes.I2B, Opcodes.I2B, insnFormat2, true);
        SUB_INT_2ADDR = dop170;
        Dop dop171 = new Dop(Opcodes.GETSTATIC, Opcodes.I2C, Opcodes.I2C, insnFormat2, true);
        MUL_INT_2ADDR = dop171;
        Dop dop172 = new Dop(Opcodes.PUTSTATIC, Opcodes.I2S, Opcodes.I2S, insnFormat2, true);
        DIV_INT_2ADDR = dop172;
        Dop dop173 = new Dop(Opcodes.GETFIELD, Opcodes.LCMP, Opcodes.LCMP, insnFormat2, true);
        REM_INT_2ADDR = dop173;
        Dop dop174 = new Dop(Opcodes.PUTFIELD, Opcodes.FCMPL, Opcodes.FCMPL, insnFormat2, true);
        AND_INT_2ADDR = dop174;
        Dop dop175 = new Dop(Opcodes.INVOKEVIRTUAL, 150, 150, insnFormat2, true);
        OR_INT_2ADDR = dop175;
        Dop dop176 = new Dop(Opcodes.INVOKESPECIAL, Opcodes.DCMPL, Opcodes.DCMPL, insnFormat2, true);
        XOR_INT_2ADDR = dop176;
        Dop dop177 = new Dop(Opcodes.INVOKESTATIC, Opcodes.DCMPG, Opcodes.DCMPG, insnFormat2, true);
        SHL_INT_2ADDR = dop177;
        Dop dop178 = new Dop(Opcodes.INVOKEINTERFACE, Opcodes.IFEQ, Opcodes.IFEQ, insnFormat2, true);
        SHR_INT_2ADDR = dop178;
        Dop dop179 = new Dop(Opcodes.INVOKEDYNAMIC, Opcodes.IFNE, Opcodes.IFNE, insnFormat2, true);
        USHR_INT_2ADDR = dop179;
        Dop dop180 = new Dop(Opcodes.NEW, 155, 155, insnFormat2, true);
        ADD_LONG_2ADDR = dop180;
        Dop dop181 = new Dop(Opcodes.NEWARRAY, Opcodes.IFGE, Opcodes.IFGE, insnFormat2, true);
        SUB_LONG_2ADDR = dop181;
        Dop dop182 = new Dop(Opcodes.ANEWARRAY, Opcodes.IFGT, Opcodes.IFGT, insnFormat2, true);
        MUL_LONG_2ADDR = dop182;
        Dop dop183 = new Dop(Opcodes.ARRAYLENGTH, Opcodes.IFLE, Opcodes.IFLE, insnFormat2, true);
        DIV_LONG_2ADDR = dop183;
        Dop dop184 = new Dop(Opcodes.ATHROW, Opcodes.IF_ICMPEQ, Opcodes.IF_ICMPEQ, insnFormat2, true);
        REM_LONG_2ADDR = dop184;
        Dop dop185 = new Dop(Opcodes.CHECKCAST, Opcodes.IF_ICMPNE, Opcodes.IF_ICMPNE, insnFormat2, true);
        AND_LONG_2ADDR = dop185;
        Dop dop186 = new Dop(Opcodes.INSTANCEOF, Opcodes.IF_ICMPLT, Opcodes.IF_ICMPLT, insnFormat2, true);
        OR_LONG_2ADDR = dop186;
        Dop dop187 = new Dop(Opcodes.MONITORENTER, Opcodes.IF_ICMPGE, Opcodes.IF_ICMPGE, insnFormat2, true);
        XOR_LONG_2ADDR = dop187;
        Dop dop188 = new Dop(Opcodes.MONITOREXIT, Opcodes.IF_ICMPGT, Opcodes.IF_ICMPGT, insnFormat2, true);
        SHL_LONG_2ADDR = dop188;
        Dop dop189 = new Dop(196, Opcodes.IF_ICMPLE, Opcodes.IF_ICMPLE, insnFormat2, true);
        SHR_LONG_2ADDR = dop189;
        Dop dop190 = new Dop(Opcodes.MULTIANEWARRAY, Opcodes.IF_ACMPEQ, Opcodes.IF_ACMPEQ, insnFormat2, true);
        USHR_LONG_2ADDR = dop190;
        Dop dop191 = new Dop(Opcodes.IFNULL, Opcodes.IF_ACMPNE, Opcodes.IF_ACMPNE, insnFormat2, true);
        ADD_FLOAT_2ADDR = dop191;
        Dop dop192 = new Dop(Opcodes.IFNONNULL, Opcodes.GOTO, Opcodes.GOTO, insnFormat2, true);
        SUB_FLOAT_2ADDR = dop192;
        Dop dop193 = new Dop(DataTypes.EMPTY, 168, 168, insnFormat2, true);
        MUL_FLOAT_2ADDR = dop193;
        Dop dop194 = new Dop(201, Opcodes.RET, Opcodes.RET, insnFormat2, true);
        DIV_FLOAT_2ADDR = dop194;
        Dop dop195 = new Dop(202, Opcodes.TABLESWITCH, Opcodes.TABLESWITCH, insnFormat2, true);
        REM_FLOAT_2ADDR = dop195;
        Dop dop196 = new Dop(VoIPService.ID_INCOMING_CALL_PRENOTIFICATION, Opcodes.LOOKUPSWITCH, Opcodes.LOOKUPSWITCH, insnFormat2, true);
        ADD_DOUBLE_2ADDR = dop196;
        Dop dop197 = new Dop(204, Opcodes.IRETURN, Opcodes.IRETURN, insnFormat2, true);
        SUB_DOUBLE_2ADDR = dop197;
        Dop dop198 = new Dop(205, Opcodes.LRETURN, Opcodes.LRETURN, insnFormat2, true);
        MUL_DOUBLE_2ADDR = dop198;
        Dop dop199 = new Dop(206, Opcodes.FRETURN, Opcodes.FRETURN, insnFormat2, true);
        DIV_DOUBLE_2ADDR = dop199;
        Dop dop200 = new Dop(207, Opcodes.DRETURN, Opcodes.DRETURN, insnFormat2, true);
        REM_DOUBLE_2ADDR = dop200;
        InsnFormat insnFormat17 = Form22s.THE_ONE;
        Dop dop201 = new Dop(208, Opcodes.D2F, -1, insnFormat17, true);
        ADD_INT_LIT16 = dop201;
        Dop dop202 = new Dop(209, 209, -1, insnFormat17, true);
        RSUB_INT = dop202;
        Dop dop203 = new Dop(210, Opcodes.I2C, -1, insnFormat17, true);
        MUL_INT_LIT16 = dop203;
        Dop dop204 = new Dop(211, Opcodes.I2S, -1, insnFormat17, true);
        DIV_INT_LIT16 = dop204;
        Dop dop205 = new Dop(212, Opcodes.LCMP, -1, insnFormat17, true);
        REM_INT_LIT16 = dop205;
        Dop dop206 = new Dop(213, Opcodes.FCMPL, -1, insnFormat17, true);
        AND_INT_LIT16 = dop206;
        Dop dop207 = new Dop(214, 150, -1, insnFormat17, true);
        OR_INT_LIT16 = dop207;
        Dop dop208 = new Dop(215, Opcodes.DCMPL, -1, insnFormat17, true);
        XOR_INT_LIT16 = dop208;
        InsnFormat insnFormat18 = Form22b.THE_ONE;
        Dop dop209 = new Dop(216, Opcodes.D2F, 208, insnFormat18, true);
        ADD_INT_LIT8 = dop209;
        Dop dop210 = new Dop(217, 209, 209, insnFormat18, true);
        RSUB_INT_LIT8 = dop210;
        Dop dop211 = new Dop(218, Opcodes.I2C, 210, insnFormat18, true);
        MUL_INT_LIT8 = dop211;
        Dop dop212 = new Dop(219, Opcodes.I2S, 211, insnFormat18, true);
        DIV_INT_LIT8 = dop212;
        Dop dop213 = new Dop(220, Opcodes.LCMP, 212, insnFormat18, true);
        REM_INT_LIT8 = dop213;
        Dop dop214 = new Dop(221, Opcodes.FCMPL, 213, insnFormat18, true);
        AND_INT_LIT8 = dop214;
        Dop dop215 = new Dop(222, 150, 214, insnFormat18, true);
        OR_INT_LIT8 = dop215;
        Dop dop216 = new Dop(223, Opcodes.DCMPL, 215, insnFormat18, true);
        XOR_INT_LIT8 = dop216;
        Dop dop217 = new Dop(224, Opcodes.DCMPG, -1, insnFormat18, true);
        SHL_INT_LIT8 = dop217;
        Dop dop218 = new Dop(225, Opcodes.IFEQ, -1, insnFormat18, true);
        SHR_INT_LIT8 = dop218;
        Dop dop219 = new Dop(226, Opcodes.IFNE, -1, insnFormat18, true);
        USHR_INT_LIT8 = dop219;
        Dop dop220 = new Dop(MediaDataController.MAX_LINKS_COUNT, MediaDataController.MAX_LINKS_COUNT, 251, Form45cc.THE_ONE, false);
        INVOKE_POLYMORPHIC = dop220;
        Dop dop221 = new Dop(251, MediaDataController.MAX_LINKS_COUNT, -1, Form4rcc.THE_ONE, false);
        ...
        Dop dop225 = new Dop(Function.USE_VARARGS, Function.USE_VARARGS, -1, insnFormat9, true);
