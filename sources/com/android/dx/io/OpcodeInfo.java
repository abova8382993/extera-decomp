...
public abstract class OpcodeInfo {
    ...
    static {
        ...
        Info info4 = new Info(ViewUtils.EDGE_TO_EDGE_FLAGS, "fill-array-data-payload", InstructionCodec.FORMAT_FILL_ARRAY_DATA_PAYLOAD, indexType);
        ...
        Info info115 = new Info(org.mvel2.asm.Opcodes.LNEG, "invoke-super/range", instructionCodec13, indexType5);
        INVOKE_SUPER_RANGE = info115;
        Info info116 = new Info(org.mvel2.asm.Opcodes.FNEG, "invoke-direct/range", instructionCodec13, indexType5);
        INVOKE_DIRECT_RANGE = info116;
        Info info117 = new Info(org.mvel2.asm.Opcodes.DNEG, "invoke-static/range", instructionCodec13, indexType5);
        INVOKE_STATIC_RANGE = info117;
        Info info118 = new Info(org.mvel2.asm.Opcodes.ISHL, "invoke-interface/range", instructionCodec13, indexType5);
        INVOKE_INTERFACE_RANGE = info118;
        Info info119 = new Info(org.mvel2.asm.Opcodes.LSHR, "neg-int", instructionCodec3, indexType);
        NEG_INT = info119;
        Info info120 = new Info(org.mvel2.asm.Opcodes.IUSHR, "not-int", instructionCodec3, indexType);
        NOT_INT = info120;
        Info info121 = new Info(org.mvel2.asm.Opcodes.LUSHR, "neg-long", instructionCodec3, indexType);
        NEG_LONG = info121;
        ...
        NEG_DOUBLE = info124;
        Info info125 = new Info(org.mvel2.asm.Opcodes.LOR, "int-to-long", instructionCodec3, indexType);
        INT_TO_LONG = info125;
        Info info126 = new Info(org.mvel2.asm.Opcodes.IXOR, "int-to-float", instructionCodec3, indexType);
        INT_TO_FLOAT = info126;
        Info info127 = new Info(org.mvel2.asm.Opcodes.LXOR, "int-to-double", instructionCodec3, indexType);
        INT_TO_DOUBLE = info127;
        Info info128 = new Info(org.mvel2.asm.Opcodes.IINC, "long-to-int", instructionCodec3, indexType);
        LONG_TO_INT = info128;
        Info info129 = new Info(org.mvel2.asm.Opcodes.I2L, "long-to-float", instructionCodec3, indexType);
        LONG_TO_FLOAT = info129;
        Info info130 = new Info(org.mvel2.asm.Opcodes.I2F, "long-to-double", instructionCodec3, indexType);
        LONG_TO_DOUBLE = info130;
        Info info131 = new Info(org.mvel2.asm.Opcodes.I2D, "float-to-int", instructionCodec3, indexType);
        FLOAT_TO_INT = info131;
        Info info132 = new Info(org.mvel2.asm.Opcodes.L2I, "float-to-long", instructionCodec3, indexType);
        FLOAT_TO_LONG = info132;
        Info info133 = new Info(org.mvel2.asm.Opcodes.L2F, "float-to-double", instructionCodec3, indexType);
        FLOAT_TO_DOUBLE = info133;
        Info info134 = new Info(org.mvel2.asm.Opcodes.L2D, "double-to-int", instructionCodec3, indexType);
        DOUBLE_TO_INT = info134;
        Info info135 = new Info(org.mvel2.asm.Opcodes.F2I, "double-to-long", instructionCodec3, indexType);
        DOUBLE_TO_LONG = info135;
        Info info136 = new Info(org.mvel2.asm.Opcodes.F2L, "double-to-float", instructionCodec3, indexType);
        DOUBLE_TO_FLOAT = info136;
        Info info137 = new Info(org.mvel2.asm.Opcodes.F2D, "int-to-byte", instructionCodec3, indexType);
        INT_TO_BYTE = info137;
        Info info138 = new Info(org.mvel2.asm.Opcodes.D2I, "int-to-char", instructionCodec3, indexType);
        INT_TO_CHAR = info138;
        Info info139 = new Info(org.mvel2.asm.Opcodes.D2L, "int-to-short", instructionCodec3, indexType);
        INT_TO_SHORT = info139;
        Info info140 = new Info(org.mvel2.asm.Opcodes.D2F, "add-int", instructionCodec15, indexType);
        ADD_INT = info140;
        Info info141 = new Info(org.mvel2.asm.Opcodes.I2B, "sub-int", instructionCodec15, indexType);
        SUB_INT = info141;
        Info info142 = new Info(org.mvel2.asm.Opcodes.I2C, "mul-int", instructionCodec15, indexType);
        MUL_INT = info142;
        Info info143 = new Info(org.mvel2.asm.Opcodes.I2S, "div-int", instructionCodec15, indexType);
        DIV_INT = info143;
        Info info144 = new Info(org.mvel2.asm.Opcodes.LCMP, "rem-int", instructionCodec15, indexType);
        REM_INT = info144;
        Info info145 = new Info(org.mvel2.asm.Opcodes.FCMPL, "and-int", instructionCodec15, indexType);
        AND_INT = info145;
        Info info146 = new Info(150, "or-int", instructionCodec15, indexType);
        OR_INT = info146;
        Info info147 = new Info(org.mvel2.asm.Opcodes.DCMPL, "xor-int", instructionCodec15, indexType);
        XOR_INT = info147;
        Info info148 = new Info(org.mvel2.asm.Opcodes.DCMPG, "shl-int", instructionCodec15, indexType);
        SHL_INT = info148;
        Info info149 = new Info(org.mvel2.asm.Opcodes.IFEQ, "shr-int", instructionCodec15, indexType);
        SHR_INT = info149;
        Info info150 = new Info(org.mvel2.asm.Opcodes.IFNE, "ushr-int", instructionCodec15, indexType);
        USHR_INT = info150;
        Info info151 = new Info(155, "add-long", instructionCodec15, indexType);
        ADD_LONG = info151;
        Info info152 = new Info(org.mvel2.asm.Opcodes.IFGE, "sub-long", instructionCodec15, indexType);
        SUB_LONG = info152;
        Info info153 = new Info(org.mvel2.asm.Opcodes.IFGT, "mul-long", instructionCodec15, indexType);
        MUL_LONG = info153;
        Info info154 = new Info(org.mvel2.asm.Opcodes.IFLE, "div-long", instructionCodec15, indexType);
        DIV_LONG = info154;
        Info info155 = new Info(org.mvel2.asm.Opcodes.IF_ICMPEQ, "rem-long", instructionCodec15, indexType);
        REM_LONG = info155;
        Info info156 = new Info(org.mvel2.asm.Opcodes.IF_ICMPNE, "and-long", instructionCodec15, indexType);
        AND_LONG = info156;
        Info info157 = new Info(org.mvel2.asm.Opcodes.IF_ICMPLT, "or-long", instructionCodec15, indexType);
        OR_LONG = info157;
        Info info158 = new Info(org.mvel2.asm.Opcodes.IF_ICMPGE, "xor-long", instructionCodec15, indexType);
        XOR_LONG = info158;
        Info info159 = new Info(org.mvel2.asm.Opcodes.IF_ICMPGT, "shl-long", instructionCodec15, indexType);
        SHL_LONG = info159;
        Info info160 = new Info(org.mvel2.asm.Opcodes.IF_ICMPLE, "shr-long", instructionCodec15, indexType);
        SHR_LONG = info160;
        Info info161 = new Info(org.mvel2.asm.Opcodes.IF_ACMPEQ, "ushr-long", instructionCodec15, indexType);
        USHR_LONG = info161;
        Info info162 = new Info(org.mvel2.asm.Opcodes.IF_ACMPNE, "add-float", instructionCodec15, indexType);
        ADD_FLOAT = info162;
        Info info163 = new Info(org.mvel2.asm.Opcodes.GOTO, "sub-float", instructionCodec15, indexType);
        SUB_FLOAT = info163;
        Info info164 = new Info(168, "mul-float", instructionCodec15, indexType);
        MUL_FLOAT = info164;
        Info info165 = new Info(org.mvel2.asm.Opcodes.RET, "div-float", instructionCodec15, indexType);
        DIV_FLOAT = info165;
        Info info166 = new Info(org.mvel2.asm.Opcodes.TABLESWITCH, "rem-float", instructionCodec15, indexType);
        REM_FLOAT = info166;
        Info info167 = new Info(org.mvel2.asm.Opcodes.LOOKUPSWITCH, "add-double", instructionCodec15, indexType);
        ADD_DOUBLE = info167;
        Info info168 = new Info(org.mvel2.asm.Opcodes.IRETURN, "sub-double", instructionCodec15, indexType);
        SUB_DOUBLE = info168;
        Info info169 = new Info(org.mvel2.asm.Opcodes.LRETURN, "mul-double", instructionCodec15, indexType);
        MUL_DOUBLE = info169;
        Info info170 = new Info(org.mvel2.asm.Opcodes.FRETURN, "div-double", instructionCodec15, indexType);
        DIV_DOUBLE = info170;
        Info info171 = new Info(org.mvel2.asm.Opcodes.DRETURN, "rem-double", instructionCodec15, indexType);
        REM_DOUBLE = info171;
        Info info172 = new Info(org.mvel2.asm.Opcodes.ARETURN, "add-int/2addr", instructionCodec3, indexType);
        ADD_INT_2ADDR = info172;
        Info info173 = new Info(org.mvel2.asm.Opcodes.RETURN, "sub-int/2addr", instructionCodec3, indexType);
        SUB_INT_2ADDR = info173;
        Info info174 = new Info(org.mvel2.asm.Opcodes.GETSTATIC, "mul-int/2addr", instructionCodec3, indexType);
        MUL_INT_2ADDR = info174;
        Info info175 = new Info(org.mvel2.asm.Opcodes.PUTSTATIC, "div-int/2addr", instructionCodec3, indexType);
        DIV_INT_2ADDR = info175;
        Info info176 = new Info(org.mvel2.asm.Opcodes.GETFIELD, "rem-int/2addr", instructionCodec3, indexType);
        REM_INT_2ADDR = info176;
        Info info177 = new Info(org.mvel2.asm.Opcodes.PUTFIELD, "and-int/2addr", instructionCodec3, indexType);
        AND_INT_2ADDR = info177;
        Info info178 = new Info(org.mvel2.asm.Opcodes.INVOKEVIRTUAL, "or-int/2addr", instructionCodec3, indexType);
        OR_INT_2ADDR = info178;
        Info info179 = new Info(org.mvel2.asm.Opcodes.INVOKESPECIAL, "xor-int/2addr", instructionCodec3, indexType);
        XOR_INT_2ADDR = info179;
        Info info180 = new Info(org.mvel2.asm.Opcodes.INVOKESTATIC, "shl-int/2addr", instructionCodec3, indexType);
        SHL_INT_2ADDR = info180;
        Info info181 = new Info(org.mvel2.asm.Opcodes.INVOKEINTERFACE, "shr-int/2addr", instructionCodec3, indexType);
        SHR_INT_2ADDR = info181;
        Info info182 = new Info(org.mvel2.asm.Opcodes.INVOKEDYNAMIC, "ushr-int/2addr", instructionCodec3, indexType);
        USHR_INT_2ADDR = info182;
        Info info183 = new Info(org.mvel2.asm.Opcodes.NEW, "add-long/2addr", instructionCodec3, indexType);
        ADD_LONG_2ADDR = info183;
        Info info184 = new Info(org.mvel2.asm.Opcodes.NEWARRAY, "sub-long/2addr", instructionCodec3, indexType);
        SUB_LONG_2ADDR = info184;
        Info info185 = new Info(org.mvel2.asm.Opcodes.ANEWARRAY, "mul-long/2addr", instructionCodec3, indexType);
        MUL_LONG_2ADDR = info185;
        Info info186 = new Info(org.mvel2.asm.Opcodes.ARRAYLENGTH, "div-long/2addr", instructionCodec3, indexType);
        DIV_LONG_2ADDR = info186;
        Info info187 = new Info(org.mvel2.asm.Opcodes.ATHROW, "rem-long/2addr", instructionCodec3, indexType);
        REM_LONG_2ADDR = info187;
        Info info188 = new Info(org.mvel2.asm.Opcodes.CHECKCAST, "and-long/2addr", instructionCodec3, indexType);
        AND_LONG_2ADDR = info188;
        Info info189 = new Info(org.mvel2.asm.Opcodes.INSTANCEOF, "or-long/2addr", instructionCodec3, indexType);
        OR_LONG_2ADDR = info189;
        Info info190 = new Info(org.mvel2.asm.Opcodes.MONITORENTER, "xor-long/2addr", instructionCodec3, indexType);
        XOR_LONG_2ADDR = info190;
        Info info191 = new Info(org.mvel2.asm.Opcodes.MONITOREXIT, "shl-long/2addr", instructionCodec3, indexType);
        SHL_LONG_2ADDR = info191;
        Info info192 = new Info(196, "shr-long/2addr", instructionCodec3, indexType);
        SHR_LONG_2ADDR = info192;
        Info info193 = new Info(org.mvel2.asm.Opcodes.MULTIANEWARRAY, "ushr-long/2addr", instructionCodec3, indexType);
        USHR_LONG_2ADDR = info193;
        Info info194 = new Info(org.mvel2.asm.Opcodes.IFNULL, "add-float/2addr", instructionCodec3, indexType);
        ADD_FLOAT_2ADDR = info194;
        Info info195 = new Info(org.mvel2.asm.Opcodes.IFNONNULL, "sub-float/2addr", instructionCodec3, indexType);
        SUB_FLOAT_2ADDR = info195;
        Info info196 = new Info(DataTypes.EMPTY, "mul-float/2addr", instructionCodec3, indexType);
        ...
        Info info199 = new Info(VoIPService.ID_INCOMING_CALL_PRENOTIFICATION, "add-double/2addr", instructionCodec3, indexType);
        ...
        Info info223 = new Info(MediaDataController.MAX_LINKS_COUNT, "invoke-polymorphic", instructionCodec20, indexType6);
        ...
        Info info228 = new Info(Function.USE_VARARGS, "const-method-type", instructionCodec10, IndexType.PROTO_REF);
