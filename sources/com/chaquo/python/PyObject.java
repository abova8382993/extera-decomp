...
public class PyObject extends AbstractMap<String, PyObject> implements AutoCloseable {
    ...
    public class C10261 extends AbstractSet<Map.Entry<String, PyObject>> {
        public C10261() {
        }
        ...
        /* JADX INFO: renamed from: com.chaquo.python.PyObject$1$1 */
        public class AnonymousClass1 implements Iterator<Map.Entry<String, PyObject>> {
            ...
            public boolean hasNext() {
                return this.f203i < this.keys.size();
            }

            /* JADX INFO: renamed from: com.chaquo.python.PyObject$1$1$1 */
            public class C76281 implements Map.Entry<String, PyObject> {
                String key;

                public C76281() {
                    this.key = AnonymousClass1.this.keys.get(AnonymousClass1.this.f203i);
                }
            ...
            public Map.Entry<String, PyObject> next() {
                ...
                C76281 c76281 = new Map.Entry<String, PyObject>() { // from class: com.chaquo.python.PyObject.1.1.1
                    String key;
            ...
            @Override // java.util.Iterator
            public void remove() {
                PyObject.this.remove((Object) this.keys.get(this.f203i - 1));
            }
        }
