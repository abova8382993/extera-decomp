package com.exteragram.messenger.speech.p016ui;
...
public class LoadingModelView extends FrameLayout {
    ...
    public LoadingModelView(Context context) {
        ...
        this.title.setText(LocaleController.getString(C2888R.string.DownloadingModel));
        ...
        this.subtitle.setText(LocaleController.getString(C2888R.string.DownloadingModelInfo));
    ...
    public void setProgress(float f) {
        ...
        this.percentsTextView.setText(iCeil == 100 ? LocaleController.getString(C2888R.string.ModelUnzipping) : String.format("%s%%", Integer.valueOf(iCeil)), !LocaleController.isRTL);
    ...
    static class ProgressView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawRoundRect(rectF, AndroidUtilities.m1124dp(3.0f), AndroidUtilities.m1124dp(3.0f), this.f302in);
        }
    }
}
