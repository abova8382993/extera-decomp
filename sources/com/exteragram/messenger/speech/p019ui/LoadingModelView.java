...
public class LoadingModelView extends FrameLayout {
    ...
    public LoadingModelView(Context context) {
        ...
        this.title.setText(LocaleController.getString(C2797R.string.DownloadingModel));
        ...
        this.subtitle.setText(LocaleController.getString(C2797R.string.DownloadingModelInfo));
    ...
    public void setProgress(float f) {
        ...
        this.percentsTextView.setText(iCeil == 100 ? LocaleController.getString(C2797R.string.ModelUnzipping) : String.format("%s%%", Integer.valueOf(iCeil)), !LocaleController.isRTL);
    ...
    public static class ProgressView extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            canvas.drawRoundRect(rectF, AndroidUtilities.m1036dp(3.0f), AndroidUtilities.m1036dp(3.0f), this.f350in);
        }
    }
}
