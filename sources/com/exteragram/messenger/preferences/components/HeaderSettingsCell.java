...
public class HeaderSettingsCell extends LinearLayout implements CustomPreferenceCell {
    ...
    public HeaderSettingsCell(Context context) {
        ...
        setOrientation(1);
        setGravity(17);
        Drawable drawableMutate = ContextCompat.getDrawable(context, C2888R.drawable.ic_foreground).mutate();
        Theme.ThemeInfo activeTheme = Theme.getActiveTheme();
        int color = ContextCompat.getColor(context, C2888R.color.ic_background);
        if (activeTheme.isMonet() && Build.VERSION.SDK_INT >= 31) {
            color = MonetUtils.getColor(activeTheme.isDark() ? "a2_800" : "a1_100");
            drawableMutate = ContextCompat.getDrawable(context, C2888R.drawable.ic_foreground_solid).mutate();
        ...
        textView.setText(LocaleController.getString(C2888R.string.exteraAppName));
        textView.setLines(1);
