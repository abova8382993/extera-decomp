...
import org.telegram.p035ui.Cells.ProfileChannelCell;
...
public class AvatarCornersPreviewCell extends FrameLayout implements CustomPreferenceCell {
    ...
    public AvatarCornersPreviewCell(Context context, final BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider, int i) {
        ...
        }, 0, 28, LocaleController.getString(C2797R.string.AvatarCorners), LocaleController.getString(C2797R.string.AvatarCornersLeft), LocaleController.getString(C2797R.string.AvatarCornersRight));
        ...
        if (mode == mode2) {
            ...
            initMockMode();
            frameLayout.setMinimumHeight(AndroidUtilities.m1036dp(83.0f));
        }
    ...
    public void drawMock(Canvas canvas) {
        ...
        float fM1036dp2 = AndroidUtilities.m1036dp(15.0f);
        float fM1036dp3 = AndroidUtilities.m1036dp(83.0f);
        int iM1036dp = AndroidUtilities.m1036dp(56.0f);
        float width = this.preview.getWidth();
        RectF rectF = AndroidUtilities.rectTmp;
        float fM1036dp4 = AndroidUtilities.m1036dp(12.0f) + fM1036dp;
        float f = iM1036dp;
        float f2 = fM1036dp2 + f;
        float f3 = f + fM1036dp4;
        rectF.set(fM1036dp2, fM1036dp4, f2, f3);
        ...
        float fM1036dp5 = AndroidUtilities.m1036dp(4.0f);
        rectF.set(AndroidUtilities.m1036dp(6.0f) + fM1036dp3, AndroidUtilities.m1036dp(16.0f) + fM1036dp, AndroidUtilities.m1036dp(6.0f) + fM1036dp3 + (0.4f * width), AndroidUtilities.m1036dp(24.33f) + fM1036dp);
        canvas.drawRoundRect(rectF, fM1036dp5, fM1036dp5, this.brightMockPaint);
        rectF.set(AndroidUtilities.m1036dp(6.0f) + fM1036dp3, AndroidUtilities.m1036dp(38.0f) + fM1036dp, AndroidUtilities.m1036dp(6.0f) + fM1036dp3 + (0.5f * width), AndroidUtilities.m1036dp(46.33f) + fM1036dp);
        canvas.drawRoundRect(rectF, fM1036dp5, fM1036dp5, this.mockPaint);
        rectF.set(AndroidUtilities.m1036dp(6.0f) + fM1036dp3, AndroidUtilities.m1036dp(56.0f) + fM1036dp, fM1036dp3 + AndroidUtilities.m1036dp(6.0f) + (0.36f * width), AndroidUtilities.m1036dp(64.33f) + fM1036dp);
        canvas.drawRoundRect(rectF, fM1036dp5, fM1036dp5, this.mockPaint);
        rectF.set((width - AndroidUtilities.m1036dp(16.0f)) - AndroidUtilities.m1036dp(43.0f), AndroidUtilities.m1036dp(16.0f) + fM1036dp, width - AndroidUtilities.m1036dp(16.0f), fM1036dp + AndroidUtilities.m1036dp(24.33f));
        canvas.drawRoundRect(rectF, fM1036dp5, fM1036dp5, this.mockPaint);
    }
    ...
    public void drawLoading(Canvas canvas) {
        ...
        if (f > 0.0f) {
            ...
            int iM1036dp = AndroidUtilities.m1036dp(56.0f);
            float x = this.dialogCell.getX() + AndroidUtilities.m1036dp(this.dialogCell.avatarStart);
            float y = this.dialogCell.getY() + AndroidUtilities.m1036dp(12.0f);
            ...
            rectF.set(this.dialogCell.getX() + AndroidUtilities.m1036dp(this.dialogCell.messagePaddingStart + 6), this.dialogCell.getY() + AndroidUtilities.m1036dp(16.0f), this.dialogCell.getX() + AndroidUtilities.m1036dp(this.dialogCell.messagePaddingStart + 6) + (getWidth() * 0.4f), this.dialogCell.getY() + AndroidUtilities.m1036dp(24.33f));
            this.loadingDrawable.setBounds(rectF);
            this.loadingDrawable.draw(canvas);
            z = true;
        } else {
        ...
        if (f2 > 0.0f) {
            ...
            rectF2.set(this.dialogCell.getX() + AndroidUtilities.m1036dp(this.dialogCell.messagePaddingStart + 6), this.dialogCell.getY() + AndroidUtilities.m1036dp(38.0f), this.dialogCell.getX() + AndroidUtilities.m1036dp(this.dialogCell.messagePaddingStart + 6) + (getWidth() * 0.5f), this.dialogCell.getY() + AndroidUtilities.m1036dp(46.33f));
            this.loadingDrawable.setBounds(rectF2);
            this.loadingDrawable.draw(canvas);
            rectF2.set(this.dialogCell.getX() + AndroidUtilities.m1036dp(this.dialogCell.messagePaddingStart + 6), this.dialogCell.getY() + AndroidUtilities.m1036dp(56.0f), this.dialogCell.getX() + AndroidUtilities.m1036dp(this.dialogCell.messagePaddingStart + 6) + (getWidth() * 0.36f), this.dialogCell.getY() + AndroidUtilities.m1036dp(64.33f));
            this.loadingDrawable.setBounds(rectF2);
            this.loadingDrawable.draw(canvas);
            rectF2.set(((this.dialogCell.getX() + this.dialogCell.getWidth()) - AndroidUtilities.m1036dp(16.0f)) - AndroidUtilities.m1036dp(43.0f), this.dialogCell.getY() + AndroidUtilities.m1036dp(12.0f), (this.dialogCell.getX() + this.dialogCell.getWidth()) - AndroidUtilities.m1036dp(16.0f), this.dialogCell.getY() + AndroidUtilities.m1036dp(20.33f));
            this.loadingDrawable.setBounds(rectF2);
            this.loadingDrawable.draw(canvas);
        } else {
            z2 = z;
