...
public class DrawerHeaderView extends FrameLayout {
    ...
    public DrawerHeaderView(Context context) {
        ...
        frameLayout.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1124dp(18.0f), getThemeToggleBackgroundColor()));
        addView(frameLayout, LayoutHelper.createFrame(36, 36.0f, 53, 0.0f, 16.0f, 16.0f, 0.0f));
        int i = C2888R.raw.sun;
        RLottieDrawable rLottieDrawable = new RLottieDrawable(i, String.valueOf(i), AndroidUtilities.m1124dp(24.0f), AndroidUtilities.m1124dp(24.0f), true, null);
        ...
        frameLayout2.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1124dp(18.0f), getThemeToggleBackgroundColor()));
        ...
        linearLayout.setPadding(AndroidUtilities.m1124dp(6.0f), 0, AndroidUtilities.m1124dp(6.0f), 0);
        ...
        animatedTextView.setPadding(AndroidUtilities.m1124dp(2.0f), 0, AndroidUtilities.m1124dp(4.0f), 0);
        ...
        AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable swapAnimatedEmojiDrawable = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(simpleTextView, AndroidUtilities.m1124dp(22.0f));
        this.premiumStatusDrawable = swapAnimatedEmojiDrawable;
        AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable swapAnimatedEmojiDrawable2 = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(simpleTextView, AndroidUtilities.m1124dp(22.0f));
        ...
        frameLayout3.addView(textView, LayoutHelper.createFrame(-2, -2.0f, 51, 16.0f, 26.0f, 64.0f, 0.0f));
        ImageView imageView2 = new ImageView(context);
        this.chevronView = imageView2;
        imageView2.setImageResource(C2888R.drawable.msg_expand);
    ...
    public void updateUserInfo(BadgeDTO badgeDTO) {
        ...
        if (publicUsername != null && !publicUsername.isEmpty()) {
            this.subtitleView.setText("@" + publicUsername);
        } else {
            String str = currentUser.phone;
            if (str != null && !str.isEmpty()) {
                if (ExteraConfig.hidePhoneNumber) {
                    this.subtitleView.setText(LocaleController.getString(C2888R.string.MobileHidden));
                } else {
                    this.subtitleView.setText(PhoneFormat.getInstance().format("+" + currentUser.phone));
                }
            } else {
                this.subtitleView.setText(LocaleController.getString(C2888R.string.NumberUnknown));
            }
        }
        ...
        if (emojiStatusDocumentId != 0) {
            ...
            this.premiumStatusDrawable.set(PremiumGradient.getInstance().premiumStarDrawableMini, true);
        } else {
            this.premiumStatusDrawable.set((Drawable) null, true);
        }
    ...
    public void updateProxyStatus() {
        ...
        if (i > 0) {
            this.proxyButton.setVisibility(0);
            if (i == 2) {
                this.proxyTextView.setVisibility(0);
                this.proxyTextView.setText(LocaleController.formatString(C2888R.string.NavigationDrawerProxyPingShort, Long.valueOf(jClamp)), true);
            } else {
                this.proxyTextView.setVisibility(8);
            }
            ...
            if (color != this.lastProxyColor) {
                ...
                this.proxyButton.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1124dp(18.0f), Theme.multAlpha(color, 0.075f)));
            ...
            this.proxyIcon.setImageResource((zIsProxyEnabled && z) ? C2888R.drawable.drawer_proxy_on : C2888R.drawable.drawer_proxy_off);
            return;
        }
        this.proxyButton.setVisibility(8);
    }
    ...
    public void updateColors() {
        ...
        this.themeToggleBg.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1124dp(18.0f), getThemeToggleBackgroundColor()));
        this.lastProxyState = -1;
        this.lastProxyColor = -1;
        updateUserInfo();
