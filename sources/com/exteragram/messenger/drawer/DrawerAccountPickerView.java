...
public class DrawerAccountPickerView extends FrameLayout {
    ...
    public DrawerAccountPickerView(Context context) {
        ...
        this.cornerRadius = AndroidUtilities.m1036dp(16.0f);
        ...
        C10871 c10871 = new FrameLayout(context) { // from class: com.exteragram.messenger.drawer.DrawerAccountPickerView.1
            public C10871(Context context2) {
                super(context2);
            }
            ...
            public void onMeasure(int i, int i2) {
                ...
                int iM1036dp = (int) ((AndroidUtilities.m1036dp(48.0f) * (itemCount <= 6 ? itemCount : 5.5f)) + (AndroidUtilities.m1036dp(4.0f) * 2));
                int size = View.MeasureSpec.getSize(i);
                measureChildren(View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(iM1036dp, TLObject.FLAG_30));
                ...
                if (View.MeasureSpec.getMode(i2) == 0 || size2 > iM1036dp) {
                    i2 = View.MeasureSpec.makeMeasureSpec(iM1036dp, Integer.MIN_VALUE);
                }
            ...
            public void dispatchDraw(Canvas canvas) {
                ...
                if (DrawerAccountPickerView.this.topGradient == null || getHeight() != DrawerAccountPickerView.this.lastHeight) {
                    ...
                    drawerAccountPickerView.topGradient = new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.m1036dp(16.0f), new int[]{-16777216, 0}, (float[]) null, tileMode);
                    DrawerAccountPickerView.this.topGradientPaint.setShader(DrawerAccountPickerView.this.topGradient);
                    DrawerAccountPickerView.this.bottomGradient = new LinearGradient(0.0f, getHeight(), 0.0f, getHeight() - AndroidUtilities.m1036dp(16.0f), new int[]{-16777216, 0}, (float[]) null, tileMode);
                ...
                if (fMin > 0.0f) {
                    ...
                    canvas.drawRect(0.0f, 0.0f, getWidth(), AndroidUtilities.m1036dp(16.0f), DrawerAccountPickerView.this.topGradientPaint);
                }
                if (fMin2 > 0.0f) {
                    DrawerAccountPickerView.this.bottomGradientPaint.setAlpha((int) (fMin2 * 255.0f));
                    canvas2 = canvas;
                    canvas2.drawRect(0.0f, getHeight() - AndroidUtilities.m1036dp(16.0f), getWidth(), getHeight(), DrawerAccountPickerView.this.bottomGradientPaint);
                } else {
                    canvas2 = canvas;
                }
        ...
        this.clipWrapper = c10871;
        c10871.setOutlineProvider(new ViewOutlineProvider() { // from class: com.exteragram.messenger.drawer.DrawerAccountPickerView.2
            public C10882() {
            }
        ...
        c10871.setClipToOutline(true);
        addView(c10871, LayoutHelper.createFrame(-1, 0.0f, 48, 12.0f, 0.0f, 12.0f, 0.0f));
        ...
        recyclerView.setPadding(iM1036dp, iM1036dp, iM1036dp, iM1036dp);
        ...
        recyclerView.addItemDecoration(new RecyclerView.ItemDecoration() { // from class: com.exteragram.messenger.drawer.DrawerAccountPickerView.3
            final /* synthetic */ int val$itemInset;

            public C10893(int iM1036dp2) {
                i = iM1036dp2;
            }
        ...
        c10871.addView(recyclerView, LayoutHelper.createFrame(-1, -2.0f));
        ItemTouchHelper itemTouchHelper = new ItemTouchHelper(new ItemTouchHelper.Callback() { // from class: com.exteragram.messenger.drawer.DrawerAccountPickerView.5
            final /* synthetic */ RecyclerView.ChildDrawingOrderCallback val$dragDrawingOrderCallback;
            ...
            public C10915(RecyclerView.ChildDrawingOrderCallback childDrawingOrderCallback) {
        ...
        if (this.expanded) {
            loadAccounts();
            setVisibility(0);
            ViewGroup.LayoutParams layoutParams = c10871.getLayoutParams();
            layoutParams.height = -2;
            c10871.setLayoutParams(layoutParams);
            return;
        }
        setVisibility(8);
    }

    /* JADX INFO: renamed from: com.exteragram.messenger.drawer.DrawerAccountPickerView$1 */
    public class C10871 extends FrameLayout {
        public C10871(Context context2) {
            super(context2);
        }
    ...
    /* JADX INFO: renamed from: com.exteragram.messenger.drawer.DrawerAccountPickerView$2 */
    public class C10882 extends ViewOutlineProvider {
        public C10882() {
        }
    ...
    /* JADX INFO: renamed from: com.exteragram.messenger.drawer.DrawerAccountPickerView$3 */
    public class C10893 extends RecyclerView.ItemDecoration {
        final /* synthetic */ int val$itemInset;
    ...
    /* JADX INFO: renamed from: com.exteragram.messenger.drawer.DrawerAccountPickerView$4 */
    public class C10904 extends RecyclerView.OnScrollListener {
        public C10904() {
        }
    ...
    /* JADX INFO: renamed from: com.exteragram.messenger.drawer.DrawerAccountPickerView$5 */
    public class C10915 extends ItemTouchHelper.Callback {
        final /* synthetic */ RecyclerView.ChildDrawingOrderCallback val$dragDrawingOrderCallback;
    ...
    public void loadAccounts(BadgeDTO badgeDTO) {
        ...
        this.accounts.sort(Comparator.comparingLong(new ToLongFunction() { // from class: com.exteragram.messenger.drawer.DrawerAccountPickerView$$ExternalSyntheticLambda2
            ...
            public final long applyAsLong(java.lang.Object r1) {
                /*
                    ...
                    long r0 = com.exteragram.messenger.drawer.DrawerAccountPickerView.$r8$lambda$yjWCo34d2ZmtiGQ94EotqdxDScQ(r1)
                    return r0
                */
    ...
    public void setExpanded(boolean z) {
        ...
        this.clipWrapper.measure(View.MeasureSpec.makeMeasureSpec(((View) getParent()).getMeasuredWidth() - AndroidUtilities.m1036dp(24.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec((int) ((AndroidUtilities.m1036dp(48.0f) * (itemCount <= 6 ? itemCount : 5.5f)) + (AndroidUtilities.m1036dp(4.0f) * 2)), Integer.MIN_VALUE));
    ...
    /* JADX INFO: renamed from: com.exteragram.messenger.drawer.DrawerAccountPickerView$6 */
    /* JADX INFO: loaded from: classes4.dex */
    public class C10926 extends AnimatorListenerAdapter {
        private boolean cancelled;
    ...
    public static Drawable createSelectedAccountBackgroundDrawable() {
        return Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1036dp(12.0f), Theme.getColor(COLOR_KEY_SURFACE), Theme.getColor(COLOR_KEY_SELECTOR));
    }

    public class AccountAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        public /* synthetic */ AccountAdapter(DrawerAccountPickerView drawerAccountPickerView, DrawerAccountPickerViewIA drawerAccountPickerViewIA) {
            this();
        }
        ...
        /* JADX INFO: renamed from: com.exteragram.messenger.drawer.DrawerAccountPickerView$AccountAdapter$1 */
        public class C10931 extends RecyclerView.ViewHolder {
            public C10931(View view) {
                super(view);
            }
        }

        /* JADX INFO: renamed from: com.exteragram.messenger.drawer.DrawerAccountPickerView$AccountAdapter$2 */
        public class C10942 extends RecyclerView.ViewHolder {
            public C10942(View view) {
                super(view);
            }
        }
    ...
    public static class AccountRowView extends FrameLayout {
        ...
        public AccountRowView(Context context) {
            ...
            setLayoutParams(new RecyclerView.LayoutParams(-1, AndroidUtilities.m1036dp(44.0f)));
            setBackground(DrawerAccountPickerView.createAccountItemRippleDrawable());
            AvatarDrawable avatarDrawable = new AvatarDrawable();
            this.avatarDrawable = avatarDrawable;
            avatarDrawable.setTextSize(AndroidUtilities.m1036dp(20.0f));
            ...
            this.premiumStatusDrawable = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(simpleTextView, AndroidUtilities.m1036dp(18.0f));
            this.exteraBadgeDrawable = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(simpleTextView, AndroidUtilities.m1036dp(18.0f));
            this.unreadBadge = new DrawerAccountUnreadBadge();
            paint.setStyle(Paint.Style.STROKE);
            paint.setStrokeWidth(AndroidUtilities.m1036dp(1.67f));
    ...
    public static class AddAccountView extends LinearLayout {
        ...
        public AddAccountView(Context context) {
            ...
            Drawable drawable = ResourcesCompat.getDrawable(context.getResources(), C2797R.drawable.poll_add_circle, null);
            this.circleDrawable = drawable;
            Drawable drawable2 = ResourcesCompat.getDrawable(context.getResources(), C2797R.drawable.poll_add_plus, null);
            ...
            C10951 c10951 = new CombinedDrawable(drawable, drawable2) { // from class: com.exteragram.messenger.drawer.DrawerAccountPickerView.AddAccountView.1
                @Override // org.telegram.p035ui.Components.CombinedDrawable, android.graphics.drawable.Drawable
                public void setColorFilter(ColorFilter colorFilter) {
                }

                public C10951(Drawable drawable3, Drawable drawable22) {
                    super(drawable3, drawable22);
                }
            };
            c10951.setCustomSize(AndroidUtilities.m1036dp(24.0f), AndroidUtilities.m1036dp(24.0f));
            imageView.setImageDrawable(c10951);
            ...
            simpleTextView.setTypeface(AndroidUtilities.bold());
            simpleTextView.setGravity(19);
            simpleTextView.setText(LocaleController.getString(C2797R.string.AddAccount));
            addView(simpleTextView, LayoutHelper.createLinear(-2, -1, 16, 12, 0, 12, 0));
            updateColors();
        }

        /* JADX INFO: renamed from: com.exteragram.messenger.drawer.DrawerAccountPickerView$AddAccountView$1 */
        public class C10951 extends CombinedDrawable {
            @Override // org.telegram.p035ui.Components.CombinedDrawable, android.graphics.drawable.Drawable
            public void setColorFilter(ColorFilter colorFilter) {
            }
