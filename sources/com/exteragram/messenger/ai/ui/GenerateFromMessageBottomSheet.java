...
public class GenerateFromMessageBottomSheet extends BottomSheet {
    ...
    public static final class GenerationData extends RecordTag {
        ...
        public final int hashCode() {
            return GenerateFromMessageBottomSheet$GenerationData$$ExternalSyntheticRecord1.m(this.useHistory, this.prompt, this.imagePath);
        }
        ...
        public final String toString() {
            return GenerateFromMessageBottomSheet$GenerationData$$ExternalSyntheticRecord0.m($record$getFieldsAsObjects(), GenerationData.class, "prompt;useHistory;imagePath");
        }
