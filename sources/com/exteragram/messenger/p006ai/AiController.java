...
import p019j$.util.DesugarCollections;
...
public class AiController {
    ...
    public static void clearHistory(final BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider, boolean z) {
        ...
        if (z) {
            ...
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.getString(C2702R.string.ClearConversationHistoryInfo)));
            builder.setTitle(LocaleController.getString(C2702R.string.ClearHistory));
            builder.setNegativeButton(LocaleController.getString(C2702R.string.Cancel), null);
            builder.setPositiveButton(LocaleController.getString(C2702R.string.ClearButton), new AlertDialog.OnButtonClickListener() { // from class: com.exteragram.messenger.ai.AiController$$ExternalSyntheticLambda0
        ...
        BulletinFactory.m1195of(baseFragment).createSimpleBulletin(C2702R.raw.ic_delete, LocaleController.getString(C2702R.string.HistoryCleared)).show();
    }
    ...
    private static void showErrorBulletin(BaseFragment baseFragment, ViewGroup viewGroup, Theme.ResourcesProvider resourcesProvider, int i) {
        ...
        final int i3;
        final int i4;
        final BulletinFactory bulletinFactoryM1195of;
        if (i == 408) {
            i2 = C2702R.string.AIError408;
            i3 = C2702R.string.AIError408Info;
            i4 = 5;
        } else if (i != 429) {
            i4 = 3;
            if (i == 502) {
                i2 = C2702R.string.AIError502;
                i3 = C2702R.string.AIError502Info;
            } else if (i != 503) {
                switch (i) {
                    case 400:
                        i2 = C2702R.string.AIError400;
                        i3 = C2702R.string.AIError400Info;
                        i4 = 2;
                        break;
                    case 401:
                        i2 = C2702R.string.AIError401;
                        i3 = C2702R.string.AIError401Info;
                        break;
                    case 402:
                        i2 = C2702R.string.AIError402;
                        i3 = C2702R.string.AIError402Info;
                        i4 = 8;
                        break;
                    case 403:
                        i2 = C2702R.string.AIError403;
                        i3 = C2702R.string.AIError403Info;
                        i4 = 9;
                        break;
                    default:
                        i2 = C2702R.string.AIError;
                        i3 = C2702R.string.AIErrorInfo;
                        break;
                }
            } else {
                i2 = C2702R.string.AIError503;
                i3 = C2702R.string.AIError503Info;
            }
        } else {
            i2 = C2702R.string.AIError429;
            i3 = C2702R.string.AIError429Info;
            i4 = 6;
        }
        if (viewGroup != null) {
            bulletinFactoryM1195of = BulletinFactory.m1194of((FrameLayout) viewGroup, resourcesProvider);
        } else {
            bulletinFactoryM1195of = baseFragment != null ? BulletinFactory.m1195of(baseFragment) : BulletinFactory.global();
        }
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: com.exteragram.messenger.ai.AiController$$ExternalSyntheticLambda5
            ...
            public final void run() {
                bulletinFactoryM1195of.createSimpleBulletin(LocaleController.getString(i2), LocaleController.getString(i3), i4).show();
            }
        });
    }
    ...
    public void loadRoles() {
        ...
        Collection.EL.removeIf(this.roles, new Predicate() { // from class: com.exteragram.messenger.ai.AiController$$ExternalSyntheticLambda3
            ...
            public /* synthetic */ Predicate m185or(Predicate predicate) {
    ...
    public Service getSelected() {
        Optional optionalFindFirst = Collection.EL.stream(this.services).filter(new Predicate() { // from class: com.exteragram.messenger.ai.AiController$$ExternalSyntheticLambda2
            ...
            /* JADX INFO: renamed from: or */
            public /* synthetic */ Predicate m184or(Predicate predicate) {
                return Predicate$CC.$default$or(this, predicate);
            }
