...
public class EditServiceActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(currentService != null ? C2702R.string.EditService : C2702R.string.NewService));
        ...
        Pair pairCreateField = createField(context, LocaleController.getString(C2702R.string.ServiceURL), new InputFilter[]{new InputFilter.LengthFilter(128)});
        ...
        Pair pairCreateField2 = createField(context, LocaleController.getString(C2702R.string.ServiceModel), new InputFilter[]{new InputFilter.LengthFilter(64)});
        ...
        Pair pairCreateField3 = createField(context, LocaleController.getString(C2702R.string.ServiceKey), new InputFilter[]{new InputFilter.LengthFilter(256)});
        ...
        textView3.setBackground(Theme.createSimpleSelectorRoundRectDrawable(iM1081dp, color, Theme.getColor(i3)));
        ...
        spannableStringBuilder.setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m1081dp(4.0f)), 1, 2, 0);
        spannableStringBuilder.append((CharSequence) LocaleController.getString(R.string.paste));
        spannableStringBuilder.append((CharSequence) ".").setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m1081dp(3.0f)), spannableStringBuilder.length() - 1, spannableStringBuilder.length(), 0);
        this.pasteView.setText(spannableStringBuilder);
        this.pasteView.setPadding(AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(14.0f), AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(10.0f));
        ...
        this.deleteView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1081dp(8.0f), Theme.getColor(i2), Theme.getColor(i3)));
        SpannableStringBuilder spannableStringBuilder2 = new SpannableStringBuilder();
        spannableStringBuilder2.append((CharSequence) "..").setSpan(new ColoredImageSpan(ContextCompat.getDrawable(context, C2702R.drawable.msg_delete_filled)), 0, 1, 0);
        spannableStringBuilder2.setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m1081dp(4.0f)), 1, 2, 0);
        spannableStringBuilder2.append((CharSequence) LocaleController.getString(C2702R.string.Delete));
        spannableStringBuilder2.append((CharSequence) ".").setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m1081dp(3.0f)), spannableStringBuilder2.length() - 1, spannableStringBuilder2.length(), 0);
        this.deleteView.setText(spannableStringBuilder2);
        this.deleteView.setPadding(AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(14.0f), AndroidUtilities.m1081dp(10.0f), AndroidUtilities.m1081dp(10.0f));
    ...
    class C08901 extends ActionBar.ActionBarMenuOnItemClick {
        C08901() {
        }
    ...
    class C08912 implements TextWatcher {
        @Override // android.text.TextWatcher
        public void afterTextChanged(Editable editable) {
        }
    ...
    class C08923 implements TextWatcher {
        @Override // android.text.TextWatcher
        public void afterTextChanged(Editable editable) {
        }
    ...
    class C08934 implements TextWatcher {
        @Override // android.text.TextWatcher
        public void afterTextChanged(Editable editable) {
        }
    ...
    private Pair createField(Context context, String str, InputFilter[] inputFilterArr) {
        ...
        editTextBoldCursor.setPadding(0, iM1081dp, 0, iM1081dp);
        ...
        editTextBoldCursor.setMinHeight(AndroidUtilities.m1081dp(36.0f));
    ...
    public void saveConfig() {
        Service service = new Service(this.urlField.getText().toString().trim(), this.modelField.getText().toString().trim(), this.keyField.getText().toString().trim());
        if (!AiController.getInstance().contains(service)) {
            ...
            final String response = clientBuild.getResponse("Say 'hi'.", new GenerationCallback() { // from class: com.exteragram.messenger.ai.ui.activities.EditServiceActivity.5
                ...
                C08945(AlertDialog alertDialog2, Service service2) {
            ...
            alertDialog2.setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: com.exteragram.messenger.ai.ui.activities.EditServiceActivity$$ExternalSyntheticLambda8
    ...
    /* JADX INFO: renamed from: com.exteragram.messenger.ai.ui.activities.EditServiceActivity$5 */
    class C08945 implements GenerationCallback {
        final /* synthetic */ AlertDialog val$progressDialog;
        final /* synthetic */ Service val$service;
