...
import org.telegram.p026ui.Components.CodepointsLengthInputFilter;
...
public class EditRoleActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(currentRole != null ? C2702R.string.EditRole : C2702R.string.NewRole));
        ...
        this.fragmentView.setOnTouchListener(new View.OnTouchListener() { // from class: com.exteragram.messenger.ai.ui.activities.EditRoleActivity$$ExternalSyntheticLambda0
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return EditRoleActivity.m1657$r8$lambda$RZDlYB1sSHOgTj7naL0qxxe3nw(view, motionEvent);
            }
        });
        ...
        this.nameField.setPadding(0, iM1081dp, 0, iM1081dp);
        ...
        this.nameField.setMinHeight(AndroidUtilities.m1081dp(36.0f));
        ...
        this.nameField.addTextChangedListener(new TextWatcher() { // from class: com.exteragram.messenger.ai.ui.activities.EditRoleActivity.3
            ...
            public void afterTextChanged(Editable editable) {
                EditRoleActivity.this.nameFieldContainer.setText(String.format("%s • %d", LocaleController.getString(C2702R.string.RoleName), Integer.valueOf(64 - Character.codePointCount(editable, 0, editable.length()))));
            }
        });
        this.nameFieldContainer.setText(String.format("%s • %d", LocaleController.getString(C2702R.string.RoleName), 64));
        ...
        this.promptField.setPadding(0, iM1081dp, 0, iM1081dp);
        this.promptField.setCursorSize(AndroidUtilities.m1081dp(20.0f));
        ...
        this.promptField.setMinHeight(AndroidUtilities.m1081dp(36.0f));
        ...
        this.promptField.addTextChangedListener(new TextWatcher() { // from class: com.exteragram.messenger.ai.ui.activities.EditRoleActivity.5
            ...
            @Override // android.text.TextWatcher
            public void afterTextChanged(Editable editable) {
                EditRoleActivity.this.promptFieldContainer.setText(String.format("%s • %d", LocaleController.getString(C2702R.string.RolePrompt), Integer.valueOf(1024 - Character.codePointCount(editable, 0, editable.length()))));
            }
        });
        this.promptFieldContainer.setText(String.format("%s • %d", LocaleController.getString(C2702R.string.RolePrompt), 1024));
        ...
        linksTextView.setText(LocaleController.getString(C2702R.string.PromptInfo));
    ...
    class C08851 extends ActionBar.ActionBarMenuOnItemClick {
        C08851() {
        }
    ...
    public static /* synthetic */ boolean m1657$r8$lambda$RZDlYB1sSHOgTj7naL0qxxe3nw(View view, MotionEvent motionEvent) {
        return true;
    }
    ...
    class C08862 extends CodepointsLengthInputFilter {
        C08862(int i3) {
            super(i3);
        }
    ...
    class C08873 implements TextWatcher {
        @Override // android.text.TextWatcher
        public void beforeTextChanged(CharSequence charSequence, int i3, int i4, int i5) {
        }
    ...
    class C08884 extends CodepointsLengthInputFilter {
        C08884(int i3) {
            super(i3);
        }
    ...
    class C08895 implements TextWatcher {
        @Override // android.text.TextWatcher
        public void beforeTextChanged(CharSequence charSequence, int i3, int i4, int i5) {
        }
