...
public class ServicesActivity extends BasePreferencesActivity implements NotificationCenter.NotificationCenterDelegate {
    ...
    public String getTitle() {
        return LocaleController.getString(C2702R.string.Services);
    }

    @Override // com.exteragram.messenger.preferences.BasePreferencesActivity
    protected void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        arrayList.add(UItem.asTopView(LocaleController.getString(C2702R.string.ServicesInfo), "exteraGramPlaceholders", "🔑"));
        arrayList.add(UItem.asHeader(LocaleController.getString(C2702R.string.Services)));
        ...
        Drawable drawable = getContext().getResources().getDrawable(C2702R.drawable.poll_add_circle);
        Drawable drawable2 = getContext().getResources().getDrawable(C2702R.drawable.poll_add_plus);
        ...
        UItem uItemAccent = UItem.asButton(1, new CombinedDrawable(drawable, drawable2) { // from class: com.exteragram.messenger.ai.ui.activities.ServicesActivity.1
            ...
            {
                this.translateX = AndroidUtilities.m1081dp(2.0f);
            }
        }, LocaleController.getString(C2702R.string.NewService)).accent();
        uItemAccent.pad = 61;
    ...
    protected boolean onLongClick(UItem uItem, View view, int i, float f, float f2) {
        ...
        ItemOptions.makeOptions(this, view).add(C2702R.drawable.msg_edit, LocaleController.getString(C2702R.string.Edit), new Runnable() { // from class: com.exteragram.messenger.ai.ui.activities.ServicesActivity$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$onLongClick$0(service);
            }
        }).add(C2702R.drawable.msg_copy, LocaleController.getString(C2702R.string.Copy), new Runnable() { // from class: com.exteragram.messenger.ai.ui.activities.ServicesActivity$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$onLongClick$1(service);
            }
        }).add(C2702R.drawable.msg_delete, (CharSequence) LocaleController.getString(C2702R.string.Delete), true, new Runnable() { // from class: com.exteragram.messenger.ai.ui.activities.ServicesActivity$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
