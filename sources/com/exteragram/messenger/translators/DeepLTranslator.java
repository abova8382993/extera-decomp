...
public class DeepLTranslator extends BaseTranslator {
    ...
    private static final OkHttpClient client = ExteraHttpClient.INSTANCE.getClient().newBuilder().addNetworkInterceptor(new Interceptor() { // from class: com.exteragram.messenger.translators.DeepLTranslator$$ExternalSyntheticLambda1
        @Override // okhttp3.Interceptor
        public final Response intercept(Interceptor.Chain chain) {
            return DeepLTranslator.$r8$lambda$C3t8HA5LdSNw5SCJiN1vp78rw6U(chain);
        }
    }).build();
    private static final Set SUPPORTED_LANGUAGES = new HashSet(DeepLTranslator$$ExternalSyntheticBackport0.m283m(new String[]{"bg", "cs", "da", "de", "el", "en", "en-GB", "en-US", "es", "fi", "fr", "hu", "id", "it", "ja", "lt", "lv", "nl", "pl", "pt", "pt-BR", "pt-PT", "ro", "ru", "sk", "sl", "sv", "tr", "uk", "zh"}));
