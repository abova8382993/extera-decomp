...
public class ScriptletsManager {
    ...
    /* JADX INFO: renamed from: com.exteragram.messenger.adblock.backend.ScriptletsManager$1 */
    class C10071 extends HashMap {
        C10071() {
            put("1x1.gif", new ScriptletInfo("1x1-transparent.gif"));
            put("2x2.png", new ScriptletInfo("2x2-transparent.png"));
            put("3x2.png", new ScriptletInfo("3x2-transparent.png"));
    ...
    public static class Scriptlet {
        ...
        /* synthetic */ Scriptlet(String str, List list, String str2, ScriptletsManagerIA scriptletsManagerIA) {
            this(str, list, str2);
        }
