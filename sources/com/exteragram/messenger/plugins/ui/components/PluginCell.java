...
public class PluginCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public PluginCell(Context context) {
        ...
        addView(linearLayout, LayoutHelper.createFrame(-1, -2.0f, Opcodes.DNEG, 16.0f, 16.0f, 16.0f, 8.0f));
        ...
        effectsTextView.setTypeface(AndroidUtilities.getTypeface(Deobfuscator$exteraGramDev$TMessagesProj.getString(-11160336361576L)));
        ...
        effectsTextView2.setTypeface(AndroidUtilities.getTypeface(Deobfuscator$exteraGramDev$TMessagesProj.getString(-11241940740200L)));
    ...
    public void set(Plugin plugin, final PluginCellDelegate pluginCellDelegate) {
        ...
        if (z) {
            MediaDataController.getInstance(UserConfig.selectedAccount).setPlaceholderImageByIndex(this.imageView, plugin.getPack(), plugin.getIndex(), Deobfuscator$exteraGramDev$TMessagesProj.getString(-11323545118824L));
        } else {
        ...
        EffectsTextView effectsTextView = this.subtitleView;
        if (this.compact) {
            string = Deobfuscator$exteraGramDev$TMessagesProj.getString(-11357904857192L);
        } else {
            string = LocaleController.getString(R.string.PluginVersion) + Deobfuscator$exteraGramDev$TMessagesProj.getString(-11366494791784L);
        }
        effectsTextView.setText(new SpannableStringBuilder(string).append((CharSequence) plugin.getVersion()).append((CharSequence) Deobfuscator$exteraGramDev$TMessagesProj.getString(-11375084726376L)).append(LocaleUtils.formatWithUsernames(plugin.getAuthor())));
    ...
    private void bindNotRespondingState() {
        ...
        this.descriptionView.setTypeface(AndroidUtilities.getTypeface(Deobfuscator$exteraGramDev$TMessagesProj.getString(-11392264595560L)));
    ...
    private void bindErrorState() {
        ...
        this.descriptionView.setTextColor(Theme.getColor(Theme.key_text_RedRegular));
        this.descriptionView.setTypeface(AndroidUtilities.getTypeface(Deobfuscator$exteraGramDev$TMessagesProj.getString(-11460984072296L)));
        this.descriptionView.setTextSize(1, 12.0f);
    ...
    private void bindNormalState() {
        ...
        this.descriptionView.setTypeface(AndroidUtilities.getTypeface(Deobfuscator$exteraGramDev$TMessagesProj.getString(-11529703549032L)));
