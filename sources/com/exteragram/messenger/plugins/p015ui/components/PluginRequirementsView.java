...
public class PluginRequirementsView extends ViewGroup {
    ...
    public PluginRequirementsView(Context context, Theme.ResourcesProvider resourcesProvider) {
        super(context);
        this.itemSpacing = AndroidUtilities.m1124dp(4.0f);
        this.lineSpacing = AndroidUtilities.m1124dp(4.0f);
    ...
    public void setRequirements(List<String> list) {
        ...
        for (final String str : list) {
            ...
            textView.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1124dp(6.0f), ColorUtils.setAlphaComponent(themedColor, 30)));
            textView.setPadding(AndroidUtilities.m1124dp(6.0f), AndroidUtilities.m1124dp(2.0f), AndroidUtilities.m1124dp(6.0f), AndroidUtilities.m1124dp(2.0f));
