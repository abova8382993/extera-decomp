...
public class InstallPluginBottomSheet extends BottomSheet {
    ...
    public InstallPluginBottomSheet(final BaseFragment baseFragment, final PluginsController.PluginValidationResult pluginValidationResult, final PluginInstallParams pluginInstallParams) {
        ...
        if (pluginValidationResult.plugin.getPack() != null && pluginValidationResult.plugin.getIndex() >= 0) {
            BackupImageView backupImageView = new BackupImageView(parentActivity) { // from class: com.exteragram.messenger.plugins.ui.components.InstallPluginBottomSheet.2
                ...
                public void onDraw(Canvas canvas) {
                    ...
                    paint.setStrokeWidth(AndroidUtilities.m1124dp(4.0f));
                    paint.setStyle(Paint.Style.STROKE);
                    canvas.drawCircle(getMeasuredWidth() - AndroidUtilities.m1124dp(10.0f), getMeasuredHeight() - AndroidUtilities.m1124dp(10.0f), AndroidUtilities.m1124dp(12.0f), paint);
                    Paint paint2 = new Paint(1);
                    paint2.setColor(InstallPluginBottomSheet.this.getThemedColor(Theme.key_featuredStickers_addButton));
                    paint2.setStyle(Paint.Style.FILL);
                    canvas.drawCircle(getMeasuredWidth() - AndroidUtilities.m1124dp(10.0f), getMeasuredHeight() - AndroidUtilities.m1124dp(10.0f), AndroidUtilities.m1124dp(12.0f), paint2);
                    Drawable drawable = ContextCompat.getDrawable(getContext(), C2888R.drawable.plugin_large);
                    if (drawable != null) {
                        ...
                        drawable.setBounds(getMeasuredWidth() - AndroidUtilities.m1124dp(18.0f), getMeasuredHeight() - AndroidUtilities.m1124dp(18.0f), getMeasuredWidth() - AndroidUtilities.m1124dp(2.0f), getMeasuredHeight() - AndroidUtilities.m1124dp(2.0f));
            ...
            MediaDataController.getInstance(UserConfig.selectedAccount).setPlaceholderImageByIndex(backupImageView, pluginValidationResult.plugin.getPack(), pluginValidationResult.plugin.getIndex(), Deobfuscator$exteraGramDev$TMessagesProj.getString(-5986140613782369499L));
        } else {
            RLottieImageView rLottieImageView = new RLottieImageView(getContext());
            rLottieImageView.setScaleType(ImageView.ScaleType.CENTER);
            rLottieImageView.setImageResource(C2888R.drawable.plugin_large);
            ...
            rLottieImageView.setBackground(Theme.createCircleDrawable(AndroidUtilities.m1124dp(78.0f), getThemedColor(Theme.key_featuredStickers_addButton)));
        ...
        effectsTextView.setTypeface(AndroidUtilities.getTypeface(Deobfuscator$exteraGramDev$TMessagesProj.getString(-5986140648142107867L)));
        ...
        SpannableStringBuilder spannableStringBuilderAppend = new SpannableStringBuilder(LocaleController.getString(C2888R.string.PluginVersion)).append((CharSequence) Deobfuscator$exteraGramDev$TMessagesProj.getString(-5986140729746486491L));
        ...
        if (zContainsKey) {
            ...
            if (plugin != null) {
                spannableStringBuilderAppend.append((CharSequence) plugin.getVersion()).append((CharSequence) Deobfuscator$exteraGramDev$TMessagesProj.getString(-5986140738336421083L)).append((CharSequence) pluginValidationResult.plugin.getVersion());
                spannableStringBuilderAppend = VerticalImageSpan.createSpan(getContext(), C2888R.drawable.msg_mini_arrow_mediathin, spannableStringBuilderAppend.toString(), Deobfuscator$exteraGramDev$TMessagesProj.getString(-5986140759811257563L), i3, this.resourcesProvider);
        ...
        spannableStringBuilderAppend.append((CharSequence) Deobfuscator$exteraGramDev$TMessagesProj.getString(-5986140772696159451L)).append(LocaleUtils.formatWithUsernames(pluginValidationResult.plugin.getAuthor(), baseFragment, new Runnable() { // from class: com.exteragram.messenger.plugins.ui.components.InstallPluginBottomSheet$$ExternalSyntheticLambda3
        ...
        int i4 = z2 ? C2888R.drawable.trusted_mini : C2888R.drawable.unknown_mini;
        int themedColor = getThemedColor(z2 ? Theme.key_windowBackgroundWhiteGreenText : Theme.key_text_RedRegular);
        String string = LocaleController.getString(pluginInstallParams.trusted ? C2888R.string.PluginSourceTrusted : C2888R.string.PluginSourceUnknown);
        ...
        linearLayout2.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1124dp(20.0f), AndroidUtilities.m1124dp(20.0f), AndroidUtilities.multiplyAlphaComponent(themedColor, 0.1f)));
        linearLayout2.setPadding(AndroidUtilities.m1124dp(12.0f), AndroidUtilities.m1124dp(6.0f), AndroidUtilities.m1124dp(16.0f), AndroidUtilities.m1124dp(6.0f));
        ...
        textView2.setTypeface(AndroidUtilities.getTypeface(Deobfuscator$exteraGramDev$TMessagesProj.getString(-5986140789876028635L)));
        ...
        effectsTextView2.setTypeface(AndroidUtilities.getTypeface(Deobfuscator$exteraGramDev$TMessagesProj.getString(-5986140871480407259L)));
        ...
        if (!pluginValidationResult.plugin.isEnabled()) {
            ...
            textView3.setText(LocaleController.getString(C2888R.string.EnableAfterInstallation));
            ...
            linearLayout3.setPadding(AndroidUtilities.m1124dp(8.0f), AndroidUtilities.m1124dp(6.0f), AndroidUtilities.m1124dp(10.0f), AndroidUtilities.m1124dp(6.0f));
        ...
        imageView2.setImageDrawable(ContextCompat.getDrawable(parentActivity, C2888R.drawable.msg_openin).mutate());
        ...
        imageView2.setBackground(Theme.createSelectorDrawable(Theme.getColor(Theme.key_dialogButtonSelector), 1, AndroidUtilities.m1124dp(20.0f)));
        ...
        if (pluginInstallParams.trusted) {
            z = false;
            if (ExteraConfig.preferences.getBoolean(Deobfuscator$exteraGramDev$TMessagesProj.getString(-5986140953084785883L), false)) {
            }
        ...
        z = false;
        if (pluginInstallParams.trusted || ExteraConfig.preferences.getBoolean(Deobfuscator$exteraGramDev$TMessagesProj.getString(-5986141038984131803L), z)) {
            return;
        }
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: com.exteragram.messenger.plugins.ui.components.InstallPluginBottomSheet$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
    ...
    public /* synthetic */ void lambda$new$0(View view, HintView2 hintView2) {
        ...
        iArr[1] = i;
        hintView2.setTranslationY((i - AndroidUtilities.m1124dp(100.0f)) - AndroidUtilities.m1124dp(6.0f));
        hintView2.setJointPx(0.0f, (-AndroidUtilities.m1124dp(32.0f)) + iArr[0] + (view.getMeasuredWidth() / 2.0f));
    ...
    public /* synthetic */ void lambda$new$8(PluginInstallParams pluginInstallParams, final PluginsController.PluginValidationResult pluginValidationResult, final BaseFragment baseFragment, View view) {
        ...
        PythonPluginsEngine pythonPluginsEngine = (PythonPluginsEngine) PluginsController.engines.get(Deobfuscator$exteraGramDev$TMessagesProj.getString(-5986141343926809819L));
    ...
    public /* synthetic */ void lambda$new$6(final String str, final PluginsController.PluginValidationResult pluginValidationResult, final BaseFragment baseFragment) {
        ...
        if (str != null) {
            if (str.contains(Deobfuscator$exteraGramDev$TMessagesProj.getString(-5986141373991580891L))) {
                restoreButtonText(true);
                return;
            }
            restoreButtonText(true);
            str.split(Deobfuscator$exteraGramDev$TMessagesProj.getString(-5986141472775828699L))[0].replaceAll(Deobfuscator$exteraGramDev$TMessagesProj.getString(-5986141481365763291L), Deobfuscator$exteraGramDev$TMessagesProj.getString(-5986141524315436251L));
            BulletinFactory.m1245of(this.topBulletinContainer, this.resourcesProvider).createSimpleBulletin(C2888R.raw.error, LocaleController.formatString(C2888R.string.PluginInstallError, pluginValidationResult.plugin.getName()), LocaleUtils.createCopySpan(baseFragment), new Runnable() { // from class: com.exteragram.messenger.plugins.ui.components.InstallPluginBottomSheet$$ExternalSyntheticLambda9
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public /* synthetic */ void lambda$new$5(final BaseFragment baseFragment, PluginsController.PluginValidationResult pluginValidationResult, final String str) {
        if (str == null) {
            ...
            BulletinFactory.m1246of(baseFragment).createSimpleBulletin(C2888R.raw.error, LocaleController.formatString(C2888R.string.PluginInstalledButFailedToEnable, pluginValidationResult.plugin.getName()), LocaleUtils.createCopySpan(baseFragment), new Runnable() { // from class: com.exteragram.messenger.plugins.ui.components.InstallPluginBottomSheet$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    InstallPluginBottomSheet.m2655$r8$lambda$lvJDf0WVltZZt4leIihxTBEd94(str, baseFragment);
                }
            }).show();
        }
    }
    ...
    public static /* synthetic */ void m2655$r8$lambda$lvJDf0WVltZZt4leIihxTBEd94(String str, BaseFragment baseFragment) {
        if (AndroidUtilities.addToClipboard(str)) {
            BulletinFactory.m1246of(baseFragment).createCopyBulletin(LocaleController.getString(C2888R.string.TextCopied)).show();
        }
    }
    ...
    class C11673 implements PipController.InstallerDelegate {
        C11673() {
        }
        ...
        public /* synthetic */ void lambda$onProgress$0(String str) {
            ...
            InstallPluginBottomSheet.this.button.setText(LocaleController.getString(C2888R.string.Cancel), true);
    ...
    public /* synthetic */ void lambda$new$10(PluginInstallParams pluginInstallParams, BaseFragment baseFragment, View view) {
        ...
        if (file.exists()) {
            AndroidUtilities.openForView(file, file.getName(), Deobfuscator$exteraGramDev$TMessagesProj.getString(-5986141296682169563L), baseFragment.getParentActivity(), baseFragment.getResourceProvider(), false);
        }
    }
    ...
    public static /* synthetic */ void $r8$lambda$NCk_PnzBOhorfCXboXcLY60hXac(LinearLayout linearLayout, PluginInstallParams pluginInstallParams) {
        ...
        ExteraConfig.editor.putBoolean(Deobfuscator$exteraGramDev$TMessagesProj.getString(pluginInstallParams.trusted ? -5986141124883477723L : -5986141210782823643L), true).apply();
    }

    private void showSuccessBulletin(BaseFragment baseFragment, final Plugin plugin) {
        final BulletinFactory bulletinFactoryM1246of = BulletinFactory.m1246of(baseFragment);
        ...
        if (plugin.getPack() != null && plugin.getIndex() >= 0) {
            ...
            final Runnable runnable = new Runnable() { // from class: com.exteragram.messenger.plugins.ui.components.InstallPluginBottomSheet$$ExternalSyntheticLambda16
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$showSuccessBulletin$12(atomicBoolean, plugin, bulletinFactoryM1246of);
                }
            };
            ...
            MediaDataController.getInstance(UserConfig.selectedAccount).getStickerSet(tL_inputStickerSetShortName, 0, true, new Utilities.Callback() { // from class: com.exteragram.messenger.plugins.ui.components.InstallPluginBottomSheet$$ExternalSyntheticLambda17
                @Override // org.telegram.messenger.Utilities.Callback
                public final void run(Object obj) {
                    this.f$0.lambda$showSuccessBulletin$15(atomicBoolean, plugin, runnable, name, bulletinFactoryM1246of, (TLRPC.TL_messages_stickerSet) obj);
                }
            });
            return;
        }
        showSimpleSuccessBulletin(plugin, bulletinFactoryM1246of);
    }
    ...
    public /* synthetic */ void lambda$showSuccessBulletin$14(AtomicBoolean atomicBoolean, TLRPC.TL_messages_stickerSet tL_messages_stickerSet, final Plugin plugin, Runnable runnable, String str, BulletinFactory bulletinFactory) {
        ...
        AndroidUtilities.cancelRunOnUIThread(runnable);
        SpannableStringBuilder spannableStringBuilderReplaceTags = AndroidUtilities.replaceTags(LocaleController.formatString(this.isUpdate ? C2888R.string.PluginUpdated : C2888R.string.PluginInstalled, str));
        ...
        if (plugin2 != null && PluginsController.getInstance().hasPluginSettings(plugin.getId()) && plugin2.isEnabled()) {
            bulletinCreateSimpleBulletin = bulletinFactory.createEmojiBulletin(document, spannableStringBuilderReplaceTags, LocaleController.getString(C2888R.string.Settings), new Runnable() { // from class: com.exteragram.messenger.plugins.ui.components.InstallPluginBottomSheet$$ExternalSyntheticLambda14
                @Override // java.lang.Runnable
                public final void run() {
    ...
    private void showSimpleSuccessBulletin(final Plugin plugin, BulletinFactory bulletinFactory) {
        String string = LocaleController.formatString(this.isUpdate ? C2888R.string.PluginUpdated : C2888R.string.PluginInstalled, plugin.getName());
        Plugin plugin2 = PluginsController.getInstance().plugins.get(plugin.getId());
        if (plugin2 != null && PluginsController.getInstance().hasPluginSettings(plugin.getId()) && plugin2.isEnabled()) {
            bulletinFactory.createSimpleBulletin(C2888R.raw.contact_check, string, LocaleController.getString(C2888R.string.Settings), new Runnable() { // from class: com.exteragram.messenger.plugins.ui.components.InstallPluginBottomSheet$$ExternalSyntheticLambda15
                @Override // java.lang.Runnable
                public final void run() {
                    PluginsController.openPluginSettings(plugin.getId());
                }
            ...
            bulletinFactory.createSimpleBulletin(C2888R.raw.contact_check, string).show();
        }
    }

    private void restoreButtonText(boolean z) {
        this.button.setText(LocaleController.getString(this.isUpdate ? C2888R.string.UpdatePlugin : C2888R.string.InstallPlugin), z);
    ...
    public static class PluginInstallParams {
        ...
        */
        public static com.exteragram.messenger.plugins.ui.components.InstallPluginBottomSheet.PluginInstallParams m261of(org.telegram.messenger.MessageObject r6) {
            /*
                com.exteragram.messenger.utils.chats.ChatUtils r0 = com.exteragram.messenger.utils.chats.ChatUtils.getInstance()
            ...
            L51:
                ...
                return r6
            */
            throw new UnsupportedOperationException("Method not decompiled: com.exteragram.messenger.plugins.ui.components.InstallPluginBottomSheet.PluginInstallParams.m261of(org.telegram.messenger.MessageObject):com.exteragram.messenger.plugins.ui.components.InstallPluginBottomSheet$PluginInstallParams");
        }
    }
}
