package com.exteragram.messenger.nowplaying.p011ui;
...
public final class SetupNowPlayingActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2702R.string.NowPlaying));
        ...
        EditTextCell editTextCell = new EditTextCell(context, LocaleController.getString(C2702R.string.Username), this.resourceProvider) { // from class: com.exteragram.messenger.nowplaying.ui.SetupNowPlayingActivity.createView.4
        ...
        Drawable drawable = ContextCompat.getDrawable(context, C2702R.drawable.ic_ab_done);
        ...
        this.doneButton = this.actionBar.createMenu().addItemWithWidth(0, this.doneButtonDrawable, AndroidUtilities.m1081dp(56.0f), LocaleController.getString(C2702R.string.Done));
        checkDone(false);
    ...
    private final void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        arrayList.add(UItem.asHeader(LocaleController.getString(C2702R.string.SelectService)));
        ...
        arrayList.add(UItem.asShadow(LocaleController.getString(C2702R.string.SelectServiceInfo)));
        if (this.currentState.getServiceType() != NowPlayingServiceType.NONE) {
            arrayList.add(UItem.asHeader(LocaleController.getString(C2702R.string.EnterUsername)));
            ...
            SpannableStringBuilder spannableStringBuilderReplaceSingleTag = AndroidUtilities.replaceSingleTag(LocaleController.getString(C2702R.string.EnterUsernameInfo), new Runnable() { // from class: com.exteragram.messenger.nowplaying.ui.SetupNowPlayingActivity$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
    ...
    private final void onClick(UItem uItem, View view, int i, float f, float f2) {
        if (view instanceof DialogRadioCell) {
            UniversalRecyclerView universalRecyclerView = null;
            this.currentState = NowPlayingState.copy$default(this.currentState, ((NowPlayingServiceType[]) NowPlayingServiceType.getEntries().toArray(new NowPlayingServiceType[0]))[uItem.f2056id], null, 2, null);
            UniversalRecyclerView universalRecyclerView2 = this.listView;
            if (universalRecyclerView2 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("listView");
            } else {
    ...
    public static final void processDone$lambda$1$0(Boolean bool, SetupNowPlayingActivity setupNowPlayingActivity, NowPlayingInfoDTO nowPlayingInfoDTO) {
        if (!bool.booleanValue()) {
            ...
            BulletinFactory.m1195of(setupNowPlayingActivity).createErrorBulletin(LocaleController.getString(C2702R.string.UnknownError)).show();
            return;
        }
