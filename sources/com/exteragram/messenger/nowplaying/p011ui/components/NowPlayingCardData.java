package com.exteragram.messenger.nowplaying.p011ui.components;
...
import com.exteragram.messenger.nowplaying.p011ui.components.NowPlayingCardData;
...
public final class NowPlayingCardData {
    ...
    public int hashCode() {
        ...
        return ((iHashCode4 + (imageLocation != null ? imageLocation.hashCode() : 0)) * 31) + AbstractC0155x440b9a8e.m36m(this.userEmoji);
    }
    ...
    public /* synthetic */ NowPlayingCardData(com.exteragram.messenger.api.dto.NowPlayingDTO r9, java.lang.Integer r10, java.lang.Integer r11, android.graphics.Bitmap r12, org.telegram.messenger.ImageLocation r13, long r14, int r16, kotlin.jvm.internal.DefaultConstructorMarker r17) {
        ...
        L19:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.exteragram.messenger.nowplaying.p011ui.components.NowPlayingCardData.<init>(com.exteragram.messenger.api.dto.NowPlayingDTO, java.lang.Integer, java.lang.Integer, android.graphics.Bitmap, org.telegram.messenger.ImageLocation, long, int, kotlin.jvm.internal.DefaultConstructorMarker):void");
    }
    ...
    public static final class Companion {
        ...
        private final Pair extractColors(Bitmap bitmap) {
            ...
            float f2;
            if (bitmap == null) {
                return TuplesKt.m1038to(null, null);
            }
            ...
            if (0.0f <= f3 && f3 <= 0.25f) {
                ...
                if (0.5f > f3 || f3 > 0.75f) {
                    f = 0.5f;
                    return TuplesKt.m1038to(Integer.valueOf(i), Integer.valueOf(UIUtil.adjustHsl$default(UIUtil.INSTANCE, i, f, 0.0f, 4, null)));
                }
                f2 = 1.0f;
            }
            f = f2;
