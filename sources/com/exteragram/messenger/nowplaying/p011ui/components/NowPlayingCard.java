...
public abstract class NowPlayingCard extends FrameLayout {
    ...
    public NowPlayingCard(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.emoji = new AnimatedEmojiDrawable.SwapAnimatedEmojiDrawable(frameLayout, false, AndroidUtilities.m1081dp(20.0f), 13);
        LinearLayout linearLayout = new LinearLayout(context);
        linearLayout.setOrientation(0);
        frameLayout.addView(linearLayout, LayoutHelper.createLinear(-1, -2, Opcodes.DNEG, 12, 12, 12, 12));
        BackupImageView backupImageView = new BackupImageView(context);
        backupImageView.setRoundRadius(AndroidUtilities.m1081dp(8.0f));
    ...
    public final void set(final NowPlayingCardData cardData) {
        ...
        if (artists.isEmpty()) {
            this.artistView.setText(LocaleController.getString(C2702R.string.AudioUnknownArtist));
        } else {
        ...
        imageView2.setBackground(Theme.createCircleDrawable(iM1081dp, accentColor != null ? accentColor.intValue() : getThemedColor(Theme.key_featuredStickers_addButton)));
        ...
        if (cardData.getImageLocation() != null) {
            ...
            this.imageView.setImageResource(C2702R.drawable.nocover, getThemedColor(Theme.key_player_button));
