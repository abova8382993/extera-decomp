...
final class C0992x547df597 extends SuspendLambda implements Function2 {
    final /* synthetic */ TLRPC.Document $savedMusic;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    C0992x547df597(TLRPC.Document document, Continuation continuation) {
    ...
    public final Continuation create(Object obj, Continuation continuation) {
        return new C0992x547df597(this.$savedMusic, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
        return ((C0992x547df597) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
