...
public class ExportMapper {
    ...
    */
    private org.telegram.tgnet.TLRPC.MessageMedia mapMedia(final com.exteragram.messenger.export.ui.ExportMapper.JsonMessage r8) throws java.lang.Throwable {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.exteragram.messenger.export.p014ui.ExportMapper.mapMedia(com.exteragram.messenger.export.ui.ExportMapper$JsonMessage):org.telegram.tgnet.TLRPC$MessageMedia");
    }
        ...
        if (str4 != null) {
            ...
            switch (b2) {
                ...
                case 1:
                    ...
                    tL_documentAttributeVideo.f1256w = media3.width;
                    tL_documentAttributeVideo.f1255h = media3.height;
    ...
    private TLRPC.TL_messageService mapService(JsonMessage jsonMessage) {
        ...
        tL_messageService.f1271id = jsonMessage.f336id;
                ...
                if (str2 != null && !str2.isEmpty()) {
                    ...
                    if ("attach_menu_bot_allowed".equals(jsonMessage.action.actionType) || "web_app_bot_allowed".equals(jsonMessage.action.actionType) || "allow_sending_messages".equals(jsonMessage.action.actionType)) {
                        ...
                        if ("allow_sending_messages".equals(jsonMessage.action.actionType)) {
                            ...
                            tL_botApp.f1242id = action3.reason_app_id;
                        ...
                        if ("send_premium_gift".equals(jsonMessage.action.actionType)) {
                            ...
                            if ("set_same_chat_wallpaper".equals(jsonMessage.action.actionType) || "set_chat_wallpaper".equals(jsonMessage.action.actionType)) {
                                ...
                                if ("refunded_payment".equals(jsonMessage.action.actionType)) {
                                    ...
                                    tL_paymentCharge.f1386id = jsonMessage.action.charge_id;
                                    return tL_messageService;
                                }
                                if ("send_stars_gift".equals(jsonMessage.action.actionType)) {
                                    ...
                                    tL_starGift.f1443id = jsonMessage.action.gift_id;
            ...
            if (jsonMessage != null) {
                if ("service".equals(jsonMessage.type)) {
                    ...
                    if (str != null && str.contains("bot_chat")) {
                        tL_peerUser.user_id = this.chatInfo.f335id;
                    } else {
