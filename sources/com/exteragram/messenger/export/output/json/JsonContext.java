...
public class JsonContext {
    ...
    public static String SerializeMessage(final JsonContext jsonContext, final ApiWrap$Message apiWrap$Message, final HashMap<Long, ApiWrap$Peer> map, String str) {
        ...
        if (apiWrap$Message.media.content instanceof ApiWrap$UnsupportedMedia) {
            return SerializeObject(jsonContext, new Pair("id", Integer.valueOf(apiWrap$Message.f310id)), new Pair(TeXSymbolParser.TYPE_ATTR, SerializeString("unsupported")));
        }
        ...
        Utilities.CallbackReturn callbackReturn2 = new Utilities.CallbackReturn() { // from class: com.exteragram.messenger.export.output.json.JsonContext$$ExternalSyntheticLambda4
            @Override // org.telegram.messenger.Utilities.CallbackReturn
            public final Object run(Object obj) {
                return JsonContext.m2340$r8$lambda$Lb75cXPDJ068NTmfGbGV7wsayQ(callbackReturn, (Long) obj);
            }
        };
        final ArrayList arrayList = new ArrayList();
        arrayList.add(new Pair("id", Integer.valueOf(apiWrap$Message.f310id)));
        ...
        if (arrayList2 != null && !arrayList2.isEmpty()) {
            ...
            List list = (List) apiWrap$Message.inlineButtonRows.stream().map(new Function() { // from class: com.exteragram.messenger.export.output.json.JsonContext$$ExternalSyntheticLambda1
                ...
                public final Object apply(Object obj) {
                    return JsonContext.m2341$r8$lambda$hmtII8_x5IKMyyqN62IoDyQTf4(callbackReturn5, (ArrayList) obj);
                }
    ...
    public static /* synthetic */ ApiWrap$User m2340$r8$lambda$Lb75cXPDJ068NTmfGbGV7wsayQ(Utilities.CallbackReturn callbackReturn, Long l) {
    ...
    public static /* synthetic */ void $r8$lambda$oOh1TbUsZyqtWEJs5VUnyheqEho(ApiWrap$Message apiWrap$Message, Utilities.Callback2 callback2, Utilities.CallbackReturn callbackReturn, Utilities.Callback2 callback22, String str) {
        ...
        if (j != 0) {
            ...
            callback22.run(str.concat("_id"), Long.valueOf(apiWrap$Message.fromId));
        }
    }
    ...
    public static /* synthetic */ String $r8$lambda$lKrxcF5Xyg1WzKTSgzvku1TscPg(final JsonContext jsonContext, ArrayList arrayList) {
        ...
        List list = (List) arrayList.stream().map(new Function() { // from class: com.exteragram.messenger.export.output.json.JsonContext$$ExternalSyntheticLambda13
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return JsonContext.m2345$r8$lambda$z_7ew4tZrjahCzTlJ65jxaK0v0(this.f$0, (ApiWrap$HistoryMessageMarkupButton) obj);
            }
        }).collect(Collectors.toList());
        jsonContext.nesting.remove(r0.size() - 1);
    ...
    public static /* synthetic */ String m2345$r8$lambda$z_7ew4tZrjahCzTlJ65jxaK0v0(JsonContext jsonContext, ApiWrap$HistoryMessageMarkupButton apiWrap$HistoryMessageMarkupButton) {
    ...
    public static /* synthetic */ String m2341$r8$lambda$hmtII8_x5IKMyyqN62IoDyQTf4(Utilities.CallbackReturn callbackReturn, ArrayList arrayList) {
    ...
    public static /* synthetic */ class C11141 {
        ...
        static {
            ...
            try {
                f329x894b9bc3[ApiWrap$Reaction.Type.CustomEmoji.ordinal()] = 2;
            ...
            try {
                f328xd696c439[ApiWrap$File.SkipReason.FileSize.ordinal()] = 2;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f328xd696c439[ApiWrap$File.SkipReason.FileType.ordinal()] = 3;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f328xd696c439[ApiWrap$File.SkipReason.None.ordinal()] = 4;
            ...
            try {
                f330x9004fd8c[ApiWrap$TextPart.Type.Mention.ordinal()] = 2;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f330x9004fd8c[ApiWrap$TextPart.Type.Hashtag.ordinal()] = 3;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f330x9004fd8c[ApiWrap$TextPart.Type.BotCommand.ordinal()] = 4;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f330x9004fd8c[ApiWrap$TextPart.Type.Url.ordinal()] = 5;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f330x9004fd8c[ApiWrap$TextPart.Type.Email.ordinal()] = 6;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f330x9004fd8c[ApiWrap$TextPart.Type.Bold.ordinal()] = 7;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f330x9004fd8c[ApiWrap$TextPart.Type.Italic.ordinal()] = 8;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f330x9004fd8c[ApiWrap$TextPart.Type.Code.ordinal()] = 9;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                f330x9004fd8c[ApiWrap$TextPart.Type.Pre.ordinal()] = 10;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                f330x9004fd8c[ApiWrap$TextPart.Type.Text.ordinal()] = 11;
            } catch (NoSuchFieldError unused17) {
            }
            try {
                f330x9004fd8c[ApiWrap$TextPart.Type.TextUrl.ordinal()] = 12;
            } catch (NoSuchFieldError unused18) {
            }
            try {
                f330x9004fd8c[ApiWrap$TextPart.Type.MentionName.ordinal()] = 13;
            } catch (NoSuchFieldError unused19) {
            }
            try {
                f330x9004fd8c[ApiWrap$TextPart.Type.Phone.ordinal()] = 14;
            } catch (NoSuchFieldError unused20) {
            }
            try {
                f330x9004fd8c[ApiWrap$TextPart.Type.Cashtag.ordinal()] = 15;
            } catch (NoSuchFieldError unused21) {
            }
            try {
                f330x9004fd8c[ApiWrap$TextPart.Type.Underline.ordinal()] = 16;
            } catch (NoSuchFieldError unused22) {
            }
            try {
                f330x9004fd8c[ApiWrap$TextPart.Type.Strike.ordinal()] = 17;
            } catch (NoSuchFieldError unused23) {
            }
            try {
                f330x9004fd8c[ApiWrap$TextPart.Type.Blockquote.ordinal()] = 18;
            } catch (NoSuchFieldError unused24) {
            }
            try {
                f330x9004fd8c[ApiWrap$TextPart.Type.BankCard.ordinal()] = 19;
            } catch (NoSuchFieldError unused25) {
            }
            try {
                f330x9004fd8c[ApiWrap$TextPart.Type.Spoiler.ordinal()] = 20;
            } catch (NoSuchFieldError unused26) {
            }
            try {
                f330x9004fd8c[ApiWrap$TextPart.Type.CustomEmoji.ordinal()] = 21;
    ...
    private static String SerializeMessageMedia(ApiWrap$Message apiWrap$Message, final JsonContext jsonContext, final HashMap<Long, ApiWrap$Peer> map, String str) {
        ...
        final Utilities.CallbackReturn callbackReturn = new Utilities.CallbackReturn() { // from class: com.exteragram.messenger.export.output.json.JsonContext$$ExternalSyntheticLambda29
            @Override // org.telegram.messenger.Utilities.CallbackReturn
            public final Object run(Object obj) {
                return JsonContext.m2335$r8$lambda$0G3AK7RwrqIoB5h65Np1ClK9s((Long) obj);
            }
        };
        ...
        final Utilities.CallbackReturn callbackReturn2 = new Utilities.CallbackReturn() { // from class: com.exteragram.messenger.export.output.json.JsonContext$$ExternalSyntheticLambda31
            @Override // org.telegram.messenger.Utilities.CallbackReturn
            public final Object run(Object obj) {
                return JsonContext.m2338$r8$lambda$A7SAhkqqvPMMCDUVzfseNfek48(map, (Long) obj);
            }
        };
        ...
        final Utilities.Callback3 callback3 = new Utilities.Callback3() { // from class: com.exteragram.messenger.export.output.json.JsonContext$$ExternalSyntheticLambda33
            ...
            public final void run(Object obj, Object obj2, Object obj3) {
                JsonContext.m2337$r8$lambda$5ZTMoi45tFEPX66k7pRMwqlwpI(callback22, (ApiWrap$File) obj, (String) obj2, (String) obj3);
            }
        };
        ...
        if (obj instanceof HtmlWriter.Photo) {
            ...
            if (z) {
                ...
                jsonContext.nesting.remove(r10.size() - 1);
                ...
                FileLog.m1046e("Export: Unsupported message");
            }
        }
    ...
    public static /* synthetic */ String m2335$r8$lambda$0G3AK7RwrqIoB5h65Np1ClK9s(Long l) {
        if (l.longValue() < 0) {
            return SerializeString("chat" + l);
        }
        return SerializeString("user" + l);
    ...
    public static /* synthetic */ ApiWrap$Peer m2338$r8$lambda$A7SAhkqqvPMMCDUVzfseNfek48(HashMap map, Long l) {
        ApiWrap$Peer apiWrap$Peer = (ApiWrap$Peer) map.get(l);
        return apiWrap$Peer != null ? apiWrap$Peer : new ApiWrap$Peer(new ApiWrap$User());
    }
    ...
    public static /* synthetic */ void m2337$r8$lambda$5ZTMoi45tFEPX66k7pRMwqlwpI(Utilities.Callback2 callback2, ApiWrap$File apiWrap$File, String str, String str2) {
        String strConcat;
        String strConcat2 = str2.isEmpty() ? _UrlKt.FRAGMENT_ENCODE_SET : str2.concat(" ");
        int i = C11141.f328xd696c439[apiWrap$File.skipReason.ordinal()];
        if (i == 1) {
    ...
    public static /* synthetic */ String $r8$lambda$DZvvVfxINNbQgeVwZHbS0Lp0an4(JsonContext jsonContext, ApiWrap$Poll.Answer answer) {
        jsonContext.nesting.add(Boolean.FALSE);
        String strSerializeObject = SerializeObject(jsonContext, new Pair("text", SerializeString(answer.text())), new Pair("voters", DataTypesUtils.NumberToString(answer.votes())), new Pair("chosen", answer.m260my() ? "true" : "false"));
        jsonContext.nesting.remove(r4.size() - 1);
    ...
    private static String SerializeMessageAction(final JsonContext jsonContext, TLRPC.MessageAction messageAction, final ApiWrap$Message apiWrap$Message, final HashMap<Long, ApiWrap$Peer> map) {
        ...
        final Utilities.CallbackReturn callbackReturn2 = new Utilities.CallbackReturn() { // from class: com.exteragram.messenger.export.output.json.JsonContext$$ExternalSyntheticLambda18
            @Override // org.telegram.messenger.Utilities.CallbackReturn
            public final Object run(Object obj) {
                return JsonContext.m2342$r8$lambda$l3kw5Q6evJjim0J_zsiqvwknVk(callbackReturn, (Long) obj);
            }
        };
        ...
        Utilities.Callback2 callback23 = new Utilities.Callback2() { // from class: com.exteragram.messenger.export.output.json.JsonContext$$ExternalSyntheticLambda25
            @Override // org.telegram.messenger.Utilities.Callback2
            public final void run(Object obj, Object obj2) {
                JsonContext.m2344$r8$lambda$qketphKXD6umlaSqbPSIjrbZ8c(callbackReturn2, callback2, jsonContext, (ArrayList) obj, (String) obj2);
            }
        };
        ...
        Utilities.Callback callback4 = new Utilities.Callback() { // from class: com.exteragram.messenger.export.output.json.JsonContext$$ExternalSyntheticLambda15
            @Override // org.telegram.messenger.Utilities.Callback
            public final void run(Object obj) {
                JsonContext.m2336$r8$lambda$0JEATGwgrDcrUlHLnU4tlxdjgY(callback32, callback22, (ApiWrap$Image) obj);
            }
        };
        ...
        if (messageAction instanceof TLRPC.TL_messageActionChatCreate) {
            ...
            if (messageAction instanceof TLRPC.TL_messageActionChatDeletePhoto) {
                ...
                } else if (tL_messageActionBotAllowed.app.f1242id != 0) {
                    callback5.run("allow_sending_messages");
                    callback22.run("reason_app_id", Long.valueOf(tL_messageActionBotAllowed.app.f1242id));
                ...
                callback22.run("charge_id", tL_messageActionPaymentRefunded.charge.f1386id);
                ...
                arrayList = arrayList;
                arrayList.add(new Pair("gift_id", Long.valueOf(tL_messageActionStarGift.gift.f1443id)));
    ...
    public static /* synthetic */ ApiWrap$User m2342$r8$lambda$l3kw5Q6evJjim0J_zsiqvwknVk(Utilities.CallbackReturn callbackReturn, Long l) {
        ApiWrap$User apiWrap$User = ((ApiWrap$Peer) callbackReturn.run(l)).user;
        return apiWrap$User != null ? apiWrap$User : new ApiWrap$User();
    }
    ...
    public static /* synthetic */ void $r8$lambda$hw2aHHYioc0DYTvaVxxcyJjnUJs(ApiWrap$Message apiWrap$Message, Utilities.Callback2 callback2, Utilities.CallbackReturn callbackReturn, Utilities.Callback2 callback22, String str) {
        ...
        if (j != 0) {
            ...
            callback22.run(str.concat("_id"), tL_peerUser);
        }
    }
    ...
    public static /* synthetic */ void m2344$r8$lambda$qketphKXD6umlaSqbPSIjrbZ8c(Utilities.CallbackReturn callbackReturn, Utilities.Callback2 callback2, JsonContext jsonContext, ArrayList arrayList, String str) {
        ArrayList arrayList2 = new ArrayList();
    ...
    public static /* synthetic */ void m2336$r8$lambda$0JEATGwgrDcrUlHLnU4tlxdjgY(Utilities.Callback3 callback3, Utilities.Callback2 callback2, ApiWrap$Image apiWrap$Image) {
        callback3.run(apiWrap$Image.file, "photo", _UrlKt.FRAGMENT_ENCODE_SET);
        int i = apiWrap$Image.width;
        if (i == 0 || apiWrap$Image.height == 0) {
            return;
    ...
    public static String Indentation(int i) {
        return HtmlContext$$ExternalSyntheticBackport1.m266m(" ", i);
    }
    ...
    public static String SerializeText(JsonContext jsonContext, ArrayList<ApiWrap$TextPart> arrayList, boolean z) {
        ...
        while (i < size) {
            ...
            if (type == ApiWrap$TextPart.Type.Text && !z) {
                ...
                switch (C11141.f330x9004fd8c[type.ordinal()]) {
                    case 1:
                        str = "unknown";
                        break;
                    case 2:
                    ...
                    case 21:
                        ...
                        break;
                    default:
                        CstInsn$$ExternalSyntheticBUOutline0.m219m("wtf is it? ", apiWrap$TextPart2.text);
                        return null;
                }
