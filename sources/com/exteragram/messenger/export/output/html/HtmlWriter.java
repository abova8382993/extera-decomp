...
public class HtmlWriter extends AbstractWriter {
    ...
    public static String WriteUserpicThumb(String str, String str2, final UserpicData userpicData) {
        return (String) HtmlContext.WriteImageThumb(str, str2, new Function() { // from class: com.exteragram.messenger.export.output.html.HtmlWriter$$ExternalSyntheticLambda4
            ...
            public final Object apply(Object obj) {
                return HtmlWriter.m2325$r8$lambda$0DixWPzMjZ6lOOvAG9W5PMq7o(userpicData, (Dimension) obj);
            }
        }, null, 0, "_thumb").first;
    }

    /* JADX INFO: renamed from: $r8$lambda$--0DixWPzMjZ6lOOvAG9W5PMq7o */
    public static /* synthetic */ Dimension m2325$r8$lambda$0DixWPzMjZ6lOOvAG9W5PMq7o(UserpicData userpicData, Dimension dimension) {
    ...
    private AbstractWriter.Result writePreparedPersonal(ApiWrap$ExportPersonalInfo apiWrap$ExportPersonalInfo, String str) {
        ...
        pushRows("names", ImageCapture$$ExternalSyntheticBackport1.m73m(new Object[]{new Pair("First name", apiWrap$ContactInfo.firstName), new Pair("Last name", apiWrap$ContactInfo.lastName)}), sb);
        ...
        pushRows("info", ImageCapture$$ExternalSyntheticBackport1.m73m(new Object[]{pair, new Pair("Username", str2)}), sb);
        pushRows("bio", ImageCapture$$ExternalSyntheticBackport1.m73m(new Object[]{new Pair("Bio", apiWrap$ExportPersonalInfo.bio)}), sb);
        sb.append(this._summary.popTag());
    ...
    private AbstractWriter.Result writeSessions(ApiWrap$SessionsList apiWrap$SessionsList) {
        ...
        while (i < size) {
            ...
            sb4.append(tL_authorization2.f1284ip);
            sb4.append(" - ");
    ...
    private AbstractWriter.Result writeWebSessions(ApiWrap$SessionsList apiWrap$SessionsList) {
        ...
        while (i < size) {
            ...
            int iStringBarePeerId = (int) (DataTypesUtils.StringBarePeerId(apiWrap$WebSession2.domain()) + 4096);
            ...
            String str4 = apiWrap$WebSession2.m263ip() + " - " + apiWrap$WebSession2.region();
    ...
    public AbstractWriter.Result writeDialogsStart(ApiWrap$DialogsInfo apiWrap$DialogsInfo) {
        if (this._chats != null) {
            Segment$$ExternalSyntheticBUOutline1.m992m("chats already initialized!");
            return null;
        }
    ...
    public AbstractWriter.Result writeDialogSlice(ApiWrap$MessagesSlice apiWrap$MessagesSlice) {
        int i;
        StringBuilder sb;
        ArrayList<ApiWrap$Message> arrayList;
        ...
        StringBuilder sb2 = new StringBuilder();
        ArrayList<ApiWrap$Message> arrayList2 = apiWrap$MessagesSlice.list;
        int size = arrayList2.size();
        int i4 = 0;
        while (i4 < size) {
            int i5 = i4 + 1;
            ApiWrap$Message apiWrap$Message = arrayList2.get(i4);
            if (DataTypesUtils.SkipMessageByDate(apiWrap$Message, this._settings)) {
                ...
                if (i3 != i6) {
                    ...
                    this._lastMessageIdsPerFile.add(Integer.valueOf(messageInfo2 != null ? messageInfo2.f326id : this._lastMessageInfo.f326id));
                    StringBuilder sb3 = new StringBuilder();
                    messageInfo = null;
                    this._lastMessageInfo = null;
                    sb = sb3;
    ...
    public AbstractWriter.Result writeDialogEnd() {
        ...
        int i = C11132.f324x410af476[this._dialog.type.ordinal()];
    ...
    public AbstractWriter.Result writeUserpicsSlice(ArrayList<Photo> arrayList) {
        ...
        while (i < size) {
            ...
            int i2 = C11132.f325xd696c439[apiWrap$File.skipReason.ordinal()];
            if (i2 == 1) {
    ...
    public static /* synthetic */ class C11132 {
        ...
        static {
            ...
            try {
                f325xd696c439[ApiWrap$File.SkipReason.FileSize.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f325xd696c439[ApiWrap$File.SkipReason.FileType.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f325xd696c439[ApiWrap$File.SkipReason.None.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f325xd696c439[ApiWrap$File.SkipReason.DateLimits.ordinal()] = 5;
            ...
            try {
                f324x410af476[ApiWrap$DialogInfo.Type.Replies.ordinal()] = 2;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f324x410af476[ApiWrap$DialogInfo.Type.VerifyCodes.ordinal()] = 3;
    ...
    public AbstractWriter.Result writeStoriesSlice(ApiWrap$StoriesSlice apiWrap$StoriesSlice) {
        ...
        while (i < size) {
            ...
            int i2 = C11132.f325xd696c439[apiWrap$FileFile.skipReason.ordinal()];
            if (i2 != 1 && i2 != 2 && i2 != 3) {
                if (i2 != 4) {
                    if (i2 != 5) {
                        throw new IncompatibleClassChangeError();
                    }
                    Segment$$ExternalSyntheticBUOutline1.m992m("Skip reason while writing story path.");
                    return null;
                }
            ...
            apiWrap$StoryData.imageLink = (String) HtmlContext.WriteImageThumb(this._settings.path, str, new Function() { // from class: com.exteragram.messenger.export.output.html.HtmlWriter$$ExternalSyntheticLambda3
                @Override // java.util.function.Function
                public final Object apply(Object obj) {
                    return HtmlWriter.m2326$r8$lambda$B8MGwMXHL_evNdsjLxRh5KBA((Dimension) obj);
                }
            }, null, 0, null).first;
    ...
    public static /* synthetic */ Dimension m2326$r8$lambda$B8MGwMXHL_evNdsjLxRh5KBA(Dimension dimension) {
    ...
    private AbstractWriter.Result writeFrequentContacts(ApiWrap$ContactsList apiWrap$ContactsList) {
        ...
        sb.append(htmlContextFileWithRelativePath.pushDiv("entry_list"));
        C11121 c11121 = new Utilities.Callback2<ArrayList<ApiWrap$TopPeer>, String>() { // from class: com.exteragram.messenger.export.output.html.HtmlWriter.1
            final /* synthetic */ StringBuilder val$block;
            final /* synthetic */ HtmlContext val$file;

            public C11121(StringBuilder sb2, HtmlContext htmlContextFileWithRelativePath2) {
                sb = sb2;
            ...
            public void run(ArrayList<ApiWrap$TopPeer> arrayList, String str) {
                ...
                while (i < size2) {
                    ...
                    UserpicData userpicData = new UserpicData();
                    userpicData.colorIndex = DataTypesUtils.PeerColorIndex(apiWrap$TopPeer2.peer.m259id());
                    userpicData.pixelSize = 48;
                    userpicData.firstName = strName;
                    userpicData.lastName = str2;
                    String str3 = str;
                    sb.append(htmlContext.pushListEntry(userpicData, DataTypesUtils.ComposeName(userpicData, "Deleted Account"), "Rating: " + apiWrap$TopPeer2.rating, str3, _UrlKt.FRAGMENT_ENCODE_SET));
                    str = str3;
                }
            }
        };
        c11121.run(apiWrap$ContactsList.correspondents, "people");
        c11121.run(apiWrap$ContactsList.inlineBots, "inline bots");
        c11121.run(apiWrap$ContactsList.phoneCalls, "calls");
    ...
    public class C11121 implements Utilities.Callback2<ArrayList<ApiWrap$TopPeer>, String> {
        final /* synthetic */ StringBuilder val$block;
        final /* synthetic */ HtmlContext val$file;
