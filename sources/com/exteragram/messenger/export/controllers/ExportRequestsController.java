...
public class ExportRequestsController {
    ...
    public static ApiWrap$DialogsInfo ParseDialogsInfo(TLRPC.InputPeer inputPeer, Vector vector) {
        ...
        if (inputPeer instanceof TLRPC.TL_inputPeerUser) {
            ...
            if (!(inputPeer instanceof TLRPC.TL_inputPeerSelf)) {
                DexMaker$$ExternalSyntheticBUOutline0.m217m("wtf is it: ", inputPeer);
                return null;
            }
            j = 0;
        }
        ...
        while (i < size) {
            ...
            if (obj instanceof TLRPC.User) {
                ...
                if (user.f1407id == j || (j == 0 && user.self)) {
    ...
    public static ApiWrap$DialogsInfo ParseDialogsInfo(TLRPC.InputPeer inputPeer, TLRPC.messages_Chats messages_chats) {
        ...
        if (inputPeer instanceof TLRPC.TL_inputPeerChat) {
            ...
            DexMaker$$ExternalSyntheticBUOutline0.m217m("illegal type: ", inputPeer);
            return null;
        }
        ApiWrap$DialogsInfo apiWrap$DialogsInfo = new ApiWrap$DialogsInfo();
        ...
        while (i < size) {
            ...
            if (chat2 instanceof TLRPC.TL_channel) {
                j2 = ((TLRPC.TL_channel) chat2).f1245id;
            } else if (chat2 instanceof TLRPC.TL_channelForbidden) {
                j2 = ((TLRPC.TL_channelForbidden) chat2).f1245id;
            } else {
                j2 = chat2.f1245id;
            }
            if (j2 == j) {
    ...
    public void sendNextStartRequest() {
        ...
        arrayList.remove(0);
        int i = C11101.f322xb0544668[step.ordinal()];
        if (i == 1) {
    ...
    /* JADX INFO: renamed from: com.exteragram.messenger.export.controllers.ExportRequestsController$1 */
    public static /* synthetic */ class C11101 {

        /* JADX INFO: renamed from: $SwitchMap$com$exteragram$messenger$export$controllers$ExportRequestsController$StartProcess$Step */
        static final /* synthetic */ int[] f322xb0544668;
        ...
        static {
            ...
            try {
                f322xb0544668[StartProcess.Step.StoriesCount.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f322xb0544668[StartProcess.Step.SplitRanges.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f322xb0544668[StartProcess.Step.DialogsCount.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f322xb0544668[StartProcess.Step.LeftChannelsCount.ordinal()] = 5;
    ...
    */
    private void startMainSession(final java.lang.Runnable r8) {
        ...
        L63:
            ...
            java.util.List r1 = androidx.camera.core.ImageCapture$$ExternalSyntheticBackport0.m72m(r1)
            r2.<init>(r1)
            r0.f1400id = r2
        ...
        if (tLObject instanceof Vector) {
            ...
            while (i < size) {
                ...
                if (tLObject2 instanceof TLRPC.User) {
                    ...
                    if (user.self) {
                        this._selfId = user.f1407id;
                    }
                }
            }
            if (this._selfId == 0) {
                Segment$$ExternalSyntheticBUOutline1.m992m("not mine id!");
            } else {
    ...
    public /* synthetic */ void lambda$startMainSession$0(Runnable runnable, TLObject tLObject, TLRPC.TL_error tL_error) {
        if (tL_error != null && tL_error.text != null) {
            ...
            this._takeoutId = ((ExportRequests$Takeout) tLObject).f319id;
            runnable.run();
        }
    }
    ...
    public /* synthetic */ void lambda$requestMessagesCount$8(int i, TLRPC.messages_Messages messages_messages) {
        ...
        if (size < 0) {
            Segment$$ExternalSyntheticBUOutline1.m992m("Unexpected messagesNotModified received");
    ...
    public /* synthetic */ void lambda$resolveCustomEmoji$12(Runnable runnable, TLObject tLObject, TLRPC.TL_error tL_error) {
        if (tL_error != null) {
            FileLog.m1046e("Export Error: Failed to get documents for emoji.");
            runnable.run();
            return;
        }
        if (tLObject instanceof Vector) {
            ...
            while (i < size) {
                ...
                this._resolvedCustomEmoji.put(Long.valueOf(apiWrap$DocumentParseDocument.f308id), apiWrap$DocumentParseDocument);
            }
            runnable.run();
        }
    }
    ...
    private void loadNextMessageFile() {
        final ExportRequestsController exportRequestsController;
        ...
        while (this._chatProcess.fileIndex < arrayList.size()) {
            ...
            if (DataTypesUtils.SkipMessageByDate(apiWrap$Message, this._settings)) {
                ...
                ExportRequestsController exportRequestsController2 = this;
                exportRequestsController = exportRequestsController2;
                if (!exportRequestsController2.processFileLoad(arrayList.get(this._chatProcess.fileIndex).getFile(), this.currentFileMessageOrigin(), new ExportRequestsController$$ExternalSyntheticLambda1(this), new Utilities.Callback() { // from class: com.exteragram.messenger.export.controllers.ExportRequestsController$$ExternalSyntheticLambda56
                    @Override // org.telegram.messenger.Utilities.Callback
                    public final void run(Object obj) {
                        this.f$0.loadMessageFileDone((String) obj);
                    }
                }, this.currentFileMessage(), null) || !exportRequestsController.processFileLoad(apiWrap$Message.getFile(), exportRequestsController.currentFileMessageOrigin(), new ExportRequestsController$$ExternalSyntheticLambda1(exportRequestsController), new Utilities.Callback() { // from class: com.exteragram.messenger.export.controllers.ExportRequestsController$$ExternalSyntheticLambda57
                    @Override // org.telegram.messenger.Utilities.Callback
                    public final void run(Object obj) {
                        this.f$0.loadMessageThumbDone((String) obj);
                    }
                }, exportRequestsController.currentFileMessage(), null)) {
                    return;
                }
            }
    ...
    private ApiWrap$FileOrigin currentFileMessageOrigin() {
        ...
        return new ApiWrap$FileOrigin(i, inputPeer, currentFileMessage().f310id, 0, 0L);
    }
    ...
    public void loadMessageThumbDone(String str) {
        ...
        if (str.contains("null")) {
            Segment$$ExternalSyntheticBUOutline1.m992m("zdes 1");
            return;
        }
    ...
    private void filePartRefreshReference(final long j) {
        ...
        if (apiWrap$FileOrigin.storyId() != 0) {
            ...
            tL_stories_getStoriesByID.f1461id = new ArrayList<>(Collections.singletonList(Integer.valueOf(apiWrap$FileOrigin.storyId())));
        ...
        if ((apiWrap$FileOrigin.peer() instanceof TLRPC.TL_inputPeerChannel) || (apiWrap$FileOrigin.peer() instanceof TLRPC.TL_inputPeerChannelFromMessage)) {
            ...
            tL_channels_getMessages.f1292id = new ArrayList<>(Collections.singletonList(Integer.valueOf(apiWrap$FileOrigin.messageId())));
        ...
        new TLRPC.TL_messages_getMessages().f1352id = new ArrayList<>(Collections.singletonList(Integer.valueOf(apiWrap$FileOrigin.messageId())));
    ...
    public /* synthetic */ void lambda$filePartRefreshReference$15(long j, TLObject tLObject, TLRPC.TL_error tL_error) {
        if (tL_error != null) {
            this._fileProcess.requestId = 0L;
            FileLog.m1049w("Export Error: File unavailable.");
    ...
    private void filePartExtractReference(final long j, TL_stories.TL_stories_stories tL_stories_stories) {
        ...
        while (i < size) {
            ...
            if (apiWrap$Story2.f313id == this._fileProcess.origin.storyId()) {
                ...
                if (zRefreshFileReference || zRefreshFileReference2) {
                    this._fileProcess.requestId = fileRequest(r8.location, j, new Utilities.Callback2() { // from class: com.exteragram.messenger.export.controllers.ExportRequestsController$$ExternalSyntheticLambda0
                        @Override // org.telegram.messenger.Utilities.Callback2
                        public final void run(Object obj, Object obj2) {
                            this.f$0.lambda$filePartExtractReference$17(j, (TLObject) obj, (TLRPC.TL_error) obj2);
                        }
                    });
                    return;
                }
    ...
    private void filePartExtractReference(final long j, TLRPC.messages_Messages messages_messages) {
        if (messages_messages instanceof TLRPC.TL_messages_messagesNotModified) {
            Segment$$ExternalSyntheticBUOutline1.m992m("wtf, TL_messages_messagesNotModified received!");
            return;
        }
        ...
        while (i < size) {
            ...
            i++;
            ApiWrap$Message apiWrap$Message2 = apiWrap$Message;
            if (apiWrap$Message2.f310id == this._fileProcess.origin.messageId()) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:101:0x00d2, code lost:
        ...
        if (r8 <= r7.offset) goto L106;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void filePartDone(long r7, org.telegram.tgnet.TLObject r9) {
        /*
    ...
    private void loadNextStory() {
        ...
        while (this._storiesProcess.fileIndex < arrayList.size()) {
            ...
            ApiWrap$FileOrigin apiWrap$FileOrigin = new ApiWrap$FileOrigin(0, null, 0, apiWrap$Story.f313id, 0L);
            final ExportRequestsController exportRequestsController = this;
            if (!exportRequestsController.processFileLoad(apiWrap$Story.file(), apiWrap$FileOrigin, new Utilities.CallbackReturn() { // from class: com.exteragram.messenger.export.controllers.ExportRequestsController$$ExternalSyntheticLambda24
            ...
            }, null, apiWrap$Story) || !exportRequestsController.processFileLoad(apiWrap$Story.thumb().file, apiWrap$FileOrigin, new Utilities.CallbackReturn() { // from class: com.exteragram.messenger.export.controllers.ExportRequestsController$$ExternalSyntheticLambda24
                @Override // org.telegram.messenger.Utilities.CallbackReturn
                public final Object run(Object obj) {
                    return Boolean.valueOf(this.f$0.loadStoryProgress((ApiWrap$FileProgress) obj));
                }
            ...
            exportRequestsController._storiesProcess.fileIndex++;
            this = exportRequestsController;
        }
    ...
    public void requestContacts(Utilities.Callback<ApiWrap$ContactsList> callback) {
        ...
        mainRequest(new TLObject() { // from class: com.exteragram.messenger.export.api.ExportRequests$TL_contacts_getSaved
            ...
            public TLObject deserializeResponse(InputSerializedData inputSerializedData, int i, boolean z) {
                Vector vector = new Vector(new C1107x420a2706());
    ...
    public /* synthetic */ void lambda$requestTopPeersSlice$25(TLObject tLObject, TLRPC.TL_error tL_error) {
        if (tLObject instanceof TLRPC.contacts_TopPeers) {
            ...
            if (!DataTypesUtils.AppendTopPeers(this._contactsProcess.result, contacts_toppeers)) {
                GlShader$$ExternalSyntheticBUOutline1.m1250m("Unexpected data in requestTopPeersSlice.");
                return;
            }
    ...
    private void loadNextUserpic() {
        ...
        while (this._userpicsProcess.fileIndex < arrayList.size()) {
            ...
            if (!exportRequestsController.processFileLoad(arrayList.get(this._userpicsProcess.fileIndex).image.file, new ApiWrap$FileOrigin(), new Utilities.CallbackReturn() { // from class: com.exteragram.messenger.export.controllers.ExportRequestsController$$ExternalSyntheticLambda32
                @Override // org.telegram.messenger.Utilities.CallbackReturn
                public final Object run(Object obj) {
    ...
    private void finishUserpicsSlice() {
        ...
        if (!arrayList.isEmpty()) {
            ...
            this._userpicsProcess.maxId = arrayList.get(arrayList.size() - 1).f327id;
    ...
    private void finishMessagesSlice() {
        ...
        if (!apiWrap$MessagesSliceAdjustMigrateMessageIds.list.isEmpty()) {
            ...
            apiWrap$ChatProcess.largestIdPlusOne = arrayList.get(arrayList.size() - 1).f310id + 1;
            ApiWrap$ChatProcess apiWrap$ChatProcess2 = this._chatProcess;
    ...
    private void requestSinglePeerDialog() {
        ...
        if (inputPeer instanceof TLRPC.TL_inputPeerChat) {
            ...
            tL_messages_getChats.f1346id = new ArrayList<>(ImageCapture$$ExternalSyntheticBackport1.m73m(new Object[]{Long.valueOf(((TLRPC.TL_inputPeerChat) inputPeer).chat_id)}));
            ...
            if (inputPeer instanceof TLRPC.TL_inputPeerUserFromMessage) {
                Segment$$ExternalSyntheticBUOutline1.m992m("From message peer in requestSinglePeerDialog.");
            } else if (inputPeer instanceof TLRPC.TL_inputPeerChannelFromMessage) {
                Segment$$ExternalSyntheticBUOutline1.m992m("From message peer in requestSinglePeerDialog.");
            } else if (inputPeer instanceof TLRPC.TL_inputPeerEmpty) {
                Segment$$ExternalSyntheticBUOutline1.m992m("Empty peer in requestSinglePeerDialog.");
            }
        }
    }
    ...
    public /* synthetic */ void lambda$requestSinglePeerDialog$31(TLObject tLObject) {
        if (tLObject instanceof Vector) {
            ...
            DexMaker$$ExternalSyntheticBUOutline0.m217m("not implemnted: ", tLObject);
        }
    }
    ...
    public /* synthetic */ void lambda$requestSinglePeerDialog$33(final Utilities.Callback callback, TLRPC.InputUser inputUser) {
        ...
        tL_users_getUsers.f1400id = new ArrayList<>(ImageCapture$$ExternalSyntheticBackport1.m73m(new Object[]{inputUser}));
    ...
    private int requestSinglePeerMigrated(ApiWrap$DialogInfo apiWrap$DialogInfo) {
        ...
        Buffer$$ExternalSyntheticBUOutline4.m978m("unexpected peer type: ", apiWrap$DialogInfo.input);
        return 0;
    }
    ...
    private ApiWrap$DialogsInfo ParseDialogsInfo(TLRPC.messages_Dialogs messages_dialogs) {
        ...
        ApiWrap$DialogsInfo apiWrap$DialogsInfo = new ApiWrap$DialogsInfo();
        if (messages_dialogs != null) {
            if (messages_dialogs instanceof TLRPC.TL_messages_dialogsNotModified) {
                Segment$$ExternalSyntheticBUOutline1.m992m("unexpected dialogsNotModified in ParseDialogsInfo.");
                return null;
            }
    ...
    private HashMap<String, ApiWrap$Message> ParseMessagesList(long j, ArrayList<TLRPC.Message> arrayList, String str) {
        ...
        while (i < size) {
            ...
            new ApiWrap$MessageId().didAndMsgId = apiWrap$MessageParseMessage.peerId + "_" + apiWrap$MessageParseMessage.f310id;
            linkedHashMap.put(apiWrap$MessageParseMessage.peerId + "_" + apiWrap$MessageParseMessage.f310id, apiWrap$MessageParseMessage);
        }
    ...
    public void requestPersonalInfo(final Utilities.Callback<ApiWrap$ExportPersonalInfo> callback) {
        ...
        tL_users_getFullUser.f1399id = new TLRPC.TL_inputUserSelf();
        mainRequest(tL_users_getFullUser, new Utilities.Callback2() { // from class: com.exteragram.messenger.export.controllers.ExportRequestsController$$ExternalSyntheticLambda10
            @Override // org.telegram.messenger.Utilities.Callback2
            public final void run(Object obj, Object obj2) {
                ExportRequestsController.m2316$r8$lambda$K6Z8Dxak9YlqZ3WIvUBpQOpswQ(callback, (TLObject) obj, (TLRPC.TL_error) obj2);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$K6Z8Dxak9YlqZ-3WIvUBpQOpswQ */
    public static /* synthetic */ void m2316$r8$lambda$K6Z8Dxak9YlqZ3WIvUBpQOpswQ(Utilities.Callback callback, TLObject tLObject, TLRPC.TL_error tL_error) {
        if (tLObject instanceof TLRPC.TL_users_userFull) {
            TLRPC.TL_users_userFull tL_users_userFull = (TLRPC.TL_users_userFull) tLObject;
            if (!tL_users_userFull.users.isEmpty()) {
                callback.run(DataTypesUtils.ParsePersonalInfo(tL_users_userFull));
            } else {
                g$$ExternalSyntheticBUOutline1.m207m("got 0 users in requestPersonalInfo!");
            }
        }
    }
    ...
    public /* synthetic */ void lambda$fileRequest$44(long j, Utilities.Callback2 callback2, TLObject tLObject, TLRPC.TL_error tL_error) {
        if (tL_error != null) {
            ...
            if (Objects.equals(tL_error.text, "TAKEOUT_FILE_EMPTY") && this._otherDataProcess != null) {
                ...
                sb.append(tLObject);
                OkHttpClient$Builder$$ExternalSyntheticBUOutline0.m962m(sb, " error: ", tL_error.text);
                return;
            }
        }
    ...
    public void requestSplitRanges() {
        mainRequest(new TLObject() { // from class: com.exteragram.messenger.export.api.ExportRequests$getSplitRanges
            @Override // org.telegram.tgnet.TLObject
            public TLObject deserializeResponse(InputSerializedData inputSerializedData, int i, boolean z) {
                Vector vector = new Vector(new C1106x420a2705());
                vector.readParams(inputSerializedData, z);
                return vector;
            }
    ...
    public /* synthetic */ void lambda$requestDialogsCount$46(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (size < 0) {
            Segment$$ExternalSyntheticBUOutline1.m992m("unexpected TL_messages_dialogsNotModified received");
            return;
        }
        StartProcess startProcess = this._startProcess;
    ...
    public void invokeFinish(boolean z, final Runnable runnable) {
        ...
        mainRequest(exportRequests$FinishTakeoutSession, new Utilities.Callback2() { // from class: com.exteragram.messenger.export.controllers.ExportRequestsController$$ExternalSyntheticLambda4
            @Override // org.telegram.messenger.Utilities.Callback2
            public final void run(Object obj, Object obj2) {
                ExportRequestsController.m2315$r8$lambda$K5E2oN2LAwJDAki5Obw5XGaixo(runnable, (TLObject) obj, (TLRPC.TL_error) obj2);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$K5E2oN2LAwJDAki5Obw5-XGaixo */
    public static /* synthetic */ void m2315$r8$lambda$K5E2oN2LAwJDAki5Obw5XGaixo(Runnable runnable, TLObject tLObject, TLRPC.TL_error tL_error) {
        runnable.run();
