...
public class ExportActivity extends BasePreferencesActivity implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (i == ExportController.FINISH_NOTIFICATION) {
            BulletinFactory.m1195of(this).createSimpleBulletin(C2702R.raw.contact_check, "Export complete!").show();
            return;
        }
    ...
    protected void onClick(UItem uItem, View view, int i, float f, float f2) {
        ...
        switch (ExportItem.values()[uItem.f2056id - 1].ordinal()) {
            case 1:
                exportActivity = this;
            ...
            case 22:
                ...
                BulletinFactory.m1195of(this).createErrorBulletin("Starting export...").show();
