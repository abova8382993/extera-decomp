...
import com.exteragram.messenger.export.p009ui.ExportMapper;
...
public class ChatViewer extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void updateEmptyPlaceholder() {
        ...
        textView.setPadding(AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(5.0f), AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(5.0f));
        this.emptyView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2702R.string.NoResult)));
    }
        ...
        if (atomicInteger2 != null) {
            ...
            for (File file : new File(this.path).listFiles(new FilenameFilter() { // from class: com.exteragram.messenger.export.ui.ChatViewer$$ExternalSyntheticLambda3
                ...
                public final boolean accept(File file2, String str) {
                    return ChatViewer.m1775$r8$lambda$6DSknWxEQzdmDrzFTcnJnuhpAU(file2, str);
                }
            })) {
    ...
    public static /* synthetic */ boolean m1775$r8$lambda$6DSknWxEQzdmDrzFTcnJnuhpAU(File file, String str) {
    ...
    */
    public /* synthetic */ void lambda$loadMessages$4(java.util.ArrayList r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.exteragram.messenger.export.p009ui.ChatViewer.lambda$loadMessages$4(java.util.ArrayList):void");
    }
    ...
    public View createView(Context context) {
        ...
        ChatAvatarContainer chatAvatarContainer = new ChatAvatarContainer(context, null, false, this.theme) { // from class: com.exteragram.messenger.export.ui.ChatViewer.3
            @Override // org.telegram.p026ui.Components.ChatAvatarContainer
        ...
        TLObject dialogInAnyWay = getDialogInAnyWay(this.chatInfo.f251id, Integer.valueOf(UserConfig.selectedAccount), true);
                ...
                for (int i4 = 0; i4 < childCount; i4++) {
                    ...
                    if (childAt != null && childAt.getVisibility() != 8 && childAt != ((BaseFragment) ChatViewer.this).actionBar) {
                        if (childAt == ChatViewer.this.chatListView || childAt == ChatViewer.this.progressView) {
                            childAt.measure(View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(Math.max(AndroidUtilities.m1081dp(10.0f), paddingTop), TLObject.FLAG_30));
            ...
            */
            protected void onLayout(boolean r10, int r11, int r12, int r13, int r14) {
                /*
                    ...
                    To view this dump change 'Code comments level' option to 'DEBUG'
                */
                throw new UnsupportedOperationException("Method not decompiled: com.exteragram.messenger.export.p009ui.ChatViewer.C09534.onLayout(boolean, int, int, int, int):void");
            }
        ...
        this.emptyViewContainer.setOnTouchListener(new View.OnTouchListener() { // from class: com.exteragram.messenger.export.ui.ChatViewer$$ExternalSyntheticLambda0
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return ChatViewer.m1776$r8$lambda$FCwMhBQq047uSYAuBP2Yay1Zkw(view, motionEvent);
            }
        });
        ...
        this.emptyView.setBackground(Theme.createServiceDrawable(AndroidUtilities.m1081dp(6.0f), this.emptyView, this.contentView));
        ...
        RecyclerListView recyclerListView3 = this.chatListView;
        C09556 c09556 = new C09556(null, this.chatListView, this.theme);
        this.chatListItemAnimator = c09556;
        recyclerListView3.setItemAnimator(c09556);
        ...
        radialProgressView.setSize(AndroidUtilities.m1081dp(28.0f));
    ...
    public static /* synthetic */ boolean m1776$r8$lambda$FCwMhBQq047uSYAuBP2Yay1Zkw(View view, MotionEvent motionEvent) {
        return true;
    }
    ...
    class C09556 extends ChatListItemAnimator {
        Runnable finishRunnable;
        int scrollAnimationIndex;

        C09556(ChatActivity chatActivity, RecyclerListView recyclerListView, Theme.ResourcesProvider resourcesProvider) {
    ...
    private boolean createMenu(final View view, final float f, final float f2) {
        ...
        if (messageObject2.type == 0 || messageObject2.caption != null) {
            arrayList.add(LocaleController.getString(C2702R.string.Copy));
            arrayList3.add(Integer.valueOf(C2702R.drawable.msg_copy));
            arrayList2.add(3);
        }
        if (messageType == 3) {
            ...
            if ((messageMedia instanceof TLRPC.TL_messageMediaWebPage) && MessageObject.isNewGifDocument(messageMedia.webpage.document)) {
                arrayList.add(LocaleController.getString(C2702R.string.SaveToGIFs));
                arrayList3.add(Integer.valueOf(C2702R.drawable.msg_gif));
                arrayList2.add(11);
            }
        } else if (messageType == 4) {
            if (this.selectedObject.isVideo()) {
                arrayList.add(LocaleController.getString(C2702R.string.SaveToGallery));
                arrayList3.add(Integer.valueOf(C2702R.drawable.msg_gallery));
                arrayList2.add(4);
                arrayList.add(LocaleController.getString(C2702R.string.ShareFile));
                arrayList3.add(Integer.valueOf(C2702R.drawable.msg_share));
                arrayList2.add(6);
            } else if (this.selectedObject.isMusic()) {
                arrayList.add(LocaleController.getString(C2702R.string.SaveToMusic));
                arrayList3.add(Integer.valueOf(C2702R.drawable.msg_download));
                arrayList2.add(10);
                arrayList.add(LocaleController.getString(C2702R.string.ShareFile));
                arrayList3.add(Integer.valueOf(C2702R.drawable.msg_share));
                arrayList2.add(6);
                ...
                arrayList.add(LocaleController.getString(C2702R.string.SaveToDownloads));
                arrayList3.add(Integer.valueOf(C2702R.drawable.msg_download));
                arrayList2.add(10);
                arrayList.add(LocaleController.getString(C2702R.string.ShareFile));
                arrayList3.add(Integer.valueOf(C2702R.drawable.msg_share));
            ...
            arrayList.add(LocaleController.getString(C2702R.string.ApplyLocalizationFile));
            arrayList3.add(Integer.valueOf(C2702R.drawable.msg_language));
            arrayList2.add(5);
            arrayList.add(LocaleController.getString(C2702R.string.SaveToDownloads));
            arrayList3.add(Integer.valueOf(C2702R.drawable.msg_download));
            arrayList2.add(10);
            ...
            arrayList.add(LocaleController.getString(C2702R.string.ApplyThemeFile));
            arrayList3.add(Integer.valueOf(C2702R.drawable.msg_theme));
            arrayList2.add(5);
            arrayList.add(LocaleController.getString(C2702R.string.SaveToDownloads));
            arrayList3.add(Integer.valueOf(C2702R.drawable.msg_download));
            arrayList2.add(10);
            ...
            if (this.selectedObject.isMask()) {
                arrayList.add(LocaleController.getString(C2702R.string.AddToMasks));
            } else {
                arrayList.add(LocaleController.getString(C2702R.string.AddToStickers));
            }
            arrayList3.add(Integer.valueOf(C2702R.drawable.msg_sticker));
            arrayList2.add(9);
            ...
            if (user != null && user.f1775id != UserConfig.getInstance(this.currentAccount).getClientUserId() && ContactsController.getInstance(this.currentAccount).contactsDict.get(Long.valueOf(user.f1775id)) == null) {
                arrayList.add(LocaleController.getString(C2702R.string.AddContactTitle));
                arrayList3.add(Integer.valueOf(C2702R.drawable.msg_addcontact));
                arrayList2.add(15);
            }
            if (!TextUtils.isEmpty(this.selectedObject.messageOwner.media.phone_number)) {
                ...
                arrayList3.add(Integer.valueOf(C2702R.drawable.msg_copy));
                arrayList2.add(16);
                arrayList.add(LocaleController.getString(C2702R.string.Call));
                arrayList3.add(Integer.valueOf(C2702R.drawable.msg_calls));
                arrayList2.add(17);
            }
        }
        arrayList.add(LocaleController.getString(C2702R.string.Details));
        arrayList2.add(204);
        arrayList3.add(Integer.valueOf(C2702R.drawable.msg_info));
    ...
    public /* synthetic */ void lambda$createMenu$9(ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, View view, float f, float f2) {
        ...
        final ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout2 = new ActionBarPopupWindow.ActionBarPopupWindowLayout(getParentActivity(), C2702R.drawable.popup_fixed_alert, getResourceProvider(), 1);
        actionBarPopupWindowLayout2.setMinimumWidth(AndroidUtilities.m1081dp(200.0f));
        Rect rect = new Rect();
                    ...
                    final int iAddViewToSwipeBack = actionBarPopupWindowLayout.addViewToSwipeBack(new MessageDetailsPopupWrapper(this, actionBarPopupWindowLayout.getSwipeBack(), this.selectedObject, getResourceProvider()) { // from class: com.exteragram.messenger.export.ui.ChatViewer.9
                        ...
                        protected void copy(String str) {
                            if (AndroidUtilities.addToClipboard(str)) {
                                BulletinFactory.m1195of(ChatViewer.this).createCopyBulletin(LocaleController.getString(C2702R.string.TextCopied)).show();
                            }
                        }
                    }.swipeBack);
                    actionBarMenuSubItem.setRightIcon(C2702R.drawable.msg_arrowright);
        ...
        if (measuredHeight < height) {
            ...
            if (y < this.chatListView.getY() + AndroidUtilities.m1081dp(24.0f)) {
                ...
                if (y > i4 - AndroidUtilities.m1081dp(8.0f)) {
                    y = i4 - AndroidUtilities.m1081dp(8.0f);
                }
            }
        } else {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void processSelectedOption(int r12, java.util.ArrayList r13, org.telegram.ui.ActionBar.ActionBarPopupWindow.ActionBarPopupWindowLayout r14, org.telegram.p026ui.ActionBar.ActionBarMenuSubItem r15) {
        /*
            Method dump skipped, instruction units count: 1098
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.exteragram.messenger.export.p009ui.ChatViewer.processSelectedOption(int, java.util.ArrayList, org.telegram.ui.ActionBar.ActionBarPopupWindow$ActionBarPopupWindowLayout, org.telegram.ui.ActionBar.ActionBarMenuSubItem):void");
    }
    ...
    public void alertUserOpenError(MessageObject messageObject) {
        ...
        if (messageObject.type == 3) {
            builder.setMessage(LocaleController.getString(C2702R.string.NoPlayerInstalled));
        } else {
            builder.setMessage(LocaleController.formatString(C2702R.string.NoHandleAppInstalled, messageObject.getDocument().mime_type));
        }
    ...
    public void showOpenUrlAlert(final String str, boolean z) {
        ...
        builder.setMessage(LocaleController.formatString(C2702R.string.OpenUrlAlert2, str));
        builder.setPositiveButton(LocaleController.getString(C2702R.string.Open), new AlertDialog.OnButtonClickListener() { // from class: com.exteragram.messenger.export.ui.ChatViewer$$ExternalSyntheticLambda8
    ...
    public class ChatActivityAdapter extends RecyclerView.Adapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                chatMessageCell2.setDelegate(new C09591());
        ...
        class C09591 implements ChatMessageCell.ChatMessageCellDelegate {
            ...
            public void didPressCodeCopy(ChatMessageCell chatMessageCell, MessageObject.TextLayoutBlock textLayoutBlock) {
                ...
                BulletinFactory.m1195of(ChatViewer.this).createCopyBulletin(LocaleController.getString(C2702R.string.CodeCopied)).show();
            }
            ...
            public void didPressUserAvatar(ChatMessageCell chatMessageCell, TLRPC.User user, float f, float f2, boolean z) {
                if (user == null || user.f1775id == UserConfig.getInstance(((BaseFragment) ChatViewer.this).currentAccount).getClientUserId()) {
                    return;
                }
                openProfile(user);
            }
            ...
            public boolean didLongPressUserAvatar(final ChatMessageCell chatMessageCell, final TLRPC.User user, float f, float f2) {
                ...
                if (user != null && user.f1775id != UserConfig.getInstance(((BaseFragment) ChatViewer.this).currentAccount).getClientUserId()) {
                    ...
                    TLRPC.UserFull userFull = ChatViewer.this.getMessagesController().getUserFull(user.f1775id);
                    if (userFull == null) {
                        dataM1165of = AvatarPreviewer.Data.m1165of(user, ((BaseFragment) ChatViewer.this).classGuid, menuItemArr);
                    } else {
                    ...
                    if (AvatarPreviewer.canPreview(dataM1165of)) {
                        ...
                        avatarPreviewer.show((ViewGroup) chatViewer.fragmentView, chatViewer.getResourceProvider(), dataM1165of, new AvatarPreviewer.Callback() { // from class: com.exteragram.messenger.export.ui.ChatViewer$ChatActivityAdapter$1$$ExternalSyntheticLambda0
            ...
            public /* synthetic */ void lambda$didLongPressUserAvatar$0(ChatMessageCell chatMessageCell, TLRPC.User user, AvatarPreviewer.MenuItem menuItem) {
                int i = C095015.$SwitchMap$org$telegram$ui$AvatarPreviewer$MenuItem[menuItem.ordinal()];
                if (i == 1) {
            ...
            public void didPressUrl(ChatMessageCell chatMessageCell, CharacterStyle characterStyle, boolean z) {
                ...
                if (characterStyle instanceof URLSpanMono) {
                    ...
                    if (AndroidUtilities.shouldShowClipboardToast()) {
                        Toast.makeText(ChatViewer.this.getParentActivity(), LocaleController.getString(C2702R.string.TextCopied), 0).show();
                    }
                    ...
                    if (z) {
                        ...
                        builder.setItems(new CharSequence[]{LocaleController.getString(C2702R.string.Open), LocaleController.getString(C2702R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: com.exteragram.messenger.export.ui.ChatViewer$ChatActivityAdapter$1$$ExternalSyntheticLambda2
            ...
            */
            public void didPressImage(org.telegram.p026ui.Cells.ChatMessageCell r11, float r12, float r13, boolean r14) {
                /*
                    ...
                    To view this dump change 'Code comments level' option to 'DEBUG'
                */
                throw new UnsupportedOperationException("Method not decompiled: com.exteragram.messenger.export.ui.ChatViewer.ChatActivityAdapter.C09591.didPressImage(org.telegram.ui.Cells.ChatMessageCell, float, float, boolean):void");
            }
            ...
            public boolean didPressAnimatedEmoji(ChatMessageCell chatMessageCell, AnimatedEmojiSpan animatedEmojiSpan) {
                ...
                emojiPacksAlert.setCalcMandatoryInsets(ChatViewer.this.contentView.getKeyboardHeight() > AndroidUtilities.m1081dp(20.0f));
            ...
            public void didLongPressBotButton(ChatMessageCell chatMessageCell, final TLRPC.KeyboardButton keyboardButton) {
                if ((keyboardButton instanceof TLRPC.TL_keyboardButtonSwitchInline) || (keyboardButton instanceof TLRPC.TL_keyboardButtonCallback) || (keyboardButton instanceof TLRPC.TL_keyboardButtonGame) || (keyboardButton instanceof TLRPC.TL_keyboardButtonUrl) || (keyboardButton instanceof TLRPC.TL_keyboardButtonBuy) || (keyboardButton instanceof TLRPC.TL_keyboardButtonUrlAuth) || (keyboardButton instanceof TLRPC.TL_keyboardButtonUserProfile) || (keyboardButton instanceof TLRPC.TL_keyboardButtonCopy) || (keyboardButton instanceof TLRPC.TL_keyboardButtonWebView)) {
                    ...
                    builder.setItems(new CharSequence[]{LocaleController.getString(C2702R.string.CopyTitle), keyboardButton.data != null ? LocaleController.getString(C2702R.string.CopyCallback) : null, !TextUtils.isEmpty(keyboardButton.url) ? LocaleController.getString(C2702R.string.CopyLink) : null, keyboardButton.query != null ? LocaleController.getString(C2702R.string.CopyInlineQuery) : null, keyboardButton.user_id != 0 ? LocaleController.getString(C2702R.string.CopyID) : null}, new DialogInterface.OnClickListener() { // from class: com.exteragram.messenger.export.ui.ChatViewer$ChatActivityAdapter$1$$ExternalSyntheticLambda1
                        @Override // android.content.DialogInterface.OnClickListener
                        public final void onClick(DialogInterface dialogInterface, int i) {
            ...
            public void didLongPressCopyButton(final String str) {
                ...
                builder.setItems(new CharSequence[]{LocaleController.getString(C2702R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: com.exteragram.messenger.export.ui.ChatViewer$ChatActivityAdapter$1$$ExternalSyntheticLambda3
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
            ...
            public /* synthetic */ void lambda$didLongPressCopyButton$3(String str, DialogInterface dialogInterface, int i) {
                AndroidUtilities.addToClipboard(str);
                BulletinFactory.m1195of(ChatViewer.this).createCopyBulletin(LocaleController.formatString(C2702R.string.ExactTextCopied, str)).show();
            }
        }
    ...
    static /* synthetic */ class C095015 {
        ...
        public Pair getDicts() {
            if (this.usersDict == null && this.chatsDict == null) {
                ...
                while (i2 < size) {
                    ...
                    this.usersDict.put(user.f1775id, user);
                }
                ...
                while (i < size2) {
                    ...
                    this.chatsDict.put(chat.f1610id, chat);
                }
            }
