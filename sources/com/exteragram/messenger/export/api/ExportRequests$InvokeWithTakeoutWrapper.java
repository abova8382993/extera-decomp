        ...
        switch (i) {
            ...
            case 481674261:
                ...
                if (tLObject instanceof ExportRequests$getSplitRanges) {
                    vector = new Vector(new C1106x420a2705());
                } else if (tLObject instanceof ExportRequests$TL_contacts_getSaved) {
                    vector = new Vector(new C1107x420a2706());
                } else {
                    vector = tLObject instanceof TLRPC.TL_messages_getCustomEmojiDocuments ? new Vector(new C1108x420a2707()) : null;
                }
                ...
                if (vector == null) {
                    ...
                    CstInsn$$ExternalSyntheticBUOutline0.m219m("unable to deserialize vector with query: ", this.query);
                    return null;
                }
            ...
            default:
                Buffer$$ExternalSyntheticBUOutline4.m978m("cannot deserialize response with constructor: 0x", Integer.toHexString(i));
                return null;
        }
    }
