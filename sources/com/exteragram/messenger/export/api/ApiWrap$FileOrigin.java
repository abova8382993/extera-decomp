...
public final class ApiWrap$FileOrigin extends RecordTag {
    ...
    public final int hashCode() {
        return ApiWrap$FileOrigin$$ExternalSyntheticRecord0.m256m(this.split, this.messageId, this.storyId, this.customEmojiId, this.peer);
    }
    ...
    public final String toString() {
        return Client$ImagePayload$$ExternalSyntheticRecord1.m245m($record$getFieldsAsObjects(), ApiWrap$FileOrigin.class, "split;peer;messageId;storyId;customEmojiId");
    }
