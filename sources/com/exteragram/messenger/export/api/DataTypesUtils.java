...
public abstract class DataTypesUtils {
    ...
    public static int SettingsFromDialogsType(ApiWrap$DialogInfo.Type type) {
        switch (C11052.f316x410af476[type.ordinal()]) {
            case 1:
            case 2:
                return 32;
            case 3:
    ...
    public static ApiWrap$DialogInfo DialogInfoFromUser(ApiWrap$User apiWrap$User) {
        ...
        apiWrap$DialogInfo.peerId = apiWrap$User.f314id.longValue();
    ...
    public static ApiWrap$Chat ParseChat(TLRPC.Chat chat) {
        ...
        if (chat instanceof TLRPC.TL_chat) {
            ...
            apiWrap$Chat.bareId = tL_chat.f1245id;
            ...
            if (chat instanceof TLRPC.TL_channel) {
                ...
                tL_inputPeerChannel.channel_id = tL_channel.f1245id;
            ...
            if (chat instanceof TLRPC.TL_channelForbidden) {
                ...
                apiWrap$Chat.bareId = tL_channelForbidden.f1245id;
                ...
                tL_inputPeerChannel2.channel_id = tL_channelForbidden.f1245id;
    ...
    public static ApiWrap$Message ParseMessage(ApiWrap$ParseMediaContext apiWrap$ParseMediaContext, TLRPC.Message message, String str) {
        ...
        apiWrap$Message.f310id = message.f1271id;
    ...
    private static ApiWrap$Media ParseMedia(ApiWrap$ParseMediaContext apiWrap$ParseMediaContext, TLRPC.MessageMedia messageMedia, String str, int i) {
        ...
        if (messageMedia instanceof TLRPC.TL_messageMediaGame) {
            ...
            if (tL_game != null) {
                apiWrap$Game.f309id = tL_game.f1308id;
        ...
        if (messageMedia instanceof TLRPC.TL_messageMediaPoll) {
            ...
            if (poll instanceof TLRPC.TL_poll) {
                ...
                apiWrap$Poll.f311id = tL_poll.f1279id;
    ...
    public static ApiWrap$Peer EmptyPeer(TLRPC.Peer peer) {
        ...
        Buffer$$ExternalSyntheticBUOutline4.m978m("PeerId in EmptyPeer: ", ExteraConfig.getGSON().toJson(peer));
        return null;
    }
    ...
    public static ApiWrap$WebSession ParseWebSession(TLRPC.TL_webAuthorization tL_webAuthorization, HashMap<Long, ApiWrap$User> map) {
        ...
        return new ApiWrap$WebSession(str, tL_webAuthorization.domain, tL_webAuthorization.browser, tL_webAuthorization.platform, tL_webAuthorization.date_created, tL_webAuthorization.date_active, tL_webAuthorization.f1402ip, tL_webAuthorization.region);
    }
    ...
    public static ApiWrap$Document ParseDocument(ApiWrap$ParseMediaContext apiWrap$ParseMediaContext, TLRPC.Document document, String str, int i) {
        ...
        if (document instanceof TLRPC.TL_document) {
            ...
            apiWrap$Document.f308id = tL_document.f1253id;
            ...
            tL_inputDocumentFileLocation.f1265id = tL_document.f1253id;
            ...
            apiWrap$Document.f308id = ((TLRPC.TL_documentEmpty) document).f1253id;
        }
        return apiWrap$Document;
    }
    ...
    public static boolean RefreshFileReference(TLRPC.InputFileLocation inputFileLocation, TLRPC.InputFileLocation inputFileLocation2) {
        ...
        if (inputFileLocation instanceof TLRPC.TL_inputPhotoFileLocation) {
            if (inputFileLocation.f1265id != inputFileLocation2.f1265id || !Objects.equals(inputFileLocation.thumb_size, inputFileLocation2.thumb_size)) {
                return false;
            }
            inputFileLocation.file_reference = inputFileLocation2.file_reference;
            return true;
        }
        if (!(inputFileLocation instanceof TLRPC.TL_inputDocumentFileLocation) || inputFileLocation.f1265id != inputFileLocation2.f1265id || !Objects.equals(inputFileLocation.thumb_size, inputFileLocation2.thumb_size)) {
            return false;
        }
        inputFileLocation.file_reference = inputFileLocation2.file_reference;
        return true;
    ...
    public static void ParseAttributes(ApiWrap$Document apiWrap$Document, ArrayList<TLRPC.DocumentAttribute> arrayList) {
        ...
        while (i < size) {
            ...
            if (documentAttribute2 instanceof TLRPC.TL_documentAttributeImageSize) {
                ...
                apiWrap$Document.width = tL_documentAttributeImageSize.f1256w;
                apiWrap$Document.height = tL_documentAttributeImageSize.f1255h;
                ...
                apiWrap$Document.width = tL_documentAttributeVideo.f1256w;
                apiWrap$Document.height = tL_documentAttributeVideo.f1255h;
    ...
    public static String ComputeDocumentName(ApiWrap$ParseMediaContext apiWrap$ParseMediaContext, final TLRPC.Document document, int i, String str) {
        if (document == null) {
            g$$ExternalSyntheticBUOutline1.m207m("trying to pass null document!!!");
            return null;
        }
        if (str != null && !str.isEmpty()) {
            return str;
    ...
    private static long getArea(TLRPC.PhotoSize photoSize) {
        ...
        return ((long) photoSize.f1278w) * ((long) photoSize.f1277h);
    }
    ...
    private static ApiWrap$Image ParseDocumentThumb(TLRPC.Document document, String str) {
        ...
        apiWrap$Image.width = photoSize.f1278w;
        apiWrap$Image.height = photoSize.f1277h;
        TLRPC.TL_inputDocumentFileLocation tL_inputDocumentFileLocation = new TLRPC.TL_inputDocumentFileLocation();
    ...
    public static ApiWrap$MessagesSlice AdjustMigrateMessageIds(ApiWrap$MessagesSlice apiWrap$MessagesSlice) {
        ...
        while (i < size) {
            ...
            apiWrap$Message2.f310id -= 1000000000;
    ...
    public static ApiWrap$User ParseUser(TLRPC.User user) {
        ...
        if (user instanceof TLRPC.TL_user) {
            ...
            Long lValueOf = Long.valueOf(tL_user.f1407id);
            ...
            tL_inputUser.user_id = tL_user.f1407id;
        ...
        if (user instanceof TLRPC.TL_userEmpty) {
            ...
            tL_inputUser2.user_id = ((TLRPC.TL_userEmpty) user).f1407id;
    ...
    public static ApiWrap$ContactInfo ParseContactInfo(TLRPC.User user) {
        ...
        if (user instanceof TLRPC.TL_userEmpty) {
            Long lValueOf2 = Long.valueOf(((TLRPC.TL_userEmpty) user).f1407id);
    ...
    public static boolean messageNeedsWrap(ApiWrap$Message apiWrap$Message, HtmlWriter.MessageInfo messageInfo) {
        ...
        if (j != 0 && messageInfo.fromId == j && apiWrap$Message.viaBotId == messageInfo.viaBotId && LocaleController.getInstance().getFormatterYear().format(((long) messageInfo.date) * 1000).trim().equals(LocaleController.getInstance().getFormatterYear().format(((long) apiWrap$Message.date) * 1000).trim()) && apiWrap$Message.forwarded == messageInfo.forwarded && apiWrap$Message.showForwardedAsOriginal == messageInfo.showForwardedAsOriginal && apiWrap$Message.forwardedFromId == messageInfo.forwardedFromId && Objects.equals(apiWrap$Message.forwardedFromName, messageInfo.forwardedFromName)) {
            return Math.abs(apiWrap$Message.date - messageInfo.date) > (((apiWrap$Message.forwardedFromId > 0L ? 1 : (apiWrap$Message.forwardedFromId == 0L ? 0 : -1)) != 0 || !apiWrap$Message.forwardedFromName.isEmpty()) ? 1 : RichMessageLayout.PART_MAX_HEIGHT_DP);
        }
        return true;
    }
    ...
    public static /* synthetic */ class C11052 {
        ...
        static {
            ...
            try {
                f318x9004fd8c[ApiWrap$TextPart.Type.Unknown.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f318x9004fd8c[ApiWrap$TextPart.Type.BankCard.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f318x9004fd8c[ApiWrap$TextPart.Type.Mention.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f318x9004fd8c[ApiWrap$TextPart.Type.Hashtag.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f318x9004fd8c[ApiWrap$TextPart.Type.BotCommand.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f318x9004fd8c[ApiWrap$TextPart.Type.Url.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f318x9004fd8c[ApiWrap$TextPart.Type.Email.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f318x9004fd8c[ApiWrap$TextPart.Type.Bold.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f318x9004fd8c[ApiWrap$TextPart.Type.Italic.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f318x9004fd8c[ApiWrap$TextPart.Type.Code.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f318x9004fd8c[ApiWrap$TextPart.Type.Pre.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f318x9004fd8c[ApiWrap$TextPart.Type.TextUrl.ordinal()] = 13;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f318x9004fd8c[ApiWrap$TextPart.Type.MentionName.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f318x9004fd8c[ApiWrap$TextPart.Type.Phone.ordinal()] = 15;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                f318x9004fd8c[ApiWrap$TextPart.Type.Cashtag.ordinal()] = 16;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                f318x9004fd8c[ApiWrap$TextPart.Type.Underline.ordinal()] = 17;
            } catch (NoSuchFieldError unused17) {
            }
            try {
                f318x9004fd8c[ApiWrap$TextPart.Type.Strike.ordinal()] = 18;
            } catch (NoSuchFieldError unused18) {
            }
            try {
                f318x9004fd8c[ApiWrap$TextPart.Type.Blockquote.ordinal()] = 19;
            } catch (NoSuchFieldError unused19) {
            }
            try {
                f318x9004fd8c[ApiWrap$TextPart.Type.Spoiler.ordinal()] = 20;
            } catch (NoSuchFieldError unused20) {
            }
            try {
                f318x9004fd8c[ApiWrap$TextPart.Type.CustomEmoji.ordinal()] = 21;
            ...
            try {
                f317xd696c439[ApiWrap$File.SkipReason.FileSize.ordinal()] = 2;
            } catch (NoSuchFieldError unused23) {
            }
            try {
                f317xd696c439[ApiWrap$File.SkipReason.FileType.ordinal()] = 3;
            } catch (NoSuchFieldError unused24) {
            }
            try {
                f317xd696c439[ApiWrap$File.SkipReason.None.ordinal()] = 4;
            ...
            try {
                f316x410af476[ApiWrap$DialogInfo.Type.Personal.ordinal()] = 2;
            } catch (NoSuchFieldError unused27) {
            }
            try {
                f316x410af476[ApiWrap$DialogInfo.Type.Bot.ordinal()] = 3;
            } catch (NoSuchFieldError unused28) {
            }
            try {
                f316x410af476[ApiWrap$DialogInfo.Type.PrivateGroup.ordinal()] = 4;
            } catch (NoSuchFieldError unused29) {
            }
            try {
                f316x410af476[ApiWrap$DialogInfo.Type.PrivateSupergroup.ordinal()] = 5;
            } catch (NoSuchFieldError unused30) {
            }
            try {
                f316x410af476[ApiWrap$DialogInfo.Type.PublicSupergroup.ordinal()] = 6;
            } catch (NoSuchFieldError unused31) {
            }
            try {
                f316x410af476[ApiWrap$DialogInfo.Type.PrivateChannel.ordinal()] = 7;
            } catch (NoSuchFieldError unused32) {
            }
            try {
                f316x410af476[ApiWrap$DialogInfo.Type.PublicChannel.ordinal()] = 8;
            } catch (NoSuchFieldError unused33) {
            }
            try {
                f316x410af476[ApiWrap$DialogInfo.Type.Unknown.ordinal()] = 9;
            } catch (NoSuchFieldError unused34) {
            }
            try {
                f316x410af476[ApiWrap$DialogInfo.Type.Replies.ordinal()] = 10;
            } catch (NoSuchFieldError unused35) {
            }
            try {
                f316x410af476[ApiWrap$DialogInfo.Type.VerifyCodes.ordinal()] = 11;
    ...
    public static /* synthetic */ String $r8$lambda$YnixTTMCGZSy3zr12T7r1r9bYeo(String str, String str2, ApiWrap$TextPart apiWrap$TextPart) {
        ...
        switch (C11052.f318x9004fd8c[apiWrap$TextPart.type.ordinal()]) {
            case 1:
            case 2:
            case 3:
    ...
    public static ApiWrap$StoriesSlice ParseStoriesSlice(ArrayList<TL_stories.StoryItem> arrayList, int i) {
        ...
        while (i2 < size) {
            ...
            apiWrap$StoriesSlice.lastId = storyItem2.f1454id;
            ...
            if (!(apiWrap$Media.content instanceof ApiWrap$UnsupportedMedia)) {
                ...
                apiWrap$Story.f313id = storyItem2.f1454id;
    ...
    public static HtmlWriter.Photo ParsePhoto(TLRPC.Photo photo, String str) {
        ...
        if (photo instanceof TLRPC.TL_photoEmpty) {
            photo2.f327id = ((TLRPC.TL_photoEmpty) photo).f1276id;
            return photo2;
        }
        if (photo instanceof TLRPC.TL_photo) {
            TLRPC.TL_photo tL_photo = (TLRPC.TL_photo) photo;
            photo2.f327id = tL_photo.f1276id;
    ...
    private static ApiWrap$Image ParseMaxImage(TLRPC.Photo photo, String str) {
        ...
        while (i < size) {
            ...
            if (!(photoSize2 instanceof TLRPC.TL_photoSizeEmpty) && !(photoSize2 instanceof TLRPC.TL_photoStrippedSize) && !(photoSize2 instanceof TLRPC.TL_photoPathSize)) {
                int i2 = photoSize2.f1278w;
                int i3 = photoSize2.f1277h;
                long j2 = i2 * i3;
                if (j2 > j) {
                    ...
                    if (photoSize2 instanceof TLRPC.TL_photoCachedSize) {
                        apiWrap$File.content = ((TLRPC.TL_photoCachedSize) photoSize2).bytes;
    ...
    public static String ComputeLocationKey(ApiWrap$FileLocation apiWrap$FileLocation) {
        ...
        if (inputFileLocation instanceof TLRPC.TL_inputDocumentFileLocation) {
            return str + "doc_" + ((TLRPC.TL_inputDocumentFileLocation) inputFileLocation).f1265id;
        }
        if (inputFileLocation instanceof TLRPC.TL_inputPhotoFileLocation) {
            return str + "photo_" + ((TLRPC.TL_inputPhotoFileLocation) inputFileLocation).f1265id;
        }
        if (inputFileLocation instanceof ExportRequests$TL_inputTakeoutFileLocation) {
            return str.concat("takeout");
        }
        FileLog.m1046e("wtf! File location type in Export::ComputeLocationKey. " + apiWrap$FileLocation);
        DexMaker$$ExternalSyntheticBUOutline0.m217m("wtf! File location type in ComputeLocationKey.", apiWrap$FileLocation);
        return null;
    }
    ...
    public static String NoFileDescription(ApiWrap$File.SkipReason skipReason) {
        int i = C11052.f317xd696c439[skipReason.ordinal()];
        if (i == 1) {
        ...
        GlShader$$ExternalSyntheticBUOutline1.m1250m("Skip reason in NoFileDescription.");
        return null;
    }
    ...
    public static boolean AppendTopPeers(ApiWrap$ContactsList apiWrap$ContactsList, TLRPC.contacts_TopPeers contacts_toppeers) {
        ...
        Utils$$ExternalSyntheticBUOutline2.m1268m("wtf in appendTopPeers! to: ", apiWrap$ContactsList, " d: ", contacts_toppeers);
        return false;
    }
