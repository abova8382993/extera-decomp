...
public final class ApiWrap$HistoryMessageMarkupButton extends RecordTag {
    ...
    public final int hashCode() {
        return ApiWrap$HistoryMessageMarkupButton$$ExternalSyntheticRecord0.m258m(this.buttonId, this.type, this.text, this.data, this.forwardText);
    }
    ...
    public final String toString() {
        return Client$ImagePayload$$ExternalSyntheticRecord1.m245m($record$getFieldsAsObjects(), ApiWrap$HistoryMessageMarkupButton.class, "type;text;data;forwardText;buttonId");
    }
    ...
    public static String TypeToString(ApiWrap$HistoryMessageMarkupButton apiWrap$HistoryMessageMarkupButton) {
        switch (ApiWrap$1.f306x5e9458ff[apiWrap$HistoryMessageMarkupButton.type.ordinal()]) {
            case 1:
                return "default";
            case 2:
                return "url";
