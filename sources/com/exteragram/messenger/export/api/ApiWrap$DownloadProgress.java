...
public final class ApiWrap$DownloadProgress extends RecordTag {
    ...
    public final int hashCode() {
        return ApiWrap$DownloadProgress$$ExternalSyntheticRecord0.m233m(this.itemIndex, this.randomId, this.ready, this.total, this.path);
    }
    ...
    public final String toString() {
        return AbstractC1011x1d8a54ff.m224m($record$getFieldsAsObjects(), ApiWrap$DownloadProgress.class, "randomId;path;itemIndex;ready;total");
    }
