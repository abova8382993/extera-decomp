...
public class CachePill extends BasePill implements NotificationCenter.NotificationCenterDelegate {
    ...
    public CachePill(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        linearLayout.setPadding(AndroidUtilities.m1124dp(6.0f), 0, AndroidUtilities.m1124dp(8.0f), 0);
    ...
    public int getPillId() {
        return PillStackConfig.PillType.CACHE.f298id;
    }
    ...
    public boolean onPillLongClicked() {
        ...
        ItemOptions.makeOptions(safeLastFragment, this).add(C2888R.drawable.msg2_data, LocaleController.getString(C2888R.string.StorageUsage), new Runnable() { // from class: com.exteragram.messenger.pillstack.ui.pills.system.CachePill$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.openCacheSettings();
            }
        }).addGap().add(C2888R.drawable.msg_retry, LocaleController.getString(C2888R.string.Refresh), new Runnable() { // from class: com.exteragram.messenger.pillstack.ui.pills.system.CachePill$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$onPillLongClicked$3();
            }
        }).add(C2888R.drawable.msg_settings, LocaleController.getString(C2888R.string.Settings), new Runnable() { // from class: com.exteragram.messenger.pillstack.ui.pills.system.CachePill$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private static class StorageProgressDrawable extends Drawable {
        ...
        public void draw(Canvas canvas) {
            ...
            float fMin = Math.min(iWidth, iHeight) - AndroidUtilities.m1124dp(2.0f);
            float f = iWidth;
