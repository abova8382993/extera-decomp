...
public class WeatherPill extends BasePill implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean onPillLongClicked() {
        ...
        ItemOptions.makeOptions(safeLastFragment, this).add(C2797R.drawable.msg_retry, LocaleController.getString(C2797R.string.Refresh), new Runnable() { // from class: com.exteragram.messenger.pillstack.ui.pills.weather.WeatherPill$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$onPillLongClicked$0();
            }
        }).add(C2797R.drawable.msg_settings, LocaleController.getString(C2797R.string.Settings), new Runnable() { // from class: com.exteragram.messenger.pillstack.ui.pills.weather.WeatherPill$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onUpdateData(boolean z) {
        if (PillStackConfig.getUseCurrentLocation()) {
            if (!Weather.isLocationPermissionGranted()) {
                setLocationState(C2797R.string.WeatherLocationPermissionGrant, this.showingWeather);
                return;
            } else if (!Weather.isLocationEnabled()) {
                setLocationState(C2797R.string.WeatherLocationServicesEnable, this.showingWeather);
                return;
            }
        }
        if (z) {
    ...
    private void setLocationState(int i, boolean z) {
        ...
        this.iconView.setImageResource(C2797R.drawable.filled_location);
