...
public class ColoredBackground extends Drawable {
    ...
    public ColoredBackground(int i, int i2) {
        ...
        paint.setShader(new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.m1036dp(28.0f), new int[]{i, i2}, new float[]{0.0f, 1.0f}, tileMode));
        paint2.setStyle(Paint.Style.STROKE);
        paint2.setStrokeWidth(AndroidUtilities.m1036dp(1.0f));
        paint2.setShader(new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.m1036dp(28.0f), new int[]{1308622847, 0, 452984831}, new float[]{0.0f, 0.5f, 1.0f}, tileMode));
    }
