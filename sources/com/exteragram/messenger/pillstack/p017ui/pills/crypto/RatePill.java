...
public abstract class RatePill extends BasePill implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void onPillClicked() {
        if (this.iconView.getVisibility() == 0 && this.textView.getText() != null && TextUtils.equals(this.textView.getText(), LocaleController.getString(C2797R.string.Retry))) {
            onUpdateData(true);
        } else {
            onPillLongClicked();
        }
    ...
    public boolean onPillLongClicked() {
        ...
        final ItemOptions itemOptionsAddGap = itemOptionsMakeOptions.makeSwipeback(true).add(C2797R.drawable.ic_ab_back, LocaleController.getString(C2797R.string.Back), new RatePill$$ExternalSyntheticLambda1(itemOptionsMakeOptions)).addGap();
        ...
        actionBarMenuSubItem.setTextAndIcon(LocaleController.getString(C2797R.string.CryptoPillTargetCurrency), C2797R.drawable.msg_language);
        ...
        itemOptionsMakeOptions.add(actionBarMenuSubItem).addGap().add(C2797R.drawable.msg_retry, LocaleController.getString(C2797R.string.Refresh), new Runnable() { // from class: com.exteragram.messenger.pillstack.ui.pills.crypto.RatePill$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$onPillLongClicked$2();
            }
        }).add(C2797R.drawable.msg_settings, LocaleController.getString(C2797R.string.Settings), new Runnable() { // from class: com.exteragram.messenger.pillstack.ui.pills.crypto.RatePill$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private void setErrorState(boolean z) {
        ...
        this.iconView.setImageResource(C2797R.drawable.msg_retry);
        this.iconView.setVisibility(0);
        this.textView.setText(LocaleController.getString(C2797R.string.Retry), z);
        this.textView.setVisibility(0);
    }
