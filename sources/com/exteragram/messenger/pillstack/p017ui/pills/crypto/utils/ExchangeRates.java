...
public abstract class ExchangeRates {
    ...
    public static final class State extends RecordTag {
        ...
        public final String toString() {
            return Client$ImagePayload$$ExternalSyntheticRecord1.m245m($record$getFieldsAsObjects(), State.class, "usdRates");
        }
    ...
    /* JADX INFO: renamed from: com.exteragram.messenger.pillstack.ui.pills.crypto.utils.ExchangeRates$1 */
    public class C11811 implements Callback {
        @Override // okhttp3.Callback
        public void onFailure(Call call, IOException iOException) {
            FileLog.m1048e(iOException);
            ExchangeRates.complete(ExchangeRates.getCached());
    ...
    public static void complete(final State state) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: com.exteragram.messenger.pillstack.ui.pills.crypto.utils.ExchangeRates$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                ExchangeRates.m2498$r8$lambda$N2ze8JRy2FQCLLaC_XD27HNkyw(arrayList, state);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$N2-ze8JRy2FQCLLaC_XD27HNkyw */
    public static /* synthetic */ void m2498$r8$lambda$N2ze8JRy2FQCLLaC_XD27HNkyw(ArrayList arrayList, State state) {
