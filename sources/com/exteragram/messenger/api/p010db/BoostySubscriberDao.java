...
public interface BoostySubscriberDao {
    ...
    @DebugMetadata(m1083c = "com.exteragram.messenger.api.db.BoostySubscriberDao", m1084f = "BoostySubscriberDao.kt", m1085l = {34, 35}, m1086m = "replaceSubscribers$suspendImpl", m1087v = 1)
    ...
    public abstract /* synthetic */ class CC {
        ...
        */
        public static /* synthetic */ java.lang.Object replaceSubscribers$suspendImpl(com.exteragram.messenger.api.p010db.BoostySubscriberDao r5, java.util.List r6, kotlin.coroutines.Continuation r7) {
            /*
                boolean r0 = r7 instanceof com.exteragram.messenger.api.p010db.BoostySubscriberDao.C10401
                if (r0 == 0) goto L13
                r0 = r7
                com.exteragram.messenger.api.db.BoostySubscriberDao$replaceSubscribers$1 r0 = (com.exteragram.messenger.api.p010db.BoostySubscriberDao.C10401) r0
                int r1 = r0.label
            ...
            L18:
                ...
                com.exteragram.messenger.api.db.BoostySubscriberDao r5 = (com.exteragram.messenger.api.p010db.BoostySubscriberDao) r5
            ...
            L6e:
                ...
                return r5
            */
            throw new UnsupportedOperationException("Method not decompiled: com.exteragram.messenger.api.p010db.BoostySubscriberDao.CC.replaceSubscribers$suspendImpl(com.exteragram.messenger.api.db.BoostySubscriberDao, java.util.List, kotlin.coroutines.Continuation):java.lang.Object");
        }
    }
