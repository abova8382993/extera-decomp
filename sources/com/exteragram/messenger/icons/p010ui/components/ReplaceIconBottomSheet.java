...
public class ReplaceIconBottomSheet extends BottomSheet {
    ...
    */
    public /* synthetic */ void lambda$loadDrawables$1(android.content.Context r12) throws java.lang.Throwable {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.exteragram.messenger.icons.p010ui.components.ReplaceIconBottomSheet.lambda$loadDrawables$1(android.content.Context):void");
    }
    ...
    public /* synthetic */ void lambda$loadDrawables$0(Drawable drawable, int i, int i2, Drawable drawable2, int i3, int i4) {
        ...
        if (buttonWithCounterView != null) {
            buttonWithCounterView.setText(LocaleController.getString(this.newDrawable != null ? C2702R.string.Reset : C2702R.string.Cancel), false);
        }
    ...
    private View createView(final Context context) {
        ...
        linearLayout2.setPadding(AndroidUtilities.m1081dp(16.0f), 0, AndroidUtilities.m1081dp(16.0f), 0);
        ...
        linearLayout4.setPadding(AndroidUtilities.m1081dp(16.0f), 0, AndroidUtilities.m1081dp(16.0f), AndroidUtilities.m1081dp(16.0f));
        ButtonWithCounterView buttonWithCounterView = new ButtonWithCounterView(context, true, this.resourcesProvider);
        buttonWithCounterView.setRound();
        buttonWithCounterView.setText(LocaleController.getString(C2702R.string.Save), false);
        ...
        this.resetButton.setText(LocaleController.getString(this.iconPack.getIcons().get(this.resourceName) != null ? C2702R.string.Reset : C2702R.string.Cancel), false);
    ...
    public /* synthetic */ void lambda$createView$5(final Context context, View view) {
        ...
        ItemOptions.makeOptions(this.containerView, view).addIf(z, C2702R.drawable.msg_copy, LocaleController.getString(C2702R.string.PasteFromClipboard), new Runnable() { // from class: com.exteragram.messenger.icons.ui.components.ReplaceIconBottomSheet$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$createView$2(clipboardManager, context);
            }
        }).add(C2702R.drawable.msg_photos, LocaleController.getString(C2702R.string.SelectFromGallery), new Runnable() { // from class: com.exteragram.messenger.icons.ui.components.ReplaceIconBottomSheet$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$createView$3(parentActivity);
            }
        }).add(C2702R.drawable.msg2_folder, LocaleController.getString(C2702R.string.StoryMusicSelectFromFiles), new Runnable() { // from class: com.exteragram.messenger.icons.ui.components.ReplaceIconBottomSheet$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
    ...
    */
    public /* synthetic */ void lambda$processSelectedImage$11(android.content.Context r12, android.net.Uri r13) throws java.lang.Throwable {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.exteragram.messenger.icons.p010ui.components.ReplaceIconBottomSheet.lambda$processSelectedImage$11(android.content.Context, android.net.Uri):void");
    }
    ...
    private static class IconInfoView extends LinearLayout {
        ...
        public IconInfoView(Context context, boolean z) {
            ...
            borderedImageView.setPadding(AndroidUtilities.m1081dp(6.0f), AndroidUtilities.m1081dp(6.0f), AndroidUtilities.m1081dp(6.0f), AndroidUtilities.m1081dp(6.0f));
    ...
    private static class ArrowView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            float fM1081dp = AndroidUtilities.m1081dp(18.0f);
            this.path.reset();
            float f = fM1081dp / 2.0f;
            this.path.moveTo(width - f, height);
            float f2 = width + f;
            this.path.lineTo(f2, height);
            this.path.moveTo(f2 - AndroidUtilities.m1081dp(7.0f), height - AndroidUtilities.m1081dp(7.0f));
            this.path.lineTo(f2, height);
            this.path.lineTo(f2 - AndroidUtilities.m1081dp(7.0f), height + AndroidUtilities.m1081dp(7.0f));
    ...
    public static class BorderedImageView extends ImageView {
        ...
        public BorderedImageView(Context context, AttributeSet attributeSet) {
            ...
            this.path = new Path();
            this.rect = new RectF();
            this.cornerRadius = AndroidUtilities.m1081dp(12.0f);
            ...
            paint3.setPathEffect(new DashPathEffect(new float[]{AndroidUtilities.m1081dp(8.0f), AndroidUtilities.m1081dp(8.0f)}, 0.0f));
        }
