...
public class IconPackPreviewView extends View {
    private static final int[] DEFAULT_ICONS = {C2702R.drawable.msg_sticker, C2702R.drawable.msg_link2, C2702R.drawable.msg_pin, C2702R.drawable.msg_photos};
    ...
    public IconPackPreviewView(Context context) {
        ...
        this.cols = 2;
        this.count = 4;
        this.iconSize = AndroidUtilities.m1081dp(20.0f);
        this.gap = AndroidUtilities.m1081dp(4.0f);
        this.isCircularMode = false;
        this.circInnerRadius = AndroidUtilities.m1081dp(46.0f);
        this.circInnerIconSize = AndroidUtilities.m1081dp(24.0f);
        this.circOuterRadius = AndroidUtilities.m1081dp(72.0f);
        this.circOuterIconSize = AndroidUtilities.m1081dp(20.0f);
        this.circCenterSize = AndroidUtilities.m1081dp(36.0f);
    ...
    protected void onMeasure(int i, int i2) {
        if (this.isCircularMode) {
            setMeasuredDimension(View.getDefaultSize(getSuggestedMinimumWidth(), i), View.resolveSize(((this.circOuterRadius + (this.circOuterIconSize / 2)) * 2) + AndroidUtilities.m1081dp(8.0f), i2));
        } else {
        ...
        if (this.currentPack != iconPack || this.availableIconIds.isEmpty() || this.availableIconIds.size() < this.count) {
            ...
            if (iconPack.isBase()) {
                ...
                if (arrayList.isEmpty()) {
                    this.availableIconIds.add(Integer.valueOf(C2702R.drawable.msg_media));
                } else {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.count == 4) {
            ...
            if (i == 1) {
                ...
                drawIcon(canvas, 0, (getWidth() - iM1081dp) / 2, (getHeight() - iM1081dp) / 2, iM1081dp, 1.0f);
                return;
            }
            if (i == 2) {
                int iM1081dp2 = AndroidUtilities.m1081dp(20.0f);
                int iM1081dp3 = AndroidUtilities.m1081dp(4.0f);
                int height = (getHeight() - iM1081dp2) / 2;
                drawIcon(canvas, 0, 0, height, iM1081dp2, 1.0f);
                drawIcon(canvas, 1, iM1081dp2 + iM1081dp3, height, iM1081dp2, 1.0f);
                return;
            }
            if (i == 3) {
                int iM1081dp4 = AndroidUtilities.m1081dp(20.0f);
                int iM1081dp5 = AndroidUtilities.m1081dp(4.0f);
                drawIcon(canvas, 0, 0, 0, iM1081dp4, 1.0f);
                int i2 = iM1081dp4 + iM1081dp5;
                drawIcon(canvas, 1, i2, 0, iM1081dp4, 1.0f);
                drawIcon(canvas, 2, (getWidth() - iM1081dp4) / 2, i2, iM1081dp4, 1.0f);
                return;
            }
            int iM1081dp6 = AndroidUtilities.m1081dp(20.0f);
            int iM1081dp7 = iM1081dp6 + AndroidUtilities.m1081dp(4.0f);
            drawIcon(canvas, 0, 0, 0, iM1081dp6, 1.0f);
            drawIcon(canvas, 1, iM1081dp7, 0, iM1081dp6, 1.0f);
            drawIcon(canvas, 2, 0, iM1081dp7, iM1081dp6, 1.0f);
            drawIcon(canvas, 3, iM1081dp7, iM1081dp7, iM1081dp6, 1.0f);
            return;
        }
