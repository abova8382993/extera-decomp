...
public class IconPacksActivity extends BasePreferencesActivity implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        fragmentFloatingButton.imageView.setImageResource(C2702R.drawable.msg_add);
        this.floatingButton.setContentDescription(LocaleController.getString(C2702R.string.Add));
    ...
    public String getTitle() {
        return LocaleController.getString(C2702R.string.IconPacks);
    }
    ...
    protected void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        arrayList.add(UItem.asHeader(LocaleController.getString(C2702R.string.BasePacks)));
        ...
        arrayList.add(UItem.asShadow(LocaleController.getString(C2702R.string.BaseIconPackInfo)));
        ArrayList arrayList3 = ExteraConfig.iconPacksLayout;
        int size2 = arrayList3.size();
        int i3 = 0;
        while (true) {
        ...
        if (z) {
            universalAdapter.whiteSectionStart();
            arrayList.add(UItem.asHeader(LocaleController.getString(C2702R.string.EnabledPacks)));
            ArrayList arrayList4 = ExteraConfig.iconPacksLayout;
            int size3 = arrayList4.size();
            int i4 = 0;
            int i5 = 0;
        ...
        if (z2) {
            ...
            universalAdapter.whiteSectionStart();
            arrayList.add(UItem.asHeader(LocaleController.getString(C2702R.string.AllPacks)));
        ...
        if (z || z2) {
            arrayList.add(UItem.asShadow(LocaleController.getString(C2702R.string.IconPacksHint)));
        }
    }
    ...
    protected boolean onLongClick(UItem uItem, View view, int i, float f, float f2) {
        ...
        if (obj instanceof IconPack) {
            ...
            ItemOptions.makeOptions(this, view).addIf(ExteraConfig.iconPacksLayout.contains(id), C2702R.drawable.msg_edit, LocaleController.getString(C2702R.string.Edit), new Runnable() { // from class: com.exteragram.messenger.icons.ui.IconPacksActivity$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onLongClick$3(iconPack);
                }
            }).add(C2702R.drawable.msg_share, LocaleController.getString(C2702R.string.ShareFile), new Runnable() { // from class: com.exteragram.messenger.icons.ui.IconPacksActivity$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onLongClick$6(iconPack);
                }
            }).add(C2702R.drawable.msg_delete, (CharSequence) LocaleController.getString(C2702R.string.Delete), true, new Runnable() { // from class: com.exteragram.messenger.icons.ui.IconPacksActivity$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public /* synthetic */ void lambda$onLongClick$4(File file) {
        ...
        intent.addFlags(1);
        getParentActivity().startActivity(Intent.createChooser(intent, LocaleController.getString(C2702R.string.ShareFile)));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onLongClick$8(final IconPack iconPack) {
        AlertDialog alertDialogCreate = new AlertDialog.Builder(getParentActivity(), getResourceProvider()).setTitle(LocaleController.getString(C2702R.string.DeletePack)).setMessage(AndroidUtilities.replaceTags(LocaleController.formatString(C2702R.string.DeletePackInfo, iconPack.getName()))).setPositiveButton(LocaleController.getString(C2702R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: com.exteragram.messenger.icons.ui.IconPacksActivity$$ExternalSyntheticLambda7
