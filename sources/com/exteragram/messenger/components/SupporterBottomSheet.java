...
public class SupporterBottomSheet extends BottomSheet {
    public SupporterBottomSheet(final BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider) {
        ...
        rLottieImageView.setImageResource(C2888R.drawable.extera_heart_large);
        rLottieImageView.setColorFilter(new PorterDuffColorFilter(-1, PorterDuff.Mode.SRC_IN));
        rLottieImageView.setBackground(Theme.createCircleDrawable(AndroidUtilities.m1124dp(80.0f), ContextCompat.getColor(parentActivity, C2888R.color.ic_background)));
        linearLayout.addView(rLottieImageView, LayoutHelper.createLinear(80, 80, 1, 0, 28, 0, 0));
        TextView textView = new TextView(parentActivity);
        textView.setText(LocaleController.getString(C2888R.string.SupportDevelopment));
        ...
        textView2.setText(LocaleController.getString(C2888R.string.SupportDevelopmentInfo));
        ...
        final FeatureCell featureCell = new FeatureCell(parentActivity, C2888R.drawable.menu_feature_paid, LocaleController.getString(C2888R.string.MakeDonation), _UrlKt.FRAGMENT_ENCODE_SET);
        ...
        linearLayout.addView(new FeatureCell(parentActivity, C2888R.drawable.menu_feature_wallpaper, LocaleController.getString(C2888R.string.SendProof), AndroidUtilities.replaceSingleTag(LocaleController.getString(C2888R.string.SendProofInfo), Theme.key_chat_messageLinkIn, 0, new Runnable() { // from class: com.exteragram.messenger.components.SupporterBottomSheet$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$new$2(baseFragment);
            }
        })), LayoutHelper.createLinear(-1, -2, 0.0f, 0, 0, 16, 0, 0));
        linearLayout.addView(new FeatureCell(parentActivity, C2888R.drawable.menu_feature_reactions, LocaleController.getString(C2888R.string.ReceiveBadge), LocaleController.getString(C2888R.string.ReceiveBadgeInfo)), LayoutHelper.createLinear(-1, -2, 0.0f, 0, 0, 16, 0, 0));
    ...
    public /* synthetic */ void lambda$new$1(float f, String str, final BaseFragment baseFragment, FeatureCell featureCell, ExchangeRates.State state) {
        ...
        SpannableStringBuilder spannableStringBuilderReplaceSingleTag = AndroidUtilities.replaceSingleTag(LocaleController.formatString(C2888R.string.MakeDonationInfo, str, str2 + ", " + str3), Theme.key_chat_messageLinkIn, 0, new Runnable() { // from class: com.exteragram.messenger.components.SupporterBottomSheet$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    class FeatureCell extends FrameLayout {
