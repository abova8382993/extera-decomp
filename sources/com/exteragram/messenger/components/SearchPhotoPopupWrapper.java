...
public class SearchPhotoPopupWrapper {
     ...
     */
    public SearchPhotoPopupWrapper(Context context, final PopupSwipeBackLayout popupSwipeBackLayout, final Utilities.Callback2<String, Boolean> callback2) {
        ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout = new ActionBarPopupWindow.ActionBarPopupWindowLayout(context, 0, null);
        this.searchSwipeBackLayout = actionBarPopupWindowLayout;
        actionBarPopupWindowLayout.setFitItems(true);
        ActionBarMenuSubItem actionBarMenuSubItemAddItem = ActionBarMenuItem.addItem(this.searchSwipeBackLayout, C2797R.drawable.msg_arrow_back, LocaleController.getString(C2797R.string.Back), false, null);
        ...
        linksTextView.setText(LocaleController.getString(C2797R.string.SearchPhotoInfo));
