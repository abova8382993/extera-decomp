...
public abstract class BoostyBottomSheet extends BottomSheet {
    ...
    public BoostyBottomSheet(final Context context, final List<BoostySubscriberDTO> list) {
        super(context, false);
        this.ITEM_HEIGHT = AndroidUtilities.m1036dp(48.0f);
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: com.exteragram.messenger.components.BoostyBottomSheet.2
            ...
            public void onMeasure(int i2, int i3) {
                ...
                if (!zIsTablet) {
                    boolean z = ((BottomSheet) boostyBottomSheet).isPortrait;
                ...
                super.onMeasure(i2, View.MeasureSpec.makeMeasureSpec(BoostyBottomSheet.this.contentHeight + AndroidUtilities.m1036dp(2.0f), TLObject.FLAG_30));
                this.rectF.set(0.0f, AndroidUtilities.m1036dp(2.0f), getMeasuredWidth(), getMeasuredHeight() + AndroidUtilities.m1036dp(18.0f));
                BoostyBottomSheet.this.starDrawable.rect.set(0.0f, AndroidUtilities.m1036dp(2.0f), getMeasuredWidth(), getMeasuredHeight());
                BoostyBottomSheet.this.starDrawable.rect2.set(-AndroidUtilities.m1036dp(15.0f), -AndroidUtilities.m1036dp(15.0f), getMeasuredWidth() + AndroidUtilities.m1036dp(15.0f), getMeasuredHeight() + AndroidUtilities.m1036dp(15.0f));
            ...
            public void dispatchDraw(Canvas canvas) {
                ...
                this.rectF.set(0.0f, AndroidUtilities.m1036dp(2.0f), getMeasuredWidth(), getMeasuredHeight() + AndroidUtilities.m1036dp(18.0f));
                paint.setShader(new RadialGradient(this.rectF.centerX(), this.rectF.centerY() - AndroidUtilities.m1036dp(9.0f), Math.max(this.rectF.width(), this.rectF.height()) / 2.0f, -830418, -2536663, Shader.TileMode.CLAMP));
                canvas.save();
                canvas.clipRect(0, AndroidUtilities.m1036dp(2.0f), getMeasuredWidth(), getMeasuredHeight());
                float f = fM1036dp - 1.0f;
        ...
        recyclerListView.setOnScrollListener(new C10775());
        ...
        this.descriptionView.setText(AndroidUtilities.replaceTags(new SpannableStringBuilder(LocaleController.getString(C2797R.string.BoostyInfo)).append((CharSequence) "\n").append((CharSequence) LocaleController.getString(C2797R.string.BoostyInfo2))));
        linearLayout.addView(this.descriptionView, LayoutHelper.createLinear(-2, -2, 1, 20, 6, 20, 0));
        ButtonWithCounterView buttonWithCounterView = new ButtonWithCounterView(context, this.resourcesProvider);
        this.buttonView = buttonWithCounterView;
        buttonWithCounterView.setRound();
        SpannableStringBuilder spannableStringBuilderAppend = new SpannableStringBuilder(LocaleController.getString(C2797R.string.Open)).append((CharSequence) "  Boosty");
        ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C2797R.drawable.boosty_icon, 2);
        coloredImageSpan.setSize(AndroidUtilities.m1036dp(20.0f));
    ...
    public class C10775 extends RecyclerView.OnScrollListener {
        public C10775() {
        }
