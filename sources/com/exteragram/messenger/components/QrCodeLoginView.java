...
public abstract class QrCodeLoginView extends SlideView {
    ...
    public QrCodeLoginView(Context context) {
        ...
        textView.setText(LocaleController.getString(C2888R.string.LoginQrTitle));
        ...
        textView2.setText(LocaleController.getString(C2888R.string.LoginQrSubtitle));
    ...
    public String getHeaderName() {
        return LocaleController.getString(C2888R.string.LoginQrTitle);
    }
    ...
    static class QrRenderView extends View {
        ...
        QrRenderView(Context context) {
            ...
            paint.setShader(new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.m1124dp(140.0f), new int[]{-1, 0}, new float[]{0.0f, 1.0f}, tileMode));
            PorterDuff.Mode mode = PorterDuff.Mode.DST_OUT;
            paint.setXfermode(new PorterDuffXfermode(mode));
            paint2.setShader(new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.m1124dp(140.0f), new int[]{0, -1}, new float[]{0.0f, 1.0f}, tileMode));
        ...
        private void drawLoading(Canvas canvas, int i, int i2, float f) {
            ...
            if (rLottieDrawable == null) {
                RLottieDrawable rLottieDrawable2 = new RLottieDrawable(C2888R.raw.qr_matrix, "qr_matrix", AndroidUtilities.m1124dp(200.0f), AndroidUtilities.m1124dp(200.0f));
            ...
            if (bitmap == null) {
                this.qrLogo = SvgHelper.getBitmap(AndroidUtilities.readRes(null, C2888R.raw.qr_logo), i5, i5, false);
                this.qrLogoSize = i5;
