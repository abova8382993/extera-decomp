...
public class GenerateFromMessageBottomSheet extends BottomSheet {
    ...
    public GenerateFromMessageBottomSheet(String str, final String str2, BaseFragment baseFragment, Context context, final Utilities.Callback<GenerationData> callback, boolean z) {
        ...
        outlineTextContainerView.setText(LocaleController.getString(C2797R.string.RolePrompt));
        ...
        editTextBoldCursor.setPadding(iM1036dp, 0, iM1036dp, 0);
        ...
        textView.setText(LocaleController.getString(C2797R.string.MessageHistory));
        ...
        textView2.setText(LocaleController.getString(C2797R.string.AttachPhoto));
        ...
        linearLayout3.setPadding(AndroidUtilities.m1036dp(8.0f), AndroidUtilities.m1036dp(6.0f), AndroidUtilities.m1036dp(6.0f), AndroidUtilities.m1036dp(6.0f));
        ...
        buttonWithCounterView.setText(LocaleController.getString(C2797R.string.Proceed), false);
        ...
        setTitle(LocaleController.getString(C2797R.string.Generate), true);
    }
    ...
    public static final class GenerationData extends RecordTag {
        ...
        public final int hashCode() {
            return AbstractC1042x1d8a54ff.m247m(this.useHistory, this.prompt, this.imagePath);
        }
        ...
        public final String toString() {
            return Client$ImagePayload$$ExternalSyntheticRecord1.m245m($record$getFieldsAsObjects(), GenerationData.class, "prompt;useHistory;imagePath");
        }
