package com.exteragram.messenger.p011ai.p012ui;
...
import com.exteragram.messenger.p011ai.p012ui.GenerateFromMessageBottomSheet;
...
public abstract class AiResponseAlert extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    private AiResponseAlert(Context context, final Client client, String str, String str2, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        linksTextView.setPadding(AndroidUtilities.m1036dp(22.0f), AndroidUtilities.m1036dp(12.0f), AndroidUtilities.m1036dp(22.0f), AndroidUtilities.m1036dp(6.0f));
        ...
        recyclerListView.setPadding(0, AndroidUtilities.statusBarHeight + AndroidUtilities.m1036dp(56.0f), 0, AndroidUtilities.m1036dp(80.0f));
        ...
        recyclerListView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: com.exteragram.messenger.ai.ui.AiResponseAlert.3
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int i2) {
                ...
                if ((i2 == 0 || i2 == 2) && AiResponseAlert.this.getSheetTop(false) > 0.0f && AiResponseAlert.this.getSheetTop(false) < AndroidUtilities.m1036dp(96.0f) && AiResponseAlert.this.listView.canScrollVertically(1) && AiResponseAlert.this.hasEnoughHeight()) {
    ...
    private Markwon createMarkwon(Context context) {
        ...
        return Markwon.builderNoCore(context).usePlugin(CorePlugin.create().hasExplicitMovementMethod(true)).usePlugin(new AbstractMarkwonPlugin() { // from class: com.exteragram.messenger.ai.ui.AiResponseAlert.5
            ...
            public void configureTheme(MarkwonTheme.Builder builder) {
                MarkwonTheme.Builder builderCodeBlockTextSize = builder.linkColor(themedColor2).isLinkUnderlined(false).blockMargin(AndroidUtilities.m1036dp(16.0f)).blockQuoteWidth(AndroidUtilities.m1036dp(3.0f)).blockQuoteColor(themedColor2).listItemColor(themedColor).bulletListItemStrokeWidth(AndroidUtilities.m1036dp(1.0f)).bulletWidth(AndroidUtilities.m1036dp(4.0f)).codeTextColor(themedColor).codeBlockTextColor(themedColor).codeBackgroundColor(iBlendARGB).codeBlockBackgroundColor(iBlendARGB2).codeBlockMargin(AndroidUtilities.m1036dp(12.0f)).codeTextSize(AndroidUtilities.m1036dp((int) (SharedConfig.fontSize * 0.92f))).codeBlockTextSize(AndroidUtilities.m1036dp((int) (SharedConfig.fontSize * 0.92f)));
                Typeface typeface = Typeface.MONOSPACE;
                builderCodeBlockTextSize.codeTypeface(typeface).codeBlockTypeface(typeface).headingBreakHeight(0).headingBreakColor(Theme.multAlpha(themedColor, 0.12f)).headingTextSizeMultipliers(new float[]{1.25f, 1.18f, 1.12f, 1.06f, 1.0f, 1.0f}).thematicBreakColor(Theme.multAlpha(themedColor, 0.12f)).thematicBreakHeight(AndroidUtilities.m1036dp(1.0f));
            }
            ...
            public final void configureTheme(TableTheme.Builder builder) {
                int i = iMultAlpha;
                builder.tableCellPadding(AndroidUtilities.m1036dp(8.0f)).tableBorderWidth(AndroidUtilities.m1036dp(1.0f)).tableBorderColor(i).tableHeaderRowBackgroundColor(iMultAlpha2).tableOddRowBackgroundColor(iMultAlpha3);
            }
    ...
    public static AiResponseAlert showAlert(BaseFragment baseFragment, Client client, String str, String str2, boolean z, boolean z2, Utilities.CallbackReturn<URLSpan, Boolean> callbackReturn, final Runnable runnable, Utilities.Callback2<String, CharSequence> callback2) {
        AiResponseAlert aiResponseAlert = new AiResponseAlert(baseFragment.getContext(), client, str, str2, z, baseFragment.getResourceProvider()) { // from class: com.exteragram.messenger.ai.ui.AiResponseAlert.6
            @Override // com.exteragram.messenger.p011ai.p012ui.AiResponseAlert, org.telegram.p035ui.ActionBar.BottomSheet, android.app.Dialog, android.content.DialogInterface, org.telegram.ui.ActionBar.BaseFragment.AttachedSheet
    ...
    private void formatPrompt() {
        ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C2797R.drawable.msg_mini_arrow_mediathin);
        ...
        spannableStringBuilder.setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m1036dp(4.0f)), 1, 2, 33);
    ...
    public void generate() {
        ...
        stopThinking();
        if (AiConfig.getReasoningEnabled() && AiConfig.getResponseStreaming()) {
            showThinking();
        }
        this.currentRequestId = this.client.getResponse(this.prompt, this.useHistory, AiConfig.getResponseStreaming(), this.imagePath, new GenerationCallback() { // from class: com.exteragram.messenger.ai.ui.AiResponseAlert.7
            ...
            public void onError(int i, String str) {
                AiResponseAlert.this.stopThinking();
                AiController.showErrorBulletin(((BottomSheet) AiResponseAlert.this).containerView, ((BottomSheet) AiResponseAlert.this).resourcesProvider, i);
                AiResponseAlert.this.adapter.updateMainView(AiResponseAlert.this.textViewContainer);
    ...
    public static class ThinkingDotsView extends View {
        ...
        @Override // android.view.View
        public void onMeasure(int i, int i2) {
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m1036dp(42.0f));
        }
        ...
        public void onSizeChanged(int i, int i2, int i3, int i4) {
            ...
            DrawableUtils.setBounds(this.drawable, AndroidUtilities.m1036dp(22.0f), i2 / 2.0f, 19);
        }
    ...
    public class HeaderView extends FrameLayout {
        ...
        public HeaderView(Context context) {
            ...
            imageView2.setImageResource(C2797R.drawable.msg_send);
            ...
            ActionBarMenuItem actionBarMenuItem = new ActionBarMenuItem(context, null, 0, i3, false, ((BottomSheet) AiResponseAlert.this).resourcesProvider);
            ...
            actionBarMenuItem.setBackground(Theme.createSelectorDrawable(AiResponseAlert.this.getThemedColor(i2), 1, AndroidUtilities.m1036dp(18.0f)));
            addView(actionBarMenuItem, LayoutHelper.createFrame(48, 54.0f, 53, 1.0f, 1.0f, 16.0f, 1.0f));
            actionBarMenuItem.addSubItem(1, C2797R.drawable.msg_copy, LocaleController.getString(C2797R.string.Copy));
            actionBarMenuItem.addSubItem(2, C2797R.drawable.msg_retry, LocaleController.getString(C2797R.string.Retry));
            actionBarMenuItem.addSubItem(3, C2797R.drawable.msg_edit, LocaleController.getString(C2797R.string.Edit));
            if (AiResponseAlert.this.useHistory) {
                actionBarMenuItem.addSubItem(4, C2797R.drawable.menu_reply, LocaleController.getString(C2797R.string.Reply));
            }
            ...
            animatedTextView.setTextSize(AndroidUtilities.m1036dp(20.0f));
            ...
            AnimatedTextView animatedTextView2 = new AnimatedTextView(context) { // from class: com.exteragram.messenger.ai.ui.AiResponseAlert.HeaderView.1
                ...
                public void onDraw(Canvas canvas) {
                    ...
                    rectF.set(0.0f, (getHeight() - AndroidUtilities.m1036dp(18.0f)) / 2.0f, width(), (getHeight() + AndroidUtilities.m1036dp(18.0f)) / 2.0f);
                ...
                public boolean onTouchEvent(MotionEvent motionEvent) {
                    if (motionEvent.getAction() == 0) {
                        LinkSpanDrawable linkSpanDrawable = new LinkSpanDrawable(null, ((BottomSheet) AiResponseAlert.this).resourcesProvider, motionEvent.getX(), motionEvent.getY());
            ...
            animatedTextView2.setPadding(AndroidUtilities.m1036dp(4.0f), AndroidUtilities.m1036dp(2.0f), AndroidUtilities.m1036dp(4.0f), AndroidUtilities.m1036dp(2.0f));
        ...
        public /* synthetic */ void lambda$new$5(int i) {
            if (i == 1) {
                ...
                if (AndroidUtilities.addToClipboard(aiResponseAlert.getRawResponse(aiResponseAlert.currentResponse))) {
                    BulletinFactory.m1142of((FrameLayout) ((BottomSheet) AiResponseAlert.this).containerView, ((BottomSheet) AiResponseAlert.this).resourcesProvider).createCopyBulletin(LocaleController.getString(C2797R.string.TextCopied)).show();
                    return;
                }
                return;
            }
        ...
        public void openModelSelect() {
            ...
            ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout = new ActionBarPopupWindow.ActionBarPopupWindowLayout(getContext()) { // from class: com.exteragram.messenger.ai.ui.AiResponseAlert.HeaderView.2
                ...
                public void onMeasure(int i, int i2) {
                    if (services.size() >= 6) {
                        super.onMeasure(i, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1036dp(336.0f), TLObject.FLAG_30));
                    } else {
                        super.onMeasure(i, i2);
                    }
                }
            ...
            while (i < services.size()) {
                ...
                ActionBarMenuSubItem actionBarMenuSubItem = new ActionBarMenuSubItem(getContext(), 2, i == 0, i == services.size() - 1, ((BottomSheet) AiResponseAlert.this).resourcesProvider);
                actionBarMenuSubItem.setText(service.getModel());
                actionBarMenuSubItem.setSubtext(service.getUrl());
                actionBarMenuSubItem.subtextView.setPadding(0, 0, service.isSelected() ? AndroidUtilities.m1036dp(34.0f) : 0, 0);
            ...
            int i2 = iArr[1];
            actionBarPopupWindow.showAtLocation(((BottomSheet) AiResponseAlert.this).containerView, 51, iArr[0] - AndroidUtilities.m1036dp(8.0f), ((float) i2) > (((float) AndroidUtilities.displaySize.y) * 0.9f) - ((float) measuredHeight) ? (i2 - measuredHeight) + AndroidUtilities.m1036dp(8.0f) : (i2 + this.modelSelector.getMeasuredHeight()) - AndroidUtilities.m1036dp(8.0f));
        }
        ...
        private void updateLightStatusBar(boolean z) {
            ...
            if (bool == null || bool.booleanValue() != z) {
                ...
                if (z) {
                    ...
                    iBlendOver = Theme.blendOver(aiResponseAlert.getThemedColor(Theme.key_actionBarDefault), AndroidUtilities.DARK_STATUS_BAR_OVERLAY);
                }
