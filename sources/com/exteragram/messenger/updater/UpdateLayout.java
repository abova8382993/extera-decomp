...
public class UpdateLayout extends IUpdateLayout {
    ...
    @Override // org.telegram.p029ui.IUpdateLayout
    public void updateFileProgress(Object[] objArr) {
        ...
        this.updateTextView.setText(LocaleController.formatString(C2888R.string.AppUpdateDownloading, Integer.valueOf((int) (fLongValue * 100.0f))));
    }
    ...
    public void createUpdateUI(final int i) {
        ...
        this.updateLayout.setTranslationY(AndroidUtilities.m1124dp(44.0f));
        ...
        AnimatedTextView animatedTextView = new AnimatedTextView(this.activity, true, true, true) { // from class: com.exteragram.messenger.updater.UpdateLayout.1
            ...
            protected void onDraw(Canvas canvas) {
                UpdateLayout.this.updateSizeTextView.setBounds(0, 0, getMeasuredWidth() - AndroidUtilities.m1124dp(20.0f), getMeasuredHeight());
                UpdateLayout.this.updateSizeTextView.draw(canvas);
                canvas.save();
                canvas.translate(AndroidUtilities.m1124dp(15.0f), 0.0f);
                super.onDraw(canvas);
                canvas.translate(((getMeasuredWidth() - width()) / 2.0f) - AndroidUtilities.m1124dp(30.0f), AndroidUtilities.m1124dp(11.0f));
        ...
        this.updateTextView.setText(LocaleController.getString(C2888R.string.AppUpdateBeta), false);
        ...
        this.updateLayoutIcon.setProgressRect(0, 0, AndroidUtilities.m1124dp(22.0f), AndroidUtilities.m1124dp(22.0f));
        this.updateLayoutIcon.setCircleRadius(AndroidUtilities.m1124dp(11.0f));
        ...
        this.updateSizeTextView.setTextSize(AndroidUtilities.m1124dp(14.0f));
