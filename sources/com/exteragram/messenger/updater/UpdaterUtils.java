...
public abstract class UpdaterUtils {
        ...
        while (true) {
            ...
            if ((message2 instanceof TLRPC.TL_message) && ((message2.message.startsWith("update_test") && BadgesController.INSTANCE.isDeveloper()) || ((message2.message.startsWith("update_lite_beta") && BuildVars.isBetaApp() && BuildVars.IS_LITE_VERSION) || ((message2.message.startsWith("update_lite_stable") && !BuildVars.isBetaApp() && BuildVars.IS_LITE_VERSION) || ((message2.message.startsWith("update_beta") && BuildVars.isBetaApp() && !BuildVars.IS_LITE_VERSION) || (message2.message.startsWith("update_stable") && !BuildVars.isBetaApp() && !BuildVars.IS_LITE_VERSION)))))) {
                ...
                if (strArrSplit.length >= 6) {
                    ...
                    tL_help_appUpdate.f1311id = message2.f1271id;
                    i = i5;
                }
            }
        }
            ...
            if (message4 instanceof TLRPC.TL_message) {
                if (message4.f1271id == i3) {
                    ...
                    if (messageMedia != null) {
                        ...
                        if (message4.f1271id == i && !document.attributes.isEmpty() && document.attributes.get(0).file_name.endsWith(".apk")) {
                            tL_help_appUpdate.document = document;
                            tL_help_appUpdate.flags |= 2;
                        } else if (message4.f1271id == i2 && MessageObject.isStickerDocument(document)) {
    ...
    private static void showInstallDialog(Activity activity) {
        ...
        textView.setText(LocaleController.getString(C2797R.string.UpdateInstalling));
        ...
        if (Build.VERSION.SDK_INT < 29 || Settings.canDrawOverlays(activity)) {
            string = LocaleController.getString(C2797R.string.UpdateInstallingRelaunch);
        } else {
            string = LocaleController.getString(C2797R.string.UpdateInstallingNotification);
        }
    ...
    private static void handleInstallError(Activity activity, File file, IOException iOException) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: com.exteragram.messenger.updater.UpdaterUtils$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                UpdaterUtils.m2672$r8$lambda$JrnIHfIWjS4z_PFGN622PKVTCU();
            }
        });
        AlertsCreator.createSimpleAlert(activity, LocaleController.getString(C2797R.string.ErrorOccurred) + "\n" + iOException.getLocalizedMessage()).show();
    ...
    public static /* synthetic */ void m2672$r8$lambda$JrnIHfIWjS4z_PFGN622PKVTCU() {
        AlertDialog alertDialog = dialog;
        if (alertDialog != null) {
            alertDialog.dismiss();
            dialog = null;
            ...
            if (context instanceof LaunchActivity) {
                ((LaunchActivity) context).showBulletin(new Function() { // from class: com.exteragram.messenger.updater.UpdaterUtils$InstallReceiver$$ExternalSyntheticLambda0
                    ...
                    public final Object apply(Object obj) {
                        return ((BulletinFactory) obj).createErrorBulletin(LocaleController.formatString(C2797R.string.UpdateFailedToInstall, Integer.valueOf(intent.getIntExtra("android.content.pm.extra.STATUS", 1))));
                    }
                });
            }
        }
    ...
    public static class UpdateReceiver extends BroadcastReceiver {
        ...
        private void showNotification(Context context, Intent intent) {
            NotificationChannelCompat notificationChannelCompatBuild = new NotificationChannelCompat.Builder("updated", 4).setName(LocaleController.getString(C2797R.string.UpdateApp)).setLightsEnabled(false).setVibrationEnabled(false).setSound(null, null).build();
            ...
            notificationManagerCompatFrom.notify(8732833, new NotificationCompat.Builder(context, "updated").setSmallIcon(IconManager.getNotificationIcon()).setColor(AppUtils.getNotificationColor()).setShowWhen(false).setContentText(LocaleController.getString(C2797R.string.UpdateInstalledNotification)).setCategory("status").setContentIntent(PendingIntent.getActivity(context, 0, intent, 201326592)).build());
        }
    }
}
