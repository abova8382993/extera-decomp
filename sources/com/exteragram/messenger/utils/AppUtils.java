...
public class AppUtils {
    ...
    /* JADX INFO: renamed from: com.exteragram.messenger.utils.AppUtils$1 */
    /* JADX INFO: loaded from: classes4.dex */
    public class C12341 implements ExclusionStrategy {
        @Override // com.google.gson.ExclusionStrategy
        public boolean shouldSkipField(FieldAttributes fieldAttributes) {
            if (fieldAttributes.getDeclaringClass().getPackage() == null) {
                return false;
    ...
    private static void logInternal(String str, Throwable th, int i) {
        StackTraceElement stackTraceElement = Thread.currentThread().getStackTrace()[Math.max(3, Math.min(i, r0.length - 1))];
    ...
    public static boolean compareVersions(String str, String str2, String str3) {
        ...
        switch (str) {
            ...
            case ">=":
                return iCompareVersionValues >= 0;
            default:
                g$$ExternalSyntheticBUOutline1.m207m("Unsupported operator: ".concat(str));
                return false;
        }
    }
