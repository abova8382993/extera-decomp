...
public abstract class SystemUtils {
    ...
    public static boolean hasBiometrics() {
        ...
        if (i >= 29) {
            BiometricManager biometricManagerM286m = SystemUtils$$ExternalSyntheticApiModelOutline1.m286m(ApplicationLoader.applicationContext.getSystemService(SystemUtils$$ExternalSyntheticApiModelOutline0.m285m()));
            if (biometricManagerM286m == null) {
                return false;
            }
            return i >= 30 ? biometricManagerM286m.canAuthenticate(255) == 0 : biometricManagerM286m.canAuthenticate() == 0;
        }
    ...
    public static class ExternalApp {
        ...
        private String fetchName() throws PackageManager.NameNotFoundException {
            ...
            try {
                ...
                string = LocaleController.getString(C2888R.string.NumberUnknown);
            }
        ...
        private Drawable fetchIcon() {
            try {
                return new BitmapDrawable(ApplicationLoader.applicationContext.getResources(), UIUtil.drawableToBitmap(ApplicationLoader.applicationContext.getPackageManager().getApplicationIcon(this.packageName), AndroidUtilities.m1124dp(24.0f), AndroidUtilities.m1124dp(24.0f)));
            } catch (Exception unused) {
                return ContextCompat.getDrawable(ApplicationLoader.applicationContext, C2888R.drawable.msg_media);
            }
        }
