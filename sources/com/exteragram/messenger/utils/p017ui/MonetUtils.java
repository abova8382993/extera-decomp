...
public final class MonetUtils {
    ...
    static {
        ...
        map.put("mBlack", Integer.valueOf(C2888R.color.black));
        map.put("mWhite", Integer.valueOf(C2888R.color.white));
        map.put("mRed200", Integer.valueOf(C2888R.color.mRed200));
        map.put("mRed500", Integer.valueOf(C2888R.color.mRed500));
        map.put("mRed800", Integer.valueOf(C2888R.color.mRed800));
        map.put("mGreen200", Integer.valueOf(C2888R.color.mGreen200));
        map.put("mGreen500", Integer.valueOf(C2888R.color.mGreen500));
        map.put("mGreen800", Integer.valueOf(C2888R.color.mGreen800));
  ...
  0x00c4: PHI (r15v2 'colorString' java.lang.String) = (r15v0 'colorString' java.lang.String), (r15v5 'colorString' java.lang.String) binds: [B:6:0x001a, B:16:0x0038] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public static final int getColor(java.lang.String r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.exteragram.messenger.utils.p017ui.MonetUtils.getColor(java.lang.String):int");
    }
