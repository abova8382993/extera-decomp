...
import org.telegram.p029ui.ChannelAdminLogActivity;
    ...
    */
    ...
    public static void uploadImageTemporary(final File file, final Utilities.Callback callback) {
        utilsQueue.postRunnable(new Runnable() { // from class: com.exteragram.messenger.utils.chats.ChatUtils$$ExternalSyntheticLambda8
            ...
            public final void run() {
                ChatUtils.m2794$r8$lambda$s0B85LvTHTSh4H75cP4h2cOGmc(file, callback);
            }
        });
    }

    /* JADX INFO: renamed from: $r8$lambda$s0B85LvTH-TSh4H75cP4h2cOGmc, reason: not valid java name */
    public static /* synthetic */ void m2794$r8$lambda$s0B85LvTHTSh4H75cP4h2cOGmc(File file, Utilities.Callback callback) {
        try {
    ...
    public static /* synthetic */ void $r8$lambda$33_JiIM6Ii58qn96m_myB3_Dg3w(ImgurUtils.ImgurResponse imgurResponse) {
        try {
            ...
            FileLog.m1134e("Unable to delete uploaded image with hash " + imgurResponse.deleteHash + ", URL: " + imgurResponse.imageUrl);
        } catch (Exception e) {
            FileLog.m1136e(e);
        }
    }
    ...
    public String getName(long j) {
        ...
        return j == getUserConfig().getClientUserId() ? LocaleController.getString(C2888R.string.SavedMessages) : name;
    }
    ...
    public Runnable sendInlineBotRequest(final TLRPC.User user, final String str, final boolean z, final Utilities.Callback callback, final Utilities.Callback callback2) {
        ...
        final String str2 = "bot_inline_query_" + user.f1825id + "_" + str;
    ...
    public /* synthetic */ void lambda$searchUser$11(final Utilities.Callback callback, TLRPC.messages_BotResults messages_botresults) {
        ...
        for (String str : strArrSplit) {
            ...
            if (strTrim.startsWith("🆔")) {
                tL_user.f1825id = Utilities.parseLong(strTrim.replaceAll("\\D+", _UrlKt.FRAGMENT_ENCODE_SET).trim()).longValue();
            ...
            if (strTrim.startsWith("🆔")) {
                try {
                    ...
                    if (String.valueOf(jLongValue).startsWith("-100")) {
                        tL_channel.f1660id = Long.parseLong(String.valueOf(jLongValue).substring(4));
                    } else {
                        tL_channel.f1660id = jLongValue;
                    }
