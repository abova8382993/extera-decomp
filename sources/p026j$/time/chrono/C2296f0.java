...
public final class C2296f0 extends AbstractC2285a implements Serializable {

    /* JADX INFO: renamed from: c */
    public static final C2296f0 f770c = new C2296f0();
    ...
    public final List mo701A() {
        return AbstractC2283b.m674c(EnumC2302i0.values());
    }
    ...
    public final InterfaceC2305l mo702C(int i) {
        if (i == 0) {
            return EnumC2302i0.BEFORE_BE;
        }
        if (i == 1) {
            return EnumC2302i0.f780BE;
        }
    ...
    public final int mo703D(InterfaceC2305l interfaceC2305l, int i) {
        if (interfaceC2305l instanceof EnumC2302i0) {
            return interfaceC2305l == EnumC2302i0.f780BE ? i : 1 - i;
        }
    ...
    public final InterfaceC2287b mo704H(InterfaceC2376l interfaceC2376l) {
        return interfaceC2376l instanceof C2300h0 ? (C2300h0) interfaceC2376l : new C2300h0(LocalDate.m588G(interfaceC2376l));
    }

    @Override // p026j$.time.chrono.InterfaceC2304k
    /* JADX INFO: renamed from: L */
    public final InterfaceC2287b mo705L() {
        return new C2300h0(LocalDate.m588G(LocalDate.m589c0(AbstractC2283b.m675d())));
    }

    @Override // p026j$.time.chrono.InterfaceC2304k
    /* JADX INFO: renamed from: Q */
    public final InterfaceC2287b mo706Q(int i, int i2, int i3) {
        return new C2300h0(LocalDate.m593of(i - 543, i2, i3));
    }
    ...
    public final InterfaceC2287b mo685S(Map map, EnumC2350z enumC2350z) {
        return (C2300h0) super.mo685S(map, enumC2350z);
    }
    ...
    public final InterfaceC2287b mo708r(long j) {
        return new C2300h0(LocalDate.m590d0(j));
    }
    ...
    public final InterfaceC2287b mo710x(int i, int i2) {
        return new C2300h0(LocalDate.m591e0(i - 543, i2));
    }

    @Override // p026j$.time.chrono.InterfaceC2304k
    /* JADX INFO: renamed from: z */
    public final C2384t mo711z(EnumC2365a enumC2365a) {
        int i = AbstractC2294e0.f767a[enumC2365a.ordinal()];
        if (i == 1) {
            C2384t c2384t = EnumC2365a.PROLEPTIC_MONTH.f942b;
            return C2384t.m847f(c2384t.f965a + 6516, c2384t.f968d + 6516);
        }
        if (i == 2) {
            C2384t c2384t2 = EnumC2365a.YEAR.f942b;
            return C2384t.m848g((-(c2384t2.f965a + 543)) + 1, c2384t2.f968d + 543);
        }
        if (i != 3) {
            return enumC2365a.f942b;
        }
        C2384t c2384t3 = EnumC2365a.YEAR.f942b;
        return C2384t.m847f(c2384t3.f965a + 543, c2384t3.f968d + 543);
    }
}
