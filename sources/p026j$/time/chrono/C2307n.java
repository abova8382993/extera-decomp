...
public final class C2307n extends AbstractC2285a implements Serializable {

    /* JADX INFO: renamed from: l */
    public static final C2307n f786l;
    private static final long serialVersionUID = 3127340209035924785L;

    /* JADX INFO: renamed from: c */
    public volatile transient boolean f787c;

    /* JADX INFO: renamed from: d */
    public transient int[] f788d;

    /* JADX INFO: renamed from: e */
    public transient int f789e;

    /* JADX INFO: renamed from: f */
    public transient int f790f;

    /* JADX INFO: renamed from: g */
    public transient int f791g;

    /* JADX INFO: renamed from: h */
    public transient int f792h;

    /* JADX INFO: renamed from: i */
    public transient int f793i;

    /* JADX INFO: renamed from: j */
    public transient int f794j;

    /* JADX INFO: renamed from: k */
    public transient int f795k;

    static {
        C2307n c2307n = new C2307n();
        f786l = c2307n;
        AbstractC2285a.m680B(c2307n, "Hijrah");
        AbstractC2285a.m680B(c2307n, "islamic");
    }

    /* JADX INFO: renamed from: b0 */
    public static int[][] m722b0() {
    ...
    public final List mo701A() {
        return AbstractC2283b.m674c(EnumC2310q.values());
    }
    ...
    public final InterfaceC2305l mo702C(int i) {
        ...
        C2351g.m796a("invalid Hijrah era");
        return null;
    }
    ...
    public final int mo703D(InterfaceC2305l interfaceC2305l, int i) {
        if (interfaceC2305l instanceof EnumC2310q) {
            return i;
        }
    ...
    public final InterfaceC2287b mo704H(InterfaceC2376l interfaceC2376l) {
        return interfaceC2376l instanceof C2309p ? (C2309p) interfaceC2376l : new C2309p(this, interfaceC2376l.mo572k(EnumC2365a.EPOCH_DAY));
    }

    @Override // p026j$.time.chrono.InterfaceC2304k
    /* JADX INFO: renamed from: L */
    public final InterfaceC2287b mo705L() {
        return new C2309p(this, LocalDate.m589c0(AbstractC2283b.m675d()).mo572k(EnumC2365a.EPOCH_DAY));
    }

    @Override // p026j$.time.chrono.InterfaceC2304k
    /* JADX INFO: renamed from: Q */
    public final InterfaceC2287b mo706Q(int i, int i2, int i3) {
        return new C2309p(this, i, i2, i3);
    }
    ...
    public final InterfaceC2287b mo685S(Map map, EnumC2350z enumC2350z) {
        return (C2309p) super.mo685S(map, enumC2350z);
    }
    ...
    public final void m723X() {
        if (this.f787c) {
            return;
        }
        try {
            HashMap map = new HashMap();
            int[][] iArrM722b0 = m722b0();
            int iMo595J = (int) LocalDate.m593of(1882, 11, 12).mo595J();
            for (int i = 1300; i <= 1600; i++) {
                int[] iArr = iArrM722b0[i - 1300];
                if (iArr.length != 12) {
            ...
            this.f791g = 15600;
            this.f789e = iMo595J;
            int[] iArrM724Y = m724Y(iMo595J, map);
            this.f788d = iArrM724Y;
            this.f790f = iArrM724Y[3612];
            for (int i2 = 1300; i2 < 1600; i2++) {
                int iM727c0 = m727c0(i2, 12);
                this.f794j = Math.min(this.f794j, iM727c0);
                this.f795k = Math.max(this.f795k, iM727c0);
            }
            this.f787c = true;
        } catch (Exception e) {
            throw new C2284c("Unable to initialize HijrahCalendar: Hijrah-umalqura", e);
        }
    }

    /* JADX INFO: renamed from: Y */
    public final int[] m724Y(int i, Map map) {
        ...
        for (int i3 = 1300; i3 <= 1600; i3++) {
            ...
            while (i4 < 12) {
                ...
                i += i5;
                this.f792h = Math.min(this.f792h, i5);
                this.f793i = Math.max(this.f793i, i5);
                i4++;
                i2 = i6;
            }
        }
    ...
    public final long m725Z(int i, int i2, int i3) {
        m723X();
        if (i2 < 1 || i2 > 12) {
            C2351g.m797b("Invalid Hijrah month: ", i2);
            return 0L;
        }
        int i4 = (i2 - 1) + ((i * 12) - this.f791g);
        if (i4 < 0 || i4 >= this.f788d.length) {
            throw new C2284c("Invalid Hijrah date, year: " + i + ", month: " + i2);
        }
        if (i3 < 1 || i3 > m726a0(i, i2)) {
            C2351g.m797b("Invalid Hijrah day of month: ", i3);
            return 0L;
        }
        return (i3 - 1) + this.f788d[i4];
    }

    /* JADX INFO: renamed from: a0 */
    public final int m726a0(int i, int i2) {
        int i3 = (i2 - 1) + ((i * 12) - this.f791g);
        if (i3 >= 0) {
            int[] iArr = this.f788d;
            if (i3 < iArr.length) {
    ...
    public final int m727c0(int i, int i2) {
        int i3 = (i * 12) - this.f791g;
        int[] iArr = this.f788d;
    ...
    public final InterfaceC2287b mo710x(int i, int i2) {
        C2309p c2309p = new C2309p(this, i, 1, 1);
        if (i2 <= c2309p.f797a.m727c0(c2309p.f798b, 12)) {
            return c2309p.mo687G(i2 - 1);
        }
        C2351g.m797b("Invalid dayOfYear: ", i2);
        return null;
    }
    ...
    public final C2384t mo711z(EnumC2365a enumC2365a) {
        ...
        switch (AbstractC2306m.f785a[enumC2365a.ordinal()]) {
            case 1:
                return C2384t.m848g(this.f792h, this.f793i);
            case 2:
                return C2384t.m847f(1L, this.f795k);
            case 3:
                return C2384t.m847f(1L, 5L);
            case 4:
            case 5:
                int i = this.f791g;
                return C2384t.m847f(i / 12, (((this.f788d.length - 1) + i) / 12) - 1);
            case 6:
                return C2384t.m847f(1L, 1L);
            default:
                return enumC2365a.f942b;
        }
    }
