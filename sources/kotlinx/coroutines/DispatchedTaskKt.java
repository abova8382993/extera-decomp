...
public abstract class DispatchedTaskKt {
    ...
    public static final void resume(DispatchedTask dispatchedTask, Continuation continuation, boolean z) {
        ...
        Object objM3604constructorimpl = Result.m3604constructorimpl(successfulResult$kotlinx_coroutines_core);
        if (z) {
            ...
            try {
                dispatchedContinuation.continuation.resumeWith(objM3604constructorimpl);
        ...
        continuation.resumeWith(objM3604constructorimpl);
    }
