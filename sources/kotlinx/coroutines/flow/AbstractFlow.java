...
public abstract class AbstractFlow implements Flow {
    ...
    static final class C26141 extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C26141(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public final java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector r6, kotlin.coroutines.Continuation r7) throws java.lang.Throwable {
        /*
            r5 = this;
            boolean r0 = r7 instanceof kotlinx.coroutines.flow.AbstractFlow.C26141
            if (r0 == 0) goto L13
            r0 = r7
            kotlinx.coroutines.flow.AbstractFlow$collect$1 r0 = (kotlinx.coroutines.flow.AbstractFlow.C26141) r0
            int r1 = r0.label
