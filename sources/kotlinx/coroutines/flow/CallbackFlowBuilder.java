...
final class CallbackFlowBuilder extends ChannelFlowBuilder {
    ...
    static final class C26151 extends ContinuationImpl {
        ...
        C26151(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    protected java.lang.Object collectTo(kotlinx.coroutines.channels.ProducerScope r5, kotlin.coroutines.Continuation r6) {
        /*
            r4 = this;
            boolean r0 = r6 instanceof kotlinx.coroutines.flow.CallbackFlowBuilder.C26151
            if (r0 == 0) goto L13
            r0 = r6
            kotlinx.coroutines.flow.CallbackFlowBuilder$collectTo$1 r0 = (kotlinx.coroutines.flow.CallbackFlowBuilder.C26151) r0
            int r1 = r0.label
