...
final class StateFlowSlot extends AbstractSharedFlowSlot {
    ...
    public final void makePending() {
        ...
        while (true) {
            ...
            if (value == StateFlowKt.NONE) {
                if (AbstractC1272xa830b30.m315m(this._state, value, StateFlowKt.PENDING)) {
                    return;
                }
            } else if (AbstractC1272xa830b30.m315m(this._state, value, StateFlowKt.NONE)) {
                Result.Companion companion = Result.Companion;
                ((CancellableContinuationImpl) value).resumeWith(Result.m3604constructorimpl(Unit.INSTANCE));
                return;
            }
        }
    }
    ...
    public final Object awaitPending(Continuation continuation) {
        ...
        if (!AbstractC1272xa830b30.m315m(this._state, StateFlowKt.NONE, cancellableContinuationImpl)) {
            Result.Companion companion = Result.Companion;
