...
public final class SafeCollector<T> extends ContinuationImpl implements FlowCollector<T>, CoroutineStackFrame {
    ...
    public SafeCollector(FlowCollector<? super T> flowCollector, CoroutineContext coroutineContext) {
        ...
        this.collectContextSize = ((Number) coroutineContext.fold(0, new Function2() { // from class: kotlinx.coroutines.flow.internal.SafeCollector$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj, Object obj2) {
                return Integer.valueOf(SafeCollector.$r8$lambda$idxg0bEmSgrK6v2pQsR7xybd4HY(((Integer) obj).intValue(), (CoroutineContext.Element) obj2));
            }
        })).intValue();
    }
    ...
    public static int $r8$lambda$idxg0bEmSgrK6v2pQsR7xybd4HY(int i, CoroutineContext.Element element) {
        return i + 1;
    }
    ...
    public Object invokeSuspend(Object result) {
        Throwable thM3497exceptionOrNullimpl = Result.m3497exceptionOrNullimpl(result);
        if (thM3497exceptionOrNullimpl != null) {
            this.lastEmissionContext = new DownstreamExceptionContext(thM3497exceptionOrNullimpl, get$context());
        }
        Continuation<? super Unit> continuation = this.completion_;
