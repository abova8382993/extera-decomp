...
public abstract class ChannelFlow implements FusibleFlow {
    ...
    */
    ...
    static final class C26392 extends SuspendLambda implements Function2 {
        ...
        C26392(FlowCollector flowCollector, ChannelFlow channelFlow, Continuation continuation) {
        ...
        public final Continuation create(Object obj, Continuation continuation) {
            C26392 c26392 = new C26392(this.$collector, this.this$0, continuation);
            c26392.L$0 = obj;
            return c26392;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
            return ((C26392) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    static /* synthetic */ Object collect$suspendImpl(ChannelFlow channelFlow, FlowCollector flowCollector, Continuation continuation) {
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C26392(flowCollector, channelFlow, null), continuation);
