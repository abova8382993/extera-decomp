...
public abstract class ChannelFlow<T> implements FusibleFlow<T> {
    ...
    public abstract ChannelFlow<T> create(CoroutineContext context, int capacity, BufferOverflow onBufferOverflow);
    ...
    */
    ...
    @DebugMetadata(m895c = "kotlinx.coroutines.flow.internal.ChannelFlow$collect$2", m896f = "ChannelFlow.kt", m897i = {}, m898l = {119}, m899m = "invokeSuspend", m900n = {}, m902s = {})
    public static final class C25272 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public C25272(FlowCollector<? super T> flowCollector, ChannelFlow<T> channelFlow, Continuation<? super C25272> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C25272 c25272 = new C25272(this.$collector, this.this$0, continuation);
            c25272.L$0 = obj;
            return c25272;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C25272) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static /* synthetic */ <T> Object collect$suspendImpl(ChannelFlow<T> channelFlow, FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C25272(flowCollector, channelFlow, null), continuation);
