...
public class SharedFlowImpl extends AbstractSharedFlow implements MutableSharedFlow, Flow, FusibleFlow {
    ...
    static final class C26341 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        Object L$3;
        ...
        C26341(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    static /* synthetic */ java.lang.Object collect$suspendImpl(kotlinx.coroutines.flow.SharedFlowImpl r8, kotlinx.coroutines.flow.FlowCollector r9, kotlin.coroutines.Continuation r10) throws java.lang.Throwable {
        /*
            boolean r0 = r10 instanceof kotlinx.coroutines.flow.SharedFlowImpl.C26341
            if (r0 == 0) goto L13
            r0 = r10
            kotlinx.coroutines.flow.SharedFlowImpl$collect$1 r0 = (kotlinx.coroutines.flow.SharedFlowImpl.C26341) r0
            int r1 = r0.label
        ...
        synchronized (this) {
            try {
                if (tryPeekLocked(sharedFlowSlot) >= 0) {
                    Result.Companion companion = Result.Companion;
                    cancellableContinuationImpl.resumeWith(Result.m3604constructorimpl(Unit.INSTANCE));
                } else {
        ...
        synchronized (this) {
            try {
                if (tryEmitLocked(obj)) {
                    ...
                    try {
                        emitter = new Emitter(this, getHead() + ((long) getTotalSize()), obj, cancellableContinuationImpl);
                ...
                for (Continuation continuation2 : continuationArrFindSlotsToResumeLocked) {
                    if (continuation2 != null) {
                        ...
                        continuation2.resumeWith(Result.m3604constructorimpl(Unit.INSTANCE));
                    }
                }
                Object result = cancellableContinuationImpl.getResult();
                if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
