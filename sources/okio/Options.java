...
@Metadata(m876d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\n\u0000\n\u0002\u0010\u0015\n\u0002\b\b\n\u0002\u0010\b\n\u0002\b\u0006\u0018\u0000 \u00162\b\u0012\u0004\u0012\u00020\u00020\u00012\u00060\u0003j\u0002`\u0004:\u0001\u0016B!\b\u0002\u0012\u000e\u0010\u0005\u001a\n\u0012\u0006\b\u0001\u0012\u00020\u00020\u0006\u0012\u0006\u0010\u0007\u001a\u00020\b¢\u0006\u0004\b\t\u0010\nJ\u0011\u0010\u0014\u001a\u00020\u00022\u0006\u0010\u0015\u001a\u00020\u0011H\u0096\u0002R\u001e\u0010\u0005\u001a\n\u0012\u0006\b\u0001\u0012\u00020\u00020\u0006X\u0080\u0004¢\u0006\n\n\u0002\u0010\r\u001a\u0004\b\u000b\u0010\fR\u0014\u0010\u0007\u001a\u00020\bX\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u000e\u0010\u000fR\u0014\u0010\u0010\u001a\u00020\u00118VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b\u0012\u0010\u0013¨\u0006\u0017"}, m877d2 = {"Lokio/Options;", "Lkotlin/collections/AbstractList;", "Lokio/ByteString;", "Ljava/util/RandomAccess;", "Lkotlin/collections/RandomAccess;", "byteStrings", _UrlKt.FRAGMENT_ENCODE_SET, "trie", _UrlKt.FRAGMENT_ENCODE_SET, "<init>", "([Lokio/ByteString;[I)V", "getByteStrings$okio", "()[Lokio/ByteString;", "[Lokio/ByteString;", "getTrie$okio", "()[I", "size", _UrlKt.FRAGMENT_ENCODE_SET, "getSize", "()I", "get", "index", "Companion", "okio"}, m878k = 1, m879mv = {2, 2, 0}, m881xi = 48)
public final class Options extends AbstractList<ByteString> implements RandomAccess {
    ...
    @Metadata(m876d1 = {"\u0000<\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\u0010 \n\u0002\b\u0007\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J!\u0010\u0004\u001a\u00020\u00052\u0012\u0010\u0006\u001a\n\u0012\u0006\b\u0001\u0012\u00020\b0\u0007\"\u00020\bH\u0007¢\u0006\u0002\u0010\tJT\u0010\n\u001a\u00020\u000b2\b\b\u0002\u0010\f\u001a\u00020\r2\u0006\u0010\u000e\u001a\u00020\u000f2\b\b\u0002\u0010\u0010\u001a\u00020\u00112\f\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\b0\u00122\b\b\u0002\u0010\u0013\u001a\u00020\u00112\b\b\u0002\u0010\u0014\u001a\u00020\u00112\f\u0010\u0015\u001a\b\u0012\u0004\u0012\u00020\u00110\u0012H\u0002R\u0018\u0010\u0016\u001a\u00020\r*\u00020\u000f8BX\u0082\u0004¢\u0006\u0006\u001a\u0004\b\u0017\u0010\u0018¨\u0006\u0019"}, m877d2 = {"Lokio/Options$Companion;", _UrlKt.FRAGMENT_ENCODE_SET, "<init>", "()V", "of", "Lokio/Options;", "byteStrings", _UrlKt.FRAGMENT_ENCODE_SET, "Lokio/ByteString;", "([Lokio/ByteString;)Lokio/Options;", "buildTrieRecursive", _UrlKt.FRAGMENT_ENCODE_SET, "nodeOffset", _UrlKt.FRAGMENT_ENCODE_SET, "node", "Lokio/Buffer;", "byteStringOffset", _UrlKt.FRAGMENT_ENCODE_SET, _UrlKt.FRAGMENT_ENCODE_SET, "fromIndex", "toIndex", "indexes", "intCount", "getIntCount", "(Lokio/Buffer;)J", "okio"}, m878k = 1, m879mv = {2, 2, 0}, m881xi = 48)
    ...
    public static final class Companion {
        ...
        */
        public final okio.Options m989of(okio.ByteString... r17) {
            /*
                Method dump skipped, instruction units count: 236
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: okio.Options.Companion.m989of(okio.ByteString[]):okio.Options");
        }
        ...
        private final void buildTrieRecursive(long nodeOffset, Buffer node, int byteStringOffset, List<? extends ByteString> byteStrings, int fromIndex, int toIndex, List<Integer> indexes) {
            ...
            if (byteString.getByte(i4) != byteString2.getByte(i4)) {
                ...
                long intCount = nodeOffset + getIntCount(node) + 2 + ((long) (i7 * 2));
                node.writeInt(i7);
                node.writeInt(i2);
                for (int i9 = i; i9 < toIndex; i9++) {
                    byte b3 = byteStrings.get(i9).getByte(i4);
                    if (i9 == i || b3 != byteStrings.get(i9 - 1).getByte(i4)) {
                        node.writeInt(b3 & UByte.MAX_VALUE);
                    }
                }
                ...
                while (i < toIndex) {
                    ...
                    while (true) {
                        if (i11 >= toIndex) {
                            ...
                            if (b4 != byteStrings.get(i11).getByte(i4)) {
                                i3 = i11;
                                break;
                            }
                            i11++;
            ...
            long intCount2 = nodeOffset + getIntCount(node) + j + ((long) i12) + 1;
            node.writeInt(-i12);
            node.writeInt(i2);
            int i14 = i4 + i12;
            while (i4 < i14) {
