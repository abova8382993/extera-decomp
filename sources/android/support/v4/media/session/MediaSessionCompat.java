...
public class MediaSessionCompat {
    ...
    public MediaSessionCompat(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, Bundle bundle, VersionedParcelable versionedParcelable) {
        ...
        if (TextUtils.isEmpty(str)) {
            g$$ExternalSyntheticBUOutline1.m207m("tag must not be null or empty");
            throw null;
        }
    ...
    public class C00071 extends Callback {
        public C00071() {
        }
    }
    ...
    public void setPlaybackToRemote(VolumeProviderCompat volumeProviderCompat) {
        if (volumeProviderCompat == null) {
            g$$ExternalSyntheticBUOutline1.m207m("volumeProvider may not be null!");
        } else {
    ...
    public void setActive(boolean z) {
        ...
        Iterator<Object> it = this.mActiveListeners.iterator();
        if (it.hasNext()) {
    ...
    public void setQueue(List<QueueItem> list) {
        if (list != null) {
            ...
            for (QueueItem queueItem : list) {
                if (queueItem == null) {
                    g$$ExternalSyntheticBUOutline1.m207m("queue shouldn't have null items");
                    return;
                }
    ...
    public static final class Token implements Parcelable {
        ...
        public class C00111 implements Parcelable.Creator<Token> {
            @Override // android.os.Parcelable.Creator
            public Token createFromParcel(Parcel parcel) {
                return new Token(parcel.readParcelable(null));
            }
    ...
    public static final class QueueItem implements Parcelable {
        ...
        private QueueItem(MediaSession.QueueItem queueItem, MediaDescriptionCompat mediaDescriptionCompat, long j) {
            if (mediaDescriptionCompat == null) {
                g$$ExternalSyntheticBUOutline1.m207m("Description cannot be null");
                throw null;
            }
            if (j == -1) {
                g$$ExternalSyntheticBUOutline1.m207m("Id cannot be QueueItem.UNKNOWN_ID");
                throw null;
            }
        ...
        public class C00091 implements Parcelable.Creator<QueueItem> {
            @Override // android.os.Parcelable.Creator
            public QueueItem createFromParcel(Parcel parcel) {
                return new QueueItem(parcel);
            }
    ...
    public static final class ResultReceiverWrapper implements Parcelable {
        ...
        public class C00101 implements Parcelable.Creator<ResultReceiverWrapper> {
            @Override // android.os.Parcelable.Creator
            public ResultReceiverWrapper createFromParcel(Parcel parcel) {
                return new ResultReceiverWrapper(parcel);
            }
    ...
    public static class MediaSessionImplApi29 extends MediaSessionImplApi28 {
        ...
        public MediaSession createFwkMediaSession(Context context, String str, Bundle bundle) {
            return AbstractC0008x4c959418.m3m(context, str, bundle);
        }
    }
}
