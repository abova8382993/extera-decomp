...
public final class PlaybackStateCompat implements Parcelable {
        ...
        public static final class Builder {
            ...
            public Builder(String str, CharSequence charSequence, int i) {
                if (TextUtils.isEmpty(str)) {
                    g$$ExternalSyntheticBUOutline1.m207m("You must specify an action to build a CustomAction");
                    throw null;
                }
                if (TextUtils.isEmpty(charSequence)) {
                    g$$ExternalSyntheticBUOutline1.m207m("You must specify a name to build a CustomAction");
                    throw null;
                }
                if (i == 0) {
                    g$$ExternalSyntheticBUOutline1.m207m("You must specify an icon resource id to build a CustomAction");
                    throw null;
                }
                this.mAction = str;
                this.mName = charSequence;
    ...
    public static final class Builder {
        ...
        public Builder addCustomAction(CustomAction customAction) {
            if (customAction == null) {
                g$$ExternalSyntheticBUOutline1.m207m("You may not add a null CustomAction to PlaybackStateCompat");
                return null;
            }
