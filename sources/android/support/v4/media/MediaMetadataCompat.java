    ...
    public static final class Builder {
        ...
        public Builder putText(String str, CharSequence charSequence) {
            ...
            if (arrayMap.containsKey(str) && arrayMap.get(str).intValue() != 1) {
                Native$$ExternalSyntheticBUOutline0.m549m("The ", str, " key cannot be used to put a CharSequence");
                return null;
            }
        ...
        public Builder putString(String str, String str2) {
            ArrayMap<String, Integer> arrayMap = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (arrayMap.containsKey(str) && arrayMap.get(str).intValue() != 1) {
                Native$$ExternalSyntheticBUOutline0.m549m("The ", str, " key cannot be used to put a String");
                return null;
            }
        ...
        public Builder putLong(String str, long j) {
            ...
            if (arrayMap.containsKey(str) && arrayMap.get(str).intValue() != 0) {
                Native$$ExternalSyntheticBUOutline0.m549m("The ", str, " key cannot be used to put a long");
                return null;
            }
        ...
        public Builder putRating(String str, RatingCompat ratingCompat) {
            ...
            if (arrayMap.containsKey(str) && arrayMap.get(str).intValue() != 3) {
                Native$$ExternalSyntheticBUOutline0.m549m("The ", str, " key cannot be used to put a Rating");
                return null;
            }
        ...
        public Builder putBitmap(String str, Bitmap bitmap) {
            ...
            if (arrayMap.containsKey(str) && arrayMap.get(str).intValue() != 2) {
                Native$$ExternalSyntheticBUOutline0.m549m("The ", str, " key cannot be used to put a Bitmap");
                return null;
            }
